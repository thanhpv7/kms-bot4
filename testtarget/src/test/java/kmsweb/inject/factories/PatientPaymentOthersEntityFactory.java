...
public class PatientPaymentOthersEntityFactory extends BaseFactory<PatientPaymentOthersEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public PatientPaymentOthersEntityFactory(
		...
		super(
				...
				PatientPaymentOthersEntity.class,
				injector
		);
