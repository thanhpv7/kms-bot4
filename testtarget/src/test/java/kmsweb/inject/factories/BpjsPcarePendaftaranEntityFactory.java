...
public class BpjsPcarePendaftaranEntityFactory extends BaseFactory<BpjsPcarePendaftaranEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public BpjsPcarePendaftaranEntityFactory(
		...
		super(
				...
				BpjsPcarePendaftaranEntity.class,
				injector
		);
