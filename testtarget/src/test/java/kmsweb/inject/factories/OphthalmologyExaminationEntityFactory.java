...
public class OphthalmologyExaminationEntityFactory extends BaseFactory<OphthalmologyExaminationEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public OphthalmologyExaminationEntityFactory(
		...
		super(
				...
				OphthalmologyExaminationEntity.class,
				injector
		);
