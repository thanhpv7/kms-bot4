...
public class PreoperativeRecordsEntityFactory extends BaseFactory<PreoperativeRecordsEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public PreoperativeRecordsEntityFactory(
		...
		super(
				...
				PreoperativeRecordsEntity.class,
				injector
		);
