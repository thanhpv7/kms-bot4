...
public class SampleCollectionInformationEntityFactory extends BaseFactory<SampleCollectionInformationEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public SampleCollectionInformationEntityFactory(
		...
		super(
				...
				SampleCollectionInformationEntity.class,
				injector
		);
