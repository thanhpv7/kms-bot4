...
public class HemodialysisExaminationEntityFactory extends BaseFactory<HemodialysisExaminationEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public HemodialysisExaminationEntityFactory(
		...
		super(
				...
				HemodialysisExaminationEntity.class,
				injector
		);
