...
public class NhisSpecialtyAttendedEntityFactory extends BaseFactory<NhisSpecialtyAttendedEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public NhisSpecialtyAttendedEntityFactory(
		...
		super(
				...
				NhisSpecialtyAttendedEntity.class,
				injector
		);
