...
public class DeliveryMedicalExaminationRecordEntityFactory extends BaseFactory<DeliveryMedicalExaminationRecordEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public DeliveryMedicalExaminationRecordEntityFactory(
		...
		super(
				...
				DeliveryMedicalExaminationRecordEntity.class,
				injector
		);
