...
public class BpjsPcareRegistrationsEntityFactory extends BaseFactory<BpjsPcareRegistrationsEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public BpjsPcareRegistrationsEntityFactory(
		...
		super(
				...
				BpjsPcareRegistrationsEntity.class,
				injector
		);
