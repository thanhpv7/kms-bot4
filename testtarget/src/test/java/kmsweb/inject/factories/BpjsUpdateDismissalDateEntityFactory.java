...
public class BpjsUpdateDismissalDateEntityFactory extends BaseFactory<BpjsUpdateDismissalDateEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public BpjsUpdateDismissalDateEntityFactory(
		...
		super(
				...
				BpjsUpdateDismissalDateEntity.class,
				injector
		);
