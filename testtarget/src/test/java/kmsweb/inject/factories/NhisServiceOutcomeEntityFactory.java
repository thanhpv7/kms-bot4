...
public class NhisServiceOutcomeEntityFactory extends BaseFactory<NhisServiceOutcomeEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public NhisServiceOutcomeEntityFactory(
		...
		super(
				...
				NhisServiceOutcomeEntity.class,
				injector
		);
