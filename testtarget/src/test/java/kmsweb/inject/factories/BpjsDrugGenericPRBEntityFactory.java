...
public class BpjsDrugGenericPRBEntityFactory extends BaseFactory<BpjsDrugGenericPRBEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public BpjsDrugGenericPRBEntityFactory(
		...
		super(
				...
				BpjsDrugGenericPRBEntity.class,
				injector
		);
