...
public class BpjsHospitalizationPlanEntityFactory extends BaseFactory<BpjsHospitalizationPlanEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public BpjsHospitalizationPlanEntityFactory(
		...
		super(
				...
				BpjsHospitalizationPlanEntity.class,
				injector
		);
