...
public class BodyChartExaminationEntityFactory extends BaseFactory<BodyChartExaminationEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public BodyChartExaminationEntityFactory(
		...
		super(
				...
				BodyChartExaminationEntity.class,
				injector
		);
