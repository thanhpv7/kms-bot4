...
public class PatientEmergencyContactDetailEntityFactory extends BaseFactory<PatientEmergencyContactDetailEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public PatientEmergencyContactDetailEntityFactory(
		...
		super(
				...
				PatientEmergencyContactDetailEntity.class,
				injector
		);
