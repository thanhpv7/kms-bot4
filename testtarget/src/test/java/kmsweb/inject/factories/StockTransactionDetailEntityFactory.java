...
public class StockTransactionDetailEntityFactory extends BaseFactory<StockTransactionDetailEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public StockTransactionDetailEntityFactory(
		...
		super(
				...
				StockTransactionDetailEntity.class,
				injector
		);
