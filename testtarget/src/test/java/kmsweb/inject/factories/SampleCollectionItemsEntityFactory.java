...
public class SampleCollectionItemsEntityFactory extends BaseFactory<SampleCollectionItemsEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public SampleCollectionItemsEntityFactory(
		...
		super(
				...
				SampleCollectionItemsEntity.class,
				injector
		);
