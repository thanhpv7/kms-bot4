...
public class MedicalTranscriberUserEntityFactory extends BaseFactory<MedicalTranscriberUserEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public MedicalTranscriberUserEntityFactory(
		...
		super(
				...
				MedicalTranscriberUserEntity.class,
				injector
		);
