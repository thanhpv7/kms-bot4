...
public class SatuSehatConfigurationEntityFactory extends BaseFactory<SatuSehatConfigurationEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public SatuSehatConfigurationEntityFactory(
		...
		super(
				...
				SatuSehatConfigurationEntity.class,
				injector
		);
