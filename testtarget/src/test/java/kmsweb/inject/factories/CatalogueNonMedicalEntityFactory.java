...
public class CatalogueNonMedicalEntityFactory extends BaseFactory<CatalogueNonMedicalEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public CatalogueNonMedicalEntityFactory(
		...
		super(
				...
				CatalogueNonMedicalEntity.class,
				injector
		);
