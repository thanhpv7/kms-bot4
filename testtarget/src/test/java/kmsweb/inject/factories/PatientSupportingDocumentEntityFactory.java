...
public class PatientSupportingDocumentEntityFactory extends BaseFactory<PatientSupportingDocumentEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public PatientSupportingDocumentEntityFactory(
		...
		super(
				...
				PatientSupportingDocumentEntity.class,
				injector
		);
