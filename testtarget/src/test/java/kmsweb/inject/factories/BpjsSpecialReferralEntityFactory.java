...
public class BpjsSpecialReferralEntityFactory extends BaseFactory<BpjsSpecialReferralEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public BpjsSpecialReferralEntityFactory(
		...
		super(
				...
				BpjsSpecialReferralEntity.class,
				injector
		);
