...
public class BpjsTotalReferralSEPEntityFactory extends BaseFactory<BpjsTotalReferralSEPEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public BpjsTotalReferralSEPEntityFactory(
		...
		super(
				...
				BpjsTotalReferralSEPEntity.class,
				injector
		);
