...
public class PatientGeneralInfoEntityFactory extends BaseFactory<PatientGeneralInfoEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public PatientGeneralInfoEntityFactory(
		...
		super(
				...
				PatientGeneralInfoEntity.class,
				injector
		);
