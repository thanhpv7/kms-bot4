...
public class InternalOrderStockDetailEntityFactory extends BaseFactory<InternalOrderStockDetailEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public InternalOrderStockDetailEntityFactory(
		...
		super(
				...
				InternalOrderStockDetailEntity.class,
				injector
		);
