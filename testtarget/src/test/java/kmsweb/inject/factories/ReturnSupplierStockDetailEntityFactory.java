...
public class ReturnSupplierStockDetailEntityFactory extends BaseFactory<ReturnSupplierStockDetailEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public ReturnSupplierStockDetailEntityFactory(
		...
		super(
				...
				ReturnSupplierStockDetailEntity.class,
				injector
		);
