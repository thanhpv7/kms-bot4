...
public class PcareNonCompoundDrugEntityFactory extends BaseFactory<PcareNonCompoundDrugEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public PcareNonCompoundDrugEntityFactory(
		...
		super(
				...
				PcareNonCompoundDrugEntity.class,
				injector
		);
