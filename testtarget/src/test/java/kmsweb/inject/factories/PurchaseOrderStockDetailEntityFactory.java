...
public class PurchaseOrderStockDetailEntityFactory extends BaseFactory<PurchaseOrderStockDetailEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public PurchaseOrderStockDetailEntityFactory(
		...
		super(
				...
				PurchaseOrderStockDetailEntity.class,
				injector
		);
