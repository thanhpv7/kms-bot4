...
public class NurseVitalSignMeasurementEntityFactory extends BaseFactory<NurseVitalSignMeasurementEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public NurseVitalSignMeasurementEntityFactory(
		...
		super(
				...
				NurseVitalSignMeasurementEntity.class,
				injector
		);
