...
public class VaccinationOrderDetailEntityFactory extends BaseFactory<VaccinationOrderDetailEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public VaccinationOrderDetailEntityFactory(
		...
		super(
				...
				VaccinationOrderDetailEntity.class,
				injector
		);
