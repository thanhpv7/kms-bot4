...
public class BatchStockBalancePerDateEntityFactory extends BaseFactory<BatchStockBalancePerDateEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public BatchStockBalancePerDateEntityFactory(
		...
		super(
				...
				BatchStockBalancePerDateEntity.class,
				injector
		);
