...
public class SupplierProductDetailEntityFactory extends BaseFactory<SupplierProductDetailEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public SupplierProductDetailEntityFactory(
		...
		super(
				...
				SupplierProductDetailEntity.class,
				injector
		);
