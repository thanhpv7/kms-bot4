...
public class BpjsDismissalMappingEntityFactory extends BaseFactory<BpjsDismissalMappingEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public BpjsDismissalMappingEntityFactory(
		...
		super(
				...
				BpjsDismissalMappingEntity.class,
				injector
		);
