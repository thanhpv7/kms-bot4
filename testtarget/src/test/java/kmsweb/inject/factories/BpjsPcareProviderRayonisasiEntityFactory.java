...
public class BpjsPcareProviderRayonisasiEntityFactory extends BaseFactory<BpjsPcareProviderRayonisasiEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public BpjsPcareProviderRayonisasiEntityFactory(
		...
		super(
				...
				BpjsPcareProviderRayonisasiEntity.class,
				injector
		);
