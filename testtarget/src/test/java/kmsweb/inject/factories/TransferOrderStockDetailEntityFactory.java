...
public class TransferOrderStockDetailEntityFactory extends BaseFactory<TransferOrderStockDetailEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public TransferOrderStockDetailEntityFactory(
		...
		super(
				...
				TransferOrderStockDetailEntity.class,
				injector
		);
