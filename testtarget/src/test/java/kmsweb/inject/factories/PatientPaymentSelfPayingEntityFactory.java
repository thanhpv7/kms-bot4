...
public class PatientPaymentSelfPayingEntityFactory extends BaseFactory<PatientPaymentSelfPayingEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public PatientPaymentSelfPayingEntityFactory(
		...
		super(
				...
				PatientPaymentSelfPayingEntity.class,
				injector
		);
