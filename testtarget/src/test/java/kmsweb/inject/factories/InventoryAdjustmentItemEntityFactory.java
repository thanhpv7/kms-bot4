...
public class InventoryAdjustmentItemEntityFactory extends BaseFactory<InventoryAdjustmentItemEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public InventoryAdjustmentItemEntityFactory(
		...
		super(
				...
				InventoryAdjustmentItemEntity.class,
				injector
		);
