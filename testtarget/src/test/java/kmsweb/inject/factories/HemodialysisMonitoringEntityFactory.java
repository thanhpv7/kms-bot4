...
public class HemodialysisMonitoringEntityFactory extends BaseFactory<HemodialysisMonitoringEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public HemodialysisMonitoringEntityFactory(
		...
		super(
				...
				HemodialysisMonitoringEntity.class,
				injector
		);
