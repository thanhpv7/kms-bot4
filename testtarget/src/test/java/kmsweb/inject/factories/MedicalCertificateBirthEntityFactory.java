...
public class MedicalCertificateBirthEntityFactory extends BaseFactory<MedicalCertificateBirthEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public MedicalCertificateBirthEntityFactory(
		...
		super(
				...
				MedicalCertificateBirthEntity.class,
				injector
		);
