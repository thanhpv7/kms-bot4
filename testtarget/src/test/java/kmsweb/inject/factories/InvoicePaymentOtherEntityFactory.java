...
public class InvoicePaymentOtherEntityFactory extends BaseFactory<InvoicePaymentOtherEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public InvoicePaymentOtherEntityFactory(
		...
		super(
				...
				InvoicePaymentOtherEntity.class,
				injector
		);
