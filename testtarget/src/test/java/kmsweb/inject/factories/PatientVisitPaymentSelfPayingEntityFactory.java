...
public class PatientVisitPaymentSelfPayingEntityFactory extends BaseFactory<PatientVisitPaymentSelfPayingEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public PatientVisitPaymentSelfPayingEntityFactory(
		...
		super(
				...
				PatientVisitPaymentSelfPayingEntity.class,
				injector
		);
