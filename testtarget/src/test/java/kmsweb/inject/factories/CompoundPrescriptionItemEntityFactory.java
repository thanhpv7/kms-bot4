...
public class CompoundPrescriptionItemEntityFactory extends BaseFactory<CompoundPrescriptionItemEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public CompoundPrescriptionItemEntityFactory(
		...
		super(
				...
				CompoundPrescriptionItemEntity.class,
				injector
		);
