...
public class DiagnosticStaffExaminationSummaryEntityFactory extends BaseFactory<DiagnosticStaffExaminationSummaryEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public DiagnosticStaffExaminationSummaryEntityFactory(
		...
		super(
				...
				DiagnosticStaffExaminationSummaryEntity.class,
				injector
		);
