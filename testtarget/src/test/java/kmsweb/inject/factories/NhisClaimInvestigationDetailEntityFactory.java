...
public class NhisClaimInvestigationDetailEntityFactory extends BaseFactory<NhisClaimInvestigationDetailEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public NhisClaimInvestigationDetailEntityFactory(
		...
		super(
				...
				NhisClaimInvestigationDetailEntity.class,
				injector
		);
