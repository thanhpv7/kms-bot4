...
public class BatchStockTransactionDetailEntityFactory extends BaseFactory<BatchStockTransactionDetailEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public BatchStockTransactionDetailEntityFactory(
		...
		super(
				...
				BatchStockTransactionDetailEntity.class,
				injector
		);
