...
public class ServiceItemAssignmentEntityFactory extends BaseFactory<ServiceItemAssignmentEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public ServiceItemAssignmentEntityFactory(
		...
		super(
				...
				ServiceItemAssignmentEntity.class,
				injector
		);
