...
public class GoodsReceiveNoteItemEntityFactory extends BaseFactory<GoodsReceiveNoteItemEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public GoodsReceiveNoteItemEntityFactory(
		...
		super(
				...
				GoodsReceiveNoteItemEntity.class,
				injector
		);
