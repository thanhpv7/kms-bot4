...
public class DiagnosticSupportUserEntityFactory extends BaseFactory<DiagnosticSupportUserEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public DiagnosticSupportUserEntityFactory(
		...
		super(
				...
				DiagnosticSupportUserEntity.class,
				injector
		);
