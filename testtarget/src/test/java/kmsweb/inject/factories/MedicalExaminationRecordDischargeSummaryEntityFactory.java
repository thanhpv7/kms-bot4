...
public class MedicalExaminationRecordDischargeSummaryEntityFactory extends BaseFactory<MedicalExaminationRecordDischargeSummaryEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public MedicalExaminationRecordDischargeSummaryEntityFactory(
		...
		super(
				...
				MedicalExaminationRecordDischargeSummaryEntity.class,
				injector
		);
