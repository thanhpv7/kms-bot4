...
public class RetailPharmacyInvoiceEntityFactory extends BaseFactory<RetailPharmacyInvoiceEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public RetailPharmacyInvoiceEntityFactory(
		...
		super(
				...
				RetailPharmacyInvoiceEntity.class,
				injector
		);
