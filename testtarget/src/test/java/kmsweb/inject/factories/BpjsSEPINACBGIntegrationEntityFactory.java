...
public class BpjsSEPINACBGIntegrationEntityFactory extends BaseFactory<BpjsSEPINACBGIntegrationEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public BpjsSEPINACBGIntegrationEntityFactory(
		...
		super(
				...
				BpjsSEPINACBGIntegrationEntity.class,
				injector
		);
