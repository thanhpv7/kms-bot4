...
public class MedicalCertificateMedicalAttendanceEntityFactory extends BaseFactory<MedicalCertificateMedicalAttendanceEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public MedicalCertificateMedicalAttendanceEntityFactory(
		...
		super(
				...
				MedicalCertificateMedicalAttendanceEntity.class,
				injector
		);
