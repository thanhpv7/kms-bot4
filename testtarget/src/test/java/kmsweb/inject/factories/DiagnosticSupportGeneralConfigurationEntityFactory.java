...
public class DiagnosticSupportGeneralConfigurationEntityFactory extends BaseFactory<DiagnosticSupportGeneralConfigurationEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public DiagnosticSupportGeneralConfigurationEntityFactory(
		...
		super(
				...
				DiagnosticSupportGeneralConfigurationEntity.class,
				injector
		);
