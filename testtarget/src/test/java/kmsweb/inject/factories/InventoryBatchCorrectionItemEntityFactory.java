...
public class InventoryBatchCorrectionItemEntityFactory extends BaseFactory<InventoryBatchCorrectionItemEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public InventoryBatchCorrectionItemEntityFactory(
		...
		super(
				...
				InventoryBatchCorrectionItemEntity.class,
				injector
		);
