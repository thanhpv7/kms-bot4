...
public class WarehouseInitialStockEntityFactory extends BaseFactory<WarehouseInitialStockEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public WarehouseInitialStockEntityFactory(
		...
		super(
				...
				WarehouseInitialStockEntity.class,
				injector
		);
