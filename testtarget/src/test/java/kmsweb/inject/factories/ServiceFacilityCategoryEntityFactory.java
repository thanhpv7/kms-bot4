...
public class ServiceFacilityCategoryEntityFactory extends BaseFactory<ServiceFacilityCategoryEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public ServiceFacilityCategoryEntityFactory(
		...
		super(
				...
				ServiceFacilityCategoryEntity.class,
				injector
		);
