...
public class OperatingTheaterMedicalExaminationRecordEntityFactory extends BaseFactory<OperatingTheaterMedicalExaminationRecordEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public OperatingTheaterMedicalExaminationRecordEntityFactory(
		...
		super(
				...
				OperatingTheaterMedicalExaminationRecordEntity.class,
				injector
		);
