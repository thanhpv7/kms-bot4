...
public class BpjsSearchControlLetterEntityFactory extends BaseFactory<BpjsSearchControlLetterEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public BpjsSearchControlLetterEntityFactory(
		...
		super(
				...
				BpjsSearchControlLetterEntity.class,
				injector
		);
