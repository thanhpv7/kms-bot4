...
public class MedicalRecordNextVerificationChecklistEntityFactory extends BaseFactory<MedicalRecordNextVerificationChecklistEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public MedicalRecordNextVerificationChecklistEntityFactory(
		...
		super(
				...
				MedicalRecordNextVerificationChecklistEntity.class,
				injector
		);
