...
public class MedicalExaminationRecordEntityFactory extends BaseFactory<MedicalExaminationRecordEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public MedicalExaminationRecordEntityFactory(
		...
		super(
				...
				MedicalExaminationRecordEntity.class,
				injector
		);
