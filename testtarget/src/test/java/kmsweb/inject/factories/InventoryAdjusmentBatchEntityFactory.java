...
public class InventoryAdjusmentBatchEntityFactory extends BaseFactory<InventoryAdjusmentBatchEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public InventoryAdjusmentBatchEntityFactory(
		...
		super(
				...
				InventoryAdjusmentBatchEntity.class,
				injector
		);
