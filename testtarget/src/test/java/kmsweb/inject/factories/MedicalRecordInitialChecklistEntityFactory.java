...
public class MedicalRecordInitialChecklistEntityFactory extends BaseFactory<MedicalRecordInitialChecklistEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public MedicalRecordInitialChecklistEntityFactory(
		...
		super(
				...
				MedicalRecordInitialChecklistEntity.class,
				injector
		);
