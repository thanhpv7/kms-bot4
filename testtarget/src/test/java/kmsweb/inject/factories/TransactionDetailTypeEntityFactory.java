...
public class TransactionDetailTypeEntityFactory extends BaseFactory<TransactionDetailTypeEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public TransactionDetailTypeEntityFactory(
		...
		super(
				...
				TransactionDetailTypeEntity.class,
				injector
		);
