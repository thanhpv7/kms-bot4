...
public class BpjsPcareKegiatanKelompokEntityFactory extends BaseFactory<BpjsPcareKegiatanKelompokEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public BpjsPcareKegiatanKelompokEntityFactory(
		...
		super(
				...
				BpjsPcareKegiatanKelompokEntity.class,
				injector
		);
