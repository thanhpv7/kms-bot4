...
public class PatientVisitPatientPaymentOthersEntityFactory extends BaseFactory<PatientVisitPatientPaymentOthersEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public PatientVisitPatientPaymentOthersEntityFactory(
		...
		super(
				...
				PatientVisitPatientPaymentOthersEntity.class,
				injector
		);
