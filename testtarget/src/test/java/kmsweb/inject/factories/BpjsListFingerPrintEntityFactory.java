...
public class BpjsListFingerPrintEntityFactory extends BaseFactory<BpjsListFingerPrintEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public BpjsListFingerPrintEntityFactory(
		...
		super(
				...
				BpjsListFingerPrintEntity.class,
				injector
		);
