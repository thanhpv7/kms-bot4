...
public class BpjsPcareKesadaranEntityFactory extends BaseFactory<BpjsPcareKesadaranEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public BpjsPcareKesadaranEntityFactory(
		...
		super(
				...
				BpjsPcareKesadaranEntity.class,
				injector
		);
