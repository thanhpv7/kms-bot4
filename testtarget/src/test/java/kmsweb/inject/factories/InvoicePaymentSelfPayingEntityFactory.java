...
public class InvoicePaymentSelfPayingEntityFactory extends BaseFactory<InvoicePaymentSelfPayingEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public InvoicePaymentSelfPayingEntityFactory(
		...
		super(
				...
				InvoicePaymentSelfPayingEntity.class,
				injector
		);
