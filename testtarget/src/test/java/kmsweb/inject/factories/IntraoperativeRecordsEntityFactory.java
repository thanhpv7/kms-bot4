...
public class IntraoperativeRecordsEntityFactory extends BaseFactory<IntraoperativeRecordsEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public IntraoperativeRecordsEntityFactory(
		...
		super(
				...
				IntraoperativeRecordsEntity.class,
				injector
		);
