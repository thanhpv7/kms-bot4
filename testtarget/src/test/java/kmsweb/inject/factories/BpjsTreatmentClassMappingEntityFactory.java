...
public class BpjsTreatmentClassMappingEntityFactory extends BaseFactory<BpjsTreatmentClassMappingEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public BpjsTreatmentClassMappingEntityFactory(
		...
		super(
				...
				BpjsTreatmentClassMappingEntity.class,
				injector
		);
