...
public class MedicalCertificatePhysicalHealthEntityFactory extends BaseFactory<MedicalCertificatePhysicalHealthEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public MedicalCertificatePhysicalHealthEntityFactory(
		...
		super(
				...
				MedicalCertificatePhysicalHealthEntity.class,
				injector
		);
