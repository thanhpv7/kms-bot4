...
public class PatientEmploymentDetailEntityFactory extends BaseFactory<PatientEmploymentDetailEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public PatientEmploymentDetailEntityFactory(
		...
		super(
				...
				PatientEmploymentDetailEntity.class,
				injector
		);
