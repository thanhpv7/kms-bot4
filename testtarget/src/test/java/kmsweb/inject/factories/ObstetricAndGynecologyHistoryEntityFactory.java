...
public class ObstetricAndGynecologyHistoryEntityFactory extends BaseFactory<ObstetricAndGynecologyHistoryEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public ObstetricAndGynecologyHistoryEntityFactory(
		...
		super(
				...
				ObstetricAndGynecologyHistoryEntity.class,
				injector
		);
