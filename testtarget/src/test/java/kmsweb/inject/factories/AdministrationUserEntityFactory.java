...
public class AdministrationUserEntityFactory extends BaseFactory<AdministrationUserEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public AdministrationUserEntityFactory(
		...
		super(
				...
				AdministrationUserEntity.class,
				injector
		);
