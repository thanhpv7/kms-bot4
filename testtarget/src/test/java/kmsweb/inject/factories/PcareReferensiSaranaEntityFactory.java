...
public class PcareReferensiSaranaEntityFactory extends BaseFactory<PcareReferensiSaranaEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public PcareReferensiSaranaEntityFactory(
		...
		super(
				...
				PcareReferensiSaranaEntity.class,
				injector
		);
