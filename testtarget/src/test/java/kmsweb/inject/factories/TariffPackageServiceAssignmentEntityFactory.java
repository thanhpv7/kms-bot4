...
public class TariffPackageServiceAssignmentEntityFactory extends BaseFactory<TariffPackageServiceAssignmentEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public TariffPackageServiceAssignmentEntityFactory(
		...
		super(
				...
				TariffPackageServiceAssignmentEntity.class,
				injector
		);
