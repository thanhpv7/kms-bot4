...
public class MedicationAdministeredHistoryEntityFactory extends BaseFactory<MedicationAdministeredHistoryEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public MedicationAdministeredHistoryEntityFactory(
		...
		super(
				...
				MedicationAdministeredHistoryEntity.class,
				injector
		);
