...
public class BpjsHealthFacilityEntityFactory extends BaseFactory<BpjsHealthFacilityEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public BpjsHealthFacilityEntityFactory(
		...
		super(
				...
				BpjsHealthFacilityEntity.class,
				injector
		);
