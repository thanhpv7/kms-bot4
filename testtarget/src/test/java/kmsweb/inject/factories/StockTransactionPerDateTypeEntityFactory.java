...
public class StockTransactionPerDateTypeEntityFactory extends BaseFactory<StockTransactionPerDateTypeEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public StockTransactionPerDateTypeEntityFactory(
		...
		super(
				...
				StockTransactionPerDateTypeEntity.class,
				injector
		);
