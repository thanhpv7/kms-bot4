...
public class BpjsPcareKunjunganRujukanEntityFactory extends BaseFactory<BpjsPcareKunjunganRujukanEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public BpjsPcareKunjunganRujukanEntityFactory(
		...
		super(
				...
				BpjsPcareKunjunganRujukanEntity.class,
				injector
		);
