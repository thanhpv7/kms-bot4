...
public class PurchaseRequisitionStockDetailEntityFactory extends BaseFactory<PurchaseRequisitionStockDetailEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public PurchaseRequisitionStockDetailEntityFactory(
		...
		super(
				...
				PurchaseRequisitionStockDetailEntity.class,
				injector
		);
