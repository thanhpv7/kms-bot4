...
public class StockTransactionPerDateEntityFactory extends BaseFactory<StockTransactionPerDateEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public StockTransactionPerDateEntityFactory(
		...
		super(
				...
				StockTransactionPerDateEntity.class,
				injector
		);
