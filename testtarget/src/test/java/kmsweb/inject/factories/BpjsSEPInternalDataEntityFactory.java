...
public class BpjsSEPInternalDataEntityFactory extends BaseFactory<BpjsSEPInternalDataEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public BpjsSEPInternalDataEntityFactory(
		...
		super(
				...
				BpjsSEPInternalDataEntity.class,
				injector
		);
