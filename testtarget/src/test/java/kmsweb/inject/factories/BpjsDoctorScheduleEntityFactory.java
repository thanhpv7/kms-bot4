...
public class BpjsDoctorScheduleEntityFactory extends BaseFactory<BpjsDoctorScheduleEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public BpjsDoctorScheduleEntityFactory(
		...
		super(
				...
				BpjsDoctorScheduleEntity.class,
				injector
		);
