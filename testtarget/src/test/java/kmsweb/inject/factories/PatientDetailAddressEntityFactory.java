...
public class PatientDetailAddressEntityFactory extends BaseFactory<PatientDetailAddressEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public PatientDetailAddressEntityFactory(
		...
		super(
				...
				PatientDetailAddressEntity.class,
				injector
		);
