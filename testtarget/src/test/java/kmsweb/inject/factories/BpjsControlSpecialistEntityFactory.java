...
public class BpjsControlSpecialistEntityFactory extends BaseFactory<BpjsControlSpecialistEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public BpjsControlSpecialistEntityFactory(
		...
		super(
				...
				BpjsControlSpecialistEntity.class,
				injector
		);
