...
public class RetailPharmacyStockDetailEntityFactory extends BaseFactory<RetailPharmacyStockDetailEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public RetailPharmacyStockDetailEntityFactory(
		...
		super(
				...
				RetailPharmacyStockDetailEntity.class,
				injector
		);
