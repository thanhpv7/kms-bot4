...
public class SupplierContactDetailEntityFactory extends BaseFactory<SupplierContactDetailEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public SupplierContactDetailEntityFactory(
		...
		super(
				...
				SupplierContactDetailEntity.class,
				injector
		);
