...
public class InvoiceItemComponentEntityFactory extends BaseFactory<InvoiceItemComponentEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public InvoiceItemComponentEntityFactory(
		...
		super(
				...
				InvoiceItemComponentEntity.class,
				injector
		);
