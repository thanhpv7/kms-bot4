...
public class PatientPaymentInsuranceEntityFactory extends BaseFactory<PatientPaymentInsuranceEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public PatientPaymentInsuranceEntityFactory(
		...
		super(
				...
				PatientPaymentInsuranceEntity.class,
				injector
		);
