...
public class PcareCompoundDrugItemEntityFactory extends BaseFactory<PcareCompoundDrugItemEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public PcareCompoundDrugItemEntityFactory(
		...
		super(
				...
				PcareCompoundDrugItemEntity.class,
				injector
		);
