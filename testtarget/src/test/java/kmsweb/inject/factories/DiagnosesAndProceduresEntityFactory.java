...
public class DiagnosesAndProceduresEntityFactory extends BaseFactory<DiagnosesAndProceduresEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public DiagnosesAndProceduresEntityFactory(
		...
		super(
				...
				DiagnosesAndProceduresEntity.class,
				injector
		);
