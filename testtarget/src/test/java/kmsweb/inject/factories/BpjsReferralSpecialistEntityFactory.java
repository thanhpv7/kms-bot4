...
public class BpjsReferralSpecialistEntityFactory extends BaseFactory<BpjsReferralSpecialistEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public BpjsReferralSpecialistEntityFactory(
		...
		super(
				...
				BpjsReferralSpecialistEntity.class,
				injector
		);
