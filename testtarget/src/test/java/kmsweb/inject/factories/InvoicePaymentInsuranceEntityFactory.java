...
public class InvoicePaymentInsuranceEntityFactory extends BaseFactory<InvoicePaymentInsuranceEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public InvoicePaymentInsuranceEntityFactory(
		...
		super(
				...
				InvoicePaymentInsuranceEntity.class,
				injector
		);
