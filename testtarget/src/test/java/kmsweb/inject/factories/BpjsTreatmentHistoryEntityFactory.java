...
public class BpjsTreatmentHistoryEntityFactory extends BaseFactory<BpjsTreatmentHistoryEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public BpjsTreatmentHistoryEntityFactory(
		...
		super(
				...
				BpjsTreatmentHistoryEntity.class,
				injector
		);
