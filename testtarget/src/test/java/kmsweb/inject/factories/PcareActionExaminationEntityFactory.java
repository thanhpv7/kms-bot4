...
public class PcareActionExaminationEntityFactory extends BaseFactory<PcareActionExaminationEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public PcareActionExaminationEntityFactory(
		...
		super(
				...
				PcareActionExaminationEntity.class,
				injector
		);
