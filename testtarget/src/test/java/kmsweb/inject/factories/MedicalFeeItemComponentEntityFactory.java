...
public class MedicalFeeItemComponentEntityFactory extends BaseFactory<MedicalFeeItemComponentEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public MedicalFeeItemComponentEntityFactory(
		...
		super(
				...
				MedicalFeeItemComponentEntity.class,
				injector
		);
