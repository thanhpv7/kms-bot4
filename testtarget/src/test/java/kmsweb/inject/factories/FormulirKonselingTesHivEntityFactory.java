...
public class FormulirKonselingTesHivEntityFactory extends BaseFactory<FormulirKonselingTesHivEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public FormulirKonselingTesHivEntityFactory(
		...
		super(
				...
				FormulirKonselingTesHivEntity.class,
				injector
		);
