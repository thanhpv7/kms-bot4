...
public class GoodsReceiveNoteBatchEntityFactory extends BaseFactory<GoodsReceiveNoteBatchEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public GoodsReceiveNoteBatchEntityFactory(
		...
		super(
				...
				GoodsReceiveNoteBatchEntity.class,
				injector
		);
