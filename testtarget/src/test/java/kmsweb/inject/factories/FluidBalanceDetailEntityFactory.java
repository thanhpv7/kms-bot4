...
public class FluidBalanceDetailEntityFactory extends BaseFactory<FluidBalanceDetailEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public FluidBalanceDetailEntityFactory(
		...
		super(
				...
				FluidBalanceDetailEntity.class,
				injector
		);
