...
public class OdontogramExaminationEntityFactory extends BaseFactory<OdontogramExaminationEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public OdontogramExaminationEntityFactory(
		...
		super(
				...
				OdontogramExaminationEntity.class,
				injector
		);
