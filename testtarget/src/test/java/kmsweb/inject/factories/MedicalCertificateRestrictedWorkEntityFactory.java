...
public class MedicalCertificateRestrictedWorkEntityFactory extends BaseFactory<MedicalCertificateRestrictedWorkEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public MedicalCertificateRestrictedWorkEntityFactory(
		...
		super(
				...
				MedicalCertificateRestrictedWorkEntity.class,
				injector
		);
