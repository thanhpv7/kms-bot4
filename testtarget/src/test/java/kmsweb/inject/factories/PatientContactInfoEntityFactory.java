...
public class PatientContactInfoEntityFactory extends BaseFactory<PatientContactInfoEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public PatientContactInfoEntityFactory(
		...
		super(
				...
				PatientContactInfoEntity.class,
				injector
		);
