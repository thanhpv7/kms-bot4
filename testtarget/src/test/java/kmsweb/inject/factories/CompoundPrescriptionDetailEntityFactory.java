...
public class CompoundPrescriptionDetailEntityFactory extends BaseFactory<CompoundPrescriptionDetailEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public CompoundPrescriptionDetailEntityFactory(
		...
		super(
				...
				CompoundPrescriptionDetailEntity.class,
				injector
		);
