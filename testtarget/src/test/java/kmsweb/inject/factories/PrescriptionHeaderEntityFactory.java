...
public class PrescriptionHeaderEntityFactory extends BaseFactory<PrescriptionHeaderEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public PrescriptionHeaderEntityFactory(
		...
		super(
				...
				PrescriptionHeaderEntity.class,
				injector
		);
