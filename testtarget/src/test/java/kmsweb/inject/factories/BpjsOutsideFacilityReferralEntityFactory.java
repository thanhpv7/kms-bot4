...
public class BpjsOutsideFacilityReferralEntityFactory extends BaseFactory<BpjsOutsideFacilityReferralEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public BpjsOutsideFacilityReferralEntityFactory(
		...
		super(
				...
				BpjsOutsideFacilityReferralEntity.class,
				injector
		);
