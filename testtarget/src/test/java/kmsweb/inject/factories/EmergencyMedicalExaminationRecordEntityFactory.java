...
public class EmergencyMedicalExaminationRecordEntityFactory extends BaseFactory<EmergencyMedicalExaminationRecordEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public EmergencyMedicalExaminationRecordEntityFactory(
		...
		super(
				...
				EmergencyMedicalExaminationRecordEntity.class,
				injector
		);
