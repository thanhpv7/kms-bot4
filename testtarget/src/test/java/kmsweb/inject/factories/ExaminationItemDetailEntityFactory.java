...
public class ExaminationItemDetailEntityFactory extends BaseFactory<ExaminationItemDetailEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public ExaminationItemDetailEntityFactory(
		...
		super(
				...
				ExaminationItemDetailEntity.class,
				injector
		);
