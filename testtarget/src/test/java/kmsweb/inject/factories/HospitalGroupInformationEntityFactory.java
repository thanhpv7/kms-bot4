...
public class HospitalGroupInformationEntityFactory extends BaseFactory<HospitalGroupInformationEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public HospitalGroupInformationEntityFactory(
		...
		super(
				...
				HospitalGroupInformationEntity.class,
				injector
		);
