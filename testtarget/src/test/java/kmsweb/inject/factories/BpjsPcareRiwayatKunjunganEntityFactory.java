...
public class BpjsPcareRiwayatKunjunganEntityFactory extends BaseFactory<BpjsPcareRiwayatKunjunganEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public BpjsPcareRiwayatKunjunganEntityFactory(
		...
		super(
				...
				BpjsPcareRiwayatKunjunganEntity.class,
				injector
		);
