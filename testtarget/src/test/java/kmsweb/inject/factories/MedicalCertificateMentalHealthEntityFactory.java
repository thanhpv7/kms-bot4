...
public class MedicalCertificateMentalHealthEntityFactory extends BaseFactory<MedicalCertificateMentalHealthEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public MedicalCertificateMentalHealthEntityFactory(
		...
		super(
				...
				MedicalCertificateMentalHealthEntity.class,
				injector
		);
