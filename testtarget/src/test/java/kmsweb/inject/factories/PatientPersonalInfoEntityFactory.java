...
public class PatientPersonalInfoEntityFactory extends BaseFactory<PatientPersonalInfoEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public PatientPersonalInfoEntityFactory(
		...
		super(
				...
				PatientPersonalInfoEntity.class,
				injector
		);
