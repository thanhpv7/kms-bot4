...
public class PatientVisitPatientPaymentInsuranceEntityFactory extends BaseFactory<PatientVisitPatientPaymentInsuranceEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public PatientVisitPatientPaymentInsuranceEntityFactory(
		...
		super(
				...
				PatientVisitPatientPaymentInsuranceEntity.class,
				injector
		);
