...
public class BpjsDismissalConditionEntityFactory extends BaseFactory<BpjsDismissalConditionEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public BpjsDismissalConditionEntityFactory(
		...
		super(
				...
				BpjsDismissalConditionEntity.class,
				injector
		);
