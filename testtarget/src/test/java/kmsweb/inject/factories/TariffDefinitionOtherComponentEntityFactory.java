...
public class TariffDefinitionOtherComponentEntityFactory extends BaseFactory<TariffDefinitionOtherComponentEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public TariffDefinitionOtherComponentEntityFactory(
		...
		super(
				...
				TariffDefinitionOtherComponentEntity.class,
				injector
		);
