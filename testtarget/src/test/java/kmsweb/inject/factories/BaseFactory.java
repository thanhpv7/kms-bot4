 ...
 */
package kmsweb.inject.factories;
...
public class BaseFactory<E extends AbstractEntity> {
	...
	public Collection<E> createMultipleWithNoRef(int size) {
		...
		// % protected region % [Apply any additional logic for createMultipleWithNoRef before the main body here] off begin
		// % protected region % [Apply any additional logic for createMultipleWithNoRef before the main body here] end
		...
		// % protected region % [Apply any additional logic for createMultipleWithNoRef after the main body here] off begin
		// % protected region % [Apply any additional logic for createMultipleWithNoRef after the main body here] end
	...
	public E createWithRefs() {
		...
		// % protected region % [Apply any additional logic for createWithRefs before the main body here] off begin
		// % protected region % [Apply any additional logic for createWithRefs before the main body here] end
		...
		// % protected region % [Apply any additional logic for createWithRefs after the main body here] off begin
		// % protected region % [Apply any additional logic for createWithRefs after the main body here] end
	...
	public Collection<E> createMultipleWithRefs(int size) {
		...
		// % protected region % [Apply any additional logic for createMultipleWithRefs before the main body here] off begin
		// % protected region % [Apply any additional logic for createMultipleWithRefs before the main body here] end

		Collection<E> newEntities = IntStream.range(0, size).mapToObj((i) -> {
			E newEntity = createWithRefs();

			// % protected region % [Add any additional logic for createMultipleWithRefs before the returning the new entity here] off begin
			// % protected region % [Add any additional logic for createMultipleWithRefs before the returning the new entity here] end

			return newEntity;
		}).collect(Collectors.toSet());

		// % protected region % [Apply any additional logic for createMultipleWithRefs after the main body here] off begin
		// % protected region % [Apply any additional logic for createMultipleWithRefs after the main body here] end
