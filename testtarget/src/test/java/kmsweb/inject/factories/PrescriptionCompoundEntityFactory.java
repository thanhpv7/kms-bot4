...
public class PrescriptionCompoundEntityFactory extends BaseFactory<PrescriptionCompoundEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public PrescriptionCompoundEntityFactory(
		...
		super(
				...
				PrescriptionCompoundEntity.class,
				injector
		);
