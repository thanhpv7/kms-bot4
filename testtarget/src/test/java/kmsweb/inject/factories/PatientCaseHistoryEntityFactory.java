...
public class PatientCaseHistoryEntityFactory extends BaseFactory<PatientCaseHistoryEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public PatientCaseHistoryEntityFactory(
		...
		super(
				...
				PatientCaseHistoryEntity.class,
				injector
		);
