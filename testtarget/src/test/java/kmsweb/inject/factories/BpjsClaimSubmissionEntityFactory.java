...
public class BpjsClaimSubmissionEntityFactory extends BaseFactory<BpjsClaimSubmissionEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public BpjsClaimSubmissionEntityFactory(
		...
		super(
				...
				BpjsClaimSubmissionEntity.class,
				injector
		);
