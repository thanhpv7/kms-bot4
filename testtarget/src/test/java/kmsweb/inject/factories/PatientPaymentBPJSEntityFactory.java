...
public class PatientPaymentBPJSEntityFactory extends BaseFactory<PatientPaymentBPJSEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public PatientPaymentBPJSEntityFactory(
		...
		super(
				...
				PatientPaymentBPJSEntity.class,
				injector
		);
