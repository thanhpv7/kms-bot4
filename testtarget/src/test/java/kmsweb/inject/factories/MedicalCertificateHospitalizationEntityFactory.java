...
public class MedicalCertificateHospitalizationEntityFactory extends BaseFactory<MedicalCertificateHospitalizationEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public MedicalCertificateHospitalizationEntityFactory(
		...
		super(
				...
				MedicalCertificateHospitalizationEntity.class,
				injector
		);
