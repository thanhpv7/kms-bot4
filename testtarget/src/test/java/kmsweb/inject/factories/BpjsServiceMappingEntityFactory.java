...
public class BpjsServiceMappingEntityFactory extends BaseFactory<BpjsServiceMappingEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public BpjsServiceMappingEntityFactory(
		...
		super(
				...
				BpjsServiceMappingEntity.class,
				injector
		);
