...
public class MerchantSurchargeAndFeeEntityFactory extends BaseFactory<MerchantSurchargeAndFeeEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public MerchantSurchargeAndFeeEntityFactory(
		...
		super(
				...
				MerchantSurchargeAndFeeEntity.class,
				injector
		);
