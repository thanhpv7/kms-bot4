...
public class InventoryBatchCorrectionEntityFactory extends BaseFactory<InventoryBatchCorrectionEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public InventoryBatchCorrectionEntityFactory(
		...
		super(
				...
				InventoryBatchCorrectionEntity.class,
				injector
		);
