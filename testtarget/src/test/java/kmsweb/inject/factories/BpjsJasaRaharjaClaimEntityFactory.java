...
public class BpjsJasaRaharjaClaimEntityFactory extends BaseFactory<BpjsJasaRaharjaClaimEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public BpjsJasaRaharjaClaimEntityFactory(
		...
		super(
				...
				BpjsJasaRaharjaClaimEntity.class,
				injector
		);
