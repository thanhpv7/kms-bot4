...
public class PostOperativeDetailsEntityFactory extends BaseFactory<PostOperativeDetailsEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public PostOperativeDetailsEntityFactory(
		...
		super(
				...
				PostOperativeDetailsEntity.class,
				injector
		);
