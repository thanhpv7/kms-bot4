...
public class BpjsAccidentMasterEntityFactory extends BaseFactory<BpjsAccidentMasterEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public BpjsAccidentMasterEntityFactory(
		...
		super(
				...
				BpjsAccidentMasterEntity.class,
				injector
		);
