...
public class InpatientMedicalExaminationRecordEntityFactory extends BaseFactory<InpatientMedicalExaminationRecordEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public InpatientMedicalExaminationRecordEntityFactory(
		...
		super(
				...
				InpatientMedicalExaminationRecordEntity.class,
				injector
		);
