...
public class DiagnosticExaminationResultsEntityFactory extends BaseFactory<DiagnosticExaminationResultsEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public DiagnosticExaminationResultsEntityFactory(
		...
		super(
				...
				DiagnosticExaminationResultsEntity.class,
				injector
		);
