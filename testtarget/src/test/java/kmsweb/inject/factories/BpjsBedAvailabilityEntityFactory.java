...
public class BpjsBedAvailabilityEntityFactory extends BaseFactory<BpjsBedAvailabilityEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public BpjsBedAvailabilityEntityFactory(
		...
		super(
				...
				BpjsBedAvailabilityEntity.class,
				injector
		);
