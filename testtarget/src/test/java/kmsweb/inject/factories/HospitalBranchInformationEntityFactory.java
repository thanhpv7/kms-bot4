...
public class HospitalBranchInformationEntityFactory extends BaseFactory<HospitalBranchInformationEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public HospitalBranchInformationEntityFactory(
		...
		super(
				...
				HospitalBranchInformationEntity.class,
				injector
		);
