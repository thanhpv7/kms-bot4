...
public class MedicalCertificateDischargeResumeEntityFactory extends BaseFactory<MedicalCertificateDischargeResumeEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public MedicalCertificateDischargeResumeEntityFactory(
		...
		super(
				...
				MedicalCertificateDischargeResumeEntity.class,
				injector
		);
