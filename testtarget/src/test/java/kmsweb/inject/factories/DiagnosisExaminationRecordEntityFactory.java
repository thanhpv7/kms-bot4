...
public class DiagnosisExaminationRecordEntityFactory extends BaseFactory<DiagnosisExaminationRecordEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public DiagnosisExaminationRecordEntityFactory(
		...
		super(
				...
				DiagnosisExaminationRecordEntity.class,
				injector
		);
