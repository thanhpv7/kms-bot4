...
public class ChartOfAccountMappingEntityFactory extends BaseFactory<ChartOfAccountMappingEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public ChartOfAccountMappingEntityFactory(
		...
		super(
				...
				ChartOfAccountMappingEntity.class,
				injector
		);
