...
public class BpjsPcarePesertaKegiatanKelompokEntityFactory extends BaseFactory<BpjsPcarePesertaKegiatanKelompokEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public BpjsPcarePesertaKegiatanKelompokEntityFactory(
		...
		super(
				...
				BpjsPcarePesertaKegiatanKelompokEntity.class,
				injector
		);
