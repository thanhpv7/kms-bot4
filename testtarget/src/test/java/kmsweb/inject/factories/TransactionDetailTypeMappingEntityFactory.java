...
public class TransactionDetailTypeMappingEntityFactory extends BaseFactory<TransactionDetailTypeMappingEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public TransactionDetailTypeMappingEntityFactory(
		...
		super(
				...
				TransactionDetailTypeMappingEntity.class,
				injector
		);
