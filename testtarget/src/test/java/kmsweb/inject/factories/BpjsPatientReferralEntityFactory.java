...
public class BpjsPatientReferralEntityFactory extends BaseFactory<BpjsPatientReferralEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public BpjsPatientReferralEntityFactory(
		...
		super(
				...
				BpjsPatientReferralEntity.class,
				injector
		);
