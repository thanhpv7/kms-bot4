...
public class InsuranceBenefitPlanEntityFactory extends BaseFactory<InsuranceBenefitPlanEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public InsuranceBenefitPlanEntityFactory(
		...
		super(
				...
				InsuranceBenefitPlanEntity.class,
				injector
		);
