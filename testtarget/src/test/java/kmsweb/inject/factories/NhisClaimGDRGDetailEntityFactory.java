...
public class NhisClaimGDRGDetailEntityFactory extends BaseFactory<NhisClaimGDRGDetailEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public NhisClaimGDRGDetailEntityFactory(
		...
		super(
				...
				NhisClaimGDRGDetailEntity.class,
				injector
		);
