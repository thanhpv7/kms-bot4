...
public class MedicalCertificateSickLeaveEntityFactory extends BaseFactory<MedicalCertificateSickLeaveEntity> {

	// % protected region % [Apply any additional class fields here] off begin
	// % protected region % [Apply any additional class fields here] end

	public MedicalCertificateSickLeaveEntityFactory(
		...
		super(
				...
				MedicalCertificateSickLeaveEntity.class,
				injector
		);
