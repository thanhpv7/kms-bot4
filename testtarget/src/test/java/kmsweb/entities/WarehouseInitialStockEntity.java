...
public class WarehouseInitialStockEntity extends AbstractEntity {
	...
	public WarehouseInitialStockEntity() {
	...
	private void initialiseReferences() {
		...
		var LocationOneMany = new EntityReference();
			LocationOneMany.entityName = "Location";
			LocationOneMany.oppositeName = "Location";
			LocationOneMany.name = "WarehouseInitialStockS";
			LocationOneMany.optional = true;
			LocationOneMany.type = "One";
			LocationOneMany.oppositeType = "Many";

		References.add(LocationOneMany);
		...
		var StockCatalogueOneMany = new EntityReference();
			...
			StockCatalogueOneMany.name = "WarehouseInitialStockS";
		...
		var WarehouseOneMany = new EntityReference();
			...
			WarehouseOneMany.name = "WarehouseInitialStockS";
	 ...
	 */
	public void setLocation(@NonNull LocationEntity entity) {
	 ...
	 */
	public void setLocation(@NonNull LocationEntity entity, boolean reverseAdd) {
