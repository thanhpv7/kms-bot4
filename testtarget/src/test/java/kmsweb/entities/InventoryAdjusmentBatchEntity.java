...
public class InventoryAdjusmentBatchEntity extends AbstractEntity {
	...
	public InventoryAdjusmentBatchEntity() {
	...
	private void initialiseReferences() {
		...
		var InventoryAdjustmentItemOneMany = new EntityReference();
			InventoryAdjustmentItemOneMany.entityName = "InventoryAdjustmentItem";
			InventoryAdjustmentItemOneMany.oppositeName = "InventoryAdjustmentItem";
			InventoryAdjustmentItemOneMany.name = "InventoryAdjusmentBatchs";
			InventoryAdjustmentItemOneMany.optional = true;
			InventoryAdjustmentItemOneMany.type = "One";
			InventoryAdjustmentItemOneMany.oppositeType = "Many";

		References.add(InventoryAdjustmentItemOneMany);
		...
		var StockCatalogueOneMany = new EntityReference();
			...
			StockCatalogueOneMany.name = "InventoryAdjusmentBatchs";
		...
		var WarehouseOneMany = new EntityReference();
			...
			WarehouseOneMany.name = "InventoryAdjusmentBatchs";
	 ...
	 */
	public void setInventoryAdjustmentItem(@NonNull InventoryAdjustmentItemEntity entity) {
	 ...
	 */
	public void setInventoryAdjustmentItem(@NonNull InventoryAdjustmentItemEntity entity, boolean reverseAdd) {
