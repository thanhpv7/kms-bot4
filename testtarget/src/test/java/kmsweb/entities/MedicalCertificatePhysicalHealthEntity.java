...
public class MedicalCertificatePhysicalHealthEntity extends AbstractEntity {
	...
	public MedicalCertificatePhysicalHealthEntity() {
	...
	private void initialiseReferences() {
		...
		var RegistrationOneOne = new EntityReference();
			...
			RegistrationOneOne.name = "MedicalCertificatePhysicalHealth";
		...
		var MedicalStaffOneMany = new EntityReference();
			...
			MedicalStaffOneMany.name = "MedicalStaffOfPhysicalHealths";
