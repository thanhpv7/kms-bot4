...
public class WarehouseInventoryEntity extends AbstractEntity {
	...
	public WarehouseInventoryEntity() {
	...
	private void initialiseReferences() {
		...
		var LocationOneMany = new EntityReference();
			...
			LocationOneMany.name = "WarehouseInventories";
		...
		var StockCatalogueOneMany = new EntityReference();
			...
			StockCatalogueOneMany.name = "WarehouseInventories";
		...
		var WarehouseOneMany = new EntityReference();
			...
			WarehouseOneMany.name = "WarehouseInventories";
