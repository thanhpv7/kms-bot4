...
public class MedicalCertificateSickLeaveEntity extends AbstractEntity {
	...
	public MedicalCertificateSickLeaveEntity() {
	...
	private void initialiseReferences() {
		...
		var RegistrationOneOne = new EntityReference();
			...
			RegistrationOneOne.name = "MedicalCertificateSickLeave";
		...
		var MedicalStaffOneMany = new EntityReference();
			...
			MedicalStaffOneMany.name = "MedicalStaffOfSickLeavesCertificate";
