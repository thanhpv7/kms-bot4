...
public class StockTransactionDetailEntity extends AbstractEntity {
	...
	public StockTransactionDetailEntity() {
	...
	private void initialiseReferences() {
		...
		var StockCatalogueOneMany = new EntityReference();
			...
			StockCatalogueOneMany.name = "StockTransactionDetails";
		...
		var TransactionDetailTypeOneMany = new EntityReference();
			...
			TransactionDetailTypeOneMany.name = "StockTransactionDetails";
		...
		var WarehouseOneMany = new EntityReference();
			...
			WarehouseOneMany.name = "StockTransactionDetails";
