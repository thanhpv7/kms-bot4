...
public class MedicalCertificateMedicalAttendanceEntity extends AbstractEntity {
	...
	public MedicalCertificateMedicalAttendanceEntity() {
	...
	private void initialiseReferences() {
		...
		var RegistrationOneOne = new EntityReference();
			...
			RegistrationOneOne.name = "MedicalCertificateMedicalAttendance";
		...
		var MedicalStaffOneMany = new EntityReference();
			...
			MedicalStaffOneMany.name = "MedicalStaffOfMedicalAttendancesCertificate";
