...
public class MedicalCertificateHospitalizationEntity extends AbstractEntity {
	...
	public MedicalCertificateHospitalizationEntity() {
	...
	private void initialiseReferences() {
		...
		var RegistrationOneOne = new EntityReference();
			...
			RegistrationOneOne.name = "MedicalCertificateHospitalization";
		...
		var MedicalStaffOneMany = new EntityReference();
			...
			MedicalStaffOneMany.name = "MedicalCertificateHospitalizations";
