...
public class MedicalCertificateRestrictedWorkEntity extends AbstractEntity {
	...
	public MedicalCertificateRestrictedWorkEntity() {
	...
	private void initialiseReferences() {
		...
		var RegistrationOneOne = new EntityReference();
			...
			RegistrationOneOne.name = "MedicalCertificateRestrictedWork";
		...
		var MedicalStaffOneMany = new EntityReference();
			...
			MedicalStaffOneMany.name = "MedicalStaffOfRestrictedWorksCertificate";
