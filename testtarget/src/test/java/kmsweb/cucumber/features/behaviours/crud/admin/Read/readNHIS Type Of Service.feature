...
@botwritten
@crud @read @nhisTypeOfService
Feature: Read NHIS Type Of Service as admin user
	Scenario: Read NHIS Type Of Service as admin user
		...
		When I login with username "administrator@example.com" with password "password"
			...
			And I "view" an existing "NhisTypeOfService"