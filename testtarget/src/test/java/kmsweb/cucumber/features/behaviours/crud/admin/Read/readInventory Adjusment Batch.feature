...
@botwritten
@crud @read @inventoryAdjusmentBatch
Feature: Read Inventory Adjusment Batch as admin user
	Scenario: Read Inventory Adjusment Batch as admin user
		...
		When I login with username "administrator@example.com" with password "password"
			...
			And I "view" an existing "InventoryAdjusmentBatch"