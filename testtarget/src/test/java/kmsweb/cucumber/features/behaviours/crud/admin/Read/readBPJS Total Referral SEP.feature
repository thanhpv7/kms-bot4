...
@botwritten
@crud @read @bpjsTotalReferralSEP
Feature: Read BPJS Total Referral SEP as admin user
	Scenario: Read BPJS Total Referral SEP as admin user
		...
		When I login with username "administrator@example.com" with password "password"
			...
			And I "view" an existing "BpjsTotalReferralSEP"