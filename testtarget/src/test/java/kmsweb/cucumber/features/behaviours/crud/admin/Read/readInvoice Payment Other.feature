...
@botwritten
@crud @read @invoicePaymentOther
Feature: Read Invoice Payment Other as admin user
	Scenario: Read Invoice Payment Other as admin user
		...
		When I login with username "administrator@example.com" with password "password"
			...
			And I "view" an existing "InvoicePaymentOther"