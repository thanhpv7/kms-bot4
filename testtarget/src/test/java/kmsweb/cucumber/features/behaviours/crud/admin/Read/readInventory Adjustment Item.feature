...
@botwritten
@crud @read @inventoryAdjustmentItem
Feature: Read Inventory Adjustment Item as admin user
	Scenario: Read Inventory Adjustment Item as admin user
		...
		When I login with username "administrator@example.com" with password "password"
			...
			And I "view" an existing "InventoryAdjustmentItem"