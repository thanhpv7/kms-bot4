...
@botwritten
@crud @read @bpjsPcareRegistrations
Feature: Read BPJS Pcare Registrations as admin user
	Scenario: Read BPJS Pcare Registrations as admin user
		...
		When I login with username "administrator@example.com" with password "password"
			...
			And I "view" an existing "BpjsPcareRegistrations"