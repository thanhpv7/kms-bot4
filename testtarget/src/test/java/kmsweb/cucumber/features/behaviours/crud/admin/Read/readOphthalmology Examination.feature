...
@botwritten
@crud @read @ophthalmologyExamination
Feature: Read Ophthalmology Examination as admin user
	Scenario: Read Ophthalmology Examination as admin user
		...
		When I login with username "administrator@example.com" with password "password"
			...
			And I "view" an existing "OphthalmologyExamination"