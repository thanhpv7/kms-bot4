...
@botwritten
@crud @read @fluidBalanceDetail
Feature: Read Fluid Balance Detail as admin user
	Scenario: Read Fluid Balance Detail as admin user
		...
		When I login with username "administrator@example.com" with password "password"
			...
			And I "view" an existing "FluidBalanceDetail"