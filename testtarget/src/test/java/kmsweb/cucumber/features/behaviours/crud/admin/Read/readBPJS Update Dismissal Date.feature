...
@botwritten
@crud @read @bpjsUpdateDismissalDate
Feature: Read BPJS Update Dismissal Date as admin user
	Scenario: Read BPJS Update Dismissal Date as admin user
		...
		When I login with username "administrator@example.com" with password "password"
			...
			And I "view" an existing "BpjsUpdateDismissalDate"