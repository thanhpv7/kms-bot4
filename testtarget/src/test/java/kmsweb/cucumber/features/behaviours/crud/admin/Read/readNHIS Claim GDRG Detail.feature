...
@botwritten
@crud @read @nhisClaimGDRGDetail
Feature: Read NHIS Claim GDRG Detail as admin user
	Scenario: Read NHIS Claim GDRG Detail as admin user
		...
		When I login with username "administrator@example.com" with password "password"
			...
			And I "view" an existing "NhisClaimGDRGDetail"