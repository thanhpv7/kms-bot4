...
@botwritten
@crud @read @amendmentDetail
Feature: Read Amendment Detail as admin user
	Scenario: Read Amendment Detail as admin user
		...
		When I login with username "administrator@example.com" with password "password"
			...
			And I "view" an existing "AmendmentDetail"