...
@botwritten
@crud @read @nhisInvestigation
Feature: Read NHIS Investigation as admin user
	Scenario: Read NHIS Investigation as admin user
		...
		When I login with username "administrator@example.com" with password "password"
			...
			And I "view" an existing "NhisInvestigation"