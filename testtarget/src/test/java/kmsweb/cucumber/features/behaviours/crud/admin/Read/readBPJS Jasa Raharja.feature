...
@botwritten
@crud @read @bpjsJasaRaharja
Feature: Read BPJS Jasa Raharja as admin user
	Scenario: Read BPJS Jasa Raharja as admin user
		...
		When I login with username "administrator@example.com" with password "password"
			...
			And I "view" an existing "BpjsJasaRaharja"