...
@botwritten
@crud @read @patientCaseHistory
Feature: Read Patient Case History as admin user
	Scenario: Read Patient Case History as admin user
		...
		When I login with username "administrator@example.com" with password "password"
			...
			And I "view" an existing "PatientCaseHistory"