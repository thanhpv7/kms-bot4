...
@botwritten
@crud @read @diagnosesAndProcedures
Feature: Read Diagnoses and Procedures as admin user
	Scenario: Read Diagnoses and Procedures as admin user
		...
		When I login with username "administrator@example.com" with password "password"
			...
			And I "view" an existing "DiagnosesAndProcedures"