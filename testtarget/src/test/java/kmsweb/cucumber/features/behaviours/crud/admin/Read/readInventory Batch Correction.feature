...
@botwritten
@crud @read @inventoryBatchCorrection
Feature: Read Inventory Batch Correction as admin user
	Scenario: Read Inventory Batch Correction as admin user
		...
		When I login with username "administrator@example.com" with password "password"
			...
			And I "view" an existing "InventoryBatchCorrection"