...
@botwritten
@crud @read @satuSehatConfiguration
Feature: Read Satu Sehat Configuration as admin user
	Scenario: Read Satu Sehat Configuration as admin user
		...
		When I login with username "administrator@example.com" with password "password"
			...
			And I "view" an existing "SatuSehatConfiguration"