...
@botwritten
@crud @read @examinationItemDetail
Feature: Read Examination Item Detail as admin user
	Scenario: Read Examination Item Detail as admin user
		...
		When I login with username "administrator@example.com" with password "password"
			...
			And I "view" an existing "ExaminationItemDetail"