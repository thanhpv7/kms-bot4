...
@botwritten
@crud @read @bpjsSpecialReferral
Feature: Read BPJS Special Referral as admin user
	Scenario: Read BPJS Special Referral as admin user
		...
		When I login with username "administrator@example.com" with password "password"
			...
			And I "view" an existing "BpjsSpecialReferral"