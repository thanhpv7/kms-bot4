...
@botwritten
@crud @read @bpjsTreatmentHistory
Feature: Read BPJS Treatment History as admin user
	Scenario: Read BPJS Treatment History as admin user
		...
		When I login with username "administrator@example.com" with password "password"
			...
			And I "view" an existing "BpjsTreatmentHistory"