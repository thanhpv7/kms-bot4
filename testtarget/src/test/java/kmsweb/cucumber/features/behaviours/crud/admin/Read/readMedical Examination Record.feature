...
@botwritten
@crud @read @medicalExaminationRecord
Feature: Read Medical Examination Record as admin user
	Scenario: Read Medical Examination Record as admin user
		...
		When I login with username "administrator@example.com" with password "password"
			...
			And I "view" an existing "MedicalExaminationRecord"