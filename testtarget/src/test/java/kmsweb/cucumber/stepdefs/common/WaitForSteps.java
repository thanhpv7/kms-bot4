...
public class WaitForSteps extends AbstractStepDef {
	...
	@Then("I wait for the site url to be {string}")
	public void wait_for_url_in_site(String url) throws Exception {
		WaitUtils.waitForUrl(webDriver, properties.get("selenium.url") + "/" + url);
	}
