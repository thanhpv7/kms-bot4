...
/**
 * BPJS Visit DataPage is a Page POM that is associated with the admin/entities/bpjs-visit-data url.
 *
 */
@Slf4j
@ScenarioScoped
public class AdminEntitiesBpjsVisitDataCrudEditPage extends CrudEdit {
	...
	@FindBy(how = How.XPATH, using = "//*[@id='sepDismissalDate-field']")
	private WebElement sepDismissalDateField;
	...
	@Inject
	public AdminEntitiesBpjsVisitDataCrudEditPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/bpjs-visit-data/create"
		);
	...
	{
		var entity = (BpjsVisitDataEntity) abstractEntity;
		...
		sepDismissalDateField.sendKeys(entity.getSepDismissalDate());
