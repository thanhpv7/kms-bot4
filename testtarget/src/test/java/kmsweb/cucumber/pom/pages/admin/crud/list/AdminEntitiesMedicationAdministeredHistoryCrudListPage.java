...
@Slf4j
@ScenarioScoped
public class AdminEntitiesMedicationAdministeredHistoryCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesMedicationAdministeredHistoryCrudListPage(
		...
		super(
			...
			"admin/entities/medication-administered-history"
		);
