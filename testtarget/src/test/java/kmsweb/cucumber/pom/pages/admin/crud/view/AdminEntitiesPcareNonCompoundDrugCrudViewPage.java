...
@Slf4j
@ScenarioScoped
public class AdminEntitiesPcareNonCompoundDrugCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesPcareNonCompoundDrugCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/pcare-noncompound-drug/view"
		);
