...
/**
 * BPJS Patient ReferralPage is a Page POM that is associated with the admin/entities/bpjs-patient-referral url.
 *
 */
@Slf4j
@ScenarioScoped
public class AdminEntitiesBpjsPatientReferralCrudEditPage extends CrudEdit {
	...
	@FindBy(how = How.XPATH, using = "//*[@id='referredType-field']")
	private WebElement referredTypeField;
	// TODO default handling dataAttribute referralDateField;
	@FindBy(how = How.XPATH, using = "//*[@id='referralDate-field']")
	private WebElement referralDateField;
	// TODO default handling dataAttribute referalDatePlanField;
	@FindBy(how = How.XPATH, using = "//*[@id='referalDatePlan-field']")
	private WebElement referalDatePlanField;
	...
	@Inject
	public AdminEntitiesBpjsPatientReferralCrudEditPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/bpjs-patient-referral/create"
		);
	...
	{
		var entity = (BpjsPatientReferralEntity) abstractEntity;
		noSEPField.sendKeys(entity.getNoSEP());
		referralNoField.sendKeys(entity.getReferralNo());
		referredTypeField.sendKeys(entity.getReferredType());
		// TODO default handling for dataAttribute referralDateField
		referralDateField.sendKeys(entity.getReferralDate().toString());

		// TODO default handling for dataAttribute referalDatePlanField
		referalDatePlanField.sendKeys(entity.getReferalDatePlan().toString());
