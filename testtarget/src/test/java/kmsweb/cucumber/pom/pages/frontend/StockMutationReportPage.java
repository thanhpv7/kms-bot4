...
/**
 * Stock Mutation Report is a Page POM associated with the 'stock-mutation-report' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class StockMutationReportPage extends AbstractPage {
	...
	@Inject
	public StockMutationReportPage(
