...
/**
 * Patient Invoice is a Page POM associated with the 'patient-invoice' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class PatientInvoicePage extends AbstractPage {
