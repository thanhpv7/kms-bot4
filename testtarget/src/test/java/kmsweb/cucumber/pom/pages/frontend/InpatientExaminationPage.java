...
/**
 * Inpatient Examination is a Page POM associated with the 'inpatient-examination' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class InpatientExaminationPage extends AbstractPage {
	...
	@Inject
	public InpatientExaminationPage(
