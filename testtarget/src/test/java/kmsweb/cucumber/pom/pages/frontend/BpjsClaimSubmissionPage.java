...
/**
 * BPJS Claim Submission is a Page POM associated with the 'bpjs-claim-submission' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class BpjsClaimSubmissionPage extends AbstractPage {
	...
	@Inject
	public BpjsClaimSubmissionPage(
