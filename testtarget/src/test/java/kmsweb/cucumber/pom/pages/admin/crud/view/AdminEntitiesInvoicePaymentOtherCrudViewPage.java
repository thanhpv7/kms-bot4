...
@Slf4j
@ScenarioScoped
public class AdminEntitiesInvoicePaymentOtherCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesInvoicePaymentOtherCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/invoice-payment-other/view"
		);
