...
/**
 * Referral Activity Report is a Page POM associated with the 'referral-activity-report' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class ReferralActivityReportPage extends AbstractPage {
	...
	@Inject
	public ReferralActivityReportPage(
