...
@Slf4j
@ScenarioScoped
public class AdminEntitiesDiagnosisExaminationRecordCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesDiagnosisExaminationRecordCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/diagnosis-examination-record/view"
		);
