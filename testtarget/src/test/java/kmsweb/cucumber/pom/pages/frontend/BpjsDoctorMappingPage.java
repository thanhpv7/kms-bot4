...
/**
 * BPJS Doctor Mapping is a Page POM associated with the 'bpjs-doctor-mapping' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class BpjsDoctorMappingPage extends AbstractPage {
