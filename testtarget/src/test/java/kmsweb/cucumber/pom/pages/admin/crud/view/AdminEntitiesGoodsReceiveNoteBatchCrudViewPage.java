...
@Slf4j
@ScenarioScoped
public class AdminEntitiesGoodsReceiveNoteBatchCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesGoodsReceiveNoteBatchCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/goods-receive-note-batch/view"
		);
