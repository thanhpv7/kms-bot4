...
@Slf4j
@ScenarioScoped
public class AdminEntitiesMedicalCertificatePhysicalHealthCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesMedicalCertificatePhysicalHealthCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/medical-certificate-physical-health/view"
		);
