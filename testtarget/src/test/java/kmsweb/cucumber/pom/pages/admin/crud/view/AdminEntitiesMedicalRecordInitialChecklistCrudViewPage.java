...
@Slf4j
@ScenarioScoped
public class AdminEntitiesMedicalRecordInitialChecklistCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesMedicalRecordInitialChecklistCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/medical-record-initial-checklist/view"
		);
