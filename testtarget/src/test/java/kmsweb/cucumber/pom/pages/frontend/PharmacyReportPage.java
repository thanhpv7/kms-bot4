...
/**
 * Pharmacy Report is a Page POM associated with the 'pharmacy-report' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class PharmacyReportPage extends AbstractPage {
