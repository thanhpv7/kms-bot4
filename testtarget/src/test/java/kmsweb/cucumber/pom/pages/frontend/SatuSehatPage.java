...
/**
 * Satu Sehat is a Page POM associated with the 'satu-sehat' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class SatuSehatPage extends AbstractPage {
