...
@Slf4j
@ScenarioScoped
public class AdminEntitiesPreoperativeRecordsCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesPreoperativeRecordsCrudListPage(
		...
		super(
			...
			"admin/entities/preoperative-records"
		);
