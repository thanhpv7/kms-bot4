...
@Slf4j
@ScenarioScoped
public class AdminEntitiesStockTransactionPerDateTypeCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesStockTransactionPerDateTypeCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/stock-transaction-per-date-type/view"
		);
