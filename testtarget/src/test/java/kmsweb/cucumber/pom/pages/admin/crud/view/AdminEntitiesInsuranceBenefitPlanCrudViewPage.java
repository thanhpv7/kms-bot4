...
@Slf4j
@ScenarioScoped
public class AdminEntitiesInsuranceBenefitPlanCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesInsuranceBenefitPlanCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/insurance-benefit-plan/view"
		);
