...
@Slf4j
@ScenarioScoped
public class AdminEntitiesBpjsControlSpecialistCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesBpjsControlSpecialistCrudListPage(
		...
		super(
			...
			"admin/entities/bpjs-control-specialist"
		);
