...
@Slf4j
@ScenarioScoped
public class AdminEntitiesBpjsPcarePendaftaranCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesBpjsPcarePendaftaranCrudListPage(
		...
		super(
			...
			"admin/entities/bpjs-pcare-pendaftaran"
		);
