...
@Slf4j
@ScenarioScoped
public class AdminEntitiesBpjsPcareRegistrationsCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesBpjsPcareRegistrationsCrudListPage(
		...
		super(
			...
			"admin/entities/bpjs-pcare-registrations"
		);
