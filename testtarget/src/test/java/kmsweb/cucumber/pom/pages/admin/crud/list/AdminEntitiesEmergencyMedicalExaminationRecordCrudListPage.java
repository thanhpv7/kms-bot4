...
@Slf4j
@ScenarioScoped
public class AdminEntitiesEmergencyMedicalExaminationRecordCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesEmergencyMedicalExaminationRecordCrudListPage(
		...
		super(
			...
			"admin/entities/emergency-medical-examination-record"
		);
