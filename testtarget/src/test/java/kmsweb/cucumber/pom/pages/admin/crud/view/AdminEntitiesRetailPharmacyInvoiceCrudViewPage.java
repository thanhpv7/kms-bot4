...
@Slf4j
@ScenarioScoped
public class AdminEntitiesRetailPharmacyInvoiceCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesRetailPharmacyInvoiceCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/retail-pharmacy-invoice/view"
		);
