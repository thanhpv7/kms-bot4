...
@Slf4j
@ScenarioScoped
public class AdminEntitiesRetailPharmacyInvoiceCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesRetailPharmacyInvoiceCrudListPage(
		...
		super(
			...
			"admin/entities/retail-pharmacy-invoice"
		);
