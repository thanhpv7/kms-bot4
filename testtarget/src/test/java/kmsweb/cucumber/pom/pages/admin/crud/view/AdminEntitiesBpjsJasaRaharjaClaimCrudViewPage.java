...
@Slf4j
@ScenarioScoped
public class AdminEntitiesBpjsJasaRaharjaClaimCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesBpjsJasaRaharjaClaimCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/bpjs-jasa-raharja-claim/view"
		);
