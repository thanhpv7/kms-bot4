...
/**
 * Diagnostic Support is a Page POM associated with the 'diagnostic-support' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class DiagnosticSupportPage extends AbstractPage {
