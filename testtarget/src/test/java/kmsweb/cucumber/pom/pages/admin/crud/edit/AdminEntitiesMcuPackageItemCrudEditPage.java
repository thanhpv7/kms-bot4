...
/**
 * MCU Package ItemPage is a Page POM that is associated with the admin/entities/mcu-package-item url.
 *
 */
@Slf4j
@ScenarioScoped
public class AdminEntitiesMcuPackageItemCrudEditPage extends CrudEdit {
	...
	@FindBy(how = How.XPATH, using = "//ng-select[@id='mcuPackageId-field']")
	...
	@Inject
	public AdminEntitiesMcuPackageItemCrudEditPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/mcu-package-item/create"
		);
	...
	{
		var entity = (McuPackageItemEntity) abstractEntity;
