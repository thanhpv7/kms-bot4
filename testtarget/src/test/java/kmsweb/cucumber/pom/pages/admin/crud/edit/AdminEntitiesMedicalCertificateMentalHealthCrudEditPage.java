...
/**
 * Medical Certificate Mental HealthPage is a Page POM that is associated with the admin/entities/medical-certificate-mental-health url.
 *
 */
@Slf4j
@ScenarioScoped
public class AdminEntitiesMedicalCertificateMentalHealthCrudEditPage extends CrudEdit {
	...
	@Inject
	public AdminEntitiesMedicalCertificateMentalHealthCrudEditPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/medical-certificate-mental-health/create"
		);
	...
	{
		var entity = (MedicalCertificateMentalHealthEntity) abstractEntity;
