...
@Slf4j
@ScenarioScoped
public class AdminEntitiesPostOperativeDetailsCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesPostOperativeDetailsCrudListPage(
		...
		super(
			...
			"admin/entities/post-operative-details"
		);
