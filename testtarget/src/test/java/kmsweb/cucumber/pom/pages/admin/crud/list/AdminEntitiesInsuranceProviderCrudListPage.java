...
@Slf4j
@ScenarioScoped
public class AdminEntitiesInsuranceProviderCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesInsuranceProviderCrudListPage(
		...
		super(
			...
			"admin/entities/insurance-provider"
		);
