...
/**
 * Batch Correction is a Page POM associated with the 'batch-correction' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class BatchCorrectionPage extends AbstractPage {
