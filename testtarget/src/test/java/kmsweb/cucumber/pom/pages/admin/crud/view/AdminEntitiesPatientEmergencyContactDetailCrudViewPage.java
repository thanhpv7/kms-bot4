...
@Slf4j
@ScenarioScoped
public class AdminEntitiesPatientEmergencyContactDetailCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesPatientEmergencyContactDetailCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/patient-emergency-contact-detail/view"
		);
