...
@Slf4j
@ScenarioScoped
public class AdminEntitiesStockTransactionPerDateCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesStockTransactionPerDateCrudListPage(
		...
		super(
			...
			"admin/entities/stock-transaction-per-date"
		);
