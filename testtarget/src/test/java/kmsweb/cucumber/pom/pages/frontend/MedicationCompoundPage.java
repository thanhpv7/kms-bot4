...
/**
 * Medication Compound is a Page POM associated with the 'medication-compound' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class MedicationCompoundPage extends AbstractPage {
