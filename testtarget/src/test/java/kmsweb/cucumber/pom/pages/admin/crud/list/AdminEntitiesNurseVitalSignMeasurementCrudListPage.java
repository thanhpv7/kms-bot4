...
@Slf4j
@ScenarioScoped
public class AdminEntitiesNurseVitalSignMeasurementCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesNurseVitalSignMeasurementCrudListPage(
		...
		super(
			...
			"admin/entities/nurse-vital-sign-measurement"
		);
