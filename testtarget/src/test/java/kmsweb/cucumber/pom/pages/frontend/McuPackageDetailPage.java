...
/**
 * MCU Package Detail is a Page POM associated with the 'mcu-package-detail' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class McuPackageDetailPage extends AbstractPage {
