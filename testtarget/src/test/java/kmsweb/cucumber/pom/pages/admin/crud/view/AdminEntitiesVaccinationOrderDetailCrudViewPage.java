...
@Slf4j
@ScenarioScoped
public class AdminEntitiesVaccinationOrderDetailCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesVaccinationOrderDetailCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/vaccination-order-detail/view"
		);
