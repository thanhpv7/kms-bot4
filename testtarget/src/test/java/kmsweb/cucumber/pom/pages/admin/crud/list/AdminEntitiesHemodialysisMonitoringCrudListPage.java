...
@Slf4j
@ScenarioScoped
public class AdminEntitiesHemodialysisMonitoringCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesHemodialysisMonitoringCrudListPage(
		...
		super(
			...
			"admin/entities/hemodialysis-monitoring"
		);
