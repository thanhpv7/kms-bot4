...
/**
 * Personalization is a Page POM associated with the 'personalization' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class PersonalizationPage extends AbstractPage {
