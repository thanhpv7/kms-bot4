...
@Slf4j
@ScenarioScoped
public class AdminEntitiesMedicalCertificateSickLeaveCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesMedicalCertificateSickLeaveCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/medical-certificate-sick-leave/view"
		);
