...
/**
 * Stock Summary Report is a Page POM associated with the 'stock-summary-report' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class StockSummaryReportPage extends AbstractPage {
