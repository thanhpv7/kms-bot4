...
/**
 * Birth History is a Page POM associated with the 'birth-history' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class BirthHistoryPage extends AbstractPage {
