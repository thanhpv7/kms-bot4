...
@Slf4j
@ScenarioScoped
public class AdminEntitiesIntraoperativeRecordsCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesIntraoperativeRecordsCrudListPage(
		...
		super(
			...
			"admin/entities/intraoperative-records"
		);
