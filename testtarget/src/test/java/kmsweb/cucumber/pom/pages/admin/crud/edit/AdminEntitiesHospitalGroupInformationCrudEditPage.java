...
@Slf4j
@ScenarioScoped
public class AdminEntitiesHospitalGroupInformationCrudEditPage extends CrudEdit {
	...
	@Inject
	public AdminEntitiesHospitalGroupInformationCrudEditPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/hospital-group-information/create"
		);
	...
	{
		var entity = (HospitalGroupInformationEntity) abstractEntity;
		hospitalGroupCodeField.sendKeys(entity.getHospitalGroupCode());
		hospitalGroupNameField.sendKeys(entity.getHospitalGroupName());
		hospitalGroupCorporationNameField.sendKeys(entity.getHospitalGroupCorporationName());
		hospitalGroupDirectorField.sendKeys(entity.getHospitalGroupDirector());
		operationalLicenseNoField.sendKeys(entity.getOperationalLicenseNo());
		hospitalGroupCorporationStatusField.sendKeys(entity.getHospitalGroupCorporationStatus());
