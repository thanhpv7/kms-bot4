...
@Slf4j
@ScenarioScoped
public class AdminEntitiesRetailPharmacyStockDetailCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesRetailPharmacyStockDetailCrudListPage(
		...
		super(
			...
			"admin/entities/retail-pharmacy-stock-detail"
		);
