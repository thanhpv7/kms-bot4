...
@Slf4j
@ScenarioScoped
public class AdminEntitiesMedicalExaminationRecordDischargeSummaryCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesMedicalExaminationRecordDischargeSummaryCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/medical-examination-record-discharge-summary/view"
		);
