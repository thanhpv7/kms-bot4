...
/**
 * BPJS General is a Page POM associated with the 'bpjs-general' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class BpjsGeneralPage extends AbstractPage {
