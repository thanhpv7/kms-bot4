...
@Slf4j
@ScenarioScoped
public class AdminEntitiesMedicalRecordNextVerificationChecklistCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesMedicalRecordNextVerificationChecklistCrudListPage(
		...
		super(
			...
			"admin/entities/medical-record-next-verification-checklist"
		);
