...
/**
 * Tariff Package ItemPage is a Page POM that is associated with the admin/entities/tariff-package-item url.
 *
 */
@Slf4j
@ScenarioScoped
public class AdminEntitiesTariffPackageItemCrudEditPage extends CrudEdit {
	...
	@FindBy(how = How.XPATH, using = "//*[@id='tariffName-field']")
	private WebElement tariffNameField;
	...
	@FindBy(how = How.XPATH, using = "//*[@id='modifiable-field']")
	private WebElement modifiableField;
	...
	@FindBy(how = How.XPATH, using = "//ng-select[@id='tariffPackageId-field']")
	private WebElement tariffPackageField;
	...
	@Inject
	public AdminEntitiesTariffPackageItemCrudEditPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/tariff-package-item/create"
		);
	...
	{
		var entity = (TariffPackageItemEntity) abstractEntity;
		...
		tariffNameField.sendKeys(entity.getTariffName());
