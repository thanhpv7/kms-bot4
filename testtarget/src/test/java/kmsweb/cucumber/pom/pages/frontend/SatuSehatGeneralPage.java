...
/**
 * Satu Sehat General is a Page POM associated with the 'satu-sehat-general' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class SatuSehatGeneralPage extends AbstractPage {
