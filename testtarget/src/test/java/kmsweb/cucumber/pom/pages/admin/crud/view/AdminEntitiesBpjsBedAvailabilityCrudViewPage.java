...
@Slf4j
@ScenarioScoped
public class AdminEntitiesBpjsBedAvailabilityCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesBpjsBedAvailabilityCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/bpjs-bed-availability/view"
		);
