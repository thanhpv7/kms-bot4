...
/**
 * Invoice Item Report is a Page POM associated with the 'invoice-item-report' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class InvoiceItemReportPage extends AbstractPage {
