...
@Slf4j
@ScenarioScoped
public class AdminEntitiesBpjsOutsideFacilityReferralCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesBpjsOutsideFacilityReferralCrudListPage(
		...
		super(
			...
			"admin/entities/bpjs-outside-facility-referral"
		);
