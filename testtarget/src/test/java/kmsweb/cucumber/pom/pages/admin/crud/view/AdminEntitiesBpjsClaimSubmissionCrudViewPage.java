...
@Slf4j
@ScenarioScoped
public class AdminEntitiesBpjsClaimSubmissionCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesBpjsClaimSubmissionCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/bpjs-claim-submission/view"
		);
