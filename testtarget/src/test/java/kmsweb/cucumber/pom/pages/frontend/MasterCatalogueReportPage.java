...
/**
 * Master Catalogue Report is a Page POM associated with the 'master-catalogue-report' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class MasterCatalogueReportPage extends AbstractPage {
	...
	@Inject
	public MasterCatalogueReportPage(
