...
@Slf4j
@ScenarioScoped
public class AdminEntitiesPatientEmploymentDetailCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesPatientEmploymentDetailCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/patient-employment-detail/view"
		);
