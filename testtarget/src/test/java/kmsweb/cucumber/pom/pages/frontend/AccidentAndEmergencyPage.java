...
/**
 * Accident and Emergency is a Page POM associated with the 'accident-and-emergency' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class AccidentAndEmergencyPage extends AbstractPage {
	...
	@Inject
	public AccidentAndEmergencyPage(
