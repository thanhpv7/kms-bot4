...
/**
 * BPJS Diagnose is a Page POM associated with the 'bpjs-diagnose' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class BpjsDiagnosePage extends AbstractPage {
