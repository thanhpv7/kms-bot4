...
@Slf4j
@ScenarioScoped
public class AdminEntitiesExaminationItemCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesExaminationItemCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/examination-item/view"
		);
