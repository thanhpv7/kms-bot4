...
@Slf4j
@ScenarioScoped
public class AdminEntitiesRetailPharmacyStockDetailCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesRetailPharmacyStockDetailCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/retail-pharmacy-stock-detail/view"
		);
