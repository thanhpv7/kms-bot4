...
/**
 * PCare Diagnosa is a Page POM associated with the 'pcare-diagnosa' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class PcareDiagnosaPage extends AbstractPage {
