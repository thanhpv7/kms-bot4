...
/**
 * Patient Billing is a Page POM associated with the 'patient-billing' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class PatientBillingPage extends AbstractPage {
