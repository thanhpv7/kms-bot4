...
/**
 * Internal Order is a Page POM associated with the 'internal-order' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class InternalOrderPage extends AbstractPage {
