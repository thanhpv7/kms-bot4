...
/**
 * Patient Refund is a Page POM associated with the 'patient-refund' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class PatientRefundPage extends AbstractPage {
