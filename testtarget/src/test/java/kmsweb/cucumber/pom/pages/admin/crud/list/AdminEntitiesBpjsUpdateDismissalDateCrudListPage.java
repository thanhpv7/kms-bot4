...
@Slf4j
@ScenarioScoped
public class AdminEntitiesBpjsUpdateDismissalDateCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesBpjsUpdateDismissalDateCrudListPage(
		...
		super(
			...
			"admin/entities/bpjs-update-dismissal-date"
		);
