...
@Slf4j
@ScenarioScoped
public class AdminEntitiesInventoryBatchCorrectionItemCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesInventoryBatchCorrectionItemCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/inventory-batch-correction-item/view"
		);
