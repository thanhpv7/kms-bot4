...
/**
 * BPJS INACBG is a Page POM associated with the 'bpjs-inacbg' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class BpjsINACBGPage extends AbstractPage {
