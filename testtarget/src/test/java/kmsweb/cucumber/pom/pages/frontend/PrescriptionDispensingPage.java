...
/**
 * Prescription Dispensing is a Page POM associated with the 'prescription-dispensing' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class PrescriptionDispensingPage extends AbstractPage {
