...
@Slf4j
@ScenarioScoped
public class AdminEntitiesPatientPersonalInfoCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesPatientPersonalInfoCrudListPage(
		...
		super(
			...
			"admin/entities/patient-personal-info"
		);
