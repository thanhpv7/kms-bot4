...
/**
 * Pharmacy Configuration is a Page POM associated with the 'pharmacy-configuration' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class PharmacyConfigurationPage extends AbstractPage {
	...
	@Inject
	public PharmacyConfigurationPage(
