...
/**
 * Medical Fee is a Page POM associated with the 'medical-fee' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class MedicalFeePage extends AbstractPage {
