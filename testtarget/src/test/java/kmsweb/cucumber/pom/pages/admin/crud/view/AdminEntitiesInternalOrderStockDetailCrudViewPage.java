...
@Slf4j
@ScenarioScoped
public class AdminEntitiesInternalOrderStockDetailCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesInternalOrderStockDetailCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/internal-order-stock-detail/view"
		);
