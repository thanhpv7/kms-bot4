...
/**
 * Payment Method Report is a Page POM associated with the 'payment-method-report' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class PaymentMethodReportPage extends AbstractPage {
	...
	@Inject
	public PaymentMethodReportPage(
