...
@Slf4j
@ScenarioScoped
public class AdminEntitiesBpjsSEPInternalDataCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesBpjsSEPInternalDataCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/bpjs-sep-internal-data/view"
		);
