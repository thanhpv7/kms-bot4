...
@Slf4j
@ScenarioScoped
public class AdminEntitiesExaminationItemDetailCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesExaminationItemDetailCrudListPage(
		...
		super(
			...
			"admin/entities/examination-item-detail"
		);
