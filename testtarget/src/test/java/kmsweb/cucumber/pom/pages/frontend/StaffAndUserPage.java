...
/**
 * Staff and User is a Page POM associated with the 'staff-and-user' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class StaffAndUserPage extends AbstractPage {
