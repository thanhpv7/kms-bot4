...
@Slf4j
@ScenarioScoped
public class AdminEntitiesPatientDetailAddressCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesPatientDetailAddressCrudListPage(
		...
		super(
			...
			"admin/entities/patient-detail-address"
		);
