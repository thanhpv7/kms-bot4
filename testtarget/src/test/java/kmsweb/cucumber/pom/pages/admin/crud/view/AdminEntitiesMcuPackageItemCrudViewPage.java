...
@Slf4j
@ScenarioScoped
public class AdminEntitiesMcuPackageItemCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesMcuPackageItemCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/mcu-package-item/view"
		);
