...
@Slf4j
@ScenarioScoped
public class AdminEntitiesProcessWorkflowCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesProcessWorkflowCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/process-workflow/view"
		);
