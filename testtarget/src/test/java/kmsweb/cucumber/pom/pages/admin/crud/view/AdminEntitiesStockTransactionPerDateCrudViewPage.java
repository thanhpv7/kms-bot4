...
@Slf4j
@ScenarioScoped
public class AdminEntitiesStockTransactionPerDateCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesStockTransactionPerDateCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/stock-transaction-per-date/view"
		);
