...
@Slf4j
@ScenarioScoped
public class AdminEntitiesBpjsBedAvailabilityCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesBpjsBedAvailabilityCrudListPage(
		...
		super(
			...
			"admin/entities/bpjs-bed-availability"
		);
