...
/**
 * Medication Administered History is a Page POM associated with the 'medication-administered-history' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class MedicationAdministeredHistoryPage extends AbstractPage {
	...
	@Inject
	public MedicationAdministeredHistoryPage(
