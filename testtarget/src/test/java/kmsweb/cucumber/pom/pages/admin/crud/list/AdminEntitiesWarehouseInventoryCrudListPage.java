...
@Slf4j
@ScenarioScoped
public class AdminEntitiesWarehouseInventoryCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesWarehouseInventoryCrudListPage(
		...
		super(
			...
			"admin/entities/warehouse-inventory"
		);
