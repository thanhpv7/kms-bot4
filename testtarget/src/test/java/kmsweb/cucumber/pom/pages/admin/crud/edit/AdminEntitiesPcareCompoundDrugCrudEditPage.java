...
@Slf4j
@ScenarioScoped
public class AdminEntitiesPcareCompoundDrugCrudEditPage extends CrudEdit {
	...
	// TODO default handling dataAttribute packageQtyField;
	...
	@Inject
	public AdminEntitiesPcareCompoundDrugCrudEditPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/pcare-compound-drug/create"
		);
	...
	{
		var entity = (PcareCompoundDrugEntity) abstractEntity;
		...
		// TODO default handling for dataAttribute packageQtyField
		packageQtyField.sendKeys(entity.getPackageQty().toString());
		...
		namaObatNonDPHOField.sendKeys(entity.getNamaObatNonDPHO());
