...
/**
 * Tariff Scheme is a Page POM associated with the 'tariff-scheme' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class TariffSchemePage extends AbstractPage {
