...
@Slf4j
@ScenarioScoped
public class AdminEntitiesCatalogueMedicalCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesCatalogueMedicalCrudListPage(
		...
		super(
			...
			"admin/entities/catalogue-medical"
		);
