...
/**
 * Compound Prescription ItemPage is a Page POM that is associated with the admin/entities/compound-prescription-item url.
 *
 */
@Slf4j
@ScenarioScoped
public class AdminEntitiesCompoundPrescriptionItemCrudEditPage extends CrudEdit {
	...
	@FindBy(how = How.XPATH, using = "//ng-select[@id='compoundPrescriptionDetailId-field']")
	private WebElement compoundPrescriptionDetailField;
	...
	@Inject
	public AdminEntitiesCompoundPrescriptionItemCrudEditPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/compound-prescription-item/create"
		);
	...
	{
		var entity = (CompoundPrescriptionItemEntity) abstractEntity;
