...
@Slf4j
@ScenarioScoped
public class AdminEntitiesBatchStockBalanceCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesBatchStockBalanceCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/batch-stock-balance/view"
		);
