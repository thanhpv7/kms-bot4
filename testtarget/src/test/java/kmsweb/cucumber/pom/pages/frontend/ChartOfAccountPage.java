...
/**
 * Chart of Account is a Page POM associated with the 'chart-of-account' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class ChartOfAccountPage extends AbstractPage {
