...
/**
 * BPJS Finger Print is a Page POM associated with the 'bpjs-finger-print' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class BpjsFingerPrintPage extends AbstractPage {
