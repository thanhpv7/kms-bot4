...
/**
 * BPJS Referral SpecialistPage is a Page POM that is associated with the admin/entities/bpjs-referral-specialist url.
 *
 */
@Slf4j
@ScenarioScoped
public class AdminEntitiesBpjsReferralSpecialistCrudEditPage extends CrudEdit {
	...
	@FindBy(how = How.XPATH, using = "//*[@id='totalReferral-field']")
	private WebElement totalReferralField;
	...
	@Inject
	public AdminEntitiesBpjsReferralSpecialistCrudEditPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/bpjs-referral-specialist/create"
		);
	...
	{
		var entity = (BpjsReferralSpecialistEntity) abstractEntity;
		...
		totalReferralField.sendKeys(entity.getTotalReferral());
