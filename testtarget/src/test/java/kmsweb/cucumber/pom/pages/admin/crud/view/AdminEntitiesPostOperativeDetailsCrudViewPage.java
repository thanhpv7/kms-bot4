...
@Slf4j
@ScenarioScoped
public class AdminEntitiesPostOperativeDetailsCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesPostOperativeDetailsCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/post-operative-details/view"
		);
