...
@Slf4j
@ScenarioScoped
public class AdminEntitiesBodyChartExaminationCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesBodyChartExaminationCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/body-chart-examination/view"
		);
