...
/**
 * Patient Refund Setup is a Page POM associated with the 'patient-refund-setup' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class PatientRefundSetupPage extends AbstractPage {
