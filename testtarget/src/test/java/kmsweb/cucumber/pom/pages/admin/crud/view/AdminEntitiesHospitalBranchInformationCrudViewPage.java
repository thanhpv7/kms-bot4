...
@Slf4j
@ScenarioScoped
public class AdminEntitiesHospitalBranchInformationCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesHospitalBranchInformationCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/hospital-branch-information/view"
		);
