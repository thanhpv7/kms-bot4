...
/**
 * Master Patient Report is a Page POM associated with the 'master-patient-report' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class MasterPatientReportPage extends AbstractPage {
	...
	@Inject
	public MasterPatientReportPage(
