...
@Slf4j
@ScenarioScoped
public class AdminEntitiesPatientGeneralInfoCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesPatientGeneralInfoCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/patient-general-info/view"
		);
