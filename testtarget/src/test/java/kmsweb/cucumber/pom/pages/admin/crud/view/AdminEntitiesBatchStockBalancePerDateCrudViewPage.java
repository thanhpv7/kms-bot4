...
@Slf4j
@ScenarioScoped
public class AdminEntitiesBatchStockBalancePerDateCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesBatchStockBalancePerDateCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/batch-stock-balance-per-date/view"
		);
