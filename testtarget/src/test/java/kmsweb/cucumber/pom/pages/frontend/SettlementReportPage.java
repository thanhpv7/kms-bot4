...
/**
 * Settlement Report is a Page POM associated with the 'settlement-report' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class SettlementReportPage extends AbstractPage {
