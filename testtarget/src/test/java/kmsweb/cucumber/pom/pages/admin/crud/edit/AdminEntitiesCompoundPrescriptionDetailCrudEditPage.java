...
/**
 * Compound Prescription DetailPage is a Page POM that is associated with the admin/entities/compound-prescription-detail url.
 *
 */
@Slf4j
@ScenarioScoped
public class AdminEntitiesCompoundPrescriptionDetailCrudEditPage extends CrudEdit {
	...
	// TODO default handling dataAttribute requestQuantityField;
	@FindBy(how = How.XPATH, using = "//*[@id='requestQuantity-field']")
	private WebElement requestQuantityField;
	...
	@FindBy(how = How.XPATH, using = "//ng-select[@id='consumptionUnitId-field']")
	...
	@Inject
	public AdminEntitiesCompoundPrescriptionDetailCrudEditPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/compound-prescription-detail/create"
		);
	...
	{
		var entity = (CompoundPrescriptionDetailEntity) abstractEntity;
		compoundCodeField.sendKeys(entity.getCompoundCode());
		compoundNameField.sendKeys(entity.getCompoundName());
		// TODO default handling for dataAttribute requestQuantityField
		requestQuantityField.sendKeys(entity.getRequestQuantity().toString());
