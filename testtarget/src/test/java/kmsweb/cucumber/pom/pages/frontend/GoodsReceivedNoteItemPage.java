...
/**
 * Goods Received Note Item is a Page POM associated with the 'goods-received-note-item' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class GoodsReceivedNoteItemPage extends AbstractPage {
	...
	@Inject
	public GoodsReceivedNoteItemPage(
