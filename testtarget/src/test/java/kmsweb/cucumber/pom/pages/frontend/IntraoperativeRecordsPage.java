...
/**
 * Intraoperative Records is a Page POM associated with the 'intraoperative-records' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class IntraoperativeRecordsPage extends AbstractPage {
	...
	@Inject
	public IntraoperativeRecordsPage(
