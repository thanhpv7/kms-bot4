...
/**
 * Merchant Bank is a Page POM associated with the 'merchant-bank' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class MerchantBankPage extends AbstractPage {
