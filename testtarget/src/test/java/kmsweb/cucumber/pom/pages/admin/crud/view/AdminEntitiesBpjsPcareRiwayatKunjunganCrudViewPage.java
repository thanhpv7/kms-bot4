...
@Slf4j
@ScenarioScoped
public class AdminEntitiesBpjsPcareRiwayatKunjunganCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesBpjsPcareRiwayatKunjunganCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/bpjs-pcare-riwayat-kunjungan/view"
		);
