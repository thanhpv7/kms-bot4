...
@Slf4j
@ScenarioScoped
public class AdminEntitiesSampleCollectionItemsCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesSampleCollectionItemsCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/sample-collection-items/view"
		);
