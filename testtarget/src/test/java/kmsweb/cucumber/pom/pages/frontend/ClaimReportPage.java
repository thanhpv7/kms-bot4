...
/**
 * Claim Report is a Page POM associated with the 'claim-report' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class ClaimReportPage extends AbstractPage {
