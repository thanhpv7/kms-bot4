...
/**
 * BPJS SEP SubmissionPage is a Page POM that is associated with the admin/entities/bpjs-sep-submission url.
 *
 */
@Slf4j
@ScenarioScoped
public class AdminEntitiesBpjsSEPSubmissionCrudEditPage extends CrudEdit {
	...
	@FindBy(how = How.XPATH, using = "//*[@id='submissionType-field']")
	private WebElement submissionTypeField;
	...
	@Inject
	public AdminEntitiesBpjsSEPSubmissionCrudEditPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/bpjs-sep-submission/create"
		);
	...
	{
		var entity = (BpjsSEPSubmissionEntity) abstractEntity;
		statusField.sendKeys(entity.getStatus());
		submissionTypeField.sendKeys(entity.getSubmissionType());
