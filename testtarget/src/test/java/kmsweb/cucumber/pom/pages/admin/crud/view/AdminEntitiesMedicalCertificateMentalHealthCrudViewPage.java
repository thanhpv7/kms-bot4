...
@Slf4j
@ScenarioScoped
public class AdminEntitiesMedicalCertificateMentalHealthCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesMedicalCertificateMentalHealthCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/medical-certificate-mental-health/view"
		);
