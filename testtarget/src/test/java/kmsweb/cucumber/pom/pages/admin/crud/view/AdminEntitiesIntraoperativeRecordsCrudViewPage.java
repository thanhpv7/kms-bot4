...
@Slf4j
@ScenarioScoped
public class AdminEntitiesIntraoperativeRecordsCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesIntraoperativeRecordsCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/intraoperative-records/view"
		);
