...
@Slf4j
@ScenarioScoped
public class AdminEntitiesDeliveryProgressCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesDeliveryProgressCrudListPage(
		...
		super(
			...
			"admin/entities/delivery-progress"
		);
