...
@Slf4j
@ScenarioScoped
public class AdminEntitiesInsuranceBenefitPlanCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesInsuranceBenefitPlanCrudListPage(
		...
		super(
			...
			"admin/entities/insurance-benefit-plan"
		);
