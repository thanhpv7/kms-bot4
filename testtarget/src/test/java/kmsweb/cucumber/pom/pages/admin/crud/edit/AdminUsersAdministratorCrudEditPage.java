...
/**
 * AdministratorPage is a Page POM that is associated with the admin/users/administrator url.
 *
 */
@Slf4j
@ScenarioScoped
public class AdminUsersAdministratorCrudEditPage extends CrudEdit {
	...
	@Inject
	public AdminUsersAdministratorCrudEditPage(
	...
	{
		var entity = (AdministratorEntity) abstractEntity;
