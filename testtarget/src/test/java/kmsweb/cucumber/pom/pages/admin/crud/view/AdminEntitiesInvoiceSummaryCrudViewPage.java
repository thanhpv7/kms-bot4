...
@Slf4j
@ScenarioScoped
public class AdminEntitiesInvoiceSummaryCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesInvoiceSummaryCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/invoice-summary/view"
		);
