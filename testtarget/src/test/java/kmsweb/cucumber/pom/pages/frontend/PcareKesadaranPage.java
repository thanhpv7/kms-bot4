...
/**
 * PCare Kesadaran is a Page POM associated with the 'pcare-kesadaran' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class PcareKesadaranPage extends AbstractPage {
