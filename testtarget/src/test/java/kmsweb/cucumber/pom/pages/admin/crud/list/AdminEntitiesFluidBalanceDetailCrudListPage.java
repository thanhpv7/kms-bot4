...
@Slf4j
@ScenarioScoped
public class AdminEntitiesFluidBalanceDetailCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesFluidBalanceDetailCrudListPage(
		...
		super(
			...
			"admin/entities/fluid-balance-detail"
		);
