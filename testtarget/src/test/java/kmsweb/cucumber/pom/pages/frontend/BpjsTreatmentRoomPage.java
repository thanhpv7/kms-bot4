...
/**
 * BPJS Treatment Room is a Page POM associated with the 'bpjs-treatment-room' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class BpjsTreatmentRoomPage extends AbstractPage {
