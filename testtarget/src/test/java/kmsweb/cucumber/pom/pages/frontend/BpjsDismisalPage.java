...
/**
 * BPJS Dismisal is a Page POM associated with the 'bpjs-dismisal' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class BpjsDismisalPage extends AbstractPage {
