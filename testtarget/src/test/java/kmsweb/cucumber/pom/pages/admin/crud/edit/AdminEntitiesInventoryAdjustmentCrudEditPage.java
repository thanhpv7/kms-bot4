...
/**
 * Inventory AdjustmentPage is a Page POM that is associated with the admin/entities/inventory-adjustment url.
 *
 */
@Slf4j
@ScenarioScoped
public class AdminEntitiesInventoryAdjustmentCrudEditPage extends CrudEdit {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end


	@FindBy(how = How.XPATH, using = "//*[@id='adjustmentNumber-field']")
	private WebElement adjustmentNumberField;
	...
	@FindBy(how = How.XPATH, using = "//*[@id='adjustmentType-field']")
	private WebElement adjustmentTypeField;
	...
	@Inject
	public AdminEntitiesInventoryAdjustmentCrudEditPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/inventory-adjustment/create"
		);
	...
	{
		var entity = (InventoryAdjustmentEntity) abstractEntity;
		adjustmentNumberField.sendKeys(entity.getAdjustmentNumber());
		...
		adjustmentTypeField.sendKeys(entity.getAdjustmentType());
