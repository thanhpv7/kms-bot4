...
/**
 * Inventory Enquiry is a Page POM associated with the 'inventory-enquiry' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class InventoryEnquiryPage extends AbstractPage {
