...
@Slf4j
@ScenarioScoped
public class AdminEntitiesOperatingTheaterMedicalExaminationRecordCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesOperatingTheaterMedicalExaminationRecordCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/operating-theater-medical-examination-record/view"
		);
