...
@Slf4j
@ScenarioScoped
public class AdminEntitiesInventoryAdjustmentCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesInventoryAdjustmentCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/inventory-adjustment/view"
		);
