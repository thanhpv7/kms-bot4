...
@Slf4j
@ScenarioScoped
public class AdminEntitiesMedicalCertificateRestrictedWorkCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesMedicalCertificateRestrictedWorkCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/medical-certificate-restricted-work/view"
		);
