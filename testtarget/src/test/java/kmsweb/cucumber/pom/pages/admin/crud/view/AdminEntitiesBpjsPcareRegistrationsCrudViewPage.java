...
@Slf4j
@ScenarioScoped
public class AdminEntitiesBpjsPcareRegistrationsCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesBpjsPcareRegistrationsCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/bpjs-pcare-registrations/view"
		);
