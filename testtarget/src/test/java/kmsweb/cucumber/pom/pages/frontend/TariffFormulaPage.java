...
/**
 * Tariff Formula is a Page POM associated with the 'tariff-formula' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class TariffFormulaPage extends AbstractPage {
