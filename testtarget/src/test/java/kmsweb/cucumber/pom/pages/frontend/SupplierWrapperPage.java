...
/**
 * Supplier Wrapper is a Page POM associated with the 'supplier-wrapper' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class SupplierWrapperPage extends AbstractPage {
