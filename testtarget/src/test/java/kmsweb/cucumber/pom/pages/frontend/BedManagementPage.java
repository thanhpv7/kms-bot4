...
/**
 * Bed Management is a Page POM associated with the 'bed-management' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class BedManagementPage extends AbstractPage {
