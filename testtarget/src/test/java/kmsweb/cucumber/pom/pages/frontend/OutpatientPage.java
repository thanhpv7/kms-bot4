...
/**
 * Outpatient is a Page POM associated with the 'outpatient' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class OutpatientPage extends AbstractPage {
