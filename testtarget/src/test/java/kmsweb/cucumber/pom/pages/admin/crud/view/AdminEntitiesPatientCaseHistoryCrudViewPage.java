...
@Slf4j
@ScenarioScoped
public class AdminEntitiesPatientCaseHistoryCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesPatientCaseHistoryCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/patient-case-history/view"
		);
