...
/**
 * Purchase Requisition is a Page POM associated with the 'purchase-requisition' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class PurchaseRequisitionPage extends AbstractPage {
