...
/**
 * Hospital Information Report is a Page POM associated with the 'hospital-information-report' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class HospitalInformationReportPage extends AbstractPage {
	...
	@Inject
	public HospitalInformationReportPage(
