...
@Slf4j
@ScenarioScoped
public class AdminEntitiesBpjsPatientReferralCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesBpjsPatientReferralCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/bpjs-patient-referral/view"
		);
