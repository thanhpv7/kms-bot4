...
@Slf4j
@ScenarioScoped
public class AdminEntitiesMedicationAdministeredHistoryCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesMedicationAdministeredHistoryCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/medication-administered-history/view"
		);
