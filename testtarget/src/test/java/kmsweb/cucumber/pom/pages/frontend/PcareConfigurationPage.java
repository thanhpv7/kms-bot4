...
/**
 * PCare Configuration is a Page POM associated with the 'pcare-configuration' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class PcareConfigurationPage extends AbstractPage {
