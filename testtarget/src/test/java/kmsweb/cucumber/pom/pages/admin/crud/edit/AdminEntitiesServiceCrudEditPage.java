...
@Slf4j
@ScenarioScoped
public class AdminEntitiesServiceCrudEditPage extends CrudEdit {
	...
	@Inject
	public AdminEntitiesServiceCrudEditPage(
	...
	{
		var entity = (ServiceEntity) abstractEntity;
		serviceNumberField.sendKeys(entity.getServiceNumber());
		serviceNameField.sendKeys(entity.getServiceName());
		sectionCodeField.sendKeys(entity.getSectionCode());
		if (entity.getByPassDoctorAssignment()) {
			byPassDoctorAssignmentField.click();
		}
		if (entity.getHasExaminationItem()) {
			hasExaminationItemField.click();
		}
		revenueCenterField.sendKeys(entity.getRevenueCenter());
		serviceCodeField.sendKeys(entity.getServiceCode());
