...
@Slf4j
@ScenarioScoped
public class AdminEntitiesDiagnosesAndProceduresCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesDiagnosesAndProceduresCrudListPage(
		...
		super(
			...
			"admin/entities/diagnoses-and-procedures"
		);
