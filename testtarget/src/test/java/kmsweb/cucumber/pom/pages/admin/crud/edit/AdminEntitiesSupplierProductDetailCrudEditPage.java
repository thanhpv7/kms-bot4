...
/**
 * Supplier Product DetailPage is a Page POM that is associated with the admin/entities/supplier-product-detail url.
 *
 */
@Slf4j
@ScenarioScoped
public class AdminEntitiesSupplierProductDetailCrudEditPage extends CrudEdit {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end


	@FindBy(how = How.XPATH, using = "//*[@id='unitCode-field']")
	private WebElement unitCodeField;
	...
	@Inject
	public AdminEntitiesSupplierProductDetailCrudEditPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/supplier-product-detail/create"
		);
	...
	{
		var entity = (SupplierProductDetailEntity) abstractEntity;
		unitCodeField.sendKeys(entity.getUnitCode());
