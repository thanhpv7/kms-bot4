...
@Slf4j
@ScenarioScoped
public class AdminEntitiesSupplierContactDetailCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesSupplierContactDetailCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/supplier-contact-detail/view"
		);
