...
@Slf4j
@ScenarioScoped
public class AdminEntitiesCatalogueNonMedicalCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesCatalogueNonMedicalCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/catalogue-non-medical/view"
		);
