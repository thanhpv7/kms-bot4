...
/**
 * Patient Invoice Detail is a Page POM associated with the 'patient-invoice-detail' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class PatientInvoiceDetailPage extends AbstractPage {
	...
	@Inject
	public PatientInvoiceDetailPage(
