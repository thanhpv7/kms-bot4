...
@Slf4j
@ScenarioScoped
public class AdminEntitiesCompoundPrescriptionDetailCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesCompoundPrescriptionDetailCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/compound-prescription-detail/view"
		);
