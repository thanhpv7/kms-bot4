...
/**
 * Bed ReservePage is a Page POM that is associated with the admin/entities/bed-reserve url.
 *
 */
@Slf4j
@ScenarioScoped
public class AdminEntitiesBedReserveCrudEditPage extends CrudEdit {
	...
	@Inject
	public AdminEntitiesBedReserveCrudEditPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/bed-reserve/create"
		);
	...
	{
		var entity = (BedReserveEntity) abstractEntity;
