...
@Slf4j
@ScenarioScoped
public class AdminEntitiesInventoryBatchCorrectionCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesInventoryBatchCorrectionCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/inventory-batch-correction/view"
		);
