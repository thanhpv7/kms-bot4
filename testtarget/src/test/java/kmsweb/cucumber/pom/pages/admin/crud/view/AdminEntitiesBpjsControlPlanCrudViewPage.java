...
@Slf4j
@ScenarioScoped
public class AdminEntitiesBpjsControlPlanCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesBpjsControlPlanCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/bpjs-control-plan/view"
		);
