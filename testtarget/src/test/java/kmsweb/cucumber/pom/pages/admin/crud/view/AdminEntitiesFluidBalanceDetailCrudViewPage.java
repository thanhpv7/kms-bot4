...
@Slf4j
@ScenarioScoped
public class AdminEntitiesFluidBalanceDetailCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesFluidBalanceDetailCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/fluid-balance-detail/view"
		);
