...
/**
 * BPJS SEP Internal is a Page POM associated with the 'bpjs-sep-internal' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class BpjsSEPInternalPage extends AbstractPage {
