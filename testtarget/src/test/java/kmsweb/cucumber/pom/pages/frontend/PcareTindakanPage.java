...
/**
 * PCare Tindakan is a Page POM associated with the 'pcare-tindakan' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class PcareTindakanPage extends AbstractPage {
