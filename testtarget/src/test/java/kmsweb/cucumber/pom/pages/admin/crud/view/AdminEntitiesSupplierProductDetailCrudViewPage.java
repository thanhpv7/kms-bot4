...
@Slf4j
@ScenarioScoped
public class AdminEntitiesSupplierProductDetailCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesSupplierProductDetailCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/supplier-product-detail/view"
		);
