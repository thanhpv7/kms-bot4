...
@Slf4j
@ScenarioScoped
public class AdminEntitiesCatalogueMedicalCrudEditPage extends CrudEdit {
	...
	// TODO default handling dataAttribute inventoryRoundingAmountField;
	...
	@Inject
	public AdminEntitiesCatalogueMedicalCrudEditPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/catalogue-medical/create"
		);
	...
	{
		var entity = (CatalogueMedicalEntity) abstractEntity;
		compositionField.sendKeys(entity.getComposition());
		if (entity.getCanBePrescribed()) {
			canBePrescribedField.click();
		}
		if (entity.getIsHospitalFormulary()) {
			isHospitalFormularyField.click();
		}
		approvalNotesField.sendKeys(entity.getApprovalNotes());
		if (entity.getIsGeneric()) {
			isGenericField.click();
		}
		if (entity.getIsRestricted()) {
			isRestrictedField.click();
		}
		if (entity.getIsVaccine()) {
			isVaccineField.click();
		}
		vaccineTypeField.sendKeys(entity.getVaccineType());
		consumptionMethodField.sendKeys(entity.getConsumptionMethod());
		consumptionUnitField.sendKeys(entity.getConsumptionUnit());
		if (entity.getCompoundChargingRounding()) {
			compoundChargingRoundingField.click();
		}
		compoundChargingRoundingAmountField.sendKeys(entity.getCompoundChargingRoundingAmount());
		if (entity.getInventoryRounding()) {
			inventoryRoundingField.click();
		}
		// TODO default handling for dataAttribute inventoryRoundingAmountField
		inventoryRoundingAmountField.sendKeys(entity.getInventoryRoundingAmount().toString());
