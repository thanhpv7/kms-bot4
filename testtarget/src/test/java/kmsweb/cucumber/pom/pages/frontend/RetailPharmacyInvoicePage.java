...
/**
 * Retail Pharmacy Invoice is a Page POM associated with the 'retail-pharmacy-invoice' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class RetailPharmacyInvoicePage extends AbstractPage {
	...
	@Inject
	public RetailPharmacyInvoicePage(
