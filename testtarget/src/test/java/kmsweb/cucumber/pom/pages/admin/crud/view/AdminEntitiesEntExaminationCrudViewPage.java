...
@Slf4j
@ScenarioScoped
public class AdminEntitiesEntExaminationCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesEntExaminationCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/ent-examination/view"
		);
