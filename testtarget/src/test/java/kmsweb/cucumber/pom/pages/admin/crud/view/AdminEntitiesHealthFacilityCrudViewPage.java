...
@Slf4j
@ScenarioScoped
public class AdminEntitiesHealthFacilityCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesHealthFacilityCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/health-facility/view"
		);
