...
/**
 * Preoperative Records is a Page POM associated with the 'preoperative-records' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class PreoperativeRecordsPage extends AbstractPage {
	...
	@Inject
	public PreoperativeRecordsPage(
