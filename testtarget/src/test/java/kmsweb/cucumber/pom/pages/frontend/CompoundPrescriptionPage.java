...
/**
 * Compound Prescription is a Page POM associated with the 'compound-prescription' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class CompoundPrescriptionPage extends AbstractPage {
	...
	@Inject
	public CompoundPrescriptionPage(
