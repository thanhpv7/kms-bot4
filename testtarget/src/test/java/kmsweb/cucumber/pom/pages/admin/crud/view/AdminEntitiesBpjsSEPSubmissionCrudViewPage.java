...
@Slf4j
@ScenarioScoped
public class AdminEntitiesBpjsSEPSubmissionCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesBpjsSEPSubmissionCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/bpjs-sep-submission/view"
		);
