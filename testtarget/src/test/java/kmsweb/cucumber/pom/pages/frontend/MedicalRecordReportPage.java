...
/**
 * Medical Record Report is a Page POM associated with the 'medical-record-report' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class MedicalRecordReportPage extends AbstractPage {
	...
	@Inject
	public MedicalRecordReportPage(
