...
/**
 * BPJS Procedure is a Page POM associated with the 'bpjs-procedure' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class BpjsProcedurePage extends AbstractPage {
