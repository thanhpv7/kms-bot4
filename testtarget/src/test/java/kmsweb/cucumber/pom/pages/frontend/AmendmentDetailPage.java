...
/**
 * Amendment Detail is a Page POM associated with the 'amendment-detail' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class AmendmentDetailPage extends AbstractPage {
