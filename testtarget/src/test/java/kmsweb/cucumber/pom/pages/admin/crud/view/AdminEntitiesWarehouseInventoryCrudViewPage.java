...
@Slf4j
@ScenarioScoped
public class AdminEntitiesWarehouseInventoryCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesWarehouseInventoryCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/warehouse-inventory/view"
		);
