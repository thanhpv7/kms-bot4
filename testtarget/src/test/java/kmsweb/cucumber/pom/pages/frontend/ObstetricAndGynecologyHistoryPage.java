...
/**
 * Obstetric And Gynecology History is a Page POM associated with the 'obstetric-and-gynecology-history' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class ObstetricAndGynecologyHistoryPage extends AbstractPage {
	...
	@Inject
	public ObstetricAndGynecologyHistoryPage(
