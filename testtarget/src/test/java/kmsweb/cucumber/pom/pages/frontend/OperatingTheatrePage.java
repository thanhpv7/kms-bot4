...
/**
 * Operating Theatre is a Page POM associated with the 'operating-theatre' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class OperatingTheatrePage extends AbstractPage {
