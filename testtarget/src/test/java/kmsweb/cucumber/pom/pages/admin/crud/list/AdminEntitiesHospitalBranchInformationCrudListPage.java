...
@Slf4j
@ScenarioScoped
public class AdminEntitiesHospitalBranchInformationCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesHospitalBranchInformationCrudListPage(
		...
		super(
			...
			"admin/entities/hospital-branch-information"
		);
