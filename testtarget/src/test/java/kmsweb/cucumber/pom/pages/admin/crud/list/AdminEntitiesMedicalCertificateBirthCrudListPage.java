...
@Slf4j
@ScenarioScoped
public class AdminEntitiesMedicalCertificateBirthCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesMedicalCertificateBirthCrudListPage(
		...
		super(
			...
			"admin/entities/medical-certificate-birth"
		);
