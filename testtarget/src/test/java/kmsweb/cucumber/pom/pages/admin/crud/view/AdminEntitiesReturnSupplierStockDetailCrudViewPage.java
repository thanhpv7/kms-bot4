...
@Slf4j
@ScenarioScoped
public class AdminEntitiesReturnSupplierStockDetailCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesReturnSupplierStockDetailCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/return-supplier-stock-detail/view"
		);
