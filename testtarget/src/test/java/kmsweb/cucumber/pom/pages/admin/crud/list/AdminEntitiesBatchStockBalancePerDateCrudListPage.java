...
@Slf4j
@ScenarioScoped
public class AdminEntitiesBatchStockBalancePerDateCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesBatchStockBalancePerDateCrudListPage(
		...
		super(
			...
			"admin/entities/batch-stock-balance-per-date"
		);
