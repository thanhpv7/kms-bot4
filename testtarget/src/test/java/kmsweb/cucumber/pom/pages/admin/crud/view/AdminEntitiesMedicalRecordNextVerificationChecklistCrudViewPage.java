...
@Slf4j
@ScenarioScoped
public class AdminEntitiesMedicalRecordNextVerificationChecklistCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesMedicalRecordNextVerificationChecklistCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/medical-record-next-verification-checklist/view"
		);
