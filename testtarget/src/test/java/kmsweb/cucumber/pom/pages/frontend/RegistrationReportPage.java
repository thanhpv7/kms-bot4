...
/**
 * Registration Report is a Page POM associated with the 'registration-report' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class RegistrationReportPage extends AbstractPage {
