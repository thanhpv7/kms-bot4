...
@Slf4j
@ScenarioScoped
public class AdminEntitiesFacilityHistoryCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesFacilityHistoryCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/facility-history/view"
		);
