...
/**
 * Inventory Batch CorrectionPage is a Page POM that is associated with the admin/entities/inventory-batch-correction url.
 *
 */
@Slf4j
@ScenarioScoped
public class AdminEntitiesInventoryBatchCorrectionCrudEditPage extends CrudEdit {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end


	@FindBy(how = How.XPATH, using = "//*[@id='batchCorrectionNumber-field']")
	private WebElement batchCorrectionNumberField;
	...
	@Inject
	public AdminEntitiesInventoryBatchCorrectionCrudEditPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/inventory-batch-correction/create"
		);
	...
	{
		var entity = (InventoryBatchCorrectionEntity) abstractEntity;
		batchCorrectionNumberField.sendKeys(entity.getBatchCorrectionNumber());
		...
		DropdownUtils.selectOptionByName(webDriver, transactionTypeField, entity.getTransactionType().getLiteralValue());
