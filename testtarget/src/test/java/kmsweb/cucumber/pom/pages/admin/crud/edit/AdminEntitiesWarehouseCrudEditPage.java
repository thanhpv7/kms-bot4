...
@Slf4j
@ScenarioScoped
public class AdminEntitiesWarehouseCrudEditPage extends CrudEdit {
	...
	@Inject
	public AdminEntitiesWarehouseCrudEditPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/warehouse/create"
		);
	...
	{
		var entity = (WarehouseEntity) abstractEntity;
		warehouseNumberField.sendKeys(entity.getWarehouseNumber());
		warehouseNameField.sendKeys(entity.getWarehouseName());
