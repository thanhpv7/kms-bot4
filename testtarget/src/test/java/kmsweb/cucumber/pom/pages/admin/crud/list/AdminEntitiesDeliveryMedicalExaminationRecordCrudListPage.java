...
@Slf4j
@ScenarioScoped
public class AdminEntitiesDeliveryMedicalExaminationRecordCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesDeliveryMedicalExaminationRecordCrudListPage(
		...
		super(
			...
			"admin/entities/delivery-medical-examination-record"
		);
