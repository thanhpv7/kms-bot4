...
@Slf4j
@ScenarioScoped
public class AdminEntitiesBpjsClaimSubmissionCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesBpjsClaimSubmissionCrudListPage(
		...
		super(
			...
			"admin/entities/bpjs-claim-submission"
		);
