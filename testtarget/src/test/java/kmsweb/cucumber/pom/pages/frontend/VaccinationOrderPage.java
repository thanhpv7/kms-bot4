...
/**
 * Vaccination Order is a Page POM associated with the 'vaccination-order' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class VaccinationOrderPage extends AbstractPage {
