...
/**
 * BPJS Diagnose PRB is a Page POM associated with the 'bpjs-diagnose-prb' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class BpjsDiagnosePRBPage extends AbstractPage {
