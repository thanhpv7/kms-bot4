...
@Slf4j
@ScenarioScoped
public class AdminEntitiesHospitalGroupInformationCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesHospitalGroupInformationCrudListPage(
		...
		super(
			...
			"admin/entities/hospital-group-information"
		);
