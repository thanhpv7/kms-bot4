...
/**
 * Newborn Detail is a Page POM associated with the 'newborn-detail' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class NewbornDetailPage extends AbstractPage {
