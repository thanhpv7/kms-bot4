...
/**
 * Numbering Setup is a Page POM associated with the 'numbering-setup' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class NumberingSetupPage extends AbstractPage {
