...
@Slf4j
@ScenarioScoped
public class AdminEntitiesBpjsClaimDataCrudEditPage extends CrudEdit {
	...
	@Inject
	public AdminEntitiesBpjsClaimDataCrudEditPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/bpjs-claim-data/create"
		);
	...
	{
		var entity = (BpjsClaimDataEntity) abstractEntity;
		inacbgCodeField.sendKeys(entity.getInacbgCode());
		inacbgNameField.sendKeys(entity.getInacbgName());
		submittedTariffField.sendKeys(entity.getSubmittedTariff());
		approvalField.sendKeys(entity.getApproval());
		grouperTariffField.sendKeys(entity.getGrouperTariff());
		hospitalTariffField.sendKeys(entity.getHospitalTariff());
		topUpField.sendKeys(entity.getTopUp());
		treatmentClassField.sendKeys(entity.getTreatmentClass());
		fpkNoField.sendKeys(entity.getFpkNo());
