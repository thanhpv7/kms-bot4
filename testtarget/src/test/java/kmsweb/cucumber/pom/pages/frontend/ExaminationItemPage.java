...
/**
 * Examination Item is a Page POM associated with the 'examination-item' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class ExaminationItemPage extends AbstractPage {
