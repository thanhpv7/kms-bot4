...
@Slf4j
@ScenarioScoped
public class AdminEntitiesBpjsOutsideFacilityReferralCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesBpjsOutsideFacilityReferralCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/bpjs-outside-facility-referral/view"
		);
