...
@Slf4j
@ScenarioScoped
public class AdminEntitiesAmendmentDetailCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesAmendmentDetailCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/amendment-detail/view"
		);
