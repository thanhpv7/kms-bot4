...
@Slf4j
@ScenarioScoped
public class AdminEntitiesPreoperativeRecordsCrudEditPage extends CrudEdit {
	...
	@Inject
	public AdminEntitiesPreoperativeRecordsCrudEditPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/preoperative-records/create"
		);
	...
	{
		var entity = (PreoperativeRecordsEntity) abstractEntity;
		...
		physicalStatusEvaluationField.sendKeys(entity.getPhysicalStatusEvaluation());
		surgeryRiskField.sendKeys(entity.getSurgeryRisk());
		psychologicalStateField.sendKeys(entity.getPsychologicalState());
		anesthesiaSurgeryRiskField.sendKeys(entity.getAnesthesiaSurgeryRisk());
		preoperativeEvaluationField.sendKeys(entity.getPreoperativeEvaluation());
		anesthesiaNotesField.sendKeys(entity.getAnesthesiaNotes());
		surgicalSpecialtyField.sendKeys(entity.getSurgicalSpecialty());
		antibioticProphylaxisGivenField.sendKeys(entity.getAntibioticProphylaxisGiven());
		surgeryTypeField.sendKeys(entity.getSurgeryType());
		surgeryClassField.sendKeys(entity.getSurgeryClass());
		surgicalSurgeryRiskField.sendKeys(entity.getSurgicalSurgeryRisk());
		physicalStatusClassificationField.sendKeys(entity.getPhysicalStatusClassification());
		preSurgeryDiagnosisField.sendKeys(entity.getPreSurgeryDiagnosis());
		preoperativeInstructionsField.sendKeys(entity.getPreoperativeInstructions());
		preoperativeSurgicalNotesField.sendKeys(entity.getPreoperativeSurgicalNotes());
