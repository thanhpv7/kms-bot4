...
/**
 * Patient Vital Information is a Page POM associated with the 'patient-vital-information' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class PatientVitalInformationPage extends AbstractPage {
	...
	@Inject
	public PatientVitalInformationPage(
