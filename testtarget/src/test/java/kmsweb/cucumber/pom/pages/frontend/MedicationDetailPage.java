...
/**
 * Medication Detail is a Page POM associated with the 'medication-detail' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class MedicationDetailPage extends AbstractPage {
