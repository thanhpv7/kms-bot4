...
/**
 * Stock Transaction Per Date TypePage is a Page POM that is associated with the admin/entities/stock-transaction-per-date-type url.
 *
 */
@Slf4j
@ScenarioScoped
public class AdminEntitiesStockTransactionPerDateTypeCrudEditPage extends CrudEdit {
	...
	@Inject
	public AdminEntitiesStockTransactionPerDateTypeCrudEditPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/stock-transaction-per-date-type/create"
		);
	...
	{
		var entity = (StockTransactionPerDateTypeEntity) abstractEntity;
