...
@Slf4j
@ScenarioScoped
public class AdminEntitiesPatientVitalInformationCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesPatientVitalInformationCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/patient-vital-information/view"
		);
