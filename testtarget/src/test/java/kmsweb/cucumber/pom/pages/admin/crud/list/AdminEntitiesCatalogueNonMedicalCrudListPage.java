...
@Slf4j
@ScenarioScoped
public class AdminEntitiesCatalogueNonMedicalCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesCatalogueNonMedicalCrudListPage(
		...
		super(
			...
			"admin/entities/catalogue-non-medical"
		);
