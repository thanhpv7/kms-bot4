...
@Slf4j
@ScenarioScoped
public class AdminEntitiesMedicationHeaderCrudEditPage extends CrudEdit {
	...
	@Inject
	public AdminEntitiesMedicationHeaderCrudEditPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/medication-header/create"
		);
	...
	{
		var entity = (MedicationHeaderEntity) abstractEntity;
		medicationNumberField.sendKeys(entity.getMedicationNumber());
		dispensingTypeField.sendKeys(entity.getDispensingType());
		originalMedicationNumberField.sendKeys(entity.getOriginalMedicationNumber());
