...
/**
 * Batch Stock BalancePage is a Page POM that is associated with the admin/entities/batch-stock-balance url.
 *
 */
@Slf4j
@ScenarioScoped
public class AdminEntitiesBatchStockBalanceCrudEditPage extends CrudEdit {
	...
	@Inject
	public AdminEntitiesBatchStockBalanceCrudEditPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/batch-stock-balance/create"
		);
	...
	{
		var entity = (BatchStockBalanceEntity) abstractEntity;
