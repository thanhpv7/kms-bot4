...
@Slf4j
@ScenarioScoped
public class AdminEntitiesMedicalExaminationRecordCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesMedicalExaminationRecordCrudListPage(
		...
		super(
			...
			"admin/entities/medical-examination-record"
		);
