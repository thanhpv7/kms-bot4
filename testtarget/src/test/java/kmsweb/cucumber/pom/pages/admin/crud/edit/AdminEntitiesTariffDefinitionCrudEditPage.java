...
/**
 * Tariff DefinitionPage is a Page POM that is associated with the admin/entities/tariff-definition url.
 *
 */
@Slf4j
@ScenarioScoped
public class AdminEntitiesTariffDefinitionCrudEditPage extends CrudEdit {
	...
	// TODO default handling dataAttribute tariffPriceField;
	@FindBy(how = How.XPATH, using = "//*[@id='tariffPrice-field']")
	private WebElement tariffPriceField;
	...
	@FindBy(how = How.XPATH, using = "//ng-select[@id='priceSchemaId-field']")
	private WebElement priceSchemaField;
	...
	@Inject
	public AdminEntitiesTariffDefinitionCrudEditPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/tariff-definition/create"
		);
	...
	{
		var entity = (TariffDefinitionEntity) abstractEntity;
		...
		// TODO default handling for dataAttribute tariffPriceField
		tariffPriceField.sendKeys(entity.getTariffPrice().toString());
