...
/**
 * BPJS Doctor Schedule is a Page POM associated with the 'bpjs-doctor-schedule' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class BpjsDoctorSchedulePage extends AbstractPage {
