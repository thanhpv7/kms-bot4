...
@Slf4j
@ScenarioScoped
public class AdminEntitiesInpatientMedicalExaminationRecordCrudEditPage extends CrudEdit {
	...
	@Inject
	public AdminEntitiesInpatientMedicalExaminationRecordCrudEditPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/inpatient-medical-examination-record/create"
		);
	...
	{
		var entity = (InpatientMedicalExaminationRecordEntity) abstractEntity;
		...
		inpatientCaseField.sendKeys(entity.getInpatientCase());
		serviceCaseField.sendKeys(entity.getServiceCase());
		dependencyLevelField.sendKeys(entity.getDependencyLevel());
		currentDependencyField.sendKeys(entity.getCurrentDependency());
		infantConditionField.sendKeys(entity.getInfantCondition());
