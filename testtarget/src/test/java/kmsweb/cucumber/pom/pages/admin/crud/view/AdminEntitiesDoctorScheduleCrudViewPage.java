...
@Slf4j
@ScenarioScoped
public class AdminEntitiesDoctorScheduleCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesDoctorScheduleCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/doctor-schedule/view"
		);
