...
/**
 * Inpatient Order is a Page POM associated with the 'inpatient-order' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class InpatientOrderPage extends AbstractPage {
