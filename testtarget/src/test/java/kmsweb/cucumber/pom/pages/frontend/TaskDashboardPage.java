...
/**
 * Task Dashboard is a Page POM associated with the 'task-dashboard' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class TaskDashboardPage extends AbstractPage {
