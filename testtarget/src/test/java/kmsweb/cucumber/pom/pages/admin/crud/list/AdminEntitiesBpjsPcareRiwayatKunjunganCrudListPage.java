...
@Slf4j
@ScenarioScoped
public class AdminEntitiesBpjsPcareRiwayatKunjunganCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesBpjsPcareRiwayatKunjunganCrudListPage(
		...
		super(
			...
			"admin/entities/bpjs-pcare-riwayat-kunjungan"
		);
