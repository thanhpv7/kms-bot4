...
@Slf4j
@ScenarioScoped
public class AdminEntitiesPatientEmploymentDetailCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesPatientEmploymentDetailCrudListPage(
		...
		super(
			...
			"admin/entities/patient-employment-detail"
		);
