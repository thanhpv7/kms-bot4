...
@Slf4j
@ScenarioScoped
public class AdminEntitiesTransferOrderStockDetailCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesTransferOrderStockDetailCrudListPage(
		...
		super(
			...
			"admin/entities/transfer-order-stock-detail"
		);
