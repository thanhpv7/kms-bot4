...
/**
 * Medical Record Checklist is a Page POM associated with the 'medical-record-checklist' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class MedicalRecordChecklistPage extends AbstractPage {
	...
	@Inject
	public MedicalRecordChecklistPage(
