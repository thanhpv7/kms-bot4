...
@Slf4j
@ScenarioScoped
public class AdminEntitiesDiagnosesAndProceduresCrudEditPage extends CrudEdit {
	...
	@Inject
	public AdminEntitiesDiagnosesAndProceduresCrudEditPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/diagnoses-and-procedures/create"
		);
	...
	{
		var entity = (DiagnosesAndProceduresEntity) abstractEntity;
		itemTypeField.sendKeys(entity.getItemType());
