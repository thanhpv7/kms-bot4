...
@Slf4j
@ScenarioScoped
public class AdminEntitiesPurchaseRequisitionStockDetailCrudEditPage extends CrudEdit {
	...
	// TODO default handling dataAttribute quantityRequestedField;
	...
	@Inject
	public AdminEntitiesPurchaseRequisitionStockDetailCrudEditPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/purchase-requisition-stock-detail/create"
		);
	...
	{
		var entity = (PurchaseRequisitionStockDetailEntity) abstractEntity;
		...
		// TODO default handling for dataAttribute quantityRequestedField
		quantityRequestedField.sendKeys(entity.getQuantityRequested().toString());
