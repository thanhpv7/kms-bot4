...
/**
 * Inpatient Admission is a Page POM associated with the 'inpatient-admission' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class InpatientAdmissionPage extends AbstractPage {
