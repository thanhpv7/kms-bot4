...
/**
 * Daily Care CPPT is a Page POM associated with the 'daily-care-cppt' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class DailyCareCPPTPage extends AbstractPage {
