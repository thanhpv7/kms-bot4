...
/**
 * BPJS Jasa Raharja is a Page POM associated with the 'bpjs-jasa-raharja' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class BpjsJasaRaharjaPage extends AbstractPage {
