...
@Slf4j
@ScenarioScoped
public class AdminEntitiesMedicalCertificateHospitalizationCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesMedicalCertificateHospitalizationCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/medical-certificate-hospitalization/view"
		);
