...
@Slf4j
@ScenarioScoped
public class AdminEntitiesPrescriptionCompoundCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesPrescriptionCompoundCrudListPage(
		...
		super(
			...
			"admin/entities/prescription-compound"
		);
