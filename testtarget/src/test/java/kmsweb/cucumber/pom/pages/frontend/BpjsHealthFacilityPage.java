...
/**
 * BPJS Health Facility is a Page POM associated with the 'bpjs-health-facility' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class BpjsHealthFacilityPage extends AbstractPage {
