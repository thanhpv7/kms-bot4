...
@Slf4j
@ScenarioScoped
public class AdminEntitiesPurchaseOrderStockDetailCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesPurchaseOrderStockDetailCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/purchase-order-stock-detail/view"
		);
