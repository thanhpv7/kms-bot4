...
/**
 * Invoice Payment OtherPage is a Page POM that is associated with the admin/entities/invoice-payment-other url.
 *
 */
@Slf4j
@ScenarioScoped
public class AdminEntitiesInvoicePaymentOtherCrudEditPage extends CrudEdit {
	...
	@Inject
	public AdminEntitiesInvoicePaymentOtherCrudEditPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/invoice-payment-other/create"
		);
	...
	{
		var entity = (InvoicePaymentOtherEntity) abstractEntity;
