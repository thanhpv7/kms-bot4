...
@Slf4j
@ScenarioScoped
public class AdminEntitiesEmergencyMedicalExaminationRecordCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesEmergencyMedicalExaminationRecordCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/emergency-medical-examination-record/view"
		);
