...
@Slf4j
@ScenarioScoped
public class AdminEntitiesPrescriptionCompoundCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesPrescriptionCompoundCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/prescription-compound/view"
		);
