...
/**
 * Non Compound Drug is a Page POM associated with the 'non-compound-drug' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class NonCompoundDrugPage extends AbstractPage {
