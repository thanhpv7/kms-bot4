...
/**
 * BPJS Visit Data is a Page POM associated with the 'bpjs-visit-data' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class BpjsVisitDataPage extends AbstractPage {
