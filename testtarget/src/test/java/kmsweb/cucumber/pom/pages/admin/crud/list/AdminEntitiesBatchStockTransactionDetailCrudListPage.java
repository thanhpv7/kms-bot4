...
@Slf4j
@ScenarioScoped
public class AdminEntitiesBatchStockTransactionDetailCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesBatchStockTransactionDetailCrudListPage(
		...
		super(
			...
			"admin/entities/batch-stock-transaction-detail"
		);
