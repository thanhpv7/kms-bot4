...
@Slf4j
@ScenarioScoped
public class AdminEntitiesBpjsSpecialReferralCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesBpjsSpecialReferralCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/bpjs-special-referral/view"
		);
