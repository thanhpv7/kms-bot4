...
/**
 * Return Supplier is a Page POM associated with the 'return-supplier' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class ReturnSupplierPage extends AbstractPage {
