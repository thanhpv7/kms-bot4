...
/**
 * PCare Dokter is a Page POM associated with the 'pcare-dokter' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class PcareDokterPage extends AbstractPage {
