...
/**
 * BPJS SEPPage is a Page POM that is associated with the admin/entities/bpjs-sep url.
 *
 */
@Slf4j
@ScenarioScoped
public class AdminEntitiesBpjsSEPCrudEditPage extends CrudEdit {
	...
	@Inject
	public AdminEntitiesBpjsSEPCrudEditPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/bpjs-sep/create"
		);
	...
	{
		var entity = (BpjsSEPEntity) abstractEntity;
