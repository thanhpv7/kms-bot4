...
/**
 * Pcare Obat is a Page POM associated with the 'pcare-obat' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class PcareObatPage extends AbstractPage {
