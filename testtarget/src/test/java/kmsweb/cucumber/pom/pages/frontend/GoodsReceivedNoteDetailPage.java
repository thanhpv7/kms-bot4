...
/**
 * Goods Received Note Detail is a Page POM associated with the 'goods-received-note-detail' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class GoodsReceivedNoteDetailPage extends AbstractPage {
	...
	@Inject
	public GoodsReceivedNoteDetailPage(
