...
/**
 * Supplier Product Detail is a Page POM associated with the 'supplier-product-detail' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class SupplierProductDetailPage extends AbstractPage {
	...
	@Inject
	public SupplierProductDetailPage(
