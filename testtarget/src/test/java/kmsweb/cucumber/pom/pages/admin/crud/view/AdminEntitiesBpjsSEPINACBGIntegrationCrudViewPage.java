...
@Slf4j
@ScenarioScoped
public class AdminEntitiesBpjsSEPINACBGIntegrationCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesBpjsSEPINACBGIntegrationCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/bpjs-sep-inacbg-integration/view"
		);
