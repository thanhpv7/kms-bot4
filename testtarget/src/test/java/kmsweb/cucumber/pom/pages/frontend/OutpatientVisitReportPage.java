...
/**
 * Outpatient Visit Report is a Page POM associated with the 'outpatient-visit-report' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class OutpatientVisitReportPage extends AbstractPage {
	...
	@Inject
	public OutpatientVisitReportPage(
