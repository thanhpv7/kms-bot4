...
@Slf4j
@ScenarioScoped
public class AdminEntitiesBpjsHospitalizationPlanCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesBpjsHospitalizationPlanCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/bpjs-hospitalization-plan/view"
		);
