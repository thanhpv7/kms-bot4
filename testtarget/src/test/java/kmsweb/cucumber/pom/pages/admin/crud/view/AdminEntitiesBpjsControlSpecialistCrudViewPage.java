...
@Slf4j
@ScenarioScoped
public class AdminEntitiesBpjsControlSpecialistCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesBpjsControlSpecialistCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/bpjs-control-specialist/view"
		);
