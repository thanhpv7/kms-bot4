...
/**
 * Patient Configuration is a Page POM associated with the 'patient-configuration' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class PatientConfigurationPage extends AbstractPage {
	...
	@Inject
	public PatientConfigurationPage(
