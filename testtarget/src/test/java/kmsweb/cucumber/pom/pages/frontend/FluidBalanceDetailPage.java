...
/**
 * Fluid Balance Detail is a Page POM associated with the 'fluid-balance-detail' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class FluidBalanceDetailPage extends AbstractPage {
