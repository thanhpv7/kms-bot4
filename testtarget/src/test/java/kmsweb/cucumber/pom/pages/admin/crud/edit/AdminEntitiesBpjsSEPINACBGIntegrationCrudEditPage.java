...
/**
 * BPJS SEP INACBG IntegrationPage is a Page POM that is associated with the admin/entities/bpjs-sep-inacbg-integration url.
 *
 */
@Slf4j
@ScenarioScoped
public class AdminEntitiesBpjsSEPINACBGIntegrationCrudEditPage extends CrudEdit {
	...
	@Inject
	public AdminEntitiesBpjsSEPINACBGIntegrationCrudEditPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/bpjs-sep-inacbg-integration/create"
		);
	...
	{
		var entity = (BpjsSEPINACBGIntegrationEntity) abstractEntity;
		...
		visitDateField.sendKeys(entity.getVisitDate());
