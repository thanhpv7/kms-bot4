...
/**
 * Tariff Management is a Page POM associated with the 'tariff-management' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class TariffManagementPage extends AbstractPage {
