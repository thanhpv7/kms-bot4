...
/**
 * BPJS Sep Submission is a Page POM associated with the 'bpjs-sep-submission' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class BpjsSepSubmissionPage extends AbstractPage {
