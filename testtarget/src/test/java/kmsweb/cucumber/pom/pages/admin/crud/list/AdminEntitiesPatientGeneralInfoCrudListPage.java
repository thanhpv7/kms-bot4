...
@Slf4j
@ScenarioScoped
public class AdminEntitiesPatientGeneralInfoCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesPatientGeneralInfoCrudListPage(
		...
		super(
			...
			"admin/entities/patient-general-info"
		);
