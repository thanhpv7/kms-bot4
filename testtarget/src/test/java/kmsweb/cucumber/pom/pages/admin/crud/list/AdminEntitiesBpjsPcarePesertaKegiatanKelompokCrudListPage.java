...
@Slf4j
@ScenarioScoped
public class AdminEntitiesBpjsPcarePesertaKegiatanKelompokCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesBpjsPcarePesertaKegiatanKelompokCrudListPage(
		...
		super(
			...
			"admin/entities/bpjs-pcare-peserta-kegiatan-kelompok"
		);
