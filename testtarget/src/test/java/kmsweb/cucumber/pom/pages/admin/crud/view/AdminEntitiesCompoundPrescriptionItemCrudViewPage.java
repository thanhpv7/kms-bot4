...
@Slf4j
@ScenarioScoped
public class AdminEntitiesCompoundPrescriptionItemCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesCompoundPrescriptionItemCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/compound-prescription-item/view"
		);
