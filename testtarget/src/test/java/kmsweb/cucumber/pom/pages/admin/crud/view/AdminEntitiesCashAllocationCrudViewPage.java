...
@Slf4j
@ScenarioScoped
public class AdminEntitiesCashAllocationCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesCashAllocationCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/cash-allocation/view"
		);
