...
/**
 * Room TransferPage is a Page POM that is associated with the admin/entities/room-transfer url.
 *
 */
@Slf4j
@ScenarioScoped
public class AdminEntitiesRoomTransferCrudEditPage extends CrudEdit {
	...
	@FindBy(how = How.XPATH, using = "//*[@id='transferringStaffName-field']")
	private WebElement transferringStaffNameField;
	...
	@FindBy(how = How.XPATH, using = "//ng-select[@id='transferringStaffId-field']")
	private WebElement transferringStaffField;
	...
	@Inject
	public AdminEntitiesRoomTransferCrudEditPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/room-transfer/create"
		);
	...
	{
		var entity = (RoomTransferEntity) abstractEntity;
		...
		transferringStaffNameField.sendKeys(entity.getTransferringStaffName());
