...
/**
 * Diagnostic Support Configuration is a Page POM associated with the 'diagnostic-support-configuration' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class DiagnosticSupportConfigurationPage extends AbstractPage {
	...
	@Inject
	public DiagnosticSupportConfigurationPage(
