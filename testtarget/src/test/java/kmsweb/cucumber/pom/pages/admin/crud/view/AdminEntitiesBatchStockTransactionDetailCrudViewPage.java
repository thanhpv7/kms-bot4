...
@Slf4j
@ScenarioScoped
public class AdminEntitiesBatchStockTransactionDetailCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesBatchStockTransactionDetailCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/batch-stock-transaction-detail/view"
		);
