...
/**
 * PCare MCU Wrapper is a Page POM associated with the 'pcare-mcu-wrapper' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class PcareMCUWrapperPage extends AbstractPage {
