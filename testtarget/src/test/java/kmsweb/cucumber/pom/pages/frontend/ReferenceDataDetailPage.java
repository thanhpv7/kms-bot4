...
/**
 * Reference Data Detail is a Page POM associated with the 'reference-data-detail' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class ReferenceDataDetailPage extends AbstractPage {
	...
	@Inject
	public ReferenceDataDetailPage(
