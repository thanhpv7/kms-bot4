...
/**
 * Medical Fee Item ComponentPage is a Page POM that is associated with the admin/entities/medical-fee-item-component url.
 *
 */
@Slf4j
@ScenarioScoped
public class AdminEntitiesMedicalFeeItemComponentCrudEditPage extends CrudEdit {
	...
	@Inject
	public AdminEntitiesMedicalFeeItemComponentCrudEditPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/medical-fee-item-component/create"
		);
	...
	{
		var entity = (MedicalFeeItemComponentEntity) abstractEntity;
