...
@Slf4j
@ScenarioScoped
public class AdminEntitiesReturnSupplierStockDetailCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesReturnSupplierStockDetailCrudListPage(
		...
		super(
			...
			"admin/entities/return-supplier-stock-detail"
		);
