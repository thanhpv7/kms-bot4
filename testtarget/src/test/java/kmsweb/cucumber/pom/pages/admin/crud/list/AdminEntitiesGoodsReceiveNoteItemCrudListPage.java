...
@Slf4j
@ScenarioScoped
public class AdminEntitiesGoodsReceiveNoteItemCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesGoodsReceiveNoteItemCrudListPage(
		...
		super(
			...
			"admin/entities/goods-receive-note-item"
		);
