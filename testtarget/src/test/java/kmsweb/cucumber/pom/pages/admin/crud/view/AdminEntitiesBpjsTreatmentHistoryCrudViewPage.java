...
@Slf4j
@ScenarioScoped
public class AdminEntitiesBpjsTreatmentHistoryCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesBpjsTreatmentHistoryCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/bpjs-treatment-history/view"
		);
