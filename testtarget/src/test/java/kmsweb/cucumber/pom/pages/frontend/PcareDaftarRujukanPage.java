...
/**
 * PCare Daftar Rujukan is a Page POM associated with the 'pcare-daftar-rujukan' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class PcareDaftarRujukanPage extends AbstractPage {
