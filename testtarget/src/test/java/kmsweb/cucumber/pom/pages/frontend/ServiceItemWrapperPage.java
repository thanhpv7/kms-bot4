...
/**
 * Service Item Wrapper is a Page POM associated with the 'service-item-wrapper' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class ServiceItemWrapperPage extends AbstractPage {
