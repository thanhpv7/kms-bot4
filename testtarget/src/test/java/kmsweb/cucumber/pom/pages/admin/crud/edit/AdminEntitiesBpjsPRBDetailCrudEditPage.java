...
/**
 * BPJS PRB DetailPage is a Page POM that is associated with the admin/entities/bpjs-prb-detail url.
 *
 */
@Slf4j
@ScenarioScoped
public class AdminEntitiesBpjsPRBDetailCrudEditPage extends CrudEdit {
	...
	@FindBy(how = How.XPATH, using = "//*[@id='signa1-field']")
	private WebElement signa1Field;
	@FindBy(how = How.XPATH, using = "//*[@id='signa2-field']")
	private WebElement signa2Field;
	...
	@Inject
	public AdminEntitiesBpjsPRBDetailCrudEditPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/bpjs-prb-detail/create"
		);
	...
	{
		var entity = (BpjsPRBDetailEntity) abstractEntity;
		srbNoField.sendKeys(entity.getSrbNo());
		drugCodeField.sendKeys(entity.getDrugCode());
		drugNameField.sendKeys(entity.getDrugName());
		signa1Field.sendKeys(entity.getSigna1());
		signa2Field.sendKeys(entity.getSigna2());
		qtyField.sendKeys(entity.getQty());
