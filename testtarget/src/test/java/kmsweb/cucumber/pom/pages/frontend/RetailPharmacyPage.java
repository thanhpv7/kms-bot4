...
/**
 * Retail Pharmacy is a Page POM associated with the 'retail-pharmacy' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class RetailPharmacyPage extends AbstractPage {
