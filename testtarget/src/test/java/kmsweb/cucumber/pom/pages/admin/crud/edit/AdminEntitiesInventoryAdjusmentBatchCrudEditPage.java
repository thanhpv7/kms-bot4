...
/**
 * Inventory Adjusment BatchPage is a Page POM that is associated with the admin/entities/inventory-adjusment-batch url.
 *
 */
@Slf4j
@ScenarioScoped
public class AdminEntitiesInventoryAdjusmentBatchCrudEditPage extends CrudEdit {
	...
	@FindBy(how = How.XPATH, using = "//ng-select[@id='inventoryAdjustmentItemId-field']")
	private WebElement inventoryAdjustmentItemField;
	...
	@Inject
	public AdminEntitiesInventoryAdjusmentBatchCrudEditPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/inventory-adjusment-batch/create"
		);
	...
	{
		var entity = (InventoryAdjusmentBatchEntity) abstractEntity;
