...
/**
 * Internal OrderPage is a Page POM that is associated with the admin/entities/internal-order url.
 *
 */
@Slf4j
@ScenarioScoped
public class AdminEntitiesInternalOrderCrudEditPage extends CrudEdit {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end


	@FindBy(how = How.XPATH, using = "//*[@id='internalOrderNumber-field']")
	private WebElement internalOrderNumberField;
	...
	@FindBy(how = How.XPATH, using = "//*[@id='requestUnit-field']")
	private WebElement requestUnitField;
	@FindBy(how = How.XPATH, using = "//*[@id='requestPerson-field']")
	private WebElement requestPersonField;
	...
	@Inject
	public AdminEntitiesInternalOrderCrudEditPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/internal-order/create"
		);
	...
	{
		var entity = (InternalOrderEntity) abstractEntity;
		internalOrderNumberField.sendKeys(entity.getInternalOrderNumber());
		...
		requestUnitField.sendKeys(entity.getRequestUnit());
		requestPersonField.sendKeys(entity.getRequestPerson());
