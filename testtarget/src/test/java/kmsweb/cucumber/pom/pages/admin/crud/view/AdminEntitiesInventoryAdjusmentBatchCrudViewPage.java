...
@Slf4j
@ScenarioScoped
public class AdminEntitiesInventoryAdjusmentBatchCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesInventoryAdjusmentBatchCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/inventory-adjusment-batch/view"
		);
