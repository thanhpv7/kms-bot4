...
/**
 * Medical Certificate HospitalizationPage is a Page POM that is associated with the admin/entities/medical-certificate-hospitalization url.
 *
 */
@Slf4j
@ScenarioScoped
public class AdminEntitiesMedicalCertificateHospitalizationCrudEditPage extends CrudEdit {
	...
	@Inject
	public AdminEntitiesMedicalCertificateHospitalizationCrudEditPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/medical-certificate-hospitalization/create"
		);
	...
	{
		var entity = (MedicalCertificateHospitalizationEntity) abstractEntity;
