...
/**
 * Stock Transaction Detail Report is a Page POM associated with the 'stock-transaction-detail-report' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class StockTransactionDetailReportPage extends AbstractPage {
	...
	@Inject
	public StockTransactionDetailReportPage(
