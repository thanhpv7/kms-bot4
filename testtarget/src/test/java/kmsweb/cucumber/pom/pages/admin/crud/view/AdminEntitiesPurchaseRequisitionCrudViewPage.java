...
@Slf4j
@ScenarioScoped
public class AdminEntitiesPurchaseRequisitionCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesPurchaseRequisitionCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/purchase-requisition/view"
		);
