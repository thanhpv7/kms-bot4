...
/**
 * Patient Receipt is a Page POM associated with the 'patient-receipt' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class PatientReceiptPage extends AbstractPage {
