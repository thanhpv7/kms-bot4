...
/**
 * Merchant Surcharge Fee is a Page POM associated with the 'merchant-surcharge-fee' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class MerchantSurchargeFeePage extends AbstractPage {
	...
	@Inject
	public MerchantSurchargeFeePage(
