...
@Slf4j
@ScenarioScoped
public class AdminEntitiesPurchaseOrderStockDetailCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesPurchaseOrderStockDetailCrudListPage(
		...
		super(
			...
			"admin/entities/purchase-order-stock-detail"
		);
