...
@Slf4j
@ScenarioScoped
public class AdminEntitiesGoodsReceiveNoteCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesGoodsReceiveNoteCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/goods-receive-note/view"
		);
