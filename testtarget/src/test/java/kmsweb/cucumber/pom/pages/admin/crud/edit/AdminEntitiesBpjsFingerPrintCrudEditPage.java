...
/**
 * BPJS Finger PrintPage is a Page POM that is associated with the admin/entities/bpjs-finger-print url.
 *
 */
@Slf4j
@ScenarioScoped
public class AdminEntitiesBpjsFingerPrintCrudEditPage extends CrudEdit {
	...
	@Inject
	public AdminEntitiesBpjsFingerPrintCrudEditPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/bpjs-finger-print/create"
		);
	...
	{
		var entity = (BpjsFingerPrintEntity) abstractEntity;
