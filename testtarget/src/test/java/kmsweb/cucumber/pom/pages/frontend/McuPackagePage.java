...
/**
 * MCU Package is a Page POM associated with the 'mcu-package' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class McuPackagePage extends AbstractPage {
