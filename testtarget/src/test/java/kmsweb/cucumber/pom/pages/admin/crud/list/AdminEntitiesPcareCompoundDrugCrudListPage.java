...
@Slf4j
@ScenarioScoped
public class AdminEntitiesPcareCompoundDrugCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesPcareCompoundDrugCrudListPage(
		...
		super(
			...
			"admin/entities/pcare-compound-drug"
		);
