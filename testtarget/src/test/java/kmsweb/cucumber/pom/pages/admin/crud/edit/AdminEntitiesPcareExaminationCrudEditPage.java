...
@Slf4j
@ScenarioScoped
public class AdminEntitiesPcareExaminationCrudEditPage extends CrudEdit {
	...
	// TODO default handling dataAttribute referringDateField;
	...
	// TODO default handling dataAttribute respiratoryRateField;
	...
	@Inject
	public AdminEntitiesPcareExaminationCrudEditPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/pcare-examination/create"
		);
	...
	{
		var entity = (PcareExaminationEntity) abstractEntity;
		visitTypeField.sendKeys(entity.getVisitType());
		treatmentField.sendKeys(entity.getTreatment());
		destinationPolyclinicField.sendKeys(entity.getDestinationPolyclinic());
		diseaseField.sendKeys(entity.getDisease());
		diagnosisField.sendKeys(entity.getDiagnosis());
		diagnosis2Field.sendKeys(entity.getDiagnosis2());
		diagnosis3Field.sendKeys(entity.getDiagnosis3());
		therapyField.sendKeys(entity.getTherapy());
		consciousnessField.sendKeys(entity.getConsciousness());
		dischargeStatusField.sendKeys(entity.getDischargeStatus());
		internalReferralPolyclinicField.sendKeys(entity.getInternalReferralPolyclinic());
		// TODO default handling for dataAttribute referringDateField
		referringDateField.sendKeys(entity.getReferringDate().toString());

		pkkField.sendKeys(entity.getPkk());
		subSpecialistField.sendKeys(entity.getSubSpecialist());
		facilityField.sendKeys(entity.getFacility());
		taccField.sendKeys(entity.getTacc());
		taccReasonField.sendKeys(entity.getTaccReason());
		specialField.sendKeys(entity.getSpecial());
		...
		// TODO default handling for dataAttribute respiratoryRateField
		respiratoryRateField.sendKeys(entity.getRespiratoryRate().toString());

		// TODO default handling for dataAttribute heartRateField
		heartRateField.sendKeys(entity.getHeartRate().toString());

		medicalStaffField.sendKeys(entity.getMedicalStaff());
		tglpulangField.sendKeys(entity.getTglpulang());
		kdsubspesialis1Field.sendKeys(entity.getKdsubspesialis1());
		rujuklanjutField.sendKeys(entity.getRujuklanjut());
		catatanField.sendKeys(entity.getCatatan());
		nokunjunganField.sendKeys(entity.getNokunjungan());
		jsoninsertField.sendKeys(entity.getJsoninsert());
		jsonupdateField.sendKeys(entity.getJsonupdate());
