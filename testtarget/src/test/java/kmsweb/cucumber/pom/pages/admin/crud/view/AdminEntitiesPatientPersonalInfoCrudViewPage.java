...
@Slf4j
@ScenarioScoped
public class AdminEntitiesPatientPersonalInfoCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesPatientPersonalInfoCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/patient-personal-info/view"
		);
