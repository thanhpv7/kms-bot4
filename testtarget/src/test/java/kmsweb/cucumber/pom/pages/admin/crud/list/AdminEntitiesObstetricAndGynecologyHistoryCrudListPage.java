...
@Slf4j
@ScenarioScoped
public class AdminEntitiesObstetricAndGynecologyHistoryCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesObstetricAndGynecologyHistoryCrudListPage(
		...
		super(
			...
			"admin/entities/obstetric-and-gynecology-history"
		);
