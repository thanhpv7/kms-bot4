...
/**
 * Medication Item is a Page POM associated with the 'medication-item' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class MedicationItemPage extends AbstractPage {
