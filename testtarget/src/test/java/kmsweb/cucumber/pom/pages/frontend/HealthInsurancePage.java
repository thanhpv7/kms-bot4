...
/**
 * Health Insurance is a Page POM associated with the 'health-insurance' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class HealthInsurancePage extends AbstractPage {
