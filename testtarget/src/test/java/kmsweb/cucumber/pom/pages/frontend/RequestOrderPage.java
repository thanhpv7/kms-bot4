...
/**
 * Request Order is a Page POM associated with the 'request-order' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class RequestOrderPage extends AbstractPage {
