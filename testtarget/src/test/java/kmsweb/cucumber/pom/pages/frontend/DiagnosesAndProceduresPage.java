...
/**
 * Diagnoses and Procedures is a Page POM associated with the 'diagnoses-and-procedures' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class DiagnosesAndProceduresPage extends AbstractPage {
	...
	@Inject
	public DiagnosesAndProceduresPage(
