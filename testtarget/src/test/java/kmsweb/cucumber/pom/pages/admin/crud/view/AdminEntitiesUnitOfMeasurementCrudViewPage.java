...
@Slf4j
@ScenarioScoped
public class AdminEntitiesUnitOfMeasurementCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesUnitOfMeasurementCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/unit-of-measurement/view"
		);
