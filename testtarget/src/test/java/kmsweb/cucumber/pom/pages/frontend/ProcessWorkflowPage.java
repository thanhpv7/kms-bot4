...
/**
 * Process Workflow is a Page POM associated with the 'process-workflow' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class ProcessWorkflowPage extends AbstractPage {
