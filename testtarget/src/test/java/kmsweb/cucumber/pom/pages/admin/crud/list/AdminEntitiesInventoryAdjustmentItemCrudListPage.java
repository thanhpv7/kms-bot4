...
@Slf4j
@ScenarioScoped
public class AdminEntitiesInventoryAdjustmentItemCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesInventoryAdjustmentItemCrudListPage(
		...
		super(
			...
			"admin/entities/inventory-adjustment-item"
		);
