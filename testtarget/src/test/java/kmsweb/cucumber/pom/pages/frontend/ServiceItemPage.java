...
/**
 * Service Item is a Page POM associated with the 'service-item' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class ServiceItemPage extends AbstractPage {
