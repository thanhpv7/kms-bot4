...
@Slf4j
@ScenarioScoped
public class AdminEntitiesBpjsTreatmentHistoryCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesBpjsTreatmentHistoryCrudListPage(
		...
		super(
			...
			"admin/entities/bpjs-treatment-history"
		);
