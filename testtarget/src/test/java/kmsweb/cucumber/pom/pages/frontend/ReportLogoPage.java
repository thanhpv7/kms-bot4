...
/**
 * Report Logo is a Page POM associated with the 'report-logo' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class ReportLogoPage extends AbstractPage {
