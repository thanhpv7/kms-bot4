...
@Slf4j
@ScenarioScoped
public class AdminEntitiesMedicalCertificateSickLeaveCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesMedicalCertificateSickLeaveCrudListPage(
		...
		super(
			...
			"admin/entities/medical-certificate-sick-leave"
		);
