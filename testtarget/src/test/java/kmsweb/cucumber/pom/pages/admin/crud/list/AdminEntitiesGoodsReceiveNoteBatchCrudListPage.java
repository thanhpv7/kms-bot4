...
@Slf4j
@ScenarioScoped
public class AdminEntitiesGoodsReceiveNoteBatchCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesGoodsReceiveNoteBatchCrudListPage(
		...
		super(
			...
			"admin/entities/goods-receive-note-batch"
		);
