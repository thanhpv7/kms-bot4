...
@Slf4j
@ScenarioScoped
public class AdminEntitiesBpjsSearchControlLetterCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesBpjsSearchControlLetterCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/bpjs-search-control-letter/view"
		);
