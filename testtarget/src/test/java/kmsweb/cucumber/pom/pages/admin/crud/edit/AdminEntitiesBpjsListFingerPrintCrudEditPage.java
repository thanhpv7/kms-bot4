...
/**
 * BPJS List Finger PrintPage is a Page POM that is associated with the admin/entities/bpjs-list-finger-print url.
 *
 */
@Slf4j
@ScenarioScoped
public class AdminEntitiesBpjsListFingerPrintCrudEditPage extends CrudEdit {
	...
	@Inject
	public AdminEntitiesBpjsListFingerPrintCrudEditPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/bpjs-list-finger-print/create"
		);
	...
	{
		var entity = (BpjsListFingerPrintEntity) abstractEntity;
