...
@Slf4j
@ScenarioScoped
public class AdminEntitiesBodyChartExaminationCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesBodyChartExaminationCrudListPage(
		...
		super(
			...
			"admin/entities/body-chart-examination"
		);
