...
@Slf4j
@ScenarioScoped
public class AdminEntitiesBpjsReferralSpecialistCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesBpjsReferralSpecialistCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/bpjs-referral-specialist/view"
		);
