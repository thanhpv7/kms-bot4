...
@Slf4j
@ScenarioScoped
public class AdminEntitiesMedicalCertificateBirthCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesMedicalCertificateBirthCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/medical-certificate-birth/view"
		);
