...
/**
 * Sample Collection Items is a Page POM associated with the 'sample-collection-items' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class SampleCollectionItemsPage extends AbstractPage {
	...
	@Inject
	public SampleCollectionItemsPage(
