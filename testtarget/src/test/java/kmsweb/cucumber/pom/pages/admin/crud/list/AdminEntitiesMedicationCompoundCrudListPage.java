...
@Slf4j
@ScenarioScoped
public class AdminEntitiesMedicationCompoundCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesMedicationCompoundCrudListPage(
		...
		super(
			...
			"admin/entities/medication-compound"
		);
