...
@Slf4j
@ScenarioScoped
public class AdminEntitiesNurseVitalSignMeasurementCrudEditPage extends CrudEdit {
	...
	@Inject
	public AdminEntitiesNurseVitalSignMeasurementCrudEditPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/nurse-vital-sign-measurement/create"
		);
	...
	{
		var entity = (NurseVitalSignMeasurementEntity) abstractEntity;
