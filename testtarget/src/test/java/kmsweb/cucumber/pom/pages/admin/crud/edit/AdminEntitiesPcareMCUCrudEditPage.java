...
@Slf4j
@ScenarioScoped
public class AdminEntitiesPcareMCUCrudEditPage extends CrudEdit {
	...
	@Inject
	public AdminEntitiesPcareMCUCrudEditPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/pcare-mcu/create"
		);
	...
	{
		var entity = (PcareMCUEntity) abstractEntity;
		kodeMCUField.sendKeys(entity.getKodeMCU());
		noKunjunganField.sendKeys(entity.getNoKunjungan());
		kodeProviderField.sendKeys(entity.getKodeProvider());
		namaProviderField.sendKeys(entity.getNamaProvider());
		tanggalPelayananField.sendKeys(entity.getTanggalPelayanan());
		sistoleField.sendKeys(entity.getSistole());
		diastoleField.sendKeys(entity.getDiastole());
		radiologiFotoField.sendKeys(entity.getRadiologiFoto());
		hemoglobinField.sendKeys(entity.getHemoglobin());
		leukositField.sendKeys(entity.getLeukosit());
		eritrositField.sendKeys(entity.getEritrosit());
		lajuEndapDarahField.sendKeys(entity.getLajuEndapDarah());
		hematokritField.sendKeys(entity.getHematokrit());
		trombositField.sendKeys(entity.getTrombosit());
		hdlField.sendKeys(entity.getHdl());
		ldlField.sendKeys(entity.getLdl());
		cholesterolField.sendKeys(entity.getCholesterol());
		trigliseridaField.sendKeys(entity.getTrigliserida());
		sewaktuField.sendKeys(entity.getSewaktu());
		puasaField.sendKeys(entity.getPuasa());
		postPrandialField.sendKeys(entity.getPostPrandial());
		hba1cField.sendKeys(entity.getHba1c());
		sgotField.sendKeys(entity.getSgot());
		sgptField.sendKeys(entity.getSgpt());
		gammaField.sendKeys(entity.getGamma());
		proteinKualitatifField.sendKeys(entity.getProteinKualitatif());
		albuminField.sendKeys(entity.getAlbumin());
		creatinineField.sendKeys(entity.getCreatinine());
		ureumField.sendKeys(entity.getUreum());
		asamField.sendKeys(entity.getAsam());
		abiField.sendKeys(entity.getAbi());
		ekgField.sendKeys(entity.getEkg());
		echoField.sendKeys(entity.getEcho());
		funduskopiField.sendKeys(entity.getFunduskopi());
		pemeriksaanLainField.sendKeys(entity.getPemeriksaanLain());
