...
/**
 * BPJS Referred Back is a Page POM associated with the 'bpjs-referred-back' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class BpjsReferredBackPage extends AbstractPage {
