...
/**
 * Refund Detail Report is a Page POM associated with the 'refund-detail-report' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class RefundDetailReportPage extends AbstractPage {
