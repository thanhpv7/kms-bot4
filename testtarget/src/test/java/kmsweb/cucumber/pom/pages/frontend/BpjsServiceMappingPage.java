...
/**
 * BPJS Service Mapping is a Page POM associated with the 'bpjs-service-mapping' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class BpjsServiceMappingPage extends AbstractPage {
