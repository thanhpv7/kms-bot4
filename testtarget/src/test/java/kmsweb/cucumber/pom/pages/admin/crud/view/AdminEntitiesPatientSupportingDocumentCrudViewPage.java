...
@Slf4j
@ScenarioScoped
public class AdminEntitiesPatientSupportingDocumentCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesPatientSupportingDocumentCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/patient-supporting-document/view"
		);
