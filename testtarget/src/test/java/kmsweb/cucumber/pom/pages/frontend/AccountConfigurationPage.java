...
/**
 * Account Configuration is a Page POM associated with the 'account-configuration' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class AccountConfigurationPage extends AbstractPage {
