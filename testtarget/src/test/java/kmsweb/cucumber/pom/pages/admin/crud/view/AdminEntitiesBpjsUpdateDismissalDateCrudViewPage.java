...
@Slf4j
@ScenarioScoped
public class AdminEntitiesBpjsUpdateDismissalDateCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesBpjsUpdateDismissalDateCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/bpjs-update-dismissal-date/view"
		);
