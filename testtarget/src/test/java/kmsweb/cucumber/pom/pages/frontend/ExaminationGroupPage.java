...
/**
 * Examination Group is a Page POM associated with the 'examination-group' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class ExaminationGroupPage extends AbstractPage {
