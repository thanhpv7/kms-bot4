...
/**
 * Prescription Detail is a Page POM associated with the 'prescription-detail' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class PrescriptionDetailPage extends AbstractPage {
