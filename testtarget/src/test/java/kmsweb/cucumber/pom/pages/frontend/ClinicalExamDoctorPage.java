...
/**
 * Clinical Exam Doctor is a Page POM associated with the 'clinical-exam-doctor' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class ClinicalExamDoctorPage extends AbstractPage {
