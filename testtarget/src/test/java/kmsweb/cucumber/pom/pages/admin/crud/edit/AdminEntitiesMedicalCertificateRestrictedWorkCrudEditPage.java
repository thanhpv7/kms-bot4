...
/**
 * Medical Certificate Restricted WorkPage is a Page POM that is associated with the admin/entities/medical-certificate-restricted-work url.
 *
 */
@Slf4j
@ScenarioScoped
public class AdminEntitiesMedicalCertificateRestrictedWorkCrudEditPage extends CrudEdit {
	...
	@Inject
	public AdminEntitiesMedicalCertificateRestrictedWorkCrudEditPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/medical-certificate-restricted-work/create"
		);
	...
	{
		var entity = (MedicalCertificateRestrictedWorkEntity) abstractEntity;
