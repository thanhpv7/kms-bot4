...
@Slf4j
@ScenarioScoped
public class AdminEntitiesStockTransactionDetailCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesStockTransactionDetailCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/stock-transaction-detail/view"
		);
