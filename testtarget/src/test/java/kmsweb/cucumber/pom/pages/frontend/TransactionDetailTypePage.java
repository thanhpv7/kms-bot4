...
/**
 * Transaction Detail Type is a Page POM associated with the 'transaction-detail-type' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class TransactionDetailTypePage extends AbstractPage {
	...
	@Inject
	public TransactionDetailTypePage(
