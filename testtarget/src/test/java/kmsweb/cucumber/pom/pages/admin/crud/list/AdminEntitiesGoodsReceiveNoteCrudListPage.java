...
@Slf4j
@ScenarioScoped
public class AdminEntitiesGoodsReceiveNoteCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesGoodsReceiveNoteCrudListPage(
		...
		super(
			...
			"admin/entities/goods-receive-note"
		);
