...
/**
 * BPJS Claim Data is a Page POM associated with the 'bpjs-claim-data' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class BpjsClaimDataPage extends AbstractPage {
