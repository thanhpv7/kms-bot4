...
@Slf4j
@ScenarioScoped
public class AdminEntitiesBpjsSEPInternalDataCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesBpjsSEPInternalDataCrudListPage(
		...
		super(
			...
			"admin/entities/bpjs-sep-internal-data"
		);
