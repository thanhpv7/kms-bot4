...
@Slf4j
@ScenarioScoped
public class AdminEntitiesPurchaseRequisitionCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesPurchaseRequisitionCrudListPage(
		...
		super(
			...
			"admin/entities/purchase-requisition"
		);
