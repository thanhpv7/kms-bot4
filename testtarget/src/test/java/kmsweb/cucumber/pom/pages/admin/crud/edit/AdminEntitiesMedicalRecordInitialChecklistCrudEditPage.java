...
/**
 * Medical Record Initial ChecklistPage is a Page POM that is associated with the admin/entities/medical-record-initial-checklist url.
 *
 */
@Slf4j
@ScenarioScoped
public class AdminEntitiesMedicalRecordInitialChecklistCrudEditPage extends CrudEdit {
	...
	@Inject
	public AdminEntitiesMedicalRecordInitialChecklistCrudEditPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/medical-record-initial-checklist/create"
		);
	...
	{
		var entity = (MedicalRecordInitialChecklistEntity) abstractEntity;
