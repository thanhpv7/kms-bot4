...
@Slf4j
@ScenarioScoped
public class AdminEntitiesPrescriptionHeaderCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesPrescriptionHeaderCrudListPage(
		...
		super(
			...
			"admin/entities/prescription-header"
		);
