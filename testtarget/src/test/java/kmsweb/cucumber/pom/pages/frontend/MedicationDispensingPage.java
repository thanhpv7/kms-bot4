...
/**
 * Medication Dispensing is a Page POM associated with the 'medication-dispensing' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class MedicationDispensingPage extends AbstractPage {
	...
	@Inject
	public MedicationDispensingPage(
