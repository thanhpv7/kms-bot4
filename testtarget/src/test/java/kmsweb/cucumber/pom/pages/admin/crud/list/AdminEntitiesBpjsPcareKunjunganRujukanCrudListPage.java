...
@Slf4j
@ScenarioScoped
public class AdminEntitiesBpjsPcareKunjunganRujukanCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesBpjsPcareKunjunganRujukanCrudListPage(
		...
		super(
			...
			"admin/entities/bpjs-pcare-kunjungan-rujukan"
		);
