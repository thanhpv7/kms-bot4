...
@Slf4j
@ScenarioScoped
public class AdminEntitiesBpjsPcareKunjunganRujukanCrudEditPage extends CrudEdit {
	...
	@Inject
	public AdminEntitiesBpjsPcareKunjunganRujukanCrudEditPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/bpjs-pcare-kunjungan-rujukan/create"
		);
	...
	{
		var entity = (BpjsPcareKunjunganRujukanEntity) abstractEntity;
		norujukanField.sendKeys(entity.getNorujukan());
		kdppkField.sendKeys(entity.getKdppk());
		nmppkField.sendKeys(entity.getNmppk());
		alamatField.sendKeys(entity.getAlamat());
		kdkcField.sendKeys(entity.getKdkc());
		nmkcField.sendKeys(entity.getNmkc());
		alamatkcField.sendKeys(entity.getAlamatkc());
		telpkcField.sendKeys(entity.getTelpkc());
		faxkcField.sendKeys(entity.getFaxkc());
		kdpropField.sendKeys(entity.getKdprop());
		kddatiField.sendKeys(entity.getKddati());
		nmdatiField.sendKeys(entity.getNmdati());
		kdkrField.sendKeys(entity.getKdkr());
		nmkrField.sendKeys(entity.getNmkr());
		alamatkrField.sendKeys(entity.getAlamatkr());
		telpkrField.sendKeys(entity.getTelpkr());
		faxkrField.sendKeys(entity.getFaxkr());
		...
		nokapstField.sendKeys(entity.getNokapst());
		nmpstField.sendKeys(entity.getNmpst());
		tgllahirField.sendKeys(entity.getTgllahir());
		pisaField.sendKeys(entity.getPisa());
		ketpisaField.sendKeys(entity.getKetpisa());
		sexField.sendKeys(entity.getSex());
		kddiag1Field.sendKeys(entity.getKddiag1());
		nmdiag1Field.sendKeys(entity.getNmdiag1());
		kddiag2Field.sendKeys(entity.getKddiag2());
		nmdiag2Field.sendKeys(entity.getNmdiag2());
		kddiag3Field.sendKeys(entity.getKddiag3());
		nmdiag3Field.sendKeys(entity.getNmdiag3());
		catatanField.sendKeys(entity.getCatatan());
		kddokterField.sendKeys(entity.getKddokter());
		nmdokterField.sendKeys(entity.getNmdokter());
		nmtaccField.sendKeys(entity.getNmtacc());
		alasantaccField.sendKeys(entity.getAlasantacc());
		infodendaField.sendKeys(entity.getInfodenda());
