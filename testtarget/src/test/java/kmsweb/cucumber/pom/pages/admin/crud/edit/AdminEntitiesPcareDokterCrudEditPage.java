...
/**
 * PCare DokterPage is a Page POM that is associated with the admin/entities/pcare-dokter url.
 *
 */
@Slf4j
@ScenarioScoped
public class AdminEntitiesPcareDokterCrudEditPage extends CrudEdit {
	...
	@Inject
	public AdminEntitiesPcareDokterCrudEditPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/pcare-dokter/create"
		);
	...
	{
		var entity = (PcareDokterEntity) abstractEntity;
