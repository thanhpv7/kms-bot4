...
/**
 * Internal Order Stock DetailPage is a Page POM that is associated with the admin/entities/internal-order-stock-detail url.
 *
 */
@Slf4j
@ScenarioScoped
public class AdminEntitiesInternalOrderStockDetailCrudEditPage extends CrudEdit {
	...
	@FindBy(how = How.XPATH, using = "//ng-select[@id='internalOrderId-field']")
	private WebElement internalOrderField;
	...
	@Inject
	public AdminEntitiesInternalOrderStockDetailCrudEditPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/internal-order-stock-detail/create"
		);
	...
	{
		var entity = (InternalOrderStockDetailEntity) abstractEntity;
