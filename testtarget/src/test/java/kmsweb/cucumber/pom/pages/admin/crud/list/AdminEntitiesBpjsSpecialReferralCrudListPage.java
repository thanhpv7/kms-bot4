...
@Slf4j
@ScenarioScoped
public class AdminEntitiesBpjsSpecialReferralCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesBpjsSpecialReferralCrudListPage(
		...
		super(
			...
			"admin/entities/bpjs-special-referral"
		);
