...
@Slf4j
@ScenarioScoped
public class AdminEntitiesNumberingSetupCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesNumberingSetupCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/numbering-setup/view"
		);
