...
/**
 * BPJS Configuration is a Page POM associated with the 'bpjs-configuration' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class BpjsConfigurationPage extends AbstractPage {
