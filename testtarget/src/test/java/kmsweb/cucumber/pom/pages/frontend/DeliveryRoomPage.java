...
/**
 * Delivery Room is a Page POM associated with the 'delivery-room' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class DeliveryRoomPage extends AbstractPage {
