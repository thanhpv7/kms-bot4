...
@Slf4j
@ScenarioScoped
public class AdminEntitiesPatientCaseHistoryCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesPatientCaseHistoryCrudListPage(
		...
		super(
			...
			"admin/entities/patient-case-history"
		);
