...
/**
 * PCare Status Pulang is a Page POM associated with the 'pcare-status-pulang' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class PcareStatusPulangPage extends AbstractPage {
