...
/**
 * Clinical Exam Nurse is a Page POM associated with the 'clinical-exam-nurse' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class ClinicalExamNursePage extends AbstractPage {
