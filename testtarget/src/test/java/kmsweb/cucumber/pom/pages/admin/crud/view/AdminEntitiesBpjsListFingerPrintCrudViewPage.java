...
@Slf4j
@ScenarioScoped
public class AdminEntitiesBpjsListFingerPrintCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesBpjsListFingerPrintCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/bpjs-list-finger-print/view"
		);
