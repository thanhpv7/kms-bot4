...
@Slf4j
@ScenarioScoped
public class AdminEntitiesRetailPharmacyCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesRetailPharmacyCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/retail-pharmacy/view"
		);
