...
@Slf4j
@ScenarioScoped
public class AdminEntitiesOperatingTheaterMedicalExaminationRecordCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesOperatingTheaterMedicalExaminationRecordCrudListPage(
		...
		super(
			...
			"admin/entities/operating-theater-medical-examination-record"
		);
