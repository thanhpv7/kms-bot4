...
@Slf4j
@ScenarioScoped
public class AdminEntitiesMedicalCertificateDischargeResumeCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesMedicalCertificateDischargeResumeCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/medical-certificate-discharge-resume/view"
		);
