...
@Slf4j
@ScenarioScoped
public class AdminEntitiesInpatientMedicalExaminationRecordCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesInpatientMedicalExaminationRecordCrudListPage(
		...
		super(
			...
			"admin/entities/inpatient-medical-examination-record"
		);
