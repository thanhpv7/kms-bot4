...
@Slf4j
@ScenarioScoped
public class AdminEntitiesTariffPackageCrudEditPage extends CrudEdit {
	...
	@Inject
	public AdminEntitiesTariffPackageCrudEditPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/tariff-package/create"
		);
	...
	{
		var entity = (TariffPackageEntity) abstractEntity;
		tariffPackageCodeField.sendKeys(entity.getTariffPackageCode());
		tariffPackageNameField.sendKeys(entity.getTariffPackageName());
