...
/**
 * Operational Dashboard is a Page POM associated with the 'operational-dashboard' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class OperationalDashboardPage extends AbstractPage {
	...
	@Inject
	public OperationalDashboardPage(
