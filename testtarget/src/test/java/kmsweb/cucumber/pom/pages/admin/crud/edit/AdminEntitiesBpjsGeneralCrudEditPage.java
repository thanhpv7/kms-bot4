...
@Slf4j
@ScenarioScoped
public class AdminEntitiesBpjsGeneralCrudEditPage extends CrudEdit {
	...
	@Inject
	public AdminEntitiesBpjsGeneralCrudEditPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/bpjs-general/create"
		);
	...
	{
		var entity = (BpjsGeneralEntity) abstractEntity;
		consIDField.sendKeys(entity.getConsID());
		secretKeyField.sendKeys(entity.getSecretKey());
		bpjsWebServiceURLField.sendKeys(entity.getBpjsWebServiceURL());
		aplicareWebServiceURLField.sendKeys(entity.getAplicareWebServiceURL());
		...
		mjknWSBPJSURLField.sendKeys(entity.getMjknWSBPJSURL());
		mjknWSBPJSUserKeyField.sendKeys(entity.getMjknWSBPJSUserKey());
		vclaimUserKeyField.sendKeys(entity.getVclaimUserKey());
		if (entity.getConnectToOtherSystem()) {
			connectToOtherSystemField.click();
		}
		if (entity.getIsmobilejkn()) {
			ismobilejknField.click();
		}
		externalSystemURLField.sendKeys(entity.getExternalSystemURL());
		if (entity.getBasicAuth()) {
			basicAuthField.click();
		}
		basicAuthUsernameField.sendKeys(entity.getBasicAuthUsername());
		basicAuthPasswordField.sendKeys(entity.getBasicAuthPassword());
		if (entity.getBypassSSLValidation()) {
			bypassSSLValidationField.click();
		}
		if (entity.getClaimStatus()) {
			claimStatusField.click();
		}
		facilityTypeField.sendKeys(entity.getFacilityType());
		if (entity.getSendNonJKN()) {
			sendNonJKNField.click();
		}
		if (entity.getVclaimIntegration()) {
			vclaimIntegrationField.click();
		}
		externalVclaimServiceURLField.sendKeys(entity.getExternalVclaimServiceURL());
