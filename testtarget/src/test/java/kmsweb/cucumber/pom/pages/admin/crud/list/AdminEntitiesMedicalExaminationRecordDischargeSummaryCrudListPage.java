...
@Slf4j
@ScenarioScoped
public class AdminEntitiesMedicalExaminationRecordDischargeSummaryCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesMedicalExaminationRecordDischargeSummaryCrudListPage(
		...
		super(
			...
			"admin/entities/medical-examination-record-discharge-summary"
		);
