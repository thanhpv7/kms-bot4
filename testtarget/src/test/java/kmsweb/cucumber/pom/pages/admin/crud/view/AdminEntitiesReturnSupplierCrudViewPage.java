...
@Slf4j
@ScenarioScoped
public class AdminEntitiesReturnSupplierCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesReturnSupplierCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/return-supplier/view"
		);
