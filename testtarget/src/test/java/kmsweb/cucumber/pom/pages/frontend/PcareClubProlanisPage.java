...
/**
 * PCare Club Prolanis is a Page POM associated with the 'pcare-club-prolanis' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class PcareClubProlanisPage extends AbstractPage {
