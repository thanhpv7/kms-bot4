...
/**
 * Postoperative Details is a Page POM associated with the 'postoperative-details' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class PostoperativeDetailsPage extends AbstractPage {
	...
	@Inject
	public PostoperativeDetailsPage(
