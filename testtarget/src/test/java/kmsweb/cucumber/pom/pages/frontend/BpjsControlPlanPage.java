...
/**
 * BPJS Control Plan is a Page POM associated with the 'bpjs-control-plan' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class BpjsControlPlanPage extends AbstractPage {
