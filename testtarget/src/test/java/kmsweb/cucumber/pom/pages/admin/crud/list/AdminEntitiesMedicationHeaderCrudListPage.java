...
@Slf4j
@ScenarioScoped
public class AdminEntitiesMedicationHeaderCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesMedicationHeaderCrudListPage(
		...
		super(
			...
			"admin/entities/medication-header"
		);
