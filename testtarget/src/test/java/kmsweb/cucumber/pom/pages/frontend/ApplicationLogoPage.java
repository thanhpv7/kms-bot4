...
/**
 * Application Logo is a Page POM associated with the 'application-logo' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class ApplicationLogoPage extends AbstractPage {
