...
/**
 * Outpatient Examination is a Page POM associated with the 'outpatient-examination' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class OutpatientExaminationPage extends AbstractPage {
	...
	@Inject
	public OutpatientExaminationPage(
