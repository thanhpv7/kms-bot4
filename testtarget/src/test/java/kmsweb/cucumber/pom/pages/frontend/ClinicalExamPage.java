...
/**
 * Clinical Exam is a Page POM associated with the 'clinical-exam' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class ClinicalExamPage extends AbstractPage {
