...
/**
 * Goods Received Note is a Page POM associated with the 'goods-received-note' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class GoodsReceivedNotePage extends AbstractPage {
