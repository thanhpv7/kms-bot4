...
@Slf4j
@ScenarioScoped
public class AdminEntitiesDiagnosisExaminationRecordCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesDiagnosisExaminationRecordCrudListPage(
		...
		super(
			...
			"admin/entities/diagnosis-examination-record"
		);
