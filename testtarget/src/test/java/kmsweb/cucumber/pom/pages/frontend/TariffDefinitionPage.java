...
/**
 * Tariff Definition is a Page POM associated with the 'tariff-definition' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class TariffDefinitionPage extends AbstractPage {
