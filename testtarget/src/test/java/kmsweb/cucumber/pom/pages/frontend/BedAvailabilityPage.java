...
/**
 * Bed Availability is a Page POM associated with the 'bed-availability' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class BedAvailabilityPage extends AbstractPage {
