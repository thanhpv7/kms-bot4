...
@Slf4j
@ScenarioScoped
public class AdminEntitiesPcareNonCompoundDrugCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesPcareNonCompoundDrugCrudListPage(
		...
		super(
			...
			"admin/entities/pcare-noncompound-drug"
		);
