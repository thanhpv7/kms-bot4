...
@Slf4j
@ScenarioScoped
public class AdminEntitiesPatientDetailAddressCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesPatientDetailAddressCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/patient-detail-address/view"
		);
