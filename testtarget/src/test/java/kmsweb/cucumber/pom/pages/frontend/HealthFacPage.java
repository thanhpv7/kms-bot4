...
/**
 * Health Fac is a Page POM associated with the 'health-fac' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class HealthFacPage extends AbstractPage {
