...
/**
 * Warehouse Inventory is a Page POM associated with the 'warehouse-inventory' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class WarehouseInventoryPage extends AbstractPage {
