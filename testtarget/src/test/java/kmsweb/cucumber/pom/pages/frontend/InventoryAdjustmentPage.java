...
/**
 * Inventory Adjustment is a Page POM associated with the 'inventory-adjustment' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class InventoryAdjustmentPage extends AbstractPage {
