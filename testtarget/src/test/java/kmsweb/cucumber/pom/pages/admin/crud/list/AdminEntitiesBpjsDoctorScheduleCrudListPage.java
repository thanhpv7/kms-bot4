...
@Slf4j
@ScenarioScoped
public class AdminEntitiesBpjsDoctorScheduleCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesBpjsDoctorScheduleCrudListPage(
		...
		super(
			...
			"admin/entities/bpjs-doctor-schedule"
		);
