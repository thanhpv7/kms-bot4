...
@Slf4j
@ScenarioScoped
public class AdminEntitiesPriceComponentCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesPriceComponentCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/price-component/view"
		);
