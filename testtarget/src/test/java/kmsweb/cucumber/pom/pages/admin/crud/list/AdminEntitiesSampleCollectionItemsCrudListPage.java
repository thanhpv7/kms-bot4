...
@Slf4j
@ScenarioScoped
public class AdminEntitiesSampleCollectionItemsCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesSampleCollectionItemsCrudListPage(
		...
		super(
			...
			"admin/entities/sample-collection-items"
		);
