...
/**
 * Critical Care is a Page POM associated with the 'critical-care' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class CriticalCarePage extends AbstractPage {
