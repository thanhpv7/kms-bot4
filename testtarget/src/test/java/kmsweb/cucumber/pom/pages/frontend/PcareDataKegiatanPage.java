...
/**
 * PCare Data Kegiatan is a Page POM associated with the 'pcare-data-kegiatan' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class PcareDataKegiatanPage extends AbstractPage {
