...
@Slf4j
@ScenarioScoped
public class AdminEntitiesPatientConsentCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesPatientConsentCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/patient-consent/view"
		);
