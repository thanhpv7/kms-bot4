...
/**
 * BPJS Task History is a Page POM associated with the 'bpjs-task-history' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class BpjsTaskHistoryPage extends AbstractPage {
