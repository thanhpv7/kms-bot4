...
/**
 * Satu Sehat Configuration is a Page POM associated with the 'satu-sehat-configuration' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class SatuSehatConfigurationPage extends AbstractPage {
	...
	@Inject
	public SatuSehatConfigurationPage(
