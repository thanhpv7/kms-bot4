...
@Slf4j
@ScenarioScoped
public class AdminEntitiesHemodialysisExaminationCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesHemodialysisExaminationCrudListPage(
		...
		super(
			...
			"admin/entities/hemodialysis-examination"
		);
