...
@Slf4j
@ScenarioScoped
public class AdminEntitiesMedicalCertificateDischargeResumeCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesMedicalCertificateDischargeResumeCrudListPage(
		...
		super(
			...
			"admin/entities/medical-certificate-discharge-resume"
		);
