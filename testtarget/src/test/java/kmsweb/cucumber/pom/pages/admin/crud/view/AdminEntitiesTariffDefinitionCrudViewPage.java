...
@Slf4j
@ScenarioScoped
public class AdminEntitiesTariffDefinitionCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesTariffDefinitionCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/tariff-definition/view"
		);
