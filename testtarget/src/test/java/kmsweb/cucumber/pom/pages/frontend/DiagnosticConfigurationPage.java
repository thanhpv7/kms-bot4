...
/**
 * Diagnostic Configuration is a Page POM associated with the 'diagnostic-configuration' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class DiagnosticConfigurationPage extends AbstractPage {
	...
	@Inject
	public DiagnosticConfigurationPage(
