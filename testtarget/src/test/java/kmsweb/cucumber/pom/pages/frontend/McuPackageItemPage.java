...
/**
 * MCU Package Item is a Page POM associated with the 'mcu-package-item' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class McuPackageItemPage extends AbstractPage {
