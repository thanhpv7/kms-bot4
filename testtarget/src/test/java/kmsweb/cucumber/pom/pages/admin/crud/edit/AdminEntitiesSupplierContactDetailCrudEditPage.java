...
/**
 * Supplier Contact DetailPage is a Page POM that is associated with the admin/entities/supplier-contact-detail url.
 *
 */
@Slf4j
@ScenarioScoped
public class AdminEntitiesSupplierContactDetailCrudEditPage extends CrudEdit {
	...
	@Inject
	public AdminEntitiesSupplierContactDetailCrudEditPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/supplier-contact-detail/create"
		);
	...
	{
		var entity = (SupplierContactDetailEntity) abstractEntity;
		...
		extField.sendKeys(entity.getExt());
