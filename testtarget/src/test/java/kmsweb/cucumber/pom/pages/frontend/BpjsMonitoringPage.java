...
/**
 * BPJS Monitoring is a Page POM associated with the 'bpjs-monitoring' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class BpjsMonitoringPage extends AbstractPage {
