...
/**
 * Price Component is a Page POM associated with the 'price-component' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class PriceComponentPage extends AbstractPage {
