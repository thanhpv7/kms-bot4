...
/**
 * Chart of Account Mapping is a Page POM associated with the 'chart-of-account-mapping' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class ChartOfAccountMappingPage extends AbstractPage {
	...
	@Inject
	public ChartOfAccountMappingPage(
