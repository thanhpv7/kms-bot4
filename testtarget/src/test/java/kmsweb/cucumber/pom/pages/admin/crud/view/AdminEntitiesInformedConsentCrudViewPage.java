...
@Slf4j
@ScenarioScoped
public class AdminEntitiesInformedConsentCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesInformedConsentCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/informed-consent/view"
		);
