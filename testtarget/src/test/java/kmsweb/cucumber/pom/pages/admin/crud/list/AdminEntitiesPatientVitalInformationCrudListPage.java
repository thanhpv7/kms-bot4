...
@Slf4j
@ScenarioScoped
public class AdminEntitiesPatientVitalInformationCrudListPage extends CrudList {

	// % protected region % [Add any additional fields here] off begin
	// % protected region % [Add any additional fields here] end

	@Inject
	public AdminEntitiesPatientVitalInformationCrudListPage(
		...
		super(
			...
			"admin/entities/patient-vital-information"
		);
