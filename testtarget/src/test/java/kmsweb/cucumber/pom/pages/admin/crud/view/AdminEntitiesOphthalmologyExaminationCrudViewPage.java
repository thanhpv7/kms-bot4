...
@Slf4j
@ScenarioScoped
public class AdminEntitiesOphthalmologyExaminationCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesOphthalmologyExaminationCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/ophthalmology-examination/view"
		);
