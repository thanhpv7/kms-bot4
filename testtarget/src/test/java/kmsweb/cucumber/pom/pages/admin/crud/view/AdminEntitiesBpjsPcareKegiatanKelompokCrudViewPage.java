...
@Slf4j
@ScenarioScoped
public class AdminEntitiesBpjsPcareKegiatanKelompokCrudViewPage extends CrudView {
	...
	@Inject
	public AdminEntitiesBpjsPcareKegiatanKelompokCrudViewPage(
		...
		super(
			...
			webDriver,
			properties,
			"admin/entities/bpjs-pcare-kegiatan-kelompok/view"
		);
