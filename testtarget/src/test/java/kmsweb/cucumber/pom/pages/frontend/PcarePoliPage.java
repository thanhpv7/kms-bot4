...
/**
 * Pcare Poli is a Page POM associated with the 'pcare-poli' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class PcarePoliPage extends AbstractPage {
