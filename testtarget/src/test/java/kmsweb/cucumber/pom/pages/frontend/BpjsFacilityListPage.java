...
/**
 * BPJS Facility List is a Page POM associated with the 'bpjs-facility-list' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class BpjsFacilityListPage extends AbstractPage {
