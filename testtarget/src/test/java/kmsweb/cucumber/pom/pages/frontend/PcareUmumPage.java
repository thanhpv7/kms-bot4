...
/**
 * PCare Umum is a Page POM associated with the 'pcare-umum' url in the application frontend
 */
@Slf4j
@ScenarioScoped
public class PcareUmumPage extends AbstractPage {
