...
public class WaitUtils {
	...
	/**
	 * Similar to {@link #waitForUrl(WebDriver, String)} with the key difference being the match is performed with regex.
	 * @param webDriver The web driver in use
	 * @param regex The regex to using in matching the url
	 */
	public static void waitForUrlMatch(@NonNull WebDriver webDriver, String regex) {
		waitForPage(webDriver);
		getWaitDriver(webDriver).until(driver -> driver.getCurrentUrl().matches(regex));
	}
