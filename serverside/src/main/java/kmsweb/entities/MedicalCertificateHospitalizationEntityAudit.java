...
@ToString
public class MedicalCertificateHospitalizationEntityAudit extends AbstractEntityAudit<MedicalCertificateHospitalizationEntity> {
	...
	public MedicalCertificateHospitalizationEntityAudit(
			...
			MedicalCertificateHospitalizationEntity entity,
