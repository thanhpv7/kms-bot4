...
@ToString
public class TransactionDetailTypeMappingEntityAudit extends AbstractEntityAudit<TransactionDetailTypeMappingEntity> {
	...
	public TransactionDetailTypeMappingEntityAudit(
			...
			TransactionDetailTypeMappingEntity entity,
