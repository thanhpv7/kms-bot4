...
@ToString
public class PcareStatusPulangEntityAudit extends AbstractEntityAudit<PcareStatusPulangEntity> {
	...
	public PcareStatusPulangEntityAudit(
			...
			PcareStatusPulangEntity entity,
