...
@ToString
public class PcareClubProlanisEntityAudit extends AbstractEntityAudit<PcareClubProlanisEntity> {
	...
	public PcareClubProlanisEntityAudit(
			...
			PcareClubProlanisEntity entity,
