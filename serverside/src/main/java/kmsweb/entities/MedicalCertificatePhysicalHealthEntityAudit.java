...
@ToString
public class MedicalCertificatePhysicalHealthEntityAudit extends AbstractEntityAudit<MedicalCertificatePhysicalHealthEntity> {
	...
	public MedicalCertificatePhysicalHealthEntityAudit(
			...
			MedicalCertificatePhysicalHealthEntity entity,
