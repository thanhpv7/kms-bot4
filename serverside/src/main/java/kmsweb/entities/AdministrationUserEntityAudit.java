...
@ToString
public class AdministrationUserEntityAudit extends AbstractEntityAudit<AdministrationUserEntity> {
	...
	public AdministrationUserEntityAudit(
			...
			AdministrationUserEntity entity,
