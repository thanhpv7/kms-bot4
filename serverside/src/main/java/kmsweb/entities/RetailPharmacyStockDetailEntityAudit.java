...
@ToString
public class RetailPharmacyStockDetailEntityAudit extends AbstractEntityAudit<RetailPharmacyStockDetailEntity> {
	...
	public RetailPharmacyStockDetailEntityAudit(
			...
			RetailPharmacyStockDetailEntity entity,
