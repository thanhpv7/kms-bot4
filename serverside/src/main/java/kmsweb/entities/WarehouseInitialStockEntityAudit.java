...
@ToString
public class WarehouseInitialStockEntityAudit extends AbstractEntityAudit<WarehouseInitialStockEntity> {
	...
	public WarehouseInitialStockEntityAudit(
			...
			WarehouseInitialStockEntity entity,
