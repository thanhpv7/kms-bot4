...
@ToString
public class BpjsSEPInternalDataEntityAudit extends AbstractEntityAudit<BpjsSEPInternalDataEntity> {
	...
	public BpjsSEPInternalDataEntityAudit(
			...
			BpjsSEPInternalDataEntity entity,
