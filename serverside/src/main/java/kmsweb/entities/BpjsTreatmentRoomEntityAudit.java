...
@ToString
public class BpjsTreatmentRoomEntityAudit extends AbstractEntityAudit<BpjsTreatmentRoomEntity> {
	...
	public BpjsTreatmentRoomEntityAudit(
			...
			BpjsTreatmentRoomEntity entity,
