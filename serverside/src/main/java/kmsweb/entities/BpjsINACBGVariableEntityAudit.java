...
@ToString
public class BpjsINACBGVariableEntityAudit extends AbstractEntityAudit<BpjsINACBGVariableEntity> {
	...
	public BpjsINACBGVariableEntityAudit(
			...
			BpjsINACBGVariableEntity entity,
