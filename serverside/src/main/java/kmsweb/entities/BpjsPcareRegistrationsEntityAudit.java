...
@ToString
public class BpjsPcareRegistrationsEntityAudit extends AbstractEntityAudit<BpjsPcareRegistrationsEntity> {
	...
	public BpjsPcareRegistrationsEntityAudit(
			...
			BpjsPcareRegistrationsEntity entity,
