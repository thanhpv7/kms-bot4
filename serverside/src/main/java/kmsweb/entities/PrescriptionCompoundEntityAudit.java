...
@ToString
public class PrescriptionCompoundEntityAudit extends AbstractEntityAudit<PrescriptionCompoundEntity> {
	...
	public PrescriptionCompoundEntityAudit(
			...
			PrescriptionCompoundEntity entity,
