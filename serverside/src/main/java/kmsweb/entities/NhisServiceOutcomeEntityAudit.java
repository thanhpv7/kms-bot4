...
@ToString
public class NhisServiceOutcomeEntityAudit extends AbstractEntityAudit<NhisServiceOutcomeEntity> {
	...
	public NhisServiceOutcomeEntityAudit(
			...
			NhisServiceOutcomeEntity entity,
