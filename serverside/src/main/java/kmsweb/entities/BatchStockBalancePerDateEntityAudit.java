...
@ToString
public class BatchStockBalancePerDateEntityAudit extends AbstractEntityAudit<BatchStockBalancePerDateEntity> {
	...
	public BatchStockBalancePerDateEntityAudit(
			...
			BatchStockBalancePerDateEntity entity,
