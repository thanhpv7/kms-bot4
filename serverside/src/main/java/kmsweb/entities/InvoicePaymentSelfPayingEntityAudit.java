...
@ToString
public class InvoicePaymentSelfPayingEntityAudit extends AbstractEntityAudit<InvoicePaymentSelfPayingEntity> {
	...
	public InvoicePaymentSelfPayingEntityAudit(
			...
			InvoicePaymentSelfPayingEntity entity,
