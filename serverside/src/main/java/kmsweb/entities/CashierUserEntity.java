...
import kmsweb.entities.listeners.CashierUserEntityListener;
import kmsweb.serializers.CashierUserSerializer;
...
@EntityListeners({CashierUserEntityListener.class, AuditingEntityListener.class})
@JsonSerialize(using = CashierUserSerializer.class)
@Table(
	uniqueConstraints = {
	}
)
public class CashierUserEntity extends UserEntity {

	/**
	 * Takes a CashierUserEntityDto and converts it into a CashierUserEntity.
	 * Primarily used when endpoints are invoked, as they take DTOs as input, which need to be converted to the entity type
	 *
	 * @param cashierUserEntityDto
	 */
	public CashierUserEntity(CashierUserEntityDto cashierUserEntityDto) {
		// Need to account for potential that any field is empty.  This will be run before any server validation and
		// endpoints will most likely not be subject to clientside validation

		if (cashierUserEntityDto.getId() != null) {
			this.setId(cashierUserEntityDto.getId());
		}

		if (cashierUserEntityDto.getStaff() != null) {
			this.setStaff(cashierUserEntityDto.getStaff());
		}
	...
	@OneToOne(mappedBy = "cashierUser", cascade = {CascadeType.MERGE}, fetch = FetchType.LAZY)
	@CsvIgnore
	 ...
	 *
	 * @param entity the CashierUserEntity to be set or updated
	...
	public void setStaff(@NotNull StaffEntity entity, boolean reverseAdd) {
		...
		if (this.staff != null) {
			this.staff.unsetCashierUser();
		}

		this.staff = entity;

		if (reverseAdd) {
			this.staff.setCashierUser(this, false);
		}
	...
	public void unsetStaff(boolean reverse) {
		if (reverse && this.staff != null) {
			this.staff.unsetCashierUser(false);
		}
		this.staff = null;
	}
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	@Override
	public boolean equals(Object cashierUser) {
		if (this == cashierUser) {
			return true;
		}
		if (cashierUser == null || this.getClass() != cashierUser.getClass()) {
			return false;
		}
		if (!super.equals(cashierUser)) {
			return false;
		}

		// Compare references by ids only
		this.addRelationEntitiesToIdSet();
		CashierUserEntity that = (CashierUserEntity) cashierUser;
		return
