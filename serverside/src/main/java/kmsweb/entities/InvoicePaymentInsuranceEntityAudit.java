...
@ToString
public class InvoicePaymentInsuranceEntityAudit extends AbstractEntityAudit<InvoicePaymentInsuranceEntity> {
	...
	public InvoicePaymentInsuranceEntityAudit(
			...
			InvoicePaymentInsuranceEntity entity,
