...
@ToString
public class PatientPaymentSelfPayingEntityAudit extends AbstractEntityAudit<PatientPaymentSelfPayingEntity> {
	...
	public PatientPaymentSelfPayingEntityAudit(
			...
			PatientPaymentSelfPayingEntity entity,
