...
@ToString
public class FluidBalanceDetailEntityAudit extends AbstractEntityAudit<FluidBalanceDetailEntity> {
	...
	public FluidBalanceDetailEntityAudit(
			...
			FluidBalanceDetailEntity entity,
