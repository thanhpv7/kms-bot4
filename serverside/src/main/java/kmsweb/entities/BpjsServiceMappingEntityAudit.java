...
@ToString
public class BpjsServiceMappingEntityAudit extends AbstractEntityAudit<BpjsServiceMappingEntity> {
	...
	public BpjsServiceMappingEntityAudit(
			...
			BpjsServiceMappingEntity entity,
