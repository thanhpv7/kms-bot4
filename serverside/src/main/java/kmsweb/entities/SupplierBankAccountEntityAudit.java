...
@ToString
public class SupplierBankAccountEntityAudit extends AbstractEntityAudit<SupplierBankAccountEntity> {
	...
	public SupplierBankAccountEntityAudit(
			...
			SupplierBankAccountEntity entity,
