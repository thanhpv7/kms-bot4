...
@ToString
public class GoodsReceiveNoteItemEntityAudit extends AbstractEntityAudit<GoodsReceiveNoteItemEntity> {
	...
	public GoodsReceiveNoteItemEntityAudit(
			...
			GoodsReceiveNoteItemEntity entity,
