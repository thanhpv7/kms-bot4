...
@ToString
public class PatientEmergencyContactDetailEntityAudit extends AbstractEntityAudit<PatientEmergencyContactDetailEntity> {
	...
	public PatientEmergencyContactDetailEntityAudit(
			...
			PatientEmergencyContactDetailEntity entity,
