...
import kmsweb.entities.listeners.MedicalCertificateSickLeaveEntityListener;
import kmsweb.serializers.MedicalCertificateSickLeaveSerializer;
...
@EntityListeners({MedicalCertificateSickLeaveEntityListener.class, AuditingEntityListener.class})
@JsonSerialize(using = MedicalCertificateSickLeaveSerializer.class)
@Table(
	uniqueConstraints = {
	}
)
public class MedicalCertificateSickLeaveEntity extends AbstractEntity {

	/**
	 * Takes a MedicalCertificateSickLeaveEntityDto and converts it into a MedicalCertificateSickLeaveEntity.
	 * Primarily used when endpoints are invoked, as they take DTOs as input, which need to be converted to the entity type
	 *
	 * @param medicalCertificateSickLeaveEntityDto
	 */
	public MedicalCertificateSickLeaveEntity(MedicalCertificateSickLeaveEntityDto medicalCertificateSickLeaveEntityDto) {
		// Need to account for potential that any field is empty.  This will be run before any server validation and
		// endpoints will most likely not be subject to clientside validation

		if (medicalCertificateSickLeaveEntityDto.getId() != null) {
			this.setId(medicalCertificateSickLeaveEntityDto.getId());
		}

		if (medicalCertificateSickLeaveEntityDto.getPeriod() != null) {
			this.setPeriod(medicalCertificateSickLeaveEntityDto.getPeriod());
		}

		if (medicalCertificateSickLeaveEntityDto.getStartDate() != null) {
			this.setStartDate(medicalCertificateSickLeaveEntityDto.getStartDate());
		}

		if (medicalCertificateSickLeaveEntityDto.getEndDate() != null) {
			this.setEndDate(medicalCertificateSickLeaveEntityDto.getEndDate());
		}

		if (medicalCertificateSickLeaveEntityDto.getNotes() != null) {
			this.setNotes(medicalCertificateSickLeaveEntityDto.getNotes());
		}

		if (medicalCertificateSickLeaveEntityDto.getRegistration() != null) {
			this.setRegistration(medicalCertificateSickLeaveEntityDto.getRegistration());
		}

		if (medicalCertificateSickLeaveEntityDto.getMedicalStaff() != null) {
			this.setMedicalStaff(medicalCertificateSickLeaveEntityDto.getMedicalStaff());
		}
	...
	public void setRegistration(RegistrationEntity entity, boolean reverseAdd) {
		...
		if (this.registration != null) {
			this.registration.unsetMedicalCertificateSickLeave(false);
		}

		this.registration = entity;
		if (reverseAdd) {
			this.registration.setMedicalCertificateSickLeave(this, false);
		}
	...
	public void unsetRegistration(boolean reverse) {
		if (reverse && this.registration != null) {
			this.registration.unsetMedicalCertificateSickLeave();
		}
	...
	public void setMedicalStaff(@NotNull StaffEntity entity, boolean reverseAdd) {
		...
		if (this.medicalStaff != null) {
			this.medicalStaff.removeMedicalStaffOfSickLeavesCertificate(this, false);
		}
		this.medicalStaff = entity;
		if (reverseAdd) {
			this.medicalStaff.addMedicalStaffOfSickLeavesCertificate(this, false);
		}
	...
	@Override
	public boolean equals(Object medicalCertificateSickLeave) {
		if (this == medicalCertificateSickLeave) {
			return true;
		}
		if (medicalCertificateSickLeave == null || this.getClass() != medicalCertificateSickLeave.getClass()) {
			return false;
		}
		if (!super.equals(medicalCertificateSickLeave)) {
			return false;
		}

		// Compare references by ids only
		this.addRelationEntitiesToIdSet();
		MedicalCertificateSickLeaveEntity that = (MedicalCertificateSickLeaveEntity) medicalCertificateSickLeave;
		return
