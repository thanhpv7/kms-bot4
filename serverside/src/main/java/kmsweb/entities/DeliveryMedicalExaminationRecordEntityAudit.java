...
@ToString
public class DeliveryMedicalExaminationRecordEntityAudit extends AbstractEntityAudit<DeliveryMedicalExaminationRecordEntity> {
	...
	public DeliveryMedicalExaminationRecordEntityAudit(
			...
			DeliveryMedicalExaminationRecordEntity entity,
