...
@ToString
public class HemodialysisMonitoringEntityAudit extends AbstractEntityAudit<HemodialysisMonitoringEntity> {
	...
	public HemodialysisMonitoringEntityAudit(
			...
			HemodialysisMonitoringEntity entity,
