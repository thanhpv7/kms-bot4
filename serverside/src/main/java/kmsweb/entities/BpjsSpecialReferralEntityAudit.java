...
@ToString
public class BpjsSpecialReferralEntityAudit extends AbstractEntityAudit<BpjsSpecialReferralEntity> {
	...
	public BpjsSpecialReferralEntityAudit(
			...
			BpjsSpecialReferralEntity entity,
