...
@ToString
public class BpjsHospitalizationPlanEntityAudit extends AbstractEntityAudit<BpjsHospitalizationPlanEntity> {
	...
	public BpjsHospitalizationPlanEntityAudit(
			...
			BpjsHospitalizationPlanEntity entity,
