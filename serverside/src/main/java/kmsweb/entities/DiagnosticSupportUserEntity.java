...
import kmsweb.entities.listeners.DiagnosticSupportUserEntityListener;
import kmsweb.serializers.DiagnosticSupportUserSerializer;
...
@EntityListeners({DiagnosticSupportUserEntityListener.class, AuditingEntityListener.class})
@JsonSerialize(using = DiagnosticSupportUserSerializer.class)
@Table(
	uniqueConstraints = {
	}
)
public class DiagnosticSupportUserEntity extends UserEntity {

	/**
	 * Takes a DiagnosticSupportUserEntityDto and converts it into a DiagnosticSupportUserEntity.
	 * Primarily used when endpoints are invoked, as they take DTOs as input, which need to be converted to the entity type
	 *
	 * @param diagnosticSupportUserEntityDto
	 */
	public DiagnosticSupportUserEntity(DiagnosticSupportUserEntityDto diagnosticSupportUserEntityDto) {
		// Need to account for potential that any field is empty.  This will be run before any server validation and
		// endpoints will most likely not be subject to clientside validation

		if (diagnosticSupportUserEntityDto.getId() != null) {
			this.setId(diagnosticSupportUserEntityDto.getId());
		}

		if (diagnosticSupportUserEntityDto.getStaff() != null) {
			this.setStaff(diagnosticSupportUserEntityDto.getStaff());
		}
	...
	@OneToOne(mappedBy = "diagnosticSupportUser", cascade = {CascadeType.MERGE}, fetch = FetchType.LAZY)
	@CsvIgnore
	 ...
	 *
	 * @param entity the DiagnosticSupportUserEntity to be set or updated
	...
	public void setStaff(@NotNull StaffEntity entity, boolean reverseAdd) {
		...
		if (this.staff != null) {
			this.staff.unsetDiagnosticSupportUser();
		}

		this.staff = entity;

		if (reverseAdd) {
			this.staff.setDiagnosticSupportUser(this, false);
		}
	...
	public void unsetStaff(boolean reverse) {
		if (reverse && this.staff != null) {
			this.staff.unsetDiagnosticSupportUser(false);
		}
		this.staff = null;
	}
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	@Override
	public boolean equals(Object diagnosticSupportUser) {
		if (this == diagnosticSupportUser) {
			return true;
		}
		if (diagnosticSupportUser == null || this.getClass() != diagnosticSupportUser.getClass()) {
			return false;
		}
		if (!super.equals(diagnosticSupportUser)) {
			return false;
		}

		// Compare references by ids only
		this.addRelationEntitiesToIdSet();
		DiagnosticSupportUserEntity that = (DiagnosticSupportUserEntity) diagnosticSupportUser;
		return
