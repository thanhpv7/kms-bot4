...
import kmsweb.entities.listeners.MedicalRecordUserEntityListener;
import kmsweb.serializers.MedicalRecordUserSerializer;
...
@EntityListeners({MedicalRecordUserEntityListener.class, AuditingEntityListener.class})
@JsonSerialize(using = MedicalRecordUserSerializer.class)
@Table(
	uniqueConstraints = {
	}
)
public class MedicalRecordUserEntity extends UserEntity {

	/**
	 * Takes a MedicalRecordUserEntityDto and converts it into a MedicalRecordUserEntity.
	 * Primarily used when endpoints are invoked, as they take DTOs as input, which need to be converted to the entity type
	 *
	 * @param medicalRecordUserEntityDto
	 */
	public MedicalRecordUserEntity(MedicalRecordUserEntityDto medicalRecordUserEntityDto) {
		// Need to account for potential that any field is empty.  This will be run before any server validation and
		// endpoints will most likely not be subject to clientside validation

		if (medicalRecordUserEntityDto.getId() != null) {
			this.setId(medicalRecordUserEntityDto.getId());
		}

		if (medicalRecordUserEntityDto.getStaff() != null) {
			this.setStaff(medicalRecordUserEntityDto.getStaff());
		}
	...
	@OneToOne(mappedBy = "medicalRecordUser", cascade = {CascadeType.MERGE}, fetch = FetchType.LAZY)
	@CsvIgnore
	 ...
	 *
	 * @param entity the MedicalRecordUserEntity to be set or updated
	...
	public void setStaff(@NotNull StaffEntity entity, boolean reverseAdd) {
		...
		if (this.staff != null) {
			this.staff.unsetMedicalRecordUser();
		}

		this.staff = entity;

		if (reverseAdd) {
			this.staff.setMedicalRecordUser(this, false);
		}
	...
	public void unsetStaff(boolean reverse) {
		if (reverse && this.staff != null) {
			this.staff.unsetMedicalRecordUser(false);
		}
		this.staff = null;
	}
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	@Override
	public boolean equals(Object medicalRecordUser) {
		if (this == medicalRecordUser) {
			return true;
		}
		if (medicalRecordUser == null || this.getClass() != medicalRecordUser.getClass()) {
			return false;
		}
		if (!super.equals(medicalRecordUser)) {
			return false;
		}

		// Compare references by ids only
		this.addRelationEntitiesToIdSet();
		MedicalRecordUserEntity that = (MedicalRecordUserEntity) medicalRecordUser;
		return
