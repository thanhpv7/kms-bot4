...
@ToString
public class TariffDefinitionOtherComponentEntityAudit extends AbstractEntityAudit<TariffDefinitionOtherComponentEntity> {
	...
	public TariffDefinitionOtherComponentEntityAudit(
			...
			TariffDefinitionOtherComponentEntity entity,
