...
@ToString
public class RetailPharmacyInvoiceEntityAudit extends AbstractEntityAudit<RetailPharmacyInvoiceEntity> {
	...
	public RetailPharmacyInvoiceEntityAudit(
			...
			RetailPharmacyInvoiceEntity entity,
