...
@ToString
public class NhisClaimInvestigationDetailEntityAudit extends AbstractEntityAudit<NhisClaimInvestigationDetailEntity> {
	...
	public NhisClaimInvestigationDetailEntityAudit(
			...
			NhisClaimInvestigationDetailEntity entity,
