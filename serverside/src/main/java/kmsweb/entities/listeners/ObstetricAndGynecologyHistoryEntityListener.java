...
import kmsweb.configs.security.auditing.services.ObstetricAndGynecologyHistoryEntityReadAuditService;
...
/**
 * Listener class used to tap into life cycle hooks when processing ObstetricAndGynecologyHistoryEntity.
 */
@Slf4j
@Component
public class ObstetricAndGynecologyHistoryEntityListener {

	private static PermissionEvaluator permissionEvaluator;
	private static ObstetricAndGynecologyHistoryEntityReadAuditService auditService;
	...
	public void init(
		...
		ObstetricAndGynecologyHistoryEntityReadAuditService auditService,
		SecurityProperties securityProperties
	) {
		ObstetricAndGynecologyHistoryEntityListener.permissionEvaluator = permissionEvaluator;
		ObstetricAndGynecologyHistoryEntityListener.auditService = auditService;
		ObstetricAndGynecologyHistoryEntityListener.securityProperties = securityProperties;
	}

	@PrePersist
	public void beforePersist(ObstetricAndGynecologyHistoryEntity entity) {
	...
	@PostPersist
	public void afterPersist(ObstetricAndGynecologyHistoryEntity entity) {
	...
	@PreRemove
	public void beforeRemove(ObstetricAndGynecologyHistoryEntity entity) {
	...
	@PostRemove
	public void afterRemove(ObstetricAndGynecologyHistoryEntity entity) {
	...
	@PreUpdate
	public void beforeUpdate(ObstetricAndGynecologyHistoryEntity entity) {
	...
	@PostUpdate
	public void afterUpdate(ObstetricAndGynecologyHistoryEntity entity) {
	...
	@PostLoad
	public void afterLoad(ObstetricAndGynecologyHistoryEntity entity) throws JsonProcessingException {
		checkPermission(entity.getClass().getSimpleName(), "read");

		// % protected region % [Override the global configuration for read audits for the ObstetricAndGynecologyHistoryEntity here] off begin
		if (securityProperties.isReadAuditEnabled()) {
			// Create a new read record against this entity.
			auditService.createWith(entity);
		}
		// % protected region % [Override the global configuration for read audits for the ObstetricAndGynecologyHistoryEntity here] end
	...
	private void checkPermission(@NonNull String entityName, @NonNull String permission) {
		if (!permissionEvaluator.hasPermission(SecurityContextHolder.getContext().getAuthentication(), entityName, permission)) {
			...
			throw new AccessDeniedException("Access to Obstetric And Gynecology History is not permitted.");
		}
	}
	 ...
	 */
	protected void removeAllReferences(ObstetricAndGynecologyHistoryEntity entity) {
