...
import kmsweb.configs.security.auditing.services.CatalogueUOMEntityReadAuditService;
...
/**
 * Listener class used to tap into life cycle hooks when processing CatalogueUOMEntity.
 */
@Slf4j
@Component
public class CatalogueUOMEntityListener {

	private static PermissionEvaluator permissionEvaluator;
	private static CatalogueUOMEntityReadAuditService auditService;
	...
	public void init(
		...
		CatalogueUOMEntityReadAuditService auditService,
		SecurityProperties securityProperties
	) {
		CatalogueUOMEntityListener.permissionEvaluator = permissionEvaluator;
		CatalogueUOMEntityListener.auditService = auditService;
		CatalogueUOMEntityListener.securityProperties = securityProperties;
	}

	@PrePersist
	public void beforePersist(CatalogueUOMEntity entity) {
	...
	@PostPersist
	public void afterPersist(CatalogueUOMEntity entity) {
	...
	@PreRemove
	public void beforeRemove(CatalogueUOMEntity entity) {
	...
	@PostRemove
	public void afterRemove(CatalogueUOMEntity entity) {
	...
	@PreUpdate
	public void beforeUpdate(CatalogueUOMEntity entity) {
	...
	@PostUpdate
	public void afterUpdate(CatalogueUOMEntity entity) {
	...
	@PostLoad
	public void afterLoad(CatalogueUOMEntity entity) throws JsonProcessingException {
		checkPermission(entity.getClass().getSimpleName(), "read");

		// % protected region % [Override the global configuration for read audits for the CatalogueUOMEntity here] off begin
		if (securityProperties.isReadAuditEnabled()) {
			// Create a new read record against this entity.
			auditService.createWith(entity);
		}
		// % protected region % [Override the global configuration for read audits for the CatalogueUOMEntity here] end
	...
	private void checkPermission(@NonNull String entityName, @NonNull String permission) {
		if (!permissionEvaluator.hasPermission(SecurityContextHolder.getContext().getAuthentication(), entityName, permission)) {
			...
			throw new AccessDeniedException("Access to Catalogue UOM is not permitted.");
		}
	}
	 ...
	 */
	protected void removeAllReferences(CatalogueUOMEntity entity) {
