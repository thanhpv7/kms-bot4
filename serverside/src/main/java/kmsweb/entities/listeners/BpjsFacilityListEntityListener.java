...
import kmsweb.configs.security.auditing.services.BpjsFacilityListEntityReadAuditService;
...
/**
 * Listener class used to tap into life cycle hooks when processing BpjsFacilityListEntity.
 */
@Slf4j
@Component
public class BpjsFacilityListEntityListener {

	private static PermissionEvaluator permissionEvaluator;
	private static BpjsFacilityListEntityReadAuditService auditService;
	...
	public void init(
		...
		BpjsFacilityListEntityReadAuditService auditService,
		SecurityProperties securityProperties
	) {
		BpjsFacilityListEntityListener.permissionEvaluator = permissionEvaluator;
		BpjsFacilityListEntityListener.auditService = auditService;
		BpjsFacilityListEntityListener.securityProperties = securityProperties;
	}

	@PrePersist
	public void beforePersist(BpjsFacilityListEntity entity) {
	...
	@PostPersist
	public void afterPersist(BpjsFacilityListEntity entity) {
	...
	@PreRemove
	public void beforeRemove(BpjsFacilityListEntity entity) {
	...
	@PostRemove
	public void afterRemove(BpjsFacilityListEntity entity) {
	...
	@PreUpdate
	public void beforeUpdate(BpjsFacilityListEntity entity) {
	...
	@PostUpdate
	public void afterUpdate(BpjsFacilityListEntity entity) {
	...
	@PostLoad
	public void afterLoad(BpjsFacilityListEntity entity) throws JsonProcessingException {
		checkPermission(entity.getClass().getSimpleName(), "read");

		// % protected region % [Override the global configuration for read audits for the BpjsFacilityListEntity here] off begin
		if (securityProperties.isReadAuditEnabled()) {
			// Create a new read record against this entity.
			auditService.createWith(entity);
		}
		// % protected region % [Override the global configuration for read audits for the BpjsFacilityListEntity here] end
	...
	private void checkPermission(@NonNull String entityName, @NonNull String permission) {
		if (!permissionEvaluator.hasPermission(SecurityContextHolder.getContext().getAuthentication(), entityName, permission)) {
			...
			throw new AccessDeniedException("Access to BPJS Facility List is not permitted.");
		}
	}
	 ...
	 */
	protected void removeAllReferences(BpjsFacilityListEntity entity) {
