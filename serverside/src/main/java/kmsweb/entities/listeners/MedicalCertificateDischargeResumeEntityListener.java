...
import kmsweb.configs.security.auditing.services.MedicalCertificateDischargeResumeEntityReadAuditService;
...
/**
 * Listener class used to tap into life cycle hooks when processing MedicalCertificateDischargeResumeEntity.
 */
@Slf4j
@Component
public class MedicalCertificateDischargeResumeEntityListener {

	private static PermissionEvaluator permissionEvaluator;
	private static MedicalCertificateDischargeResumeEntityReadAuditService auditService;
	...
	public void init(
		...
		MedicalCertificateDischargeResumeEntityReadAuditService auditService,
		SecurityProperties securityProperties
	) {
		MedicalCertificateDischargeResumeEntityListener.permissionEvaluator = permissionEvaluator;
		MedicalCertificateDischargeResumeEntityListener.auditService = auditService;
		MedicalCertificateDischargeResumeEntityListener.securityProperties = securityProperties;
	}

	@PrePersist
	public void beforePersist(MedicalCertificateDischargeResumeEntity entity) {
	...
	@PostPersist
	public void afterPersist(MedicalCertificateDischargeResumeEntity entity) {
	...
	@PreRemove
	public void beforeRemove(MedicalCertificateDischargeResumeEntity entity) {
	...
	@PostRemove
	public void afterRemove(MedicalCertificateDischargeResumeEntity entity) {
	...
	@PreUpdate
	public void beforeUpdate(MedicalCertificateDischargeResumeEntity entity) {
	...
	@PostUpdate
	public void afterUpdate(MedicalCertificateDischargeResumeEntity entity) {
	...
	@PostLoad
	public void afterLoad(MedicalCertificateDischargeResumeEntity entity) throws JsonProcessingException {
		checkPermission(entity.getClass().getSimpleName(), "read");

		// % protected region % [Override the global configuration for read audits for the MedicalCertificateDischargeResumeEntity here] off begin
		if (securityProperties.isReadAuditEnabled()) {
			// Create a new read record against this entity.
			auditService.createWith(entity);
		}
		// % protected region % [Override the global configuration for read audits for the MedicalCertificateDischargeResumeEntity here] end
	...
	private void checkPermission(@NonNull String entityName, @NonNull String permission) {
		if (!permissionEvaluator.hasPermission(SecurityContextHolder.getContext().getAuthentication(), entityName, permission)) {
			...
			throw new AccessDeniedException("Access to Medical Certificate  Discharge Resume is not permitted.");
		}
	}
	 ...
	 */
	protected void removeAllReferences(MedicalCertificateDischargeResumeEntity entity) {
		entity.unsetRegistration();
		entity.unsetDischargeICD10();
		entity.unsetDischargeICD9CM();
		entity.unsetMedicalStaff();
	}
