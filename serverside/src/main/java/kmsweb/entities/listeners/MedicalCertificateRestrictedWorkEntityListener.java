...
import kmsweb.configs.security.auditing.services.MedicalCertificateRestrictedWorkEntityReadAuditService;
...
/**
 * Listener class used to tap into life cycle hooks when processing MedicalCertificateRestrictedWorkEntity.
 */
@Slf4j
@Component
public class MedicalCertificateRestrictedWorkEntityListener {

	private static PermissionEvaluator permissionEvaluator;
	private static MedicalCertificateRestrictedWorkEntityReadAuditService auditService;
	...
	public void init(
		...
		MedicalCertificateRestrictedWorkEntityReadAuditService auditService,
		SecurityProperties securityProperties
	) {
		MedicalCertificateRestrictedWorkEntityListener.permissionEvaluator = permissionEvaluator;
		MedicalCertificateRestrictedWorkEntityListener.auditService = auditService;
		MedicalCertificateRestrictedWorkEntityListener.securityProperties = securityProperties;
	}

	@PrePersist
	public void beforePersist(MedicalCertificateRestrictedWorkEntity entity) {
	...
	@PostPersist
	public void afterPersist(MedicalCertificateRestrictedWorkEntity entity) {
	...
	@PreRemove
	public void beforeRemove(MedicalCertificateRestrictedWorkEntity entity) {
	...
	@PostRemove
	public void afterRemove(MedicalCertificateRestrictedWorkEntity entity) {
	...
	@PreUpdate
	public void beforeUpdate(MedicalCertificateRestrictedWorkEntity entity) {
	...
	@PostUpdate
	public void afterUpdate(MedicalCertificateRestrictedWorkEntity entity) {
	...
	@PostLoad
	public void afterLoad(MedicalCertificateRestrictedWorkEntity entity) throws JsonProcessingException {
		checkPermission(entity.getClass().getSimpleName(), "read");

		// % protected region % [Override the global configuration for read audits for the MedicalCertificateRestrictedWorkEntity here] off begin
		if (securityProperties.isReadAuditEnabled()) {
			// Create a new read record against this entity.
			auditService.createWith(entity);
		}
		// % protected region % [Override the global configuration for read audits for the MedicalCertificateRestrictedWorkEntity here] end
	...
	private void checkPermission(@NonNull String entityName, @NonNull String permission) {
		if (!permissionEvaluator.hasPermission(SecurityContextHolder.getContext().getAuthentication(), entityName, permission)) {
			...
			throw new AccessDeniedException("Access to Medical Certificate Restricted Work is not permitted.");
		}
	}
	 ...
	 */
	protected void removeAllReferences(MedicalCertificateRestrictedWorkEntity entity) {
