...
import kmsweb.configs.security.auditing.services.MedicationItemEntityReadAuditService;
...
/**
 * Listener class used to tap into life cycle hooks when processing MedicationItemEntity.
 */
@Slf4j
@Component
public class MedicationItemEntityListener {

	private static PermissionEvaluator permissionEvaluator;
	private static MedicationItemEntityReadAuditService auditService;
	...
	public void init(
		...
		MedicationItemEntityReadAuditService auditService,
		SecurityProperties securityProperties
	) {
		MedicationItemEntityListener.permissionEvaluator = permissionEvaluator;
		MedicationItemEntityListener.auditService = auditService;
		MedicationItemEntityListener.securityProperties = securityProperties;
	}

	@PrePersist
	public void beforePersist(MedicationItemEntity entity) {
	...
	@PostPersist
	public void afterPersist(MedicationItemEntity entity) {
	...
	@PreRemove
	public void beforeRemove(MedicationItemEntity entity) {
	...
	@PostRemove
	public void afterRemove(MedicationItemEntity entity) {
	...
	@PreUpdate
	public void beforeUpdate(MedicationItemEntity entity) {
	...
	@PostUpdate
	public void afterUpdate(MedicationItemEntity entity) {
	...
	@PostLoad
	public void afterLoad(MedicationItemEntity entity) throws JsonProcessingException {
		checkPermission(entity.getClass().getSimpleName(), "read");

		// % protected region % [Override the global configuration for read audits for the MedicationItemEntity here] off begin
		if (securityProperties.isReadAuditEnabled()) {
			// Create a new read record against this entity.
			auditService.createWith(entity);
		}
		// % protected region % [Override the global configuration for read audits for the MedicationItemEntity here] end
	...
	private void checkPermission(@NonNull String entityName, @NonNull String permission) {
		if (!permissionEvaluator.hasPermission(SecurityContextHolder.getContext().getAuthentication(), entityName, permission)) {
			...
			throw new AccessDeniedException("Access to Medication Item is not permitted.");
		}
	}
	 ...
	 */
	protected void removeAllReferences(MedicationItemEntity entity) {
