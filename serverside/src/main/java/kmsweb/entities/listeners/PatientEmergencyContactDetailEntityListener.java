...
import kmsweb.configs.security.auditing.services.PatientEmergencyContactDetailEntityReadAuditService;
...
/**
 * Listener class used to tap into life cycle hooks when processing PatientEmergencyContactDetailEntity.
 */
@Slf4j
@Component
public class PatientEmergencyContactDetailEntityListener {

	private static PermissionEvaluator permissionEvaluator;
	private static PatientEmergencyContactDetailEntityReadAuditService auditService;
	...
	public void init(
		...
		PatientEmergencyContactDetailEntityReadAuditService auditService,
		SecurityProperties securityProperties
	) {
		PatientEmergencyContactDetailEntityListener.permissionEvaluator = permissionEvaluator;
		PatientEmergencyContactDetailEntityListener.auditService = auditService;
		PatientEmergencyContactDetailEntityListener.securityProperties = securityProperties;
	}

	@PrePersist
	public void beforePersist(PatientEmergencyContactDetailEntity entity) {
	...
	@PostPersist
	public void afterPersist(PatientEmergencyContactDetailEntity entity) {
	...
	@PreRemove
	public void beforeRemove(PatientEmergencyContactDetailEntity entity) {
	...
	@PostRemove
	public void afterRemove(PatientEmergencyContactDetailEntity entity) {
	...
	@PreUpdate
	public void beforeUpdate(PatientEmergencyContactDetailEntity entity) {
	...
	@PostUpdate
	public void afterUpdate(PatientEmergencyContactDetailEntity entity) {
	...
	@PostLoad
	public void afterLoad(PatientEmergencyContactDetailEntity entity) throws JsonProcessingException {
		checkPermission(entity.getClass().getSimpleName(), "read");

		// % protected region % [Override the global configuration for read audits for the PatientEmergencyContactDetailEntity here] off begin
		if (securityProperties.isReadAuditEnabled()) {
			// Create a new read record against this entity.
			auditService.createWith(entity);
		}
		// % protected region % [Override the global configuration for read audits for the PatientEmergencyContactDetailEntity here] end
	...
	private void checkPermission(@NonNull String entityName, @NonNull String permission) {
		if (!permissionEvaluator.hasPermission(SecurityContextHolder.getContext().getAuthentication(), entityName, permission)) {
			...
			throw new AccessDeniedException("Access to Patient Emergency Contact Detail is not permitted.");
		}
	}
	 ...
	 */
	protected void removeAllReferences(PatientEmergencyContactDetailEntity entity) {
		entity.unsetPatientGeneralInformation();
	}
