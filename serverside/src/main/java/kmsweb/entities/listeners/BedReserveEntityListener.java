...
import kmsweb.configs.security.auditing.services.BedReserveEntityReadAuditService;
...
/**
 * Listener class used to tap into life cycle hooks when processing BedReserveEntity.
 */
@Slf4j
@Component
public class BedReserveEntityListener {

	private static PermissionEvaluator permissionEvaluator;
	private static BedReserveEntityReadAuditService auditService;
	...
	public void init(
		...
		BedReserveEntityReadAuditService auditService,
		SecurityProperties securityProperties
	) {
		BedReserveEntityListener.permissionEvaluator = permissionEvaluator;
		BedReserveEntityListener.auditService = auditService;
		BedReserveEntityListener.securityProperties = securityProperties;
	}

	@PrePersist
	public void beforePersist(BedReserveEntity entity) {
	...
	@PostPersist
	public void afterPersist(BedReserveEntity entity) {
	...
	@PreRemove
	public void beforeRemove(BedReserveEntity entity) {
	...
	@PostRemove
	public void afterRemove(BedReserveEntity entity) {
	...
	@PreUpdate
	public void beforeUpdate(BedReserveEntity entity) {
	...
	@PostUpdate
	public void afterUpdate(BedReserveEntity entity) {
	...
	@PostLoad
	public void afterLoad(BedReserveEntity entity) throws JsonProcessingException {
		checkPermission(entity.getClass().getSimpleName(), "read");

		// % protected region % [Override the global configuration for read audits for the BedReserveEntity here] off begin
		if (securityProperties.isReadAuditEnabled()) {
			// Create a new read record against this entity.
			auditService.createWith(entity);
		}
		// % protected region % [Override the global configuration for read audits for the BedReserveEntity here] end
	...
	private void checkPermission(@NonNull String entityName, @NonNull String permission) {
		if (!permissionEvaluator.hasPermission(SecurityContextHolder.getContext().getAuthentication(), entityName, permission)) {
			...
			throw new AccessDeniedException("Access to Bed Reserve is not permitted.");
		}
	}
	 ...
	 */
	protected void removeAllReferences(BedReserveEntity entity) {
