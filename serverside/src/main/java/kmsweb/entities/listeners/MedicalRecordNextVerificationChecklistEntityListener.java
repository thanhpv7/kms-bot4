...
import kmsweb.configs.security.auditing.services.MedicalRecordNextVerificationChecklistEntityReadAuditService;
...
/**
 * Listener class used to tap into life cycle hooks when processing MedicalRecordNextVerificationChecklistEntity.
 */
@Slf4j
@Component
public class MedicalRecordNextVerificationChecklistEntityListener {

	private static PermissionEvaluator permissionEvaluator;
	private static MedicalRecordNextVerificationChecklistEntityReadAuditService auditService;
	...
	public void init(
		...
		MedicalRecordNextVerificationChecklistEntityReadAuditService auditService,
		SecurityProperties securityProperties
	) {
		MedicalRecordNextVerificationChecklistEntityListener.permissionEvaluator = permissionEvaluator;
		MedicalRecordNextVerificationChecklistEntityListener.auditService = auditService;
		MedicalRecordNextVerificationChecklistEntityListener.securityProperties = securityProperties;
	}

	@PrePersist
	public void beforePersist(MedicalRecordNextVerificationChecklistEntity entity) {
	...
	@PostPersist
	public void afterPersist(MedicalRecordNextVerificationChecklistEntity entity) {
	...
	@PreRemove
	public void beforeRemove(MedicalRecordNextVerificationChecklistEntity entity) {
	...
	@PostRemove
	public void afterRemove(MedicalRecordNextVerificationChecklistEntity entity) {
	...
	@PreUpdate
	public void beforeUpdate(MedicalRecordNextVerificationChecklistEntity entity) {
	...
	@PostUpdate
	public void afterUpdate(MedicalRecordNextVerificationChecklistEntity entity) {
	...
	@PostLoad
	public void afterLoad(MedicalRecordNextVerificationChecklistEntity entity) throws JsonProcessingException {
		checkPermission(entity.getClass().getSimpleName(), "read");

		// % protected region % [Override the global configuration for read audits for the MedicalRecordNextVerificationChecklistEntity here] off begin
		if (securityProperties.isReadAuditEnabled()) {
			// Create a new read record against this entity.
			auditService.createWith(entity);
		}
		// % protected region % [Override the global configuration for read audits for the MedicalRecordNextVerificationChecklistEntity here] end
	...
	private void checkPermission(@NonNull String entityName, @NonNull String permission) {
		if (!permissionEvaluator.hasPermission(SecurityContextHolder.getContext().getAuthentication(), entityName, permission)) {
			...
			throw new AccessDeniedException("Access to Medical Record Next Verification Checklist is not permitted.");
		}
	}
	 ...
	 */
	protected void removeAllReferences(MedicalRecordNextVerificationChecklistEntity entity) {
