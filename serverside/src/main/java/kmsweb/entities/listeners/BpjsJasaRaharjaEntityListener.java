...
import kmsweb.configs.security.auditing.services.BpjsJasaRaharjaEntityReadAuditService;
...
/**
 * Listener class used to tap into life cycle hooks when processing BpjsJasaRaharjaEntity.
 */
@Slf4j
@Component
public class BpjsJasaRaharjaEntityListener {

	private static PermissionEvaluator permissionEvaluator;
	private static BpjsJasaRaharjaEntityReadAuditService auditService;
	...
	public void init(
		...
		BpjsJasaRaharjaEntityReadAuditService auditService,
		SecurityProperties securityProperties
	) {
		BpjsJasaRaharjaEntityListener.permissionEvaluator = permissionEvaluator;
		BpjsJasaRaharjaEntityListener.auditService = auditService;
		BpjsJasaRaharjaEntityListener.securityProperties = securityProperties;
	}

	@PrePersist
	public void beforePersist(BpjsJasaRaharjaEntity entity) {
	...
	@PostPersist
	public void afterPersist(BpjsJasaRaharjaEntity entity) {
	...
	@PreRemove
	public void beforeRemove(BpjsJasaRaharjaEntity entity) {
	...
	@PostRemove
	public void afterRemove(BpjsJasaRaharjaEntity entity) {
	...
	@PreUpdate
	public void beforeUpdate(BpjsJasaRaharjaEntity entity) {
	...
	@PostUpdate
	public void afterUpdate(BpjsJasaRaharjaEntity entity) {
	...
	@PostLoad
	public void afterLoad(BpjsJasaRaharjaEntity entity) throws JsonProcessingException {
		checkPermission(entity.getClass().getSimpleName(), "read");

		// % protected region % [Override the global configuration for read audits for the BpjsJasaRaharjaEntity here] off begin
		if (securityProperties.isReadAuditEnabled()) {
			// Create a new read record against this entity.
			auditService.createWith(entity);
		}
		// % protected region % [Override the global configuration for read audits for the BpjsJasaRaharjaEntity here] end
	...
	private void checkPermission(@NonNull String entityName, @NonNull String permission) {
		if (!permissionEvaluator.hasPermission(SecurityContextHolder.getContext().getAuthentication(), entityName, permission)) {
			...
			throw new AccessDeniedException("Access to BPJS Jasa Raharja is not permitted.");
		}
	}
	 ...
	 */
	protected void removeAllReferences(BpjsJasaRaharjaEntity entity) {
