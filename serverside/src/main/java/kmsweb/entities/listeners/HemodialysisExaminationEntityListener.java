...
import kmsweb.configs.security.auditing.services.HemodialysisExaminationEntityReadAuditService;
...
/**
 * Listener class used to tap into life cycle hooks when processing HemodialysisExaminationEntity.
 */
@Slf4j
@Component
public class HemodialysisExaminationEntityListener {

	private static PermissionEvaluator permissionEvaluator;
	private static HemodialysisExaminationEntityReadAuditService auditService;
	...
	public void init(
		...
		HemodialysisExaminationEntityReadAuditService auditService,
		SecurityProperties securityProperties
	) {
		HemodialysisExaminationEntityListener.permissionEvaluator = permissionEvaluator;
		HemodialysisExaminationEntityListener.auditService = auditService;
		HemodialysisExaminationEntityListener.securityProperties = securityProperties;
	}

	@PrePersist
	public void beforePersist(HemodialysisExaminationEntity entity) {
	...
	@PostPersist
	public void afterPersist(HemodialysisExaminationEntity entity) {
	...
	@PreRemove
	public void beforeRemove(HemodialysisExaminationEntity entity) {
	...
	@PostRemove
	public void afterRemove(HemodialysisExaminationEntity entity) {
	...
	@PreUpdate
	public void beforeUpdate(HemodialysisExaminationEntity entity) {
	...
	@PostUpdate
	public void afterUpdate(HemodialysisExaminationEntity entity) {
	...
	@PostLoad
	public void afterLoad(HemodialysisExaminationEntity entity) throws JsonProcessingException {
		checkPermission(entity.getClass().getSimpleName(), "read");

		// % protected region % [Override the global configuration for read audits for the HemodialysisExaminationEntity here] off begin
		if (securityProperties.isReadAuditEnabled()) {
			// Create a new read record against this entity.
			auditService.createWith(entity);
		}
		// % protected region % [Override the global configuration for read audits for the HemodialysisExaminationEntity here] end
	...
	private void checkPermission(@NonNull String entityName, @NonNull String permission) {
		if (!permissionEvaluator.hasPermission(SecurityContextHolder.getContext().getAuthentication(), entityName, permission)) {
			...
			throw new AccessDeniedException("Access to Hemodialysis Examination is not permitted.");
		}
	}
	 ...
	 */
	protected void removeAllReferences(HemodialysisExaminationEntity entity) {
