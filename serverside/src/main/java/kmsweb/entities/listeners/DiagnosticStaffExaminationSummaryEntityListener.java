...
import kmsweb.configs.security.auditing.services.DiagnosticStaffExaminationSummaryEntityReadAuditService;
...
/**
 * Listener class used to tap into life cycle hooks when processing DiagnosticStaffExaminationSummaryEntity.
 */
@Slf4j
@Component
public class DiagnosticStaffExaminationSummaryEntityListener {

	private static PermissionEvaluator permissionEvaluator;
	private static DiagnosticStaffExaminationSummaryEntityReadAuditService auditService;
	...
	public void init(
		...
		DiagnosticStaffExaminationSummaryEntityReadAuditService auditService,
		SecurityProperties securityProperties
	) {
		DiagnosticStaffExaminationSummaryEntityListener.permissionEvaluator = permissionEvaluator;
		DiagnosticStaffExaminationSummaryEntityListener.auditService = auditService;
		DiagnosticStaffExaminationSummaryEntityListener.securityProperties = securityProperties;
	}

	@PrePersist
	public void beforePersist(DiagnosticStaffExaminationSummaryEntity entity) {
	...
	@PostPersist
	public void afterPersist(DiagnosticStaffExaminationSummaryEntity entity) {
	...
	@PreRemove
	public void beforeRemove(DiagnosticStaffExaminationSummaryEntity entity) {
	...
	@PostRemove
	public void afterRemove(DiagnosticStaffExaminationSummaryEntity entity) {
	...
	@PreUpdate
	public void beforeUpdate(DiagnosticStaffExaminationSummaryEntity entity) {
	...
	@PostUpdate
	public void afterUpdate(DiagnosticStaffExaminationSummaryEntity entity) {
	...
	@PostLoad
	public void afterLoad(DiagnosticStaffExaminationSummaryEntity entity) throws JsonProcessingException {
		checkPermission(entity.getClass().getSimpleName(), "read");

		// % protected region % [Override the global configuration for read audits for the DiagnosticStaffExaminationSummaryEntity here] off begin
		if (securityProperties.isReadAuditEnabled()) {
			// Create a new read record against this entity.
			auditService.createWith(entity);
		}
		// % protected region % [Override the global configuration for read audits for the DiagnosticStaffExaminationSummaryEntity here] end
	...
	private void checkPermission(@NonNull String entityName, @NonNull String permission) {
		if (!permissionEvaluator.hasPermission(SecurityContextHolder.getContext().getAuthentication(), entityName, permission)) {
			...
			throw new AccessDeniedException("Access to Diagnostic Staff Examination Summary is not permitted.");
		}
	}
	 ...
	 */
	protected void removeAllReferences(DiagnosticStaffExaminationSummaryEntity entity) {
		entity.unsetDiagnosisExaminationRecord();
