...
import kmsweb.configs.security.auditing.services.DiagnosticExaminationResultsEntityReadAuditService;
...
/**
 * Listener class used to tap into life cycle hooks when processing DiagnosticExaminationResultsEntity.
 */
@Slf4j
@Component
public class DiagnosticExaminationResultsEntityListener {

	private static PermissionEvaluator permissionEvaluator;
	private static DiagnosticExaminationResultsEntityReadAuditService auditService;
	...
	public void init(
		...
		DiagnosticExaminationResultsEntityReadAuditService auditService,
		SecurityProperties securityProperties
	) {
		DiagnosticExaminationResultsEntityListener.permissionEvaluator = permissionEvaluator;
		DiagnosticExaminationResultsEntityListener.auditService = auditService;
		DiagnosticExaminationResultsEntityListener.securityProperties = securityProperties;
	}

	@PrePersist
	public void beforePersist(DiagnosticExaminationResultsEntity entity) {
	...
	@PostPersist
	public void afterPersist(DiagnosticExaminationResultsEntity entity) {
	...
	@PreRemove
	public void beforeRemove(DiagnosticExaminationResultsEntity entity) {
	...
	@PostRemove
	public void afterRemove(DiagnosticExaminationResultsEntity entity) {
	...
	@PreUpdate
	public void beforeUpdate(DiagnosticExaminationResultsEntity entity) {
	...
	@PostUpdate
	public void afterUpdate(DiagnosticExaminationResultsEntity entity) {
	...
	@PostLoad
	public void afterLoad(DiagnosticExaminationResultsEntity entity) throws JsonProcessingException {
		checkPermission(entity.getClass().getSimpleName(), "read");

		// % protected region % [Override the global configuration for read audits for the DiagnosticExaminationResultsEntity here] off begin
		if (securityProperties.isReadAuditEnabled()) {
			// Create a new read record against this entity.
			auditService.createWith(entity);
		}
		// % protected region % [Override the global configuration for read audits for the DiagnosticExaminationResultsEntity here] end
	...
	private void checkPermission(@NonNull String entityName, @NonNull String permission) {
		if (!permissionEvaluator.hasPermission(SecurityContextHolder.getContext().getAuthentication(), entityName, permission)) {
			...
			throw new AccessDeniedException("Access to Diagnostic Examination Results is not permitted.");
		}
	}
	 ...
	 */
	protected void removeAllReferences(DiagnosticExaminationResultsEntity entity) {
		entity.unsetExaminationItem();
