...
import kmsweb.configs.security.auditing.services.CatalogueMedicalEntityReadAuditService;
...
/**
 * Listener class used to tap into life cycle hooks when processing CatalogueMedicalEntity.
 */
@Slf4j
@Component
public class CatalogueMedicalEntityListener {

	private static PermissionEvaluator permissionEvaluator;
	private static CatalogueMedicalEntityReadAuditService auditService;
	...
	public void init(
		...
		CatalogueMedicalEntityReadAuditService auditService,
		SecurityProperties securityProperties
	) {
		CatalogueMedicalEntityListener.permissionEvaluator = permissionEvaluator;
		CatalogueMedicalEntityListener.auditService = auditService;
		CatalogueMedicalEntityListener.securityProperties = securityProperties;
	}

	@PrePersist
	public void beforePersist(CatalogueMedicalEntity entity) {
	...
	@PostPersist
	public void afterPersist(CatalogueMedicalEntity entity) {
	...
	@PreRemove
	public void beforeRemove(CatalogueMedicalEntity entity) {
	...
	@PostRemove
	public void afterRemove(CatalogueMedicalEntity entity) {
	...
	@PreUpdate
	public void beforeUpdate(CatalogueMedicalEntity entity) {
	...
	@PostUpdate
	public void afterUpdate(CatalogueMedicalEntity entity) {
	...
	@PostLoad
	public void afterLoad(CatalogueMedicalEntity entity) throws JsonProcessingException {
		checkPermission(entity.getClass().getSimpleName(), "read");

		// % protected region % [Override the global configuration for read audits for the CatalogueMedicalEntity here] off begin
		if (securityProperties.isReadAuditEnabled()) {
			// Create a new read record against this entity.
			auditService.createWith(entity);
		}
		// % protected region % [Override the global configuration for read audits for the CatalogueMedicalEntity here] end
	...
	private void checkPermission(@NonNull String entityName, @NonNull String permission) {
		if (!permissionEvaluator.hasPermission(SecurityContextHolder.getContext().getAuthentication(), entityName, permission)) {
			...
			throw new AccessDeniedException("Access to Catalogue Medical  is not permitted.");
		}
	}
	 ...
	 */
	protected void removeAllReferences(CatalogueMedicalEntity entity) {
