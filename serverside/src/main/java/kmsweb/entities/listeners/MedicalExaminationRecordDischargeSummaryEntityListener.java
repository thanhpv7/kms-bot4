...
import kmsweb.configs.security.auditing.services.MedicalExaminationRecordDischargeSummaryEntityReadAuditService;
...
/**
 * Listener class used to tap into life cycle hooks when processing MedicalExaminationRecordDischargeSummaryEntity.
 */
@Slf4j
@Component
public class MedicalExaminationRecordDischargeSummaryEntityListener {

	private static PermissionEvaluator permissionEvaluator;
	private static MedicalExaminationRecordDischargeSummaryEntityReadAuditService auditService;
	...
	public void init(
		...
		MedicalExaminationRecordDischargeSummaryEntityReadAuditService auditService,
		SecurityProperties securityProperties
	) {
		MedicalExaminationRecordDischargeSummaryEntityListener.permissionEvaluator = permissionEvaluator;
		MedicalExaminationRecordDischargeSummaryEntityListener.auditService = auditService;
		MedicalExaminationRecordDischargeSummaryEntityListener.securityProperties = securityProperties;
	}

	@PrePersist
	public void beforePersist(MedicalExaminationRecordDischargeSummaryEntity entity) {
	...
	@PostPersist
	public void afterPersist(MedicalExaminationRecordDischargeSummaryEntity entity) {
	...
	@PreRemove
	public void beforeRemove(MedicalExaminationRecordDischargeSummaryEntity entity) {
	...
	@PostRemove
	public void afterRemove(MedicalExaminationRecordDischargeSummaryEntity entity) {
	...
	@PreUpdate
	public void beforeUpdate(MedicalExaminationRecordDischargeSummaryEntity entity) {
	...
	@PostUpdate
	public void afterUpdate(MedicalExaminationRecordDischargeSummaryEntity entity) {
	...
	@PostLoad
	public void afterLoad(MedicalExaminationRecordDischargeSummaryEntity entity) throws JsonProcessingException {
		checkPermission(entity.getClass().getSimpleName(), "read");

		// % protected region % [Override the global configuration for read audits for the MedicalExaminationRecordDischargeSummaryEntity here] off begin
		if (securityProperties.isReadAuditEnabled()) {
			// Create a new read record against this entity.
			auditService.createWith(entity);
		}
		// % protected region % [Override the global configuration for read audits for the MedicalExaminationRecordDischargeSummaryEntity here] end
	...
	private void checkPermission(@NonNull String entityName, @NonNull String permission) {
		if (!permissionEvaluator.hasPermission(SecurityContextHolder.getContext().getAuthentication(), entityName, permission)) {
			...
			throw new AccessDeniedException("Access to Medical Examination Record Discharge Summary is not permitted.");
		}
	}
	 ...
	 */
	protected void removeAllReferences(MedicalExaminationRecordDischargeSummaryEntity entity) {
		entity.unsetMedicalExaminationRecord();
		entity.unsetDischargingDoctor();
