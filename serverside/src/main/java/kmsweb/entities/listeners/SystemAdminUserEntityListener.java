...
import kmsweb.configs.security.auditing.services.SystemAdminUserEntityReadAuditService;
...
/**
 * Listener class used to tap into life cycle hooks when processing SystemAdminUserEntity.
 */
@Slf4j
@Component
public class SystemAdminUserEntityListener {

	private static PermissionEvaluator permissionEvaluator;
	private static SystemAdminUserEntityReadAuditService auditService;
	...
	public void init(
		...
		SystemAdminUserEntityReadAuditService auditService,
		SecurityProperties securityProperties
	) {
		SystemAdminUserEntityListener.permissionEvaluator = permissionEvaluator;
		SystemAdminUserEntityListener.auditService = auditService;
		SystemAdminUserEntityListener.securityProperties = securityProperties;
	}

	@PrePersist
	public void beforePersist(SystemAdminUserEntity entity) {
	...
	@PostPersist
	public void afterPersist(SystemAdminUserEntity entity) {
	...
	@PreRemove
	public void beforeRemove(SystemAdminUserEntity entity) {
	...
	@PostRemove
	public void afterRemove(SystemAdminUserEntity entity) {
	...
	@PreUpdate
	public void beforeUpdate(SystemAdminUserEntity entity) {
	...
	@PostUpdate
	public void afterUpdate(SystemAdminUserEntity entity) {
	...
	@PostLoad
	public void afterLoad(SystemAdminUserEntity entity) throws JsonProcessingException {
		checkPermission(entity.getClass().getSimpleName(), "read");

		// % protected region % [Override the global configuration for read audits for the SystemAdminUserEntity here] off begin
		if (securityProperties.isReadAuditEnabled()) {
			// Create a new read record against this entity.
			auditService.createWith(entity);
		}
		// % protected region % [Override the global configuration for read audits for the SystemAdminUserEntity here] end
	...
	private void checkPermission(@NonNull String entityName, @NonNull String permission) {
		if (!permissionEvaluator.hasPermission(SecurityContextHolder.getContext().getAuthentication(), entityName, permission)) {
			...
			throw new AccessDeniedException("Access to System Admin User is not permitted.");
		}
	}
	 ...
	 */
	protected void removeAllReferences(SystemAdminUserEntity entity) {
		entity.unsetStaff();
	}
