...
import kmsweb.configs.security.auditing.services.HealthFacilityEntityReadAuditService;
...
/**
 * Listener class used to tap into life cycle hooks when processing HealthFacilityEntity.
 */
@Slf4j
@Component
public class HealthFacilityEntityListener {

	private static PermissionEvaluator permissionEvaluator;
	private static HealthFacilityEntityReadAuditService auditService;
	...
	public void init(
		...
		HealthFacilityEntityReadAuditService auditService,
		SecurityProperties securityProperties
	) {
		HealthFacilityEntityListener.permissionEvaluator = permissionEvaluator;
		HealthFacilityEntityListener.auditService = auditService;
		HealthFacilityEntityListener.securityProperties = securityProperties;
	}

	@PrePersist
	public void beforePersist(HealthFacilityEntity entity) {
	...
	@PostPersist
	public void afterPersist(HealthFacilityEntity entity) {
	...
	@PreRemove
	public void beforeRemove(HealthFacilityEntity entity) {
	...
	@PostRemove
	public void afterRemove(HealthFacilityEntity entity) {
	...
	@PreUpdate
	public void beforeUpdate(HealthFacilityEntity entity) {
	...
	@PostUpdate
	public void afterUpdate(HealthFacilityEntity entity) {
	...
	@PostLoad
	public void afterLoad(HealthFacilityEntity entity) throws JsonProcessingException {
		checkPermission(entity.getClass().getSimpleName(), "read");

		// % protected region % [Override the global configuration for read audits for the HealthFacilityEntity here] off begin
		if (securityProperties.isReadAuditEnabled()) {
			// Create a new read record against this entity.
			auditService.createWith(entity);
		}
		// % protected region % [Override the global configuration for read audits for the HealthFacilityEntity here] end
	...
	private void checkPermission(@NonNull String entityName, @NonNull String permission) {
		if (!permissionEvaluator.hasPermission(SecurityContextHolder.getContext().getAuthentication(), entityName, permission)) {
			...
			throw new AccessDeniedException("Access to Health Facility is not permitted.");
		}
	}
	 ...
	 */
	protected void removeAllReferences(HealthFacilityEntity entity) {
