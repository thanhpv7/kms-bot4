...
import kmsweb.configs.security.auditing.services.MedicalFeeEntityReadAuditService;
...
/**
 * Listener class used to tap into life cycle hooks when processing MedicalFeeEntity.
 */
@Slf4j
@Component
public class MedicalFeeEntityListener {

	private static PermissionEvaluator permissionEvaluator;
	private static MedicalFeeEntityReadAuditService auditService;
	...
	public void init(
		...
		MedicalFeeEntityReadAuditService auditService,
		SecurityProperties securityProperties
	) {
		MedicalFeeEntityListener.permissionEvaluator = permissionEvaluator;
		MedicalFeeEntityListener.auditService = auditService;
		MedicalFeeEntityListener.securityProperties = securityProperties;
	}

	@PrePersist
	public void beforePersist(MedicalFeeEntity entity) {
	...
	@PostPersist
	public void afterPersist(MedicalFeeEntity entity) {
	...
	@PreRemove
	public void beforeRemove(MedicalFeeEntity entity) {
	...
	@PostRemove
	public void afterRemove(MedicalFeeEntity entity) {
	...
	@PreUpdate
	public void beforeUpdate(MedicalFeeEntity entity) {
	...
	@PostUpdate
	public void afterUpdate(MedicalFeeEntity entity) {
	...
	@PostLoad
	public void afterLoad(MedicalFeeEntity entity) throws JsonProcessingException {
		checkPermission(entity.getClass().getSimpleName(), "read");

		// % protected region % [Override the global configuration for read audits for the MedicalFeeEntity here] off begin
		if (securityProperties.isReadAuditEnabled()) {
			// Create a new read record against this entity.
			auditService.createWith(entity);
		}
		// % protected region % [Override the global configuration for read audits for the MedicalFeeEntity here] end
	...
	private void checkPermission(@NonNull String entityName, @NonNull String permission) {
		if (!permissionEvaluator.hasPermission(SecurityContextHolder.getContext().getAuthentication(), entityName, permission)) {
			...
			throw new AccessDeniedException("Access to Medical Fee is not permitted.");
		}
	}
	 ...
	 */
	protected void removeAllReferences(MedicalFeeEntity entity) {
