...
import kmsweb.configs.security.auditing.services.BpjsVisitDataEntityReadAuditService;
...
/**
 * Listener class used to tap into life cycle hooks when processing BpjsVisitDataEntity.
 */
@Slf4j
@Component
public class BpjsVisitDataEntityListener {

	private static PermissionEvaluator permissionEvaluator;
	private static BpjsVisitDataEntityReadAuditService auditService;
	...
	public void init(
		...
		BpjsVisitDataEntityReadAuditService auditService,
		SecurityProperties securityProperties
	) {
		BpjsVisitDataEntityListener.permissionEvaluator = permissionEvaluator;
		BpjsVisitDataEntityListener.auditService = auditService;
		BpjsVisitDataEntityListener.securityProperties = securityProperties;
	}

	@PrePersist
	public void beforePersist(BpjsVisitDataEntity entity) {
	...
	@PostPersist
	public void afterPersist(BpjsVisitDataEntity entity) {
	...
	@PreRemove
	public void beforeRemove(BpjsVisitDataEntity entity) {
	...
	@PostRemove
	public void afterRemove(BpjsVisitDataEntity entity) {
	...
	@PreUpdate
	public void beforeUpdate(BpjsVisitDataEntity entity) {
	...
	@PostUpdate
	public void afterUpdate(BpjsVisitDataEntity entity) {
	...
	@PostLoad
	public void afterLoad(BpjsVisitDataEntity entity) throws JsonProcessingException {
		checkPermission(entity.getClass().getSimpleName(), "read");

		// % protected region % [Override the global configuration for read audits for the BpjsVisitDataEntity here] off begin
		if (securityProperties.isReadAuditEnabled()) {
			// Create a new read record against this entity.
			auditService.createWith(entity);
		}
		// % protected region % [Override the global configuration for read audits for the BpjsVisitDataEntity here] end
	...
	private void checkPermission(@NonNull String entityName, @NonNull String permission) {
		if (!permissionEvaluator.hasPermission(SecurityContextHolder.getContext().getAuthentication(), entityName, permission)) {
			...
			throw new AccessDeniedException("Access to BPJS Visit Data is not permitted.");
		}
	}
	 ...
	 */
	protected void removeAllReferences(BpjsVisitDataEntity entity) {
