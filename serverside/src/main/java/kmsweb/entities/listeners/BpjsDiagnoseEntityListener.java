...
import kmsweb.configs.security.auditing.services.BpjsDiagnoseEntityReadAuditService;
...
/**
 * Listener class used to tap into life cycle hooks when processing BpjsDiagnoseEntity.
 */
@Slf4j
@Component
public class BpjsDiagnoseEntityListener {

	private static PermissionEvaluator permissionEvaluator;
	private static BpjsDiagnoseEntityReadAuditService auditService;
	...
	public void init(
		...
		BpjsDiagnoseEntityReadAuditService auditService,
		SecurityProperties securityProperties
	) {
		BpjsDiagnoseEntityListener.permissionEvaluator = permissionEvaluator;
		BpjsDiagnoseEntityListener.auditService = auditService;
		BpjsDiagnoseEntityListener.securityProperties = securityProperties;
	}

	@PrePersist
	public void beforePersist(BpjsDiagnoseEntity entity) {
	...
	@PostPersist
	public void afterPersist(BpjsDiagnoseEntity entity) {
	...
	@PreRemove
	public void beforeRemove(BpjsDiagnoseEntity entity) {
	...
	@PostRemove
	public void afterRemove(BpjsDiagnoseEntity entity) {
	...
	@PreUpdate
	public void beforeUpdate(BpjsDiagnoseEntity entity) {
	...
	@PostUpdate
	public void afterUpdate(BpjsDiagnoseEntity entity) {
	...
	@PostLoad
	public void afterLoad(BpjsDiagnoseEntity entity) throws JsonProcessingException {
		checkPermission(entity.getClass().getSimpleName(), "read");

		// % protected region % [Override the global configuration for read audits for the BpjsDiagnoseEntity here] off begin
		if (securityProperties.isReadAuditEnabled()) {
			// Create a new read record against this entity.
			auditService.createWith(entity);
		}
		// % protected region % [Override the global configuration for read audits for the BpjsDiagnoseEntity here] end
	...
	private void checkPermission(@NonNull String entityName, @NonNull String permission) {
		if (!permissionEvaluator.hasPermission(SecurityContextHolder.getContext().getAuthentication(), entityName, permission)) {
			...
			throw new AccessDeniedException("Access to BPJS Diagnose is not permitted.");
		}
	}
	 ...
	 */
	protected void removeAllReferences(BpjsDiagnoseEntity entity) {
