...
import kmsweb.configs.security.auditing.services.NurseVitalSignMeasurementEntityReadAuditService;
...
/**
 * Listener class used to tap into life cycle hooks when processing NurseVitalSignMeasurementEntity.
 */
@Slf4j
@Component
public class NurseVitalSignMeasurementEntityListener {

	private static PermissionEvaluator permissionEvaluator;
	private static NurseVitalSignMeasurementEntityReadAuditService auditService;
	...
	public void init(
		...
		NurseVitalSignMeasurementEntityReadAuditService auditService,
		SecurityProperties securityProperties
	) {
		NurseVitalSignMeasurementEntityListener.permissionEvaluator = permissionEvaluator;
		NurseVitalSignMeasurementEntityListener.auditService = auditService;
		NurseVitalSignMeasurementEntityListener.securityProperties = securityProperties;
	}

	@PrePersist
	public void beforePersist(NurseVitalSignMeasurementEntity entity) {
	...
	@PostPersist
	public void afterPersist(NurseVitalSignMeasurementEntity entity) {
	...
	@PreRemove
	public void beforeRemove(NurseVitalSignMeasurementEntity entity) {
	...
	@PostRemove
	public void afterRemove(NurseVitalSignMeasurementEntity entity) {
	...
	@PreUpdate
	public void beforeUpdate(NurseVitalSignMeasurementEntity entity) {
	...
	@PostUpdate
	public void afterUpdate(NurseVitalSignMeasurementEntity entity) {
	...
	@PostLoad
	public void afterLoad(NurseVitalSignMeasurementEntity entity) throws JsonProcessingException {
		checkPermission(entity.getClass().getSimpleName(), "read");

		// % protected region % [Override the global configuration for read audits for the NurseVitalSignMeasurementEntity here] off begin
		if (securityProperties.isReadAuditEnabled()) {
			// Create a new read record against this entity.
			auditService.createWith(entity);
		}
		// % protected region % [Override the global configuration for read audits for the NurseVitalSignMeasurementEntity here] end
	...
	private void checkPermission(@NonNull String entityName, @NonNull String permission) {
		if (!permissionEvaluator.hasPermission(SecurityContextHolder.getContext().getAuthentication(), entityName, permission)) {
			...
			throw new AccessDeniedException("Access to Nurse Vital Sign Measurement is not permitted.");
		}
	}
	 ...
	 */
	protected void removeAllReferences(NurseVitalSignMeasurementEntity entity) {
