...
import kmsweb.configs.security.auditing.services.MedicalExaminationRecordEntityReadAuditService;
...
/**
 * Listener class used to tap into life cycle hooks when processing MedicalExaminationRecordEntity.
 */
@Slf4j
@Component
public class MedicalExaminationRecordEntityListener {

	private static PermissionEvaluator permissionEvaluator;
	private static MedicalExaminationRecordEntityReadAuditService auditService;
	...
	public void init(
		...
		MedicalExaminationRecordEntityReadAuditService auditService,
		SecurityProperties securityProperties
	) {
		MedicalExaminationRecordEntityListener.permissionEvaluator = permissionEvaluator;
		MedicalExaminationRecordEntityListener.auditService = auditService;
		MedicalExaminationRecordEntityListener.securityProperties = securityProperties;
	}

	@PrePersist
	public void beforePersist(MedicalExaminationRecordEntity entity) {
	...
	@PostPersist
	public void afterPersist(MedicalExaminationRecordEntity entity) {
	...
	@PreRemove
	public void beforeRemove(MedicalExaminationRecordEntity entity) {
	...
	@PostRemove
	public void afterRemove(MedicalExaminationRecordEntity entity) {
	...
	@PreUpdate
	public void beforeUpdate(MedicalExaminationRecordEntity entity) {
	...
	@PostUpdate
	public void afterUpdate(MedicalExaminationRecordEntity entity) {
	...
	@PostLoad
	public void afterLoad(MedicalExaminationRecordEntity entity) throws JsonProcessingException {
		checkPermission(entity.getClass().getSimpleName(), "read");

		// % protected region % [Override the global configuration for read audits for the MedicalExaminationRecordEntity here] off begin
		if (securityProperties.isReadAuditEnabled()) {
			// Create a new read record against this entity.
			auditService.createWith(entity);
		}
		// % protected region % [Override the global configuration for read audits for the MedicalExaminationRecordEntity here] end
	...
	private void checkPermission(@NonNull String entityName, @NonNull String permission) {
		if (!permissionEvaluator.hasPermission(SecurityContextHolder.getContext().getAuthentication(), entityName, permission)) {
			...
			throw new AccessDeniedException("Access to Medical Examination Record is not permitted.");
		}
	}
	 ...
	 */
	protected void removeAllReferences(MedicalExaminationRecordEntity entity) {
		entity.unsetInpatientMedicalExaminationRecord();
		entity.unsetRegistration();
		entity.unsetBirthHistory();
		entity.unsetBodyChartExamination();
		entity.unsetDeliveryMedicalExaminationRecord();
		entity.unsetEntExamination();
		entity.unsetEmergencyMedicationExaminationRecord();
		entity.unsetFormulirKonselingTesHiv();
		entity.unsetHemodialysisExamination();
		entity.unsetMedicalExaminationRecordDischargeSummary();
		entity.unsetMedicalRecordInitialChecklist();
		entity.unsetMedicalRecordNextVerificationChecklist();
		entity.unsetNurseVitalSignMeasurement();
		entity.unsetObstetricAndGynecologyHistory();
		entity.unsetOdontogramExamination();
		entity.unsetOperatingTheaterMedicalExaminationRecord();
		entity.unsetOphthalmologyExamination();
		entity.unsetDoctor();
		entity.unsetMedicalTranscriber();
		entity.unsetNurse();
		entity.unsetAmendmentDetails();
		entity.unsetCoTreatingDoctors();
		entity.unsetDailyCareCPPTs();
		entity.unsetDiagnosisExaminationRecords();
		entity.unsetDiagnosisNandas();
