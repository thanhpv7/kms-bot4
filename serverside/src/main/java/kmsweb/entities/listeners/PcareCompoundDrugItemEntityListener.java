...
import kmsweb.configs.security.auditing.services.PcareCompoundDrugItemEntityReadAuditService;
...
/**
 * Listener class used to tap into life cycle hooks when processing PcareCompoundDrugItemEntity.
 */
@Slf4j
@Component
public class PcareCompoundDrugItemEntityListener {

	private static PermissionEvaluator permissionEvaluator;
	private static PcareCompoundDrugItemEntityReadAuditService auditService;
	...
	public void init(
		...
		PcareCompoundDrugItemEntityReadAuditService auditService,
		SecurityProperties securityProperties
	) {
		PcareCompoundDrugItemEntityListener.permissionEvaluator = permissionEvaluator;
		PcareCompoundDrugItemEntityListener.auditService = auditService;
		PcareCompoundDrugItemEntityListener.securityProperties = securityProperties;
	}

	@PrePersist
	public void beforePersist(PcareCompoundDrugItemEntity entity) {
	...
	@PostPersist
	public void afterPersist(PcareCompoundDrugItemEntity entity) {
	...
	@PreRemove
	public void beforeRemove(PcareCompoundDrugItemEntity entity) {
	...
	@PostRemove
	public void afterRemove(PcareCompoundDrugItemEntity entity) {
	...
	@PreUpdate
	public void beforeUpdate(PcareCompoundDrugItemEntity entity) {
	...
	@PostUpdate
	public void afterUpdate(PcareCompoundDrugItemEntity entity) {
	...
	@PostLoad
	public void afterLoad(PcareCompoundDrugItemEntity entity) throws JsonProcessingException {
		checkPermission(entity.getClass().getSimpleName(), "read");

		// % protected region % [Override the global configuration for read audits for the PcareCompoundDrugItemEntity here] off begin
		if (securityProperties.isReadAuditEnabled()) {
			// Create a new read record against this entity.
			auditService.createWith(entity);
		}
		// % protected region % [Override the global configuration for read audits for the PcareCompoundDrugItemEntity here] end
	...
	private void checkPermission(@NonNull String entityName, @NonNull String permission) {
		if (!permissionEvaluator.hasPermission(SecurityContextHolder.getContext().getAuthentication(), entityName, permission)) {
			...
			throw new AccessDeniedException("Access to PCare Compound Drug Item is not permitted.");
		}
	}
	 ...
	 */
	protected void removeAllReferences(PcareCompoundDrugItemEntity entity) {
		entity.unsetPcareCompoundDrug();
	}
