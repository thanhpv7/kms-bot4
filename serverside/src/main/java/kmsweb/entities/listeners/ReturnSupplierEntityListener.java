...
import kmsweb.configs.security.auditing.services.ReturnSupplierEntityReadAuditService;
...
/**
 * Listener class used to tap into life cycle hooks when processing ReturnSupplierEntity.
 */
@Slf4j
@Component
public class ReturnSupplierEntityListener {

	private static PermissionEvaluator permissionEvaluator;
	private static ReturnSupplierEntityReadAuditService auditService;
	...
	public void init(
		...
		ReturnSupplierEntityReadAuditService auditService,
		SecurityProperties securityProperties
	) {
		ReturnSupplierEntityListener.permissionEvaluator = permissionEvaluator;
		ReturnSupplierEntityListener.auditService = auditService;
		ReturnSupplierEntityListener.securityProperties = securityProperties;
	}

	@PrePersist
	public void beforePersist(ReturnSupplierEntity entity) {
	...
	@PostPersist
	public void afterPersist(ReturnSupplierEntity entity) {
	...
	@PreRemove
	public void beforeRemove(ReturnSupplierEntity entity) {
	...
	@PostRemove
	public void afterRemove(ReturnSupplierEntity entity) {
	...
	@PreUpdate
	public void beforeUpdate(ReturnSupplierEntity entity) {
	...
	@PostUpdate
	public void afterUpdate(ReturnSupplierEntity entity) {
	...
	@PostLoad
	public void afterLoad(ReturnSupplierEntity entity) throws JsonProcessingException {
		checkPermission(entity.getClass().getSimpleName(), "read");

		// % protected region % [Override the global configuration for read audits for the ReturnSupplierEntity here] off begin
		if (securityProperties.isReadAuditEnabled()) {
			// Create a new read record against this entity.
			auditService.createWith(entity);
		}
		// % protected region % [Override the global configuration for read audits for the ReturnSupplierEntity here] end
	...
	private void checkPermission(@NonNull String entityName, @NonNull String permission) {
		if (!permissionEvaluator.hasPermission(SecurityContextHolder.getContext().getAuthentication(), entityName, permission)) {
			...
			throw new AccessDeniedException("Access to Return Supplier is not permitted.");
		}
	}
	 ...
	 */
	protected void removeAllReferences(ReturnSupplierEntity entity) {
