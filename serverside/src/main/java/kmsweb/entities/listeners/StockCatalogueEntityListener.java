...
import kmsweb.configs.security.auditing.services.StockCatalogueEntityReadAuditService;
...
/**
 * Listener class used to tap into life cycle hooks when processing StockCatalogueEntity.
 */
@Slf4j
@Component
public class StockCatalogueEntityListener {

	private static PermissionEvaluator permissionEvaluator;
	private static StockCatalogueEntityReadAuditService auditService;
	...
	public void init(
		...
		StockCatalogueEntityReadAuditService auditService,
		SecurityProperties securityProperties
	) {
		StockCatalogueEntityListener.permissionEvaluator = permissionEvaluator;
		StockCatalogueEntityListener.auditService = auditService;
		StockCatalogueEntityListener.securityProperties = securityProperties;
	}

	@PrePersist
	public void beforePersist(StockCatalogueEntity entity) {
	...
	@PostPersist
	public void afterPersist(StockCatalogueEntity entity) {
	...
	@PreRemove
	public void beforeRemove(StockCatalogueEntity entity) {
	...
	@PostRemove
	public void afterRemove(StockCatalogueEntity entity) {
	...
	@PreUpdate
	public void beforeUpdate(StockCatalogueEntity entity) {
	...
	@PostUpdate
	public void afterUpdate(StockCatalogueEntity entity) {
	...
	@PostLoad
	public void afterLoad(StockCatalogueEntity entity) throws JsonProcessingException {
		checkPermission(entity.getClass().getSimpleName(), "read");

		// % protected region % [Override the global configuration for read audits for the StockCatalogueEntity here] off begin
		if (securityProperties.isReadAuditEnabled()) {
			// Create a new read record against this entity.
			auditService.createWith(entity);
		}
		// % protected region % [Override the global configuration for read audits for the StockCatalogueEntity here] end
	...
	private void checkPermission(@NonNull String entityName, @NonNull String permission) {
		if (!permissionEvaluator.hasPermission(SecurityContextHolder.getContext().getAuthentication(), entityName, permission)) {
			...
			throw new AccessDeniedException("Access to Stock Catalogue is not permitted.");
		}
	}
	 ...
	 */
	protected void removeAllReferences(StockCatalogueEntity entity) {
		entity.unsetBpjsDrugGenericPRB();
		entity.unsetBpjsPcareDPHO();
		entity.unsetStockCatalogueMedical();
		entity.unsetStockCatalogueNonMedical();
		entity.unsetWarehouse();
		entity.unsetBatchStockBalancesCatalogue();
		entity.unsetBatchStockBalances();
		entity.unsetBatchStockTransactionDetails();
		entity.unsetCatalogueUOMs();
		entity.unsetCompoundPrescriptionItems();
		entity.unsetGoodsReceiveNoteBatchs();
		entity.unsetGoodsReceiveNoteItems();
		entity.unsetInternalOrderStockDetails();
		entity.unsetInventoryAdjusmentBatchs();
		entity.unsetInventoryAdjustmentItems();
		entity.unsetInventoryBatchCorrectionItems();
		entity.unsetMedicationItems();
		entity.unsetPrescriptionItem();
		entity.unsetPurchaseOrderStockDetails();
		entity.unsetPurchaseRequisitionStockDetails();
		entity.unsetRetailPharmacyStockDetails();
		entity.unsetReturnSupplierStockDetails();
		entity.unsetStockControls();
		entity.unsetStockTransactionDetails();
		entity.unsetStockTransactionPerDateTypes();
		entity.unsetStockTransactionPerDates();
		entity.unsetSupplierProductDetails();
		entity.unsetTransferOrderStockDetails();
		entity.unsetVaccinationOrderDetails();
		entity.unsetWarehouseInitialStockS();
		entity.unsetWarehouseInventories();
	}
