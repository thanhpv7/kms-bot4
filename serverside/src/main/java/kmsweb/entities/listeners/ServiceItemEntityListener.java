...
import kmsweb.configs.security.auditing.services.ServiceItemEntityReadAuditService;
...
/**
 * Listener class used to tap into life cycle hooks when processing ServiceItemEntity.
 */
@Slf4j
@Component
public class ServiceItemEntityListener {

	private static PermissionEvaluator permissionEvaluator;
	private static ServiceItemEntityReadAuditService auditService;
	...
	public void init(
		...
		ServiceItemEntityReadAuditService auditService,
		SecurityProperties securityProperties
	) {
		ServiceItemEntityListener.permissionEvaluator = permissionEvaluator;
		ServiceItemEntityListener.auditService = auditService;
		ServiceItemEntityListener.securityProperties = securityProperties;
	}

	@PrePersist
	public void beforePersist(ServiceItemEntity entity) {
	...
	@PostPersist
	public void afterPersist(ServiceItemEntity entity) {
	...
	@PreRemove
	public void beforeRemove(ServiceItemEntity entity) {
	...
	@PostRemove
	public void afterRemove(ServiceItemEntity entity) {
	...
	@PreUpdate
	public void beforeUpdate(ServiceItemEntity entity) {
	...
	@PostUpdate
	public void afterUpdate(ServiceItemEntity entity) {
	...
	@PostLoad
	public void afterLoad(ServiceItemEntity entity) throws JsonProcessingException {
		checkPermission(entity.getClass().getSimpleName(), "read");

		// % protected region % [Override the global configuration for read audits for the ServiceItemEntity here] off begin
		if (securityProperties.isReadAuditEnabled()) {
			// Create a new read record against this entity.
			auditService.createWith(entity);
		}
		// % protected region % [Override the global configuration for read audits for the ServiceItemEntity here] end
	...
	private void checkPermission(@NonNull String entityName, @NonNull String permission) {
		if (!permissionEvaluator.hasPermission(SecurityContextHolder.getContext().getAuthentication(), entityName, permission)) {
			...
			throw new AccessDeniedException("Access to Service Item is not permitted.");
		}
	}
	 ...
	 */
	protected void removeAllReferences(ServiceItemEntity entity) {
