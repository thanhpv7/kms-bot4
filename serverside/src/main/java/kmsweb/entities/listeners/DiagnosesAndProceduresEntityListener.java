...
import kmsweb.configs.security.auditing.services.DiagnosesAndProceduresEntityReadAuditService;
...
/**
 * Listener class used to tap into life cycle hooks when processing DiagnosesAndProceduresEntity.
 */
@Slf4j
@Component
public class DiagnosesAndProceduresEntityListener {

	private static PermissionEvaluator permissionEvaluator;
	private static DiagnosesAndProceduresEntityReadAuditService auditService;
	...
	public void init(
		...
		DiagnosesAndProceduresEntityReadAuditService auditService,
		SecurityProperties securityProperties
	) {
		DiagnosesAndProceduresEntityListener.permissionEvaluator = permissionEvaluator;
		DiagnosesAndProceduresEntityListener.auditService = auditService;
		DiagnosesAndProceduresEntityListener.securityProperties = securityProperties;
	}

	@PrePersist
	public void beforePersist(DiagnosesAndProceduresEntity entity) {
	...
	@PostPersist
	public void afterPersist(DiagnosesAndProceduresEntity entity) {
	...
	@PreRemove
	public void beforeRemove(DiagnosesAndProceduresEntity entity) {
	...
	@PostRemove
	public void afterRemove(DiagnosesAndProceduresEntity entity) {
	...
	@PreUpdate
	public void beforeUpdate(DiagnosesAndProceduresEntity entity) {
	...
	@PostUpdate
	public void afterUpdate(DiagnosesAndProceduresEntity entity) {
	...
	@PostLoad
	public void afterLoad(DiagnosesAndProceduresEntity entity) throws JsonProcessingException {
		checkPermission(entity.getClass().getSimpleName(), "read");

		// % protected region % [Override the global configuration for read audits for the DiagnosesAndProceduresEntity here] off begin
		if (securityProperties.isReadAuditEnabled()) {
			// Create a new read record against this entity.
			auditService.createWith(entity);
		}
		// % protected region % [Override the global configuration for read audits for the DiagnosesAndProceduresEntity here] end
	...
	private void checkPermission(@NonNull String entityName, @NonNull String permission) {
		if (!permissionEvaluator.hasPermission(SecurityContextHolder.getContext().getAuthentication(), entityName, permission)) {
			...
			throw new AccessDeniedException("Access to Diagnoses and Procedures is not permitted.");
		}
	}
	 ...
	 */
	protected void removeAllReferences(DiagnosesAndProceduresEntity entity) {
		entity.unsetBpjsDiagnose();
		entity.unsetBpjsDiagnosePRB();
		entity.unsetMasterICD10();
		entity.unsetMasterICD9CM();
		entity.unsetAdmissionICD10();
		entity.unsetAdmissionICD9CM();
		entity.unsetCpptICD10();
		entity.unsetCpptICD9CM();
		entity.unsetDischargeICD10();
		entity.unsetDischargeICD9CM();
		entity.unsetIcd10();
		entity.unsetIcd9CM();
		entity.unsetInvoicesICD10();
		entity.unsetInvoicesICD9CM();
		entity.unsetPostOperativeICD10();
		entity.unsetPostOperativeICD9CM();
		entity.unsetPreSurgeryICD10();
		entity.unsetPreSurgeryICD9CM();
