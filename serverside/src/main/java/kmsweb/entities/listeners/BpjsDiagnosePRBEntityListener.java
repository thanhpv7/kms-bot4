...
import kmsweb.configs.security.auditing.services.BpjsDiagnosePRBEntityReadAuditService;
...
/**
 * Listener class used to tap into life cycle hooks when processing BpjsDiagnosePRBEntity.
 */
@Slf4j
@Component
public class BpjsDiagnosePRBEntityListener {

	private static PermissionEvaluator permissionEvaluator;
	private static BpjsDiagnosePRBEntityReadAuditService auditService;
	...
	public void init(
		...
		BpjsDiagnosePRBEntityReadAuditService auditService,
		SecurityProperties securityProperties
	) {
		BpjsDiagnosePRBEntityListener.permissionEvaluator = permissionEvaluator;
		BpjsDiagnosePRBEntityListener.auditService = auditService;
		BpjsDiagnosePRBEntityListener.securityProperties = securityProperties;
	}

	@PrePersist
	public void beforePersist(BpjsDiagnosePRBEntity entity) {
	...
	@PostPersist
	public void afterPersist(BpjsDiagnosePRBEntity entity) {
	...
	@PreRemove
	public void beforeRemove(BpjsDiagnosePRBEntity entity) {
	...
	@PostRemove
	public void afterRemove(BpjsDiagnosePRBEntity entity) {
	...
	@PreUpdate
	public void beforeUpdate(BpjsDiagnosePRBEntity entity) {
	...
	@PostUpdate
	public void afterUpdate(BpjsDiagnosePRBEntity entity) {
	...
	@PostLoad
	public void afterLoad(BpjsDiagnosePRBEntity entity) throws JsonProcessingException {
		checkPermission(entity.getClass().getSimpleName(), "read");

		// % protected region % [Override the global configuration for read audits for the BpjsDiagnosePRBEntity here] off begin
		if (securityProperties.isReadAuditEnabled()) {
			// Create a new read record against this entity.
			auditService.createWith(entity);
		}
		// % protected region % [Override the global configuration for read audits for the BpjsDiagnosePRBEntity here] end
	...
	private void checkPermission(@NonNull String entityName, @NonNull String permission) {
		if (!permissionEvaluator.hasPermission(SecurityContextHolder.getContext().getAuthentication(), entityName, permission)) {
			...
			throw new AccessDeniedException("Access to BPJS Diagnose PRB is not permitted.");
		}
	}
	 ...
	 */
	protected void removeAllReferences(BpjsDiagnosePRBEntity entity) {
