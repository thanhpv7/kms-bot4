...
import kmsweb.configs.security.auditing.services.MedicalCertificateMentalHealthEntityReadAuditService;
...
/**
 * Listener class used to tap into life cycle hooks when processing MedicalCertificateMentalHealthEntity.
 */
@Slf4j
@Component
public class MedicalCertificateMentalHealthEntityListener {

	private static PermissionEvaluator permissionEvaluator;
	private static MedicalCertificateMentalHealthEntityReadAuditService auditService;
	...
	public void init(
		...
		MedicalCertificateMentalHealthEntityReadAuditService auditService,
		SecurityProperties securityProperties
	) {
		MedicalCertificateMentalHealthEntityListener.permissionEvaluator = permissionEvaluator;
		MedicalCertificateMentalHealthEntityListener.auditService = auditService;
		MedicalCertificateMentalHealthEntityListener.securityProperties = securityProperties;
	}

	@PrePersist
	public void beforePersist(MedicalCertificateMentalHealthEntity entity) {
	...
	@PostPersist
	public void afterPersist(MedicalCertificateMentalHealthEntity entity) {
	...
	@PreRemove
	public void beforeRemove(MedicalCertificateMentalHealthEntity entity) {
	...
	@PostRemove
	public void afterRemove(MedicalCertificateMentalHealthEntity entity) {
	...
	@PreUpdate
	public void beforeUpdate(MedicalCertificateMentalHealthEntity entity) {
	...
	@PostUpdate
	public void afterUpdate(MedicalCertificateMentalHealthEntity entity) {
	...
	@PostLoad
	public void afterLoad(MedicalCertificateMentalHealthEntity entity) throws JsonProcessingException {
		checkPermission(entity.getClass().getSimpleName(), "read");

		// % protected region % [Override the global configuration for read audits for the MedicalCertificateMentalHealthEntity here] off begin
		if (securityProperties.isReadAuditEnabled()) {
			// Create a new read record against this entity.
			auditService.createWith(entity);
		}
		// % protected region % [Override the global configuration for read audits for the MedicalCertificateMentalHealthEntity here] end
	...
	private void checkPermission(@NonNull String entityName, @NonNull String permission) {
		if (!permissionEvaluator.hasPermission(SecurityContextHolder.getContext().getAuthentication(), entityName, permission)) {
			...
			throw new AccessDeniedException("Access to Medical Certificate Mental Health is not permitted.");
		}
	}
	 ...
	 */
	protected void removeAllReferences(MedicalCertificateMentalHealthEntity entity) {
