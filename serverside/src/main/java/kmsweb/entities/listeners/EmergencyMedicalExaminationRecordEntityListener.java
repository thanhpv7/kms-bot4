...
import kmsweb.configs.security.auditing.services.EmergencyMedicalExaminationRecordEntityReadAuditService;
...
/**
 * Listener class used to tap into life cycle hooks when processing EmergencyMedicalExaminationRecordEntity.
 */
@Slf4j
@Component
public class EmergencyMedicalExaminationRecordEntityListener {

	private static PermissionEvaluator permissionEvaluator;
	private static EmergencyMedicalExaminationRecordEntityReadAuditService auditService;
	...
	public void init(
		...
		EmergencyMedicalExaminationRecordEntityReadAuditService auditService,
		SecurityProperties securityProperties
	) {
		EmergencyMedicalExaminationRecordEntityListener.permissionEvaluator = permissionEvaluator;
		EmergencyMedicalExaminationRecordEntityListener.auditService = auditService;
		EmergencyMedicalExaminationRecordEntityListener.securityProperties = securityProperties;
	}

	@PrePersist
	public void beforePersist(EmergencyMedicalExaminationRecordEntity entity) {
	...
	@PostPersist
	public void afterPersist(EmergencyMedicalExaminationRecordEntity entity) {
	...
	@PreRemove
	public void beforeRemove(EmergencyMedicalExaminationRecordEntity entity) {
	...
	@PostRemove
	public void afterRemove(EmergencyMedicalExaminationRecordEntity entity) {
	...
	@PreUpdate
	public void beforeUpdate(EmergencyMedicalExaminationRecordEntity entity) {
	...
	@PostUpdate
	public void afterUpdate(EmergencyMedicalExaminationRecordEntity entity) {
	...
	@PostLoad
	public void afterLoad(EmergencyMedicalExaminationRecordEntity entity) throws JsonProcessingException {
		checkPermission(entity.getClass().getSimpleName(), "read");

		// % protected region % [Override the global configuration for read audits for the EmergencyMedicalExaminationRecordEntity here] off begin
		if (securityProperties.isReadAuditEnabled()) {
			// Create a new read record against this entity.
			auditService.createWith(entity);
		}
		// % protected region % [Override the global configuration for read audits for the EmergencyMedicalExaminationRecordEntity here] end
	...
	private void checkPermission(@NonNull String entityName, @NonNull String permission) {
		if (!permissionEvaluator.hasPermission(SecurityContextHolder.getContext().getAuthentication(), entityName, permission)) {
			...
			throw new AccessDeniedException("Access to Emergency Medical Examination Record is not permitted.");
		}
	}
	 ...
	 */
	protected void removeAllReferences(EmergencyMedicalExaminationRecordEntity entity) {
