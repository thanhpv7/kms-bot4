...
@ToString
public class GoodsReceiveNoteBatchEntityAudit extends AbstractEntityAudit<GoodsReceiveNoteBatchEntity> {
	...
	public GoodsReceiveNoteBatchEntityAudit(
			...
			GoodsReceiveNoteBatchEntity entity,
