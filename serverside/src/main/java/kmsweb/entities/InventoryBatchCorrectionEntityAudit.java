...
@ToString
public class InventoryBatchCorrectionEntityAudit extends AbstractEntityAudit<InventoryBatchCorrectionEntity> {
	...
	public InventoryBatchCorrectionEntityAudit(
			...
			InventoryBatchCorrectionEntity entity,
