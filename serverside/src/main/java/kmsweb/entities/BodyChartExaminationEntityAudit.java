...
@ToString
public class BodyChartExaminationEntityAudit extends AbstractEntityAudit<BodyChartExaminationEntity> {
	...
	public BodyChartExaminationEntityAudit(
			...
			BodyChartExaminationEntity entity,
