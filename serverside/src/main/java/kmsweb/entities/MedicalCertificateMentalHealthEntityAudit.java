...
@ToString
public class MedicalCertificateMentalHealthEntityAudit extends AbstractEntityAudit<MedicalCertificateMentalHealthEntity> {
	...
	public MedicalCertificateMentalHealthEntityAudit(
			...
			MedicalCertificateMentalHealthEntity entity,
