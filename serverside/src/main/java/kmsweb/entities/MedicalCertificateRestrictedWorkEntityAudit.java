...
@ToString
public class MedicalCertificateRestrictedWorkEntityAudit extends AbstractEntityAudit<MedicalCertificateRestrictedWorkEntity> {
	...
	public MedicalCertificateRestrictedWorkEntityAudit(
			...
			MedicalCertificateRestrictedWorkEntity entity,
