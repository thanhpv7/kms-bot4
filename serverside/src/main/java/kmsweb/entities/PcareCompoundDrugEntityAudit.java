...
@ToString
public class PcareCompoundDrugEntityAudit extends AbstractEntityAudit<PcareCompoundDrugEntity> {
	...
	public PcareCompoundDrugEntityAudit(
			...
			PcareCompoundDrugEntity entity,
