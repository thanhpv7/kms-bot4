...
@ToString
public class OphthalmologyExaminationEntityAudit extends AbstractEntityAudit<OphthalmologyExaminationEntity> {
	...
	public OphthalmologyExaminationEntityAudit(
			...
			OphthalmologyExaminationEntity entity,
