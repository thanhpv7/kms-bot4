...
@ToString
public class DiagnosticSupportUserEntityAudit extends AbstractEntityAudit<DiagnosticSupportUserEntity> {
	...
	public DiagnosticSupportUserEntityAudit(
			...
			DiagnosticSupportUserEntity entity,
