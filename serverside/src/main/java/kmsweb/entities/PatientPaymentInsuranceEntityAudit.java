...
@ToString
public class PatientPaymentInsuranceEntityAudit extends AbstractEntityAudit<PatientPaymentInsuranceEntity> {
	...
	public PatientPaymentInsuranceEntityAudit(
			...
			PatientPaymentInsuranceEntity entity,
