...
import kmsweb.entities.listeners.WarehouseUserEntityListener;
import kmsweb.serializers.WarehouseUserSerializer;
...
@EntityListeners({WarehouseUserEntityListener.class, AuditingEntityListener.class})
@JsonSerialize(using = WarehouseUserSerializer.class)
@Table(
	uniqueConstraints = {
	}
)
public class WarehouseUserEntity extends UserEntity {

	/**
	 * Takes a WarehouseUserEntityDto and converts it into a WarehouseUserEntity.
	 * Primarily used when endpoints are invoked, as they take DTOs as input, which need to be converted to the entity type
	 *
	 * @param warehouseUserEntityDto
	 */
	public WarehouseUserEntity(WarehouseUserEntityDto warehouseUserEntityDto) {
		// Need to account for potential that any field is empty.  This will be run before any server validation and
		// endpoints will most likely not be subject to clientside validation

		if (warehouseUserEntityDto.getId() != null) {
			this.setId(warehouseUserEntityDto.getId());
		}

		if (warehouseUserEntityDto.getStaff() != null) {
			this.setStaff(warehouseUserEntityDto.getStaff());
		}
	...
	@OneToOne(mappedBy = "warehouseUser", cascade = {CascadeType.MERGE}, fetch = FetchType.LAZY)
	@CsvIgnore
	 ...
	 *
	 * @param entity the WarehouseUserEntity to be set or updated
	...
	public void setStaff(@NotNull StaffEntity entity, boolean reverseAdd) {
		...
		if (this.staff != null) {
			this.staff.unsetWarehouseUser();
		}

		this.staff = entity;

		if (reverseAdd) {
			this.staff.setWarehouseUser(this, false);
		}
	...
	public void unsetStaff(boolean reverse) {
		if (reverse && this.staff != null) {
			this.staff.unsetWarehouseUser(false);
		}
		this.staff = null;
	}
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	@Override
	public boolean equals(Object warehouseUser) {
		if (this == warehouseUser) {
			return true;
		}
		if (warehouseUser == null || this.getClass() != warehouseUser.getClass()) {
			return false;
		}
		if (!super.equals(warehouseUser)) {
			return false;
		}

		// Compare references by ids only
		this.addRelationEntitiesToIdSet();
		WarehouseUserEntity that = (WarehouseUserEntity) warehouseUser;
		return
