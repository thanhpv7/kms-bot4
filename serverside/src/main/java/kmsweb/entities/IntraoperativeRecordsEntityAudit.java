...
@ToString
public class IntraoperativeRecordsEntityAudit extends AbstractEntityAudit<IntraoperativeRecordsEntity> {
	...
	public IntraoperativeRecordsEntityAudit(
			...
			IntraoperativeRecordsEntity entity,
