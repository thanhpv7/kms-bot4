...
@ToString
public class BpjsOutsideFacilityReferralEntityAudit extends AbstractEntityAudit<BpjsOutsideFacilityReferralEntity> {
	...
	public BpjsOutsideFacilityReferralEntityAudit(
			...
			BpjsOutsideFacilityReferralEntity entity,
