...
@ToString
public class PurchaseOrderStockDetailEntityAudit extends AbstractEntityAudit<PurchaseOrderStockDetailEntity> {
	...
	public PurchaseOrderStockDetailEntityAudit(
			...
			PurchaseOrderStockDetailEntity entity,
