...
@ToString
public class BpjsReferralSpecialistEntityAudit extends AbstractEntityAudit<BpjsReferralSpecialistEntity> {
	...
	public BpjsReferralSpecialistEntityAudit(
			...
			BpjsReferralSpecialistEntity entity,
