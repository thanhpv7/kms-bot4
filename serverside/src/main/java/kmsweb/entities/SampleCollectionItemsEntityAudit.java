...
@ToString
public class SampleCollectionItemsEntityAudit extends AbstractEntityAudit<SampleCollectionItemsEntity> {
	...
	public SampleCollectionItemsEntityAudit(
			...
			SampleCollectionItemsEntity entity,
