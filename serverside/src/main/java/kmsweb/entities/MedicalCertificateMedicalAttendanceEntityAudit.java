...
@ToString
public class MedicalCertificateMedicalAttendanceEntityAudit extends AbstractEntityAudit<MedicalCertificateMedicalAttendanceEntity> {
	...
	public MedicalCertificateMedicalAttendanceEntityAudit(
			...
			MedicalCertificateMedicalAttendanceEntity entity,
