...
@ToString
public class BpjsPcareRiwayatKunjunganEntityAudit extends AbstractEntityAudit<BpjsPcareRiwayatKunjunganEntity> {
	...
	public BpjsPcareRiwayatKunjunganEntityAudit(
			...
			BpjsPcareRiwayatKunjunganEntity entity,
