...
@ToString
public class ServiceItemAssignmentEntityAudit extends AbstractEntityAudit<ServiceItemAssignmentEntity> {
	...
	public ServiceItemAssignmentEntityAudit(
			...
			ServiceItemAssignmentEntity entity,
