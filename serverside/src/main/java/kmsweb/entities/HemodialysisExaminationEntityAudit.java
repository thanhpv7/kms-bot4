...
@ToString
public class HemodialysisExaminationEntityAudit extends AbstractEntityAudit<HemodialysisExaminationEntity> {
	...
	public HemodialysisExaminationEntityAudit(
			...
			HemodialysisExaminationEntity entity,
