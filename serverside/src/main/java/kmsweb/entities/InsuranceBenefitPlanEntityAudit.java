...
@ToString
public class InsuranceBenefitPlanEntityAudit extends AbstractEntityAudit<InsuranceBenefitPlanEntity> {
	...
	public InsuranceBenefitPlanEntityAudit(
			...
			InsuranceBenefitPlanEntity entity,
