...
@ToString
public class BatchStockTransactionDetailEntityAudit extends AbstractEntityAudit<BatchStockTransactionDetailEntity> {
	...
	public BatchStockTransactionDetailEntityAudit(
			...
			BatchStockTransactionDetailEntity entity,
