...
@ToString
public class PatientPersonalInfoEntityAudit extends AbstractEntityAudit<PatientPersonalInfoEntity> {
	...
	public PatientPersonalInfoEntityAudit(
			...
			PatientPersonalInfoEntity entity,
