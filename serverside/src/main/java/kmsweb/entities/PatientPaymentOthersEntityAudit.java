...
@ToString
public class PatientPaymentOthersEntityAudit extends AbstractEntityAudit<PatientPaymentOthersEntity> {
	...
	public PatientPaymentOthersEntityAudit(
			...
			PatientPaymentOthersEntity entity,
