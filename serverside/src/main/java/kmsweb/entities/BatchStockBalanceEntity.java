...
import kmsweb.entities.listeners.BatchStockBalanceEntityListener;
import kmsweb.serializers.BatchStockBalanceSerializer;
...
@EntityListeners({BatchStockBalanceEntityListener.class, AuditingEntityListener.class})
@JsonSerialize(using = BatchStockBalanceSerializer.class)
@Table(
	uniqueConstraints = {
	}
)
public class BatchStockBalanceEntity extends AbstractEntity {

	/**
	 * Takes a BatchStockBalanceEntityDto and converts it into a BatchStockBalanceEntity.
	 * Primarily used when endpoints are invoked, as they take DTOs as input, which need to be converted to the entity type
	 *
	 * @param batchStockBalanceEntityDto
	 */
	public BatchStockBalanceEntity(BatchStockBalanceEntityDto batchStockBalanceEntityDto) {
		// Need to account for potential that any field is empty.  This will be run before any server validation and
		// endpoints will most likely not be subject to clientside validation

		if (batchStockBalanceEntityDto.getId() != null) {
			this.setId(batchStockBalanceEntityDto.getId());
		}

		if (batchStockBalanceEntityDto.getSourceNumber() != null) {
			this.setSourceNumber(batchStockBalanceEntityDto.getSourceNumber());
		}

		if (batchStockBalanceEntityDto.getBatchNo() != null) {
			this.setBatchNo(batchStockBalanceEntityDto.getBatchNo());
		}

		if (batchStockBalanceEntityDto.getExpirationDate() != null) {
			this.setExpirationDate(batchStockBalanceEntityDto.getExpirationDate());
		}

		if (batchStockBalanceEntityDto.getBatchQtyUoi() != null) {
			this.setBatchQtyUoi(batchStockBalanceEntityDto.getBatchQtyUoi());
		}

		if (batchStockBalanceEntityDto.getUoi() != null) {
			this.setUoi(batchStockBalanceEntityDto.getUoi());
		}

		if (batchStockBalanceEntityDto.getStockCatalogue() != null) {
			this.setStockCatalogue(batchStockBalanceEntityDto.getStockCatalogue());
		}

		if (batchStockBalanceEntityDto.getWarehouse() != null) {
			this.setWarehouse(batchStockBalanceEntityDto.getWarehouse());
		}
	...
	public void setStockCatalogue(@NotNull StockCatalogueEntity entity, boolean reverseAdd) {
		...
		if (this.stockCatalogue != null) {
			this.stockCatalogue.removeBatchStockBalancesCatalogue(this, false);
		}
		this.stockCatalogue = entity;
		if (reverseAdd) {
			this.stockCatalogue.addBatchStockBalancesCatalogue(this, false);
		}
	...
	public void setWarehouse(@NotNull WarehouseEntity entity, boolean reverseAdd) {
		...
		if (this.warehouse != null) {
			this.warehouse.removeBatchStockBalancesWarehouse(this, false);
		}
		this.warehouse = entity;
		if (reverseAdd) {
			this.warehouse.addBatchStockBalancesWarehouse(this, false);
		}
	...
	public static String getExampleCsvHeader() {
		...
		return "SOURCE_NUMBER,BATCH_NO,EXPIRATION_DATE,BATCH_QTY_UOI,UOI,STOCK_CATALOGUE_ID,WAREHOUSE_ID,ID";
	...
	@Override
	public boolean equals(Object batchStockBalance) {
		if (this == batchStockBalance) {
			return true;
		}
		if (batchStockBalance == null || this.getClass() != batchStockBalance.getClass()) {
			return false;
		}
		if (!super.equals(batchStockBalance)) {
			return false;
		}

		// Compare references by ids only
		this.addRelationEntitiesToIdSet();
		BatchStockBalanceEntity that = (BatchStockBalanceEntity) batchStockBalance;
		return
