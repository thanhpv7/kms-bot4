...
@ToString
public class PatientVisitPatientPaymentOthersEntityAudit extends AbstractEntityAudit<PatientVisitPatientPaymentOthersEntity> {
	...
	public PatientVisitPatientPaymentOthersEntityAudit(
			...
			PatientVisitPatientPaymentOthersEntity entity,
