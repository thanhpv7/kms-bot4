...
@ToString
public class BpjsControlSpecialistEntityAudit extends AbstractEntityAudit<BpjsControlSpecialistEntity> {
	...
	public BpjsControlSpecialistEntityAudit(
			...
			BpjsControlSpecialistEntity entity,
