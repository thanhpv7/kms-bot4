...
@ToString
public class PcareReferensiSaranaEntityAudit extends AbstractEntityAudit<PcareReferensiSaranaEntity> {
	...
	public PcareReferensiSaranaEntityAudit(
			...
			PcareReferensiSaranaEntity entity,
