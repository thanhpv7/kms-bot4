...
@ToString
public class SatuSehatConfigurationEntityAudit extends AbstractEntityAudit<SatuSehatConfigurationEntity> {
	...
	public SatuSehatConfigurationEntityAudit(
			...
			SatuSehatConfigurationEntity entity,
