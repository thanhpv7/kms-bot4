...
@ToString
public class TransferOrderStockDetailEntityAudit extends AbstractEntityAudit<TransferOrderStockDetailEntity> {
	...
	public TransferOrderStockDetailEntityAudit(
			...
			TransferOrderStockDetailEntity entity,
