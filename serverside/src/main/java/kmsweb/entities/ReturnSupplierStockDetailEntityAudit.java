...
@ToString
public class ReturnSupplierStockDetailEntityAudit extends AbstractEntityAudit<ReturnSupplierStockDetailEntity> {
	...
	public ReturnSupplierStockDetailEntityAudit(
			...
			ReturnSupplierStockDetailEntity entity,
