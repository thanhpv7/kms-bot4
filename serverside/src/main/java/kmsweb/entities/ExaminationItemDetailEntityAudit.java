...
@ToString
public class ExaminationItemDetailEntityAudit extends AbstractEntityAudit<ExaminationItemDetailEntity> {
	...
	public ExaminationItemDetailEntityAudit(
			...
			ExaminationItemDetailEntity entity,
