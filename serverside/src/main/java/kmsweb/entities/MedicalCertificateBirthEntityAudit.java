...
@ToString
public class MedicalCertificateBirthEntityAudit extends AbstractEntityAudit<MedicalCertificateBirthEntity> {
	...
	public MedicalCertificateBirthEntityAudit(
			...
			MedicalCertificateBirthEntity entity,
