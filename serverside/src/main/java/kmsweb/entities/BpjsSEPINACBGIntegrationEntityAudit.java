...
@ToString
public class BpjsSEPINACBGIntegrationEntityAudit extends AbstractEntityAudit<BpjsSEPINACBGIntegrationEntity> {
	...
	public BpjsSEPINACBGIntegrationEntityAudit(
			...
			BpjsSEPINACBGIntegrationEntity entity,
