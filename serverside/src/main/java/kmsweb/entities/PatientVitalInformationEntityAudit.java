...
@ToString
public class PatientVitalInformationEntityAudit extends AbstractEntityAudit<PatientVitalInformationEntity> {
	...
	public PatientVitalInformationEntityAudit(
			...
			PatientVitalInformationEntity entity,
