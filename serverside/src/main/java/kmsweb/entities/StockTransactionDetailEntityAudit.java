...
@ToString
public class StockTransactionDetailEntityAudit extends AbstractEntityAudit<StockTransactionDetailEntity> {
	...
	public StockTransactionDetailEntityAudit(
			...
			StockTransactionDetailEntity entity,
