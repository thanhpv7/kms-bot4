...
@ToString
public class BpjsSEPSubmissionEntityAudit extends AbstractEntityAudit<BpjsSEPSubmissionEntity> {
	...
	public BpjsSEPSubmissionEntityAudit(
			...
			BpjsSEPSubmissionEntity entity,
