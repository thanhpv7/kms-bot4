...
@ToString
public class PostOperativeDetailsEntityAudit extends AbstractEntityAudit<PostOperativeDetailsEntity> {
	...
	public PostOperativeDetailsEntityAudit(
			...
			PostOperativeDetailsEntity entity,
