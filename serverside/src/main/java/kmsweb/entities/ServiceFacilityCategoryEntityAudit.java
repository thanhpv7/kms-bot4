...
@ToString
public class ServiceFacilityCategoryEntityAudit extends AbstractEntityAudit<ServiceFacilityCategoryEntity> {
	...
	public ServiceFacilityCategoryEntityAudit(
			...
			ServiceFacilityCategoryEntity entity,
