...
@ToString
public class PcareNonCompoundDrugEntityAudit extends AbstractEntityAudit<PcareNonCompoundDrugEntity> {
	...
	public PcareNonCompoundDrugEntityAudit(
			...
			PcareNonCompoundDrugEntity entity,
