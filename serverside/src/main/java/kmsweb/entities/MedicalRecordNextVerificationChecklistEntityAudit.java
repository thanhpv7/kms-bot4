...
@ToString
public class MedicalRecordNextVerificationChecklistEntityAudit extends AbstractEntityAudit<MedicalRecordNextVerificationChecklistEntity> {
	...
	public MedicalRecordNextVerificationChecklistEntityAudit(
			...
			MedicalRecordNextVerificationChecklistEntity entity,
