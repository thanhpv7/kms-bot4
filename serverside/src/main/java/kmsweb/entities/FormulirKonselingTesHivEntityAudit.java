...
@ToString
public class FormulirKonselingTesHivEntityAudit extends AbstractEntityAudit<FormulirKonselingTesHivEntity> {
	...
	public FormulirKonselingTesHivEntityAudit(
			...
			FormulirKonselingTesHivEntity entity,
