...
@ToString
public class BpjsDismissalConditionEntityAudit extends AbstractEntityAudit<BpjsDismissalConditionEntity> {
	...
	public BpjsDismissalConditionEntityAudit(
			...
			BpjsDismissalConditionEntity entity,
