...
import kmsweb.entities.listeners.MedicalCertificateMentalHealthEntityListener;
import kmsweb.serializers.MedicalCertificateMentalHealthSerializer;
...
@EntityListeners({MedicalCertificateMentalHealthEntityListener.class, AuditingEntityListener.class})
@JsonSerialize(using = MedicalCertificateMentalHealthSerializer.class)
@Table(
	uniqueConstraints = {
	}
)
public class MedicalCertificateMentalHealthEntity extends AbstractEntity {
	...
	/**
	 * Takes a MedicalCertificateMentalHealthEntityDto and converts it into a MedicalCertificateMentalHealthEntity.
	 * Primarily used when endpoints are invoked, as they take DTOs as input, which need to be converted to the entity type
	 *
	 * @param medicalCertificateMentalHealthEntityDto
	 */
	public MedicalCertificateMentalHealthEntity(MedicalCertificateMentalHealthEntityDto medicalCertificateMentalHealthEntityDto) {
		// Need to account for potential that any field is empty.  This will be run before any server validation and
		// endpoints will most likely not be subject to clientside validation

		if (medicalCertificateMentalHealthEntityDto.getId() != null) {
			this.setId(medicalCertificateMentalHealthEntityDto.getId());
		}

		if (medicalCertificateMentalHealthEntityDto.getExaminationDateTime() != null) {
			this.setExaminationDateTime(medicalCertificateMentalHealthEntityDto.getExaminationDateTime());
		}

		if (medicalCertificateMentalHealthEntityDto.getExaminationResult() != null) {
			this.setExaminationResult(medicalCertificateMentalHealthEntityDto.getExaminationResult());
		}

		if (medicalCertificateMentalHealthEntityDto.getNotes() != null) {
			this.setNotes(medicalCertificateMentalHealthEntityDto.getNotes());
		}

		if (medicalCertificateMentalHealthEntityDto.getPurpose() != null) {
			this.setPurpose(medicalCertificateMentalHealthEntityDto.getPurpose());
		}

		if (medicalCertificateMentalHealthEntityDto.getRegistration() != null) {
			this.setRegistration(medicalCertificateMentalHealthEntityDto.getRegistration());
		}

		if (medicalCertificateMentalHealthEntityDto.getMedicalStaff() != null) {
			this.setMedicalStaff(medicalCertificateMentalHealthEntityDto.getMedicalStaff());
		}
	...
	@Override
	public boolean equals(Object medicalCertificateMentalHealth) {
		if (this == medicalCertificateMentalHealth) {
			return true;
		}
		if (medicalCertificateMentalHealth == null || this.getClass() != medicalCertificateMentalHealth.getClass()) {
			return false;
		}
		if (!super.equals(medicalCertificateMentalHealth)) {
			return false;
		}

		// Compare references by ids only
		this.addRelationEntitiesToIdSet();
		MedicalCertificateMentalHealthEntity that = (MedicalCertificateMentalHealthEntity) medicalCertificateMentalHealth;
		return
			Objects.equals(
