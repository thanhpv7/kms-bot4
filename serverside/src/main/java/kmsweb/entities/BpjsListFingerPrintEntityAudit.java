...
@ToString
public class BpjsListFingerPrintEntityAudit extends AbstractEntityAudit<BpjsListFingerPrintEntity> {
	...
	public BpjsListFingerPrintEntityAudit(
			...
			BpjsListFingerPrintEntity entity,
