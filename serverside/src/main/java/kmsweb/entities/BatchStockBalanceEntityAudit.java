...
@ToString
public class BatchStockBalanceEntityAudit extends AbstractEntityAudit<BatchStockBalanceEntity> {
	...
	public BatchStockBalanceEntityAudit(
			...
			BatchStockBalanceEntity entity,
