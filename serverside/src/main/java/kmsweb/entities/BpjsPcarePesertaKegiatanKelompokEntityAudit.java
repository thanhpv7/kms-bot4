...
@ToString
public class BpjsPcarePesertaKegiatanKelompokEntityAudit extends AbstractEntityAudit<BpjsPcarePesertaKegiatanKelompokEntity> {
	...
	public BpjsPcarePesertaKegiatanKelompokEntityAudit(
			...
			BpjsPcarePesertaKegiatanKelompokEntity entity,
