...
@ToString
public class PatientSupportingDocumentEntityAudit extends AbstractEntityAudit<PatientSupportingDocumentEntity> {
	...
	public PatientSupportingDocumentEntityAudit(
			...
			PatientSupportingDocumentEntity entity,
