...
@ToString
public class PatientDetailAddressEntityAudit extends AbstractEntityAudit<PatientDetailAddressEntity> {
	...
	public PatientDetailAddressEntityAudit(
			...
			PatientDetailAddressEntity entity,
