...
@ToString
public class PreoperativeRecordsEntityAudit extends AbstractEntityAudit<PreoperativeRecordsEntity> {
	...
	public PreoperativeRecordsEntityAudit(
			...
			PreoperativeRecordsEntity entity,
