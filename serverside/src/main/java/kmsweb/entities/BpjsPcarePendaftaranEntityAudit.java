...
@ToString
public class BpjsPcarePendaftaranEntityAudit extends AbstractEntityAudit<BpjsPcarePendaftaranEntity> {
	...
	public BpjsPcarePendaftaranEntityAudit(
			...
			BpjsPcarePendaftaranEntity entity,
