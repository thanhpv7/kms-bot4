...
@ToString
public class TariffPackageItemEntityAudit extends AbstractEntityAudit<TariffPackageItemEntity> {
	...
	public TariffPackageItemEntityAudit(
			...
			TariffPackageItemEntity entity,
