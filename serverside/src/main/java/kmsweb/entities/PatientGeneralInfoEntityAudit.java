...
@ToString
public class PatientGeneralInfoEntityAudit extends AbstractEntityAudit<PatientGeneralInfoEntity> {
	...
	public PatientGeneralInfoEntityAudit(
			...
			PatientGeneralInfoEntity entity,
