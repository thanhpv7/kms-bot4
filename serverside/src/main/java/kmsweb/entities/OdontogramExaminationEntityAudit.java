...
@ToString
public class OdontogramExaminationEntityAudit extends AbstractEntityAudit<OdontogramExaminationEntity> {
	...
	public OdontogramExaminationEntityAudit(
			...
			OdontogramExaminationEntity entity,
