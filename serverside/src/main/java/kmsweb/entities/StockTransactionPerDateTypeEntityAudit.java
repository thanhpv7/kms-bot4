...
@ToString
public class StockTransactionPerDateTypeEntityAudit extends AbstractEntityAudit<StockTransactionPerDateTypeEntity> {
	...
	public StockTransactionPerDateTypeEntityAudit(
			...
			StockTransactionPerDateTypeEntity entity,
