...
@ToString
public class TransactionDetailTypeEntityAudit extends AbstractEntityAudit<TransactionDetailTypeEntity> {
	...
	public TransactionDetailTypeEntityAudit(
			...
			TransactionDetailTypeEntity entity,
