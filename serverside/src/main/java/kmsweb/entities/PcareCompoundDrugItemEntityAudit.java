...
@ToString
public class PcareCompoundDrugItemEntityAudit extends AbstractEntityAudit<PcareCompoundDrugItemEntity> {
	...
	public PcareCompoundDrugItemEntityAudit(
			...
			PcareCompoundDrugItemEntity entity,
