...
@ToString
public class InventoryBatchCorrectionItemEntityAudit extends AbstractEntityAudit<InventoryBatchCorrectionItemEntity> {
	...
	public InventoryBatchCorrectionItemEntityAudit(
			...
			InventoryBatchCorrectionItemEntity entity,
