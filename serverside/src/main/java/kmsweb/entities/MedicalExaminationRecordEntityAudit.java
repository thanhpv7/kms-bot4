...
@ToString
public class MedicalExaminationRecordEntityAudit extends AbstractEntityAudit<MedicalExaminationRecordEntity> {
	...
	public MedicalExaminationRecordEntityAudit(
			...
			MedicalExaminationRecordEntity entity,
