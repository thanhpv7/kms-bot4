...
@ToString
public class BpjsSearchControlLetterEntityAudit extends AbstractEntityAudit<BpjsSearchControlLetterEntity> {
	...
	public BpjsSearchControlLetterEntityAudit(
			...
			BpjsSearchControlLetterEntity entity,
