...
import kmsweb.entities.listeners.AdministrationUserEntityListener;
import kmsweb.serializers.AdministrationUserSerializer;
...
@EntityListeners({AdministrationUserEntityListener.class, AuditingEntityListener.class})
@JsonSerialize(using = AdministrationUserSerializer.class)
@Table(
	uniqueConstraints = {
	}
)
public class AdministrationUserEntity extends UserEntity {

	/**
	 * Takes a AdministrationUserEntityDto and converts it into a AdministrationUserEntity.
	 * Primarily used when endpoints are invoked, as they take DTOs as input, which need to be converted to the entity type
	 *
	 * @param administrationUserEntityDto
	 */
	public AdministrationUserEntity(AdministrationUserEntityDto administrationUserEntityDto) {
		// Need to account for potential that any field is empty.  This will be run before any server validation and
		// endpoints will most likely not be subject to clientside validation

		if (administrationUserEntityDto.getId() != null) {
			this.setId(administrationUserEntityDto.getId());
		}

		if (administrationUserEntityDto.getStaff() != null) {
			this.setStaff(administrationUserEntityDto.getStaff());
		}
	...
	@OneToOne(mappedBy = "administrationUser", cascade = {CascadeType.MERGE}, fetch = FetchType.LAZY)
	@CsvIgnore
	 ...
	 *
	 * @param entity the AdministrationUserEntity to be set or updated
	...
	public void setStaff(@NotNull StaffEntity entity, boolean reverseAdd) {
		...
		if (this.staff != null) {
			this.staff.unsetAdministrationUser();
		}

		this.staff = entity;

		if (reverseAdd) {
			this.staff.setAdministrationUser(this, false);
		}
	...
	public void unsetStaff(boolean reverse) {
		if (reverse && this.staff != null) {
			this.staff.unsetAdministrationUser(false);
		}
		this.staff = null;
	}
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	@Override
	public boolean equals(Object administrationUser) {
		if (this == administrationUser) {
			return true;
		}
		if (administrationUser == null || this.getClass() != administrationUser.getClass()) {
			return false;
		}
		if (!super.equals(administrationUser)) {
			return false;
		}

		// Compare references by ids only
		this.addRelationEntitiesToIdSet();
		AdministrationUserEntity that = (AdministrationUserEntity) administrationUser;
		return
