...
import kmsweb.entities.listeners.NurseUserEntityListener;
import kmsweb.serializers.NurseUserSerializer;
...
@EntityListeners({NurseUserEntityListener.class, AuditingEntityListener.class})
@JsonSerialize(using = NurseUserSerializer.class)
@Table(
	uniqueConstraints = {
	}
)
public class NurseUserEntity extends UserEntity {

	/**
	 * Takes a NurseUserEntityDto and converts it into a NurseUserEntity.
	 * Primarily used when endpoints are invoked, as they take DTOs as input, which need to be converted to the entity type
	 *
	 * @param nurseUserEntityDto
	 */
	public NurseUserEntity(NurseUserEntityDto nurseUserEntityDto) {
		// Need to account for potential that any field is empty.  This will be run before any server validation and
		// endpoints will most likely not be subject to clientside validation

		if (nurseUserEntityDto.getId() != null) {
			this.setId(nurseUserEntityDto.getId());
		}

		if (nurseUserEntityDto.getStaff() != null) {
			this.setStaff(nurseUserEntityDto.getStaff());
		}
	...
	@OneToOne(mappedBy = "nurseUser", cascade = {CascadeType.MERGE}, fetch = FetchType.LAZY)
	@CsvIgnore
	 ...
	 *
	 * @param entity the NurseUserEntity to be set or updated
	...
	public void setStaff(@NotNull StaffEntity entity, boolean reverseAdd) {
		...
		if (this.staff != null) {
			this.staff.unsetNurseUser();
		}

		this.staff = entity;

		if (reverseAdd) {
			this.staff.setNurseUser(this, false);
		}
	...
	public void unsetStaff(boolean reverse) {
		if (reverse && this.staff != null) {
			this.staff.unsetNurseUser(false);
		}
		this.staff = null;
	}
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	@Override
	public boolean equals(Object nurseUser) {
		if (this == nurseUser) {
			return true;
		}
		if (nurseUser == null || this.getClass() != nurseUser.getClass()) {
			return false;
		}
		if (!super.equals(nurseUser)) {
			return false;
		}

		// Compare references by ids only
		this.addRelationEntitiesToIdSet();
		NurseUserEntity that = (NurseUserEntity) nurseUser;
		return
