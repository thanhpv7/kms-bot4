...
@ToString
public class HospitalBranchInformationEntityAudit extends AbstractEntityAudit<HospitalBranchInformationEntity> {
	...
	public HospitalBranchInformationEntityAudit(
			...
			HospitalBranchInformationEntity entity,
