...
@ToString
public class SupplierProductDetailEntityAudit extends AbstractEntityAudit<SupplierProductDetailEntity> {
	...
	public SupplierProductDetailEntityAudit(
			...
			SupplierProductDetailEntity entity,
