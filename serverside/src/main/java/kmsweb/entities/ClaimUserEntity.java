...
import kmsweb.entities.listeners.ClaimUserEntityListener;
import kmsweb.serializers.ClaimUserSerializer;
...
@EntityListeners({ClaimUserEntityListener.class, AuditingEntityListener.class})
@JsonSerialize(using = ClaimUserSerializer.class)
@Table(
	uniqueConstraints = {
	}
)
public class ClaimUserEntity extends UserEntity {

	/**
	 * Takes a ClaimUserEntityDto and converts it into a ClaimUserEntity.
	 * Primarily used when endpoints are invoked, as they take DTOs as input, which need to be converted to the entity type
	 *
	 * @param claimUserEntityDto
	 */
	public ClaimUserEntity(ClaimUserEntityDto claimUserEntityDto) {
		// Need to account for potential that any field is empty.  This will be run before any server validation and
		// endpoints will most likely not be subject to clientside validation

		if (claimUserEntityDto.getId() != null) {
			this.setId(claimUserEntityDto.getId());
		}

		if (claimUserEntityDto.getStaff() != null) {
			this.setStaff(claimUserEntityDto.getStaff());
		}
	...
	@OneToOne(mappedBy = "claimUser", cascade = {CascadeType.MERGE}, fetch = FetchType.LAZY)
	@CsvIgnore
	 ...
	 *
	 * @param entity the ClaimUserEntity to be set or updated
	...
	public void setStaff(@NotNull StaffEntity entity, boolean reverseAdd) {
		...
		if (this.staff != null) {
			this.staff.unsetClaimUser();
		}

		this.staff = entity;

		if (reverseAdd) {
			this.staff.setClaimUser(this, false);
		}
	...
	public void unsetStaff(boolean reverse) {
		if (reverse && this.staff != null) {
			this.staff.unsetClaimUser(false);
		}
		this.staff = null;
	}
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	@Override
	public boolean equals(Object claimUser) {
		if (this == claimUser) {
			return true;
		}
		if (claimUser == null || this.getClass() != claimUser.getClass()) {
			return false;
		}
		if (!super.equals(claimUser)) {
			return false;
		}

		// Compare references by ids only
		this.addRelationEntitiesToIdSet();
		ClaimUserEntity that = (ClaimUserEntity) claimUser;
		return
