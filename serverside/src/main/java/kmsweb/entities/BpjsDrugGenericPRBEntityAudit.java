...
@ToString
public class BpjsDrugGenericPRBEntityAudit extends AbstractEntityAudit<BpjsDrugGenericPRBEntity> {
	...
	public BpjsDrugGenericPRBEntityAudit(
			...
			BpjsDrugGenericPRBEntity entity,
