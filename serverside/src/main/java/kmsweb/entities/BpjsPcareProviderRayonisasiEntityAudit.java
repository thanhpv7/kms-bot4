...
@ToString
public class BpjsPcareProviderRayonisasiEntityAudit extends AbstractEntityAudit<BpjsPcareProviderRayonisasiEntity> {
	...
	public BpjsPcareProviderRayonisasiEntityAudit(
			...
			BpjsPcareProviderRayonisasiEntity entity,
