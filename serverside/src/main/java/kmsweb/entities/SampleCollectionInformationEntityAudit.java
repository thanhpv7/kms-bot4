...
@ToString
public class SampleCollectionInformationEntityAudit extends AbstractEntityAudit<SampleCollectionInformationEntity> {
	...
	public SampleCollectionInformationEntityAudit(
			...
			SampleCollectionInformationEntity entity,
