...
@ToString
public class BpjsHealthFacilityEntityAudit extends AbstractEntityAudit<BpjsHealthFacilityEntity> {
	...
	public BpjsHealthFacilityEntityAudit(
			...
			BpjsHealthFacilityEntity entity,
