...
@ToString
public class BpjsPatientReferralEntityAudit extends AbstractEntityAudit<BpjsPatientReferralEntity> {
	...
	public BpjsPatientReferralEntityAudit(
			...
			BpjsPatientReferralEntity entity,
