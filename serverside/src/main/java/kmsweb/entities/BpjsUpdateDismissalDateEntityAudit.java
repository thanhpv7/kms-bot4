...
@ToString
public class BpjsUpdateDismissalDateEntityAudit extends AbstractEntityAudit<BpjsUpdateDismissalDateEntity> {
	...
	public BpjsUpdateDismissalDateEntityAudit(
			...
			BpjsUpdateDismissalDateEntity entity,
