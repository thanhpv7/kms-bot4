...
@ToString
public class MedicalRecordInitialChecklistEntityAudit extends AbstractEntityAudit<MedicalRecordInitialChecklistEntity> {
	...
	public MedicalRecordInitialChecklistEntityAudit(
			...
			MedicalRecordInitialChecklistEntity entity,
