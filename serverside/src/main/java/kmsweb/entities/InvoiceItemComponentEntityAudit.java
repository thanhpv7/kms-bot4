...
@ToString
public class InvoiceItemComponentEntityAudit extends AbstractEntityAudit<InvoiceItemComponentEntity> {
	...
	public InvoiceItemComponentEntityAudit(
			...
			InvoiceItemComponentEntity entity,
