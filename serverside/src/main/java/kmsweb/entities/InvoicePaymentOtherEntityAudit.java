...
@ToString
public class InvoicePaymentOtherEntityAudit extends AbstractEntityAudit<InvoicePaymentOtherEntity> {
	...
	public InvoicePaymentOtherEntityAudit(
			...
			InvoicePaymentOtherEntity entity,
