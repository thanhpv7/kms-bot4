...
@ToString
public class PatientVisitPatientPaymentInsuranceEntityAudit extends AbstractEntityAudit<PatientVisitPatientPaymentInsuranceEntity> {
	...
	public PatientVisitPatientPaymentInsuranceEntityAudit(
			...
			PatientVisitPatientPaymentInsuranceEntity entity,
