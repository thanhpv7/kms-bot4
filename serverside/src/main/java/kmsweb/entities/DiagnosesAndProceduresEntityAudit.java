...
@ToString
public class DiagnosesAndProceduresEntityAudit extends AbstractEntityAudit<DiagnosesAndProceduresEntity> {
	...
	public DiagnosesAndProceduresEntityAudit(
			...
			DiagnosesAndProceduresEntity entity,
