...
@ToString
public class OperatingTheaterMedicalExaminationRecordEntityAudit extends AbstractEntityAudit<OperatingTheaterMedicalExaminationRecordEntity> {
	...
	public OperatingTheaterMedicalExaminationRecordEntityAudit(
			...
			OperatingTheaterMedicalExaminationRecordEntity entity,
