...
import kmsweb.entities.listeners.DoctorUserEntityListener;
import kmsweb.serializers.DoctorUserSerializer;
...
@EntityListeners({DoctorUserEntityListener.class, AuditingEntityListener.class})
@JsonSerialize(using = DoctorUserSerializer.class)
@Table(
	uniqueConstraints = {
	}
)
public class DoctorUserEntity extends UserEntity {
	...
	/**
	 * Takes a DoctorUserEntityDto and converts it into a DoctorUserEntity.
	 * Primarily used when endpoints are invoked, as they take DTOs as input, which need to be converted to the entity type
	 *
	 * @param doctorUserEntityDto
	 */
	public DoctorUserEntity(DoctorUserEntityDto doctorUserEntityDto) {
		// Need to account for potential that any field is empty.  This will be run before any server validation and
		// endpoints will most likely not be subject to clientside validation

		if (doctorUserEntityDto.getId() != null) {
			this.setId(doctorUserEntityDto.getId());
		}

		if (doctorUserEntityDto.getStaff() != null) {
			this.setStaff(doctorUserEntityDto.getStaff());
		}
	...
	@OneToOne(mappedBy = "doctorUser", cascade = {CascadeType.MERGE}, fetch = FetchType.LAZY)
	@CsvIgnore
	 ...
	 *
	 * @param entity the DoctorUserEntity to be set or updated
	...
	public void setStaff(@NotNull StaffEntity entity, boolean reverseAdd) {
		...
		if (this.staff != null) {
			this.staff.unsetDoctorUser();
		}

		this.staff = entity;

		if (reverseAdd) {
			this.staff.setDoctorUser(this, false);
		}
	...
	public void unsetStaff(boolean reverse) {
		if (reverse && this.staff != null) {
			this.staff.unsetDoctorUser(false);
		}
		this.staff = null;
	}
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	@Override
	public boolean equals(Object doctorUser) {
		if (this == doctorUser) {
			return true;
		}
		if (doctorUser == null || this.getClass() != doctorUser.getClass()) {
			return false;
		}
		if (!super.equals(doctorUser)) {
			return false;
		}

		// Compare references by ids only
		this.addRelationEntitiesToIdSet();
		DoctorUserEntity that = (DoctorUserEntity) doctorUser;
		return
