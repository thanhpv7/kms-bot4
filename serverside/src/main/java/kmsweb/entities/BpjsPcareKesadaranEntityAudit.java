...
@ToString
public class BpjsPcareKesadaranEntityAudit extends AbstractEntityAudit<BpjsPcareKesadaranEntity> {
	...
	public BpjsPcareKesadaranEntityAudit(
			...
			BpjsPcareKesadaranEntity entity,
