...
@ToString
public class InternalOrderStockDetailEntityAudit extends AbstractEntityAudit<InternalOrderStockDetailEntity> {
	...
	public InternalOrderStockDetailEntityAudit(
			...
			InternalOrderStockDetailEntity entity,
