...
@ToString
public class PatientContactInfoEntityAudit extends AbstractEntityAudit<PatientContactInfoEntity> {
	...
	public PatientContactInfoEntityAudit(
			...
			PatientContactInfoEntity entity,
