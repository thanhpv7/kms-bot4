...
@ToString
public class BpjsDoctorMappingEntityAudit extends AbstractEntityAudit<BpjsDoctorMappingEntity> {
	...
	public BpjsDoctorMappingEntityAudit(
			...
			BpjsDoctorMappingEntity entity,
