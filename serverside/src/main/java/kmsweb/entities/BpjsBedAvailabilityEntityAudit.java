...
@ToString
public class BpjsBedAvailabilityEntityAudit extends AbstractEntityAudit<BpjsBedAvailabilityEntity> {
	...
	public BpjsBedAvailabilityEntityAudit(
			...
			BpjsBedAvailabilityEntity entity,
