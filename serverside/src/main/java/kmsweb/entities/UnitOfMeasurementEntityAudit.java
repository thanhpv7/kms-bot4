...
@ToString
public class UnitOfMeasurementEntityAudit extends AbstractEntityAudit<UnitOfMeasurementEntity> {
	...
	public UnitOfMeasurementEntityAudit(
			...
			UnitOfMeasurementEntity entity,
