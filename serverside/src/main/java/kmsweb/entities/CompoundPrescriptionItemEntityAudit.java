...
@ToString
public class CompoundPrescriptionItemEntityAudit extends AbstractEntityAudit<CompoundPrescriptionItemEntity> {
	...
	public CompoundPrescriptionItemEntityAudit(
			...
			CompoundPrescriptionItemEntity entity,
