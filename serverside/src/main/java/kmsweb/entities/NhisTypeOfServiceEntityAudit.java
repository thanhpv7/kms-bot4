...
@ToString
public class NhisTypeOfServiceEntityAudit extends AbstractEntityAudit<NhisTypeOfServiceEntity> {
	...
	public NhisTypeOfServiceEntityAudit(
			...
			NhisTypeOfServiceEntity entity,
