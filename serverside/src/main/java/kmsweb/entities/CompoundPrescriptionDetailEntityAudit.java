...
@ToString
public class CompoundPrescriptionDetailEntityAudit extends AbstractEntityAudit<CompoundPrescriptionDetailEntity> {
	...
	public CompoundPrescriptionDetailEntityAudit(
			...
			CompoundPrescriptionDetailEntity entity,
