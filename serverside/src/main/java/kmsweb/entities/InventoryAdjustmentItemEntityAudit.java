...
@ToString
public class InventoryAdjustmentItemEntityAudit extends AbstractEntityAudit<InventoryAdjustmentItemEntity> {
	...
	public InventoryAdjustmentItemEntityAudit(
			...
			InventoryAdjustmentItemEntity entity,
