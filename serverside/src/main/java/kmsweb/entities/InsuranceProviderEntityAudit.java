...
@ToString
public class InsuranceProviderEntityAudit extends AbstractEntityAudit<InsuranceProviderEntity> {
	...
	public InsuranceProviderEntityAudit(
			...
			InsuranceProviderEntity entity,
