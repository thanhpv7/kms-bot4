...
import kmsweb.entities.listeners.PurchasingUserEntityListener;
import kmsweb.serializers.PurchasingUserSerializer;
...
@EntityListeners({PurchasingUserEntityListener.class, AuditingEntityListener.class})
@JsonSerialize(using = PurchasingUserSerializer.class)
@Table(
	uniqueConstraints = {
	}
)
public class PurchasingUserEntity extends UserEntity {

	/**
	 * Takes a PurchasingUserEntityDto and converts it into a PurchasingUserEntity.
	 * Primarily used when endpoints are invoked, as they take DTOs as input, which need to be converted to the entity type
	 *
	 * @param purchasingUserEntityDto
	 */
	public PurchasingUserEntity(PurchasingUserEntityDto purchasingUserEntityDto) {
		// Need to account for potential that any field is empty.  This will be run before any server validation and
		// endpoints will most likely not be subject to clientside validation

		if (purchasingUserEntityDto.getId() != null) {
			this.setId(purchasingUserEntityDto.getId());
		}

		if (purchasingUserEntityDto.getStaff() != null) {
			this.setStaff(purchasingUserEntityDto.getStaff());
		}
	...
	@OneToOne(mappedBy = "purchasingUser", cascade = {CascadeType.MERGE}, fetch = FetchType.LAZY)
	@CsvIgnore
	 ...
	 *
	 * @param entity the PurchasingUserEntity to be set or updated
	...
	public void setStaff(@NotNull StaffEntity entity, boolean reverseAdd) {
		...
		if (this.staff != null) {
			this.staff.unsetPurchasingUser();
		}

		this.staff = entity;

		if (reverseAdd) {
			this.staff.setPurchasingUser(this, false);
		}
	...
	public void unsetStaff(boolean reverse) {
		if (reverse && this.staff != null) {
			this.staff.unsetPurchasingUser(false);
		}
		this.staff = null;
	}
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	@Override
	public boolean equals(Object purchasingUser) {
		if (this == purchasingUser) {
			return true;
		}
		if (purchasingUser == null || this.getClass() != purchasingUser.getClass()) {
			return false;
		}
		if (!super.equals(purchasingUser)) {
			return false;
		}

		// Compare references by ids only
		this.addRelationEntitiesToIdSet();
		PurchasingUserEntity that = (PurchasingUserEntity) purchasingUser;
		return
