...
@ToString
public class NhisSpecialtyAttendedEntityAudit extends AbstractEntityAudit<NhisSpecialtyAttendedEntity> {
	...
	public NhisSpecialtyAttendedEntityAudit(
			...
			NhisSpecialtyAttendedEntity entity,
