...
@ToString
public class PcareActionExaminationEntityAudit extends AbstractEntityAudit<PcareActionExaminationEntity> {
	...
	public PcareActionExaminationEntityAudit(
			...
			PcareActionExaminationEntity entity,
