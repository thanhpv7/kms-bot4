...
@ToString
public class ObstetricAndGynecologyHistoryEntityAudit extends AbstractEntityAudit<ObstetricAndGynecologyHistoryEntity> {
	...
	public ObstetricAndGynecologyHistoryEntityAudit(
			...
			ObstetricAndGynecologyHistoryEntity entity,
