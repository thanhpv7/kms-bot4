...
@ToString
public class BpjsDismissalMappingEntityAudit extends AbstractEntityAudit<BpjsDismissalMappingEntity> {
	...
	public BpjsDismissalMappingEntityAudit(
			...
			BpjsDismissalMappingEntity entity,
