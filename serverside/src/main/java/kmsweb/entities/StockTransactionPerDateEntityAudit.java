...
@ToString
public class StockTransactionPerDateEntityAudit extends AbstractEntityAudit<StockTransactionPerDateEntity> {
	...
	public StockTransactionPerDateEntityAudit(
			...
			StockTransactionPerDateEntity entity,
