...
@ToString
public class MedicalFeeItemComponentEntityAudit extends AbstractEntityAudit<MedicalFeeItemComponentEntity> {
	...
	public MedicalFeeItemComponentEntityAudit(
			...
			MedicalFeeItemComponentEntity entity,
