...
@ToString
public class BpjsDoctorScheduleEntityAudit extends AbstractEntityAudit<BpjsDoctorScheduleEntity> {
	...
	public BpjsDoctorScheduleEntityAudit(
			...
			BpjsDoctorScheduleEntity entity,
