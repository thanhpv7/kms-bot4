...
@ToString
public class BpjsPcareKunjunganRujukanEntityAudit extends AbstractEntityAudit<BpjsPcareKunjunganRujukanEntity> {
	...
	public BpjsPcareKunjunganRujukanEntityAudit(
			...
			BpjsPcareKunjunganRujukanEntity entity,
