...
@ToString
public class CatalogueNonMedicalEntityAudit extends AbstractEntityAudit<CatalogueNonMedicalEntity> {
	...
	public CatalogueNonMedicalEntityAudit(
			...
			CatalogueNonMedicalEntity entity,
