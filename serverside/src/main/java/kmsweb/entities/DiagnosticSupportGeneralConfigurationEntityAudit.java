...
@ToString
public class DiagnosticSupportGeneralConfigurationEntityAudit extends AbstractEntityAudit<DiagnosticSupportGeneralConfigurationEntity> {
	...
	public DiagnosticSupportGeneralConfigurationEntityAudit(
			...
			DiagnosticSupportGeneralConfigurationEntity entity,
