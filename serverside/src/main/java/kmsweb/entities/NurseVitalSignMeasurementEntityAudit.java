...
@ToString
public class NurseVitalSignMeasurementEntityAudit extends AbstractEntityAudit<NurseVitalSignMeasurementEntity> {
	...
	public NurseVitalSignMeasurementEntityAudit(
			...
			NurseVitalSignMeasurementEntity entity,
