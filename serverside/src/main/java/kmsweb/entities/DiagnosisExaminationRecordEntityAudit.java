...
@ToString
public class DiagnosisExaminationRecordEntityAudit extends AbstractEntityAudit<DiagnosisExaminationRecordEntity> {
	...
	public DiagnosisExaminationRecordEntityAudit(
			...
			DiagnosisExaminationRecordEntity entity,
