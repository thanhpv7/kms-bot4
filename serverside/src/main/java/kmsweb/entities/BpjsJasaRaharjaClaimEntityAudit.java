...
@ToString
public class BpjsJasaRaharjaClaimEntityAudit extends AbstractEntityAudit<BpjsJasaRaharjaClaimEntity> {
	...
	public BpjsJasaRaharjaClaimEntityAudit(
			...
			BpjsJasaRaharjaClaimEntity entity,
