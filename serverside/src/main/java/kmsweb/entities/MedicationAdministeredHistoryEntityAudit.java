...
@ToString
public class MedicationAdministeredHistoryEntityAudit extends AbstractEntityAudit<MedicationAdministeredHistoryEntity> {
	...
	public MedicationAdministeredHistoryEntityAudit(
			...
			MedicationAdministeredHistoryEntity entity,
