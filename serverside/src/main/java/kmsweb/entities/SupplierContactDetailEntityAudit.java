...
@ToString
public class SupplierContactDetailEntityAudit extends AbstractEntityAudit<SupplierContactDetailEntity> {
	...
	public SupplierContactDetailEntityAudit(
			...
			SupplierContactDetailEntity entity,
