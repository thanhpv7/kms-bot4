...
@ToString
public class PatientPaymentBPJSEntityAudit extends AbstractEntityAudit<PatientPaymentBPJSEntity> {
	...
	public PatientPaymentBPJSEntityAudit(
			...
			PatientPaymentBPJSEntity entity,
