...
@ToString
public class BpjsTreatmentClassMappingEntityAudit extends AbstractEntityAudit<BpjsTreatmentClassMappingEntity> {
	...
	public BpjsTreatmentClassMappingEntityAudit(
			...
			BpjsTreatmentClassMappingEntity entity,
