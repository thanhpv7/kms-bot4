...
@ToString
public class BpjsTreatmentHistoryEntityAudit extends AbstractEntityAudit<BpjsTreatmentHistoryEntity> {
	...
	public BpjsTreatmentHistoryEntityAudit(
			...
			BpjsTreatmentHistoryEntity entity,
