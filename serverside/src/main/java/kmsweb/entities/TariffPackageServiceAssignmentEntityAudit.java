...
@ToString
public class TariffPackageServiceAssignmentEntityAudit extends AbstractEntityAudit<TariffPackageServiceAssignmentEntity> {
	...
	public TariffPackageServiceAssignmentEntityAudit(
			...
			TariffPackageServiceAssignmentEntity entity,
