...
@ToString
public class DiagnosticExaminationResultsEntityAudit extends AbstractEntityAudit<DiagnosticExaminationResultsEntity> {
	...
	public DiagnosticExaminationResultsEntityAudit(
			...
			DiagnosticExaminationResultsEntity entity,
