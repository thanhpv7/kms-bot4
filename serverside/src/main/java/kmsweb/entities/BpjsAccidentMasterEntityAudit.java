...
@ToString
public class BpjsAccidentMasterEntityAudit extends AbstractEntityAudit<BpjsAccidentMasterEntity> {
	...
	public BpjsAccidentMasterEntityAudit(
			...
			BpjsAccidentMasterEntity entity,
