...
@ToString
public class MedicalRecordUserEntityAudit extends AbstractEntityAudit<MedicalRecordUserEntity> {
	...
	public MedicalRecordUserEntityAudit(
			...
			MedicalRecordUserEntity entity,
