...
@ToString
public class EmergencyMedicalExaminationRecordEntityAudit extends AbstractEntityAudit<EmergencyMedicalExaminationRecordEntity> {
	...
	public EmergencyMedicalExaminationRecordEntityAudit(
			...
			EmergencyMedicalExaminationRecordEntity entity,
