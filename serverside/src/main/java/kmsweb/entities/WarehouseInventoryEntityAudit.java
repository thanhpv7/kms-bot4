...
@ToString
public class WarehouseInventoryEntityAudit extends AbstractEntityAudit<WarehouseInventoryEntity> {
	...
	public WarehouseInventoryEntityAudit(
			...
			WarehouseInventoryEntity entity,
