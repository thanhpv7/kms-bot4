...
import kmsweb.entities.listeners.ManagementUserEntityListener;
import kmsweb.serializers.ManagementUserSerializer;
...
@EntityListeners({ManagementUserEntityListener.class, AuditingEntityListener.class})
@JsonSerialize(using = ManagementUserSerializer.class)
@Table(
	uniqueConstraints = {
	}
)
public class ManagementUserEntity extends UserEntity {
	...
	/**
	 * Takes a ManagementUserEntityDto and converts it into a ManagementUserEntity.
	 * Primarily used when endpoints are invoked, as they take DTOs as input, which need to be converted to the entity type
	 *
	 * @param managementUserEntityDto
	 */
	public ManagementUserEntity(ManagementUserEntityDto managementUserEntityDto) {
		// Need to account for potential that any field is empty.  This will be run before any server validation and
		// endpoints will most likely not be subject to clientside validation

		if (managementUserEntityDto.getId() != null) {
			this.setId(managementUserEntityDto.getId());
		}

		if (managementUserEntityDto.getStaff() != null) {
			this.setStaff(managementUserEntityDto.getStaff());
		}
	...
	@OneToOne(mappedBy = "managementUser", cascade = {CascadeType.MERGE}, fetch = FetchType.LAZY)
	@CsvIgnore
	...
	@Override
	public boolean equals(Object managementUser) {
		if (this == managementUser) {
			return true;
		}
		if (managementUser == null || this.getClass() != managementUser.getClass()) {
			return false;
		}
		if (!super.equals(managementUser)) {
			return false;
		}

		// Compare references by ids only
		this.addRelationEntitiesToIdSet();
		ManagementUserEntity that = (ManagementUserEntity) managementUser;
		return
