...
@ToString
public class PatientVisitPaymentSelfPayingEntityAudit extends AbstractEntityAudit<PatientVisitPaymentSelfPayingEntity> {
	...
	public PatientVisitPaymentSelfPayingEntityAudit(
			...
			PatientVisitPaymentSelfPayingEntity entity,
