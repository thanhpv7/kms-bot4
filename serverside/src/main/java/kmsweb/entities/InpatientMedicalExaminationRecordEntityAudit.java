...
@ToString
public class InpatientMedicalExaminationRecordEntityAudit extends AbstractEntityAudit<InpatientMedicalExaminationRecordEntity> {
	...
	public InpatientMedicalExaminationRecordEntityAudit(
			...
			InpatientMedicalExaminationRecordEntity entity,
