...
@ToString
public class BpjsClaimSubmissionEntityAudit extends AbstractEntityAudit<BpjsClaimSubmissionEntity> {
	...
	public BpjsClaimSubmissionEntityAudit(
			...
			BpjsClaimSubmissionEntity entity,
