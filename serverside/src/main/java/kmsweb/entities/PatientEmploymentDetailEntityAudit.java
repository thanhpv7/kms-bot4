...
@ToString
public class PatientEmploymentDetailEntityAudit extends AbstractEntityAudit<PatientEmploymentDetailEntity> {
	...
	public PatientEmploymentDetailEntityAudit(
			...
			PatientEmploymentDetailEntity entity,
