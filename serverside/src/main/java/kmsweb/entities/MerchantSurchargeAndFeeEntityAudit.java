...
@ToString
public class MerchantSurchargeAndFeeEntityAudit extends AbstractEntityAudit<MerchantSurchargeAndFeeEntity> {
	...
	public MerchantSurchargeAndFeeEntityAudit(
			...
			MerchantSurchargeAndFeeEntity entity,
