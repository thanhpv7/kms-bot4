...
@ToString
public class BpjsPcareKegiatanKelompokEntityAudit extends AbstractEntityAudit<BpjsPcareKegiatanKelompokEntity> {
	...
	public BpjsPcareKegiatanKelompokEntityAudit(
			...
			BpjsPcareKegiatanKelompokEntity entity,
