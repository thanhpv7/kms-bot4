...
import kmsweb.entities.listeners.FacilityUserEntityListener;
import kmsweb.serializers.FacilityUserSerializer;
...
@EntityListeners({FacilityUserEntityListener.class, AuditingEntityListener.class})
@JsonSerialize(using = FacilityUserSerializer.class)
@Table(
	uniqueConstraints = {
	}
)
public class FacilityUserEntity extends UserEntity {

	/**
	 * Takes a FacilityUserEntityDto and converts it into a FacilityUserEntity.
	 * Primarily used when endpoints are invoked, as they take DTOs as input, which need to be converted to the entity type
	 *
	 * @param facilityUserEntityDto
	 */
	public FacilityUserEntity(FacilityUserEntityDto facilityUserEntityDto) {
		// Need to account for potential that any field is empty.  This will be run before any server validation and
		// endpoints will most likely not be subject to clientside validation

		if (facilityUserEntityDto.getId() != null) {
			this.setId(facilityUserEntityDto.getId());
		}

		if (facilityUserEntityDto.getStaff() != null) {
			this.setStaff(facilityUserEntityDto.getStaff());
		}
	...
	@OneToOne(mappedBy = "facilityUser", cascade = {CascadeType.MERGE}, fetch = FetchType.LAZY)
	@CsvIgnore
	 ...
	 *
	 * @param entity the FacilityUserEntity to be set or updated
	...
	public void setStaff(@NotNull StaffEntity entity, boolean reverseAdd) {
		...
		if (this.staff != null) {
			this.staff.unsetFacilityUser();
		}

		this.staff = entity;

		if (reverseAdd) {
			this.staff.setFacilityUser(this, false);
		}
	...
	public void unsetStaff(boolean reverse) {
		if (reverse && this.staff != null) {
			this.staff.unsetFacilityUser(false);
		}
		this.staff = null;
	}
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	@Override
	public boolean equals(Object facilityUser) {
		if (this == facilityUser) {
			return true;
		}
		if (facilityUser == null || this.getClass() != facilityUser.getClass()) {
			return false;
		}
		if (!super.equals(facilityUser)) {
			return false;
		}

		// Compare references by ids only
		this.addRelationEntitiesToIdSet();
		FacilityUserEntity that = (FacilityUserEntity) facilityUser;
		return
