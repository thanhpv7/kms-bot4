...
@ToString
public class PatientCaseHistoryEntityAudit extends AbstractEntityAudit<PatientCaseHistoryEntity> {
	...
	public PatientCaseHistoryEntityAudit(
			...
			PatientCaseHistoryEntity entity,
