...
@ToString
public class NhisInvestigationEntityAudit extends AbstractEntityAudit<NhisInvestigationEntity> {
	...
	public NhisInvestigationEntityAudit(
			...
			NhisInvestigationEntity entity,
