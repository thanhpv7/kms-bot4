...
@ToString
public class PrescriptionHeaderEntityAudit extends AbstractEntityAudit<PrescriptionHeaderEntity> {
	...
	public PrescriptionHeaderEntityAudit(
			...
			PrescriptionHeaderEntity entity,
