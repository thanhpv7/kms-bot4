...
@ToString
public class InventoryAdjusmentBatchEntityAudit extends AbstractEntityAudit<InventoryAdjusmentBatchEntity> {
	...
	public InventoryAdjusmentBatchEntityAudit(
			...
			InventoryAdjusmentBatchEntity entity,
