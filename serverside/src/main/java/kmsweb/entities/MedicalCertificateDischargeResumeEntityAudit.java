...
@ToString
public class MedicalCertificateDischargeResumeEntityAudit extends AbstractEntityAudit<MedicalCertificateDischargeResumeEntity> {
	...
	public MedicalCertificateDischargeResumeEntityAudit(
			...
			MedicalCertificateDischargeResumeEntity entity,
