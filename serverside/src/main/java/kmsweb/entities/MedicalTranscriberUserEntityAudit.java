...
@ToString
public class MedicalTranscriberUserEntityAudit extends AbstractEntityAudit<MedicalTranscriberUserEntity> {
	...
	public MedicalTranscriberUserEntityAudit(
			...
			MedicalTranscriberUserEntity entity,
