...
@ToString
public class NhisClaimGDRGDetailEntityAudit extends AbstractEntityAudit<NhisClaimGDRGDetailEntity> {
	...
	public NhisClaimGDRGDetailEntityAudit(
			...
			NhisClaimGDRGDetailEntity entity,
