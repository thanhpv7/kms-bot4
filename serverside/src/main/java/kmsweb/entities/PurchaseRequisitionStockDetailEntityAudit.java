...
@ToString
public class PurchaseRequisitionStockDetailEntityAudit extends AbstractEntityAudit<PurchaseRequisitionStockDetailEntity> {
	...
	public PurchaseRequisitionStockDetailEntityAudit(
			...
			PurchaseRequisitionStockDetailEntity entity,
