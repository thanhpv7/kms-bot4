...
@ToString
public class HospitalGroupInformationEntityAudit extends AbstractEntityAudit<HospitalGroupInformationEntity> {
	...
	public HospitalGroupInformationEntityAudit(
			...
			HospitalGroupInformationEntity entity,
