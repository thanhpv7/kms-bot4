...
@ToString
public class BpjsTotalReferralSEPEntityAudit extends AbstractEntityAudit<BpjsTotalReferralSEPEntity> {
	...
	public BpjsTotalReferralSEPEntityAudit(
			...
			BpjsTotalReferralSEPEntity entity,
