...
@ToString
public class VaccinationOrderDetailEntityAudit extends AbstractEntityAudit<VaccinationOrderDetailEntity> {
	...
	public VaccinationOrderDetailEntityAudit(
			...
			VaccinationOrderDetailEntity entity,
