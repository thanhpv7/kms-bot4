...
@ToString
public class ChartOfAccountMappingEntityAudit extends AbstractEntityAudit<ChartOfAccountMappingEntity> {
	...
	public ChartOfAccountMappingEntityAudit(
			...
			ChartOfAccountMappingEntity entity,
