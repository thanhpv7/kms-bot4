...
@ToString
public class MedicalCertificateSickLeaveEntityAudit extends AbstractEntityAudit<MedicalCertificateSickLeaveEntity> {
	...
	public MedicalCertificateSickLeaveEntityAudit(
			...
			MedicalCertificateSickLeaveEntity entity,
