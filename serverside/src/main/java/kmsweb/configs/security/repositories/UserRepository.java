 ...
 * {@link kmsweb.repositories.UserRepository} since we want to be able to query all user tables at once
 ...
 * against all user types at once, which is not possible for {@link kmsweb.repositories.UserRepository}.
 */
@Repository
public interface UserRepository extends kmsweb.repositories.UserRepository<UserEntity> {
