...
import static kmsweb.configs.security.SecurityConfig.ANONYMOUS_USER;
...
public class JwtAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
	 ...
	 */
	public JwtAuthenticationFilter(String defaultFilterProcessesUrl, AuthenticationService authService) {
	...
	protected void unsuccessfulAuthentication(
		...
		if (failed.getCause() instanceof ExpiredJwtException) {
			rootNode.put("error_description", "The session has expired.");
