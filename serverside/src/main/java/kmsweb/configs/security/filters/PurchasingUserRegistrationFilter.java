 ...
 */
public class PurchasingUserRegistrationFilter extends AbstractRegistrationFilter<PurchasingUserRepository> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public PurchasingUserRegistrationFilter(
			@NonNull String registrationEndpoint,
			@NonNull AuthenticationService authService,
			@NonNull PurchasingUserRepository userRepository,
	...
	public void doFilter(
		...
		final PurchasingUserEntity purchasingUserEntity = objectMapper.convertValue(paramMap, PurchasingUserEntity.class);
		...
		AnonymousHelper.runAnonymously(() -> defaultRoles.forEach(purchasingUserEntity::addRoles));
		...
		purchasingUserEntity.setPassword(passwordEncoder.encode(purchasingUserEntity.getPassword()));
		...
		AnonymousHelper.runAnonymously(() -> userRepository.save(purchasingUserEntity));
	...
	protected List<RoleEntity> getDefaultRoles() {
		...
		Optional<RoleEntity> purchasingUser = roleRepository.findByName("PURCHASING_USER");
		if (purchasingUser.isEmpty()) {
			throw new RuntimeException("Role purchasingUser not present on the server.");
		}
