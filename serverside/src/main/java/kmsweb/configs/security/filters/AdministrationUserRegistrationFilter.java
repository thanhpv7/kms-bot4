 ...
 */
public class AdministrationUserRegistrationFilter extends AbstractRegistrationFilter<AdministrationUserRepository> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public AdministrationUserRegistrationFilter(
			@NonNull String registrationEndpoint,
			@NonNull AuthenticationService authService,
			@NonNull AdministrationUserRepository userRepository,
	...
	public void doFilter(
		...
		final AdministrationUserEntity administrationUserEntity = objectMapper.convertValue(paramMap, AdministrationUserEntity.class);
		...
		AnonymousHelper.runAnonymously(() -> defaultRoles.forEach(administrationUserEntity::addRoles));
		...
		administrationUserEntity.setPassword(passwordEncoder.encode(administrationUserEntity.getPassword()));
		...
		AnonymousHelper.runAnonymously(() -> userRepository.save(administrationUserEntity));
	...
	protected List<RoleEntity> getDefaultRoles() {
		...
		Optional<RoleEntity> administrationUser = roleRepository.findByName("ADMINISTRATION_USER");
		if (administrationUser.isEmpty()) {
			throw new RuntimeException("Role administrationUser not present on the server.");
		}
