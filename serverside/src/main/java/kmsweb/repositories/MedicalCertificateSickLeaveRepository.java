 ...
 */
@Repository
public interface MedicalCertificateSickLeaveRepository extends AbstractRepository<MedicalCertificateSickLeaveEntity> {
	/**
	 ...
	 */
	List<MedicalCertificateSickLeaveEntity> findByPeriod(@NotNull Integer period);
	/**
	 ...
	 */
	List<MedicalCertificateSickLeaveEntity> findByStartDate(@NotNull OffsetDateTime startDate);
	/**
	 ...
	 */
	List<MedicalCertificateSickLeaveEntity> findByEndDate(@NotNull OffsetDateTime endDate);
	/**
	 ...
	 */
	List<MedicalCertificateSickLeaveEntity> findByNotes(@NotNull String notes);
	...
	@Transactional
	List<MedicalCertificateSickLeaveEntity> findAllByIdNotIn(@NotNull Iterable<UUID> ids);

	@Transactional
	List<MedicalCertificateSickLeaveEntity> findAllByIdIn(@NotNull Iterable<UUID> ids);
