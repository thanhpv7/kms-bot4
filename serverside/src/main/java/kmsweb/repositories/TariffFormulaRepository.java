 ...
 */
@Repository
public interface TariffFormulaRepository extends AbstractRepository<TariffFormulaEntity> {
	/**
	 ...
	 */
	List<TariffFormulaEntity> findByTariffType(@NotNull TariffTypeEnum tariffType);
	/**
	 ...
	 */
	List<TariffFormulaEntity> findByClassification(@NotNull String classification);
	/**
	 ...
	 */
	List<TariffFormulaEntity> findByMultiplier(@NotNull Double multiplier);
	/**
	 ...
	 */
	List<TariffFormulaEntity> findByRounding(@NotNull Integer rounding);
	/**
	 ...
	 */
	List<TariffFormulaEntity> findByRoundingMethod(@NotNull RoundingMethodEnum roundingMethod);
	...
	@Transactional
	List<TariffFormulaEntity> findAllByIdNotIn(@NotNull Iterable<UUID> ids);

	@Transactional
	List<TariffFormulaEntity> findAllByIdIn(@NotNull Iterable<UUID> ids);
