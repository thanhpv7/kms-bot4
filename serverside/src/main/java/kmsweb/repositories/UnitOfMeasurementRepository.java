 ...
 */
@Repository
public interface UnitOfMeasurementRepository extends AbstractRepository<UnitOfMeasurementEntity> {
	/**
	 ...
	 */
	List<UnitOfMeasurementEntity> findByUnitName(@NotNull String unitName);
	/**
	 ...
	 */
	List<UnitOfMeasurementEntity> findBySymbol(@NotNull String symbol);
	/**
	 ...
	 */
	List<UnitOfMeasurementEntity> findByDescription(@NotNull String description);
	/**
	 ...
	 */
	List<UnitOfMeasurementEntity> findByUnitCategory(@NotNull String unitCategory);
	/**
	 ...
	 */
	List<UnitOfMeasurementEntity> findByConsumptionUnit(@NotNull Boolean consumptionUnit);
	...
	@Transactional
	List<UnitOfMeasurementEntity> findAllByIdNotIn(@NotNull Iterable<UUID> ids);

	@Transactional
	List<UnitOfMeasurementEntity> findAllByIdIn(@NotNull Iterable<UUID> ids);
