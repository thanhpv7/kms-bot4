 ...
 */
@Repository
public interface BpjsDiagnoseRepository extends AbstractRepository<BpjsDiagnoseEntity> {
	/**
	 ...
	 */
	List<BpjsDiagnoseEntity> findByRefCode(@NotNull String refCode);
	/**
	 ...
	 */
	List<BpjsDiagnoseEntity> findByRefName(@NotNull String refName);
	...
	@Transactional
	List<BpjsDiagnoseEntity> findAllByIdNotIn(@NotNull Iterable<UUID> ids);

	@Transactional
	List<BpjsDiagnoseEntity> findAllByIdIn(@NotNull Iterable<UUID> ids);
