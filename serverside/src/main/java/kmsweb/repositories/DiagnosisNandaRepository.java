 ...
 */
@Repository
public interface DiagnosisNandaRepository extends AbstractRepository<DiagnosisNandaEntity> {
	/**
	 ...
	 */
	List<DiagnosisNandaEntity> findByNursingNotes(@NotNull String nursingNotes);
	/**
	 ...
	 */
	List<DiagnosisNandaEntity> findBySequence(@NotNull Integer sequence);
	...
	@Transactional
	List<DiagnosisNandaEntity> findAllByIdNotIn(@NotNull Iterable<UUID> ids);

	@Transactional
	List<DiagnosisNandaEntity> findAllByIdIn(@NotNull Iterable<UUID> ids);
