 ...
 */
@Repository
public interface PatientVisitPatientPaymentInsuranceRepository extends AbstractRepository<PatientVisitPatientPaymentInsuranceEntity> {
	/**
	 ...
	 */
	List<PatientVisitPatientPaymentInsuranceEntity> findByMemberNo(@NotNull String memberNo);
	/**
	 ...
	 */
	List<PatientVisitPatientPaymentInsuranceEntity> findByPolicyHolderNo(@NotNull String policyHolderNo);
	/**
	 ...
	 */
	List<PatientVisitPatientPaymentInsuranceEntity> findByEligilityVerification(@NotNull String eligilityVerification);
	/**
	 ...
	 */
	List<PatientVisitPatientPaymentInsuranceEntity> findByGuaranteeLetterNo(@NotNull String guaranteeLetterNo);
	/**
	 ...
	 */
	List<PatientVisitPatientPaymentInsuranceEntity> findByCoverageBalance(@NotNull Double coverageBalance);
	/**
	 ...
	 */
	List<PatientVisitPatientPaymentInsuranceEntity> findByNotes(@NotNull String notes);
	...
	@Transactional
	List<PatientVisitPatientPaymentInsuranceEntity> findAllByIdNotIn(@NotNull Iterable<UUID> ids);

	@Transactional
	List<PatientVisitPatientPaymentInsuranceEntity> findAllByIdIn(@NotNull Iterable<UUID> ids);
