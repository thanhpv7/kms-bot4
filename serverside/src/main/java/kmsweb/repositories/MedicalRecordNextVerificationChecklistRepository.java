 ...
 */
@Repository
public interface MedicalRecordNextVerificationChecklistRepository extends AbstractRepository<MedicalRecordNextVerificationChecklistEntity> {
	/**
	 ...
	 */
	List<MedicalRecordNextVerificationChecklistEntity> findByOutVitalSign(@NotNull Boolean outVitalSign);
	/**
	 ...
	 */
	List<MedicalRecordNextVerificationChecklistEntity> findByOutAnamnesis(@NotNull Boolean outAnamnesis);
	/**
	 ...
	 */
	List<MedicalRecordNextVerificationChecklistEntity> findByOutPhysicalExamination(@NotNull Boolean outPhysicalExamination);
	/**
	 ...
	 */
	List<MedicalRecordNextVerificationChecklistEntity> findByOutDiagnosis(@NotNull Boolean outDiagnosis);
	/**
	 ...
	 */
	List<MedicalRecordNextVerificationChecklistEntity> findByOutDismissalType(@NotNull Boolean outDismissalType);
	/**
	 ...
	 */
	List<MedicalRecordNextVerificationChecklistEntity> findByInpVitalSign(@NotNull Boolean inpVitalSign);
	/**
	 ...
	 */
	List<MedicalRecordNextVerificationChecklistEntity> findByInpDailyCareDoctorNotes(@NotNull Boolean inpDailyCareDoctorNotes);
	/**
	 ...
	 */
	List<MedicalRecordNextVerificationChecklistEntity> findByInpDailyCareDoctorNotesNA(@NotNull Boolean inpDailyCareDoctorNotesNA);
	/**
	 ...
	 */
	List<MedicalRecordNextVerificationChecklistEntity> findByInpDailyCareNursingNotes(@NotNull Boolean inpDailyCareNursingNotes);
	/**
	 ...
	 */
	List<MedicalRecordNextVerificationChecklistEntity> findByInpDailyCareNursingNotesNA(@NotNull Boolean inpDailyCareNursingNotesNA);
	/**
	 ...
	 */
	List<MedicalRecordNextVerificationChecklistEntity> findByInpDailyCareProgressNotes(@NotNull Boolean inpDailyCareProgressNotes);
	/**
	 ...
	 */
	List<MedicalRecordNextVerificationChecklistEntity> findByInpDailyCareProgressNotesNA(@NotNull Boolean inpDailyCareProgressNotesNA);
	/**
	 ...
	 */
	List<MedicalRecordNextVerificationChecklistEntity> findByInpDismissalDiagnosis(@NotNull Boolean inpDismissalDiagnosis);
	/**
	 ...
	 */
	List<MedicalRecordNextVerificationChecklistEntity> findByInpDismissalType(@NotNull Boolean inpDismissalType);
	/**
	 ...
	 */
	List<MedicalRecordNextVerificationChecklistEntity> findByInpDismissalCondition(@NotNull Boolean inpDismissalCondition);
	/**
	 ...
	 */
	List<MedicalRecordNextVerificationChecklistEntity> findByDrAdmissionDiagnosis(@NotNull Boolean drAdmissionDiagnosis);
	/**
	 ...
	 */
	List<MedicalRecordNextVerificationChecklistEntity> findByDrObservationDoctorNotes(@NotNull Boolean drObservationDoctorNotes);
	/**
	 ...
	 */
	List<MedicalRecordNextVerificationChecklistEntity> findByDrObservationDoctorNotesNA(@NotNull Boolean drObservationDoctorNotesNA);
	/**
	 ...
	 */
	List<MedicalRecordNextVerificationChecklistEntity> findByDrObservationNursingNotes(@NotNull Boolean drObservationNursingNotes);
	/**
	 ...
	 */
	List<MedicalRecordNextVerificationChecklistEntity> findByDrObservationNursingNotesNA(@NotNull Boolean drObservationNursingNotesNA);
	/**
	 ...
	 */
	List<MedicalRecordNextVerificationChecklistEntity> findByDrObservationProgressNotes(@NotNull Boolean drObservationProgressNotes);
	/**
	 ...
	 */
	List<MedicalRecordNextVerificationChecklistEntity> findByDrObservationProgressNotesNA(@NotNull Boolean drObservationProgressNotesNA);
	/**
	 ...
	 */
	List<MedicalRecordNextVerificationChecklistEntity> findByDrDismissalDiagnosis(@NotNull Boolean drDismissalDiagnosis);
	/**
	 ...
	 */
	List<MedicalRecordNextVerificationChecklistEntity> findByDrDismissalType(@NotNull Boolean drDismissalType);
	/**
	 ...
	 */
	List<MedicalRecordNextVerificationChecklistEntity> findByOtPreOperativeDiagnosis(@NotNull Boolean otPreOperativeDiagnosis);
	/**
	 ...
	 */
	List<MedicalRecordNextVerificationChecklistEntity> findByOtPreOperativeNotesSurgery(@NotNull Boolean otPreOperativeNotesSurgery);
	/**
	 ...
	 */
	List<MedicalRecordNextVerificationChecklistEntity> findByOtPreOperativeNotesAnaesthesiology(@NotNull Boolean otPreOperativeNotesAnaesthesiology);
	/**
	 ...
	 */
	List<MedicalRecordNextVerificationChecklistEntity> findByOtIntraOperativeNotesSurgery(@NotNull Boolean otIntraOperativeNotesSurgery);
	/**
	 ...
	 */
	List<MedicalRecordNextVerificationChecklistEntity> findByOtIntraOperativeNotesAnaesthesiology(@NotNull Boolean otIntraOperativeNotesAnaesthesiology);
	/**
	 ...
	 */
	List<MedicalRecordNextVerificationChecklistEntity> findByOtPostOperativeNotesSurgery(@NotNull Boolean otPostOperativeNotesSurgery);
	/**
	 ...
	 */
	List<MedicalRecordNextVerificationChecklistEntity> findByOtPostOperativeNotesAnaesthesiology(@NotNull Boolean otPostOperativeNotesAnaesthesiology);
	/**
	 ...
	 */
	List<MedicalRecordNextVerificationChecklistEntity> findByOtPostOperativeDiagnosis(@NotNull Boolean otPostOperativeDiagnosis);
	/**
	 ...
	 */
	List<MedicalRecordNextVerificationChecklistEntity> findByOtDismissalType(@NotNull Boolean otDismissalType);
	/**
	 ...
	 */
	List<MedicalRecordNextVerificationChecklistEntity> findByDsResponsibleStaff(@NotNull Boolean dsResponsibleStaff);
	/**
	 ...
	 */
	List<MedicalRecordNextVerificationChecklistEntity> findByDsInterpretation(@NotNull Boolean dsInterpretation);
	/**
	 ...
	 */
	List<MedicalRecordNextVerificationChecklistEntity> findByNotes(@NotNull String notes);
	...
	@Transactional
	List<MedicalRecordNextVerificationChecklistEntity> findAllByIdNotIn(@NotNull Iterable<UUID> ids);

	@Transactional
	List<MedicalRecordNextVerificationChecklistEntity> findAllByIdIn(@NotNull Iterable<UUID> ids);
