 ...
 */
@Repository
public interface InternalOrderRepository extends AbstractRepository<InternalOrderEntity> {
	/**
	 ...
	 */
	List<InternalOrderEntity> findByInternalOrderNumber(@NotNull String internalOrderNumber);
	/**
	 ...
	 */
	List<InternalOrderEntity> findByTransactionStatus(@NotNull String transactionStatus);
	/**
	 ...
	 */
	List<InternalOrderEntity> findByApprovalStatus(@NotNull String approvalStatus);
	/**
	 ...
	 */
	List<InternalOrderEntity> findByOrderDate(@NotNull OffsetDateTime orderDate);
	/**
	 ...
	 */
	List<InternalOrderEntity> findByExpectedDate(@NotNull OffsetDateTime expectedDate);
	/**
	 ...
	 */
	List<InternalOrderEntity> findByRequestUnit(@NotNull String requestUnit);
	/**
	 ...
	 */
	List<InternalOrderEntity> findByRequestPerson(@NotNull String requestPerson);
	/**
	 ...
	 */
	List<InternalOrderEntity> findByTransactionDetailType(@NotNull String transactionDetailType);
	/**
	 ...
	 */
	List<InternalOrderEntity> findByReferenceNumber(@NotNull String referenceNumber);
	/**
	 ...
	 */
	List<InternalOrderEntity> findByNotes(@NotNull String notes);
	/**
	 ...
	 */
	List<InternalOrderEntity> findByVoidDate(@NotNull OffsetDateTime voidDate);
	/**
	 ...
	 */
	List<InternalOrderEntity> findByIssuedDateTime(@NotNull OffsetDateTime issuedDateTime);
	/**
	 ...
	 */
	List<InternalOrderEntity> findByReceivedDateTime(@NotNull OffsetDateTime receivedDateTime);
	...
	@Transactional
	List<InternalOrderEntity> findAllByIdNotIn(@NotNull Iterable<UUID> ids);

	@Transactional
	List<InternalOrderEntity> findAllByIdIn(@NotNull Iterable<UUID> ids);
