 ...
 */
@Repository
public interface BpjsReferralSpecialistRepository extends AbstractRepository<BpjsReferralSpecialistEntity> {
	/**
	 ...
	 */
	List<BpjsReferralSpecialistEntity> findBySpecialistCode(@NotNull String specialistCode);
	/**
	 ...
	 */
	List<BpjsReferralSpecialistEntity> findBySpecialistName(@NotNull String specialistName);
	/**
	 ...
	 */
	List<BpjsReferralSpecialistEntity> findByCapacity(@NotNull String capacity);
	/**
	 ...
	 */
	List<BpjsReferralSpecialistEntity> findByTotalReferral(@NotNull String totalReferral);
	/**
	 ...
	 */
	List<BpjsReferralSpecialistEntity> findByPercentage(@NotNull String percentage);
	...
	@Transactional
	List<BpjsReferralSpecialistEntity> findAllByIdNotIn(@NotNull Iterable<UUID> ids);

	@Transactional
	List<BpjsReferralSpecialistEntity> findAllByIdIn(@NotNull Iterable<UUID> ids);
