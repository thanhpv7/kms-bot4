 ...
 */
@Repository
public interface DiagnosisExaminationRecordRepository extends AbstractRepository<DiagnosisExaminationRecordEntity> {
	/**
	 ...
	 */
	List<DiagnosisExaminationRecordEntity> findByDiagnosisSequence(@NotNull Integer diagnosisSequence);
	/**
	 ...
	 */
	List<DiagnosisExaminationRecordEntity> findByDiagnosisNotes(@NotNull String diagnosisNotes);
	/**
	 ...
	 */
	List<DiagnosisExaminationRecordEntity> findByActionNotes(@NotNull String actionNotes);
	/**
	 ...
	 */
	List<DiagnosisExaminationRecordEntity> findByNewCase(@NotNull Boolean newCase);
	/**
	 ...
	 */
	List<DiagnosisExaminationRecordEntity> findByPrintingNumber(@NotNull Integer printingNumber);
	...
	@Transactional
	List<DiagnosisExaminationRecordEntity> findAllByIdNotIn(@NotNull Iterable<UUID> ids);

	@Transactional
	List<DiagnosisExaminationRecordEntity> findAllByIdIn(@NotNull Iterable<UUID> ids);
