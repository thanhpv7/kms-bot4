 ...
 */
@Repository
public interface NhisClaimInvestigationDetailRepository extends AbstractRepository<NhisClaimInvestigationDetailEntity> {
	/**
	 ...
	 */
	List<NhisClaimInvestigationDetailEntity> findByDate(@NotNull OffsetDateTime date);
	/**
	 ...
	 */
	List<NhisClaimInvestigationDetailEntity> findByDescription(@NotNull String description);
	...
	@Transactional
	List<NhisClaimInvestigationDetailEntity> findAllByIdNotIn(@NotNull Iterable<UUID> ids);

	@Transactional
	List<NhisClaimInvestigationDetailEntity> findAllByIdIn(@NotNull Iterable<UUID> ids);
