 ...
 */
@Repository
public interface PatientPaymentSelfPayingRepository extends AbstractRepository<PatientPaymentSelfPayingEntity> {
	/**
	 ...
	 */
	List<PatientPaymentSelfPayingEntity> findBySponsorName(@NotNull String sponsorName);
	/**
	 ...
	 */
	List<PatientPaymentSelfPayingEntity> findBySponsorAddress(@NotNull String sponsorAddress);
	/**
	 ...
	 */
	List<PatientPaymentSelfPayingEntity> findBySponsorPhoneNo(@NotNull String sponsorPhoneNo);
	/**
	 ...
	 */
	List<PatientPaymentSelfPayingEntity> findBySponsorship(@NotNull String sponsorship);
	...
	@Transactional
	List<PatientPaymentSelfPayingEntity> findAllByIdNotIn(@NotNull Iterable<UUID> ids);

	@Transactional
	List<PatientPaymentSelfPayingEntity> findAllByIdIn(@NotNull Iterable<UUID> ids);
