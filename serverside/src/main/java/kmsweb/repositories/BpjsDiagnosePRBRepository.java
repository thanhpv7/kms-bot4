 ...
 */
@Repository
public interface BpjsDiagnosePRBRepository extends AbstractRepository<BpjsDiagnosePRBEntity> {
	/**
	 ...
	 */
	List<BpjsDiagnosePRBEntity> findByRefCode(@NotNull String refCode);
	/**
	 ...
	 */
	List<BpjsDiagnosePRBEntity> findByRefName(@NotNull String refName);
	...
	@Transactional
	List<BpjsDiagnosePRBEntity> findAllByIdNotIn(@NotNull Iterable<UUID> ids);

	@Transactional
	List<BpjsDiagnosePRBEntity> findAllByIdIn(@NotNull Iterable<UUID> ids);
