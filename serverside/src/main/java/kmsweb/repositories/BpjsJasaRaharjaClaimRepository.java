 ...
 */
@Repository
public interface BpjsJasaRaharjaClaimRepository extends AbstractRepository<BpjsJasaRaharjaClaimEntity> {
	/**
	 ...
	 */
	List<BpjsJasaRaharjaClaimEntity> findByNoSEP(@NotNull String noSEP);
	/**
	 ...
	 */
	List<BpjsJasaRaharjaClaimEntity> findBySepDate(@NotNull OffsetDateTime sepDate);
	/**
	 ...
	 */
	List<BpjsJasaRaharjaClaimEntity> findByDismissalDate(@NotNull OffsetDateTime dismissalDate);
	/**
	 ...
	 */
	List<BpjsJasaRaharjaClaimEntity> findByPatientID(@NotNull String patientID);
	/**
	 ...
	 */
	List<BpjsJasaRaharjaClaimEntity> findByTreatmentType(@NotNull String treatmentType);
	/**
	 ...
	 */
	List<BpjsJasaRaharjaClaimEntity> findByPolyclinic(@NotNull String polyclinic);
	/**
	 ...
	 */
	List<BpjsJasaRaharjaClaimEntity> findByBpjsCardNo(@NotNull String bpjsCardNo);
	/**
	 ...
	 */
	List<BpjsJasaRaharjaClaimEntity> findByName(@NotNull String name);
	/**
	 ...
	 */
	List<BpjsJasaRaharjaClaimEntity> findByIncidentDate(@NotNull OffsetDateTime incidentDate);
	...
	@Transactional
	List<BpjsJasaRaharjaClaimEntity> findAllByIdNotIn(@NotNull Iterable<UUID> ids);

	@Transactional
	List<BpjsJasaRaharjaClaimEntity> findAllByIdIn(@NotNull Iterable<UUID> ids);
