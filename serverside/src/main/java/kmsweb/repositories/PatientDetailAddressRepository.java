 ...
 */
@Repository
public interface PatientDetailAddressRepository extends AbstractRepository<PatientDetailAddressEntity> {
	/**
	 ...
	 */
	List<PatientDetailAddressEntity> findByCountry(@NotNull String country);
	/**
	 ...
	 */
	List<PatientDetailAddressEntity> findByState(@NotNull String state);
	/**
	 ...
	 */
	List<PatientDetailAddressEntity> findByRegency(@NotNull String regency);
	/**
	 ...
	 */
	List<PatientDetailAddressEntity> findByDistrict(@NotNull String district);
	/**
	 ...
	 */
	List<PatientDetailAddressEntity> findByVillage(@NotNull String village);
	/**
	 ...
	 */
	List<PatientDetailAddressEntity> findByPostCode(@NotNull String postCode);
	/**
	 ...
	 */
	List<PatientDetailAddressEntity> findByRt(@NotNull String rt);
	/**
	 ...
	 */
	List<PatientDetailAddressEntity> findByRw(@NotNull String rw);
	...
	@Transactional
	List<PatientDetailAddressEntity> findAllByIdNotIn(@NotNull Iterable<UUID> ids);

	@Transactional
	List<PatientDetailAddressEntity> findAllByIdIn(@NotNull Iterable<UUID> ids);
