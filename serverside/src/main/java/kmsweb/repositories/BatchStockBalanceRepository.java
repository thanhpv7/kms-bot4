 ...
 */
@Repository
public interface BatchStockBalanceRepository extends AbstractRepository<BatchStockBalanceEntity> {
	/**
	 ...
	 */
	List<BatchStockBalanceEntity> findBySourceNumber(@NotNull String sourceNumber);
	/**
	 ...
	 */
	List<BatchStockBalanceEntity> findByBatchNo(@NotNull String batchNo);
	/**
	 ...
	 */
	List<BatchStockBalanceEntity> findByExpirationDate(@NotNull OffsetDateTime expirationDate);
	/**
	 ...
	 */
	List<BatchStockBalanceEntity> findByBatchQtyUoi(@NotNull Double batchQtyUoi);
	/**
	 ...
	 */
	List<BatchStockBalanceEntity> findByUoi(@NotNull String uoi);
	...
	@Transactional
	List<BatchStockBalanceEntity> findAllByIdNotIn(@NotNull Iterable<UUID> ids);

	@Transactional
	List<BatchStockBalanceEntity> findAllByIdIn(@NotNull Iterable<UUID> ids);
