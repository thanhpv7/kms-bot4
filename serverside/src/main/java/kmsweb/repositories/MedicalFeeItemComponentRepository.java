 ...
 */
@Repository
public interface MedicalFeeItemComponentRepository extends AbstractRepository<MedicalFeeItemComponentEntity> {
	/**
	 ...
	 */
	List<MedicalFeeItemComponentEntity> findByPrice(@NotNull Double price);
	/**
	 ...
	 */
	List<MedicalFeeItemComponentEntity> findByMedicalStaffCode(@NotNull String medicalStaffCode);
	/**
	 ...
	 */
	List<MedicalFeeItemComponentEntity> findByNotes(@NotNull String notes);
	...
	@Transactional
	List<MedicalFeeItemComponentEntity> findAllByIdNotIn(@NotNull Iterable<UUID> ids);

	@Transactional
	List<MedicalFeeItemComponentEntity> findAllByIdIn(@NotNull Iterable<UUID> ids);
