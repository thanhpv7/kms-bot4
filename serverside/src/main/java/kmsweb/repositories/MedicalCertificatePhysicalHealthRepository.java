 ...
 */
@Repository
public interface MedicalCertificatePhysicalHealthRepository extends AbstractRepository<MedicalCertificatePhysicalHealthEntity> {
	/**
	 ...
	 */
	List<MedicalCertificatePhysicalHealthEntity> findByExaminationDateTime(@NotNull OffsetDateTime examinationDateTime);
	/**
	 ...
	 */
	List<MedicalCertificatePhysicalHealthEntity> findByExaminationResult(@NotNull Boolean examinationResult);
	/**
	 ...
	 */
	List<MedicalCertificatePhysicalHealthEntity> findByNotes(@NotNull String notes);
	/**
	 ...
	 */
	List<MedicalCertificatePhysicalHealthEntity> findByPurpose(@NotNull String purpose);
	...
	@Transactional
	List<MedicalCertificatePhysicalHealthEntity> findAllByIdNotIn(@NotNull Iterable<UUID> ids);

	@Transactional
	List<MedicalCertificatePhysicalHealthEntity> findAllByIdIn(@NotNull Iterable<UUID> ids);
