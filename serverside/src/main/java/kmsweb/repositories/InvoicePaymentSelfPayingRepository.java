 ...
 */
@Repository
public interface InvoicePaymentSelfPayingRepository extends AbstractRepository<InvoicePaymentSelfPayingEntity> {
	/**
	 ...
	 */
	List<InvoicePaymentSelfPayingEntity> findBySponsorName(@NotNull String sponsorName);
	/**
	 ...
	 */
	List<InvoicePaymentSelfPayingEntity> findBySponsorAddress(@NotNull String sponsorAddress);
	/**
	 ...
	 */
	List<InvoicePaymentSelfPayingEntity> findBySponsorPhoneNo(@NotNull String sponsorPhoneNo);
	/**
	 ...
	 */
	List<InvoicePaymentSelfPayingEntity> findBySponsorship(@NotNull String sponsorship);
	...
	@Transactional
	List<InvoicePaymentSelfPayingEntity> findAllByIdNotIn(@NotNull Iterable<UUID> ids);

	@Transactional
	List<InvoicePaymentSelfPayingEntity> findAllByIdIn(@NotNull Iterable<UUID> ids);
