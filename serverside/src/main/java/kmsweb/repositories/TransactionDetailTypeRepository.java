 ...
 */
@Repository
public interface TransactionDetailTypeRepository extends AbstractRepository<TransactionDetailTypeEntity> {
	/**
	 ...
	 */
	List<TransactionDetailTypeEntity> findByTransactionDetail(@NotNull String transactionDetail);
	/**
	 ...
	 */
	List<TransactionDetailTypeEntity> findByNotes(@NotNull String notes);
	/**
	 ...
	 */
	List<TransactionDetailTypeEntity> findByCoaCOGS(@NotNull String coaCOGS);
	/**
	 ...
	 */
	List<TransactionDetailTypeEntity> findByCoaSell(@NotNull String coaSell);
	/**
	 ...
	 */
	List<TransactionDetailTypeEntity> findByCoaInventory(@NotNull String coaInventory);
	...
	@Transactional
	List<TransactionDetailTypeEntity> findAllByIdNotIn(@NotNull Iterable<UUID> ids);

	@Transactional
	List<TransactionDetailTypeEntity> findAllByIdIn(@NotNull Iterable<UUID> ids);
