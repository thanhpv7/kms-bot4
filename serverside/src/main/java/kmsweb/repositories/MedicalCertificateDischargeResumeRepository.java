 ...
 */
@Repository
public interface MedicalCertificateDischargeResumeRepository extends AbstractRepository<MedicalCertificateDischargeResumeEntity> {
	/**
	 ...
	 */
	List<MedicalCertificateDischargeResumeEntity> findByAdmissionDateTime(@NotNull OffsetDateTime admissionDateTime);
	/**
	 ...
	 */
	List<MedicalCertificateDischargeResumeEntity> findByDischargeDateTime(@NotNull OffsetDateTime dischargeDateTime);
	/**
	 ...
	 */
	List<MedicalCertificateDischargeResumeEntity> findByCondition(@NotNull String condition);
	/**
	 ...
	 */
	List<MedicalCertificateDischargeResumeEntity> findByMainDiagnosis(@NotNull String mainDiagnosis);
	/**
	 ...
	 */
	List<MedicalCertificateDischargeResumeEntity> findByAction(@NotNull String action);
	/**
	 ...
	 */
	List<MedicalCertificateDischargeResumeEntity> findByNotes(@NotNull String notes);
	...
	@Transactional
	List<MedicalCertificateDischargeResumeEntity> findAllByIdNotIn(@NotNull Iterable<UUID> ids);

	@Transactional
	List<MedicalCertificateDischargeResumeEntity> findAllByIdIn(@NotNull Iterable<UUID> ids);
