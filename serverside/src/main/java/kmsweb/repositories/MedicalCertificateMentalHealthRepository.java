 ...
 */
@Repository
public interface MedicalCertificateMentalHealthRepository extends AbstractRepository<MedicalCertificateMentalHealthEntity> {
	/**
	 ...
	 */
	List<MedicalCertificateMentalHealthEntity> findByExaminationDateTime(@NotNull OffsetDateTime examinationDateTime);
	/**
	 ...
	 */
	List<MedicalCertificateMentalHealthEntity> findByExaminationResult(@NotNull Boolean examinationResult);
	/**
	 ...
	 */
	List<MedicalCertificateMentalHealthEntity> findByNotes(@NotNull String notes);
	/**
	 ...
	 */
	List<MedicalCertificateMentalHealthEntity> findByPurpose(@NotNull String purpose);
	...
	@Transactional
	List<MedicalCertificateMentalHealthEntity> findAllByIdNotIn(@NotNull Iterable<UUID> ids);

	@Transactional
	List<MedicalCertificateMentalHealthEntity> findAllByIdIn(@NotNull Iterable<UUID> ids);
