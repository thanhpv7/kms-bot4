 ...
 */
@Repository
public interface CompoundPrescriptionItemRepository extends AbstractRepository<CompoundPrescriptionItemEntity> {
	/**
	 ...
	 */
	List<CompoundPrescriptionItemEntity> findByDose(@NotNull Integer dose);
	/**
	 ...
	 */
	List<CompoundPrescriptionItemEntity> findByRequestedQuantity(@NotNull Double requestedQuantity);
	/**
	 ...
	 */
	List<CompoundPrescriptionItemEntity> findByNotes(@NotNull String notes);
	...
	@Transactional
	List<CompoundPrescriptionItemEntity> findAllByIdNotIn(@NotNull Iterable<UUID> ids);

	@Transactional
	List<CompoundPrescriptionItemEntity> findAllByIdIn(@NotNull Iterable<UUID> ids);
