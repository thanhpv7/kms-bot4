 ...
 */
@Repository
public interface BpjsPcareProviderRayonisasiRepository extends AbstractRepository<BpjsPcareProviderRayonisasiEntity> {
	/**
	 ...
	 */
	List<BpjsPcareProviderRayonisasiEntity> findByKdprovider(@NotNull String kdprovider);
	/**
	 ...
	 */
	List<BpjsPcareProviderRayonisasiEntity> findByNmprovider(@NotNull String nmprovider);
	...
	@Transactional
	List<BpjsPcareProviderRayonisasiEntity> findAllByIdNotIn(@NotNull Iterable<UUID> ids);

	@Transactional
	List<BpjsPcareProviderRayonisasiEntity> findAllByIdIn(@NotNull Iterable<UUID> ids);
