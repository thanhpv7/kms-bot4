 ...
 */
@Repository
public interface BpjsPRBDetailRepository extends AbstractRepository<BpjsPRBDetailEntity> {
	/**
	 ...
	 */
	List<BpjsPRBDetailEntity> findBySrbNo(@NotNull String srbNo);
	/**
	 ...
	 */
	List<BpjsPRBDetailEntity> findByDrugCode(@NotNull String drugCode);
	/**
	 ...
	 */
	List<BpjsPRBDetailEntity> findByDrugName(@NotNull String drugName);
	/**
	 ...
	 */
	List<BpjsPRBDetailEntity> findBySigna1(@NotNull String signa1);
	/**
	 ...
	 */
	List<BpjsPRBDetailEntity> findBySigna2(@NotNull String signa2);
	/**
	 ...
	 */
	List<BpjsPRBDetailEntity> findByQty(@NotNull String qty);
	...
	@Transactional
	List<BpjsPRBDetailEntity> findAllByIdNotIn(@NotNull Iterable<UUID> ids);

	@Transactional
	List<BpjsPRBDetailEntity> findAllByIdIn(@NotNull Iterable<UUID> ids);
