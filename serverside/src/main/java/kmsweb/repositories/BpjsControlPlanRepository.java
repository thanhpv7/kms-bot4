 ...
 */
@Repository
public interface BpjsControlPlanRepository extends AbstractRepository<BpjsControlPlanEntity> {
	/**
	 ...
	 */
	List<BpjsControlPlanEntity> findByNoSEP(@NotNull String noSEP);
	/**
	 ...
	 */
	List<BpjsControlPlanEntity> findByControlLetterNo(@NotNull String controlLetterNo);
	/**
	 ...
	 */
	List<BpjsControlPlanEntity> findByControlPlanDate(@NotNull String controlPlanDate);
	/**
	 ...
	 */
	List<BpjsControlPlanEntity> findByBpjsCardNo(@NotNull String bpjsCardNo);
	/**
	 ...
	 */
	List<BpjsControlPlanEntity> findByName(@NotNull String name);
	/**
	 ...
	 */
	List<BpjsControlPlanEntity> findByGender(@NotNull String gender);
	/**
	 ...
	 */
	List<BpjsControlPlanEntity> findByDateOfBirth(@NotNull String dateOfBirth);
	/**
	 ...
	 */
	List<BpjsControlPlanEntity> findByDoctorCode(@NotNull String doctorCode);
	/**
	 ...
	 */
	List<BpjsControlPlanEntity> findByPolyclinicCode(@NotNull String polyclinicCode);
	...
	@Transactional
	List<BpjsControlPlanEntity> findAllByIdNotIn(@NotNull Iterable<UUID> ids);

	@Transactional
	List<BpjsControlPlanEntity> findAllByIdIn(@NotNull Iterable<UUID> ids);
