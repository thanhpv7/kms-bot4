 ...
 */
@Repository
public interface BpjsClaimSubmissionRepository extends AbstractRepository<BpjsClaimSubmissionEntity> {
	/**
	 ...
	 */
	List<BpjsClaimSubmissionEntity> findBySepNo(@NotNull String sepNo);
	/**
	 ...
	 */
	List<BpjsClaimSubmissionEntity> findByAdmissionDate(@NotNull OffsetDateTime admissionDate);
	/**
	 ...
	 */
	List<BpjsClaimSubmissionEntity> findByDismissalDate(@NotNull OffsetDateTime dismissalDate);
	/**
	 ...
	 */
	List<BpjsClaimSubmissionEntity> findByInsuranceProvider(@NotNull String insuranceProvider);
	/**
	 ...
	 */
	List<BpjsClaimSubmissionEntity> findByTreatmentType(@NotNull String treatmentType);
	/**
	 ...
	 */
	List<BpjsClaimSubmissionEntity> findByFollowUpPlan(@NotNull String followUpPlan);
	/**
	 ...
	 */
	List<BpjsClaimSubmissionEntity> findByControlDate(@NotNull OffsetDateTime controlDate);
	/**
	 ...
	 */
	List<BpjsClaimSubmissionEntity> findByAdditionalDiagnosis(@NotNull String additionalDiagnosis);
	/**
	 ...
	 */
	List<BpjsClaimSubmissionEntity> findByAdditionalProcedure(@NotNull String additionalProcedure);
	/**
	 ...
	 */
	List<BpjsClaimSubmissionEntity> findByKelasRawat(@NotNull KelasRawatEnum kelasRawat);
	...
	@Transactional
	List<BpjsClaimSubmissionEntity> findAllByIdNotIn(@NotNull Iterable<UUID> ids);

	@Transactional
	List<BpjsClaimSubmissionEntity> findAllByIdIn(@NotNull Iterable<UUID> ids);
