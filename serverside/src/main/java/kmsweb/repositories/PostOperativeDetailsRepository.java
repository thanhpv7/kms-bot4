 ...
 */
@Repository
public interface PostOperativeDetailsRepository extends AbstractRepository<PostOperativeDetailsEntity> {
	/**
	 ...
	 */
	List<PostOperativeDetailsEntity> findByRecoveryStartDateTime(@NotNull OffsetDateTime recoveryStartDateTime);
	/**
	 ...
	 */
	List<PostOperativeDetailsEntity> findByRecoveryEndDateTime(@NotNull OffsetDateTime recoveryEndDateTime);
	/**
	 ...
	 */
	List<PostOperativeDetailsEntity> findByPostoperativeMainDiagnosis(@NotNull String postoperativeMainDiagnosis);
	/**
	 ...
	 */
	List<PostOperativeDetailsEntity> findByPostoperativeAction(@NotNull String postoperativeAction);
	/**
	 ...
	 */
	List<PostOperativeDetailsEntity> findByNewCase(@NotNull Boolean newCase);
	/**
	 ...
	 */
	List<PostOperativeDetailsEntity> findByPostoperativeDiagnosisSupportOrder(@NotNull String postoperativeDiagnosisSupportOrder);
	/**
	 ...
	 */
	List<PostOperativeDetailsEntity> findByAnesthesiaPostoperativeMonitoring(@NotNull String anesthesiaPostoperativeMonitoring);
	/**
	 ...
	 */
	List<PostOperativeDetailsEntity> findByAnesthesiaPostoperativeAction(@NotNull String anesthesiaPostoperativeAction);
	...
	@Transactional
	List<PostOperativeDetailsEntity> findAllByIdNotIn(@NotNull Iterable<UUID> ids);

	@Transactional
	List<PostOperativeDetailsEntity> findAllByIdIn(@NotNull Iterable<UUID> ids);
