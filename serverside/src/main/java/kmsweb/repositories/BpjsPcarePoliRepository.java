 ...
 */
@Repository
public interface BpjsPcarePoliRepository extends AbstractRepository<BpjsPcarePoliEntity> {
	/**
	 ...
	 */
	List<BpjsPcarePoliEntity> findByKdpoli(@NotNull String kdpoli);
	/**
	 ...
	 */
	List<BpjsPcarePoliEntity> findByNmpoli(@NotNull String nmpoli);
	/**
	 ...
	 */
	List<BpjsPcarePoliEntity> findByPolisakit(@NotNull Boolean polisakit);
	...
	@Transactional
	List<BpjsPcarePoliEntity> findAllByIdNotIn(@NotNull Iterable<UUID> ids);

	@Transactional
	List<BpjsPcarePoliEntity> findAllByIdIn(@NotNull Iterable<UUID> ids);
