 ...
 */
@Repository
public interface PriceComponentRepository extends AbstractRepository<PriceComponentEntity> {
	/**
	 ...
	 */
	Optional<PriceComponentEntity> findByComponentCode(@NotNull String componentCode);
	/**
	 ...
	 */
	List<PriceComponentEntity> findByComponentName(@NotNull String componentName);
	/**
	 ...
	 */
	List<PriceComponentEntity> findByCoaCOGS(@NotNull String coaCOGS);
	/**
	 ...
	 */
	List<PriceComponentEntity> findByCoaSell(@NotNull String coaSell);
	/**
	 ...
	 */
	List<PriceComponentEntity> findByCoaInventory(@NotNull String coaInventory);
	...
	@Transactional
	List<PriceComponentEntity> findAllByIdNotIn(@NotNull Iterable<UUID> ids);

	@Transactional
	List<PriceComponentEntity> findAllByIdIn(@NotNull Iterable<UUID> ids);
