 ...
 */
@Repository
public interface PatientVisitRepository extends AbstractRepository<PatientVisitEntity> {
	/**
	 ...
	 */
	List<PatientVisitEntity> findByVisitNumber(@NotNull String visitNumber);
	/**
	 ...
	 */
	List<PatientVisitEntity> findByRegistrationType(@NotNull String registrationType);
	/**
	 ...
	 */
	List<PatientVisitEntity> findByVisitDate(@NotNull OffsetDateTime visitDate);
	/**
	 ...
	 */
	List<PatientVisitEntity> findByRegistrationLocation(@NotNull String registrationLocation);
	/**
	 ...
	 */
	List<PatientVisitEntity> findByPatientPaymentType(@NotNull String patientPaymentType);
	/**
	 ...
	 */
	List<PatientVisitEntity> findByVisitType(@NotNull String visitType);
	...
	@Transactional
	List<PatientVisitEntity> findAllByIdNotIn(@NotNull Iterable<UUID> ids);

	@Transactional
	List<PatientVisitEntity> findAllByIdIn(@NotNull Iterable<UUID> ids);
