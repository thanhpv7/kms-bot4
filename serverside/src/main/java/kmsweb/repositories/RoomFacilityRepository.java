 ...
 */
@Repository
public interface RoomFacilityRepository extends AbstractRepository<RoomFacilityEntity> {
	/**
	 ...
	 */
	Optional<RoomFacilityEntity> findByRoomNumber(@NotNull String roomNumber);
	/**
	 ...
	 */
	List<RoomFacilityEntity> findByRoomName(@NotNull String roomName);
	/**
	 ...
	 */
	List<RoomFacilityEntity> findByDepartment(@NotNull String department);
	/**
	 ...
	 */
	List<RoomFacilityEntity> findByGenderAllocation(@NotNull String genderAllocation);
	/**
	 ...
	 */
	List<RoomFacilityEntity> findByLocation(@NotNull String location);
	/**
	 ...
	 */
	List<RoomFacilityEntity> findByNotes(@NotNull String notes);
	/**
	 ...
	 */
	List<RoomFacilityEntity> findByCategory(@NotNull String category);
	/**
	 ...
	 */
	List<RoomFacilityEntity> findByTreatmentClass(@NotNull String treatmentClass);
	...
	@Transactional
	List<RoomFacilityEntity> findAllByIdNotIn(@NotNull Iterable<UUID> ids);

	@Transactional
	List<RoomFacilityEntity> findAllByIdIn(@NotNull Iterable<UUID> ids);
