 ...
 */
@Repository
public interface VaccinationOrderRepository extends AbstractRepository<VaccinationOrderEntity> {
	/**
	 ...
	 */
	List<VaccinationOrderEntity> findByVaccinationLocation(@NotNull String vaccinationLocation);
	/**
	 ...
	 */
	List<VaccinationOrderEntity> findByVaccinationReaction(@NotNull String vaccinationReaction);
	/**
	 ...
	 */
	List<VaccinationOrderEntity> findByPurpose(@NotNull String purpose);
	/**
	 ...
	 */
	List<VaccinationOrderEntity> findByVaccinationNotes(@NotNull String vaccinationNotes);
	/**
	 ...
	 */
	List<VaccinationOrderEntity> findByReactionNotes(@NotNull String reactionNotes);
	...
	@Transactional
	List<VaccinationOrderEntity> findAllByIdNotIn(@NotNull Iterable<UUID> ids);

	@Transactional
	List<VaccinationOrderEntity> findAllByIdIn(@NotNull Iterable<UUID> ids);
