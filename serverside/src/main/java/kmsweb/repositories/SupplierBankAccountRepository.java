 ...
 */
@Repository
public interface SupplierBankAccountRepository extends AbstractRepository<SupplierBankAccountEntity> {
	/**
	 ...
	 */
	List<SupplierBankAccountEntity> findByBankName(@NotNull String bankName);
	/**
	 ...
	 */
	List<SupplierBankAccountEntity> findByAccountName(@NotNull String accountName);
	/**
	 ...
	 */
	List<SupplierBankAccountEntity> findByAccountNumber(@NotNull String accountNumber);
	/**
	 ...
	 */
	List<SupplierBankAccountEntity> findByCity(@NotNull String city);
	/**
	 ...
	 */
	List<SupplierBankAccountEntity> findByBranch(@NotNull String branch);
	/**
	 ...
	 */
	List<SupplierBankAccountEntity> findByNotes(@NotNull String notes);
	...
	@Transactional
	List<SupplierBankAccountEntity> findAllByIdNotIn(@NotNull Iterable<UUID> ids);

	@Transactional
	List<SupplierBankAccountEntity> findAllByIdIn(@NotNull Iterable<UUID> ids);
