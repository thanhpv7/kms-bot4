 ...
 */
@Repository
public interface StockTransactionPerDateTypeRepository extends AbstractRepository<StockTransactionPerDateTypeEntity> {
	/**
	 ...
	 */
	List<StockTransactionPerDateTypeEntity> findByAsOfDate(@NotNull OffsetDateTime asOfDate);
	/**
	 ...
	 */
	List<StockTransactionPerDateTypeEntity> findByTransactionType(@NotNull String transactionType);
	/**
	 ...
	 */
	List<StockTransactionPerDateTypeEntity> findByQtyUoi(@NotNull Double qtyUoi);
	...
	@Transactional
	List<StockTransactionPerDateTypeEntity> findAllByIdNotIn(@NotNull Iterable<UUID> ids);

	@Transactional
	List<StockTransactionPerDateTypeEntity> findAllByIdIn(@NotNull Iterable<UUID> ids);
