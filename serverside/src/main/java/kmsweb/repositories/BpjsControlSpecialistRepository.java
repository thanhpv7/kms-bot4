 ...
 */
@Repository
public interface BpjsControlSpecialistRepository extends AbstractRepository<BpjsControlSpecialistEntity> {
	/**
	 ...
	 */
	List<BpjsControlSpecialistEntity> findBySpecialistCode(@NotNull String specialistCode);
	/**
	 ...
	 */
	List<BpjsControlSpecialistEntity> findBySpecialistName(@NotNull String specialistName);
	/**
	 ...
	 */
	List<BpjsControlSpecialistEntity> findByCapacity(@NotNull String capacity);
	/**
	 ...
	 */
	List<BpjsControlSpecialistEntity> findByTotalControlPlanReferral(@NotNull String totalControlPlanReferral);
	/**
	 ...
	 */
	List<BpjsControlSpecialistEntity> findByPercentage(@NotNull String percentage);
	...
	@Transactional
	List<BpjsControlSpecialistEntity> findAllByIdNotIn(@NotNull Iterable<UUID> ids);

	@Transactional
	List<BpjsControlSpecialistEntity> findAllByIdIn(@NotNull Iterable<UUID> ids);
