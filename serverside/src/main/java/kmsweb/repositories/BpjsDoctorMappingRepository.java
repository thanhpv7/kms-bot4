 ...
 */
@Repository
public interface BpjsDoctorMappingRepository extends AbstractRepository<BpjsDoctorMappingEntity> {
	/**
	 ...
	 */
	Optional<BpjsDoctorMappingEntity> findByRefCode(@NotNull String refCode);
	/**
	 ...
	 */
	List<BpjsDoctorMappingEntity> findByBpjsMedicalStaff(@NotNull String bpjsMedicalStaff);
	/**
	 ...
	 */
	List<BpjsDoctorMappingEntity> findByNotes(@NotNull String notes);
	/**
	 ...
	 */
	List<BpjsDoctorMappingEntity> findByRefCodeService(@NotNull String refCodeService);
	...
	@Transactional
	List<BpjsDoctorMappingEntity> findAllByIdNotIn(@NotNull Iterable<UUID> ids);

	@Transactional
	List<BpjsDoctorMappingEntity> findAllByIdIn(@NotNull Iterable<UUID> ids);
