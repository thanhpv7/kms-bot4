 ...
 */
@Repository
public interface BpjsHealthFacilityRepository extends AbstractRepository<BpjsHealthFacilityEntity> {
	/**
	 ...
	 */
	Optional<BpjsHealthFacilityEntity> findByRefCode(@NotNull String refCode);
	/**
	 ...
	 */
	List<BpjsHealthFacilityEntity> findByRefName(@NotNull String refName);
	...
	@Transactional
	List<BpjsHealthFacilityEntity> findAllByIdNotIn(@NotNull Iterable<UUID> ids);

	@Transactional
	List<BpjsHealthFacilityEntity> findAllByIdIn(@NotNull Iterable<UUID> ids);
