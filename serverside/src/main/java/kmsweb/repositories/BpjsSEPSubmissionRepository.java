 ...
 */
@Repository
public interface BpjsSEPSubmissionRepository extends AbstractRepository<BpjsSEPSubmissionEntity> {
	/**
	 ...
	 */
	List<BpjsSEPSubmissionEntity> findByStatus(@NotNull String status);
	/**
	 ...
	 */
	List<BpjsSEPSubmissionEntity> findBySubmissionType(@NotNull String submissionType);
	/**
	 ...
	 */
	List<BpjsSEPSubmissionEntity> findBySepDate(@NotNull String sepDate);
	/**
	 ...
	 */
	List<BpjsSEPSubmissionEntity> findByTreatmentType(@NotNull String treatmentType);
	/**
	 ...
	 */
	List<BpjsSEPSubmissionEntity> findByNotes(@NotNull String notes);
	...
	@Transactional
	List<BpjsSEPSubmissionEntity> findAllByIdNotIn(@NotNull Iterable<UUID> ids);

	@Transactional
	List<BpjsSEPSubmissionEntity> findAllByIdIn(@NotNull Iterable<UUID> ids);
