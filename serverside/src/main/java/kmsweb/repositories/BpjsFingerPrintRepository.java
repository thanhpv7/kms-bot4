 ...
 */
@Repository
public interface BpjsFingerPrintRepository extends AbstractRepository<BpjsFingerPrintEntity> {
	/**
	 ...
	 */
	List<BpjsFingerPrintEntity> findByBpjsCardNo(@NotNull String bpjsCardNo);
	/**
	 ...
	 */
	List<BpjsFingerPrintEntity> findByVisitDate(@NotNull OffsetDateTime visitDate);
	/**
	 ...
	 */
	List<BpjsFingerPrintEntity> findByCode(@NotNull String code);
	/**
	 ...
	 */
	List<BpjsFingerPrintEntity> findByStatus(@NotNull String status);
	...
	@Transactional
	List<BpjsFingerPrintEntity> findAllByIdNotIn(@NotNull Iterable<UUID> ids);

	@Transactional
	List<BpjsFingerPrintEntity> findAllByIdIn(@NotNull Iterable<UUID> ids);
