 ...
 */
@Repository
public interface McuPackageItemRepository extends AbstractRepository<McuPackageItemEntity> {
	/**
	 ...
	 */
	List<McuPackageItemEntity> findByItemCode(@NotNull String itemCode);
	/**
	 ...
	 */
	List<McuPackageItemEntity> findByDuration(@NotNull Integer duration);
	/**
	 ...
	 */
	List<McuPackageItemEntity> findBySequence(@NotNull Integer sequence);
	...
	@Transactional
	List<McuPackageItemEntity> findAllByIdNotIn(@NotNull Iterable<UUID> ids);

	@Transactional
	List<McuPackageItemEntity> findAllByIdIn(@NotNull Iterable<UUID> ids);
