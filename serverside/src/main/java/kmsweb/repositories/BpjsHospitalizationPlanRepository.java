 ...
 */
@Repository
public interface BpjsHospitalizationPlanRepository extends AbstractRepository<BpjsHospitalizationPlanEntity> {
	/**
	 ...
	 */
	List<BpjsHospitalizationPlanEntity> findByNokartu(@NotNull String nokartu);
	/**
	 ...
	 */
	List<BpjsHospitalizationPlanEntity> findByTglrencanakontrol(@NotNull OffsetDateTime tglrencanakontrol);
	/**
	 ...
	 */
	List<BpjsHospitalizationPlanEntity> findByNospri(@NotNull String nospri);
	/**
	 ...
	 */
	List<BpjsHospitalizationPlanEntity> findByDiagnosa(@NotNull String diagnosa);
	...
	@Transactional
	List<BpjsHospitalizationPlanEntity> findAllByIdNotIn(@NotNull Iterable<UUID> ids);

	@Transactional
	List<BpjsHospitalizationPlanEntity> findAllByIdIn(@NotNull Iterable<UUID> ids);
