 ...
 */
@Repository
public interface SupplierContactDetailRepository extends AbstractRepository<SupplierContactDetailEntity> {
	/**
	 ...
	 */
	List<SupplierContactDetailEntity> findByName(@NotNull String name);
	/**
	 ...
	 */
	List<SupplierContactDetailEntity> findByPosition(@NotNull String position);
	/**
	 ...
	 */
	List<SupplierContactDetailEntity> findByPhoneNumber(@NotNull String phoneNumber);
	/**
	 ...
	 */
	List<SupplierContactDetailEntity> findByMobilePhoneNumber(@NotNull String mobilePhoneNumber);
	/**
	 ...
	 */
	List<SupplierContactDetailEntity> findByExt(@NotNull String ext);
	/**
	 ...
	 */
	List<SupplierContactDetailEntity> findByEmail(@NotNull String email);
	...
	@Transactional
	List<SupplierContactDetailEntity> findAllByIdNotIn(@NotNull Iterable<UUID> ids);

	@Transactional
	List<SupplierContactDetailEntity> findAllByIdIn(@NotNull Iterable<UUID> ids);
