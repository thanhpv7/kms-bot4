 ...
 */
@Repository
public interface LibraryRepository extends AbstractRepository<LibraryEntity> {
	/**
	 ...
	 */
	Optional<LibraryEntity> findByLibraryItemCode(@NotNull String libraryItemCode);
	/**
	 ...
	 */
	List<LibraryEntity> findByLibraryItemDescription(@NotNull String libraryItemDescription);
	/**
	 ...
	 */
	List<LibraryEntity> findByClassification(@NotNull String classification);
	/**
	 ...
	 */
	List<LibraryEntity> findByAuthor(@NotNull String author);
	/**
	 ...
	 */
	List<LibraryEntity> findByPublisher(@NotNull String publisher);
	...
	@Transactional
	List<LibraryEntity> findAllByIdNotIn(@NotNull Iterable<UUID> ids);

	@Transactional
	List<LibraryEntity> findAllByIdIn(@NotNull Iterable<UUID> ids);
