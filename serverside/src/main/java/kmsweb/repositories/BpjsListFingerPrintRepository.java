 ...
 */
@Repository
public interface BpjsListFingerPrintRepository extends AbstractRepository<BpjsListFingerPrintEntity> {
	/**
	 ...
	 */
	List<BpjsListFingerPrintEntity> findByBpjsCardNo(@NotNull String bpjsCardNo);
	/**
	 ...
	 */
	List<BpjsListFingerPrintEntity> findByVisitDate(@NotNull OffsetDateTime visitDate);
	/**
	 ...
	 */
	List<BpjsListFingerPrintEntity> findBySepNo(@NotNull String sepNo);
	...
	@Transactional
	List<BpjsListFingerPrintEntity> findAllByIdNotIn(@NotNull Iterable<UUID> ids);

	@Transactional
	List<BpjsListFingerPrintEntity> findAllByIdIn(@NotNull Iterable<UUID> ids);
