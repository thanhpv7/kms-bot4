 ...
 */
public class PatientPaymentBPJSSerializer extends AbstractSerializer<PatientPaymentBPJSEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public PatientPaymentBPJSSerializer() {
		super(PatientPaymentBPJSEntity.class);
	...
	@Override
	public void serialize(PatientPaymentBPJSEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
