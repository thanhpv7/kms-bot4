 ...
 */
public class InventoryAdjustmentSerializer extends AbstractSerializer<InventoryAdjustmentEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public InventoryAdjustmentSerializer() {
		super(InventoryAdjustmentEntity.class);
	...
	@Override
	public void serialize(InventoryAdjustmentEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
		super.serialize(value, gen, provider);

		writeStringField(gen, "adjustmentNumber", value.getAdjustmentNumber());
		...
		writeStringField(gen, "adjustmentType", value.getAdjustmentType());
