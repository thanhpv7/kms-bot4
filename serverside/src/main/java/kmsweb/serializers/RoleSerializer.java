 ...
 */
public class RoleSerializer extends AbstractSerializer<RoleEntity> {
	...
	@Override
	public void serialize(RoleEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
