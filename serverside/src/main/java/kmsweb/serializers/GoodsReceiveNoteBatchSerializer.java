 ...
 */
public class GoodsReceiveNoteBatchSerializer extends AbstractSerializer<GoodsReceiveNoteBatchEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public GoodsReceiveNoteBatchSerializer() {
		super(GoodsReceiveNoteBatchEntity.class);
	...
	@Override
	public void serialize(GoodsReceiveNoteBatchEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
