 ...
 */
public class StockTransactionPerDateSerializer extends AbstractSerializer<StockTransactionPerDateEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public StockTransactionPerDateSerializer() {
		super(StockTransactionPerDateEntity.class);
	...
	@Override
	public void serialize(StockTransactionPerDateEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
