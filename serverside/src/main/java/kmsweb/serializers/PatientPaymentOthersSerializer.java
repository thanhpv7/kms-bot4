 ...
 */
public class PatientPaymentOthersSerializer extends AbstractSerializer<PatientPaymentOthersEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public PatientPaymentOthersSerializer() {
		super(PatientPaymentOthersEntity.class);
	...
	@Override
	public void serialize(PatientPaymentOthersEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
