 ...
 */
public class PatientDetailAddressSerializer extends AbstractSerializer<PatientDetailAddressEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public PatientDetailAddressSerializer() {
		super(PatientDetailAddressEntity.class);
	...
	@Override
	public void serialize(PatientDetailAddressEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
		...
		writeStringField(gen, "rt", value.getRt());
		writeStringField(gen, "rw", value.getRw());
