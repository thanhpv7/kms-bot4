 ...
 */
public class TariffDefinitionSerializer extends AbstractSerializer<TariffDefinitionEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public TariffDefinitionSerializer() {
		super(TariffDefinitionEntity.class);
	...
	@Override
	public void serialize(TariffDefinitionEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
		...
		writeDoubleField(gen, "tariffPrice", value.getTariffPrice());
