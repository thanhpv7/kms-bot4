 ...
 */
public class TariffPackageItemSerializer extends AbstractSerializer<TariffPackageItemEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public TariffPackageItemSerializer() {
		super(TariffPackageItemEntity.class);
	...
	@Override
	public void serialize(TariffPackageItemEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
		...
		writeStringField(gen, "tariffName", value.getTariffName());
		writeDoubleField(gen, "quantity", value.getQuantity());
		writeStringField(gen, "unit", value.getUnit());
		writeBooleanField(gen, "modifiable", value.getModifiable());
