 ...
 */
public class PatientVisitPatientPaymentOthersSerializer extends AbstractSerializer<PatientVisitPatientPaymentOthersEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public PatientVisitPatientPaymentOthersSerializer() {
		super(PatientVisitPatientPaymentOthersEntity.class);
	...
	@Override
	public void serialize(PatientVisitPatientPaymentOthersEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
