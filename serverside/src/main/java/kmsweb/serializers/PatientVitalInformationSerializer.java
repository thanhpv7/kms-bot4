 ...
 */
public class PatientVitalInformationSerializer extends AbstractSerializer<PatientVitalInformationEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public PatientVitalInformationSerializer() {
		super(PatientVitalInformationEntity.class);
	...
	@Override
	public void serialize(PatientVitalInformationEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
		...
		writeDoubleField(gen, "pulse", value.getPulse());
		writeStringField(gen, "pulseRhythm", value.getPulseRhythm());
		writeStringField(gen, "strength", value.getStrength());
		...
		writeStringField(gen, "respiratory", value.getRespiratory());
		...
		writeDoubleField(gen, "painScale", value.getPainScale());
		writeStringField(gen, "painScaleUsed", value.getPainScaleUsed());
		writeDoubleField(gen, "riskFallScale", value.getRiskFallScale());
