 ...
 */
public class BpjsTotalReferralSEPSerializer extends AbstractSerializer<BpjsTotalReferralSEPEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public BpjsTotalReferralSEPSerializer() {
		super(BpjsTotalReferralSEPEntity.class);
	...
	@Override
	public void serialize(BpjsTotalReferralSEPEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
		super.serialize(value, gen, provider);

		writeStringField(gen, "referralType", value.getReferralType());
		writeStringField(gen, "referralNo", value.getReferralNo());
		writeStringField(gen, "totalSEP", value.getTotalSEP());
