 ...
 */
public class BpjsDiagnosePRBSerializer extends AbstractSerializer<BpjsDiagnosePRBEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public BpjsDiagnosePRBSerializer() {
		super(BpjsDiagnosePRBEntity.class);
	...
	@Override
	public void serialize(BpjsDiagnosePRBEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
