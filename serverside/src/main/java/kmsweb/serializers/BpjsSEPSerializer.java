 ...
 */
public class BpjsSEPSerializer extends AbstractSerializer<BpjsSEPEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public BpjsSEPSerializer() {
		super(BpjsSEPEntity.class);
	...
	@Override
	public void serialize(BpjsSEPEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
