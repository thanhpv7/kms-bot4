 ...
 */
public class PurchasingUserSerializer extends UserSerializer<PurchasingUserEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public PurchasingUserSerializer() {
		super(PurchasingUserEntity.class);
	...
	@Override
	public void serialize(PurchasingUserEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
