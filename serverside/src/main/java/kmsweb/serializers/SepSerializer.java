 ...
 */
public class SepSerializer extends AbstractSerializer<SepEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public SepSerializer() {
		super(SepEntity.class);
	...
	@Override
	public void serialize(SepEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
		super.serialize(value, gen, provider);

		writeStringField(gen, "sepData", value.getSepData());
