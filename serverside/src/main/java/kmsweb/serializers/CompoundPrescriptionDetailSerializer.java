 ...
 */
public class CompoundPrescriptionDetailSerializer extends AbstractSerializer<CompoundPrescriptionDetailEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public CompoundPrescriptionDetailSerializer() {
		super(CompoundPrescriptionDetailEntity.class);
	...
	@Override
	public void serialize(CompoundPrescriptionDetailEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
		super.serialize(value, gen, provider);

		writeStringField(gen, "compoundCode", value.getCompoundCode());
		writeStringField(gen, "compoundName", value.getCompoundName());
		writeDoubleField(gen, "requestQuantity", value.getRequestQuantity());
