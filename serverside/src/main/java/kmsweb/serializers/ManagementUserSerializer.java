 ...
 */
public class ManagementUserSerializer extends UserSerializer<ManagementUserEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public ManagementUserSerializer() {
		super(ManagementUserEntity.class);
	...
	@Override
	public void serialize(ManagementUserEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
