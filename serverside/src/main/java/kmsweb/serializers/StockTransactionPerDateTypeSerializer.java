 ...
 */
public class StockTransactionPerDateTypeSerializer extends AbstractSerializer<StockTransactionPerDateTypeEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public StockTransactionPerDateTypeSerializer() {
		super(StockTransactionPerDateTypeEntity.class);
	...
	@Override
	public void serialize(StockTransactionPerDateTypeEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
