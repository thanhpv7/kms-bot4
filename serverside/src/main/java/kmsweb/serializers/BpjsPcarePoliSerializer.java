 ...
 */
public class BpjsPcarePoliSerializer extends AbstractSerializer<BpjsPcarePoliEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public BpjsPcarePoliSerializer() {
		super(BpjsPcarePoliEntity.class);
	...
	@Override
	public void serialize(BpjsPcarePoliEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
		super.serialize(value, gen, provider);

		writeStringField(gen, "kdpoli", value.getKdpoli());
		writeStringField(gen, "nmpoli", value.getNmpoli());
		writeBooleanField(gen, "polisakit", value.getPolisakit());
