 ...
 */
public class BpjsJasaRaharjaClaimSerializer extends AbstractSerializer<BpjsJasaRaharjaClaimEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public BpjsJasaRaharjaClaimSerializer() {
		super(BpjsJasaRaharjaClaimEntity.class);
	...
	@Override
	public void serialize(BpjsJasaRaharjaClaimEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
