 ...
 */
public class InternalOrderSerializer extends AbstractSerializer<InternalOrderEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public InternalOrderSerializer() {
		super(InternalOrderEntity.class);
	...
	@Override
	public void serialize(InternalOrderEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
		super.serialize(value, gen, provider);

		writeStringField(gen, "internalOrderNumber", value.getInternalOrderNumber());
		...
		writeStringField(gen, "requestUnit", value.getRequestUnit());
		writeStringField(gen, "requestPerson", value.getRequestPerson());
		...
		writeOffsetDateTimeField(gen, "issuedDateTime", value.getIssuedDateTime());
		writeOffsetDateTimeField(gen, "receivedDateTime", value.getReceivedDateTime());
