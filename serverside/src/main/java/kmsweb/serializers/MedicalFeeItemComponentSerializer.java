 ...
 */
public class MedicalFeeItemComponentSerializer extends AbstractSerializer<MedicalFeeItemComponentEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public MedicalFeeItemComponentSerializer() {
		super(MedicalFeeItemComponentEntity.class);
	...
	@Override
	public void serialize(MedicalFeeItemComponentEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
