 ...
 */
public class MedicalRecordUserSerializer extends UserSerializer<MedicalRecordUserEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public MedicalRecordUserSerializer() {
		super(MedicalRecordUserEntity.class);
	...
	@Override
	public void serialize(MedicalRecordUserEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
