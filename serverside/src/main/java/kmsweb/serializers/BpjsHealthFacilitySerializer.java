 ...
 */
public class BpjsHealthFacilitySerializer extends AbstractSerializer<BpjsHealthFacilityEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public BpjsHealthFacilitySerializer() {
		super(BpjsHealthFacilityEntity.class);
	...
	@Override
	public void serialize(BpjsHealthFacilityEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
