 ...
 */
public class DiagnosticSupportUserSerializer extends UserSerializer<DiagnosticSupportUserEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public DiagnosticSupportUserSerializer() {
		super(DiagnosticSupportUserEntity.class);
	...
	@Override
	public void serialize(DiagnosticSupportUserEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
