 ...
 */
public class BpjsDiagnoseSerializer extends AbstractSerializer<BpjsDiagnoseEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public BpjsDiagnoseSerializer() {
		super(BpjsDiagnoseEntity.class);
	...
	@Override
	public void serialize(BpjsDiagnoseEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
