 ...
 */
public class MedicalCertificateSickLeaveSerializer extends AbstractSerializer<MedicalCertificateSickLeaveEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public MedicalCertificateSickLeaveSerializer() {
		super(MedicalCertificateSickLeaveEntity.class);
	...
	@Override
	public void serialize(MedicalCertificateSickLeaveEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
