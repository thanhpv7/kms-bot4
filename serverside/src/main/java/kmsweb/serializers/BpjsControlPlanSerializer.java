 ...
 */
public class BpjsControlPlanSerializer extends AbstractSerializer<BpjsControlPlanEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public BpjsControlPlanSerializer() {
		super(BpjsControlPlanEntity.class);
	...
	@Override
	public void serialize(BpjsControlPlanEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
		...
		writeStringField(gen, "polyclinicCode", value.getPolyclinicCode());
