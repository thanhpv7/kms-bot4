 ...
 */
public class RegistrationUserSerializer extends UserSerializer<RegistrationUserEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public RegistrationUserSerializer() {
		super(RegistrationUserEntity.class);
	...
	@Override
	public void serialize(RegistrationUserEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
