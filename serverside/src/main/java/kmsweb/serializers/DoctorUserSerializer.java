 ...
 */
public class DoctorUserSerializer extends UserSerializer<DoctorUserEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public DoctorUserSerializer() {
		super(DoctorUserEntity.class);
	...
	@Override
	public void serialize(DoctorUserEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
