 ...
 */
public class ClaimUserSerializer extends UserSerializer<ClaimUserEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public ClaimUserSerializer() {
		super(ClaimUserEntity.class);
	...
	@Override
	public void serialize(ClaimUserEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
