 ...
 */
public class MedicationCompoundSerializer extends AbstractSerializer<MedicationCompoundEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public MedicationCompoundSerializer() {
		super(MedicationCompoundEntity.class);
	...
	@Override
	public void serialize(MedicationCompoundEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
