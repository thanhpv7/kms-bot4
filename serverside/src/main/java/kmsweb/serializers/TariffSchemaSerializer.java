 ...
 */
public class TariffSchemaSerializer extends AbstractSerializer<TariffSchemaEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public TariffSchemaSerializer() {
		super(TariffSchemaEntity.class);
	...
	@Override
	public void serialize(TariffSchemaEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
		super.serialize(value, gen, provider);

		writeStringField(gen, "schemaCode", value.getSchemaCode());
		writeStringField(gen, "schemeName", value.getSchemeName());
