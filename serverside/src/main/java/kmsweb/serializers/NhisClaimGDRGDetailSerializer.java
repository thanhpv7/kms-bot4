 ...
 */
public class NhisClaimGDRGDetailSerializer extends AbstractSerializer<NhisClaimGDRGDetailEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public NhisClaimGDRGDetailSerializer() {
		super(NhisClaimGDRGDetailEntity.class);
	...
	@Override
	public void serialize(NhisClaimGDRGDetailEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
