 ...
 */
public class BpjsPcareProviderRayonisasiSerializer extends AbstractSerializer<BpjsPcareProviderRayonisasiEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public BpjsPcareProviderRayonisasiSerializer() {
		super(BpjsPcareProviderRayonisasiEntity.class);
	...
	@Override
	public void serialize(BpjsPcareProviderRayonisasiEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
