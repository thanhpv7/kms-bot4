 ...
 */
public class PatientGeneralInfoSerializer extends AbstractSerializer<PatientGeneralInfoEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public PatientGeneralInfoSerializer() {
		super(PatientGeneralInfoEntity.class);
	...
	@Override
	public void serialize(PatientGeneralInfoEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
		...
		writeStringField(gen, "importantNotes", value.getImportantNotes());
		writeBooleanField(gen, "hasOutstandingPayment", value.getHasOutstandingPayment());
