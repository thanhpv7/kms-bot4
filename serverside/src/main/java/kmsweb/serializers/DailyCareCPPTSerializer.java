 ...
 */
public class DailyCareCPPTSerializer extends AbstractSerializer<DailyCareCPPTEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public DailyCareCPPTSerializer() {
		super(DailyCareCPPTEntity.class);
	...
	@Override
	public void serialize(DailyCareCPPTEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
		...
		writeOffsetDateTimeField(gen, "verifiedDate", value.getVerifiedDate());
		writeStringField(gen, "verifiedBy", value.getVerifiedBy());
		writeOffsetDateTimeField(gen, "canceledDate", value.getCanceledDate());
		writeStringField(gen, "canceledBy", value.getCanceledBy());
		writeStringField(gen, "status", value.getStatus());
		writeOffsetDateTimeField(gen, "cpptDateTime", value.getCpptDateTime());
