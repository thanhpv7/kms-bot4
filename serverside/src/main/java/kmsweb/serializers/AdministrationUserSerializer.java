 ...
 */
public class AdministrationUserSerializer extends UserSerializer<AdministrationUserEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public AdministrationUserSerializer() {
		super(AdministrationUserEntity.class);
	...
	@Override
	public void serialize(AdministrationUserEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
