 ...
 */
public class AdministratorSerializer extends UserSerializer<AdministratorEntity> {
	...
	@Override
	public void serialize(AdministratorEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
