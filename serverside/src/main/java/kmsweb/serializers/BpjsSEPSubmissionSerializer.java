 ...
 */
public class BpjsSEPSubmissionSerializer extends AbstractSerializer<BpjsSEPSubmissionEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public BpjsSEPSubmissionSerializer() {
		super(BpjsSEPSubmissionEntity.class);
	...
	@Override
	public void serialize(BpjsSEPSubmissionEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
		super.serialize(value, gen, provider);

		writeStringField(gen, "status", value.getStatus());
		writeStringField(gen, "submissionType", value.getSubmissionType());
