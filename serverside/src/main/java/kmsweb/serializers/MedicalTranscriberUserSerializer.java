 ...
 */
public class MedicalTranscriberUserSerializer extends UserSerializer<MedicalTranscriberUserEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public MedicalTranscriberUserSerializer() {
		super(MedicalTranscriberUserEntity.class);
	...
	@Override
	public void serialize(MedicalTranscriberUserEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
