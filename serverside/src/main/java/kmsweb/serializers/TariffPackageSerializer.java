 ...
 */
public class TariffPackageSerializer extends AbstractSerializer<TariffPackageEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public TariffPackageSerializer() {
		super(TariffPackageEntity.class);
	...
	@Override
	public void serialize(TariffPackageEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
		super.serialize(value, gen, provider);

		writeStringField(gen, "tariffPackageCode", value.getTariffPackageCode());
		writeStringField(gen, "tariffPackageName", value.getTariffPackageName());
