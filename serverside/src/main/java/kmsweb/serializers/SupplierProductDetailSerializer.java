 ...
 */
public class SupplierProductDetailSerializer extends AbstractSerializer<SupplierProductDetailEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public SupplierProductDetailSerializer() {
		super(SupplierProductDetailEntity.class);
	...
	@Override
	public void serialize(SupplierProductDetailEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
		super.serialize(value, gen, provider);

		writeStringField(gen, "unitCode", value.getUnitCode());
