 ...
 */
public class MerchantSurchargeAndFeeSerializer extends AbstractSerializer<MerchantSurchargeAndFeeEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public MerchantSurchargeAndFeeSerializer() {
		super(MerchantSurchargeAndFeeEntity.class);
	...
	@Override
	public void serialize(MerchantSurchargeAndFeeEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
		super.serialize(value, gen, provider);

		writeStringField(gen, "bankName", value.getBankName());
		writeStringField(gen, "cardType", value.getCardType());
		writeDoubleField(gen, "surcharge", value.getSurcharge());
		writeStringField(gen, "fee", value.getFee());
