 ...
 */
public class TransactionDetailTypeMappingSerializer extends AbstractSerializer<TransactionDetailTypeMappingEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public TransactionDetailTypeMappingSerializer() {
		super(TransactionDetailTypeMappingEntity.class);
	...
	@Override
	public void serialize(TransactionDetailTypeMappingEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
