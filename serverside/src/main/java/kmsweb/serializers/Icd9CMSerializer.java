 ...
 */
public class Icd9CMSerializer extends AbstractSerializer<Icd9CMEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public Icd9CMSerializer() {
		super(Icd9CMEntity.class);
	...
	@Override
	public void serialize(Icd9CMEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
		super.serialize(value, gen, provider);

		writeBooleanField(gen, "topProcedure", value.getTopProcedure());
