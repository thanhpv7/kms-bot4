 ...
 */
public class WarehouseSerializer extends AbstractSerializer<WarehouseEntity> {
	...
	@Override
	public void serialize(WarehouseEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
		super.serialize(value, gen, provider);

		writeStringField(gen, "warehouseNumber", value.getWarehouseNumber());
		writeStringField(gen, "warehouseName", value.getWarehouseName());
		...
		writeStringField(gen, "ext", value.getExt());
