 ...
 */
public class BpjsSearchSEPSerializer extends AbstractSerializer<BpjsSearchSEPEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public BpjsSearchSEPSerializer() {
		super(BpjsSearchSEPEntity.class);
	...
	@Override
	public void serialize(BpjsSearchSEPEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
