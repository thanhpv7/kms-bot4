 ...
 */
public class InvoicePaymentOtherSerializer extends AbstractSerializer<InvoicePaymentOtherEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public InvoicePaymentOtherSerializer() {
		super(InvoicePaymentOtherEntity.class);
	...
	@Override
	public void serialize(InvoicePaymentOtherEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
