 ...
 */
public class CashierUserSerializer extends UserSerializer<CashierUserEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public CashierUserSerializer() {
		super(CashierUserEntity.class);
	...
	@Override
	public void serialize(CashierUserEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
