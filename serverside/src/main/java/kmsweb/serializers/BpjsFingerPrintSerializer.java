 ...
 */
public class BpjsFingerPrintSerializer extends AbstractSerializer<BpjsFingerPrintEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public BpjsFingerPrintSerializer() {
		super(BpjsFingerPrintEntity.class);
	...
	@Override
	public void serialize(BpjsFingerPrintEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
