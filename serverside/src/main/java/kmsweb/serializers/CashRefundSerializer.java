 ...
 */
public class CashRefundSerializer extends AbstractSerializer<CashRefundEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public CashRefundSerializer() {
		super(CashRefundEntity.class);
	...
	@Override
	public void serialize(CashRefundEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
		super.serialize(value, gen, provider);

		writeStringField(gen, "refundNumber", value.getRefundNumber());
		writeOffsetDateTimeField(gen, "refundDate", value.getRefundDate());
		...
		writeDoubleField(gen, "refundAmount", value.getRefundAmount());
