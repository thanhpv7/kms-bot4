 ...
 */
public class InventoryBatchCorrectionSerializer extends AbstractSerializer<InventoryBatchCorrectionEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public InventoryBatchCorrectionSerializer() {
		super(InventoryBatchCorrectionEntity.class);
	...
	@Override
	public void serialize(InventoryBatchCorrectionEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
		super.serialize(value, gen, provider);

		writeStringField(gen, "batchCorrectionNumber", value.getBatchCorrectionNumber());
		...
		if (value.getTransactionType() != null) {
			writeStringField(gen, "transactionType", value.getTransactionType().toString());
		}
