 ...
 */
public class MedicalCertificateRestrictedWorkSerializer extends AbstractSerializer<MedicalCertificateRestrictedWorkEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public MedicalCertificateRestrictedWorkSerializer() {
		super(MedicalCertificateRestrictedWorkEntity.class);
	...
	@Override
	public void serialize(MedicalCertificateRestrictedWorkEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
		super.serialize(value, gen, provider);

		writeIntegerField(gen, "period", value.getPeriod());
