 ...
 */
public class RoomTransferSerializer extends AbstractSerializer<RoomTransferEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public RoomTransferSerializer() {
		super(RoomTransferEntity.class);
	...
	@Override
	public void serialize(RoomTransferEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
		...
		writeStringField(gen, "transferringStaffName", value.getTransferringStaffName());
