 ...
 */
public class CompoundPrescriptionItemSerializer extends AbstractSerializer<CompoundPrescriptionItemEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public CompoundPrescriptionItemSerializer() {
		super(CompoundPrescriptionItemEntity.class);
	...
	@Override
	public void serialize(CompoundPrescriptionItemEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
