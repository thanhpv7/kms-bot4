 ...
 */
public class DiagnosesAndProceduresSerializer extends AbstractSerializer<DiagnosesAndProceduresEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public DiagnosesAndProceduresSerializer() {
		super(DiagnosesAndProceduresEntity.class);
	...
	@Override
	public void serialize(DiagnosesAndProceduresEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
		super.serialize(value, gen, provider);

		writeStringField(gen, "itemType", value.getItemType());
