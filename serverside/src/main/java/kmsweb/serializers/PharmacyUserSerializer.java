 ...
 */
public class PharmacyUserSerializer extends UserSerializer<PharmacyUserEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public PharmacyUserSerializer() {
		super(PharmacyUserEntity.class);
	...
	@Override
	public void serialize(PharmacyUserEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
