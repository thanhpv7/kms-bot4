 ...
 */
public class BpjsUpdateDismissalDateSerializer extends AbstractSerializer<BpjsUpdateDismissalDateEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public BpjsUpdateDismissalDateSerializer() {
		super(BpjsUpdateDismissalDateEntity.class);
	...
	@Override
	public void serialize(BpjsUpdateDismissalDateEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
		super.serialize(value, gen, provider);

		writeStringField(gen, "sepNo", value.getSepNo());
		writeStringField(gen, "dismissalType", value.getDismissalType());
		writeStringField(gen, "deathCertificateLetterNo", value.getDeathCertificateLetterNo());
		...
		writeStringField(gen, "policeReportNo", value.getPoliceReportNo());
