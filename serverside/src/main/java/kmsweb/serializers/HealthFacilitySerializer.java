 ...
 */
public class HealthFacilitySerializer extends AbstractSerializer<HealthFacilityEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public HealthFacilitySerializer() {
		super(HealthFacilityEntity.class);
	...
	@Override
	public void serialize(HealthFacilityEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
		super.serialize(value, gen, provider);

		writeStringField(gen, "healthFacilityID", value.getHealthFacilityID());
		...
		writeStringField(gen, "province", value.getProvince());
		...
		writeStringField(gen, "salutation", value.getSalutation());
		writeStringField(gen, "firstName", value.getFirstName());
		writeStringField(gen, "lastName", value.getLastName());
		writeStringField(gen, "phoneNumberPOC", value.getPhoneNumberPOC());
		writeStringField(gen, "mobilePhoneNumberPOC", value.getMobilePhoneNumberPOC());
		writeStringField(gen, "emailPOC", value.getEmailPOC());
		writeStringField(gen, "healthFacilityType", value.getHealthFacilityType());
