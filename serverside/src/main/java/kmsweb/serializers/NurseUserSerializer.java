 ...
 */
public class NurseUserSerializer extends UserSerializer<NurseUserEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public NurseUserSerializer() {
		super(NurseUserEntity.class);
	...
	@Override
	public void serialize(NurseUserEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
