 ...
 */
public class BpjsVisitDataSerializer extends AbstractSerializer<BpjsVisitDataEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public BpjsVisitDataSerializer() {
		super(BpjsVisitDataEntity.class);
	...
	@Override
	public void serialize(BpjsVisitDataEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
		...
		writeStringField(gen, "sepDismissalDate", value.getSepDismissalDate());
