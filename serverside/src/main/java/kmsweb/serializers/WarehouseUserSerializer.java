 ...
 */
public class WarehouseUserSerializer extends UserSerializer<WarehouseUserEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public WarehouseUserSerializer() {
		super(WarehouseUserEntity.class);
	...
	@Override
	public void serialize(WarehouseUserEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
