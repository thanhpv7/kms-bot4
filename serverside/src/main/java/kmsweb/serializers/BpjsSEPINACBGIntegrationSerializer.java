 ...
 */
public class BpjsSEPINACBGIntegrationSerializer extends AbstractSerializer<BpjsSEPINACBGIntegrationEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public BpjsSEPINACBGIntegrationSerializer() {
		super(BpjsSEPINACBGIntegrationEntity.class);
	...
	@Override
	public void serialize(BpjsSEPINACBGIntegrationEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
		...
		writeStringField(gen, "visitDate", value.getVisitDate());
