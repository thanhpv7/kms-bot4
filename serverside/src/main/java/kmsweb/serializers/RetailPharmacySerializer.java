 ...
 */
public class RetailPharmacySerializer extends AbstractSerializer<RetailPharmacyEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public RetailPharmacySerializer() {
		super(RetailPharmacyEntity.class);
	...
	@Override
	public void serialize(RetailPharmacyEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
		super.serialize(value, gen, provider);

		writeStringField(gen, "customerType", value.getCustomerType());
		writeStringField(gen, "retailNumber", value.getRetailNumber());
