 ...
 */
public class BpjsINACBGSerializer extends AbstractSerializer<BpjsINACBGEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public BpjsINACBGSerializer() {
		super(BpjsINACBGEntity.class);
	...
	@Override
	public void serialize(BpjsINACBGEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
		...
		writeStringField(gen, "cityRegency", value.getCityRegency());
		writeStringField(gen, "regional", value.getRegional());
		writeStringField(gen, "hospitalClass", value.getHospitalClass());
		writeStringField(gen, "inacbgTariff1", value.getInacbgTariff1());
		writeStringField(gen, "inacbgTariff2", value.getInacbgTariff2());
		writeStringField(gen, "additionalUpgradeVIP", value.getAdditionalUpgradeVIP());
		writeStringField(gen, "payplanID", value.getPayplanID());
		writeStringField(gen, "paymentPlanCode", value.getPaymentPlanCode());
		...
		writeStringField(gen, "password", value.getPassword());
		writeStringField(gen, "secretKey", value.getSecretKey());
		writeStringField(gen, "coderID", value.getCoderID());
