 ...
 */
public class PatientSupportingDocumentSerializer extends AbstractSerializer<PatientSupportingDocumentEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public PatientSupportingDocumentSerializer() {
		super(PatientSupportingDocumentEntity.class);
	...
	@Override
	public void serialize(PatientSupportingDocumentEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
		super.serialize(value, gen, provider);

		writeStringField(gen, "fileName", value.getFileName());
