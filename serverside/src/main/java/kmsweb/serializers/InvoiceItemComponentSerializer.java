 ...
 */
public class InvoiceItemComponentSerializer extends AbstractSerializer<InvoiceItemComponentEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public InvoiceItemComponentSerializer() {
		super(InvoiceItemComponentEntity.class);
	...
	@Override
	public void serialize(InvoiceItemComponentEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
