 ...
 */
public class BpjsListFingerPrintSerializer extends AbstractSerializer<BpjsListFingerPrintEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public BpjsListFingerPrintSerializer() {
		super(BpjsListFingerPrintEntity.class);
	...
	@Override
	public void serialize(BpjsListFingerPrintEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
