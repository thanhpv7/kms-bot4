 ...
 */
public class BpjsTreatmentRoomSerializer extends AbstractSerializer<BpjsTreatmentRoomEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public BpjsTreatmentRoomSerializer() {
		super(BpjsTreatmentRoomEntity.class);
	...
	@Override
	public void serialize(BpjsTreatmentRoomEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
		super.serialize(value, gen, provider);

		writeStringField(gen, "kode", value.getKode());
