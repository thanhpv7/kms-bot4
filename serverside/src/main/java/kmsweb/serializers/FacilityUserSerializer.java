 ...
 */
public class FacilityUserSerializer extends UserSerializer<FacilityUserEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public FacilityUserSerializer() {
		super(FacilityUserEntity.class);
	...
	@Override
	public void serialize(FacilityUserEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
