 ...
 */
public class SystemAdminUserSerializer extends UserSerializer<SystemAdminUserEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public SystemAdminUserSerializer() {
		super(SystemAdminUserEntity.class);
	...
	@Override
	public void serialize(SystemAdminUserEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
