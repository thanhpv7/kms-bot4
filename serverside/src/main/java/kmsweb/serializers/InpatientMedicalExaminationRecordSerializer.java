 ...
 */
public class InpatientMedicalExaminationRecordSerializer extends AbstractSerializer<InpatientMedicalExaminationRecordEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public InpatientMedicalExaminationRecordSerializer() {
		super(InpatientMedicalExaminationRecordEntity.class);
	...
	@Override
	public void serialize(InpatientMedicalExaminationRecordEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
		...
		writeStringField(gen, "inpatientCase", value.getInpatientCase());
		writeStringField(gen, "serviceCase", value.getServiceCase());
		writeStringField(gen, "dependencyLevel", value.getDependencyLevel());
		writeStringField(gen, "currentDependency", value.getCurrentDependency());
		writeStringField(gen, "infantCondition", value.getInfantCondition());
