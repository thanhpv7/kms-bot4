 ...
 */
public class BpjsTreatmentHistorySerializer extends AbstractSerializer<BpjsTreatmentHistoryEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public BpjsTreatmentHistorySerializer() {
		super(BpjsTreatmentHistoryEntity.class);
	...
	@Override
	public void serialize(BpjsTreatmentHistoryEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
		...
		writeStringField(gen, "healthFacility", value.getHealthFacility());
