 ...
 */
public class MedicalRecordNextVerificationChecklistSerializer extends AbstractSerializer<MedicalRecordNextVerificationChecklistEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public MedicalRecordNextVerificationChecklistSerializer() {
		super(MedicalRecordNextVerificationChecklistEntity.class);
	...
	@Override
	public void serialize(MedicalRecordNextVerificationChecklistEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
