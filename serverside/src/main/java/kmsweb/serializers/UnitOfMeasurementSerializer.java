 ...
 */
public class UnitOfMeasurementSerializer extends AbstractSerializer<UnitOfMeasurementEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public UnitOfMeasurementSerializer() {
		super(UnitOfMeasurementEntity.class);
	...
	@Override
	public void serialize(UnitOfMeasurementEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
		...
		writeStringField(gen, "unitCategory", value.getUnitCategory());
		writeBooleanField(gen, "consumptionUnit", value.getConsumptionUnit());
