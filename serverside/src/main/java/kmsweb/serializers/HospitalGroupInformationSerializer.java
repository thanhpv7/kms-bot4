 ...
 */
public class HospitalGroupInformationSerializer extends AbstractSerializer<HospitalGroupInformationEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public HospitalGroupInformationSerializer() {
		super(HospitalGroupInformationEntity.class);
	...
	@Override
	public void serialize(HospitalGroupInformationEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
		super.serialize(value, gen, provider);

		writeStringField(gen, "hospitalGroupCode", value.getHospitalGroupCode());
		writeStringField(gen, "hospitalGroupName", value.getHospitalGroupName());
		writeStringField(gen, "hospitalGroupCorporationName", value.getHospitalGroupCorporationName());
		writeStringField(gen, "hospitalGroupDirector", value.getHospitalGroupDirector());
		writeStringField(gen, "operationalLicenseNo", value.getOperationalLicenseNo());
		writeStringField(gen, "hospitalGroupCorporationStatus", value.getHospitalGroupCorporationStatus());
