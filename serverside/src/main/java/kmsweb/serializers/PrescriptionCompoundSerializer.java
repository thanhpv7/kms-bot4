 ...
 */
public class PrescriptionCompoundSerializer extends AbstractSerializer<PrescriptionCompoundEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public PrescriptionCompoundSerializer() {
		super(PrescriptionCompoundEntity.class);
	...
	@Override
	public void serialize(PrescriptionCompoundEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
		...
		writeStringField(gen, "externalCompoundName", value.getExternalCompoundName());
