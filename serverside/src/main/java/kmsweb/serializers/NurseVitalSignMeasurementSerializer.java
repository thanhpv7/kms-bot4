 ...
 */
public class NurseVitalSignMeasurementSerializer extends AbstractSerializer<NurseVitalSignMeasurementEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public NurseVitalSignMeasurementSerializer() {
		super(NurseVitalSignMeasurementEntity.class);
	...
	@Override
	public void serialize(NurseVitalSignMeasurementEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
