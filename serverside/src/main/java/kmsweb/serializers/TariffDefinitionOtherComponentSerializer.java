 ...
 */
public class TariffDefinitionOtherComponentSerializer extends AbstractSerializer<TariffDefinitionOtherComponentEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public TariffDefinitionOtherComponentSerializer() {
		super(TariffDefinitionOtherComponentEntity.class);
	...
	@Override
	public void serialize(TariffDefinitionOtherComponentEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
