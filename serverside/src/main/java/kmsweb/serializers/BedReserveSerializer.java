 ...
 */
public class BedReserveSerializer extends AbstractSerializer<BedReserveEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public BedReserveSerializer() {
		super(BedReserveEntity.class);
	...
	@Override
	public void serialize(BedReserveEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
