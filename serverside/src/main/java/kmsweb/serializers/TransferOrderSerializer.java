 ...
 */
public class TransferOrderSerializer extends AbstractSerializer<TransferOrderEntity> {

	// % protected region % [Add any additional class fields here] off begin
	// % protected region % [Add any additional class fields here] end

	public TransferOrderSerializer() {
		super(TransferOrderEntity.class);
	...
	@Override
	public void serialize(TransferOrderEntity value, JsonGenerator gen, SerializerProvider provider) throws IOException {
		super.serialize(value, gen, provider);

		writeStringField(gen, "transferOrderNumber", value.getTransferOrderNumber());
