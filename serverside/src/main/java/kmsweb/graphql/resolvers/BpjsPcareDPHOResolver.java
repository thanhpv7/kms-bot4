...
@Component
public class BpjsPcareDPHOResolver implements GraphQLResolver<BpjsPcareDPHOEntity> {
	...
	public StockCatalogueEntity stockCatalogue(BpjsPcareDPHOEntity bpjsPcareDPHO) {
		return bpjsPcareDPHO.getStockCatalogue();
	}
