...
@Component
public class RoleResolver implements GraphQLResolver<RoleEntity> {
	...
	public Set<PrivilegeEntity> privileges(RoleEntity role) {
		return role.getPrivileges();
	}

	@PreAuthorize("hasPermission('UserEntity', 'read')")
	public Set<UserEntity> users(RoleEntity role) {
