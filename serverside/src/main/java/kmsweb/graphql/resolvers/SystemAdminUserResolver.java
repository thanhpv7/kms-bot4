...
@Component
public class SystemAdminUserResolver implements GraphQLResolver<SystemAdminUserEntity> {
	...
	public StaffEntity staff(SystemAdminUserEntity systemAdminUser) {
		return systemAdminUser.getStaff();
	}
