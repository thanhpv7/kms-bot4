...
@Component
public class ManagementUserResolver implements GraphQLResolver<ManagementUserEntity> {
	...
	public StaffEntity staff(ManagementUserEntity managementUser) {
		return managementUser.getStaff();
	}
