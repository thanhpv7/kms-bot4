...
@Component
public class BirthHistoryResolver implements GraphQLResolver<BirthHistoryEntity> {
	...
	public MedicalExaminationRecordEntity medicalExaminationRecord(BirthHistoryEntity birthHistory) {
		return birthHistory.getMedicalExaminationRecord();
	}
