...
@Component
public class BpjsVisitDataResolver implements GraphQLResolver<BpjsVisitDataEntity> {
	...
	public PatientVisitEntity patientVisit(BpjsVisitDataEntity bpjsVisitData) {
		return bpjsVisitData.getPatientVisit();
	}
