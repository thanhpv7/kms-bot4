...
@Component
public class WarehouseUserResolver implements GraphQLResolver<WarehouseUserEntity> {
	...
	public StaffEntity staff(WarehouseUserEntity warehouseUser) {
		return warehouseUser.getStaff();
	}
