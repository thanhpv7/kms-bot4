...
@Component
public class MedicalRecordUserResolver implements GraphQLResolver<MedicalRecordUserEntity> {
	...
	public StaffEntity staff(MedicalRecordUserEntity medicalRecordUser) {
		return medicalRecordUser.getStaff();
	}
