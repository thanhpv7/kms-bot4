...
@Component
public class RegistrationUserResolver implements GraphQLResolver<RegistrationUserEntity> {
	...
	public StaffEntity staff(RegistrationUserEntity registrationUser) {
		return registrationUser.getStaff();
	}
