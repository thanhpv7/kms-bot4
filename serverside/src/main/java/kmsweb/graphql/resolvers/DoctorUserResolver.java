...
@Component
public class DoctorUserResolver implements GraphQLResolver<DoctorUserEntity> {
	...
	public StaffEntity staff(DoctorUserEntity doctorUser) {
		return doctorUser.getStaff();
	}
