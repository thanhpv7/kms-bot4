...
@Component
public class VitalSignsResolver implements GraphQLResolver<VitalSignsEntity> {
	...
	public NewbornDetailEntity newbornDetail(VitalSignsEntity vitalSigns) {
		return vitalSigns.getNewbornDetail();
	}
