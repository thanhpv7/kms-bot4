...
@Component
public class FacilityUserResolver implements GraphQLResolver<FacilityUserEntity> {
	...
	public StaffEntity staff(FacilityUserEntity facilityUser) {
		return facilityUser.getStaff();
	}
