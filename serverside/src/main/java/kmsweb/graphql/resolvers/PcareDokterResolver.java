...
@Component
public class PcareDokterResolver implements GraphQLResolver<PcareDokterEntity> {
	...
	public StaffEntity staff(PcareDokterEntity pcareDokter) {
		return pcareDokter.getStaff();
	}
