...
@Component
public class Icd9CMResolver implements GraphQLResolver<Icd9CMEntity> {
	...
	public DiagnosesAndProceduresEntity diagnosesAndProcedures(Icd9CMEntity icd9CM) {
		return icd9CM.getDiagnosesAndProcedures();
	}
