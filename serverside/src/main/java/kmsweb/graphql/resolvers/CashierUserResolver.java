...
@Component
public class CashierUserResolver implements GraphQLResolver<CashierUserEntity> {
	...
	public StaffEntity staff(CashierUserEntity cashierUser) {
		return cashierUser.getStaff();
	}
