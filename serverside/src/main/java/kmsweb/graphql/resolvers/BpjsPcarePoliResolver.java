...
@Component
public class BpjsPcarePoliResolver implements GraphQLResolver<BpjsPcarePoliEntity> {
	...
	public ServiceEntity service(BpjsPcarePoliEntity bpjsPcarePoli) {
		return bpjsPcarePoli.getService();
	}
