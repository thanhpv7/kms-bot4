...
@Component
public class AdministratorResolver implements GraphQLResolver<AdministratorEntity> {
	...
	public StaffEntity staff(AdministratorEntity administrator) {
		return administrator.getStaff();
	}
