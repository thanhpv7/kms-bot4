...
@Slf4j
@Component
public class DiagnosisExaminationRecordMutationResolver implements GraphQLMutationResolver {
	...
	@Autowired
	public DiagnosisExaminationRecordMutationResolver(
	...
	public DiagnosisExaminationRecordEntity createDiagnosisExaminationRecord(@NonNull DiagnosisExaminationRecordEntity rawEntity, Boolean persistRelations) {
		...
		DiagnosisExaminationRecordEntity newEntity = diagnosisExaminationRecordService.create(rawEntity, persistRelations);
	...
	/**
	 * Similar to {@link DiagnosisExaminationRecordMutationResolver#createDiagnosisExaminationRecord(DiagnosisExaminationRecordEntity, Boolean)}
	 * but with multiple entities at once.
	 */
	@PreAuthorize("hasPermission('DiagnosisExaminationRecordEntity', 'create')")
	public List<DiagnosisExaminationRecordEntity> createAllDiagnosisExaminationRecord(@NonNull List<DiagnosisExaminationRecordEntity> rawEntities) {
		List<DiagnosisExaminationRecordEntity> newEntities = Lists.newArrayList(diagnosisExaminationRecordService.createAll(rawEntities));
	...
	public DiagnosisExaminationRecordEntity updateDiagnosisExaminationRecord(@NonNull DiagnosisExaminationRecordEntity rawEntity, Boolean persistRelations) {
		if (persistRelations == null) {
			persistRelations = false;
		}
		...
		DiagnosisExaminationRecordEntity entityFromDb = diagnosisExaminationRecordService.findById(rawEntity.getId()).orElseThrow();
		rawEntity.setCreatedBy(entityFromDb.getCreatedBy());
		DiagnosisExaminationRecordEntity newEntity = diagnosisExaminationRecordService.update(rawEntity, persistRelations);
	...
	/**
	 * Similar to {@link DiagnosisExaminationRecordMutationResolver#updateDiagnosisExaminationRecord(DiagnosisExaminationRecordEntity, Boolean)}
	 * but with multiple entities at once.
	 */
	@PreAuthorize("hasPermission('DiagnosisExaminationRecordEntity', 'update')")
	public List<DiagnosisExaminationRecordEntity> updateAllDiagnosisExaminationRecord(@NonNull List<DiagnosisExaminationRecordEntity> rawEntities) {
		List<DiagnosisExaminationRecordEntity> newEntities = Lists.newArrayList(diagnosisExaminationRecordService.updateAll(rawEntities));
	...
	public String deleteDiagnosisExaminationRecordById(@NonNull String id) {
		diagnosisExaminationRecordService.deleteById(UUID.fromString(id));
	...
	/**
	 * Similar to {@link DiagnosisExaminationRecordMutationResolver#deleteDiagnosisExaminationRecordById(String)}
	 * but with multiple entities at once.
	 */
	@PreAuthorize("hasPermission('DiagnosisExaminationRecordEntity', 'delete')")
	public List<String> deleteAllDiagnosisExaminationRecordByIds(@NonNull List<String> ids) {
		diagnosisExaminationRecordService.deleteAllByIds(ids.stream().map(UUID::fromString).collect(Collectors.toList()));
	...
	@PreAuthorize("hasPermission('DiagnosisExaminationRecordEntity', 'delete')")
	public List<String> deleteDiagnosisExaminationRecordExcludingIds(@NonNull List<String> ids) {
		diagnosisExaminationRecordService.deleteAllExcludingIds(ids.stream().map(UUID::fromString).collect(Collectors.toList()));
