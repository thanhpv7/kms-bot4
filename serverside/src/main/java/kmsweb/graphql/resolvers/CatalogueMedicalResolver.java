...
@Component
public class CatalogueMedicalResolver implements GraphQLResolver<CatalogueMedicalEntity> {
	...
	public StockCatalogueEntity stockCatalogue(CatalogueMedicalEntity catalogueMedical) {
		return catalogueMedical.getStockCatalogue();
	}
