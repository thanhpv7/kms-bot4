...
@Component
public class ProcessWorkflowResolver implements GraphQLResolver<ProcessWorkflowEntity> {
	...
	public StaffEntity staff(ProcessWorkflowEntity processWorkflow) {
		return processWorkflow.getStaff();
	}
