...
@Component
public class PurchasingUserResolver implements GraphQLResolver<PurchasingUserEntity> {
	...
	public StaffEntity staff(PurchasingUserEntity purchasingUser) {
		return purchasingUser.getStaff();
	}
