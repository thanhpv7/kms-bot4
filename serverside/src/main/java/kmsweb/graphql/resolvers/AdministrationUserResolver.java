...
@Component
public class AdministrationUserResolver implements GraphQLResolver<AdministrationUserEntity> {
	...
	public StaffEntity staff(AdministrationUserEntity administrationUser) {
		return administrationUser.getStaff();
	}
