...
@Component
public class Icd10Resolver implements GraphQLResolver<Icd10Entity> {
	...
	public DiagnosesAndProceduresEntity diagnosesAndProcedures(Icd10Entity icd10) {
		return icd10.getDiagnosesAndProcedures();
	}
