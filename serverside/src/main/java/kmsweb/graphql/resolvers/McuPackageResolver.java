...
@Component
public class McuPackageResolver implements GraphQLResolver<McuPackageEntity> {
	...
	public Set<McuPackageItemEntity> mcuPackageItems(McuPackageEntity mcuPackage) {
		return mcuPackage.getMcuPackageItems();
	}
