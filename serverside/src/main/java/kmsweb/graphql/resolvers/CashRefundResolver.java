...
@Component
public class CashRefundResolver implements GraphQLResolver<CashRefundEntity> {
	...
	public PatientGeneralInfoEntity patientGeneralInfo(CashRefundEntity cashRefund) {
		return cashRefund.getPatientGeneralInfo();
	}
