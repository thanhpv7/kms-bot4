...
@Component
public class PharmacyUserResolver implements GraphQLResolver<PharmacyUserEntity> {
	...
	public StaffEntity staff(PharmacyUserEntity pharmacyUser) {
		return pharmacyUser.getStaff();
	}
