...
/**
 * Controller used to handle all REST operations regarding Medical Certificate  Discharge Resume
 */
// % protected region % [Update the API route or description for the Medical Certificate  Discharge ResumeController here] off begin
// The text associated with this tag can be found and edited in SwaggerConfig
@Tags(value = @Tag(name = "MedicalCertificateDischargeResumeController"))
@RestController
@Slf4j
@RequestMapping("/api/medicalcertificatedischargeresume")
// % protected region % [Update the API route or description for the Medical Certificate  Discharge ResumeController here] end
public class MedicalCertificateDischargeResumeController {

	private final MedicalCertificateDischargeResumeService medicalCertificateDischargeResumeService;
	private final CsvUtils<MedicalCertificateDischargeResumeEntity, MedicalCertificateDischargeResumeRepository, MedicalCertificateDischargeResumeEntityAudit,  MedicalCertificateDischargeResumeService> csvUtils;
	...
	@Autowired
	public MedicalCertificateDischargeResumeController(
		...
		this.csvUtils = new CsvUtils<>(medicalCertificateDischargeResumeService, MedicalCertificateDischargeResumeEntity.class);
	...
	/**
	 * Return all the Medical Certificate  Discharge Resumes.
	 *
	 * @return all the Medical Certificate  Discharge Resumes
	 */
	// % protected region % [Update the route mapping or description for the 'getAllWithPage' endpoint here] off begin
	@Operation(
			description = "Returns a single page of MedicalCertificateDischargeResumes",
		security = {
	...
	public ResponseEntity<List<MedicalCertificateDischargeResumeEntity>> getAllWithPage(
			@Parameter(description = "The page to return.")
			@RequestParam(value = "page", defaultValue = "1", required = false) int page,
			@Parameter(description = "The size of the page to return.")
			@RequestParam(value = "pageSize", defaultValue = "10", required = false) int pageSize
	) {
		List<MedicalCertificateDischargeResumeEntity> medicalCertificateDischargeResumes = medicalCertificateDischargeResumeService.findAllWithPage((page > 0) ? page - 1 : page, pageSize);
		...
		return new ResponseEntity<>(medicalCertificateDischargeResumes, HttpStatus.OK);
	}

	/**
	 * Return the Medical Certificate  Discharge Resume that has the same id as the given id.
	 *
	 * @param id      The id of the MedicalCertificateDischargeResumeEntity to be returned
	 * @return the Medical Certificate  Discharge Resume that has the same id as the given id
	 */
	...
	@Operation(
			description = "Return a single MedicalCertificateDischargeResume as defined by the id provided.",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "404", description = "MedicalCertificateDischargeResume entity not found"),
	})
	@PreAuthorize("hasPermission('MedicalCertificateDischargeResumeEntity', 'read')")
	@GetMapping(value = "/{id}", produces = "application/json")
	// % protected region % [Update the route mapping or description for the 'getById' endpoint here] end
	public ResponseEntity<MedicalCertificateDischargeResumeEntity> getById(
			@Parameter(description = "The UUID of the MedicalCertificateDischargeResume to return.")
			@PathVariable("id") UUID id
	) {
		Optional<MedicalCertificateDischargeResumeEntity> medicalCertificateDischargeResumeEntity = medicalCertificateDischargeResumeService.findById(id);
	...
	/**
	 * Create/Update the given Medical Certificate  Discharge Resume. If the entity has an id it will be updated, if not it will be created.
	 * The appropriate status codes will be set.
	 *
	 * @param medicalCertificateDischargeResumeEntityDto The Dto of the entity to save or update
	 */
	// % protected region % [Update the route mapping or description for the 'saveMedicalCertificateDischargeResume' endpoint here] off begin
	@Operation(
			description = "Create a MedicalCertificateDischargeResume if id not exists. Return 409 otherwise",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Successfully created the new MedicalCertificateDischargeResume."),
			@ApiResponse(responseCode = "409", description = "Failed to create the new MedicalCertificateDischargeResume, duplicate record found")
	})
	@PreAuthorize("hasPermission('MedicalCertificateDischargeResumeEntity', 'create')")
	@PostMapping
	// % protected region % [Update the route mapping or description for the 'saveMedicalCertificateDischargeResume' endpoint here] end
	public ResponseEntity<?> saveMedicalCertificateDischargeResume(
			@Parameter(description = "The MedicalCertificateDischargeResumeEntity to create or update.")
			@RequestBody MedicalCertificateDischargeResumeEntityDto medicalCertificateDischargeResumeEntityDto
	) {
		// % protected region % [Add any logic before save here] off begin
		// % protected region % [Add any logic before save here] end

		try {
			MedicalCertificateDischargeResumeEntity medicalCertificateDischargeResumeEntity = medicalCertificateDischargeResumeService.create(new MedicalCertificateDischargeResumeEntity(medicalCertificateDischargeResumeEntityDto));
			return new ResponseEntity<>(medicalCertificateDischargeResumeEntity, HttpStatus.OK);
	...
	/**
	 * Update the given Medical Certificate  Discharge Resume. If the entity has an id which is associated with an existing entity it will be updated, if not then the request will fail
	 * The appropriate status codes will be set.
	 *
	 * @param medicalCertificateDischargeResumeEntityDto The Dto of the entity to save or update
	 */
	// % protected region % [Update the route mapping or description for the 'updateMedicalCertificateDischargeResume' endpoint here] off begin
	@Operation(
			description = "Update a MedicalCertificateDischargeResume entity if id exists and is associated with an existing entity.  Return BAD_REQUEST otherwise",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	@ApiResponses(value = {
		@ApiResponse(responseCode = "200", description = "Successfully updated the MedicalCertificateDischargeResume."),
		@ApiResponse(responseCode = "400", description = "Failed to update the MedicalCertificateDischargeResume, entity id either does not exist" +
				"or is not associated with an existing entity")
	})
	@PreAuthorize("hasPermission('MedicalCertificateDischargeResumeEntity', 'update')")
	@PutMapping
	// % protected region % [Update the route mapping or description for the 'updateMedicalCertificateDischargeResume' endpoint here] end
	public ResponseEntity<?> updateMedicalCertificateDischargeResume(
			@Parameter(description = "The MedicalCertificateDischargeResumeEntity to create or update.")
			@RequestBody MedicalCertificateDischargeResumeEntityDto medicalCertificateDischargeResumeEntityDto
	) {
		// % protected region % [Add any logic before update here] off begin
		// % protected region % [Add any logic before update here] end
		Optional<MedicalCertificateDischargeResumeEntity> checkMedicalCertificateDischargeResumeExists = medicalCertificateDischargeResumeService.findById(medicalCertificateDischargeResumeEntityDto.getId());
		MedicalCertificateDischargeResumeEntity medicalCertificateDischargeResumeEntity = new MedicalCertificateDischargeResumeEntity(medicalCertificateDischargeResumeEntityDto);

		if (checkMedicalCertificateDischargeResumeExists.isPresent()) {
			try {
				medicalCertificateDischargeResumeEntity = medicalCertificateDischargeResumeService.update(medicalCertificateDischargeResumeEntity);
				return new ResponseEntity<>(medicalCertificateDischargeResumeEntity, HttpStatus.OK);
			} catch (ConstraintViolationException err) {
				return ControllerUtils.failedValidationApiResponse(err);
			}
		...
		return new ResponseEntity<>(medicalCertificateDischargeResumeEntity, HttpStatus.BAD_REQUEST);
	}

	/**
	 * Delete the Medical Certificate  Discharge Resume that has the same id as the given id.
	 *
	 * @param id The id of the MedicalCertificateDischargeResumeEntity to be deleted
	...
	@Operation(
			description = "Delete a single MedicalCertificateDischargeResume as defined by the id provided.",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	public ResponseEntity<Void> deleteById(
			@Parameter(description = "The UUID of the MedicalCertificateDischargeResume to delete.")
		...
		medicalCertificateDischargeResumeService.deleteById(id);
	 ...
	 */
	// % protected region % [Update the route mapping or description for the 'exportMedicalCertificateDischargeResume' endpoint here] off begin
	@Operation(
			description = "Download a csv file including all Medical Certificate  Discharge Resume entities included in the ids provided",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	// % protected region % [Update the route mapping or description for the 'exportMedicalCertificateDischargeResume' endpoint here] end
	public void exportMedicalCertificateDischargeResume(
			@Parameter(description = "The ids of the MedicalCertificateDischargeResumeEntities to export")
			@RequestParam @NotNull List<UUID> ids, HttpServletResponse response
	) {
		if (ids == null || ids.size() == 0) {
			response.setStatus(HttpServletResponse.SC_BAD_REQUEST);
		} else {
			List<MedicalCertificateDischargeResumeEntity> entitiesToExport = medicalCertificateDischargeResumeService.findAllByIds(ids);
			// % protected region % [Modify the default file name for the Export endpoint here] off begin
			String datetime = new SimpleDateFormat("yyyy-MM-dd_HH-mm-ss").format(new Date());
			String fileName = "MedicalCertificateDischargeResume_Export_" + datetime + ".csv";
			// % protected region % [Modify the default file name for the Export endpoint here] end

		for (MedicalCertificateDischargeResumeEntity entity: entitiesToExport) {
	 ...
	 * @param response The response object
	 */
	// % protected region % [Update the route mapping or description for the 'exportMedicalCertificateDischargeResumeExcludingIds' endpoint here] off begin
	@Operation(
	...
	// % protected region % [Update the route mapping or description for the 'exportMedicalCertificateDischargeResumeExcludingIds' endpoint here] end
	public void exportMedicalCertificateDischargeResumeExcludingIds(
			@Parameter(description = "The ids of the MedicalCertificateDischargeResumeEntities to exclude from the export")
			@RequestParam @NotNull List<UUID> ids, HttpServletResponse response
	) {
		List<MedicalCertificateDischargeResumeEntity> entitiesToExport;
		...
		if (ids == null || ids.size() == 0) {
			entitiesToExport = medicalCertificateDischargeResumeService.findAllExcludingIds(new ArrayList<>());
		} else {
			entitiesToExport = medicalCertificateDischargeResumeService.findAllExcludingIds(ids);
		}
	...
	/**
	 * Download a CSV file containing all of the headers of the MedicalCertificateDischargeResume entity.
	...
	public void csvImportExample(
		...
		String datetime = new SimpleDateFormat("yyyy-MM-dd_HH-mm-ss").format(new Date());
		String fileName = "MedicalCertificateDischargeResume_Import_Example_" + datetime + ".csv";
		// % protected region % [Modify the default file name for the Example Import endpoint here] end
		try {
			InputStream is = new ByteArrayInputStream(MedicalCertificateDischargeResumeEntity.getExampleCsvHeader().getBytes());
	...
	/**
	 * Upload a CSV file containing attributes for Medical Certificate  Discharge Resume entities, and import them into the database.  This method
	...
	@PreAuthorize("hasPermission('MedicalCertificateDischargeResumeEntity', 'create')  || hasPermission('MedicalCertificateDischargeResumeEntity', 'update')")
	...
	public ResponseEntity<String> csvUpload(HttpServletRequest request,
			@Parameter(description = "The CSV file with MedicalCertificateDischargeResumeEntity entities to import")
		...
		CustomGrantedAuthority entityAuthority = authorities.stream().filter(x -> x.getTargetEntity().matches("MedicalCertificateDischargeResumeEntity"))
		...
		List<String> allowedHeaders = Arrays.asList(MedicalCertificateDischargeResumeEntity.getExampleCsvHeader().split(","));
		...
		CsvToBean<MedicalCertificateDischargeResumeEntity> csvToBean = new CsvToBeanBuilder<MedicalCertificateDischargeResumeEntity>(reader)
				.withType(MedicalCertificateDischargeResumeEntity.class)
				.withIgnoreLeadingWhiteSpace(true)
				.withThrowExceptions(true)
				.build();

		List<MedicalCertificateDischargeResumeEntity> entities = new ArrayList<>();
		...
		try {
			Iterator<MedicalCertificateDischargeResumeEntity> iterator = csvToBean.iterator();
				...
				try {
					...
					if (next.getId() != null && !allowUpdate) {
						return ResponseEntity.status(HttpStatus.FORBIDDEN).body("Line " + currentLine
								+ ": You attempted to update a Medical Certificate  Discharge Resume entity and you do not have permission");
					}

					if (next.getId() == null && !allowCreate) {
						return ResponseEntity.status(HttpStatus.FORBIDDEN).body("Line " + currentLine
								+ ": You attempted to create a Medical Certificate  Discharge Resume entity and you do not have permission");
					}
