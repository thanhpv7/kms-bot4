...
import kmsweb.dtos.MedicalCertificateSickLeaveEntityDto;
import kmsweb.entities.MedicalCertificateSickLeaveEntityAudit;
...
/**
 * Controller used to handle all REST operations regarding Medical Certificate Sick Leave
 */
// % protected region % [Update the API route or description for the Medical Certificate Sick LeaveController here] off begin
// The text associated with this tag can be found and edited in SwaggerConfig
@Tags(value = @Tag(name = "MedicalCertificateSickLeaveController"))
@RestController
@Slf4j
@RequestMapping("/api/medicalcertificatesickleave")
// % protected region % [Update the API route or description for the Medical Certificate Sick LeaveController here] end
public class MedicalCertificateSickLeaveController {

	private final MedicalCertificateSickLeaveService medicalCertificateSickLeaveService;
	private final CsvUtils<MedicalCertificateSickLeaveEntity, MedicalCertificateSickLeaveRepository, MedicalCertificateSickLeaveEntityAudit,  MedicalCertificateSickLeaveService> csvUtils;
	...
	@Autowired
	public MedicalCertificateSickLeaveController(
		...
		this.csvUtils = new CsvUtils<>(medicalCertificateSickLeaveService, MedicalCertificateSickLeaveEntity.class);
	...
	/**
	 * Return all the Medical Certificate Sick Leaves.
	 *
	 * @return all the Medical Certificate Sick Leaves
	 */
	// % protected region % [Update the route mapping or description for the 'getAllWithPage' endpoint here] off begin
	@Operation(
			description = "Returns a single page of MedicalCertificateSickLeaves",
		security = {
	...
	public ResponseEntity<List<MedicalCertificateSickLeaveEntity>> getAllWithPage(
			@Parameter(description = "The page to return.")
			@RequestParam(value = "page", defaultValue = "1", required = false) int page,
			@Parameter(description = "The size of the page to return.")
			@RequestParam(value = "pageSize", defaultValue = "10", required = false) int pageSize
	) {
		List<MedicalCertificateSickLeaveEntity> medicalCertificateSickLeaves = medicalCertificateSickLeaveService.findAllWithPage((page > 0) ? page - 1 : page, pageSize);
		...
		return new ResponseEntity<>(medicalCertificateSickLeaves, HttpStatus.OK);
	}

	/**
	 * Return the Medical Certificate Sick Leave that has the same id as the given id.
	 *
	 * @param id      The id of the MedicalCertificateSickLeaveEntity to be returned
	 * @return the Medical Certificate Sick Leave that has the same id as the given id
	 */
	...
	@Operation(
			description = "Return a single MedicalCertificateSickLeave as defined by the id provided.",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "404", description = "MedicalCertificateSickLeave entity not found"),
	})
	@PreAuthorize("hasPermission('MedicalCertificateSickLeaveEntity', 'read')")
	@GetMapping(value = "/{id}", produces = "application/json")
	// % protected region % [Update the route mapping or description for the 'getById' endpoint here] end
	public ResponseEntity<MedicalCertificateSickLeaveEntity> getById(
			@Parameter(description = "The UUID of the MedicalCertificateSickLeave to return.")
			@PathVariable("id") UUID id
	) {
		Optional<MedicalCertificateSickLeaveEntity> medicalCertificateSickLeaveEntity = medicalCertificateSickLeaveService.findById(id);
	...
	/**
	 * Create/Update the given Medical Certificate Sick Leave. If the entity has an id it will be updated, if not it will be created.
	 * The appropriate status codes will be set.
	 *
	 * @param medicalCertificateSickLeaveEntityDto The Dto of the entity to save or update
	 */
	// % protected region % [Update the route mapping or description for the 'saveMedicalCertificateSickLeave' endpoint here] off begin
	@Operation(
			description = "Create a MedicalCertificateSickLeave if id not exists. Return 409 otherwise",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Successfully created the new MedicalCertificateSickLeave."),
			@ApiResponse(responseCode = "409", description = "Failed to create the new MedicalCertificateSickLeave, duplicate record found")
	})
	@PreAuthorize("hasPermission('MedicalCertificateSickLeaveEntity', 'create')")
	@PostMapping
	// % protected region % [Update the route mapping or description for the 'saveMedicalCertificateSickLeave' endpoint here] end
	public ResponseEntity<?> saveMedicalCertificateSickLeave(
			@Parameter(description = "The MedicalCertificateSickLeaveEntity to create or update.")
			@RequestBody MedicalCertificateSickLeaveEntityDto medicalCertificateSickLeaveEntityDto
	) {
		// % protected region % [Add any logic before save here] off begin
		// % protected region % [Add any logic before save here] end

		try {
			MedicalCertificateSickLeaveEntity medicalCertificateSickLeaveEntity = medicalCertificateSickLeaveService.create(new MedicalCertificateSickLeaveEntity(medicalCertificateSickLeaveEntityDto));
			return new ResponseEntity<>(medicalCertificateSickLeaveEntity, HttpStatus.OK);
	...
	/**
	 * Update the given Medical Certificate Sick Leave. If the entity has an id which is associated with an existing entity it will be updated, if not then the request will fail
	 * The appropriate status codes will be set.
	 *
	 * @param medicalCertificateSickLeaveEntityDto The Dto of the entity to save or update
	 */
	// % protected region % [Update the route mapping or description for the 'updateMedicalCertificateSickLeave' endpoint here] off begin
	@Operation(
			description = "Update a MedicalCertificateSickLeave entity if id exists and is associated with an existing entity.  Return BAD_REQUEST otherwise",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	@ApiResponses(value = {
		@ApiResponse(responseCode = "200", description = "Successfully updated the MedicalCertificateSickLeave."),
		@ApiResponse(responseCode = "400", description = "Failed to update the MedicalCertificateSickLeave, entity id either does not exist" +
				"or is not associated with an existing entity")
	})
	@PreAuthorize("hasPermission('MedicalCertificateSickLeaveEntity', 'update')")
	@PutMapping
	// % protected region % [Update the route mapping or description for the 'updateMedicalCertificateSickLeave' endpoint here] end
	public ResponseEntity<?> updateMedicalCertificateSickLeave(
			@Parameter(description = "The MedicalCertificateSickLeaveEntity to create or update.")
			@RequestBody MedicalCertificateSickLeaveEntityDto medicalCertificateSickLeaveEntityDto
	) {
		// % protected region % [Add any logic before update here] off begin
		// % protected region % [Add any logic before update here] end
		Optional<MedicalCertificateSickLeaveEntity> checkMedicalCertificateSickLeaveExists = medicalCertificateSickLeaveService.findById(medicalCertificateSickLeaveEntityDto.getId());
		MedicalCertificateSickLeaveEntity medicalCertificateSickLeaveEntity = new MedicalCertificateSickLeaveEntity(medicalCertificateSickLeaveEntityDto);

		if (checkMedicalCertificateSickLeaveExists.isPresent()) {
			try {
				medicalCertificateSickLeaveEntity = medicalCertificateSickLeaveService.update(medicalCertificateSickLeaveEntity);
				return new ResponseEntity<>(medicalCertificateSickLeaveEntity, HttpStatus.OK);
			} catch (ConstraintViolationException err) {
				return ControllerUtils.failedValidationApiResponse(err);
			}
		...
		return new ResponseEntity<>(medicalCertificateSickLeaveEntity, HttpStatus.BAD_REQUEST);
	}

	/**
	 * Delete the Medical Certificate Sick Leave that has the same id as the given id.
	 *
	 * @param id The id of the MedicalCertificateSickLeaveEntity to be deleted
	...
	@Operation(
			description = "Delete a single MedicalCertificateSickLeave as defined by the id provided.",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	@PreAuthorize("hasPermission('MedicalCertificateSickLeaveEntity', 'delete')")
	@DeleteMapping(value = "/{id}")
	// % protected region % [Update the route mapping or description for the 'deleteById' endpoint here] end
	public ResponseEntity<Void> deleteById(
			@Parameter(description = "The UUID of the MedicalCertificateSickLeave to delete.")
		...
		medicalCertificateSickLeaveService.deleteById(id);
	 ...
	 */
	// % protected region % [Update the route mapping or description for the 'exportMedicalCertificateSickLeave' endpoint here] off begin
	@Operation(
			description = "Download a csv file including all Medical Certificate Sick Leave entities included in the ids provided",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	// % protected region % [Update the route mapping or description for the 'exportMedicalCertificateSickLeave' endpoint here] end
	public void exportMedicalCertificateSickLeave(
			@Parameter(description = "The ids of the MedicalCertificateSickLeaveEntities to export")
			@RequestParam @NotNull List<UUID> ids, HttpServletResponse response
	) {
		if (ids == null || ids.size() == 0) {
			response.setStatus(HttpServletResponse.SC_BAD_REQUEST);
		} else {
			List<MedicalCertificateSickLeaveEntity> entitiesToExport = medicalCertificateSickLeaveService.findAllByIds(ids);
			// % protected region % [Modify the default file name for the Export endpoint here] off begin
			String datetime = new SimpleDateFormat("yyyy-MM-dd_HH-mm-ss").format(new Date());
			String fileName = "MedicalCertificateSickLeave_Export_" + datetime + ".csv";
			// % protected region % [Modify the default file name for the Export endpoint here] end

		for (MedicalCertificateSickLeaveEntity entity: entitiesToExport) {
	 ...
	 * @param response The response object
	 */
	// % protected region % [Update the route mapping or description for the 'exportMedicalCertificateSickLeaveExcludingIds' endpoint here] off begin
	@Operation(
	...
	// % protected region % [Update the route mapping or description for the 'exportMedicalCertificateSickLeaveExcludingIds' endpoint here] end
	public void exportMedicalCertificateSickLeaveExcludingIds(
			@Parameter(description = "The ids of the MedicalCertificateSickLeaveEntities to exclude from the export")
			@RequestParam @NotNull List<UUID> ids, HttpServletResponse response
	) {
		List<MedicalCertificateSickLeaveEntity> entitiesToExport;
		...
		if (ids == null || ids.size() == 0) {
			entitiesToExport = medicalCertificateSickLeaveService.findAllExcludingIds(new ArrayList<>());
		} else {
			entitiesToExport = medicalCertificateSickLeaveService.findAllExcludingIds(ids);
		}
	...
	/**
	 * Download a CSV file containing all of the headers of the MedicalCertificateSickLeave entity.
	...
	public void csvImportExample(
		...
		String datetime = new SimpleDateFormat("yyyy-MM-dd_HH-mm-ss").format(new Date());
		String fileName = "MedicalCertificateSickLeave_Import_Example_" + datetime + ".csv";
		// % protected region % [Modify the default file name for the Example Import endpoint here] end
		try {
			InputStream is = new ByteArrayInputStream(MedicalCertificateSickLeaveEntity.getExampleCsvHeader().getBytes());
	...
	/**
	 * Upload a CSV file containing attributes for Medical Certificate Sick Leave entities, and import them into the database.  This method
	...
	@PreAuthorize("hasPermission('MedicalCertificateSickLeaveEntity', 'create')  || hasPermission('MedicalCertificateSickLeaveEntity', 'update')")
	...
	public ResponseEntity<String> csvUpload(HttpServletRequest request,
			@Parameter(description = "The CSV file with MedicalCertificateSickLeaveEntity entities to import")
		...
		CustomGrantedAuthority entityAuthority = authorities.stream().filter(x -> x.getTargetEntity().matches("MedicalCertificateSickLeaveEntity"))
		...
		List<String> allowedHeaders = Arrays.asList(MedicalCertificateSickLeaveEntity.getExampleCsvHeader().split(","));
		...
		CsvToBean<MedicalCertificateSickLeaveEntity> csvToBean = new CsvToBeanBuilder<MedicalCertificateSickLeaveEntity>(reader)
				.withType(MedicalCertificateSickLeaveEntity.class)
				.withIgnoreLeadingWhiteSpace(true)
				.withThrowExceptions(true)
				.build();

		List<MedicalCertificateSickLeaveEntity> entities = new ArrayList<>();
		...
		try {
			Iterator<MedicalCertificateSickLeaveEntity> iterator = csvToBean.iterator();
				...
				try {
					...
					if (next.getId() != null && !allowUpdate) {
						return ResponseEntity.status(HttpStatus.FORBIDDEN).body("Line " + currentLine
								+ ": You attempted to update a Medical Certificate Sick Leave entity and you do not have permission");
					}

					if (next.getId() == null && !allowCreate) {
						return ResponseEntity.status(HttpStatus.FORBIDDEN).body("Line " + currentLine
								+ ": You attempted to create a Medical Certificate Sick Leave entity and you do not have permission");
					}
