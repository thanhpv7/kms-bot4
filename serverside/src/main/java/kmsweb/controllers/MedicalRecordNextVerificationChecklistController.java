...
import kmsweb.entities.MedicalRecordNextVerificationChecklistEntityAudit;
...
/**
 * Controller used to handle all REST operations regarding Medical Record Next Verification Checklist
 */
// % protected region % [Update the API route or description for the Medical Record Next Verification ChecklistController here] off begin
// The text associated with this tag can be found and edited in SwaggerConfig
@Tags(value = @Tag(name = "MedicalRecordNextVerificationChecklistController"))
@RestController
@Slf4j
@RequestMapping("/api/medicalrecordnextverificationchecklist")
// % protected region % [Update the API route or description for the Medical Record Next Verification ChecklistController here] end
public class MedicalRecordNextVerificationChecklistController {

	private final MedicalRecordNextVerificationChecklistService medicalRecordNextVerificationChecklistService;
	private final CsvUtils<MedicalRecordNextVerificationChecklistEntity, MedicalRecordNextVerificationChecklistRepository, MedicalRecordNextVerificationChecklistEntityAudit,  MedicalRecordNextVerificationChecklistService> csvUtils;
	...
	@Autowired
	public MedicalRecordNextVerificationChecklistController(
		...
		this.csvUtils = new CsvUtils<>(medicalRecordNextVerificationChecklistService, MedicalRecordNextVerificationChecklistEntity.class);
	...
	/**
	 * Return all the Medical Record Next Verification Checklists.
	 *
	 * @return all the Medical Record Next Verification Checklists
	 */
	// % protected region % [Update the route mapping or description for the 'getAllWithPage' endpoint here] off begin
	@Operation(
			description = "Returns a single page of MedicalRecordNextVerificationChecklists",
		security = {
	...
	public ResponseEntity<List<MedicalRecordNextVerificationChecklistEntity>> getAllWithPage(
			@Parameter(description = "The page to return.")
			@RequestParam(value = "page", defaultValue = "1", required = false) int page,
			@Parameter(description = "The size of the page to return.")
			@RequestParam(value = "pageSize", defaultValue = "10", required = false) int pageSize
	) {
		List<MedicalRecordNextVerificationChecklistEntity> medicalRecordNextVerificationChecklists = medicalRecordNextVerificationChecklistService.findAllWithPage((page > 0) ? page - 1 : page, pageSize);
		...
		return new ResponseEntity<>(medicalRecordNextVerificationChecklists, HttpStatus.OK);
	}

	/**
	 * Return the Medical Record Next Verification Checklist that has the same id as the given id.
	 *
	 * @param id      The id of the MedicalRecordNextVerificationChecklistEntity to be returned
	 * @return the Medical Record Next Verification Checklist that has the same id as the given id
	 */
	...
	@Operation(
			description = "Return a single MedicalRecordNextVerificationChecklist as defined by the id provided.",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "404", description = "MedicalRecordNextVerificationChecklist entity not found"),
	})
	@PreAuthorize("hasPermission('MedicalRecordNextVerificationChecklistEntity', 'read')")
	@GetMapping(value = "/{id}", produces = "application/json")
	// % protected region % [Update the route mapping or description for the 'getById' endpoint here] end
	public ResponseEntity<MedicalRecordNextVerificationChecklistEntity> getById(
			@Parameter(description = "The UUID of the MedicalRecordNextVerificationChecklist to return.")
			@PathVariable("id") UUID id
	) {
		Optional<MedicalRecordNextVerificationChecklistEntity> medicalRecordNextVerificationChecklistEntity = medicalRecordNextVerificationChecklistService.findById(id);
	...
	/**
	 * Create/Update the given Medical Record Next Verification Checklist. If the entity has an id it will be updated, if not it will be created.
	 * The appropriate status codes will be set.
	 *
	 * @param medicalRecordNextVerificationChecklistEntityDto The Dto of the entity to save or update
	 */
	// % protected region % [Update the route mapping or description for the 'saveMedicalRecordNextVerificationChecklist' endpoint here] off begin
	@Operation(
			description = "Create a MedicalRecordNextVerificationChecklist if id not exists. Return 409 otherwise",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Successfully created the new MedicalRecordNextVerificationChecklist."),
			@ApiResponse(responseCode = "409", description = "Failed to create the new MedicalRecordNextVerificationChecklist, duplicate record found")
	})
	@PreAuthorize("hasPermission('MedicalRecordNextVerificationChecklistEntity', 'create')")
	@PostMapping
	// % protected region % [Update the route mapping or description for the 'saveMedicalRecordNextVerificationChecklist' endpoint here] end
	public ResponseEntity<?> saveMedicalRecordNextVerificationChecklist(
			@Parameter(description = "The MedicalRecordNextVerificationChecklistEntity to create or update.")
			@RequestBody MedicalRecordNextVerificationChecklistEntityDto medicalRecordNextVerificationChecklistEntityDto
	) {
		// % protected region % [Add any logic before save here] off begin
		// % protected region % [Add any logic before save here] end

		try {
			MedicalRecordNextVerificationChecklistEntity medicalRecordNextVerificationChecklistEntity = medicalRecordNextVerificationChecklistService.create(new MedicalRecordNextVerificationChecklistEntity(medicalRecordNextVerificationChecklistEntityDto));
			return new ResponseEntity<>(medicalRecordNextVerificationChecklistEntity, HttpStatus.OK);
	...
	/**
	 * Update the given Medical Record Next Verification Checklist. If the entity has an id which is associated with an existing entity it will be updated, if not then the request will fail
	 * The appropriate status codes will be set.
	 *
	 * @param medicalRecordNextVerificationChecklistEntityDto The Dto of the entity to save or update
	 */
	// % protected region % [Update the route mapping or description for the 'updateMedicalRecordNextVerificationChecklist' endpoint here] off begin
	@Operation(
			description = "Update a MedicalRecordNextVerificationChecklist entity if id exists and is associated with an existing entity.  Return BAD_REQUEST otherwise",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	@ApiResponses(value = {
		@ApiResponse(responseCode = "200", description = "Successfully updated the MedicalRecordNextVerificationChecklist."),
		@ApiResponse(responseCode = "400", description = "Failed to update the MedicalRecordNextVerificationChecklist, entity id either does not exist" +
	...
	@PutMapping
	// % protected region % [Update the route mapping or description for the 'updateMedicalRecordNextVerificationChecklist' endpoint here] end
	public ResponseEntity<?> updateMedicalRecordNextVerificationChecklist(
			@Parameter(description = "The MedicalRecordNextVerificationChecklistEntity to create or update.")
			@RequestBody MedicalRecordNextVerificationChecklistEntityDto medicalRecordNextVerificationChecklistEntityDto
	) {
		// % protected region % [Add any logic before update here] off begin
		// % protected region % [Add any logic before update here] end
		Optional<MedicalRecordNextVerificationChecklistEntity> checkMedicalRecordNextVerificationChecklistExists = medicalRecordNextVerificationChecklistService.findById(medicalRecordNextVerificationChecklistEntityDto.getId());
		MedicalRecordNextVerificationChecklistEntity medicalRecordNextVerificationChecklistEntity = new MedicalRecordNextVerificationChecklistEntity(medicalRecordNextVerificationChecklistEntityDto);

		if (checkMedicalRecordNextVerificationChecklistExists.isPresent()) {
			try {
				medicalRecordNextVerificationChecklistEntity = medicalRecordNextVerificationChecklistService.update(medicalRecordNextVerificationChecklistEntity);
				return new ResponseEntity<>(medicalRecordNextVerificationChecklistEntity, HttpStatus.OK);
			} catch (ConstraintViolationException err) {
				return ControllerUtils.failedValidationApiResponse(err);
			}
		...
		return new ResponseEntity<>(medicalRecordNextVerificationChecklistEntity, HttpStatus.BAD_REQUEST);
	}

	/**
	 * Delete the Medical Record Next Verification Checklist that has the same id as the given id.
	 *
	 * @param id The id of the MedicalRecordNextVerificationChecklistEntity to be deleted
	...
	@Operation(
			description = "Delete a single MedicalRecordNextVerificationChecklist as defined by the id provided.",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	public ResponseEntity<Void> deleteById(
			@Parameter(description = "The UUID of the MedicalRecordNextVerificationChecklist to delete.")
		...
		medicalRecordNextVerificationChecklistService.deleteById(id);
	 ...
	 */
	// % protected region % [Update the route mapping or description for the 'exportMedicalRecordNextVerificationChecklist' endpoint here] off begin
	@Operation(
			description = "Download a csv file including all Medical Record Next Verification Checklist entities included in the ids provided",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	// % protected region % [Update the route mapping or description for the 'exportMedicalRecordNextVerificationChecklist' endpoint here] end
	public void exportMedicalRecordNextVerificationChecklist(
			@Parameter(description = "The ids of the MedicalRecordNextVerificationChecklistEntities to export")
			@RequestParam @NotNull List<UUID> ids, HttpServletResponse response
	) {
		if (ids == null || ids.size() == 0) {
			response.setStatus(HttpServletResponse.SC_BAD_REQUEST);
		} else {
			List<MedicalRecordNextVerificationChecklistEntity> entitiesToExport = medicalRecordNextVerificationChecklistService.findAllByIds(ids);
			// % protected region % [Modify the default file name for the Export endpoint here] off begin
			String datetime = new SimpleDateFormat("yyyy-MM-dd_HH-mm-ss").format(new Date());
			String fileName = "MedicalRecordNextVerificationChecklist_Export_" + datetime + ".csv";
			// % protected region % [Modify the default file name for the Export endpoint here] end

		for (MedicalRecordNextVerificationChecklistEntity entity: entitiesToExport) {
	 ...
	 * @param response The response object
	 */
	// % protected region % [Update the route mapping or description for the 'exportMedicalRecordNextVerificationChecklistExcludingIds' endpoint here] off begin
	@Operation(
	...
	// % protected region % [Update the route mapping or description for the 'exportMedicalRecordNextVerificationChecklistExcludingIds' endpoint here] end
	public void exportMedicalRecordNextVerificationChecklistExcludingIds(
			@Parameter(description = "The ids of the MedicalRecordNextVerificationChecklistEntities to exclude from the export")
			@RequestParam @NotNull List<UUID> ids, HttpServletResponse response
	) {
		List<MedicalRecordNextVerificationChecklistEntity> entitiesToExport;
		...
		if (ids == null || ids.size() == 0) {
			entitiesToExport = medicalRecordNextVerificationChecklistService.findAllExcludingIds(new ArrayList<>());
		} else {
			entitiesToExport = medicalRecordNextVerificationChecklistService.findAllExcludingIds(ids);
		}
	...
	/**
	 * Download a CSV file containing all of the headers of the MedicalRecordNextVerificationChecklist entity.
	...
	public void csvImportExample(
		...
		String datetime = new SimpleDateFormat("yyyy-MM-dd_HH-mm-ss").format(new Date());
		String fileName = "MedicalRecordNextVerificationChecklist_Import_Example_" + datetime + ".csv";
		// % protected region % [Modify the default file name for the Example Import endpoint here] end
		try {
			InputStream is = new ByteArrayInputStream(MedicalRecordNextVerificationChecklistEntity.getExampleCsvHeader().getBytes());
	...
	/**
	 * Upload a CSV file containing attributes for Medical Record Next Verification Checklist entities, and import them into the database.  This method
	...
	@PreAuthorize("hasPermission('MedicalRecordNextVerificationChecklistEntity', 'create')  || hasPermission('MedicalRecordNextVerificationChecklistEntity', 'update')")
	...
	public ResponseEntity<String> csvUpload(HttpServletRequest request,
			@Parameter(description = "The CSV file with MedicalRecordNextVerificationChecklistEntity entities to import")
		...
		CustomGrantedAuthority entityAuthority = authorities.stream().filter(x -> x.getTargetEntity().matches("MedicalRecordNextVerificationChecklistEntity"))
		...
		List<String> allowedHeaders = Arrays.asList(MedicalRecordNextVerificationChecklistEntity.getExampleCsvHeader().split(","));
		...
		CsvToBean<MedicalRecordNextVerificationChecklistEntity> csvToBean = new CsvToBeanBuilder<MedicalRecordNextVerificationChecklistEntity>(reader)
				.withType(MedicalRecordNextVerificationChecklistEntity.class)
				.withIgnoreLeadingWhiteSpace(true)
				.withThrowExceptions(true)
				.build();

		List<MedicalRecordNextVerificationChecklistEntity> entities = new ArrayList<>();
		...
		try {
			Iterator<MedicalRecordNextVerificationChecklistEntity> iterator = csvToBean.iterator();
				...
				try {
					...
					if (next.getId() != null && !allowUpdate) {
						return ResponseEntity.status(HttpStatus.FORBIDDEN).body("Line " + currentLine
								+ ": You attempted to update a Medical Record Next Verification Checklist entity and you do not have permission");
					}

					if (next.getId() == null && !allowCreate) {
						return ResponseEntity.status(HttpStatus.FORBIDDEN).body("Line " + currentLine
								+ ": You attempted to create a Medical Record Next Verification Checklist entity and you do not have permission");
					}
