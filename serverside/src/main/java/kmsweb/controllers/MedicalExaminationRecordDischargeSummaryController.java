...
/**
 * Controller used to handle all REST operations regarding Medical Examination Record Discharge Summary
 */
// % protected region % [Update the API route or description for the Medical Examination Record Discharge SummaryController here] off begin
// The text associated with this tag can be found and edited in SwaggerConfig
@Tags(value = @Tag(name = "MedicalExaminationRecordDischargeSummaryController"))
@RestController
@Slf4j
@RequestMapping("/api/medicalexaminationrecorddischargesummary")
// % protected region % [Update the API route or description for the Medical Examination Record Discharge SummaryController here] end
public class MedicalExaminationRecordDischargeSummaryController {

	private final MedicalExaminationRecordDischargeSummaryService medicalExaminationRecordDischargeSummaryService;
	private final CsvUtils<MedicalExaminationRecordDischargeSummaryEntity, MedicalExaminationRecordDischargeSummaryRepository, MedicalExaminationRecordDischargeSummaryEntityAudit,  MedicalExaminationRecordDischargeSummaryService> csvUtils;
	...
	@Autowired
	public MedicalExaminationRecordDischargeSummaryController(
		...
		this.csvUtils = new CsvUtils<>(medicalExaminationRecordDischargeSummaryService, MedicalExaminationRecordDischargeSummaryEntity.class);
	...
	/**
	 * Return all the Medical Examination Record Discharge Summarys.
	 *
	 * @return all the Medical Examination Record Discharge Summarys
	 */
	// % protected region % [Update the route mapping or description for the 'getAllWithPage' endpoint here] off begin
	@Operation(
			description = "Returns a single page of MedicalExaminationRecordDischargeSummarys",
		security = {
	...
	public ResponseEntity<List<MedicalExaminationRecordDischargeSummaryEntity>> getAllWithPage(
			@Parameter(description = "The page to return.")
			@RequestParam(value = "page", defaultValue = "1", required = false) int page,
			@Parameter(description = "The size of the page to return.")
			@RequestParam(value = "pageSize", defaultValue = "10", required = false) int pageSize
	) {
		List<MedicalExaminationRecordDischargeSummaryEntity> medicalExaminationRecordDischargeSummarys = medicalExaminationRecordDischargeSummaryService.findAllWithPage((page > 0) ? page - 1 : page, pageSize);
		...
		return new ResponseEntity<>(medicalExaminationRecordDischargeSummarys, HttpStatus.OK);
	}

	/**
	 * Return the Medical Examination Record Discharge Summary that has the same id as the given id.
	 *
	 * @param id      The id of the MedicalExaminationRecordDischargeSummaryEntity to be returned
	 * @return the Medical Examination Record Discharge Summary that has the same id as the given id
	 */
	...
	@Operation(
			description = "Return a single MedicalExaminationRecordDischargeSummary as defined by the id provided.",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "404", description = "MedicalExaminationRecordDischargeSummary entity not found"),
	})
	@PreAuthorize("hasPermission('MedicalExaminationRecordDischargeSummaryEntity', 'read')")
	@GetMapping(value = "/{id}", produces = "application/json")
	// % protected region % [Update the route mapping or description for the 'getById' endpoint here] end
	public ResponseEntity<MedicalExaminationRecordDischargeSummaryEntity> getById(
			@Parameter(description = "The UUID of the MedicalExaminationRecordDischargeSummary to return.")
			@PathVariable("id") UUID id
	) {
		Optional<MedicalExaminationRecordDischargeSummaryEntity> medicalExaminationRecordDischargeSummaryEntity = medicalExaminationRecordDischargeSummaryService.findById(id);
	...
	/**
	 * Create/Update the given Medical Examination Record Discharge Summary. If the entity has an id it will be updated, if not it will be created.
	 * The appropriate status codes will be set.
	 *
	 * @param medicalExaminationRecordDischargeSummaryEntityDto The Dto of the entity to save or update
	 */
	// % protected region % [Update the route mapping or description for the 'saveMedicalExaminationRecordDischargeSummary' endpoint here] off begin
	@Operation(
			description = "Create a MedicalExaminationRecordDischargeSummary if id not exists. Return 409 otherwise",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Successfully created the new MedicalExaminationRecordDischargeSummary."),
			@ApiResponse(responseCode = "409", description = "Failed to create the new MedicalExaminationRecordDischargeSummary, duplicate record found")
	})
	@PreAuthorize("hasPermission('MedicalExaminationRecordDischargeSummaryEntity', 'create')")
	@PostMapping
	// % protected region % [Update the route mapping or description for the 'saveMedicalExaminationRecordDischargeSummary' endpoint here] end
	public ResponseEntity<?> saveMedicalExaminationRecordDischargeSummary(
			@Parameter(description = "The MedicalExaminationRecordDischargeSummaryEntity to create or update.")
			@RequestBody MedicalExaminationRecordDischargeSummaryEntityDto medicalExaminationRecordDischargeSummaryEntityDto
	) {
		// % protected region % [Add any logic before save here] off begin
		// % protected region % [Add any logic before save here] end

		try {
			MedicalExaminationRecordDischargeSummaryEntity medicalExaminationRecordDischargeSummaryEntity = medicalExaminationRecordDischargeSummaryService.create(new MedicalExaminationRecordDischargeSummaryEntity(medicalExaminationRecordDischargeSummaryEntityDto));
			return new ResponseEntity<>(medicalExaminationRecordDischargeSummaryEntity, HttpStatus.OK);
	...
	/**
	 * Update the given Medical Examination Record Discharge Summary. If the entity has an id which is associated with an existing entity it will be updated, if not then the request will fail
	 * The appropriate status codes will be set.
	 *
	 * @param medicalExaminationRecordDischargeSummaryEntityDto The Dto of the entity to save or update
	 */
	// % protected region % [Update the route mapping or description for the 'updateMedicalExaminationRecordDischargeSummary' endpoint here] off begin
	@Operation(
			description = "Update a MedicalExaminationRecordDischargeSummary entity if id exists and is associated with an existing entity.  Return BAD_REQUEST otherwise",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	@ApiResponses(value = {
		@ApiResponse(responseCode = "200", description = "Successfully updated the MedicalExaminationRecordDischargeSummary."),
		@ApiResponse(responseCode = "400", description = "Failed to update the MedicalExaminationRecordDischargeSummary, entity id either does not exist" +
	...
	@PutMapping
	// % protected region % [Update the route mapping or description for the 'updateMedicalExaminationRecordDischargeSummary' endpoint here] end
	public ResponseEntity<?> updateMedicalExaminationRecordDischargeSummary(
			@Parameter(description = "The MedicalExaminationRecordDischargeSummaryEntity to create or update.")
			@RequestBody MedicalExaminationRecordDischargeSummaryEntityDto medicalExaminationRecordDischargeSummaryEntityDto
	) {
		// % protected region % [Add any logic before update here] off begin
		// % protected region % [Add any logic before update here] end
		Optional<MedicalExaminationRecordDischargeSummaryEntity> checkMedicalExaminationRecordDischargeSummaryExists = medicalExaminationRecordDischargeSummaryService.findById(medicalExaminationRecordDischargeSummaryEntityDto.getId());
		MedicalExaminationRecordDischargeSummaryEntity medicalExaminationRecordDischargeSummaryEntity = new MedicalExaminationRecordDischargeSummaryEntity(medicalExaminationRecordDischargeSummaryEntityDto);

		if (checkMedicalExaminationRecordDischargeSummaryExists.isPresent()) {
			try {
				medicalExaminationRecordDischargeSummaryEntity = medicalExaminationRecordDischargeSummaryService.update(medicalExaminationRecordDischargeSummaryEntity);
				return new ResponseEntity<>(medicalExaminationRecordDischargeSummaryEntity, HttpStatus.OK);
			} catch (ConstraintViolationException err) {
				return ControllerUtils.failedValidationApiResponse(err);
			}
		...
		return new ResponseEntity<>(medicalExaminationRecordDischargeSummaryEntity, HttpStatus.BAD_REQUEST);
	}

	/**
	 * Delete the Medical Examination Record Discharge Summary that has the same id as the given id.
	 *
	 * @param id The id of the MedicalExaminationRecordDischargeSummaryEntity to be deleted
	...
	@Operation(
			description = "Delete a single MedicalExaminationRecordDischargeSummary as defined by the id provided.",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	public ResponseEntity<Void> deleteById(
			@Parameter(description = "The UUID of the MedicalExaminationRecordDischargeSummary to delete.")
		...
		medicalExaminationRecordDischargeSummaryService.deleteById(id);
	 ...
	 */
	// % protected region % [Update the route mapping or description for the 'exportMedicalExaminationRecordDischargeSummary' endpoint here] off begin
	@Operation(
			description = "Download a csv file including all Medical Examination Record Discharge Summary entities included in the ids provided",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	// % protected region % [Update the route mapping or description for the 'exportMedicalExaminationRecordDischargeSummary' endpoint here] end
	public void exportMedicalExaminationRecordDischargeSummary(
			@Parameter(description = "The ids of the MedicalExaminationRecordDischargeSummaryEntities to export")
			@RequestParam @NotNull List<UUID> ids, HttpServletResponse response
	) {
		if (ids == null || ids.size() == 0) {
			response.setStatus(HttpServletResponse.SC_BAD_REQUEST);
		} else {
			List<MedicalExaminationRecordDischargeSummaryEntity> entitiesToExport = medicalExaminationRecordDischargeSummaryService.findAllByIds(ids);
			// % protected region % [Modify the default file name for the Export endpoint here] off begin
			String datetime = new SimpleDateFormat("yyyy-MM-dd_HH-mm-ss").format(new Date());
			String fileName = "MedicalExaminationRecordDischargeSummary_Export_" + datetime + ".csv";
			// % protected region % [Modify the default file name for the Export endpoint here] end

		for (MedicalExaminationRecordDischargeSummaryEntity entity: entitiesToExport) {
	 ...
	 * @param response The response object
	 */
	// % protected region % [Update the route mapping or description for the 'exportMedicalExaminationRecordDischargeSummaryExcludingIds' endpoint here] off begin
	@Operation(
	...
	// % protected region % [Update the route mapping or description for the 'exportMedicalExaminationRecordDischargeSummaryExcludingIds' endpoint here] end
	public void exportMedicalExaminationRecordDischargeSummaryExcludingIds(
			@Parameter(description = "The ids of the MedicalExaminationRecordDischargeSummaryEntities to exclude from the export")
			@RequestParam @NotNull List<UUID> ids, HttpServletResponse response
	) {
		List<MedicalExaminationRecordDischargeSummaryEntity> entitiesToExport;
		...
		if (ids == null || ids.size() == 0) {
			entitiesToExport = medicalExaminationRecordDischargeSummaryService.findAllExcludingIds(new ArrayList<>());
		} else {
			entitiesToExport = medicalExaminationRecordDischargeSummaryService.findAllExcludingIds(ids);
		}
	...
	/**
	 * Download a CSV file containing all of the headers of the MedicalExaminationRecordDischargeSummary entity.
	...
	public void csvImportExample(
		...
		String datetime = new SimpleDateFormat("yyyy-MM-dd_HH-mm-ss").format(new Date());
		String fileName = "MedicalExaminationRecordDischargeSummary_Import_Example_" + datetime + ".csv";
		// % protected region % [Modify the default file name for the Example Import endpoint here] end
		try {
			InputStream is = new ByteArrayInputStream(MedicalExaminationRecordDischargeSummaryEntity.getExampleCsvHeader().getBytes());
	...
	/**
	 * Upload a CSV file containing attributes for Medical Examination Record Discharge Summary entities, and import them into the database.  This method
	...
	@PreAuthorize("hasPermission('MedicalExaminationRecordDischargeSummaryEntity', 'create')  || hasPermission('MedicalExaminationRecordDischargeSummaryEntity', 'update')")
	...
	public ResponseEntity<String> csvUpload(HttpServletRequest request,
			@Parameter(description = "The CSV file with MedicalExaminationRecordDischargeSummaryEntity entities to import")
		...
		CustomGrantedAuthority entityAuthority = authorities.stream().filter(x -> x.getTargetEntity().matches("MedicalExaminationRecordDischargeSummaryEntity"))
		...
		List<String> allowedHeaders = Arrays.asList(MedicalExaminationRecordDischargeSummaryEntity.getExampleCsvHeader().split(","));
		...
		CsvToBean<MedicalExaminationRecordDischargeSummaryEntity> csvToBean = new CsvToBeanBuilder<MedicalExaminationRecordDischargeSummaryEntity>(reader)
				.withType(MedicalExaminationRecordDischargeSummaryEntity.class)
				.withIgnoreLeadingWhiteSpace(true)
				.withThrowExceptions(true)
				.build();

		List<MedicalExaminationRecordDischargeSummaryEntity> entities = new ArrayList<>();
		...
		try {
			Iterator<MedicalExaminationRecordDischargeSummaryEntity> iterator = csvToBean.iterator();
				...
				try {
					...
					if (next.getId() != null && !allowUpdate) {
						return ResponseEntity.status(HttpStatus.FORBIDDEN).body("Line " + currentLine
								+ ": You attempted to update a Medical Examination Record Discharge Summary entity and you do not have permission");
					}

					if (next.getId() == null && !allowCreate) {
						return ResponseEntity.status(HttpStatus.FORBIDDEN).body("Line " + currentLine
								+ ": You attempted to create a Medical Examination Record Discharge Summary entity and you do not have permission");
					}
