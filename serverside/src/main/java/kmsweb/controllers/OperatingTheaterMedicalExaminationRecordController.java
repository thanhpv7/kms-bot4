...
import kmsweb.entities.OperatingTheaterMedicalExaminationRecordEntityAudit;
...
/**
 * Controller used to handle all REST operations regarding Operating Theater Medical Examination Record
 */
// % protected region % [Update the API route or description for the Operating Theater Medical Examination RecordController here] off begin
// The text associated with this tag can be found and edited in SwaggerConfig
@Tags(value = @Tag(name = "OperatingTheaterMedicalExaminationRecordController"))
@RestController
@Slf4j
@RequestMapping("/api/operatingtheatermedicalexaminationrecord")
// % protected region % [Update the API route or description for the Operating Theater Medical Examination RecordController here] end
public class OperatingTheaterMedicalExaminationRecordController {

	private final OperatingTheaterMedicalExaminationRecordService operatingTheaterMedicalExaminationRecordService;
	private final CsvUtils<OperatingTheaterMedicalExaminationRecordEntity, OperatingTheaterMedicalExaminationRecordRepository, OperatingTheaterMedicalExaminationRecordEntityAudit,  OperatingTheaterMedicalExaminationRecordService> csvUtils;
	...
	@Autowired
	public OperatingTheaterMedicalExaminationRecordController(
		...
		this.csvUtils = new CsvUtils<>(operatingTheaterMedicalExaminationRecordService, OperatingTheaterMedicalExaminationRecordEntity.class);
	...
	/**
	 * Return all the Operating Theater Medical Examination Records.
	 *
	 * @return all the Operating Theater Medical Examination Records
	 */
	// % protected region % [Update the route mapping or description for the 'getAllWithPage' endpoint here] off begin
	@Operation(
			description = "Returns a single page of OperatingTheaterMedicalExaminationRecords",
		security = {
	...
	public ResponseEntity<List<OperatingTheaterMedicalExaminationRecordEntity>> getAllWithPage(
			@Parameter(description = "The page to return.")
			@RequestParam(value = "page", defaultValue = "1", required = false) int page,
			@Parameter(description = "The size of the page to return.")
			@RequestParam(value = "pageSize", defaultValue = "10", required = false) int pageSize
	) {
		List<OperatingTheaterMedicalExaminationRecordEntity> operatingTheaterMedicalExaminationRecords = operatingTheaterMedicalExaminationRecordService.findAllWithPage((page > 0) ? page - 1 : page, pageSize);
		...
		return new ResponseEntity<>(operatingTheaterMedicalExaminationRecords, HttpStatus.OK);
	}

	/**
	 * Return the Operating Theater Medical Examination Record that has the same id as the given id.
	 *
	 * @param id      The id of the OperatingTheaterMedicalExaminationRecordEntity to be returned
	 * @return the Operating Theater Medical Examination Record that has the same id as the given id
	 */
	...
	@Operation(
			description = "Return a single OperatingTheaterMedicalExaminationRecord as defined by the id provided.",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "404", description = "OperatingTheaterMedicalExaminationRecord entity not found"),
	})
	@PreAuthorize("hasPermission('OperatingTheaterMedicalExaminationRecordEntity', 'read')")
	@GetMapping(value = "/{id}", produces = "application/json")
	// % protected region % [Update the route mapping or description for the 'getById' endpoint here] end
	public ResponseEntity<OperatingTheaterMedicalExaminationRecordEntity> getById(
			@Parameter(description = "The UUID of the OperatingTheaterMedicalExaminationRecord to return.")
			@PathVariable("id") UUID id
	) {
		Optional<OperatingTheaterMedicalExaminationRecordEntity> operatingTheaterMedicalExaminationRecordEntity = operatingTheaterMedicalExaminationRecordService.findById(id);
	...
	/**
	 * Create/Update the given Operating Theater Medical Examination Record. If the entity has an id it will be updated, if not it will be created.
	 * The appropriate status codes will be set.
	 *
	 * @param operatingTheaterMedicalExaminationRecordEntityDto The Dto of the entity to save or update
	 */
	// % protected region % [Update the route mapping or description for the 'saveOperatingTheaterMedicalExaminationRecord' endpoint here] off begin
	@Operation(
			description = "Create a OperatingTheaterMedicalExaminationRecord if id not exists. Return 409 otherwise",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Successfully created the new OperatingTheaterMedicalExaminationRecord."),
			@ApiResponse(responseCode = "409", description = "Failed to create the new OperatingTheaterMedicalExaminationRecord, duplicate record found")
	})
	@PreAuthorize("hasPermission('OperatingTheaterMedicalExaminationRecordEntity', 'create')")
	@PostMapping
	// % protected region % [Update the route mapping or description for the 'saveOperatingTheaterMedicalExaminationRecord' endpoint here] end
	public ResponseEntity<?> saveOperatingTheaterMedicalExaminationRecord(
			@Parameter(description = "The OperatingTheaterMedicalExaminationRecordEntity to create or update.")
			@RequestBody OperatingTheaterMedicalExaminationRecordEntityDto operatingTheaterMedicalExaminationRecordEntityDto
	) {
		// % protected region % [Add any logic before save here] off begin
		// % protected region % [Add any logic before save here] end

		try {
			OperatingTheaterMedicalExaminationRecordEntity operatingTheaterMedicalExaminationRecordEntity = operatingTheaterMedicalExaminationRecordService.create(new OperatingTheaterMedicalExaminationRecordEntity(operatingTheaterMedicalExaminationRecordEntityDto));
			return new ResponseEntity<>(operatingTheaterMedicalExaminationRecordEntity, HttpStatus.OK);
	...
	/**
	 * Update the given Operating Theater Medical Examination Record. If the entity has an id which is associated with an existing entity it will be updated, if not then the request will fail
	 * The appropriate status codes will be set.
	 *
	 * @param operatingTheaterMedicalExaminationRecordEntityDto The Dto of the entity to save or update
	 */
	// % protected region % [Update the route mapping or description for the 'updateOperatingTheaterMedicalExaminationRecord' endpoint here] off begin
	@Operation(
			description = "Update a OperatingTheaterMedicalExaminationRecord entity if id exists and is associated with an existing entity.  Return BAD_REQUEST otherwise",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	@ApiResponses(value = {
		@ApiResponse(responseCode = "200", description = "Successfully updated the OperatingTheaterMedicalExaminationRecord."),
		@ApiResponse(responseCode = "400", description = "Failed to update the OperatingTheaterMedicalExaminationRecord, entity id either does not exist" +
	...
	@PutMapping
	// % protected region % [Update the route mapping or description for the 'updateOperatingTheaterMedicalExaminationRecord' endpoint here] end
	public ResponseEntity<?> updateOperatingTheaterMedicalExaminationRecord(
			@Parameter(description = "The OperatingTheaterMedicalExaminationRecordEntity to create or update.")
			@RequestBody OperatingTheaterMedicalExaminationRecordEntityDto operatingTheaterMedicalExaminationRecordEntityDto
	) {
		// % protected region % [Add any logic before update here] off begin
		// % protected region % [Add any logic before update here] end
		Optional<OperatingTheaterMedicalExaminationRecordEntity> checkOperatingTheaterMedicalExaminationRecordExists = operatingTheaterMedicalExaminationRecordService.findById(operatingTheaterMedicalExaminationRecordEntityDto.getId());
		OperatingTheaterMedicalExaminationRecordEntity operatingTheaterMedicalExaminationRecordEntity = new OperatingTheaterMedicalExaminationRecordEntity(operatingTheaterMedicalExaminationRecordEntityDto);

		if (checkOperatingTheaterMedicalExaminationRecordExists.isPresent()) {
			try {
				operatingTheaterMedicalExaminationRecordEntity = operatingTheaterMedicalExaminationRecordService.update(operatingTheaterMedicalExaminationRecordEntity);
				return new ResponseEntity<>(operatingTheaterMedicalExaminationRecordEntity, HttpStatus.OK);
			} catch (ConstraintViolationException err) {
				return ControllerUtils.failedValidationApiResponse(err);
			}
		...
		return new ResponseEntity<>(operatingTheaterMedicalExaminationRecordEntity, HttpStatus.BAD_REQUEST);
	}

	/**
	 * Delete the Operating Theater Medical Examination Record that has the same id as the given id.
	 *
	 * @param id The id of the OperatingTheaterMedicalExaminationRecordEntity to be deleted
	...
	@Operation(
			description = "Delete a single OperatingTheaterMedicalExaminationRecord as defined by the id provided.",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	public ResponseEntity<Void> deleteById(
			@Parameter(description = "The UUID of the OperatingTheaterMedicalExaminationRecord to delete.")
		...
		operatingTheaterMedicalExaminationRecordService.deleteById(id);
	 ...
	 */
	// % protected region % [Update the route mapping or description for the 'exportOperatingTheaterMedicalExaminationRecord' endpoint here] off begin
	@Operation(
			description = "Download a csv file including all Operating Theater Medical Examination Record entities included in the ids provided",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	// % protected region % [Update the route mapping or description for the 'exportOperatingTheaterMedicalExaminationRecord' endpoint here] end
	public void exportOperatingTheaterMedicalExaminationRecord(
			@Parameter(description = "The ids of the OperatingTheaterMedicalExaminationRecordEntities to export")
			@RequestParam @NotNull List<UUID> ids, HttpServletResponse response
	) {
		if (ids == null || ids.size() == 0) {
			response.setStatus(HttpServletResponse.SC_BAD_REQUEST);
		} else {
			List<OperatingTheaterMedicalExaminationRecordEntity> entitiesToExport = operatingTheaterMedicalExaminationRecordService.findAllByIds(ids);
			// % protected region % [Modify the default file name for the Export endpoint here] off begin
			String datetime = new SimpleDateFormat("yyyy-MM-dd_HH-mm-ss").format(new Date());
			String fileName = "OperatingTheaterMedicalExaminationRecord_Export_" + datetime + ".csv";
			// % protected region % [Modify the default file name for the Export endpoint here] end

		for (OperatingTheaterMedicalExaminationRecordEntity entity: entitiesToExport) {
	 ...
	 * @param response The response object
	 */
	// % protected region % [Update the route mapping or description for the 'exportOperatingTheaterMedicalExaminationRecordExcludingIds' endpoint here] off begin
	@Operation(
	...
	// % protected region % [Update the route mapping or description for the 'exportOperatingTheaterMedicalExaminationRecordExcludingIds' endpoint here] end
	public void exportOperatingTheaterMedicalExaminationRecordExcludingIds(
			@Parameter(description = "The ids of the OperatingTheaterMedicalExaminationRecordEntities to exclude from the export")
			@RequestParam @NotNull List<UUID> ids, HttpServletResponse response
	) {
		List<OperatingTheaterMedicalExaminationRecordEntity> entitiesToExport;
		...
		if (ids == null || ids.size() == 0) {
			entitiesToExport = operatingTheaterMedicalExaminationRecordService.findAllExcludingIds(new ArrayList<>());
		} else {
			entitiesToExport = operatingTheaterMedicalExaminationRecordService.findAllExcludingIds(ids);
		}
	...
	/**
	 * Download a CSV file containing all of the headers of the OperatingTheaterMedicalExaminationRecord entity.
	...
	public void csvImportExample(
		...
		String datetime = new SimpleDateFormat("yyyy-MM-dd_HH-mm-ss").format(new Date());
		String fileName = "OperatingTheaterMedicalExaminationRecord_Import_Example_" + datetime + ".csv";
		// % protected region % [Modify the default file name for the Example Import endpoint here] end
		try {
			InputStream is = new ByteArrayInputStream(OperatingTheaterMedicalExaminationRecordEntity.getExampleCsvHeader().getBytes());
	...
	/**
	 * Upload a CSV file containing attributes for Operating Theater Medical Examination Record entities, and import them into the database.  This method
	...
	@PreAuthorize("hasPermission('OperatingTheaterMedicalExaminationRecordEntity', 'create')  || hasPermission('OperatingTheaterMedicalExaminationRecordEntity', 'update')")
	...
	public ResponseEntity<String> csvUpload(HttpServletRequest request,
			@Parameter(description = "The CSV file with OperatingTheaterMedicalExaminationRecordEntity entities to import")
		...
		CustomGrantedAuthority entityAuthority = authorities.stream().filter(x -> x.getTargetEntity().matches("OperatingTheaterMedicalExaminationRecordEntity"))
		...
		List<String> allowedHeaders = Arrays.asList(OperatingTheaterMedicalExaminationRecordEntity.getExampleCsvHeader().split(","));
		...
		CsvToBean<OperatingTheaterMedicalExaminationRecordEntity> csvToBean = new CsvToBeanBuilder<OperatingTheaterMedicalExaminationRecordEntity>(reader)
				.withType(OperatingTheaterMedicalExaminationRecordEntity.class)
				.withIgnoreLeadingWhiteSpace(true)
				.withThrowExceptions(true)
				.build();

		List<OperatingTheaterMedicalExaminationRecordEntity> entities = new ArrayList<>();
		...
		try {
			Iterator<OperatingTheaterMedicalExaminationRecordEntity> iterator = csvToBean.iterator();
				...
				try {
					...
					if (next.getId() != null && !allowUpdate) {
						return ResponseEntity.status(HttpStatus.FORBIDDEN).body("Line " + currentLine
								+ ": You attempted to update a Operating Theater Medical Examination Record entity and you do not have permission");
					}

					if (next.getId() == null && !allowCreate) {
						return ResponseEntity.status(HttpStatus.FORBIDDEN).body("Line " + currentLine
								+ ": You attempted to create a Operating Theater Medical Examination Record entity and you do not have permission");
					}
