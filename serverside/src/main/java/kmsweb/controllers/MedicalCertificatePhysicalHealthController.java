...
import kmsweb.entities.MedicalCertificatePhysicalHealthEntityAudit;
...
/**
 * Controller used to handle all REST operations regarding Medical Certificate Physical Health
 */
// % protected region % [Update the API route or description for the Medical Certificate Physical HealthController here] off begin
// The text associated with this tag can be found and edited in SwaggerConfig
@Tags(value = @Tag(name = "MedicalCertificatePhysicalHealthController"))
@RestController
@Slf4j
@RequestMapping("/api/medicalcertificatephysicalhealth")
// % protected region % [Update the API route or description for the Medical Certificate Physical HealthController here] end
public class MedicalCertificatePhysicalHealthController {

	private final MedicalCertificatePhysicalHealthService medicalCertificatePhysicalHealthService;
	private final CsvUtils<MedicalCertificatePhysicalHealthEntity, MedicalCertificatePhysicalHealthRepository, MedicalCertificatePhysicalHealthEntityAudit,  MedicalCertificatePhysicalHealthService> csvUtils;
	...
	@Autowired
	public MedicalCertificatePhysicalHealthController(
		...
		this.csvUtils = new CsvUtils<>(medicalCertificatePhysicalHealthService, MedicalCertificatePhysicalHealthEntity.class);
	...
	/**
	 * Return all the Medical Certificate Physical Healths.
	 *
	 * @return all the Medical Certificate Physical Healths
	 */
	// % protected region % [Update the route mapping or description for the 'getAllWithPage' endpoint here] off begin
	@Operation(
			description = "Returns a single page of MedicalCertificatePhysicalHealths",
		security = {
	...
	public ResponseEntity<List<MedicalCertificatePhysicalHealthEntity>> getAllWithPage(
			@Parameter(description = "The page to return.")
			@RequestParam(value = "page", defaultValue = "1", required = false) int page,
			@Parameter(description = "The size of the page to return.")
			@RequestParam(value = "pageSize", defaultValue = "10", required = false) int pageSize
	) {
		List<MedicalCertificatePhysicalHealthEntity> medicalCertificatePhysicalHealths = medicalCertificatePhysicalHealthService.findAllWithPage((page > 0) ? page - 1 : page, pageSize);
		...
		return new ResponseEntity<>(medicalCertificatePhysicalHealths, HttpStatus.OK);
	}

	/**
	 * Return the Medical Certificate Physical Health that has the same id as the given id.
	 *
	 * @param id      The id of the MedicalCertificatePhysicalHealthEntity to be returned
	 * @return the Medical Certificate Physical Health that has the same id as the given id
	 */
	...
	@Operation(
			description = "Return a single MedicalCertificatePhysicalHealth as defined by the id provided.",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "404", description = "MedicalCertificatePhysicalHealth entity not found"),
	})
	@PreAuthorize("hasPermission('MedicalCertificatePhysicalHealthEntity', 'read')")
	@GetMapping(value = "/{id}", produces = "application/json")
	// % protected region % [Update the route mapping or description for the 'getById' endpoint here] end
	public ResponseEntity<MedicalCertificatePhysicalHealthEntity> getById(
			@Parameter(description = "The UUID of the MedicalCertificatePhysicalHealth to return.")
			@PathVariable("id") UUID id
	) {
		Optional<MedicalCertificatePhysicalHealthEntity> medicalCertificatePhysicalHealthEntity = medicalCertificatePhysicalHealthService.findById(id);
	...
	/**
	 * Create/Update the given Medical Certificate Physical Health. If the entity has an id it will be updated, if not it will be created.
	 * The appropriate status codes will be set.
	 *
	 * @param medicalCertificatePhysicalHealthEntityDto The Dto of the entity to save or update
	 */
	// % protected region % [Update the route mapping or description for the 'saveMedicalCertificatePhysicalHealth' endpoint here] off begin
	@Operation(
			description = "Create a MedicalCertificatePhysicalHealth if id not exists. Return 409 otherwise",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Successfully created the new MedicalCertificatePhysicalHealth."),
			@ApiResponse(responseCode = "409", description = "Failed to create the new MedicalCertificatePhysicalHealth, duplicate record found")
	})
	@PreAuthorize("hasPermission('MedicalCertificatePhysicalHealthEntity', 'create')")
	@PostMapping
	// % protected region % [Update the route mapping or description for the 'saveMedicalCertificatePhysicalHealth' endpoint here] end
	public ResponseEntity<?> saveMedicalCertificatePhysicalHealth(
			@Parameter(description = "The MedicalCertificatePhysicalHealthEntity to create or update.")
			@RequestBody MedicalCertificatePhysicalHealthEntityDto medicalCertificatePhysicalHealthEntityDto
	) {
		// % protected region % [Add any logic before save here] off begin
		// % protected region % [Add any logic before save here] end

		try {
			MedicalCertificatePhysicalHealthEntity medicalCertificatePhysicalHealthEntity = medicalCertificatePhysicalHealthService.create(new MedicalCertificatePhysicalHealthEntity(medicalCertificatePhysicalHealthEntityDto));
			return new ResponseEntity<>(medicalCertificatePhysicalHealthEntity, HttpStatus.OK);
	...
	/**
	 * Update the given Medical Certificate Physical Health. If the entity has an id which is associated with an existing entity it will be updated, if not then the request will fail
	 * The appropriate status codes will be set.
	 *
	 * @param medicalCertificatePhysicalHealthEntityDto The Dto of the entity to save or update
	 */
	// % protected region % [Update the route mapping or description for the 'updateMedicalCertificatePhysicalHealth' endpoint here] off begin
	@Operation(
			description = "Update a MedicalCertificatePhysicalHealth entity if id exists and is associated with an existing entity.  Return BAD_REQUEST otherwise",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	@ApiResponses(value = {
		@ApiResponse(responseCode = "200", description = "Successfully updated the MedicalCertificatePhysicalHealth."),
		@ApiResponse(responseCode = "400", description = "Failed to update the MedicalCertificatePhysicalHealth, entity id either does not exist" +
				"or is not associated with an existing entity")
	})
	@PreAuthorize("hasPermission('MedicalCertificatePhysicalHealthEntity', 'update')")
	@PutMapping
	// % protected region % [Update the route mapping or description for the 'updateMedicalCertificatePhysicalHealth' endpoint here] end
	public ResponseEntity<?> updateMedicalCertificatePhysicalHealth(
			@Parameter(description = "The MedicalCertificatePhysicalHealthEntity to create or update.")
			@RequestBody MedicalCertificatePhysicalHealthEntityDto medicalCertificatePhysicalHealthEntityDto
	) {
		// % protected region % [Add any logic before update here] off begin
		// % protected region % [Add any logic before update here] end
		Optional<MedicalCertificatePhysicalHealthEntity> checkMedicalCertificatePhysicalHealthExists = medicalCertificatePhysicalHealthService.findById(medicalCertificatePhysicalHealthEntityDto.getId());
		MedicalCertificatePhysicalHealthEntity medicalCertificatePhysicalHealthEntity = new MedicalCertificatePhysicalHealthEntity(medicalCertificatePhysicalHealthEntityDto);

		if (checkMedicalCertificatePhysicalHealthExists.isPresent()) {
			try {
				medicalCertificatePhysicalHealthEntity = medicalCertificatePhysicalHealthService.update(medicalCertificatePhysicalHealthEntity);
				return new ResponseEntity<>(medicalCertificatePhysicalHealthEntity, HttpStatus.OK);
			} catch (ConstraintViolationException err) {
				return ControllerUtils.failedValidationApiResponse(err);
			}
		...
		return new ResponseEntity<>(medicalCertificatePhysicalHealthEntity, HttpStatus.BAD_REQUEST);
	}

	/**
	 * Delete the Medical Certificate Physical Health that has the same id as the given id.
	 *
	 * @param id The id of the MedicalCertificatePhysicalHealthEntity to be deleted
	...
	@Operation(
			description = "Delete a single MedicalCertificatePhysicalHealth as defined by the id provided.",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	public ResponseEntity<Void> deleteById(
			@Parameter(description = "The UUID of the MedicalCertificatePhysicalHealth to delete.")
		...
		medicalCertificatePhysicalHealthService.deleteById(id);
	 ...
	 */
	// % protected region % [Update the route mapping or description for the 'exportMedicalCertificatePhysicalHealth' endpoint here] off begin
	@Operation(
			description = "Download a csv file including all Medical Certificate Physical Health entities included in the ids provided",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	// % protected region % [Update the route mapping or description for the 'exportMedicalCertificatePhysicalHealth' endpoint here] end
	public void exportMedicalCertificatePhysicalHealth(
			@Parameter(description = "The ids of the MedicalCertificatePhysicalHealthEntities to export")
			@RequestParam @NotNull List<UUID> ids, HttpServletResponse response
	) {
		if (ids == null || ids.size() == 0) {
			response.setStatus(HttpServletResponse.SC_BAD_REQUEST);
		} else {
			List<MedicalCertificatePhysicalHealthEntity> entitiesToExport = medicalCertificatePhysicalHealthService.findAllByIds(ids);
			// % protected region % [Modify the default file name for the Export endpoint here] off begin
			String datetime = new SimpleDateFormat("yyyy-MM-dd_HH-mm-ss").format(new Date());
			String fileName = "MedicalCertificatePhysicalHealth_Export_" + datetime + ".csv";
			// % protected region % [Modify the default file name for the Export endpoint here] end

		for (MedicalCertificatePhysicalHealthEntity entity: entitiesToExport) {
	 ...
	 * @param response The response object
	 */
	// % protected region % [Update the route mapping or description for the 'exportMedicalCertificatePhysicalHealthExcludingIds' endpoint here] off begin
	@Operation(
	...
	// % protected region % [Update the route mapping or description for the 'exportMedicalCertificatePhysicalHealthExcludingIds' endpoint here] end
	public void exportMedicalCertificatePhysicalHealthExcludingIds(
			@Parameter(description = "The ids of the MedicalCertificatePhysicalHealthEntities to exclude from the export")
			@RequestParam @NotNull List<UUID> ids, HttpServletResponse response
	) {
		List<MedicalCertificatePhysicalHealthEntity> entitiesToExport;
		...
		if (ids == null || ids.size() == 0) {
			entitiesToExport = medicalCertificatePhysicalHealthService.findAllExcludingIds(new ArrayList<>());
		} else {
			entitiesToExport = medicalCertificatePhysicalHealthService.findAllExcludingIds(ids);
		}
	...
	/**
	 * Download a CSV file containing all of the headers of the MedicalCertificatePhysicalHealth entity.
	...
	public void csvImportExample(
		...
		String datetime = new SimpleDateFormat("yyyy-MM-dd_HH-mm-ss").format(new Date());
		String fileName = "MedicalCertificatePhysicalHealth_Import_Example_" + datetime + ".csv";
		// % protected region % [Modify the default file name for the Example Import endpoint here] end
		try {
			InputStream is = new ByteArrayInputStream(MedicalCertificatePhysicalHealthEntity.getExampleCsvHeader().getBytes());
	...
	/**
	 * Upload a CSV file containing attributes for Medical Certificate Physical Health entities, and import them into the database.  This method
	...
	@PreAuthorize("hasPermission('MedicalCertificatePhysicalHealthEntity', 'create')  || hasPermission('MedicalCertificatePhysicalHealthEntity', 'update')")
	...
	public ResponseEntity<String> csvUpload(HttpServletRequest request,
			@Parameter(description = "The CSV file with MedicalCertificatePhysicalHealthEntity entities to import")
		...
		CustomGrantedAuthority entityAuthority = authorities.stream().filter(x -> x.getTargetEntity().matches("MedicalCertificatePhysicalHealthEntity"))
		...
		List<String> allowedHeaders = Arrays.asList(MedicalCertificatePhysicalHealthEntity.getExampleCsvHeader().split(","));
		...
		CsvToBean<MedicalCertificatePhysicalHealthEntity> csvToBean = new CsvToBeanBuilder<MedicalCertificatePhysicalHealthEntity>(reader)
				.withType(MedicalCertificatePhysicalHealthEntity.class)
				.withIgnoreLeadingWhiteSpace(true)
				.withThrowExceptions(true)
				.build();

		List<MedicalCertificatePhysicalHealthEntity> entities = new ArrayList<>();
		...
		try {
			Iterator<MedicalCertificatePhysicalHealthEntity> iterator = csvToBean.iterator();
				...
				try {
					...
					if (next.getId() != null && !allowUpdate) {
						return ResponseEntity.status(HttpStatus.FORBIDDEN).body("Line " + currentLine
								+ ": You attempted to update a Medical Certificate Physical Health entity and you do not have permission");
					}

					if (next.getId() == null && !allowCreate) {
						return ResponseEntity.status(HttpStatus.FORBIDDEN).body("Line " + currentLine
								+ ": You attempted to create a Medical Certificate Physical Health entity and you do not have permission");
					}
