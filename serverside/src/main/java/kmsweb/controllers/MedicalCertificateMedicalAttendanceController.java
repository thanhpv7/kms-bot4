...
/**
 * Controller used to handle all REST operations regarding Medical Certificate Medical Attendance
 */
// % protected region % [Update the API route or description for the Medical Certificate Medical AttendanceController here] off begin
// The text associated with this tag can be found and edited in SwaggerConfig
@Tags(value = @Tag(name = "MedicalCertificateMedicalAttendanceController"))
@RestController
@Slf4j
@RequestMapping("/api/medicalcertificatemedicalattendance")
// % protected region % [Update the API route or description for the Medical Certificate Medical AttendanceController here] end
public class MedicalCertificateMedicalAttendanceController {

	private final MedicalCertificateMedicalAttendanceService medicalCertificateMedicalAttendanceService;
	private final CsvUtils<MedicalCertificateMedicalAttendanceEntity, MedicalCertificateMedicalAttendanceRepository, MedicalCertificateMedicalAttendanceEntityAudit,  MedicalCertificateMedicalAttendanceService> csvUtils;
	...
	@Autowired
	public MedicalCertificateMedicalAttendanceController(
		...
		this.csvUtils = new CsvUtils<>(medicalCertificateMedicalAttendanceService, MedicalCertificateMedicalAttendanceEntity.class);
	...
	/**
	 * Return all the Medical Certificate Medical Attendances.
	 *
	 * @return all the Medical Certificate Medical Attendances
	 */
	// % protected region % [Update the route mapping or description for the 'getAllWithPage' endpoint here] off begin
	@Operation(
			description = "Returns a single page of MedicalCertificateMedicalAttendances",
		security = {
	...
	public ResponseEntity<List<MedicalCertificateMedicalAttendanceEntity>> getAllWithPage(
			@Parameter(description = "The page to return.")
			@RequestParam(value = "page", defaultValue = "1", required = false) int page,
			@Parameter(description = "The size of the page to return.")
			@RequestParam(value = "pageSize", defaultValue = "10", required = false) int pageSize
	) {
		List<MedicalCertificateMedicalAttendanceEntity> medicalCertificateMedicalAttendances = medicalCertificateMedicalAttendanceService.findAllWithPage((page > 0) ? page - 1 : page, pageSize);
		...
		return new ResponseEntity<>(medicalCertificateMedicalAttendances, HttpStatus.OK);
	}

	/**
	 * Return the Medical Certificate Medical Attendance that has the same id as the given id.
	 *
	 * @param id      The id of the MedicalCertificateMedicalAttendanceEntity to be returned
	 * @return the Medical Certificate Medical Attendance that has the same id as the given id
	 */
	...
	@Operation(
			description = "Return a single MedicalCertificateMedicalAttendance as defined by the id provided.",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "404", description = "MedicalCertificateMedicalAttendance entity not found"),
	})
	@PreAuthorize("hasPermission('MedicalCertificateMedicalAttendanceEntity', 'read')")
	@GetMapping(value = "/{id}", produces = "application/json")
	// % protected region % [Update the route mapping or description for the 'getById' endpoint here] end
	public ResponseEntity<MedicalCertificateMedicalAttendanceEntity> getById(
			@Parameter(description = "The UUID of the MedicalCertificateMedicalAttendance to return.")
			@PathVariable("id") UUID id
	) {
		Optional<MedicalCertificateMedicalAttendanceEntity> medicalCertificateMedicalAttendanceEntity = medicalCertificateMedicalAttendanceService.findById(id);
	...
	/**
	 * Create/Update the given Medical Certificate Medical Attendance. If the entity has an id it will be updated, if not it will be created.
	 * The appropriate status codes will be set.
	 *
	 * @param medicalCertificateMedicalAttendanceEntityDto The Dto of the entity to save or update
	 */
	// % protected region % [Update the route mapping or description for the 'saveMedicalCertificateMedicalAttendance' endpoint here] off begin
	@Operation(
			description = "Create a MedicalCertificateMedicalAttendance if id not exists. Return 409 otherwise",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Successfully created the new MedicalCertificateMedicalAttendance."),
			@ApiResponse(responseCode = "409", description = "Failed to create the new MedicalCertificateMedicalAttendance, duplicate record found")
	})
	@PreAuthorize("hasPermission('MedicalCertificateMedicalAttendanceEntity', 'create')")
	@PostMapping
	// % protected region % [Update the route mapping or description for the 'saveMedicalCertificateMedicalAttendance' endpoint here] end
	public ResponseEntity<?> saveMedicalCertificateMedicalAttendance(
			@Parameter(description = "The MedicalCertificateMedicalAttendanceEntity to create or update.")
			@RequestBody MedicalCertificateMedicalAttendanceEntityDto medicalCertificateMedicalAttendanceEntityDto
	) {
		// % protected region % [Add any logic before save here] off begin
		// % protected region % [Add any logic before save here] end

		try {
			MedicalCertificateMedicalAttendanceEntity medicalCertificateMedicalAttendanceEntity = medicalCertificateMedicalAttendanceService.create(new MedicalCertificateMedicalAttendanceEntity(medicalCertificateMedicalAttendanceEntityDto));
			return new ResponseEntity<>(medicalCertificateMedicalAttendanceEntity, HttpStatus.OK);
	...
	/**
	 * Update the given Medical Certificate Medical Attendance. If the entity has an id which is associated with an existing entity it will be updated, if not then the request will fail
	 * The appropriate status codes will be set.
	 *
	 * @param medicalCertificateMedicalAttendanceEntityDto The Dto of the entity to save or update
	 */
	// % protected region % [Update the route mapping or description for the 'updateMedicalCertificateMedicalAttendance' endpoint here] off begin
	@Operation(
			description = "Update a MedicalCertificateMedicalAttendance entity if id exists and is associated with an existing entity.  Return BAD_REQUEST otherwise",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	@ApiResponses(value = {
		@ApiResponse(responseCode = "200", description = "Successfully updated the MedicalCertificateMedicalAttendance."),
		@ApiResponse(responseCode = "400", description = "Failed to update the MedicalCertificateMedicalAttendance, entity id either does not exist" +
				"or is not associated with an existing entity")
	})
	@PreAuthorize("hasPermission('MedicalCertificateMedicalAttendanceEntity', 'update')")
	@PutMapping
	// % protected region % [Update the route mapping or description for the 'updateMedicalCertificateMedicalAttendance' endpoint here] end
	public ResponseEntity<?> updateMedicalCertificateMedicalAttendance(
			@Parameter(description = "The MedicalCertificateMedicalAttendanceEntity to create or update.")
			@RequestBody MedicalCertificateMedicalAttendanceEntityDto medicalCertificateMedicalAttendanceEntityDto
	) {
		// % protected region % [Add any logic before update here] off begin
		// % protected region % [Add any logic before update here] end
		Optional<MedicalCertificateMedicalAttendanceEntity> checkMedicalCertificateMedicalAttendanceExists = medicalCertificateMedicalAttendanceService.findById(medicalCertificateMedicalAttendanceEntityDto.getId());
		MedicalCertificateMedicalAttendanceEntity medicalCertificateMedicalAttendanceEntity = new MedicalCertificateMedicalAttendanceEntity(medicalCertificateMedicalAttendanceEntityDto);

		if (checkMedicalCertificateMedicalAttendanceExists.isPresent()) {
			try {
				medicalCertificateMedicalAttendanceEntity = medicalCertificateMedicalAttendanceService.update(medicalCertificateMedicalAttendanceEntity);
				return new ResponseEntity<>(medicalCertificateMedicalAttendanceEntity, HttpStatus.OK);
			} catch (ConstraintViolationException err) {
				return ControllerUtils.failedValidationApiResponse(err);
			}
		...
		return new ResponseEntity<>(medicalCertificateMedicalAttendanceEntity, HttpStatus.BAD_REQUEST);
	}

	/**
	 * Delete the Medical Certificate Medical Attendance that has the same id as the given id.
	 *
	 * @param id The id of the MedicalCertificateMedicalAttendanceEntity to be deleted
	...
	@Operation(
			description = "Delete a single MedicalCertificateMedicalAttendance as defined by the id provided.",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	public ResponseEntity<Void> deleteById(
			@Parameter(description = "The UUID of the MedicalCertificateMedicalAttendance to delete.")
		...
		medicalCertificateMedicalAttendanceService.deleteById(id);
	 ...
	 */
	// % protected region % [Update the route mapping or description for the 'exportMedicalCertificateMedicalAttendance' endpoint here] off begin
	@Operation(
			description = "Download a csv file including all Medical Certificate Medical Attendance entities included in the ids provided",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	// % protected region % [Update the route mapping or description for the 'exportMedicalCertificateMedicalAttendance' endpoint here] end
	public void exportMedicalCertificateMedicalAttendance(
			@Parameter(description = "The ids of the MedicalCertificateMedicalAttendanceEntities to export")
			@RequestParam @NotNull List<UUID> ids, HttpServletResponse response
	) {
		if (ids == null || ids.size() == 0) {
			response.setStatus(HttpServletResponse.SC_BAD_REQUEST);
		} else {
			List<MedicalCertificateMedicalAttendanceEntity> entitiesToExport = medicalCertificateMedicalAttendanceService.findAllByIds(ids);
			// % protected region % [Modify the default file name for the Export endpoint here] off begin
			String datetime = new SimpleDateFormat("yyyy-MM-dd_HH-mm-ss").format(new Date());
			String fileName = "MedicalCertificateMedicalAttendance_Export_" + datetime + ".csv";
			// % protected region % [Modify the default file name for the Export endpoint here] end

		for (MedicalCertificateMedicalAttendanceEntity entity: entitiesToExport) {
	 ...
	 * @param response The response object
	 */
	// % protected region % [Update the route mapping or description for the 'exportMedicalCertificateMedicalAttendanceExcludingIds' endpoint here] off begin
	@Operation(
	...
	// % protected region % [Update the route mapping or description for the 'exportMedicalCertificateMedicalAttendanceExcludingIds' endpoint here] end
	public void exportMedicalCertificateMedicalAttendanceExcludingIds(
			@Parameter(description = "The ids of the MedicalCertificateMedicalAttendanceEntities to exclude from the export")
			@RequestParam @NotNull List<UUID> ids, HttpServletResponse response
	) {
		List<MedicalCertificateMedicalAttendanceEntity> entitiesToExport;
		...
		if (ids == null || ids.size() == 0) {
			entitiesToExport = medicalCertificateMedicalAttendanceService.findAllExcludingIds(new ArrayList<>());
		} else {
			entitiesToExport = medicalCertificateMedicalAttendanceService.findAllExcludingIds(ids);
		}
	...
	/**
	 * Download a CSV file containing all of the headers of the MedicalCertificateMedicalAttendance entity.
	...
	public void csvImportExample(
		...
		String datetime = new SimpleDateFormat("yyyy-MM-dd_HH-mm-ss").format(new Date());
		String fileName = "MedicalCertificateMedicalAttendance_Import_Example_" + datetime + ".csv";
		// % protected region % [Modify the default file name for the Example Import endpoint here] end
		try {
			InputStream is = new ByteArrayInputStream(MedicalCertificateMedicalAttendanceEntity.getExampleCsvHeader().getBytes());
	...
	/**
	 * Upload a CSV file containing attributes for Medical Certificate Medical Attendance entities, and import them into the database.  This method
	...
	@PreAuthorize("hasPermission('MedicalCertificateMedicalAttendanceEntity', 'create')  || hasPermission('MedicalCertificateMedicalAttendanceEntity', 'update')")
	...
	public ResponseEntity<String> csvUpload(HttpServletRequest request,
			@Parameter(description = "The CSV file with MedicalCertificateMedicalAttendanceEntity entities to import")
		...
		CustomGrantedAuthority entityAuthority = authorities.stream().filter(x -> x.getTargetEntity().matches("MedicalCertificateMedicalAttendanceEntity"))
		...
		List<String> allowedHeaders = Arrays.asList(MedicalCertificateMedicalAttendanceEntity.getExampleCsvHeader().split(","));
		...
		CsvToBean<MedicalCertificateMedicalAttendanceEntity> csvToBean = new CsvToBeanBuilder<MedicalCertificateMedicalAttendanceEntity>(reader)
				.withType(MedicalCertificateMedicalAttendanceEntity.class)
				.withIgnoreLeadingWhiteSpace(true)
				.withThrowExceptions(true)
				.build();

		List<MedicalCertificateMedicalAttendanceEntity> entities = new ArrayList<>();
		...
		try {
			Iterator<MedicalCertificateMedicalAttendanceEntity> iterator = csvToBean.iterator();
				...
				try {
					...
					if (next.getId() != null && !allowUpdate) {
						return ResponseEntity.status(HttpStatus.FORBIDDEN).body("Line " + currentLine
								+ ": You attempted to update a Medical Certificate Medical Attendance entity and you do not have permission");
					}

					if (next.getId() == null && !allowCreate) {
						return ResponseEntity.status(HttpStatus.FORBIDDEN).body("Line " + currentLine
								+ ": You attempted to create a Medical Certificate Medical Attendance entity and you do not have permission");
					}
