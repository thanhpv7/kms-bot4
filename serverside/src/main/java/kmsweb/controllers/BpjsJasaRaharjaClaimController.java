...
import kmsweb.entities.BpjsJasaRaharjaClaimEntityAudit;
import kmsweb.repositories.BpjsJasaRaharjaClaimRepository;
import kmsweb.services.BpjsJasaRaharjaClaimService;
...
/**
 * Controller used to handle all REST operations regarding BPJS Jasa Raharja Claim
 */
// % protected region % [Update the API route or description for the BPJS Jasa Raharja ClaimController here] off begin
// The text associated with this tag can be found and edited in SwaggerConfig
@Tags(value = @Tag(name = "BpjsJasaRaharjaClaimController"))
@RestController
@Slf4j
@RequestMapping("/api/bpjsjasaraharjaclaim")
// % protected region % [Update the API route or description for the BPJS Jasa Raharja ClaimController here] end
public class BpjsJasaRaharjaClaimController {

	private final BpjsJasaRaharjaClaimService bpjsJasaRaharjaClaimService;
	private final CsvUtils<BpjsJasaRaharjaClaimEntity, BpjsJasaRaharjaClaimRepository, BpjsJasaRaharjaClaimEntityAudit,  BpjsJasaRaharjaClaimService> csvUtils;
	...
	@Autowired
	public BpjsJasaRaharjaClaimController(
			// % protected region % [Add any additional constructor parameters here] off begin
			// % protected region % [Add any additional constructor parameters here] end
			AuthenticationService authService,
			BpjsJasaRaharjaClaimService bpjsJasaRaharjaClaimService
	) {
		this.authService = authService;
		this.bpjsJasaRaharjaClaimService = bpjsJasaRaharjaClaimService;
		this.csvUtils = new CsvUtils<>(bpjsJasaRaharjaClaimService, BpjsJasaRaharjaClaimEntity.class);
	...
	@PreAuthorize("hasPermission('BpjsJasaRaharjaClaimEntity', 'read')")
	@GetMapping(produces = "application/json")
	// % protected region % [Update the route mapping or description for the 'getAllWithPage' endpoint here] end
	public ResponseEntity<List<BpjsJasaRaharjaClaimEntity>> getAllWithPage(
			@Parameter(description = "The page to return.")
			@RequestParam(value = "page", defaultValue = "1", required = false) int page,
			@Parameter(description = "The size of the page to return.")
			@RequestParam(value = "pageSize", defaultValue = "10", required = false) int pageSize
	) {
		List<BpjsJasaRaharjaClaimEntity> bpjsJasaRaharjaClaims = bpjsJasaRaharjaClaimService.findAllWithPage((page > 0) ? page - 1 : page, pageSize);
		...
		return new ResponseEntity<>(bpjsJasaRaharjaClaims, HttpStatus.OK);
	}

	/**
	 * Return the BPJS Jasa Raharja Claim that has the same id as the given id.
	 *
	 * @param id      The id of the BpjsJasaRaharjaClaimEntity to be returned
	 * @return the BPJS Jasa Raharja Claim that has the same id as the given id
	 */
	...
	@Operation(
			description = "Return a single BpjsJasaRaharjaClaim as defined by the id provided.",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "404", description = "BpjsJasaRaharjaClaim entity not found"),
	})
	@PreAuthorize("hasPermission('BpjsJasaRaharjaClaimEntity', 'read')")
	@GetMapping(value = "/{id}", produces = "application/json")
	// % protected region % [Update the route mapping or description for the 'getById' endpoint here] end
	public ResponseEntity<BpjsJasaRaharjaClaimEntity> getById(
			@Parameter(description = "The UUID of the BpjsJasaRaharjaClaim to return.")
			@PathVariable("id") UUID id
	) {
		Optional<BpjsJasaRaharjaClaimEntity> bpjsJasaRaharjaClaimEntity = bpjsJasaRaharjaClaimService.findById(id);
	...
	/**
	 * Create/Update the given BPJS Jasa Raharja Claim. If the entity has an id it will be updated, if not it will be created.
	 * The appropriate status codes will be set.
	 *
	 * @param bpjsJasaRaharjaClaimEntityDto The Dto of the entity to save or update
	 */
	// % protected region % [Update the route mapping or description for the 'saveBpjsJasaRaharjaClaim' endpoint here] off begin
	@Operation(
			description = "Create a BpjsJasaRaharjaClaim if id not exists. Return 409 otherwise",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Successfully created the new BpjsJasaRaharjaClaim."),
			@ApiResponse(responseCode = "409", description = "Failed to create the new BpjsJasaRaharjaClaim, duplicate record found")
	})
	@PreAuthorize("hasPermission('BpjsJasaRaharjaClaimEntity', 'create')")
	@PostMapping
	// % protected region % [Update the route mapping or description for the 'saveBpjsJasaRaharjaClaim' endpoint here] end
	public ResponseEntity<?> saveBpjsJasaRaharjaClaim(
			@Parameter(description = "The BpjsJasaRaharjaClaimEntity to create or update.")
			@RequestBody BpjsJasaRaharjaClaimEntityDto bpjsJasaRaharjaClaimEntityDto
	) {
		// % protected region % [Add any logic before save here] off begin
		// % protected region % [Add any logic before save here] end

		try {
			BpjsJasaRaharjaClaimEntity bpjsJasaRaharjaClaimEntity = bpjsJasaRaharjaClaimService.create(new BpjsJasaRaharjaClaimEntity(bpjsJasaRaharjaClaimEntityDto));
			return new ResponseEntity<>(bpjsJasaRaharjaClaimEntity, HttpStatus.OK);
	...
	/**
	 * Update the given BPJS Jasa Raharja Claim. If the entity has an id which is associated with an existing entity it will be updated, if not then the request will fail
	 * The appropriate status codes will be set.
	 *
	 * @param bpjsJasaRaharjaClaimEntityDto The Dto of the entity to save or update
	 */
	// % protected region % [Update the route mapping or description for the 'updateBpjsJasaRaharjaClaim' endpoint here] off begin
	@Operation(
			description = "Update a BpjsJasaRaharjaClaim entity if id exists and is associated with an existing entity.  Return BAD_REQUEST otherwise",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	@ApiResponses(value = {
		@ApiResponse(responseCode = "200", description = "Successfully updated the BpjsJasaRaharjaClaim."),
		@ApiResponse(responseCode = "400", description = "Failed to update the BpjsJasaRaharjaClaim, entity id either does not exist" +
				"or is not associated with an existing entity")
	})
	@PreAuthorize("hasPermission('BpjsJasaRaharjaClaimEntity', 'update')")
	@PutMapping
	// % protected region % [Update the route mapping or description for the 'updateBpjsJasaRaharjaClaim' endpoint here] end
	public ResponseEntity<?> updateBpjsJasaRaharjaClaim(
			@Parameter(description = "The BpjsJasaRaharjaClaimEntity to create or update.")
			@RequestBody BpjsJasaRaharjaClaimEntityDto bpjsJasaRaharjaClaimEntityDto
	) {
		// % protected region % [Add any logic before update here] off begin
		// % protected region % [Add any logic before update here] end
		Optional<BpjsJasaRaharjaClaimEntity> checkBpjsJasaRaharjaClaimExists = bpjsJasaRaharjaClaimService.findById(bpjsJasaRaharjaClaimEntityDto.getId());
		BpjsJasaRaharjaClaimEntity bpjsJasaRaharjaClaimEntity = new BpjsJasaRaharjaClaimEntity(bpjsJasaRaharjaClaimEntityDto);

		if (checkBpjsJasaRaharjaClaimExists.isPresent()) {
			try {
				bpjsJasaRaharjaClaimEntity = bpjsJasaRaharjaClaimService.update(bpjsJasaRaharjaClaimEntity);
				return new ResponseEntity<>(bpjsJasaRaharjaClaimEntity, HttpStatus.OK);
			} catch (ConstraintViolationException err) {
				return ControllerUtils.failedValidationApiResponse(err);
			}
		...
		return new ResponseEntity<>(bpjsJasaRaharjaClaimEntity, HttpStatus.BAD_REQUEST);
	}

	/**
	 * Delete the BPJS Jasa Raharja Claim that has the same id as the given id.
	 *
	 * @param id The id of the BpjsJasaRaharjaClaimEntity to be deleted
	...
	@Operation(
			description = "Delete a single BpjsJasaRaharjaClaim as defined by the id provided.",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	@PreAuthorize("hasPermission('BpjsJasaRaharjaClaimEntity', 'delete')")
	@DeleteMapping(value = "/{id}")
	// % protected region % [Update the route mapping or description for the 'deleteById' endpoint here] end
	public ResponseEntity<Void> deleteById(
			@Parameter(description = "The UUID of the BpjsJasaRaharjaClaim to delete.")
		...
		bpjsJasaRaharjaClaimService.deleteById(id);
	 ...
	 */
	// % protected region % [Update the route mapping or description for the 'exportBpjsJasaRaharjaClaim' endpoint here] off begin
	@Operation(
			description = "Download a csv file including all BPJS Jasa Raharja Claim entities included in the ids provided",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	// % protected region % [Update the route mapping or description for the 'exportBpjsJasaRaharjaClaim' endpoint here] end
	public void exportBpjsJasaRaharjaClaim(
			@Parameter(description = "The ids of the BpjsJasaRaharjaClaimEntities to export")
			@RequestParam @NotNull List<UUID> ids, HttpServletResponse response
	) {
		if (ids == null || ids.size() == 0) {
			response.setStatus(HttpServletResponse.SC_BAD_REQUEST);
		} else {
			List<BpjsJasaRaharjaClaimEntity> entitiesToExport = bpjsJasaRaharjaClaimService.findAllByIds(ids);
			// % protected region % [Modify the default file name for the Export endpoint here] off begin
			String datetime = new SimpleDateFormat("yyyy-MM-dd_HH-mm-ss").format(new Date());
			String fileName = "BpjsJasaRaharjaClaim_Export_" + datetime + ".csv";
			// % protected region % [Modify the default file name for the Export endpoint here] end

		for (BpjsJasaRaharjaClaimEntity entity: entitiesToExport) {
	 ...
	 * @param response The response object
	 */
	// % protected region % [Update the route mapping or description for the 'exportBpjsJasaRaharjaClaimExcludingIds' endpoint here] off begin
	@Operation(
	...
	// % protected region % [Update the route mapping or description for the 'exportBpjsJasaRaharjaClaimExcludingIds' endpoint here] end
	public void exportBpjsJasaRaharjaClaimExcludingIds(
			@Parameter(description = "The ids of the BpjsJasaRaharjaClaimEntities to exclude from the export")
			@RequestParam @NotNull List<UUID> ids, HttpServletResponse response
	) {
		List<BpjsJasaRaharjaClaimEntity> entitiesToExport;
		...
		if (ids == null || ids.size() == 0) {
			entitiesToExport = bpjsJasaRaharjaClaimService.findAllExcludingIds(new ArrayList<>());
		} else {
			entitiesToExport = bpjsJasaRaharjaClaimService.findAllExcludingIds(ids);
		}
	...
	/**
	 * Download a CSV file containing all of the headers of the BpjsJasaRaharjaClaim entity.
	...
	public void csvImportExample(
		...
		String datetime = new SimpleDateFormat("yyyy-MM-dd_HH-mm-ss").format(new Date());
		String fileName = "BpjsJasaRaharjaClaim_Import_Example_" + datetime + ".csv";
		// % protected region % [Modify the default file name for the Example Import endpoint here] end
		try {
			InputStream is = new ByteArrayInputStream(BpjsJasaRaharjaClaimEntity.getExampleCsvHeader().getBytes());
	...
	/**
	 * Upload a CSV file containing attributes for BPJS Jasa Raharja Claim entities, and import them into the database.  This method
	...
	@PreAuthorize("hasPermission('BpjsJasaRaharjaClaimEntity', 'create')  || hasPermission('BpjsJasaRaharjaClaimEntity', 'update')")
	...
	public ResponseEntity<String> csvUpload(HttpServletRequest request,
			@Parameter(description = "The CSV file with BpjsJasaRaharjaClaimEntity entities to import")
		...
		CustomGrantedAuthority entityAuthority = authorities.stream().filter(x -> x.getTargetEntity().matches("BpjsJasaRaharjaClaimEntity"))
		...
		List<String> allowedHeaders = Arrays.asList(BpjsJasaRaharjaClaimEntity.getExampleCsvHeader().split(","));
		...
		CsvToBean<BpjsJasaRaharjaClaimEntity> csvToBean = new CsvToBeanBuilder<BpjsJasaRaharjaClaimEntity>(reader)
				.withType(BpjsJasaRaharjaClaimEntity.class)
				.withIgnoreLeadingWhiteSpace(true)
				.withThrowExceptions(true)
				.build();

		List<BpjsJasaRaharjaClaimEntity> entities = new ArrayList<>();
		...
		try {
			Iterator<BpjsJasaRaharjaClaimEntity> iterator = csvToBean.iterator();
				...
				try {
					...
					if (next.getId() != null && !allowUpdate) {
						return ResponseEntity.status(HttpStatus.FORBIDDEN).body("Line " + currentLine
								+ ": You attempted to update a BPJS Jasa Raharja Claim entity and you do not have permission");
					}

					if (next.getId() == null && !allowCreate) {
						return ResponseEntity.status(HttpStatus.FORBIDDEN).body("Line " + currentLine
								+ ": You attempted to create a BPJS Jasa Raharja Claim entity and you do not have permission");
					}
