...
import kmsweb.entities.EmergencyMedicalExaminationRecordEntityAudit;
...
/**
 * Controller used to handle all REST operations regarding Emergency Medical Examination Record
 */
// % protected region % [Update the API route or description for the Emergency Medical Examination RecordController here] off begin
// The text associated with this tag can be found and edited in SwaggerConfig
@Tags(value = @Tag(name = "EmergencyMedicalExaminationRecordController"))
@RestController
@Slf4j
@RequestMapping("/api/emergencymedicalexaminationrecord")
// % protected region % [Update the API route or description for the Emergency Medical Examination RecordController here] end
public class EmergencyMedicalExaminationRecordController {

	private final EmergencyMedicalExaminationRecordService emergencyMedicalExaminationRecordService;
	private final CsvUtils<EmergencyMedicalExaminationRecordEntity, EmergencyMedicalExaminationRecordRepository, EmergencyMedicalExaminationRecordEntityAudit,  EmergencyMedicalExaminationRecordService> csvUtils;
	...
	@Autowired
	public EmergencyMedicalExaminationRecordController(
		...
		this.csvUtils = new CsvUtils<>(emergencyMedicalExaminationRecordService, EmergencyMedicalExaminationRecordEntity.class);
	...
	/**
	 * Return all the Emergency Medical Examination Records.
	 *
	 * @return all the Emergency Medical Examination Records
	 */
	// % protected region % [Update the route mapping or description for the 'getAllWithPage' endpoint here] off begin
	@Operation(
			description = "Returns a single page of EmergencyMedicalExaminationRecords",
		security = {
	...
	public ResponseEntity<List<EmergencyMedicalExaminationRecordEntity>> getAllWithPage(
			@Parameter(description = "The page to return.")
			@RequestParam(value = "page", defaultValue = "1", required = false) int page,
			@Parameter(description = "The size of the page to return.")
			@RequestParam(value = "pageSize", defaultValue = "10", required = false) int pageSize
	) {
		List<EmergencyMedicalExaminationRecordEntity> emergencyMedicalExaminationRecords = emergencyMedicalExaminationRecordService.findAllWithPage((page > 0) ? page - 1 : page, pageSize);
		...
		return new ResponseEntity<>(emergencyMedicalExaminationRecords, HttpStatus.OK);
	}

	/**
	 * Return the Emergency Medical Examination Record that has the same id as the given id.
	 *
	 * @param id      The id of the EmergencyMedicalExaminationRecordEntity to be returned
	 * @return the Emergency Medical Examination Record that has the same id as the given id
	 */
	...
	@Operation(
			description = "Return a single EmergencyMedicalExaminationRecord as defined by the id provided.",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "404", description = "EmergencyMedicalExaminationRecord entity not found"),
	})
	@PreAuthorize("hasPermission('EmergencyMedicalExaminationRecordEntity', 'read')")
	@GetMapping(value = "/{id}", produces = "application/json")
	// % protected region % [Update the route mapping or description for the 'getById' endpoint here] end
	public ResponseEntity<EmergencyMedicalExaminationRecordEntity> getById(
			@Parameter(description = "The UUID of the EmergencyMedicalExaminationRecord to return.")
			@PathVariable("id") UUID id
	) {
		Optional<EmergencyMedicalExaminationRecordEntity> emergencyMedicalExaminationRecordEntity = emergencyMedicalExaminationRecordService.findById(id);
	...
	/**
	 * Create/Update the given Emergency Medical Examination Record. If the entity has an id it will be updated, if not it will be created.
	 * The appropriate status codes will be set.
	 *
	 * @param emergencyMedicalExaminationRecordEntityDto The Dto of the entity to save or update
	 */
	// % protected region % [Update the route mapping or description for the 'saveEmergencyMedicalExaminationRecord' endpoint here] off begin
	@Operation(
			description = "Create a EmergencyMedicalExaminationRecord if id not exists. Return 409 otherwise",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Successfully created the new EmergencyMedicalExaminationRecord."),
			@ApiResponse(responseCode = "409", description = "Failed to create the new EmergencyMedicalExaminationRecord, duplicate record found")
	})
	@PreAuthorize("hasPermission('EmergencyMedicalExaminationRecordEntity', 'create')")
	@PostMapping
	// % protected region % [Update the route mapping or description for the 'saveEmergencyMedicalExaminationRecord' endpoint here] end
	public ResponseEntity<?> saveEmergencyMedicalExaminationRecord(
			@Parameter(description = "The EmergencyMedicalExaminationRecordEntity to create or update.")
			@RequestBody EmergencyMedicalExaminationRecordEntityDto emergencyMedicalExaminationRecordEntityDto
	) {
		// % protected region % [Add any logic before save here] off begin
		// % protected region % [Add any logic before save here] end

		try {
			EmergencyMedicalExaminationRecordEntity emergencyMedicalExaminationRecordEntity = emergencyMedicalExaminationRecordService.create(new EmergencyMedicalExaminationRecordEntity(emergencyMedicalExaminationRecordEntityDto));
			return new ResponseEntity<>(emergencyMedicalExaminationRecordEntity, HttpStatus.OK);
	...
	/**
	 * Update the given Emergency Medical Examination Record. If the entity has an id which is associated with an existing entity it will be updated, if not then the request will fail
	 * The appropriate status codes will be set.
	 *
	 * @param emergencyMedicalExaminationRecordEntityDto The Dto of the entity to save or update
	 */
	// % protected region % [Update the route mapping or description for the 'updateEmergencyMedicalExaminationRecord' endpoint here] off begin
	@Operation(
			description = "Update a EmergencyMedicalExaminationRecord entity if id exists and is associated with an existing entity.  Return BAD_REQUEST otherwise",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	@ApiResponses(value = {
		@ApiResponse(responseCode = "200", description = "Successfully updated the EmergencyMedicalExaminationRecord."),
		@ApiResponse(responseCode = "400", description = "Failed to update the EmergencyMedicalExaminationRecord, entity id either does not exist" +
				"or is not associated with an existing entity")
	})
	@PreAuthorize("hasPermission('EmergencyMedicalExaminationRecordEntity', 'update')")
	@PutMapping
	// % protected region % [Update the route mapping or description for the 'updateEmergencyMedicalExaminationRecord' endpoint here] end
	public ResponseEntity<?> updateEmergencyMedicalExaminationRecord(
			@Parameter(description = "The EmergencyMedicalExaminationRecordEntity to create or update.")
			@RequestBody EmergencyMedicalExaminationRecordEntityDto emergencyMedicalExaminationRecordEntityDto
	) {
		// % protected region % [Add any logic before update here] off begin
		// % protected region % [Add any logic before update here] end
		Optional<EmergencyMedicalExaminationRecordEntity> checkEmergencyMedicalExaminationRecordExists = emergencyMedicalExaminationRecordService.findById(emergencyMedicalExaminationRecordEntityDto.getId());
		EmergencyMedicalExaminationRecordEntity emergencyMedicalExaminationRecordEntity = new EmergencyMedicalExaminationRecordEntity(emergencyMedicalExaminationRecordEntityDto);

		if (checkEmergencyMedicalExaminationRecordExists.isPresent()) {
			try {
				emergencyMedicalExaminationRecordEntity = emergencyMedicalExaminationRecordService.update(emergencyMedicalExaminationRecordEntity);
				return new ResponseEntity<>(emergencyMedicalExaminationRecordEntity, HttpStatus.OK);
			} catch (ConstraintViolationException err) {
				return ControllerUtils.failedValidationApiResponse(err);
			}
		...
		return new ResponseEntity<>(emergencyMedicalExaminationRecordEntity, HttpStatus.BAD_REQUEST);
	}

	/**
	 * Delete the Emergency Medical Examination Record that has the same id as the given id.
	 *
	 * @param id The id of the EmergencyMedicalExaminationRecordEntity to be deleted
	...
	@Operation(
			description = "Delete a single EmergencyMedicalExaminationRecord as defined by the id provided.",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	public ResponseEntity<Void> deleteById(
			@Parameter(description = "The UUID of the EmergencyMedicalExaminationRecord to delete.")
		...
		emergencyMedicalExaminationRecordService.deleteById(id);
	 ...
	 */
	// % protected region % [Update the route mapping or description for the 'exportEmergencyMedicalExaminationRecord' endpoint here] off begin
	@Operation(
			description = "Download a csv file including all Emergency Medical Examination Record entities included in the ids provided",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	// % protected region % [Update the route mapping or description for the 'exportEmergencyMedicalExaminationRecord' endpoint here] end
	public void exportEmergencyMedicalExaminationRecord(
			@Parameter(description = "The ids of the EmergencyMedicalExaminationRecordEntities to export")
			@RequestParam @NotNull List<UUID> ids, HttpServletResponse response
	) {
		if (ids == null || ids.size() == 0) {
			response.setStatus(HttpServletResponse.SC_BAD_REQUEST);
		} else {
			List<EmergencyMedicalExaminationRecordEntity> entitiesToExport = emergencyMedicalExaminationRecordService.findAllByIds(ids);
			// % protected region % [Modify the default file name for the Export endpoint here] off begin
			String datetime = new SimpleDateFormat("yyyy-MM-dd_HH-mm-ss").format(new Date());
			String fileName = "EmergencyMedicalExaminationRecord_Export_" + datetime + ".csv";
			// % protected region % [Modify the default file name for the Export endpoint here] end

		for (EmergencyMedicalExaminationRecordEntity entity: entitiesToExport) {
	 ...
	 * @param response The response object
	 */
	// % protected region % [Update the route mapping or description for the 'exportEmergencyMedicalExaminationRecordExcludingIds' endpoint here] off begin
	@Operation(
	...
	// % protected region % [Update the route mapping or description for the 'exportEmergencyMedicalExaminationRecordExcludingIds' endpoint here] end
	public void exportEmergencyMedicalExaminationRecordExcludingIds(
			@Parameter(description = "The ids of the EmergencyMedicalExaminationRecordEntities to exclude from the export")
			@RequestParam @NotNull List<UUID> ids, HttpServletResponse response
	) {
		List<EmergencyMedicalExaminationRecordEntity> entitiesToExport;
		...
		if (ids == null || ids.size() == 0) {
			entitiesToExport = emergencyMedicalExaminationRecordService.findAllExcludingIds(new ArrayList<>());
		} else {
			entitiesToExport = emergencyMedicalExaminationRecordService.findAllExcludingIds(ids);
		}
	...
	/**
	 * Download a CSV file containing all of the headers of the EmergencyMedicalExaminationRecord entity.
	...
	public void csvImportExample(
		...
		String datetime = new SimpleDateFormat("yyyy-MM-dd_HH-mm-ss").format(new Date());
		String fileName = "EmergencyMedicalExaminationRecord_Import_Example_" + datetime + ".csv";
		// % protected region % [Modify the default file name for the Example Import endpoint here] end
		try {
			InputStream is = new ByteArrayInputStream(EmergencyMedicalExaminationRecordEntity.getExampleCsvHeader().getBytes());
	...
	/**
	 * Upload a CSV file containing attributes for Emergency Medical Examination Record entities, and import them into the database.  This method
	...
	@PreAuthorize("hasPermission('EmergencyMedicalExaminationRecordEntity', 'create')  || hasPermission('EmergencyMedicalExaminationRecordEntity', 'update')")
	...
	public ResponseEntity<String> csvUpload(HttpServletRequest request,
			@Parameter(description = "The CSV file with EmergencyMedicalExaminationRecordEntity entities to import")
		...
		CustomGrantedAuthority entityAuthority = authorities.stream().filter(x -> x.getTargetEntity().matches("EmergencyMedicalExaminationRecordEntity"))
		...
		List<String> allowedHeaders = Arrays.asList(EmergencyMedicalExaminationRecordEntity.getExampleCsvHeader().split(","));
		...
		CsvToBean<EmergencyMedicalExaminationRecordEntity> csvToBean = new CsvToBeanBuilder<EmergencyMedicalExaminationRecordEntity>(reader)
				.withType(EmergencyMedicalExaminationRecordEntity.class)
				.withIgnoreLeadingWhiteSpace(true)
				.withThrowExceptions(true)
				.build();

		List<EmergencyMedicalExaminationRecordEntity> entities = new ArrayList<>();
		...
		try {
			Iterator<EmergencyMedicalExaminationRecordEntity> iterator = csvToBean.iterator();
				...
				try {
					...
					if (next.getId() != null && !allowUpdate) {
						return ResponseEntity.status(HttpStatus.FORBIDDEN).body("Line " + currentLine
								+ ": You attempted to update a Emergency Medical Examination Record entity and you do not have permission");
					}

					if (next.getId() == null && !allowCreate) {
						return ResponseEntity.status(HttpStatus.FORBIDDEN).body("Line " + currentLine
								+ ": You attempted to create a Emergency Medical Examination Record entity and you do not have permission");
					}
