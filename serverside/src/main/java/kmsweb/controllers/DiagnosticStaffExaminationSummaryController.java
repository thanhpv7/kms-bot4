...
/**
 * Controller used to handle all REST operations regarding Diagnostic Staff Examination Summary
 */
// % protected region % [Update the API route or description for the Diagnostic Staff Examination SummaryController here] off begin
// The text associated with this tag can be found and edited in SwaggerConfig
@Tags(value = @Tag(name = "DiagnosticStaffExaminationSummaryController"))
@RestController
@Slf4j
@RequestMapping("/api/diagnosticstaffexaminationsummary")
// % protected region % [Update the API route or description for the Diagnostic Staff Examination SummaryController here] end
public class DiagnosticStaffExaminationSummaryController {

	private final DiagnosticStaffExaminationSummaryService diagnosticStaffExaminationSummaryService;
	private final CsvUtils<DiagnosticStaffExaminationSummaryEntity, DiagnosticStaffExaminationSummaryRepository, DiagnosticStaffExaminationSummaryEntityAudit,  DiagnosticStaffExaminationSummaryService> csvUtils;
	...
	@Autowired
	public DiagnosticStaffExaminationSummaryController(
		...
		this.csvUtils = new CsvUtils<>(diagnosticStaffExaminationSummaryService, DiagnosticStaffExaminationSummaryEntity.class);
	...
	/**
	 * Return all the Diagnostic Staff Examination Summarys.
	 *
	 * @return all the Diagnostic Staff Examination Summarys
	 */
	// % protected region % [Update the route mapping or description for the 'getAllWithPage' endpoint here] off begin
	@Operation(
			description = "Returns a single page of DiagnosticStaffExaminationSummarys",
		security = {
	...
	public ResponseEntity<List<DiagnosticStaffExaminationSummaryEntity>> getAllWithPage(
			@Parameter(description = "The page to return.")
			@RequestParam(value = "page", defaultValue = "1", required = false) int page,
			@Parameter(description = "The size of the page to return.")
			@RequestParam(value = "pageSize", defaultValue = "10", required = false) int pageSize
	) {
		List<DiagnosticStaffExaminationSummaryEntity> diagnosticStaffExaminationSummarys = diagnosticStaffExaminationSummaryService.findAllWithPage((page > 0) ? page - 1 : page, pageSize);
		...
		return new ResponseEntity<>(diagnosticStaffExaminationSummarys, HttpStatus.OK);
	}

	/**
	 * Return the Diagnostic Staff Examination Summary that has the same id as the given id.
	 *
	 * @param id      The id of the DiagnosticStaffExaminationSummaryEntity to be returned
	 * @return the Diagnostic Staff Examination Summary that has the same id as the given id
	 */
	...
	@Operation(
			description = "Return a single DiagnosticStaffExaminationSummary as defined by the id provided.",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "404", description = "DiagnosticStaffExaminationSummary entity not found"),
	})
	@PreAuthorize("hasPermission('DiagnosticStaffExaminationSummaryEntity', 'read')")
	@GetMapping(value = "/{id}", produces = "application/json")
	// % protected region % [Update the route mapping or description for the 'getById' endpoint here] end
	public ResponseEntity<DiagnosticStaffExaminationSummaryEntity> getById(
			@Parameter(description = "The UUID of the DiagnosticStaffExaminationSummary to return.")
			@PathVariable("id") UUID id
	) {
		Optional<DiagnosticStaffExaminationSummaryEntity> diagnosticStaffExaminationSummaryEntity = diagnosticStaffExaminationSummaryService.findById(id);
	...
	/**
	 * Create/Update the given Diagnostic Staff Examination Summary. If the entity has an id it will be updated, if not it will be created.
	 * The appropriate status codes will be set.
	 *
	 * @param diagnosticStaffExaminationSummaryEntityDto The Dto of the entity to save or update
	 */
	// % protected region % [Update the route mapping or description for the 'saveDiagnosticStaffExaminationSummary' endpoint here] off begin
	@Operation(
			description = "Create a DiagnosticStaffExaminationSummary if id not exists. Return 409 otherwise",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Successfully created the new DiagnosticStaffExaminationSummary."),
			@ApiResponse(responseCode = "409", description = "Failed to create the new DiagnosticStaffExaminationSummary, duplicate record found")
	})
	@PreAuthorize("hasPermission('DiagnosticStaffExaminationSummaryEntity', 'create')")
	@PostMapping
	// % protected region % [Update the route mapping or description for the 'saveDiagnosticStaffExaminationSummary' endpoint here] end
	public ResponseEntity<?> saveDiagnosticStaffExaminationSummary(
			@Parameter(description = "The DiagnosticStaffExaminationSummaryEntity to create or update.")
			@RequestBody DiagnosticStaffExaminationSummaryEntityDto diagnosticStaffExaminationSummaryEntityDto
	) {
		// % protected region % [Add any logic before save here] off begin
		// % protected region % [Add any logic before save here] end

		try {
			DiagnosticStaffExaminationSummaryEntity diagnosticStaffExaminationSummaryEntity = diagnosticStaffExaminationSummaryService.create(new DiagnosticStaffExaminationSummaryEntity(diagnosticStaffExaminationSummaryEntityDto));
			return new ResponseEntity<>(diagnosticStaffExaminationSummaryEntity, HttpStatus.OK);
	...
	/**
	 * Update the given Diagnostic Staff Examination Summary. If the entity has an id which is associated with an existing entity it will be updated, if not then the request will fail
	 * The appropriate status codes will be set.
	 *
	 * @param diagnosticStaffExaminationSummaryEntityDto The Dto of the entity to save or update
	 */
	// % protected region % [Update the route mapping or description for the 'updateDiagnosticStaffExaminationSummary' endpoint here] off begin
	@Operation(
			description = "Update a DiagnosticStaffExaminationSummary entity if id exists and is associated with an existing entity.  Return BAD_REQUEST otherwise",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	@ApiResponses(value = {
		@ApiResponse(responseCode = "200", description = "Successfully updated the DiagnosticStaffExaminationSummary."),
		@ApiResponse(responseCode = "400", description = "Failed to update the DiagnosticStaffExaminationSummary, entity id either does not exist" +
				"or is not associated with an existing entity")
	})
	@PreAuthorize("hasPermission('DiagnosticStaffExaminationSummaryEntity', 'update')")
	@PutMapping
	// % protected region % [Update the route mapping or description for the 'updateDiagnosticStaffExaminationSummary' endpoint here] end
	public ResponseEntity<?> updateDiagnosticStaffExaminationSummary(
			@Parameter(description = "The DiagnosticStaffExaminationSummaryEntity to create or update.")
			@RequestBody DiagnosticStaffExaminationSummaryEntityDto diagnosticStaffExaminationSummaryEntityDto
	) {
		// % protected region % [Add any logic before update here] off begin
		// % protected region % [Add any logic before update here] end
		Optional<DiagnosticStaffExaminationSummaryEntity> checkDiagnosticStaffExaminationSummaryExists = diagnosticStaffExaminationSummaryService.findById(diagnosticStaffExaminationSummaryEntityDto.getId());
		DiagnosticStaffExaminationSummaryEntity diagnosticStaffExaminationSummaryEntity = new DiagnosticStaffExaminationSummaryEntity(diagnosticStaffExaminationSummaryEntityDto);

		if (checkDiagnosticStaffExaminationSummaryExists.isPresent()) {
			try {
				diagnosticStaffExaminationSummaryEntity = diagnosticStaffExaminationSummaryService.update(diagnosticStaffExaminationSummaryEntity);
				return new ResponseEntity<>(diagnosticStaffExaminationSummaryEntity, HttpStatus.OK);
			} catch (ConstraintViolationException err) {
				return ControllerUtils.failedValidationApiResponse(err);
			}
		...
		return new ResponseEntity<>(diagnosticStaffExaminationSummaryEntity, HttpStatus.BAD_REQUEST);
	}

	/**
	 * Delete the Diagnostic Staff Examination Summary that has the same id as the given id.
	 *
	 * @param id The id of the DiagnosticStaffExaminationSummaryEntity to be deleted
	...
	@Operation(
			description = "Delete a single DiagnosticStaffExaminationSummary as defined by the id provided.",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	public ResponseEntity<Void> deleteById(
			@Parameter(description = "The UUID of the DiagnosticStaffExaminationSummary to delete.")
		...
		diagnosticStaffExaminationSummaryService.deleteById(id);
	 ...
	 */
	// % protected region % [Update the route mapping or description for the 'exportDiagnosticStaffExaminationSummary' endpoint here] off begin
	@Operation(
			description = "Download a csv file including all Diagnostic Staff Examination Summary entities included in the ids provided",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	// % protected region % [Update the route mapping or description for the 'exportDiagnosticStaffExaminationSummary' endpoint here] end
	public void exportDiagnosticStaffExaminationSummary(
			@Parameter(description = "The ids of the DiagnosticStaffExaminationSummaryEntities to export")
			@RequestParam @NotNull List<UUID> ids, HttpServletResponse response
	) {
		if (ids == null || ids.size() == 0) {
			response.setStatus(HttpServletResponse.SC_BAD_REQUEST);
		} else {
			List<DiagnosticStaffExaminationSummaryEntity> entitiesToExport = diagnosticStaffExaminationSummaryService.findAllByIds(ids);
			// % protected region % [Modify the default file name for the Export endpoint here] off begin
			String datetime = new SimpleDateFormat("yyyy-MM-dd_HH-mm-ss").format(new Date());
			String fileName = "DiagnosticStaffExaminationSummary_Export_" + datetime + ".csv";
			// % protected region % [Modify the default file name for the Export endpoint here] end

		for (DiagnosticStaffExaminationSummaryEntity entity: entitiesToExport) {
	 ...
	 * @param response The response object
	 */
	// % protected region % [Update the route mapping or description for the 'exportDiagnosticStaffExaminationSummaryExcludingIds' endpoint here] off begin
	@Operation(
	...
	// % protected region % [Update the route mapping or description for the 'exportDiagnosticStaffExaminationSummaryExcludingIds' endpoint here] end
	public void exportDiagnosticStaffExaminationSummaryExcludingIds(
			@Parameter(description = "The ids of the DiagnosticStaffExaminationSummaryEntities to exclude from the export")
			@RequestParam @NotNull List<UUID> ids, HttpServletResponse response
	) {
		List<DiagnosticStaffExaminationSummaryEntity> entitiesToExport;
		...
		if (ids == null || ids.size() == 0) {
			entitiesToExport = diagnosticStaffExaminationSummaryService.findAllExcludingIds(new ArrayList<>());
		} else {
			entitiesToExport = diagnosticStaffExaminationSummaryService.findAllExcludingIds(ids);
		}
	...
	/**
	 * Download a CSV file containing all of the headers of the DiagnosticStaffExaminationSummary entity.
	...
	public void csvImportExample(
		...
		String datetime = new SimpleDateFormat("yyyy-MM-dd_HH-mm-ss").format(new Date());
		String fileName = "DiagnosticStaffExaminationSummary_Import_Example_" + datetime + ".csv";
		// % protected region % [Modify the default file name for the Example Import endpoint here] end
		try {
			InputStream is = new ByteArrayInputStream(DiagnosticStaffExaminationSummaryEntity.getExampleCsvHeader().getBytes());
	...
	/**
	 * Upload a CSV file containing attributes for Diagnostic Staff Examination Summary entities, and import them into the database.  This method
	...
	@PreAuthorize("hasPermission('DiagnosticStaffExaminationSummaryEntity', 'create')  || hasPermission('DiagnosticStaffExaminationSummaryEntity', 'update')")
	...
	public ResponseEntity<String> csvUpload(HttpServletRequest request,
			@Parameter(description = "The CSV file with DiagnosticStaffExaminationSummaryEntity entities to import")
		...
		CustomGrantedAuthority entityAuthority = authorities.stream().filter(x -> x.getTargetEntity().matches("DiagnosticStaffExaminationSummaryEntity"))
		...
		List<String> allowedHeaders = Arrays.asList(DiagnosticStaffExaminationSummaryEntity.getExampleCsvHeader().split(","));
		...
		CsvToBean<DiagnosticStaffExaminationSummaryEntity> csvToBean = new CsvToBeanBuilder<DiagnosticStaffExaminationSummaryEntity>(reader)
				.withType(DiagnosticStaffExaminationSummaryEntity.class)
				.withIgnoreLeadingWhiteSpace(true)
				.withThrowExceptions(true)
				.build();

		List<DiagnosticStaffExaminationSummaryEntity> entities = new ArrayList<>();
		...
		try {
			Iterator<DiagnosticStaffExaminationSummaryEntity> iterator = csvToBean.iterator();
				...
				try {
					...
					if (next.getId() != null && !allowUpdate) {
						return ResponseEntity.status(HttpStatus.FORBIDDEN).body("Line " + currentLine
								+ ": You attempted to update a Diagnostic Staff Examination Summary entity and you do not have permission");
					}

					if (next.getId() == null && !allowCreate) {
						return ResponseEntity.status(HttpStatus.FORBIDDEN).body("Line " + currentLine
								+ ": You attempted to create a Diagnostic Staff Examination Summary entity and you do not have permission");
					}
