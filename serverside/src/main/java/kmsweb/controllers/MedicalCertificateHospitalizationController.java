...
/**
 * Controller used to handle all REST operations regarding Medical Certificate Hospitalization
 */
// % protected region % [Update the API route or description for the Medical Certificate HospitalizationController here] off begin
// The text associated with this tag can be found and edited in SwaggerConfig
@Tags(value = @Tag(name = "MedicalCertificateHospitalizationController"))
@RestController
@Slf4j
@RequestMapping("/api/medicalcertificatehospitalization")
// % protected region % [Update the API route or description for the Medical Certificate HospitalizationController here] end
public class MedicalCertificateHospitalizationController {

	private final MedicalCertificateHospitalizationService medicalCertificateHospitalizationService;
	private final CsvUtils<MedicalCertificateHospitalizationEntity, MedicalCertificateHospitalizationRepository, MedicalCertificateHospitalizationEntityAudit,  MedicalCertificateHospitalizationService> csvUtils;
	...
	@Autowired
	public MedicalCertificateHospitalizationController(
		...
		this.csvUtils = new CsvUtils<>(medicalCertificateHospitalizationService, MedicalCertificateHospitalizationEntity.class);
	...
	/**
	 * Return all the Medical Certificate Hospitalizations.
	 *
	 * @return all the Medical Certificate Hospitalizations
	 */
	// % protected region % [Update the route mapping or description for the 'getAllWithPage' endpoint here] off begin
	@Operation(
			description = "Returns a single page of MedicalCertificateHospitalizations",
		security = {
	...
	public ResponseEntity<List<MedicalCertificateHospitalizationEntity>> getAllWithPage(
			@Parameter(description = "The page to return.")
			@RequestParam(value = "page", defaultValue = "1", required = false) int page,
			@Parameter(description = "The size of the page to return.")
			@RequestParam(value = "pageSize", defaultValue = "10", required = false) int pageSize
	) {
		List<MedicalCertificateHospitalizationEntity> medicalCertificateHospitalizations = medicalCertificateHospitalizationService.findAllWithPage((page > 0) ? page - 1 : page, pageSize);
		...
		return new ResponseEntity<>(medicalCertificateHospitalizations, HttpStatus.OK);
	}

	/**
	 * Return the Medical Certificate Hospitalization that has the same id as the given id.
	 *
	 * @param id      The id of the MedicalCertificateHospitalizationEntity to be returned
	 * @return the Medical Certificate Hospitalization that has the same id as the given id
	 */
	...
	@Operation(
			description = "Return a single MedicalCertificateHospitalization as defined by the id provided.",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "404", description = "MedicalCertificateHospitalization entity not found"),
	})
	@PreAuthorize("hasPermission('MedicalCertificateHospitalizationEntity', 'read')")
	@GetMapping(value = "/{id}", produces = "application/json")
	// % protected region % [Update the route mapping or description for the 'getById' endpoint here] end
	public ResponseEntity<MedicalCertificateHospitalizationEntity> getById(
			@Parameter(description = "The UUID of the MedicalCertificateHospitalization to return.")
			@PathVariable("id") UUID id
	) {
		Optional<MedicalCertificateHospitalizationEntity> medicalCertificateHospitalizationEntity = medicalCertificateHospitalizationService.findById(id);
	...
	/**
	 * Create/Update the given Medical Certificate Hospitalization. If the entity has an id it will be updated, if not it will be created.
	 * The appropriate status codes will be set.
	 *
	 * @param medicalCertificateHospitalizationEntityDto The Dto of the entity to save or update
	 */
	// % protected region % [Update the route mapping or description for the 'saveMedicalCertificateHospitalization' endpoint here] off begin
	@Operation(
			description = "Create a MedicalCertificateHospitalization if id not exists. Return 409 otherwise",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Successfully created the new MedicalCertificateHospitalization."),
			@ApiResponse(responseCode = "409", description = "Failed to create the new MedicalCertificateHospitalization, duplicate record found")
	})
	@PreAuthorize("hasPermission('MedicalCertificateHospitalizationEntity', 'create')")
	@PostMapping
	// % protected region % [Update the route mapping or description for the 'saveMedicalCertificateHospitalization' endpoint here] end
	public ResponseEntity<?> saveMedicalCertificateHospitalization(
			@Parameter(description = "The MedicalCertificateHospitalizationEntity to create or update.")
			@RequestBody MedicalCertificateHospitalizationEntityDto medicalCertificateHospitalizationEntityDto
	) {
		// % protected region % [Add any logic before save here] off begin
		// % protected region % [Add any logic before save here] end

		try {
			MedicalCertificateHospitalizationEntity medicalCertificateHospitalizationEntity = medicalCertificateHospitalizationService.create(new MedicalCertificateHospitalizationEntity(medicalCertificateHospitalizationEntityDto));
			return new ResponseEntity<>(medicalCertificateHospitalizationEntity, HttpStatus.OK);
	...
	/**
	 * Update the given Medical Certificate Hospitalization. If the entity has an id which is associated with an existing entity it will be updated, if not then the request will fail
	 * The appropriate status codes will be set.
	 *
	 * @param medicalCertificateHospitalizationEntityDto The Dto of the entity to save or update
	 */
	// % protected region % [Update the route mapping or description for the 'updateMedicalCertificateHospitalization' endpoint here] off begin
	@Operation(
			description = "Update a MedicalCertificateHospitalization entity if id exists and is associated with an existing entity.  Return BAD_REQUEST otherwise",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	@ApiResponses(value = {
		@ApiResponse(responseCode = "200", description = "Successfully updated the MedicalCertificateHospitalization."),
		@ApiResponse(responseCode = "400", description = "Failed to update the MedicalCertificateHospitalization, entity id either does not exist" +
				"or is not associated with an existing entity")
	})
	@PreAuthorize("hasPermission('MedicalCertificateHospitalizationEntity', 'update')")
	@PutMapping
	// % protected region % [Update the route mapping or description for the 'updateMedicalCertificateHospitalization' endpoint here] end
	public ResponseEntity<?> updateMedicalCertificateHospitalization(
			@Parameter(description = "The MedicalCertificateHospitalizationEntity to create or update.")
			@RequestBody MedicalCertificateHospitalizationEntityDto medicalCertificateHospitalizationEntityDto
	) {
		// % protected region % [Add any logic before update here] off begin
		// % protected region % [Add any logic before update here] end
		Optional<MedicalCertificateHospitalizationEntity> checkMedicalCertificateHospitalizationExists = medicalCertificateHospitalizationService.findById(medicalCertificateHospitalizationEntityDto.getId());
		MedicalCertificateHospitalizationEntity medicalCertificateHospitalizationEntity = new MedicalCertificateHospitalizationEntity(medicalCertificateHospitalizationEntityDto);

		if (checkMedicalCertificateHospitalizationExists.isPresent()) {
			try {
				medicalCertificateHospitalizationEntity = medicalCertificateHospitalizationService.update(medicalCertificateHospitalizationEntity);
				return new ResponseEntity<>(medicalCertificateHospitalizationEntity, HttpStatus.OK);
			} catch (ConstraintViolationException err) {
				return ControllerUtils.failedValidationApiResponse(err);
			}
		...
		return new ResponseEntity<>(medicalCertificateHospitalizationEntity, HttpStatus.BAD_REQUEST);
	}

	/**
	 * Delete the Medical Certificate Hospitalization that has the same id as the given id.
	 *
	 * @param id The id of the MedicalCertificateHospitalizationEntity to be deleted
	...
	@Operation(
			description = "Delete a single MedicalCertificateHospitalization as defined by the id provided.",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	@PreAuthorize("hasPermission('MedicalCertificateHospitalizationEntity', 'delete')")
	@DeleteMapping(value = "/{id}")
	// % protected region % [Update the route mapping or description for the 'deleteById' endpoint here] end
	public ResponseEntity<Void> deleteById(
			@Parameter(description = "The UUID of the MedicalCertificateHospitalization to delete.")
		...
		medicalCertificateHospitalizationService.deleteById(id);
	 ...
	 */
	// % protected region % [Update the route mapping or description for the 'exportMedicalCertificateHospitalization' endpoint here] off begin
	@Operation(
			description = "Download a csv file including all Medical Certificate Hospitalization entities included in the ids provided",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	// % protected region % [Update the route mapping or description for the 'exportMedicalCertificateHospitalization' endpoint here] end
	public void exportMedicalCertificateHospitalization(
			@Parameter(description = "The ids of the MedicalCertificateHospitalizationEntities to export")
			@RequestParam @NotNull List<UUID> ids, HttpServletResponse response
	) {
		if (ids == null || ids.size() == 0) {
			response.setStatus(HttpServletResponse.SC_BAD_REQUEST);
		} else {
			List<MedicalCertificateHospitalizationEntity> entitiesToExport = medicalCertificateHospitalizationService.findAllByIds(ids);
			// % protected region % [Modify the default file name for the Export endpoint here] off begin
			String datetime = new SimpleDateFormat("yyyy-MM-dd_HH-mm-ss").format(new Date());
			String fileName = "MedicalCertificateHospitalization_Export_" + datetime + ".csv";
			// % protected region % [Modify the default file name for the Export endpoint here] end

		for (MedicalCertificateHospitalizationEntity entity: entitiesToExport) {
	 ...
	 * @param response The response object
	 */
	// % protected region % [Update the route mapping or description for the 'exportMedicalCertificateHospitalizationExcludingIds' endpoint here] off begin
	@Operation(
	...
	// % protected region % [Update the route mapping or description for the 'exportMedicalCertificateHospitalizationExcludingIds' endpoint here] end
	public void exportMedicalCertificateHospitalizationExcludingIds(
			@Parameter(description = "The ids of the MedicalCertificateHospitalizationEntities to exclude from the export")
			@RequestParam @NotNull List<UUID> ids, HttpServletResponse response
	) {
		List<MedicalCertificateHospitalizationEntity> entitiesToExport;
		...
		if (ids == null || ids.size() == 0) {
			entitiesToExport = medicalCertificateHospitalizationService.findAllExcludingIds(new ArrayList<>());
		} else {
			entitiesToExport = medicalCertificateHospitalizationService.findAllExcludingIds(ids);
		}
	...
	/**
	 * Download a CSV file containing all of the headers of the MedicalCertificateHospitalization entity.
	...
	public void csvImportExample(
		...
		String datetime = new SimpleDateFormat("yyyy-MM-dd_HH-mm-ss").format(new Date());
		String fileName = "MedicalCertificateHospitalization_Import_Example_" + datetime + ".csv";
		// % protected region % [Modify the default file name for the Example Import endpoint here] end
		try {
			InputStream is = new ByteArrayInputStream(MedicalCertificateHospitalizationEntity.getExampleCsvHeader().getBytes());
	...
	/**
	 * Upload a CSV file containing attributes for Medical Certificate Hospitalization entities, and import them into the database.  This method
	...
	@PreAuthorize("hasPermission('MedicalCertificateHospitalizationEntity', 'create')  || hasPermission('MedicalCertificateHospitalizationEntity', 'update')")
	...
	public ResponseEntity<String> csvUpload(HttpServletRequest request,
			@Parameter(description = "The CSV file with MedicalCertificateHospitalizationEntity entities to import")
		...
		CustomGrantedAuthority entityAuthority = authorities.stream().filter(x -> x.getTargetEntity().matches("MedicalCertificateHospitalizationEntity"))
		...
		List<String> allowedHeaders = Arrays.asList(MedicalCertificateHospitalizationEntity.getExampleCsvHeader().split(","));
		...
		CsvToBean<MedicalCertificateHospitalizationEntity> csvToBean = new CsvToBeanBuilder<MedicalCertificateHospitalizationEntity>(reader)
				.withType(MedicalCertificateHospitalizationEntity.class)
				.withIgnoreLeadingWhiteSpace(true)
				.withThrowExceptions(true)
				.build();

		List<MedicalCertificateHospitalizationEntity> entities = new ArrayList<>();
		...
		try {
			Iterator<MedicalCertificateHospitalizationEntity> iterator = csvToBean.iterator();
				...
				try {
					...
					if (next.getId() != null && !allowUpdate) {
						return ResponseEntity.status(HttpStatus.FORBIDDEN).body("Line " + currentLine
								+ ": You attempted to update a Medical Certificate Hospitalization entity and you do not have permission");
					}

					if (next.getId() == null && !allowCreate) {
						return ResponseEntity.status(HttpStatus.FORBIDDEN).body("Line " + currentLine
								+ ": You attempted to create a Medical Certificate Hospitalization entity and you do not have permission");
					}
