...
import kmsweb.entities.PatientVisitPatientPaymentOthersEntityAudit;
...
/**
 * Controller used to handle all REST operations regarding Patient Visit Patient Payment Others
 */
// % protected region % [Update the API route or description for the Patient Visit Patient Payment OthersController here] off begin
// The text associated with this tag can be found and edited in SwaggerConfig
@Tags(value = @Tag(name = "PatientVisitPatientPaymentOthersController"))
@RestController
@Slf4j
@RequestMapping("/api/patientvisitpatientpaymentothers")
// % protected region % [Update the API route or description for the Patient Visit Patient Payment OthersController here] end
public class PatientVisitPatientPaymentOthersController {

	private final PatientVisitPatientPaymentOthersService patientVisitPatientPaymentOthersService;
	private final CsvUtils<PatientVisitPatientPaymentOthersEntity, PatientVisitPatientPaymentOthersRepository, PatientVisitPatientPaymentOthersEntityAudit,  PatientVisitPatientPaymentOthersService> csvUtils;
	...
	@Autowired
	public PatientVisitPatientPaymentOthersController(
		...
		this.csvUtils = new CsvUtils<>(patientVisitPatientPaymentOthersService, PatientVisitPatientPaymentOthersEntity.class);
	...
	/**
	 * Return all the Patient Visit Patient Payment Otherss.
	 *
	 * @return all the Patient Visit Patient Payment Otherss
	 */
	// % protected region % [Update the route mapping or description for the 'getAllWithPage' endpoint here] off begin
	@Operation(
			description = "Returns a single page of PatientVisitPatientPaymentOtherss",
		security = {
	...
	@PreAuthorize("hasPermission('PatientVisitPatientPaymentOthersEntity', 'read')")
	@GetMapping(produces = "application/json")
	// % protected region % [Update the route mapping or description for the 'getAllWithPage' endpoint here] end
	public ResponseEntity<List<PatientVisitPatientPaymentOthersEntity>> getAllWithPage(
			@Parameter(description = "The page to return.")
			@RequestParam(value = "page", defaultValue = "1", required = false) int page,
			@Parameter(description = "The size of the page to return.")
			@RequestParam(value = "pageSize", defaultValue = "10", required = false) int pageSize
	) {
		List<PatientVisitPatientPaymentOthersEntity> patientVisitPatientPaymentOtherss = patientVisitPatientPaymentOthersService.findAllWithPage((page > 0) ? page - 1 : page, pageSize);
		...
		return new ResponseEntity<>(patientVisitPatientPaymentOtherss, HttpStatus.OK);
	}

	/**
	 * Return the Patient Visit Patient Payment Others that has the same id as the given id.
	 *
	 * @param id      The id of the PatientVisitPatientPaymentOthersEntity to be returned
	 * @return the Patient Visit Patient Payment Others that has the same id as the given id
	 */
	...
	@Operation(
			description = "Return a single PatientVisitPatientPaymentOthers as defined by the id provided.",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "404", description = "PatientVisitPatientPaymentOthers entity not found"),
	})
	@PreAuthorize("hasPermission('PatientVisitPatientPaymentOthersEntity', 'read')")
	@GetMapping(value = "/{id}", produces = "application/json")
	// % protected region % [Update the route mapping or description for the 'getById' endpoint here] end
	public ResponseEntity<PatientVisitPatientPaymentOthersEntity> getById(
			@Parameter(description = "The UUID of the PatientVisitPatientPaymentOthers to return.")
			@PathVariable("id") UUID id
	) {
		Optional<PatientVisitPatientPaymentOthersEntity> patientVisitPatientPaymentOthersEntity = patientVisitPatientPaymentOthersService.findById(id);
	...
	/**
	 * Create/Update the given Patient Visit Patient Payment Others. If the entity has an id it will be updated, if not it will be created.
	 * The appropriate status codes will be set.
	 *
	 * @param patientVisitPatientPaymentOthersEntityDto The Dto of the entity to save or update
	 */
	// % protected region % [Update the route mapping or description for the 'savePatientVisitPatientPaymentOthers' endpoint here] off begin
	@Operation(
			description = "Create a PatientVisitPatientPaymentOthers if id not exists. Return 409 otherwise",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Successfully created the new PatientVisitPatientPaymentOthers."),
			@ApiResponse(responseCode = "409", description = "Failed to create the new PatientVisitPatientPaymentOthers, duplicate record found")
	})
	@PreAuthorize("hasPermission('PatientVisitPatientPaymentOthersEntity', 'create')")
	@PostMapping
	// % protected region % [Update the route mapping or description for the 'savePatientVisitPatientPaymentOthers' endpoint here] end
	public ResponseEntity<?> savePatientVisitPatientPaymentOthers(
			@Parameter(description = "The PatientVisitPatientPaymentOthersEntity to create or update.")
			@RequestBody PatientVisitPatientPaymentOthersEntityDto patientVisitPatientPaymentOthersEntityDto
	) {
		// % protected region % [Add any logic before save here] off begin
		// % protected region % [Add any logic before save here] end

		try {
			PatientVisitPatientPaymentOthersEntity patientVisitPatientPaymentOthersEntity = patientVisitPatientPaymentOthersService.create(new PatientVisitPatientPaymentOthersEntity(patientVisitPatientPaymentOthersEntityDto));
			return new ResponseEntity<>(patientVisitPatientPaymentOthersEntity, HttpStatus.OK);
	...
	/**
	 * Update the given Patient Visit Patient Payment Others. If the entity has an id which is associated with an existing entity it will be updated, if not then the request will fail
	 * The appropriate status codes will be set.
	 *
	 * @param patientVisitPatientPaymentOthersEntityDto The Dto of the entity to save or update
	 */
	// % protected region % [Update the route mapping or description for the 'updatePatientVisitPatientPaymentOthers' endpoint here] off begin
	@Operation(
			description = "Update a PatientVisitPatientPaymentOthers entity if id exists and is associated with an existing entity.  Return BAD_REQUEST otherwise",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	@ApiResponses(value = {
		@ApiResponse(responseCode = "200", description = "Successfully updated the PatientVisitPatientPaymentOthers."),
		@ApiResponse(responseCode = "400", description = "Failed to update the PatientVisitPatientPaymentOthers, entity id either does not exist" +
				"or is not associated with an existing entity")
	})
	@PreAuthorize("hasPermission('PatientVisitPatientPaymentOthersEntity', 'update')")
	@PutMapping
	// % protected region % [Update the route mapping or description for the 'updatePatientVisitPatientPaymentOthers' endpoint here] end
	public ResponseEntity<?> updatePatientVisitPatientPaymentOthers(
			@Parameter(description = "The PatientVisitPatientPaymentOthersEntity to create or update.")
			@RequestBody PatientVisitPatientPaymentOthersEntityDto patientVisitPatientPaymentOthersEntityDto
	) {
		// % protected region % [Add any logic before update here] off begin
		// % protected region % [Add any logic before update here] end
		Optional<PatientVisitPatientPaymentOthersEntity> checkPatientVisitPatientPaymentOthersExists = patientVisitPatientPaymentOthersService.findById(patientVisitPatientPaymentOthersEntityDto.getId());
		PatientVisitPatientPaymentOthersEntity patientVisitPatientPaymentOthersEntity = new PatientVisitPatientPaymentOthersEntity(patientVisitPatientPaymentOthersEntityDto);

		if (checkPatientVisitPatientPaymentOthersExists.isPresent()) {
			try {
				patientVisitPatientPaymentOthersEntity = patientVisitPatientPaymentOthersService.update(patientVisitPatientPaymentOthersEntity);
				return new ResponseEntity<>(patientVisitPatientPaymentOthersEntity, HttpStatus.OK);
			} catch (ConstraintViolationException err) {
				return ControllerUtils.failedValidationApiResponse(err);
			}
		...
		return new ResponseEntity<>(patientVisitPatientPaymentOthersEntity, HttpStatus.BAD_REQUEST);
	}

	/**
	 * Delete the Patient Visit Patient Payment Others that has the same id as the given id.
	 *
	 * @param id The id of the PatientVisitPatientPaymentOthersEntity to be deleted
	...
	@Operation(
			description = "Delete a single PatientVisitPatientPaymentOthers as defined by the id provided.",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	@PreAuthorize("hasPermission('PatientVisitPatientPaymentOthersEntity', 'delete')")
	@DeleteMapping(value = "/{id}")
	// % protected region % [Update the route mapping or description for the 'deleteById' endpoint here] end
	public ResponseEntity<Void> deleteById(
			@Parameter(description = "The UUID of the PatientVisitPatientPaymentOthers to delete.")
		...
		patientVisitPatientPaymentOthersService.deleteById(id);
	 ...
	 */
	// % protected region % [Update the route mapping or description for the 'exportPatientVisitPatientPaymentOthers' endpoint here] off begin
	@Operation(
			description = "Download a csv file including all Patient Visit Patient Payment Others entities included in the ids provided",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	// % protected region % [Update the route mapping or description for the 'exportPatientVisitPatientPaymentOthers' endpoint here] end
	public void exportPatientVisitPatientPaymentOthers(
			@Parameter(description = "The ids of the PatientVisitPatientPaymentOthersEntities to export")
			@RequestParam @NotNull List<UUID> ids, HttpServletResponse response
	) {
		if (ids == null || ids.size() == 0) {
			response.setStatus(HttpServletResponse.SC_BAD_REQUEST);
		} else {
			List<PatientVisitPatientPaymentOthersEntity> entitiesToExport = patientVisitPatientPaymentOthersService.findAllByIds(ids);
			// % protected region % [Modify the default file name for the Export endpoint here] off begin
			String datetime = new SimpleDateFormat("yyyy-MM-dd_HH-mm-ss").format(new Date());
			String fileName = "PatientVisitPatientPaymentOthers_Export_" + datetime + ".csv";
			// % protected region % [Modify the default file name for the Export endpoint here] end

		for (PatientVisitPatientPaymentOthersEntity entity: entitiesToExport) {
	 ...
	 * @param response The response object
	 */
	// % protected region % [Update the route mapping or description for the 'exportPatientVisitPatientPaymentOthersExcludingIds' endpoint here] off begin
	@Operation(
	...
	// % protected region % [Update the route mapping or description for the 'exportPatientVisitPatientPaymentOthersExcludingIds' endpoint here] end
	public void exportPatientVisitPatientPaymentOthersExcludingIds(
			@Parameter(description = "The ids of the PatientVisitPatientPaymentOthersEntities to exclude from the export")
			@RequestParam @NotNull List<UUID> ids, HttpServletResponse response
	) {
		List<PatientVisitPatientPaymentOthersEntity> entitiesToExport;
		...
		if (ids == null || ids.size() == 0) {
			entitiesToExport = patientVisitPatientPaymentOthersService.findAllExcludingIds(new ArrayList<>());
		} else {
			entitiesToExport = patientVisitPatientPaymentOthersService.findAllExcludingIds(ids);
		}
	...
	/**
	 * Download a CSV file containing all of the headers of the PatientVisitPatientPaymentOthers entity.
	...
	public void csvImportExample(
		...
		String datetime = new SimpleDateFormat("yyyy-MM-dd_HH-mm-ss").format(new Date());
		String fileName = "PatientVisitPatientPaymentOthers_Import_Example_" + datetime + ".csv";
		// % protected region % [Modify the default file name for the Example Import endpoint here] end
		try {
			InputStream is = new ByteArrayInputStream(PatientVisitPatientPaymentOthersEntity.getExampleCsvHeader().getBytes());
	...
	/**
	 * Upload a CSV file containing attributes for Patient Visit Patient Payment Others entities, and import them into the database.  This method
	...
	@PreAuthorize("hasPermission('PatientVisitPatientPaymentOthersEntity', 'create')  || hasPermission('PatientVisitPatientPaymentOthersEntity', 'update')")
	...
	public ResponseEntity<String> csvUpload(HttpServletRequest request,
			@Parameter(description = "The CSV file with PatientVisitPatientPaymentOthersEntity entities to import")
		...
		CustomGrantedAuthority entityAuthority = authorities.stream().filter(x -> x.getTargetEntity().matches("PatientVisitPatientPaymentOthersEntity"))
		...
		List<String> allowedHeaders = Arrays.asList(PatientVisitPatientPaymentOthersEntity.getExampleCsvHeader().split(","));
		...
		CsvToBean<PatientVisitPatientPaymentOthersEntity> csvToBean = new CsvToBeanBuilder<PatientVisitPatientPaymentOthersEntity>(reader)
				.withType(PatientVisitPatientPaymentOthersEntity.class)
				.withIgnoreLeadingWhiteSpace(true)
				.withThrowExceptions(true)
				.build();

		List<PatientVisitPatientPaymentOthersEntity> entities = new ArrayList<>();
		...
		try {
			Iterator<PatientVisitPatientPaymentOthersEntity> iterator = csvToBean.iterator();
				...
				try {
					...
					if (next.getId() != null && !allowUpdate) {
						return ResponseEntity.status(HttpStatus.FORBIDDEN).body("Line " + currentLine
								+ ": You attempted to update a Patient Visit Patient Payment Others entity and you do not have permission");
					}

					if (next.getId() == null && !allowCreate) {
						return ResponseEntity.status(HttpStatus.FORBIDDEN).body("Line " + currentLine
								+ ": You attempted to create a Patient Visit Patient Payment Others entity and you do not have permission");
					}
