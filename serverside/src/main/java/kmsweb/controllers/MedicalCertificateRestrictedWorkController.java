...
import kmsweb.entities.MedicalCertificateRestrictedWorkEntityAudit;
...
/**
 * Controller used to handle all REST operations regarding Medical Certificate Restricted Work
 */
// % protected region % [Update the API route or description for the Medical Certificate Restricted WorkController here] off begin
// The text associated with this tag can be found and edited in SwaggerConfig
@Tags(value = @Tag(name = "MedicalCertificateRestrictedWorkController"))
@RestController
@Slf4j
@RequestMapping("/api/medicalcertificaterestrictedwork")
// % protected region % [Update the API route or description for the Medical Certificate Restricted WorkController here] end
public class MedicalCertificateRestrictedWorkController {

	private final MedicalCertificateRestrictedWorkService medicalCertificateRestrictedWorkService;
	private final CsvUtils<MedicalCertificateRestrictedWorkEntity, MedicalCertificateRestrictedWorkRepository, MedicalCertificateRestrictedWorkEntityAudit,  MedicalCertificateRestrictedWorkService> csvUtils;
	...
	@Autowired
	public MedicalCertificateRestrictedWorkController(
		...
		this.csvUtils = new CsvUtils<>(medicalCertificateRestrictedWorkService, MedicalCertificateRestrictedWorkEntity.class);
	...
	/**
	 * Return all the Medical Certificate Restricted Works.
	 *
	 * @return all the Medical Certificate Restricted Works
	 */
	// % protected region % [Update the route mapping or description for the 'getAllWithPage' endpoint here] off begin
	@Operation(
			description = "Returns a single page of MedicalCertificateRestrictedWorks",
		security = {
	...
	public ResponseEntity<List<MedicalCertificateRestrictedWorkEntity>> getAllWithPage(
			@Parameter(description = "The page to return.")
			@RequestParam(value = "page", defaultValue = "1", required = false) int page,
			@Parameter(description = "The size of the page to return.")
			@RequestParam(value = "pageSize", defaultValue = "10", required = false) int pageSize
	) {
		List<MedicalCertificateRestrictedWorkEntity> medicalCertificateRestrictedWorks = medicalCertificateRestrictedWorkService.findAllWithPage((page > 0) ? page - 1 : page, pageSize);
		...
		return new ResponseEntity<>(medicalCertificateRestrictedWorks, HttpStatus.OK);
	}

	/**
	 * Return the Medical Certificate Restricted Work that has the same id as the given id.
	 *
	 * @param id      The id of the MedicalCertificateRestrictedWorkEntity to be returned
	 * @return the Medical Certificate Restricted Work that has the same id as the given id
	 */
	...
	@Operation(
			description = "Return a single MedicalCertificateRestrictedWork as defined by the id provided.",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "404", description = "MedicalCertificateRestrictedWork entity not found"),
	})
	@PreAuthorize("hasPermission('MedicalCertificateRestrictedWorkEntity', 'read')")
	@GetMapping(value = "/{id}", produces = "application/json")
	// % protected region % [Update the route mapping or description for the 'getById' endpoint here] end
	public ResponseEntity<MedicalCertificateRestrictedWorkEntity> getById(
			@Parameter(description = "The UUID of the MedicalCertificateRestrictedWork to return.")
			@PathVariable("id") UUID id
	) {
		Optional<MedicalCertificateRestrictedWorkEntity> medicalCertificateRestrictedWorkEntity = medicalCertificateRestrictedWorkService.findById(id);
	...
	/**
	 * Create/Update the given Medical Certificate Restricted Work. If the entity has an id it will be updated, if not it will be created.
	 * The appropriate status codes will be set.
	 *
	 * @param medicalCertificateRestrictedWorkEntityDto The Dto of the entity to save or update
	 */
	// % protected region % [Update the route mapping or description for the 'saveMedicalCertificateRestrictedWork' endpoint here] off begin
	@Operation(
			description = "Create a MedicalCertificateRestrictedWork if id not exists. Return 409 otherwise",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Successfully created the new MedicalCertificateRestrictedWork."),
			@ApiResponse(responseCode = "409", description = "Failed to create the new MedicalCertificateRestrictedWork, duplicate record found")
	})
	@PreAuthorize("hasPermission('MedicalCertificateRestrictedWorkEntity', 'create')")
	@PostMapping
	// % protected region % [Update the route mapping or description for the 'saveMedicalCertificateRestrictedWork' endpoint here] end
	public ResponseEntity<?> saveMedicalCertificateRestrictedWork(
			@Parameter(description = "The MedicalCertificateRestrictedWorkEntity to create or update.")
			@RequestBody MedicalCertificateRestrictedWorkEntityDto medicalCertificateRestrictedWorkEntityDto
	) {
		// % protected region % [Add any logic before save here] off begin
		// % protected region % [Add any logic before save here] end

		try {
			MedicalCertificateRestrictedWorkEntity medicalCertificateRestrictedWorkEntity = medicalCertificateRestrictedWorkService.create(new MedicalCertificateRestrictedWorkEntity(medicalCertificateRestrictedWorkEntityDto));
			return new ResponseEntity<>(medicalCertificateRestrictedWorkEntity, HttpStatus.OK);
	...
	/**
	 * Update the given Medical Certificate Restricted Work. If the entity has an id which is associated with an existing entity it will be updated, if not then the request will fail
	 * The appropriate status codes will be set.
	 *
	 * @param medicalCertificateRestrictedWorkEntityDto The Dto of the entity to save or update
	 */
	// % protected region % [Update the route mapping or description for the 'updateMedicalCertificateRestrictedWork' endpoint here] off begin
	@Operation(
			description = "Update a MedicalCertificateRestrictedWork entity if id exists and is associated with an existing entity.  Return BAD_REQUEST otherwise",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	@ApiResponses(value = {
		@ApiResponse(responseCode = "200", description = "Successfully updated the MedicalCertificateRestrictedWork."),
		@ApiResponse(responseCode = "400", description = "Failed to update the MedicalCertificateRestrictedWork, entity id either does not exist" +
				"or is not associated with an existing entity")
	})
	@PreAuthorize("hasPermission('MedicalCertificateRestrictedWorkEntity', 'update')")
	@PutMapping
	// % protected region % [Update the route mapping or description for the 'updateMedicalCertificateRestrictedWork' endpoint here] end
	public ResponseEntity<?> updateMedicalCertificateRestrictedWork(
			@Parameter(description = "The MedicalCertificateRestrictedWorkEntity to create or update.")
			@RequestBody MedicalCertificateRestrictedWorkEntityDto medicalCertificateRestrictedWorkEntityDto
	) {
		// % protected region % [Add any logic before update here] off begin
		// % protected region % [Add any logic before update here] end
		Optional<MedicalCertificateRestrictedWorkEntity> checkMedicalCertificateRestrictedWorkExists = medicalCertificateRestrictedWorkService.findById(medicalCertificateRestrictedWorkEntityDto.getId());
		MedicalCertificateRestrictedWorkEntity medicalCertificateRestrictedWorkEntity = new MedicalCertificateRestrictedWorkEntity(medicalCertificateRestrictedWorkEntityDto);

		if (checkMedicalCertificateRestrictedWorkExists.isPresent()) {
			try {
				medicalCertificateRestrictedWorkEntity = medicalCertificateRestrictedWorkService.update(medicalCertificateRestrictedWorkEntity);
				return new ResponseEntity<>(medicalCertificateRestrictedWorkEntity, HttpStatus.OK);
			} catch (ConstraintViolationException err) {
				return ControllerUtils.failedValidationApiResponse(err);
			}
		...
		return new ResponseEntity<>(medicalCertificateRestrictedWorkEntity, HttpStatus.BAD_REQUEST);
	}

	/**
	 * Delete the Medical Certificate Restricted Work that has the same id as the given id.
	 *
	 * @param id The id of the MedicalCertificateRestrictedWorkEntity to be deleted
	...
	@Operation(
			description = "Delete a single MedicalCertificateRestrictedWork as defined by the id provided.",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	@PreAuthorize("hasPermission('MedicalCertificateRestrictedWorkEntity', 'delete')")
	@DeleteMapping(value = "/{id}")
	// % protected region % [Update the route mapping or description for the 'deleteById' endpoint here] end
	public ResponseEntity<Void> deleteById(
			@Parameter(description = "The UUID of the MedicalCertificateRestrictedWork to delete.")
		...
		medicalCertificateRestrictedWorkService.deleteById(id);
	 ...
	 */
	// % protected region % [Update the route mapping or description for the 'exportMedicalCertificateRestrictedWork' endpoint here] off begin
	@Operation(
			description = "Download a csv file including all Medical Certificate Restricted Work entities included in the ids provided",
			security = {
					@SecurityRequirement(name = "Authentication-Token"),
					@SecurityRequirement(name = "CSRF-Token"),
					@SecurityRequirement(name = "CSRF-Cookie")
	...
	// % protected region % [Update the route mapping or description for the 'exportMedicalCertificateRestrictedWork' endpoint here] end
	public void exportMedicalCertificateRestrictedWork(
			@Parameter(description = "The ids of the MedicalCertificateRestrictedWorkEntities to export")
			@RequestParam @NotNull List<UUID> ids, HttpServletResponse response
	) {
		if (ids == null || ids.size() == 0) {
			response.setStatus(HttpServletResponse.SC_BAD_REQUEST);
		} else {
			List<MedicalCertificateRestrictedWorkEntity> entitiesToExport = medicalCertificateRestrictedWorkService.findAllByIds(ids);
			// % protected region % [Modify the default file name for the Export endpoint here] off begin
			String datetime = new SimpleDateFormat("yyyy-MM-dd_HH-mm-ss").format(new Date());
			String fileName = "MedicalCertificateRestrictedWork_Export_" + datetime + ".csv";
			// % protected region % [Modify the default file name for the Export endpoint here] end

		for (MedicalCertificateRestrictedWorkEntity entity: entitiesToExport) {
	 ...
	 * @param response The response object
	 */
	// % protected region % [Update the route mapping or description for the 'exportMedicalCertificateRestrictedWorkExcludingIds' endpoint here] off begin
	@Operation(
	...
	// % protected region % [Update the route mapping or description for the 'exportMedicalCertificateRestrictedWorkExcludingIds' endpoint here] end
	public void exportMedicalCertificateRestrictedWorkExcludingIds(
			@Parameter(description = "The ids of the MedicalCertificateRestrictedWorkEntities to exclude from the export")
			@RequestParam @NotNull List<UUID> ids, HttpServletResponse response
	) {
		List<MedicalCertificateRestrictedWorkEntity> entitiesToExport;
		...
		if (ids == null || ids.size() == 0) {
			entitiesToExport = medicalCertificateRestrictedWorkService.findAllExcludingIds(new ArrayList<>());
		} else {
			entitiesToExport = medicalCertificateRestrictedWorkService.findAllExcludingIds(ids);
		}
	...
	/**
	 * Download a CSV file containing all of the headers of the MedicalCertificateRestrictedWork entity.
	...
	public void csvImportExample(
		...
		String datetime = new SimpleDateFormat("yyyy-MM-dd_HH-mm-ss").format(new Date());
		String fileName = "MedicalCertificateRestrictedWork_Import_Example_" + datetime + ".csv";
		// % protected region % [Modify the default file name for the Example Import endpoint here] end
		try {
			InputStream is = new ByteArrayInputStream(MedicalCertificateRestrictedWorkEntity.getExampleCsvHeader().getBytes());
	...
	/**
	 * Upload a CSV file containing attributes for Medical Certificate Restricted Work entities, and import them into the database.  This method
	...
	@PreAuthorize("hasPermission('MedicalCertificateRestrictedWorkEntity', 'create')  || hasPermission('MedicalCertificateRestrictedWorkEntity', 'update')")
	...
	public ResponseEntity<String> csvUpload(HttpServletRequest request,
			@Parameter(description = "The CSV file with MedicalCertificateRestrictedWorkEntity entities to import")
		...
		CustomGrantedAuthority entityAuthority = authorities.stream().filter(x -> x.getTargetEntity().matches("MedicalCertificateRestrictedWorkEntity"))
		...
		List<String> allowedHeaders = Arrays.asList(MedicalCertificateRestrictedWorkEntity.getExampleCsvHeader().split(","));
		...
		CsvToBean<MedicalCertificateRestrictedWorkEntity> csvToBean = new CsvToBeanBuilder<MedicalCertificateRestrictedWorkEntity>(reader)
				.withType(MedicalCertificateRestrictedWorkEntity.class)
				.withIgnoreLeadingWhiteSpace(true)
				.withThrowExceptions(true)
				.build();

		List<MedicalCertificateRestrictedWorkEntity> entities = new ArrayList<>();
		...
		try {
			Iterator<MedicalCertificateRestrictedWorkEntity> iterator = csvToBean.iterator();
				...
				try {
					...
					if (next.getId() != null && !allowUpdate) {
						return ResponseEntity.status(HttpStatus.FORBIDDEN).body("Line " + currentLine
								+ ": You attempted to update a Medical Certificate Restricted Work entity and you do not have permission");
					}

					if (next.getId() == null && !allowCreate) {
						return ResponseEntity.status(HttpStatus.FORBIDDEN).body("Line " + currentLine
								+ ": You attempted to create a Medical Certificate Restricted Work entity and you do not have permission");
					}
