...
public class InsuranceProviderServiceTest {
	 ...
	 */
	private InsuranceProviderEntity setupConstrainViolationMock() {
		// % protected region % [Customise entity mock setup here] off begin
		var entity = new InsuranceProviderEntity();

		entity.setProviderCode(mockNeat.strings().get());
		when(insuranceProviderRepository.findByProviderCode(entity.getProviderCode()))
	 ...
	 * @return populated entity
	 */
	private InsuranceProviderEntity setupConstrainHonouredMock() {
	...
	// % protected region % [Override test method here testUniquenessConstraintViolatedOnProviderCodeAttribute] off begin
	@Test
	public void testUniquenessConstraintViolatedOnProviderCodeAttribute() {
		var entity = setupConstrainViolationMock();
		String UNIQUENESS_VIOLATION_MESSAGE = "must be unique";
		var nameConstraintViolation = new SimpleConstraintViolationImpl<InsuranceProviderEntity>(
				"Provider Code",
		...
		ConstraintViolationException exception = assertThrows(ConstraintViolationException.class, () -> {
			insuranceProviderService.validateEntity(entity);
		});
	...
	// % protected region % [Override test method here testUniquenessConstraintViolatedOnProviderCodeAttribute] end

	// % protected region % [Override test method here testUniquenessConstraintHonouredOnProviderCodeAttribute] off begin
	@Test
	public void testUniquenessConstraintHonouredOnProviderCodeAttribute() {
	...
	// % protected region % [Override test method here testUniquenessConstraintHonouredOnProviderCodeAttribute] end
