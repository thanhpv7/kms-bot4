...
public class BpjsTreatmentClassMappingServiceTest {
	 ...
	 */
	private BpjsTreatmentClassMappingEntity setupConstrainViolationMock() {
		// % protected region % [Customise entity mock setup here] off begin
		var entity = new BpjsTreatmentClassMappingEntity();

		entity.setRefCode(mockNeat.strings().get());
		when(bpjsTreatmentClassMappingRepository.findByRefCode(entity.getRefCode()))
	 ...
	 * @return populated entity
	 */
	private BpjsTreatmentClassMappingEntity setupConstrainHonouredMock() {
	...
	public void testUniquenessConstraintViolatedOnRefCodeAttribute() {
		...
		var nameConstraintViolation = new SimpleConstraintViolationImpl<BpjsTreatmentClassMappingEntity>(
				"Ref Code",
				entity.getRefCode(),
		...
		ConstraintViolationException exception = assertThrows(ConstraintViolationException.class, () -> {
			bpjsTreatmentClassMappingService.validateEntity(entity);
		});
