...
public class PrivilegeServiceTest {
	 ...
	 */
	private PrivilegeEntity setupConstrainViolationMock() {
		...
		when(privilegeRepository.findByName(entity.getName()))
	 ...
	 * @return populated entity
	 */
	private PrivilegeEntity setupConstrainHonouredMock() {
	...
	public void testUniquenessConstraintViolatedOnNameAttribute() {
		...
		var nameConstraintViolation = new SimpleConstraintViolationImpl<PrivilegeEntity>(
				"name",
				entity.getName(),
		...
		ConstraintViolationException exception = assertThrows(ConstraintViolationException.class, () -> {
			privilegeService.validateEntity(entity);
		});
