...
public class MerchantServiceTest {
	 ...
	 */
	private MerchantEntity setupConstrainViolationMock() {
		// % protected region % [Customise entity mock setup here] off begin
		var entity = new MerchantEntity();

		entity.setMerchantNumber(mockNeat.strings().get());
		when(merchantRepository.findByMerchantNumber(entity.getMerchantNumber()))
	 ...
	 * @return populated entity
	 */
	private MerchantEntity setupConstrainHonouredMock() {
	...
	// % protected region % [Override test method here testUniquenessConstraintViolatedOnMerchantNumberAttribute] off begin
	@Test
	public void testUniquenessConstraintViolatedOnMerchantNumberAttribute() {
		var entity = setupConstrainViolationMock();
		String UNIQUENESS_VIOLATION_MESSAGE = "must be unique";
		var nameConstraintViolation = new SimpleConstraintViolationImpl<MerchantEntity>(
				"Merchant Number",
		...
		ConstraintViolationException exception = assertThrows(ConstraintViolationException.class, () -> {
			merchantService.validateEntity(entity);
		});
	...
	// % protected region % [Override test method here testUniquenessConstraintViolatedOnMerchantNumberAttribute] end

	// % protected region % [Override test method here testUniquenessConstraintHonouredOnMerchantNumberAttribute] off begin
	@Test
	public void testUniquenessConstraintHonouredOnMerchantNumberAttribute() {
	...
	// % protected region % [Override test method here testUniquenessConstraintHonouredOnMerchantNumberAttribute] end
