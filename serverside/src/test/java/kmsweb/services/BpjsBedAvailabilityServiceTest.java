...
public class BpjsBedAvailabilityServiceTest {
	 ...
	 */
	private BpjsBedAvailabilityEntity setupConstrainViolationMock() {
		// % protected region % [Customise entity mock setup here] off begin
		var entity = new BpjsBedAvailabilityEntity();

		entity.setKoderuang(mockNeat.strings().get());
		when(bpjsBedAvailabilityRepository.findByKoderuang(entity.getKoderuang()))
	 ...
	 * @return populated entity
	 */
	private BpjsBedAvailabilityEntity setupConstrainHonouredMock() {
	...
	// % protected region % [Override test method here testUniquenessConstraintViolatedOnKoderuangAttribute] off begin
	@Test
	public void testUniquenessConstraintViolatedOnKoderuangAttribute() {
		var entity = setupConstrainViolationMock();
		String UNIQUENESS_VIOLATION_MESSAGE = "must be unique";
		var nameConstraintViolation = new SimpleConstraintViolationImpl<BpjsBedAvailabilityEntity>(
				"koderuang",
				entity.getKoderuang(),
		...
		ConstraintViolationException exception = assertThrows(ConstraintViolationException.class, () -> {
			bpjsBedAvailabilityService.validateEntity(entity);
		});
	...
	// % protected region % [Override test method here testUniquenessConstraintViolatedOnKoderuangAttribute] end

	// % protected region % [Override test method here testUniquenessConstraintHonouredOnKoderuangAttribute] off begin
	@Test
	public void testUniquenessConstraintHonouredOnKoderuangAttribute() {
	...
	// % protected region % [Override test method here testUniquenessConstraintHonouredOnKoderuangAttribute] end
