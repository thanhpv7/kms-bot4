...
public class NhisSpecialtyAttendedServiceTest {
	 ...
	 */
	private NhisSpecialtyAttendedEntity setupConstrainViolationMock() {
		// % protected region % [Customise entity mock setup here] off begin
		var entity = new NhisSpecialtyAttendedEntity();

		entity.setCode(mockNeat.strings().get());
		when(nhisSpecialtyAttendedRepository.findByCode(entity.getCode()))
	 ...
	 * @return populated entity
	 */
	private NhisSpecialtyAttendedEntity setupConstrainHonouredMock() {
	...
	public void testUniquenessConstraintViolatedOnCodeAttribute() {
		...
		var nameConstraintViolation = new SimpleConstraintViolationImpl<NhisSpecialtyAttendedEntity>(
				"Code",
				entity.getCode(),
		...
		ConstraintViolationException exception = assertThrows(ConstraintViolationException.class, () -> {
			nhisSpecialtyAttendedService.validateEntity(entity);
		});
