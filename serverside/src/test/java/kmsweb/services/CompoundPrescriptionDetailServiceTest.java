...
public class CompoundPrescriptionDetailServiceTest {
	 ...
	 */
	private CompoundPrescriptionDetailEntity setupConstrainViolationMock() {
		// % protected region % [Customise entity mock setup here] off begin
		var entity = new CompoundPrescriptionDetailEntity();

		entity.setCompoundCode(mockNeat.strings().get());
		when(compoundPrescriptionDetailRepository.findByCompoundCode(entity.getCompoundCode()))
	 ...
	 * @return populated entity
	 */
	private CompoundPrescriptionDetailEntity setupConstrainHonouredMock() {
	...
	// % protected region % [Override test method here testUniquenessConstraintViolatedOnCompoundCodeAttribute] off begin
	@Test
	public void testUniquenessConstraintViolatedOnCompoundCodeAttribute() {
		var entity = setupConstrainViolationMock();
		String UNIQUENESS_VIOLATION_MESSAGE = "must be unique";
		var nameConstraintViolation = new SimpleConstraintViolationImpl<CompoundPrescriptionDetailEntity>(
				"Compound Code",
		...
		ConstraintViolationException exception = assertThrows(ConstraintViolationException.class, () -> {
			compoundPrescriptionDetailService.validateEntity(entity);
		});
	...
	// % protected region % [Override test method here testUniquenessConstraintViolatedOnCompoundCodeAttribute] end

	// % protected region % [Override test method here testUniquenessConstraintHonouredOnCompoundCodeAttribute] off begin
	@Test
	public void testUniquenessConstraintHonouredOnCompoundCodeAttribute() {
	...
	// % protected region % [Override test method here testUniquenessConstraintHonouredOnCompoundCodeAttribute] end
