...
public class NumberingSetupServiceTest {
	 ...
	 */
	private NumberingSetupEntity setupConstrainViolationMock() {
		// % protected region % [Customise entity mock setup here] off begin
		var entity = new NumberingSetupEntity();

		entity.setPrefix(mockNeat.strings().get());
		when(numberingSetupRepository.findByPrefix(entity.getPrefix()))
	 ...
	 * @return populated entity
	 */
	private NumberingSetupEntity setupConstrainHonouredMock() {
	...
	// % protected region % [Override test method here testUniquenessConstraintViolatedOnPrefixAttribute] off begin
	@Test
	public void testUniquenessConstraintViolatedOnPrefixAttribute() {
		var entity = setupConstrainViolationMock();
		String UNIQUENESS_VIOLATION_MESSAGE = "must be unique";
		var nameConstraintViolation = new SimpleConstraintViolationImpl<NumberingSetupEntity>(
				"Prefix",
				entity.getPrefix(),
		...
		ConstraintViolationException exception = assertThrows(ConstraintViolationException.class, () -> {
			numberingSetupService.validateEntity(entity);
		});
	...
	// % protected region % [Override test method here testUniquenessConstraintViolatedOnPrefixAttribute] end

	// % protected region % [Override test method here testUniquenessConstraintHonouredOnPrefixAttribute] off begin
	@Test
	public void testUniquenessConstraintHonouredOnPrefixAttribute() {
	...
	// % protected region % [Override test method here testUniquenessConstraintHonouredOnPrefixAttribute] end
