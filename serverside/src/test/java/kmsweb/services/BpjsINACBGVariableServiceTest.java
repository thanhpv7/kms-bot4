...
public class BpjsINACBGVariableServiceTest {
	 ...
	 */
	private BpjsINACBGVariableEntity setupConstrainViolationMock() {
		// % protected region % [Customise entity mock setup here] off begin
		var entity = new BpjsINACBGVariableEntity();

		entity.setVariableCode(mockNeat.strings().get());
		when(bpjsINACBGVariableRepository.findByVariableCode(entity.getVariableCode()))
	 ...
	 * @return populated entity
	 */
	private BpjsINACBGVariableEntity setupConstrainHonouredMock() {
	...
	// % protected region % [Override test method here testUniquenessConstraintViolatedOnVariableCodeAttribute] off begin
	@Test
	public void testUniquenessConstraintViolatedOnVariableCodeAttribute() {
		var entity = setupConstrainViolationMock();
		String UNIQUENESS_VIOLATION_MESSAGE = "must be unique";
		var nameConstraintViolation = new SimpleConstraintViolationImpl<BpjsINACBGVariableEntity>(
				"Variable Code",
		...
		ConstraintViolationException exception = assertThrows(ConstraintViolationException.class, () -> {
			bpjsINACBGVariableService.validateEntity(entity);
		});
	...
	// % protected region % [Override test method here testUniquenessConstraintViolatedOnVariableCodeAttribute] end

	// % protected region % [Override test method here testUniquenessConstraintHonouredOnVariableCodeAttribute] off begin
	@Test
	public void testUniquenessConstraintHonouredOnVariableCodeAttribute() {
	...
	// % protected region % [Override test method here testUniquenessConstraintHonouredOnVariableCodeAttribute] end
