...
public class TariffPackageServiceTest {
	 ...
	 */
	private TariffPackageEntity setupConstrainViolationMock() {
		// % protected region % [Customise entity mock setup here] off begin
		var entity = new TariffPackageEntity();

		entity.setTariffPackageCode(mockNeat.strings().get());
		when(tariffPackageRepository.findByTariffPackageCode(entity.getTariffPackageCode()))
	 ...
	 * @return populated entity
	 */
	private TariffPackageEntity setupConstrainHonouredMock() {
	...
	// % protected region % [Override test method here testUniquenessConstraintViolatedOnTariffPackageCodeAttribute] off begin
	@Test
	public void testUniquenessConstraintViolatedOnTariffPackageCodeAttribute() {
		var entity = setupConstrainViolationMock();
		String UNIQUENESS_VIOLATION_MESSAGE = "must be unique";
		var nameConstraintViolation = new SimpleConstraintViolationImpl<TariffPackageEntity>(
				"Tariff Package Code",
		...
		ConstraintViolationException exception = assertThrows(ConstraintViolationException.class, () -> {
			tariffPackageService.validateEntity(entity);
		});
	...
	// % protected region % [Override test method here testUniquenessConstraintViolatedOnTariffPackageCodeAttribute] end

	// % protected region % [Override test method here testUniquenessConstraintHonouredOnTariffPackageCodeAttribute] off begin
	@Test
	public void testUniquenessConstraintHonouredOnTariffPackageCodeAttribute() {
	...
	// % protected region % [Override test method here testUniquenessConstraintHonouredOnTariffPackageCodeAttribute] end
