...
public class BpjsDismissalMappingServiceTest {
	 ...
	 */
	private BpjsDismissalMappingEntity setupConstrainViolationMock() {
		// % protected region % [Customise entity mock setup here] off begin
		var entity = new BpjsDismissalMappingEntity();

		entity.setRefCode(mockNeat.strings().get());
		when(bpjsDismissalMappingRepository.findByRefCode(entity.getRefCode()))
	 ...
	 * @return populated entity
	 */
	private BpjsDismissalMappingEntity setupConstrainHonouredMock() {
	...
	public void testUniquenessConstraintViolatedOnRefCodeAttribute() {
		...
		var nameConstraintViolation = new SimpleConstraintViolationImpl<BpjsDismissalMappingEntity>(
				"Ref Code",
				entity.getRefCode(),
		...
		ConstraintViolationException exception = assertThrows(ConstraintViolationException.class, () -> {
			bpjsDismissalMappingService.validateEntity(entity);
		});
