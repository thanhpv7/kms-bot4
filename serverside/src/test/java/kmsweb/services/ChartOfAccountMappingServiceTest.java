...
public class ChartOfAccountMappingServiceTest {
	 ...
	 */
	private ChartOfAccountMappingEntity setupConstrainViolationMock() {
		// % protected region % [Customise entity mock setup here] off begin
		var entity = new ChartOfAccountMappingEntity();

		entity.setAccountType(mockNeat.strings().get());
		when(chartOfAccountMappingRepository.findByAccountType(entity.getAccountType()))
	 ...
	 * @return populated entity
	 */
	private ChartOfAccountMappingEntity setupConstrainHonouredMock() {
	...
	// % protected region % [Override test method here testUniquenessConstraintViolatedOnAccountTypeAttribute] off begin
	@Test
	public void testUniquenessConstraintViolatedOnAccountTypeAttribute() {
		var entity = setupConstrainViolationMock();
		String UNIQUENESS_VIOLATION_MESSAGE = "must be unique";
		var nameConstraintViolation = new SimpleConstraintViolationImpl<ChartOfAccountMappingEntity>(
				"Account Type",
		...
		ConstraintViolationException exception = assertThrows(ConstraintViolationException.class, () -> {
			chartOfAccountMappingService.validateEntity(entity);
		});
	...
	// % protected region % [Override test method here testUniquenessConstraintViolatedOnAccountTypeAttribute] end

	// % protected region % [Override test method here testUniquenessConstraintHonouredOnAccountTypeAttribute] off begin
	@Test
	public void testUniquenessConstraintHonouredOnAccountTypeAttribute() {
	...
	// % protected region % [Override test method here testUniquenessConstraintHonouredOnAccountTypeAttribute] end
