...
public class BpjsDoctorMappingServiceTest {
	 ...
	 */
	private BpjsDoctorMappingEntity setupConstrainViolationMock() {
		// % protected region % [Customise entity mock setup here] off begin
		var entity = new BpjsDoctorMappingEntity();

		entity.setRefCode(mockNeat.strings().get());
		when(bpjsDoctorMappingRepository.findByRefCode(entity.getRefCode()))
	 ...
	 * @return populated entity
	 */
	private BpjsDoctorMappingEntity setupConstrainHonouredMock() {
	...
	public void testUniquenessConstraintViolatedOnRefCodeAttribute() {
		...
		var nameConstraintViolation = new SimpleConstraintViolationImpl<BpjsDoctorMappingEntity>(
				"Ref Code",
				entity.getRefCode(),
		...
		ConstraintViolationException exception = assertThrows(ConstraintViolationException.class, () -> {
			bpjsDoctorMappingService.validateEntity(entity);
		});
