...
public class ChartOfAccountServiceTest {
	 ...
	 */
	private ChartOfAccountEntity setupConstrainViolationMock() {
		// % protected region % [Customise entity mock setup here] off begin
		var entity = new ChartOfAccountEntity();

		entity.setAccountCode(mockNeat.strings().get());
		when(chartOfAccountRepository.findByAccountCode(entity.getAccountCode()))
	 ...
	 * @return populated entity
	 */
	private ChartOfAccountEntity setupConstrainHonouredMock() {
	...
	// % protected region % [Override test method here testUniquenessConstraintViolatedOnAccountCodeAttribute] off begin
	@Test
	public void testUniquenessConstraintViolatedOnAccountCodeAttribute() {
		var entity = setupConstrainViolationMock();
		String UNIQUENESS_VIOLATION_MESSAGE = "must be unique";
		var nameConstraintViolation = new SimpleConstraintViolationImpl<ChartOfAccountEntity>(
				"Account Code",
		...
		ConstraintViolationException exception = assertThrows(ConstraintViolationException.class, () -> {
			chartOfAccountService.validateEntity(entity);
		});
	...
	// % protected region % [Override test method here testUniquenessConstraintViolatedOnAccountCodeAttribute] end

	// % protected region % [Override test method here testUniquenessConstraintHonouredOnAccountCodeAttribute] off begin
	@Test
	public void testUniquenessConstraintHonouredOnAccountCodeAttribute() {
	...
	// % protected region % [Override test method here testUniquenessConstraintHonouredOnAccountCodeAttribute] end
