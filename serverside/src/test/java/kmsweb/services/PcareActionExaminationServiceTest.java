...
public class PcareActionExaminationServiceTest {
	 ...
	 */
	private PcareActionExaminationEntity setupConstrainViolationMock() {
		// % protected region % [Customise entity mock setup here] off begin
		var entity = new PcareActionExaminationEntity();

		entity.setKdtindakansk(mockNeat.strings().get());
		when(pcareActionExaminationRepository.findByKdtindakansk(entity.getKdtindakansk()))
	 ...
	 * @return populated entity
	 */
	private PcareActionExaminationEntity setupConstrainHonouredMock() {
	...
	// % protected region % [Override test method here testUniquenessConstraintViolatedOnKdtindakanskAttribute] off begin
	@Test
	public void testUniquenessConstraintViolatedOnKdtindakanskAttribute() {
		var entity = setupConstrainViolationMock();
		String UNIQUENESS_VIOLATION_MESSAGE = "must be unique";
		var nameConstraintViolation = new SimpleConstraintViolationImpl<PcareActionExaminationEntity>(
				"kdTindakanSK",
		...
		ConstraintViolationException exception = assertThrows(ConstraintViolationException.class, () -> {
			pcareActionExaminationService.validateEntity(entity);
		});
	...
	// % protected region % [Override test method here testUniquenessConstraintViolatedOnKdtindakanskAttribute] end

	// % protected region % [Override test method here testUniquenessConstraintHonouredOnKdtindakanskAttribute] off begin
	@Test
	public void testUniquenessConstraintHonouredOnKdtindakanskAttribute() {
	...
	// % protected region % [Override test method here testUniquenessConstraintHonouredOnKdtindakanskAttribute] end
