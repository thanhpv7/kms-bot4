...
public class NhisInvestigationServiceTest {
	 ...
	 */
	private NhisInvestigationEntity setupConstrainViolationMock() {
		// % protected region % [Customise entity mock setup here] off begin
		var entity = new NhisInvestigationEntity();

		entity.setGdrgCode(mockNeat.strings().get());
		when(nhisInvestigationRepository.findByGdrgCode(entity.getGdrgCode()))
	 ...
	 * @return populated entity
	 */
	private NhisInvestigationEntity setupConstrainHonouredMock() {
	...
	// % protected region % [Override test method here testUniquenessConstraintViolatedOnGdrgCodeAttribute] off begin
	@Test
	public void testUniquenessConstraintViolatedOnGdrgCodeAttribute() {
		var entity = setupConstrainViolationMock();
		String UNIQUENESS_VIOLATION_MESSAGE = "must be unique";
		var nameConstraintViolation = new SimpleConstraintViolationImpl<NhisInvestigationEntity>(
				"GDRG Code",
				entity.getGdrgCode(),
		...
		ConstraintViolationException exception = assertThrows(ConstraintViolationException.class, () -> {
			nhisInvestigationService.validateEntity(entity);
		});
	...
	// % protected region % [Override test method here testUniquenessConstraintViolatedOnGdrgCodeAttribute] end

	// % protected region % [Override test method here testUniquenessConstraintHonouredOnGdrgCodeAttribute] off begin
	@Test
	public void testUniquenessConstraintHonouredOnGdrgCodeAttribute() {
	...
	// % protected region % [Override test method here testUniquenessConstraintHonouredOnGdrgCodeAttribute] end
