...
public class NhisGDRGServiceTest {
	 ...
	 */
	private NhisGDRGEntity setupConstrainViolationMock() {
		// % protected region % [Customise entity mock setup here] off begin
		var entity = new NhisGDRGEntity();

		entity.setCoreGDRGCode(mockNeat.strings().get());
		when(nhisGDRGRepository.findByCoreGDRGCode(entity.getCoreGDRGCode()))
	 ...
	 * @return populated entity
	 */
	private NhisGDRGEntity setupConstrainHonouredMock() {
	...
	// % protected region % [Override test method here testUniquenessConstraintViolatedOnCoreGDRGCodeAttribute] off begin
	@Test
	public void testUniquenessConstraintViolatedOnCoreGDRGCodeAttribute() {
		var entity = setupConstrainViolationMock();
		String UNIQUENESS_VIOLATION_MESSAGE = "must be unique";
		var nameConstraintViolation = new SimpleConstraintViolationImpl<NhisGDRGEntity>(
				"Core GDRG Code",
		...
		ConstraintViolationException exception = assertThrows(ConstraintViolationException.class, () -> {
			nhisGDRGService.validateEntity(entity);
		});
	...
	// % protected region % [Override test method here testUniquenessConstraintViolatedOnCoreGDRGCodeAttribute] end

	// % protected region % [Override test method here testUniquenessConstraintHonouredOnCoreGDRGCodeAttribute] off begin
	@Test
	public void testUniquenessConstraintHonouredOnCoreGDRGCodeAttribute() {
	...
	// % protected region % [Override test method here testUniquenessConstraintHonouredOnCoreGDRGCodeAttribute] end
