...
public class ClaimUserFactory implements FactoryBean<ClaimUserEntity> {
	 ...
	 */
	@Override
	public ClaimUserEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public ClaimUserEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public ClaimUserEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		// % protected region % [Apply any additional logic for claimUser with ref here] off begin
		// % protected region % [Apply any additional logic for claimUser with ref here] end

		return newEntity;
	}

	@Override
	public Class<ClaimUserEntity> getObjectType() {
