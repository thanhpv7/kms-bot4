...
public class StockTransactionPerDateFactory implements FactoryBean<StockTransactionPerDateEntity> {
	 ...
	 */
	@Override
	public StockTransactionPerDateEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public StockTransactionPerDateEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public StockTransactionPerDateEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		// % protected region % [Apply any additional logic for stockTransactionPerDate with ref here] off begin
		// % protected region % [Apply any additional logic for stockTransactionPerDate with ref here] end

		return newEntity;
	}

	@Override
	public Class<StockTransactionPerDateEntity> getObjectType() {
