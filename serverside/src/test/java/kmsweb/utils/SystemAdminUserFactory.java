...
public class SystemAdminUserFactory implements FactoryBean<SystemAdminUserEntity> {
	 ...
	 */
	@Override
	public SystemAdminUserEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public SystemAdminUserEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public SystemAdminUserEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		// % protected region % [Apply any additional logic for systemAdminUser with ref here] off begin
		// % protected region % [Apply any additional logic for systemAdminUser with ref here] end

		return newEntity;
	}

	@Override
	public Class<SystemAdminUserEntity> getObjectType() {
