...
public class MedicalRecordUserFactory implements FactoryBean<MedicalRecordUserEntity> {
	 ...
	 */
	@Override
	public MedicalRecordUserEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public MedicalRecordUserEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public MedicalRecordUserEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		// % protected region % [Apply any additional logic for medicalRecordUser with ref here] off begin
		// % protected region % [Apply any additional logic for medicalRecordUser with ref here] end

		return newEntity;
	}

	@Override
	public Class<MedicalRecordUserEntity> getObjectType() {
