...
public class CashAllocationFactory implements FactoryBean<CashAllocationEntity> {
	 ...
	 */
	@Override
	public CashAllocationEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public CashAllocationEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public CashAllocationEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		String randomStringForCashNumber = mockNeat
				.strings()
				.get();
		...
		newEntity.setSourceAmount(mockNeat.doubles().get());
	...
	@Override
	public Class<CashAllocationEntity> getObjectType() {
