...
public class BpjsFacilityListFactory implements FactoryBean<BpjsFacilityListEntity> {
	 ...
	 */
	@Override
	public BpjsFacilityListEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public BpjsFacilityListEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public BpjsFacilityListEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		String randomStringForFacilityName = mockNeat
				.strings()
				.get();
		...
		// % protected region % [Apply any additional logic for bpjsFacilityList with ref here] off begin
		// % protected region % [Apply any additional logic for bpjsFacilityList with ref here] end

		return newEntity;
	}

	@Override
	public Class<BpjsFacilityListEntity> getObjectType() {
