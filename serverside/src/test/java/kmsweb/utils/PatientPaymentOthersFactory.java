...
public class PatientPaymentOthersFactory implements FactoryBean<PatientPaymentOthersEntity> {
	 ...
	 */
	@Override
	public PatientPaymentOthersEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public PatientPaymentOthersEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public PatientPaymentOthersEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		// % protected region % [Apply any additional logic for patientPaymentOthers with ref here] off begin
		// % protected region % [Apply any additional logic for patientPaymentOthers with ref here] end

		return newEntity;
	}

	@Override
	public Class<PatientPaymentOthersEntity> getObjectType() {
