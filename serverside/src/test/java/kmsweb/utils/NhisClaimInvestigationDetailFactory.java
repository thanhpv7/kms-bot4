...
public class NhisClaimInvestigationDetailFactory implements FactoryBean<NhisClaimInvestigationDetailEntity> {
	 ...
	 */
	@Override
	public NhisClaimInvestigationDetailEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public NhisClaimInvestigationDetailEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public NhisClaimInvestigationDetailEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
	...
	@Override
	public Class<NhisClaimInvestigationDetailEntity> getObjectType() {
