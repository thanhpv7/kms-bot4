...
public class BpjsPcareProviderRayonisasiFactory implements FactoryBean<BpjsPcareProviderRayonisasiEntity> {
	 ...
	 */
	@Override
	public BpjsPcareProviderRayonisasiEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public BpjsPcareProviderRayonisasiEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public BpjsPcareProviderRayonisasiEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
	...
	@Override
	public Class<BpjsPcareProviderRayonisasiEntity> getObjectType() {
