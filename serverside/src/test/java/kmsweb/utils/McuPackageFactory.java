...
public class McuPackageFactory implements FactoryBean<McuPackageEntity> {
	 ...
	 */
	@Override
	public McuPackageEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public McuPackageEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public McuPackageEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		String randomStringForMcuPackageCode = mockNeat
				.strings()
				.get();
		...
		String randomStringForPackageType = mockNeat
				.strings()
				.get();
		...
		// % protected region % [Apply any additional logic for mcuPackage with ref here] off begin
		// % protected region % [Apply any additional logic for mcuPackage with ref here] end

		return newEntity;
	}

	@Override
	public Class<McuPackageEntity> getObjectType() {
