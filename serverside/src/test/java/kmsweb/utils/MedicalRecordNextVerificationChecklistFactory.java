...
public class MedicalRecordNextVerificationChecklistFactory implements FactoryBean<MedicalRecordNextVerificationChecklistEntity> {
	 ...
	 */
	@Override
	public MedicalRecordNextVerificationChecklistEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public MedicalRecordNextVerificationChecklistEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public MedicalRecordNextVerificationChecklistEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		// % protected region % [Apply any additional logic for medicalRecordNextVerificationChecklist with ref here] off begin
		// % protected region % [Apply any additional logic for medicalRecordNextVerificationChecklist with ref here] end

		return newEntity;
	}

	@Override
	public Class<MedicalRecordNextVerificationChecklistEntity> getObjectType() {
