...
public class FacilityUserFactory implements FactoryBean<FacilityUserEntity> {
	 ...
	 */
	@Override
	public FacilityUserEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public FacilityUserEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public FacilityUserEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		// % protected region % [Apply any additional logic for facilityUser with ref here] off begin
		// % protected region % [Apply any additional logic for facilityUser with ref here] end

		return newEntity;
	}

	@Override
	public Class<FacilityUserEntity> getObjectType() {
