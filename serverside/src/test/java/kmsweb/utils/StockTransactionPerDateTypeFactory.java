...
public class StockTransactionPerDateTypeFactory implements FactoryBean<StockTransactionPerDateTypeEntity> {
	 ...
	 */
	@Override
	public StockTransactionPerDateTypeEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public StockTransactionPerDateTypeEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public StockTransactionPerDateTypeEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		// % protected region % [Apply any additional logic for stockTransactionPerDateType with ref here] off begin
		// % protected region % [Apply any additional logic for stockTransactionPerDateType with ref here] end

		return newEntity;
	}

	@Override
	public Class<StockTransactionPerDateTypeEntity> getObjectType() {
