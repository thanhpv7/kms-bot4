...
public class NhisTypeOfServiceFactory implements FactoryBean<NhisTypeOfServiceEntity> {
	 ...
	 */
	@Override
	public NhisTypeOfServiceEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public NhisTypeOfServiceEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public NhisTypeOfServiceEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		String randomStringForSections = mockNeat
				.strings()
				.get();
	...
	@Override
	public Class<NhisTypeOfServiceEntity> getObjectType() {
