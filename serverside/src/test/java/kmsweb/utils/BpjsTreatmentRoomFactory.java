...
public class BpjsTreatmentRoomFactory implements FactoryBean<BpjsTreatmentRoomEntity> {
	 ...
	 */
	@Override
	public BpjsTreatmentRoomEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public BpjsTreatmentRoomEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public BpjsTreatmentRoomEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		String randomStringForKode = mockNeat
				.strings()
				.get();
		...
		// % protected region % [Apply any additional logic for bpjsTreatmentRoom with ref here] off begin
		// % protected region % [Apply any additional logic for bpjsTreatmentRoom with ref here] end

		return newEntity;
	}

	@Override
	public Class<BpjsTreatmentRoomEntity> getObjectType() {
