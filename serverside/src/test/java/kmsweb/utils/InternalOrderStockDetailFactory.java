...
public class InternalOrderStockDetailFactory implements FactoryBean<InternalOrderStockDetailEntity> {
	 ...
	 */
	@Override
	public InternalOrderStockDetailEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public InternalOrderStockDetailEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public InternalOrderStockDetailEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		if (includeReferences) {
			...
			// % protected region % [Override the reference inclusions for incomingOneToManyInternal Order here] off begin
			var internalOrderFactory = new InternalOrderFactory();
			newEntity.setInternalOrder(internalOrderFactory.getObject(false, includeId), false);
			// % protected region % [Override the reference inclusions for incomingOneToManyInternal Order here] end
		...
		// % protected region % [Apply any additional logic for internalOrderStockDetail with ref here] off begin
		// % protected region % [Apply any additional logic for internalOrderStockDetail with ref here] end

		return newEntity;
	}

	@Override
	public Class<InternalOrderStockDetailEntity> getObjectType() {
