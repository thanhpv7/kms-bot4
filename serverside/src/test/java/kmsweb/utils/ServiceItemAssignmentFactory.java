...
public class ServiceItemAssignmentFactory implements FactoryBean<ServiceItemAssignmentEntity> {
	 ...
	 */
	@Override
	public ServiceItemAssignmentEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public ServiceItemAssignmentEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public ServiceItemAssignmentEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		// % protected region % [Apply any additional logic for serviceItemAssignment with ref here] off begin
		// % protected region % [Apply any additional logic for serviceItemAssignment with ref here] end

		return newEntity;
	}

	@Override
	public Class<ServiceItemAssignmentEntity> getObjectType() {
