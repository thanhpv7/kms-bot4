...
public class PatientVisitPatientPaymentInsuranceFactory implements FactoryBean<PatientVisitPatientPaymentInsuranceEntity> {
	 ...
	 */
	@Override
	public PatientVisitPatientPaymentInsuranceEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public PatientVisitPatientPaymentInsuranceEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public PatientVisitPatientPaymentInsuranceEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		// % protected region % [Apply any additional logic for patientVisitPatientPaymentInsurance with ref here] off begin
		// % protected region % [Apply any additional logic for patientVisitPatientPaymentInsurance with ref here] end

		return newEntity;
	}

	@Override
	public Class<PatientVisitPatientPaymentInsuranceEntity> getObjectType() {
