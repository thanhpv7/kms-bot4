...
public class PatientDetailFactory implements FactoryBean<PatientDetailEntity> {
	 ...
	 */
	@Override
	public PatientDetailEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public PatientDetailEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public PatientDetailEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		String randomStringForActivePatientID = mockNeat
				.strings()
				.get();
		...
		String randomStringForPatientClassification = mockNeat
				.strings()
				.get();
		...
		String randomStringForPatientType = mockNeat
				.strings()
				.get();
		...
		// % protected region % [Apply any additional logic for patientDetail with ref here] off begin
		// % protected region % [Apply any additional logic for patientDetail with ref here] end

		return newEntity;
	}

	@Override
	public Class<PatientDetailEntity> getObjectType() {
