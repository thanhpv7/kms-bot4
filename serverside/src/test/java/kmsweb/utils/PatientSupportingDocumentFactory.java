...
public class PatientSupportingDocumentFactory implements FactoryBean<PatientSupportingDocumentEntity> {
	 ...
	 */
	@Override
	public PatientSupportingDocumentEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public PatientSupportingDocumentEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public PatientSupportingDocumentEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		String randomStringForFileName = mockNeat
				.strings()
				.get();
		...
		// % protected region % [Apply any additional logic for patientSupportingDocument with ref here] off begin
		// % protected region % [Apply any additional logic for patientSupportingDocument with ref here] end

		return newEntity;
	}

	@Override
	public Class<PatientSupportingDocumentEntity> getObjectType() {
