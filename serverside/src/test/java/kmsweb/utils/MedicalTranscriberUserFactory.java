...
public class MedicalTranscriberUserFactory implements FactoryBean<MedicalTranscriberUserEntity> {
	 ...
	 */
	@Override
	public MedicalTranscriberUserEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public MedicalTranscriberUserEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public MedicalTranscriberUserEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		// % protected region % [Apply any additional logic for medicalTranscriberUser with ref here] off begin
		// % protected region % [Apply any additional logic for medicalTranscriberUser with ref here] end

		return newEntity;
	}

	@Override
	public Class<MedicalTranscriberUserEntity> getObjectType() {
