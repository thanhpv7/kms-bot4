...
public class BpjsSEPFactory implements FactoryBean<BpjsSEPEntity> {
	 ...
	 */
	@Override
	public BpjsSEPEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public BpjsSEPEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public BpjsSEPEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		// % protected region % [Apply any additional logic for bpjsSEP with ref here] off begin
		// % protected region % [Apply any additional logic for bpjsSEP with ref here] end

		return newEntity;
	}

	@Override
	public Class<BpjsSEPEntity> getObjectType() {
