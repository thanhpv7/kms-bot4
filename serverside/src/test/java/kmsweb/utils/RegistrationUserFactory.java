...
public class RegistrationUserFactory implements FactoryBean<RegistrationUserEntity> {
	 ...
	 */
	@Override
	public RegistrationUserEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public RegistrationUserEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public RegistrationUserEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		// % protected region % [Apply any additional logic for registrationUser with ref here] off begin
		// % protected region % [Apply any additional logic for registrationUser with ref here] end

		return newEntity;
	}

	@Override
	public Class<RegistrationUserEntity> getObjectType() {
