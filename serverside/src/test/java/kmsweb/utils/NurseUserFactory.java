...
public class NurseUserFactory implements FactoryBean<NurseUserEntity> {
	 ...
	 */
	@Override
	public NurseUserEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public NurseUserEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public NurseUserEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		// % protected region % [Apply any additional logic for nurseUser with ref here] off begin
		// % protected region % [Apply any additional logic for nurseUser with ref here] end

		return newEntity;
	}

	@Override
	public Class<NurseUserEntity> getObjectType() {
