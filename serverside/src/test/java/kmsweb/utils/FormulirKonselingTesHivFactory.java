...
public class FormulirKonselingTesHivFactory implements FactoryBean<FormulirKonselingTesHivEntity> {
	 ...
	 */
	@Override
	public FormulirKonselingTesHivEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public FormulirKonselingTesHivEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public FormulirKonselingTesHivEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		String randomStringForFormData = mockNeat
				.strings()
				.get();
		...
		// % protected region % [Apply any additional logic for formulirKonselingTesHiv with ref here] off begin
		// % protected region % [Apply any additional logic for formulirKonselingTesHiv with ref here] end

		return newEntity;
	}

	@Override
	public Class<FormulirKonselingTesHivEntity> getObjectType() {
