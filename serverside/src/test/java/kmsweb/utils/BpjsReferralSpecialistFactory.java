...
public class BpjsReferralSpecialistFactory implements FactoryBean<BpjsReferralSpecialistEntity> {
	 ...
	 */
	@Override
	public BpjsReferralSpecialistEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public BpjsReferralSpecialistEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public BpjsReferralSpecialistEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		String randomStringForTotalReferral = mockNeat
				.strings()
				.get();
		...
		// % protected region % [Apply any additional logic for bpjsReferralSpecialist with ref here] off begin
		// % protected region % [Apply any additional logic for bpjsReferralSpecialist with ref here] end

		return newEntity;
	}

	@Override
	public Class<BpjsReferralSpecialistEntity> getObjectType() {
