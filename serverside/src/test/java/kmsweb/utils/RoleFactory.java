...
public class RoleFactory implements FactoryBean<RoleEntity> {
	 ...
	 */
	@Override
	public RoleEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public RoleEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public RoleEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
	...
	@Override
	public Class<RoleEntity> getObjectType() {
