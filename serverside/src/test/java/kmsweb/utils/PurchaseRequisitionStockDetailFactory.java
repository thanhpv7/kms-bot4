...
public class PurchaseRequisitionStockDetailFactory implements FactoryBean<PurchaseRequisitionStockDetailEntity> {
	 ...
	 */
	@Override
	public PurchaseRequisitionStockDetailEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public PurchaseRequisitionStockDetailEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public PurchaseRequisitionStockDetailEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		newEntity.setQuantityRequested(mockNeat.doubles().get());
		...
		if (includeReferences) {
			...
			// % protected region % [Override the reference inclusions for incomingOneToManyPurchase Requisition here] off begin
			var purchaseRequisitionFactory = new PurchaseRequisitionFactory();
			newEntity.setPurchaseRequisition(purchaseRequisitionFactory.getObject(false, includeId), false);
			// % protected region % [Override the reference inclusions for incomingOneToManyPurchase Requisition here] end
		...
		// % protected region % [Apply any additional logic for purchaseRequisitionStockDetail with ref here] off begin
		// % protected region % [Apply any additional logic for purchaseRequisitionStockDetail with ref here] end

		return newEntity;
	}

	@Override
	public Class<PurchaseRequisitionStockDetailEntity> getObjectType() {
