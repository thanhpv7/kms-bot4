...
public class PcareStatusPulangFactory implements FactoryBean<PcareStatusPulangEntity> {
	 ...
	 */
	@Override
	public PcareStatusPulangEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public PcareStatusPulangEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public PcareStatusPulangEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		String randomStringForKodeStatusPulang = mockNeat
				.strings()
				.get();
		...
		String randomStringForNamaStatusPulang = mockNeat
				.strings()
				.get();
		...
		String randomStringForKodeReferensiInternal = mockNeat
				.strings()
				.get();
	...
	@Override
	public Class<PcareStatusPulangEntity> getObjectType() {
