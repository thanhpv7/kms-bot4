...
public class BpjsVisitDataFactory implements FactoryBean<BpjsVisitDataEntity> {
	 ...
	 */
	@Override
	public BpjsVisitDataEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public BpjsVisitDataEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public BpjsVisitDataEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		String randomStringForSepDismissalDate = mockNeat
				.strings()
				.get();
		...
		// % protected region % [Apply any additional logic for bpjsVisitData with ref here] off begin
		// % protected region % [Apply any additional logic for bpjsVisitData with ref here] end

		return newEntity;
	}

	@Override
	public Class<BpjsVisitDataEntity> getObjectType() {
