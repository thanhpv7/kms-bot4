...
public class MedicalCertificatePhysicalHealthFactory implements FactoryBean<MedicalCertificatePhysicalHealthEntity> {
	 ...
	 */
	@Override
	public MedicalCertificatePhysicalHealthEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public MedicalCertificatePhysicalHealthEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public MedicalCertificatePhysicalHealthEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		// % protected region % [Apply any additional logic for medicalCertificatePhysicalHealth with ref here] off begin
		// % protected region % [Apply any additional logic for medicalCertificatePhysicalHealth with ref here] end

		return newEntity;
	}

	@Override
	public Class<MedicalCertificatePhysicalHealthEntity> getObjectType() {
