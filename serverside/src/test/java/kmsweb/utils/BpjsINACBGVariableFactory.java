...
public class BpjsINACBGVariableFactory implements FactoryBean<BpjsINACBGVariableEntity> {
	 ...
	 */
	@Override
	public BpjsINACBGVariableEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public BpjsINACBGVariableEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public BpjsINACBGVariableEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		String randomStringForVariableCode = mockNeat
				.strings()
				.get();
		...
		String randomStringForEnglish = mockNeat
				.strings()
				.get();
		...
		String randomStringForIndonesian = mockNeat
				.strings()
				.get();
	...
	@Override
	public Class<BpjsINACBGVariableEntity> getObjectType() {
