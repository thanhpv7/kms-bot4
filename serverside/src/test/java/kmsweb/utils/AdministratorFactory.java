...
public class AdministratorFactory implements FactoryBean<AdministratorEntity> {
	 ...
	 */
	@Override
	public AdministratorEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public AdministratorEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public AdministratorEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		// % protected region % [Apply any additional logic for administrator with ref here] off begin
		// % protected region % [Apply any additional logic for administrator with ref here] end

		return newEntity;
	}

	@Override
	public Class<AdministratorEntity> getObjectType() {
