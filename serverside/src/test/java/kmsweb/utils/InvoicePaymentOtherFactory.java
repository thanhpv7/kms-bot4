...
public class InvoicePaymentOtherFactory implements FactoryBean<InvoicePaymentOtherEntity> {
	 ...
	 */
	@Override
	public InvoicePaymentOtherEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public InvoicePaymentOtherEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public InvoicePaymentOtherEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		// % protected region % [Apply any additional logic for invoicePaymentOther with ref here] off begin
		// % protected region % [Apply any additional logic for invoicePaymentOther with ref here] end

		return newEntity;
	}

	@Override
	public Class<InvoicePaymentOtherEntity> getObjectType() {
