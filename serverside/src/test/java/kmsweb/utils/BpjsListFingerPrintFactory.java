...
public class BpjsListFingerPrintFactory implements FactoryBean<BpjsListFingerPrintEntity> {
	 ...
	 */
	@Override
	public BpjsListFingerPrintEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public BpjsListFingerPrintEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public BpjsListFingerPrintEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
	...
	@Override
	public Class<BpjsListFingerPrintEntity> getObjectType() {
