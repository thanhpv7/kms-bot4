...
public class ManagementUserFactory implements FactoryBean<ManagementUserEntity> {
	 ...
	 */
	@Override
	public ManagementUserEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public ManagementUserEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public ManagementUserEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		// % protected region % [Apply any additional logic for managementUser with ref here] off begin
		// % protected region % [Apply any additional logic for managementUser with ref here] end

		return newEntity;
	}

	@Override
	public Class<ManagementUserEntity> getObjectType() {
