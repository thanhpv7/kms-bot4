...
public class DiagnosticSupportUserFactory implements FactoryBean<DiagnosticSupportUserEntity> {
	 ...
	 */
	@Override
	public DiagnosticSupportUserEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public DiagnosticSupportUserEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public DiagnosticSupportUserEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		// % protected region % [Apply any additional logic for diagnosticSupportUser with ref here] off begin
		// % protected region % [Apply any additional logic for diagnosticSupportUser with ref here] end

		return newEntity;
	}

	@Override
	public Class<DiagnosticSupportUserEntity> getObjectType() {
