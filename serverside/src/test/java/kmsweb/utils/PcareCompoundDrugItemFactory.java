...
public class PcareCompoundDrugItemFactory implements FactoryBean<PcareCompoundDrugItemEntity> {
	 ...
	 */
	@Override
	public PcareCompoundDrugItemEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public PcareCompoundDrugItemEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public PcareCompoundDrugItemEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		newEntity.setRequest(mockNeat.doubles().get());
		...
		if (includeReferences) {
			...
			// % protected region % [Override the reference inclusions for incomingOneToManyPCare Compound Drug here] off begin
			var pcareCompoundDrugFactory = new PcareCompoundDrugFactory();
			newEntity.setPcareCompoundDrug(pcareCompoundDrugFactory.getObject(false, includeId), false);
			// % protected region % [Override the reference inclusions for incomingOneToManyPCare Compound Drug here] end

		}

		// % protected region % [Apply any additional logic for pcareCompoundDrugItem with ref here] off begin
		// % protected region % [Apply any additional logic for pcareCompoundDrugItem with ref here] end

		return newEntity;
	}

	@Override
	public Class<PcareCompoundDrugItemEntity> getObjectType() {
