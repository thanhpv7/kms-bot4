...
public class MedicalFeeItemComponentFactory implements FactoryBean<MedicalFeeItemComponentEntity> {
	 ...
	 */
	@Override
	public MedicalFeeItemComponentEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public MedicalFeeItemComponentEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public MedicalFeeItemComponentEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		// % protected region % [Apply any additional logic for medicalFeeItemComponent with ref here] off begin
		// % protected region % [Apply any additional logic for medicalFeeItemComponent with ref here] end

		return newEntity;
	}

	@Override
	public Class<MedicalFeeItemComponentEntity> getObjectType() {
