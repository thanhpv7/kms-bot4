...
public class PcareReferensiSaranaFactory implements FactoryBean<PcareReferensiSaranaEntity> {
	 ...
	 */
	@Override
	public PcareReferensiSaranaEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public PcareReferensiSaranaEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public PcareReferensiSaranaEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		String randomStringForKodeSarana = mockNeat
				.strings()
				.get();
		...
		String randomStringForNamaSarana = mockNeat
				.strings()
				.get();
	...
	@Override
	public Class<PcareReferensiSaranaEntity> getObjectType() {
