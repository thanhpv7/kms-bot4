...
public class PrescriptionCompoundFactory implements FactoryBean<PrescriptionCompoundEntity> {
	 ...
	 */
	@Override
	public PrescriptionCompoundEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public PrescriptionCompoundEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public PrescriptionCompoundEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		if (includeReferences) {
			...
			// Incoming One to Many reference
			// % protected region % [Override the reference inclusions for incomingOneToManyPrescription Header here] off begin
			...
			// % protected region % [Override the reference inclusions for incomingOneToManyPrescription Header here] end

			// % protected region % [Override the reference inclusion for outgoingOneToMany Compound Items here] off begin
			// Outgoing one to many reference
			var compoundItemsFactory = new PrescriptionItemFactory();
			newEntity.setCompoundItems(Collections.singletonList(compoundItemsFactory.getObject(false, includeId)), false);
			// % protected region % [Override the reference inclusion for outgoingOneToMany Compound Items here] end

		}

		// % protected region % [Apply any additional logic for prescriptionCompound with ref here] off begin
		// % protected region % [Apply any additional logic for prescriptionCompound with ref here] end

		return newEntity;
	}

	@Override
	public Class<PrescriptionCompoundEntity> getObjectType() {
