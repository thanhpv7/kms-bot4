...
public class InventoryAdjusmentBatchFactory implements FactoryBean<InventoryAdjusmentBatchEntity> {
	 ...
	 */
	@Override
	public InventoryAdjusmentBatchEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public InventoryAdjusmentBatchEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public InventoryAdjusmentBatchEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		if (includeReferences) {
			...
			// % protected region % [Override the reference inclusions for incomingOneToManyInventory Adjustment Item here] off begin
			var inventoryAdjustmentItemFactory = new InventoryAdjustmentItemFactory();
			newEntity.setInventoryAdjustmentItem(inventoryAdjustmentItemFactory.getObject(false, includeId), false);
			// % protected region % [Override the reference inclusions for incomingOneToManyInventory Adjustment Item here] end
		...
		// % protected region % [Apply any additional logic for inventoryAdjusmentBatch with ref here] off begin
		// % protected region % [Apply any additional logic for inventoryAdjusmentBatch with ref here] end

		return newEntity;
	}

	@Override
	public Class<InventoryAdjusmentBatchEntity> getObjectType() {
