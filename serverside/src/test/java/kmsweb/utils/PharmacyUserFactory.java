...
public class PharmacyUserFactory implements FactoryBean<PharmacyUserEntity> {
	 ...
	 */
	@Override
	public PharmacyUserEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public PharmacyUserEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public PharmacyUserEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		// % protected region % [Apply any additional logic for pharmacyUser with ref here] off begin
		// % protected region % [Apply any additional logic for pharmacyUser with ref here] end

		return newEntity;
	}

	@Override
	public Class<PharmacyUserEntity> getObjectType() {
