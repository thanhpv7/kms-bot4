...
public class BedReserveFactory implements FactoryBean<BedReserveEntity> {
	 ...
	 */
	@Override
	public BedReserveEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public BedReserveEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public BedReserveEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		// % protected region % [Apply any additional logic for bedReserve with ref here] off begin
		// % protected region % [Apply any additional logic for bedReserve with ref here] end

		return newEntity;
	}

	@Override
	public Class<BedReserveEntity> getObjectType() {
