...
public class MedicalCertificateRestrictedWorkFactory implements FactoryBean<MedicalCertificateRestrictedWorkEntity> {
	 ...
	 */
	@Override
	public MedicalCertificateRestrictedWorkEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public MedicalCertificateRestrictedWorkEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public MedicalCertificateRestrictedWorkEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		// % protected region % [Apply any additional logic for medicalCertificateRestrictedWork with ref here] off begin
		// % protected region % [Apply any additional logic for medicalCertificateRestrictedWork with ref here] end

		return newEntity;
	}

	@Override
	public Class<MedicalCertificateRestrictedWorkEntity> getObjectType() {
