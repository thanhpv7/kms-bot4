...
public class BpjsTreatmentClassMappingFactory implements FactoryBean<BpjsTreatmentClassMappingEntity> {
	 ...
	 */
	@Override
	public BpjsTreatmentClassMappingEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public BpjsTreatmentClassMappingEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public BpjsTreatmentClassMappingEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		String randomStringForInternalTreatmentClass = mockNeat
				.strings()
				.get();
	...
	@Override
	public Class<BpjsTreatmentClassMappingEntity> getObjectType() {
