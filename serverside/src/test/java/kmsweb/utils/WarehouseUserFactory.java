...
public class WarehouseUserFactory implements FactoryBean<WarehouseUserEntity> {
	 ...
	 */
	@Override
	public WarehouseUserEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public WarehouseUserEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public WarehouseUserEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		// % protected region % [Apply any additional logic for warehouseUser with ref here] off begin
		// % protected region % [Apply any additional logic for warehouseUser with ref here] end

		return newEntity;
	}

	@Override
	public Class<WarehouseUserEntity> getObjectType() {
