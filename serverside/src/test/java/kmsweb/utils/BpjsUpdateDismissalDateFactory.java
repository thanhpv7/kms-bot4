...
public class BpjsUpdateDismissalDateFactory implements FactoryBean<BpjsUpdateDismissalDateEntity> {
	 ...
	 */
	@Override
	public BpjsUpdateDismissalDateEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public BpjsUpdateDismissalDateEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public BpjsUpdateDismissalDateEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		String randomStringForDeathCertificateLetterNo = mockNeat
				.strings()
				.get();
		...
		String randomStringForPoliceReportNo = mockNeat
				.strings()
				.get();
	...
	@Override
	public Class<BpjsUpdateDismissalDateEntity> getObjectType() {
