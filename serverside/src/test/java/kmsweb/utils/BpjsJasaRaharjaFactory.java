...
public class BpjsJasaRaharjaFactory implements FactoryBean<BpjsJasaRaharjaEntity> {
	 ...
	 */
	@Override
	public BpjsJasaRaharjaEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public BpjsJasaRaharjaEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public BpjsJasaRaharjaEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		String randomStringForInitialSEPNo = mockNeat
				.strings()
				.get();
		...
		String randomStringForRegistrationNo = mockNeat
				.strings()
				.get();
		...
		// % protected region % [Apply any additional logic for bpjsJasaRaharja with ref here] off begin
		// % protected region % [Apply any additional logic for bpjsJasaRaharja with ref here] end

		return newEntity;
	}

	@Override
	public Class<BpjsJasaRaharjaEntity> getObjectType() {
