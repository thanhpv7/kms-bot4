...
public class PatientPaymentSelfPayingFactory implements FactoryBean<PatientPaymentSelfPayingEntity> {
	 ...
	 */
	@Override
	public PatientPaymentSelfPayingEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public PatientPaymentSelfPayingEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public PatientPaymentSelfPayingEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		// % protected region % [Apply any additional logic for patientPaymentSelfPaying with ref here] off begin
		// % protected region % [Apply any additional logic for patientPaymentSelfPaying with ref here] end

		return newEntity;
	}

	@Override
	public Class<PatientPaymentSelfPayingEntity> getObjectType() {
