...
public class DoctorUserFactory implements FactoryBean<DoctorUserEntity> {
	 ...
	 */
	@Override
	public DoctorUserEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public DoctorUserEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public DoctorUserEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		// % protected region % [Apply any additional logic for doctorUser with ref here] off begin
		// % protected region % [Apply any additional logic for doctorUser with ref here] end

		return newEntity;
	}

	@Override
	public Class<DoctorUserEntity> getObjectType() {
