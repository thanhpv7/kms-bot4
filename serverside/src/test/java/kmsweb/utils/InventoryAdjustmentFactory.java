...
public class InventoryAdjustmentFactory implements FactoryBean<InventoryAdjustmentEntity> {
	 ...
	 */
	@Override
	public InventoryAdjustmentEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public InventoryAdjustmentEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public InventoryAdjustmentEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		String randomStringForAdjustmentNumber = mockNeat
				.strings()
				.get();
		...
		String randomStringForAdjustmentType = mockNeat
				.strings()
				.get();
		...
		// % protected region % [Apply any additional logic for inventoryAdjustment with ref here] off begin
		// % protected region % [Apply any additional logic for inventoryAdjustment with ref here] end

		return newEntity;
	}

	@Override
	public Class<InventoryAdjustmentEntity> getObjectType() {
