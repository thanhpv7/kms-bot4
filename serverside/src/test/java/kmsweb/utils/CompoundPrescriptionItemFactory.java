...
public class CompoundPrescriptionItemFactory implements FactoryBean<CompoundPrescriptionItemEntity> {
	 ...
	 */
	@Override
	public CompoundPrescriptionItemEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public CompoundPrescriptionItemEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public CompoundPrescriptionItemEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		if (includeReferences) {
			...
			// % protected region % [Override the reference inclusions for incomingOneToManyCompound Prescription Detail here] off begin
			var compoundPrescriptionDetailFactory = new CompoundPrescriptionDetailFactory();
			newEntity.setCompoundPrescriptionDetail(compoundPrescriptionDetailFactory.getObject(false, includeId), false);
			// % protected region % [Override the reference inclusions for incomingOneToManyCompound Prescription Detail here] end
		...
		// % protected region % [Apply any additional logic for compoundPrescriptionItem with ref here] off begin
		// % protected region % [Apply any additional logic for compoundPrescriptionItem with ref here] end

		return newEntity;
	}

	@Override
	public Class<CompoundPrescriptionItemEntity> getObjectType() {
