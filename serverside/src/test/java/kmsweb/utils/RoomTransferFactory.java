...
public class RoomTransferFactory implements FactoryBean<RoomTransferEntity> {
	 ...
	 */
	@Override
	public RoomTransferEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public RoomTransferEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public RoomTransferEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		String randomStringForTransferringStaffName = mockNeat
				.strings()
				.get();
		...
		if (includeReferences) {
			...
			// Incoming One to Many reference
			// % protected region % [Override the reference inclusions for incomingOneToManyTransferring Staff here] off begin
			var transferringStaffFactory = new StaffFactory();
			newEntity.setTransferringStaff(transferringStaffFactory.getObject(false, includeId), false);
			// % protected region % [Override the reference inclusions for incomingOneToManyTransferring Staff here] end

		}

		// % protected region % [Apply any additional logic for roomTransfer with ref here] off begin
		// % protected region % [Apply any additional logic for roomTransfer with ref here] end

		return newEntity;
	}

	@Override
	public Class<RoomTransferEntity> getObjectType() {
