...
public class ServiceFacilityCategoryFactory implements FactoryBean<ServiceFacilityCategoryEntity> {
	 ...
	 */
	@Override
	public ServiceFacilityCategoryEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public ServiceFacilityCategoryEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public ServiceFacilityCategoryEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		String randomStringForFacilityCode = mockNeat
				.strings()
				.get();
		...
		// % protected region % [Apply any additional logic for serviceFacilityCategory with ref here] off begin
		// % protected region % [Apply any additional logic for serviceFacilityCategory with ref here] end

		return newEntity;
	}

	@Override
	public Class<ServiceFacilityCategoryEntity> getObjectType() {
