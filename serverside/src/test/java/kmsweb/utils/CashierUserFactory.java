...
public class CashierUserFactory implements FactoryBean<CashierUserEntity> {
	 ...
	 */
	@Override
	public CashierUserEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public CashierUserEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public CashierUserEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		// % protected region % [Apply any additional logic for cashierUser with ref here] off begin
		// % protected region % [Apply any additional logic for cashierUser with ref here] end

		return newEntity;
	}

	@Override
	public Class<CashierUserEntity> getObjectType() {
