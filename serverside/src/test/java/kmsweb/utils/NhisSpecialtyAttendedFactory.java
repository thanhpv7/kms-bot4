...
public class NhisSpecialtyAttendedFactory implements FactoryBean<NhisSpecialtyAttendedEntity> {
	 ...
	 */
	@Override
	public NhisSpecialtyAttendedEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public NhisSpecialtyAttendedEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public NhisSpecialtyAttendedEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		String randomStringForServices = mockNeat
				.strings()
				.get();
	...
	@Override
	public Class<NhisSpecialtyAttendedEntity> getObjectType() {
