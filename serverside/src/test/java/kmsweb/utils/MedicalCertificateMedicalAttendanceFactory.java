...
public class MedicalCertificateMedicalAttendanceFactory implements FactoryBean<MedicalCertificateMedicalAttendanceEntity> {
	 ...
	 */
	@Override
	public MedicalCertificateMedicalAttendanceEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public MedicalCertificateMedicalAttendanceEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public MedicalCertificateMedicalAttendanceEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		// % protected region % [Apply any additional logic for medicalCertificateMedicalAttendance with ref here] off begin
		// % protected region % [Apply any additional logic for medicalCertificateMedicalAttendance with ref here] end

		return newEntity;
	}

	@Override
	public Class<MedicalCertificateMedicalAttendanceEntity> getObjectType() {
