...
public class ReferenceHeaderFactory implements FactoryBean<ReferenceHeaderEntity> {
	 ...
	 */
	@Override
	public ReferenceHeaderEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public ReferenceHeaderEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public ReferenceHeaderEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
	...
	@Override
	public Class<ReferenceHeaderEntity> getObjectType() {
