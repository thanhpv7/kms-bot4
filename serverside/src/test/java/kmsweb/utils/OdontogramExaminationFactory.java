...
public class OdontogramExaminationFactory implements FactoryBean<OdontogramExaminationEntity> {
	 ...
	 */
	@Override
	public OdontogramExaminationEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public OdontogramExaminationEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public OdontogramExaminationEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		String randomStringForOdontogramData = mockNeat
				.strings()
				.get();
		...
		newEntity.setIsPermanent(mockNeat.bools().get());
		...
		// % protected region % [Apply any additional logic for odontogramExamination with ref here] off begin
		// % protected region % [Apply any additional logic for odontogramExamination with ref here] end

		return newEntity;
	}

	@Override
	public Class<OdontogramExaminationEntity> getObjectType() {
