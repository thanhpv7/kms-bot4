...
public class BatchStockBalanceFactory implements FactoryBean<BatchStockBalanceEntity> {
	 ...
	 */
	@Override
	public BatchStockBalanceEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public BatchStockBalanceEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public BatchStockBalanceEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		String randomStringForSourceNumber = mockNeat
				.strings()
				.get();
		...
		// % protected region % [Apply any additional logic for batchStockBalance with ref here] off begin
		// % protected region % [Apply any additional logic for batchStockBalance with ref here] end

		return newEntity;
	}

	@Override
	public Class<BatchStockBalanceEntity> getObjectType() {
