...
public class BpjsTotalReferralSEPFactory implements FactoryBean<BpjsTotalReferralSEPEntity> {
	 ...
	 */
	@Override
	public BpjsTotalReferralSEPEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public BpjsTotalReferralSEPEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public BpjsTotalReferralSEPEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		String randomStringForTotalSEP = mockNeat
				.strings()
				.get();
	...
	@Override
	public Class<BpjsTotalReferralSEPEntity> getObjectType() {
