...
public class PcareTindakanFactory implements FactoryBean<PcareTindakanEntity> {
	 ...
	 */
	@Override
	public PcareTindakanEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public PcareTindakanEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public PcareTindakanEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		String randomStringForKodeTindakan = mockNeat
				.strings()
				.get();
		...
		String randomStringForNamaTindakan = mockNeat
				.strings()
				.get();
		...
		String randomStringForMaksimalTarif = mockNeat
				.strings()
				.get();
		...
		newEntity.setWithvalue(mockNeat.bools().get());
		...
		String randomStringForTindakanInternal = mockNeat
				.strings()
				.get();
	...
	@Override
	public Class<PcareTindakanEntity> getObjectType() {
