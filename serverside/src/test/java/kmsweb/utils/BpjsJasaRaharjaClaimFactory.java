...
public class BpjsJasaRaharjaClaimFactory implements FactoryBean<BpjsJasaRaharjaClaimEntity> {
	 ...
	 */
	@Override
	public BpjsJasaRaharjaClaimEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public BpjsJasaRaharjaClaimEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public BpjsJasaRaharjaClaimEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
	...
	@Override
	public Class<BpjsJasaRaharjaClaimEntity> getObjectType() {
