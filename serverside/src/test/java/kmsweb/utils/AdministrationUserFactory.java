...
public class AdministrationUserFactory implements FactoryBean<AdministrationUserEntity> {
	 ...
	 */
	@Override
	public AdministrationUserEntity getObject() throws Exception {
	 ...
	 * @see #getObject(boolean, boolean)
	 */
	public AdministrationUserEntity getObjectWithReferences(boolean includeIds) throws Exception {
	 ...
	 * @throws Exception
	 */
	public AdministrationUserEntity getObject(boolean includeReferences, boolean includeId) throws Exception {
		...
		// % protected region % [Apply any additional logic for administrationUser with ref here] off begin
		// % protected region % [Apply any additional logic for administrationUser with ref here] end

		return newEntity;
	}

	@Override
	public Class<AdministrationUserEntity> getObjectType() {
