...
@ActiveProfiles("test")
public class BpjsPcareProviderRayonisasiControllerTest {
	...
	public void checkAuthorisationForVisitorsGetAll() {
		...
		RestAssuredMockMvc
				.given()
				.when()
				.get("/api/bpjspcareproviderrayonisasi")
				.then()
	...
	public void checkAuthorisationForVisitorsGet() {
		...
		RestAssuredMockMvc
				...
				.get("/api/bpjspcareproviderrayonisasi/ec8d16d0-484b-405b-b024-977161a9faee")
				.then()
	...
	public void checkAuthorisationForVisitorsPost() {
		...
		RestAssuredMockMvc
				.given()
				.when()
				.post("/api/bpjspcareproviderrayonisasi")
				.then()
	...
	public void checkAuthorisationForVisitorsPut() {
		...
		RestAssuredMockMvc
				.given()
				.when()
				.put("/api/bpjspcareproviderrayonisasi")
				.then()
	...
	public void checkAuthorisationForVisitorsDelete() {
		...
		RestAssuredMockMvc
				...
				.when()
				/* Use a random UUID to test security */
				.delete("/api/bpjspcareproviderrayonisasi/ec8d16d0-484b-405b-b024-977161a9faee")
				.then()
