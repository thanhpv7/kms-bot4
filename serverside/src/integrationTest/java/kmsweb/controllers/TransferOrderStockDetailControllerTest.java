...
@ActiveProfiles("test")
public class TransferOrderStockDetailControllerTest {
	...
	public void checkAuthorisationForVisitorsGetAll() {
		...
		RestAssuredMockMvc
				.given()
				.when()
				.get("/api/transferorderstockdetail")
				.then()
	...
	public void checkAuthorisationForVisitorsGet() {
		...
		RestAssuredMockMvc
				...
				.get("/api/transferorderstockdetail/ec8d16d0-484b-405b-b024-977161a9faee")
				.then()
	...
	public void checkAuthorisationForVisitorsPost() {
		...
		RestAssuredMockMvc
				.given()
				.when()
				.post("/api/transferorderstockdetail")
				.then()
	...
	public void checkAuthorisationForVisitorsPut() {
		...
		RestAssuredMockMvc
				.given()
				.when()
				.put("/api/transferorderstockdetail")
				.then()
	...
	public void checkAuthorisationForVisitorsDelete() {
		...
		RestAssuredMockMvc
				...
				.when()
				/* Use a random UUID to test security */
				.delete("/api/transferorderstockdetail/ec8d16d0-484b-405b-b024-977161a9faee")
				.then()
