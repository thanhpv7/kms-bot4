...
@ActiveProfiles("test")
public class PreoperativeRecordsControllerTest {
	...
	public void checkAuthorisationForVisitorsGet() {
		...
		RestAssuredMockMvc
				...
				.get("/api/preoperativerecords/ec8d16d0-484b-405b-b024-977161a9faee")
				.then()
	...
	public void checkAuthorisationForVisitorsDelete() {
		...
		RestAssuredMockMvc
				...
				.when()
				/* Use a random UUID to test security */
				.delete("/api/preoperativerecords/ec8d16d0-484b-405b-b024-977161a9faee")
				.then()
