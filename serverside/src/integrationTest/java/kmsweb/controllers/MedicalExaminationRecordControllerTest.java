...
@ActiveProfiles("test")
public class MedicalExaminationRecordControllerTest {
	...
	public void checkAuthorisationForVisitorsGetAll() {
		...
		RestAssuredMockMvc
				.given()
				.when()
				.get("/api/medicalexaminationrecord")
				.then()
	...
	public void checkAuthorisationForVisitorsGet() {
		...
		RestAssuredMockMvc
				...
				.get("/api/medicalexaminationrecord/ec8d16d0-484b-405b-b024-977161a9faee")
				.then()
	...
	public void checkAuthorisationForVisitorsPost() {
		...
		RestAssuredMockMvc
				.given()
				.when()
				.post("/api/medicalexaminationrecord")
				.then()
	...
	public void checkAuthorisationForVisitorsPut() {
		...
		RestAssuredMockMvc
				.given()
				.when()
				.put("/api/medicalexaminationrecord")
				.then()
	...
	public void checkAuthorisationForVisitorsDelete() {
		...
		RestAssuredMockMvc
				...
				.when()
				/* Use a random UUID to test security */
				.delete("/api/medicalexaminationrecord/ec8d16d0-484b-405b-b024-977161a9faee")
				.then()
