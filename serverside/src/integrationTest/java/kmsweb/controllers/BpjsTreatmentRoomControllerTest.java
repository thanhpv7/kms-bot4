...
@ActiveProfiles("test")
public class BpjsTreatmentRoomControllerTest {
	...
	public void checkAuthorisationForVisitorsGet() {
		...
		RestAssuredMockMvc
				...
				.get("/api/bpjstreatmentroom/ec8d16d0-484b-405b-b024-977161a9faee")
				.then()
	...
	public void checkAuthorisationForVisitorsDelete() {
		...
		RestAssuredMockMvc
				...
				.when()
				/* Use a random UUID to test security */
				.delete("/api/bpjstreatmentroom/ec8d16d0-484b-405b-b024-977161a9faee")
				.then()
