...
@ActiveProfiles("test")
public class BodyChartExaminationControllerTest {
	...
	public void checkAuthorisationForVisitorsGet() {
		...
		RestAssuredMockMvc
				...
				.get("/api/bodychartexamination/ec8d16d0-484b-405b-b024-977161a9faee")
				.then()
	...
	public void checkAuthorisationForVisitorsDelete() {
		...
		RestAssuredMockMvc
				...
				.when()
				/* Use a random UUID to test security */
				.delete("/api/bodychartexamination/ec8d16d0-484b-405b-b024-977161a9faee")
				.then()
