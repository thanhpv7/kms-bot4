...
@ActiveProfiles("test")
public class GoodsReceiveNoteBatchControllerTest {
	...
	public void checkAuthorisationForVisitorsGet() {
		...
		RestAssuredMockMvc
				...
				.get("/api/goodsreceivenotebatch/ec8d16d0-484b-405b-b024-977161a9faee")
				.then()
	...
	public void checkAuthorisationForVisitorsPost() {
		...
		RestAssuredMockMvc
				.given()
				.when()
				.post("/api/goodsreceivenotebatch")
				.then()
	...
	public void checkAuthorisationForVisitorsDelete() {
		...
		RestAssuredMockMvc
				...
				.when()
				/* Use a random UUID to test security */
				.delete("/api/goodsreceivenotebatch/ec8d16d0-484b-405b-b024-977161a9faee")
				.then()
