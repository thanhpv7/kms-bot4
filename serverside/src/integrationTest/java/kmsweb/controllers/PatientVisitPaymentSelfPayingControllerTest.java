...
@ActiveProfiles("test")
public class PatientVisitPaymentSelfPayingControllerTest {
	...
	public void checkAuthorisationForVisitorsGetAll() {
		...
		RestAssuredMockMvc
				.given()
				.when()
				.get("/api/patientvisitpaymentselfpaying")
				.then()
	...
	public void checkAuthorisationForVisitorsGet() {
		...
		RestAssuredMockMvc
				...
				.get("/api/patientvisitpaymentselfpaying/ec8d16d0-484b-405b-b024-977161a9faee")
				.then()
	...
	public void checkAuthorisationForVisitorsPost() {
		...
		RestAssuredMockMvc
				.given()
				.when()
				.post("/api/patientvisitpaymentselfpaying")
				.then()
	...
	public void checkAuthorisationForVisitorsPut() {
		...
		RestAssuredMockMvc
				.given()
				.when()
				.put("/api/patientvisitpaymentselfpaying")
				.then()
	...
	public void checkAuthorisationForVisitorsDelete() {
		...
		RestAssuredMockMvc
				...
				.when()
				/* Use a random UUID to test security */
				.delete("/api/patientvisitpaymentselfpaying/ec8d16d0-484b-405b-b024-977161a9faee")
				.then()
