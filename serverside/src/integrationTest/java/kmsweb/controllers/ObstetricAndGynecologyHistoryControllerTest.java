...
@ActiveProfiles("test")
public class ObstetricAndGynecologyHistoryControllerTest {
	...
	public void checkAuthorisationForVisitorsGetAll() {
		...
		RestAssuredMockMvc
				.given()
				.when()
				.get("/api/obstetricandgynecologyhistory")
				.then()
	...
	public void checkAuthorisationForVisitorsGet() {
		...
		RestAssuredMockMvc
				...
				.get("/api/obstetricandgynecologyhistory/ec8d16d0-484b-405b-b024-977161a9faee")
				.then()
	...
	public void checkAuthorisationForVisitorsPost() {
		...
		RestAssuredMockMvc
				.given()
				.when()
				.post("/api/obstetricandgynecologyhistory")
				.then()
	...
	public void checkAuthorisationForVisitorsPut() {
		...
		RestAssuredMockMvc
				.given()
				.when()
				.put("/api/obstetricandgynecologyhistory")
				.then()
	...
	public void checkAuthorisationForVisitorsDelete() {
		...
		RestAssuredMockMvc
				...
				.when()
				/* Use a random UUID to test security */
				.delete("/api/obstetricandgynecologyhistory/ec8d16d0-484b-405b-b024-977161a9faee")
				.then()
