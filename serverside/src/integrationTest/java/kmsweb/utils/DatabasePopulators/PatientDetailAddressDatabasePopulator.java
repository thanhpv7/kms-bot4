...
@Component
public class PatientDetailAddressDatabasePopulator implements DatabasePopulatorInterface<PatientDetailAddressEntity> {
	...
	public PatientDetailAddressDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull PatientDetailAddressEntity entity,
