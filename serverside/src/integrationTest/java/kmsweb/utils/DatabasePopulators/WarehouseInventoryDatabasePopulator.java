...
@Component
public class WarehouseInventoryDatabasePopulator implements DatabasePopulatorInterface<WarehouseInventoryEntity> {
	...
	public WarehouseInventoryDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull WarehouseInventoryEntity entity,
