...
@Component
public class PrivilegeDatabasePopulator implements DatabasePopulatorInterface<PrivilegeEntity> {
	...
	public PrivilegeDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull PrivilegeEntity entity,
