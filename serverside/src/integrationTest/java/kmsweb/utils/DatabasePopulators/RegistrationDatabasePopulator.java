...
@Component
public class RegistrationDatabasePopulator implements DatabasePopulatorInterface<RegistrationEntity> {
	...
	public RegistrationDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull RegistrationEntity entity,
