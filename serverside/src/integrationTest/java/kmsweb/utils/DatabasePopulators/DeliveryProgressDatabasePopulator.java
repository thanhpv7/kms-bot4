...
@Component
public class DeliveryProgressDatabasePopulator implements DatabasePopulatorInterface<DeliveryProgressEntity> {
	...
	public DeliveryProgressDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull DeliveryProgressEntity entity,
