...
@Component
public class StockCatalogueDatabasePopulator implements DatabasePopulatorInterface<StockCatalogueEntity> {
	...
	public StockCatalogueDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull StockCatalogueEntity entity,
