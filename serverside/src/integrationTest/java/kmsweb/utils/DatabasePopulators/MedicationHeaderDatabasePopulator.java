...
@Component
public class MedicationHeaderDatabasePopulator implements DatabasePopulatorInterface<MedicationHeaderEntity> {
	...
	public MedicationHeaderDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull MedicationHeaderEntity entity,
