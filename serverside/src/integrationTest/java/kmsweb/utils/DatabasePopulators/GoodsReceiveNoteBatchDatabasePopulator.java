...
@Component
public class GoodsReceiveNoteBatchDatabasePopulator implements DatabasePopulatorInterface<GoodsReceiveNoteBatchEntity> {
	...
	public GoodsReceiveNoteBatchDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull GoodsReceiveNoteBatchEntity entity,
