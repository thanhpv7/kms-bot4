...
@Component
public class StockControlDatabasePopulator implements DatabasePopulatorInterface<StockControlEntity> {
	...
	public StockControlDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull StockControlEntity entity,
