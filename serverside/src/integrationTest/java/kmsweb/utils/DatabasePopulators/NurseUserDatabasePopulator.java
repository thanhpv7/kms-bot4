...
@Component
public class NurseUserDatabasePopulator implements DatabasePopulatorInterface<NurseUserEntity> {
	...
	public NurseUserDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull NurseUserEntity entity,
