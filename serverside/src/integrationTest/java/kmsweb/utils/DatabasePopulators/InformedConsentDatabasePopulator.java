...
@Component
public class InformedConsentDatabasePopulator implements DatabasePopulatorInterface<InformedConsentEntity> {
	...
	public InformedConsentDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull InformedConsentEntity entity,
