...
@Component
public class PatientContactInfoDatabasePopulator implements DatabasePopulatorInterface<PatientContactInfoEntity> {
	...
	public PatientContactInfoDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull PatientContactInfoEntity entity,
