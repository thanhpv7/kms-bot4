...
@Component
public class WarehouseInitialStockDatabasePopulator implements DatabasePopulatorInterface<WarehouseInitialStockEntity> {
	...
	public WarehouseInitialStockDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull WarehouseInitialStockEntity entity,
