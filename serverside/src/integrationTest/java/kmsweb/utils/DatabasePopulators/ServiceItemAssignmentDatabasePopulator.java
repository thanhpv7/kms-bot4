...
@Component
public class ServiceItemAssignmentDatabasePopulator implements DatabasePopulatorInterface<ServiceItemAssignmentEntity> {
	...
	public ServiceItemAssignmentDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull ServiceItemAssignmentEntity entity,
