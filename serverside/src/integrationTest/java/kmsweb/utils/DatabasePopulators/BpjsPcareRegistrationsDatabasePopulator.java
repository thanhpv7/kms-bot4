...
@Component
public class BpjsPcareRegistrationsDatabasePopulator implements DatabasePopulatorInterface<BpjsPcareRegistrationsEntity> {
	...
	public BpjsPcareRegistrationsDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull BpjsPcareRegistrationsEntity entity,
