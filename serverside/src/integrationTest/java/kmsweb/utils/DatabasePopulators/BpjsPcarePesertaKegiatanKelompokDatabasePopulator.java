...
@Component
public class BpjsPcarePesertaKegiatanKelompokDatabasePopulator implements DatabasePopulatorInterface<BpjsPcarePesertaKegiatanKelompokEntity> {
	...
	public BpjsPcarePesertaKegiatanKelompokDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull BpjsPcarePesertaKegiatanKelompokEntity entity,
