...
@Component
public class BpjsPcareKegiatanKelompokDatabasePopulator implements DatabasePopulatorInterface<BpjsPcareKegiatanKelompokEntity> {
	...
	public BpjsPcareKegiatanKelompokDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull BpjsPcareKegiatanKelompokEntity entity,
