...
@Component
public class DoctorUserDatabasePopulator implements DatabasePopulatorInterface<DoctorUserEntity> {
	...
	public DoctorUserDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull DoctorUserEntity entity,
