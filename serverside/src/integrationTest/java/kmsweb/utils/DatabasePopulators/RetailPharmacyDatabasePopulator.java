...
@Component
public class RetailPharmacyDatabasePopulator implements DatabasePopulatorInterface<RetailPharmacyEntity> {
	...
	public RetailPharmacyDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull RetailPharmacyEntity entity,
