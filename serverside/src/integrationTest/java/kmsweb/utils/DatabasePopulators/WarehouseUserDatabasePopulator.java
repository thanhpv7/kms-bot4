...
@Component
public class WarehouseUserDatabasePopulator implements DatabasePopulatorInterface<WarehouseUserEntity> {
	...
	public WarehouseUserDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull WarehouseUserEntity entity,
