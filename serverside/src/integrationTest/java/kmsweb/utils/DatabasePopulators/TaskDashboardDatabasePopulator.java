...
@Component
public class TaskDashboardDatabasePopulator implements DatabasePopulatorInterface<TaskDashboardEntity> {
	...
	public TaskDashboardDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull TaskDashboardEntity entity,
