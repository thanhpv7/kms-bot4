...
@Component
public class PurchaseOrderDatabasePopulator implements DatabasePopulatorInterface<PurchaseOrderEntity> {
	...
	public PurchaseOrderDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull PurchaseOrderEntity entity,
