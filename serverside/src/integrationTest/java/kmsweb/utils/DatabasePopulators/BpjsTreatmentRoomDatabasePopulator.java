...
@Component
public class BpjsTreatmentRoomDatabasePopulator implements DatabasePopulatorInterface<BpjsTreatmentRoomEntity> {
	...
	public BpjsTreatmentRoomDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull BpjsTreatmentRoomEntity entity,
