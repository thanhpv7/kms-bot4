...
@Component
public class InvoicePaymentInsuranceDatabasePopulator implements DatabasePopulatorInterface<InvoicePaymentInsuranceEntity> {
	...
	public InvoicePaymentInsuranceDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull InvoicePaymentInsuranceEntity entity,
