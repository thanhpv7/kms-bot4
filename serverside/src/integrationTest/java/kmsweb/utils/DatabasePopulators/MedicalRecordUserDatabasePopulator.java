...
@Component
public class MedicalRecordUserDatabasePopulator implements DatabasePopulatorInterface<MedicalRecordUserEntity> {
	...
	public MedicalRecordUserDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull MedicalRecordUserEntity entity,
