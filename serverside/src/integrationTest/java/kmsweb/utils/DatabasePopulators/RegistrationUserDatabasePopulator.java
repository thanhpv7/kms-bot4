...
@Component
public class RegistrationUserDatabasePopulator implements DatabasePopulatorInterface<RegistrationUserEntity> {
	...
	public RegistrationUserDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull RegistrationUserEntity entity,
