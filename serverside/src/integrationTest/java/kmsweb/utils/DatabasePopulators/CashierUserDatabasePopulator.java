...
@Component
public class CashierUserDatabasePopulator implements DatabasePopulatorInterface<CashierUserEntity> {
	...
	public CashierUserDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull CashierUserEntity entity,
