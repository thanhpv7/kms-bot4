...
@Component
public class NhisClaimDatabasePopulator implements DatabasePopulatorInterface<NhisClaimEntity> {
	...
	public NhisClaimDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull NhisClaimEntity entity,
