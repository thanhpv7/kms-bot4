...
@Component
public class PharmacyUserDatabasePopulator implements DatabasePopulatorInterface<PharmacyUserEntity> {
	...
	public PharmacyUserDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull PharmacyUserEntity entity,
