...
@Component
public class ChartOfAccountDatabasePopulator implements DatabasePopulatorInterface<ChartOfAccountEntity> {
	...
	public ChartOfAccountDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull ChartOfAccountEntity entity,
