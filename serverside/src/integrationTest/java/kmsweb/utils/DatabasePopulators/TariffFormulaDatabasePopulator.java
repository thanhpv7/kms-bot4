...
@Component
public class TariffFormulaDatabasePopulator implements DatabasePopulatorInterface<TariffFormulaEntity> {
	...
	public TariffFormulaDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull TariffFormulaEntity entity,
