...
@Component
public class HealthFacilityDatabasePopulator implements DatabasePopulatorInterface<HealthFacilityEntity> {
	...
	public HealthFacilityDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull HealthFacilityEntity entity,
