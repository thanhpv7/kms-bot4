...
@Component
public class WarehouseDatabasePopulator implements DatabasePopulatorInterface<WarehouseEntity> {
	...
	public WarehouseDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull WarehouseEntity entity,
