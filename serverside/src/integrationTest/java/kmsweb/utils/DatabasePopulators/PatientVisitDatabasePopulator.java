...
@Component
public class PatientVisitDatabasePopulator implements DatabasePopulatorInterface<PatientVisitEntity> {
	...
	public PatientVisitDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull PatientVisitEntity entity,
