...
@Component
public class ChartOfAccountMappingDatabasePopulator implements DatabasePopulatorInterface<ChartOfAccountMappingEntity> {
	...
	public ChartOfAccountMappingDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull ChartOfAccountMappingEntity entity,
