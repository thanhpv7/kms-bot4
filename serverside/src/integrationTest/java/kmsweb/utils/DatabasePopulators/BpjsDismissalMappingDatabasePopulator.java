...
@Component
public class BpjsDismissalMappingDatabasePopulator implements DatabasePopulatorInterface<BpjsDismissalMappingEntity> {
	...
	public BpjsDismissalMappingDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull BpjsDismissalMappingEntity entity,
