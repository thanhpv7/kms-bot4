...
@Component
public class PatientPaymentSelfPayingDatabasePopulator implements DatabasePopulatorInterface<PatientPaymentSelfPayingEntity> {
	...
	public PatientPaymentSelfPayingDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull PatientPaymentSelfPayingEntity entity,
