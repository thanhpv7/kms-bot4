...
@Component
public class BpjsSearchControlLetterDatabasePopulator implements DatabasePopulatorInterface<BpjsSearchControlLetterEntity> {
	...
	public BpjsSearchControlLetterDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull BpjsSearchControlLetterEntity entity,
