...
@Component
public class RoomTransferDatabasePopulator implements DatabasePopulatorInterface<RoomTransferEntity> {
	...
	public RoomTransferDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull RoomTransferEntity entity,
