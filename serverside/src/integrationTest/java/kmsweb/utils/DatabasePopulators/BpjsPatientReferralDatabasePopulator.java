...
@Component
public class BpjsPatientReferralDatabasePopulator implements DatabasePopulatorInterface<BpjsPatientReferralEntity> {
	...
	public BpjsPatientReferralDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull BpjsPatientReferralEntity entity,
