...
@Component
public class GoodsReceiveNoteDatabasePopulator implements DatabasePopulatorInterface<GoodsReceiveNoteEntity> {
	...
	public GoodsReceiveNoteDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull GoodsReceiveNoteEntity entity,
