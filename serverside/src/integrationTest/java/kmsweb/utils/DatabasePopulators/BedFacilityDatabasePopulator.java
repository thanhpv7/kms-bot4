...
@Component
public class BedFacilityDatabasePopulator implements DatabasePopulatorInterface<BedFacilityEntity> {
	...
	public BedFacilityDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull BedFacilityEntity entity,
