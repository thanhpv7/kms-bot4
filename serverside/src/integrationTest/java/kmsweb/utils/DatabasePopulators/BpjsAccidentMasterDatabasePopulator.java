...
@Component
public class BpjsAccidentMasterDatabasePopulator implements DatabasePopulatorInterface<BpjsAccidentMasterEntity> {
	...
	public BpjsAccidentMasterDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull BpjsAccidentMasterEntity entity,
