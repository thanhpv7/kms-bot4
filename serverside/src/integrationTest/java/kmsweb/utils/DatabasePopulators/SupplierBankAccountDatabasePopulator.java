...
@Component
public class SupplierBankAccountDatabasePopulator implements DatabasePopulatorInterface<SupplierBankAccountEntity> {
	...
	public SupplierBankAccountDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull SupplierBankAccountEntity entity,
