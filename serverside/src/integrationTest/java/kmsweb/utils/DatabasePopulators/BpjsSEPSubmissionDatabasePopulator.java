...
@Component
public class BpjsSEPSubmissionDatabasePopulator implements DatabasePopulatorInterface<BpjsSEPSubmissionEntity> {
	...
	public BpjsSEPSubmissionDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull BpjsSEPSubmissionEntity entity,
