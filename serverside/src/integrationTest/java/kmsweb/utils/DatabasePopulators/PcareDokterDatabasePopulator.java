...
@Component
public class PcareDokterDatabasePopulator implements DatabasePopulatorInterface<PcareDokterEntity> {
	...
	public PcareDokterDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull PcareDokterEntity entity,
