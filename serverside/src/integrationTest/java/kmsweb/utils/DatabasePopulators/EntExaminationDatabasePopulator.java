...
@Component
public class EntExaminationDatabasePopulator implements DatabasePopulatorInterface<EntExaminationEntity> {
	...
	public EntExaminationDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull EntExaminationEntity entity,
