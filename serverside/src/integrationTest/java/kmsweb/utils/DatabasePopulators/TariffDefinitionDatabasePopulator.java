...
@Component
public class TariffDefinitionDatabasePopulator implements DatabasePopulatorInterface<TariffDefinitionEntity> {
	...
	public TariffDefinitionDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull TariffDefinitionEntity entity,
