...
@Component
public class BatchStockBalanceDatabasePopulator implements DatabasePopulatorInterface<BatchStockBalanceEntity> {
	...
	public BatchStockBalanceDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull BatchStockBalanceEntity entity,
