...
@Component
public class DoctorScheduleDatabasePopulator implements DatabasePopulatorInterface<DoctorScheduleEntity> {
	...
	public DoctorScheduleDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull DoctorScheduleEntity entity,
