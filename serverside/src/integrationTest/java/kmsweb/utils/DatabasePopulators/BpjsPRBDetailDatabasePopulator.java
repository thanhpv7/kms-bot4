...
@Component
public class BpjsPRBDetailDatabasePopulator implements DatabasePopulatorInterface<BpjsPRBDetailEntity> {
	...
	public BpjsPRBDetailDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull BpjsPRBDetailEntity entity,
