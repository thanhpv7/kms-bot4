...
@Component
public class CatalogueUOMDatabasePopulator implements DatabasePopulatorInterface<CatalogueUOMEntity> {
	...
	public CatalogueUOMDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull CatalogueUOMEntity entity,
