...
@Component
public class InvoicePaymentSelfPayingDatabasePopulator implements DatabasePopulatorInterface<InvoicePaymentSelfPayingEntity> {
	...
	public InvoicePaymentSelfPayingDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull InvoicePaymentSelfPayingEntity entity,
