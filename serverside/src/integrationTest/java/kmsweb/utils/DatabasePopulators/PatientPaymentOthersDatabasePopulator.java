...
@Component
public class PatientPaymentOthersDatabasePopulator implements DatabasePopulatorInterface<PatientPaymentOthersEntity> {
	...
	public PatientPaymentOthersDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull PatientPaymentOthersEntity entity,
