...
@Component
public class MedicalFeeDatabasePopulator implements DatabasePopulatorInterface<MedicalFeeEntity> {
	...
	public MedicalFeeDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull MedicalFeeEntity entity,
