...
@Component
public class McuPackageDatabasePopulator implements DatabasePopulatorInterface<McuPackageEntity> {
	...
	public McuPackageDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull McuPackageEntity entity,
