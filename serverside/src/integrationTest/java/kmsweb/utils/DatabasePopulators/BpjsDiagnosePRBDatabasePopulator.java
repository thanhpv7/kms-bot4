...
@Component
public class BpjsDiagnosePRBDatabasePopulator implements DatabasePopulatorInterface<BpjsDiagnosePRBEntity> {
	...
	public BpjsDiagnosePRBDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull BpjsDiagnosePRBEntity entity,
