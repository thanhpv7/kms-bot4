...
@Component
public class BpjsPcarePoliDatabasePopulator implements DatabasePopulatorInterface<BpjsPcarePoliEntity> {
	...
	public BpjsPcarePoliDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull BpjsPcarePoliEntity entity,
