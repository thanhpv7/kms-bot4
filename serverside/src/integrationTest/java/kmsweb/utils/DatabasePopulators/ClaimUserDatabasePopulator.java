...
@Component
public class ClaimUserDatabasePopulator implements DatabasePopulatorInterface<ClaimUserEntity> {
	...
	public ClaimUserDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull ClaimUserEntity entity,
