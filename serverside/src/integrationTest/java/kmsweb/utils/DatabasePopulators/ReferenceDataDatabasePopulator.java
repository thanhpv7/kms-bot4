...
@Component
public class ReferenceDataDatabasePopulator implements DatabasePopulatorInterface<ReferenceDataEntity> {
	...
	public ReferenceDataDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull ReferenceDataEntity entity,
