...
@Component
public class PatientPaymentInsuranceDatabasePopulator implements DatabasePopulatorInterface<PatientPaymentInsuranceEntity> {
	...
	public PatientPaymentInsuranceDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull PatientPaymentInsuranceEntity entity,
