...
@Component
public class TariffSchemaDatabasePopulator implements DatabasePopulatorInterface<TariffSchemaEntity> {
	...
	public TariffSchemaDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull TariffSchemaEntity entity,
