...
@Component
public class UnitOfMeasurementDatabasePopulator implements DatabasePopulatorInterface<UnitOfMeasurementEntity> {
	...
	public UnitOfMeasurementDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull UnitOfMeasurementEntity entity,
