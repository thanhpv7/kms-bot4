...
@Component
public class PatientConsentDatabasePopulator implements DatabasePopulatorInterface<PatientConsentEntity> {
	...
	public PatientConsentDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull PatientConsentEntity entity,
