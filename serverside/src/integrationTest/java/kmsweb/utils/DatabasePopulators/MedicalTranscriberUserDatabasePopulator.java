...
@Component
public class MedicalTranscriberUserDatabasePopulator implements DatabasePopulatorInterface<MedicalTranscriberUserEntity> {
	...
	public MedicalTranscriberUserDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull MedicalTranscriberUserEntity entity,
