...
@Component
public class MedicalCertificateMentalHealthDatabasePopulator implements DatabasePopulatorInterface<MedicalCertificateMentalHealthEntity> {
	...
	public MedicalCertificateMentalHealthDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull MedicalCertificateMentalHealthEntity entity,
