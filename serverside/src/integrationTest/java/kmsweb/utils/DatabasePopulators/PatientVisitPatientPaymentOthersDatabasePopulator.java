...
@Component
public class PatientVisitPatientPaymentOthersDatabasePopulator implements DatabasePopulatorInterface<PatientVisitPatientPaymentOthersEntity> {
	...
	public PatientVisitPatientPaymentOthersDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull PatientVisitPatientPaymentOthersEntity entity,
