...
@Component
public class BirthHistoryDatabasePopulator implements DatabasePopulatorInterface<BirthHistoryEntity> {
	...
	public BirthHistoryDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull BirthHistoryEntity entity,
