...
@Component
public class BedReserveDatabasePopulator implements DatabasePopulatorInterface<BedReserveEntity> {
	...
	public BedReserveDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull BedReserveEntity entity,
