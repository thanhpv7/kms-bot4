...
@Component
public class MedicationCompoundDatabasePopulator implements DatabasePopulatorInterface<MedicationCompoundEntity> {
	...
	public MedicationCompoundDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull MedicationCompoundEntity entity,
