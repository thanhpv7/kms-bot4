...
@Component
public class PatientVisitPaymentSelfPayingDatabasePopulator implements DatabasePopulatorInterface<PatientVisitPaymentSelfPayingEntity> {
	...
	public PatientVisitPaymentSelfPayingDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull PatientVisitPaymentSelfPayingEntity entity,
