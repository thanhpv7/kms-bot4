...
@Component
public class BpjsHealthFacilityDatabasePopulator implements DatabasePopulatorInterface<BpjsHealthFacilityEntity> {
	...
	public BpjsHealthFacilityDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull BpjsHealthFacilityEntity entity,
