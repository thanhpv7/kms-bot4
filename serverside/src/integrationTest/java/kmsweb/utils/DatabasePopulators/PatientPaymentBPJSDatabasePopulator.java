...
@Component
public class PatientPaymentBPJSDatabasePopulator implements DatabasePopulatorInterface<PatientPaymentBPJSEntity> {
	...
	public PatientPaymentBPJSDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull PatientPaymentBPJSEntity entity,
