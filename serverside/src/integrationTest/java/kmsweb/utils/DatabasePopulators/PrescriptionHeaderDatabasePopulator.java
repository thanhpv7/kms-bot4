...
@Component
public class PrescriptionHeaderDatabasePopulator implements DatabasePopulatorInterface<PrescriptionHeaderEntity> {
	...
	public PrescriptionHeaderDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull PrescriptionHeaderEntity entity,
