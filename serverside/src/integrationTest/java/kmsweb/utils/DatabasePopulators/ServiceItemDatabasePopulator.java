...
@Component
public class ServiceItemDatabasePopulator implements DatabasePopulatorInterface<ServiceItemEntity> {
	...
	public ServiceItemDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull ServiceItemEntity entity,
