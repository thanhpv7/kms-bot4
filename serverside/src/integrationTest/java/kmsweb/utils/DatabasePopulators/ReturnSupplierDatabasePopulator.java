...
@Component
public class ReturnSupplierDatabasePopulator implements DatabasePopulatorInterface<ReturnSupplierEntity> {
	...
	public ReturnSupplierDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull ReturnSupplierEntity entity,
