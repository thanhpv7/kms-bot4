...
@Component
public class InternalOrderDatabasePopulator implements DatabasePopulatorInterface<InternalOrderEntity> {
	...
	public InternalOrderDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull InternalOrderEntity entity,
