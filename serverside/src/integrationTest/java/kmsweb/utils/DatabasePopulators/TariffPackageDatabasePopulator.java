...
@Component
public class TariffPackageDatabasePopulator implements DatabasePopulatorInterface<TariffPackageEntity> {
	...
	public TariffPackageDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull TariffPackageEntity entity,
