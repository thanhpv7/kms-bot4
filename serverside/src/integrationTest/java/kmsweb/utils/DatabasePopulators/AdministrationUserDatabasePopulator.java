...
@Component
public class AdministrationUserDatabasePopulator implements DatabasePopulatorInterface<AdministrationUserEntity> {
	...
	public AdministrationUserDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull AdministrationUserEntity entity,
