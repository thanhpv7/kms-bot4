...
@Component
public class PatientDetailDatabasePopulator implements DatabasePopulatorInterface<PatientDetailEntity> {
	...
	public PatientDetailDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull PatientDetailEntity entity,
