...
@Component
public class AdministratorDatabasePopulator implements DatabasePopulatorInterface<AdministratorEntity> {
	...
	public AdministratorDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull AdministratorEntity entity,
