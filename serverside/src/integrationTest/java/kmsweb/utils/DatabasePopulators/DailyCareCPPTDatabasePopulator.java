...
@Component
public class DailyCareCPPTDatabasePopulator implements DatabasePopulatorInterface<DailyCareCPPTEntity> {
	...
	public DailyCareCPPTDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull DailyCareCPPTEntity entity,
