...
@Component
public class PurchasingUserDatabasePopulator implements DatabasePopulatorInterface<PurchasingUserEntity> {
	...
	public PurchasingUserDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull PurchasingUserEntity entity,
