...
@Component
public class BpjsServiceMappingDatabasePopulator implements DatabasePopulatorInterface<BpjsServiceMappingEntity> {
	...
	public BpjsServiceMappingDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull BpjsServiceMappingEntity entity,
