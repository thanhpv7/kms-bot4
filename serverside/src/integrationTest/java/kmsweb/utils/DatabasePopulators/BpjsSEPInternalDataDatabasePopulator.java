...
@Component
public class BpjsSEPInternalDataDatabasePopulator implements DatabasePopulatorInterface<BpjsSEPInternalDataEntity> {
	...
	public BpjsSEPInternalDataDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull BpjsSEPInternalDataEntity entity,
