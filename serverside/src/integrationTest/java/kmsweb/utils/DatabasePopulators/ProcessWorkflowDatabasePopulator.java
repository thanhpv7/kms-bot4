...
@Component
public class ProcessWorkflowDatabasePopulator implements DatabasePopulatorInterface<ProcessWorkflowEntity> {
	...
	public ProcessWorkflowDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull ProcessWorkflowEntity entity,
