...
@Component
public class PatientGeneralInfoDatabasePopulator implements DatabasePopulatorInterface<PatientGeneralInfoEntity> {
	...
	public PatientGeneralInfoDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull PatientGeneralInfoEntity entity,
