...
@Component
public class VitalSignsDatabasePopulator implements DatabasePopulatorInterface<VitalSignsEntity> {
	...
	public VitalSignsDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull VitalSignsEntity entity,
