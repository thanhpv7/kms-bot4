...
@Component
public class InventoryAdjustmentDatabasePopulator implements DatabasePopulatorInterface<InventoryAdjustmentEntity> {
	...
	public InventoryAdjustmentDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull InventoryAdjustmentEntity entity,
