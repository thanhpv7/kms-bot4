...
@Component
public class TariffPackageServiceAssignmentDatabasePopulator implements DatabasePopulatorInterface<TariffPackageServiceAssignmentEntity> {
	...
	public TariffPackageServiceAssignmentDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull TariffPackageServiceAssignmentEntity entity,
