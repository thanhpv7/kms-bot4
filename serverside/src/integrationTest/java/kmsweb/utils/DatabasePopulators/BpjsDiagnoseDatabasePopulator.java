...
@Component
public class BpjsDiagnoseDatabasePopulator implements DatabasePopulatorInterface<BpjsDiagnoseEntity> {
	...
	public BpjsDiagnoseDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull BpjsDiagnoseEntity entity,
