...
@Component
public class MedicationItemDatabasePopulator implements DatabasePopulatorInterface<MedicationItemEntity> {
	...
	public MedicationItemDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull MedicationItemEntity entity,
