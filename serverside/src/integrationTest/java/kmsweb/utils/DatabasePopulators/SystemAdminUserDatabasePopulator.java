...
@Component
public class SystemAdminUserDatabasePopulator implements DatabasePopulatorInterface<SystemAdminUserEntity> {
	...
	public SystemAdminUserDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull SystemAdminUserEntity entity,
