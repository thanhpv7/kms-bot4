...
@Component
public class TariffPackageItemDatabasePopulator implements DatabasePopulatorInterface<TariffPackageItemEntity> {
	...
	public TariffPackageItemDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull TariffPackageItemEntity entity,
