...
@Component
public class BpjsTreatmentHistoryDatabasePopulator implements DatabasePopulatorInterface<BpjsTreatmentHistoryEntity> {
	...
	public BpjsTreatmentHistoryDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull BpjsTreatmentHistoryEntity entity,
