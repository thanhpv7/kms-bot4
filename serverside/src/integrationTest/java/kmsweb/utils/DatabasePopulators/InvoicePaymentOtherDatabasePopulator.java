...
@Component
public class InvoicePaymentOtherDatabasePopulator implements DatabasePopulatorInterface<InvoicePaymentOtherEntity> {
	...
	public InvoicePaymentOtherDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull InvoicePaymentOtherEntity entity,
