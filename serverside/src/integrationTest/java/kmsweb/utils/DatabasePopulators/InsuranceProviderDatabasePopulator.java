...
@Component
public class InsuranceProviderDatabasePopulator implements DatabasePopulatorInterface<InsuranceProviderEntity> {
	...
	public InsuranceProviderDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull InsuranceProviderEntity entity,
