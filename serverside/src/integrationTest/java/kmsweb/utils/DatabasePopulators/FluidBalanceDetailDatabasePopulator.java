...
@Component
public class FluidBalanceDetailDatabasePopulator implements DatabasePopulatorInterface<FluidBalanceDetailEntity> {
	...
	public FluidBalanceDetailDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull FluidBalanceDetailEntity entity,
