...
@Component
public class BpjsClaimSubmissionDatabasePopulator implements DatabasePopulatorInterface<BpjsClaimSubmissionEntity> {
	...
	public BpjsClaimSubmissionDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull BpjsClaimSubmissionEntity entity,
