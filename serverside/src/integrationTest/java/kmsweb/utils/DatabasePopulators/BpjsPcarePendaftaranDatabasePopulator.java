...
@Component
public class BpjsPcarePendaftaranDatabasePopulator implements DatabasePopulatorInterface<BpjsPcarePendaftaranEntity> {
	...
	public BpjsPcarePendaftaranDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull BpjsPcarePendaftaranEntity entity,
