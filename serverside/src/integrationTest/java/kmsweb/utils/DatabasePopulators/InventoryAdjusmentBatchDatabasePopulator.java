...
@Component
public class InventoryAdjusmentBatchDatabasePopulator implements DatabasePopulatorInterface<InventoryAdjusmentBatchEntity> {
	...
	public InventoryAdjusmentBatchDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull InventoryAdjusmentBatchEntity entity,
