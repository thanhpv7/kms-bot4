...
@Component
public class CashReceiptDatabasePopulator implements DatabasePopulatorInterface<CashReceiptEntity> {
	...
	public CashReceiptDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull CashReceiptEntity entity,
