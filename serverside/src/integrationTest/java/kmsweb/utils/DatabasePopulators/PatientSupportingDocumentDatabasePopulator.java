...
@Component
public class PatientSupportingDocumentDatabasePopulator implements DatabasePopulatorInterface<PatientSupportingDocumentEntity> {
	...
	public PatientSupportingDocumentDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull PatientSupportingDocumentEntity entity,
