...
@Component
public class BpjsProcedureDatabasePopulator implements DatabasePopulatorInterface<BpjsProcedureEntity> {
	...
	public BpjsProcedureDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull BpjsProcedureEntity entity,
