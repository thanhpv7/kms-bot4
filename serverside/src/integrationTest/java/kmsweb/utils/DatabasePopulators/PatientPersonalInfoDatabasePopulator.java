...
@Component
public class PatientPersonalInfoDatabasePopulator implements DatabasePopulatorInterface<PatientPersonalInfoEntity> {
	...
	public PatientPersonalInfoDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull PatientPersonalInfoEntity entity,
