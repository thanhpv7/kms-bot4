...
@Component
public class PostOperativeDetailsDatabasePopulator implements DatabasePopulatorInterface<PostOperativeDetailsEntity> {
	...
	public PostOperativeDetailsDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull PostOperativeDetailsEntity entity,
