...
@Component
public class DiagnosticSupportUserDatabasePopulator implements DatabasePopulatorInterface<DiagnosticSupportUserEntity> {
	...
	public DiagnosticSupportUserDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull DiagnosticSupportUserEntity entity,
