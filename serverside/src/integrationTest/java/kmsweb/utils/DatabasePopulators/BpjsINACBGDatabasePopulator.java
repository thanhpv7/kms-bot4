...
@Component
public class BpjsINACBGDatabasePopulator implements DatabasePopulatorInterface<BpjsINACBGEntity> {
	...
	public BpjsINACBGDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull BpjsINACBGEntity entity,
