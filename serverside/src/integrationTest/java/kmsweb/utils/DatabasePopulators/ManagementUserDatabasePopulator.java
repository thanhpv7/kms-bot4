...
@Component
public class ManagementUserDatabasePopulator implements DatabasePopulatorInterface<ManagementUserEntity> {
	...
	public ManagementUserDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull ManagementUserEntity entity,
