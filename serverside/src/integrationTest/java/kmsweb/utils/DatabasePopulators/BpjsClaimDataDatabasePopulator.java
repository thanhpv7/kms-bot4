...
@Component
public class BpjsClaimDataDatabasePopulator implements DatabasePopulatorInterface<BpjsClaimDataEntity> {
	...
	public BpjsClaimDataDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull BpjsClaimDataEntity entity,
