...
@Component
public class BpjsGeneralDatabasePopulator implements DatabasePopulatorInterface<BpjsGeneralEntity> {
	...
	public BpjsGeneralDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull BpjsGeneralEntity entity,
