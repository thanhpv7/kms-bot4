...
@Component
public class PreoperativeRecordsDatabasePopulator implements DatabasePopulatorInterface<PreoperativeRecordsEntity> {
	...
	public PreoperativeRecordsDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull PreoperativeRecordsEntity entity,
