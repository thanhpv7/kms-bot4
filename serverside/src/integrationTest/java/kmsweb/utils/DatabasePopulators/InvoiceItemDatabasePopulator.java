...
@Component
public class InvoiceItemDatabasePopulator implements DatabasePopulatorInterface<InvoiceItemEntity> {
	...
	public InvoiceItemDatabasePopulator() {}
	...
	public void populateRelatedEntitiesInDatabase(
		@NotNull InvoiceItemEntity entity,
