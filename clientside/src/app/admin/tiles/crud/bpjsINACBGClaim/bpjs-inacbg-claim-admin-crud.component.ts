 ...
 */
@Component({
	selector: 'cb-bpjs-inacbg-claim-admin-crud',
	templateUrl: './bpjs-inacbg-claim-admin-crud.component.html',
	styleUrls: [
		'./bpjs-inacbg-claim-admin-crud.component.scss',
...
export class AdminBpjsINACBGClaimCrudComponent implements OnDestroy {
