...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBpjsControlPlanCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBpjsControlPlanCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBpjsControlPlanCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBpjsControlPlanCrudRoutingModule {
}
