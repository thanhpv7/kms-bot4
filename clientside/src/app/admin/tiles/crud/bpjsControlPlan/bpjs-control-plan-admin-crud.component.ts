 ...
 */
@Component({
	selector: 'cb-bpjs-control-plan-admin-crud',
	templateUrl: './bpjs-control-plan-admin-crud.component.html',
	styleUrls: [
		'./bpjs-control-plan-admin-crud.component.scss',
...
export class AdminBpjsControlPlanCrudComponent implements OnDestroy {
