 ...
 */
@Component({
	selector: 'cb-bpjs-pcare-kegiatan-kelompok-admin-crud',
	templateUrl: './bpjs-pcare-kegiatan-kelompok-admin-crud.component.html',
	styleUrls: [
		'./bpjs-pcare-kegiatan-kelompok-admin-crud.component.scss',
...
export class AdminBpjsPcareKegiatanKelompokCrudComponent implements OnDestroy {
