...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminUnitOfMeasurementCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminUnitOfMeasurementCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminUnitOfMeasurementCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminUnitOfMeasurementCrudRoutingModule {
}
