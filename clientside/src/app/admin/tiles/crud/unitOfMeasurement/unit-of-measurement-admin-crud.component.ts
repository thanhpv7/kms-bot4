 ...
 */
@Component({
	selector: 'cb-unit-of-measurement-admin-crud',
	templateUrl: './unit-of-measurement-admin-crud.component.html',
	styleUrls: [
		'./unit-of-measurement-admin-crud.component.scss',
...
export class AdminUnitOfMeasurementCrudComponent implements OnDestroy {
