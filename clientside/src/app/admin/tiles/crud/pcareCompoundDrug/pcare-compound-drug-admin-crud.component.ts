 ...
 */
@Component({
	selector: 'cb-pcare-compound-drug-admin-crud',
	templateUrl: './pcare-compound-drug-admin-crud.component.html',
	styleUrls: [
		'./pcare-compound-drug-admin-crud.component.scss',
...
export class AdminPcareCompoundDrugCrudComponent implements OnDestroy {
