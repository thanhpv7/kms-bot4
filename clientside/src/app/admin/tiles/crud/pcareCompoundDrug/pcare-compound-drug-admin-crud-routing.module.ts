...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminPcareCompoundDrugCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminPcareCompoundDrugCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminPcareCompoundDrugCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminPcareCompoundDrugCrudRoutingModule {
}
