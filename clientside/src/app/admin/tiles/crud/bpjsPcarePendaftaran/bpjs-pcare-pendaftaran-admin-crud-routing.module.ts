...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBpjsPcarePendaftaranCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBpjsPcarePendaftaranCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBpjsPcarePendaftaranCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBpjsPcarePendaftaranCrudRoutingModule {
}
