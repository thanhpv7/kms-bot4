 ...
 */
@Component({
	selector: 'cb-bpjs-pcare-pendaftaran-admin-crud',
	templateUrl: './bpjs-pcare-pendaftaran-admin-crud.component.html',
	styleUrls: [
		'./bpjs-pcare-pendaftaran-admin-crud.component.scss',
...
export class AdminBpjsPcarePendaftaranCrudComponent implements OnDestroy {
