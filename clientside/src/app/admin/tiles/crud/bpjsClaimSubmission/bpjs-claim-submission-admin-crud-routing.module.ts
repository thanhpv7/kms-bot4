...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBpjsClaimSubmissionCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBpjsClaimSubmissionCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBpjsClaimSubmissionCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBpjsClaimSubmissionCrudRoutingModule {
}
