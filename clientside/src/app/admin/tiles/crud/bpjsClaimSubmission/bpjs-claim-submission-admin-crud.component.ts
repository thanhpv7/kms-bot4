 ...
 */
@Component({
	selector: 'cb-bpjs-claim-submission-admin-crud',
	templateUrl: './bpjs-claim-submission-admin-crud.component.html',
	styleUrls: [
		'./bpjs-claim-submission-admin-crud.component.scss',
...
export class AdminBpjsClaimSubmissionCrudComponent implements OnDestroy {
