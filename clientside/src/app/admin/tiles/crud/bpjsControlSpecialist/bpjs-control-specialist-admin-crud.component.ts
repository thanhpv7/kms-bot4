 ...
 */
@Component({
	selector: 'cb-bpjs-control-specialist-admin-crud',
	templateUrl: './bpjs-control-specialist-admin-crud.component.html',
	styleUrls: [
		'./bpjs-control-specialist-admin-crud.component.scss',
...
export class AdminBpjsControlSpecialistCrudComponent implements OnDestroy {
