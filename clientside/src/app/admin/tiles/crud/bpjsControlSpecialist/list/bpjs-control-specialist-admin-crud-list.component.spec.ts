...
import {AdminBpjsControlSpecialistCrudListComponent} from './bpjs-control-specialist-admin-crud-list.component';
...
import {AdminBpjsControlSpecialistCrudModule} from '../bpjs-control-specialist-admin-crud.module';
import {
...
describe('BPJS Control Specialist Crud List Tile Component', () => {
	...
	let fixture;
	let bpjsControlSpecialistCrudListComponent: AdminBpjsControlSpecialistCrudListComponent;
	...
	const routerState: RouterState = {
		url: 'bpjs-control-specialist-admin-crud',
		urls: ['bpjs-control-specialist-admin-crud'],
		params: {},
		queryParams: {},
		data: {},
	};
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			imports: [
				...
				AdminBpjsControlSpecialistCrudModule,
			],
			providers: [
				provideMockStore(),
				{
			...
			fixture = TestBed.createComponent(AdminBpjsControlSpecialistCrudListComponent);
