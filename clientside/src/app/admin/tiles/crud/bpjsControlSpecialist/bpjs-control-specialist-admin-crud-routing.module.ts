...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBpjsControlSpecialistCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBpjsControlSpecialistCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBpjsControlSpecialistCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBpjsControlSpecialistCrudRoutingModule {
}
