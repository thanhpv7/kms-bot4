 ...
 */
@Component({
	selector: 'cb-pcare-tindakan-admin-crud',
	templateUrl: './pcare-tindakan-admin-crud.component.html',
	styleUrls: [
		'./pcare-tindakan-admin-crud.component.scss',
...
export class AdminPcareTindakanCrudComponent implements OnDestroy {
