...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminPcareTindakanCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminPcareTindakanCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminPcareTindakanCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminPcareTindakanCrudRoutingModule {
}
