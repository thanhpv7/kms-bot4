...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminPharmacyUserCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminPharmacyUserCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminPharmacyUserCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminPharmacyUserCrudRoutingModule {
}
