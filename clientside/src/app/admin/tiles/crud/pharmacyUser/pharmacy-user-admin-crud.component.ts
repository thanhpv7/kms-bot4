 ...
 */
@Component({
	selector: 'cb-pharmacy-user-admin-crud',
	templateUrl: './pharmacy-user-admin-crud.component.html',
	styleUrls: [
		'./pharmacy-user-admin-crud.component.scss',
...
export class AdminPharmacyUserCrudComponent implements OnDestroy {
