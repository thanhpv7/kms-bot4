...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminStockTransactionDetailCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminStockTransactionDetailCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminStockTransactionDetailCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminStockTransactionDetailCrudRoutingModule {
}
