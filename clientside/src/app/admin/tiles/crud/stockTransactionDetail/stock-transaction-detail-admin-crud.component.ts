 ...
 */
@Component({
	selector: 'cb-stock-transaction-detail-admin-crud',
	templateUrl: './stock-transaction-detail-admin-crud.component.html',
	styleUrls: [
		'./stock-transaction-detail-admin-crud.component.scss',
...
export class AdminStockTransactionDetailCrudComponent implements OnDestroy {
