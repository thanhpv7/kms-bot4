 ...
 */
@Component({
	selector: 'cb-invoice-payment-insurance-admin-crud',
	templateUrl: './invoice-payment-insurance-admin-crud.component.html',
	styleUrls: [
		'./invoice-payment-insurance-admin-crud.component.scss',
...
export class AdminInvoicePaymentInsuranceCrudComponent implements OnDestroy {
