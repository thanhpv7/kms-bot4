...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminInvoicePaymentInsuranceCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminInvoicePaymentInsuranceCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminInvoicePaymentInsuranceCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminInvoicePaymentInsuranceCrudRoutingModule {
}
