 ...
 */
@Component({
	selector: 'cb-bpjs-search-control-letter-admin-crud',
	templateUrl: './bpjs-search-control-letter-admin-crud.component.html',
	styleUrls: [
		'./bpjs-search-control-letter-admin-crud.component.scss',
...
export class AdminBpjsSearchControlLetterCrudComponent implements OnDestroy {
