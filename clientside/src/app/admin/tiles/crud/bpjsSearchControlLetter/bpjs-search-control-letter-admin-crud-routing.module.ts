...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBpjsSearchControlLetterCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBpjsSearchControlLetterCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBpjsSearchControlLetterCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBpjsSearchControlLetterCrudRoutingModule {
}
