 ...
 */
@Component({
	selector: 'cb-preoperative-records-admin-crud',
	templateUrl: './preoperative-records-admin-crud.component.html',
	styleUrls: [
		'./preoperative-records-admin-crud.component.scss',
...
export class AdminPreoperativeRecordsCrudComponent implements OnDestroy {
