...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminPreoperativeRecordsCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminPreoperativeRecordsCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminPreoperativeRecordsCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminPreoperativeRecordsCrudRoutingModule {
}
