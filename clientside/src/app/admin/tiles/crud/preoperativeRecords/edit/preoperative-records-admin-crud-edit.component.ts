...
@Component({
	selector: 'cb-preoperative-records-admin-crud-edit',
	templateUrl: './preoperative-records-admin-crud-edit.component.html',
	styleUrls: [
		'./preoperative-records-admin-crud-edit.component.scss',
...
export class AdminPreoperativeRecordsCrudEditComponent
