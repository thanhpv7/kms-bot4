 ...
 */
@Component({
	selector: 'cb-goods-receive-note-item-admin-crud',
	templateUrl: './goods-receive-note-item-admin-crud.component.html',
	styleUrls: [
		'./goods-receive-note-item-admin-crud.component.scss',
...
export class AdminGoodsReceiveNoteItemCrudComponent implements OnDestroy {
