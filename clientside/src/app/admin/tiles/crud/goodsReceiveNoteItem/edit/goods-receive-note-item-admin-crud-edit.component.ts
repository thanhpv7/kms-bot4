...
@Component({
	selector: 'cb-goods-receive-note-item-admin-crud-edit',
	templateUrl: './goods-receive-note-item-admin-crud-edit.component.html',
	styleUrls: [
		'./goods-receive-note-item-admin-crud-edit.component.scss',
...
export class AdminGoodsReceiveNoteItemCrudEditComponent
