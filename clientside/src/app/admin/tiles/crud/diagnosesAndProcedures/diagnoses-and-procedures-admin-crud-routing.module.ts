...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminDiagnosesAndProceduresCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminDiagnosesAndProceduresCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminDiagnosesAndProceduresCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminDiagnosesAndProceduresCrudRoutingModule {
}
