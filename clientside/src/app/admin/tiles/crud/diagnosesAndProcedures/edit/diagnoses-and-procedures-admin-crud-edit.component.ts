...
@Component({
	selector: 'cb-diagnoses-and-procedures-admin-crud-edit',
	templateUrl: './diagnoses-and-procedures-admin-crud-edit.component.html',
	styleUrls: [
		'./diagnoses-and-procedures-admin-crud-edit.component.scss',
...
export class AdminDiagnosesAndProceduresCrudEditComponent
