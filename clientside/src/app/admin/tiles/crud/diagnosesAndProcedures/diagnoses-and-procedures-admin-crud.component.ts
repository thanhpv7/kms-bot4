 ...
 */
@Component({
	selector: 'cb-diagnoses-and-procedures-admin-crud',
	templateUrl: './diagnoses-and-procedures-admin-crud.component.html',
	styleUrls: [
		'./diagnoses-and-procedures-admin-crud.component.scss',
...
export class AdminDiagnosesAndProceduresCrudComponent implements OnDestroy {
