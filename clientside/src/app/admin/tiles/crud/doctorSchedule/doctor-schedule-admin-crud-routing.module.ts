...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminDoctorScheduleCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminDoctorScheduleCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminDoctorScheduleCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminDoctorScheduleCrudRoutingModule {
}
