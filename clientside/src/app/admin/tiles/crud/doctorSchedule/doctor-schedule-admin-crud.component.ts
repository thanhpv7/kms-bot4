 ...
 */
@Component({
	selector: 'cb-doctor-schedule-admin-crud',
	templateUrl: './doctor-schedule-admin-crud.component.html',
	styleUrls: [
		'./doctor-schedule-admin-crud.component.scss',
...
export class AdminDoctorScheduleCrudComponent implements OnDestroy {
