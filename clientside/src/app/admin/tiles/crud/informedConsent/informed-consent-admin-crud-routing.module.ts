...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminInformedConsentCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminInformedConsentCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminInformedConsentCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminInformedConsentCrudRoutingModule {
}
