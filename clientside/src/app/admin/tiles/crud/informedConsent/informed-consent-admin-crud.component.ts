 ...
 */
@Component({
	selector: 'cb-informed-consent-admin-crud',
	templateUrl: './informed-consent-admin-crud.component.html',
	styleUrls: [
		'./informed-consent-admin-crud.component.scss',
...
export class AdminInformedConsentCrudComponent implements OnDestroy {
