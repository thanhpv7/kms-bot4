...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminDiagnosticExaminationResultsCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminDiagnosticExaminationResultsCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminDiagnosticExaminationResultsCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminDiagnosticExaminationResultsCrudRoutingModule {
}
