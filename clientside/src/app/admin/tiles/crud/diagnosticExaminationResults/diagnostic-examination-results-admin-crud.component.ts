 ...
 */
@Component({
	selector: 'cb-diagnostic-examination-results-admin-crud',
	templateUrl: './diagnostic-examination-results-admin-crud.component.html',
	styleUrls: [
		'./diagnostic-examination-results-admin-crud.component.scss',
...
export class AdminDiagnosticExaminationResultsCrudComponent implements OnDestroy {
