...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminPurchaseOrderCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminPurchaseOrderCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminPurchaseOrderCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminPurchaseOrderCrudRoutingModule {
}
