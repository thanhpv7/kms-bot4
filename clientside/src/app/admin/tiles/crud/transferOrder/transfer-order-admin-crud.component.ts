 ...
 */
@Component({
	selector: 'cb-transfer-order-admin-crud',
	templateUrl: './transfer-order-admin-crud.component.html',
	styleUrls: [
		'./transfer-order-admin-crud.component.scss',
...
export class AdminTransferOrderCrudComponent implements OnDestroy {
