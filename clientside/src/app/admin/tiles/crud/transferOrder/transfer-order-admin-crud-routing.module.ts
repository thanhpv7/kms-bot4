...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminTransferOrderCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminTransferOrderCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminTransferOrderCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminTransferOrderCrudRoutingModule {
}
