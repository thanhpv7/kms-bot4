 ...
 */
@Component({
	selector: 'cb-registration-admin-crud',
	templateUrl: './registration-admin-crud.component.html',
	styleUrls: [
		'./registration-admin-crud.component.scss',
...
export class AdminRegistrationCrudComponent implements OnDestroy {
