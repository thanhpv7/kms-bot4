...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminRegistrationCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminRegistrationCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminRegistrationCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminRegistrationCrudRoutingModule {
}
