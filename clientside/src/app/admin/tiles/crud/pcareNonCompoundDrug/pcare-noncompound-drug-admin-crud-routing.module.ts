...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminPcareNonCompoundDrugCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminPcareNonCompoundDrugCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminPcareNonCompoundDrugCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminPcareNonCompoundDrugCrudRoutingModule {
}
