 ...
 */
@Component({
	selector: 'cb-pcare-noncompound-drug-admin-crud',
	templateUrl: './pcare-noncompound-drug-admin-crud.component.html',
	styleUrls: [
		'./pcare-noncompound-drug-admin-crud.component.scss',
...
export class AdminPcareNonCompoundDrugCrudComponent implements OnDestroy {
