 ...
 */
@Component({
	selector: 'cb-bpjs-pcare-dpho-admin-crud',
	templateUrl: './bpjs-pcare-dpho-admin-crud.component.html',
	styleUrls: [
		'./bpjs-pcare-dpho-admin-crud.component.scss',
...
export class AdminBpjsPcareDPHOCrudComponent implements OnDestroy {
