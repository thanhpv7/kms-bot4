...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBpjsPcareDPHOCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBpjsPcareDPHOCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBpjsPcareDPHOCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBpjsPcareDPHOCrudRoutingModule {
}
