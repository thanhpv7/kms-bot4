 ...
 */
@Component({
	selector: 'cb-medication-administered-history-admin-crud',
	templateUrl: './medication-administered-history-admin-crud.component.html',
	styleUrls: [
		'./medication-administered-history-admin-crud.component.scss',
...
export class AdminMedicationAdministeredHistoryCrudComponent implements OnDestroy {
