...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminMedicationAdministeredHistoryCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminMedicationAdministeredHistoryCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminMedicationAdministeredHistoryCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminMedicationAdministeredHistoryCrudRoutingModule {
}
