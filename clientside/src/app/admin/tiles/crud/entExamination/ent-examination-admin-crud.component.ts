 ...
 */
@Component({
	selector: 'cb-ent-examination-admin-crud',
	templateUrl: './ent-examination-admin-crud.component.html',
	styleUrls: [
		'./ent-examination-admin-crud.component.scss',
...
export class AdminEntExaminationCrudComponent implements OnDestroy {
