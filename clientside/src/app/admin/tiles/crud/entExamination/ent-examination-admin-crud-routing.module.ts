...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminEntExaminationCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminEntExaminationCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminEntExaminationCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminEntExaminationCrudRoutingModule {
}
