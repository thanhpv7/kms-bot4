 ...
 */
@Component({
	selector: 'cb-batch-stock-balance-admin-crud',
	templateUrl: './batch-stock-balance-admin-crud.component.html',
	styleUrls: [
		'./batch-stock-balance-admin-crud.component.scss',
...
export class AdminBatchStockBalanceCrudComponent implements OnDestroy {
