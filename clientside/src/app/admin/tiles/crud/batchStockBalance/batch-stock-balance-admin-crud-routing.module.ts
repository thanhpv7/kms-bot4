...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBatchStockBalanceCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBatchStockBalanceCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBatchStockBalanceCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBatchStockBalanceCrudRoutingModule {
}
