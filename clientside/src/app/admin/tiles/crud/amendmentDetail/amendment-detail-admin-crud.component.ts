 ...
 */
@Component({
	selector: 'cb-amendment-detail-admin-crud',
	templateUrl: './amendment-detail-admin-crud.component.html',
	styleUrls: [
		'./amendment-detail-admin-crud.component.scss',
...
export class AdminAmendmentDetailCrudComponent implements OnDestroy {
