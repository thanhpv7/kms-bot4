...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminAmendmentDetailCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminAmendmentDetailCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminAmendmentDetailCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminAmendmentDetailCrudRoutingModule {
}
