...
import {AdminDeliveryMedicalExaminationRecordCrudListComponent} from './delivery-medical-examination-record-admin-crud-list.component';
...
import {AdminDeliveryMedicalExaminationRecordCrudModule} from '../delivery-medical-examination-record-admin-crud.module';
import {
...
describe('Delivery Medical Examination Record Crud List Tile Component', () => {
	...
	let fixture;
	let deliveryMedicalExaminationRecordCrudListComponent: AdminDeliveryMedicalExaminationRecordCrudListComponent;
	...
	const routerState: RouterState = {
		url: 'delivery-medical-examination-record-admin-crud',
		urls: ['delivery-medical-examination-record-admin-crud'],
		params: {},
		queryParams: {},
		data: {},
	};
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			imports: [
				...
				AdminDeliveryMedicalExaminationRecordCrudModule,
			],
			providers: [
				provideMockStore(),
				{
			...
			fixture = TestBed.createComponent(AdminDeliveryMedicalExaminationRecordCrudListComponent);
