 ...
 */
@Component({
	selector: 'cb-delivery-medical-examination-record-admin-crud',
	templateUrl: './delivery-medical-examination-record-admin-crud.component.html',
	styleUrls: [
		'./delivery-medical-examination-record-admin-crud.component.scss',
...
export class AdminDeliveryMedicalExaminationRecordCrudComponent implements OnDestroy {
