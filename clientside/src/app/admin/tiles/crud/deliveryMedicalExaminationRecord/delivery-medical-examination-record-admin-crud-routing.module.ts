...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminDeliveryMedicalExaminationRecordCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminDeliveryMedicalExaminationRecordCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminDeliveryMedicalExaminationRecordCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminDeliveryMedicalExaminationRecordCrudRoutingModule {
}
