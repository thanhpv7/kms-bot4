...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminInvoiceCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminInvoiceCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminInvoiceCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminInvoiceCrudRoutingModule {
}
