 ...
 */
@Component({
	selector: 'cb-invoice-admin-crud',
	templateUrl: './invoice-admin-crud.component.html',
	styleUrls: [
		'./invoice-admin-crud.component.scss',
...
export class AdminInvoiceCrudComponent implements OnDestroy {
