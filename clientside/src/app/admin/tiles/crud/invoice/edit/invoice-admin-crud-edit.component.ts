...
@Component({
	selector: 'cb-invoice-admin-crud-edit',
	templateUrl: './invoice-admin-crud-edit.component.html',
	styleUrls: [
		'./invoice-admin-crud-edit.component.scss',
...
export class AdminInvoiceCrudEditComponent
