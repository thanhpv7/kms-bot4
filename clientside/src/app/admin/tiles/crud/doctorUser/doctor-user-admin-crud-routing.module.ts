...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminDoctorUserCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminDoctorUserCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminDoctorUserCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminDoctorUserCrudRoutingModule {
}
