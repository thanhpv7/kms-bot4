 ...
 */
@Component({
	selector: 'cb-doctor-user-admin-crud',
	templateUrl: './doctor-user-admin-crud.component.html',
	styleUrls: [
		'./doctor-user-admin-crud.component.scss',
...
export class AdminDoctorUserCrudComponent implements OnDestroy {
