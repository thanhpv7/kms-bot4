 ...
 */
@Component({
	selector: 'cb-vaccination-order-admin-crud',
	templateUrl: './vaccination-order-admin-crud.component.html',
	styleUrls: [
		'./vaccination-order-admin-crud.component.scss',
...
export class AdminVaccinationOrderCrudComponent implements OnDestroy {
