...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminVaccinationOrderCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminVaccinationOrderCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminVaccinationOrderCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminVaccinationOrderCrudRoutingModule {
}
