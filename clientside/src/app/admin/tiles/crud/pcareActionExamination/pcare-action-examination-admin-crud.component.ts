 ...
 */
@Component({
	selector: 'cb-pcare-action-examination-admin-crud',
	templateUrl: './pcare-action-examination-admin-crud.component.html',
	styleUrls: [
		'./pcare-action-examination-admin-crud.component.scss',
...
export class AdminPcareActionExaminationCrudComponent implements OnDestroy {
