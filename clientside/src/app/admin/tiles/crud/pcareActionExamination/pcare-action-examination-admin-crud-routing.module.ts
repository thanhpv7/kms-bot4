...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminPcareActionExaminationCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminPcareActionExaminationCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminPcareActionExaminationCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminPcareActionExaminationCrudRoutingModule {
}
