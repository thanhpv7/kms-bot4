 ...
 */
@Component({
	selector: 'cb-icd-10-admin-crud',
	templateUrl: './icd-10-admin-crud.component.html',
	styleUrls: [
		'./icd-10-admin-crud.component.scss',
...
export class AdminIcd10CrudComponent implements OnDestroy {
