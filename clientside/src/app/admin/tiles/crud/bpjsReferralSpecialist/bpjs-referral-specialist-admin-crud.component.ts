 ...
 */
@Component({
	selector: 'cb-bpjs-referral-specialist-admin-crud',
	templateUrl: './bpjs-referral-specialist-admin-crud.component.html',
	styleUrls: [
		'./bpjs-referral-specialist-admin-crud.component.scss',
...
export class AdminBpjsReferralSpecialistCrudComponent implements OnDestroy {
