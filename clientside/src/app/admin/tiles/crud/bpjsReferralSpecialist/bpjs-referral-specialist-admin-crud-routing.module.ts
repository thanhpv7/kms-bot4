...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBpjsReferralSpecialistCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBpjsReferralSpecialistCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBpjsReferralSpecialistCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBpjsReferralSpecialistCrudRoutingModule {
}
