 ...
 */
@Component({
	selector: 'cb-tariff-package-item-admin-crud',
	templateUrl: './tariff-package-item-admin-crud.component.html',
	styleUrls: [
		'./tariff-package-item-admin-crud.component.scss',
...
export class AdminTariffPackageItemCrudComponent implements OnDestroy {
