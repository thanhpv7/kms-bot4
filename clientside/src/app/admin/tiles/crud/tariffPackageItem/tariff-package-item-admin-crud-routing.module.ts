...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminTariffPackageItemCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminTariffPackageItemCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminTariffPackageItemCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminTariffPackageItemCrudRoutingModule {
}
