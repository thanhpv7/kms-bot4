 ...
 */
@Component({
	selector: 'cb-patient-consent-admin-crud',
	templateUrl: './patient-consent-admin-crud.component.html',
	styleUrls: [
		'./patient-consent-admin-crud.component.scss',
...
export class AdminPatientConsentCrudComponent implements OnDestroy {
