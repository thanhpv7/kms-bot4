...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminPatientConsentCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminPatientConsentCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminPatientConsentCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminPatientConsentCrudRoutingModule {
}
