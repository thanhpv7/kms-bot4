 ...
 */
@Component({
	selector: 'cb-bpjs-health-facility-admin-crud',
	templateUrl: './bpjs-health-facility-admin-crud.component.html',
	styleUrls: [
		'./bpjs-health-facility-admin-crud.component.scss',
...
export class AdminBpjsHealthFacilityCrudComponent implements OnDestroy {
