...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBpjsHealthFacilityCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBpjsHealthFacilityCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBpjsHealthFacilityCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBpjsHealthFacilityCrudRoutingModule {
}
