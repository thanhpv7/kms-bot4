 ...
 */
@Component({
	selector: 'cb-bpjs-dismissal-mapping-admin-crud',
	templateUrl: './bpjs-dismissal-mapping-admin-crud.component.html',
	styleUrls: [
		'./bpjs-dismissal-mapping-admin-crud.component.scss',
...
export class AdminBpjsDismissalMappingCrudComponent implements OnDestroy {
