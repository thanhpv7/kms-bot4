...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBpjsDismissalMappingCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBpjsDismissalMappingCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBpjsDismissalMappingCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBpjsDismissalMappingCrudRoutingModule {
}
