 ...
 */
@Component({
	selector: 'cb-patient-case-history-admin-crud',
	templateUrl: './patient-case-history-admin-crud.component.html',
	styleUrls: [
		'./patient-case-history-admin-crud.component.scss',
...
export class AdminPatientCaseHistoryCrudComponent implements OnDestroy {
