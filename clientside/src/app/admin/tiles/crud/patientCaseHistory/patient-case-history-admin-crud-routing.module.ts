...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminPatientCaseHistoryCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminPatientCaseHistoryCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminPatientCaseHistoryCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminPatientCaseHistoryCrudRoutingModule {
}
