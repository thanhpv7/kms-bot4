 ...
 */
@Component({
	selector: 'cb-diagnostic-support-general-configuration-admin-crud',
	templateUrl: './diagnostic-support-general-configuration-admin-crud.component.html',
	styleUrls: [
		'./diagnostic-support-general-configuration-admin-crud.component.scss',
...
export class AdminDiagnosticSupportGeneralConfigurationCrudComponent implements OnDestroy {
