...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminDiagnosticSupportGeneralConfigurationCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminDiagnosticSupportGeneralConfigurationCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminDiagnosticSupportGeneralConfigurationCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminDiagnosticSupportGeneralConfigurationCrudRoutingModule {
}
