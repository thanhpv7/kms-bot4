 ...
 */
@Component({
	selector: 'cb-hemodialysis-monitoring-admin-crud',
	templateUrl: './hemodialysis-monitoring-admin-crud.component.html',
	styleUrls: [
		'./hemodialysis-monitoring-admin-crud.component.scss',
...
export class AdminHemodialysisMonitoringCrudComponent implements OnDestroy {
