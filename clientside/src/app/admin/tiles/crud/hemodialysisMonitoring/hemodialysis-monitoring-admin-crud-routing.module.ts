...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminHemodialysisMonitoringCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminHemodialysisMonitoringCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminHemodialysisMonitoringCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminHemodialysisMonitoringCrudRoutingModule {
}
