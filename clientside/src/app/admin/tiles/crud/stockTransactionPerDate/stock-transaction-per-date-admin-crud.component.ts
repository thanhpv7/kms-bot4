 ...
 */
@Component({
	selector: 'cb-stock-transaction-per-date-admin-crud',
	templateUrl: './stock-transaction-per-date-admin-crud.component.html',
	styleUrls: [
		'./stock-transaction-per-date-admin-crud.component.scss',
...
export class AdminStockTransactionPerDateCrudComponent implements OnDestroy {
