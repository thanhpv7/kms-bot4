...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminStockTransactionPerDateCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminStockTransactionPerDateCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminStockTransactionPerDateCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminStockTransactionPerDateCrudRoutingModule {
}
