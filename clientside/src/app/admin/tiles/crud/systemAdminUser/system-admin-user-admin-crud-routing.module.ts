...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminSystemAdminUserCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminSystemAdminUserCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminSystemAdminUserCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminSystemAdminUserCrudRoutingModule {
}
