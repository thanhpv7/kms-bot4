 ...
 */
@Component({
	selector: 'cb-system-admin-user-admin-crud',
	templateUrl: './system-admin-user-admin-crud.component.html',
	styleUrls: [
		'./system-admin-user-admin-crud.component.scss',
...
export class AdminSystemAdminUserCrudComponent implements OnDestroy {
