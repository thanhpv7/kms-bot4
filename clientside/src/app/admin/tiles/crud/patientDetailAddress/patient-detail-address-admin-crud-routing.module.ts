...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminPatientDetailAddressCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminPatientDetailAddressCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminPatientDetailAddressCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminPatientDetailAddressCrudRoutingModule {
}
