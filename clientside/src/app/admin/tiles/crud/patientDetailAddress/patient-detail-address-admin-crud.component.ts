 ...
 */
@Component({
	selector: 'cb-patient-detail-address-admin-crud',
	templateUrl: './patient-detail-address-admin-crud.component.html',
	styleUrls: [
		'./patient-detail-address-admin-crud.component.scss',
...
export class AdminPatientDetailAddressCrudComponent implements OnDestroy {
