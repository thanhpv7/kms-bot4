 ...
 */
@Component({
	selector: 'cb-inventory-adjustment-admin-crud',
	templateUrl: './inventory-adjustment-admin-crud.component.html',
	styleUrls: [
		'./inventory-adjustment-admin-crud.component.scss',
...
export class AdminInventoryAdjustmentCrudComponent implements OnDestroy {
