...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminInventoryAdjustmentCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminInventoryAdjustmentCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminInventoryAdjustmentCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminInventoryAdjustmentCrudRoutingModule {
}
