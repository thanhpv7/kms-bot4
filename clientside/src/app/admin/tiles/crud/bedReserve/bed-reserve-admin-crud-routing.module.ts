...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBedReserveCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBedReserveCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBedReserveCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBedReserveCrudRoutingModule {
}
