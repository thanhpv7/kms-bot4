 ...
 */
@Component({
	selector: 'cb-bed-reserve-admin-crud',
	templateUrl: './bed-reserve-admin-crud.component.html',
	styleUrls: [
		'./bed-reserve-admin-crud.component.scss',
...
export class AdminBedReserveCrudComponent implements OnDestroy {
