...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminPcareStatusPulangCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminPcareStatusPulangCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminPcareStatusPulangCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminPcareStatusPulangCrudRoutingModule {
}
