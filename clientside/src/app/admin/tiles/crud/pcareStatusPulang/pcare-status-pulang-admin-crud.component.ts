 ...
 */
@Component({
	selector: 'cb-pcare-status-pulang-admin-crud',
	templateUrl: './pcare-status-pulang-admin-crud.component.html',
	styleUrls: [
		'./pcare-status-pulang-admin-crud.component.scss',
...
export class AdminPcareStatusPulangCrudComponent implements OnDestroy {
