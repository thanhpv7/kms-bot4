 ...
 */
@Component({
	selector: 'cb-retail-pharmacy-admin-crud',
	templateUrl: './retail-pharmacy-admin-crud.component.html',
	styleUrls: [
		'./retail-pharmacy-admin-crud.component.scss',
...
export class AdminRetailPharmacyCrudComponent implements OnDestroy {
