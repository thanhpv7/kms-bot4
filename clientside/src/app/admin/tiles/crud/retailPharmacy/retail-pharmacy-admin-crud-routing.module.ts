...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminRetailPharmacyCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminRetailPharmacyCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminRetailPharmacyCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminRetailPharmacyCrudRoutingModule {
}
