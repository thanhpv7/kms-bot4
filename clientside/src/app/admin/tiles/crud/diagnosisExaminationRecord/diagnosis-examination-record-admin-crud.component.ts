 ...
 */
@Component({
	selector: 'cb-diagnosis-examination-record-admin-crud',
	templateUrl: './diagnosis-examination-record-admin-crud.component.html',
	styleUrls: [
		'./diagnosis-examination-record-admin-crud.component.scss',
...
export class AdminDiagnosisExaminationRecordCrudComponent implements OnDestroy {
