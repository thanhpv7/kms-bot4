...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminDiagnosisExaminationRecordCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminDiagnosisExaminationRecordCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminDiagnosisExaminationRecordCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminDiagnosisExaminationRecordCrudRoutingModule {
}
