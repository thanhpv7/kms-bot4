 ...
 */
@Component({
	selector: 'cb-transaction-detail-type-admin-crud',
	templateUrl: './transaction-detail-type-admin-crud.component.html',
	styleUrls: [
		'./transaction-detail-type-admin-crud.component.scss',
...
export class AdminTransactionDetailTypeCrudComponent implements OnDestroy {
