...
@Component({
	selector: 'cb-transaction-detail-type-admin-crud-edit',
	templateUrl: './transaction-detail-type-admin-crud-edit.component.html',
	styleUrls: [
		'./transaction-detail-type-admin-crud-edit.component.scss',
...
export class AdminTransactionDetailTypeCrudEditComponent
