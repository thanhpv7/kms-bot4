...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminTransactionDetailTypeCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminTransactionDetailTypeCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminTransactionDetailTypeCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminTransactionDetailTypeCrudRoutingModule {
}
