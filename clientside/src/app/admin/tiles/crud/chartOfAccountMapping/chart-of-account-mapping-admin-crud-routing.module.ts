...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminChartOfAccountMappingCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminChartOfAccountMappingCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminChartOfAccountMappingCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminChartOfAccountMappingCrudRoutingModule {
}
