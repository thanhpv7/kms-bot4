 ...
 */
@Component({
	selector: 'cb-chart-of-account-mapping-admin-crud',
	templateUrl: './chart-of-account-mapping-admin-crud.component.html',
	styleUrls: [
		'./chart-of-account-mapping-admin-crud.component.scss',
...
export class AdminChartOfAccountMappingCrudComponent implements OnDestroy {
