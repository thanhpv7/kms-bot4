...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminInventoryAdjustmentItemCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminInventoryAdjustmentItemCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminInventoryAdjustmentItemCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminInventoryAdjustmentItemCrudRoutingModule {
}
