 ...
 */
@Component({
	selector: 'cb-inventory-adjustment-item-admin-crud',
	templateUrl: './inventory-adjustment-item-admin-crud.component.html',
	styleUrls: [
		'./inventory-adjustment-item-admin-crud.component.scss',
...
export class AdminInventoryAdjustmentItemCrudComponent implements OnDestroy {
