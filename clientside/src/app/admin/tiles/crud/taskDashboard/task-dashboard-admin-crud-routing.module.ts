...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminTaskDashboardCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminTaskDashboardCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminTaskDashboardCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminTaskDashboardCrudRoutingModule {
}
