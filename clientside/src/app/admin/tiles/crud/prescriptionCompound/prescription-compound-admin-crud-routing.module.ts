...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminPrescriptionCompoundCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminPrescriptionCompoundCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminPrescriptionCompoundCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminPrescriptionCompoundCrudRoutingModule {
}
