 ...
 */
@Component({
	selector: 'cb-prescription-compound-admin-crud',
	templateUrl: './prescription-compound-admin-crud.component.html',
	styleUrls: [
		'./prescription-compound-admin-crud.component.scss',
...
export class AdminPrescriptionCompoundCrudComponent implements OnDestroy {
