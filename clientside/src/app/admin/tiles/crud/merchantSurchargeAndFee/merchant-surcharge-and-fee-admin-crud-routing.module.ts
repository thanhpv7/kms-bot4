...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminMerchantSurchargeAndFeeCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminMerchantSurchargeAndFeeCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminMerchantSurchargeAndFeeCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminMerchantSurchargeAndFeeCrudRoutingModule {
}
