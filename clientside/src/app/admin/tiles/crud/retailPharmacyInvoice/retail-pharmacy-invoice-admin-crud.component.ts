 ...
 */
@Component({
	selector: 'cb-retail-pharmacy-invoice-admin-crud',
	templateUrl: './retail-pharmacy-invoice-admin-crud.component.html',
	styleUrls: [
		'./retail-pharmacy-invoice-admin-crud.component.scss',
...
export class AdminRetailPharmacyInvoiceCrudComponent implements OnDestroy {
