...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminRetailPharmacyInvoiceCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminRetailPharmacyInvoiceCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminRetailPharmacyInvoiceCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminRetailPharmacyInvoiceCrudRoutingModule {
}
