 ...
 */
@Component({
	selector: 'cb-patient-payment-others-admin-crud',
	templateUrl: './patient-payment-others-admin-crud.component.html',
	styleUrls: [
		'./patient-payment-others-admin-crud.component.scss',
...
export class AdminPatientPaymentOthersCrudComponent implements OnDestroy {
