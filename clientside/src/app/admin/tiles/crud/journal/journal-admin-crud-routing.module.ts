...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminJournalCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminJournalCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminJournalCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminJournalCrudRoutingModule {
}
