 ...
 */
@Component({
	selector: 'cb-journal-admin-crud',
	templateUrl: './journal-admin-crud.component.html',
	styleUrls: [
		'./journal-admin-crud.component.scss',
...
export class AdminJournalCrudComponent implements OnDestroy {
