...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminTariffDefinitionCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminTariffDefinitionCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminTariffDefinitionCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminTariffDefinitionCrudRoutingModule {
}
