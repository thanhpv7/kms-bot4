 ...
 */
@Component({
	selector: 'cb-tariff-definition-admin-crud',
	templateUrl: './tariff-definition-admin-crud.component.html',
	styleUrls: [
		'./tariff-definition-admin-crud.component.scss',
...
export class AdminTariffDefinitionCrudComponent implements OnDestroy {
