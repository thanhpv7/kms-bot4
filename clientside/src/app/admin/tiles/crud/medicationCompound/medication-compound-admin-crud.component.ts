 ...
 */
@Component({
	selector: 'cb-medication-compound-admin-crud',
	templateUrl: './medication-compound-admin-crud.component.html',
	styleUrls: [
		'./medication-compound-admin-crud.component.scss',
...
export class AdminMedicationCompoundCrudComponent implements OnDestroy {
