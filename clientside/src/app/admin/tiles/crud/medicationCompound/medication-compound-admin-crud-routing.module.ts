...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminMedicationCompoundCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminMedicationCompoundCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminMedicationCompoundCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminMedicationCompoundCrudRoutingModule {
}
