...
@Component({
	selector: 'cb-medication-compound-admin-crud-edit',
	templateUrl: './medication-compound-admin-crud-edit.component.html',
	styleUrls: [
		'./medication-compound-admin-crud-edit.component.scss',
...
export class AdminMedicationCompoundCrudEditComponent
