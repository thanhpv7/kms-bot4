 ...
 */
@Component({
	selector: 'cb-bpjs-accident-master-admin-crud',
	templateUrl: './bpjs-accident-master-admin-crud.component.html',
	styleUrls: [
		'./bpjs-accident-master-admin-crud.component.scss',
...
export class AdminBpjsAccidentMasterCrudComponent implements OnDestroy {
