...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBpjsAccidentMasterCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBpjsAccidentMasterCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBpjsAccidentMasterCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBpjsAccidentMasterCrudRoutingModule {
}
