 ...
 */
@Component({
	selector: 'cb-bpjs-prb-detail-admin-crud',
	templateUrl: './bpjs-prb-detail-admin-crud.component.html',
	styleUrls: [
		'./bpjs-prb-detail-admin-crud.component.scss',
...
export class AdminBpjsPRBDetailCrudComponent implements OnDestroy {
