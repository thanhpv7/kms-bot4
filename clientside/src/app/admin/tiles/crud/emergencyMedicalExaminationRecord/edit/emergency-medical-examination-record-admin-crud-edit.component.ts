...
import {EmergencyMedicalExaminationRecordModelState, EmergencyMedicalExaminationRecordModelAudit} from 'src/app/models/emergencyMedicalExaminationRecord/emergency_medical_examination_record.model.state';
...
import {
	getEmergencyMedicalExaminationRecordModelAuditsByEntityId,
	getEmergencyMedicalExaminationRecordModelWithId,
	getCountEmergencyMedicalExaminationRecordModels,
...
@Component({
	selector: 'cb-emergency-medical-examination-record-admin-crud-edit',
	templateUrl: './emergency-medical-examination-record-admin-crud-edit.component.html',
	styleUrls: [
		'./emergency-medical-examination-record-admin-crud-edit.component.scss',
...
export class AdminEmergencyMedicalExaminationRecordCrudEditComponent
		...
		// % protected region % [Add any additional interfaces to implement here] end
{
	 ...
	 */
	emergencyMedicalExaminationRecordAudits$: Observable<EmergencyMedicalExaminationRecordModelAudit[]>;
	...
	medicalExaminationRecordOppositeRelation = 'emergencyMedicationExaminationRecord';
	...
	private get defaultExpands(): Expand[] {
		let expands: Expand[] = EmergencyMedicalExaminationRecordModel.getRelations().map(
			relation => {
				let exp = {
					name: relation.id,
	 ...
	 */
	targetModel: EmergencyMedicalExaminationRecordModel;
	...
	ngOnInit() {
		 ...
		 */
		this.creationNavigationSubscription$.add(this.store.select(getCountEmergencyMedicalExaminationRecordModels).subscribe(count => {
	...
	private initializeTargetModel() {
		...
		if (this.tileMode === CrudTileMode.Edit || this.tileMode === CrudTileMode.View) {
			...
			this.targetModel = new EmergencyMedicalExaminationRecordModel();
		...
		if (this.targetModelId) {
			this.emergencyMedicalExaminationRecordAudits$ = this.store.select(getEmergencyMedicalExaminationRecordModelAuditsByEntityId, this.targetModelId);
		}
	 ...
	 */
	private fetchEntity() {
		const stateConfig: PassableStateConfig<EmergencyMedicalExaminationRecordModel> = {
		...
		this.store.dispatch(new modelAction.EmergencyMedicalExaminationRecordAction(
			modelAction.EmergencyMedicalExaminationRecordModelActionTypes.FETCH_EMERGENCY_MEDICAL_EXAMINATION_RECORD,
			stateConfig
		));

		this.creationNavigationSubscription$.add(this.store.select(getEmergencyMedicalExaminationRecordModelWithId, this.targetModelId)
			...
			model = new EmergencyMedicalExaminationRecordModel(model);
			model.syncRelations();
	...
	onViewHistory() {
		...
		this.store.dispatch(new modelAction.EmergencyMedicalExaminationRecordAction(
			modelAction.EmergencyMedicalExaminationRecordModelActionTypes.FETCH_EMERGENCY_MEDICAL_EXAMINATION_RECORD_AUDITS_BY_ENTITY_ID,
			{
				targetModelId: this.targetModelId
			}
		));
	...
	onCreateOrSaveClicked(event: { isCreate: boolean, additionalEntities: any, payload?: { [s: string]: any } }) {
		...
		if (event.isCreate) {
			...
			this.store.dispatch(new modelAction.EmergencyMedicalExaminationRecordAction(
				modelAction.EmergencyMedicalExaminationRecordModelActionTypes.CREATE_EMERGENCY_MEDICAL_EXAMINATION_RECORD,
				stateConfig,
			...
			this.store.dispatch(new modelAction.EmergencyMedicalExaminationRecordAction(
				modelAction.EmergencyMedicalExaminationRecordModelActionTypes.UPDATE_EMERGENCY_MEDICAL_EXAMINATION_RECORD,
				stateConfig,
			...
			if (this.singlePageComponent) {
				let updatedModel: EmergencyMedicalExaminationRecordModel = new EmergencyMedicalExaminationRecordModel(this.targetModel).applyUpdates(stateConfig.updates);
				...
				this.creationNavigationSubscription$.add(this.store.select(getEmergencyMedicalExaminationRecordModelWithId, this.targetModelId).subscribe(model => {
					let differences = new EmergencyMedicalExaminationRecordModel(model).difference(updatedModel);
	 ...
	 */
	resetPropsAndRels() {
		this.modelProperties = EmergencyMedicalExaminationRecordModel.getProps();
		this.modelRelations = EmergencyMedicalExaminationRecordModel.getRelations();
	 ...
	 */
	addAdditionalEntitiesToModel(model: EmergencyMedicalExaminationRecordModel, event: { isCreate: boolean, additionalEntities: any, payload?: { [s: string]: any } }): EmergencyMedicalExaminationRecordModel {
		let updatedModel: EmergencyMedicalExaminationRecordModel = new EmergencyMedicalExaminationRecordModel(model);
