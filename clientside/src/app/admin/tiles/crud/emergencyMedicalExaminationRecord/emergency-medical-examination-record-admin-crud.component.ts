 ...
 */
@Component({
	selector: 'cb-emergency-medical-examination-record-admin-crud',
	templateUrl: './emergency-medical-examination-record-admin-crud.component.html',
	styleUrls: [
		'./emergency-medical-examination-record-admin-crud.component.scss',
...
export class AdminEmergencyMedicalExaminationRecordCrudComponent implements OnDestroy {
