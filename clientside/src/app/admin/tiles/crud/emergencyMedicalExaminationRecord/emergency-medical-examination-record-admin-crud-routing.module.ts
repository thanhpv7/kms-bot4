...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminEmergencyMedicalExaminationRecordCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminEmergencyMedicalExaminationRecordCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminEmergencyMedicalExaminationRecordCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminEmergencyMedicalExaminationRecordCrudRoutingModule {
}
