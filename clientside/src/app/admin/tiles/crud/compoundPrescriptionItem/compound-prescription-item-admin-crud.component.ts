 ...
 */
@Component({
	selector: 'cb-compound-prescription-item-admin-crud',
	templateUrl: './compound-prescription-item-admin-crud.component.html',
	styleUrls: [
		'./compound-prescription-item-admin-crud.component.scss',
...
export class AdminCompoundPrescriptionItemCrudComponent implements OnDestroy {
