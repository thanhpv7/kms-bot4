...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminCompoundPrescriptionItemCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminCompoundPrescriptionItemCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminCompoundPrescriptionItemCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminCompoundPrescriptionItemCrudRoutingModule {
}
