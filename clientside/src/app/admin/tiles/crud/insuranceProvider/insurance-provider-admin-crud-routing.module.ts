...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminInsuranceProviderCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminInsuranceProviderCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminInsuranceProviderCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminInsuranceProviderCrudRoutingModule {
}
