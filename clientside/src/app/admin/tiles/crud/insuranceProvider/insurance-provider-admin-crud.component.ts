 ...
 */
@Component({
	selector: 'cb-insurance-provider-admin-crud',
	templateUrl: './insurance-provider-admin-crud.component.html',
	styleUrls: [
		'./insurance-provider-admin-crud.component.scss',
...
export class AdminInsuranceProviderCrudComponent implements OnDestroy {
