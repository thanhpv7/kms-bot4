...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminPcareDiagnosaCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminPcareDiagnosaCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminPcareDiagnosaCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminPcareDiagnosaCrudRoutingModule {
}
