 ...
 */
@Component({
	selector: 'cb-pcare-diagnosa-admin-crud',
	templateUrl: './pcare-diagnosa-admin-crud.component.html',
	styleUrls: [
		'./pcare-diagnosa-admin-crud.component.scss',
...
export class AdminPcareDiagnosaCrudComponent implements OnDestroy {
