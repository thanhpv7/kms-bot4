 ...
 */
@Component({
	selector: 'cb-nurse-vital-sign-measurement-admin-crud',
	templateUrl: './nurse-vital-sign-measurement-admin-crud.component.html',
	styleUrls: [
		'./nurse-vital-sign-measurement-admin-crud.component.scss',
...
export class AdminNurseVitalSignMeasurementCrudComponent implements OnDestroy {
