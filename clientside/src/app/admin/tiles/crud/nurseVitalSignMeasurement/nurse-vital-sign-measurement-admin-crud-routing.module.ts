...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminNurseVitalSignMeasurementCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminNurseVitalSignMeasurementCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminNurseVitalSignMeasurementCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminNurseVitalSignMeasurementCrudRoutingModule {
}
