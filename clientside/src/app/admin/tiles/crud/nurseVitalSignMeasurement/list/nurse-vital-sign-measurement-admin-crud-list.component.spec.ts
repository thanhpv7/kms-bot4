...
import {AdminNurseVitalSignMeasurementCrudListComponent} from './nurse-vital-sign-measurement-admin-crud-list.component';
...
import {AdminNurseVitalSignMeasurementCrudModule} from '../nurse-vital-sign-measurement-admin-crud.module';
import {
...
describe('Nurse Vital Sign Measurement Crud List Tile Component', () => {
	...
	let fixture;
	let nurseVitalSignMeasurementCrudListComponent: AdminNurseVitalSignMeasurementCrudListComponent;
	...
	const routerState: RouterState = {
		url: 'nurse-vital-sign-measurement-admin-crud',
		urls: ['nurse-vital-sign-measurement-admin-crud'],
		params: {},
		queryParams: {},
		data: {},
	};
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			imports: [
				...
				AdminNurseVitalSignMeasurementCrudModule,
			],
			providers: [
				provideMockStore(),
				{
			...
			fixture = TestBed.createComponent(AdminNurseVitalSignMeasurementCrudListComponent);
