 ...
 */
@Component({
	selector: 'cb-purchase-requisition-stock-detail-admin-crud',
	templateUrl: './purchase-requisition-stock-detail-admin-crud.component.html',
	styleUrls: [
		'./purchase-requisition-stock-detail-admin-crud.component.scss',
...
export class AdminPurchaseRequisitionStockDetailCrudComponent implements OnDestroy {
