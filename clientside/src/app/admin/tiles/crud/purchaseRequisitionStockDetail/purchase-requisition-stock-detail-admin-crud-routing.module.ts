...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminPurchaseRequisitionStockDetailCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminPurchaseRequisitionStockDetailCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminPurchaseRequisitionStockDetailCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminPurchaseRequisitionStockDetailCrudRoutingModule {
}
