...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminFormulirKonselingTesHivCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminFormulirKonselingTesHivCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminFormulirKonselingTesHivCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminFormulirKonselingTesHivCrudRoutingModule {
}
