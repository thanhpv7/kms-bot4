 ...
 */
@Component({
	selector: 'cb-formulir-konseling-tes-hiv-admin-crud',
	templateUrl: './formulir-konseling-tes-hiv-admin-crud.component.html',
	styleUrls: [
		'./formulir-konseling-tes-hiv-admin-crud.component.scss',
...
export class AdminFormulirKonselingTesHivCrudComponent implements OnDestroy {
