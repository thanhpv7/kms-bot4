...
import {FormulirKonselingTesHivModelState, FormulirKonselingTesHivModelAudit} from 'src/app/models/formulirKonselingTesHiv/formulir_konseling_tes_hiv.model.state';
import {FormulirKonselingTesHivModel} from 'src/app/models/formulirKonselingTesHiv/formulir_konseling_tes_hiv.model';
import {
	getFormulirKonselingTesHivModelAuditsByEntityId,
	getFormulirKonselingTesHivModelWithId,
	getCountFormulirKonselingTesHivModels,
...
@Component({
	selector: 'cb-formulir-konseling-tes-hiv-admin-crud-edit',
	templateUrl: './formulir-konseling-tes-hiv-admin-crud-edit.component.html',
	styleUrls: [
		'./formulir-konseling-tes-hiv-admin-crud-edit.component.scss',
...
export class AdminFormulirKonselingTesHivCrudEditComponent
		...
		// % protected region % [Add any additional interfaces to implement here] end
{
	 ...
	 */
	formulirKonselingTesHivAudits$: Observable<FormulirKonselingTesHivModelAudit[]>;
	...
	medicalExaminationRecordOppositeRelation = 'formulirKonselingTesHiv';
	...
	private get defaultExpands(): Expand[] {
		let expands: Expand[] = FormulirKonselingTesHivModel.getRelations().map(
			relation => {
				let exp = {
					name: relation.id,
	 ...
	 */
	targetModel: FormulirKonselingTesHivModel;
	...
	ngOnInit() {
		 ...
		 */
		this.creationNavigationSubscription$.add(this.store.select(getCountFormulirKonselingTesHivModels).subscribe(count => {
	...
	private initializeTargetModel() {
		...
		if (this.tileMode === CrudTileMode.Edit || this.tileMode === CrudTileMode.View) {
			...
			this.targetModel = new FormulirKonselingTesHivModel();
		...
		if (this.targetModelId) {
			this.formulirKonselingTesHivAudits$ = this.store.select(getFormulirKonselingTesHivModelAuditsByEntityId, this.targetModelId);
		}
	 ...
	 */
	private fetchEntity() {
		const stateConfig: PassableStateConfig<FormulirKonselingTesHivModel> = {
		...
		this.store.dispatch(new modelAction.FormulirKonselingTesHivAction(
			modelAction.FormulirKonselingTesHivModelActionTypes.FETCH_FORMULIR_KONSELING_TES_HIV,
			stateConfig
		));

		this.creationNavigationSubscription$.add(this.store.select(getFormulirKonselingTesHivModelWithId, this.targetModelId)
			...
			model = new FormulirKonselingTesHivModel(model);
			model.syncRelations();
	...
	onViewHistory() {
		...
		this.store.dispatch(new modelAction.FormulirKonselingTesHivAction(
			modelAction.FormulirKonselingTesHivModelActionTypes.FETCH_FORMULIR_KONSELING_TES_HIV_AUDITS_BY_ENTITY_ID,
			{
				targetModelId: this.targetModelId
			}
		));
	...
	onCreateOrSaveClicked(event: { isCreate: boolean, additionalEntities: any, payload?: { [s: string]: any } }) {
		...
		if (event.isCreate) {
			...
			this.store.dispatch(new modelAction.FormulirKonselingTesHivAction(
				modelAction.FormulirKonselingTesHivModelActionTypes.CREATE_FORMULIR_KONSELING_TES_HIV,
				stateConfig,
			...
			this.store.dispatch(new modelAction.FormulirKonselingTesHivAction(
				modelAction.FormulirKonselingTesHivModelActionTypes.UPDATE_FORMULIR_KONSELING_TES_HIV,
				stateConfig,
			...
			if (this.singlePageComponent) {
				let updatedModel: FormulirKonselingTesHivModel = new FormulirKonselingTesHivModel(this.targetModel).applyUpdates(stateConfig.updates);
				...
				this.creationNavigationSubscription$.add(this.store.select(getFormulirKonselingTesHivModelWithId, this.targetModelId).subscribe(model => {
					let differences = new FormulirKonselingTesHivModel(model).difference(updatedModel);
	 ...
	 */
	resetPropsAndRels() {
		this.modelProperties = FormulirKonselingTesHivModel.getProps();
		this.modelRelations = FormulirKonselingTesHivModel.getRelations();
	 ...
	 */
	addAdditionalEntitiesToModel(model: FormulirKonselingTesHivModel, event: { isCreate: boolean, additionalEntities: any, payload?: { [s: string]: any } }): FormulirKonselingTesHivModel {
		let updatedModel: FormulirKonselingTesHivModel = new FormulirKonselingTesHivModel(model);
