...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminVitalSignsCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminVitalSignsCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminVitalSignsCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminVitalSignsCrudRoutingModule {
}
