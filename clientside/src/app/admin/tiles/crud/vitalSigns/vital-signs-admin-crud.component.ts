 ...
 */
@Component({
	selector: 'cb-vital-signs-admin-crud',
	templateUrl: './vital-signs-admin-crud.component.html',
	styleUrls: [
		'./vital-signs-admin-crud.component.scss',
...
export class AdminVitalSignsCrudComponent implements OnDestroy {
