 ...
 */
@Component({
	selector: 'cb-bpjs-drug-generic-prb-admin-crud',
	templateUrl: './bpjs-drug-generic-prb-admin-crud.component.html',
	styleUrls: [
		'./bpjs-drug-generic-prb-admin-crud.component.scss',
...
export class AdminBpjsDrugGenericPRBCrudComponent implements OnDestroy {
