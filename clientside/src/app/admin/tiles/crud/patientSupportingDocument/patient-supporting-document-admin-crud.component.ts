 ...
 */
@Component({
	selector: 'cb-patient-supporting-document-admin-crud',
	templateUrl: './patient-supporting-document-admin-crud.component.html',
	styleUrls: [
		'./patient-supporting-document-admin-crud.component.scss',
...
export class AdminPatientSupportingDocumentCrudComponent implements OnDestroy {
