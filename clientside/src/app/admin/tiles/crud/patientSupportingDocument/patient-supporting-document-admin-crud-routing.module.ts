...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminPatientSupportingDocumentCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminPatientSupportingDocumentCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminPatientSupportingDocumentCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminPatientSupportingDocumentCrudRoutingModule {
}
