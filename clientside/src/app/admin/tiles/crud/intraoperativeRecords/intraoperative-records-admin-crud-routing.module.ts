...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminIntraoperativeRecordsCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminIntraoperativeRecordsCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminIntraoperativeRecordsCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminIntraoperativeRecordsCrudRoutingModule {
}
