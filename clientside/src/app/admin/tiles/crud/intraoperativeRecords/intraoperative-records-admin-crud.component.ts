 ...
 */
@Component({
	selector: 'cb-intraoperative-records-admin-crud',
	templateUrl: './intraoperative-records-admin-crud.component.html',
	styleUrls: [
		'./intraoperative-records-admin-crud.component.scss',
...
export class AdminIntraoperativeRecordsCrudComponent implements OnDestroy {
