 ...
 */
@Component({
	selector: 'cb-medication-header-admin-crud',
	templateUrl: './medication-header-admin-crud.component.html',
	styleUrls: [
		'./medication-header-admin-crud.component.scss',
...
export class AdminMedicationHeaderCrudComponent implements OnDestroy {
