...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminMedicationHeaderCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminMedicationHeaderCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminMedicationHeaderCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminMedicationHeaderCrudRoutingModule {
}
