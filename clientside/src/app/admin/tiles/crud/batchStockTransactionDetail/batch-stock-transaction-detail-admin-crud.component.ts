 ...
 */
@Component({
	selector: 'cb-batch-stock-transaction-detail-admin-crud',
	templateUrl: './batch-stock-transaction-detail-admin-crud.component.html',
	styleUrls: [
		'./batch-stock-transaction-detail-admin-crud.component.scss',
...
export class AdminBatchStockTransactionDetailCrudComponent implements OnDestroy {
