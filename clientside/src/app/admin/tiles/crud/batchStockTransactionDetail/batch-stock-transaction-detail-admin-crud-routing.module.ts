...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBatchStockTransactionDetailCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBatchStockTransactionDetailCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBatchStockTransactionDetailCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBatchStockTransactionDetailCrudRoutingModule {
}
