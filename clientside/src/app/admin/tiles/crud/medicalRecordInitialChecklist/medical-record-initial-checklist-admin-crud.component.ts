 ...
 */
@Component({
	selector: 'cb-medical-record-initial-checklist-admin-crud',
	templateUrl: './medical-record-initial-checklist-admin-crud.component.html',
	styleUrls: [
		'./medical-record-initial-checklist-admin-crud.component.scss',
...
export class AdminMedicalRecordInitialChecklistCrudComponent implements OnDestroy {
