...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminMedicalRecordInitialChecklistCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminMedicalRecordInitialChecklistCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminMedicalRecordInitialChecklistCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminMedicalRecordInitialChecklistCrudRoutingModule {
}
