 ...
 */
@Component({
	selector: 'cb-newborn-detail-admin-crud',
	templateUrl: './newborn-detail-admin-crud.component.html',
	styleUrls: [
		'./newborn-detail-admin-crud.component.scss',
...
export class AdminNewbornDetailCrudComponent implements OnDestroy {
