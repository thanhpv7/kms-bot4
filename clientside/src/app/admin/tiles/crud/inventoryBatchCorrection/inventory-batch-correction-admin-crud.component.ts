 ...
 */
@Component({
	selector: 'cb-inventory-batch-correction-admin-crud',
	templateUrl: './inventory-batch-correction-admin-crud.component.html',
	styleUrls: [
		'./inventory-batch-correction-admin-crud.component.scss',
...
export class AdminInventoryBatchCorrectionCrudComponent implements OnDestroy {
