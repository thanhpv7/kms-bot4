...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminInventoryBatchCorrectionCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminInventoryBatchCorrectionCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminInventoryBatchCorrectionCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminInventoryBatchCorrectionCrudRoutingModule {
}
