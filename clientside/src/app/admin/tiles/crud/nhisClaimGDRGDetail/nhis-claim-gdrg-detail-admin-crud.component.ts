 ...
 */
@Component({
	selector: 'cb-nhis-claim-gdrg-detail-admin-crud',
	templateUrl: './nhis-claim-gdrg-detail-admin-crud.component.html',
	styleUrls: [
		'./nhis-claim-gdrg-detail-admin-crud.component.scss',
...
export class AdminNhisClaimGDRGDetailCrudComponent implements OnDestroy {
