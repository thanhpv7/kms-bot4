...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminNhisClaimGDRGDetailCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminNhisClaimGDRGDetailCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminNhisClaimGDRGDetailCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminNhisClaimGDRGDetailCrudRoutingModule {
}
