...
@Component({
	selector: 'cb-bpjs-service-mapping-admin-crud-edit',
	templateUrl: './bpjs-service-mapping-admin-crud-edit.component.html',
	styleUrls: [
		'./bpjs-service-mapping-admin-crud-edit.component.scss',
...
export class AdminBpjsServiceMappingCrudEditComponent
