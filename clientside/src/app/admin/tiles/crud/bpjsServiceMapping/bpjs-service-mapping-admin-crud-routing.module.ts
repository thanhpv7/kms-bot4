...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBpjsServiceMappingCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBpjsServiceMappingCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBpjsServiceMappingCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBpjsServiceMappingCrudRoutingModule {
}
