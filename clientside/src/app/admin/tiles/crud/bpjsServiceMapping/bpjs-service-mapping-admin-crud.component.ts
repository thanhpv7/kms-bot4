 ...
 */
@Component({
	selector: 'cb-bpjs-service-mapping-admin-crud',
	templateUrl: './bpjs-service-mapping-admin-crud.component.html',
	styleUrls: [
		'./bpjs-service-mapping-admin-crud.component.scss',
...
export class AdminBpjsServiceMappingCrudComponent implements OnDestroy {
