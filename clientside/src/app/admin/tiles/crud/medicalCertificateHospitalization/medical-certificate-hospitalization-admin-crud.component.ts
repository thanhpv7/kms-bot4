 ...
 */
@Component({
	selector: 'cb-medical-certificate-hospitalization-admin-crud',
	templateUrl: './medical-certificate-hospitalization-admin-crud.component.html',
	styleUrls: [
		'./medical-certificate-hospitalization-admin-crud.component.scss',
...
export class AdminMedicalCertificateHospitalizationCrudComponent implements OnDestroy {
