...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminMedicalCertificateHospitalizationCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminMedicalCertificateHospitalizationCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminMedicalCertificateHospitalizationCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminMedicalCertificateHospitalizationCrudRoutingModule {
}
