 ...
 */
@Component({
	selector: 'cb-chart-of-account-admin-crud',
	templateUrl: './chart-of-account-admin-crud.component.html',
	styleUrls: [
		'./chart-of-account-admin-crud.component.scss',
...
export class AdminChartOfAccountCrudComponent implements OnDestroy {
