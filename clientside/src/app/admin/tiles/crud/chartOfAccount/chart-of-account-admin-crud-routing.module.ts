...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminChartOfAccountCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminChartOfAccountCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminChartOfAccountCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminChartOfAccountCrudRoutingModule {
}
