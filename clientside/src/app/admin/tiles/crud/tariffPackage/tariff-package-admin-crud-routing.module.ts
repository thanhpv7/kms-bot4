...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminTariffPackageCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminTariffPackageCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminTariffPackageCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminTariffPackageCrudRoutingModule {
}
