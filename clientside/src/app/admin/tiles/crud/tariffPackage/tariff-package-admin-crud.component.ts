 ...
 */
@Component({
	selector: 'cb-tariff-package-admin-crud',
	templateUrl: './tariff-package-admin-crud.component.html',
	styleUrls: [
		'./tariff-package-admin-crud.component.scss',
...
export class AdminTariffPackageCrudComponent implements OnDestroy {
