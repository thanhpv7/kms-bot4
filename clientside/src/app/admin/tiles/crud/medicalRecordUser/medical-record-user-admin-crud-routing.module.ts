...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminMedicalRecordUserCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminMedicalRecordUserCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminMedicalRecordUserCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminMedicalRecordUserCrudRoutingModule {
}
