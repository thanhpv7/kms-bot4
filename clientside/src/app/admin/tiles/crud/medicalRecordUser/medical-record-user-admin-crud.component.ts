 ...
 */
@Component({
	selector: 'cb-medical-record-user-admin-crud',
	templateUrl: './medical-record-user-admin-crud.component.html',
	styleUrls: [
		'./medical-record-user-admin-crud.component.scss',
...
export class AdminMedicalRecordUserCrudComponent implements OnDestroy {
