...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminOphthalmologyExaminationCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminOphthalmologyExaminationCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminOphthalmologyExaminationCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminOphthalmologyExaminationCrudRoutingModule {
}
