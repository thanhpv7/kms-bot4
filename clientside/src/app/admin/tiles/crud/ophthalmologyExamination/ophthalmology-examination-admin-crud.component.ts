 ...
 */
@Component({
	selector: 'cb-ophthalmology-examination-admin-crud',
	templateUrl: './ophthalmology-examination-admin-crud.component.html',
	styleUrls: [
		'./ophthalmology-examination-admin-crud.component.scss',
...
export class AdminOphthalmologyExaminationCrudComponent implements OnDestroy {
