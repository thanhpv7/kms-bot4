...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminNhisInvestigationCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminNhisInvestigationCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminNhisInvestigationCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminNhisInvestigationCrudRoutingModule {
}
