 ...
 */
@Component({
	selector: 'cb-nhis-investigation-admin-crud',
	templateUrl: './nhis-investigation-admin-crud.component.html',
	styleUrls: [
		'./nhis-investigation-admin-crud.component.scss',
...
export class AdminNhisInvestigationCrudComponent implements OnDestroy {
