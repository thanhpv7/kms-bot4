 ...
 */
@Component({
	selector: 'cb-supplier-contact-detail-admin-crud',
	templateUrl: './supplier-contact-detail-admin-crud.component.html',
	styleUrls: [
		'./supplier-contact-detail-admin-crud.component.scss',
...
export class AdminSupplierContactDetailCrudComponent implements OnDestroy {
