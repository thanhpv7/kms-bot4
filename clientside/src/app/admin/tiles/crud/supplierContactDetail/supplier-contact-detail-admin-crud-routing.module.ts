...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminSupplierContactDetailCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminSupplierContactDetailCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminSupplierContactDetailCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminSupplierContactDetailCrudRoutingModule {
}
