 ...
 */
@Component({
	selector: 'cb-patient-visit-payment-self-paying-admin-crud',
	templateUrl: './patient-visit-payment-self-paying-admin-crud.component.html',
	styleUrls: [
		'./patient-visit-payment-self-paying-admin-crud.component.scss',
...
export class AdminPatientVisitPaymentSelfPayingCrudComponent implements OnDestroy {
