...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminPatientVisitPaymentSelfPayingCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminPatientVisitPaymentSelfPayingCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminPatientVisitPaymentSelfPayingCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminPatientVisitPaymentSelfPayingCrudRoutingModule {
}
