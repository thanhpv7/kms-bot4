 ...
 */
@Component({
	selector: 'cb-satu-sehat-configuration-admin-crud',
	templateUrl: './satu-sehat-configuration-admin-crud.component.html',
	styleUrls: [
		'./satu-sehat-configuration-admin-crud.component.scss',
...
export class AdminSatuSehatConfigurationCrudComponent implements OnDestroy {
