...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminSatuSehatConfigurationCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminSatuSehatConfigurationCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminSatuSehatConfigurationCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminSatuSehatConfigurationCrudRoutingModule {
}
