...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBpjsUpdateDismissalDateCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBpjsUpdateDismissalDateCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBpjsUpdateDismissalDateCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBpjsUpdateDismissalDateCrudRoutingModule {
}
