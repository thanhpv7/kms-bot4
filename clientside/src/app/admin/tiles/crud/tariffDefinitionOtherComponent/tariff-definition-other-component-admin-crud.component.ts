 ...
 */
@Component({
	selector: 'cb-tariff-definition-other-component-admin-crud',
	templateUrl: './tariff-definition-other-component-admin-crud.component.html',
	styleUrls: [
		'./tariff-definition-other-component-admin-crud.component.scss',
...
export class AdminTariffDefinitionOtherComponentCrudComponent implements OnDestroy {
