...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminWarehouseUserCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminWarehouseUserCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminWarehouseUserCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminWarehouseUserCrudRoutingModule {
}
