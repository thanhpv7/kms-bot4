 ...
 */
@Component({
	selector: 'cb-warehouse-user-admin-crud',
	templateUrl: './warehouse-user-admin-crud.component.html',
	styleUrls: [
		'./warehouse-user-admin-crud.component.scss',
...
export class AdminWarehouseUserCrudComponent implements OnDestroy {
