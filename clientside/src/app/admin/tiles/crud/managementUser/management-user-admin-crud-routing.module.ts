...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminManagementUserCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminManagementUserCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminManagementUserCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminManagementUserCrudRoutingModule {
}
