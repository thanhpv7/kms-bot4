 ...
 */
@Component({
	selector: 'cb-management-user-admin-crud',
	templateUrl: './management-user-admin-crud.component.html',
	styleUrls: [
		'./management-user-admin-crud.component.scss',
...
export class AdminManagementUserCrudComponent implements OnDestroy {
