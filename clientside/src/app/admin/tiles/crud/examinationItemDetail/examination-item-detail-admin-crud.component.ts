 ...
 */
@Component({
	selector: 'cb-examination-item-detail-admin-crud',
	templateUrl: './examination-item-detail-admin-crud.component.html',
	styleUrls: [
		'./examination-item-detail-admin-crud.component.scss',
...
export class AdminExaminationItemDetailCrudComponent implements OnDestroy {
