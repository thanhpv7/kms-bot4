...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminExaminationItemDetailCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminExaminationItemDetailCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminExaminationItemDetailCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminExaminationItemDetailCrudRoutingModule {
}
