 ...
 */
@Component({
	selector: 'cb-pcare-compound-drug-item-admin-crud',
	templateUrl: './pcare-compound-drug-item-admin-crud.component.html',
	styleUrls: [
		'./pcare-compound-drug-item-admin-crud.component.scss',
...
export class AdminPcareCompoundDrugItemCrudComponent implements OnDestroy {
