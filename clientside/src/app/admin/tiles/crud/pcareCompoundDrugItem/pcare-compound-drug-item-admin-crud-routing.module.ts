...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminPcareCompoundDrugItemCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminPcareCompoundDrugItemCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminPcareCompoundDrugItemCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminPcareCompoundDrugItemCrudRoutingModule {
}
