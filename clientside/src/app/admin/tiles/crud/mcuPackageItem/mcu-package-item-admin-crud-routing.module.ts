...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminMcuPackageItemCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminMcuPackageItemCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminMcuPackageItemCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminMcuPackageItemCrudRoutingModule {
}
