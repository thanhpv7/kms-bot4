 ...
 */
@Component({
	selector: 'cb-mcu-package-item-admin-crud',
	templateUrl: './mcu-package-item-admin-crud.component.html',
	styleUrls: [
		'./mcu-package-item-admin-crud.component.scss',
...
export class AdminMcuPackageItemCrudComponent implements OnDestroy {
