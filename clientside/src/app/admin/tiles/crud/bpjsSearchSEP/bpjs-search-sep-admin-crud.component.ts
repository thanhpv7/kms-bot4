 ...
 */
@Component({
	selector: 'cb-bpjs-search-sep-admin-crud',
	templateUrl: './bpjs-search-sep-admin-crud.component.html',
	styleUrls: [
		'./bpjs-search-sep-admin-crud.component.scss',
...
export class AdminBpjsSearchSEPCrudComponent implements OnDestroy {
