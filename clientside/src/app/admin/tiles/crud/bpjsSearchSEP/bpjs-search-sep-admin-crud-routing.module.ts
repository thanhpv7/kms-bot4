...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBpjsSearchSEPCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBpjsSearchSEPCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBpjsSearchSEPCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBpjsSearchSEPCrudRoutingModule {
}
