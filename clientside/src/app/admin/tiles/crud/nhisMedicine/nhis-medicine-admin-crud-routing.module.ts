...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminNhisMedicineCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminNhisMedicineCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminNhisMedicineCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminNhisMedicineCrudRoutingModule {
}
