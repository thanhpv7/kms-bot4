 ...
 */
@Component({
	selector: 'cb-nhis-medicine-admin-crud',
	templateUrl: './nhis-medicine-admin-crud.component.html',
	styleUrls: [
		'./nhis-medicine-admin-crud.component.scss',
...
export class AdminNhisMedicineCrudComponent implements OnDestroy {
