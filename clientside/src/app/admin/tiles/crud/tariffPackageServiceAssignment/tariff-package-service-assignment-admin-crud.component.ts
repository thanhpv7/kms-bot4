 ...
 */
@Component({
	selector: 'cb-tariff-package-service-assignment-admin-crud',
	templateUrl: './tariff-package-service-assignment-admin-crud.component.html',
	styleUrls: [
		'./tariff-package-service-assignment-admin-crud.component.scss',
...
export class AdminTariffPackageServiceAssignmentCrudComponent implements OnDestroy {
