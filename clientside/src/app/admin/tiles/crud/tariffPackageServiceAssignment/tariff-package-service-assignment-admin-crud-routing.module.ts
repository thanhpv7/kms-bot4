...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminTariffPackageServiceAssignmentCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminTariffPackageServiceAssignmentCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminTariffPackageServiceAssignmentCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminTariffPackageServiceAssignmentCrudRoutingModule {
}
