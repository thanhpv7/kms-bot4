 ...
 */
@Component({
	selector: 'cb-bpjs-special-referral-admin-crud',
	templateUrl: './bpjs-special-referral-admin-crud.component.html',
	styleUrls: [
		'./bpjs-special-referral-admin-crud.component.scss',
...
export class AdminBpjsSpecialReferralCrudComponent implements OnDestroy {
