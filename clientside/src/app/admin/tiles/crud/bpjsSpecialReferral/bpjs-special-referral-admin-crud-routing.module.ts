...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBpjsSpecialReferralCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBpjsSpecialReferralCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBpjsSpecialReferralCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBpjsSpecialReferralCrudRoutingModule {
}
