...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminDiagnosticSupportUserCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminDiagnosticSupportUserCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminDiagnosticSupportUserCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminDiagnosticSupportUserCrudRoutingModule {
}
