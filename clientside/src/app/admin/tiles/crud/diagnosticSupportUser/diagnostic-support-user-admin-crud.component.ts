 ...
 */
@Component({
	selector: 'cb-diagnostic-support-user-admin-crud',
	templateUrl: './diagnostic-support-user-admin-crud.component.html',
	styleUrls: [
		'./diagnostic-support-user-admin-crud.component.scss',
...
export class AdminDiagnosticSupportUserCrudComponent implements OnDestroy {
