 ...
 */
@Component({
	selector: 'cb-patient-general-info-admin-crud',
	templateUrl: './patient-general-info-admin-crud.component.html',
	styleUrls: [
		'./patient-general-info-admin-crud.component.scss',
...
export class AdminPatientGeneralInfoCrudComponent implements OnDestroy {
