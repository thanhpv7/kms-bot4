...
@Component({
	selector: 'cb-patient-general-info-admin-crud-edit',
	templateUrl: './patient-general-info-admin-crud-edit.component.html',
	styleUrls: [
		'./patient-general-info-admin-crud-edit.component.scss',
...
export class AdminPatientGeneralInfoCrudEditComponent
