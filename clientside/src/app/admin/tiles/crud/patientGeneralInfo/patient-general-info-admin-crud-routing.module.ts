...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminPatientGeneralInfoCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminPatientGeneralInfoCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminPatientGeneralInfoCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminPatientGeneralInfoCrudRoutingModule {
}
