...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminPrescriptionHeaderCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminPrescriptionHeaderCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminPrescriptionHeaderCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminPrescriptionHeaderCrudRoutingModule {
}
