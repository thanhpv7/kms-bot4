 ...
 */
@Component({
	selector: 'cb-prescription-header-admin-crud',
	templateUrl: './prescription-header-admin-crud.component.html',
	styleUrls: [
		'./prescription-header-admin-crud.component.scss',
...
export class AdminPrescriptionHeaderCrudComponent implements OnDestroy {
