 ...
 */
@Component({
	selector: 'cb-patient-visit-patient-payment-others-admin-crud',
	templateUrl: './patient-visit-patient-payment-others-admin-crud.component.html',
	styleUrls: [
		'./patient-visit-patient-payment-others-admin-crud.component.scss',
...
export class AdminPatientVisitPatientPaymentOthersCrudComponent implements OnDestroy {
