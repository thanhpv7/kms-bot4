...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminPatientVisitPatientPaymentOthersCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminPatientVisitPatientPaymentOthersCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminPatientVisitPatientPaymentOthersCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminPatientVisitPatientPaymentOthersCrudRoutingModule {
}
