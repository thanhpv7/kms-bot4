...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminHospitalBranchInformationCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminHospitalBranchInformationCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminHospitalBranchInformationCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminHospitalBranchInformationCrudRoutingModule {
}
