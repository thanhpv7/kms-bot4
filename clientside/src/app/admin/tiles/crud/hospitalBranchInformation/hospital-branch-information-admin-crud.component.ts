 ...
 */
@Component({
	selector: 'cb-hospital-branch-information-admin-crud',
	templateUrl: './hospital-branch-information-admin-crud.component.html',
	styleUrls: [
		'./hospital-branch-information-admin-crud.component.scss',
...
export class AdminHospitalBranchInformationCrudComponent implements OnDestroy {
