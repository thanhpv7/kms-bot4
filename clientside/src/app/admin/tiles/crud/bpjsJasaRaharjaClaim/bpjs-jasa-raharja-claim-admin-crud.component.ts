 ...
 */
@Component({
	selector: 'cb-bpjs-jasa-raharja-claim-admin-crud',
	templateUrl: './bpjs-jasa-raharja-claim-admin-crud.component.html',
	styleUrls: [
		'./bpjs-jasa-raharja-claim-admin-crud.component.scss',
...
export class AdminBpjsJasaRaharjaClaimCrudComponent implements OnDestroy {
