 ...
 */
@Component({
	selector: 'cb-insurance-benefit-plan-admin-crud',
	templateUrl: './insurance-benefit-plan-admin-crud.component.html',
	styleUrls: [
		'./insurance-benefit-plan-admin-crud.component.scss',
...
export class AdminInsuranceBenefitPlanCrudComponent implements OnDestroy {
