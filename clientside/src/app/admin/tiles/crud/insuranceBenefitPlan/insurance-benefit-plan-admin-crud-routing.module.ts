...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminInsuranceBenefitPlanCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminInsuranceBenefitPlanCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminInsuranceBenefitPlanCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminInsuranceBenefitPlanCrudRoutingModule {
}
