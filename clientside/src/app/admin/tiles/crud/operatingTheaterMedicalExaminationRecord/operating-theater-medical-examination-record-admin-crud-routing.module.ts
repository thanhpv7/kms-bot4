...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminOperatingTheaterMedicalExaminationRecordCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminOperatingTheaterMedicalExaminationRecordCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminOperatingTheaterMedicalExaminationRecordCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminOperatingTheaterMedicalExaminationRecordCrudRoutingModule {
}
