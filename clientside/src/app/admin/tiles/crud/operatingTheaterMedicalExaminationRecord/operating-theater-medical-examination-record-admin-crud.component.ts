 ...
 */
@Component({
	selector: 'cb-operating-theater-medical-examination-record-admin-crud',
	templateUrl: './operating-theater-medical-examination-record-admin-crud.component.html',
	styleUrls: [
		'./operating-theater-medical-examination-record-admin-crud.component.scss',
...
export class AdminOperatingTheaterMedicalExaminationRecordCrudComponent implements OnDestroy {
