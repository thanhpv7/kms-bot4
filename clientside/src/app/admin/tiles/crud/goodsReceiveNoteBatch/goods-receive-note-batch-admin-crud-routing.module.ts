...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminGoodsReceiveNoteBatchCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminGoodsReceiveNoteBatchCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminGoodsReceiveNoteBatchCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminGoodsReceiveNoteBatchCrudRoutingModule {
}
