 ...
 */
@Component({
	selector: 'cb-goods-receive-note-batch-admin-crud',
	templateUrl: './goods-receive-note-batch-admin-crud.component.html',
	styleUrls: [
		'./goods-receive-note-batch-admin-crud.component.scss',
...
export class AdminGoodsReceiveNoteBatchCrudComponent implements OnDestroy {
