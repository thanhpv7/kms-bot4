...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminInternalOrderCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminInternalOrderCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminInternalOrderCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminInternalOrderCrudRoutingModule {
}
