 ...
 */
@Component({
	selector: 'cb-internal-order-admin-crud',
	templateUrl: './internal-order-admin-crud.component.html',
	styleUrls: [
		'./internal-order-admin-crud.component.scss',
...
export class AdminInternalOrderCrudComponent implements OnDestroy {
