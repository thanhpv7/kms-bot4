 ...
 */
@Component({
	selector: 'cb-delivery-progress-admin-crud',
	templateUrl: './delivery-progress-admin-crud.component.html',
	styleUrls: [
		'./delivery-progress-admin-crud.component.scss',
...
export class AdminDeliveryProgressCrudComponent implements OnDestroy {
