...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminDeliveryProgressCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminDeliveryProgressCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminDeliveryProgressCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminDeliveryProgressCrudRoutingModule {
}
