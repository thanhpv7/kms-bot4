...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBpjsSEPINACBGIntegrationCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBpjsSEPINACBGIntegrationCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBpjsSEPINACBGIntegrationCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBpjsSEPINACBGIntegrationCrudRoutingModule {
}
