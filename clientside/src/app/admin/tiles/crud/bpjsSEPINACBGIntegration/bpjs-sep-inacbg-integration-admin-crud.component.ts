 ...
 */
@Component({
	selector: 'cb-bpjs-sep-inacbg-integration-admin-crud',
	templateUrl: './bpjs-sep-inacbg-integration-admin-crud.component.html',
	styleUrls: [
		'./bpjs-sep-inacbg-integration-admin-crud.component.scss',
...
export class AdminBpjsSEPINACBGIntegrationCrudComponent implements OnDestroy {
