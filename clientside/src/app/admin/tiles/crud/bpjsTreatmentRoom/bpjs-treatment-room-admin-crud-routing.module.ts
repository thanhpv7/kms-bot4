...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBpjsTreatmentRoomCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBpjsTreatmentRoomCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBpjsTreatmentRoomCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBpjsTreatmentRoomCrudRoutingModule {
}
