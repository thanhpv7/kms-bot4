 ...
 */
@Component({
	selector: 'cb-bpjs-treatment-room-admin-crud',
	templateUrl: './bpjs-treatment-room-admin-crud.component.html',
	styleUrls: [
		'./bpjs-treatment-room-admin-crud.component.scss',
...
export class AdminBpjsTreatmentRoomCrudComponent implements OnDestroy {
