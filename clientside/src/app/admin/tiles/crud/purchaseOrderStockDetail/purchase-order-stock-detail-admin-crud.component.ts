 ...
 */
@Component({
	selector: 'cb-purchase-order-stock-detail-admin-crud',
	templateUrl: './purchase-order-stock-detail-admin-crud.component.html',
	styleUrls: [
		'./purchase-order-stock-detail-admin-crud.component.scss',
...
export class AdminPurchaseOrderStockDetailCrudComponent implements OnDestroy {
