...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminPurchaseOrderStockDetailCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminPurchaseOrderStockDetailCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminPurchaseOrderStockDetailCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminPurchaseOrderStockDetailCrudRoutingModule {
}
