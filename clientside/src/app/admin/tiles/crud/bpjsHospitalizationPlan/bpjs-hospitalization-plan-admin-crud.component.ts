 ...
 */
@Component({
	selector: 'cb-bpjs-hospitalization-plan-admin-crud',
	templateUrl: './bpjs-hospitalization-plan-admin-crud.component.html',
	styleUrls: [
		'./bpjs-hospitalization-plan-admin-crud.component.scss',
...
export class AdminBpjsHospitalizationPlanCrudComponent implements OnDestroy {
