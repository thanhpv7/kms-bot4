...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBpjsHospitalizationPlanCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBpjsHospitalizationPlanCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBpjsHospitalizationPlanCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBpjsHospitalizationPlanCrudRoutingModule {
}
