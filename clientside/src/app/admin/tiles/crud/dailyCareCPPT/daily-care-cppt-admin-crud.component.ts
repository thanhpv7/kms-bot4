 ...
 */
@Component({
	selector: 'cb-daily-care-cppt-admin-crud',
	templateUrl: './daily-care-cppt-admin-crud.component.html',
	styleUrls: [
		'./daily-care-cppt-admin-crud.component.scss',
...
export class AdminDailyCareCPPTCrudComponent implements OnDestroy {
