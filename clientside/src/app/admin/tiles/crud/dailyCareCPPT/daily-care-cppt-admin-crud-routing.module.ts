...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminDailyCareCPPTCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminDailyCareCPPTCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminDailyCareCPPTCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminDailyCareCPPTCrudRoutingModule {
}
