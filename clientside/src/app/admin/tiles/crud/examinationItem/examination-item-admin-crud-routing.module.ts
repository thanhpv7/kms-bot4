...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminExaminationItemCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminExaminationItemCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminExaminationItemCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminExaminationItemCrudRoutingModule {
}
