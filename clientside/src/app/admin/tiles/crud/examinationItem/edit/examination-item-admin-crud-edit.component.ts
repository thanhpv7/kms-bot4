...
@Component({
	selector: 'cb-examination-item-admin-crud-edit',
	templateUrl: './examination-item-admin-crud-edit.component.html',
	styleUrls: [
		'./examination-item-admin-crud-edit.component.scss',
...
export class AdminExaminationItemCrudEditComponent
