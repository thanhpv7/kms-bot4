 ...
 */
@Component({
	selector: 'cb-examination-item-admin-crud',
	templateUrl: './examination-item-admin-crud.component.html',
	styleUrls: [
		'./examination-item-admin-crud.component.scss',
...
export class AdminExaminationItemCrudComponent implements OnDestroy {
