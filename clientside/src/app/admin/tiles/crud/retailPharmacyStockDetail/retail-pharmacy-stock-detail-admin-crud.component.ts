 ...
 */
@Component({
	selector: 'cb-retail-pharmacy-stock-detail-admin-crud',
	templateUrl: './retail-pharmacy-stock-detail-admin-crud.component.html',
	styleUrls: [
		'./retail-pharmacy-stock-detail-admin-crud.component.scss',
...
export class AdminRetailPharmacyStockDetailCrudComponent implements OnDestroy {
