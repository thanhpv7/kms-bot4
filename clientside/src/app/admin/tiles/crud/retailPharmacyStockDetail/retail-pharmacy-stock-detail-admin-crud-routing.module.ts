...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminRetailPharmacyStockDetailCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminRetailPharmacyStockDetailCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminRetailPharmacyStockDetailCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminRetailPharmacyStockDetailCrudRoutingModule {
}
