...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminPatientDetailCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminPatientDetailCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminPatientDetailCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminPatientDetailCrudRoutingModule {
}
