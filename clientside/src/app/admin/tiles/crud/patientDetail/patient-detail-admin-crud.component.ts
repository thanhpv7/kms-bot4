 ...
 */
@Component({
	selector: 'cb-patient-detail-admin-crud',
	templateUrl: './patient-detail-admin-crud.component.html',
	styleUrls: [
		'./patient-detail-admin-crud.component.scss',
...
export class AdminPatientDetailCrudComponent implements OnDestroy {
