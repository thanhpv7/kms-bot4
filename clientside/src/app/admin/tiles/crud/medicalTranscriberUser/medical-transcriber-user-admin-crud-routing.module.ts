...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminMedicalTranscriberUserCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminMedicalTranscriberUserCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminMedicalTranscriberUserCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminMedicalTranscriberUserCrudRoutingModule {
}
