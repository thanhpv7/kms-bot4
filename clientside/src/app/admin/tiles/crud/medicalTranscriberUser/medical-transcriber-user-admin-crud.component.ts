 ...
 */
@Component({
	selector: 'cb-medical-transcriber-user-admin-crud',
	templateUrl: './medical-transcriber-user-admin-crud.component.html',
	styleUrls: [
		'./medical-transcriber-user-admin-crud.component.scss',
...
export class AdminMedicalTranscriberUserCrudComponent implements OnDestroy {
