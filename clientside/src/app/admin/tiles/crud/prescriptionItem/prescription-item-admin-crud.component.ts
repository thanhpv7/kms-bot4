 ...
 */
@Component({
	selector: 'cb-prescription-item-admin-crud',
	templateUrl: './prescription-item-admin-crud.component.html',
	styleUrls: [
		'./prescription-item-admin-crud.component.scss',
...
export class AdminPrescriptionItemCrudComponent implements OnDestroy {
