...
@Component({
	selector: 'cb-prescription-item-admin-crud-edit',
	templateUrl: './prescription-item-admin-crud-edit.component.html',
	styleUrls: [
		'./prescription-item-admin-crud-edit.component.scss',
...
export class AdminPrescriptionItemCrudEditComponent
