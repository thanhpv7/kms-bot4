...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminPrescriptionItemCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminPrescriptionItemCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminPrescriptionItemCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminPrescriptionItemCrudRoutingModule {
}
