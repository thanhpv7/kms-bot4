 ...
 */
@Component({
	selector: 'cb-hospital-group-information-admin-crud',
	templateUrl: './hospital-group-information-admin-crud.component.html',
	styleUrls: [
		'./hospital-group-information-admin-crud.component.scss',
...
export class AdminHospitalGroupInformationCrudComponent implements OnDestroy {
