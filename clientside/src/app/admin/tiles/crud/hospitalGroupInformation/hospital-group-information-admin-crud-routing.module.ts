...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminHospitalGroupInformationCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminHospitalGroupInformationCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminHospitalGroupInformationCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminHospitalGroupInformationCrudRoutingModule {
}
