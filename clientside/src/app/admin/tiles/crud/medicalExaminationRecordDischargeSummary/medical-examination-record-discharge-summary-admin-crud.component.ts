 ...
 */
@Component({
	selector: 'cb-medical-examination-record-discharge-summary-admin-crud',
	templateUrl: './medical-examination-record-discharge-summary-admin-crud.component.html',
	styleUrls: [
		'./medical-examination-record-discharge-summary-admin-crud.component.scss',
...
export class AdminMedicalExaminationRecordDischargeSummaryCrudComponent implements OnDestroy {
