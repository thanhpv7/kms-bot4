...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminMedicalExaminationRecordDischargeSummaryCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminMedicalExaminationRecordDischargeSummaryCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminMedicalExaminationRecordDischargeSummaryCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminMedicalExaminationRecordDischargeSummaryCrudRoutingModule {
}
