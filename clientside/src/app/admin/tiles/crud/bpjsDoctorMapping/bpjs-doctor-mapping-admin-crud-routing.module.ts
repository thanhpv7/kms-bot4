...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBpjsDoctorMappingCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBpjsDoctorMappingCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBpjsDoctorMappingCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBpjsDoctorMappingCrudRoutingModule {
}
