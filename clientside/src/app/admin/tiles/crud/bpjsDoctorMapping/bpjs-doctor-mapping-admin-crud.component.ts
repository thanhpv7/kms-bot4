 ...
 */
@Component({
	selector: 'cb-bpjs-doctor-mapping-admin-crud',
	templateUrl: './bpjs-doctor-mapping-admin-crud.component.html',
	styleUrls: [
		'./bpjs-doctor-mapping-admin-crud.component.scss',
...
export class AdminBpjsDoctorMappingCrudComponent implements OnDestroy {
