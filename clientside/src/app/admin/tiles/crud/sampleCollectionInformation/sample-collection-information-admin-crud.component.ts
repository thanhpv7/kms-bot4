 ...
 */
@Component({
	selector: 'cb-sample-collection-information-admin-crud',
	templateUrl: './sample-collection-information-admin-crud.component.html',
	styleUrls: [
		'./sample-collection-information-admin-crud.component.scss',
...
export class AdminSampleCollectionInformationCrudComponent implements OnDestroy {
