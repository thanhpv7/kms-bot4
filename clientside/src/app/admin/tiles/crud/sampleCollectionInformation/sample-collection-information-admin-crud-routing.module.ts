...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminSampleCollectionInformationCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminSampleCollectionInformationCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminSampleCollectionInformationCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminSampleCollectionInformationCrudRoutingModule {
}
