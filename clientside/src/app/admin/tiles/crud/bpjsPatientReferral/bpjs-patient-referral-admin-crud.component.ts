 ...
 */
@Component({
	selector: 'cb-bpjs-patient-referral-admin-crud',
	templateUrl: './bpjs-patient-referral-admin-crud.component.html',
	styleUrls: [
		'./bpjs-patient-referral-admin-crud.component.scss',
...
export class AdminBpjsPatientReferralCrudComponent implements OnDestroy {
