...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBpjsPatientReferralCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBpjsPatientReferralCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBpjsPatientReferralCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBpjsPatientReferralCrudRoutingModule {
}
