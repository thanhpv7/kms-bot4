 ...
 */
@Component({
	selector: 'cb-batch-stock-balance-per-date-admin-crud',
	templateUrl: './batch-stock-balance-per-date-admin-crud.component.html',
	styleUrls: [
		'./batch-stock-balance-per-date-admin-crud.component.scss',
...
export class AdminBatchStockBalancePerDateCrudComponent implements OnDestroy {
