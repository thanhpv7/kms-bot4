...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBatchStockBalancePerDateCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBatchStockBalancePerDateCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBatchStockBalancePerDateCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBatchStockBalancePerDateCrudRoutingModule {
}
