...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminPcareDokterCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminPcareDokterCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminPcareDokterCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminPcareDokterCrudRoutingModule {
}
