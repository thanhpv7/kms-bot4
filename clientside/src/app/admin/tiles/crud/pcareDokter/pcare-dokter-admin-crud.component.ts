 ...
 */
@Component({
	selector: 'cb-pcare-dokter-admin-crud',
	templateUrl: './pcare-dokter-admin-crud.component.html',
	styleUrls: [
		'./pcare-dokter-admin-crud.component.scss',
...
export class AdminPcareDokterCrudComponent implements OnDestroy {
