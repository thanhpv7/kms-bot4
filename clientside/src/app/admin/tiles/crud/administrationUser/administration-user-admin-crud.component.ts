 ...
 */
@Component({
	selector: 'cb-administration-user-admin-crud',
	templateUrl: './administration-user-admin-crud.component.html',
	styleUrls: [
		'./administration-user-admin-crud.component.scss',
...
export class AdminAdministrationUserCrudComponent implements OnDestroy {
