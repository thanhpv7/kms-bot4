...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminAdministrationUserCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminAdministrationUserCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminAdministrationUserCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminAdministrationUserCrudRoutingModule {
}
