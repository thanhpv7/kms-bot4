 ...
 */
@Component({
	selector: 'cb-medical-certificate-sick-leave-admin-crud',
	templateUrl: './medical-certificate-sick-leave-admin-crud.component.html',
	styleUrls: [
		'./medical-certificate-sick-leave-admin-crud.component.scss',
...
export class AdminMedicalCertificateSickLeaveCrudComponent implements OnDestroy {
