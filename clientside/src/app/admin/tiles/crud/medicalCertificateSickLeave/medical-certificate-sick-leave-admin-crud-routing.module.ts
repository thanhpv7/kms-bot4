...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminMedicalCertificateSickLeaveCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminMedicalCertificateSickLeaveCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminMedicalCertificateSickLeaveCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminMedicalCertificateSickLeaveCrudRoutingModule {
}
