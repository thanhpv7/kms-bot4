...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminTariffSchemaCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminTariffSchemaCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminTariffSchemaCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminTariffSchemaCrudRoutingModule {
}
