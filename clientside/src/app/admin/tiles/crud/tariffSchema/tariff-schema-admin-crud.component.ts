 ...
 */
@Component({
	selector: 'cb-tariff-schema-admin-crud',
	templateUrl: './tariff-schema-admin-crud.component.html',
	styleUrls: [
		'./tariff-schema-admin-crud.component.scss',
...
export class AdminTariffSchemaCrudComponent implements OnDestroy {
