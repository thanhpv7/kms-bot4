...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminWarehouseInitialStockCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminWarehouseInitialStockCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminWarehouseInitialStockCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminWarehouseInitialStockCrudRoutingModule {
}
