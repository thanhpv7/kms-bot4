 ...
 */
@Component({
	selector: 'cb-warehouse-initial-stock-admin-crud',
	templateUrl: './warehouse-initial-stock-admin-crud.component.html',
	styleUrls: [
		'./warehouse-initial-stock-admin-crud.component.scss',
...
export class AdminWarehouseInitialStockCrudComponent implements OnDestroy {
