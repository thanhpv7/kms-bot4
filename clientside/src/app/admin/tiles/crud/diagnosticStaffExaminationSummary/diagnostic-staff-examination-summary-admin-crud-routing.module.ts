...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminDiagnosticStaffExaminationSummaryCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminDiagnosticStaffExaminationSummaryCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminDiagnosticStaffExaminationSummaryCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminDiagnosticStaffExaminationSummaryCrudRoutingModule {
}
