 ...
 */
@Component({
	selector: 'cb-diagnostic-staff-examination-summary-admin-crud',
	templateUrl: './diagnostic-staff-examination-summary-admin-crud.component.html',
	styleUrls: [
		'./diagnostic-staff-examination-summary-admin-crud.component.scss',
...
export class AdminDiagnosticStaffExaminationSummaryCrudComponent implements OnDestroy {
