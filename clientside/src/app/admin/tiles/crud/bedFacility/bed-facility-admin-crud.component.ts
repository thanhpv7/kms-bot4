 ...
 */
@Component({
	selector: 'cb-bed-facility-admin-crud',
	templateUrl: './bed-facility-admin-crud.component.html',
	styleUrls: [
		'./bed-facility-admin-crud.component.scss',
...
export class AdminBedFacilityCrudComponent implements OnDestroy {
