...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBedFacilityCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBedFacilityCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBedFacilityCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBedFacilityCrudRoutingModule {
}
