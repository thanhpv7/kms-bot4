...
@Component({
	selector: 'cb-bed-facility-admin-crud-edit',
	templateUrl: './bed-facility-admin-crud-edit.component.html',
	styleUrls: [
		'./bed-facility-admin-crud-edit.component.scss',
...
export class AdminBedFacilityCrudEditComponent
