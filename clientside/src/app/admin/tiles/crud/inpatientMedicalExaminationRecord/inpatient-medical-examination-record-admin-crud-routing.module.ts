...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminInpatientMedicalExaminationRecordCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminInpatientMedicalExaminationRecordCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminInpatientMedicalExaminationRecordCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminInpatientMedicalExaminationRecordCrudRoutingModule {
}
