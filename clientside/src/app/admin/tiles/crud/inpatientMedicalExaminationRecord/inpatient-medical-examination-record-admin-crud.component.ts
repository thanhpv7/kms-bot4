 ...
 */
@Component({
	selector: 'cb-inpatient-medical-examination-record-admin-crud',
	templateUrl: './inpatient-medical-examination-record-admin-crud.component.html',
	styleUrls: [
		'./inpatient-medical-examination-record-admin-crud.component.scss',
...
export class AdminInpatientMedicalExaminationRecordCrudComponent implements OnDestroy {
