...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminLibraryCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminLibraryCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminLibraryCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminLibraryCrudRoutingModule {
}
