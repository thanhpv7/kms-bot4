 ...
 */
@Component({
	selector: 'cb-library-admin-crud',
	templateUrl: './library-admin-crud.component.html',
	styleUrls: [
		'./library-admin-crud.component.scss',
...
export class AdminLibraryCrudComponent implements OnDestroy {
