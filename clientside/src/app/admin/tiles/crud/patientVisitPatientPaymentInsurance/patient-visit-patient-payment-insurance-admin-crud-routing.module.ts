...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminPatientVisitPatientPaymentInsuranceCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminPatientVisitPatientPaymentInsuranceCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminPatientVisitPatientPaymentInsuranceCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminPatientVisitPatientPaymentInsuranceCrudRoutingModule {
}
