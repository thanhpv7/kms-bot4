 ...
 */
@Component({
	selector: 'cb-patient-visit-patient-payment-insurance-admin-crud',
	templateUrl: './patient-visit-patient-payment-insurance-admin-crud.component.html',
	styleUrls: [
		'./patient-visit-patient-payment-insurance-admin-crud.component.scss',
...
export class AdminPatientVisitPatientPaymentInsuranceCrudComponent implements OnDestroy {
