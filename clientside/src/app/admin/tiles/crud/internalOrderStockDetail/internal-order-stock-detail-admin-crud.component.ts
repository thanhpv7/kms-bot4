 ...
 */
@Component({
	selector: 'cb-internal-order-stock-detail-admin-crud',
	templateUrl: './internal-order-stock-detail-admin-crud.component.html',
	styleUrls: [
		'./internal-order-stock-detail-admin-crud.component.scss',
...
export class AdminInternalOrderStockDetailCrudComponent implements OnDestroy {
