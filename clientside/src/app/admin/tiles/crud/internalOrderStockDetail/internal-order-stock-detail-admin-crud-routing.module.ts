...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminInternalOrderStockDetailCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminInternalOrderStockDetailCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminInternalOrderStockDetailCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminInternalOrderStockDetailCrudRoutingModule {
}
