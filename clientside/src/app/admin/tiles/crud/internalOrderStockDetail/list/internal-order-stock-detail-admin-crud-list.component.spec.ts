...
import {AdminInternalOrderStockDetailCrudListComponent} from './internal-order-stock-detail-admin-crud-list.component';
...
import {AdminInternalOrderStockDetailCrudModule} from '../internal-order-stock-detail-admin-crud.module';
import {
...
describe('Internal Order Stock Detail Crud List Tile Component', () => {
	...
	let fixture;
	let internalOrderStockDetailCrudListComponent: AdminInternalOrderStockDetailCrudListComponent;
	...
	const routerState: RouterState = {
		url: 'internal-order-stock-detail-admin-crud',
		urls: ['internal-order-stock-detail-admin-crud'],
		params: {},
		queryParams: {},
		data: {},
	};
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			imports: [
				...
				AdminInternalOrderStockDetailCrudModule,
			],
			providers: [
				provideMockStore(),
				{
			...
			fixture = TestBed.createComponent(AdminInternalOrderStockDetailCrudListComponent);
