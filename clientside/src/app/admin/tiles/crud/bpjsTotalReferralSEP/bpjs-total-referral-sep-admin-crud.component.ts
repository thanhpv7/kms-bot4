 ...
 */
@Component({
	selector: 'cb-bpjs-total-referral-sep-admin-crud',
	templateUrl: './bpjs-total-referral-sep-admin-crud.component.html',
	styleUrls: [
		'./bpjs-total-referral-sep-admin-crud.component.scss',
...
export class AdminBpjsTotalReferralSEPCrudComponent implements OnDestroy {
