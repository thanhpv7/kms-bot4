...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBpjsTotalReferralSEPCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBpjsTotalReferralSEPCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBpjsTotalReferralSEPCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBpjsTotalReferralSEPCrudRoutingModule {
}
