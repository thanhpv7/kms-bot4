 ...
 */
@Component({
	selector: 'cb-bpjs-pcare-riwayat-kunjungan-admin-crud',
	templateUrl: './bpjs-pcare-riwayat-kunjungan-admin-crud.component.html',
	styleUrls: [
		'./bpjs-pcare-riwayat-kunjungan-admin-crud.component.scss',
...
export class AdminBpjsPcareRiwayatKunjunganCrudComponent implements OnDestroy {
