 ...
 */
@Component({
	selector: 'cb-return-supplier-admin-crud',
	templateUrl: './return-supplier-admin-crud.component.html',
	styleUrls: [
		'./return-supplier-admin-crud.component.scss',
...
export class AdminReturnSupplierCrudComponent implements OnDestroy {
