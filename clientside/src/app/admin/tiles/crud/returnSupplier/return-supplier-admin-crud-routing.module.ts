...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminReturnSupplierCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminReturnSupplierCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminReturnSupplierCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminReturnSupplierCrudRoutingModule {
}
