 ...
 */
@Component({
	selector: 'cb-bpjs-pcare-poli-admin-crud',
	templateUrl: './bpjs-pcare-poli-admin-crud.component.html',
	styleUrls: [
		'./bpjs-pcare-poli-admin-crud.component.scss',
...
export class AdminBpjsPcarePoliCrudComponent implements OnDestroy {
