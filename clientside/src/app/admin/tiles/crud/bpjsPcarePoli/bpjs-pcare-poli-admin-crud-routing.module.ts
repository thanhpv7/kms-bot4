...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBpjsPcarePoliCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBpjsPcarePoliCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBpjsPcarePoliCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBpjsPcarePoliCrudRoutingModule {
}
