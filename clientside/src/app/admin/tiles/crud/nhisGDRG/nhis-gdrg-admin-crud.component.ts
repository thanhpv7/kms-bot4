 ...
 */
@Component({
	selector: 'cb-nhis-gdrg-admin-crud',
	templateUrl: './nhis-gdrg-admin-crud.component.html',
	styleUrls: [
		'./nhis-gdrg-admin-crud.component.scss',
...
export class AdminNhisGDRGCrudComponent implements OnDestroy {
