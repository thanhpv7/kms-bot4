...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminNhisGDRGCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminNhisGDRGCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminNhisGDRGCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminNhisGDRGCrudRoutingModule {
}
