 ...
 */
@Component({
	selector: 'cb-pcare-mcu-admin-crud',
	templateUrl: './pcare-mcu-admin-crud.component.html',
	styleUrls: [
		'./pcare-mcu-admin-crud.component.scss',
...
export class AdminPcareMCUCrudComponent implements OnDestroy {
