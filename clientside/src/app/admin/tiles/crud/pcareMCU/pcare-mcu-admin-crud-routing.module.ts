...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminPcareMCUCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminPcareMCUCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminPcareMCUCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminPcareMCUCrudRoutingModule {
}
