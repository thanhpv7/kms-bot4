...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminCashReceiptCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminCashReceiptCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminCashReceiptCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminCashReceiptCrudRoutingModule {
}
