 ...
 */
@Component({
	selector: 'cb-cash-receipt-admin-crud',
	templateUrl: './cash-receipt-admin-crud.component.html',
	styleUrls: [
		'./cash-receipt-admin-crud.component.scss',
...
export class AdminCashReceiptCrudComponent implements OnDestroy {
