...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminCoTreatingDoctorCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminCoTreatingDoctorCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminCoTreatingDoctorCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminCoTreatingDoctorCrudRoutingModule {
}
