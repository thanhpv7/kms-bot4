 ...
 */
@Component({
	selector: 'cb-co-treating-doctor-admin-crud',
	templateUrl: './co-treating-doctor-admin-crud.component.html',
	styleUrls: [
		'./co-treating-doctor-admin-crud.component.scss',
...
export class AdminCoTreatingDoctorCrudComponent implements OnDestroy {
