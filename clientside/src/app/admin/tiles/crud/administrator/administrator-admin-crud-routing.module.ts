...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminAdministratorCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminAdministratorCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminAdministratorCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminAdministratorCrudRoutingModule {
}
