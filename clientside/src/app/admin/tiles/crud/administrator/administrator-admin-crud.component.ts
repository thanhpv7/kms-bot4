 ...
 */
@Component({
	selector: 'cb-administrator-admin-crud',
	templateUrl: './administrator-admin-crud.component.html',
	styleUrls: [
		'./administrator-admin-crud.component.scss',
...
export class AdminAdministratorCrudComponent implements OnDestroy {
