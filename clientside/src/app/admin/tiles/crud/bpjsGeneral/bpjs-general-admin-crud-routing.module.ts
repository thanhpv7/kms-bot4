...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBpjsGeneralCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBpjsGeneralCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBpjsGeneralCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBpjsGeneralCrudRoutingModule {
}
