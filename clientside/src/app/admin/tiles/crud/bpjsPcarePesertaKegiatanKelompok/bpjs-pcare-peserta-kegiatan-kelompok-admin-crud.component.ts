 ...
 */
@Component({
	selector: 'cb-bpjs-pcare-peserta-kegiatan-kelompok-admin-crud',
	templateUrl: './bpjs-pcare-peserta-kegiatan-kelompok-admin-crud.component.html',
	styleUrls: [
		'./bpjs-pcare-peserta-kegiatan-kelompok-admin-crud.component.scss',
...
export class AdminBpjsPcarePesertaKegiatanKelompokCrudComponent implements OnDestroy {
