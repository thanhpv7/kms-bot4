...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBpjsPcarePesertaKegiatanKelompokCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBpjsPcarePesertaKegiatanKelompokCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBpjsPcarePesertaKegiatanKelompokCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBpjsPcarePesertaKegiatanKelompokCrudRoutingModule {
}
