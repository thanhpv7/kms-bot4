...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminNumberingSetupCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminNumberingSetupCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminNumberingSetupCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminNumberingSetupCrudRoutingModule {
}
