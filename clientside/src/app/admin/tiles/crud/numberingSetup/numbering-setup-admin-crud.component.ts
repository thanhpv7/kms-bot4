 ...
 */
@Component({
	selector: 'cb-numbering-setup-admin-crud',
	templateUrl: './numbering-setup-admin-crud.component.html',
	styleUrls: [
		'./numbering-setup-admin-crud.component.scss',
...
export class AdminNumberingSetupCrudComponent implements OnDestroy {
