...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminTariffFormulaCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminTariffFormulaCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminTariffFormulaCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminTariffFormulaCrudRoutingModule {
}
