 ...
 */
@Component({
	selector: 'cb-purchase-requisition-admin-crud',
	templateUrl: './purchase-requisition-admin-crud.component.html',
	styleUrls: [
		'./purchase-requisition-admin-crud.component.scss',
...
export class AdminPurchaseRequisitionCrudComponent implements OnDestroy {
