...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminPurchaseRequisitionCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminPurchaseRequisitionCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminPurchaseRequisitionCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminPurchaseRequisitionCrudRoutingModule {
}
