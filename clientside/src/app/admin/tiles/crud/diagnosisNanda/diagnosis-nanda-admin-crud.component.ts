 ...
 */
@Component({
	selector: 'cb-diagnosis-nanda-admin-crud',
	templateUrl: './diagnosis-nanda-admin-crud.component.html',
	styleUrls: [
		'./diagnosis-nanda-admin-crud.component.scss',
...
export class AdminDiagnosisNandaCrudComponent implements OnDestroy {
