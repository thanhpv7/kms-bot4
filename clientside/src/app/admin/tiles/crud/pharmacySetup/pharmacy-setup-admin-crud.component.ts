 ...
 */
@Component({
	selector: 'cb-pharmacy-setup-admin-crud',
	templateUrl: './pharmacy-setup-admin-crud.component.html',
	styleUrls: [
		'./pharmacy-setup-admin-crud.component.scss',
...
export class AdminPharmacySetupCrudComponent implements OnDestroy {
