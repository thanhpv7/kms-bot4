...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminPharmacySetupCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminPharmacySetupCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminPharmacySetupCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminPharmacySetupCrudRoutingModule {
}
