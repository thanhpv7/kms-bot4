...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminTransferOrderStockDetailCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminTransferOrderStockDetailCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminTransferOrderStockDetailCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminTransferOrderStockDetailCrudRoutingModule {
}
