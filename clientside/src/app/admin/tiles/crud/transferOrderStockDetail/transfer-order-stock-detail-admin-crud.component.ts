 ...
 */
@Component({
	selector: 'cb-transfer-order-stock-detail-admin-crud',
	templateUrl: './transfer-order-stock-detail-admin-crud.component.html',
	styleUrls: [
		'./transfer-order-stock-detail-admin-crud.component.scss',
...
export class AdminTransferOrderStockDetailCrudComponent implements OnDestroy {
