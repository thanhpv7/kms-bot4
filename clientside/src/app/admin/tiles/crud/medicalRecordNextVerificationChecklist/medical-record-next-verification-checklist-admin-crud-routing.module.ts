...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminMedicalRecordNextVerificationChecklistCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminMedicalRecordNextVerificationChecklistCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminMedicalRecordNextVerificationChecklistCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminMedicalRecordNextVerificationChecklistCrudRoutingModule {
}
