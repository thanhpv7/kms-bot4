 ...
 */
@Component({
	selector: 'cb-medical-record-next-verification-checklist-admin-crud',
	templateUrl: './medical-record-next-verification-checklist-admin-crud.component.html',
	styleUrls: [
		'./medical-record-next-verification-checklist-admin-crud.component.scss',
...
export class AdminMedicalRecordNextVerificationChecklistCrudComponent implements OnDestroy {
