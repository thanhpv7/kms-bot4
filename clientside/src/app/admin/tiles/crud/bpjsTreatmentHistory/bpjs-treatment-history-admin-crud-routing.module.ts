...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBpjsTreatmentHistoryCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBpjsTreatmentHistoryCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBpjsTreatmentHistoryCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBpjsTreatmentHistoryCrudRoutingModule {
}
