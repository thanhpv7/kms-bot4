 ...
 */
@Component({
	selector: 'cb-bpjs-treatment-history-admin-crud',
	templateUrl: './bpjs-treatment-history-admin-crud.component.html',
	styleUrls: [
		'./bpjs-treatment-history-admin-crud.component.scss',
...
export class AdminBpjsTreatmentHistoryCrudComponent implements OnDestroy {
