...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminPcareUmumCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminPcareUmumCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminPcareUmumCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminPcareUmumCrudRoutingModule {
}
