 ...
 */
@Component({
	selector: 'cb-pcare-umum-admin-crud',
	templateUrl: './pcare-umum-admin-crud.component.html',
	styleUrls: [
		'./pcare-umum-admin-crud.component.scss',
...
export class AdminPcareUmumCrudComponent implements OnDestroy {
