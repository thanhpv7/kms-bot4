 ...
 */
@Component({
	selector: 'cb-bpjs-pcare-provider-rayonisasi-admin-crud',
	templateUrl: './bpjs-pcare-provider-rayonisasi-admin-crud.component.html',
	styleUrls: [
		'./bpjs-pcare-provider-rayonisasi-admin-crud.component.scss',
...
export class AdminBpjsPcareProviderRayonisasiCrudComponent implements OnDestroy {
