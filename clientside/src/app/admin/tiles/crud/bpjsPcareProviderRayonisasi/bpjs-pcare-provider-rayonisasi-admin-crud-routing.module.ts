...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBpjsPcareProviderRayonisasiCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBpjsPcareProviderRayonisasiCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBpjsPcareProviderRayonisasiCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBpjsPcareProviderRayonisasiCrudRoutingModule {
}
