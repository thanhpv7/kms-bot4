 ...
 */
@Component({
	selector: 'cb-hemodialysis-examination-admin-crud',
	templateUrl: './hemodialysis-examination-admin-crud.component.html',
	styleUrls: [
		'./hemodialysis-examination-admin-crud.component.scss',
...
export class AdminHemodialysisExaminationCrudComponent implements OnDestroy {
