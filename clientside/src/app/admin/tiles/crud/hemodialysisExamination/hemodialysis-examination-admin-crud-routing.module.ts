...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminHemodialysisExaminationCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminHemodialysisExaminationCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminHemodialysisExaminationCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminHemodialysisExaminationCrudRoutingModule {
}
