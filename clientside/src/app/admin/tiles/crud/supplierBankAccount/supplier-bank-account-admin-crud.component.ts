 ...
 */
@Component({
	selector: 'cb-supplier-bank-account-admin-crud',
	templateUrl: './supplier-bank-account-admin-crud.component.html',
	styleUrls: [
		'./supplier-bank-account-admin-crud.component.scss',
...
export class AdminSupplierBankAccountCrudComponent implements OnDestroy {
