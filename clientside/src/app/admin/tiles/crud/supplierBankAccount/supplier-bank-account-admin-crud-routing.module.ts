...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminSupplierBankAccountCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminSupplierBankAccountCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminSupplierBankAccountCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminSupplierBankAccountCrudRoutingModule {
}
