 ...
 */
@Component({
	selector: 'cb-obstetric-and-gynecology-history-admin-crud',
	templateUrl: './obstetric-and-gynecology-history-admin-crud.component.html',
	styleUrls: [
		'./obstetric-and-gynecology-history-admin-crud.component.scss',
...
export class AdminObstetricAndGynecologyHistoryCrudComponent implements OnDestroy {
