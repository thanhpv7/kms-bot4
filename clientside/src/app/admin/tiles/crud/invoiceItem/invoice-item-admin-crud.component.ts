 ...
 */
@Component({
	selector: 'cb-invoice-item-admin-crud',
	templateUrl: './invoice-item-admin-crud.component.html',
	styleUrls: [
		'./invoice-item-admin-crud.component.scss',
...
export class AdminInvoiceItemCrudComponent implements OnDestroy {
