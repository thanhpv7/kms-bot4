...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminInvoiceItemCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminInvoiceItemCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminInvoiceItemCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminInvoiceItemCrudRoutingModule {
}
