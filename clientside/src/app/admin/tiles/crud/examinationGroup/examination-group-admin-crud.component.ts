 ...
 */
@Component({
	selector: 'cb-examination-group-admin-crud',
	templateUrl: './examination-group-admin-crud.component.html',
	styleUrls: [
		'./examination-group-admin-crud.component.scss',
...
export class AdminExaminationGroupCrudComponent implements OnDestroy {
