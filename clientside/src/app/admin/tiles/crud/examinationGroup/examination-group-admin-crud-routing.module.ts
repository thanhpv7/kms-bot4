...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminExaminationGroupCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminExaminationGroupCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminExaminationGroupCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminExaminationGroupCrudRoutingModule {
}
