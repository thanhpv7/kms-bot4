...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminMedicalCertificatePhysicalHealthCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminMedicalCertificatePhysicalHealthCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminMedicalCertificatePhysicalHealthCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminMedicalCertificatePhysicalHealthCrudRoutingModule {
}
