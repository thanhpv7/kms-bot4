 ...
 */
@Component({
	selector: 'cb-medical-certificate-physical-health-admin-crud',
	templateUrl: './medical-certificate-physical-health-admin-crud.component.html',
	styleUrls: [
		'./medical-certificate-physical-health-admin-crud.component.scss',
...
export class AdminMedicalCertificatePhysicalHealthCrudComponent implements OnDestroy {
