...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminFluidBalanceDetailCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminFluidBalanceDetailCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminFluidBalanceDetailCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminFluidBalanceDetailCrudRoutingModule {
}
