 ...
 */
@Component({
	selector: 'cb-fluid-balance-detail-admin-crud',
	templateUrl: './fluid-balance-detail-admin-crud.component.html',
	styleUrls: [
		'./fluid-balance-detail-admin-crud.component.scss',
...
export class AdminFluidBalanceDetailCrudComponent implements OnDestroy {
