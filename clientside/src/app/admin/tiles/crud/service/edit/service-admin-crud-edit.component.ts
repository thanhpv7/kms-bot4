...
@Component({
	selector: 'cb-service-admin-crud-edit',
	templateUrl: './service-admin-crud-edit.component.html',
	styleUrls: [
		'./service-admin-crud-edit.component.scss',
...
export class AdminServiceCrudEditComponent
