 ...
 */
@Component({
	selector: 'cb-service-admin-crud',
	templateUrl: './service-admin-crud.component.html',
	styleUrls: [
		'./service-admin-crud.component.scss',
...
export class AdminServiceCrudComponent implements OnDestroy {
