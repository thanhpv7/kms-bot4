...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminServiceCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminServiceCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminServiceCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminServiceCrudRoutingModule {
}
