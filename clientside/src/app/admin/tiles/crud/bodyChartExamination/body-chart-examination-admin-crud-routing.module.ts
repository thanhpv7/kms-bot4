...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBodyChartExaminationCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBodyChartExaminationCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBodyChartExaminationCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBodyChartExaminationCrudRoutingModule {
}
