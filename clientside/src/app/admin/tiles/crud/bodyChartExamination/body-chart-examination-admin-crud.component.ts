 ...
 */
@Component({
	selector: 'cb-body-chart-examination-admin-crud',
	templateUrl: './body-chart-examination-admin-crud.component.html',
	styleUrls: [
		'./body-chart-examination-admin-crud.component.scss',
...
export class AdminBodyChartExaminationCrudComponent implements OnDestroy {
