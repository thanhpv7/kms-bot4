...
import {AdminBpjsPcareKunjunganRujukanCrudListComponent} from './bpjs-pcare-kunjungan-rujukan-admin-crud-list.component';
...
import {AdminBpjsPcareKunjunganRujukanCrudModule} from '../bpjs-pcare-kunjungan-rujukan-admin-crud.module';
import {
...
describe('Bpjs Pcare Kunjungan Rujukan Crud List Tile Component', () => {
	...
	let fixture;
	let bpjsPcareKunjunganRujukanCrudListComponent: AdminBpjsPcareKunjunganRujukanCrudListComponent;
	...
	const routerState: RouterState = {
		url: 'bpjs-pcare-kunjungan-rujukan-admin-crud',
		urls: ['bpjs-pcare-kunjungan-rujukan-admin-crud'],
		params: {},
		queryParams: {},
		data: {},
	};
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			imports: [
				...
				AdminBpjsPcareKunjunganRujukanCrudModule,
			],
			providers: [
				provideMockStore(),
				{
			...
			fixture = TestBed.createComponent(AdminBpjsPcareKunjunganRujukanCrudListComponent);
