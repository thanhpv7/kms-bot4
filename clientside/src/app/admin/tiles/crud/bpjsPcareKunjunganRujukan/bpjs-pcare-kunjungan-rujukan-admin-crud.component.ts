 ...
 */
@Component({
	selector: 'cb-bpjs-pcare-kunjungan-rujukan-admin-crud',
	templateUrl: './bpjs-pcare-kunjungan-rujukan-admin-crud.component.html',
	styleUrls: [
		'./bpjs-pcare-kunjungan-rujukan-admin-crud.component.scss',
...
export class AdminBpjsPcareKunjunganRujukanCrudComponent implements OnDestroy {
