...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminMedicalCertificateMedicalAttendanceCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminMedicalCertificateMedicalAttendanceCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminMedicalCertificateMedicalAttendanceCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminMedicalCertificateMedicalAttendanceCrudRoutingModule {
}
