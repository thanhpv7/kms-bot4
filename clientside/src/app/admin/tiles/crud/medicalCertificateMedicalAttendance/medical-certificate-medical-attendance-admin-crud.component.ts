 ...
 */
@Component({
	selector: 'cb-medical-certificate-medical-attendance-admin-crud',
	templateUrl: './medical-certificate-medical-attendance-admin-crud.component.html',
	styleUrls: [
		'./medical-certificate-medical-attendance-admin-crud.component.scss',
...
export class AdminMedicalCertificateMedicalAttendanceCrudComponent implements OnDestroy {
