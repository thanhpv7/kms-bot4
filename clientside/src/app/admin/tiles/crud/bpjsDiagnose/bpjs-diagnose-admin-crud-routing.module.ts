...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBpjsDiagnoseCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBpjsDiagnoseCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBpjsDiagnoseCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBpjsDiagnoseCrudRoutingModule {
}
