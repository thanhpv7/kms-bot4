 ...
 */
@Component({
	selector: 'cb-bpjs-diagnose-admin-crud',
	templateUrl: './bpjs-diagnose-admin-crud.component.html',
	styleUrls: [
		'./bpjs-diagnose-admin-crud.component.scss',
...
export class AdminBpjsDiagnoseCrudComponent implements OnDestroy {
