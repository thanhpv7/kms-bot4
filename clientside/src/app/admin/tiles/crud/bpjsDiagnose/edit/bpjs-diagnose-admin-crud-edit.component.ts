...
@Component({
	selector: 'cb-bpjs-diagnose-admin-crud-edit',
	templateUrl: './bpjs-diagnose-admin-crud-edit.component.html',
	styleUrls: [
		'./bpjs-diagnose-admin-crud-edit.component.scss',
...
export class AdminBpjsDiagnoseCrudEditComponent
