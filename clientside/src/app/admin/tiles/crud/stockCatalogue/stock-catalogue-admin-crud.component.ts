 ...
 */
@Component({
	selector: 'cb-stock-catalogue-admin-crud',
	templateUrl: './stock-catalogue-admin-crud.component.html',
	styleUrls: [
		'./stock-catalogue-admin-crud.component.scss',
...
export class AdminStockCatalogueCrudComponent implements OnDestroy {
