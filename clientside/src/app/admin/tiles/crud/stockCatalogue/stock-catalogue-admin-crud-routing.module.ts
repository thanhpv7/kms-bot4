...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminStockCatalogueCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminStockCatalogueCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminStockCatalogueCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminStockCatalogueCrudRoutingModule {
}
