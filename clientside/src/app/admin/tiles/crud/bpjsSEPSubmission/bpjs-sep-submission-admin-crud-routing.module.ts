...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBpjsSEPSubmissionCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBpjsSEPSubmissionCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBpjsSEPSubmissionCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBpjsSEPSubmissionCrudRoutingModule {
}
