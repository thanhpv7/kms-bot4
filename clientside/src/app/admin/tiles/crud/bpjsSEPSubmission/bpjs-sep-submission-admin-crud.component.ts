 ...
 */
@Component({
	selector: 'cb-bpjs-sep-submission-admin-crud',
	templateUrl: './bpjs-sep-submission-admin-crud.component.html',
	styleUrls: [
		'./bpjs-sep-submission-admin-crud.component.scss',
...
export class AdminBpjsSEPSubmissionCrudComponent implements OnDestroy {
