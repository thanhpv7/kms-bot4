...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminPatientPaymentInsuranceCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminPatientPaymentInsuranceCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminPatientPaymentInsuranceCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminPatientPaymentInsuranceCrudRoutingModule {
}
