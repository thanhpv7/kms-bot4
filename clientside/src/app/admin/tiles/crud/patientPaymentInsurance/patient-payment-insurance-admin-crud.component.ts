 ...
 */
@Component({
	selector: 'cb-patient-payment-insurance-admin-crud',
	templateUrl: './patient-payment-insurance-admin-crud.component.html',
	styleUrls: [
		'./patient-payment-insurance-admin-crud.component.scss',
...
export class AdminPatientPaymentInsuranceCrudComponent implements OnDestroy {
