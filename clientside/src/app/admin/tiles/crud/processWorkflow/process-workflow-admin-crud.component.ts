 ...
 */
@Component({
	selector: 'cb-process-workflow-admin-crud',
	templateUrl: './process-workflow-admin-crud.component.html',
	styleUrls: [
		'./process-workflow-admin-crud.component.scss',
...
export class AdminProcessWorkflowCrudComponent implements OnDestroy {
