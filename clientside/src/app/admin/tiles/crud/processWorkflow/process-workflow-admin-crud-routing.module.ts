...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminProcessWorkflowCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminProcessWorkflowCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminProcessWorkflowCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminProcessWorkflowCrudRoutingModule {
}
