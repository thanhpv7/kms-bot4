...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminGoodsReceiveNoteCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminGoodsReceiveNoteCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminGoodsReceiveNoteCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminGoodsReceiveNoteCrudRoutingModule {
}
