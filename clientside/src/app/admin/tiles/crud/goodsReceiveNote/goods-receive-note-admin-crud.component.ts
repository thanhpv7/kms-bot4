 ...
 */
@Component({
	selector: 'cb-goods-receive-note-admin-crud',
	templateUrl: './goods-receive-note-admin-crud.component.html',
	styleUrls: [
		'./goods-receive-note-admin-crud.component.scss',
...
export class AdminGoodsReceiveNoteCrudComponent implements OnDestroy {
