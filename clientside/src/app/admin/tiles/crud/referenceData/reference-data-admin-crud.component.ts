 ...
 */
@Component({
	selector: 'cb-reference-data-admin-crud',
	templateUrl: './reference-data-admin-crud.component.html',
	styleUrls: [
		'./reference-data-admin-crud.component.scss',
...
export class AdminReferenceDataCrudComponent implements OnDestroy {
