...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminReferenceDataCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminReferenceDataCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminReferenceDataCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminReferenceDataCrudRoutingModule {
}
