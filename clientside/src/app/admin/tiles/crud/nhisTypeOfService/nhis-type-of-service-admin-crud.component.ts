 ...
 */
@Component({
	selector: 'cb-nhis-type-of-service-admin-crud',
	templateUrl: './nhis-type-of-service-admin-crud.component.html',
	styleUrls: [
		'./nhis-type-of-service-admin-crud.component.scss',
...
export class AdminNhisTypeOfServiceCrudComponent implements OnDestroy {
