...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminNhisTypeOfServiceCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminNhisTypeOfServiceCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminNhisTypeOfServiceCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminNhisTypeOfServiceCrudRoutingModule {
}
