 ...
 */
@Component({
	selector: 'cb-medical-certificate-discharge-resume-admin-crud',
	templateUrl: './medical-certificate-discharge-resume-admin-crud.component.html',
	styleUrls: [
		'./medical-certificate-discharge-resume-admin-crud.component.scss',
...
export class AdminMedicalCertificateDischargeResumeCrudComponent implements OnDestroy {
