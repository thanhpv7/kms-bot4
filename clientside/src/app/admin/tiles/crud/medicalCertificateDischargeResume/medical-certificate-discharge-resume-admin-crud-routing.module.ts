...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminMedicalCertificateDischargeResumeCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminMedicalCertificateDischargeResumeCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminMedicalCertificateDischargeResumeCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminMedicalCertificateDischargeResumeCrudRoutingModule {
}
