...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminTransactionDetailTypeMappingCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminTransactionDetailTypeMappingCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminTransactionDetailTypeMappingCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminTransactionDetailTypeMappingCrudRoutingModule {
}
