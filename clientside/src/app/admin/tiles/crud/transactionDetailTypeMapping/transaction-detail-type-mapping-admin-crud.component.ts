 ...
 */
@Component({
	selector: 'cb-transaction-detail-type-mapping-admin-crud',
	templateUrl: './transaction-detail-type-mapping-admin-crud.component.html',
	styleUrls: [
		'./transaction-detail-type-mapping-admin-crud.component.scss',
...
export class AdminTransactionDetailTypeMappingCrudComponent implements OnDestroy {
