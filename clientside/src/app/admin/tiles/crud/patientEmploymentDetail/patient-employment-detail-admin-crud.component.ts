 ...
 */
@Component({
	selector: 'cb-patient-employment-detail-admin-crud',
	templateUrl: './patient-employment-detail-admin-crud.component.html',
	styleUrls: [
		'./patient-employment-detail-admin-crud.component.scss',
...
export class AdminPatientEmploymentDetailCrudComponent implements OnDestroy {
