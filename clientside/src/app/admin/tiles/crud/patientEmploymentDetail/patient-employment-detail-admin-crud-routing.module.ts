...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminPatientEmploymentDetailCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminPatientEmploymentDetailCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminPatientEmploymentDetailCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminPatientEmploymentDetailCrudRoutingModule {
}
