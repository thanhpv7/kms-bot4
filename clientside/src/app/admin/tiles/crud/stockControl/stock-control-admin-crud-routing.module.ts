...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminStockControlCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminStockControlCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminStockControlCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminStockControlCrudRoutingModule {
}
