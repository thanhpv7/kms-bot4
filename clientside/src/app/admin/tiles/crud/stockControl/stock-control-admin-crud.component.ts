 ...
 */
@Component({
	selector: 'cb-stock-control-admin-crud',
	templateUrl: './stock-control-admin-crud.component.html',
	styleUrls: [
		'./stock-control-admin-crud.component.scss',
...
export class AdminStockControlCrudComponent implements OnDestroy {
