...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminNhisSpecialtyAttendedCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminNhisSpecialtyAttendedCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminNhisSpecialtyAttendedCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminNhisSpecialtyAttendedCrudRoutingModule {
}
