 ...
 */
@Component({
	selector: 'cb-nhis-specialty-attended-admin-crud',
	templateUrl: './nhis-specialty-attended-admin-crud.component.html',
	styleUrls: [
		'./nhis-specialty-attended-admin-crud.component.scss',
...
export class AdminNhisSpecialtyAttendedCrudComponent implements OnDestroy {
