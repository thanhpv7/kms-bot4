...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminPatientPaymentBPJSCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminPatientPaymentBPJSCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminPatientPaymentBPJSCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminPatientPaymentBPJSCrudRoutingModule {
}
