 ...
 */
@Component({
	selector: 'cb-patient-payment-bpjs-admin-crud',
	templateUrl: './patient-payment-bpjs-admin-crud.component.html',
	styleUrls: [
		'./patient-payment-bpjs-admin-crud.component.scss',
...
export class AdminPatientPaymentBPJSCrudComponent implements OnDestroy {
