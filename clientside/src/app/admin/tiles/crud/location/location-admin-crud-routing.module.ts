...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminLocationCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminLocationCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminLocationCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminLocationCrudRoutingModule {
}
