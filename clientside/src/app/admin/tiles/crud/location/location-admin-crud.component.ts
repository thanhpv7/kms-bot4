 ...
 */
@Component({
	selector: 'cb-location-admin-crud',
	templateUrl: './location-admin-crud.component.html',
	styleUrls: [
		'./location-admin-crud.component.scss',
...
export class AdminLocationCrudComponent implements OnDestroy {
