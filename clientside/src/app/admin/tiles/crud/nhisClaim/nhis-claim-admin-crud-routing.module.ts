...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminNhisClaimCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminNhisClaimCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminNhisClaimCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminNhisClaimCrudRoutingModule {
}
