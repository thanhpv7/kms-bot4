 ...
 */
@Component({
	selector: 'cb-nhis-claim-admin-crud',
	templateUrl: './nhis-claim-admin-crud.component.html',
	styleUrls: [
		'./nhis-claim-admin-crud.component.scss',
...
export class AdminNhisClaimCrudComponent implements OnDestroy {
