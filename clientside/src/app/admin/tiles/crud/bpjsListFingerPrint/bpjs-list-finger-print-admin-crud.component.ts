 ...
 */
@Component({
	selector: 'cb-bpjs-list-finger-print-admin-crud',
	templateUrl: './bpjs-list-finger-print-admin-crud.component.html',
	styleUrls: [
		'./bpjs-list-finger-print-admin-crud.component.scss',
...
export class AdminBpjsListFingerPrintCrudComponent implements OnDestroy {
