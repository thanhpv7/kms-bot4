...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBpjsListFingerPrintCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBpjsListFingerPrintCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBpjsListFingerPrintCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBpjsListFingerPrintCrudRoutingModule {
}
