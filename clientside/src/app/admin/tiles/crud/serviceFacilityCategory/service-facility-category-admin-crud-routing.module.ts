...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminServiceFacilityCategoryCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminServiceFacilityCategoryCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminServiceFacilityCategoryCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminServiceFacilityCategoryCrudRoutingModule {
}
