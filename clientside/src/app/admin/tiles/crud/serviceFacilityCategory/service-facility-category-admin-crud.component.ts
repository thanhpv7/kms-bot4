 ...
 */
@Component({
	selector: 'cb-service-facility-category-admin-crud',
	templateUrl: './service-facility-category-admin-crud.component.html',
	styleUrls: [
		'./service-facility-category-admin-crud.component.scss',
...
export class AdminServiceFacilityCategoryCrudComponent implements OnDestroy {
