 ...
 */
@Component({
	selector: 'cb-inventory-adjusment-batch-admin-crud',
	templateUrl: './inventory-adjusment-batch-admin-crud.component.html',
	styleUrls: [
		'./inventory-adjusment-batch-admin-crud.component.scss',
...
export class AdminInventoryAdjusmentBatchCrudComponent implements OnDestroy {
