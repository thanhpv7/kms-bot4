...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminInventoryAdjusmentBatchCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminInventoryAdjusmentBatchCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminInventoryAdjusmentBatchCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminInventoryAdjusmentBatchCrudRoutingModule {
}
