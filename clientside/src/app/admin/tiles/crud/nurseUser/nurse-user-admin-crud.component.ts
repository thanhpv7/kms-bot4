 ...
 */
@Component({
	selector: 'cb-nurse-user-admin-crud',
	templateUrl: './nurse-user-admin-crud.component.html',
	styleUrls: [
		'./nurse-user-admin-crud.component.scss',
...
export class AdminNurseUserCrudComponent implements OnDestroy {
