...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminNurseUserCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminNurseUserCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminNurseUserCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminNurseUserCrudRoutingModule {
}
