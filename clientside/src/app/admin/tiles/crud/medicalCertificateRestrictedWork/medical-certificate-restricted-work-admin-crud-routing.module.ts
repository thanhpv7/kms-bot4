...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminMedicalCertificateRestrictedWorkCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminMedicalCertificateRestrictedWorkCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminMedicalCertificateRestrictedWorkCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminMedicalCertificateRestrictedWorkCrudRoutingModule {
}
