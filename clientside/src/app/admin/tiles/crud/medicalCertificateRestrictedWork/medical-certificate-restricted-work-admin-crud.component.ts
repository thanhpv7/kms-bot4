 ...
 */
@Component({
	selector: 'cb-medical-certificate-restricted-work-admin-crud',
	templateUrl: './medical-certificate-restricted-work-admin-crud.component.html',
	styleUrls: [
		'./medical-certificate-restricted-work-admin-crud.component.scss',
...
export class AdminMedicalCertificateRestrictedWorkCrudComponent implements OnDestroy {
