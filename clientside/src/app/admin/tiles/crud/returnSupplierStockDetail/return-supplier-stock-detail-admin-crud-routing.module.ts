...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminReturnSupplierStockDetailCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminReturnSupplierStockDetailCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminReturnSupplierStockDetailCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminReturnSupplierStockDetailCrudRoutingModule {
}
