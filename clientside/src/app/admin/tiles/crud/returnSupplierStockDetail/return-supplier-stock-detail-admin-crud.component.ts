 ...
 */
@Component({
	selector: 'cb-return-supplier-stock-detail-admin-crud',
	templateUrl: './return-supplier-stock-detail-admin-crud.component.html',
	styleUrls: [
		'./return-supplier-stock-detail-admin-crud.component.scss',
...
export class AdminReturnSupplierStockDetailCrudComponent implements OnDestroy {
