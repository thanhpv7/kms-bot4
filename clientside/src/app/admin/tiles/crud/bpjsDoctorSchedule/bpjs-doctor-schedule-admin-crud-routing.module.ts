...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBpjsDoctorScheduleCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBpjsDoctorScheduleCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBpjsDoctorScheduleCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBpjsDoctorScheduleCrudRoutingModule {
}
