 ...
 */
@Component({
	selector: 'cb-bpjs-doctor-schedule-admin-crud',
	templateUrl: './bpjs-doctor-schedule-admin-crud.component.html',
	styleUrls: [
		'./bpjs-doctor-schedule-admin-crud.component.scss',
...
export class AdminBpjsDoctorScheduleCrudComponent implements OnDestroy {
