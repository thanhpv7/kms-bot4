...
@Component({
	selector: 'cb-room-facility-admin-crud-edit',
	templateUrl: './room-facility-admin-crud-edit.component.html',
	styleUrls: [
		'./room-facility-admin-crud-edit.component.scss',
...
export class AdminRoomFacilityCrudEditComponent
