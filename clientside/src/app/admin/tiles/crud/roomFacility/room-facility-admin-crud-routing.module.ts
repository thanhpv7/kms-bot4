...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminRoomFacilityCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminRoomFacilityCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminRoomFacilityCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminRoomFacilityCrudRoutingModule {
}
