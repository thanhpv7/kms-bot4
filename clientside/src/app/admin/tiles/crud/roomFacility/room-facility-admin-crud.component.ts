 ...
 */
@Component({
	selector: 'cb-room-facility-admin-crud',
	templateUrl: './room-facility-admin-crud.component.html',
	styleUrls: [
		'./room-facility-admin-crud.component.scss',
...
export class AdminRoomFacilityCrudComponent implements OnDestroy {
