...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminPatientPaymentSelfPayingCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminPatientPaymentSelfPayingCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminPatientPaymentSelfPayingCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminPatientPaymentSelfPayingCrudRoutingModule {
}
