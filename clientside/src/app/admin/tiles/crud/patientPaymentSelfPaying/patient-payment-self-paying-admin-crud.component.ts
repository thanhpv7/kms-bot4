 ...
 */
@Component({
	selector: 'cb-patient-payment-self-paying-admin-crud',
	templateUrl: './patient-payment-self-paying-admin-crud.component.html',
	styleUrls: [
		'./patient-payment-self-paying-admin-crud.component.scss',
...
export class AdminPatientPaymentSelfPayingCrudComponent implements OnDestroy {
