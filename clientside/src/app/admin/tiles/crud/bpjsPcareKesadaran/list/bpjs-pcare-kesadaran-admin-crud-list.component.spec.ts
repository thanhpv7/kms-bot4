...
import {AdminBpjsPcareKesadaranCrudListComponent} from './bpjs-pcare-kesadaran-admin-crud-list.component';
...
import {AdminBpjsPcareKesadaranCrudModule} from '../bpjs-pcare-kesadaran-admin-crud.module';
import {
...
describe('BPJS Pcare Kesadaran Crud List Tile Component', () => {
	...
	let fixture;
	let bpjsPcareKesadaranCrudListComponent: AdminBpjsPcareKesadaranCrudListComponent;
	...
	const routerState: RouterState = {
		url: 'bpjs-pcare-kesadaran-admin-crud',
		urls: ['bpjs-pcare-kesadaran-admin-crud'],
		params: {},
		queryParams: {},
		data: {},
	};
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			imports: [
				...
				AdminBpjsPcareKesadaranCrudModule,
			],
			providers: [
				provideMockStore(),
				{
			...
			fixture = TestBed.createComponent(AdminBpjsPcareKesadaranCrudListComponent);
