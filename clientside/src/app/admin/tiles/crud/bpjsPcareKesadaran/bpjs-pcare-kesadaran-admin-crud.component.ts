 ...
 */
@Component({
	selector: 'cb-bpjs-pcare-kesadaran-admin-crud',
	templateUrl: './bpjs-pcare-kesadaran-admin-crud.component.html',
	styleUrls: [
		'./bpjs-pcare-kesadaran-admin-crud.component.scss',
...
export class AdminBpjsPcareKesadaranCrudComponent implements OnDestroy {
