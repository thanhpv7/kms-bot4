 ...
 */
@Component({
	selector: 'cb-invoice-payment-other-admin-crud',
	templateUrl: './invoice-payment-other-admin-crud.component.html',
	styleUrls: [
		'./invoice-payment-other-admin-crud.component.scss',
...
export class AdminInvoicePaymentOtherCrudComponent implements OnDestroy {
