 ...
 */
@Component({
	selector: 'cb-medication-item-admin-crud',
	templateUrl: './medication-item-admin-crud.component.html',
	styleUrls: [
		'./medication-item-admin-crud.component.scss',
...
export class AdminMedicationItemCrudComponent implements OnDestroy {
