...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminMedicationItemCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminMedicationItemCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminMedicationItemCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminMedicationItemCrudRoutingModule {
}
