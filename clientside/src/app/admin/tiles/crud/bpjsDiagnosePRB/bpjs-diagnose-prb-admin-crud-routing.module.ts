...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBpjsDiagnosePRBCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBpjsDiagnosePRBCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBpjsDiagnosePRBCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBpjsDiagnosePRBCrudRoutingModule {
}
