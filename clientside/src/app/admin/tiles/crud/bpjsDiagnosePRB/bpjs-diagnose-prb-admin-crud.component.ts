 ...
 */
@Component({
	selector: 'cb-bpjs-diagnose-prb-admin-crud',
	templateUrl: './bpjs-diagnose-prb-admin-crud.component.html',
	styleUrls: [
		'./bpjs-diagnose-prb-admin-crud.component.scss',
...
export class AdminBpjsDiagnosePRBCrudComponent implements OnDestroy {
