...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminWarehouseCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminWarehouseCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminWarehouseCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminWarehouseCrudRoutingModule {
}
