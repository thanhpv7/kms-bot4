 ...
 */
@Component({
	selector: 'cb-warehouse-admin-crud',
	templateUrl: './warehouse-admin-crud.component.html',
	styleUrls: [
		'./warehouse-admin-crud.component.scss',
...
export class AdminWarehouseCrudComponent implements OnDestroy {
