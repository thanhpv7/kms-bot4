 ...
 */
@Component({
	selector: 'cb-claim-user-admin-crud',
	templateUrl: './claim-user-admin-crud.component.html',
	styleUrls: [
		'./claim-user-admin-crud.component.scss',
...
export class AdminClaimUserCrudComponent implements OnDestroy {
