...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminClaimUserCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminClaimUserCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminClaimUserCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminClaimUserCrudRoutingModule {
}
