 ...
 */
@Component({
	selector: 'cb-reference-header-admin-crud',
	templateUrl: './reference-header-admin-crud.component.html',
	styleUrls: [
		'./reference-header-admin-crud.component.scss',
...
export class AdminReferenceHeaderCrudComponent implements OnDestroy {
