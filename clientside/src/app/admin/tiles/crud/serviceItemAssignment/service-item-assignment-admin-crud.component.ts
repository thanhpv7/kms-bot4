 ...
 */
@Component({
	selector: 'cb-service-item-assignment-admin-crud',
	templateUrl: './service-item-assignment-admin-crud.component.html',
	styleUrls: [
		'./service-item-assignment-admin-crud.component.scss',
...
export class AdminServiceItemAssignmentCrudComponent implements OnDestroy {
