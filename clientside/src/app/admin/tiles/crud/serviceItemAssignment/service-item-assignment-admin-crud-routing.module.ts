...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminServiceItemAssignmentCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminServiceItemAssignmentCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminServiceItemAssignmentCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminServiceItemAssignmentCrudRoutingModule {
}
