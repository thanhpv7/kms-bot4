...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminServiceItemCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminServiceItemCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminServiceItemCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminServiceItemCrudRoutingModule {
}
