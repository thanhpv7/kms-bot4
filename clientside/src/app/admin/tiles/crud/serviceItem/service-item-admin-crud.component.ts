 ...
 */
@Component({
	selector: 'cb-service-item-admin-crud',
	templateUrl: './service-item-admin-crud.component.html',
	styleUrls: [
		'./service-item-admin-crud.component.scss',
...
export class AdminServiceItemCrudComponent implements OnDestroy {
