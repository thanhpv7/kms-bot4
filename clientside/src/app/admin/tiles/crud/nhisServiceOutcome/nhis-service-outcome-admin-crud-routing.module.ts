...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminNhisServiceOutcomeCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminNhisServiceOutcomeCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminNhisServiceOutcomeCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminNhisServiceOutcomeCrudRoutingModule {
}
