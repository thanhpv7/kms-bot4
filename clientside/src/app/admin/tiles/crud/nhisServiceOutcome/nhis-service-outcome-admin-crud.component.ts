 ...
 */
@Component({
	selector: 'cb-nhis-service-outcome-admin-crud',
	templateUrl: './nhis-service-outcome-admin-crud.component.html',
	styleUrls: [
		'./nhis-service-outcome-admin-crud.component.scss',
...
export class AdminNhisServiceOutcomeCrudComponent implements OnDestroy {
