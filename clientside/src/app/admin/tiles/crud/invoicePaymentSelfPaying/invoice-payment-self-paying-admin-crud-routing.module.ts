...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminInvoicePaymentSelfPayingCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminInvoicePaymentSelfPayingCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminInvoicePaymentSelfPayingCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminInvoicePaymentSelfPayingCrudRoutingModule {
}
