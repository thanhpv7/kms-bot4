 ...
 */
@Component({
	selector: 'cb-invoice-payment-self-paying-admin-crud',
	templateUrl: './invoice-payment-self-paying-admin-crud.component.html',
	styleUrls: [
		'./invoice-payment-self-paying-admin-crud.component.scss',
...
export class AdminInvoicePaymentSelfPayingCrudComponent implements OnDestroy {
