...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBpjsListTaskCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBpjsListTaskCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBpjsListTaskCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBpjsListTaskCrudRoutingModule {
}
