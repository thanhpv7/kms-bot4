 ...
 */
@Component({
	selector: 'cb-bpjs-list-task-admin-crud',
	templateUrl: './bpjs-list-task-admin-crud.component.html',
	styleUrls: [
		'./bpjs-list-task-admin-crud.component.scss',
...
export class AdminBpjsListTaskCrudComponent implements OnDestroy {
