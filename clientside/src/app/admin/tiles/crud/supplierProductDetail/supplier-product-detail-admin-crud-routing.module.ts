...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminSupplierProductDetailCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminSupplierProductDetailCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminSupplierProductDetailCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminSupplierProductDetailCrudRoutingModule {
}
