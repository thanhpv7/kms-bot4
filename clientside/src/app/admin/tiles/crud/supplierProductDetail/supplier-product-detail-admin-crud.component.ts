 ...
 */
@Component({
	selector: 'cb-supplier-product-detail-admin-crud',
	templateUrl: './supplier-product-detail-admin-crud.component.html',
	styleUrls: [
		'./supplier-product-detail-admin-crud.component.scss',
...
export class AdminSupplierProductDetailCrudComponent implements OnDestroy {
