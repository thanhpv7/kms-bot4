 ...
 */
@Component({
	selector: 'cb-bpjs-jasa-raharja-admin-crud',
	templateUrl: './bpjs-jasa-raharja-admin-crud.component.html',
	styleUrls: [
		'./bpjs-jasa-raharja-admin-crud.component.scss',
...
export class AdminBpjsJasaRaharjaCrudComponent implements OnDestroy {
