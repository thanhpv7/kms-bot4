 ...
 */
@Component({
	selector: 'cb-bpjs-dismissal-condition-admin-crud',
	templateUrl: './bpjs-dismissal-condition-admin-crud.component.html',
	styleUrls: [
		'./bpjs-dismissal-condition-admin-crud.component.scss',
...
export class AdminBpjsDismissalConditionCrudComponent implements OnDestroy {
