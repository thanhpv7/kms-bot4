...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBpjsDismissalConditionCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBpjsDismissalConditionCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBpjsDismissalConditionCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBpjsDismissalConditionCrudRoutingModule {
}
