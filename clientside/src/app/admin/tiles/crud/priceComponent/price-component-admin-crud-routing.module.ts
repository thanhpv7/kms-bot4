...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminPriceComponentCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminPriceComponentCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminPriceComponentCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminPriceComponentCrudRoutingModule {
}
