 ...
 */
@Component({
	selector: 'cb-price-component-admin-crud',
	templateUrl: './price-component-admin-crud.component.html',
	styleUrls: [
		'./price-component-admin-crud.component.scss',
...
export class AdminPriceComponentCrudComponent implements OnDestroy {
