...
@Component({
	selector: 'cb-price-component-admin-crud-edit',
	templateUrl: './price-component-admin-crud-edit.component.html',
	styleUrls: [
		'./price-component-admin-crud-edit.component.scss',
...
export class AdminPriceComponentCrudEditComponent
