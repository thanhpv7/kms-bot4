...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBpjsVisitDataCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBpjsVisitDataCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBpjsVisitDataCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBpjsVisitDataCrudRoutingModule {
}
