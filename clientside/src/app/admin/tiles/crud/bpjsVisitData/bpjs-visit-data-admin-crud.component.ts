 ...
 */
@Component({
	selector: 'cb-bpjs-visit-data-admin-crud',
	templateUrl: './bpjs-visit-data-admin-crud.component.html',
	styleUrls: [
		'./bpjs-visit-data-admin-crud.component.scss',
...
export class AdminBpjsVisitDataCrudComponent implements OnDestroy {
