...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminPurchasingUserCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminPurchasingUserCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminPurchasingUserCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminPurchasingUserCrudRoutingModule {
}
