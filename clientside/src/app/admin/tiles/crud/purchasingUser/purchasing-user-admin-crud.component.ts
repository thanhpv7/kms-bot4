 ...
 */
@Component({
	selector: 'cb-purchasing-user-admin-crud',
	templateUrl: './purchasing-user-admin-crud.component.html',
	styleUrls: [
		'./purchasing-user-admin-crud.component.scss',
...
export class AdminPurchasingUserCrudComponent implements OnDestroy {
