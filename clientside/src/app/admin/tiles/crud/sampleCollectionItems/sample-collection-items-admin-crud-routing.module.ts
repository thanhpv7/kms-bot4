...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminSampleCollectionItemsCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminSampleCollectionItemsCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminSampleCollectionItemsCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminSampleCollectionItemsCrudRoutingModule {
}
