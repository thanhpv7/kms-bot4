 ...
 */
@Component({
	selector: 'cb-sample-collection-items-admin-crud',
	templateUrl: './sample-collection-items-admin-crud.component.html',
	styleUrls: [
		'./sample-collection-items-admin-crud.component.scss',
...
export class AdminSampleCollectionItemsCrudComponent implements OnDestroy {
