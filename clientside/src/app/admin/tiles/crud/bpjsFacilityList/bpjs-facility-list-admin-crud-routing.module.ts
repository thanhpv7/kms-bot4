...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBpjsFacilityListCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBpjsFacilityListCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBpjsFacilityListCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBpjsFacilityListCrudRoutingModule {
}
