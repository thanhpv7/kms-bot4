 ...
 */
@Component({
	selector: 'cb-bpjs-facility-list-admin-crud',
	templateUrl: './bpjs-facility-list-admin-crud.component.html',
	styleUrls: [
		'./bpjs-facility-list-admin-crud.component.scss',
...
export class AdminBpjsFacilityListCrudComponent implements OnDestroy {
