...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminCashRefundCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminCashRefundCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminCashRefundCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminCashRefundCrudRoutingModule {
}
