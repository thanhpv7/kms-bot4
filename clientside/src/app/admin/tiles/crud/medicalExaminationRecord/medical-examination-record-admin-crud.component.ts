 ...
 */
@Component({
	selector: 'cb-medical-examination-record-admin-crud',
	templateUrl: './medical-examination-record-admin-crud.component.html',
	styleUrls: [
		'./medical-examination-record-admin-crud.component.scss',
...
export class AdminMedicalExaminationRecordCrudComponent implements OnDestroy {
