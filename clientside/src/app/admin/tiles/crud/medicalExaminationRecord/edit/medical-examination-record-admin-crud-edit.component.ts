...
@Component({
	selector: 'cb-medical-examination-record-admin-crud-edit',
	templateUrl: './medical-examination-record-admin-crud-edit.component.html',
	styleUrls: [
		'./medical-examination-record-admin-crud-edit.component.scss',
...
export class AdminMedicalExaminationRecordCrudEditComponent
