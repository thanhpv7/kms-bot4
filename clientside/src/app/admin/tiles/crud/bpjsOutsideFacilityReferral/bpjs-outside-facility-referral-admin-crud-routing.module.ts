...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBpjsOutsideFacilityReferralCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBpjsOutsideFacilityReferralCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBpjsOutsideFacilityReferralCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBpjsOutsideFacilityReferralCrudRoutingModule {
}
