 ...
 */
@Component({
	selector: 'cb-bpjs-outside-facility-referral-admin-crud',
	templateUrl: './bpjs-outside-facility-referral-admin-crud.component.html',
	styleUrls: [
		'./bpjs-outside-facility-referral-admin-crud.component.scss',
...
export class AdminBpjsOutsideFacilityReferralCrudComponent implements OnDestroy {
