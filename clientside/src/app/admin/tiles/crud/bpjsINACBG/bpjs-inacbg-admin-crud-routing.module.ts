...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBpjsINACBGCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBpjsINACBGCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBpjsINACBGCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBpjsINACBGCrudRoutingModule {
}
