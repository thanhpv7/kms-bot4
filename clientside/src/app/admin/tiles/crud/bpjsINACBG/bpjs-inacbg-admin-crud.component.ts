 ...
 */
@Component({
	selector: 'cb-bpjs-inacbg-admin-crud',
	templateUrl: './bpjs-inacbg-admin-crud.component.html',
	styleUrls: [
		'./bpjs-inacbg-admin-crud.component.scss',
...
export class AdminBpjsINACBGCrudComponent implements OnDestroy {
