 ...
 */
@Component({
	selector: 'cb-catalogue-uom-admin-crud',
	templateUrl: './catalogue-uom-admin-crud.component.html',
	styleUrls: [
		'./catalogue-uom-admin-crud.component.scss',
...
export class AdminCatalogueUOMCrudComponent implements OnDestroy {
