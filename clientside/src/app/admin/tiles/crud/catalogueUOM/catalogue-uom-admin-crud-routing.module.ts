...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminCatalogueUOMCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminCatalogueUOMCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminCatalogueUOMCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminCatalogueUOMCrudRoutingModule {
}
