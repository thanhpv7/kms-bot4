 ...
 */
@Component({
	selector: 'cb-cash-allocation-admin-crud',
	templateUrl: './cash-allocation-admin-crud.component.html',
	styleUrls: [
		'./cash-allocation-admin-crud.component.scss',
...
export class AdminCashAllocationCrudComponent implements OnDestroy {
