...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminCashAllocationCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminCashAllocationCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminCashAllocationCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminCashAllocationCrudRoutingModule {
}
