...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminOdontogramExaminationCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminOdontogramExaminationCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminOdontogramExaminationCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminOdontogramExaminationCrudRoutingModule {
}
