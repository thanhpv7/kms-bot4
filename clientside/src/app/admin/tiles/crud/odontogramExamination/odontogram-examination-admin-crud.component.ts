 ...
 */
@Component({
	selector: 'cb-odontogram-examination-admin-crud',
	templateUrl: './odontogram-examination-admin-crud.component.html',
	styleUrls: [
		'./odontogram-examination-admin-crud.component.scss',
...
export class AdminOdontogramExaminationCrudComponent implements OnDestroy {
