 ...
 */
@Component({
	selector: 'cb-patient-vital-information-admin-crud',
	templateUrl: './patient-vital-information-admin-crud.component.html',
	styleUrls: [
		'./patient-vital-information-admin-crud.component.scss',
...
export class AdminPatientVitalInformationCrudComponent implements OnDestroy {
