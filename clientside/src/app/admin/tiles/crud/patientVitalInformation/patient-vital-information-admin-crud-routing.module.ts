...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminPatientVitalInformationCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminPatientVitalInformationCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminPatientVitalInformationCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminPatientVitalInformationCrudRoutingModule {
}
