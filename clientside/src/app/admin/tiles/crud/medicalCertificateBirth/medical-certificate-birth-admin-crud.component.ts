 ...
 */
@Component({
	selector: 'cb-medical-certificate-birth-admin-crud',
	templateUrl: './medical-certificate-birth-admin-crud.component.html',
	styleUrls: [
		'./medical-certificate-birth-admin-crud.component.scss',
...
export class AdminMedicalCertificateBirthCrudComponent implements OnDestroy {
