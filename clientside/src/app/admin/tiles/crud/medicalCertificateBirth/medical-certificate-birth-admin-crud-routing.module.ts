...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminMedicalCertificateBirthCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminMedicalCertificateBirthCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminMedicalCertificateBirthCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminMedicalCertificateBirthCrudRoutingModule {
}
