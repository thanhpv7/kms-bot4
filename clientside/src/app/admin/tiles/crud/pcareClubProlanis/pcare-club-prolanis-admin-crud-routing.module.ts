...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminPcareClubProlanisCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminPcareClubProlanisCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminPcareClubProlanisCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminPcareClubProlanisCrudRoutingModule {
}
