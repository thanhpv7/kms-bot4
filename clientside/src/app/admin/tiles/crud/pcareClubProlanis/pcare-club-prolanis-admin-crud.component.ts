 ...
 */
@Component({
	selector: 'cb-pcare-club-prolanis-admin-crud',
	templateUrl: './pcare-club-prolanis-admin-crud.component.html',
	styleUrls: [
		'./pcare-club-prolanis-admin-crud.component.scss',
...
export class AdminPcareClubProlanisCrudComponent implements OnDestroy {
