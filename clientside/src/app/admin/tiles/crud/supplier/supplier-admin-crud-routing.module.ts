...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminSupplierCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminSupplierCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminSupplierCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminSupplierCrudRoutingModule {
}
