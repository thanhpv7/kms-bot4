...
@Component({
	selector: 'cb-supplier-admin-crud-edit',
	templateUrl: './supplier-admin-crud-edit.component.html',
	styleUrls: [
		'./supplier-admin-crud-edit.component.scss',
...
export class AdminSupplierCrudEditComponent
