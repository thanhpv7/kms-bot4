 ...
 */
@Component({
	selector: 'cb-supplier-admin-crud',
	templateUrl: './supplier-admin-crud.component.html',
	styleUrls: [
		'./supplier-admin-crud.component.scss',
...
export class AdminSupplierCrudComponent implements OnDestroy {
