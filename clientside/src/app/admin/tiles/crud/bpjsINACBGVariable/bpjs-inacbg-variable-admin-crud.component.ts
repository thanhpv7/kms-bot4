 ...
 */
@Component({
	selector: 'cb-bpjs-inacbg-variable-admin-crud',
	templateUrl: './bpjs-inacbg-variable-admin-crud.component.html',
	styleUrls: [
		'./bpjs-inacbg-variable-admin-crud.component.scss',
...
export class AdminBpjsINACBGVariableCrudComponent implements OnDestroy {
