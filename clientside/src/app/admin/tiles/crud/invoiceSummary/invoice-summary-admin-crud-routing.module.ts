...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminInvoiceSummaryCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminInvoiceSummaryCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminInvoiceSummaryCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminInvoiceSummaryCrudRoutingModule {
}
