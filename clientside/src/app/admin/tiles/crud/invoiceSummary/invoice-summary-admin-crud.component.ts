 ...
 */
@Component({
	selector: 'cb-invoice-summary-admin-crud',
	templateUrl: './invoice-summary-admin-crud.component.html',
	styleUrls: [
		'./invoice-summary-admin-crud.component.scss',
...
export class AdminInvoiceSummaryCrudComponent implements OnDestroy {
