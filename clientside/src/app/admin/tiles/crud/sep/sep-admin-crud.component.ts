 ...
 */
@Component({
	selector: 'cb-sep-admin-crud',
	templateUrl: './sep-admin-crud.component.html',
	styleUrls: [
		'./sep-admin-crud.component.scss',
...
export class AdminSepCrudComponent implements OnDestroy {
