...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBpjsClaimDataCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBpjsClaimDataCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBpjsClaimDataCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBpjsClaimDataCrudRoutingModule {
}
