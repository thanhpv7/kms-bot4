 ...
 */
@Component({
	selector: 'cb-bpjs-claim-data-admin-crud',
	templateUrl: './bpjs-claim-data-admin-crud.component.html',
	styleUrls: [
		'./bpjs-claim-data-admin-crud.component.scss',
...
export class AdminBpjsClaimDataCrudComponent implements OnDestroy {
