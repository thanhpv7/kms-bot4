 ...
 */
@Component({
	selector: 'cb-inventory-batch-correction-item-admin-crud',
	templateUrl: './inventory-batch-correction-item-admin-crud.component.html',
	styleUrls: [
		'./inventory-batch-correction-item-admin-crud.component.scss',
...
export class AdminInventoryBatchCorrectionItemCrudComponent implements OnDestroy {
