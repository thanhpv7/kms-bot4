...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminInventoryBatchCorrectionItemCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminInventoryBatchCorrectionItemCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminInventoryBatchCorrectionItemCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminInventoryBatchCorrectionItemCrudRoutingModule {
}
