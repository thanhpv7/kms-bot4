...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminPatientContactInfoCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminPatientContactInfoCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminPatientContactInfoCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminPatientContactInfoCrudRoutingModule {
}
