 ...
 */
@Component({
	selector: 'cb-patient-contact-info-admin-crud',
	templateUrl: './patient-contact-info-admin-crud.component.html',
	styleUrls: [
		'./patient-contact-info-admin-crud.component.scss',
...
export class AdminPatientContactInfoCrudComponent implements OnDestroy {
