...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminMedicalFeeItemComponentCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminMedicalFeeItemComponentCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminMedicalFeeItemComponentCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminMedicalFeeItemComponentCrudRoutingModule {
}
