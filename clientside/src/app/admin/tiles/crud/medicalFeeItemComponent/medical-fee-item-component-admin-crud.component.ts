 ...
 */
@Component({
	selector: 'cb-medical-fee-item-component-admin-crud',
	templateUrl: './medical-fee-item-component-admin-crud.component.html',
	styleUrls: [
		'./medical-fee-item-component-admin-crud.component.scss',
...
export class AdminMedicalFeeItemComponentCrudComponent implements OnDestroy {
