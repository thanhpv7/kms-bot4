 ...
 */
@Component({
	selector: 'cb-catalogue-medical-admin-crud',
	templateUrl: './catalogue-medical-admin-crud.component.html',
	styleUrls: [
		'./catalogue-medical-admin-crud.component.scss',
...
export class AdminCatalogueMedicalCrudComponent implements OnDestroy {
