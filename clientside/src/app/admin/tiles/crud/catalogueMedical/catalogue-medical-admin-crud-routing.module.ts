...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminCatalogueMedicalCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminCatalogueMedicalCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminCatalogueMedicalCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminCatalogueMedicalCrudRoutingModule {
}
