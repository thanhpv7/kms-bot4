...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminPcareReferensiSaranaCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminPcareReferensiSaranaCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminPcareReferensiSaranaCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminPcareReferensiSaranaCrudRoutingModule {
}
