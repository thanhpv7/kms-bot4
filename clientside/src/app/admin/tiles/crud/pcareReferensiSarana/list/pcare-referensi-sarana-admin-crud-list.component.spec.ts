...
import {AdminPcareReferensiSaranaCrudListComponent} from './pcare-referensi-sarana-admin-crud-list.component';
...
import {AdminPcareReferensiSaranaCrudModule} from '../pcare-referensi-sarana-admin-crud.module';
import {
...
describe('PCare Referensi Sarana Crud List Tile Component', () => {
	...
	let fixture;
	let pcareReferensiSaranaCrudListComponent: AdminPcareReferensiSaranaCrudListComponent;
	...
	const routerState: RouterState = {
		url: 'pcare-referensi-sarana-admin-crud',
		urls: ['pcare-referensi-sarana-admin-crud'],
		params: {},
		queryParams: {},
		data: {},
	};
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			imports: [
				...
				AdminPcareReferensiSaranaCrudModule,
			],
			providers: [
				provideMockStore(),
				{
			...
			fixture = TestBed.createComponent(AdminPcareReferensiSaranaCrudListComponent);
