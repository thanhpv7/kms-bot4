 ...
 */
@Component({
	selector: 'cb-catalogue-non-medical-admin-crud',
	templateUrl: './catalogue-non-medical-admin-crud.component.html',
	styleUrls: [
		'./catalogue-non-medical-admin-crud.component.scss',
...
export class AdminCatalogueNonMedicalCrudComponent implements OnDestroy {
