 ...
 */
@Component({
	selector: 'cb-cashier-user-admin-crud',
	templateUrl: './cashier-user-admin-crud.component.html',
	styleUrls: [
		'./cashier-user-admin-crud.component.scss',
...
export class AdminCashierUserCrudComponent implements OnDestroy {
