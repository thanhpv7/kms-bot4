...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminCashierUserCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminCashierUserCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminCashierUserCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminCashierUserCrudRoutingModule {
}
