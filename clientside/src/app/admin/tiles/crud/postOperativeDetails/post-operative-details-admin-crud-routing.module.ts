...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminPostOperativeDetailsCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminPostOperativeDetailsCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminPostOperativeDetailsCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminPostOperativeDetailsCrudRoutingModule {
}
