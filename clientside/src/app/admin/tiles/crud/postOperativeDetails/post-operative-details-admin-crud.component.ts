 ...
 */
@Component({
	selector: 'cb-post-operative-details-admin-crud',
	templateUrl: './post-operative-details-admin-crud.component.html',
	styleUrls: [
		'./post-operative-details-admin-crud.component.scss',
...
export class AdminPostOperativeDetailsCrudComponent implements OnDestroy {
