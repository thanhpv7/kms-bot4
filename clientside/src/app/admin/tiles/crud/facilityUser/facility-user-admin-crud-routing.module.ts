...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminFacilityUserCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminFacilityUserCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminFacilityUserCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminFacilityUserCrudRoutingModule {
}
