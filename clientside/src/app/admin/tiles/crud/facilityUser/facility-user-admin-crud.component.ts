 ...
 */
@Component({
	selector: 'cb-facility-user-admin-crud',
	templateUrl: './facility-user-admin-crud.component.html',
	styleUrls: [
		'./facility-user-admin-crud.component.scss',
...
export class AdminFacilityUserCrudComponent implements OnDestroy {
