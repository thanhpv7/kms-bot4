...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBpjsTreatmentClassMappingCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBpjsTreatmentClassMappingCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBpjsTreatmentClassMappingCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBpjsTreatmentClassMappingCrudRoutingModule {
}
