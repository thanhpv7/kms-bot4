 ...
 */
@Component({
	selector: 'cb-bpjs-treatment-class-mapping-admin-crud',
	templateUrl: './bpjs-treatment-class-mapping-admin-crud.component.html',
	styleUrls: [
		'./bpjs-treatment-class-mapping-admin-crud.component.scss',
...
export class AdminBpjsTreatmentClassMappingCrudComponent implements OnDestroy {
