...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBpjsSEPCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBpjsSEPCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBpjsSEPCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBpjsSEPCrudRoutingModule {
}
