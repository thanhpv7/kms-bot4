 ...
 */
@Component({
	selector: 'cb-bpjs-sep-admin-crud',
	templateUrl: './bpjs-sep-admin-crud.component.html',
	styleUrls: [
		'./bpjs-sep-admin-crud.component.scss',
...
export class AdminBpjsSEPCrudComponent implements OnDestroy {
