...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminVaccinationOrderDetailCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminVaccinationOrderDetailCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminVaccinationOrderDetailCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminVaccinationOrderDetailCrudRoutingModule {
}
