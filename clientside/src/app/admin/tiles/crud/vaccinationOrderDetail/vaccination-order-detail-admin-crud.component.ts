 ...
 */
@Component({
	selector: 'cb-vaccination-order-detail-admin-crud',
	templateUrl: './vaccination-order-detail-admin-crud.component.html',
	styleUrls: [
		'./vaccination-order-detail-admin-crud.component.scss',
...
export class AdminVaccinationOrderDetailCrudComponent implements OnDestroy {
