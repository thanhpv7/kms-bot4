...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminInvoiceItemComponentCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminInvoiceItemComponentCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminInvoiceItemComponentCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminInvoiceItemComponentCrudRoutingModule {
}
