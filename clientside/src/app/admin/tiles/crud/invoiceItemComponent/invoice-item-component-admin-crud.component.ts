 ...
 */
@Component({
	selector: 'cb-invoice-item-component-admin-crud',
	templateUrl: './invoice-item-component-admin-crud.component.html',
	styleUrls: [
		'./invoice-item-component-admin-crud.component.scss',
...
export class AdminInvoiceItemComponentCrudComponent implements OnDestroy {
