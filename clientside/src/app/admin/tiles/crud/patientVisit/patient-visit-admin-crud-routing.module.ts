...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminPatientVisitCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminPatientVisitCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminPatientVisitCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminPatientVisitCrudRoutingModule {
}
