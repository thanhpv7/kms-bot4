 ...
 */
@Component({
	selector: 'cb-patient-visit-admin-crud',
	templateUrl: './patient-visit-admin-crud.component.html',
	styleUrls: [
		'./patient-visit-admin-crud.component.scss',
...
export class AdminPatientVisitCrudComponent implements OnDestroy {
