 ...
 */
@Component({
	selector: 'cb-medical-certificate-mental-health-admin-crud',
	templateUrl: './medical-certificate-mental-health-admin-crud.component.html',
	styleUrls: [
		'./medical-certificate-mental-health-admin-crud.component.scss',
...
export class AdminMedicalCertificateMentalHealthCrudComponent implements OnDestroy {
