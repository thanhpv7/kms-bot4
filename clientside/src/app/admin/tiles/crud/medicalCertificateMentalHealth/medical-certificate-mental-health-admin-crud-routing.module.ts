...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminMedicalCertificateMentalHealthCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminMedicalCertificateMentalHealthCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminMedicalCertificateMentalHealthCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminMedicalCertificateMentalHealthCrudRoutingModule {
}
