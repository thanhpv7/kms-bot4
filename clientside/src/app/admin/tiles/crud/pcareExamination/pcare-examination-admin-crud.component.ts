 ...
 */
@Component({
	selector: 'cb-pcare-examination-admin-crud',
	templateUrl: './pcare-examination-admin-crud.component.html',
	styleUrls: [
		'./pcare-examination-admin-crud.component.scss',
...
export class AdminPcareExaminationCrudComponent implements OnDestroy {
