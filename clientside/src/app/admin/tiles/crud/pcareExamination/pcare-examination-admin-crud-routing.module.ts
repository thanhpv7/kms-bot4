...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminPcareExaminationCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminPcareExaminationCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminPcareExaminationCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminPcareExaminationCrudRoutingModule {
}
