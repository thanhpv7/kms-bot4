...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBpjsBedAvailabilityCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBpjsBedAvailabilityCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBpjsBedAvailabilityCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBpjsBedAvailabilityCrudRoutingModule {
}
