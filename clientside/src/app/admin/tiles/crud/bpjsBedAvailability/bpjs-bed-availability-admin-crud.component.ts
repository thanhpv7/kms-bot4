 ...
 */
@Component({
	selector: 'cb-bpjs-bed-availability-admin-crud',
	templateUrl: './bpjs-bed-availability-admin-crud.component.html',
	styleUrls: [
		'./bpjs-bed-availability-admin-crud.component.scss',
...
export class AdminBpjsBedAvailabilityCrudComponent implements OnDestroy {
