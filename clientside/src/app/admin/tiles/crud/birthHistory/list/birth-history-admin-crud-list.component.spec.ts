...
import {AdminBirthHistoryCrudListComponent} from './birth-history-admin-crud-list.component';
...
import {AdminBirthHistoryCrudModule} from '../birth-history-admin-crud.module';
import {
...
describe('Birth History Crud List Tile Component', () => {
	...
	let fixture;
	let birthHistoryCrudListComponent: AdminBirthHistoryCrudListComponent;
	...
	const routerState: RouterState = {
		url: 'birth-history-admin-crud',
		urls: ['birth-history-admin-crud'],
		params: {},
		queryParams: {},
		data: {},
	};
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(AdminBirthHistoryCrudListComponent);
