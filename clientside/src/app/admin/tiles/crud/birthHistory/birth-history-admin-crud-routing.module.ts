...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBirthHistoryCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBirthHistoryCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBirthHistoryCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBirthHistoryCrudRoutingModule {
}
