 ...
 */
@Component({
	selector: 'cb-birth-history-admin-crud',
	templateUrl: './birth-history-admin-crud.component.html',
	styleUrls: [
		'./birth-history-admin-crud.component.scss',
...
export class AdminBirthHistoryCrudComponent implements OnDestroy {
