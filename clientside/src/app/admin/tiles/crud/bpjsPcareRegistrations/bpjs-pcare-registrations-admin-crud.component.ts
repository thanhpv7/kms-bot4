 ...
 */
@Component({
	selector: 'cb-bpjs-pcare-registrations-admin-crud',
	templateUrl: './bpjs-pcare-registrations-admin-crud.component.html',
	styleUrls: [
		'./bpjs-pcare-registrations-admin-crud.component.scss',
...
export class AdminBpjsPcareRegistrationsCrudComponent implements OnDestroy {
