...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBpjsPcareRegistrationsCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBpjsPcareRegistrationsCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBpjsPcareRegistrationsCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBpjsPcareRegistrationsCrudRoutingModule {
}
