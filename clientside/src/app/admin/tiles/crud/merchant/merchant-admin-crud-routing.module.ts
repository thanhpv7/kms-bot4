...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminMerchantCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminMerchantCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminMerchantCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminMerchantCrudRoutingModule {
}
