 ...
 */
@Component({
	selector: 'cb-merchant-admin-crud',
	templateUrl: './merchant-admin-crud.component.html',
	styleUrls: [
		'./merchant-admin-crud.component.scss',
...
export class AdminMerchantCrudComponent implements OnDestroy {
