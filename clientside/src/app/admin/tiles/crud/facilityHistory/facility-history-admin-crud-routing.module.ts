...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminFacilityHistoryCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminFacilityHistoryCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminFacilityHistoryCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminFacilityHistoryCrudRoutingModule {
}
