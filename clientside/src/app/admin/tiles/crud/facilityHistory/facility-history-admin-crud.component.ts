 ...
 */
@Component({
	selector: 'cb-facility-history-admin-crud',
	templateUrl: './facility-history-admin-crud.component.html',
	styleUrls: [
		'./facility-history-admin-crud.component.scss',
...
export class AdminFacilityHistoryCrudComponent implements OnDestroy {
