 ...
 */
@Component({
	selector: 'cb-patient-personal-info-admin-crud',
	templateUrl: './patient-personal-info-admin-crud.component.html',
	styleUrls: [
		'./patient-personal-info-admin-crud.component.scss',
...
export class AdminPatientPersonalInfoCrudComponent implements OnDestroy {
