...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminPatientPersonalInfoCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminPatientPersonalInfoCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminPatientPersonalInfoCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminPatientPersonalInfoCrudRoutingModule {
}
