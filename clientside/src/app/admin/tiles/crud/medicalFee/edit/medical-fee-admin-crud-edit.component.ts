...
@Component({
	selector: 'cb-medical-fee-admin-crud-edit',
	templateUrl: './medical-fee-admin-crud-edit.component.html',
	styleUrls: [
		'./medical-fee-admin-crud-edit.component.scss',
...
export class AdminMedicalFeeCrudEditComponent
