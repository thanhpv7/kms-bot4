...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminMedicalFeeCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminMedicalFeeCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminMedicalFeeCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminMedicalFeeCrudRoutingModule {
}
