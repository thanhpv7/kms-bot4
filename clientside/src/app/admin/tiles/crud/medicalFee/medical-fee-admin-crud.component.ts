 ...
 */
@Component({
	selector: 'cb-medical-fee-admin-crud',
	templateUrl: './medical-fee-admin-crud.component.html',
	styleUrls: [
		'./medical-fee-admin-crud.component.scss',
...
export class AdminMedicalFeeCrudComponent implements OnDestroy {
