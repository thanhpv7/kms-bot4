...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminWarehouseInventoryCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminWarehouseInventoryCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminWarehouseInventoryCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminWarehouseInventoryCrudRoutingModule {
}
