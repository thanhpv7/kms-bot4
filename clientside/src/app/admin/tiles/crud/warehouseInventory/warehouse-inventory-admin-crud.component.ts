 ...
 */
@Component({
	selector: 'cb-warehouse-inventory-admin-crud',
	templateUrl: './warehouse-inventory-admin-crud.component.html',
	styleUrls: [
		'./warehouse-inventory-admin-crud.component.scss',
...
export class AdminWarehouseInventoryCrudComponent implements OnDestroy {
