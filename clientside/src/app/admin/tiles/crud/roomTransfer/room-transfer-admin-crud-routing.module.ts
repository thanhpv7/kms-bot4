...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminRoomTransferCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminRoomTransferCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminRoomTransferCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminRoomTransferCrudRoutingModule {
}
