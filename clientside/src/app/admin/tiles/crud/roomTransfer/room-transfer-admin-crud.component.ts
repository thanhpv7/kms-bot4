 ...
 */
@Component({
	selector: 'cb-room-transfer-admin-crud',
	templateUrl: './room-transfer-admin-crud.component.html',
	styleUrls: [
		'./room-transfer-admin-crud.component.scss',
...
export class AdminRoomTransferCrudComponent implements OnDestroy {
