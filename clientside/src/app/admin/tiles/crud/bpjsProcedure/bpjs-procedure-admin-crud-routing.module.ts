...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBpjsProcedureCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBpjsProcedureCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBpjsProcedureCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBpjsProcedureCrudRoutingModule {
}
