 ...
 */
@Component({
	selector: 'cb-bpjs-procedure-admin-crud',
	templateUrl: './bpjs-procedure-admin-crud.component.html',
	styleUrls: [
		'./bpjs-procedure-admin-crud.component.scss',
...
export class AdminBpjsProcedureCrudComponent implements OnDestroy {
