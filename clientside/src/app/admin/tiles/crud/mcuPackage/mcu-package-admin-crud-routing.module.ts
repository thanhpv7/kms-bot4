...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminMcuPackageCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminMcuPackageCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminMcuPackageCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminMcuPackageCrudRoutingModule {
}
