 ...
 */
@Component({
	selector: 'cb-mcu-package-admin-crud',
	templateUrl: './mcu-package-admin-crud.component.html',
	styleUrls: [
		'./mcu-package-admin-crud.component.scss',
...
export class AdminMcuPackageCrudComponent implements OnDestroy {
