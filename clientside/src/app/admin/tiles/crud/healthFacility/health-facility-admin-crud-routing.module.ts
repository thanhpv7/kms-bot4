...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminHealthFacilityCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminHealthFacilityCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminHealthFacilityCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminHealthFacilityCrudRoutingModule {
}
