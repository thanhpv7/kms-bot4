 ...
 */
@Component({
	selector: 'cb-health-facility-admin-crud',
	templateUrl: './health-facility-admin-crud.component.html',
	styleUrls: [
		'./health-facility-admin-crud.component.scss',
...
export class AdminHealthFacilityCrudComponent implements OnDestroy {
