 ...
 */
@Component({
	selector: 'cb-bpjs-prb-admin-crud',
	templateUrl: './bpjs-prb-admin-crud.component.html',
	styleUrls: [
		'./bpjs-prb-admin-crud.component.scss',
...
export class AdminBpjsPRBCrudComponent implements OnDestroy {
