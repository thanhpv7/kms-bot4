...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBpjsSEPInternalDataCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBpjsSEPInternalDataCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBpjsSEPInternalDataCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBpjsSEPInternalDataCrudRoutingModule {
}
