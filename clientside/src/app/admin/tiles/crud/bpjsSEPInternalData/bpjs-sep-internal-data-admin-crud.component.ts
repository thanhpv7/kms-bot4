 ...
 */
@Component({
	selector: 'cb-bpjs-sep-internal-data-admin-crud',
	templateUrl: './bpjs-sep-internal-data-admin-crud.component.html',
	styleUrls: [
		'./bpjs-sep-internal-data-admin-crud.component.scss',
...
export class AdminBpjsSEPInternalDataCrudComponent implements OnDestroy {
