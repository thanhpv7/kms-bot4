 ...
 */
@Component({
	selector: 'cb-registration-user-admin-crud',
	templateUrl: './registration-user-admin-crud.component.html',
	styleUrls: [
		'./registration-user-admin-crud.component.scss',
...
export class AdminRegistrationUserCrudComponent implements OnDestroy {
