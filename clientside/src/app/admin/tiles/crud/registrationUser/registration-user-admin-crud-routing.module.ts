...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminRegistrationUserCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminRegistrationUserCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminRegistrationUserCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminRegistrationUserCrudRoutingModule {
}
