...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminCompoundPrescriptionDetailCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminCompoundPrescriptionDetailCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminCompoundPrescriptionDetailCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminCompoundPrescriptionDetailCrudRoutingModule {
}
