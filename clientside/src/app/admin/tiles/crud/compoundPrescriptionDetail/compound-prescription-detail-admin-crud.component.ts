 ...
 */
@Component({
	selector: 'cb-compound-prescription-detail-admin-crud',
	templateUrl: './compound-prescription-detail-admin-crud.component.html',
	styleUrls: [
		'./compound-prescription-detail-admin-crud.component.scss',
...
export class AdminCompoundPrescriptionDetailCrudComponent implements OnDestroy {
