...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminStockTransactionPerDateTypeCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminStockTransactionPerDateTypeCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminStockTransactionPerDateTypeCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminStockTransactionPerDateTypeCrudRoutingModule {
}
