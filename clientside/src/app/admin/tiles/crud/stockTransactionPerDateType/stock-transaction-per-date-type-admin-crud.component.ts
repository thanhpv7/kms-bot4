 ...
 */
@Component({
	selector: 'cb-stock-transaction-per-date-type-admin-crud',
	templateUrl: './stock-transaction-per-date-type-admin-crud.component.html',
	styleUrls: [
		'./stock-transaction-per-date-type-admin-crud.component.scss',
...
export class AdminStockTransactionPerDateTypeCrudComponent implements OnDestroy {
