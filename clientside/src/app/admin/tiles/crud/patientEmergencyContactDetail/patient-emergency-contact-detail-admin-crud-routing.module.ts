...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminPatientEmergencyContactDetailCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminPatientEmergencyContactDetailCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminPatientEmergencyContactDetailCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminPatientEmergencyContactDetailCrudRoutingModule {
}
