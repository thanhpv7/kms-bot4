 ...
 */
@Component({
	selector: 'cb-patient-emergency-contact-detail-admin-crud',
	templateUrl: './patient-emergency-contact-detail-admin-crud.component.html',
	styleUrls: [
		'./patient-emergency-contact-detail-admin-crud.component.scss',
...
export class AdminPatientEmergencyContactDetailCrudComponent implements OnDestroy {
