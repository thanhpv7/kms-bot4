 ...
 */
@Component({
	selector: 'cb-bpjs-finger-print-admin-crud',
	templateUrl: './bpjs-finger-print-admin-crud.component.html',
	styleUrls: [
		'./bpjs-finger-print-admin-crud.component.scss',
...
export class AdminBpjsFingerPrintCrudComponent implements OnDestroy {
