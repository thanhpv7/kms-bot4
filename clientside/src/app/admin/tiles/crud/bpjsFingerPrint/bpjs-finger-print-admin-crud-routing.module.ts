...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminBpjsFingerPrintCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminBpjsFingerPrintCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminBpjsFingerPrintCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminBpjsFingerPrintCrudRoutingModule {
}
