 ...
 */
@Component({
	selector: 'cb-nhis-claim-investigation-detail-admin-crud',
	templateUrl: './nhis-claim-investigation-detail-admin-crud.component.html',
	styleUrls: [
		'./nhis-claim-investigation-detail-admin-crud.component.scss',
...
export class AdminNhisClaimInvestigationDetailCrudComponent implements OnDestroy {
