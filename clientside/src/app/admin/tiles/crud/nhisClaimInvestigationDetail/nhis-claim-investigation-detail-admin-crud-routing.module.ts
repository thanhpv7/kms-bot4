...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AdminNhisClaimInvestigationDetailCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AdminNhisClaimInvestigationDetailCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'view/:id',
				component: AdminNhisClaimInvestigationDetailCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AdminNhisClaimInvestigationDetailCrudRoutingModule {
}
