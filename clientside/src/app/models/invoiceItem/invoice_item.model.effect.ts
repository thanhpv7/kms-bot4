...
import * as modelAction from './invoice_item.model.action';
import {InvoiceItemService} from '../../services/invoiceItem/invoice_item.service';
...
/**
 * Effect class used for side effects related to Invoice Item model.
 */
@Injectable()
export class InvoiceItemEffect {
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceItemAction>(modelAction.InvoiceItemModelActionTypes.COUNT_INVOICE_ITEMS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.InvoiceItemActionOK(
						modelAction.InvoiceItemModelActionTypes.COUNT_INVOICE_ITEMS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceItemActionFail(
								modelAction.InvoiceItemModelActionTypes.COUNT_INVOICE_ITEMS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceItemAction>(modelAction.InvoiceItemModelActionTypes.FETCH_INVOICE_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InvoiceItemActionOK(
						modelAction.InvoiceItemModelActionTypes.FETCH_INVOICE_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceItemActionFail(
								modelAction.InvoiceItemModelActionTypes.FETCH_INVOICE_ITEM_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceItemAction>(modelAction.InvoiceItemModelActionTypes.FETCH_ALL_INVOICE_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.InvoiceItemActionOK(
						modelAction.InvoiceItemModelActionTypes.FETCH_ALL_INVOICE_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceItemActionFail(
								modelAction.InvoiceItemModelActionTypes.FETCH_ALL_INVOICE_ITEM_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceItemAction>(modelAction.InvoiceItemModelActionTypes.FETCH_INVOICE_ITEM_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.InvoiceItemActionOK(
						modelAction.InvoiceItemModelActionTypes.FETCH_INVOICE_ITEM_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceItemActionFail(
								modelAction.InvoiceItemModelActionTypes.FETCH_INVOICE_ITEM_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceItemAction>(modelAction.InvoiceItemModelActionTypes.FETCH_LAST_INVOICE_ITEM_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.InvoiceItemActionOK(
						modelAction.InvoiceItemModelActionTypes.FETCH_LAST_INVOICE_ITEM_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceItemActionFail(
								modelAction.InvoiceItemModelActionTypes.FETCH_LAST_INVOICE_ITEM_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceItemAction>(modelAction.InvoiceItemModelActionTypes.CREATE_INVOICE_ITEM),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as InvoiceItemModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InvoiceItemActionOK(
						modelAction.InvoiceItemModelActionTypes.CREATE_INVOICE_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceItemActionFail(
								modelAction.InvoiceItemModelActionTypes.CREATE_INVOICE_ITEM_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceItemAction>(modelAction.InvoiceItemModelActionTypes.CREATE_ALL_INVOICE_ITEM),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as InvoiceItemModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InvoiceItemActionOK(
						modelAction.InvoiceItemModelActionTypes.CREATE_ALL_INVOICE_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceItemActionFail(
								modelAction.InvoiceItemModelActionTypes.CREATE_ALL_INVOICE_ITEM_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceItemAction>(modelAction.InvoiceItemModelActionTypes.UPDATE_INVOICE_ITEM),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as InvoiceItemModel;
				...
				return this.service.update(new InvoiceItemModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.InvoiceItemActionOK(
						modelAction.InvoiceItemModelActionTypes.UPDATE_INVOICE_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceItemActionFail(
								modelAction.InvoiceItemModelActionTypes.UPDATE_INVOICE_ITEM_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceItemAction>(modelAction.InvoiceItemModelActionTypes.UPDATE_ALL_INVOICE_ITEM),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as InvoiceItemModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new InvoiceItemModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InvoiceItemActionOK(
						modelAction.InvoiceItemModelActionTypes.UPDATE_ALL_INVOICE_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceItemActionFail(
								modelAction.InvoiceItemModelActionTypes.UPDATE_ALL_INVOICE_ITEM_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceItemAction>(modelAction.InvoiceItemModelActionTypes.DELETE_INVOICE_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.InvoiceItemActionOK(
						modelAction.InvoiceItemModelActionTypes.DELETE_INVOICE_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceItemActionFail(
								modelAction.InvoiceItemModelActionTypes.DELETE_INVOICE_ITEM_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceItemAction>(modelAction.InvoiceItemModelActionTypes.DELETE_INVOICE_ITEM_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.InvoiceItemActionOK(
						modelAction.InvoiceItemModelActionTypes.DELETE_INVOICE_ITEM_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceItemActionFail(
								modelAction.InvoiceItemModelActionTypes.DELETE_INVOICE_ITEM_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceItemAction>(modelAction.InvoiceItemModelActionTypes.DELETE_ALL_INVOICE_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.InvoiceItemActionOK(
						modelAction.InvoiceItemModelActionTypes.DELETE_ALL_INVOICE_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceItemActionFail(
								modelAction.InvoiceItemModelActionTypes.DELETE_ALL_INVOICE_ITEM_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceItemAction>(modelAction.InvoiceItemModelActionTypes.EXPORT_INVOICE_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.InvoiceItemActionOK(
						modelAction.InvoiceItemModelActionTypes.EXPORT_INVOICE_ITEM,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceItemAction>(modelAction.InvoiceItemModelActionTypes.EXPORT_ALL_INVOICE_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.InvoiceItemActionOK(
						modelAction.InvoiceItemModelActionTypes.EXPORT_ALL_INVOICE_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceItemActionFail(
								modelAction.InvoiceItemModelActionTypes.EXPORT_ALL_INVOICE_ITEM_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceItemAction>(modelAction.InvoiceItemModelActionTypes.EXPORT_INVOICE_ITEM_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.InvoiceItemActionOK(
						modelAction.InvoiceItemModelActionTypes.EXPORT_INVOICE_ITEM_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceItemActionFail(
								modelAction.InvoiceItemModelActionTypes.EXPORT_INVOICE_ITEM_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceItemAction>(modelAction.InvoiceItemModelActionTypes.IMPORT_INVOICE_ITEMS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.InvoiceItemActionOK(
						modelAction.InvoiceItemModelActionTypes.IMPORT_INVOICE_ITEMS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceItemActionFail(
								modelAction.InvoiceItemModelActionTypes.IMPORT_INVOICE_ITEMS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceItemAction>(modelAction.InvoiceItemModelActionTypes.FETCH_INVOICE_ITEM_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.InvoiceItemActionOK(
						modelAction.InvoiceItemModelActionTypes.FETCH_INVOICE_ITEM_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceItemActionFail(
								modelAction.InvoiceItemModelActionTypes.FETCH_INVOICE_ITEM_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceItemAction>(modelAction.InvoiceItemModelActionTypes.FETCH_INVOICE_ITEM_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.InvoiceItemActionOK(
						modelAction.InvoiceItemModelActionTypes.FETCH_INVOICE_ITEM_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceItemActionFail(
								modelAction.InvoiceItemModelActionTypes.FETCH_INVOICE_ITEM_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
