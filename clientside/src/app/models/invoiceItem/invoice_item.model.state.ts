...
/**
 * InvoiceItemCollectionState would store the state of a collection of InvoiceItem
 */
export interface InvoiceItemCollectionState extends CollectionState {
 ...
 */
export interface InvoiceItemModelAudit extends AbstractModelAudit<InvoiceItemModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * InvoiceItemModelState would store the state of the model
 */
export interface InvoiceItemModelState {
	collectionState: {
		[key: string]: InvoiceItemCollectionState;
	};
	data: {
		[id: string]: InvoiceItemModel;
	};
	totalCount: number;
	audits: InvoiceItemModelAudit[];
 ...
 */
export const initialInvoiceItemCollectionState: InvoiceItemCollectionState = {
...
/**
 * The initial state of InvoiceItemModelState
 */
export const initialState: InvoiceItemModelState = {
	collectionState: {
