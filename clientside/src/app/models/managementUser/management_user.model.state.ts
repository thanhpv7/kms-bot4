...
/**
 * ManagementUserCollectionState would store the state of a collection of ManagementUser
 */
export interface ManagementUserCollectionState extends CollectionState {
 ...
 */
export interface ManagementUserModelAudit extends AbstractModelAudit<ManagementUserModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * ManagementUserModelState would store the state of the model
 */
export interface ManagementUserModelState {
	collectionState: {
		[key: string]: ManagementUserCollectionState;
	};
	data: {
		[id: string]: ManagementUserModel;
	};
	totalCount: number;
	audits: ManagementUserModelAudit[];
 ...
 */
export const initialManagementUserCollectionState: ManagementUserCollectionState = {
...
/**
 * The initial state of ManagementUserModelState
 */
export const initialState: ManagementUserModelState = {
	collectionState: {
