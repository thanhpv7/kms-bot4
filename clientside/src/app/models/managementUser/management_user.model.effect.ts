...
import * as modelAction from './management_user.model.action';
import {ManagementUserService} from '../../services/managementUser/management_user.service';
...
/**
 * Effect class used for side effects related to Management User model.
 */
@Injectable()
export class ManagementUserEffect {
	...
	constructor(
		...
		protected readonly service: ManagementUserService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ManagementUserAction>(modelAction.ManagementUserModelActionTypes.COUNT_MANAGEMENT_USERS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.ManagementUserActionOK(
						modelAction.ManagementUserModelActionTypes.COUNT_MANAGEMENT_USERS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ManagementUserActionFail(
								modelAction.ManagementUserModelActionTypes.COUNT_MANAGEMENT_USERS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ManagementUserAction>(modelAction.ManagementUserModelActionTypes.FETCH_MANAGEMENT_USER),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ManagementUserActionOK(
						modelAction.ManagementUserModelActionTypes.FETCH_MANAGEMENT_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ManagementUserActionFail(
								modelAction.ManagementUserModelActionTypes.FETCH_MANAGEMENT_USER_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ManagementUserAction>(modelAction.ManagementUserModelActionTypes.FETCH_ALL_MANAGEMENT_USER),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.ManagementUserActionOK(
						modelAction.ManagementUserModelActionTypes.FETCH_ALL_MANAGEMENT_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ManagementUserActionFail(
								modelAction.ManagementUserModelActionTypes.FETCH_ALL_MANAGEMENT_USER_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ManagementUserAction>(modelAction.ManagementUserModelActionTypes.FETCH_MANAGEMENT_USER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.ManagementUserActionOK(
						modelAction.ManagementUserModelActionTypes.FETCH_MANAGEMENT_USER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ManagementUserActionFail(
								modelAction.ManagementUserModelActionTypes.FETCH_MANAGEMENT_USER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ManagementUserAction>(modelAction.ManagementUserModelActionTypes.FETCH_LAST_MANAGEMENT_USER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.ManagementUserActionOK(
						modelAction.ManagementUserModelActionTypes.FETCH_LAST_MANAGEMENT_USER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ManagementUserActionFail(
								modelAction.ManagementUserModelActionTypes.FETCH_LAST_MANAGEMENT_USER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ManagementUserAction>(modelAction.ManagementUserModelActionTypes.CREATE_MANAGEMENT_USER),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as ManagementUserModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ManagementUserActionOK(
						modelAction.ManagementUserModelActionTypes.CREATE_MANAGEMENT_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ManagementUserActionFail(
								modelAction.ManagementUserModelActionTypes.CREATE_MANAGEMENT_USER_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ManagementUserAction>(modelAction.ManagementUserModelActionTypes.CREATE_ALL_MANAGEMENT_USER),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as ManagementUserModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ManagementUserActionOK(
						modelAction.ManagementUserModelActionTypes.CREATE_ALL_MANAGEMENT_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ManagementUserActionFail(
								modelAction.ManagementUserModelActionTypes.CREATE_ALL_MANAGEMENT_USER_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ManagementUserAction>(modelAction.ManagementUserModelActionTypes.UPDATE_MANAGEMENT_USER),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as ManagementUserModel;
				...
				return this.service.update(new ManagementUserModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.ManagementUserActionOK(
						modelAction.ManagementUserModelActionTypes.UPDATE_MANAGEMENT_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ManagementUserActionFail(
								modelAction.ManagementUserModelActionTypes.UPDATE_MANAGEMENT_USER_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ManagementUserAction>(modelAction.ManagementUserModelActionTypes.UPDATE_ALL_MANAGEMENT_USER),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as ManagementUserModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new ManagementUserModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ManagementUserActionOK(
						modelAction.ManagementUserModelActionTypes.UPDATE_ALL_MANAGEMENT_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ManagementUserActionFail(
								modelAction.ManagementUserModelActionTypes.UPDATE_ALL_MANAGEMENT_USER_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ManagementUserAction>(modelAction.ManagementUserModelActionTypes.DELETE_MANAGEMENT_USER),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.ManagementUserActionOK(
						modelAction.ManagementUserModelActionTypes.DELETE_MANAGEMENT_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ManagementUserActionFail(
								modelAction.ManagementUserModelActionTypes.DELETE_MANAGEMENT_USER_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ManagementUserAction>(modelAction.ManagementUserModelActionTypes.DELETE_MANAGEMENT_USER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.ManagementUserActionOK(
						modelAction.ManagementUserModelActionTypes.DELETE_MANAGEMENT_USER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ManagementUserActionFail(
								modelAction.ManagementUserModelActionTypes.DELETE_MANAGEMENT_USER_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ManagementUserAction>(modelAction.ManagementUserModelActionTypes.DELETE_ALL_MANAGEMENT_USER),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.ManagementUserActionOK(
						modelAction.ManagementUserModelActionTypes.DELETE_ALL_MANAGEMENT_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ManagementUserActionFail(
								modelAction.ManagementUserModelActionTypes.DELETE_ALL_MANAGEMENT_USER_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ManagementUserAction>(modelAction.ManagementUserModelActionTypes.EXPORT_MANAGEMENT_USER),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ManagementUserActionOK(
						modelAction.ManagementUserModelActionTypes.EXPORT_MANAGEMENT_USER,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ManagementUserAction>(modelAction.ManagementUserModelActionTypes.EXPORT_ALL_MANAGEMENT_USER),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ManagementUserActionOK(
						modelAction.ManagementUserModelActionTypes.EXPORT_ALL_MANAGEMENT_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ManagementUserActionFail(
								modelAction.ManagementUserModelActionTypes.EXPORT_ALL_MANAGEMENT_USER_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ManagementUserAction>(modelAction.ManagementUserModelActionTypes.EXPORT_MANAGEMENT_USER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ManagementUserActionOK(
						modelAction.ManagementUserModelActionTypes.EXPORT_MANAGEMENT_USER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ManagementUserActionFail(
								modelAction.ManagementUserModelActionTypes.EXPORT_MANAGEMENT_USER_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ManagementUserAction>(modelAction.ManagementUserModelActionTypes.IMPORT_MANAGEMENT_USERS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.ManagementUserActionOK(
						modelAction.ManagementUserModelActionTypes.IMPORT_MANAGEMENT_USERS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ManagementUserActionFail(
								modelAction.ManagementUserModelActionTypes.IMPORT_MANAGEMENT_USERS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ManagementUserAction>(modelAction.ManagementUserModelActionTypes.FETCH_MANAGEMENT_USER_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.ManagementUserActionOK(
						modelAction.ManagementUserModelActionTypes.FETCH_MANAGEMENT_USER_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.ManagementUserActionFail(
								modelAction.ManagementUserModelActionTypes.FETCH_MANAGEMENT_USER_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ManagementUserAction>(modelAction.ManagementUserModelActionTypes.FETCH_MANAGEMENT_USER_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.ManagementUserActionOK(
						modelAction.ManagementUserModelActionTypes.FETCH_MANAGEMENT_USER_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.ManagementUserActionFail(
								modelAction.ManagementUserModelActionTypes.FETCH_MANAGEMENT_USER_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
