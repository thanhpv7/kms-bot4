...
import * as modelAction from './bpjs_search_control_letter.model.action';
import {BpjsSearchControlLetterService} from '../../services/bpjsSearchControlLetter/bpjs_search_control_letter.service';
...
/**
 * Effect class used for side effects related to BPJS Search Control Letter model.
 */
@Injectable()
export class BpjsSearchControlLetterEffect {
	...
	constructor(
		...
		protected readonly service: BpjsSearchControlLetterService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSearchControlLetterAction>(modelAction.BpjsSearchControlLetterModelActionTypes.COUNT_BPJS_SEARCH_CONTROL_LETTERS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsSearchControlLetterActionOK(
						modelAction.BpjsSearchControlLetterModelActionTypes.COUNT_BPJS_SEARCH_CONTROL_LETTERS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSearchControlLetterActionFail(
								modelAction.BpjsSearchControlLetterModelActionTypes.COUNT_BPJS_SEARCH_CONTROL_LETTERS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSearchControlLetterAction>(modelAction.BpjsSearchControlLetterModelActionTypes.FETCH_BPJS_SEARCH_CONTROL_LETTER),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsSearchControlLetterActionOK(
						modelAction.BpjsSearchControlLetterModelActionTypes.FETCH_BPJS_SEARCH_CONTROL_LETTER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSearchControlLetterActionFail(
								modelAction.BpjsSearchControlLetterModelActionTypes.FETCH_BPJS_SEARCH_CONTROL_LETTER_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSearchControlLetterAction>(modelAction.BpjsSearchControlLetterModelActionTypes.FETCH_ALL_BPJS_SEARCH_CONTROL_LETTER),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsSearchControlLetterActionOK(
						modelAction.BpjsSearchControlLetterModelActionTypes.FETCH_ALL_BPJS_SEARCH_CONTROL_LETTER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSearchControlLetterActionFail(
								modelAction.BpjsSearchControlLetterModelActionTypes.FETCH_ALL_BPJS_SEARCH_CONTROL_LETTER_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSearchControlLetterAction>(modelAction.BpjsSearchControlLetterModelActionTypes.FETCH_BPJS_SEARCH_CONTROL_LETTER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsSearchControlLetterActionOK(
						modelAction.BpjsSearchControlLetterModelActionTypes.FETCH_BPJS_SEARCH_CONTROL_LETTER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSearchControlLetterActionFail(
								modelAction.BpjsSearchControlLetterModelActionTypes.FETCH_BPJS_SEARCH_CONTROL_LETTER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSearchControlLetterAction>(modelAction.BpjsSearchControlLetterModelActionTypes.FETCH_LAST_BPJS_SEARCH_CONTROL_LETTER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsSearchControlLetterActionOK(
						modelAction.BpjsSearchControlLetterModelActionTypes.FETCH_LAST_BPJS_SEARCH_CONTROL_LETTER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSearchControlLetterActionFail(
								modelAction.BpjsSearchControlLetterModelActionTypes.FETCH_LAST_BPJS_SEARCH_CONTROL_LETTER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSearchControlLetterAction>(modelAction.BpjsSearchControlLetterModelActionTypes.CREATE_BPJS_SEARCH_CONTROL_LETTER),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsSearchControlLetterModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsSearchControlLetterActionOK(
						modelAction.BpjsSearchControlLetterModelActionTypes.CREATE_BPJS_SEARCH_CONTROL_LETTER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSearchControlLetterActionFail(
								modelAction.BpjsSearchControlLetterModelActionTypes.CREATE_BPJS_SEARCH_CONTROL_LETTER_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSearchControlLetterAction>(modelAction.BpjsSearchControlLetterModelActionTypes.CREATE_ALL_BPJS_SEARCH_CONTROL_LETTER),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsSearchControlLetterModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsSearchControlLetterActionOK(
						modelAction.BpjsSearchControlLetterModelActionTypes.CREATE_ALL_BPJS_SEARCH_CONTROL_LETTER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSearchControlLetterActionFail(
								modelAction.BpjsSearchControlLetterModelActionTypes.CREATE_ALL_BPJS_SEARCH_CONTROL_LETTER_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSearchControlLetterAction>(modelAction.BpjsSearchControlLetterModelActionTypes.UPDATE_BPJS_SEARCH_CONTROL_LETTER),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsSearchControlLetterModel;
				...
				return this.service.update(new BpjsSearchControlLetterModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsSearchControlLetterActionOK(
						modelAction.BpjsSearchControlLetterModelActionTypes.UPDATE_BPJS_SEARCH_CONTROL_LETTER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSearchControlLetterActionFail(
								modelAction.BpjsSearchControlLetterModelActionTypes.UPDATE_BPJS_SEARCH_CONTROL_LETTER_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSearchControlLetterAction>(modelAction.BpjsSearchControlLetterModelActionTypes.UPDATE_ALL_BPJS_SEARCH_CONTROL_LETTER),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsSearchControlLetterModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsSearchControlLetterModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsSearchControlLetterActionOK(
						modelAction.BpjsSearchControlLetterModelActionTypes.UPDATE_ALL_BPJS_SEARCH_CONTROL_LETTER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSearchControlLetterActionFail(
								modelAction.BpjsSearchControlLetterModelActionTypes.UPDATE_ALL_BPJS_SEARCH_CONTROL_LETTER_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSearchControlLetterAction>(modelAction.BpjsSearchControlLetterModelActionTypes.DELETE_BPJS_SEARCH_CONTROL_LETTER),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsSearchControlLetterActionOK(
						modelAction.BpjsSearchControlLetterModelActionTypes.DELETE_BPJS_SEARCH_CONTROL_LETTER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSearchControlLetterActionFail(
								modelAction.BpjsSearchControlLetterModelActionTypes.DELETE_BPJS_SEARCH_CONTROL_LETTER_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSearchControlLetterAction>(modelAction.BpjsSearchControlLetterModelActionTypes.DELETE_BPJS_SEARCH_CONTROL_LETTER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsSearchControlLetterActionOK(
						modelAction.BpjsSearchControlLetterModelActionTypes.DELETE_BPJS_SEARCH_CONTROL_LETTER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSearchControlLetterActionFail(
								modelAction.BpjsSearchControlLetterModelActionTypes.DELETE_BPJS_SEARCH_CONTROL_LETTER_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSearchControlLetterAction>(modelAction.BpjsSearchControlLetterModelActionTypes.DELETE_ALL_BPJS_SEARCH_CONTROL_LETTER),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsSearchControlLetterActionOK(
						modelAction.BpjsSearchControlLetterModelActionTypes.DELETE_ALL_BPJS_SEARCH_CONTROL_LETTER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSearchControlLetterActionFail(
								modelAction.BpjsSearchControlLetterModelActionTypes.DELETE_ALL_BPJS_SEARCH_CONTROL_LETTER_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSearchControlLetterAction>(modelAction.BpjsSearchControlLetterModelActionTypes.EXPORT_BPJS_SEARCH_CONTROL_LETTER),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsSearchControlLetterActionOK(
						modelAction.BpjsSearchControlLetterModelActionTypes.EXPORT_BPJS_SEARCH_CONTROL_LETTER,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSearchControlLetterAction>(modelAction.BpjsSearchControlLetterModelActionTypes.EXPORT_ALL_BPJS_SEARCH_CONTROL_LETTER),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsSearchControlLetterActionOK(
						modelAction.BpjsSearchControlLetterModelActionTypes.EXPORT_ALL_BPJS_SEARCH_CONTROL_LETTER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSearchControlLetterActionFail(
								modelAction.BpjsSearchControlLetterModelActionTypes.EXPORT_ALL_BPJS_SEARCH_CONTROL_LETTER_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSearchControlLetterAction>(modelAction.BpjsSearchControlLetterModelActionTypes.EXPORT_BPJS_SEARCH_CONTROL_LETTER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsSearchControlLetterActionOK(
						modelAction.BpjsSearchControlLetterModelActionTypes.EXPORT_BPJS_SEARCH_CONTROL_LETTER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSearchControlLetterActionFail(
								modelAction.BpjsSearchControlLetterModelActionTypes.EXPORT_BPJS_SEARCH_CONTROL_LETTER_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSearchControlLetterAction>(modelAction.BpjsSearchControlLetterModelActionTypes.IMPORT_BPJS_SEARCH_CONTROL_LETTERS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsSearchControlLetterActionOK(
						modelAction.BpjsSearchControlLetterModelActionTypes.IMPORT_BPJS_SEARCH_CONTROL_LETTERS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSearchControlLetterActionFail(
								modelAction.BpjsSearchControlLetterModelActionTypes.IMPORT_BPJS_SEARCH_CONTROL_LETTERS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSearchControlLetterAction>(modelAction.BpjsSearchControlLetterModelActionTypes.FETCH_BPJS_SEARCH_CONTROL_LETTER_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsSearchControlLetterActionOK(
						modelAction.BpjsSearchControlLetterModelActionTypes.FETCH_BPJS_SEARCH_CONTROL_LETTER_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSearchControlLetterActionFail(
								modelAction.BpjsSearchControlLetterModelActionTypes.FETCH_BPJS_SEARCH_CONTROL_LETTER_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSearchControlLetterAction>(modelAction.BpjsSearchControlLetterModelActionTypes.FETCH_BPJS_SEARCH_CONTROL_LETTER_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsSearchControlLetterActionOK(
						modelAction.BpjsSearchControlLetterModelActionTypes.FETCH_BPJS_SEARCH_CONTROL_LETTER_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSearchControlLetterActionFail(
								modelAction.BpjsSearchControlLetterModelActionTypes.FETCH_BPJS_SEARCH_CONTROL_LETTER_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
