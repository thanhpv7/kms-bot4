...
/**
 * BpjsSearchControlLetterCollectionState would store the state of a collection of BpjsSearchControlLetter
 */
export interface BpjsSearchControlLetterCollectionState extends CollectionState {
 ...
 */
export interface BpjsSearchControlLetterModelAudit extends AbstractModelAudit<BpjsSearchControlLetterModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsSearchControlLetterModelState would store the state of the model
 */
export interface BpjsSearchControlLetterModelState {
	collectionState: {
		[key: string]: BpjsSearchControlLetterCollectionState;
	};
	data: {
		[id: string]: BpjsSearchControlLetterModel;
	};
	totalCount: number;
	audits: BpjsSearchControlLetterModelAudit[];
 ...
 */
export const initialBpjsSearchControlLetterCollectionState: BpjsSearchControlLetterCollectionState = {
...
/**
 * The initial state of BpjsSearchControlLetterModelState
 */
export const initialState: BpjsSearchControlLetterModelState = {
	collectionState: {
