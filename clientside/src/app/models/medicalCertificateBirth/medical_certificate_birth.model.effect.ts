...
import * as modelAction from './medical_certificate_birth.model.action';
import {MedicalCertificateBirthService} from '../../services/medicalCertificateBirth/medical_certificate_birth.service';
...
/**
 * Effect class used for side effects related to Medical Certificate Birth model.
 */
@Injectable()
export class MedicalCertificateBirthEffect {
	...
	constructor(
		...
		protected readonly service: MedicalCertificateBirthService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateBirthAction>(modelAction.MedicalCertificateBirthModelActionTypes.COUNT_MEDICAL_CERTIFICATE_BIRTHS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateBirthActionOK(
						modelAction.MedicalCertificateBirthModelActionTypes.COUNT_MEDICAL_CERTIFICATE_BIRTHS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateBirthActionFail(
								modelAction.MedicalCertificateBirthModelActionTypes.COUNT_MEDICAL_CERTIFICATE_BIRTHS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateBirthAction>(modelAction.MedicalCertificateBirthModelActionTypes.FETCH_MEDICAL_CERTIFICATE_BIRTH),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateBirthActionOK(
						modelAction.MedicalCertificateBirthModelActionTypes.FETCH_MEDICAL_CERTIFICATE_BIRTH_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateBirthActionFail(
								modelAction.MedicalCertificateBirthModelActionTypes.FETCH_MEDICAL_CERTIFICATE_BIRTH_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateBirthAction>(modelAction.MedicalCertificateBirthModelActionTypes.FETCH_ALL_MEDICAL_CERTIFICATE_BIRTH),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateBirthActionOK(
						modelAction.MedicalCertificateBirthModelActionTypes.FETCH_ALL_MEDICAL_CERTIFICATE_BIRTH_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateBirthActionFail(
								modelAction.MedicalCertificateBirthModelActionTypes.FETCH_ALL_MEDICAL_CERTIFICATE_BIRTH_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateBirthAction>(modelAction.MedicalCertificateBirthModelActionTypes.FETCH_MEDICAL_CERTIFICATE_BIRTH_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateBirthActionOK(
						modelAction.MedicalCertificateBirthModelActionTypes.FETCH_MEDICAL_CERTIFICATE_BIRTH_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateBirthActionFail(
								modelAction.MedicalCertificateBirthModelActionTypes.FETCH_MEDICAL_CERTIFICATE_BIRTH_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateBirthAction>(modelAction.MedicalCertificateBirthModelActionTypes.FETCH_LAST_MEDICAL_CERTIFICATE_BIRTH_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateBirthActionOK(
						modelAction.MedicalCertificateBirthModelActionTypes.FETCH_LAST_MEDICAL_CERTIFICATE_BIRTH_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateBirthActionFail(
								modelAction.MedicalCertificateBirthModelActionTypes.FETCH_LAST_MEDICAL_CERTIFICATE_BIRTH_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateBirthAction>(modelAction.MedicalCertificateBirthModelActionTypes.CREATE_MEDICAL_CERTIFICATE_BIRTH),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as MedicalCertificateBirthModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateBirthActionOK(
						modelAction.MedicalCertificateBirthModelActionTypes.CREATE_MEDICAL_CERTIFICATE_BIRTH_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateBirthActionFail(
								modelAction.MedicalCertificateBirthModelActionTypes.CREATE_MEDICAL_CERTIFICATE_BIRTH_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateBirthAction>(modelAction.MedicalCertificateBirthModelActionTypes.CREATE_ALL_MEDICAL_CERTIFICATE_BIRTH),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as MedicalCertificateBirthModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateBirthActionOK(
						modelAction.MedicalCertificateBirthModelActionTypes.CREATE_ALL_MEDICAL_CERTIFICATE_BIRTH_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateBirthActionFail(
								modelAction.MedicalCertificateBirthModelActionTypes.CREATE_ALL_MEDICAL_CERTIFICATE_BIRTH_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateBirthAction>(modelAction.MedicalCertificateBirthModelActionTypes.UPDATE_MEDICAL_CERTIFICATE_BIRTH),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as MedicalCertificateBirthModel;
				...
				return this.service.update(new MedicalCertificateBirthModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateBirthActionOK(
						modelAction.MedicalCertificateBirthModelActionTypes.UPDATE_MEDICAL_CERTIFICATE_BIRTH_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateBirthActionFail(
								modelAction.MedicalCertificateBirthModelActionTypes.UPDATE_MEDICAL_CERTIFICATE_BIRTH_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateBirthAction>(modelAction.MedicalCertificateBirthModelActionTypes.UPDATE_ALL_MEDICAL_CERTIFICATE_BIRTH),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as MedicalCertificateBirthModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new MedicalCertificateBirthModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateBirthActionOK(
						modelAction.MedicalCertificateBirthModelActionTypes.UPDATE_ALL_MEDICAL_CERTIFICATE_BIRTH_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateBirthActionFail(
								modelAction.MedicalCertificateBirthModelActionTypes.UPDATE_ALL_MEDICAL_CERTIFICATE_BIRTH_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateBirthAction>(modelAction.MedicalCertificateBirthModelActionTypes.DELETE_MEDICAL_CERTIFICATE_BIRTH),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateBirthActionOK(
						modelAction.MedicalCertificateBirthModelActionTypes.DELETE_MEDICAL_CERTIFICATE_BIRTH_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateBirthActionFail(
								modelAction.MedicalCertificateBirthModelActionTypes.DELETE_MEDICAL_CERTIFICATE_BIRTH_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateBirthAction>(modelAction.MedicalCertificateBirthModelActionTypes.DELETE_MEDICAL_CERTIFICATE_BIRTH_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateBirthActionOK(
						modelAction.MedicalCertificateBirthModelActionTypes.DELETE_MEDICAL_CERTIFICATE_BIRTH_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateBirthActionFail(
								modelAction.MedicalCertificateBirthModelActionTypes.DELETE_MEDICAL_CERTIFICATE_BIRTH_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateBirthAction>(modelAction.MedicalCertificateBirthModelActionTypes.DELETE_ALL_MEDICAL_CERTIFICATE_BIRTH),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateBirthActionOK(
						modelAction.MedicalCertificateBirthModelActionTypes.DELETE_ALL_MEDICAL_CERTIFICATE_BIRTH_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateBirthActionFail(
								modelAction.MedicalCertificateBirthModelActionTypes.DELETE_ALL_MEDICAL_CERTIFICATE_BIRTH_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateBirthAction>(modelAction.MedicalCertificateBirthModelActionTypes.EXPORT_MEDICAL_CERTIFICATE_BIRTH),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateBirthActionOK(
						modelAction.MedicalCertificateBirthModelActionTypes.EXPORT_MEDICAL_CERTIFICATE_BIRTH,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateBirthAction>(modelAction.MedicalCertificateBirthModelActionTypes.EXPORT_ALL_MEDICAL_CERTIFICATE_BIRTH),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateBirthActionOK(
						modelAction.MedicalCertificateBirthModelActionTypes.EXPORT_ALL_MEDICAL_CERTIFICATE_BIRTH_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateBirthActionFail(
								modelAction.MedicalCertificateBirthModelActionTypes.EXPORT_ALL_MEDICAL_CERTIFICATE_BIRTH_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateBirthAction>(modelAction.MedicalCertificateBirthModelActionTypes.EXPORT_MEDICAL_CERTIFICATE_BIRTH_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateBirthActionOK(
						modelAction.MedicalCertificateBirthModelActionTypes.EXPORT_MEDICAL_CERTIFICATE_BIRTH_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateBirthActionFail(
								modelAction.MedicalCertificateBirthModelActionTypes.EXPORT_MEDICAL_CERTIFICATE_BIRTH_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateBirthAction>(modelAction.MedicalCertificateBirthModelActionTypes.IMPORT_MEDICAL_CERTIFICATE_BIRTHS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateBirthActionOK(
						modelAction.MedicalCertificateBirthModelActionTypes.IMPORT_MEDICAL_CERTIFICATE_BIRTHS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateBirthActionFail(
								modelAction.MedicalCertificateBirthModelActionTypes.IMPORT_MEDICAL_CERTIFICATE_BIRTHS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateBirthAction>(modelAction.MedicalCertificateBirthModelActionTypes.FETCH_MEDICAL_CERTIFICATE_BIRTH_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.MedicalCertificateBirthActionOK(
						modelAction.MedicalCertificateBirthModelActionTypes.FETCH_MEDICAL_CERTIFICATE_BIRTH_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateBirthActionFail(
								modelAction.MedicalCertificateBirthModelActionTypes.FETCH_MEDICAL_CERTIFICATE_BIRTH_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateBirthAction>(modelAction.MedicalCertificateBirthModelActionTypes.FETCH_MEDICAL_CERTIFICATE_BIRTH_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.MedicalCertificateBirthActionOK(
						modelAction.MedicalCertificateBirthModelActionTypes.FETCH_MEDICAL_CERTIFICATE_BIRTH_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateBirthActionFail(
								modelAction.MedicalCertificateBirthModelActionTypes.FETCH_MEDICAL_CERTIFICATE_BIRTH_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
