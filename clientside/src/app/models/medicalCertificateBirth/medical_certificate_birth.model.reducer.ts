...
import {initialMedicalCertificateBirthCollectionState} from './medical_certificate_birth.model.state';
...
export function modelReducer(currentState: ModelState, action: Action): ModelState {
	...
	const className = (action as modelAction.BaseMedicalCertificateBirthAction).className;
	...
	return produce(currentState, draft => {
		...
		switch (action.type) {
			case modelAction.MedicalCertificateBirthModelActionTypes.CREATE_MEDICAL_CERTIFICATE_BIRTH_OK:
				const createdModel = (action as modelAction.MedicalCertificateBirthActionOK ).stateConfig.targetModel;
				...
				MedicalCertificateBirthModel.deepParse(createdModel).forEach(model => {
				...
				break;
			case modelAction.MedicalCertificateBirthModelActionTypes.CREATE_MEDICAL_CERTIFICATE_BIRTH_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.MedicalCertificateBirthModelActionTypes.CREATE_ALL_MEDICAL_CERTIFICATE_BIRTH_OK:
				const createdModels = (action as modelAction.MedicalCertificateBirthActionOK).stateConfig.targetModels;
				const collectionIdAfterCreateAll = (action as modelAction.MedicalCertificateBirthActionOK).stateConfig.collectionId;
				...
				createdModels.forEach((m) => {
					MedicalCertificateBirthModel.deepParse(m).forEach(model => {
						draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
						(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
					});
				});
				...
				break;
			case modelAction.MedicalCertificateBirthModelActionTypes.CREATE_ALL_MEDICAL_CERTIFICATE_BIRTH_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.MedicalCertificateBirthModelActionTypes.DELETE_MEDICAL_CERTIFICATE_BIRTH_OK:
				const deletedModelId = (action as modelAction.MedicalCertificateBirthActionOK).stateConfig.targetModelId;
				const collectionIdAfterDelete = (action as modelAction.MedicalCertificateBirthActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.MedicalCertificateBirthModelActionTypes.DELETE_ALL_MEDICAL_CERTIFICATE_BIRTH_OK:
				const deletedModelIds = (action as modelAction.MedicalCertificateBirthActionOK).stateConfig.targetModelIds;
				const collectionIdAfterDeleteAll = (action as modelAction.MedicalCertificateBirthActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.MedicalCertificateBirthModelActionTypes.DELETE_MEDICAL_CERTIFICATE_BIRTH_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.MedicalCertificateBirthModelActionTypes.UPDATE_MEDICAL_CERTIFICATE_BIRTH_OK:
				const updatedModel = (action as modelAction.MedicalCertificateBirthActionOK).stateConfig.targetModel;
				...
				MedicalCertificateBirthModel.deepParse(updatedModel).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalCertificateBirthModelActionTypes.UPDATE_MEDICAL_CERTIFICATE_BIRTH_FAIL:
				// TODO: Add handling of failure
				break;

			case modelAction.MedicalCertificateBirthModelActionTypes.UPDATE_ALL_MEDICAL_CERTIFICATE_BIRTH_OK:
				const updatedModels = (action as modelAction.MedicalCertificateBirthActionOK).stateConfig.targetModels;
				const collectionIdAfterUpdateAll = (action as modelAction.MedicalCertificateBirthActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.MedicalCertificateBirthModelActionTypes.UPDATE_ALL_MEDICAL_CERTIFICATE_BIRTH_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.MedicalCertificateBirthModelActionTypes.FETCH_MEDICAL_CERTIFICATE_BIRTH_OK:
				let fetchedModel = (action as modelAction.MedicalCertificateBirthActionOK).stateConfig.targetModel;
				...
				MedicalCertificateBirthModel.deepParse(fetchedModel).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalCertificateBirthModelActionTypes.FETCH_ALL_MEDICAL_CERTIFICATE_BIRTH_OK:
				const totalCountAfterFetchAll = (action as modelAction.MedicalCertificateBirthActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchAll = (action as modelAction.MedicalCertificateBirthActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchAll = (action as modelAction.MedicalCertificateBirthActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchAll = (action as modelAction.MedicalCertificateBirthActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchAll.map(model => MedicalCertificateBirthModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalCertificateBirthModelActionTypes.FETCH_MEDICAL_CERTIFICATE_BIRTH_AUDIT_OK:
				const audits = (action as modelAction.MedicalCertificateBirthActionOK).audits;
				...
				break;
			case modelAction.MedicalCertificateBirthModelActionTypes.FETCH_MEDICAL_CERTIFICATE_BIRTH_AUDITS_BY_ENTITY_ID_OK:
				const auditsByEntityId = (action as modelAction.MedicalCertificateBirthActionOK).audits;
				...
				break;
			case modelAction.MedicalCertificateBirthModelActionTypes.FETCH_MEDICAL_CERTIFICATE_BIRTH_WITH_QUERY_OK:
				const totalCountAfterFetchWithQuery = (action as modelAction.MedicalCertificateBirthActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchWithQuery = (action as modelAction.MedicalCertificateBirthActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchWithQuery = (action as modelAction.MedicalCertificateBirthActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchWithQuery = (action as modelAction.MedicalCertificateBirthActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchWithQuery.map(model => MedicalCertificateBirthModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalCertificateBirthModelActionTypes.FETCH_LAST_MEDICAL_CERTIFICATE_BIRTH_WITH_QUERY_OK:
				const totalCountAfterFetchLastWithQuery = (action as modelAction.MedicalCertificateBirthActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchLastWithQuery = (action as modelAction.MedicalCertificateBirthActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchLastWithQuery = (action as modelAction.MedicalCertificateBirthActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchLastWithQuery = (action as modelAction.MedicalCertificateBirthActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchLastWithQuery.map(model => MedicalCertificateBirthModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalCertificateBirthModelActionTypes.COUNT_MEDICAL_CERTIFICATE_BIRTHS_OK:
				const totalCountAfterCount = (action as modelAction.MedicalCertificateBirthActionOK).stateConfig.totalCount;
				...
				break;
			case modelAction.MedicalCertificateBirthModelActionTypes.INITIALISE_MEDICAL_CERTIFICATE_BIRTH_COLLECTION_STATE:
				const collectionIdToInitialise =  (action as modelAction.MedicalCertificateBirthActionOK).stateConfig.collectionId;
				const queryParamsToInitialise = (action as modelAction.MedicalCertificateBirthActionOK).stateConfig.queryParams;
				...
				if (!draft[className].collectionState[collectionIdToInitialise]) {
					draft[className].collectionState[collectionIdToInitialise] = {
						...initialMedicalCertificateBirthCollectionState
					};
				}
