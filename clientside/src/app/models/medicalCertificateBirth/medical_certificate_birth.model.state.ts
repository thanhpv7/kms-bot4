...
/**
 * MedicalCertificateBirthCollectionState would store the state of a collection of MedicalCertificateBirth
 */
export interface MedicalCertificateBirthCollectionState extends CollectionState {
 ...
 */
export interface MedicalCertificateBirthModelAudit extends AbstractModelAudit<MedicalCertificateBirthModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * MedicalCertificateBirthModelState would store the state of the model
 */
export interface MedicalCertificateBirthModelState {
	collectionState: {
		[key: string]: MedicalCertificateBirthCollectionState;
	};
	data: {
		[id: string]: MedicalCertificateBirthModel;
	};
	totalCount: number;
	audits: MedicalCertificateBirthModelAudit[];
 ...
 */
export const initialMedicalCertificateBirthCollectionState: MedicalCertificateBirthCollectionState = {
...
/**
 * The initial state of MedicalCertificateBirthModelState
 */
export const initialState: MedicalCertificateBirthModelState = {
	collectionState: {
