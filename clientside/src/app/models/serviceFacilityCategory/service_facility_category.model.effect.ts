...
import * as modelAction from './service_facility_category.model.action';
import {ServiceFacilityCategoryService} from '../../services/serviceFacilityCategory/service_facility_category.service';
...
/**
 * Effect class used for side effects related to Service Facility Category model.
 */
@Injectable()
export class ServiceFacilityCategoryEffect {
	...
	constructor(
		...
		protected readonly service: ServiceFacilityCategoryService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceFacilityCategoryAction>(modelAction.ServiceFacilityCategoryModelActionTypes.COUNT_SERVICE_FACILITY_CATEGORYS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.ServiceFacilityCategoryActionOK(
						modelAction.ServiceFacilityCategoryModelActionTypes.COUNT_SERVICE_FACILITY_CATEGORYS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceFacilityCategoryActionFail(
								modelAction.ServiceFacilityCategoryModelActionTypes.COUNT_SERVICE_FACILITY_CATEGORYS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceFacilityCategoryAction>(modelAction.ServiceFacilityCategoryModelActionTypes.FETCH_SERVICE_FACILITY_CATEGORY),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ServiceFacilityCategoryActionOK(
						modelAction.ServiceFacilityCategoryModelActionTypes.FETCH_SERVICE_FACILITY_CATEGORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceFacilityCategoryActionFail(
								modelAction.ServiceFacilityCategoryModelActionTypes.FETCH_SERVICE_FACILITY_CATEGORY_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceFacilityCategoryAction>(modelAction.ServiceFacilityCategoryModelActionTypes.FETCH_ALL_SERVICE_FACILITY_CATEGORY),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.ServiceFacilityCategoryActionOK(
						modelAction.ServiceFacilityCategoryModelActionTypes.FETCH_ALL_SERVICE_FACILITY_CATEGORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceFacilityCategoryActionFail(
								modelAction.ServiceFacilityCategoryModelActionTypes.FETCH_ALL_SERVICE_FACILITY_CATEGORY_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceFacilityCategoryAction>(modelAction.ServiceFacilityCategoryModelActionTypes.FETCH_SERVICE_FACILITY_CATEGORY_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.ServiceFacilityCategoryActionOK(
						modelAction.ServiceFacilityCategoryModelActionTypes.FETCH_SERVICE_FACILITY_CATEGORY_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceFacilityCategoryActionFail(
								modelAction.ServiceFacilityCategoryModelActionTypes.FETCH_SERVICE_FACILITY_CATEGORY_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceFacilityCategoryAction>(modelAction.ServiceFacilityCategoryModelActionTypes.FETCH_LAST_SERVICE_FACILITY_CATEGORY_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.ServiceFacilityCategoryActionOK(
						modelAction.ServiceFacilityCategoryModelActionTypes.FETCH_LAST_SERVICE_FACILITY_CATEGORY_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceFacilityCategoryActionFail(
								modelAction.ServiceFacilityCategoryModelActionTypes.FETCH_LAST_SERVICE_FACILITY_CATEGORY_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceFacilityCategoryAction>(modelAction.ServiceFacilityCategoryModelActionTypes.CREATE_SERVICE_FACILITY_CATEGORY),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as ServiceFacilityCategoryModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ServiceFacilityCategoryActionOK(
						modelAction.ServiceFacilityCategoryModelActionTypes.CREATE_SERVICE_FACILITY_CATEGORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceFacilityCategoryActionFail(
								modelAction.ServiceFacilityCategoryModelActionTypes.CREATE_SERVICE_FACILITY_CATEGORY_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceFacilityCategoryAction>(modelAction.ServiceFacilityCategoryModelActionTypes.CREATE_ALL_SERVICE_FACILITY_CATEGORY),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as ServiceFacilityCategoryModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ServiceFacilityCategoryActionOK(
						modelAction.ServiceFacilityCategoryModelActionTypes.CREATE_ALL_SERVICE_FACILITY_CATEGORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceFacilityCategoryActionFail(
								modelAction.ServiceFacilityCategoryModelActionTypes.CREATE_ALL_SERVICE_FACILITY_CATEGORY_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceFacilityCategoryAction>(modelAction.ServiceFacilityCategoryModelActionTypes.UPDATE_SERVICE_FACILITY_CATEGORY),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as ServiceFacilityCategoryModel;
				...
				return this.service.update(new ServiceFacilityCategoryModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.ServiceFacilityCategoryActionOK(
						modelAction.ServiceFacilityCategoryModelActionTypes.UPDATE_SERVICE_FACILITY_CATEGORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceFacilityCategoryActionFail(
								modelAction.ServiceFacilityCategoryModelActionTypes.UPDATE_SERVICE_FACILITY_CATEGORY_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceFacilityCategoryAction>(modelAction.ServiceFacilityCategoryModelActionTypes.UPDATE_ALL_SERVICE_FACILITY_CATEGORY),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as ServiceFacilityCategoryModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new ServiceFacilityCategoryModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ServiceFacilityCategoryActionOK(
						modelAction.ServiceFacilityCategoryModelActionTypes.UPDATE_ALL_SERVICE_FACILITY_CATEGORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceFacilityCategoryActionFail(
								modelAction.ServiceFacilityCategoryModelActionTypes.UPDATE_ALL_SERVICE_FACILITY_CATEGORY_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceFacilityCategoryAction>(modelAction.ServiceFacilityCategoryModelActionTypes.DELETE_SERVICE_FACILITY_CATEGORY),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.ServiceFacilityCategoryActionOK(
						modelAction.ServiceFacilityCategoryModelActionTypes.DELETE_SERVICE_FACILITY_CATEGORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceFacilityCategoryActionFail(
								modelAction.ServiceFacilityCategoryModelActionTypes.DELETE_SERVICE_FACILITY_CATEGORY_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceFacilityCategoryAction>(modelAction.ServiceFacilityCategoryModelActionTypes.DELETE_SERVICE_FACILITY_CATEGORY_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.ServiceFacilityCategoryActionOK(
						modelAction.ServiceFacilityCategoryModelActionTypes.DELETE_SERVICE_FACILITY_CATEGORY_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceFacilityCategoryActionFail(
								modelAction.ServiceFacilityCategoryModelActionTypes.DELETE_SERVICE_FACILITY_CATEGORY_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceFacilityCategoryAction>(modelAction.ServiceFacilityCategoryModelActionTypes.DELETE_ALL_SERVICE_FACILITY_CATEGORY),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.ServiceFacilityCategoryActionOK(
						modelAction.ServiceFacilityCategoryModelActionTypes.DELETE_ALL_SERVICE_FACILITY_CATEGORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceFacilityCategoryActionFail(
								modelAction.ServiceFacilityCategoryModelActionTypes.DELETE_ALL_SERVICE_FACILITY_CATEGORY_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceFacilityCategoryAction>(modelAction.ServiceFacilityCategoryModelActionTypes.EXPORT_SERVICE_FACILITY_CATEGORY),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ServiceFacilityCategoryActionOK(
						modelAction.ServiceFacilityCategoryModelActionTypes.EXPORT_SERVICE_FACILITY_CATEGORY,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceFacilityCategoryAction>(modelAction.ServiceFacilityCategoryModelActionTypes.EXPORT_ALL_SERVICE_FACILITY_CATEGORY),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ServiceFacilityCategoryActionOK(
						modelAction.ServiceFacilityCategoryModelActionTypes.EXPORT_ALL_SERVICE_FACILITY_CATEGORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceFacilityCategoryActionFail(
								modelAction.ServiceFacilityCategoryModelActionTypes.EXPORT_ALL_SERVICE_FACILITY_CATEGORY_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceFacilityCategoryAction>(modelAction.ServiceFacilityCategoryModelActionTypes.EXPORT_SERVICE_FACILITY_CATEGORY_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ServiceFacilityCategoryActionOK(
						modelAction.ServiceFacilityCategoryModelActionTypes.EXPORT_SERVICE_FACILITY_CATEGORY_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceFacilityCategoryActionFail(
								modelAction.ServiceFacilityCategoryModelActionTypes.EXPORT_SERVICE_FACILITY_CATEGORY_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceFacilityCategoryAction>(modelAction.ServiceFacilityCategoryModelActionTypes.IMPORT_SERVICE_FACILITY_CATEGORYS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.ServiceFacilityCategoryActionOK(
						modelAction.ServiceFacilityCategoryModelActionTypes.IMPORT_SERVICE_FACILITY_CATEGORYS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceFacilityCategoryActionFail(
								modelAction.ServiceFacilityCategoryModelActionTypes.IMPORT_SERVICE_FACILITY_CATEGORYS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceFacilityCategoryAction>(modelAction.ServiceFacilityCategoryModelActionTypes.FETCH_SERVICE_FACILITY_CATEGORY_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.ServiceFacilityCategoryActionOK(
						modelAction.ServiceFacilityCategoryModelActionTypes.FETCH_SERVICE_FACILITY_CATEGORY_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.ServiceFacilityCategoryActionFail(
								modelAction.ServiceFacilityCategoryModelActionTypes.FETCH_SERVICE_FACILITY_CATEGORY_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceFacilityCategoryAction>(modelAction.ServiceFacilityCategoryModelActionTypes.FETCH_SERVICE_FACILITY_CATEGORY_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.ServiceFacilityCategoryActionOK(
						modelAction.ServiceFacilityCategoryModelActionTypes.FETCH_SERVICE_FACILITY_CATEGORY_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.ServiceFacilityCategoryActionFail(
								modelAction.ServiceFacilityCategoryModelActionTypes.FETCH_SERVICE_FACILITY_CATEGORY_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
