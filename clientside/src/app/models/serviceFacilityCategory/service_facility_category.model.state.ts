...
/**
 * ServiceFacilityCategoryCollectionState would store the state of a collection of ServiceFacilityCategory
 */
export interface ServiceFacilityCategoryCollectionState extends CollectionState {
 ...
 */
export interface ServiceFacilityCategoryModelAudit extends AbstractModelAudit<ServiceFacilityCategoryModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * ServiceFacilityCategoryModelState would store the state of the model
 */
export interface ServiceFacilityCategoryModelState {
	collectionState: {
		[key: string]: ServiceFacilityCategoryCollectionState;
	};
	data: {
		[id: string]: ServiceFacilityCategoryModel;
	};
	totalCount: number;
	audits: ServiceFacilityCategoryModelAudit[];
 ...
 */
export const initialServiceFacilityCategoryCollectionState: ServiceFacilityCategoryCollectionState = {
...
/**
 * The initial state of ServiceFacilityCategoryModelState
 */
export const initialState: ServiceFacilityCategoryModelState = {
	collectionState: {
