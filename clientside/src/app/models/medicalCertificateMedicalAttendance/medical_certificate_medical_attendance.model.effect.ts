...
import * as modelAction from './medical_certificate_medical_attendance.model.action';
import {MedicalCertificateMedicalAttendanceService} from '../../services/medicalCertificateMedicalAttendance/medical_certificate_medical_attendance.service';
...
/**
 * Effect class used for side effects related to Medical Certificate Medical Attendance model.
 */
@Injectable()
export class MedicalCertificateMedicalAttendanceEffect {
	...
	constructor(
		...
		protected readonly service: MedicalCertificateMedicalAttendanceService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateMedicalAttendanceAction>(modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.COUNT_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCES),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateMedicalAttendanceActionOK(
						modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.COUNT_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCES_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateMedicalAttendanceActionFail(
								modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.COUNT_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCES_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateMedicalAttendanceAction>(modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.FETCH_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateMedicalAttendanceActionOK(
						modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.FETCH_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateMedicalAttendanceActionFail(
								modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.FETCH_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateMedicalAttendanceAction>(modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.FETCH_ALL_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateMedicalAttendanceActionOK(
						modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.FETCH_ALL_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateMedicalAttendanceActionFail(
								modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.FETCH_ALL_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateMedicalAttendanceAction>(modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.FETCH_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateMedicalAttendanceActionOK(
						modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.FETCH_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateMedicalAttendanceActionFail(
								modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.FETCH_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateMedicalAttendanceAction>(modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.FETCH_LAST_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateMedicalAttendanceActionOK(
						modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.FETCH_LAST_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateMedicalAttendanceActionFail(
								modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.FETCH_LAST_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateMedicalAttendanceAction>(modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.CREATE_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as MedicalCertificateMedicalAttendanceModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateMedicalAttendanceActionOK(
						modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.CREATE_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateMedicalAttendanceActionFail(
								modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.CREATE_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateMedicalAttendanceAction>(modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.CREATE_ALL_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as MedicalCertificateMedicalAttendanceModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateMedicalAttendanceActionOK(
						modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.CREATE_ALL_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateMedicalAttendanceActionFail(
								modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.CREATE_ALL_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateMedicalAttendanceAction>(modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.UPDATE_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as MedicalCertificateMedicalAttendanceModel;
				...
				return this.service.update(new MedicalCertificateMedicalAttendanceModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateMedicalAttendanceActionOK(
						modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.UPDATE_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateMedicalAttendanceActionFail(
								modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.UPDATE_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateMedicalAttendanceAction>(modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.UPDATE_ALL_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as MedicalCertificateMedicalAttendanceModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new MedicalCertificateMedicalAttendanceModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateMedicalAttendanceActionOK(
						modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.UPDATE_ALL_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateMedicalAttendanceActionFail(
								modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.UPDATE_ALL_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateMedicalAttendanceAction>(modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.DELETE_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateMedicalAttendanceActionOK(
						modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.DELETE_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateMedicalAttendanceActionFail(
								modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.DELETE_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateMedicalAttendanceAction>(modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.DELETE_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateMedicalAttendanceActionOK(
						modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.DELETE_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateMedicalAttendanceActionFail(
								modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.DELETE_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateMedicalAttendanceAction>(modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.DELETE_ALL_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateMedicalAttendanceActionOK(
						modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.DELETE_ALL_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateMedicalAttendanceActionFail(
								modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.DELETE_ALL_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateMedicalAttendanceAction>(modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.EXPORT_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateMedicalAttendanceActionOK(
						modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.EXPORT_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateMedicalAttendanceAction>(modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.EXPORT_ALL_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateMedicalAttendanceActionOK(
						modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.EXPORT_ALL_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateMedicalAttendanceActionFail(
								modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.EXPORT_ALL_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateMedicalAttendanceAction>(modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.EXPORT_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateMedicalAttendanceActionOK(
						modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.EXPORT_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateMedicalAttendanceActionFail(
								modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.EXPORT_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateMedicalAttendanceAction>(modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.IMPORT_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCES),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateMedicalAttendanceActionOK(
						modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.IMPORT_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCES_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateMedicalAttendanceActionFail(
								modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.IMPORT_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCES_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateMedicalAttendanceAction>(modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.FETCH_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.MedicalCertificateMedicalAttendanceActionOK(
						modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.FETCH_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateMedicalAttendanceActionFail(
								modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.FETCH_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateMedicalAttendanceAction>(modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.FETCH_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.MedicalCertificateMedicalAttendanceActionOK(
						modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.FETCH_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateMedicalAttendanceActionFail(
								modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.FETCH_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
