...
import {initialMedicalCertificateMedicalAttendanceCollectionState} from './medical_certificate_medical_attendance.model.state';
...
export function modelReducer(currentState: ModelState, action: Action): ModelState {
	...
	const className = (action as modelAction.BaseMedicalCertificateMedicalAttendanceAction).className;
	...
	return produce(currentState, draft => {
		...
		switch (action.type) {
			case modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.CREATE_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_OK:
				const createdModel = (action as modelAction.MedicalCertificateMedicalAttendanceActionOK ).stateConfig.targetModel;
				...
				MedicalCertificateMedicalAttendanceModel.deepParse(createdModel).forEach(model => {
				...
				break;
			case modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.CREATE_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.CREATE_ALL_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_OK:
				const createdModels = (action as modelAction.MedicalCertificateMedicalAttendanceActionOK).stateConfig.targetModels;
				const collectionIdAfterCreateAll = (action as modelAction.MedicalCertificateMedicalAttendanceActionOK).stateConfig.collectionId;
				...
				createdModels.forEach((m) => {
					MedicalCertificateMedicalAttendanceModel.deepParse(m).forEach(model => {
						draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
						(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
					});
				});
				...
				break;
			case modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.CREATE_ALL_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.DELETE_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_OK:
				const deletedModelId = (action as modelAction.MedicalCertificateMedicalAttendanceActionOK).stateConfig.targetModelId;
				const collectionIdAfterDelete = (action as modelAction.MedicalCertificateMedicalAttendanceActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.DELETE_ALL_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_OK:
				const deletedModelIds = (action as modelAction.MedicalCertificateMedicalAttendanceActionOK).stateConfig.targetModelIds;
				const collectionIdAfterDeleteAll = (action as modelAction.MedicalCertificateMedicalAttendanceActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.DELETE_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.UPDATE_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_OK:
				const updatedModel = (action as modelAction.MedicalCertificateMedicalAttendanceActionOK).stateConfig.targetModel;
				...
				MedicalCertificateMedicalAttendanceModel.deepParse(updatedModel).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.UPDATE_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_FAIL:
				// TODO: Add handling of failure
				break;

			case modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.UPDATE_ALL_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_OK:
				const updatedModels = (action as modelAction.MedicalCertificateMedicalAttendanceActionOK).stateConfig.targetModels;
				const collectionIdAfterUpdateAll = (action as modelAction.MedicalCertificateMedicalAttendanceActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.UPDATE_ALL_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.FETCH_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_OK:
				let fetchedModel = (action as modelAction.MedicalCertificateMedicalAttendanceActionOK).stateConfig.targetModel;
				...
				MedicalCertificateMedicalAttendanceModel.deepParse(fetchedModel).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.FETCH_ALL_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_OK:
				const totalCountAfterFetchAll = (action as modelAction.MedicalCertificateMedicalAttendanceActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchAll = (action as modelAction.MedicalCertificateMedicalAttendanceActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchAll = (action as modelAction.MedicalCertificateMedicalAttendanceActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchAll = (action as modelAction.MedicalCertificateMedicalAttendanceActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchAll.map(model => MedicalCertificateMedicalAttendanceModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.FETCH_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_AUDIT_OK:
				const audits = (action as modelAction.MedicalCertificateMedicalAttendanceActionOK).audits;
				...
				break;
			case modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.FETCH_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_AUDITS_BY_ENTITY_ID_OK:
				const auditsByEntityId = (action as modelAction.MedicalCertificateMedicalAttendanceActionOK).audits;
				...
				break;
			case modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.FETCH_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_WITH_QUERY_OK:
				const totalCountAfterFetchWithQuery = (action as modelAction.MedicalCertificateMedicalAttendanceActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchWithQuery = (action as modelAction.MedicalCertificateMedicalAttendanceActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchWithQuery = (action as modelAction.MedicalCertificateMedicalAttendanceActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchWithQuery = (action as modelAction.MedicalCertificateMedicalAttendanceActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchWithQuery.map(model => MedicalCertificateMedicalAttendanceModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.FETCH_LAST_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_WITH_QUERY_OK:
				const totalCountAfterFetchLastWithQuery = (action as modelAction.MedicalCertificateMedicalAttendanceActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchLastWithQuery = (action as modelAction.MedicalCertificateMedicalAttendanceActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchLastWithQuery = (action as modelAction.MedicalCertificateMedicalAttendanceActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchLastWithQuery = (action as modelAction.MedicalCertificateMedicalAttendanceActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchLastWithQuery.map(model => MedicalCertificateMedicalAttendanceModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.COUNT_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCES_OK:
				const totalCountAfterCount = (action as modelAction.MedicalCertificateMedicalAttendanceActionOK).stateConfig.totalCount;
				...
				break;
			case modelAction.MedicalCertificateMedicalAttendanceModelActionTypes.INITIALISE_MEDICAL_CERTIFICATE_MEDICAL_ATTENDANCE_COLLECTION_STATE:
				const collectionIdToInitialise =  (action as modelAction.MedicalCertificateMedicalAttendanceActionOK).stateConfig.collectionId;
				const queryParamsToInitialise = (action as modelAction.MedicalCertificateMedicalAttendanceActionOK).stateConfig.queryParams;
				...
				if (!draft[className].collectionState[collectionIdToInitialise]) {
					draft[className].collectionState[collectionIdToInitialise] = {
						...initialMedicalCertificateMedicalAttendanceCollectionState
					};
				}
