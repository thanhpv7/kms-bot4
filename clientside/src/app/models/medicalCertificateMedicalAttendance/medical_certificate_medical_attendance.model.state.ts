...
/**
 * MedicalCertificateMedicalAttendanceCollectionState would store the state of a collection of MedicalCertificateMedicalAttendance
 */
export interface MedicalCertificateMedicalAttendanceCollectionState extends CollectionState {
 ...
 */
export interface MedicalCertificateMedicalAttendanceModelAudit extends AbstractModelAudit<MedicalCertificateMedicalAttendanceModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * MedicalCertificateMedicalAttendanceModelState would store the state of the model
 */
export interface MedicalCertificateMedicalAttendanceModelState {
	collectionState: {
		[key: string]: MedicalCertificateMedicalAttendanceCollectionState;
	};
	data: {
		[id: string]: MedicalCertificateMedicalAttendanceModel;
	};
	totalCount: number;
	audits: MedicalCertificateMedicalAttendanceModelAudit[];
 ...
 */
export const initialMedicalCertificateMedicalAttendanceCollectionState: MedicalCertificateMedicalAttendanceCollectionState = {
...
/**
 * The initial state of MedicalCertificateMedicalAttendanceModelState
 */
export const initialState: MedicalCertificateMedicalAttendanceModelState = {
	collectionState: {
