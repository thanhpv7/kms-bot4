...
import * as modelAction from './nurse_vital_sign_measurement.model.action';
import {NurseVitalSignMeasurementService} from '../../services/nurseVitalSignMeasurement/nurse_vital_sign_measurement.service';
...
/**
 * Effect class used for side effects related to Nurse Vital Sign Measurement model.
 */
@Injectable()
export class NurseVitalSignMeasurementEffect {
	...
	constructor(
		...
		protected readonly service: NurseVitalSignMeasurementService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NurseVitalSignMeasurementAction>(modelAction.NurseVitalSignMeasurementModelActionTypes.COUNT_NURSE_VITAL_SIGN_MEASUREMENTS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.NurseVitalSignMeasurementActionOK(
						modelAction.NurseVitalSignMeasurementModelActionTypes.COUNT_NURSE_VITAL_SIGN_MEASUREMENTS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NurseVitalSignMeasurementActionFail(
								modelAction.NurseVitalSignMeasurementModelActionTypes.COUNT_NURSE_VITAL_SIGN_MEASUREMENTS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NurseVitalSignMeasurementAction>(modelAction.NurseVitalSignMeasurementModelActionTypes.FETCH_NURSE_VITAL_SIGN_MEASUREMENT),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.NurseVitalSignMeasurementActionOK(
						modelAction.NurseVitalSignMeasurementModelActionTypes.FETCH_NURSE_VITAL_SIGN_MEASUREMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NurseVitalSignMeasurementActionFail(
								modelAction.NurseVitalSignMeasurementModelActionTypes.FETCH_NURSE_VITAL_SIGN_MEASUREMENT_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NurseVitalSignMeasurementAction>(modelAction.NurseVitalSignMeasurementModelActionTypes.FETCH_ALL_NURSE_VITAL_SIGN_MEASUREMENT),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.NurseVitalSignMeasurementActionOK(
						modelAction.NurseVitalSignMeasurementModelActionTypes.FETCH_ALL_NURSE_VITAL_SIGN_MEASUREMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NurseVitalSignMeasurementActionFail(
								modelAction.NurseVitalSignMeasurementModelActionTypes.FETCH_ALL_NURSE_VITAL_SIGN_MEASUREMENT_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NurseVitalSignMeasurementAction>(modelAction.NurseVitalSignMeasurementModelActionTypes.FETCH_NURSE_VITAL_SIGN_MEASUREMENT_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.NurseVitalSignMeasurementActionOK(
						modelAction.NurseVitalSignMeasurementModelActionTypes.FETCH_NURSE_VITAL_SIGN_MEASUREMENT_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NurseVitalSignMeasurementActionFail(
								modelAction.NurseVitalSignMeasurementModelActionTypes.FETCH_NURSE_VITAL_SIGN_MEASUREMENT_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NurseVitalSignMeasurementAction>(modelAction.NurseVitalSignMeasurementModelActionTypes.FETCH_LAST_NURSE_VITAL_SIGN_MEASUREMENT_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.NurseVitalSignMeasurementActionOK(
						modelAction.NurseVitalSignMeasurementModelActionTypes.FETCH_LAST_NURSE_VITAL_SIGN_MEASUREMENT_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NurseVitalSignMeasurementActionFail(
								modelAction.NurseVitalSignMeasurementModelActionTypes.FETCH_LAST_NURSE_VITAL_SIGN_MEASUREMENT_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NurseVitalSignMeasurementAction>(modelAction.NurseVitalSignMeasurementModelActionTypes.CREATE_NURSE_VITAL_SIGN_MEASUREMENT),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as NurseVitalSignMeasurementModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.NurseVitalSignMeasurementActionOK(
						modelAction.NurseVitalSignMeasurementModelActionTypes.CREATE_NURSE_VITAL_SIGN_MEASUREMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NurseVitalSignMeasurementActionFail(
								modelAction.NurseVitalSignMeasurementModelActionTypes.CREATE_NURSE_VITAL_SIGN_MEASUREMENT_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NurseVitalSignMeasurementAction>(modelAction.NurseVitalSignMeasurementModelActionTypes.CREATE_ALL_NURSE_VITAL_SIGN_MEASUREMENT),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as NurseVitalSignMeasurementModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.NurseVitalSignMeasurementActionOK(
						modelAction.NurseVitalSignMeasurementModelActionTypes.CREATE_ALL_NURSE_VITAL_SIGN_MEASUREMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NurseVitalSignMeasurementActionFail(
								modelAction.NurseVitalSignMeasurementModelActionTypes.CREATE_ALL_NURSE_VITAL_SIGN_MEASUREMENT_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NurseVitalSignMeasurementAction>(modelAction.NurseVitalSignMeasurementModelActionTypes.UPDATE_NURSE_VITAL_SIGN_MEASUREMENT),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as NurseVitalSignMeasurementModel;
				...
				return this.service.update(new NurseVitalSignMeasurementModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.NurseVitalSignMeasurementActionOK(
						modelAction.NurseVitalSignMeasurementModelActionTypes.UPDATE_NURSE_VITAL_SIGN_MEASUREMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NurseVitalSignMeasurementActionFail(
								modelAction.NurseVitalSignMeasurementModelActionTypes.UPDATE_NURSE_VITAL_SIGN_MEASUREMENT_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NurseVitalSignMeasurementAction>(modelAction.NurseVitalSignMeasurementModelActionTypes.UPDATE_ALL_NURSE_VITAL_SIGN_MEASUREMENT),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as NurseVitalSignMeasurementModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new NurseVitalSignMeasurementModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.NurseVitalSignMeasurementActionOK(
						modelAction.NurseVitalSignMeasurementModelActionTypes.UPDATE_ALL_NURSE_VITAL_SIGN_MEASUREMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NurseVitalSignMeasurementActionFail(
								modelAction.NurseVitalSignMeasurementModelActionTypes.UPDATE_ALL_NURSE_VITAL_SIGN_MEASUREMENT_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NurseVitalSignMeasurementAction>(modelAction.NurseVitalSignMeasurementModelActionTypes.DELETE_NURSE_VITAL_SIGN_MEASUREMENT),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.NurseVitalSignMeasurementActionOK(
						modelAction.NurseVitalSignMeasurementModelActionTypes.DELETE_NURSE_VITAL_SIGN_MEASUREMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NurseVitalSignMeasurementActionFail(
								modelAction.NurseVitalSignMeasurementModelActionTypes.DELETE_NURSE_VITAL_SIGN_MEASUREMENT_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NurseVitalSignMeasurementAction>(modelAction.NurseVitalSignMeasurementModelActionTypes.DELETE_NURSE_VITAL_SIGN_MEASUREMENT_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.NurseVitalSignMeasurementActionOK(
						modelAction.NurseVitalSignMeasurementModelActionTypes.DELETE_NURSE_VITAL_SIGN_MEASUREMENT_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NurseVitalSignMeasurementActionFail(
								modelAction.NurseVitalSignMeasurementModelActionTypes.DELETE_NURSE_VITAL_SIGN_MEASUREMENT_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NurseVitalSignMeasurementAction>(modelAction.NurseVitalSignMeasurementModelActionTypes.DELETE_ALL_NURSE_VITAL_SIGN_MEASUREMENT),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.NurseVitalSignMeasurementActionOK(
						modelAction.NurseVitalSignMeasurementModelActionTypes.DELETE_ALL_NURSE_VITAL_SIGN_MEASUREMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NurseVitalSignMeasurementActionFail(
								modelAction.NurseVitalSignMeasurementModelActionTypes.DELETE_ALL_NURSE_VITAL_SIGN_MEASUREMENT_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NurseVitalSignMeasurementAction>(modelAction.NurseVitalSignMeasurementModelActionTypes.EXPORT_NURSE_VITAL_SIGN_MEASUREMENT),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.NurseVitalSignMeasurementActionOK(
						modelAction.NurseVitalSignMeasurementModelActionTypes.EXPORT_NURSE_VITAL_SIGN_MEASUREMENT,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NurseVitalSignMeasurementAction>(modelAction.NurseVitalSignMeasurementModelActionTypes.EXPORT_ALL_NURSE_VITAL_SIGN_MEASUREMENT),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.NurseVitalSignMeasurementActionOK(
						modelAction.NurseVitalSignMeasurementModelActionTypes.EXPORT_ALL_NURSE_VITAL_SIGN_MEASUREMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NurseVitalSignMeasurementActionFail(
								modelAction.NurseVitalSignMeasurementModelActionTypes.EXPORT_ALL_NURSE_VITAL_SIGN_MEASUREMENT_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NurseVitalSignMeasurementAction>(modelAction.NurseVitalSignMeasurementModelActionTypes.EXPORT_NURSE_VITAL_SIGN_MEASUREMENT_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.NurseVitalSignMeasurementActionOK(
						modelAction.NurseVitalSignMeasurementModelActionTypes.EXPORT_NURSE_VITAL_SIGN_MEASUREMENT_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NurseVitalSignMeasurementActionFail(
								modelAction.NurseVitalSignMeasurementModelActionTypes.EXPORT_NURSE_VITAL_SIGN_MEASUREMENT_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NurseVitalSignMeasurementAction>(modelAction.NurseVitalSignMeasurementModelActionTypes.IMPORT_NURSE_VITAL_SIGN_MEASUREMENTS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.NurseVitalSignMeasurementActionOK(
						modelAction.NurseVitalSignMeasurementModelActionTypes.IMPORT_NURSE_VITAL_SIGN_MEASUREMENTS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NurseVitalSignMeasurementActionFail(
								modelAction.NurseVitalSignMeasurementModelActionTypes.IMPORT_NURSE_VITAL_SIGN_MEASUREMENTS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NurseVitalSignMeasurementAction>(modelAction.NurseVitalSignMeasurementModelActionTypes.FETCH_NURSE_VITAL_SIGN_MEASUREMENT_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.NurseVitalSignMeasurementActionOK(
						modelAction.NurseVitalSignMeasurementModelActionTypes.FETCH_NURSE_VITAL_SIGN_MEASUREMENT_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.NurseVitalSignMeasurementActionFail(
								modelAction.NurseVitalSignMeasurementModelActionTypes.FETCH_NURSE_VITAL_SIGN_MEASUREMENT_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NurseVitalSignMeasurementAction>(modelAction.NurseVitalSignMeasurementModelActionTypes.FETCH_NURSE_VITAL_SIGN_MEASUREMENT_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.NurseVitalSignMeasurementActionOK(
						modelAction.NurseVitalSignMeasurementModelActionTypes.FETCH_NURSE_VITAL_SIGN_MEASUREMENT_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.NurseVitalSignMeasurementActionFail(
								modelAction.NurseVitalSignMeasurementModelActionTypes.FETCH_NURSE_VITAL_SIGN_MEASUREMENT_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
