...
/**
 * PurchaseOrderCollectionState would store the state of a collection of PurchaseOrder
 */
export interface PurchaseOrderCollectionState extends CollectionState {
 ...
 */
export interface PurchaseOrderModelAudit extends AbstractModelAudit<PurchaseOrderModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * PurchaseOrderModelState would store the state of the model
 */
export interface PurchaseOrderModelState {
	collectionState: {
		[key: string]: PurchaseOrderCollectionState;
	};
	data: {
		[id: string]: PurchaseOrderModel;
	};
	totalCount: number;
	audits: PurchaseOrderModelAudit[];
 ...
 */
export const initialPurchaseOrderCollectionState: PurchaseOrderCollectionState = {
...
/**
 * The initial state of PurchaseOrderModelState
 */
export const initialState: PurchaseOrderModelState = {
	collectionState: {
