...
import * as modelAction from './purchase_order.model.action';
import {PurchaseOrderService} from '../../services/purchaseOrder/purchase_order.service';
...
/**
 * Effect class used for side effects related to Purchase Order model.
 */
@Injectable()
export class PurchaseOrderEffect {
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseOrderAction>(modelAction.PurchaseOrderModelActionTypes.COUNT_PURCHASE_ORDERS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.PurchaseOrderActionOK(
						modelAction.PurchaseOrderModelActionTypes.COUNT_PURCHASE_ORDERS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseOrderActionFail(
								modelAction.PurchaseOrderModelActionTypes.COUNT_PURCHASE_ORDERS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseOrderAction>(modelAction.PurchaseOrderModelActionTypes.FETCH_PURCHASE_ORDER),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PurchaseOrderActionOK(
						modelAction.PurchaseOrderModelActionTypes.FETCH_PURCHASE_ORDER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseOrderActionFail(
								modelAction.PurchaseOrderModelActionTypes.FETCH_PURCHASE_ORDER_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseOrderAction>(modelAction.PurchaseOrderModelActionTypes.FETCH_ALL_PURCHASE_ORDER),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.PurchaseOrderActionOK(
						modelAction.PurchaseOrderModelActionTypes.FETCH_ALL_PURCHASE_ORDER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseOrderActionFail(
								modelAction.PurchaseOrderModelActionTypes.FETCH_ALL_PURCHASE_ORDER_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseOrderAction>(modelAction.PurchaseOrderModelActionTypes.FETCH_PURCHASE_ORDER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PurchaseOrderActionOK(
						modelAction.PurchaseOrderModelActionTypes.FETCH_PURCHASE_ORDER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseOrderActionFail(
								modelAction.PurchaseOrderModelActionTypes.FETCH_PURCHASE_ORDER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseOrderAction>(modelAction.PurchaseOrderModelActionTypes.FETCH_LAST_PURCHASE_ORDER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PurchaseOrderActionOK(
						modelAction.PurchaseOrderModelActionTypes.FETCH_LAST_PURCHASE_ORDER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseOrderActionFail(
								modelAction.PurchaseOrderModelActionTypes.FETCH_LAST_PURCHASE_ORDER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseOrderAction>(modelAction.PurchaseOrderModelActionTypes.CREATE_PURCHASE_ORDER),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as PurchaseOrderModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PurchaseOrderActionOK(
						modelAction.PurchaseOrderModelActionTypes.CREATE_PURCHASE_ORDER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseOrderActionFail(
								modelAction.PurchaseOrderModelActionTypes.CREATE_PURCHASE_ORDER_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseOrderAction>(modelAction.PurchaseOrderModelActionTypes.CREATE_ALL_PURCHASE_ORDER),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as PurchaseOrderModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PurchaseOrderActionOK(
						modelAction.PurchaseOrderModelActionTypes.CREATE_ALL_PURCHASE_ORDER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseOrderActionFail(
								modelAction.PurchaseOrderModelActionTypes.CREATE_ALL_PURCHASE_ORDER_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseOrderAction>(modelAction.PurchaseOrderModelActionTypes.UPDATE_PURCHASE_ORDER),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as PurchaseOrderModel;
				...
				return this.service.update(new PurchaseOrderModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.PurchaseOrderActionOK(
						modelAction.PurchaseOrderModelActionTypes.UPDATE_PURCHASE_ORDER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseOrderActionFail(
								modelAction.PurchaseOrderModelActionTypes.UPDATE_PURCHASE_ORDER_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseOrderAction>(modelAction.PurchaseOrderModelActionTypes.UPDATE_ALL_PURCHASE_ORDER),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as PurchaseOrderModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new PurchaseOrderModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PurchaseOrderActionOK(
						modelAction.PurchaseOrderModelActionTypes.UPDATE_ALL_PURCHASE_ORDER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseOrderActionFail(
								modelAction.PurchaseOrderModelActionTypes.UPDATE_ALL_PURCHASE_ORDER_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseOrderAction>(modelAction.PurchaseOrderModelActionTypes.DELETE_PURCHASE_ORDER),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PurchaseOrderActionOK(
						modelAction.PurchaseOrderModelActionTypes.DELETE_PURCHASE_ORDER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseOrderActionFail(
								modelAction.PurchaseOrderModelActionTypes.DELETE_PURCHASE_ORDER_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseOrderAction>(modelAction.PurchaseOrderModelActionTypes.DELETE_PURCHASE_ORDER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.PurchaseOrderActionOK(
						modelAction.PurchaseOrderModelActionTypes.DELETE_PURCHASE_ORDER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseOrderActionFail(
								modelAction.PurchaseOrderModelActionTypes.DELETE_PURCHASE_ORDER_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseOrderAction>(modelAction.PurchaseOrderModelActionTypes.DELETE_ALL_PURCHASE_ORDER),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PurchaseOrderActionOK(
						modelAction.PurchaseOrderModelActionTypes.DELETE_ALL_PURCHASE_ORDER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseOrderActionFail(
								modelAction.PurchaseOrderModelActionTypes.DELETE_ALL_PURCHASE_ORDER_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseOrderAction>(modelAction.PurchaseOrderModelActionTypes.EXPORT_PURCHASE_ORDER),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PurchaseOrderActionOK(
						modelAction.PurchaseOrderModelActionTypes.EXPORT_PURCHASE_ORDER,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseOrderAction>(modelAction.PurchaseOrderModelActionTypes.EXPORT_ALL_PURCHASE_ORDER),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PurchaseOrderActionOK(
						modelAction.PurchaseOrderModelActionTypes.EXPORT_ALL_PURCHASE_ORDER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseOrderActionFail(
								modelAction.PurchaseOrderModelActionTypes.EXPORT_ALL_PURCHASE_ORDER_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseOrderAction>(modelAction.PurchaseOrderModelActionTypes.EXPORT_PURCHASE_ORDER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PurchaseOrderActionOK(
						modelAction.PurchaseOrderModelActionTypes.EXPORT_PURCHASE_ORDER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseOrderActionFail(
								modelAction.PurchaseOrderModelActionTypes.EXPORT_PURCHASE_ORDER_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseOrderAction>(modelAction.PurchaseOrderModelActionTypes.IMPORT_PURCHASE_ORDERS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.PurchaseOrderActionOK(
						modelAction.PurchaseOrderModelActionTypes.IMPORT_PURCHASE_ORDERS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseOrderActionFail(
								modelAction.PurchaseOrderModelActionTypes.IMPORT_PURCHASE_ORDERS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseOrderAction>(modelAction.PurchaseOrderModelActionTypes.FETCH_PURCHASE_ORDER_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.PurchaseOrderActionOK(
						modelAction.PurchaseOrderModelActionTypes.FETCH_PURCHASE_ORDER_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseOrderActionFail(
								modelAction.PurchaseOrderModelActionTypes.FETCH_PURCHASE_ORDER_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseOrderAction>(modelAction.PurchaseOrderModelActionTypes.FETCH_PURCHASE_ORDER_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.PurchaseOrderActionOK(
						modelAction.PurchaseOrderModelActionTypes.FETCH_PURCHASE_ORDER_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseOrderActionFail(
								modelAction.PurchaseOrderModelActionTypes.FETCH_PURCHASE_ORDER_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
