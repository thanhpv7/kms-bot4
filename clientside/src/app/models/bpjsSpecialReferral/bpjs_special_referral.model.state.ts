...
/**
 * BpjsSpecialReferralCollectionState would store the state of a collection of BpjsSpecialReferral
 */
export interface BpjsSpecialReferralCollectionState extends CollectionState {
 ...
 */
export interface BpjsSpecialReferralModelAudit extends AbstractModelAudit<BpjsSpecialReferralModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsSpecialReferralModelState would store the state of the model
 */
export interface BpjsSpecialReferralModelState {
	collectionState: {
		[key: string]: BpjsSpecialReferralCollectionState;
	};
	data: {
		[id: string]: BpjsSpecialReferralModel;
	};
	totalCount: number;
	audits: BpjsSpecialReferralModelAudit[];
 ...
 */
export const initialBpjsSpecialReferralCollectionState: BpjsSpecialReferralCollectionState = {
...
/**
 * The initial state of BpjsSpecialReferralModelState
 */
export const initialState: BpjsSpecialReferralModelState = {
	collectionState: {
