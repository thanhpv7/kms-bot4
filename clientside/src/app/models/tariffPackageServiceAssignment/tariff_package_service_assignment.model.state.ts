...
/**
 * TariffPackageServiceAssignmentCollectionState would store the state of a collection of TariffPackageServiceAssignment
 */
export interface TariffPackageServiceAssignmentCollectionState extends CollectionState {
 ...
 */
export interface TariffPackageServiceAssignmentModelAudit extends AbstractModelAudit<TariffPackageServiceAssignmentModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * TariffPackageServiceAssignmentModelState would store the state of the model
 */
export interface TariffPackageServiceAssignmentModelState {
	collectionState: {
		[key: string]: TariffPackageServiceAssignmentCollectionState;
	};
	data: {
		[id: string]: TariffPackageServiceAssignmentModel;
	};
	totalCount: number;
	audits: TariffPackageServiceAssignmentModelAudit[];
 ...
 */
export const initialTariffPackageServiceAssignmentCollectionState: TariffPackageServiceAssignmentCollectionState = {
...
/**
 * The initial state of TariffPackageServiceAssignmentModelState
 */
export const initialState: TariffPackageServiceAssignmentModelState = {
	collectionState: {
