...
import * as modelAction from './tariff_package_service_assignment.model.action';
import {TariffPackageServiceAssignmentService} from '../../services/tariffPackageServiceAssignment/tariff_package_service_assignment.service';
...
/**
 * Effect class used for side effects related to Tariff Package Service Assignment model.
 */
@Injectable()
export class TariffPackageServiceAssignmentEffect {
	...
	constructor(
		...
		protected readonly service: TariffPackageServiceAssignmentService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageServiceAssignmentAction>(modelAction.TariffPackageServiceAssignmentModelActionTypes.COUNT_TARIFF_PACKAGE_SERVICE_ASSIGNMENTS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.TariffPackageServiceAssignmentActionOK(
						modelAction.TariffPackageServiceAssignmentModelActionTypes.COUNT_TARIFF_PACKAGE_SERVICE_ASSIGNMENTS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageServiceAssignmentActionFail(
								modelAction.TariffPackageServiceAssignmentModelActionTypes.COUNT_TARIFF_PACKAGE_SERVICE_ASSIGNMENTS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageServiceAssignmentAction>(modelAction.TariffPackageServiceAssignmentModelActionTypes.FETCH_TARIFF_PACKAGE_SERVICE_ASSIGNMENT),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.TariffPackageServiceAssignmentActionOK(
						modelAction.TariffPackageServiceAssignmentModelActionTypes.FETCH_TARIFF_PACKAGE_SERVICE_ASSIGNMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageServiceAssignmentActionFail(
								modelAction.TariffPackageServiceAssignmentModelActionTypes.FETCH_TARIFF_PACKAGE_SERVICE_ASSIGNMENT_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageServiceAssignmentAction>(modelAction.TariffPackageServiceAssignmentModelActionTypes.FETCH_ALL_TARIFF_PACKAGE_SERVICE_ASSIGNMENT),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.TariffPackageServiceAssignmentActionOK(
						modelAction.TariffPackageServiceAssignmentModelActionTypes.FETCH_ALL_TARIFF_PACKAGE_SERVICE_ASSIGNMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageServiceAssignmentActionFail(
								modelAction.TariffPackageServiceAssignmentModelActionTypes.FETCH_ALL_TARIFF_PACKAGE_SERVICE_ASSIGNMENT_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageServiceAssignmentAction>(modelAction.TariffPackageServiceAssignmentModelActionTypes.FETCH_TARIFF_PACKAGE_SERVICE_ASSIGNMENT_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.TariffPackageServiceAssignmentActionOK(
						modelAction.TariffPackageServiceAssignmentModelActionTypes.FETCH_TARIFF_PACKAGE_SERVICE_ASSIGNMENT_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageServiceAssignmentActionFail(
								modelAction.TariffPackageServiceAssignmentModelActionTypes.FETCH_TARIFF_PACKAGE_SERVICE_ASSIGNMENT_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageServiceAssignmentAction>(modelAction.TariffPackageServiceAssignmentModelActionTypes.FETCH_LAST_TARIFF_PACKAGE_SERVICE_ASSIGNMENT_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.TariffPackageServiceAssignmentActionOK(
						modelAction.TariffPackageServiceAssignmentModelActionTypes.FETCH_LAST_TARIFF_PACKAGE_SERVICE_ASSIGNMENT_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageServiceAssignmentActionFail(
								modelAction.TariffPackageServiceAssignmentModelActionTypes.FETCH_LAST_TARIFF_PACKAGE_SERVICE_ASSIGNMENT_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageServiceAssignmentAction>(modelAction.TariffPackageServiceAssignmentModelActionTypes.CREATE_TARIFF_PACKAGE_SERVICE_ASSIGNMENT),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as TariffPackageServiceAssignmentModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.TariffPackageServiceAssignmentActionOK(
						modelAction.TariffPackageServiceAssignmentModelActionTypes.CREATE_TARIFF_PACKAGE_SERVICE_ASSIGNMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageServiceAssignmentActionFail(
								modelAction.TariffPackageServiceAssignmentModelActionTypes.CREATE_TARIFF_PACKAGE_SERVICE_ASSIGNMENT_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageServiceAssignmentAction>(modelAction.TariffPackageServiceAssignmentModelActionTypes.CREATE_ALL_TARIFF_PACKAGE_SERVICE_ASSIGNMENT),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as TariffPackageServiceAssignmentModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.TariffPackageServiceAssignmentActionOK(
						modelAction.TariffPackageServiceAssignmentModelActionTypes.CREATE_ALL_TARIFF_PACKAGE_SERVICE_ASSIGNMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageServiceAssignmentActionFail(
								modelAction.TariffPackageServiceAssignmentModelActionTypes.CREATE_ALL_TARIFF_PACKAGE_SERVICE_ASSIGNMENT_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageServiceAssignmentAction>(modelAction.TariffPackageServiceAssignmentModelActionTypes.UPDATE_TARIFF_PACKAGE_SERVICE_ASSIGNMENT),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as TariffPackageServiceAssignmentModel;
				...
				return this.service.update(new TariffPackageServiceAssignmentModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.TariffPackageServiceAssignmentActionOK(
						modelAction.TariffPackageServiceAssignmentModelActionTypes.UPDATE_TARIFF_PACKAGE_SERVICE_ASSIGNMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageServiceAssignmentActionFail(
								modelAction.TariffPackageServiceAssignmentModelActionTypes.UPDATE_TARIFF_PACKAGE_SERVICE_ASSIGNMENT_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageServiceAssignmentAction>(modelAction.TariffPackageServiceAssignmentModelActionTypes.UPDATE_ALL_TARIFF_PACKAGE_SERVICE_ASSIGNMENT),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as TariffPackageServiceAssignmentModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new TariffPackageServiceAssignmentModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.TariffPackageServiceAssignmentActionOK(
						modelAction.TariffPackageServiceAssignmentModelActionTypes.UPDATE_ALL_TARIFF_PACKAGE_SERVICE_ASSIGNMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageServiceAssignmentActionFail(
								modelAction.TariffPackageServiceAssignmentModelActionTypes.UPDATE_ALL_TARIFF_PACKAGE_SERVICE_ASSIGNMENT_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageServiceAssignmentAction>(modelAction.TariffPackageServiceAssignmentModelActionTypes.DELETE_TARIFF_PACKAGE_SERVICE_ASSIGNMENT),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.TariffPackageServiceAssignmentActionOK(
						modelAction.TariffPackageServiceAssignmentModelActionTypes.DELETE_TARIFF_PACKAGE_SERVICE_ASSIGNMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageServiceAssignmentActionFail(
								modelAction.TariffPackageServiceAssignmentModelActionTypes.DELETE_TARIFF_PACKAGE_SERVICE_ASSIGNMENT_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageServiceAssignmentAction>(modelAction.TariffPackageServiceAssignmentModelActionTypes.DELETE_TARIFF_PACKAGE_SERVICE_ASSIGNMENT_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.TariffPackageServiceAssignmentActionOK(
						modelAction.TariffPackageServiceAssignmentModelActionTypes.DELETE_TARIFF_PACKAGE_SERVICE_ASSIGNMENT_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageServiceAssignmentActionFail(
								modelAction.TariffPackageServiceAssignmentModelActionTypes.DELETE_TARIFF_PACKAGE_SERVICE_ASSIGNMENT_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageServiceAssignmentAction>(modelAction.TariffPackageServiceAssignmentModelActionTypes.DELETE_ALL_TARIFF_PACKAGE_SERVICE_ASSIGNMENT),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.TariffPackageServiceAssignmentActionOK(
						modelAction.TariffPackageServiceAssignmentModelActionTypes.DELETE_ALL_TARIFF_PACKAGE_SERVICE_ASSIGNMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageServiceAssignmentActionFail(
								modelAction.TariffPackageServiceAssignmentModelActionTypes.DELETE_ALL_TARIFF_PACKAGE_SERVICE_ASSIGNMENT_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageServiceAssignmentAction>(modelAction.TariffPackageServiceAssignmentModelActionTypes.EXPORT_TARIFF_PACKAGE_SERVICE_ASSIGNMENT),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.TariffPackageServiceAssignmentActionOK(
						modelAction.TariffPackageServiceAssignmentModelActionTypes.EXPORT_TARIFF_PACKAGE_SERVICE_ASSIGNMENT,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageServiceAssignmentAction>(modelAction.TariffPackageServiceAssignmentModelActionTypes.EXPORT_ALL_TARIFF_PACKAGE_SERVICE_ASSIGNMENT),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.TariffPackageServiceAssignmentActionOK(
						modelAction.TariffPackageServiceAssignmentModelActionTypes.EXPORT_ALL_TARIFF_PACKAGE_SERVICE_ASSIGNMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageServiceAssignmentActionFail(
								modelAction.TariffPackageServiceAssignmentModelActionTypes.EXPORT_ALL_TARIFF_PACKAGE_SERVICE_ASSIGNMENT_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageServiceAssignmentAction>(modelAction.TariffPackageServiceAssignmentModelActionTypes.EXPORT_TARIFF_PACKAGE_SERVICE_ASSIGNMENT_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.TariffPackageServiceAssignmentActionOK(
						modelAction.TariffPackageServiceAssignmentModelActionTypes.EXPORT_TARIFF_PACKAGE_SERVICE_ASSIGNMENT_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageServiceAssignmentActionFail(
								modelAction.TariffPackageServiceAssignmentModelActionTypes.EXPORT_TARIFF_PACKAGE_SERVICE_ASSIGNMENT_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageServiceAssignmentAction>(modelAction.TariffPackageServiceAssignmentModelActionTypes.IMPORT_TARIFF_PACKAGE_SERVICE_ASSIGNMENTS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.TariffPackageServiceAssignmentActionOK(
						modelAction.TariffPackageServiceAssignmentModelActionTypes.IMPORT_TARIFF_PACKAGE_SERVICE_ASSIGNMENTS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageServiceAssignmentActionFail(
								modelAction.TariffPackageServiceAssignmentModelActionTypes.IMPORT_TARIFF_PACKAGE_SERVICE_ASSIGNMENTS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageServiceAssignmentAction>(modelAction.TariffPackageServiceAssignmentModelActionTypes.FETCH_TARIFF_PACKAGE_SERVICE_ASSIGNMENT_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.TariffPackageServiceAssignmentActionOK(
						modelAction.TariffPackageServiceAssignmentModelActionTypes.FETCH_TARIFF_PACKAGE_SERVICE_ASSIGNMENT_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageServiceAssignmentActionFail(
								modelAction.TariffPackageServiceAssignmentModelActionTypes.FETCH_TARIFF_PACKAGE_SERVICE_ASSIGNMENT_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageServiceAssignmentAction>(modelAction.TariffPackageServiceAssignmentModelActionTypes.FETCH_TARIFF_PACKAGE_SERVICE_ASSIGNMENT_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.TariffPackageServiceAssignmentActionOK(
						modelAction.TariffPackageServiceAssignmentModelActionTypes.FETCH_TARIFF_PACKAGE_SERVICE_ASSIGNMENT_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageServiceAssignmentActionFail(
								modelAction.TariffPackageServiceAssignmentModelActionTypes.FETCH_TARIFF_PACKAGE_SERVICE_ASSIGNMENT_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
