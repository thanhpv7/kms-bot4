...
/**
 * NhisGDRGCollectionState would store the state of a collection of NhisGDRG
 */
export interface NhisGDRGCollectionState extends CollectionState {
 ...
 */
export interface NhisGDRGModelAudit extends AbstractModelAudit<NhisGDRGModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * NhisGDRGModelState would store the state of the model
 */
export interface NhisGDRGModelState {
	collectionState: {
		[key: string]: NhisGDRGCollectionState;
	};
	data: {
		[id: string]: NhisGDRGModel;
	};
	totalCount: number;
	audits: NhisGDRGModelAudit[];
 ...
 */
export const initialNhisGDRGCollectionState: NhisGDRGCollectionState = {
...
/**
 * The initial state of NhisGDRGModelState
 */
export const initialState: NhisGDRGModelState = {
	collectionState: {
