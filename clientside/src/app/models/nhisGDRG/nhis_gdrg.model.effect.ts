...
import * as modelAction from './nhis_gdrg.model.action';
import {NhisGDRGService} from '../../services/nhisGDRG/nhis_gdrg.service';
...
/**
 * Effect class used for side effects related to NHIS GDRG model.
 */
@Injectable()
export class NhisGDRGEffect {
	...
	constructor(
		...
		protected readonly service: NhisGDRGService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisGDRGAction>(modelAction.NhisGDRGModelActionTypes.COUNT_NHIS_GDRGS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.NhisGDRGActionOK(
						modelAction.NhisGDRGModelActionTypes.COUNT_NHIS_GDRGS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisGDRGActionFail(
								modelAction.NhisGDRGModelActionTypes.COUNT_NHIS_GDRGS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisGDRGAction>(modelAction.NhisGDRGModelActionTypes.FETCH_NHIS_GDRG),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisGDRGActionOK(
						modelAction.NhisGDRGModelActionTypes.FETCH_NHIS_GDRG_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisGDRGActionFail(
								modelAction.NhisGDRGModelActionTypes.FETCH_NHIS_GDRG_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisGDRGAction>(modelAction.NhisGDRGModelActionTypes.FETCH_ALL_NHIS_GDRG),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.NhisGDRGActionOK(
						modelAction.NhisGDRGModelActionTypes.FETCH_ALL_NHIS_GDRG_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisGDRGActionFail(
								modelAction.NhisGDRGModelActionTypes.FETCH_ALL_NHIS_GDRG_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisGDRGAction>(modelAction.NhisGDRGModelActionTypes.FETCH_NHIS_GDRG_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisGDRGActionOK(
						modelAction.NhisGDRGModelActionTypes.FETCH_NHIS_GDRG_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisGDRGActionFail(
								modelAction.NhisGDRGModelActionTypes.FETCH_NHIS_GDRG_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisGDRGAction>(modelAction.NhisGDRGModelActionTypes.FETCH_LAST_NHIS_GDRG_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisGDRGActionOK(
						modelAction.NhisGDRGModelActionTypes.FETCH_LAST_NHIS_GDRG_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisGDRGActionFail(
								modelAction.NhisGDRGModelActionTypes.FETCH_LAST_NHIS_GDRG_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisGDRGAction>(modelAction.NhisGDRGModelActionTypes.CREATE_NHIS_GDRG),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as NhisGDRGModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisGDRGActionOK(
						modelAction.NhisGDRGModelActionTypes.CREATE_NHIS_GDRG_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisGDRGActionFail(
								modelAction.NhisGDRGModelActionTypes.CREATE_NHIS_GDRG_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisGDRGAction>(modelAction.NhisGDRGModelActionTypes.CREATE_ALL_NHIS_GDRG),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as NhisGDRGModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisGDRGActionOK(
						modelAction.NhisGDRGModelActionTypes.CREATE_ALL_NHIS_GDRG_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisGDRGActionFail(
								modelAction.NhisGDRGModelActionTypes.CREATE_ALL_NHIS_GDRG_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisGDRGAction>(modelAction.NhisGDRGModelActionTypes.UPDATE_NHIS_GDRG),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as NhisGDRGModel;
				...
				return this.service.update(new NhisGDRGModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisGDRGActionOK(
						modelAction.NhisGDRGModelActionTypes.UPDATE_NHIS_GDRG_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisGDRGActionFail(
								modelAction.NhisGDRGModelActionTypes.UPDATE_NHIS_GDRG_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisGDRGAction>(modelAction.NhisGDRGModelActionTypes.UPDATE_ALL_NHIS_GDRG),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as NhisGDRGModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new NhisGDRGModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisGDRGActionOK(
						modelAction.NhisGDRGModelActionTypes.UPDATE_ALL_NHIS_GDRG_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisGDRGActionFail(
								modelAction.NhisGDRGModelActionTypes.UPDATE_ALL_NHIS_GDRG_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisGDRGAction>(modelAction.NhisGDRGModelActionTypes.DELETE_NHIS_GDRG),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.NhisGDRGActionOK(
						modelAction.NhisGDRGModelActionTypes.DELETE_NHIS_GDRG_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisGDRGActionFail(
								modelAction.NhisGDRGModelActionTypes.DELETE_NHIS_GDRG_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisGDRGAction>(modelAction.NhisGDRGModelActionTypes.DELETE_NHIS_GDRG_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.NhisGDRGActionOK(
						modelAction.NhisGDRGModelActionTypes.DELETE_NHIS_GDRG_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisGDRGActionFail(
								modelAction.NhisGDRGModelActionTypes.DELETE_NHIS_GDRG_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisGDRGAction>(modelAction.NhisGDRGModelActionTypes.DELETE_ALL_NHIS_GDRG),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.NhisGDRGActionOK(
						modelAction.NhisGDRGModelActionTypes.DELETE_ALL_NHIS_GDRG_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisGDRGActionFail(
								modelAction.NhisGDRGModelActionTypes.DELETE_ALL_NHIS_GDRG_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisGDRGAction>(modelAction.NhisGDRGModelActionTypes.EXPORT_NHIS_GDRG),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.NhisGDRGActionOK(
						modelAction.NhisGDRGModelActionTypes.EXPORT_NHIS_GDRG,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisGDRGAction>(modelAction.NhisGDRGModelActionTypes.EXPORT_ALL_NHIS_GDRG),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.NhisGDRGActionOK(
						modelAction.NhisGDRGModelActionTypes.EXPORT_ALL_NHIS_GDRG_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisGDRGActionFail(
								modelAction.NhisGDRGModelActionTypes.EXPORT_ALL_NHIS_GDRG_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisGDRGAction>(modelAction.NhisGDRGModelActionTypes.EXPORT_NHIS_GDRG_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.NhisGDRGActionOK(
						modelAction.NhisGDRGModelActionTypes.EXPORT_NHIS_GDRG_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisGDRGActionFail(
								modelAction.NhisGDRGModelActionTypes.EXPORT_NHIS_GDRG_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisGDRGAction>(modelAction.NhisGDRGModelActionTypes.IMPORT_NHIS_GDRGS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.NhisGDRGActionOK(
						modelAction.NhisGDRGModelActionTypes.IMPORT_NHIS_GDRGS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisGDRGActionFail(
								modelAction.NhisGDRGModelActionTypes.IMPORT_NHIS_GDRGS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisGDRGAction>(modelAction.NhisGDRGModelActionTypes.FETCH_NHIS_GDRG_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.NhisGDRGActionOK(
						modelAction.NhisGDRGModelActionTypes.FETCH_NHIS_GDRG_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.NhisGDRGActionFail(
								modelAction.NhisGDRGModelActionTypes.FETCH_NHIS_GDRG_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisGDRGAction>(modelAction.NhisGDRGModelActionTypes.FETCH_NHIS_GDRG_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.NhisGDRGActionOK(
						modelAction.NhisGDRGModelActionTypes.FETCH_NHIS_GDRG_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.NhisGDRGActionFail(
								modelAction.NhisGDRGModelActionTypes.FETCH_NHIS_GDRG_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
