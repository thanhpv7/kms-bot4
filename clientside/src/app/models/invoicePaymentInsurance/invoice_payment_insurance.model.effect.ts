...
import * as modelAction from './invoice_payment_insurance.model.action';
import {InvoicePaymentInsuranceService} from '../../services/invoicePaymentInsurance/invoice_payment_insurance.service';
...
/**
 * Effect class used for side effects related to Invoice Payment Insurance model.
 */
@Injectable()
export class InvoicePaymentInsuranceEffect {
	...
	constructor(
		...
		protected readonly service: InvoicePaymentInsuranceService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentInsuranceAction>(modelAction.InvoicePaymentInsuranceModelActionTypes.COUNT_INVOICE_PAYMENT_INSURANCES),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.InvoicePaymentInsuranceActionOK(
						modelAction.InvoicePaymentInsuranceModelActionTypes.COUNT_INVOICE_PAYMENT_INSURANCES_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentInsuranceActionFail(
								modelAction.InvoicePaymentInsuranceModelActionTypes.COUNT_INVOICE_PAYMENT_INSURANCES_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentInsuranceAction>(modelAction.InvoicePaymentInsuranceModelActionTypes.FETCH_INVOICE_PAYMENT_INSURANCE),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InvoicePaymentInsuranceActionOK(
						modelAction.InvoicePaymentInsuranceModelActionTypes.FETCH_INVOICE_PAYMENT_INSURANCE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentInsuranceActionFail(
								modelAction.InvoicePaymentInsuranceModelActionTypes.FETCH_INVOICE_PAYMENT_INSURANCE_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentInsuranceAction>(modelAction.InvoicePaymentInsuranceModelActionTypes.FETCH_ALL_INVOICE_PAYMENT_INSURANCE),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.InvoicePaymentInsuranceActionOK(
						modelAction.InvoicePaymentInsuranceModelActionTypes.FETCH_ALL_INVOICE_PAYMENT_INSURANCE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentInsuranceActionFail(
								modelAction.InvoicePaymentInsuranceModelActionTypes.FETCH_ALL_INVOICE_PAYMENT_INSURANCE_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentInsuranceAction>(modelAction.InvoicePaymentInsuranceModelActionTypes.FETCH_INVOICE_PAYMENT_INSURANCE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.InvoicePaymentInsuranceActionOK(
						modelAction.InvoicePaymentInsuranceModelActionTypes.FETCH_INVOICE_PAYMENT_INSURANCE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentInsuranceActionFail(
								modelAction.InvoicePaymentInsuranceModelActionTypes.FETCH_INVOICE_PAYMENT_INSURANCE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentInsuranceAction>(modelAction.InvoicePaymentInsuranceModelActionTypes.FETCH_LAST_INVOICE_PAYMENT_INSURANCE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.InvoicePaymentInsuranceActionOK(
						modelAction.InvoicePaymentInsuranceModelActionTypes.FETCH_LAST_INVOICE_PAYMENT_INSURANCE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentInsuranceActionFail(
								modelAction.InvoicePaymentInsuranceModelActionTypes.FETCH_LAST_INVOICE_PAYMENT_INSURANCE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentInsuranceAction>(modelAction.InvoicePaymentInsuranceModelActionTypes.CREATE_INVOICE_PAYMENT_INSURANCE),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as InvoicePaymentInsuranceModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InvoicePaymentInsuranceActionOK(
						modelAction.InvoicePaymentInsuranceModelActionTypes.CREATE_INVOICE_PAYMENT_INSURANCE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentInsuranceActionFail(
								modelAction.InvoicePaymentInsuranceModelActionTypes.CREATE_INVOICE_PAYMENT_INSURANCE_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentInsuranceAction>(modelAction.InvoicePaymentInsuranceModelActionTypes.CREATE_ALL_INVOICE_PAYMENT_INSURANCE),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as InvoicePaymentInsuranceModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InvoicePaymentInsuranceActionOK(
						modelAction.InvoicePaymentInsuranceModelActionTypes.CREATE_ALL_INVOICE_PAYMENT_INSURANCE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentInsuranceActionFail(
								modelAction.InvoicePaymentInsuranceModelActionTypes.CREATE_ALL_INVOICE_PAYMENT_INSURANCE_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentInsuranceAction>(modelAction.InvoicePaymentInsuranceModelActionTypes.UPDATE_INVOICE_PAYMENT_INSURANCE),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as InvoicePaymentInsuranceModel;
				...
				return this.service.update(new InvoicePaymentInsuranceModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.InvoicePaymentInsuranceActionOK(
						modelAction.InvoicePaymentInsuranceModelActionTypes.UPDATE_INVOICE_PAYMENT_INSURANCE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentInsuranceActionFail(
								modelAction.InvoicePaymentInsuranceModelActionTypes.UPDATE_INVOICE_PAYMENT_INSURANCE_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentInsuranceAction>(modelAction.InvoicePaymentInsuranceModelActionTypes.UPDATE_ALL_INVOICE_PAYMENT_INSURANCE),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as InvoicePaymentInsuranceModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new InvoicePaymentInsuranceModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InvoicePaymentInsuranceActionOK(
						modelAction.InvoicePaymentInsuranceModelActionTypes.UPDATE_ALL_INVOICE_PAYMENT_INSURANCE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentInsuranceActionFail(
								modelAction.InvoicePaymentInsuranceModelActionTypes.UPDATE_ALL_INVOICE_PAYMENT_INSURANCE_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentInsuranceAction>(modelAction.InvoicePaymentInsuranceModelActionTypes.DELETE_INVOICE_PAYMENT_INSURANCE),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.InvoicePaymentInsuranceActionOK(
						modelAction.InvoicePaymentInsuranceModelActionTypes.DELETE_INVOICE_PAYMENT_INSURANCE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentInsuranceActionFail(
								modelAction.InvoicePaymentInsuranceModelActionTypes.DELETE_INVOICE_PAYMENT_INSURANCE_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentInsuranceAction>(modelAction.InvoicePaymentInsuranceModelActionTypes.DELETE_INVOICE_PAYMENT_INSURANCE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.InvoicePaymentInsuranceActionOK(
						modelAction.InvoicePaymentInsuranceModelActionTypes.DELETE_INVOICE_PAYMENT_INSURANCE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentInsuranceActionFail(
								modelAction.InvoicePaymentInsuranceModelActionTypes.DELETE_INVOICE_PAYMENT_INSURANCE_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentInsuranceAction>(modelAction.InvoicePaymentInsuranceModelActionTypes.DELETE_ALL_INVOICE_PAYMENT_INSURANCE),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.InvoicePaymentInsuranceActionOK(
						modelAction.InvoicePaymentInsuranceModelActionTypes.DELETE_ALL_INVOICE_PAYMENT_INSURANCE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentInsuranceActionFail(
								modelAction.InvoicePaymentInsuranceModelActionTypes.DELETE_ALL_INVOICE_PAYMENT_INSURANCE_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentInsuranceAction>(modelAction.InvoicePaymentInsuranceModelActionTypes.EXPORT_INVOICE_PAYMENT_INSURANCE),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.InvoicePaymentInsuranceActionOK(
						modelAction.InvoicePaymentInsuranceModelActionTypes.EXPORT_INVOICE_PAYMENT_INSURANCE,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentInsuranceAction>(modelAction.InvoicePaymentInsuranceModelActionTypes.EXPORT_ALL_INVOICE_PAYMENT_INSURANCE),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.InvoicePaymentInsuranceActionOK(
						modelAction.InvoicePaymentInsuranceModelActionTypes.EXPORT_ALL_INVOICE_PAYMENT_INSURANCE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentInsuranceActionFail(
								modelAction.InvoicePaymentInsuranceModelActionTypes.EXPORT_ALL_INVOICE_PAYMENT_INSURANCE_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentInsuranceAction>(modelAction.InvoicePaymentInsuranceModelActionTypes.EXPORT_INVOICE_PAYMENT_INSURANCE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.InvoicePaymentInsuranceActionOK(
						modelAction.InvoicePaymentInsuranceModelActionTypes.EXPORT_INVOICE_PAYMENT_INSURANCE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentInsuranceActionFail(
								modelAction.InvoicePaymentInsuranceModelActionTypes.EXPORT_INVOICE_PAYMENT_INSURANCE_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentInsuranceAction>(modelAction.InvoicePaymentInsuranceModelActionTypes.IMPORT_INVOICE_PAYMENT_INSURANCES),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.InvoicePaymentInsuranceActionOK(
						modelAction.InvoicePaymentInsuranceModelActionTypes.IMPORT_INVOICE_PAYMENT_INSURANCES_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentInsuranceActionFail(
								modelAction.InvoicePaymentInsuranceModelActionTypes.IMPORT_INVOICE_PAYMENT_INSURANCES_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentInsuranceAction>(modelAction.InvoicePaymentInsuranceModelActionTypes.FETCH_INVOICE_PAYMENT_INSURANCE_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.InvoicePaymentInsuranceActionOK(
						modelAction.InvoicePaymentInsuranceModelActionTypes.FETCH_INVOICE_PAYMENT_INSURANCE_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentInsuranceActionFail(
								modelAction.InvoicePaymentInsuranceModelActionTypes.FETCH_INVOICE_PAYMENT_INSURANCE_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentInsuranceAction>(modelAction.InvoicePaymentInsuranceModelActionTypes.FETCH_INVOICE_PAYMENT_INSURANCE_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.InvoicePaymentInsuranceActionOK(
						modelAction.InvoicePaymentInsuranceModelActionTypes.FETCH_INVOICE_PAYMENT_INSURANCE_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentInsuranceActionFail(
								modelAction.InvoicePaymentInsuranceModelActionTypes.FETCH_INVOICE_PAYMENT_INSURANCE_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
