...
/**
 * InvoicePaymentInsuranceCollectionState would store the state of a collection of InvoicePaymentInsurance
 */
export interface InvoicePaymentInsuranceCollectionState extends CollectionState {
 ...
 */
export interface InvoicePaymentInsuranceModelAudit extends AbstractModelAudit<InvoicePaymentInsuranceModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * InvoicePaymentInsuranceModelState would store the state of the model
 */
export interface InvoicePaymentInsuranceModelState {
	collectionState: {
		[key: string]: InvoicePaymentInsuranceCollectionState;
	};
	data: {
		[id: string]: InvoicePaymentInsuranceModel;
	};
	totalCount: number;
	audits: InvoicePaymentInsuranceModelAudit[];
 ...
 */
export const initialInvoicePaymentInsuranceCollectionState: InvoicePaymentInsuranceCollectionState = {
...
/**
 * The initial state of InvoicePaymentInsuranceModelState
 */
export const initialState: InvoicePaymentInsuranceModelState = {
	collectionState: {
