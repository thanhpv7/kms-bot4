...
import * as modelAction from './pcare_club_prolanis.model.action';
import {PcareClubProlanisService} from '../../services/pcareClubProlanis/pcare_club_prolanis.service';
...
/**
 * Effect class used for side effects related to PCare Club Prolanis model.
 */
@Injectable()
export class PcareClubProlanisEffect {
	...
	constructor(
		...
		protected readonly service: PcareClubProlanisService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareClubProlanisAction>(modelAction.PcareClubProlanisModelActionTypes.COUNT_PCARE_CLUB_PROLANISS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.PcareClubProlanisActionOK(
						modelAction.PcareClubProlanisModelActionTypes.COUNT_PCARE_CLUB_PROLANISS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareClubProlanisActionFail(
								modelAction.PcareClubProlanisModelActionTypes.COUNT_PCARE_CLUB_PROLANISS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareClubProlanisAction>(modelAction.PcareClubProlanisModelActionTypes.FETCH_PCARE_CLUB_PROLANIS),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareClubProlanisActionOK(
						modelAction.PcareClubProlanisModelActionTypes.FETCH_PCARE_CLUB_PROLANIS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareClubProlanisActionFail(
								modelAction.PcareClubProlanisModelActionTypes.FETCH_PCARE_CLUB_PROLANIS_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareClubProlanisAction>(modelAction.PcareClubProlanisModelActionTypes.FETCH_ALL_PCARE_CLUB_PROLANIS),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.PcareClubProlanisActionOK(
						modelAction.PcareClubProlanisModelActionTypes.FETCH_ALL_PCARE_CLUB_PROLANIS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareClubProlanisActionFail(
								modelAction.PcareClubProlanisModelActionTypes.FETCH_ALL_PCARE_CLUB_PROLANIS_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareClubProlanisAction>(modelAction.PcareClubProlanisModelActionTypes.FETCH_PCARE_CLUB_PROLANIS_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareClubProlanisActionOK(
						modelAction.PcareClubProlanisModelActionTypes.FETCH_PCARE_CLUB_PROLANIS_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareClubProlanisActionFail(
								modelAction.PcareClubProlanisModelActionTypes.FETCH_PCARE_CLUB_PROLANIS_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareClubProlanisAction>(modelAction.PcareClubProlanisModelActionTypes.FETCH_LAST_PCARE_CLUB_PROLANIS_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareClubProlanisActionOK(
						modelAction.PcareClubProlanisModelActionTypes.FETCH_LAST_PCARE_CLUB_PROLANIS_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareClubProlanisActionFail(
								modelAction.PcareClubProlanisModelActionTypes.FETCH_LAST_PCARE_CLUB_PROLANIS_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareClubProlanisAction>(modelAction.PcareClubProlanisModelActionTypes.CREATE_PCARE_CLUB_PROLANIS),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as PcareClubProlanisModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareClubProlanisActionOK(
						modelAction.PcareClubProlanisModelActionTypes.CREATE_PCARE_CLUB_PROLANIS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareClubProlanisActionFail(
								modelAction.PcareClubProlanisModelActionTypes.CREATE_PCARE_CLUB_PROLANIS_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareClubProlanisAction>(modelAction.PcareClubProlanisModelActionTypes.CREATE_ALL_PCARE_CLUB_PROLANIS),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as PcareClubProlanisModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareClubProlanisActionOK(
						modelAction.PcareClubProlanisModelActionTypes.CREATE_ALL_PCARE_CLUB_PROLANIS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareClubProlanisActionFail(
								modelAction.PcareClubProlanisModelActionTypes.CREATE_ALL_PCARE_CLUB_PROLANIS_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareClubProlanisAction>(modelAction.PcareClubProlanisModelActionTypes.UPDATE_PCARE_CLUB_PROLANIS),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as PcareClubProlanisModel;
				...
				return this.service.update(new PcareClubProlanisModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareClubProlanisActionOK(
						modelAction.PcareClubProlanisModelActionTypes.UPDATE_PCARE_CLUB_PROLANIS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareClubProlanisActionFail(
								modelAction.PcareClubProlanisModelActionTypes.UPDATE_PCARE_CLUB_PROLANIS_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareClubProlanisAction>(modelAction.PcareClubProlanisModelActionTypes.UPDATE_ALL_PCARE_CLUB_PROLANIS),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as PcareClubProlanisModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new PcareClubProlanisModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareClubProlanisActionOK(
						modelAction.PcareClubProlanisModelActionTypes.UPDATE_ALL_PCARE_CLUB_PROLANIS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareClubProlanisActionFail(
								modelAction.PcareClubProlanisModelActionTypes.UPDATE_ALL_PCARE_CLUB_PROLANIS_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareClubProlanisAction>(modelAction.PcareClubProlanisModelActionTypes.DELETE_PCARE_CLUB_PROLANIS),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PcareClubProlanisActionOK(
						modelAction.PcareClubProlanisModelActionTypes.DELETE_PCARE_CLUB_PROLANIS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareClubProlanisActionFail(
								modelAction.PcareClubProlanisModelActionTypes.DELETE_PCARE_CLUB_PROLANIS_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareClubProlanisAction>(modelAction.PcareClubProlanisModelActionTypes.DELETE_PCARE_CLUB_PROLANIS_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.PcareClubProlanisActionOK(
						modelAction.PcareClubProlanisModelActionTypes.DELETE_PCARE_CLUB_PROLANIS_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareClubProlanisActionFail(
								modelAction.PcareClubProlanisModelActionTypes.DELETE_PCARE_CLUB_PROLANIS_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareClubProlanisAction>(modelAction.PcareClubProlanisModelActionTypes.DELETE_ALL_PCARE_CLUB_PROLANIS),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PcareClubProlanisActionOK(
						modelAction.PcareClubProlanisModelActionTypes.DELETE_ALL_PCARE_CLUB_PROLANIS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareClubProlanisActionFail(
								modelAction.PcareClubProlanisModelActionTypes.DELETE_ALL_PCARE_CLUB_PROLANIS_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareClubProlanisAction>(modelAction.PcareClubProlanisModelActionTypes.EXPORT_PCARE_CLUB_PROLANIS),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PcareClubProlanisActionOK(
						modelAction.PcareClubProlanisModelActionTypes.EXPORT_PCARE_CLUB_PROLANIS,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareClubProlanisAction>(modelAction.PcareClubProlanisModelActionTypes.EXPORT_ALL_PCARE_CLUB_PROLANIS),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PcareClubProlanisActionOK(
						modelAction.PcareClubProlanisModelActionTypes.EXPORT_ALL_PCARE_CLUB_PROLANIS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareClubProlanisActionFail(
								modelAction.PcareClubProlanisModelActionTypes.EXPORT_ALL_PCARE_CLUB_PROLANIS_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareClubProlanisAction>(modelAction.PcareClubProlanisModelActionTypes.EXPORT_PCARE_CLUB_PROLANIS_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PcareClubProlanisActionOK(
						modelAction.PcareClubProlanisModelActionTypes.EXPORT_PCARE_CLUB_PROLANIS_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareClubProlanisActionFail(
								modelAction.PcareClubProlanisModelActionTypes.EXPORT_PCARE_CLUB_PROLANIS_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareClubProlanisAction>(modelAction.PcareClubProlanisModelActionTypes.IMPORT_PCARE_CLUB_PROLANISS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.PcareClubProlanisActionOK(
						modelAction.PcareClubProlanisModelActionTypes.IMPORT_PCARE_CLUB_PROLANISS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareClubProlanisActionFail(
								modelAction.PcareClubProlanisModelActionTypes.IMPORT_PCARE_CLUB_PROLANISS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareClubProlanisAction>(modelAction.PcareClubProlanisModelActionTypes.FETCH_PCARE_CLUB_PROLANIS_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.PcareClubProlanisActionOK(
						modelAction.PcareClubProlanisModelActionTypes.FETCH_PCARE_CLUB_PROLANIS_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PcareClubProlanisActionFail(
								modelAction.PcareClubProlanisModelActionTypes.FETCH_PCARE_CLUB_PROLANIS_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareClubProlanisAction>(modelAction.PcareClubProlanisModelActionTypes.FETCH_PCARE_CLUB_PROLANIS_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.PcareClubProlanisActionOK(
						modelAction.PcareClubProlanisModelActionTypes.FETCH_PCARE_CLUB_PROLANIS_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PcareClubProlanisActionFail(
								modelAction.PcareClubProlanisModelActionTypes.FETCH_PCARE_CLUB_PROLANIS_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
