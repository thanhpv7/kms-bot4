...
/**
 * PcareClubProlanisCollectionState would store the state of a collection of PcareClubProlanis
 */
export interface PcareClubProlanisCollectionState extends CollectionState {
 ...
 */
export interface PcareClubProlanisModelAudit extends AbstractModelAudit<PcareClubProlanisModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * PcareClubProlanisModelState would store the state of the model
 */
export interface PcareClubProlanisModelState {
	collectionState: {
		[key: string]: PcareClubProlanisCollectionState;
	};
	data: {
		[id: string]: PcareClubProlanisModel;
	};
	totalCount: number;
	audits: PcareClubProlanisModelAudit[];
 ...
 */
export const initialPcareClubProlanisCollectionState: PcareClubProlanisCollectionState = {
...
/**
 * The initial state of PcareClubProlanisModelState
 */
export const initialState: PcareClubProlanisModelState = {
	collectionState: {
