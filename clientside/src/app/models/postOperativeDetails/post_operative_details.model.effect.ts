...
import * as modelAction from './post_operative_details.model.action';
import {PostOperativeDetailsService} from '../../services/postOperativeDetails/post_operative_details.service';
...
/**
 * Effect class used for side effects related to Post Operative Details model.
 */
@Injectable()
export class PostOperativeDetailsEffect {
	...
	constructor(
		...
		protected readonly service: PostOperativeDetailsService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PostOperativeDetailsAction>(modelAction.PostOperativeDetailsModelActionTypes.COUNT_POST_OPERATIVE_DETAILSS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.PostOperativeDetailsActionOK(
						modelAction.PostOperativeDetailsModelActionTypes.COUNT_POST_OPERATIVE_DETAILSS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PostOperativeDetailsActionFail(
								modelAction.PostOperativeDetailsModelActionTypes.COUNT_POST_OPERATIVE_DETAILSS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PostOperativeDetailsAction>(modelAction.PostOperativeDetailsModelActionTypes.FETCH_POST_OPERATIVE_DETAILS),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PostOperativeDetailsActionOK(
						modelAction.PostOperativeDetailsModelActionTypes.FETCH_POST_OPERATIVE_DETAILS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PostOperativeDetailsActionFail(
								modelAction.PostOperativeDetailsModelActionTypes.FETCH_POST_OPERATIVE_DETAILS_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PostOperativeDetailsAction>(modelAction.PostOperativeDetailsModelActionTypes.FETCH_ALL_POST_OPERATIVE_DETAILS),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.PostOperativeDetailsActionOK(
						modelAction.PostOperativeDetailsModelActionTypes.FETCH_ALL_POST_OPERATIVE_DETAILS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PostOperativeDetailsActionFail(
								modelAction.PostOperativeDetailsModelActionTypes.FETCH_ALL_POST_OPERATIVE_DETAILS_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PostOperativeDetailsAction>(modelAction.PostOperativeDetailsModelActionTypes.FETCH_POST_OPERATIVE_DETAILS_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PostOperativeDetailsActionOK(
						modelAction.PostOperativeDetailsModelActionTypes.FETCH_POST_OPERATIVE_DETAILS_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PostOperativeDetailsActionFail(
								modelAction.PostOperativeDetailsModelActionTypes.FETCH_POST_OPERATIVE_DETAILS_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PostOperativeDetailsAction>(modelAction.PostOperativeDetailsModelActionTypes.FETCH_LAST_POST_OPERATIVE_DETAILS_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PostOperativeDetailsActionOK(
						modelAction.PostOperativeDetailsModelActionTypes.FETCH_LAST_POST_OPERATIVE_DETAILS_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PostOperativeDetailsActionFail(
								modelAction.PostOperativeDetailsModelActionTypes.FETCH_LAST_POST_OPERATIVE_DETAILS_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PostOperativeDetailsAction>(modelAction.PostOperativeDetailsModelActionTypes.CREATE_POST_OPERATIVE_DETAILS),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as PostOperativeDetailsModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PostOperativeDetailsActionOK(
						modelAction.PostOperativeDetailsModelActionTypes.CREATE_POST_OPERATIVE_DETAILS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PostOperativeDetailsActionFail(
								modelAction.PostOperativeDetailsModelActionTypes.CREATE_POST_OPERATIVE_DETAILS_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PostOperativeDetailsAction>(modelAction.PostOperativeDetailsModelActionTypes.CREATE_ALL_POST_OPERATIVE_DETAILS),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as PostOperativeDetailsModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PostOperativeDetailsActionOK(
						modelAction.PostOperativeDetailsModelActionTypes.CREATE_ALL_POST_OPERATIVE_DETAILS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PostOperativeDetailsActionFail(
								modelAction.PostOperativeDetailsModelActionTypes.CREATE_ALL_POST_OPERATIVE_DETAILS_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PostOperativeDetailsAction>(modelAction.PostOperativeDetailsModelActionTypes.UPDATE_POST_OPERATIVE_DETAILS),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as PostOperativeDetailsModel;
				...
				return this.service.update(new PostOperativeDetailsModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.PostOperativeDetailsActionOK(
						modelAction.PostOperativeDetailsModelActionTypes.UPDATE_POST_OPERATIVE_DETAILS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PostOperativeDetailsActionFail(
								modelAction.PostOperativeDetailsModelActionTypes.UPDATE_POST_OPERATIVE_DETAILS_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PostOperativeDetailsAction>(modelAction.PostOperativeDetailsModelActionTypes.UPDATE_ALL_POST_OPERATIVE_DETAILS),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as PostOperativeDetailsModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new PostOperativeDetailsModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PostOperativeDetailsActionOK(
						modelAction.PostOperativeDetailsModelActionTypes.UPDATE_ALL_POST_OPERATIVE_DETAILS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PostOperativeDetailsActionFail(
								modelAction.PostOperativeDetailsModelActionTypes.UPDATE_ALL_POST_OPERATIVE_DETAILS_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PostOperativeDetailsAction>(modelAction.PostOperativeDetailsModelActionTypes.DELETE_POST_OPERATIVE_DETAILS),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PostOperativeDetailsActionOK(
						modelAction.PostOperativeDetailsModelActionTypes.DELETE_POST_OPERATIVE_DETAILS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PostOperativeDetailsActionFail(
								modelAction.PostOperativeDetailsModelActionTypes.DELETE_POST_OPERATIVE_DETAILS_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PostOperativeDetailsAction>(modelAction.PostOperativeDetailsModelActionTypes.DELETE_POST_OPERATIVE_DETAILS_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.PostOperativeDetailsActionOK(
						modelAction.PostOperativeDetailsModelActionTypes.DELETE_POST_OPERATIVE_DETAILS_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PostOperativeDetailsActionFail(
								modelAction.PostOperativeDetailsModelActionTypes.DELETE_POST_OPERATIVE_DETAILS_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PostOperativeDetailsAction>(modelAction.PostOperativeDetailsModelActionTypes.DELETE_ALL_POST_OPERATIVE_DETAILS),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PostOperativeDetailsActionOK(
						modelAction.PostOperativeDetailsModelActionTypes.DELETE_ALL_POST_OPERATIVE_DETAILS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PostOperativeDetailsActionFail(
								modelAction.PostOperativeDetailsModelActionTypes.DELETE_ALL_POST_OPERATIVE_DETAILS_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PostOperativeDetailsAction>(modelAction.PostOperativeDetailsModelActionTypes.EXPORT_POST_OPERATIVE_DETAILS),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PostOperativeDetailsActionOK(
						modelAction.PostOperativeDetailsModelActionTypes.EXPORT_POST_OPERATIVE_DETAILS,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PostOperativeDetailsAction>(modelAction.PostOperativeDetailsModelActionTypes.EXPORT_ALL_POST_OPERATIVE_DETAILS),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PostOperativeDetailsActionOK(
						modelAction.PostOperativeDetailsModelActionTypes.EXPORT_ALL_POST_OPERATIVE_DETAILS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PostOperativeDetailsActionFail(
								modelAction.PostOperativeDetailsModelActionTypes.EXPORT_ALL_POST_OPERATIVE_DETAILS_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PostOperativeDetailsAction>(modelAction.PostOperativeDetailsModelActionTypes.EXPORT_POST_OPERATIVE_DETAILS_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PostOperativeDetailsActionOK(
						modelAction.PostOperativeDetailsModelActionTypes.EXPORT_POST_OPERATIVE_DETAILS_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PostOperativeDetailsActionFail(
								modelAction.PostOperativeDetailsModelActionTypes.EXPORT_POST_OPERATIVE_DETAILS_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PostOperativeDetailsAction>(modelAction.PostOperativeDetailsModelActionTypes.IMPORT_POST_OPERATIVE_DETAILSS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.PostOperativeDetailsActionOK(
						modelAction.PostOperativeDetailsModelActionTypes.IMPORT_POST_OPERATIVE_DETAILSS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PostOperativeDetailsActionFail(
								modelAction.PostOperativeDetailsModelActionTypes.IMPORT_POST_OPERATIVE_DETAILSS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PostOperativeDetailsAction>(modelAction.PostOperativeDetailsModelActionTypes.FETCH_POST_OPERATIVE_DETAILS_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.PostOperativeDetailsActionOK(
						modelAction.PostOperativeDetailsModelActionTypes.FETCH_POST_OPERATIVE_DETAILS_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PostOperativeDetailsActionFail(
								modelAction.PostOperativeDetailsModelActionTypes.FETCH_POST_OPERATIVE_DETAILS_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PostOperativeDetailsAction>(modelAction.PostOperativeDetailsModelActionTypes.FETCH_POST_OPERATIVE_DETAILS_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.PostOperativeDetailsActionOK(
						modelAction.PostOperativeDetailsModelActionTypes.FETCH_POST_OPERATIVE_DETAILS_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PostOperativeDetailsActionFail(
								modelAction.PostOperativeDetailsModelActionTypes.FETCH_POST_OPERATIVE_DETAILS_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
