...
/**
 * PostOperativeDetailsCollectionState would store the state of a collection of PostOperativeDetails
 */
export interface PostOperativeDetailsCollectionState extends CollectionState {
 ...
 */
export interface PostOperativeDetailsModelAudit extends AbstractModelAudit<PostOperativeDetailsModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * PostOperativeDetailsModelState would store the state of the model
 */
export interface PostOperativeDetailsModelState {
	collectionState: {
		[key: string]: PostOperativeDetailsCollectionState;
	};
	data: {
		[id: string]: PostOperativeDetailsModel;
	};
	totalCount: number;
	audits: PostOperativeDetailsModelAudit[];
 ...
 */
export const initialPostOperativeDetailsCollectionState: PostOperativeDetailsCollectionState = {
...
/**
 * The initial state of PostOperativeDetailsModelState
 */
export const initialState: PostOperativeDetailsModelState = {
	collectionState: {
