...
/**
 * PcareExaminationCollectionState would store the state of a collection of PcareExamination
 */
export interface PcareExaminationCollectionState extends CollectionState {
 ...
 */
export interface PcareExaminationModelAudit extends AbstractModelAudit<PcareExaminationModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * PcareExaminationModelState would store the state of the model
 */
export interface PcareExaminationModelState {
	collectionState: {
		[key: string]: PcareExaminationCollectionState;
	};
	data: {
		[id: string]: PcareExaminationModel;
	};
	totalCount: number;
	audits: PcareExaminationModelAudit[];
 ...
 */
export const initialPcareExaminationCollectionState: PcareExaminationCollectionState = {
...
/**
 * The initial state of PcareExaminationModelState
 */
export const initialState: PcareExaminationModelState = {
	collectionState: {
