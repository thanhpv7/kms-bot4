...
import * as modelAction from './pcare_examination.model.action';
import {PcareExaminationService} from '../../services/pcareExamination/pcare_examination.service';
...
/**
 * Effect class used for side effects related to PCare Examination model.
 */
@Injectable()
export class PcareExaminationEffect {
	...
	constructor(
		...
		protected readonly service: PcareExaminationService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareExaminationAction>(modelAction.PcareExaminationModelActionTypes.COUNT_PCARE_EXAMINATIONS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.PcareExaminationActionOK(
						modelAction.PcareExaminationModelActionTypes.COUNT_PCARE_EXAMINATIONS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareExaminationActionFail(
								modelAction.PcareExaminationModelActionTypes.COUNT_PCARE_EXAMINATIONS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareExaminationAction>(modelAction.PcareExaminationModelActionTypes.FETCH_PCARE_EXAMINATION),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareExaminationActionOK(
						modelAction.PcareExaminationModelActionTypes.FETCH_PCARE_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareExaminationActionFail(
								modelAction.PcareExaminationModelActionTypes.FETCH_PCARE_EXAMINATION_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareExaminationAction>(modelAction.PcareExaminationModelActionTypes.FETCH_ALL_PCARE_EXAMINATION),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.PcareExaminationActionOK(
						modelAction.PcareExaminationModelActionTypes.FETCH_ALL_PCARE_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareExaminationActionFail(
								modelAction.PcareExaminationModelActionTypes.FETCH_ALL_PCARE_EXAMINATION_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareExaminationAction>(modelAction.PcareExaminationModelActionTypes.FETCH_PCARE_EXAMINATION_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareExaminationActionOK(
						modelAction.PcareExaminationModelActionTypes.FETCH_PCARE_EXAMINATION_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareExaminationActionFail(
								modelAction.PcareExaminationModelActionTypes.FETCH_PCARE_EXAMINATION_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareExaminationAction>(modelAction.PcareExaminationModelActionTypes.FETCH_LAST_PCARE_EXAMINATION_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareExaminationActionOK(
						modelAction.PcareExaminationModelActionTypes.FETCH_LAST_PCARE_EXAMINATION_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareExaminationActionFail(
								modelAction.PcareExaminationModelActionTypes.FETCH_LAST_PCARE_EXAMINATION_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareExaminationAction>(modelAction.PcareExaminationModelActionTypes.CREATE_PCARE_EXAMINATION),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as PcareExaminationModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareExaminationActionOK(
						modelAction.PcareExaminationModelActionTypes.CREATE_PCARE_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareExaminationActionFail(
								modelAction.PcareExaminationModelActionTypes.CREATE_PCARE_EXAMINATION_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareExaminationAction>(modelAction.PcareExaminationModelActionTypes.CREATE_ALL_PCARE_EXAMINATION),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as PcareExaminationModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareExaminationActionOK(
						modelAction.PcareExaminationModelActionTypes.CREATE_ALL_PCARE_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareExaminationActionFail(
								modelAction.PcareExaminationModelActionTypes.CREATE_ALL_PCARE_EXAMINATION_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareExaminationAction>(modelAction.PcareExaminationModelActionTypes.UPDATE_PCARE_EXAMINATION),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as PcareExaminationModel;
				...
				return this.service.update(new PcareExaminationModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareExaminationActionOK(
						modelAction.PcareExaminationModelActionTypes.UPDATE_PCARE_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareExaminationActionFail(
								modelAction.PcareExaminationModelActionTypes.UPDATE_PCARE_EXAMINATION_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareExaminationAction>(modelAction.PcareExaminationModelActionTypes.UPDATE_ALL_PCARE_EXAMINATION),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as PcareExaminationModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new PcareExaminationModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareExaminationActionOK(
						modelAction.PcareExaminationModelActionTypes.UPDATE_ALL_PCARE_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareExaminationActionFail(
								modelAction.PcareExaminationModelActionTypes.UPDATE_ALL_PCARE_EXAMINATION_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareExaminationAction>(modelAction.PcareExaminationModelActionTypes.DELETE_PCARE_EXAMINATION),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PcareExaminationActionOK(
						modelAction.PcareExaminationModelActionTypes.DELETE_PCARE_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareExaminationActionFail(
								modelAction.PcareExaminationModelActionTypes.DELETE_PCARE_EXAMINATION_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareExaminationAction>(modelAction.PcareExaminationModelActionTypes.DELETE_PCARE_EXAMINATION_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.PcareExaminationActionOK(
						modelAction.PcareExaminationModelActionTypes.DELETE_PCARE_EXAMINATION_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareExaminationActionFail(
								modelAction.PcareExaminationModelActionTypes.DELETE_PCARE_EXAMINATION_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareExaminationAction>(modelAction.PcareExaminationModelActionTypes.DELETE_ALL_PCARE_EXAMINATION),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PcareExaminationActionOK(
						modelAction.PcareExaminationModelActionTypes.DELETE_ALL_PCARE_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareExaminationActionFail(
								modelAction.PcareExaminationModelActionTypes.DELETE_ALL_PCARE_EXAMINATION_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareExaminationAction>(modelAction.PcareExaminationModelActionTypes.EXPORT_PCARE_EXAMINATION),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PcareExaminationActionOK(
						modelAction.PcareExaminationModelActionTypes.EXPORT_PCARE_EXAMINATION,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareExaminationAction>(modelAction.PcareExaminationModelActionTypes.EXPORT_ALL_PCARE_EXAMINATION),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PcareExaminationActionOK(
						modelAction.PcareExaminationModelActionTypes.EXPORT_ALL_PCARE_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareExaminationActionFail(
								modelAction.PcareExaminationModelActionTypes.EXPORT_ALL_PCARE_EXAMINATION_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareExaminationAction>(modelAction.PcareExaminationModelActionTypes.EXPORT_PCARE_EXAMINATION_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PcareExaminationActionOK(
						modelAction.PcareExaminationModelActionTypes.EXPORT_PCARE_EXAMINATION_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareExaminationActionFail(
								modelAction.PcareExaminationModelActionTypes.EXPORT_PCARE_EXAMINATION_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareExaminationAction>(modelAction.PcareExaminationModelActionTypes.IMPORT_PCARE_EXAMINATIONS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.PcareExaminationActionOK(
						modelAction.PcareExaminationModelActionTypes.IMPORT_PCARE_EXAMINATIONS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareExaminationActionFail(
								modelAction.PcareExaminationModelActionTypes.IMPORT_PCARE_EXAMINATIONS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareExaminationAction>(modelAction.PcareExaminationModelActionTypes.FETCH_PCARE_EXAMINATION_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.PcareExaminationActionOK(
						modelAction.PcareExaminationModelActionTypes.FETCH_PCARE_EXAMINATION_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PcareExaminationActionFail(
								modelAction.PcareExaminationModelActionTypes.FETCH_PCARE_EXAMINATION_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareExaminationAction>(modelAction.PcareExaminationModelActionTypes.FETCH_PCARE_EXAMINATION_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.PcareExaminationActionOK(
						modelAction.PcareExaminationModelActionTypes.FETCH_PCARE_EXAMINATION_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PcareExaminationActionFail(
								modelAction.PcareExaminationModelActionTypes.FETCH_PCARE_EXAMINATION_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
