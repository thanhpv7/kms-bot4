...
import * as modelAction from './warehouse_initial_stock.model.action';
import {WarehouseInitialStockService} from '../../services/warehouseInitialStock/warehouse_initial_stock.service';
...
/**
 * Effect class used for side effects related to Warehouse Initial Stock  model.
 */
@Injectable()
export class WarehouseInitialStockEffect {
	...
	constructor(
		...
		protected readonly service: WarehouseInitialStockService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseInitialStockAction>(modelAction.WarehouseInitialStockModelActionTypes.COUNT_WAREHOUSE_INITIAL_STOCKS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.WarehouseInitialStockActionOK(
						modelAction.WarehouseInitialStockModelActionTypes.COUNT_WAREHOUSE_INITIAL_STOCKS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseInitialStockActionFail(
								modelAction.WarehouseInitialStockModelActionTypes.COUNT_WAREHOUSE_INITIAL_STOCKS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseInitialStockAction>(modelAction.WarehouseInitialStockModelActionTypes.FETCH_WAREHOUSE_INITIAL_STOCK),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.WarehouseInitialStockActionOK(
						modelAction.WarehouseInitialStockModelActionTypes.FETCH_WAREHOUSE_INITIAL_STOCK_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseInitialStockActionFail(
								modelAction.WarehouseInitialStockModelActionTypes.FETCH_WAREHOUSE_INITIAL_STOCK_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseInitialStockAction>(modelAction.WarehouseInitialStockModelActionTypes.FETCH_ALL_WAREHOUSE_INITIAL_STOCK),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.WarehouseInitialStockActionOK(
						modelAction.WarehouseInitialStockModelActionTypes.FETCH_ALL_WAREHOUSE_INITIAL_STOCK_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseInitialStockActionFail(
								modelAction.WarehouseInitialStockModelActionTypes.FETCH_ALL_WAREHOUSE_INITIAL_STOCK_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseInitialStockAction>(modelAction.WarehouseInitialStockModelActionTypes.FETCH_WAREHOUSE_INITIAL_STOCK_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.WarehouseInitialStockActionOK(
						modelAction.WarehouseInitialStockModelActionTypes.FETCH_WAREHOUSE_INITIAL_STOCK_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseInitialStockActionFail(
								modelAction.WarehouseInitialStockModelActionTypes.FETCH_WAREHOUSE_INITIAL_STOCK_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseInitialStockAction>(modelAction.WarehouseInitialStockModelActionTypes.FETCH_LAST_WAREHOUSE_INITIAL_STOCK_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.WarehouseInitialStockActionOK(
						modelAction.WarehouseInitialStockModelActionTypes.FETCH_LAST_WAREHOUSE_INITIAL_STOCK_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseInitialStockActionFail(
								modelAction.WarehouseInitialStockModelActionTypes.FETCH_LAST_WAREHOUSE_INITIAL_STOCK_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseInitialStockAction>(modelAction.WarehouseInitialStockModelActionTypes.CREATE_WAREHOUSE_INITIAL_STOCK),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as WarehouseInitialStockModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.WarehouseInitialStockActionOK(
						modelAction.WarehouseInitialStockModelActionTypes.CREATE_WAREHOUSE_INITIAL_STOCK_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseInitialStockActionFail(
								modelAction.WarehouseInitialStockModelActionTypes.CREATE_WAREHOUSE_INITIAL_STOCK_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseInitialStockAction>(modelAction.WarehouseInitialStockModelActionTypes.CREATE_ALL_WAREHOUSE_INITIAL_STOCK),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as WarehouseInitialStockModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.WarehouseInitialStockActionOK(
						modelAction.WarehouseInitialStockModelActionTypes.CREATE_ALL_WAREHOUSE_INITIAL_STOCK_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseInitialStockActionFail(
								modelAction.WarehouseInitialStockModelActionTypes.CREATE_ALL_WAREHOUSE_INITIAL_STOCK_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseInitialStockAction>(modelAction.WarehouseInitialStockModelActionTypes.UPDATE_WAREHOUSE_INITIAL_STOCK),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as WarehouseInitialStockModel;
				...
				return this.service.update(new WarehouseInitialStockModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.WarehouseInitialStockActionOK(
						modelAction.WarehouseInitialStockModelActionTypes.UPDATE_WAREHOUSE_INITIAL_STOCK_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseInitialStockActionFail(
								modelAction.WarehouseInitialStockModelActionTypes.UPDATE_WAREHOUSE_INITIAL_STOCK_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseInitialStockAction>(modelAction.WarehouseInitialStockModelActionTypes.UPDATE_ALL_WAREHOUSE_INITIAL_STOCK),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as WarehouseInitialStockModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new WarehouseInitialStockModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.WarehouseInitialStockActionOK(
						modelAction.WarehouseInitialStockModelActionTypes.UPDATE_ALL_WAREHOUSE_INITIAL_STOCK_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseInitialStockActionFail(
								modelAction.WarehouseInitialStockModelActionTypes.UPDATE_ALL_WAREHOUSE_INITIAL_STOCK_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseInitialStockAction>(modelAction.WarehouseInitialStockModelActionTypes.DELETE_WAREHOUSE_INITIAL_STOCK),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.WarehouseInitialStockActionOK(
						modelAction.WarehouseInitialStockModelActionTypes.DELETE_WAREHOUSE_INITIAL_STOCK_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseInitialStockActionFail(
								modelAction.WarehouseInitialStockModelActionTypes.DELETE_WAREHOUSE_INITIAL_STOCK_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseInitialStockAction>(modelAction.WarehouseInitialStockModelActionTypes.DELETE_WAREHOUSE_INITIAL_STOCK_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.WarehouseInitialStockActionOK(
						modelAction.WarehouseInitialStockModelActionTypes.DELETE_WAREHOUSE_INITIAL_STOCK_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseInitialStockActionFail(
								modelAction.WarehouseInitialStockModelActionTypes.DELETE_WAREHOUSE_INITIAL_STOCK_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseInitialStockAction>(modelAction.WarehouseInitialStockModelActionTypes.DELETE_ALL_WAREHOUSE_INITIAL_STOCK),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.WarehouseInitialStockActionOK(
						modelAction.WarehouseInitialStockModelActionTypes.DELETE_ALL_WAREHOUSE_INITIAL_STOCK_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseInitialStockActionFail(
								modelAction.WarehouseInitialStockModelActionTypes.DELETE_ALL_WAREHOUSE_INITIAL_STOCK_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseInitialStockAction>(modelAction.WarehouseInitialStockModelActionTypes.EXPORT_WAREHOUSE_INITIAL_STOCK),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.WarehouseInitialStockActionOK(
						modelAction.WarehouseInitialStockModelActionTypes.EXPORT_WAREHOUSE_INITIAL_STOCK,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseInitialStockAction>(modelAction.WarehouseInitialStockModelActionTypes.EXPORT_ALL_WAREHOUSE_INITIAL_STOCK),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.WarehouseInitialStockActionOK(
						modelAction.WarehouseInitialStockModelActionTypes.EXPORT_ALL_WAREHOUSE_INITIAL_STOCK_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseInitialStockActionFail(
								modelAction.WarehouseInitialStockModelActionTypes.EXPORT_ALL_WAREHOUSE_INITIAL_STOCK_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseInitialStockAction>(modelAction.WarehouseInitialStockModelActionTypes.EXPORT_WAREHOUSE_INITIAL_STOCK_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.WarehouseInitialStockActionOK(
						modelAction.WarehouseInitialStockModelActionTypes.EXPORT_WAREHOUSE_INITIAL_STOCK_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseInitialStockActionFail(
								modelAction.WarehouseInitialStockModelActionTypes.EXPORT_WAREHOUSE_INITIAL_STOCK_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseInitialStockAction>(modelAction.WarehouseInitialStockModelActionTypes.IMPORT_WAREHOUSE_INITIAL_STOCKS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.WarehouseInitialStockActionOK(
						modelAction.WarehouseInitialStockModelActionTypes.IMPORT_WAREHOUSE_INITIAL_STOCKS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseInitialStockActionFail(
								modelAction.WarehouseInitialStockModelActionTypes.IMPORT_WAREHOUSE_INITIAL_STOCKS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseInitialStockAction>(modelAction.WarehouseInitialStockModelActionTypes.FETCH_WAREHOUSE_INITIAL_STOCK_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.WarehouseInitialStockActionOK(
						modelAction.WarehouseInitialStockModelActionTypes.FETCH_WAREHOUSE_INITIAL_STOCK_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseInitialStockActionFail(
								modelAction.WarehouseInitialStockModelActionTypes.FETCH_WAREHOUSE_INITIAL_STOCK_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseInitialStockAction>(modelAction.WarehouseInitialStockModelActionTypes.FETCH_WAREHOUSE_INITIAL_STOCK_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.WarehouseInitialStockActionOK(
						modelAction.WarehouseInitialStockModelActionTypes.FETCH_WAREHOUSE_INITIAL_STOCK_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseInitialStockActionFail(
								modelAction.WarehouseInitialStockModelActionTypes.FETCH_WAREHOUSE_INITIAL_STOCK_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
