...
/**
 * WarehouseInitialStockCollectionState would store the state of a collection of WarehouseInitialStock
 */
export interface WarehouseInitialStockCollectionState extends CollectionState {
 ...
 */
export interface WarehouseInitialStockModelAudit extends AbstractModelAudit<WarehouseInitialStockModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * WarehouseInitialStockModelState would store the state of the model
 */
export interface WarehouseInitialStockModelState {
	collectionState: {
		[key: string]: WarehouseInitialStockCollectionState;
	};
	data: {
		[id: string]: WarehouseInitialStockModel;
	};
	totalCount: number;
	audits: WarehouseInitialStockModelAudit[];
 ...
 */
export const initialWarehouseInitialStockCollectionState: WarehouseInitialStockCollectionState = {
...
/**
 * The initial state of WarehouseInitialStockModelState
 */
export const initialState: WarehouseInitialStockModelState = {
	collectionState: {
