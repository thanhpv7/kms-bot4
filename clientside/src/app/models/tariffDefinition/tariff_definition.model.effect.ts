...
import * as modelAction from './tariff_definition.model.action';
import {TariffDefinitionService} from '../../services/tariffDefinition/tariff_definition.service';
...
/**
 * Effect class used for side effects related to Tariff Definition model.
 */
@Injectable()
export class TariffDefinitionEffect {
	...
	constructor(
		...
		protected readonly service: TariffDefinitionService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffDefinitionAction>(modelAction.TariffDefinitionModelActionTypes.COUNT_TARIFF_DEFINITIONS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.TariffDefinitionActionOK(
						modelAction.TariffDefinitionModelActionTypes.COUNT_TARIFF_DEFINITIONS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffDefinitionActionFail(
								modelAction.TariffDefinitionModelActionTypes.COUNT_TARIFF_DEFINITIONS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffDefinitionAction>(modelAction.TariffDefinitionModelActionTypes.FETCH_TARIFF_DEFINITION),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.TariffDefinitionActionOK(
						modelAction.TariffDefinitionModelActionTypes.FETCH_TARIFF_DEFINITION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffDefinitionActionFail(
								modelAction.TariffDefinitionModelActionTypes.FETCH_TARIFF_DEFINITION_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffDefinitionAction>(modelAction.TariffDefinitionModelActionTypes.FETCH_ALL_TARIFF_DEFINITION),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.TariffDefinitionActionOK(
						modelAction.TariffDefinitionModelActionTypes.FETCH_ALL_TARIFF_DEFINITION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffDefinitionActionFail(
								modelAction.TariffDefinitionModelActionTypes.FETCH_ALL_TARIFF_DEFINITION_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffDefinitionAction>(modelAction.TariffDefinitionModelActionTypes.FETCH_TARIFF_DEFINITION_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.TariffDefinitionActionOK(
						modelAction.TariffDefinitionModelActionTypes.FETCH_TARIFF_DEFINITION_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffDefinitionActionFail(
								modelAction.TariffDefinitionModelActionTypes.FETCH_TARIFF_DEFINITION_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffDefinitionAction>(modelAction.TariffDefinitionModelActionTypes.FETCH_LAST_TARIFF_DEFINITION_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.TariffDefinitionActionOK(
						modelAction.TariffDefinitionModelActionTypes.FETCH_LAST_TARIFF_DEFINITION_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffDefinitionActionFail(
								modelAction.TariffDefinitionModelActionTypes.FETCH_LAST_TARIFF_DEFINITION_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffDefinitionAction>(modelAction.TariffDefinitionModelActionTypes.CREATE_TARIFF_DEFINITION),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as TariffDefinitionModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.TariffDefinitionActionOK(
						modelAction.TariffDefinitionModelActionTypes.CREATE_TARIFF_DEFINITION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffDefinitionActionFail(
								modelAction.TariffDefinitionModelActionTypes.CREATE_TARIFF_DEFINITION_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffDefinitionAction>(modelAction.TariffDefinitionModelActionTypes.CREATE_ALL_TARIFF_DEFINITION),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as TariffDefinitionModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.TariffDefinitionActionOK(
						modelAction.TariffDefinitionModelActionTypes.CREATE_ALL_TARIFF_DEFINITION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffDefinitionActionFail(
								modelAction.TariffDefinitionModelActionTypes.CREATE_ALL_TARIFF_DEFINITION_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffDefinitionAction>(modelAction.TariffDefinitionModelActionTypes.UPDATE_TARIFF_DEFINITION),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as TariffDefinitionModel;
				...
				return this.service.update(new TariffDefinitionModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.TariffDefinitionActionOK(
						modelAction.TariffDefinitionModelActionTypes.UPDATE_TARIFF_DEFINITION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffDefinitionActionFail(
								modelAction.TariffDefinitionModelActionTypes.UPDATE_TARIFF_DEFINITION_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffDefinitionAction>(modelAction.TariffDefinitionModelActionTypes.UPDATE_ALL_TARIFF_DEFINITION),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as TariffDefinitionModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new TariffDefinitionModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.TariffDefinitionActionOK(
						modelAction.TariffDefinitionModelActionTypes.UPDATE_ALL_TARIFF_DEFINITION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffDefinitionActionFail(
								modelAction.TariffDefinitionModelActionTypes.UPDATE_ALL_TARIFF_DEFINITION_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffDefinitionAction>(modelAction.TariffDefinitionModelActionTypes.DELETE_TARIFF_DEFINITION),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.TariffDefinitionActionOK(
						modelAction.TariffDefinitionModelActionTypes.DELETE_TARIFF_DEFINITION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffDefinitionActionFail(
								modelAction.TariffDefinitionModelActionTypes.DELETE_TARIFF_DEFINITION_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffDefinitionAction>(modelAction.TariffDefinitionModelActionTypes.DELETE_TARIFF_DEFINITION_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.TariffDefinitionActionOK(
						modelAction.TariffDefinitionModelActionTypes.DELETE_TARIFF_DEFINITION_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffDefinitionActionFail(
								modelAction.TariffDefinitionModelActionTypes.DELETE_TARIFF_DEFINITION_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffDefinitionAction>(modelAction.TariffDefinitionModelActionTypes.DELETE_ALL_TARIFF_DEFINITION),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.TariffDefinitionActionOK(
						modelAction.TariffDefinitionModelActionTypes.DELETE_ALL_TARIFF_DEFINITION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffDefinitionActionFail(
								modelAction.TariffDefinitionModelActionTypes.DELETE_ALL_TARIFF_DEFINITION_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffDefinitionAction>(modelAction.TariffDefinitionModelActionTypes.EXPORT_TARIFF_DEFINITION),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.TariffDefinitionActionOK(
						modelAction.TariffDefinitionModelActionTypes.EXPORT_TARIFF_DEFINITION,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffDefinitionAction>(modelAction.TariffDefinitionModelActionTypes.EXPORT_ALL_TARIFF_DEFINITION),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.TariffDefinitionActionOK(
						modelAction.TariffDefinitionModelActionTypes.EXPORT_ALL_TARIFF_DEFINITION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffDefinitionActionFail(
								modelAction.TariffDefinitionModelActionTypes.EXPORT_ALL_TARIFF_DEFINITION_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffDefinitionAction>(modelAction.TariffDefinitionModelActionTypes.EXPORT_TARIFF_DEFINITION_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.TariffDefinitionActionOK(
						modelAction.TariffDefinitionModelActionTypes.EXPORT_TARIFF_DEFINITION_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffDefinitionActionFail(
								modelAction.TariffDefinitionModelActionTypes.EXPORT_TARIFF_DEFINITION_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffDefinitionAction>(modelAction.TariffDefinitionModelActionTypes.IMPORT_TARIFF_DEFINITIONS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.TariffDefinitionActionOK(
						modelAction.TariffDefinitionModelActionTypes.IMPORT_TARIFF_DEFINITIONS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffDefinitionActionFail(
								modelAction.TariffDefinitionModelActionTypes.IMPORT_TARIFF_DEFINITIONS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffDefinitionAction>(modelAction.TariffDefinitionModelActionTypes.FETCH_TARIFF_DEFINITION_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.TariffDefinitionActionOK(
						modelAction.TariffDefinitionModelActionTypes.FETCH_TARIFF_DEFINITION_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.TariffDefinitionActionFail(
								modelAction.TariffDefinitionModelActionTypes.FETCH_TARIFF_DEFINITION_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffDefinitionAction>(modelAction.TariffDefinitionModelActionTypes.FETCH_TARIFF_DEFINITION_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.TariffDefinitionActionOK(
						modelAction.TariffDefinitionModelActionTypes.FETCH_TARIFF_DEFINITION_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.TariffDefinitionActionFail(
								modelAction.TariffDefinitionModelActionTypes.FETCH_TARIFF_DEFINITION_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
