...
/**
 * TariffDefinitionCollectionState would store the state of a collection of TariffDefinition
 */
export interface TariffDefinitionCollectionState extends CollectionState {
 ...
 */
export interface TariffDefinitionModelAudit extends AbstractModelAudit<TariffDefinitionModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * TariffDefinitionModelState would store the state of the model
 */
export interface TariffDefinitionModelState {
	collectionState: {
		[key: string]: TariffDefinitionCollectionState;
	};
	data: {
		[id: string]: TariffDefinitionModel;
	};
	totalCount: number;
	audits: TariffDefinitionModelAudit[];
 ...
 */
export const initialTariffDefinitionCollectionState: TariffDefinitionCollectionState = {
...
/**
 * The initial state of TariffDefinitionModelState
 */
export const initialState: TariffDefinitionModelState = {
	collectionState: {
