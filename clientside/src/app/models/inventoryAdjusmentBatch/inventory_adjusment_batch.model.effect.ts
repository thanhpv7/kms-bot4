...
import * as modelAction from './inventory_adjusment_batch.model.action';
import {InventoryAdjusmentBatchService} from '../../services/inventoryAdjusmentBatch/inventory_adjusment_batch.service';
...
/**
 * Effect class used for side effects related to Inventory Adjusment Batch model.
 */
@Injectable()
export class InventoryAdjusmentBatchEffect {
	...
	constructor(
		...
		protected readonly service: InventoryAdjusmentBatchService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryAdjusmentBatchAction>(modelAction.InventoryAdjusmentBatchModelActionTypes.COUNT_INVENTORY_ADJUSMENT_BATCHS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.InventoryAdjusmentBatchActionOK(
						modelAction.InventoryAdjusmentBatchModelActionTypes.COUNT_INVENTORY_ADJUSMENT_BATCHS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryAdjusmentBatchActionFail(
								modelAction.InventoryAdjusmentBatchModelActionTypes.COUNT_INVENTORY_ADJUSMENT_BATCHS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryAdjusmentBatchAction>(modelAction.InventoryAdjusmentBatchModelActionTypes.FETCH_INVENTORY_ADJUSMENT_BATCH),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InventoryAdjusmentBatchActionOK(
						modelAction.InventoryAdjusmentBatchModelActionTypes.FETCH_INVENTORY_ADJUSMENT_BATCH_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryAdjusmentBatchActionFail(
								modelAction.InventoryAdjusmentBatchModelActionTypes.FETCH_INVENTORY_ADJUSMENT_BATCH_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryAdjusmentBatchAction>(modelAction.InventoryAdjusmentBatchModelActionTypes.FETCH_ALL_INVENTORY_ADJUSMENT_BATCH),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.InventoryAdjusmentBatchActionOK(
						modelAction.InventoryAdjusmentBatchModelActionTypes.FETCH_ALL_INVENTORY_ADJUSMENT_BATCH_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryAdjusmentBatchActionFail(
								modelAction.InventoryAdjusmentBatchModelActionTypes.FETCH_ALL_INVENTORY_ADJUSMENT_BATCH_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryAdjusmentBatchAction>(modelAction.InventoryAdjusmentBatchModelActionTypes.FETCH_INVENTORY_ADJUSMENT_BATCH_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.InventoryAdjusmentBatchActionOK(
						modelAction.InventoryAdjusmentBatchModelActionTypes.FETCH_INVENTORY_ADJUSMENT_BATCH_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryAdjusmentBatchActionFail(
								modelAction.InventoryAdjusmentBatchModelActionTypes.FETCH_INVENTORY_ADJUSMENT_BATCH_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryAdjusmentBatchAction>(modelAction.InventoryAdjusmentBatchModelActionTypes.FETCH_LAST_INVENTORY_ADJUSMENT_BATCH_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.InventoryAdjusmentBatchActionOK(
						modelAction.InventoryAdjusmentBatchModelActionTypes.FETCH_LAST_INVENTORY_ADJUSMENT_BATCH_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryAdjusmentBatchActionFail(
								modelAction.InventoryAdjusmentBatchModelActionTypes.FETCH_LAST_INVENTORY_ADJUSMENT_BATCH_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryAdjusmentBatchAction>(modelAction.InventoryAdjusmentBatchModelActionTypes.CREATE_INVENTORY_ADJUSMENT_BATCH),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as InventoryAdjusmentBatchModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InventoryAdjusmentBatchActionOK(
						modelAction.InventoryAdjusmentBatchModelActionTypes.CREATE_INVENTORY_ADJUSMENT_BATCH_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryAdjusmentBatchActionFail(
								modelAction.InventoryAdjusmentBatchModelActionTypes.CREATE_INVENTORY_ADJUSMENT_BATCH_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryAdjusmentBatchAction>(modelAction.InventoryAdjusmentBatchModelActionTypes.CREATE_ALL_INVENTORY_ADJUSMENT_BATCH),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as InventoryAdjusmentBatchModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InventoryAdjusmentBatchActionOK(
						modelAction.InventoryAdjusmentBatchModelActionTypes.CREATE_ALL_INVENTORY_ADJUSMENT_BATCH_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryAdjusmentBatchActionFail(
								modelAction.InventoryAdjusmentBatchModelActionTypes.CREATE_ALL_INVENTORY_ADJUSMENT_BATCH_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryAdjusmentBatchAction>(modelAction.InventoryAdjusmentBatchModelActionTypes.UPDATE_INVENTORY_ADJUSMENT_BATCH),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as InventoryAdjusmentBatchModel;
				...
				return this.service.update(new InventoryAdjusmentBatchModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.InventoryAdjusmentBatchActionOK(
						modelAction.InventoryAdjusmentBatchModelActionTypes.UPDATE_INVENTORY_ADJUSMENT_BATCH_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryAdjusmentBatchActionFail(
								modelAction.InventoryAdjusmentBatchModelActionTypes.UPDATE_INVENTORY_ADJUSMENT_BATCH_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryAdjusmentBatchAction>(modelAction.InventoryAdjusmentBatchModelActionTypes.UPDATE_ALL_INVENTORY_ADJUSMENT_BATCH),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as InventoryAdjusmentBatchModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new InventoryAdjusmentBatchModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InventoryAdjusmentBatchActionOK(
						modelAction.InventoryAdjusmentBatchModelActionTypes.UPDATE_ALL_INVENTORY_ADJUSMENT_BATCH_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryAdjusmentBatchActionFail(
								modelAction.InventoryAdjusmentBatchModelActionTypes.UPDATE_ALL_INVENTORY_ADJUSMENT_BATCH_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryAdjusmentBatchAction>(modelAction.InventoryAdjusmentBatchModelActionTypes.DELETE_INVENTORY_ADJUSMENT_BATCH),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.InventoryAdjusmentBatchActionOK(
						modelAction.InventoryAdjusmentBatchModelActionTypes.DELETE_INVENTORY_ADJUSMENT_BATCH_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryAdjusmentBatchActionFail(
								modelAction.InventoryAdjusmentBatchModelActionTypes.DELETE_INVENTORY_ADJUSMENT_BATCH_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryAdjusmentBatchAction>(modelAction.InventoryAdjusmentBatchModelActionTypes.DELETE_INVENTORY_ADJUSMENT_BATCH_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.InventoryAdjusmentBatchActionOK(
						modelAction.InventoryAdjusmentBatchModelActionTypes.DELETE_INVENTORY_ADJUSMENT_BATCH_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryAdjusmentBatchActionFail(
								modelAction.InventoryAdjusmentBatchModelActionTypes.DELETE_INVENTORY_ADJUSMENT_BATCH_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryAdjusmentBatchAction>(modelAction.InventoryAdjusmentBatchModelActionTypes.DELETE_ALL_INVENTORY_ADJUSMENT_BATCH),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.InventoryAdjusmentBatchActionOK(
						modelAction.InventoryAdjusmentBatchModelActionTypes.DELETE_ALL_INVENTORY_ADJUSMENT_BATCH_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryAdjusmentBatchActionFail(
								modelAction.InventoryAdjusmentBatchModelActionTypes.DELETE_ALL_INVENTORY_ADJUSMENT_BATCH_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryAdjusmentBatchAction>(modelAction.InventoryAdjusmentBatchModelActionTypes.EXPORT_INVENTORY_ADJUSMENT_BATCH),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.InventoryAdjusmentBatchActionOK(
						modelAction.InventoryAdjusmentBatchModelActionTypes.EXPORT_INVENTORY_ADJUSMENT_BATCH,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryAdjusmentBatchAction>(modelAction.InventoryAdjusmentBatchModelActionTypes.EXPORT_ALL_INVENTORY_ADJUSMENT_BATCH),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.InventoryAdjusmentBatchActionOK(
						modelAction.InventoryAdjusmentBatchModelActionTypes.EXPORT_ALL_INVENTORY_ADJUSMENT_BATCH_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryAdjusmentBatchActionFail(
								modelAction.InventoryAdjusmentBatchModelActionTypes.EXPORT_ALL_INVENTORY_ADJUSMENT_BATCH_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryAdjusmentBatchAction>(modelAction.InventoryAdjusmentBatchModelActionTypes.EXPORT_INVENTORY_ADJUSMENT_BATCH_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.InventoryAdjusmentBatchActionOK(
						modelAction.InventoryAdjusmentBatchModelActionTypes.EXPORT_INVENTORY_ADJUSMENT_BATCH_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryAdjusmentBatchActionFail(
								modelAction.InventoryAdjusmentBatchModelActionTypes.EXPORT_INVENTORY_ADJUSMENT_BATCH_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryAdjusmentBatchAction>(modelAction.InventoryAdjusmentBatchModelActionTypes.IMPORT_INVENTORY_ADJUSMENT_BATCHS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.InventoryAdjusmentBatchActionOK(
						modelAction.InventoryAdjusmentBatchModelActionTypes.IMPORT_INVENTORY_ADJUSMENT_BATCHS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryAdjusmentBatchActionFail(
								modelAction.InventoryAdjusmentBatchModelActionTypes.IMPORT_INVENTORY_ADJUSMENT_BATCHS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryAdjusmentBatchAction>(modelAction.InventoryAdjusmentBatchModelActionTypes.FETCH_INVENTORY_ADJUSMENT_BATCH_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.InventoryAdjusmentBatchActionOK(
						modelAction.InventoryAdjusmentBatchModelActionTypes.FETCH_INVENTORY_ADJUSMENT_BATCH_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.InventoryAdjusmentBatchActionFail(
								modelAction.InventoryAdjusmentBatchModelActionTypes.FETCH_INVENTORY_ADJUSMENT_BATCH_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryAdjusmentBatchAction>(modelAction.InventoryAdjusmentBatchModelActionTypes.FETCH_INVENTORY_ADJUSMENT_BATCH_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.InventoryAdjusmentBatchActionOK(
						modelAction.InventoryAdjusmentBatchModelActionTypes.FETCH_INVENTORY_ADJUSMENT_BATCH_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.InventoryAdjusmentBatchActionFail(
								modelAction.InventoryAdjusmentBatchModelActionTypes.FETCH_INVENTORY_ADJUSMENT_BATCH_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
