...
/**
 * InventoryAdjusmentBatchCollectionState would store the state of a collection of InventoryAdjusmentBatch
 */
export interface InventoryAdjusmentBatchCollectionState extends CollectionState {
 ...
 */
export interface InventoryAdjusmentBatchModelAudit extends AbstractModelAudit<InventoryAdjusmentBatchModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * InventoryAdjusmentBatchModelState would store the state of the model
 */
export interface InventoryAdjusmentBatchModelState {
	collectionState: {
		[key: string]: InventoryAdjusmentBatchCollectionState;
	};
	data: {
		[id: string]: InventoryAdjusmentBatchModel;
	};
	totalCount: number;
	audits: InventoryAdjusmentBatchModelAudit[];
 ...
 */
export const initialInventoryAdjusmentBatchCollectionState: InventoryAdjusmentBatchCollectionState = {
...
/**
 * The initial state of InventoryAdjusmentBatchModelState
 */
export const initialState: InventoryAdjusmentBatchModelState = {
	collectionState: {
