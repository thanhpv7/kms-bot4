...
/**
 * Effect class used for side effects related to Location model.
 */
@Injectable()
export class LocationEffect {
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.LocationAction>(modelAction.LocationModelActionTypes.COUNT_LOCATIONS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.LocationActionOK(
						modelAction.LocationModelActionTypes.COUNT_LOCATIONS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.LocationActionFail(
								modelAction.LocationModelActionTypes.COUNT_LOCATIONS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.LocationAction>(modelAction.LocationModelActionTypes.FETCH_LOCATION),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.LocationActionOK(
						modelAction.LocationModelActionTypes.FETCH_LOCATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.LocationActionFail(
								modelAction.LocationModelActionTypes.FETCH_LOCATION_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.LocationAction>(modelAction.LocationModelActionTypes.FETCH_ALL_LOCATION),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.LocationActionOK(
						modelAction.LocationModelActionTypes.FETCH_ALL_LOCATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.LocationActionFail(
								modelAction.LocationModelActionTypes.FETCH_ALL_LOCATION_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.LocationAction>(modelAction.LocationModelActionTypes.FETCH_LOCATION_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.LocationActionOK(
						modelAction.LocationModelActionTypes.FETCH_LOCATION_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.LocationActionFail(
								modelAction.LocationModelActionTypes.FETCH_LOCATION_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.LocationAction>(modelAction.LocationModelActionTypes.FETCH_LAST_LOCATION_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.LocationActionOK(
						modelAction.LocationModelActionTypes.FETCH_LAST_LOCATION_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.LocationActionFail(
								modelAction.LocationModelActionTypes.FETCH_LAST_LOCATION_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.LocationAction>(modelAction.LocationModelActionTypes.CREATE_LOCATION),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as LocationModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.LocationActionOK(
						modelAction.LocationModelActionTypes.CREATE_LOCATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.LocationActionFail(
								modelAction.LocationModelActionTypes.CREATE_LOCATION_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.LocationAction>(modelAction.LocationModelActionTypes.CREATE_ALL_LOCATION),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as LocationModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.LocationActionOK(
						modelAction.LocationModelActionTypes.CREATE_ALL_LOCATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.LocationActionFail(
								modelAction.LocationModelActionTypes.CREATE_ALL_LOCATION_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.LocationAction>(modelAction.LocationModelActionTypes.UPDATE_LOCATION),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as LocationModel;
				...
				return this.service.update(new LocationModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.LocationActionOK(
						modelAction.LocationModelActionTypes.UPDATE_LOCATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.LocationActionFail(
								modelAction.LocationModelActionTypes.UPDATE_LOCATION_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.LocationAction>(modelAction.LocationModelActionTypes.UPDATE_ALL_LOCATION),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as LocationModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new LocationModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.LocationActionOK(
						modelAction.LocationModelActionTypes.UPDATE_ALL_LOCATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.LocationActionFail(
								modelAction.LocationModelActionTypes.UPDATE_ALL_LOCATION_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.LocationAction>(modelAction.LocationModelActionTypes.DELETE_LOCATION),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.LocationActionOK(
						modelAction.LocationModelActionTypes.DELETE_LOCATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.LocationActionFail(
								modelAction.LocationModelActionTypes.DELETE_LOCATION_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.LocationAction>(modelAction.LocationModelActionTypes.DELETE_LOCATION_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.LocationActionOK(
						modelAction.LocationModelActionTypes.DELETE_LOCATION_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.LocationActionFail(
								modelAction.LocationModelActionTypes.DELETE_LOCATION_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.LocationAction>(modelAction.LocationModelActionTypes.DELETE_ALL_LOCATION),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.LocationActionOK(
						modelAction.LocationModelActionTypes.DELETE_ALL_LOCATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.LocationActionFail(
								modelAction.LocationModelActionTypes.DELETE_ALL_LOCATION_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.LocationAction>(modelAction.LocationModelActionTypes.EXPORT_LOCATION),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.LocationActionOK(
						modelAction.LocationModelActionTypes.EXPORT_LOCATION,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.LocationAction>(modelAction.LocationModelActionTypes.EXPORT_ALL_LOCATION),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.LocationActionOK(
						modelAction.LocationModelActionTypes.EXPORT_ALL_LOCATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.LocationActionFail(
								modelAction.LocationModelActionTypes.EXPORT_ALL_LOCATION_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.LocationAction>(modelAction.LocationModelActionTypes.EXPORT_LOCATION_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.LocationActionOK(
						modelAction.LocationModelActionTypes.EXPORT_LOCATION_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.LocationActionFail(
								modelAction.LocationModelActionTypes.EXPORT_LOCATION_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.LocationAction>(modelAction.LocationModelActionTypes.IMPORT_LOCATIONS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.LocationActionOK(
						modelAction.LocationModelActionTypes.IMPORT_LOCATIONS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.LocationActionFail(
								modelAction.LocationModelActionTypes.IMPORT_LOCATIONS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.LocationAction>(modelAction.LocationModelActionTypes.FETCH_LOCATION_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.LocationActionOK(
						modelAction.LocationModelActionTypes.FETCH_LOCATION_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.LocationActionFail(
								modelAction.LocationModelActionTypes.FETCH_LOCATION_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.LocationAction>(modelAction.LocationModelActionTypes.FETCH_LOCATION_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.LocationActionOK(
						modelAction.LocationModelActionTypes.FETCH_LOCATION_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.LocationActionFail(
								modelAction.LocationModelActionTypes.FETCH_LOCATION_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
