...
/**
 * LocationCollectionState would store the state of a collection of Location
 */
export interface LocationCollectionState extends CollectionState {
 ...
 */
export interface LocationModelAudit extends AbstractModelAudit<LocationModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * LocationModelState would store the state of the model
 */
export interface LocationModelState {
	collectionState: {
		[key: string]: LocationCollectionState;
	};
	data: {
		[id: string]: LocationModel;
	};
	totalCount: number;
	audits: LocationModelAudit[];
 ...
 */
export const initialLocationCollectionState: LocationCollectionState = {
...
/**
 * The initial state of LocationModelState
 */
export const initialState: LocationModelState = {
	collectionState: {
