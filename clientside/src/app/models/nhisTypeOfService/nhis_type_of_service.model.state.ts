...
/**
 * NhisTypeOfServiceCollectionState would store the state of a collection of NhisTypeOfService
 */
export interface NhisTypeOfServiceCollectionState extends CollectionState {
 ...
 */
export interface NhisTypeOfServiceModelAudit extends AbstractModelAudit<NhisTypeOfServiceModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * NhisTypeOfServiceModelState would store the state of the model
 */
export interface NhisTypeOfServiceModelState {
	collectionState: {
		[key: string]: NhisTypeOfServiceCollectionState;
	};
	data: {
		[id: string]: NhisTypeOfServiceModel;
	};
	totalCount: number;
	audits: NhisTypeOfServiceModelAudit[];
 ...
 */
export const initialNhisTypeOfServiceCollectionState: NhisTypeOfServiceCollectionState = {
...
/**
 * The initial state of NhisTypeOfServiceModelState
 */
export const initialState: NhisTypeOfServiceModelState = {
	collectionState: {
