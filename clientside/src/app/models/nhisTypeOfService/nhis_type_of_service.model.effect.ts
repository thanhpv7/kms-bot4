...
import * as modelAction from './nhis_type_of_service.model.action';
import {NhisTypeOfServiceService} from '../../services/nhisTypeOfService/nhis_type_of_service.service';
...
/**
 * Effect class used for side effects related to NHIS Type Of Service model.
 */
@Injectable()
export class NhisTypeOfServiceEffect {
	...
	constructor(
		...
		protected readonly service: NhisTypeOfServiceService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisTypeOfServiceAction>(modelAction.NhisTypeOfServiceModelActionTypes.COUNT_NHIS_TYPE_OF_SERVICES),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.NhisTypeOfServiceActionOK(
						modelAction.NhisTypeOfServiceModelActionTypes.COUNT_NHIS_TYPE_OF_SERVICES_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisTypeOfServiceActionFail(
								modelAction.NhisTypeOfServiceModelActionTypes.COUNT_NHIS_TYPE_OF_SERVICES_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisTypeOfServiceAction>(modelAction.NhisTypeOfServiceModelActionTypes.FETCH_NHIS_TYPE_OF_SERVICE),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisTypeOfServiceActionOK(
						modelAction.NhisTypeOfServiceModelActionTypes.FETCH_NHIS_TYPE_OF_SERVICE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisTypeOfServiceActionFail(
								modelAction.NhisTypeOfServiceModelActionTypes.FETCH_NHIS_TYPE_OF_SERVICE_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisTypeOfServiceAction>(modelAction.NhisTypeOfServiceModelActionTypes.FETCH_ALL_NHIS_TYPE_OF_SERVICE),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.NhisTypeOfServiceActionOK(
						modelAction.NhisTypeOfServiceModelActionTypes.FETCH_ALL_NHIS_TYPE_OF_SERVICE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisTypeOfServiceActionFail(
								modelAction.NhisTypeOfServiceModelActionTypes.FETCH_ALL_NHIS_TYPE_OF_SERVICE_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisTypeOfServiceAction>(modelAction.NhisTypeOfServiceModelActionTypes.FETCH_NHIS_TYPE_OF_SERVICE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisTypeOfServiceActionOK(
						modelAction.NhisTypeOfServiceModelActionTypes.FETCH_NHIS_TYPE_OF_SERVICE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisTypeOfServiceActionFail(
								modelAction.NhisTypeOfServiceModelActionTypes.FETCH_NHIS_TYPE_OF_SERVICE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisTypeOfServiceAction>(modelAction.NhisTypeOfServiceModelActionTypes.FETCH_LAST_NHIS_TYPE_OF_SERVICE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisTypeOfServiceActionOK(
						modelAction.NhisTypeOfServiceModelActionTypes.FETCH_LAST_NHIS_TYPE_OF_SERVICE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisTypeOfServiceActionFail(
								modelAction.NhisTypeOfServiceModelActionTypes.FETCH_LAST_NHIS_TYPE_OF_SERVICE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisTypeOfServiceAction>(modelAction.NhisTypeOfServiceModelActionTypes.CREATE_NHIS_TYPE_OF_SERVICE),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as NhisTypeOfServiceModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisTypeOfServiceActionOK(
						modelAction.NhisTypeOfServiceModelActionTypes.CREATE_NHIS_TYPE_OF_SERVICE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisTypeOfServiceActionFail(
								modelAction.NhisTypeOfServiceModelActionTypes.CREATE_NHIS_TYPE_OF_SERVICE_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisTypeOfServiceAction>(modelAction.NhisTypeOfServiceModelActionTypes.CREATE_ALL_NHIS_TYPE_OF_SERVICE),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as NhisTypeOfServiceModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisTypeOfServiceActionOK(
						modelAction.NhisTypeOfServiceModelActionTypes.CREATE_ALL_NHIS_TYPE_OF_SERVICE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisTypeOfServiceActionFail(
								modelAction.NhisTypeOfServiceModelActionTypes.CREATE_ALL_NHIS_TYPE_OF_SERVICE_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisTypeOfServiceAction>(modelAction.NhisTypeOfServiceModelActionTypes.UPDATE_NHIS_TYPE_OF_SERVICE),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as NhisTypeOfServiceModel;
				...
				return this.service.update(new NhisTypeOfServiceModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisTypeOfServiceActionOK(
						modelAction.NhisTypeOfServiceModelActionTypes.UPDATE_NHIS_TYPE_OF_SERVICE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisTypeOfServiceActionFail(
								modelAction.NhisTypeOfServiceModelActionTypes.UPDATE_NHIS_TYPE_OF_SERVICE_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisTypeOfServiceAction>(modelAction.NhisTypeOfServiceModelActionTypes.UPDATE_ALL_NHIS_TYPE_OF_SERVICE),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as NhisTypeOfServiceModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new NhisTypeOfServiceModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisTypeOfServiceActionOK(
						modelAction.NhisTypeOfServiceModelActionTypes.UPDATE_ALL_NHIS_TYPE_OF_SERVICE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisTypeOfServiceActionFail(
								modelAction.NhisTypeOfServiceModelActionTypes.UPDATE_ALL_NHIS_TYPE_OF_SERVICE_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisTypeOfServiceAction>(modelAction.NhisTypeOfServiceModelActionTypes.DELETE_NHIS_TYPE_OF_SERVICE),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.NhisTypeOfServiceActionOK(
						modelAction.NhisTypeOfServiceModelActionTypes.DELETE_NHIS_TYPE_OF_SERVICE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisTypeOfServiceActionFail(
								modelAction.NhisTypeOfServiceModelActionTypes.DELETE_NHIS_TYPE_OF_SERVICE_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisTypeOfServiceAction>(modelAction.NhisTypeOfServiceModelActionTypes.DELETE_NHIS_TYPE_OF_SERVICE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.NhisTypeOfServiceActionOK(
						modelAction.NhisTypeOfServiceModelActionTypes.DELETE_NHIS_TYPE_OF_SERVICE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisTypeOfServiceActionFail(
								modelAction.NhisTypeOfServiceModelActionTypes.DELETE_NHIS_TYPE_OF_SERVICE_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisTypeOfServiceAction>(modelAction.NhisTypeOfServiceModelActionTypes.DELETE_ALL_NHIS_TYPE_OF_SERVICE),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.NhisTypeOfServiceActionOK(
						modelAction.NhisTypeOfServiceModelActionTypes.DELETE_ALL_NHIS_TYPE_OF_SERVICE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisTypeOfServiceActionFail(
								modelAction.NhisTypeOfServiceModelActionTypes.DELETE_ALL_NHIS_TYPE_OF_SERVICE_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisTypeOfServiceAction>(modelAction.NhisTypeOfServiceModelActionTypes.EXPORT_NHIS_TYPE_OF_SERVICE),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.NhisTypeOfServiceActionOK(
						modelAction.NhisTypeOfServiceModelActionTypes.EXPORT_NHIS_TYPE_OF_SERVICE,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisTypeOfServiceAction>(modelAction.NhisTypeOfServiceModelActionTypes.EXPORT_ALL_NHIS_TYPE_OF_SERVICE),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.NhisTypeOfServiceActionOK(
						modelAction.NhisTypeOfServiceModelActionTypes.EXPORT_ALL_NHIS_TYPE_OF_SERVICE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisTypeOfServiceActionFail(
								modelAction.NhisTypeOfServiceModelActionTypes.EXPORT_ALL_NHIS_TYPE_OF_SERVICE_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisTypeOfServiceAction>(modelAction.NhisTypeOfServiceModelActionTypes.EXPORT_NHIS_TYPE_OF_SERVICE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.NhisTypeOfServiceActionOK(
						modelAction.NhisTypeOfServiceModelActionTypes.EXPORT_NHIS_TYPE_OF_SERVICE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisTypeOfServiceActionFail(
								modelAction.NhisTypeOfServiceModelActionTypes.EXPORT_NHIS_TYPE_OF_SERVICE_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisTypeOfServiceAction>(modelAction.NhisTypeOfServiceModelActionTypes.IMPORT_NHIS_TYPE_OF_SERVICES),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.NhisTypeOfServiceActionOK(
						modelAction.NhisTypeOfServiceModelActionTypes.IMPORT_NHIS_TYPE_OF_SERVICES_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisTypeOfServiceActionFail(
								modelAction.NhisTypeOfServiceModelActionTypes.IMPORT_NHIS_TYPE_OF_SERVICES_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisTypeOfServiceAction>(modelAction.NhisTypeOfServiceModelActionTypes.FETCH_NHIS_TYPE_OF_SERVICE_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.NhisTypeOfServiceActionOK(
						modelAction.NhisTypeOfServiceModelActionTypes.FETCH_NHIS_TYPE_OF_SERVICE_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.NhisTypeOfServiceActionFail(
								modelAction.NhisTypeOfServiceModelActionTypes.FETCH_NHIS_TYPE_OF_SERVICE_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisTypeOfServiceAction>(modelAction.NhisTypeOfServiceModelActionTypes.FETCH_NHIS_TYPE_OF_SERVICE_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.NhisTypeOfServiceActionOK(
						modelAction.NhisTypeOfServiceModelActionTypes.FETCH_NHIS_TYPE_OF_SERVICE_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.NhisTypeOfServiceActionFail(
								modelAction.NhisTypeOfServiceModelActionTypes.FETCH_NHIS_TYPE_OF_SERVICE_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
