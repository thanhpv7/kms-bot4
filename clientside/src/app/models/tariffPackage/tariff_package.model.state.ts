...
/**
 * TariffPackageCollectionState would store the state of a collection of TariffPackage
 */
export interface TariffPackageCollectionState extends CollectionState {
 ...
 */
export interface TariffPackageModelAudit extends AbstractModelAudit<TariffPackageModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * TariffPackageModelState would store the state of the model
 */
export interface TariffPackageModelState {
	collectionState: {
		[key: string]: TariffPackageCollectionState;
	};
	data: {
		[id: string]: TariffPackageModel;
	};
	totalCount: number;
	audits: TariffPackageModelAudit[];
 ...
 */
export const initialTariffPackageCollectionState: TariffPackageCollectionState = {
...
/**
 * The initial state of TariffPackageModelState
 */
export const initialState: TariffPackageModelState = {
	collectionState: {
