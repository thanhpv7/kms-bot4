...
import * as modelAction from './tariff_package.model.action';
import {TariffPackageService} from '../../services/tariffPackage/tariff_package.service';
...
/**
 * Effect class used for side effects related to Tariff Package model.
 */
@Injectable()
export class TariffPackageEffect {
	...
	constructor(
		...
		protected readonly service: TariffPackageService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageAction>(modelAction.TariffPackageModelActionTypes.COUNT_TARIFF_PACKAGES),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.TariffPackageActionOK(
						modelAction.TariffPackageModelActionTypes.COUNT_TARIFF_PACKAGES_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageActionFail(
								modelAction.TariffPackageModelActionTypes.COUNT_TARIFF_PACKAGES_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageAction>(modelAction.TariffPackageModelActionTypes.FETCH_TARIFF_PACKAGE),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.TariffPackageActionOK(
						modelAction.TariffPackageModelActionTypes.FETCH_TARIFF_PACKAGE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageActionFail(
								modelAction.TariffPackageModelActionTypes.FETCH_TARIFF_PACKAGE_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageAction>(modelAction.TariffPackageModelActionTypes.FETCH_ALL_TARIFF_PACKAGE),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.TariffPackageActionOK(
						modelAction.TariffPackageModelActionTypes.FETCH_ALL_TARIFF_PACKAGE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageActionFail(
								modelAction.TariffPackageModelActionTypes.FETCH_ALL_TARIFF_PACKAGE_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageAction>(modelAction.TariffPackageModelActionTypes.FETCH_TARIFF_PACKAGE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.TariffPackageActionOK(
						modelAction.TariffPackageModelActionTypes.FETCH_TARIFF_PACKAGE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageActionFail(
								modelAction.TariffPackageModelActionTypes.FETCH_TARIFF_PACKAGE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageAction>(modelAction.TariffPackageModelActionTypes.FETCH_LAST_TARIFF_PACKAGE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.TariffPackageActionOK(
						modelAction.TariffPackageModelActionTypes.FETCH_LAST_TARIFF_PACKAGE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageActionFail(
								modelAction.TariffPackageModelActionTypes.FETCH_LAST_TARIFF_PACKAGE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageAction>(modelAction.TariffPackageModelActionTypes.CREATE_TARIFF_PACKAGE),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as TariffPackageModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.TariffPackageActionOK(
						modelAction.TariffPackageModelActionTypes.CREATE_TARIFF_PACKAGE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageActionFail(
								modelAction.TariffPackageModelActionTypes.CREATE_TARIFF_PACKAGE_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageAction>(modelAction.TariffPackageModelActionTypes.CREATE_ALL_TARIFF_PACKAGE),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as TariffPackageModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.TariffPackageActionOK(
						modelAction.TariffPackageModelActionTypes.CREATE_ALL_TARIFF_PACKAGE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageActionFail(
								modelAction.TariffPackageModelActionTypes.CREATE_ALL_TARIFF_PACKAGE_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageAction>(modelAction.TariffPackageModelActionTypes.UPDATE_TARIFF_PACKAGE),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as TariffPackageModel;
				...
				return this.service.update(new TariffPackageModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.TariffPackageActionOK(
						modelAction.TariffPackageModelActionTypes.UPDATE_TARIFF_PACKAGE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageActionFail(
								modelAction.TariffPackageModelActionTypes.UPDATE_TARIFF_PACKAGE_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageAction>(modelAction.TariffPackageModelActionTypes.UPDATE_ALL_TARIFF_PACKAGE),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as TariffPackageModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new TariffPackageModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.TariffPackageActionOK(
						modelAction.TariffPackageModelActionTypes.UPDATE_ALL_TARIFF_PACKAGE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageActionFail(
								modelAction.TariffPackageModelActionTypes.UPDATE_ALL_TARIFF_PACKAGE_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageAction>(modelAction.TariffPackageModelActionTypes.DELETE_TARIFF_PACKAGE),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.TariffPackageActionOK(
						modelAction.TariffPackageModelActionTypes.DELETE_TARIFF_PACKAGE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageActionFail(
								modelAction.TariffPackageModelActionTypes.DELETE_TARIFF_PACKAGE_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageAction>(modelAction.TariffPackageModelActionTypes.DELETE_TARIFF_PACKAGE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.TariffPackageActionOK(
						modelAction.TariffPackageModelActionTypes.DELETE_TARIFF_PACKAGE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageActionFail(
								modelAction.TariffPackageModelActionTypes.DELETE_TARIFF_PACKAGE_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageAction>(modelAction.TariffPackageModelActionTypes.DELETE_ALL_TARIFF_PACKAGE),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.TariffPackageActionOK(
						modelAction.TariffPackageModelActionTypes.DELETE_ALL_TARIFF_PACKAGE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageActionFail(
								modelAction.TariffPackageModelActionTypes.DELETE_ALL_TARIFF_PACKAGE_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageAction>(modelAction.TariffPackageModelActionTypes.EXPORT_TARIFF_PACKAGE),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.TariffPackageActionOK(
						modelAction.TariffPackageModelActionTypes.EXPORT_TARIFF_PACKAGE,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageAction>(modelAction.TariffPackageModelActionTypes.EXPORT_ALL_TARIFF_PACKAGE),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.TariffPackageActionOK(
						modelAction.TariffPackageModelActionTypes.EXPORT_ALL_TARIFF_PACKAGE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageActionFail(
								modelAction.TariffPackageModelActionTypes.EXPORT_ALL_TARIFF_PACKAGE_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageAction>(modelAction.TariffPackageModelActionTypes.EXPORT_TARIFF_PACKAGE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.TariffPackageActionOK(
						modelAction.TariffPackageModelActionTypes.EXPORT_TARIFF_PACKAGE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageActionFail(
								modelAction.TariffPackageModelActionTypes.EXPORT_TARIFF_PACKAGE_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageAction>(modelAction.TariffPackageModelActionTypes.IMPORT_TARIFF_PACKAGES),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.TariffPackageActionOK(
						modelAction.TariffPackageModelActionTypes.IMPORT_TARIFF_PACKAGES_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageActionFail(
								modelAction.TariffPackageModelActionTypes.IMPORT_TARIFF_PACKAGES_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageAction>(modelAction.TariffPackageModelActionTypes.FETCH_TARIFF_PACKAGE_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.TariffPackageActionOK(
						modelAction.TariffPackageModelActionTypes.FETCH_TARIFF_PACKAGE_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageActionFail(
								modelAction.TariffPackageModelActionTypes.FETCH_TARIFF_PACKAGE_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageAction>(modelAction.TariffPackageModelActionTypes.FETCH_TARIFF_PACKAGE_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.TariffPackageActionOK(
						modelAction.TariffPackageModelActionTypes.FETCH_TARIFF_PACKAGE_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageActionFail(
								modelAction.TariffPackageModelActionTypes.FETCH_TARIFF_PACKAGE_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
