...
/**
 * SampleCollectionItemsCollectionState would store the state of a collection of SampleCollectionItems
 */
export interface SampleCollectionItemsCollectionState extends CollectionState {
 ...
 */
export interface SampleCollectionItemsModelAudit extends AbstractModelAudit<SampleCollectionItemsModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * SampleCollectionItemsModelState would store the state of the model
 */
export interface SampleCollectionItemsModelState {
	collectionState: {
		[key: string]: SampleCollectionItemsCollectionState;
	};
	data: {
		[id: string]: SampleCollectionItemsModel;
	};
	totalCount: number;
	audits: SampleCollectionItemsModelAudit[];
 ...
 */
export const initialSampleCollectionItemsCollectionState: SampleCollectionItemsCollectionState = {
...
/**
 * The initial state of SampleCollectionItemsModelState
 */
export const initialState: SampleCollectionItemsModelState = {
	collectionState: {
