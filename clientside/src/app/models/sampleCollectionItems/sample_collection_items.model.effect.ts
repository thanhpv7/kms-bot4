...
import {SampleCollectionItemsService} from '../../services/sampleCollectionItems/sample_collection_items.service';
...
/**
 * Effect class used for side effects related to Sample Collection Items model.
 */
@Injectable()
export class SampleCollectionItemsEffect {
	...
	constructor(
		...
		protected readonly service: SampleCollectionItemsService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SampleCollectionItemsAction>(modelAction.SampleCollectionItemsModelActionTypes.COUNT_SAMPLE_COLLECTION_ITEMSS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.SampleCollectionItemsActionOK(
						modelAction.SampleCollectionItemsModelActionTypes.COUNT_SAMPLE_COLLECTION_ITEMSS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SampleCollectionItemsActionFail(
								modelAction.SampleCollectionItemsModelActionTypes.COUNT_SAMPLE_COLLECTION_ITEMSS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SampleCollectionItemsAction>(modelAction.SampleCollectionItemsModelActionTypes.FETCH_SAMPLE_COLLECTION_ITEMS),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.SampleCollectionItemsActionOK(
						modelAction.SampleCollectionItemsModelActionTypes.FETCH_SAMPLE_COLLECTION_ITEMS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SampleCollectionItemsActionFail(
								modelAction.SampleCollectionItemsModelActionTypes.FETCH_SAMPLE_COLLECTION_ITEMS_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SampleCollectionItemsAction>(modelAction.SampleCollectionItemsModelActionTypes.FETCH_ALL_SAMPLE_COLLECTION_ITEMS),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.SampleCollectionItemsActionOK(
						modelAction.SampleCollectionItemsModelActionTypes.FETCH_ALL_SAMPLE_COLLECTION_ITEMS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SampleCollectionItemsActionFail(
								modelAction.SampleCollectionItemsModelActionTypes.FETCH_ALL_SAMPLE_COLLECTION_ITEMS_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SampleCollectionItemsAction>(modelAction.SampleCollectionItemsModelActionTypes.FETCH_SAMPLE_COLLECTION_ITEMS_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.SampleCollectionItemsActionOK(
						modelAction.SampleCollectionItemsModelActionTypes.FETCH_SAMPLE_COLLECTION_ITEMS_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SampleCollectionItemsActionFail(
								modelAction.SampleCollectionItemsModelActionTypes.FETCH_SAMPLE_COLLECTION_ITEMS_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SampleCollectionItemsAction>(modelAction.SampleCollectionItemsModelActionTypes.FETCH_LAST_SAMPLE_COLLECTION_ITEMS_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.SampleCollectionItemsActionOK(
						modelAction.SampleCollectionItemsModelActionTypes.FETCH_LAST_SAMPLE_COLLECTION_ITEMS_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SampleCollectionItemsActionFail(
								modelAction.SampleCollectionItemsModelActionTypes.FETCH_LAST_SAMPLE_COLLECTION_ITEMS_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SampleCollectionItemsAction>(modelAction.SampleCollectionItemsModelActionTypes.CREATE_SAMPLE_COLLECTION_ITEMS),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as SampleCollectionItemsModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.SampleCollectionItemsActionOK(
						modelAction.SampleCollectionItemsModelActionTypes.CREATE_SAMPLE_COLLECTION_ITEMS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SampleCollectionItemsActionFail(
								modelAction.SampleCollectionItemsModelActionTypes.CREATE_SAMPLE_COLLECTION_ITEMS_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SampleCollectionItemsAction>(modelAction.SampleCollectionItemsModelActionTypes.CREATE_ALL_SAMPLE_COLLECTION_ITEMS),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as SampleCollectionItemsModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.SampleCollectionItemsActionOK(
						modelAction.SampleCollectionItemsModelActionTypes.CREATE_ALL_SAMPLE_COLLECTION_ITEMS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SampleCollectionItemsActionFail(
								modelAction.SampleCollectionItemsModelActionTypes.CREATE_ALL_SAMPLE_COLLECTION_ITEMS_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SampleCollectionItemsAction>(modelAction.SampleCollectionItemsModelActionTypes.UPDATE_SAMPLE_COLLECTION_ITEMS),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as SampleCollectionItemsModel;
				...
				return this.service.update(new SampleCollectionItemsModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.SampleCollectionItemsActionOK(
						modelAction.SampleCollectionItemsModelActionTypes.UPDATE_SAMPLE_COLLECTION_ITEMS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SampleCollectionItemsActionFail(
								modelAction.SampleCollectionItemsModelActionTypes.UPDATE_SAMPLE_COLLECTION_ITEMS_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SampleCollectionItemsAction>(modelAction.SampleCollectionItemsModelActionTypes.UPDATE_ALL_SAMPLE_COLLECTION_ITEMS),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as SampleCollectionItemsModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new SampleCollectionItemsModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.SampleCollectionItemsActionOK(
						modelAction.SampleCollectionItemsModelActionTypes.UPDATE_ALL_SAMPLE_COLLECTION_ITEMS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SampleCollectionItemsActionFail(
								modelAction.SampleCollectionItemsModelActionTypes.UPDATE_ALL_SAMPLE_COLLECTION_ITEMS_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SampleCollectionItemsAction>(modelAction.SampleCollectionItemsModelActionTypes.DELETE_SAMPLE_COLLECTION_ITEMS),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.SampleCollectionItemsActionOK(
						modelAction.SampleCollectionItemsModelActionTypes.DELETE_SAMPLE_COLLECTION_ITEMS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SampleCollectionItemsActionFail(
								modelAction.SampleCollectionItemsModelActionTypes.DELETE_SAMPLE_COLLECTION_ITEMS_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SampleCollectionItemsAction>(modelAction.SampleCollectionItemsModelActionTypes.DELETE_SAMPLE_COLLECTION_ITEMS_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.SampleCollectionItemsActionOK(
						modelAction.SampleCollectionItemsModelActionTypes.DELETE_SAMPLE_COLLECTION_ITEMS_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SampleCollectionItemsActionFail(
								modelAction.SampleCollectionItemsModelActionTypes.DELETE_SAMPLE_COLLECTION_ITEMS_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SampleCollectionItemsAction>(modelAction.SampleCollectionItemsModelActionTypes.DELETE_ALL_SAMPLE_COLLECTION_ITEMS),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.SampleCollectionItemsActionOK(
						modelAction.SampleCollectionItemsModelActionTypes.DELETE_ALL_SAMPLE_COLLECTION_ITEMS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SampleCollectionItemsActionFail(
								modelAction.SampleCollectionItemsModelActionTypes.DELETE_ALL_SAMPLE_COLLECTION_ITEMS_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SampleCollectionItemsAction>(modelAction.SampleCollectionItemsModelActionTypes.EXPORT_SAMPLE_COLLECTION_ITEMS),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.SampleCollectionItemsActionOK(
						modelAction.SampleCollectionItemsModelActionTypes.EXPORT_SAMPLE_COLLECTION_ITEMS,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SampleCollectionItemsAction>(modelAction.SampleCollectionItemsModelActionTypes.EXPORT_ALL_SAMPLE_COLLECTION_ITEMS),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.SampleCollectionItemsActionOK(
						modelAction.SampleCollectionItemsModelActionTypes.EXPORT_ALL_SAMPLE_COLLECTION_ITEMS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SampleCollectionItemsActionFail(
								modelAction.SampleCollectionItemsModelActionTypes.EXPORT_ALL_SAMPLE_COLLECTION_ITEMS_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SampleCollectionItemsAction>(modelAction.SampleCollectionItemsModelActionTypes.EXPORT_SAMPLE_COLLECTION_ITEMS_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.SampleCollectionItemsActionOK(
						modelAction.SampleCollectionItemsModelActionTypes.EXPORT_SAMPLE_COLLECTION_ITEMS_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SampleCollectionItemsActionFail(
								modelAction.SampleCollectionItemsModelActionTypes.EXPORT_SAMPLE_COLLECTION_ITEMS_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SampleCollectionItemsAction>(modelAction.SampleCollectionItemsModelActionTypes.IMPORT_SAMPLE_COLLECTION_ITEMSS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.SampleCollectionItemsActionOK(
						modelAction.SampleCollectionItemsModelActionTypes.IMPORT_SAMPLE_COLLECTION_ITEMSS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SampleCollectionItemsActionFail(
								modelAction.SampleCollectionItemsModelActionTypes.IMPORT_SAMPLE_COLLECTION_ITEMSS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SampleCollectionItemsAction>(modelAction.SampleCollectionItemsModelActionTypes.FETCH_SAMPLE_COLLECTION_ITEMS_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.SampleCollectionItemsActionOK(
						modelAction.SampleCollectionItemsModelActionTypes.FETCH_SAMPLE_COLLECTION_ITEMS_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.SampleCollectionItemsActionFail(
								modelAction.SampleCollectionItemsModelActionTypes.FETCH_SAMPLE_COLLECTION_ITEMS_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SampleCollectionItemsAction>(modelAction.SampleCollectionItemsModelActionTypes.FETCH_SAMPLE_COLLECTION_ITEMS_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.SampleCollectionItemsActionOK(
						modelAction.SampleCollectionItemsModelActionTypes.FETCH_SAMPLE_COLLECTION_ITEMS_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.SampleCollectionItemsActionFail(
								modelAction.SampleCollectionItemsModelActionTypes.FETCH_SAMPLE_COLLECTION_ITEMS_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
