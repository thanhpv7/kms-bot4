...
/**
 * TariffFormulaCollectionState would store the state of a collection of TariffFormula
 */
export interface TariffFormulaCollectionState extends CollectionState {
 ...
 */
export interface TariffFormulaModelAudit extends AbstractModelAudit<TariffFormulaModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * TariffFormulaModelState would store the state of the model
 */
export interface TariffFormulaModelState {
	collectionState: {
		[key: string]: TariffFormulaCollectionState;
	};
	data: {
		[id: string]: TariffFormulaModel;
	};
	totalCount: number;
	audits: TariffFormulaModelAudit[];
 ...
 */
export const initialTariffFormulaCollectionState: TariffFormulaCollectionState = {
...
/**
 * The initial state of TariffFormulaModelState
 */
export const initialState: TariffFormulaModelState = {
	collectionState: {
