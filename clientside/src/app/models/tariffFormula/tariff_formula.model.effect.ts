...
import * as modelAction from './tariff_formula.model.action';
import {TariffFormulaService} from '../../services/tariffFormula/tariff_formula.service';
...
/**
 * Effect class used for side effects related to Tariff Formula model.
 */
@Injectable()
export class TariffFormulaEffect {
	...
	constructor(
		...
		protected readonly service: TariffFormulaService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffFormulaAction>(modelAction.TariffFormulaModelActionTypes.COUNT_TARIFF_FORMULAS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.TariffFormulaActionOK(
						modelAction.TariffFormulaModelActionTypes.COUNT_TARIFF_FORMULAS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffFormulaActionFail(
								modelAction.TariffFormulaModelActionTypes.COUNT_TARIFF_FORMULAS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffFormulaAction>(modelAction.TariffFormulaModelActionTypes.FETCH_TARIFF_FORMULA),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.TariffFormulaActionOK(
						modelAction.TariffFormulaModelActionTypes.FETCH_TARIFF_FORMULA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffFormulaActionFail(
								modelAction.TariffFormulaModelActionTypes.FETCH_TARIFF_FORMULA_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffFormulaAction>(modelAction.TariffFormulaModelActionTypes.FETCH_ALL_TARIFF_FORMULA),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.TariffFormulaActionOK(
						modelAction.TariffFormulaModelActionTypes.FETCH_ALL_TARIFF_FORMULA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffFormulaActionFail(
								modelAction.TariffFormulaModelActionTypes.FETCH_ALL_TARIFF_FORMULA_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffFormulaAction>(modelAction.TariffFormulaModelActionTypes.FETCH_TARIFF_FORMULA_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.TariffFormulaActionOK(
						modelAction.TariffFormulaModelActionTypes.FETCH_TARIFF_FORMULA_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffFormulaActionFail(
								modelAction.TariffFormulaModelActionTypes.FETCH_TARIFF_FORMULA_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffFormulaAction>(modelAction.TariffFormulaModelActionTypes.FETCH_LAST_TARIFF_FORMULA_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.TariffFormulaActionOK(
						modelAction.TariffFormulaModelActionTypes.FETCH_LAST_TARIFF_FORMULA_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffFormulaActionFail(
								modelAction.TariffFormulaModelActionTypes.FETCH_LAST_TARIFF_FORMULA_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffFormulaAction>(modelAction.TariffFormulaModelActionTypes.CREATE_TARIFF_FORMULA),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as TariffFormulaModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.TariffFormulaActionOK(
						modelAction.TariffFormulaModelActionTypes.CREATE_TARIFF_FORMULA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffFormulaActionFail(
								modelAction.TariffFormulaModelActionTypes.CREATE_TARIFF_FORMULA_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffFormulaAction>(modelAction.TariffFormulaModelActionTypes.CREATE_ALL_TARIFF_FORMULA),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as TariffFormulaModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.TariffFormulaActionOK(
						modelAction.TariffFormulaModelActionTypes.CREATE_ALL_TARIFF_FORMULA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffFormulaActionFail(
								modelAction.TariffFormulaModelActionTypes.CREATE_ALL_TARIFF_FORMULA_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffFormulaAction>(modelAction.TariffFormulaModelActionTypes.UPDATE_TARIFF_FORMULA),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as TariffFormulaModel;
				...
				return this.service.update(new TariffFormulaModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.TariffFormulaActionOK(
						modelAction.TariffFormulaModelActionTypes.UPDATE_TARIFF_FORMULA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffFormulaActionFail(
								modelAction.TariffFormulaModelActionTypes.UPDATE_TARIFF_FORMULA_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffFormulaAction>(modelAction.TariffFormulaModelActionTypes.UPDATE_ALL_TARIFF_FORMULA),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as TariffFormulaModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new TariffFormulaModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.TariffFormulaActionOK(
						modelAction.TariffFormulaModelActionTypes.UPDATE_ALL_TARIFF_FORMULA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffFormulaActionFail(
								modelAction.TariffFormulaModelActionTypes.UPDATE_ALL_TARIFF_FORMULA_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffFormulaAction>(modelAction.TariffFormulaModelActionTypes.DELETE_TARIFF_FORMULA),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.TariffFormulaActionOK(
						modelAction.TariffFormulaModelActionTypes.DELETE_TARIFF_FORMULA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffFormulaActionFail(
								modelAction.TariffFormulaModelActionTypes.DELETE_TARIFF_FORMULA_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffFormulaAction>(modelAction.TariffFormulaModelActionTypes.DELETE_TARIFF_FORMULA_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.TariffFormulaActionOK(
						modelAction.TariffFormulaModelActionTypes.DELETE_TARIFF_FORMULA_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffFormulaActionFail(
								modelAction.TariffFormulaModelActionTypes.DELETE_TARIFF_FORMULA_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffFormulaAction>(modelAction.TariffFormulaModelActionTypes.DELETE_ALL_TARIFF_FORMULA),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.TariffFormulaActionOK(
						modelAction.TariffFormulaModelActionTypes.DELETE_ALL_TARIFF_FORMULA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffFormulaActionFail(
								modelAction.TariffFormulaModelActionTypes.DELETE_ALL_TARIFF_FORMULA_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffFormulaAction>(modelAction.TariffFormulaModelActionTypes.EXPORT_TARIFF_FORMULA),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.TariffFormulaActionOK(
						modelAction.TariffFormulaModelActionTypes.EXPORT_TARIFF_FORMULA,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffFormulaAction>(modelAction.TariffFormulaModelActionTypes.EXPORT_ALL_TARIFF_FORMULA),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.TariffFormulaActionOK(
						modelAction.TariffFormulaModelActionTypes.EXPORT_ALL_TARIFF_FORMULA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffFormulaActionFail(
								modelAction.TariffFormulaModelActionTypes.EXPORT_ALL_TARIFF_FORMULA_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffFormulaAction>(modelAction.TariffFormulaModelActionTypes.EXPORT_TARIFF_FORMULA_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.TariffFormulaActionOK(
						modelAction.TariffFormulaModelActionTypes.EXPORT_TARIFF_FORMULA_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffFormulaActionFail(
								modelAction.TariffFormulaModelActionTypes.EXPORT_TARIFF_FORMULA_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffFormulaAction>(modelAction.TariffFormulaModelActionTypes.IMPORT_TARIFF_FORMULAS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.TariffFormulaActionOK(
						modelAction.TariffFormulaModelActionTypes.IMPORT_TARIFF_FORMULAS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffFormulaActionFail(
								modelAction.TariffFormulaModelActionTypes.IMPORT_TARIFF_FORMULAS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffFormulaAction>(modelAction.TariffFormulaModelActionTypes.FETCH_TARIFF_FORMULA_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.TariffFormulaActionOK(
						modelAction.TariffFormulaModelActionTypes.FETCH_TARIFF_FORMULA_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.TariffFormulaActionFail(
								modelAction.TariffFormulaModelActionTypes.FETCH_TARIFF_FORMULA_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffFormulaAction>(modelAction.TariffFormulaModelActionTypes.FETCH_TARIFF_FORMULA_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.TariffFormulaActionOK(
						modelAction.TariffFormulaModelActionTypes.FETCH_TARIFF_FORMULA_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.TariffFormulaActionFail(
								modelAction.TariffFormulaModelActionTypes.FETCH_TARIFF_FORMULA_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
