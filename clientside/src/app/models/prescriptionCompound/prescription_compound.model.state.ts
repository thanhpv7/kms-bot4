...
/**
 * PrescriptionCompoundCollectionState would store the state of a collection of PrescriptionCompound
 */
export interface PrescriptionCompoundCollectionState extends CollectionState {
 ...
 */
export interface PrescriptionCompoundModelAudit extends AbstractModelAudit<PrescriptionCompoundModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * PrescriptionCompoundModelState would store the state of the model
 */
export interface PrescriptionCompoundModelState {
	collectionState: {
		[key: string]: PrescriptionCompoundCollectionState;
	};
	data: {
		[id: string]: PrescriptionCompoundModel;
	};
	totalCount: number;
	audits: PrescriptionCompoundModelAudit[];
 ...
 */
export const initialPrescriptionCompoundCollectionState: PrescriptionCompoundCollectionState = {
...
/**
 * The initial state of PrescriptionCompoundModelState
 */
export const initialState: PrescriptionCompoundModelState = {
	collectionState: {
