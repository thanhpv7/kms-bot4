...
import * as modelAction from './prescription_compound.model.action';
import {PrescriptionCompoundService} from '../../services/prescriptionCompound/prescription_compound.service';
...
/**
 * Effect class used for side effects related to Prescription Compound model.
 */
@Injectable()
export class PrescriptionCompoundEffect {
	...
	constructor(
		...
		protected readonly service: PrescriptionCompoundService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrescriptionCompoundAction>(modelAction.PrescriptionCompoundModelActionTypes.COUNT_PRESCRIPTION_COMPOUNDS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.PrescriptionCompoundActionOK(
						modelAction.PrescriptionCompoundModelActionTypes.COUNT_PRESCRIPTION_COMPOUNDS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PrescriptionCompoundActionFail(
								modelAction.PrescriptionCompoundModelActionTypes.COUNT_PRESCRIPTION_COMPOUNDS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrescriptionCompoundAction>(modelAction.PrescriptionCompoundModelActionTypes.FETCH_PRESCRIPTION_COMPOUND),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PrescriptionCompoundActionOK(
						modelAction.PrescriptionCompoundModelActionTypes.FETCH_PRESCRIPTION_COMPOUND_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PrescriptionCompoundActionFail(
								modelAction.PrescriptionCompoundModelActionTypes.FETCH_PRESCRIPTION_COMPOUND_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrescriptionCompoundAction>(modelAction.PrescriptionCompoundModelActionTypes.FETCH_ALL_PRESCRIPTION_COMPOUND),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.PrescriptionCompoundActionOK(
						modelAction.PrescriptionCompoundModelActionTypes.FETCH_ALL_PRESCRIPTION_COMPOUND_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PrescriptionCompoundActionFail(
								modelAction.PrescriptionCompoundModelActionTypes.FETCH_ALL_PRESCRIPTION_COMPOUND_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrescriptionCompoundAction>(modelAction.PrescriptionCompoundModelActionTypes.FETCH_PRESCRIPTION_COMPOUND_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PrescriptionCompoundActionOK(
						modelAction.PrescriptionCompoundModelActionTypes.FETCH_PRESCRIPTION_COMPOUND_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PrescriptionCompoundActionFail(
								modelAction.PrescriptionCompoundModelActionTypes.FETCH_PRESCRIPTION_COMPOUND_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrescriptionCompoundAction>(modelAction.PrescriptionCompoundModelActionTypes.FETCH_LAST_PRESCRIPTION_COMPOUND_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PrescriptionCompoundActionOK(
						modelAction.PrescriptionCompoundModelActionTypes.FETCH_LAST_PRESCRIPTION_COMPOUND_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PrescriptionCompoundActionFail(
								modelAction.PrescriptionCompoundModelActionTypes.FETCH_LAST_PRESCRIPTION_COMPOUND_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrescriptionCompoundAction>(modelAction.PrescriptionCompoundModelActionTypes.CREATE_PRESCRIPTION_COMPOUND),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as PrescriptionCompoundModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PrescriptionCompoundActionOK(
						modelAction.PrescriptionCompoundModelActionTypes.CREATE_PRESCRIPTION_COMPOUND_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PrescriptionCompoundActionFail(
								modelAction.PrescriptionCompoundModelActionTypes.CREATE_PRESCRIPTION_COMPOUND_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrescriptionCompoundAction>(modelAction.PrescriptionCompoundModelActionTypes.CREATE_ALL_PRESCRIPTION_COMPOUND),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as PrescriptionCompoundModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PrescriptionCompoundActionOK(
						modelAction.PrescriptionCompoundModelActionTypes.CREATE_ALL_PRESCRIPTION_COMPOUND_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PrescriptionCompoundActionFail(
								modelAction.PrescriptionCompoundModelActionTypes.CREATE_ALL_PRESCRIPTION_COMPOUND_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrescriptionCompoundAction>(modelAction.PrescriptionCompoundModelActionTypes.UPDATE_PRESCRIPTION_COMPOUND),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as PrescriptionCompoundModel;
				...
				return this.service.update(new PrescriptionCompoundModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.PrescriptionCompoundActionOK(
						modelAction.PrescriptionCompoundModelActionTypes.UPDATE_PRESCRIPTION_COMPOUND_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PrescriptionCompoundActionFail(
								modelAction.PrescriptionCompoundModelActionTypes.UPDATE_PRESCRIPTION_COMPOUND_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrescriptionCompoundAction>(modelAction.PrescriptionCompoundModelActionTypes.UPDATE_ALL_PRESCRIPTION_COMPOUND),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as PrescriptionCompoundModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new PrescriptionCompoundModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PrescriptionCompoundActionOK(
						modelAction.PrescriptionCompoundModelActionTypes.UPDATE_ALL_PRESCRIPTION_COMPOUND_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PrescriptionCompoundActionFail(
								modelAction.PrescriptionCompoundModelActionTypes.UPDATE_ALL_PRESCRIPTION_COMPOUND_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrescriptionCompoundAction>(modelAction.PrescriptionCompoundModelActionTypes.DELETE_PRESCRIPTION_COMPOUND),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PrescriptionCompoundActionOK(
						modelAction.PrescriptionCompoundModelActionTypes.DELETE_PRESCRIPTION_COMPOUND_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PrescriptionCompoundActionFail(
								modelAction.PrescriptionCompoundModelActionTypes.DELETE_PRESCRIPTION_COMPOUND_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrescriptionCompoundAction>(modelAction.PrescriptionCompoundModelActionTypes.DELETE_PRESCRIPTION_COMPOUND_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.PrescriptionCompoundActionOK(
						modelAction.PrescriptionCompoundModelActionTypes.DELETE_PRESCRIPTION_COMPOUND_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PrescriptionCompoundActionFail(
								modelAction.PrescriptionCompoundModelActionTypes.DELETE_PRESCRIPTION_COMPOUND_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrescriptionCompoundAction>(modelAction.PrescriptionCompoundModelActionTypes.DELETE_ALL_PRESCRIPTION_COMPOUND),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PrescriptionCompoundActionOK(
						modelAction.PrescriptionCompoundModelActionTypes.DELETE_ALL_PRESCRIPTION_COMPOUND_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PrescriptionCompoundActionFail(
								modelAction.PrescriptionCompoundModelActionTypes.DELETE_ALL_PRESCRIPTION_COMPOUND_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrescriptionCompoundAction>(modelAction.PrescriptionCompoundModelActionTypes.EXPORT_PRESCRIPTION_COMPOUND),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PrescriptionCompoundActionOK(
						modelAction.PrescriptionCompoundModelActionTypes.EXPORT_PRESCRIPTION_COMPOUND,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrescriptionCompoundAction>(modelAction.PrescriptionCompoundModelActionTypes.EXPORT_ALL_PRESCRIPTION_COMPOUND),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PrescriptionCompoundActionOK(
						modelAction.PrescriptionCompoundModelActionTypes.EXPORT_ALL_PRESCRIPTION_COMPOUND_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PrescriptionCompoundActionFail(
								modelAction.PrescriptionCompoundModelActionTypes.EXPORT_ALL_PRESCRIPTION_COMPOUND_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrescriptionCompoundAction>(modelAction.PrescriptionCompoundModelActionTypes.EXPORT_PRESCRIPTION_COMPOUND_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PrescriptionCompoundActionOK(
						modelAction.PrescriptionCompoundModelActionTypes.EXPORT_PRESCRIPTION_COMPOUND_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PrescriptionCompoundActionFail(
								modelAction.PrescriptionCompoundModelActionTypes.EXPORT_PRESCRIPTION_COMPOUND_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrescriptionCompoundAction>(modelAction.PrescriptionCompoundModelActionTypes.IMPORT_PRESCRIPTION_COMPOUNDS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.PrescriptionCompoundActionOK(
						modelAction.PrescriptionCompoundModelActionTypes.IMPORT_PRESCRIPTION_COMPOUNDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PrescriptionCompoundActionFail(
								modelAction.PrescriptionCompoundModelActionTypes.IMPORT_PRESCRIPTION_COMPOUNDS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrescriptionCompoundAction>(modelAction.PrescriptionCompoundModelActionTypes.FETCH_PRESCRIPTION_COMPOUND_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.PrescriptionCompoundActionOK(
						modelAction.PrescriptionCompoundModelActionTypes.FETCH_PRESCRIPTION_COMPOUND_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PrescriptionCompoundActionFail(
								modelAction.PrescriptionCompoundModelActionTypes.FETCH_PRESCRIPTION_COMPOUND_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrescriptionCompoundAction>(modelAction.PrescriptionCompoundModelActionTypes.FETCH_PRESCRIPTION_COMPOUND_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.PrescriptionCompoundActionOK(
						modelAction.PrescriptionCompoundModelActionTypes.FETCH_PRESCRIPTION_COMPOUND_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PrescriptionCompoundActionFail(
								modelAction.PrescriptionCompoundModelActionTypes.FETCH_PRESCRIPTION_COMPOUND_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
