...
/**
 * PrescriptionHeaderCollectionState would store the state of a collection of PrescriptionHeader
 */
export interface PrescriptionHeaderCollectionState extends CollectionState {
 ...
 */
export interface PrescriptionHeaderModelAudit extends AbstractModelAudit<PrescriptionHeaderModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * PrescriptionHeaderModelState would store the state of the model
 */
export interface PrescriptionHeaderModelState {
	collectionState: {
		[key: string]: PrescriptionHeaderCollectionState;
	};
	data: {
		[id: string]: PrescriptionHeaderModel;
	};
	totalCount: number;
	audits: PrescriptionHeaderModelAudit[];
 ...
 */
export const initialPrescriptionHeaderCollectionState: PrescriptionHeaderCollectionState = {
...
/**
 * The initial state of PrescriptionHeaderModelState
 */
export const initialState: PrescriptionHeaderModelState = {
	collectionState: {
