...
import * as modelAction from './prescription_header.model.action';
import {PrescriptionHeaderService} from '../../services/prescriptionHeader/prescription_header.service';
...
/**
 * Effect class used for side effects related to Prescription Header model.
 */
@Injectable()
export class PrescriptionHeaderEffect {
	...
	constructor(
		...
		protected readonly service: PrescriptionHeaderService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrescriptionHeaderAction>(modelAction.PrescriptionHeaderModelActionTypes.COUNT_PRESCRIPTION_HEADERS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.PrescriptionHeaderActionOK(
						modelAction.PrescriptionHeaderModelActionTypes.COUNT_PRESCRIPTION_HEADERS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PrescriptionHeaderActionFail(
								modelAction.PrescriptionHeaderModelActionTypes.COUNT_PRESCRIPTION_HEADERS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrescriptionHeaderAction>(modelAction.PrescriptionHeaderModelActionTypes.FETCH_PRESCRIPTION_HEADER),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PrescriptionHeaderActionOK(
						modelAction.PrescriptionHeaderModelActionTypes.FETCH_PRESCRIPTION_HEADER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PrescriptionHeaderActionFail(
								modelAction.PrescriptionHeaderModelActionTypes.FETCH_PRESCRIPTION_HEADER_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrescriptionHeaderAction>(modelAction.PrescriptionHeaderModelActionTypes.FETCH_ALL_PRESCRIPTION_HEADER),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.PrescriptionHeaderActionOK(
						modelAction.PrescriptionHeaderModelActionTypes.FETCH_ALL_PRESCRIPTION_HEADER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PrescriptionHeaderActionFail(
								modelAction.PrescriptionHeaderModelActionTypes.FETCH_ALL_PRESCRIPTION_HEADER_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrescriptionHeaderAction>(modelAction.PrescriptionHeaderModelActionTypes.FETCH_PRESCRIPTION_HEADER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PrescriptionHeaderActionOK(
						modelAction.PrescriptionHeaderModelActionTypes.FETCH_PRESCRIPTION_HEADER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PrescriptionHeaderActionFail(
								modelAction.PrescriptionHeaderModelActionTypes.FETCH_PRESCRIPTION_HEADER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrescriptionHeaderAction>(modelAction.PrescriptionHeaderModelActionTypes.FETCH_LAST_PRESCRIPTION_HEADER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PrescriptionHeaderActionOK(
						modelAction.PrescriptionHeaderModelActionTypes.FETCH_LAST_PRESCRIPTION_HEADER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PrescriptionHeaderActionFail(
								modelAction.PrescriptionHeaderModelActionTypes.FETCH_LAST_PRESCRIPTION_HEADER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrescriptionHeaderAction>(modelAction.PrescriptionHeaderModelActionTypes.CREATE_PRESCRIPTION_HEADER),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as PrescriptionHeaderModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PrescriptionHeaderActionOK(
						modelAction.PrescriptionHeaderModelActionTypes.CREATE_PRESCRIPTION_HEADER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PrescriptionHeaderActionFail(
								modelAction.PrescriptionHeaderModelActionTypes.CREATE_PRESCRIPTION_HEADER_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrescriptionHeaderAction>(modelAction.PrescriptionHeaderModelActionTypes.CREATE_ALL_PRESCRIPTION_HEADER),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as PrescriptionHeaderModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PrescriptionHeaderActionOK(
						modelAction.PrescriptionHeaderModelActionTypes.CREATE_ALL_PRESCRIPTION_HEADER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PrescriptionHeaderActionFail(
								modelAction.PrescriptionHeaderModelActionTypes.CREATE_ALL_PRESCRIPTION_HEADER_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrescriptionHeaderAction>(modelAction.PrescriptionHeaderModelActionTypes.UPDATE_PRESCRIPTION_HEADER),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as PrescriptionHeaderModel;
				...
				return this.service.update(new PrescriptionHeaderModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.PrescriptionHeaderActionOK(
						modelAction.PrescriptionHeaderModelActionTypes.UPDATE_PRESCRIPTION_HEADER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PrescriptionHeaderActionFail(
								modelAction.PrescriptionHeaderModelActionTypes.UPDATE_PRESCRIPTION_HEADER_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrescriptionHeaderAction>(modelAction.PrescriptionHeaderModelActionTypes.UPDATE_ALL_PRESCRIPTION_HEADER),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as PrescriptionHeaderModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new PrescriptionHeaderModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PrescriptionHeaderActionOK(
						modelAction.PrescriptionHeaderModelActionTypes.UPDATE_ALL_PRESCRIPTION_HEADER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PrescriptionHeaderActionFail(
								modelAction.PrescriptionHeaderModelActionTypes.UPDATE_ALL_PRESCRIPTION_HEADER_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrescriptionHeaderAction>(modelAction.PrescriptionHeaderModelActionTypes.DELETE_PRESCRIPTION_HEADER),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PrescriptionHeaderActionOK(
						modelAction.PrescriptionHeaderModelActionTypes.DELETE_PRESCRIPTION_HEADER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PrescriptionHeaderActionFail(
								modelAction.PrescriptionHeaderModelActionTypes.DELETE_PRESCRIPTION_HEADER_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrescriptionHeaderAction>(modelAction.PrescriptionHeaderModelActionTypes.DELETE_PRESCRIPTION_HEADER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.PrescriptionHeaderActionOK(
						modelAction.PrescriptionHeaderModelActionTypes.DELETE_PRESCRIPTION_HEADER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PrescriptionHeaderActionFail(
								modelAction.PrescriptionHeaderModelActionTypes.DELETE_PRESCRIPTION_HEADER_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrescriptionHeaderAction>(modelAction.PrescriptionHeaderModelActionTypes.DELETE_ALL_PRESCRIPTION_HEADER),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PrescriptionHeaderActionOK(
						modelAction.PrescriptionHeaderModelActionTypes.DELETE_ALL_PRESCRIPTION_HEADER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PrescriptionHeaderActionFail(
								modelAction.PrescriptionHeaderModelActionTypes.DELETE_ALL_PRESCRIPTION_HEADER_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrescriptionHeaderAction>(modelAction.PrescriptionHeaderModelActionTypes.EXPORT_PRESCRIPTION_HEADER),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PrescriptionHeaderActionOK(
						modelAction.PrescriptionHeaderModelActionTypes.EXPORT_PRESCRIPTION_HEADER,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrescriptionHeaderAction>(modelAction.PrescriptionHeaderModelActionTypes.EXPORT_ALL_PRESCRIPTION_HEADER),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PrescriptionHeaderActionOK(
						modelAction.PrescriptionHeaderModelActionTypes.EXPORT_ALL_PRESCRIPTION_HEADER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PrescriptionHeaderActionFail(
								modelAction.PrescriptionHeaderModelActionTypes.EXPORT_ALL_PRESCRIPTION_HEADER_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrescriptionHeaderAction>(modelAction.PrescriptionHeaderModelActionTypes.EXPORT_PRESCRIPTION_HEADER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PrescriptionHeaderActionOK(
						modelAction.PrescriptionHeaderModelActionTypes.EXPORT_PRESCRIPTION_HEADER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PrescriptionHeaderActionFail(
								modelAction.PrescriptionHeaderModelActionTypes.EXPORT_PRESCRIPTION_HEADER_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrescriptionHeaderAction>(modelAction.PrescriptionHeaderModelActionTypes.IMPORT_PRESCRIPTION_HEADERS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.PrescriptionHeaderActionOK(
						modelAction.PrescriptionHeaderModelActionTypes.IMPORT_PRESCRIPTION_HEADERS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PrescriptionHeaderActionFail(
								modelAction.PrescriptionHeaderModelActionTypes.IMPORT_PRESCRIPTION_HEADERS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrescriptionHeaderAction>(modelAction.PrescriptionHeaderModelActionTypes.FETCH_PRESCRIPTION_HEADER_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.PrescriptionHeaderActionOK(
						modelAction.PrescriptionHeaderModelActionTypes.FETCH_PRESCRIPTION_HEADER_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PrescriptionHeaderActionFail(
								modelAction.PrescriptionHeaderModelActionTypes.FETCH_PRESCRIPTION_HEADER_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrescriptionHeaderAction>(modelAction.PrescriptionHeaderModelActionTypes.FETCH_PRESCRIPTION_HEADER_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.PrescriptionHeaderActionOK(
						modelAction.PrescriptionHeaderModelActionTypes.FETCH_PRESCRIPTION_HEADER_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PrescriptionHeaderActionFail(
								modelAction.PrescriptionHeaderModelActionTypes.FETCH_PRESCRIPTION_HEADER_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
