...
/**
 * PrescriptionItemCollectionState would store the state of a collection of PrescriptionItem
 */
export interface PrescriptionItemCollectionState extends CollectionState {
 ...
 */
export interface PrescriptionItemModelAudit extends AbstractModelAudit<PrescriptionItemModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * PrescriptionItemModelState would store the state of the model
 */
export interface PrescriptionItemModelState {
	collectionState: {
		[key: string]: PrescriptionItemCollectionState;
	};
	data: {
		[id: string]: PrescriptionItemModel;
	};
	totalCount: number;
	audits: PrescriptionItemModelAudit[];
 ...
 */
export const initialPrescriptionItemCollectionState: PrescriptionItemCollectionState = {
...
/**
 * The initial state of PrescriptionItemModelState
 */
export const initialState: PrescriptionItemModelState = {
	collectionState: {
