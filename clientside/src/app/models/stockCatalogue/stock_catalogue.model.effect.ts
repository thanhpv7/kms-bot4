...
import * as modelAction from './stock_catalogue.model.action';
import {StockCatalogueService} from '../../services/stockCatalogue/stock_catalogue.service';
...
/**
 * Effect class used for side effects related to Stock Catalogue model.
 */
@Injectable()
export class StockCatalogueEffect {
	...
	constructor(
		...
		protected readonly service: StockCatalogueService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockCatalogueAction>(modelAction.StockCatalogueModelActionTypes.COUNT_STOCK_CATALOGUES),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.StockCatalogueActionOK(
						modelAction.StockCatalogueModelActionTypes.COUNT_STOCK_CATALOGUES_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockCatalogueActionFail(
								modelAction.StockCatalogueModelActionTypes.COUNT_STOCK_CATALOGUES_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockCatalogueAction>(modelAction.StockCatalogueModelActionTypes.FETCH_STOCK_CATALOGUE),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.StockCatalogueActionOK(
						modelAction.StockCatalogueModelActionTypes.FETCH_STOCK_CATALOGUE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockCatalogueActionFail(
								modelAction.StockCatalogueModelActionTypes.FETCH_STOCK_CATALOGUE_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockCatalogueAction>(modelAction.StockCatalogueModelActionTypes.FETCH_ALL_STOCK_CATALOGUE),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.StockCatalogueActionOK(
						modelAction.StockCatalogueModelActionTypes.FETCH_ALL_STOCK_CATALOGUE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockCatalogueActionFail(
								modelAction.StockCatalogueModelActionTypes.FETCH_ALL_STOCK_CATALOGUE_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockCatalogueAction>(modelAction.StockCatalogueModelActionTypes.FETCH_STOCK_CATALOGUE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.StockCatalogueActionOK(
						modelAction.StockCatalogueModelActionTypes.FETCH_STOCK_CATALOGUE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockCatalogueActionFail(
								modelAction.StockCatalogueModelActionTypes.FETCH_STOCK_CATALOGUE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockCatalogueAction>(modelAction.StockCatalogueModelActionTypes.FETCH_LAST_STOCK_CATALOGUE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.StockCatalogueActionOK(
						modelAction.StockCatalogueModelActionTypes.FETCH_LAST_STOCK_CATALOGUE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockCatalogueActionFail(
								modelAction.StockCatalogueModelActionTypes.FETCH_LAST_STOCK_CATALOGUE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockCatalogueAction>(modelAction.StockCatalogueModelActionTypes.CREATE_STOCK_CATALOGUE),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as StockCatalogueModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.StockCatalogueActionOK(
						modelAction.StockCatalogueModelActionTypes.CREATE_STOCK_CATALOGUE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockCatalogueActionFail(
								modelAction.StockCatalogueModelActionTypes.CREATE_STOCK_CATALOGUE_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockCatalogueAction>(modelAction.StockCatalogueModelActionTypes.CREATE_ALL_STOCK_CATALOGUE),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as StockCatalogueModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.StockCatalogueActionOK(
						modelAction.StockCatalogueModelActionTypes.CREATE_ALL_STOCK_CATALOGUE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockCatalogueActionFail(
								modelAction.StockCatalogueModelActionTypes.CREATE_ALL_STOCK_CATALOGUE_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockCatalogueAction>(modelAction.StockCatalogueModelActionTypes.UPDATE_STOCK_CATALOGUE),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as StockCatalogueModel;
				...
				return this.service.update(new StockCatalogueModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.StockCatalogueActionOK(
						modelAction.StockCatalogueModelActionTypes.UPDATE_STOCK_CATALOGUE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockCatalogueActionFail(
								modelAction.StockCatalogueModelActionTypes.UPDATE_STOCK_CATALOGUE_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockCatalogueAction>(modelAction.StockCatalogueModelActionTypes.UPDATE_ALL_STOCK_CATALOGUE),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as StockCatalogueModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new StockCatalogueModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.StockCatalogueActionOK(
						modelAction.StockCatalogueModelActionTypes.UPDATE_ALL_STOCK_CATALOGUE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockCatalogueActionFail(
								modelAction.StockCatalogueModelActionTypes.UPDATE_ALL_STOCK_CATALOGUE_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockCatalogueAction>(modelAction.StockCatalogueModelActionTypes.DELETE_STOCK_CATALOGUE),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.StockCatalogueActionOK(
						modelAction.StockCatalogueModelActionTypes.DELETE_STOCK_CATALOGUE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockCatalogueActionFail(
								modelAction.StockCatalogueModelActionTypes.DELETE_STOCK_CATALOGUE_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockCatalogueAction>(modelAction.StockCatalogueModelActionTypes.DELETE_STOCK_CATALOGUE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.StockCatalogueActionOK(
						modelAction.StockCatalogueModelActionTypes.DELETE_STOCK_CATALOGUE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockCatalogueActionFail(
								modelAction.StockCatalogueModelActionTypes.DELETE_STOCK_CATALOGUE_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockCatalogueAction>(modelAction.StockCatalogueModelActionTypes.DELETE_ALL_STOCK_CATALOGUE),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.StockCatalogueActionOK(
						modelAction.StockCatalogueModelActionTypes.DELETE_ALL_STOCK_CATALOGUE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockCatalogueActionFail(
								modelAction.StockCatalogueModelActionTypes.DELETE_ALL_STOCK_CATALOGUE_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockCatalogueAction>(modelAction.StockCatalogueModelActionTypes.EXPORT_STOCK_CATALOGUE),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.StockCatalogueActionOK(
						modelAction.StockCatalogueModelActionTypes.EXPORT_STOCK_CATALOGUE,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockCatalogueAction>(modelAction.StockCatalogueModelActionTypes.EXPORT_ALL_STOCK_CATALOGUE),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.StockCatalogueActionOK(
						modelAction.StockCatalogueModelActionTypes.EXPORT_ALL_STOCK_CATALOGUE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockCatalogueActionFail(
								modelAction.StockCatalogueModelActionTypes.EXPORT_ALL_STOCK_CATALOGUE_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockCatalogueAction>(modelAction.StockCatalogueModelActionTypes.EXPORT_STOCK_CATALOGUE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.StockCatalogueActionOK(
						modelAction.StockCatalogueModelActionTypes.EXPORT_STOCK_CATALOGUE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockCatalogueActionFail(
								modelAction.StockCatalogueModelActionTypes.EXPORT_STOCK_CATALOGUE_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockCatalogueAction>(modelAction.StockCatalogueModelActionTypes.IMPORT_STOCK_CATALOGUES),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.StockCatalogueActionOK(
						modelAction.StockCatalogueModelActionTypes.IMPORT_STOCK_CATALOGUES_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockCatalogueActionFail(
								modelAction.StockCatalogueModelActionTypes.IMPORT_STOCK_CATALOGUES_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockCatalogueAction>(modelAction.StockCatalogueModelActionTypes.FETCH_STOCK_CATALOGUE_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.StockCatalogueActionOK(
						modelAction.StockCatalogueModelActionTypes.FETCH_STOCK_CATALOGUE_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.StockCatalogueActionFail(
								modelAction.StockCatalogueModelActionTypes.FETCH_STOCK_CATALOGUE_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockCatalogueAction>(modelAction.StockCatalogueModelActionTypes.FETCH_STOCK_CATALOGUE_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.StockCatalogueActionOK(
						modelAction.StockCatalogueModelActionTypes.FETCH_STOCK_CATALOGUE_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.StockCatalogueActionFail(
								modelAction.StockCatalogueModelActionTypes.FETCH_STOCK_CATALOGUE_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
