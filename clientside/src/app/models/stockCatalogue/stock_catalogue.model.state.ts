...
/**
 * StockCatalogueCollectionState would store the state of a collection of StockCatalogue
 */
export interface StockCatalogueCollectionState extends CollectionState {
 ...
 */
export interface StockCatalogueModelAudit extends AbstractModelAudit<StockCatalogueModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * StockCatalogueModelState would store the state of the model
 */
export interface StockCatalogueModelState {
	collectionState: {
		[key: string]: StockCatalogueCollectionState;
	};
	data: {
		[id: string]: StockCatalogueModel;
	};
	totalCount: number;
	audits: StockCatalogueModelAudit[];
 ...
 */
export const initialStockCatalogueCollectionState: StockCatalogueCollectionState = {
...
/**
 * The initial state of StockCatalogueModelState
 */
export const initialState: StockCatalogueModelState = {
	collectionState: {
