...
import * as modelAction from './bpjs_inacbg_variable.model.action';
import {BpjsINACBGVariableService} from '../../services/bpjsINACBGVariable/bpjs_inacbg_variable.service';
...
/**
 * Effect class used for side effects related to BPJS INACBG Variable model.
 */
@Injectable()
export class BpjsINACBGVariableEffect {
	...
	constructor(
		...
		protected readonly service: BpjsINACBGVariableService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGVariableAction>(modelAction.BpjsINACBGVariableModelActionTypes.COUNT_BPJS_INACBG_VARIABLES),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsINACBGVariableActionOK(
						modelAction.BpjsINACBGVariableModelActionTypes.COUNT_BPJS_INACBG_VARIABLES_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGVariableActionFail(
								modelAction.BpjsINACBGVariableModelActionTypes.COUNT_BPJS_INACBG_VARIABLES_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGVariableAction>(modelAction.BpjsINACBGVariableModelActionTypes.FETCH_BPJS_INACBG_VARIABLE),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsINACBGVariableActionOK(
						modelAction.BpjsINACBGVariableModelActionTypes.FETCH_BPJS_INACBG_VARIABLE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGVariableActionFail(
								modelAction.BpjsINACBGVariableModelActionTypes.FETCH_BPJS_INACBG_VARIABLE_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGVariableAction>(modelAction.BpjsINACBGVariableModelActionTypes.FETCH_ALL_BPJS_INACBG_VARIABLE),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsINACBGVariableActionOK(
						modelAction.BpjsINACBGVariableModelActionTypes.FETCH_ALL_BPJS_INACBG_VARIABLE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGVariableActionFail(
								modelAction.BpjsINACBGVariableModelActionTypes.FETCH_ALL_BPJS_INACBG_VARIABLE_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGVariableAction>(modelAction.BpjsINACBGVariableModelActionTypes.FETCH_BPJS_INACBG_VARIABLE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsINACBGVariableActionOK(
						modelAction.BpjsINACBGVariableModelActionTypes.FETCH_BPJS_INACBG_VARIABLE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGVariableActionFail(
								modelAction.BpjsINACBGVariableModelActionTypes.FETCH_BPJS_INACBG_VARIABLE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGVariableAction>(modelAction.BpjsINACBGVariableModelActionTypes.FETCH_LAST_BPJS_INACBG_VARIABLE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsINACBGVariableActionOK(
						modelAction.BpjsINACBGVariableModelActionTypes.FETCH_LAST_BPJS_INACBG_VARIABLE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGVariableActionFail(
								modelAction.BpjsINACBGVariableModelActionTypes.FETCH_LAST_BPJS_INACBG_VARIABLE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGVariableAction>(modelAction.BpjsINACBGVariableModelActionTypes.CREATE_BPJS_INACBG_VARIABLE),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsINACBGVariableModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsINACBGVariableActionOK(
						modelAction.BpjsINACBGVariableModelActionTypes.CREATE_BPJS_INACBG_VARIABLE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGVariableActionFail(
								modelAction.BpjsINACBGVariableModelActionTypes.CREATE_BPJS_INACBG_VARIABLE_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGVariableAction>(modelAction.BpjsINACBGVariableModelActionTypes.CREATE_ALL_BPJS_INACBG_VARIABLE),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsINACBGVariableModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsINACBGVariableActionOK(
						modelAction.BpjsINACBGVariableModelActionTypes.CREATE_ALL_BPJS_INACBG_VARIABLE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGVariableActionFail(
								modelAction.BpjsINACBGVariableModelActionTypes.CREATE_ALL_BPJS_INACBG_VARIABLE_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGVariableAction>(modelAction.BpjsINACBGVariableModelActionTypes.UPDATE_BPJS_INACBG_VARIABLE),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsINACBGVariableModel;
				...
				return this.service.update(new BpjsINACBGVariableModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsINACBGVariableActionOK(
						modelAction.BpjsINACBGVariableModelActionTypes.UPDATE_BPJS_INACBG_VARIABLE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGVariableActionFail(
								modelAction.BpjsINACBGVariableModelActionTypes.UPDATE_BPJS_INACBG_VARIABLE_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGVariableAction>(modelAction.BpjsINACBGVariableModelActionTypes.UPDATE_ALL_BPJS_INACBG_VARIABLE),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsINACBGVariableModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsINACBGVariableModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsINACBGVariableActionOK(
						modelAction.BpjsINACBGVariableModelActionTypes.UPDATE_ALL_BPJS_INACBG_VARIABLE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGVariableActionFail(
								modelAction.BpjsINACBGVariableModelActionTypes.UPDATE_ALL_BPJS_INACBG_VARIABLE_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGVariableAction>(modelAction.BpjsINACBGVariableModelActionTypes.DELETE_BPJS_INACBG_VARIABLE),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsINACBGVariableActionOK(
						modelAction.BpjsINACBGVariableModelActionTypes.DELETE_BPJS_INACBG_VARIABLE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGVariableActionFail(
								modelAction.BpjsINACBGVariableModelActionTypes.DELETE_BPJS_INACBG_VARIABLE_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGVariableAction>(modelAction.BpjsINACBGVariableModelActionTypes.DELETE_BPJS_INACBG_VARIABLE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsINACBGVariableActionOK(
						modelAction.BpjsINACBGVariableModelActionTypes.DELETE_BPJS_INACBG_VARIABLE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGVariableActionFail(
								modelAction.BpjsINACBGVariableModelActionTypes.DELETE_BPJS_INACBG_VARIABLE_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGVariableAction>(modelAction.BpjsINACBGVariableModelActionTypes.DELETE_ALL_BPJS_INACBG_VARIABLE),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsINACBGVariableActionOK(
						modelAction.BpjsINACBGVariableModelActionTypes.DELETE_ALL_BPJS_INACBG_VARIABLE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGVariableActionFail(
								modelAction.BpjsINACBGVariableModelActionTypes.DELETE_ALL_BPJS_INACBG_VARIABLE_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGVariableAction>(modelAction.BpjsINACBGVariableModelActionTypes.EXPORT_BPJS_INACBG_VARIABLE),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsINACBGVariableActionOK(
						modelAction.BpjsINACBGVariableModelActionTypes.EXPORT_BPJS_INACBG_VARIABLE,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGVariableAction>(modelAction.BpjsINACBGVariableModelActionTypes.EXPORT_ALL_BPJS_INACBG_VARIABLE),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsINACBGVariableActionOK(
						modelAction.BpjsINACBGVariableModelActionTypes.EXPORT_ALL_BPJS_INACBG_VARIABLE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGVariableActionFail(
								modelAction.BpjsINACBGVariableModelActionTypes.EXPORT_ALL_BPJS_INACBG_VARIABLE_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGVariableAction>(modelAction.BpjsINACBGVariableModelActionTypes.EXPORT_BPJS_INACBG_VARIABLE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsINACBGVariableActionOK(
						modelAction.BpjsINACBGVariableModelActionTypes.EXPORT_BPJS_INACBG_VARIABLE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGVariableActionFail(
								modelAction.BpjsINACBGVariableModelActionTypes.EXPORT_BPJS_INACBG_VARIABLE_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGVariableAction>(modelAction.BpjsINACBGVariableModelActionTypes.IMPORT_BPJS_INACBG_VARIABLES),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsINACBGVariableActionOK(
						modelAction.BpjsINACBGVariableModelActionTypes.IMPORT_BPJS_INACBG_VARIABLES_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGVariableActionFail(
								modelAction.BpjsINACBGVariableModelActionTypes.IMPORT_BPJS_INACBG_VARIABLES_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGVariableAction>(modelAction.BpjsINACBGVariableModelActionTypes.FETCH_BPJS_INACBG_VARIABLE_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsINACBGVariableActionOK(
						modelAction.BpjsINACBGVariableModelActionTypes.FETCH_BPJS_INACBG_VARIABLE_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGVariableActionFail(
								modelAction.BpjsINACBGVariableModelActionTypes.FETCH_BPJS_INACBG_VARIABLE_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGVariableAction>(modelAction.BpjsINACBGVariableModelActionTypes.FETCH_BPJS_INACBG_VARIABLE_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsINACBGVariableActionOK(
						modelAction.BpjsINACBGVariableModelActionTypes.FETCH_BPJS_INACBG_VARIABLE_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGVariableActionFail(
								modelAction.BpjsINACBGVariableModelActionTypes.FETCH_BPJS_INACBG_VARIABLE_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
