...
/**
 * BpjsINACBGVariableCollectionState would store the state of a collection of BpjsINACBGVariable
 */
export interface BpjsINACBGVariableCollectionState extends CollectionState {
 ...
 */
export interface BpjsINACBGVariableModelAudit extends AbstractModelAudit<BpjsINACBGVariableModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsINACBGVariableModelState would store the state of the model
 */
export interface BpjsINACBGVariableModelState {
	collectionState: {
		[key: string]: BpjsINACBGVariableCollectionState;
	};
	data: {
		[id: string]: BpjsINACBGVariableModel;
	};
	totalCount: number;
	audits: BpjsINACBGVariableModelAudit[];
 ...
 */
export const initialBpjsINACBGVariableCollectionState: BpjsINACBGVariableCollectionState = {
...
/**
 * The initial state of BpjsINACBGVariableModelState
 */
export const initialState: BpjsINACBGVariableModelState = {
	collectionState: {
