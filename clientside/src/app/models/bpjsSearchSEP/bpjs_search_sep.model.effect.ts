...
import {BpjsSearchSEPService} from '../../services/bpjsSearchSEP/bpjs_search_sep.service';
...
/**
 * Effect class used for side effects related to BPJS Search SEP model.
 */
@Injectable()
export class BpjsSearchSEPEffect {
	...
	constructor(
		...
		protected readonly service: BpjsSearchSEPService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSearchSEPAction>(modelAction.BpjsSearchSEPModelActionTypes.COUNT_BPJS_SEARCH_SEPS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsSearchSEPActionOK(
						modelAction.BpjsSearchSEPModelActionTypes.COUNT_BPJS_SEARCH_SEPS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSearchSEPActionFail(
								modelAction.BpjsSearchSEPModelActionTypes.COUNT_BPJS_SEARCH_SEPS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSearchSEPAction>(modelAction.BpjsSearchSEPModelActionTypes.FETCH_BPJS_SEARCH_SEP),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsSearchSEPActionOK(
						modelAction.BpjsSearchSEPModelActionTypes.FETCH_BPJS_SEARCH_SEP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSearchSEPActionFail(
								modelAction.BpjsSearchSEPModelActionTypes.FETCH_BPJS_SEARCH_SEP_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSearchSEPAction>(modelAction.BpjsSearchSEPModelActionTypes.FETCH_ALL_BPJS_SEARCH_SEP),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsSearchSEPActionOK(
						modelAction.BpjsSearchSEPModelActionTypes.FETCH_ALL_BPJS_SEARCH_SEP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSearchSEPActionFail(
								modelAction.BpjsSearchSEPModelActionTypes.FETCH_ALL_BPJS_SEARCH_SEP_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSearchSEPAction>(modelAction.BpjsSearchSEPModelActionTypes.FETCH_BPJS_SEARCH_SEP_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsSearchSEPActionOK(
						modelAction.BpjsSearchSEPModelActionTypes.FETCH_BPJS_SEARCH_SEP_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSearchSEPActionFail(
								modelAction.BpjsSearchSEPModelActionTypes.FETCH_BPJS_SEARCH_SEP_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSearchSEPAction>(modelAction.BpjsSearchSEPModelActionTypes.FETCH_LAST_BPJS_SEARCH_SEP_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsSearchSEPActionOK(
						modelAction.BpjsSearchSEPModelActionTypes.FETCH_LAST_BPJS_SEARCH_SEP_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSearchSEPActionFail(
								modelAction.BpjsSearchSEPModelActionTypes.FETCH_LAST_BPJS_SEARCH_SEP_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSearchSEPAction>(modelAction.BpjsSearchSEPModelActionTypes.CREATE_BPJS_SEARCH_SEP),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsSearchSEPModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsSearchSEPActionOK(
						modelAction.BpjsSearchSEPModelActionTypes.CREATE_BPJS_SEARCH_SEP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSearchSEPActionFail(
								modelAction.BpjsSearchSEPModelActionTypes.CREATE_BPJS_SEARCH_SEP_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSearchSEPAction>(modelAction.BpjsSearchSEPModelActionTypes.CREATE_ALL_BPJS_SEARCH_SEP),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsSearchSEPModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsSearchSEPActionOK(
						modelAction.BpjsSearchSEPModelActionTypes.CREATE_ALL_BPJS_SEARCH_SEP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSearchSEPActionFail(
								modelAction.BpjsSearchSEPModelActionTypes.CREATE_ALL_BPJS_SEARCH_SEP_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSearchSEPAction>(modelAction.BpjsSearchSEPModelActionTypes.UPDATE_BPJS_SEARCH_SEP),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsSearchSEPModel;
				...
				return this.service.update(new BpjsSearchSEPModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsSearchSEPActionOK(
						modelAction.BpjsSearchSEPModelActionTypes.UPDATE_BPJS_SEARCH_SEP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSearchSEPActionFail(
								modelAction.BpjsSearchSEPModelActionTypes.UPDATE_BPJS_SEARCH_SEP_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSearchSEPAction>(modelAction.BpjsSearchSEPModelActionTypes.UPDATE_ALL_BPJS_SEARCH_SEP),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsSearchSEPModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsSearchSEPModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsSearchSEPActionOK(
						modelAction.BpjsSearchSEPModelActionTypes.UPDATE_ALL_BPJS_SEARCH_SEP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSearchSEPActionFail(
								modelAction.BpjsSearchSEPModelActionTypes.UPDATE_ALL_BPJS_SEARCH_SEP_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSearchSEPAction>(modelAction.BpjsSearchSEPModelActionTypes.DELETE_BPJS_SEARCH_SEP),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsSearchSEPActionOK(
						modelAction.BpjsSearchSEPModelActionTypes.DELETE_BPJS_SEARCH_SEP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSearchSEPActionFail(
								modelAction.BpjsSearchSEPModelActionTypes.DELETE_BPJS_SEARCH_SEP_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSearchSEPAction>(modelAction.BpjsSearchSEPModelActionTypes.DELETE_BPJS_SEARCH_SEP_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsSearchSEPActionOK(
						modelAction.BpjsSearchSEPModelActionTypes.DELETE_BPJS_SEARCH_SEP_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSearchSEPActionFail(
								modelAction.BpjsSearchSEPModelActionTypes.DELETE_BPJS_SEARCH_SEP_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSearchSEPAction>(modelAction.BpjsSearchSEPModelActionTypes.DELETE_ALL_BPJS_SEARCH_SEP),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsSearchSEPActionOK(
						modelAction.BpjsSearchSEPModelActionTypes.DELETE_ALL_BPJS_SEARCH_SEP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSearchSEPActionFail(
								modelAction.BpjsSearchSEPModelActionTypes.DELETE_ALL_BPJS_SEARCH_SEP_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSearchSEPAction>(modelAction.BpjsSearchSEPModelActionTypes.EXPORT_BPJS_SEARCH_SEP),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsSearchSEPActionOK(
						modelAction.BpjsSearchSEPModelActionTypes.EXPORT_BPJS_SEARCH_SEP,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSearchSEPAction>(modelAction.BpjsSearchSEPModelActionTypes.EXPORT_ALL_BPJS_SEARCH_SEP),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsSearchSEPActionOK(
						modelAction.BpjsSearchSEPModelActionTypes.EXPORT_ALL_BPJS_SEARCH_SEP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSearchSEPActionFail(
								modelAction.BpjsSearchSEPModelActionTypes.EXPORT_ALL_BPJS_SEARCH_SEP_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSearchSEPAction>(modelAction.BpjsSearchSEPModelActionTypes.EXPORT_BPJS_SEARCH_SEP_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsSearchSEPActionOK(
						modelAction.BpjsSearchSEPModelActionTypes.EXPORT_BPJS_SEARCH_SEP_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSearchSEPActionFail(
								modelAction.BpjsSearchSEPModelActionTypes.EXPORT_BPJS_SEARCH_SEP_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSearchSEPAction>(modelAction.BpjsSearchSEPModelActionTypes.IMPORT_BPJS_SEARCH_SEPS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsSearchSEPActionOK(
						modelAction.BpjsSearchSEPModelActionTypes.IMPORT_BPJS_SEARCH_SEPS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSearchSEPActionFail(
								modelAction.BpjsSearchSEPModelActionTypes.IMPORT_BPJS_SEARCH_SEPS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSearchSEPAction>(modelAction.BpjsSearchSEPModelActionTypes.FETCH_BPJS_SEARCH_SEP_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsSearchSEPActionOK(
						modelAction.BpjsSearchSEPModelActionTypes.FETCH_BPJS_SEARCH_SEP_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSearchSEPActionFail(
								modelAction.BpjsSearchSEPModelActionTypes.FETCH_BPJS_SEARCH_SEP_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSearchSEPAction>(modelAction.BpjsSearchSEPModelActionTypes.FETCH_BPJS_SEARCH_SEP_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsSearchSEPActionOK(
						modelAction.BpjsSearchSEPModelActionTypes.FETCH_BPJS_SEARCH_SEP_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSearchSEPActionFail(
								modelAction.BpjsSearchSEPModelActionTypes.FETCH_BPJS_SEARCH_SEP_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
