...
/**
 * BpjsSearchSEPCollectionState would store the state of a collection of BpjsSearchSEP
 */
export interface BpjsSearchSEPCollectionState extends CollectionState {
 ...
 */
export interface BpjsSearchSEPModelAudit extends AbstractModelAudit<BpjsSearchSEPModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsSearchSEPModelState would store the state of the model
 */
export interface BpjsSearchSEPModelState {
	collectionState: {
		[key: string]: BpjsSearchSEPCollectionState;
	};
	data: {
		[id: string]: BpjsSearchSEPModel;
	};
	totalCount: number;
	audits: BpjsSearchSEPModelAudit[];
 ...
 */
export const initialBpjsSearchSEPCollectionState: BpjsSearchSEPCollectionState = {
...
/**
 * The initial state of BpjsSearchSEPModelState
 */
export const initialState: BpjsSearchSEPModelState = {
	collectionState: {
