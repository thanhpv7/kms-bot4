...
/**
 * InventoryAdjustmentItemCollectionState would store the state of a collection of InventoryAdjustmentItem
 */
export interface InventoryAdjustmentItemCollectionState extends CollectionState {
 ...
 */
export interface InventoryAdjustmentItemModelAudit extends AbstractModelAudit<InventoryAdjustmentItemModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * InventoryAdjustmentItemModelState would store the state of the model
 */
export interface InventoryAdjustmentItemModelState {
	collectionState: {
		[key: string]: InventoryAdjustmentItemCollectionState;
	};
	data: {
		[id: string]: InventoryAdjustmentItemModel;
	};
	totalCount: number;
	audits: InventoryAdjustmentItemModelAudit[];
 ...
 */
export const initialInventoryAdjustmentItemCollectionState: InventoryAdjustmentItemCollectionState = {
...
/**
 * The initial state of InventoryAdjustmentItemModelState
 */
export const initialState: InventoryAdjustmentItemModelState = {
	collectionState: {
