...
/**
 * PatientEmploymentDetailCollectionState would store the state of a collection of PatientEmploymentDetail
 */
export interface PatientEmploymentDetailCollectionState extends CollectionState {
 ...
 */
export interface PatientEmploymentDetailModelAudit extends AbstractModelAudit<PatientEmploymentDetailModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * PatientEmploymentDetailModelState would store the state of the model
 */
export interface PatientEmploymentDetailModelState {
	collectionState: {
		[key: string]: PatientEmploymentDetailCollectionState;
	};
	data: {
		[id: string]: PatientEmploymentDetailModel;
	};
	totalCount: number;
	audits: PatientEmploymentDetailModelAudit[];
 ...
 */
export const initialPatientEmploymentDetailCollectionState: PatientEmploymentDetailCollectionState = {
...
/**
 * The initial state of PatientEmploymentDetailModelState
 */
export const initialState: PatientEmploymentDetailModelState = {
	collectionState: {
