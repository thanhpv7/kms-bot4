...
import * as modelAction from './patient_employment_detail.model.action';
import {PatientEmploymentDetailService} from '../../services/patientEmploymentDetail/patient_employment_detail.service';
...
/**
 * Effect class used for side effects related to Patient Employment Detail  model.
 */
@Injectable()
export class PatientEmploymentDetailEffect {
	...
	constructor(
		...
		protected readonly service: PatientEmploymentDetailService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientEmploymentDetailAction>(modelAction.PatientEmploymentDetailModelActionTypes.COUNT_PATIENT_EMPLOYMENT_DETAILS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.PatientEmploymentDetailActionOK(
						modelAction.PatientEmploymentDetailModelActionTypes.COUNT_PATIENT_EMPLOYMENT_DETAILS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientEmploymentDetailActionFail(
								modelAction.PatientEmploymentDetailModelActionTypes.COUNT_PATIENT_EMPLOYMENT_DETAILS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientEmploymentDetailAction>(modelAction.PatientEmploymentDetailModelActionTypes.FETCH_PATIENT_EMPLOYMENT_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientEmploymentDetailActionOK(
						modelAction.PatientEmploymentDetailModelActionTypes.FETCH_PATIENT_EMPLOYMENT_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientEmploymentDetailActionFail(
								modelAction.PatientEmploymentDetailModelActionTypes.FETCH_PATIENT_EMPLOYMENT_DETAIL_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientEmploymentDetailAction>(modelAction.PatientEmploymentDetailModelActionTypes.FETCH_ALL_PATIENT_EMPLOYMENT_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.PatientEmploymentDetailActionOK(
						modelAction.PatientEmploymentDetailModelActionTypes.FETCH_ALL_PATIENT_EMPLOYMENT_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientEmploymentDetailActionFail(
								modelAction.PatientEmploymentDetailModelActionTypes.FETCH_ALL_PATIENT_EMPLOYMENT_DETAIL_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientEmploymentDetailAction>(modelAction.PatientEmploymentDetailModelActionTypes.FETCH_PATIENT_EMPLOYMENT_DETAIL_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientEmploymentDetailActionOK(
						modelAction.PatientEmploymentDetailModelActionTypes.FETCH_PATIENT_EMPLOYMENT_DETAIL_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientEmploymentDetailActionFail(
								modelAction.PatientEmploymentDetailModelActionTypes.FETCH_PATIENT_EMPLOYMENT_DETAIL_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientEmploymentDetailAction>(modelAction.PatientEmploymentDetailModelActionTypes.FETCH_LAST_PATIENT_EMPLOYMENT_DETAIL_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientEmploymentDetailActionOK(
						modelAction.PatientEmploymentDetailModelActionTypes.FETCH_LAST_PATIENT_EMPLOYMENT_DETAIL_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientEmploymentDetailActionFail(
								modelAction.PatientEmploymentDetailModelActionTypes.FETCH_LAST_PATIENT_EMPLOYMENT_DETAIL_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientEmploymentDetailAction>(modelAction.PatientEmploymentDetailModelActionTypes.CREATE_PATIENT_EMPLOYMENT_DETAIL),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as PatientEmploymentDetailModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientEmploymentDetailActionOK(
						modelAction.PatientEmploymentDetailModelActionTypes.CREATE_PATIENT_EMPLOYMENT_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientEmploymentDetailActionFail(
								modelAction.PatientEmploymentDetailModelActionTypes.CREATE_PATIENT_EMPLOYMENT_DETAIL_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientEmploymentDetailAction>(modelAction.PatientEmploymentDetailModelActionTypes.CREATE_ALL_PATIENT_EMPLOYMENT_DETAIL),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as PatientEmploymentDetailModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientEmploymentDetailActionOK(
						modelAction.PatientEmploymentDetailModelActionTypes.CREATE_ALL_PATIENT_EMPLOYMENT_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientEmploymentDetailActionFail(
								modelAction.PatientEmploymentDetailModelActionTypes.CREATE_ALL_PATIENT_EMPLOYMENT_DETAIL_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientEmploymentDetailAction>(modelAction.PatientEmploymentDetailModelActionTypes.UPDATE_PATIENT_EMPLOYMENT_DETAIL),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as PatientEmploymentDetailModel;
				...
				return this.service.update(new PatientEmploymentDetailModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientEmploymentDetailActionOK(
						modelAction.PatientEmploymentDetailModelActionTypes.UPDATE_PATIENT_EMPLOYMENT_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientEmploymentDetailActionFail(
								modelAction.PatientEmploymentDetailModelActionTypes.UPDATE_PATIENT_EMPLOYMENT_DETAIL_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientEmploymentDetailAction>(modelAction.PatientEmploymentDetailModelActionTypes.UPDATE_ALL_PATIENT_EMPLOYMENT_DETAIL),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as PatientEmploymentDetailModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new PatientEmploymentDetailModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientEmploymentDetailActionOK(
						modelAction.PatientEmploymentDetailModelActionTypes.UPDATE_ALL_PATIENT_EMPLOYMENT_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientEmploymentDetailActionFail(
								modelAction.PatientEmploymentDetailModelActionTypes.UPDATE_ALL_PATIENT_EMPLOYMENT_DETAIL_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientEmploymentDetailAction>(modelAction.PatientEmploymentDetailModelActionTypes.DELETE_PATIENT_EMPLOYMENT_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PatientEmploymentDetailActionOK(
						modelAction.PatientEmploymentDetailModelActionTypes.DELETE_PATIENT_EMPLOYMENT_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientEmploymentDetailActionFail(
								modelAction.PatientEmploymentDetailModelActionTypes.DELETE_PATIENT_EMPLOYMENT_DETAIL_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientEmploymentDetailAction>(modelAction.PatientEmploymentDetailModelActionTypes.DELETE_PATIENT_EMPLOYMENT_DETAIL_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.PatientEmploymentDetailActionOK(
						modelAction.PatientEmploymentDetailModelActionTypes.DELETE_PATIENT_EMPLOYMENT_DETAIL_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientEmploymentDetailActionFail(
								modelAction.PatientEmploymentDetailModelActionTypes.DELETE_PATIENT_EMPLOYMENT_DETAIL_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientEmploymentDetailAction>(modelAction.PatientEmploymentDetailModelActionTypes.DELETE_ALL_PATIENT_EMPLOYMENT_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PatientEmploymentDetailActionOK(
						modelAction.PatientEmploymentDetailModelActionTypes.DELETE_ALL_PATIENT_EMPLOYMENT_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientEmploymentDetailActionFail(
								modelAction.PatientEmploymentDetailModelActionTypes.DELETE_ALL_PATIENT_EMPLOYMENT_DETAIL_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientEmploymentDetailAction>(modelAction.PatientEmploymentDetailModelActionTypes.EXPORT_PATIENT_EMPLOYMENT_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PatientEmploymentDetailActionOK(
						modelAction.PatientEmploymentDetailModelActionTypes.EXPORT_PATIENT_EMPLOYMENT_DETAIL,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientEmploymentDetailAction>(modelAction.PatientEmploymentDetailModelActionTypes.EXPORT_ALL_PATIENT_EMPLOYMENT_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PatientEmploymentDetailActionOK(
						modelAction.PatientEmploymentDetailModelActionTypes.EXPORT_ALL_PATIENT_EMPLOYMENT_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientEmploymentDetailActionFail(
								modelAction.PatientEmploymentDetailModelActionTypes.EXPORT_ALL_PATIENT_EMPLOYMENT_DETAIL_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientEmploymentDetailAction>(modelAction.PatientEmploymentDetailModelActionTypes.EXPORT_PATIENT_EMPLOYMENT_DETAIL_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PatientEmploymentDetailActionOK(
						modelAction.PatientEmploymentDetailModelActionTypes.EXPORT_PATIENT_EMPLOYMENT_DETAIL_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientEmploymentDetailActionFail(
								modelAction.PatientEmploymentDetailModelActionTypes.EXPORT_PATIENT_EMPLOYMENT_DETAIL_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientEmploymentDetailAction>(modelAction.PatientEmploymentDetailModelActionTypes.IMPORT_PATIENT_EMPLOYMENT_DETAILS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.PatientEmploymentDetailActionOK(
						modelAction.PatientEmploymentDetailModelActionTypes.IMPORT_PATIENT_EMPLOYMENT_DETAILS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientEmploymentDetailActionFail(
								modelAction.PatientEmploymentDetailModelActionTypes.IMPORT_PATIENT_EMPLOYMENT_DETAILS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientEmploymentDetailAction>(modelAction.PatientEmploymentDetailModelActionTypes.FETCH_PATIENT_EMPLOYMENT_DETAIL_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.PatientEmploymentDetailActionOK(
						modelAction.PatientEmploymentDetailModelActionTypes.FETCH_PATIENT_EMPLOYMENT_DETAIL_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PatientEmploymentDetailActionFail(
								modelAction.PatientEmploymentDetailModelActionTypes.FETCH_PATIENT_EMPLOYMENT_DETAIL_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientEmploymentDetailAction>(modelAction.PatientEmploymentDetailModelActionTypes.FETCH_PATIENT_EMPLOYMENT_DETAIL_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.PatientEmploymentDetailActionOK(
						modelAction.PatientEmploymentDetailModelActionTypes.FETCH_PATIENT_EMPLOYMENT_DETAIL_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PatientEmploymentDetailActionFail(
								modelAction.PatientEmploymentDetailModelActionTypes.FETCH_PATIENT_EMPLOYMENT_DETAIL_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
