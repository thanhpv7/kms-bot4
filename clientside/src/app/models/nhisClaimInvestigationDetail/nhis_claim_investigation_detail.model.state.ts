...
/**
 * NhisClaimInvestigationDetailCollectionState would store the state of a collection of NhisClaimInvestigationDetail
 */
export interface NhisClaimInvestigationDetailCollectionState extends CollectionState {
 ...
 */
export interface NhisClaimInvestigationDetailModelAudit extends AbstractModelAudit<NhisClaimInvestigationDetailModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * NhisClaimInvestigationDetailModelState would store the state of the model
 */
export interface NhisClaimInvestigationDetailModelState {
	collectionState: {
		[key: string]: NhisClaimInvestigationDetailCollectionState;
	};
	data: {
		[id: string]: NhisClaimInvestigationDetailModel;
	};
	totalCount: number;
	audits: NhisClaimInvestigationDetailModelAudit[];
 ...
 */
export const initialNhisClaimInvestigationDetailCollectionState: NhisClaimInvestigationDetailCollectionState = {
...
/**
 * The initial state of NhisClaimInvestigationDetailModelState
 */
export const initialState: NhisClaimInvestigationDetailModelState = {
	collectionState: {
