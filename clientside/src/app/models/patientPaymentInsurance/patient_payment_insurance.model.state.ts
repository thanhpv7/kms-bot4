...
/**
 * PatientPaymentInsuranceCollectionState would store the state of a collection of PatientPaymentInsurance
 */
export interface PatientPaymentInsuranceCollectionState extends CollectionState {
 ...
 */
export interface PatientPaymentInsuranceModelAudit extends AbstractModelAudit<PatientPaymentInsuranceModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * PatientPaymentInsuranceModelState would store the state of the model
 */
export interface PatientPaymentInsuranceModelState {
	collectionState: {
		[key: string]: PatientPaymentInsuranceCollectionState;
	};
	data: {
		[id: string]: PatientPaymentInsuranceModel;
	};
	totalCount: number;
	audits: PatientPaymentInsuranceModelAudit[];
 ...
 */
export const initialPatientPaymentInsuranceCollectionState: PatientPaymentInsuranceCollectionState = {
...
/**
 * The initial state of PatientPaymentInsuranceModelState
 */
export const initialState: PatientPaymentInsuranceModelState = {
	collectionState: {
