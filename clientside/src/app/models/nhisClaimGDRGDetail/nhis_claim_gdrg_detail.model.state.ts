...
/**
 * NhisClaimGDRGDetailCollectionState would store the state of a collection of NhisClaimGDRGDetail
 */
export interface NhisClaimGDRGDetailCollectionState extends CollectionState {
 ...
 */
export interface NhisClaimGDRGDetailModelAudit extends AbstractModelAudit<NhisClaimGDRGDetailModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * NhisClaimGDRGDetailModelState would store the state of the model
 */
export interface NhisClaimGDRGDetailModelState {
	collectionState: {
		[key: string]: NhisClaimGDRGDetailCollectionState;
	};
	data: {
		[id: string]: NhisClaimGDRGDetailModel;
	};
	totalCount: number;
	audits: NhisClaimGDRGDetailModelAudit[];
 ...
 */
export const initialNhisClaimGDRGDetailCollectionState: NhisClaimGDRGDetailCollectionState = {
...
/**
 * The initial state of NhisClaimGDRGDetailModelState
 */
export const initialState: NhisClaimGDRGDetailModelState = {
	collectionState: {
