...
import * as modelAction from './nhis_claim_gdrg_detail.model.action';
import {NhisClaimGDRGDetailService} from '../../services/nhisClaimGDRGDetail/nhis_claim_gdrg_detail.service';
...
/**
 * Effect class used for side effects related to NHIS Claim GDRG Detail model.
 */
@Injectable()
export class NhisClaimGDRGDetailEffect {
	...
	constructor(
		...
		protected readonly service: NhisClaimGDRGDetailService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisClaimGDRGDetailAction>(modelAction.NhisClaimGDRGDetailModelActionTypes.COUNT_NHIS_CLAIM_GDRG_DETAILS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.NhisClaimGDRGDetailActionOK(
						modelAction.NhisClaimGDRGDetailModelActionTypes.COUNT_NHIS_CLAIM_GDRG_DETAILS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisClaimGDRGDetailActionFail(
								modelAction.NhisClaimGDRGDetailModelActionTypes.COUNT_NHIS_CLAIM_GDRG_DETAILS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisClaimGDRGDetailAction>(modelAction.NhisClaimGDRGDetailModelActionTypes.FETCH_NHIS_CLAIM_GDRG_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisClaimGDRGDetailActionOK(
						modelAction.NhisClaimGDRGDetailModelActionTypes.FETCH_NHIS_CLAIM_GDRG_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisClaimGDRGDetailActionFail(
								modelAction.NhisClaimGDRGDetailModelActionTypes.FETCH_NHIS_CLAIM_GDRG_DETAIL_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisClaimGDRGDetailAction>(modelAction.NhisClaimGDRGDetailModelActionTypes.FETCH_ALL_NHIS_CLAIM_GDRG_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.NhisClaimGDRGDetailActionOK(
						modelAction.NhisClaimGDRGDetailModelActionTypes.FETCH_ALL_NHIS_CLAIM_GDRG_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisClaimGDRGDetailActionFail(
								modelAction.NhisClaimGDRGDetailModelActionTypes.FETCH_ALL_NHIS_CLAIM_GDRG_DETAIL_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisClaimGDRGDetailAction>(modelAction.NhisClaimGDRGDetailModelActionTypes.FETCH_NHIS_CLAIM_GDRG_DETAIL_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisClaimGDRGDetailActionOK(
						modelAction.NhisClaimGDRGDetailModelActionTypes.FETCH_NHIS_CLAIM_GDRG_DETAIL_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisClaimGDRGDetailActionFail(
								modelAction.NhisClaimGDRGDetailModelActionTypes.FETCH_NHIS_CLAIM_GDRG_DETAIL_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisClaimGDRGDetailAction>(modelAction.NhisClaimGDRGDetailModelActionTypes.FETCH_LAST_NHIS_CLAIM_GDRG_DETAIL_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisClaimGDRGDetailActionOK(
						modelAction.NhisClaimGDRGDetailModelActionTypes.FETCH_LAST_NHIS_CLAIM_GDRG_DETAIL_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisClaimGDRGDetailActionFail(
								modelAction.NhisClaimGDRGDetailModelActionTypes.FETCH_LAST_NHIS_CLAIM_GDRG_DETAIL_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisClaimGDRGDetailAction>(modelAction.NhisClaimGDRGDetailModelActionTypes.CREATE_NHIS_CLAIM_GDRG_DETAIL),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as NhisClaimGDRGDetailModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisClaimGDRGDetailActionOK(
						modelAction.NhisClaimGDRGDetailModelActionTypes.CREATE_NHIS_CLAIM_GDRG_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisClaimGDRGDetailActionFail(
								modelAction.NhisClaimGDRGDetailModelActionTypes.CREATE_NHIS_CLAIM_GDRG_DETAIL_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisClaimGDRGDetailAction>(modelAction.NhisClaimGDRGDetailModelActionTypes.CREATE_ALL_NHIS_CLAIM_GDRG_DETAIL),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as NhisClaimGDRGDetailModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisClaimGDRGDetailActionOK(
						modelAction.NhisClaimGDRGDetailModelActionTypes.CREATE_ALL_NHIS_CLAIM_GDRG_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisClaimGDRGDetailActionFail(
								modelAction.NhisClaimGDRGDetailModelActionTypes.CREATE_ALL_NHIS_CLAIM_GDRG_DETAIL_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisClaimGDRGDetailAction>(modelAction.NhisClaimGDRGDetailModelActionTypes.UPDATE_NHIS_CLAIM_GDRG_DETAIL),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as NhisClaimGDRGDetailModel;
				...
				return this.service.update(new NhisClaimGDRGDetailModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisClaimGDRGDetailActionOK(
						modelAction.NhisClaimGDRGDetailModelActionTypes.UPDATE_NHIS_CLAIM_GDRG_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisClaimGDRGDetailActionFail(
								modelAction.NhisClaimGDRGDetailModelActionTypes.UPDATE_NHIS_CLAIM_GDRG_DETAIL_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisClaimGDRGDetailAction>(modelAction.NhisClaimGDRGDetailModelActionTypes.UPDATE_ALL_NHIS_CLAIM_GDRG_DETAIL),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as NhisClaimGDRGDetailModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new NhisClaimGDRGDetailModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisClaimGDRGDetailActionOK(
						modelAction.NhisClaimGDRGDetailModelActionTypes.UPDATE_ALL_NHIS_CLAIM_GDRG_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisClaimGDRGDetailActionFail(
								modelAction.NhisClaimGDRGDetailModelActionTypes.UPDATE_ALL_NHIS_CLAIM_GDRG_DETAIL_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisClaimGDRGDetailAction>(modelAction.NhisClaimGDRGDetailModelActionTypes.DELETE_NHIS_CLAIM_GDRG_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.NhisClaimGDRGDetailActionOK(
						modelAction.NhisClaimGDRGDetailModelActionTypes.DELETE_NHIS_CLAIM_GDRG_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisClaimGDRGDetailActionFail(
								modelAction.NhisClaimGDRGDetailModelActionTypes.DELETE_NHIS_CLAIM_GDRG_DETAIL_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisClaimGDRGDetailAction>(modelAction.NhisClaimGDRGDetailModelActionTypes.DELETE_NHIS_CLAIM_GDRG_DETAIL_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.NhisClaimGDRGDetailActionOK(
						modelAction.NhisClaimGDRGDetailModelActionTypes.DELETE_NHIS_CLAIM_GDRG_DETAIL_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisClaimGDRGDetailActionFail(
								modelAction.NhisClaimGDRGDetailModelActionTypes.DELETE_NHIS_CLAIM_GDRG_DETAIL_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisClaimGDRGDetailAction>(modelAction.NhisClaimGDRGDetailModelActionTypes.DELETE_ALL_NHIS_CLAIM_GDRG_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.NhisClaimGDRGDetailActionOK(
						modelAction.NhisClaimGDRGDetailModelActionTypes.DELETE_ALL_NHIS_CLAIM_GDRG_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisClaimGDRGDetailActionFail(
								modelAction.NhisClaimGDRGDetailModelActionTypes.DELETE_ALL_NHIS_CLAIM_GDRG_DETAIL_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisClaimGDRGDetailAction>(modelAction.NhisClaimGDRGDetailModelActionTypes.EXPORT_NHIS_CLAIM_GDRG_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.NhisClaimGDRGDetailActionOK(
						modelAction.NhisClaimGDRGDetailModelActionTypes.EXPORT_NHIS_CLAIM_GDRG_DETAIL,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisClaimGDRGDetailAction>(modelAction.NhisClaimGDRGDetailModelActionTypes.EXPORT_ALL_NHIS_CLAIM_GDRG_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.NhisClaimGDRGDetailActionOK(
						modelAction.NhisClaimGDRGDetailModelActionTypes.EXPORT_ALL_NHIS_CLAIM_GDRG_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisClaimGDRGDetailActionFail(
								modelAction.NhisClaimGDRGDetailModelActionTypes.EXPORT_ALL_NHIS_CLAIM_GDRG_DETAIL_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisClaimGDRGDetailAction>(modelAction.NhisClaimGDRGDetailModelActionTypes.EXPORT_NHIS_CLAIM_GDRG_DETAIL_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.NhisClaimGDRGDetailActionOK(
						modelAction.NhisClaimGDRGDetailModelActionTypes.EXPORT_NHIS_CLAIM_GDRG_DETAIL_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisClaimGDRGDetailActionFail(
								modelAction.NhisClaimGDRGDetailModelActionTypes.EXPORT_NHIS_CLAIM_GDRG_DETAIL_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisClaimGDRGDetailAction>(modelAction.NhisClaimGDRGDetailModelActionTypes.IMPORT_NHIS_CLAIM_GDRG_DETAILS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.NhisClaimGDRGDetailActionOK(
						modelAction.NhisClaimGDRGDetailModelActionTypes.IMPORT_NHIS_CLAIM_GDRG_DETAILS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisClaimGDRGDetailActionFail(
								modelAction.NhisClaimGDRGDetailModelActionTypes.IMPORT_NHIS_CLAIM_GDRG_DETAILS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisClaimGDRGDetailAction>(modelAction.NhisClaimGDRGDetailModelActionTypes.FETCH_NHIS_CLAIM_GDRG_DETAIL_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.NhisClaimGDRGDetailActionOK(
						modelAction.NhisClaimGDRGDetailModelActionTypes.FETCH_NHIS_CLAIM_GDRG_DETAIL_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.NhisClaimGDRGDetailActionFail(
								modelAction.NhisClaimGDRGDetailModelActionTypes.FETCH_NHIS_CLAIM_GDRG_DETAIL_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisClaimGDRGDetailAction>(modelAction.NhisClaimGDRGDetailModelActionTypes.FETCH_NHIS_CLAIM_GDRG_DETAIL_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.NhisClaimGDRGDetailActionOK(
						modelAction.NhisClaimGDRGDetailModelActionTypes.FETCH_NHIS_CLAIM_GDRG_DETAIL_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.NhisClaimGDRGDetailActionFail(
								modelAction.NhisClaimGDRGDetailModelActionTypes.FETCH_NHIS_CLAIM_GDRG_DETAIL_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
