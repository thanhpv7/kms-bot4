...
/**
 * BpjsPcareRegistrationsCollectionState would store the state of a collection of BpjsPcareRegistrations
 */
export interface BpjsPcareRegistrationsCollectionState extends CollectionState {
 ...
 */
export interface BpjsPcareRegistrationsModelAudit extends AbstractModelAudit<BpjsPcareRegistrationsModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsPcareRegistrationsModelState would store the state of the model
 */
export interface BpjsPcareRegistrationsModelState {
	collectionState: {
		[key: string]: BpjsPcareRegistrationsCollectionState;
	};
	data: {
		[id: string]: BpjsPcareRegistrationsModel;
	};
	totalCount: number;
	audits: BpjsPcareRegistrationsModelAudit[];
 ...
 */
export const initialBpjsPcareRegistrationsCollectionState: BpjsPcareRegistrationsCollectionState = {
...
/**
 * The initial state of BpjsPcareRegistrationsModelState
 */
export const initialState: BpjsPcareRegistrationsModelState = {
	collectionState: {
