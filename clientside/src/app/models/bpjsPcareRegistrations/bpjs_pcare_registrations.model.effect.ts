...
import * as modelAction from './bpjs_pcare_registrations.model.action';
import {BpjsPcareRegistrationsService} from '../../services/bpjsPcareRegistrations/bpjs_pcare_registrations.service';
...
/**
 * Effect class used for side effects related to BPJS Pcare Registrations model.
 */
@Injectable()
export class BpjsPcareRegistrationsEffect {
	...
	constructor(
		...
		protected readonly service: BpjsPcareRegistrationsService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareRegistrationsAction>(modelAction.BpjsPcareRegistrationsModelActionTypes.COUNT_BPJS_PCARE_REGISTRATIONSS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareRegistrationsActionOK(
						modelAction.BpjsPcareRegistrationsModelActionTypes.COUNT_BPJS_PCARE_REGISTRATIONSS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareRegistrationsActionFail(
								modelAction.BpjsPcareRegistrationsModelActionTypes.COUNT_BPJS_PCARE_REGISTRATIONSS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareRegistrationsAction>(modelAction.BpjsPcareRegistrationsModelActionTypes.FETCH_BPJS_PCARE_REGISTRATIONS),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareRegistrationsActionOK(
						modelAction.BpjsPcareRegistrationsModelActionTypes.FETCH_BPJS_PCARE_REGISTRATIONS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareRegistrationsActionFail(
								modelAction.BpjsPcareRegistrationsModelActionTypes.FETCH_BPJS_PCARE_REGISTRATIONS_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareRegistrationsAction>(modelAction.BpjsPcareRegistrationsModelActionTypes.FETCH_ALL_BPJS_PCARE_REGISTRATIONS),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareRegistrationsActionOK(
						modelAction.BpjsPcareRegistrationsModelActionTypes.FETCH_ALL_BPJS_PCARE_REGISTRATIONS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareRegistrationsActionFail(
								modelAction.BpjsPcareRegistrationsModelActionTypes.FETCH_ALL_BPJS_PCARE_REGISTRATIONS_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareRegistrationsAction>(modelAction.BpjsPcareRegistrationsModelActionTypes.FETCH_BPJS_PCARE_REGISTRATIONS_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareRegistrationsActionOK(
						modelAction.BpjsPcareRegistrationsModelActionTypes.FETCH_BPJS_PCARE_REGISTRATIONS_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareRegistrationsActionFail(
								modelAction.BpjsPcareRegistrationsModelActionTypes.FETCH_BPJS_PCARE_REGISTRATIONS_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareRegistrationsAction>(modelAction.BpjsPcareRegistrationsModelActionTypes.FETCH_LAST_BPJS_PCARE_REGISTRATIONS_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareRegistrationsActionOK(
						modelAction.BpjsPcareRegistrationsModelActionTypes.FETCH_LAST_BPJS_PCARE_REGISTRATIONS_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareRegistrationsActionFail(
								modelAction.BpjsPcareRegistrationsModelActionTypes.FETCH_LAST_BPJS_PCARE_REGISTRATIONS_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareRegistrationsAction>(modelAction.BpjsPcareRegistrationsModelActionTypes.CREATE_BPJS_PCARE_REGISTRATIONS),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsPcareRegistrationsModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareRegistrationsActionOK(
						modelAction.BpjsPcareRegistrationsModelActionTypes.CREATE_BPJS_PCARE_REGISTRATIONS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareRegistrationsActionFail(
								modelAction.BpjsPcareRegistrationsModelActionTypes.CREATE_BPJS_PCARE_REGISTRATIONS_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareRegistrationsAction>(modelAction.BpjsPcareRegistrationsModelActionTypes.CREATE_ALL_BPJS_PCARE_REGISTRATIONS),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsPcareRegistrationsModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareRegistrationsActionOK(
						modelAction.BpjsPcareRegistrationsModelActionTypes.CREATE_ALL_BPJS_PCARE_REGISTRATIONS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareRegistrationsActionFail(
								modelAction.BpjsPcareRegistrationsModelActionTypes.CREATE_ALL_BPJS_PCARE_REGISTRATIONS_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareRegistrationsAction>(modelAction.BpjsPcareRegistrationsModelActionTypes.UPDATE_BPJS_PCARE_REGISTRATIONS),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsPcareRegistrationsModel;
				...
				return this.service.update(new BpjsPcareRegistrationsModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareRegistrationsActionOK(
						modelAction.BpjsPcareRegistrationsModelActionTypes.UPDATE_BPJS_PCARE_REGISTRATIONS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareRegistrationsActionFail(
								modelAction.BpjsPcareRegistrationsModelActionTypes.UPDATE_BPJS_PCARE_REGISTRATIONS_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareRegistrationsAction>(modelAction.BpjsPcareRegistrationsModelActionTypes.UPDATE_ALL_BPJS_PCARE_REGISTRATIONS),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsPcareRegistrationsModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsPcareRegistrationsModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareRegistrationsActionOK(
						modelAction.BpjsPcareRegistrationsModelActionTypes.UPDATE_ALL_BPJS_PCARE_REGISTRATIONS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareRegistrationsActionFail(
								modelAction.BpjsPcareRegistrationsModelActionTypes.UPDATE_ALL_BPJS_PCARE_REGISTRATIONS_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareRegistrationsAction>(modelAction.BpjsPcareRegistrationsModelActionTypes.DELETE_BPJS_PCARE_REGISTRATIONS),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareRegistrationsActionOK(
						modelAction.BpjsPcareRegistrationsModelActionTypes.DELETE_BPJS_PCARE_REGISTRATIONS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareRegistrationsActionFail(
								modelAction.BpjsPcareRegistrationsModelActionTypes.DELETE_BPJS_PCARE_REGISTRATIONS_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareRegistrationsAction>(modelAction.BpjsPcareRegistrationsModelActionTypes.DELETE_BPJS_PCARE_REGISTRATIONS_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareRegistrationsActionOK(
						modelAction.BpjsPcareRegistrationsModelActionTypes.DELETE_BPJS_PCARE_REGISTRATIONS_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareRegistrationsActionFail(
								modelAction.BpjsPcareRegistrationsModelActionTypes.DELETE_BPJS_PCARE_REGISTRATIONS_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareRegistrationsAction>(modelAction.BpjsPcareRegistrationsModelActionTypes.DELETE_ALL_BPJS_PCARE_REGISTRATIONS),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareRegistrationsActionOK(
						modelAction.BpjsPcareRegistrationsModelActionTypes.DELETE_ALL_BPJS_PCARE_REGISTRATIONS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareRegistrationsActionFail(
								modelAction.BpjsPcareRegistrationsModelActionTypes.DELETE_ALL_BPJS_PCARE_REGISTRATIONS_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareRegistrationsAction>(modelAction.BpjsPcareRegistrationsModelActionTypes.EXPORT_BPJS_PCARE_REGISTRATIONS),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareRegistrationsActionOK(
						modelAction.BpjsPcareRegistrationsModelActionTypes.EXPORT_BPJS_PCARE_REGISTRATIONS,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareRegistrationsAction>(modelAction.BpjsPcareRegistrationsModelActionTypes.EXPORT_ALL_BPJS_PCARE_REGISTRATIONS),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareRegistrationsActionOK(
						modelAction.BpjsPcareRegistrationsModelActionTypes.EXPORT_ALL_BPJS_PCARE_REGISTRATIONS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareRegistrationsActionFail(
								modelAction.BpjsPcareRegistrationsModelActionTypes.EXPORT_ALL_BPJS_PCARE_REGISTRATIONS_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareRegistrationsAction>(modelAction.BpjsPcareRegistrationsModelActionTypes.EXPORT_BPJS_PCARE_REGISTRATIONS_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareRegistrationsActionOK(
						modelAction.BpjsPcareRegistrationsModelActionTypes.EXPORT_BPJS_PCARE_REGISTRATIONS_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareRegistrationsActionFail(
								modelAction.BpjsPcareRegistrationsModelActionTypes.EXPORT_BPJS_PCARE_REGISTRATIONS_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareRegistrationsAction>(modelAction.BpjsPcareRegistrationsModelActionTypes.IMPORT_BPJS_PCARE_REGISTRATIONSS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareRegistrationsActionOK(
						modelAction.BpjsPcareRegistrationsModelActionTypes.IMPORT_BPJS_PCARE_REGISTRATIONSS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareRegistrationsActionFail(
								modelAction.BpjsPcareRegistrationsModelActionTypes.IMPORT_BPJS_PCARE_REGISTRATIONSS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareRegistrationsAction>(modelAction.BpjsPcareRegistrationsModelActionTypes.FETCH_BPJS_PCARE_REGISTRATIONS_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsPcareRegistrationsActionOK(
						modelAction.BpjsPcareRegistrationsModelActionTypes.FETCH_BPJS_PCARE_REGISTRATIONS_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareRegistrationsActionFail(
								modelAction.BpjsPcareRegistrationsModelActionTypes.FETCH_BPJS_PCARE_REGISTRATIONS_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareRegistrationsAction>(modelAction.BpjsPcareRegistrationsModelActionTypes.FETCH_BPJS_PCARE_REGISTRATIONS_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsPcareRegistrationsActionOK(
						modelAction.BpjsPcareRegistrationsModelActionTypes.FETCH_BPJS_PCARE_REGISTRATIONS_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareRegistrationsActionFail(
								modelAction.BpjsPcareRegistrationsModelActionTypes.FETCH_BPJS_PCARE_REGISTRATIONS_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
