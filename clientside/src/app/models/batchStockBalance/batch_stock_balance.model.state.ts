...
/**
 * BatchStockBalanceCollectionState would store the state of a collection of BatchStockBalance
 */
export interface BatchStockBalanceCollectionState extends CollectionState {
 ...
 */
export interface BatchStockBalanceModelAudit extends AbstractModelAudit<BatchStockBalanceModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BatchStockBalanceModelState would store the state of the model
 */
export interface BatchStockBalanceModelState {
	collectionState: {
		[key: string]: BatchStockBalanceCollectionState;
	};
	data: {
		[id: string]: BatchStockBalanceModel;
	};
	totalCount: number;
	audits: BatchStockBalanceModelAudit[];
 ...
 */
export const initialBatchStockBalanceCollectionState: BatchStockBalanceCollectionState = {
...
/**
 * The initial state of BatchStockBalanceModelState
 */
export const initialState: BatchStockBalanceModelState = {
	collectionState: {
