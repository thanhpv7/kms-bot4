...
import * as modelAction from './batch_stock_balance.model.action';
import {BatchStockBalanceService} from '../../services/batchStockBalance/batch_stock_balance.service';
...
/**
 * Effect class used for side effects related to Batch Stock Balance model.
 */
@Injectable()
export class BatchStockBalanceEffect {
	...
	constructor(
		...
		protected readonly service: BatchStockBalanceService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockBalanceAction>(modelAction.BatchStockBalanceModelActionTypes.COUNT_BATCH_STOCK_BALANCES),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BatchStockBalanceActionOK(
						modelAction.BatchStockBalanceModelActionTypes.COUNT_BATCH_STOCK_BALANCES_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockBalanceActionFail(
								modelAction.BatchStockBalanceModelActionTypes.COUNT_BATCH_STOCK_BALANCES_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockBalanceAction>(modelAction.BatchStockBalanceModelActionTypes.FETCH_BATCH_STOCK_BALANCE),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BatchStockBalanceActionOK(
						modelAction.BatchStockBalanceModelActionTypes.FETCH_BATCH_STOCK_BALANCE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockBalanceActionFail(
								modelAction.BatchStockBalanceModelActionTypes.FETCH_BATCH_STOCK_BALANCE_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockBalanceAction>(modelAction.BatchStockBalanceModelActionTypes.FETCH_ALL_BATCH_STOCK_BALANCE),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BatchStockBalanceActionOK(
						modelAction.BatchStockBalanceModelActionTypes.FETCH_ALL_BATCH_STOCK_BALANCE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockBalanceActionFail(
								modelAction.BatchStockBalanceModelActionTypes.FETCH_ALL_BATCH_STOCK_BALANCE_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockBalanceAction>(modelAction.BatchStockBalanceModelActionTypes.FETCH_BATCH_STOCK_BALANCE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BatchStockBalanceActionOK(
						modelAction.BatchStockBalanceModelActionTypes.FETCH_BATCH_STOCK_BALANCE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockBalanceActionFail(
								modelAction.BatchStockBalanceModelActionTypes.FETCH_BATCH_STOCK_BALANCE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockBalanceAction>(modelAction.BatchStockBalanceModelActionTypes.FETCH_LAST_BATCH_STOCK_BALANCE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BatchStockBalanceActionOK(
						modelAction.BatchStockBalanceModelActionTypes.FETCH_LAST_BATCH_STOCK_BALANCE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockBalanceActionFail(
								modelAction.BatchStockBalanceModelActionTypes.FETCH_LAST_BATCH_STOCK_BALANCE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockBalanceAction>(modelAction.BatchStockBalanceModelActionTypes.CREATE_BATCH_STOCK_BALANCE),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BatchStockBalanceModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BatchStockBalanceActionOK(
						modelAction.BatchStockBalanceModelActionTypes.CREATE_BATCH_STOCK_BALANCE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockBalanceActionFail(
								modelAction.BatchStockBalanceModelActionTypes.CREATE_BATCH_STOCK_BALANCE_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockBalanceAction>(modelAction.BatchStockBalanceModelActionTypes.CREATE_ALL_BATCH_STOCK_BALANCE),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BatchStockBalanceModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BatchStockBalanceActionOK(
						modelAction.BatchStockBalanceModelActionTypes.CREATE_ALL_BATCH_STOCK_BALANCE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockBalanceActionFail(
								modelAction.BatchStockBalanceModelActionTypes.CREATE_ALL_BATCH_STOCK_BALANCE_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockBalanceAction>(modelAction.BatchStockBalanceModelActionTypes.UPDATE_BATCH_STOCK_BALANCE),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BatchStockBalanceModel;
				...
				return this.service.update(new BatchStockBalanceModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BatchStockBalanceActionOK(
						modelAction.BatchStockBalanceModelActionTypes.UPDATE_BATCH_STOCK_BALANCE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockBalanceActionFail(
								modelAction.BatchStockBalanceModelActionTypes.UPDATE_BATCH_STOCK_BALANCE_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockBalanceAction>(modelAction.BatchStockBalanceModelActionTypes.UPDATE_ALL_BATCH_STOCK_BALANCE),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BatchStockBalanceModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BatchStockBalanceModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BatchStockBalanceActionOK(
						modelAction.BatchStockBalanceModelActionTypes.UPDATE_ALL_BATCH_STOCK_BALANCE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockBalanceActionFail(
								modelAction.BatchStockBalanceModelActionTypes.UPDATE_ALL_BATCH_STOCK_BALANCE_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockBalanceAction>(modelAction.BatchStockBalanceModelActionTypes.DELETE_BATCH_STOCK_BALANCE),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BatchStockBalanceActionOK(
						modelAction.BatchStockBalanceModelActionTypes.DELETE_BATCH_STOCK_BALANCE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockBalanceActionFail(
								modelAction.BatchStockBalanceModelActionTypes.DELETE_BATCH_STOCK_BALANCE_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockBalanceAction>(modelAction.BatchStockBalanceModelActionTypes.DELETE_BATCH_STOCK_BALANCE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BatchStockBalanceActionOK(
						modelAction.BatchStockBalanceModelActionTypes.DELETE_BATCH_STOCK_BALANCE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockBalanceActionFail(
								modelAction.BatchStockBalanceModelActionTypes.DELETE_BATCH_STOCK_BALANCE_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockBalanceAction>(modelAction.BatchStockBalanceModelActionTypes.DELETE_ALL_BATCH_STOCK_BALANCE),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BatchStockBalanceActionOK(
						modelAction.BatchStockBalanceModelActionTypes.DELETE_ALL_BATCH_STOCK_BALANCE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockBalanceActionFail(
								modelAction.BatchStockBalanceModelActionTypes.DELETE_ALL_BATCH_STOCK_BALANCE_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockBalanceAction>(modelAction.BatchStockBalanceModelActionTypes.EXPORT_BATCH_STOCK_BALANCE),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BatchStockBalanceActionOK(
						modelAction.BatchStockBalanceModelActionTypes.EXPORT_BATCH_STOCK_BALANCE,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockBalanceAction>(modelAction.BatchStockBalanceModelActionTypes.EXPORT_ALL_BATCH_STOCK_BALANCE),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BatchStockBalanceActionOK(
						modelAction.BatchStockBalanceModelActionTypes.EXPORT_ALL_BATCH_STOCK_BALANCE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockBalanceActionFail(
								modelAction.BatchStockBalanceModelActionTypes.EXPORT_ALL_BATCH_STOCK_BALANCE_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockBalanceAction>(modelAction.BatchStockBalanceModelActionTypes.EXPORT_BATCH_STOCK_BALANCE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BatchStockBalanceActionOK(
						modelAction.BatchStockBalanceModelActionTypes.EXPORT_BATCH_STOCK_BALANCE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockBalanceActionFail(
								modelAction.BatchStockBalanceModelActionTypes.EXPORT_BATCH_STOCK_BALANCE_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockBalanceAction>(modelAction.BatchStockBalanceModelActionTypes.IMPORT_BATCH_STOCK_BALANCES),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BatchStockBalanceActionOK(
						modelAction.BatchStockBalanceModelActionTypes.IMPORT_BATCH_STOCK_BALANCES_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockBalanceActionFail(
								modelAction.BatchStockBalanceModelActionTypes.IMPORT_BATCH_STOCK_BALANCES_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockBalanceAction>(modelAction.BatchStockBalanceModelActionTypes.FETCH_BATCH_STOCK_BALANCE_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BatchStockBalanceActionOK(
						modelAction.BatchStockBalanceModelActionTypes.FETCH_BATCH_STOCK_BALANCE_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockBalanceActionFail(
								modelAction.BatchStockBalanceModelActionTypes.FETCH_BATCH_STOCK_BALANCE_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockBalanceAction>(modelAction.BatchStockBalanceModelActionTypes.FETCH_BATCH_STOCK_BALANCE_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BatchStockBalanceActionOK(
						modelAction.BatchStockBalanceModelActionTypes.FETCH_BATCH_STOCK_BALANCE_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockBalanceActionFail(
								modelAction.BatchStockBalanceModelActionTypes.FETCH_BATCH_STOCK_BALANCE_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
