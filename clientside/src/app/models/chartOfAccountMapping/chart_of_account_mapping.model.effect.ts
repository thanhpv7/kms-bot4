...
import * as modelAction from './chart_of_account_mapping.model.action';
import {ChartOfAccountMappingService} from '../../services/chartOfAccountMapping/chart_of_account_mapping.service';
...
/**
 * Effect class used for side effects related to Chart of Account Mapping model.
 */
@Injectable()
export class ChartOfAccountMappingEffect {
	...
	constructor(
		...
		protected readonly service: ChartOfAccountMappingService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ChartOfAccountMappingAction>(modelAction.ChartOfAccountMappingModelActionTypes.COUNT_CHART_OF_ACCOUNT_MAPPINGS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.ChartOfAccountMappingActionOK(
						modelAction.ChartOfAccountMappingModelActionTypes.COUNT_CHART_OF_ACCOUNT_MAPPINGS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ChartOfAccountMappingActionFail(
								modelAction.ChartOfAccountMappingModelActionTypes.COUNT_CHART_OF_ACCOUNT_MAPPINGS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ChartOfAccountMappingAction>(modelAction.ChartOfAccountMappingModelActionTypes.FETCH_CHART_OF_ACCOUNT_MAPPING),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ChartOfAccountMappingActionOK(
						modelAction.ChartOfAccountMappingModelActionTypes.FETCH_CHART_OF_ACCOUNT_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ChartOfAccountMappingActionFail(
								modelAction.ChartOfAccountMappingModelActionTypes.FETCH_CHART_OF_ACCOUNT_MAPPING_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ChartOfAccountMappingAction>(modelAction.ChartOfAccountMappingModelActionTypes.FETCH_ALL_CHART_OF_ACCOUNT_MAPPING),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.ChartOfAccountMappingActionOK(
						modelAction.ChartOfAccountMappingModelActionTypes.FETCH_ALL_CHART_OF_ACCOUNT_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ChartOfAccountMappingActionFail(
								modelAction.ChartOfAccountMappingModelActionTypes.FETCH_ALL_CHART_OF_ACCOUNT_MAPPING_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ChartOfAccountMappingAction>(modelAction.ChartOfAccountMappingModelActionTypes.FETCH_CHART_OF_ACCOUNT_MAPPING_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.ChartOfAccountMappingActionOK(
						modelAction.ChartOfAccountMappingModelActionTypes.FETCH_CHART_OF_ACCOUNT_MAPPING_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ChartOfAccountMappingActionFail(
								modelAction.ChartOfAccountMappingModelActionTypes.FETCH_CHART_OF_ACCOUNT_MAPPING_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ChartOfAccountMappingAction>(modelAction.ChartOfAccountMappingModelActionTypes.FETCH_LAST_CHART_OF_ACCOUNT_MAPPING_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.ChartOfAccountMappingActionOK(
						modelAction.ChartOfAccountMappingModelActionTypes.FETCH_LAST_CHART_OF_ACCOUNT_MAPPING_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ChartOfAccountMappingActionFail(
								modelAction.ChartOfAccountMappingModelActionTypes.FETCH_LAST_CHART_OF_ACCOUNT_MAPPING_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ChartOfAccountMappingAction>(modelAction.ChartOfAccountMappingModelActionTypes.CREATE_CHART_OF_ACCOUNT_MAPPING),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as ChartOfAccountMappingModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ChartOfAccountMappingActionOK(
						modelAction.ChartOfAccountMappingModelActionTypes.CREATE_CHART_OF_ACCOUNT_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ChartOfAccountMappingActionFail(
								modelAction.ChartOfAccountMappingModelActionTypes.CREATE_CHART_OF_ACCOUNT_MAPPING_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ChartOfAccountMappingAction>(modelAction.ChartOfAccountMappingModelActionTypes.CREATE_ALL_CHART_OF_ACCOUNT_MAPPING),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as ChartOfAccountMappingModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ChartOfAccountMappingActionOK(
						modelAction.ChartOfAccountMappingModelActionTypes.CREATE_ALL_CHART_OF_ACCOUNT_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ChartOfAccountMappingActionFail(
								modelAction.ChartOfAccountMappingModelActionTypes.CREATE_ALL_CHART_OF_ACCOUNT_MAPPING_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ChartOfAccountMappingAction>(modelAction.ChartOfAccountMappingModelActionTypes.UPDATE_CHART_OF_ACCOUNT_MAPPING),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as ChartOfAccountMappingModel;
				...
				return this.service.update(new ChartOfAccountMappingModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.ChartOfAccountMappingActionOK(
						modelAction.ChartOfAccountMappingModelActionTypes.UPDATE_CHART_OF_ACCOUNT_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ChartOfAccountMappingActionFail(
								modelAction.ChartOfAccountMappingModelActionTypes.UPDATE_CHART_OF_ACCOUNT_MAPPING_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ChartOfAccountMappingAction>(modelAction.ChartOfAccountMappingModelActionTypes.UPDATE_ALL_CHART_OF_ACCOUNT_MAPPING),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as ChartOfAccountMappingModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new ChartOfAccountMappingModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ChartOfAccountMappingActionOK(
						modelAction.ChartOfAccountMappingModelActionTypes.UPDATE_ALL_CHART_OF_ACCOUNT_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ChartOfAccountMappingActionFail(
								modelAction.ChartOfAccountMappingModelActionTypes.UPDATE_ALL_CHART_OF_ACCOUNT_MAPPING_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ChartOfAccountMappingAction>(modelAction.ChartOfAccountMappingModelActionTypes.DELETE_CHART_OF_ACCOUNT_MAPPING),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.ChartOfAccountMappingActionOK(
						modelAction.ChartOfAccountMappingModelActionTypes.DELETE_CHART_OF_ACCOUNT_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ChartOfAccountMappingActionFail(
								modelAction.ChartOfAccountMappingModelActionTypes.DELETE_CHART_OF_ACCOUNT_MAPPING_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ChartOfAccountMappingAction>(modelAction.ChartOfAccountMappingModelActionTypes.DELETE_CHART_OF_ACCOUNT_MAPPING_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.ChartOfAccountMappingActionOK(
						modelAction.ChartOfAccountMappingModelActionTypes.DELETE_CHART_OF_ACCOUNT_MAPPING_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ChartOfAccountMappingActionFail(
								modelAction.ChartOfAccountMappingModelActionTypes.DELETE_CHART_OF_ACCOUNT_MAPPING_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ChartOfAccountMappingAction>(modelAction.ChartOfAccountMappingModelActionTypes.DELETE_ALL_CHART_OF_ACCOUNT_MAPPING),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.ChartOfAccountMappingActionOK(
						modelAction.ChartOfAccountMappingModelActionTypes.DELETE_ALL_CHART_OF_ACCOUNT_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ChartOfAccountMappingActionFail(
								modelAction.ChartOfAccountMappingModelActionTypes.DELETE_ALL_CHART_OF_ACCOUNT_MAPPING_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ChartOfAccountMappingAction>(modelAction.ChartOfAccountMappingModelActionTypes.EXPORT_CHART_OF_ACCOUNT_MAPPING),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ChartOfAccountMappingActionOK(
						modelAction.ChartOfAccountMappingModelActionTypes.EXPORT_CHART_OF_ACCOUNT_MAPPING,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ChartOfAccountMappingAction>(modelAction.ChartOfAccountMappingModelActionTypes.EXPORT_ALL_CHART_OF_ACCOUNT_MAPPING),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ChartOfAccountMappingActionOK(
						modelAction.ChartOfAccountMappingModelActionTypes.EXPORT_ALL_CHART_OF_ACCOUNT_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ChartOfAccountMappingActionFail(
								modelAction.ChartOfAccountMappingModelActionTypes.EXPORT_ALL_CHART_OF_ACCOUNT_MAPPING_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ChartOfAccountMappingAction>(modelAction.ChartOfAccountMappingModelActionTypes.EXPORT_CHART_OF_ACCOUNT_MAPPING_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ChartOfAccountMappingActionOK(
						modelAction.ChartOfAccountMappingModelActionTypes.EXPORT_CHART_OF_ACCOUNT_MAPPING_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ChartOfAccountMappingActionFail(
								modelAction.ChartOfAccountMappingModelActionTypes.EXPORT_CHART_OF_ACCOUNT_MAPPING_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ChartOfAccountMappingAction>(modelAction.ChartOfAccountMappingModelActionTypes.IMPORT_CHART_OF_ACCOUNT_MAPPINGS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.ChartOfAccountMappingActionOK(
						modelAction.ChartOfAccountMappingModelActionTypes.IMPORT_CHART_OF_ACCOUNT_MAPPINGS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ChartOfAccountMappingActionFail(
								modelAction.ChartOfAccountMappingModelActionTypes.IMPORT_CHART_OF_ACCOUNT_MAPPINGS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ChartOfAccountMappingAction>(modelAction.ChartOfAccountMappingModelActionTypes.FETCH_CHART_OF_ACCOUNT_MAPPING_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.ChartOfAccountMappingActionOK(
						modelAction.ChartOfAccountMappingModelActionTypes.FETCH_CHART_OF_ACCOUNT_MAPPING_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.ChartOfAccountMappingActionFail(
								modelAction.ChartOfAccountMappingModelActionTypes.FETCH_CHART_OF_ACCOUNT_MAPPING_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ChartOfAccountMappingAction>(modelAction.ChartOfAccountMappingModelActionTypes.FETCH_CHART_OF_ACCOUNT_MAPPING_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.ChartOfAccountMappingActionOK(
						modelAction.ChartOfAccountMappingModelActionTypes.FETCH_CHART_OF_ACCOUNT_MAPPING_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.ChartOfAccountMappingActionFail(
								modelAction.ChartOfAccountMappingModelActionTypes.FETCH_CHART_OF_ACCOUNT_MAPPING_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
