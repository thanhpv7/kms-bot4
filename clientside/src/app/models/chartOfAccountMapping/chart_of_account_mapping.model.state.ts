...
/**
 * ChartOfAccountMappingCollectionState would store the state of a collection of ChartOfAccountMapping
 */
export interface ChartOfAccountMappingCollectionState extends CollectionState {
 ...
 */
export interface ChartOfAccountMappingModelAudit extends AbstractModelAudit<ChartOfAccountMappingModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * ChartOfAccountMappingModelState would store the state of the model
 */
export interface ChartOfAccountMappingModelState {
	collectionState: {
		[key: string]: ChartOfAccountMappingCollectionState;
	};
	data: {
		[id: string]: ChartOfAccountMappingModel;
	};
	totalCount: number;
	audits: ChartOfAccountMappingModelAudit[];
 ...
 */
export const initialChartOfAccountMappingCollectionState: ChartOfAccountMappingCollectionState = {
...
/**
 * The initial state of ChartOfAccountMappingModelState
 */
export const initialState: ChartOfAccountMappingModelState = {
	collectionState: {
