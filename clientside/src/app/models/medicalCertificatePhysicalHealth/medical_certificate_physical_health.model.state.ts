...
/**
 * MedicalCertificatePhysicalHealthCollectionState would store the state of a collection of MedicalCertificatePhysicalHealth
 */
export interface MedicalCertificatePhysicalHealthCollectionState extends CollectionState {
 ...
 */
export interface MedicalCertificatePhysicalHealthModelAudit extends AbstractModelAudit<MedicalCertificatePhysicalHealthModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * MedicalCertificatePhysicalHealthModelState would store the state of the model
 */
export interface MedicalCertificatePhysicalHealthModelState {
	collectionState: {
		[key: string]: MedicalCertificatePhysicalHealthCollectionState;
	};
	data: {
		[id: string]: MedicalCertificatePhysicalHealthModel;
	};
	totalCount: number;
	audits: MedicalCertificatePhysicalHealthModelAudit[];
 ...
 */
export const initialMedicalCertificatePhysicalHealthCollectionState: MedicalCertificatePhysicalHealthCollectionState = {
...
/**
 * The initial state of MedicalCertificatePhysicalHealthModelState
 */
export const initialState: MedicalCertificatePhysicalHealthModelState = {
	collectionState: {
