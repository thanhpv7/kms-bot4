...
import * as modelAction from './medical_certificate_physical_health.model.action';
import {MedicalCertificatePhysicalHealthService} from '../../services/medicalCertificatePhysicalHealth/medical_certificate_physical_health.service';
...
/**
 * Effect class used for side effects related to Medical Certificate Physical Health model.
 */
@Injectable()
export class MedicalCertificatePhysicalHealthEffect {
	...
	constructor(
		...
		protected readonly service: MedicalCertificatePhysicalHealthService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificatePhysicalHealthAction>(modelAction.MedicalCertificatePhysicalHealthModelActionTypes.COUNT_MEDICAL_CERTIFICATE_PHYSICAL_HEALTHS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificatePhysicalHealthActionOK(
						modelAction.MedicalCertificatePhysicalHealthModelActionTypes.COUNT_MEDICAL_CERTIFICATE_PHYSICAL_HEALTHS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificatePhysicalHealthActionFail(
								modelAction.MedicalCertificatePhysicalHealthModelActionTypes.COUNT_MEDICAL_CERTIFICATE_PHYSICAL_HEALTHS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificatePhysicalHealthAction>(modelAction.MedicalCertificatePhysicalHealthModelActionTypes.FETCH_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificatePhysicalHealthActionOK(
						modelAction.MedicalCertificatePhysicalHealthModelActionTypes.FETCH_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificatePhysicalHealthActionFail(
								modelAction.MedicalCertificatePhysicalHealthModelActionTypes.FETCH_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificatePhysicalHealthAction>(modelAction.MedicalCertificatePhysicalHealthModelActionTypes.FETCH_ALL_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificatePhysicalHealthActionOK(
						modelAction.MedicalCertificatePhysicalHealthModelActionTypes.FETCH_ALL_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificatePhysicalHealthActionFail(
								modelAction.MedicalCertificatePhysicalHealthModelActionTypes.FETCH_ALL_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificatePhysicalHealthAction>(modelAction.MedicalCertificatePhysicalHealthModelActionTypes.FETCH_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificatePhysicalHealthActionOK(
						modelAction.MedicalCertificatePhysicalHealthModelActionTypes.FETCH_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificatePhysicalHealthActionFail(
								modelAction.MedicalCertificatePhysicalHealthModelActionTypes.FETCH_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificatePhysicalHealthAction>(modelAction.MedicalCertificatePhysicalHealthModelActionTypes.FETCH_LAST_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificatePhysicalHealthActionOK(
						modelAction.MedicalCertificatePhysicalHealthModelActionTypes.FETCH_LAST_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificatePhysicalHealthActionFail(
								modelAction.MedicalCertificatePhysicalHealthModelActionTypes.FETCH_LAST_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificatePhysicalHealthAction>(modelAction.MedicalCertificatePhysicalHealthModelActionTypes.CREATE_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as MedicalCertificatePhysicalHealthModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificatePhysicalHealthActionOK(
						modelAction.MedicalCertificatePhysicalHealthModelActionTypes.CREATE_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificatePhysicalHealthActionFail(
								modelAction.MedicalCertificatePhysicalHealthModelActionTypes.CREATE_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificatePhysicalHealthAction>(modelAction.MedicalCertificatePhysicalHealthModelActionTypes.CREATE_ALL_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as MedicalCertificatePhysicalHealthModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificatePhysicalHealthActionOK(
						modelAction.MedicalCertificatePhysicalHealthModelActionTypes.CREATE_ALL_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificatePhysicalHealthActionFail(
								modelAction.MedicalCertificatePhysicalHealthModelActionTypes.CREATE_ALL_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificatePhysicalHealthAction>(modelAction.MedicalCertificatePhysicalHealthModelActionTypes.UPDATE_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as MedicalCertificatePhysicalHealthModel;
				...
				return this.service.update(new MedicalCertificatePhysicalHealthModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificatePhysicalHealthActionOK(
						modelAction.MedicalCertificatePhysicalHealthModelActionTypes.UPDATE_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificatePhysicalHealthActionFail(
								modelAction.MedicalCertificatePhysicalHealthModelActionTypes.UPDATE_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificatePhysicalHealthAction>(modelAction.MedicalCertificatePhysicalHealthModelActionTypes.UPDATE_ALL_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as MedicalCertificatePhysicalHealthModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new MedicalCertificatePhysicalHealthModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificatePhysicalHealthActionOK(
						modelAction.MedicalCertificatePhysicalHealthModelActionTypes.UPDATE_ALL_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificatePhysicalHealthActionFail(
								modelAction.MedicalCertificatePhysicalHealthModelActionTypes.UPDATE_ALL_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificatePhysicalHealthAction>(modelAction.MedicalCertificatePhysicalHealthModelActionTypes.DELETE_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificatePhysicalHealthActionOK(
						modelAction.MedicalCertificatePhysicalHealthModelActionTypes.DELETE_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificatePhysicalHealthActionFail(
								modelAction.MedicalCertificatePhysicalHealthModelActionTypes.DELETE_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificatePhysicalHealthAction>(modelAction.MedicalCertificatePhysicalHealthModelActionTypes.DELETE_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificatePhysicalHealthActionOK(
						modelAction.MedicalCertificatePhysicalHealthModelActionTypes.DELETE_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificatePhysicalHealthActionFail(
								modelAction.MedicalCertificatePhysicalHealthModelActionTypes.DELETE_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificatePhysicalHealthAction>(modelAction.MedicalCertificatePhysicalHealthModelActionTypes.DELETE_ALL_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificatePhysicalHealthActionOK(
						modelAction.MedicalCertificatePhysicalHealthModelActionTypes.DELETE_ALL_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificatePhysicalHealthActionFail(
								modelAction.MedicalCertificatePhysicalHealthModelActionTypes.DELETE_ALL_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificatePhysicalHealthAction>(modelAction.MedicalCertificatePhysicalHealthModelActionTypes.EXPORT_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificatePhysicalHealthActionOK(
						modelAction.MedicalCertificatePhysicalHealthModelActionTypes.EXPORT_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificatePhysicalHealthAction>(modelAction.MedicalCertificatePhysicalHealthModelActionTypes.EXPORT_ALL_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificatePhysicalHealthActionOK(
						modelAction.MedicalCertificatePhysicalHealthModelActionTypes.EXPORT_ALL_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificatePhysicalHealthActionFail(
								modelAction.MedicalCertificatePhysicalHealthModelActionTypes.EXPORT_ALL_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificatePhysicalHealthAction>(modelAction.MedicalCertificatePhysicalHealthModelActionTypes.EXPORT_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificatePhysicalHealthActionOK(
						modelAction.MedicalCertificatePhysicalHealthModelActionTypes.EXPORT_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificatePhysicalHealthActionFail(
								modelAction.MedicalCertificatePhysicalHealthModelActionTypes.EXPORT_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificatePhysicalHealthAction>(modelAction.MedicalCertificatePhysicalHealthModelActionTypes.IMPORT_MEDICAL_CERTIFICATE_PHYSICAL_HEALTHS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificatePhysicalHealthActionOK(
						modelAction.MedicalCertificatePhysicalHealthModelActionTypes.IMPORT_MEDICAL_CERTIFICATE_PHYSICAL_HEALTHS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificatePhysicalHealthActionFail(
								modelAction.MedicalCertificatePhysicalHealthModelActionTypes.IMPORT_MEDICAL_CERTIFICATE_PHYSICAL_HEALTHS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificatePhysicalHealthAction>(modelAction.MedicalCertificatePhysicalHealthModelActionTypes.FETCH_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.MedicalCertificatePhysicalHealthActionOK(
						modelAction.MedicalCertificatePhysicalHealthModelActionTypes.FETCH_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificatePhysicalHealthActionFail(
								modelAction.MedicalCertificatePhysicalHealthModelActionTypes.FETCH_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificatePhysicalHealthAction>(modelAction.MedicalCertificatePhysicalHealthModelActionTypes.FETCH_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.MedicalCertificatePhysicalHealthActionOK(
						modelAction.MedicalCertificatePhysicalHealthModelActionTypes.FETCH_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificatePhysicalHealthActionFail(
								modelAction.MedicalCertificatePhysicalHealthModelActionTypes.FETCH_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
