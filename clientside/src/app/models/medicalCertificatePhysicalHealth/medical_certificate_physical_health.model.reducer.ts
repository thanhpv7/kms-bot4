...
import {initialMedicalCertificatePhysicalHealthCollectionState} from './medical_certificate_physical_health.model.state';
...
export function modelReducer(currentState: ModelState, action: Action): ModelState {
	...
	const className = (action as modelAction.BaseMedicalCertificatePhysicalHealthAction).className;
	...
	return produce(currentState, draft => {
		...
		switch (action.type) {
			case modelAction.MedicalCertificatePhysicalHealthModelActionTypes.CREATE_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_OK:
				const createdModel = (action as modelAction.MedicalCertificatePhysicalHealthActionOK ).stateConfig.targetModel;
				...
				MedicalCertificatePhysicalHealthModel.deepParse(createdModel).forEach(model => {
				...
				break;
			case modelAction.MedicalCertificatePhysicalHealthModelActionTypes.CREATE_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.MedicalCertificatePhysicalHealthModelActionTypes.CREATE_ALL_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_OK:
				const createdModels = (action as modelAction.MedicalCertificatePhysicalHealthActionOK).stateConfig.targetModels;
				const collectionIdAfterCreateAll = (action as modelAction.MedicalCertificatePhysicalHealthActionOK).stateConfig.collectionId;
				...
				createdModels.forEach((m) => {
					MedicalCertificatePhysicalHealthModel.deepParse(m).forEach(model => {
						draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
						(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
					});
				});
				...
				break;
			case modelAction.MedicalCertificatePhysicalHealthModelActionTypes.CREATE_ALL_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.MedicalCertificatePhysicalHealthModelActionTypes.DELETE_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_OK:
				const deletedModelId = (action as modelAction.MedicalCertificatePhysicalHealthActionOK).stateConfig.targetModelId;
				const collectionIdAfterDelete = (action as modelAction.MedicalCertificatePhysicalHealthActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.MedicalCertificatePhysicalHealthModelActionTypes.DELETE_ALL_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_OK:
				const deletedModelIds = (action as modelAction.MedicalCertificatePhysicalHealthActionOK).stateConfig.targetModelIds;
				const collectionIdAfterDeleteAll = (action as modelAction.MedicalCertificatePhysicalHealthActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.MedicalCertificatePhysicalHealthModelActionTypes.DELETE_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.MedicalCertificatePhysicalHealthModelActionTypes.UPDATE_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_OK:
				const updatedModel = (action as modelAction.MedicalCertificatePhysicalHealthActionOK).stateConfig.targetModel;
				...
				MedicalCertificatePhysicalHealthModel.deepParse(updatedModel).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalCertificatePhysicalHealthModelActionTypes.UPDATE_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_FAIL:
				// TODO: Add handling of failure
				break;

			case modelAction.MedicalCertificatePhysicalHealthModelActionTypes.UPDATE_ALL_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_OK:
				const updatedModels = (action as modelAction.MedicalCertificatePhysicalHealthActionOK).stateConfig.targetModels;
				const collectionIdAfterUpdateAll = (action as modelAction.MedicalCertificatePhysicalHealthActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.MedicalCertificatePhysicalHealthModelActionTypes.UPDATE_ALL_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.MedicalCertificatePhysicalHealthModelActionTypes.FETCH_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_OK:
				let fetchedModel = (action as modelAction.MedicalCertificatePhysicalHealthActionOK).stateConfig.targetModel;
				...
				MedicalCertificatePhysicalHealthModel.deepParse(fetchedModel).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalCertificatePhysicalHealthModelActionTypes.FETCH_ALL_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_OK:
				const totalCountAfterFetchAll = (action as modelAction.MedicalCertificatePhysicalHealthActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchAll = (action as modelAction.MedicalCertificatePhysicalHealthActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchAll = (action as modelAction.MedicalCertificatePhysicalHealthActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchAll = (action as modelAction.MedicalCertificatePhysicalHealthActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchAll.map(model => MedicalCertificatePhysicalHealthModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalCertificatePhysicalHealthModelActionTypes.FETCH_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_AUDIT_OK:
				const audits = (action as modelAction.MedicalCertificatePhysicalHealthActionOK).audits;
				...
				break;
			case modelAction.MedicalCertificatePhysicalHealthModelActionTypes.FETCH_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_AUDITS_BY_ENTITY_ID_OK:
				const auditsByEntityId = (action as modelAction.MedicalCertificatePhysicalHealthActionOK).audits;
				...
				break;
			case modelAction.MedicalCertificatePhysicalHealthModelActionTypes.FETCH_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_WITH_QUERY_OK:
				const totalCountAfterFetchWithQuery = (action as modelAction.MedicalCertificatePhysicalHealthActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchWithQuery = (action as modelAction.MedicalCertificatePhysicalHealthActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchWithQuery = (action as modelAction.MedicalCertificatePhysicalHealthActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchWithQuery = (action as modelAction.MedicalCertificatePhysicalHealthActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchWithQuery.map(model => MedicalCertificatePhysicalHealthModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalCertificatePhysicalHealthModelActionTypes.FETCH_LAST_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_WITH_QUERY_OK:
				const totalCountAfterFetchLastWithQuery = (action as modelAction.MedicalCertificatePhysicalHealthActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchLastWithQuery = (action as modelAction.MedicalCertificatePhysicalHealthActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchLastWithQuery = (action as modelAction.MedicalCertificatePhysicalHealthActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchLastWithQuery = (action as modelAction.MedicalCertificatePhysicalHealthActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchLastWithQuery.map(model => MedicalCertificatePhysicalHealthModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalCertificatePhysicalHealthModelActionTypes.COUNT_MEDICAL_CERTIFICATE_PHYSICAL_HEALTHS_OK:
				const totalCountAfterCount = (action as modelAction.MedicalCertificatePhysicalHealthActionOK).stateConfig.totalCount;
				...
				break;
			case modelAction.MedicalCertificatePhysicalHealthModelActionTypes.INITIALISE_MEDICAL_CERTIFICATE_PHYSICAL_HEALTH_COLLECTION_STATE:
				const collectionIdToInitialise =  (action as modelAction.MedicalCertificatePhysicalHealthActionOK).stateConfig.collectionId;
				const queryParamsToInitialise = (action as modelAction.MedicalCertificatePhysicalHealthActionOK).stateConfig.queryParams;
				...
				if (!draft[className].collectionState[collectionIdToInitialise]) {
					draft[className].collectionState[collectionIdToInitialise] = {
						...initialMedicalCertificatePhysicalHealthCollectionState
					};
				}
