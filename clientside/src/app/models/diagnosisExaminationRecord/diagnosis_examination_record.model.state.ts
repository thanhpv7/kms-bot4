...
/**
 * DiagnosisExaminationRecordCollectionState would store the state of a collection of DiagnosisExaminationRecord
 */
export interface DiagnosisExaminationRecordCollectionState extends CollectionState {
 ...
 */
export interface DiagnosisExaminationRecordModelAudit extends AbstractModelAudit<DiagnosisExaminationRecordModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * DiagnosisExaminationRecordModelState would store the state of the model
 */
export interface DiagnosisExaminationRecordModelState {
	collectionState: {
		[key: string]: DiagnosisExaminationRecordCollectionState;
	};
	data: {
		[id: string]: DiagnosisExaminationRecordModel;
	};
	totalCount: number;
	audits: DiagnosisExaminationRecordModelAudit[];
 ...
 */
export const initialDiagnosisExaminationRecordCollectionState: DiagnosisExaminationRecordCollectionState = {
...
/**
 * The initial state of DiagnosisExaminationRecordModelState
 */
export const initialState: DiagnosisExaminationRecordModelState = {
	collectionState: {
