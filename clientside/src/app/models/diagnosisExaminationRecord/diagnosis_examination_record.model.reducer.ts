...
import {initialDiagnosisExaminationRecordCollectionState} from './diagnosis_examination_record.model.state';
...
export function modelReducer(currentState: ModelState, action: Action): ModelState {
	...
	const className = (action as modelAction.BaseDiagnosisExaminationRecordAction).className;
	...
	return produce(currentState, draft => {
		...
		switch (action.type) {
			case modelAction.DiagnosisExaminationRecordModelActionTypes.CREATE_DIAGNOSIS_EXAMINATION_RECORD_OK:
				const createdModel = (action as modelAction.DiagnosisExaminationRecordActionOK ).stateConfig.targetModel;
				...
				DiagnosisExaminationRecordModel.deepParse(createdModel).forEach(model => {
				...
				break;
			case modelAction.DiagnosisExaminationRecordModelActionTypes.CREATE_DIAGNOSIS_EXAMINATION_RECORD_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.DiagnosisExaminationRecordModelActionTypes.CREATE_ALL_DIAGNOSIS_EXAMINATION_RECORD_OK:
				const createdModels = (action as modelAction.DiagnosisExaminationRecordActionOK).stateConfig.targetModels;
				const collectionIdAfterCreateAll = (action as modelAction.DiagnosisExaminationRecordActionOK).stateConfig.collectionId;
				...
				createdModels.forEach((m) => {
					DiagnosisExaminationRecordModel.deepParse(m).forEach(model => {
						draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
						(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
					});
				});
				...
				break;
			case modelAction.DiagnosisExaminationRecordModelActionTypes.CREATE_ALL_DIAGNOSIS_EXAMINATION_RECORD_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.DiagnosisExaminationRecordModelActionTypes.DELETE_DIAGNOSIS_EXAMINATION_RECORD_OK:
				const deletedModelId = (action as modelAction.DiagnosisExaminationRecordActionOK).stateConfig.targetModelId;
				const collectionIdAfterDelete = (action as modelAction.DiagnosisExaminationRecordActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.DiagnosisExaminationRecordModelActionTypes.DELETE_ALL_DIAGNOSIS_EXAMINATION_RECORD_OK:
				const deletedModelIds = (action as modelAction.DiagnosisExaminationRecordActionOK).stateConfig.targetModelIds;
				const collectionIdAfterDeleteAll = (action as modelAction.DiagnosisExaminationRecordActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.DiagnosisExaminationRecordModelActionTypes.DELETE_DIAGNOSIS_EXAMINATION_RECORD_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.DiagnosisExaminationRecordModelActionTypes.UPDATE_DIAGNOSIS_EXAMINATION_RECORD_OK:
				const updatedModel = (action as modelAction.DiagnosisExaminationRecordActionOK).stateConfig.targetModel;
				...
				DiagnosisExaminationRecordModel.deepParse(updatedModel).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.DiagnosisExaminationRecordModelActionTypes.UPDATE_DIAGNOSIS_EXAMINATION_RECORD_FAIL:
				// TODO: Add handling of failure
				break;

			case modelAction.DiagnosisExaminationRecordModelActionTypes.UPDATE_ALL_DIAGNOSIS_EXAMINATION_RECORD_OK:
				const updatedModels = (action as modelAction.DiagnosisExaminationRecordActionOK).stateConfig.targetModels;
				const collectionIdAfterUpdateAll = (action as modelAction.DiagnosisExaminationRecordActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.DiagnosisExaminationRecordModelActionTypes.UPDATE_ALL_DIAGNOSIS_EXAMINATION_RECORD_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.DiagnosisExaminationRecordModelActionTypes.FETCH_DIAGNOSIS_EXAMINATION_RECORD_OK:
				let fetchedModel = (action as modelAction.DiagnosisExaminationRecordActionOK).stateConfig.targetModel;
				...
				DiagnosisExaminationRecordModel.deepParse(fetchedModel).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.DiagnosisExaminationRecordModelActionTypes.FETCH_ALL_DIAGNOSIS_EXAMINATION_RECORD_OK:
				const totalCountAfterFetchAll = (action as modelAction.DiagnosisExaminationRecordActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchAll = (action as modelAction.DiagnosisExaminationRecordActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchAll = (action as modelAction.DiagnosisExaminationRecordActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchAll = (action as modelAction.DiagnosisExaminationRecordActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchAll.map(model => DiagnosisExaminationRecordModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.DiagnosisExaminationRecordModelActionTypes.FETCH_DIAGNOSIS_EXAMINATION_RECORD_AUDIT_OK:
				const audits = (action as modelAction.DiagnosisExaminationRecordActionOK).audits;
				...
				break;
			case modelAction.DiagnosisExaminationRecordModelActionTypes.FETCH_DIAGNOSIS_EXAMINATION_RECORD_AUDITS_BY_ENTITY_ID_OK:
				const auditsByEntityId = (action as modelAction.DiagnosisExaminationRecordActionOK).audits;
				...
				break;
			case modelAction.DiagnosisExaminationRecordModelActionTypes.FETCH_DIAGNOSIS_EXAMINATION_RECORD_WITH_QUERY_OK:
				const totalCountAfterFetchWithQuery = (action as modelAction.DiagnosisExaminationRecordActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchWithQuery = (action as modelAction.DiagnosisExaminationRecordActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchWithQuery = (action as modelAction.DiagnosisExaminationRecordActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchWithQuery = (action as modelAction.DiagnosisExaminationRecordActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchWithQuery.map(model => DiagnosisExaminationRecordModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.DiagnosisExaminationRecordModelActionTypes.FETCH_LAST_DIAGNOSIS_EXAMINATION_RECORD_WITH_QUERY_OK:
				const totalCountAfterFetchLastWithQuery = (action as modelAction.DiagnosisExaminationRecordActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchLastWithQuery = (action as modelAction.DiagnosisExaminationRecordActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchLastWithQuery = (action as modelAction.DiagnosisExaminationRecordActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchLastWithQuery = (action as modelAction.DiagnosisExaminationRecordActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchLastWithQuery.map(model => DiagnosisExaminationRecordModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.DiagnosisExaminationRecordModelActionTypes.COUNT_DIAGNOSIS_EXAMINATION_RECORDS_OK:
				const totalCountAfterCount = (action as modelAction.DiagnosisExaminationRecordActionOK).stateConfig.totalCount;
				...
				break;
			case modelAction.DiagnosisExaminationRecordModelActionTypes.INITIALISE_DIAGNOSIS_EXAMINATION_RECORD_COLLECTION_STATE:
				const collectionIdToInitialise =  (action as modelAction.DiagnosisExaminationRecordActionOK).stateConfig.collectionId;
				const queryParamsToInitialise = (action as modelAction.DiagnosisExaminationRecordActionOK).stateConfig.queryParams;
				...
				if (!draft[className].collectionState[collectionIdToInitialise]) {
					draft[className].collectionState[collectionIdToInitialise] = {
						...initialDiagnosisExaminationRecordCollectionState
					};
				}
