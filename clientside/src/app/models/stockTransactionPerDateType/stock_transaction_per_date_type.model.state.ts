...
/**
 * StockTransactionPerDateTypeCollectionState would store the state of a collection of StockTransactionPerDateType
 */
export interface StockTransactionPerDateTypeCollectionState extends CollectionState {
 ...
 */
export interface StockTransactionPerDateTypeModelAudit extends AbstractModelAudit<StockTransactionPerDateTypeModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * StockTransactionPerDateTypeModelState would store the state of the model
 */
export interface StockTransactionPerDateTypeModelState {
	collectionState: {
		[key: string]: StockTransactionPerDateTypeCollectionState;
	};
	data: {
		[id: string]: StockTransactionPerDateTypeModel;
	};
	totalCount: number;
	audits: StockTransactionPerDateTypeModelAudit[];
 ...
 */
export const initialStockTransactionPerDateTypeCollectionState: StockTransactionPerDateTypeCollectionState = {
...
/**
 * The initial state of StockTransactionPerDateTypeModelState
 */
export const initialState: StockTransactionPerDateTypeModelState = {
	collectionState: {
