...
import * as modelAction from './stock_transaction_per_date_type.model.action';
import {StockTransactionPerDateTypeService} from '../../services/stockTransactionPerDateType/stock_transaction_per_date_type.service';
...
/**
 * Effect class used for side effects related to Stock Transaction Per Date Type model.
 */
@Injectable()
export class StockTransactionPerDateTypeEffect {
	...
	constructor(
		...
		protected readonly service: StockTransactionPerDateTypeService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionPerDateTypeAction>(modelAction.StockTransactionPerDateTypeModelActionTypes.COUNT_STOCK_TRANSACTION_PER_DATE_TYPES),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.StockTransactionPerDateTypeActionOK(
						modelAction.StockTransactionPerDateTypeModelActionTypes.COUNT_STOCK_TRANSACTION_PER_DATE_TYPES_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionPerDateTypeActionFail(
								modelAction.StockTransactionPerDateTypeModelActionTypes.COUNT_STOCK_TRANSACTION_PER_DATE_TYPES_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionPerDateTypeAction>(modelAction.StockTransactionPerDateTypeModelActionTypes.FETCH_STOCK_TRANSACTION_PER_DATE_TYPE),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.StockTransactionPerDateTypeActionOK(
						modelAction.StockTransactionPerDateTypeModelActionTypes.FETCH_STOCK_TRANSACTION_PER_DATE_TYPE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionPerDateTypeActionFail(
								modelAction.StockTransactionPerDateTypeModelActionTypes.FETCH_STOCK_TRANSACTION_PER_DATE_TYPE_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionPerDateTypeAction>(modelAction.StockTransactionPerDateTypeModelActionTypes.FETCH_ALL_STOCK_TRANSACTION_PER_DATE_TYPE),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.StockTransactionPerDateTypeActionOK(
						modelAction.StockTransactionPerDateTypeModelActionTypes.FETCH_ALL_STOCK_TRANSACTION_PER_DATE_TYPE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionPerDateTypeActionFail(
								modelAction.StockTransactionPerDateTypeModelActionTypes.FETCH_ALL_STOCK_TRANSACTION_PER_DATE_TYPE_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionPerDateTypeAction>(modelAction.StockTransactionPerDateTypeModelActionTypes.FETCH_STOCK_TRANSACTION_PER_DATE_TYPE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.StockTransactionPerDateTypeActionOK(
						modelAction.StockTransactionPerDateTypeModelActionTypes.FETCH_STOCK_TRANSACTION_PER_DATE_TYPE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionPerDateTypeActionFail(
								modelAction.StockTransactionPerDateTypeModelActionTypes.FETCH_STOCK_TRANSACTION_PER_DATE_TYPE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionPerDateTypeAction>(modelAction.StockTransactionPerDateTypeModelActionTypes.FETCH_LAST_STOCK_TRANSACTION_PER_DATE_TYPE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.StockTransactionPerDateTypeActionOK(
						modelAction.StockTransactionPerDateTypeModelActionTypes.FETCH_LAST_STOCK_TRANSACTION_PER_DATE_TYPE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionPerDateTypeActionFail(
								modelAction.StockTransactionPerDateTypeModelActionTypes.FETCH_LAST_STOCK_TRANSACTION_PER_DATE_TYPE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionPerDateTypeAction>(modelAction.StockTransactionPerDateTypeModelActionTypes.CREATE_STOCK_TRANSACTION_PER_DATE_TYPE),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as StockTransactionPerDateTypeModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.StockTransactionPerDateTypeActionOK(
						modelAction.StockTransactionPerDateTypeModelActionTypes.CREATE_STOCK_TRANSACTION_PER_DATE_TYPE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionPerDateTypeActionFail(
								modelAction.StockTransactionPerDateTypeModelActionTypes.CREATE_STOCK_TRANSACTION_PER_DATE_TYPE_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionPerDateTypeAction>(modelAction.StockTransactionPerDateTypeModelActionTypes.CREATE_ALL_STOCK_TRANSACTION_PER_DATE_TYPE),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as StockTransactionPerDateTypeModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.StockTransactionPerDateTypeActionOK(
						modelAction.StockTransactionPerDateTypeModelActionTypes.CREATE_ALL_STOCK_TRANSACTION_PER_DATE_TYPE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionPerDateTypeActionFail(
								modelAction.StockTransactionPerDateTypeModelActionTypes.CREATE_ALL_STOCK_TRANSACTION_PER_DATE_TYPE_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionPerDateTypeAction>(modelAction.StockTransactionPerDateTypeModelActionTypes.UPDATE_STOCK_TRANSACTION_PER_DATE_TYPE),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as StockTransactionPerDateTypeModel;
				...
				return this.service.update(new StockTransactionPerDateTypeModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.StockTransactionPerDateTypeActionOK(
						modelAction.StockTransactionPerDateTypeModelActionTypes.UPDATE_STOCK_TRANSACTION_PER_DATE_TYPE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionPerDateTypeActionFail(
								modelAction.StockTransactionPerDateTypeModelActionTypes.UPDATE_STOCK_TRANSACTION_PER_DATE_TYPE_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionPerDateTypeAction>(modelAction.StockTransactionPerDateTypeModelActionTypes.UPDATE_ALL_STOCK_TRANSACTION_PER_DATE_TYPE),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as StockTransactionPerDateTypeModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new StockTransactionPerDateTypeModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.StockTransactionPerDateTypeActionOK(
						modelAction.StockTransactionPerDateTypeModelActionTypes.UPDATE_ALL_STOCK_TRANSACTION_PER_DATE_TYPE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionPerDateTypeActionFail(
								modelAction.StockTransactionPerDateTypeModelActionTypes.UPDATE_ALL_STOCK_TRANSACTION_PER_DATE_TYPE_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionPerDateTypeAction>(modelAction.StockTransactionPerDateTypeModelActionTypes.DELETE_STOCK_TRANSACTION_PER_DATE_TYPE),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.StockTransactionPerDateTypeActionOK(
						modelAction.StockTransactionPerDateTypeModelActionTypes.DELETE_STOCK_TRANSACTION_PER_DATE_TYPE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionPerDateTypeActionFail(
								modelAction.StockTransactionPerDateTypeModelActionTypes.DELETE_STOCK_TRANSACTION_PER_DATE_TYPE_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionPerDateTypeAction>(modelAction.StockTransactionPerDateTypeModelActionTypes.DELETE_STOCK_TRANSACTION_PER_DATE_TYPE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.StockTransactionPerDateTypeActionOK(
						modelAction.StockTransactionPerDateTypeModelActionTypes.DELETE_STOCK_TRANSACTION_PER_DATE_TYPE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionPerDateTypeActionFail(
								modelAction.StockTransactionPerDateTypeModelActionTypes.DELETE_STOCK_TRANSACTION_PER_DATE_TYPE_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionPerDateTypeAction>(modelAction.StockTransactionPerDateTypeModelActionTypes.DELETE_ALL_STOCK_TRANSACTION_PER_DATE_TYPE),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.StockTransactionPerDateTypeActionOK(
						modelAction.StockTransactionPerDateTypeModelActionTypes.DELETE_ALL_STOCK_TRANSACTION_PER_DATE_TYPE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionPerDateTypeActionFail(
								modelAction.StockTransactionPerDateTypeModelActionTypes.DELETE_ALL_STOCK_TRANSACTION_PER_DATE_TYPE_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionPerDateTypeAction>(modelAction.StockTransactionPerDateTypeModelActionTypes.EXPORT_STOCK_TRANSACTION_PER_DATE_TYPE),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.StockTransactionPerDateTypeActionOK(
						modelAction.StockTransactionPerDateTypeModelActionTypes.EXPORT_STOCK_TRANSACTION_PER_DATE_TYPE,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionPerDateTypeAction>(modelAction.StockTransactionPerDateTypeModelActionTypes.EXPORT_ALL_STOCK_TRANSACTION_PER_DATE_TYPE),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.StockTransactionPerDateTypeActionOK(
						modelAction.StockTransactionPerDateTypeModelActionTypes.EXPORT_ALL_STOCK_TRANSACTION_PER_DATE_TYPE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionPerDateTypeActionFail(
								modelAction.StockTransactionPerDateTypeModelActionTypes.EXPORT_ALL_STOCK_TRANSACTION_PER_DATE_TYPE_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionPerDateTypeAction>(modelAction.StockTransactionPerDateTypeModelActionTypes.EXPORT_STOCK_TRANSACTION_PER_DATE_TYPE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.StockTransactionPerDateTypeActionOK(
						modelAction.StockTransactionPerDateTypeModelActionTypes.EXPORT_STOCK_TRANSACTION_PER_DATE_TYPE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionPerDateTypeActionFail(
								modelAction.StockTransactionPerDateTypeModelActionTypes.EXPORT_STOCK_TRANSACTION_PER_DATE_TYPE_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionPerDateTypeAction>(modelAction.StockTransactionPerDateTypeModelActionTypes.IMPORT_STOCK_TRANSACTION_PER_DATE_TYPES),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.StockTransactionPerDateTypeActionOK(
						modelAction.StockTransactionPerDateTypeModelActionTypes.IMPORT_STOCK_TRANSACTION_PER_DATE_TYPES_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionPerDateTypeActionFail(
								modelAction.StockTransactionPerDateTypeModelActionTypes.IMPORT_STOCK_TRANSACTION_PER_DATE_TYPES_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionPerDateTypeAction>(modelAction.StockTransactionPerDateTypeModelActionTypes.FETCH_STOCK_TRANSACTION_PER_DATE_TYPE_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.StockTransactionPerDateTypeActionOK(
						modelAction.StockTransactionPerDateTypeModelActionTypes.FETCH_STOCK_TRANSACTION_PER_DATE_TYPE_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionPerDateTypeActionFail(
								modelAction.StockTransactionPerDateTypeModelActionTypes.FETCH_STOCK_TRANSACTION_PER_DATE_TYPE_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionPerDateTypeAction>(modelAction.StockTransactionPerDateTypeModelActionTypes.FETCH_STOCK_TRANSACTION_PER_DATE_TYPE_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.StockTransactionPerDateTypeActionOK(
						modelAction.StockTransactionPerDateTypeModelActionTypes.FETCH_STOCK_TRANSACTION_PER_DATE_TYPE_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionPerDateTypeActionFail(
								modelAction.StockTransactionPerDateTypeModelActionTypes.FETCH_STOCK_TRANSACTION_PER_DATE_TYPE_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
