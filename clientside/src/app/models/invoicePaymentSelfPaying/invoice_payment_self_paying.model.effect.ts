...
import * as modelAction from './invoice_payment_self_paying.model.action';
import {InvoicePaymentSelfPayingService} from '../../services/invoicePaymentSelfPaying/invoice_payment_self_paying.service';
...
/**
 * Effect class used for side effects related to Invoice Payment Self Paying model.
 */
@Injectable()
export class InvoicePaymentSelfPayingEffect {
	...
	constructor(
		...
		protected readonly service: InvoicePaymentSelfPayingService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentSelfPayingAction>(modelAction.InvoicePaymentSelfPayingModelActionTypes.COUNT_INVOICE_PAYMENT_SELF_PAYINGS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.InvoicePaymentSelfPayingActionOK(
						modelAction.InvoicePaymentSelfPayingModelActionTypes.COUNT_INVOICE_PAYMENT_SELF_PAYINGS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentSelfPayingActionFail(
								modelAction.InvoicePaymentSelfPayingModelActionTypes.COUNT_INVOICE_PAYMENT_SELF_PAYINGS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentSelfPayingAction>(modelAction.InvoicePaymentSelfPayingModelActionTypes.FETCH_INVOICE_PAYMENT_SELF_PAYING),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InvoicePaymentSelfPayingActionOK(
						modelAction.InvoicePaymentSelfPayingModelActionTypes.FETCH_INVOICE_PAYMENT_SELF_PAYING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentSelfPayingActionFail(
								modelAction.InvoicePaymentSelfPayingModelActionTypes.FETCH_INVOICE_PAYMENT_SELF_PAYING_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentSelfPayingAction>(modelAction.InvoicePaymentSelfPayingModelActionTypes.FETCH_ALL_INVOICE_PAYMENT_SELF_PAYING),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.InvoicePaymentSelfPayingActionOK(
						modelAction.InvoicePaymentSelfPayingModelActionTypes.FETCH_ALL_INVOICE_PAYMENT_SELF_PAYING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentSelfPayingActionFail(
								modelAction.InvoicePaymentSelfPayingModelActionTypes.FETCH_ALL_INVOICE_PAYMENT_SELF_PAYING_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentSelfPayingAction>(modelAction.InvoicePaymentSelfPayingModelActionTypes.FETCH_INVOICE_PAYMENT_SELF_PAYING_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.InvoicePaymentSelfPayingActionOK(
						modelAction.InvoicePaymentSelfPayingModelActionTypes.FETCH_INVOICE_PAYMENT_SELF_PAYING_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentSelfPayingActionFail(
								modelAction.InvoicePaymentSelfPayingModelActionTypes.FETCH_INVOICE_PAYMENT_SELF_PAYING_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentSelfPayingAction>(modelAction.InvoicePaymentSelfPayingModelActionTypes.FETCH_LAST_INVOICE_PAYMENT_SELF_PAYING_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.InvoicePaymentSelfPayingActionOK(
						modelAction.InvoicePaymentSelfPayingModelActionTypes.FETCH_LAST_INVOICE_PAYMENT_SELF_PAYING_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentSelfPayingActionFail(
								modelAction.InvoicePaymentSelfPayingModelActionTypes.FETCH_LAST_INVOICE_PAYMENT_SELF_PAYING_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentSelfPayingAction>(modelAction.InvoicePaymentSelfPayingModelActionTypes.CREATE_INVOICE_PAYMENT_SELF_PAYING),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as InvoicePaymentSelfPayingModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InvoicePaymentSelfPayingActionOK(
						modelAction.InvoicePaymentSelfPayingModelActionTypes.CREATE_INVOICE_PAYMENT_SELF_PAYING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentSelfPayingActionFail(
								modelAction.InvoicePaymentSelfPayingModelActionTypes.CREATE_INVOICE_PAYMENT_SELF_PAYING_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentSelfPayingAction>(modelAction.InvoicePaymentSelfPayingModelActionTypes.CREATE_ALL_INVOICE_PAYMENT_SELF_PAYING),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as InvoicePaymentSelfPayingModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InvoicePaymentSelfPayingActionOK(
						modelAction.InvoicePaymentSelfPayingModelActionTypes.CREATE_ALL_INVOICE_PAYMENT_SELF_PAYING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentSelfPayingActionFail(
								modelAction.InvoicePaymentSelfPayingModelActionTypes.CREATE_ALL_INVOICE_PAYMENT_SELF_PAYING_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentSelfPayingAction>(modelAction.InvoicePaymentSelfPayingModelActionTypes.UPDATE_INVOICE_PAYMENT_SELF_PAYING),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as InvoicePaymentSelfPayingModel;
				...
				return this.service.update(new InvoicePaymentSelfPayingModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.InvoicePaymentSelfPayingActionOK(
						modelAction.InvoicePaymentSelfPayingModelActionTypes.UPDATE_INVOICE_PAYMENT_SELF_PAYING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentSelfPayingActionFail(
								modelAction.InvoicePaymentSelfPayingModelActionTypes.UPDATE_INVOICE_PAYMENT_SELF_PAYING_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentSelfPayingAction>(modelAction.InvoicePaymentSelfPayingModelActionTypes.UPDATE_ALL_INVOICE_PAYMENT_SELF_PAYING),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as InvoicePaymentSelfPayingModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new InvoicePaymentSelfPayingModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InvoicePaymentSelfPayingActionOK(
						modelAction.InvoicePaymentSelfPayingModelActionTypes.UPDATE_ALL_INVOICE_PAYMENT_SELF_PAYING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentSelfPayingActionFail(
								modelAction.InvoicePaymentSelfPayingModelActionTypes.UPDATE_ALL_INVOICE_PAYMENT_SELF_PAYING_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentSelfPayingAction>(modelAction.InvoicePaymentSelfPayingModelActionTypes.DELETE_INVOICE_PAYMENT_SELF_PAYING),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.InvoicePaymentSelfPayingActionOK(
						modelAction.InvoicePaymentSelfPayingModelActionTypes.DELETE_INVOICE_PAYMENT_SELF_PAYING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentSelfPayingActionFail(
								modelAction.InvoicePaymentSelfPayingModelActionTypes.DELETE_INVOICE_PAYMENT_SELF_PAYING_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentSelfPayingAction>(modelAction.InvoicePaymentSelfPayingModelActionTypes.DELETE_INVOICE_PAYMENT_SELF_PAYING_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.InvoicePaymentSelfPayingActionOK(
						modelAction.InvoicePaymentSelfPayingModelActionTypes.DELETE_INVOICE_PAYMENT_SELF_PAYING_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentSelfPayingActionFail(
								modelAction.InvoicePaymentSelfPayingModelActionTypes.DELETE_INVOICE_PAYMENT_SELF_PAYING_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentSelfPayingAction>(modelAction.InvoicePaymentSelfPayingModelActionTypes.DELETE_ALL_INVOICE_PAYMENT_SELF_PAYING),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.InvoicePaymentSelfPayingActionOK(
						modelAction.InvoicePaymentSelfPayingModelActionTypes.DELETE_ALL_INVOICE_PAYMENT_SELF_PAYING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentSelfPayingActionFail(
								modelAction.InvoicePaymentSelfPayingModelActionTypes.DELETE_ALL_INVOICE_PAYMENT_SELF_PAYING_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentSelfPayingAction>(modelAction.InvoicePaymentSelfPayingModelActionTypes.EXPORT_INVOICE_PAYMENT_SELF_PAYING),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.InvoicePaymentSelfPayingActionOK(
						modelAction.InvoicePaymentSelfPayingModelActionTypes.EXPORT_INVOICE_PAYMENT_SELF_PAYING,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentSelfPayingAction>(modelAction.InvoicePaymentSelfPayingModelActionTypes.EXPORT_ALL_INVOICE_PAYMENT_SELF_PAYING),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.InvoicePaymentSelfPayingActionOK(
						modelAction.InvoicePaymentSelfPayingModelActionTypes.EXPORT_ALL_INVOICE_PAYMENT_SELF_PAYING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentSelfPayingActionFail(
								modelAction.InvoicePaymentSelfPayingModelActionTypes.EXPORT_ALL_INVOICE_PAYMENT_SELF_PAYING_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentSelfPayingAction>(modelAction.InvoicePaymentSelfPayingModelActionTypes.EXPORT_INVOICE_PAYMENT_SELF_PAYING_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.InvoicePaymentSelfPayingActionOK(
						modelAction.InvoicePaymentSelfPayingModelActionTypes.EXPORT_INVOICE_PAYMENT_SELF_PAYING_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentSelfPayingActionFail(
								modelAction.InvoicePaymentSelfPayingModelActionTypes.EXPORT_INVOICE_PAYMENT_SELF_PAYING_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentSelfPayingAction>(modelAction.InvoicePaymentSelfPayingModelActionTypes.IMPORT_INVOICE_PAYMENT_SELF_PAYINGS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.InvoicePaymentSelfPayingActionOK(
						modelAction.InvoicePaymentSelfPayingModelActionTypes.IMPORT_INVOICE_PAYMENT_SELF_PAYINGS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentSelfPayingActionFail(
								modelAction.InvoicePaymentSelfPayingModelActionTypes.IMPORT_INVOICE_PAYMENT_SELF_PAYINGS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentSelfPayingAction>(modelAction.InvoicePaymentSelfPayingModelActionTypes.FETCH_INVOICE_PAYMENT_SELF_PAYING_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.InvoicePaymentSelfPayingActionOK(
						modelAction.InvoicePaymentSelfPayingModelActionTypes.FETCH_INVOICE_PAYMENT_SELF_PAYING_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentSelfPayingActionFail(
								modelAction.InvoicePaymentSelfPayingModelActionTypes.FETCH_INVOICE_PAYMENT_SELF_PAYING_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentSelfPayingAction>(modelAction.InvoicePaymentSelfPayingModelActionTypes.FETCH_INVOICE_PAYMENT_SELF_PAYING_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.InvoicePaymentSelfPayingActionOK(
						modelAction.InvoicePaymentSelfPayingModelActionTypes.FETCH_INVOICE_PAYMENT_SELF_PAYING_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentSelfPayingActionFail(
								modelAction.InvoicePaymentSelfPayingModelActionTypes.FETCH_INVOICE_PAYMENT_SELF_PAYING_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
