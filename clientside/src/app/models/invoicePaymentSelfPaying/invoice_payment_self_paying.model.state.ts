...
/**
 * InvoicePaymentSelfPayingCollectionState would store the state of a collection of InvoicePaymentSelfPaying
 */
export interface InvoicePaymentSelfPayingCollectionState extends CollectionState {
 ...
 */
export interface InvoicePaymentSelfPayingModelAudit extends AbstractModelAudit<InvoicePaymentSelfPayingModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * InvoicePaymentSelfPayingModelState would store the state of the model
 */
export interface InvoicePaymentSelfPayingModelState {
	collectionState: {
		[key: string]: InvoicePaymentSelfPayingCollectionState;
	};
	data: {
		[id: string]: InvoicePaymentSelfPayingModel;
	};
	totalCount: number;
	audits: InvoicePaymentSelfPayingModelAudit[];
 ...
 */
export const initialInvoicePaymentSelfPayingCollectionState: InvoicePaymentSelfPayingCollectionState = {
...
/**
 * The initial state of InvoicePaymentSelfPayingModelState
 */
export const initialState: InvoicePaymentSelfPayingModelState = {
	collectionState: {
