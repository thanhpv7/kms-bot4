...
/**
 * PatientVisitPatientPaymentInsuranceCollectionState would store the state of a collection of PatientVisitPatientPaymentInsurance
 */
export interface PatientVisitPatientPaymentInsuranceCollectionState extends CollectionState {
 ...
 */
export interface PatientVisitPatientPaymentInsuranceModelAudit extends AbstractModelAudit<PatientVisitPatientPaymentInsuranceModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * PatientVisitPatientPaymentInsuranceModelState would store the state of the model
 */
export interface PatientVisitPatientPaymentInsuranceModelState {
	collectionState: {
		[key: string]: PatientVisitPatientPaymentInsuranceCollectionState;
	};
	data: {
		[id: string]: PatientVisitPatientPaymentInsuranceModel;
	};
	totalCount: number;
	audits: PatientVisitPatientPaymentInsuranceModelAudit[];
 ...
 */
export const initialPatientVisitPatientPaymentInsuranceCollectionState: PatientVisitPatientPaymentInsuranceCollectionState = {
...
/**
 * The initial state of PatientVisitPatientPaymentInsuranceModelState
 */
export const initialState: PatientVisitPatientPaymentInsuranceModelState = {
	collectionState: {
