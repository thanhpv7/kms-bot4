...
/**
 * PcareCompoundDrugCollectionState would store the state of a collection of PcareCompoundDrug
 */
export interface PcareCompoundDrugCollectionState extends CollectionState {
 ...
 */
export interface PcareCompoundDrugModelAudit extends AbstractModelAudit<PcareCompoundDrugModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * PcareCompoundDrugModelState would store the state of the model
 */
export interface PcareCompoundDrugModelState {
	collectionState: {
		[key: string]: PcareCompoundDrugCollectionState;
	};
	data: {
		[id: string]: PcareCompoundDrugModel;
	};
	totalCount: number;
	audits: PcareCompoundDrugModelAudit[];
 ...
 */
export const initialPcareCompoundDrugCollectionState: PcareCompoundDrugCollectionState = {
...
/**
 * The initial state of PcareCompoundDrugModelState
 */
export const initialState: PcareCompoundDrugModelState = {
	collectionState: {
