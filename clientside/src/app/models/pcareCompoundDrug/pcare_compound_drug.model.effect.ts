...
import * as modelAction from './pcare_compound_drug.model.action';
import {PcareCompoundDrugService} from '../../services/pcareCompoundDrug/pcare_compound_drug.service';
...
/**
 * Effect class used for side effects related to PCare Compound Drug model.
 */
@Injectable()
export class PcareCompoundDrugEffect {
	...
	constructor(
		...
		protected readonly service: PcareCompoundDrugService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareCompoundDrugAction>(modelAction.PcareCompoundDrugModelActionTypes.COUNT_PCARE_COMPOUND_DRUGS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.PcareCompoundDrugActionOK(
						modelAction.PcareCompoundDrugModelActionTypes.COUNT_PCARE_COMPOUND_DRUGS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareCompoundDrugActionFail(
								modelAction.PcareCompoundDrugModelActionTypes.COUNT_PCARE_COMPOUND_DRUGS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareCompoundDrugAction>(modelAction.PcareCompoundDrugModelActionTypes.FETCH_PCARE_COMPOUND_DRUG),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareCompoundDrugActionOK(
						modelAction.PcareCompoundDrugModelActionTypes.FETCH_PCARE_COMPOUND_DRUG_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareCompoundDrugActionFail(
								modelAction.PcareCompoundDrugModelActionTypes.FETCH_PCARE_COMPOUND_DRUG_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareCompoundDrugAction>(modelAction.PcareCompoundDrugModelActionTypes.FETCH_ALL_PCARE_COMPOUND_DRUG),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.PcareCompoundDrugActionOK(
						modelAction.PcareCompoundDrugModelActionTypes.FETCH_ALL_PCARE_COMPOUND_DRUG_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareCompoundDrugActionFail(
								modelAction.PcareCompoundDrugModelActionTypes.FETCH_ALL_PCARE_COMPOUND_DRUG_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareCompoundDrugAction>(modelAction.PcareCompoundDrugModelActionTypes.FETCH_PCARE_COMPOUND_DRUG_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareCompoundDrugActionOK(
						modelAction.PcareCompoundDrugModelActionTypes.FETCH_PCARE_COMPOUND_DRUG_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareCompoundDrugActionFail(
								modelAction.PcareCompoundDrugModelActionTypes.FETCH_PCARE_COMPOUND_DRUG_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareCompoundDrugAction>(modelAction.PcareCompoundDrugModelActionTypes.FETCH_LAST_PCARE_COMPOUND_DRUG_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareCompoundDrugActionOK(
						modelAction.PcareCompoundDrugModelActionTypes.FETCH_LAST_PCARE_COMPOUND_DRUG_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareCompoundDrugActionFail(
								modelAction.PcareCompoundDrugModelActionTypes.FETCH_LAST_PCARE_COMPOUND_DRUG_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareCompoundDrugAction>(modelAction.PcareCompoundDrugModelActionTypes.CREATE_PCARE_COMPOUND_DRUG),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as PcareCompoundDrugModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareCompoundDrugActionOK(
						modelAction.PcareCompoundDrugModelActionTypes.CREATE_PCARE_COMPOUND_DRUG_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareCompoundDrugActionFail(
								modelAction.PcareCompoundDrugModelActionTypes.CREATE_PCARE_COMPOUND_DRUG_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareCompoundDrugAction>(modelAction.PcareCompoundDrugModelActionTypes.CREATE_ALL_PCARE_COMPOUND_DRUG),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as PcareCompoundDrugModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareCompoundDrugActionOK(
						modelAction.PcareCompoundDrugModelActionTypes.CREATE_ALL_PCARE_COMPOUND_DRUG_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareCompoundDrugActionFail(
								modelAction.PcareCompoundDrugModelActionTypes.CREATE_ALL_PCARE_COMPOUND_DRUG_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareCompoundDrugAction>(modelAction.PcareCompoundDrugModelActionTypes.UPDATE_PCARE_COMPOUND_DRUG),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as PcareCompoundDrugModel;
				...
				return this.service.update(new PcareCompoundDrugModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareCompoundDrugActionOK(
						modelAction.PcareCompoundDrugModelActionTypes.UPDATE_PCARE_COMPOUND_DRUG_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareCompoundDrugActionFail(
								modelAction.PcareCompoundDrugModelActionTypes.UPDATE_PCARE_COMPOUND_DRUG_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareCompoundDrugAction>(modelAction.PcareCompoundDrugModelActionTypes.UPDATE_ALL_PCARE_COMPOUND_DRUG),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as PcareCompoundDrugModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new PcareCompoundDrugModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareCompoundDrugActionOK(
						modelAction.PcareCompoundDrugModelActionTypes.UPDATE_ALL_PCARE_COMPOUND_DRUG_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareCompoundDrugActionFail(
								modelAction.PcareCompoundDrugModelActionTypes.UPDATE_ALL_PCARE_COMPOUND_DRUG_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareCompoundDrugAction>(modelAction.PcareCompoundDrugModelActionTypes.DELETE_PCARE_COMPOUND_DRUG),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PcareCompoundDrugActionOK(
						modelAction.PcareCompoundDrugModelActionTypes.DELETE_PCARE_COMPOUND_DRUG_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareCompoundDrugActionFail(
								modelAction.PcareCompoundDrugModelActionTypes.DELETE_PCARE_COMPOUND_DRUG_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareCompoundDrugAction>(modelAction.PcareCompoundDrugModelActionTypes.DELETE_PCARE_COMPOUND_DRUG_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.PcareCompoundDrugActionOK(
						modelAction.PcareCompoundDrugModelActionTypes.DELETE_PCARE_COMPOUND_DRUG_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareCompoundDrugActionFail(
								modelAction.PcareCompoundDrugModelActionTypes.DELETE_PCARE_COMPOUND_DRUG_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareCompoundDrugAction>(modelAction.PcareCompoundDrugModelActionTypes.DELETE_ALL_PCARE_COMPOUND_DRUG),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PcareCompoundDrugActionOK(
						modelAction.PcareCompoundDrugModelActionTypes.DELETE_ALL_PCARE_COMPOUND_DRUG_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareCompoundDrugActionFail(
								modelAction.PcareCompoundDrugModelActionTypes.DELETE_ALL_PCARE_COMPOUND_DRUG_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareCompoundDrugAction>(modelAction.PcareCompoundDrugModelActionTypes.EXPORT_PCARE_COMPOUND_DRUG),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PcareCompoundDrugActionOK(
						modelAction.PcareCompoundDrugModelActionTypes.EXPORT_PCARE_COMPOUND_DRUG,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareCompoundDrugAction>(modelAction.PcareCompoundDrugModelActionTypes.EXPORT_ALL_PCARE_COMPOUND_DRUG),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PcareCompoundDrugActionOK(
						modelAction.PcareCompoundDrugModelActionTypes.EXPORT_ALL_PCARE_COMPOUND_DRUG_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareCompoundDrugActionFail(
								modelAction.PcareCompoundDrugModelActionTypes.EXPORT_ALL_PCARE_COMPOUND_DRUG_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareCompoundDrugAction>(modelAction.PcareCompoundDrugModelActionTypes.EXPORT_PCARE_COMPOUND_DRUG_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PcareCompoundDrugActionOK(
						modelAction.PcareCompoundDrugModelActionTypes.EXPORT_PCARE_COMPOUND_DRUG_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareCompoundDrugActionFail(
								modelAction.PcareCompoundDrugModelActionTypes.EXPORT_PCARE_COMPOUND_DRUG_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareCompoundDrugAction>(modelAction.PcareCompoundDrugModelActionTypes.IMPORT_PCARE_COMPOUND_DRUGS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.PcareCompoundDrugActionOK(
						modelAction.PcareCompoundDrugModelActionTypes.IMPORT_PCARE_COMPOUND_DRUGS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareCompoundDrugActionFail(
								modelAction.PcareCompoundDrugModelActionTypes.IMPORT_PCARE_COMPOUND_DRUGS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareCompoundDrugAction>(modelAction.PcareCompoundDrugModelActionTypes.FETCH_PCARE_COMPOUND_DRUG_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.PcareCompoundDrugActionOK(
						modelAction.PcareCompoundDrugModelActionTypes.FETCH_PCARE_COMPOUND_DRUG_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PcareCompoundDrugActionFail(
								modelAction.PcareCompoundDrugModelActionTypes.FETCH_PCARE_COMPOUND_DRUG_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareCompoundDrugAction>(modelAction.PcareCompoundDrugModelActionTypes.FETCH_PCARE_COMPOUND_DRUG_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.PcareCompoundDrugActionOK(
						modelAction.PcareCompoundDrugModelActionTypes.FETCH_PCARE_COMPOUND_DRUG_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PcareCompoundDrugActionFail(
								modelAction.PcareCompoundDrugModelActionTypes.FETCH_PCARE_COMPOUND_DRUG_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
