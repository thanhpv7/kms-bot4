...
import * as modelAction from './transaction_detail_type.model.action';
import {TransactionDetailTypeService} from '../../services/transactionDetailType/transaction_detail_type.service';
...
/**
 * Effect class used for side effects related to Transaction Detail Type model.
 */
@Injectable()
export class TransactionDetailTypeEffect {
	...
	constructor(
		...
		protected readonly service: TransactionDetailTypeService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransactionDetailTypeAction>(modelAction.TransactionDetailTypeModelActionTypes.COUNT_TRANSACTION_DETAIL_TYPES),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.TransactionDetailTypeActionOK(
						modelAction.TransactionDetailTypeModelActionTypes.COUNT_TRANSACTION_DETAIL_TYPES_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TransactionDetailTypeActionFail(
								modelAction.TransactionDetailTypeModelActionTypes.COUNT_TRANSACTION_DETAIL_TYPES_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransactionDetailTypeAction>(modelAction.TransactionDetailTypeModelActionTypes.FETCH_TRANSACTION_DETAIL_TYPE),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.TransactionDetailTypeActionOK(
						modelAction.TransactionDetailTypeModelActionTypes.FETCH_TRANSACTION_DETAIL_TYPE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TransactionDetailTypeActionFail(
								modelAction.TransactionDetailTypeModelActionTypes.FETCH_TRANSACTION_DETAIL_TYPE_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransactionDetailTypeAction>(modelAction.TransactionDetailTypeModelActionTypes.FETCH_ALL_TRANSACTION_DETAIL_TYPE),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.TransactionDetailTypeActionOK(
						modelAction.TransactionDetailTypeModelActionTypes.FETCH_ALL_TRANSACTION_DETAIL_TYPE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TransactionDetailTypeActionFail(
								modelAction.TransactionDetailTypeModelActionTypes.FETCH_ALL_TRANSACTION_DETAIL_TYPE_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransactionDetailTypeAction>(modelAction.TransactionDetailTypeModelActionTypes.FETCH_TRANSACTION_DETAIL_TYPE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.TransactionDetailTypeActionOK(
						modelAction.TransactionDetailTypeModelActionTypes.FETCH_TRANSACTION_DETAIL_TYPE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TransactionDetailTypeActionFail(
								modelAction.TransactionDetailTypeModelActionTypes.FETCH_TRANSACTION_DETAIL_TYPE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransactionDetailTypeAction>(modelAction.TransactionDetailTypeModelActionTypes.FETCH_LAST_TRANSACTION_DETAIL_TYPE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.TransactionDetailTypeActionOK(
						modelAction.TransactionDetailTypeModelActionTypes.FETCH_LAST_TRANSACTION_DETAIL_TYPE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TransactionDetailTypeActionFail(
								modelAction.TransactionDetailTypeModelActionTypes.FETCH_LAST_TRANSACTION_DETAIL_TYPE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransactionDetailTypeAction>(modelAction.TransactionDetailTypeModelActionTypes.CREATE_TRANSACTION_DETAIL_TYPE),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as TransactionDetailTypeModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.TransactionDetailTypeActionOK(
						modelAction.TransactionDetailTypeModelActionTypes.CREATE_TRANSACTION_DETAIL_TYPE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TransactionDetailTypeActionFail(
								modelAction.TransactionDetailTypeModelActionTypes.CREATE_TRANSACTION_DETAIL_TYPE_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransactionDetailTypeAction>(modelAction.TransactionDetailTypeModelActionTypes.CREATE_ALL_TRANSACTION_DETAIL_TYPE),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as TransactionDetailTypeModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.TransactionDetailTypeActionOK(
						modelAction.TransactionDetailTypeModelActionTypes.CREATE_ALL_TRANSACTION_DETAIL_TYPE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TransactionDetailTypeActionFail(
								modelAction.TransactionDetailTypeModelActionTypes.CREATE_ALL_TRANSACTION_DETAIL_TYPE_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransactionDetailTypeAction>(modelAction.TransactionDetailTypeModelActionTypes.UPDATE_TRANSACTION_DETAIL_TYPE),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as TransactionDetailTypeModel;
				...
				return this.service.update(new TransactionDetailTypeModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.TransactionDetailTypeActionOK(
						modelAction.TransactionDetailTypeModelActionTypes.UPDATE_TRANSACTION_DETAIL_TYPE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TransactionDetailTypeActionFail(
								modelAction.TransactionDetailTypeModelActionTypes.UPDATE_TRANSACTION_DETAIL_TYPE_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransactionDetailTypeAction>(modelAction.TransactionDetailTypeModelActionTypes.UPDATE_ALL_TRANSACTION_DETAIL_TYPE),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as TransactionDetailTypeModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new TransactionDetailTypeModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.TransactionDetailTypeActionOK(
						modelAction.TransactionDetailTypeModelActionTypes.UPDATE_ALL_TRANSACTION_DETAIL_TYPE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TransactionDetailTypeActionFail(
								modelAction.TransactionDetailTypeModelActionTypes.UPDATE_ALL_TRANSACTION_DETAIL_TYPE_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransactionDetailTypeAction>(modelAction.TransactionDetailTypeModelActionTypes.DELETE_TRANSACTION_DETAIL_TYPE),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.TransactionDetailTypeActionOK(
						modelAction.TransactionDetailTypeModelActionTypes.DELETE_TRANSACTION_DETAIL_TYPE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TransactionDetailTypeActionFail(
								modelAction.TransactionDetailTypeModelActionTypes.DELETE_TRANSACTION_DETAIL_TYPE_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransactionDetailTypeAction>(modelAction.TransactionDetailTypeModelActionTypes.DELETE_TRANSACTION_DETAIL_TYPE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.TransactionDetailTypeActionOK(
						modelAction.TransactionDetailTypeModelActionTypes.DELETE_TRANSACTION_DETAIL_TYPE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TransactionDetailTypeActionFail(
								modelAction.TransactionDetailTypeModelActionTypes.DELETE_TRANSACTION_DETAIL_TYPE_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransactionDetailTypeAction>(modelAction.TransactionDetailTypeModelActionTypes.DELETE_ALL_TRANSACTION_DETAIL_TYPE),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.TransactionDetailTypeActionOK(
						modelAction.TransactionDetailTypeModelActionTypes.DELETE_ALL_TRANSACTION_DETAIL_TYPE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TransactionDetailTypeActionFail(
								modelAction.TransactionDetailTypeModelActionTypes.DELETE_ALL_TRANSACTION_DETAIL_TYPE_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransactionDetailTypeAction>(modelAction.TransactionDetailTypeModelActionTypes.EXPORT_TRANSACTION_DETAIL_TYPE),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.TransactionDetailTypeActionOK(
						modelAction.TransactionDetailTypeModelActionTypes.EXPORT_TRANSACTION_DETAIL_TYPE,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransactionDetailTypeAction>(modelAction.TransactionDetailTypeModelActionTypes.EXPORT_ALL_TRANSACTION_DETAIL_TYPE),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.TransactionDetailTypeActionOK(
						modelAction.TransactionDetailTypeModelActionTypes.EXPORT_ALL_TRANSACTION_DETAIL_TYPE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TransactionDetailTypeActionFail(
								modelAction.TransactionDetailTypeModelActionTypes.EXPORT_ALL_TRANSACTION_DETAIL_TYPE_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransactionDetailTypeAction>(modelAction.TransactionDetailTypeModelActionTypes.EXPORT_TRANSACTION_DETAIL_TYPE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.TransactionDetailTypeActionOK(
						modelAction.TransactionDetailTypeModelActionTypes.EXPORT_TRANSACTION_DETAIL_TYPE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TransactionDetailTypeActionFail(
								modelAction.TransactionDetailTypeModelActionTypes.EXPORT_TRANSACTION_DETAIL_TYPE_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransactionDetailTypeAction>(modelAction.TransactionDetailTypeModelActionTypes.IMPORT_TRANSACTION_DETAIL_TYPES),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.TransactionDetailTypeActionOK(
						modelAction.TransactionDetailTypeModelActionTypes.IMPORT_TRANSACTION_DETAIL_TYPES_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TransactionDetailTypeActionFail(
								modelAction.TransactionDetailTypeModelActionTypes.IMPORT_TRANSACTION_DETAIL_TYPES_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransactionDetailTypeAction>(modelAction.TransactionDetailTypeModelActionTypes.FETCH_TRANSACTION_DETAIL_TYPE_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.TransactionDetailTypeActionOK(
						modelAction.TransactionDetailTypeModelActionTypes.FETCH_TRANSACTION_DETAIL_TYPE_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.TransactionDetailTypeActionFail(
								modelAction.TransactionDetailTypeModelActionTypes.FETCH_TRANSACTION_DETAIL_TYPE_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransactionDetailTypeAction>(modelAction.TransactionDetailTypeModelActionTypes.FETCH_TRANSACTION_DETAIL_TYPE_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.TransactionDetailTypeActionOK(
						modelAction.TransactionDetailTypeModelActionTypes.FETCH_TRANSACTION_DETAIL_TYPE_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.TransactionDetailTypeActionFail(
								modelAction.TransactionDetailTypeModelActionTypes.FETCH_TRANSACTION_DETAIL_TYPE_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
