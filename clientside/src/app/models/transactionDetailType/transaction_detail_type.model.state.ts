...
/**
 * TransactionDetailTypeCollectionState would store the state of a collection of TransactionDetailType
 */
export interface TransactionDetailTypeCollectionState extends CollectionState {
 ...
 */
export interface TransactionDetailTypeModelAudit extends AbstractModelAudit<TransactionDetailTypeModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * TransactionDetailTypeModelState would store the state of the model
 */
export interface TransactionDetailTypeModelState {
	collectionState: {
		[key: string]: TransactionDetailTypeCollectionState;
	};
	data: {
		[id: string]: TransactionDetailTypeModel;
	};
	totalCount: number;
	audits: TransactionDetailTypeModelAudit[];
 ...
 */
export const initialTransactionDetailTypeCollectionState: TransactionDetailTypeCollectionState = {
...
/**
 * The initial state of TransactionDetailTypeModelState
 */
export const initialState: TransactionDetailTypeModelState = {
	collectionState: {
