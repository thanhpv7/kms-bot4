...
/**
 * HealthFacilityCollectionState would store the state of a collection of HealthFacility
 */
export interface HealthFacilityCollectionState extends CollectionState {
 ...
 */
export interface HealthFacilityModelAudit extends AbstractModelAudit<HealthFacilityModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * HealthFacilityModelState would store the state of the model
 */
export interface HealthFacilityModelState {
	collectionState: {
		[key: string]: HealthFacilityCollectionState;
	};
	data: {
		[id: string]: HealthFacilityModel;
	};
	totalCount: number;
	audits: HealthFacilityModelAudit[];
 ...
 */
export const initialHealthFacilityCollectionState: HealthFacilityCollectionState = {
...
/**
 * The initial state of HealthFacilityModelState
 */
export const initialState: HealthFacilityModelState = {
	collectionState: {
