...
import * as modelAction from './bpjs_facility_list.model.action';
import {BpjsFacilityListService} from '../../services/bpjsFacilityList/bpjs_facility_list.service';
...
/**
 * Effect class used for side effects related to BPJS Facility List model.
 */
@Injectable()
export class BpjsFacilityListEffect {
	...
	constructor(
		...
		protected readonly service: BpjsFacilityListService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsFacilityListAction>(modelAction.BpjsFacilityListModelActionTypes.COUNT_BPJS_FACILITY_LISTS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsFacilityListActionOK(
						modelAction.BpjsFacilityListModelActionTypes.COUNT_BPJS_FACILITY_LISTS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsFacilityListActionFail(
								modelAction.BpjsFacilityListModelActionTypes.COUNT_BPJS_FACILITY_LISTS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsFacilityListAction>(modelAction.BpjsFacilityListModelActionTypes.FETCH_BPJS_FACILITY_LIST),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsFacilityListActionOK(
						modelAction.BpjsFacilityListModelActionTypes.FETCH_BPJS_FACILITY_LIST_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsFacilityListActionFail(
								modelAction.BpjsFacilityListModelActionTypes.FETCH_BPJS_FACILITY_LIST_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsFacilityListAction>(modelAction.BpjsFacilityListModelActionTypes.FETCH_ALL_BPJS_FACILITY_LIST),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsFacilityListActionOK(
						modelAction.BpjsFacilityListModelActionTypes.FETCH_ALL_BPJS_FACILITY_LIST_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsFacilityListActionFail(
								modelAction.BpjsFacilityListModelActionTypes.FETCH_ALL_BPJS_FACILITY_LIST_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsFacilityListAction>(modelAction.BpjsFacilityListModelActionTypes.FETCH_BPJS_FACILITY_LIST_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsFacilityListActionOK(
						modelAction.BpjsFacilityListModelActionTypes.FETCH_BPJS_FACILITY_LIST_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsFacilityListActionFail(
								modelAction.BpjsFacilityListModelActionTypes.FETCH_BPJS_FACILITY_LIST_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsFacilityListAction>(modelAction.BpjsFacilityListModelActionTypes.FETCH_LAST_BPJS_FACILITY_LIST_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsFacilityListActionOK(
						modelAction.BpjsFacilityListModelActionTypes.FETCH_LAST_BPJS_FACILITY_LIST_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsFacilityListActionFail(
								modelAction.BpjsFacilityListModelActionTypes.FETCH_LAST_BPJS_FACILITY_LIST_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsFacilityListAction>(modelAction.BpjsFacilityListModelActionTypes.CREATE_BPJS_FACILITY_LIST),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsFacilityListModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsFacilityListActionOK(
						modelAction.BpjsFacilityListModelActionTypes.CREATE_BPJS_FACILITY_LIST_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsFacilityListActionFail(
								modelAction.BpjsFacilityListModelActionTypes.CREATE_BPJS_FACILITY_LIST_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsFacilityListAction>(modelAction.BpjsFacilityListModelActionTypes.CREATE_ALL_BPJS_FACILITY_LIST),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsFacilityListModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsFacilityListActionOK(
						modelAction.BpjsFacilityListModelActionTypes.CREATE_ALL_BPJS_FACILITY_LIST_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsFacilityListActionFail(
								modelAction.BpjsFacilityListModelActionTypes.CREATE_ALL_BPJS_FACILITY_LIST_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsFacilityListAction>(modelAction.BpjsFacilityListModelActionTypes.UPDATE_BPJS_FACILITY_LIST),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsFacilityListModel;
				...
				return this.service.update(new BpjsFacilityListModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsFacilityListActionOK(
						modelAction.BpjsFacilityListModelActionTypes.UPDATE_BPJS_FACILITY_LIST_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsFacilityListActionFail(
								modelAction.BpjsFacilityListModelActionTypes.UPDATE_BPJS_FACILITY_LIST_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsFacilityListAction>(modelAction.BpjsFacilityListModelActionTypes.UPDATE_ALL_BPJS_FACILITY_LIST),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsFacilityListModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsFacilityListModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsFacilityListActionOK(
						modelAction.BpjsFacilityListModelActionTypes.UPDATE_ALL_BPJS_FACILITY_LIST_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsFacilityListActionFail(
								modelAction.BpjsFacilityListModelActionTypes.UPDATE_ALL_BPJS_FACILITY_LIST_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsFacilityListAction>(modelAction.BpjsFacilityListModelActionTypes.DELETE_BPJS_FACILITY_LIST),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsFacilityListActionOK(
						modelAction.BpjsFacilityListModelActionTypes.DELETE_BPJS_FACILITY_LIST_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsFacilityListActionFail(
								modelAction.BpjsFacilityListModelActionTypes.DELETE_BPJS_FACILITY_LIST_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsFacilityListAction>(modelAction.BpjsFacilityListModelActionTypes.DELETE_BPJS_FACILITY_LIST_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsFacilityListActionOK(
						modelAction.BpjsFacilityListModelActionTypes.DELETE_BPJS_FACILITY_LIST_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsFacilityListActionFail(
								modelAction.BpjsFacilityListModelActionTypes.DELETE_BPJS_FACILITY_LIST_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsFacilityListAction>(modelAction.BpjsFacilityListModelActionTypes.DELETE_ALL_BPJS_FACILITY_LIST),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsFacilityListActionOK(
						modelAction.BpjsFacilityListModelActionTypes.DELETE_ALL_BPJS_FACILITY_LIST_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsFacilityListActionFail(
								modelAction.BpjsFacilityListModelActionTypes.DELETE_ALL_BPJS_FACILITY_LIST_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsFacilityListAction>(modelAction.BpjsFacilityListModelActionTypes.EXPORT_BPJS_FACILITY_LIST),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsFacilityListActionOK(
						modelAction.BpjsFacilityListModelActionTypes.EXPORT_BPJS_FACILITY_LIST,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsFacilityListAction>(modelAction.BpjsFacilityListModelActionTypes.EXPORT_ALL_BPJS_FACILITY_LIST),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsFacilityListActionOK(
						modelAction.BpjsFacilityListModelActionTypes.EXPORT_ALL_BPJS_FACILITY_LIST_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsFacilityListActionFail(
								modelAction.BpjsFacilityListModelActionTypes.EXPORT_ALL_BPJS_FACILITY_LIST_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsFacilityListAction>(modelAction.BpjsFacilityListModelActionTypes.EXPORT_BPJS_FACILITY_LIST_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsFacilityListActionOK(
						modelAction.BpjsFacilityListModelActionTypes.EXPORT_BPJS_FACILITY_LIST_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsFacilityListActionFail(
								modelAction.BpjsFacilityListModelActionTypes.EXPORT_BPJS_FACILITY_LIST_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsFacilityListAction>(modelAction.BpjsFacilityListModelActionTypes.IMPORT_BPJS_FACILITY_LISTS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsFacilityListActionOK(
						modelAction.BpjsFacilityListModelActionTypes.IMPORT_BPJS_FACILITY_LISTS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsFacilityListActionFail(
								modelAction.BpjsFacilityListModelActionTypes.IMPORT_BPJS_FACILITY_LISTS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsFacilityListAction>(modelAction.BpjsFacilityListModelActionTypes.FETCH_BPJS_FACILITY_LIST_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsFacilityListActionOK(
						modelAction.BpjsFacilityListModelActionTypes.FETCH_BPJS_FACILITY_LIST_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsFacilityListActionFail(
								modelAction.BpjsFacilityListModelActionTypes.FETCH_BPJS_FACILITY_LIST_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsFacilityListAction>(modelAction.BpjsFacilityListModelActionTypes.FETCH_BPJS_FACILITY_LIST_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsFacilityListActionOK(
						modelAction.BpjsFacilityListModelActionTypes.FETCH_BPJS_FACILITY_LIST_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsFacilityListActionFail(
								modelAction.BpjsFacilityListModelActionTypes.FETCH_BPJS_FACILITY_LIST_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
