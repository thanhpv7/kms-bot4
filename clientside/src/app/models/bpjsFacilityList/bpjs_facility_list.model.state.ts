...
/**
 * BpjsFacilityListCollectionState would store the state of a collection of BpjsFacilityList
 */
export interface BpjsFacilityListCollectionState extends CollectionState {
 ...
 */
export interface BpjsFacilityListModelAudit extends AbstractModelAudit<BpjsFacilityListModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsFacilityListModelState would store the state of the model
 */
export interface BpjsFacilityListModelState {
	collectionState: {
		[key: string]: BpjsFacilityListCollectionState;
	};
	data: {
		[id: string]: BpjsFacilityListModel;
	};
	totalCount: number;
	audits: BpjsFacilityListModelAudit[];
 ...
 */
export const initialBpjsFacilityListCollectionState: BpjsFacilityListCollectionState = {
...
/**
 * The initial state of BpjsFacilityListModelState
 */
export const initialState: BpjsFacilityListModelState = {
	collectionState: {
