...
/**
 * BpjsJasaRaharjaClaimCollectionState would store the state of a collection of BpjsJasaRaharjaClaim
 */
export interface BpjsJasaRaharjaClaimCollectionState extends CollectionState {
 ...
 */
export interface BpjsJasaRaharjaClaimModelAudit extends AbstractModelAudit<BpjsJasaRaharjaClaimModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsJasaRaharjaClaimModelState would store the state of the model
 */
export interface BpjsJasaRaharjaClaimModelState {
	collectionState: {
		[key: string]: BpjsJasaRaharjaClaimCollectionState;
	};
	data: {
		[id: string]: BpjsJasaRaharjaClaimModel;
	};
	totalCount: number;
	audits: BpjsJasaRaharjaClaimModelAudit[];
 ...
 */
export const initialBpjsJasaRaharjaClaimCollectionState: BpjsJasaRaharjaClaimCollectionState = {
...
/**
 * The initial state of BpjsJasaRaharjaClaimModelState
 */
export const initialState: BpjsJasaRaharjaClaimModelState = {
	collectionState: {
