...
import * as modelAction from './bpjs_jasa_raharja_claim.model.action';
import {BpjsJasaRaharjaClaimService} from '../../services/bpjsJasaRaharjaClaim/bpjs_jasa_raharja_claim.service';
...
/**
 * Effect class used for side effects related to BPJS Jasa Raharja Claim model.
 */
@Injectable()
export class BpjsJasaRaharjaClaimEffect {
	...
	constructor(
		...
		protected readonly service: BpjsJasaRaharjaClaimService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsJasaRaharjaClaimAction>(modelAction.BpjsJasaRaharjaClaimModelActionTypes.COUNT_BPJS_JASA_RAHARJA_CLAIMS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsJasaRaharjaClaimActionOK(
						modelAction.BpjsJasaRaharjaClaimModelActionTypes.COUNT_BPJS_JASA_RAHARJA_CLAIMS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsJasaRaharjaClaimActionFail(
								modelAction.BpjsJasaRaharjaClaimModelActionTypes.COUNT_BPJS_JASA_RAHARJA_CLAIMS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsJasaRaharjaClaimAction>(modelAction.BpjsJasaRaharjaClaimModelActionTypes.FETCH_BPJS_JASA_RAHARJA_CLAIM),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsJasaRaharjaClaimActionOK(
						modelAction.BpjsJasaRaharjaClaimModelActionTypes.FETCH_BPJS_JASA_RAHARJA_CLAIM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsJasaRaharjaClaimActionFail(
								modelAction.BpjsJasaRaharjaClaimModelActionTypes.FETCH_BPJS_JASA_RAHARJA_CLAIM_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsJasaRaharjaClaimAction>(modelAction.BpjsJasaRaharjaClaimModelActionTypes.FETCH_ALL_BPJS_JASA_RAHARJA_CLAIM),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsJasaRaharjaClaimActionOK(
						modelAction.BpjsJasaRaharjaClaimModelActionTypes.FETCH_ALL_BPJS_JASA_RAHARJA_CLAIM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsJasaRaharjaClaimActionFail(
								modelAction.BpjsJasaRaharjaClaimModelActionTypes.FETCH_ALL_BPJS_JASA_RAHARJA_CLAIM_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsJasaRaharjaClaimAction>(modelAction.BpjsJasaRaharjaClaimModelActionTypes.FETCH_BPJS_JASA_RAHARJA_CLAIM_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsJasaRaharjaClaimActionOK(
						modelAction.BpjsJasaRaharjaClaimModelActionTypes.FETCH_BPJS_JASA_RAHARJA_CLAIM_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsJasaRaharjaClaimActionFail(
								modelAction.BpjsJasaRaharjaClaimModelActionTypes.FETCH_BPJS_JASA_RAHARJA_CLAIM_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsJasaRaharjaClaimAction>(modelAction.BpjsJasaRaharjaClaimModelActionTypes.FETCH_LAST_BPJS_JASA_RAHARJA_CLAIM_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsJasaRaharjaClaimActionOK(
						modelAction.BpjsJasaRaharjaClaimModelActionTypes.FETCH_LAST_BPJS_JASA_RAHARJA_CLAIM_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsJasaRaharjaClaimActionFail(
								modelAction.BpjsJasaRaharjaClaimModelActionTypes.FETCH_LAST_BPJS_JASA_RAHARJA_CLAIM_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsJasaRaharjaClaimAction>(modelAction.BpjsJasaRaharjaClaimModelActionTypes.CREATE_BPJS_JASA_RAHARJA_CLAIM),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsJasaRaharjaClaimModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsJasaRaharjaClaimActionOK(
						modelAction.BpjsJasaRaharjaClaimModelActionTypes.CREATE_BPJS_JASA_RAHARJA_CLAIM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsJasaRaharjaClaimActionFail(
								modelAction.BpjsJasaRaharjaClaimModelActionTypes.CREATE_BPJS_JASA_RAHARJA_CLAIM_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsJasaRaharjaClaimAction>(modelAction.BpjsJasaRaharjaClaimModelActionTypes.CREATE_ALL_BPJS_JASA_RAHARJA_CLAIM),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsJasaRaharjaClaimModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsJasaRaharjaClaimActionOK(
						modelAction.BpjsJasaRaharjaClaimModelActionTypes.CREATE_ALL_BPJS_JASA_RAHARJA_CLAIM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsJasaRaharjaClaimActionFail(
								modelAction.BpjsJasaRaharjaClaimModelActionTypes.CREATE_ALL_BPJS_JASA_RAHARJA_CLAIM_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsJasaRaharjaClaimAction>(modelAction.BpjsJasaRaharjaClaimModelActionTypes.UPDATE_BPJS_JASA_RAHARJA_CLAIM),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsJasaRaharjaClaimModel;
				...
				return this.service.update(new BpjsJasaRaharjaClaimModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsJasaRaharjaClaimActionOK(
						modelAction.BpjsJasaRaharjaClaimModelActionTypes.UPDATE_BPJS_JASA_RAHARJA_CLAIM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsJasaRaharjaClaimActionFail(
								modelAction.BpjsJasaRaharjaClaimModelActionTypes.UPDATE_BPJS_JASA_RAHARJA_CLAIM_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsJasaRaharjaClaimAction>(modelAction.BpjsJasaRaharjaClaimModelActionTypes.UPDATE_ALL_BPJS_JASA_RAHARJA_CLAIM),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsJasaRaharjaClaimModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsJasaRaharjaClaimModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsJasaRaharjaClaimActionOK(
						modelAction.BpjsJasaRaharjaClaimModelActionTypes.UPDATE_ALL_BPJS_JASA_RAHARJA_CLAIM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsJasaRaharjaClaimActionFail(
								modelAction.BpjsJasaRaharjaClaimModelActionTypes.UPDATE_ALL_BPJS_JASA_RAHARJA_CLAIM_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsJasaRaharjaClaimAction>(modelAction.BpjsJasaRaharjaClaimModelActionTypes.DELETE_BPJS_JASA_RAHARJA_CLAIM),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsJasaRaharjaClaimActionOK(
						modelAction.BpjsJasaRaharjaClaimModelActionTypes.DELETE_BPJS_JASA_RAHARJA_CLAIM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsJasaRaharjaClaimActionFail(
								modelAction.BpjsJasaRaharjaClaimModelActionTypes.DELETE_BPJS_JASA_RAHARJA_CLAIM_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsJasaRaharjaClaimAction>(modelAction.BpjsJasaRaharjaClaimModelActionTypes.DELETE_BPJS_JASA_RAHARJA_CLAIM_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsJasaRaharjaClaimActionOK(
						modelAction.BpjsJasaRaharjaClaimModelActionTypes.DELETE_BPJS_JASA_RAHARJA_CLAIM_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsJasaRaharjaClaimActionFail(
								modelAction.BpjsJasaRaharjaClaimModelActionTypes.DELETE_BPJS_JASA_RAHARJA_CLAIM_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsJasaRaharjaClaimAction>(modelAction.BpjsJasaRaharjaClaimModelActionTypes.DELETE_ALL_BPJS_JASA_RAHARJA_CLAIM),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsJasaRaharjaClaimActionOK(
						modelAction.BpjsJasaRaharjaClaimModelActionTypes.DELETE_ALL_BPJS_JASA_RAHARJA_CLAIM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsJasaRaharjaClaimActionFail(
								modelAction.BpjsJasaRaharjaClaimModelActionTypes.DELETE_ALL_BPJS_JASA_RAHARJA_CLAIM_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsJasaRaharjaClaimAction>(modelAction.BpjsJasaRaharjaClaimModelActionTypes.EXPORT_BPJS_JASA_RAHARJA_CLAIM),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsJasaRaharjaClaimActionOK(
						modelAction.BpjsJasaRaharjaClaimModelActionTypes.EXPORT_BPJS_JASA_RAHARJA_CLAIM,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsJasaRaharjaClaimAction>(modelAction.BpjsJasaRaharjaClaimModelActionTypes.EXPORT_ALL_BPJS_JASA_RAHARJA_CLAIM),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsJasaRaharjaClaimActionOK(
						modelAction.BpjsJasaRaharjaClaimModelActionTypes.EXPORT_ALL_BPJS_JASA_RAHARJA_CLAIM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsJasaRaharjaClaimActionFail(
								modelAction.BpjsJasaRaharjaClaimModelActionTypes.EXPORT_ALL_BPJS_JASA_RAHARJA_CLAIM_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsJasaRaharjaClaimAction>(modelAction.BpjsJasaRaharjaClaimModelActionTypes.EXPORT_BPJS_JASA_RAHARJA_CLAIM_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsJasaRaharjaClaimActionOK(
						modelAction.BpjsJasaRaharjaClaimModelActionTypes.EXPORT_BPJS_JASA_RAHARJA_CLAIM_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsJasaRaharjaClaimActionFail(
								modelAction.BpjsJasaRaharjaClaimModelActionTypes.EXPORT_BPJS_JASA_RAHARJA_CLAIM_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsJasaRaharjaClaimAction>(modelAction.BpjsJasaRaharjaClaimModelActionTypes.IMPORT_BPJS_JASA_RAHARJA_CLAIMS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsJasaRaharjaClaimActionOK(
						modelAction.BpjsJasaRaharjaClaimModelActionTypes.IMPORT_BPJS_JASA_RAHARJA_CLAIMS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsJasaRaharjaClaimActionFail(
								modelAction.BpjsJasaRaharjaClaimModelActionTypes.IMPORT_BPJS_JASA_RAHARJA_CLAIMS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsJasaRaharjaClaimAction>(modelAction.BpjsJasaRaharjaClaimModelActionTypes.FETCH_BPJS_JASA_RAHARJA_CLAIM_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsJasaRaharjaClaimActionOK(
						modelAction.BpjsJasaRaharjaClaimModelActionTypes.FETCH_BPJS_JASA_RAHARJA_CLAIM_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsJasaRaharjaClaimActionFail(
								modelAction.BpjsJasaRaharjaClaimModelActionTypes.FETCH_BPJS_JASA_RAHARJA_CLAIM_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsJasaRaharjaClaimAction>(modelAction.BpjsJasaRaharjaClaimModelActionTypes.FETCH_BPJS_JASA_RAHARJA_CLAIM_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsJasaRaharjaClaimActionOK(
						modelAction.BpjsJasaRaharjaClaimModelActionTypes.FETCH_BPJS_JASA_RAHARJA_CLAIM_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsJasaRaharjaClaimActionFail(
								modelAction.BpjsJasaRaharjaClaimModelActionTypes.FETCH_BPJS_JASA_RAHARJA_CLAIM_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
