...
/**
 * Effect class used for side effects related to Supplier model.
 */
@Injectable()
export class SupplierEffect {
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierAction>(modelAction.SupplierModelActionTypes.COUNT_SUPPLIERS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.SupplierActionOK(
						modelAction.SupplierModelActionTypes.COUNT_SUPPLIERS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SupplierActionFail(
								modelAction.SupplierModelActionTypes.COUNT_SUPPLIERS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierAction>(modelAction.SupplierModelActionTypes.FETCH_SUPPLIER),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.SupplierActionOK(
						modelAction.SupplierModelActionTypes.FETCH_SUPPLIER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SupplierActionFail(
								modelAction.SupplierModelActionTypes.FETCH_SUPPLIER_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierAction>(modelAction.SupplierModelActionTypes.FETCH_ALL_SUPPLIER),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.SupplierActionOK(
						modelAction.SupplierModelActionTypes.FETCH_ALL_SUPPLIER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SupplierActionFail(
								modelAction.SupplierModelActionTypes.FETCH_ALL_SUPPLIER_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierAction>(modelAction.SupplierModelActionTypes.FETCH_SUPPLIER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.SupplierActionOK(
						modelAction.SupplierModelActionTypes.FETCH_SUPPLIER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SupplierActionFail(
								modelAction.SupplierModelActionTypes.FETCH_SUPPLIER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierAction>(modelAction.SupplierModelActionTypes.FETCH_LAST_SUPPLIER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.SupplierActionOK(
						modelAction.SupplierModelActionTypes.FETCH_LAST_SUPPLIER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SupplierActionFail(
								modelAction.SupplierModelActionTypes.FETCH_LAST_SUPPLIER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierAction>(modelAction.SupplierModelActionTypes.CREATE_SUPPLIER),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as SupplierModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.SupplierActionOK(
						modelAction.SupplierModelActionTypes.CREATE_SUPPLIER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SupplierActionFail(
								modelAction.SupplierModelActionTypes.CREATE_SUPPLIER_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierAction>(modelAction.SupplierModelActionTypes.CREATE_ALL_SUPPLIER),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as SupplierModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.SupplierActionOK(
						modelAction.SupplierModelActionTypes.CREATE_ALL_SUPPLIER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SupplierActionFail(
								modelAction.SupplierModelActionTypes.CREATE_ALL_SUPPLIER_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierAction>(modelAction.SupplierModelActionTypes.UPDATE_SUPPLIER),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as SupplierModel;
				...
				return this.service.update(new SupplierModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.SupplierActionOK(
						modelAction.SupplierModelActionTypes.UPDATE_SUPPLIER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SupplierActionFail(
								modelAction.SupplierModelActionTypes.UPDATE_SUPPLIER_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierAction>(modelAction.SupplierModelActionTypes.UPDATE_ALL_SUPPLIER),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as SupplierModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new SupplierModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.SupplierActionOK(
						modelAction.SupplierModelActionTypes.UPDATE_ALL_SUPPLIER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SupplierActionFail(
								modelAction.SupplierModelActionTypes.UPDATE_ALL_SUPPLIER_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierAction>(modelAction.SupplierModelActionTypes.DELETE_SUPPLIER),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.SupplierActionOK(
						modelAction.SupplierModelActionTypes.DELETE_SUPPLIER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SupplierActionFail(
								modelAction.SupplierModelActionTypes.DELETE_SUPPLIER_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierAction>(modelAction.SupplierModelActionTypes.DELETE_SUPPLIER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.SupplierActionOK(
						modelAction.SupplierModelActionTypes.DELETE_SUPPLIER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SupplierActionFail(
								modelAction.SupplierModelActionTypes.DELETE_SUPPLIER_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierAction>(modelAction.SupplierModelActionTypes.DELETE_ALL_SUPPLIER),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.SupplierActionOK(
						modelAction.SupplierModelActionTypes.DELETE_ALL_SUPPLIER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SupplierActionFail(
								modelAction.SupplierModelActionTypes.DELETE_ALL_SUPPLIER_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierAction>(modelAction.SupplierModelActionTypes.EXPORT_SUPPLIER),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.SupplierActionOK(
						modelAction.SupplierModelActionTypes.EXPORT_SUPPLIER,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierAction>(modelAction.SupplierModelActionTypes.EXPORT_ALL_SUPPLIER),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.SupplierActionOK(
						modelAction.SupplierModelActionTypes.EXPORT_ALL_SUPPLIER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SupplierActionFail(
								modelAction.SupplierModelActionTypes.EXPORT_ALL_SUPPLIER_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierAction>(modelAction.SupplierModelActionTypes.EXPORT_SUPPLIER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.SupplierActionOK(
						modelAction.SupplierModelActionTypes.EXPORT_SUPPLIER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SupplierActionFail(
								modelAction.SupplierModelActionTypes.EXPORT_SUPPLIER_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierAction>(modelAction.SupplierModelActionTypes.IMPORT_SUPPLIERS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.SupplierActionOK(
						modelAction.SupplierModelActionTypes.IMPORT_SUPPLIERS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SupplierActionFail(
								modelAction.SupplierModelActionTypes.IMPORT_SUPPLIERS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierAction>(modelAction.SupplierModelActionTypes.FETCH_SUPPLIER_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.SupplierActionOK(
						modelAction.SupplierModelActionTypes.FETCH_SUPPLIER_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.SupplierActionFail(
								modelAction.SupplierModelActionTypes.FETCH_SUPPLIER_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierAction>(modelAction.SupplierModelActionTypes.FETCH_SUPPLIER_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.SupplierActionOK(
						modelAction.SupplierModelActionTypes.FETCH_SUPPLIER_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.SupplierActionFail(
								modelAction.SupplierModelActionTypes.FETCH_SUPPLIER_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
