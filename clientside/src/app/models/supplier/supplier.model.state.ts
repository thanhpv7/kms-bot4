...
/**
 * SupplierCollectionState would store the state of a collection of Supplier
 */
export interface SupplierCollectionState extends CollectionState {
 ...
 */
export interface SupplierModelAudit extends AbstractModelAudit<SupplierModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * SupplierModelState would store the state of the model
 */
export interface SupplierModelState {
	collectionState: {
		[key: string]: SupplierCollectionState;
	};
	data: {
		[id: string]: SupplierModel;
	};
	totalCount: number;
	audits: SupplierModelAudit[];
 ...
 */
export const initialSupplierCollectionState: SupplierCollectionState = {
...
/**
 * The initial state of SupplierModelState
 */
export const initialState: SupplierModelState = {
	collectionState: {
