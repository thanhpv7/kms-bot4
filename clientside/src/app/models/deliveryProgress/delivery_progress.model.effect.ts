...
import * as modelAction from './delivery_progress.model.action';
import {DeliveryProgressService} from '../../services/deliveryProgress/delivery_progress.service';
...
/**
 * Effect class used for side effects related to Delivery Progress model.
 */
@Injectable()
export class DeliveryProgressEffect {
	...
	constructor(
		...
		protected readonly service: DeliveryProgressService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DeliveryProgressAction>(modelAction.DeliveryProgressModelActionTypes.COUNT_DELIVERY_PROGRESSS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.DeliveryProgressActionOK(
						modelAction.DeliveryProgressModelActionTypes.COUNT_DELIVERY_PROGRESSS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DeliveryProgressActionFail(
								modelAction.DeliveryProgressModelActionTypes.COUNT_DELIVERY_PROGRESSS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DeliveryProgressAction>(modelAction.DeliveryProgressModelActionTypes.FETCH_DELIVERY_PROGRESS),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.DeliveryProgressActionOK(
						modelAction.DeliveryProgressModelActionTypes.FETCH_DELIVERY_PROGRESS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DeliveryProgressActionFail(
								modelAction.DeliveryProgressModelActionTypes.FETCH_DELIVERY_PROGRESS_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DeliveryProgressAction>(modelAction.DeliveryProgressModelActionTypes.FETCH_ALL_DELIVERY_PROGRESS),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.DeliveryProgressActionOK(
						modelAction.DeliveryProgressModelActionTypes.FETCH_ALL_DELIVERY_PROGRESS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DeliveryProgressActionFail(
								modelAction.DeliveryProgressModelActionTypes.FETCH_ALL_DELIVERY_PROGRESS_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DeliveryProgressAction>(modelAction.DeliveryProgressModelActionTypes.FETCH_DELIVERY_PROGRESS_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.DeliveryProgressActionOK(
						modelAction.DeliveryProgressModelActionTypes.FETCH_DELIVERY_PROGRESS_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DeliveryProgressActionFail(
								modelAction.DeliveryProgressModelActionTypes.FETCH_DELIVERY_PROGRESS_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DeliveryProgressAction>(modelAction.DeliveryProgressModelActionTypes.FETCH_LAST_DELIVERY_PROGRESS_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.DeliveryProgressActionOK(
						modelAction.DeliveryProgressModelActionTypes.FETCH_LAST_DELIVERY_PROGRESS_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DeliveryProgressActionFail(
								modelAction.DeliveryProgressModelActionTypes.FETCH_LAST_DELIVERY_PROGRESS_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DeliveryProgressAction>(modelAction.DeliveryProgressModelActionTypes.CREATE_DELIVERY_PROGRESS),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as DeliveryProgressModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.DeliveryProgressActionOK(
						modelAction.DeliveryProgressModelActionTypes.CREATE_DELIVERY_PROGRESS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DeliveryProgressActionFail(
								modelAction.DeliveryProgressModelActionTypes.CREATE_DELIVERY_PROGRESS_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DeliveryProgressAction>(modelAction.DeliveryProgressModelActionTypes.CREATE_ALL_DELIVERY_PROGRESS),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as DeliveryProgressModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.DeliveryProgressActionOK(
						modelAction.DeliveryProgressModelActionTypes.CREATE_ALL_DELIVERY_PROGRESS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DeliveryProgressActionFail(
								modelAction.DeliveryProgressModelActionTypes.CREATE_ALL_DELIVERY_PROGRESS_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DeliveryProgressAction>(modelAction.DeliveryProgressModelActionTypes.UPDATE_DELIVERY_PROGRESS),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as DeliveryProgressModel;
				...
				return this.service.update(new DeliveryProgressModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.DeliveryProgressActionOK(
						modelAction.DeliveryProgressModelActionTypes.UPDATE_DELIVERY_PROGRESS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DeliveryProgressActionFail(
								modelAction.DeliveryProgressModelActionTypes.UPDATE_DELIVERY_PROGRESS_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DeliveryProgressAction>(modelAction.DeliveryProgressModelActionTypes.UPDATE_ALL_DELIVERY_PROGRESS),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as DeliveryProgressModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new DeliveryProgressModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.DeliveryProgressActionOK(
						modelAction.DeliveryProgressModelActionTypes.UPDATE_ALL_DELIVERY_PROGRESS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DeliveryProgressActionFail(
								modelAction.DeliveryProgressModelActionTypes.UPDATE_ALL_DELIVERY_PROGRESS_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DeliveryProgressAction>(modelAction.DeliveryProgressModelActionTypes.DELETE_DELIVERY_PROGRESS),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.DeliveryProgressActionOK(
						modelAction.DeliveryProgressModelActionTypes.DELETE_DELIVERY_PROGRESS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DeliveryProgressActionFail(
								modelAction.DeliveryProgressModelActionTypes.DELETE_DELIVERY_PROGRESS_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DeliveryProgressAction>(modelAction.DeliveryProgressModelActionTypes.DELETE_DELIVERY_PROGRESS_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.DeliveryProgressActionOK(
						modelAction.DeliveryProgressModelActionTypes.DELETE_DELIVERY_PROGRESS_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DeliveryProgressActionFail(
								modelAction.DeliveryProgressModelActionTypes.DELETE_DELIVERY_PROGRESS_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DeliveryProgressAction>(modelAction.DeliveryProgressModelActionTypes.DELETE_ALL_DELIVERY_PROGRESS),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.DeliveryProgressActionOK(
						modelAction.DeliveryProgressModelActionTypes.DELETE_ALL_DELIVERY_PROGRESS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DeliveryProgressActionFail(
								modelAction.DeliveryProgressModelActionTypes.DELETE_ALL_DELIVERY_PROGRESS_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DeliveryProgressAction>(modelAction.DeliveryProgressModelActionTypes.EXPORT_DELIVERY_PROGRESS),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.DeliveryProgressActionOK(
						modelAction.DeliveryProgressModelActionTypes.EXPORT_DELIVERY_PROGRESS,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DeliveryProgressAction>(modelAction.DeliveryProgressModelActionTypes.EXPORT_ALL_DELIVERY_PROGRESS),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.DeliveryProgressActionOK(
						modelAction.DeliveryProgressModelActionTypes.EXPORT_ALL_DELIVERY_PROGRESS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DeliveryProgressActionFail(
								modelAction.DeliveryProgressModelActionTypes.EXPORT_ALL_DELIVERY_PROGRESS_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DeliveryProgressAction>(modelAction.DeliveryProgressModelActionTypes.EXPORT_DELIVERY_PROGRESS_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.DeliveryProgressActionOK(
						modelAction.DeliveryProgressModelActionTypes.EXPORT_DELIVERY_PROGRESS_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DeliveryProgressActionFail(
								modelAction.DeliveryProgressModelActionTypes.EXPORT_DELIVERY_PROGRESS_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DeliveryProgressAction>(modelAction.DeliveryProgressModelActionTypes.IMPORT_DELIVERY_PROGRESSS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.DeliveryProgressActionOK(
						modelAction.DeliveryProgressModelActionTypes.IMPORT_DELIVERY_PROGRESSS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DeliveryProgressActionFail(
								modelAction.DeliveryProgressModelActionTypes.IMPORT_DELIVERY_PROGRESSS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DeliveryProgressAction>(modelAction.DeliveryProgressModelActionTypes.FETCH_DELIVERY_PROGRESS_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.DeliveryProgressActionOK(
						modelAction.DeliveryProgressModelActionTypes.FETCH_DELIVERY_PROGRESS_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.DeliveryProgressActionFail(
								modelAction.DeliveryProgressModelActionTypes.FETCH_DELIVERY_PROGRESS_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DeliveryProgressAction>(modelAction.DeliveryProgressModelActionTypes.FETCH_DELIVERY_PROGRESS_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.DeliveryProgressActionOK(
						modelAction.DeliveryProgressModelActionTypes.FETCH_DELIVERY_PROGRESS_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.DeliveryProgressActionFail(
								modelAction.DeliveryProgressModelActionTypes.FETCH_DELIVERY_PROGRESS_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
