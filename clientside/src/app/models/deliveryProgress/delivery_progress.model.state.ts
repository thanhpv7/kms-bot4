...
/**
 * DeliveryProgressCollectionState would store the state of a collection of DeliveryProgress
 */
export interface DeliveryProgressCollectionState extends CollectionState {
 ...
 */
export interface DeliveryProgressModelAudit extends AbstractModelAudit<DeliveryProgressModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * DeliveryProgressModelState would store the state of the model
 */
export interface DeliveryProgressModelState {
	collectionState: {
		[key: string]: DeliveryProgressCollectionState;
	};
	data: {
		[id: string]: DeliveryProgressModel;
	};
	totalCount: number;
	audits: DeliveryProgressModelAudit[];
 ...
 */
export const initialDeliveryProgressCollectionState: DeliveryProgressCollectionState = {
...
/**
 * The initial state of DeliveryProgressModelState
 */
export const initialState: DeliveryProgressModelState = {
	collectionState: {
