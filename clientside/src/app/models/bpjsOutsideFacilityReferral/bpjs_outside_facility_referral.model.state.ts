...
/**
 * BpjsOutsideFacilityReferralCollectionState would store the state of a collection of BpjsOutsideFacilityReferral
 */
export interface BpjsOutsideFacilityReferralCollectionState extends CollectionState {
 ...
 */
export interface BpjsOutsideFacilityReferralModelAudit extends AbstractModelAudit<BpjsOutsideFacilityReferralModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsOutsideFacilityReferralModelState would store the state of the model
 */
export interface BpjsOutsideFacilityReferralModelState {
	collectionState: {
		[key: string]: BpjsOutsideFacilityReferralCollectionState;
	};
	data: {
		[id: string]: BpjsOutsideFacilityReferralModel;
	};
	totalCount: number;
	audits: BpjsOutsideFacilityReferralModelAudit[];
 ...
 */
export const initialBpjsOutsideFacilityReferralCollectionState: BpjsOutsideFacilityReferralCollectionState = {
...
/**
 * The initial state of BpjsOutsideFacilityReferralModelState
 */
export const initialState: BpjsOutsideFacilityReferralModelState = {
	collectionState: {
