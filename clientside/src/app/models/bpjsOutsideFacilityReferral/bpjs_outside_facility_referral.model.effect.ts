...
import * as modelAction from './bpjs_outside_facility_referral.model.action';
import {BpjsOutsideFacilityReferralService} from '../../services/bpjsOutsideFacilityReferral/bpjs_outside_facility_referral.service';
...
/**
 * Effect class used for side effects related to BPJS Outside Facility Referral model.
 */
@Injectable()
export class BpjsOutsideFacilityReferralEffect {
	...
	constructor(
		...
		protected readonly service: BpjsOutsideFacilityReferralService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsOutsideFacilityReferralAction>(modelAction.BpjsOutsideFacilityReferralModelActionTypes.COUNT_BPJS_OUTSIDE_FACILITY_REFERRALS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsOutsideFacilityReferralActionOK(
						modelAction.BpjsOutsideFacilityReferralModelActionTypes.COUNT_BPJS_OUTSIDE_FACILITY_REFERRALS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsOutsideFacilityReferralActionFail(
								modelAction.BpjsOutsideFacilityReferralModelActionTypes.COUNT_BPJS_OUTSIDE_FACILITY_REFERRALS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsOutsideFacilityReferralAction>(modelAction.BpjsOutsideFacilityReferralModelActionTypes.FETCH_BPJS_OUTSIDE_FACILITY_REFERRAL),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsOutsideFacilityReferralActionOK(
						modelAction.BpjsOutsideFacilityReferralModelActionTypes.FETCH_BPJS_OUTSIDE_FACILITY_REFERRAL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsOutsideFacilityReferralActionFail(
								modelAction.BpjsOutsideFacilityReferralModelActionTypes.FETCH_BPJS_OUTSIDE_FACILITY_REFERRAL_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsOutsideFacilityReferralAction>(modelAction.BpjsOutsideFacilityReferralModelActionTypes.FETCH_ALL_BPJS_OUTSIDE_FACILITY_REFERRAL),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsOutsideFacilityReferralActionOK(
						modelAction.BpjsOutsideFacilityReferralModelActionTypes.FETCH_ALL_BPJS_OUTSIDE_FACILITY_REFERRAL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsOutsideFacilityReferralActionFail(
								modelAction.BpjsOutsideFacilityReferralModelActionTypes.FETCH_ALL_BPJS_OUTSIDE_FACILITY_REFERRAL_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsOutsideFacilityReferralAction>(modelAction.BpjsOutsideFacilityReferralModelActionTypes.FETCH_BPJS_OUTSIDE_FACILITY_REFERRAL_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsOutsideFacilityReferralActionOK(
						modelAction.BpjsOutsideFacilityReferralModelActionTypes.FETCH_BPJS_OUTSIDE_FACILITY_REFERRAL_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsOutsideFacilityReferralActionFail(
								modelAction.BpjsOutsideFacilityReferralModelActionTypes.FETCH_BPJS_OUTSIDE_FACILITY_REFERRAL_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsOutsideFacilityReferralAction>(modelAction.BpjsOutsideFacilityReferralModelActionTypes.FETCH_LAST_BPJS_OUTSIDE_FACILITY_REFERRAL_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsOutsideFacilityReferralActionOK(
						modelAction.BpjsOutsideFacilityReferralModelActionTypes.FETCH_LAST_BPJS_OUTSIDE_FACILITY_REFERRAL_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsOutsideFacilityReferralActionFail(
								modelAction.BpjsOutsideFacilityReferralModelActionTypes.FETCH_LAST_BPJS_OUTSIDE_FACILITY_REFERRAL_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsOutsideFacilityReferralAction>(modelAction.BpjsOutsideFacilityReferralModelActionTypes.CREATE_BPJS_OUTSIDE_FACILITY_REFERRAL),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsOutsideFacilityReferralModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsOutsideFacilityReferralActionOK(
						modelAction.BpjsOutsideFacilityReferralModelActionTypes.CREATE_BPJS_OUTSIDE_FACILITY_REFERRAL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsOutsideFacilityReferralActionFail(
								modelAction.BpjsOutsideFacilityReferralModelActionTypes.CREATE_BPJS_OUTSIDE_FACILITY_REFERRAL_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsOutsideFacilityReferralAction>(modelAction.BpjsOutsideFacilityReferralModelActionTypes.CREATE_ALL_BPJS_OUTSIDE_FACILITY_REFERRAL),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsOutsideFacilityReferralModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsOutsideFacilityReferralActionOK(
						modelAction.BpjsOutsideFacilityReferralModelActionTypes.CREATE_ALL_BPJS_OUTSIDE_FACILITY_REFERRAL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsOutsideFacilityReferralActionFail(
								modelAction.BpjsOutsideFacilityReferralModelActionTypes.CREATE_ALL_BPJS_OUTSIDE_FACILITY_REFERRAL_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsOutsideFacilityReferralAction>(modelAction.BpjsOutsideFacilityReferralModelActionTypes.UPDATE_BPJS_OUTSIDE_FACILITY_REFERRAL),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsOutsideFacilityReferralModel;
				...
				return this.service.update(new BpjsOutsideFacilityReferralModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsOutsideFacilityReferralActionOK(
						modelAction.BpjsOutsideFacilityReferralModelActionTypes.UPDATE_BPJS_OUTSIDE_FACILITY_REFERRAL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsOutsideFacilityReferralActionFail(
								modelAction.BpjsOutsideFacilityReferralModelActionTypes.UPDATE_BPJS_OUTSIDE_FACILITY_REFERRAL_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsOutsideFacilityReferralAction>(modelAction.BpjsOutsideFacilityReferralModelActionTypes.UPDATE_ALL_BPJS_OUTSIDE_FACILITY_REFERRAL),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsOutsideFacilityReferralModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsOutsideFacilityReferralModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsOutsideFacilityReferralActionOK(
						modelAction.BpjsOutsideFacilityReferralModelActionTypes.UPDATE_ALL_BPJS_OUTSIDE_FACILITY_REFERRAL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsOutsideFacilityReferralActionFail(
								modelAction.BpjsOutsideFacilityReferralModelActionTypes.UPDATE_ALL_BPJS_OUTSIDE_FACILITY_REFERRAL_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsOutsideFacilityReferralAction>(modelAction.BpjsOutsideFacilityReferralModelActionTypes.DELETE_BPJS_OUTSIDE_FACILITY_REFERRAL),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsOutsideFacilityReferralActionOK(
						modelAction.BpjsOutsideFacilityReferralModelActionTypes.DELETE_BPJS_OUTSIDE_FACILITY_REFERRAL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsOutsideFacilityReferralActionFail(
								modelAction.BpjsOutsideFacilityReferralModelActionTypes.DELETE_BPJS_OUTSIDE_FACILITY_REFERRAL_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsOutsideFacilityReferralAction>(modelAction.BpjsOutsideFacilityReferralModelActionTypes.DELETE_BPJS_OUTSIDE_FACILITY_REFERRAL_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsOutsideFacilityReferralActionOK(
						modelAction.BpjsOutsideFacilityReferralModelActionTypes.DELETE_BPJS_OUTSIDE_FACILITY_REFERRAL_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsOutsideFacilityReferralActionFail(
								modelAction.BpjsOutsideFacilityReferralModelActionTypes.DELETE_BPJS_OUTSIDE_FACILITY_REFERRAL_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsOutsideFacilityReferralAction>(modelAction.BpjsOutsideFacilityReferralModelActionTypes.DELETE_ALL_BPJS_OUTSIDE_FACILITY_REFERRAL),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsOutsideFacilityReferralActionOK(
						modelAction.BpjsOutsideFacilityReferralModelActionTypes.DELETE_ALL_BPJS_OUTSIDE_FACILITY_REFERRAL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsOutsideFacilityReferralActionFail(
								modelAction.BpjsOutsideFacilityReferralModelActionTypes.DELETE_ALL_BPJS_OUTSIDE_FACILITY_REFERRAL_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsOutsideFacilityReferralAction>(modelAction.BpjsOutsideFacilityReferralModelActionTypes.EXPORT_BPJS_OUTSIDE_FACILITY_REFERRAL),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsOutsideFacilityReferralActionOK(
						modelAction.BpjsOutsideFacilityReferralModelActionTypes.EXPORT_BPJS_OUTSIDE_FACILITY_REFERRAL,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsOutsideFacilityReferralAction>(modelAction.BpjsOutsideFacilityReferralModelActionTypes.EXPORT_ALL_BPJS_OUTSIDE_FACILITY_REFERRAL),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsOutsideFacilityReferralActionOK(
						modelAction.BpjsOutsideFacilityReferralModelActionTypes.EXPORT_ALL_BPJS_OUTSIDE_FACILITY_REFERRAL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsOutsideFacilityReferralActionFail(
								modelAction.BpjsOutsideFacilityReferralModelActionTypes.EXPORT_ALL_BPJS_OUTSIDE_FACILITY_REFERRAL_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsOutsideFacilityReferralAction>(modelAction.BpjsOutsideFacilityReferralModelActionTypes.EXPORT_BPJS_OUTSIDE_FACILITY_REFERRAL_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsOutsideFacilityReferralActionOK(
						modelAction.BpjsOutsideFacilityReferralModelActionTypes.EXPORT_BPJS_OUTSIDE_FACILITY_REFERRAL_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsOutsideFacilityReferralActionFail(
								modelAction.BpjsOutsideFacilityReferralModelActionTypes.EXPORT_BPJS_OUTSIDE_FACILITY_REFERRAL_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsOutsideFacilityReferralAction>(modelAction.BpjsOutsideFacilityReferralModelActionTypes.IMPORT_BPJS_OUTSIDE_FACILITY_REFERRALS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsOutsideFacilityReferralActionOK(
						modelAction.BpjsOutsideFacilityReferralModelActionTypes.IMPORT_BPJS_OUTSIDE_FACILITY_REFERRALS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsOutsideFacilityReferralActionFail(
								modelAction.BpjsOutsideFacilityReferralModelActionTypes.IMPORT_BPJS_OUTSIDE_FACILITY_REFERRALS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsOutsideFacilityReferralAction>(modelAction.BpjsOutsideFacilityReferralModelActionTypes.FETCH_BPJS_OUTSIDE_FACILITY_REFERRAL_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsOutsideFacilityReferralActionOK(
						modelAction.BpjsOutsideFacilityReferralModelActionTypes.FETCH_BPJS_OUTSIDE_FACILITY_REFERRAL_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsOutsideFacilityReferralActionFail(
								modelAction.BpjsOutsideFacilityReferralModelActionTypes.FETCH_BPJS_OUTSIDE_FACILITY_REFERRAL_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsOutsideFacilityReferralAction>(modelAction.BpjsOutsideFacilityReferralModelActionTypes.FETCH_BPJS_OUTSIDE_FACILITY_REFERRAL_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsOutsideFacilityReferralActionOK(
						modelAction.BpjsOutsideFacilityReferralModelActionTypes.FETCH_BPJS_OUTSIDE_FACILITY_REFERRAL_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsOutsideFacilityReferralActionFail(
								modelAction.BpjsOutsideFacilityReferralModelActionTypes.FETCH_BPJS_OUTSIDE_FACILITY_REFERRAL_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
