...
/**
 * InvoiceSummaryCollectionState would store the state of a collection of InvoiceSummary
 */
export interface InvoiceSummaryCollectionState extends CollectionState {
 ...
 */
export interface InvoiceSummaryModelAudit extends AbstractModelAudit<InvoiceSummaryModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * InvoiceSummaryModelState would store the state of the model
 */
export interface InvoiceSummaryModelState {
	collectionState: {
		[key: string]: InvoiceSummaryCollectionState;
	};
	data: {
		[id: string]: InvoiceSummaryModel;
	};
	totalCount: number;
	audits: InvoiceSummaryModelAudit[];
 ...
 */
export const initialInvoiceSummaryCollectionState: InvoiceSummaryCollectionState = {
...
/**
 * The initial state of InvoiceSummaryModelState
 */
export const initialState: InvoiceSummaryModelState = {
	collectionState: {
