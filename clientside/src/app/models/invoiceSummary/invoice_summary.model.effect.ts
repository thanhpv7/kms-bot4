...
import * as modelAction from './invoice_summary.model.action';
import {InvoiceSummaryService} from '../../services/invoiceSummary/invoice_summary.service';
...
/**
 * Effect class used for side effects related to Invoice Summary model.
 */
@Injectable()
export class InvoiceSummaryEffect {
	...
	constructor(
		...
		protected readonly service: InvoiceSummaryService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceSummaryAction>(modelAction.InvoiceSummaryModelActionTypes.COUNT_INVOICE_SUMMARYS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.InvoiceSummaryActionOK(
						modelAction.InvoiceSummaryModelActionTypes.COUNT_INVOICE_SUMMARYS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceSummaryActionFail(
								modelAction.InvoiceSummaryModelActionTypes.COUNT_INVOICE_SUMMARYS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceSummaryAction>(modelAction.InvoiceSummaryModelActionTypes.FETCH_INVOICE_SUMMARY),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InvoiceSummaryActionOK(
						modelAction.InvoiceSummaryModelActionTypes.FETCH_INVOICE_SUMMARY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceSummaryActionFail(
								modelAction.InvoiceSummaryModelActionTypes.FETCH_INVOICE_SUMMARY_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceSummaryAction>(modelAction.InvoiceSummaryModelActionTypes.FETCH_ALL_INVOICE_SUMMARY),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.InvoiceSummaryActionOK(
						modelAction.InvoiceSummaryModelActionTypes.FETCH_ALL_INVOICE_SUMMARY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceSummaryActionFail(
								modelAction.InvoiceSummaryModelActionTypes.FETCH_ALL_INVOICE_SUMMARY_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceSummaryAction>(modelAction.InvoiceSummaryModelActionTypes.FETCH_INVOICE_SUMMARY_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.InvoiceSummaryActionOK(
						modelAction.InvoiceSummaryModelActionTypes.FETCH_INVOICE_SUMMARY_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceSummaryActionFail(
								modelAction.InvoiceSummaryModelActionTypes.FETCH_INVOICE_SUMMARY_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceSummaryAction>(modelAction.InvoiceSummaryModelActionTypes.FETCH_LAST_INVOICE_SUMMARY_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.InvoiceSummaryActionOK(
						modelAction.InvoiceSummaryModelActionTypes.FETCH_LAST_INVOICE_SUMMARY_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceSummaryActionFail(
								modelAction.InvoiceSummaryModelActionTypes.FETCH_LAST_INVOICE_SUMMARY_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceSummaryAction>(modelAction.InvoiceSummaryModelActionTypes.CREATE_INVOICE_SUMMARY),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as InvoiceSummaryModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InvoiceSummaryActionOK(
						modelAction.InvoiceSummaryModelActionTypes.CREATE_INVOICE_SUMMARY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceSummaryActionFail(
								modelAction.InvoiceSummaryModelActionTypes.CREATE_INVOICE_SUMMARY_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceSummaryAction>(modelAction.InvoiceSummaryModelActionTypes.CREATE_ALL_INVOICE_SUMMARY),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as InvoiceSummaryModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InvoiceSummaryActionOK(
						modelAction.InvoiceSummaryModelActionTypes.CREATE_ALL_INVOICE_SUMMARY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceSummaryActionFail(
								modelAction.InvoiceSummaryModelActionTypes.CREATE_ALL_INVOICE_SUMMARY_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceSummaryAction>(modelAction.InvoiceSummaryModelActionTypes.UPDATE_INVOICE_SUMMARY),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as InvoiceSummaryModel;
				...
				return this.service.update(new InvoiceSummaryModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.InvoiceSummaryActionOK(
						modelAction.InvoiceSummaryModelActionTypes.UPDATE_INVOICE_SUMMARY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceSummaryActionFail(
								modelAction.InvoiceSummaryModelActionTypes.UPDATE_INVOICE_SUMMARY_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceSummaryAction>(modelAction.InvoiceSummaryModelActionTypes.UPDATE_ALL_INVOICE_SUMMARY),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as InvoiceSummaryModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new InvoiceSummaryModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InvoiceSummaryActionOK(
						modelAction.InvoiceSummaryModelActionTypes.UPDATE_ALL_INVOICE_SUMMARY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceSummaryActionFail(
								modelAction.InvoiceSummaryModelActionTypes.UPDATE_ALL_INVOICE_SUMMARY_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceSummaryAction>(modelAction.InvoiceSummaryModelActionTypes.DELETE_INVOICE_SUMMARY),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.InvoiceSummaryActionOK(
						modelAction.InvoiceSummaryModelActionTypes.DELETE_INVOICE_SUMMARY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceSummaryActionFail(
								modelAction.InvoiceSummaryModelActionTypes.DELETE_INVOICE_SUMMARY_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceSummaryAction>(modelAction.InvoiceSummaryModelActionTypes.DELETE_INVOICE_SUMMARY_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.InvoiceSummaryActionOK(
						modelAction.InvoiceSummaryModelActionTypes.DELETE_INVOICE_SUMMARY_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceSummaryActionFail(
								modelAction.InvoiceSummaryModelActionTypes.DELETE_INVOICE_SUMMARY_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceSummaryAction>(modelAction.InvoiceSummaryModelActionTypes.DELETE_ALL_INVOICE_SUMMARY),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.InvoiceSummaryActionOK(
						modelAction.InvoiceSummaryModelActionTypes.DELETE_ALL_INVOICE_SUMMARY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceSummaryActionFail(
								modelAction.InvoiceSummaryModelActionTypes.DELETE_ALL_INVOICE_SUMMARY_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceSummaryAction>(modelAction.InvoiceSummaryModelActionTypes.EXPORT_INVOICE_SUMMARY),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.InvoiceSummaryActionOK(
						modelAction.InvoiceSummaryModelActionTypes.EXPORT_INVOICE_SUMMARY,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceSummaryAction>(modelAction.InvoiceSummaryModelActionTypes.EXPORT_ALL_INVOICE_SUMMARY),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.InvoiceSummaryActionOK(
						modelAction.InvoiceSummaryModelActionTypes.EXPORT_ALL_INVOICE_SUMMARY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceSummaryActionFail(
								modelAction.InvoiceSummaryModelActionTypes.EXPORT_ALL_INVOICE_SUMMARY_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceSummaryAction>(modelAction.InvoiceSummaryModelActionTypes.EXPORT_INVOICE_SUMMARY_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.InvoiceSummaryActionOK(
						modelAction.InvoiceSummaryModelActionTypes.EXPORT_INVOICE_SUMMARY_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceSummaryActionFail(
								modelAction.InvoiceSummaryModelActionTypes.EXPORT_INVOICE_SUMMARY_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceSummaryAction>(modelAction.InvoiceSummaryModelActionTypes.IMPORT_INVOICE_SUMMARYS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.InvoiceSummaryActionOK(
						modelAction.InvoiceSummaryModelActionTypes.IMPORT_INVOICE_SUMMARYS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceSummaryActionFail(
								modelAction.InvoiceSummaryModelActionTypes.IMPORT_INVOICE_SUMMARYS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceSummaryAction>(modelAction.InvoiceSummaryModelActionTypes.FETCH_INVOICE_SUMMARY_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.InvoiceSummaryActionOK(
						modelAction.InvoiceSummaryModelActionTypes.FETCH_INVOICE_SUMMARY_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceSummaryActionFail(
								modelAction.InvoiceSummaryModelActionTypes.FETCH_INVOICE_SUMMARY_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceSummaryAction>(modelAction.InvoiceSummaryModelActionTypes.FETCH_INVOICE_SUMMARY_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.InvoiceSummaryActionOK(
						modelAction.InvoiceSummaryModelActionTypes.FETCH_INVOICE_SUMMARY_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceSummaryActionFail(
								modelAction.InvoiceSummaryModelActionTypes.FETCH_INVOICE_SUMMARY_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
