...
/**
 * MerchantCollectionState would store the state of a collection of Merchant
 */
export interface MerchantCollectionState extends CollectionState {
 ...
 */
export interface MerchantModelAudit extends AbstractModelAudit<MerchantModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * MerchantModelState would store the state of the model
 */
export interface MerchantModelState {
	collectionState: {
		[key: string]: MerchantCollectionState;
	};
	data: {
		[id: string]: MerchantModel;
	};
	totalCount: number;
	audits: MerchantModelAudit[];
 ...
 */
export const initialMerchantCollectionState: MerchantCollectionState = {
...
/**
 * The initial state of MerchantModelState
 */
export const initialState: MerchantModelState = {
	collectionState: {
