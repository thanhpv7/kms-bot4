...
/**
 * Effect class used for side effects related to Merchant model.
 */
@Injectable()
export class MerchantEffect {
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MerchantAction>(modelAction.MerchantModelActionTypes.COUNT_MERCHANTS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.MerchantActionOK(
						modelAction.MerchantModelActionTypes.COUNT_MERCHANTS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MerchantActionFail(
								modelAction.MerchantModelActionTypes.COUNT_MERCHANTS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MerchantAction>(modelAction.MerchantModelActionTypes.FETCH_MERCHANT),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MerchantActionOK(
						modelAction.MerchantModelActionTypes.FETCH_MERCHANT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MerchantActionFail(
								modelAction.MerchantModelActionTypes.FETCH_MERCHANT_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MerchantAction>(modelAction.MerchantModelActionTypes.FETCH_ALL_MERCHANT),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.MerchantActionOK(
						modelAction.MerchantModelActionTypes.FETCH_ALL_MERCHANT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MerchantActionFail(
								modelAction.MerchantModelActionTypes.FETCH_ALL_MERCHANT_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MerchantAction>(modelAction.MerchantModelActionTypes.FETCH_MERCHANT_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.MerchantActionOK(
						modelAction.MerchantModelActionTypes.FETCH_MERCHANT_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MerchantActionFail(
								modelAction.MerchantModelActionTypes.FETCH_MERCHANT_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MerchantAction>(modelAction.MerchantModelActionTypes.FETCH_LAST_MERCHANT_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.MerchantActionOK(
						modelAction.MerchantModelActionTypes.FETCH_LAST_MERCHANT_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MerchantActionFail(
								modelAction.MerchantModelActionTypes.FETCH_LAST_MERCHANT_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MerchantAction>(modelAction.MerchantModelActionTypes.CREATE_MERCHANT),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as MerchantModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MerchantActionOK(
						modelAction.MerchantModelActionTypes.CREATE_MERCHANT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MerchantActionFail(
								modelAction.MerchantModelActionTypes.CREATE_MERCHANT_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MerchantAction>(modelAction.MerchantModelActionTypes.CREATE_ALL_MERCHANT),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as MerchantModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MerchantActionOK(
						modelAction.MerchantModelActionTypes.CREATE_ALL_MERCHANT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MerchantActionFail(
								modelAction.MerchantModelActionTypes.CREATE_ALL_MERCHANT_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MerchantAction>(modelAction.MerchantModelActionTypes.UPDATE_MERCHANT),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as MerchantModel;
				...
				return this.service.update(new MerchantModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.MerchantActionOK(
						modelAction.MerchantModelActionTypes.UPDATE_MERCHANT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MerchantActionFail(
								modelAction.MerchantModelActionTypes.UPDATE_MERCHANT_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MerchantAction>(modelAction.MerchantModelActionTypes.UPDATE_ALL_MERCHANT),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as MerchantModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new MerchantModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MerchantActionOK(
						modelAction.MerchantModelActionTypes.UPDATE_ALL_MERCHANT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MerchantActionFail(
								modelAction.MerchantModelActionTypes.UPDATE_ALL_MERCHANT_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MerchantAction>(modelAction.MerchantModelActionTypes.DELETE_MERCHANT),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.MerchantActionOK(
						modelAction.MerchantModelActionTypes.DELETE_MERCHANT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MerchantActionFail(
								modelAction.MerchantModelActionTypes.DELETE_MERCHANT_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MerchantAction>(modelAction.MerchantModelActionTypes.DELETE_MERCHANT_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.MerchantActionOK(
						modelAction.MerchantModelActionTypes.DELETE_MERCHANT_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MerchantActionFail(
								modelAction.MerchantModelActionTypes.DELETE_MERCHANT_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MerchantAction>(modelAction.MerchantModelActionTypes.DELETE_ALL_MERCHANT),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.MerchantActionOK(
						modelAction.MerchantModelActionTypes.DELETE_ALL_MERCHANT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MerchantActionFail(
								modelAction.MerchantModelActionTypes.DELETE_ALL_MERCHANT_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MerchantAction>(modelAction.MerchantModelActionTypes.EXPORT_MERCHANT),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MerchantActionOK(
						modelAction.MerchantModelActionTypes.EXPORT_MERCHANT,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MerchantAction>(modelAction.MerchantModelActionTypes.EXPORT_ALL_MERCHANT),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MerchantActionOK(
						modelAction.MerchantModelActionTypes.EXPORT_ALL_MERCHANT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MerchantActionFail(
								modelAction.MerchantModelActionTypes.EXPORT_ALL_MERCHANT_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MerchantAction>(modelAction.MerchantModelActionTypes.EXPORT_MERCHANT_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MerchantActionOK(
						modelAction.MerchantModelActionTypes.EXPORT_MERCHANT_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MerchantActionFail(
								modelAction.MerchantModelActionTypes.EXPORT_MERCHANT_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MerchantAction>(modelAction.MerchantModelActionTypes.IMPORT_MERCHANTS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.MerchantActionOK(
						modelAction.MerchantModelActionTypes.IMPORT_MERCHANTS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MerchantActionFail(
								modelAction.MerchantModelActionTypes.IMPORT_MERCHANTS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MerchantAction>(modelAction.MerchantModelActionTypes.FETCH_MERCHANT_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.MerchantActionOK(
						modelAction.MerchantModelActionTypes.FETCH_MERCHANT_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.MerchantActionFail(
								modelAction.MerchantModelActionTypes.FETCH_MERCHANT_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MerchantAction>(modelAction.MerchantModelActionTypes.FETCH_MERCHANT_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.MerchantActionOK(
						modelAction.MerchantModelActionTypes.FETCH_MERCHANT_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.MerchantActionFail(
								modelAction.MerchantModelActionTypes.FETCH_MERCHANT_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
