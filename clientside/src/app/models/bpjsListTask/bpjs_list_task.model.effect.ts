...
import * as modelAction from './bpjs_list_task.model.action';
import {BpjsListTaskService} from '../../services/bpjsListTask/bpjs_list_task.service';
...
/**
 * Effect class used for side effects related to BPJS List Task model.
 */
@Injectable()
export class BpjsListTaskEffect {
	...
	constructor(
		...
		protected readonly service: BpjsListTaskService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsListTaskAction>(modelAction.BpjsListTaskModelActionTypes.COUNT_BPJS_LIST_TASKS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsListTaskActionOK(
						modelAction.BpjsListTaskModelActionTypes.COUNT_BPJS_LIST_TASKS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsListTaskActionFail(
								modelAction.BpjsListTaskModelActionTypes.COUNT_BPJS_LIST_TASKS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsListTaskAction>(modelAction.BpjsListTaskModelActionTypes.FETCH_BPJS_LIST_TASK),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsListTaskActionOK(
						modelAction.BpjsListTaskModelActionTypes.FETCH_BPJS_LIST_TASK_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsListTaskActionFail(
								modelAction.BpjsListTaskModelActionTypes.FETCH_BPJS_LIST_TASK_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsListTaskAction>(modelAction.BpjsListTaskModelActionTypes.FETCH_ALL_BPJS_LIST_TASK),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsListTaskActionOK(
						modelAction.BpjsListTaskModelActionTypes.FETCH_ALL_BPJS_LIST_TASK_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsListTaskActionFail(
								modelAction.BpjsListTaskModelActionTypes.FETCH_ALL_BPJS_LIST_TASK_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsListTaskAction>(modelAction.BpjsListTaskModelActionTypes.FETCH_BPJS_LIST_TASK_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsListTaskActionOK(
						modelAction.BpjsListTaskModelActionTypes.FETCH_BPJS_LIST_TASK_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsListTaskActionFail(
								modelAction.BpjsListTaskModelActionTypes.FETCH_BPJS_LIST_TASK_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsListTaskAction>(modelAction.BpjsListTaskModelActionTypes.FETCH_LAST_BPJS_LIST_TASK_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsListTaskActionOK(
						modelAction.BpjsListTaskModelActionTypes.FETCH_LAST_BPJS_LIST_TASK_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsListTaskActionFail(
								modelAction.BpjsListTaskModelActionTypes.FETCH_LAST_BPJS_LIST_TASK_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsListTaskAction>(modelAction.BpjsListTaskModelActionTypes.CREATE_BPJS_LIST_TASK),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsListTaskModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsListTaskActionOK(
						modelAction.BpjsListTaskModelActionTypes.CREATE_BPJS_LIST_TASK_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsListTaskActionFail(
								modelAction.BpjsListTaskModelActionTypes.CREATE_BPJS_LIST_TASK_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsListTaskAction>(modelAction.BpjsListTaskModelActionTypes.CREATE_ALL_BPJS_LIST_TASK),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsListTaskModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsListTaskActionOK(
						modelAction.BpjsListTaskModelActionTypes.CREATE_ALL_BPJS_LIST_TASK_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsListTaskActionFail(
								modelAction.BpjsListTaskModelActionTypes.CREATE_ALL_BPJS_LIST_TASK_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsListTaskAction>(modelAction.BpjsListTaskModelActionTypes.UPDATE_BPJS_LIST_TASK),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsListTaskModel;
				...
				return this.service.update(new BpjsListTaskModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsListTaskActionOK(
						modelAction.BpjsListTaskModelActionTypes.UPDATE_BPJS_LIST_TASK_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsListTaskActionFail(
								modelAction.BpjsListTaskModelActionTypes.UPDATE_BPJS_LIST_TASK_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsListTaskAction>(modelAction.BpjsListTaskModelActionTypes.UPDATE_ALL_BPJS_LIST_TASK),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsListTaskModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsListTaskModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsListTaskActionOK(
						modelAction.BpjsListTaskModelActionTypes.UPDATE_ALL_BPJS_LIST_TASK_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsListTaskActionFail(
								modelAction.BpjsListTaskModelActionTypes.UPDATE_ALL_BPJS_LIST_TASK_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsListTaskAction>(modelAction.BpjsListTaskModelActionTypes.DELETE_BPJS_LIST_TASK),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsListTaskActionOK(
						modelAction.BpjsListTaskModelActionTypes.DELETE_BPJS_LIST_TASK_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsListTaskActionFail(
								modelAction.BpjsListTaskModelActionTypes.DELETE_BPJS_LIST_TASK_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsListTaskAction>(modelAction.BpjsListTaskModelActionTypes.DELETE_BPJS_LIST_TASK_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsListTaskActionOK(
						modelAction.BpjsListTaskModelActionTypes.DELETE_BPJS_LIST_TASK_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsListTaskActionFail(
								modelAction.BpjsListTaskModelActionTypes.DELETE_BPJS_LIST_TASK_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsListTaskAction>(modelAction.BpjsListTaskModelActionTypes.DELETE_ALL_BPJS_LIST_TASK),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsListTaskActionOK(
						modelAction.BpjsListTaskModelActionTypes.DELETE_ALL_BPJS_LIST_TASK_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsListTaskActionFail(
								modelAction.BpjsListTaskModelActionTypes.DELETE_ALL_BPJS_LIST_TASK_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsListTaskAction>(modelAction.BpjsListTaskModelActionTypes.EXPORT_BPJS_LIST_TASK),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsListTaskActionOK(
						modelAction.BpjsListTaskModelActionTypes.EXPORT_BPJS_LIST_TASK,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsListTaskAction>(modelAction.BpjsListTaskModelActionTypes.EXPORT_ALL_BPJS_LIST_TASK),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsListTaskActionOK(
						modelAction.BpjsListTaskModelActionTypes.EXPORT_ALL_BPJS_LIST_TASK_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsListTaskActionFail(
								modelAction.BpjsListTaskModelActionTypes.EXPORT_ALL_BPJS_LIST_TASK_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsListTaskAction>(modelAction.BpjsListTaskModelActionTypes.EXPORT_BPJS_LIST_TASK_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsListTaskActionOK(
						modelAction.BpjsListTaskModelActionTypes.EXPORT_BPJS_LIST_TASK_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsListTaskActionFail(
								modelAction.BpjsListTaskModelActionTypes.EXPORT_BPJS_LIST_TASK_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsListTaskAction>(modelAction.BpjsListTaskModelActionTypes.IMPORT_BPJS_LIST_TASKS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsListTaskActionOK(
						modelAction.BpjsListTaskModelActionTypes.IMPORT_BPJS_LIST_TASKS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsListTaskActionFail(
								modelAction.BpjsListTaskModelActionTypes.IMPORT_BPJS_LIST_TASKS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsListTaskAction>(modelAction.BpjsListTaskModelActionTypes.FETCH_BPJS_LIST_TASK_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsListTaskActionOK(
						modelAction.BpjsListTaskModelActionTypes.FETCH_BPJS_LIST_TASK_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsListTaskActionFail(
								modelAction.BpjsListTaskModelActionTypes.FETCH_BPJS_LIST_TASK_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsListTaskAction>(modelAction.BpjsListTaskModelActionTypes.FETCH_BPJS_LIST_TASK_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsListTaskActionOK(
						modelAction.BpjsListTaskModelActionTypes.FETCH_BPJS_LIST_TASK_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsListTaskActionFail(
								modelAction.BpjsListTaskModelActionTypes.FETCH_BPJS_LIST_TASK_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
