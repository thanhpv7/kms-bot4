...
/**
 * BpjsListTaskCollectionState would store the state of a collection of BpjsListTask
 */
export interface BpjsListTaskCollectionState extends CollectionState {
 ...
 */
export interface BpjsListTaskModelAudit extends AbstractModelAudit<BpjsListTaskModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsListTaskModelState would store the state of the model
 */
export interface BpjsListTaskModelState {
	collectionState: {
		[key: string]: BpjsListTaskCollectionState;
	};
	data: {
		[id: string]: BpjsListTaskModel;
	};
	totalCount: number;
	audits: BpjsListTaskModelAudit[];
 ...
 */
export const initialBpjsListTaskCollectionState: BpjsListTaskCollectionState = {
...
/**
 * The initial state of BpjsListTaskModelState
 */
export const initialState: BpjsListTaskModelState = {
	collectionState: {
