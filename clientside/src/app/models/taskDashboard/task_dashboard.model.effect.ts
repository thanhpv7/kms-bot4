...
import * as modelAction from './task_dashboard.model.action';
import {TaskDashboardService} from '../../services/taskDashboard/task_dashboard.service';
...
/**
 * Effect class used for side effects related to Task Dashboard model.
 */
@Injectable()
export class TaskDashboardEffect {
	...
	constructor(
		...
		protected readonly service: TaskDashboardService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TaskDashboardAction>(modelAction.TaskDashboardModelActionTypes.COUNT_TASK_DASHBOARDS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.TaskDashboardActionOK(
						modelAction.TaskDashboardModelActionTypes.COUNT_TASK_DASHBOARDS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TaskDashboardActionFail(
								modelAction.TaskDashboardModelActionTypes.COUNT_TASK_DASHBOARDS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TaskDashboardAction>(modelAction.TaskDashboardModelActionTypes.FETCH_TASK_DASHBOARD),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.TaskDashboardActionOK(
						modelAction.TaskDashboardModelActionTypes.FETCH_TASK_DASHBOARD_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TaskDashboardActionFail(
								modelAction.TaskDashboardModelActionTypes.FETCH_TASK_DASHBOARD_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TaskDashboardAction>(modelAction.TaskDashboardModelActionTypes.FETCH_ALL_TASK_DASHBOARD),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.TaskDashboardActionOK(
						modelAction.TaskDashboardModelActionTypes.FETCH_ALL_TASK_DASHBOARD_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TaskDashboardActionFail(
								modelAction.TaskDashboardModelActionTypes.FETCH_ALL_TASK_DASHBOARD_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TaskDashboardAction>(modelAction.TaskDashboardModelActionTypes.FETCH_TASK_DASHBOARD_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.TaskDashboardActionOK(
						modelAction.TaskDashboardModelActionTypes.FETCH_TASK_DASHBOARD_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TaskDashboardActionFail(
								modelAction.TaskDashboardModelActionTypes.FETCH_TASK_DASHBOARD_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TaskDashboardAction>(modelAction.TaskDashboardModelActionTypes.FETCH_LAST_TASK_DASHBOARD_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.TaskDashboardActionOK(
						modelAction.TaskDashboardModelActionTypes.FETCH_LAST_TASK_DASHBOARD_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TaskDashboardActionFail(
								modelAction.TaskDashboardModelActionTypes.FETCH_LAST_TASK_DASHBOARD_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TaskDashboardAction>(modelAction.TaskDashboardModelActionTypes.CREATE_TASK_DASHBOARD),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as TaskDashboardModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.TaskDashboardActionOK(
						modelAction.TaskDashboardModelActionTypes.CREATE_TASK_DASHBOARD_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TaskDashboardActionFail(
								modelAction.TaskDashboardModelActionTypes.CREATE_TASK_DASHBOARD_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TaskDashboardAction>(modelAction.TaskDashboardModelActionTypes.CREATE_ALL_TASK_DASHBOARD),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as TaskDashboardModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.TaskDashboardActionOK(
						modelAction.TaskDashboardModelActionTypes.CREATE_ALL_TASK_DASHBOARD_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TaskDashboardActionFail(
								modelAction.TaskDashboardModelActionTypes.CREATE_ALL_TASK_DASHBOARD_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TaskDashboardAction>(modelAction.TaskDashboardModelActionTypes.UPDATE_TASK_DASHBOARD),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as TaskDashboardModel;
				...
				return this.service.update(new TaskDashboardModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.TaskDashboardActionOK(
						modelAction.TaskDashboardModelActionTypes.UPDATE_TASK_DASHBOARD_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TaskDashboardActionFail(
								modelAction.TaskDashboardModelActionTypes.UPDATE_TASK_DASHBOARD_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TaskDashboardAction>(modelAction.TaskDashboardModelActionTypes.UPDATE_ALL_TASK_DASHBOARD),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as TaskDashboardModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new TaskDashboardModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.TaskDashboardActionOK(
						modelAction.TaskDashboardModelActionTypes.UPDATE_ALL_TASK_DASHBOARD_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TaskDashboardActionFail(
								modelAction.TaskDashboardModelActionTypes.UPDATE_ALL_TASK_DASHBOARD_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TaskDashboardAction>(modelAction.TaskDashboardModelActionTypes.DELETE_TASK_DASHBOARD),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.TaskDashboardActionOK(
						modelAction.TaskDashboardModelActionTypes.DELETE_TASK_DASHBOARD_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TaskDashboardActionFail(
								modelAction.TaskDashboardModelActionTypes.DELETE_TASK_DASHBOARD_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TaskDashboardAction>(modelAction.TaskDashboardModelActionTypes.DELETE_TASK_DASHBOARD_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.TaskDashboardActionOK(
						modelAction.TaskDashboardModelActionTypes.DELETE_TASK_DASHBOARD_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TaskDashboardActionFail(
								modelAction.TaskDashboardModelActionTypes.DELETE_TASK_DASHBOARD_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TaskDashboardAction>(modelAction.TaskDashboardModelActionTypes.DELETE_ALL_TASK_DASHBOARD),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.TaskDashboardActionOK(
						modelAction.TaskDashboardModelActionTypes.DELETE_ALL_TASK_DASHBOARD_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TaskDashboardActionFail(
								modelAction.TaskDashboardModelActionTypes.DELETE_ALL_TASK_DASHBOARD_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TaskDashboardAction>(modelAction.TaskDashboardModelActionTypes.EXPORT_TASK_DASHBOARD),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.TaskDashboardActionOK(
						modelAction.TaskDashboardModelActionTypes.EXPORT_TASK_DASHBOARD,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TaskDashboardAction>(modelAction.TaskDashboardModelActionTypes.EXPORT_ALL_TASK_DASHBOARD),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.TaskDashboardActionOK(
						modelAction.TaskDashboardModelActionTypes.EXPORT_ALL_TASK_DASHBOARD_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TaskDashboardActionFail(
								modelAction.TaskDashboardModelActionTypes.EXPORT_ALL_TASK_DASHBOARD_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TaskDashboardAction>(modelAction.TaskDashboardModelActionTypes.EXPORT_TASK_DASHBOARD_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.TaskDashboardActionOK(
						modelAction.TaskDashboardModelActionTypes.EXPORT_TASK_DASHBOARD_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TaskDashboardActionFail(
								modelAction.TaskDashboardModelActionTypes.EXPORT_TASK_DASHBOARD_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TaskDashboardAction>(modelAction.TaskDashboardModelActionTypes.IMPORT_TASK_DASHBOARDS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.TaskDashboardActionOK(
						modelAction.TaskDashboardModelActionTypes.IMPORT_TASK_DASHBOARDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TaskDashboardActionFail(
								modelAction.TaskDashboardModelActionTypes.IMPORT_TASK_DASHBOARDS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TaskDashboardAction>(modelAction.TaskDashboardModelActionTypes.FETCH_TASK_DASHBOARD_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.TaskDashboardActionOK(
						modelAction.TaskDashboardModelActionTypes.FETCH_TASK_DASHBOARD_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.TaskDashboardActionFail(
								modelAction.TaskDashboardModelActionTypes.FETCH_TASK_DASHBOARD_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TaskDashboardAction>(modelAction.TaskDashboardModelActionTypes.FETCH_TASK_DASHBOARD_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.TaskDashboardActionOK(
						modelAction.TaskDashboardModelActionTypes.FETCH_TASK_DASHBOARD_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.TaskDashboardActionFail(
								modelAction.TaskDashboardModelActionTypes.FETCH_TASK_DASHBOARD_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
