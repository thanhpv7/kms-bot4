...
/**
 * TaskDashboardCollectionState would store the state of a collection of TaskDashboard
 */
export interface TaskDashboardCollectionState extends CollectionState {
 ...
 */
export interface TaskDashboardModelAudit extends AbstractModelAudit<TaskDashboardModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * TaskDashboardModelState would store the state of the model
 */
export interface TaskDashboardModelState {
	collectionState: {
		[key: string]: TaskDashboardCollectionState;
	};
	data: {
		[id: string]: TaskDashboardModel;
	};
	totalCount: number;
	audits: TaskDashboardModelAudit[];
 ...
 */
export const initialTaskDashboardCollectionState: TaskDashboardCollectionState = {
...
/**
 * The initial state of TaskDashboardModelState
 */
export const initialState: TaskDashboardModelState = {
	collectionState: {
