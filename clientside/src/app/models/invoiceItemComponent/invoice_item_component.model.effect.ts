...
import * as modelAction from './invoice_item_component.model.action';
import {InvoiceItemComponentService} from '../../services/invoiceItemComponent/invoice_item_component.service';
...
/**
 * Effect class used for side effects related to Invoice Item Component model.
 */
@Injectable()
export class InvoiceItemComponentEffect {
	...
	constructor(
		...
		protected readonly service: InvoiceItemComponentService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceItemComponentAction>(modelAction.InvoiceItemComponentModelActionTypes.COUNT_INVOICE_ITEM_COMPONENTS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.InvoiceItemComponentActionOK(
						modelAction.InvoiceItemComponentModelActionTypes.COUNT_INVOICE_ITEM_COMPONENTS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceItemComponentActionFail(
								modelAction.InvoiceItemComponentModelActionTypes.COUNT_INVOICE_ITEM_COMPONENTS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceItemComponentAction>(modelAction.InvoiceItemComponentModelActionTypes.FETCH_INVOICE_ITEM_COMPONENT),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InvoiceItemComponentActionOK(
						modelAction.InvoiceItemComponentModelActionTypes.FETCH_INVOICE_ITEM_COMPONENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceItemComponentActionFail(
								modelAction.InvoiceItemComponentModelActionTypes.FETCH_INVOICE_ITEM_COMPONENT_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceItemComponentAction>(modelAction.InvoiceItemComponentModelActionTypes.FETCH_ALL_INVOICE_ITEM_COMPONENT),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.InvoiceItemComponentActionOK(
						modelAction.InvoiceItemComponentModelActionTypes.FETCH_ALL_INVOICE_ITEM_COMPONENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceItemComponentActionFail(
								modelAction.InvoiceItemComponentModelActionTypes.FETCH_ALL_INVOICE_ITEM_COMPONENT_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceItemComponentAction>(modelAction.InvoiceItemComponentModelActionTypes.FETCH_INVOICE_ITEM_COMPONENT_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.InvoiceItemComponentActionOK(
						modelAction.InvoiceItemComponentModelActionTypes.FETCH_INVOICE_ITEM_COMPONENT_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceItemComponentActionFail(
								modelAction.InvoiceItemComponentModelActionTypes.FETCH_INVOICE_ITEM_COMPONENT_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceItemComponentAction>(modelAction.InvoiceItemComponentModelActionTypes.FETCH_LAST_INVOICE_ITEM_COMPONENT_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.InvoiceItemComponentActionOK(
						modelAction.InvoiceItemComponentModelActionTypes.FETCH_LAST_INVOICE_ITEM_COMPONENT_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceItemComponentActionFail(
								modelAction.InvoiceItemComponentModelActionTypes.FETCH_LAST_INVOICE_ITEM_COMPONENT_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceItemComponentAction>(modelAction.InvoiceItemComponentModelActionTypes.CREATE_INVOICE_ITEM_COMPONENT),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as InvoiceItemComponentModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InvoiceItemComponentActionOK(
						modelAction.InvoiceItemComponentModelActionTypes.CREATE_INVOICE_ITEM_COMPONENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceItemComponentActionFail(
								modelAction.InvoiceItemComponentModelActionTypes.CREATE_INVOICE_ITEM_COMPONENT_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceItemComponentAction>(modelAction.InvoiceItemComponentModelActionTypes.CREATE_ALL_INVOICE_ITEM_COMPONENT),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as InvoiceItemComponentModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InvoiceItemComponentActionOK(
						modelAction.InvoiceItemComponentModelActionTypes.CREATE_ALL_INVOICE_ITEM_COMPONENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceItemComponentActionFail(
								modelAction.InvoiceItemComponentModelActionTypes.CREATE_ALL_INVOICE_ITEM_COMPONENT_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceItemComponentAction>(modelAction.InvoiceItemComponentModelActionTypes.UPDATE_INVOICE_ITEM_COMPONENT),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as InvoiceItemComponentModel;
				...
				return this.service.update(new InvoiceItemComponentModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.InvoiceItemComponentActionOK(
						modelAction.InvoiceItemComponentModelActionTypes.UPDATE_INVOICE_ITEM_COMPONENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceItemComponentActionFail(
								modelAction.InvoiceItemComponentModelActionTypes.UPDATE_INVOICE_ITEM_COMPONENT_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceItemComponentAction>(modelAction.InvoiceItemComponentModelActionTypes.UPDATE_ALL_INVOICE_ITEM_COMPONENT),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as InvoiceItemComponentModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new InvoiceItemComponentModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InvoiceItemComponentActionOK(
						modelAction.InvoiceItemComponentModelActionTypes.UPDATE_ALL_INVOICE_ITEM_COMPONENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceItemComponentActionFail(
								modelAction.InvoiceItemComponentModelActionTypes.UPDATE_ALL_INVOICE_ITEM_COMPONENT_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceItemComponentAction>(modelAction.InvoiceItemComponentModelActionTypes.DELETE_INVOICE_ITEM_COMPONENT),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.InvoiceItemComponentActionOK(
						modelAction.InvoiceItemComponentModelActionTypes.DELETE_INVOICE_ITEM_COMPONENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceItemComponentActionFail(
								modelAction.InvoiceItemComponentModelActionTypes.DELETE_INVOICE_ITEM_COMPONENT_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceItemComponentAction>(modelAction.InvoiceItemComponentModelActionTypes.DELETE_INVOICE_ITEM_COMPONENT_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.InvoiceItemComponentActionOK(
						modelAction.InvoiceItemComponentModelActionTypes.DELETE_INVOICE_ITEM_COMPONENT_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceItemComponentActionFail(
								modelAction.InvoiceItemComponentModelActionTypes.DELETE_INVOICE_ITEM_COMPONENT_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceItemComponentAction>(modelAction.InvoiceItemComponentModelActionTypes.DELETE_ALL_INVOICE_ITEM_COMPONENT),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.InvoiceItemComponentActionOK(
						modelAction.InvoiceItemComponentModelActionTypes.DELETE_ALL_INVOICE_ITEM_COMPONENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceItemComponentActionFail(
								modelAction.InvoiceItemComponentModelActionTypes.DELETE_ALL_INVOICE_ITEM_COMPONENT_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceItemComponentAction>(modelAction.InvoiceItemComponentModelActionTypes.EXPORT_INVOICE_ITEM_COMPONENT),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.InvoiceItemComponentActionOK(
						modelAction.InvoiceItemComponentModelActionTypes.EXPORT_INVOICE_ITEM_COMPONENT,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceItemComponentAction>(modelAction.InvoiceItemComponentModelActionTypes.EXPORT_ALL_INVOICE_ITEM_COMPONENT),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.InvoiceItemComponentActionOK(
						modelAction.InvoiceItemComponentModelActionTypes.EXPORT_ALL_INVOICE_ITEM_COMPONENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceItemComponentActionFail(
								modelAction.InvoiceItemComponentModelActionTypes.EXPORT_ALL_INVOICE_ITEM_COMPONENT_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceItemComponentAction>(modelAction.InvoiceItemComponentModelActionTypes.EXPORT_INVOICE_ITEM_COMPONENT_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.InvoiceItemComponentActionOK(
						modelAction.InvoiceItemComponentModelActionTypes.EXPORT_INVOICE_ITEM_COMPONENT_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceItemComponentActionFail(
								modelAction.InvoiceItemComponentModelActionTypes.EXPORT_INVOICE_ITEM_COMPONENT_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceItemComponentAction>(modelAction.InvoiceItemComponentModelActionTypes.IMPORT_INVOICE_ITEM_COMPONENTS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.InvoiceItemComponentActionOK(
						modelAction.InvoiceItemComponentModelActionTypes.IMPORT_INVOICE_ITEM_COMPONENTS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceItemComponentActionFail(
								modelAction.InvoiceItemComponentModelActionTypes.IMPORT_INVOICE_ITEM_COMPONENTS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceItemComponentAction>(modelAction.InvoiceItemComponentModelActionTypes.FETCH_INVOICE_ITEM_COMPONENT_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.InvoiceItemComponentActionOK(
						modelAction.InvoiceItemComponentModelActionTypes.FETCH_INVOICE_ITEM_COMPONENT_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceItemComponentActionFail(
								modelAction.InvoiceItemComponentModelActionTypes.FETCH_INVOICE_ITEM_COMPONENT_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceItemComponentAction>(modelAction.InvoiceItemComponentModelActionTypes.FETCH_INVOICE_ITEM_COMPONENT_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.InvoiceItemComponentActionOK(
						modelAction.InvoiceItemComponentModelActionTypes.FETCH_INVOICE_ITEM_COMPONENT_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceItemComponentActionFail(
								modelAction.InvoiceItemComponentModelActionTypes.FETCH_INVOICE_ITEM_COMPONENT_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
