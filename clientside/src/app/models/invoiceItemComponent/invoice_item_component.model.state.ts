...
/**
 * InvoiceItemComponentCollectionState would store the state of a collection of InvoiceItemComponent
 */
export interface InvoiceItemComponentCollectionState extends CollectionState {
 ...
 */
export interface InvoiceItemComponentModelAudit extends AbstractModelAudit<InvoiceItemComponentModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * InvoiceItemComponentModelState would store the state of the model
 */
export interface InvoiceItemComponentModelState {
	collectionState: {
		[key: string]: InvoiceItemComponentCollectionState;
	};
	data: {
		[id: string]: InvoiceItemComponentModel;
	};
	totalCount: number;
	audits: InvoiceItemComponentModelAudit[];
 ...
 */
export const initialInvoiceItemComponentCollectionState: InvoiceItemComponentCollectionState = {
...
/**
 * The initial state of InvoiceItemComponentModelState
 */
export const initialState: InvoiceItemComponentModelState = {
	collectionState: {
