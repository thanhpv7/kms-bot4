...
import * as modelAction from './bpjs_sep.model.action';
import {BpjsSEPService} from '../../services/bpjsSEP/bpjs_sep.service';
...
/**
 * Effect class used for side effects related to BPJS SEP model.
 */
@Injectable()
export class BpjsSEPEffect {
	...
	constructor(
		...
		protected readonly service: BpjsSEPService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPAction>(modelAction.BpjsSEPModelActionTypes.COUNT_BPJS_SEPS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPActionOK(
						modelAction.BpjsSEPModelActionTypes.COUNT_BPJS_SEPS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPActionFail(
								modelAction.BpjsSEPModelActionTypes.COUNT_BPJS_SEPS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPAction>(modelAction.BpjsSEPModelActionTypes.FETCH_BPJS_SEP),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPActionOK(
						modelAction.BpjsSEPModelActionTypes.FETCH_BPJS_SEP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPActionFail(
								modelAction.BpjsSEPModelActionTypes.FETCH_BPJS_SEP_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPAction>(modelAction.BpjsSEPModelActionTypes.FETCH_ALL_BPJS_SEP),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPActionOK(
						modelAction.BpjsSEPModelActionTypes.FETCH_ALL_BPJS_SEP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPActionFail(
								modelAction.BpjsSEPModelActionTypes.FETCH_ALL_BPJS_SEP_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPAction>(modelAction.BpjsSEPModelActionTypes.FETCH_BPJS_SEP_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPActionOK(
						modelAction.BpjsSEPModelActionTypes.FETCH_BPJS_SEP_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPActionFail(
								modelAction.BpjsSEPModelActionTypes.FETCH_BPJS_SEP_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPAction>(modelAction.BpjsSEPModelActionTypes.FETCH_LAST_BPJS_SEP_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPActionOK(
						modelAction.BpjsSEPModelActionTypes.FETCH_LAST_BPJS_SEP_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPActionFail(
								modelAction.BpjsSEPModelActionTypes.FETCH_LAST_BPJS_SEP_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPAction>(modelAction.BpjsSEPModelActionTypes.CREATE_BPJS_SEP),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsSEPModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPActionOK(
						modelAction.BpjsSEPModelActionTypes.CREATE_BPJS_SEP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPActionFail(
								modelAction.BpjsSEPModelActionTypes.CREATE_BPJS_SEP_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPAction>(modelAction.BpjsSEPModelActionTypes.CREATE_ALL_BPJS_SEP),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsSEPModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPActionOK(
						modelAction.BpjsSEPModelActionTypes.CREATE_ALL_BPJS_SEP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPActionFail(
								modelAction.BpjsSEPModelActionTypes.CREATE_ALL_BPJS_SEP_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPAction>(modelAction.BpjsSEPModelActionTypes.UPDATE_BPJS_SEP),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsSEPModel;
				...
				return this.service.update(new BpjsSEPModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPActionOK(
						modelAction.BpjsSEPModelActionTypes.UPDATE_BPJS_SEP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPActionFail(
								modelAction.BpjsSEPModelActionTypes.UPDATE_BPJS_SEP_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPAction>(modelAction.BpjsSEPModelActionTypes.UPDATE_ALL_BPJS_SEP),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsSEPModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsSEPModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPActionOK(
						modelAction.BpjsSEPModelActionTypes.UPDATE_ALL_BPJS_SEP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPActionFail(
								modelAction.BpjsSEPModelActionTypes.UPDATE_ALL_BPJS_SEP_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPAction>(modelAction.BpjsSEPModelActionTypes.DELETE_BPJS_SEP),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPActionOK(
						modelAction.BpjsSEPModelActionTypes.DELETE_BPJS_SEP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPActionFail(
								modelAction.BpjsSEPModelActionTypes.DELETE_BPJS_SEP_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPAction>(modelAction.BpjsSEPModelActionTypes.DELETE_BPJS_SEP_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPActionOK(
						modelAction.BpjsSEPModelActionTypes.DELETE_BPJS_SEP_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPActionFail(
								modelAction.BpjsSEPModelActionTypes.DELETE_BPJS_SEP_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPAction>(modelAction.BpjsSEPModelActionTypes.DELETE_ALL_BPJS_SEP),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPActionOK(
						modelAction.BpjsSEPModelActionTypes.DELETE_ALL_BPJS_SEP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPActionFail(
								modelAction.BpjsSEPModelActionTypes.DELETE_ALL_BPJS_SEP_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPAction>(modelAction.BpjsSEPModelActionTypes.EXPORT_BPJS_SEP),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPActionOK(
						modelAction.BpjsSEPModelActionTypes.EXPORT_BPJS_SEP,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPAction>(modelAction.BpjsSEPModelActionTypes.EXPORT_ALL_BPJS_SEP),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPActionOK(
						modelAction.BpjsSEPModelActionTypes.EXPORT_ALL_BPJS_SEP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPActionFail(
								modelAction.BpjsSEPModelActionTypes.EXPORT_ALL_BPJS_SEP_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPAction>(modelAction.BpjsSEPModelActionTypes.EXPORT_BPJS_SEP_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPActionOK(
						modelAction.BpjsSEPModelActionTypes.EXPORT_BPJS_SEP_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPActionFail(
								modelAction.BpjsSEPModelActionTypes.EXPORT_BPJS_SEP_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPAction>(modelAction.BpjsSEPModelActionTypes.IMPORT_BPJS_SEPS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPActionOK(
						modelAction.BpjsSEPModelActionTypes.IMPORT_BPJS_SEPS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPActionFail(
								modelAction.BpjsSEPModelActionTypes.IMPORT_BPJS_SEPS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPAction>(modelAction.BpjsSEPModelActionTypes.FETCH_BPJS_SEP_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsSEPActionOK(
						modelAction.BpjsSEPModelActionTypes.FETCH_BPJS_SEP_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPActionFail(
								modelAction.BpjsSEPModelActionTypes.FETCH_BPJS_SEP_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPAction>(modelAction.BpjsSEPModelActionTypes.FETCH_BPJS_SEP_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsSEPActionOK(
						modelAction.BpjsSEPModelActionTypes.FETCH_BPJS_SEP_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPActionFail(
								modelAction.BpjsSEPModelActionTypes.FETCH_BPJS_SEP_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
