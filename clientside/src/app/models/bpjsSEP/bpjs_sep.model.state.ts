...
/**
 * BpjsSEPCollectionState would store the state of a collection of BpjsSEP
 */
export interface BpjsSEPCollectionState extends CollectionState {
 ...
 */
export interface BpjsSEPModelAudit extends AbstractModelAudit<BpjsSEPModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsSEPModelState would store the state of the model
 */
export interface BpjsSEPModelState {
	collectionState: {
		[key: string]: BpjsSEPCollectionState;
	};
	data: {
		[id: string]: BpjsSEPModel;
	};
	totalCount: number;
	audits: BpjsSEPModelAudit[];
 ...
 */
export const initialBpjsSEPCollectionState: BpjsSEPCollectionState = {
...
/**
 * The initial state of BpjsSEPModelState
 */
export const initialState: BpjsSEPModelState = {
	collectionState: {
