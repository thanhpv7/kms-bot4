...
import * as modelAction from './pcare_tindakan.model.action';
import {PcareTindakanService} from '../../services/pcareTindakan/pcare_tindakan.service';
...
/**
 * Effect class used for side effects related to PCare Tindakan model.
 */
@Injectable()
export class PcareTindakanEffect {
	...
	constructor(
		...
		protected readonly service: PcareTindakanService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareTindakanAction>(modelAction.PcareTindakanModelActionTypes.COUNT_PCARE_TINDAKANS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.PcareTindakanActionOK(
						modelAction.PcareTindakanModelActionTypes.COUNT_PCARE_TINDAKANS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareTindakanActionFail(
								modelAction.PcareTindakanModelActionTypes.COUNT_PCARE_TINDAKANS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareTindakanAction>(modelAction.PcareTindakanModelActionTypes.FETCH_PCARE_TINDAKAN),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareTindakanActionOK(
						modelAction.PcareTindakanModelActionTypes.FETCH_PCARE_TINDAKAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareTindakanActionFail(
								modelAction.PcareTindakanModelActionTypes.FETCH_PCARE_TINDAKAN_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareTindakanAction>(modelAction.PcareTindakanModelActionTypes.FETCH_ALL_PCARE_TINDAKAN),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.PcareTindakanActionOK(
						modelAction.PcareTindakanModelActionTypes.FETCH_ALL_PCARE_TINDAKAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareTindakanActionFail(
								modelAction.PcareTindakanModelActionTypes.FETCH_ALL_PCARE_TINDAKAN_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareTindakanAction>(modelAction.PcareTindakanModelActionTypes.FETCH_PCARE_TINDAKAN_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareTindakanActionOK(
						modelAction.PcareTindakanModelActionTypes.FETCH_PCARE_TINDAKAN_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareTindakanActionFail(
								modelAction.PcareTindakanModelActionTypes.FETCH_PCARE_TINDAKAN_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareTindakanAction>(modelAction.PcareTindakanModelActionTypes.FETCH_LAST_PCARE_TINDAKAN_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareTindakanActionOK(
						modelAction.PcareTindakanModelActionTypes.FETCH_LAST_PCARE_TINDAKAN_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareTindakanActionFail(
								modelAction.PcareTindakanModelActionTypes.FETCH_LAST_PCARE_TINDAKAN_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareTindakanAction>(modelAction.PcareTindakanModelActionTypes.CREATE_PCARE_TINDAKAN),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as PcareTindakanModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareTindakanActionOK(
						modelAction.PcareTindakanModelActionTypes.CREATE_PCARE_TINDAKAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareTindakanActionFail(
								modelAction.PcareTindakanModelActionTypes.CREATE_PCARE_TINDAKAN_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareTindakanAction>(modelAction.PcareTindakanModelActionTypes.CREATE_ALL_PCARE_TINDAKAN),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as PcareTindakanModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareTindakanActionOK(
						modelAction.PcareTindakanModelActionTypes.CREATE_ALL_PCARE_TINDAKAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareTindakanActionFail(
								modelAction.PcareTindakanModelActionTypes.CREATE_ALL_PCARE_TINDAKAN_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareTindakanAction>(modelAction.PcareTindakanModelActionTypes.UPDATE_PCARE_TINDAKAN),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as PcareTindakanModel;
				...
				return this.service.update(new PcareTindakanModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareTindakanActionOK(
						modelAction.PcareTindakanModelActionTypes.UPDATE_PCARE_TINDAKAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareTindakanActionFail(
								modelAction.PcareTindakanModelActionTypes.UPDATE_PCARE_TINDAKAN_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareTindakanAction>(modelAction.PcareTindakanModelActionTypes.UPDATE_ALL_PCARE_TINDAKAN),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as PcareTindakanModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new PcareTindakanModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareTindakanActionOK(
						modelAction.PcareTindakanModelActionTypes.UPDATE_ALL_PCARE_TINDAKAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareTindakanActionFail(
								modelAction.PcareTindakanModelActionTypes.UPDATE_ALL_PCARE_TINDAKAN_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareTindakanAction>(modelAction.PcareTindakanModelActionTypes.DELETE_PCARE_TINDAKAN),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PcareTindakanActionOK(
						modelAction.PcareTindakanModelActionTypes.DELETE_PCARE_TINDAKAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareTindakanActionFail(
								modelAction.PcareTindakanModelActionTypes.DELETE_PCARE_TINDAKAN_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareTindakanAction>(modelAction.PcareTindakanModelActionTypes.DELETE_PCARE_TINDAKAN_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.PcareTindakanActionOK(
						modelAction.PcareTindakanModelActionTypes.DELETE_PCARE_TINDAKAN_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareTindakanActionFail(
								modelAction.PcareTindakanModelActionTypes.DELETE_PCARE_TINDAKAN_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareTindakanAction>(modelAction.PcareTindakanModelActionTypes.DELETE_ALL_PCARE_TINDAKAN),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PcareTindakanActionOK(
						modelAction.PcareTindakanModelActionTypes.DELETE_ALL_PCARE_TINDAKAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareTindakanActionFail(
								modelAction.PcareTindakanModelActionTypes.DELETE_ALL_PCARE_TINDAKAN_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareTindakanAction>(modelAction.PcareTindakanModelActionTypes.EXPORT_PCARE_TINDAKAN),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PcareTindakanActionOK(
						modelAction.PcareTindakanModelActionTypes.EXPORT_PCARE_TINDAKAN,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareTindakanAction>(modelAction.PcareTindakanModelActionTypes.EXPORT_ALL_PCARE_TINDAKAN),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PcareTindakanActionOK(
						modelAction.PcareTindakanModelActionTypes.EXPORT_ALL_PCARE_TINDAKAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareTindakanActionFail(
								modelAction.PcareTindakanModelActionTypes.EXPORT_ALL_PCARE_TINDAKAN_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareTindakanAction>(modelAction.PcareTindakanModelActionTypes.EXPORT_PCARE_TINDAKAN_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PcareTindakanActionOK(
						modelAction.PcareTindakanModelActionTypes.EXPORT_PCARE_TINDAKAN_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareTindakanActionFail(
								modelAction.PcareTindakanModelActionTypes.EXPORT_PCARE_TINDAKAN_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareTindakanAction>(modelAction.PcareTindakanModelActionTypes.IMPORT_PCARE_TINDAKANS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.PcareTindakanActionOK(
						modelAction.PcareTindakanModelActionTypes.IMPORT_PCARE_TINDAKANS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareTindakanActionFail(
								modelAction.PcareTindakanModelActionTypes.IMPORT_PCARE_TINDAKANS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareTindakanAction>(modelAction.PcareTindakanModelActionTypes.FETCH_PCARE_TINDAKAN_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.PcareTindakanActionOK(
						modelAction.PcareTindakanModelActionTypes.FETCH_PCARE_TINDAKAN_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PcareTindakanActionFail(
								modelAction.PcareTindakanModelActionTypes.FETCH_PCARE_TINDAKAN_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareTindakanAction>(modelAction.PcareTindakanModelActionTypes.FETCH_PCARE_TINDAKAN_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.PcareTindakanActionOK(
						modelAction.PcareTindakanModelActionTypes.FETCH_PCARE_TINDAKAN_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PcareTindakanActionFail(
								modelAction.PcareTindakanModelActionTypes.FETCH_PCARE_TINDAKAN_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
