...
/**
 * PcareTindakanCollectionState would store the state of a collection of PcareTindakan
 */
export interface PcareTindakanCollectionState extends CollectionState {
 ...
 */
export interface PcareTindakanModelAudit extends AbstractModelAudit<PcareTindakanModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * PcareTindakanModelState would store the state of the model
 */
export interface PcareTindakanModelState {
	collectionState: {
		[key: string]: PcareTindakanCollectionState;
	};
	data: {
		[id: string]: PcareTindakanModel;
	};
	totalCount: number;
	audits: PcareTindakanModelAudit[];
 ...
 */
export const initialPcareTindakanCollectionState: PcareTindakanCollectionState = {
...
/**
 * The initial state of PcareTindakanModelState
 */
export const initialState: PcareTindakanModelState = {
	collectionState: {
