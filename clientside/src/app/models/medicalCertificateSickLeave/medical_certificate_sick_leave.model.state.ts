...
/**
 * MedicalCertificateSickLeaveCollectionState would store the state of a collection of MedicalCertificateSickLeave
 */
export interface MedicalCertificateSickLeaveCollectionState extends CollectionState {
 ...
 */
export interface MedicalCertificateSickLeaveModelAudit extends AbstractModelAudit<MedicalCertificateSickLeaveModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * MedicalCertificateSickLeaveModelState would store the state of the model
 */
export interface MedicalCertificateSickLeaveModelState {
	collectionState: {
		[key: string]: MedicalCertificateSickLeaveCollectionState;
	};
	data: {
		[id: string]: MedicalCertificateSickLeaveModel;
	};
	totalCount: number;
	audits: MedicalCertificateSickLeaveModelAudit[];
 ...
 */
export const initialMedicalCertificateSickLeaveCollectionState: MedicalCertificateSickLeaveCollectionState = {
...
/**
 * The initial state of MedicalCertificateSickLeaveModelState
 */
export const initialState: MedicalCertificateSickLeaveModelState = {
	collectionState: {
