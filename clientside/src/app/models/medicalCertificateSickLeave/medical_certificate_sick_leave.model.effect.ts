...
import * as modelAction from './medical_certificate_sick_leave.model.action';
import {MedicalCertificateSickLeaveService} from '../../services/medicalCertificateSickLeave/medical_certificate_sick_leave.service';
...
/**
 * Effect class used for side effects related to Medical Certificate Sick Leave model.
 */
@Injectable()
export class MedicalCertificateSickLeaveEffect {
	...
	constructor(
		...
		protected readonly service: MedicalCertificateSickLeaveService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateSickLeaveAction>(modelAction.MedicalCertificateSickLeaveModelActionTypes.COUNT_MEDICAL_CERTIFICATE_SICK_LEAVES),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateSickLeaveActionOK(
						modelAction.MedicalCertificateSickLeaveModelActionTypes.COUNT_MEDICAL_CERTIFICATE_SICK_LEAVES_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateSickLeaveActionFail(
								modelAction.MedicalCertificateSickLeaveModelActionTypes.COUNT_MEDICAL_CERTIFICATE_SICK_LEAVES_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateSickLeaveAction>(modelAction.MedicalCertificateSickLeaveModelActionTypes.FETCH_MEDICAL_CERTIFICATE_SICK_LEAVE),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateSickLeaveActionOK(
						modelAction.MedicalCertificateSickLeaveModelActionTypes.FETCH_MEDICAL_CERTIFICATE_SICK_LEAVE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateSickLeaveActionFail(
								modelAction.MedicalCertificateSickLeaveModelActionTypes.FETCH_MEDICAL_CERTIFICATE_SICK_LEAVE_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateSickLeaveAction>(modelAction.MedicalCertificateSickLeaveModelActionTypes.FETCH_ALL_MEDICAL_CERTIFICATE_SICK_LEAVE),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateSickLeaveActionOK(
						modelAction.MedicalCertificateSickLeaveModelActionTypes.FETCH_ALL_MEDICAL_CERTIFICATE_SICK_LEAVE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateSickLeaveActionFail(
								modelAction.MedicalCertificateSickLeaveModelActionTypes.FETCH_ALL_MEDICAL_CERTIFICATE_SICK_LEAVE_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateSickLeaveAction>(modelAction.MedicalCertificateSickLeaveModelActionTypes.FETCH_MEDICAL_CERTIFICATE_SICK_LEAVE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateSickLeaveActionOK(
						modelAction.MedicalCertificateSickLeaveModelActionTypes.FETCH_MEDICAL_CERTIFICATE_SICK_LEAVE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateSickLeaveActionFail(
								modelAction.MedicalCertificateSickLeaveModelActionTypes.FETCH_MEDICAL_CERTIFICATE_SICK_LEAVE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateSickLeaveAction>(modelAction.MedicalCertificateSickLeaveModelActionTypes.FETCH_LAST_MEDICAL_CERTIFICATE_SICK_LEAVE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateSickLeaveActionOK(
						modelAction.MedicalCertificateSickLeaveModelActionTypes.FETCH_LAST_MEDICAL_CERTIFICATE_SICK_LEAVE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateSickLeaveActionFail(
								modelAction.MedicalCertificateSickLeaveModelActionTypes.FETCH_LAST_MEDICAL_CERTIFICATE_SICK_LEAVE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateSickLeaveAction>(modelAction.MedicalCertificateSickLeaveModelActionTypes.CREATE_MEDICAL_CERTIFICATE_SICK_LEAVE),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as MedicalCertificateSickLeaveModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateSickLeaveActionOK(
						modelAction.MedicalCertificateSickLeaveModelActionTypes.CREATE_MEDICAL_CERTIFICATE_SICK_LEAVE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateSickLeaveActionFail(
								modelAction.MedicalCertificateSickLeaveModelActionTypes.CREATE_MEDICAL_CERTIFICATE_SICK_LEAVE_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateSickLeaveAction>(modelAction.MedicalCertificateSickLeaveModelActionTypes.CREATE_ALL_MEDICAL_CERTIFICATE_SICK_LEAVE),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as MedicalCertificateSickLeaveModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateSickLeaveActionOK(
						modelAction.MedicalCertificateSickLeaveModelActionTypes.CREATE_ALL_MEDICAL_CERTIFICATE_SICK_LEAVE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateSickLeaveActionFail(
								modelAction.MedicalCertificateSickLeaveModelActionTypes.CREATE_ALL_MEDICAL_CERTIFICATE_SICK_LEAVE_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateSickLeaveAction>(modelAction.MedicalCertificateSickLeaveModelActionTypes.UPDATE_MEDICAL_CERTIFICATE_SICK_LEAVE),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as MedicalCertificateSickLeaveModel;
				...
				return this.service.update(new MedicalCertificateSickLeaveModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateSickLeaveActionOK(
						modelAction.MedicalCertificateSickLeaveModelActionTypes.UPDATE_MEDICAL_CERTIFICATE_SICK_LEAVE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateSickLeaveActionFail(
								modelAction.MedicalCertificateSickLeaveModelActionTypes.UPDATE_MEDICAL_CERTIFICATE_SICK_LEAVE_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateSickLeaveAction>(modelAction.MedicalCertificateSickLeaveModelActionTypes.UPDATE_ALL_MEDICAL_CERTIFICATE_SICK_LEAVE),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as MedicalCertificateSickLeaveModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new MedicalCertificateSickLeaveModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateSickLeaveActionOK(
						modelAction.MedicalCertificateSickLeaveModelActionTypes.UPDATE_ALL_MEDICAL_CERTIFICATE_SICK_LEAVE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateSickLeaveActionFail(
								modelAction.MedicalCertificateSickLeaveModelActionTypes.UPDATE_ALL_MEDICAL_CERTIFICATE_SICK_LEAVE_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateSickLeaveAction>(modelAction.MedicalCertificateSickLeaveModelActionTypes.DELETE_MEDICAL_CERTIFICATE_SICK_LEAVE),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateSickLeaveActionOK(
						modelAction.MedicalCertificateSickLeaveModelActionTypes.DELETE_MEDICAL_CERTIFICATE_SICK_LEAVE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateSickLeaveActionFail(
								modelAction.MedicalCertificateSickLeaveModelActionTypes.DELETE_MEDICAL_CERTIFICATE_SICK_LEAVE_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateSickLeaveAction>(modelAction.MedicalCertificateSickLeaveModelActionTypes.DELETE_MEDICAL_CERTIFICATE_SICK_LEAVE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateSickLeaveActionOK(
						modelAction.MedicalCertificateSickLeaveModelActionTypes.DELETE_MEDICAL_CERTIFICATE_SICK_LEAVE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateSickLeaveActionFail(
								modelAction.MedicalCertificateSickLeaveModelActionTypes.DELETE_MEDICAL_CERTIFICATE_SICK_LEAVE_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateSickLeaveAction>(modelAction.MedicalCertificateSickLeaveModelActionTypes.DELETE_ALL_MEDICAL_CERTIFICATE_SICK_LEAVE),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateSickLeaveActionOK(
						modelAction.MedicalCertificateSickLeaveModelActionTypes.DELETE_ALL_MEDICAL_CERTIFICATE_SICK_LEAVE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateSickLeaveActionFail(
								modelAction.MedicalCertificateSickLeaveModelActionTypes.DELETE_ALL_MEDICAL_CERTIFICATE_SICK_LEAVE_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateSickLeaveAction>(modelAction.MedicalCertificateSickLeaveModelActionTypes.EXPORT_MEDICAL_CERTIFICATE_SICK_LEAVE),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateSickLeaveActionOK(
						modelAction.MedicalCertificateSickLeaveModelActionTypes.EXPORT_MEDICAL_CERTIFICATE_SICK_LEAVE,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateSickLeaveAction>(modelAction.MedicalCertificateSickLeaveModelActionTypes.EXPORT_ALL_MEDICAL_CERTIFICATE_SICK_LEAVE),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateSickLeaveActionOK(
						modelAction.MedicalCertificateSickLeaveModelActionTypes.EXPORT_ALL_MEDICAL_CERTIFICATE_SICK_LEAVE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateSickLeaveActionFail(
								modelAction.MedicalCertificateSickLeaveModelActionTypes.EXPORT_ALL_MEDICAL_CERTIFICATE_SICK_LEAVE_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateSickLeaveAction>(modelAction.MedicalCertificateSickLeaveModelActionTypes.EXPORT_MEDICAL_CERTIFICATE_SICK_LEAVE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateSickLeaveActionOK(
						modelAction.MedicalCertificateSickLeaveModelActionTypes.EXPORT_MEDICAL_CERTIFICATE_SICK_LEAVE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateSickLeaveActionFail(
								modelAction.MedicalCertificateSickLeaveModelActionTypes.EXPORT_MEDICAL_CERTIFICATE_SICK_LEAVE_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateSickLeaveAction>(modelAction.MedicalCertificateSickLeaveModelActionTypes.IMPORT_MEDICAL_CERTIFICATE_SICK_LEAVES),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateSickLeaveActionOK(
						modelAction.MedicalCertificateSickLeaveModelActionTypes.IMPORT_MEDICAL_CERTIFICATE_SICK_LEAVES_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateSickLeaveActionFail(
								modelAction.MedicalCertificateSickLeaveModelActionTypes.IMPORT_MEDICAL_CERTIFICATE_SICK_LEAVES_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateSickLeaveAction>(modelAction.MedicalCertificateSickLeaveModelActionTypes.FETCH_MEDICAL_CERTIFICATE_SICK_LEAVE_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.MedicalCertificateSickLeaveActionOK(
						modelAction.MedicalCertificateSickLeaveModelActionTypes.FETCH_MEDICAL_CERTIFICATE_SICK_LEAVE_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateSickLeaveActionFail(
								modelAction.MedicalCertificateSickLeaveModelActionTypes.FETCH_MEDICAL_CERTIFICATE_SICK_LEAVE_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateSickLeaveAction>(modelAction.MedicalCertificateSickLeaveModelActionTypes.FETCH_MEDICAL_CERTIFICATE_SICK_LEAVE_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.MedicalCertificateSickLeaveActionOK(
						modelAction.MedicalCertificateSickLeaveModelActionTypes.FETCH_MEDICAL_CERTIFICATE_SICK_LEAVE_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateSickLeaveActionFail(
								modelAction.MedicalCertificateSickLeaveModelActionTypes.FETCH_MEDICAL_CERTIFICATE_SICK_LEAVE_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
