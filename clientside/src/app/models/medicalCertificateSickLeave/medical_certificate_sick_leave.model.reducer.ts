...
import {initialMedicalCertificateSickLeaveCollectionState} from './medical_certificate_sick_leave.model.state';
...
export function modelReducer(currentState: ModelState, action: Action): ModelState {
	...
	const className = (action as modelAction.BaseMedicalCertificateSickLeaveAction).className;
	...
	return produce(currentState, draft => {
		...
		switch (action.type) {
			case modelAction.MedicalCertificateSickLeaveModelActionTypes.CREATE_MEDICAL_CERTIFICATE_SICK_LEAVE_OK:
				const createdModel = (action as modelAction.MedicalCertificateSickLeaveActionOK ).stateConfig.targetModel;
				...
				MedicalCertificateSickLeaveModel.deepParse(createdModel).forEach(model => {
				...
				break;
			case modelAction.MedicalCertificateSickLeaveModelActionTypes.CREATE_MEDICAL_CERTIFICATE_SICK_LEAVE_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.MedicalCertificateSickLeaveModelActionTypes.CREATE_ALL_MEDICAL_CERTIFICATE_SICK_LEAVE_OK:
				const createdModels = (action as modelAction.MedicalCertificateSickLeaveActionOK).stateConfig.targetModels;
				const collectionIdAfterCreateAll = (action as modelAction.MedicalCertificateSickLeaveActionOK).stateConfig.collectionId;
				...
				createdModels.forEach((m) => {
					MedicalCertificateSickLeaveModel.deepParse(m).forEach(model => {
						draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
						(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
					});
				});
				...
				break;
			case modelAction.MedicalCertificateSickLeaveModelActionTypes.CREATE_ALL_MEDICAL_CERTIFICATE_SICK_LEAVE_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.MedicalCertificateSickLeaveModelActionTypes.DELETE_MEDICAL_CERTIFICATE_SICK_LEAVE_OK:
				const deletedModelId = (action as modelAction.MedicalCertificateSickLeaveActionOK).stateConfig.targetModelId;
				const collectionIdAfterDelete = (action as modelAction.MedicalCertificateSickLeaveActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.MedicalCertificateSickLeaveModelActionTypes.DELETE_ALL_MEDICAL_CERTIFICATE_SICK_LEAVE_OK:
				const deletedModelIds = (action as modelAction.MedicalCertificateSickLeaveActionOK).stateConfig.targetModelIds;
				const collectionIdAfterDeleteAll = (action as modelAction.MedicalCertificateSickLeaveActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.MedicalCertificateSickLeaveModelActionTypes.DELETE_MEDICAL_CERTIFICATE_SICK_LEAVE_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.MedicalCertificateSickLeaveModelActionTypes.UPDATE_MEDICAL_CERTIFICATE_SICK_LEAVE_OK:
				const updatedModel = (action as modelAction.MedicalCertificateSickLeaveActionOK).stateConfig.targetModel;
				...
				MedicalCertificateSickLeaveModel.deepParse(updatedModel).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalCertificateSickLeaveModelActionTypes.UPDATE_MEDICAL_CERTIFICATE_SICK_LEAVE_FAIL:
				// TODO: Add handling of failure
				break;

			case modelAction.MedicalCertificateSickLeaveModelActionTypes.UPDATE_ALL_MEDICAL_CERTIFICATE_SICK_LEAVE_OK:
				const updatedModels = (action as modelAction.MedicalCertificateSickLeaveActionOK).stateConfig.targetModels;
				const collectionIdAfterUpdateAll = (action as modelAction.MedicalCertificateSickLeaveActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.MedicalCertificateSickLeaveModelActionTypes.UPDATE_ALL_MEDICAL_CERTIFICATE_SICK_LEAVE_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.MedicalCertificateSickLeaveModelActionTypes.FETCH_MEDICAL_CERTIFICATE_SICK_LEAVE_OK:
				let fetchedModel = (action as modelAction.MedicalCertificateSickLeaveActionOK).stateConfig.targetModel;
				...
				MedicalCertificateSickLeaveModel.deepParse(fetchedModel).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalCertificateSickLeaveModelActionTypes.FETCH_ALL_MEDICAL_CERTIFICATE_SICK_LEAVE_OK:
				const totalCountAfterFetchAll = (action as modelAction.MedicalCertificateSickLeaveActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchAll = (action as modelAction.MedicalCertificateSickLeaveActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchAll = (action as modelAction.MedicalCertificateSickLeaveActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchAll = (action as modelAction.MedicalCertificateSickLeaveActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchAll.map(model => MedicalCertificateSickLeaveModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalCertificateSickLeaveModelActionTypes.FETCH_MEDICAL_CERTIFICATE_SICK_LEAVE_AUDIT_OK:
				const audits = (action as modelAction.MedicalCertificateSickLeaveActionOK).audits;
				...
				break;
			case modelAction.MedicalCertificateSickLeaveModelActionTypes.FETCH_MEDICAL_CERTIFICATE_SICK_LEAVE_AUDITS_BY_ENTITY_ID_OK:
				const auditsByEntityId = (action as modelAction.MedicalCertificateSickLeaveActionOK).audits;
				...
				break;
			case modelAction.MedicalCertificateSickLeaveModelActionTypes.FETCH_MEDICAL_CERTIFICATE_SICK_LEAVE_WITH_QUERY_OK:
				const totalCountAfterFetchWithQuery = (action as modelAction.MedicalCertificateSickLeaveActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchWithQuery = (action as modelAction.MedicalCertificateSickLeaveActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchWithQuery = (action as modelAction.MedicalCertificateSickLeaveActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchWithQuery = (action as modelAction.MedicalCertificateSickLeaveActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchWithQuery.map(model => MedicalCertificateSickLeaveModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalCertificateSickLeaveModelActionTypes.FETCH_LAST_MEDICAL_CERTIFICATE_SICK_LEAVE_WITH_QUERY_OK:
				const totalCountAfterFetchLastWithQuery = (action as modelAction.MedicalCertificateSickLeaveActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchLastWithQuery = (action as modelAction.MedicalCertificateSickLeaveActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchLastWithQuery = (action as modelAction.MedicalCertificateSickLeaveActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchLastWithQuery = (action as modelAction.MedicalCertificateSickLeaveActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchLastWithQuery.map(model => MedicalCertificateSickLeaveModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalCertificateSickLeaveModelActionTypes.COUNT_MEDICAL_CERTIFICATE_SICK_LEAVES_OK:
				const totalCountAfterCount = (action as modelAction.MedicalCertificateSickLeaveActionOK).stateConfig.totalCount;
				...
				break;
			case modelAction.MedicalCertificateSickLeaveModelActionTypes.INITIALISE_MEDICAL_CERTIFICATE_SICK_LEAVE_COLLECTION_STATE:
				const collectionIdToInitialise =  (action as modelAction.MedicalCertificateSickLeaveActionOK).stateConfig.collectionId;
				const queryParamsToInitialise = (action as modelAction.MedicalCertificateSickLeaveActionOK).stateConfig.queryParams;
				...
				if (!draft[className].collectionState[collectionIdToInitialise]) {
					draft[className].collectionState[collectionIdToInitialise] = {
						...initialMedicalCertificateSickLeaveCollectionState
					};
				}
