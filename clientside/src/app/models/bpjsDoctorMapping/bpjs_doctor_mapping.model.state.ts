...
/**
 * BpjsDoctorMappingCollectionState would store the state of a collection of BpjsDoctorMapping
 */
export interface BpjsDoctorMappingCollectionState extends CollectionState {
 ...
 */
export interface BpjsDoctorMappingModelAudit extends AbstractModelAudit<BpjsDoctorMappingModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsDoctorMappingModelState would store the state of the model
 */
export interface BpjsDoctorMappingModelState {
	collectionState: {
		[key: string]: BpjsDoctorMappingCollectionState;
	};
	data: {
		[id: string]: BpjsDoctorMappingModel;
	};
	totalCount: number;
	audits: BpjsDoctorMappingModelAudit[];
 ...
 */
export const initialBpjsDoctorMappingCollectionState: BpjsDoctorMappingCollectionState = {
...
/**
 * The initial state of BpjsDoctorMappingModelState
 */
export const initialState: BpjsDoctorMappingModelState = {
	collectionState: {
