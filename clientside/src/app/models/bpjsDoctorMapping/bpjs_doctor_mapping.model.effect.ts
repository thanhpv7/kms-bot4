...
import * as modelAction from './bpjs_doctor_mapping.model.action';
import {BpjsDoctorMappingService} from '../../services/bpjsDoctorMapping/bpjs_doctor_mapping.service';
...
/**
 * Effect class used for side effects related to BPJS Doctor Mapping model.
 */
@Injectable()
export class BpjsDoctorMappingEffect {
	...
	constructor(
		...
		protected readonly service: BpjsDoctorMappingService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDoctorMappingAction>(modelAction.BpjsDoctorMappingModelActionTypes.COUNT_BPJS_DOCTOR_MAPPINGS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsDoctorMappingActionOK(
						modelAction.BpjsDoctorMappingModelActionTypes.COUNT_BPJS_DOCTOR_MAPPINGS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDoctorMappingActionFail(
								modelAction.BpjsDoctorMappingModelActionTypes.COUNT_BPJS_DOCTOR_MAPPINGS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDoctorMappingAction>(modelAction.BpjsDoctorMappingModelActionTypes.FETCH_BPJS_DOCTOR_MAPPING),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsDoctorMappingActionOK(
						modelAction.BpjsDoctorMappingModelActionTypes.FETCH_BPJS_DOCTOR_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDoctorMappingActionFail(
								modelAction.BpjsDoctorMappingModelActionTypes.FETCH_BPJS_DOCTOR_MAPPING_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDoctorMappingAction>(modelAction.BpjsDoctorMappingModelActionTypes.FETCH_ALL_BPJS_DOCTOR_MAPPING),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsDoctorMappingActionOK(
						modelAction.BpjsDoctorMappingModelActionTypes.FETCH_ALL_BPJS_DOCTOR_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDoctorMappingActionFail(
								modelAction.BpjsDoctorMappingModelActionTypes.FETCH_ALL_BPJS_DOCTOR_MAPPING_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDoctorMappingAction>(modelAction.BpjsDoctorMappingModelActionTypes.FETCH_BPJS_DOCTOR_MAPPING_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsDoctorMappingActionOK(
						modelAction.BpjsDoctorMappingModelActionTypes.FETCH_BPJS_DOCTOR_MAPPING_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDoctorMappingActionFail(
								modelAction.BpjsDoctorMappingModelActionTypes.FETCH_BPJS_DOCTOR_MAPPING_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDoctorMappingAction>(modelAction.BpjsDoctorMappingModelActionTypes.FETCH_LAST_BPJS_DOCTOR_MAPPING_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsDoctorMappingActionOK(
						modelAction.BpjsDoctorMappingModelActionTypes.FETCH_LAST_BPJS_DOCTOR_MAPPING_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDoctorMappingActionFail(
								modelAction.BpjsDoctorMappingModelActionTypes.FETCH_LAST_BPJS_DOCTOR_MAPPING_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDoctorMappingAction>(modelAction.BpjsDoctorMappingModelActionTypes.CREATE_BPJS_DOCTOR_MAPPING),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsDoctorMappingModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsDoctorMappingActionOK(
						modelAction.BpjsDoctorMappingModelActionTypes.CREATE_BPJS_DOCTOR_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDoctorMappingActionFail(
								modelAction.BpjsDoctorMappingModelActionTypes.CREATE_BPJS_DOCTOR_MAPPING_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDoctorMappingAction>(modelAction.BpjsDoctorMappingModelActionTypes.CREATE_ALL_BPJS_DOCTOR_MAPPING),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsDoctorMappingModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsDoctorMappingActionOK(
						modelAction.BpjsDoctorMappingModelActionTypes.CREATE_ALL_BPJS_DOCTOR_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDoctorMappingActionFail(
								modelAction.BpjsDoctorMappingModelActionTypes.CREATE_ALL_BPJS_DOCTOR_MAPPING_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDoctorMappingAction>(modelAction.BpjsDoctorMappingModelActionTypes.UPDATE_BPJS_DOCTOR_MAPPING),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsDoctorMappingModel;
				...
				return this.service.update(new BpjsDoctorMappingModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsDoctorMappingActionOK(
						modelAction.BpjsDoctorMappingModelActionTypes.UPDATE_BPJS_DOCTOR_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDoctorMappingActionFail(
								modelAction.BpjsDoctorMappingModelActionTypes.UPDATE_BPJS_DOCTOR_MAPPING_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDoctorMappingAction>(modelAction.BpjsDoctorMappingModelActionTypes.UPDATE_ALL_BPJS_DOCTOR_MAPPING),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsDoctorMappingModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsDoctorMappingModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsDoctorMappingActionOK(
						modelAction.BpjsDoctorMappingModelActionTypes.UPDATE_ALL_BPJS_DOCTOR_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDoctorMappingActionFail(
								modelAction.BpjsDoctorMappingModelActionTypes.UPDATE_ALL_BPJS_DOCTOR_MAPPING_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDoctorMappingAction>(modelAction.BpjsDoctorMappingModelActionTypes.DELETE_BPJS_DOCTOR_MAPPING),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsDoctorMappingActionOK(
						modelAction.BpjsDoctorMappingModelActionTypes.DELETE_BPJS_DOCTOR_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDoctorMappingActionFail(
								modelAction.BpjsDoctorMappingModelActionTypes.DELETE_BPJS_DOCTOR_MAPPING_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDoctorMappingAction>(modelAction.BpjsDoctorMappingModelActionTypes.DELETE_BPJS_DOCTOR_MAPPING_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsDoctorMappingActionOK(
						modelAction.BpjsDoctorMappingModelActionTypes.DELETE_BPJS_DOCTOR_MAPPING_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDoctorMappingActionFail(
								modelAction.BpjsDoctorMappingModelActionTypes.DELETE_BPJS_DOCTOR_MAPPING_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDoctorMappingAction>(modelAction.BpjsDoctorMappingModelActionTypes.DELETE_ALL_BPJS_DOCTOR_MAPPING),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsDoctorMappingActionOK(
						modelAction.BpjsDoctorMappingModelActionTypes.DELETE_ALL_BPJS_DOCTOR_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDoctorMappingActionFail(
								modelAction.BpjsDoctorMappingModelActionTypes.DELETE_ALL_BPJS_DOCTOR_MAPPING_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDoctorMappingAction>(modelAction.BpjsDoctorMappingModelActionTypes.EXPORT_BPJS_DOCTOR_MAPPING),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsDoctorMappingActionOK(
						modelAction.BpjsDoctorMappingModelActionTypes.EXPORT_BPJS_DOCTOR_MAPPING,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDoctorMappingAction>(modelAction.BpjsDoctorMappingModelActionTypes.EXPORT_ALL_BPJS_DOCTOR_MAPPING),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsDoctorMappingActionOK(
						modelAction.BpjsDoctorMappingModelActionTypes.EXPORT_ALL_BPJS_DOCTOR_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDoctorMappingActionFail(
								modelAction.BpjsDoctorMappingModelActionTypes.EXPORT_ALL_BPJS_DOCTOR_MAPPING_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDoctorMappingAction>(modelAction.BpjsDoctorMappingModelActionTypes.EXPORT_BPJS_DOCTOR_MAPPING_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsDoctorMappingActionOK(
						modelAction.BpjsDoctorMappingModelActionTypes.EXPORT_BPJS_DOCTOR_MAPPING_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDoctorMappingActionFail(
								modelAction.BpjsDoctorMappingModelActionTypes.EXPORT_BPJS_DOCTOR_MAPPING_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDoctorMappingAction>(modelAction.BpjsDoctorMappingModelActionTypes.IMPORT_BPJS_DOCTOR_MAPPINGS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsDoctorMappingActionOK(
						modelAction.BpjsDoctorMappingModelActionTypes.IMPORT_BPJS_DOCTOR_MAPPINGS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDoctorMappingActionFail(
								modelAction.BpjsDoctorMappingModelActionTypes.IMPORT_BPJS_DOCTOR_MAPPINGS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDoctorMappingAction>(modelAction.BpjsDoctorMappingModelActionTypes.FETCH_BPJS_DOCTOR_MAPPING_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsDoctorMappingActionOK(
						modelAction.BpjsDoctorMappingModelActionTypes.FETCH_BPJS_DOCTOR_MAPPING_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDoctorMappingActionFail(
								modelAction.BpjsDoctorMappingModelActionTypes.FETCH_BPJS_DOCTOR_MAPPING_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDoctorMappingAction>(modelAction.BpjsDoctorMappingModelActionTypes.FETCH_BPJS_DOCTOR_MAPPING_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsDoctorMappingActionOK(
						modelAction.BpjsDoctorMappingModelActionTypes.FETCH_BPJS_DOCTOR_MAPPING_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDoctorMappingActionFail(
								modelAction.BpjsDoctorMappingModelActionTypes.FETCH_BPJS_DOCTOR_MAPPING_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
