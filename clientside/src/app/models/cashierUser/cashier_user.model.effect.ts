...
import * as modelAction from './cashier_user.model.action';
import {CashierUserService} from '../../services/cashierUser/cashier_user.service';
...
/**
 * Effect class used for side effects related to Cashier User model.
 */
@Injectable()
export class CashierUserEffect {
	...
	constructor(
		...
		protected readonly service: CashierUserService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashierUserAction>(modelAction.CashierUserModelActionTypes.COUNT_CASHIER_USERS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.CashierUserActionOK(
						modelAction.CashierUserModelActionTypes.COUNT_CASHIER_USERS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashierUserActionFail(
								modelAction.CashierUserModelActionTypes.COUNT_CASHIER_USERS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashierUserAction>(modelAction.CashierUserModelActionTypes.FETCH_CASHIER_USER),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.CashierUserActionOK(
						modelAction.CashierUserModelActionTypes.FETCH_CASHIER_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashierUserActionFail(
								modelAction.CashierUserModelActionTypes.FETCH_CASHIER_USER_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashierUserAction>(modelAction.CashierUserModelActionTypes.FETCH_ALL_CASHIER_USER),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.CashierUserActionOK(
						modelAction.CashierUserModelActionTypes.FETCH_ALL_CASHIER_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashierUserActionFail(
								modelAction.CashierUserModelActionTypes.FETCH_ALL_CASHIER_USER_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashierUserAction>(modelAction.CashierUserModelActionTypes.FETCH_CASHIER_USER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.CashierUserActionOK(
						modelAction.CashierUserModelActionTypes.FETCH_CASHIER_USER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashierUserActionFail(
								modelAction.CashierUserModelActionTypes.FETCH_CASHIER_USER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashierUserAction>(modelAction.CashierUserModelActionTypes.FETCH_LAST_CASHIER_USER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.CashierUserActionOK(
						modelAction.CashierUserModelActionTypes.FETCH_LAST_CASHIER_USER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashierUserActionFail(
								modelAction.CashierUserModelActionTypes.FETCH_LAST_CASHIER_USER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashierUserAction>(modelAction.CashierUserModelActionTypes.CREATE_CASHIER_USER),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as CashierUserModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.CashierUserActionOK(
						modelAction.CashierUserModelActionTypes.CREATE_CASHIER_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashierUserActionFail(
								modelAction.CashierUserModelActionTypes.CREATE_CASHIER_USER_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashierUserAction>(modelAction.CashierUserModelActionTypes.CREATE_ALL_CASHIER_USER),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as CashierUserModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.CashierUserActionOK(
						modelAction.CashierUserModelActionTypes.CREATE_ALL_CASHIER_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashierUserActionFail(
								modelAction.CashierUserModelActionTypes.CREATE_ALL_CASHIER_USER_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashierUserAction>(modelAction.CashierUserModelActionTypes.UPDATE_CASHIER_USER),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as CashierUserModel;
				...
				return this.service.update(new CashierUserModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.CashierUserActionOK(
						modelAction.CashierUserModelActionTypes.UPDATE_CASHIER_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashierUserActionFail(
								modelAction.CashierUserModelActionTypes.UPDATE_CASHIER_USER_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashierUserAction>(modelAction.CashierUserModelActionTypes.UPDATE_ALL_CASHIER_USER),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as CashierUserModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new CashierUserModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.CashierUserActionOK(
						modelAction.CashierUserModelActionTypes.UPDATE_ALL_CASHIER_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashierUserActionFail(
								modelAction.CashierUserModelActionTypes.UPDATE_ALL_CASHIER_USER_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashierUserAction>(modelAction.CashierUserModelActionTypes.DELETE_CASHIER_USER),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.CashierUserActionOK(
						modelAction.CashierUserModelActionTypes.DELETE_CASHIER_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashierUserActionFail(
								modelAction.CashierUserModelActionTypes.DELETE_CASHIER_USER_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashierUserAction>(modelAction.CashierUserModelActionTypes.DELETE_CASHIER_USER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.CashierUserActionOK(
						modelAction.CashierUserModelActionTypes.DELETE_CASHIER_USER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashierUserActionFail(
								modelAction.CashierUserModelActionTypes.DELETE_CASHIER_USER_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashierUserAction>(modelAction.CashierUserModelActionTypes.DELETE_ALL_CASHIER_USER),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.CashierUserActionOK(
						modelAction.CashierUserModelActionTypes.DELETE_ALL_CASHIER_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashierUserActionFail(
								modelAction.CashierUserModelActionTypes.DELETE_ALL_CASHIER_USER_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashierUserAction>(modelAction.CashierUserModelActionTypes.EXPORT_CASHIER_USER),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.CashierUserActionOK(
						modelAction.CashierUserModelActionTypes.EXPORT_CASHIER_USER,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashierUserAction>(modelAction.CashierUserModelActionTypes.EXPORT_ALL_CASHIER_USER),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.CashierUserActionOK(
						modelAction.CashierUserModelActionTypes.EXPORT_ALL_CASHIER_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashierUserActionFail(
								modelAction.CashierUserModelActionTypes.EXPORT_ALL_CASHIER_USER_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashierUserAction>(modelAction.CashierUserModelActionTypes.EXPORT_CASHIER_USER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.CashierUserActionOK(
						modelAction.CashierUserModelActionTypes.EXPORT_CASHIER_USER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashierUserActionFail(
								modelAction.CashierUserModelActionTypes.EXPORT_CASHIER_USER_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashierUserAction>(modelAction.CashierUserModelActionTypes.IMPORT_CASHIER_USERS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.CashierUserActionOK(
						modelAction.CashierUserModelActionTypes.IMPORT_CASHIER_USERS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashierUserActionFail(
								modelAction.CashierUserModelActionTypes.IMPORT_CASHIER_USERS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashierUserAction>(modelAction.CashierUserModelActionTypes.FETCH_CASHIER_USER_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.CashierUserActionOK(
						modelAction.CashierUserModelActionTypes.FETCH_CASHIER_USER_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.CashierUserActionFail(
								modelAction.CashierUserModelActionTypes.FETCH_CASHIER_USER_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashierUserAction>(modelAction.CashierUserModelActionTypes.FETCH_CASHIER_USER_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.CashierUserActionOK(
						modelAction.CashierUserModelActionTypes.FETCH_CASHIER_USER_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.CashierUserActionFail(
								modelAction.CashierUserModelActionTypes.FETCH_CASHIER_USER_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
