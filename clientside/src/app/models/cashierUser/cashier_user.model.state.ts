...
/**
 * CashierUserCollectionState would store the state of a collection of CashierUser
 */
export interface CashierUserCollectionState extends CollectionState {
 ...
 */
export interface CashierUserModelAudit extends AbstractModelAudit<CashierUserModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * CashierUserModelState would store the state of the model
 */
export interface CashierUserModelState {
	collectionState: {
		[key: string]: CashierUserCollectionState;
	};
	data: {
		[id: string]: CashierUserModel;
	};
	totalCount: number;
	audits: CashierUserModelAudit[];
 ...
 */
export const initialCashierUserCollectionState: CashierUserCollectionState = {
...
/**
 * The initial state of CashierUserModelState
 */
export const initialState: CashierUserModelState = {
	collectionState: {
