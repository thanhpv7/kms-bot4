...
/**
 * BpjsPcarePoliCollectionState would store the state of a collection of BpjsPcarePoli
 */
export interface BpjsPcarePoliCollectionState extends CollectionState {
 ...
 */
export interface BpjsPcarePoliModelAudit extends AbstractModelAudit<BpjsPcarePoliModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsPcarePoliModelState would store the state of the model
 */
export interface BpjsPcarePoliModelState {
	collectionState: {
		[key: string]: BpjsPcarePoliCollectionState;
	};
	data: {
		[id: string]: BpjsPcarePoliModel;
	};
	totalCount: number;
	audits: BpjsPcarePoliModelAudit[];
 ...
 */
export const initialBpjsPcarePoliCollectionState: BpjsPcarePoliCollectionState = {
...
/**
 * The initial state of BpjsPcarePoliModelState
 */
export const initialState: BpjsPcarePoliModelState = {
	collectionState: {
