...
import * as modelAction from './bpjs_pcare_poli.model.action';
import {BpjsPcarePoliService} from '../../services/bpjsPcarePoli/bpjs_pcare_poli.service';
...
/**
 * Effect class used for side effects related to BPJS Pcare Poli model.
 */
@Injectable()
export class BpjsPcarePoliEffect {
	...
	constructor(
		...
		protected readonly service: BpjsPcarePoliService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePoliAction>(modelAction.BpjsPcarePoliModelActionTypes.COUNT_BPJS_PCARE_POLIS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsPcarePoliActionOK(
						modelAction.BpjsPcarePoliModelActionTypes.COUNT_BPJS_PCARE_POLIS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePoliActionFail(
								modelAction.BpjsPcarePoliModelActionTypes.COUNT_BPJS_PCARE_POLIS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePoliAction>(modelAction.BpjsPcarePoliModelActionTypes.FETCH_BPJS_PCARE_POLI),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcarePoliActionOK(
						modelAction.BpjsPcarePoliModelActionTypes.FETCH_BPJS_PCARE_POLI_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePoliActionFail(
								modelAction.BpjsPcarePoliModelActionTypes.FETCH_BPJS_PCARE_POLI_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePoliAction>(modelAction.BpjsPcarePoliModelActionTypes.FETCH_ALL_BPJS_PCARE_POLI),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsPcarePoliActionOK(
						modelAction.BpjsPcarePoliModelActionTypes.FETCH_ALL_BPJS_PCARE_POLI_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePoliActionFail(
								modelAction.BpjsPcarePoliModelActionTypes.FETCH_ALL_BPJS_PCARE_POLI_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePoliAction>(modelAction.BpjsPcarePoliModelActionTypes.FETCH_BPJS_PCARE_POLI_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcarePoliActionOK(
						modelAction.BpjsPcarePoliModelActionTypes.FETCH_BPJS_PCARE_POLI_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePoliActionFail(
								modelAction.BpjsPcarePoliModelActionTypes.FETCH_BPJS_PCARE_POLI_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePoliAction>(modelAction.BpjsPcarePoliModelActionTypes.FETCH_LAST_BPJS_PCARE_POLI_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcarePoliActionOK(
						modelAction.BpjsPcarePoliModelActionTypes.FETCH_LAST_BPJS_PCARE_POLI_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePoliActionFail(
								modelAction.BpjsPcarePoliModelActionTypes.FETCH_LAST_BPJS_PCARE_POLI_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePoliAction>(modelAction.BpjsPcarePoliModelActionTypes.CREATE_BPJS_PCARE_POLI),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsPcarePoliModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcarePoliActionOK(
						modelAction.BpjsPcarePoliModelActionTypes.CREATE_BPJS_PCARE_POLI_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePoliActionFail(
								modelAction.BpjsPcarePoliModelActionTypes.CREATE_BPJS_PCARE_POLI_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePoliAction>(modelAction.BpjsPcarePoliModelActionTypes.CREATE_ALL_BPJS_PCARE_POLI),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsPcarePoliModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcarePoliActionOK(
						modelAction.BpjsPcarePoliModelActionTypes.CREATE_ALL_BPJS_PCARE_POLI_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePoliActionFail(
								modelAction.BpjsPcarePoliModelActionTypes.CREATE_ALL_BPJS_PCARE_POLI_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePoliAction>(modelAction.BpjsPcarePoliModelActionTypes.UPDATE_BPJS_PCARE_POLI),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsPcarePoliModel;
				...
				return this.service.update(new BpjsPcarePoliModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcarePoliActionOK(
						modelAction.BpjsPcarePoliModelActionTypes.UPDATE_BPJS_PCARE_POLI_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePoliActionFail(
								modelAction.BpjsPcarePoliModelActionTypes.UPDATE_BPJS_PCARE_POLI_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePoliAction>(modelAction.BpjsPcarePoliModelActionTypes.UPDATE_ALL_BPJS_PCARE_POLI),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsPcarePoliModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsPcarePoliModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcarePoliActionOK(
						modelAction.BpjsPcarePoliModelActionTypes.UPDATE_ALL_BPJS_PCARE_POLI_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePoliActionFail(
								modelAction.BpjsPcarePoliModelActionTypes.UPDATE_ALL_BPJS_PCARE_POLI_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePoliAction>(modelAction.BpjsPcarePoliModelActionTypes.DELETE_BPJS_PCARE_POLI),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcarePoliActionOK(
						modelAction.BpjsPcarePoliModelActionTypes.DELETE_BPJS_PCARE_POLI_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePoliActionFail(
								modelAction.BpjsPcarePoliModelActionTypes.DELETE_BPJS_PCARE_POLI_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePoliAction>(modelAction.BpjsPcarePoliModelActionTypes.DELETE_BPJS_PCARE_POLI_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcarePoliActionOK(
						modelAction.BpjsPcarePoliModelActionTypes.DELETE_BPJS_PCARE_POLI_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePoliActionFail(
								modelAction.BpjsPcarePoliModelActionTypes.DELETE_BPJS_PCARE_POLI_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePoliAction>(modelAction.BpjsPcarePoliModelActionTypes.DELETE_ALL_BPJS_PCARE_POLI),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcarePoliActionOK(
						modelAction.BpjsPcarePoliModelActionTypes.DELETE_ALL_BPJS_PCARE_POLI_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePoliActionFail(
								modelAction.BpjsPcarePoliModelActionTypes.DELETE_ALL_BPJS_PCARE_POLI_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePoliAction>(modelAction.BpjsPcarePoliModelActionTypes.EXPORT_BPJS_PCARE_POLI),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcarePoliActionOK(
						modelAction.BpjsPcarePoliModelActionTypes.EXPORT_BPJS_PCARE_POLI,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePoliAction>(modelAction.BpjsPcarePoliModelActionTypes.EXPORT_ALL_BPJS_PCARE_POLI),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcarePoliActionOK(
						modelAction.BpjsPcarePoliModelActionTypes.EXPORT_ALL_BPJS_PCARE_POLI_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePoliActionFail(
								modelAction.BpjsPcarePoliModelActionTypes.EXPORT_ALL_BPJS_PCARE_POLI_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePoliAction>(modelAction.BpjsPcarePoliModelActionTypes.EXPORT_BPJS_PCARE_POLI_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcarePoliActionOK(
						modelAction.BpjsPcarePoliModelActionTypes.EXPORT_BPJS_PCARE_POLI_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePoliActionFail(
								modelAction.BpjsPcarePoliModelActionTypes.EXPORT_BPJS_PCARE_POLI_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePoliAction>(modelAction.BpjsPcarePoliModelActionTypes.IMPORT_BPJS_PCARE_POLIS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcarePoliActionOK(
						modelAction.BpjsPcarePoliModelActionTypes.IMPORT_BPJS_PCARE_POLIS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePoliActionFail(
								modelAction.BpjsPcarePoliModelActionTypes.IMPORT_BPJS_PCARE_POLIS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePoliAction>(modelAction.BpjsPcarePoliModelActionTypes.FETCH_BPJS_PCARE_POLI_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsPcarePoliActionOK(
						modelAction.BpjsPcarePoliModelActionTypes.FETCH_BPJS_PCARE_POLI_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePoliActionFail(
								modelAction.BpjsPcarePoliModelActionTypes.FETCH_BPJS_PCARE_POLI_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePoliAction>(modelAction.BpjsPcarePoliModelActionTypes.FETCH_BPJS_PCARE_POLI_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsPcarePoliActionOK(
						modelAction.BpjsPcarePoliModelActionTypes.FETCH_BPJS_PCARE_POLI_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePoliActionFail(
								modelAction.BpjsPcarePoliModelActionTypes.FETCH_BPJS_PCARE_POLI_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
