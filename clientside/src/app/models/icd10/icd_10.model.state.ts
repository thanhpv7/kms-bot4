...
/**
 * Icd10CollectionState would store the state of a collection of Icd10
 */
export interface Icd10CollectionState extends CollectionState {
 ...
 */
export interface Icd10ModelAudit extends AbstractModelAudit<Icd10Model> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * Icd10ModelState would store the state of the model
 */
export interface Icd10ModelState {
	collectionState: {
		[key: string]: Icd10CollectionState;
	};
	data: {
		[id: string]: Icd10Model;
	};
	totalCount: number;
	audits: Icd10ModelAudit[];
 ...
 */
export const initialIcd10CollectionState: Icd10CollectionState = {
...
/**
 * The initial state of Icd10ModelState
 */
export const initialState: Icd10ModelState = {
	collectionState: {
