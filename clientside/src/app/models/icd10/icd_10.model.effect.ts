...
import {Icd10Service} from '../../services/icd10/icd_10.service';
...
/**
 * Effect class used for side effects related to ICD 10 model.
 */
@Injectable()
export class Icd10Effect {
	...
	constructor(
		...
		protected readonly service: Icd10Service,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.Icd10Action>(modelAction.Icd10ModelActionTypes.COUNT_ICD_10S),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.Icd10ActionOK(
						modelAction.Icd10ModelActionTypes.COUNT_ICD_10S_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.Icd10ActionFail(
								modelAction.Icd10ModelActionTypes.COUNT_ICD_10S_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.Icd10Action>(modelAction.Icd10ModelActionTypes.FETCH_ICD_10),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.Icd10ActionOK(
						modelAction.Icd10ModelActionTypes.FETCH_ICD_10_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.Icd10ActionFail(
								modelAction.Icd10ModelActionTypes.FETCH_ICD_10_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.Icd10Action>(modelAction.Icd10ModelActionTypes.FETCH_ALL_ICD_10),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.Icd10ActionOK(
						modelAction.Icd10ModelActionTypes.FETCH_ALL_ICD_10_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.Icd10ActionFail(
								modelAction.Icd10ModelActionTypes.FETCH_ALL_ICD_10_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.Icd10Action>(modelAction.Icd10ModelActionTypes.FETCH_ICD_10_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.Icd10ActionOK(
						modelAction.Icd10ModelActionTypes.FETCH_ICD_10_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.Icd10ActionFail(
								modelAction.Icd10ModelActionTypes.FETCH_ICD_10_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.Icd10Action>(modelAction.Icd10ModelActionTypes.FETCH_LAST_ICD_10_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.Icd10ActionOK(
						modelAction.Icd10ModelActionTypes.FETCH_LAST_ICD_10_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.Icd10ActionFail(
								modelAction.Icd10ModelActionTypes.FETCH_LAST_ICD_10_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.Icd10Action>(modelAction.Icd10ModelActionTypes.CREATE_ICD_10),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as Icd10Model;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.Icd10ActionOK(
						modelAction.Icd10ModelActionTypes.CREATE_ICD_10_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.Icd10ActionFail(
								modelAction.Icd10ModelActionTypes.CREATE_ICD_10_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.Icd10Action>(modelAction.Icd10ModelActionTypes.CREATE_ALL_ICD_10),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as Icd10Model[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.Icd10ActionOK(
						modelAction.Icd10ModelActionTypes.CREATE_ALL_ICD_10_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.Icd10ActionFail(
								modelAction.Icd10ModelActionTypes.CREATE_ALL_ICD_10_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.Icd10Action>(modelAction.Icd10ModelActionTypes.UPDATE_ICD_10),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as Icd10Model;
				...
				return this.service.update(new Icd10Model({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.Icd10ActionOK(
						modelAction.Icd10ModelActionTypes.UPDATE_ICD_10_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.Icd10ActionFail(
								modelAction.Icd10ModelActionTypes.UPDATE_ICD_10_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.Icd10Action>(modelAction.Icd10ModelActionTypes.UPDATE_ALL_ICD_10),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as Icd10Model[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new Icd10Model({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.Icd10ActionOK(
						modelAction.Icd10ModelActionTypes.UPDATE_ALL_ICD_10_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.Icd10ActionFail(
								modelAction.Icd10ModelActionTypes.UPDATE_ALL_ICD_10_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.Icd10Action>(modelAction.Icd10ModelActionTypes.DELETE_ICD_10),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.Icd10ActionOK(
						modelAction.Icd10ModelActionTypes.DELETE_ICD_10_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.Icd10ActionFail(
								modelAction.Icd10ModelActionTypes.DELETE_ICD_10_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.Icd10Action>(modelAction.Icd10ModelActionTypes.DELETE_ICD_10_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.Icd10ActionOK(
						modelAction.Icd10ModelActionTypes.DELETE_ICD_10_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.Icd10ActionFail(
								modelAction.Icd10ModelActionTypes.DELETE_ICD_10_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.Icd10Action>(modelAction.Icd10ModelActionTypes.DELETE_ALL_ICD_10),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.Icd10ActionOK(
						modelAction.Icd10ModelActionTypes.DELETE_ALL_ICD_10_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.Icd10ActionFail(
								modelAction.Icd10ModelActionTypes.DELETE_ALL_ICD_10_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.Icd10Action>(modelAction.Icd10ModelActionTypes.EXPORT_ICD_10),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.Icd10ActionOK(
						modelAction.Icd10ModelActionTypes.EXPORT_ICD_10,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.Icd10Action>(modelAction.Icd10ModelActionTypes.EXPORT_ALL_ICD_10),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.Icd10ActionOK(
						modelAction.Icd10ModelActionTypes.EXPORT_ALL_ICD_10_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.Icd10ActionFail(
								modelAction.Icd10ModelActionTypes.EXPORT_ALL_ICD_10_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.Icd10Action>(modelAction.Icd10ModelActionTypes.EXPORT_ICD_10_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.Icd10ActionOK(
						modelAction.Icd10ModelActionTypes.EXPORT_ICD_10_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.Icd10ActionFail(
								modelAction.Icd10ModelActionTypes.EXPORT_ICD_10_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.Icd10Action>(modelAction.Icd10ModelActionTypes.IMPORT_ICD_10S),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.Icd10ActionOK(
						modelAction.Icd10ModelActionTypes.IMPORT_ICD_10S_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.Icd10ActionFail(
								modelAction.Icd10ModelActionTypes.IMPORT_ICD_10S_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.Icd10Action>(modelAction.Icd10ModelActionTypes.FETCH_ICD_10_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.Icd10ActionOK(
						modelAction.Icd10ModelActionTypes.FETCH_ICD_10_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.Icd10ActionFail(
								modelAction.Icd10ModelActionTypes.FETCH_ICD_10_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.Icd10Action>(modelAction.Icd10ModelActionTypes.FETCH_ICD_10_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.Icd10ActionOK(
						modelAction.Icd10ModelActionTypes.FETCH_ICD_10_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.Icd10ActionFail(
								modelAction.Icd10ModelActionTypes.FETCH_ICD_10_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
