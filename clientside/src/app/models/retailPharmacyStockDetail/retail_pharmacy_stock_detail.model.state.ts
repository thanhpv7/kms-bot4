...
/**
 * RetailPharmacyStockDetailCollectionState would store the state of a collection of RetailPharmacyStockDetail
 */
export interface RetailPharmacyStockDetailCollectionState extends CollectionState {
 ...
 */
export interface RetailPharmacyStockDetailModelAudit extends AbstractModelAudit<RetailPharmacyStockDetailModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * RetailPharmacyStockDetailModelState would store the state of the model
 */
export interface RetailPharmacyStockDetailModelState {
	collectionState: {
		[key: string]: RetailPharmacyStockDetailCollectionState;
	};
	data: {
		[id: string]: RetailPharmacyStockDetailModel;
	};
	totalCount: number;
	audits: RetailPharmacyStockDetailModelAudit[];
 ...
 */
export const initialRetailPharmacyStockDetailCollectionState: RetailPharmacyStockDetailCollectionState = {
...
/**
 * The initial state of RetailPharmacyStockDetailModelState
 */
export const initialState: RetailPharmacyStockDetailModelState = {
	collectionState: {
