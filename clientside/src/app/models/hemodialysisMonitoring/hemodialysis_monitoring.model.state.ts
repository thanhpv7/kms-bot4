...
/**
 * HemodialysisMonitoringCollectionState would store the state of a collection of HemodialysisMonitoring
 */
export interface HemodialysisMonitoringCollectionState extends CollectionState {
 ...
 */
export interface HemodialysisMonitoringModelAudit extends AbstractModelAudit<HemodialysisMonitoringModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * HemodialysisMonitoringModelState would store the state of the model
 */
export interface HemodialysisMonitoringModelState {
	collectionState: {
		[key: string]: HemodialysisMonitoringCollectionState;
	};
	data: {
		[id: string]: HemodialysisMonitoringModel;
	};
	totalCount: number;
	audits: HemodialysisMonitoringModelAudit[];
 ...
 */
export const initialHemodialysisMonitoringCollectionState: HemodialysisMonitoringCollectionState = {
...
/**
 * The initial state of HemodialysisMonitoringModelState
 */
export const initialState: HemodialysisMonitoringModelState = {
	collectionState: {
