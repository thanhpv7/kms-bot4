...
import * as modelAction from './hemodialysis_monitoring.model.action';
import {HemodialysisMonitoringService} from '../../services/hemodialysisMonitoring/hemodialysis_monitoring.service';
...
/**
 * Effect class used for side effects related to Hemodialysis Monitoring model.
 */
@Injectable()
export class HemodialysisMonitoringEffect {
	...
	constructor(
		...
		protected readonly service: HemodialysisMonitoringService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HemodialysisMonitoringAction>(modelAction.HemodialysisMonitoringModelActionTypes.COUNT_HEMODIALYSIS_MONITORINGS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.HemodialysisMonitoringActionOK(
						modelAction.HemodialysisMonitoringModelActionTypes.COUNT_HEMODIALYSIS_MONITORINGS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.HemodialysisMonitoringActionFail(
								modelAction.HemodialysisMonitoringModelActionTypes.COUNT_HEMODIALYSIS_MONITORINGS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HemodialysisMonitoringAction>(modelAction.HemodialysisMonitoringModelActionTypes.FETCH_HEMODIALYSIS_MONITORING),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.HemodialysisMonitoringActionOK(
						modelAction.HemodialysisMonitoringModelActionTypes.FETCH_HEMODIALYSIS_MONITORING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.HemodialysisMonitoringActionFail(
								modelAction.HemodialysisMonitoringModelActionTypes.FETCH_HEMODIALYSIS_MONITORING_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HemodialysisMonitoringAction>(modelAction.HemodialysisMonitoringModelActionTypes.FETCH_ALL_HEMODIALYSIS_MONITORING),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.HemodialysisMonitoringActionOK(
						modelAction.HemodialysisMonitoringModelActionTypes.FETCH_ALL_HEMODIALYSIS_MONITORING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.HemodialysisMonitoringActionFail(
								modelAction.HemodialysisMonitoringModelActionTypes.FETCH_ALL_HEMODIALYSIS_MONITORING_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HemodialysisMonitoringAction>(modelAction.HemodialysisMonitoringModelActionTypes.FETCH_HEMODIALYSIS_MONITORING_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.HemodialysisMonitoringActionOK(
						modelAction.HemodialysisMonitoringModelActionTypes.FETCH_HEMODIALYSIS_MONITORING_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.HemodialysisMonitoringActionFail(
								modelAction.HemodialysisMonitoringModelActionTypes.FETCH_HEMODIALYSIS_MONITORING_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HemodialysisMonitoringAction>(modelAction.HemodialysisMonitoringModelActionTypes.FETCH_LAST_HEMODIALYSIS_MONITORING_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.HemodialysisMonitoringActionOK(
						modelAction.HemodialysisMonitoringModelActionTypes.FETCH_LAST_HEMODIALYSIS_MONITORING_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.HemodialysisMonitoringActionFail(
								modelAction.HemodialysisMonitoringModelActionTypes.FETCH_LAST_HEMODIALYSIS_MONITORING_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HemodialysisMonitoringAction>(modelAction.HemodialysisMonitoringModelActionTypes.CREATE_HEMODIALYSIS_MONITORING),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as HemodialysisMonitoringModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.HemodialysisMonitoringActionOK(
						modelAction.HemodialysisMonitoringModelActionTypes.CREATE_HEMODIALYSIS_MONITORING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.HemodialysisMonitoringActionFail(
								modelAction.HemodialysisMonitoringModelActionTypes.CREATE_HEMODIALYSIS_MONITORING_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HemodialysisMonitoringAction>(modelAction.HemodialysisMonitoringModelActionTypes.CREATE_ALL_HEMODIALYSIS_MONITORING),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as HemodialysisMonitoringModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.HemodialysisMonitoringActionOK(
						modelAction.HemodialysisMonitoringModelActionTypes.CREATE_ALL_HEMODIALYSIS_MONITORING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.HemodialysisMonitoringActionFail(
								modelAction.HemodialysisMonitoringModelActionTypes.CREATE_ALL_HEMODIALYSIS_MONITORING_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HemodialysisMonitoringAction>(modelAction.HemodialysisMonitoringModelActionTypes.UPDATE_HEMODIALYSIS_MONITORING),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as HemodialysisMonitoringModel;
				...
				return this.service.update(new HemodialysisMonitoringModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.HemodialysisMonitoringActionOK(
						modelAction.HemodialysisMonitoringModelActionTypes.UPDATE_HEMODIALYSIS_MONITORING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.HemodialysisMonitoringActionFail(
								modelAction.HemodialysisMonitoringModelActionTypes.UPDATE_HEMODIALYSIS_MONITORING_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HemodialysisMonitoringAction>(modelAction.HemodialysisMonitoringModelActionTypes.UPDATE_ALL_HEMODIALYSIS_MONITORING),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as HemodialysisMonitoringModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new HemodialysisMonitoringModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.HemodialysisMonitoringActionOK(
						modelAction.HemodialysisMonitoringModelActionTypes.UPDATE_ALL_HEMODIALYSIS_MONITORING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.HemodialysisMonitoringActionFail(
								modelAction.HemodialysisMonitoringModelActionTypes.UPDATE_ALL_HEMODIALYSIS_MONITORING_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HemodialysisMonitoringAction>(modelAction.HemodialysisMonitoringModelActionTypes.DELETE_HEMODIALYSIS_MONITORING),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.HemodialysisMonitoringActionOK(
						modelAction.HemodialysisMonitoringModelActionTypes.DELETE_HEMODIALYSIS_MONITORING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.HemodialysisMonitoringActionFail(
								modelAction.HemodialysisMonitoringModelActionTypes.DELETE_HEMODIALYSIS_MONITORING_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HemodialysisMonitoringAction>(modelAction.HemodialysisMonitoringModelActionTypes.DELETE_HEMODIALYSIS_MONITORING_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.HemodialysisMonitoringActionOK(
						modelAction.HemodialysisMonitoringModelActionTypes.DELETE_HEMODIALYSIS_MONITORING_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.HemodialysisMonitoringActionFail(
								modelAction.HemodialysisMonitoringModelActionTypes.DELETE_HEMODIALYSIS_MONITORING_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HemodialysisMonitoringAction>(modelAction.HemodialysisMonitoringModelActionTypes.DELETE_ALL_HEMODIALYSIS_MONITORING),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.HemodialysisMonitoringActionOK(
						modelAction.HemodialysisMonitoringModelActionTypes.DELETE_ALL_HEMODIALYSIS_MONITORING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.HemodialysisMonitoringActionFail(
								modelAction.HemodialysisMonitoringModelActionTypes.DELETE_ALL_HEMODIALYSIS_MONITORING_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HemodialysisMonitoringAction>(modelAction.HemodialysisMonitoringModelActionTypes.EXPORT_HEMODIALYSIS_MONITORING),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.HemodialysisMonitoringActionOK(
						modelAction.HemodialysisMonitoringModelActionTypes.EXPORT_HEMODIALYSIS_MONITORING,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HemodialysisMonitoringAction>(modelAction.HemodialysisMonitoringModelActionTypes.EXPORT_ALL_HEMODIALYSIS_MONITORING),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.HemodialysisMonitoringActionOK(
						modelAction.HemodialysisMonitoringModelActionTypes.EXPORT_ALL_HEMODIALYSIS_MONITORING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.HemodialysisMonitoringActionFail(
								modelAction.HemodialysisMonitoringModelActionTypes.EXPORT_ALL_HEMODIALYSIS_MONITORING_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HemodialysisMonitoringAction>(modelAction.HemodialysisMonitoringModelActionTypes.EXPORT_HEMODIALYSIS_MONITORING_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.HemodialysisMonitoringActionOK(
						modelAction.HemodialysisMonitoringModelActionTypes.EXPORT_HEMODIALYSIS_MONITORING_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.HemodialysisMonitoringActionFail(
								modelAction.HemodialysisMonitoringModelActionTypes.EXPORT_HEMODIALYSIS_MONITORING_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HemodialysisMonitoringAction>(modelAction.HemodialysisMonitoringModelActionTypes.IMPORT_HEMODIALYSIS_MONITORINGS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.HemodialysisMonitoringActionOK(
						modelAction.HemodialysisMonitoringModelActionTypes.IMPORT_HEMODIALYSIS_MONITORINGS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.HemodialysisMonitoringActionFail(
								modelAction.HemodialysisMonitoringModelActionTypes.IMPORT_HEMODIALYSIS_MONITORINGS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HemodialysisMonitoringAction>(modelAction.HemodialysisMonitoringModelActionTypes.FETCH_HEMODIALYSIS_MONITORING_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.HemodialysisMonitoringActionOK(
						modelAction.HemodialysisMonitoringModelActionTypes.FETCH_HEMODIALYSIS_MONITORING_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.HemodialysisMonitoringActionFail(
								modelAction.HemodialysisMonitoringModelActionTypes.FETCH_HEMODIALYSIS_MONITORING_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HemodialysisMonitoringAction>(modelAction.HemodialysisMonitoringModelActionTypes.FETCH_HEMODIALYSIS_MONITORING_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.HemodialysisMonitoringActionOK(
						modelAction.HemodialysisMonitoringModelActionTypes.FETCH_HEMODIALYSIS_MONITORING_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.HemodialysisMonitoringActionFail(
								modelAction.HemodialysisMonitoringModelActionTypes.FETCH_HEMODIALYSIS_MONITORING_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
