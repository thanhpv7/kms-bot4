...
import * as modelAction from './tariff_schema.model.action';
import {TariffSchemaService} from '../../services/tariffSchema/tariff_schema.service';
...
/**
 * Effect class used for side effects related to Tariff Schema model.
 */
@Injectable()
export class TariffSchemaEffect {
	...
	constructor(
		...
		protected readonly service: TariffSchemaService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffSchemaAction>(modelAction.TariffSchemaModelActionTypes.COUNT_TARIFF_SCHEMAS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.TariffSchemaActionOK(
						modelAction.TariffSchemaModelActionTypes.COUNT_TARIFF_SCHEMAS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffSchemaActionFail(
								modelAction.TariffSchemaModelActionTypes.COUNT_TARIFF_SCHEMAS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffSchemaAction>(modelAction.TariffSchemaModelActionTypes.FETCH_TARIFF_SCHEMA),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.TariffSchemaActionOK(
						modelAction.TariffSchemaModelActionTypes.FETCH_TARIFF_SCHEMA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffSchemaActionFail(
								modelAction.TariffSchemaModelActionTypes.FETCH_TARIFF_SCHEMA_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffSchemaAction>(modelAction.TariffSchemaModelActionTypes.FETCH_ALL_TARIFF_SCHEMA),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.TariffSchemaActionOK(
						modelAction.TariffSchemaModelActionTypes.FETCH_ALL_TARIFF_SCHEMA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffSchemaActionFail(
								modelAction.TariffSchemaModelActionTypes.FETCH_ALL_TARIFF_SCHEMA_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffSchemaAction>(modelAction.TariffSchemaModelActionTypes.FETCH_TARIFF_SCHEMA_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.TariffSchemaActionOK(
						modelAction.TariffSchemaModelActionTypes.FETCH_TARIFF_SCHEMA_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffSchemaActionFail(
								modelAction.TariffSchemaModelActionTypes.FETCH_TARIFF_SCHEMA_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffSchemaAction>(modelAction.TariffSchemaModelActionTypes.FETCH_LAST_TARIFF_SCHEMA_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.TariffSchemaActionOK(
						modelAction.TariffSchemaModelActionTypes.FETCH_LAST_TARIFF_SCHEMA_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffSchemaActionFail(
								modelAction.TariffSchemaModelActionTypes.FETCH_LAST_TARIFF_SCHEMA_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffSchemaAction>(modelAction.TariffSchemaModelActionTypes.CREATE_TARIFF_SCHEMA),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as TariffSchemaModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.TariffSchemaActionOK(
						modelAction.TariffSchemaModelActionTypes.CREATE_TARIFF_SCHEMA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffSchemaActionFail(
								modelAction.TariffSchemaModelActionTypes.CREATE_TARIFF_SCHEMA_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffSchemaAction>(modelAction.TariffSchemaModelActionTypes.CREATE_ALL_TARIFF_SCHEMA),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as TariffSchemaModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.TariffSchemaActionOK(
						modelAction.TariffSchemaModelActionTypes.CREATE_ALL_TARIFF_SCHEMA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffSchemaActionFail(
								modelAction.TariffSchemaModelActionTypes.CREATE_ALL_TARIFF_SCHEMA_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffSchemaAction>(modelAction.TariffSchemaModelActionTypes.UPDATE_TARIFF_SCHEMA),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as TariffSchemaModel;
				...
				return this.service.update(new TariffSchemaModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.TariffSchemaActionOK(
						modelAction.TariffSchemaModelActionTypes.UPDATE_TARIFF_SCHEMA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffSchemaActionFail(
								modelAction.TariffSchemaModelActionTypes.UPDATE_TARIFF_SCHEMA_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffSchemaAction>(modelAction.TariffSchemaModelActionTypes.UPDATE_ALL_TARIFF_SCHEMA),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as TariffSchemaModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new TariffSchemaModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.TariffSchemaActionOK(
						modelAction.TariffSchemaModelActionTypes.UPDATE_ALL_TARIFF_SCHEMA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffSchemaActionFail(
								modelAction.TariffSchemaModelActionTypes.UPDATE_ALL_TARIFF_SCHEMA_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffSchemaAction>(modelAction.TariffSchemaModelActionTypes.DELETE_TARIFF_SCHEMA),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.TariffSchemaActionOK(
						modelAction.TariffSchemaModelActionTypes.DELETE_TARIFF_SCHEMA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffSchemaActionFail(
								modelAction.TariffSchemaModelActionTypes.DELETE_TARIFF_SCHEMA_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffSchemaAction>(modelAction.TariffSchemaModelActionTypes.DELETE_TARIFF_SCHEMA_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.TariffSchemaActionOK(
						modelAction.TariffSchemaModelActionTypes.DELETE_TARIFF_SCHEMA_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffSchemaActionFail(
								modelAction.TariffSchemaModelActionTypes.DELETE_TARIFF_SCHEMA_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffSchemaAction>(modelAction.TariffSchemaModelActionTypes.DELETE_ALL_TARIFF_SCHEMA),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.TariffSchemaActionOK(
						modelAction.TariffSchemaModelActionTypes.DELETE_ALL_TARIFF_SCHEMA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffSchemaActionFail(
								modelAction.TariffSchemaModelActionTypes.DELETE_ALL_TARIFF_SCHEMA_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffSchemaAction>(modelAction.TariffSchemaModelActionTypes.EXPORT_TARIFF_SCHEMA),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.TariffSchemaActionOK(
						modelAction.TariffSchemaModelActionTypes.EXPORT_TARIFF_SCHEMA,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffSchemaAction>(modelAction.TariffSchemaModelActionTypes.EXPORT_ALL_TARIFF_SCHEMA),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.TariffSchemaActionOK(
						modelAction.TariffSchemaModelActionTypes.EXPORT_ALL_TARIFF_SCHEMA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffSchemaActionFail(
								modelAction.TariffSchemaModelActionTypes.EXPORT_ALL_TARIFF_SCHEMA_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffSchemaAction>(modelAction.TariffSchemaModelActionTypes.EXPORT_TARIFF_SCHEMA_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.TariffSchemaActionOK(
						modelAction.TariffSchemaModelActionTypes.EXPORT_TARIFF_SCHEMA_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffSchemaActionFail(
								modelAction.TariffSchemaModelActionTypes.EXPORT_TARIFF_SCHEMA_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffSchemaAction>(modelAction.TariffSchemaModelActionTypes.IMPORT_TARIFF_SCHEMAS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.TariffSchemaActionOK(
						modelAction.TariffSchemaModelActionTypes.IMPORT_TARIFF_SCHEMAS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffSchemaActionFail(
								modelAction.TariffSchemaModelActionTypes.IMPORT_TARIFF_SCHEMAS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffSchemaAction>(modelAction.TariffSchemaModelActionTypes.FETCH_TARIFF_SCHEMA_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.TariffSchemaActionOK(
						modelAction.TariffSchemaModelActionTypes.FETCH_TARIFF_SCHEMA_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.TariffSchemaActionFail(
								modelAction.TariffSchemaModelActionTypes.FETCH_TARIFF_SCHEMA_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffSchemaAction>(modelAction.TariffSchemaModelActionTypes.FETCH_TARIFF_SCHEMA_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.TariffSchemaActionOK(
						modelAction.TariffSchemaModelActionTypes.FETCH_TARIFF_SCHEMA_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.TariffSchemaActionFail(
								modelAction.TariffSchemaModelActionTypes.FETCH_TARIFF_SCHEMA_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
