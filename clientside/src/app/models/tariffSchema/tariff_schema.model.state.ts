...
/**
 * TariffSchemaCollectionState would store the state of a collection of TariffSchema
 */
export interface TariffSchemaCollectionState extends CollectionState {
 ...
 */
export interface TariffSchemaModelAudit extends AbstractModelAudit<TariffSchemaModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * TariffSchemaModelState would store the state of the model
 */
export interface TariffSchemaModelState {
	collectionState: {
		[key: string]: TariffSchemaCollectionState;
	};
	data: {
		[id: string]: TariffSchemaModel;
	};
	totalCount: number;
	audits: TariffSchemaModelAudit[];
 ...
 */
export const initialTariffSchemaCollectionState: TariffSchemaCollectionState = {
...
/**
 * The initial state of TariffSchemaModelState
 */
export const initialState: TariffSchemaModelState = {
	collectionState: {
