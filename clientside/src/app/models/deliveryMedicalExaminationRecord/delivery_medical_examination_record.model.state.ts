...
/**
 * DeliveryMedicalExaminationRecordCollectionState would store the state of a collection of DeliveryMedicalExaminationRecord
 */
export interface DeliveryMedicalExaminationRecordCollectionState extends CollectionState {
 ...
 */
export interface DeliveryMedicalExaminationRecordModelAudit extends AbstractModelAudit<DeliveryMedicalExaminationRecordModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * DeliveryMedicalExaminationRecordModelState would store the state of the model
 */
export interface DeliveryMedicalExaminationRecordModelState {
	collectionState: {
		[key: string]: DeliveryMedicalExaminationRecordCollectionState;
	};
	data: {
		[id: string]: DeliveryMedicalExaminationRecordModel;
	};
	totalCount: number;
	audits: DeliveryMedicalExaminationRecordModelAudit[];
 ...
 */
export const initialDeliveryMedicalExaminationRecordCollectionState: DeliveryMedicalExaminationRecordCollectionState = {
...
/**
 * The initial state of DeliveryMedicalExaminationRecordModelState
 */
export const initialState: DeliveryMedicalExaminationRecordModelState = {
	collectionState: {
