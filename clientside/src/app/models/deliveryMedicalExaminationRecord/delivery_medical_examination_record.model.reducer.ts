...
import {initialDeliveryMedicalExaminationRecordCollectionState} from './delivery_medical_examination_record.model.state';
...
export function modelReducer(currentState: ModelState, action: Action): ModelState {
	...
	const className = (action as modelAction.BaseDeliveryMedicalExaminationRecordAction).className;
	...
	return produce(currentState, draft => {
		...
		switch (action.type) {
			case modelAction.DeliveryMedicalExaminationRecordModelActionTypes.CREATE_DELIVERY_MEDICAL_EXAMINATION_RECORD_OK:
				const createdModel = (action as modelAction.DeliveryMedicalExaminationRecordActionOK ).stateConfig.targetModel;
				...
				DeliveryMedicalExaminationRecordModel.deepParse(createdModel).forEach(model => {
				...
				break;
			case modelAction.DeliveryMedicalExaminationRecordModelActionTypes.CREATE_DELIVERY_MEDICAL_EXAMINATION_RECORD_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.DeliveryMedicalExaminationRecordModelActionTypes.CREATE_ALL_DELIVERY_MEDICAL_EXAMINATION_RECORD_OK:
				const createdModels = (action as modelAction.DeliveryMedicalExaminationRecordActionOK).stateConfig.targetModels;
				const collectionIdAfterCreateAll = (action as modelAction.DeliveryMedicalExaminationRecordActionOK).stateConfig.collectionId;
				...
				createdModels.forEach((m) => {
					DeliveryMedicalExaminationRecordModel.deepParse(m).forEach(model => {
						draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
						(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
					});
				});
				...
				break;
			case modelAction.DeliveryMedicalExaminationRecordModelActionTypes.CREATE_ALL_DELIVERY_MEDICAL_EXAMINATION_RECORD_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.DeliveryMedicalExaminationRecordModelActionTypes.DELETE_DELIVERY_MEDICAL_EXAMINATION_RECORD_OK:
				const deletedModelId = (action as modelAction.DeliveryMedicalExaminationRecordActionOK).stateConfig.targetModelId;
				const collectionIdAfterDelete = (action as modelAction.DeliveryMedicalExaminationRecordActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.DeliveryMedicalExaminationRecordModelActionTypes.DELETE_ALL_DELIVERY_MEDICAL_EXAMINATION_RECORD_OK:
				const deletedModelIds = (action as modelAction.DeliveryMedicalExaminationRecordActionOK).stateConfig.targetModelIds;
				const collectionIdAfterDeleteAll = (action as modelAction.DeliveryMedicalExaminationRecordActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.DeliveryMedicalExaminationRecordModelActionTypes.DELETE_DELIVERY_MEDICAL_EXAMINATION_RECORD_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.DeliveryMedicalExaminationRecordModelActionTypes.UPDATE_DELIVERY_MEDICAL_EXAMINATION_RECORD_OK:
				const updatedModel = (action as modelAction.DeliveryMedicalExaminationRecordActionOK).stateConfig.targetModel;
				...
				DeliveryMedicalExaminationRecordModel.deepParse(updatedModel).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.DeliveryMedicalExaminationRecordModelActionTypes.UPDATE_DELIVERY_MEDICAL_EXAMINATION_RECORD_FAIL:
				// TODO: Add handling of failure
				break;

			case modelAction.DeliveryMedicalExaminationRecordModelActionTypes.UPDATE_ALL_DELIVERY_MEDICAL_EXAMINATION_RECORD_OK:
				const updatedModels = (action as modelAction.DeliveryMedicalExaminationRecordActionOK).stateConfig.targetModels;
				const collectionIdAfterUpdateAll = (action as modelAction.DeliveryMedicalExaminationRecordActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.DeliveryMedicalExaminationRecordModelActionTypes.UPDATE_ALL_DELIVERY_MEDICAL_EXAMINATION_RECORD_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.DeliveryMedicalExaminationRecordModelActionTypes.FETCH_DELIVERY_MEDICAL_EXAMINATION_RECORD_OK:
				let fetchedModel = (action as modelAction.DeliveryMedicalExaminationRecordActionOK).stateConfig.targetModel;
				...
				DeliveryMedicalExaminationRecordModel.deepParse(fetchedModel).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.DeliveryMedicalExaminationRecordModelActionTypes.FETCH_ALL_DELIVERY_MEDICAL_EXAMINATION_RECORD_OK:
				const totalCountAfterFetchAll = (action as modelAction.DeliveryMedicalExaminationRecordActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchAll = (action as modelAction.DeliveryMedicalExaminationRecordActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchAll = (action as modelAction.DeliveryMedicalExaminationRecordActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchAll = (action as modelAction.DeliveryMedicalExaminationRecordActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchAll.map(model => DeliveryMedicalExaminationRecordModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.DeliveryMedicalExaminationRecordModelActionTypes.FETCH_DELIVERY_MEDICAL_EXAMINATION_RECORD_AUDIT_OK:
				const audits = (action as modelAction.DeliveryMedicalExaminationRecordActionOK).audits;
				...
				break;
			case modelAction.DeliveryMedicalExaminationRecordModelActionTypes.FETCH_DELIVERY_MEDICAL_EXAMINATION_RECORD_AUDITS_BY_ENTITY_ID_OK:
				const auditsByEntityId = (action as modelAction.DeliveryMedicalExaminationRecordActionOK).audits;
				...
				break;
			case modelAction.DeliveryMedicalExaminationRecordModelActionTypes.FETCH_DELIVERY_MEDICAL_EXAMINATION_RECORD_WITH_QUERY_OK:
				const totalCountAfterFetchWithQuery = (action as modelAction.DeliveryMedicalExaminationRecordActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchWithQuery = (action as modelAction.DeliveryMedicalExaminationRecordActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchWithQuery = (action as modelAction.DeliveryMedicalExaminationRecordActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchWithQuery = (action as modelAction.DeliveryMedicalExaminationRecordActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchWithQuery.map(model => DeliveryMedicalExaminationRecordModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.DeliveryMedicalExaminationRecordModelActionTypes.FETCH_LAST_DELIVERY_MEDICAL_EXAMINATION_RECORD_WITH_QUERY_OK:
				const totalCountAfterFetchLastWithQuery = (action as modelAction.DeliveryMedicalExaminationRecordActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchLastWithQuery = (action as modelAction.DeliveryMedicalExaminationRecordActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchLastWithQuery = (action as modelAction.DeliveryMedicalExaminationRecordActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchLastWithQuery = (action as modelAction.DeliveryMedicalExaminationRecordActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchLastWithQuery.map(model => DeliveryMedicalExaminationRecordModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.DeliveryMedicalExaminationRecordModelActionTypes.COUNT_DELIVERY_MEDICAL_EXAMINATION_RECORDS_OK:
				const totalCountAfterCount = (action as modelAction.DeliveryMedicalExaminationRecordActionOK).stateConfig.totalCount;
				...
				break;
			case modelAction.DeliveryMedicalExaminationRecordModelActionTypes.INITIALISE_DELIVERY_MEDICAL_EXAMINATION_RECORD_COLLECTION_STATE:
				const collectionIdToInitialise =  (action as modelAction.DeliveryMedicalExaminationRecordActionOK).stateConfig.collectionId;
				const queryParamsToInitialise = (action as modelAction.DeliveryMedicalExaminationRecordActionOK).stateConfig.queryParams;
				...
				if (!draft[className].collectionState[collectionIdToInitialise]) {
					draft[className].collectionState[collectionIdToInitialise] = {
						...initialDeliveryMedicalExaminationRecordCollectionState
					};
				}
