...
/**
 * GoodsReceiveNoteBatchCollectionState would store the state of a collection of GoodsReceiveNoteBatch
 */
export interface GoodsReceiveNoteBatchCollectionState extends CollectionState {
 ...
 */
export interface GoodsReceiveNoteBatchModelAudit extends AbstractModelAudit<GoodsReceiveNoteBatchModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * GoodsReceiveNoteBatchModelState would store the state of the model
 */
export interface GoodsReceiveNoteBatchModelState {
	collectionState: {
		[key: string]: GoodsReceiveNoteBatchCollectionState;
	};
	data: {
		[id: string]: GoodsReceiveNoteBatchModel;
	};
	totalCount: number;
	audits: GoodsReceiveNoteBatchModelAudit[];
 ...
 */
export const initialGoodsReceiveNoteBatchCollectionState: GoodsReceiveNoteBatchCollectionState = {
...
/**
 * The initial state of GoodsReceiveNoteBatchModelState
 */
export const initialState: GoodsReceiveNoteBatchModelState = {
	collectionState: {
