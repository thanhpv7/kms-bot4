...
import * as modelAction from './goods_receive_note_batch.model.action';
import {GoodsReceiveNoteBatchService} from '../../services/goodsReceiveNoteBatch/goods_receive_note_batch.service';
...
/**
 * Effect class used for side effects related to Goods Receive Note Batch model.
 */
@Injectable()
export class GoodsReceiveNoteBatchEffect {
	...
	constructor(
		...
		protected readonly service: GoodsReceiveNoteBatchService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteBatchAction>(modelAction.GoodsReceiveNoteBatchModelActionTypes.COUNT_GOODS_RECEIVE_NOTE_BATCHS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.GoodsReceiveNoteBatchActionOK(
						modelAction.GoodsReceiveNoteBatchModelActionTypes.COUNT_GOODS_RECEIVE_NOTE_BATCHS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteBatchActionFail(
								modelAction.GoodsReceiveNoteBatchModelActionTypes.COUNT_GOODS_RECEIVE_NOTE_BATCHS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteBatchAction>(modelAction.GoodsReceiveNoteBatchModelActionTypes.FETCH_GOODS_RECEIVE_NOTE_BATCH),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.GoodsReceiveNoteBatchActionOK(
						modelAction.GoodsReceiveNoteBatchModelActionTypes.FETCH_GOODS_RECEIVE_NOTE_BATCH_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteBatchActionFail(
								modelAction.GoodsReceiveNoteBatchModelActionTypes.FETCH_GOODS_RECEIVE_NOTE_BATCH_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteBatchAction>(modelAction.GoodsReceiveNoteBatchModelActionTypes.FETCH_ALL_GOODS_RECEIVE_NOTE_BATCH),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.GoodsReceiveNoteBatchActionOK(
						modelAction.GoodsReceiveNoteBatchModelActionTypes.FETCH_ALL_GOODS_RECEIVE_NOTE_BATCH_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteBatchActionFail(
								modelAction.GoodsReceiveNoteBatchModelActionTypes.FETCH_ALL_GOODS_RECEIVE_NOTE_BATCH_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteBatchAction>(modelAction.GoodsReceiveNoteBatchModelActionTypes.FETCH_GOODS_RECEIVE_NOTE_BATCH_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.GoodsReceiveNoteBatchActionOK(
						modelAction.GoodsReceiveNoteBatchModelActionTypes.FETCH_GOODS_RECEIVE_NOTE_BATCH_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteBatchActionFail(
								modelAction.GoodsReceiveNoteBatchModelActionTypes.FETCH_GOODS_RECEIVE_NOTE_BATCH_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteBatchAction>(modelAction.GoodsReceiveNoteBatchModelActionTypes.FETCH_LAST_GOODS_RECEIVE_NOTE_BATCH_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.GoodsReceiveNoteBatchActionOK(
						modelAction.GoodsReceiveNoteBatchModelActionTypes.FETCH_LAST_GOODS_RECEIVE_NOTE_BATCH_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteBatchActionFail(
								modelAction.GoodsReceiveNoteBatchModelActionTypes.FETCH_LAST_GOODS_RECEIVE_NOTE_BATCH_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteBatchAction>(modelAction.GoodsReceiveNoteBatchModelActionTypes.CREATE_GOODS_RECEIVE_NOTE_BATCH),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as GoodsReceiveNoteBatchModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.GoodsReceiveNoteBatchActionOK(
						modelAction.GoodsReceiveNoteBatchModelActionTypes.CREATE_GOODS_RECEIVE_NOTE_BATCH_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteBatchActionFail(
								modelAction.GoodsReceiveNoteBatchModelActionTypes.CREATE_GOODS_RECEIVE_NOTE_BATCH_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteBatchAction>(modelAction.GoodsReceiveNoteBatchModelActionTypes.CREATE_ALL_GOODS_RECEIVE_NOTE_BATCH),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as GoodsReceiveNoteBatchModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.GoodsReceiveNoteBatchActionOK(
						modelAction.GoodsReceiveNoteBatchModelActionTypes.CREATE_ALL_GOODS_RECEIVE_NOTE_BATCH_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteBatchActionFail(
								modelAction.GoodsReceiveNoteBatchModelActionTypes.CREATE_ALL_GOODS_RECEIVE_NOTE_BATCH_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteBatchAction>(modelAction.GoodsReceiveNoteBatchModelActionTypes.UPDATE_GOODS_RECEIVE_NOTE_BATCH),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as GoodsReceiveNoteBatchModel;
				...
				return this.service.update(new GoodsReceiveNoteBatchModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.GoodsReceiveNoteBatchActionOK(
						modelAction.GoodsReceiveNoteBatchModelActionTypes.UPDATE_GOODS_RECEIVE_NOTE_BATCH_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteBatchActionFail(
								modelAction.GoodsReceiveNoteBatchModelActionTypes.UPDATE_GOODS_RECEIVE_NOTE_BATCH_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteBatchAction>(modelAction.GoodsReceiveNoteBatchModelActionTypes.UPDATE_ALL_GOODS_RECEIVE_NOTE_BATCH),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as GoodsReceiveNoteBatchModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new GoodsReceiveNoteBatchModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.GoodsReceiveNoteBatchActionOK(
						modelAction.GoodsReceiveNoteBatchModelActionTypes.UPDATE_ALL_GOODS_RECEIVE_NOTE_BATCH_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteBatchActionFail(
								modelAction.GoodsReceiveNoteBatchModelActionTypes.UPDATE_ALL_GOODS_RECEIVE_NOTE_BATCH_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteBatchAction>(modelAction.GoodsReceiveNoteBatchModelActionTypes.DELETE_GOODS_RECEIVE_NOTE_BATCH),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.GoodsReceiveNoteBatchActionOK(
						modelAction.GoodsReceiveNoteBatchModelActionTypes.DELETE_GOODS_RECEIVE_NOTE_BATCH_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteBatchActionFail(
								modelAction.GoodsReceiveNoteBatchModelActionTypes.DELETE_GOODS_RECEIVE_NOTE_BATCH_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteBatchAction>(modelAction.GoodsReceiveNoteBatchModelActionTypes.DELETE_GOODS_RECEIVE_NOTE_BATCH_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.GoodsReceiveNoteBatchActionOK(
						modelAction.GoodsReceiveNoteBatchModelActionTypes.DELETE_GOODS_RECEIVE_NOTE_BATCH_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteBatchActionFail(
								modelAction.GoodsReceiveNoteBatchModelActionTypes.DELETE_GOODS_RECEIVE_NOTE_BATCH_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteBatchAction>(modelAction.GoodsReceiveNoteBatchModelActionTypes.DELETE_ALL_GOODS_RECEIVE_NOTE_BATCH),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.GoodsReceiveNoteBatchActionOK(
						modelAction.GoodsReceiveNoteBatchModelActionTypes.DELETE_ALL_GOODS_RECEIVE_NOTE_BATCH_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteBatchActionFail(
								modelAction.GoodsReceiveNoteBatchModelActionTypes.DELETE_ALL_GOODS_RECEIVE_NOTE_BATCH_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteBatchAction>(modelAction.GoodsReceiveNoteBatchModelActionTypes.EXPORT_GOODS_RECEIVE_NOTE_BATCH),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.GoodsReceiveNoteBatchActionOK(
						modelAction.GoodsReceiveNoteBatchModelActionTypes.EXPORT_GOODS_RECEIVE_NOTE_BATCH,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteBatchAction>(modelAction.GoodsReceiveNoteBatchModelActionTypes.EXPORT_ALL_GOODS_RECEIVE_NOTE_BATCH),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.GoodsReceiveNoteBatchActionOK(
						modelAction.GoodsReceiveNoteBatchModelActionTypes.EXPORT_ALL_GOODS_RECEIVE_NOTE_BATCH_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteBatchActionFail(
								modelAction.GoodsReceiveNoteBatchModelActionTypes.EXPORT_ALL_GOODS_RECEIVE_NOTE_BATCH_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteBatchAction>(modelAction.GoodsReceiveNoteBatchModelActionTypes.EXPORT_GOODS_RECEIVE_NOTE_BATCH_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.GoodsReceiveNoteBatchActionOK(
						modelAction.GoodsReceiveNoteBatchModelActionTypes.EXPORT_GOODS_RECEIVE_NOTE_BATCH_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteBatchActionFail(
								modelAction.GoodsReceiveNoteBatchModelActionTypes.EXPORT_GOODS_RECEIVE_NOTE_BATCH_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteBatchAction>(modelAction.GoodsReceiveNoteBatchModelActionTypes.IMPORT_GOODS_RECEIVE_NOTE_BATCHS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.GoodsReceiveNoteBatchActionOK(
						modelAction.GoodsReceiveNoteBatchModelActionTypes.IMPORT_GOODS_RECEIVE_NOTE_BATCHS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteBatchActionFail(
								modelAction.GoodsReceiveNoteBatchModelActionTypes.IMPORT_GOODS_RECEIVE_NOTE_BATCHS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteBatchAction>(modelAction.GoodsReceiveNoteBatchModelActionTypes.FETCH_GOODS_RECEIVE_NOTE_BATCH_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.GoodsReceiveNoteBatchActionOK(
						modelAction.GoodsReceiveNoteBatchModelActionTypes.FETCH_GOODS_RECEIVE_NOTE_BATCH_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteBatchActionFail(
								modelAction.GoodsReceiveNoteBatchModelActionTypes.FETCH_GOODS_RECEIVE_NOTE_BATCH_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteBatchAction>(modelAction.GoodsReceiveNoteBatchModelActionTypes.FETCH_GOODS_RECEIVE_NOTE_BATCH_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.GoodsReceiveNoteBatchActionOK(
						modelAction.GoodsReceiveNoteBatchModelActionTypes.FETCH_GOODS_RECEIVE_NOTE_BATCH_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteBatchActionFail(
								modelAction.GoodsReceiveNoteBatchModelActionTypes.FETCH_GOODS_RECEIVE_NOTE_BATCH_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
