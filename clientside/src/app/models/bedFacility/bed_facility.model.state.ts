...
/**
 * BedFacilityCollectionState would store the state of a collection of BedFacility
 */
export interface BedFacilityCollectionState extends CollectionState {
 ...
 */
export interface BedFacilityModelAudit extends AbstractModelAudit<BedFacilityModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BedFacilityModelState would store the state of the model
 */
export interface BedFacilityModelState {
	collectionState: {
		[key: string]: BedFacilityCollectionState;
	};
	data: {
		[id: string]: BedFacilityModel;
	};
	totalCount: number;
	audits: BedFacilityModelAudit[];
 ...
 */
export const initialBedFacilityCollectionState: BedFacilityCollectionState = {
...
/**
 * The initial state of BedFacilityModelState
 */
export const initialState: BedFacilityModelState = {
	collectionState: {
