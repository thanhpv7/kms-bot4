...
import * as modelAction from './bed_facility.model.action';
import {BedFacilityService} from '../../services/bedFacility/bed_facility.service';
...
/**
 * Effect class used for side effects related to Bed Facility model.
 */
@Injectable()
export class BedFacilityEffect {
	...
	constructor(
		...
		protected readonly service: BedFacilityService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BedFacilityAction>(modelAction.BedFacilityModelActionTypes.COUNT_BED_FACILITYS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BedFacilityActionOK(
						modelAction.BedFacilityModelActionTypes.COUNT_BED_FACILITYS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BedFacilityActionFail(
								modelAction.BedFacilityModelActionTypes.COUNT_BED_FACILITYS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BedFacilityAction>(modelAction.BedFacilityModelActionTypes.FETCH_BED_FACILITY),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BedFacilityActionOK(
						modelAction.BedFacilityModelActionTypes.FETCH_BED_FACILITY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BedFacilityActionFail(
								modelAction.BedFacilityModelActionTypes.FETCH_BED_FACILITY_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BedFacilityAction>(modelAction.BedFacilityModelActionTypes.FETCH_ALL_BED_FACILITY),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BedFacilityActionOK(
						modelAction.BedFacilityModelActionTypes.FETCH_ALL_BED_FACILITY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BedFacilityActionFail(
								modelAction.BedFacilityModelActionTypes.FETCH_ALL_BED_FACILITY_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BedFacilityAction>(modelAction.BedFacilityModelActionTypes.FETCH_BED_FACILITY_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BedFacilityActionOK(
						modelAction.BedFacilityModelActionTypes.FETCH_BED_FACILITY_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BedFacilityActionFail(
								modelAction.BedFacilityModelActionTypes.FETCH_BED_FACILITY_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BedFacilityAction>(modelAction.BedFacilityModelActionTypes.FETCH_LAST_BED_FACILITY_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BedFacilityActionOK(
						modelAction.BedFacilityModelActionTypes.FETCH_LAST_BED_FACILITY_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BedFacilityActionFail(
								modelAction.BedFacilityModelActionTypes.FETCH_LAST_BED_FACILITY_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BedFacilityAction>(modelAction.BedFacilityModelActionTypes.CREATE_BED_FACILITY),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BedFacilityModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BedFacilityActionOK(
						modelAction.BedFacilityModelActionTypes.CREATE_BED_FACILITY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BedFacilityActionFail(
								modelAction.BedFacilityModelActionTypes.CREATE_BED_FACILITY_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BedFacilityAction>(modelAction.BedFacilityModelActionTypes.CREATE_ALL_BED_FACILITY),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BedFacilityModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BedFacilityActionOK(
						modelAction.BedFacilityModelActionTypes.CREATE_ALL_BED_FACILITY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BedFacilityActionFail(
								modelAction.BedFacilityModelActionTypes.CREATE_ALL_BED_FACILITY_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BedFacilityAction>(modelAction.BedFacilityModelActionTypes.UPDATE_BED_FACILITY),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BedFacilityModel;
				...
				return this.service.update(new BedFacilityModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BedFacilityActionOK(
						modelAction.BedFacilityModelActionTypes.UPDATE_BED_FACILITY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BedFacilityActionFail(
								modelAction.BedFacilityModelActionTypes.UPDATE_BED_FACILITY_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BedFacilityAction>(modelAction.BedFacilityModelActionTypes.UPDATE_ALL_BED_FACILITY),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BedFacilityModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BedFacilityModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BedFacilityActionOK(
						modelAction.BedFacilityModelActionTypes.UPDATE_ALL_BED_FACILITY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BedFacilityActionFail(
								modelAction.BedFacilityModelActionTypes.UPDATE_ALL_BED_FACILITY_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BedFacilityAction>(modelAction.BedFacilityModelActionTypes.DELETE_BED_FACILITY),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BedFacilityActionOK(
						modelAction.BedFacilityModelActionTypes.DELETE_BED_FACILITY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BedFacilityActionFail(
								modelAction.BedFacilityModelActionTypes.DELETE_BED_FACILITY_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BedFacilityAction>(modelAction.BedFacilityModelActionTypes.DELETE_BED_FACILITY_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BedFacilityActionOK(
						modelAction.BedFacilityModelActionTypes.DELETE_BED_FACILITY_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BedFacilityActionFail(
								modelAction.BedFacilityModelActionTypes.DELETE_BED_FACILITY_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BedFacilityAction>(modelAction.BedFacilityModelActionTypes.DELETE_ALL_BED_FACILITY),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BedFacilityActionOK(
						modelAction.BedFacilityModelActionTypes.DELETE_ALL_BED_FACILITY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BedFacilityActionFail(
								modelAction.BedFacilityModelActionTypes.DELETE_ALL_BED_FACILITY_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BedFacilityAction>(modelAction.BedFacilityModelActionTypes.EXPORT_BED_FACILITY),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BedFacilityActionOK(
						modelAction.BedFacilityModelActionTypes.EXPORT_BED_FACILITY,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BedFacilityAction>(modelAction.BedFacilityModelActionTypes.EXPORT_ALL_BED_FACILITY),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BedFacilityActionOK(
						modelAction.BedFacilityModelActionTypes.EXPORT_ALL_BED_FACILITY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BedFacilityActionFail(
								modelAction.BedFacilityModelActionTypes.EXPORT_ALL_BED_FACILITY_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BedFacilityAction>(modelAction.BedFacilityModelActionTypes.EXPORT_BED_FACILITY_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BedFacilityActionOK(
						modelAction.BedFacilityModelActionTypes.EXPORT_BED_FACILITY_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BedFacilityActionFail(
								modelAction.BedFacilityModelActionTypes.EXPORT_BED_FACILITY_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BedFacilityAction>(modelAction.BedFacilityModelActionTypes.IMPORT_BED_FACILITYS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BedFacilityActionOK(
						modelAction.BedFacilityModelActionTypes.IMPORT_BED_FACILITYS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BedFacilityActionFail(
								modelAction.BedFacilityModelActionTypes.IMPORT_BED_FACILITYS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BedFacilityAction>(modelAction.BedFacilityModelActionTypes.FETCH_BED_FACILITY_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BedFacilityActionOK(
						modelAction.BedFacilityModelActionTypes.FETCH_BED_FACILITY_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BedFacilityActionFail(
								modelAction.BedFacilityModelActionTypes.FETCH_BED_FACILITY_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BedFacilityAction>(modelAction.BedFacilityModelActionTypes.FETCH_BED_FACILITY_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BedFacilityActionOK(
						modelAction.BedFacilityModelActionTypes.FETCH_BED_FACILITY_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BedFacilityActionFail(
								modelAction.BedFacilityModelActionTypes.FETCH_BED_FACILITY_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
