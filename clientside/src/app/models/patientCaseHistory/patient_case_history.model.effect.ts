...
import * as modelAction from './patient_case_history.model.action';
import {PatientCaseHistoryService} from '../../services/patientCaseHistory/patient_case_history.service';
...
/**
 * Effect class used for side effects related to Patient Case History model.
 */
@Injectable()
export class PatientCaseHistoryEffect {
	...
	constructor(
		...
		protected readonly service: PatientCaseHistoryService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientCaseHistoryAction>(modelAction.PatientCaseHistoryModelActionTypes.COUNT_PATIENT_CASE_HISTORYS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.PatientCaseHistoryActionOK(
						modelAction.PatientCaseHistoryModelActionTypes.COUNT_PATIENT_CASE_HISTORYS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientCaseHistoryActionFail(
								modelAction.PatientCaseHistoryModelActionTypes.COUNT_PATIENT_CASE_HISTORYS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientCaseHistoryAction>(modelAction.PatientCaseHistoryModelActionTypes.FETCH_PATIENT_CASE_HISTORY),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientCaseHistoryActionOK(
						modelAction.PatientCaseHistoryModelActionTypes.FETCH_PATIENT_CASE_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientCaseHistoryActionFail(
								modelAction.PatientCaseHistoryModelActionTypes.FETCH_PATIENT_CASE_HISTORY_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientCaseHistoryAction>(modelAction.PatientCaseHistoryModelActionTypes.FETCH_ALL_PATIENT_CASE_HISTORY),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.PatientCaseHistoryActionOK(
						modelAction.PatientCaseHistoryModelActionTypes.FETCH_ALL_PATIENT_CASE_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientCaseHistoryActionFail(
								modelAction.PatientCaseHistoryModelActionTypes.FETCH_ALL_PATIENT_CASE_HISTORY_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientCaseHistoryAction>(modelAction.PatientCaseHistoryModelActionTypes.FETCH_PATIENT_CASE_HISTORY_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientCaseHistoryActionOK(
						modelAction.PatientCaseHistoryModelActionTypes.FETCH_PATIENT_CASE_HISTORY_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientCaseHistoryActionFail(
								modelAction.PatientCaseHistoryModelActionTypes.FETCH_PATIENT_CASE_HISTORY_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientCaseHistoryAction>(modelAction.PatientCaseHistoryModelActionTypes.FETCH_LAST_PATIENT_CASE_HISTORY_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientCaseHistoryActionOK(
						modelAction.PatientCaseHistoryModelActionTypes.FETCH_LAST_PATIENT_CASE_HISTORY_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientCaseHistoryActionFail(
								modelAction.PatientCaseHistoryModelActionTypes.FETCH_LAST_PATIENT_CASE_HISTORY_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientCaseHistoryAction>(modelAction.PatientCaseHistoryModelActionTypes.CREATE_PATIENT_CASE_HISTORY),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as PatientCaseHistoryModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientCaseHistoryActionOK(
						modelAction.PatientCaseHistoryModelActionTypes.CREATE_PATIENT_CASE_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientCaseHistoryActionFail(
								modelAction.PatientCaseHistoryModelActionTypes.CREATE_PATIENT_CASE_HISTORY_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientCaseHistoryAction>(modelAction.PatientCaseHistoryModelActionTypes.CREATE_ALL_PATIENT_CASE_HISTORY),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as PatientCaseHistoryModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientCaseHistoryActionOK(
						modelAction.PatientCaseHistoryModelActionTypes.CREATE_ALL_PATIENT_CASE_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientCaseHistoryActionFail(
								modelAction.PatientCaseHistoryModelActionTypes.CREATE_ALL_PATIENT_CASE_HISTORY_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientCaseHistoryAction>(modelAction.PatientCaseHistoryModelActionTypes.UPDATE_PATIENT_CASE_HISTORY),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as PatientCaseHistoryModel;
				...
				return this.service.update(new PatientCaseHistoryModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientCaseHistoryActionOK(
						modelAction.PatientCaseHistoryModelActionTypes.UPDATE_PATIENT_CASE_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientCaseHistoryActionFail(
								modelAction.PatientCaseHistoryModelActionTypes.UPDATE_PATIENT_CASE_HISTORY_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientCaseHistoryAction>(modelAction.PatientCaseHistoryModelActionTypes.UPDATE_ALL_PATIENT_CASE_HISTORY),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as PatientCaseHistoryModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new PatientCaseHistoryModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientCaseHistoryActionOK(
						modelAction.PatientCaseHistoryModelActionTypes.UPDATE_ALL_PATIENT_CASE_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientCaseHistoryActionFail(
								modelAction.PatientCaseHistoryModelActionTypes.UPDATE_ALL_PATIENT_CASE_HISTORY_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientCaseHistoryAction>(modelAction.PatientCaseHistoryModelActionTypes.DELETE_PATIENT_CASE_HISTORY),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PatientCaseHistoryActionOK(
						modelAction.PatientCaseHistoryModelActionTypes.DELETE_PATIENT_CASE_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientCaseHistoryActionFail(
								modelAction.PatientCaseHistoryModelActionTypes.DELETE_PATIENT_CASE_HISTORY_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientCaseHistoryAction>(modelAction.PatientCaseHistoryModelActionTypes.DELETE_PATIENT_CASE_HISTORY_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.PatientCaseHistoryActionOK(
						modelAction.PatientCaseHistoryModelActionTypes.DELETE_PATIENT_CASE_HISTORY_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientCaseHistoryActionFail(
								modelAction.PatientCaseHistoryModelActionTypes.DELETE_PATIENT_CASE_HISTORY_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientCaseHistoryAction>(modelAction.PatientCaseHistoryModelActionTypes.DELETE_ALL_PATIENT_CASE_HISTORY),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PatientCaseHistoryActionOK(
						modelAction.PatientCaseHistoryModelActionTypes.DELETE_ALL_PATIENT_CASE_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientCaseHistoryActionFail(
								modelAction.PatientCaseHistoryModelActionTypes.DELETE_ALL_PATIENT_CASE_HISTORY_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientCaseHistoryAction>(modelAction.PatientCaseHistoryModelActionTypes.EXPORT_PATIENT_CASE_HISTORY),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PatientCaseHistoryActionOK(
						modelAction.PatientCaseHistoryModelActionTypes.EXPORT_PATIENT_CASE_HISTORY,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientCaseHistoryAction>(modelAction.PatientCaseHistoryModelActionTypes.EXPORT_ALL_PATIENT_CASE_HISTORY),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PatientCaseHistoryActionOK(
						modelAction.PatientCaseHistoryModelActionTypes.EXPORT_ALL_PATIENT_CASE_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientCaseHistoryActionFail(
								modelAction.PatientCaseHistoryModelActionTypes.EXPORT_ALL_PATIENT_CASE_HISTORY_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientCaseHistoryAction>(modelAction.PatientCaseHistoryModelActionTypes.EXPORT_PATIENT_CASE_HISTORY_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PatientCaseHistoryActionOK(
						modelAction.PatientCaseHistoryModelActionTypes.EXPORT_PATIENT_CASE_HISTORY_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientCaseHistoryActionFail(
								modelAction.PatientCaseHistoryModelActionTypes.EXPORT_PATIENT_CASE_HISTORY_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientCaseHistoryAction>(modelAction.PatientCaseHistoryModelActionTypes.IMPORT_PATIENT_CASE_HISTORYS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.PatientCaseHistoryActionOK(
						modelAction.PatientCaseHistoryModelActionTypes.IMPORT_PATIENT_CASE_HISTORYS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientCaseHistoryActionFail(
								modelAction.PatientCaseHistoryModelActionTypes.IMPORT_PATIENT_CASE_HISTORYS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientCaseHistoryAction>(modelAction.PatientCaseHistoryModelActionTypes.FETCH_PATIENT_CASE_HISTORY_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.PatientCaseHistoryActionOK(
						modelAction.PatientCaseHistoryModelActionTypes.FETCH_PATIENT_CASE_HISTORY_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PatientCaseHistoryActionFail(
								modelAction.PatientCaseHistoryModelActionTypes.FETCH_PATIENT_CASE_HISTORY_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientCaseHistoryAction>(modelAction.PatientCaseHistoryModelActionTypes.FETCH_PATIENT_CASE_HISTORY_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.PatientCaseHistoryActionOK(
						modelAction.PatientCaseHistoryModelActionTypes.FETCH_PATIENT_CASE_HISTORY_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PatientCaseHistoryActionFail(
								modelAction.PatientCaseHistoryModelActionTypes.FETCH_PATIENT_CASE_HISTORY_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
