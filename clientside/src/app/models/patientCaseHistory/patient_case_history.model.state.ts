...
/**
 * PatientCaseHistoryCollectionState would store the state of a collection of PatientCaseHistory
 */
export interface PatientCaseHistoryCollectionState extends CollectionState {
 ...
 */
export interface PatientCaseHistoryModelAudit extends AbstractModelAudit<PatientCaseHistoryModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * PatientCaseHistoryModelState would store the state of the model
 */
export interface PatientCaseHistoryModelState {
	collectionState: {
		[key: string]: PatientCaseHistoryCollectionState;
	};
	data: {
		[id: string]: PatientCaseHistoryModel;
	};
	totalCount: number;
	audits: PatientCaseHistoryModelAudit[];
 ...
 */
export const initialPatientCaseHistoryCollectionState: PatientCaseHistoryCollectionState = {
...
/**
 * The initial state of PatientCaseHistoryModelState
 */
export const initialState: PatientCaseHistoryModelState = {
	collectionState: {
