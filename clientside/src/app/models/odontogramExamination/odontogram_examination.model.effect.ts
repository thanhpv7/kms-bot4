...
import * as modelAction from './odontogram_examination.model.action';
import {OdontogramExaminationService} from '../../services/odontogramExamination/odontogram_examination.service';
...
/**
 * Effect class used for side effects related to Odontogram Examination model.
 */
@Injectable()
export class OdontogramExaminationEffect {
	...
	constructor(
		...
		protected readonly service: OdontogramExaminationService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OdontogramExaminationAction>(modelAction.OdontogramExaminationModelActionTypes.COUNT_ODONTOGRAM_EXAMINATIONS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.OdontogramExaminationActionOK(
						modelAction.OdontogramExaminationModelActionTypes.COUNT_ODONTOGRAM_EXAMINATIONS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.OdontogramExaminationActionFail(
								modelAction.OdontogramExaminationModelActionTypes.COUNT_ODONTOGRAM_EXAMINATIONS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OdontogramExaminationAction>(modelAction.OdontogramExaminationModelActionTypes.FETCH_ODONTOGRAM_EXAMINATION),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.OdontogramExaminationActionOK(
						modelAction.OdontogramExaminationModelActionTypes.FETCH_ODONTOGRAM_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.OdontogramExaminationActionFail(
								modelAction.OdontogramExaminationModelActionTypes.FETCH_ODONTOGRAM_EXAMINATION_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OdontogramExaminationAction>(modelAction.OdontogramExaminationModelActionTypes.FETCH_ALL_ODONTOGRAM_EXAMINATION),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.OdontogramExaminationActionOK(
						modelAction.OdontogramExaminationModelActionTypes.FETCH_ALL_ODONTOGRAM_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.OdontogramExaminationActionFail(
								modelAction.OdontogramExaminationModelActionTypes.FETCH_ALL_ODONTOGRAM_EXAMINATION_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OdontogramExaminationAction>(modelAction.OdontogramExaminationModelActionTypes.FETCH_ODONTOGRAM_EXAMINATION_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.OdontogramExaminationActionOK(
						modelAction.OdontogramExaminationModelActionTypes.FETCH_ODONTOGRAM_EXAMINATION_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.OdontogramExaminationActionFail(
								modelAction.OdontogramExaminationModelActionTypes.FETCH_ODONTOGRAM_EXAMINATION_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OdontogramExaminationAction>(modelAction.OdontogramExaminationModelActionTypes.FETCH_LAST_ODONTOGRAM_EXAMINATION_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.OdontogramExaminationActionOK(
						modelAction.OdontogramExaminationModelActionTypes.FETCH_LAST_ODONTOGRAM_EXAMINATION_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.OdontogramExaminationActionFail(
								modelAction.OdontogramExaminationModelActionTypes.FETCH_LAST_ODONTOGRAM_EXAMINATION_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OdontogramExaminationAction>(modelAction.OdontogramExaminationModelActionTypes.CREATE_ODONTOGRAM_EXAMINATION),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as OdontogramExaminationModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.OdontogramExaminationActionOK(
						modelAction.OdontogramExaminationModelActionTypes.CREATE_ODONTOGRAM_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.OdontogramExaminationActionFail(
								modelAction.OdontogramExaminationModelActionTypes.CREATE_ODONTOGRAM_EXAMINATION_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OdontogramExaminationAction>(modelAction.OdontogramExaminationModelActionTypes.CREATE_ALL_ODONTOGRAM_EXAMINATION),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as OdontogramExaminationModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.OdontogramExaminationActionOK(
						modelAction.OdontogramExaminationModelActionTypes.CREATE_ALL_ODONTOGRAM_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.OdontogramExaminationActionFail(
								modelAction.OdontogramExaminationModelActionTypes.CREATE_ALL_ODONTOGRAM_EXAMINATION_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OdontogramExaminationAction>(modelAction.OdontogramExaminationModelActionTypes.UPDATE_ODONTOGRAM_EXAMINATION),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as OdontogramExaminationModel;
				...
				return this.service.update(new OdontogramExaminationModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.OdontogramExaminationActionOK(
						modelAction.OdontogramExaminationModelActionTypes.UPDATE_ODONTOGRAM_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.OdontogramExaminationActionFail(
								modelAction.OdontogramExaminationModelActionTypes.UPDATE_ODONTOGRAM_EXAMINATION_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OdontogramExaminationAction>(modelAction.OdontogramExaminationModelActionTypes.UPDATE_ALL_ODONTOGRAM_EXAMINATION),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as OdontogramExaminationModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new OdontogramExaminationModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.OdontogramExaminationActionOK(
						modelAction.OdontogramExaminationModelActionTypes.UPDATE_ALL_ODONTOGRAM_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.OdontogramExaminationActionFail(
								modelAction.OdontogramExaminationModelActionTypes.UPDATE_ALL_ODONTOGRAM_EXAMINATION_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OdontogramExaminationAction>(modelAction.OdontogramExaminationModelActionTypes.DELETE_ODONTOGRAM_EXAMINATION),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.OdontogramExaminationActionOK(
						modelAction.OdontogramExaminationModelActionTypes.DELETE_ODONTOGRAM_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.OdontogramExaminationActionFail(
								modelAction.OdontogramExaminationModelActionTypes.DELETE_ODONTOGRAM_EXAMINATION_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OdontogramExaminationAction>(modelAction.OdontogramExaminationModelActionTypes.DELETE_ODONTOGRAM_EXAMINATION_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.OdontogramExaminationActionOK(
						modelAction.OdontogramExaminationModelActionTypes.DELETE_ODONTOGRAM_EXAMINATION_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.OdontogramExaminationActionFail(
								modelAction.OdontogramExaminationModelActionTypes.DELETE_ODONTOGRAM_EXAMINATION_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OdontogramExaminationAction>(modelAction.OdontogramExaminationModelActionTypes.DELETE_ALL_ODONTOGRAM_EXAMINATION),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.OdontogramExaminationActionOK(
						modelAction.OdontogramExaminationModelActionTypes.DELETE_ALL_ODONTOGRAM_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.OdontogramExaminationActionFail(
								modelAction.OdontogramExaminationModelActionTypes.DELETE_ALL_ODONTOGRAM_EXAMINATION_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OdontogramExaminationAction>(modelAction.OdontogramExaminationModelActionTypes.EXPORT_ODONTOGRAM_EXAMINATION),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.OdontogramExaminationActionOK(
						modelAction.OdontogramExaminationModelActionTypes.EXPORT_ODONTOGRAM_EXAMINATION,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OdontogramExaminationAction>(modelAction.OdontogramExaminationModelActionTypes.EXPORT_ALL_ODONTOGRAM_EXAMINATION),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.OdontogramExaminationActionOK(
						modelAction.OdontogramExaminationModelActionTypes.EXPORT_ALL_ODONTOGRAM_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.OdontogramExaminationActionFail(
								modelAction.OdontogramExaminationModelActionTypes.EXPORT_ALL_ODONTOGRAM_EXAMINATION_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OdontogramExaminationAction>(modelAction.OdontogramExaminationModelActionTypes.EXPORT_ODONTOGRAM_EXAMINATION_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.OdontogramExaminationActionOK(
						modelAction.OdontogramExaminationModelActionTypes.EXPORT_ODONTOGRAM_EXAMINATION_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.OdontogramExaminationActionFail(
								modelAction.OdontogramExaminationModelActionTypes.EXPORT_ODONTOGRAM_EXAMINATION_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OdontogramExaminationAction>(modelAction.OdontogramExaminationModelActionTypes.IMPORT_ODONTOGRAM_EXAMINATIONS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.OdontogramExaminationActionOK(
						modelAction.OdontogramExaminationModelActionTypes.IMPORT_ODONTOGRAM_EXAMINATIONS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.OdontogramExaminationActionFail(
								modelAction.OdontogramExaminationModelActionTypes.IMPORT_ODONTOGRAM_EXAMINATIONS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OdontogramExaminationAction>(modelAction.OdontogramExaminationModelActionTypes.FETCH_ODONTOGRAM_EXAMINATION_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.OdontogramExaminationActionOK(
						modelAction.OdontogramExaminationModelActionTypes.FETCH_ODONTOGRAM_EXAMINATION_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.OdontogramExaminationActionFail(
								modelAction.OdontogramExaminationModelActionTypes.FETCH_ODONTOGRAM_EXAMINATION_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OdontogramExaminationAction>(modelAction.OdontogramExaminationModelActionTypes.FETCH_ODONTOGRAM_EXAMINATION_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.OdontogramExaminationActionOK(
						modelAction.OdontogramExaminationModelActionTypes.FETCH_ODONTOGRAM_EXAMINATION_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.OdontogramExaminationActionFail(
								modelAction.OdontogramExaminationModelActionTypes.FETCH_ODONTOGRAM_EXAMINATION_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
