...
/**
 * OdontogramExaminationCollectionState would store the state of a collection of OdontogramExamination
 */
export interface OdontogramExaminationCollectionState extends CollectionState {
 ...
 */
export interface OdontogramExaminationModelAudit extends AbstractModelAudit<OdontogramExaminationModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * OdontogramExaminationModelState would store the state of the model
 */
export interface OdontogramExaminationModelState {
	collectionState: {
		[key: string]: OdontogramExaminationCollectionState;
	};
	data: {
		[id: string]: OdontogramExaminationModel;
	};
	totalCount: number;
	audits: OdontogramExaminationModelAudit[];
 ...
 */
export const initialOdontogramExaminationCollectionState: OdontogramExaminationCollectionState = {
...
/**
 * The initial state of OdontogramExaminationModelState
 */
export const initialState: OdontogramExaminationModelState = {
	collectionState: {
