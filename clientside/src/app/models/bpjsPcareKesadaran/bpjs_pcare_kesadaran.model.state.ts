...
/**
 * BpjsPcareKesadaranCollectionState would store the state of a collection of BpjsPcareKesadaran
 */
export interface BpjsPcareKesadaranCollectionState extends CollectionState {
 ...
 */
export interface BpjsPcareKesadaranModelAudit extends AbstractModelAudit<BpjsPcareKesadaranModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsPcareKesadaranModelState would store the state of the model
 */
export interface BpjsPcareKesadaranModelState {
	collectionState: {
		[key: string]: BpjsPcareKesadaranCollectionState;
	};
	data: {
		[id: string]: BpjsPcareKesadaranModel;
	};
	totalCount: number;
	audits: BpjsPcareKesadaranModelAudit[];
 ...
 */
export const initialBpjsPcareKesadaranCollectionState: BpjsPcareKesadaranCollectionState = {
...
/**
 * The initial state of BpjsPcareKesadaranModelState
 */
export const initialState: BpjsPcareKesadaranModelState = {
	collectionState: {
