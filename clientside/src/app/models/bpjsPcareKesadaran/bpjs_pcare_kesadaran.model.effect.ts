...
import * as modelAction from './bpjs_pcare_kesadaran.model.action';
import {BpjsPcareKesadaranService} from '../../services/bpjsPcareKesadaran/bpjs_pcare_kesadaran.service';
...
/**
 * Effect class used for side effects related to BPJS Pcare Kesadaran model.
 */
@Injectable()
export class BpjsPcareKesadaranEffect {
	...
	constructor(
		...
		protected readonly service: BpjsPcareKesadaranService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKesadaranAction>(modelAction.BpjsPcareKesadaranModelActionTypes.COUNT_BPJS_PCARE_KESADARANS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareKesadaranActionOK(
						modelAction.BpjsPcareKesadaranModelActionTypes.COUNT_BPJS_PCARE_KESADARANS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKesadaranActionFail(
								modelAction.BpjsPcareKesadaranModelActionTypes.COUNT_BPJS_PCARE_KESADARANS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKesadaranAction>(modelAction.BpjsPcareKesadaranModelActionTypes.FETCH_BPJS_PCARE_KESADARAN),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareKesadaranActionOK(
						modelAction.BpjsPcareKesadaranModelActionTypes.FETCH_BPJS_PCARE_KESADARAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKesadaranActionFail(
								modelAction.BpjsPcareKesadaranModelActionTypes.FETCH_BPJS_PCARE_KESADARAN_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKesadaranAction>(modelAction.BpjsPcareKesadaranModelActionTypes.FETCH_ALL_BPJS_PCARE_KESADARAN),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareKesadaranActionOK(
						modelAction.BpjsPcareKesadaranModelActionTypes.FETCH_ALL_BPJS_PCARE_KESADARAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKesadaranActionFail(
								modelAction.BpjsPcareKesadaranModelActionTypes.FETCH_ALL_BPJS_PCARE_KESADARAN_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKesadaranAction>(modelAction.BpjsPcareKesadaranModelActionTypes.FETCH_BPJS_PCARE_KESADARAN_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareKesadaranActionOK(
						modelAction.BpjsPcareKesadaranModelActionTypes.FETCH_BPJS_PCARE_KESADARAN_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKesadaranActionFail(
								modelAction.BpjsPcareKesadaranModelActionTypes.FETCH_BPJS_PCARE_KESADARAN_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKesadaranAction>(modelAction.BpjsPcareKesadaranModelActionTypes.FETCH_LAST_BPJS_PCARE_KESADARAN_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareKesadaranActionOK(
						modelAction.BpjsPcareKesadaranModelActionTypes.FETCH_LAST_BPJS_PCARE_KESADARAN_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKesadaranActionFail(
								modelAction.BpjsPcareKesadaranModelActionTypes.FETCH_LAST_BPJS_PCARE_KESADARAN_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKesadaranAction>(modelAction.BpjsPcareKesadaranModelActionTypes.CREATE_BPJS_PCARE_KESADARAN),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsPcareKesadaranModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareKesadaranActionOK(
						modelAction.BpjsPcareKesadaranModelActionTypes.CREATE_BPJS_PCARE_KESADARAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKesadaranActionFail(
								modelAction.BpjsPcareKesadaranModelActionTypes.CREATE_BPJS_PCARE_KESADARAN_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKesadaranAction>(modelAction.BpjsPcareKesadaranModelActionTypes.CREATE_ALL_BPJS_PCARE_KESADARAN),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsPcareKesadaranModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareKesadaranActionOK(
						modelAction.BpjsPcareKesadaranModelActionTypes.CREATE_ALL_BPJS_PCARE_KESADARAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKesadaranActionFail(
								modelAction.BpjsPcareKesadaranModelActionTypes.CREATE_ALL_BPJS_PCARE_KESADARAN_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKesadaranAction>(modelAction.BpjsPcareKesadaranModelActionTypes.UPDATE_BPJS_PCARE_KESADARAN),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsPcareKesadaranModel;
				...
				return this.service.update(new BpjsPcareKesadaranModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareKesadaranActionOK(
						modelAction.BpjsPcareKesadaranModelActionTypes.UPDATE_BPJS_PCARE_KESADARAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKesadaranActionFail(
								modelAction.BpjsPcareKesadaranModelActionTypes.UPDATE_BPJS_PCARE_KESADARAN_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKesadaranAction>(modelAction.BpjsPcareKesadaranModelActionTypes.UPDATE_ALL_BPJS_PCARE_KESADARAN),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsPcareKesadaranModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsPcareKesadaranModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareKesadaranActionOK(
						modelAction.BpjsPcareKesadaranModelActionTypes.UPDATE_ALL_BPJS_PCARE_KESADARAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKesadaranActionFail(
								modelAction.BpjsPcareKesadaranModelActionTypes.UPDATE_ALL_BPJS_PCARE_KESADARAN_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKesadaranAction>(modelAction.BpjsPcareKesadaranModelActionTypes.DELETE_BPJS_PCARE_KESADARAN),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareKesadaranActionOK(
						modelAction.BpjsPcareKesadaranModelActionTypes.DELETE_BPJS_PCARE_KESADARAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKesadaranActionFail(
								modelAction.BpjsPcareKesadaranModelActionTypes.DELETE_BPJS_PCARE_KESADARAN_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKesadaranAction>(modelAction.BpjsPcareKesadaranModelActionTypes.DELETE_BPJS_PCARE_KESADARAN_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareKesadaranActionOK(
						modelAction.BpjsPcareKesadaranModelActionTypes.DELETE_BPJS_PCARE_KESADARAN_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKesadaranActionFail(
								modelAction.BpjsPcareKesadaranModelActionTypes.DELETE_BPJS_PCARE_KESADARAN_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKesadaranAction>(modelAction.BpjsPcareKesadaranModelActionTypes.DELETE_ALL_BPJS_PCARE_KESADARAN),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareKesadaranActionOK(
						modelAction.BpjsPcareKesadaranModelActionTypes.DELETE_ALL_BPJS_PCARE_KESADARAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKesadaranActionFail(
								modelAction.BpjsPcareKesadaranModelActionTypes.DELETE_ALL_BPJS_PCARE_KESADARAN_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKesadaranAction>(modelAction.BpjsPcareKesadaranModelActionTypes.EXPORT_BPJS_PCARE_KESADARAN),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareKesadaranActionOK(
						modelAction.BpjsPcareKesadaranModelActionTypes.EXPORT_BPJS_PCARE_KESADARAN,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKesadaranAction>(modelAction.BpjsPcareKesadaranModelActionTypes.EXPORT_ALL_BPJS_PCARE_KESADARAN),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareKesadaranActionOK(
						modelAction.BpjsPcareKesadaranModelActionTypes.EXPORT_ALL_BPJS_PCARE_KESADARAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKesadaranActionFail(
								modelAction.BpjsPcareKesadaranModelActionTypes.EXPORT_ALL_BPJS_PCARE_KESADARAN_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKesadaranAction>(modelAction.BpjsPcareKesadaranModelActionTypes.EXPORT_BPJS_PCARE_KESADARAN_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareKesadaranActionOK(
						modelAction.BpjsPcareKesadaranModelActionTypes.EXPORT_BPJS_PCARE_KESADARAN_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKesadaranActionFail(
								modelAction.BpjsPcareKesadaranModelActionTypes.EXPORT_BPJS_PCARE_KESADARAN_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKesadaranAction>(modelAction.BpjsPcareKesadaranModelActionTypes.IMPORT_BPJS_PCARE_KESADARANS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareKesadaranActionOK(
						modelAction.BpjsPcareKesadaranModelActionTypes.IMPORT_BPJS_PCARE_KESADARANS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKesadaranActionFail(
								modelAction.BpjsPcareKesadaranModelActionTypes.IMPORT_BPJS_PCARE_KESADARANS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKesadaranAction>(modelAction.BpjsPcareKesadaranModelActionTypes.FETCH_BPJS_PCARE_KESADARAN_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsPcareKesadaranActionOK(
						modelAction.BpjsPcareKesadaranModelActionTypes.FETCH_BPJS_PCARE_KESADARAN_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKesadaranActionFail(
								modelAction.BpjsPcareKesadaranModelActionTypes.FETCH_BPJS_PCARE_KESADARAN_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKesadaranAction>(modelAction.BpjsPcareKesadaranModelActionTypes.FETCH_BPJS_PCARE_KESADARAN_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsPcareKesadaranActionOK(
						modelAction.BpjsPcareKesadaranModelActionTypes.FETCH_BPJS_PCARE_KESADARAN_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKesadaranActionFail(
								modelAction.BpjsPcareKesadaranModelActionTypes.FETCH_BPJS_PCARE_KESADARAN_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
