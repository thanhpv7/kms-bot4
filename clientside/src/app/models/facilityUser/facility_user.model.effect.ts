...
import * as modelAction from './facility_user.model.action';
import {FacilityUserService} from '../../services/facilityUser/facility_user.service';
...
/**
 * Effect class used for side effects related to Facility User model.
 */
@Injectable()
export class FacilityUserEffect {
	...
	constructor(
		...
		protected readonly service: FacilityUserService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FacilityUserAction>(modelAction.FacilityUserModelActionTypes.COUNT_FACILITY_USERS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.FacilityUserActionOK(
						modelAction.FacilityUserModelActionTypes.COUNT_FACILITY_USERS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FacilityUserActionFail(
								modelAction.FacilityUserModelActionTypes.COUNT_FACILITY_USERS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FacilityUserAction>(modelAction.FacilityUserModelActionTypes.FETCH_FACILITY_USER),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.FacilityUserActionOK(
						modelAction.FacilityUserModelActionTypes.FETCH_FACILITY_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FacilityUserActionFail(
								modelAction.FacilityUserModelActionTypes.FETCH_FACILITY_USER_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FacilityUserAction>(modelAction.FacilityUserModelActionTypes.FETCH_ALL_FACILITY_USER),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.FacilityUserActionOK(
						modelAction.FacilityUserModelActionTypes.FETCH_ALL_FACILITY_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FacilityUserActionFail(
								modelAction.FacilityUserModelActionTypes.FETCH_ALL_FACILITY_USER_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FacilityUserAction>(modelAction.FacilityUserModelActionTypes.FETCH_FACILITY_USER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.FacilityUserActionOK(
						modelAction.FacilityUserModelActionTypes.FETCH_FACILITY_USER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FacilityUserActionFail(
								modelAction.FacilityUserModelActionTypes.FETCH_FACILITY_USER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FacilityUserAction>(modelAction.FacilityUserModelActionTypes.FETCH_LAST_FACILITY_USER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.FacilityUserActionOK(
						modelAction.FacilityUserModelActionTypes.FETCH_LAST_FACILITY_USER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FacilityUserActionFail(
								modelAction.FacilityUserModelActionTypes.FETCH_LAST_FACILITY_USER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FacilityUserAction>(modelAction.FacilityUserModelActionTypes.CREATE_FACILITY_USER),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as FacilityUserModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.FacilityUserActionOK(
						modelAction.FacilityUserModelActionTypes.CREATE_FACILITY_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FacilityUserActionFail(
								modelAction.FacilityUserModelActionTypes.CREATE_FACILITY_USER_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FacilityUserAction>(modelAction.FacilityUserModelActionTypes.CREATE_ALL_FACILITY_USER),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as FacilityUserModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.FacilityUserActionOK(
						modelAction.FacilityUserModelActionTypes.CREATE_ALL_FACILITY_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FacilityUserActionFail(
								modelAction.FacilityUserModelActionTypes.CREATE_ALL_FACILITY_USER_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FacilityUserAction>(modelAction.FacilityUserModelActionTypes.UPDATE_FACILITY_USER),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as FacilityUserModel;
				...
				return this.service.update(new FacilityUserModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.FacilityUserActionOK(
						modelAction.FacilityUserModelActionTypes.UPDATE_FACILITY_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FacilityUserActionFail(
								modelAction.FacilityUserModelActionTypes.UPDATE_FACILITY_USER_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FacilityUserAction>(modelAction.FacilityUserModelActionTypes.UPDATE_ALL_FACILITY_USER),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as FacilityUserModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new FacilityUserModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.FacilityUserActionOK(
						modelAction.FacilityUserModelActionTypes.UPDATE_ALL_FACILITY_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FacilityUserActionFail(
								modelAction.FacilityUserModelActionTypes.UPDATE_ALL_FACILITY_USER_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FacilityUserAction>(modelAction.FacilityUserModelActionTypes.DELETE_FACILITY_USER),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.FacilityUserActionOK(
						modelAction.FacilityUserModelActionTypes.DELETE_FACILITY_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FacilityUserActionFail(
								modelAction.FacilityUserModelActionTypes.DELETE_FACILITY_USER_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FacilityUserAction>(modelAction.FacilityUserModelActionTypes.DELETE_FACILITY_USER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.FacilityUserActionOK(
						modelAction.FacilityUserModelActionTypes.DELETE_FACILITY_USER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FacilityUserActionFail(
								modelAction.FacilityUserModelActionTypes.DELETE_FACILITY_USER_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FacilityUserAction>(modelAction.FacilityUserModelActionTypes.DELETE_ALL_FACILITY_USER),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.FacilityUserActionOK(
						modelAction.FacilityUserModelActionTypes.DELETE_ALL_FACILITY_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FacilityUserActionFail(
								modelAction.FacilityUserModelActionTypes.DELETE_ALL_FACILITY_USER_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FacilityUserAction>(modelAction.FacilityUserModelActionTypes.EXPORT_FACILITY_USER),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.FacilityUserActionOK(
						modelAction.FacilityUserModelActionTypes.EXPORT_FACILITY_USER,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FacilityUserAction>(modelAction.FacilityUserModelActionTypes.EXPORT_ALL_FACILITY_USER),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.FacilityUserActionOK(
						modelAction.FacilityUserModelActionTypes.EXPORT_ALL_FACILITY_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FacilityUserActionFail(
								modelAction.FacilityUserModelActionTypes.EXPORT_ALL_FACILITY_USER_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FacilityUserAction>(modelAction.FacilityUserModelActionTypes.EXPORT_FACILITY_USER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.FacilityUserActionOK(
						modelAction.FacilityUserModelActionTypes.EXPORT_FACILITY_USER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FacilityUserActionFail(
								modelAction.FacilityUserModelActionTypes.EXPORT_FACILITY_USER_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FacilityUserAction>(modelAction.FacilityUserModelActionTypes.IMPORT_FACILITY_USERS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.FacilityUserActionOK(
						modelAction.FacilityUserModelActionTypes.IMPORT_FACILITY_USERS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FacilityUserActionFail(
								modelAction.FacilityUserModelActionTypes.IMPORT_FACILITY_USERS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FacilityUserAction>(modelAction.FacilityUserModelActionTypes.FETCH_FACILITY_USER_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.FacilityUserActionOK(
						modelAction.FacilityUserModelActionTypes.FETCH_FACILITY_USER_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.FacilityUserActionFail(
								modelAction.FacilityUserModelActionTypes.FETCH_FACILITY_USER_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FacilityUserAction>(modelAction.FacilityUserModelActionTypes.FETCH_FACILITY_USER_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.FacilityUserActionOK(
						modelAction.FacilityUserModelActionTypes.FETCH_FACILITY_USER_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.FacilityUserActionFail(
								modelAction.FacilityUserModelActionTypes.FETCH_FACILITY_USER_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
