...
/**
 * FacilityUserCollectionState would store the state of a collection of FacilityUser
 */
export interface FacilityUserCollectionState extends CollectionState {
 ...
 */
export interface FacilityUserModelAudit extends AbstractModelAudit<FacilityUserModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * FacilityUserModelState would store the state of the model
 */
export interface FacilityUserModelState {
	collectionState: {
		[key: string]: FacilityUserCollectionState;
	};
	data: {
		[id: string]: FacilityUserModel;
	};
	totalCount: number;
	audits: FacilityUserModelAudit[];
 ...
 */
export const initialFacilityUserCollectionState: FacilityUserCollectionState = {
...
/**
 * The initial state of FacilityUserModelState
 */
export const initialState: FacilityUserModelState = {
	collectionState: {
