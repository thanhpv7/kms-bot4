...
/**
 * InternalOrderStockDetailCollectionState would store the state of a collection of InternalOrderStockDetail
 */
export interface InternalOrderStockDetailCollectionState extends CollectionState {
 ...
 */
export interface InternalOrderStockDetailModelAudit extends AbstractModelAudit<InternalOrderStockDetailModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * InternalOrderStockDetailModelState would store the state of the model
 */
export interface InternalOrderStockDetailModelState {
	collectionState: {
		[key: string]: InternalOrderStockDetailCollectionState;
	};
	data: {
		[id: string]: InternalOrderStockDetailModel;
	};
	totalCount: number;
	audits: InternalOrderStockDetailModelAudit[];
 ...
 */
export const initialInternalOrderStockDetailCollectionState: InternalOrderStockDetailCollectionState = {
...
/**
 * The initial state of InternalOrderStockDetailModelState
 */
export const initialState: InternalOrderStockDetailModelState = {
	collectionState: {
