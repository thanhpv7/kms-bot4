...
import * as modelAction from './bpjs_total_referral_sep.model.action';
import {BpjsTotalReferralSEPService} from '../../services/bpjsTotalReferralSEP/bpjs_total_referral_sep.service';
...
/**
 * Effect class used for side effects related to BPJS Total Referral SEP model.
 */
@Injectable()
export class BpjsTotalReferralSEPEffect {
	...
	constructor(
		...
		protected readonly service: BpjsTotalReferralSEPService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTotalReferralSEPAction>(modelAction.BpjsTotalReferralSEPModelActionTypes.COUNT_BPJS_TOTAL_REFERRAL_SEPS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsTotalReferralSEPActionOK(
						modelAction.BpjsTotalReferralSEPModelActionTypes.COUNT_BPJS_TOTAL_REFERRAL_SEPS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTotalReferralSEPActionFail(
								modelAction.BpjsTotalReferralSEPModelActionTypes.COUNT_BPJS_TOTAL_REFERRAL_SEPS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTotalReferralSEPAction>(modelAction.BpjsTotalReferralSEPModelActionTypes.FETCH_BPJS_TOTAL_REFERRAL_SEP),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsTotalReferralSEPActionOK(
						modelAction.BpjsTotalReferralSEPModelActionTypes.FETCH_BPJS_TOTAL_REFERRAL_SEP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTotalReferralSEPActionFail(
								modelAction.BpjsTotalReferralSEPModelActionTypes.FETCH_BPJS_TOTAL_REFERRAL_SEP_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTotalReferralSEPAction>(modelAction.BpjsTotalReferralSEPModelActionTypes.FETCH_ALL_BPJS_TOTAL_REFERRAL_SEP),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsTotalReferralSEPActionOK(
						modelAction.BpjsTotalReferralSEPModelActionTypes.FETCH_ALL_BPJS_TOTAL_REFERRAL_SEP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTotalReferralSEPActionFail(
								modelAction.BpjsTotalReferralSEPModelActionTypes.FETCH_ALL_BPJS_TOTAL_REFERRAL_SEP_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTotalReferralSEPAction>(modelAction.BpjsTotalReferralSEPModelActionTypes.FETCH_BPJS_TOTAL_REFERRAL_SEP_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsTotalReferralSEPActionOK(
						modelAction.BpjsTotalReferralSEPModelActionTypes.FETCH_BPJS_TOTAL_REFERRAL_SEP_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTotalReferralSEPActionFail(
								modelAction.BpjsTotalReferralSEPModelActionTypes.FETCH_BPJS_TOTAL_REFERRAL_SEP_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTotalReferralSEPAction>(modelAction.BpjsTotalReferralSEPModelActionTypes.FETCH_LAST_BPJS_TOTAL_REFERRAL_SEP_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsTotalReferralSEPActionOK(
						modelAction.BpjsTotalReferralSEPModelActionTypes.FETCH_LAST_BPJS_TOTAL_REFERRAL_SEP_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTotalReferralSEPActionFail(
								modelAction.BpjsTotalReferralSEPModelActionTypes.FETCH_LAST_BPJS_TOTAL_REFERRAL_SEP_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTotalReferralSEPAction>(modelAction.BpjsTotalReferralSEPModelActionTypes.CREATE_BPJS_TOTAL_REFERRAL_SEP),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsTotalReferralSEPModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsTotalReferralSEPActionOK(
						modelAction.BpjsTotalReferralSEPModelActionTypes.CREATE_BPJS_TOTAL_REFERRAL_SEP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTotalReferralSEPActionFail(
								modelAction.BpjsTotalReferralSEPModelActionTypes.CREATE_BPJS_TOTAL_REFERRAL_SEP_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTotalReferralSEPAction>(modelAction.BpjsTotalReferralSEPModelActionTypes.CREATE_ALL_BPJS_TOTAL_REFERRAL_SEP),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsTotalReferralSEPModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsTotalReferralSEPActionOK(
						modelAction.BpjsTotalReferralSEPModelActionTypes.CREATE_ALL_BPJS_TOTAL_REFERRAL_SEP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTotalReferralSEPActionFail(
								modelAction.BpjsTotalReferralSEPModelActionTypes.CREATE_ALL_BPJS_TOTAL_REFERRAL_SEP_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTotalReferralSEPAction>(modelAction.BpjsTotalReferralSEPModelActionTypes.UPDATE_BPJS_TOTAL_REFERRAL_SEP),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsTotalReferralSEPModel;
				...
				return this.service.update(new BpjsTotalReferralSEPModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsTotalReferralSEPActionOK(
						modelAction.BpjsTotalReferralSEPModelActionTypes.UPDATE_BPJS_TOTAL_REFERRAL_SEP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTotalReferralSEPActionFail(
								modelAction.BpjsTotalReferralSEPModelActionTypes.UPDATE_BPJS_TOTAL_REFERRAL_SEP_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTotalReferralSEPAction>(modelAction.BpjsTotalReferralSEPModelActionTypes.UPDATE_ALL_BPJS_TOTAL_REFERRAL_SEP),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsTotalReferralSEPModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsTotalReferralSEPModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsTotalReferralSEPActionOK(
						modelAction.BpjsTotalReferralSEPModelActionTypes.UPDATE_ALL_BPJS_TOTAL_REFERRAL_SEP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTotalReferralSEPActionFail(
								modelAction.BpjsTotalReferralSEPModelActionTypes.UPDATE_ALL_BPJS_TOTAL_REFERRAL_SEP_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTotalReferralSEPAction>(modelAction.BpjsTotalReferralSEPModelActionTypes.DELETE_BPJS_TOTAL_REFERRAL_SEP),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsTotalReferralSEPActionOK(
						modelAction.BpjsTotalReferralSEPModelActionTypes.DELETE_BPJS_TOTAL_REFERRAL_SEP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTotalReferralSEPActionFail(
								modelAction.BpjsTotalReferralSEPModelActionTypes.DELETE_BPJS_TOTAL_REFERRAL_SEP_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTotalReferralSEPAction>(modelAction.BpjsTotalReferralSEPModelActionTypes.DELETE_BPJS_TOTAL_REFERRAL_SEP_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsTotalReferralSEPActionOK(
						modelAction.BpjsTotalReferralSEPModelActionTypes.DELETE_BPJS_TOTAL_REFERRAL_SEP_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTotalReferralSEPActionFail(
								modelAction.BpjsTotalReferralSEPModelActionTypes.DELETE_BPJS_TOTAL_REFERRAL_SEP_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTotalReferralSEPAction>(modelAction.BpjsTotalReferralSEPModelActionTypes.DELETE_ALL_BPJS_TOTAL_REFERRAL_SEP),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsTotalReferralSEPActionOK(
						modelAction.BpjsTotalReferralSEPModelActionTypes.DELETE_ALL_BPJS_TOTAL_REFERRAL_SEP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTotalReferralSEPActionFail(
								modelAction.BpjsTotalReferralSEPModelActionTypes.DELETE_ALL_BPJS_TOTAL_REFERRAL_SEP_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTotalReferralSEPAction>(modelAction.BpjsTotalReferralSEPModelActionTypes.EXPORT_BPJS_TOTAL_REFERRAL_SEP),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsTotalReferralSEPActionOK(
						modelAction.BpjsTotalReferralSEPModelActionTypes.EXPORT_BPJS_TOTAL_REFERRAL_SEP,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTotalReferralSEPAction>(modelAction.BpjsTotalReferralSEPModelActionTypes.EXPORT_ALL_BPJS_TOTAL_REFERRAL_SEP),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsTotalReferralSEPActionOK(
						modelAction.BpjsTotalReferralSEPModelActionTypes.EXPORT_ALL_BPJS_TOTAL_REFERRAL_SEP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTotalReferralSEPActionFail(
								modelAction.BpjsTotalReferralSEPModelActionTypes.EXPORT_ALL_BPJS_TOTAL_REFERRAL_SEP_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTotalReferralSEPAction>(modelAction.BpjsTotalReferralSEPModelActionTypes.EXPORT_BPJS_TOTAL_REFERRAL_SEP_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsTotalReferralSEPActionOK(
						modelAction.BpjsTotalReferralSEPModelActionTypes.EXPORT_BPJS_TOTAL_REFERRAL_SEP_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTotalReferralSEPActionFail(
								modelAction.BpjsTotalReferralSEPModelActionTypes.EXPORT_BPJS_TOTAL_REFERRAL_SEP_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTotalReferralSEPAction>(modelAction.BpjsTotalReferralSEPModelActionTypes.IMPORT_BPJS_TOTAL_REFERRAL_SEPS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsTotalReferralSEPActionOK(
						modelAction.BpjsTotalReferralSEPModelActionTypes.IMPORT_BPJS_TOTAL_REFERRAL_SEPS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTotalReferralSEPActionFail(
								modelAction.BpjsTotalReferralSEPModelActionTypes.IMPORT_BPJS_TOTAL_REFERRAL_SEPS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTotalReferralSEPAction>(modelAction.BpjsTotalReferralSEPModelActionTypes.FETCH_BPJS_TOTAL_REFERRAL_SEP_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsTotalReferralSEPActionOK(
						modelAction.BpjsTotalReferralSEPModelActionTypes.FETCH_BPJS_TOTAL_REFERRAL_SEP_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTotalReferralSEPActionFail(
								modelAction.BpjsTotalReferralSEPModelActionTypes.FETCH_BPJS_TOTAL_REFERRAL_SEP_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTotalReferralSEPAction>(modelAction.BpjsTotalReferralSEPModelActionTypes.FETCH_BPJS_TOTAL_REFERRAL_SEP_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsTotalReferralSEPActionOK(
						modelAction.BpjsTotalReferralSEPModelActionTypes.FETCH_BPJS_TOTAL_REFERRAL_SEP_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTotalReferralSEPActionFail(
								modelAction.BpjsTotalReferralSEPModelActionTypes.FETCH_BPJS_TOTAL_REFERRAL_SEP_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
