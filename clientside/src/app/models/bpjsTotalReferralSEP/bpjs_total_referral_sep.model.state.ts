...
/**
 * BpjsTotalReferralSEPCollectionState would store the state of a collection of BpjsTotalReferralSEP
 */
export interface BpjsTotalReferralSEPCollectionState extends CollectionState {
 ...
 */
export interface BpjsTotalReferralSEPModelAudit extends AbstractModelAudit<BpjsTotalReferralSEPModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsTotalReferralSEPModelState would store the state of the model
 */
export interface BpjsTotalReferralSEPModelState {
	collectionState: {
		[key: string]: BpjsTotalReferralSEPCollectionState;
	};
	data: {
		[id: string]: BpjsTotalReferralSEPModel;
	};
	totalCount: number;
	audits: BpjsTotalReferralSEPModelAudit[];
 ...
 */
export const initialBpjsTotalReferralSEPCollectionState: BpjsTotalReferralSEPCollectionState = {
...
/**
 * The initial state of BpjsTotalReferralSEPModelState
 */
export const initialState: BpjsTotalReferralSEPModelState = {
	collectionState: {
