...
/**
 * ServiceItemAssignmentCollectionState would store the state of a collection of ServiceItemAssignment
 */
export interface ServiceItemAssignmentCollectionState extends CollectionState {
 ...
 */
export interface ServiceItemAssignmentModelAudit extends AbstractModelAudit<ServiceItemAssignmentModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * ServiceItemAssignmentModelState would store the state of the model
 */
export interface ServiceItemAssignmentModelState {
	collectionState: {
		[key: string]: ServiceItemAssignmentCollectionState;
	};
	data: {
		[id: string]: ServiceItemAssignmentModel;
	};
	totalCount: number;
	audits: ServiceItemAssignmentModelAudit[];
 ...
 */
export const initialServiceItemAssignmentCollectionState: ServiceItemAssignmentCollectionState = {
...
/**
 * The initial state of ServiceItemAssignmentModelState
 */
export const initialState: ServiceItemAssignmentModelState = {
	collectionState: {
