...
import * as modelAction from './service_item_assignment.model.action';
import {ServiceItemAssignmentService} from '../../services/serviceItemAssignment/service_item_assignment.service';
...
/**
 * Effect class used for side effects related to Service Item Assignment model.
 */
@Injectable()
export class ServiceItemAssignmentEffect {
	...
	constructor(
		...
		protected readonly service: ServiceItemAssignmentService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceItemAssignmentAction>(modelAction.ServiceItemAssignmentModelActionTypes.COUNT_SERVICE_ITEM_ASSIGNMENTS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.ServiceItemAssignmentActionOK(
						modelAction.ServiceItemAssignmentModelActionTypes.COUNT_SERVICE_ITEM_ASSIGNMENTS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceItemAssignmentActionFail(
								modelAction.ServiceItemAssignmentModelActionTypes.COUNT_SERVICE_ITEM_ASSIGNMENTS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceItemAssignmentAction>(modelAction.ServiceItemAssignmentModelActionTypes.FETCH_SERVICE_ITEM_ASSIGNMENT),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ServiceItemAssignmentActionOK(
						modelAction.ServiceItemAssignmentModelActionTypes.FETCH_SERVICE_ITEM_ASSIGNMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceItemAssignmentActionFail(
								modelAction.ServiceItemAssignmentModelActionTypes.FETCH_SERVICE_ITEM_ASSIGNMENT_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceItemAssignmentAction>(modelAction.ServiceItemAssignmentModelActionTypes.FETCH_ALL_SERVICE_ITEM_ASSIGNMENT),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.ServiceItemAssignmentActionOK(
						modelAction.ServiceItemAssignmentModelActionTypes.FETCH_ALL_SERVICE_ITEM_ASSIGNMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceItemAssignmentActionFail(
								modelAction.ServiceItemAssignmentModelActionTypes.FETCH_ALL_SERVICE_ITEM_ASSIGNMENT_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceItemAssignmentAction>(modelAction.ServiceItemAssignmentModelActionTypes.FETCH_SERVICE_ITEM_ASSIGNMENT_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.ServiceItemAssignmentActionOK(
						modelAction.ServiceItemAssignmentModelActionTypes.FETCH_SERVICE_ITEM_ASSIGNMENT_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceItemAssignmentActionFail(
								modelAction.ServiceItemAssignmentModelActionTypes.FETCH_SERVICE_ITEM_ASSIGNMENT_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceItemAssignmentAction>(modelAction.ServiceItemAssignmentModelActionTypes.FETCH_LAST_SERVICE_ITEM_ASSIGNMENT_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.ServiceItemAssignmentActionOK(
						modelAction.ServiceItemAssignmentModelActionTypes.FETCH_LAST_SERVICE_ITEM_ASSIGNMENT_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceItemAssignmentActionFail(
								modelAction.ServiceItemAssignmentModelActionTypes.FETCH_LAST_SERVICE_ITEM_ASSIGNMENT_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceItemAssignmentAction>(modelAction.ServiceItemAssignmentModelActionTypes.CREATE_SERVICE_ITEM_ASSIGNMENT),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as ServiceItemAssignmentModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ServiceItemAssignmentActionOK(
						modelAction.ServiceItemAssignmentModelActionTypes.CREATE_SERVICE_ITEM_ASSIGNMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceItemAssignmentActionFail(
								modelAction.ServiceItemAssignmentModelActionTypes.CREATE_SERVICE_ITEM_ASSIGNMENT_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceItemAssignmentAction>(modelAction.ServiceItemAssignmentModelActionTypes.CREATE_ALL_SERVICE_ITEM_ASSIGNMENT),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as ServiceItemAssignmentModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ServiceItemAssignmentActionOK(
						modelAction.ServiceItemAssignmentModelActionTypes.CREATE_ALL_SERVICE_ITEM_ASSIGNMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceItemAssignmentActionFail(
								modelAction.ServiceItemAssignmentModelActionTypes.CREATE_ALL_SERVICE_ITEM_ASSIGNMENT_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceItemAssignmentAction>(modelAction.ServiceItemAssignmentModelActionTypes.UPDATE_SERVICE_ITEM_ASSIGNMENT),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as ServiceItemAssignmentModel;
				...
				return this.service.update(new ServiceItemAssignmentModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.ServiceItemAssignmentActionOK(
						modelAction.ServiceItemAssignmentModelActionTypes.UPDATE_SERVICE_ITEM_ASSIGNMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceItemAssignmentActionFail(
								modelAction.ServiceItemAssignmentModelActionTypes.UPDATE_SERVICE_ITEM_ASSIGNMENT_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceItemAssignmentAction>(modelAction.ServiceItemAssignmentModelActionTypes.UPDATE_ALL_SERVICE_ITEM_ASSIGNMENT),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as ServiceItemAssignmentModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new ServiceItemAssignmentModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ServiceItemAssignmentActionOK(
						modelAction.ServiceItemAssignmentModelActionTypes.UPDATE_ALL_SERVICE_ITEM_ASSIGNMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceItemAssignmentActionFail(
								modelAction.ServiceItemAssignmentModelActionTypes.UPDATE_ALL_SERVICE_ITEM_ASSIGNMENT_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceItemAssignmentAction>(modelAction.ServiceItemAssignmentModelActionTypes.DELETE_SERVICE_ITEM_ASSIGNMENT),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.ServiceItemAssignmentActionOK(
						modelAction.ServiceItemAssignmentModelActionTypes.DELETE_SERVICE_ITEM_ASSIGNMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceItemAssignmentActionFail(
								modelAction.ServiceItemAssignmentModelActionTypes.DELETE_SERVICE_ITEM_ASSIGNMENT_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceItemAssignmentAction>(modelAction.ServiceItemAssignmentModelActionTypes.DELETE_SERVICE_ITEM_ASSIGNMENT_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.ServiceItemAssignmentActionOK(
						modelAction.ServiceItemAssignmentModelActionTypes.DELETE_SERVICE_ITEM_ASSIGNMENT_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceItemAssignmentActionFail(
								modelAction.ServiceItemAssignmentModelActionTypes.DELETE_SERVICE_ITEM_ASSIGNMENT_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceItemAssignmentAction>(modelAction.ServiceItemAssignmentModelActionTypes.DELETE_ALL_SERVICE_ITEM_ASSIGNMENT),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.ServiceItemAssignmentActionOK(
						modelAction.ServiceItemAssignmentModelActionTypes.DELETE_ALL_SERVICE_ITEM_ASSIGNMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceItemAssignmentActionFail(
								modelAction.ServiceItemAssignmentModelActionTypes.DELETE_ALL_SERVICE_ITEM_ASSIGNMENT_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceItemAssignmentAction>(modelAction.ServiceItemAssignmentModelActionTypes.EXPORT_SERVICE_ITEM_ASSIGNMENT),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ServiceItemAssignmentActionOK(
						modelAction.ServiceItemAssignmentModelActionTypes.EXPORT_SERVICE_ITEM_ASSIGNMENT,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceItemAssignmentAction>(modelAction.ServiceItemAssignmentModelActionTypes.EXPORT_ALL_SERVICE_ITEM_ASSIGNMENT),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ServiceItemAssignmentActionOK(
						modelAction.ServiceItemAssignmentModelActionTypes.EXPORT_ALL_SERVICE_ITEM_ASSIGNMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceItemAssignmentActionFail(
								modelAction.ServiceItemAssignmentModelActionTypes.EXPORT_ALL_SERVICE_ITEM_ASSIGNMENT_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceItemAssignmentAction>(modelAction.ServiceItemAssignmentModelActionTypes.EXPORT_SERVICE_ITEM_ASSIGNMENT_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ServiceItemAssignmentActionOK(
						modelAction.ServiceItemAssignmentModelActionTypes.EXPORT_SERVICE_ITEM_ASSIGNMENT_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceItemAssignmentActionFail(
								modelAction.ServiceItemAssignmentModelActionTypes.EXPORT_SERVICE_ITEM_ASSIGNMENT_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceItemAssignmentAction>(modelAction.ServiceItemAssignmentModelActionTypes.IMPORT_SERVICE_ITEM_ASSIGNMENTS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.ServiceItemAssignmentActionOK(
						modelAction.ServiceItemAssignmentModelActionTypes.IMPORT_SERVICE_ITEM_ASSIGNMENTS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceItemAssignmentActionFail(
								modelAction.ServiceItemAssignmentModelActionTypes.IMPORT_SERVICE_ITEM_ASSIGNMENTS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceItemAssignmentAction>(modelAction.ServiceItemAssignmentModelActionTypes.FETCH_SERVICE_ITEM_ASSIGNMENT_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.ServiceItemAssignmentActionOK(
						modelAction.ServiceItemAssignmentModelActionTypes.FETCH_SERVICE_ITEM_ASSIGNMENT_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.ServiceItemAssignmentActionFail(
								modelAction.ServiceItemAssignmentModelActionTypes.FETCH_SERVICE_ITEM_ASSIGNMENT_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceItemAssignmentAction>(modelAction.ServiceItemAssignmentModelActionTypes.FETCH_SERVICE_ITEM_ASSIGNMENT_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.ServiceItemAssignmentActionOK(
						modelAction.ServiceItemAssignmentModelActionTypes.FETCH_SERVICE_ITEM_ASSIGNMENT_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.ServiceItemAssignmentActionFail(
								modelAction.ServiceItemAssignmentModelActionTypes.FETCH_SERVICE_ITEM_ASSIGNMENT_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
