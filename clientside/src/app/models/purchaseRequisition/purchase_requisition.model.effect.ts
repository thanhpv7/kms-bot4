...
import * as modelAction from './purchase_requisition.model.action';
import {PurchaseRequisitionService} from '../../services/purchaseRequisition/purchase_requisition.service';
...
/**
 * Effect class used for side effects related to Purchase Requisition model.
 */
@Injectable()
export class PurchaseRequisitionEffect {
	...
	constructor(
		...
		protected readonly service: PurchaseRequisitionService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseRequisitionAction>(modelAction.PurchaseRequisitionModelActionTypes.COUNT_PURCHASE_REQUISITIONS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.PurchaseRequisitionActionOK(
						modelAction.PurchaseRequisitionModelActionTypes.COUNT_PURCHASE_REQUISITIONS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseRequisitionActionFail(
								modelAction.PurchaseRequisitionModelActionTypes.COUNT_PURCHASE_REQUISITIONS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseRequisitionAction>(modelAction.PurchaseRequisitionModelActionTypes.FETCH_PURCHASE_REQUISITION),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PurchaseRequisitionActionOK(
						modelAction.PurchaseRequisitionModelActionTypes.FETCH_PURCHASE_REQUISITION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseRequisitionActionFail(
								modelAction.PurchaseRequisitionModelActionTypes.FETCH_PURCHASE_REQUISITION_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseRequisitionAction>(modelAction.PurchaseRequisitionModelActionTypes.FETCH_ALL_PURCHASE_REQUISITION),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.PurchaseRequisitionActionOK(
						modelAction.PurchaseRequisitionModelActionTypes.FETCH_ALL_PURCHASE_REQUISITION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseRequisitionActionFail(
								modelAction.PurchaseRequisitionModelActionTypes.FETCH_ALL_PURCHASE_REQUISITION_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseRequisitionAction>(modelAction.PurchaseRequisitionModelActionTypes.FETCH_PURCHASE_REQUISITION_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PurchaseRequisitionActionOK(
						modelAction.PurchaseRequisitionModelActionTypes.FETCH_PURCHASE_REQUISITION_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseRequisitionActionFail(
								modelAction.PurchaseRequisitionModelActionTypes.FETCH_PURCHASE_REQUISITION_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseRequisitionAction>(modelAction.PurchaseRequisitionModelActionTypes.FETCH_LAST_PURCHASE_REQUISITION_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PurchaseRequisitionActionOK(
						modelAction.PurchaseRequisitionModelActionTypes.FETCH_LAST_PURCHASE_REQUISITION_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseRequisitionActionFail(
								modelAction.PurchaseRequisitionModelActionTypes.FETCH_LAST_PURCHASE_REQUISITION_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseRequisitionAction>(modelAction.PurchaseRequisitionModelActionTypes.CREATE_PURCHASE_REQUISITION),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as PurchaseRequisitionModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PurchaseRequisitionActionOK(
						modelAction.PurchaseRequisitionModelActionTypes.CREATE_PURCHASE_REQUISITION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseRequisitionActionFail(
								modelAction.PurchaseRequisitionModelActionTypes.CREATE_PURCHASE_REQUISITION_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseRequisitionAction>(modelAction.PurchaseRequisitionModelActionTypes.CREATE_ALL_PURCHASE_REQUISITION),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as PurchaseRequisitionModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PurchaseRequisitionActionOK(
						modelAction.PurchaseRequisitionModelActionTypes.CREATE_ALL_PURCHASE_REQUISITION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseRequisitionActionFail(
								modelAction.PurchaseRequisitionModelActionTypes.CREATE_ALL_PURCHASE_REQUISITION_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseRequisitionAction>(modelAction.PurchaseRequisitionModelActionTypes.UPDATE_PURCHASE_REQUISITION),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as PurchaseRequisitionModel;
				...
				return this.service.update(new PurchaseRequisitionModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.PurchaseRequisitionActionOK(
						modelAction.PurchaseRequisitionModelActionTypes.UPDATE_PURCHASE_REQUISITION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseRequisitionActionFail(
								modelAction.PurchaseRequisitionModelActionTypes.UPDATE_PURCHASE_REQUISITION_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseRequisitionAction>(modelAction.PurchaseRequisitionModelActionTypes.UPDATE_ALL_PURCHASE_REQUISITION),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as PurchaseRequisitionModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new PurchaseRequisitionModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PurchaseRequisitionActionOK(
						modelAction.PurchaseRequisitionModelActionTypes.UPDATE_ALL_PURCHASE_REQUISITION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseRequisitionActionFail(
								modelAction.PurchaseRequisitionModelActionTypes.UPDATE_ALL_PURCHASE_REQUISITION_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseRequisitionAction>(modelAction.PurchaseRequisitionModelActionTypes.DELETE_PURCHASE_REQUISITION),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PurchaseRequisitionActionOK(
						modelAction.PurchaseRequisitionModelActionTypes.DELETE_PURCHASE_REQUISITION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseRequisitionActionFail(
								modelAction.PurchaseRequisitionModelActionTypes.DELETE_PURCHASE_REQUISITION_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseRequisitionAction>(modelAction.PurchaseRequisitionModelActionTypes.DELETE_PURCHASE_REQUISITION_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.PurchaseRequisitionActionOK(
						modelAction.PurchaseRequisitionModelActionTypes.DELETE_PURCHASE_REQUISITION_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseRequisitionActionFail(
								modelAction.PurchaseRequisitionModelActionTypes.DELETE_PURCHASE_REQUISITION_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseRequisitionAction>(modelAction.PurchaseRequisitionModelActionTypes.DELETE_ALL_PURCHASE_REQUISITION),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PurchaseRequisitionActionOK(
						modelAction.PurchaseRequisitionModelActionTypes.DELETE_ALL_PURCHASE_REQUISITION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseRequisitionActionFail(
								modelAction.PurchaseRequisitionModelActionTypes.DELETE_ALL_PURCHASE_REQUISITION_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseRequisitionAction>(modelAction.PurchaseRequisitionModelActionTypes.EXPORT_PURCHASE_REQUISITION),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PurchaseRequisitionActionOK(
						modelAction.PurchaseRequisitionModelActionTypes.EXPORT_PURCHASE_REQUISITION,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseRequisitionAction>(modelAction.PurchaseRequisitionModelActionTypes.EXPORT_ALL_PURCHASE_REQUISITION),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PurchaseRequisitionActionOK(
						modelAction.PurchaseRequisitionModelActionTypes.EXPORT_ALL_PURCHASE_REQUISITION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseRequisitionActionFail(
								modelAction.PurchaseRequisitionModelActionTypes.EXPORT_ALL_PURCHASE_REQUISITION_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseRequisitionAction>(modelAction.PurchaseRequisitionModelActionTypes.EXPORT_PURCHASE_REQUISITION_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PurchaseRequisitionActionOK(
						modelAction.PurchaseRequisitionModelActionTypes.EXPORT_PURCHASE_REQUISITION_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseRequisitionActionFail(
								modelAction.PurchaseRequisitionModelActionTypes.EXPORT_PURCHASE_REQUISITION_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseRequisitionAction>(modelAction.PurchaseRequisitionModelActionTypes.IMPORT_PURCHASE_REQUISITIONS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.PurchaseRequisitionActionOK(
						modelAction.PurchaseRequisitionModelActionTypes.IMPORT_PURCHASE_REQUISITIONS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseRequisitionActionFail(
								modelAction.PurchaseRequisitionModelActionTypes.IMPORT_PURCHASE_REQUISITIONS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseRequisitionAction>(modelAction.PurchaseRequisitionModelActionTypes.FETCH_PURCHASE_REQUISITION_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.PurchaseRequisitionActionOK(
						modelAction.PurchaseRequisitionModelActionTypes.FETCH_PURCHASE_REQUISITION_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseRequisitionActionFail(
								modelAction.PurchaseRequisitionModelActionTypes.FETCH_PURCHASE_REQUISITION_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseRequisitionAction>(modelAction.PurchaseRequisitionModelActionTypes.FETCH_PURCHASE_REQUISITION_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.PurchaseRequisitionActionOK(
						modelAction.PurchaseRequisitionModelActionTypes.FETCH_PURCHASE_REQUISITION_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseRequisitionActionFail(
								modelAction.PurchaseRequisitionModelActionTypes.FETCH_PURCHASE_REQUISITION_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
