...
/**
 * NurseUserCollectionState would store the state of a collection of NurseUser
 */
export interface NurseUserCollectionState extends CollectionState {
 ...
 */
export interface NurseUserModelAudit extends AbstractModelAudit<NurseUserModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * NurseUserModelState would store the state of the model
 */
export interface NurseUserModelState {
	collectionState: {
		[key: string]: NurseUserCollectionState;
	};
	data: {
		[id: string]: NurseUserModel;
	};
	totalCount: number;
	audits: NurseUserModelAudit[];
 ...
 */
export const initialNurseUserCollectionState: NurseUserCollectionState = {
...
/**
 * The initial state of NurseUserModelState
 */
export const initialState: NurseUserModelState = {
	collectionState: {
