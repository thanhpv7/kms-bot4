...
import * as modelAction from './nurse_user.model.action';
import {NurseUserService} from '../../services/nurseUser/nurse_user.service';
...
/**
 * Effect class used for side effects related to Nurse User model.
 */
@Injectable()
export class NurseUserEffect {
	...
	constructor(
		...
		protected readonly service: NurseUserService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NurseUserAction>(modelAction.NurseUserModelActionTypes.COUNT_NURSE_USERS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.NurseUserActionOK(
						modelAction.NurseUserModelActionTypes.COUNT_NURSE_USERS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NurseUserActionFail(
								modelAction.NurseUserModelActionTypes.COUNT_NURSE_USERS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NurseUserAction>(modelAction.NurseUserModelActionTypes.FETCH_NURSE_USER),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.NurseUserActionOK(
						modelAction.NurseUserModelActionTypes.FETCH_NURSE_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NurseUserActionFail(
								modelAction.NurseUserModelActionTypes.FETCH_NURSE_USER_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NurseUserAction>(modelAction.NurseUserModelActionTypes.FETCH_ALL_NURSE_USER),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.NurseUserActionOK(
						modelAction.NurseUserModelActionTypes.FETCH_ALL_NURSE_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NurseUserActionFail(
								modelAction.NurseUserModelActionTypes.FETCH_ALL_NURSE_USER_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NurseUserAction>(modelAction.NurseUserModelActionTypes.FETCH_NURSE_USER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.NurseUserActionOK(
						modelAction.NurseUserModelActionTypes.FETCH_NURSE_USER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NurseUserActionFail(
								modelAction.NurseUserModelActionTypes.FETCH_NURSE_USER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NurseUserAction>(modelAction.NurseUserModelActionTypes.FETCH_LAST_NURSE_USER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.NurseUserActionOK(
						modelAction.NurseUserModelActionTypes.FETCH_LAST_NURSE_USER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NurseUserActionFail(
								modelAction.NurseUserModelActionTypes.FETCH_LAST_NURSE_USER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NurseUserAction>(modelAction.NurseUserModelActionTypes.CREATE_NURSE_USER),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as NurseUserModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.NurseUserActionOK(
						modelAction.NurseUserModelActionTypes.CREATE_NURSE_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NurseUserActionFail(
								modelAction.NurseUserModelActionTypes.CREATE_NURSE_USER_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NurseUserAction>(modelAction.NurseUserModelActionTypes.CREATE_ALL_NURSE_USER),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as NurseUserModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.NurseUserActionOK(
						modelAction.NurseUserModelActionTypes.CREATE_ALL_NURSE_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NurseUserActionFail(
								modelAction.NurseUserModelActionTypes.CREATE_ALL_NURSE_USER_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NurseUserAction>(modelAction.NurseUserModelActionTypes.UPDATE_NURSE_USER),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as NurseUserModel;
				...
				return this.service.update(new NurseUserModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.NurseUserActionOK(
						modelAction.NurseUserModelActionTypes.UPDATE_NURSE_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NurseUserActionFail(
								modelAction.NurseUserModelActionTypes.UPDATE_NURSE_USER_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NurseUserAction>(modelAction.NurseUserModelActionTypes.UPDATE_ALL_NURSE_USER),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as NurseUserModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new NurseUserModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.NurseUserActionOK(
						modelAction.NurseUserModelActionTypes.UPDATE_ALL_NURSE_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NurseUserActionFail(
								modelAction.NurseUserModelActionTypes.UPDATE_ALL_NURSE_USER_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NurseUserAction>(modelAction.NurseUserModelActionTypes.DELETE_NURSE_USER),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.NurseUserActionOK(
						modelAction.NurseUserModelActionTypes.DELETE_NURSE_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NurseUserActionFail(
								modelAction.NurseUserModelActionTypes.DELETE_NURSE_USER_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NurseUserAction>(modelAction.NurseUserModelActionTypes.DELETE_NURSE_USER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.NurseUserActionOK(
						modelAction.NurseUserModelActionTypes.DELETE_NURSE_USER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NurseUserActionFail(
								modelAction.NurseUserModelActionTypes.DELETE_NURSE_USER_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NurseUserAction>(modelAction.NurseUserModelActionTypes.DELETE_ALL_NURSE_USER),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.NurseUserActionOK(
						modelAction.NurseUserModelActionTypes.DELETE_ALL_NURSE_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NurseUserActionFail(
								modelAction.NurseUserModelActionTypes.DELETE_ALL_NURSE_USER_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NurseUserAction>(modelAction.NurseUserModelActionTypes.EXPORT_NURSE_USER),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.NurseUserActionOK(
						modelAction.NurseUserModelActionTypes.EXPORT_NURSE_USER,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NurseUserAction>(modelAction.NurseUserModelActionTypes.EXPORT_ALL_NURSE_USER),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.NurseUserActionOK(
						modelAction.NurseUserModelActionTypes.EXPORT_ALL_NURSE_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NurseUserActionFail(
								modelAction.NurseUserModelActionTypes.EXPORT_ALL_NURSE_USER_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NurseUserAction>(modelAction.NurseUserModelActionTypes.EXPORT_NURSE_USER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.NurseUserActionOK(
						modelAction.NurseUserModelActionTypes.EXPORT_NURSE_USER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NurseUserActionFail(
								modelAction.NurseUserModelActionTypes.EXPORT_NURSE_USER_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NurseUserAction>(modelAction.NurseUserModelActionTypes.IMPORT_NURSE_USERS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.NurseUserActionOK(
						modelAction.NurseUserModelActionTypes.IMPORT_NURSE_USERS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NurseUserActionFail(
								modelAction.NurseUserModelActionTypes.IMPORT_NURSE_USERS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NurseUserAction>(modelAction.NurseUserModelActionTypes.FETCH_NURSE_USER_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.NurseUserActionOK(
						modelAction.NurseUserModelActionTypes.FETCH_NURSE_USER_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.NurseUserActionFail(
								modelAction.NurseUserModelActionTypes.FETCH_NURSE_USER_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NurseUserAction>(modelAction.NurseUserModelActionTypes.FETCH_NURSE_USER_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.NurseUserActionOK(
						modelAction.NurseUserModelActionTypes.FETCH_NURSE_USER_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.NurseUserActionFail(
								modelAction.NurseUserModelActionTypes.FETCH_NURSE_USER_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
