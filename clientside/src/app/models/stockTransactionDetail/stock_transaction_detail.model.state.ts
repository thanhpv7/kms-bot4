...
/**
 * StockTransactionDetailCollectionState would store the state of a collection of StockTransactionDetail
 */
export interface StockTransactionDetailCollectionState extends CollectionState {
 ...
 */
export interface StockTransactionDetailModelAudit extends AbstractModelAudit<StockTransactionDetailModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * StockTransactionDetailModelState would store the state of the model
 */
export interface StockTransactionDetailModelState {
	collectionState: {
		[key: string]: StockTransactionDetailCollectionState;
	};
	data: {
		[id: string]: StockTransactionDetailModel;
	};
	totalCount: number;
	audits: StockTransactionDetailModelAudit[];
 ...
 */
export const initialStockTransactionDetailCollectionState: StockTransactionDetailCollectionState = {
...
/**
 * The initial state of StockTransactionDetailModelState
 */
export const initialState: StockTransactionDetailModelState = {
	collectionState: {
