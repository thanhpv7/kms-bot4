...
import * as modelAction from './stock_transaction_detail.model.action';
import {StockTransactionDetailService} from '../../services/stockTransactionDetail/stock_transaction_detail.service';
...
/**
 * Effect class used for side effects related to Stock Transaction Detail model.
 */
@Injectable()
export class StockTransactionDetailEffect {
	...
	constructor(
		...
		protected readonly service: StockTransactionDetailService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionDetailAction>(modelAction.StockTransactionDetailModelActionTypes.COUNT_STOCK_TRANSACTION_DETAILS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.StockTransactionDetailActionOK(
						modelAction.StockTransactionDetailModelActionTypes.COUNT_STOCK_TRANSACTION_DETAILS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionDetailActionFail(
								modelAction.StockTransactionDetailModelActionTypes.COUNT_STOCK_TRANSACTION_DETAILS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionDetailAction>(modelAction.StockTransactionDetailModelActionTypes.FETCH_STOCK_TRANSACTION_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.StockTransactionDetailActionOK(
						modelAction.StockTransactionDetailModelActionTypes.FETCH_STOCK_TRANSACTION_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionDetailActionFail(
								modelAction.StockTransactionDetailModelActionTypes.FETCH_STOCK_TRANSACTION_DETAIL_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionDetailAction>(modelAction.StockTransactionDetailModelActionTypes.FETCH_ALL_STOCK_TRANSACTION_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.StockTransactionDetailActionOK(
						modelAction.StockTransactionDetailModelActionTypes.FETCH_ALL_STOCK_TRANSACTION_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionDetailActionFail(
								modelAction.StockTransactionDetailModelActionTypes.FETCH_ALL_STOCK_TRANSACTION_DETAIL_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionDetailAction>(modelAction.StockTransactionDetailModelActionTypes.FETCH_STOCK_TRANSACTION_DETAIL_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.StockTransactionDetailActionOK(
						modelAction.StockTransactionDetailModelActionTypes.FETCH_STOCK_TRANSACTION_DETAIL_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionDetailActionFail(
								modelAction.StockTransactionDetailModelActionTypes.FETCH_STOCK_TRANSACTION_DETAIL_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionDetailAction>(modelAction.StockTransactionDetailModelActionTypes.FETCH_LAST_STOCK_TRANSACTION_DETAIL_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.StockTransactionDetailActionOK(
						modelAction.StockTransactionDetailModelActionTypes.FETCH_LAST_STOCK_TRANSACTION_DETAIL_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionDetailActionFail(
								modelAction.StockTransactionDetailModelActionTypes.FETCH_LAST_STOCK_TRANSACTION_DETAIL_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionDetailAction>(modelAction.StockTransactionDetailModelActionTypes.CREATE_STOCK_TRANSACTION_DETAIL),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as StockTransactionDetailModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.StockTransactionDetailActionOK(
						modelAction.StockTransactionDetailModelActionTypes.CREATE_STOCK_TRANSACTION_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionDetailActionFail(
								modelAction.StockTransactionDetailModelActionTypes.CREATE_STOCK_TRANSACTION_DETAIL_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionDetailAction>(modelAction.StockTransactionDetailModelActionTypes.CREATE_ALL_STOCK_TRANSACTION_DETAIL),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as StockTransactionDetailModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.StockTransactionDetailActionOK(
						modelAction.StockTransactionDetailModelActionTypes.CREATE_ALL_STOCK_TRANSACTION_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionDetailActionFail(
								modelAction.StockTransactionDetailModelActionTypes.CREATE_ALL_STOCK_TRANSACTION_DETAIL_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionDetailAction>(modelAction.StockTransactionDetailModelActionTypes.UPDATE_STOCK_TRANSACTION_DETAIL),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as StockTransactionDetailModel;
				...
				return this.service.update(new StockTransactionDetailModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.StockTransactionDetailActionOK(
						modelAction.StockTransactionDetailModelActionTypes.UPDATE_STOCK_TRANSACTION_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionDetailActionFail(
								modelAction.StockTransactionDetailModelActionTypes.UPDATE_STOCK_TRANSACTION_DETAIL_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionDetailAction>(modelAction.StockTransactionDetailModelActionTypes.UPDATE_ALL_STOCK_TRANSACTION_DETAIL),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as StockTransactionDetailModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new StockTransactionDetailModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.StockTransactionDetailActionOK(
						modelAction.StockTransactionDetailModelActionTypes.UPDATE_ALL_STOCK_TRANSACTION_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionDetailActionFail(
								modelAction.StockTransactionDetailModelActionTypes.UPDATE_ALL_STOCK_TRANSACTION_DETAIL_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionDetailAction>(modelAction.StockTransactionDetailModelActionTypes.DELETE_STOCK_TRANSACTION_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.StockTransactionDetailActionOK(
						modelAction.StockTransactionDetailModelActionTypes.DELETE_STOCK_TRANSACTION_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionDetailActionFail(
								modelAction.StockTransactionDetailModelActionTypes.DELETE_STOCK_TRANSACTION_DETAIL_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionDetailAction>(modelAction.StockTransactionDetailModelActionTypes.DELETE_STOCK_TRANSACTION_DETAIL_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.StockTransactionDetailActionOK(
						modelAction.StockTransactionDetailModelActionTypes.DELETE_STOCK_TRANSACTION_DETAIL_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionDetailActionFail(
								modelAction.StockTransactionDetailModelActionTypes.DELETE_STOCK_TRANSACTION_DETAIL_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionDetailAction>(modelAction.StockTransactionDetailModelActionTypes.DELETE_ALL_STOCK_TRANSACTION_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.StockTransactionDetailActionOK(
						modelAction.StockTransactionDetailModelActionTypes.DELETE_ALL_STOCK_TRANSACTION_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionDetailActionFail(
								modelAction.StockTransactionDetailModelActionTypes.DELETE_ALL_STOCK_TRANSACTION_DETAIL_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionDetailAction>(modelAction.StockTransactionDetailModelActionTypes.EXPORT_STOCK_TRANSACTION_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.StockTransactionDetailActionOK(
						modelAction.StockTransactionDetailModelActionTypes.EXPORT_STOCK_TRANSACTION_DETAIL,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionDetailAction>(modelAction.StockTransactionDetailModelActionTypes.EXPORT_ALL_STOCK_TRANSACTION_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.StockTransactionDetailActionOK(
						modelAction.StockTransactionDetailModelActionTypes.EXPORT_ALL_STOCK_TRANSACTION_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionDetailActionFail(
								modelAction.StockTransactionDetailModelActionTypes.EXPORT_ALL_STOCK_TRANSACTION_DETAIL_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionDetailAction>(modelAction.StockTransactionDetailModelActionTypes.EXPORT_STOCK_TRANSACTION_DETAIL_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.StockTransactionDetailActionOK(
						modelAction.StockTransactionDetailModelActionTypes.EXPORT_STOCK_TRANSACTION_DETAIL_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionDetailActionFail(
								modelAction.StockTransactionDetailModelActionTypes.EXPORT_STOCK_TRANSACTION_DETAIL_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionDetailAction>(modelAction.StockTransactionDetailModelActionTypes.IMPORT_STOCK_TRANSACTION_DETAILS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.StockTransactionDetailActionOK(
						modelAction.StockTransactionDetailModelActionTypes.IMPORT_STOCK_TRANSACTION_DETAILS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionDetailActionFail(
								modelAction.StockTransactionDetailModelActionTypes.IMPORT_STOCK_TRANSACTION_DETAILS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionDetailAction>(modelAction.StockTransactionDetailModelActionTypes.FETCH_STOCK_TRANSACTION_DETAIL_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.StockTransactionDetailActionOK(
						modelAction.StockTransactionDetailModelActionTypes.FETCH_STOCK_TRANSACTION_DETAIL_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionDetailActionFail(
								modelAction.StockTransactionDetailModelActionTypes.FETCH_STOCK_TRANSACTION_DETAIL_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionDetailAction>(modelAction.StockTransactionDetailModelActionTypes.FETCH_STOCK_TRANSACTION_DETAIL_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.StockTransactionDetailActionOK(
						modelAction.StockTransactionDetailModelActionTypes.FETCH_STOCK_TRANSACTION_DETAIL_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionDetailActionFail(
								modelAction.StockTransactionDetailModelActionTypes.FETCH_STOCK_TRANSACTION_DETAIL_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
