...
/**
 * BpjsINACBGCollectionState would store the state of a collection of BpjsINACBG
 */
export interface BpjsINACBGCollectionState extends CollectionState {
 ...
 */
export interface BpjsINACBGModelAudit extends AbstractModelAudit<BpjsINACBGModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsINACBGModelState would store the state of the model
 */
export interface BpjsINACBGModelState {
	collectionState: {
		[key: string]: BpjsINACBGCollectionState;
	};
	data: {
		[id: string]: BpjsINACBGModel;
	};
	totalCount: number;
	audits: BpjsINACBGModelAudit[];
 ...
 */
export const initialBpjsINACBGCollectionState: BpjsINACBGCollectionState = {
...
/**
 * The initial state of BpjsINACBGModelState
 */
export const initialState: BpjsINACBGModelState = {
	collectionState: {
