...
import * as modelAction from './bpjs_inacbg.model.action';
import {BpjsINACBGService} from '../../services/bpjsINACBG/bpjs_inacbg.service';
...
/**
 * Effect class used for side effects related to BPJS INACBG model.
 */
@Injectable()
export class BpjsINACBGEffect {
	...
	constructor(
		...
		protected readonly service: BpjsINACBGService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGAction>(modelAction.BpjsINACBGModelActionTypes.COUNT_BPJS_INACBGS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsINACBGActionOK(
						modelAction.BpjsINACBGModelActionTypes.COUNT_BPJS_INACBGS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGActionFail(
								modelAction.BpjsINACBGModelActionTypes.COUNT_BPJS_INACBGS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGAction>(modelAction.BpjsINACBGModelActionTypes.FETCH_BPJS_INACBG),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsINACBGActionOK(
						modelAction.BpjsINACBGModelActionTypes.FETCH_BPJS_INACBG_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGActionFail(
								modelAction.BpjsINACBGModelActionTypes.FETCH_BPJS_INACBG_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGAction>(modelAction.BpjsINACBGModelActionTypes.FETCH_ALL_BPJS_INACBG),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsINACBGActionOK(
						modelAction.BpjsINACBGModelActionTypes.FETCH_ALL_BPJS_INACBG_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGActionFail(
								modelAction.BpjsINACBGModelActionTypes.FETCH_ALL_BPJS_INACBG_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGAction>(modelAction.BpjsINACBGModelActionTypes.FETCH_BPJS_INACBG_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsINACBGActionOK(
						modelAction.BpjsINACBGModelActionTypes.FETCH_BPJS_INACBG_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGActionFail(
								modelAction.BpjsINACBGModelActionTypes.FETCH_BPJS_INACBG_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGAction>(modelAction.BpjsINACBGModelActionTypes.FETCH_LAST_BPJS_INACBG_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsINACBGActionOK(
						modelAction.BpjsINACBGModelActionTypes.FETCH_LAST_BPJS_INACBG_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGActionFail(
								modelAction.BpjsINACBGModelActionTypes.FETCH_LAST_BPJS_INACBG_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGAction>(modelAction.BpjsINACBGModelActionTypes.CREATE_BPJS_INACBG),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsINACBGModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsINACBGActionOK(
						modelAction.BpjsINACBGModelActionTypes.CREATE_BPJS_INACBG_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGActionFail(
								modelAction.BpjsINACBGModelActionTypes.CREATE_BPJS_INACBG_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGAction>(modelAction.BpjsINACBGModelActionTypes.CREATE_ALL_BPJS_INACBG),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsINACBGModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsINACBGActionOK(
						modelAction.BpjsINACBGModelActionTypes.CREATE_ALL_BPJS_INACBG_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGActionFail(
								modelAction.BpjsINACBGModelActionTypes.CREATE_ALL_BPJS_INACBG_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGAction>(modelAction.BpjsINACBGModelActionTypes.UPDATE_BPJS_INACBG),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsINACBGModel;
				...
				return this.service.update(new BpjsINACBGModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsINACBGActionOK(
						modelAction.BpjsINACBGModelActionTypes.UPDATE_BPJS_INACBG_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGActionFail(
								modelAction.BpjsINACBGModelActionTypes.UPDATE_BPJS_INACBG_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGAction>(modelAction.BpjsINACBGModelActionTypes.UPDATE_ALL_BPJS_INACBG),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsINACBGModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsINACBGModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsINACBGActionOK(
						modelAction.BpjsINACBGModelActionTypes.UPDATE_ALL_BPJS_INACBG_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGActionFail(
								modelAction.BpjsINACBGModelActionTypes.UPDATE_ALL_BPJS_INACBG_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGAction>(modelAction.BpjsINACBGModelActionTypes.DELETE_BPJS_INACBG),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsINACBGActionOK(
						modelAction.BpjsINACBGModelActionTypes.DELETE_BPJS_INACBG_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGActionFail(
								modelAction.BpjsINACBGModelActionTypes.DELETE_BPJS_INACBG_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGAction>(modelAction.BpjsINACBGModelActionTypes.DELETE_BPJS_INACBG_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsINACBGActionOK(
						modelAction.BpjsINACBGModelActionTypes.DELETE_BPJS_INACBG_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGActionFail(
								modelAction.BpjsINACBGModelActionTypes.DELETE_BPJS_INACBG_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGAction>(modelAction.BpjsINACBGModelActionTypes.DELETE_ALL_BPJS_INACBG),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsINACBGActionOK(
						modelAction.BpjsINACBGModelActionTypes.DELETE_ALL_BPJS_INACBG_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGActionFail(
								modelAction.BpjsINACBGModelActionTypes.DELETE_ALL_BPJS_INACBG_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGAction>(modelAction.BpjsINACBGModelActionTypes.EXPORT_BPJS_INACBG),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsINACBGActionOK(
						modelAction.BpjsINACBGModelActionTypes.EXPORT_BPJS_INACBG,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGAction>(modelAction.BpjsINACBGModelActionTypes.EXPORT_ALL_BPJS_INACBG),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsINACBGActionOK(
						modelAction.BpjsINACBGModelActionTypes.EXPORT_ALL_BPJS_INACBG_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGActionFail(
								modelAction.BpjsINACBGModelActionTypes.EXPORT_ALL_BPJS_INACBG_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGAction>(modelAction.BpjsINACBGModelActionTypes.EXPORT_BPJS_INACBG_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsINACBGActionOK(
						modelAction.BpjsINACBGModelActionTypes.EXPORT_BPJS_INACBG_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGActionFail(
								modelAction.BpjsINACBGModelActionTypes.EXPORT_BPJS_INACBG_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGAction>(modelAction.BpjsINACBGModelActionTypes.IMPORT_BPJS_INACBGS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsINACBGActionOK(
						modelAction.BpjsINACBGModelActionTypes.IMPORT_BPJS_INACBGS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGActionFail(
								modelAction.BpjsINACBGModelActionTypes.IMPORT_BPJS_INACBGS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGAction>(modelAction.BpjsINACBGModelActionTypes.FETCH_BPJS_INACBG_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsINACBGActionOK(
						modelAction.BpjsINACBGModelActionTypes.FETCH_BPJS_INACBG_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGActionFail(
								modelAction.BpjsINACBGModelActionTypes.FETCH_BPJS_INACBG_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGAction>(modelAction.BpjsINACBGModelActionTypes.FETCH_BPJS_INACBG_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsINACBGActionOK(
						modelAction.BpjsINACBGModelActionTypes.FETCH_BPJS_INACBG_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGActionFail(
								modelAction.BpjsINACBGModelActionTypes.FETCH_BPJS_INACBG_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
