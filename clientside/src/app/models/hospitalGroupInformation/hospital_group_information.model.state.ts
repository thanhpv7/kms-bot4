...
/**
 * HospitalGroupInformationCollectionState would store the state of a collection of HospitalGroupInformation
 */
export interface HospitalGroupInformationCollectionState extends CollectionState {
 ...
 */
export interface HospitalGroupInformationModelAudit extends AbstractModelAudit<HospitalGroupInformationModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * HospitalGroupInformationModelState would store the state of the model
 */
export interface HospitalGroupInformationModelState {
	collectionState: {
		[key: string]: HospitalGroupInformationCollectionState;
	};
	data: {
		[id: string]: HospitalGroupInformationModel;
	};
	totalCount: number;
	audits: HospitalGroupInformationModelAudit[];
 ...
 */
export const initialHospitalGroupInformationCollectionState: HospitalGroupInformationCollectionState = {
...
/**
 * The initial state of HospitalGroupInformationModelState
 */
export const initialState: HospitalGroupInformationModelState = {
	collectionState: {
