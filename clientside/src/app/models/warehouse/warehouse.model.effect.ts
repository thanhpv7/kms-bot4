...
import * as modelAction from './warehouse.model.action';
...
/**
 * Effect class used for side effects related to Warehouse model.
 */
@Injectable()
export class WarehouseEffect {
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseAction>(modelAction.WarehouseModelActionTypes.COUNT_WAREHOUSES),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.WarehouseActionOK(
						modelAction.WarehouseModelActionTypes.COUNT_WAREHOUSES_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseActionFail(
								modelAction.WarehouseModelActionTypes.COUNT_WAREHOUSES_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseAction>(modelAction.WarehouseModelActionTypes.FETCH_WAREHOUSE),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.WarehouseActionOK(
						modelAction.WarehouseModelActionTypes.FETCH_WAREHOUSE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseActionFail(
								modelAction.WarehouseModelActionTypes.FETCH_WAREHOUSE_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseAction>(modelAction.WarehouseModelActionTypes.FETCH_ALL_WAREHOUSE),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.WarehouseActionOK(
						modelAction.WarehouseModelActionTypes.FETCH_ALL_WAREHOUSE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseActionFail(
								modelAction.WarehouseModelActionTypes.FETCH_ALL_WAREHOUSE_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseAction>(modelAction.WarehouseModelActionTypes.FETCH_WAREHOUSE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.WarehouseActionOK(
						modelAction.WarehouseModelActionTypes.FETCH_WAREHOUSE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseActionFail(
								modelAction.WarehouseModelActionTypes.FETCH_WAREHOUSE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseAction>(modelAction.WarehouseModelActionTypes.FETCH_LAST_WAREHOUSE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.WarehouseActionOK(
						modelAction.WarehouseModelActionTypes.FETCH_LAST_WAREHOUSE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseActionFail(
								modelAction.WarehouseModelActionTypes.FETCH_LAST_WAREHOUSE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseAction>(modelAction.WarehouseModelActionTypes.CREATE_WAREHOUSE),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as WarehouseModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.WarehouseActionOK(
						modelAction.WarehouseModelActionTypes.CREATE_WAREHOUSE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseActionFail(
								modelAction.WarehouseModelActionTypes.CREATE_WAREHOUSE_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseAction>(modelAction.WarehouseModelActionTypes.CREATE_ALL_WAREHOUSE),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as WarehouseModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.WarehouseActionOK(
						modelAction.WarehouseModelActionTypes.CREATE_ALL_WAREHOUSE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseActionFail(
								modelAction.WarehouseModelActionTypes.CREATE_ALL_WAREHOUSE_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseAction>(modelAction.WarehouseModelActionTypes.UPDATE_WAREHOUSE),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as WarehouseModel;
				...
				return this.service.update(new WarehouseModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.WarehouseActionOK(
						modelAction.WarehouseModelActionTypes.UPDATE_WAREHOUSE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseActionFail(
								modelAction.WarehouseModelActionTypes.UPDATE_WAREHOUSE_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseAction>(modelAction.WarehouseModelActionTypes.UPDATE_ALL_WAREHOUSE),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as WarehouseModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new WarehouseModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.WarehouseActionOK(
						modelAction.WarehouseModelActionTypes.UPDATE_ALL_WAREHOUSE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseActionFail(
								modelAction.WarehouseModelActionTypes.UPDATE_ALL_WAREHOUSE_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseAction>(modelAction.WarehouseModelActionTypes.DELETE_WAREHOUSE),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.WarehouseActionOK(
						modelAction.WarehouseModelActionTypes.DELETE_WAREHOUSE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseActionFail(
								modelAction.WarehouseModelActionTypes.DELETE_WAREHOUSE_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseAction>(modelAction.WarehouseModelActionTypes.DELETE_WAREHOUSE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.WarehouseActionOK(
						modelAction.WarehouseModelActionTypes.DELETE_WAREHOUSE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseActionFail(
								modelAction.WarehouseModelActionTypes.DELETE_WAREHOUSE_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseAction>(modelAction.WarehouseModelActionTypes.DELETE_ALL_WAREHOUSE),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.WarehouseActionOK(
						modelAction.WarehouseModelActionTypes.DELETE_ALL_WAREHOUSE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseActionFail(
								modelAction.WarehouseModelActionTypes.DELETE_ALL_WAREHOUSE_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseAction>(modelAction.WarehouseModelActionTypes.EXPORT_WAREHOUSE),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.WarehouseActionOK(
						modelAction.WarehouseModelActionTypes.EXPORT_WAREHOUSE,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseAction>(modelAction.WarehouseModelActionTypes.EXPORT_ALL_WAREHOUSE),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.WarehouseActionOK(
						modelAction.WarehouseModelActionTypes.EXPORT_ALL_WAREHOUSE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseActionFail(
								modelAction.WarehouseModelActionTypes.EXPORT_ALL_WAREHOUSE_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseAction>(modelAction.WarehouseModelActionTypes.EXPORT_WAREHOUSE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.WarehouseActionOK(
						modelAction.WarehouseModelActionTypes.EXPORT_WAREHOUSE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseActionFail(
								modelAction.WarehouseModelActionTypes.EXPORT_WAREHOUSE_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseAction>(modelAction.WarehouseModelActionTypes.IMPORT_WAREHOUSES),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.WarehouseActionOK(
						modelAction.WarehouseModelActionTypes.IMPORT_WAREHOUSES_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseActionFail(
								modelAction.WarehouseModelActionTypes.IMPORT_WAREHOUSES_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseAction>(modelAction.WarehouseModelActionTypes.FETCH_WAREHOUSE_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.WarehouseActionOK(
						modelAction.WarehouseModelActionTypes.FETCH_WAREHOUSE_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseActionFail(
								modelAction.WarehouseModelActionTypes.FETCH_WAREHOUSE_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseAction>(modelAction.WarehouseModelActionTypes.FETCH_WAREHOUSE_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.WarehouseActionOK(
						modelAction.WarehouseModelActionTypes.FETCH_WAREHOUSE_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseActionFail(
								modelAction.WarehouseModelActionTypes.FETCH_WAREHOUSE_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
