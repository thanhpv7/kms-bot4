...
/**
 * WarehouseCollectionState would store the state of a collection of Warehouse
 */
export interface WarehouseCollectionState extends CollectionState {
 ...
 */
export interface WarehouseModelAudit extends AbstractModelAudit<WarehouseModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * WarehouseModelState would store the state of the model
 */
export interface WarehouseModelState {
	collectionState: {
		[key: string]: WarehouseCollectionState;
	};
	data: {
		[id: string]: WarehouseModel;
	};
	totalCount: number;
	audits: WarehouseModelAudit[];
 ...
 */
export const initialWarehouseCollectionState: WarehouseCollectionState = {
...
/**
 * The initial state of WarehouseModelState
 */
export const initialState: WarehouseModelState = {
	collectionState: {
