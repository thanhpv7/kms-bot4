...
/**
 * PatientVitalInformationCollectionState would store the state of a collection of PatientVitalInformation
 */
export interface PatientVitalInformationCollectionState extends CollectionState {
 ...
 */
export interface PatientVitalInformationModelAudit extends AbstractModelAudit<PatientVitalInformationModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * PatientVitalInformationModelState would store the state of the model
 */
export interface PatientVitalInformationModelState {
	collectionState: {
		[key: string]: PatientVitalInformationCollectionState;
	};
	data: {
		[id: string]: PatientVitalInformationModel;
	};
	totalCount: number;
	audits: PatientVitalInformationModelAudit[];
 ...
 */
export const initialPatientVitalInformationCollectionState: PatientVitalInformationCollectionState = {
...
/**
 * The initial state of PatientVitalInformationModelState
 */
export const initialState: PatientVitalInformationModelState = {
	collectionState: {
