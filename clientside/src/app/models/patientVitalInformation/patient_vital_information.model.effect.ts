...
import * as modelAction from './patient_vital_information.model.action';
import {PatientVitalInformationService} from '../../services/patientVitalInformation/patient_vital_information.service';
...
/**
 * Effect class used for side effects related to Patient Vital Information model.
 */
@Injectable()
export class PatientVitalInformationEffect {
	...
	constructor(
		...
		protected readonly service: PatientVitalInformationService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVitalInformationAction>(modelAction.PatientVitalInformationModelActionTypes.COUNT_PATIENT_VITAL_INFORMATIONS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.PatientVitalInformationActionOK(
						modelAction.PatientVitalInformationModelActionTypes.COUNT_PATIENT_VITAL_INFORMATIONS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientVitalInformationActionFail(
								modelAction.PatientVitalInformationModelActionTypes.COUNT_PATIENT_VITAL_INFORMATIONS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVitalInformationAction>(modelAction.PatientVitalInformationModelActionTypes.FETCH_PATIENT_VITAL_INFORMATION),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientVitalInformationActionOK(
						modelAction.PatientVitalInformationModelActionTypes.FETCH_PATIENT_VITAL_INFORMATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientVitalInformationActionFail(
								modelAction.PatientVitalInformationModelActionTypes.FETCH_PATIENT_VITAL_INFORMATION_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVitalInformationAction>(modelAction.PatientVitalInformationModelActionTypes.FETCH_ALL_PATIENT_VITAL_INFORMATION),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.PatientVitalInformationActionOK(
						modelAction.PatientVitalInformationModelActionTypes.FETCH_ALL_PATIENT_VITAL_INFORMATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientVitalInformationActionFail(
								modelAction.PatientVitalInformationModelActionTypes.FETCH_ALL_PATIENT_VITAL_INFORMATION_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVitalInformationAction>(modelAction.PatientVitalInformationModelActionTypes.FETCH_PATIENT_VITAL_INFORMATION_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientVitalInformationActionOK(
						modelAction.PatientVitalInformationModelActionTypes.FETCH_PATIENT_VITAL_INFORMATION_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientVitalInformationActionFail(
								modelAction.PatientVitalInformationModelActionTypes.FETCH_PATIENT_VITAL_INFORMATION_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVitalInformationAction>(modelAction.PatientVitalInformationModelActionTypes.FETCH_LAST_PATIENT_VITAL_INFORMATION_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientVitalInformationActionOK(
						modelAction.PatientVitalInformationModelActionTypes.FETCH_LAST_PATIENT_VITAL_INFORMATION_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientVitalInformationActionFail(
								modelAction.PatientVitalInformationModelActionTypes.FETCH_LAST_PATIENT_VITAL_INFORMATION_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVitalInformationAction>(modelAction.PatientVitalInformationModelActionTypes.CREATE_PATIENT_VITAL_INFORMATION),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as PatientVitalInformationModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientVitalInformationActionOK(
						modelAction.PatientVitalInformationModelActionTypes.CREATE_PATIENT_VITAL_INFORMATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientVitalInformationActionFail(
								modelAction.PatientVitalInformationModelActionTypes.CREATE_PATIENT_VITAL_INFORMATION_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVitalInformationAction>(modelAction.PatientVitalInformationModelActionTypes.CREATE_ALL_PATIENT_VITAL_INFORMATION),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as PatientVitalInformationModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientVitalInformationActionOK(
						modelAction.PatientVitalInformationModelActionTypes.CREATE_ALL_PATIENT_VITAL_INFORMATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientVitalInformationActionFail(
								modelAction.PatientVitalInformationModelActionTypes.CREATE_ALL_PATIENT_VITAL_INFORMATION_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVitalInformationAction>(modelAction.PatientVitalInformationModelActionTypes.UPDATE_PATIENT_VITAL_INFORMATION),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as PatientVitalInformationModel;
				...
				return this.service.update(new PatientVitalInformationModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientVitalInformationActionOK(
						modelAction.PatientVitalInformationModelActionTypes.UPDATE_PATIENT_VITAL_INFORMATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientVitalInformationActionFail(
								modelAction.PatientVitalInformationModelActionTypes.UPDATE_PATIENT_VITAL_INFORMATION_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVitalInformationAction>(modelAction.PatientVitalInformationModelActionTypes.UPDATE_ALL_PATIENT_VITAL_INFORMATION),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as PatientVitalInformationModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new PatientVitalInformationModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientVitalInformationActionOK(
						modelAction.PatientVitalInformationModelActionTypes.UPDATE_ALL_PATIENT_VITAL_INFORMATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientVitalInformationActionFail(
								modelAction.PatientVitalInformationModelActionTypes.UPDATE_ALL_PATIENT_VITAL_INFORMATION_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVitalInformationAction>(modelAction.PatientVitalInformationModelActionTypes.DELETE_PATIENT_VITAL_INFORMATION),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PatientVitalInformationActionOK(
						modelAction.PatientVitalInformationModelActionTypes.DELETE_PATIENT_VITAL_INFORMATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientVitalInformationActionFail(
								modelAction.PatientVitalInformationModelActionTypes.DELETE_PATIENT_VITAL_INFORMATION_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVitalInformationAction>(modelAction.PatientVitalInformationModelActionTypes.DELETE_PATIENT_VITAL_INFORMATION_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.PatientVitalInformationActionOK(
						modelAction.PatientVitalInformationModelActionTypes.DELETE_PATIENT_VITAL_INFORMATION_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientVitalInformationActionFail(
								modelAction.PatientVitalInformationModelActionTypes.DELETE_PATIENT_VITAL_INFORMATION_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVitalInformationAction>(modelAction.PatientVitalInformationModelActionTypes.DELETE_ALL_PATIENT_VITAL_INFORMATION),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PatientVitalInformationActionOK(
						modelAction.PatientVitalInformationModelActionTypes.DELETE_ALL_PATIENT_VITAL_INFORMATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientVitalInformationActionFail(
								modelAction.PatientVitalInformationModelActionTypes.DELETE_ALL_PATIENT_VITAL_INFORMATION_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVitalInformationAction>(modelAction.PatientVitalInformationModelActionTypes.EXPORT_PATIENT_VITAL_INFORMATION),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PatientVitalInformationActionOK(
						modelAction.PatientVitalInformationModelActionTypes.EXPORT_PATIENT_VITAL_INFORMATION,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVitalInformationAction>(modelAction.PatientVitalInformationModelActionTypes.EXPORT_ALL_PATIENT_VITAL_INFORMATION),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PatientVitalInformationActionOK(
						modelAction.PatientVitalInformationModelActionTypes.EXPORT_ALL_PATIENT_VITAL_INFORMATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientVitalInformationActionFail(
								modelAction.PatientVitalInformationModelActionTypes.EXPORT_ALL_PATIENT_VITAL_INFORMATION_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVitalInformationAction>(modelAction.PatientVitalInformationModelActionTypes.EXPORT_PATIENT_VITAL_INFORMATION_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PatientVitalInformationActionOK(
						modelAction.PatientVitalInformationModelActionTypes.EXPORT_PATIENT_VITAL_INFORMATION_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientVitalInformationActionFail(
								modelAction.PatientVitalInformationModelActionTypes.EXPORT_PATIENT_VITAL_INFORMATION_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVitalInformationAction>(modelAction.PatientVitalInformationModelActionTypes.IMPORT_PATIENT_VITAL_INFORMATIONS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.PatientVitalInformationActionOK(
						modelAction.PatientVitalInformationModelActionTypes.IMPORT_PATIENT_VITAL_INFORMATIONS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientVitalInformationActionFail(
								modelAction.PatientVitalInformationModelActionTypes.IMPORT_PATIENT_VITAL_INFORMATIONS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVitalInformationAction>(modelAction.PatientVitalInformationModelActionTypes.FETCH_PATIENT_VITAL_INFORMATION_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.PatientVitalInformationActionOK(
						modelAction.PatientVitalInformationModelActionTypes.FETCH_PATIENT_VITAL_INFORMATION_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PatientVitalInformationActionFail(
								modelAction.PatientVitalInformationModelActionTypes.FETCH_PATIENT_VITAL_INFORMATION_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVitalInformationAction>(modelAction.PatientVitalInformationModelActionTypes.FETCH_PATIENT_VITAL_INFORMATION_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.PatientVitalInformationActionOK(
						modelAction.PatientVitalInformationModelActionTypes.FETCH_PATIENT_VITAL_INFORMATION_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PatientVitalInformationActionFail(
								modelAction.PatientVitalInformationModelActionTypes.FETCH_PATIENT_VITAL_INFORMATION_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
