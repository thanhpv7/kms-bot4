...
/**
 * ServiceCollectionState would store the state of a collection of Service
 */
export interface ServiceCollectionState extends CollectionState {
 ...
 */
export interface ServiceModelAudit extends AbstractModelAudit<ServiceModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * ServiceModelState would store the state of the model
 */
export interface ServiceModelState {
	collectionState: {
		[key: string]: ServiceCollectionState;
	};
	data: {
		[id: string]: ServiceModel;
	};
	totalCount: number;
	audits: ServiceModelAudit[];
 ...
 */
export const initialServiceCollectionState: ServiceCollectionState = {
...
/**
 * The initial state of ServiceModelState
 */
export const initialState: ServiceModelState = {
	collectionState: {
