...
/**
 * Effect class used for side effects related to Service model.
 */
@Injectable()
export class ServiceEffect {
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceAction>(modelAction.ServiceModelActionTypes.COUNT_SERVICES),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.ServiceActionOK(
						modelAction.ServiceModelActionTypes.COUNT_SERVICES_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceActionFail(
								modelAction.ServiceModelActionTypes.COUNT_SERVICES_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceAction>(modelAction.ServiceModelActionTypes.FETCH_SERVICE),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ServiceActionOK(
						modelAction.ServiceModelActionTypes.FETCH_SERVICE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceActionFail(
								modelAction.ServiceModelActionTypes.FETCH_SERVICE_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceAction>(modelAction.ServiceModelActionTypes.FETCH_ALL_SERVICE),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.ServiceActionOK(
						modelAction.ServiceModelActionTypes.FETCH_ALL_SERVICE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceActionFail(
								modelAction.ServiceModelActionTypes.FETCH_ALL_SERVICE_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceAction>(modelAction.ServiceModelActionTypes.FETCH_SERVICE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.ServiceActionOK(
						modelAction.ServiceModelActionTypes.FETCH_SERVICE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceActionFail(
								modelAction.ServiceModelActionTypes.FETCH_SERVICE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceAction>(modelAction.ServiceModelActionTypes.FETCH_LAST_SERVICE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.ServiceActionOK(
						modelAction.ServiceModelActionTypes.FETCH_LAST_SERVICE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceActionFail(
								modelAction.ServiceModelActionTypes.FETCH_LAST_SERVICE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceAction>(modelAction.ServiceModelActionTypes.CREATE_SERVICE),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as ServiceModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ServiceActionOK(
						modelAction.ServiceModelActionTypes.CREATE_SERVICE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceActionFail(
								modelAction.ServiceModelActionTypes.CREATE_SERVICE_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceAction>(modelAction.ServiceModelActionTypes.CREATE_ALL_SERVICE),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as ServiceModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ServiceActionOK(
						modelAction.ServiceModelActionTypes.CREATE_ALL_SERVICE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceActionFail(
								modelAction.ServiceModelActionTypes.CREATE_ALL_SERVICE_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceAction>(modelAction.ServiceModelActionTypes.UPDATE_SERVICE),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as ServiceModel;
				...
				return this.service.update(new ServiceModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.ServiceActionOK(
						modelAction.ServiceModelActionTypes.UPDATE_SERVICE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceActionFail(
								modelAction.ServiceModelActionTypes.UPDATE_SERVICE_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceAction>(modelAction.ServiceModelActionTypes.UPDATE_ALL_SERVICE),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as ServiceModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new ServiceModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ServiceActionOK(
						modelAction.ServiceModelActionTypes.UPDATE_ALL_SERVICE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceActionFail(
								modelAction.ServiceModelActionTypes.UPDATE_ALL_SERVICE_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceAction>(modelAction.ServiceModelActionTypes.DELETE_SERVICE),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.ServiceActionOK(
						modelAction.ServiceModelActionTypes.DELETE_SERVICE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceActionFail(
								modelAction.ServiceModelActionTypes.DELETE_SERVICE_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceAction>(modelAction.ServiceModelActionTypes.DELETE_SERVICE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.ServiceActionOK(
						modelAction.ServiceModelActionTypes.DELETE_SERVICE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceActionFail(
								modelAction.ServiceModelActionTypes.DELETE_SERVICE_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceAction>(modelAction.ServiceModelActionTypes.DELETE_ALL_SERVICE),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.ServiceActionOK(
						modelAction.ServiceModelActionTypes.DELETE_ALL_SERVICE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceActionFail(
								modelAction.ServiceModelActionTypes.DELETE_ALL_SERVICE_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceAction>(modelAction.ServiceModelActionTypes.EXPORT_SERVICE),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ServiceActionOK(
						modelAction.ServiceModelActionTypes.EXPORT_SERVICE,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceAction>(modelAction.ServiceModelActionTypes.EXPORT_ALL_SERVICE),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ServiceActionOK(
						modelAction.ServiceModelActionTypes.EXPORT_ALL_SERVICE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceActionFail(
								modelAction.ServiceModelActionTypes.EXPORT_ALL_SERVICE_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceAction>(modelAction.ServiceModelActionTypes.EXPORT_SERVICE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ServiceActionOK(
						modelAction.ServiceModelActionTypes.EXPORT_SERVICE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceActionFail(
								modelAction.ServiceModelActionTypes.EXPORT_SERVICE_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceAction>(modelAction.ServiceModelActionTypes.IMPORT_SERVICES),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.ServiceActionOK(
						modelAction.ServiceModelActionTypes.IMPORT_SERVICES_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceActionFail(
								modelAction.ServiceModelActionTypes.IMPORT_SERVICES_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceAction>(modelAction.ServiceModelActionTypes.FETCH_SERVICE_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.ServiceActionOK(
						modelAction.ServiceModelActionTypes.FETCH_SERVICE_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.ServiceActionFail(
								modelAction.ServiceModelActionTypes.FETCH_SERVICE_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceAction>(modelAction.ServiceModelActionTypes.FETCH_SERVICE_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.ServiceActionOK(
						modelAction.ServiceModelActionTypes.FETCH_SERVICE_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.ServiceActionFail(
								modelAction.ServiceModelActionTypes.FETCH_SERVICE_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
