...
/**
 * CashReceiptCollectionState would store the state of a collection of CashReceipt
 */
export interface CashReceiptCollectionState extends CollectionState {
 ...
 */
export interface CashReceiptModelAudit extends AbstractModelAudit<CashReceiptModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * CashReceiptModelState would store the state of the model
 */
export interface CashReceiptModelState {
	collectionState: {
		[key: string]: CashReceiptCollectionState;
	};
	data: {
		[id: string]: CashReceiptModel;
	};
	totalCount: number;
	audits: CashReceiptModelAudit[];
 ...
 */
export const initialCashReceiptCollectionState: CashReceiptCollectionState = {
...
/**
 * The initial state of CashReceiptModelState
 */
export const initialState: CashReceiptModelState = {
	collectionState: {
