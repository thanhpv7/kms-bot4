...
import * as modelAction from './cash_receipt.model.action';
import {CashReceiptService} from '../../services/cashReceipt/cash_receipt.service';
...
/**
 * Effect class used for side effects related to Cash Receipt model.
 */
@Injectable()
export class CashReceiptEffect {
	...
	constructor(
		...
		protected readonly service: CashReceiptService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashReceiptAction>(modelAction.CashReceiptModelActionTypes.COUNT_CASH_RECEIPTS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.CashReceiptActionOK(
						modelAction.CashReceiptModelActionTypes.COUNT_CASH_RECEIPTS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashReceiptActionFail(
								modelAction.CashReceiptModelActionTypes.COUNT_CASH_RECEIPTS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashReceiptAction>(modelAction.CashReceiptModelActionTypes.FETCH_CASH_RECEIPT),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.CashReceiptActionOK(
						modelAction.CashReceiptModelActionTypes.FETCH_CASH_RECEIPT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashReceiptActionFail(
								modelAction.CashReceiptModelActionTypes.FETCH_CASH_RECEIPT_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashReceiptAction>(modelAction.CashReceiptModelActionTypes.FETCH_ALL_CASH_RECEIPT),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.CashReceiptActionOK(
						modelAction.CashReceiptModelActionTypes.FETCH_ALL_CASH_RECEIPT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashReceiptActionFail(
								modelAction.CashReceiptModelActionTypes.FETCH_ALL_CASH_RECEIPT_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashReceiptAction>(modelAction.CashReceiptModelActionTypes.FETCH_CASH_RECEIPT_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.CashReceiptActionOK(
						modelAction.CashReceiptModelActionTypes.FETCH_CASH_RECEIPT_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashReceiptActionFail(
								modelAction.CashReceiptModelActionTypes.FETCH_CASH_RECEIPT_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashReceiptAction>(modelAction.CashReceiptModelActionTypes.FETCH_LAST_CASH_RECEIPT_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.CashReceiptActionOK(
						modelAction.CashReceiptModelActionTypes.FETCH_LAST_CASH_RECEIPT_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashReceiptActionFail(
								modelAction.CashReceiptModelActionTypes.FETCH_LAST_CASH_RECEIPT_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashReceiptAction>(modelAction.CashReceiptModelActionTypes.CREATE_CASH_RECEIPT),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as CashReceiptModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.CashReceiptActionOK(
						modelAction.CashReceiptModelActionTypes.CREATE_CASH_RECEIPT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashReceiptActionFail(
								modelAction.CashReceiptModelActionTypes.CREATE_CASH_RECEIPT_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashReceiptAction>(modelAction.CashReceiptModelActionTypes.CREATE_ALL_CASH_RECEIPT),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as CashReceiptModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.CashReceiptActionOK(
						modelAction.CashReceiptModelActionTypes.CREATE_ALL_CASH_RECEIPT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashReceiptActionFail(
								modelAction.CashReceiptModelActionTypes.CREATE_ALL_CASH_RECEIPT_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashReceiptAction>(modelAction.CashReceiptModelActionTypes.UPDATE_CASH_RECEIPT),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as CashReceiptModel;
				...
				return this.service.update(new CashReceiptModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.CashReceiptActionOK(
						modelAction.CashReceiptModelActionTypes.UPDATE_CASH_RECEIPT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashReceiptActionFail(
								modelAction.CashReceiptModelActionTypes.UPDATE_CASH_RECEIPT_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashReceiptAction>(modelAction.CashReceiptModelActionTypes.UPDATE_ALL_CASH_RECEIPT),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as CashReceiptModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new CashReceiptModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.CashReceiptActionOK(
						modelAction.CashReceiptModelActionTypes.UPDATE_ALL_CASH_RECEIPT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashReceiptActionFail(
								modelAction.CashReceiptModelActionTypes.UPDATE_ALL_CASH_RECEIPT_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashReceiptAction>(modelAction.CashReceiptModelActionTypes.DELETE_CASH_RECEIPT),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.CashReceiptActionOK(
						modelAction.CashReceiptModelActionTypes.DELETE_CASH_RECEIPT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashReceiptActionFail(
								modelAction.CashReceiptModelActionTypes.DELETE_CASH_RECEIPT_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashReceiptAction>(modelAction.CashReceiptModelActionTypes.DELETE_CASH_RECEIPT_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.CashReceiptActionOK(
						modelAction.CashReceiptModelActionTypes.DELETE_CASH_RECEIPT_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashReceiptActionFail(
								modelAction.CashReceiptModelActionTypes.DELETE_CASH_RECEIPT_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashReceiptAction>(modelAction.CashReceiptModelActionTypes.DELETE_ALL_CASH_RECEIPT),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.CashReceiptActionOK(
						modelAction.CashReceiptModelActionTypes.DELETE_ALL_CASH_RECEIPT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashReceiptActionFail(
								modelAction.CashReceiptModelActionTypes.DELETE_ALL_CASH_RECEIPT_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashReceiptAction>(modelAction.CashReceiptModelActionTypes.EXPORT_CASH_RECEIPT),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.CashReceiptActionOK(
						modelAction.CashReceiptModelActionTypes.EXPORT_CASH_RECEIPT,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashReceiptAction>(modelAction.CashReceiptModelActionTypes.EXPORT_ALL_CASH_RECEIPT),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.CashReceiptActionOK(
						modelAction.CashReceiptModelActionTypes.EXPORT_ALL_CASH_RECEIPT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashReceiptActionFail(
								modelAction.CashReceiptModelActionTypes.EXPORT_ALL_CASH_RECEIPT_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashReceiptAction>(modelAction.CashReceiptModelActionTypes.EXPORT_CASH_RECEIPT_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.CashReceiptActionOK(
						modelAction.CashReceiptModelActionTypes.EXPORT_CASH_RECEIPT_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashReceiptActionFail(
								modelAction.CashReceiptModelActionTypes.EXPORT_CASH_RECEIPT_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashReceiptAction>(modelAction.CashReceiptModelActionTypes.IMPORT_CASH_RECEIPTS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.CashReceiptActionOK(
						modelAction.CashReceiptModelActionTypes.IMPORT_CASH_RECEIPTS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashReceiptActionFail(
								modelAction.CashReceiptModelActionTypes.IMPORT_CASH_RECEIPTS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashReceiptAction>(modelAction.CashReceiptModelActionTypes.FETCH_CASH_RECEIPT_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.CashReceiptActionOK(
						modelAction.CashReceiptModelActionTypes.FETCH_CASH_RECEIPT_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.CashReceiptActionFail(
								modelAction.CashReceiptModelActionTypes.FETCH_CASH_RECEIPT_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashReceiptAction>(modelAction.CashReceiptModelActionTypes.FETCH_CASH_RECEIPT_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.CashReceiptActionOK(
						modelAction.CashReceiptModelActionTypes.FETCH_CASH_RECEIPT_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.CashReceiptActionFail(
								modelAction.CashReceiptModelActionTypes.FETCH_CASH_RECEIPT_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
