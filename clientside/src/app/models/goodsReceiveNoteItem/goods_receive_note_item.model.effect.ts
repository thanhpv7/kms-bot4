...
import * as modelAction from './goods_receive_note_item.model.action';
import {GoodsReceiveNoteItemService} from '../../services/goodsReceiveNoteItem/goods_receive_note_item.service';
...
/**
 * Effect class used for side effects related to Goods Receive Note Item model.
 */
@Injectable()
export class GoodsReceiveNoteItemEffect {
	...
	constructor(
		...
		protected readonly service: GoodsReceiveNoteItemService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteItemAction>(modelAction.GoodsReceiveNoteItemModelActionTypes.COUNT_GOODS_RECEIVE_NOTE_ITEMS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.GoodsReceiveNoteItemActionOK(
						modelAction.GoodsReceiveNoteItemModelActionTypes.COUNT_GOODS_RECEIVE_NOTE_ITEMS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteItemActionFail(
								modelAction.GoodsReceiveNoteItemModelActionTypes.COUNT_GOODS_RECEIVE_NOTE_ITEMS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteItemAction>(modelAction.GoodsReceiveNoteItemModelActionTypes.FETCH_GOODS_RECEIVE_NOTE_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.GoodsReceiveNoteItemActionOK(
						modelAction.GoodsReceiveNoteItemModelActionTypes.FETCH_GOODS_RECEIVE_NOTE_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteItemActionFail(
								modelAction.GoodsReceiveNoteItemModelActionTypes.FETCH_GOODS_RECEIVE_NOTE_ITEM_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteItemAction>(modelAction.GoodsReceiveNoteItemModelActionTypes.FETCH_ALL_GOODS_RECEIVE_NOTE_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.GoodsReceiveNoteItemActionOK(
						modelAction.GoodsReceiveNoteItemModelActionTypes.FETCH_ALL_GOODS_RECEIVE_NOTE_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteItemActionFail(
								modelAction.GoodsReceiveNoteItemModelActionTypes.FETCH_ALL_GOODS_RECEIVE_NOTE_ITEM_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteItemAction>(modelAction.GoodsReceiveNoteItemModelActionTypes.FETCH_GOODS_RECEIVE_NOTE_ITEM_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.GoodsReceiveNoteItemActionOK(
						modelAction.GoodsReceiveNoteItemModelActionTypes.FETCH_GOODS_RECEIVE_NOTE_ITEM_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteItemActionFail(
								modelAction.GoodsReceiveNoteItemModelActionTypes.FETCH_GOODS_RECEIVE_NOTE_ITEM_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteItemAction>(modelAction.GoodsReceiveNoteItemModelActionTypes.FETCH_LAST_GOODS_RECEIVE_NOTE_ITEM_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.GoodsReceiveNoteItemActionOK(
						modelAction.GoodsReceiveNoteItemModelActionTypes.FETCH_LAST_GOODS_RECEIVE_NOTE_ITEM_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteItemActionFail(
								modelAction.GoodsReceiveNoteItemModelActionTypes.FETCH_LAST_GOODS_RECEIVE_NOTE_ITEM_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteItemAction>(modelAction.GoodsReceiveNoteItemModelActionTypes.CREATE_GOODS_RECEIVE_NOTE_ITEM),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as GoodsReceiveNoteItemModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.GoodsReceiveNoteItemActionOK(
						modelAction.GoodsReceiveNoteItemModelActionTypes.CREATE_GOODS_RECEIVE_NOTE_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteItemActionFail(
								modelAction.GoodsReceiveNoteItemModelActionTypes.CREATE_GOODS_RECEIVE_NOTE_ITEM_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteItemAction>(modelAction.GoodsReceiveNoteItemModelActionTypes.CREATE_ALL_GOODS_RECEIVE_NOTE_ITEM),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as GoodsReceiveNoteItemModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.GoodsReceiveNoteItemActionOK(
						modelAction.GoodsReceiveNoteItemModelActionTypes.CREATE_ALL_GOODS_RECEIVE_NOTE_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteItemActionFail(
								modelAction.GoodsReceiveNoteItemModelActionTypes.CREATE_ALL_GOODS_RECEIVE_NOTE_ITEM_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteItemAction>(modelAction.GoodsReceiveNoteItemModelActionTypes.UPDATE_GOODS_RECEIVE_NOTE_ITEM),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as GoodsReceiveNoteItemModel;
				...
				return this.service.update(new GoodsReceiveNoteItemModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.GoodsReceiveNoteItemActionOK(
						modelAction.GoodsReceiveNoteItemModelActionTypes.UPDATE_GOODS_RECEIVE_NOTE_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteItemActionFail(
								modelAction.GoodsReceiveNoteItemModelActionTypes.UPDATE_GOODS_RECEIVE_NOTE_ITEM_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteItemAction>(modelAction.GoodsReceiveNoteItemModelActionTypes.UPDATE_ALL_GOODS_RECEIVE_NOTE_ITEM),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as GoodsReceiveNoteItemModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new GoodsReceiveNoteItemModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.GoodsReceiveNoteItemActionOK(
						modelAction.GoodsReceiveNoteItemModelActionTypes.UPDATE_ALL_GOODS_RECEIVE_NOTE_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteItemActionFail(
								modelAction.GoodsReceiveNoteItemModelActionTypes.UPDATE_ALL_GOODS_RECEIVE_NOTE_ITEM_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteItemAction>(modelAction.GoodsReceiveNoteItemModelActionTypes.DELETE_GOODS_RECEIVE_NOTE_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.GoodsReceiveNoteItemActionOK(
						modelAction.GoodsReceiveNoteItemModelActionTypes.DELETE_GOODS_RECEIVE_NOTE_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteItemActionFail(
								modelAction.GoodsReceiveNoteItemModelActionTypes.DELETE_GOODS_RECEIVE_NOTE_ITEM_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteItemAction>(modelAction.GoodsReceiveNoteItemModelActionTypes.DELETE_GOODS_RECEIVE_NOTE_ITEM_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.GoodsReceiveNoteItemActionOK(
						modelAction.GoodsReceiveNoteItemModelActionTypes.DELETE_GOODS_RECEIVE_NOTE_ITEM_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteItemActionFail(
								modelAction.GoodsReceiveNoteItemModelActionTypes.DELETE_GOODS_RECEIVE_NOTE_ITEM_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteItemAction>(modelAction.GoodsReceiveNoteItemModelActionTypes.DELETE_ALL_GOODS_RECEIVE_NOTE_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.GoodsReceiveNoteItemActionOK(
						modelAction.GoodsReceiveNoteItemModelActionTypes.DELETE_ALL_GOODS_RECEIVE_NOTE_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteItemActionFail(
								modelAction.GoodsReceiveNoteItemModelActionTypes.DELETE_ALL_GOODS_RECEIVE_NOTE_ITEM_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteItemAction>(modelAction.GoodsReceiveNoteItemModelActionTypes.EXPORT_GOODS_RECEIVE_NOTE_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.GoodsReceiveNoteItemActionOK(
						modelAction.GoodsReceiveNoteItemModelActionTypes.EXPORT_GOODS_RECEIVE_NOTE_ITEM,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteItemAction>(modelAction.GoodsReceiveNoteItemModelActionTypes.EXPORT_ALL_GOODS_RECEIVE_NOTE_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.GoodsReceiveNoteItemActionOK(
						modelAction.GoodsReceiveNoteItemModelActionTypes.EXPORT_ALL_GOODS_RECEIVE_NOTE_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteItemActionFail(
								modelAction.GoodsReceiveNoteItemModelActionTypes.EXPORT_ALL_GOODS_RECEIVE_NOTE_ITEM_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteItemAction>(modelAction.GoodsReceiveNoteItemModelActionTypes.EXPORT_GOODS_RECEIVE_NOTE_ITEM_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.GoodsReceiveNoteItemActionOK(
						modelAction.GoodsReceiveNoteItemModelActionTypes.EXPORT_GOODS_RECEIVE_NOTE_ITEM_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteItemActionFail(
								modelAction.GoodsReceiveNoteItemModelActionTypes.EXPORT_GOODS_RECEIVE_NOTE_ITEM_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteItemAction>(modelAction.GoodsReceiveNoteItemModelActionTypes.IMPORT_GOODS_RECEIVE_NOTE_ITEMS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.GoodsReceiveNoteItemActionOK(
						modelAction.GoodsReceiveNoteItemModelActionTypes.IMPORT_GOODS_RECEIVE_NOTE_ITEMS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteItemActionFail(
								modelAction.GoodsReceiveNoteItemModelActionTypes.IMPORT_GOODS_RECEIVE_NOTE_ITEMS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteItemAction>(modelAction.GoodsReceiveNoteItemModelActionTypes.FETCH_GOODS_RECEIVE_NOTE_ITEM_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.GoodsReceiveNoteItemActionOK(
						modelAction.GoodsReceiveNoteItemModelActionTypes.FETCH_GOODS_RECEIVE_NOTE_ITEM_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteItemActionFail(
								modelAction.GoodsReceiveNoteItemModelActionTypes.FETCH_GOODS_RECEIVE_NOTE_ITEM_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteItemAction>(modelAction.GoodsReceiveNoteItemModelActionTypes.FETCH_GOODS_RECEIVE_NOTE_ITEM_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.GoodsReceiveNoteItemActionOK(
						modelAction.GoodsReceiveNoteItemModelActionTypes.FETCH_GOODS_RECEIVE_NOTE_ITEM_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteItemActionFail(
								modelAction.GoodsReceiveNoteItemModelActionTypes.FETCH_GOODS_RECEIVE_NOTE_ITEM_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
