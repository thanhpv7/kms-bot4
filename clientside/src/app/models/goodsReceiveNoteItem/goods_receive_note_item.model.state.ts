...
/**
 * GoodsReceiveNoteItemCollectionState would store the state of a collection of GoodsReceiveNoteItem
 */
export interface GoodsReceiveNoteItemCollectionState extends CollectionState {
 ...
 */
export interface GoodsReceiveNoteItemModelAudit extends AbstractModelAudit<GoodsReceiveNoteItemModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * GoodsReceiveNoteItemModelState would store the state of the model
 */
export interface GoodsReceiveNoteItemModelState {
	collectionState: {
		[key: string]: GoodsReceiveNoteItemCollectionState;
	};
	data: {
		[id: string]: GoodsReceiveNoteItemModel;
	};
	totalCount: number;
	audits: GoodsReceiveNoteItemModelAudit[];
 ...
 */
export const initialGoodsReceiveNoteItemCollectionState: GoodsReceiveNoteItemCollectionState = {
...
/**
 * The initial state of GoodsReceiveNoteItemModelState
 */
export const initialState: GoodsReceiveNoteItemModelState = {
	collectionState: {
