...
/**
 * BpjsDismissalMappingCollectionState would store the state of a collection of BpjsDismissalMapping
 */
export interface BpjsDismissalMappingCollectionState extends CollectionState {
 ...
 */
export interface BpjsDismissalMappingModelAudit extends AbstractModelAudit<BpjsDismissalMappingModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsDismissalMappingModelState would store the state of the model
 */
export interface BpjsDismissalMappingModelState {
	collectionState: {
		[key: string]: BpjsDismissalMappingCollectionState;
	};
	data: {
		[id: string]: BpjsDismissalMappingModel;
	};
	totalCount: number;
	audits: BpjsDismissalMappingModelAudit[];
 ...
 */
export const initialBpjsDismissalMappingCollectionState: BpjsDismissalMappingCollectionState = {
...
/**
 * The initial state of BpjsDismissalMappingModelState
 */
export const initialState: BpjsDismissalMappingModelState = {
	collectionState: {
