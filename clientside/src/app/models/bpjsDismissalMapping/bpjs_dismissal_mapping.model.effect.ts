...
import * as modelAction from './bpjs_dismissal_mapping.model.action';
import {BpjsDismissalMappingService} from '../../services/bpjsDismissalMapping/bpjs_dismissal_mapping.service';
...
/**
 * Effect class used for side effects related to BPJS Dismissal Mapping model.
 */
@Injectable()
export class BpjsDismissalMappingEffect {
	...
	constructor(
		...
		protected readonly service: BpjsDismissalMappingService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDismissalMappingAction>(modelAction.BpjsDismissalMappingModelActionTypes.COUNT_BPJS_DISMISSAL_MAPPINGS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsDismissalMappingActionOK(
						modelAction.BpjsDismissalMappingModelActionTypes.COUNT_BPJS_DISMISSAL_MAPPINGS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDismissalMappingActionFail(
								modelAction.BpjsDismissalMappingModelActionTypes.COUNT_BPJS_DISMISSAL_MAPPINGS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDismissalMappingAction>(modelAction.BpjsDismissalMappingModelActionTypes.FETCH_BPJS_DISMISSAL_MAPPING),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsDismissalMappingActionOK(
						modelAction.BpjsDismissalMappingModelActionTypes.FETCH_BPJS_DISMISSAL_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDismissalMappingActionFail(
								modelAction.BpjsDismissalMappingModelActionTypes.FETCH_BPJS_DISMISSAL_MAPPING_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDismissalMappingAction>(modelAction.BpjsDismissalMappingModelActionTypes.FETCH_ALL_BPJS_DISMISSAL_MAPPING),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsDismissalMappingActionOK(
						modelAction.BpjsDismissalMappingModelActionTypes.FETCH_ALL_BPJS_DISMISSAL_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDismissalMappingActionFail(
								modelAction.BpjsDismissalMappingModelActionTypes.FETCH_ALL_BPJS_DISMISSAL_MAPPING_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDismissalMappingAction>(modelAction.BpjsDismissalMappingModelActionTypes.FETCH_BPJS_DISMISSAL_MAPPING_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsDismissalMappingActionOK(
						modelAction.BpjsDismissalMappingModelActionTypes.FETCH_BPJS_DISMISSAL_MAPPING_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDismissalMappingActionFail(
								modelAction.BpjsDismissalMappingModelActionTypes.FETCH_BPJS_DISMISSAL_MAPPING_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDismissalMappingAction>(modelAction.BpjsDismissalMappingModelActionTypes.FETCH_LAST_BPJS_DISMISSAL_MAPPING_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsDismissalMappingActionOK(
						modelAction.BpjsDismissalMappingModelActionTypes.FETCH_LAST_BPJS_DISMISSAL_MAPPING_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDismissalMappingActionFail(
								modelAction.BpjsDismissalMappingModelActionTypes.FETCH_LAST_BPJS_DISMISSAL_MAPPING_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDismissalMappingAction>(modelAction.BpjsDismissalMappingModelActionTypes.CREATE_BPJS_DISMISSAL_MAPPING),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsDismissalMappingModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsDismissalMappingActionOK(
						modelAction.BpjsDismissalMappingModelActionTypes.CREATE_BPJS_DISMISSAL_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDismissalMappingActionFail(
								modelAction.BpjsDismissalMappingModelActionTypes.CREATE_BPJS_DISMISSAL_MAPPING_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDismissalMappingAction>(modelAction.BpjsDismissalMappingModelActionTypes.CREATE_ALL_BPJS_DISMISSAL_MAPPING),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsDismissalMappingModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsDismissalMappingActionOK(
						modelAction.BpjsDismissalMappingModelActionTypes.CREATE_ALL_BPJS_DISMISSAL_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDismissalMappingActionFail(
								modelAction.BpjsDismissalMappingModelActionTypes.CREATE_ALL_BPJS_DISMISSAL_MAPPING_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDismissalMappingAction>(modelAction.BpjsDismissalMappingModelActionTypes.UPDATE_BPJS_DISMISSAL_MAPPING),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsDismissalMappingModel;
				...
				return this.service.update(new BpjsDismissalMappingModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsDismissalMappingActionOK(
						modelAction.BpjsDismissalMappingModelActionTypes.UPDATE_BPJS_DISMISSAL_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDismissalMappingActionFail(
								modelAction.BpjsDismissalMappingModelActionTypes.UPDATE_BPJS_DISMISSAL_MAPPING_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDismissalMappingAction>(modelAction.BpjsDismissalMappingModelActionTypes.UPDATE_ALL_BPJS_DISMISSAL_MAPPING),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsDismissalMappingModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsDismissalMappingModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsDismissalMappingActionOK(
						modelAction.BpjsDismissalMappingModelActionTypes.UPDATE_ALL_BPJS_DISMISSAL_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDismissalMappingActionFail(
								modelAction.BpjsDismissalMappingModelActionTypes.UPDATE_ALL_BPJS_DISMISSAL_MAPPING_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDismissalMappingAction>(modelAction.BpjsDismissalMappingModelActionTypes.DELETE_BPJS_DISMISSAL_MAPPING),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsDismissalMappingActionOK(
						modelAction.BpjsDismissalMappingModelActionTypes.DELETE_BPJS_DISMISSAL_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDismissalMappingActionFail(
								modelAction.BpjsDismissalMappingModelActionTypes.DELETE_BPJS_DISMISSAL_MAPPING_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDismissalMappingAction>(modelAction.BpjsDismissalMappingModelActionTypes.DELETE_BPJS_DISMISSAL_MAPPING_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsDismissalMappingActionOK(
						modelAction.BpjsDismissalMappingModelActionTypes.DELETE_BPJS_DISMISSAL_MAPPING_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDismissalMappingActionFail(
								modelAction.BpjsDismissalMappingModelActionTypes.DELETE_BPJS_DISMISSAL_MAPPING_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDismissalMappingAction>(modelAction.BpjsDismissalMappingModelActionTypes.DELETE_ALL_BPJS_DISMISSAL_MAPPING),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsDismissalMappingActionOK(
						modelAction.BpjsDismissalMappingModelActionTypes.DELETE_ALL_BPJS_DISMISSAL_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDismissalMappingActionFail(
								modelAction.BpjsDismissalMappingModelActionTypes.DELETE_ALL_BPJS_DISMISSAL_MAPPING_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDismissalMappingAction>(modelAction.BpjsDismissalMappingModelActionTypes.EXPORT_BPJS_DISMISSAL_MAPPING),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsDismissalMappingActionOK(
						modelAction.BpjsDismissalMappingModelActionTypes.EXPORT_BPJS_DISMISSAL_MAPPING,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDismissalMappingAction>(modelAction.BpjsDismissalMappingModelActionTypes.EXPORT_ALL_BPJS_DISMISSAL_MAPPING),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsDismissalMappingActionOK(
						modelAction.BpjsDismissalMappingModelActionTypes.EXPORT_ALL_BPJS_DISMISSAL_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDismissalMappingActionFail(
								modelAction.BpjsDismissalMappingModelActionTypes.EXPORT_ALL_BPJS_DISMISSAL_MAPPING_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDismissalMappingAction>(modelAction.BpjsDismissalMappingModelActionTypes.EXPORT_BPJS_DISMISSAL_MAPPING_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsDismissalMappingActionOK(
						modelAction.BpjsDismissalMappingModelActionTypes.EXPORT_BPJS_DISMISSAL_MAPPING_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDismissalMappingActionFail(
								modelAction.BpjsDismissalMappingModelActionTypes.EXPORT_BPJS_DISMISSAL_MAPPING_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDismissalMappingAction>(modelAction.BpjsDismissalMappingModelActionTypes.IMPORT_BPJS_DISMISSAL_MAPPINGS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsDismissalMappingActionOK(
						modelAction.BpjsDismissalMappingModelActionTypes.IMPORT_BPJS_DISMISSAL_MAPPINGS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDismissalMappingActionFail(
								modelAction.BpjsDismissalMappingModelActionTypes.IMPORT_BPJS_DISMISSAL_MAPPINGS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDismissalMappingAction>(modelAction.BpjsDismissalMappingModelActionTypes.FETCH_BPJS_DISMISSAL_MAPPING_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsDismissalMappingActionOK(
						modelAction.BpjsDismissalMappingModelActionTypes.FETCH_BPJS_DISMISSAL_MAPPING_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDismissalMappingActionFail(
								modelAction.BpjsDismissalMappingModelActionTypes.FETCH_BPJS_DISMISSAL_MAPPING_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDismissalMappingAction>(modelAction.BpjsDismissalMappingModelActionTypes.FETCH_BPJS_DISMISSAL_MAPPING_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsDismissalMappingActionOK(
						modelAction.BpjsDismissalMappingModelActionTypes.FETCH_BPJS_DISMISSAL_MAPPING_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDismissalMappingActionFail(
								modelAction.BpjsDismissalMappingModelActionTypes.FETCH_BPJS_DISMISSAL_MAPPING_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
