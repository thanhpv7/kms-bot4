...
import * as modelAction from './patient_consent.model.action';
import {PatientConsentService} from '../../services/patientConsent/patient_consent.service';
...
/**
 * Effect class used for side effects related to Patient Consent model.
 */
@Injectable()
export class PatientConsentEffect {
	...
	constructor(
		...
		protected readonly service: PatientConsentService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientConsentAction>(modelAction.PatientConsentModelActionTypes.COUNT_PATIENT_CONSENTS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.PatientConsentActionOK(
						modelAction.PatientConsentModelActionTypes.COUNT_PATIENT_CONSENTS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientConsentActionFail(
								modelAction.PatientConsentModelActionTypes.COUNT_PATIENT_CONSENTS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientConsentAction>(modelAction.PatientConsentModelActionTypes.FETCH_PATIENT_CONSENT),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientConsentActionOK(
						modelAction.PatientConsentModelActionTypes.FETCH_PATIENT_CONSENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientConsentActionFail(
								modelAction.PatientConsentModelActionTypes.FETCH_PATIENT_CONSENT_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientConsentAction>(modelAction.PatientConsentModelActionTypes.FETCH_ALL_PATIENT_CONSENT),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.PatientConsentActionOK(
						modelAction.PatientConsentModelActionTypes.FETCH_ALL_PATIENT_CONSENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientConsentActionFail(
								modelAction.PatientConsentModelActionTypes.FETCH_ALL_PATIENT_CONSENT_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientConsentAction>(modelAction.PatientConsentModelActionTypes.FETCH_PATIENT_CONSENT_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientConsentActionOK(
						modelAction.PatientConsentModelActionTypes.FETCH_PATIENT_CONSENT_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientConsentActionFail(
								modelAction.PatientConsentModelActionTypes.FETCH_PATIENT_CONSENT_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientConsentAction>(modelAction.PatientConsentModelActionTypes.FETCH_LAST_PATIENT_CONSENT_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientConsentActionOK(
						modelAction.PatientConsentModelActionTypes.FETCH_LAST_PATIENT_CONSENT_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientConsentActionFail(
								modelAction.PatientConsentModelActionTypes.FETCH_LAST_PATIENT_CONSENT_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientConsentAction>(modelAction.PatientConsentModelActionTypes.CREATE_PATIENT_CONSENT),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as PatientConsentModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientConsentActionOK(
						modelAction.PatientConsentModelActionTypes.CREATE_PATIENT_CONSENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientConsentActionFail(
								modelAction.PatientConsentModelActionTypes.CREATE_PATIENT_CONSENT_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientConsentAction>(modelAction.PatientConsentModelActionTypes.CREATE_ALL_PATIENT_CONSENT),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as PatientConsentModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientConsentActionOK(
						modelAction.PatientConsentModelActionTypes.CREATE_ALL_PATIENT_CONSENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientConsentActionFail(
								modelAction.PatientConsentModelActionTypes.CREATE_ALL_PATIENT_CONSENT_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientConsentAction>(modelAction.PatientConsentModelActionTypes.UPDATE_PATIENT_CONSENT),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as PatientConsentModel;
				...
				return this.service.update(new PatientConsentModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientConsentActionOK(
						modelAction.PatientConsentModelActionTypes.UPDATE_PATIENT_CONSENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientConsentActionFail(
								modelAction.PatientConsentModelActionTypes.UPDATE_PATIENT_CONSENT_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientConsentAction>(modelAction.PatientConsentModelActionTypes.UPDATE_ALL_PATIENT_CONSENT),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as PatientConsentModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new PatientConsentModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientConsentActionOK(
						modelAction.PatientConsentModelActionTypes.UPDATE_ALL_PATIENT_CONSENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientConsentActionFail(
								modelAction.PatientConsentModelActionTypes.UPDATE_ALL_PATIENT_CONSENT_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientConsentAction>(modelAction.PatientConsentModelActionTypes.DELETE_PATIENT_CONSENT),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PatientConsentActionOK(
						modelAction.PatientConsentModelActionTypes.DELETE_PATIENT_CONSENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientConsentActionFail(
								modelAction.PatientConsentModelActionTypes.DELETE_PATIENT_CONSENT_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientConsentAction>(modelAction.PatientConsentModelActionTypes.DELETE_PATIENT_CONSENT_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.PatientConsentActionOK(
						modelAction.PatientConsentModelActionTypes.DELETE_PATIENT_CONSENT_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientConsentActionFail(
								modelAction.PatientConsentModelActionTypes.DELETE_PATIENT_CONSENT_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientConsentAction>(modelAction.PatientConsentModelActionTypes.DELETE_ALL_PATIENT_CONSENT),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PatientConsentActionOK(
						modelAction.PatientConsentModelActionTypes.DELETE_ALL_PATIENT_CONSENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientConsentActionFail(
								modelAction.PatientConsentModelActionTypes.DELETE_ALL_PATIENT_CONSENT_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientConsentAction>(modelAction.PatientConsentModelActionTypes.EXPORT_PATIENT_CONSENT),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PatientConsentActionOK(
						modelAction.PatientConsentModelActionTypes.EXPORT_PATIENT_CONSENT,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientConsentAction>(modelAction.PatientConsentModelActionTypes.EXPORT_ALL_PATIENT_CONSENT),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PatientConsentActionOK(
						modelAction.PatientConsentModelActionTypes.EXPORT_ALL_PATIENT_CONSENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientConsentActionFail(
								modelAction.PatientConsentModelActionTypes.EXPORT_ALL_PATIENT_CONSENT_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientConsentAction>(modelAction.PatientConsentModelActionTypes.EXPORT_PATIENT_CONSENT_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PatientConsentActionOK(
						modelAction.PatientConsentModelActionTypes.EXPORT_PATIENT_CONSENT_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientConsentActionFail(
								modelAction.PatientConsentModelActionTypes.EXPORT_PATIENT_CONSENT_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientConsentAction>(modelAction.PatientConsentModelActionTypes.IMPORT_PATIENT_CONSENTS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.PatientConsentActionOK(
						modelAction.PatientConsentModelActionTypes.IMPORT_PATIENT_CONSENTS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientConsentActionFail(
								modelAction.PatientConsentModelActionTypes.IMPORT_PATIENT_CONSENTS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientConsentAction>(modelAction.PatientConsentModelActionTypes.FETCH_PATIENT_CONSENT_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.PatientConsentActionOK(
						modelAction.PatientConsentModelActionTypes.FETCH_PATIENT_CONSENT_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PatientConsentActionFail(
								modelAction.PatientConsentModelActionTypes.FETCH_PATIENT_CONSENT_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientConsentAction>(modelAction.PatientConsentModelActionTypes.FETCH_PATIENT_CONSENT_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.PatientConsentActionOK(
						modelAction.PatientConsentModelActionTypes.FETCH_PATIENT_CONSENT_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PatientConsentActionFail(
								modelAction.PatientConsentModelActionTypes.FETCH_PATIENT_CONSENT_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
