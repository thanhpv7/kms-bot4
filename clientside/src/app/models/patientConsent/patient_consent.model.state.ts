...
/**
 * PatientConsentCollectionState would store the state of a collection of PatientConsent
 */
export interface PatientConsentCollectionState extends CollectionState {
 ...
 */
export interface PatientConsentModelAudit extends AbstractModelAudit<PatientConsentModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * PatientConsentModelState would store the state of the model
 */
export interface PatientConsentModelState {
	collectionState: {
		[key: string]: PatientConsentCollectionState;
	};
	data: {
		[id: string]: PatientConsentModel;
	};
	totalCount: number;
	audits: PatientConsentModelAudit[];
 ...
 */
export const initialPatientConsentCollectionState: PatientConsentCollectionState = {
...
/**
 * The initial state of PatientConsentModelState
 */
export const initialState: PatientConsentModelState = {
	collectionState: {
