...
/**
 * PatientContactInfoCollectionState would store the state of a collection of PatientContactInfo
 */
export interface PatientContactInfoCollectionState extends CollectionState {
 ...
 */
export interface PatientContactInfoModelAudit extends AbstractModelAudit<PatientContactInfoModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * PatientContactInfoModelState would store the state of the model
 */
export interface PatientContactInfoModelState {
	collectionState: {
		[key: string]: PatientContactInfoCollectionState;
	};
	data: {
		[id: string]: PatientContactInfoModel;
	};
	totalCount: number;
	audits: PatientContactInfoModelAudit[];
 ...
 */
export const initialPatientContactInfoCollectionState: PatientContactInfoCollectionState = {
...
/**
 * The initial state of PatientContactInfoModelState
 */
export const initialState: PatientContactInfoModelState = {
	collectionState: {
