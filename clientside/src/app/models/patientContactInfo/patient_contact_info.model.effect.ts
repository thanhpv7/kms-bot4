...
import * as modelAction from './patient_contact_info.model.action';
import {PatientContactInfoService} from '../../services/patientContactInfo/patient_contact_info.service';
...
/**
 * Effect class used for side effects related to Patient Contact Info model.
 */
@Injectable()
export class PatientContactInfoEffect {
	...
	constructor(
		...
		protected readonly service: PatientContactInfoService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientContactInfoAction>(modelAction.PatientContactInfoModelActionTypes.COUNT_PATIENT_CONTACT_INFOS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.PatientContactInfoActionOK(
						modelAction.PatientContactInfoModelActionTypes.COUNT_PATIENT_CONTACT_INFOS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientContactInfoActionFail(
								modelAction.PatientContactInfoModelActionTypes.COUNT_PATIENT_CONTACT_INFOS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientContactInfoAction>(modelAction.PatientContactInfoModelActionTypes.FETCH_PATIENT_CONTACT_INFO),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientContactInfoActionOK(
						modelAction.PatientContactInfoModelActionTypes.FETCH_PATIENT_CONTACT_INFO_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientContactInfoActionFail(
								modelAction.PatientContactInfoModelActionTypes.FETCH_PATIENT_CONTACT_INFO_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientContactInfoAction>(modelAction.PatientContactInfoModelActionTypes.FETCH_ALL_PATIENT_CONTACT_INFO),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.PatientContactInfoActionOK(
						modelAction.PatientContactInfoModelActionTypes.FETCH_ALL_PATIENT_CONTACT_INFO_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientContactInfoActionFail(
								modelAction.PatientContactInfoModelActionTypes.FETCH_ALL_PATIENT_CONTACT_INFO_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientContactInfoAction>(modelAction.PatientContactInfoModelActionTypes.FETCH_PATIENT_CONTACT_INFO_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientContactInfoActionOK(
						modelAction.PatientContactInfoModelActionTypes.FETCH_PATIENT_CONTACT_INFO_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientContactInfoActionFail(
								modelAction.PatientContactInfoModelActionTypes.FETCH_PATIENT_CONTACT_INFO_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientContactInfoAction>(modelAction.PatientContactInfoModelActionTypes.FETCH_LAST_PATIENT_CONTACT_INFO_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientContactInfoActionOK(
						modelAction.PatientContactInfoModelActionTypes.FETCH_LAST_PATIENT_CONTACT_INFO_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientContactInfoActionFail(
								modelAction.PatientContactInfoModelActionTypes.FETCH_LAST_PATIENT_CONTACT_INFO_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientContactInfoAction>(modelAction.PatientContactInfoModelActionTypes.CREATE_PATIENT_CONTACT_INFO),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as PatientContactInfoModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientContactInfoActionOK(
						modelAction.PatientContactInfoModelActionTypes.CREATE_PATIENT_CONTACT_INFO_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientContactInfoActionFail(
								modelAction.PatientContactInfoModelActionTypes.CREATE_PATIENT_CONTACT_INFO_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientContactInfoAction>(modelAction.PatientContactInfoModelActionTypes.CREATE_ALL_PATIENT_CONTACT_INFO),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as PatientContactInfoModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientContactInfoActionOK(
						modelAction.PatientContactInfoModelActionTypes.CREATE_ALL_PATIENT_CONTACT_INFO_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientContactInfoActionFail(
								modelAction.PatientContactInfoModelActionTypes.CREATE_ALL_PATIENT_CONTACT_INFO_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientContactInfoAction>(modelAction.PatientContactInfoModelActionTypes.UPDATE_PATIENT_CONTACT_INFO),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as PatientContactInfoModel;
				...
				return this.service.update(new PatientContactInfoModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientContactInfoActionOK(
						modelAction.PatientContactInfoModelActionTypes.UPDATE_PATIENT_CONTACT_INFO_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientContactInfoActionFail(
								modelAction.PatientContactInfoModelActionTypes.UPDATE_PATIENT_CONTACT_INFO_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientContactInfoAction>(modelAction.PatientContactInfoModelActionTypes.UPDATE_ALL_PATIENT_CONTACT_INFO),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as PatientContactInfoModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new PatientContactInfoModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientContactInfoActionOK(
						modelAction.PatientContactInfoModelActionTypes.UPDATE_ALL_PATIENT_CONTACT_INFO_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientContactInfoActionFail(
								modelAction.PatientContactInfoModelActionTypes.UPDATE_ALL_PATIENT_CONTACT_INFO_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientContactInfoAction>(modelAction.PatientContactInfoModelActionTypes.DELETE_PATIENT_CONTACT_INFO),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PatientContactInfoActionOK(
						modelAction.PatientContactInfoModelActionTypes.DELETE_PATIENT_CONTACT_INFO_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientContactInfoActionFail(
								modelAction.PatientContactInfoModelActionTypes.DELETE_PATIENT_CONTACT_INFO_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientContactInfoAction>(modelAction.PatientContactInfoModelActionTypes.DELETE_PATIENT_CONTACT_INFO_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.PatientContactInfoActionOK(
						modelAction.PatientContactInfoModelActionTypes.DELETE_PATIENT_CONTACT_INFO_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientContactInfoActionFail(
								modelAction.PatientContactInfoModelActionTypes.DELETE_PATIENT_CONTACT_INFO_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientContactInfoAction>(modelAction.PatientContactInfoModelActionTypes.DELETE_ALL_PATIENT_CONTACT_INFO),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PatientContactInfoActionOK(
						modelAction.PatientContactInfoModelActionTypes.DELETE_ALL_PATIENT_CONTACT_INFO_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientContactInfoActionFail(
								modelAction.PatientContactInfoModelActionTypes.DELETE_ALL_PATIENT_CONTACT_INFO_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientContactInfoAction>(modelAction.PatientContactInfoModelActionTypes.EXPORT_PATIENT_CONTACT_INFO),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PatientContactInfoActionOK(
						modelAction.PatientContactInfoModelActionTypes.EXPORT_PATIENT_CONTACT_INFO,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientContactInfoAction>(modelAction.PatientContactInfoModelActionTypes.EXPORT_ALL_PATIENT_CONTACT_INFO),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PatientContactInfoActionOK(
						modelAction.PatientContactInfoModelActionTypes.EXPORT_ALL_PATIENT_CONTACT_INFO_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientContactInfoActionFail(
								modelAction.PatientContactInfoModelActionTypes.EXPORT_ALL_PATIENT_CONTACT_INFO_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientContactInfoAction>(modelAction.PatientContactInfoModelActionTypes.EXPORT_PATIENT_CONTACT_INFO_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PatientContactInfoActionOK(
						modelAction.PatientContactInfoModelActionTypes.EXPORT_PATIENT_CONTACT_INFO_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientContactInfoActionFail(
								modelAction.PatientContactInfoModelActionTypes.EXPORT_PATIENT_CONTACT_INFO_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientContactInfoAction>(modelAction.PatientContactInfoModelActionTypes.IMPORT_PATIENT_CONTACT_INFOS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.PatientContactInfoActionOK(
						modelAction.PatientContactInfoModelActionTypes.IMPORT_PATIENT_CONTACT_INFOS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientContactInfoActionFail(
								modelAction.PatientContactInfoModelActionTypes.IMPORT_PATIENT_CONTACT_INFOS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientContactInfoAction>(modelAction.PatientContactInfoModelActionTypes.FETCH_PATIENT_CONTACT_INFO_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.PatientContactInfoActionOK(
						modelAction.PatientContactInfoModelActionTypes.FETCH_PATIENT_CONTACT_INFO_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PatientContactInfoActionFail(
								modelAction.PatientContactInfoModelActionTypes.FETCH_PATIENT_CONTACT_INFO_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientContactInfoAction>(modelAction.PatientContactInfoModelActionTypes.FETCH_PATIENT_CONTACT_INFO_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.PatientContactInfoActionOK(
						modelAction.PatientContactInfoModelActionTypes.FETCH_PATIENT_CONTACT_INFO_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PatientContactInfoActionFail(
								modelAction.PatientContactInfoModelActionTypes.FETCH_PATIENT_CONTACT_INFO_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
