...
import * as modelAction from './bpjs_pcare_pendaftaran.model.action';
import {BpjsPcarePendaftaranService} from '../../services/bpjsPcarePendaftaran/bpjs_pcare_pendaftaran.service';
...
/**
 * Effect class used for side effects related to Bpjs Pcare Pendaftaran model.
 */
@Injectable()
export class BpjsPcarePendaftaranEffect {
	...
	constructor(
		...
		protected readonly service: BpjsPcarePendaftaranService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePendaftaranAction>(modelAction.BpjsPcarePendaftaranModelActionTypes.COUNT_BPJS_PCARE_PENDAFTARANS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsPcarePendaftaranActionOK(
						modelAction.BpjsPcarePendaftaranModelActionTypes.COUNT_BPJS_PCARE_PENDAFTARANS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePendaftaranActionFail(
								modelAction.BpjsPcarePendaftaranModelActionTypes.COUNT_BPJS_PCARE_PENDAFTARANS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePendaftaranAction>(modelAction.BpjsPcarePendaftaranModelActionTypes.FETCH_BPJS_PCARE_PENDAFTARAN),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcarePendaftaranActionOK(
						modelAction.BpjsPcarePendaftaranModelActionTypes.FETCH_BPJS_PCARE_PENDAFTARAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePendaftaranActionFail(
								modelAction.BpjsPcarePendaftaranModelActionTypes.FETCH_BPJS_PCARE_PENDAFTARAN_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePendaftaranAction>(modelAction.BpjsPcarePendaftaranModelActionTypes.FETCH_ALL_BPJS_PCARE_PENDAFTARAN),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsPcarePendaftaranActionOK(
						modelAction.BpjsPcarePendaftaranModelActionTypes.FETCH_ALL_BPJS_PCARE_PENDAFTARAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePendaftaranActionFail(
								modelAction.BpjsPcarePendaftaranModelActionTypes.FETCH_ALL_BPJS_PCARE_PENDAFTARAN_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePendaftaranAction>(modelAction.BpjsPcarePendaftaranModelActionTypes.FETCH_BPJS_PCARE_PENDAFTARAN_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcarePendaftaranActionOK(
						modelAction.BpjsPcarePendaftaranModelActionTypes.FETCH_BPJS_PCARE_PENDAFTARAN_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePendaftaranActionFail(
								modelAction.BpjsPcarePendaftaranModelActionTypes.FETCH_BPJS_PCARE_PENDAFTARAN_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePendaftaranAction>(modelAction.BpjsPcarePendaftaranModelActionTypes.FETCH_LAST_BPJS_PCARE_PENDAFTARAN_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcarePendaftaranActionOK(
						modelAction.BpjsPcarePendaftaranModelActionTypes.FETCH_LAST_BPJS_PCARE_PENDAFTARAN_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePendaftaranActionFail(
								modelAction.BpjsPcarePendaftaranModelActionTypes.FETCH_LAST_BPJS_PCARE_PENDAFTARAN_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePendaftaranAction>(modelAction.BpjsPcarePendaftaranModelActionTypes.CREATE_BPJS_PCARE_PENDAFTARAN),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsPcarePendaftaranModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcarePendaftaranActionOK(
						modelAction.BpjsPcarePendaftaranModelActionTypes.CREATE_BPJS_PCARE_PENDAFTARAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePendaftaranActionFail(
								modelAction.BpjsPcarePendaftaranModelActionTypes.CREATE_BPJS_PCARE_PENDAFTARAN_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePendaftaranAction>(modelAction.BpjsPcarePendaftaranModelActionTypes.CREATE_ALL_BPJS_PCARE_PENDAFTARAN),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsPcarePendaftaranModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcarePendaftaranActionOK(
						modelAction.BpjsPcarePendaftaranModelActionTypes.CREATE_ALL_BPJS_PCARE_PENDAFTARAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePendaftaranActionFail(
								modelAction.BpjsPcarePendaftaranModelActionTypes.CREATE_ALL_BPJS_PCARE_PENDAFTARAN_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePendaftaranAction>(modelAction.BpjsPcarePendaftaranModelActionTypes.UPDATE_BPJS_PCARE_PENDAFTARAN),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsPcarePendaftaranModel;
				...
				return this.service.update(new BpjsPcarePendaftaranModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcarePendaftaranActionOK(
						modelAction.BpjsPcarePendaftaranModelActionTypes.UPDATE_BPJS_PCARE_PENDAFTARAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePendaftaranActionFail(
								modelAction.BpjsPcarePendaftaranModelActionTypes.UPDATE_BPJS_PCARE_PENDAFTARAN_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePendaftaranAction>(modelAction.BpjsPcarePendaftaranModelActionTypes.UPDATE_ALL_BPJS_PCARE_PENDAFTARAN),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsPcarePendaftaranModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsPcarePendaftaranModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcarePendaftaranActionOK(
						modelAction.BpjsPcarePendaftaranModelActionTypes.UPDATE_ALL_BPJS_PCARE_PENDAFTARAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePendaftaranActionFail(
								modelAction.BpjsPcarePendaftaranModelActionTypes.UPDATE_ALL_BPJS_PCARE_PENDAFTARAN_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePendaftaranAction>(modelAction.BpjsPcarePendaftaranModelActionTypes.DELETE_BPJS_PCARE_PENDAFTARAN),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcarePendaftaranActionOK(
						modelAction.BpjsPcarePendaftaranModelActionTypes.DELETE_BPJS_PCARE_PENDAFTARAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePendaftaranActionFail(
								modelAction.BpjsPcarePendaftaranModelActionTypes.DELETE_BPJS_PCARE_PENDAFTARAN_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePendaftaranAction>(modelAction.BpjsPcarePendaftaranModelActionTypes.DELETE_BPJS_PCARE_PENDAFTARAN_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcarePendaftaranActionOK(
						modelAction.BpjsPcarePendaftaranModelActionTypes.DELETE_BPJS_PCARE_PENDAFTARAN_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePendaftaranActionFail(
								modelAction.BpjsPcarePendaftaranModelActionTypes.DELETE_BPJS_PCARE_PENDAFTARAN_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePendaftaranAction>(modelAction.BpjsPcarePendaftaranModelActionTypes.DELETE_ALL_BPJS_PCARE_PENDAFTARAN),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcarePendaftaranActionOK(
						modelAction.BpjsPcarePendaftaranModelActionTypes.DELETE_ALL_BPJS_PCARE_PENDAFTARAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePendaftaranActionFail(
								modelAction.BpjsPcarePendaftaranModelActionTypes.DELETE_ALL_BPJS_PCARE_PENDAFTARAN_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePendaftaranAction>(modelAction.BpjsPcarePendaftaranModelActionTypes.EXPORT_BPJS_PCARE_PENDAFTARAN),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcarePendaftaranActionOK(
						modelAction.BpjsPcarePendaftaranModelActionTypes.EXPORT_BPJS_PCARE_PENDAFTARAN,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePendaftaranAction>(modelAction.BpjsPcarePendaftaranModelActionTypes.EXPORT_ALL_BPJS_PCARE_PENDAFTARAN),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcarePendaftaranActionOK(
						modelAction.BpjsPcarePendaftaranModelActionTypes.EXPORT_ALL_BPJS_PCARE_PENDAFTARAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePendaftaranActionFail(
								modelAction.BpjsPcarePendaftaranModelActionTypes.EXPORT_ALL_BPJS_PCARE_PENDAFTARAN_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePendaftaranAction>(modelAction.BpjsPcarePendaftaranModelActionTypes.EXPORT_BPJS_PCARE_PENDAFTARAN_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcarePendaftaranActionOK(
						modelAction.BpjsPcarePendaftaranModelActionTypes.EXPORT_BPJS_PCARE_PENDAFTARAN_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePendaftaranActionFail(
								modelAction.BpjsPcarePendaftaranModelActionTypes.EXPORT_BPJS_PCARE_PENDAFTARAN_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePendaftaranAction>(modelAction.BpjsPcarePendaftaranModelActionTypes.IMPORT_BPJS_PCARE_PENDAFTARANS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcarePendaftaranActionOK(
						modelAction.BpjsPcarePendaftaranModelActionTypes.IMPORT_BPJS_PCARE_PENDAFTARANS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePendaftaranActionFail(
								modelAction.BpjsPcarePendaftaranModelActionTypes.IMPORT_BPJS_PCARE_PENDAFTARANS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePendaftaranAction>(modelAction.BpjsPcarePendaftaranModelActionTypes.FETCH_BPJS_PCARE_PENDAFTARAN_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsPcarePendaftaranActionOK(
						modelAction.BpjsPcarePendaftaranModelActionTypes.FETCH_BPJS_PCARE_PENDAFTARAN_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePendaftaranActionFail(
								modelAction.BpjsPcarePendaftaranModelActionTypes.FETCH_BPJS_PCARE_PENDAFTARAN_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePendaftaranAction>(modelAction.BpjsPcarePendaftaranModelActionTypes.FETCH_BPJS_PCARE_PENDAFTARAN_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsPcarePendaftaranActionOK(
						modelAction.BpjsPcarePendaftaranModelActionTypes.FETCH_BPJS_PCARE_PENDAFTARAN_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePendaftaranActionFail(
								modelAction.BpjsPcarePendaftaranModelActionTypes.FETCH_BPJS_PCARE_PENDAFTARAN_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
