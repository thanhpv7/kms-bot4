...
/**
 * BpjsPcarePendaftaranCollectionState would store the state of a collection of BpjsPcarePendaftaran
 */
export interface BpjsPcarePendaftaranCollectionState extends CollectionState {
 ...
 */
export interface BpjsPcarePendaftaranModelAudit extends AbstractModelAudit<BpjsPcarePendaftaranModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsPcarePendaftaranModelState would store the state of the model
 */
export interface BpjsPcarePendaftaranModelState {
	collectionState: {
		[key: string]: BpjsPcarePendaftaranCollectionState;
	};
	data: {
		[id: string]: BpjsPcarePendaftaranModel;
	};
	totalCount: number;
	audits: BpjsPcarePendaftaranModelAudit[];
 ...
 */
export const initialBpjsPcarePendaftaranCollectionState: BpjsPcarePendaftaranCollectionState = {
...
/**
 * The initial state of BpjsPcarePendaftaranModelState
 */
export const initialState: BpjsPcarePendaftaranModelState = {
	collectionState: {
