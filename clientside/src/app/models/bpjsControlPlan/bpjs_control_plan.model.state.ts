...
/**
 * BpjsControlPlanCollectionState would store the state of a collection of BpjsControlPlan
 */
export interface BpjsControlPlanCollectionState extends CollectionState {
 ...
 */
export interface BpjsControlPlanModelAudit extends AbstractModelAudit<BpjsControlPlanModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsControlPlanModelState would store the state of the model
 */
export interface BpjsControlPlanModelState {
	collectionState: {
		[key: string]: BpjsControlPlanCollectionState;
	};
	data: {
		[id: string]: BpjsControlPlanModel;
	};
	totalCount: number;
	audits: BpjsControlPlanModelAudit[];
 ...
 */
export const initialBpjsControlPlanCollectionState: BpjsControlPlanCollectionState = {
...
/**
 * The initial state of BpjsControlPlanModelState
 */
export const initialState: BpjsControlPlanModelState = {
	collectionState: {
