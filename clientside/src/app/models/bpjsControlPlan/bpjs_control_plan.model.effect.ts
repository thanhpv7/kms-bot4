...
import * as modelAction from './bpjs_control_plan.model.action';
import {BpjsControlPlanService} from '../../services/bpjsControlPlan/bpjs_control_plan.service';
...
/**
 * Effect class used for side effects related to BPJS Control Plan model.
 */
@Injectable()
export class BpjsControlPlanEffect {
	...
	constructor(
		...
		protected readonly service: BpjsControlPlanService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsControlPlanAction>(modelAction.BpjsControlPlanModelActionTypes.COUNT_BPJS_CONTROL_PLANS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsControlPlanActionOK(
						modelAction.BpjsControlPlanModelActionTypes.COUNT_BPJS_CONTROL_PLANS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsControlPlanActionFail(
								modelAction.BpjsControlPlanModelActionTypes.COUNT_BPJS_CONTROL_PLANS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsControlPlanAction>(modelAction.BpjsControlPlanModelActionTypes.FETCH_BPJS_CONTROL_PLAN),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsControlPlanActionOK(
						modelAction.BpjsControlPlanModelActionTypes.FETCH_BPJS_CONTROL_PLAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsControlPlanActionFail(
								modelAction.BpjsControlPlanModelActionTypes.FETCH_BPJS_CONTROL_PLAN_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsControlPlanAction>(modelAction.BpjsControlPlanModelActionTypes.FETCH_ALL_BPJS_CONTROL_PLAN),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsControlPlanActionOK(
						modelAction.BpjsControlPlanModelActionTypes.FETCH_ALL_BPJS_CONTROL_PLAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsControlPlanActionFail(
								modelAction.BpjsControlPlanModelActionTypes.FETCH_ALL_BPJS_CONTROL_PLAN_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsControlPlanAction>(modelAction.BpjsControlPlanModelActionTypes.FETCH_BPJS_CONTROL_PLAN_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsControlPlanActionOK(
						modelAction.BpjsControlPlanModelActionTypes.FETCH_BPJS_CONTROL_PLAN_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsControlPlanActionFail(
								modelAction.BpjsControlPlanModelActionTypes.FETCH_BPJS_CONTROL_PLAN_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsControlPlanAction>(modelAction.BpjsControlPlanModelActionTypes.FETCH_LAST_BPJS_CONTROL_PLAN_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsControlPlanActionOK(
						modelAction.BpjsControlPlanModelActionTypes.FETCH_LAST_BPJS_CONTROL_PLAN_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsControlPlanActionFail(
								modelAction.BpjsControlPlanModelActionTypes.FETCH_LAST_BPJS_CONTROL_PLAN_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsControlPlanAction>(modelAction.BpjsControlPlanModelActionTypes.CREATE_BPJS_CONTROL_PLAN),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsControlPlanModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsControlPlanActionOK(
						modelAction.BpjsControlPlanModelActionTypes.CREATE_BPJS_CONTROL_PLAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsControlPlanActionFail(
								modelAction.BpjsControlPlanModelActionTypes.CREATE_BPJS_CONTROL_PLAN_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsControlPlanAction>(modelAction.BpjsControlPlanModelActionTypes.CREATE_ALL_BPJS_CONTROL_PLAN),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsControlPlanModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsControlPlanActionOK(
						modelAction.BpjsControlPlanModelActionTypes.CREATE_ALL_BPJS_CONTROL_PLAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsControlPlanActionFail(
								modelAction.BpjsControlPlanModelActionTypes.CREATE_ALL_BPJS_CONTROL_PLAN_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsControlPlanAction>(modelAction.BpjsControlPlanModelActionTypes.UPDATE_BPJS_CONTROL_PLAN),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsControlPlanModel;
				...
				return this.service.update(new BpjsControlPlanModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsControlPlanActionOK(
						modelAction.BpjsControlPlanModelActionTypes.UPDATE_BPJS_CONTROL_PLAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsControlPlanActionFail(
								modelAction.BpjsControlPlanModelActionTypes.UPDATE_BPJS_CONTROL_PLAN_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsControlPlanAction>(modelAction.BpjsControlPlanModelActionTypes.UPDATE_ALL_BPJS_CONTROL_PLAN),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsControlPlanModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsControlPlanModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsControlPlanActionOK(
						modelAction.BpjsControlPlanModelActionTypes.UPDATE_ALL_BPJS_CONTROL_PLAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsControlPlanActionFail(
								modelAction.BpjsControlPlanModelActionTypes.UPDATE_ALL_BPJS_CONTROL_PLAN_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsControlPlanAction>(modelAction.BpjsControlPlanModelActionTypes.DELETE_BPJS_CONTROL_PLAN),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsControlPlanActionOK(
						modelAction.BpjsControlPlanModelActionTypes.DELETE_BPJS_CONTROL_PLAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsControlPlanActionFail(
								modelAction.BpjsControlPlanModelActionTypes.DELETE_BPJS_CONTROL_PLAN_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsControlPlanAction>(modelAction.BpjsControlPlanModelActionTypes.DELETE_BPJS_CONTROL_PLAN_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsControlPlanActionOK(
						modelAction.BpjsControlPlanModelActionTypes.DELETE_BPJS_CONTROL_PLAN_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsControlPlanActionFail(
								modelAction.BpjsControlPlanModelActionTypes.DELETE_BPJS_CONTROL_PLAN_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsControlPlanAction>(modelAction.BpjsControlPlanModelActionTypes.DELETE_ALL_BPJS_CONTROL_PLAN),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsControlPlanActionOK(
						modelAction.BpjsControlPlanModelActionTypes.DELETE_ALL_BPJS_CONTROL_PLAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsControlPlanActionFail(
								modelAction.BpjsControlPlanModelActionTypes.DELETE_ALL_BPJS_CONTROL_PLAN_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsControlPlanAction>(modelAction.BpjsControlPlanModelActionTypes.EXPORT_BPJS_CONTROL_PLAN),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsControlPlanActionOK(
						modelAction.BpjsControlPlanModelActionTypes.EXPORT_BPJS_CONTROL_PLAN,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsControlPlanAction>(modelAction.BpjsControlPlanModelActionTypes.EXPORT_ALL_BPJS_CONTROL_PLAN),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsControlPlanActionOK(
						modelAction.BpjsControlPlanModelActionTypes.EXPORT_ALL_BPJS_CONTROL_PLAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsControlPlanActionFail(
								modelAction.BpjsControlPlanModelActionTypes.EXPORT_ALL_BPJS_CONTROL_PLAN_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsControlPlanAction>(modelAction.BpjsControlPlanModelActionTypes.EXPORT_BPJS_CONTROL_PLAN_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsControlPlanActionOK(
						modelAction.BpjsControlPlanModelActionTypes.EXPORT_BPJS_CONTROL_PLAN_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsControlPlanActionFail(
								modelAction.BpjsControlPlanModelActionTypes.EXPORT_BPJS_CONTROL_PLAN_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsControlPlanAction>(modelAction.BpjsControlPlanModelActionTypes.IMPORT_BPJS_CONTROL_PLANS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsControlPlanActionOK(
						modelAction.BpjsControlPlanModelActionTypes.IMPORT_BPJS_CONTROL_PLANS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsControlPlanActionFail(
								modelAction.BpjsControlPlanModelActionTypes.IMPORT_BPJS_CONTROL_PLANS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsControlPlanAction>(modelAction.BpjsControlPlanModelActionTypes.FETCH_BPJS_CONTROL_PLAN_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsControlPlanActionOK(
						modelAction.BpjsControlPlanModelActionTypes.FETCH_BPJS_CONTROL_PLAN_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsControlPlanActionFail(
								modelAction.BpjsControlPlanModelActionTypes.FETCH_BPJS_CONTROL_PLAN_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsControlPlanAction>(modelAction.BpjsControlPlanModelActionTypes.FETCH_BPJS_CONTROL_PLAN_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsControlPlanActionOK(
						modelAction.BpjsControlPlanModelActionTypes.FETCH_BPJS_CONTROL_PLAN_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsControlPlanActionFail(
								modelAction.BpjsControlPlanModelActionTypes.FETCH_BPJS_CONTROL_PLAN_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
