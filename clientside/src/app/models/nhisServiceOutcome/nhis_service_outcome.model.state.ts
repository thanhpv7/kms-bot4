...
/**
 * NhisServiceOutcomeCollectionState would store the state of a collection of NhisServiceOutcome
 */
export interface NhisServiceOutcomeCollectionState extends CollectionState {
 ...
 */
export interface NhisServiceOutcomeModelAudit extends AbstractModelAudit<NhisServiceOutcomeModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * NhisServiceOutcomeModelState would store the state of the model
 */
export interface NhisServiceOutcomeModelState {
	collectionState: {
		[key: string]: NhisServiceOutcomeCollectionState;
	};
	data: {
		[id: string]: NhisServiceOutcomeModel;
	};
	totalCount: number;
	audits: NhisServiceOutcomeModelAudit[];
 ...
 */
export const initialNhisServiceOutcomeCollectionState: NhisServiceOutcomeCollectionState = {
...
/**
 * The initial state of NhisServiceOutcomeModelState
 */
export const initialState: NhisServiceOutcomeModelState = {
	collectionState: {
