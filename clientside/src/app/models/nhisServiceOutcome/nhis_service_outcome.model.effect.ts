...
import * as modelAction from './nhis_service_outcome.model.action';
import {NhisServiceOutcomeService} from '../../services/nhisServiceOutcome/nhis_service_outcome.service';
...
/**
 * Effect class used for side effects related to NHIS Service Outcome model.
 */
@Injectable()
export class NhisServiceOutcomeEffect {
	...
	constructor(
		...
		protected readonly service: NhisServiceOutcomeService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisServiceOutcomeAction>(modelAction.NhisServiceOutcomeModelActionTypes.COUNT_NHIS_SERVICE_OUTCOMES),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.NhisServiceOutcomeActionOK(
						modelAction.NhisServiceOutcomeModelActionTypes.COUNT_NHIS_SERVICE_OUTCOMES_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisServiceOutcomeActionFail(
								modelAction.NhisServiceOutcomeModelActionTypes.COUNT_NHIS_SERVICE_OUTCOMES_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisServiceOutcomeAction>(modelAction.NhisServiceOutcomeModelActionTypes.FETCH_NHIS_SERVICE_OUTCOME),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisServiceOutcomeActionOK(
						modelAction.NhisServiceOutcomeModelActionTypes.FETCH_NHIS_SERVICE_OUTCOME_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisServiceOutcomeActionFail(
								modelAction.NhisServiceOutcomeModelActionTypes.FETCH_NHIS_SERVICE_OUTCOME_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisServiceOutcomeAction>(modelAction.NhisServiceOutcomeModelActionTypes.FETCH_ALL_NHIS_SERVICE_OUTCOME),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.NhisServiceOutcomeActionOK(
						modelAction.NhisServiceOutcomeModelActionTypes.FETCH_ALL_NHIS_SERVICE_OUTCOME_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisServiceOutcomeActionFail(
								modelAction.NhisServiceOutcomeModelActionTypes.FETCH_ALL_NHIS_SERVICE_OUTCOME_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisServiceOutcomeAction>(modelAction.NhisServiceOutcomeModelActionTypes.FETCH_NHIS_SERVICE_OUTCOME_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisServiceOutcomeActionOK(
						modelAction.NhisServiceOutcomeModelActionTypes.FETCH_NHIS_SERVICE_OUTCOME_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisServiceOutcomeActionFail(
								modelAction.NhisServiceOutcomeModelActionTypes.FETCH_NHIS_SERVICE_OUTCOME_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisServiceOutcomeAction>(modelAction.NhisServiceOutcomeModelActionTypes.FETCH_LAST_NHIS_SERVICE_OUTCOME_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisServiceOutcomeActionOK(
						modelAction.NhisServiceOutcomeModelActionTypes.FETCH_LAST_NHIS_SERVICE_OUTCOME_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisServiceOutcomeActionFail(
								modelAction.NhisServiceOutcomeModelActionTypes.FETCH_LAST_NHIS_SERVICE_OUTCOME_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisServiceOutcomeAction>(modelAction.NhisServiceOutcomeModelActionTypes.CREATE_NHIS_SERVICE_OUTCOME),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as NhisServiceOutcomeModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisServiceOutcomeActionOK(
						modelAction.NhisServiceOutcomeModelActionTypes.CREATE_NHIS_SERVICE_OUTCOME_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisServiceOutcomeActionFail(
								modelAction.NhisServiceOutcomeModelActionTypes.CREATE_NHIS_SERVICE_OUTCOME_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisServiceOutcomeAction>(modelAction.NhisServiceOutcomeModelActionTypes.CREATE_ALL_NHIS_SERVICE_OUTCOME),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as NhisServiceOutcomeModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisServiceOutcomeActionOK(
						modelAction.NhisServiceOutcomeModelActionTypes.CREATE_ALL_NHIS_SERVICE_OUTCOME_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisServiceOutcomeActionFail(
								modelAction.NhisServiceOutcomeModelActionTypes.CREATE_ALL_NHIS_SERVICE_OUTCOME_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisServiceOutcomeAction>(modelAction.NhisServiceOutcomeModelActionTypes.UPDATE_NHIS_SERVICE_OUTCOME),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as NhisServiceOutcomeModel;
				...
				return this.service.update(new NhisServiceOutcomeModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisServiceOutcomeActionOK(
						modelAction.NhisServiceOutcomeModelActionTypes.UPDATE_NHIS_SERVICE_OUTCOME_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisServiceOutcomeActionFail(
								modelAction.NhisServiceOutcomeModelActionTypes.UPDATE_NHIS_SERVICE_OUTCOME_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisServiceOutcomeAction>(modelAction.NhisServiceOutcomeModelActionTypes.UPDATE_ALL_NHIS_SERVICE_OUTCOME),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as NhisServiceOutcomeModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new NhisServiceOutcomeModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisServiceOutcomeActionOK(
						modelAction.NhisServiceOutcomeModelActionTypes.UPDATE_ALL_NHIS_SERVICE_OUTCOME_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisServiceOutcomeActionFail(
								modelAction.NhisServiceOutcomeModelActionTypes.UPDATE_ALL_NHIS_SERVICE_OUTCOME_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisServiceOutcomeAction>(modelAction.NhisServiceOutcomeModelActionTypes.DELETE_NHIS_SERVICE_OUTCOME),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.NhisServiceOutcomeActionOK(
						modelAction.NhisServiceOutcomeModelActionTypes.DELETE_NHIS_SERVICE_OUTCOME_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisServiceOutcomeActionFail(
								modelAction.NhisServiceOutcomeModelActionTypes.DELETE_NHIS_SERVICE_OUTCOME_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisServiceOutcomeAction>(modelAction.NhisServiceOutcomeModelActionTypes.DELETE_NHIS_SERVICE_OUTCOME_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.NhisServiceOutcomeActionOK(
						modelAction.NhisServiceOutcomeModelActionTypes.DELETE_NHIS_SERVICE_OUTCOME_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisServiceOutcomeActionFail(
								modelAction.NhisServiceOutcomeModelActionTypes.DELETE_NHIS_SERVICE_OUTCOME_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisServiceOutcomeAction>(modelAction.NhisServiceOutcomeModelActionTypes.DELETE_ALL_NHIS_SERVICE_OUTCOME),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.NhisServiceOutcomeActionOK(
						modelAction.NhisServiceOutcomeModelActionTypes.DELETE_ALL_NHIS_SERVICE_OUTCOME_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisServiceOutcomeActionFail(
								modelAction.NhisServiceOutcomeModelActionTypes.DELETE_ALL_NHIS_SERVICE_OUTCOME_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisServiceOutcomeAction>(modelAction.NhisServiceOutcomeModelActionTypes.EXPORT_NHIS_SERVICE_OUTCOME),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.NhisServiceOutcomeActionOK(
						modelAction.NhisServiceOutcomeModelActionTypes.EXPORT_NHIS_SERVICE_OUTCOME,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisServiceOutcomeAction>(modelAction.NhisServiceOutcomeModelActionTypes.EXPORT_ALL_NHIS_SERVICE_OUTCOME),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.NhisServiceOutcomeActionOK(
						modelAction.NhisServiceOutcomeModelActionTypes.EXPORT_ALL_NHIS_SERVICE_OUTCOME_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisServiceOutcomeActionFail(
								modelAction.NhisServiceOutcomeModelActionTypes.EXPORT_ALL_NHIS_SERVICE_OUTCOME_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisServiceOutcomeAction>(modelAction.NhisServiceOutcomeModelActionTypes.EXPORT_NHIS_SERVICE_OUTCOME_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.NhisServiceOutcomeActionOK(
						modelAction.NhisServiceOutcomeModelActionTypes.EXPORT_NHIS_SERVICE_OUTCOME_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisServiceOutcomeActionFail(
								modelAction.NhisServiceOutcomeModelActionTypes.EXPORT_NHIS_SERVICE_OUTCOME_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisServiceOutcomeAction>(modelAction.NhisServiceOutcomeModelActionTypes.IMPORT_NHIS_SERVICE_OUTCOMES),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.NhisServiceOutcomeActionOK(
						modelAction.NhisServiceOutcomeModelActionTypes.IMPORT_NHIS_SERVICE_OUTCOMES_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisServiceOutcomeActionFail(
								modelAction.NhisServiceOutcomeModelActionTypes.IMPORT_NHIS_SERVICE_OUTCOMES_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisServiceOutcomeAction>(modelAction.NhisServiceOutcomeModelActionTypes.FETCH_NHIS_SERVICE_OUTCOME_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.NhisServiceOutcomeActionOK(
						modelAction.NhisServiceOutcomeModelActionTypes.FETCH_NHIS_SERVICE_OUTCOME_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.NhisServiceOutcomeActionFail(
								modelAction.NhisServiceOutcomeModelActionTypes.FETCH_NHIS_SERVICE_OUTCOME_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisServiceOutcomeAction>(modelAction.NhisServiceOutcomeModelActionTypes.FETCH_NHIS_SERVICE_OUTCOME_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.NhisServiceOutcomeActionOK(
						modelAction.NhisServiceOutcomeModelActionTypes.FETCH_NHIS_SERVICE_OUTCOME_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.NhisServiceOutcomeActionFail(
								modelAction.NhisServiceOutcomeModelActionTypes.FETCH_NHIS_SERVICE_OUTCOME_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
