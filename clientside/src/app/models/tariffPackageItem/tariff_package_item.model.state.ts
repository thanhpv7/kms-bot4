...
/**
 * TariffPackageItemCollectionState would store the state of a collection of TariffPackageItem
 */
export interface TariffPackageItemCollectionState extends CollectionState {
 ...
 */
export interface TariffPackageItemModelAudit extends AbstractModelAudit<TariffPackageItemModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * TariffPackageItemModelState would store the state of the model
 */
export interface TariffPackageItemModelState {
	collectionState: {
		[key: string]: TariffPackageItemCollectionState;
	};
	data: {
		[id: string]: TariffPackageItemModel;
	};
	totalCount: number;
	audits: TariffPackageItemModelAudit[];
 ...
 */
export const initialTariffPackageItemCollectionState: TariffPackageItemCollectionState = {
...
/**
 * The initial state of TariffPackageItemModelState
 */
export const initialState: TariffPackageItemModelState = {
	collectionState: {
