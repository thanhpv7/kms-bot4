...
import * as modelAction from './tariff_package_item.model.action';
import {TariffPackageItemService} from '../../services/tariffPackageItem/tariff_package_item.service';
...
/**
 * Effect class used for side effects related to Tariff Package Item model.
 */
@Injectable()
export class TariffPackageItemEffect {
	...
	constructor(
		...
		protected readonly service: TariffPackageItemService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageItemAction>(modelAction.TariffPackageItemModelActionTypes.COUNT_TARIFF_PACKAGE_ITEMS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.TariffPackageItemActionOK(
						modelAction.TariffPackageItemModelActionTypes.COUNT_TARIFF_PACKAGE_ITEMS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageItemActionFail(
								modelAction.TariffPackageItemModelActionTypes.COUNT_TARIFF_PACKAGE_ITEMS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageItemAction>(modelAction.TariffPackageItemModelActionTypes.FETCH_TARIFF_PACKAGE_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.TariffPackageItemActionOK(
						modelAction.TariffPackageItemModelActionTypes.FETCH_TARIFF_PACKAGE_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageItemActionFail(
								modelAction.TariffPackageItemModelActionTypes.FETCH_TARIFF_PACKAGE_ITEM_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageItemAction>(modelAction.TariffPackageItemModelActionTypes.FETCH_ALL_TARIFF_PACKAGE_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.TariffPackageItemActionOK(
						modelAction.TariffPackageItemModelActionTypes.FETCH_ALL_TARIFF_PACKAGE_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageItemActionFail(
								modelAction.TariffPackageItemModelActionTypes.FETCH_ALL_TARIFF_PACKAGE_ITEM_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageItemAction>(modelAction.TariffPackageItemModelActionTypes.FETCH_TARIFF_PACKAGE_ITEM_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.TariffPackageItemActionOK(
						modelAction.TariffPackageItemModelActionTypes.FETCH_TARIFF_PACKAGE_ITEM_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageItemActionFail(
								modelAction.TariffPackageItemModelActionTypes.FETCH_TARIFF_PACKAGE_ITEM_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageItemAction>(modelAction.TariffPackageItemModelActionTypes.FETCH_LAST_TARIFF_PACKAGE_ITEM_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.TariffPackageItemActionOK(
						modelAction.TariffPackageItemModelActionTypes.FETCH_LAST_TARIFF_PACKAGE_ITEM_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageItemActionFail(
								modelAction.TariffPackageItemModelActionTypes.FETCH_LAST_TARIFF_PACKAGE_ITEM_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageItemAction>(modelAction.TariffPackageItemModelActionTypes.CREATE_TARIFF_PACKAGE_ITEM),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as TariffPackageItemModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.TariffPackageItemActionOK(
						modelAction.TariffPackageItemModelActionTypes.CREATE_TARIFF_PACKAGE_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageItemActionFail(
								modelAction.TariffPackageItemModelActionTypes.CREATE_TARIFF_PACKAGE_ITEM_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageItemAction>(modelAction.TariffPackageItemModelActionTypes.CREATE_ALL_TARIFF_PACKAGE_ITEM),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as TariffPackageItemModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.TariffPackageItemActionOK(
						modelAction.TariffPackageItemModelActionTypes.CREATE_ALL_TARIFF_PACKAGE_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageItemActionFail(
								modelAction.TariffPackageItemModelActionTypes.CREATE_ALL_TARIFF_PACKAGE_ITEM_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageItemAction>(modelAction.TariffPackageItemModelActionTypes.UPDATE_TARIFF_PACKAGE_ITEM),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as TariffPackageItemModel;
				...
				return this.service.update(new TariffPackageItemModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.TariffPackageItemActionOK(
						modelAction.TariffPackageItemModelActionTypes.UPDATE_TARIFF_PACKAGE_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageItemActionFail(
								modelAction.TariffPackageItemModelActionTypes.UPDATE_TARIFF_PACKAGE_ITEM_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageItemAction>(modelAction.TariffPackageItemModelActionTypes.UPDATE_ALL_TARIFF_PACKAGE_ITEM),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as TariffPackageItemModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new TariffPackageItemModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.TariffPackageItemActionOK(
						modelAction.TariffPackageItemModelActionTypes.UPDATE_ALL_TARIFF_PACKAGE_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageItemActionFail(
								modelAction.TariffPackageItemModelActionTypes.UPDATE_ALL_TARIFF_PACKAGE_ITEM_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageItemAction>(modelAction.TariffPackageItemModelActionTypes.DELETE_TARIFF_PACKAGE_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.TariffPackageItemActionOK(
						modelAction.TariffPackageItemModelActionTypes.DELETE_TARIFF_PACKAGE_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageItemActionFail(
								modelAction.TariffPackageItemModelActionTypes.DELETE_TARIFF_PACKAGE_ITEM_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageItemAction>(modelAction.TariffPackageItemModelActionTypes.DELETE_TARIFF_PACKAGE_ITEM_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.TariffPackageItemActionOK(
						modelAction.TariffPackageItemModelActionTypes.DELETE_TARIFF_PACKAGE_ITEM_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageItemActionFail(
								modelAction.TariffPackageItemModelActionTypes.DELETE_TARIFF_PACKAGE_ITEM_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageItemAction>(modelAction.TariffPackageItemModelActionTypes.DELETE_ALL_TARIFF_PACKAGE_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.TariffPackageItemActionOK(
						modelAction.TariffPackageItemModelActionTypes.DELETE_ALL_TARIFF_PACKAGE_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageItemActionFail(
								modelAction.TariffPackageItemModelActionTypes.DELETE_ALL_TARIFF_PACKAGE_ITEM_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageItemAction>(modelAction.TariffPackageItemModelActionTypes.EXPORT_TARIFF_PACKAGE_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.TariffPackageItemActionOK(
						modelAction.TariffPackageItemModelActionTypes.EXPORT_TARIFF_PACKAGE_ITEM,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageItemAction>(modelAction.TariffPackageItemModelActionTypes.EXPORT_ALL_TARIFF_PACKAGE_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.TariffPackageItemActionOK(
						modelAction.TariffPackageItemModelActionTypes.EXPORT_ALL_TARIFF_PACKAGE_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageItemActionFail(
								modelAction.TariffPackageItemModelActionTypes.EXPORT_ALL_TARIFF_PACKAGE_ITEM_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageItemAction>(modelAction.TariffPackageItemModelActionTypes.EXPORT_TARIFF_PACKAGE_ITEM_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.TariffPackageItemActionOK(
						modelAction.TariffPackageItemModelActionTypes.EXPORT_TARIFF_PACKAGE_ITEM_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageItemActionFail(
								modelAction.TariffPackageItemModelActionTypes.EXPORT_TARIFF_PACKAGE_ITEM_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageItemAction>(modelAction.TariffPackageItemModelActionTypes.IMPORT_TARIFF_PACKAGE_ITEMS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.TariffPackageItemActionOK(
						modelAction.TariffPackageItemModelActionTypes.IMPORT_TARIFF_PACKAGE_ITEMS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageItemActionFail(
								modelAction.TariffPackageItemModelActionTypes.IMPORT_TARIFF_PACKAGE_ITEMS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageItemAction>(modelAction.TariffPackageItemModelActionTypes.FETCH_TARIFF_PACKAGE_ITEM_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.TariffPackageItemActionOK(
						modelAction.TariffPackageItemModelActionTypes.FETCH_TARIFF_PACKAGE_ITEM_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageItemActionFail(
								modelAction.TariffPackageItemModelActionTypes.FETCH_TARIFF_PACKAGE_ITEM_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffPackageItemAction>(modelAction.TariffPackageItemModelActionTypes.FETCH_TARIFF_PACKAGE_ITEM_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.TariffPackageItemActionOK(
						modelAction.TariffPackageItemModelActionTypes.FETCH_TARIFF_PACKAGE_ITEM_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.TariffPackageItemActionFail(
								modelAction.TariffPackageItemModelActionTypes.FETCH_TARIFF_PACKAGE_ITEM_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
