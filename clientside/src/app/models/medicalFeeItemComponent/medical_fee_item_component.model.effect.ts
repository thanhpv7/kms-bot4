...
import * as modelAction from './medical_fee_item_component.model.action';
import {MedicalFeeItemComponentService} from '../../services/medicalFeeItemComponent/medical_fee_item_component.service';
...
/**
 * Effect class used for side effects related to Medical Fee Item Component model.
 */
@Injectable()
export class MedicalFeeItemComponentEffect {
	...
	constructor(
		...
		protected readonly service: MedicalFeeItemComponentService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalFeeItemComponentAction>(modelAction.MedicalFeeItemComponentModelActionTypes.COUNT_MEDICAL_FEE_ITEM_COMPONENTS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.MedicalFeeItemComponentActionOK(
						modelAction.MedicalFeeItemComponentModelActionTypes.COUNT_MEDICAL_FEE_ITEM_COMPONENTS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalFeeItemComponentActionFail(
								modelAction.MedicalFeeItemComponentModelActionTypes.COUNT_MEDICAL_FEE_ITEM_COMPONENTS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalFeeItemComponentAction>(modelAction.MedicalFeeItemComponentModelActionTypes.FETCH_MEDICAL_FEE_ITEM_COMPONENT),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalFeeItemComponentActionOK(
						modelAction.MedicalFeeItemComponentModelActionTypes.FETCH_MEDICAL_FEE_ITEM_COMPONENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalFeeItemComponentActionFail(
								modelAction.MedicalFeeItemComponentModelActionTypes.FETCH_MEDICAL_FEE_ITEM_COMPONENT_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalFeeItemComponentAction>(modelAction.MedicalFeeItemComponentModelActionTypes.FETCH_ALL_MEDICAL_FEE_ITEM_COMPONENT),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.MedicalFeeItemComponentActionOK(
						modelAction.MedicalFeeItemComponentModelActionTypes.FETCH_ALL_MEDICAL_FEE_ITEM_COMPONENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalFeeItemComponentActionFail(
								modelAction.MedicalFeeItemComponentModelActionTypes.FETCH_ALL_MEDICAL_FEE_ITEM_COMPONENT_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalFeeItemComponentAction>(modelAction.MedicalFeeItemComponentModelActionTypes.FETCH_MEDICAL_FEE_ITEM_COMPONENT_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalFeeItemComponentActionOK(
						modelAction.MedicalFeeItemComponentModelActionTypes.FETCH_MEDICAL_FEE_ITEM_COMPONENT_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalFeeItemComponentActionFail(
								modelAction.MedicalFeeItemComponentModelActionTypes.FETCH_MEDICAL_FEE_ITEM_COMPONENT_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalFeeItemComponentAction>(modelAction.MedicalFeeItemComponentModelActionTypes.FETCH_LAST_MEDICAL_FEE_ITEM_COMPONENT_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalFeeItemComponentActionOK(
						modelAction.MedicalFeeItemComponentModelActionTypes.FETCH_LAST_MEDICAL_FEE_ITEM_COMPONENT_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalFeeItemComponentActionFail(
								modelAction.MedicalFeeItemComponentModelActionTypes.FETCH_LAST_MEDICAL_FEE_ITEM_COMPONENT_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalFeeItemComponentAction>(modelAction.MedicalFeeItemComponentModelActionTypes.CREATE_MEDICAL_FEE_ITEM_COMPONENT),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as MedicalFeeItemComponentModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalFeeItemComponentActionOK(
						modelAction.MedicalFeeItemComponentModelActionTypes.CREATE_MEDICAL_FEE_ITEM_COMPONENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalFeeItemComponentActionFail(
								modelAction.MedicalFeeItemComponentModelActionTypes.CREATE_MEDICAL_FEE_ITEM_COMPONENT_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalFeeItemComponentAction>(modelAction.MedicalFeeItemComponentModelActionTypes.CREATE_ALL_MEDICAL_FEE_ITEM_COMPONENT),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as MedicalFeeItemComponentModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalFeeItemComponentActionOK(
						modelAction.MedicalFeeItemComponentModelActionTypes.CREATE_ALL_MEDICAL_FEE_ITEM_COMPONENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalFeeItemComponentActionFail(
								modelAction.MedicalFeeItemComponentModelActionTypes.CREATE_ALL_MEDICAL_FEE_ITEM_COMPONENT_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalFeeItemComponentAction>(modelAction.MedicalFeeItemComponentModelActionTypes.UPDATE_MEDICAL_FEE_ITEM_COMPONENT),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as MedicalFeeItemComponentModel;
				...
				return this.service.update(new MedicalFeeItemComponentModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalFeeItemComponentActionOK(
						modelAction.MedicalFeeItemComponentModelActionTypes.UPDATE_MEDICAL_FEE_ITEM_COMPONENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalFeeItemComponentActionFail(
								modelAction.MedicalFeeItemComponentModelActionTypes.UPDATE_MEDICAL_FEE_ITEM_COMPONENT_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalFeeItemComponentAction>(modelAction.MedicalFeeItemComponentModelActionTypes.UPDATE_ALL_MEDICAL_FEE_ITEM_COMPONENT),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as MedicalFeeItemComponentModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new MedicalFeeItemComponentModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalFeeItemComponentActionOK(
						modelAction.MedicalFeeItemComponentModelActionTypes.UPDATE_ALL_MEDICAL_FEE_ITEM_COMPONENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalFeeItemComponentActionFail(
								modelAction.MedicalFeeItemComponentModelActionTypes.UPDATE_ALL_MEDICAL_FEE_ITEM_COMPONENT_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalFeeItemComponentAction>(modelAction.MedicalFeeItemComponentModelActionTypes.DELETE_MEDICAL_FEE_ITEM_COMPONENT),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.MedicalFeeItemComponentActionOK(
						modelAction.MedicalFeeItemComponentModelActionTypes.DELETE_MEDICAL_FEE_ITEM_COMPONENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalFeeItemComponentActionFail(
								modelAction.MedicalFeeItemComponentModelActionTypes.DELETE_MEDICAL_FEE_ITEM_COMPONENT_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalFeeItemComponentAction>(modelAction.MedicalFeeItemComponentModelActionTypes.DELETE_MEDICAL_FEE_ITEM_COMPONENT_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.MedicalFeeItemComponentActionOK(
						modelAction.MedicalFeeItemComponentModelActionTypes.DELETE_MEDICAL_FEE_ITEM_COMPONENT_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalFeeItemComponentActionFail(
								modelAction.MedicalFeeItemComponentModelActionTypes.DELETE_MEDICAL_FEE_ITEM_COMPONENT_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalFeeItemComponentAction>(modelAction.MedicalFeeItemComponentModelActionTypes.DELETE_ALL_MEDICAL_FEE_ITEM_COMPONENT),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.MedicalFeeItemComponentActionOK(
						modelAction.MedicalFeeItemComponentModelActionTypes.DELETE_ALL_MEDICAL_FEE_ITEM_COMPONENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalFeeItemComponentActionFail(
								modelAction.MedicalFeeItemComponentModelActionTypes.DELETE_ALL_MEDICAL_FEE_ITEM_COMPONENT_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalFeeItemComponentAction>(modelAction.MedicalFeeItemComponentModelActionTypes.EXPORT_MEDICAL_FEE_ITEM_COMPONENT),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicalFeeItemComponentActionOK(
						modelAction.MedicalFeeItemComponentModelActionTypes.EXPORT_MEDICAL_FEE_ITEM_COMPONENT,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalFeeItemComponentAction>(modelAction.MedicalFeeItemComponentModelActionTypes.EXPORT_ALL_MEDICAL_FEE_ITEM_COMPONENT),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicalFeeItemComponentActionOK(
						modelAction.MedicalFeeItemComponentModelActionTypes.EXPORT_ALL_MEDICAL_FEE_ITEM_COMPONENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalFeeItemComponentActionFail(
								modelAction.MedicalFeeItemComponentModelActionTypes.EXPORT_ALL_MEDICAL_FEE_ITEM_COMPONENT_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalFeeItemComponentAction>(modelAction.MedicalFeeItemComponentModelActionTypes.EXPORT_MEDICAL_FEE_ITEM_COMPONENT_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicalFeeItemComponentActionOK(
						modelAction.MedicalFeeItemComponentModelActionTypes.EXPORT_MEDICAL_FEE_ITEM_COMPONENT_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalFeeItemComponentActionFail(
								modelAction.MedicalFeeItemComponentModelActionTypes.EXPORT_MEDICAL_FEE_ITEM_COMPONENT_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalFeeItemComponentAction>(modelAction.MedicalFeeItemComponentModelActionTypes.IMPORT_MEDICAL_FEE_ITEM_COMPONENTS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.MedicalFeeItemComponentActionOK(
						modelAction.MedicalFeeItemComponentModelActionTypes.IMPORT_MEDICAL_FEE_ITEM_COMPONENTS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalFeeItemComponentActionFail(
								modelAction.MedicalFeeItemComponentModelActionTypes.IMPORT_MEDICAL_FEE_ITEM_COMPONENTS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalFeeItemComponentAction>(modelAction.MedicalFeeItemComponentModelActionTypes.FETCH_MEDICAL_FEE_ITEM_COMPONENT_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.MedicalFeeItemComponentActionOK(
						modelAction.MedicalFeeItemComponentModelActionTypes.FETCH_MEDICAL_FEE_ITEM_COMPONENT_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.MedicalFeeItemComponentActionFail(
								modelAction.MedicalFeeItemComponentModelActionTypes.FETCH_MEDICAL_FEE_ITEM_COMPONENT_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalFeeItemComponentAction>(modelAction.MedicalFeeItemComponentModelActionTypes.FETCH_MEDICAL_FEE_ITEM_COMPONENT_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.MedicalFeeItemComponentActionOK(
						modelAction.MedicalFeeItemComponentModelActionTypes.FETCH_MEDICAL_FEE_ITEM_COMPONENT_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.MedicalFeeItemComponentActionFail(
								modelAction.MedicalFeeItemComponentModelActionTypes.FETCH_MEDICAL_FEE_ITEM_COMPONENT_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
