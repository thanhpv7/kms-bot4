...
import {initialMedicalFeeItemComponentCollectionState} from './medical_fee_item_component.model.state';
...
export function modelReducer(currentState: ModelState, action: Action): ModelState {
	...
	const className = (action as modelAction.BaseMedicalFeeItemComponentAction).className;
	...
	return produce(currentState, draft => {
		...
		switch (action.type) {
			case modelAction.MedicalFeeItemComponentModelActionTypes.CREATE_MEDICAL_FEE_ITEM_COMPONENT_OK:
				const createdModel = (action as modelAction.MedicalFeeItemComponentActionOK ).stateConfig.targetModel;
				...
				MedicalFeeItemComponentModel.deepParse(createdModel).forEach(model => {
				...
				break;
			case modelAction.MedicalFeeItemComponentModelActionTypes.CREATE_MEDICAL_FEE_ITEM_COMPONENT_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.MedicalFeeItemComponentModelActionTypes.CREATE_ALL_MEDICAL_FEE_ITEM_COMPONENT_OK:
				const createdModels = (action as modelAction.MedicalFeeItemComponentActionOK).stateConfig.targetModels;
				const collectionIdAfterCreateAll = (action as modelAction.MedicalFeeItemComponentActionOK).stateConfig.collectionId;
				...
				createdModels.forEach((m) => {
					MedicalFeeItemComponentModel.deepParse(m).forEach(model => {
						draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
						(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
					});
				});
				...
				break;
			case modelAction.MedicalFeeItemComponentModelActionTypes.CREATE_ALL_MEDICAL_FEE_ITEM_COMPONENT_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.MedicalFeeItemComponentModelActionTypes.DELETE_MEDICAL_FEE_ITEM_COMPONENT_OK:
				const deletedModelId = (action as modelAction.MedicalFeeItemComponentActionOK).stateConfig.targetModelId;
				const collectionIdAfterDelete = (action as modelAction.MedicalFeeItemComponentActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.MedicalFeeItemComponentModelActionTypes.DELETE_ALL_MEDICAL_FEE_ITEM_COMPONENT_OK:
				const deletedModelIds = (action as modelAction.MedicalFeeItemComponentActionOK).stateConfig.targetModelIds;
				const collectionIdAfterDeleteAll = (action as modelAction.MedicalFeeItemComponentActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.MedicalFeeItemComponentModelActionTypes.DELETE_MEDICAL_FEE_ITEM_COMPONENT_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.MedicalFeeItemComponentModelActionTypes.UPDATE_MEDICAL_FEE_ITEM_COMPONENT_OK:
				const updatedModel = (action as modelAction.MedicalFeeItemComponentActionOK).stateConfig.targetModel;
				...
				MedicalFeeItemComponentModel.deepParse(updatedModel).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalFeeItemComponentModelActionTypes.UPDATE_MEDICAL_FEE_ITEM_COMPONENT_FAIL:
				// TODO: Add handling of failure
				break;

			case modelAction.MedicalFeeItemComponentModelActionTypes.UPDATE_ALL_MEDICAL_FEE_ITEM_COMPONENT_OK:
				const updatedModels = (action as modelAction.MedicalFeeItemComponentActionOK).stateConfig.targetModels;
				const collectionIdAfterUpdateAll = (action as modelAction.MedicalFeeItemComponentActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.MedicalFeeItemComponentModelActionTypes.UPDATE_ALL_MEDICAL_FEE_ITEM_COMPONENT_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.MedicalFeeItemComponentModelActionTypes.FETCH_MEDICAL_FEE_ITEM_COMPONENT_OK:
				let fetchedModel = (action as modelAction.MedicalFeeItemComponentActionOK).stateConfig.targetModel;
				...
				MedicalFeeItemComponentModel.deepParse(fetchedModel).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalFeeItemComponentModelActionTypes.FETCH_ALL_MEDICAL_FEE_ITEM_COMPONENT_OK:
				const totalCountAfterFetchAll = (action as modelAction.MedicalFeeItemComponentActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchAll = (action as modelAction.MedicalFeeItemComponentActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchAll = (action as modelAction.MedicalFeeItemComponentActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchAll = (action as modelAction.MedicalFeeItemComponentActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchAll.map(model => MedicalFeeItemComponentModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalFeeItemComponentModelActionTypes.FETCH_MEDICAL_FEE_ITEM_COMPONENT_AUDIT_OK:
				const audits = (action as modelAction.MedicalFeeItemComponentActionOK).audits;
				...
				break;
			case modelAction.MedicalFeeItemComponentModelActionTypes.FETCH_MEDICAL_FEE_ITEM_COMPONENT_AUDITS_BY_ENTITY_ID_OK:
				const auditsByEntityId = (action as modelAction.MedicalFeeItemComponentActionOK).audits;
				...
				break;
			case modelAction.MedicalFeeItemComponentModelActionTypes.FETCH_MEDICAL_FEE_ITEM_COMPONENT_WITH_QUERY_OK:
				const totalCountAfterFetchWithQuery = (action as modelAction.MedicalFeeItemComponentActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchWithQuery = (action as modelAction.MedicalFeeItemComponentActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchWithQuery = (action as modelAction.MedicalFeeItemComponentActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchWithQuery = (action as modelAction.MedicalFeeItemComponentActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchWithQuery.map(model => MedicalFeeItemComponentModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalFeeItemComponentModelActionTypes.FETCH_LAST_MEDICAL_FEE_ITEM_COMPONENT_WITH_QUERY_OK:
				const totalCountAfterFetchLastWithQuery = (action as modelAction.MedicalFeeItemComponentActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchLastWithQuery = (action as modelAction.MedicalFeeItemComponentActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchLastWithQuery = (action as modelAction.MedicalFeeItemComponentActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchLastWithQuery = (action as modelAction.MedicalFeeItemComponentActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchLastWithQuery.map(model => MedicalFeeItemComponentModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalFeeItemComponentModelActionTypes.COUNT_MEDICAL_FEE_ITEM_COMPONENTS_OK:
				const totalCountAfterCount = (action as modelAction.MedicalFeeItemComponentActionOK).stateConfig.totalCount;
				...
				break;
			case modelAction.MedicalFeeItemComponentModelActionTypes.INITIALISE_MEDICAL_FEE_ITEM_COMPONENT_COLLECTION_STATE:
				const collectionIdToInitialise =  (action as modelAction.MedicalFeeItemComponentActionOK).stateConfig.collectionId;
				const queryParamsToInitialise = (action as modelAction.MedicalFeeItemComponentActionOK).stateConfig.queryParams;
				...
				if (!draft[className].collectionState[collectionIdToInitialise]) {
					draft[className].collectionState[collectionIdToInitialise] = {
						...initialMedicalFeeItemComponentCollectionState
					};
				}
