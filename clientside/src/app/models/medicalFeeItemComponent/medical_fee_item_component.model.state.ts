...
/**
 * MedicalFeeItemComponentCollectionState would store the state of a collection of MedicalFeeItemComponent
 */
export interface MedicalFeeItemComponentCollectionState extends CollectionState {
 ...
 */
export interface MedicalFeeItemComponentModelAudit extends AbstractModelAudit<MedicalFeeItemComponentModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * MedicalFeeItemComponentModelState would store the state of the model
 */
export interface MedicalFeeItemComponentModelState {
	collectionState: {
		[key: string]: MedicalFeeItemComponentCollectionState;
	};
	data: {
		[id: string]: MedicalFeeItemComponentModel;
	};
	totalCount: number;
	audits: MedicalFeeItemComponentModelAudit[];
 ...
 */
export const initialMedicalFeeItemComponentCollectionState: MedicalFeeItemComponentCollectionState = {
...
/**
 * The initial state of MedicalFeeItemComponentModelState
 */
export const initialState: MedicalFeeItemComponentModelState = {
	collectionState: {
