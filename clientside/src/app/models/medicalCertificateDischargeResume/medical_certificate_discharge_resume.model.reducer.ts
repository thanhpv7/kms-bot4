...
import {initialMedicalCertificateDischargeResumeCollectionState} from './medical_certificate_discharge_resume.model.state';
...
export function modelReducer(currentState: ModelState, action: Action): ModelState {
	...
	const className = (action as modelAction.BaseMedicalCertificateDischargeResumeAction).className;
	...
	return produce(currentState, draft => {
		...
		switch (action.type) {
			case modelAction.MedicalCertificateDischargeResumeModelActionTypes.CREATE_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_OK:
				const createdModel = (action as modelAction.MedicalCertificateDischargeResumeActionOK ).stateConfig.targetModel;
				...
				MedicalCertificateDischargeResumeModel.deepParse(createdModel).forEach(model => {
				...
				break;
			case modelAction.MedicalCertificateDischargeResumeModelActionTypes.CREATE_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.MedicalCertificateDischargeResumeModelActionTypes.CREATE_ALL_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_OK:
				const createdModels = (action as modelAction.MedicalCertificateDischargeResumeActionOK).stateConfig.targetModels;
				const collectionIdAfterCreateAll = (action as modelAction.MedicalCertificateDischargeResumeActionOK).stateConfig.collectionId;
				...
				createdModels.forEach((m) => {
					MedicalCertificateDischargeResumeModel.deepParse(m).forEach(model => {
						draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
						(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
					});
				});
				...
				break;
			case modelAction.MedicalCertificateDischargeResumeModelActionTypes.CREATE_ALL_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.MedicalCertificateDischargeResumeModelActionTypes.DELETE_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_OK:
				const deletedModelId = (action as modelAction.MedicalCertificateDischargeResumeActionOK).stateConfig.targetModelId;
				const collectionIdAfterDelete = (action as modelAction.MedicalCertificateDischargeResumeActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.MedicalCertificateDischargeResumeModelActionTypes.DELETE_ALL_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_OK:
				const deletedModelIds = (action as modelAction.MedicalCertificateDischargeResumeActionOK).stateConfig.targetModelIds;
				const collectionIdAfterDeleteAll = (action as modelAction.MedicalCertificateDischargeResumeActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.MedicalCertificateDischargeResumeModelActionTypes.DELETE_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.MedicalCertificateDischargeResumeModelActionTypes.UPDATE_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_OK:
				const updatedModel = (action as modelAction.MedicalCertificateDischargeResumeActionOK).stateConfig.targetModel;
				...
				MedicalCertificateDischargeResumeModel.deepParse(updatedModel).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalCertificateDischargeResumeModelActionTypes.UPDATE_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_FAIL:
				// TODO: Add handling of failure
				break;

			case modelAction.MedicalCertificateDischargeResumeModelActionTypes.UPDATE_ALL_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_OK:
				const updatedModels = (action as modelAction.MedicalCertificateDischargeResumeActionOK).stateConfig.targetModels;
				const collectionIdAfterUpdateAll = (action as modelAction.MedicalCertificateDischargeResumeActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.MedicalCertificateDischargeResumeModelActionTypes.UPDATE_ALL_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.MedicalCertificateDischargeResumeModelActionTypes.FETCH_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_OK:
				let fetchedModel = (action as modelAction.MedicalCertificateDischargeResumeActionOK).stateConfig.targetModel;
				...
				MedicalCertificateDischargeResumeModel.deepParse(fetchedModel).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalCertificateDischargeResumeModelActionTypes.FETCH_ALL_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_OK:
				const totalCountAfterFetchAll = (action as modelAction.MedicalCertificateDischargeResumeActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchAll = (action as modelAction.MedicalCertificateDischargeResumeActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchAll = (action as modelAction.MedicalCertificateDischargeResumeActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchAll = (action as modelAction.MedicalCertificateDischargeResumeActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchAll.map(model => MedicalCertificateDischargeResumeModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalCertificateDischargeResumeModelActionTypes.FETCH_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_AUDIT_OK:
				const audits = (action as modelAction.MedicalCertificateDischargeResumeActionOK).audits;
				...
				break;
			case modelAction.MedicalCertificateDischargeResumeModelActionTypes.FETCH_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_AUDITS_BY_ENTITY_ID_OK:
				const auditsByEntityId = (action as modelAction.MedicalCertificateDischargeResumeActionOK).audits;
				...
				break;
			case modelAction.MedicalCertificateDischargeResumeModelActionTypes.FETCH_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_WITH_QUERY_OK:
				const totalCountAfterFetchWithQuery = (action as modelAction.MedicalCertificateDischargeResumeActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchWithQuery = (action as modelAction.MedicalCertificateDischargeResumeActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchWithQuery = (action as modelAction.MedicalCertificateDischargeResumeActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchWithQuery = (action as modelAction.MedicalCertificateDischargeResumeActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchWithQuery.map(model => MedicalCertificateDischargeResumeModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalCertificateDischargeResumeModelActionTypes.FETCH_LAST_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_WITH_QUERY_OK:
				const totalCountAfterFetchLastWithQuery = (action as modelAction.MedicalCertificateDischargeResumeActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchLastWithQuery = (action as modelAction.MedicalCertificateDischargeResumeActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchLastWithQuery = (action as modelAction.MedicalCertificateDischargeResumeActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchLastWithQuery = (action as modelAction.MedicalCertificateDischargeResumeActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchLastWithQuery.map(model => MedicalCertificateDischargeResumeModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalCertificateDischargeResumeModelActionTypes.COUNT_MEDICAL_CERTIFICATE_DISCHARGE_RESUMES_OK:
				const totalCountAfterCount = (action as modelAction.MedicalCertificateDischargeResumeActionOK).stateConfig.totalCount;
				...
				break;
			case modelAction.MedicalCertificateDischargeResumeModelActionTypes.INITIALISE_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_COLLECTION_STATE:
				const collectionIdToInitialise =  (action as modelAction.MedicalCertificateDischargeResumeActionOK).stateConfig.collectionId;
				const queryParamsToInitialise = (action as modelAction.MedicalCertificateDischargeResumeActionOK).stateConfig.queryParams;
				...
				if (!draft[className].collectionState[collectionIdToInitialise]) {
					draft[className].collectionState[collectionIdToInitialise] = {
						...initialMedicalCertificateDischargeResumeCollectionState
					};
				}
