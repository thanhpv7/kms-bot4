...
/**
 * MedicalCertificateDischargeResumeCollectionState would store the state of a collection of MedicalCertificateDischargeResume
 */
export interface MedicalCertificateDischargeResumeCollectionState extends CollectionState {
 ...
 */
export interface MedicalCertificateDischargeResumeModelAudit extends AbstractModelAudit<MedicalCertificateDischargeResumeModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * MedicalCertificateDischargeResumeModelState would store the state of the model
 */
export interface MedicalCertificateDischargeResumeModelState {
	collectionState: {
		[key: string]: MedicalCertificateDischargeResumeCollectionState;
	};
	data: {
		[id: string]: MedicalCertificateDischargeResumeModel;
	};
	totalCount: number;
	audits: MedicalCertificateDischargeResumeModelAudit[];
 ...
 */
export const initialMedicalCertificateDischargeResumeCollectionState: MedicalCertificateDischargeResumeCollectionState = {
...
/**
 * The initial state of MedicalCertificateDischargeResumeModelState
 */
export const initialState: MedicalCertificateDischargeResumeModelState = {
	collectionState: {
