...
import * as modelAction from './medical_certificate_discharge_resume.model.action';
import {MedicalCertificateDischargeResumeService} from '../../services/medicalCertificateDischargeResume/medical_certificate_discharge_resume.service';
...
/**
 * Effect class used for side effects related to Medical Certificate  Discharge Resume model.
 */
@Injectable()
export class MedicalCertificateDischargeResumeEffect {
	...
	constructor(
		...
		protected readonly service: MedicalCertificateDischargeResumeService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateDischargeResumeAction>(modelAction.MedicalCertificateDischargeResumeModelActionTypes.COUNT_MEDICAL_CERTIFICATE_DISCHARGE_RESUMES),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateDischargeResumeActionOK(
						modelAction.MedicalCertificateDischargeResumeModelActionTypes.COUNT_MEDICAL_CERTIFICATE_DISCHARGE_RESUMES_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateDischargeResumeActionFail(
								modelAction.MedicalCertificateDischargeResumeModelActionTypes.COUNT_MEDICAL_CERTIFICATE_DISCHARGE_RESUMES_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateDischargeResumeAction>(modelAction.MedicalCertificateDischargeResumeModelActionTypes.FETCH_MEDICAL_CERTIFICATE_DISCHARGE_RESUME),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateDischargeResumeActionOK(
						modelAction.MedicalCertificateDischargeResumeModelActionTypes.FETCH_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateDischargeResumeActionFail(
								modelAction.MedicalCertificateDischargeResumeModelActionTypes.FETCH_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateDischargeResumeAction>(modelAction.MedicalCertificateDischargeResumeModelActionTypes.FETCH_ALL_MEDICAL_CERTIFICATE_DISCHARGE_RESUME),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateDischargeResumeActionOK(
						modelAction.MedicalCertificateDischargeResumeModelActionTypes.FETCH_ALL_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateDischargeResumeActionFail(
								modelAction.MedicalCertificateDischargeResumeModelActionTypes.FETCH_ALL_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateDischargeResumeAction>(modelAction.MedicalCertificateDischargeResumeModelActionTypes.FETCH_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateDischargeResumeActionOK(
						modelAction.MedicalCertificateDischargeResumeModelActionTypes.FETCH_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateDischargeResumeActionFail(
								modelAction.MedicalCertificateDischargeResumeModelActionTypes.FETCH_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateDischargeResumeAction>(modelAction.MedicalCertificateDischargeResumeModelActionTypes.FETCH_LAST_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateDischargeResumeActionOK(
						modelAction.MedicalCertificateDischargeResumeModelActionTypes.FETCH_LAST_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateDischargeResumeActionFail(
								modelAction.MedicalCertificateDischargeResumeModelActionTypes.FETCH_LAST_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateDischargeResumeAction>(modelAction.MedicalCertificateDischargeResumeModelActionTypes.CREATE_MEDICAL_CERTIFICATE_DISCHARGE_RESUME),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as MedicalCertificateDischargeResumeModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateDischargeResumeActionOK(
						modelAction.MedicalCertificateDischargeResumeModelActionTypes.CREATE_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateDischargeResumeActionFail(
								modelAction.MedicalCertificateDischargeResumeModelActionTypes.CREATE_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateDischargeResumeAction>(modelAction.MedicalCertificateDischargeResumeModelActionTypes.CREATE_ALL_MEDICAL_CERTIFICATE_DISCHARGE_RESUME),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as MedicalCertificateDischargeResumeModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateDischargeResumeActionOK(
						modelAction.MedicalCertificateDischargeResumeModelActionTypes.CREATE_ALL_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateDischargeResumeActionFail(
								modelAction.MedicalCertificateDischargeResumeModelActionTypes.CREATE_ALL_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateDischargeResumeAction>(modelAction.MedicalCertificateDischargeResumeModelActionTypes.UPDATE_MEDICAL_CERTIFICATE_DISCHARGE_RESUME),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as MedicalCertificateDischargeResumeModel;
				...
				return this.service.update(new MedicalCertificateDischargeResumeModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateDischargeResumeActionOK(
						modelAction.MedicalCertificateDischargeResumeModelActionTypes.UPDATE_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateDischargeResumeActionFail(
								modelAction.MedicalCertificateDischargeResumeModelActionTypes.UPDATE_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateDischargeResumeAction>(modelAction.MedicalCertificateDischargeResumeModelActionTypes.UPDATE_ALL_MEDICAL_CERTIFICATE_DISCHARGE_RESUME),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as MedicalCertificateDischargeResumeModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new MedicalCertificateDischargeResumeModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateDischargeResumeActionOK(
						modelAction.MedicalCertificateDischargeResumeModelActionTypes.UPDATE_ALL_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateDischargeResumeActionFail(
								modelAction.MedicalCertificateDischargeResumeModelActionTypes.UPDATE_ALL_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateDischargeResumeAction>(modelAction.MedicalCertificateDischargeResumeModelActionTypes.DELETE_MEDICAL_CERTIFICATE_DISCHARGE_RESUME),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateDischargeResumeActionOK(
						modelAction.MedicalCertificateDischargeResumeModelActionTypes.DELETE_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateDischargeResumeActionFail(
								modelAction.MedicalCertificateDischargeResumeModelActionTypes.DELETE_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateDischargeResumeAction>(modelAction.MedicalCertificateDischargeResumeModelActionTypes.DELETE_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateDischargeResumeActionOK(
						modelAction.MedicalCertificateDischargeResumeModelActionTypes.DELETE_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateDischargeResumeActionFail(
								modelAction.MedicalCertificateDischargeResumeModelActionTypes.DELETE_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateDischargeResumeAction>(modelAction.MedicalCertificateDischargeResumeModelActionTypes.DELETE_ALL_MEDICAL_CERTIFICATE_DISCHARGE_RESUME),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateDischargeResumeActionOK(
						modelAction.MedicalCertificateDischargeResumeModelActionTypes.DELETE_ALL_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateDischargeResumeActionFail(
								modelAction.MedicalCertificateDischargeResumeModelActionTypes.DELETE_ALL_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateDischargeResumeAction>(modelAction.MedicalCertificateDischargeResumeModelActionTypes.EXPORT_MEDICAL_CERTIFICATE_DISCHARGE_RESUME),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateDischargeResumeActionOK(
						modelAction.MedicalCertificateDischargeResumeModelActionTypes.EXPORT_MEDICAL_CERTIFICATE_DISCHARGE_RESUME,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateDischargeResumeAction>(modelAction.MedicalCertificateDischargeResumeModelActionTypes.EXPORT_ALL_MEDICAL_CERTIFICATE_DISCHARGE_RESUME),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateDischargeResumeActionOK(
						modelAction.MedicalCertificateDischargeResumeModelActionTypes.EXPORT_ALL_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateDischargeResumeActionFail(
								modelAction.MedicalCertificateDischargeResumeModelActionTypes.EXPORT_ALL_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateDischargeResumeAction>(modelAction.MedicalCertificateDischargeResumeModelActionTypes.EXPORT_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateDischargeResumeActionOK(
						modelAction.MedicalCertificateDischargeResumeModelActionTypes.EXPORT_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateDischargeResumeActionFail(
								modelAction.MedicalCertificateDischargeResumeModelActionTypes.EXPORT_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateDischargeResumeAction>(modelAction.MedicalCertificateDischargeResumeModelActionTypes.IMPORT_MEDICAL_CERTIFICATE_DISCHARGE_RESUMES),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateDischargeResumeActionOK(
						modelAction.MedicalCertificateDischargeResumeModelActionTypes.IMPORT_MEDICAL_CERTIFICATE_DISCHARGE_RESUMES_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateDischargeResumeActionFail(
								modelAction.MedicalCertificateDischargeResumeModelActionTypes.IMPORT_MEDICAL_CERTIFICATE_DISCHARGE_RESUMES_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateDischargeResumeAction>(modelAction.MedicalCertificateDischargeResumeModelActionTypes.FETCH_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.MedicalCertificateDischargeResumeActionOK(
						modelAction.MedicalCertificateDischargeResumeModelActionTypes.FETCH_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateDischargeResumeActionFail(
								modelAction.MedicalCertificateDischargeResumeModelActionTypes.FETCH_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateDischargeResumeAction>(modelAction.MedicalCertificateDischargeResumeModelActionTypes.FETCH_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.MedicalCertificateDischargeResumeActionOK(
						modelAction.MedicalCertificateDischargeResumeModelActionTypes.FETCH_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateDischargeResumeActionFail(
								modelAction.MedicalCertificateDischargeResumeModelActionTypes.FETCH_MEDICAL_CERTIFICATE_DISCHARGE_RESUME_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
