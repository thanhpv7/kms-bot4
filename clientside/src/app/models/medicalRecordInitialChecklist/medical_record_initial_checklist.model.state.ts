...
/**
 * MedicalRecordInitialChecklistCollectionState would store the state of a collection of MedicalRecordInitialChecklist
 */
export interface MedicalRecordInitialChecklistCollectionState extends CollectionState {
 ...
 */
export interface MedicalRecordInitialChecklistModelAudit extends AbstractModelAudit<MedicalRecordInitialChecklistModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * MedicalRecordInitialChecklistModelState would store the state of the model
 */
export interface MedicalRecordInitialChecklistModelState {
	collectionState: {
		[key: string]: MedicalRecordInitialChecklistCollectionState;
	};
	data: {
		[id: string]: MedicalRecordInitialChecklistModel;
	};
	totalCount: number;
	audits: MedicalRecordInitialChecklistModelAudit[];
 ...
 */
export const initialMedicalRecordInitialChecklistCollectionState: MedicalRecordInitialChecklistCollectionState = {
...
/**
 * The initial state of MedicalRecordInitialChecklistModelState
 */
export const initialState: MedicalRecordInitialChecklistModelState = {
	collectionState: {
