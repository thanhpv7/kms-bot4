...
import {initialMedicalRecordInitialChecklistCollectionState} from './medical_record_initial_checklist.model.state';
...
export function modelReducer(currentState: ModelState, action: Action): ModelState {
	...
	const className = (action as modelAction.BaseMedicalRecordInitialChecklistAction).className;
	...
	return produce(currentState, draft => {
		...
		switch (action.type) {
			case modelAction.MedicalRecordInitialChecklistModelActionTypes.CREATE_MEDICAL_RECORD_INITIAL_CHECKLIST_OK:
				const createdModel = (action as modelAction.MedicalRecordInitialChecklistActionOK ).stateConfig.targetModel;
				...
				MedicalRecordInitialChecklistModel.deepParse(createdModel).forEach(model => {
				...
				break;
			case modelAction.MedicalRecordInitialChecklistModelActionTypes.CREATE_MEDICAL_RECORD_INITIAL_CHECKLIST_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.MedicalRecordInitialChecklistModelActionTypes.CREATE_ALL_MEDICAL_RECORD_INITIAL_CHECKLIST_OK:
				const createdModels = (action as modelAction.MedicalRecordInitialChecklistActionOK).stateConfig.targetModels;
				const collectionIdAfterCreateAll = (action as modelAction.MedicalRecordInitialChecklistActionOK).stateConfig.collectionId;
				...
				createdModels.forEach((m) => {
					MedicalRecordInitialChecklistModel.deepParse(m).forEach(model => {
						draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
						(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
					});
				});
				...
				break;
			case modelAction.MedicalRecordInitialChecklistModelActionTypes.CREATE_ALL_MEDICAL_RECORD_INITIAL_CHECKLIST_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.MedicalRecordInitialChecklistModelActionTypes.DELETE_MEDICAL_RECORD_INITIAL_CHECKLIST_OK:
				const deletedModelId = (action as modelAction.MedicalRecordInitialChecklistActionOK).stateConfig.targetModelId;
				const collectionIdAfterDelete = (action as modelAction.MedicalRecordInitialChecklistActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.MedicalRecordInitialChecklistModelActionTypes.DELETE_ALL_MEDICAL_RECORD_INITIAL_CHECKLIST_OK:
				const deletedModelIds = (action as modelAction.MedicalRecordInitialChecklistActionOK).stateConfig.targetModelIds;
				const collectionIdAfterDeleteAll = (action as modelAction.MedicalRecordInitialChecklistActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.MedicalRecordInitialChecklistModelActionTypes.DELETE_MEDICAL_RECORD_INITIAL_CHECKLIST_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.MedicalRecordInitialChecklistModelActionTypes.UPDATE_MEDICAL_RECORD_INITIAL_CHECKLIST_OK:
				const updatedModel = (action as modelAction.MedicalRecordInitialChecklistActionOK).stateConfig.targetModel;
				...
				MedicalRecordInitialChecklistModel.deepParse(updatedModel).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalRecordInitialChecklistModelActionTypes.UPDATE_MEDICAL_RECORD_INITIAL_CHECKLIST_FAIL:
				// TODO: Add handling of failure
				break;

			case modelAction.MedicalRecordInitialChecklistModelActionTypes.UPDATE_ALL_MEDICAL_RECORD_INITIAL_CHECKLIST_OK:
				const updatedModels = (action as modelAction.MedicalRecordInitialChecklistActionOK).stateConfig.targetModels;
				const collectionIdAfterUpdateAll = (action as modelAction.MedicalRecordInitialChecklistActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.MedicalRecordInitialChecklistModelActionTypes.UPDATE_ALL_MEDICAL_RECORD_INITIAL_CHECKLIST_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.MedicalRecordInitialChecklistModelActionTypes.FETCH_MEDICAL_RECORD_INITIAL_CHECKLIST_OK:
				let fetchedModel = (action as modelAction.MedicalRecordInitialChecklistActionOK).stateConfig.targetModel;
				...
				MedicalRecordInitialChecklistModel.deepParse(fetchedModel).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalRecordInitialChecklistModelActionTypes.FETCH_ALL_MEDICAL_RECORD_INITIAL_CHECKLIST_OK:
				const totalCountAfterFetchAll = (action as modelAction.MedicalRecordInitialChecklistActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchAll = (action as modelAction.MedicalRecordInitialChecklistActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchAll = (action as modelAction.MedicalRecordInitialChecklistActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchAll = (action as modelAction.MedicalRecordInitialChecklistActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchAll.map(model => MedicalRecordInitialChecklistModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalRecordInitialChecklistModelActionTypes.FETCH_MEDICAL_RECORD_INITIAL_CHECKLIST_AUDIT_OK:
				const audits = (action as modelAction.MedicalRecordInitialChecklistActionOK).audits;
				...
				break;
			case modelAction.MedicalRecordInitialChecklistModelActionTypes.FETCH_MEDICAL_RECORD_INITIAL_CHECKLIST_AUDITS_BY_ENTITY_ID_OK:
				const auditsByEntityId = (action as modelAction.MedicalRecordInitialChecklistActionOK).audits;
				...
				break;
			case modelAction.MedicalRecordInitialChecklistModelActionTypes.FETCH_MEDICAL_RECORD_INITIAL_CHECKLIST_WITH_QUERY_OK:
				const totalCountAfterFetchWithQuery = (action as modelAction.MedicalRecordInitialChecklistActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchWithQuery = (action as modelAction.MedicalRecordInitialChecklistActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchWithQuery = (action as modelAction.MedicalRecordInitialChecklistActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchWithQuery = (action as modelAction.MedicalRecordInitialChecklistActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchWithQuery.map(model => MedicalRecordInitialChecklistModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalRecordInitialChecklistModelActionTypes.FETCH_LAST_MEDICAL_RECORD_INITIAL_CHECKLIST_WITH_QUERY_OK:
				const totalCountAfterFetchLastWithQuery = (action as modelAction.MedicalRecordInitialChecklistActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchLastWithQuery = (action as modelAction.MedicalRecordInitialChecklistActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchLastWithQuery = (action as modelAction.MedicalRecordInitialChecklistActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchLastWithQuery = (action as modelAction.MedicalRecordInitialChecklistActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchLastWithQuery.map(model => MedicalRecordInitialChecklistModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalRecordInitialChecklistModelActionTypes.COUNT_MEDICAL_RECORD_INITIAL_CHECKLISTS_OK:
				const totalCountAfterCount = (action as modelAction.MedicalRecordInitialChecklistActionOK).stateConfig.totalCount;
				...
				break;
			case modelAction.MedicalRecordInitialChecklistModelActionTypes.INITIALISE_MEDICAL_RECORD_INITIAL_CHECKLIST_COLLECTION_STATE:
				const collectionIdToInitialise =  (action as modelAction.MedicalRecordInitialChecklistActionOK).stateConfig.collectionId;
				const queryParamsToInitialise = (action as modelAction.MedicalRecordInitialChecklistActionOK).stateConfig.queryParams;
				...
				if (!draft[className].collectionState[collectionIdToInitialise]) {
					draft[className].collectionState[collectionIdToInitialise] = {
						...initialMedicalRecordInitialChecklistCollectionState
					};
				}
