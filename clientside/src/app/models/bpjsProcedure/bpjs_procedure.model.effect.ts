...
import * as modelAction from './bpjs_procedure.model.action';
import {BpjsProcedureService} from '../../services/bpjsProcedure/bpjs_procedure.service';
...
/**
 * Effect class used for side effects related to BPJS Procedure model.
 */
@Injectable()
export class BpjsProcedureEffect {
	...
	constructor(
		...
		protected readonly service: BpjsProcedureService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsProcedureAction>(modelAction.BpjsProcedureModelActionTypes.COUNT_BPJS_PROCEDURES),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsProcedureActionOK(
						modelAction.BpjsProcedureModelActionTypes.COUNT_BPJS_PROCEDURES_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsProcedureActionFail(
								modelAction.BpjsProcedureModelActionTypes.COUNT_BPJS_PROCEDURES_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsProcedureAction>(modelAction.BpjsProcedureModelActionTypes.FETCH_BPJS_PROCEDURE),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsProcedureActionOK(
						modelAction.BpjsProcedureModelActionTypes.FETCH_BPJS_PROCEDURE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsProcedureActionFail(
								modelAction.BpjsProcedureModelActionTypes.FETCH_BPJS_PROCEDURE_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsProcedureAction>(modelAction.BpjsProcedureModelActionTypes.FETCH_ALL_BPJS_PROCEDURE),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsProcedureActionOK(
						modelAction.BpjsProcedureModelActionTypes.FETCH_ALL_BPJS_PROCEDURE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsProcedureActionFail(
								modelAction.BpjsProcedureModelActionTypes.FETCH_ALL_BPJS_PROCEDURE_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsProcedureAction>(modelAction.BpjsProcedureModelActionTypes.FETCH_BPJS_PROCEDURE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsProcedureActionOK(
						modelAction.BpjsProcedureModelActionTypes.FETCH_BPJS_PROCEDURE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsProcedureActionFail(
								modelAction.BpjsProcedureModelActionTypes.FETCH_BPJS_PROCEDURE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsProcedureAction>(modelAction.BpjsProcedureModelActionTypes.FETCH_LAST_BPJS_PROCEDURE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsProcedureActionOK(
						modelAction.BpjsProcedureModelActionTypes.FETCH_LAST_BPJS_PROCEDURE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsProcedureActionFail(
								modelAction.BpjsProcedureModelActionTypes.FETCH_LAST_BPJS_PROCEDURE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsProcedureAction>(modelAction.BpjsProcedureModelActionTypes.CREATE_BPJS_PROCEDURE),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsProcedureModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsProcedureActionOK(
						modelAction.BpjsProcedureModelActionTypes.CREATE_BPJS_PROCEDURE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsProcedureActionFail(
								modelAction.BpjsProcedureModelActionTypes.CREATE_BPJS_PROCEDURE_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsProcedureAction>(modelAction.BpjsProcedureModelActionTypes.CREATE_ALL_BPJS_PROCEDURE),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsProcedureModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsProcedureActionOK(
						modelAction.BpjsProcedureModelActionTypes.CREATE_ALL_BPJS_PROCEDURE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsProcedureActionFail(
								modelAction.BpjsProcedureModelActionTypes.CREATE_ALL_BPJS_PROCEDURE_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsProcedureAction>(modelAction.BpjsProcedureModelActionTypes.UPDATE_BPJS_PROCEDURE),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsProcedureModel;
				...
				return this.service.update(new BpjsProcedureModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsProcedureActionOK(
						modelAction.BpjsProcedureModelActionTypes.UPDATE_BPJS_PROCEDURE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsProcedureActionFail(
								modelAction.BpjsProcedureModelActionTypes.UPDATE_BPJS_PROCEDURE_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsProcedureAction>(modelAction.BpjsProcedureModelActionTypes.UPDATE_ALL_BPJS_PROCEDURE),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsProcedureModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsProcedureModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsProcedureActionOK(
						modelAction.BpjsProcedureModelActionTypes.UPDATE_ALL_BPJS_PROCEDURE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsProcedureActionFail(
								modelAction.BpjsProcedureModelActionTypes.UPDATE_ALL_BPJS_PROCEDURE_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsProcedureAction>(modelAction.BpjsProcedureModelActionTypes.DELETE_BPJS_PROCEDURE),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsProcedureActionOK(
						modelAction.BpjsProcedureModelActionTypes.DELETE_BPJS_PROCEDURE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsProcedureActionFail(
								modelAction.BpjsProcedureModelActionTypes.DELETE_BPJS_PROCEDURE_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsProcedureAction>(modelAction.BpjsProcedureModelActionTypes.DELETE_BPJS_PROCEDURE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsProcedureActionOK(
						modelAction.BpjsProcedureModelActionTypes.DELETE_BPJS_PROCEDURE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsProcedureActionFail(
								modelAction.BpjsProcedureModelActionTypes.DELETE_BPJS_PROCEDURE_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsProcedureAction>(modelAction.BpjsProcedureModelActionTypes.DELETE_ALL_BPJS_PROCEDURE),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsProcedureActionOK(
						modelAction.BpjsProcedureModelActionTypes.DELETE_ALL_BPJS_PROCEDURE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsProcedureActionFail(
								modelAction.BpjsProcedureModelActionTypes.DELETE_ALL_BPJS_PROCEDURE_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsProcedureAction>(modelAction.BpjsProcedureModelActionTypes.EXPORT_BPJS_PROCEDURE),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsProcedureActionOK(
						modelAction.BpjsProcedureModelActionTypes.EXPORT_BPJS_PROCEDURE,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsProcedureAction>(modelAction.BpjsProcedureModelActionTypes.EXPORT_ALL_BPJS_PROCEDURE),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsProcedureActionOK(
						modelAction.BpjsProcedureModelActionTypes.EXPORT_ALL_BPJS_PROCEDURE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsProcedureActionFail(
								modelAction.BpjsProcedureModelActionTypes.EXPORT_ALL_BPJS_PROCEDURE_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsProcedureAction>(modelAction.BpjsProcedureModelActionTypes.EXPORT_BPJS_PROCEDURE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsProcedureActionOK(
						modelAction.BpjsProcedureModelActionTypes.EXPORT_BPJS_PROCEDURE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsProcedureActionFail(
								modelAction.BpjsProcedureModelActionTypes.EXPORT_BPJS_PROCEDURE_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsProcedureAction>(modelAction.BpjsProcedureModelActionTypes.IMPORT_BPJS_PROCEDURES),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsProcedureActionOK(
						modelAction.BpjsProcedureModelActionTypes.IMPORT_BPJS_PROCEDURES_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsProcedureActionFail(
								modelAction.BpjsProcedureModelActionTypes.IMPORT_BPJS_PROCEDURES_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsProcedureAction>(modelAction.BpjsProcedureModelActionTypes.FETCH_BPJS_PROCEDURE_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsProcedureActionOK(
						modelAction.BpjsProcedureModelActionTypes.FETCH_BPJS_PROCEDURE_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsProcedureActionFail(
								modelAction.BpjsProcedureModelActionTypes.FETCH_BPJS_PROCEDURE_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsProcedureAction>(modelAction.BpjsProcedureModelActionTypes.FETCH_BPJS_PROCEDURE_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsProcedureActionOK(
						modelAction.BpjsProcedureModelActionTypes.FETCH_BPJS_PROCEDURE_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsProcedureActionFail(
								modelAction.BpjsProcedureModelActionTypes.FETCH_BPJS_PROCEDURE_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
