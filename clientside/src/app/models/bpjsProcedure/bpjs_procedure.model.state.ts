...
/**
 * BpjsProcedureCollectionState would store the state of a collection of BpjsProcedure
 */
export interface BpjsProcedureCollectionState extends CollectionState {
 ...
 */
export interface BpjsProcedureModelAudit extends AbstractModelAudit<BpjsProcedureModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsProcedureModelState would store the state of the model
 */
export interface BpjsProcedureModelState {
	collectionState: {
		[key: string]: BpjsProcedureCollectionState;
	};
	data: {
		[id: string]: BpjsProcedureModel;
	};
	totalCount: number;
	audits: BpjsProcedureModelAudit[];
 ...
 */
export const initialBpjsProcedureCollectionState: BpjsProcedureCollectionState = {
...
/**
 * The initial state of BpjsProcedureModelState
 */
export const initialState: BpjsProcedureModelState = {
	collectionState: {
