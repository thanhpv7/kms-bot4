...
/**
 * BpjsTreatmentHistoryCollectionState would store the state of a collection of BpjsTreatmentHistory
 */
export interface BpjsTreatmentHistoryCollectionState extends CollectionState {
 ...
 */
export interface BpjsTreatmentHistoryModelAudit extends AbstractModelAudit<BpjsTreatmentHistoryModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsTreatmentHistoryModelState would store the state of the model
 */
export interface BpjsTreatmentHistoryModelState {
	collectionState: {
		[key: string]: BpjsTreatmentHistoryCollectionState;
	};
	data: {
		[id: string]: BpjsTreatmentHistoryModel;
	};
	totalCount: number;
	audits: BpjsTreatmentHistoryModelAudit[];
 ...
 */
export const initialBpjsTreatmentHistoryCollectionState: BpjsTreatmentHistoryCollectionState = {
...
/**
 * The initial state of BpjsTreatmentHistoryModelState
 */
export const initialState: BpjsTreatmentHistoryModelState = {
	collectionState: {
