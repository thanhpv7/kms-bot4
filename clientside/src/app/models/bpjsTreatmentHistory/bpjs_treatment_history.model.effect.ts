...
import * as modelAction from './bpjs_treatment_history.model.action';
import {BpjsTreatmentHistoryService} from '../../services/bpjsTreatmentHistory/bpjs_treatment_history.service';
...
/**
 * Effect class used for side effects related to BPJS Treatment History model.
 */
@Injectable()
export class BpjsTreatmentHistoryEffect {
	...
	constructor(
		...
		protected readonly service: BpjsTreatmentHistoryService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentHistoryAction>(modelAction.BpjsTreatmentHistoryModelActionTypes.COUNT_BPJS_TREATMENT_HISTORYS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsTreatmentHistoryActionOK(
						modelAction.BpjsTreatmentHistoryModelActionTypes.COUNT_BPJS_TREATMENT_HISTORYS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentHistoryActionFail(
								modelAction.BpjsTreatmentHistoryModelActionTypes.COUNT_BPJS_TREATMENT_HISTORYS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentHistoryAction>(modelAction.BpjsTreatmentHistoryModelActionTypes.FETCH_BPJS_TREATMENT_HISTORY),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsTreatmentHistoryActionOK(
						modelAction.BpjsTreatmentHistoryModelActionTypes.FETCH_BPJS_TREATMENT_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentHistoryActionFail(
								modelAction.BpjsTreatmentHistoryModelActionTypes.FETCH_BPJS_TREATMENT_HISTORY_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentHistoryAction>(modelAction.BpjsTreatmentHistoryModelActionTypes.FETCH_ALL_BPJS_TREATMENT_HISTORY),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsTreatmentHistoryActionOK(
						modelAction.BpjsTreatmentHistoryModelActionTypes.FETCH_ALL_BPJS_TREATMENT_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentHistoryActionFail(
								modelAction.BpjsTreatmentHistoryModelActionTypes.FETCH_ALL_BPJS_TREATMENT_HISTORY_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentHistoryAction>(modelAction.BpjsTreatmentHistoryModelActionTypes.FETCH_BPJS_TREATMENT_HISTORY_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsTreatmentHistoryActionOK(
						modelAction.BpjsTreatmentHistoryModelActionTypes.FETCH_BPJS_TREATMENT_HISTORY_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentHistoryActionFail(
								modelAction.BpjsTreatmentHistoryModelActionTypes.FETCH_BPJS_TREATMENT_HISTORY_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentHistoryAction>(modelAction.BpjsTreatmentHistoryModelActionTypes.FETCH_LAST_BPJS_TREATMENT_HISTORY_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsTreatmentHistoryActionOK(
						modelAction.BpjsTreatmentHistoryModelActionTypes.FETCH_LAST_BPJS_TREATMENT_HISTORY_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentHistoryActionFail(
								modelAction.BpjsTreatmentHistoryModelActionTypes.FETCH_LAST_BPJS_TREATMENT_HISTORY_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentHistoryAction>(modelAction.BpjsTreatmentHistoryModelActionTypes.CREATE_BPJS_TREATMENT_HISTORY),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsTreatmentHistoryModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsTreatmentHistoryActionOK(
						modelAction.BpjsTreatmentHistoryModelActionTypes.CREATE_BPJS_TREATMENT_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentHistoryActionFail(
								modelAction.BpjsTreatmentHistoryModelActionTypes.CREATE_BPJS_TREATMENT_HISTORY_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentHistoryAction>(modelAction.BpjsTreatmentHistoryModelActionTypes.CREATE_ALL_BPJS_TREATMENT_HISTORY),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsTreatmentHistoryModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsTreatmentHistoryActionOK(
						modelAction.BpjsTreatmentHistoryModelActionTypes.CREATE_ALL_BPJS_TREATMENT_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentHistoryActionFail(
								modelAction.BpjsTreatmentHistoryModelActionTypes.CREATE_ALL_BPJS_TREATMENT_HISTORY_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentHistoryAction>(modelAction.BpjsTreatmentHistoryModelActionTypes.UPDATE_BPJS_TREATMENT_HISTORY),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsTreatmentHistoryModel;
				...
				return this.service.update(new BpjsTreatmentHistoryModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsTreatmentHistoryActionOK(
						modelAction.BpjsTreatmentHistoryModelActionTypes.UPDATE_BPJS_TREATMENT_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentHistoryActionFail(
								modelAction.BpjsTreatmentHistoryModelActionTypes.UPDATE_BPJS_TREATMENT_HISTORY_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentHistoryAction>(modelAction.BpjsTreatmentHistoryModelActionTypes.UPDATE_ALL_BPJS_TREATMENT_HISTORY),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsTreatmentHistoryModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsTreatmentHistoryModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsTreatmentHistoryActionOK(
						modelAction.BpjsTreatmentHistoryModelActionTypes.UPDATE_ALL_BPJS_TREATMENT_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentHistoryActionFail(
								modelAction.BpjsTreatmentHistoryModelActionTypes.UPDATE_ALL_BPJS_TREATMENT_HISTORY_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentHistoryAction>(modelAction.BpjsTreatmentHistoryModelActionTypes.DELETE_BPJS_TREATMENT_HISTORY),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsTreatmentHistoryActionOK(
						modelAction.BpjsTreatmentHistoryModelActionTypes.DELETE_BPJS_TREATMENT_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentHistoryActionFail(
								modelAction.BpjsTreatmentHistoryModelActionTypes.DELETE_BPJS_TREATMENT_HISTORY_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentHistoryAction>(modelAction.BpjsTreatmentHistoryModelActionTypes.DELETE_BPJS_TREATMENT_HISTORY_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsTreatmentHistoryActionOK(
						modelAction.BpjsTreatmentHistoryModelActionTypes.DELETE_BPJS_TREATMENT_HISTORY_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentHistoryActionFail(
								modelAction.BpjsTreatmentHistoryModelActionTypes.DELETE_BPJS_TREATMENT_HISTORY_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentHistoryAction>(modelAction.BpjsTreatmentHistoryModelActionTypes.DELETE_ALL_BPJS_TREATMENT_HISTORY),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsTreatmentHistoryActionOK(
						modelAction.BpjsTreatmentHistoryModelActionTypes.DELETE_ALL_BPJS_TREATMENT_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentHistoryActionFail(
								modelAction.BpjsTreatmentHistoryModelActionTypes.DELETE_ALL_BPJS_TREATMENT_HISTORY_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentHistoryAction>(modelAction.BpjsTreatmentHistoryModelActionTypes.EXPORT_BPJS_TREATMENT_HISTORY),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsTreatmentHistoryActionOK(
						modelAction.BpjsTreatmentHistoryModelActionTypes.EXPORT_BPJS_TREATMENT_HISTORY,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentHistoryAction>(modelAction.BpjsTreatmentHistoryModelActionTypes.EXPORT_ALL_BPJS_TREATMENT_HISTORY),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsTreatmentHistoryActionOK(
						modelAction.BpjsTreatmentHistoryModelActionTypes.EXPORT_ALL_BPJS_TREATMENT_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentHistoryActionFail(
								modelAction.BpjsTreatmentHistoryModelActionTypes.EXPORT_ALL_BPJS_TREATMENT_HISTORY_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentHistoryAction>(modelAction.BpjsTreatmentHistoryModelActionTypes.EXPORT_BPJS_TREATMENT_HISTORY_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsTreatmentHistoryActionOK(
						modelAction.BpjsTreatmentHistoryModelActionTypes.EXPORT_BPJS_TREATMENT_HISTORY_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentHistoryActionFail(
								modelAction.BpjsTreatmentHistoryModelActionTypes.EXPORT_BPJS_TREATMENT_HISTORY_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentHistoryAction>(modelAction.BpjsTreatmentHistoryModelActionTypes.IMPORT_BPJS_TREATMENT_HISTORYS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsTreatmentHistoryActionOK(
						modelAction.BpjsTreatmentHistoryModelActionTypes.IMPORT_BPJS_TREATMENT_HISTORYS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentHistoryActionFail(
								modelAction.BpjsTreatmentHistoryModelActionTypes.IMPORT_BPJS_TREATMENT_HISTORYS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentHistoryAction>(modelAction.BpjsTreatmentHistoryModelActionTypes.FETCH_BPJS_TREATMENT_HISTORY_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsTreatmentHistoryActionOK(
						modelAction.BpjsTreatmentHistoryModelActionTypes.FETCH_BPJS_TREATMENT_HISTORY_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentHistoryActionFail(
								modelAction.BpjsTreatmentHistoryModelActionTypes.FETCH_BPJS_TREATMENT_HISTORY_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentHistoryAction>(modelAction.BpjsTreatmentHistoryModelActionTypes.FETCH_BPJS_TREATMENT_HISTORY_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsTreatmentHistoryActionOK(
						modelAction.BpjsTreatmentHistoryModelActionTypes.FETCH_BPJS_TREATMENT_HISTORY_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentHistoryActionFail(
								modelAction.BpjsTreatmentHistoryModelActionTypes.FETCH_BPJS_TREATMENT_HISTORY_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
