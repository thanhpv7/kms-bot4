...
import * as modelAction from './cash_allocation.model.action';
import {CashAllocationService} from '../../services/cashAllocation/cash_allocation.service';
...
/**
 * Effect class used for side effects related to Cash Allocation model.
 */
@Injectable()
export class CashAllocationEffect {
	...
	constructor(
		...
		protected readonly service: CashAllocationService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashAllocationAction>(modelAction.CashAllocationModelActionTypes.COUNT_CASH_ALLOCATIONS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.CashAllocationActionOK(
						modelAction.CashAllocationModelActionTypes.COUNT_CASH_ALLOCATIONS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashAllocationActionFail(
								modelAction.CashAllocationModelActionTypes.COUNT_CASH_ALLOCATIONS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashAllocationAction>(modelAction.CashAllocationModelActionTypes.FETCH_CASH_ALLOCATION),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.CashAllocationActionOK(
						modelAction.CashAllocationModelActionTypes.FETCH_CASH_ALLOCATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashAllocationActionFail(
								modelAction.CashAllocationModelActionTypes.FETCH_CASH_ALLOCATION_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashAllocationAction>(modelAction.CashAllocationModelActionTypes.FETCH_ALL_CASH_ALLOCATION),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.CashAllocationActionOK(
						modelAction.CashAllocationModelActionTypes.FETCH_ALL_CASH_ALLOCATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashAllocationActionFail(
								modelAction.CashAllocationModelActionTypes.FETCH_ALL_CASH_ALLOCATION_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashAllocationAction>(modelAction.CashAllocationModelActionTypes.FETCH_CASH_ALLOCATION_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.CashAllocationActionOK(
						modelAction.CashAllocationModelActionTypes.FETCH_CASH_ALLOCATION_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashAllocationActionFail(
								modelAction.CashAllocationModelActionTypes.FETCH_CASH_ALLOCATION_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashAllocationAction>(modelAction.CashAllocationModelActionTypes.FETCH_LAST_CASH_ALLOCATION_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.CashAllocationActionOK(
						modelAction.CashAllocationModelActionTypes.FETCH_LAST_CASH_ALLOCATION_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashAllocationActionFail(
								modelAction.CashAllocationModelActionTypes.FETCH_LAST_CASH_ALLOCATION_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashAllocationAction>(modelAction.CashAllocationModelActionTypes.CREATE_CASH_ALLOCATION),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as CashAllocationModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.CashAllocationActionOK(
						modelAction.CashAllocationModelActionTypes.CREATE_CASH_ALLOCATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashAllocationActionFail(
								modelAction.CashAllocationModelActionTypes.CREATE_CASH_ALLOCATION_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashAllocationAction>(modelAction.CashAllocationModelActionTypes.CREATE_ALL_CASH_ALLOCATION),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as CashAllocationModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.CashAllocationActionOK(
						modelAction.CashAllocationModelActionTypes.CREATE_ALL_CASH_ALLOCATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashAllocationActionFail(
								modelAction.CashAllocationModelActionTypes.CREATE_ALL_CASH_ALLOCATION_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashAllocationAction>(modelAction.CashAllocationModelActionTypes.UPDATE_CASH_ALLOCATION),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as CashAllocationModel;
				...
				return this.service.update(new CashAllocationModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.CashAllocationActionOK(
						modelAction.CashAllocationModelActionTypes.UPDATE_CASH_ALLOCATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashAllocationActionFail(
								modelAction.CashAllocationModelActionTypes.UPDATE_CASH_ALLOCATION_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashAllocationAction>(modelAction.CashAllocationModelActionTypes.UPDATE_ALL_CASH_ALLOCATION),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as CashAllocationModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new CashAllocationModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.CashAllocationActionOK(
						modelAction.CashAllocationModelActionTypes.UPDATE_ALL_CASH_ALLOCATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashAllocationActionFail(
								modelAction.CashAllocationModelActionTypes.UPDATE_ALL_CASH_ALLOCATION_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashAllocationAction>(modelAction.CashAllocationModelActionTypes.DELETE_CASH_ALLOCATION),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.CashAllocationActionOK(
						modelAction.CashAllocationModelActionTypes.DELETE_CASH_ALLOCATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashAllocationActionFail(
								modelAction.CashAllocationModelActionTypes.DELETE_CASH_ALLOCATION_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashAllocationAction>(modelAction.CashAllocationModelActionTypes.DELETE_CASH_ALLOCATION_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.CashAllocationActionOK(
						modelAction.CashAllocationModelActionTypes.DELETE_CASH_ALLOCATION_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashAllocationActionFail(
								modelAction.CashAllocationModelActionTypes.DELETE_CASH_ALLOCATION_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashAllocationAction>(modelAction.CashAllocationModelActionTypes.DELETE_ALL_CASH_ALLOCATION),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.CashAllocationActionOK(
						modelAction.CashAllocationModelActionTypes.DELETE_ALL_CASH_ALLOCATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashAllocationActionFail(
								modelAction.CashAllocationModelActionTypes.DELETE_ALL_CASH_ALLOCATION_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashAllocationAction>(modelAction.CashAllocationModelActionTypes.EXPORT_CASH_ALLOCATION),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.CashAllocationActionOK(
						modelAction.CashAllocationModelActionTypes.EXPORT_CASH_ALLOCATION,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashAllocationAction>(modelAction.CashAllocationModelActionTypes.EXPORT_ALL_CASH_ALLOCATION),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.CashAllocationActionOK(
						modelAction.CashAllocationModelActionTypes.EXPORT_ALL_CASH_ALLOCATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashAllocationActionFail(
								modelAction.CashAllocationModelActionTypes.EXPORT_ALL_CASH_ALLOCATION_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashAllocationAction>(modelAction.CashAllocationModelActionTypes.EXPORT_CASH_ALLOCATION_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.CashAllocationActionOK(
						modelAction.CashAllocationModelActionTypes.EXPORT_CASH_ALLOCATION_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashAllocationActionFail(
								modelAction.CashAllocationModelActionTypes.EXPORT_CASH_ALLOCATION_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashAllocationAction>(modelAction.CashAllocationModelActionTypes.IMPORT_CASH_ALLOCATIONS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.CashAllocationActionOK(
						modelAction.CashAllocationModelActionTypes.IMPORT_CASH_ALLOCATIONS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashAllocationActionFail(
								modelAction.CashAllocationModelActionTypes.IMPORT_CASH_ALLOCATIONS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashAllocationAction>(modelAction.CashAllocationModelActionTypes.FETCH_CASH_ALLOCATION_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.CashAllocationActionOK(
						modelAction.CashAllocationModelActionTypes.FETCH_CASH_ALLOCATION_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.CashAllocationActionFail(
								modelAction.CashAllocationModelActionTypes.FETCH_CASH_ALLOCATION_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashAllocationAction>(modelAction.CashAllocationModelActionTypes.FETCH_CASH_ALLOCATION_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.CashAllocationActionOK(
						modelAction.CashAllocationModelActionTypes.FETCH_CASH_ALLOCATION_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.CashAllocationActionFail(
								modelAction.CashAllocationModelActionTypes.FETCH_CASH_ALLOCATION_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
