...
/**
 * CashAllocationCollectionState would store the state of a collection of CashAllocation
 */
export interface CashAllocationCollectionState extends CollectionState {
 ...
 */
export interface CashAllocationModelAudit extends AbstractModelAudit<CashAllocationModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * CashAllocationModelState would store the state of the model
 */
export interface CashAllocationModelState {
	collectionState: {
		[key: string]: CashAllocationCollectionState;
	};
	data: {
		[id: string]: CashAllocationModel;
	};
	totalCount: number;
	audits: CashAllocationModelAudit[];
 ...
 */
export const initialCashAllocationCollectionState: CashAllocationCollectionState = {
...
/**
 * The initial state of CashAllocationModelState
 */
export const initialState: CashAllocationModelState = {
	collectionState: {
