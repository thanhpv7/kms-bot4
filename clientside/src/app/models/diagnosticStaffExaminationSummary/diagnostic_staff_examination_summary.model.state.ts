...
/**
 * DiagnosticStaffExaminationSummaryCollectionState would store the state of a collection of DiagnosticStaffExaminationSummary
 */
export interface DiagnosticStaffExaminationSummaryCollectionState extends CollectionState {
 ...
 */
export interface DiagnosticStaffExaminationSummaryModelAudit extends AbstractModelAudit<DiagnosticStaffExaminationSummaryModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * DiagnosticStaffExaminationSummaryModelState would store the state of the model
 */
export interface DiagnosticStaffExaminationSummaryModelState {
	collectionState: {
		[key: string]: DiagnosticStaffExaminationSummaryCollectionState;
	};
	data: {
		[id: string]: DiagnosticStaffExaminationSummaryModel;
	};
	totalCount: number;
	audits: DiagnosticStaffExaminationSummaryModelAudit[];
 ...
 */
export const initialDiagnosticStaffExaminationSummaryCollectionState: DiagnosticStaffExaminationSummaryCollectionState = {
...
/**
 * The initial state of DiagnosticStaffExaminationSummaryModelState
 */
export const initialState: DiagnosticStaffExaminationSummaryModelState = {
	collectionState: {
