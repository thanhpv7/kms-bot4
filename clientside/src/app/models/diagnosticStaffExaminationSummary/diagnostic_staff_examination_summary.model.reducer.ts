...
import {initialDiagnosticStaffExaminationSummaryCollectionState} from './diagnostic_staff_examination_summary.model.state';
...
export function modelReducer(currentState: ModelState, action: Action): ModelState {
	...
	const className = (action as modelAction.BaseDiagnosticStaffExaminationSummaryAction).className;
	...
	return produce(currentState, draft => {
		...
		switch (action.type) {
			case modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.CREATE_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_OK:
				const createdModel = (action as modelAction.DiagnosticStaffExaminationSummaryActionOK ).stateConfig.targetModel;
				...
				DiagnosticStaffExaminationSummaryModel.deepParse(createdModel).forEach(model => {
				...
				break;
			case modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.CREATE_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.CREATE_ALL_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_OK:
				const createdModels = (action as modelAction.DiagnosticStaffExaminationSummaryActionOK).stateConfig.targetModels;
				const collectionIdAfterCreateAll = (action as modelAction.DiagnosticStaffExaminationSummaryActionOK).stateConfig.collectionId;
				...
				createdModels.forEach((m) => {
					DiagnosticStaffExaminationSummaryModel.deepParse(m).forEach(model => {
						draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
						(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
					});
				});
				...
				break;
			case modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.CREATE_ALL_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.DELETE_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_OK:
				const deletedModelId = (action as modelAction.DiagnosticStaffExaminationSummaryActionOK).stateConfig.targetModelId;
				const collectionIdAfterDelete = (action as modelAction.DiagnosticStaffExaminationSummaryActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.DELETE_ALL_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_OK:
				const deletedModelIds = (action as modelAction.DiagnosticStaffExaminationSummaryActionOK).stateConfig.targetModelIds;
				const collectionIdAfterDeleteAll = (action as modelAction.DiagnosticStaffExaminationSummaryActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.DELETE_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.UPDATE_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_OK:
				const updatedModel = (action as modelAction.DiagnosticStaffExaminationSummaryActionOK).stateConfig.targetModel;
				...
				DiagnosticStaffExaminationSummaryModel.deepParse(updatedModel).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.UPDATE_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_FAIL:
				// TODO: Add handling of failure
				break;

			case modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.UPDATE_ALL_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_OK:
				const updatedModels = (action as modelAction.DiagnosticStaffExaminationSummaryActionOK).stateConfig.targetModels;
				const collectionIdAfterUpdateAll = (action as modelAction.DiagnosticStaffExaminationSummaryActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.UPDATE_ALL_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.FETCH_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_OK:
				let fetchedModel = (action as modelAction.DiagnosticStaffExaminationSummaryActionOK).stateConfig.targetModel;
				...
				DiagnosticStaffExaminationSummaryModel.deepParse(fetchedModel).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.FETCH_ALL_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_OK:
				const totalCountAfterFetchAll = (action as modelAction.DiagnosticStaffExaminationSummaryActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchAll = (action as modelAction.DiagnosticStaffExaminationSummaryActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchAll = (action as modelAction.DiagnosticStaffExaminationSummaryActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchAll = (action as modelAction.DiagnosticStaffExaminationSummaryActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchAll.map(model => DiagnosticStaffExaminationSummaryModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.FETCH_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_AUDIT_OK:
				const audits = (action as modelAction.DiagnosticStaffExaminationSummaryActionOK).audits;
				...
				break;
			case modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.FETCH_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_AUDITS_BY_ENTITY_ID_OK:
				const auditsByEntityId = (action as modelAction.DiagnosticStaffExaminationSummaryActionOK).audits;
				...
				break;
			case modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.FETCH_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_WITH_QUERY_OK:
				const totalCountAfterFetchWithQuery = (action as modelAction.DiagnosticStaffExaminationSummaryActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchWithQuery = (action as modelAction.DiagnosticStaffExaminationSummaryActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchWithQuery = (action as modelAction.DiagnosticStaffExaminationSummaryActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchWithQuery = (action as modelAction.DiagnosticStaffExaminationSummaryActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchWithQuery.map(model => DiagnosticStaffExaminationSummaryModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.FETCH_LAST_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_WITH_QUERY_OK:
				const totalCountAfterFetchLastWithQuery = (action as modelAction.DiagnosticStaffExaminationSummaryActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchLastWithQuery = (action as modelAction.DiagnosticStaffExaminationSummaryActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchLastWithQuery = (action as modelAction.DiagnosticStaffExaminationSummaryActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchLastWithQuery = (action as modelAction.DiagnosticStaffExaminationSummaryActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchLastWithQuery.map(model => DiagnosticStaffExaminationSummaryModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.COUNT_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARYS_OK:
				const totalCountAfterCount = (action as modelAction.DiagnosticStaffExaminationSummaryActionOK).stateConfig.totalCount;
				...
				break;
			case modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.INITIALISE_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_COLLECTION_STATE:
				const collectionIdToInitialise =  (action as modelAction.DiagnosticStaffExaminationSummaryActionOK).stateConfig.collectionId;
				const queryParamsToInitialise = (action as modelAction.DiagnosticStaffExaminationSummaryActionOK).stateConfig.queryParams;
				...
				if (!draft[className].collectionState[collectionIdToInitialise]) {
					draft[className].collectionState[collectionIdToInitialise] = {
						...initialDiagnosticStaffExaminationSummaryCollectionState
					};
				}
