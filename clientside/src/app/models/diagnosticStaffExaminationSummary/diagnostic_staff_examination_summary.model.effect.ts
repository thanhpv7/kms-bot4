...
import * as modelAction from './diagnostic_staff_examination_summary.model.action';
import {DiagnosticStaffExaminationSummaryService} from '../../services/diagnosticStaffExaminationSummary/diagnostic_staff_examination_summary.service';
...
/**
 * Effect class used for side effects related to Diagnostic Staff Examination Summary model.
 */
@Injectable()
export class DiagnosticStaffExaminationSummaryEffect {
	...
	constructor(
		...
		protected readonly service: DiagnosticStaffExaminationSummaryService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticStaffExaminationSummaryAction>(modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.COUNT_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARYS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.DiagnosticStaffExaminationSummaryActionOK(
						modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.COUNT_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARYS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticStaffExaminationSummaryActionFail(
								modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.COUNT_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARYS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticStaffExaminationSummaryAction>(modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.FETCH_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticStaffExaminationSummaryActionOK(
						modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.FETCH_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticStaffExaminationSummaryActionFail(
								modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.FETCH_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticStaffExaminationSummaryAction>(modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.FETCH_ALL_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.DiagnosticStaffExaminationSummaryActionOK(
						modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.FETCH_ALL_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticStaffExaminationSummaryActionFail(
								modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.FETCH_ALL_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticStaffExaminationSummaryAction>(modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.FETCH_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticStaffExaminationSummaryActionOK(
						modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.FETCH_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticStaffExaminationSummaryActionFail(
								modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.FETCH_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticStaffExaminationSummaryAction>(modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.FETCH_LAST_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticStaffExaminationSummaryActionOK(
						modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.FETCH_LAST_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticStaffExaminationSummaryActionFail(
								modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.FETCH_LAST_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticStaffExaminationSummaryAction>(modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.CREATE_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as DiagnosticStaffExaminationSummaryModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticStaffExaminationSummaryActionOK(
						modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.CREATE_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticStaffExaminationSummaryActionFail(
								modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.CREATE_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticStaffExaminationSummaryAction>(modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.CREATE_ALL_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as DiagnosticStaffExaminationSummaryModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticStaffExaminationSummaryActionOK(
						modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.CREATE_ALL_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticStaffExaminationSummaryActionFail(
								modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.CREATE_ALL_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticStaffExaminationSummaryAction>(modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.UPDATE_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as DiagnosticStaffExaminationSummaryModel;
				...
				return this.service.update(new DiagnosticStaffExaminationSummaryModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticStaffExaminationSummaryActionOK(
						modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.UPDATE_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticStaffExaminationSummaryActionFail(
								modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.UPDATE_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticStaffExaminationSummaryAction>(modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.UPDATE_ALL_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as DiagnosticStaffExaminationSummaryModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new DiagnosticStaffExaminationSummaryModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticStaffExaminationSummaryActionOK(
						modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.UPDATE_ALL_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticStaffExaminationSummaryActionFail(
								modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.UPDATE_ALL_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticStaffExaminationSummaryAction>(modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.DELETE_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticStaffExaminationSummaryActionOK(
						modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.DELETE_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticStaffExaminationSummaryActionFail(
								modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.DELETE_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticStaffExaminationSummaryAction>(modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.DELETE_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticStaffExaminationSummaryActionOK(
						modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.DELETE_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticStaffExaminationSummaryActionFail(
								modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.DELETE_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticStaffExaminationSummaryAction>(modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.DELETE_ALL_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticStaffExaminationSummaryActionOK(
						modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.DELETE_ALL_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticStaffExaminationSummaryActionFail(
								modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.DELETE_ALL_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticStaffExaminationSummaryAction>(modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.EXPORT_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticStaffExaminationSummaryActionOK(
						modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.EXPORT_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticStaffExaminationSummaryAction>(modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.EXPORT_ALL_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticStaffExaminationSummaryActionOK(
						modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.EXPORT_ALL_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticStaffExaminationSummaryActionFail(
								modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.EXPORT_ALL_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticStaffExaminationSummaryAction>(modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.EXPORT_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticStaffExaminationSummaryActionOK(
						modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.EXPORT_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticStaffExaminationSummaryActionFail(
								modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.EXPORT_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticStaffExaminationSummaryAction>(modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.IMPORT_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARYS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticStaffExaminationSummaryActionOK(
						modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.IMPORT_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARYS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticStaffExaminationSummaryActionFail(
								modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.IMPORT_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARYS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticStaffExaminationSummaryAction>(modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.FETCH_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.DiagnosticStaffExaminationSummaryActionOK(
						modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.FETCH_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticStaffExaminationSummaryActionFail(
								modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.FETCH_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticStaffExaminationSummaryAction>(modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.FETCH_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.DiagnosticStaffExaminationSummaryActionOK(
						modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.FETCH_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticStaffExaminationSummaryActionFail(
								modelAction.DiagnosticStaffExaminationSummaryModelActionTypes.FETCH_DIAGNOSTIC_STAFF_EXAMINATION_SUMMARY_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
