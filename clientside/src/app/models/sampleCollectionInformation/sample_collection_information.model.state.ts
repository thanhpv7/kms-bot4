...
/**
 * SampleCollectionInformationCollectionState would store the state of a collection of SampleCollectionInformation
 */
export interface SampleCollectionInformationCollectionState extends CollectionState {
 ...
 */
export interface SampleCollectionInformationModelAudit extends AbstractModelAudit<SampleCollectionInformationModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * SampleCollectionInformationModelState would store the state of the model
 */
export interface SampleCollectionInformationModelState {
	collectionState: {
		[key: string]: SampleCollectionInformationCollectionState;
	};
	data: {
		[id: string]: SampleCollectionInformationModel;
	};
	totalCount: number;
	audits: SampleCollectionInformationModelAudit[];
 ...
 */
export const initialSampleCollectionInformationCollectionState: SampleCollectionInformationCollectionState = {
...
/**
 * The initial state of SampleCollectionInformationModelState
 */
export const initialState: SampleCollectionInformationModelState = {
	collectionState: {
