...
import * as modelAction from './sample_collection_information.model.action';
import {SampleCollectionInformationService} from '../../services/sampleCollectionInformation/sample_collection_information.service';
...
/**
 * Effect class used for side effects related to Sample Collection Information model.
 */
@Injectable()
export class SampleCollectionInformationEffect {
	...
	constructor(
		...
		protected readonly service: SampleCollectionInformationService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SampleCollectionInformationAction>(modelAction.SampleCollectionInformationModelActionTypes.COUNT_SAMPLE_COLLECTION_INFORMATIONS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.SampleCollectionInformationActionOK(
						modelAction.SampleCollectionInformationModelActionTypes.COUNT_SAMPLE_COLLECTION_INFORMATIONS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SampleCollectionInformationActionFail(
								modelAction.SampleCollectionInformationModelActionTypes.COUNT_SAMPLE_COLLECTION_INFORMATIONS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SampleCollectionInformationAction>(modelAction.SampleCollectionInformationModelActionTypes.FETCH_SAMPLE_COLLECTION_INFORMATION),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.SampleCollectionInformationActionOK(
						modelAction.SampleCollectionInformationModelActionTypes.FETCH_SAMPLE_COLLECTION_INFORMATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SampleCollectionInformationActionFail(
								modelAction.SampleCollectionInformationModelActionTypes.FETCH_SAMPLE_COLLECTION_INFORMATION_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SampleCollectionInformationAction>(modelAction.SampleCollectionInformationModelActionTypes.FETCH_ALL_SAMPLE_COLLECTION_INFORMATION),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.SampleCollectionInformationActionOK(
						modelAction.SampleCollectionInformationModelActionTypes.FETCH_ALL_SAMPLE_COLLECTION_INFORMATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SampleCollectionInformationActionFail(
								modelAction.SampleCollectionInformationModelActionTypes.FETCH_ALL_SAMPLE_COLLECTION_INFORMATION_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SampleCollectionInformationAction>(modelAction.SampleCollectionInformationModelActionTypes.FETCH_SAMPLE_COLLECTION_INFORMATION_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.SampleCollectionInformationActionOK(
						modelAction.SampleCollectionInformationModelActionTypes.FETCH_SAMPLE_COLLECTION_INFORMATION_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SampleCollectionInformationActionFail(
								modelAction.SampleCollectionInformationModelActionTypes.FETCH_SAMPLE_COLLECTION_INFORMATION_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SampleCollectionInformationAction>(modelAction.SampleCollectionInformationModelActionTypes.FETCH_LAST_SAMPLE_COLLECTION_INFORMATION_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.SampleCollectionInformationActionOK(
						modelAction.SampleCollectionInformationModelActionTypes.FETCH_LAST_SAMPLE_COLLECTION_INFORMATION_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SampleCollectionInformationActionFail(
								modelAction.SampleCollectionInformationModelActionTypes.FETCH_LAST_SAMPLE_COLLECTION_INFORMATION_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SampleCollectionInformationAction>(modelAction.SampleCollectionInformationModelActionTypes.CREATE_SAMPLE_COLLECTION_INFORMATION),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as SampleCollectionInformationModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.SampleCollectionInformationActionOK(
						modelAction.SampleCollectionInformationModelActionTypes.CREATE_SAMPLE_COLLECTION_INFORMATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SampleCollectionInformationActionFail(
								modelAction.SampleCollectionInformationModelActionTypes.CREATE_SAMPLE_COLLECTION_INFORMATION_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SampleCollectionInformationAction>(modelAction.SampleCollectionInformationModelActionTypes.CREATE_ALL_SAMPLE_COLLECTION_INFORMATION),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as SampleCollectionInformationModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.SampleCollectionInformationActionOK(
						modelAction.SampleCollectionInformationModelActionTypes.CREATE_ALL_SAMPLE_COLLECTION_INFORMATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SampleCollectionInformationActionFail(
								modelAction.SampleCollectionInformationModelActionTypes.CREATE_ALL_SAMPLE_COLLECTION_INFORMATION_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SampleCollectionInformationAction>(modelAction.SampleCollectionInformationModelActionTypes.UPDATE_SAMPLE_COLLECTION_INFORMATION),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as SampleCollectionInformationModel;
				...
				return this.service.update(new SampleCollectionInformationModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.SampleCollectionInformationActionOK(
						modelAction.SampleCollectionInformationModelActionTypes.UPDATE_SAMPLE_COLLECTION_INFORMATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SampleCollectionInformationActionFail(
								modelAction.SampleCollectionInformationModelActionTypes.UPDATE_SAMPLE_COLLECTION_INFORMATION_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SampleCollectionInformationAction>(modelAction.SampleCollectionInformationModelActionTypes.UPDATE_ALL_SAMPLE_COLLECTION_INFORMATION),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as SampleCollectionInformationModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new SampleCollectionInformationModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.SampleCollectionInformationActionOK(
						modelAction.SampleCollectionInformationModelActionTypes.UPDATE_ALL_SAMPLE_COLLECTION_INFORMATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SampleCollectionInformationActionFail(
								modelAction.SampleCollectionInformationModelActionTypes.UPDATE_ALL_SAMPLE_COLLECTION_INFORMATION_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SampleCollectionInformationAction>(modelAction.SampleCollectionInformationModelActionTypes.DELETE_SAMPLE_COLLECTION_INFORMATION),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.SampleCollectionInformationActionOK(
						modelAction.SampleCollectionInformationModelActionTypes.DELETE_SAMPLE_COLLECTION_INFORMATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SampleCollectionInformationActionFail(
								modelAction.SampleCollectionInformationModelActionTypes.DELETE_SAMPLE_COLLECTION_INFORMATION_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SampleCollectionInformationAction>(modelAction.SampleCollectionInformationModelActionTypes.DELETE_SAMPLE_COLLECTION_INFORMATION_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.SampleCollectionInformationActionOK(
						modelAction.SampleCollectionInformationModelActionTypes.DELETE_SAMPLE_COLLECTION_INFORMATION_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SampleCollectionInformationActionFail(
								modelAction.SampleCollectionInformationModelActionTypes.DELETE_SAMPLE_COLLECTION_INFORMATION_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SampleCollectionInformationAction>(modelAction.SampleCollectionInformationModelActionTypes.DELETE_ALL_SAMPLE_COLLECTION_INFORMATION),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.SampleCollectionInformationActionOK(
						modelAction.SampleCollectionInformationModelActionTypes.DELETE_ALL_SAMPLE_COLLECTION_INFORMATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SampleCollectionInformationActionFail(
								modelAction.SampleCollectionInformationModelActionTypes.DELETE_ALL_SAMPLE_COLLECTION_INFORMATION_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SampleCollectionInformationAction>(modelAction.SampleCollectionInformationModelActionTypes.EXPORT_SAMPLE_COLLECTION_INFORMATION),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.SampleCollectionInformationActionOK(
						modelAction.SampleCollectionInformationModelActionTypes.EXPORT_SAMPLE_COLLECTION_INFORMATION,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SampleCollectionInformationAction>(modelAction.SampleCollectionInformationModelActionTypes.EXPORT_ALL_SAMPLE_COLLECTION_INFORMATION),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.SampleCollectionInformationActionOK(
						modelAction.SampleCollectionInformationModelActionTypes.EXPORT_ALL_SAMPLE_COLLECTION_INFORMATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SampleCollectionInformationActionFail(
								modelAction.SampleCollectionInformationModelActionTypes.EXPORT_ALL_SAMPLE_COLLECTION_INFORMATION_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SampleCollectionInformationAction>(modelAction.SampleCollectionInformationModelActionTypes.EXPORT_SAMPLE_COLLECTION_INFORMATION_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.SampleCollectionInformationActionOK(
						modelAction.SampleCollectionInformationModelActionTypes.EXPORT_SAMPLE_COLLECTION_INFORMATION_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SampleCollectionInformationActionFail(
								modelAction.SampleCollectionInformationModelActionTypes.EXPORT_SAMPLE_COLLECTION_INFORMATION_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SampleCollectionInformationAction>(modelAction.SampleCollectionInformationModelActionTypes.IMPORT_SAMPLE_COLLECTION_INFORMATIONS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.SampleCollectionInformationActionOK(
						modelAction.SampleCollectionInformationModelActionTypes.IMPORT_SAMPLE_COLLECTION_INFORMATIONS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SampleCollectionInformationActionFail(
								modelAction.SampleCollectionInformationModelActionTypes.IMPORT_SAMPLE_COLLECTION_INFORMATIONS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SampleCollectionInformationAction>(modelAction.SampleCollectionInformationModelActionTypes.FETCH_SAMPLE_COLLECTION_INFORMATION_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.SampleCollectionInformationActionOK(
						modelAction.SampleCollectionInformationModelActionTypes.FETCH_SAMPLE_COLLECTION_INFORMATION_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.SampleCollectionInformationActionFail(
								modelAction.SampleCollectionInformationModelActionTypes.FETCH_SAMPLE_COLLECTION_INFORMATION_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SampleCollectionInformationAction>(modelAction.SampleCollectionInformationModelActionTypes.FETCH_SAMPLE_COLLECTION_INFORMATION_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.SampleCollectionInformationActionOK(
						modelAction.SampleCollectionInformationModelActionTypes.FETCH_SAMPLE_COLLECTION_INFORMATION_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.SampleCollectionInformationActionFail(
								modelAction.SampleCollectionInformationModelActionTypes.FETCH_SAMPLE_COLLECTION_INFORMATION_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
