...
import {ExaminationItemDetailService} from '../../services/examinationItemDetail/examination_item_detail.service';
...
/**
 * Effect class used for side effects related to Examination Item Detail model.
 */
@Injectable()
export class ExaminationItemDetailEffect {
	...
	constructor(
		...
		protected readonly service: ExaminationItemDetailService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationItemDetailAction>(modelAction.ExaminationItemDetailModelActionTypes.COUNT_EXAMINATION_ITEM_DETAILS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.ExaminationItemDetailActionOK(
						modelAction.ExaminationItemDetailModelActionTypes.COUNT_EXAMINATION_ITEM_DETAILS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationItemDetailActionFail(
								modelAction.ExaminationItemDetailModelActionTypes.COUNT_EXAMINATION_ITEM_DETAILS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationItemDetailAction>(modelAction.ExaminationItemDetailModelActionTypes.FETCH_EXAMINATION_ITEM_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ExaminationItemDetailActionOK(
						modelAction.ExaminationItemDetailModelActionTypes.FETCH_EXAMINATION_ITEM_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationItemDetailActionFail(
								modelAction.ExaminationItemDetailModelActionTypes.FETCH_EXAMINATION_ITEM_DETAIL_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationItemDetailAction>(modelAction.ExaminationItemDetailModelActionTypes.FETCH_ALL_EXAMINATION_ITEM_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.ExaminationItemDetailActionOK(
						modelAction.ExaminationItemDetailModelActionTypes.FETCH_ALL_EXAMINATION_ITEM_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationItemDetailActionFail(
								modelAction.ExaminationItemDetailModelActionTypes.FETCH_ALL_EXAMINATION_ITEM_DETAIL_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationItemDetailAction>(modelAction.ExaminationItemDetailModelActionTypes.FETCH_EXAMINATION_ITEM_DETAIL_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.ExaminationItemDetailActionOK(
						modelAction.ExaminationItemDetailModelActionTypes.FETCH_EXAMINATION_ITEM_DETAIL_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationItemDetailActionFail(
								modelAction.ExaminationItemDetailModelActionTypes.FETCH_EXAMINATION_ITEM_DETAIL_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationItemDetailAction>(modelAction.ExaminationItemDetailModelActionTypes.FETCH_LAST_EXAMINATION_ITEM_DETAIL_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.ExaminationItemDetailActionOK(
						modelAction.ExaminationItemDetailModelActionTypes.FETCH_LAST_EXAMINATION_ITEM_DETAIL_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationItemDetailActionFail(
								modelAction.ExaminationItemDetailModelActionTypes.FETCH_LAST_EXAMINATION_ITEM_DETAIL_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationItemDetailAction>(modelAction.ExaminationItemDetailModelActionTypes.CREATE_EXAMINATION_ITEM_DETAIL),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as ExaminationItemDetailModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ExaminationItemDetailActionOK(
						modelAction.ExaminationItemDetailModelActionTypes.CREATE_EXAMINATION_ITEM_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationItemDetailActionFail(
								modelAction.ExaminationItemDetailModelActionTypes.CREATE_EXAMINATION_ITEM_DETAIL_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationItemDetailAction>(modelAction.ExaminationItemDetailModelActionTypes.CREATE_ALL_EXAMINATION_ITEM_DETAIL),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as ExaminationItemDetailModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ExaminationItemDetailActionOK(
						modelAction.ExaminationItemDetailModelActionTypes.CREATE_ALL_EXAMINATION_ITEM_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationItemDetailActionFail(
								modelAction.ExaminationItemDetailModelActionTypes.CREATE_ALL_EXAMINATION_ITEM_DETAIL_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationItemDetailAction>(modelAction.ExaminationItemDetailModelActionTypes.UPDATE_EXAMINATION_ITEM_DETAIL),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as ExaminationItemDetailModel;
				...
				return this.service.update(new ExaminationItemDetailModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.ExaminationItemDetailActionOK(
						modelAction.ExaminationItemDetailModelActionTypes.UPDATE_EXAMINATION_ITEM_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationItemDetailActionFail(
								modelAction.ExaminationItemDetailModelActionTypes.UPDATE_EXAMINATION_ITEM_DETAIL_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationItemDetailAction>(modelAction.ExaminationItemDetailModelActionTypes.UPDATE_ALL_EXAMINATION_ITEM_DETAIL),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as ExaminationItemDetailModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new ExaminationItemDetailModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ExaminationItemDetailActionOK(
						modelAction.ExaminationItemDetailModelActionTypes.UPDATE_ALL_EXAMINATION_ITEM_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationItemDetailActionFail(
								modelAction.ExaminationItemDetailModelActionTypes.UPDATE_ALL_EXAMINATION_ITEM_DETAIL_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationItemDetailAction>(modelAction.ExaminationItemDetailModelActionTypes.DELETE_EXAMINATION_ITEM_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.ExaminationItemDetailActionOK(
						modelAction.ExaminationItemDetailModelActionTypes.DELETE_EXAMINATION_ITEM_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationItemDetailActionFail(
								modelAction.ExaminationItemDetailModelActionTypes.DELETE_EXAMINATION_ITEM_DETAIL_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationItemDetailAction>(modelAction.ExaminationItemDetailModelActionTypes.DELETE_EXAMINATION_ITEM_DETAIL_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.ExaminationItemDetailActionOK(
						modelAction.ExaminationItemDetailModelActionTypes.DELETE_EXAMINATION_ITEM_DETAIL_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationItemDetailActionFail(
								modelAction.ExaminationItemDetailModelActionTypes.DELETE_EXAMINATION_ITEM_DETAIL_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationItemDetailAction>(modelAction.ExaminationItemDetailModelActionTypes.DELETE_ALL_EXAMINATION_ITEM_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.ExaminationItemDetailActionOK(
						modelAction.ExaminationItemDetailModelActionTypes.DELETE_ALL_EXAMINATION_ITEM_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationItemDetailActionFail(
								modelAction.ExaminationItemDetailModelActionTypes.DELETE_ALL_EXAMINATION_ITEM_DETAIL_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationItemDetailAction>(modelAction.ExaminationItemDetailModelActionTypes.EXPORT_EXAMINATION_ITEM_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ExaminationItemDetailActionOK(
						modelAction.ExaminationItemDetailModelActionTypes.EXPORT_EXAMINATION_ITEM_DETAIL,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationItemDetailAction>(modelAction.ExaminationItemDetailModelActionTypes.EXPORT_ALL_EXAMINATION_ITEM_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ExaminationItemDetailActionOK(
						modelAction.ExaminationItemDetailModelActionTypes.EXPORT_ALL_EXAMINATION_ITEM_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationItemDetailActionFail(
								modelAction.ExaminationItemDetailModelActionTypes.EXPORT_ALL_EXAMINATION_ITEM_DETAIL_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationItemDetailAction>(modelAction.ExaminationItemDetailModelActionTypes.EXPORT_EXAMINATION_ITEM_DETAIL_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ExaminationItemDetailActionOK(
						modelAction.ExaminationItemDetailModelActionTypes.EXPORT_EXAMINATION_ITEM_DETAIL_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationItemDetailActionFail(
								modelAction.ExaminationItemDetailModelActionTypes.EXPORT_EXAMINATION_ITEM_DETAIL_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationItemDetailAction>(modelAction.ExaminationItemDetailModelActionTypes.IMPORT_EXAMINATION_ITEM_DETAILS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.ExaminationItemDetailActionOK(
						modelAction.ExaminationItemDetailModelActionTypes.IMPORT_EXAMINATION_ITEM_DETAILS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationItemDetailActionFail(
								modelAction.ExaminationItemDetailModelActionTypes.IMPORT_EXAMINATION_ITEM_DETAILS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationItemDetailAction>(modelAction.ExaminationItemDetailModelActionTypes.FETCH_EXAMINATION_ITEM_DETAIL_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.ExaminationItemDetailActionOK(
						modelAction.ExaminationItemDetailModelActionTypes.FETCH_EXAMINATION_ITEM_DETAIL_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationItemDetailActionFail(
								modelAction.ExaminationItemDetailModelActionTypes.FETCH_EXAMINATION_ITEM_DETAIL_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationItemDetailAction>(modelAction.ExaminationItemDetailModelActionTypes.FETCH_EXAMINATION_ITEM_DETAIL_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.ExaminationItemDetailActionOK(
						modelAction.ExaminationItemDetailModelActionTypes.FETCH_EXAMINATION_ITEM_DETAIL_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationItemDetailActionFail(
								modelAction.ExaminationItemDetailModelActionTypes.FETCH_EXAMINATION_ITEM_DETAIL_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
