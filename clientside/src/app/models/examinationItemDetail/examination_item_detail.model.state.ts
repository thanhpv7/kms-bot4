...
/**
 * ExaminationItemDetailCollectionState would store the state of a collection of ExaminationItemDetail
 */
export interface ExaminationItemDetailCollectionState extends CollectionState {
 ...
 */
export interface ExaminationItemDetailModelAudit extends AbstractModelAudit<ExaminationItemDetailModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * ExaminationItemDetailModelState would store the state of the model
 */
export interface ExaminationItemDetailModelState {
	collectionState: {
		[key: string]: ExaminationItemDetailCollectionState;
	};
	data: {
		[id: string]: ExaminationItemDetailModel;
	};
	totalCount: number;
	audits: ExaminationItemDetailModelAudit[];
 ...
 */
export const initialExaminationItemDetailCollectionState: ExaminationItemDetailCollectionState = {
...
/**
 * The initial state of ExaminationItemDetailModelState
 */
export const initialState: ExaminationItemDetailModelState = {
	collectionState: {
