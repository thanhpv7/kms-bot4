...
import {initialMedicalCertificateRestrictedWorkCollectionState} from './medical_certificate_restricted_work.model.state';
...
export function modelReducer(currentState: ModelState, action: Action): ModelState {
	...
	const className = (action as modelAction.BaseMedicalCertificateRestrictedWorkAction).className;
	...
	return produce(currentState, draft => {
		...
		switch (action.type) {
			case modelAction.MedicalCertificateRestrictedWorkModelActionTypes.CREATE_MEDICAL_CERTIFICATE_RESTRICTED_WORK_OK:
				const createdModel = (action as modelAction.MedicalCertificateRestrictedWorkActionOK ).stateConfig.targetModel;
				...
				MedicalCertificateRestrictedWorkModel.deepParse(createdModel).forEach(model => {
				...
				break;
			case modelAction.MedicalCertificateRestrictedWorkModelActionTypes.CREATE_MEDICAL_CERTIFICATE_RESTRICTED_WORK_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.MedicalCertificateRestrictedWorkModelActionTypes.CREATE_ALL_MEDICAL_CERTIFICATE_RESTRICTED_WORK_OK:
				const createdModels = (action as modelAction.MedicalCertificateRestrictedWorkActionOK).stateConfig.targetModels;
				const collectionIdAfterCreateAll = (action as modelAction.MedicalCertificateRestrictedWorkActionOK).stateConfig.collectionId;
				...
				createdModels.forEach((m) => {
					MedicalCertificateRestrictedWorkModel.deepParse(m).forEach(model => {
						draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
						(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
					});
				});
				...
				break;
			case modelAction.MedicalCertificateRestrictedWorkModelActionTypes.CREATE_ALL_MEDICAL_CERTIFICATE_RESTRICTED_WORK_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.MedicalCertificateRestrictedWorkModelActionTypes.DELETE_MEDICAL_CERTIFICATE_RESTRICTED_WORK_OK:
				const deletedModelId = (action as modelAction.MedicalCertificateRestrictedWorkActionOK).stateConfig.targetModelId;
				const collectionIdAfterDelete = (action as modelAction.MedicalCertificateRestrictedWorkActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.MedicalCertificateRestrictedWorkModelActionTypes.DELETE_ALL_MEDICAL_CERTIFICATE_RESTRICTED_WORK_OK:
				const deletedModelIds = (action as modelAction.MedicalCertificateRestrictedWorkActionOK).stateConfig.targetModelIds;
				const collectionIdAfterDeleteAll = (action as modelAction.MedicalCertificateRestrictedWorkActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.MedicalCertificateRestrictedWorkModelActionTypes.DELETE_MEDICAL_CERTIFICATE_RESTRICTED_WORK_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.MedicalCertificateRestrictedWorkModelActionTypes.UPDATE_MEDICAL_CERTIFICATE_RESTRICTED_WORK_OK:
				const updatedModel = (action as modelAction.MedicalCertificateRestrictedWorkActionOK).stateConfig.targetModel;
				...
				MedicalCertificateRestrictedWorkModel.deepParse(updatedModel).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalCertificateRestrictedWorkModelActionTypes.UPDATE_MEDICAL_CERTIFICATE_RESTRICTED_WORK_FAIL:
				// TODO: Add handling of failure
				break;

			case modelAction.MedicalCertificateRestrictedWorkModelActionTypes.UPDATE_ALL_MEDICAL_CERTIFICATE_RESTRICTED_WORK_OK:
				const updatedModels = (action as modelAction.MedicalCertificateRestrictedWorkActionOK).stateConfig.targetModels;
				const collectionIdAfterUpdateAll = (action as modelAction.MedicalCertificateRestrictedWorkActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.MedicalCertificateRestrictedWorkModelActionTypes.UPDATE_ALL_MEDICAL_CERTIFICATE_RESTRICTED_WORK_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.MedicalCertificateRestrictedWorkModelActionTypes.FETCH_MEDICAL_CERTIFICATE_RESTRICTED_WORK_OK:
				let fetchedModel = (action as modelAction.MedicalCertificateRestrictedWorkActionOK).stateConfig.targetModel;
				...
				MedicalCertificateRestrictedWorkModel.deepParse(fetchedModel).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalCertificateRestrictedWorkModelActionTypes.FETCH_ALL_MEDICAL_CERTIFICATE_RESTRICTED_WORK_OK:
				const totalCountAfterFetchAll = (action as modelAction.MedicalCertificateRestrictedWorkActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchAll = (action as modelAction.MedicalCertificateRestrictedWorkActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchAll = (action as modelAction.MedicalCertificateRestrictedWorkActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchAll = (action as modelAction.MedicalCertificateRestrictedWorkActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchAll.map(model => MedicalCertificateRestrictedWorkModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalCertificateRestrictedWorkModelActionTypes.FETCH_MEDICAL_CERTIFICATE_RESTRICTED_WORK_AUDIT_OK:
				const audits = (action as modelAction.MedicalCertificateRestrictedWorkActionOK).audits;
				...
				break;
			case modelAction.MedicalCertificateRestrictedWorkModelActionTypes.FETCH_MEDICAL_CERTIFICATE_RESTRICTED_WORK_AUDITS_BY_ENTITY_ID_OK:
				const auditsByEntityId = (action as modelAction.MedicalCertificateRestrictedWorkActionOK).audits;
				...
				break;
			case modelAction.MedicalCertificateRestrictedWorkModelActionTypes.FETCH_MEDICAL_CERTIFICATE_RESTRICTED_WORK_WITH_QUERY_OK:
				const totalCountAfterFetchWithQuery = (action as modelAction.MedicalCertificateRestrictedWorkActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchWithQuery = (action as modelAction.MedicalCertificateRestrictedWorkActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchWithQuery = (action as modelAction.MedicalCertificateRestrictedWorkActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchWithQuery = (action as modelAction.MedicalCertificateRestrictedWorkActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchWithQuery.map(model => MedicalCertificateRestrictedWorkModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalCertificateRestrictedWorkModelActionTypes.FETCH_LAST_MEDICAL_CERTIFICATE_RESTRICTED_WORK_WITH_QUERY_OK:
				const totalCountAfterFetchLastWithQuery = (action as modelAction.MedicalCertificateRestrictedWorkActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchLastWithQuery = (action as modelAction.MedicalCertificateRestrictedWorkActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchLastWithQuery = (action as modelAction.MedicalCertificateRestrictedWorkActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchLastWithQuery = (action as modelAction.MedicalCertificateRestrictedWorkActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchLastWithQuery.map(model => MedicalCertificateRestrictedWorkModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalCertificateRestrictedWorkModelActionTypes.COUNT_MEDICAL_CERTIFICATE_RESTRICTED_WORKS_OK:
				const totalCountAfterCount = (action as modelAction.MedicalCertificateRestrictedWorkActionOK).stateConfig.totalCount;
				...
				break;
			case modelAction.MedicalCertificateRestrictedWorkModelActionTypes.INITIALISE_MEDICAL_CERTIFICATE_RESTRICTED_WORK_COLLECTION_STATE:
				const collectionIdToInitialise =  (action as modelAction.MedicalCertificateRestrictedWorkActionOK).stateConfig.collectionId;
				const queryParamsToInitialise = (action as modelAction.MedicalCertificateRestrictedWorkActionOK).stateConfig.queryParams;
				...
				if (!draft[className].collectionState[collectionIdToInitialise]) {
					draft[className].collectionState[collectionIdToInitialise] = {
						...initialMedicalCertificateRestrictedWorkCollectionState
					};
				}
