...
/**
 * MedicalCertificateRestrictedWorkCollectionState would store the state of a collection of MedicalCertificateRestrictedWork
 */
export interface MedicalCertificateRestrictedWorkCollectionState extends CollectionState {
 ...
 */
export interface MedicalCertificateRestrictedWorkModelAudit extends AbstractModelAudit<MedicalCertificateRestrictedWorkModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * MedicalCertificateRestrictedWorkModelState would store the state of the model
 */
export interface MedicalCertificateRestrictedWorkModelState {
	collectionState: {
		[key: string]: MedicalCertificateRestrictedWorkCollectionState;
	};
	data: {
		[id: string]: MedicalCertificateRestrictedWorkModel;
	};
	totalCount: number;
	audits: MedicalCertificateRestrictedWorkModelAudit[];
 ...
 */
export const initialMedicalCertificateRestrictedWorkCollectionState: MedicalCertificateRestrictedWorkCollectionState = {
...
/**
 * The initial state of MedicalCertificateRestrictedWorkModelState
 */
export const initialState: MedicalCertificateRestrictedWorkModelState = {
	collectionState: {
