...
import * as modelAction from './medical_certificate_restricted_work.model.action';
import {MedicalCertificateRestrictedWorkService} from '../../services/medicalCertificateRestrictedWork/medical_certificate_restricted_work.service';
...
/**
 * Effect class used for side effects related to Medical Certificate Restricted Work model.
 */
@Injectable()
export class MedicalCertificateRestrictedWorkEffect {
	...
	constructor(
		...
		protected readonly service: MedicalCertificateRestrictedWorkService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateRestrictedWorkAction>(modelAction.MedicalCertificateRestrictedWorkModelActionTypes.COUNT_MEDICAL_CERTIFICATE_RESTRICTED_WORKS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateRestrictedWorkActionOK(
						modelAction.MedicalCertificateRestrictedWorkModelActionTypes.COUNT_MEDICAL_CERTIFICATE_RESTRICTED_WORKS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateRestrictedWorkActionFail(
								modelAction.MedicalCertificateRestrictedWorkModelActionTypes.COUNT_MEDICAL_CERTIFICATE_RESTRICTED_WORKS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateRestrictedWorkAction>(modelAction.MedicalCertificateRestrictedWorkModelActionTypes.FETCH_MEDICAL_CERTIFICATE_RESTRICTED_WORK),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateRestrictedWorkActionOK(
						modelAction.MedicalCertificateRestrictedWorkModelActionTypes.FETCH_MEDICAL_CERTIFICATE_RESTRICTED_WORK_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateRestrictedWorkActionFail(
								modelAction.MedicalCertificateRestrictedWorkModelActionTypes.FETCH_MEDICAL_CERTIFICATE_RESTRICTED_WORK_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateRestrictedWorkAction>(modelAction.MedicalCertificateRestrictedWorkModelActionTypes.FETCH_ALL_MEDICAL_CERTIFICATE_RESTRICTED_WORK),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateRestrictedWorkActionOK(
						modelAction.MedicalCertificateRestrictedWorkModelActionTypes.FETCH_ALL_MEDICAL_CERTIFICATE_RESTRICTED_WORK_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateRestrictedWorkActionFail(
								modelAction.MedicalCertificateRestrictedWorkModelActionTypes.FETCH_ALL_MEDICAL_CERTIFICATE_RESTRICTED_WORK_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateRestrictedWorkAction>(modelAction.MedicalCertificateRestrictedWorkModelActionTypes.FETCH_MEDICAL_CERTIFICATE_RESTRICTED_WORK_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateRestrictedWorkActionOK(
						modelAction.MedicalCertificateRestrictedWorkModelActionTypes.FETCH_MEDICAL_CERTIFICATE_RESTRICTED_WORK_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateRestrictedWorkActionFail(
								modelAction.MedicalCertificateRestrictedWorkModelActionTypes.FETCH_MEDICAL_CERTIFICATE_RESTRICTED_WORK_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateRestrictedWorkAction>(modelAction.MedicalCertificateRestrictedWorkModelActionTypes.FETCH_LAST_MEDICAL_CERTIFICATE_RESTRICTED_WORK_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateRestrictedWorkActionOK(
						modelAction.MedicalCertificateRestrictedWorkModelActionTypes.FETCH_LAST_MEDICAL_CERTIFICATE_RESTRICTED_WORK_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateRestrictedWorkActionFail(
								modelAction.MedicalCertificateRestrictedWorkModelActionTypes.FETCH_LAST_MEDICAL_CERTIFICATE_RESTRICTED_WORK_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateRestrictedWorkAction>(modelAction.MedicalCertificateRestrictedWorkModelActionTypes.CREATE_MEDICAL_CERTIFICATE_RESTRICTED_WORK),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as MedicalCertificateRestrictedWorkModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateRestrictedWorkActionOK(
						modelAction.MedicalCertificateRestrictedWorkModelActionTypes.CREATE_MEDICAL_CERTIFICATE_RESTRICTED_WORK_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateRestrictedWorkActionFail(
								modelAction.MedicalCertificateRestrictedWorkModelActionTypes.CREATE_MEDICAL_CERTIFICATE_RESTRICTED_WORK_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateRestrictedWorkAction>(modelAction.MedicalCertificateRestrictedWorkModelActionTypes.CREATE_ALL_MEDICAL_CERTIFICATE_RESTRICTED_WORK),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as MedicalCertificateRestrictedWorkModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateRestrictedWorkActionOK(
						modelAction.MedicalCertificateRestrictedWorkModelActionTypes.CREATE_ALL_MEDICAL_CERTIFICATE_RESTRICTED_WORK_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateRestrictedWorkActionFail(
								modelAction.MedicalCertificateRestrictedWorkModelActionTypes.CREATE_ALL_MEDICAL_CERTIFICATE_RESTRICTED_WORK_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateRestrictedWorkAction>(modelAction.MedicalCertificateRestrictedWorkModelActionTypes.UPDATE_MEDICAL_CERTIFICATE_RESTRICTED_WORK),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as MedicalCertificateRestrictedWorkModel;
				...
				return this.service.update(new MedicalCertificateRestrictedWorkModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateRestrictedWorkActionOK(
						modelAction.MedicalCertificateRestrictedWorkModelActionTypes.UPDATE_MEDICAL_CERTIFICATE_RESTRICTED_WORK_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateRestrictedWorkActionFail(
								modelAction.MedicalCertificateRestrictedWorkModelActionTypes.UPDATE_MEDICAL_CERTIFICATE_RESTRICTED_WORK_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateRestrictedWorkAction>(modelAction.MedicalCertificateRestrictedWorkModelActionTypes.UPDATE_ALL_MEDICAL_CERTIFICATE_RESTRICTED_WORK),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as MedicalCertificateRestrictedWorkModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new MedicalCertificateRestrictedWorkModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateRestrictedWorkActionOK(
						modelAction.MedicalCertificateRestrictedWorkModelActionTypes.UPDATE_ALL_MEDICAL_CERTIFICATE_RESTRICTED_WORK_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateRestrictedWorkActionFail(
								modelAction.MedicalCertificateRestrictedWorkModelActionTypes.UPDATE_ALL_MEDICAL_CERTIFICATE_RESTRICTED_WORK_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateRestrictedWorkAction>(modelAction.MedicalCertificateRestrictedWorkModelActionTypes.DELETE_MEDICAL_CERTIFICATE_RESTRICTED_WORK),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateRestrictedWorkActionOK(
						modelAction.MedicalCertificateRestrictedWorkModelActionTypes.DELETE_MEDICAL_CERTIFICATE_RESTRICTED_WORK_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateRestrictedWorkActionFail(
								modelAction.MedicalCertificateRestrictedWorkModelActionTypes.DELETE_MEDICAL_CERTIFICATE_RESTRICTED_WORK_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateRestrictedWorkAction>(modelAction.MedicalCertificateRestrictedWorkModelActionTypes.DELETE_MEDICAL_CERTIFICATE_RESTRICTED_WORK_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateRestrictedWorkActionOK(
						modelAction.MedicalCertificateRestrictedWorkModelActionTypes.DELETE_MEDICAL_CERTIFICATE_RESTRICTED_WORK_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateRestrictedWorkActionFail(
								modelAction.MedicalCertificateRestrictedWorkModelActionTypes.DELETE_MEDICAL_CERTIFICATE_RESTRICTED_WORK_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateRestrictedWorkAction>(modelAction.MedicalCertificateRestrictedWorkModelActionTypes.DELETE_ALL_MEDICAL_CERTIFICATE_RESTRICTED_WORK),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateRestrictedWorkActionOK(
						modelAction.MedicalCertificateRestrictedWorkModelActionTypes.DELETE_ALL_MEDICAL_CERTIFICATE_RESTRICTED_WORK_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateRestrictedWorkActionFail(
								modelAction.MedicalCertificateRestrictedWorkModelActionTypes.DELETE_ALL_MEDICAL_CERTIFICATE_RESTRICTED_WORK_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateRestrictedWorkAction>(modelAction.MedicalCertificateRestrictedWorkModelActionTypes.EXPORT_MEDICAL_CERTIFICATE_RESTRICTED_WORK),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateRestrictedWorkActionOK(
						modelAction.MedicalCertificateRestrictedWorkModelActionTypes.EXPORT_MEDICAL_CERTIFICATE_RESTRICTED_WORK,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateRestrictedWorkAction>(modelAction.MedicalCertificateRestrictedWorkModelActionTypes.EXPORT_ALL_MEDICAL_CERTIFICATE_RESTRICTED_WORK),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateRestrictedWorkActionOK(
						modelAction.MedicalCertificateRestrictedWorkModelActionTypes.EXPORT_ALL_MEDICAL_CERTIFICATE_RESTRICTED_WORK_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateRestrictedWorkActionFail(
								modelAction.MedicalCertificateRestrictedWorkModelActionTypes.EXPORT_ALL_MEDICAL_CERTIFICATE_RESTRICTED_WORK_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateRestrictedWorkAction>(modelAction.MedicalCertificateRestrictedWorkModelActionTypes.EXPORT_MEDICAL_CERTIFICATE_RESTRICTED_WORK_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateRestrictedWorkActionOK(
						modelAction.MedicalCertificateRestrictedWorkModelActionTypes.EXPORT_MEDICAL_CERTIFICATE_RESTRICTED_WORK_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateRestrictedWorkActionFail(
								modelAction.MedicalCertificateRestrictedWorkModelActionTypes.EXPORT_MEDICAL_CERTIFICATE_RESTRICTED_WORK_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateRestrictedWorkAction>(modelAction.MedicalCertificateRestrictedWorkModelActionTypes.IMPORT_MEDICAL_CERTIFICATE_RESTRICTED_WORKS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateRestrictedWorkActionOK(
						modelAction.MedicalCertificateRestrictedWorkModelActionTypes.IMPORT_MEDICAL_CERTIFICATE_RESTRICTED_WORKS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateRestrictedWorkActionFail(
								modelAction.MedicalCertificateRestrictedWorkModelActionTypes.IMPORT_MEDICAL_CERTIFICATE_RESTRICTED_WORKS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateRestrictedWorkAction>(modelAction.MedicalCertificateRestrictedWorkModelActionTypes.FETCH_MEDICAL_CERTIFICATE_RESTRICTED_WORK_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.MedicalCertificateRestrictedWorkActionOK(
						modelAction.MedicalCertificateRestrictedWorkModelActionTypes.FETCH_MEDICAL_CERTIFICATE_RESTRICTED_WORK_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateRestrictedWorkActionFail(
								modelAction.MedicalCertificateRestrictedWorkModelActionTypes.FETCH_MEDICAL_CERTIFICATE_RESTRICTED_WORK_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateRestrictedWorkAction>(modelAction.MedicalCertificateRestrictedWorkModelActionTypes.FETCH_MEDICAL_CERTIFICATE_RESTRICTED_WORK_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.MedicalCertificateRestrictedWorkActionOK(
						modelAction.MedicalCertificateRestrictedWorkModelActionTypes.FETCH_MEDICAL_CERTIFICATE_RESTRICTED_WORK_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateRestrictedWorkActionFail(
								modelAction.MedicalCertificateRestrictedWorkModelActionTypes.FETCH_MEDICAL_CERTIFICATE_RESTRICTED_WORK_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
