...
import * as modelAction from './batch_stock_transaction_detail.model.action';
import {BatchStockTransactionDetailService} from '../../services/batchStockTransactionDetail/batch_stock_transaction_detail.service';
...
/**
 * Effect class used for side effects related to Batch Stock Transaction Detail model.
 */
@Injectable()
export class BatchStockTransactionDetailEffect {
	...
	constructor(
		...
		protected readonly service: BatchStockTransactionDetailService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockTransactionDetailAction>(modelAction.BatchStockTransactionDetailModelActionTypes.COUNT_BATCH_STOCK_TRANSACTION_DETAILS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BatchStockTransactionDetailActionOK(
						modelAction.BatchStockTransactionDetailModelActionTypes.COUNT_BATCH_STOCK_TRANSACTION_DETAILS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockTransactionDetailActionFail(
								modelAction.BatchStockTransactionDetailModelActionTypes.COUNT_BATCH_STOCK_TRANSACTION_DETAILS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockTransactionDetailAction>(modelAction.BatchStockTransactionDetailModelActionTypes.FETCH_BATCH_STOCK_TRANSACTION_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BatchStockTransactionDetailActionOK(
						modelAction.BatchStockTransactionDetailModelActionTypes.FETCH_BATCH_STOCK_TRANSACTION_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockTransactionDetailActionFail(
								modelAction.BatchStockTransactionDetailModelActionTypes.FETCH_BATCH_STOCK_TRANSACTION_DETAIL_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockTransactionDetailAction>(modelAction.BatchStockTransactionDetailModelActionTypes.FETCH_ALL_BATCH_STOCK_TRANSACTION_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BatchStockTransactionDetailActionOK(
						modelAction.BatchStockTransactionDetailModelActionTypes.FETCH_ALL_BATCH_STOCK_TRANSACTION_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockTransactionDetailActionFail(
								modelAction.BatchStockTransactionDetailModelActionTypes.FETCH_ALL_BATCH_STOCK_TRANSACTION_DETAIL_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockTransactionDetailAction>(modelAction.BatchStockTransactionDetailModelActionTypes.FETCH_BATCH_STOCK_TRANSACTION_DETAIL_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BatchStockTransactionDetailActionOK(
						modelAction.BatchStockTransactionDetailModelActionTypes.FETCH_BATCH_STOCK_TRANSACTION_DETAIL_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockTransactionDetailActionFail(
								modelAction.BatchStockTransactionDetailModelActionTypes.FETCH_BATCH_STOCK_TRANSACTION_DETAIL_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockTransactionDetailAction>(modelAction.BatchStockTransactionDetailModelActionTypes.FETCH_LAST_BATCH_STOCK_TRANSACTION_DETAIL_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BatchStockTransactionDetailActionOK(
						modelAction.BatchStockTransactionDetailModelActionTypes.FETCH_LAST_BATCH_STOCK_TRANSACTION_DETAIL_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockTransactionDetailActionFail(
								modelAction.BatchStockTransactionDetailModelActionTypes.FETCH_LAST_BATCH_STOCK_TRANSACTION_DETAIL_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockTransactionDetailAction>(modelAction.BatchStockTransactionDetailModelActionTypes.CREATE_BATCH_STOCK_TRANSACTION_DETAIL),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BatchStockTransactionDetailModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BatchStockTransactionDetailActionOK(
						modelAction.BatchStockTransactionDetailModelActionTypes.CREATE_BATCH_STOCK_TRANSACTION_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockTransactionDetailActionFail(
								modelAction.BatchStockTransactionDetailModelActionTypes.CREATE_BATCH_STOCK_TRANSACTION_DETAIL_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockTransactionDetailAction>(modelAction.BatchStockTransactionDetailModelActionTypes.CREATE_ALL_BATCH_STOCK_TRANSACTION_DETAIL),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BatchStockTransactionDetailModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BatchStockTransactionDetailActionOK(
						modelAction.BatchStockTransactionDetailModelActionTypes.CREATE_ALL_BATCH_STOCK_TRANSACTION_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockTransactionDetailActionFail(
								modelAction.BatchStockTransactionDetailModelActionTypes.CREATE_ALL_BATCH_STOCK_TRANSACTION_DETAIL_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockTransactionDetailAction>(modelAction.BatchStockTransactionDetailModelActionTypes.UPDATE_BATCH_STOCK_TRANSACTION_DETAIL),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BatchStockTransactionDetailModel;
				...
				return this.service.update(new BatchStockTransactionDetailModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BatchStockTransactionDetailActionOK(
						modelAction.BatchStockTransactionDetailModelActionTypes.UPDATE_BATCH_STOCK_TRANSACTION_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockTransactionDetailActionFail(
								modelAction.BatchStockTransactionDetailModelActionTypes.UPDATE_BATCH_STOCK_TRANSACTION_DETAIL_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockTransactionDetailAction>(modelAction.BatchStockTransactionDetailModelActionTypes.UPDATE_ALL_BATCH_STOCK_TRANSACTION_DETAIL),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BatchStockTransactionDetailModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BatchStockTransactionDetailModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BatchStockTransactionDetailActionOK(
						modelAction.BatchStockTransactionDetailModelActionTypes.UPDATE_ALL_BATCH_STOCK_TRANSACTION_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockTransactionDetailActionFail(
								modelAction.BatchStockTransactionDetailModelActionTypes.UPDATE_ALL_BATCH_STOCK_TRANSACTION_DETAIL_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockTransactionDetailAction>(modelAction.BatchStockTransactionDetailModelActionTypes.DELETE_BATCH_STOCK_TRANSACTION_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BatchStockTransactionDetailActionOK(
						modelAction.BatchStockTransactionDetailModelActionTypes.DELETE_BATCH_STOCK_TRANSACTION_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockTransactionDetailActionFail(
								modelAction.BatchStockTransactionDetailModelActionTypes.DELETE_BATCH_STOCK_TRANSACTION_DETAIL_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockTransactionDetailAction>(modelAction.BatchStockTransactionDetailModelActionTypes.DELETE_BATCH_STOCK_TRANSACTION_DETAIL_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BatchStockTransactionDetailActionOK(
						modelAction.BatchStockTransactionDetailModelActionTypes.DELETE_BATCH_STOCK_TRANSACTION_DETAIL_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockTransactionDetailActionFail(
								modelAction.BatchStockTransactionDetailModelActionTypes.DELETE_BATCH_STOCK_TRANSACTION_DETAIL_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockTransactionDetailAction>(modelAction.BatchStockTransactionDetailModelActionTypes.DELETE_ALL_BATCH_STOCK_TRANSACTION_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BatchStockTransactionDetailActionOK(
						modelAction.BatchStockTransactionDetailModelActionTypes.DELETE_ALL_BATCH_STOCK_TRANSACTION_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockTransactionDetailActionFail(
								modelAction.BatchStockTransactionDetailModelActionTypes.DELETE_ALL_BATCH_STOCK_TRANSACTION_DETAIL_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockTransactionDetailAction>(modelAction.BatchStockTransactionDetailModelActionTypes.EXPORT_BATCH_STOCK_TRANSACTION_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BatchStockTransactionDetailActionOK(
						modelAction.BatchStockTransactionDetailModelActionTypes.EXPORT_BATCH_STOCK_TRANSACTION_DETAIL,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockTransactionDetailAction>(modelAction.BatchStockTransactionDetailModelActionTypes.EXPORT_ALL_BATCH_STOCK_TRANSACTION_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BatchStockTransactionDetailActionOK(
						modelAction.BatchStockTransactionDetailModelActionTypes.EXPORT_ALL_BATCH_STOCK_TRANSACTION_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockTransactionDetailActionFail(
								modelAction.BatchStockTransactionDetailModelActionTypes.EXPORT_ALL_BATCH_STOCK_TRANSACTION_DETAIL_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockTransactionDetailAction>(modelAction.BatchStockTransactionDetailModelActionTypes.EXPORT_BATCH_STOCK_TRANSACTION_DETAIL_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BatchStockTransactionDetailActionOK(
						modelAction.BatchStockTransactionDetailModelActionTypes.EXPORT_BATCH_STOCK_TRANSACTION_DETAIL_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockTransactionDetailActionFail(
								modelAction.BatchStockTransactionDetailModelActionTypes.EXPORT_BATCH_STOCK_TRANSACTION_DETAIL_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockTransactionDetailAction>(modelAction.BatchStockTransactionDetailModelActionTypes.IMPORT_BATCH_STOCK_TRANSACTION_DETAILS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BatchStockTransactionDetailActionOK(
						modelAction.BatchStockTransactionDetailModelActionTypes.IMPORT_BATCH_STOCK_TRANSACTION_DETAILS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockTransactionDetailActionFail(
								modelAction.BatchStockTransactionDetailModelActionTypes.IMPORT_BATCH_STOCK_TRANSACTION_DETAILS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockTransactionDetailAction>(modelAction.BatchStockTransactionDetailModelActionTypes.FETCH_BATCH_STOCK_TRANSACTION_DETAIL_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BatchStockTransactionDetailActionOK(
						modelAction.BatchStockTransactionDetailModelActionTypes.FETCH_BATCH_STOCK_TRANSACTION_DETAIL_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockTransactionDetailActionFail(
								modelAction.BatchStockTransactionDetailModelActionTypes.FETCH_BATCH_STOCK_TRANSACTION_DETAIL_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockTransactionDetailAction>(modelAction.BatchStockTransactionDetailModelActionTypes.FETCH_BATCH_STOCK_TRANSACTION_DETAIL_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BatchStockTransactionDetailActionOK(
						modelAction.BatchStockTransactionDetailModelActionTypes.FETCH_BATCH_STOCK_TRANSACTION_DETAIL_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockTransactionDetailActionFail(
								modelAction.BatchStockTransactionDetailModelActionTypes.FETCH_BATCH_STOCK_TRANSACTION_DETAIL_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
