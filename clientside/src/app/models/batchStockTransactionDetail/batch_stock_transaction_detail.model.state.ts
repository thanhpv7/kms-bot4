...
/**
 * BatchStockTransactionDetailCollectionState would store the state of a collection of BatchStockTransactionDetail
 */
export interface BatchStockTransactionDetailCollectionState extends CollectionState {
 ...
 */
export interface BatchStockTransactionDetailModelAudit extends AbstractModelAudit<BatchStockTransactionDetailModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BatchStockTransactionDetailModelState would store the state of the model
 */
export interface BatchStockTransactionDetailModelState {
	collectionState: {
		[key: string]: BatchStockTransactionDetailCollectionState;
	};
	data: {
		[id: string]: BatchStockTransactionDetailModel;
	};
	totalCount: number;
	audits: BatchStockTransactionDetailModelAudit[];
 ...
 */
export const initialBatchStockTransactionDetailCollectionState: BatchStockTransactionDetailCollectionState = {
...
/**
 * The initial state of BatchStockTransactionDetailModelState
 */
export const initialState: BatchStockTransactionDetailModelState = {
	collectionState: {
