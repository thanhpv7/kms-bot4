...
/**
 * BpjsUpdateDismissalDateCollectionState would store the state of a collection of BpjsUpdateDismissalDate
 */
export interface BpjsUpdateDismissalDateCollectionState extends CollectionState {
 ...
 */
export interface BpjsUpdateDismissalDateModelAudit extends AbstractModelAudit<BpjsUpdateDismissalDateModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsUpdateDismissalDateModelState would store the state of the model
 */
export interface BpjsUpdateDismissalDateModelState {
	collectionState: {
		[key: string]: BpjsUpdateDismissalDateCollectionState;
	};
	data: {
		[id: string]: BpjsUpdateDismissalDateModel;
	};
	totalCount: number;
	audits: BpjsUpdateDismissalDateModelAudit[];
 ...
 */
export const initialBpjsUpdateDismissalDateCollectionState: BpjsUpdateDismissalDateCollectionState = {
...
/**
 * The initial state of BpjsUpdateDismissalDateModelState
 */
export const initialState: BpjsUpdateDismissalDateModelState = {
	collectionState: {
