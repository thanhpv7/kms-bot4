...
import * as modelAction from './bpjs_update_dismissal_date.model.action';
import {BpjsUpdateDismissalDateService} from '../../services/bpjsUpdateDismissalDate/bpjs_update_dismissal_date.service';
...
/**
 * Effect class used for side effects related to BPJS Update Dismissal Date model.
 */
@Injectable()
export class BpjsUpdateDismissalDateEffect {
	...
	constructor(
		...
		protected readonly service: BpjsUpdateDismissalDateService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsUpdateDismissalDateAction>(modelAction.BpjsUpdateDismissalDateModelActionTypes.COUNT_BPJS_UPDATE_DISMISSAL_DATES),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsUpdateDismissalDateActionOK(
						modelAction.BpjsUpdateDismissalDateModelActionTypes.COUNT_BPJS_UPDATE_DISMISSAL_DATES_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsUpdateDismissalDateActionFail(
								modelAction.BpjsUpdateDismissalDateModelActionTypes.COUNT_BPJS_UPDATE_DISMISSAL_DATES_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsUpdateDismissalDateAction>(modelAction.BpjsUpdateDismissalDateModelActionTypes.FETCH_BPJS_UPDATE_DISMISSAL_DATE),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsUpdateDismissalDateActionOK(
						modelAction.BpjsUpdateDismissalDateModelActionTypes.FETCH_BPJS_UPDATE_DISMISSAL_DATE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsUpdateDismissalDateActionFail(
								modelAction.BpjsUpdateDismissalDateModelActionTypes.FETCH_BPJS_UPDATE_DISMISSAL_DATE_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsUpdateDismissalDateAction>(modelAction.BpjsUpdateDismissalDateModelActionTypes.FETCH_ALL_BPJS_UPDATE_DISMISSAL_DATE),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsUpdateDismissalDateActionOK(
						modelAction.BpjsUpdateDismissalDateModelActionTypes.FETCH_ALL_BPJS_UPDATE_DISMISSAL_DATE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsUpdateDismissalDateActionFail(
								modelAction.BpjsUpdateDismissalDateModelActionTypes.FETCH_ALL_BPJS_UPDATE_DISMISSAL_DATE_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsUpdateDismissalDateAction>(modelAction.BpjsUpdateDismissalDateModelActionTypes.FETCH_BPJS_UPDATE_DISMISSAL_DATE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsUpdateDismissalDateActionOK(
						modelAction.BpjsUpdateDismissalDateModelActionTypes.FETCH_BPJS_UPDATE_DISMISSAL_DATE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsUpdateDismissalDateActionFail(
								modelAction.BpjsUpdateDismissalDateModelActionTypes.FETCH_BPJS_UPDATE_DISMISSAL_DATE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsUpdateDismissalDateAction>(modelAction.BpjsUpdateDismissalDateModelActionTypes.FETCH_LAST_BPJS_UPDATE_DISMISSAL_DATE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsUpdateDismissalDateActionOK(
						modelAction.BpjsUpdateDismissalDateModelActionTypes.FETCH_LAST_BPJS_UPDATE_DISMISSAL_DATE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsUpdateDismissalDateActionFail(
								modelAction.BpjsUpdateDismissalDateModelActionTypes.FETCH_LAST_BPJS_UPDATE_DISMISSAL_DATE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsUpdateDismissalDateAction>(modelAction.BpjsUpdateDismissalDateModelActionTypes.CREATE_BPJS_UPDATE_DISMISSAL_DATE),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsUpdateDismissalDateModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsUpdateDismissalDateActionOK(
						modelAction.BpjsUpdateDismissalDateModelActionTypes.CREATE_BPJS_UPDATE_DISMISSAL_DATE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsUpdateDismissalDateActionFail(
								modelAction.BpjsUpdateDismissalDateModelActionTypes.CREATE_BPJS_UPDATE_DISMISSAL_DATE_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsUpdateDismissalDateAction>(modelAction.BpjsUpdateDismissalDateModelActionTypes.CREATE_ALL_BPJS_UPDATE_DISMISSAL_DATE),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsUpdateDismissalDateModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsUpdateDismissalDateActionOK(
						modelAction.BpjsUpdateDismissalDateModelActionTypes.CREATE_ALL_BPJS_UPDATE_DISMISSAL_DATE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsUpdateDismissalDateActionFail(
								modelAction.BpjsUpdateDismissalDateModelActionTypes.CREATE_ALL_BPJS_UPDATE_DISMISSAL_DATE_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsUpdateDismissalDateAction>(modelAction.BpjsUpdateDismissalDateModelActionTypes.UPDATE_BPJS_UPDATE_DISMISSAL_DATE),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsUpdateDismissalDateModel;
				...
				return this.service.update(new BpjsUpdateDismissalDateModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsUpdateDismissalDateActionOK(
						modelAction.BpjsUpdateDismissalDateModelActionTypes.UPDATE_BPJS_UPDATE_DISMISSAL_DATE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsUpdateDismissalDateActionFail(
								modelAction.BpjsUpdateDismissalDateModelActionTypes.UPDATE_BPJS_UPDATE_DISMISSAL_DATE_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsUpdateDismissalDateAction>(modelAction.BpjsUpdateDismissalDateModelActionTypes.UPDATE_ALL_BPJS_UPDATE_DISMISSAL_DATE),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsUpdateDismissalDateModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsUpdateDismissalDateModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsUpdateDismissalDateActionOK(
						modelAction.BpjsUpdateDismissalDateModelActionTypes.UPDATE_ALL_BPJS_UPDATE_DISMISSAL_DATE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsUpdateDismissalDateActionFail(
								modelAction.BpjsUpdateDismissalDateModelActionTypes.UPDATE_ALL_BPJS_UPDATE_DISMISSAL_DATE_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsUpdateDismissalDateAction>(modelAction.BpjsUpdateDismissalDateModelActionTypes.DELETE_BPJS_UPDATE_DISMISSAL_DATE),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsUpdateDismissalDateActionOK(
						modelAction.BpjsUpdateDismissalDateModelActionTypes.DELETE_BPJS_UPDATE_DISMISSAL_DATE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsUpdateDismissalDateActionFail(
								modelAction.BpjsUpdateDismissalDateModelActionTypes.DELETE_BPJS_UPDATE_DISMISSAL_DATE_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsUpdateDismissalDateAction>(modelAction.BpjsUpdateDismissalDateModelActionTypes.DELETE_BPJS_UPDATE_DISMISSAL_DATE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsUpdateDismissalDateActionOK(
						modelAction.BpjsUpdateDismissalDateModelActionTypes.DELETE_BPJS_UPDATE_DISMISSAL_DATE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsUpdateDismissalDateActionFail(
								modelAction.BpjsUpdateDismissalDateModelActionTypes.DELETE_BPJS_UPDATE_DISMISSAL_DATE_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsUpdateDismissalDateAction>(modelAction.BpjsUpdateDismissalDateModelActionTypes.DELETE_ALL_BPJS_UPDATE_DISMISSAL_DATE),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsUpdateDismissalDateActionOK(
						modelAction.BpjsUpdateDismissalDateModelActionTypes.DELETE_ALL_BPJS_UPDATE_DISMISSAL_DATE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsUpdateDismissalDateActionFail(
								modelAction.BpjsUpdateDismissalDateModelActionTypes.DELETE_ALL_BPJS_UPDATE_DISMISSAL_DATE_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsUpdateDismissalDateAction>(modelAction.BpjsUpdateDismissalDateModelActionTypes.EXPORT_BPJS_UPDATE_DISMISSAL_DATE),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsUpdateDismissalDateActionOK(
						modelAction.BpjsUpdateDismissalDateModelActionTypes.EXPORT_BPJS_UPDATE_DISMISSAL_DATE,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsUpdateDismissalDateAction>(modelAction.BpjsUpdateDismissalDateModelActionTypes.EXPORT_ALL_BPJS_UPDATE_DISMISSAL_DATE),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsUpdateDismissalDateActionOK(
						modelAction.BpjsUpdateDismissalDateModelActionTypes.EXPORT_ALL_BPJS_UPDATE_DISMISSAL_DATE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsUpdateDismissalDateActionFail(
								modelAction.BpjsUpdateDismissalDateModelActionTypes.EXPORT_ALL_BPJS_UPDATE_DISMISSAL_DATE_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsUpdateDismissalDateAction>(modelAction.BpjsUpdateDismissalDateModelActionTypes.EXPORT_BPJS_UPDATE_DISMISSAL_DATE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsUpdateDismissalDateActionOK(
						modelAction.BpjsUpdateDismissalDateModelActionTypes.EXPORT_BPJS_UPDATE_DISMISSAL_DATE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsUpdateDismissalDateActionFail(
								modelAction.BpjsUpdateDismissalDateModelActionTypes.EXPORT_BPJS_UPDATE_DISMISSAL_DATE_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsUpdateDismissalDateAction>(modelAction.BpjsUpdateDismissalDateModelActionTypes.IMPORT_BPJS_UPDATE_DISMISSAL_DATES),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsUpdateDismissalDateActionOK(
						modelAction.BpjsUpdateDismissalDateModelActionTypes.IMPORT_BPJS_UPDATE_DISMISSAL_DATES_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsUpdateDismissalDateActionFail(
								modelAction.BpjsUpdateDismissalDateModelActionTypes.IMPORT_BPJS_UPDATE_DISMISSAL_DATES_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsUpdateDismissalDateAction>(modelAction.BpjsUpdateDismissalDateModelActionTypes.FETCH_BPJS_UPDATE_DISMISSAL_DATE_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsUpdateDismissalDateActionOK(
						modelAction.BpjsUpdateDismissalDateModelActionTypes.FETCH_BPJS_UPDATE_DISMISSAL_DATE_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsUpdateDismissalDateActionFail(
								modelAction.BpjsUpdateDismissalDateModelActionTypes.FETCH_BPJS_UPDATE_DISMISSAL_DATE_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsUpdateDismissalDateAction>(modelAction.BpjsUpdateDismissalDateModelActionTypes.FETCH_BPJS_UPDATE_DISMISSAL_DATE_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsUpdateDismissalDateActionOK(
						modelAction.BpjsUpdateDismissalDateModelActionTypes.FETCH_BPJS_UPDATE_DISMISSAL_DATE_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsUpdateDismissalDateActionFail(
								modelAction.BpjsUpdateDismissalDateModelActionTypes.FETCH_BPJS_UPDATE_DISMISSAL_DATE_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
