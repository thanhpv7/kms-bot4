...
import {initialBpjsUpdateDismissalDateCollectionState} from './bpjs_update_dismissal_date.model.state';
...
export function modelReducer(currentState: ModelState, action: Action): ModelState {
	...
	const className = (action as modelAction.BaseBpjsUpdateDismissalDateAction).className;
	...
	return produce(currentState, draft => {
		...
		switch (action.type) {
			case modelAction.BpjsUpdateDismissalDateModelActionTypes.CREATE_BPJS_UPDATE_DISMISSAL_DATE_OK:
				const createdModel = (action as modelAction.BpjsUpdateDismissalDateActionOK ).stateConfig.targetModel;
				...
				BpjsUpdateDismissalDateModel.deepParse(createdModel).forEach(model => {
				...
				break;
			case modelAction.BpjsUpdateDismissalDateModelActionTypes.CREATE_BPJS_UPDATE_DISMISSAL_DATE_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.BpjsUpdateDismissalDateModelActionTypes.CREATE_ALL_BPJS_UPDATE_DISMISSAL_DATE_OK:
				const createdModels = (action as modelAction.BpjsUpdateDismissalDateActionOK).stateConfig.targetModels;
				const collectionIdAfterCreateAll = (action as modelAction.BpjsUpdateDismissalDateActionOK).stateConfig.collectionId;
				...
				createdModels.forEach((m) => {
					BpjsUpdateDismissalDateModel.deepParse(m).forEach(model => {
						draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
						(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
					});
				});
				...
				break;
			case modelAction.BpjsUpdateDismissalDateModelActionTypes.CREATE_ALL_BPJS_UPDATE_DISMISSAL_DATE_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.BpjsUpdateDismissalDateModelActionTypes.DELETE_BPJS_UPDATE_DISMISSAL_DATE_OK:
				const deletedModelId = (action as modelAction.BpjsUpdateDismissalDateActionOK).stateConfig.targetModelId;
				const collectionIdAfterDelete = (action as modelAction.BpjsUpdateDismissalDateActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.BpjsUpdateDismissalDateModelActionTypes.DELETE_ALL_BPJS_UPDATE_DISMISSAL_DATE_OK:
				const deletedModelIds = (action as modelAction.BpjsUpdateDismissalDateActionOK).stateConfig.targetModelIds;
				const collectionIdAfterDeleteAll = (action as modelAction.BpjsUpdateDismissalDateActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.BpjsUpdateDismissalDateModelActionTypes.DELETE_BPJS_UPDATE_DISMISSAL_DATE_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.BpjsUpdateDismissalDateModelActionTypes.UPDATE_BPJS_UPDATE_DISMISSAL_DATE_OK:
				const updatedModel = (action as modelAction.BpjsUpdateDismissalDateActionOK).stateConfig.targetModel;
				...
				BpjsUpdateDismissalDateModel.deepParse(updatedModel).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.BpjsUpdateDismissalDateModelActionTypes.UPDATE_BPJS_UPDATE_DISMISSAL_DATE_FAIL:
				// TODO: Add handling of failure
				break;

			case modelAction.BpjsUpdateDismissalDateModelActionTypes.UPDATE_ALL_BPJS_UPDATE_DISMISSAL_DATE_OK:
				const updatedModels = (action as modelAction.BpjsUpdateDismissalDateActionOK).stateConfig.targetModels;
				const collectionIdAfterUpdateAll = (action as modelAction.BpjsUpdateDismissalDateActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.BpjsUpdateDismissalDateModelActionTypes.UPDATE_ALL_BPJS_UPDATE_DISMISSAL_DATE_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.BpjsUpdateDismissalDateModelActionTypes.FETCH_BPJS_UPDATE_DISMISSAL_DATE_OK:
				let fetchedModel = (action as modelAction.BpjsUpdateDismissalDateActionOK).stateConfig.targetModel;
				...
				BpjsUpdateDismissalDateModel.deepParse(fetchedModel).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.BpjsUpdateDismissalDateModelActionTypes.FETCH_ALL_BPJS_UPDATE_DISMISSAL_DATE_OK:
				const totalCountAfterFetchAll = (action as modelAction.BpjsUpdateDismissalDateActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchAll = (action as modelAction.BpjsUpdateDismissalDateActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchAll = (action as modelAction.BpjsUpdateDismissalDateActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchAll = (action as modelAction.BpjsUpdateDismissalDateActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchAll.map(model => BpjsUpdateDismissalDateModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.BpjsUpdateDismissalDateModelActionTypes.FETCH_BPJS_UPDATE_DISMISSAL_DATE_AUDIT_OK:
				const audits = (action as modelAction.BpjsUpdateDismissalDateActionOK).audits;
				...
				break;
			case modelAction.BpjsUpdateDismissalDateModelActionTypes.FETCH_BPJS_UPDATE_DISMISSAL_DATE_AUDITS_BY_ENTITY_ID_OK:
				const auditsByEntityId = (action as modelAction.BpjsUpdateDismissalDateActionOK).audits;
				...
				break;
			case modelAction.BpjsUpdateDismissalDateModelActionTypes.FETCH_BPJS_UPDATE_DISMISSAL_DATE_WITH_QUERY_OK:
				const totalCountAfterFetchWithQuery = (action as modelAction.BpjsUpdateDismissalDateActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchWithQuery = (action as modelAction.BpjsUpdateDismissalDateActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchWithQuery = (action as modelAction.BpjsUpdateDismissalDateActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchWithQuery = (action as modelAction.BpjsUpdateDismissalDateActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchWithQuery.map(model => BpjsUpdateDismissalDateModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.BpjsUpdateDismissalDateModelActionTypes.FETCH_LAST_BPJS_UPDATE_DISMISSAL_DATE_WITH_QUERY_OK:
				const totalCountAfterFetchLastWithQuery = (action as modelAction.BpjsUpdateDismissalDateActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchLastWithQuery = (action as modelAction.BpjsUpdateDismissalDateActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchLastWithQuery = (action as modelAction.BpjsUpdateDismissalDateActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchLastWithQuery = (action as modelAction.BpjsUpdateDismissalDateActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchLastWithQuery.map(model => BpjsUpdateDismissalDateModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.BpjsUpdateDismissalDateModelActionTypes.COUNT_BPJS_UPDATE_DISMISSAL_DATES_OK:
				const totalCountAfterCount = (action as modelAction.BpjsUpdateDismissalDateActionOK).stateConfig.totalCount;
				...
				break;
			case modelAction.BpjsUpdateDismissalDateModelActionTypes.INITIALISE_BPJS_UPDATE_DISMISSAL_DATE_COLLECTION_STATE:
				const collectionIdToInitialise =  (action as modelAction.BpjsUpdateDismissalDateActionOK).stateConfig.collectionId;
				const queryParamsToInitialise = (action as modelAction.BpjsUpdateDismissalDateActionOK).stateConfig.queryParams;
				...
				if (!draft[className].collectionState[collectionIdToInitialise]) {
					draft[className].collectionState[collectionIdToInitialise] = {
						...initialBpjsUpdateDismissalDateCollectionState
					};
				}
