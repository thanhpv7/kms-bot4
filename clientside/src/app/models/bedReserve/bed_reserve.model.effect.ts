...
import * as modelAction from './bed_reserve.model.action';
import {BedReserveService} from '../../services/bedReserve/bed_reserve.service';
...
/**
 * Effect class used for side effects related to Bed Reserve model.
 */
@Injectable()
export class BedReserveEffect {
	...
	constructor(
		...
		protected readonly service: BedReserveService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BedReserveAction>(modelAction.BedReserveModelActionTypes.COUNT_BED_RESERVES),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BedReserveActionOK(
						modelAction.BedReserveModelActionTypes.COUNT_BED_RESERVES_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BedReserveActionFail(
								modelAction.BedReserveModelActionTypes.COUNT_BED_RESERVES_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BedReserveAction>(modelAction.BedReserveModelActionTypes.FETCH_BED_RESERVE),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BedReserveActionOK(
						modelAction.BedReserveModelActionTypes.FETCH_BED_RESERVE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BedReserveActionFail(
								modelAction.BedReserveModelActionTypes.FETCH_BED_RESERVE_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BedReserveAction>(modelAction.BedReserveModelActionTypes.FETCH_ALL_BED_RESERVE),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BedReserveActionOK(
						modelAction.BedReserveModelActionTypes.FETCH_ALL_BED_RESERVE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BedReserveActionFail(
								modelAction.BedReserveModelActionTypes.FETCH_ALL_BED_RESERVE_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BedReserveAction>(modelAction.BedReserveModelActionTypes.FETCH_BED_RESERVE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BedReserveActionOK(
						modelAction.BedReserveModelActionTypes.FETCH_BED_RESERVE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BedReserveActionFail(
								modelAction.BedReserveModelActionTypes.FETCH_BED_RESERVE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BedReserveAction>(modelAction.BedReserveModelActionTypes.FETCH_LAST_BED_RESERVE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BedReserveActionOK(
						modelAction.BedReserveModelActionTypes.FETCH_LAST_BED_RESERVE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BedReserveActionFail(
								modelAction.BedReserveModelActionTypes.FETCH_LAST_BED_RESERVE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BedReserveAction>(modelAction.BedReserveModelActionTypes.CREATE_BED_RESERVE),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BedReserveModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BedReserveActionOK(
						modelAction.BedReserveModelActionTypes.CREATE_BED_RESERVE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BedReserveActionFail(
								modelAction.BedReserveModelActionTypes.CREATE_BED_RESERVE_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BedReserveAction>(modelAction.BedReserveModelActionTypes.CREATE_ALL_BED_RESERVE),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BedReserveModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BedReserveActionOK(
						modelAction.BedReserveModelActionTypes.CREATE_ALL_BED_RESERVE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BedReserveActionFail(
								modelAction.BedReserveModelActionTypes.CREATE_ALL_BED_RESERVE_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BedReserveAction>(modelAction.BedReserveModelActionTypes.UPDATE_BED_RESERVE),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BedReserveModel;
				...
				return this.service.update(new BedReserveModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BedReserveActionOK(
						modelAction.BedReserveModelActionTypes.UPDATE_BED_RESERVE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BedReserveActionFail(
								modelAction.BedReserveModelActionTypes.UPDATE_BED_RESERVE_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BedReserveAction>(modelAction.BedReserveModelActionTypes.UPDATE_ALL_BED_RESERVE),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BedReserveModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BedReserveModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BedReserveActionOK(
						modelAction.BedReserveModelActionTypes.UPDATE_ALL_BED_RESERVE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BedReserveActionFail(
								modelAction.BedReserveModelActionTypes.UPDATE_ALL_BED_RESERVE_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BedReserveAction>(modelAction.BedReserveModelActionTypes.DELETE_BED_RESERVE),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BedReserveActionOK(
						modelAction.BedReserveModelActionTypes.DELETE_BED_RESERVE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BedReserveActionFail(
								modelAction.BedReserveModelActionTypes.DELETE_BED_RESERVE_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BedReserveAction>(modelAction.BedReserveModelActionTypes.DELETE_BED_RESERVE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BedReserveActionOK(
						modelAction.BedReserveModelActionTypes.DELETE_BED_RESERVE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BedReserveActionFail(
								modelAction.BedReserveModelActionTypes.DELETE_BED_RESERVE_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BedReserveAction>(modelAction.BedReserveModelActionTypes.DELETE_ALL_BED_RESERVE),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BedReserveActionOK(
						modelAction.BedReserveModelActionTypes.DELETE_ALL_BED_RESERVE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BedReserveActionFail(
								modelAction.BedReserveModelActionTypes.DELETE_ALL_BED_RESERVE_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BedReserveAction>(modelAction.BedReserveModelActionTypes.EXPORT_BED_RESERVE),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BedReserveActionOK(
						modelAction.BedReserveModelActionTypes.EXPORT_BED_RESERVE,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BedReserveAction>(modelAction.BedReserveModelActionTypes.EXPORT_ALL_BED_RESERVE),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BedReserveActionOK(
						modelAction.BedReserveModelActionTypes.EXPORT_ALL_BED_RESERVE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BedReserveActionFail(
								modelAction.BedReserveModelActionTypes.EXPORT_ALL_BED_RESERVE_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BedReserveAction>(modelAction.BedReserveModelActionTypes.EXPORT_BED_RESERVE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BedReserveActionOK(
						modelAction.BedReserveModelActionTypes.EXPORT_BED_RESERVE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BedReserveActionFail(
								modelAction.BedReserveModelActionTypes.EXPORT_BED_RESERVE_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BedReserveAction>(modelAction.BedReserveModelActionTypes.IMPORT_BED_RESERVES),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BedReserveActionOK(
						modelAction.BedReserveModelActionTypes.IMPORT_BED_RESERVES_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BedReserveActionFail(
								modelAction.BedReserveModelActionTypes.IMPORT_BED_RESERVES_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BedReserveAction>(modelAction.BedReserveModelActionTypes.FETCH_BED_RESERVE_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BedReserveActionOK(
						modelAction.BedReserveModelActionTypes.FETCH_BED_RESERVE_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BedReserveActionFail(
								modelAction.BedReserveModelActionTypes.FETCH_BED_RESERVE_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BedReserveAction>(modelAction.BedReserveModelActionTypes.FETCH_BED_RESERVE_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BedReserveActionOK(
						modelAction.BedReserveModelActionTypes.FETCH_BED_RESERVE_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BedReserveActionFail(
								modelAction.BedReserveModelActionTypes.FETCH_BED_RESERVE_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
