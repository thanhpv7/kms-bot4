...
/**
 * BedReserveCollectionState would store the state of a collection of BedReserve
 */
export interface BedReserveCollectionState extends CollectionState {
 ...
 */
export interface BedReserveModelAudit extends AbstractModelAudit<BedReserveModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BedReserveModelState would store the state of the model
 */
export interface BedReserveModelState {
	collectionState: {
		[key: string]: BedReserveCollectionState;
	};
	data: {
		[id: string]: BedReserveModel;
	};
	totalCount: number;
	audits: BedReserveModelAudit[];
 ...
 */
export const initialBedReserveCollectionState: BedReserveCollectionState = {
...
/**
 * The initial state of BedReserveModelState
 */
export const initialState: BedReserveModelState = {
	collectionState: {
