...
import * as modelAction from './vital_signs.model.action';
import {VitalSignsService} from '../../services/vitalSigns/vital_signs.service';
...
/**
 * Effect class used for side effects related to Vital Signs model.
 */
@Injectable()
export class VitalSignsEffect {
	...
	constructor(
		...
		protected readonly service: VitalSignsService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VitalSignsAction>(modelAction.VitalSignsModelActionTypes.COUNT_VITAL_SIGNSS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.VitalSignsActionOK(
						modelAction.VitalSignsModelActionTypes.COUNT_VITAL_SIGNSS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.VitalSignsActionFail(
								modelAction.VitalSignsModelActionTypes.COUNT_VITAL_SIGNSS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VitalSignsAction>(modelAction.VitalSignsModelActionTypes.FETCH_VITAL_SIGNS),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.VitalSignsActionOK(
						modelAction.VitalSignsModelActionTypes.FETCH_VITAL_SIGNS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.VitalSignsActionFail(
								modelAction.VitalSignsModelActionTypes.FETCH_VITAL_SIGNS_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VitalSignsAction>(modelAction.VitalSignsModelActionTypes.FETCH_ALL_VITAL_SIGNS),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.VitalSignsActionOK(
						modelAction.VitalSignsModelActionTypes.FETCH_ALL_VITAL_SIGNS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.VitalSignsActionFail(
								modelAction.VitalSignsModelActionTypes.FETCH_ALL_VITAL_SIGNS_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VitalSignsAction>(modelAction.VitalSignsModelActionTypes.FETCH_VITAL_SIGNS_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.VitalSignsActionOK(
						modelAction.VitalSignsModelActionTypes.FETCH_VITAL_SIGNS_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.VitalSignsActionFail(
								modelAction.VitalSignsModelActionTypes.FETCH_VITAL_SIGNS_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VitalSignsAction>(modelAction.VitalSignsModelActionTypes.FETCH_LAST_VITAL_SIGNS_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.VitalSignsActionOK(
						modelAction.VitalSignsModelActionTypes.FETCH_LAST_VITAL_SIGNS_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.VitalSignsActionFail(
								modelAction.VitalSignsModelActionTypes.FETCH_LAST_VITAL_SIGNS_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VitalSignsAction>(modelAction.VitalSignsModelActionTypes.CREATE_VITAL_SIGNS),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as VitalSignsModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.VitalSignsActionOK(
						modelAction.VitalSignsModelActionTypes.CREATE_VITAL_SIGNS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.VitalSignsActionFail(
								modelAction.VitalSignsModelActionTypes.CREATE_VITAL_SIGNS_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VitalSignsAction>(modelAction.VitalSignsModelActionTypes.CREATE_ALL_VITAL_SIGNS),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as VitalSignsModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.VitalSignsActionOK(
						modelAction.VitalSignsModelActionTypes.CREATE_ALL_VITAL_SIGNS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.VitalSignsActionFail(
								modelAction.VitalSignsModelActionTypes.CREATE_ALL_VITAL_SIGNS_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VitalSignsAction>(modelAction.VitalSignsModelActionTypes.UPDATE_VITAL_SIGNS),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as VitalSignsModel;
				...
				return this.service.update(new VitalSignsModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.VitalSignsActionOK(
						modelAction.VitalSignsModelActionTypes.UPDATE_VITAL_SIGNS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.VitalSignsActionFail(
								modelAction.VitalSignsModelActionTypes.UPDATE_VITAL_SIGNS_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VitalSignsAction>(modelAction.VitalSignsModelActionTypes.UPDATE_ALL_VITAL_SIGNS),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as VitalSignsModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new VitalSignsModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.VitalSignsActionOK(
						modelAction.VitalSignsModelActionTypes.UPDATE_ALL_VITAL_SIGNS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.VitalSignsActionFail(
								modelAction.VitalSignsModelActionTypes.UPDATE_ALL_VITAL_SIGNS_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VitalSignsAction>(modelAction.VitalSignsModelActionTypes.DELETE_VITAL_SIGNS),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.VitalSignsActionOK(
						modelAction.VitalSignsModelActionTypes.DELETE_VITAL_SIGNS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.VitalSignsActionFail(
								modelAction.VitalSignsModelActionTypes.DELETE_VITAL_SIGNS_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VitalSignsAction>(modelAction.VitalSignsModelActionTypes.DELETE_VITAL_SIGNS_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.VitalSignsActionOK(
						modelAction.VitalSignsModelActionTypes.DELETE_VITAL_SIGNS_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.VitalSignsActionFail(
								modelAction.VitalSignsModelActionTypes.DELETE_VITAL_SIGNS_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VitalSignsAction>(modelAction.VitalSignsModelActionTypes.DELETE_ALL_VITAL_SIGNS),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.VitalSignsActionOK(
						modelAction.VitalSignsModelActionTypes.DELETE_ALL_VITAL_SIGNS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.VitalSignsActionFail(
								modelAction.VitalSignsModelActionTypes.DELETE_ALL_VITAL_SIGNS_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VitalSignsAction>(modelAction.VitalSignsModelActionTypes.EXPORT_VITAL_SIGNS),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.VitalSignsActionOK(
						modelAction.VitalSignsModelActionTypes.EXPORT_VITAL_SIGNS,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VitalSignsAction>(modelAction.VitalSignsModelActionTypes.EXPORT_ALL_VITAL_SIGNS),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.VitalSignsActionOK(
						modelAction.VitalSignsModelActionTypes.EXPORT_ALL_VITAL_SIGNS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.VitalSignsActionFail(
								modelAction.VitalSignsModelActionTypes.EXPORT_ALL_VITAL_SIGNS_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VitalSignsAction>(modelAction.VitalSignsModelActionTypes.EXPORT_VITAL_SIGNS_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.VitalSignsActionOK(
						modelAction.VitalSignsModelActionTypes.EXPORT_VITAL_SIGNS_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.VitalSignsActionFail(
								modelAction.VitalSignsModelActionTypes.EXPORT_VITAL_SIGNS_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VitalSignsAction>(modelAction.VitalSignsModelActionTypes.IMPORT_VITAL_SIGNSS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.VitalSignsActionOK(
						modelAction.VitalSignsModelActionTypes.IMPORT_VITAL_SIGNSS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.VitalSignsActionFail(
								modelAction.VitalSignsModelActionTypes.IMPORT_VITAL_SIGNSS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VitalSignsAction>(modelAction.VitalSignsModelActionTypes.FETCH_VITAL_SIGNS_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.VitalSignsActionOK(
						modelAction.VitalSignsModelActionTypes.FETCH_VITAL_SIGNS_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.VitalSignsActionFail(
								modelAction.VitalSignsModelActionTypes.FETCH_VITAL_SIGNS_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VitalSignsAction>(modelAction.VitalSignsModelActionTypes.FETCH_VITAL_SIGNS_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.VitalSignsActionOK(
						modelAction.VitalSignsModelActionTypes.FETCH_VITAL_SIGNS_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.VitalSignsActionFail(
								modelAction.VitalSignsModelActionTypes.FETCH_VITAL_SIGNS_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
