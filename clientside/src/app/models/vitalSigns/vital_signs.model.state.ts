...
/**
 * VitalSignsCollectionState would store the state of a collection of VitalSigns
 */
export interface VitalSignsCollectionState extends CollectionState {
 ...
 */
export interface VitalSignsModelAudit extends AbstractModelAudit<VitalSignsModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * VitalSignsModelState would store the state of the model
 */
export interface VitalSignsModelState {
	collectionState: {
		[key: string]: VitalSignsCollectionState;
	};
	data: {
		[id: string]: VitalSignsModel;
	};
	totalCount: number;
	audits: VitalSignsModelAudit[];
 ...
 */
export const initialVitalSignsCollectionState: VitalSignsCollectionState = {
...
/**
 * The initial state of VitalSignsModelState
 */
export const initialState: VitalSignsModelState = {
	collectionState: {
