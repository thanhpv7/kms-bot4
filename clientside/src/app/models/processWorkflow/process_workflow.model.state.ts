...
/**
 * ProcessWorkflowCollectionState would store the state of a collection of ProcessWorkflow
 */
export interface ProcessWorkflowCollectionState extends CollectionState {
 ...
 */
export interface ProcessWorkflowModelAudit extends AbstractModelAudit<ProcessWorkflowModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * ProcessWorkflowModelState would store the state of the model
 */
export interface ProcessWorkflowModelState {
	collectionState: {
		[key: string]: ProcessWorkflowCollectionState;
	};
	data: {
		[id: string]: ProcessWorkflowModel;
	};
	totalCount: number;
	audits: ProcessWorkflowModelAudit[];
 ...
 */
export const initialProcessWorkflowCollectionState: ProcessWorkflowCollectionState = {
...
/**
 * The initial state of ProcessWorkflowModelState
 */
export const initialState: ProcessWorkflowModelState = {
	collectionState: {
