...
import * as modelAction from './process_workflow.model.action';
import {ProcessWorkflowService} from '../../services/processWorkflow/process_workflow.service';
...
/**
 * Effect class used for side effects related to Process Workflow model.
 */
@Injectable()
export class ProcessWorkflowEffect {
	...
	constructor(
		...
		protected readonly service: ProcessWorkflowService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ProcessWorkflowAction>(modelAction.ProcessWorkflowModelActionTypes.COUNT_PROCESS_WORKFLOWS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.ProcessWorkflowActionOK(
						modelAction.ProcessWorkflowModelActionTypes.COUNT_PROCESS_WORKFLOWS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ProcessWorkflowActionFail(
								modelAction.ProcessWorkflowModelActionTypes.COUNT_PROCESS_WORKFLOWS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ProcessWorkflowAction>(modelAction.ProcessWorkflowModelActionTypes.FETCH_PROCESS_WORKFLOW),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ProcessWorkflowActionOK(
						modelAction.ProcessWorkflowModelActionTypes.FETCH_PROCESS_WORKFLOW_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ProcessWorkflowActionFail(
								modelAction.ProcessWorkflowModelActionTypes.FETCH_PROCESS_WORKFLOW_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ProcessWorkflowAction>(modelAction.ProcessWorkflowModelActionTypes.FETCH_ALL_PROCESS_WORKFLOW),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.ProcessWorkflowActionOK(
						modelAction.ProcessWorkflowModelActionTypes.FETCH_ALL_PROCESS_WORKFLOW_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ProcessWorkflowActionFail(
								modelAction.ProcessWorkflowModelActionTypes.FETCH_ALL_PROCESS_WORKFLOW_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ProcessWorkflowAction>(modelAction.ProcessWorkflowModelActionTypes.FETCH_PROCESS_WORKFLOW_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.ProcessWorkflowActionOK(
						modelAction.ProcessWorkflowModelActionTypes.FETCH_PROCESS_WORKFLOW_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ProcessWorkflowActionFail(
								modelAction.ProcessWorkflowModelActionTypes.FETCH_PROCESS_WORKFLOW_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ProcessWorkflowAction>(modelAction.ProcessWorkflowModelActionTypes.FETCH_LAST_PROCESS_WORKFLOW_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.ProcessWorkflowActionOK(
						modelAction.ProcessWorkflowModelActionTypes.FETCH_LAST_PROCESS_WORKFLOW_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ProcessWorkflowActionFail(
								modelAction.ProcessWorkflowModelActionTypes.FETCH_LAST_PROCESS_WORKFLOW_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ProcessWorkflowAction>(modelAction.ProcessWorkflowModelActionTypes.CREATE_PROCESS_WORKFLOW),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as ProcessWorkflowModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ProcessWorkflowActionOK(
						modelAction.ProcessWorkflowModelActionTypes.CREATE_PROCESS_WORKFLOW_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ProcessWorkflowActionFail(
								modelAction.ProcessWorkflowModelActionTypes.CREATE_PROCESS_WORKFLOW_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ProcessWorkflowAction>(modelAction.ProcessWorkflowModelActionTypes.CREATE_ALL_PROCESS_WORKFLOW),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as ProcessWorkflowModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ProcessWorkflowActionOK(
						modelAction.ProcessWorkflowModelActionTypes.CREATE_ALL_PROCESS_WORKFLOW_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ProcessWorkflowActionFail(
								modelAction.ProcessWorkflowModelActionTypes.CREATE_ALL_PROCESS_WORKFLOW_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ProcessWorkflowAction>(modelAction.ProcessWorkflowModelActionTypes.UPDATE_PROCESS_WORKFLOW),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as ProcessWorkflowModel;
				...
				return this.service.update(new ProcessWorkflowModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.ProcessWorkflowActionOK(
						modelAction.ProcessWorkflowModelActionTypes.UPDATE_PROCESS_WORKFLOW_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ProcessWorkflowActionFail(
								modelAction.ProcessWorkflowModelActionTypes.UPDATE_PROCESS_WORKFLOW_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ProcessWorkflowAction>(modelAction.ProcessWorkflowModelActionTypes.UPDATE_ALL_PROCESS_WORKFLOW),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as ProcessWorkflowModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new ProcessWorkflowModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ProcessWorkflowActionOK(
						modelAction.ProcessWorkflowModelActionTypes.UPDATE_ALL_PROCESS_WORKFLOW_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ProcessWorkflowActionFail(
								modelAction.ProcessWorkflowModelActionTypes.UPDATE_ALL_PROCESS_WORKFLOW_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ProcessWorkflowAction>(modelAction.ProcessWorkflowModelActionTypes.DELETE_PROCESS_WORKFLOW),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.ProcessWorkflowActionOK(
						modelAction.ProcessWorkflowModelActionTypes.DELETE_PROCESS_WORKFLOW_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ProcessWorkflowActionFail(
								modelAction.ProcessWorkflowModelActionTypes.DELETE_PROCESS_WORKFLOW_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ProcessWorkflowAction>(modelAction.ProcessWorkflowModelActionTypes.DELETE_PROCESS_WORKFLOW_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.ProcessWorkflowActionOK(
						modelAction.ProcessWorkflowModelActionTypes.DELETE_PROCESS_WORKFLOW_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ProcessWorkflowActionFail(
								modelAction.ProcessWorkflowModelActionTypes.DELETE_PROCESS_WORKFLOW_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ProcessWorkflowAction>(modelAction.ProcessWorkflowModelActionTypes.DELETE_ALL_PROCESS_WORKFLOW),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.ProcessWorkflowActionOK(
						modelAction.ProcessWorkflowModelActionTypes.DELETE_ALL_PROCESS_WORKFLOW_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ProcessWorkflowActionFail(
								modelAction.ProcessWorkflowModelActionTypes.DELETE_ALL_PROCESS_WORKFLOW_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ProcessWorkflowAction>(modelAction.ProcessWorkflowModelActionTypes.EXPORT_PROCESS_WORKFLOW),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ProcessWorkflowActionOK(
						modelAction.ProcessWorkflowModelActionTypes.EXPORT_PROCESS_WORKFLOW,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ProcessWorkflowAction>(modelAction.ProcessWorkflowModelActionTypes.EXPORT_ALL_PROCESS_WORKFLOW),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ProcessWorkflowActionOK(
						modelAction.ProcessWorkflowModelActionTypes.EXPORT_ALL_PROCESS_WORKFLOW_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ProcessWorkflowActionFail(
								modelAction.ProcessWorkflowModelActionTypes.EXPORT_ALL_PROCESS_WORKFLOW_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ProcessWorkflowAction>(modelAction.ProcessWorkflowModelActionTypes.EXPORT_PROCESS_WORKFLOW_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ProcessWorkflowActionOK(
						modelAction.ProcessWorkflowModelActionTypes.EXPORT_PROCESS_WORKFLOW_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ProcessWorkflowActionFail(
								modelAction.ProcessWorkflowModelActionTypes.EXPORT_PROCESS_WORKFLOW_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ProcessWorkflowAction>(modelAction.ProcessWorkflowModelActionTypes.IMPORT_PROCESS_WORKFLOWS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.ProcessWorkflowActionOK(
						modelAction.ProcessWorkflowModelActionTypes.IMPORT_PROCESS_WORKFLOWS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ProcessWorkflowActionFail(
								modelAction.ProcessWorkflowModelActionTypes.IMPORT_PROCESS_WORKFLOWS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ProcessWorkflowAction>(modelAction.ProcessWorkflowModelActionTypes.FETCH_PROCESS_WORKFLOW_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.ProcessWorkflowActionOK(
						modelAction.ProcessWorkflowModelActionTypes.FETCH_PROCESS_WORKFLOW_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.ProcessWorkflowActionFail(
								modelAction.ProcessWorkflowModelActionTypes.FETCH_PROCESS_WORKFLOW_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ProcessWorkflowAction>(modelAction.ProcessWorkflowModelActionTypes.FETCH_PROCESS_WORKFLOW_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.ProcessWorkflowActionOK(
						modelAction.ProcessWorkflowModelActionTypes.FETCH_PROCESS_WORKFLOW_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.ProcessWorkflowActionFail(
								modelAction.ProcessWorkflowModelActionTypes.FETCH_PROCESS_WORKFLOW_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
