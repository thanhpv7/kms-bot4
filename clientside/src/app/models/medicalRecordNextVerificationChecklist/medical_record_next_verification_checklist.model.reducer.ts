...
import {initialMedicalRecordNextVerificationChecklistCollectionState} from './medical_record_next_verification_checklist.model.state';
...
export function modelReducer(currentState: ModelState, action: Action): ModelState {
	...
	const className = (action as modelAction.BaseMedicalRecordNextVerificationChecklistAction).className;
	...
	return produce(currentState, draft => {
		...
		switch (action.type) {
			case modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.CREATE_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_OK:
				const createdModel = (action as modelAction.MedicalRecordNextVerificationChecklistActionOK ).stateConfig.targetModel;
				...
				MedicalRecordNextVerificationChecklistModel.deepParse(createdModel).forEach(model => {
				...
				break;
			case modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.CREATE_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.CREATE_ALL_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_OK:
				const createdModels = (action as modelAction.MedicalRecordNextVerificationChecklistActionOK).stateConfig.targetModels;
				const collectionIdAfterCreateAll = (action as modelAction.MedicalRecordNextVerificationChecklistActionOK).stateConfig.collectionId;
				...
				createdModels.forEach((m) => {
					MedicalRecordNextVerificationChecklistModel.deepParse(m).forEach(model => {
						draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
						(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
					});
				});
				...
				break;
			case modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.CREATE_ALL_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.DELETE_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_OK:
				const deletedModelId = (action as modelAction.MedicalRecordNextVerificationChecklistActionOK).stateConfig.targetModelId;
				const collectionIdAfterDelete = (action as modelAction.MedicalRecordNextVerificationChecklistActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.DELETE_ALL_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_OK:
				const deletedModelIds = (action as modelAction.MedicalRecordNextVerificationChecklistActionOK).stateConfig.targetModelIds;
				const collectionIdAfterDeleteAll = (action as modelAction.MedicalRecordNextVerificationChecklistActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.DELETE_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.UPDATE_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_OK:
				const updatedModel = (action as modelAction.MedicalRecordNextVerificationChecklistActionOK).stateConfig.targetModel;
				...
				MedicalRecordNextVerificationChecklistModel.deepParse(updatedModel).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.UPDATE_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_FAIL:
				// TODO: Add handling of failure
				break;

			case modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.UPDATE_ALL_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_OK:
				const updatedModels = (action as modelAction.MedicalRecordNextVerificationChecklistActionOK).stateConfig.targetModels;
				const collectionIdAfterUpdateAll = (action as modelAction.MedicalRecordNextVerificationChecklistActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.UPDATE_ALL_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.FETCH_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_OK:
				let fetchedModel = (action as modelAction.MedicalRecordNextVerificationChecklistActionOK).stateConfig.targetModel;
				...
				MedicalRecordNextVerificationChecklistModel.deepParse(fetchedModel).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.FETCH_ALL_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_OK:
				const totalCountAfterFetchAll = (action as modelAction.MedicalRecordNextVerificationChecklistActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchAll = (action as modelAction.MedicalRecordNextVerificationChecklistActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchAll = (action as modelAction.MedicalRecordNextVerificationChecklistActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchAll = (action as modelAction.MedicalRecordNextVerificationChecklistActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchAll.map(model => MedicalRecordNextVerificationChecklistModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.FETCH_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_AUDIT_OK:
				const audits = (action as modelAction.MedicalRecordNextVerificationChecklistActionOK).audits;
				...
				break;
			case modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.FETCH_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_AUDITS_BY_ENTITY_ID_OK:
				const auditsByEntityId = (action as modelAction.MedicalRecordNextVerificationChecklistActionOK).audits;
				...
				break;
			case modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.FETCH_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_WITH_QUERY_OK:
				const totalCountAfterFetchWithQuery = (action as modelAction.MedicalRecordNextVerificationChecklistActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchWithQuery = (action as modelAction.MedicalRecordNextVerificationChecklistActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchWithQuery = (action as modelAction.MedicalRecordNextVerificationChecklistActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchWithQuery = (action as modelAction.MedicalRecordNextVerificationChecklistActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchWithQuery.map(model => MedicalRecordNextVerificationChecklistModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.FETCH_LAST_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_WITH_QUERY_OK:
				const totalCountAfterFetchLastWithQuery = (action as modelAction.MedicalRecordNextVerificationChecklistActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchLastWithQuery = (action as modelAction.MedicalRecordNextVerificationChecklistActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchLastWithQuery = (action as modelAction.MedicalRecordNextVerificationChecklistActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchLastWithQuery = (action as modelAction.MedicalRecordNextVerificationChecklistActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchLastWithQuery.map(model => MedicalRecordNextVerificationChecklistModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.COUNT_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLISTS_OK:
				const totalCountAfterCount = (action as modelAction.MedicalRecordNextVerificationChecklistActionOK).stateConfig.totalCount;
				...
				break;
			case modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.INITIALISE_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_COLLECTION_STATE:
				const collectionIdToInitialise =  (action as modelAction.MedicalRecordNextVerificationChecklistActionOK).stateConfig.collectionId;
				const queryParamsToInitialise = (action as modelAction.MedicalRecordNextVerificationChecklistActionOK).stateConfig.queryParams;
				...
				if (!draft[className].collectionState[collectionIdToInitialise]) {
					draft[className].collectionState[collectionIdToInitialise] = {
						...initialMedicalRecordNextVerificationChecklistCollectionState
					};
				}
