...
import * as modelAction from './medical_record_next_verification_checklist.model.action';
import {MedicalRecordNextVerificationChecklistService} from '../../services/medicalRecordNextVerificationChecklist/medical_record_next_verification_checklist.service';
...
/**
 * Effect class used for side effects related to Medical Record Next Verification Checklist model.
 */
@Injectable()
export class MedicalRecordNextVerificationChecklistEffect {
	...
	constructor(
		...
		protected readonly service: MedicalRecordNextVerificationChecklistService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalRecordNextVerificationChecklistAction>(modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.COUNT_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLISTS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.MedicalRecordNextVerificationChecklistActionOK(
						modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.COUNT_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLISTS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalRecordNextVerificationChecklistActionFail(
								modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.COUNT_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLISTS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalRecordNextVerificationChecklistAction>(modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.FETCH_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalRecordNextVerificationChecklistActionOK(
						modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.FETCH_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalRecordNextVerificationChecklistActionFail(
								modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.FETCH_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalRecordNextVerificationChecklistAction>(modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.FETCH_ALL_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.MedicalRecordNextVerificationChecklistActionOK(
						modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.FETCH_ALL_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalRecordNextVerificationChecklistActionFail(
								modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.FETCH_ALL_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalRecordNextVerificationChecklistAction>(modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.FETCH_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalRecordNextVerificationChecklistActionOK(
						modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.FETCH_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalRecordNextVerificationChecklistActionFail(
								modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.FETCH_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalRecordNextVerificationChecklistAction>(modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.FETCH_LAST_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalRecordNextVerificationChecklistActionOK(
						modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.FETCH_LAST_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalRecordNextVerificationChecklistActionFail(
								modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.FETCH_LAST_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalRecordNextVerificationChecklistAction>(modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.CREATE_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as MedicalRecordNextVerificationChecklistModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalRecordNextVerificationChecklistActionOK(
						modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.CREATE_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalRecordNextVerificationChecklistActionFail(
								modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.CREATE_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalRecordNextVerificationChecklistAction>(modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.CREATE_ALL_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as MedicalRecordNextVerificationChecklistModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalRecordNextVerificationChecklistActionOK(
						modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.CREATE_ALL_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalRecordNextVerificationChecklistActionFail(
								modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.CREATE_ALL_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalRecordNextVerificationChecklistAction>(modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.UPDATE_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as MedicalRecordNextVerificationChecklistModel;
				...
				return this.service.update(new MedicalRecordNextVerificationChecklistModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalRecordNextVerificationChecklistActionOK(
						modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.UPDATE_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalRecordNextVerificationChecklistActionFail(
								modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.UPDATE_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalRecordNextVerificationChecklistAction>(modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.UPDATE_ALL_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as MedicalRecordNextVerificationChecklistModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new MedicalRecordNextVerificationChecklistModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalRecordNextVerificationChecklistActionOK(
						modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.UPDATE_ALL_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalRecordNextVerificationChecklistActionFail(
								modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.UPDATE_ALL_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalRecordNextVerificationChecklistAction>(modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.DELETE_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.MedicalRecordNextVerificationChecklistActionOK(
						modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.DELETE_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalRecordNextVerificationChecklistActionFail(
								modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.DELETE_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalRecordNextVerificationChecklistAction>(modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.DELETE_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.MedicalRecordNextVerificationChecklistActionOK(
						modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.DELETE_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalRecordNextVerificationChecklistActionFail(
								modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.DELETE_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalRecordNextVerificationChecklistAction>(modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.DELETE_ALL_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.MedicalRecordNextVerificationChecklistActionOK(
						modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.DELETE_ALL_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalRecordNextVerificationChecklistActionFail(
								modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.DELETE_ALL_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalRecordNextVerificationChecklistAction>(modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.EXPORT_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicalRecordNextVerificationChecklistActionOK(
						modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.EXPORT_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalRecordNextVerificationChecklistAction>(modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.EXPORT_ALL_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicalRecordNextVerificationChecklistActionOK(
						modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.EXPORT_ALL_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalRecordNextVerificationChecklistActionFail(
								modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.EXPORT_ALL_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalRecordNextVerificationChecklistAction>(modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.EXPORT_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicalRecordNextVerificationChecklistActionOK(
						modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.EXPORT_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalRecordNextVerificationChecklistActionFail(
								modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.EXPORT_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalRecordNextVerificationChecklistAction>(modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.IMPORT_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLISTS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.MedicalRecordNextVerificationChecklistActionOK(
						modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.IMPORT_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLISTS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalRecordNextVerificationChecklistActionFail(
								modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.IMPORT_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLISTS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalRecordNextVerificationChecklistAction>(modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.FETCH_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.MedicalRecordNextVerificationChecklistActionOK(
						modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.FETCH_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.MedicalRecordNextVerificationChecklistActionFail(
								modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.FETCH_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalRecordNextVerificationChecklistAction>(modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.FETCH_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.MedicalRecordNextVerificationChecklistActionOK(
						modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.FETCH_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.MedicalRecordNextVerificationChecklistActionFail(
								modelAction.MedicalRecordNextVerificationChecklistModelActionTypes.FETCH_MEDICAL_RECORD_NEXT_VERIFICATION_CHECKLIST_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
