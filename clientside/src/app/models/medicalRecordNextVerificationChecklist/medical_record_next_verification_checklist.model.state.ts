...
/**
 * MedicalRecordNextVerificationChecklistCollectionState would store the state of a collection of MedicalRecordNextVerificationChecklist
 */
export interface MedicalRecordNextVerificationChecklistCollectionState extends CollectionState {
 ...
 */
export interface MedicalRecordNextVerificationChecklistModelAudit extends AbstractModelAudit<MedicalRecordNextVerificationChecklistModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * MedicalRecordNextVerificationChecklistModelState would store the state of the model
 */
export interface MedicalRecordNextVerificationChecklistModelState {
	collectionState: {
		[key: string]: MedicalRecordNextVerificationChecklistCollectionState;
	};
	data: {
		[id: string]: MedicalRecordNextVerificationChecklistModel;
	};
	totalCount: number;
	audits: MedicalRecordNextVerificationChecklistModelAudit[];
 ...
 */
export const initialMedicalRecordNextVerificationChecklistCollectionState: MedicalRecordNextVerificationChecklistCollectionState = {
...
/**
 * The initial state of MedicalRecordNextVerificationChecklistModelState
 */
export const initialState: MedicalRecordNextVerificationChecklistModelState = {
	collectionState: {
