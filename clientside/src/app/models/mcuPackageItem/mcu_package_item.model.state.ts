...
/**
 * McuPackageItemCollectionState would store the state of a collection of McuPackageItem
 */
export interface McuPackageItemCollectionState extends CollectionState {
 ...
 */
export interface McuPackageItemModelAudit extends AbstractModelAudit<McuPackageItemModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * McuPackageItemModelState would store the state of the model
 */
export interface McuPackageItemModelState {
	collectionState: {
		[key: string]: McuPackageItemCollectionState;
	};
	data: {
		[id: string]: McuPackageItemModel;
	};
	totalCount: number;
	audits: McuPackageItemModelAudit[];
 ...
 */
export const initialMcuPackageItemCollectionState: McuPackageItemCollectionState = {
...
/**
 * The initial state of McuPackageItemModelState
 */
export const initialState: McuPackageItemModelState = {
	collectionState: {
