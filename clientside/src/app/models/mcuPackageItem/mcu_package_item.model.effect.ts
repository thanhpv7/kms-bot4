...
import * as modelAction from './mcu_package_item.model.action';
import {McuPackageItemService} from '../../services/mcuPackageItem/mcu_package_item.service';
...
/**
 * Effect class used for side effects related to MCU Package Item model.
 */
@Injectable()
export class McuPackageItemEffect {
	...
	constructor(
		...
		protected readonly service: McuPackageItemService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.McuPackageItemAction>(modelAction.McuPackageItemModelActionTypes.COUNT_MCU_PACKAGE_ITEMS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.McuPackageItemActionOK(
						modelAction.McuPackageItemModelActionTypes.COUNT_MCU_PACKAGE_ITEMS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.McuPackageItemActionFail(
								modelAction.McuPackageItemModelActionTypes.COUNT_MCU_PACKAGE_ITEMS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.McuPackageItemAction>(modelAction.McuPackageItemModelActionTypes.FETCH_MCU_PACKAGE_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.McuPackageItemActionOK(
						modelAction.McuPackageItemModelActionTypes.FETCH_MCU_PACKAGE_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.McuPackageItemActionFail(
								modelAction.McuPackageItemModelActionTypes.FETCH_MCU_PACKAGE_ITEM_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.McuPackageItemAction>(modelAction.McuPackageItemModelActionTypes.FETCH_ALL_MCU_PACKAGE_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.McuPackageItemActionOK(
						modelAction.McuPackageItemModelActionTypes.FETCH_ALL_MCU_PACKAGE_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.McuPackageItemActionFail(
								modelAction.McuPackageItemModelActionTypes.FETCH_ALL_MCU_PACKAGE_ITEM_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.McuPackageItemAction>(modelAction.McuPackageItemModelActionTypes.FETCH_MCU_PACKAGE_ITEM_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.McuPackageItemActionOK(
						modelAction.McuPackageItemModelActionTypes.FETCH_MCU_PACKAGE_ITEM_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.McuPackageItemActionFail(
								modelAction.McuPackageItemModelActionTypes.FETCH_MCU_PACKAGE_ITEM_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.McuPackageItemAction>(modelAction.McuPackageItemModelActionTypes.FETCH_LAST_MCU_PACKAGE_ITEM_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.McuPackageItemActionOK(
						modelAction.McuPackageItemModelActionTypes.FETCH_LAST_MCU_PACKAGE_ITEM_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.McuPackageItemActionFail(
								modelAction.McuPackageItemModelActionTypes.FETCH_LAST_MCU_PACKAGE_ITEM_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.McuPackageItemAction>(modelAction.McuPackageItemModelActionTypes.CREATE_MCU_PACKAGE_ITEM),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as McuPackageItemModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.McuPackageItemActionOK(
						modelAction.McuPackageItemModelActionTypes.CREATE_MCU_PACKAGE_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.McuPackageItemActionFail(
								modelAction.McuPackageItemModelActionTypes.CREATE_MCU_PACKAGE_ITEM_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.McuPackageItemAction>(modelAction.McuPackageItemModelActionTypes.CREATE_ALL_MCU_PACKAGE_ITEM),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as McuPackageItemModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.McuPackageItemActionOK(
						modelAction.McuPackageItemModelActionTypes.CREATE_ALL_MCU_PACKAGE_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.McuPackageItemActionFail(
								modelAction.McuPackageItemModelActionTypes.CREATE_ALL_MCU_PACKAGE_ITEM_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.McuPackageItemAction>(modelAction.McuPackageItemModelActionTypes.UPDATE_MCU_PACKAGE_ITEM),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as McuPackageItemModel;
				...
				return this.service.update(new McuPackageItemModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.McuPackageItemActionOK(
						modelAction.McuPackageItemModelActionTypes.UPDATE_MCU_PACKAGE_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.McuPackageItemActionFail(
								modelAction.McuPackageItemModelActionTypes.UPDATE_MCU_PACKAGE_ITEM_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.McuPackageItemAction>(modelAction.McuPackageItemModelActionTypes.UPDATE_ALL_MCU_PACKAGE_ITEM),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as McuPackageItemModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new McuPackageItemModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.McuPackageItemActionOK(
						modelAction.McuPackageItemModelActionTypes.UPDATE_ALL_MCU_PACKAGE_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.McuPackageItemActionFail(
								modelAction.McuPackageItemModelActionTypes.UPDATE_ALL_MCU_PACKAGE_ITEM_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.McuPackageItemAction>(modelAction.McuPackageItemModelActionTypes.DELETE_MCU_PACKAGE_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.McuPackageItemActionOK(
						modelAction.McuPackageItemModelActionTypes.DELETE_MCU_PACKAGE_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.McuPackageItemActionFail(
								modelAction.McuPackageItemModelActionTypes.DELETE_MCU_PACKAGE_ITEM_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.McuPackageItemAction>(modelAction.McuPackageItemModelActionTypes.DELETE_MCU_PACKAGE_ITEM_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.McuPackageItemActionOK(
						modelAction.McuPackageItemModelActionTypes.DELETE_MCU_PACKAGE_ITEM_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.McuPackageItemActionFail(
								modelAction.McuPackageItemModelActionTypes.DELETE_MCU_PACKAGE_ITEM_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.McuPackageItemAction>(modelAction.McuPackageItemModelActionTypes.DELETE_ALL_MCU_PACKAGE_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.McuPackageItemActionOK(
						modelAction.McuPackageItemModelActionTypes.DELETE_ALL_MCU_PACKAGE_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.McuPackageItemActionFail(
								modelAction.McuPackageItemModelActionTypes.DELETE_ALL_MCU_PACKAGE_ITEM_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.McuPackageItemAction>(modelAction.McuPackageItemModelActionTypes.EXPORT_MCU_PACKAGE_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.McuPackageItemActionOK(
						modelAction.McuPackageItemModelActionTypes.EXPORT_MCU_PACKAGE_ITEM,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.McuPackageItemAction>(modelAction.McuPackageItemModelActionTypes.EXPORT_ALL_MCU_PACKAGE_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.McuPackageItemActionOK(
						modelAction.McuPackageItemModelActionTypes.EXPORT_ALL_MCU_PACKAGE_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.McuPackageItemActionFail(
								modelAction.McuPackageItemModelActionTypes.EXPORT_ALL_MCU_PACKAGE_ITEM_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.McuPackageItemAction>(modelAction.McuPackageItemModelActionTypes.EXPORT_MCU_PACKAGE_ITEM_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.McuPackageItemActionOK(
						modelAction.McuPackageItemModelActionTypes.EXPORT_MCU_PACKAGE_ITEM_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.McuPackageItemActionFail(
								modelAction.McuPackageItemModelActionTypes.EXPORT_MCU_PACKAGE_ITEM_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.McuPackageItemAction>(modelAction.McuPackageItemModelActionTypes.IMPORT_MCU_PACKAGE_ITEMS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.McuPackageItemActionOK(
						modelAction.McuPackageItemModelActionTypes.IMPORT_MCU_PACKAGE_ITEMS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.McuPackageItemActionFail(
								modelAction.McuPackageItemModelActionTypes.IMPORT_MCU_PACKAGE_ITEMS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.McuPackageItemAction>(modelAction.McuPackageItemModelActionTypes.FETCH_MCU_PACKAGE_ITEM_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.McuPackageItemActionOK(
						modelAction.McuPackageItemModelActionTypes.FETCH_MCU_PACKAGE_ITEM_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.McuPackageItemActionFail(
								modelAction.McuPackageItemModelActionTypes.FETCH_MCU_PACKAGE_ITEM_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.McuPackageItemAction>(modelAction.McuPackageItemModelActionTypes.FETCH_MCU_PACKAGE_ITEM_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.McuPackageItemActionOK(
						modelAction.McuPackageItemModelActionTypes.FETCH_MCU_PACKAGE_ITEM_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.McuPackageItemActionFail(
								modelAction.McuPackageItemModelActionTypes.FETCH_MCU_PACKAGE_ITEM_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
