...
import * as modelAction from './bpjs_hospitalization_plan.model.action';
import {BpjsHospitalizationPlanService} from '../../services/bpjsHospitalizationPlan/bpjs_hospitalization_plan.service';
...
/**
 * Effect class used for side effects related to BPJS Hospitalization Plan model.
 */
@Injectable()
export class BpjsHospitalizationPlanEffect {
	...
	constructor(
		...
		protected readonly service: BpjsHospitalizationPlanService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsHospitalizationPlanAction>(modelAction.BpjsHospitalizationPlanModelActionTypes.COUNT_BPJS_HOSPITALIZATION_PLANS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsHospitalizationPlanActionOK(
						modelAction.BpjsHospitalizationPlanModelActionTypes.COUNT_BPJS_HOSPITALIZATION_PLANS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsHospitalizationPlanActionFail(
								modelAction.BpjsHospitalizationPlanModelActionTypes.COUNT_BPJS_HOSPITALIZATION_PLANS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsHospitalizationPlanAction>(modelAction.BpjsHospitalizationPlanModelActionTypes.FETCH_BPJS_HOSPITALIZATION_PLAN),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsHospitalizationPlanActionOK(
						modelAction.BpjsHospitalizationPlanModelActionTypes.FETCH_BPJS_HOSPITALIZATION_PLAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsHospitalizationPlanActionFail(
								modelAction.BpjsHospitalizationPlanModelActionTypes.FETCH_BPJS_HOSPITALIZATION_PLAN_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsHospitalizationPlanAction>(modelAction.BpjsHospitalizationPlanModelActionTypes.FETCH_ALL_BPJS_HOSPITALIZATION_PLAN),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsHospitalizationPlanActionOK(
						modelAction.BpjsHospitalizationPlanModelActionTypes.FETCH_ALL_BPJS_HOSPITALIZATION_PLAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsHospitalizationPlanActionFail(
								modelAction.BpjsHospitalizationPlanModelActionTypes.FETCH_ALL_BPJS_HOSPITALIZATION_PLAN_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsHospitalizationPlanAction>(modelAction.BpjsHospitalizationPlanModelActionTypes.FETCH_BPJS_HOSPITALIZATION_PLAN_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsHospitalizationPlanActionOK(
						modelAction.BpjsHospitalizationPlanModelActionTypes.FETCH_BPJS_HOSPITALIZATION_PLAN_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsHospitalizationPlanActionFail(
								modelAction.BpjsHospitalizationPlanModelActionTypes.FETCH_BPJS_HOSPITALIZATION_PLAN_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsHospitalizationPlanAction>(modelAction.BpjsHospitalizationPlanModelActionTypes.FETCH_LAST_BPJS_HOSPITALIZATION_PLAN_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsHospitalizationPlanActionOK(
						modelAction.BpjsHospitalizationPlanModelActionTypes.FETCH_LAST_BPJS_HOSPITALIZATION_PLAN_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsHospitalizationPlanActionFail(
								modelAction.BpjsHospitalizationPlanModelActionTypes.FETCH_LAST_BPJS_HOSPITALIZATION_PLAN_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsHospitalizationPlanAction>(modelAction.BpjsHospitalizationPlanModelActionTypes.CREATE_BPJS_HOSPITALIZATION_PLAN),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsHospitalizationPlanModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsHospitalizationPlanActionOK(
						modelAction.BpjsHospitalizationPlanModelActionTypes.CREATE_BPJS_HOSPITALIZATION_PLAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsHospitalizationPlanActionFail(
								modelAction.BpjsHospitalizationPlanModelActionTypes.CREATE_BPJS_HOSPITALIZATION_PLAN_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsHospitalizationPlanAction>(modelAction.BpjsHospitalizationPlanModelActionTypes.CREATE_ALL_BPJS_HOSPITALIZATION_PLAN),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsHospitalizationPlanModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsHospitalizationPlanActionOK(
						modelAction.BpjsHospitalizationPlanModelActionTypes.CREATE_ALL_BPJS_HOSPITALIZATION_PLAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsHospitalizationPlanActionFail(
								modelAction.BpjsHospitalizationPlanModelActionTypes.CREATE_ALL_BPJS_HOSPITALIZATION_PLAN_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsHospitalizationPlanAction>(modelAction.BpjsHospitalizationPlanModelActionTypes.UPDATE_BPJS_HOSPITALIZATION_PLAN),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsHospitalizationPlanModel;
				...
				return this.service.update(new BpjsHospitalizationPlanModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsHospitalizationPlanActionOK(
						modelAction.BpjsHospitalizationPlanModelActionTypes.UPDATE_BPJS_HOSPITALIZATION_PLAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsHospitalizationPlanActionFail(
								modelAction.BpjsHospitalizationPlanModelActionTypes.UPDATE_BPJS_HOSPITALIZATION_PLAN_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsHospitalizationPlanAction>(modelAction.BpjsHospitalizationPlanModelActionTypes.UPDATE_ALL_BPJS_HOSPITALIZATION_PLAN),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsHospitalizationPlanModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsHospitalizationPlanModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsHospitalizationPlanActionOK(
						modelAction.BpjsHospitalizationPlanModelActionTypes.UPDATE_ALL_BPJS_HOSPITALIZATION_PLAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsHospitalizationPlanActionFail(
								modelAction.BpjsHospitalizationPlanModelActionTypes.UPDATE_ALL_BPJS_HOSPITALIZATION_PLAN_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsHospitalizationPlanAction>(modelAction.BpjsHospitalizationPlanModelActionTypes.DELETE_BPJS_HOSPITALIZATION_PLAN),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsHospitalizationPlanActionOK(
						modelAction.BpjsHospitalizationPlanModelActionTypes.DELETE_BPJS_HOSPITALIZATION_PLAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsHospitalizationPlanActionFail(
								modelAction.BpjsHospitalizationPlanModelActionTypes.DELETE_BPJS_HOSPITALIZATION_PLAN_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsHospitalizationPlanAction>(modelAction.BpjsHospitalizationPlanModelActionTypes.DELETE_BPJS_HOSPITALIZATION_PLAN_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsHospitalizationPlanActionOK(
						modelAction.BpjsHospitalizationPlanModelActionTypes.DELETE_BPJS_HOSPITALIZATION_PLAN_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsHospitalizationPlanActionFail(
								modelAction.BpjsHospitalizationPlanModelActionTypes.DELETE_BPJS_HOSPITALIZATION_PLAN_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsHospitalizationPlanAction>(modelAction.BpjsHospitalizationPlanModelActionTypes.DELETE_ALL_BPJS_HOSPITALIZATION_PLAN),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsHospitalizationPlanActionOK(
						modelAction.BpjsHospitalizationPlanModelActionTypes.DELETE_ALL_BPJS_HOSPITALIZATION_PLAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsHospitalizationPlanActionFail(
								modelAction.BpjsHospitalizationPlanModelActionTypes.DELETE_ALL_BPJS_HOSPITALIZATION_PLAN_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsHospitalizationPlanAction>(modelAction.BpjsHospitalizationPlanModelActionTypes.EXPORT_BPJS_HOSPITALIZATION_PLAN),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsHospitalizationPlanActionOK(
						modelAction.BpjsHospitalizationPlanModelActionTypes.EXPORT_BPJS_HOSPITALIZATION_PLAN,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsHospitalizationPlanAction>(modelAction.BpjsHospitalizationPlanModelActionTypes.EXPORT_ALL_BPJS_HOSPITALIZATION_PLAN),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsHospitalizationPlanActionOK(
						modelAction.BpjsHospitalizationPlanModelActionTypes.EXPORT_ALL_BPJS_HOSPITALIZATION_PLAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsHospitalizationPlanActionFail(
								modelAction.BpjsHospitalizationPlanModelActionTypes.EXPORT_ALL_BPJS_HOSPITALIZATION_PLAN_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsHospitalizationPlanAction>(modelAction.BpjsHospitalizationPlanModelActionTypes.EXPORT_BPJS_HOSPITALIZATION_PLAN_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsHospitalizationPlanActionOK(
						modelAction.BpjsHospitalizationPlanModelActionTypes.EXPORT_BPJS_HOSPITALIZATION_PLAN_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsHospitalizationPlanActionFail(
								modelAction.BpjsHospitalizationPlanModelActionTypes.EXPORT_BPJS_HOSPITALIZATION_PLAN_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsHospitalizationPlanAction>(modelAction.BpjsHospitalizationPlanModelActionTypes.IMPORT_BPJS_HOSPITALIZATION_PLANS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsHospitalizationPlanActionOK(
						modelAction.BpjsHospitalizationPlanModelActionTypes.IMPORT_BPJS_HOSPITALIZATION_PLANS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsHospitalizationPlanActionFail(
								modelAction.BpjsHospitalizationPlanModelActionTypes.IMPORT_BPJS_HOSPITALIZATION_PLANS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsHospitalizationPlanAction>(modelAction.BpjsHospitalizationPlanModelActionTypes.FETCH_BPJS_HOSPITALIZATION_PLAN_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsHospitalizationPlanActionOK(
						modelAction.BpjsHospitalizationPlanModelActionTypes.FETCH_BPJS_HOSPITALIZATION_PLAN_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsHospitalizationPlanActionFail(
								modelAction.BpjsHospitalizationPlanModelActionTypes.FETCH_BPJS_HOSPITALIZATION_PLAN_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsHospitalizationPlanAction>(modelAction.BpjsHospitalizationPlanModelActionTypes.FETCH_BPJS_HOSPITALIZATION_PLAN_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsHospitalizationPlanActionOK(
						modelAction.BpjsHospitalizationPlanModelActionTypes.FETCH_BPJS_HOSPITALIZATION_PLAN_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsHospitalizationPlanActionFail(
								modelAction.BpjsHospitalizationPlanModelActionTypes.FETCH_BPJS_HOSPITALIZATION_PLAN_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
