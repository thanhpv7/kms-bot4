...
/**
 * BpjsHospitalizationPlanCollectionState would store the state of a collection of BpjsHospitalizationPlan
 */
export interface BpjsHospitalizationPlanCollectionState extends CollectionState {
 ...
 */
export interface BpjsHospitalizationPlanModelAudit extends AbstractModelAudit<BpjsHospitalizationPlanModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsHospitalizationPlanModelState would store the state of the model
 */
export interface BpjsHospitalizationPlanModelState {
	collectionState: {
		[key: string]: BpjsHospitalizationPlanCollectionState;
	};
	data: {
		[id: string]: BpjsHospitalizationPlanModel;
	};
	totalCount: number;
	audits: BpjsHospitalizationPlanModelAudit[];
 ...
 */
export const initialBpjsHospitalizationPlanCollectionState: BpjsHospitalizationPlanCollectionState = {
...
/**
 * The initial state of BpjsHospitalizationPlanModelState
 */
export const initialState: BpjsHospitalizationPlanModelState = {
	collectionState: {
