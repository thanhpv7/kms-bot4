...
/**
 * BpjsPcareRiwayatKunjunganCollectionState would store the state of a collection of BpjsPcareRiwayatKunjungan
 */
export interface BpjsPcareRiwayatKunjunganCollectionState extends CollectionState {
 ...
 */
export interface BpjsPcareRiwayatKunjunganModelAudit extends AbstractModelAudit<BpjsPcareRiwayatKunjunganModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsPcareRiwayatKunjunganModelState would store the state of the model
 */
export interface BpjsPcareRiwayatKunjunganModelState {
	collectionState: {
		[key: string]: BpjsPcareRiwayatKunjunganCollectionState;
	};
	data: {
		[id: string]: BpjsPcareRiwayatKunjunganModel;
	};
	totalCount: number;
	audits: BpjsPcareRiwayatKunjunganModelAudit[];
 ...
 */
export const initialBpjsPcareRiwayatKunjunganCollectionState: BpjsPcareRiwayatKunjunganCollectionState = {
...
/**
 * The initial state of BpjsPcareRiwayatKunjunganModelState
 */
export const initialState: BpjsPcareRiwayatKunjunganModelState = {
	collectionState: {
