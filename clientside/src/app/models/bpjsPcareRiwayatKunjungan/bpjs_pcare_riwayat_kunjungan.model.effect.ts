...
import * as modelAction from './bpjs_pcare_riwayat_kunjungan.model.action';
import {BpjsPcareRiwayatKunjunganService} from '../../services/bpjsPcareRiwayatKunjungan/bpjs_pcare_riwayat_kunjungan.service';
...
/**
 * Effect class used for side effects related to Bpjs Pcare Riwayat Kunjungan model.
 */
@Injectable()
export class BpjsPcareRiwayatKunjunganEffect {
	...
	constructor(
		...
		protected readonly service: BpjsPcareRiwayatKunjunganService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareRiwayatKunjunganAction>(modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.COUNT_BPJS_PCARE_RIWAYAT_KUNJUNGANS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareRiwayatKunjunganActionOK(
						modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.COUNT_BPJS_PCARE_RIWAYAT_KUNJUNGANS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareRiwayatKunjunganActionFail(
								modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.COUNT_BPJS_PCARE_RIWAYAT_KUNJUNGANS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareRiwayatKunjunganAction>(modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.FETCH_BPJS_PCARE_RIWAYAT_KUNJUNGAN),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareRiwayatKunjunganActionOK(
						modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.FETCH_BPJS_PCARE_RIWAYAT_KUNJUNGAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareRiwayatKunjunganActionFail(
								modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.FETCH_BPJS_PCARE_RIWAYAT_KUNJUNGAN_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareRiwayatKunjunganAction>(modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.FETCH_ALL_BPJS_PCARE_RIWAYAT_KUNJUNGAN),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareRiwayatKunjunganActionOK(
						modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.FETCH_ALL_BPJS_PCARE_RIWAYAT_KUNJUNGAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareRiwayatKunjunganActionFail(
								modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.FETCH_ALL_BPJS_PCARE_RIWAYAT_KUNJUNGAN_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareRiwayatKunjunganAction>(modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.FETCH_BPJS_PCARE_RIWAYAT_KUNJUNGAN_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareRiwayatKunjunganActionOK(
						modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.FETCH_BPJS_PCARE_RIWAYAT_KUNJUNGAN_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareRiwayatKunjunganActionFail(
								modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.FETCH_BPJS_PCARE_RIWAYAT_KUNJUNGAN_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareRiwayatKunjunganAction>(modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.FETCH_LAST_BPJS_PCARE_RIWAYAT_KUNJUNGAN_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareRiwayatKunjunganActionOK(
						modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.FETCH_LAST_BPJS_PCARE_RIWAYAT_KUNJUNGAN_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareRiwayatKunjunganActionFail(
								modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.FETCH_LAST_BPJS_PCARE_RIWAYAT_KUNJUNGAN_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareRiwayatKunjunganAction>(modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.CREATE_BPJS_PCARE_RIWAYAT_KUNJUNGAN),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsPcareRiwayatKunjunganModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareRiwayatKunjunganActionOK(
						modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.CREATE_BPJS_PCARE_RIWAYAT_KUNJUNGAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareRiwayatKunjunganActionFail(
								modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.CREATE_BPJS_PCARE_RIWAYAT_KUNJUNGAN_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareRiwayatKunjunganAction>(modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.CREATE_ALL_BPJS_PCARE_RIWAYAT_KUNJUNGAN),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsPcareRiwayatKunjunganModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareRiwayatKunjunganActionOK(
						modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.CREATE_ALL_BPJS_PCARE_RIWAYAT_KUNJUNGAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareRiwayatKunjunganActionFail(
								modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.CREATE_ALL_BPJS_PCARE_RIWAYAT_KUNJUNGAN_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareRiwayatKunjunganAction>(modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.UPDATE_BPJS_PCARE_RIWAYAT_KUNJUNGAN),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsPcareRiwayatKunjunganModel;
				...
				return this.service.update(new BpjsPcareRiwayatKunjunganModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareRiwayatKunjunganActionOK(
						modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.UPDATE_BPJS_PCARE_RIWAYAT_KUNJUNGAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareRiwayatKunjunganActionFail(
								modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.UPDATE_BPJS_PCARE_RIWAYAT_KUNJUNGAN_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareRiwayatKunjunganAction>(modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.UPDATE_ALL_BPJS_PCARE_RIWAYAT_KUNJUNGAN),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsPcareRiwayatKunjunganModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsPcareRiwayatKunjunganModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareRiwayatKunjunganActionOK(
						modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.UPDATE_ALL_BPJS_PCARE_RIWAYAT_KUNJUNGAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareRiwayatKunjunganActionFail(
								modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.UPDATE_ALL_BPJS_PCARE_RIWAYAT_KUNJUNGAN_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareRiwayatKunjunganAction>(modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.DELETE_BPJS_PCARE_RIWAYAT_KUNJUNGAN),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareRiwayatKunjunganActionOK(
						modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.DELETE_BPJS_PCARE_RIWAYAT_KUNJUNGAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareRiwayatKunjunganActionFail(
								modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.DELETE_BPJS_PCARE_RIWAYAT_KUNJUNGAN_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareRiwayatKunjunganAction>(modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.DELETE_BPJS_PCARE_RIWAYAT_KUNJUNGAN_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareRiwayatKunjunganActionOK(
						modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.DELETE_BPJS_PCARE_RIWAYAT_KUNJUNGAN_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareRiwayatKunjunganActionFail(
								modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.DELETE_BPJS_PCARE_RIWAYAT_KUNJUNGAN_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareRiwayatKunjunganAction>(modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.DELETE_ALL_BPJS_PCARE_RIWAYAT_KUNJUNGAN),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareRiwayatKunjunganActionOK(
						modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.DELETE_ALL_BPJS_PCARE_RIWAYAT_KUNJUNGAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareRiwayatKunjunganActionFail(
								modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.DELETE_ALL_BPJS_PCARE_RIWAYAT_KUNJUNGAN_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareRiwayatKunjunganAction>(modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.EXPORT_BPJS_PCARE_RIWAYAT_KUNJUNGAN),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareRiwayatKunjunganActionOK(
						modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.EXPORT_BPJS_PCARE_RIWAYAT_KUNJUNGAN,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareRiwayatKunjunganAction>(modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.EXPORT_ALL_BPJS_PCARE_RIWAYAT_KUNJUNGAN),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareRiwayatKunjunganActionOK(
						modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.EXPORT_ALL_BPJS_PCARE_RIWAYAT_KUNJUNGAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareRiwayatKunjunganActionFail(
								modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.EXPORT_ALL_BPJS_PCARE_RIWAYAT_KUNJUNGAN_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareRiwayatKunjunganAction>(modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.EXPORT_BPJS_PCARE_RIWAYAT_KUNJUNGAN_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareRiwayatKunjunganActionOK(
						modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.EXPORT_BPJS_PCARE_RIWAYAT_KUNJUNGAN_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareRiwayatKunjunganActionFail(
								modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.EXPORT_BPJS_PCARE_RIWAYAT_KUNJUNGAN_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareRiwayatKunjunganAction>(modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.IMPORT_BPJS_PCARE_RIWAYAT_KUNJUNGANS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareRiwayatKunjunganActionOK(
						modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.IMPORT_BPJS_PCARE_RIWAYAT_KUNJUNGANS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareRiwayatKunjunganActionFail(
								modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.IMPORT_BPJS_PCARE_RIWAYAT_KUNJUNGANS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareRiwayatKunjunganAction>(modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.FETCH_BPJS_PCARE_RIWAYAT_KUNJUNGAN_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsPcareRiwayatKunjunganActionOK(
						modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.FETCH_BPJS_PCARE_RIWAYAT_KUNJUNGAN_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareRiwayatKunjunganActionFail(
								modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.FETCH_BPJS_PCARE_RIWAYAT_KUNJUNGAN_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareRiwayatKunjunganAction>(modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.FETCH_BPJS_PCARE_RIWAYAT_KUNJUNGAN_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsPcareRiwayatKunjunganActionOK(
						modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.FETCH_BPJS_PCARE_RIWAYAT_KUNJUNGAN_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareRiwayatKunjunganActionFail(
								modelAction.BpjsPcareRiwayatKunjunganModelActionTypes.FETCH_BPJS_PCARE_RIWAYAT_KUNJUNGAN_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
