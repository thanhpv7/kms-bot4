...
import * as modelAction from './purchase_requisition_stock_detail.model.action';
import {PurchaseRequisitionStockDetailService} from '../../services/purchaseRequisitionStockDetail/purchase_requisition_stock_detail.service';
...
/**
 * Effect class used for side effects related to Purchase Requisition Stock Detail model.
 */
@Injectable()
export class PurchaseRequisitionStockDetailEffect {
	...
	constructor(
		...
		protected readonly service: PurchaseRequisitionStockDetailService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseRequisitionStockDetailAction>(modelAction.PurchaseRequisitionStockDetailModelActionTypes.COUNT_PURCHASE_REQUISITION_STOCK_DETAILS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.PurchaseRequisitionStockDetailActionOK(
						modelAction.PurchaseRequisitionStockDetailModelActionTypes.COUNT_PURCHASE_REQUISITION_STOCK_DETAILS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseRequisitionStockDetailActionFail(
								modelAction.PurchaseRequisitionStockDetailModelActionTypes.COUNT_PURCHASE_REQUISITION_STOCK_DETAILS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseRequisitionStockDetailAction>(modelAction.PurchaseRequisitionStockDetailModelActionTypes.FETCH_PURCHASE_REQUISITION_STOCK_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PurchaseRequisitionStockDetailActionOK(
						modelAction.PurchaseRequisitionStockDetailModelActionTypes.FETCH_PURCHASE_REQUISITION_STOCK_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseRequisitionStockDetailActionFail(
								modelAction.PurchaseRequisitionStockDetailModelActionTypes.FETCH_PURCHASE_REQUISITION_STOCK_DETAIL_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseRequisitionStockDetailAction>(modelAction.PurchaseRequisitionStockDetailModelActionTypes.FETCH_ALL_PURCHASE_REQUISITION_STOCK_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.PurchaseRequisitionStockDetailActionOK(
						modelAction.PurchaseRequisitionStockDetailModelActionTypes.FETCH_ALL_PURCHASE_REQUISITION_STOCK_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseRequisitionStockDetailActionFail(
								modelAction.PurchaseRequisitionStockDetailModelActionTypes.FETCH_ALL_PURCHASE_REQUISITION_STOCK_DETAIL_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseRequisitionStockDetailAction>(modelAction.PurchaseRequisitionStockDetailModelActionTypes.FETCH_PURCHASE_REQUISITION_STOCK_DETAIL_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PurchaseRequisitionStockDetailActionOK(
						modelAction.PurchaseRequisitionStockDetailModelActionTypes.FETCH_PURCHASE_REQUISITION_STOCK_DETAIL_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseRequisitionStockDetailActionFail(
								modelAction.PurchaseRequisitionStockDetailModelActionTypes.FETCH_PURCHASE_REQUISITION_STOCK_DETAIL_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseRequisitionStockDetailAction>(modelAction.PurchaseRequisitionStockDetailModelActionTypes.FETCH_LAST_PURCHASE_REQUISITION_STOCK_DETAIL_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PurchaseRequisitionStockDetailActionOK(
						modelAction.PurchaseRequisitionStockDetailModelActionTypes.FETCH_LAST_PURCHASE_REQUISITION_STOCK_DETAIL_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseRequisitionStockDetailActionFail(
								modelAction.PurchaseRequisitionStockDetailModelActionTypes.FETCH_LAST_PURCHASE_REQUISITION_STOCK_DETAIL_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseRequisitionStockDetailAction>(modelAction.PurchaseRequisitionStockDetailModelActionTypes.CREATE_PURCHASE_REQUISITION_STOCK_DETAIL),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as PurchaseRequisitionStockDetailModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PurchaseRequisitionStockDetailActionOK(
						modelAction.PurchaseRequisitionStockDetailModelActionTypes.CREATE_PURCHASE_REQUISITION_STOCK_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseRequisitionStockDetailActionFail(
								modelAction.PurchaseRequisitionStockDetailModelActionTypes.CREATE_PURCHASE_REQUISITION_STOCK_DETAIL_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseRequisitionStockDetailAction>(modelAction.PurchaseRequisitionStockDetailModelActionTypes.CREATE_ALL_PURCHASE_REQUISITION_STOCK_DETAIL),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as PurchaseRequisitionStockDetailModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PurchaseRequisitionStockDetailActionOK(
						modelAction.PurchaseRequisitionStockDetailModelActionTypes.CREATE_ALL_PURCHASE_REQUISITION_STOCK_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseRequisitionStockDetailActionFail(
								modelAction.PurchaseRequisitionStockDetailModelActionTypes.CREATE_ALL_PURCHASE_REQUISITION_STOCK_DETAIL_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseRequisitionStockDetailAction>(modelAction.PurchaseRequisitionStockDetailModelActionTypes.UPDATE_PURCHASE_REQUISITION_STOCK_DETAIL),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as PurchaseRequisitionStockDetailModel;
				...
				return this.service.update(new PurchaseRequisitionStockDetailModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.PurchaseRequisitionStockDetailActionOK(
						modelAction.PurchaseRequisitionStockDetailModelActionTypes.UPDATE_PURCHASE_REQUISITION_STOCK_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseRequisitionStockDetailActionFail(
								modelAction.PurchaseRequisitionStockDetailModelActionTypes.UPDATE_PURCHASE_REQUISITION_STOCK_DETAIL_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseRequisitionStockDetailAction>(modelAction.PurchaseRequisitionStockDetailModelActionTypes.UPDATE_ALL_PURCHASE_REQUISITION_STOCK_DETAIL),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as PurchaseRequisitionStockDetailModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new PurchaseRequisitionStockDetailModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PurchaseRequisitionStockDetailActionOK(
						modelAction.PurchaseRequisitionStockDetailModelActionTypes.UPDATE_ALL_PURCHASE_REQUISITION_STOCK_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseRequisitionStockDetailActionFail(
								modelAction.PurchaseRequisitionStockDetailModelActionTypes.UPDATE_ALL_PURCHASE_REQUISITION_STOCK_DETAIL_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseRequisitionStockDetailAction>(modelAction.PurchaseRequisitionStockDetailModelActionTypes.DELETE_PURCHASE_REQUISITION_STOCK_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PurchaseRequisitionStockDetailActionOK(
						modelAction.PurchaseRequisitionStockDetailModelActionTypes.DELETE_PURCHASE_REQUISITION_STOCK_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseRequisitionStockDetailActionFail(
								modelAction.PurchaseRequisitionStockDetailModelActionTypes.DELETE_PURCHASE_REQUISITION_STOCK_DETAIL_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseRequisitionStockDetailAction>(modelAction.PurchaseRequisitionStockDetailModelActionTypes.DELETE_PURCHASE_REQUISITION_STOCK_DETAIL_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.PurchaseRequisitionStockDetailActionOK(
						modelAction.PurchaseRequisitionStockDetailModelActionTypes.DELETE_PURCHASE_REQUISITION_STOCK_DETAIL_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseRequisitionStockDetailActionFail(
								modelAction.PurchaseRequisitionStockDetailModelActionTypes.DELETE_PURCHASE_REQUISITION_STOCK_DETAIL_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseRequisitionStockDetailAction>(modelAction.PurchaseRequisitionStockDetailModelActionTypes.DELETE_ALL_PURCHASE_REQUISITION_STOCK_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PurchaseRequisitionStockDetailActionOK(
						modelAction.PurchaseRequisitionStockDetailModelActionTypes.DELETE_ALL_PURCHASE_REQUISITION_STOCK_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseRequisitionStockDetailActionFail(
								modelAction.PurchaseRequisitionStockDetailModelActionTypes.DELETE_ALL_PURCHASE_REQUISITION_STOCK_DETAIL_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseRequisitionStockDetailAction>(modelAction.PurchaseRequisitionStockDetailModelActionTypes.EXPORT_PURCHASE_REQUISITION_STOCK_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PurchaseRequisitionStockDetailActionOK(
						modelAction.PurchaseRequisitionStockDetailModelActionTypes.EXPORT_PURCHASE_REQUISITION_STOCK_DETAIL,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseRequisitionStockDetailAction>(modelAction.PurchaseRequisitionStockDetailModelActionTypes.EXPORT_ALL_PURCHASE_REQUISITION_STOCK_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PurchaseRequisitionStockDetailActionOK(
						modelAction.PurchaseRequisitionStockDetailModelActionTypes.EXPORT_ALL_PURCHASE_REQUISITION_STOCK_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseRequisitionStockDetailActionFail(
								modelAction.PurchaseRequisitionStockDetailModelActionTypes.EXPORT_ALL_PURCHASE_REQUISITION_STOCK_DETAIL_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseRequisitionStockDetailAction>(modelAction.PurchaseRequisitionStockDetailModelActionTypes.EXPORT_PURCHASE_REQUISITION_STOCK_DETAIL_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PurchaseRequisitionStockDetailActionOK(
						modelAction.PurchaseRequisitionStockDetailModelActionTypes.EXPORT_PURCHASE_REQUISITION_STOCK_DETAIL_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseRequisitionStockDetailActionFail(
								modelAction.PurchaseRequisitionStockDetailModelActionTypes.EXPORT_PURCHASE_REQUISITION_STOCK_DETAIL_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseRequisitionStockDetailAction>(modelAction.PurchaseRequisitionStockDetailModelActionTypes.IMPORT_PURCHASE_REQUISITION_STOCK_DETAILS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.PurchaseRequisitionStockDetailActionOK(
						modelAction.PurchaseRequisitionStockDetailModelActionTypes.IMPORT_PURCHASE_REQUISITION_STOCK_DETAILS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseRequisitionStockDetailActionFail(
								modelAction.PurchaseRequisitionStockDetailModelActionTypes.IMPORT_PURCHASE_REQUISITION_STOCK_DETAILS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseRequisitionStockDetailAction>(modelAction.PurchaseRequisitionStockDetailModelActionTypes.FETCH_PURCHASE_REQUISITION_STOCK_DETAIL_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.PurchaseRequisitionStockDetailActionOK(
						modelAction.PurchaseRequisitionStockDetailModelActionTypes.FETCH_PURCHASE_REQUISITION_STOCK_DETAIL_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseRequisitionStockDetailActionFail(
								modelAction.PurchaseRequisitionStockDetailModelActionTypes.FETCH_PURCHASE_REQUISITION_STOCK_DETAIL_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchaseRequisitionStockDetailAction>(modelAction.PurchaseRequisitionStockDetailModelActionTypes.FETCH_PURCHASE_REQUISITION_STOCK_DETAIL_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.PurchaseRequisitionStockDetailActionOK(
						modelAction.PurchaseRequisitionStockDetailModelActionTypes.FETCH_PURCHASE_REQUISITION_STOCK_DETAIL_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PurchaseRequisitionStockDetailActionFail(
								modelAction.PurchaseRequisitionStockDetailModelActionTypes.FETCH_PURCHASE_REQUISITION_STOCK_DETAIL_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
