...
/**
 * PurchaseRequisitionStockDetailCollectionState would store the state of a collection of PurchaseRequisitionStockDetail
 */
export interface PurchaseRequisitionStockDetailCollectionState extends CollectionState {
 ...
 */
export interface PurchaseRequisitionStockDetailModelAudit extends AbstractModelAudit<PurchaseRequisitionStockDetailModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * PurchaseRequisitionStockDetailModelState would store the state of the model
 */
export interface PurchaseRequisitionStockDetailModelState {
	collectionState: {
		[key: string]: PurchaseRequisitionStockDetailCollectionState;
	};
	data: {
		[id: string]: PurchaseRequisitionStockDetailModel;
	};
	totalCount: number;
	audits: PurchaseRequisitionStockDetailModelAudit[];
 ...
 */
export const initialPurchaseRequisitionStockDetailCollectionState: PurchaseRequisitionStockDetailCollectionState = {
...
/**
 * The initial state of PurchaseRequisitionStockDetailModelState
 */
export const initialState: PurchaseRequisitionStockDetailModelState = {
	collectionState: {
