...
/**
 * InsuranceBenefitPlanCollectionState would store the state of a collection of InsuranceBenefitPlan
 */
export interface InsuranceBenefitPlanCollectionState extends CollectionState {
 ...
 */
export interface InsuranceBenefitPlanModelAudit extends AbstractModelAudit<InsuranceBenefitPlanModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * InsuranceBenefitPlanModelState would store the state of the model
 */
export interface InsuranceBenefitPlanModelState {
	collectionState: {
		[key: string]: InsuranceBenefitPlanCollectionState;
	};
	data: {
		[id: string]: InsuranceBenefitPlanModel;
	};
	totalCount: number;
	audits: InsuranceBenefitPlanModelAudit[];
 ...
 */
export const initialInsuranceBenefitPlanCollectionState: InsuranceBenefitPlanCollectionState = {
...
/**
 * The initial state of InsuranceBenefitPlanModelState
 */
export const initialState: InsuranceBenefitPlanModelState = {
	collectionState: {
