...
import * as modelAction from './insurance_benefit_plan.model.action';
import {InsuranceBenefitPlanService} from '../../services/insuranceBenefitPlan/insurance_benefit_plan.service';
...
/**
 * Effect class used for side effects related to Insurance Benefit Plan model.
 */
@Injectable()
export class InsuranceBenefitPlanEffect {
	...
	constructor(
		...
		protected readonly service: InsuranceBenefitPlanService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InsuranceBenefitPlanAction>(modelAction.InsuranceBenefitPlanModelActionTypes.COUNT_INSURANCE_BENEFIT_PLANS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.InsuranceBenefitPlanActionOK(
						modelAction.InsuranceBenefitPlanModelActionTypes.COUNT_INSURANCE_BENEFIT_PLANS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InsuranceBenefitPlanActionFail(
								modelAction.InsuranceBenefitPlanModelActionTypes.COUNT_INSURANCE_BENEFIT_PLANS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InsuranceBenefitPlanAction>(modelAction.InsuranceBenefitPlanModelActionTypes.FETCH_INSURANCE_BENEFIT_PLAN),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InsuranceBenefitPlanActionOK(
						modelAction.InsuranceBenefitPlanModelActionTypes.FETCH_INSURANCE_BENEFIT_PLAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InsuranceBenefitPlanActionFail(
								modelAction.InsuranceBenefitPlanModelActionTypes.FETCH_INSURANCE_BENEFIT_PLAN_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InsuranceBenefitPlanAction>(modelAction.InsuranceBenefitPlanModelActionTypes.FETCH_ALL_INSURANCE_BENEFIT_PLAN),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.InsuranceBenefitPlanActionOK(
						modelAction.InsuranceBenefitPlanModelActionTypes.FETCH_ALL_INSURANCE_BENEFIT_PLAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InsuranceBenefitPlanActionFail(
								modelAction.InsuranceBenefitPlanModelActionTypes.FETCH_ALL_INSURANCE_BENEFIT_PLAN_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InsuranceBenefitPlanAction>(modelAction.InsuranceBenefitPlanModelActionTypes.FETCH_INSURANCE_BENEFIT_PLAN_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.InsuranceBenefitPlanActionOK(
						modelAction.InsuranceBenefitPlanModelActionTypes.FETCH_INSURANCE_BENEFIT_PLAN_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InsuranceBenefitPlanActionFail(
								modelAction.InsuranceBenefitPlanModelActionTypes.FETCH_INSURANCE_BENEFIT_PLAN_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InsuranceBenefitPlanAction>(modelAction.InsuranceBenefitPlanModelActionTypes.FETCH_LAST_INSURANCE_BENEFIT_PLAN_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.InsuranceBenefitPlanActionOK(
						modelAction.InsuranceBenefitPlanModelActionTypes.FETCH_LAST_INSURANCE_BENEFIT_PLAN_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InsuranceBenefitPlanActionFail(
								modelAction.InsuranceBenefitPlanModelActionTypes.FETCH_LAST_INSURANCE_BENEFIT_PLAN_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InsuranceBenefitPlanAction>(modelAction.InsuranceBenefitPlanModelActionTypes.CREATE_INSURANCE_BENEFIT_PLAN),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as InsuranceBenefitPlanModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InsuranceBenefitPlanActionOK(
						modelAction.InsuranceBenefitPlanModelActionTypes.CREATE_INSURANCE_BENEFIT_PLAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InsuranceBenefitPlanActionFail(
								modelAction.InsuranceBenefitPlanModelActionTypes.CREATE_INSURANCE_BENEFIT_PLAN_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InsuranceBenefitPlanAction>(modelAction.InsuranceBenefitPlanModelActionTypes.CREATE_ALL_INSURANCE_BENEFIT_PLAN),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as InsuranceBenefitPlanModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InsuranceBenefitPlanActionOK(
						modelAction.InsuranceBenefitPlanModelActionTypes.CREATE_ALL_INSURANCE_BENEFIT_PLAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InsuranceBenefitPlanActionFail(
								modelAction.InsuranceBenefitPlanModelActionTypes.CREATE_ALL_INSURANCE_BENEFIT_PLAN_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InsuranceBenefitPlanAction>(modelAction.InsuranceBenefitPlanModelActionTypes.UPDATE_INSURANCE_BENEFIT_PLAN),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as InsuranceBenefitPlanModel;
				...
				return this.service.update(new InsuranceBenefitPlanModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.InsuranceBenefitPlanActionOK(
						modelAction.InsuranceBenefitPlanModelActionTypes.UPDATE_INSURANCE_BENEFIT_PLAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InsuranceBenefitPlanActionFail(
								modelAction.InsuranceBenefitPlanModelActionTypes.UPDATE_INSURANCE_BENEFIT_PLAN_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InsuranceBenefitPlanAction>(modelAction.InsuranceBenefitPlanModelActionTypes.UPDATE_ALL_INSURANCE_BENEFIT_PLAN),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as InsuranceBenefitPlanModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new InsuranceBenefitPlanModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InsuranceBenefitPlanActionOK(
						modelAction.InsuranceBenefitPlanModelActionTypes.UPDATE_ALL_INSURANCE_BENEFIT_PLAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InsuranceBenefitPlanActionFail(
								modelAction.InsuranceBenefitPlanModelActionTypes.UPDATE_ALL_INSURANCE_BENEFIT_PLAN_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InsuranceBenefitPlanAction>(modelAction.InsuranceBenefitPlanModelActionTypes.DELETE_INSURANCE_BENEFIT_PLAN),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.InsuranceBenefitPlanActionOK(
						modelAction.InsuranceBenefitPlanModelActionTypes.DELETE_INSURANCE_BENEFIT_PLAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InsuranceBenefitPlanActionFail(
								modelAction.InsuranceBenefitPlanModelActionTypes.DELETE_INSURANCE_BENEFIT_PLAN_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InsuranceBenefitPlanAction>(modelAction.InsuranceBenefitPlanModelActionTypes.DELETE_INSURANCE_BENEFIT_PLAN_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.InsuranceBenefitPlanActionOK(
						modelAction.InsuranceBenefitPlanModelActionTypes.DELETE_INSURANCE_BENEFIT_PLAN_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InsuranceBenefitPlanActionFail(
								modelAction.InsuranceBenefitPlanModelActionTypes.DELETE_INSURANCE_BENEFIT_PLAN_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InsuranceBenefitPlanAction>(modelAction.InsuranceBenefitPlanModelActionTypes.DELETE_ALL_INSURANCE_BENEFIT_PLAN),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.InsuranceBenefitPlanActionOK(
						modelAction.InsuranceBenefitPlanModelActionTypes.DELETE_ALL_INSURANCE_BENEFIT_PLAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InsuranceBenefitPlanActionFail(
								modelAction.InsuranceBenefitPlanModelActionTypes.DELETE_ALL_INSURANCE_BENEFIT_PLAN_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InsuranceBenefitPlanAction>(modelAction.InsuranceBenefitPlanModelActionTypes.EXPORT_INSURANCE_BENEFIT_PLAN),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.InsuranceBenefitPlanActionOK(
						modelAction.InsuranceBenefitPlanModelActionTypes.EXPORT_INSURANCE_BENEFIT_PLAN,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InsuranceBenefitPlanAction>(modelAction.InsuranceBenefitPlanModelActionTypes.EXPORT_ALL_INSURANCE_BENEFIT_PLAN),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.InsuranceBenefitPlanActionOK(
						modelAction.InsuranceBenefitPlanModelActionTypes.EXPORT_ALL_INSURANCE_BENEFIT_PLAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InsuranceBenefitPlanActionFail(
								modelAction.InsuranceBenefitPlanModelActionTypes.EXPORT_ALL_INSURANCE_BENEFIT_PLAN_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InsuranceBenefitPlanAction>(modelAction.InsuranceBenefitPlanModelActionTypes.EXPORT_INSURANCE_BENEFIT_PLAN_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.InsuranceBenefitPlanActionOK(
						modelAction.InsuranceBenefitPlanModelActionTypes.EXPORT_INSURANCE_BENEFIT_PLAN_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InsuranceBenefitPlanActionFail(
								modelAction.InsuranceBenefitPlanModelActionTypes.EXPORT_INSURANCE_BENEFIT_PLAN_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InsuranceBenefitPlanAction>(modelAction.InsuranceBenefitPlanModelActionTypes.IMPORT_INSURANCE_BENEFIT_PLANS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.InsuranceBenefitPlanActionOK(
						modelAction.InsuranceBenefitPlanModelActionTypes.IMPORT_INSURANCE_BENEFIT_PLANS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InsuranceBenefitPlanActionFail(
								modelAction.InsuranceBenefitPlanModelActionTypes.IMPORT_INSURANCE_BENEFIT_PLANS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InsuranceBenefitPlanAction>(modelAction.InsuranceBenefitPlanModelActionTypes.FETCH_INSURANCE_BENEFIT_PLAN_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.InsuranceBenefitPlanActionOK(
						modelAction.InsuranceBenefitPlanModelActionTypes.FETCH_INSURANCE_BENEFIT_PLAN_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.InsuranceBenefitPlanActionFail(
								modelAction.InsuranceBenefitPlanModelActionTypes.FETCH_INSURANCE_BENEFIT_PLAN_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InsuranceBenefitPlanAction>(modelAction.InsuranceBenefitPlanModelActionTypes.FETCH_INSURANCE_BENEFIT_PLAN_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.InsuranceBenefitPlanActionOK(
						modelAction.InsuranceBenefitPlanModelActionTypes.FETCH_INSURANCE_BENEFIT_PLAN_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.InsuranceBenefitPlanActionFail(
								modelAction.InsuranceBenefitPlanModelActionTypes.FETCH_INSURANCE_BENEFIT_PLAN_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
