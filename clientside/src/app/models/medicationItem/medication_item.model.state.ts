...
/**
 * MedicationItemCollectionState would store the state of a collection of MedicationItem
 */
export interface MedicationItemCollectionState extends CollectionState {
 ...
 */
export interface MedicationItemModelAudit extends AbstractModelAudit<MedicationItemModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * MedicationItemModelState would store the state of the model
 */
export interface MedicationItemModelState {
	collectionState: {
		[key: string]: MedicationItemCollectionState;
	};
	data: {
		[id: string]: MedicationItemModel;
	};
	totalCount: number;
	audits: MedicationItemModelAudit[];
 ...
 */
export const initialMedicationItemCollectionState: MedicationItemCollectionState = {
...
/**
 * The initial state of MedicationItemModelState
 */
export const initialState: MedicationItemModelState = {
	collectionState: {
