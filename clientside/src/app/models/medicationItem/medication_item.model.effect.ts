...
import * as modelAction from './medication_item.model.action';
import {MedicationItemService} from '../../services/medicationItem/medication_item.service';
...
/**
 * Effect class used for side effects related to Medication Item model.
 */
@Injectable()
export class MedicationItemEffect {
	...
	constructor(
		...
		protected readonly service: MedicationItemService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationItemAction>(modelAction.MedicationItemModelActionTypes.COUNT_MEDICATION_ITEMS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.MedicationItemActionOK(
						modelAction.MedicationItemModelActionTypes.COUNT_MEDICATION_ITEMS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationItemActionFail(
								modelAction.MedicationItemModelActionTypes.COUNT_MEDICATION_ITEMS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationItemAction>(modelAction.MedicationItemModelActionTypes.FETCH_MEDICATION_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicationItemActionOK(
						modelAction.MedicationItemModelActionTypes.FETCH_MEDICATION_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationItemActionFail(
								modelAction.MedicationItemModelActionTypes.FETCH_MEDICATION_ITEM_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationItemAction>(modelAction.MedicationItemModelActionTypes.FETCH_ALL_MEDICATION_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.MedicationItemActionOK(
						modelAction.MedicationItemModelActionTypes.FETCH_ALL_MEDICATION_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationItemActionFail(
								modelAction.MedicationItemModelActionTypes.FETCH_ALL_MEDICATION_ITEM_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationItemAction>(modelAction.MedicationItemModelActionTypes.FETCH_MEDICATION_ITEM_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicationItemActionOK(
						modelAction.MedicationItemModelActionTypes.FETCH_MEDICATION_ITEM_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationItemActionFail(
								modelAction.MedicationItemModelActionTypes.FETCH_MEDICATION_ITEM_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationItemAction>(modelAction.MedicationItemModelActionTypes.FETCH_LAST_MEDICATION_ITEM_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicationItemActionOK(
						modelAction.MedicationItemModelActionTypes.FETCH_LAST_MEDICATION_ITEM_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationItemActionFail(
								modelAction.MedicationItemModelActionTypes.FETCH_LAST_MEDICATION_ITEM_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationItemAction>(modelAction.MedicationItemModelActionTypes.CREATE_MEDICATION_ITEM),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as MedicationItemModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicationItemActionOK(
						modelAction.MedicationItemModelActionTypes.CREATE_MEDICATION_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationItemActionFail(
								modelAction.MedicationItemModelActionTypes.CREATE_MEDICATION_ITEM_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationItemAction>(modelAction.MedicationItemModelActionTypes.CREATE_ALL_MEDICATION_ITEM),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as MedicationItemModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicationItemActionOK(
						modelAction.MedicationItemModelActionTypes.CREATE_ALL_MEDICATION_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationItemActionFail(
								modelAction.MedicationItemModelActionTypes.CREATE_ALL_MEDICATION_ITEM_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationItemAction>(modelAction.MedicationItemModelActionTypes.UPDATE_MEDICATION_ITEM),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as MedicationItemModel;
				...
				return this.service.update(new MedicationItemModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicationItemActionOK(
						modelAction.MedicationItemModelActionTypes.UPDATE_MEDICATION_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationItemActionFail(
								modelAction.MedicationItemModelActionTypes.UPDATE_MEDICATION_ITEM_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationItemAction>(modelAction.MedicationItemModelActionTypes.UPDATE_ALL_MEDICATION_ITEM),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as MedicationItemModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new MedicationItemModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicationItemActionOK(
						modelAction.MedicationItemModelActionTypes.UPDATE_ALL_MEDICATION_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationItemActionFail(
								modelAction.MedicationItemModelActionTypes.UPDATE_ALL_MEDICATION_ITEM_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationItemAction>(modelAction.MedicationItemModelActionTypes.DELETE_MEDICATION_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.MedicationItemActionOK(
						modelAction.MedicationItemModelActionTypes.DELETE_MEDICATION_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationItemActionFail(
								modelAction.MedicationItemModelActionTypes.DELETE_MEDICATION_ITEM_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationItemAction>(modelAction.MedicationItemModelActionTypes.DELETE_MEDICATION_ITEM_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.MedicationItemActionOK(
						modelAction.MedicationItemModelActionTypes.DELETE_MEDICATION_ITEM_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationItemActionFail(
								modelAction.MedicationItemModelActionTypes.DELETE_MEDICATION_ITEM_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationItemAction>(modelAction.MedicationItemModelActionTypes.DELETE_ALL_MEDICATION_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.MedicationItemActionOK(
						modelAction.MedicationItemModelActionTypes.DELETE_ALL_MEDICATION_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationItemActionFail(
								modelAction.MedicationItemModelActionTypes.DELETE_ALL_MEDICATION_ITEM_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationItemAction>(modelAction.MedicationItemModelActionTypes.EXPORT_MEDICATION_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicationItemActionOK(
						modelAction.MedicationItemModelActionTypes.EXPORT_MEDICATION_ITEM,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationItemAction>(modelAction.MedicationItemModelActionTypes.EXPORT_ALL_MEDICATION_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicationItemActionOK(
						modelAction.MedicationItemModelActionTypes.EXPORT_ALL_MEDICATION_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationItemActionFail(
								modelAction.MedicationItemModelActionTypes.EXPORT_ALL_MEDICATION_ITEM_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationItemAction>(modelAction.MedicationItemModelActionTypes.EXPORT_MEDICATION_ITEM_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicationItemActionOK(
						modelAction.MedicationItemModelActionTypes.EXPORT_MEDICATION_ITEM_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationItemActionFail(
								modelAction.MedicationItemModelActionTypes.EXPORT_MEDICATION_ITEM_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationItemAction>(modelAction.MedicationItemModelActionTypes.IMPORT_MEDICATION_ITEMS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.MedicationItemActionOK(
						modelAction.MedicationItemModelActionTypes.IMPORT_MEDICATION_ITEMS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationItemActionFail(
								modelAction.MedicationItemModelActionTypes.IMPORT_MEDICATION_ITEMS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationItemAction>(modelAction.MedicationItemModelActionTypes.FETCH_MEDICATION_ITEM_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.MedicationItemActionOK(
						modelAction.MedicationItemModelActionTypes.FETCH_MEDICATION_ITEM_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.MedicationItemActionFail(
								modelAction.MedicationItemModelActionTypes.FETCH_MEDICATION_ITEM_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationItemAction>(modelAction.MedicationItemModelActionTypes.FETCH_MEDICATION_ITEM_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.MedicationItemActionOK(
						modelAction.MedicationItemModelActionTypes.FETCH_MEDICATION_ITEM_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.MedicationItemActionFail(
								modelAction.MedicationItemModelActionTypes.FETCH_MEDICATION_ITEM_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
