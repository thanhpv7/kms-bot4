...
/**
 * ReferenceDataCollectionState would store the state of a collection of ReferenceData
 */
export interface ReferenceDataCollectionState extends CollectionState {
 ...
 */
export interface ReferenceDataModelAudit extends AbstractModelAudit<ReferenceDataModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * ReferenceDataModelState would store the state of the model
 */
export interface ReferenceDataModelState {
	collectionState: {
		[key: string]: ReferenceDataCollectionState;
	};
	data: {
		[id: string]: ReferenceDataModel;
	};
	totalCount: number;
	audits: ReferenceDataModelAudit[];
 ...
 */
export const initialReferenceDataCollectionState: ReferenceDataCollectionState = {
...
/**
 * The initial state of ReferenceDataModelState
 */
export const initialState: ReferenceDataModelState = {
	collectionState: {
