...
import * as modelAction from './reference_data.model.action';
import {ReferenceDataService} from '../../services/referenceData/reference_data.service';
...
/**
 * Effect class used for side effects related to Reference Data model.
 */
@Injectable()
export class ReferenceDataEffect {
	...
	constructor(
		...
		protected readonly service: ReferenceDataService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReferenceDataAction>(modelAction.ReferenceDataModelActionTypes.COUNT_REFERENCE_DATAS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.ReferenceDataActionOK(
						modelAction.ReferenceDataModelActionTypes.COUNT_REFERENCE_DATAS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReferenceDataActionFail(
								modelAction.ReferenceDataModelActionTypes.COUNT_REFERENCE_DATAS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReferenceDataAction>(modelAction.ReferenceDataModelActionTypes.FETCH_REFERENCE_DATA),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ReferenceDataActionOK(
						modelAction.ReferenceDataModelActionTypes.FETCH_REFERENCE_DATA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReferenceDataActionFail(
								modelAction.ReferenceDataModelActionTypes.FETCH_REFERENCE_DATA_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReferenceDataAction>(modelAction.ReferenceDataModelActionTypes.FETCH_ALL_REFERENCE_DATA),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.ReferenceDataActionOK(
						modelAction.ReferenceDataModelActionTypes.FETCH_ALL_REFERENCE_DATA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReferenceDataActionFail(
								modelAction.ReferenceDataModelActionTypes.FETCH_ALL_REFERENCE_DATA_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReferenceDataAction>(modelAction.ReferenceDataModelActionTypes.FETCH_REFERENCE_DATA_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.ReferenceDataActionOK(
						modelAction.ReferenceDataModelActionTypes.FETCH_REFERENCE_DATA_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReferenceDataActionFail(
								modelAction.ReferenceDataModelActionTypes.FETCH_REFERENCE_DATA_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReferenceDataAction>(modelAction.ReferenceDataModelActionTypes.FETCH_LAST_REFERENCE_DATA_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.ReferenceDataActionOK(
						modelAction.ReferenceDataModelActionTypes.FETCH_LAST_REFERENCE_DATA_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReferenceDataActionFail(
								modelAction.ReferenceDataModelActionTypes.FETCH_LAST_REFERENCE_DATA_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReferenceDataAction>(modelAction.ReferenceDataModelActionTypes.CREATE_REFERENCE_DATA),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as ReferenceDataModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ReferenceDataActionOK(
						modelAction.ReferenceDataModelActionTypes.CREATE_REFERENCE_DATA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReferenceDataActionFail(
								modelAction.ReferenceDataModelActionTypes.CREATE_REFERENCE_DATA_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReferenceDataAction>(modelAction.ReferenceDataModelActionTypes.CREATE_ALL_REFERENCE_DATA),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as ReferenceDataModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ReferenceDataActionOK(
						modelAction.ReferenceDataModelActionTypes.CREATE_ALL_REFERENCE_DATA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReferenceDataActionFail(
								modelAction.ReferenceDataModelActionTypes.CREATE_ALL_REFERENCE_DATA_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReferenceDataAction>(modelAction.ReferenceDataModelActionTypes.UPDATE_REFERENCE_DATA),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as ReferenceDataModel;
				...
				return this.service.update(new ReferenceDataModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.ReferenceDataActionOK(
						modelAction.ReferenceDataModelActionTypes.UPDATE_REFERENCE_DATA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReferenceDataActionFail(
								modelAction.ReferenceDataModelActionTypes.UPDATE_REFERENCE_DATA_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReferenceDataAction>(modelAction.ReferenceDataModelActionTypes.UPDATE_ALL_REFERENCE_DATA),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as ReferenceDataModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new ReferenceDataModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ReferenceDataActionOK(
						modelAction.ReferenceDataModelActionTypes.UPDATE_ALL_REFERENCE_DATA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReferenceDataActionFail(
								modelAction.ReferenceDataModelActionTypes.UPDATE_ALL_REFERENCE_DATA_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReferenceDataAction>(modelAction.ReferenceDataModelActionTypes.DELETE_REFERENCE_DATA),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.ReferenceDataActionOK(
						modelAction.ReferenceDataModelActionTypes.DELETE_REFERENCE_DATA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReferenceDataActionFail(
								modelAction.ReferenceDataModelActionTypes.DELETE_REFERENCE_DATA_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReferenceDataAction>(modelAction.ReferenceDataModelActionTypes.DELETE_REFERENCE_DATA_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.ReferenceDataActionOK(
						modelAction.ReferenceDataModelActionTypes.DELETE_REFERENCE_DATA_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReferenceDataActionFail(
								modelAction.ReferenceDataModelActionTypes.DELETE_REFERENCE_DATA_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReferenceDataAction>(modelAction.ReferenceDataModelActionTypes.DELETE_ALL_REFERENCE_DATA),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.ReferenceDataActionOK(
						modelAction.ReferenceDataModelActionTypes.DELETE_ALL_REFERENCE_DATA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReferenceDataActionFail(
								modelAction.ReferenceDataModelActionTypes.DELETE_ALL_REFERENCE_DATA_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReferenceDataAction>(modelAction.ReferenceDataModelActionTypes.EXPORT_REFERENCE_DATA),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ReferenceDataActionOK(
						modelAction.ReferenceDataModelActionTypes.EXPORT_REFERENCE_DATA,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReferenceDataAction>(modelAction.ReferenceDataModelActionTypes.EXPORT_ALL_REFERENCE_DATA),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ReferenceDataActionOK(
						modelAction.ReferenceDataModelActionTypes.EXPORT_ALL_REFERENCE_DATA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReferenceDataActionFail(
								modelAction.ReferenceDataModelActionTypes.EXPORT_ALL_REFERENCE_DATA_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReferenceDataAction>(modelAction.ReferenceDataModelActionTypes.EXPORT_REFERENCE_DATA_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ReferenceDataActionOK(
						modelAction.ReferenceDataModelActionTypes.EXPORT_REFERENCE_DATA_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReferenceDataActionFail(
								modelAction.ReferenceDataModelActionTypes.EXPORT_REFERENCE_DATA_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReferenceDataAction>(modelAction.ReferenceDataModelActionTypes.IMPORT_REFERENCE_DATAS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.ReferenceDataActionOK(
						modelAction.ReferenceDataModelActionTypes.IMPORT_REFERENCE_DATAS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReferenceDataActionFail(
								modelAction.ReferenceDataModelActionTypes.IMPORT_REFERENCE_DATAS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReferenceDataAction>(modelAction.ReferenceDataModelActionTypes.FETCH_REFERENCE_DATA_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.ReferenceDataActionOK(
						modelAction.ReferenceDataModelActionTypes.FETCH_REFERENCE_DATA_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.ReferenceDataActionFail(
								modelAction.ReferenceDataModelActionTypes.FETCH_REFERENCE_DATA_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReferenceDataAction>(modelAction.ReferenceDataModelActionTypes.FETCH_REFERENCE_DATA_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.ReferenceDataActionOK(
						modelAction.ReferenceDataModelActionTypes.FETCH_REFERENCE_DATA_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.ReferenceDataActionFail(
								modelAction.ReferenceDataModelActionTypes.FETCH_REFERENCE_DATA_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
