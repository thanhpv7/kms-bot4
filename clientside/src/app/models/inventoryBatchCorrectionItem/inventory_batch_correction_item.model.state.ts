...
/**
 * InventoryBatchCorrectionItemCollectionState would store the state of a collection of InventoryBatchCorrectionItem
 */
export interface InventoryBatchCorrectionItemCollectionState extends CollectionState {
 ...
 */
export interface InventoryBatchCorrectionItemModelAudit extends AbstractModelAudit<InventoryBatchCorrectionItemModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * InventoryBatchCorrectionItemModelState would store the state of the model
 */
export interface InventoryBatchCorrectionItemModelState {
	collectionState: {
		[key: string]: InventoryBatchCorrectionItemCollectionState;
	};
	data: {
		[id: string]: InventoryBatchCorrectionItemModel;
	};
	totalCount: number;
	audits: InventoryBatchCorrectionItemModelAudit[];
 ...
 */
export const initialInventoryBatchCorrectionItemCollectionState: InventoryBatchCorrectionItemCollectionState = {
...
/**
 * The initial state of InventoryBatchCorrectionItemModelState
 */
export const initialState: InventoryBatchCorrectionItemModelState = {
	collectionState: {
