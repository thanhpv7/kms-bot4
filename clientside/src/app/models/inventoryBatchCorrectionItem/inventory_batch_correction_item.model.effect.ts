...
import * as modelAction from './inventory_batch_correction_item.model.action';
import {InventoryBatchCorrectionItemService} from '../../services/inventoryBatchCorrectionItem/inventory_batch_correction_item.service';
...
/**
 * Effect class used for side effects related to Inventory Batch Correction Item model.
 */
@Injectable()
export class InventoryBatchCorrectionItemEffect {
	...
	constructor(
		...
		protected readonly service: InventoryBatchCorrectionItemService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryBatchCorrectionItemAction>(modelAction.InventoryBatchCorrectionItemModelActionTypes.COUNT_INVENTORY_BATCH_CORRECTION_ITEMS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.InventoryBatchCorrectionItemActionOK(
						modelAction.InventoryBatchCorrectionItemModelActionTypes.COUNT_INVENTORY_BATCH_CORRECTION_ITEMS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryBatchCorrectionItemActionFail(
								modelAction.InventoryBatchCorrectionItemModelActionTypes.COUNT_INVENTORY_BATCH_CORRECTION_ITEMS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryBatchCorrectionItemAction>(modelAction.InventoryBatchCorrectionItemModelActionTypes.FETCH_INVENTORY_BATCH_CORRECTION_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InventoryBatchCorrectionItemActionOK(
						modelAction.InventoryBatchCorrectionItemModelActionTypes.FETCH_INVENTORY_BATCH_CORRECTION_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryBatchCorrectionItemActionFail(
								modelAction.InventoryBatchCorrectionItemModelActionTypes.FETCH_INVENTORY_BATCH_CORRECTION_ITEM_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryBatchCorrectionItemAction>(modelAction.InventoryBatchCorrectionItemModelActionTypes.FETCH_ALL_INVENTORY_BATCH_CORRECTION_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.InventoryBatchCorrectionItemActionOK(
						modelAction.InventoryBatchCorrectionItemModelActionTypes.FETCH_ALL_INVENTORY_BATCH_CORRECTION_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryBatchCorrectionItemActionFail(
								modelAction.InventoryBatchCorrectionItemModelActionTypes.FETCH_ALL_INVENTORY_BATCH_CORRECTION_ITEM_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryBatchCorrectionItemAction>(modelAction.InventoryBatchCorrectionItemModelActionTypes.FETCH_INVENTORY_BATCH_CORRECTION_ITEM_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.InventoryBatchCorrectionItemActionOK(
						modelAction.InventoryBatchCorrectionItemModelActionTypes.FETCH_INVENTORY_BATCH_CORRECTION_ITEM_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryBatchCorrectionItemActionFail(
								modelAction.InventoryBatchCorrectionItemModelActionTypes.FETCH_INVENTORY_BATCH_CORRECTION_ITEM_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryBatchCorrectionItemAction>(modelAction.InventoryBatchCorrectionItemModelActionTypes.FETCH_LAST_INVENTORY_BATCH_CORRECTION_ITEM_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.InventoryBatchCorrectionItemActionOK(
						modelAction.InventoryBatchCorrectionItemModelActionTypes.FETCH_LAST_INVENTORY_BATCH_CORRECTION_ITEM_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryBatchCorrectionItemActionFail(
								modelAction.InventoryBatchCorrectionItemModelActionTypes.FETCH_LAST_INVENTORY_BATCH_CORRECTION_ITEM_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryBatchCorrectionItemAction>(modelAction.InventoryBatchCorrectionItemModelActionTypes.CREATE_INVENTORY_BATCH_CORRECTION_ITEM),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as InventoryBatchCorrectionItemModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InventoryBatchCorrectionItemActionOK(
						modelAction.InventoryBatchCorrectionItemModelActionTypes.CREATE_INVENTORY_BATCH_CORRECTION_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryBatchCorrectionItemActionFail(
								modelAction.InventoryBatchCorrectionItemModelActionTypes.CREATE_INVENTORY_BATCH_CORRECTION_ITEM_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryBatchCorrectionItemAction>(modelAction.InventoryBatchCorrectionItemModelActionTypes.CREATE_ALL_INVENTORY_BATCH_CORRECTION_ITEM),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as InventoryBatchCorrectionItemModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InventoryBatchCorrectionItemActionOK(
						modelAction.InventoryBatchCorrectionItemModelActionTypes.CREATE_ALL_INVENTORY_BATCH_CORRECTION_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryBatchCorrectionItemActionFail(
								modelAction.InventoryBatchCorrectionItemModelActionTypes.CREATE_ALL_INVENTORY_BATCH_CORRECTION_ITEM_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryBatchCorrectionItemAction>(modelAction.InventoryBatchCorrectionItemModelActionTypes.UPDATE_INVENTORY_BATCH_CORRECTION_ITEM),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as InventoryBatchCorrectionItemModel;
				...
				return this.service.update(new InventoryBatchCorrectionItemModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.InventoryBatchCorrectionItemActionOK(
						modelAction.InventoryBatchCorrectionItemModelActionTypes.UPDATE_INVENTORY_BATCH_CORRECTION_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryBatchCorrectionItemActionFail(
								modelAction.InventoryBatchCorrectionItemModelActionTypes.UPDATE_INVENTORY_BATCH_CORRECTION_ITEM_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryBatchCorrectionItemAction>(modelAction.InventoryBatchCorrectionItemModelActionTypes.UPDATE_ALL_INVENTORY_BATCH_CORRECTION_ITEM),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as InventoryBatchCorrectionItemModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new InventoryBatchCorrectionItemModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InventoryBatchCorrectionItemActionOK(
						modelAction.InventoryBatchCorrectionItemModelActionTypes.UPDATE_ALL_INVENTORY_BATCH_CORRECTION_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryBatchCorrectionItemActionFail(
								modelAction.InventoryBatchCorrectionItemModelActionTypes.UPDATE_ALL_INVENTORY_BATCH_CORRECTION_ITEM_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryBatchCorrectionItemAction>(modelAction.InventoryBatchCorrectionItemModelActionTypes.DELETE_INVENTORY_BATCH_CORRECTION_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.InventoryBatchCorrectionItemActionOK(
						modelAction.InventoryBatchCorrectionItemModelActionTypes.DELETE_INVENTORY_BATCH_CORRECTION_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryBatchCorrectionItemActionFail(
								modelAction.InventoryBatchCorrectionItemModelActionTypes.DELETE_INVENTORY_BATCH_CORRECTION_ITEM_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryBatchCorrectionItemAction>(modelAction.InventoryBatchCorrectionItemModelActionTypes.DELETE_INVENTORY_BATCH_CORRECTION_ITEM_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.InventoryBatchCorrectionItemActionOK(
						modelAction.InventoryBatchCorrectionItemModelActionTypes.DELETE_INVENTORY_BATCH_CORRECTION_ITEM_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryBatchCorrectionItemActionFail(
								modelAction.InventoryBatchCorrectionItemModelActionTypes.DELETE_INVENTORY_BATCH_CORRECTION_ITEM_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryBatchCorrectionItemAction>(modelAction.InventoryBatchCorrectionItemModelActionTypes.DELETE_ALL_INVENTORY_BATCH_CORRECTION_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.InventoryBatchCorrectionItemActionOK(
						modelAction.InventoryBatchCorrectionItemModelActionTypes.DELETE_ALL_INVENTORY_BATCH_CORRECTION_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryBatchCorrectionItemActionFail(
								modelAction.InventoryBatchCorrectionItemModelActionTypes.DELETE_ALL_INVENTORY_BATCH_CORRECTION_ITEM_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryBatchCorrectionItemAction>(modelAction.InventoryBatchCorrectionItemModelActionTypes.EXPORT_INVENTORY_BATCH_CORRECTION_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.InventoryBatchCorrectionItemActionOK(
						modelAction.InventoryBatchCorrectionItemModelActionTypes.EXPORT_INVENTORY_BATCH_CORRECTION_ITEM,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryBatchCorrectionItemAction>(modelAction.InventoryBatchCorrectionItemModelActionTypes.EXPORT_ALL_INVENTORY_BATCH_CORRECTION_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.InventoryBatchCorrectionItemActionOK(
						modelAction.InventoryBatchCorrectionItemModelActionTypes.EXPORT_ALL_INVENTORY_BATCH_CORRECTION_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryBatchCorrectionItemActionFail(
								modelAction.InventoryBatchCorrectionItemModelActionTypes.EXPORT_ALL_INVENTORY_BATCH_CORRECTION_ITEM_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryBatchCorrectionItemAction>(modelAction.InventoryBatchCorrectionItemModelActionTypes.EXPORT_INVENTORY_BATCH_CORRECTION_ITEM_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.InventoryBatchCorrectionItemActionOK(
						modelAction.InventoryBatchCorrectionItemModelActionTypes.EXPORT_INVENTORY_BATCH_CORRECTION_ITEM_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryBatchCorrectionItemActionFail(
								modelAction.InventoryBatchCorrectionItemModelActionTypes.EXPORT_INVENTORY_BATCH_CORRECTION_ITEM_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryBatchCorrectionItemAction>(modelAction.InventoryBatchCorrectionItemModelActionTypes.IMPORT_INVENTORY_BATCH_CORRECTION_ITEMS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.InventoryBatchCorrectionItemActionOK(
						modelAction.InventoryBatchCorrectionItemModelActionTypes.IMPORT_INVENTORY_BATCH_CORRECTION_ITEMS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryBatchCorrectionItemActionFail(
								modelAction.InventoryBatchCorrectionItemModelActionTypes.IMPORT_INVENTORY_BATCH_CORRECTION_ITEMS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryBatchCorrectionItemAction>(modelAction.InventoryBatchCorrectionItemModelActionTypes.FETCH_INVENTORY_BATCH_CORRECTION_ITEM_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.InventoryBatchCorrectionItemActionOK(
						modelAction.InventoryBatchCorrectionItemModelActionTypes.FETCH_INVENTORY_BATCH_CORRECTION_ITEM_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.InventoryBatchCorrectionItemActionFail(
								modelAction.InventoryBatchCorrectionItemModelActionTypes.FETCH_INVENTORY_BATCH_CORRECTION_ITEM_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryBatchCorrectionItemAction>(modelAction.InventoryBatchCorrectionItemModelActionTypes.FETCH_INVENTORY_BATCH_CORRECTION_ITEM_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.InventoryBatchCorrectionItemActionOK(
						modelAction.InventoryBatchCorrectionItemModelActionTypes.FETCH_INVENTORY_BATCH_CORRECTION_ITEM_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.InventoryBatchCorrectionItemActionFail(
								modelAction.InventoryBatchCorrectionItemModelActionTypes.FETCH_INVENTORY_BATCH_CORRECTION_ITEM_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
