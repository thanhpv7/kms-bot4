...
/**
 * DiagnosesAndProceduresCollectionState would store the state of a collection of DiagnosesAndProcedures
 */
export interface DiagnosesAndProceduresCollectionState extends CollectionState {
 ...
 */
export interface DiagnosesAndProceduresModelAudit extends AbstractModelAudit<DiagnosesAndProceduresModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * DiagnosesAndProceduresModelState would store the state of the model
 */
export interface DiagnosesAndProceduresModelState {
	collectionState: {
		[key: string]: DiagnosesAndProceduresCollectionState;
	};
	data: {
		[id: string]: DiagnosesAndProceduresModel;
	};
	totalCount: number;
	audits: DiagnosesAndProceduresModelAudit[];
 ...
 */
export const initialDiagnosesAndProceduresCollectionState: DiagnosesAndProceduresCollectionState = {
...
/**
 * The initial state of DiagnosesAndProceduresModelState
 */
export const initialState: DiagnosesAndProceduresModelState = {
	collectionState: {
