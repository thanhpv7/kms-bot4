...
import * as modelAction from './diagnoses_and_procedures.model.action';
import {DiagnosesAndProceduresService} from '../../services/diagnosesAndProcedures/diagnoses_and_procedures.service';
...
/**
 * Effect class used for side effects related to Diagnoses and Procedures model.
 */
@Injectable()
export class DiagnosesAndProceduresEffect {
	...
	constructor(
		...
		protected readonly service: DiagnosesAndProceduresService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosesAndProceduresAction>(modelAction.DiagnosesAndProceduresModelActionTypes.COUNT_DIAGNOSES_AND_PROCEDURESS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.DiagnosesAndProceduresActionOK(
						modelAction.DiagnosesAndProceduresModelActionTypes.COUNT_DIAGNOSES_AND_PROCEDURESS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosesAndProceduresActionFail(
								modelAction.DiagnosesAndProceduresModelActionTypes.COUNT_DIAGNOSES_AND_PROCEDURESS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosesAndProceduresAction>(modelAction.DiagnosesAndProceduresModelActionTypes.FETCH_DIAGNOSES_AND_PROCEDURES),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.DiagnosesAndProceduresActionOK(
						modelAction.DiagnosesAndProceduresModelActionTypes.FETCH_DIAGNOSES_AND_PROCEDURES_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosesAndProceduresActionFail(
								modelAction.DiagnosesAndProceduresModelActionTypes.FETCH_DIAGNOSES_AND_PROCEDURES_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosesAndProceduresAction>(modelAction.DiagnosesAndProceduresModelActionTypes.FETCH_ALL_DIAGNOSES_AND_PROCEDURES),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.DiagnosesAndProceduresActionOK(
						modelAction.DiagnosesAndProceduresModelActionTypes.FETCH_ALL_DIAGNOSES_AND_PROCEDURES_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosesAndProceduresActionFail(
								modelAction.DiagnosesAndProceduresModelActionTypes.FETCH_ALL_DIAGNOSES_AND_PROCEDURES_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosesAndProceduresAction>(modelAction.DiagnosesAndProceduresModelActionTypes.FETCH_DIAGNOSES_AND_PROCEDURES_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.DiagnosesAndProceduresActionOK(
						modelAction.DiagnosesAndProceduresModelActionTypes.FETCH_DIAGNOSES_AND_PROCEDURES_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosesAndProceduresActionFail(
								modelAction.DiagnosesAndProceduresModelActionTypes.FETCH_DIAGNOSES_AND_PROCEDURES_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosesAndProceduresAction>(modelAction.DiagnosesAndProceduresModelActionTypes.FETCH_LAST_DIAGNOSES_AND_PROCEDURES_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.DiagnosesAndProceduresActionOK(
						modelAction.DiagnosesAndProceduresModelActionTypes.FETCH_LAST_DIAGNOSES_AND_PROCEDURES_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosesAndProceduresActionFail(
								modelAction.DiagnosesAndProceduresModelActionTypes.FETCH_LAST_DIAGNOSES_AND_PROCEDURES_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosesAndProceduresAction>(modelAction.DiagnosesAndProceduresModelActionTypes.CREATE_DIAGNOSES_AND_PROCEDURES),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as DiagnosesAndProceduresModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.DiagnosesAndProceduresActionOK(
						modelAction.DiagnosesAndProceduresModelActionTypes.CREATE_DIAGNOSES_AND_PROCEDURES_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosesAndProceduresActionFail(
								modelAction.DiagnosesAndProceduresModelActionTypes.CREATE_DIAGNOSES_AND_PROCEDURES_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosesAndProceduresAction>(modelAction.DiagnosesAndProceduresModelActionTypes.CREATE_ALL_DIAGNOSES_AND_PROCEDURES),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as DiagnosesAndProceduresModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.DiagnosesAndProceduresActionOK(
						modelAction.DiagnosesAndProceduresModelActionTypes.CREATE_ALL_DIAGNOSES_AND_PROCEDURES_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosesAndProceduresActionFail(
								modelAction.DiagnosesAndProceduresModelActionTypes.CREATE_ALL_DIAGNOSES_AND_PROCEDURES_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosesAndProceduresAction>(modelAction.DiagnosesAndProceduresModelActionTypes.UPDATE_DIAGNOSES_AND_PROCEDURES),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as DiagnosesAndProceduresModel;
				...
				return this.service.update(new DiagnosesAndProceduresModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.DiagnosesAndProceduresActionOK(
						modelAction.DiagnosesAndProceduresModelActionTypes.UPDATE_DIAGNOSES_AND_PROCEDURES_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosesAndProceduresActionFail(
								modelAction.DiagnosesAndProceduresModelActionTypes.UPDATE_DIAGNOSES_AND_PROCEDURES_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosesAndProceduresAction>(modelAction.DiagnosesAndProceduresModelActionTypes.UPDATE_ALL_DIAGNOSES_AND_PROCEDURES),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as DiagnosesAndProceduresModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new DiagnosesAndProceduresModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.DiagnosesAndProceduresActionOK(
						modelAction.DiagnosesAndProceduresModelActionTypes.UPDATE_ALL_DIAGNOSES_AND_PROCEDURES_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosesAndProceduresActionFail(
								modelAction.DiagnosesAndProceduresModelActionTypes.UPDATE_ALL_DIAGNOSES_AND_PROCEDURES_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosesAndProceduresAction>(modelAction.DiagnosesAndProceduresModelActionTypes.DELETE_DIAGNOSES_AND_PROCEDURES),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.DiagnosesAndProceduresActionOK(
						modelAction.DiagnosesAndProceduresModelActionTypes.DELETE_DIAGNOSES_AND_PROCEDURES_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosesAndProceduresActionFail(
								modelAction.DiagnosesAndProceduresModelActionTypes.DELETE_DIAGNOSES_AND_PROCEDURES_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosesAndProceduresAction>(modelAction.DiagnosesAndProceduresModelActionTypes.DELETE_DIAGNOSES_AND_PROCEDURES_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.DiagnosesAndProceduresActionOK(
						modelAction.DiagnosesAndProceduresModelActionTypes.DELETE_DIAGNOSES_AND_PROCEDURES_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosesAndProceduresActionFail(
								modelAction.DiagnosesAndProceduresModelActionTypes.DELETE_DIAGNOSES_AND_PROCEDURES_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosesAndProceduresAction>(modelAction.DiagnosesAndProceduresModelActionTypes.DELETE_ALL_DIAGNOSES_AND_PROCEDURES),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.DiagnosesAndProceduresActionOK(
						modelAction.DiagnosesAndProceduresModelActionTypes.DELETE_ALL_DIAGNOSES_AND_PROCEDURES_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosesAndProceduresActionFail(
								modelAction.DiagnosesAndProceduresModelActionTypes.DELETE_ALL_DIAGNOSES_AND_PROCEDURES_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosesAndProceduresAction>(modelAction.DiagnosesAndProceduresModelActionTypes.EXPORT_DIAGNOSES_AND_PROCEDURES),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.DiagnosesAndProceduresActionOK(
						modelAction.DiagnosesAndProceduresModelActionTypes.EXPORT_DIAGNOSES_AND_PROCEDURES,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosesAndProceduresAction>(modelAction.DiagnosesAndProceduresModelActionTypes.EXPORT_ALL_DIAGNOSES_AND_PROCEDURES),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.DiagnosesAndProceduresActionOK(
						modelAction.DiagnosesAndProceduresModelActionTypes.EXPORT_ALL_DIAGNOSES_AND_PROCEDURES_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosesAndProceduresActionFail(
								modelAction.DiagnosesAndProceduresModelActionTypes.EXPORT_ALL_DIAGNOSES_AND_PROCEDURES_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosesAndProceduresAction>(modelAction.DiagnosesAndProceduresModelActionTypes.EXPORT_DIAGNOSES_AND_PROCEDURES_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.DiagnosesAndProceduresActionOK(
						modelAction.DiagnosesAndProceduresModelActionTypes.EXPORT_DIAGNOSES_AND_PROCEDURES_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosesAndProceduresActionFail(
								modelAction.DiagnosesAndProceduresModelActionTypes.EXPORT_DIAGNOSES_AND_PROCEDURES_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosesAndProceduresAction>(modelAction.DiagnosesAndProceduresModelActionTypes.IMPORT_DIAGNOSES_AND_PROCEDURESS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.DiagnosesAndProceduresActionOK(
						modelAction.DiagnosesAndProceduresModelActionTypes.IMPORT_DIAGNOSES_AND_PROCEDURESS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosesAndProceduresActionFail(
								modelAction.DiagnosesAndProceduresModelActionTypes.IMPORT_DIAGNOSES_AND_PROCEDURESS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosesAndProceduresAction>(modelAction.DiagnosesAndProceduresModelActionTypes.FETCH_DIAGNOSES_AND_PROCEDURES_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.DiagnosesAndProceduresActionOK(
						modelAction.DiagnosesAndProceduresModelActionTypes.FETCH_DIAGNOSES_AND_PROCEDURES_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosesAndProceduresActionFail(
								modelAction.DiagnosesAndProceduresModelActionTypes.FETCH_DIAGNOSES_AND_PROCEDURES_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosesAndProceduresAction>(modelAction.DiagnosesAndProceduresModelActionTypes.FETCH_DIAGNOSES_AND_PROCEDURES_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.DiagnosesAndProceduresActionOK(
						modelAction.DiagnosesAndProceduresModelActionTypes.FETCH_DIAGNOSES_AND_PROCEDURES_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosesAndProceduresActionFail(
								modelAction.DiagnosesAndProceduresModelActionTypes.FETCH_DIAGNOSES_AND_PROCEDURES_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
