...
export class PrivilegeEffect {
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrivilegeAction>(modelAction.PrivilegeModelActionTypes.COUNT_PRIVILEGES),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.PrivilegeActionOK(
						modelAction.PrivilegeModelActionTypes.COUNT_PRIVILEGES_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PrivilegeActionFail(
								modelAction.PrivilegeModelActionTypes.COUNT_PRIVILEGES_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrivilegeAction>(modelAction.PrivilegeModelActionTypes.FETCH_PRIVILEGE),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PrivilegeActionOK(
						modelAction.PrivilegeModelActionTypes.FETCH_PRIVILEGE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PrivilegeActionFail(
								modelAction.PrivilegeModelActionTypes.FETCH_PRIVILEGE_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrivilegeAction>(modelAction.PrivilegeModelActionTypes.FETCH_ALL_PRIVILEGE),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.PrivilegeActionOK(
						modelAction.PrivilegeModelActionTypes.FETCH_ALL_PRIVILEGE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PrivilegeActionFail(
								modelAction.PrivilegeModelActionTypes.FETCH_ALL_PRIVILEGE_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrivilegeAction>(modelAction.PrivilegeModelActionTypes.FETCH_PRIVILEGE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PrivilegeActionOK(
						modelAction.PrivilegeModelActionTypes.FETCH_PRIVILEGE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PrivilegeActionFail(
								modelAction.PrivilegeModelActionTypes.FETCH_PRIVILEGE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrivilegeAction>(modelAction.PrivilegeModelActionTypes.FETCH_LAST_PRIVILEGE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PrivilegeActionOK(
						modelAction.PrivilegeModelActionTypes.FETCH_LAST_PRIVILEGE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PrivilegeActionFail(
								modelAction.PrivilegeModelActionTypes.FETCH_LAST_PRIVILEGE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrivilegeAction>(modelAction.PrivilegeModelActionTypes.CREATE_PRIVILEGE),
			...
			concatMap((action) => {
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PrivilegeActionOK(
						modelAction.PrivilegeModelActionTypes.CREATE_PRIVILEGE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PrivilegeActionFail(
								modelAction.PrivilegeModelActionTypes.CREATE_PRIVILEGE_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrivilegeAction>(modelAction.PrivilegeModelActionTypes.CREATE_ALL_PRIVILEGE),
			...
			concatMap((action) => {
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PrivilegeActionOK(
						modelAction.PrivilegeModelActionTypes.CREATE_ALL_PRIVILEGE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PrivilegeActionFail(
								modelAction.PrivilegeModelActionTypes.CREATE_ALL_PRIVILEGE_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrivilegeAction>(modelAction.PrivilegeModelActionTypes.UPDATE_PRIVILEGE),
			...
			concatMap((action) => {
				...
				return this.service.update(new PrivilegeModel({
					...
					map(stateConfig => new modelAction.PrivilegeActionOK(
						modelAction.PrivilegeModelActionTypes.UPDATE_PRIVILEGE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PrivilegeActionFail(
								modelAction.PrivilegeModelActionTypes.UPDATE_PRIVILEGE_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrivilegeAction>(modelAction.PrivilegeModelActionTypes.UPDATE_ALL_PRIVILEGE),
			...
			concatMap((action) => {
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PrivilegeActionOK(
						modelAction.PrivilegeModelActionTypes.UPDATE_ALL_PRIVILEGE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PrivilegeActionFail(
								modelAction.PrivilegeModelActionTypes.UPDATE_ALL_PRIVILEGE_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrivilegeAction>(modelAction.PrivilegeModelActionTypes.DELETE_PRIVILEGE),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PrivilegeActionOK(
						modelAction.PrivilegeModelActionTypes.DELETE_PRIVILEGE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PrivilegeActionFail(
								modelAction.PrivilegeModelActionTypes.DELETE_PRIVILEGE_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrivilegeAction>(modelAction.PrivilegeModelActionTypes.DELETE_PRIVILEGE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.PrivilegeActionOK(
						modelAction.PrivilegeModelActionTypes.DELETE_PRIVILEGE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PrivilegeActionFail(
								modelAction.PrivilegeModelActionTypes.DELETE_PRIVILEGE_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrivilegeAction>(modelAction.PrivilegeModelActionTypes.DELETE_ALL_PRIVILEGE),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PrivilegeActionOK(
						modelAction.PrivilegeModelActionTypes.DELETE_ALL_PRIVILEGE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PrivilegeActionFail(
								modelAction.PrivilegeModelActionTypes.DELETE_ALL_PRIVILEGE_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrivilegeAction>(modelAction.PrivilegeModelActionTypes.EXPORT_PRIVILEGE),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PrivilegeActionOK(
						modelAction.PrivilegeModelActionTypes.EXPORT_PRIVILEGE,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrivilegeAction>(modelAction.PrivilegeModelActionTypes.EXPORT_ALL_PRIVILEGE),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PrivilegeActionOK(
						modelAction.PrivilegeModelActionTypes.EXPORT_ALL_PRIVILEGE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PrivilegeActionFail(
								modelAction.PrivilegeModelActionTypes.EXPORT_ALL_PRIVILEGE_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrivilegeAction>(modelAction.PrivilegeModelActionTypes.EXPORT_PRIVILEGE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PrivilegeActionOK(
						modelAction.PrivilegeModelActionTypes.EXPORT_PRIVILEGE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PrivilegeActionFail(
								modelAction.PrivilegeModelActionTypes.EXPORT_PRIVILEGE_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrivilegeAction>(modelAction.PrivilegeModelActionTypes.IMPORT_PRIVILEGES),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.PrivilegeActionOK(
						modelAction.PrivilegeModelActionTypes.IMPORT_PRIVILEGES_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PrivilegeActionFail(
								modelAction.PrivilegeModelActionTypes.IMPORT_PRIVILEGES_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrivilegeAction>(modelAction.PrivilegeModelActionTypes.FETCH_PRIVILEGE_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.PrivilegeActionOK(
						modelAction.PrivilegeModelActionTypes.FETCH_PRIVILEGE_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PrivilegeActionFail(
								modelAction.PrivilegeModelActionTypes.FETCH_PRIVILEGE_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PrivilegeAction>(modelAction.PrivilegeModelActionTypes.FETCH_PRIVILEGE_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.PrivilegeActionOK(
						modelAction.PrivilegeModelActionTypes.FETCH_PRIVILEGE_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PrivilegeActionFail(
								modelAction.PrivilegeModelActionTypes.FETCH_PRIVILEGE_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
