...
/**
 * PrivilegeCollectionState would store the state of a collection of Privilege
 */
export interface PrivilegeCollectionState extends CollectionState {
 ...
 */
export interface PrivilegeModelAudit extends AbstractModelAudit<PrivilegeModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * PrivilegeModelState would store the state of the model
 */
export interface PrivilegeModelState {
	collectionState: {
		[key: string]: PrivilegeCollectionState;
	};
	data: {
		[id: string]: PrivilegeModel;
	};
	totalCount: number;
	audits: PrivilegeModelAudit[];
 ...
 */
export const initialPrivilegeCollectionState: PrivilegeCollectionState = {
...
/**
 * The initial state of PrivilegeModelState
 */
export const initialState: PrivilegeModelState = {
	collectionState: {
