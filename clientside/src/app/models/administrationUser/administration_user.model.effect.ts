...
import * as modelAction from './administration_user.model.action';
import {AdministrationUserService} from '../../services/administrationUser/administration_user.service';
...
/**
 * Effect class used for side effects related to Administration User model.
 */
@Injectable()
export class AdministrationUserEffect {
	...
	constructor(
		...
		protected readonly service: AdministrationUserService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AdministrationUserAction>(modelAction.AdministrationUserModelActionTypes.COUNT_ADMINISTRATION_USERS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.AdministrationUserActionOK(
						modelAction.AdministrationUserModelActionTypes.COUNT_ADMINISTRATION_USERS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.AdministrationUserActionFail(
								modelAction.AdministrationUserModelActionTypes.COUNT_ADMINISTRATION_USERS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AdministrationUserAction>(modelAction.AdministrationUserModelActionTypes.FETCH_ADMINISTRATION_USER),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.AdministrationUserActionOK(
						modelAction.AdministrationUserModelActionTypes.FETCH_ADMINISTRATION_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.AdministrationUserActionFail(
								modelAction.AdministrationUserModelActionTypes.FETCH_ADMINISTRATION_USER_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AdministrationUserAction>(modelAction.AdministrationUserModelActionTypes.FETCH_ALL_ADMINISTRATION_USER),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.AdministrationUserActionOK(
						modelAction.AdministrationUserModelActionTypes.FETCH_ALL_ADMINISTRATION_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.AdministrationUserActionFail(
								modelAction.AdministrationUserModelActionTypes.FETCH_ALL_ADMINISTRATION_USER_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AdministrationUserAction>(modelAction.AdministrationUserModelActionTypes.FETCH_ADMINISTRATION_USER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.AdministrationUserActionOK(
						modelAction.AdministrationUserModelActionTypes.FETCH_ADMINISTRATION_USER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.AdministrationUserActionFail(
								modelAction.AdministrationUserModelActionTypes.FETCH_ADMINISTRATION_USER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AdministrationUserAction>(modelAction.AdministrationUserModelActionTypes.FETCH_LAST_ADMINISTRATION_USER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.AdministrationUserActionOK(
						modelAction.AdministrationUserModelActionTypes.FETCH_LAST_ADMINISTRATION_USER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.AdministrationUserActionFail(
								modelAction.AdministrationUserModelActionTypes.FETCH_LAST_ADMINISTRATION_USER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AdministrationUserAction>(modelAction.AdministrationUserModelActionTypes.CREATE_ADMINISTRATION_USER),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as AdministrationUserModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.AdministrationUserActionOK(
						modelAction.AdministrationUserModelActionTypes.CREATE_ADMINISTRATION_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.AdministrationUserActionFail(
								modelAction.AdministrationUserModelActionTypes.CREATE_ADMINISTRATION_USER_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AdministrationUserAction>(modelAction.AdministrationUserModelActionTypes.CREATE_ALL_ADMINISTRATION_USER),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as AdministrationUserModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.AdministrationUserActionOK(
						modelAction.AdministrationUserModelActionTypes.CREATE_ALL_ADMINISTRATION_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.AdministrationUserActionFail(
								modelAction.AdministrationUserModelActionTypes.CREATE_ALL_ADMINISTRATION_USER_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AdministrationUserAction>(modelAction.AdministrationUserModelActionTypes.UPDATE_ADMINISTRATION_USER),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as AdministrationUserModel;
				...
				return this.service.update(new AdministrationUserModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.AdministrationUserActionOK(
						modelAction.AdministrationUserModelActionTypes.UPDATE_ADMINISTRATION_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.AdministrationUserActionFail(
								modelAction.AdministrationUserModelActionTypes.UPDATE_ADMINISTRATION_USER_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AdministrationUserAction>(modelAction.AdministrationUserModelActionTypes.UPDATE_ALL_ADMINISTRATION_USER),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as AdministrationUserModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new AdministrationUserModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.AdministrationUserActionOK(
						modelAction.AdministrationUserModelActionTypes.UPDATE_ALL_ADMINISTRATION_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.AdministrationUserActionFail(
								modelAction.AdministrationUserModelActionTypes.UPDATE_ALL_ADMINISTRATION_USER_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AdministrationUserAction>(modelAction.AdministrationUserModelActionTypes.DELETE_ADMINISTRATION_USER),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.AdministrationUserActionOK(
						modelAction.AdministrationUserModelActionTypes.DELETE_ADMINISTRATION_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.AdministrationUserActionFail(
								modelAction.AdministrationUserModelActionTypes.DELETE_ADMINISTRATION_USER_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AdministrationUserAction>(modelAction.AdministrationUserModelActionTypes.DELETE_ADMINISTRATION_USER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.AdministrationUserActionOK(
						modelAction.AdministrationUserModelActionTypes.DELETE_ADMINISTRATION_USER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.AdministrationUserActionFail(
								modelAction.AdministrationUserModelActionTypes.DELETE_ADMINISTRATION_USER_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AdministrationUserAction>(modelAction.AdministrationUserModelActionTypes.DELETE_ALL_ADMINISTRATION_USER),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.AdministrationUserActionOK(
						modelAction.AdministrationUserModelActionTypes.DELETE_ALL_ADMINISTRATION_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.AdministrationUserActionFail(
								modelAction.AdministrationUserModelActionTypes.DELETE_ALL_ADMINISTRATION_USER_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AdministrationUserAction>(modelAction.AdministrationUserModelActionTypes.EXPORT_ADMINISTRATION_USER),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.AdministrationUserActionOK(
						modelAction.AdministrationUserModelActionTypes.EXPORT_ADMINISTRATION_USER,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AdministrationUserAction>(modelAction.AdministrationUserModelActionTypes.EXPORT_ALL_ADMINISTRATION_USER),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.AdministrationUserActionOK(
						modelAction.AdministrationUserModelActionTypes.EXPORT_ALL_ADMINISTRATION_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.AdministrationUserActionFail(
								modelAction.AdministrationUserModelActionTypes.EXPORT_ALL_ADMINISTRATION_USER_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AdministrationUserAction>(modelAction.AdministrationUserModelActionTypes.EXPORT_ADMINISTRATION_USER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.AdministrationUserActionOK(
						modelAction.AdministrationUserModelActionTypes.EXPORT_ADMINISTRATION_USER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.AdministrationUserActionFail(
								modelAction.AdministrationUserModelActionTypes.EXPORT_ADMINISTRATION_USER_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AdministrationUserAction>(modelAction.AdministrationUserModelActionTypes.IMPORT_ADMINISTRATION_USERS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.AdministrationUserActionOK(
						modelAction.AdministrationUserModelActionTypes.IMPORT_ADMINISTRATION_USERS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.AdministrationUserActionFail(
								modelAction.AdministrationUserModelActionTypes.IMPORT_ADMINISTRATION_USERS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AdministrationUserAction>(modelAction.AdministrationUserModelActionTypes.FETCH_ADMINISTRATION_USER_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.AdministrationUserActionOK(
						modelAction.AdministrationUserModelActionTypes.FETCH_ADMINISTRATION_USER_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.AdministrationUserActionFail(
								modelAction.AdministrationUserModelActionTypes.FETCH_ADMINISTRATION_USER_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AdministrationUserAction>(modelAction.AdministrationUserModelActionTypes.FETCH_ADMINISTRATION_USER_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.AdministrationUserActionOK(
						modelAction.AdministrationUserModelActionTypes.FETCH_ADMINISTRATION_USER_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.AdministrationUserActionFail(
								modelAction.AdministrationUserModelActionTypes.FETCH_ADMINISTRATION_USER_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
