...
/**
 * AdministrationUserCollectionState would store the state of a collection of AdministrationUser
 */
export interface AdministrationUserCollectionState extends CollectionState {
 ...
 */
export interface AdministrationUserModelAudit extends AbstractModelAudit<AdministrationUserModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * AdministrationUserModelState would store the state of the model
 */
export interface AdministrationUserModelState {
	collectionState: {
		[key: string]: AdministrationUserCollectionState;
	};
	data: {
		[id: string]: AdministrationUserModel;
	};
	totalCount: number;
	audits: AdministrationUserModelAudit[];
 ...
 */
export const initialAdministrationUserCollectionState: AdministrationUserCollectionState = {
...
/**
 * The initial state of AdministrationUserModelState
 */
export const initialState: AdministrationUserModelState = {
	collectionState: {
