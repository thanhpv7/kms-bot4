...
/**
 * BpjsJasaRaharjaCollectionState would store the state of a collection of BpjsJasaRaharja
 */
export interface BpjsJasaRaharjaCollectionState extends CollectionState {
 ...
 */
export interface BpjsJasaRaharjaModelAudit extends AbstractModelAudit<BpjsJasaRaharjaModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsJasaRaharjaModelState would store the state of the model
 */
export interface BpjsJasaRaharjaModelState {
	collectionState: {
		[key: string]: BpjsJasaRaharjaCollectionState;
	};
	data: {
		[id: string]: BpjsJasaRaharjaModel;
	};
	totalCount: number;
	audits: BpjsJasaRaharjaModelAudit[];
 ...
 */
export const initialBpjsJasaRaharjaCollectionState: BpjsJasaRaharjaCollectionState = {
...
/**
 * The initial state of BpjsJasaRaharjaModelState
 */
export const initialState: BpjsJasaRaharjaModelState = {
	collectionState: {
