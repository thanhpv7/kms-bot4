...
import {initialBpjsJasaRaharjaCollectionState} from './bpjs_jasa_raharja.model.state';
...
export function modelReducer(currentState: ModelState, action: Action): ModelState {
	...
	const className = (action as modelAction.BaseBpjsJasaRaharjaAction).className;
	...
	return produce(currentState, draft => {
		...
		switch (action.type) {
			case modelAction.BpjsJasaRaharjaModelActionTypes.CREATE_BPJS_JASA_RAHARJA_OK:
				const createdModel = (action as modelAction.BpjsJasaRaharjaActionOK ).stateConfig.targetModel;
				...
				BpjsJasaRaharjaModel.deepParse(createdModel).forEach(model => {
				...
				break;
			case modelAction.BpjsJasaRaharjaModelActionTypes.CREATE_BPJS_JASA_RAHARJA_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.BpjsJasaRaharjaModelActionTypes.CREATE_ALL_BPJS_JASA_RAHARJA_OK:
				const createdModels = (action as modelAction.BpjsJasaRaharjaActionOK).stateConfig.targetModels;
				const collectionIdAfterCreateAll = (action as modelAction.BpjsJasaRaharjaActionOK).stateConfig.collectionId;
				...
				createdModels.forEach((m) => {
					BpjsJasaRaharjaModel.deepParse(m).forEach(model => {
						draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
						(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
					});
				});
				...
				break;
			case modelAction.BpjsJasaRaharjaModelActionTypes.CREATE_ALL_BPJS_JASA_RAHARJA_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.BpjsJasaRaharjaModelActionTypes.DELETE_BPJS_JASA_RAHARJA_OK:
				const deletedModelId = (action as modelAction.BpjsJasaRaharjaActionOK).stateConfig.targetModelId;
				const collectionIdAfterDelete = (action as modelAction.BpjsJasaRaharjaActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.BpjsJasaRaharjaModelActionTypes.DELETE_ALL_BPJS_JASA_RAHARJA_OK:
				const deletedModelIds = (action as modelAction.BpjsJasaRaharjaActionOK).stateConfig.targetModelIds;
				const collectionIdAfterDeleteAll = (action as modelAction.BpjsJasaRaharjaActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.BpjsJasaRaharjaModelActionTypes.DELETE_BPJS_JASA_RAHARJA_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.BpjsJasaRaharjaModelActionTypes.UPDATE_BPJS_JASA_RAHARJA_OK:
				const updatedModel = (action as modelAction.BpjsJasaRaharjaActionOK).stateConfig.targetModel;
				...
				BpjsJasaRaharjaModel.deepParse(updatedModel).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.BpjsJasaRaharjaModelActionTypes.UPDATE_BPJS_JASA_RAHARJA_FAIL:
				// TODO: Add handling of failure
				break;

			case modelAction.BpjsJasaRaharjaModelActionTypes.UPDATE_ALL_BPJS_JASA_RAHARJA_OK:
				const updatedModels = (action as modelAction.BpjsJasaRaharjaActionOK).stateConfig.targetModels;
				const collectionIdAfterUpdateAll = (action as modelAction.BpjsJasaRaharjaActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.BpjsJasaRaharjaModelActionTypes.UPDATE_ALL_BPJS_JASA_RAHARJA_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.BpjsJasaRaharjaModelActionTypes.FETCH_BPJS_JASA_RAHARJA_OK:
				let fetchedModel = (action as modelAction.BpjsJasaRaharjaActionOK).stateConfig.targetModel;
				...
				BpjsJasaRaharjaModel.deepParse(fetchedModel).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.BpjsJasaRaharjaModelActionTypes.FETCH_ALL_BPJS_JASA_RAHARJA_OK:
				const totalCountAfterFetchAll = (action as modelAction.BpjsJasaRaharjaActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchAll = (action as modelAction.BpjsJasaRaharjaActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchAll = (action as modelAction.BpjsJasaRaharjaActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchAll = (action as modelAction.BpjsJasaRaharjaActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchAll.map(model => BpjsJasaRaharjaModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.BpjsJasaRaharjaModelActionTypes.FETCH_BPJS_JASA_RAHARJA_AUDIT_OK:
				const audits = (action as modelAction.BpjsJasaRaharjaActionOK).audits;
				...
				break;
			case modelAction.BpjsJasaRaharjaModelActionTypes.FETCH_BPJS_JASA_RAHARJA_AUDITS_BY_ENTITY_ID_OK:
				const auditsByEntityId = (action as modelAction.BpjsJasaRaharjaActionOK).audits;
				...
				break;
			case modelAction.BpjsJasaRaharjaModelActionTypes.FETCH_BPJS_JASA_RAHARJA_WITH_QUERY_OK:
				const totalCountAfterFetchWithQuery = (action as modelAction.BpjsJasaRaharjaActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchWithQuery = (action as modelAction.BpjsJasaRaharjaActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchWithQuery = (action as modelAction.BpjsJasaRaharjaActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchWithQuery = (action as modelAction.BpjsJasaRaharjaActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchWithQuery.map(model => BpjsJasaRaharjaModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.BpjsJasaRaharjaModelActionTypes.FETCH_LAST_BPJS_JASA_RAHARJA_WITH_QUERY_OK:
				const totalCountAfterFetchLastWithQuery = (action as modelAction.BpjsJasaRaharjaActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchLastWithQuery = (action as modelAction.BpjsJasaRaharjaActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchLastWithQuery = (action as modelAction.BpjsJasaRaharjaActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchLastWithQuery = (action as modelAction.BpjsJasaRaharjaActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchLastWithQuery.map(model => BpjsJasaRaharjaModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.BpjsJasaRaharjaModelActionTypes.COUNT_BPJS_JASA_RAHARJAS_OK:
				const totalCountAfterCount = (action as modelAction.BpjsJasaRaharjaActionOK).stateConfig.totalCount;
				...
				break;
			case modelAction.BpjsJasaRaharjaModelActionTypes.INITIALISE_BPJS_JASA_RAHARJA_COLLECTION_STATE:
				const collectionIdToInitialise =  (action as modelAction.BpjsJasaRaharjaActionOK).stateConfig.collectionId;
				const queryParamsToInitialise = (action as modelAction.BpjsJasaRaharjaActionOK).stateConfig.queryParams;
				...
				if (!draft[className].collectionState[collectionIdToInitialise]) {
					draft[className].collectionState[collectionIdToInitialise] = {
						...initialBpjsJasaRaharjaCollectionState
					};
				}
