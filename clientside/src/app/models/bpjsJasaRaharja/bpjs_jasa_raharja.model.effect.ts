...
import * as modelAction from './bpjs_jasa_raharja.model.action';
import {BpjsJasaRaharjaService} from '../../services/bpjsJasaRaharja/bpjs_jasa_raharja.service';
...
/**
 * Effect class used for side effects related to BPJS Jasa Raharja model.
 */
@Injectable()
export class BpjsJasaRaharjaEffect {
	...
	constructor(
		...
		protected readonly service: BpjsJasaRaharjaService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsJasaRaharjaAction>(modelAction.BpjsJasaRaharjaModelActionTypes.COUNT_BPJS_JASA_RAHARJAS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsJasaRaharjaActionOK(
						modelAction.BpjsJasaRaharjaModelActionTypes.COUNT_BPJS_JASA_RAHARJAS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsJasaRaharjaActionFail(
								modelAction.BpjsJasaRaharjaModelActionTypes.COUNT_BPJS_JASA_RAHARJAS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsJasaRaharjaAction>(modelAction.BpjsJasaRaharjaModelActionTypes.FETCH_BPJS_JASA_RAHARJA),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsJasaRaharjaActionOK(
						modelAction.BpjsJasaRaharjaModelActionTypes.FETCH_BPJS_JASA_RAHARJA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsJasaRaharjaActionFail(
								modelAction.BpjsJasaRaharjaModelActionTypes.FETCH_BPJS_JASA_RAHARJA_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsJasaRaharjaAction>(modelAction.BpjsJasaRaharjaModelActionTypes.FETCH_ALL_BPJS_JASA_RAHARJA),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsJasaRaharjaActionOK(
						modelAction.BpjsJasaRaharjaModelActionTypes.FETCH_ALL_BPJS_JASA_RAHARJA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsJasaRaharjaActionFail(
								modelAction.BpjsJasaRaharjaModelActionTypes.FETCH_ALL_BPJS_JASA_RAHARJA_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsJasaRaharjaAction>(modelAction.BpjsJasaRaharjaModelActionTypes.FETCH_BPJS_JASA_RAHARJA_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsJasaRaharjaActionOK(
						modelAction.BpjsJasaRaharjaModelActionTypes.FETCH_BPJS_JASA_RAHARJA_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsJasaRaharjaActionFail(
								modelAction.BpjsJasaRaharjaModelActionTypes.FETCH_BPJS_JASA_RAHARJA_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsJasaRaharjaAction>(modelAction.BpjsJasaRaharjaModelActionTypes.FETCH_LAST_BPJS_JASA_RAHARJA_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsJasaRaharjaActionOK(
						modelAction.BpjsJasaRaharjaModelActionTypes.FETCH_LAST_BPJS_JASA_RAHARJA_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsJasaRaharjaActionFail(
								modelAction.BpjsJasaRaharjaModelActionTypes.FETCH_LAST_BPJS_JASA_RAHARJA_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsJasaRaharjaAction>(modelAction.BpjsJasaRaharjaModelActionTypes.CREATE_BPJS_JASA_RAHARJA),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsJasaRaharjaModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsJasaRaharjaActionOK(
						modelAction.BpjsJasaRaharjaModelActionTypes.CREATE_BPJS_JASA_RAHARJA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsJasaRaharjaActionFail(
								modelAction.BpjsJasaRaharjaModelActionTypes.CREATE_BPJS_JASA_RAHARJA_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsJasaRaharjaAction>(modelAction.BpjsJasaRaharjaModelActionTypes.CREATE_ALL_BPJS_JASA_RAHARJA),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsJasaRaharjaModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsJasaRaharjaActionOK(
						modelAction.BpjsJasaRaharjaModelActionTypes.CREATE_ALL_BPJS_JASA_RAHARJA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsJasaRaharjaActionFail(
								modelAction.BpjsJasaRaharjaModelActionTypes.CREATE_ALL_BPJS_JASA_RAHARJA_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsJasaRaharjaAction>(modelAction.BpjsJasaRaharjaModelActionTypes.UPDATE_BPJS_JASA_RAHARJA),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsJasaRaharjaModel;
				...
				return this.service.update(new BpjsJasaRaharjaModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsJasaRaharjaActionOK(
						modelAction.BpjsJasaRaharjaModelActionTypes.UPDATE_BPJS_JASA_RAHARJA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsJasaRaharjaActionFail(
								modelAction.BpjsJasaRaharjaModelActionTypes.UPDATE_BPJS_JASA_RAHARJA_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsJasaRaharjaAction>(modelAction.BpjsJasaRaharjaModelActionTypes.UPDATE_ALL_BPJS_JASA_RAHARJA),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsJasaRaharjaModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsJasaRaharjaModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsJasaRaharjaActionOK(
						modelAction.BpjsJasaRaharjaModelActionTypes.UPDATE_ALL_BPJS_JASA_RAHARJA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsJasaRaharjaActionFail(
								modelAction.BpjsJasaRaharjaModelActionTypes.UPDATE_ALL_BPJS_JASA_RAHARJA_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsJasaRaharjaAction>(modelAction.BpjsJasaRaharjaModelActionTypes.DELETE_BPJS_JASA_RAHARJA),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsJasaRaharjaActionOK(
						modelAction.BpjsJasaRaharjaModelActionTypes.DELETE_BPJS_JASA_RAHARJA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsJasaRaharjaActionFail(
								modelAction.BpjsJasaRaharjaModelActionTypes.DELETE_BPJS_JASA_RAHARJA_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsJasaRaharjaAction>(modelAction.BpjsJasaRaharjaModelActionTypes.DELETE_BPJS_JASA_RAHARJA_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsJasaRaharjaActionOK(
						modelAction.BpjsJasaRaharjaModelActionTypes.DELETE_BPJS_JASA_RAHARJA_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsJasaRaharjaActionFail(
								modelAction.BpjsJasaRaharjaModelActionTypes.DELETE_BPJS_JASA_RAHARJA_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsJasaRaharjaAction>(modelAction.BpjsJasaRaharjaModelActionTypes.DELETE_ALL_BPJS_JASA_RAHARJA),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsJasaRaharjaActionOK(
						modelAction.BpjsJasaRaharjaModelActionTypes.DELETE_ALL_BPJS_JASA_RAHARJA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsJasaRaharjaActionFail(
								modelAction.BpjsJasaRaharjaModelActionTypes.DELETE_ALL_BPJS_JASA_RAHARJA_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsJasaRaharjaAction>(modelAction.BpjsJasaRaharjaModelActionTypes.EXPORT_BPJS_JASA_RAHARJA),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsJasaRaharjaActionOK(
						modelAction.BpjsJasaRaharjaModelActionTypes.EXPORT_BPJS_JASA_RAHARJA,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsJasaRaharjaAction>(modelAction.BpjsJasaRaharjaModelActionTypes.EXPORT_ALL_BPJS_JASA_RAHARJA),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsJasaRaharjaActionOK(
						modelAction.BpjsJasaRaharjaModelActionTypes.EXPORT_ALL_BPJS_JASA_RAHARJA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsJasaRaharjaActionFail(
								modelAction.BpjsJasaRaharjaModelActionTypes.EXPORT_ALL_BPJS_JASA_RAHARJA_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsJasaRaharjaAction>(modelAction.BpjsJasaRaharjaModelActionTypes.EXPORT_BPJS_JASA_RAHARJA_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsJasaRaharjaActionOK(
						modelAction.BpjsJasaRaharjaModelActionTypes.EXPORT_BPJS_JASA_RAHARJA_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsJasaRaharjaActionFail(
								modelAction.BpjsJasaRaharjaModelActionTypes.EXPORT_BPJS_JASA_RAHARJA_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsJasaRaharjaAction>(modelAction.BpjsJasaRaharjaModelActionTypes.IMPORT_BPJS_JASA_RAHARJAS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsJasaRaharjaActionOK(
						modelAction.BpjsJasaRaharjaModelActionTypes.IMPORT_BPJS_JASA_RAHARJAS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsJasaRaharjaActionFail(
								modelAction.BpjsJasaRaharjaModelActionTypes.IMPORT_BPJS_JASA_RAHARJAS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsJasaRaharjaAction>(modelAction.BpjsJasaRaharjaModelActionTypes.FETCH_BPJS_JASA_RAHARJA_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsJasaRaharjaActionOK(
						modelAction.BpjsJasaRaharjaModelActionTypes.FETCH_BPJS_JASA_RAHARJA_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsJasaRaharjaActionFail(
								modelAction.BpjsJasaRaharjaModelActionTypes.FETCH_BPJS_JASA_RAHARJA_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsJasaRaharjaAction>(modelAction.BpjsJasaRaharjaModelActionTypes.FETCH_BPJS_JASA_RAHARJA_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsJasaRaharjaActionOK(
						modelAction.BpjsJasaRaharjaModelActionTypes.FETCH_BPJS_JASA_RAHARJA_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsJasaRaharjaActionFail(
								modelAction.BpjsJasaRaharjaModelActionTypes.FETCH_BPJS_JASA_RAHARJA_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
