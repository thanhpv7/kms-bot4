...
/**
 * CoTreatingDoctorCollectionState would store the state of a collection of CoTreatingDoctor
 */
export interface CoTreatingDoctorCollectionState extends CollectionState {
 ...
 */
export interface CoTreatingDoctorModelAudit extends AbstractModelAudit<CoTreatingDoctorModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * CoTreatingDoctorModelState would store the state of the model
 */
export interface CoTreatingDoctorModelState {
	collectionState: {
		[key: string]: CoTreatingDoctorCollectionState;
	};
	data: {
		[id: string]: CoTreatingDoctorModel;
	};
	totalCount: number;
	audits: CoTreatingDoctorModelAudit[];
 ...
 */
export const initialCoTreatingDoctorCollectionState: CoTreatingDoctorCollectionState = {
...
/**
 * The initial state of CoTreatingDoctorModelState
 */
export const initialState: CoTreatingDoctorModelState = {
	collectionState: {
