...
import * as modelAction from './co_treating_doctor.model.action';
import {CoTreatingDoctorService} from '../../services/coTreatingDoctor/co_treating_doctor.service';
...
/**
 * Effect class used for side effects related to Co Treating Doctor model.
 */
@Injectable()
export class CoTreatingDoctorEffect {
	...
	constructor(
		...
		protected readonly service: CoTreatingDoctorService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CoTreatingDoctorAction>(modelAction.CoTreatingDoctorModelActionTypes.COUNT_CO_TREATING_DOCTORS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.CoTreatingDoctorActionOK(
						modelAction.CoTreatingDoctorModelActionTypes.COUNT_CO_TREATING_DOCTORS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CoTreatingDoctorActionFail(
								modelAction.CoTreatingDoctorModelActionTypes.COUNT_CO_TREATING_DOCTORS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CoTreatingDoctorAction>(modelAction.CoTreatingDoctorModelActionTypes.FETCH_CO_TREATING_DOCTOR),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.CoTreatingDoctorActionOK(
						modelAction.CoTreatingDoctorModelActionTypes.FETCH_CO_TREATING_DOCTOR_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CoTreatingDoctorActionFail(
								modelAction.CoTreatingDoctorModelActionTypes.FETCH_CO_TREATING_DOCTOR_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CoTreatingDoctorAction>(modelAction.CoTreatingDoctorModelActionTypes.FETCH_ALL_CO_TREATING_DOCTOR),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.CoTreatingDoctorActionOK(
						modelAction.CoTreatingDoctorModelActionTypes.FETCH_ALL_CO_TREATING_DOCTOR_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CoTreatingDoctorActionFail(
								modelAction.CoTreatingDoctorModelActionTypes.FETCH_ALL_CO_TREATING_DOCTOR_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CoTreatingDoctorAction>(modelAction.CoTreatingDoctorModelActionTypes.FETCH_CO_TREATING_DOCTOR_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.CoTreatingDoctorActionOK(
						modelAction.CoTreatingDoctorModelActionTypes.FETCH_CO_TREATING_DOCTOR_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CoTreatingDoctorActionFail(
								modelAction.CoTreatingDoctorModelActionTypes.FETCH_CO_TREATING_DOCTOR_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CoTreatingDoctorAction>(modelAction.CoTreatingDoctorModelActionTypes.FETCH_LAST_CO_TREATING_DOCTOR_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.CoTreatingDoctorActionOK(
						modelAction.CoTreatingDoctorModelActionTypes.FETCH_LAST_CO_TREATING_DOCTOR_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CoTreatingDoctorActionFail(
								modelAction.CoTreatingDoctorModelActionTypes.FETCH_LAST_CO_TREATING_DOCTOR_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CoTreatingDoctorAction>(modelAction.CoTreatingDoctorModelActionTypes.CREATE_CO_TREATING_DOCTOR),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as CoTreatingDoctorModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.CoTreatingDoctorActionOK(
						modelAction.CoTreatingDoctorModelActionTypes.CREATE_CO_TREATING_DOCTOR_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CoTreatingDoctorActionFail(
								modelAction.CoTreatingDoctorModelActionTypes.CREATE_CO_TREATING_DOCTOR_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CoTreatingDoctorAction>(modelAction.CoTreatingDoctorModelActionTypes.CREATE_ALL_CO_TREATING_DOCTOR),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as CoTreatingDoctorModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.CoTreatingDoctorActionOK(
						modelAction.CoTreatingDoctorModelActionTypes.CREATE_ALL_CO_TREATING_DOCTOR_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CoTreatingDoctorActionFail(
								modelAction.CoTreatingDoctorModelActionTypes.CREATE_ALL_CO_TREATING_DOCTOR_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CoTreatingDoctorAction>(modelAction.CoTreatingDoctorModelActionTypes.UPDATE_CO_TREATING_DOCTOR),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as CoTreatingDoctorModel;
				...
				return this.service.update(new CoTreatingDoctorModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.CoTreatingDoctorActionOK(
						modelAction.CoTreatingDoctorModelActionTypes.UPDATE_CO_TREATING_DOCTOR_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CoTreatingDoctorActionFail(
								modelAction.CoTreatingDoctorModelActionTypes.UPDATE_CO_TREATING_DOCTOR_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CoTreatingDoctorAction>(modelAction.CoTreatingDoctorModelActionTypes.UPDATE_ALL_CO_TREATING_DOCTOR),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as CoTreatingDoctorModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new CoTreatingDoctorModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.CoTreatingDoctorActionOK(
						modelAction.CoTreatingDoctorModelActionTypes.UPDATE_ALL_CO_TREATING_DOCTOR_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CoTreatingDoctorActionFail(
								modelAction.CoTreatingDoctorModelActionTypes.UPDATE_ALL_CO_TREATING_DOCTOR_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CoTreatingDoctorAction>(modelAction.CoTreatingDoctorModelActionTypes.DELETE_CO_TREATING_DOCTOR),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.CoTreatingDoctorActionOK(
						modelAction.CoTreatingDoctorModelActionTypes.DELETE_CO_TREATING_DOCTOR_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CoTreatingDoctorActionFail(
								modelAction.CoTreatingDoctorModelActionTypes.DELETE_CO_TREATING_DOCTOR_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CoTreatingDoctorAction>(modelAction.CoTreatingDoctorModelActionTypes.DELETE_CO_TREATING_DOCTOR_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.CoTreatingDoctorActionOK(
						modelAction.CoTreatingDoctorModelActionTypes.DELETE_CO_TREATING_DOCTOR_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CoTreatingDoctorActionFail(
								modelAction.CoTreatingDoctorModelActionTypes.DELETE_CO_TREATING_DOCTOR_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CoTreatingDoctorAction>(modelAction.CoTreatingDoctorModelActionTypes.DELETE_ALL_CO_TREATING_DOCTOR),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.CoTreatingDoctorActionOK(
						modelAction.CoTreatingDoctorModelActionTypes.DELETE_ALL_CO_TREATING_DOCTOR_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CoTreatingDoctorActionFail(
								modelAction.CoTreatingDoctorModelActionTypes.DELETE_ALL_CO_TREATING_DOCTOR_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CoTreatingDoctorAction>(modelAction.CoTreatingDoctorModelActionTypes.EXPORT_CO_TREATING_DOCTOR),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.CoTreatingDoctorActionOK(
						modelAction.CoTreatingDoctorModelActionTypes.EXPORT_CO_TREATING_DOCTOR,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CoTreatingDoctorAction>(modelAction.CoTreatingDoctorModelActionTypes.EXPORT_ALL_CO_TREATING_DOCTOR),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.CoTreatingDoctorActionOK(
						modelAction.CoTreatingDoctorModelActionTypes.EXPORT_ALL_CO_TREATING_DOCTOR_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CoTreatingDoctorActionFail(
								modelAction.CoTreatingDoctorModelActionTypes.EXPORT_ALL_CO_TREATING_DOCTOR_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CoTreatingDoctorAction>(modelAction.CoTreatingDoctorModelActionTypes.EXPORT_CO_TREATING_DOCTOR_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.CoTreatingDoctorActionOK(
						modelAction.CoTreatingDoctorModelActionTypes.EXPORT_CO_TREATING_DOCTOR_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CoTreatingDoctorActionFail(
								modelAction.CoTreatingDoctorModelActionTypes.EXPORT_CO_TREATING_DOCTOR_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CoTreatingDoctorAction>(modelAction.CoTreatingDoctorModelActionTypes.IMPORT_CO_TREATING_DOCTORS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.CoTreatingDoctorActionOK(
						modelAction.CoTreatingDoctorModelActionTypes.IMPORT_CO_TREATING_DOCTORS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CoTreatingDoctorActionFail(
								modelAction.CoTreatingDoctorModelActionTypes.IMPORT_CO_TREATING_DOCTORS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CoTreatingDoctorAction>(modelAction.CoTreatingDoctorModelActionTypes.FETCH_CO_TREATING_DOCTOR_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.CoTreatingDoctorActionOK(
						modelAction.CoTreatingDoctorModelActionTypes.FETCH_CO_TREATING_DOCTOR_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.CoTreatingDoctorActionFail(
								modelAction.CoTreatingDoctorModelActionTypes.FETCH_CO_TREATING_DOCTOR_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CoTreatingDoctorAction>(modelAction.CoTreatingDoctorModelActionTypes.FETCH_CO_TREATING_DOCTOR_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.CoTreatingDoctorActionOK(
						modelAction.CoTreatingDoctorModelActionTypes.FETCH_CO_TREATING_DOCTOR_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.CoTreatingDoctorActionFail(
								modelAction.CoTreatingDoctorModelActionTypes.FETCH_CO_TREATING_DOCTOR_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
