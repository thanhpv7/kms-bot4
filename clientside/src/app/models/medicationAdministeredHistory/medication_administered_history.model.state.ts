...
/**
 * MedicationAdministeredHistoryCollectionState would store the state of a collection of MedicationAdministeredHistory
 */
export interface MedicationAdministeredHistoryCollectionState extends CollectionState {
 ...
 */
export interface MedicationAdministeredHistoryModelAudit extends AbstractModelAudit<MedicationAdministeredHistoryModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * MedicationAdministeredHistoryModelState would store the state of the model
 */
export interface MedicationAdministeredHistoryModelState {
	collectionState: {
		[key: string]: MedicationAdministeredHistoryCollectionState;
	};
	data: {
		[id: string]: MedicationAdministeredHistoryModel;
	};
	totalCount: number;
	audits: MedicationAdministeredHistoryModelAudit[];
 ...
 */
export const initialMedicationAdministeredHistoryCollectionState: MedicationAdministeredHistoryCollectionState = {
...
/**
 * The initial state of MedicationAdministeredHistoryModelState
 */
export const initialState: MedicationAdministeredHistoryModelState = {
	collectionState: {
