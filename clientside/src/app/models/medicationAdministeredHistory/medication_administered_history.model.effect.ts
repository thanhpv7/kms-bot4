...
import * as modelAction from './medication_administered_history.model.action';
import {MedicationAdministeredHistoryService} from '../../services/medicationAdministeredHistory/medication_administered_history.service';
...
/**
 * Effect class used for side effects related to Medication Administered History model.
 */
@Injectable()
export class MedicationAdministeredHistoryEffect {
	...
	constructor(
		...
		protected readonly service: MedicationAdministeredHistoryService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationAdministeredHistoryAction>(modelAction.MedicationAdministeredHistoryModelActionTypes.COUNT_MEDICATION_ADMINISTERED_HISTORYS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.MedicationAdministeredHistoryActionOK(
						modelAction.MedicationAdministeredHistoryModelActionTypes.COUNT_MEDICATION_ADMINISTERED_HISTORYS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationAdministeredHistoryActionFail(
								modelAction.MedicationAdministeredHistoryModelActionTypes.COUNT_MEDICATION_ADMINISTERED_HISTORYS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationAdministeredHistoryAction>(modelAction.MedicationAdministeredHistoryModelActionTypes.FETCH_MEDICATION_ADMINISTERED_HISTORY),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicationAdministeredHistoryActionOK(
						modelAction.MedicationAdministeredHistoryModelActionTypes.FETCH_MEDICATION_ADMINISTERED_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationAdministeredHistoryActionFail(
								modelAction.MedicationAdministeredHistoryModelActionTypes.FETCH_MEDICATION_ADMINISTERED_HISTORY_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationAdministeredHistoryAction>(modelAction.MedicationAdministeredHistoryModelActionTypes.FETCH_ALL_MEDICATION_ADMINISTERED_HISTORY),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.MedicationAdministeredHistoryActionOK(
						modelAction.MedicationAdministeredHistoryModelActionTypes.FETCH_ALL_MEDICATION_ADMINISTERED_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationAdministeredHistoryActionFail(
								modelAction.MedicationAdministeredHistoryModelActionTypes.FETCH_ALL_MEDICATION_ADMINISTERED_HISTORY_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationAdministeredHistoryAction>(modelAction.MedicationAdministeredHistoryModelActionTypes.FETCH_MEDICATION_ADMINISTERED_HISTORY_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicationAdministeredHistoryActionOK(
						modelAction.MedicationAdministeredHistoryModelActionTypes.FETCH_MEDICATION_ADMINISTERED_HISTORY_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationAdministeredHistoryActionFail(
								modelAction.MedicationAdministeredHistoryModelActionTypes.FETCH_MEDICATION_ADMINISTERED_HISTORY_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationAdministeredHistoryAction>(modelAction.MedicationAdministeredHistoryModelActionTypes.FETCH_LAST_MEDICATION_ADMINISTERED_HISTORY_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicationAdministeredHistoryActionOK(
						modelAction.MedicationAdministeredHistoryModelActionTypes.FETCH_LAST_MEDICATION_ADMINISTERED_HISTORY_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationAdministeredHistoryActionFail(
								modelAction.MedicationAdministeredHistoryModelActionTypes.FETCH_LAST_MEDICATION_ADMINISTERED_HISTORY_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationAdministeredHistoryAction>(modelAction.MedicationAdministeredHistoryModelActionTypes.CREATE_MEDICATION_ADMINISTERED_HISTORY),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as MedicationAdministeredHistoryModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicationAdministeredHistoryActionOK(
						modelAction.MedicationAdministeredHistoryModelActionTypes.CREATE_MEDICATION_ADMINISTERED_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationAdministeredHistoryActionFail(
								modelAction.MedicationAdministeredHistoryModelActionTypes.CREATE_MEDICATION_ADMINISTERED_HISTORY_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationAdministeredHistoryAction>(modelAction.MedicationAdministeredHistoryModelActionTypes.CREATE_ALL_MEDICATION_ADMINISTERED_HISTORY),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as MedicationAdministeredHistoryModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicationAdministeredHistoryActionOK(
						modelAction.MedicationAdministeredHistoryModelActionTypes.CREATE_ALL_MEDICATION_ADMINISTERED_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationAdministeredHistoryActionFail(
								modelAction.MedicationAdministeredHistoryModelActionTypes.CREATE_ALL_MEDICATION_ADMINISTERED_HISTORY_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationAdministeredHistoryAction>(modelAction.MedicationAdministeredHistoryModelActionTypes.UPDATE_MEDICATION_ADMINISTERED_HISTORY),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as MedicationAdministeredHistoryModel;
				...
				return this.service.update(new MedicationAdministeredHistoryModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicationAdministeredHistoryActionOK(
						modelAction.MedicationAdministeredHistoryModelActionTypes.UPDATE_MEDICATION_ADMINISTERED_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationAdministeredHistoryActionFail(
								modelAction.MedicationAdministeredHistoryModelActionTypes.UPDATE_MEDICATION_ADMINISTERED_HISTORY_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationAdministeredHistoryAction>(modelAction.MedicationAdministeredHistoryModelActionTypes.UPDATE_ALL_MEDICATION_ADMINISTERED_HISTORY),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as MedicationAdministeredHistoryModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new MedicationAdministeredHistoryModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicationAdministeredHistoryActionOK(
						modelAction.MedicationAdministeredHistoryModelActionTypes.UPDATE_ALL_MEDICATION_ADMINISTERED_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationAdministeredHistoryActionFail(
								modelAction.MedicationAdministeredHistoryModelActionTypes.UPDATE_ALL_MEDICATION_ADMINISTERED_HISTORY_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationAdministeredHistoryAction>(modelAction.MedicationAdministeredHistoryModelActionTypes.DELETE_MEDICATION_ADMINISTERED_HISTORY),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.MedicationAdministeredHistoryActionOK(
						modelAction.MedicationAdministeredHistoryModelActionTypes.DELETE_MEDICATION_ADMINISTERED_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationAdministeredHistoryActionFail(
								modelAction.MedicationAdministeredHistoryModelActionTypes.DELETE_MEDICATION_ADMINISTERED_HISTORY_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationAdministeredHistoryAction>(modelAction.MedicationAdministeredHistoryModelActionTypes.DELETE_MEDICATION_ADMINISTERED_HISTORY_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.MedicationAdministeredHistoryActionOK(
						modelAction.MedicationAdministeredHistoryModelActionTypes.DELETE_MEDICATION_ADMINISTERED_HISTORY_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationAdministeredHistoryActionFail(
								modelAction.MedicationAdministeredHistoryModelActionTypes.DELETE_MEDICATION_ADMINISTERED_HISTORY_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationAdministeredHistoryAction>(modelAction.MedicationAdministeredHistoryModelActionTypes.DELETE_ALL_MEDICATION_ADMINISTERED_HISTORY),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.MedicationAdministeredHistoryActionOK(
						modelAction.MedicationAdministeredHistoryModelActionTypes.DELETE_ALL_MEDICATION_ADMINISTERED_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationAdministeredHistoryActionFail(
								modelAction.MedicationAdministeredHistoryModelActionTypes.DELETE_ALL_MEDICATION_ADMINISTERED_HISTORY_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationAdministeredHistoryAction>(modelAction.MedicationAdministeredHistoryModelActionTypes.EXPORT_MEDICATION_ADMINISTERED_HISTORY),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicationAdministeredHistoryActionOK(
						modelAction.MedicationAdministeredHistoryModelActionTypes.EXPORT_MEDICATION_ADMINISTERED_HISTORY,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationAdministeredHistoryAction>(modelAction.MedicationAdministeredHistoryModelActionTypes.EXPORT_ALL_MEDICATION_ADMINISTERED_HISTORY),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicationAdministeredHistoryActionOK(
						modelAction.MedicationAdministeredHistoryModelActionTypes.EXPORT_ALL_MEDICATION_ADMINISTERED_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationAdministeredHistoryActionFail(
								modelAction.MedicationAdministeredHistoryModelActionTypes.EXPORT_ALL_MEDICATION_ADMINISTERED_HISTORY_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationAdministeredHistoryAction>(modelAction.MedicationAdministeredHistoryModelActionTypes.EXPORT_MEDICATION_ADMINISTERED_HISTORY_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicationAdministeredHistoryActionOK(
						modelAction.MedicationAdministeredHistoryModelActionTypes.EXPORT_MEDICATION_ADMINISTERED_HISTORY_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationAdministeredHistoryActionFail(
								modelAction.MedicationAdministeredHistoryModelActionTypes.EXPORT_MEDICATION_ADMINISTERED_HISTORY_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationAdministeredHistoryAction>(modelAction.MedicationAdministeredHistoryModelActionTypes.IMPORT_MEDICATION_ADMINISTERED_HISTORYS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.MedicationAdministeredHistoryActionOK(
						modelAction.MedicationAdministeredHistoryModelActionTypes.IMPORT_MEDICATION_ADMINISTERED_HISTORYS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationAdministeredHistoryActionFail(
								modelAction.MedicationAdministeredHistoryModelActionTypes.IMPORT_MEDICATION_ADMINISTERED_HISTORYS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationAdministeredHistoryAction>(modelAction.MedicationAdministeredHistoryModelActionTypes.FETCH_MEDICATION_ADMINISTERED_HISTORY_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.MedicationAdministeredHistoryActionOK(
						modelAction.MedicationAdministeredHistoryModelActionTypes.FETCH_MEDICATION_ADMINISTERED_HISTORY_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.MedicationAdministeredHistoryActionFail(
								modelAction.MedicationAdministeredHistoryModelActionTypes.FETCH_MEDICATION_ADMINISTERED_HISTORY_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationAdministeredHistoryAction>(modelAction.MedicationAdministeredHistoryModelActionTypes.FETCH_MEDICATION_ADMINISTERED_HISTORY_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.MedicationAdministeredHistoryActionOK(
						modelAction.MedicationAdministeredHistoryModelActionTypes.FETCH_MEDICATION_ADMINISTERED_HISTORY_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.MedicationAdministeredHistoryActionFail(
								modelAction.MedicationAdministeredHistoryModelActionTypes.FETCH_MEDICATION_ADMINISTERED_HISTORY_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
