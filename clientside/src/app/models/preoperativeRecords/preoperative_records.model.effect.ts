...
import * as modelAction from './preoperative_records.model.action';
import {PreoperativeRecordsService} from '../../services/preoperativeRecords/preoperative_records.service';
...
/**
 * Effect class used for side effects related to Preoperative Records model.
 */
@Injectable()
export class PreoperativeRecordsEffect {
	...
	constructor(
		...
		protected readonly service: PreoperativeRecordsService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PreoperativeRecordsAction>(modelAction.PreoperativeRecordsModelActionTypes.COUNT_PREOPERATIVE_RECORDSS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.PreoperativeRecordsActionOK(
						modelAction.PreoperativeRecordsModelActionTypes.COUNT_PREOPERATIVE_RECORDSS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PreoperativeRecordsActionFail(
								modelAction.PreoperativeRecordsModelActionTypes.COUNT_PREOPERATIVE_RECORDSS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PreoperativeRecordsAction>(modelAction.PreoperativeRecordsModelActionTypes.FETCH_PREOPERATIVE_RECORDS),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PreoperativeRecordsActionOK(
						modelAction.PreoperativeRecordsModelActionTypes.FETCH_PREOPERATIVE_RECORDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PreoperativeRecordsActionFail(
								modelAction.PreoperativeRecordsModelActionTypes.FETCH_PREOPERATIVE_RECORDS_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PreoperativeRecordsAction>(modelAction.PreoperativeRecordsModelActionTypes.FETCH_ALL_PREOPERATIVE_RECORDS),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.PreoperativeRecordsActionOK(
						modelAction.PreoperativeRecordsModelActionTypes.FETCH_ALL_PREOPERATIVE_RECORDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PreoperativeRecordsActionFail(
								modelAction.PreoperativeRecordsModelActionTypes.FETCH_ALL_PREOPERATIVE_RECORDS_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PreoperativeRecordsAction>(modelAction.PreoperativeRecordsModelActionTypes.FETCH_PREOPERATIVE_RECORDS_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PreoperativeRecordsActionOK(
						modelAction.PreoperativeRecordsModelActionTypes.FETCH_PREOPERATIVE_RECORDS_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PreoperativeRecordsActionFail(
								modelAction.PreoperativeRecordsModelActionTypes.FETCH_PREOPERATIVE_RECORDS_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PreoperativeRecordsAction>(modelAction.PreoperativeRecordsModelActionTypes.FETCH_LAST_PREOPERATIVE_RECORDS_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PreoperativeRecordsActionOK(
						modelAction.PreoperativeRecordsModelActionTypes.FETCH_LAST_PREOPERATIVE_RECORDS_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PreoperativeRecordsActionFail(
								modelAction.PreoperativeRecordsModelActionTypes.FETCH_LAST_PREOPERATIVE_RECORDS_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PreoperativeRecordsAction>(modelAction.PreoperativeRecordsModelActionTypes.CREATE_PREOPERATIVE_RECORDS),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as PreoperativeRecordsModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PreoperativeRecordsActionOK(
						modelAction.PreoperativeRecordsModelActionTypes.CREATE_PREOPERATIVE_RECORDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PreoperativeRecordsActionFail(
								modelAction.PreoperativeRecordsModelActionTypes.CREATE_PREOPERATIVE_RECORDS_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PreoperativeRecordsAction>(modelAction.PreoperativeRecordsModelActionTypes.CREATE_ALL_PREOPERATIVE_RECORDS),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as PreoperativeRecordsModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PreoperativeRecordsActionOK(
						modelAction.PreoperativeRecordsModelActionTypes.CREATE_ALL_PREOPERATIVE_RECORDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PreoperativeRecordsActionFail(
								modelAction.PreoperativeRecordsModelActionTypes.CREATE_ALL_PREOPERATIVE_RECORDS_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PreoperativeRecordsAction>(modelAction.PreoperativeRecordsModelActionTypes.UPDATE_PREOPERATIVE_RECORDS),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as PreoperativeRecordsModel;
				...
				return this.service.update(new PreoperativeRecordsModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.PreoperativeRecordsActionOK(
						modelAction.PreoperativeRecordsModelActionTypes.UPDATE_PREOPERATIVE_RECORDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PreoperativeRecordsActionFail(
								modelAction.PreoperativeRecordsModelActionTypes.UPDATE_PREOPERATIVE_RECORDS_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PreoperativeRecordsAction>(modelAction.PreoperativeRecordsModelActionTypes.UPDATE_ALL_PREOPERATIVE_RECORDS),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as PreoperativeRecordsModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new PreoperativeRecordsModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PreoperativeRecordsActionOK(
						modelAction.PreoperativeRecordsModelActionTypes.UPDATE_ALL_PREOPERATIVE_RECORDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PreoperativeRecordsActionFail(
								modelAction.PreoperativeRecordsModelActionTypes.UPDATE_ALL_PREOPERATIVE_RECORDS_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PreoperativeRecordsAction>(modelAction.PreoperativeRecordsModelActionTypes.DELETE_PREOPERATIVE_RECORDS),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PreoperativeRecordsActionOK(
						modelAction.PreoperativeRecordsModelActionTypes.DELETE_PREOPERATIVE_RECORDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PreoperativeRecordsActionFail(
								modelAction.PreoperativeRecordsModelActionTypes.DELETE_PREOPERATIVE_RECORDS_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PreoperativeRecordsAction>(modelAction.PreoperativeRecordsModelActionTypes.DELETE_PREOPERATIVE_RECORDS_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.PreoperativeRecordsActionOK(
						modelAction.PreoperativeRecordsModelActionTypes.DELETE_PREOPERATIVE_RECORDS_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PreoperativeRecordsActionFail(
								modelAction.PreoperativeRecordsModelActionTypes.DELETE_PREOPERATIVE_RECORDS_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PreoperativeRecordsAction>(modelAction.PreoperativeRecordsModelActionTypes.DELETE_ALL_PREOPERATIVE_RECORDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PreoperativeRecordsActionOK(
						modelAction.PreoperativeRecordsModelActionTypes.DELETE_ALL_PREOPERATIVE_RECORDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PreoperativeRecordsActionFail(
								modelAction.PreoperativeRecordsModelActionTypes.DELETE_ALL_PREOPERATIVE_RECORDS_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PreoperativeRecordsAction>(modelAction.PreoperativeRecordsModelActionTypes.EXPORT_PREOPERATIVE_RECORDS),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PreoperativeRecordsActionOK(
						modelAction.PreoperativeRecordsModelActionTypes.EXPORT_PREOPERATIVE_RECORDS,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PreoperativeRecordsAction>(modelAction.PreoperativeRecordsModelActionTypes.EXPORT_ALL_PREOPERATIVE_RECORDS),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PreoperativeRecordsActionOK(
						modelAction.PreoperativeRecordsModelActionTypes.EXPORT_ALL_PREOPERATIVE_RECORDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PreoperativeRecordsActionFail(
								modelAction.PreoperativeRecordsModelActionTypes.EXPORT_ALL_PREOPERATIVE_RECORDS_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PreoperativeRecordsAction>(modelAction.PreoperativeRecordsModelActionTypes.EXPORT_PREOPERATIVE_RECORDS_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PreoperativeRecordsActionOK(
						modelAction.PreoperativeRecordsModelActionTypes.EXPORT_PREOPERATIVE_RECORDS_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PreoperativeRecordsActionFail(
								modelAction.PreoperativeRecordsModelActionTypes.EXPORT_PREOPERATIVE_RECORDS_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PreoperativeRecordsAction>(modelAction.PreoperativeRecordsModelActionTypes.IMPORT_PREOPERATIVE_RECORDSS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.PreoperativeRecordsActionOK(
						modelAction.PreoperativeRecordsModelActionTypes.IMPORT_PREOPERATIVE_RECORDSS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PreoperativeRecordsActionFail(
								modelAction.PreoperativeRecordsModelActionTypes.IMPORT_PREOPERATIVE_RECORDSS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PreoperativeRecordsAction>(modelAction.PreoperativeRecordsModelActionTypes.FETCH_PREOPERATIVE_RECORDS_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.PreoperativeRecordsActionOK(
						modelAction.PreoperativeRecordsModelActionTypes.FETCH_PREOPERATIVE_RECORDS_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PreoperativeRecordsActionFail(
								modelAction.PreoperativeRecordsModelActionTypes.FETCH_PREOPERATIVE_RECORDS_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PreoperativeRecordsAction>(modelAction.PreoperativeRecordsModelActionTypes.FETCH_PREOPERATIVE_RECORDS_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.PreoperativeRecordsActionOK(
						modelAction.PreoperativeRecordsModelActionTypes.FETCH_PREOPERATIVE_RECORDS_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PreoperativeRecordsActionFail(
								modelAction.PreoperativeRecordsModelActionTypes.FETCH_PREOPERATIVE_RECORDS_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
