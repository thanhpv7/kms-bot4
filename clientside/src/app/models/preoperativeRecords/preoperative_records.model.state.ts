...
/**
 * PreoperativeRecordsCollectionState would store the state of a collection of PreoperativeRecords
 */
export interface PreoperativeRecordsCollectionState extends CollectionState {
 ...
 */
export interface PreoperativeRecordsModelAudit extends AbstractModelAudit<PreoperativeRecordsModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * PreoperativeRecordsModelState would store the state of the model
 */
export interface PreoperativeRecordsModelState {
	collectionState: {
		[key: string]: PreoperativeRecordsCollectionState;
	};
	data: {
		[id: string]: PreoperativeRecordsModel;
	};
	totalCount: number;
	audits: PreoperativeRecordsModelAudit[];
 ...
 */
export const initialPreoperativeRecordsCollectionState: PreoperativeRecordsCollectionState = {
...
/**
 * The initial state of PreoperativeRecordsModelState
 */
export const initialState: PreoperativeRecordsModelState = {
	collectionState: {
