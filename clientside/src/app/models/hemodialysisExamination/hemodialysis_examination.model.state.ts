...
/**
 * HemodialysisExaminationCollectionState would store the state of a collection of HemodialysisExamination
 */
export interface HemodialysisExaminationCollectionState extends CollectionState {
 ...
 */
export interface HemodialysisExaminationModelAudit extends AbstractModelAudit<HemodialysisExaminationModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * HemodialysisExaminationModelState would store the state of the model
 */
export interface HemodialysisExaminationModelState {
	collectionState: {
		[key: string]: HemodialysisExaminationCollectionState;
	};
	data: {
		[id: string]: HemodialysisExaminationModel;
	};
	totalCount: number;
	audits: HemodialysisExaminationModelAudit[];
 ...
 */
export const initialHemodialysisExaminationCollectionState: HemodialysisExaminationCollectionState = {
...
/**
 * The initial state of HemodialysisExaminationModelState
 */
export const initialState: HemodialysisExaminationModelState = {
	collectionState: {
