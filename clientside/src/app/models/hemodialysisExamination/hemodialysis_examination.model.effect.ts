...
import * as modelAction from './hemodialysis_examination.model.action';
import {HemodialysisExaminationService} from '../../services/hemodialysisExamination/hemodialysis_examination.service';
...
/**
 * Effect class used for side effects related to Hemodialysis Examination model.
 */
@Injectable()
export class HemodialysisExaminationEffect {
	...
	constructor(
		...
		protected readonly service: HemodialysisExaminationService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HemodialysisExaminationAction>(modelAction.HemodialysisExaminationModelActionTypes.COUNT_HEMODIALYSIS_EXAMINATIONS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.HemodialysisExaminationActionOK(
						modelAction.HemodialysisExaminationModelActionTypes.COUNT_HEMODIALYSIS_EXAMINATIONS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.HemodialysisExaminationActionFail(
								modelAction.HemodialysisExaminationModelActionTypes.COUNT_HEMODIALYSIS_EXAMINATIONS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HemodialysisExaminationAction>(modelAction.HemodialysisExaminationModelActionTypes.FETCH_HEMODIALYSIS_EXAMINATION),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.HemodialysisExaminationActionOK(
						modelAction.HemodialysisExaminationModelActionTypes.FETCH_HEMODIALYSIS_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.HemodialysisExaminationActionFail(
								modelAction.HemodialysisExaminationModelActionTypes.FETCH_HEMODIALYSIS_EXAMINATION_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HemodialysisExaminationAction>(modelAction.HemodialysisExaminationModelActionTypes.FETCH_ALL_HEMODIALYSIS_EXAMINATION),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.HemodialysisExaminationActionOK(
						modelAction.HemodialysisExaminationModelActionTypes.FETCH_ALL_HEMODIALYSIS_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.HemodialysisExaminationActionFail(
								modelAction.HemodialysisExaminationModelActionTypes.FETCH_ALL_HEMODIALYSIS_EXAMINATION_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HemodialysisExaminationAction>(modelAction.HemodialysisExaminationModelActionTypes.FETCH_HEMODIALYSIS_EXAMINATION_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.HemodialysisExaminationActionOK(
						modelAction.HemodialysisExaminationModelActionTypes.FETCH_HEMODIALYSIS_EXAMINATION_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.HemodialysisExaminationActionFail(
								modelAction.HemodialysisExaminationModelActionTypes.FETCH_HEMODIALYSIS_EXAMINATION_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HemodialysisExaminationAction>(modelAction.HemodialysisExaminationModelActionTypes.FETCH_LAST_HEMODIALYSIS_EXAMINATION_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.HemodialysisExaminationActionOK(
						modelAction.HemodialysisExaminationModelActionTypes.FETCH_LAST_HEMODIALYSIS_EXAMINATION_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.HemodialysisExaminationActionFail(
								modelAction.HemodialysisExaminationModelActionTypes.FETCH_LAST_HEMODIALYSIS_EXAMINATION_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HemodialysisExaminationAction>(modelAction.HemodialysisExaminationModelActionTypes.CREATE_HEMODIALYSIS_EXAMINATION),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as HemodialysisExaminationModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.HemodialysisExaminationActionOK(
						modelAction.HemodialysisExaminationModelActionTypes.CREATE_HEMODIALYSIS_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.HemodialysisExaminationActionFail(
								modelAction.HemodialysisExaminationModelActionTypes.CREATE_HEMODIALYSIS_EXAMINATION_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HemodialysisExaminationAction>(modelAction.HemodialysisExaminationModelActionTypes.CREATE_ALL_HEMODIALYSIS_EXAMINATION),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as HemodialysisExaminationModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.HemodialysisExaminationActionOK(
						modelAction.HemodialysisExaminationModelActionTypes.CREATE_ALL_HEMODIALYSIS_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.HemodialysisExaminationActionFail(
								modelAction.HemodialysisExaminationModelActionTypes.CREATE_ALL_HEMODIALYSIS_EXAMINATION_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HemodialysisExaminationAction>(modelAction.HemodialysisExaminationModelActionTypes.UPDATE_HEMODIALYSIS_EXAMINATION),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as HemodialysisExaminationModel;
				...
				return this.service.update(new HemodialysisExaminationModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.HemodialysisExaminationActionOK(
						modelAction.HemodialysisExaminationModelActionTypes.UPDATE_HEMODIALYSIS_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.HemodialysisExaminationActionFail(
								modelAction.HemodialysisExaminationModelActionTypes.UPDATE_HEMODIALYSIS_EXAMINATION_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HemodialysisExaminationAction>(modelAction.HemodialysisExaminationModelActionTypes.UPDATE_ALL_HEMODIALYSIS_EXAMINATION),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as HemodialysisExaminationModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new HemodialysisExaminationModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.HemodialysisExaminationActionOK(
						modelAction.HemodialysisExaminationModelActionTypes.UPDATE_ALL_HEMODIALYSIS_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.HemodialysisExaminationActionFail(
								modelAction.HemodialysisExaminationModelActionTypes.UPDATE_ALL_HEMODIALYSIS_EXAMINATION_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HemodialysisExaminationAction>(modelAction.HemodialysisExaminationModelActionTypes.DELETE_HEMODIALYSIS_EXAMINATION),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.HemodialysisExaminationActionOK(
						modelAction.HemodialysisExaminationModelActionTypes.DELETE_HEMODIALYSIS_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.HemodialysisExaminationActionFail(
								modelAction.HemodialysisExaminationModelActionTypes.DELETE_HEMODIALYSIS_EXAMINATION_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HemodialysisExaminationAction>(modelAction.HemodialysisExaminationModelActionTypes.DELETE_HEMODIALYSIS_EXAMINATION_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.HemodialysisExaminationActionOK(
						modelAction.HemodialysisExaminationModelActionTypes.DELETE_HEMODIALYSIS_EXAMINATION_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.HemodialysisExaminationActionFail(
								modelAction.HemodialysisExaminationModelActionTypes.DELETE_HEMODIALYSIS_EXAMINATION_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HemodialysisExaminationAction>(modelAction.HemodialysisExaminationModelActionTypes.DELETE_ALL_HEMODIALYSIS_EXAMINATION),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.HemodialysisExaminationActionOK(
						modelAction.HemodialysisExaminationModelActionTypes.DELETE_ALL_HEMODIALYSIS_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.HemodialysisExaminationActionFail(
								modelAction.HemodialysisExaminationModelActionTypes.DELETE_ALL_HEMODIALYSIS_EXAMINATION_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HemodialysisExaminationAction>(modelAction.HemodialysisExaminationModelActionTypes.EXPORT_HEMODIALYSIS_EXAMINATION),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.HemodialysisExaminationActionOK(
						modelAction.HemodialysisExaminationModelActionTypes.EXPORT_HEMODIALYSIS_EXAMINATION,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HemodialysisExaminationAction>(modelAction.HemodialysisExaminationModelActionTypes.EXPORT_ALL_HEMODIALYSIS_EXAMINATION),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.HemodialysisExaminationActionOK(
						modelAction.HemodialysisExaminationModelActionTypes.EXPORT_ALL_HEMODIALYSIS_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.HemodialysisExaminationActionFail(
								modelAction.HemodialysisExaminationModelActionTypes.EXPORT_ALL_HEMODIALYSIS_EXAMINATION_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HemodialysisExaminationAction>(modelAction.HemodialysisExaminationModelActionTypes.EXPORT_HEMODIALYSIS_EXAMINATION_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.HemodialysisExaminationActionOK(
						modelAction.HemodialysisExaminationModelActionTypes.EXPORT_HEMODIALYSIS_EXAMINATION_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.HemodialysisExaminationActionFail(
								modelAction.HemodialysisExaminationModelActionTypes.EXPORT_HEMODIALYSIS_EXAMINATION_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HemodialysisExaminationAction>(modelAction.HemodialysisExaminationModelActionTypes.IMPORT_HEMODIALYSIS_EXAMINATIONS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.HemodialysisExaminationActionOK(
						modelAction.HemodialysisExaminationModelActionTypes.IMPORT_HEMODIALYSIS_EXAMINATIONS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.HemodialysisExaminationActionFail(
								modelAction.HemodialysisExaminationModelActionTypes.IMPORT_HEMODIALYSIS_EXAMINATIONS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HemodialysisExaminationAction>(modelAction.HemodialysisExaminationModelActionTypes.FETCH_HEMODIALYSIS_EXAMINATION_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.HemodialysisExaminationActionOK(
						modelAction.HemodialysisExaminationModelActionTypes.FETCH_HEMODIALYSIS_EXAMINATION_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.HemodialysisExaminationActionFail(
								modelAction.HemodialysisExaminationModelActionTypes.FETCH_HEMODIALYSIS_EXAMINATION_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HemodialysisExaminationAction>(modelAction.HemodialysisExaminationModelActionTypes.FETCH_HEMODIALYSIS_EXAMINATION_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.HemodialysisExaminationActionOK(
						modelAction.HemodialysisExaminationModelActionTypes.FETCH_HEMODIALYSIS_EXAMINATION_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.HemodialysisExaminationActionFail(
								modelAction.HemodialysisExaminationModelActionTypes.FETCH_HEMODIALYSIS_EXAMINATION_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
