...
/**
 * AdministratorCollectionState would store the state of a collection of Administrator
 */
export interface AdministratorCollectionState extends CollectionState {
 ...
 */
export interface AdministratorModelAudit extends AbstractModelAudit<AdministratorModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * AdministratorModelState would store the state of the model
 */
export interface AdministratorModelState {
	collectionState: {
		[key: string]: AdministratorCollectionState;
	};
	data: {
		[id: string]: AdministratorModel;
	};
	totalCount: number;
	audits: AdministratorModelAudit[];
 ...
 */
export const initialAdministratorCollectionState: AdministratorCollectionState = {
...
/**
 * The initial state of AdministratorModelState
 */
export const initialState: AdministratorModelState = {
	collectionState: {
