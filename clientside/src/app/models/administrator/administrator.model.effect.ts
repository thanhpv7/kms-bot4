...
import * as modelAction from './administrator.model.action';
...
/**
 * Effect class used for side effects related to Administrator model.
 */
@Injectable()
export class AdministratorEffect {
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AdministratorAction>(modelAction.AdministratorModelActionTypes.COUNT_ADMINISTRATORS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.AdministratorActionOK(
						modelAction.AdministratorModelActionTypes.COUNT_ADMINISTRATORS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.AdministratorActionFail(
								modelAction.AdministratorModelActionTypes.COUNT_ADMINISTRATORS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AdministratorAction>(modelAction.AdministratorModelActionTypes.FETCH_ADMINISTRATOR),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.AdministratorActionOK(
						modelAction.AdministratorModelActionTypes.FETCH_ADMINISTRATOR_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.AdministratorActionFail(
								modelAction.AdministratorModelActionTypes.FETCH_ADMINISTRATOR_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AdministratorAction>(modelAction.AdministratorModelActionTypes.FETCH_ALL_ADMINISTRATOR),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.AdministratorActionOK(
						modelAction.AdministratorModelActionTypes.FETCH_ALL_ADMINISTRATOR_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.AdministratorActionFail(
								modelAction.AdministratorModelActionTypes.FETCH_ALL_ADMINISTRATOR_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AdministratorAction>(modelAction.AdministratorModelActionTypes.FETCH_ADMINISTRATOR_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.AdministratorActionOK(
						modelAction.AdministratorModelActionTypes.FETCH_ADMINISTRATOR_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.AdministratorActionFail(
								modelAction.AdministratorModelActionTypes.FETCH_ADMINISTRATOR_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AdministratorAction>(modelAction.AdministratorModelActionTypes.FETCH_LAST_ADMINISTRATOR_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.AdministratorActionOK(
						modelAction.AdministratorModelActionTypes.FETCH_LAST_ADMINISTRATOR_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.AdministratorActionFail(
								modelAction.AdministratorModelActionTypes.FETCH_LAST_ADMINISTRATOR_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AdministratorAction>(modelAction.AdministratorModelActionTypes.CREATE_ADMINISTRATOR),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as AdministratorModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.AdministratorActionOK(
						modelAction.AdministratorModelActionTypes.CREATE_ADMINISTRATOR_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.AdministratorActionFail(
								modelAction.AdministratorModelActionTypes.CREATE_ADMINISTRATOR_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AdministratorAction>(modelAction.AdministratorModelActionTypes.CREATE_ALL_ADMINISTRATOR),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as AdministratorModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.AdministratorActionOK(
						modelAction.AdministratorModelActionTypes.CREATE_ALL_ADMINISTRATOR_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.AdministratorActionFail(
								modelAction.AdministratorModelActionTypes.CREATE_ALL_ADMINISTRATOR_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AdministratorAction>(modelAction.AdministratorModelActionTypes.UPDATE_ADMINISTRATOR),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as AdministratorModel;
				...
				return this.service.update(new AdministratorModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.AdministratorActionOK(
						modelAction.AdministratorModelActionTypes.UPDATE_ADMINISTRATOR_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.AdministratorActionFail(
								modelAction.AdministratorModelActionTypes.UPDATE_ADMINISTRATOR_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AdministratorAction>(modelAction.AdministratorModelActionTypes.UPDATE_ALL_ADMINISTRATOR),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as AdministratorModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new AdministratorModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.AdministratorActionOK(
						modelAction.AdministratorModelActionTypes.UPDATE_ALL_ADMINISTRATOR_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.AdministratorActionFail(
								modelAction.AdministratorModelActionTypes.UPDATE_ALL_ADMINISTRATOR_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AdministratorAction>(modelAction.AdministratorModelActionTypes.DELETE_ADMINISTRATOR),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.AdministratorActionOK(
						modelAction.AdministratorModelActionTypes.DELETE_ADMINISTRATOR_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.AdministratorActionFail(
								modelAction.AdministratorModelActionTypes.DELETE_ADMINISTRATOR_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AdministratorAction>(modelAction.AdministratorModelActionTypes.DELETE_ADMINISTRATOR_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.AdministratorActionOK(
						modelAction.AdministratorModelActionTypes.DELETE_ADMINISTRATOR_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.AdministratorActionFail(
								modelAction.AdministratorModelActionTypes.DELETE_ADMINISTRATOR_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AdministratorAction>(modelAction.AdministratorModelActionTypes.DELETE_ALL_ADMINISTRATOR),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.AdministratorActionOK(
						modelAction.AdministratorModelActionTypes.DELETE_ALL_ADMINISTRATOR_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.AdministratorActionFail(
								modelAction.AdministratorModelActionTypes.DELETE_ALL_ADMINISTRATOR_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AdministratorAction>(modelAction.AdministratorModelActionTypes.EXPORT_ADMINISTRATOR),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.AdministratorActionOK(
						modelAction.AdministratorModelActionTypes.EXPORT_ADMINISTRATOR,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AdministratorAction>(modelAction.AdministratorModelActionTypes.EXPORT_ALL_ADMINISTRATOR),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.AdministratorActionOK(
						modelAction.AdministratorModelActionTypes.EXPORT_ALL_ADMINISTRATOR_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.AdministratorActionFail(
								modelAction.AdministratorModelActionTypes.EXPORT_ALL_ADMINISTRATOR_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AdministratorAction>(modelAction.AdministratorModelActionTypes.EXPORT_ADMINISTRATOR_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.AdministratorActionOK(
						modelAction.AdministratorModelActionTypes.EXPORT_ADMINISTRATOR_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.AdministratorActionFail(
								modelAction.AdministratorModelActionTypes.EXPORT_ADMINISTRATOR_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AdministratorAction>(modelAction.AdministratorModelActionTypes.IMPORT_ADMINISTRATORS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.AdministratorActionOK(
						modelAction.AdministratorModelActionTypes.IMPORT_ADMINISTRATORS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.AdministratorActionFail(
								modelAction.AdministratorModelActionTypes.IMPORT_ADMINISTRATORS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AdministratorAction>(modelAction.AdministratorModelActionTypes.FETCH_ADMINISTRATOR_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.AdministratorActionOK(
						modelAction.AdministratorModelActionTypes.FETCH_ADMINISTRATOR_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.AdministratorActionFail(
								modelAction.AdministratorModelActionTypes.FETCH_ADMINISTRATOR_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AdministratorAction>(modelAction.AdministratorModelActionTypes.FETCH_ADMINISTRATOR_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.AdministratorActionOK(
						modelAction.AdministratorModelActionTypes.FETCH_ADMINISTRATOR_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.AdministratorActionFail(
								modelAction.AdministratorModelActionTypes.FETCH_ADMINISTRATOR_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
