...
/**
 * AmendmentDetailCollectionState would store the state of a collection of AmendmentDetail
 */
export interface AmendmentDetailCollectionState extends CollectionState {
 ...
 */
export interface AmendmentDetailModelAudit extends AbstractModelAudit<AmendmentDetailModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * AmendmentDetailModelState would store the state of the model
 */
export interface AmendmentDetailModelState {
	collectionState: {
		[key: string]: AmendmentDetailCollectionState;
	};
	data: {
		[id: string]: AmendmentDetailModel;
	};
	totalCount: number;
	audits: AmendmentDetailModelAudit[];
 ...
 */
export const initialAmendmentDetailCollectionState: AmendmentDetailCollectionState = {
...
/**
 * The initial state of AmendmentDetailModelState
 */
export const initialState: AmendmentDetailModelState = {
	collectionState: {
