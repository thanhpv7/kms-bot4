...
import * as modelAction from './amendment_detail.model.action';
import {AmendmentDetailService} from '../../services/amendmentDetail/amendment_detail.service';
...
/**
 * Effect class used for side effects related to Amendment Detail model.
 */
@Injectable()
export class AmendmentDetailEffect {
	...
	constructor(
		...
		protected readonly service: AmendmentDetailService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AmendmentDetailAction>(modelAction.AmendmentDetailModelActionTypes.COUNT_AMENDMENT_DETAILS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.AmendmentDetailActionOK(
						modelAction.AmendmentDetailModelActionTypes.COUNT_AMENDMENT_DETAILS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.AmendmentDetailActionFail(
								modelAction.AmendmentDetailModelActionTypes.COUNT_AMENDMENT_DETAILS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AmendmentDetailAction>(modelAction.AmendmentDetailModelActionTypes.FETCH_AMENDMENT_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.AmendmentDetailActionOK(
						modelAction.AmendmentDetailModelActionTypes.FETCH_AMENDMENT_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.AmendmentDetailActionFail(
								modelAction.AmendmentDetailModelActionTypes.FETCH_AMENDMENT_DETAIL_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AmendmentDetailAction>(modelAction.AmendmentDetailModelActionTypes.FETCH_ALL_AMENDMENT_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.AmendmentDetailActionOK(
						modelAction.AmendmentDetailModelActionTypes.FETCH_ALL_AMENDMENT_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.AmendmentDetailActionFail(
								modelAction.AmendmentDetailModelActionTypes.FETCH_ALL_AMENDMENT_DETAIL_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AmendmentDetailAction>(modelAction.AmendmentDetailModelActionTypes.FETCH_AMENDMENT_DETAIL_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.AmendmentDetailActionOK(
						modelAction.AmendmentDetailModelActionTypes.FETCH_AMENDMENT_DETAIL_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.AmendmentDetailActionFail(
								modelAction.AmendmentDetailModelActionTypes.FETCH_AMENDMENT_DETAIL_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AmendmentDetailAction>(modelAction.AmendmentDetailModelActionTypes.FETCH_LAST_AMENDMENT_DETAIL_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.AmendmentDetailActionOK(
						modelAction.AmendmentDetailModelActionTypes.FETCH_LAST_AMENDMENT_DETAIL_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.AmendmentDetailActionFail(
								modelAction.AmendmentDetailModelActionTypes.FETCH_LAST_AMENDMENT_DETAIL_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AmendmentDetailAction>(modelAction.AmendmentDetailModelActionTypes.CREATE_AMENDMENT_DETAIL),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as AmendmentDetailModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.AmendmentDetailActionOK(
						modelAction.AmendmentDetailModelActionTypes.CREATE_AMENDMENT_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.AmendmentDetailActionFail(
								modelAction.AmendmentDetailModelActionTypes.CREATE_AMENDMENT_DETAIL_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AmendmentDetailAction>(modelAction.AmendmentDetailModelActionTypes.CREATE_ALL_AMENDMENT_DETAIL),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as AmendmentDetailModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.AmendmentDetailActionOK(
						modelAction.AmendmentDetailModelActionTypes.CREATE_ALL_AMENDMENT_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.AmendmentDetailActionFail(
								modelAction.AmendmentDetailModelActionTypes.CREATE_ALL_AMENDMENT_DETAIL_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AmendmentDetailAction>(modelAction.AmendmentDetailModelActionTypes.UPDATE_AMENDMENT_DETAIL),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as AmendmentDetailModel;
				...
				return this.service.update(new AmendmentDetailModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.AmendmentDetailActionOK(
						modelAction.AmendmentDetailModelActionTypes.UPDATE_AMENDMENT_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.AmendmentDetailActionFail(
								modelAction.AmendmentDetailModelActionTypes.UPDATE_AMENDMENT_DETAIL_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AmendmentDetailAction>(modelAction.AmendmentDetailModelActionTypes.UPDATE_ALL_AMENDMENT_DETAIL),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as AmendmentDetailModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new AmendmentDetailModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.AmendmentDetailActionOK(
						modelAction.AmendmentDetailModelActionTypes.UPDATE_ALL_AMENDMENT_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.AmendmentDetailActionFail(
								modelAction.AmendmentDetailModelActionTypes.UPDATE_ALL_AMENDMENT_DETAIL_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AmendmentDetailAction>(modelAction.AmendmentDetailModelActionTypes.DELETE_AMENDMENT_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.AmendmentDetailActionOK(
						modelAction.AmendmentDetailModelActionTypes.DELETE_AMENDMENT_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.AmendmentDetailActionFail(
								modelAction.AmendmentDetailModelActionTypes.DELETE_AMENDMENT_DETAIL_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AmendmentDetailAction>(modelAction.AmendmentDetailModelActionTypes.DELETE_AMENDMENT_DETAIL_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.AmendmentDetailActionOK(
						modelAction.AmendmentDetailModelActionTypes.DELETE_AMENDMENT_DETAIL_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.AmendmentDetailActionFail(
								modelAction.AmendmentDetailModelActionTypes.DELETE_AMENDMENT_DETAIL_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AmendmentDetailAction>(modelAction.AmendmentDetailModelActionTypes.DELETE_ALL_AMENDMENT_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.AmendmentDetailActionOK(
						modelAction.AmendmentDetailModelActionTypes.DELETE_ALL_AMENDMENT_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.AmendmentDetailActionFail(
								modelAction.AmendmentDetailModelActionTypes.DELETE_ALL_AMENDMENT_DETAIL_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AmendmentDetailAction>(modelAction.AmendmentDetailModelActionTypes.EXPORT_AMENDMENT_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.AmendmentDetailActionOK(
						modelAction.AmendmentDetailModelActionTypes.EXPORT_AMENDMENT_DETAIL,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AmendmentDetailAction>(modelAction.AmendmentDetailModelActionTypes.EXPORT_ALL_AMENDMENT_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.AmendmentDetailActionOK(
						modelAction.AmendmentDetailModelActionTypes.EXPORT_ALL_AMENDMENT_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.AmendmentDetailActionFail(
								modelAction.AmendmentDetailModelActionTypes.EXPORT_ALL_AMENDMENT_DETAIL_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AmendmentDetailAction>(modelAction.AmendmentDetailModelActionTypes.EXPORT_AMENDMENT_DETAIL_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.AmendmentDetailActionOK(
						modelAction.AmendmentDetailModelActionTypes.EXPORT_AMENDMENT_DETAIL_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.AmendmentDetailActionFail(
								modelAction.AmendmentDetailModelActionTypes.EXPORT_AMENDMENT_DETAIL_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AmendmentDetailAction>(modelAction.AmendmentDetailModelActionTypes.IMPORT_AMENDMENT_DETAILS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.AmendmentDetailActionOK(
						modelAction.AmendmentDetailModelActionTypes.IMPORT_AMENDMENT_DETAILS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.AmendmentDetailActionFail(
								modelAction.AmendmentDetailModelActionTypes.IMPORT_AMENDMENT_DETAILS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AmendmentDetailAction>(modelAction.AmendmentDetailModelActionTypes.FETCH_AMENDMENT_DETAIL_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.AmendmentDetailActionOK(
						modelAction.AmendmentDetailModelActionTypes.FETCH_AMENDMENT_DETAIL_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.AmendmentDetailActionFail(
								modelAction.AmendmentDetailModelActionTypes.FETCH_AMENDMENT_DETAIL_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.AmendmentDetailAction>(modelAction.AmendmentDetailModelActionTypes.FETCH_AMENDMENT_DETAIL_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.AmendmentDetailActionOK(
						modelAction.AmendmentDetailModelActionTypes.FETCH_AMENDMENT_DETAIL_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.AmendmentDetailActionFail(
								modelAction.AmendmentDetailModelActionTypes.FETCH_AMENDMENT_DETAIL_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
