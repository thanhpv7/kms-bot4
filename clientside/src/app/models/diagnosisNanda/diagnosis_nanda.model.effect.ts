...
import * as modelAction from './diagnosis_nanda.model.action';
import {DiagnosisNandaService} from '../../services/diagnosisNanda/diagnosis_nanda.service';
...
/**
 * Effect class used for side effects related to Diagnosis Nanda model.
 */
@Injectable()
export class DiagnosisNandaEffect {
	...
	constructor(
		...
		protected readonly service: DiagnosisNandaService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosisNandaAction>(modelAction.DiagnosisNandaModelActionTypes.COUNT_DIAGNOSIS_NANDAS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.DiagnosisNandaActionOK(
						modelAction.DiagnosisNandaModelActionTypes.COUNT_DIAGNOSIS_NANDAS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosisNandaActionFail(
								modelAction.DiagnosisNandaModelActionTypes.COUNT_DIAGNOSIS_NANDAS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosisNandaAction>(modelAction.DiagnosisNandaModelActionTypes.FETCH_DIAGNOSIS_NANDA),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.DiagnosisNandaActionOK(
						modelAction.DiagnosisNandaModelActionTypes.FETCH_DIAGNOSIS_NANDA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosisNandaActionFail(
								modelAction.DiagnosisNandaModelActionTypes.FETCH_DIAGNOSIS_NANDA_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosisNandaAction>(modelAction.DiagnosisNandaModelActionTypes.FETCH_ALL_DIAGNOSIS_NANDA),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.DiagnosisNandaActionOK(
						modelAction.DiagnosisNandaModelActionTypes.FETCH_ALL_DIAGNOSIS_NANDA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosisNandaActionFail(
								modelAction.DiagnosisNandaModelActionTypes.FETCH_ALL_DIAGNOSIS_NANDA_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosisNandaAction>(modelAction.DiagnosisNandaModelActionTypes.FETCH_DIAGNOSIS_NANDA_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.DiagnosisNandaActionOK(
						modelAction.DiagnosisNandaModelActionTypes.FETCH_DIAGNOSIS_NANDA_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosisNandaActionFail(
								modelAction.DiagnosisNandaModelActionTypes.FETCH_DIAGNOSIS_NANDA_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosisNandaAction>(modelAction.DiagnosisNandaModelActionTypes.FETCH_LAST_DIAGNOSIS_NANDA_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.DiagnosisNandaActionOK(
						modelAction.DiagnosisNandaModelActionTypes.FETCH_LAST_DIAGNOSIS_NANDA_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosisNandaActionFail(
								modelAction.DiagnosisNandaModelActionTypes.FETCH_LAST_DIAGNOSIS_NANDA_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosisNandaAction>(modelAction.DiagnosisNandaModelActionTypes.CREATE_DIAGNOSIS_NANDA),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as DiagnosisNandaModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.DiagnosisNandaActionOK(
						modelAction.DiagnosisNandaModelActionTypes.CREATE_DIAGNOSIS_NANDA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosisNandaActionFail(
								modelAction.DiagnosisNandaModelActionTypes.CREATE_DIAGNOSIS_NANDA_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosisNandaAction>(modelAction.DiagnosisNandaModelActionTypes.CREATE_ALL_DIAGNOSIS_NANDA),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as DiagnosisNandaModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.DiagnosisNandaActionOK(
						modelAction.DiagnosisNandaModelActionTypes.CREATE_ALL_DIAGNOSIS_NANDA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosisNandaActionFail(
								modelAction.DiagnosisNandaModelActionTypes.CREATE_ALL_DIAGNOSIS_NANDA_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosisNandaAction>(modelAction.DiagnosisNandaModelActionTypes.UPDATE_DIAGNOSIS_NANDA),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as DiagnosisNandaModel;
				...
				return this.service.update(new DiagnosisNandaModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.DiagnosisNandaActionOK(
						modelAction.DiagnosisNandaModelActionTypes.UPDATE_DIAGNOSIS_NANDA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosisNandaActionFail(
								modelAction.DiagnosisNandaModelActionTypes.UPDATE_DIAGNOSIS_NANDA_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosisNandaAction>(modelAction.DiagnosisNandaModelActionTypes.UPDATE_ALL_DIAGNOSIS_NANDA),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as DiagnosisNandaModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new DiagnosisNandaModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.DiagnosisNandaActionOK(
						modelAction.DiagnosisNandaModelActionTypes.UPDATE_ALL_DIAGNOSIS_NANDA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosisNandaActionFail(
								modelAction.DiagnosisNandaModelActionTypes.UPDATE_ALL_DIAGNOSIS_NANDA_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosisNandaAction>(modelAction.DiagnosisNandaModelActionTypes.DELETE_DIAGNOSIS_NANDA),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.DiagnosisNandaActionOK(
						modelAction.DiagnosisNandaModelActionTypes.DELETE_DIAGNOSIS_NANDA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosisNandaActionFail(
								modelAction.DiagnosisNandaModelActionTypes.DELETE_DIAGNOSIS_NANDA_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosisNandaAction>(modelAction.DiagnosisNandaModelActionTypes.DELETE_DIAGNOSIS_NANDA_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.DiagnosisNandaActionOK(
						modelAction.DiagnosisNandaModelActionTypes.DELETE_DIAGNOSIS_NANDA_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosisNandaActionFail(
								modelAction.DiagnosisNandaModelActionTypes.DELETE_DIAGNOSIS_NANDA_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosisNandaAction>(modelAction.DiagnosisNandaModelActionTypes.DELETE_ALL_DIAGNOSIS_NANDA),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.DiagnosisNandaActionOK(
						modelAction.DiagnosisNandaModelActionTypes.DELETE_ALL_DIAGNOSIS_NANDA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosisNandaActionFail(
								modelAction.DiagnosisNandaModelActionTypes.DELETE_ALL_DIAGNOSIS_NANDA_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosisNandaAction>(modelAction.DiagnosisNandaModelActionTypes.EXPORT_DIAGNOSIS_NANDA),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.DiagnosisNandaActionOK(
						modelAction.DiagnosisNandaModelActionTypes.EXPORT_DIAGNOSIS_NANDA,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosisNandaAction>(modelAction.DiagnosisNandaModelActionTypes.EXPORT_ALL_DIAGNOSIS_NANDA),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.DiagnosisNandaActionOK(
						modelAction.DiagnosisNandaModelActionTypes.EXPORT_ALL_DIAGNOSIS_NANDA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosisNandaActionFail(
								modelAction.DiagnosisNandaModelActionTypes.EXPORT_ALL_DIAGNOSIS_NANDA_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosisNandaAction>(modelAction.DiagnosisNandaModelActionTypes.EXPORT_DIAGNOSIS_NANDA_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.DiagnosisNandaActionOK(
						modelAction.DiagnosisNandaModelActionTypes.EXPORT_DIAGNOSIS_NANDA_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosisNandaActionFail(
								modelAction.DiagnosisNandaModelActionTypes.EXPORT_DIAGNOSIS_NANDA_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosisNandaAction>(modelAction.DiagnosisNandaModelActionTypes.IMPORT_DIAGNOSIS_NANDAS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.DiagnosisNandaActionOK(
						modelAction.DiagnosisNandaModelActionTypes.IMPORT_DIAGNOSIS_NANDAS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosisNandaActionFail(
								modelAction.DiagnosisNandaModelActionTypes.IMPORT_DIAGNOSIS_NANDAS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosisNandaAction>(modelAction.DiagnosisNandaModelActionTypes.FETCH_DIAGNOSIS_NANDA_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.DiagnosisNandaActionOK(
						modelAction.DiagnosisNandaModelActionTypes.FETCH_DIAGNOSIS_NANDA_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosisNandaActionFail(
								modelAction.DiagnosisNandaModelActionTypes.FETCH_DIAGNOSIS_NANDA_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosisNandaAction>(modelAction.DiagnosisNandaModelActionTypes.FETCH_DIAGNOSIS_NANDA_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.DiagnosisNandaActionOK(
						modelAction.DiagnosisNandaModelActionTypes.FETCH_DIAGNOSIS_NANDA_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosisNandaActionFail(
								modelAction.DiagnosisNandaModelActionTypes.FETCH_DIAGNOSIS_NANDA_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
