...
/**
 * DiagnosisNandaCollectionState would store the state of a collection of DiagnosisNanda
 */
export interface DiagnosisNandaCollectionState extends CollectionState {
 ...
 */
export interface DiagnosisNandaModelAudit extends AbstractModelAudit<DiagnosisNandaModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * DiagnosisNandaModelState would store the state of the model
 */
export interface DiagnosisNandaModelState {
	collectionState: {
		[key: string]: DiagnosisNandaCollectionState;
	};
	data: {
		[id: string]: DiagnosisNandaModel;
	};
	totalCount: number;
	audits: DiagnosisNandaModelAudit[];
 ...
 */
export const initialDiagnosisNandaCollectionState: DiagnosisNandaCollectionState = {
...
/**
 * The initial state of DiagnosisNandaModelState
 */
export const initialState: DiagnosisNandaModelState = {
	collectionState: {
