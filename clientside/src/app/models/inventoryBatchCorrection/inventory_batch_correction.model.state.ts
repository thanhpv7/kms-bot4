...
/**
 * InventoryBatchCorrectionCollectionState would store the state of a collection of InventoryBatchCorrection
 */
export interface InventoryBatchCorrectionCollectionState extends CollectionState {
 ...
 */
export interface InventoryBatchCorrectionModelAudit extends AbstractModelAudit<InventoryBatchCorrectionModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * InventoryBatchCorrectionModelState would store the state of the model
 */
export interface InventoryBatchCorrectionModelState {
	collectionState: {
		[key: string]: InventoryBatchCorrectionCollectionState;
	};
	data: {
		[id: string]: InventoryBatchCorrectionModel;
	};
	totalCount: number;
	audits: InventoryBatchCorrectionModelAudit[];
 ...
 */
export const initialInventoryBatchCorrectionCollectionState: InventoryBatchCorrectionCollectionState = {
...
/**
 * The initial state of InventoryBatchCorrectionModelState
 */
export const initialState: InventoryBatchCorrectionModelState = {
	collectionState: {
