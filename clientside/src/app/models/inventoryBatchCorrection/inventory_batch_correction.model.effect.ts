...
import * as modelAction from './inventory_batch_correction.model.action';
import {InventoryBatchCorrectionService} from '../../services/inventoryBatchCorrection/inventory_batch_correction.service';
...
/**
 * Effect class used for side effects related to Inventory Batch Correction model.
 */
@Injectable()
export class InventoryBatchCorrectionEffect {
	...
	constructor(
		...
		protected readonly service: InventoryBatchCorrectionService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryBatchCorrectionAction>(modelAction.InventoryBatchCorrectionModelActionTypes.COUNT_INVENTORY_BATCH_CORRECTIONS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.InventoryBatchCorrectionActionOK(
						modelAction.InventoryBatchCorrectionModelActionTypes.COUNT_INVENTORY_BATCH_CORRECTIONS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryBatchCorrectionActionFail(
								modelAction.InventoryBatchCorrectionModelActionTypes.COUNT_INVENTORY_BATCH_CORRECTIONS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryBatchCorrectionAction>(modelAction.InventoryBatchCorrectionModelActionTypes.FETCH_INVENTORY_BATCH_CORRECTION),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InventoryBatchCorrectionActionOK(
						modelAction.InventoryBatchCorrectionModelActionTypes.FETCH_INVENTORY_BATCH_CORRECTION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryBatchCorrectionActionFail(
								modelAction.InventoryBatchCorrectionModelActionTypes.FETCH_INVENTORY_BATCH_CORRECTION_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryBatchCorrectionAction>(modelAction.InventoryBatchCorrectionModelActionTypes.FETCH_ALL_INVENTORY_BATCH_CORRECTION),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.InventoryBatchCorrectionActionOK(
						modelAction.InventoryBatchCorrectionModelActionTypes.FETCH_ALL_INVENTORY_BATCH_CORRECTION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryBatchCorrectionActionFail(
								modelAction.InventoryBatchCorrectionModelActionTypes.FETCH_ALL_INVENTORY_BATCH_CORRECTION_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryBatchCorrectionAction>(modelAction.InventoryBatchCorrectionModelActionTypes.FETCH_INVENTORY_BATCH_CORRECTION_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.InventoryBatchCorrectionActionOK(
						modelAction.InventoryBatchCorrectionModelActionTypes.FETCH_INVENTORY_BATCH_CORRECTION_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryBatchCorrectionActionFail(
								modelAction.InventoryBatchCorrectionModelActionTypes.FETCH_INVENTORY_BATCH_CORRECTION_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryBatchCorrectionAction>(modelAction.InventoryBatchCorrectionModelActionTypes.FETCH_LAST_INVENTORY_BATCH_CORRECTION_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.InventoryBatchCorrectionActionOK(
						modelAction.InventoryBatchCorrectionModelActionTypes.FETCH_LAST_INVENTORY_BATCH_CORRECTION_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryBatchCorrectionActionFail(
								modelAction.InventoryBatchCorrectionModelActionTypes.FETCH_LAST_INVENTORY_BATCH_CORRECTION_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryBatchCorrectionAction>(modelAction.InventoryBatchCorrectionModelActionTypes.CREATE_INVENTORY_BATCH_CORRECTION),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as InventoryBatchCorrectionModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InventoryBatchCorrectionActionOK(
						modelAction.InventoryBatchCorrectionModelActionTypes.CREATE_INVENTORY_BATCH_CORRECTION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryBatchCorrectionActionFail(
								modelAction.InventoryBatchCorrectionModelActionTypes.CREATE_INVENTORY_BATCH_CORRECTION_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryBatchCorrectionAction>(modelAction.InventoryBatchCorrectionModelActionTypes.CREATE_ALL_INVENTORY_BATCH_CORRECTION),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as InventoryBatchCorrectionModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InventoryBatchCorrectionActionOK(
						modelAction.InventoryBatchCorrectionModelActionTypes.CREATE_ALL_INVENTORY_BATCH_CORRECTION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryBatchCorrectionActionFail(
								modelAction.InventoryBatchCorrectionModelActionTypes.CREATE_ALL_INVENTORY_BATCH_CORRECTION_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryBatchCorrectionAction>(modelAction.InventoryBatchCorrectionModelActionTypes.UPDATE_INVENTORY_BATCH_CORRECTION),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as InventoryBatchCorrectionModel;
				...
				return this.service.update(new InventoryBatchCorrectionModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.InventoryBatchCorrectionActionOK(
						modelAction.InventoryBatchCorrectionModelActionTypes.UPDATE_INVENTORY_BATCH_CORRECTION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryBatchCorrectionActionFail(
								modelAction.InventoryBatchCorrectionModelActionTypes.UPDATE_INVENTORY_BATCH_CORRECTION_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryBatchCorrectionAction>(modelAction.InventoryBatchCorrectionModelActionTypes.UPDATE_ALL_INVENTORY_BATCH_CORRECTION),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as InventoryBatchCorrectionModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new InventoryBatchCorrectionModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InventoryBatchCorrectionActionOK(
						modelAction.InventoryBatchCorrectionModelActionTypes.UPDATE_ALL_INVENTORY_BATCH_CORRECTION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryBatchCorrectionActionFail(
								modelAction.InventoryBatchCorrectionModelActionTypes.UPDATE_ALL_INVENTORY_BATCH_CORRECTION_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryBatchCorrectionAction>(modelAction.InventoryBatchCorrectionModelActionTypes.DELETE_INVENTORY_BATCH_CORRECTION),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.InventoryBatchCorrectionActionOK(
						modelAction.InventoryBatchCorrectionModelActionTypes.DELETE_INVENTORY_BATCH_CORRECTION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryBatchCorrectionActionFail(
								modelAction.InventoryBatchCorrectionModelActionTypes.DELETE_INVENTORY_BATCH_CORRECTION_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryBatchCorrectionAction>(modelAction.InventoryBatchCorrectionModelActionTypes.DELETE_INVENTORY_BATCH_CORRECTION_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.InventoryBatchCorrectionActionOK(
						modelAction.InventoryBatchCorrectionModelActionTypes.DELETE_INVENTORY_BATCH_CORRECTION_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryBatchCorrectionActionFail(
								modelAction.InventoryBatchCorrectionModelActionTypes.DELETE_INVENTORY_BATCH_CORRECTION_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryBatchCorrectionAction>(modelAction.InventoryBatchCorrectionModelActionTypes.DELETE_ALL_INVENTORY_BATCH_CORRECTION),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.InventoryBatchCorrectionActionOK(
						modelAction.InventoryBatchCorrectionModelActionTypes.DELETE_ALL_INVENTORY_BATCH_CORRECTION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryBatchCorrectionActionFail(
								modelAction.InventoryBatchCorrectionModelActionTypes.DELETE_ALL_INVENTORY_BATCH_CORRECTION_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryBatchCorrectionAction>(modelAction.InventoryBatchCorrectionModelActionTypes.EXPORT_INVENTORY_BATCH_CORRECTION),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.InventoryBatchCorrectionActionOK(
						modelAction.InventoryBatchCorrectionModelActionTypes.EXPORT_INVENTORY_BATCH_CORRECTION,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryBatchCorrectionAction>(modelAction.InventoryBatchCorrectionModelActionTypes.EXPORT_ALL_INVENTORY_BATCH_CORRECTION),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.InventoryBatchCorrectionActionOK(
						modelAction.InventoryBatchCorrectionModelActionTypes.EXPORT_ALL_INVENTORY_BATCH_CORRECTION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryBatchCorrectionActionFail(
								modelAction.InventoryBatchCorrectionModelActionTypes.EXPORT_ALL_INVENTORY_BATCH_CORRECTION_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryBatchCorrectionAction>(modelAction.InventoryBatchCorrectionModelActionTypes.EXPORT_INVENTORY_BATCH_CORRECTION_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.InventoryBatchCorrectionActionOK(
						modelAction.InventoryBatchCorrectionModelActionTypes.EXPORT_INVENTORY_BATCH_CORRECTION_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryBatchCorrectionActionFail(
								modelAction.InventoryBatchCorrectionModelActionTypes.EXPORT_INVENTORY_BATCH_CORRECTION_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryBatchCorrectionAction>(modelAction.InventoryBatchCorrectionModelActionTypes.IMPORT_INVENTORY_BATCH_CORRECTIONS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.InventoryBatchCorrectionActionOK(
						modelAction.InventoryBatchCorrectionModelActionTypes.IMPORT_INVENTORY_BATCH_CORRECTIONS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryBatchCorrectionActionFail(
								modelAction.InventoryBatchCorrectionModelActionTypes.IMPORT_INVENTORY_BATCH_CORRECTIONS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryBatchCorrectionAction>(modelAction.InventoryBatchCorrectionModelActionTypes.FETCH_INVENTORY_BATCH_CORRECTION_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.InventoryBatchCorrectionActionOK(
						modelAction.InventoryBatchCorrectionModelActionTypes.FETCH_INVENTORY_BATCH_CORRECTION_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.InventoryBatchCorrectionActionFail(
								modelAction.InventoryBatchCorrectionModelActionTypes.FETCH_INVENTORY_BATCH_CORRECTION_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryBatchCorrectionAction>(modelAction.InventoryBatchCorrectionModelActionTypes.FETCH_INVENTORY_BATCH_CORRECTION_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.InventoryBatchCorrectionActionOK(
						modelAction.InventoryBatchCorrectionModelActionTypes.FETCH_INVENTORY_BATCH_CORRECTION_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.InventoryBatchCorrectionActionFail(
								modelAction.InventoryBatchCorrectionModelActionTypes.FETCH_INVENTORY_BATCH_CORRECTION_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
