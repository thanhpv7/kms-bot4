...
import * as modelAction from './bpjs_sep_inacbg_integration.model.action';
import {BpjsSEPINACBGIntegrationService} from '../../services/bpjsSEPINACBGIntegration/bpjs_sep_inacbg_integration.service';
...
/**
 * Effect class used for side effects related to BPJS SEP INACBG Integration model.
 */
@Injectable()
export class BpjsSEPINACBGIntegrationEffect {
	...
	constructor(
		...
		protected readonly service: BpjsSEPINACBGIntegrationService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPINACBGIntegrationAction>(modelAction.BpjsSEPINACBGIntegrationModelActionTypes.COUNT_BPJS_SEP_INACBG_INTEGRATIONS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPINACBGIntegrationActionOK(
						modelAction.BpjsSEPINACBGIntegrationModelActionTypes.COUNT_BPJS_SEP_INACBG_INTEGRATIONS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPINACBGIntegrationActionFail(
								modelAction.BpjsSEPINACBGIntegrationModelActionTypes.COUNT_BPJS_SEP_INACBG_INTEGRATIONS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPINACBGIntegrationAction>(modelAction.BpjsSEPINACBGIntegrationModelActionTypes.FETCH_BPJS_SEP_INACBG_INTEGRATION),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPINACBGIntegrationActionOK(
						modelAction.BpjsSEPINACBGIntegrationModelActionTypes.FETCH_BPJS_SEP_INACBG_INTEGRATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPINACBGIntegrationActionFail(
								modelAction.BpjsSEPINACBGIntegrationModelActionTypes.FETCH_BPJS_SEP_INACBG_INTEGRATION_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPINACBGIntegrationAction>(modelAction.BpjsSEPINACBGIntegrationModelActionTypes.FETCH_ALL_BPJS_SEP_INACBG_INTEGRATION),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPINACBGIntegrationActionOK(
						modelAction.BpjsSEPINACBGIntegrationModelActionTypes.FETCH_ALL_BPJS_SEP_INACBG_INTEGRATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPINACBGIntegrationActionFail(
								modelAction.BpjsSEPINACBGIntegrationModelActionTypes.FETCH_ALL_BPJS_SEP_INACBG_INTEGRATION_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPINACBGIntegrationAction>(modelAction.BpjsSEPINACBGIntegrationModelActionTypes.FETCH_BPJS_SEP_INACBG_INTEGRATION_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPINACBGIntegrationActionOK(
						modelAction.BpjsSEPINACBGIntegrationModelActionTypes.FETCH_BPJS_SEP_INACBG_INTEGRATION_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPINACBGIntegrationActionFail(
								modelAction.BpjsSEPINACBGIntegrationModelActionTypes.FETCH_BPJS_SEP_INACBG_INTEGRATION_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPINACBGIntegrationAction>(modelAction.BpjsSEPINACBGIntegrationModelActionTypes.FETCH_LAST_BPJS_SEP_INACBG_INTEGRATION_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPINACBGIntegrationActionOK(
						modelAction.BpjsSEPINACBGIntegrationModelActionTypes.FETCH_LAST_BPJS_SEP_INACBG_INTEGRATION_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPINACBGIntegrationActionFail(
								modelAction.BpjsSEPINACBGIntegrationModelActionTypes.FETCH_LAST_BPJS_SEP_INACBG_INTEGRATION_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPINACBGIntegrationAction>(modelAction.BpjsSEPINACBGIntegrationModelActionTypes.CREATE_BPJS_SEP_INACBG_INTEGRATION),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsSEPINACBGIntegrationModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPINACBGIntegrationActionOK(
						modelAction.BpjsSEPINACBGIntegrationModelActionTypes.CREATE_BPJS_SEP_INACBG_INTEGRATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPINACBGIntegrationActionFail(
								modelAction.BpjsSEPINACBGIntegrationModelActionTypes.CREATE_BPJS_SEP_INACBG_INTEGRATION_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPINACBGIntegrationAction>(modelAction.BpjsSEPINACBGIntegrationModelActionTypes.CREATE_ALL_BPJS_SEP_INACBG_INTEGRATION),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsSEPINACBGIntegrationModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPINACBGIntegrationActionOK(
						modelAction.BpjsSEPINACBGIntegrationModelActionTypes.CREATE_ALL_BPJS_SEP_INACBG_INTEGRATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPINACBGIntegrationActionFail(
								modelAction.BpjsSEPINACBGIntegrationModelActionTypes.CREATE_ALL_BPJS_SEP_INACBG_INTEGRATION_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPINACBGIntegrationAction>(modelAction.BpjsSEPINACBGIntegrationModelActionTypes.UPDATE_BPJS_SEP_INACBG_INTEGRATION),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsSEPINACBGIntegrationModel;
				...
				return this.service.update(new BpjsSEPINACBGIntegrationModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPINACBGIntegrationActionOK(
						modelAction.BpjsSEPINACBGIntegrationModelActionTypes.UPDATE_BPJS_SEP_INACBG_INTEGRATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPINACBGIntegrationActionFail(
								modelAction.BpjsSEPINACBGIntegrationModelActionTypes.UPDATE_BPJS_SEP_INACBG_INTEGRATION_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPINACBGIntegrationAction>(modelAction.BpjsSEPINACBGIntegrationModelActionTypes.UPDATE_ALL_BPJS_SEP_INACBG_INTEGRATION),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsSEPINACBGIntegrationModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsSEPINACBGIntegrationModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPINACBGIntegrationActionOK(
						modelAction.BpjsSEPINACBGIntegrationModelActionTypes.UPDATE_ALL_BPJS_SEP_INACBG_INTEGRATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPINACBGIntegrationActionFail(
								modelAction.BpjsSEPINACBGIntegrationModelActionTypes.UPDATE_ALL_BPJS_SEP_INACBG_INTEGRATION_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPINACBGIntegrationAction>(modelAction.BpjsSEPINACBGIntegrationModelActionTypes.DELETE_BPJS_SEP_INACBG_INTEGRATION),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPINACBGIntegrationActionOK(
						modelAction.BpjsSEPINACBGIntegrationModelActionTypes.DELETE_BPJS_SEP_INACBG_INTEGRATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPINACBGIntegrationActionFail(
								modelAction.BpjsSEPINACBGIntegrationModelActionTypes.DELETE_BPJS_SEP_INACBG_INTEGRATION_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPINACBGIntegrationAction>(modelAction.BpjsSEPINACBGIntegrationModelActionTypes.DELETE_BPJS_SEP_INACBG_INTEGRATION_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPINACBGIntegrationActionOK(
						modelAction.BpjsSEPINACBGIntegrationModelActionTypes.DELETE_BPJS_SEP_INACBG_INTEGRATION_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPINACBGIntegrationActionFail(
								modelAction.BpjsSEPINACBGIntegrationModelActionTypes.DELETE_BPJS_SEP_INACBG_INTEGRATION_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPINACBGIntegrationAction>(modelAction.BpjsSEPINACBGIntegrationModelActionTypes.DELETE_ALL_BPJS_SEP_INACBG_INTEGRATION),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPINACBGIntegrationActionOK(
						modelAction.BpjsSEPINACBGIntegrationModelActionTypes.DELETE_ALL_BPJS_SEP_INACBG_INTEGRATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPINACBGIntegrationActionFail(
								modelAction.BpjsSEPINACBGIntegrationModelActionTypes.DELETE_ALL_BPJS_SEP_INACBG_INTEGRATION_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPINACBGIntegrationAction>(modelAction.BpjsSEPINACBGIntegrationModelActionTypes.EXPORT_BPJS_SEP_INACBG_INTEGRATION),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPINACBGIntegrationActionOK(
						modelAction.BpjsSEPINACBGIntegrationModelActionTypes.EXPORT_BPJS_SEP_INACBG_INTEGRATION,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPINACBGIntegrationAction>(modelAction.BpjsSEPINACBGIntegrationModelActionTypes.EXPORT_ALL_BPJS_SEP_INACBG_INTEGRATION),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPINACBGIntegrationActionOK(
						modelAction.BpjsSEPINACBGIntegrationModelActionTypes.EXPORT_ALL_BPJS_SEP_INACBG_INTEGRATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPINACBGIntegrationActionFail(
								modelAction.BpjsSEPINACBGIntegrationModelActionTypes.EXPORT_ALL_BPJS_SEP_INACBG_INTEGRATION_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPINACBGIntegrationAction>(modelAction.BpjsSEPINACBGIntegrationModelActionTypes.EXPORT_BPJS_SEP_INACBG_INTEGRATION_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPINACBGIntegrationActionOK(
						modelAction.BpjsSEPINACBGIntegrationModelActionTypes.EXPORT_BPJS_SEP_INACBG_INTEGRATION_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPINACBGIntegrationActionFail(
								modelAction.BpjsSEPINACBGIntegrationModelActionTypes.EXPORT_BPJS_SEP_INACBG_INTEGRATION_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPINACBGIntegrationAction>(modelAction.BpjsSEPINACBGIntegrationModelActionTypes.IMPORT_BPJS_SEP_INACBG_INTEGRATIONS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPINACBGIntegrationActionOK(
						modelAction.BpjsSEPINACBGIntegrationModelActionTypes.IMPORT_BPJS_SEP_INACBG_INTEGRATIONS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPINACBGIntegrationActionFail(
								modelAction.BpjsSEPINACBGIntegrationModelActionTypes.IMPORT_BPJS_SEP_INACBG_INTEGRATIONS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPINACBGIntegrationAction>(modelAction.BpjsSEPINACBGIntegrationModelActionTypes.FETCH_BPJS_SEP_INACBG_INTEGRATION_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsSEPINACBGIntegrationActionOK(
						modelAction.BpjsSEPINACBGIntegrationModelActionTypes.FETCH_BPJS_SEP_INACBG_INTEGRATION_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPINACBGIntegrationActionFail(
								modelAction.BpjsSEPINACBGIntegrationModelActionTypes.FETCH_BPJS_SEP_INACBG_INTEGRATION_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPINACBGIntegrationAction>(modelAction.BpjsSEPINACBGIntegrationModelActionTypes.FETCH_BPJS_SEP_INACBG_INTEGRATION_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsSEPINACBGIntegrationActionOK(
						modelAction.BpjsSEPINACBGIntegrationModelActionTypes.FETCH_BPJS_SEP_INACBG_INTEGRATION_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPINACBGIntegrationActionFail(
								modelAction.BpjsSEPINACBGIntegrationModelActionTypes.FETCH_BPJS_SEP_INACBG_INTEGRATION_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
