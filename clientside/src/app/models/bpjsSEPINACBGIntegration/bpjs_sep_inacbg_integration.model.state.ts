...
/**
 * BpjsSEPINACBGIntegrationCollectionState would store the state of a collection of BpjsSEPINACBGIntegration
 */
export interface BpjsSEPINACBGIntegrationCollectionState extends CollectionState {
 ...
 */
export interface BpjsSEPINACBGIntegrationModelAudit extends AbstractModelAudit<BpjsSEPINACBGIntegrationModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsSEPINACBGIntegrationModelState would store the state of the model
 */
export interface BpjsSEPINACBGIntegrationModelState {
	collectionState: {
		[key: string]: BpjsSEPINACBGIntegrationCollectionState;
	};
	data: {
		[id: string]: BpjsSEPINACBGIntegrationModel;
	};
	totalCount: number;
	audits: BpjsSEPINACBGIntegrationModelAudit[];
 ...
 */
export const initialBpjsSEPINACBGIntegrationCollectionState: BpjsSEPINACBGIntegrationCollectionState = {
...
/**
 * The initial state of BpjsSEPINACBGIntegrationModelState
 */
export const initialState: BpjsSEPINACBGIntegrationModelState = {
	collectionState: {
