...
import {initialBpjsSEPINACBGIntegrationCollectionState} from './bpjs_sep_inacbg_integration.model.state';
...
export function modelReducer(currentState: ModelState, action: Action): ModelState {
	...
	const className = (action as modelAction.BaseBpjsSEPINACBGIntegrationAction).className;
	...
	return produce(currentState, draft => {
		...
		switch (action.type) {
			case modelAction.BpjsSEPINACBGIntegrationModelActionTypes.CREATE_BPJS_SEP_INACBG_INTEGRATION_OK:
				const createdModel = (action as modelAction.BpjsSEPINACBGIntegrationActionOK ).stateConfig.targetModel;
				...
				BpjsSEPINACBGIntegrationModel.deepParse(createdModel).forEach(model => {
				...
				break;
			case modelAction.BpjsSEPINACBGIntegrationModelActionTypes.CREATE_BPJS_SEP_INACBG_INTEGRATION_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.BpjsSEPINACBGIntegrationModelActionTypes.CREATE_ALL_BPJS_SEP_INACBG_INTEGRATION_OK:
				const createdModels = (action as modelAction.BpjsSEPINACBGIntegrationActionOK).stateConfig.targetModels;
				const collectionIdAfterCreateAll = (action as modelAction.BpjsSEPINACBGIntegrationActionOK).stateConfig.collectionId;
				...
				createdModels.forEach((m) => {
					BpjsSEPINACBGIntegrationModel.deepParse(m).forEach(model => {
						draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
						(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
					});
				});
				...
				break;
			case modelAction.BpjsSEPINACBGIntegrationModelActionTypes.CREATE_ALL_BPJS_SEP_INACBG_INTEGRATION_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.BpjsSEPINACBGIntegrationModelActionTypes.DELETE_BPJS_SEP_INACBG_INTEGRATION_OK:
				const deletedModelId = (action as modelAction.BpjsSEPINACBGIntegrationActionOK).stateConfig.targetModelId;
				const collectionIdAfterDelete = (action as modelAction.BpjsSEPINACBGIntegrationActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.BpjsSEPINACBGIntegrationModelActionTypes.DELETE_ALL_BPJS_SEP_INACBG_INTEGRATION_OK:
				const deletedModelIds = (action as modelAction.BpjsSEPINACBGIntegrationActionOK).stateConfig.targetModelIds;
				const collectionIdAfterDeleteAll = (action as modelAction.BpjsSEPINACBGIntegrationActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.BpjsSEPINACBGIntegrationModelActionTypes.DELETE_BPJS_SEP_INACBG_INTEGRATION_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.BpjsSEPINACBGIntegrationModelActionTypes.UPDATE_BPJS_SEP_INACBG_INTEGRATION_OK:
				const updatedModel = (action as modelAction.BpjsSEPINACBGIntegrationActionOK).stateConfig.targetModel;
				...
				BpjsSEPINACBGIntegrationModel.deepParse(updatedModel).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.BpjsSEPINACBGIntegrationModelActionTypes.UPDATE_BPJS_SEP_INACBG_INTEGRATION_FAIL:
				// TODO: Add handling of failure
				break;

			case modelAction.BpjsSEPINACBGIntegrationModelActionTypes.UPDATE_ALL_BPJS_SEP_INACBG_INTEGRATION_OK:
				const updatedModels = (action as modelAction.BpjsSEPINACBGIntegrationActionOK).stateConfig.targetModels;
				const collectionIdAfterUpdateAll = (action as modelAction.BpjsSEPINACBGIntegrationActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.BpjsSEPINACBGIntegrationModelActionTypes.UPDATE_ALL_BPJS_SEP_INACBG_INTEGRATION_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.BpjsSEPINACBGIntegrationModelActionTypes.FETCH_BPJS_SEP_INACBG_INTEGRATION_OK:
				let fetchedModel = (action as modelAction.BpjsSEPINACBGIntegrationActionOK).stateConfig.targetModel;
				...
				BpjsSEPINACBGIntegrationModel.deepParse(fetchedModel).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.BpjsSEPINACBGIntegrationModelActionTypes.FETCH_ALL_BPJS_SEP_INACBG_INTEGRATION_OK:
				const totalCountAfterFetchAll = (action as modelAction.BpjsSEPINACBGIntegrationActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchAll = (action as modelAction.BpjsSEPINACBGIntegrationActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchAll = (action as modelAction.BpjsSEPINACBGIntegrationActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchAll = (action as modelAction.BpjsSEPINACBGIntegrationActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchAll.map(model => BpjsSEPINACBGIntegrationModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.BpjsSEPINACBGIntegrationModelActionTypes.FETCH_BPJS_SEP_INACBG_INTEGRATION_AUDIT_OK:
				const audits = (action as modelAction.BpjsSEPINACBGIntegrationActionOK).audits;
				...
				break;
			case modelAction.BpjsSEPINACBGIntegrationModelActionTypes.FETCH_BPJS_SEP_INACBG_INTEGRATION_AUDITS_BY_ENTITY_ID_OK:
				const auditsByEntityId = (action as modelAction.BpjsSEPINACBGIntegrationActionOK).audits;
				...
				break;
			case modelAction.BpjsSEPINACBGIntegrationModelActionTypes.FETCH_BPJS_SEP_INACBG_INTEGRATION_WITH_QUERY_OK:
				const totalCountAfterFetchWithQuery = (action as modelAction.BpjsSEPINACBGIntegrationActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchWithQuery = (action as modelAction.BpjsSEPINACBGIntegrationActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchWithQuery = (action as modelAction.BpjsSEPINACBGIntegrationActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchWithQuery = (action as modelAction.BpjsSEPINACBGIntegrationActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchWithQuery.map(model => BpjsSEPINACBGIntegrationModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.BpjsSEPINACBGIntegrationModelActionTypes.FETCH_LAST_BPJS_SEP_INACBG_INTEGRATION_WITH_QUERY_OK:
				const totalCountAfterFetchLastWithQuery = (action as modelAction.BpjsSEPINACBGIntegrationActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchLastWithQuery = (action as modelAction.BpjsSEPINACBGIntegrationActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchLastWithQuery = (action as modelAction.BpjsSEPINACBGIntegrationActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchLastWithQuery = (action as modelAction.BpjsSEPINACBGIntegrationActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchLastWithQuery.map(model => BpjsSEPINACBGIntegrationModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.BpjsSEPINACBGIntegrationModelActionTypes.COUNT_BPJS_SEP_INACBG_INTEGRATIONS_OK:
				const totalCountAfterCount = (action as modelAction.BpjsSEPINACBGIntegrationActionOK).stateConfig.totalCount;
				...
				break;
			case modelAction.BpjsSEPINACBGIntegrationModelActionTypes.INITIALISE_BPJS_SEP_INACBG_INTEGRATION_COLLECTION_STATE:
				const collectionIdToInitialise =  (action as modelAction.BpjsSEPINACBGIntegrationActionOK).stateConfig.collectionId;
				const queryParamsToInitialise = (action as modelAction.BpjsSEPINACBGIntegrationActionOK).stateConfig.queryParams;
				...
				if (!draft[className].collectionState[collectionIdToInitialise]) {
					draft[className].collectionState[collectionIdToInitialise] = {
						...initialBpjsSEPINACBGIntegrationCollectionState
					};
				}
