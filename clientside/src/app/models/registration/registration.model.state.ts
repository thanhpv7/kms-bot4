...
/**
 * RegistrationCollectionState would store the state of a collection of Registration
 */
export interface RegistrationCollectionState extends CollectionState {
 ...
 */
export interface RegistrationModelAudit extends AbstractModelAudit<RegistrationModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * RegistrationModelState would store the state of the model
 */
export interface RegistrationModelState {
	collectionState: {
		[key: string]: RegistrationCollectionState;
	};
	data: {
		[id: string]: RegistrationModel;
	};
	totalCount: number;
	audits: RegistrationModelAudit[];
 ...
 */
export const initialRegistrationCollectionState: RegistrationCollectionState = {
...
/**
 * The initial state of RegistrationModelState
 */
export const initialState: RegistrationModelState = {
	collectionState: {
