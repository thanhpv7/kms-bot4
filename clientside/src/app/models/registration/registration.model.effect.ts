...
import * as modelAction from './registration.model.action';
...
/**
 * Effect class used for side effects related to Registration model.
 */
@Injectable()
export class RegistrationEffect {
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RegistrationAction>(modelAction.RegistrationModelActionTypes.COUNT_REGISTRATIONS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.RegistrationActionOK(
						modelAction.RegistrationModelActionTypes.COUNT_REGISTRATIONS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RegistrationActionFail(
								modelAction.RegistrationModelActionTypes.COUNT_REGISTRATIONS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RegistrationAction>(modelAction.RegistrationModelActionTypes.FETCH_REGISTRATION),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.RegistrationActionOK(
						modelAction.RegistrationModelActionTypes.FETCH_REGISTRATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RegistrationActionFail(
								modelAction.RegistrationModelActionTypes.FETCH_REGISTRATION_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RegistrationAction>(modelAction.RegistrationModelActionTypes.FETCH_ALL_REGISTRATION),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.RegistrationActionOK(
						modelAction.RegistrationModelActionTypes.FETCH_ALL_REGISTRATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RegistrationActionFail(
								modelAction.RegistrationModelActionTypes.FETCH_ALL_REGISTRATION_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RegistrationAction>(modelAction.RegistrationModelActionTypes.FETCH_REGISTRATION_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.RegistrationActionOK(
						modelAction.RegistrationModelActionTypes.FETCH_REGISTRATION_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RegistrationActionFail(
								modelAction.RegistrationModelActionTypes.FETCH_REGISTRATION_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RegistrationAction>(modelAction.RegistrationModelActionTypes.FETCH_LAST_REGISTRATION_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.RegistrationActionOK(
						modelAction.RegistrationModelActionTypes.FETCH_LAST_REGISTRATION_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RegistrationActionFail(
								modelAction.RegistrationModelActionTypes.FETCH_LAST_REGISTRATION_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RegistrationAction>(modelAction.RegistrationModelActionTypes.CREATE_REGISTRATION),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as RegistrationModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.RegistrationActionOK(
						modelAction.RegistrationModelActionTypes.CREATE_REGISTRATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RegistrationActionFail(
								modelAction.RegistrationModelActionTypes.CREATE_REGISTRATION_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RegistrationAction>(modelAction.RegistrationModelActionTypes.CREATE_ALL_REGISTRATION),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as RegistrationModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.RegistrationActionOK(
						modelAction.RegistrationModelActionTypes.CREATE_ALL_REGISTRATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RegistrationActionFail(
								modelAction.RegistrationModelActionTypes.CREATE_ALL_REGISTRATION_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RegistrationAction>(modelAction.RegistrationModelActionTypes.UPDATE_REGISTRATION),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as RegistrationModel;
				...
				return this.service.update(new RegistrationModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.RegistrationActionOK(
						modelAction.RegistrationModelActionTypes.UPDATE_REGISTRATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RegistrationActionFail(
								modelAction.RegistrationModelActionTypes.UPDATE_REGISTRATION_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RegistrationAction>(modelAction.RegistrationModelActionTypes.UPDATE_ALL_REGISTRATION),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as RegistrationModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new RegistrationModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.RegistrationActionOK(
						modelAction.RegistrationModelActionTypes.UPDATE_ALL_REGISTRATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RegistrationActionFail(
								modelAction.RegistrationModelActionTypes.UPDATE_ALL_REGISTRATION_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RegistrationAction>(modelAction.RegistrationModelActionTypes.DELETE_REGISTRATION),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.RegistrationActionOK(
						modelAction.RegistrationModelActionTypes.DELETE_REGISTRATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RegistrationActionFail(
								modelAction.RegistrationModelActionTypes.DELETE_REGISTRATION_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RegistrationAction>(modelAction.RegistrationModelActionTypes.DELETE_REGISTRATION_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.RegistrationActionOK(
						modelAction.RegistrationModelActionTypes.DELETE_REGISTRATION_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RegistrationActionFail(
								modelAction.RegistrationModelActionTypes.DELETE_REGISTRATION_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RegistrationAction>(modelAction.RegistrationModelActionTypes.DELETE_ALL_REGISTRATION),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.RegistrationActionOK(
						modelAction.RegistrationModelActionTypes.DELETE_ALL_REGISTRATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RegistrationActionFail(
								modelAction.RegistrationModelActionTypes.DELETE_ALL_REGISTRATION_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RegistrationAction>(modelAction.RegistrationModelActionTypes.EXPORT_REGISTRATION),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.RegistrationActionOK(
						modelAction.RegistrationModelActionTypes.EXPORT_REGISTRATION,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RegistrationAction>(modelAction.RegistrationModelActionTypes.EXPORT_ALL_REGISTRATION),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.RegistrationActionOK(
						modelAction.RegistrationModelActionTypes.EXPORT_ALL_REGISTRATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RegistrationActionFail(
								modelAction.RegistrationModelActionTypes.EXPORT_ALL_REGISTRATION_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RegistrationAction>(modelAction.RegistrationModelActionTypes.EXPORT_REGISTRATION_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.RegistrationActionOK(
						modelAction.RegistrationModelActionTypes.EXPORT_REGISTRATION_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RegistrationActionFail(
								modelAction.RegistrationModelActionTypes.EXPORT_REGISTRATION_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RegistrationAction>(modelAction.RegistrationModelActionTypes.IMPORT_REGISTRATIONS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.RegistrationActionOK(
						modelAction.RegistrationModelActionTypes.IMPORT_REGISTRATIONS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RegistrationActionFail(
								modelAction.RegistrationModelActionTypes.IMPORT_REGISTRATIONS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RegistrationAction>(modelAction.RegistrationModelActionTypes.FETCH_REGISTRATION_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.RegistrationActionOK(
						modelAction.RegistrationModelActionTypes.FETCH_REGISTRATION_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.RegistrationActionFail(
								modelAction.RegistrationModelActionTypes.FETCH_REGISTRATION_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RegistrationAction>(modelAction.RegistrationModelActionTypes.FETCH_REGISTRATION_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.RegistrationActionOK(
						modelAction.RegistrationModelActionTypes.FETCH_REGISTRATION_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.RegistrationActionFail(
								modelAction.RegistrationModelActionTypes.FETCH_REGISTRATION_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
