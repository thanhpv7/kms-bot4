...
/**
 * BpjsReferralSpecialistCollectionState would store the state of a collection of BpjsReferralSpecialist
 */
export interface BpjsReferralSpecialistCollectionState extends CollectionState {
 ...
 */
export interface BpjsReferralSpecialistModelAudit extends AbstractModelAudit<BpjsReferralSpecialistModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsReferralSpecialistModelState would store the state of the model
 */
export interface BpjsReferralSpecialistModelState {
	collectionState: {
		[key: string]: BpjsReferralSpecialistCollectionState;
	};
	data: {
		[id: string]: BpjsReferralSpecialistModel;
	};
	totalCount: number;
	audits: BpjsReferralSpecialistModelAudit[];
 ...
 */
export const initialBpjsReferralSpecialistCollectionState: BpjsReferralSpecialistCollectionState = {
...
/**
 * The initial state of BpjsReferralSpecialistModelState
 */
export const initialState: BpjsReferralSpecialistModelState = {
	collectionState: {
