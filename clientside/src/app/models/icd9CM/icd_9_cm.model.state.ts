...
/**
 * Icd9CMCollectionState would store the state of a collection of Icd9CM
 */
export interface Icd9CMCollectionState extends CollectionState {
 ...
 */
export interface Icd9CMModelAudit extends AbstractModelAudit<Icd9CMModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * Icd9CMModelState would store the state of the model
 */
export interface Icd9CMModelState {
	collectionState: {
		[key: string]: Icd9CMCollectionState;
	};
	data: {
		[id: string]: Icd9CMModel;
	};
	totalCount: number;
	audits: Icd9CMModelAudit[];
 ...
 */
export const initialIcd9CMCollectionState: Icd9CMCollectionState = {
...
/**
 * The initial state of Icd9CMModelState
 */
export const initialState: Icd9CMModelState = {
	collectionState: {
