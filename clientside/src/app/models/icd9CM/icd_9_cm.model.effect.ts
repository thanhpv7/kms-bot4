...
import * as modelAction from './icd_9_cm.model.action';
import {Icd9CMService} from '../../services/icd9CM/icd_9_cm.service';
...
/**
 * Effect class used for side effects related to ICD 9 CM model.
 */
@Injectable()
export class Icd9CMEffect {
	...
	constructor(
		...
		protected readonly service: Icd9CMService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.Icd9CMAction>(modelAction.Icd9CMModelActionTypes.COUNT_ICD_9_CMS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.Icd9CMActionOK(
						modelAction.Icd9CMModelActionTypes.COUNT_ICD_9_CMS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.Icd9CMActionFail(
								modelAction.Icd9CMModelActionTypes.COUNT_ICD_9_CMS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.Icd9CMAction>(modelAction.Icd9CMModelActionTypes.FETCH_ICD_9_CM),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.Icd9CMActionOK(
						modelAction.Icd9CMModelActionTypes.FETCH_ICD_9_CM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.Icd9CMActionFail(
								modelAction.Icd9CMModelActionTypes.FETCH_ICD_9_CM_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.Icd9CMAction>(modelAction.Icd9CMModelActionTypes.FETCH_ALL_ICD_9_CM),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.Icd9CMActionOK(
						modelAction.Icd9CMModelActionTypes.FETCH_ALL_ICD_9_CM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.Icd9CMActionFail(
								modelAction.Icd9CMModelActionTypes.FETCH_ALL_ICD_9_CM_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.Icd9CMAction>(modelAction.Icd9CMModelActionTypes.FETCH_ICD_9_CM_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.Icd9CMActionOK(
						modelAction.Icd9CMModelActionTypes.FETCH_ICD_9_CM_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.Icd9CMActionFail(
								modelAction.Icd9CMModelActionTypes.FETCH_ICD_9_CM_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.Icd9CMAction>(modelAction.Icd9CMModelActionTypes.FETCH_LAST_ICD_9_CM_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.Icd9CMActionOK(
						modelAction.Icd9CMModelActionTypes.FETCH_LAST_ICD_9_CM_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.Icd9CMActionFail(
								modelAction.Icd9CMModelActionTypes.FETCH_LAST_ICD_9_CM_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.Icd9CMAction>(modelAction.Icd9CMModelActionTypes.CREATE_ICD_9_CM),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as Icd9CMModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.Icd9CMActionOK(
						modelAction.Icd9CMModelActionTypes.CREATE_ICD_9_CM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.Icd9CMActionFail(
								modelAction.Icd9CMModelActionTypes.CREATE_ICD_9_CM_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.Icd9CMAction>(modelAction.Icd9CMModelActionTypes.CREATE_ALL_ICD_9_CM),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as Icd9CMModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.Icd9CMActionOK(
						modelAction.Icd9CMModelActionTypes.CREATE_ALL_ICD_9_CM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.Icd9CMActionFail(
								modelAction.Icd9CMModelActionTypes.CREATE_ALL_ICD_9_CM_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.Icd9CMAction>(modelAction.Icd9CMModelActionTypes.UPDATE_ICD_9_CM),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as Icd9CMModel;
				...
				return this.service.update(new Icd9CMModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.Icd9CMActionOK(
						modelAction.Icd9CMModelActionTypes.UPDATE_ICD_9_CM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.Icd9CMActionFail(
								modelAction.Icd9CMModelActionTypes.UPDATE_ICD_9_CM_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.Icd9CMAction>(modelAction.Icd9CMModelActionTypes.UPDATE_ALL_ICD_9_CM),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as Icd9CMModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new Icd9CMModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.Icd9CMActionOK(
						modelAction.Icd9CMModelActionTypes.UPDATE_ALL_ICD_9_CM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.Icd9CMActionFail(
								modelAction.Icd9CMModelActionTypes.UPDATE_ALL_ICD_9_CM_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.Icd9CMAction>(modelAction.Icd9CMModelActionTypes.DELETE_ICD_9_CM),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.Icd9CMActionOK(
						modelAction.Icd9CMModelActionTypes.DELETE_ICD_9_CM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.Icd9CMActionFail(
								modelAction.Icd9CMModelActionTypes.DELETE_ICD_9_CM_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.Icd9CMAction>(modelAction.Icd9CMModelActionTypes.DELETE_ICD_9_CM_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.Icd9CMActionOK(
						modelAction.Icd9CMModelActionTypes.DELETE_ICD_9_CM_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.Icd9CMActionFail(
								modelAction.Icd9CMModelActionTypes.DELETE_ICD_9_CM_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.Icd9CMAction>(modelAction.Icd9CMModelActionTypes.DELETE_ALL_ICD_9_CM),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.Icd9CMActionOK(
						modelAction.Icd9CMModelActionTypes.DELETE_ALL_ICD_9_CM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.Icd9CMActionFail(
								modelAction.Icd9CMModelActionTypes.DELETE_ALL_ICD_9_CM_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.Icd9CMAction>(modelAction.Icd9CMModelActionTypes.EXPORT_ICD_9_CM),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.Icd9CMActionOK(
						modelAction.Icd9CMModelActionTypes.EXPORT_ICD_9_CM,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.Icd9CMAction>(modelAction.Icd9CMModelActionTypes.EXPORT_ALL_ICD_9_CM),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.Icd9CMActionOK(
						modelAction.Icd9CMModelActionTypes.EXPORT_ALL_ICD_9_CM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.Icd9CMActionFail(
								modelAction.Icd9CMModelActionTypes.EXPORT_ALL_ICD_9_CM_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.Icd9CMAction>(modelAction.Icd9CMModelActionTypes.EXPORT_ICD_9_CM_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.Icd9CMActionOK(
						modelAction.Icd9CMModelActionTypes.EXPORT_ICD_9_CM_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.Icd9CMActionFail(
								modelAction.Icd9CMModelActionTypes.EXPORT_ICD_9_CM_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.Icd9CMAction>(modelAction.Icd9CMModelActionTypes.IMPORT_ICD_9_CMS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.Icd9CMActionOK(
						modelAction.Icd9CMModelActionTypes.IMPORT_ICD_9_CMS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.Icd9CMActionFail(
								modelAction.Icd9CMModelActionTypes.IMPORT_ICD_9_CMS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.Icd9CMAction>(modelAction.Icd9CMModelActionTypes.FETCH_ICD_9_CM_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.Icd9CMActionOK(
						modelAction.Icd9CMModelActionTypes.FETCH_ICD_9_CM_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.Icd9CMActionFail(
								modelAction.Icd9CMModelActionTypes.FETCH_ICD_9_CM_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.Icd9CMAction>(modelAction.Icd9CMModelActionTypes.FETCH_ICD_9_CM_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.Icd9CMActionOK(
						modelAction.Icd9CMModelActionTypes.FETCH_ICD_9_CM_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.Icd9CMActionFail(
								modelAction.Icd9CMModelActionTypes.FETCH_ICD_9_CM_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
