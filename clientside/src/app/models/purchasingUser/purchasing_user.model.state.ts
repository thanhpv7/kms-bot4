...
/**
 * PurchasingUserCollectionState would store the state of a collection of PurchasingUser
 */
export interface PurchasingUserCollectionState extends CollectionState {
 ...
 */
export interface PurchasingUserModelAudit extends AbstractModelAudit<PurchasingUserModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * PurchasingUserModelState would store the state of the model
 */
export interface PurchasingUserModelState {
	collectionState: {
		[key: string]: PurchasingUserCollectionState;
	};
	data: {
		[id: string]: PurchasingUserModel;
	};
	totalCount: number;
	audits: PurchasingUserModelAudit[];
 ...
 */
export const initialPurchasingUserCollectionState: PurchasingUserCollectionState = {
...
/**
 * The initial state of PurchasingUserModelState
 */
export const initialState: PurchasingUserModelState = {
	collectionState: {
