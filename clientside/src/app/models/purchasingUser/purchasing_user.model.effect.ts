...
import {PurchasingUserService} from '../../services/purchasingUser/purchasing_user.service';
...
/**
 * Effect class used for side effects related to Purchasing User model.
 */
@Injectable()
export class PurchasingUserEffect {
	...
	constructor(
		...
		protected readonly service: PurchasingUserService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchasingUserAction>(modelAction.PurchasingUserModelActionTypes.COUNT_PURCHASING_USERS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.PurchasingUserActionOK(
						modelAction.PurchasingUserModelActionTypes.COUNT_PURCHASING_USERS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchasingUserActionFail(
								modelAction.PurchasingUserModelActionTypes.COUNT_PURCHASING_USERS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchasingUserAction>(modelAction.PurchasingUserModelActionTypes.FETCH_PURCHASING_USER),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PurchasingUserActionOK(
						modelAction.PurchasingUserModelActionTypes.FETCH_PURCHASING_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchasingUserActionFail(
								modelAction.PurchasingUserModelActionTypes.FETCH_PURCHASING_USER_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchasingUserAction>(modelAction.PurchasingUserModelActionTypes.FETCH_ALL_PURCHASING_USER),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.PurchasingUserActionOK(
						modelAction.PurchasingUserModelActionTypes.FETCH_ALL_PURCHASING_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchasingUserActionFail(
								modelAction.PurchasingUserModelActionTypes.FETCH_ALL_PURCHASING_USER_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchasingUserAction>(modelAction.PurchasingUserModelActionTypes.FETCH_PURCHASING_USER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PurchasingUserActionOK(
						modelAction.PurchasingUserModelActionTypes.FETCH_PURCHASING_USER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchasingUserActionFail(
								modelAction.PurchasingUserModelActionTypes.FETCH_PURCHASING_USER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchasingUserAction>(modelAction.PurchasingUserModelActionTypes.FETCH_LAST_PURCHASING_USER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PurchasingUserActionOK(
						modelAction.PurchasingUserModelActionTypes.FETCH_LAST_PURCHASING_USER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchasingUserActionFail(
								modelAction.PurchasingUserModelActionTypes.FETCH_LAST_PURCHASING_USER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchasingUserAction>(modelAction.PurchasingUserModelActionTypes.CREATE_PURCHASING_USER),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as PurchasingUserModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PurchasingUserActionOK(
						modelAction.PurchasingUserModelActionTypes.CREATE_PURCHASING_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchasingUserActionFail(
								modelAction.PurchasingUserModelActionTypes.CREATE_PURCHASING_USER_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchasingUserAction>(modelAction.PurchasingUserModelActionTypes.CREATE_ALL_PURCHASING_USER),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as PurchasingUserModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PurchasingUserActionOK(
						modelAction.PurchasingUserModelActionTypes.CREATE_ALL_PURCHASING_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchasingUserActionFail(
								modelAction.PurchasingUserModelActionTypes.CREATE_ALL_PURCHASING_USER_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchasingUserAction>(modelAction.PurchasingUserModelActionTypes.UPDATE_PURCHASING_USER),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as PurchasingUserModel;
				...
				return this.service.update(new PurchasingUserModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.PurchasingUserActionOK(
						modelAction.PurchasingUserModelActionTypes.UPDATE_PURCHASING_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchasingUserActionFail(
								modelAction.PurchasingUserModelActionTypes.UPDATE_PURCHASING_USER_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchasingUserAction>(modelAction.PurchasingUserModelActionTypes.UPDATE_ALL_PURCHASING_USER),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as PurchasingUserModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new PurchasingUserModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PurchasingUserActionOK(
						modelAction.PurchasingUserModelActionTypes.UPDATE_ALL_PURCHASING_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchasingUserActionFail(
								modelAction.PurchasingUserModelActionTypes.UPDATE_ALL_PURCHASING_USER_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchasingUserAction>(modelAction.PurchasingUserModelActionTypes.DELETE_PURCHASING_USER),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PurchasingUserActionOK(
						modelAction.PurchasingUserModelActionTypes.DELETE_PURCHASING_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchasingUserActionFail(
								modelAction.PurchasingUserModelActionTypes.DELETE_PURCHASING_USER_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchasingUserAction>(modelAction.PurchasingUserModelActionTypes.DELETE_PURCHASING_USER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.PurchasingUserActionOK(
						modelAction.PurchasingUserModelActionTypes.DELETE_PURCHASING_USER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchasingUserActionFail(
								modelAction.PurchasingUserModelActionTypes.DELETE_PURCHASING_USER_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchasingUserAction>(modelAction.PurchasingUserModelActionTypes.DELETE_ALL_PURCHASING_USER),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PurchasingUserActionOK(
						modelAction.PurchasingUserModelActionTypes.DELETE_ALL_PURCHASING_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchasingUserActionFail(
								modelAction.PurchasingUserModelActionTypes.DELETE_ALL_PURCHASING_USER_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchasingUserAction>(modelAction.PurchasingUserModelActionTypes.EXPORT_PURCHASING_USER),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PurchasingUserActionOK(
						modelAction.PurchasingUserModelActionTypes.EXPORT_PURCHASING_USER,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchasingUserAction>(modelAction.PurchasingUserModelActionTypes.EXPORT_ALL_PURCHASING_USER),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PurchasingUserActionOK(
						modelAction.PurchasingUserModelActionTypes.EXPORT_ALL_PURCHASING_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchasingUserActionFail(
								modelAction.PurchasingUserModelActionTypes.EXPORT_ALL_PURCHASING_USER_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchasingUserAction>(modelAction.PurchasingUserModelActionTypes.EXPORT_PURCHASING_USER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PurchasingUserActionOK(
						modelAction.PurchasingUserModelActionTypes.EXPORT_PURCHASING_USER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchasingUserActionFail(
								modelAction.PurchasingUserModelActionTypes.EXPORT_PURCHASING_USER_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchasingUserAction>(modelAction.PurchasingUserModelActionTypes.IMPORT_PURCHASING_USERS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.PurchasingUserActionOK(
						modelAction.PurchasingUserModelActionTypes.IMPORT_PURCHASING_USERS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PurchasingUserActionFail(
								modelAction.PurchasingUserModelActionTypes.IMPORT_PURCHASING_USERS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchasingUserAction>(modelAction.PurchasingUserModelActionTypes.FETCH_PURCHASING_USER_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.PurchasingUserActionOK(
						modelAction.PurchasingUserModelActionTypes.FETCH_PURCHASING_USER_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PurchasingUserActionFail(
								modelAction.PurchasingUserModelActionTypes.FETCH_PURCHASING_USER_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PurchasingUserAction>(modelAction.PurchasingUserModelActionTypes.FETCH_PURCHASING_USER_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.PurchasingUserActionOK(
						modelAction.PurchasingUserModelActionTypes.FETCH_PURCHASING_USER_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PurchasingUserActionFail(
								modelAction.PurchasingUserModelActionTypes.FETCH_PURCHASING_USER_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
