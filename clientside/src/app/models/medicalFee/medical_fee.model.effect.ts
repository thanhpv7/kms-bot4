...
import * as modelAction from './medical_fee.model.action';
import {MedicalFeeService} from '../../services/medicalFee/medical_fee.service';
...
/**
 * Effect class used for side effects related to Medical Fee model.
 */
@Injectable()
export class MedicalFeeEffect {
	...
	constructor(
		...
		protected readonly service: MedicalFeeService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalFeeAction>(modelAction.MedicalFeeModelActionTypes.COUNT_MEDICAL_FEES),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.MedicalFeeActionOK(
						modelAction.MedicalFeeModelActionTypes.COUNT_MEDICAL_FEES_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalFeeActionFail(
								modelAction.MedicalFeeModelActionTypes.COUNT_MEDICAL_FEES_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalFeeAction>(modelAction.MedicalFeeModelActionTypes.FETCH_MEDICAL_FEE),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalFeeActionOK(
						modelAction.MedicalFeeModelActionTypes.FETCH_MEDICAL_FEE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalFeeActionFail(
								modelAction.MedicalFeeModelActionTypes.FETCH_MEDICAL_FEE_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalFeeAction>(modelAction.MedicalFeeModelActionTypes.FETCH_ALL_MEDICAL_FEE),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.MedicalFeeActionOK(
						modelAction.MedicalFeeModelActionTypes.FETCH_ALL_MEDICAL_FEE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalFeeActionFail(
								modelAction.MedicalFeeModelActionTypes.FETCH_ALL_MEDICAL_FEE_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalFeeAction>(modelAction.MedicalFeeModelActionTypes.FETCH_MEDICAL_FEE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalFeeActionOK(
						modelAction.MedicalFeeModelActionTypes.FETCH_MEDICAL_FEE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalFeeActionFail(
								modelAction.MedicalFeeModelActionTypes.FETCH_MEDICAL_FEE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalFeeAction>(modelAction.MedicalFeeModelActionTypes.FETCH_LAST_MEDICAL_FEE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalFeeActionOK(
						modelAction.MedicalFeeModelActionTypes.FETCH_LAST_MEDICAL_FEE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalFeeActionFail(
								modelAction.MedicalFeeModelActionTypes.FETCH_LAST_MEDICAL_FEE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalFeeAction>(modelAction.MedicalFeeModelActionTypes.CREATE_MEDICAL_FEE),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as MedicalFeeModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalFeeActionOK(
						modelAction.MedicalFeeModelActionTypes.CREATE_MEDICAL_FEE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalFeeActionFail(
								modelAction.MedicalFeeModelActionTypes.CREATE_MEDICAL_FEE_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalFeeAction>(modelAction.MedicalFeeModelActionTypes.CREATE_ALL_MEDICAL_FEE),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as MedicalFeeModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalFeeActionOK(
						modelAction.MedicalFeeModelActionTypes.CREATE_ALL_MEDICAL_FEE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalFeeActionFail(
								modelAction.MedicalFeeModelActionTypes.CREATE_ALL_MEDICAL_FEE_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalFeeAction>(modelAction.MedicalFeeModelActionTypes.UPDATE_MEDICAL_FEE),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as MedicalFeeModel;
				...
				return this.service.update(new MedicalFeeModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalFeeActionOK(
						modelAction.MedicalFeeModelActionTypes.UPDATE_MEDICAL_FEE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalFeeActionFail(
								modelAction.MedicalFeeModelActionTypes.UPDATE_MEDICAL_FEE_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalFeeAction>(modelAction.MedicalFeeModelActionTypes.UPDATE_ALL_MEDICAL_FEE),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as MedicalFeeModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new MedicalFeeModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalFeeActionOK(
						modelAction.MedicalFeeModelActionTypes.UPDATE_ALL_MEDICAL_FEE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalFeeActionFail(
								modelAction.MedicalFeeModelActionTypes.UPDATE_ALL_MEDICAL_FEE_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalFeeAction>(modelAction.MedicalFeeModelActionTypes.DELETE_MEDICAL_FEE),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.MedicalFeeActionOK(
						modelAction.MedicalFeeModelActionTypes.DELETE_MEDICAL_FEE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalFeeActionFail(
								modelAction.MedicalFeeModelActionTypes.DELETE_MEDICAL_FEE_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalFeeAction>(modelAction.MedicalFeeModelActionTypes.DELETE_MEDICAL_FEE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.MedicalFeeActionOK(
						modelAction.MedicalFeeModelActionTypes.DELETE_MEDICAL_FEE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalFeeActionFail(
								modelAction.MedicalFeeModelActionTypes.DELETE_MEDICAL_FEE_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalFeeAction>(modelAction.MedicalFeeModelActionTypes.DELETE_ALL_MEDICAL_FEE),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.MedicalFeeActionOK(
						modelAction.MedicalFeeModelActionTypes.DELETE_ALL_MEDICAL_FEE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalFeeActionFail(
								modelAction.MedicalFeeModelActionTypes.DELETE_ALL_MEDICAL_FEE_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalFeeAction>(modelAction.MedicalFeeModelActionTypes.EXPORT_MEDICAL_FEE),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicalFeeActionOK(
						modelAction.MedicalFeeModelActionTypes.EXPORT_MEDICAL_FEE,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalFeeAction>(modelAction.MedicalFeeModelActionTypes.EXPORT_ALL_MEDICAL_FEE),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicalFeeActionOK(
						modelAction.MedicalFeeModelActionTypes.EXPORT_ALL_MEDICAL_FEE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalFeeActionFail(
								modelAction.MedicalFeeModelActionTypes.EXPORT_ALL_MEDICAL_FEE_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalFeeAction>(modelAction.MedicalFeeModelActionTypes.EXPORT_MEDICAL_FEE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicalFeeActionOK(
						modelAction.MedicalFeeModelActionTypes.EXPORT_MEDICAL_FEE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalFeeActionFail(
								modelAction.MedicalFeeModelActionTypes.EXPORT_MEDICAL_FEE_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalFeeAction>(modelAction.MedicalFeeModelActionTypes.IMPORT_MEDICAL_FEES),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.MedicalFeeActionOK(
						modelAction.MedicalFeeModelActionTypes.IMPORT_MEDICAL_FEES_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalFeeActionFail(
								modelAction.MedicalFeeModelActionTypes.IMPORT_MEDICAL_FEES_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalFeeAction>(modelAction.MedicalFeeModelActionTypes.FETCH_MEDICAL_FEE_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.MedicalFeeActionOK(
						modelAction.MedicalFeeModelActionTypes.FETCH_MEDICAL_FEE_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.MedicalFeeActionFail(
								modelAction.MedicalFeeModelActionTypes.FETCH_MEDICAL_FEE_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalFeeAction>(modelAction.MedicalFeeModelActionTypes.FETCH_MEDICAL_FEE_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.MedicalFeeActionOK(
						modelAction.MedicalFeeModelActionTypes.FETCH_MEDICAL_FEE_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.MedicalFeeActionFail(
								modelAction.MedicalFeeModelActionTypes.FETCH_MEDICAL_FEE_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
