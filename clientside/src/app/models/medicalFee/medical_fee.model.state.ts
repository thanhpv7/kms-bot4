...
/**
 * MedicalFeeCollectionState would store the state of a collection of MedicalFee
 */
export interface MedicalFeeCollectionState extends CollectionState {
 ...
 */
export interface MedicalFeeModelAudit extends AbstractModelAudit<MedicalFeeModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * MedicalFeeModelState would store the state of the model
 */
export interface MedicalFeeModelState {
	collectionState: {
		[key: string]: MedicalFeeCollectionState;
	};
	data: {
		[id: string]: MedicalFeeModel;
	};
	totalCount: number;
	audits: MedicalFeeModelAudit[];
 ...
 */
export const initialMedicalFeeCollectionState: MedicalFeeCollectionState = {
...
/**
 * The initial state of MedicalFeeModelState
 */
export const initialState: MedicalFeeModelState = {
	collectionState: {
