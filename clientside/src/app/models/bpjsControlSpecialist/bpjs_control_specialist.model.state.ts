...
/**
 * BpjsControlSpecialistCollectionState would store the state of a collection of BpjsControlSpecialist
 */
export interface BpjsControlSpecialistCollectionState extends CollectionState {
 ...
 */
export interface BpjsControlSpecialistModelAudit extends AbstractModelAudit<BpjsControlSpecialistModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsControlSpecialistModelState would store the state of the model
 */
export interface BpjsControlSpecialistModelState {
	collectionState: {
		[key: string]: BpjsControlSpecialistCollectionState;
	};
	data: {
		[id: string]: BpjsControlSpecialistModel;
	};
	totalCount: number;
	audits: BpjsControlSpecialistModelAudit[];
 ...
 */
export const initialBpjsControlSpecialistCollectionState: BpjsControlSpecialistCollectionState = {
...
/**
 * The initial state of BpjsControlSpecialistModelState
 */
export const initialState: BpjsControlSpecialistModelState = {
	collectionState: {
