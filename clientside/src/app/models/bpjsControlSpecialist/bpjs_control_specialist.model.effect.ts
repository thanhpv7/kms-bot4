...
import * as modelAction from './bpjs_control_specialist.model.action';
import {BpjsControlSpecialistService} from '../../services/bpjsControlSpecialist/bpjs_control_specialist.service';
...
/**
 * Effect class used for side effects related to BPJS Control Specialist model.
 */
@Injectable()
export class BpjsControlSpecialistEffect {
	...
	constructor(
		...
		protected readonly service: BpjsControlSpecialistService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsControlSpecialistAction>(modelAction.BpjsControlSpecialistModelActionTypes.COUNT_BPJS_CONTROL_SPECIALISTS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsControlSpecialistActionOK(
						modelAction.BpjsControlSpecialistModelActionTypes.COUNT_BPJS_CONTROL_SPECIALISTS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsControlSpecialistActionFail(
								modelAction.BpjsControlSpecialistModelActionTypes.COUNT_BPJS_CONTROL_SPECIALISTS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsControlSpecialistAction>(modelAction.BpjsControlSpecialistModelActionTypes.FETCH_BPJS_CONTROL_SPECIALIST),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsControlSpecialistActionOK(
						modelAction.BpjsControlSpecialistModelActionTypes.FETCH_BPJS_CONTROL_SPECIALIST_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsControlSpecialistActionFail(
								modelAction.BpjsControlSpecialistModelActionTypes.FETCH_BPJS_CONTROL_SPECIALIST_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsControlSpecialistAction>(modelAction.BpjsControlSpecialistModelActionTypes.FETCH_ALL_BPJS_CONTROL_SPECIALIST),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsControlSpecialistActionOK(
						modelAction.BpjsControlSpecialistModelActionTypes.FETCH_ALL_BPJS_CONTROL_SPECIALIST_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsControlSpecialistActionFail(
								modelAction.BpjsControlSpecialistModelActionTypes.FETCH_ALL_BPJS_CONTROL_SPECIALIST_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsControlSpecialistAction>(modelAction.BpjsControlSpecialistModelActionTypes.FETCH_BPJS_CONTROL_SPECIALIST_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsControlSpecialistActionOK(
						modelAction.BpjsControlSpecialistModelActionTypes.FETCH_BPJS_CONTROL_SPECIALIST_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsControlSpecialistActionFail(
								modelAction.BpjsControlSpecialistModelActionTypes.FETCH_BPJS_CONTROL_SPECIALIST_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsControlSpecialistAction>(modelAction.BpjsControlSpecialistModelActionTypes.FETCH_LAST_BPJS_CONTROL_SPECIALIST_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsControlSpecialistActionOK(
						modelAction.BpjsControlSpecialistModelActionTypes.FETCH_LAST_BPJS_CONTROL_SPECIALIST_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsControlSpecialistActionFail(
								modelAction.BpjsControlSpecialistModelActionTypes.FETCH_LAST_BPJS_CONTROL_SPECIALIST_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsControlSpecialistAction>(modelAction.BpjsControlSpecialistModelActionTypes.CREATE_BPJS_CONTROL_SPECIALIST),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsControlSpecialistModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsControlSpecialistActionOK(
						modelAction.BpjsControlSpecialistModelActionTypes.CREATE_BPJS_CONTROL_SPECIALIST_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsControlSpecialistActionFail(
								modelAction.BpjsControlSpecialistModelActionTypes.CREATE_BPJS_CONTROL_SPECIALIST_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsControlSpecialistAction>(modelAction.BpjsControlSpecialistModelActionTypes.CREATE_ALL_BPJS_CONTROL_SPECIALIST),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsControlSpecialistModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsControlSpecialistActionOK(
						modelAction.BpjsControlSpecialistModelActionTypes.CREATE_ALL_BPJS_CONTROL_SPECIALIST_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsControlSpecialistActionFail(
								modelAction.BpjsControlSpecialistModelActionTypes.CREATE_ALL_BPJS_CONTROL_SPECIALIST_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsControlSpecialistAction>(modelAction.BpjsControlSpecialistModelActionTypes.UPDATE_BPJS_CONTROL_SPECIALIST),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsControlSpecialistModel;
				...
				return this.service.update(new BpjsControlSpecialistModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsControlSpecialistActionOK(
						modelAction.BpjsControlSpecialistModelActionTypes.UPDATE_BPJS_CONTROL_SPECIALIST_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsControlSpecialistActionFail(
								modelAction.BpjsControlSpecialistModelActionTypes.UPDATE_BPJS_CONTROL_SPECIALIST_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsControlSpecialistAction>(modelAction.BpjsControlSpecialistModelActionTypes.UPDATE_ALL_BPJS_CONTROL_SPECIALIST),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsControlSpecialistModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsControlSpecialistModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsControlSpecialistActionOK(
						modelAction.BpjsControlSpecialistModelActionTypes.UPDATE_ALL_BPJS_CONTROL_SPECIALIST_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsControlSpecialistActionFail(
								modelAction.BpjsControlSpecialistModelActionTypes.UPDATE_ALL_BPJS_CONTROL_SPECIALIST_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsControlSpecialistAction>(modelAction.BpjsControlSpecialistModelActionTypes.DELETE_BPJS_CONTROL_SPECIALIST),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsControlSpecialistActionOK(
						modelAction.BpjsControlSpecialistModelActionTypes.DELETE_BPJS_CONTROL_SPECIALIST_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsControlSpecialistActionFail(
								modelAction.BpjsControlSpecialistModelActionTypes.DELETE_BPJS_CONTROL_SPECIALIST_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsControlSpecialistAction>(modelAction.BpjsControlSpecialistModelActionTypes.DELETE_BPJS_CONTROL_SPECIALIST_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsControlSpecialistActionOK(
						modelAction.BpjsControlSpecialistModelActionTypes.DELETE_BPJS_CONTROL_SPECIALIST_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsControlSpecialistActionFail(
								modelAction.BpjsControlSpecialistModelActionTypes.DELETE_BPJS_CONTROL_SPECIALIST_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsControlSpecialistAction>(modelAction.BpjsControlSpecialistModelActionTypes.DELETE_ALL_BPJS_CONTROL_SPECIALIST),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsControlSpecialistActionOK(
						modelAction.BpjsControlSpecialistModelActionTypes.DELETE_ALL_BPJS_CONTROL_SPECIALIST_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsControlSpecialistActionFail(
								modelAction.BpjsControlSpecialistModelActionTypes.DELETE_ALL_BPJS_CONTROL_SPECIALIST_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsControlSpecialistAction>(modelAction.BpjsControlSpecialistModelActionTypes.EXPORT_BPJS_CONTROL_SPECIALIST),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsControlSpecialistActionOK(
						modelAction.BpjsControlSpecialistModelActionTypes.EXPORT_BPJS_CONTROL_SPECIALIST,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsControlSpecialistAction>(modelAction.BpjsControlSpecialistModelActionTypes.EXPORT_ALL_BPJS_CONTROL_SPECIALIST),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsControlSpecialistActionOK(
						modelAction.BpjsControlSpecialistModelActionTypes.EXPORT_ALL_BPJS_CONTROL_SPECIALIST_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsControlSpecialistActionFail(
								modelAction.BpjsControlSpecialistModelActionTypes.EXPORT_ALL_BPJS_CONTROL_SPECIALIST_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsControlSpecialistAction>(modelAction.BpjsControlSpecialistModelActionTypes.EXPORT_BPJS_CONTROL_SPECIALIST_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsControlSpecialistActionOK(
						modelAction.BpjsControlSpecialistModelActionTypes.EXPORT_BPJS_CONTROL_SPECIALIST_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsControlSpecialistActionFail(
								modelAction.BpjsControlSpecialistModelActionTypes.EXPORT_BPJS_CONTROL_SPECIALIST_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsControlSpecialistAction>(modelAction.BpjsControlSpecialistModelActionTypes.IMPORT_BPJS_CONTROL_SPECIALISTS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsControlSpecialistActionOK(
						modelAction.BpjsControlSpecialistModelActionTypes.IMPORT_BPJS_CONTROL_SPECIALISTS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsControlSpecialistActionFail(
								modelAction.BpjsControlSpecialistModelActionTypes.IMPORT_BPJS_CONTROL_SPECIALISTS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsControlSpecialistAction>(modelAction.BpjsControlSpecialistModelActionTypes.FETCH_BPJS_CONTROL_SPECIALIST_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsControlSpecialistActionOK(
						modelAction.BpjsControlSpecialistModelActionTypes.FETCH_BPJS_CONTROL_SPECIALIST_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsControlSpecialistActionFail(
								modelAction.BpjsControlSpecialistModelActionTypes.FETCH_BPJS_CONTROL_SPECIALIST_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsControlSpecialistAction>(modelAction.BpjsControlSpecialistModelActionTypes.FETCH_BPJS_CONTROL_SPECIALIST_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsControlSpecialistActionOK(
						modelAction.BpjsControlSpecialistModelActionTypes.FETCH_BPJS_CONTROL_SPECIALIST_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsControlSpecialistActionFail(
								modelAction.BpjsControlSpecialistModelActionTypes.FETCH_BPJS_CONTROL_SPECIALIST_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
