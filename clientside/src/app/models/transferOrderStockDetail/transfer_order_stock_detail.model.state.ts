...
/**
 * TransferOrderStockDetailCollectionState would store the state of a collection of TransferOrderStockDetail
 */
export interface TransferOrderStockDetailCollectionState extends CollectionState {
 ...
 */
export interface TransferOrderStockDetailModelAudit extends AbstractModelAudit<TransferOrderStockDetailModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * TransferOrderStockDetailModelState would store the state of the model
 */
export interface TransferOrderStockDetailModelState {
	collectionState: {
		[key: string]: TransferOrderStockDetailCollectionState;
	};
	data: {
		[id: string]: TransferOrderStockDetailModel;
	};
	totalCount: number;
	audits: TransferOrderStockDetailModelAudit[];
 ...
 */
export const initialTransferOrderStockDetailCollectionState: TransferOrderStockDetailCollectionState = {
...
/**
 * The initial state of TransferOrderStockDetailModelState
 */
export const initialState: TransferOrderStockDetailModelState = {
	collectionState: {
