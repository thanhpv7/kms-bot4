...
import * as modelAction from './facility_history.model.action';
import {FacilityHistoryService} from '../../services/facilityHistory/facility_history.service';
...
/**
 * Effect class used for side effects related to Facility History model.
 */
@Injectable()
export class FacilityHistoryEffect {
	...
	constructor(
		...
		protected readonly service: FacilityHistoryService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FacilityHistoryAction>(modelAction.FacilityHistoryModelActionTypes.COUNT_FACILITY_HISTORYS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.FacilityHistoryActionOK(
						modelAction.FacilityHistoryModelActionTypes.COUNT_FACILITY_HISTORYS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FacilityHistoryActionFail(
								modelAction.FacilityHistoryModelActionTypes.COUNT_FACILITY_HISTORYS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FacilityHistoryAction>(modelAction.FacilityHistoryModelActionTypes.FETCH_FACILITY_HISTORY),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.FacilityHistoryActionOK(
						modelAction.FacilityHistoryModelActionTypes.FETCH_FACILITY_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FacilityHistoryActionFail(
								modelAction.FacilityHistoryModelActionTypes.FETCH_FACILITY_HISTORY_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FacilityHistoryAction>(modelAction.FacilityHistoryModelActionTypes.FETCH_ALL_FACILITY_HISTORY),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.FacilityHistoryActionOK(
						modelAction.FacilityHistoryModelActionTypes.FETCH_ALL_FACILITY_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FacilityHistoryActionFail(
								modelAction.FacilityHistoryModelActionTypes.FETCH_ALL_FACILITY_HISTORY_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FacilityHistoryAction>(modelAction.FacilityHistoryModelActionTypes.FETCH_FACILITY_HISTORY_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.FacilityHistoryActionOK(
						modelAction.FacilityHistoryModelActionTypes.FETCH_FACILITY_HISTORY_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FacilityHistoryActionFail(
								modelAction.FacilityHistoryModelActionTypes.FETCH_FACILITY_HISTORY_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FacilityHistoryAction>(modelAction.FacilityHistoryModelActionTypes.FETCH_LAST_FACILITY_HISTORY_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.FacilityHistoryActionOK(
						modelAction.FacilityHistoryModelActionTypes.FETCH_LAST_FACILITY_HISTORY_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FacilityHistoryActionFail(
								modelAction.FacilityHistoryModelActionTypes.FETCH_LAST_FACILITY_HISTORY_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FacilityHistoryAction>(modelAction.FacilityHistoryModelActionTypes.CREATE_FACILITY_HISTORY),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as FacilityHistoryModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.FacilityHistoryActionOK(
						modelAction.FacilityHistoryModelActionTypes.CREATE_FACILITY_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FacilityHistoryActionFail(
								modelAction.FacilityHistoryModelActionTypes.CREATE_FACILITY_HISTORY_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FacilityHistoryAction>(modelAction.FacilityHistoryModelActionTypes.CREATE_ALL_FACILITY_HISTORY),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as FacilityHistoryModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.FacilityHistoryActionOK(
						modelAction.FacilityHistoryModelActionTypes.CREATE_ALL_FACILITY_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FacilityHistoryActionFail(
								modelAction.FacilityHistoryModelActionTypes.CREATE_ALL_FACILITY_HISTORY_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FacilityHistoryAction>(modelAction.FacilityHistoryModelActionTypes.UPDATE_FACILITY_HISTORY),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as FacilityHistoryModel;
				...
				return this.service.update(new FacilityHistoryModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.FacilityHistoryActionOK(
						modelAction.FacilityHistoryModelActionTypes.UPDATE_FACILITY_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FacilityHistoryActionFail(
								modelAction.FacilityHistoryModelActionTypes.UPDATE_FACILITY_HISTORY_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FacilityHistoryAction>(modelAction.FacilityHistoryModelActionTypes.UPDATE_ALL_FACILITY_HISTORY),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as FacilityHistoryModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new FacilityHistoryModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.FacilityHistoryActionOK(
						modelAction.FacilityHistoryModelActionTypes.UPDATE_ALL_FACILITY_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FacilityHistoryActionFail(
								modelAction.FacilityHistoryModelActionTypes.UPDATE_ALL_FACILITY_HISTORY_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FacilityHistoryAction>(modelAction.FacilityHistoryModelActionTypes.DELETE_FACILITY_HISTORY),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.FacilityHistoryActionOK(
						modelAction.FacilityHistoryModelActionTypes.DELETE_FACILITY_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FacilityHistoryActionFail(
								modelAction.FacilityHistoryModelActionTypes.DELETE_FACILITY_HISTORY_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FacilityHistoryAction>(modelAction.FacilityHistoryModelActionTypes.DELETE_FACILITY_HISTORY_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.FacilityHistoryActionOK(
						modelAction.FacilityHistoryModelActionTypes.DELETE_FACILITY_HISTORY_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FacilityHistoryActionFail(
								modelAction.FacilityHistoryModelActionTypes.DELETE_FACILITY_HISTORY_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FacilityHistoryAction>(modelAction.FacilityHistoryModelActionTypes.DELETE_ALL_FACILITY_HISTORY),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.FacilityHistoryActionOK(
						modelAction.FacilityHistoryModelActionTypes.DELETE_ALL_FACILITY_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FacilityHistoryActionFail(
								modelAction.FacilityHistoryModelActionTypes.DELETE_ALL_FACILITY_HISTORY_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FacilityHistoryAction>(modelAction.FacilityHistoryModelActionTypes.EXPORT_FACILITY_HISTORY),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.FacilityHistoryActionOK(
						modelAction.FacilityHistoryModelActionTypes.EXPORT_FACILITY_HISTORY,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FacilityHistoryAction>(modelAction.FacilityHistoryModelActionTypes.EXPORT_ALL_FACILITY_HISTORY),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.FacilityHistoryActionOK(
						modelAction.FacilityHistoryModelActionTypes.EXPORT_ALL_FACILITY_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FacilityHistoryActionFail(
								modelAction.FacilityHistoryModelActionTypes.EXPORT_ALL_FACILITY_HISTORY_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FacilityHistoryAction>(modelAction.FacilityHistoryModelActionTypes.EXPORT_FACILITY_HISTORY_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.FacilityHistoryActionOK(
						modelAction.FacilityHistoryModelActionTypes.EXPORT_FACILITY_HISTORY_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FacilityHistoryActionFail(
								modelAction.FacilityHistoryModelActionTypes.EXPORT_FACILITY_HISTORY_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FacilityHistoryAction>(modelAction.FacilityHistoryModelActionTypes.IMPORT_FACILITY_HISTORYS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.FacilityHistoryActionOK(
						modelAction.FacilityHistoryModelActionTypes.IMPORT_FACILITY_HISTORYS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FacilityHistoryActionFail(
								modelAction.FacilityHistoryModelActionTypes.IMPORT_FACILITY_HISTORYS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FacilityHistoryAction>(modelAction.FacilityHistoryModelActionTypes.FETCH_FACILITY_HISTORY_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.FacilityHistoryActionOK(
						modelAction.FacilityHistoryModelActionTypes.FETCH_FACILITY_HISTORY_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.FacilityHistoryActionFail(
								modelAction.FacilityHistoryModelActionTypes.FETCH_FACILITY_HISTORY_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FacilityHistoryAction>(modelAction.FacilityHistoryModelActionTypes.FETCH_FACILITY_HISTORY_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.FacilityHistoryActionOK(
						modelAction.FacilityHistoryModelActionTypes.FETCH_FACILITY_HISTORY_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.FacilityHistoryActionFail(
								modelAction.FacilityHistoryModelActionTypes.FETCH_FACILITY_HISTORY_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
