...
/**
 * FacilityHistoryCollectionState would store the state of a collection of FacilityHistory
 */
export interface FacilityHistoryCollectionState extends CollectionState {
 ...
 */
export interface FacilityHistoryModelAudit extends AbstractModelAudit<FacilityHistoryModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * FacilityHistoryModelState would store the state of the model
 */
export interface FacilityHistoryModelState {
	collectionState: {
		[key: string]: FacilityHistoryCollectionState;
	};
	data: {
		[id: string]: FacilityHistoryModel;
	};
	totalCount: number;
	audits: FacilityHistoryModelAudit[];
 ...
 */
export const initialFacilityHistoryCollectionState: FacilityHistoryCollectionState = {
...
/**
 * The initial state of FacilityHistoryModelState
 */
export const initialState: FacilityHistoryModelState = {
	collectionState: {
