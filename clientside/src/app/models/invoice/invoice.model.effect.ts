...
/**
 * Effect class used for side effects related to Invoice model.
 */
@Injectable()
export class InvoiceEffect {
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceAction>(modelAction.InvoiceModelActionTypes.COUNT_INVOICES),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.InvoiceActionOK(
						modelAction.InvoiceModelActionTypes.COUNT_INVOICES_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceActionFail(
								modelAction.InvoiceModelActionTypes.COUNT_INVOICES_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceAction>(modelAction.InvoiceModelActionTypes.FETCH_INVOICE),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InvoiceActionOK(
						modelAction.InvoiceModelActionTypes.FETCH_INVOICE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceActionFail(
								modelAction.InvoiceModelActionTypes.FETCH_INVOICE_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceAction>(modelAction.InvoiceModelActionTypes.FETCH_ALL_INVOICE),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.InvoiceActionOK(
						modelAction.InvoiceModelActionTypes.FETCH_ALL_INVOICE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceActionFail(
								modelAction.InvoiceModelActionTypes.FETCH_ALL_INVOICE_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceAction>(modelAction.InvoiceModelActionTypes.FETCH_INVOICE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.InvoiceActionOK(
						modelAction.InvoiceModelActionTypes.FETCH_INVOICE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceActionFail(
								modelAction.InvoiceModelActionTypes.FETCH_INVOICE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceAction>(modelAction.InvoiceModelActionTypes.FETCH_LAST_INVOICE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.InvoiceActionOK(
						modelAction.InvoiceModelActionTypes.FETCH_LAST_INVOICE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceActionFail(
								modelAction.InvoiceModelActionTypes.FETCH_LAST_INVOICE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceAction>(modelAction.InvoiceModelActionTypes.CREATE_INVOICE),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as InvoiceModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InvoiceActionOK(
						modelAction.InvoiceModelActionTypes.CREATE_INVOICE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceActionFail(
								modelAction.InvoiceModelActionTypes.CREATE_INVOICE_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceAction>(modelAction.InvoiceModelActionTypes.CREATE_ALL_INVOICE),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as InvoiceModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InvoiceActionOK(
						modelAction.InvoiceModelActionTypes.CREATE_ALL_INVOICE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceActionFail(
								modelAction.InvoiceModelActionTypes.CREATE_ALL_INVOICE_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceAction>(modelAction.InvoiceModelActionTypes.UPDATE_INVOICE),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as InvoiceModel;
				...
				return this.service.update(new InvoiceModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.InvoiceActionOK(
						modelAction.InvoiceModelActionTypes.UPDATE_INVOICE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceActionFail(
								modelAction.InvoiceModelActionTypes.UPDATE_INVOICE_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceAction>(modelAction.InvoiceModelActionTypes.UPDATE_ALL_INVOICE),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as InvoiceModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new InvoiceModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InvoiceActionOK(
						modelAction.InvoiceModelActionTypes.UPDATE_ALL_INVOICE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceActionFail(
								modelAction.InvoiceModelActionTypes.UPDATE_ALL_INVOICE_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceAction>(modelAction.InvoiceModelActionTypes.DELETE_INVOICE),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.InvoiceActionOK(
						modelAction.InvoiceModelActionTypes.DELETE_INVOICE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceActionFail(
								modelAction.InvoiceModelActionTypes.DELETE_INVOICE_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceAction>(modelAction.InvoiceModelActionTypes.DELETE_INVOICE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.InvoiceActionOK(
						modelAction.InvoiceModelActionTypes.DELETE_INVOICE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceActionFail(
								modelAction.InvoiceModelActionTypes.DELETE_INVOICE_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceAction>(modelAction.InvoiceModelActionTypes.DELETE_ALL_INVOICE),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.InvoiceActionOK(
						modelAction.InvoiceModelActionTypes.DELETE_ALL_INVOICE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceActionFail(
								modelAction.InvoiceModelActionTypes.DELETE_ALL_INVOICE_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceAction>(modelAction.InvoiceModelActionTypes.EXPORT_INVOICE),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.InvoiceActionOK(
						modelAction.InvoiceModelActionTypes.EXPORT_INVOICE,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceAction>(modelAction.InvoiceModelActionTypes.EXPORT_ALL_INVOICE),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.InvoiceActionOK(
						modelAction.InvoiceModelActionTypes.EXPORT_ALL_INVOICE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceActionFail(
								modelAction.InvoiceModelActionTypes.EXPORT_ALL_INVOICE_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceAction>(modelAction.InvoiceModelActionTypes.EXPORT_INVOICE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.InvoiceActionOK(
						modelAction.InvoiceModelActionTypes.EXPORT_INVOICE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceActionFail(
								modelAction.InvoiceModelActionTypes.EXPORT_INVOICE_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceAction>(modelAction.InvoiceModelActionTypes.IMPORT_INVOICES),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.InvoiceActionOK(
						modelAction.InvoiceModelActionTypes.IMPORT_INVOICES_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceActionFail(
								modelAction.InvoiceModelActionTypes.IMPORT_INVOICES_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceAction>(modelAction.InvoiceModelActionTypes.FETCH_INVOICE_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.InvoiceActionOK(
						modelAction.InvoiceModelActionTypes.FETCH_INVOICE_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceActionFail(
								modelAction.InvoiceModelActionTypes.FETCH_INVOICE_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoiceAction>(modelAction.InvoiceModelActionTypes.FETCH_INVOICE_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.InvoiceActionOK(
						modelAction.InvoiceModelActionTypes.FETCH_INVOICE_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.InvoiceActionFail(
								modelAction.InvoiceModelActionTypes.FETCH_INVOICE_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
