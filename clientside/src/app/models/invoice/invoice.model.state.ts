...
/**
 * InvoiceCollectionState would store the state of a collection of Invoice
 */
export interface InvoiceCollectionState extends CollectionState {
 ...
 */
export interface InvoiceModelAudit extends AbstractModelAudit<InvoiceModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * InvoiceModelState would store the state of the model
 */
export interface InvoiceModelState {
	collectionState: {
		[key: string]: InvoiceCollectionState;
	};
	data: {
		[id: string]: InvoiceModel;
	};
	totalCount: number;
	audits: InvoiceModelAudit[];
 ...
 */
export const initialInvoiceCollectionState: InvoiceCollectionState = {
...
/**
 * The initial state of InvoiceModelState
 */
export const initialState: InvoiceModelState = {
	collectionState: {
