...
import * as modelAction from './pcare_noncompound_drug.model.action';
import {PcareNonCompoundDrugService} from '../../services/pcareNonCompoundDrug/pcare_noncompound_drug.service';
...
/**
 * Effect class used for side effects related to PCare NonCompound Drug model.
 */
@Injectable()
export class PcareNonCompoundDrugEffect {
	...
	constructor(
		...
		protected readonly service: PcareNonCompoundDrugService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareNonCompoundDrugAction>(modelAction.PcareNonCompoundDrugModelActionTypes.COUNT_PCARE_NONCOMPOUND_DRUGS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.PcareNonCompoundDrugActionOK(
						modelAction.PcareNonCompoundDrugModelActionTypes.COUNT_PCARE_NONCOMPOUND_DRUGS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareNonCompoundDrugActionFail(
								modelAction.PcareNonCompoundDrugModelActionTypes.COUNT_PCARE_NONCOMPOUND_DRUGS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareNonCompoundDrugAction>(modelAction.PcareNonCompoundDrugModelActionTypes.FETCH_PCARE_NONCOMPOUND_DRUG),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareNonCompoundDrugActionOK(
						modelAction.PcareNonCompoundDrugModelActionTypes.FETCH_PCARE_NONCOMPOUND_DRUG_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareNonCompoundDrugActionFail(
								modelAction.PcareNonCompoundDrugModelActionTypes.FETCH_PCARE_NONCOMPOUND_DRUG_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareNonCompoundDrugAction>(modelAction.PcareNonCompoundDrugModelActionTypes.FETCH_ALL_PCARE_NONCOMPOUND_DRUG),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.PcareNonCompoundDrugActionOK(
						modelAction.PcareNonCompoundDrugModelActionTypes.FETCH_ALL_PCARE_NONCOMPOUND_DRUG_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareNonCompoundDrugActionFail(
								modelAction.PcareNonCompoundDrugModelActionTypes.FETCH_ALL_PCARE_NONCOMPOUND_DRUG_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareNonCompoundDrugAction>(modelAction.PcareNonCompoundDrugModelActionTypes.FETCH_PCARE_NONCOMPOUND_DRUG_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareNonCompoundDrugActionOK(
						modelAction.PcareNonCompoundDrugModelActionTypes.FETCH_PCARE_NONCOMPOUND_DRUG_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareNonCompoundDrugActionFail(
								modelAction.PcareNonCompoundDrugModelActionTypes.FETCH_PCARE_NONCOMPOUND_DRUG_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareNonCompoundDrugAction>(modelAction.PcareNonCompoundDrugModelActionTypes.FETCH_LAST_PCARE_NONCOMPOUND_DRUG_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareNonCompoundDrugActionOK(
						modelAction.PcareNonCompoundDrugModelActionTypes.FETCH_LAST_PCARE_NONCOMPOUND_DRUG_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareNonCompoundDrugActionFail(
								modelAction.PcareNonCompoundDrugModelActionTypes.FETCH_LAST_PCARE_NONCOMPOUND_DRUG_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareNonCompoundDrugAction>(modelAction.PcareNonCompoundDrugModelActionTypes.CREATE_PCARE_NONCOMPOUND_DRUG),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as PcareNonCompoundDrugModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareNonCompoundDrugActionOK(
						modelAction.PcareNonCompoundDrugModelActionTypes.CREATE_PCARE_NONCOMPOUND_DRUG_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareNonCompoundDrugActionFail(
								modelAction.PcareNonCompoundDrugModelActionTypes.CREATE_PCARE_NONCOMPOUND_DRUG_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareNonCompoundDrugAction>(modelAction.PcareNonCompoundDrugModelActionTypes.CREATE_ALL_PCARE_NONCOMPOUND_DRUG),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as PcareNonCompoundDrugModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareNonCompoundDrugActionOK(
						modelAction.PcareNonCompoundDrugModelActionTypes.CREATE_ALL_PCARE_NONCOMPOUND_DRUG_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareNonCompoundDrugActionFail(
								modelAction.PcareNonCompoundDrugModelActionTypes.CREATE_ALL_PCARE_NONCOMPOUND_DRUG_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareNonCompoundDrugAction>(modelAction.PcareNonCompoundDrugModelActionTypes.UPDATE_PCARE_NONCOMPOUND_DRUG),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as PcareNonCompoundDrugModel;
				...
				return this.service.update(new PcareNonCompoundDrugModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareNonCompoundDrugActionOK(
						modelAction.PcareNonCompoundDrugModelActionTypes.UPDATE_PCARE_NONCOMPOUND_DRUG_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareNonCompoundDrugActionFail(
								modelAction.PcareNonCompoundDrugModelActionTypes.UPDATE_PCARE_NONCOMPOUND_DRUG_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareNonCompoundDrugAction>(modelAction.PcareNonCompoundDrugModelActionTypes.UPDATE_ALL_PCARE_NONCOMPOUND_DRUG),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as PcareNonCompoundDrugModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new PcareNonCompoundDrugModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareNonCompoundDrugActionOK(
						modelAction.PcareNonCompoundDrugModelActionTypes.UPDATE_ALL_PCARE_NONCOMPOUND_DRUG_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareNonCompoundDrugActionFail(
								modelAction.PcareNonCompoundDrugModelActionTypes.UPDATE_ALL_PCARE_NONCOMPOUND_DRUG_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareNonCompoundDrugAction>(modelAction.PcareNonCompoundDrugModelActionTypes.DELETE_PCARE_NONCOMPOUND_DRUG),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PcareNonCompoundDrugActionOK(
						modelAction.PcareNonCompoundDrugModelActionTypes.DELETE_PCARE_NONCOMPOUND_DRUG_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareNonCompoundDrugActionFail(
								modelAction.PcareNonCompoundDrugModelActionTypes.DELETE_PCARE_NONCOMPOUND_DRUG_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareNonCompoundDrugAction>(modelAction.PcareNonCompoundDrugModelActionTypes.DELETE_PCARE_NONCOMPOUND_DRUG_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.PcareNonCompoundDrugActionOK(
						modelAction.PcareNonCompoundDrugModelActionTypes.DELETE_PCARE_NONCOMPOUND_DRUG_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareNonCompoundDrugActionFail(
								modelAction.PcareNonCompoundDrugModelActionTypes.DELETE_PCARE_NONCOMPOUND_DRUG_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareNonCompoundDrugAction>(modelAction.PcareNonCompoundDrugModelActionTypes.DELETE_ALL_PCARE_NONCOMPOUND_DRUG),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PcareNonCompoundDrugActionOK(
						modelAction.PcareNonCompoundDrugModelActionTypes.DELETE_ALL_PCARE_NONCOMPOUND_DRUG_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareNonCompoundDrugActionFail(
								modelAction.PcareNonCompoundDrugModelActionTypes.DELETE_ALL_PCARE_NONCOMPOUND_DRUG_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareNonCompoundDrugAction>(modelAction.PcareNonCompoundDrugModelActionTypes.EXPORT_PCARE_NONCOMPOUND_DRUG),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PcareNonCompoundDrugActionOK(
						modelAction.PcareNonCompoundDrugModelActionTypes.EXPORT_PCARE_NONCOMPOUND_DRUG,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareNonCompoundDrugAction>(modelAction.PcareNonCompoundDrugModelActionTypes.EXPORT_ALL_PCARE_NONCOMPOUND_DRUG),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PcareNonCompoundDrugActionOK(
						modelAction.PcareNonCompoundDrugModelActionTypes.EXPORT_ALL_PCARE_NONCOMPOUND_DRUG_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareNonCompoundDrugActionFail(
								modelAction.PcareNonCompoundDrugModelActionTypes.EXPORT_ALL_PCARE_NONCOMPOUND_DRUG_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareNonCompoundDrugAction>(modelAction.PcareNonCompoundDrugModelActionTypes.EXPORT_PCARE_NONCOMPOUND_DRUG_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PcareNonCompoundDrugActionOK(
						modelAction.PcareNonCompoundDrugModelActionTypes.EXPORT_PCARE_NONCOMPOUND_DRUG_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareNonCompoundDrugActionFail(
								modelAction.PcareNonCompoundDrugModelActionTypes.EXPORT_PCARE_NONCOMPOUND_DRUG_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareNonCompoundDrugAction>(modelAction.PcareNonCompoundDrugModelActionTypes.IMPORT_PCARE_NONCOMPOUND_DRUGS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.PcareNonCompoundDrugActionOK(
						modelAction.PcareNonCompoundDrugModelActionTypes.IMPORT_PCARE_NONCOMPOUND_DRUGS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareNonCompoundDrugActionFail(
								modelAction.PcareNonCompoundDrugModelActionTypes.IMPORT_PCARE_NONCOMPOUND_DRUGS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareNonCompoundDrugAction>(modelAction.PcareNonCompoundDrugModelActionTypes.FETCH_PCARE_NONCOMPOUND_DRUG_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.PcareNonCompoundDrugActionOK(
						modelAction.PcareNonCompoundDrugModelActionTypes.FETCH_PCARE_NONCOMPOUND_DRUG_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PcareNonCompoundDrugActionFail(
								modelAction.PcareNonCompoundDrugModelActionTypes.FETCH_PCARE_NONCOMPOUND_DRUG_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareNonCompoundDrugAction>(modelAction.PcareNonCompoundDrugModelActionTypes.FETCH_PCARE_NONCOMPOUND_DRUG_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.PcareNonCompoundDrugActionOK(
						modelAction.PcareNonCompoundDrugModelActionTypes.FETCH_PCARE_NONCOMPOUND_DRUG_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PcareNonCompoundDrugActionFail(
								modelAction.PcareNonCompoundDrugModelActionTypes.FETCH_PCARE_NONCOMPOUND_DRUG_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
