...
/**
 * PcareNonCompoundDrugCollectionState would store the state of a collection of PcareNonCompoundDrug
 */
export interface PcareNonCompoundDrugCollectionState extends CollectionState {
 ...
 */
export interface PcareNonCompoundDrugModelAudit extends AbstractModelAudit<PcareNonCompoundDrugModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * PcareNonCompoundDrugModelState would store the state of the model
 */
export interface PcareNonCompoundDrugModelState {
	collectionState: {
		[key: string]: PcareNonCompoundDrugCollectionState;
	};
	data: {
		[id: string]: PcareNonCompoundDrugModel;
	};
	totalCount: number;
	audits: PcareNonCompoundDrugModelAudit[];
 ...
 */
export const initialPcareNonCompoundDrugCollectionState: PcareNonCompoundDrugCollectionState = {
...
/**
 * The initial state of PcareNonCompoundDrugModelState
 */
export const initialState: PcareNonCompoundDrugModelState = {
	collectionState: {
