...
/**
 * MedicalCertificateMentalHealthCollectionState would store the state of a collection of MedicalCertificateMentalHealth
 */
export interface MedicalCertificateMentalHealthCollectionState extends CollectionState {
 ...
 */
export interface MedicalCertificateMentalHealthModelAudit extends AbstractModelAudit<MedicalCertificateMentalHealthModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * MedicalCertificateMentalHealthModelState would store the state of the model
 */
export interface MedicalCertificateMentalHealthModelState {
	collectionState: {
		[key: string]: MedicalCertificateMentalHealthCollectionState;
	};
	data: {
		[id: string]: MedicalCertificateMentalHealthModel;
	};
	totalCount: number;
	audits: MedicalCertificateMentalHealthModelAudit[];
 ...
 */
export const initialMedicalCertificateMentalHealthCollectionState: MedicalCertificateMentalHealthCollectionState = {
...
/**
 * The initial state of MedicalCertificateMentalHealthModelState
 */
export const initialState: MedicalCertificateMentalHealthModelState = {
	collectionState: {
