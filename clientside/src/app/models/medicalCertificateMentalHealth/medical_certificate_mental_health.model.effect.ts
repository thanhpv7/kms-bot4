...
import * as modelAction from './medical_certificate_mental_health.model.action';
import {MedicalCertificateMentalHealthService} from '../../services/medicalCertificateMentalHealth/medical_certificate_mental_health.service';
...
/**
 * Effect class used for side effects related to Medical Certificate Mental Health model.
 */
@Injectable()
export class MedicalCertificateMentalHealthEffect {
	...
	constructor(
		...
		protected readonly service: MedicalCertificateMentalHealthService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateMentalHealthAction>(modelAction.MedicalCertificateMentalHealthModelActionTypes.COUNT_MEDICAL_CERTIFICATE_MENTAL_HEALTHS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateMentalHealthActionOK(
						modelAction.MedicalCertificateMentalHealthModelActionTypes.COUNT_MEDICAL_CERTIFICATE_MENTAL_HEALTHS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateMentalHealthActionFail(
								modelAction.MedicalCertificateMentalHealthModelActionTypes.COUNT_MEDICAL_CERTIFICATE_MENTAL_HEALTHS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateMentalHealthAction>(modelAction.MedicalCertificateMentalHealthModelActionTypes.FETCH_MEDICAL_CERTIFICATE_MENTAL_HEALTH),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateMentalHealthActionOK(
						modelAction.MedicalCertificateMentalHealthModelActionTypes.FETCH_MEDICAL_CERTIFICATE_MENTAL_HEALTH_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateMentalHealthActionFail(
								modelAction.MedicalCertificateMentalHealthModelActionTypes.FETCH_MEDICAL_CERTIFICATE_MENTAL_HEALTH_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateMentalHealthAction>(modelAction.MedicalCertificateMentalHealthModelActionTypes.FETCH_ALL_MEDICAL_CERTIFICATE_MENTAL_HEALTH),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateMentalHealthActionOK(
						modelAction.MedicalCertificateMentalHealthModelActionTypes.FETCH_ALL_MEDICAL_CERTIFICATE_MENTAL_HEALTH_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateMentalHealthActionFail(
								modelAction.MedicalCertificateMentalHealthModelActionTypes.FETCH_ALL_MEDICAL_CERTIFICATE_MENTAL_HEALTH_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateMentalHealthAction>(modelAction.MedicalCertificateMentalHealthModelActionTypes.FETCH_MEDICAL_CERTIFICATE_MENTAL_HEALTH_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateMentalHealthActionOK(
						modelAction.MedicalCertificateMentalHealthModelActionTypes.FETCH_MEDICAL_CERTIFICATE_MENTAL_HEALTH_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateMentalHealthActionFail(
								modelAction.MedicalCertificateMentalHealthModelActionTypes.FETCH_MEDICAL_CERTIFICATE_MENTAL_HEALTH_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateMentalHealthAction>(modelAction.MedicalCertificateMentalHealthModelActionTypes.FETCH_LAST_MEDICAL_CERTIFICATE_MENTAL_HEALTH_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateMentalHealthActionOK(
						modelAction.MedicalCertificateMentalHealthModelActionTypes.FETCH_LAST_MEDICAL_CERTIFICATE_MENTAL_HEALTH_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateMentalHealthActionFail(
								modelAction.MedicalCertificateMentalHealthModelActionTypes.FETCH_LAST_MEDICAL_CERTIFICATE_MENTAL_HEALTH_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateMentalHealthAction>(modelAction.MedicalCertificateMentalHealthModelActionTypes.CREATE_MEDICAL_CERTIFICATE_MENTAL_HEALTH),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as MedicalCertificateMentalHealthModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateMentalHealthActionOK(
						modelAction.MedicalCertificateMentalHealthModelActionTypes.CREATE_MEDICAL_CERTIFICATE_MENTAL_HEALTH_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateMentalHealthActionFail(
								modelAction.MedicalCertificateMentalHealthModelActionTypes.CREATE_MEDICAL_CERTIFICATE_MENTAL_HEALTH_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateMentalHealthAction>(modelAction.MedicalCertificateMentalHealthModelActionTypes.CREATE_ALL_MEDICAL_CERTIFICATE_MENTAL_HEALTH),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as MedicalCertificateMentalHealthModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateMentalHealthActionOK(
						modelAction.MedicalCertificateMentalHealthModelActionTypes.CREATE_ALL_MEDICAL_CERTIFICATE_MENTAL_HEALTH_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateMentalHealthActionFail(
								modelAction.MedicalCertificateMentalHealthModelActionTypes.CREATE_ALL_MEDICAL_CERTIFICATE_MENTAL_HEALTH_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateMentalHealthAction>(modelAction.MedicalCertificateMentalHealthModelActionTypes.UPDATE_MEDICAL_CERTIFICATE_MENTAL_HEALTH),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as MedicalCertificateMentalHealthModel;
				...
				return this.service.update(new MedicalCertificateMentalHealthModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateMentalHealthActionOK(
						modelAction.MedicalCertificateMentalHealthModelActionTypes.UPDATE_MEDICAL_CERTIFICATE_MENTAL_HEALTH_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateMentalHealthActionFail(
								modelAction.MedicalCertificateMentalHealthModelActionTypes.UPDATE_MEDICAL_CERTIFICATE_MENTAL_HEALTH_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateMentalHealthAction>(modelAction.MedicalCertificateMentalHealthModelActionTypes.UPDATE_ALL_MEDICAL_CERTIFICATE_MENTAL_HEALTH),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as MedicalCertificateMentalHealthModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new MedicalCertificateMentalHealthModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateMentalHealthActionOK(
						modelAction.MedicalCertificateMentalHealthModelActionTypes.UPDATE_ALL_MEDICAL_CERTIFICATE_MENTAL_HEALTH_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateMentalHealthActionFail(
								modelAction.MedicalCertificateMentalHealthModelActionTypes.UPDATE_ALL_MEDICAL_CERTIFICATE_MENTAL_HEALTH_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateMentalHealthAction>(modelAction.MedicalCertificateMentalHealthModelActionTypes.DELETE_MEDICAL_CERTIFICATE_MENTAL_HEALTH),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateMentalHealthActionOK(
						modelAction.MedicalCertificateMentalHealthModelActionTypes.DELETE_MEDICAL_CERTIFICATE_MENTAL_HEALTH_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateMentalHealthActionFail(
								modelAction.MedicalCertificateMentalHealthModelActionTypes.DELETE_MEDICAL_CERTIFICATE_MENTAL_HEALTH_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateMentalHealthAction>(modelAction.MedicalCertificateMentalHealthModelActionTypes.DELETE_MEDICAL_CERTIFICATE_MENTAL_HEALTH_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateMentalHealthActionOK(
						modelAction.MedicalCertificateMentalHealthModelActionTypes.DELETE_MEDICAL_CERTIFICATE_MENTAL_HEALTH_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateMentalHealthActionFail(
								modelAction.MedicalCertificateMentalHealthModelActionTypes.DELETE_MEDICAL_CERTIFICATE_MENTAL_HEALTH_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateMentalHealthAction>(modelAction.MedicalCertificateMentalHealthModelActionTypes.DELETE_ALL_MEDICAL_CERTIFICATE_MENTAL_HEALTH),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateMentalHealthActionOK(
						modelAction.MedicalCertificateMentalHealthModelActionTypes.DELETE_ALL_MEDICAL_CERTIFICATE_MENTAL_HEALTH_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateMentalHealthActionFail(
								modelAction.MedicalCertificateMentalHealthModelActionTypes.DELETE_ALL_MEDICAL_CERTIFICATE_MENTAL_HEALTH_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateMentalHealthAction>(modelAction.MedicalCertificateMentalHealthModelActionTypes.EXPORT_MEDICAL_CERTIFICATE_MENTAL_HEALTH),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateMentalHealthActionOK(
						modelAction.MedicalCertificateMentalHealthModelActionTypes.EXPORT_MEDICAL_CERTIFICATE_MENTAL_HEALTH,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateMentalHealthAction>(modelAction.MedicalCertificateMentalHealthModelActionTypes.EXPORT_ALL_MEDICAL_CERTIFICATE_MENTAL_HEALTH),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateMentalHealthActionOK(
						modelAction.MedicalCertificateMentalHealthModelActionTypes.EXPORT_ALL_MEDICAL_CERTIFICATE_MENTAL_HEALTH_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateMentalHealthActionFail(
								modelAction.MedicalCertificateMentalHealthModelActionTypes.EXPORT_ALL_MEDICAL_CERTIFICATE_MENTAL_HEALTH_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateMentalHealthAction>(modelAction.MedicalCertificateMentalHealthModelActionTypes.EXPORT_MEDICAL_CERTIFICATE_MENTAL_HEALTH_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateMentalHealthActionOK(
						modelAction.MedicalCertificateMentalHealthModelActionTypes.EXPORT_MEDICAL_CERTIFICATE_MENTAL_HEALTH_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateMentalHealthActionFail(
								modelAction.MedicalCertificateMentalHealthModelActionTypes.EXPORT_MEDICAL_CERTIFICATE_MENTAL_HEALTH_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateMentalHealthAction>(modelAction.MedicalCertificateMentalHealthModelActionTypes.IMPORT_MEDICAL_CERTIFICATE_MENTAL_HEALTHS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateMentalHealthActionOK(
						modelAction.MedicalCertificateMentalHealthModelActionTypes.IMPORT_MEDICAL_CERTIFICATE_MENTAL_HEALTHS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateMentalHealthActionFail(
								modelAction.MedicalCertificateMentalHealthModelActionTypes.IMPORT_MEDICAL_CERTIFICATE_MENTAL_HEALTHS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateMentalHealthAction>(modelAction.MedicalCertificateMentalHealthModelActionTypes.FETCH_MEDICAL_CERTIFICATE_MENTAL_HEALTH_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.MedicalCertificateMentalHealthActionOK(
						modelAction.MedicalCertificateMentalHealthModelActionTypes.FETCH_MEDICAL_CERTIFICATE_MENTAL_HEALTH_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateMentalHealthActionFail(
								modelAction.MedicalCertificateMentalHealthModelActionTypes.FETCH_MEDICAL_CERTIFICATE_MENTAL_HEALTH_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateMentalHealthAction>(modelAction.MedicalCertificateMentalHealthModelActionTypes.FETCH_MEDICAL_CERTIFICATE_MENTAL_HEALTH_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.MedicalCertificateMentalHealthActionOK(
						modelAction.MedicalCertificateMentalHealthModelActionTypes.FETCH_MEDICAL_CERTIFICATE_MENTAL_HEALTH_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateMentalHealthActionFail(
								modelAction.MedicalCertificateMentalHealthModelActionTypes.FETCH_MEDICAL_CERTIFICATE_MENTAL_HEALTH_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
