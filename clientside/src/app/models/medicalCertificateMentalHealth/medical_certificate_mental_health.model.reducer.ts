...
import {initialMedicalCertificateMentalHealthCollectionState} from './medical_certificate_mental_health.model.state';
...
export function modelReducer(currentState: ModelState, action: Action): ModelState {
	...
	const className = (action as modelAction.BaseMedicalCertificateMentalHealthAction).className;
	...
	return produce(currentState, draft => {
		...
		switch (action.type) {
			case modelAction.MedicalCertificateMentalHealthModelActionTypes.CREATE_MEDICAL_CERTIFICATE_MENTAL_HEALTH_OK:
				const createdModel = (action as modelAction.MedicalCertificateMentalHealthActionOK ).stateConfig.targetModel;
				...
				MedicalCertificateMentalHealthModel.deepParse(createdModel).forEach(model => {
				...
				break;
			case modelAction.MedicalCertificateMentalHealthModelActionTypes.CREATE_MEDICAL_CERTIFICATE_MENTAL_HEALTH_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.MedicalCertificateMentalHealthModelActionTypes.CREATE_ALL_MEDICAL_CERTIFICATE_MENTAL_HEALTH_OK:
				const createdModels = (action as modelAction.MedicalCertificateMentalHealthActionOK).stateConfig.targetModels;
				const collectionIdAfterCreateAll = (action as modelAction.MedicalCertificateMentalHealthActionOK).stateConfig.collectionId;
				...
				createdModels.forEach((m) => {
					MedicalCertificateMentalHealthModel.deepParse(m).forEach(model => {
						draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
						(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
					});
				});
				...
				break;
			case modelAction.MedicalCertificateMentalHealthModelActionTypes.CREATE_ALL_MEDICAL_CERTIFICATE_MENTAL_HEALTH_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.MedicalCertificateMentalHealthModelActionTypes.DELETE_MEDICAL_CERTIFICATE_MENTAL_HEALTH_OK:
				const deletedModelId = (action as modelAction.MedicalCertificateMentalHealthActionOK).stateConfig.targetModelId;
				const collectionIdAfterDelete = (action as modelAction.MedicalCertificateMentalHealthActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.MedicalCertificateMentalHealthModelActionTypes.DELETE_ALL_MEDICAL_CERTIFICATE_MENTAL_HEALTH_OK:
				const deletedModelIds = (action as modelAction.MedicalCertificateMentalHealthActionOK).stateConfig.targetModelIds;
				const collectionIdAfterDeleteAll = (action as modelAction.MedicalCertificateMentalHealthActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.MedicalCertificateMentalHealthModelActionTypes.DELETE_MEDICAL_CERTIFICATE_MENTAL_HEALTH_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.MedicalCertificateMentalHealthModelActionTypes.UPDATE_MEDICAL_CERTIFICATE_MENTAL_HEALTH_OK:
				const updatedModel = (action as modelAction.MedicalCertificateMentalHealthActionOK).stateConfig.targetModel;
				...
				MedicalCertificateMentalHealthModel.deepParse(updatedModel).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalCertificateMentalHealthModelActionTypes.UPDATE_MEDICAL_CERTIFICATE_MENTAL_HEALTH_FAIL:
				// TODO: Add handling of failure
				break;

			case modelAction.MedicalCertificateMentalHealthModelActionTypes.UPDATE_ALL_MEDICAL_CERTIFICATE_MENTAL_HEALTH_OK:
				const updatedModels = (action as modelAction.MedicalCertificateMentalHealthActionOK).stateConfig.targetModels;
				const collectionIdAfterUpdateAll = (action as modelAction.MedicalCertificateMentalHealthActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.MedicalCertificateMentalHealthModelActionTypes.UPDATE_ALL_MEDICAL_CERTIFICATE_MENTAL_HEALTH_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.MedicalCertificateMentalHealthModelActionTypes.FETCH_MEDICAL_CERTIFICATE_MENTAL_HEALTH_OK:
				let fetchedModel = (action as modelAction.MedicalCertificateMentalHealthActionOK).stateConfig.targetModel;
				...
				MedicalCertificateMentalHealthModel.deepParse(fetchedModel).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalCertificateMentalHealthModelActionTypes.FETCH_ALL_MEDICAL_CERTIFICATE_MENTAL_HEALTH_OK:
				const totalCountAfterFetchAll = (action as modelAction.MedicalCertificateMentalHealthActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchAll = (action as modelAction.MedicalCertificateMentalHealthActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchAll = (action as modelAction.MedicalCertificateMentalHealthActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchAll = (action as modelAction.MedicalCertificateMentalHealthActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchAll.map(model => MedicalCertificateMentalHealthModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalCertificateMentalHealthModelActionTypes.FETCH_MEDICAL_CERTIFICATE_MENTAL_HEALTH_AUDIT_OK:
				const audits = (action as modelAction.MedicalCertificateMentalHealthActionOK).audits;
				...
				break;
			case modelAction.MedicalCertificateMentalHealthModelActionTypes.FETCH_MEDICAL_CERTIFICATE_MENTAL_HEALTH_AUDITS_BY_ENTITY_ID_OK:
				const auditsByEntityId = (action as modelAction.MedicalCertificateMentalHealthActionOK).audits;
				...
				break;
			case modelAction.MedicalCertificateMentalHealthModelActionTypes.FETCH_MEDICAL_CERTIFICATE_MENTAL_HEALTH_WITH_QUERY_OK:
				const totalCountAfterFetchWithQuery = (action as modelAction.MedicalCertificateMentalHealthActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchWithQuery = (action as modelAction.MedicalCertificateMentalHealthActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchWithQuery = (action as modelAction.MedicalCertificateMentalHealthActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchWithQuery = (action as modelAction.MedicalCertificateMentalHealthActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchWithQuery.map(model => MedicalCertificateMentalHealthModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalCertificateMentalHealthModelActionTypes.FETCH_LAST_MEDICAL_CERTIFICATE_MENTAL_HEALTH_WITH_QUERY_OK:
				const totalCountAfterFetchLastWithQuery = (action as modelAction.MedicalCertificateMentalHealthActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchLastWithQuery = (action as modelAction.MedicalCertificateMentalHealthActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchLastWithQuery = (action as modelAction.MedicalCertificateMentalHealthActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchLastWithQuery = (action as modelAction.MedicalCertificateMentalHealthActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchLastWithQuery.map(model => MedicalCertificateMentalHealthModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalCertificateMentalHealthModelActionTypes.COUNT_MEDICAL_CERTIFICATE_MENTAL_HEALTHS_OK:
				const totalCountAfterCount = (action as modelAction.MedicalCertificateMentalHealthActionOK).stateConfig.totalCount;
				...
				break;
			case modelAction.MedicalCertificateMentalHealthModelActionTypes.INITIALISE_MEDICAL_CERTIFICATE_MENTAL_HEALTH_COLLECTION_STATE:
				const collectionIdToInitialise =  (action as modelAction.MedicalCertificateMentalHealthActionOK).stateConfig.collectionId;
				const queryParamsToInitialise = (action as modelAction.MedicalCertificateMentalHealthActionOK).stateConfig.queryParams;
				...
				if (!draft[className].collectionState[collectionIdToInitialise]) {
					draft[className].collectionState[collectionIdToInitialise] = {
						...initialMedicalCertificateMentalHealthCollectionState
					};
				}
