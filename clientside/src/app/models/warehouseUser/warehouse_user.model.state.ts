...
/**
 * WarehouseUserCollectionState would store the state of a collection of WarehouseUser
 */
export interface WarehouseUserCollectionState extends CollectionState {
 ...
 */
export interface WarehouseUserModelAudit extends AbstractModelAudit<WarehouseUserModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * WarehouseUserModelState would store the state of the model
 */
export interface WarehouseUserModelState {
	collectionState: {
		[key: string]: WarehouseUserCollectionState;
	};
	data: {
		[id: string]: WarehouseUserModel;
	};
	totalCount: number;
	audits: WarehouseUserModelAudit[];
 ...
 */
export const initialWarehouseUserCollectionState: WarehouseUserCollectionState = {
...
/**
 * The initial state of WarehouseUserModelState
 */
export const initialState: WarehouseUserModelState = {
	collectionState: {
