...
import * as modelAction from './warehouse_user.model.action';
import {WarehouseUserService} from '../../services/warehouseUser/warehouse_user.service';
...
/**
 * Effect class used for side effects related to Warehouse User model.
 */
@Injectable()
export class WarehouseUserEffect {
	...
	constructor(
		...
		protected readonly service: WarehouseUserService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseUserAction>(modelAction.WarehouseUserModelActionTypes.COUNT_WAREHOUSE_USERS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.WarehouseUserActionOK(
						modelAction.WarehouseUserModelActionTypes.COUNT_WAREHOUSE_USERS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseUserActionFail(
								modelAction.WarehouseUserModelActionTypes.COUNT_WAREHOUSE_USERS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseUserAction>(modelAction.WarehouseUserModelActionTypes.FETCH_WAREHOUSE_USER),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.WarehouseUserActionOK(
						modelAction.WarehouseUserModelActionTypes.FETCH_WAREHOUSE_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseUserActionFail(
								modelAction.WarehouseUserModelActionTypes.FETCH_WAREHOUSE_USER_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseUserAction>(modelAction.WarehouseUserModelActionTypes.FETCH_ALL_WAREHOUSE_USER),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.WarehouseUserActionOK(
						modelAction.WarehouseUserModelActionTypes.FETCH_ALL_WAREHOUSE_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseUserActionFail(
								modelAction.WarehouseUserModelActionTypes.FETCH_ALL_WAREHOUSE_USER_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseUserAction>(modelAction.WarehouseUserModelActionTypes.FETCH_WAREHOUSE_USER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.WarehouseUserActionOK(
						modelAction.WarehouseUserModelActionTypes.FETCH_WAREHOUSE_USER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseUserActionFail(
								modelAction.WarehouseUserModelActionTypes.FETCH_WAREHOUSE_USER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseUserAction>(modelAction.WarehouseUserModelActionTypes.FETCH_LAST_WAREHOUSE_USER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.WarehouseUserActionOK(
						modelAction.WarehouseUserModelActionTypes.FETCH_LAST_WAREHOUSE_USER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseUserActionFail(
								modelAction.WarehouseUserModelActionTypes.FETCH_LAST_WAREHOUSE_USER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseUserAction>(modelAction.WarehouseUserModelActionTypes.CREATE_WAREHOUSE_USER),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as WarehouseUserModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.WarehouseUserActionOK(
						modelAction.WarehouseUserModelActionTypes.CREATE_WAREHOUSE_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseUserActionFail(
								modelAction.WarehouseUserModelActionTypes.CREATE_WAREHOUSE_USER_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseUserAction>(modelAction.WarehouseUserModelActionTypes.CREATE_ALL_WAREHOUSE_USER),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as WarehouseUserModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.WarehouseUserActionOK(
						modelAction.WarehouseUserModelActionTypes.CREATE_ALL_WAREHOUSE_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseUserActionFail(
								modelAction.WarehouseUserModelActionTypes.CREATE_ALL_WAREHOUSE_USER_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseUserAction>(modelAction.WarehouseUserModelActionTypes.UPDATE_WAREHOUSE_USER),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as WarehouseUserModel;
				...
				return this.service.update(new WarehouseUserModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.WarehouseUserActionOK(
						modelAction.WarehouseUserModelActionTypes.UPDATE_WAREHOUSE_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseUserActionFail(
								modelAction.WarehouseUserModelActionTypes.UPDATE_WAREHOUSE_USER_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseUserAction>(modelAction.WarehouseUserModelActionTypes.UPDATE_ALL_WAREHOUSE_USER),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as WarehouseUserModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new WarehouseUserModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.WarehouseUserActionOK(
						modelAction.WarehouseUserModelActionTypes.UPDATE_ALL_WAREHOUSE_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseUserActionFail(
								modelAction.WarehouseUserModelActionTypes.UPDATE_ALL_WAREHOUSE_USER_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseUserAction>(modelAction.WarehouseUserModelActionTypes.DELETE_WAREHOUSE_USER),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.WarehouseUserActionOK(
						modelAction.WarehouseUserModelActionTypes.DELETE_WAREHOUSE_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseUserActionFail(
								modelAction.WarehouseUserModelActionTypes.DELETE_WAREHOUSE_USER_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseUserAction>(modelAction.WarehouseUserModelActionTypes.DELETE_WAREHOUSE_USER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.WarehouseUserActionOK(
						modelAction.WarehouseUserModelActionTypes.DELETE_WAREHOUSE_USER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseUserActionFail(
								modelAction.WarehouseUserModelActionTypes.DELETE_WAREHOUSE_USER_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseUserAction>(modelAction.WarehouseUserModelActionTypes.DELETE_ALL_WAREHOUSE_USER),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.WarehouseUserActionOK(
						modelAction.WarehouseUserModelActionTypes.DELETE_ALL_WAREHOUSE_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseUserActionFail(
								modelAction.WarehouseUserModelActionTypes.DELETE_ALL_WAREHOUSE_USER_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseUserAction>(modelAction.WarehouseUserModelActionTypes.EXPORT_WAREHOUSE_USER),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.WarehouseUserActionOK(
						modelAction.WarehouseUserModelActionTypes.EXPORT_WAREHOUSE_USER,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseUserAction>(modelAction.WarehouseUserModelActionTypes.EXPORT_ALL_WAREHOUSE_USER),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.WarehouseUserActionOK(
						modelAction.WarehouseUserModelActionTypes.EXPORT_ALL_WAREHOUSE_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseUserActionFail(
								modelAction.WarehouseUserModelActionTypes.EXPORT_ALL_WAREHOUSE_USER_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseUserAction>(modelAction.WarehouseUserModelActionTypes.EXPORT_WAREHOUSE_USER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.WarehouseUserActionOK(
						modelAction.WarehouseUserModelActionTypes.EXPORT_WAREHOUSE_USER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseUserActionFail(
								modelAction.WarehouseUserModelActionTypes.EXPORT_WAREHOUSE_USER_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseUserAction>(modelAction.WarehouseUserModelActionTypes.IMPORT_WAREHOUSE_USERS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.WarehouseUserActionOK(
						modelAction.WarehouseUserModelActionTypes.IMPORT_WAREHOUSE_USERS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseUserActionFail(
								modelAction.WarehouseUserModelActionTypes.IMPORT_WAREHOUSE_USERS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseUserAction>(modelAction.WarehouseUserModelActionTypes.FETCH_WAREHOUSE_USER_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.WarehouseUserActionOK(
						modelAction.WarehouseUserModelActionTypes.FETCH_WAREHOUSE_USER_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseUserActionFail(
								modelAction.WarehouseUserModelActionTypes.FETCH_WAREHOUSE_USER_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseUserAction>(modelAction.WarehouseUserModelActionTypes.FETCH_WAREHOUSE_USER_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.WarehouseUserActionOK(
						modelAction.WarehouseUserModelActionTypes.FETCH_WAREHOUSE_USER_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseUserActionFail(
								modelAction.WarehouseUserModelActionTypes.FETCH_WAREHOUSE_USER_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
