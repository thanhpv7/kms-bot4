...
import {initialBpjsINACBGClaimCollectionState} from './bpjs_inacbg_claim.model.state';
...
export function modelReducer(currentState: ModelState, action: Action): ModelState {
	...
	const className = (action as modelAction.BaseBpjsINACBGClaimAction).className;
	...
	return produce(currentState, draft => {
		...
		switch (action.type) {
			case modelAction.BpjsINACBGClaimModelActionTypes.CREATE_BPJS_INACBG_CLAIM_OK:
				const createdModel = (action as modelAction.BpjsINACBGClaimActionOK ).stateConfig.targetModel;
				...
				BpjsINACBGClaimModel.deepParse(createdModel).forEach(model => {
				...
				break;
			case modelAction.BpjsINACBGClaimModelActionTypes.CREATE_BPJS_INACBG_CLAIM_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.BpjsINACBGClaimModelActionTypes.CREATE_ALL_BPJS_INACBG_CLAIM_OK:
				const createdModels = (action as modelAction.BpjsINACBGClaimActionOK).stateConfig.targetModels;
				const collectionIdAfterCreateAll = (action as modelAction.BpjsINACBGClaimActionOK).stateConfig.collectionId;
				...
				createdModels.forEach((m) => {
					BpjsINACBGClaimModel.deepParse(m).forEach(model => {
						draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
						(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
					});
				});
				...
				break;
			case modelAction.BpjsINACBGClaimModelActionTypes.CREATE_ALL_BPJS_INACBG_CLAIM_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.BpjsINACBGClaimModelActionTypes.DELETE_BPJS_INACBG_CLAIM_OK:
				const deletedModelId = (action as modelAction.BpjsINACBGClaimActionOK).stateConfig.targetModelId;
				const collectionIdAfterDelete = (action as modelAction.BpjsINACBGClaimActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.BpjsINACBGClaimModelActionTypes.DELETE_ALL_BPJS_INACBG_CLAIM_OK:
				const deletedModelIds = (action as modelAction.BpjsINACBGClaimActionOK).stateConfig.targetModelIds;
				const collectionIdAfterDeleteAll = (action as modelAction.BpjsINACBGClaimActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.BpjsINACBGClaimModelActionTypes.DELETE_BPJS_INACBG_CLAIM_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.BpjsINACBGClaimModelActionTypes.UPDATE_BPJS_INACBG_CLAIM_OK:
				const updatedModel = (action as modelAction.BpjsINACBGClaimActionOK).stateConfig.targetModel;
				...
				BpjsINACBGClaimModel.deepParse(updatedModel).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.BpjsINACBGClaimModelActionTypes.UPDATE_BPJS_INACBG_CLAIM_FAIL:
				// TODO: Add handling of failure
				break;

			case modelAction.BpjsINACBGClaimModelActionTypes.UPDATE_ALL_BPJS_INACBG_CLAIM_OK:
				const updatedModels = (action as modelAction.BpjsINACBGClaimActionOK).stateConfig.targetModels;
				const collectionIdAfterUpdateAll = (action as modelAction.BpjsINACBGClaimActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.BpjsINACBGClaimModelActionTypes.UPDATE_ALL_BPJS_INACBG_CLAIM_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.BpjsINACBGClaimModelActionTypes.FETCH_BPJS_INACBG_CLAIM_OK:
				let fetchedModel = (action as modelAction.BpjsINACBGClaimActionOK).stateConfig.targetModel;
				...
				BpjsINACBGClaimModel.deepParse(fetchedModel).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.BpjsINACBGClaimModelActionTypes.FETCH_ALL_BPJS_INACBG_CLAIM_OK:
				const totalCountAfterFetchAll = (action as modelAction.BpjsINACBGClaimActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchAll = (action as modelAction.BpjsINACBGClaimActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchAll = (action as modelAction.BpjsINACBGClaimActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchAll = (action as modelAction.BpjsINACBGClaimActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchAll.map(model => BpjsINACBGClaimModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.BpjsINACBGClaimModelActionTypes.FETCH_BPJS_INACBG_CLAIM_AUDIT_OK:
				const audits = (action as modelAction.BpjsINACBGClaimActionOK).audits;
				...
				break;
			case modelAction.BpjsINACBGClaimModelActionTypes.FETCH_BPJS_INACBG_CLAIM_AUDITS_BY_ENTITY_ID_OK:
				const auditsByEntityId = (action as modelAction.BpjsINACBGClaimActionOK).audits;
				...
				break;
			case modelAction.BpjsINACBGClaimModelActionTypes.FETCH_BPJS_INACBG_CLAIM_WITH_QUERY_OK:
				const totalCountAfterFetchWithQuery = (action as modelAction.BpjsINACBGClaimActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchWithQuery = (action as modelAction.BpjsINACBGClaimActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchWithQuery = (action as modelAction.BpjsINACBGClaimActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchWithQuery = (action as modelAction.BpjsINACBGClaimActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchWithQuery.map(model => BpjsINACBGClaimModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.BpjsINACBGClaimModelActionTypes.FETCH_LAST_BPJS_INACBG_CLAIM_WITH_QUERY_OK:
				const totalCountAfterFetchLastWithQuery = (action as modelAction.BpjsINACBGClaimActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchLastWithQuery = (action as modelAction.BpjsINACBGClaimActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchLastWithQuery = (action as modelAction.BpjsINACBGClaimActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchLastWithQuery = (action as modelAction.BpjsINACBGClaimActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchLastWithQuery.map(model => BpjsINACBGClaimModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.BpjsINACBGClaimModelActionTypes.COUNT_BPJS_INACBG_CLAIMS_OK:
				const totalCountAfterCount = (action as modelAction.BpjsINACBGClaimActionOK).stateConfig.totalCount;
				...
				break;
			case modelAction.BpjsINACBGClaimModelActionTypes.INITIALISE_BPJS_INACBG_CLAIM_COLLECTION_STATE:
				const collectionIdToInitialise =  (action as modelAction.BpjsINACBGClaimActionOK).stateConfig.collectionId;
				const queryParamsToInitialise = (action as modelAction.BpjsINACBGClaimActionOK).stateConfig.queryParams;
				...
				if (!draft[className].collectionState[collectionIdToInitialise]) {
					draft[className].collectionState[collectionIdToInitialise] = {
						...initialBpjsINACBGClaimCollectionState
					};
				}
