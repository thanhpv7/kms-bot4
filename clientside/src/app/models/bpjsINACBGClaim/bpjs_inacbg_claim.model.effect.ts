...
import * as modelAction from './bpjs_inacbg_claim.model.action';
import {BpjsINACBGClaimService} from '../../services/bpjsINACBGClaim/bpjs_inacbg_claim.service';
...
/**
 * Effect class used for side effects related to BPJS INACBG Claim model.
 */
@Injectable()
export class BpjsINACBGClaimEffect {
	...
	constructor(
		...
		protected readonly service: BpjsINACBGClaimService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGClaimAction>(modelAction.BpjsINACBGClaimModelActionTypes.COUNT_BPJS_INACBG_CLAIMS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsINACBGClaimActionOK(
						modelAction.BpjsINACBGClaimModelActionTypes.COUNT_BPJS_INACBG_CLAIMS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGClaimActionFail(
								modelAction.BpjsINACBGClaimModelActionTypes.COUNT_BPJS_INACBG_CLAIMS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGClaimAction>(modelAction.BpjsINACBGClaimModelActionTypes.FETCH_BPJS_INACBG_CLAIM),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsINACBGClaimActionOK(
						modelAction.BpjsINACBGClaimModelActionTypes.FETCH_BPJS_INACBG_CLAIM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGClaimActionFail(
								modelAction.BpjsINACBGClaimModelActionTypes.FETCH_BPJS_INACBG_CLAIM_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGClaimAction>(modelAction.BpjsINACBGClaimModelActionTypes.FETCH_ALL_BPJS_INACBG_CLAIM),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsINACBGClaimActionOK(
						modelAction.BpjsINACBGClaimModelActionTypes.FETCH_ALL_BPJS_INACBG_CLAIM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGClaimActionFail(
								modelAction.BpjsINACBGClaimModelActionTypes.FETCH_ALL_BPJS_INACBG_CLAIM_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGClaimAction>(modelAction.BpjsINACBGClaimModelActionTypes.FETCH_BPJS_INACBG_CLAIM_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsINACBGClaimActionOK(
						modelAction.BpjsINACBGClaimModelActionTypes.FETCH_BPJS_INACBG_CLAIM_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGClaimActionFail(
								modelAction.BpjsINACBGClaimModelActionTypes.FETCH_BPJS_INACBG_CLAIM_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGClaimAction>(modelAction.BpjsINACBGClaimModelActionTypes.FETCH_LAST_BPJS_INACBG_CLAIM_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsINACBGClaimActionOK(
						modelAction.BpjsINACBGClaimModelActionTypes.FETCH_LAST_BPJS_INACBG_CLAIM_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGClaimActionFail(
								modelAction.BpjsINACBGClaimModelActionTypes.FETCH_LAST_BPJS_INACBG_CLAIM_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGClaimAction>(modelAction.BpjsINACBGClaimModelActionTypes.CREATE_BPJS_INACBG_CLAIM),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsINACBGClaimModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsINACBGClaimActionOK(
						modelAction.BpjsINACBGClaimModelActionTypes.CREATE_BPJS_INACBG_CLAIM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGClaimActionFail(
								modelAction.BpjsINACBGClaimModelActionTypes.CREATE_BPJS_INACBG_CLAIM_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGClaimAction>(modelAction.BpjsINACBGClaimModelActionTypes.CREATE_ALL_BPJS_INACBG_CLAIM),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsINACBGClaimModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsINACBGClaimActionOK(
						modelAction.BpjsINACBGClaimModelActionTypes.CREATE_ALL_BPJS_INACBG_CLAIM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGClaimActionFail(
								modelAction.BpjsINACBGClaimModelActionTypes.CREATE_ALL_BPJS_INACBG_CLAIM_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGClaimAction>(modelAction.BpjsINACBGClaimModelActionTypes.UPDATE_BPJS_INACBG_CLAIM),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsINACBGClaimModel;
				...
				return this.service.update(new BpjsINACBGClaimModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsINACBGClaimActionOK(
						modelAction.BpjsINACBGClaimModelActionTypes.UPDATE_BPJS_INACBG_CLAIM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGClaimActionFail(
								modelAction.BpjsINACBGClaimModelActionTypes.UPDATE_BPJS_INACBG_CLAIM_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGClaimAction>(modelAction.BpjsINACBGClaimModelActionTypes.UPDATE_ALL_BPJS_INACBG_CLAIM),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsINACBGClaimModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsINACBGClaimModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsINACBGClaimActionOK(
						modelAction.BpjsINACBGClaimModelActionTypes.UPDATE_ALL_BPJS_INACBG_CLAIM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGClaimActionFail(
								modelAction.BpjsINACBGClaimModelActionTypes.UPDATE_ALL_BPJS_INACBG_CLAIM_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGClaimAction>(modelAction.BpjsINACBGClaimModelActionTypes.DELETE_BPJS_INACBG_CLAIM),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsINACBGClaimActionOK(
						modelAction.BpjsINACBGClaimModelActionTypes.DELETE_BPJS_INACBG_CLAIM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGClaimActionFail(
								modelAction.BpjsINACBGClaimModelActionTypes.DELETE_BPJS_INACBG_CLAIM_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGClaimAction>(modelAction.BpjsINACBGClaimModelActionTypes.DELETE_BPJS_INACBG_CLAIM_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsINACBGClaimActionOK(
						modelAction.BpjsINACBGClaimModelActionTypes.DELETE_BPJS_INACBG_CLAIM_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGClaimActionFail(
								modelAction.BpjsINACBGClaimModelActionTypes.DELETE_BPJS_INACBG_CLAIM_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGClaimAction>(modelAction.BpjsINACBGClaimModelActionTypes.DELETE_ALL_BPJS_INACBG_CLAIM),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsINACBGClaimActionOK(
						modelAction.BpjsINACBGClaimModelActionTypes.DELETE_ALL_BPJS_INACBG_CLAIM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGClaimActionFail(
								modelAction.BpjsINACBGClaimModelActionTypes.DELETE_ALL_BPJS_INACBG_CLAIM_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGClaimAction>(modelAction.BpjsINACBGClaimModelActionTypes.EXPORT_BPJS_INACBG_CLAIM),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsINACBGClaimActionOK(
						modelAction.BpjsINACBGClaimModelActionTypes.EXPORT_BPJS_INACBG_CLAIM,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGClaimAction>(modelAction.BpjsINACBGClaimModelActionTypes.EXPORT_ALL_BPJS_INACBG_CLAIM),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsINACBGClaimActionOK(
						modelAction.BpjsINACBGClaimModelActionTypes.EXPORT_ALL_BPJS_INACBG_CLAIM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGClaimActionFail(
								modelAction.BpjsINACBGClaimModelActionTypes.EXPORT_ALL_BPJS_INACBG_CLAIM_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGClaimAction>(modelAction.BpjsINACBGClaimModelActionTypes.EXPORT_BPJS_INACBG_CLAIM_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsINACBGClaimActionOK(
						modelAction.BpjsINACBGClaimModelActionTypes.EXPORT_BPJS_INACBG_CLAIM_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGClaimActionFail(
								modelAction.BpjsINACBGClaimModelActionTypes.EXPORT_BPJS_INACBG_CLAIM_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGClaimAction>(modelAction.BpjsINACBGClaimModelActionTypes.IMPORT_BPJS_INACBG_CLAIMS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsINACBGClaimActionOK(
						modelAction.BpjsINACBGClaimModelActionTypes.IMPORT_BPJS_INACBG_CLAIMS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGClaimActionFail(
								modelAction.BpjsINACBGClaimModelActionTypes.IMPORT_BPJS_INACBG_CLAIMS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGClaimAction>(modelAction.BpjsINACBGClaimModelActionTypes.FETCH_BPJS_INACBG_CLAIM_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsINACBGClaimActionOK(
						modelAction.BpjsINACBGClaimModelActionTypes.FETCH_BPJS_INACBG_CLAIM_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGClaimActionFail(
								modelAction.BpjsINACBGClaimModelActionTypes.FETCH_BPJS_INACBG_CLAIM_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsINACBGClaimAction>(modelAction.BpjsINACBGClaimModelActionTypes.FETCH_BPJS_INACBG_CLAIM_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsINACBGClaimActionOK(
						modelAction.BpjsINACBGClaimModelActionTypes.FETCH_BPJS_INACBG_CLAIM_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsINACBGClaimActionFail(
								modelAction.BpjsINACBGClaimModelActionTypes.FETCH_BPJS_INACBG_CLAIM_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
