...
/**
 * BpjsINACBGClaimCollectionState would store the state of a collection of BpjsINACBGClaim
 */
export interface BpjsINACBGClaimCollectionState extends CollectionState {
 ...
 */
export interface BpjsINACBGClaimModelAudit extends AbstractModelAudit<BpjsINACBGClaimModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsINACBGClaimModelState would store the state of the model
 */
export interface BpjsINACBGClaimModelState {
	collectionState: {
		[key: string]: BpjsINACBGClaimCollectionState;
	};
	data: {
		[id: string]: BpjsINACBGClaimModel;
	};
	totalCount: number;
	audits: BpjsINACBGClaimModelAudit[];
 ...
 */
export const initialBpjsINACBGClaimCollectionState: BpjsINACBGClaimCollectionState = {
...
/**
 * The initial state of BpjsINACBGClaimModelState
 */
export const initialState: BpjsINACBGClaimModelState = {
	collectionState: {
