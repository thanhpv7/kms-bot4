...
/**
 * PcareStatusPulangCollectionState would store the state of a collection of PcareStatusPulang
 */
export interface PcareStatusPulangCollectionState extends CollectionState {
 ...
 */
export interface PcareStatusPulangModelAudit extends AbstractModelAudit<PcareStatusPulangModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * PcareStatusPulangModelState would store the state of the model
 */
export interface PcareStatusPulangModelState {
	collectionState: {
		[key: string]: PcareStatusPulangCollectionState;
	};
	data: {
		[id: string]: PcareStatusPulangModel;
	};
	totalCount: number;
	audits: PcareStatusPulangModelAudit[];
 ...
 */
export const initialPcareStatusPulangCollectionState: PcareStatusPulangCollectionState = {
...
/**
 * The initial state of PcareStatusPulangModelState
 */
export const initialState: PcareStatusPulangModelState = {
	collectionState: {
