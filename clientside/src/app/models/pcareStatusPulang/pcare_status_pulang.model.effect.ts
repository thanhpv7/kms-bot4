...
import * as modelAction from './pcare_status_pulang.model.action';
import {PcareStatusPulangService} from '../../services/pcareStatusPulang/pcare_status_pulang.service';
...
/**
 * Effect class used for side effects related to PCare Status Pulang model.
 */
@Injectable()
export class PcareStatusPulangEffect {
	...
	constructor(
		...
		protected readonly service: PcareStatusPulangService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareStatusPulangAction>(modelAction.PcareStatusPulangModelActionTypes.COUNT_PCARE_STATUS_PULANGS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.PcareStatusPulangActionOK(
						modelAction.PcareStatusPulangModelActionTypes.COUNT_PCARE_STATUS_PULANGS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareStatusPulangActionFail(
								modelAction.PcareStatusPulangModelActionTypes.COUNT_PCARE_STATUS_PULANGS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareStatusPulangAction>(modelAction.PcareStatusPulangModelActionTypes.FETCH_PCARE_STATUS_PULANG),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareStatusPulangActionOK(
						modelAction.PcareStatusPulangModelActionTypes.FETCH_PCARE_STATUS_PULANG_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareStatusPulangActionFail(
								modelAction.PcareStatusPulangModelActionTypes.FETCH_PCARE_STATUS_PULANG_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareStatusPulangAction>(modelAction.PcareStatusPulangModelActionTypes.FETCH_ALL_PCARE_STATUS_PULANG),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.PcareStatusPulangActionOK(
						modelAction.PcareStatusPulangModelActionTypes.FETCH_ALL_PCARE_STATUS_PULANG_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareStatusPulangActionFail(
								modelAction.PcareStatusPulangModelActionTypes.FETCH_ALL_PCARE_STATUS_PULANG_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareStatusPulangAction>(modelAction.PcareStatusPulangModelActionTypes.FETCH_PCARE_STATUS_PULANG_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareStatusPulangActionOK(
						modelAction.PcareStatusPulangModelActionTypes.FETCH_PCARE_STATUS_PULANG_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareStatusPulangActionFail(
								modelAction.PcareStatusPulangModelActionTypes.FETCH_PCARE_STATUS_PULANG_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareStatusPulangAction>(modelAction.PcareStatusPulangModelActionTypes.FETCH_LAST_PCARE_STATUS_PULANG_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareStatusPulangActionOK(
						modelAction.PcareStatusPulangModelActionTypes.FETCH_LAST_PCARE_STATUS_PULANG_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareStatusPulangActionFail(
								modelAction.PcareStatusPulangModelActionTypes.FETCH_LAST_PCARE_STATUS_PULANG_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareStatusPulangAction>(modelAction.PcareStatusPulangModelActionTypes.CREATE_PCARE_STATUS_PULANG),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as PcareStatusPulangModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareStatusPulangActionOK(
						modelAction.PcareStatusPulangModelActionTypes.CREATE_PCARE_STATUS_PULANG_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareStatusPulangActionFail(
								modelAction.PcareStatusPulangModelActionTypes.CREATE_PCARE_STATUS_PULANG_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareStatusPulangAction>(modelAction.PcareStatusPulangModelActionTypes.CREATE_ALL_PCARE_STATUS_PULANG),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as PcareStatusPulangModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareStatusPulangActionOK(
						modelAction.PcareStatusPulangModelActionTypes.CREATE_ALL_PCARE_STATUS_PULANG_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareStatusPulangActionFail(
								modelAction.PcareStatusPulangModelActionTypes.CREATE_ALL_PCARE_STATUS_PULANG_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareStatusPulangAction>(modelAction.PcareStatusPulangModelActionTypes.UPDATE_PCARE_STATUS_PULANG),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as PcareStatusPulangModel;
				...
				return this.service.update(new PcareStatusPulangModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareStatusPulangActionOK(
						modelAction.PcareStatusPulangModelActionTypes.UPDATE_PCARE_STATUS_PULANG_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareStatusPulangActionFail(
								modelAction.PcareStatusPulangModelActionTypes.UPDATE_PCARE_STATUS_PULANG_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareStatusPulangAction>(modelAction.PcareStatusPulangModelActionTypes.UPDATE_ALL_PCARE_STATUS_PULANG),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as PcareStatusPulangModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new PcareStatusPulangModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareStatusPulangActionOK(
						modelAction.PcareStatusPulangModelActionTypes.UPDATE_ALL_PCARE_STATUS_PULANG_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareStatusPulangActionFail(
								modelAction.PcareStatusPulangModelActionTypes.UPDATE_ALL_PCARE_STATUS_PULANG_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareStatusPulangAction>(modelAction.PcareStatusPulangModelActionTypes.DELETE_PCARE_STATUS_PULANG),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PcareStatusPulangActionOK(
						modelAction.PcareStatusPulangModelActionTypes.DELETE_PCARE_STATUS_PULANG_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareStatusPulangActionFail(
								modelAction.PcareStatusPulangModelActionTypes.DELETE_PCARE_STATUS_PULANG_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareStatusPulangAction>(modelAction.PcareStatusPulangModelActionTypes.DELETE_PCARE_STATUS_PULANG_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.PcareStatusPulangActionOK(
						modelAction.PcareStatusPulangModelActionTypes.DELETE_PCARE_STATUS_PULANG_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareStatusPulangActionFail(
								modelAction.PcareStatusPulangModelActionTypes.DELETE_PCARE_STATUS_PULANG_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareStatusPulangAction>(modelAction.PcareStatusPulangModelActionTypes.DELETE_ALL_PCARE_STATUS_PULANG),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PcareStatusPulangActionOK(
						modelAction.PcareStatusPulangModelActionTypes.DELETE_ALL_PCARE_STATUS_PULANG_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareStatusPulangActionFail(
								modelAction.PcareStatusPulangModelActionTypes.DELETE_ALL_PCARE_STATUS_PULANG_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareStatusPulangAction>(modelAction.PcareStatusPulangModelActionTypes.EXPORT_PCARE_STATUS_PULANG),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PcareStatusPulangActionOK(
						modelAction.PcareStatusPulangModelActionTypes.EXPORT_PCARE_STATUS_PULANG,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareStatusPulangAction>(modelAction.PcareStatusPulangModelActionTypes.EXPORT_ALL_PCARE_STATUS_PULANG),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PcareStatusPulangActionOK(
						modelAction.PcareStatusPulangModelActionTypes.EXPORT_ALL_PCARE_STATUS_PULANG_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareStatusPulangActionFail(
								modelAction.PcareStatusPulangModelActionTypes.EXPORT_ALL_PCARE_STATUS_PULANG_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareStatusPulangAction>(modelAction.PcareStatusPulangModelActionTypes.EXPORT_PCARE_STATUS_PULANG_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PcareStatusPulangActionOK(
						modelAction.PcareStatusPulangModelActionTypes.EXPORT_PCARE_STATUS_PULANG_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareStatusPulangActionFail(
								modelAction.PcareStatusPulangModelActionTypes.EXPORT_PCARE_STATUS_PULANG_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareStatusPulangAction>(modelAction.PcareStatusPulangModelActionTypes.IMPORT_PCARE_STATUS_PULANGS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.PcareStatusPulangActionOK(
						modelAction.PcareStatusPulangModelActionTypes.IMPORT_PCARE_STATUS_PULANGS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareStatusPulangActionFail(
								modelAction.PcareStatusPulangModelActionTypes.IMPORT_PCARE_STATUS_PULANGS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareStatusPulangAction>(modelAction.PcareStatusPulangModelActionTypes.FETCH_PCARE_STATUS_PULANG_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.PcareStatusPulangActionOK(
						modelAction.PcareStatusPulangModelActionTypes.FETCH_PCARE_STATUS_PULANG_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PcareStatusPulangActionFail(
								modelAction.PcareStatusPulangModelActionTypes.FETCH_PCARE_STATUS_PULANG_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareStatusPulangAction>(modelAction.PcareStatusPulangModelActionTypes.FETCH_PCARE_STATUS_PULANG_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.PcareStatusPulangActionOK(
						modelAction.PcareStatusPulangModelActionTypes.FETCH_PCARE_STATUS_PULANG_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PcareStatusPulangActionFail(
								modelAction.PcareStatusPulangModelActionTypes.FETCH_PCARE_STATUS_PULANG_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
