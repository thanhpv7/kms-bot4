...
/**
 * SupplierBankAccountCollectionState would store the state of a collection of SupplierBankAccount
 */
export interface SupplierBankAccountCollectionState extends CollectionState {
 ...
 */
export interface SupplierBankAccountModelAudit extends AbstractModelAudit<SupplierBankAccountModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * SupplierBankAccountModelState would store the state of the model
 */
export interface SupplierBankAccountModelState {
	collectionState: {
		[key: string]: SupplierBankAccountCollectionState;
	};
	data: {
		[id: string]: SupplierBankAccountModel;
	};
	totalCount: number;
	audits: SupplierBankAccountModelAudit[];
 ...
 */
export const initialSupplierBankAccountCollectionState: SupplierBankAccountCollectionState = {
...
/**
 * The initial state of SupplierBankAccountModelState
 */
export const initialState: SupplierBankAccountModelState = {
	collectionState: {
