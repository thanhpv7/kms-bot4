...
import * as modelAction from './supplier_bank_account.model.action';
import {SupplierBankAccountService} from '../../services/supplierBankAccount/supplier_bank_account.service';
...
/**
 * Effect class used for side effects related to Supplier Bank Account model.
 */
@Injectable()
export class SupplierBankAccountEffect {
	...
	constructor(
		...
		protected readonly service: SupplierBankAccountService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierBankAccountAction>(modelAction.SupplierBankAccountModelActionTypes.COUNT_SUPPLIER_BANK_ACCOUNTS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.SupplierBankAccountActionOK(
						modelAction.SupplierBankAccountModelActionTypes.COUNT_SUPPLIER_BANK_ACCOUNTS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SupplierBankAccountActionFail(
								modelAction.SupplierBankAccountModelActionTypes.COUNT_SUPPLIER_BANK_ACCOUNTS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierBankAccountAction>(modelAction.SupplierBankAccountModelActionTypes.FETCH_SUPPLIER_BANK_ACCOUNT),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.SupplierBankAccountActionOK(
						modelAction.SupplierBankAccountModelActionTypes.FETCH_SUPPLIER_BANK_ACCOUNT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SupplierBankAccountActionFail(
								modelAction.SupplierBankAccountModelActionTypes.FETCH_SUPPLIER_BANK_ACCOUNT_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierBankAccountAction>(modelAction.SupplierBankAccountModelActionTypes.FETCH_ALL_SUPPLIER_BANK_ACCOUNT),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.SupplierBankAccountActionOK(
						modelAction.SupplierBankAccountModelActionTypes.FETCH_ALL_SUPPLIER_BANK_ACCOUNT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SupplierBankAccountActionFail(
								modelAction.SupplierBankAccountModelActionTypes.FETCH_ALL_SUPPLIER_BANK_ACCOUNT_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierBankAccountAction>(modelAction.SupplierBankAccountModelActionTypes.FETCH_SUPPLIER_BANK_ACCOUNT_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.SupplierBankAccountActionOK(
						modelAction.SupplierBankAccountModelActionTypes.FETCH_SUPPLIER_BANK_ACCOUNT_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SupplierBankAccountActionFail(
								modelAction.SupplierBankAccountModelActionTypes.FETCH_SUPPLIER_BANK_ACCOUNT_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierBankAccountAction>(modelAction.SupplierBankAccountModelActionTypes.FETCH_LAST_SUPPLIER_BANK_ACCOUNT_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.SupplierBankAccountActionOK(
						modelAction.SupplierBankAccountModelActionTypes.FETCH_LAST_SUPPLIER_BANK_ACCOUNT_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SupplierBankAccountActionFail(
								modelAction.SupplierBankAccountModelActionTypes.FETCH_LAST_SUPPLIER_BANK_ACCOUNT_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierBankAccountAction>(modelAction.SupplierBankAccountModelActionTypes.CREATE_SUPPLIER_BANK_ACCOUNT),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as SupplierBankAccountModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.SupplierBankAccountActionOK(
						modelAction.SupplierBankAccountModelActionTypes.CREATE_SUPPLIER_BANK_ACCOUNT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SupplierBankAccountActionFail(
								modelAction.SupplierBankAccountModelActionTypes.CREATE_SUPPLIER_BANK_ACCOUNT_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierBankAccountAction>(modelAction.SupplierBankAccountModelActionTypes.CREATE_ALL_SUPPLIER_BANK_ACCOUNT),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as SupplierBankAccountModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.SupplierBankAccountActionOK(
						modelAction.SupplierBankAccountModelActionTypes.CREATE_ALL_SUPPLIER_BANK_ACCOUNT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SupplierBankAccountActionFail(
								modelAction.SupplierBankAccountModelActionTypes.CREATE_ALL_SUPPLIER_BANK_ACCOUNT_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierBankAccountAction>(modelAction.SupplierBankAccountModelActionTypes.UPDATE_SUPPLIER_BANK_ACCOUNT),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as SupplierBankAccountModel;
				...
				return this.service.update(new SupplierBankAccountModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.SupplierBankAccountActionOK(
						modelAction.SupplierBankAccountModelActionTypes.UPDATE_SUPPLIER_BANK_ACCOUNT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SupplierBankAccountActionFail(
								modelAction.SupplierBankAccountModelActionTypes.UPDATE_SUPPLIER_BANK_ACCOUNT_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierBankAccountAction>(modelAction.SupplierBankAccountModelActionTypes.UPDATE_ALL_SUPPLIER_BANK_ACCOUNT),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as SupplierBankAccountModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new SupplierBankAccountModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.SupplierBankAccountActionOK(
						modelAction.SupplierBankAccountModelActionTypes.UPDATE_ALL_SUPPLIER_BANK_ACCOUNT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SupplierBankAccountActionFail(
								modelAction.SupplierBankAccountModelActionTypes.UPDATE_ALL_SUPPLIER_BANK_ACCOUNT_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierBankAccountAction>(modelAction.SupplierBankAccountModelActionTypes.DELETE_SUPPLIER_BANK_ACCOUNT),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.SupplierBankAccountActionOK(
						modelAction.SupplierBankAccountModelActionTypes.DELETE_SUPPLIER_BANK_ACCOUNT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SupplierBankAccountActionFail(
								modelAction.SupplierBankAccountModelActionTypes.DELETE_SUPPLIER_BANK_ACCOUNT_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierBankAccountAction>(modelAction.SupplierBankAccountModelActionTypes.DELETE_SUPPLIER_BANK_ACCOUNT_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.SupplierBankAccountActionOK(
						modelAction.SupplierBankAccountModelActionTypes.DELETE_SUPPLIER_BANK_ACCOUNT_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SupplierBankAccountActionFail(
								modelAction.SupplierBankAccountModelActionTypes.DELETE_SUPPLIER_BANK_ACCOUNT_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierBankAccountAction>(modelAction.SupplierBankAccountModelActionTypes.DELETE_ALL_SUPPLIER_BANK_ACCOUNT),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.SupplierBankAccountActionOK(
						modelAction.SupplierBankAccountModelActionTypes.DELETE_ALL_SUPPLIER_BANK_ACCOUNT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SupplierBankAccountActionFail(
								modelAction.SupplierBankAccountModelActionTypes.DELETE_ALL_SUPPLIER_BANK_ACCOUNT_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierBankAccountAction>(modelAction.SupplierBankAccountModelActionTypes.EXPORT_SUPPLIER_BANK_ACCOUNT),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.SupplierBankAccountActionOK(
						modelAction.SupplierBankAccountModelActionTypes.EXPORT_SUPPLIER_BANK_ACCOUNT,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierBankAccountAction>(modelAction.SupplierBankAccountModelActionTypes.EXPORT_ALL_SUPPLIER_BANK_ACCOUNT),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.SupplierBankAccountActionOK(
						modelAction.SupplierBankAccountModelActionTypes.EXPORT_ALL_SUPPLIER_BANK_ACCOUNT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SupplierBankAccountActionFail(
								modelAction.SupplierBankAccountModelActionTypes.EXPORT_ALL_SUPPLIER_BANK_ACCOUNT_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierBankAccountAction>(modelAction.SupplierBankAccountModelActionTypes.EXPORT_SUPPLIER_BANK_ACCOUNT_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.SupplierBankAccountActionOK(
						modelAction.SupplierBankAccountModelActionTypes.EXPORT_SUPPLIER_BANK_ACCOUNT_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SupplierBankAccountActionFail(
								modelAction.SupplierBankAccountModelActionTypes.EXPORT_SUPPLIER_BANK_ACCOUNT_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierBankAccountAction>(modelAction.SupplierBankAccountModelActionTypes.IMPORT_SUPPLIER_BANK_ACCOUNTS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.SupplierBankAccountActionOK(
						modelAction.SupplierBankAccountModelActionTypes.IMPORT_SUPPLIER_BANK_ACCOUNTS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SupplierBankAccountActionFail(
								modelAction.SupplierBankAccountModelActionTypes.IMPORT_SUPPLIER_BANK_ACCOUNTS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierBankAccountAction>(modelAction.SupplierBankAccountModelActionTypes.FETCH_SUPPLIER_BANK_ACCOUNT_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.SupplierBankAccountActionOK(
						modelAction.SupplierBankAccountModelActionTypes.FETCH_SUPPLIER_BANK_ACCOUNT_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.SupplierBankAccountActionFail(
								modelAction.SupplierBankAccountModelActionTypes.FETCH_SUPPLIER_BANK_ACCOUNT_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierBankAccountAction>(modelAction.SupplierBankAccountModelActionTypes.FETCH_SUPPLIER_BANK_ACCOUNT_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.SupplierBankAccountActionOK(
						modelAction.SupplierBankAccountModelActionTypes.FETCH_SUPPLIER_BANK_ACCOUNT_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.SupplierBankAccountActionFail(
								modelAction.SupplierBankAccountModelActionTypes.FETCH_SUPPLIER_BANK_ACCOUNT_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
