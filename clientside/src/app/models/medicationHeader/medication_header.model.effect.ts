...
import * as modelAction from './medication_header.model.action';
import {MedicationHeaderService} from '../../services/medicationHeader/medication_header.service';
...
/**
 * Effect class used for side effects related to Medication Header model.
 */
@Injectable()
export class MedicationHeaderEffect {
	...
	constructor(
		...
		protected readonly service: MedicationHeaderService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationHeaderAction>(modelAction.MedicationHeaderModelActionTypes.COUNT_MEDICATION_HEADERS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.MedicationHeaderActionOK(
						modelAction.MedicationHeaderModelActionTypes.COUNT_MEDICATION_HEADERS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationHeaderActionFail(
								modelAction.MedicationHeaderModelActionTypes.COUNT_MEDICATION_HEADERS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationHeaderAction>(modelAction.MedicationHeaderModelActionTypes.FETCH_MEDICATION_HEADER),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicationHeaderActionOK(
						modelAction.MedicationHeaderModelActionTypes.FETCH_MEDICATION_HEADER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationHeaderActionFail(
								modelAction.MedicationHeaderModelActionTypes.FETCH_MEDICATION_HEADER_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationHeaderAction>(modelAction.MedicationHeaderModelActionTypes.FETCH_ALL_MEDICATION_HEADER),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.MedicationHeaderActionOK(
						modelAction.MedicationHeaderModelActionTypes.FETCH_ALL_MEDICATION_HEADER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationHeaderActionFail(
								modelAction.MedicationHeaderModelActionTypes.FETCH_ALL_MEDICATION_HEADER_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationHeaderAction>(modelAction.MedicationHeaderModelActionTypes.FETCH_MEDICATION_HEADER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicationHeaderActionOK(
						modelAction.MedicationHeaderModelActionTypes.FETCH_MEDICATION_HEADER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationHeaderActionFail(
								modelAction.MedicationHeaderModelActionTypes.FETCH_MEDICATION_HEADER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationHeaderAction>(modelAction.MedicationHeaderModelActionTypes.FETCH_LAST_MEDICATION_HEADER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicationHeaderActionOK(
						modelAction.MedicationHeaderModelActionTypes.FETCH_LAST_MEDICATION_HEADER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationHeaderActionFail(
								modelAction.MedicationHeaderModelActionTypes.FETCH_LAST_MEDICATION_HEADER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationHeaderAction>(modelAction.MedicationHeaderModelActionTypes.CREATE_MEDICATION_HEADER),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as MedicationHeaderModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicationHeaderActionOK(
						modelAction.MedicationHeaderModelActionTypes.CREATE_MEDICATION_HEADER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationHeaderActionFail(
								modelAction.MedicationHeaderModelActionTypes.CREATE_MEDICATION_HEADER_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationHeaderAction>(modelAction.MedicationHeaderModelActionTypes.CREATE_ALL_MEDICATION_HEADER),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as MedicationHeaderModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicationHeaderActionOK(
						modelAction.MedicationHeaderModelActionTypes.CREATE_ALL_MEDICATION_HEADER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationHeaderActionFail(
								modelAction.MedicationHeaderModelActionTypes.CREATE_ALL_MEDICATION_HEADER_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationHeaderAction>(modelAction.MedicationHeaderModelActionTypes.UPDATE_MEDICATION_HEADER),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as MedicationHeaderModel;
				...
				return this.service.update(new MedicationHeaderModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicationHeaderActionOK(
						modelAction.MedicationHeaderModelActionTypes.UPDATE_MEDICATION_HEADER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationHeaderActionFail(
								modelAction.MedicationHeaderModelActionTypes.UPDATE_MEDICATION_HEADER_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationHeaderAction>(modelAction.MedicationHeaderModelActionTypes.UPDATE_ALL_MEDICATION_HEADER),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as MedicationHeaderModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new MedicationHeaderModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicationHeaderActionOK(
						modelAction.MedicationHeaderModelActionTypes.UPDATE_ALL_MEDICATION_HEADER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationHeaderActionFail(
								modelAction.MedicationHeaderModelActionTypes.UPDATE_ALL_MEDICATION_HEADER_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationHeaderAction>(modelAction.MedicationHeaderModelActionTypes.DELETE_MEDICATION_HEADER),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.MedicationHeaderActionOK(
						modelAction.MedicationHeaderModelActionTypes.DELETE_MEDICATION_HEADER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationHeaderActionFail(
								modelAction.MedicationHeaderModelActionTypes.DELETE_MEDICATION_HEADER_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationHeaderAction>(modelAction.MedicationHeaderModelActionTypes.DELETE_MEDICATION_HEADER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.MedicationHeaderActionOK(
						modelAction.MedicationHeaderModelActionTypes.DELETE_MEDICATION_HEADER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationHeaderActionFail(
								modelAction.MedicationHeaderModelActionTypes.DELETE_MEDICATION_HEADER_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationHeaderAction>(modelAction.MedicationHeaderModelActionTypes.DELETE_ALL_MEDICATION_HEADER),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.MedicationHeaderActionOK(
						modelAction.MedicationHeaderModelActionTypes.DELETE_ALL_MEDICATION_HEADER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationHeaderActionFail(
								modelAction.MedicationHeaderModelActionTypes.DELETE_ALL_MEDICATION_HEADER_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationHeaderAction>(modelAction.MedicationHeaderModelActionTypes.EXPORT_MEDICATION_HEADER),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicationHeaderActionOK(
						modelAction.MedicationHeaderModelActionTypes.EXPORT_MEDICATION_HEADER,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationHeaderAction>(modelAction.MedicationHeaderModelActionTypes.EXPORT_ALL_MEDICATION_HEADER),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicationHeaderActionOK(
						modelAction.MedicationHeaderModelActionTypes.EXPORT_ALL_MEDICATION_HEADER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationHeaderActionFail(
								modelAction.MedicationHeaderModelActionTypes.EXPORT_ALL_MEDICATION_HEADER_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationHeaderAction>(modelAction.MedicationHeaderModelActionTypes.EXPORT_MEDICATION_HEADER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicationHeaderActionOK(
						modelAction.MedicationHeaderModelActionTypes.EXPORT_MEDICATION_HEADER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationHeaderActionFail(
								modelAction.MedicationHeaderModelActionTypes.EXPORT_MEDICATION_HEADER_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationHeaderAction>(modelAction.MedicationHeaderModelActionTypes.IMPORT_MEDICATION_HEADERS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.MedicationHeaderActionOK(
						modelAction.MedicationHeaderModelActionTypes.IMPORT_MEDICATION_HEADERS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationHeaderActionFail(
								modelAction.MedicationHeaderModelActionTypes.IMPORT_MEDICATION_HEADERS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationHeaderAction>(modelAction.MedicationHeaderModelActionTypes.FETCH_MEDICATION_HEADER_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.MedicationHeaderActionOK(
						modelAction.MedicationHeaderModelActionTypes.FETCH_MEDICATION_HEADER_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.MedicationHeaderActionFail(
								modelAction.MedicationHeaderModelActionTypes.FETCH_MEDICATION_HEADER_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationHeaderAction>(modelAction.MedicationHeaderModelActionTypes.FETCH_MEDICATION_HEADER_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.MedicationHeaderActionOK(
						modelAction.MedicationHeaderModelActionTypes.FETCH_MEDICATION_HEADER_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.MedicationHeaderActionFail(
								modelAction.MedicationHeaderModelActionTypes.FETCH_MEDICATION_HEADER_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
