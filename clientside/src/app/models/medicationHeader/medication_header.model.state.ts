...
/**
 * MedicationHeaderCollectionState would store the state of a collection of MedicationHeader
 */
export interface MedicationHeaderCollectionState extends CollectionState {
 ...
 */
export interface MedicationHeaderModelAudit extends AbstractModelAudit<MedicationHeaderModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * MedicationHeaderModelState would store the state of the model
 */
export interface MedicationHeaderModelState {
	collectionState: {
		[key: string]: MedicationHeaderCollectionState;
	};
	data: {
		[id: string]: MedicationHeaderModel;
	};
	totalCount: number;
	audits: MedicationHeaderModelAudit[];
 ...
 */
export const initialMedicationHeaderCollectionState: MedicationHeaderCollectionState = {
...
/**
 * The initial state of MedicationHeaderModelState
 */
export const initialState: MedicationHeaderModelState = {
	collectionState: {
