...
/**
 * ExaminationGroupCollectionState would store the state of a collection of ExaminationGroup
 */
export interface ExaminationGroupCollectionState extends CollectionState {
 ...
 */
export interface ExaminationGroupModelAudit extends AbstractModelAudit<ExaminationGroupModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * ExaminationGroupModelState would store the state of the model
 */
export interface ExaminationGroupModelState {
	collectionState: {
		[key: string]: ExaminationGroupCollectionState;
	};
	data: {
		[id: string]: ExaminationGroupModel;
	};
	totalCount: number;
	audits: ExaminationGroupModelAudit[];
 ...
 */
export const initialExaminationGroupCollectionState: ExaminationGroupCollectionState = {
...
/**
 * The initial state of ExaminationGroupModelState
 */
export const initialState: ExaminationGroupModelState = {
	collectionState: {
