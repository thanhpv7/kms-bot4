...
import * as modelAction from './examination_group.model.action';
import {ExaminationGroupService} from '../../services/examinationGroup/examination_group.service';
...
/**
 * Effect class used for side effects related to Examination Group model.
 */
@Injectable()
export class ExaminationGroupEffect {
	...
	constructor(
		...
		protected readonly service: ExaminationGroupService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationGroupAction>(modelAction.ExaminationGroupModelActionTypes.COUNT_EXAMINATION_GROUPS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.ExaminationGroupActionOK(
						modelAction.ExaminationGroupModelActionTypes.COUNT_EXAMINATION_GROUPS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationGroupActionFail(
								modelAction.ExaminationGroupModelActionTypes.COUNT_EXAMINATION_GROUPS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationGroupAction>(modelAction.ExaminationGroupModelActionTypes.FETCH_EXAMINATION_GROUP),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ExaminationGroupActionOK(
						modelAction.ExaminationGroupModelActionTypes.FETCH_EXAMINATION_GROUP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationGroupActionFail(
								modelAction.ExaminationGroupModelActionTypes.FETCH_EXAMINATION_GROUP_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationGroupAction>(modelAction.ExaminationGroupModelActionTypes.FETCH_ALL_EXAMINATION_GROUP),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.ExaminationGroupActionOK(
						modelAction.ExaminationGroupModelActionTypes.FETCH_ALL_EXAMINATION_GROUP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationGroupActionFail(
								modelAction.ExaminationGroupModelActionTypes.FETCH_ALL_EXAMINATION_GROUP_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationGroupAction>(modelAction.ExaminationGroupModelActionTypes.FETCH_EXAMINATION_GROUP_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.ExaminationGroupActionOK(
						modelAction.ExaminationGroupModelActionTypes.FETCH_EXAMINATION_GROUP_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationGroupActionFail(
								modelAction.ExaminationGroupModelActionTypes.FETCH_EXAMINATION_GROUP_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationGroupAction>(modelAction.ExaminationGroupModelActionTypes.FETCH_LAST_EXAMINATION_GROUP_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.ExaminationGroupActionOK(
						modelAction.ExaminationGroupModelActionTypes.FETCH_LAST_EXAMINATION_GROUP_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationGroupActionFail(
								modelAction.ExaminationGroupModelActionTypes.FETCH_LAST_EXAMINATION_GROUP_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationGroupAction>(modelAction.ExaminationGroupModelActionTypes.CREATE_EXAMINATION_GROUP),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as ExaminationGroupModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ExaminationGroupActionOK(
						modelAction.ExaminationGroupModelActionTypes.CREATE_EXAMINATION_GROUP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationGroupActionFail(
								modelAction.ExaminationGroupModelActionTypes.CREATE_EXAMINATION_GROUP_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationGroupAction>(modelAction.ExaminationGroupModelActionTypes.CREATE_ALL_EXAMINATION_GROUP),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as ExaminationGroupModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ExaminationGroupActionOK(
						modelAction.ExaminationGroupModelActionTypes.CREATE_ALL_EXAMINATION_GROUP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationGroupActionFail(
								modelAction.ExaminationGroupModelActionTypes.CREATE_ALL_EXAMINATION_GROUP_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationGroupAction>(modelAction.ExaminationGroupModelActionTypes.UPDATE_EXAMINATION_GROUP),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as ExaminationGroupModel;
				...
				return this.service.update(new ExaminationGroupModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.ExaminationGroupActionOK(
						modelAction.ExaminationGroupModelActionTypes.UPDATE_EXAMINATION_GROUP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationGroupActionFail(
								modelAction.ExaminationGroupModelActionTypes.UPDATE_EXAMINATION_GROUP_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationGroupAction>(modelAction.ExaminationGroupModelActionTypes.UPDATE_ALL_EXAMINATION_GROUP),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as ExaminationGroupModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new ExaminationGroupModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ExaminationGroupActionOK(
						modelAction.ExaminationGroupModelActionTypes.UPDATE_ALL_EXAMINATION_GROUP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationGroupActionFail(
								modelAction.ExaminationGroupModelActionTypes.UPDATE_ALL_EXAMINATION_GROUP_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationGroupAction>(modelAction.ExaminationGroupModelActionTypes.DELETE_EXAMINATION_GROUP),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.ExaminationGroupActionOK(
						modelAction.ExaminationGroupModelActionTypes.DELETE_EXAMINATION_GROUP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationGroupActionFail(
								modelAction.ExaminationGroupModelActionTypes.DELETE_EXAMINATION_GROUP_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationGroupAction>(modelAction.ExaminationGroupModelActionTypes.DELETE_EXAMINATION_GROUP_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.ExaminationGroupActionOK(
						modelAction.ExaminationGroupModelActionTypes.DELETE_EXAMINATION_GROUP_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationGroupActionFail(
								modelAction.ExaminationGroupModelActionTypes.DELETE_EXAMINATION_GROUP_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationGroupAction>(modelAction.ExaminationGroupModelActionTypes.DELETE_ALL_EXAMINATION_GROUP),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.ExaminationGroupActionOK(
						modelAction.ExaminationGroupModelActionTypes.DELETE_ALL_EXAMINATION_GROUP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationGroupActionFail(
								modelAction.ExaminationGroupModelActionTypes.DELETE_ALL_EXAMINATION_GROUP_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationGroupAction>(modelAction.ExaminationGroupModelActionTypes.EXPORT_EXAMINATION_GROUP),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ExaminationGroupActionOK(
						modelAction.ExaminationGroupModelActionTypes.EXPORT_EXAMINATION_GROUP,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationGroupAction>(modelAction.ExaminationGroupModelActionTypes.EXPORT_ALL_EXAMINATION_GROUP),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ExaminationGroupActionOK(
						modelAction.ExaminationGroupModelActionTypes.EXPORT_ALL_EXAMINATION_GROUP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationGroupActionFail(
								modelAction.ExaminationGroupModelActionTypes.EXPORT_ALL_EXAMINATION_GROUP_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationGroupAction>(modelAction.ExaminationGroupModelActionTypes.EXPORT_EXAMINATION_GROUP_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ExaminationGroupActionOK(
						modelAction.ExaminationGroupModelActionTypes.EXPORT_EXAMINATION_GROUP_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationGroupActionFail(
								modelAction.ExaminationGroupModelActionTypes.EXPORT_EXAMINATION_GROUP_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationGroupAction>(modelAction.ExaminationGroupModelActionTypes.IMPORT_EXAMINATION_GROUPS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.ExaminationGroupActionOK(
						modelAction.ExaminationGroupModelActionTypes.IMPORT_EXAMINATION_GROUPS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationGroupActionFail(
								modelAction.ExaminationGroupModelActionTypes.IMPORT_EXAMINATION_GROUPS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationGroupAction>(modelAction.ExaminationGroupModelActionTypes.FETCH_EXAMINATION_GROUP_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.ExaminationGroupActionOK(
						modelAction.ExaminationGroupModelActionTypes.FETCH_EXAMINATION_GROUP_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationGroupActionFail(
								modelAction.ExaminationGroupModelActionTypes.FETCH_EXAMINATION_GROUP_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationGroupAction>(modelAction.ExaminationGroupModelActionTypes.FETCH_EXAMINATION_GROUP_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.ExaminationGroupActionOK(
						modelAction.ExaminationGroupModelActionTypes.FETCH_EXAMINATION_GROUP_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationGroupActionFail(
								modelAction.ExaminationGroupModelActionTypes.FETCH_EXAMINATION_GROUP_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
