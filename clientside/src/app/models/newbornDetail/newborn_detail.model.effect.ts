...
import * as modelAction from './newborn_detail.model.action';
import {NewbornDetailService} from '../../services/newbornDetail/newborn_detail.service';
...
/**
 * Effect class used for side effects related to Newborn Detail model.
 */
@Injectable()
export class NewbornDetailEffect {
	...
	constructor(
		...
		protected readonly service: NewbornDetailService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NewbornDetailAction>(modelAction.NewbornDetailModelActionTypes.COUNT_NEWBORN_DETAILS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.NewbornDetailActionOK(
						modelAction.NewbornDetailModelActionTypes.COUNT_NEWBORN_DETAILS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NewbornDetailActionFail(
								modelAction.NewbornDetailModelActionTypes.COUNT_NEWBORN_DETAILS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NewbornDetailAction>(modelAction.NewbornDetailModelActionTypes.FETCH_NEWBORN_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.NewbornDetailActionOK(
						modelAction.NewbornDetailModelActionTypes.FETCH_NEWBORN_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NewbornDetailActionFail(
								modelAction.NewbornDetailModelActionTypes.FETCH_NEWBORN_DETAIL_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NewbornDetailAction>(modelAction.NewbornDetailModelActionTypes.FETCH_ALL_NEWBORN_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.NewbornDetailActionOK(
						modelAction.NewbornDetailModelActionTypes.FETCH_ALL_NEWBORN_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NewbornDetailActionFail(
								modelAction.NewbornDetailModelActionTypes.FETCH_ALL_NEWBORN_DETAIL_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NewbornDetailAction>(modelAction.NewbornDetailModelActionTypes.FETCH_NEWBORN_DETAIL_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.NewbornDetailActionOK(
						modelAction.NewbornDetailModelActionTypes.FETCH_NEWBORN_DETAIL_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NewbornDetailActionFail(
								modelAction.NewbornDetailModelActionTypes.FETCH_NEWBORN_DETAIL_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NewbornDetailAction>(modelAction.NewbornDetailModelActionTypes.FETCH_LAST_NEWBORN_DETAIL_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.NewbornDetailActionOK(
						modelAction.NewbornDetailModelActionTypes.FETCH_LAST_NEWBORN_DETAIL_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NewbornDetailActionFail(
								modelAction.NewbornDetailModelActionTypes.FETCH_LAST_NEWBORN_DETAIL_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NewbornDetailAction>(modelAction.NewbornDetailModelActionTypes.CREATE_NEWBORN_DETAIL),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as NewbornDetailModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.NewbornDetailActionOK(
						modelAction.NewbornDetailModelActionTypes.CREATE_NEWBORN_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NewbornDetailActionFail(
								modelAction.NewbornDetailModelActionTypes.CREATE_NEWBORN_DETAIL_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NewbornDetailAction>(modelAction.NewbornDetailModelActionTypes.CREATE_ALL_NEWBORN_DETAIL),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as NewbornDetailModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.NewbornDetailActionOK(
						modelAction.NewbornDetailModelActionTypes.CREATE_ALL_NEWBORN_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NewbornDetailActionFail(
								modelAction.NewbornDetailModelActionTypes.CREATE_ALL_NEWBORN_DETAIL_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NewbornDetailAction>(modelAction.NewbornDetailModelActionTypes.UPDATE_NEWBORN_DETAIL),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as NewbornDetailModel;
				...
				return this.service.update(new NewbornDetailModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.NewbornDetailActionOK(
						modelAction.NewbornDetailModelActionTypes.UPDATE_NEWBORN_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NewbornDetailActionFail(
								modelAction.NewbornDetailModelActionTypes.UPDATE_NEWBORN_DETAIL_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NewbornDetailAction>(modelAction.NewbornDetailModelActionTypes.UPDATE_ALL_NEWBORN_DETAIL),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as NewbornDetailModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new NewbornDetailModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.NewbornDetailActionOK(
						modelAction.NewbornDetailModelActionTypes.UPDATE_ALL_NEWBORN_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NewbornDetailActionFail(
								modelAction.NewbornDetailModelActionTypes.UPDATE_ALL_NEWBORN_DETAIL_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NewbornDetailAction>(modelAction.NewbornDetailModelActionTypes.DELETE_NEWBORN_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.NewbornDetailActionOK(
						modelAction.NewbornDetailModelActionTypes.DELETE_NEWBORN_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NewbornDetailActionFail(
								modelAction.NewbornDetailModelActionTypes.DELETE_NEWBORN_DETAIL_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NewbornDetailAction>(modelAction.NewbornDetailModelActionTypes.DELETE_NEWBORN_DETAIL_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.NewbornDetailActionOK(
						modelAction.NewbornDetailModelActionTypes.DELETE_NEWBORN_DETAIL_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NewbornDetailActionFail(
								modelAction.NewbornDetailModelActionTypes.DELETE_NEWBORN_DETAIL_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NewbornDetailAction>(modelAction.NewbornDetailModelActionTypes.DELETE_ALL_NEWBORN_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.NewbornDetailActionOK(
						modelAction.NewbornDetailModelActionTypes.DELETE_ALL_NEWBORN_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NewbornDetailActionFail(
								modelAction.NewbornDetailModelActionTypes.DELETE_ALL_NEWBORN_DETAIL_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NewbornDetailAction>(modelAction.NewbornDetailModelActionTypes.EXPORT_NEWBORN_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.NewbornDetailActionOK(
						modelAction.NewbornDetailModelActionTypes.EXPORT_NEWBORN_DETAIL,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NewbornDetailAction>(modelAction.NewbornDetailModelActionTypes.EXPORT_ALL_NEWBORN_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.NewbornDetailActionOK(
						modelAction.NewbornDetailModelActionTypes.EXPORT_ALL_NEWBORN_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NewbornDetailActionFail(
								modelAction.NewbornDetailModelActionTypes.EXPORT_ALL_NEWBORN_DETAIL_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NewbornDetailAction>(modelAction.NewbornDetailModelActionTypes.EXPORT_NEWBORN_DETAIL_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.NewbornDetailActionOK(
						modelAction.NewbornDetailModelActionTypes.EXPORT_NEWBORN_DETAIL_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NewbornDetailActionFail(
								modelAction.NewbornDetailModelActionTypes.EXPORT_NEWBORN_DETAIL_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NewbornDetailAction>(modelAction.NewbornDetailModelActionTypes.IMPORT_NEWBORN_DETAILS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.NewbornDetailActionOK(
						modelAction.NewbornDetailModelActionTypes.IMPORT_NEWBORN_DETAILS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NewbornDetailActionFail(
								modelAction.NewbornDetailModelActionTypes.IMPORT_NEWBORN_DETAILS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NewbornDetailAction>(modelAction.NewbornDetailModelActionTypes.FETCH_NEWBORN_DETAIL_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.NewbornDetailActionOK(
						modelAction.NewbornDetailModelActionTypes.FETCH_NEWBORN_DETAIL_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.NewbornDetailActionFail(
								modelAction.NewbornDetailModelActionTypes.FETCH_NEWBORN_DETAIL_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NewbornDetailAction>(modelAction.NewbornDetailModelActionTypes.FETCH_NEWBORN_DETAIL_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.NewbornDetailActionOK(
						modelAction.NewbornDetailModelActionTypes.FETCH_NEWBORN_DETAIL_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.NewbornDetailActionFail(
								modelAction.NewbornDetailModelActionTypes.FETCH_NEWBORN_DETAIL_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
