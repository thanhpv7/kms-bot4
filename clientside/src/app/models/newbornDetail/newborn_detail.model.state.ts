...
/**
 * NewbornDetailCollectionState would store the state of a collection of NewbornDetail
 */
export interface NewbornDetailCollectionState extends CollectionState {
 ...
 */
export interface NewbornDetailModelAudit extends AbstractModelAudit<NewbornDetailModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * NewbornDetailModelState would store the state of the model
 */
export interface NewbornDetailModelState {
	collectionState: {
		[key: string]: NewbornDetailCollectionState;
	};
	data: {
		[id: string]: NewbornDetailModel;
	};
	totalCount: number;
	audits: NewbornDetailModelAudit[];
 ...
 */
export const initialNewbornDetailCollectionState: NewbornDetailCollectionState = {
...
/**
 * The initial state of NewbornDetailModelState
 */
export const initialState: NewbornDetailModelState = {
	collectionState: {
