...
/**
 * GoodsReceiveNoteCollectionState would store the state of a collection of GoodsReceiveNote
 */
export interface GoodsReceiveNoteCollectionState extends CollectionState {
 ...
 */
export interface GoodsReceiveNoteModelAudit extends AbstractModelAudit<GoodsReceiveNoteModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * GoodsReceiveNoteModelState would store the state of the model
 */
export interface GoodsReceiveNoteModelState {
	collectionState: {
		[key: string]: GoodsReceiveNoteCollectionState;
	};
	data: {
		[id: string]: GoodsReceiveNoteModel;
	};
	totalCount: number;
	audits: GoodsReceiveNoteModelAudit[];
 ...
 */
export const initialGoodsReceiveNoteCollectionState: GoodsReceiveNoteCollectionState = {
...
/**
 * The initial state of GoodsReceiveNoteModelState
 */
export const initialState: GoodsReceiveNoteModelState = {
	collectionState: {
