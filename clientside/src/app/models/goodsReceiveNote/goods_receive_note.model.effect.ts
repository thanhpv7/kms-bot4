...
import * as modelAction from './goods_receive_note.model.action';
import {GoodsReceiveNoteService} from '../../services/goodsReceiveNote/goods_receive_note.service';
...
/**
 * Effect class used for side effects related to Goods Receive Note model.
 */
@Injectable()
export class GoodsReceiveNoteEffect {
	...
	constructor(
		...
		protected readonly service: GoodsReceiveNoteService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteAction>(modelAction.GoodsReceiveNoteModelActionTypes.COUNT_GOODS_RECEIVE_NOTES),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.GoodsReceiveNoteActionOK(
						modelAction.GoodsReceiveNoteModelActionTypes.COUNT_GOODS_RECEIVE_NOTES_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteActionFail(
								modelAction.GoodsReceiveNoteModelActionTypes.COUNT_GOODS_RECEIVE_NOTES_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteAction>(modelAction.GoodsReceiveNoteModelActionTypes.FETCH_GOODS_RECEIVE_NOTE),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.GoodsReceiveNoteActionOK(
						modelAction.GoodsReceiveNoteModelActionTypes.FETCH_GOODS_RECEIVE_NOTE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteActionFail(
								modelAction.GoodsReceiveNoteModelActionTypes.FETCH_GOODS_RECEIVE_NOTE_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteAction>(modelAction.GoodsReceiveNoteModelActionTypes.FETCH_ALL_GOODS_RECEIVE_NOTE),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.GoodsReceiveNoteActionOK(
						modelAction.GoodsReceiveNoteModelActionTypes.FETCH_ALL_GOODS_RECEIVE_NOTE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteActionFail(
								modelAction.GoodsReceiveNoteModelActionTypes.FETCH_ALL_GOODS_RECEIVE_NOTE_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteAction>(modelAction.GoodsReceiveNoteModelActionTypes.FETCH_GOODS_RECEIVE_NOTE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.GoodsReceiveNoteActionOK(
						modelAction.GoodsReceiveNoteModelActionTypes.FETCH_GOODS_RECEIVE_NOTE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteActionFail(
								modelAction.GoodsReceiveNoteModelActionTypes.FETCH_GOODS_RECEIVE_NOTE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteAction>(modelAction.GoodsReceiveNoteModelActionTypes.FETCH_LAST_GOODS_RECEIVE_NOTE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.GoodsReceiveNoteActionOK(
						modelAction.GoodsReceiveNoteModelActionTypes.FETCH_LAST_GOODS_RECEIVE_NOTE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteActionFail(
								modelAction.GoodsReceiveNoteModelActionTypes.FETCH_LAST_GOODS_RECEIVE_NOTE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteAction>(modelAction.GoodsReceiveNoteModelActionTypes.CREATE_GOODS_RECEIVE_NOTE),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as GoodsReceiveNoteModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.GoodsReceiveNoteActionOK(
						modelAction.GoodsReceiveNoteModelActionTypes.CREATE_GOODS_RECEIVE_NOTE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteActionFail(
								modelAction.GoodsReceiveNoteModelActionTypes.CREATE_GOODS_RECEIVE_NOTE_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteAction>(modelAction.GoodsReceiveNoteModelActionTypes.CREATE_ALL_GOODS_RECEIVE_NOTE),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as GoodsReceiveNoteModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.GoodsReceiveNoteActionOK(
						modelAction.GoodsReceiveNoteModelActionTypes.CREATE_ALL_GOODS_RECEIVE_NOTE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteActionFail(
								modelAction.GoodsReceiveNoteModelActionTypes.CREATE_ALL_GOODS_RECEIVE_NOTE_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteAction>(modelAction.GoodsReceiveNoteModelActionTypes.UPDATE_GOODS_RECEIVE_NOTE),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as GoodsReceiveNoteModel;
				...
				return this.service.update(new GoodsReceiveNoteModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.GoodsReceiveNoteActionOK(
						modelAction.GoodsReceiveNoteModelActionTypes.UPDATE_GOODS_RECEIVE_NOTE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteActionFail(
								modelAction.GoodsReceiveNoteModelActionTypes.UPDATE_GOODS_RECEIVE_NOTE_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteAction>(modelAction.GoodsReceiveNoteModelActionTypes.UPDATE_ALL_GOODS_RECEIVE_NOTE),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as GoodsReceiveNoteModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new GoodsReceiveNoteModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.GoodsReceiveNoteActionOK(
						modelAction.GoodsReceiveNoteModelActionTypes.UPDATE_ALL_GOODS_RECEIVE_NOTE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteActionFail(
								modelAction.GoodsReceiveNoteModelActionTypes.UPDATE_ALL_GOODS_RECEIVE_NOTE_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteAction>(modelAction.GoodsReceiveNoteModelActionTypes.DELETE_GOODS_RECEIVE_NOTE),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.GoodsReceiveNoteActionOK(
						modelAction.GoodsReceiveNoteModelActionTypes.DELETE_GOODS_RECEIVE_NOTE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteActionFail(
								modelAction.GoodsReceiveNoteModelActionTypes.DELETE_GOODS_RECEIVE_NOTE_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteAction>(modelAction.GoodsReceiveNoteModelActionTypes.DELETE_GOODS_RECEIVE_NOTE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.GoodsReceiveNoteActionOK(
						modelAction.GoodsReceiveNoteModelActionTypes.DELETE_GOODS_RECEIVE_NOTE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteActionFail(
								modelAction.GoodsReceiveNoteModelActionTypes.DELETE_GOODS_RECEIVE_NOTE_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteAction>(modelAction.GoodsReceiveNoteModelActionTypes.DELETE_ALL_GOODS_RECEIVE_NOTE),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.GoodsReceiveNoteActionOK(
						modelAction.GoodsReceiveNoteModelActionTypes.DELETE_ALL_GOODS_RECEIVE_NOTE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteActionFail(
								modelAction.GoodsReceiveNoteModelActionTypes.DELETE_ALL_GOODS_RECEIVE_NOTE_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteAction>(modelAction.GoodsReceiveNoteModelActionTypes.EXPORT_GOODS_RECEIVE_NOTE),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.GoodsReceiveNoteActionOK(
						modelAction.GoodsReceiveNoteModelActionTypes.EXPORT_GOODS_RECEIVE_NOTE,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteAction>(modelAction.GoodsReceiveNoteModelActionTypes.EXPORT_ALL_GOODS_RECEIVE_NOTE),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.GoodsReceiveNoteActionOK(
						modelAction.GoodsReceiveNoteModelActionTypes.EXPORT_ALL_GOODS_RECEIVE_NOTE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteActionFail(
								modelAction.GoodsReceiveNoteModelActionTypes.EXPORT_ALL_GOODS_RECEIVE_NOTE_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteAction>(modelAction.GoodsReceiveNoteModelActionTypes.EXPORT_GOODS_RECEIVE_NOTE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.GoodsReceiveNoteActionOK(
						modelAction.GoodsReceiveNoteModelActionTypes.EXPORT_GOODS_RECEIVE_NOTE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteActionFail(
								modelAction.GoodsReceiveNoteModelActionTypes.EXPORT_GOODS_RECEIVE_NOTE_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteAction>(modelAction.GoodsReceiveNoteModelActionTypes.IMPORT_GOODS_RECEIVE_NOTES),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.GoodsReceiveNoteActionOK(
						modelAction.GoodsReceiveNoteModelActionTypes.IMPORT_GOODS_RECEIVE_NOTES_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteActionFail(
								modelAction.GoodsReceiveNoteModelActionTypes.IMPORT_GOODS_RECEIVE_NOTES_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteAction>(modelAction.GoodsReceiveNoteModelActionTypes.FETCH_GOODS_RECEIVE_NOTE_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.GoodsReceiveNoteActionOK(
						modelAction.GoodsReceiveNoteModelActionTypes.FETCH_GOODS_RECEIVE_NOTE_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteActionFail(
								modelAction.GoodsReceiveNoteModelActionTypes.FETCH_GOODS_RECEIVE_NOTE_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.GoodsReceiveNoteAction>(modelAction.GoodsReceiveNoteModelActionTypes.FETCH_GOODS_RECEIVE_NOTE_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.GoodsReceiveNoteActionOK(
						modelAction.GoodsReceiveNoteModelActionTypes.FETCH_GOODS_RECEIVE_NOTE_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.GoodsReceiveNoteActionFail(
								modelAction.GoodsReceiveNoteModelActionTypes.FETCH_GOODS_RECEIVE_NOTE_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
