...
import * as modelAction from './return_supplier_stock_detail.model.action';
import {ReturnSupplierStockDetailService} from '../../services/returnSupplierStockDetail/return_supplier_stock_detail.service';
...
/**
 * Effect class used for side effects related to Return Supplier Stock Detail model.
 */
@Injectable()
export class ReturnSupplierStockDetailEffect {
	...
	constructor(
		...
		protected readonly service: ReturnSupplierStockDetailService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReturnSupplierStockDetailAction>(modelAction.ReturnSupplierStockDetailModelActionTypes.COUNT_RETURN_SUPPLIER_STOCK_DETAILS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.ReturnSupplierStockDetailActionOK(
						modelAction.ReturnSupplierStockDetailModelActionTypes.COUNT_RETURN_SUPPLIER_STOCK_DETAILS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReturnSupplierStockDetailActionFail(
								modelAction.ReturnSupplierStockDetailModelActionTypes.COUNT_RETURN_SUPPLIER_STOCK_DETAILS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReturnSupplierStockDetailAction>(modelAction.ReturnSupplierStockDetailModelActionTypes.FETCH_RETURN_SUPPLIER_STOCK_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ReturnSupplierStockDetailActionOK(
						modelAction.ReturnSupplierStockDetailModelActionTypes.FETCH_RETURN_SUPPLIER_STOCK_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReturnSupplierStockDetailActionFail(
								modelAction.ReturnSupplierStockDetailModelActionTypes.FETCH_RETURN_SUPPLIER_STOCK_DETAIL_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReturnSupplierStockDetailAction>(modelAction.ReturnSupplierStockDetailModelActionTypes.FETCH_ALL_RETURN_SUPPLIER_STOCK_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.ReturnSupplierStockDetailActionOK(
						modelAction.ReturnSupplierStockDetailModelActionTypes.FETCH_ALL_RETURN_SUPPLIER_STOCK_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReturnSupplierStockDetailActionFail(
								modelAction.ReturnSupplierStockDetailModelActionTypes.FETCH_ALL_RETURN_SUPPLIER_STOCK_DETAIL_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReturnSupplierStockDetailAction>(modelAction.ReturnSupplierStockDetailModelActionTypes.FETCH_RETURN_SUPPLIER_STOCK_DETAIL_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.ReturnSupplierStockDetailActionOK(
						modelAction.ReturnSupplierStockDetailModelActionTypes.FETCH_RETURN_SUPPLIER_STOCK_DETAIL_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReturnSupplierStockDetailActionFail(
								modelAction.ReturnSupplierStockDetailModelActionTypes.FETCH_RETURN_SUPPLIER_STOCK_DETAIL_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReturnSupplierStockDetailAction>(modelAction.ReturnSupplierStockDetailModelActionTypes.FETCH_LAST_RETURN_SUPPLIER_STOCK_DETAIL_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.ReturnSupplierStockDetailActionOK(
						modelAction.ReturnSupplierStockDetailModelActionTypes.FETCH_LAST_RETURN_SUPPLIER_STOCK_DETAIL_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReturnSupplierStockDetailActionFail(
								modelAction.ReturnSupplierStockDetailModelActionTypes.FETCH_LAST_RETURN_SUPPLIER_STOCK_DETAIL_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReturnSupplierStockDetailAction>(modelAction.ReturnSupplierStockDetailModelActionTypes.CREATE_RETURN_SUPPLIER_STOCK_DETAIL),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as ReturnSupplierStockDetailModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ReturnSupplierStockDetailActionOK(
						modelAction.ReturnSupplierStockDetailModelActionTypes.CREATE_RETURN_SUPPLIER_STOCK_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReturnSupplierStockDetailActionFail(
								modelAction.ReturnSupplierStockDetailModelActionTypes.CREATE_RETURN_SUPPLIER_STOCK_DETAIL_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReturnSupplierStockDetailAction>(modelAction.ReturnSupplierStockDetailModelActionTypes.CREATE_ALL_RETURN_SUPPLIER_STOCK_DETAIL),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as ReturnSupplierStockDetailModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ReturnSupplierStockDetailActionOK(
						modelAction.ReturnSupplierStockDetailModelActionTypes.CREATE_ALL_RETURN_SUPPLIER_STOCK_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReturnSupplierStockDetailActionFail(
								modelAction.ReturnSupplierStockDetailModelActionTypes.CREATE_ALL_RETURN_SUPPLIER_STOCK_DETAIL_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReturnSupplierStockDetailAction>(modelAction.ReturnSupplierStockDetailModelActionTypes.UPDATE_RETURN_SUPPLIER_STOCK_DETAIL),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as ReturnSupplierStockDetailModel;
				...
				return this.service.update(new ReturnSupplierStockDetailModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.ReturnSupplierStockDetailActionOK(
						modelAction.ReturnSupplierStockDetailModelActionTypes.UPDATE_RETURN_SUPPLIER_STOCK_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReturnSupplierStockDetailActionFail(
								modelAction.ReturnSupplierStockDetailModelActionTypes.UPDATE_RETURN_SUPPLIER_STOCK_DETAIL_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReturnSupplierStockDetailAction>(modelAction.ReturnSupplierStockDetailModelActionTypes.UPDATE_ALL_RETURN_SUPPLIER_STOCK_DETAIL),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as ReturnSupplierStockDetailModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new ReturnSupplierStockDetailModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ReturnSupplierStockDetailActionOK(
						modelAction.ReturnSupplierStockDetailModelActionTypes.UPDATE_ALL_RETURN_SUPPLIER_STOCK_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReturnSupplierStockDetailActionFail(
								modelAction.ReturnSupplierStockDetailModelActionTypes.UPDATE_ALL_RETURN_SUPPLIER_STOCK_DETAIL_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReturnSupplierStockDetailAction>(modelAction.ReturnSupplierStockDetailModelActionTypes.DELETE_RETURN_SUPPLIER_STOCK_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.ReturnSupplierStockDetailActionOK(
						modelAction.ReturnSupplierStockDetailModelActionTypes.DELETE_RETURN_SUPPLIER_STOCK_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReturnSupplierStockDetailActionFail(
								modelAction.ReturnSupplierStockDetailModelActionTypes.DELETE_RETURN_SUPPLIER_STOCK_DETAIL_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReturnSupplierStockDetailAction>(modelAction.ReturnSupplierStockDetailModelActionTypes.DELETE_RETURN_SUPPLIER_STOCK_DETAIL_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.ReturnSupplierStockDetailActionOK(
						modelAction.ReturnSupplierStockDetailModelActionTypes.DELETE_RETURN_SUPPLIER_STOCK_DETAIL_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReturnSupplierStockDetailActionFail(
								modelAction.ReturnSupplierStockDetailModelActionTypes.DELETE_RETURN_SUPPLIER_STOCK_DETAIL_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReturnSupplierStockDetailAction>(modelAction.ReturnSupplierStockDetailModelActionTypes.DELETE_ALL_RETURN_SUPPLIER_STOCK_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.ReturnSupplierStockDetailActionOK(
						modelAction.ReturnSupplierStockDetailModelActionTypes.DELETE_ALL_RETURN_SUPPLIER_STOCK_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReturnSupplierStockDetailActionFail(
								modelAction.ReturnSupplierStockDetailModelActionTypes.DELETE_ALL_RETURN_SUPPLIER_STOCK_DETAIL_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReturnSupplierStockDetailAction>(modelAction.ReturnSupplierStockDetailModelActionTypes.EXPORT_RETURN_SUPPLIER_STOCK_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ReturnSupplierStockDetailActionOK(
						modelAction.ReturnSupplierStockDetailModelActionTypes.EXPORT_RETURN_SUPPLIER_STOCK_DETAIL,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReturnSupplierStockDetailAction>(modelAction.ReturnSupplierStockDetailModelActionTypes.EXPORT_ALL_RETURN_SUPPLIER_STOCK_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ReturnSupplierStockDetailActionOK(
						modelAction.ReturnSupplierStockDetailModelActionTypes.EXPORT_ALL_RETURN_SUPPLIER_STOCK_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReturnSupplierStockDetailActionFail(
								modelAction.ReturnSupplierStockDetailModelActionTypes.EXPORT_ALL_RETURN_SUPPLIER_STOCK_DETAIL_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReturnSupplierStockDetailAction>(modelAction.ReturnSupplierStockDetailModelActionTypes.EXPORT_RETURN_SUPPLIER_STOCK_DETAIL_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ReturnSupplierStockDetailActionOK(
						modelAction.ReturnSupplierStockDetailModelActionTypes.EXPORT_RETURN_SUPPLIER_STOCK_DETAIL_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReturnSupplierStockDetailActionFail(
								modelAction.ReturnSupplierStockDetailModelActionTypes.EXPORT_RETURN_SUPPLIER_STOCK_DETAIL_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReturnSupplierStockDetailAction>(modelAction.ReturnSupplierStockDetailModelActionTypes.IMPORT_RETURN_SUPPLIER_STOCK_DETAILS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.ReturnSupplierStockDetailActionOK(
						modelAction.ReturnSupplierStockDetailModelActionTypes.IMPORT_RETURN_SUPPLIER_STOCK_DETAILS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReturnSupplierStockDetailActionFail(
								modelAction.ReturnSupplierStockDetailModelActionTypes.IMPORT_RETURN_SUPPLIER_STOCK_DETAILS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReturnSupplierStockDetailAction>(modelAction.ReturnSupplierStockDetailModelActionTypes.FETCH_RETURN_SUPPLIER_STOCK_DETAIL_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.ReturnSupplierStockDetailActionOK(
						modelAction.ReturnSupplierStockDetailModelActionTypes.FETCH_RETURN_SUPPLIER_STOCK_DETAIL_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.ReturnSupplierStockDetailActionFail(
								modelAction.ReturnSupplierStockDetailModelActionTypes.FETCH_RETURN_SUPPLIER_STOCK_DETAIL_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReturnSupplierStockDetailAction>(modelAction.ReturnSupplierStockDetailModelActionTypes.FETCH_RETURN_SUPPLIER_STOCK_DETAIL_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.ReturnSupplierStockDetailActionOK(
						modelAction.ReturnSupplierStockDetailModelActionTypes.FETCH_RETURN_SUPPLIER_STOCK_DETAIL_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.ReturnSupplierStockDetailActionFail(
								modelAction.ReturnSupplierStockDetailModelActionTypes.FETCH_RETURN_SUPPLIER_STOCK_DETAIL_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
