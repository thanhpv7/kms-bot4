...
/**
 * ReturnSupplierStockDetailCollectionState would store the state of a collection of ReturnSupplierStockDetail
 */
export interface ReturnSupplierStockDetailCollectionState extends CollectionState {
 ...
 */
export interface ReturnSupplierStockDetailModelAudit extends AbstractModelAudit<ReturnSupplierStockDetailModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * ReturnSupplierStockDetailModelState would store the state of the model
 */
export interface ReturnSupplierStockDetailModelState {
	collectionState: {
		[key: string]: ReturnSupplierStockDetailCollectionState;
	};
	data: {
		[id: string]: ReturnSupplierStockDetailModel;
	};
	totalCount: number;
	audits: ReturnSupplierStockDetailModelAudit[];
 ...
 */
export const initialReturnSupplierStockDetailCollectionState: ReturnSupplierStockDetailCollectionState = {
...
/**
 * The initial state of ReturnSupplierStockDetailModelState
 */
export const initialState: ReturnSupplierStockDetailModelState = {
	collectionState: {
