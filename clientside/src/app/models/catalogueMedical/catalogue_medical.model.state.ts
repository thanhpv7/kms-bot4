...
/**
 * CatalogueMedicalCollectionState would store the state of a collection of CatalogueMedical
 */
export interface CatalogueMedicalCollectionState extends CollectionState {
 ...
 */
export interface CatalogueMedicalModelAudit extends AbstractModelAudit<CatalogueMedicalModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * CatalogueMedicalModelState would store the state of the model
 */
export interface CatalogueMedicalModelState {
	collectionState: {
		[key: string]: CatalogueMedicalCollectionState;
	};
	data: {
		[id: string]: CatalogueMedicalModel;
	};
	totalCount: number;
	audits: CatalogueMedicalModelAudit[];
 ...
 */
export const initialCatalogueMedicalCollectionState: CatalogueMedicalCollectionState = {
...
/**
 * The initial state of CatalogueMedicalModelState
 */
export const initialState: CatalogueMedicalModelState = {
	collectionState: {
