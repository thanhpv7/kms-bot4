...
import * as modelAction from './catalogue_medical.model.action';
import {CatalogueMedicalService} from '../../services/catalogueMedical/catalogue_medical.service';
...
/**
 * Effect class used for side effects related to Catalogue Medical  model.
 */
@Injectable()
export class CatalogueMedicalEffect {
	...
	constructor(
		...
		protected readonly service: CatalogueMedicalService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CatalogueMedicalAction>(modelAction.CatalogueMedicalModelActionTypes.COUNT_CATALOGUE_MEDICALS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.CatalogueMedicalActionOK(
						modelAction.CatalogueMedicalModelActionTypes.COUNT_CATALOGUE_MEDICALS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CatalogueMedicalActionFail(
								modelAction.CatalogueMedicalModelActionTypes.COUNT_CATALOGUE_MEDICALS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CatalogueMedicalAction>(modelAction.CatalogueMedicalModelActionTypes.FETCH_CATALOGUE_MEDICAL),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.CatalogueMedicalActionOK(
						modelAction.CatalogueMedicalModelActionTypes.FETCH_CATALOGUE_MEDICAL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CatalogueMedicalActionFail(
								modelAction.CatalogueMedicalModelActionTypes.FETCH_CATALOGUE_MEDICAL_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CatalogueMedicalAction>(modelAction.CatalogueMedicalModelActionTypes.FETCH_ALL_CATALOGUE_MEDICAL),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.CatalogueMedicalActionOK(
						modelAction.CatalogueMedicalModelActionTypes.FETCH_ALL_CATALOGUE_MEDICAL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CatalogueMedicalActionFail(
								modelAction.CatalogueMedicalModelActionTypes.FETCH_ALL_CATALOGUE_MEDICAL_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CatalogueMedicalAction>(modelAction.CatalogueMedicalModelActionTypes.FETCH_CATALOGUE_MEDICAL_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.CatalogueMedicalActionOK(
						modelAction.CatalogueMedicalModelActionTypes.FETCH_CATALOGUE_MEDICAL_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CatalogueMedicalActionFail(
								modelAction.CatalogueMedicalModelActionTypes.FETCH_CATALOGUE_MEDICAL_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CatalogueMedicalAction>(modelAction.CatalogueMedicalModelActionTypes.FETCH_LAST_CATALOGUE_MEDICAL_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.CatalogueMedicalActionOK(
						modelAction.CatalogueMedicalModelActionTypes.FETCH_LAST_CATALOGUE_MEDICAL_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CatalogueMedicalActionFail(
								modelAction.CatalogueMedicalModelActionTypes.FETCH_LAST_CATALOGUE_MEDICAL_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CatalogueMedicalAction>(modelAction.CatalogueMedicalModelActionTypes.CREATE_CATALOGUE_MEDICAL),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as CatalogueMedicalModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.CatalogueMedicalActionOK(
						modelAction.CatalogueMedicalModelActionTypes.CREATE_CATALOGUE_MEDICAL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CatalogueMedicalActionFail(
								modelAction.CatalogueMedicalModelActionTypes.CREATE_CATALOGUE_MEDICAL_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CatalogueMedicalAction>(modelAction.CatalogueMedicalModelActionTypes.CREATE_ALL_CATALOGUE_MEDICAL),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as CatalogueMedicalModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.CatalogueMedicalActionOK(
						modelAction.CatalogueMedicalModelActionTypes.CREATE_ALL_CATALOGUE_MEDICAL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CatalogueMedicalActionFail(
								modelAction.CatalogueMedicalModelActionTypes.CREATE_ALL_CATALOGUE_MEDICAL_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CatalogueMedicalAction>(modelAction.CatalogueMedicalModelActionTypes.UPDATE_CATALOGUE_MEDICAL),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as CatalogueMedicalModel;
				...
				return this.service.update(new CatalogueMedicalModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.CatalogueMedicalActionOK(
						modelAction.CatalogueMedicalModelActionTypes.UPDATE_CATALOGUE_MEDICAL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CatalogueMedicalActionFail(
								modelAction.CatalogueMedicalModelActionTypes.UPDATE_CATALOGUE_MEDICAL_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CatalogueMedicalAction>(modelAction.CatalogueMedicalModelActionTypes.UPDATE_ALL_CATALOGUE_MEDICAL),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as CatalogueMedicalModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new CatalogueMedicalModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.CatalogueMedicalActionOK(
						modelAction.CatalogueMedicalModelActionTypes.UPDATE_ALL_CATALOGUE_MEDICAL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CatalogueMedicalActionFail(
								modelAction.CatalogueMedicalModelActionTypes.UPDATE_ALL_CATALOGUE_MEDICAL_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CatalogueMedicalAction>(modelAction.CatalogueMedicalModelActionTypes.DELETE_CATALOGUE_MEDICAL),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.CatalogueMedicalActionOK(
						modelAction.CatalogueMedicalModelActionTypes.DELETE_CATALOGUE_MEDICAL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CatalogueMedicalActionFail(
								modelAction.CatalogueMedicalModelActionTypes.DELETE_CATALOGUE_MEDICAL_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CatalogueMedicalAction>(modelAction.CatalogueMedicalModelActionTypes.DELETE_CATALOGUE_MEDICAL_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.CatalogueMedicalActionOK(
						modelAction.CatalogueMedicalModelActionTypes.DELETE_CATALOGUE_MEDICAL_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CatalogueMedicalActionFail(
								modelAction.CatalogueMedicalModelActionTypes.DELETE_CATALOGUE_MEDICAL_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CatalogueMedicalAction>(modelAction.CatalogueMedicalModelActionTypes.DELETE_ALL_CATALOGUE_MEDICAL),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.CatalogueMedicalActionOK(
						modelAction.CatalogueMedicalModelActionTypes.DELETE_ALL_CATALOGUE_MEDICAL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CatalogueMedicalActionFail(
								modelAction.CatalogueMedicalModelActionTypes.DELETE_ALL_CATALOGUE_MEDICAL_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CatalogueMedicalAction>(modelAction.CatalogueMedicalModelActionTypes.EXPORT_CATALOGUE_MEDICAL),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.CatalogueMedicalActionOK(
						modelAction.CatalogueMedicalModelActionTypes.EXPORT_CATALOGUE_MEDICAL,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CatalogueMedicalAction>(modelAction.CatalogueMedicalModelActionTypes.EXPORT_ALL_CATALOGUE_MEDICAL),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.CatalogueMedicalActionOK(
						modelAction.CatalogueMedicalModelActionTypes.EXPORT_ALL_CATALOGUE_MEDICAL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CatalogueMedicalActionFail(
								modelAction.CatalogueMedicalModelActionTypes.EXPORT_ALL_CATALOGUE_MEDICAL_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CatalogueMedicalAction>(modelAction.CatalogueMedicalModelActionTypes.EXPORT_CATALOGUE_MEDICAL_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.CatalogueMedicalActionOK(
						modelAction.CatalogueMedicalModelActionTypes.EXPORT_CATALOGUE_MEDICAL_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CatalogueMedicalActionFail(
								modelAction.CatalogueMedicalModelActionTypes.EXPORT_CATALOGUE_MEDICAL_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CatalogueMedicalAction>(modelAction.CatalogueMedicalModelActionTypes.IMPORT_CATALOGUE_MEDICALS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.CatalogueMedicalActionOK(
						modelAction.CatalogueMedicalModelActionTypes.IMPORT_CATALOGUE_MEDICALS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CatalogueMedicalActionFail(
								modelAction.CatalogueMedicalModelActionTypes.IMPORT_CATALOGUE_MEDICALS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CatalogueMedicalAction>(modelAction.CatalogueMedicalModelActionTypes.FETCH_CATALOGUE_MEDICAL_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.CatalogueMedicalActionOK(
						modelAction.CatalogueMedicalModelActionTypes.FETCH_CATALOGUE_MEDICAL_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.CatalogueMedicalActionFail(
								modelAction.CatalogueMedicalModelActionTypes.FETCH_CATALOGUE_MEDICAL_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CatalogueMedicalAction>(modelAction.CatalogueMedicalModelActionTypes.FETCH_CATALOGUE_MEDICAL_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.CatalogueMedicalActionOK(
						modelAction.CatalogueMedicalModelActionTypes.FETCH_CATALOGUE_MEDICAL_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.CatalogueMedicalActionFail(
								modelAction.CatalogueMedicalModelActionTypes.FETCH_CATALOGUE_MEDICAL_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
