...
/**
 * InventoryAdjustmentCollectionState would store the state of a collection of InventoryAdjustment
 */
export interface InventoryAdjustmentCollectionState extends CollectionState {
 ...
 */
export interface InventoryAdjustmentModelAudit extends AbstractModelAudit<InventoryAdjustmentModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * InventoryAdjustmentModelState would store the state of the model
 */
export interface InventoryAdjustmentModelState {
	collectionState: {
		[key: string]: InventoryAdjustmentCollectionState;
	};
	data: {
		[id: string]: InventoryAdjustmentModel;
	};
	totalCount: number;
	audits: InventoryAdjustmentModelAudit[];
 ...
 */
export const initialInventoryAdjustmentCollectionState: InventoryAdjustmentCollectionState = {
...
/**
 * The initial state of InventoryAdjustmentModelState
 */
export const initialState: InventoryAdjustmentModelState = {
	collectionState: {
