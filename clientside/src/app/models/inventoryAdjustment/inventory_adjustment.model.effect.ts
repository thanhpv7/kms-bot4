...
import * as modelAction from './inventory_adjustment.model.action';
import {InventoryAdjustmentService} from '../../services/inventoryAdjustment/inventory_adjustment.service';
...
/**
 * Effect class used for side effects related to Inventory Adjustment model.
 */
@Injectable()
export class InventoryAdjustmentEffect {
	...
	constructor(
		...
		protected readonly service: InventoryAdjustmentService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryAdjustmentAction>(modelAction.InventoryAdjustmentModelActionTypes.COUNT_INVENTORY_ADJUSTMENTS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.InventoryAdjustmentActionOK(
						modelAction.InventoryAdjustmentModelActionTypes.COUNT_INVENTORY_ADJUSTMENTS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryAdjustmentActionFail(
								modelAction.InventoryAdjustmentModelActionTypes.COUNT_INVENTORY_ADJUSTMENTS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryAdjustmentAction>(modelAction.InventoryAdjustmentModelActionTypes.FETCH_INVENTORY_ADJUSTMENT),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InventoryAdjustmentActionOK(
						modelAction.InventoryAdjustmentModelActionTypes.FETCH_INVENTORY_ADJUSTMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryAdjustmentActionFail(
								modelAction.InventoryAdjustmentModelActionTypes.FETCH_INVENTORY_ADJUSTMENT_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryAdjustmentAction>(modelAction.InventoryAdjustmentModelActionTypes.FETCH_ALL_INVENTORY_ADJUSTMENT),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.InventoryAdjustmentActionOK(
						modelAction.InventoryAdjustmentModelActionTypes.FETCH_ALL_INVENTORY_ADJUSTMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryAdjustmentActionFail(
								modelAction.InventoryAdjustmentModelActionTypes.FETCH_ALL_INVENTORY_ADJUSTMENT_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryAdjustmentAction>(modelAction.InventoryAdjustmentModelActionTypes.FETCH_INVENTORY_ADJUSTMENT_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.InventoryAdjustmentActionOK(
						modelAction.InventoryAdjustmentModelActionTypes.FETCH_INVENTORY_ADJUSTMENT_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryAdjustmentActionFail(
								modelAction.InventoryAdjustmentModelActionTypes.FETCH_INVENTORY_ADJUSTMENT_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryAdjustmentAction>(modelAction.InventoryAdjustmentModelActionTypes.FETCH_LAST_INVENTORY_ADJUSTMENT_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.InventoryAdjustmentActionOK(
						modelAction.InventoryAdjustmentModelActionTypes.FETCH_LAST_INVENTORY_ADJUSTMENT_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryAdjustmentActionFail(
								modelAction.InventoryAdjustmentModelActionTypes.FETCH_LAST_INVENTORY_ADJUSTMENT_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryAdjustmentAction>(modelAction.InventoryAdjustmentModelActionTypes.CREATE_INVENTORY_ADJUSTMENT),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as InventoryAdjustmentModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InventoryAdjustmentActionOK(
						modelAction.InventoryAdjustmentModelActionTypes.CREATE_INVENTORY_ADJUSTMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryAdjustmentActionFail(
								modelAction.InventoryAdjustmentModelActionTypes.CREATE_INVENTORY_ADJUSTMENT_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryAdjustmentAction>(modelAction.InventoryAdjustmentModelActionTypes.CREATE_ALL_INVENTORY_ADJUSTMENT),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as InventoryAdjustmentModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InventoryAdjustmentActionOK(
						modelAction.InventoryAdjustmentModelActionTypes.CREATE_ALL_INVENTORY_ADJUSTMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryAdjustmentActionFail(
								modelAction.InventoryAdjustmentModelActionTypes.CREATE_ALL_INVENTORY_ADJUSTMENT_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryAdjustmentAction>(modelAction.InventoryAdjustmentModelActionTypes.UPDATE_INVENTORY_ADJUSTMENT),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as InventoryAdjustmentModel;
				...
				return this.service.update(new InventoryAdjustmentModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.InventoryAdjustmentActionOK(
						modelAction.InventoryAdjustmentModelActionTypes.UPDATE_INVENTORY_ADJUSTMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryAdjustmentActionFail(
								modelAction.InventoryAdjustmentModelActionTypes.UPDATE_INVENTORY_ADJUSTMENT_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryAdjustmentAction>(modelAction.InventoryAdjustmentModelActionTypes.UPDATE_ALL_INVENTORY_ADJUSTMENT),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as InventoryAdjustmentModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new InventoryAdjustmentModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InventoryAdjustmentActionOK(
						modelAction.InventoryAdjustmentModelActionTypes.UPDATE_ALL_INVENTORY_ADJUSTMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryAdjustmentActionFail(
								modelAction.InventoryAdjustmentModelActionTypes.UPDATE_ALL_INVENTORY_ADJUSTMENT_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryAdjustmentAction>(modelAction.InventoryAdjustmentModelActionTypes.DELETE_INVENTORY_ADJUSTMENT),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.InventoryAdjustmentActionOK(
						modelAction.InventoryAdjustmentModelActionTypes.DELETE_INVENTORY_ADJUSTMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryAdjustmentActionFail(
								modelAction.InventoryAdjustmentModelActionTypes.DELETE_INVENTORY_ADJUSTMENT_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryAdjustmentAction>(modelAction.InventoryAdjustmentModelActionTypes.DELETE_INVENTORY_ADJUSTMENT_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.InventoryAdjustmentActionOK(
						modelAction.InventoryAdjustmentModelActionTypes.DELETE_INVENTORY_ADJUSTMENT_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryAdjustmentActionFail(
								modelAction.InventoryAdjustmentModelActionTypes.DELETE_INVENTORY_ADJUSTMENT_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryAdjustmentAction>(modelAction.InventoryAdjustmentModelActionTypes.DELETE_ALL_INVENTORY_ADJUSTMENT),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.InventoryAdjustmentActionOK(
						modelAction.InventoryAdjustmentModelActionTypes.DELETE_ALL_INVENTORY_ADJUSTMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryAdjustmentActionFail(
								modelAction.InventoryAdjustmentModelActionTypes.DELETE_ALL_INVENTORY_ADJUSTMENT_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryAdjustmentAction>(modelAction.InventoryAdjustmentModelActionTypes.EXPORT_INVENTORY_ADJUSTMENT),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.InventoryAdjustmentActionOK(
						modelAction.InventoryAdjustmentModelActionTypes.EXPORT_INVENTORY_ADJUSTMENT,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryAdjustmentAction>(modelAction.InventoryAdjustmentModelActionTypes.EXPORT_ALL_INVENTORY_ADJUSTMENT),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.InventoryAdjustmentActionOK(
						modelAction.InventoryAdjustmentModelActionTypes.EXPORT_ALL_INVENTORY_ADJUSTMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryAdjustmentActionFail(
								modelAction.InventoryAdjustmentModelActionTypes.EXPORT_ALL_INVENTORY_ADJUSTMENT_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryAdjustmentAction>(modelAction.InventoryAdjustmentModelActionTypes.EXPORT_INVENTORY_ADJUSTMENT_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.InventoryAdjustmentActionOK(
						modelAction.InventoryAdjustmentModelActionTypes.EXPORT_INVENTORY_ADJUSTMENT_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryAdjustmentActionFail(
								modelAction.InventoryAdjustmentModelActionTypes.EXPORT_INVENTORY_ADJUSTMENT_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryAdjustmentAction>(modelAction.InventoryAdjustmentModelActionTypes.IMPORT_INVENTORY_ADJUSTMENTS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.InventoryAdjustmentActionOK(
						modelAction.InventoryAdjustmentModelActionTypes.IMPORT_INVENTORY_ADJUSTMENTS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InventoryAdjustmentActionFail(
								modelAction.InventoryAdjustmentModelActionTypes.IMPORT_INVENTORY_ADJUSTMENTS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryAdjustmentAction>(modelAction.InventoryAdjustmentModelActionTypes.FETCH_INVENTORY_ADJUSTMENT_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.InventoryAdjustmentActionOK(
						modelAction.InventoryAdjustmentModelActionTypes.FETCH_INVENTORY_ADJUSTMENT_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.InventoryAdjustmentActionFail(
								modelAction.InventoryAdjustmentModelActionTypes.FETCH_INVENTORY_ADJUSTMENT_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InventoryAdjustmentAction>(modelAction.InventoryAdjustmentModelActionTypes.FETCH_INVENTORY_ADJUSTMENT_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.InventoryAdjustmentActionOK(
						modelAction.InventoryAdjustmentModelActionTypes.FETCH_INVENTORY_ADJUSTMENT_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.InventoryAdjustmentActionFail(
								modelAction.InventoryAdjustmentModelActionTypes.FETCH_INVENTORY_ADJUSTMENT_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
