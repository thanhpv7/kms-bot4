...
/**
 * InternalOrderCollectionState would store the state of a collection of InternalOrder
 */
export interface InternalOrderCollectionState extends CollectionState {
 ...
 */
export interface InternalOrderModelAudit extends AbstractModelAudit<InternalOrderModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * InternalOrderModelState would store the state of the model
 */
export interface InternalOrderModelState {
	collectionState: {
		[key: string]: InternalOrderCollectionState;
	};
	data: {
		[id: string]: InternalOrderModel;
	};
	totalCount: number;
	audits: InternalOrderModelAudit[];
 ...
 */
export const initialInternalOrderCollectionState: InternalOrderCollectionState = {
...
/**
 * The initial state of InternalOrderModelState
 */
export const initialState: InternalOrderModelState = {
	collectionState: {
