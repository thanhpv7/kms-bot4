...
import * as modelAction from './internal_order.model.action';
import {InternalOrderService} from '../../services/internalOrder/internal_order.service';
...
/**
 * Effect class used for side effects related to Internal Order model.
 */
@Injectable()
export class InternalOrderEffect {
	...
	constructor(
		...
		protected readonly service: InternalOrderService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InternalOrderAction>(modelAction.InternalOrderModelActionTypes.COUNT_INTERNAL_ORDERS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.InternalOrderActionOK(
						modelAction.InternalOrderModelActionTypes.COUNT_INTERNAL_ORDERS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InternalOrderActionFail(
								modelAction.InternalOrderModelActionTypes.COUNT_INTERNAL_ORDERS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InternalOrderAction>(modelAction.InternalOrderModelActionTypes.FETCH_INTERNAL_ORDER),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InternalOrderActionOK(
						modelAction.InternalOrderModelActionTypes.FETCH_INTERNAL_ORDER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InternalOrderActionFail(
								modelAction.InternalOrderModelActionTypes.FETCH_INTERNAL_ORDER_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InternalOrderAction>(modelAction.InternalOrderModelActionTypes.FETCH_ALL_INTERNAL_ORDER),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.InternalOrderActionOK(
						modelAction.InternalOrderModelActionTypes.FETCH_ALL_INTERNAL_ORDER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InternalOrderActionFail(
								modelAction.InternalOrderModelActionTypes.FETCH_ALL_INTERNAL_ORDER_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InternalOrderAction>(modelAction.InternalOrderModelActionTypes.FETCH_INTERNAL_ORDER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.InternalOrderActionOK(
						modelAction.InternalOrderModelActionTypes.FETCH_INTERNAL_ORDER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InternalOrderActionFail(
								modelAction.InternalOrderModelActionTypes.FETCH_INTERNAL_ORDER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InternalOrderAction>(modelAction.InternalOrderModelActionTypes.FETCH_LAST_INTERNAL_ORDER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.InternalOrderActionOK(
						modelAction.InternalOrderModelActionTypes.FETCH_LAST_INTERNAL_ORDER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InternalOrderActionFail(
								modelAction.InternalOrderModelActionTypes.FETCH_LAST_INTERNAL_ORDER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InternalOrderAction>(modelAction.InternalOrderModelActionTypes.CREATE_INTERNAL_ORDER),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as InternalOrderModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InternalOrderActionOK(
						modelAction.InternalOrderModelActionTypes.CREATE_INTERNAL_ORDER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InternalOrderActionFail(
								modelAction.InternalOrderModelActionTypes.CREATE_INTERNAL_ORDER_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InternalOrderAction>(modelAction.InternalOrderModelActionTypes.CREATE_ALL_INTERNAL_ORDER),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as InternalOrderModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InternalOrderActionOK(
						modelAction.InternalOrderModelActionTypes.CREATE_ALL_INTERNAL_ORDER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InternalOrderActionFail(
								modelAction.InternalOrderModelActionTypes.CREATE_ALL_INTERNAL_ORDER_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InternalOrderAction>(modelAction.InternalOrderModelActionTypes.UPDATE_INTERNAL_ORDER),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as InternalOrderModel;
				...
				return this.service.update(new InternalOrderModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.InternalOrderActionOK(
						modelAction.InternalOrderModelActionTypes.UPDATE_INTERNAL_ORDER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InternalOrderActionFail(
								modelAction.InternalOrderModelActionTypes.UPDATE_INTERNAL_ORDER_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InternalOrderAction>(modelAction.InternalOrderModelActionTypes.UPDATE_ALL_INTERNAL_ORDER),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as InternalOrderModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new InternalOrderModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InternalOrderActionOK(
						modelAction.InternalOrderModelActionTypes.UPDATE_ALL_INTERNAL_ORDER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InternalOrderActionFail(
								modelAction.InternalOrderModelActionTypes.UPDATE_ALL_INTERNAL_ORDER_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InternalOrderAction>(modelAction.InternalOrderModelActionTypes.DELETE_INTERNAL_ORDER),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.InternalOrderActionOK(
						modelAction.InternalOrderModelActionTypes.DELETE_INTERNAL_ORDER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InternalOrderActionFail(
								modelAction.InternalOrderModelActionTypes.DELETE_INTERNAL_ORDER_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InternalOrderAction>(modelAction.InternalOrderModelActionTypes.DELETE_INTERNAL_ORDER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.InternalOrderActionOK(
						modelAction.InternalOrderModelActionTypes.DELETE_INTERNAL_ORDER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InternalOrderActionFail(
								modelAction.InternalOrderModelActionTypes.DELETE_INTERNAL_ORDER_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InternalOrderAction>(modelAction.InternalOrderModelActionTypes.DELETE_ALL_INTERNAL_ORDER),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.InternalOrderActionOK(
						modelAction.InternalOrderModelActionTypes.DELETE_ALL_INTERNAL_ORDER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InternalOrderActionFail(
								modelAction.InternalOrderModelActionTypes.DELETE_ALL_INTERNAL_ORDER_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InternalOrderAction>(modelAction.InternalOrderModelActionTypes.EXPORT_INTERNAL_ORDER),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.InternalOrderActionOK(
						modelAction.InternalOrderModelActionTypes.EXPORT_INTERNAL_ORDER,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InternalOrderAction>(modelAction.InternalOrderModelActionTypes.EXPORT_ALL_INTERNAL_ORDER),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.InternalOrderActionOK(
						modelAction.InternalOrderModelActionTypes.EXPORT_ALL_INTERNAL_ORDER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InternalOrderActionFail(
								modelAction.InternalOrderModelActionTypes.EXPORT_ALL_INTERNAL_ORDER_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InternalOrderAction>(modelAction.InternalOrderModelActionTypes.EXPORT_INTERNAL_ORDER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.InternalOrderActionOK(
						modelAction.InternalOrderModelActionTypes.EXPORT_INTERNAL_ORDER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InternalOrderActionFail(
								modelAction.InternalOrderModelActionTypes.EXPORT_INTERNAL_ORDER_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InternalOrderAction>(modelAction.InternalOrderModelActionTypes.IMPORT_INTERNAL_ORDERS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.InternalOrderActionOK(
						modelAction.InternalOrderModelActionTypes.IMPORT_INTERNAL_ORDERS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InternalOrderActionFail(
								modelAction.InternalOrderModelActionTypes.IMPORT_INTERNAL_ORDERS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InternalOrderAction>(modelAction.InternalOrderModelActionTypes.FETCH_INTERNAL_ORDER_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.InternalOrderActionOK(
						modelAction.InternalOrderModelActionTypes.FETCH_INTERNAL_ORDER_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.InternalOrderActionFail(
								modelAction.InternalOrderModelActionTypes.FETCH_INTERNAL_ORDER_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InternalOrderAction>(modelAction.InternalOrderModelActionTypes.FETCH_INTERNAL_ORDER_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.InternalOrderActionOK(
						modelAction.InternalOrderModelActionTypes.FETCH_INTERNAL_ORDER_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.InternalOrderActionFail(
								modelAction.InternalOrderModelActionTypes.FETCH_INTERNAL_ORDER_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
