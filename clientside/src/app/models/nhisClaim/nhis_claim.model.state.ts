...
/**
 * NhisClaimCollectionState would store the state of a collection of NhisClaim
 */
export interface NhisClaimCollectionState extends CollectionState {
 ...
 */
export interface NhisClaimModelAudit extends AbstractModelAudit<NhisClaimModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * NhisClaimModelState would store the state of the model
 */
export interface NhisClaimModelState {
	collectionState: {
		[key: string]: NhisClaimCollectionState;
	};
	data: {
		[id: string]: NhisClaimModel;
	};
	totalCount: number;
	audits: NhisClaimModelAudit[];
 ...
 */
export const initialNhisClaimCollectionState: NhisClaimCollectionState = {
...
/**
 * The initial state of NhisClaimModelState
 */
export const initialState: NhisClaimModelState = {
	collectionState: {
