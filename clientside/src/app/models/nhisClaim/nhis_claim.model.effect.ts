...
import * as modelAction from './nhis_claim.model.action';
import {NhisClaimService} from '../../services/nhisClaim/nhis_claim.service';
...
/**
 * Effect class used for side effects related to NHIS Claim model.
 */
@Injectable()
export class NhisClaimEffect {
	...
	constructor(
		...
		protected readonly service: NhisClaimService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisClaimAction>(modelAction.NhisClaimModelActionTypes.COUNT_NHIS_CLAIMS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.NhisClaimActionOK(
						modelAction.NhisClaimModelActionTypes.COUNT_NHIS_CLAIMS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisClaimActionFail(
								modelAction.NhisClaimModelActionTypes.COUNT_NHIS_CLAIMS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisClaimAction>(modelAction.NhisClaimModelActionTypes.FETCH_NHIS_CLAIM),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisClaimActionOK(
						modelAction.NhisClaimModelActionTypes.FETCH_NHIS_CLAIM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisClaimActionFail(
								modelAction.NhisClaimModelActionTypes.FETCH_NHIS_CLAIM_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisClaimAction>(modelAction.NhisClaimModelActionTypes.FETCH_ALL_NHIS_CLAIM),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.NhisClaimActionOK(
						modelAction.NhisClaimModelActionTypes.FETCH_ALL_NHIS_CLAIM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisClaimActionFail(
								modelAction.NhisClaimModelActionTypes.FETCH_ALL_NHIS_CLAIM_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisClaimAction>(modelAction.NhisClaimModelActionTypes.FETCH_NHIS_CLAIM_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisClaimActionOK(
						modelAction.NhisClaimModelActionTypes.FETCH_NHIS_CLAIM_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisClaimActionFail(
								modelAction.NhisClaimModelActionTypes.FETCH_NHIS_CLAIM_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisClaimAction>(modelAction.NhisClaimModelActionTypes.FETCH_LAST_NHIS_CLAIM_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisClaimActionOK(
						modelAction.NhisClaimModelActionTypes.FETCH_LAST_NHIS_CLAIM_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisClaimActionFail(
								modelAction.NhisClaimModelActionTypes.FETCH_LAST_NHIS_CLAIM_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisClaimAction>(modelAction.NhisClaimModelActionTypes.CREATE_NHIS_CLAIM),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as NhisClaimModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisClaimActionOK(
						modelAction.NhisClaimModelActionTypes.CREATE_NHIS_CLAIM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisClaimActionFail(
								modelAction.NhisClaimModelActionTypes.CREATE_NHIS_CLAIM_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisClaimAction>(modelAction.NhisClaimModelActionTypes.CREATE_ALL_NHIS_CLAIM),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as NhisClaimModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisClaimActionOK(
						modelAction.NhisClaimModelActionTypes.CREATE_ALL_NHIS_CLAIM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisClaimActionFail(
								modelAction.NhisClaimModelActionTypes.CREATE_ALL_NHIS_CLAIM_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisClaimAction>(modelAction.NhisClaimModelActionTypes.UPDATE_NHIS_CLAIM),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as NhisClaimModel;
				...
				return this.service.update(new NhisClaimModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisClaimActionOK(
						modelAction.NhisClaimModelActionTypes.UPDATE_NHIS_CLAIM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisClaimActionFail(
								modelAction.NhisClaimModelActionTypes.UPDATE_NHIS_CLAIM_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisClaimAction>(modelAction.NhisClaimModelActionTypes.UPDATE_ALL_NHIS_CLAIM),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as NhisClaimModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new NhisClaimModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisClaimActionOK(
						modelAction.NhisClaimModelActionTypes.UPDATE_ALL_NHIS_CLAIM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisClaimActionFail(
								modelAction.NhisClaimModelActionTypes.UPDATE_ALL_NHIS_CLAIM_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisClaimAction>(modelAction.NhisClaimModelActionTypes.DELETE_NHIS_CLAIM),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.NhisClaimActionOK(
						modelAction.NhisClaimModelActionTypes.DELETE_NHIS_CLAIM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisClaimActionFail(
								modelAction.NhisClaimModelActionTypes.DELETE_NHIS_CLAIM_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisClaimAction>(modelAction.NhisClaimModelActionTypes.DELETE_NHIS_CLAIM_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.NhisClaimActionOK(
						modelAction.NhisClaimModelActionTypes.DELETE_NHIS_CLAIM_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisClaimActionFail(
								modelAction.NhisClaimModelActionTypes.DELETE_NHIS_CLAIM_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisClaimAction>(modelAction.NhisClaimModelActionTypes.DELETE_ALL_NHIS_CLAIM),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.NhisClaimActionOK(
						modelAction.NhisClaimModelActionTypes.DELETE_ALL_NHIS_CLAIM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisClaimActionFail(
								modelAction.NhisClaimModelActionTypes.DELETE_ALL_NHIS_CLAIM_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisClaimAction>(modelAction.NhisClaimModelActionTypes.EXPORT_NHIS_CLAIM),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.NhisClaimActionOK(
						modelAction.NhisClaimModelActionTypes.EXPORT_NHIS_CLAIM,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisClaimAction>(modelAction.NhisClaimModelActionTypes.EXPORT_ALL_NHIS_CLAIM),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.NhisClaimActionOK(
						modelAction.NhisClaimModelActionTypes.EXPORT_ALL_NHIS_CLAIM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisClaimActionFail(
								modelAction.NhisClaimModelActionTypes.EXPORT_ALL_NHIS_CLAIM_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisClaimAction>(modelAction.NhisClaimModelActionTypes.EXPORT_NHIS_CLAIM_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.NhisClaimActionOK(
						modelAction.NhisClaimModelActionTypes.EXPORT_NHIS_CLAIM_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisClaimActionFail(
								modelAction.NhisClaimModelActionTypes.EXPORT_NHIS_CLAIM_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisClaimAction>(modelAction.NhisClaimModelActionTypes.IMPORT_NHIS_CLAIMS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.NhisClaimActionOK(
						modelAction.NhisClaimModelActionTypes.IMPORT_NHIS_CLAIMS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisClaimActionFail(
								modelAction.NhisClaimModelActionTypes.IMPORT_NHIS_CLAIMS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisClaimAction>(modelAction.NhisClaimModelActionTypes.FETCH_NHIS_CLAIM_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.NhisClaimActionOK(
						modelAction.NhisClaimModelActionTypes.FETCH_NHIS_CLAIM_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.NhisClaimActionFail(
								modelAction.NhisClaimModelActionTypes.FETCH_NHIS_CLAIM_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisClaimAction>(modelAction.NhisClaimModelActionTypes.FETCH_NHIS_CLAIM_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.NhisClaimActionOK(
						modelAction.NhisClaimModelActionTypes.FETCH_NHIS_CLAIM_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.NhisClaimActionFail(
								modelAction.NhisClaimModelActionTypes.FETCH_NHIS_CLAIM_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
