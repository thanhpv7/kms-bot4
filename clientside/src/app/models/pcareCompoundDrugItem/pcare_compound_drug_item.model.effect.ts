...
import * as modelAction from './pcare_compound_drug_item.model.action';
import {PcareCompoundDrugItemService} from '../../services/pcareCompoundDrugItem/pcare_compound_drug_item.service';
...
/**
 * Effect class used for side effects related to PCare Compound Drug Item model.
 */
@Injectable()
export class PcareCompoundDrugItemEffect {
	...
	constructor(
		...
		protected readonly service: PcareCompoundDrugItemService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareCompoundDrugItemAction>(modelAction.PcareCompoundDrugItemModelActionTypes.COUNT_PCARE_COMPOUND_DRUG_ITEMS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.PcareCompoundDrugItemActionOK(
						modelAction.PcareCompoundDrugItemModelActionTypes.COUNT_PCARE_COMPOUND_DRUG_ITEMS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareCompoundDrugItemActionFail(
								modelAction.PcareCompoundDrugItemModelActionTypes.COUNT_PCARE_COMPOUND_DRUG_ITEMS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareCompoundDrugItemAction>(modelAction.PcareCompoundDrugItemModelActionTypes.FETCH_PCARE_COMPOUND_DRUG_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareCompoundDrugItemActionOK(
						modelAction.PcareCompoundDrugItemModelActionTypes.FETCH_PCARE_COMPOUND_DRUG_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareCompoundDrugItemActionFail(
								modelAction.PcareCompoundDrugItemModelActionTypes.FETCH_PCARE_COMPOUND_DRUG_ITEM_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareCompoundDrugItemAction>(modelAction.PcareCompoundDrugItemModelActionTypes.FETCH_ALL_PCARE_COMPOUND_DRUG_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.PcareCompoundDrugItemActionOK(
						modelAction.PcareCompoundDrugItemModelActionTypes.FETCH_ALL_PCARE_COMPOUND_DRUG_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareCompoundDrugItemActionFail(
								modelAction.PcareCompoundDrugItemModelActionTypes.FETCH_ALL_PCARE_COMPOUND_DRUG_ITEM_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareCompoundDrugItemAction>(modelAction.PcareCompoundDrugItemModelActionTypes.FETCH_PCARE_COMPOUND_DRUG_ITEM_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareCompoundDrugItemActionOK(
						modelAction.PcareCompoundDrugItemModelActionTypes.FETCH_PCARE_COMPOUND_DRUG_ITEM_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareCompoundDrugItemActionFail(
								modelAction.PcareCompoundDrugItemModelActionTypes.FETCH_PCARE_COMPOUND_DRUG_ITEM_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareCompoundDrugItemAction>(modelAction.PcareCompoundDrugItemModelActionTypes.FETCH_LAST_PCARE_COMPOUND_DRUG_ITEM_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareCompoundDrugItemActionOK(
						modelAction.PcareCompoundDrugItemModelActionTypes.FETCH_LAST_PCARE_COMPOUND_DRUG_ITEM_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareCompoundDrugItemActionFail(
								modelAction.PcareCompoundDrugItemModelActionTypes.FETCH_LAST_PCARE_COMPOUND_DRUG_ITEM_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareCompoundDrugItemAction>(modelAction.PcareCompoundDrugItemModelActionTypes.CREATE_PCARE_COMPOUND_DRUG_ITEM),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as PcareCompoundDrugItemModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareCompoundDrugItemActionOK(
						modelAction.PcareCompoundDrugItemModelActionTypes.CREATE_PCARE_COMPOUND_DRUG_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareCompoundDrugItemActionFail(
								modelAction.PcareCompoundDrugItemModelActionTypes.CREATE_PCARE_COMPOUND_DRUG_ITEM_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareCompoundDrugItemAction>(modelAction.PcareCompoundDrugItemModelActionTypes.CREATE_ALL_PCARE_COMPOUND_DRUG_ITEM),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as PcareCompoundDrugItemModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareCompoundDrugItemActionOK(
						modelAction.PcareCompoundDrugItemModelActionTypes.CREATE_ALL_PCARE_COMPOUND_DRUG_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareCompoundDrugItemActionFail(
								modelAction.PcareCompoundDrugItemModelActionTypes.CREATE_ALL_PCARE_COMPOUND_DRUG_ITEM_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareCompoundDrugItemAction>(modelAction.PcareCompoundDrugItemModelActionTypes.UPDATE_PCARE_COMPOUND_DRUG_ITEM),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as PcareCompoundDrugItemModel;
				...
				return this.service.update(new PcareCompoundDrugItemModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareCompoundDrugItemActionOK(
						modelAction.PcareCompoundDrugItemModelActionTypes.UPDATE_PCARE_COMPOUND_DRUG_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareCompoundDrugItemActionFail(
								modelAction.PcareCompoundDrugItemModelActionTypes.UPDATE_PCARE_COMPOUND_DRUG_ITEM_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareCompoundDrugItemAction>(modelAction.PcareCompoundDrugItemModelActionTypes.UPDATE_ALL_PCARE_COMPOUND_DRUG_ITEM),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as PcareCompoundDrugItemModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new PcareCompoundDrugItemModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareCompoundDrugItemActionOK(
						modelAction.PcareCompoundDrugItemModelActionTypes.UPDATE_ALL_PCARE_COMPOUND_DRUG_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareCompoundDrugItemActionFail(
								modelAction.PcareCompoundDrugItemModelActionTypes.UPDATE_ALL_PCARE_COMPOUND_DRUG_ITEM_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareCompoundDrugItemAction>(modelAction.PcareCompoundDrugItemModelActionTypes.DELETE_PCARE_COMPOUND_DRUG_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PcareCompoundDrugItemActionOK(
						modelAction.PcareCompoundDrugItemModelActionTypes.DELETE_PCARE_COMPOUND_DRUG_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareCompoundDrugItemActionFail(
								modelAction.PcareCompoundDrugItemModelActionTypes.DELETE_PCARE_COMPOUND_DRUG_ITEM_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareCompoundDrugItemAction>(modelAction.PcareCompoundDrugItemModelActionTypes.DELETE_PCARE_COMPOUND_DRUG_ITEM_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.PcareCompoundDrugItemActionOK(
						modelAction.PcareCompoundDrugItemModelActionTypes.DELETE_PCARE_COMPOUND_DRUG_ITEM_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareCompoundDrugItemActionFail(
								modelAction.PcareCompoundDrugItemModelActionTypes.DELETE_PCARE_COMPOUND_DRUG_ITEM_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareCompoundDrugItemAction>(modelAction.PcareCompoundDrugItemModelActionTypes.DELETE_ALL_PCARE_COMPOUND_DRUG_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PcareCompoundDrugItemActionOK(
						modelAction.PcareCompoundDrugItemModelActionTypes.DELETE_ALL_PCARE_COMPOUND_DRUG_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareCompoundDrugItemActionFail(
								modelAction.PcareCompoundDrugItemModelActionTypes.DELETE_ALL_PCARE_COMPOUND_DRUG_ITEM_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareCompoundDrugItemAction>(modelAction.PcareCompoundDrugItemModelActionTypes.EXPORT_PCARE_COMPOUND_DRUG_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PcareCompoundDrugItemActionOK(
						modelAction.PcareCompoundDrugItemModelActionTypes.EXPORT_PCARE_COMPOUND_DRUG_ITEM,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareCompoundDrugItemAction>(modelAction.PcareCompoundDrugItemModelActionTypes.EXPORT_ALL_PCARE_COMPOUND_DRUG_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PcareCompoundDrugItemActionOK(
						modelAction.PcareCompoundDrugItemModelActionTypes.EXPORT_ALL_PCARE_COMPOUND_DRUG_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareCompoundDrugItemActionFail(
								modelAction.PcareCompoundDrugItemModelActionTypes.EXPORT_ALL_PCARE_COMPOUND_DRUG_ITEM_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareCompoundDrugItemAction>(modelAction.PcareCompoundDrugItemModelActionTypes.EXPORT_PCARE_COMPOUND_DRUG_ITEM_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PcareCompoundDrugItemActionOK(
						modelAction.PcareCompoundDrugItemModelActionTypes.EXPORT_PCARE_COMPOUND_DRUG_ITEM_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareCompoundDrugItemActionFail(
								modelAction.PcareCompoundDrugItemModelActionTypes.EXPORT_PCARE_COMPOUND_DRUG_ITEM_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareCompoundDrugItemAction>(modelAction.PcareCompoundDrugItemModelActionTypes.IMPORT_PCARE_COMPOUND_DRUG_ITEMS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.PcareCompoundDrugItemActionOK(
						modelAction.PcareCompoundDrugItemModelActionTypes.IMPORT_PCARE_COMPOUND_DRUG_ITEMS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareCompoundDrugItemActionFail(
								modelAction.PcareCompoundDrugItemModelActionTypes.IMPORT_PCARE_COMPOUND_DRUG_ITEMS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareCompoundDrugItemAction>(modelAction.PcareCompoundDrugItemModelActionTypes.FETCH_PCARE_COMPOUND_DRUG_ITEM_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.PcareCompoundDrugItemActionOK(
						modelAction.PcareCompoundDrugItemModelActionTypes.FETCH_PCARE_COMPOUND_DRUG_ITEM_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PcareCompoundDrugItemActionFail(
								modelAction.PcareCompoundDrugItemModelActionTypes.FETCH_PCARE_COMPOUND_DRUG_ITEM_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareCompoundDrugItemAction>(modelAction.PcareCompoundDrugItemModelActionTypes.FETCH_PCARE_COMPOUND_DRUG_ITEM_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.PcareCompoundDrugItemActionOK(
						modelAction.PcareCompoundDrugItemModelActionTypes.FETCH_PCARE_COMPOUND_DRUG_ITEM_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PcareCompoundDrugItemActionFail(
								modelAction.PcareCompoundDrugItemModelActionTypes.FETCH_PCARE_COMPOUND_DRUG_ITEM_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
