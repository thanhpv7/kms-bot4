...
/**
 * PcareCompoundDrugItemCollectionState would store the state of a collection of PcareCompoundDrugItem
 */
export interface PcareCompoundDrugItemCollectionState extends CollectionState {
 ...
 */
export interface PcareCompoundDrugItemModelAudit extends AbstractModelAudit<PcareCompoundDrugItemModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * PcareCompoundDrugItemModelState would store the state of the model
 */
export interface PcareCompoundDrugItemModelState {
	collectionState: {
		[key: string]: PcareCompoundDrugItemCollectionState;
	};
	data: {
		[id: string]: PcareCompoundDrugItemModel;
	};
	totalCount: number;
	audits: PcareCompoundDrugItemModelAudit[];
 ...
 */
export const initialPcareCompoundDrugItemCollectionState: PcareCompoundDrugItemCollectionState = {
...
/**
 * The initial state of PcareCompoundDrugItemModelState
 */
export const initialState: PcareCompoundDrugItemModelState = {
	collectionState: {
