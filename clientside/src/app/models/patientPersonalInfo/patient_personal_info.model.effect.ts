...
import * as modelAction from './patient_personal_info.model.action';
import {PatientPersonalInfoService} from '../../services/patientPersonalInfo/patient_personal_info.service';
...
/**
 * Effect class used for side effects related to Patient Personal Info model.
 */
@Injectable()
export class PatientPersonalInfoEffect {
	...
	constructor(
		...
		protected readonly service: PatientPersonalInfoService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPersonalInfoAction>(modelAction.PatientPersonalInfoModelActionTypes.COUNT_PATIENT_PERSONAL_INFOS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.PatientPersonalInfoActionOK(
						modelAction.PatientPersonalInfoModelActionTypes.COUNT_PATIENT_PERSONAL_INFOS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientPersonalInfoActionFail(
								modelAction.PatientPersonalInfoModelActionTypes.COUNT_PATIENT_PERSONAL_INFOS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPersonalInfoAction>(modelAction.PatientPersonalInfoModelActionTypes.FETCH_PATIENT_PERSONAL_INFO),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientPersonalInfoActionOK(
						modelAction.PatientPersonalInfoModelActionTypes.FETCH_PATIENT_PERSONAL_INFO_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientPersonalInfoActionFail(
								modelAction.PatientPersonalInfoModelActionTypes.FETCH_PATIENT_PERSONAL_INFO_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPersonalInfoAction>(modelAction.PatientPersonalInfoModelActionTypes.FETCH_ALL_PATIENT_PERSONAL_INFO),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.PatientPersonalInfoActionOK(
						modelAction.PatientPersonalInfoModelActionTypes.FETCH_ALL_PATIENT_PERSONAL_INFO_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientPersonalInfoActionFail(
								modelAction.PatientPersonalInfoModelActionTypes.FETCH_ALL_PATIENT_PERSONAL_INFO_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPersonalInfoAction>(modelAction.PatientPersonalInfoModelActionTypes.FETCH_PATIENT_PERSONAL_INFO_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientPersonalInfoActionOK(
						modelAction.PatientPersonalInfoModelActionTypes.FETCH_PATIENT_PERSONAL_INFO_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientPersonalInfoActionFail(
								modelAction.PatientPersonalInfoModelActionTypes.FETCH_PATIENT_PERSONAL_INFO_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPersonalInfoAction>(modelAction.PatientPersonalInfoModelActionTypes.FETCH_LAST_PATIENT_PERSONAL_INFO_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientPersonalInfoActionOK(
						modelAction.PatientPersonalInfoModelActionTypes.FETCH_LAST_PATIENT_PERSONAL_INFO_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientPersonalInfoActionFail(
								modelAction.PatientPersonalInfoModelActionTypes.FETCH_LAST_PATIENT_PERSONAL_INFO_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPersonalInfoAction>(modelAction.PatientPersonalInfoModelActionTypes.CREATE_PATIENT_PERSONAL_INFO),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as PatientPersonalInfoModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientPersonalInfoActionOK(
						modelAction.PatientPersonalInfoModelActionTypes.CREATE_PATIENT_PERSONAL_INFO_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientPersonalInfoActionFail(
								modelAction.PatientPersonalInfoModelActionTypes.CREATE_PATIENT_PERSONAL_INFO_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPersonalInfoAction>(modelAction.PatientPersonalInfoModelActionTypes.CREATE_ALL_PATIENT_PERSONAL_INFO),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as PatientPersonalInfoModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientPersonalInfoActionOK(
						modelAction.PatientPersonalInfoModelActionTypes.CREATE_ALL_PATIENT_PERSONAL_INFO_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientPersonalInfoActionFail(
								modelAction.PatientPersonalInfoModelActionTypes.CREATE_ALL_PATIENT_PERSONAL_INFO_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPersonalInfoAction>(modelAction.PatientPersonalInfoModelActionTypes.UPDATE_PATIENT_PERSONAL_INFO),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as PatientPersonalInfoModel;
				...
				return this.service.update(new PatientPersonalInfoModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientPersonalInfoActionOK(
						modelAction.PatientPersonalInfoModelActionTypes.UPDATE_PATIENT_PERSONAL_INFO_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientPersonalInfoActionFail(
								modelAction.PatientPersonalInfoModelActionTypes.UPDATE_PATIENT_PERSONAL_INFO_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPersonalInfoAction>(modelAction.PatientPersonalInfoModelActionTypes.UPDATE_ALL_PATIENT_PERSONAL_INFO),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as PatientPersonalInfoModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new PatientPersonalInfoModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientPersonalInfoActionOK(
						modelAction.PatientPersonalInfoModelActionTypes.UPDATE_ALL_PATIENT_PERSONAL_INFO_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientPersonalInfoActionFail(
								modelAction.PatientPersonalInfoModelActionTypes.UPDATE_ALL_PATIENT_PERSONAL_INFO_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPersonalInfoAction>(modelAction.PatientPersonalInfoModelActionTypes.DELETE_PATIENT_PERSONAL_INFO),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PatientPersonalInfoActionOK(
						modelAction.PatientPersonalInfoModelActionTypes.DELETE_PATIENT_PERSONAL_INFO_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientPersonalInfoActionFail(
								modelAction.PatientPersonalInfoModelActionTypes.DELETE_PATIENT_PERSONAL_INFO_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPersonalInfoAction>(modelAction.PatientPersonalInfoModelActionTypes.DELETE_PATIENT_PERSONAL_INFO_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.PatientPersonalInfoActionOK(
						modelAction.PatientPersonalInfoModelActionTypes.DELETE_PATIENT_PERSONAL_INFO_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientPersonalInfoActionFail(
								modelAction.PatientPersonalInfoModelActionTypes.DELETE_PATIENT_PERSONAL_INFO_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPersonalInfoAction>(modelAction.PatientPersonalInfoModelActionTypes.DELETE_ALL_PATIENT_PERSONAL_INFO),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PatientPersonalInfoActionOK(
						modelAction.PatientPersonalInfoModelActionTypes.DELETE_ALL_PATIENT_PERSONAL_INFO_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientPersonalInfoActionFail(
								modelAction.PatientPersonalInfoModelActionTypes.DELETE_ALL_PATIENT_PERSONAL_INFO_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPersonalInfoAction>(modelAction.PatientPersonalInfoModelActionTypes.EXPORT_PATIENT_PERSONAL_INFO),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PatientPersonalInfoActionOK(
						modelAction.PatientPersonalInfoModelActionTypes.EXPORT_PATIENT_PERSONAL_INFO,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPersonalInfoAction>(modelAction.PatientPersonalInfoModelActionTypes.EXPORT_ALL_PATIENT_PERSONAL_INFO),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PatientPersonalInfoActionOK(
						modelAction.PatientPersonalInfoModelActionTypes.EXPORT_ALL_PATIENT_PERSONAL_INFO_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientPersonalInfoActionFail(
								modelAction.PatientPersonalInfoModelActionTypes.EXPORT_ALL_PATIENT_PERSONAL_INFO_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPersonalInfoAction>(modelAction.PatientPersonalInfoModelActionTypes.EXPORT_PATIENT_PERSONAL_INFO_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PatientPersonalInfoActionOK(
						modelAction.PatientPersonalInfoModelActionTypes.EXPORT_PATIENT_PERSONAL_INFO_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientPersonalInfoActionFail(
								modelAction.PatientPersonalInfoModelActionTypes.EXPORT_PATIENT_PERSONAL_INFO_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPersonalInfoAction>(modelAction.PatientPersonalInfoModelActionTypes.IMPORT_PATIENT_PERSONAL_INFOS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.PatientPersonalInfoActionOK(
						modelAction.PatientPersonalInfoModelActionTypes.IMPORT_PATIENT_PERSONAL_INFOS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientPersonalInfoActionFail(
								modelAction.PatientPersonalInfoModelActionTypes.IMPORT_PATIENT_PERSONAL_INFOS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPersonalInfoAction>(modelAction.PatientPersonalInfoModelActionTypes.FETCH_PATIENT_PERSONAL_INFO_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.PatientPersonalInfoActionOK(
						modelAction.PatientPersonalInfoModelActionTypes.FETCH_PATIENT_PERSONAL_INFO_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PatientPersonalInfoActionFail(
								modelAction.PatientPersonalInfoModelActionTypes.FETCH_PATIENT_PERSONAL_INFO_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPersonalInfoAction>(modelAction.PatientPersonalInfoModelActionTypes.FETCH_PATIENT_PERSONAL_INFO_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.PatientPersonalInfoActionOK(
						modelAction.PatientPersonalInfoModelActionTypes.FETCH_PATIENT_PERSONAL_INFO_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PatientPersonalInfoActionFail(
								modelAction.PatientPersonalInfoModelActionTypes.FETCH_PATIENT_PERSONAL_INFO_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
