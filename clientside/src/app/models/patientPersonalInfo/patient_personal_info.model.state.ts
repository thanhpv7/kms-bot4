...
/**
 * PatientPersonalInfoCollectionState would store the state of a collection of PatientPersonalInfo
 */
export interface PatientPersonalInfoCollectionState extends CollectionState {
 ...
 */
export interface PatientPersonalInfoModelAudit extends AbstractModelAudit<PatientPersonalInfoModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * PatientPersonalInfoModelState would store the state of the model
 */
export interface PatientPersonalInfoModelState {
	collectionState: {
		[key: string]: PatientPersonalInfoCollectionState;
	};
	data: {
		[id: string]: PatientPersonalInfoModel;
	};
	totalCount: number;
	audits: PatientPersonalInfoModelAudit[];
 ...
 */
export const initialPatientPersonalInfoCollectionState: PatientPersonalInfoCollectionState = {
...
/**
 * The initial state of PatientPersonalInfoModelState
 */
export const initialState: PatientPersonalInfoModelState = {
	collectionState: {
