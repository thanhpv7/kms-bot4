...
/**
 * PatientVisitCollectionState would store the state of a collection of PatientVisit
 */
export interface PatientVisitCollectionState extends CollectionState {
 ...
 */
export interface PatientVisitModelAudit extends AbstractModelAudit<PatientVisitModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * PatientVisitModelState would store the state of the model
 */
export interface PatientVisitModelState {
	collectionState: {
		[key: string]: PatientVisitCollectionState;
	};
	data: {
		[id: string]: PatientVisitModel;
	};
	totalCount: number;
	audits: PatientVisitModelAudit[];
 ...
 */
export const initialPatientVisitCollectionState: PatientVisitCollectionState = {
...
/**
 * The initial state of PatientVisitModelState
 */
export const initialState: PatientVisitModelState = {
	collectionState: {
