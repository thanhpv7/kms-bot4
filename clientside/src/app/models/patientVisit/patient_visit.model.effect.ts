...
import {PatientVisitService} from '../../services/patientVisit/patient_visit.service';
...
/**
 * Effect class used for side effects related to Patient Visit model.
 */
@Injectable()
export class PatientVisitEffect {
	...
	constructor(
		...
		protected readonly service: PatientVisitService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVisitAction>(modelAction.PatientVisitModelActionTypes.COUNT_PATIENT_VISITS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.PatientVisitActionOK(
						modelAction.PatientVisitModelActionTypes.COUNT_PATIENT_VISITS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientVisitActionFail(
								modelAction.PatientVisitModelActionTypes.COUNT_PATIENT_VISITS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVisitAction>(modelAction.PatientVisitModelActionTypes.FETCH_PATIENT_VISIT),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientVisitActionOK(
						modelAction.PatientVisitModelActionTypes.FETCH_PATIENT_VISIT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientVisitActionFail(
								modelAction.PatientVisitModelActionTypes.FETCH_PATIENT_VISIT_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVisitAction>(modelAction.PatientVisitModelActionTypes.FETCH_ALL_PATIENT_VISIT),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.PatientVisitActionOK(
						modelAction.PatientVisitModelActionTypes.FETCH_ALL_PATIENT_VISIT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientVisitActionFail(
								modelAction.PatientVisitModelActionTypes.FETCH_ALL_PATIENT_VISIT_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVisitAction>(modelAction.PatientVisitModelActionTypes.FETCH_PATIENT_VISIT_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientVisitActionOK(
						modelAction.PatientVisitModelActionTypes.FETCH_PATIENT_VISIT_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientVisitActionFail(
								modelAction.PatientVisitModelActionTypes.FETCH_PATIENT_VISIT_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVisitAction>(modelAction.PatientVisitModelActionTypes.FETCH_LAST_PATIENT_VISIT_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientVisitActionOK(
						modelAction.PatientVisitModelActionTypes.FETCH_LAST_PATIENT_VISIT_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientVisitActionFail(
								modelAction.PatientVisitModelActionTypes.FETCH_LAST_PATIENT_VISIT_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVisitAction>(modelAction.PatientVisitModelActionTypes.CREATE_PATIENT_VISIT),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as PatientVisitModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientVisitActionOK(
						modelAction.PatientVisitModelActionTypes.CREATE_PATIENT_VISIT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientVisitActionFail(
								modelAction.PatientVisitModelActionTypes.CREATE_PATIENT_VISIT_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVisitAction>(modelAction.PatientVisitModelActionTypes.CREATE_ALL_PATIENT_VISIT),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as PatientVisitModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientVisitActionOK(
						modelAction.PatientVisitModelActionTypes.CREATE_ALL_PATIENT_VISIT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientVisitActionFail(
								modelAction.PatientVisitModelActionTypes.CREATE_ALL_PATIENT_VISIT_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVisitAction>(modelAction.PatientVisitModelActionTypes.UPDATE_PATIENT_VISIT),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as PatientVisitModel;
				...
				return this.service.update(new PatientVisitModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientVisitActionOK(
						modelAction.PatientVisitModelActionTypes.UPDATE_PATIENT_VISIT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientVisitActionFail(
								modelAction.PatientVisitModelActionTypes.UPDATE_PATIENT_VISIT_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVisitAction>(modelAction.PatientVisitModelActionTypes.UPDATE_ALL_PATIENT_VISIT),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as PatientVisitModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new PatientVisitModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientVisitActionOK(
						modelAction.PatientVisitModelActionTypes.UPDATE_ALL_PATIENT_VISIT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientVisitActionFail(
								modelAction.PatientVisitModelActionTypes.UPDATE_ALL_PATIENT_VISIT_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVisitAction>(modelAction.PatientVisitModelActionTypes.DELETE_PATIENT_VISIT),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PatientVisitActionOK(
						modelAction.PatientVisitModelActionTypes.DELETE_PATIENT_VISIT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientVisitActionFail(
								modelAction.PatientVisitModelActionTypes.DELETE_PATIENT_VISIT_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVisitAction>(modelAction.PatientVisitModelActionTypes.DELETE_PATIENT_VISIT_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.PatientVisitActionOK(
						modelAction.PatientVisitModelActionTypes.DELETE_PATIENT_VISIT_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientVisitActionFail(
								modelAction.PatientVisitModelActionTypes.DELETE_PATIENT_VISIT_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVisitAction>(modelAction.PatientVisitModelActionTypes.DELETE_ALL_PATIENT_VISIT),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PatientVisitActionOK(
						modelAction.PatientVisitModelActionTypes.DELETE_ALL_PATIENT_VISIT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientVisitActionFail(
								modelAction.PatientVisitModelActionTypes.DELETE_ALL_PATIENT_VISIT_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVisitAction>(modelAction.PatientVisitModelActionTypes.EXPORT_PATIENT_VISIT),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PatientVisitActionOK(
						modelAction.PatientVisitModelActionTypes.EXPORT_PATIENT_VISIT,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVisitAction>(modelAction.PatientVisitModelActionTypes.EXPORT_ALL_PATIENT_VISIT),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PatientVisitActionOK(
						modelAction.PatientVisitModelActionTypes.EXPORT_ALL_PATIENT_VISIT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientVisitActionFail(
								modelAction.PatientVisitModelActionTypes.EXPORT_ALL_PATIENT_VISIT_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVisitAction>(modelAction.PatientVisitModelActionTypes.EXPORT_PATIENT_VISIT_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PatientVisitActionOK(
						modelAction.PatientVisitModelActionTypes.EXPORT_PATIENT_VISIT_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientVisitActionFail(
								modelAction.PatientVisitModelActionTypes.EXPORT_PATIENT_VISIT_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVisitAction>(modelAction.PatientVisitModelActionTypes.IMPORT_PATIENT_VISITS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.PatientVisitActionOK(
						modelAction.PatientVisitModelActionTypes.IMPORT_PATIENT_VISITS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientVisitActionFail(
								modelAction.PatientVisitModelActionTypes.IMPORT_PATIENT_VISITS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVisitAction>(modelAction.PatientVisitModelActionTypes.FETCH_PATIENT_VISIT_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.PatientVisitActionOK(
						modelAction.PatientVisitModelActionTypes.FETCH_PATIENT_VISIT_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PatientVisitActionFail(
								modelAction.PatientVisitModelActionTypes.FETCH_PATIENT_VISIT_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVisitAction>(modelAction.PatientVisitModelActionTypes.FETCH_PATIENT_VISIT_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.PatientVisitActionOK(
						modelAction.PatientVisitModelActionTypes.FETCH_PATIENT_VISIT_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PatientVisitActionFail(
								modelAction.PatientVisitModelActionTypes.FETCH_PATIENT_VISIT_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
