...
import * as modelAction from './diagnostic_support_user.model.action';
import {DiagnosticSupportUserService} from '../../services/diagnosticSupportUser/diagnostic_support_user.service';
...
/**
 * Effect class used for side effects related to Diagnostic Support User model.
 */
@Injectable()
export class DiagnosticSupportUserEffect {
	...
	constructor(
		...
		protected readonly service: DiagnosticSupportUserService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticSupportUserAction>(modelAction.DiagnosticSupportUserModelActionTypes.COUNT_DIAGNOSTIC_SUPPORT_USERS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.DiagnosticSupportUserActionOK(
						modelAction.DiagnosticSupportUserModelActionTypes.COUNT_DIAGNOSTIC_SUPPORT_USERS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticSupportUserActionFail(
								modelAction.DiagnosticSupportUserModelActionTypes.COUNT_DIAGNOSTIC_SUPPORT_USERS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticSupportUserAction>(modelAction.DiagnosticSupportUserModelActionTypes.FETCH_DIAGNOSTIC_SUPPORT_USER),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticSupportUserActionOK(
						modelAction.DiagnosticSupportUserModelActionTypes.FETCH_DIAGNOSTIC_SUPPORT_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticSupportUserActionFail(
								modelAction.DiagnosticSupportUserModelActionTypes.FETCH_DIAGNOSTIC_SUPPORT_USER_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticSupportUserAction>(modelAction.DiagnosticSupportUserModelActionTypes.FETCH_ALL_DIAGNOSTIC_SUPPORT_USER),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.DiagnosticSupportUserActionOK(
						modelAction.DiagnosticSupportUserModelActionTypes.FETCH_ALL_DIAGNOSTIC_SUPPORT_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticSupportUserActionFail(
								modelAction.DiagnosticSupportUserModelActionTypes.FETCH_ALL_DIAGNOSTIC_SUPPORT_USER_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticSupportUserAction>(modelAction.DiagnosticSupportUserModelActionTypes.FETCH_DIAGNOSTIC_SUPPORT_USER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticSupportUserActionOK(
						modelAction.DiagnosticSupportUserModelActionTypes.FETCH_DIAGNOSTIC_SUPPORT_USER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticSupportUserActionFail(
								modelAction.DiagnosticSupportUserModelActionTypes.FETCH_DIAGNOSTIC_SUPPORT_USER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticSupportUserAction>(modelAction.DiagnosticSupportUserModelActionTypes.FETCH_LAST_DIAGNOSTIC_SUPPORT_USER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticSupportUserActionOK(
						modelAction.DiagnosticSupportUserModelActionTypes.FETCH_LAST_DIAGNOSTIC_SUPPORT_USER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticSupportUserActionFail(
								modelAction.DiagnosticSupportUserModelActionTypes.FETCH_LAST_DIAGNOSTIC_SUPPORT_USER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticSupportUserAction>(modelAction.DiagnosticSupportUserModelActionTypes.CREATE_DIAGNOSTIC_SUPPORT_USER),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as DiagnosticSupportUserModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticSupportUserActionOK(
						modelAction.DiagnosticSupportUserModelActionTypes.CREATE_DIAGNOSTIC_SUPPORT_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticSupportUserActionFail(
								modelAction.DiagnosticSupportUserModelActionTypes.CREATE_DIAGNOSTIC_SUPPORT_USER_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticSupportUserAction>(modelAction.DiagnosticSupportUserModelActionTypes.CREATE_ALL_DIAGNOSTIC_SUPPORT_USER),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as DiagnosticSupportUserModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticSupportUserActionOK(
						modelAction.DiagnosticSupportUserModelActionTypes.CREATE_ALL_DIAGNOSTIC_SUPPORT_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticSupportUserActionFail(
								modelAction.DiagnosticSupportUserModelActionTypes.CREATE_ALL_DIAGNOSTIC_SUPPORT_USER_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticSupportUserAction>(modelAction.DiagnosticSupportUserModelActionTypes.UPDATE_DIAGNOSTIC_SUPPORT_USER),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as DiagnosticSupportUserModel;
				...
				return this.service.update(new DiagnosticSupportUserModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticSupportUserActionOK(
						modelAction.DiagnosticSupportUserModelActionTypes.UPDATE_DIAGNOSTIC_SUPPORT_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticSupportUserActionFail(
								modelAction.DiagnosticSupportUserModelActionTypes.UPDATE_DIAGNOSTIC_SUPPORT_USER_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticSupportUserAction>(modelAction.DiagnosticSupportUserModelActionTypes.UPDATE_ALL_DIAGNOSTIC_SUPPORT_USER),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as DiagnosticSupportUserModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new DiagnosticSupportUserModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticSupportUserActionOK(
						modelAction.DiagnosticSupportUserModelActionTypes.UPDATE_ALL_DIAGNOSTIC_SUPPORT_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticSupportUserActionFail(
								modelAction.DiagnosticSupportUserModelActionTypes.UPDATE_ALL_DIAGNOSTIC_SUPPORT_USER_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticSupportUserAction>(modelAction.DiagnosticSupportUserModelActionTypes.DELETE_DIAGNOSTIC_SUPPORT_USER),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticSupportUserActionOK(
						modelAction.DiagnosticSupportUserModelActionTypes.DELETE_DIAGNOSTIC_SUPPORT_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticSupportUserActionFail(
								modelAction.DiagnosticSupportUserModelActionTypes.DELETE_DIAGNOSTIC_SUPPORT_USER_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticSupportUserAction>(modelAction.DiagnosticSupportUserModelActionTypes.DELETE_DIAGNOSTIC_SUPPORT_USER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticSupportUserActionOK(
						modelAction.DiagnosticSupportUserModelActionTypes.DELETE_DIAGNOSTIC_SUPPORT_USER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticSupportUserActionFail(
								modelAction.DiagnosticSupportUserModelActionTypes.DELETE_DIAGNOSTIC_SUPPORT_USER_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticSupportUserAction>(modelAction.DiagnosticSupportUserModelActionTypes.DELETE_ALL_DIAGNOSTIC_SUPPORT_USER),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticSupportUserActionOK(
						modelAction.DiagnosticSupportUserModelActionTypes.DELETE_ALL_DIAGNOSTIC_SUPPORT_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticSupportUserActionFail(
								modelAction.DiagnosticSupportUserModelActionTypes.DELETE_ALL_DIAGNOSTIC_SUPPORT_USER_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticSupportUserAction>(modelAction.DiagnosticSupportUserModelActionTypes.EXPORT_DIAGNOSTIC_SUPPORT_USER),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticSupportUserActionOK(
						modelAction.DiagnosticSupportUserModelActionTypes.EXPORT_DIAGNOSTIC_SUPPORT_USER,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticSupportUserAction>(modelAction.DiagnosticSupportUserModelActionTypes.EXPORT_ALL_DIAGNOSTIC_SUPPORT_USER),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticSupportUserActionOK(
						modelAction.DiagnosticSupportUserModelActionTypes.EXPORT_ALL_DIAGNOSTIC_SUPPORT_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticSupportUserActionFail(
								modelAction.DiagnosticSupportUserModelActionTypes.EXPORT_ALL_DIAGNOSTIC_SUPPORT_USER_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticSupportUserAction>(modelAction.DiagnosticSupportUserModelActionTypes.EXPORT_DIAGNOSTIC_SUPPORT_USER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticSupportUserActionOK(
						modelAction.DiagnosticSupportUserModelActionTypes.EXPORT_DIAGNOSTIC_SUPPORT_USER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticSupportUserActionFail(
								modelAction.DiagnosticSupportUserModelActionTypes.EXPORT_DIAGNOSTIC_SUPPORT_USER_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticSupportUserAction>(modelAction.DiagnosticSupportUserModelActionTypes.IMPORT_DIAGNOSTIC_SUPPORT_USERS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticSupportUserActionOK(
						modelAction.DiagnosticSupportUserModelActionTypes.IMPORT_DIAGNOSTIC_SUPPORT_USERS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticSupportUserActionFail(
								modelAction.DiagnosticSupportUserModelActionTypes.IMPORT_DIAGNOSTIC_SUPPORT_USERS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticSupportUserAction>(modelAction.DiagnosticSupportUserModelActionTypes.FETCH_DIAGNOSTIC_SUPPORT_USER_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.DiagnosticSupportUserActionOK(
						modelAction.DiagnosticSupportUserModelActionTypes.FETCH_DIAGNOSTIC_SUPPORT_USER_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticSupportUserActionFail(
								modelAction.DiagnosticSupportUserModelActionTypes.FETCH_DIAGNOSTIC_SUPPORT_USER_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticSupportUserAction>(modelAction.DiagnosticSupportUserModelActionTypes.FETCH_DIAGNOSTIC_SUPPORT_USER_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.DiagnosticSupportUserActionOK(
						modelAction.DiagnosticSupportUserModelActionTypes.FETCH_DIAGNOSTIC_SUPPORT_USER_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticSupportUserActionFail(
								modelAction.DiagnosticSupportUserModelActionTypes.FETCH_DIAGNOSTIC_SUPPORT_USER_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
