...
/**
 * DiagnosticSupportUserCollectionState would store the state of a collection of DiagnosticSupportUser
 */
export interface DiagnosticSupportUserCollectionState extends CollectionState {
 ...
 */
export interface DiagnosticSupportUserModelAudit extends AbstractModelAudit<DiagnosticSupportUserModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * DiagnosticSupportUserModelState would store the state of the model
 */
export interface DiagnosticSupportUserModelState {
	collectionState: {
		[key: string]: DiagnosticSupportUserCollectionState;
	};
	data: {
		[id: string]: DiagnosticSupportUserModel;
	};
	totalCount: number;
	audits: DiagnosticSupportUserModelAudit[];
 ...
 */
export const initialDiagnosticSupportUserCollectionState: DiagnosticSupportUserCollectionState = {
...
/**
 * The initial state of DiagnosticSupportUserModelState
 */
export const initialState: DiagnosticSupportUserModelState = {
	collectionState: {
