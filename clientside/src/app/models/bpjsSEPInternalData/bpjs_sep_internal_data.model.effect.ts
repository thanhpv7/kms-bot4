...
import * as modelAction from './bpjs_sep_internal_data.model.action';
import {BpjsSEPInternalDataService} from '../../services/bpjsSEPInternalData/bpjs_sep_internal_data.service';
...
/**
 * Effect class used for side effects related to BPJS SEP Internal Data model.
 */
@Injectable()
export class BpjsSEPInternalDataEffect {
	...
	constructor(
		...
		protected readonly service: BpjsSEPInternalDataService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPInternalDataAction>(modelAction.BpjsSEPInternalDataModelActionTypes.COUNT_BPJS_SEP_INTERNAL_DATAS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPInternalDataActionOK(
						modelAction.BpjsSEPInternalDataModelActionTypes.COUNT_BPJS_SEP_INTERNAL_DATAS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPInternalDataActionFail(
								modelAction.BpjsSEPInternalDataModelActionTypes.COUNT_BPJS_SEP_INTERNAL_DATAS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPInternalDataAction>(modelAction.BpjsSEPInternalDataModelActionTypes.FETCH_BPJS_SEP_INTERNAL_DATA),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPInternalDataActionOK(
						modelAction.BpjsSEPInternalDataModelActionTypes.FETCH_BPJS_SEP_INTERNAL_DATA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPInternalDataActionFail(
								modelAction.BpjsSEPInternalDataModelActionTypes.FETCH_BPJS_SEP_INTERNAL_DATA_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPInternalDataAction>(modelAction.BpjsSEPInternalDataModelActionTypes.FETCH_ALL_BPJS_SEP_INTERNAL_DATA),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPInternalDataActionOK(
						modelAction.BpjsSEPInternalDataModelActionTypes.FETCH_ALL_BPJS_SEP_INTERNAL_DATA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPInternalDataActionFail(
								modelAction.BpjsSEPInternalDataModelActionTypes.FETCH_ALL_BPJS_SEP_INTERNAL_DATA_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPInternalDataAction>(modelAction.BpjsSEPInternalDataModelActionTypes.FETCH_BPJS_SEP_INTERNAL_DATA_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPInternalDataActionOK(
						modelAction.BpjsSEPInternalDataModelActionTypes.FETCH_BPJS_SEP_INTERNAL_DATA_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPInternalDataActionFail(
								modelAction.BpjsSEPInternalDataModelActionTypes.FETCH_BPJS_SEP_INTERNAL_DATA_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPInternalDataAction>(modelAction.BpjsSEPInternalDataModelActionTypes.FETCH_LAST_BPJS_SEP_INTERNAL_DATA_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPInternalDataActionOK(
						modelAction.BpjsSEPInternalDataModelActionTypes.FETCH_LAST_BPJS_SEP_INTERNAL_DATA_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPInternalDataActionFail(
								modelAction.BpjsSEPInternalDataModelActionTypes.FETCH_LAST_BPJS_SEP_INTERNAL_DATA_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPInternalDataAction>(modelAction.BpjsSEPInternalDataModelActionTypes.CREATE_BPJS_SEP_INTERNAL_DATA),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsSEPInternalDataModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPInternalDataActionOK(
						modelAction.BpjsSEPInternalDataModelActionTypes.CREATE_BPJS_SEP_INTERNAL_DATA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPInternalDataActionFail(
								modelAction.BpjsSEPInternalDataModelActionTypes.CREATE_BPJS_SEP_INTERNAL_DATA_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPInternalDataAction>(modelAction.BpjsSEPInternalDataModelActionTypes.CREATE_ALL_BPJS_SEP_INTERNAL_DATA),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsSEPInternalDataModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPInternalDataActionOK(
						modelAction.BpjsSEPInternalDataModelActionTypes.CREATE_ALL_BPJS_SEP_INTERNAL_DATA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPInternalDataActionFail(
								modelAction.BpjsSEPInternalDataModelActionTypes.CREATE_ALL_BPJS_SEP_INTERNAL_DATA_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPInternalDataAction>(modelAction.BpjsSEPInternalDataModelActionTypes.UPDATE_BPJS_SEP_INTERNAL_DATA),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsSEPInternalDataModel;
				...
				return this.service.update(new BpjsSEPInternalDataModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPInternalDataActionOK(
						modelAction.BpjsSEPInternalDataModelActionTypes.UPDATE_BPJS_SEP_INTERNAL_DATA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPInternalDataActionFail(
								modelAction.BpjsSEPInternalDataModelActionTypes.UPDATE_BPJS_SEP_INTERNAL_DATA_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPInternalDataAction>(modelAction.BpjsSEPInternalDataModelActionTypes.UPDATE_ALL_BPJS_SEP_INTERNAL_DATA),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsSEPInternalDataModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsSEPInternalDataModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPInternalDataActionOK(
						modelAction.BpjsSEPInternalDataModelActionTypes.UPDATE_ALL_BPJS_SEP_INTERNAL_DATA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPInternalDataActionFail(
								modelAction.BpjsSEPInternalDataModelActionTypes.UPDATE_ALL_BPJS_SEP_INTERNAL_DATA_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPInternalDataAction>(modelAction.BpjsSEPInternalDataModelActionTypes.DELETE_BPJS_SEP_INTERNAL_DATA),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPInternalDataActionOK(
						modelAction.BpjsSEPInternalDataModelActionTypes.DELETE_BPJS_SEP_INTERNAL_DATA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPInternalDataActionFail(
								modelAction.BpjsSEPInternalDataModelActionTypes.DELETE_BPJS_SEP_INTERNAL_DATA_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPInternalDataAction>(modelAction.BpjsSEPInternalDataModelActionTypes.DELETE_BPJS_SEP_INTERNAL_DATA_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPInternalDataActionOK(
						modelAction.BpjsSEPInternalDataModelActionTypes.DELETE_BPJS_SEP_INTERNAL_DATA_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPInternalDataActionFail(
								modelAction.BpjsSEPInternalDataModelActionTypes.DELETE_BPJS_SEP_INTERNAL_DATA_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPInternalDataAction>(modelAction.BpjsSEPInternalDataModelActionTypes.DELETE_ALL_BPJS_SEP_INTERNAL_DATA),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPInternalDataActionOK(
						modelAction.BpjsSEPInternalDataModelActionTypes.DELETE_ALL_BPJS_SEP_INTERNAL_DATA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPInternalDataActionFail(
								modelAction.BpjsSEPInternalDataModelActionTypes.DELETE_ALL_BPJS_SEP_INTERNAL_DATA_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPInternalDataAction>(modelAction.BpjsSEPInternalDataModelActionTypes.EXPORT_BPJS_SEP_INTERNAL_DATA),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPInternalDataActionOK(
						modelAction.BpjsSEPInternalDataModelActionTypes.EXPORT_BPJS_SEP_INTERNAL_DATA,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPInternalDataAction>(modelAction.BpjsSEPInternalDataModelActionTypes.EXPORT_ALL_BPJS_SEP_INTERNAL_DATA),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPInternalDataActionOK(
						modelAction.BpjsSEPInternalDataModelActionTypes.EXPORT_ALL_BPJS_SEP_INTERNAL_DATA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPInternalDataActionFail(
								modelAction.BpjsSEPInternalDataModelActionTypes.EXPORT_ALL_BPJS_SEP_INTERNAL_DATA_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPInternalDataAction>(modelAction.BpjsSEPInternalDataModelActionTypes.EXPORT_BPJS_SEP_INTERNAL_DATA_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPInternalDataActionOK(
						modelAction.BpjsSEPInternalDataModelActionTypes.EXPORT_BPJS_SEP_INTERNAL_DATA_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPInternalDataActionFail(
								modelAction.BpjsSEPInternalDataModelActionTypes.EXPORT_BPJS_SEP_INTERNAL_DATA_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPInternalDataAction>(modelAction.BpjsSEPInternalDataModelActionTypes.IMPORT_BPJS_SEP_INTERNAL_DATAS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPInternalDataActionOK(
						modelAction.BpjsSEPInternalDataModelActionTypes.IMPORT_BPJS_SEP_INTERNAL_DATAS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPInternalDataActionFail(
								modelAction.BpjsSEPInternalDataModelActionTypes.IMPORT_BPJS_SEP_INTERNAL_DATAS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPInternalDataAction>(modelAction.BpjsSEPInternalDataModelActionTypes.FETCH_BPJS_SEP_INTERNAL_DATA_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsSEPInternalDataActionOK(
						modelAction.BpjsSEPInternalDataModelActionTypes.FETCH_BPJS_SEP_INTERNAL_DATA_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPInternalDataActionFail(
								modelAction.BpjsSEPInternalDataModelActionTypes.FETCH_BPJS_SEP_INTERNAL_DATA_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPInternalDataAction>(modelAction.BpjsSEPInternalDataModelActionTypes.FETCH_BPJS_SEP_INTERNAL_DATA_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsSEPInternalDataActionOK(
						modelAction.BpjsSEPInternalDataModelActionTypes.FETCH_BPJS_SEP_INTERNAL_DATA_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPInternalDataActionFail(
								modelAction.BpjsSEPInternalDataModelActionTypes.FETCH_BPJS_SEP_INTERNAL_DATA_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
