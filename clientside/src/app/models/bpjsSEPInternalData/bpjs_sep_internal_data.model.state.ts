...
/**
 * BpjsSEPInternalDataCollectionState would store the state of a collection of BpjsSEPInternalData
 */
export interface BpjsSEPInternalDataCollectionState extends CollectionState {
 ...
 */
export interface BpjsSEPInternalDataModelAudit extends AbstractModelAudit<BpjsSEPInternalDataModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsSEPInternalDataModelState would store the state of the model
 */
export interface BpjsSEPInternalDataModelState {
	collectionState: {
		[key: string]: BpjsSEPInternalDataCollectionState;
	};
	data: {
		[id: string]: BpjsSEPInternalDataModel;
	};
	totalCount: number;
	audits: BpjsSEPInternalDataModelAudit[];
 ...
 */
export const initialBpjsSEPInternalDataCollectionState: BpjsSEPInternalDataCollectionState = {
...
/**
 * The initial state of BpjsSEPInternalDataModelState
 */
export const initialState: BpjsSEPInternalDataModelState = {
	collectionState: {
