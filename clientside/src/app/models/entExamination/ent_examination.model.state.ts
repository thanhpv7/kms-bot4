...
/**
 * EntExaminationCollectionState would store the state of a collection of EntExamination
 */
export interface EntExaminationCollectionState extends CollectionState {
 ...
 */
export interface EntExaminationModelAudit extends AbstractModelAudit<EntExaminationModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * EntExaminationModelState would store the state of the model
 */
export interface EntExaminationModelState {
	collectionState: {
		[key: string]: EntExaminationCollectionState;
	};
	data: {
		[id: string]: EntExaminationModel;
	};
	totalCount: number;
	audits: EntExaminationModelAudit[];
 ...
 */
export const initialEntExaminationCollectionState: EntExaminationCollectionState = {
...
/**
 * The initial state of EntExaminationModelState
 */
export const initialState: EntExaminationModelState = {
	collectionState: {
