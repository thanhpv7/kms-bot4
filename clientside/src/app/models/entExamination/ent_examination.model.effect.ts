...
import {EntExaminationService} from '../../services/entExamination/ent_examination.service';
...
/**
 * Effect class used for side effects related to ENT Examination model.
 */
@Injectable()
export class EntExaminationEffect {
	...
	constructor(
		...
		protected readonly service: EntExaminationService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.EntExaminationAction>(modelAction.EntExaminationModelActionTypes.COUNT_ENT_EXAMINATIONS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.EntExaminationActionOK(
						modelAction.EntExaminationModelActionTypes.COUNT_ENT_EXAMINATIONS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.EntExaminationActionFail(
								modelAction.EntExaminationModelActionTypes.COUNT_ENT_EXAMINATIONS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.EntExaminationAction>(modelAction.EntExaminationModelActionTypes.FETCH_ENT_EXAMINATION),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.EntExaminationActionOK(
						modelAction.EntExaminationModelActionTypes.FETCH_ENT_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.EntExaminationActionFail(
								modelAction.EntExaminationModelActionTypes.FETCH_ENT_EXAMINATION_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.EntExaminationAction>(modelAction.EntExaminationModelActionTypes.FETCH_ALL_ENT_EXAMINATION),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.EntExaminationActionOK(
						modelAction.EntExaminationModelActionTypes.FETCH_ALL_ENT_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.EntExaminationActionFail(
								modelAction.EntExaminationModelActionTypes.FETCH_ALL_ENT_EXAMINATION_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.EntExaminationAction>(modelAction.EntExaminationModelActionTypes.FETCH_ENT_EXAMINATION_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.EntExaminationActionOK(
						modelAction.EntExaminationModelActionTypes.FETCH_ENT_EXAMINATION_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.EntExaminationActionFail(
								modelAction.EntExaminationModelActionTypes.FETCH_ENT_EXAMINATION_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.EntExaminationAction>(modelAction.EntExaminationModelActionTypes.FETCH_LAST_ENT_EXAMINATION_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.EntExaminationActionOK(
						modelAction.EntExaminationModelActionTypes.FETCH_LAST_ENT_EXAMINATION_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.EntExaminationActionFail(
								modelAction.EntExaminationModelActionTypes.FETCH_LAST_ENT_EXAMINATION_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.EntExaminationAction>(modelAction.EntExaminationModelActionTypes.CREATE_ENT_EXAMINATION),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as EntExaminationModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.EntExaminationActionOK(
						modelAction.EntExaminationModelActionTypes.CREATE_ENT_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.EntExaminationActionFail(
								modelAction.EntExaminationModelActionTypes.CREATE_ENT_EXAMINATION_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.EntExaminationAction>(modelAction.EntExaminationModelActionTypes.CREATE_ALL_ENT_EXAMINATION),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as EntExaminationModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.EntExaminationActionOK(
						modelAction.EntExaminationModelActionTypes.CREATE_ALL_ENT_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.EntExaminationActionFail(
								modelAction.EntExaminationModelActionTypes.CREATE_ALL_ENT_EXAMINATION_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.EntExaminationAction>(modelAction.EntExaminationModelActionTypes.UPDATE_ENT_EXAMINATION),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as EntExaminationModel;
				...
				return this.service.update(new EntExaminationModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.EntExaminationActionOK(
						modelAction.EntExaminationModelActionTypes.UPDATE_ENT_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.EntExaminationActionFail(
								modelAction.EntExaminationModelActionTypes.UPDATE_ENT_EXAMINATION_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.EntExaminationAction>(modelAction.EntExaminationModelActionTypes.UPDATE_ALL_ENT_EXAMINATION),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as EntExaminationModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new EntExaminationModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.EntExaminationActionOK(
						modelAction.EntExaminationModelActionTypes.UPDATE_ALL_ENT_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.EntExaminationActionFail(
								modelAction.EntExaminationModelActionTypes.UPDATE_ALL_ENT_EXAMINATION_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.EntExaminationAction>(modelAction.EntExaminationModelActionTypes.DELETE_ENT_EXAMINATION),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.EntExaminationActionOK(
						modelAction.EntExaminationModelActionTypes.DELETE_ENT_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.EntExaminationActionFail(
								modelAction.EntExaminationModelActionTypes.DELETE_ENT_EXAMINATION_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.EntExaminationAction>(modelAction.EntExaminationModelActionTypes.DELETE_ENT_EXAMINATION_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.EntExaminationActionOK(
						modelAction.EntExaminationModelActionTypes.DELETE_ENT_EXAMINATION_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.EntExaminationActionFail(
								modelAction.EntExaminationModelActionTypes.DELETE_ENT_EXAMINATION_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.EntExaminationAction>(modelAction.EntExaminationModelActionTypes.DELETE_ALL_ENT_EXAMINATION),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.EntExaminationActionOK(
						modelAction.EntExaminationModelActionTypes.DELETE_ALL_ENT_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.EntExaminationActionFail(
								modelAction.EntExaminationModelActionTypes.DELETE_ALL_ENT_EXAMINATION_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.EntExaminationAction>(modelAction.EntExaminationModelActionTypes.EXPORT_ENT_EXAMINATION),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.EntExaminationActionOK(
						modelAction.EntExaminationModelActionTypes.EXPORT_ENT_EXAMINATION,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.EntExaminationAction>(modelAction.EntExaminationModelActionTypes.EXPORT_ALL_ENT_EXAMINATION),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.EntExaminationActionOK(
						modelAction.EntExaminationModelActionTypes.EXPORT_ALL_ENT_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.EntExaminationActionFail(
								modelAction.EntExaminationModelActionTypes.EXPORT_ALL_ENT_EXAMINATION_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.EntExaminationAction>(modelAction.EntExaminationModelActionTypes.EXPORT_ENT_EXAMINATION_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.EntExaminationActionOK(
						modelAction.EntExaminationModelActionTypes.EXPORT_ENT_EXAMINATION_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.EntExaminationActionFail(
								modelAction.EntExaminationModelActionTypes.EXPORT_ENT_EXAMINATION_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.EntExaminationAction>(modelAction.EntExaminationModelActionTypes.IMPORT_ENT_EXAMINATIONS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.EntExaminationActionOK(
						modelAction.EntExaminationModelActionTypes.IMPORT_ENT_EXAMINATIONS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.EntExaminationActionFail(
								modelAction.EntExaminationModelActionTypes.IMPORT_ENT_EXAMINATIONS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.EntExaminationAction>(modelAction.EntExaminationModelActionTypes.FETCH_ENT_EXAMINATION_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.EntExaminationActionOK(
						modelAction.EntExaminationModelActionTypes.FETCH_ENT_EXAMINATION_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.EntExaminationActionFail(
								modelAction.EntExaminationModelActionTypes.FETCH_ENT_EXAMINATION_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.EntExaminationAction>(modelAction.EntExaminationModelActionTypes.FETCH_ENT_EXAMINATION_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.EntExaminationActionOK(
						modelAction.EntExaminationModelActionTypes.FETCH_ENT_EXAMINATION_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.EntExaminationActionFail(
								modelAction.EntExaminationModelActionTypes.FETCH_ENT_EXAMINATION_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
