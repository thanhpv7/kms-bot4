...
import * as modelAction from './retail_pharmacy.model.action';
import {RetailPharmacyService} from '../../services/retailPharmacy/retail_pharmacy.service';
...
/**
 * Effect class used for side effects related to Retail Pharmacy model.
 */
@Injectable()
export class RetailPharmacyEffect {
	...
	constructor(
		...
		protected readonly service: RetailPharmacyService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RetailPharmacyAction>(modelAction.RetailPharmacyModelActionTypes.COUNT_RETAIL_PHARMACYS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.RetailPharmacyActionOK(
						modelAction.RetailPharmacyModelActionTypes.COUNT_RETAIL_PHARMACYS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RetailPharmacyActionFail(
								modelAction.RetailPharmacyModelActionTypes.COUNT_RETAIL_PHARMACYS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RetailPharmacyAction>(modelAction.RetailPharmacyModelActionTypes.FETCH_RETAIL_PHARMACY),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.RetailPharmacyActionOK(
						modelAction.RetailPharmacyModelActionTypes.FETCH_RETAIL_PHARMACY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RetailPharmacyActionFail(
								modelAction.RetailPharmacyModelActionTypes.FETCH_RETAIL_PHARMACY_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RetailPharmacyAction>(modelAction.RetailPharmacyModelActionTypes.FETCH_ALL_RETAIL_PHARMACY),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.RetailPharmacyActionOK(
						modelAction.RetailPharmacyModelActionTypes.FETCH_ALL_RETAIL_PHARMACY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RetailPharmacyActionFail(
								modelAction.RetailPharmacyModelActionTypes.FETCH_ALL_RETAIL_PHARMACY_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RetailPharmacyAction>(modelAction.RetailPharmacyModelActionTypes.FETCH_RETAIL_PHARMACY_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.RetailPharmacyActionOK(
						modelAction.RetailPharmacyModelActionTypes.FETCH_RETAIL_PHARMACY_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RetailPharmacyActionFail(
								modelAction.RetailPharmacyModelActionTypes.FETCH_RETAIL_PHARMACY_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RetailPharmacyAction>(modelAction.RetailPharmacyModelActionTypes.FETCH_LAST_RETAIL_PHARMACY_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.RetailPharmacyActionOK(
						modelAction.RetailPharmacyModelActionTypes.FETCH_LAST_RETAIL_PHARMACY_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RetailPharmacyActionFail(
								modelAction.RetailPharmacyModelActionTypes.FETCH_LAST_RETAIL_PHARMACY_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RetailPharmacyAction>(modelAction.RetailPharmacyModelActionTypes.CREATE_RETAIL_PHARMACY),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as RetailPharmacyModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.RetailPharmacyActionOK(
						modelAction.RetailPharmacyModelActionTypes.CREATE_RETAIL_PHARMACY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RetailPharmacyActionFail(
								modelAction.RetailPharmacyModelActionTypes.CREATE_RETAIL_PHARMACY_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RetailPharmacyAction>(modelAction.RetailPharmacyModelActionTypes.CREATE_ALL_RETAIL_PHARMACY),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as RetailPharmacyModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.RetailPharmacyActionOK(
						modelAction.RetailPharmacyModelActionTypes.CREATE_ALL_RETAIL_PHARMACY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RetailPharmacyActionFail(
								modelAction.RetailPharmacyModelActionTypes.CREATE_ALL_RETAIL_PHARMACY_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RetailPharmacyAction>(modelAction.RetailPharmacyModelActionTypes.UPDATE_RETAIL_PHARMACY),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as RetailPharmacyModel;
				...
				return this.service.update(new RetailPharmacyModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.RetailPharmacyActionOK(
						modelAction.RetailPharmacyModelActionTypes.UPDATE_RETAIL_PHARMACY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RetailPharmacyActionFail(
								modelAction.RetailPharmacyModelActionTypes.UPDATE_RETAIL_PHARMACY_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RetailPharmacyAction>(modelAction.RetailPharmacyModelActionTypes.UPDATE_ALL_RETAIL_PHARMACY),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as RetailPharmacyModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new RetailPharmacyModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.RetailPharmacyActionOK(
						modelAction.RetailPharmacyModelActionTypes.UPDATE_ALL_RETAIL_PHARMACY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RetailPharmacyActionFail(
								modelAction.RetailPharmacyModelActionTypes.UPDATE_ALL_RETAIL_PHARMACY_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RetailPharmacyAction>(modelAction.RetailPharmacyModelActionTypes.DELETE_RETAIL_PHARMACY),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.RetailPharmacyActionOK(
						modelAction.RetailPharmacyModelActionTypes.DELETE_RETAIL_PHARMACY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RetailPharmacyActionFail(
								modelAction.RetailPharmacyModelActionTypes.DELETE_RETAIL_PHARMACY_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RetailPharmacyAction>(modelAction.RetailPharmacyModelActionTypes.DELETE_RETAIL_PHARMACY_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.RetailPharmacyActionOK(
						modelAction.RetailPharmacyModelActionTypes.DELETE_RETAIL_PHARMACY_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RetailPharmacyActionFail(
								modelAction.RetailPharmacyModelActionTypes.DELETE_RETAIL_PHARMACY_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RetailPharmacyAction>(modelAction.RetailPharmacyModelActionTypes.DELETE_ALL_RETAIL_PHARMACY),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.RetailPharmacyActionOK(
						modelAction.RetailPharmacyModelActionTypes.DELETE_ALL_RETAIL_PHARMACY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RetailPharmacyActionFail(
								modelAction.RetailPharmacyModelActionTypes.DELETE_ALL_RETAIL_PHARMACY_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RetailPharmacyAction>(modelAction.RetailPharmacyModelActionTypes.EXPORT_RETAIL_PHARMACY),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.RetailPharmacyActionOK(
						modelAction.RetailPharmacyModelActionTypes.EXPORT_RETAIL_PHARMACY,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RetailPharmacyAction>(modelAction.RetailPharmacyModelActionTypes.EXPORT_ALL_RETAIL_PHARMACY),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.RetailPharmacyActionOK(
						modelAction.RetailPharmacyModelActionTypes.EXPORT_ALL_RETAIL_PHARMACY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RetailPharmacyActionFail(
								modelAction.RetailPharmacyModelActionTypes.EXPORT_ALL_RETAIL_PHARMACY_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RetailPharmacyAction>(modelAction.RetailPharmacyModelActionTypes.EXPORT_RETAIL_PHARMACY_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.RetailPharmacyActionOK(
						modelAction.RetailPharmacyModelActionTypes.EXPORT_RETAIL_PHARMACY_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RetailPharmacyActionFail(
								modelAction.RetailPharmacyModelActionTypes.EXPORT_RETAIL_PHARMACY_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RetailPharmacyAction>(modelAction.RetailPharmacyModelActionTypes.IMPORT_RETAIL_PHARMACYS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.RetailPharmacyActionOK(
						modelAction.RetailPharmacyModelActionTypes.IMPORT_RETAIL_PHARMACYS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RetailPharmacyActionFail(
								modelAction.RetailPharmacyModelActionTypes.IMPORT_RETAIL_PHARMACYS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RetailPharmacyAction>(modelAction.RetailPharmacyModelActionTypes.FETCH_RETAIL_PHARMACY_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.RetailPharmacyActionOK(
						modelAction.RetailPharmacyModelActionTypes.FETCH_RETAIL_PHARMACY_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.RetailPharmacyActionFail(
								modelAction.RetailPharmacyModelActionTypes.FETCH_RETAIL_PHARMACY_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RetailPharmacyAction>(modelAction.RetailPharmacyModelActionTypes.FETCH_RETAIL_PHARMACY_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.RetailPharmacyActionOK(
						modelAction.RetailPharmacyModelActionTypes.FETCH_RETAIL_PHARMACY_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.RetailPharmacyActionFail(
								modelAction.RetailPharmacyModelActionTypes.FETCH_RETAIL_PHARMACY_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
