...
/**
 * RetailPharmacyCollectionState would store the state of a collection of RetailPharmacy
 */
export interface RetailPharmacyCollectionState extends CollectionState {
 ...
 */
export interface RetailPharmacyModelAudit extends AbstractModelAudit<RetailPharmacyModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * RetailPharmacyModelState would store the state of the model
 */
export interface RetailPharmacyModelState {
	collectionState: {
		[key: string]: RetailPharmacyCollectionState;
	};
	data: {
		[id: string]: RetailPharmacyModel;
	};
	totalCount: number;
	audits: RetailPharmacyModelAudit[];
 ...
 */
export const initialRetailPharmacyCollectionState: RetailPharmacyCollectionState = {
...
/**
 * The initial state of RetailPharmacyModelState
 */
export const initialState: RetailPharmacyModelState = {
	collectionState: {
