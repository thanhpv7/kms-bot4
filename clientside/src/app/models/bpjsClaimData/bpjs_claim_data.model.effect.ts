...
import * as modelAction from './bpjs_claim_data.model.action';
import {BpjsClaimDataService} from '../../services/bpjsClaimData/bpjs_claim_data.service';
...
/**
 * Effect class used for side effects related to BPJS Claim Data model.
 */
@Injectable()
export class BpjsClaimDataEffect {
	...
	constructor(
		...
		protected readonly service: BpjsClaimDataService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsClaimDataAction>(modelAction.BpjsClaimDataModelActionTypes.COUNT_BPJS_CLAIM_DATAS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsClaimDataActionOK(
						modelAction.BpjsClaimDataModelActionTypes.COUNT_BPJS_CLAIM_DATAS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsClaimDataActionFail(
								modelAction.BpjsClaimDataModelActionTypes.COUNT_BPJS_CLAIM_DATAS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsClaimDataAction>(modelAction.BpjsClaimDataModelActionTypes.FETCH_BPJS_CLAIM_DATA),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsClaimDataActionOK(
						modelAction.BpjsClaimDataModelActionTypes.FETCH_BPJS_CLAIM_DATA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsClaimDataActionFail(
								modelAction.BpjsClaimDataModelActionTypes.FETCH_BPJS_CLAIM_DATA_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsClaimDataAction>(modelAction.BpjsClaimDataModelActionTypes.FETCH_ALL_BPJS_CLAIM_DATA),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsClaimDataActionOK(
						modelAction.BpjsClaimDataModelActionTypes.FETCH_ALL_BPJS_CLAIM_DATA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsClaimDataActionFail(
								modelAction.BpjsClaimDataModelActionTypes.FETCH_ALL_BPJS_CLAIM_DATA_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsClaimDataAction>(modelAction.BpjsClaimDataModelActionTypes.FETCH_BPJS_CLAIM_DATA_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsClaimDataActionOK(
						modelAction.BpjsClaimDataModelActionTypes.FETCH_BPJS_CLAIM_DATA_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsClaimDataActionFail(
								modelAction.BpjsClaimDataModelActionTypes.FETCH_BPJS_CLAIM_DATA_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsClaimDataAction>(modelAction.BpjsClaimDataModelActionTypes.FETCH_LAST_BPJS_CLAIM_DATA_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsClaimDataActionOK(
						modelAction.BpjsClaimDataModelActionTypes.FETCH_LAST_BPJS_CLAIM_DATA_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsClaimDataActionFail(
								modelAction.BpjsClaimDataModelActionTypes.FETCH_LAST_BPJS_CLAIM_DATA_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsClaimDataAction>(modelAction.BpjsClaimDataModelActionTypes.CREATE_BPJS_CLAIM_DATA),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsClaimDataModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsClaimDataActionOK(
						modelAction.BpjsClaimDataModelActionTypes.CREATE_BPJS_CLAIM_DATA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsClaimDataActionFail(
								modelAction.BpjsClaimDataModelActionTypes.CREATE_BPJS_CLAIM_DATA_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsClaimDataAction>(modelAction.BpjsClaimDataModelActionTypes.CREATE_ALL_BPJS_CLAIM_DATA),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsClaimDataModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsClaimDataActionOK(
						modelAction.BpjsClaimDataModelActionTypes.CREATE_ALL_BPJS_CLAIM_DATA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsClaimDataActionFail(
								modelAction.BpjsClaimDataModelActionTypes.CREATE_ALL_BPJS_CLAIM_DATA_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsClaimDataAction>(modelAction.BpjsClaimDataModelActionTypes.UPDATE_BPJS_CLAIM_DATA),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsClaimDataModel;
				...
				return this.service.update(new BpjsClaimDataModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsClaimDataActionOK(
						modelAction.BpjsClaimDataModelActionTypes.UPDATE_BPJS_CLAIM_DATA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsClaimDataActionFail(
								modelAction.BpjsClaimDataModelActionTypes.UPDATE_BPJS_CLAIM_DATA_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsClaimDataAction>(modelAction.BpjsClaimDataModelActionTypes.UPDATE_ALL_BPJS_CLAIM_DATA),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsClaimDataModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsClaimDataModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsClaimDataActionOK(
						modelAction.BpjsClaimDataModelActionTypes.UPDATE_ALL_BPJS_CLAIM_DATA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsClaimDataActionFail(
								modelAction.BpjsClaimDataModelActionTypes.UPDATE_ALL_BPJS_CLAIM_DATA_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsClaimDataAction>(modelAction.BpjsClaimDataModelActionTypes.DELETE_BPJS_CLAIM_DATA),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsClaimDataActionOK(
						modelAction.BpjsClaimDataModelActionTypes.DELETE_BPJS_CLAIM_DATA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsClaimDataActionFail(
								modelAction.BpjsClaimDataModelActionTypes.DELETE_BPJS_CLAIM_DATA_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsClaimDataAction>(modelAction.BpjsClaimDataModelActionTypes.DELETE_BPJS_CLAIM_DATA_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsClaimDataActionOK(
						modelAction.BpjsClaimDataModelActionTypes.DELETE_BPJS_CLAIM_DATA_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsClaimDataActionFail(
								modelAction.BpjsClaimDataModelActionTypes.DELETE_BPJS_CLAIM_DATA_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsClaimDataAction>(modelAction.BpjsClaimDataModelActionTypes.DELETE_ALL_BPJS_CLAIM_DATA),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsClaimDataActionOK(
						modelAction.BpjsClaimDataModelActionTypes.DELETE_ALL_BPJS_CLAIM_DATA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsClaimDataActionFail(
								modelAction.BpjsClaimDataModelActionTypes.DELETE_ALL_BPJS_CLAIM_DATA_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsClaimDataAction>(modelAction.BpjsClaimDataModelActionTypes.EXPORT_BPJS_CLAIM_DATA),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsClaimDataActionOK(
						modelAction.BpjsClaimDataModelActionTypes.EXPORT_BPJS_CLAIM_DATA,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsClaimDataAction>(modelAction.BpjsClaimDataModelActionTypes.EXPORT_ALL_BPJS_CLAIM_DATA),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsClaimDataActionOK(
						modelAction.BpjsClaimDataModelActionTypes.EXPORT_ALL_BPJS_CLAIM_DATA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsClaimDataActionFail(
								modelAction.BpjsClaimDataModelActionTypes.EXPORT_ALL_BPJS_CLAIM_DATA_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsClaimDataAction>(modelAction.BpjsClaimDataModelActionTypes.EXPORT_BPJS_CLAIM_DATA_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsClaimDataActionOK(
						modelAction.BpjsClaimDataModelActionTypes.EXPORT_BPJS_CLAIM_DATA_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsClaimDataActionFail(
								modelAction.BpjsClaimDataModelActionTypes.EXPORT_BPJS_CLAIM_DATA_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsClaimDataAction>(modelAction.BpjsClaimDataModelActionTypes.IMPORT_BPJS_CLAIM_DATAS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsClaimDataActionOK(
						modelAction.BpjsClaimDataModelActionTypes.IMPORT_BPJS_CLAIM_DATAS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsClaimDataActionFail(
								modelAction.BpjsClaimDataModelActionTypes.IMPORT_BPJS_CLAIM_DATAS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsClaimDataAction>(modelAction.BpjsClaimDataModelActionTypes.FETCH_BPJS_CLAIM_DATA_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsClaimDataActionOK(
						modelAction.BpjsClaimDataModelActionTypes.FETCH_BPJS_CLAIM_DATA_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsClaimDataActionFail(
								modelAction.BpjsClaimDataModelActionTypes.FETCH_BPJS_CLAIM_DATA_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsClaimDataAction>(modelAction.BpjsClaimDataModelActionTypes.FETCH_BPJS_CLAIM_DATA_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsClaimDataActionOK(
						modelAction.BpjsClaimDataModelActionTypes.FETCH_BPJS_CLAIM_DATA_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsClaimDataActionFail(
								modelAction.BpjsClaimDataModelActionTypes.FETCH_BPJS_CLAIM_DATA_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
