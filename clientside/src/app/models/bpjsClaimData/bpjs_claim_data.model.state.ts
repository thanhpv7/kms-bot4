...
/**
 * BpjsClaimDataCollectionState would store the state of a collection of BpjsClaimData
 */
export interface BpjsClaimDataCollectionState extends CollectionState {
 ...
 */
export interface BpjsClaimDataModelAudit extends AbstractModelAudit<BpjsClaimDataModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsClaimDataModelState would store the state of the model
 */
export interface BpjsClaimDataModelState {
	collectionState: {
		[key: string]: BpjsClaimDataCollectionState;
	};
	data: {
		[id: string]: BpjsClaimDataModel;
	};
	totalCount: number;
	audits: BpjsClaimDataModelAudit[];
 ...
 */
export const initialBpjsClaimDataCollectionState: BpjsClaimDataCollectionState = {
...
/**
 * The initial state of BpjsClaimDataModelState
 */
export const initialState: BpjsClaimDataModelState = {
	collectionState: {
