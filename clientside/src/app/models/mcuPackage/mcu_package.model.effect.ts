...
import * as modelAction from './mcu_package.model.action';
import {McuPackageService} from '../../services/mcuPackage/mcu_package.service';
...
/**
 * Effect class used for side effects related to MCU Package model.
 */
@Injectable()
export class McuPackageEffect {
	...
	constructor(
		...
		protected readonly service: McuPackageService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.McuPackageAction>(modelAction.McuPackageModelActionTypes.COUNT_MCU_PACKAGES),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.McuPackageActionOK(
						modelAction.McuPackageModelActionTypes.COUNT_MCU_PACKAGES_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.McuPackageActionFail(
								modelAction.McuPackageModelActionTypes.COUNT_MCU_PACKAGES_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.McuPackageAction>(modelAction.McuPackageModelActionTypes.FETCH_MCU_PACKAGE),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.McuPackageActionOK(
						modelAction.McuPackageModelActionTypes.FETCH_MCU_PACKAGE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.McuPackageActionFail(
								modelAction.McuPackageModelActionTypes.FETCH_MCU_PACKAGE_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.McuPackageAction>(modelAction.McuPackageModelActionTypes.FETCH_ALL_MCU_PACKAGE),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.McuPackageActionOK(
						modelAction.McuPackageModelActionTypes.FETCH_ALL_MCU_PACKAGE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.McuPackageActionFail(
								modelAction.McuPackageModelActionTypes.FETCH_ALL_MCU_PACKAGE_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.McuPackageAction>(modelAction.McuPackageModelActionTypes.FETCH_MCU_PACKAGE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.McuPackageActionOK(
						modelAction.McuPackageModelActionTypes.FETCH_MCU_PACKAGE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.McuPackageActionFail(
								modelAction.McuPackageModelActionTypes.FETCH_MCU_PACKAGE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.McuPackageAction>(modelAction.McuPackageModelActionTypes.FETCH_LAST_MCU_PACKAGE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.McuPackageActionOK(
						modelAction.McuPackageModelActionTypes.FETCH_LAST_MCU_PACKAGE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.McuPackageActionFail(
								modelAction.McuPackageModelActionTypes.FETCH_LAST_MCU_PACKAGE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.McuPackageAction>(modelAction.McuPackageModelActionTypes.CREATE_MCU_PACKAGE),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as McuPackageModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.McuPackageActionOK(
						modelAction.McuPackageModelActionTypes.CREATE_MCU_PACKAGE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.McuPackageActionFail(
								modelAction.McuPackageModelActionTypes.CREATE_MCU_PACKAGE_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.McuPackageAction>(modelAction.McuPackageModelActionTypes.CREATE_ALL_MCU_PACKAGE),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as McuPackageModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.McuPackageActionOK(
						modelAction.McuPackageModelActionTypes.CREATE_ALL_MCU_PACKAGE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.McuPackageActionFail(
								modelAction.McuPackageModelActionTypes.CREATE_ALL_MCU_PACKAGE_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.McuPackageAction>(modelAction.McuPackageModelActionTypes.UPDATE_MCU_PACKAGE),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as McuPackageModel;
				...
				return this.service.update(new McuPackageModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.McuPackageActionOK(
						modelAction.McuPackageModelActionTypes.UPDATE_MCU_PACKAGE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.McuPackageActionFail(
								modelAction.McuPackageModelActionTypes.UPDATE_MCU_PACKAGE_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.McuPackageAction>(modelAction.McuPackageModelActionTypes.UPDATE_ALL_MCU_PACKAGE),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as McuPackageModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new McuPackageModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.McuPackageActionOK(
						modelAction.McuPackageModelActionTypes.UPDATE_ALL_MCU_PACKAGE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.McuPackageActionFail(
								modelAction.McuPackageModelActionTypes.UPDATE_ALL_MCU_PACKAGE_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.McuPackageAction>(modelAction.McuPackageModelActionTypes.DELETE_MCU_PACKAGE),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.McuPackageActionOK(
						modelAction.McuPackageModelActionTypes.DELETE_MCU_PACKAGE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.McuPackageActionFail(
								modelAction.McuPackageModelActionTypes.DELETE_MCU_PACKAGE_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.McuPackageAction>(modelAction.McuPackageModelActionTypes.DELETE_MCU_PACKAGE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.McuPackageActionOK(
						modelAction.McuPackageModelActionTypes.DELETE_MCU_PACKAGE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.McuPackageActionFail(
								modelAction.McuPackageModelActionTypes.DELETE_MCU_PACKAGE_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.McuPackageAction>(modelAction.McuPackageModelActionTypes.DELETE_ALL_MCU_PACKAGE),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.McuPackageActionOK(
						modelAction.McuPackageModelActionTypes.DELETE_ALL_MCU_PACKAGE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.McuPackageActionFail(
								modelAction.McuPackageModelActionTypes.DELETE_ALL_MCU_PACKAGE_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.McuPackageAction>(modelAction.McuPackageModelActionTypes.EXPORT_MCU_PACKAGE),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.McuPackageActionOK(
						modelAction.McuPackageModelActionTypes.EXPORT_MCU_PACKAGE,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.McuPackageAction>(modelAction.McuPackageModelActionTypes.EXPORT_ALL_MCU_PACKAGE),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.McuPackageActionOK(
						modelAction.McuPackageModelActionTypes.EXPORT_ALL_MCU_PACKAGE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.McuPackageActionFail(
								modelAction.McuPackageModelActionTypes.EXPORT_ALL_MCU_PACKAGE_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.McuPackageAction>(modelAction.McuPackageModelActionTypes.EXPORT_MCU_PACKAGE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.McuPackageActionOK(
						modelAction.McuPackageModelActionTypes.EXPORT_MCU_PACKAGE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.McuPackageActionFail(
								modelAction.McuPackageModelActionTypes.EXPORT_MCU_PACKAGE_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.McuPackageAction>(modelAction.McuPackageModelActionTypes.IMPORT_MCU_PACKAGES),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.McuPackageActionOK(
						modelAction.McuPackageModelActionTypes.IMPORT_MCU_PACKAGES_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.McuPackageActionFail(
								modelAction.McuPackageModelActionTypes.IMPORT_MCU_PACKAGES_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.McuPackageAction>(modelAction.McuPackageModelActionTypes.FETCH_MCU_PACKAGE_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.McuPackageActionOK(
						modelAction.McuPackageModelActionTypes.FETCH_MCU_PACKAGE_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.McuPackageActionFail(
								modelAction.McuPackageModelActionTypes.FETCH_MCU_PACKAGE_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.McuPackageAction>(modelAction.McuPackageModelActionTypes.FETCH_MCU_PACKAGE_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.McuPackageActionOK(
						modelAction.McuPackageModelActionTypes.FETCH_MCU_PACKAGE_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.McuPackageActionFail(
								modelAction.McuPackageModelActionTypes.FETCH_MCU_PACKAGE_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
