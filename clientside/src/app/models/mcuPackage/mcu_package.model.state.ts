...
/**
 * McuPackageCollectionState would store the state of a collection of McuPackage
 */
export interface McuPackageCollectionState extends CollectionState {
 ...
 */
export interface McuPackageModelAudit extends AbstractModelAudit<McuPackageModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * McuPackageModelState would store the state of the model
 */
export interface McuPackageModelState {
	collectionState: {
		[key: string]: McuPackageCollectionState;
	};
	data: {
		[id: string]: McuPackageModel;
	};
	totalCount: number;
	audits: McuPackageModelAudit[];
 ...
 */
export const initialMcuPackageCollectionState: McuPackageCollectionState = {
...
/**
 * The initial state of McuPackageModelState
 */
export const initialState: McuPackageModelState = {
	collectionState: {
