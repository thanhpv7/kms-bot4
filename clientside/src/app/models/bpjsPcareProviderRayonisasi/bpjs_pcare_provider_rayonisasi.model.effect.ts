...
import * as modelAction from './bpjs_pcare_provider_rayonisasi.model.action';
import {BpjsPcareProviderRayonisasiService} from '../../services/bpjsPcareProviderRayonisasi/bpjs_pcare_provider_rayonisasi.service';
...
/**
 * Effect class used for side effects related to BPJS Pcare Provider Rayonisasi model.
 */
@Injectable()
export class BpjsPcareProviderRayonisasiEffect {
	...
	constructor(
		...
		protected readonly service: BpjsPcareProviderRayonisasiService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareProviderRayonisasiAction>(modelAction.BpjsPcareProviderRayonisasiModelActionTypes.COUNT_BPJS_PCARE_PROVIDER_RAYONISASIS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareProviderRayonisasiActionOK(
						modelAction.BpjsPcareProviderRayonisasiModelActionTypes.COUNT_BPJS_PCARE_PROVIDER_RAYONISASIS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareProviderRayonisasiActionFail(
								modelAction.BpjsPcareProviderRayonisasiModelActionTypes.COUNT_BPJS_PCARE_PROVIDER_RAYONISASIS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareProviderRayonisasiAction>(modelAction.BpjsPcareProviderRayonisasiModelActionTypes.FETCH_BPJS_PCARE_PROVIDER_RAYONISASI),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareProviderRayonisasiActionOK(
						modelAction.BpjsPcareProviderRayonisasiModelActionTypes.FETCH_BPJS_PCARE_PROVIDER_RAYONISASI_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareProviderRayonisasiActionFail(
								modelAction.BpjsPcareProviderRayonisasiModelActionTypes.FETCH_BPJS_PCARE_PROVIDER_RAYONISASI_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareProviderRayonisasiAction>(modelAction.BpjsPcareProviderRayonisasiModelActionTypes.FETCH_ALL_BPJS_PCARE_PROVIDER_RAYONISASI),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareProviderRayonisasiActionOK(
						modelAction.BpjsPcareProviderRayonisasiModelActionTypes.FETCH_ALL_BPJS_PCARE_PROVIDER_RAYONISASI_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareProviderRayonisasiActionFail(
								modelAction.BpjsPcareProviderRayonisasiModelActionTypes.FETCH_ALL_BPJS_PCARE_PROVIDER_RAYONISASI_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareProviderRayonisasiAction>(modelAction.BpjsPcareProviderRayonisasiModelActionTypes.FETCH_BPJS_PCARE_PROVIDER_RAYONISASI_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareProviderRayonisasiActionOK(
						modelAction.BpjsPcareProviderRayonisasiModelActionTypes.FETCH_BPJS_PCARE_PROVIDER_RAYONISASI_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareProviderRayonisasiActionFail(
								modelAction.BpjsPcareProviderRayonisasiModelActionTypes.FETCH_BPJS_PCARE_PROVIDER_RAYONISASI_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareProviderRayonisasiAction>(modelAction.BpjsPcareProviderRayonisasiModelActionTypes.FETCH_LAST_BPJS_PCARE_PROVIDER_RAYONISASI_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareProviderRayonisasiActionOK(
						modelAction.BpjsPcareProviderRayonisasiModelActionTypes.FETCH_LAST_BPJS_PCARE_PROVIDER_RAYONISASI_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareProviderRayonisasiActionFail(
								modelAction.BpjsPcareProviderRayonisasiModelActionTypes.FETCH_LAST_BPJS_PCARE_PROVIDER_RAYONISASI_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareProviderRayonisasiAction>(modelAction.BpjsPcareProviderRayonisasiModelActionTypes.CREATE_BPJS_PCARE_PROVIDER_RAYONISASI),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsPcareProviderRayonisasiModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareProviderRayonisasiActionOK(
						modelAction.BpjsPcareProviderRayonisasiModelActionTypes.CREATE_BPJS_PCARE_PROVIDER_RAYONISASI_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareProviderRayonisasiActionFail(
								modelAction.BpjsPcareProviderRayonisasiModelActionTypes.CREATE_BPJS_PCARE_PROVIDER_RAYONISASI_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareProviderRayonisasiAction>(modelAction.BpjsPcareProviderRayonisasiModelActionTypes.CREATE_ALL_BPJS_PCARE_PROVIDER_RAYONISASI),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsPcareProviderRayonisasiModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareProviderRayonisasiActionOK(
						modelAction.BpjsPcareProviderRayonisasiModelActionTypes.CREATE_ALL_BPJS_PCARE_PROVIDER_RAYONISASI_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareProviderRayonisasiActionFail(
								modelAction.BpjsPcareProviderRayonisasiModelActionTypes.CREATE_ALL_BPJS_PCARE_PROVIDER_RAYONISASI_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareProviderRayonisasiAction>(modelAction.BpjsPcareProviderRayonisasiModelActionTypes.UPDATE_BPJS_PCARE_PROVIDER_RAYONISASI),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsPcareProviderRayonisasiModel;
				...
				return this.service.update(new BpjsPcareProviderRayonisasiModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareProviderRayonisasiActionOK(
						modelAction.BpjsPcareProviderRayonisasiModelActionTypes.UPDATE_BPJS_PCARE_PROVIDER_RAYONISASI_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareProviderRayonisasiActionFail(
								modelAction.BpjsPcareProviderRayonisasiModelActionTypes.UPDATE_BPJS_PCARE_PROVIDER_RAYONISASI_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareProviderRayonisasiAction>(modelAction.BpjsPcareProviderRayonisasiModelActionTypes.UPDATE_ALL_BPJS_PCARE_PROVIDER_RAYONISASI),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsPcareProviderRayonisasiModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsPcareProviderRayonisasiModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareProviderRayonisasiActionOK(
						modelAction.BpjsPcareProviderRayonisasiModelActionTypes.UPDATE_ALL_BPJS_PCARE_PROVIDER_RAYONISASI_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareProviderRayonisasiActionFail(
								modelAction.BpjsPcareProviderRayonisasiModelActionTypes.UPDATE_ALL_BPJS_PCARE_PROVIDER_RAYONISASI_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareProviderRayonisasiAction>(modelAction.BpjsPcareProviderRayonisasiModelActionTypes.DELETE_BPJS_PCARE_PROVIDER_RAYONISASI),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareProviderRayonisasiActionOK(
						modelAction.BpjsPcareProviderRayonisasiModelActionTypes.DELETE_BPJS_PCARE_PROVIDER_RAYONISASI_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareProviderRayonisasiActionFail(
								modelAction.BpjsPcareProviderRayonisasiModelActionTypes.DELETE_BPJS_PCARE_PROVIDER_RAYONISASI_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareProviderRayonisasiAction>(modelAction.BpjsPcareProviderRayonisasiModelActionTypes.DELETE_BPJS_PCARE_PROVIDER_RAYONISASI_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareProviderRayonisasiActionOK(
						modelAction.BpjsPcareProviderRayonisasiModelActionTypes.DELETE_BPJS_PCARE_PROVIDER_RAYONISASI_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareProviderRayonisasiActionFail(
								modelAction.BpjsPcareProviderRayonisasiModelActionTypes.DELETE_BPJS_PCARE_PROVIDER_RAYONISASI_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareProviderRayonisasiAction>(modelAction.BpjsPcareProviderRayonisasiModelActionTypes.DELETE_ALL_BPJS_PCARE_PROVIDER_RAYONISASI),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareProviderRayonisasiActionOK(
						modelAction.BpjsPcareProviderRayonisasiModelActionTypes.DELETE_ALL_BPJS_PCARE_PROVIDER_RAYONISASI_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareProviderRayonisasiActionFail(
								modelAction.BpjsPcareProviderRayonisasiModelActionTypes.DELETE_ALL_BPJS_PCARE_PROVIDER_RAYONISASI_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareProviderRayonisasiAction>(modelAction.BpjsPcareProviderRayonisasiModelActionTypes.EXPORT_BPJS_PCARE_PROVIDER_RAYONISASI),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareProviderRayonisasiActionOK(
						modelAction.BpjsPcareProviderRayonisasiModelActionTypes.EXPORT_BPJS_PCARE_PROVIDER_RAYONISASI,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareProviderRayonisasiAction>(modelAction.BpjsPcareProviderRayonisasiModelActionTypes.EXPORT_ALL_BPJS_PCARE_PROVIDER_RAYONISASI),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareProviderRayonisasiActionOK(
						modelAction.BpjsPcareProviderRayonisasiModelActionTypes.EXPORT_ALL_BPJS_PCARE_PROVIDER_RAYONISASI_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareProviderRayonisasiActionFail(
								modelAction.BpjsPcareProviderRayonisasiModelActionTypes.EXPORT_ALL_BPJS_PCARE_PROVIDER_RAYONISASI_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareProviderRayonisasiAction>(modelAction.BpjsPcareProviderRayonisasiModelActionTypes.EXPORT_BPJS_PCARE_PROVIDER_RAYONISASI_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareProviderRayonisasiActionOK(
						modelAction.BpjsPcareProviderRayonisasiModelActionTypes.EXPORT_BPJS_PCARE_PROVIDER_RAYONISASI_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareProviderRayonisasiActionFail(
								modelAction.BpjsPcareProviderRayonisasiModelActionTypes.EXPORT_BPJS_PCARE_PROVIDER_RAYONISASI_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareProviderRayonisasiAction>(modelAction.BpjsPcareProviderRayonisasiModelActionTypes.IMPORT_BPJS_PCARE_PROVIDER_RAYONISASIS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareProviderRayonisasiActionOK(
						modelAction.BpjsPcareProviderRayonisasiModelActionTypes.IMPORT_BPJS_PCARE_PROVIDER_RAYONISASIS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareProviderRayonisasiActionFail(
								modelAction.BpjsPcareProviderRayonisasiModelActionTypes.IMPORT_BPJS_PCARE_PROVIDER_RAYONISASIS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareProviderRayonisasiAction>(modelAction.BpjsPcareProviderRayonisasiModelActionTypes.FETCH_BPJS_PCARE_PROVIDER_RAYONISASI_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsPcareProviderRayonisasiActionOK(
						modelAction.BpjsPcareProviderRayonisasiModelActionTypes.FETCH_BPJS_PCARE_PROVIDER_RAYONISASI_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareProviderRayonisasiActionFail(
								modelAction.BpjsPcareProviderRayonisasiModelActionTypes.FETCH_BPJS_PCARE_PROVIDER_RAYONISASI_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareProviderRayonisasiAction>(modelAction.BpjsPcareProviderRayonisasiModelActionTypes.FETCH_BPJS_PCARE_PROVIDER_RAYONISASI_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsPcareProviderRayonisasiActionOK(
						modelAction.BpjsPcareProviderRayonisasiModelActionTypes.FETCH_BPJS_PCARE_PROVIDER_RAYONISASI_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareProviderRayonisasiActionFail(
								modelAction.BpjsPcareProviderRayonisasiModelActionTypes.FETCH_BPJS_PCARE_PROVIDER_RAYONISASI_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
