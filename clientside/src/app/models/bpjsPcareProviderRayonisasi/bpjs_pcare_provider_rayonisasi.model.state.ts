...
/**
 * BpjsPcareProviderRayonisasiCollectionState would store the state of a collection of BpjsPcareProviderRayonisasi
 */
export interface BpjsPcareProviderRayonisasiCollectionState extends CollectionState {
 ...
 */
export interface BpjsPcareProviderRayonisasiModelAudit extends AbstractModelAudit<BpjsPcareProviderRayonisasiModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsPcareProviderRayonisasiModelState would store the state of the model
 */
export interface BpjsPcareProviderRayonisasiModelState {
	collectionState: {
		[key: string]: BpjsPcareProviderRayonisasiCollectionState;
	};
	data: {
		[id: string]: BpjsPcareProviderRayonisasiModel;
	};
	totalCount: number;
	audits: BpjsPcareProviderRayonisasiModelAudit[];
 ...
 */
export const initialBpjsPcareProviderRayonisasiCollectionState: BpjsPcareProviderRayonisasiCollectionState = {
...
/**
 * The initial state of BpjsPcareProviderRayonisasiModelState
 */
export const initialState: BpjsPcareProviderRayonisasiModelState = {
	collectionState: {
