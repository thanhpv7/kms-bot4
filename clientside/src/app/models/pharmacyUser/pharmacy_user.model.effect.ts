...
import * as modelAction from './pharmacy_user.model.action';
import {PharmacyUserService} from '../../services/pharmacyUser/pharmacy_user.service';
...
/**
 * Effect class used for side effects related to Pharmacy User model.
 */
@Injectable()
export class PharmacyUserEffect {
	...
	constructor(
		...
		protected readonly service: PharmacyUserService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PharmacyUserAction>(modelAction.PharmacyUserModelActionTypes.COUNT_PHARMACY_USERS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.PharmacyUserActionOK(
						modelAction.PharmacyUserModelActionTypes.COUNT_PHARMACY_USERS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PharmacyUserActionFail(
								modelAction.PharmacyUserModelActionTypes.COUNT_PHARMACY_USERS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PharmacyUserAction>(modelAction.PharmacyUserModelActionTypes.FETCH_PHARMACY_USER),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PharmacyUserActionOK(
						modelAction.PharmacyUserModelActionTypes.FETCH_PHARMACY_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PharmacyUserActionFail(
								modelAction.PharmacyUserModelActionTypes.FETCH_PHARMACY_USER_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PharmacyUserAction>(modelAction.PharmacyUserModelActionTypes.FETCH_ALL_PHARMACY_USER),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.PharmacyUserActionOK(
						modelAction.PharmacyUserModelActionTypes.FETCH_ALL_PHARMACY_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PharmacyUserActionFail(
								modelAction.PharmacyUserModelActionTypes.FETCH_ALL_PHARMACY_USER_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PharmacyUserAction>(modelAction.PharmacyUserModelActionTypes.FETCH_PHARMACY_USER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PharmacyUserActionOK(
						modelAction.PharmacyUserModelActionTypes.FETCH_PHARMACY_USER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PharmacyUserActionFail(
								modelAction.PharmacyUserModelActionTypes.FETCH_PHARMACY_USER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PharmacyUserAction>(modelAction.PharmacyUserModelActionTypes.FETCH_LAST_PHARMACY_USER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PharmacyUserActionOK(
						modelAction.PharmacyUserModelActionTypes.FETCH_LAST_PHARMACY_USER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PharmacyUserActionFail(
								modelAction.PharmacyUserModelActionTypes.FETCH_LAST_PHARMACY_USER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PharmacyUserAction>(modelAction.PharmacyUserModelActionTypes.CREATE_PHARMACY_USER),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as PharmacyUserModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PharmacyUserActionOK(
						modelAction.PharmacyUserModelActionTypes.CREATE_PHARMACY_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PharmacyUserActionFail(
								modelAction.PharmacyUserModelActionTypes.CREATE_PHARMACY_USER_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PharmacyUserAction>(modelAction.PharmacyUserModelActionTypes.CREATE_ALL_PHARMACY_USER),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as PharmacyUserModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PharmacyUserActionOK(
						modelAction.PharmacyUserModelActionTypes.CREATE_ALL_PHARMACY_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PharmacyUserActionFail(
								modelAction.PharmacyUserModelActionTypes.CREATE_ALL_PHARMACY_USER_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PharmacyUserAction>(modelAction.PharmacyUserModelActionTypes.UPDATE_PHARMACY_USER),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as PharmacyUserModel;
				...
				return this.service.update(new PharmacyUserModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.PharmacyUserActionOK(
						modelAction.PharmacyUserModelActionTypes.UPDATE_PHARMACY_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PharmacyUserActionFail(
								modelAction.PharmacyUserModelActionTypes.UPDATE_PHARMACY_USER_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PharmacyUserAction>(modelAction.PharmacyUserModelActionTypes.UPDATE_ALL_PHARMACY_USER),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as PharmacyUserModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new PharmacyUserModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PharmacyUserActionOK(
						modelAction.PharmacyUserModelActionTypes.UPDATE_ALL_PHARMACY_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PharmacyUserActionFail(
								modelAction.PharmacyUserModelActionTypes.UPDATE_ALL_PHARMACY_USER_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PharmacyUserAction>(modelAction.PharmacyUserModelActionTypes.DELETE_PHARMACY_USER),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PharmacyUserActionOK(
						modelAction.PharmacyUserModelActionTypes.DELETE_PHARMACY_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PharmacyUserActionFail(
								modelAction.PharmacyUserModelActionTypes.DELETE_PHARMACY_USER_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PharmacyUserAction>(modelAction.PharmacyUserModelActionTypes.DELETE_PHARMACY_USER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.PharmacyUserActionOK(
						modelAction.PharmacyUserModelActionTypes.DELETE_PHARMACY_USER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PharmacyUserActionFail(
								modelAction.PharmacyUserModelActionTypes.DELETE_PHARMACY_USER_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PharmacyUserAction>(modelAction.PharmacyUserModelActionTypes.DELETE_ALL_PHARMACY_USER),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PharmacyUserActionOK(
						modelAction.PharmacyUserModelActionTypes.DELETE_ALL_PHARMACY_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PharmacyUserActionFail(
								modelAction.PharmacyUserModelActionTypes.DELETE_ALL_PHARMACY_USER_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PharmacyUserAction>(modelAction.PharmacyUserModelActionTypes.EXPORT_PHARMACY_USER),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PharmacyUserActionOK(
						modelAction.PharmacyUserModelActionTypes.EXPORT_PHARMACY_USER,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PharmacyUserAction>(modelAction.PharmacyUserModelActionTypes.EXPORT_ALL_PHARMACY_USER),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PharmacyUserActionOK(
						modelAction.PharmacyUserModelActionTypes.EXPORT_ALL_PHARMACY_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PharmacyUserActionFail(
								modelAction.PharmacyUserModelActionTypes.EXPORT_ALL_PHARMACY_USER_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PharmacyUserAction>(modelAction.PharmacyUserModelActionTypes.EXPORT_PHARMACY_USER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PharmacyUserActionOK(
						modelAction.PharmacyUserModelActionTypes.EXPORT_PHARMACY_USER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PharmacyUserActionFail(
								modelAction.PharmacyUserModelActionTypes.EXPORT_PHARMACY_USER_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PharmacyUserAction>(modelAction.PharmacyUserModelActionTypes.IMPORT_PHARMACY_USERS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.PharmacyUserActionOK(
						modelAction.PharmacyUserModelActionTypes.IMPORT_PHARMACY_USERS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PharmacyUserActionFail(
								modelAction.PharmacyUserModelActionTypes.IMPORT_PHARMACY_USERS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PharmacyUserAction>(modelAction.PharmacyUserModelActionTypes.FETCH_PHARMACY_USER_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.PharmacyUserActionOK(
						modelAction.PharmacyUserModelActionTypes.FETCH_PHARMACY_USER_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PharmacyUserActionFail(
								modelAction.PharmacyUserModelActionTypes.FETCH_PHARMACY_USER_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PharmacyUserAction>(modelAction.PharmacyUserModelActionTypes.FETCH_PHARMACY_USER_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.PharmacyUserActionOK(
						modelAction.PharmacyUserModelActionTypes.FETCH_PHARMACY_USER_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PharmacyUserActionFail(
								modelAction.PharmacyUserModelActionTypes.FETCH_PHARMACY_USER_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
