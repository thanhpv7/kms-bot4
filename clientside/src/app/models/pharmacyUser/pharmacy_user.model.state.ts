...
/**
 * PharmacyUserCollectionState would store the state of a collection of PharmacyUser
 */
export interface PharmacyUserCollectionState extends CollectionState {
 ...
 */
export interface PharmacyUserModelAudit extends AbstractModelAudit<PharmacyUserModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * PharmacyUserModelState would store the state of the model
 */
export interface PharmacyUserModelState {
	collectionState: {
		[key: string]: PharmacyUserCollectionState;
	};
	data: {
		[id: string]: PharmacyUserModel;
	};
	totalCount: number;
	audits: PharmacyUserModelAudit[];
 ...
 */
export const initialPharmacyUserCollectionState: PharmacyUserCollectionState = {
...
/**
 * The initial state of PharmacyUserModelState
 */
export const initialState: PharmacyUserModelState = {
	collectionState: {
