...
/**
 * SepCollectionState would store the state of a collection of Sep
 */
export interface SepCollectionState extends CollectionState {
 ...
 */
export interface SepModelAudit extends AbstractModelAudit<SepModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * SepModelState would store the state of the model
 */
export interface SepModelState {
	collectionState: {
		[key: string]: SepCollectionState;
	};
	data: {
		[id: string]: SepModel;
	};
	totalCount: number;
	audits: SepModelAudit[];
 ...
 */
export const initialSepCollectionState: SepCollectionState = {
...
/**
 * The initial state of SepModelState
 */
export const initialState: SepModelState = {
	collectionState: {
