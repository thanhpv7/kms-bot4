...
import {SepService} from '../../services/sep/sep.service';
...
/**
 * Effect class used for side effects related to SEP model.
 */
@Injectable()
export class SepEffect {
	...
	constructor(
		...
		protected readonly service: SepService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SepAction>(modelAction.SepModelActionTypes.COUNT_SEPS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.SepActionOK(
						modelAction.SepModelActionTypes.COUNT_SEPS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SepActionFail(
								modelAction.SepModelActionTypes.COUNT_SEPS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SepAction>(modelAction.SepModelActionTypes.FETCH_SEP),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.SepActionOK(
						modelAction.SepModelActionTypes.FETCH_SEP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SepActionFail(
								modelAction.SepModelActionTypes.FETCH_SEP_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SepAction>(modelAction.SepModelActionTypes.FETCH_ALL_SEP),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.SepActionOK(
						modelAction.SepModelActionTypes.FETCH_ALL_SEP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SepActionFail(
								modelAction.SepModelActionTypes.FETCH_ALL_SEP_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SepAction>(modelAction.SepModelActionTypes.FETCH_SEP_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.SepActionOK(
						modelAction.SepModelActionTypes.FETCH_SEP_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SepActionFail(
								modelAction.SepModelActionTypes.FETCH_SEP_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SepAction>(modelAction.SepModelActionTypes.FETCH_LAST_SEP_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.SepActionOK(
						modelAction.SepModelActionTypes.FETCH_LAST_SEP_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SepActionFail(
								modelAction.SepModelActionTypes.FETCH_LAST_SEP_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SepAction>(modelAction.SepModelActionTypes.CREATE_SEP),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as SepModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.SepActionOK(
						modelAction.SepModelActionTypes.CREATE_SEP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SepActionFail(
								modelAction.SepModelActionTypes.CREATE_SEP_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SepAction>(modelAction.SepModelActionTypes.CREATE_ALL_SEP),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as SepModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.SepActionOK(
						modelAction.SepModelActionTypes.CREATE_ALL_SEP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SepActionFail(
								modelAction.SepModelActionTypes.CREATE_ALL_SEP_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SepAction>(modelAction.SepModelActionTypes.UPDATE_SEP),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as SepModel;
				...
				return this.service.update(new SepModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.SepActionOK(
						modelAction.SepModelActionTypes.UPDATE_SEP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SepActionFail(
								modelAction.SepModelActionTypes.UPDATE_SEP_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SepAction>(modelAction.SepModelActionTypes.UPDATE_ALL_SEP),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as SepModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new SepModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.SepActionOK(
						modelAction.SepModelActionTypes.UPDATE_ALL_SEP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SepActionFail(
								modelAction.SepModelActionTypes.UPDATE_ALL_SEP_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SepAction>(modelAction.SepModelActionTypes.DELETE_SEP),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.SepActionOK(
						modelAction.SepModelActionTypes.DELETE_SEP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SepActionFail(
								modelAction.SepModelActionTypes.DELETE_SEP_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SepAction>(modelAction.SepModelActionTypes.DELETE_SEP_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.SepActionOK(
						modelAction.SepModelActionTypes.DELETE_SEP_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SepActionFail(
								modelAction.SepModelActionTypes.DELETE_SEP_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SepAction>(modelAction.SepModelActionTypes.DELETE_ALL_SEP),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.SepActionOK(
						modelAction.SepModelActionTypes.DELETE_ALL_SEP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SepActionFail(
								modelAction.SepModelActionTypes.DELETE_ALL_SEP_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SepAction>(modelAction.SepModelActionTypes.EXPORT_SEP),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.SepActionOK(
						modelAction.SepModelActionTypes.EXPORT_SEP,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SepAction>(modelAction.SepModelActionTypes.EXPORT_ALL_SEP),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.SepActionOK(
						modelAction.SepModelActionTypes.EXPORT_ALL_SEP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SepActionFail(
								modelAction.SepModelActionTypes.EXPORT_ALL_SEP_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SepAction>(modelAction.SepModelActionTypes.EXPORT_SEP_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.SepActionOK(
						modelAction.SepModelActionTypes.EXPORT_SEP_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SepActionFail(
								modelAction.SepModelActionTypes.EXPORT_SEP_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SepAction>(modelAction.SepModelActionTypes.IMPORT_SEPS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.SepActionOK(
						modelAction.SepModelActionTypes.IMPORT_SEPS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SepActionFail(
								modelAction.SepModelActionTypes.IMPORT_SEPS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SepAction>(modelAction.SepModelActionTypes.FETCH_SEP_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.SepActionOK(
						modelAction.SepModelActionTypes.FETCH_SEP_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.SepActionFail(
								modelAction.SepModelActionTypes.FETCH_SEP_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SepAction>(modelAction.SepModelActionTypes.FETCH_SEP_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.SepActionOK(
						modelAction.SepModelActionTypes.FETCH_SEP_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.SepActionFail(
								modelAction.SepModelActionTypes.FETCH_SEP_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
