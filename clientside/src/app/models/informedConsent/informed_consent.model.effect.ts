...
import * as modelAction from './informed_consent.model.action';
import {InformedConsentService} from '../../services/informedConsent/informed_consent.service';
...
/**
 * Effect class used for side effects related to Informed Consent model.
 */
@Injectable()
export class InformedConsentEffect {
	...
	constructor(
		...
		protected readonly service: InformedConsentService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InformedConsentAction>(modelAction.InformedConsentModelActionTypes.COUNT_INFORMED_CONSENTS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.InformedConsentActionOK(
						modelAction.InformedConsentModelActionTypes.COUNT_INFORMED_CONSENTS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InformedConsentActionFail(
								modelAction.InformedConsentModelActionTypes.COUNT_INFORMED_CONSENTS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InformedConsentAction>(modelAction.InformedConsentModelActionTypes.FETCH_INFORMED_CONSENT),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InformedConsentActionOK(
						modelAction.InformedConsentModelActionTypes.FETCH_INFORMED_CONSENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InformedConsentActionFail(
								modelAction.InformedConsentModelActionTypes.FETCH_INFORMED_CONSENT_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InformedConsentAction>(modelAction.InformedConsentModelActionTypes.FETCH_ALL_INFORMED_CONSENT),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.InformedConsentActionOK(
						modelAction.InformedConsentModelActionTypes.FETCH_ALL_INFORMED_CONSENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InformedConsentActionFail(
								modelAction.InformedConsentModelActionTypes.FETCH_ALL_INFORMED_CONSENT_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InformedConsentAction>(modelAction.InformedConsentModelActionTypes.FETCH_INFORMED_CONSENT_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.InformedConsentActionOK(
						modelAction.InformedConsentModelActionTypes.FETCH_INFORMED_CONSENT_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InformedConsentActionFail(
								modelAction.InformedConsentModelActionTypes.FETCH_INFORMED_CONSENT_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InformedConsentAction>(modelAction.InformedConsentModelActionTypes.FETCH_LAST_INFORMED_CONSENT_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.InformedConsentActionOK(
						modelAction.InformedConsentModelActionTypes.FETCH_LAST_INFORMED_CONSENT_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InformedConsentActionFail(
								modelAction.InformedConsentModelActionTypes.FETCH_LAST_INFORMED_CONSENT_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InformedConsentAction>(modelAction.InformedConsentModelActionTypes.CREATE_INFORMED_CONSENT),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as InformedConsentModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InformedConsentActionOK(
						modelAction.InformedConsentModelActionTypes.CREATE_INFORMED_CONSENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InformedConsentActionFail(
								modelAction.InformedConsentModelActionTypes.CREATE_INFORMED_CONSENT_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InformedConsentAction>(modelAction.InformedConsentModelActionTypes.CREATE_ALL_INFORMED_CONSENT),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as InformedConsentModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InformedConsentActionOK(
						modelAction.InformedConsentModelActionTypes.CREATE_ALL_INFORMED_CONSENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InformedConsentActionFail(
								modelAction.InformedConsentModelActionTypes.CREATE_ALL_INFORMED_CONSENT_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InformedConsentAction>(modelAction.InformedConsentModelActionTypes.UPDATE_INFORMED_CONSENT),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as InformedConsentModel;
				...
				return this.service.update(new InformedConsentModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.InformedConsentActionOK(
						modelAction.InformedConsentModelActionTypes.UPDATE_INFORMED_CONSENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InformedConsentActionFail(
								modelAction.InformedConsentModelActionTypes.UPDATE_INFORMED_CONSENT_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InformedConsentAction>(modelAction.InformedConsentModelActionTypes.UPDATE_ALL_INFORMED_CONSENT),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as InformedConsentModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new InformedConsentModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InformedConsentActionOK(
						modelAction.InformedConsentModelActionTypes.UPDATE_ALL_INFORMED_CONSENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InformedConsentActionFail(
								modelAction.InformedConsentModelActionTypes.UPDATE_ALL_INFORMED_CONSENT_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InformedConsentAction>(modelAction.InformedConsentModelActionTypes.DELETE_INFORMED_CONSENT),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.InformedConsentActionOK(
						modelAction.InformedConsentModelActionTypes.DELETE_INFORMED_CONSENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InformedConsentActionFail(
								modelAction.InformedConsentModelActionTypes.DELETE_INFORMED_CONSENT_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InformedConsentAction>(modelAction.InformedConsentModelActionTypes.DELETE_INFORMED_CONSENT_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.InformedConsentActionOK(
						modelAction.InformedConsentModelActionTypes.DELETE_INFORMED_CONSENT_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InformedConsentActionFail(
								modelAction.InformedConsentModelActionTypes.DELETE_INFORMED_CONSENT_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InformedConsentAction>(modelAction.InformedConsentModelActionTypes.DELETE_ALL_INFORMED_CONSENT),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.InformedConsentActionOK(
						modelAction.InformedConsentModelActionTypes.DELETE_ALL_INFORMED_CONSENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InformedConsentActionFail(
								modelAction.InformedConsentModelActionTypes.DELETE_ALL_INFORMED_CONSENT_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InformedConsentAction>(modelAction.InformedConsentModelActionTypes.EXPORT_INFORMED_CONSENT),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.InformedConsentActionOK(
						modelAction.InformedConsentModelActionTypes.EXPORT_INFORMED_CONSENT,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InformedConsentAction>(modelAction.InformedConsentModelActionTypes.EXPORT_ALL_INFORMED_CONSENT),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.InformedConsentActionOK(
						modelAction.InformedConsentModelActionTypes.EXPORT_ALL_INFORMED_CONSENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InformedConsentActionFail(
								modelAction.InformedConsentModelActionTypes.EXPORT_ALL_INFORMED_CONSENT_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InformedConsentAction>(modelAction.InformedConsentModelActionTypes.EXPORT_INFORMED_CONSENT_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.InformedConsentActionOK(
						modelAction.InformedConsentModelActionTypes.EXPORT_INFORMED_CONSENT_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InformedConsentActionFail(
								modelAction.InformedConsentModelActionTypes.EXPORT_INFORMED_CONSENT_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InformedConsentAction>(modelAction.InformedConsentModelActionTypes.IMPORT_INFORMED_CONSENTS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.InformedConsentActionOK(
						modelAction.InformedConsentModelActionTypes.IMPORT_INFORMED_CONSENTS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InformedConsentActionFail(
								modelAction.InformedConsentModelActionTypes.IMPORT_INFORMED_CONSENTS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InformedConsentAction>(modelAction.InformedConsentModelActionTypes.FETCH_INFORMED_CONSENT_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.InformedConsentActionOK(
						modelAction.InformedConsentModelActionTypes.FETCH_INFORMED_CONSENT_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.InformedConsentActionFail(
								modelAction.InformedConsentModelActionTypes.FETCH_INFORMED_CONSENT_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InformedConsentAction>(modelAction.InformedConsentModelActionTypes.FETCH_INFORMED_CONSENT_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.InformedConsentActionOK(
						modelAction.InformedConsentModelActionTypes.FETCH_INFORMED_CONSENT_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.InformedConsentActionFail(
								modelAction.InformedConsentModelActionTypes.FETCH_INFORMED_CONSENT_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
