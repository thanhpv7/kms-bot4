...
/**
 * InformedConsentCollectionState would store the state of a collection of InformedConsent
 */
export interface InformedConsentCollectionState extends CollectionState {
 ...
 */
export interface InformedConsentModelAudit extends AbstractModelAudit<InformedConsentModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * InformedConsentModelState would store the state of the model
 */
export interface InformedConsentModelState {
	collectionState: {
		[key: string]: InformedConsentCollectionState;
	};
	data: {
		[id: string]: InformedConsentModel;
	};
	totalCount: number;
	audits: InformedConsentModelAudit[];
 ...
 */
export const initialInformedConsentCollectionState: InformedConsentCollectionState = {
...
/**
 * The initial state of InformedConsentModelState
 */
export const initialState: InformedConsentModelState = {
	collectionState: {
