...
/**
 * DiagnosticExaminationResultsCollectionState would store the state of a collection of DiagnosticExaminationResults
 */
export interface DiagnosticExaminationResultsCollectionState extends CollectionState {
 ...
 */
export interface DiagnosticExaminationResultsModelAudit extends AbstractModelAudit<DiagnosticExaminationResultsModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * DiagnosticExaminationResultsModelState would store the state of the model
 */
export interface DiagnosticExaminationResultsModelState {
	collectionState: {
		[key: string]: DiagnosticExaminationResultsCollectionState;
	};
	data: {
		[id: string]: DiagnosticExaminationResultsModel;
	};
	totalCount: number;
	audits: DiagnosticExaminationResultsModelAudit[];
 ...
 */
export const initialDiagnosticExaminationResultsCollectionState: DiagnosticExaminationResultsCollectionState = {
...
/**
 * The initial state of DiagnosticExaminationResultsModelState
 */
export const initialState: DiagnosticExaminationResultsModelState = {
	collectionState: {
