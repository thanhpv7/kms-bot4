...
import * as modelAction from './diagnostic_examination_results.model.action';
import {DiagnosticExaminationResultsService} from '../../services/diagnosticExaminationResults/diagnostic_examination_results.service';
...
/**
 * Effect class used for side effects related to Diagnostic Examination Results model.
 */
@Injectable()
export class DiagnosticExaminationResultsEffect {
	...
	constructor(
		...
		protected readonly service: DiagnosticExaminationResultsService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticExaminationResultsAction>(modelAction.DiagnosticExaminationResultsModelActionTypes.COUNT_DIAGNOSTIC_EXAMINATION_RESULTSS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.DiagnosticExaminationResultsActionOK(
						modelAction.DiagnosticExaminationResultsModelActionTypes.COUNT_DIAGNOSTIC_EXAMINATION_RESULTSS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticExaminationResultsActionFail(
								modelAction.DiagnosticExaminationResultsModelActionTypes.COUNT_DIAGNOSTIC_EXAMINATION_RESULTSS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticExaminationResultsAction>(modelAction.DiagnosticExaminationResultsModelActionTypes.FETCH_DIAGNOSTIC_EXAMINATION_RESULTS),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticExaminationResultsActionOK(
						modelAction.DiagnosticExaminationResultsModelActionTypes.FETCH_DIAGNOSTIC_EXAMINATION_RESULTS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticExaminationResultsActionFail(
								modelAction.DiagnosticExaminationResultsModelActionTypes.FETCH_DIAGNOSTIC_EXAMINATION_RESULTS_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticExaminationResultsAction>(modelAction.DiagnosticExaminationResultsModelActionTypes.FETCH_ALL_DIAGNOSTIC_EXAMINATION_RESULTS),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.DiagnosticExaminationResultsActionOK(
						modelAction.DiagnosticExaminationResultsModelActionTypes.FETCH_ALL_DIAGNOSTIC_EXAMINATION_RESULTS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticExaminationResultsActionFail(
								modelAction.DiagnosticExaminationResultsModelActionTypes.FETCH_ALL_DIAGNOSTIC_EXAMINATION_RESULTS_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticExaminationResultsAction>(modelAction.DiagnosticExaminationResultsModelActionTypes.FETCH_DIAGNOSTIC_EXAMINATION_RESULTS_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticExaminationResultsActionOK(
						modelAction.DiagnosticExaminationResultsModelActionTypes.FETCH_DIAGNOSTIC_EXAMINATION_RESULTS_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticExaminationResultsActionFail(
								modelAction.DiagnosticExaminationResultsModelActionTypes.FETCH_DIAGNOSTIC_EXAMINATION_RESULTS_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticExaminationResultsAction>(modelAction.DiagnosticExaminationResultsModelActionTypes.FETCH_LAST_DIAGNOSTIC_EXAMINATION_RESULTS_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticExaminationResultsActionOK(
						modelAction.DiagnosticExaminationResultsModelActionTypes.FETCH_LAST_DIAGNOSTIC_EXAMINATION_RESULTS_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticExaminationResultsActionFail(
								modelAction.DiagnosticExaminationResultsModelActionTypes.FETCH_LAST_DIAGNOSTIC_EXAMINATION_RESULTS_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticExaminationResultsAction>(modelAction.DiagnosticExaminationResultsModelActionTypes.CREATE_DIAGNOSTIC_EXAMINATION_RESULTS),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as DiagnosticExaminationResultsModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticExaminationResultsActionOK(
						modelAction.DiagnosticExaminationResultsModelActionTypes.CREATE_DIAGNOSTIC_EXAMINATION_RESULTS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticExaminationResultsActionFail(
								modelAction.DiagnosticExaminationResultsModelActionTypes.CREATE_DIAGNOSTIC_EXAMINATION_RESULTS_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticExaminationResultsAction>(modelAction.DiagnosticExaminationResultsModelActionTypes.CREATE_ALL_DIAGNOSTIC_EXAMINATION_RESULTS),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as DiagnosticExaminationResultsModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticExaminationResultsActionOK(
						modelAction.DiagnosticExaminationResultsModelActionTypes.CREATE_ALL_DIAGNOSTIC_EXAMINATION_RESULTS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticExaminationResultsActionFail(
								modelAction.DiagnosticExaminationResultsModelActionTypes.CREATE_ALL_DIAGNOSTIC_EXAMINATION_RESULTS_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticExaminationResultsAction>(modelAction.DiagnosticExaminationResultsModelActionTypes.UPDATE_DIAGNOSTIC_EXAMINATION_RESULTS),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as DiagnosticExaminationResultsModel;
				...
				return this.service.update(new DiagnosticExaminationResultsModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticExaminationResultsActionOK(
						modelAction.DiagnosticExaminationResultsModelActionTypes.UPDATE_DIAGNOSTIC_EXAMINATION_RESULTS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticExaminationResultsActionFail(
								modelAction.DiagnosticExaminationResultsModelActionTypes.UPDATE_DIAGNOSTIC_EXAMINATION_RESULTS_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticExaminationResultsAction>(modelAction.DiagnosticExaminationResultsModelActionTypes.UPDATE_ALL_DIAGNOSTIC_EXAMINATION_RESULTS),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as DiagnosticExaminationResultsModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new DiagnosticExaminationResultsModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticExaminationResultsActionOK(
						modelAction.DiagnosticExaminationResultsModelActionTypes.UPDATE_ALL_DIAGNOSTIC_EXAMINATION_RESULTS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticExaminationResultsActionFail(
								modelAction.DiagnosticExaminationResultsModelActionTypes.UPDATE_ALL_DIAGNOSTIC_EXAMINATION_RESULTS_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticExaminationResultsAction>(modelAction.DiagnosticExaminationResultsModelActionTypes.DELETE_DIAGNOSTIC_EXAMINATION_RESULTS),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticExaminationResultsActionOK(
						modelAction.DiagnosticExaminationResultsModelActionTypes.DELETE_DIAGNOSTIC_EXAMINATION_RESULTS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticExaminationResultsActionFail(
								modelAction.DiagnosticExaminationResultsModelActionTypes.DELETE_DIAGNOSTIC_EXAMINATION_RESULTS_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticExaminationResultsAction>(modelAction.DiagnosticExaminationResultsModelActionTypes.DELETE_DIAGNOSTIC_EXAMINATION_RESULTS_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticExaminationResultsActionOK(
						modelAction.DiagnosticExaminationResultsModelActionTypes.DELETE_DIAGNOSTIC_EXAMINATION_RESULTS_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticExaminationResultsActionFail(
								modelAction.DiagnosticExaminationResultsModelActionTypes.DELETE_DIAGNOSTIC_EXAMINATION_RESULTS_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticExaminationResultsAction>(modelAction.DiagnosticExaminationResultsModelActionTypes.DELETE_ALL_DIAGNOSTIC_EXAMINATION_RESULTS),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticExaminationResultsActionOK(
						modelAction.DiagnosticExaminationResultsModelActionTypes.DELETE_ALL_DIAGNOSTIC_EXAMINATION_RESULTS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticExaminationResultsActionFail(
								modelAction.DiagnosticExaminationResultsModelActionTypes.DELETE_ALL_DIAGNOSTIC_EXAMINATION_RESULTS_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticExaminationResultsAction>(modelAction.DiagnosticExaminationResultsModelActionTypes.EXPORT_DIAGNOSTIC_EXAMINATION_RESULTS),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticExaminationResultsActionOK(
						modelAction.DiagnosticExaminationResultsModelActionTypes.EXPORT_DIAGNOSTIC_EXAMINATION_RESULTS,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticExaminationResultsAction>(modelAction.DiagnosticExaminationResultsModelActionTypes.EXPORT_ALL_DIAGNOSTIC_EXAMINATION_RESULTS),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticExaminationResultsActionOK(
						modelAction.DiagnosticExaminationResultsModelActionTypes.EXPORT_ALL_DIAGNOSTIC_EXAMINATION_RESULTS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticExaminationResultsActionFail(
								modelAction.DiagnosticExaminationResultsModelActionTypes.EXPORT_ALL_DIAGNOSTIC_EXAMINATION_RESULTS_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticExaminationResultsAction>(modelAction.DiagnosticExaminationResultsModelActionTypes.EXPORT_DIAGNOSTIC_EXAMINATION_RESULTS_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticExaminationResultsActionOK(
						modelAction.DiagnosticExaminationResultsModelActionTypes.EXPORT_DIAGNOSTIC_EXAMINATION_RESULTS_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticExaminationResultsActionFail(
								modelAction.DiagnosticExaminationResultsModelActionTypes.EXPORT_DIAGNOSTIC_EXAMINATION_RESULTS_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticExaminationResultsAction>(modelAction.DiagnosticExaminationResultsModelActionTypes.IMPORT_DIAGNOSTIC_EXAMINATION_RESULTSS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticExaminationResultsActionOK(
						modelAction.DiagnosticExaminationResultsModelActionTypes.IMPORT_DIAGNOSTIC_EXAMINATION_RESULTSS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticExaminationResultsActionFail(
								modelAction.DiagnosticExaminationResultsModelActionTypes.IMPORT_DIAGNOSTIC_EXAMINATION_RESULTSS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticExaminationResultsAction>(modelAction.DiagnosticExaminationResultsModelActionTypes.FETCH_DIAGNOSTIC_EXAMINATION_RESULTS_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.DiagnosticExaminationResultsActionOK(
						modelAction.DiagnosticExaminationResultsModelActionTypes.FETCH_DIAGNOSTIC_EXAMINATION_RESULTS_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticExaminationResultsActionFail(
								modelAction.DiagnosticExaminationResultsModelActionTypes.FETCH_DIAGNOSTIC_EXAMINATION_RESULTS_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticExaminationResultsAction>(modelAction.DiagnosticExaminationResultsModelActionTypes.FETCH_DIAGNOSTIC_EXAMINATION_RESULTS_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.DiagnosticExaminationResultsActionOK(
						modelAction.DiagnosticExaminationResultsModelActionTypes.FETCH_DIAGNOSTIC_EXAMINATION_RESULTS_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticExaminationResultsActionFail(
								modelAction.DiagnosticExaminationResultsModelActionTypes.FETCH_DIAGNOSTIC_EXAMINATION_RESULTS_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
