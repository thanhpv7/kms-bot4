...
import * as modelAction from './bpjs_treatment_room.model.action';
import {BpjsTreatmentRoomService} from '../../services/bpjsTreatmentRoom/bpjs_treatment_room.service';
...
/**
 * Effect class used for side effects related to BPJS Treatment Room model.
 */
@Injectable()
export class BpjsTreatmentRoomEffect {
	...
	constructor(
		...
		protected readonly service: BpjsTreatmentRoomService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentRoomAction>(modelAction.BpjsTreatmentRoomModelActionTypes.COUNT_BPJS_TREATMENT_ROOMS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsTreatmentRoomActionOK(
						modelAction.BpjsTreatmentRoomModelActionTypes.COUNT_BPJS_TREATMENT_ROOMS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentRoomActionFail(
								modelAction.BpjsTreatmentRoomModelActionTypes.COUNT_BPJS_TREATMENT_ROOMS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentRoomAction>(modelAction.BpjsTreatmentRoomModelActionTypes.FETCH_BPJS_TREATMENT_ROOM),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsTreatmentRoomActionOK(
						modelAction.BpjsTreatmentRoomModelActionTypes.FETCH_BPJS_TREATMENT_ROOM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentRoomActionFail(
								modelAction.BpjsTreatmentRoomModelActionTypes.FETCH_BPJS_TREATMENT_ROOM_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentRoomAction>(modelAction.BpjsTreatmentRoomModelActionTypes.FETCH_ALL_BPJS_TREATMENT_ROOM),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsTreatmentRoomActionOK(
						modelAction.BpjsTreatmentRoomModelActionTypes.FETCH_ALL_BPJS_TREATMENT_ROOM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentRoomActionFail(
								modelAction.BpjsTreatmentRoomModelActionTypes.FETCH_ALL_BPJS_TREATMENT_ROOM_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentRoomAction>(modelAction.BpjsTreatmentRoomModelActionTypes.FETCH_BPJS_TREATMENT_ROOM_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsTreatmentRoomActionOK(
						modelAction.BpjsTreatmentRoomModelActionTypes.FETCH_BPJS_TREATMENT_ROOM_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentRoomActionFail(
								modelAction.BpjsTreatmentRoomModelActionTypes.FETCH_BPJS_TREATMENT_ROOM_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentRoomAction>(modelAction.BpjsTreatmentRoomModelActionTypes.FETCH_LAST_BPJS_TREATMENT_ROOM_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsTreatmentRoomActionOK(
						modelAction.BpjsTreatmentRoomModelActionTypes.FETCH_LAST_BPJS_TREATMENT_ROOM_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentRoomActionFail(
								modelAction.BpjsTreatmentRoomModelActionTypes.FETCH_LAST_BPJS_TREATMENT_ROOM_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentRoomAction>(modelAction.BpjsTreatmentRoomModelActionTypes.CREATE_BPJS_TREATMENT_ROOM),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsTreatmentRoomModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsTreatmentRoomActionOK(
						modelAction.BpjsTreatmentRoomModelActionTypes.CREATE_BPJS_TREATMENT_ROOM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentRoomActionFail(
								modelAction.BpjsTreatmentRoomModelActionTypes.CREATE_BPJS_TREATMENT_ROOM_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentRoomAction>(modelAction.BpjsTreatmentRoomModelActionTypes.CREATE_ALL_BPJS_TREATMENT_ROOM),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsTreatmentRoomModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsTreatmentRoomActionOK(
						modelAction.BpjsTreatmentRoomModelActionTypes.CREATE_ALL_BPJS_TREATMENT_ROOM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentRoomActionFail(
								modelAction.BpjsTreatmentRoomModelActionTypes.CREATE_ALL_BPJS_TREATMENT_ROOM_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentRoomAction>(modelAction.BpjsTreatmentRoomModelActionTypes.UPDATE_BPJS_TREATMENT_ROOM),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsTreatmentRoomModel;
				...
				return this.service.update(new BpjsTreatmentRoomModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsTreatmentRoomActionOK(
						modelAction.BpjsTreatmentRoomModelActionTypes.UPDATE_BPJS_TREATMENT_ROOM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentRoomActionFail(
								modelAction.BpjsTreatmentRoomModelActionTypes.UPDATE_BPJS_TREATMENT_ROOM_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentRoomAction>(modelAction.BpjsTreatmentRoomModelActionTypes.UPDATE_ALL_BPJS_TREATMENT_ROOM),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsTreatmentRoomModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsTreatmentRoomModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsTreatmentRoomActionOK(
						modelAction.BpjsTreatmentRoomModelActionTypes.UPDATE_ALL_BPJS_TREATMENT_ROOM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentRoomActionFail(
								modelAction.BpjsTreatmentRoomModelActionTypes.UPDATE_ALL_BPJS_TREATMENT_ROOM_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentRoomAction>(modelAction.BpjsTreatmentRoomModelActionTypes.DELETE_BPJS_TREATMENT_ROOM),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsTreatmentRoomActionOK(
						modelAction.BpjsTreatmentRoomModelActionTypes.DELETE_BPJS_TREATMENT_ROOM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentRoomActionFail(
								modelAction.BpjsTreatmentRoomModelActionTypes.DELETE_BPJS_TREATMENT_ROOM_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentRoomAction>(modelAction.BpjsTreatmentRoomModelActionTypes.DELETE_BPJS_TREATMENT_ROOM_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsTreatmentRoomActionOK(
						modelAction.BpjsTreatmentRoomModelActionTypes.DELETE_BPJS_TREATMENT_ROOM_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentRoomActionFail(
								modelAction.BpjsTreatmentRoomModelActionTypes.DELETE_BPJS_TREATMENT_ROOM_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentRoomAction>(modelAction.BpjsTreatmentRoomModelActionTypes.DELETE_ALL_BPJS_TREATMENT_ROOM),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsTreatmentRoomActionOK(
						modelAction.BpjsTreatmentRoomModelActionTypes.DELETE_ALL_BPJS_TREATMENT_ROOM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentRoomActionFail(
								modelAction.BpjsTreatmentRoomModelActionTypes.DELETE_ALL_BPJS_TREATMENT_ROOM_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentRoomAction>(modelAction.BpjsTreatmentRoomModelActionTypes.EXPORT_BPJS_TREATMENT_ROOM),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsTreatmentRoomActionOK(
						modelAction.BpjsTreatmentRoomModelActionTypes.EXPORT_BPJS_TREATMENT_ROOM,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentRoomAction>(modelAction.BpjsTreatmentRoomModelActionTypes.EXPORT_ALL_BPJS_TREATMENT_ROOM),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsTreatmentRoomActionOK(
						modelAction.BpjsTreatmentRoomModelActionTypes.EXPORT_ALL_BPJS_TREATMENT_ROOM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentRoomActionFail(
								modelAction.BpjsTreatmentRoomModelActionTypes.EXPORT_ALL_BPJS_TREATMENT_ROOM_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentRoomAction>(modelAction.BpjsTreatmentRoomModelActionTypes.EXPORT_BPJS_TREATMENT_ROOM_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsTreatmentRoomActionOK(
						modelAction.BpjsTreatmentRoomModelActionTypes.EXPORT_BPJS_TREATMENT_ROOM_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentRoomActionFail(
								modelAction.BpjsTreatmentRoomModelActionTypes.EXPORT_BPJS_TREATMENT_ROOM_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentRoomAction>(modelAction.BpjsTreatmentRoomModelActionTypes.IMPORT_BPJS_TREATMENT_ROOMS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsTreatmentRoomActionOK(
						modelAction.BpjsTreatmentRoomModelActionTypes.IMPORT_BPJS_TREATMENT_ROOMS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentRoomActionFail(
								modelAction.BpjsTreatmentRoomModelActionTypes.IMPORT_BPJS_TREATMENT_ROOMS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentRoomAction>(modelAction.BpjsTreatmentRoomModelActionTypes.FETCH_BPJS_TREATMENT_ROOM_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsTreatmentRoomActionOK(
						modelAction.BpjsTreatmentRoomModelActionTypes.FETCH_BPJS_TREATMENT_ROOM_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentRoomActionFail(
								modelAction.BpjsTreatmentRoomModelActionTypes.FETCH_BPJS_TREATMENT_ROOM_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentRoomAction>(modelAction.BpjsTreatmentRoomModelActionTypes.FETCH_BPJS_TREATMENT_ROOM_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsTreatmentRoomActionOK(
						modelAction.BpjsTreatmentRoomModelActionTypes.FETCH_BPJS_TREATMENT_ROOM_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentRoomActionFail(
								modelAction.BpjsTreatmentRoomModelActionTypes.FETCH_BPJS_TREATMENT_ROOM_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
