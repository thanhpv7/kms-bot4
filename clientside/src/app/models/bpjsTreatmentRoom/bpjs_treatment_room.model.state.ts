...
/**
 * BpjsTreatmentRoomCollectionState would store the state of a collection of BpjsTreatmentRoom
 */
export interface BpjsTreatmentRoomCollectionState extends CollectionState {
 ...
 */
export interface BpjsTreatmentRoomModelAudit extends AbstractModelAudit<BpjsTreatmentRoomModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsTreatmentRoomModelState would store the state of the model
 */
export interface BpjsTreatmentRoomModelState {
	collectionState: {
		[key: string]: BpjsTreatmentRoomCollectionState;
	};
	data: {
		[id: string]: BpjsTreatmentRoomModel;
	};
	totalCount: number;
	audits: BpjsTreatmentRoomModelAudit[];
 ...
 */
export const initialBpjsTreatmentRoomCollectionState: BpjsTreatmentRoomCollectionState = {
...
/**
 * The initial state of BpjsTreatmentRoomModelState
 */
export const initialState: BpjsTreatmentRoomModelState = {
	collectionState: {
