...
/**
 * JournalCollectionState would store the state of a collection of Journal
 */
export interface JournalCollectionState extends CollectionState {
 ...
 */
export interface JournalModelAudit extends AbstractModelAudit<JournalModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * JournalModelState would store the state of the model
 */
export interface JournalModelState {
	collectionState: {
		[key: string]: JournalCollectionState;
	};
	data: {
		[id: string]: JournalModel;
	};
	totalCount: number;
	audits: JournalModelAudit[];
 ...
 */
export const initialJournalCollectionState: JournalCollectionState = {
...
/**
 * The initial state of JournalModelState
 */
export const initialState: JournalModelState = {
	collectionState: {
