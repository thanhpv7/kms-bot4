...
/**
 * Effect class used for side effects related to Journal model.
 */
@Injectable()
export class JournalEffect {
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.JournalAction>(modelAction.JournalModelActionTypes.COUNT_JOURNALS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.JournalActionOK(
						modelAction.JournalModelActionTypes.COUNT_JOURNALS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.JournalActionFail(
								modelAction.JournalModelActionTypes.COUNT_JOURNALS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.JournalAction>(modelAction.JournalModelActionTypes.FETCH_JOURNAL),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.JournalActionOK(
						modelAction.JournalModelActionTypes.FETCH_JOURNAL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.JournalActionFail(
								modelAction.JournalModelActionTypes.FETCH_JOURNAL_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.JournalAction>(modelAction.JournalModelActionTypes.FETCH_ALL_JOURNAL),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.JournalActionOK(
						modelAction.JournalModelActionTypes.FETCH_ALL_JOURNAL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.JournalActionFail(
								modelAction.JournalModelActionTypes.FETCH_ALL_JOURNAL_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.JournalAction>(modelAction.JournalModelActionTypes.FETCH_JOURNAL_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.JournalActionOK(
						modelAction.JournalModelActionTypes.FETCH_JOURNAL_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.JournalActionFail(
								modelAction.JournalModelActionTypes.FETCH_JOURNAL_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.JournalAction>(modelAction.JournalModelActionTypes.FETCH_LAST_JOURNAL_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.JournalActionOK(
						modelAction.JournalModelActionTypes.FETCH_LAST_JOURNAL_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.JournalActionFail(
								modelAction.JournalModelActionTypes.FETCH_LAST_JOURNAL_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.JournalAction>(modelAction.JournalModelActionTypes.CREATE_JOURNAL),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as JournalModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.JournalActionOK(
						modelAction.JournalModelActionTypes.CREATE_JOURNAL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.JournalActionFail(
								modelAction.JournalModelActionTypes.CREATE_JOURNAL_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.JournalAction>(modelAction.JournalModelActionTypes.CREATE_ALL_JOURNAL),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as JournalModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.JournalActionOK(
						modelAction.JournalModelActionTypes.CREATE_ALL_JOURNAL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.JournalActionFail(
								modelAction.JournalModelActionTypes.CREATE_ALL_JOURNAL_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.JournalAction>(modelAction.JournalModelActionTypes.UPDATE_JOURNAL),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as JournalModel;
				...
				return this.service.update(new JournalModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.JournalActionOK(
						modelAction.JournalModelActionTypes.UPDATE_JOURNAL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.JournalActionFail(
								modelAction.JournalModelActionTypes.UPDATE_JOURNAL_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.JournalAction>(modelAction.JournalModelActionTypes.UPDATE_ALL_JOURNAL),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as JournalModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new JournalModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.JournalActionOK(
						modelAction.JournalModelActionTypes.UPDATE_ALL_JOURNAL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.JournalActionFail(
								modelAction.JournalModelActionTypes.UPDATE_ALL_JOURNAL_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.JournalAction>(modelAction.JournalModelActionTypes.DELETE_JOURNAL),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.JournalActionOK(
						modelAction.JournalModelActionTypes.DELETE_JOURNAL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.JournalActionFail(
								modelAction.JournalModelActionTypes.DELETE_JOURNAL_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.JournalAction>(modelAction.JournalModelActionTypes.DELETE_JOURNAL_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.JournalActionOK(
						modelAction.JournalModelActionTypes.DELETE_JOURNAL_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.JournalActionFail(
								modelAction.JournalModelActionTypes.DELETE_JOURNAL_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.JournalAction>(modelAction.JournalModelActionTypes.DELETE_ALL_JOURNAL),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.JournalActionOK(
						modelAction.JournalModelActionTypes.DELETE_ALL_JOURNAL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.JournalActionFail(
								modelAction.JournalModelActionTypes.DELETE_ALL_JOURNAL_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.JournalAction>(modelAction.JournalModelActionTypes.EXPORT_JOURNAL),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.JournalActionOK(
						modelAction.JournalModelActionTypes.EXPORT_JOURNAL,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.JournalAction>(modelAction.JournalModelActionTypes.EXPORT_ALL_JOURNAL),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.JournalActionOK(
						modelAction.JournalModelActionTypes.EXPORT_ALL_JOURNAL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.JournalActionFail(
								modelAction.JournalModelActionTypes.EXPORT_ALL_JOURNAL_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.JournalAction>(modelAction.JournalModelActionTypes.EXPORT_JOURNAL_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.JournalActionOK(
						modelAction.JournalModelActionTypes.EXPORT_JOURNAL_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.JournalActionFail(
								modelAction.JournalModelActionTypes.EXPORT_JOURNAL_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.JournalAction>(modelAction.JournalModelActionTypes.IMPORT_JOURNALS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.JournalActionOK(
						modelAction.JournalModelActionTypes.IMPORT_JOURNALS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.JournalActionFail(
								modelAction.JournalModelActionTypes.IMPORT_JOURNALS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.JournalAction>(modelAction.JournalModelActionTypes.FETCH_JOURNAL_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.JournalActionOK(
						modelAction.JournalModelActionTypes.FETCH_JOURNAL_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.JournalActionFail(
								modelAction.JournalModelActionTypes.FETCH_JOURNAL_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.JournalAction>(modelAction.JournalModelActionTypes.FETCH_JOURNAL_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.JournalActionOK(
						modelAction.JournalModelActionTypes.FETCH_JOURNAL_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.JournalActionFail(
								modelAction.JournalModelActionTypes.FETCH_JOURNAL_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
