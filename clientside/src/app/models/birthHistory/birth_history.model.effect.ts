...
import * as modelAction from './birth_history.model.action';
import {BirthHistoryService} from '../../services/birthHistory/birth_history.service';
...
/**
 * Effect class used for side effects related to Birth History model.
 */
@Injectable()
export class BirthHistoryEffect {
	...
	constructor(
		...
		protected readonly service: BirthHistoryService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BirthHistoryAction>(modelAction.BirthHistoryModelActionTypes.COUNT_BIRTH_HISTORYS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BirthHistoryActionOK(
						modelAction.BirthHistoryModelActionTypes.COUNT_BIRTH_HISTORYS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BirthHistoryActionFail(
								modelAction.BirthHistoryModelActionTypes.COUNT_BIRTH_HISTORYS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BirthHistoryAction>(modelAction.BirthHistoryModelActionTypes.FETCH_BIRTH_HISTORY),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BirthHistoryActionOK(
						modelAction.BirthHistoryModelActionTypes.FETCH_BIRTH_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BirthHistoryActionFail(
								modelAction.BirthHistoryModelActionTypes.FETCH_BIRTH_HISTORY_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BirthHistoryAction>(modelAction.BirthHistoryModelActionTypes.FETCH_ALL_BIRTH_HISTORY),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BirthHistoryActionOK(
						modelAction.BirthHistoryModelActionTypes.FETCH_ALL_BIRTH_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BirthHistoryActionFail(
								modelAction.BirthHistoryModelActionTypes.FETCH_ALL_BIRTH_HISTORY_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BirthHistoryAction>(modelAction.BirthHistoryModelActionTypes.FETCH_BIRTH_HISTORY_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BirthHistoryActionOK(
						modelAction.BirthHistoryModelActionTypes.FETCH_BIRTH_HISTORY_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BirthHistoryActionFail(
								modelAction.BirthHistoryModelActionTypes.FETCH_BIRTH_HISTORY_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BirthHistoryAction>(modelAction.BirthHistoryModelActionTypes.FETCH_LAST_BIRTH_HISTORY_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BirthHistoryActionOK(
						modelAction.BirthHistoryModelActionTypes.FETCH_LAST_BIRTH_HISTORY_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BirthHistoryActionFail(
								modelAction.BirthHistoryModelActionTypes.FETCH_LAST_BIRTH_HISTORY_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BirthHistoryAction>(modelAction.BirthHistoryModelActionTypes.CREATE_BIRTH_HISTORY),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BirthHistoryModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BirthHistoryActionOK(
						modelAction.BirthHistoryModelActionTypes.CREATE_BIRTH_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BirthHistoryActionFail(
								modelAction.BirthHistoryModelActionTypes.CREATE_BIRTH_HISTORY_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BirthHistoryAction>(modelAction.BirthHistoryModelActionTypes.CREATE_ALL_BIRTH_HISTORY),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BirthHistoryModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BirthHistoryActionOK(
						modelAction.BirthHistoryModelActionTypes.CREATE_ALL_BIRTH_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BirthHistoryActionFail(
								modelAction.BirthHistoryModelActionTypes.CREATE_ALL_BIRTH_HISTORY_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BirthHistoryAction>(modelAction.BirthHistoryModelActionTypes.UPDATE_BIRTH_HISTORY),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BirthHistoryModel;
				...
				return this.service.update(new BirthHistoryModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BirthHistoryActionOK(
						modelAction.BirthHistoryModelActionTypes.UPDATE_BIRTH_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BirthHistoryActionFail(
								modelAction.BirthHistoryModelActionTypes.UPDATE_BIRTH_HISTORY_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BirthHistoryAction>(modelAction.BirthHistoryModelActionTypes.UPDATE_ALL_BIRTH_HISTORY),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BirthHistoryModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BirthHistoryModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BirthHistoryActionOK(
						modelAction.BirthHistoryModelActionTypes.UPDATE_ALL_BIRTH_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BirthHistoryActionFail(
								modelAction.BirthHistoryModelActionTypes.UPDATE_ALL_BIRTH_HISTORY_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BirthHistoryAction>(modelAction.BirthHistoryModelActionTypes.DELETE_BIRTH_HISTORY),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BirthHistoryActionOK(
						modelAction.BirthHistoryModelActionTypes.DELETE_BIRTH_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BirthHistoryActionFail(
								modelAction.BirthHistoryModelActionTypes.DELETE_BIRTH_HISTORY_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BirthHistoryAction>(modelAction.BirthHistoryModelActionTypes.DELETE_BIRTH_HISTORY_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BirthHistoryActionOK(
						modelAction.BirthHistoryModelActionTypes.DELETE_BIRTH_HISTORY_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BirthHistoryActionFail(
								modelAction.BirthHistoryModelActionTypes.DELETE_BIRTH_HISTORY_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BirthHistoryAction>(modelAction.BirthHistoryModelActionTypes.DELETE_ALL_BIRTH_HISTORY),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BirthHistoryActionOK(
						modelAction.BirthHistoryModelActionTypes.DELETE_ALL_BIRTH_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BirthHistoryActionFail(
								modelAction.BirthHistoryModelActionTypes.DELETE_ALL_BIRTH_HISTORY_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BirthHistoryAction>(modelAction.BirthHistoryModelActionTypes.EXPORT_BIRTH_HISTORY),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BirthHistoryActionOK(
						modelAction.BirthHistoryModelActionTypes.EXPORT_BIRTH_HISTORY,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BirthHistoryAction>(modelAction.BirthHistoryModelActionTypes.EXPORT_ALL_BIRTH_HISTORY),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BirthHistoryActionOK(
						modelAction.BirthHistoryModelActionTypes.EXPORT_ALL_BIRTH_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BirthHistoryActionFail(
								modelAction.BirthHistoryModelActionTypes.EXPORT_ALL_BIRTH_HISTORY_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BirthHistoryAction>(modelAction.BirthHistoryModelActionTypes.EXPORT_BIRTH_HISTORY_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BirthHistoryActionOK(
						modelAction.BirthHistoryModelActionTypes.EXPORT_BIRTH_HISTORY_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BirthHistoryActionFail(
								modelAction.BirthHistoryModelActionTypes.EXPORT_BIRTH_HISTORY_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BirthHistoryAction>(modelAction.BirthHistoryModelActionTypes.IMPORT_BIRTH_HISTORYS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BirthHistoryActionOK(
						modelAction.BirthHistoryModelActionTypes.IMPORT_BIRTH_HISTORYS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BirthHistoryActionFail(
								modelAction.BirthHistoryModelActionTypes.IMPORT_BIRTH_HISTORYS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BirthHistoryAction>(modelAction.BirthHistoryModelActionTypes.FETCH_BIRTH_HISTORY_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BirthHistoryActionOK(
						modelAction.BirthHistoryModelActionTypes.FETCH_BIRTH_HISTORY_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BirthHistoryActionFail(
								modelAction.BirthHistoryModelActionTypes.FETCH_BIRTH_HISTORY_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BirthHistoryAction>(modelAction.BirthHistoryModelActionTypes.FETCH_BIRTH_HISTORY_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BirthHistoryActionOK(
						modelAction.BirthHistoryModelActionTypes.FETCH_BIRTH_HISTORY_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BirthHistoryActionFail(
								modelAction.BirthHistoryModelActionTypes.FETCH_BIRTH_HISTORY_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
