...
/**
 * BirthHistoryCollectionState would store the state of a collection of BirthHistory
 */
export interface BirthHistoryCollectionState extends CollectionState {
 ...
 */
export interface BirthHistoryModelAudit extends AbstractModelAudit<BirthHistoryModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BirthHistoryModelState would store the state of the model
 */
export interface BirthHistoryModelState {
	collectionState: {
		[key: string]: BirthHistoryCollectionState;
	};
	data: {
		[id: string]: BirthHistoryModel;
	};
	totalCount: number;
	audits: BirthHistoryModelAudit[];
 ...
 */
export const initialBirthHistoryCollectionState: BirthHistoryCollectionState = {
...
/**
 * The initial state of BirthHistoryModelState
 */
export const initialState: BirthHistoryModelState = {
	collectionState: {
