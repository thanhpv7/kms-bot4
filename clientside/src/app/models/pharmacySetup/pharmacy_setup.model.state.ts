...
/**
 * PharmacySetupCollectionState would store the state of a collection of PharmacySetup
 */
export interface PharmacySetupCollectionState extends CollectionState {
 ...
 */
export interface PharmacySetupModelAudit extends AbstractModelAudit<PharmacySetupModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * PharmacySetupModelState would store the state of the model
 */
export interface PharmacySetupModelState {
	collectionState: {
		[key: string]: PharmacySetupCollectionState;
	};
	data: {
		[id: string]: PharmacySetupModel;
	};
	totalCount: number;
	audits: PharmacySetupModelAudit[];
 ...
 */
export const initialPharmacySetupCollectionState: PharmacySetupCollectionState = {
...
/**
 * The initial state of PharmacySetupModelState
 */
export const initialState: PharmacySetupModelState = {
	collectionState: {
