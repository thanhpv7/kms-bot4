...
import * as modelAction from './pharmacy_setup.model.action';
import {PharmacySetupService} from '../../services/pharmacySetup/pharmacy_setup.service';
...
/**
 * Effect class used for side effects related to Pharmacy Setup model.
 */
@Injectable()
export class PharmacySetupEffect {
	...
	constructor(
		...
		protected readonly service: PharmacySetupService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PharmacySetupAction>(modelAction.PharmacySetupModelActionTypes.COUNT_PHARMACY_SETUPS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.PharmacySetupActionOK(
						modelAction.PharmacySetupModelActionTypes.COUNT_PHARMACY_SETUPS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PharmacySetupActionFail(
								modelAction.PharmacySetupModelActionTypes.COUNT_PHARMACY_SETUPS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PharmacySetupAction>(modelAction.PharmacySetupModelActionTypes.FETCH_PHARMACY_SETUP),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PharmacySetupActionOK(
						modelAction.PharmacySetupModelActionTypes.FETCH_PHARMACY_SETUP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PharmacySetupActionFail(
								modelAction.PharmacySetupModelActionTypes.FETCH_PHARMACY_SETUP_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PharmacySetupAction>(modelAction.PharmacySetupModelActionTypes.FETCH_ALL_PHARMACY_SETUP),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.PharmacySetupActionOK(
						modelAction.PharmacySetupModelActionTypes.FETCH_ALL_PHARMACY_SETUP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PharmacySetupActionFail(
								modelAction.PharmacySetupModelActionTypes.FETCH_ALL_PHARMACY_SETUP_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PharmacySetupAction>(modelAction.PharmacySetupModelActionTypes.FETCH_PHARMACY_SETUP_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PharmacySetupActionOK(
						modelAction.PharmacySetupModelActionTypes.FETCH_PHARMACY_SETUP_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PharmacySetupActionFail(
								modelAction.PharmacySetupModelActionTypes.FETCH_PHARMACY_SETUP_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PharmacySetupAction>(modelAction.PharmacySetupModelActionTypes.FETCH_LAST_PHARMACY_SETUP_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PharmacySetupActionOK(
						modelAction.PharmacySetupModelActionTypes.FETCH_LAST_PHARMACY_SETUP_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PharmacySetupActionFail(
								modelAction.PharmacySetupModelActionTypes.FETCH_LAST_PHARMACY_SETUP_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PharmacySetupAction>(modelAction.PharmacySetupModelActionTypes.CREATE_PHARMACY_SETUP),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as PharmacySetupModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PharmacySetupActionOK(
						modelAction.PharmacySetupModelActionTypes.CREATE_PHARMACY_SETUP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PharmacySetupActionFail(
								modelAction.PharmacySetupModelActionTypes.CREATE_PHARMACY_SETUP_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PharmacySetupAction>(modelAction.PharmacySetupModelActionTypes.CREATE_ALL_PHARMACY_SETUP),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as PharmacySetupModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PharmacySetupActionOK(
						modelAction.PharmacySetupModelActionTypes.CREATE_ALL_PHARMACY_SETUP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PharmacySetupActionFail(
								modelAction.PharmacySetupModelActionTypes.CREATE_ALL_PHARMACY_SETUP_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PharmacySetupAction>(modelAction.PharmacySetupModelActionTypes.UPDATE_PHARMACY_SETUP),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as PharmacySetupModel;
				...
				return this.service.update(new PharmacySetupModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.PharmacySetupActionOK(
						modelAction.PharmacySetupModelActionTypes.UPDATE_PHARMACY_SETUP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PharmacySetupActionFail(
								modelAction.PharmacySetupModelActionTypes.UPDATE_PHARMACY_SETUP_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PharmacySetupAction>(modelAction.PharmacySetupModelActionTypes.UPDATE_ALL_PHARMACY_SETUP),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as PharmacySetupModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new PharmacySetupModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PharmacySetupActionOK(
						modelAction.PharmacySetupModelActionTypes.UPDATE_ALL_PHARMACY_SETUP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PharmacySetupActionFail(
								modelAction.PharmacySetupModelActionTypes.UPDATE_ALL_PHARMACY_SETUP_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PharmacySetupAction>(modelAction.PharmacySetupModelActionTypes.DELETE_PHARMACY_SETUP),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PharmacySetupActionOK(
						modelAction.PharmacySetupModelActionTypes.DELETE_PHARMACY_SETUP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PharmacySetupActionFail(
								modelAction.PharmacySetupModelActionTypes.DELETE_PHARMACY_SETUP_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PharmacySetupAction>(modelAction.PharmacySetupModelActionTypes.DELETE_PHARMACY_SETUP_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.PharmacySetupActionOK(
						modelAction.PharmacySetupModelActionTypes.DELETE_PHARMACY_SETUP_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PharmacySetupActionFail(
								modelAction.PharmacySetupModelActionTypes.DELETE_PHARMACY_SETUP_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PharmacySetupAction>(modelAction.PharmacySetupModelActionTypes.DELETE_ALL_PHARMACY_SETUP),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PharmacySetupActionOK(
						modelAction.PharmacySetupModelActionTypes.DELETE_ALL_PHARMACY_SETUP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PharmacySetupActionFail(
								modelAction.PharmacySetupModelActionTypes.DELETE_ALL_PHARMACY_SETUP_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PharmacySetupAction>(modelAction.PharmacySetupModelActionTypes.EXPORT_PHARMACY_SETUP),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PharmacySetupActionOK(
						modelAction.PharmacySetupModelActionTypes.EXPORT_PHARMACY_SETUP,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PharmacySetupAction>(modelAction.PharmacySetupModelActionTypes.EXPORT_ALL_PHARMACY_SETUP),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PharmacySetupActionOK(
						modelAction.PharmacySetupModelActionTypes.EXPORT_ALL_PHARMACY_SETUP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PharmacySetupActionFail(
								modelAction.PharmacySetupModelActionTypes.EXPORT_ALL_PHARMACY_SETUP_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PharmacySetupAction>(modelAction.PharmacySetupModelActionTypes.EXPORT_PHARMACY_SETUP_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PharmacySetupActionOK(
						modelAction.PharmacySetupModelActionTypes.EXPORT_PHARMACY_SETUP_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PharmacySetupActionFail(
								modelAction.PharmacySetupModelActionTypes.EXPORT_PHARMACY_SETUP_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PharmacySetupAction>(modelAction.PharmacySetupModelActionTypes.IMPORT_PHARMACY_SETUPS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.PharmacySetupActionOK(
						modelAction.PharmacySetupModelActionTypes.IMPORT_PHARMACY_SETUPS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PharmacySetupActionFail(
								modelAction.PharmacySetupModelActionTypes.IMPORT_PHARMACY_SETUPS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PharmacySetupAction>(modelAction.PharmacySetupModelActionTypes.FETCH_PHARMACY_SETUP_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.PharmacySetupActionOK(
						modelAction.PharmacySetupModelActionTypes.FETCH_PHARMACY_SETUP_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PharmacySetupActionFail(
								modelAction.PharmacySetupModelActionTypes.FETCH_PHARMACY_SETUP_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PharmacySetupAction>(modelAction.PharmacySetupModelActionTypes.FETCH_PHARMACY_SETUP_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.PharmacySetupActionOK(
						modelAction.PharmacySetupModelActionTypes.FETCH_PHARMACY_SETUP_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PharmacySetupActionFail(
								modelAction.PharmacySetupModelActionTypes.FETCH_PHARMACY_SETUP_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
