...
/**
 * PatientPaymentSelfPayingCollectionState would store the state of a collection of PatientPaymentSelfPaying
 */
export interface PatientPaymentSelfPayingCollectionState extends CollectionState {
 ...
 */
export interface PatientPaymentSelfPayingModelAudit extends AbstractModelAudit<PatientPaymentSelfPayingModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * PatientPaymentSelfPayingModelState would store the state of the model
 */
export interface PatientPaymentSelfPayingModelState {
	collectionState: {
		[key: string]: PatientPaymentSelfPayingCollectionState;
	};
	data: {
		[id: string]: PatientPaymentSelfPayingModel;
	};
	totalCount: number;
	audits: PatientPaymentSelfPayingModelAudit[];
 ...
 */
export const initialPatientPaymentSelfPayingCollectionState: PatientPaymentSelfPayingCollectionState = {
...
/**
 * The initial state of PatientPaymentSelfPayingModelState
 */
export const initialState: PatientPaymentSelfPayingModelState = {
	collectionState: {
