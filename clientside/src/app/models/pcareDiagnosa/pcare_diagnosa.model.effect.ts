...
import * as modelAction from './pcare_diagnosa.model.action';
import {PcareDiagnosaService} from '../../services/pcareDiagnosa/pcare_diagnosa.service';
...
/**
 * Effect class used for side effects related to PCare Diagnosa model.
 */
@Injectable()
export class PcareDiagnosaEffect {
	...
	constructor(
		...
		protected readonly service: PcareDiagnosaService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareDiagnosaAction>(modelAction.PcareDiagnosaModelActionTypes.COUNT_PCARE_DIAGNOSAS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.PcareDiagnosaActionOK(
						modelAction.PcareDiagnosaModelActionTypes.COUNT_PCARE_DIAGNOSAS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareDiagnosaActionFail(
								modelAction.PcareDiagnosaModelActionTypes.COUNT_PCARE_DIAGNOSAS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareDiagnosaAction>(modelAction.PcareDiagnosaModelActionTypes.FETCH_PCARE_DIAGNOSA),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareDiagnosaActionOK(
						modelAction.PcareDiagnosaModelActionTypes.FETCH_PCARE_DIAGNOSA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareDiagnosaActionFail(
								modelAction.PcareDiagnosaModelActionTypes.FETCH_PCARE_DIAGNOSA_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareDiagnosaAction>(modelAction.PcareDiagnosaModelActionTypes.FETCH_ALL_PCARE_DIAGNOSA),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.PcareDiagnosaActionOK(
						modelAction.PcareDiagnosaModelActionTypes.FETCH_ALL_PCARE_DIAGNOSA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareDiagnosaActionFail(
								modelAction.PcareDiagnosaModelActionTypes.FETCH_ALL_PCARE_DIAGNOSA_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareDiagnosaAction>(modelAction.PcareDiagnosaModelActionTypes.FETCH_PCARE_DIAGNOSA_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareDiagnosaActionOK(
						modelAction.PcareDiagnosaModelActionTypes.FETCH_PCARE_DIAGNOSA_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareDiagnosaActionFail(
								modelAction.PcareDiagnosaModelActionTypes.FETCH_PCARE_DIAGNOSA_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareDiagnosaAction>(modelAction.PcareDiagnosaModelActionTypes.FETCH_LAST_PCARE_DIAGNOSA_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareDiagnosaActionOK(
						modelAction.PcareDiagnosaModelActionTypes.FETCH_LAST_PCARE_DIAGNOSA_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareDiagnosaActionFail(
								modelAction.PcareDiagnosaModelActionTypes.FETCH_LAST_PCARE_DIAGNOSA_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareDiagnosaAction>(modelAction.PcareDiagnosaModelActionTypes.CREATE_PCARE_DIAGNOSA),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as PcareDiagnosaModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareDiagnosaActionOK(
						modelAction.PcareDiagnosaModelActionTypes.CREATE_PCARE_DIAGNOSA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareDiagnosaActionFail(
								modelAction.PcareDiagnosaModelActionTypes.CREATE_PCARE_DIAGNOSA_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareDiagnosaAction>(modelAction.PcareDiagnosaModelActionTypes.CREATE_ALL_PCARE_DIAGNOSA),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as PcareDiagnosaModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareDiagnosaActionOK(
						modelAction.PcareDiagnosaModelActionTypes.CREATE_ALL_PCARE_DIAGNOSA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareDiagnosaActionFail(
								modelAction.PcareDiagnosaModelActionTypes.CREATE_ALL_PCARE_DIAGNOSA_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareDiagnosaAction>(modelAction.PcareDiagnosaModelActionTypes.UPDATE_PCARE_DIAGNOSA),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as PcareDiagnosaModel;
				...
				return this.service.update(new PcareDiagnosaModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareDiagnosaActionOK(
						modelAction.PcareDiagnosaModelActionTypes.UPDATE_PCARE_DIAGNOSA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareDiagnosaActionFail(
								modelAction.PcareDiagnosaModelActionTypes.UPDATE_PCARE_DIAGNOSA_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareDiagnosaAction>(modelAction.PcareDiagnosaModelActionTypes.UPDATE_ALL_PCARE_DIAGNOSA),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as PcareDiagnosaModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new PcareDiagnosaModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareDiagnosaActionOK(
						modelAction.PcareDiagnosaModelActionTypes.UPDATE_ALL_PCARE_DIAGNOSA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareDiagnosaActionFail(
								modelAction.PcareDiagnosaModelActionTypes.UPDATE_ALL_PCARE_DIAGNOSA_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareDiagnosaAction>(modelAction.PcareDiagnosaModelActionTypes.DELETE_PCARE_DIAGNOSA),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PcareDiagnosaActionOK(
						modelAction.PcareDiagnosaModelActionTypes.DELETE_PCARE_DIAGNOSA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareDiagnosaActionFail(
								modelAction.PcareDiagnosaModelActionTypes.DELETE_PCARE_DIAGNOSA_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareDiagnosaAction>(modelAction.PcareDiagnosaModelActionTypes.DELETE_PCARE_DIAGNOSA_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.PcareDiagnosaActionOK(
						modelAction.PcareDiagnosaModelActionTypes.DELETE_PCARE_DIAGNOSA_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareDiagnosaActionFail(
								modelAction.PcareDiagnosaModelActionTypes.DELETE_PCARE_DIAGNOSA_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareDiagnosaAction>(modelAction.PcareDiagnosaModelActionTypes.DELETE_ALL_PCARE_DIAGNOSA),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PcareDiagnosaActionOK(
						modelAction.PcareDiagnosaModelActionTypes.DELETE_ALL_PCARE_DIAGNOSA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareDiagnosaActionFail(
								modelAction.PcareDiagnosaModelActionTypes.DELETE_ALL_PCARE_DIAGNOSA_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareDiagnosaAction>(modelAction.PcareDiagnosaModelActionTypes.EXPORT_PCARE_DIAGNOSA),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PcareDiagnosaActionOK(
						modelAction.PcareDiagnosaModelActionTypes.EXPORT_PCARE_DIAGNOSA,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareDiagnosaAction>(modelAction.PcareDiagnosaModelActionTypes.EXPORT_ALL_PCARE_DIAGNOSA),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PcareDiagnosaActionOK(
						modelAction.PcareDiagnosaModelActionTypes.EXPORT_ALL_PCARE_DIAGNOSA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareDiagnosaActionFail(
								modelAction.PcareDiagnosaModelActionTypes.EXPORT_ALL_PCARE_DIAGNOSA_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareDiagnosaAction>(modelAction.PcareDiagnosaModelActionTypes.EXPORT_PCARE_DIAGNOSA_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PcareDiagnosaActionOK(
						modelAction.PcareDiagnosaModelActionTypes.EXPORT_PCARE_DIAGNOSA_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareDiagnosaActionFail(
								modelAction.PcareDiagnosaModelActionTypes.EXPORT_PCARE_DIAGNOSA_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareDiagnosaAction>(modelAction.PcareDiagnosaModelActionTypes.IMPORT_PCARE_DIAGNOSAS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.PcareDiagnosaActionOK(
						modelAction.PcareDiagnosaModelActionTypes.IMPORT_PCARE_DIAGNOSAS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareDiagnosaActionFail(
								modelAction.PcareDiagnosaModelActionTypes.IMPORT_PCARE_DIAGNOSAS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareDiagnosaAction>(modelAction.PcareDiagnosaModelActionTypes.FETCH_PCARE_DIAGNOSA_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.PcareDiagnosaActionOK(
						modelAction.PcareDiagnosaModelActionTypes.FETCH_PCARE_DIAGNOSA_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PcareDiagnosaActionFail(
								modelAction.PcareDiagnosaModelActionTypes.FETCH_PCARE_DIAGNOSA_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareDiagnosaAction>(modelAction.PcareDiagnosaModelActionTypes.FETCH_PCARE_DIAGNOSA_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.PcareDiagnosaActionOK(
						modelAction.PcareDiagnosaModelActionTypes.FETCH_PCARE_DIAGNOSA_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PcareDiagnosaActionFail(
								modelAction.PcareDiagnosaModelActionTypes.FETCH_PCARE_DIAGNOSA_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
