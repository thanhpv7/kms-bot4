...
/**
 * PatientPaymentOthersCollectionState would store the state of a collection of PatientPaymentOthers
 */
export interface PatientPaymentOthersCollectionState extends CollectionState {
 ...
 */
export interface PatientPaymentOthersModelAudit extends AbstractModelAudit<PatientPaymentOthersModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * PatientPaymentOthersModelState would store the state of the model
 */
export interface PatientPaymentOthersModelState {
	collectionState: {
		[key: string]: PatientPaymentOthersCollectionState;
	};
	data: {
		[id: string]: PatientPaymentOthersModel;
	};
	totalCount: number;
	audits: PatientPaymentOthersModelAudit[];
 ...
 */
export const initialPatientPaymentOthersCollectionState: PatientPaymentOthersCollectionState = {
...
/**
 * The initial state of PatientPaymentOthersModelState
 */
export const initialState: PatientPaymentOthersModelState = {
	collectionState: {
