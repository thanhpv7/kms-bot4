...
import * as modelAction from './patient_payment_others.model.action';
import {PatientPaymentOthersService} from '../../services/patientPaymentOthers/patient_payment_others.service';
...
/**
 * Effect class used for side effects related to Patient Payment Others model.
 */
@Injectable()
export class PatientPaymentOthersEffect {
	...
	constructor(
		...
		protected readonly service: PatientPaymentOthersService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPaymentOthersAction>(modelAction.PatientPaymentOthersModelActionTypes.COUNT_PATIENT_PAYMENT_OTHERSS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.PatientPaymentOthersActionOK(
						modelAction.PatientPaymentOthersModelActionTypes.COUNT_PATIENT_PAYMENT_OTHERSS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientPaymentOthersActionFail(
								modelAction.PatientPaymentOthersModelActionTypes.COUNT_PATIENT_PAYMENT_OTHERSS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPaymentOthersAction>(modelAction.PatientPaymentOthersModelActionTypes.FETCH_PATIENT_PAYMENT_OTHERS),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientPaymentOthersActionOK(
						modelAction.PatientPaymentOthersModelActionTypes.FETCH_PATIENT_PAYMENT_OTHERS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientPaymentOthersActionFail(
								modelAction.PatientPaymentOthersModelActionTypes.FETCH_PATIENT_PAYMENT_OTHERS_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPaymentOthersAction>(modelAction.PatientPaymentOthersModelActionTypes.FETCH_ALL_PATIENT_PAYMENT_OTHERS),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.PatientPaymentOthersActionOK(
						modelAction.PatientPaymentOthersModelActionTypes.FETCH_ALL_PATIENT_PAYMENT_OTHERS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientPaymentOthersActionFail(
								modelAction.PatientPaymentOthersModelActionTypes.FETCH_ALL_PATIENT_PAYMENT_OTHERS_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPaymentOthersAction>(modelAction.PatientPaymentOthersModelActionTypes.FETCH_PATIENT_PAYMENT_OTHERS_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientPaymentOthersActionOK(
						modelAction.PatientPaymentOthersModelActionTypes.FETCH_PATIENT_PAYMENT_OTHERS_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientPaymentOthersActionFail(
								modelAction.PatientPaymentOthersModelActionTypes.FETCH_PATIENT_PAYMENT_OTHERS_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPaymentOthersAction>(modelAction.PatientPaymentOthersModelActionTypes.FETCH_LAST_PATIENT_PAYMENT_OTHERS_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientPaymentOthersActionOK(
						modelAction.PatientPaymentOthersModelActionTypes.FETCH_LAST_PATIENT_PAYMENT_OTHERS_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientPaymentOthersActionFail(
								modelAction.PatientPaymentOthersModelActionTypes.FETCH_LAST_PATIENT_PAYMENT_OTHERS_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPaymentOthersAction>(modelAction.PatientPaymentOthersModelActionTypes.CREATE_PATIENT_PAYMENT_OTHERS),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as PatientPaymentOthersModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientPaymentOthersActionOK(
						modelAction.PatientPaymentOthersModelActionTypes.CREATE_PATIENT_PAYMENT_OTHERS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientPaymentOthersActionFail(
								modelAction.PatientPaymentOthersModelActionTypes.CREATE_PATIENT_PAYMENT_OTHERS_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPaymentOthersAction>(modelAction.PatientPaymentOthersModelActionTypes.CREATE_ALL_PATIENT_PAYMENT_OTHERS),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as PatientPaymentOthersModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientPaymentOthersActionOK(
						modelAction.PatientPaymentOthersModelActionTypes.CREATE_ALL_PATIENT_PAYMENT_OTHERS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientPaymentOthersActionFail(
								modelAction.PatientPaymentOthersModelActionTypes.CREATE_ALL_PATIENT_PAYMENT_OTHERS_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPaymentOthersAction>(modelAction.PatientPaymentOthersModelActionTypes.UPDATE_PATIENT_PAYMENT_OTHERS),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as PatientPaymentOthersModel;
				...
				return this.service.update(new PatientPaymentOthersModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientPaymentOthersActionOK(
						modelAction.PatientPaymentOthersModelActionTypes.UPDATE_PATIENT_PAYMENT_OTHERS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientPaymentOthersActionFail(
								modelAction.PatientPaymentOthersModelActionTypes.UPDATE_PATIENT_PAYMENT_OTHERS_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPaymentOthersAction>(modelAction.PatientPaymentOthersModelActionTypes.UPDATE_ALL_PATIENT_PAYMENT_OTHERS),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as PatientPaymentOthersModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new PatientPaymentOthersModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientPaymentOthersActionOK(
						modelAction.PatientPaymentOthersModelActionTypes.UPDATE_ALL_PATIENT_PAYMENT_OTHERS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientPaymentOthersActionFail(
								modelAction.PatientPaymentOthersModelActionTypes.UPDATE_ALL_PATIENT_PAYMENT_OTHERS_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPaymentOthersAction>(modelAction.PatientPaymentOthersModelActionTypes.DELETE_PATIENT_PAYMENT_OTHERS),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PatientPaymentOthersActionOK(
						modelAction.PatientPaymentOthersModelActionTypes.DELETE_PATIENT_PAYMENT_OTHERS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientPaymentOthersActionFail(
								modelAction.PatientPaymentOthersModelActionTypes.DELETE_PATIENT_PAYMENT_OTHERS_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPaymentOthersAction>(modelAction.PatientPaymentOthersModelActionTypes.DELETE_PATIENT_PAYMENT_OTHERS_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.PatientPaymentOthersActionOK(
						modelAction.PatientPaymentOthersModelActionTypes.DELETE_PATIENT_PAYMENT_OTHERS_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientPaymentOthersActionFail(
								modelAction.PatientPaymentOthersModelActionTypes.DELETE_PATIENT_PAYMENT_OTHERS_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPaymentOthersAction>(modelAction.PatientPaymentOthersModelActionTypes.DELETE_ALL_PATIENT_PAYMENT_OTHERS),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PatientPaymentOthersActionOK(
						modelAction.PatientPaymentOthersModelActionTypes.DELETE_ALL_PATIENT_PAYMENT_OTHERS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientPaymentOthersActionFail(
								modelAction.PatientPaymentOthersModelActionTypes.DELETE_ALL_PATIENT_PAYMENT_OTHERS_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPaymentOthersAction>(modelAction.PatientPaymentOthersModelActionTypes.EXPORT_PATIENT_PAYMENT_OTHERS),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PatientPaymentOthersActionOK(
						modelAction.PatientPaymentOthersModelActionTypes.EXPORT_PATIENT_PAYMENT_OTHERS,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPaymentOthersAction>(modelAction.PatientPaymentOthersModelActionTypes.EXPORT_ALL_PATIENT_PAYMENT_OTHERS),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PatientPaymentOthersActionOK(
						modelAction.PatientPaymentOthersModelActionTypes.EXPORT_ALL_PATIENT_PAYMENT_OTHERS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientPaymentOthersActionFail(
								modelAction.PatientPaymentOthersModelActionTypes.EXPORT_ALL_PATIENT_PAYMENT_OTHERS_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPaymentOthersAction>(modelAction.PatientPaymentOthersModelActionTypes.EXPORT_PATIENT_PAYMENT_OTHERS_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PatientPaymentOthersActionOK(
						modelAction.PatientPaymentOthersModelActionTypes.EXPORT_PATIENT_PAYMENT_OTHERS_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientPaymentOthersActionFail(
								modelAction.PatientPaymentOthersModelActionTypes.EXPORT_PATIENT_PAYMENT_OTHERS_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPaymentOthersAction>(modelAction.PatientPaymentOthersModelActionTypes.IMPORT_PATIENT_PAYMENT_OTHERSS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.PatientPaymentOthersActionOK(
						modelAction.PatientPaymentOthersModelActionTypes.IMPORT_PATIENT_PAYMENT_OTHERSS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientPaymentOthersActionFail(
								modelAction.PatientPaymentOthersModelActionTypes.IMPORT_PATIENT_PAYMENT_OTHERSS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPaymentOthersAction>(modelAction.PatientPaymentOthersModelActionTypes.FETCH_PATIENT_PAYMENT_OTHERS_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.PatientPaymentOthersActionOK(
						modelAction.PatientPaymentOthersModelActionTypes.FETCH_PATIENT_PAYMENT_OTHERS_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PatientPaymentOthersActionFail(
								modelAction.PatientPaymentOthersModelActionTypes.FETCH_PATIENT_PAYMENT_OTHERS_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPaymentOthersAction>(modelAction.PatientPaymentOthersModelActionTypes.FETCH_PATIENT_PAYMENT_OTHERS_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.PatientPaymentOthersActionOK(
						modelAction.PatientPaymentOthersModelActionTypes.FETCH_PATIENT_PAYMENT_OTHERS_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PatientPaymentOthersActionFail(
								modelAction.PatientPaymentOthersModelActionTypes.FETCH_PATIENT_PAYMENT_OTHERS_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
