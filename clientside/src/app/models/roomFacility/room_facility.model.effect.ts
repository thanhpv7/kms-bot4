...
import * as modelAction from './room_facility.model.action';
import {RoomFacilityService} from '../../services/roomFacility/room_facility.service';
...
/**
 * Effect class used for side effects related to Room Facility model.
 */
@Injectable()
export class RoomFacilityEffect {
	...
	constructor(
		...
		protected readonly service: RoomFacilityService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoomFacilityAction>(modelAction.RoomFacilityModelActionTypes.COUNT_ROOM_FACILITYS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.RoomFacilityActionOK(
						modelAction.RoomFacilityModelActionTypes.COUNT_ROOM_FACILITYS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RoomFacilityActionFail(
								modelAction.RoomFacilityModelActionTypes.COUNT_ROOM_FACILITYS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoomFacilityAction>(modelAction.RoomFacilityModelActionTypes.FETCH_ROOM_FACILITY),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.RoomFacilityActionOK(
						modelAction.RoomFacilityModelActionTypes.FETCH_ROOM_FACILITY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RoomFacilityActionFail(
								modelAction.RoomFacilityModelActionTypes.FETCH_ROOM_FACILITY_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoomFacilityAction>(modelAction.RoomFacilityModelActionTypes.FETCH_ALL_ROOM_FACILITY),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.RoomFacilityActionOK(
						modelAction.RoomFacilityModelActionTypes.FETCH_ALL_ROOM_FACILITY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RoomFacilityActionFail(
								modelAction.RoomFacilityModelActionTypes.FETCH_ALL_ROOM_FACILITY_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoomFacilityAction>(modelAction.RoomFacilityModelActionTypes.FETCH_ROOM_FACILITY_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.RoomFacilityActionOK(
						modelAction.RoomFacilityModelActionTypes.FETCH_ROOM_FACILITY_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RoomFacilityActionFail(
								modelAction.RoomFacilityModelActionTypes.FETCH_ROOM_FACILITY_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoomFacilityAction>(modelAction.RoomFacilityModelActionTypes.FETCH_LAST_ROOM_FACILITY_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.RoomFacilityActionOK(
						modelAction.RoomFacilityModelActionTypes.FETCH_LAST_ROOM_FACILITY_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RoomFacilityActionFail(
								modelAction.RoomFacilityModelActionTypes.FETCH_LAST_ROOM_FACILITY_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoomFacilityAction>(modelAction.RoomFacilityModelActionTypes.CREATE_ROOM_FACILITY),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as RoomFacilityModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.RoomFacilityActionOK(
						modelAction.RoomFacilityModelActionTypes.CREATE_ROOM_FACILITY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RoomFacilityActionFail(
								modelAction.RoomFacilityModelActionTypes.CREATE_ROOM_FACILITY_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoomFacilityAction>(modelAction.RoomFacilityModelActionTypes.CREATE_ALL_ROOM_FACILITY),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as RoomFacilityModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.RoomFacilityActionOK(
						modelAction.RoomFacilityModelActionTypes.CREATE_ALL_ROOM_FACILITY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RoomFacilityActionFail(
								modelAction.RoomFacilityModelActionTypes.CREATE_ALL_ROOM_FACILITY_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoomFacilityAction>(modelAction.RoomFacilityModelActionTypes.UPDATE_ROOM_FACILITY),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as RoomFacilityModel;
				...
				return this.service.update(new RoomFacilityModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.RoomFacilityActionOK(
						modelAction.RoomFacilityModelActionTypes.UPDATE_ROOM_FACILITY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RoomFacilityActionFail(
								modelAction.RoomFacilityModelActionTypes.UPDATE_ROOM_FACILITY_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoomFacilityAction>(modelAction.RoomFacilityModelActionTypes.UPDATE_ALL_ROOM_FACILITY),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as RoomFacilityModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new RoomFacilityModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.RoomFacilityActionOK(
						modelAction.RoomFacilityModelActionTypes.UPDATE_ALL_ROOM_FACILITY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RoomFacilityActionFail(
								modelAction.RoomFacilityModelActionTypes.UPDATE_ALL_ROOM_FACILITY_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoomFacilityAction>(modelAction.RoomFacilityModelActionTypes.DELETE_ROOM_FACILITY),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.RoomFacilityActionOK(
						modelAction.RoomFacilityModelActionTypes.DELETE_ROOM_FACILITY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RoomFacilityActionFail(
								modelAction.RoomFacilityModelActionTypes.DELETE_ROOM_FACILITY_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoomFacilityAction>(modelAction.RoomFacilityModelActionTypes.DELETE_ROOM_FACILITY_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.RoomFacilityActionOK(
						modelAction.RoomFacilityModelActionTypes.DELETE_ROOM_FACILITY_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RoomFacilityActionFail(
								modelAction.RoomFacilityModelActionTypes.DELETE_ROOM_FACILITY_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoomFacilityAction>(modelAction.RoomFacilityModelActionTypes.DELETE_ALL_ROOM_FACILITY),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.RoomFacilityActionOK(
						modelAction.RoomFacilityModelActionTypes.DELETE_ALL_ROOM_FACILITY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RoomFacilityActionFail(
								modelAction.RoomFacilityModelActionTypes.DELETE_ALL_ROOM_FACILITY_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoomFacilityAction>(modelAction.RoomFacilityModelActionTypes.EXPORT_ROOM_FACILITY),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.RoomFacilityActionOK(
						modelAction.RoomFacilityModelActionTypes.EXPORT_ROOM_FACILITY,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoomFacilityAction>(modelAction.RoomFacilityModelActionTypes.EXPORT_ALL_ROOM_FACILITY),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.RoomFacilityActionOK(
						modelAction.RoomFacilityModelActionTypes.EXPORT_ALL_ROOM_FACILITY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RoomFacilityActionFail(
								modelAction.RoomFacilityModelActionTypes.EXPORT_ALL_ROOM_FACILITY_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoomFacilityAction>(modelAction.RoomFacilityModelActionTypes.EXPORT_ROOM_FACILITY_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.RoomFacilityActionOK(
						modelAction.RoomFacilityModelActionTypes.EXPORT_ROOM_FACILITY_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RoomFacilityActionFail(
								modelAction.RoomFacilityModelActionTypes.EXPORT_ROOM_FACILITY_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoomFacilityAction>(modelAction.RoomFacilityModelActionTypes.IMPORT_ROOM_FACILITYS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.RoomFacilityActionOK(
						modelAction.RoomFacilityModelActionTypes.IMPORT_ROOM_FACILITYS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RoomFacilityActionFail(
								modelAction.RoomFacilityModelActionTypes.IMPORT_ROOM_FACILITYS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoomFacilityAction>(modelAction.RoomFacilityModelActionTypes.FETCH_ROOM_FACILITY_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.RoomFacilityActionOK(
						modelAction.RoomFacilityModelActionTypes.FETCH_ROOM_FACILITY_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.RoomFacilityActionFail(
								modelAction.RoomFacilityModelActionTypes.FETCH_ROOM_FACILITY_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoomFacilityAction>(modelAction.RoomFacilityModelActionTypes.FETCH_ROOM_FACILITY_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.RoomFacilityActionOK(
						modelAction.RoomFacilityModelActionTypes.FETCH_ROOM_FACILITY_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.RoomFacilityActionFail(
								modelAction.RoomFacilityModelActionTypes.FETCH_ROOM_FACILITY_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
