...
/**
 * RoomFacilityCollectionState would store the state of a collection of RoomFacility
 */
export interface RoomFacilityCollectionState extends CollectionState {
 ...
 */
export interface RoomFacilityModelAudit extends AbstractModelAudit<RoomFacilityModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * RoomFacilityModelState would store the state of the model
 */
export interface RoomFacilityModelState {
	collectionState: {
		[key: string]: RoomFacilityCollectionState;
	};
	data: {
		[id: string]: RoomFacilityModel;
	};
	totalCount: number;
	audits: RoomFacilityModelAudit[];
 ...
 */
export const initialRoomFacilityCollectionState: RoomFacilityCollectionState = {
...
/**
 * The initial state of RoomFacilityModelState
 */
export const initialState: RoomFacilityModelState = {
	collectionState: {
