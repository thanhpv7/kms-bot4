...
/**
 * PatientGeneralInfoCollectionState would store the state of a collection of PatientGeneralInfo
 */
export interface PatientGeneralInfoCollectionState extends CollectionState {
 ...
 */
export interface PatientGeneralInfoModelAudit extends AbstractModelAudit<PatientGeneralInfoModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * PatientGeneralInfoModelState would store the state of the model
 */
export interface PatientGeneralInfoModelState {
	collectionState: {
		[key: string]: PatientGeneralInfoCollectionState;
	};
	data: {
		[id: string]: PatientGeneralInfoModel;
	};
	totalCount: number;
	audits: PatientGeneralInfoModelAudit[];
 ...
 */
export const initialPatientGeneralInfoCollectionState: PatientGeneralInfoCollectionState = {
...
/**
 * The initial state of PatientGeneralInfoModelState
 */
export const initialState: PatientGeneralInfoModelState = {
	collectionState: {
