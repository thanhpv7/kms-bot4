...
import * as modelAction from './patient_general_info.model.action';
import {PatientGeneralInfoService} from '../../services/patientGeneralInfo/patient_general_info.service';
...
/**
 * Effect class used for side effects related to Patient General Info model.
 */
@Injectable()
export class PatientGeneralInfoEffect {
	...
	constructor(
		...
		protected readonly service: PatientGeneralInfoService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientGeneralInfoAction>(modelAction.PatientGeneralInfoModelActionTypes.COUNT_PATIENT_GENERAL_INFOS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.PatientGeneralInfoActionOK(
						modelAction.PatientGeneralInfoModelActionTypes.COUNT_PATIENT_GENERAL_INFOS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientGeneralInfoActionFail(
								modelAction.PatientGeneralInfoModelActionTypes.COUNT_PATIENT_GENERAL_INFOS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientGeneralInfoAction>(modelAction.PatientGeneralInfoModelActionTypes.FETCH_PATIENT_GENERAL_INFO),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientGeneralInfoActionOK(
						modelAction.PatientGeneralInfoModelActionTypes.FETCH_PATIENT_GENERAL_INFO_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientGeneralInfoActionFail(
								modelAction.PatientGeneralInfoModelActionTypes.FETCH_PATIENT_GENERAL_INFO_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientGeneralInfoAction>(modelAction.PatientGeneralInfoModelActionTypes.FETCH_ALL_PATIENT_GENERAL_INFO),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.PatientGeneralInfoActionOK(
						modelAction.PatientGeneralInfoModelActionTypes.FETCH_ALL_PATIENT_GENERAL_INFO_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientGeneralInfoActionFail(
								modelAction.PatientGeneralInfoModelActionTypes.FETCH_ALL_PATIENT_GENERAL_INFO_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientGeneralInfoAction>(modelAction.PatientGeneralInfoModelActionTypes.FETCH_PATIENT_GENERAL_INFO_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientGeneralInfoActionOK(
						modelAction.PatientGeneralInfoModelActionTypes.FETCH_PATIENT_GENERAL_INFO_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientGeneralInfoActionFail(
								modelAction.PatientGeneralInfoModelActionTypes.FETCH_PATIENT_GENERAL_INFO_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientGeneralInfoAction>(modelAction.PatientGeneralInfoModelActionTypes.FETCH_LAST_PATIENT_GENERAL_INFO_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientGeneralInfoActionOK(
						modelAction.PatientGeneralInfoModelActionTypes.FETCH_LAST_PATIENT_GENERAL_INFO_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientGeneralInfoActionFail(
								modelAction.PatientGeneralInfoModelActionTypes.FETCH_LAST_PATIENT_GENERAL_INFO_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientGeneralInfoAction>(modelAction.PatientGeneralInfoModelActionTypes.CREATE_PATIENT_GENERAL_INFO),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as PatientGeneralInfoModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientGeneralInfoActionOK(
						modelAction.PatientGeneralInfoModelActionTypes.CREATE_PATIENT_GENERAL_INFO_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientGeneralInfoActionFail(
								modelAction.PatientGeneralInfoModelActionTypes.CREATE_PATIENT_GENERAL_INFO_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientGeneralInfoAction>(modelAction.PatientGeneralInfoModelActionTypes.CREATE_ALL_PATIENT_GENERAL_INFO),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as PatientGeneralInfoModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientGeneralInfoActionOK(
						modelAction.PatientGeneralInfoModelActionTypes.CREATE_ALL_PATIENT_GENERAL_INFO_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientGeneralInfoActionFail(
								modelAction.PatientGeneralInfoModelActionTypes.CREATE_ALL_PATIENT_GENERAL_INFO_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientGeneralInfoAction>(modelAction.PatientGeneralInfoModelActionTypes.UPDATE_PATIENT_GENERAL_INFO),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as PatientGeneralInfoModel;
				...
				return this.service.update(new PatientGeneralInfoModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientGeneralInfoActionOK(
						modelAction.PatientGeneralInfoModelActionTypes.UPDATE_PATIENT_GENERAL_INFO_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientGeneralInfoActionFail(
								modelAction.PatientGeneralInfoModelActionTypes.UPDATE_PATIENT_GENERAL_INFO_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientGeneralInfoAction>(modelAction.PatientGeneralInfoModelActionTypes.UPDATE_ALL_PATIENT_GENERAL_INFO),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as PatientGeneralInfoModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new PatientGeneralInfoModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientGeneralInfoActionOK(
						modelAction.PatientGeneralInfoModelActionTypes.UPDATE_ALL_PATIENT_GENERAL_INFO_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientGeneralInfoActionFail(
								modelAction.PatientGeneralInfoModelActionTypes.UPDATE_ALL_PATIENT_GENERAL_INFO_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientGeneralInfoAction>(modelAction.PatientGeneralInfoModelActionTypes.DELETE_PATIENT_GENERAL_INFO),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PatientGeneralInfoActionOK(
						modelAction.PatientGeneralInfoModelActionTypes.DELETE_PATIENT_GENERAL_INFO_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientGeneralInfoActionFail(
								modelAction.PatientGeneralInfoModelActionTypes.DELETE_PATIENT_GENERAL_INFO_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientGeneralInfoAction>(modelAction.PatientGeneralInfoModelActionTypes.DELETE_PATIENT_GENERAL_INFO_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.PatientGeneralInfoActionOK(
						modelAction.PatientGeneralInfoModelActionTypes.DELETE_PATIENT_GENERAL_INFO_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientGeneralInfoActionFail(
								modelAction.PatientGeneralInfoModelActionTypes.DELETE_PATIENT_GENERAL_INFO_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientGeneralInfoAction>(modelAction.PatientGeneralInfoModelActionTypes.DELETE_ALL_PATIENT_GENERAL_INFO),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PatientGeneralInfoActionOK(
						modelAction.PatientGeneralInfoModelActionTypes.DELETE_ALL_PATIENT_GENERAL_INFO_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientGeneralInfoActionFail(
								modelAction.PatientGeneralInfoModelActionTypes.DELETE_ALL_PATIENT_GENERAL_INFO_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientGeneralInfoAction>(modelAction.PatientGeneralInfoModelActionTypes.EXPORT_PATIENT_GENERAL_INFO),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PatientGeneralInfoActionOK(
						modelAction.PatientGeneralInfoModelActionTypes.EXPORT_PATIENT_GENERAL_INFO,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientGeneralInfoAction>(modelAction.PatientGeneralInfoModelActionTypes.EXPORT_ALL_PATIENT_GENERAL_INFO),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PatientGeneralInfoActionOK(
						modelAction.PatientGeneralInfoModelActionTypes.EXPORT_ALL_PATIENT_GENERAL_INFO_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientGeneralInfoActionFail(
								modelAction.PatientGeneralInfoModelActionTypes.EXPORT_ALL_PATIENT_GENERAL_INFO_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientGeneralInfoAction>(modelAction.PatientGeneralInfoModelActionTypes.EXPORT_PATIENT_GENERAL_INFO_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PatientGeneralInfoActionOK(
						modelAction.PatientGeneralInfoModelActionTypes.EXPORT_PATIENT_GENERAL_INFO_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientGeneralInfoActionFail(
								modelAction.PatientGeneralInfoModelActionTypes.EXPORT_PATIENT_GENERAL_INFO_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientGeneralInfoAction>(modelAction.PatientGeneralInfoModelActionTypes.IMPORT_PATIENT_GENERAL_INFOS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.PatientGeneralInfoActionOK(
						modelAction.PatientGeneralInfoModelActionTypes.IMPORT_PATIENT_GENERAL_INFOS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientGeneralInfoActionFail(
								modelAction.PatientGeneralInfoModelActionTypes.IMPORT_PATIENT_GENERAL_INFOS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientGeneralInfoAction>(modelAction.PatientGeneralInfoModelActionTypes.FETCH_PATIENT_GENERAL_INFO_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.PatientGeneralInfoActionOK(
						modelAction.PatientGeneralInfoModelActionTypes.FETCH_PATIENT_GENERAL_INFO_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PatientGeneralInfoActionFail(
								modelAction.PatientGeneralInfoModelActionTypes.FETCH_PATIENT_GENERAL_INFO_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientGeneralInfoAction>(modelAction.PatientGeneralInfoModelActionTypes.FETCH_PATIENT_GENERAL_INFO_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.PatientGeneralInfoActionOK(
						modelAction.PatientGeneralInfoModelActionTypes.FETCH_PATIENT_GENERAL_INFO_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PatientGeneralInfoActionFail(
								modelAction.PatientGeneralInfoModelActionTypes.FETCH_PATIENT_GENERAL_INFO_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
