...
import * as modelAction from './bpjs_pcare_peserta_kegiatan_kelompok.model.action';
import {BpjsPcarePesertaKegiatanKelompokService} from '../../services/bpjsPcarePesertaKegiatanKelompok/bpjs_pcare_peserta_kegiatan_kelompok.service';
...
/**
 * Effect class used for side effects related to BPJS Pcare Peserta Kegiatan Kelompok model.
 */
@Injectable()
export class BpjsPcarePesertaKegiatanKelompokEffect {
	...
	constructor(
		...
		protected readonly service: BpjsPcarePesertaKegiatanKelompokService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePesertaKegiatanKelompokAction>(modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.COUNT_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOKS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsPcarePesertaKegiatanKelompokActionOK(
						modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.COUNT_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOKS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePesertaKegiatanKelompokActionFail(
								modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.COUNT_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOKS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePesertaKegiatanKelompokAction>(modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.FETCH_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOK),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcarePesertaKegiatanKelompokActionOK(
						modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.FETCH_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOK_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePesertaKegiatanKelompokActionFail(
								modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.FETCH_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOK_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePesertaKegiatanKelompokAction>(modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.FETCH_ALL_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOK),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsPcarePesertaKegiatanKelompokActionOK(
						modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.FETCH_ALL_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOK_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePesertaKegiatanKelompokActionFail(
								modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.FETCH_ALL_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOK_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePesertaKegiatanKelompokAction>(modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.FETCH_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOK_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcarePesertaKegiatanKelompokActionOK(
						modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.FETCH_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOK_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePesertaKegiatanKelompokActionFail(
								modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.FETCH_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOK_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePesertaKegiatanKelompokAction>(modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.FETCH_LAST_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOK_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcarePesertaKegiatanKelompokActionOK(
						modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.FETCH_LAST_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOK_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePesertaKegiatanKelompokActionFail(
								modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.FETCH_LAST_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOK_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePesertaKegiatanKelompokAction>(modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.CREATE_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOK),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsPcarePesertaKegiatanKelompokModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcarePesertaKegiatanKelompokActionOK(
						modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.CREATE_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOK_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePesertaKegiatanKelompokActionFail(
								modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.CREATE_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOK_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePesertaKegiatanKelompokAction>(modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.CREATE_ALL_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOK),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsPcarePesertaKegiatanKelompokModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcarePesertaKegiatanKelompokActionOK(
						modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.CREATE_ALL_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOK_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePesertaKegiatanKelompokActionFail(
								modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.CREATE_ALL_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOK_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePesertaKegiatanKelompokAction>(modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.UPDATE_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOK),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsPcarePesertaKegiatanKelompokModel;
				...
				return this.service.update(new BpjsPcarePesertaKegiatanKelompokModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcarePesertaKegiatanKelompokActionOK(
						modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.UPDATE_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOK_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePesertaKegiatanKelompokActionFail(
								modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.UPDATE_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOK_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePesertaKegiatanKelompokAction>(modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.UPDATE_ALL_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOK),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsPcarePesertaKegiatanKelompokModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsPcarePesertaKegiatanKelompokModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcarePesertaKegiatanKelompokActionOK(
						modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.UPDATE_ALL_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOK_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePesertaKegiatanKelompokActionFail(
								modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.UPDATE_ALL_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOK_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePesertaKegiatanKelompokAction>(modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.DELETE_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOK),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcarePesertaKegiatanKelompokActionOK(
						modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.DELETE_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOK_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePesertaKegiatanKelompokActionFail(
								modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.DELETE_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOK_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePesertaKegiatanKelompokAction>(modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.DELETE_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOK_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcarePesertaKegiatanKelompokActionOK(
						modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.DELETE_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOK_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePesertaKegiatanKelompokActionFail(
								modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.DELETE_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOK_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePesertaKegiatanKelompokAction>(modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.DELETE_ALL_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOK),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcarePesertaKegiatanKelompokActionOK(
						modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.DELETE_ALL_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOK_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePesertaKegiatanKelompokActionFail(
								modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.DELETE_ALL_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOK_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePesertaKegiatanKelompokAction>(modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.EXPORT_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOK),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcarePesertaKegiatanKelompokActionOK(
						modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.EXPORT_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOK,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePesertaKegiatanKelompokAction>(modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.EXPORT_ALL_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOK),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcarePesertaKegiatanKelompokActionOK(
						modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.EXPORT_ALL_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOK_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePesertaKegiatanKelompokActionFail(
								modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.EXPORT_ALL_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOK_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePesertaKegiatanKelompokAction>(modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.EXPORT_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOK_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcarePesertaKegiatanKelompokActionOK(
						modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.EXPORT_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOK_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePesertaKegiatanKelompokActionFail(
								modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.EXPORT_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOK_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePesertaKegiatanKelompokAction>(modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.IMPORT_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOKS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcarePesertaKegiatanKelompokActionOK(
						modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.IMPORT_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOKS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePesertaKegiatanKelompokActionFail(
								modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.IMPORT_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOKS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePesertaKegiatanKelompokAction>(modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.FETCH_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOK_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsPcarePesertaKegiatanKelompokActionOK(
						modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.FETCH_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOK_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePesertaKegiatanKelompokActionFail(
								modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.FETCH_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOK_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcarePesertaKegiatanKelompokAction>(modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.FETCH_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOK_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsPcarePesertaKegiatanKelompokActionOK(
						modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.FETCH_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOK_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcarePesertaKegiatanKelompokActionFail(
								modelAction.BpjsPcarePesertaKegiatanKelompokModelActionTypes.FETCH_BPJS_PCARE_PESERTA_KEGIATAN_KELOMPOK_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
