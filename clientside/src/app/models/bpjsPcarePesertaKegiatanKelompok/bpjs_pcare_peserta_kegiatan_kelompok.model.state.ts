...
/**
 * BpjsPcarePesertaKegiatanKelompokCollectionState would store the state of a collection of BpjsPcarePesertaKegiatanKelompok
 */
export interface BpjsPcarePesertaKegiatanKelompokCollectionState extends CollectionState {
 ...
 */
export interface BpjsPcarePesertaKegiatanKelompokModelAudit extends AbstractModelAudit<BpjsPcarePesertaKegiatanKelompokModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsPcarePesertaKegiatanKelompokModelState would store the state of the model
 */
export interface BpjsPcarePesertaKegiatanKelompokModelState {
	collectionState: {
		[key: string]: BpjsPcarePesertaKegiatanKelompokCollectionState;
	};
	data: {
		[id: string]: BpjsPcarePesertaKegiatanKelompokModel;
	};
	totalCount: number;
	audits: BpjsPcarePesertaKegiatanKelompokModelAudit[];
 ...
 */
export const initialBpjsPcarePesertaKegiatanKelompokCollectionState: BpjsPcarePesertaKegiatanKelompokCollectionState = {
...
/**
 * The initial state of BpjsPcarePesertaKegiatanKelompokModelState
 */
export const initialState: BpjsPcarePesertaKegiatanKelompokModelState = {
	collectionState: {
