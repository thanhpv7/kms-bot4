...
import * as modelAction from './nhis_investigation.model.action';
import {NhisInvestigationService} from '../../services/nhisInvestigation/nhis_investigation.service';
...
/**
 * Effect class used for side effects related to NHIS Investigation model.
 */
@Injectable()
export class NhisInvestigationEffect {
	...
	constructor(
		...
		protected readonly service: NhisInvestigationService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisInvestigationAction>(modelAction.NhisInvestigationModelActionTypes.COUNT_NHIS_INVESTIGATIONS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.NhisInvestigationActionOK(
						modelAction.NhisInvestigationModelActionTypes.COUNT_NHIS_INVESTIGATIONS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisInvestigationActionFail(
								modelAction.NhisInvestigationModelActionTypes.COUNT_NHIS_INVESTIGATIONS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisInvestigationAction>(modelAction.NhisInvestigationModelActionTypes.FETCH_NHIS_INVESTIGATION),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisInvestigationActionOK(
						modelAction.NhisInvestigationModelActionTypes.FETCH_NHIS_INVESTIGATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisInvestigationActionFail(
								modelAction.NhisInvestigationModelActionTypes.FETCH_NHIS_INVESTIGATION_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisInvestigationAction>(modelAction.NhisInvestigationModelActionTypes.FETCH_ALL_NHIS_INVESTIGATION),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.NhisInvestigationActionOK(
						modelAction.NhisInvestigationModelActionTypes.FETCH_ALL_NHIS_INVESTIGATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisInvestigationActionFail(
								modelAction.NhisInvestigationModelActionTypes.FETCH_ALL_NHIS_INVESTIGATION_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisInvestigationAction>(modelAction.NhisInvestigationModelActionTypes.FETCH_NHIS_INVESTIGATION_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisInvestigationActionOK(
						modelAction.NhisInvestigationModelActionTypes.FETCH_NHIS_INVESTIGATION_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisInvestigationActionFail(
								modelAction.NhisInvestigationModelActionTypes.FETCH_NHIS_INVESTIGATION_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisInvestigationAction>(modelAction.NhisInvestigationModelActionTypes.FETCH_LAST_NHIS_INVESTIGATION_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisInvestigationActionOK(
						modelAction.NhisInvestigationModelActionTypes.FETCH_LAST_NHIS_INVESTIGATION_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisInvestigationActionFail(
								modelAction.NhisInvestigationModelActionTypes.FETCH_LAST_NHIS_INVESTIGATION_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisInvestigationAction>(modelAction.NhisInvestigationModelActionTypes.CREATE_NHIS_INVESTIGATION),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as NhisInvestigationModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisInvestigationActionOK(
						modelAction.NhisInvestigationModelActionTypes.CREATE_NHIS_INVESTIGATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisInvestigationActionFail(
								modelAction.NhisInvestigationModelActionTypes.CREATE_NHIS_INVESTIGATION_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisInvestigationAction>(modelAction.NhisInvestigationModelActionTypes.CREATE_ALL_NHIS_INVESTIGATION),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as NhisInvestigationModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisInvestigationActionOK(
						modelAction.NhisInvestigationModelActionTypes.CREATE_ALL_NHIS_INVESTIGATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisInvestigationActionFail(
								modelAction.NhisInvestigationModelActionTypes.CREATE_ALL_NHIS_INVESTIGATION_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisInvestigationAction>(modelAction.NhisInvestigationModelActionTypes.UPDATE_NHIS_INVESTIGATION),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as NhisInvestigationModel;
				...
				return this.service.update(new NhisInvestigationModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisInvestigationActionOK(
						modelAction.NhisInvestigationModelActionTypes.UPDATE_NHIS_INVESTIGATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisInvestigationActionFail(
								modelAction.NhisInvestigationModelActionTypes.UPDATE_NHIS_INVESTIGATION_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisInvestigationAction>(modelAction.NhisInvestigationModelActionTypes.UPDATE_ALL_NHIS_INVESTIGATION),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as NhisInvestigationModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new NhisInvestigationModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisInvestigationActionOK(
						modelAction.NhisInvestigationModelActionTypes.UPDATE_ALL_NHIS_INVESTIGATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisInvestigationActionFail(
								modelAction.NhisInvestigationModelActionTypes.UPDATE_ALL_NHIS_INVESTIGATION_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisInvestigationAction>(modelAction.NhisInvestigationModelActionTypes.DELETE_NHIS_INVESTIGATION),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.NhisInvestigationActionOK(
						modelAction.NhisInvestigationModelActionTypes.DELETE_NHIS_INVESTIGATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisInvestigationActionFail(
								modelAction.NhisInvestigationModelActionTypes.DELETE_NHIS_INVESTIGATION_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisInvestigationAction>(modelAction.NhisInvestigationModelActionTypes.DELETE_NHIS_INVESTIGATION_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.NhisInvestigationActionOK(
						modelAction.NhisInvestigationModelActionTypes.DELETE_NHIS_INVESTIGATION_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisInvestigationActionFail(
								modelAction.NhisInvestigationModelActionTypes.DELETE_NHIS_INVESTIGATION_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisInvestigationAction>(modelAction.NhisInvestigationModelActionTypes.DELETE_ALL_NHIS_INVESTIGATION),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.NhisInvestigationActionOK(
						modelAction.NhisInvestigationModelActionTypes.DELETE_ALL_NHIS_INVESTIGATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisInvestigationActionFail(
								modelAction.NhisInvestigationModelActionTypes.DELETE_ALL_NHIS_INVESTIGATION_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisInvestigationAction>(modelAction.NhisInvestigationModelActionTypes.EXPORT_NHIS_INVESTIGATION),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.NhisInvestigationActionOK(
						modelAction.NhisInvestigationModelActionTypes.EXPORT_NHIS_INVESTIGATION,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisInvestigationAction>(modelAction.NhisInvestigationModelActionTypes.EXPORT_ALL_NHIS_INVESTIGATION),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.NhisInvestigationActionOK(
						modelAction.NhisInvestigationModelActionTypes.EXPORT_ALL_NHIS_INVESTIGATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisInvestigationActionFail(
								modelAction.NhisInvestigationModelActionTypes.EXPORT_ALL_NHIS_INVESTIGATION_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisInvestigationAction>(modelAction.NhisInvestigationModelActionTypes.EXPORT_NHIS_INVESTIGATION_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.NhisInvestigationActionOK(
						modelAction.NhisInvestigationModelActionTypes.EXPORT_NHIS_INVESTIGATION_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisInvestigationActionFail(
								modelAction.NhisInvestigationModelActionTypes.EXPORT_NHIS_INVESTIGATION_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisInvestigationAction>(modelAction.NhisInvestigationModelActionTypes.IMPORT_NHIS_INVESTIGATIONS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.NhisInvestigationActionOK(
						modelAction.NhisInvestigationModelActionTypes.IMPORT_NHIS_INVESTIGATIONS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisInvestigationActionFail(
								modelAction.NhisInvestigationModelActionTypes.IMPORT_NHIS_INVESTIGATIONS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisInvestigationAction>(modelAction.NhisInvestigationModelActionTypes.FETCH_NHIS_INVESTIGATION_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.NhisInvestigationActionOK(
						modelAction.NhisInvestigationModelActionTypes.FETCH_NHIS_INVESTIGATION_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.NhisInvestigationActionFail(
								modelAction.NhisInvestigationModelActionTypes.FETCH_NHIS_INVESTIGATION_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisInvestigationAction>(modelAction.NhisInvestigationModelActionTypes.FETCH_NHIS_INVESTIGATION_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.NhisInvestigationActionOK(
						modelAction.NhisInvestigationModelActionTypes.FETCH_NHIS_INVESTIGATION_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.NhisInvestigationActionFail(
								modelAction.NhisInvestigationModelActionTypes.FETCH_NHIS_INVESTIGATION_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
