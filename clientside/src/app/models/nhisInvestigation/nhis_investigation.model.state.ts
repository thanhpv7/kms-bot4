...
/**
 * NhisInvestigationCollectionState would store the state of a collection of NhisInvestigation
 */
export interface NhisInvestigationCollectionState extends CollectionState {
 ...
 */
export interface NhisInvestigationModelAudit extends AbstractModelAudit<NhisInvestigationModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * NhisInvestigationModelState would store the state of the model
 */
export interface NhisInvestigationModelState {
	collectionState: {
		[key: string]: NhisInvestigationCollectionState;
	};
	data: {
		[id: string]: NhisInvestigationModel;
	};
	totalCount: number;
	audits: NhisInvestigationModelAudit[];
 ...
 */
export const initialNhisInvestigationCollectionState: NhisInvestigationCollectionState = {
...
/**
 * The initial state of NhisInvestigationModelState
 */
export const initialState: NhisInvestigationModelState = {
	collectionState: {
