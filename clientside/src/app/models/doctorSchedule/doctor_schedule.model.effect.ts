...
import * as modelAction from './doctor_schedule.model.action';
import {DoctorScheduleService} from '../../services/doctorSchedule/doctor_schedule.service';
...
/**
 * Effect class used for side effects related to Doctor Schedule model.
 */
@Injectable()
export class DoctorScheduleEffect {
	...
	constructor(
		...
		protected readonly service: DoctorScheduleService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DoctorScheduleAction>(modelAction.DoctorScheduleModelActionTypes.COUNT_DOCTOR_SCHEDULES),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.DoctorScheduleActionOK(
						modelAction.DoctorScheduleModelActionTypes.COUNT_DOCTOR_SCHEDULES_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DoctorScheduleActionFail(
								modelAction.DoctorScheduleModelActionTypes.COUNT_DOCTOR_SCHEDULES_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DoctorScheduleAction>(modelAction.DoctorScheduleModelActionTypes.FETCH_DOCTOR_SCHEDULE),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.DoctorScheduleActionOK(
						modelAction.DoctorScheduleModelActionTypes.FETCH_DOCTOR_SCHEDULE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DoctorScheduleActionFail(
								modelAction.DoctorScheduleModelActionTypes.FETCH_DOCTOR_SCHEDULE_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DoctorScheduleAction>(modelAction.DoctorScheduleModelActionTypes.FETCH_ALL_DOCTOR_SCHEDULE),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.DoctorScheduleActionOK(
						modelAction.DoctorScheduleModelActionTypes.FETCH_ALL_DOCTOR_SCHEDULE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DoctorScheduleActionFail(
								modelAction.DoctorScheduleModelActionTypes.FETCH_ALL_DOCTOR_SCHEDULE_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DoctorScheduleAction>(modelAction.DoctorScheduleModelActionTypes.FETCH_DOCTOR_SCHEDULE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.DoctorScheduleActionOK(
						modelAction.DoctorScheduleModelActionTypes.FETCH_DOCTOR_SCHEDULE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DoctorScheduleActionFail(
								modelAction.DoctorScheduleModelActionTypes.FETCH_DOCTOR_SCHEDULE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DoctorScheduleAction>(modelAction.DoctorScheduleModelActionTypes.FETCH_LAST_DOCTOR_SCHEDULE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.DoctorScheduleActionOK(
						modelAction.DoctorScheduleModelActionTypes.FETCH_LAST_DOCTOR_SCHEDULE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DoctorScheduleActionFail(
								modelAction.DoctorScheduleModelActionTypes.FETCH_LAST_DOCTOR_SCHEDULE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DoctorScheduleAction>(modelAction.DoctorScheduleModelActionTypes.CREATE_DOCTOR_SCHEDULE),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as DoctorScheduleModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.DoctorScheduleActionOK(
						modelAction.DoctorScheduleModelActionTypes.CREATE_DOCTOR_SCHEDULE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DoctorScheduleActionFail(
								modelAction.DoctorScheduleModelActionTypes.CREATE_DOCTOR_SCHEDULE_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DoctorScheduleAction>(modelAction.DoctorScheduleModelActionTypes.CREATE_ALL_DOCTOR_SCHEDULE),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as DoctorScheduleModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.DoctorScheduleActionOK(
						modelAction.DoctorScheduleModelActionTypes.CREATE_ALL_DOCTOR_SCHEDULE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DoctorScheduleActionFail(
								modelAction.DoctorScheduleModelActionTypes.CREATE_ALL_DOCTOR_SCHEDULE_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DoctorScheduleAction>(modelAction.DoctorScheduleModelActionTypes.UPDATE_DOCTOR_SCHEDULE),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as DoctorScheduleModel;
				...
				return this.service.update(new DoctorScheduleModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.DoctorScheduleActionOK(
						modelAction.DoctorScheduleModelActionTypes.UPDATE_DOCTOR_SCHEDULE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DoctorScheduleActionFail(
								modelAction.DoctorScheduleModelActionTypes.UPDATE_DOCTOR_SCHEDULE_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DoctorScheduleAction>(modelAction.DoctorScheduleModelActionTypes.UPDATE_ALL_DOCTOR_SCHEDULE),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as DoctorScheduleModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new DoctorScheduleModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.DoctorScheduleActionOK(
						modelAction.DoctorScheduleModelActionTypes.UPDATE_ALL_DOCTOR_SCHEDULE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DoctorScheduleActionFail(
								modelAction.DoctorScheduleModelActionTypes.UPDATE_ALL_DOCTOR_SCHEDULE_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DoctorScheduleAction>(modelAction.DoctorScheduleModelActionTypes.DELETE_DOCTOR_SCHEDULE),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.DoctorScheduleActionOK(
						modelAction.DoctorScheduleModelActionTypes.DELETE_DOCTOR_SCHEDULE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DoctorScheduleActionFail(
								modelAction.DoctorScheduleModelActionTypes.DELETE_DOCTOR_SCHEDULE_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DoctorScheduleAction>(modelAction.DoctorScheduleModelActionTypes.DELETE_DOCTOR_SCHEDULE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.DoctorScheduleActionOK(
						modelAction.DoctorScheduleModelActionTypes.DELETE_DOCTOR_SCHEDULE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DoctorScheduleActionFail(
								modelAction.DoctorScheduleModelActionTypes.DELETE_DOCTOR_SCHEDULE_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DoctorScheduleAction>(modelAction.DoctorScheduleModelActionTypes.DELETE_ALL_DOCTOR_SCHEDULE),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.DoctorScheduleActionOK(
						modelAction.DoctorScheduleModelActionTypes.DELETE_ALL_DOCTOR_SCHEDULE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DoctorScheduleActionFail(
								modelAction.DoctorScheduleModelActionTypes.DELETE_ALL_DOCTOR_SCHEDULE_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DoctorScheduleAction>(modelAction.DoctorScheduleModelActionTypes.EXPORT_DOCTOR_SCHEDULE),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.DoctorScheduleActionOK(
						modelAction.DoctorScheduleModelActionTypes.EXPORT_DOCTOR_SCHEDULE,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DoctorScheduleAction>(modelAction.DoctorScheduleModelActionTypes.EXPORT_ALL_DOCTOR_SCHEDULE),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.DoctorScheduleActionOK(
						modelAction.DoctorScheduleModelActionTypes.EXPORT_ALL_DOCTOR_SCHEDULE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DoctorScheduleActionFail(
								modelAction.DoctorScheduleModelActionTypes.EXPORT_ALL_DOCTOR_SCHEDULE_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DoctorScheduleAction>(modelAction.DoctorScheduleModelActionTypes.EXPORT_DOCTOR_SCHEDULE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.DoctorScheduleActionOK(
						modelAction.DoctorScheduleModelActionTypes.EXPORT_DOCTOR_SCHEDULE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DoctorScheduleActionFail(
								modelAction.DoctorScheduleModelActionTypes.EXPORT_DOCTOR_SCHEDULE_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DoctorScheduleAction>(modelAction.DoctorScheduleModelActionTypes.IMPORT_DOCTOR_SCHEDULES),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.DoctorScheduleActionOK(
						modelAction.DoctorScheduleModelActionTypes.IMPORT_DOCTOR_SCHEDULES_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DoctorScheduleActionFail(
								modelAction.DoctorScheduleModelActionTypes.IMPORT_DOCTOR_SCHEDULES_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DoctorScheduleAction>(modelAction.DoctorScheduleModelActionTypes.FETCH_DOCTOR_SCHEDULE_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.DoctorScheduleActionOK(
						modelAction.DoctorScheduleModelActionTypes.FETCH_DOCTOR_SCHEDULE_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.DoctorScheduleActionFail(
								modelAction.DoctorScheduleModelActionTypes.FETCH_DOCTOR_SCHEDULE_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DoctorScheduleAction>(modelAction.DoctorScheduleModelActionTypes.FETCH_DOCTOR_SCHEDULE_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.DoctorScheduleActionOK(
						modelAction.DoctorScheduleModelActionTypes.FETCH_DOCTOR_SCHEDULE_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.DoctorScheduleActionFail(
								modelAction.DoctorScheduleModelActionTypes.FETCH_DOCTOR_SCHEDULE_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
