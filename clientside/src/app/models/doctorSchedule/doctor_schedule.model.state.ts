...
/**
 * DoctorScheduleCollectionState would store the state of a collection of DoctorSchedule
 */
export interface DoctorScheduleCollectionState extends CollectionState {
 ...
 */
export interface DoctorScheduleModelAudit extends AbstractModelAudit<DoctorScheduleModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * DoctorScheduleModelState would store the state of the model
 */
export interface DoctorScheduleModelState {
	collectionState: {
		[key: string]: DoctorScheduleCollectionState;
	};
	data: {
		[id: string]: DoctorScheduleModel;
	};
	totalCount: number;
	audits: DoctorScheduleModelAudit[];
 ...
 */
export const initialDoctorScheduleCollectionState: DoctorScheduleCollectionState = {
...
/**
 * The initial state of DoctorScheduleModelState
 */
export const initialState: DoctorScheduleModelState = {
	collectionState: {
