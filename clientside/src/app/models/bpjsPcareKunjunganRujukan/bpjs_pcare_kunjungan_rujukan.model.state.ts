...
/**
 * BpjsPcareKunjunganRujukanCollectionState would store the state of a collection of BpjsPcareKunjunganRujukan
 */
export interface BpjsPcareKunjunganRujukanCollectionState extends CollectionState {
 ...
 */
export interface BpjsPcareKunjunganRujukanModelAudit extends AbstractModelAudit<BpjsPcareKunjunganRujukanModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsPcareKunjunganRujukanModelState would store the state of the model
 */
export interface BpjsPcareKunjunganRujukanModelState {
	collectionState: {
		[key: string]: BpjsPcareKunjunganRujukanCollectionState;
	};
	data: {
		[id: string]: BpjsPcareKunjunganRujukanModel;
	};
	totalCount: number;
	audits: BpjsPcareKunjunganRujukanModelAudit[];
 ...
 */
export const initialBpjsPcareKunjunganRujukanCollectionState: BpjsPcareKunjunganRujukanCollectionState = {
...
/**
 * The initial state of BpjsPcareKunjunganRujukanModelState
 */
export const initialState: BpjsPcareKunjunganRujukanModelState = {
	collectionState: {
