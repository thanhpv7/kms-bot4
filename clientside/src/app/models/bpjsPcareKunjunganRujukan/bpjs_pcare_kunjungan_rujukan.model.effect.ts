...
import * as modelAction from './bpjs_pcare_kunjungan_rujukan.model.action';
import {BpjsPcareKunjunganRujukanService} from '../../services/bpjsPcareKunjunganRujukan/bpjs_pcare_kunjungan_rujukan.service';
...
/**
 * Effect class used for side effects related to Bpjs Pcare Kunjungan Rujukan model.
 */
@Injectable()
export class BpjsPcareKunjunganRujukanEffect {
	...
	constructor(
		...
		protected readonly service: BpjsPcareKunjunganRujukanService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKunjunganRujukanAction>(modelAction.BpjsPcareKunjunganRujukanModelActionTypes.COUNT_BPJS_PCARE_KUNJUNGAN_RUJUKANS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareKunjunganRujukanActionOK(
						modelAction.BpjsPcareKunjunganRujukanModelActionTypes.COUNT_BPJS_PCARE_KUNJUNGAN_RUJUKANS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKunjunganRujukanActionFail(
								modelAction.BpjsPcareKunjunganRujukanModelActionTypes.COUNT_BPJS_PCARE_KUNJUNGAN_RUJUKANS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKunjunganRujukanAction>(modelAction.BpjsPcareKunjunganRujukanModelActionTypes.FETCH_BPJS_PCARE_KUNJUNGAN_RUJUKAN),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareKunjunganRujukanActionOK(
						modelAction.BpjsPcareKunjunganRujukanModelActionTypes.FETCH_BPJS_PCARE_KUNJUNGAN_RUJUKAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKunjunganRujukanActionFail(
								modelAction.BpjsPcareKunjunganRujukanModelActionTypes.FETCH_BPJS_PCARE_KUNJUNGAN_RUJUKAN_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKunjunganRujukanAction>(modelAction.BpjsPcareKunjunganRujukanModelActionTypes.FETCH_ALL_BPJS_PCARE_KUNJUNGAN_RUJUKAN),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareKunjunganRujukanActionOK(
						modelAction.BpjsPcareKunjunganRujukanModelActionTypes.FETCH_ALL_BPJS_PCARE_KUNJUNGAN_RUJUKAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKunjunganRujukanActionFail(
								modelAction.BpjsPcareKunjunganRujukanModelActionTypes.FETCH_ALL_BPJS_PCARE_KUNJUNGAN_RUJUKAN_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKunjunganRujukanAction>(modelAction.BpjsPcareKunjunganRujukanModelActionTypes.FETCH_BPJS_PCARE_KUNJUNGAN_RUJUKAN_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareKunjunganRujukanActionOK(
						modelAction.BpjsPcareKunjunganRujukanModelActionTypes.FETCH_BPJS_PCARE_KUNJUNGAN_RUJUKAN_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKunjunganRujukanActionFail(
								modelAction.BpjsPcareKunjunganRujukanModelActionTypes.FETCH_BPJS_PCARE_KUNJUNGAN_RUJUKAN_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKunjunganRujukanAction>(modelAction.BpjsPcareKunjunganRujukanModelActionTypes.FETCH_LAST_BPJS_PCARE_KUNJUNGAN_RUJUKAN_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareKunjunganRujukanActionOK(
						modelAction.BpjsPcareKunjunganRujukanModelActionTypes.FETCH_LAST_BPJS_PCARE_KUNJUNGAN_RUJUKAN_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKunjunganRujukanActionFail(
								modelAction.BpjsPcareKunjunganRujukanModelActionTypes.FETCH_LAST_BPJS_PCARE_KUNJUNGAN_RUJUKAN_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKunjunganRujukanAction>(modelAction.BpjsPcareKunjunganRujukanModelActionTypes.CREATE_BPJS_PCARE_KUNJUNGAN_RUJUKAN),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsPcareKunjunganRujukanModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareKunjunganRujukanActionOK(
						modelAction.BpjsPcareKunjunganRujukanModelActionTypes.CREATE_BPJS_PCARE_KUNJUNGAN_RUJUKAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKunjunganRujukanActionFail(
								modelAction.BpjsPcareKunjunganRujukanModelActionTypes.CREATE_BPJS_PCARE_KUNJUNGAN_RUJUKAN_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKunjunganRujukanAction>(modelAction.BpjsPcareKunjunganRujukanModelActionTypes.CREATE_ALL_BPJS_PCARE_KUNJUNGAN_RUJUKAN),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsPcareKunjunganRujukanModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareKunjunganRujukanActionOK(
						modelAction.BpjsPcareKunjunganRujukanModelActionTypes.CREATE_ALL_BPJS_PCARE_KUNJUNGAN_RUJUKAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKunjunganRujukanActionFail(
								modelAction.BpjsPcareKunjunganRujukanModelActionTypes.CREATE_ALL_BPJS_PCARE_KUNJUNGAN_RUJUKAN_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKunjunganRujukanAction>(modelAction.BpjsPcareKunjunganRujukanModelActionTypes.UPDATE_BPJS_PCARE_KUNJUNGAN_RUJUKAN),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsPcareKunjunganRujukanModel;
				...
				return this.service.update(new BpjsPcareKunjunganRujukanModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareKunjunganRujukanActionOK(
						modelAction.BpjsPcareKunjunganRujukanModelActionTypes.UPDATE_BPJS_PCARE_KUNJUNGAN_RUJUKAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKunjunganRujukanActionFail(
								modelAction.BpjsPcareKunjunganRujukanModelActionTypes.UPDATE_BPJS_PCARE_KUNJUNGAN_RUJUKAN_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKunjunganRujukanAction>(modelAction.BpjsPcareKunjunganRujukanModelActionTypes.UPDATE_ALL_BPJS_PCARE_KUNJUNGAN_RUJUKAN),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsPcareKunjunganRujukanModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsPcareKunjunganRujukanModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareKunjunganRujukanActionOK(
						modelAction.BpjsPcareKunjunganRujukanModelActionTypes.UPDATE_ALL_BPJS_PCARE_KUNJUNGAN_RUJUKAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKunjunganRujukanActionFail(
								modelAction.BpjsPcareKunjunganRujukanModelActionTypes.UPDATE_ALL_BPJS_PCARE_KUNJUNGAN_RUJUKAN_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKunjunganRujukanAction>(modelAction.BpjsPcareKunjunganRujukanModelActionTypes.DELETE_BPJS_PCARE_KUNJUNGAN_RUJUKAN),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareKunjunganRujukanActionOK(
						modelAction.BpjsPcareKunjunganRujukanModelActionTypes.DELETE_BPJS_PCARE_KUNJUNGAN_RUJUKAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKunjunganRujukanActionFail(
								modelAction.BpjsPcareKunjunganRujukanModelActionTypes.DELETE_BPJS_PCARE_KUNJUNGAN_RUJUKAN_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKunjunganRujukanAction>(modelAction.BpjsPcareKunjunganRujukanModelActionTypes.DELETE_BPJS_PCARE_KUNJUNGAN_RUJUKAN_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareKunjunganRujukanActionOK(
						modelAction.BpjsPcareKunjunganRujukanModelActionTypes.DELETE_BPJS_PCARE_KUNJUNGAN_RUJUKAN_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKunjunganRujukanActionFail(
								modelAction.BpjsPcareKunjunganRujukanModelActionTypes.DELETE_BPJS_PCARE_KUNJUNGAN_RUJUKAN_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKunjunganRujukanAction>(modelAction.BpjsPcareKunjunganRujukanModelActionTypes.DELETE_ALL_BPJS_PCARE_KUNJUNGAN_RUJUKAN),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareKunjunganRujukanActionOK(
						modelAction.BpjsPcareKunjunganRujukanModelActionTypes.DELETE_ALL_BPJS_PCARE_KUNJUNGAN_RUJUKAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKunjunganRujukanActionFail(
								modelAction.BpjsPcareKunjunganRujukanModelActionTypes.DELETE_ALL_BPJS_PCARE_KUNJUNGAN_RUJUKAN_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKunjunganRujukanAction>(modelAction.BpjsPcareKunjunganRujukanModelActionTypes.EXPORT_BPJS_PCARE_KUNJUNGAN_RUJUKAN),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareKunjunganRujukanActionOK(
						modelAction.BpjsPcareKunjunganRujukanModelActionTypes.EXPORT_BPJS_PCARE_KUNJUNGAN_RUJUKAN,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKunjunganRujukanAction>(modelAction.BpjsPcareKunjunganRujukanModelActionTypes.EXPORT_ALL_BPJS_PCARE_KUNJUNGAN_RUJUKAN),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareKunjunganRujukanActionOK(
						modelAction.BpjsPcareKunjunganRujukanModelActionTypes.EXPORT_ALL_BPJS_PCARE_KUNJUNGAN_RUJUKAN_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKunjunganRujukanActionFail(
								modelAction.BpjsPcareKunjunganRujukanModelActionTypes.EXPORT_ALL_BPJS_PCARE_KUNJUNGAN_RUJUKAN_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKunjunganRujukanAction>(modelAction.BpjsPcareKunjunganRujukanModelActionTypes.EXPORT_BPJS_PCARE_KUNJUNGAN_RUJUKAN_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareKunjunganRujukanActionOK(
						modelAction.BpjsPcareKunjunganRujukanModelActionTypes.EXPORT_BPJS_PCARE_KUNJUNGAN_RUJUKAN_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKunjunganRujukanActionFail(
								modelAction.BpjsPcareKunjunganRujukanModelActionTypes.EXPORT_BPJS_PCARE_KUNJUNGAN_RUJUKAN_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKunjunganRujukanAction>(modelAction.BpjsPcareKunjunganRujukanModelActionTypes.IMPORT_BPJS_PCARE_KUNJUNGAN_RUJUKANS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareKunjunganRujukanActionOK(
						modelAction.BpjsPcareKunjunganRujukanModelActionTypes.IMPORT_BPJS_PCARE_KUNJUNGAN_RUJUKANS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKunjunganRujukanActionFail(
								modelAction.BpjsPcareKunjunganRujukanModelActionTypes.IMPORT_BPJS_PCARE_KUNJUNGAN_RUJUKANS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKunjunganRujukanAction>(modelAction.BpjsPcareKunjunganRujukanModelActionTypes.FETCH_BPJS_PCARE_KUNJUNGAN_RUJUKAN_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsPcareKunjunganRujukanActionOK(
						modelAction.BpjsPcareKunjunganRujukanModelActionTypes.FETCH_BPJS_PCARE_KUNJUNGAN_RUJUKAN_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKunjunganRujukanActionFail(
								modelAction.BpjsPcareKunjunganRujukanModelActionTypes.FETCH_BPJS_PCARE_KUNJUNGAN_RUJUKAN_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKunjunganRujukanAction>(modelAction.BpjsPcareKunjunganRujukanModelActionTypes.FETCH_BPJS_PCARE_KUNJUNGAN_RUJUKAN_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsPcareKunjunganRujukanActionOK(
						modelAction.BpjsPcareKunjunganRujukanModelActionTypes.FETCH_BPJS_PCARE_KUNJUNGAN_RUJUKAN_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKunjunganRujukanActionFail(
								modelAction.BpjsPcareKunjunganRujukanModelActionTypes.FETCH_BPJS_PCARE_KUNJUNGAN_RUJUKAN_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
