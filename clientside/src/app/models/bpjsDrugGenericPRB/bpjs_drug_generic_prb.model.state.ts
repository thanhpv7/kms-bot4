...
/**
 * BpjsDrugGenericPRBCollectionState would store the state of a collection of BpjsDrugGenericPRB
 */
export interface BpjsDrugGenericPRBCollectionState extends CollectionState {
 ...
 */
export interface BpjsDrugGenericPRBModelAudit extends AbstractModelAudit<BpjsDrugGenericPRBModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsDrugGenericPRBModelState would store the state of the model
 */
export interface BpjsDrugGenericPRBModelState {
	collectionState: {
		[key: string]: BpjsDrugGenericPRBCollectionState;
	};
	data: {
		[id: string]: BpjsDrugGenericPRBModel;
	};
	totalCount: number;
	audits: BpjsDrugGenericPRBModelAudit[];
 ...
 */
export const initialBpjsDrugGenericPRBCollectionState: BpjsDrugGenericPRBCollectionState = {
...
/**
 * The initial state of BpjsDrugGenericPRBModelState
 */
export const initialState: BpjsDrugGenericPRBModelState = {
	collectionState: {
