...
import * as modelAction from './bpjs_drug_generic_prb.model.action';
import {BpjsDrugGenericPRBService} from '../../services/bpjsDrugGenericPRB/bpjs_drug_generic_prb.service';
...
/**
 * Effect class used for side effects related to BPJS Drug Generic PRB model.
 */
@Injectable()
export class BpjsDrugGenericPRBEffect {
	...
	constructor(
		...
		protected readonly service: BpjsDrugGenericPRBService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDrugGenericPRBAction>(modelAction.BpjsDrugGenericPRBModelActionTypes.COUNT_BPJS_DRUG_GENERIC_PRBS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsDrugGenericPRBActionOK(
						modelAction.BpjsDrugGenericPRBModelActionTypes.COUNT_BPJS_DRUG_GENERIC_PRBS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDrugGenericPRBActionFail(
								modelAction.BpjsDrugGenericPRBModelActionTypes.COUNT_BPJS_DRUG_GENERIC_PRBS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDrugGenericPRBAction>(modelAction.BpjsDrugGenericPRBModelActionTypes.FETCH_BPJS_DRUG_GENERIC_PRB),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsDrugGenericPRBActionOK(
						modelAction.BpjsDrugGenericPRBModelActionTypes.FETCH_BPJS_DRUG_GENERIC_PRB_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDrugGenericPRBActionFail(
								modelAction.BpjsDrugGenericPRBModelActionTypes.FETCH_BPJS_DRUG_GENERIC_PRB_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDrugGenericPRBAction>(modelAction.BpjsDrugGenericPRBModelActionTypes.FETCH_ALL_BPJS_DRUG_GENERIC_PRB),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsDrugGenericPRBActionOK(
						modelAction.BpjsDrugGenericPRBModelActionTypes.FETCH_ALL_BPJS_DRUG_GENERIC_PRB_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDrugGenericPRBActionFail(
								modelAction.BpjsDrugGenericPRBModelActionTypes.FETCH_ALL_BPJS_DRUG_GENERIC_PRB_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDrugGenericPRBAction>(modelAction.BpjsDrugGenericPRBModelActionTypes.FETCH_BPJS_DRUG_GENERIC_PRB_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsDrugGenericPRBActionOK(
						modelAction.BpjsDrugGenericPRBModelActionTypes.FETCH_BPJS_DRUG_GENERIC_PRB_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDrugGenericPRBActionFail(
								modelAction.BpjsDrugGenericPRBModelActionTypes.FETCH_BPJS_DRUG_GENERIC_PRB_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDrugGenericPRBAction>(modelAction.BpjsDrugGenericPRBModelActionTypes.FETCH_LAST_BPJS_DRUG_GENERIC_PRB_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsDrugGenericPRBActionOK(
						modelAction.BpjsDrugGenericPRBModelActionTypes.FETCH_LAST_BPJS_DRUG_GENERIC_PRB_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDrugGenericPRBActionFail(
								modelAction.BpjsDrugGenericPRBModelActionTypes.FETCH_LAST_BPJS_DRUG_GENERIC_PRB_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDrugGenericPRBAction>(modelAction.BpjsDrugGenericPRBModelActionTypes.CREATE_BPJS_DRUG_GENERIC_PRB),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsDrugGenericPRBModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsDrugGenericPRBActionOK(
						modelAction.BpjsDrugGenericPRBModelActionTypes.CREATE_BPJS_DRUG_GENERIC_PRB_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDrugGenericPRBActionFail(
								modelAction.BpjsDrugGenericPRBModelActionTypes.CREATE_BPJS_DRUG_GENERIC_PRB_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDrugGenericPRBAction>(modelAction.BpjsDrugGenericPRBModelActionTypes.CREATE_ALL_BPJS_DRUG_GENERIC_PRB),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsDrugGenericPRBModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsDrugGenericPRBActionOK(
						modelAction.BpjsDrugGenericPRBModelActionTypes.CREATE_ALL_BPJS_DRUG_GENERIC_PRB_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDrugGenericPRBActionFail(
								modelAction.BpjsDrugGenericPRBModelActionTypes.CREATE_ALL_BPJS_DRUG_GENERIC_PRB_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDrugGenericPRBAction>(modelAction.BpjsDrugGenericPRBModelActionTypes.UPDATE_BPJS_DRUG_GENERIC_PRB),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsDrugGenericPRBModel;
				...
				return this.service.update(new BpjsDrugGenericPRBModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsDrugGenericPRBActionOK(
						modelAction.BpjsDrugGenericPRBModelActionTypes.UPDATE_BPJS_DRUG_GENERIC_PRB_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDrugGenericPRBActionFail(
								modelAction.BpjsDrugGenericPRBModelActionTypes.UPDATE_BPJS_DRUG_GENERIC_PRB_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDrugGenericPRBAction>(modelAction.BpjsDrugGenericPRBModelActionTypes.UPDATE_ALL_BPJS_DRUG_GENERIC_PRB),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsDrugGenericPRBModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsDrugGenericPRBModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsDrugGenericPRBActionOK(
						modelAction.BpjsDrugGenericPRBModelActionTypes.UPDATE_ALL_BPJS_DRUG_GENERIC_PRB_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDrugGenericPRBActionFail(
								modelAction.BpjsDrugGenericPRBModelActionTypes.UPDATE_ALL_BPJS_DRUG_GENERIC_PRB_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDrugGenericPRBAction>(modelAction.BpjsDrugGenericPRBModelActionTypes.DELETE_BPJS_DRUG_GENERIC_PRB),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsDrugGenericPRBActionOK(
						modelAction.BpjsDrugGenericPRBModelActionTypes.DELETE_BPJS_DRUG_GENERIC_PRB_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDrugGenericPRBActionFail(
								modelAction.BpjsDrugGenericPRBModelActionTypes.DELETE_BPJS_DRUG_GENERIC_PRB_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDrugGenericPRBAction>(modelAction.BpjsDrugGenericPRBModelActionTypes.DELETE_BPJS_DRUG_GENERIC_PRB_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsDrugGenericPRBActionOK(
						modelAction.BpjsDrugGenericPRBModelActionTypes.DELETE_BPJS_DRUG_GENERIC_PRB_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDrugGenericPRBActionFail(
								modelAction.BpjsDrugGenericPRBModelActionTypes.DELETE_BPJS_DRUG_GENERIC_PRB_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDrugGenericPRBAction>(modelAction.BpjsDrugGenericPRBModelActionTypes.DELETE_ALL_BPJS_DRUG_GENERIC_PRB),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsDrugGenericPRBActionOK(
						modelAction.BpjsDrugGenericPRBModelActionTypes.DELETE_ALL_BPJS_DRUG_GENERIC_PRB_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDrugGenericPRBActionFail(
								modelAction.BpjsDrugGenericPRBModelActionTypes.DELETE_ALL_BPJS_DRUG_GENERIC_PRB_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDrugGenericPRBAction>(modelAction.BpjsDrugGenericPRBModelActionTypes.EXPORT_BPJS_DRUG_GENERIC_PRB),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsDrugGenericPRBActionOK(
						modelAction.BpjsDrugGenericPRBModelActionTypes.EXPORT_BPJS_DRUG_GENERIC_PRB,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDrugGenericPRBAction>(modelAction.BpjsDrugGenericPRBModelActionTypes.EXPORT_ALL_BPJS_DRUG_GENERIC_PRB),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsDrugGenericPRBActionOK(
						modelAction.BpjsDrugGenericPRBModelActionTypes.EXPORT_ALL_BPJS_DRUG_GENERIC_PRB_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDrugGenericPRBActionFail(
								modelAction.BpjsDrugGenericPRBModelActionTypes.EXPORT_ALL_BPJS_DRUG_GENERIC_PRB_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDrugGenericPRBAction>(modelAction.BpjsDrugGenericPRBModelActionTypes.EXPORT_BPJS_DRUG_GENERIC_PRB_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsDrugGenericPRBActionOK(
						modelAction.BpjsDrugGenericPRBModelActionTypes.EXPORT_BPJS_DRUG_GENERIC_PRB_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDrugGenericPRBActionFail(
								modelAction.BpjsDrugGenericPRBModelActionTypes.EXPORT_BPJS_DRUG_GENERIC_PRB_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDrugGenericPRBAction>(modelAction.BpjsDrugGenericPRBModelActionTypes.IMPORT_BPJS_DRUG_GENERIC_PRBS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsDrugGenericPRBActionOK(
						modelAction.BpjsDrugGenericPRBModelActionTypes.IMPORT_BPJS_DRUG_GENERIC_PRBS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDrugGenericPRBActionFail(
								modelAction.BpjsDrugGenericPRBModelActionTypes.IMPORT_BPJS_DRUG_GENERIC_PRBS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDrugGenericPRBAction>(modelAction.BpjsDrugGenericPRBModelActionTypes.FETCH_BPJS_DRUG_GENERIC_PRB_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsDrugGenericPRBActionOK(
						modelAction.BpjsDrugGenericPRBModelActionTypes.FETCH_BPJS_DRUG_GENERIC_PRB_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDrugGenericPRBActionFail(
								modelAction.BpjsDrugGenericPRBModelActionTypes.FETCH_BPJS_DRUG_GENERIC_PRB_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDrugGenericPRBAction>(modelAction.BpjsDrugGenericPRBModelActionTypes.FETCH_BPJS_DRUG_GENERIC_PRB_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsDrugGenericPRBActionOK(
						modelAction.BpjsDrugGenericPRBModelActionTypes.FETCH_BPJS_DRUG_GENERIC_PRB_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDrugGenericPRBActionFail(
								modelAction.BpjsDrugGenericPRBModelActionTypes.FETCH_BPJS_DRUG_GENERIC_PRB_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
