...
/**
 * NhisSpecialtyAttendedCollectionState would store the state of a collection of NhisSpecialtyAttended
 */
export interface NhisSpecialtyAttendedCollectionState extends CollectionState {
 ...
 */
export interface NhisSpecialtyAttendedModelAudit extends AbstractModelAudit<NhisSpecialtyAttendedModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * NhisSpecialtyAttendedModelState would store the state of the model
 */
export interface NhisSpecialtyAttendedModelState {
	collectionState: {
		[key: string]: NhisSpecialtyAttendedCollectionState;
	};
	data: {
		[id: string]: NhisSpecialtyAttendedModel;
	};
	totalCount: number;
	audits: NhisSpecialtyAttendedModelAudit[];
 ...
 */
export const initialNhisSpecialtyAttendedCollectionState: NhisSpecialtyAttendedCollectionState = {
...
/**
 * The initial state of NhisSpecialtyAttendedModelState
 */
export const initialState: NhisSpecialtyAttendedModelState = {
	collectionState: {
