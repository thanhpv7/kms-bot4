...
import * as modelAction from './nhis_specialty_attended.model.action';
import {NhisSpecialtyAttendedService} from '../../services/nhisSpecialtyAttended/nhis_specialty_attended.service';
...
/**
 * Effect class used for side effects related to NHIS Specialty Attended model.
 */
@Injectable()
export class NhisSpecialtyAttendedEffect {
	...
	constructor(
		...
		protected readonly service: NhisSpecialtyAttendedService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisSpecialtyAttendedAction>(modelAction.NhisSpecialtyAttendedModelActionTypes.COUNT_NHIS_SPECIALTY_ATTENDEDS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.NhisSpecialtyAttendedActionOK(
						modelAction.NhisSpecialtyAttendedModelActionTypes.COUNT_NHIS_SPECIALTY_ATTENDEDS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisSpecialtyAttendedActionFail(
								modelAction.NhisSpecialtyAttendedModelActionTypes.COUNT_NHIS_SPECIALTY_ATTENDEDS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisSpecialtyAttendedAction>(modelAction.NhisSpecialtyAttendedModelActionTypes.FETCH_NHIS_SPECIALTY_ATTENDED),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisSpecialtyAttendedActionOK(
						modelAction.NhisSpecialtyAttendedModelActionTypes.FETCH_NHIS_SPECIALTY_ATTENDED_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisSpecialtyAttendedActionFail(
								modelAction.NhisSpecialtyAttendedModelActionTypes.FETCH_NHIS_SPECIALTY_ATTENDED_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisSpecialtyAttendedAction>(modelAction.NhisSpecialtyAttendedModelActionTypes.FETCH_ALL_NHIS_SPECIALTY_ATTENDED),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.NhisSpecialtyAttendedActionOK(
						modelAction.NhisSpecialtyAttendedModelActionTypes.FETCH_ALL_NHIS_SPECIALTY_ATTENDED_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisSpecialtyAttendedActionFail(
								modelAction.NhisSpecialtyAttendedModelActionTypes.FETCH_ALL_NHIS_SPECIALTY_ATTENDED_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisSpecialtyAttendedAction>(modelAction.NhisSpecialtyAttendedModelActionTypes.FETCH_NHIS_SPECIALTY_ATTENDED_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisSpecialtyAttendedActionOK(
						modelAction.NhisSpecialtyAttendedModelActionTypes.FETCH_NHIS_SPECIALTY_ATTENDED_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisSpecialtyAttendedActionFail(
								modelAction.NhisSpecialtyAttendedModelActionTypes.FETCH_NHIS_SPECIALTY_ATTENDED_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisSpecialtyAttendedAction>(modelAction.NhisSpecialtyAttendedModelActionTypes.FETCH_LAST_NHIS_SPECIALTY_ATTENDED_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisSpecialtyAttendedActionOK(
						modelAction.NhisSpecialtyAttendedModelActionTypes.FETCH_LAST_NHIS_SPECIALTY_ATTENDED_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisSpecialtyAttendedActionFail(
								modelAction.NhisSpecialtyAttendedModelActionTypes.FETCH_LAST_NHIS_SPECIALTY_ATTENDED_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisSpecialtyAttendedAction>(modelAction.NhisSpecialtyAttendedModelActionTypes.CREATE_NHIS_SPECIALTY_ATTENDED),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as NhisSpecialtyAttendedModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisSpecialtyAttendedActionOK(
						modelAction.NhisSpecialtyAttendedModelActionTypes.CREATE_NHIS_SPECIALTY_ATTENDED_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisSpecialtyAttendedActionFail(
								modelAction.NhisSpecialtyAttendedModelActionTypes.CREATE_NHIS_SPECIALTY_ATTENDED_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisSpecialtyAttendedAction>(modelAction.NhisSpecialtyAttendedModelActionTypes.CREATE_ALL_NHIS_SPECIALTY_ATTENDED),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as NhisSpecialtyAttendedModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisSpecialtyAttendedActionOK(
						modelAction.NhisSpecialtyAttendedModelActionTypes.CREATE_ALL_NHIS_SPECIALTY_ATTENDED_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisSpecialtyAttendedActionFail(
								modelAction.NhisSpecialtyAttendedModelActionTypes.CREATE_ALL_NHIS_SPECIALTY_ATTENDED_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisSpecialtyAttendedAction>(modelAction.NhisSpecialtyAttendedModelActionTypes.UPDATE_NHIS_SPECIALTY_ATTENDED),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as NhisSpecialtyAttendedModel;
				...
				return this.service.update(new NhisSpecialtyAttendedModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisSpecialtyAttendedActionOK(
						modelAction.NhisSpecialtyAttendedModelActionTypes.UPDATE_NHIS_SPECIALTY_ATTENDED_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisSpecialtyAttendedActionFail(
								modelAction.NhisSpecialtyAttendedModelActionTypes.UPDATE_NHIS_SPECIALTY_ATTENDED_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisSpecialtyAttendedAction>(modelAction.NhisSpecialtyAttendedModelActionTypes.UPDATE_ALL_NHIS_SPECIALTY_ATTENDED),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as NhisSpecialtyAttendedModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new NhisSpecialtyAttendedModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisSpecialtyAttendedActionOK(
						modelAction.NhisSpecialtyAttendedModelActionTypes.UPDATE_ALL_NHIS_SPECIALTY_ATTENDED_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisSpecialtyAttendedActionFail(
								modelAction.NhisSpecialtyAttendedModelActionTypes.UPDATE_ALL_NHIS_SPECIALTY_ATTENDED_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisSpecialtyAttendedAction>(modelAction.NhisSpecialtyAttendedModelActionTypes.DELETE_NHIS_SPECIALTY_ATTENDED),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.NhisSpecialtyAttendedActionOK(
						modelAction.NhisSpecialtyAttendedModelActionTypes.DELETE_NHIS_SPECIALTY_ATTENDED_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisSpecialtyAttendedActionFail(
								modelAction.NhisSpecialtyAttendedModelActionTypes.DELETE_NHIS_SPECIALTY_ATTENDED_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisSpecialtyAttendedAction>(modelAction.NhisSpecialtyAttendedModelActionTypes.DELETE_NHIS_SPECIALTY_ATTENDED_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.NhisSpecialtyAttendedActionOK(
						modelAction.NhisSpecialtyAttendedModelActionTypes.DELETE_NHIS_SPECIALTY_ATTENDED_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisSpecialtyAttendedActionFail(
								modelAction.NhisSpecialtyAttendedModelActionTypes.DELETE_NHIS_SPECIALTY_ATTENDED_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisSpecialtyAttendedAction>(modelAction.NhisSpecialtyAttendedModelActionTypes.DELETE_ALL_NHIS_SPECIALTY_ATTENDED),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.NhisSpecialtyAttendedActionOK(
						modelAction.NhisSpecialtyAttendedModelActionTypes.DELETE_ALL_NHIS_SPECIALTY_ATTENDED_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisSpecialtyAttendedActionFail(
								modelAction.NhisSpecialtyAttendedModelActionTypes.DELETE_ALL_NHIS_SPECIALTY_ATTENDED_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisSpecialtyAttendedAction>(modelAction.NhisSpecialtyAttendedModelActionTypes.EXPORT_NHIS_SPECIALTY_ATTENDED),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.NhisSpecialtyAttendedActionOK(
						modelAction.NhisSpecialtyAttendedModelActionTypes.EXPORT_NHIS_SPECIALTY_ATTENDED,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisSpecialtyAttendedAction>(modelAction.NhisSpecialtyAttendedModelActionTypes.EXPORT_ALL_NHIS_SPECIALTY_ATTENDED),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.NhisSpecialtyAttendedActionOK(
						modelAction.NhisSpecialtyAttendedModelActionTypes.EXPORT_ALL_NHIS_SPECIALTY_ATTENDED_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisSpecialtyAttendedActionFail(
								modelAction.NhisSpecialtyAttendedModelActionTypes.EXPORT_ALL_NHIS_SPECIALTY_ATTENDED_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisSpecialtyAttendedAction>(modelAction.NhisSpecialtyAttendedModelActionTypes.EXPORT_NHIS_SPECIALTY_ATTENDED_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.NhisSpecialtyAttendedActionOK(
						modelAction.NhisSpecialtyAttendedModelActionTypes.EXPORT_NHIS_SPECIALTY_ATTENDED_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisSpecialtyAttendedActionFail(
								modelAction.NhisSpecialtyAttendedModelActionTypes.EXPORT_NHIS_SPECIALTY_ATTENDED_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisSpecialtyAttendedAction>(modelAction.NhisSpecialtyAttendedModelActionTypes.IMPORT_NHIS_SPECIALTY_ATTENDEDS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.NhisSpecialtyAttendedActionOK(
						modelAction.NhisSpecialtyAttendedModelActionTypes.IMPORT_NHIS_SPECIALTY_ATTENDEDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisSpecialtyAttendedActionFail(
								modelAction.NhisSpecialtyAttendedModelActionTypes.IMPORT_NHIS_SPECIALTY_ATTENDEDS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisSpecialtyAttendedAction>(modelAction.NhisSpecialtyAttendedModelActionTypes.FETCH_NHIS_SPECIALTY_ATTENDED_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.NhisSpecialtyAttendedActionOK(
						modelAction.NhisSpecialtyAttendedModelActionTypes.FETCH_NHIS_SPECIALTY_ATTENDED_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.NhisSpecialtyAttendedActionFail(
								modelAction.NhisSpecialtyAttendedModelActionTypes.FETCH_NHIS_SPECIALTY_ATTENDED_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisSpecialtyAttendedAction>(modelAction.NhisSpecialtyAttendedModelActionTypes.FETCH_NHIS_SPECIALTY_ATTENDED_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.NhisSpecialtyAttendedActionOK(
						modelAction.NhisSpecialtyAttendedModelActionTypes.FETCH_NHIS_SPECIALTY_ATTENDED_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.NhisSpecialtyAttendedActionFail(
								modelAction.NhisSpecialtyAttendedModelActionTypes.FETCH_NHIS_SPECIALTY_ATTENDED_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
