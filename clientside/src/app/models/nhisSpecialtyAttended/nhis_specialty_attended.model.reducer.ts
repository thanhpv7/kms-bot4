...
import {initialNhisSpecialtyAttendedCollectionState} from './nhis_specialty_attended.model.state';
...
export function modelReducer(currentState: ModelState, action: Action): ModelState {
	...
	const className = (action as modelAction.BaseNhisSpecialtyAttendedAction).className;
	...
	return produce(currentState, draft => {
		...
		switch (action.type) {
			case modelAction.NhisSpecialtyAttendedModelActionTypes.CREATE_NHIS_SPECIALTY_ATTENDED_OK:
				const createdModel = (action as modelAction.NhisSpecialtyAttendedActionOK ).stateConfig.targetModel;
				...
				NhisSpecialtyAttendedModel.deepParse(createdModel).forEach(model => {
				...
				break;
			case modelAction.NhisSpecialtyAttendedModelActionTypes.CREATE_NHIS_SPECIALTY_ATTENDED_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.NhisSpecialtyAttendedModelActionTypes.CREATE_ALL_NHIS_SPECIALTY_ATTENDED_OK:
				const createdModels = (action as modelAction.NhisSpecialtyAttendedActionOK).stateConfig.targetModels;
				const collectionIdAfterCreateAll = (action as modelAction.NhisSpecialtyAttendedActionOK).stateConfig.collectionId;
				...
				createdModels.forEach((m) => {
					NhisSpecialtyAttendedModel.deepParse(m).forEach(model => {
						draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
						(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
					});
				});
				...
				break;
			case modelAction.NhisSpecialtyAttendedModelActionTypes.CREATE_ALL_NHIS_SPECIALTY_ATTENDED_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.NhisSpecialtyAttendedModelActionTypes.DELETE_NHIS_SPECIALTY_ATTENDED_OK:
				const deletedModelId = (action as modelAction.NhisSpecialtyAttendedActionOK).stateConfig.targetModelId;
				const collectionIdAfterDelete = (action as modelAction.NhisSpecialtyAttendedActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.NhisSpecialtyAttendedModelActionTypes.DELETE_ALL_NHIS_SPECIALTY_ATTENDED_OK:
				const deletedModelIds = (action as modelAction.NhisSpecialtyAttendedActionOK).stateConfig.targetModelIds;
				const collectionIdAfterDeleteAll = (action as modelAction.NhisSpecialtyAttendedActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.NhisSpecialtyAttendedModelActionTypes.DELETE_NHIS_SPECIALTY_ATTENDED_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.NhisSpecialtyAttendedModelActionTypes.UPDATE_NHIS_SPECIALTY_ATTENDED_OK:
				const updatedModel = (action as modelAction.NhisSpecialtyAttendedActionOK).stateConfig.targetModel;
				...
				NhisSpecialtyAttendedModel.deepParse(updatedModel).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.NhisSpecialtyAttendedModelActionTypes.UPDATE_NHIS_SPECIALTY_ATTENDED_FAIL:
				// TODO: Add handling of failure
				break;

			case modelAction.NhisSpecialtyAttendedModelActionTypes.UPDATE_ALL_NHIS_SPECIALTY_ATTENDED_OK:
				const updatedModels = (action as modelAction.NhisSpecialtyAttendedActionOK).stateConfig.targetModels;
				const collectionIdAfterUpdateAll = (action as modelAction.NhisSpecialtyAttendedActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.NhisSpecialtyAttendedModelActionTypes.UPDATE_ALL_NHIS_SPECIALTY_ATTENDED_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.NhisSpecialtyAttendedModelActionTypes.FETCH_NHIS_SPECIALTY_ATTENDED_OK:
				let fetchedModel = (action as modelAction.NhisSpecialtyAttendedActionOK).stateConfig.targetModel;
				...
				NhisSpecialtyAttendedModel.deepParse(fetchedModel).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.NhisSpecialtyAttendedModelActionTypes.FETCH_ALL_NHIS_SPECIALTY_ATTENDED_OK:
				const totalCountAfterFetchAll = (action as modelAction.NhisSpecialtyAttendedActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchAll = (action as modelAction.NhisSpecialtyAttendedActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchAll = (action as modelAction.NhisSpecialtyAttendedActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchAll = (action as modelAction.NhisSpecialtyAttendedActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchAll.map(model => NhisSpecialtyAttendedModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.NhisSpecialtyAttendedModelActionTypes.FETCH_NHIS_SPECIALTY_ATTENDED_AUDIT_OK:
				const audits = (action as modelAction.NhisSpecialtyAttendedActionOK).audits;
				...
				break;
			case modelAction.NhisSpecialtyAttendedModelActionTypes.FETCH_NHIS_SPECIALTY_ATTENDED_AUDITS_BY_ENTITY_ID_OK:
				const auditsByEntityId = (action as modelAction.NhisSpecialtyAttendedActionOK).audits;
				...
				break;
			case modelAction.NhisSpecialtyAttendedModelActionTypes.FETCH_NHIS_SPECIALTY_ATTENDED_WITH_QUERY_OK:
				const totalCountAfterFetchWithQuery = (action as modelAction.NhisSpecialtyAttendedActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchWithQuery = (action as modelAction.NhisSpecialtyAttendedActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchWithQuery = (action as modelAction.NhisSpecialtyAttendedActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchWithQuery = (action as modelAction.NhisSpecialtyAttendedActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchWithQuery.map(model => NhisSpecialtyAttendedModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.NhisSpecialtyAttendedModelActionTypes.FETCH_LAST_NHIS_SPECIALTY_ATTENDED_WITH_QUERY_OK:
				const totalCountAfterFetchLastWithQuery = (action as modelAction.NhisSpecialtyAttendedActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchLastWithQuery = (action as modelAction.NhisSpecialtyAttendedActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchLastWithQuery = (action as modelAction.NhisSpecialtyAttendedActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchLastWithQuery = (action as modelAction.NhisSpecialtyAttendedActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchLastWithQuery.map(model => NhisSpecialtyAttendedModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.NhisSpecialtyAttendedModelActionTypes.COUNT_NHIS_SPECIALTY_ATTENDEDS_OK:
				const totalCountAfterCount = (action as modelAction.NhisSpecialtyAttendedActionOK).stateConfig.totalCount;
				...
				break;
			case modelAction.NhisSpecialtyAttendedModelActionTypes.INITIALISE_NHIS_SPECIALTY_ATTENDED_COLLECTION_STATE:
				const collectionIdToInitialise =  (action as modelAction.NhisSpecialtyAttendedActionOK).stateConfig.collectionId;
				const queryParamsToInitialise = (action as modelAction.NhisSpecialtyAttendedActionOK).stateConfig.queryParams;
				...
				if (!draft[className].collectionState[collectionIdToInitialise]) {
					draft[className].collectionState[collectionIdToInitialise] = {
						...initialNhisSpecialtyAttendedCollectionState
					};
				}
