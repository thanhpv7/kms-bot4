...
/**
 * DailyCareCPPTCollectionState would store the state of a collection of DailyCareCPPT
 */
export interface DailyCareCPPTCollectionState extends CollectionState {
 ...
 */
export interface DailyCareCPPTModelAudit extends AbstractModelAudit<DailyCareCPPTModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * DailyCareCPPTModelState would store the state of the model
 */
export interface DailyCareCPPTModelState {
	collectionState: {
		[key: string]: DailyCareCPPTCollectionState;
	};
	data: {
		[id: string]: DailyCareCPPTModel;
	};
	totalCount: number;
	audits: DailyCareCPPTModelAudit[];
 ...
 */
export const initialDailyCareCPPTCollectionState: DailyCareCPPTCollectionState = {
...
/**
 * The initial state of DailyCareCPPTModelState
 */
export const initialState: DailyCareCPPTModelState = {
	collectionState: {
