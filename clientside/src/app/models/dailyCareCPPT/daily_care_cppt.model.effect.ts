...
import * as modelAction from './daily_care_cppt.model.action';
import {DailyCareCPPTService} from '../../services/dailyCareCPPT/daily_care_cppt.service';
...
/**
 * Effect class used for side effects related to Daily Care CPPT model.
 */
@Injectable()
export class DailyCareCPPTEffect {
	...
	constructor(
		...
		protected readonly service: DailyCareCPPTService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DailyCareCPPTAction>(modelAction.DailyCareCPPTModelActionTypes.COUNT_DAILY_CARE_CPPTS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.DailyCareCPPTActionOK(
						modelAction.DailyCareCPPTModelActionTypes.COUNT_DAILY_CARE_CPPTS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DailyCareCPPTActionFail(
								modelAction.DailyCareCPPTModelActionTypes.COUNT_DAILY_CARE_CPPTS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DailyCareCPPTAction>(modelAction.DailyCareCPPTModelActionTypes.FETCH_DAILY_CARE_CPPT),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.DailyCareCPPTActionOK(
						modelAction.DailyCareCPPTModelActionTypes.FETCH_DAILY_CARE_CPPT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DailyCareCPPTActionFail(
								modelAction.DailyCareCPPTModelActionTypes.FETCH_DAILY_CARE_CPPT_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DailyCareCPPTAction>(modelAction.DailyCareCPPTModelActionTypes.FETCH_ALL_DAILY_CARE_CPPT),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.DailyCareCPPTActionOK(
						modelAction.DailyCareCPPTModelActionTypes.FETCH_ALL_DAILY_CARE_CPPT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DailyCareCPPTActionFail(
								modelAction.DailyCareCPPTModelActionTypes.FETCH_ALL_DAILY_CARE_CPPT_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DailyCareCPPTAction>(modelAction.DailyCareCPPTModelActionTypes.FETCH_DAILY_CARE_CPPT_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.DailyCareCPPTActionOK(
						modelAction.DailyCareCPPTModelActionTypes.FETCH_DAILY_CARE_CPPT_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DailyCareCPPTActionFail(
								modelAction.DailyCareCPPTModelActionTypes.FETCH_DAILY_CARE_CPPT_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DailyCareCPPTAction>(modelAction.DailyCareCPPTModelActionTypes.FETCH_LAST_DAILY_CARE_CPPT_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.DailyCareCPPTActionOK(
						modelAction.DailyCareCPPTModelActionTypes.FETCH_LAST_DAILY_CARE_CPPT_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DailyCareCPPTActionFail(
								modelAction.DailyCareCPPTModelActionTypes.FETCH_LAST_DAILY_CARE_CPPT_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DailyCareCPPTAction>(modelAction.DailyCareCPPTModelActionTypes.CREATE_DAILY_CARE_CPPT),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as DailyCareCPPTModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.DailyCareCPPTActionOK(
						modelAction.DailyCareCPPTModelActionTypes.CREATE_DAILY_CARE_CPPT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DailyCareCPPTActionFail(
								modelAction.DailyCareCPPTModelActionTypes.CREATE_DAILY_CARE_CPPT_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DailyCareCPPTAction>(modelAction.DailyCareCPPTModelActionTypes.CREATE_ALL_DAILY_CARE_CPPT),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as DailyCareCPPTModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.DailyCareCPPTActionOK(
						modelAction.DailyCareCPPTModelActionTypes.CREATE_ALL_DAILY_CARE_CPPT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DailyCareCPPTActionFail(
								modelAction.DailyCareCPPTModelActionTypes.CREATE_ALL_DAILY_CARE_CPPT_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DailyCareCPPTAction>(modelAction.DailyCareCPPTModelActionTypes.UPDATE_DAILY_CARE_CPPT),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as DailyCareCPPTModel;
				...
				return this.service.update(new DailyCareCPPTModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.DailyCareCPPTActionOK(
						modelAction.DailyCareCPPTModelActionTypes.UPDATE_DAILY_CARE_CPPT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DailyCareCPPTActionFail(
								modelAction.DailyCareCPPTModelActionTypes.UPDATE_DAILY_CARE_CPPT_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DailyCareCPPTAction>(modelAction.DailyCareCPPTModelActionTypes.UPDATE_ALL_DAILY_CARE_CPPT),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as DailyCareCPPTModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new DailyCareCPPTModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.DailyCareCPPTActionOK(
						modelAction.DailyCareCPPTModelActionTypes.UPDATE_ALL_DAILY_CARE_CPPT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DailyCareCPPTActionFail(
								modelAction.DailyCareCPPTModelActionTypes.UPDATE_ALL_DAILY_CARE_CPPT_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DailyCareCPPTAction>(modelAction.DailyCareCPPTModelActionTypes.DELETE_DAILY_CARE_CPPT),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.DailyCareCPPTActionOK(
						modelAction.DailyCareCPPTModelActionTypes.DELETE_DAILY_CARE_CPPT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DailyCareCPPTActionFail(
								modelAction.DailyCareCPPTModelActionTypes.DELETE_DAILY_CARE_CPPT_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DailyCareCPPTAction>(modelAction.DailyCareCPPTModelActionTypes.DELETE_DAILY_CARE_CPPT_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.DailyCareCPPTActionOK(
						modelAction.DailyCareCPPTModelActionTypes.DELETE_DAILY_CARE_CPPT_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DailyCareCPPTActionFail(
								modelAction.DailyCareCPPTModelActionTypes.DELETE_DAILY_CARE_CPPT_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DailyCareCPPTAction>(modelAction.DailyCareCPPTModelActionTypes.DELETE_ALL_DAILY_CARE_CPPT),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.DailyCareCPPTActionOK(
						modelAction.DailyCareCPPTModelActionTypes.DELETE_ALL_DAILY_CARE_CPPT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DailyCareCPPTActionFail(
								modelAction.DailyCareCPPTModelActionTypes.DELETE_ALL_DAILY_CARE_CPPT_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DailyCareCPPTAction>(modelAction.DailyCareCPPTModelActionTypes.EXPORT_DAILY_CARE_CPPT),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.DailyCareCPPTActionOK(
						modelAction.DailyCareCPPTModelActionTypes.EXPORT_DAILY_CARE_CPPT,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DailyCareCPPTAction>(modelAction.DailyCareCPPTModelActionTypes.EXPORT_ALL_DAILY_CARE_CPPT),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.DailyCareCPPTActionOK(
						modelAction.DailyCareCPPTModelActionTypes.EXPORT_ALL_DAILY_CARE_CPPT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DailyCareCPPTActionFail(
								modelAction.DailyCareCPPTModelActionTypes.EXPORT_ALL_DAILY_CARE_CPPT_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DailyCareCPPTAction>(modelAction.DailyCareCPPTModelActionTypes.EXPORT_DAILY_CARE_CPPT_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.DailyCareCPPTActionOK(
						modelAction.DailyCareCPPTModelActionTypes.EXPORT_DAILY_CARE_CPPT_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DailyCareCPPTActionFail(
								modelAction.DailyCareCPPTModelActionTypes.EXPORT_DAILY_CARE_CPPT_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DailyCareCPPTAction>(modelAction.DailyCareCPPTModelActionTypes.IMPORT_DAILY_CARE_CPPTS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.DailyCareCPPTActionOK(
						modelAction.DailyCareCPPTModelActionTypes.IMPORT_DAILY_CARE_CPPTS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DailyCareCPPTActionFail(
								modelAction.DailyCareCPPTModelActionTypes.IMPORT_DAILY_CARE_CPPTS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DailyCareCPPTAction>(modelAction.DailyCareCPPTModelActionTypes.FETCH_DAILY_CARE_CPPT_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.DailyCareCPPTActionOK(
						modelAction.DailyCareCPPTModelActionTypes.FETCH_DAILY_CARE_CPPT_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.DailyCareCPPTActionFail(
								modelAction.DailyCareCPPTModelActionTypes.FETCH_DAILY_CARE_CPPT_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DailyCareCPPTAction>(modelAction.DailyCareCPPTModelActionTypes.FETCH_DAILY_CARE_CPPT_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.DailyCareCPPTActionOK(
						modelAction.DailyCareCPPTModelActionTypes.FETCH_DAILY_CARE_CPPT_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.DailyCareCPPTActionFail(
								modelAction.DailyCareCPPTModelActionTypes.FETCH_DAILY_CARE_CPPT_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
