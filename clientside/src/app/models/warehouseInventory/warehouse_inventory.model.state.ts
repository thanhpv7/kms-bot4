...
/**
 * WarehouseInventoryCollectionState would store the state of a collection of WarehouseInventory
 */
export interface WarehouseInventoryCollectionState extends CollectionState {
 ...
 */
export interface WarehouseInventoryModelAudit extends AbstractModelAudit<WarehouseInventoryModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * WarehouseInventoryModelState would store the state of the model
 */
export interface WarehouseInventoryModelState {
	collectionState: {
		[key: string]: WarehouseInventoryCollectionState;
	};
	data: {
		[id: string]: WarehouseInventoryModel;
	};
	totalCount: number;
	audits: WarehouseInventoryModelAudit[];
 ...
 */
export const initialWarehouseInventoryCollectionState: WarehouseInventoryCollectionState = {
...
/**
 * The initial state of WarehouseInventoryModelState
 */
export const initialState: WarehouseInventoryModelState = {
	collectionState: {
