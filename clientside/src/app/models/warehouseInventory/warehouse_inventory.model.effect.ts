...
import * as modelAction from './warehouse_inventory.model.action';
import {WarehouseInventoryService} from '../../services/warehouseInventory/warehouse_inventory.service';
...
/**
 * Effect class used for side effects related to Warehouse Inventory model.
 */
@Injectable()
export class WarehouseInventoryEffect {
	...
	constructor(
		...
		protected readonly service: WarehouseInventoryService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseInventoryAction>(modelAction.WarehouseInventoryModelActionTypes.COUNT_WAREHOUSE_INVENTORYS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.WarehouseInventoryActionOK(
						modelAction.WarehouseInventoryModelActionTypes.COUNT_WAREHOUSE_INVENTORYS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseInventoryActionFail(
								modelAction.WarehouseInventoryModelActionTypes.COUNT_WAREHOUSE_INVENTORYS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseInventoryAction>(modelAction.WarehouseInventoryModelActionTypes.FETCH_WAREHOUSE_INVENTORY),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.WarehouseInventoryActionOK(
						modelAction.WarehouseInventoryModelActionTypes.FETCH_WAREHOUSE_INVENTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseInventoryActionFail(
								modelAction.WarehouseInventoryModelActionTypes.FETCH_WAREHOUSE_INVENTORY_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseInventoryAction>(modelAction.WarehouseInventoryModelActionTypes.FETCH_ALL_WAREHOUSE_INVENTORY),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.WarehouseInventoryActionOK(
						modelAction.WarehouseInventoryModelActionTypes.FETCH_ALL_WAREHOUSE_INVENTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseInventoryActionFail(
								modelAction.WarehouseInventoryModelActionTypes.FETCH_ALL_WAREHOUSE_INVENTORY_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseInventoryAction>(modelAction.WarehouseInventoryModelActionTypes.FETCH_WAREHOUSE_INVENTORY_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.WarehouseInventoryActionOK(
						modelAction.WarehouseInventoryModelActionTypes.FETCH_WAREHOUSE_INVENTORY_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseInventoryActionFail(
								modelAction.WarehouseInventoryModelActionTypes.FETCH_WAREHOUSE_INVENTORY_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseInventoryAction>(modelAction.WarehouseInventoryModelActionTypes.FETCH_LAST_WAREHOUSE_INVENTORY_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.WarehouseInventoryActionOK(
						modelAction.WarehouseInventoryModelActionTypes.FETCH_LAST_WAREHOUSE_INVENTORY_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseInventoryActionFail(
								modelAction.WarehouseInventoryModelActionTypes.FETCH_LAST_WAREHOUSE_INVENTORY_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseInventoryAction>(modelAction.WarehouseInventoryModelActionTypes.CREATE_WAREHOUSE_INVENTORY),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as WarehouseInventoryModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.WarehouseInventoryActionOK(
						modelAction.WarehouseInventoryModelActionTypes.CREATE_WAREHOUSE_INVENTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseInventoryActionFail(
								modelAction.WarehouseInventoryModelActionTypes.CREATE_WAREHOUSE_INVENTORY_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseInventoryAction>(modelAction.WarehouseInventoryModelActionTypes.CREATE_ALL_WAREHOUSE_INVENTORY),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as WarehouseInventoryModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.WarehouseInventoryActionOK(
						modelAction.WarehouseInventoryModelActionTypes.CREATE_ALL_WAREHOUSE_INVENTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseInventoryActionFail(
								modelAction.WarehouseInventoryModelActionTypes.CREATE_ALL_WAREHOUSE_INVENTORY_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseInventoryAction>(modelAction.WarehouseInventoryModelActionTypes.UPDATE_WAREHOUSE_INVENTORY),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as WarehouseInventoryModel;
				...
				return this.service.update(new WarehouseInventoryModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.WarehouseInventoryActionOK(
						modelAction.WarehouseInventoryModelActionTypes.UPDATE_WAREHOUSE_INVENTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseInventoryActionFail(
								modelAction.WarehouseInventoryModelActionTypes.UPDATE_WAREHOUSE_INVENTORY_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseInventoryAction>(modelAction.WarehouseInventoryModelActionTypes.UPDATE_ALL_WAREHOUSE_INVENTORY),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as WarehouseInventoryModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new WarehouseInventoryModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.WarehouseInventoryActionOK(
						modelAction.WarehouseInventoryModelActionTypes.UPDATE_ALL_WAREHOUSE_INVENTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseInventoryActionFail(
								modelAction.WarehouseInventoryModelActionTypes.UPDATE_ALL_WAREHOUSE_INVENTORY_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseInventoryAction>(modelAction.WarehouseInventoryModelActionTypes.DELETE_WAREHOUSE_INVENTORY),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.WarehouseInventoryActionOK(
						modelAction.WarehouseInventoryModelActionTypes.DELETE_WAREHOUSE_INVENTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseInventoryActionFail(
								modelAction.WarehouseInventoryModelActionTypes.DELETE_WAREHOUSE_INVENTORY_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseInventoryAction>(modelAction.WarehouseInventoryModelActionTypes.DELETE_WAREHOUSE_INVENTORY_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.WarehouseInventoryActionOK(
						modelAction.WarehouseInventoryModelActionTypes.DELETE_WAREHOUSE_INVENTORY_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseInventoryActionFail(
								modelAction.WarehouseInventoryModelActionTypes.DELETE_WAREHOUSE_INVENTORY_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseInventoryAction>(modelAction.WarehouseInventoryModelActionTypes.DELETE_ALL_WAREHOUSE_INVENTORY),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.WarehouseInventoryActionOK(
						modelAction.WarehouseInventoryModelActionTypes.DELETE_ALL_WAREHOUSE_INVENTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseInventoryActionFail(
								modelAction.WarehouseInventoryModelActionTypes.DELETE_ALL_WAREHOUSE_INVENTORY_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseInventoryAction>(modelAction.WarehouseInventoryModelActionTypes.EXPORT_WAREHOUSE_INVENTORY),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.WarehouseInventoryActionOK(
						modelAction.WarehouseInventoryModelActionTypes.EXPORT_WAREHOUSE_INVENTORY,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseInventoryAction>(modelAction.WarehouseInventoryModelActionTypes.EXPORT_ALL_WAREHOUSE_INVENTORY),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.WarehouseInventoryActionOK(
						modelAction.WarehouseInventoryModelActionTypes.EXPORT_ALL_WAREHOUSE_INVENTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseInventoryActionFail(
								modelAction.WarehouseInventoryModelActionTypes.EXPORT_ALL_WAREHOUSE_INVENTORY_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseInventoryAction>(modelAction.WarehouseInventoryModelActionTypes.EXPORT_WAREHOUSE_INVENTORY_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.WarehouseInventoryActionOK(
						modelAction.WarehouseInventoryModelActionTypes.EXPORT_WAREHOUSE_INVENTORY_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseInventoryActionFail(
								modelAction.WarehouseInventoryModelActionTypes.EXPORT_WAREHOUSE_INVENTORY_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseInventoryAction>(modelAction.WarehouseInventoryModelActionTypes.IMPORT_WAREHOUSE_INVENTORYS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.WarehouseInventoryActionOK(
						modelAction.WarehouseInventoryModelActionTypes.IMPORT_WAREHOUSE_INVENTORYS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseInventoryActionFail(
								modelAction.WarehouseInventoryModelActionTypes.IMPORT_WAREHOUSE_INVENTORYS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseInventoryAction>(modelAction.WarehouseInventoryModelActionTypes.FETCH_WAREHOUSE_INVENTORY_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.WarehouseInventoryActionOK(
						modelAction.WarehouseInventoryModelActionTypes.FETCH_WAREHOUSE_INVENTORY_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseInventoryActionFail(
								modelAction.WarehouseInventoryModelActionTypes.FETCH_WAREHOUSE_INVENTORY_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.WarehouseInventoryAction>(modelAction.WarehouseInventoryModelActionTypes.FETCH_WAREHOUSE_INVENTORY_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.WarehouseInventoryActionOK(
						modelAction.WarehouseInventoryModelActionTypes.FETCH_WAREHOUSE_INVENTORY_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.WarehouseInventoryActionFail(
								modelAction.WarehouseInventoryModelActionTypes.FETCH_WAREHOUSE_INVENTORY_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
