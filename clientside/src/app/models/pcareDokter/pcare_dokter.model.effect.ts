...
import * as modelAction from './pcare_dokter.model.action';
import {PcareDokterService} from '../../services/pcareDokter/pcare_dokter.service';
...
/**
 * Effect class used for side effects related to PCare Dokter model.
 */
@Injectable()
export class PcareDokterEffect {
	...
	constructor(
		...
		protected readonly service: PcareDokterService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareDokterAction>(modelAction.PcareDokterModelActionTypes.COUNT_PCARE_DOKTERS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.PcareDokterActionOK(
						modelAction.PcareDokterModelActionTypes.COUNT_PCARE_DOKTERS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareDokterActionFail(
								modelAction.PcareDokterModelActionTypes.COUNT_PCARE_DOKTERS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareDokterAction>(modelAction.PcareDokterModelActionTypes.FETCH_PCARE_DOKTER),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareDokterActionOK(
						modelAction.PcareDokterModelActionTypes.FETCH_PCARE_DOKTER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareDokterActionFail(
								modelAction.PcareDokterModelActionTypes.FETCH_PCARE_DOKTER_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareDokterAction>(modelAction.PcareDokterModelActionTypes.FETCH_ALL_PCARE_DOKTER),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.PcareDokterActionOK(
						modelAction.PcareDokterModelActionTypes.FETCH_ALL_PCARE_DOKTER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareDokterActionFail(
								modelAction.PcareDokterModelActionTypes.FETCH_ALL_PCARE_DOKTER_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareDokterAction>(modelAction.PcareDokterModelActionTypes.FETCH_PCARE_DOKTER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareDokterActionOK(
						modelAction.PcareDokterModelActionTypes.FETCH_PCARE_DOKTER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareDokterActionFail(
								modelAction.PcareDokterModelActionTypes.FETCH_PCARE_DOKTER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareDokterAction>(modelAction.PcareDokterModelActionTypes.FETCH_LAST_PCARE_DOKTER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareDokterActionOK(
						modelAction.PcareDokterModelActionTypes.FETCH_LAST_PCARE_DOKTER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareDokterActionFail(
								modelAction.PcareDokterModelActionTypes.FETCH_LAST_PCARE_DOKTER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareDokterAction>(modelAction.PcareDokterModelActionTypes.CREATE_PCARE_DOKTER),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as PcareDokterModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareDokterActionOK(
						modelAction.PcareDokterModelActionTypes.CREATE_PCARE_DOKTER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareDokterActionFail(
								modelAction.PcareDokterModelActionTypes.CREATE_PCARE_DOKTER_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareDokterAction>(modelAction.PcareDokterModelActionTypes.CREATE_ALL_PCARE_DOKTER),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as PcareDokterModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareDokterActionOK(
						modelAction.PcareDokterModelActionTypes.CREATE_ALL_PCARE_DOKTER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareDokterActionFail(
								modelAction.PcareDokterModelActionTypes.CREATE_ALL_PCARE_DOKTER_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareDokterAction>(modelAction.PcareDokterModelActionTypes.UPDATE_PCARE_DOKTER),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as PcareDokterModel;
				...
				return this.service.update(new PcareDokterModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareDokterActionOK(
						modelAction.PcareDokterModelActionTypes.UPDATE_PCARE_DOKTER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareDokterActionFail(
								modelAction.PcareDokterModelActionTypes.UPDATE_PCARE_DOKTER_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareDokterAction>(modelAction.PcareDokterModelActionTypes.UPDATE_ALL_PCARE_DOKTER),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as PcareDokterModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new PcareDokterModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareDokterActionOK(
						modelAction.PcareDokterModelActionTypes.UPDATE_ALL_PCARE_DOKTER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareDokterActionFail(
								modelAction.PcareDokterModelActionTypes.UPDATE_ALL_PCARE_DOKTER_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareDokterAction>(modelAction.PcareDokterModelActionTypes.DELETE_PCARE_DOKTER),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PcareDokterActionOK(
						modelAction.PcareDokterModelActionTypes.DELETE_PCARE_DOKTER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareDokterActionFail(
								modelAction.PcareDokterModelActionTypes.DELETE_PCARE_DOKTER_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareDokterAction>(modelAction.PcareDokterModelActionTypes.DELETE_PCARE_DOKTER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.PcareDokterActionOK(
						modelAction.PcareDokterModelActionTypes.DELETE_PCARE_DOKTER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareDokterActionFail(
								modelAction.PcareDokterModelActionTypes.DELETE_PCARE_DOKTER_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareDokterAction>(modelAction.PcareDokterModelActionTypes.DELETE_ALL_PCARE_DOKTER),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PcareDokterActionOK(
						modelAction.PcareDokterModelActionTypes.DELETE_ALL_PCARE_DOKTER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareDokterActionFail(
								modelAction.PcareDokterModelActionTypes.DELETE_ALL_PCARE_DOKTER_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareDokterAction>(modelAction.PcareDokterModelActionTypes.EXPORT_PCARE_DOKTER),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PcareDokterActionOK(
						modelAction.PcareDokterModelActionTypes.EXPORT_PCARE_DOKTER,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareDokterAction>(modelAction.PcareDokterModelActionTypes.EXPORT_ALL_PCARE_DOKTER),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PcareDokterActionOK(
						modelAction.PcareDokterModelActionTypes.EXPORT_ALL_PCARE_DOKTER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareDokterActionFail(
								modelAction.PcareDokterModelActionTypes.EXPORT_ALL_PCARE_DOKTER_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareDokterAction>(modelAction.PcareDokterModelActionTypes.EXPORT_PCARE_DOKTER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PcareDokterActionOK(
						modelAction.PcareDokterModelActionTypes.EXPORT_PCARE_DOKTER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareDokterActionFail(
								modelAction.PcareDokterModelActionTypes.EXPORT_PCARE_DOKTER_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareDokterAction>(modelAction.PcareDokterModelActionTypes.IMPORT_PCARE_DOKTERS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.PcareDokterActionOK(
						modelAction.PcareDokterModelActionTypes.IMPORT_PCARE_DOKTERS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareDokterActionFail(
								modelAction.PcareDokterModelActionTypes.IMPORT_PCARE_DOKTERS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareDokterAction>(modelAction.PcareDokterModelActionTypes.FETCH_PCARE_DOKTER_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.PcareDokterActionOK(
						modelAction.PcareDokterModelActionTypes.FETCH_PCARE_DOKTER_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PcareDokterActionFail(
								modelAction.PcareDokterModelActionTypes.FETCH_PCARE_DOKTER_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareDokterAction>(modelAction.PcareDokterModelActionTypes.FETCH_PCARE_DOKTER_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.PcareDokterActionOK(
						modelAction.PcareDokterModelActionTypes.FETCH_PCARE_DOKTER_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PcareDokterActionFail(
								modelAction.PcareDokterModelActionTypes.FETCH_PCARE_DOKTER_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
