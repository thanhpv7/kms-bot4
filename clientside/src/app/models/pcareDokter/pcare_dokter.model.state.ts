...
/**
 * PcareDokterCollectionState would store the state of a collection of PcareDokter
 */
export interface PcareDokterCollectionState extends CollectionState {
 ...
 */
export interface PcareDokterModelAudit extends AbstractModelAudit<PcareDokterModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * PcareDokterModelState would store the state of the model
 */
export interface PcareDokterModelState {
	collectionState: {
		[key: string]: PcareDokterCollectionState;
	};
	data: {
		[id: string]: PcareDokterModel;
	};
	totalCount: number;
	audits: PcareDokterModelAudit[];
 ...
 */
export const initialPcareDokterCollectionState: PcareDokterCollectionState = {
...
/**
 * The initial state of PcareDokterModelState
 */
export const initialState: PcareDokterModelState = {
	collectionState: {
