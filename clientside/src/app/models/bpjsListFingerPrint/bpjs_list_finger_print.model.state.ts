...
/**
 * BpjsListFingerPrintCollectionState would store the state of a collection of BpjsListFingerPrint
 */
export interface BpjsListFingerPrintCollectionState extends CollectionState {
 ...
 */
export interface BpjsListFingerPrintModelAudit extends AbstractModelAudit<BpjsListFingerPrintModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsListFingerPrintModelState would store the state of the model
 */
export interface BpjsListFingerPrintModelState {
	collectionState: {
		[key: string]: BpjsListFingerPrintCollectionState;
	};
	data: {
		[id: string]: BpjsListFingerPrintModel;
	};
	totalCount: number;
	audits: BpjsListFingerPrintModelAudit[];
 ...
 */
export const initialBpjsListFingerPrintCollectionState: BpjsListFingerPrintCollectionState = {
...
/**
 * The initial state of BpjsListFingerPrintModelState
 */
export const initialState: BpjsListFingerPrintModelState = {
	collectionState: {
