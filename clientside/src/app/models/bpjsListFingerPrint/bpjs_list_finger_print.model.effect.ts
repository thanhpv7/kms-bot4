...
import * as modelAction from './bpjs_list_finger_print.model.action';
import {BpjsListFingerPrintService} from '../../services/bpjsListFingerPrint/bpjs_list_finger_print.service';
...
/**
 * Effect class used for side effects related to BPJS List Finger Print model.
 */
@Injectable()
export class BpjsListFingerPrintEffect {
	...
	constructor(
		...
		protected readonly service: BpjsListFingerPrintService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsListFingerPrintAction>(modelAction.BpjsListFingerPrintModelActionTypes.COUNT_BPJS_LIST_FINGER_PRINTS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsListFingerPrintActionOK(
						modelAction.BpjsListFingerPrintModelActionTypes.COUNT_BPJS_LIST_FINGER_PRINTS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsListFingerPrintActionFail(
								modelAction.BpjsListFingerPrintModelActionTypes.COUNT_BPJS_LIST_FINGER_PRINTS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsListFingerPrintAction>(modelAction.BpjsListFingerPrintModelActionTypes.FETCH_BPJS_LIST_FINGER_PRINT),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsListFingerPrintActionOK(
						modelAction.BpjsListFingerPrintModelActionTypes.FETCH_BPJS_LIST_FINGER_PRINT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsListFingerPrintActionFail(
								modelAction.BpjsListFingerPrintModelActionTypes.FETCH_BPJS_LIST_FINGER_PRINT_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsListFingerPrintAction>(modelAction.BpjsListFingerPrintModelActionTypes.FETCH_ALL_BPJS_LIST_FINGER_PRINT),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsListFingerPrintActionOK(
						modelAction.BpjsListFingerPrintModelActionTypes.FETCH_ALL_BPJS_LIST_FINGER_PRINT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsListFingerPrintActionFail(
								modelAction.BpjsListFingerPrintModelActionTypes.FETCH_ALL_BPJS_LIST_FINGER_PRINT_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsListFingerPrintAction>(modelAction.BpjsListFingerPrintModelActionTypes.FETCH_BPJS_LIST_FINGER_PRINT_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsListFingerPrintActionOK(
						modelAction.BpjsListFingerPrintModelActionTypes.FETCH_BPJS_LIST_FINGER_PRINT_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsListFingerPrintActionFail(
								modelAction.BpjsListFingerPrintModelActionTypes.FETCH_BPJS_LIST_FINGER_PRINT_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsListFingerPrintAction>(modelAction.BpjsListFingerPrintModelActionTypes.FETCH_LAST_BPJS_LIST_FINGER_PRINT_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsListFingerPrintActionOK(
						modelAction.BpjsListFingerPrintModelActionTypes.FETCH_LAST_BPJS_LIST_FINGER_PRINT_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsListFingerPrintActionFail(
								modelAction.BpjsListFingerPrintModelActionTypes.FETCH_LAST_BPJS_LIST_FINGER_PRINT_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsListFingerPrintAction>(modelAction.BpjsListFingerPrintModelActionTypes.CREATE_BPJS_LIST_FINGER_PRINT),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsListFingerPrintModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsListFingerPrintActionOK(
						modelAction.BpjsListFingerPrintModelActionTypes.CREATE_BPJS_LIST_FINGER_PRINT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsListFingerPrintActionFail(
								modelAction.BpjsListFingerPrintModelActionTypes.CREATE_BPJS_LIST_FINGER_PRINT_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsListFingerPrintAction>(modelAction.BpjsListFingerPrintModelActionTypes.CREATE_ALL_BPJS_LIST_FINGER_PRINT),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsListFingerPrintModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsListFingerPrintActionOK(
						modelAction.BpjsListFingerPrintModelActionTypes.CREATE_ALL_BPJS_LIST_FINGER_PRINT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsListFingerPrintActionFail(
								modelAction.BpjsListFingerPrintModelActionTypes.CREATE_ALL_BPJS_LIST_FINGER_PRINT_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsListFingerPrintAction>(modelAction.BpjsListFingerPrintModelActionTypes.UPDATE_BPJS_LIST_FINGER_PRINT),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsListFingerPrintModel;
				...
				return this.service.update(new BpjsListFingerPrintModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsListFingerPrintActionOK(
						modelAction.BpjsListFingerPrintModelActionTypes.UPDATE_BPJS_LIST_FINGER_PRINT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsListFingerPrintActionFail(
								modelAction.BpjsListFingerPrintModelActionTypes.UPDATE_BPJS_LIST_FINGER_PRINT_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsListFingerPrintAction>(modelAction.BpjsListFingerPrintModelActionTypes.UPDATE_ALL_BPJS_LIST_FINGER_PRINT),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsListFingerPrintModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsListFingerPrintModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsListFingerPrintActionOK(
						modelAction.BpjsListFingerPrintModelActionTypes.UPDATE_ALL_BPJS_LIST_FINGER_PRINT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsListFingerPrintActionFail(
								modelAction.BpjsListFingerPrintModelActionTypes.UPDATE_ALL_BPJS_LIST_FINGER_PRINT_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsListFingerPrintAction>(modelAction.BpjsListFingerPrintModelActionTypes.DELETE_BPJS_LIST_FINGER_PRINT),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsListFingerPrintActionOK(
						modelAction.BpjsListFingerPrintModelActionTypes.DELETE_BPJS_LIST_FINGER_PRINT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsListFingerPrintActionFail(
								modelAction.BpjsListFingerPrintModelActionTypes.DELETE_BPJS_LIST_FINGER_PRINT_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsListFingerPrintAction>(modelAction.BpjsListFingerPrintModelActionTypes.DELETE_BPJS_LIST_FINGER_PRINT_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsListFingerPrintActionOK(
						modelAction.BpjsListFingerPrintModelActionTypes.DELETE_BPJS_LIST_FINGER_PRINT_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsListFingerPrintActionFail(
								modelAction.BpjsListFingerPrintModelActionTypes.DELETE_BPJS_LIST_FINGER_PRINT_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsListFingerPrintAction>(modelAction.BpjsListFingerPrintModelActionTypes.DELETE_ALL_BPJS_LIST_FINGER_PRINT),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsListFingerPrintActionOK(
						modelAction.BpjsListFingerPrintModelActionTypes.DELETE_ALL_BPJS_LIST_FINGER_PRINT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsListFingerPrintActionFail(
								modelAction.BpjsListFingerPrintModelActionTypes.DELETE_ALL_BPJS_LIST_FINGER_PRINT_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsListFingerPrintAction>(modelAction.BpjsListFingerPrintModelActionTypes.EXPORT_BPJS_LIST_FINGER_PRINT),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsListFingerPrintActionOK(
						modelAction.BpjsListFingerPrintModelActionTypes.EXPORT_BPJS_LIST_FINGER_PRINT,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsListFingerPrintAction>(modelAction.BpjsListFingerPrintModelActionTypes.EXPORT_ALL_BPJS_LIST_FINGER_PRINT),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsListFingerPrintActionOK(
						modelAction.BpjsListFingerPrintModelActionTypes.EXPORT_ALL_BPJS_LIST_FINGER_PRINT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsListFingerPrintActionFail(
								modelAction.BpjsListFingerPrintModelActionTypes.EXPORT_ALL_BPJS_LIST_FINGER_PRINT_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsListFingerPrintAction>(modelAction.BpjsListFingerPrintModelActionTypes.EXPORT_BPJS_LIST_FINGER_PRINT_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsListFingerPrintActionOK(
						modelAction.BpjsListFingerPrintModelActionTypes.EXPORT_BPJS_LIST_FINGER_PRINT_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsListFingerPrintActionFail(
								modelAction.BpjsListFingerPrintModelActionTypes.EXPORT_BPJS_LIST_FINGER_PRINT_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsListFingerPrintAction>(modelAction.BpjsListFingerPrintModelActionTypes.IMPORT_BPJS_LIST_FINGER_PRINTS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsListFingerPrintActionOK(
						modelAction.BpjsListFingerPrintModelActionTypes.IMPORT_BPJS_LIST_FINGER_PRINTS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsListFingerPrintActionFail(
								modelAction.BpjsListFingerPrintModelActionTypes.IMPORT_BPJS_LIST_FINGER_PRINTS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsListFingerPrintAction>(modelAction.BpjsListFingerPrintModelActionTypes.FETCH_BPJS_LIST_FINGER_PRINT_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsListFingerPrintActionOK(
						modelAction.BpjsListFingerPrintModelActionTypes.FETCH_BPJS_LIST_FINGER_PRINT_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsListFingerPrintActionFail(
								modelAction.BpjsListFingerPrintModelActionTypes.FETCH_BPJS_LIST_FINGER_PRINT_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsListFingerPrintAction>(modelAction.BpjsListFingerPrintModelActionTypes.FETCH_BPJS_LIST_FINGER_PRINT_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsListFingerPrintActionOK(
						modelAction.BpjsListFingerPrintModelActionTypes.FETCH_BPJS_LIST_FINGER_PRINT_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsListFingerPrintActionFail(
								modelAction.BpjsListFingerPrintModelActionTypes.FETCH_BPJS_LIST_FINGER_PRINT_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
