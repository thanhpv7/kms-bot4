...
/**
 * BpjsGeneralCollectionState would store the state of a collection of BpjsGeneral
 */
export interface BpjsGeneralCollectionState extends CollectionState {
 ...
 */
export interface BpjsGeneralModelAudit extends AbstractModelAudit<BpjsGeneralModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsGeneralModelState would store the state of the model
 */
export interface BpjsGeneralModelState {
	collectionState: {
		[key: string]: BpjsGeneralCollectionState;
	};
	data: {
		[id: string]: BpjsGeneralModel;
	};
	totalCount: number;
	audits: BpjsGeneralModelAudit[];
 ...
 */
export const initialBpjsGeneralCollectionState: BpjsGeneralCollectionState = {
...
/**
 * The initial state of BpjsGeneralModelState
 */
export const initialState: BpjsGeneralModelState = {
	collectionState: {
