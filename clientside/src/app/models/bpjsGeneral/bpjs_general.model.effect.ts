...
import * as modelAction from './bpjs_general.model.action';
import {BpjsGeneralService} from '../../services/bpjsGeneral/bpjs_general.service';
...
/**
 * Effect class used for side effects related to BPJS General model.
 */
@Injectable()
export class BpjsGeneralEffect {
	...
	constructor(
		...
		protected readonly service: BpjsGeneralService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsGeneralAction>(modelAction.BpjsGeneralModelActionTypes.COUNT_BPJS_GENERALS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsGeneralActionOK(
						modelAction.BpjsGeneralModelActionTypes.COUNT_BPJS_GENERALS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsGeneralActionFail(
								modelAction.BpjsGeneralModelActionTypes.COUNT_BPJS_GENERALS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsGeneralAction>(modelAction.BpjsGeneralModelActionTypes.FETCH_BPJS_GENERAL),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsGeneralActionOK(
						modelAction.BpjsGeneralModelActionTypes.FETCH_BPJS_GENERAL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsGeneralActionFail(
								modelAction.BpjsGeneralModelActionTypes.FETCH_BPJS_GENERAL_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsGeneralAction>(modelAction.BpjsGeneralModelActionTypes.FETCH_ALL_BPJS_GENERAL),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsGeneralActionOK(
						modelAction.BpjsGeneralModelActionTypes.FETCH_ALL_BPJS_GENERAL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsGeneralActionFail(
								modelAction.BpjsGeneralModelActionTypes.FETCH_ALL_BPJS_GENERAL_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsGeneralAction>(modelAction.BpjsGeneralModelActionTypes.FETCH_BPJS_GENERAL_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsGeneralActionOK(
						modelAction.BpjsGeneralModelActionTypes.FETCH_BPJS_GENERAL_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsGeneralActionFail(
								modelAction.BpjsGeneralModelActionTypes.FETCH_BPJS_GENERAL_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsGeneralAction>(modelAction.BpjsGeneralModelActionTypes.FETCH_LAST_BPJS_GENERAL_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsGeneralActionOK(
						modelAction.BpjsGeneralModelActionTypes.FETCH_LAST_BPJS_GENERAL_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsGeneralActionFail(
								modelAction.BpjsGeneralModelActionTypes.FETCH_LAST_BPJS_GENERAL_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsGeneralAction>(modelAction.BpjsGeneralModelActionTypes.CREATE_BPJS_GENERAL),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsGeneralModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsGeneralActionOK(
						modelAction.BpjsGeneralModelActionTypes.CREATE_BPJS_GENERAL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsGeneralActionFail(
								modelAction.BpjsGeneralModelActionTypes.CREATE_BPJS_GENERAL_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsGeneralAction>(modelAction.BpjsGeneralModelActionTypes.CREATE_ALL_BPJS_GENERAL),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsGeneralModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsGeneralActionOK(
						modelAction.BpjsGeneralModelActionTypes.CREATE_ALL_BPJS_GENERAL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsGeneralActionFail(
								modelAction.BpjsGeneralModelActionTypes.CREATE_ALL_BPJS_GENERAL_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsGeneralAction>(modelAction.BpjsGeneralModelActionTypes.UPDATE_BPJS_GENERAL),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsGeneralModel;
				...
				return this.service.update(new BpjsGeneralModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsGeneralActionOK(
						modelAction.BpjsGeneralModelActionTypes.UPDATE_BPJS_GENERAL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsGeneralActionFail(
								modelAction.BpjsGeneralModelActionTypes.UPDATE_BPJS_GENERAL_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsGeneralAction>(modelAction.BpjsGeneralModelActionTypes.UPDATE_ALL_BPJS_GENERAL),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsGeneralModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsGeneralModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsGeneralActionOK(
						modelAction.BpjsGeneralModelActionTypes.UPDATE_ALL_BPJS_GENERAL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsGeneralActionFail(
								modelAction.BpjsGeneralModelActionTypes.UPDATE_ALL_BPJS_GENERAL_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsGeneralAction>(modelAction.BpjsGeneralModelActionTypes.DELETE_BPJS_GENERAL),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsGeneralActionOK(
						modelAction.BpjsGeneralModelActionTypes.DELETE_BPJS_GENERAL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsGeneralActionFail(
								modelAction.BpjsGeneralModelActionTypes.DELETE_BPJS_GENERAL_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsGeneralAction>(modelAction.BpjsGeneralModelActionTypes.DELETE_BPJS_GENERAL_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsGeneralActionOK(
						modelAction.BpjsGeneralModelActionTypes.DELETE_BPJS_GENERAL_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsGeneralActionFail(
								modelAction.BpjsGeneralModelActionTypes.DELETE_BPJS_GENERAL_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsGeneralAction>(modelAction.BpjsGeneralModelActionTypes.DELETE_ALL_BPJS_GENERAL),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsGeneralActionOK(
						modelAction.BpjsGeneralModelActionTypes.DELETE_ALL_BPJS_GENERAL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsGeneralActionFail(
								modelAction.BpjsGeneralModelActionTypes.DELETE_ALL_BPJS_GENERAL_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsGeneralAction>(modelAction.BpjsGeneralModelActionTypes.EXPORT_BPJS_GENERAL),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsGeneralActionOK(
						modelAction.BpjsGeneralModelActionTypes.EXPORT_BPJS_GENERAL,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsGeneralAction>(modelAction.BpjsGeneralModelActionTypes.EXPORT_ALL_BPJS_GENERAL),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsGeneralActionOK(
						modelAction.BpjsGeneralModelActionTypes.EXPORT_ALL_BPJS_GENERAL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsGeneralActionFail(
								modelAction.BpjsGeneralModelActionTypes.EXPORT_ALL_BPJS_GENERAL_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsGeneralAction>(modelAction.BpjsGeneralModelActionTypes.EXPORT_BPJS_GENERAL_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsGeneralActionOK(
						modelAction.BpjsGeneralModelActionTypes.EXPORT_BPJS_GENERAL_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsGeneralActionFail(
								modelAction.BpjsGeneralModelActionTypes.EXPORT_BPJS_GENERAL_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsGeneralAction>(modelAction.BpjsGeneralModelActionTypes.IMPORT_BPJS_GENERALS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsGeneralActionOK(
						modelAction.BpjsGeneralModelActionTypes.IMPORT_BPJS_GENERALS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsGeneralActionFail(
								modelAction.BpjsGeneralModelActionTypes.IMPORT_BPJS_GENERALS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsGeneralAction>(modelAction.BpjsGeneralModelActionTypes.FETCH_BPJS_GENERAL_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsGeneralActionOK(
						modelAction.BpjsGeneralModelActionTypes.FETCH_BPJS_GENERAL_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsGeneralActionFail(
								modelAction.BpjsGeneralModelActionTypes.FETCH_BPJS_GENERAL_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsGeneralAction>(modelAction.BpjsGeneralModelActionTypes.FETCH_BPJS_GENERAL_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsGeneralActionOK(
						modelAction.BpjsGeneralModelActionTypes.FETCH_BPJS_GENERAL_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsGeneralActionFail(
								modelAction.BpjsGeneralModelActionTypes.FETCH_BPJS_GENERAL_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
