...
import * as modelAction from './service_item.model.action';
import {ServiceItemService} from '../../services/serviceItem/service_item.service';
...
/**
 * Effect class used for side effects related to Service Item model.
 */
@Injectable()
export class ServiceItemEffect {
	...
	constructor(
		...
		protected readonly service: ServiceItemService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceItemAction>(modelAction.ServiceItemModelActionTypes.COUNT_SERVICE_ITEMS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.ServiceItemActionOK(
						modelAction.ServiceItemModelActionTypes.COUNT_SERVICE_ITEMS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceItemActionFail(
								modelAction.ServiceItemModelActionTypes.COUNT_SERVICE_ITEMS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceItemAction>(modelAction.ServiceItemModelActionTypes.FETCH_SERVICE_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ServiceItemActionOK(
						modelAction.ServiceItemModelActionTypes.FETCH_SERVICE_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceItemActionFail(
								modelAction.ServiceItemModelActionTypes.FETCH_SERVICE_ITEM_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceItemAction>(modelAction.ServiceItemModelActionTypes.FETCH_ALL_SERVICE_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.ServiceItemActionOK(
						modelAction.ServiceItemModelActionTypes.FETCH_ALL_SERVICE_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceItemActionFail(
								modelAction.ServiceItemModelActionTypes.FETCH_ALL_SERVICE_ITEM_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceItemAction>(modelAction.ServiceItemModelActionTypes.FETCH_SERVICE_ITEM_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.ServiceItemActionOK(
						modelAction.ServiceItemModelActionTypes.FETCH_SERVICE_ITEM_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceItemActionFail(
								modelAction.ServiceItemModelActionTypes.FETCH_SERVICE_ITEM_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceItemAction>(modelAction.ServiceItemModelActionTypes.FETCH_LAST_SERVICE_ITEM_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.ServiceItemActionOK(
						modelAction.ServiceItemModelActionTypes.FETCH_LAST_SERVICE_ITEM_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceItemActionFail(
								modelAction.ServiceItemModelActionTypes.FETCH_LAST_SERVICE_ITEM_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceItemAction>(modelAction.ServiceItemModelActionTypes.CREATE_SERVICE_ITEM),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as ServiceItemModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ServiceItemActionOK(
						modelAction.ServiceItemModelActionTypes.CREATE_SERVICE_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceItemActionFail(
								modelAction.ServiceItemModelActionTypes.CREATE_SERVICE_ITEM_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceItemAction>(modelAction.ServiceItemModelActionTypes.CREATE_ALL_SERVICE_ITEM),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as ServiceItemModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ServiceItemActionOK(
						modelAction.ServiceItemModelActionTypes.CREATE_ALL_SERVICE_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceItemActionFail(
								modelAction.ServiceItemModelActionTypes.CREATE_ALL_SERVICE_ITEM_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceItemAction>(modelAction.ServiceItemModelActionTypes.UPDATE_SERVICE_ITEM),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as ServiceItemModel;
				...
				return this.service.update(new ServiceItemModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.ServiceItemActionOK(
						modelAction.ServiceItemModelActionTypes.UPDATE_SERVICE_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceItemActionFail(
								modelAction.ServiceItemModelActionTypes.UPDATE_SERVICE_ITEM_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceItemAction>(modelAction.ServiceItemModelActionTypes.UPDATE_ALL_SERVICE_ITEM),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as ServiceItemModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new ServiceItemModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ServiceItemActionOK(
						modelAction.ServiceItemModelActionTypes.UPDATE_ALL_SERVICE_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceItemActionFail(
								modelAction.ServiceItemModelActionTypes.UPDATE_ALL_SERVICE_ITEM_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceItemAction>(modelAction.ServiceItemModelActionTypes.DELETE_SERVICE_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.ServiceItemActionOK(
						modelAction.ServiceItemModelActionTypes.DELETE_SERVICE_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceItemActionFail(
								modelAction.ServiceItemModelActionTypes.DELETE_SERVICE_ITEM_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceItemAction>(modelAction.ServiceItemModelActionTypes.DELETE_SERVICE_ITEM_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.ServiceItemActionOK(
						modelAction.ServiceItemModelActionTypes.DELETE_SERVICE_ITEM_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceItemActionFail(
								modelAction.ServiceItemModelActionTypes.DELETE_SERVICE_ITEM_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceItemAction>(modelAction.ServiceItemModelActionTypes.DELETE_ALL_SERVICE_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.ServiceItemActionOK(
						modelAction.ServiceItemModelActionTypes.DELETE_ALL_SERVICE_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceItemActionFail(
								modelAction.ServiceItemModelActionTypes.DELETE_ALL_SERVICE_ITEM_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceItemAction>(modelAction.ServiceItemModelActionTypes.EXPORT_SERVICE_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ServiceItemActionOK(
						modelAction.ServiceItemModelActionTypes.EXPORT_SERVICE_ITEM,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceItemAction>(modelAction.ServiceItemModelActionTypes.EXPORT_ALL_SERVICE_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ServiceItemActionOK(
						modelAction.ServiceItemModelActionTypes.EXPORT_ALL_SERVICE_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceItemActionFail(
								modelAction.ServiceItemModelActionTypes.EXPORT_ALL_SERVICE_ITEM_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceItemAction>(modelAction.ServiceItemModelActionTypes.EXPORT_SERVICE_ITEM_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ServiceItemActionOK(
						modelAction.ServiceItemModelActionTypes.EXPORT_SERVICE_ITEM_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceItemActionFail(
								modelAction.ServiceItemModelActionTypes.EXPORT_SERVICE_ITEM_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceItemAction>(modelAction.ServiceItemModelActionTypes.IMPORT_SERVICE_ITEMS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.ServiceItemActionOK(
						modelAction.ServiceItemModelActionTypes.IMPORT_SERVICE_ITEMS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ServiceItemActionFail(
								modelAction.ServiceItemModelActionTypes.IMPORT_SERVICE_ITEMS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceItemAction>(modelAction.ServiceItemModelActionTypes.FETCH_SERVICE_ITEM_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.ServiceItemActionOK(
						modelAction.ServiceItemModelActionTypes.FETCH_SERVICE_ITEM_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.ServiceItemActionFail(
								modelAction.ServiceItemModelActionTypes.FETCH_SERVICE_ITEM_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ServiceItemAction>(modelAction.ServiceItemModelActionTypes.FETCH_SERVICE_ITEM_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.ServiceItemActionOK(
						modelAction.ServiceItemModelActionTypes.FETCH_SERVICE_ITEM_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.ServiceItemActionFail(
								modelAction.ServiceItemModelActionTypes.FETCH_SERVICE_ITEM_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
