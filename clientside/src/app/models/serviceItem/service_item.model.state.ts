...
/**
 * ServiceItemCollectionState would store the state of a collection of ServiceItem
 */
export interface ServiceItemCollectionState extends CollectionState {
 ...
 */
export interface ServiceItemModelAudit extends AbstractModelAudit<ServiceItemModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * ServiceItemModelState would store the state of the model
 */
export interface ServiceItemModelState {
	collectionState: {
		[key: string]: ServiceItemCollectionState;
	};
	data: {
		[id: string]: ServiceItemModel;
	};
	totalCount: number;
	audits: ServiceItemModelAudit[];
 ...
 */
export const initialServiceItemCollectionState: ServiceItemCollectionState = {
...
/**
 * The initial state of ServiceItemModelState
 */
export const initialState: ServiceItemModelState = {
	collectionState: {
