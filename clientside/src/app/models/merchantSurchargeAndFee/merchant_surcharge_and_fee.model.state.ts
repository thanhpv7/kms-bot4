...
/**
 * MerchantSurchargeAndFeeCollectionState would store the state of a collection of MerchantSurchargeAndFee
 */
export interface MerchantSurchargeAndFeeCollectionState extends CollectionState {
 ...
 */
export interface MerchantSurchargeAndFeeModelAudit extends AbstractModelAudit<MerchantSurchargeAndFeeModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * MerchantSurchargeAndFeeModelState would store the state of the model
 */
export interface MerchantSurchargeAndFeeModelState {
	collectionState: {
		[key: string]: MerchantSurchargeAndFeeCollectionState;
	};
	data: {
		[id: string]: MerchantSurchargeAndFeeModel;
	};
	totalCount: number;
	audits: MerchantSurchargeAndFeeModelAudit[];
 ...
 */
export const initialMerchantSurchargeAndFeeCollectionState: MerchantSurchargeAndFeeCollectionState = {
...
/**
 * The initial state of MerchantSurchargeAndFeeModelState
 */
export const initialState: MerchantSurchargeAndFeeModelState = {
	collectionState: {
