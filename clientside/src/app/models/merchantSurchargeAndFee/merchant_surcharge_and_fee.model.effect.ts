...
import * as modelAction from './merchant_surcharge_and_fee.model.action';
import {MerchantSurchargeAndFeeService} from '../../services/merchantSurchargeAndFee/merchant_surcharge_and_fee.service';
...
/**
 * Effect class used for side effects related to Merchant Surcharge and Fee model.
 */
@Injectable()
export class MerchantSurchargeAndFeeEffect {
	...
	constructor(
		...
		protected readonly service: MerchantSurchargeAndFeeService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MerchantSurchargeAndFeeAction>(modelAction.MerchantSurchargeAndFeeModelActionTypes.COUNT_MERCHANT_SURCHARGE_AND_FEES),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.MerchantSurchargeAndFeeActionOK(
						modelAction.MerchantSurchargeAndFeeModelActionTypes.COUNT_MERCHANT_SURCHARGE_AND_FEES_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MerchantSurchargeAndFeeActionFail(
								modelAction.MerchantSurchargeAndFeeModelActionTypes.COUNT_MERCHANT_SURCHARGE_AND_FEES_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MerchantSurchargeAndFeeAction>(modelAction.MerchantSurchargeAndFeeModelActionTypes.FETCH_MERCHANT_SURCHARGE_AND_FEE),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MerchantSurchargeAndFeeActionOK(
						modelAction.MerchantSurchargeAndFeeModelActionTypes.FETCH_MERCHANT_SURCHARGE_AND_FEE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MerchantSurchargeAndFeeActionFail(
								modelAction.MerchantSurchargeAndFeeModelActionTypes.FETCH_MERCHANT_SURCHARGE_AND_FEE_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MerchantSurchargeAndFeeAction>(modelAction.MerchantSurchargeAndFeeModelActionTypes.FETCH_ALL_MERCHANT_SURCHARGE_AND_FEE),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.MerchantSurchargeAndFeeActionOK(
						modelAction.MerchantSurchargeAndFeeModelActionTypes.FETCH_ALL_MERCHANT_SURCHARGE_AND_FEE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MerchantSurchargeAndFeeActionFail(
								modelAction.MerchantSurchargeAndFeeModelActionTypes.FETCH_ALL_MERCHANT_SURCHARGE_AND_FEE_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MerchantSurchargeAndFeeAction>(modelAction.MerchantSurchargeAndFeeModelActionTypes.FETCH_MERCHANT_SURCHARGE_AND_FEE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.MerchantSurchargeAndFeeActionOK(
						modelAction.MerchantSurchargeAndFeeModelActionTypes.FETCH_MERCHANT_SURCHARGE_AND_FEE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MerchantSurchargeAndFeeActionFail(
								modelAction.MerchantSurchargeAndFeeModelActionTypes.FETCH_MERCHANT_SURCHARGE_AND_FEE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MerchantSurchargeAndFeeAction>(modelAction.MerchantSurchargeAndFeeModelActionTypes.FETCH_LAST_MERCHANT_SURCHARGE_AND_FEE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.MerchantSurchargeAndFeeActionOK(
						modelAction.MerchantSurchargeAndFeeModelActionTypes.FETCH_LAST_MERCHANT_SURCHARGE_AND_FEE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MerchantSurchargeAndFeeActionFail(
								modelAction.MerchantSurchargeAndFeeModelActionTypes.FETCH_LAST_MERCHANT_SURCHARGE_AND_FEE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MerchantSurchargeAndFeeAction>(modelAction.MerchantSurchargeAndFeeModelActionTypes.CREATE_MERCHANT_SURCHARGE_AND_FEE),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as MerchantSurchargeAndFeeModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MerchantSurchargeAndFeeActionOK(
						modelAction.MerchantSurchargeAndFeeModelActionTypes.CREATE_MERCHANT_SURCHARGE_AND_FEE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MerchantSurchargeAndFeeActionFail(
								modelAction.MerchantSurchargeAndFeeModelActionTypes.CREATE_MERCHANT_SURCHARGE_AND_FEE_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MerchantSurchargeAndFeeAction>(modelAction.MerchantSurchargeAndFeeModelActionTypes.CREATE_ALL_MERCHANT_SURCHARGE_AND_FEE),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as MerchantSurchargeAndFeeModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MerchantSurchargeAndFeeActionOK(
						modelAction.MerchantSurchargeAndFeeModelActionTypes.CREATE_ALL_MERCHANT_SURCHARGE_AND_FEE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MerchantSurchargeAndFeeActionFail(
								modelAction.MerchantSurchargeAndFeeModelActionTypes.CREATE_ALL_MERCHANT_SURCHARGE_AND_FEE_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MerchantSurchargeAndFeeAction>(modelAction.MerchantSurchargeAndFeeModelActionTypes.UPDATE_MERCHANT_SURCHARGE_AND_FEE),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as MerchantSurchargeAndFeeModel;
				...
				return this.service.update(new MerchantSurchargeAndFeeModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.MerchantSurchargeAndFeeActionOK(
						modelAction.MerchantSurchargeAndFeeModelActionTypes.UPDATE_MERCHANT_SURCHARGE_AND_FEE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MerchantSurchargeAndFeeActionFail(
								modelAction.MerchantSurchargeAndFeeModelActionTypes.UPDATE_MERCHANT_SURCHARGE_AND_FEE_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MerchantSurchargeAndFeeAction>(modelAction.MerchantSurchargeAndFeeModelActionTypes.UPDATE_ALL_MERCHANT_SURCHARGE_AND_FEE),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as MerchantSurchargeAndFeeModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new MerchantSurchargeAndFeeModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MerchantSurchargeAndFeeActionOK(
						modelAction.MerchantSurchargeAndFeeModelActionTypes.UPDATE_ALL_MERCHANT_SURCHARGE_AND_FEE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MerchantSurchargeAndFeeActionFail(
								modelAction.MerchantSurchargeAndFeeModelActionTypes.UPDATE_ALL_MERCHANT_SURCHARGE_AND_FEE_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MerchantSurchargeAndFeeAction>(modelAction.MerchantSurchargeAndFeeModelActionTypes.DELETE_MERCHANT_SURCHARGE_AND_FEE),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.MerchantSurchargeAndFeeActionOK(
						modelAction.MerchantSurchargeAndFeeModelActionTypes.DELETE_MERCHANT_SURCHARGE_AND_FEE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MerchantSurchargeAndFeeActionFail(
								modelAction.MerchantSurchargeAndFeeModelActionTypes.DELETE_MERCHANT_SURCHARGE_AND_FEE_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MerchantSurchargeAndFeeAction>(modelAction.MerchantSurchargeAndFeeModelActionTypes.DELETE_MERCHANT_SURCHARGE_AND_FEE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.MerchantSurchargeAndFeeActionOK(
						modelAction.MerchantSurchargeAndFeeModelActionTypes.DELETE_MERCHANT_SURCHARGE_AND_FEE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MerchantSurchargeAndFeeActionFail(
								modelAction.MerchantSurchargeAndFeeModelActionTypes.DELETE_MERCHANT_SURCHARGE_AND_FEE_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MerchantSurchargeAndFeeAction>(modelAction.MerchantSurchargeAndFeeModelActionTypes.DELETE_ALL_MERCHANT_SURCHARGE_AND_FEE),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.MerchantSurchargeAndFeeActionOK(
						modelAction.MerchantSurchargeAndFeeModelActionTypes.DELETE_ALL_MERCHANT_SURCHARGE_AND_FEE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MerchantSurchargeAndFeeActionFail(
								modelAction.MerchantSurchargeAndFeeModelActionTypes.DELETE_ALL_MERCHANT_SURCHARGE_AND_FEE_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MerchantSurchargeAndFeeAction>(modelAction.MerchantSurchargeAndFeeModelActionTypes.EXPORT_MERCHANT_SURCHARGE_AND_FEE),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MerchantSurchargeAndFeeActionOK(
						modelAction.MerchantSurchargeAndFeeModelActionTypes.EXPORT_MERCHANT_SURCHARGE_AND_FEE,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MerchantSurchargeAndFeeAction>(modelAction.MerchantSurchargeAndFeeModelActionTypes.EXPORT_ALL_MERCHANT_SURCHARGE_AND_FEE),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MerchantSurchargeAndFeeActionOK(
						modelAction.MerchantSurchargeAndFeeModelActionTypes.EXPORT_ALL_MERCHANT_SURCHARGE_AND_FEE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MerchantSurchargeAndFeeActionFail(
								modelAction.MerchantSurchargeAndFeeModelActionTypes.EXPORT_ALL_MERCHANT_SURCHARGE_AND_FEE_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MerchantSurchargeAndFeeAction>(modelAction.MerchantSurchargeAndFeeModelActionTypes.EXPORT_MERCHANT_SURCHARGE_AND_FEE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MerchantSurchargeAndFeeActionOK(
						modelAction.MerchantSurchargeAndFeeModelActionTypes.EXPORT_MERCHANT_SURCHARGE_AND_FEE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MerchantSurchargeAndFeeActionFail(
								modelAction.MerchantSurchargeAndFeeModelActionTypes.EXPORT_MERCHANT_SURCHARGE_AND_FEE_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MerchantSurchargeAndFeeAction>(modelAction.MerchantSurchargeAndFeeModelActionTypes.IMPORT_MERCHANT_SURCHARGE_AND_FEES),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.MerchantSurchargeAndFeeActionOK(
						modelAction.MerchantSurchargeAndFeeModelActionTypes.IMPORT_MERCHANT_SURCHARGE_AND_FEES_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MerchantSurchargeAndFeeActionFail(
								modelAction.MerchantSurchargeAndFeeModelActionTypes.IMPORT_MERCHANT_SURCHARGE_AND_FEES_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MerchantSurchargeAndFeeAction>(modelAction.MerchantSurchargeAndFeeModelActionTypes.FETCH_MERCHANT_SURCHARGE_AND_FEE_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.MerchantSurchargeAndFeeActionOK(
						modelAction.MerchantSurchargeAndFeeModelActionTypes.FETCH_MERCHANT_SURCHARGE_AND_FEE_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.MerchantSurchargeAndFeeActionFail(
								modelAction.MerchantSurchargeAndFeeModelActionTypes.FETCH_MERCHANT_SURCHARGE_AND_FEE_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MerchantSurchargeAndFeeAction>(modelAction.MerchantSurchargeAndFeeModelActionTypes.FETCH_MERCHANT_SURCHARGE_AND_FEE_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.MerchantSurchargeAndFeeActionOK(
						modelAction.MerchantSurchargeAndFeeModelActionTypes.FETCH_MERCHANT_SURCHARGE_AND_FEE_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.MerchantSurchargeAndFeeActionFail(
								modelAction.MerchantSurchargeAndFeeModelActionTypes.FETCH_MERCHANT_SURCHARGE_AND_FEE_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
