...
/**
 * MedicalExaminationRecordCollectionState would store the state of a collection of MedicalExaminationRecord
 */
export interface MedicalExaminationRecordCollectionState extends CollectionState {
 ...
 */
export interface MedicalExaminationRecordModelAudit extends AbstractModelAudit<MedicalExaminationRecordModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * MedicalExaminationRecordModelState would store the state of the model
 */
export interface MedicalExaminationRecordModelState {
	collectionState: {
		[key: string]: MedicalExaminationRecordCollectionState;
	};
	data: {
		[id: string]: MedicalExaminationRecordModel;
	};
	totalCount: number;
	audits: MedicalExaminationRecordModelAudit[];
 ...
 */
export const initialMedicalExaminationRecordCollectionState: MedicalExaminationRecordCollectionState = {
...
/**
 * The initial state of MedicalExaminationRecordModelState
 */
export const initialState: MedicalExaminationRecordModelState = {
	collectionState: {
