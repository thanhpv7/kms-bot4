...
import * as modelAction from './medical_examination_record.model.action';
import {MedicalExaminationRecordService} from '../../services/medicalExaminationRecord/medical_examination_record.service';
...
/**
 * Effect class used for side effects related to Medical Examination Record model.
 */
@Injectable()
export class MedicalExaminationRecordEffect {
	...
	constructor(
		...
		protected readonly service: MedicalExaminationRecordService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalExaminationRecordAction>(modelAction.MedicalExaminationRecordModelActionTypes.COUNT_MEDICAL_EXAMINATION_RECORDS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.MedicalExaminationRecordActionOK(
						modelAction.MedicalExaminationRecordModelActionTypes.COUNT_MEDICAL_EXAMINATION_RECORDS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalExaminationRecordActionFail(
								modelAction.MedicalExaminationRecordModelActionTypes.COUNT_MEDICAL_EXAMINATION_RECORDS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalExaminationRecordAction>(modelAction.MedicalExaminationRecordModelActionTypes.FETCH_MEDICAL_EXAMINATION_RECORD),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalExaminationRecordActionOK(
						modelAction.MedicalExaminationRecordModelActionTypes.FETCH_MEDICAL_EXAMINATION_RECORD_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalExaminationRecordActionFail(
								modelAction.MedicalExaminationRecordModelActionTypes.FETCH_MEDICAL_EXAMINATION_RECORD_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalExaminationRecordAction>(modelAction.MedicalExaminationRecordModelActionTypes.FETCH_ALL_MEDICAL_EXAMINATION_RECORD),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.MedicalExaminationRecordActionOK(
						modelAction.MedicalExaminationRecordModelActionTypes.FETCH_ALL_MEDICAL_EXAMINATION_RECORD_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalExaminationRecordActionFail(
								modelAction.MedicalExaminationRecordModelActionTypes.FETCH_ALL_MEDICAL_EXAMINATION_RECORD_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalExaminationRecordAction>(modelAction.MedicalExaminationRecordModelActionTypes.FETCH_MEDICAL_EXAMINATION_RECORD_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalExaminationRecordActionOK(
						modelAction.MedicalExaminationRecordModelActionTypes.FETCH_MEDICAL_EXAMINATION_RECORD_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalExaminationRecordActionFail(
								modelAction.MedicalExaminationRecordModelActionTypes.FETCH_MEDICAL_EXAMINATION_RECORD_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalExaminationRecordAction>(modelAction.MedicalExaminationRecordModelActionTypes.FETCH_LAST_MEDICAL_EXAMINATION_RECORD_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalExaminationRecordActionOK(
						modelAction.MedicalExaminationRecordModelActionTypes.FETCH_LAST_MEDICAL_EXAMINATION_RECORD_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalExaminationRecordActionFail(
								modelAction.MedicalExaminationRecordModelActionTypes.FETCH_LAST_MEDICAL_EXAMINATION_RECORD_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalExaminationRecordAction>(modelAction.MedicalExaminationRecordModelActionTypes.CREATE_MEDICAL_EXAMINATION_RECORD),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as MedicalExaminationRecordModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalExaminationRecordActionOK(
						modelAction.MedicalExaminationRecordModelActionTypes.CREATE_MEDICAL_EXAMINATION_RECORD_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalExaminationRecordActionFail(
								modelAction.MedicalExaminationRecordModelActionTypes.CREATE_MEDICAL_EXAMINATION_RECORD_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalExaminationRecordAction>(modelAction.MedicalExaminationRecordModelActionTypes.CREATE_ALL_MEDICAL_EXAMINATION_RECORD),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as MedicalExaminationRecordModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalExaminationRecordActionOK(
						modelAction.MedicalExaminationRecordModelActionTypes.CREATE_ALL_MEDICAL_EXAMINATION_RECORD_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalExaminationRecordActionFail(
								modelAction.MedicalExaminationRecordModelActionTypes.CREATE_ALL_MEDICAL_EXAMINATION_RECORD_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalExaminationRecordAction>(modelAction.MedicalExaminationRecordModelActionTypes.UPDATE_MEDICAL_EXAMINATION_RECORD),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as MedicalExaminationRecordModel;
				...
				return this.service.update(new MedicalExaminationRecordModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalExaminationRecordActionOK(
						modelAction.MedicalExaminationRecordModelActionTypes.UPDATE_MEDICAL_EXAMINATION_RECORD_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalExaminationRecordActionFail(
								modelAction.MedicalExaminationRecordModelActionTypes.UPDATE_MEDICAL_EXAMINATION_RECORD_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalExaminationRecordAction>(modelAction.MedicalExaminationRecordModelActionTypes.UPDATE_ALL_MEDICAL_EXAMINATION_RECORD),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as MedicalExaminationRecordModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new MedicalExaminationRecordModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalExaminationRecordActionOK(
						modelAction.MedicalExaminationRecordModelActionTypes.UPDATE_ALL_MEDICAL_EXAMINATION_RECORD_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalExaminationRecordActionFail(
								modelAction.MedicalExaminationRecordModelActionTypes.UPDATE_ALL_MEDICAL_EXAMINATION_RECORD_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalExaminationRecordAction>(modelAction.MedicalExaminationRecordModelActionTypes.DELETE_MEDICAL_EXAMINATION_RECORD),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.MedicalExaminationRecordActionOK(
						modelAction.MedicalExaminationRecordModelActionTypes.DELETE_MEDICAL_EXAMINATION_RECORD_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalExaminationRecordActionFail(
								modelAction.MedicalExaminationRecordModelActionTypes.DELETE_MEDICAL_EXAMINATION_RECORD_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalExaminationRecordAction>(modelAction.MedicalExaminationRecordModelActionTypes.DELETE_MEDICAL_EXAMINATION_RECORD_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.MedicalExaminationRecordActionOK(
						modelAction.MedicalExaminationRecordModelActionTypes.DELETE_MEDICAL_EXAMINATION_RECORD_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalExaminationRecordActionFail(
								modelAction.MedicalExaminationRecordModelActionTypes.DELETE_MEDICAL_EXAMINATION_RECORD_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalExaminationRecordAction>(modelAction.MedicalExaminationRecordModelActionTypes.DELETE_ALL_MEDICAL_EXAMINATION_RECORD),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.MedicalExaminationRecordActionOK(
						modelAction.MedicalExaminationRecordModelActionTypes.DELETE_ALL_MEDICAL_EXAMINATION_RECORD_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalExaminationRecordActionFail(
								modelAction.MedicalExaminationRecordModelActionTypes.DELETE_ALL_MEDICAL_EXAMINATION_RECORD_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalExaminationRecordAction>(modelAction.MedicalExaminationRecordModelActionTypes.EXPORT_MEDICAL_EXAMINATION_RECORD),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicalExaminationRecordActionOK(
						modelAction.MedicalExaminationRecordModelActionTypes.EXPORT_MEDICAL_EXAMINATION_RECORD,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalExaminationRecordAction>(modelAction.MedicalExaminationRecordModelActionTypes.EXPORT_ALL_MEDICAL_EXAMINATION_RECORD),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicalExaminationRecordActionOK(
						modelAction.MedicalExaminationRecordModelActionTypes.EXPORT_ALL_MEDICAL_EXAMINATION_RECORD_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalExaminationRecordActionFail(
								modelAction.MedicalExaminationRecordModelActionTypes.EXPORT_ALL_MEDICAL_EXAMINATION_RECORD_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalExaminationRecordAction>(modelAction.MedicalExaminationRecordModelActionTypes.EXPORT_MEDICAL_EXAMINATION_RECORD_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicalExaminationRecordActionOK(
						modelAction.MedicalExaminationRecordModelActionTypes.EXPORT_MEDICAL_EXAMINATION_RECORD_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalExaminationRecordActionFail(
								modelAction.MedicalExaminationRecordModelActionTypes.EXPORT_MEDICAL_EXAMINATION_RECORD_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalExaminationRecordAction>(modelAction.MedicalExaminationRecordModelActionTypes.IMPORT_MEDICAL_EXAMINATION_RECORDS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.MedicalExaminationRecordActionOK(
						modelAction.MedicalExaminationRecordModelActionTypes.IMPORT_MEDICAL_EXAMINATION_RECORDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalExaminationRecordActionFail(
								modelAction.MedicalExaminationRecordModelActionTypes.IMPORT_MEDICAL_EXAMINATION_RECORDS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalExaminationRecordAction>(modelAction.MedicalExaminationRecordModelActionTypes.FETCH_MEDICAL_EXAMINATION_RECORD_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.MedicalExaminationRecordActionOK(
						modelAction.MedicalExaminationRecordModelActionTypes.FETCH_MEDICAL_EXAMINATION_RECORD_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.MedicalExaminationRecordActionFail(
								modelAction.MedicalExaminationRecordModelActionTypes.FETCH_MEDICAL_EXAMINATION_RECORD_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalExaminationRecordAction>(modelAction.MedicalExaminationRecordModelActionTypes.FETCH_MEDICAL_EXAMINATION_RECORD_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.MedicalExaminationRecordActionOK(
						modelAction.MedicalExaminationRecordModelActionTypes.FETCH_MEDICAL_EXAMINATION_RECORD_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.MedicalExaminationRecordActionFail(
								modelAction.MedicalExaminationRecordModelActionTypes.FETCH_MEDICAL_EXAMINATION_RECORD_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
