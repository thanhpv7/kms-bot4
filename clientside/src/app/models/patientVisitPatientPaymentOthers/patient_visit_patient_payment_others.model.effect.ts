...
import * as modelAction from './patient_visit_patient_payment_others.model.action';
import {PatientVisitPatientPaymentOthersService} from '../../services/patientVisitPatientPaymentOthers/patient_visit_patient_payment_others.service';
...
/**
 * Effect class used for side effects related to Patient Visit Patient Payment Others model.
 */
@Injectable()
export class PatientVisitPatientPaymentOthersEffect {
	...
	constructor(
		...
		protected readonly service: PatientVisitPatientPaymentOthersService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVisitPatientPaymentOthersAction>(modelAction.PatientVisitPatientPaymentOthersModelActionTypes.COUNT_PATIENT_VISIT_PATIENT_PAYMENT_OTHERSS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.PatientVisitPatientPaymentOthersActionOK(
						modelAction.PatientVisitPatientPaymentOthersModelActionTypes.COUNT_PATIENT_VISIT_PATIENT_PAYMENT_OTHERSS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientVisitPatientPaymentOthersActionFail(
								modelAction.PatientVisitPatientPaymentOthersModelActionTypes.COUNT_PATIENT_VISIT_PATIENT_PAYMENT_OTHERSS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVisitPatientPaymentOthersAction>(modelAction.PatientVisitPatientPaymentOthersModelActionTypes.FETCH_PATIENT_VISIT_PATIENT_PAYMENT_OTHERS),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientVisitPatientPaymentOthersActionOK(
						modelAction.PatientVisitPatientPaymentOthersModelActionTypes.FETCH_PATIENT_VISIT_PATIENT_PAYMENT_OTHERS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientVisitPatientPaymentOthersActionFail(
								modelAction.PatientVisitPatientPaymentOthersModelActionTypes.FETCH_PATIENT_VISIT_PATIENT_PAYMENT_OTHERS_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVisitPatientPaymentOthersAction>(modelAction.PatientVisitPatientPaymentOthersModelActionTypes.FETCH_ALL_PATIENT_VISIT_PATIENT_PAYMENT_OTHERS),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.PatientVisitPatientPaymentOthersActionOK(
						modelAction.PatientVisitPatientPaymentOthersModelActionTypes.FETCH_ALL_PATIENT_VISIT_PATIENT_PAYMENT_OTHERS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientVisitPatientPaymentOthersActionFail(
								modelAction.PatientVisitPatientPaymentOthersModelActionTypes.FETCH_ALL_PATIENT_VISIT_PATIENT_PAYMENT_OTHERS_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVisitPatientPaymentOthersAction>(modelAction.PatientVisitPatientPaymentOthersModelActionTypes.FETCH_PATIENT_VISIT_PATIENT_PAYMENT_OTHERS_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientVisitPatientPaymentOthersActionOK(
						modelAction.PatientVisitPatientPaymentOthersModelActionTypes.FETCH_PATIENT_VISIT_PATIENT_PAYMENT_OTHERS_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientVisitPatientPaymentOthersActionFail(
								modelAction.PatientVisitPatientPaymentOthersModelActionTypes.FETCH_PATIENT_VISIT_PATIENT_PAYMENT_OTHERS_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVisitPatientPaymentOthersAction>(modelAction.PatientVisitPatientPaymentOthersModelActionTypes.FETCH_LAST_PATIENT_VISIT_PATIENT_PAYMENT_OTHERS_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientVisitPatientPaymentOthersActionOK(
						modelAction.PatientVisitPatientPaymentOthersModelActionTypes.FETCH_LAST_PATIENT_VISIT_PATIENT_PAYMENT_OTHERS_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientVisitPatientPaymentOthersActionFail(
								modelAction.PatientVisitPatientPaymentOthersModelActionTypes.FETCH_LAST_PATIENT_VISIT_PATIENT_PAYMENT_OTHERS_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVisitPatientPaymentOthersAction>(modelAction.PatientVisitPatientPaymentOthersModelActionTypes.CREATE_PATIENT_VISIT_PATIENT_PAYMENT_OTHERS),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as PatientVisitPatientPaymentOthersModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientVisitPatientPaymentOthersActionOK(
						modelAction.PatientVisitPatientPaymentOthersModelActionTypes.CREATE_PATIENT_VISIT_PATIENT_PAYMENT_OTHERS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientVisitPatientPaymentOthersActionFail(
								modelAction.PatientVisitPatientPaymentOthersModelActionTypes.CREATE_PATIENT_VISIT_PATIENT_PAYMENT_OTHERS_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVisitPatientPaymentOthersAction>(modelAction.PatientVisitPatientPaymentOthersModelActionTypes.CREATE_ALL_PATIENT_VISIT_PATIENT_PAYMENT_OTHERS),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as PatientVisitPatientPaymentOthersModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientVisitPatientPaymentOthersActionOK(
						modelAction.PatientVisitPatientPaymentOthersModelActionTypes.CREATE_ALL_PATIENT_VISIT_PATIENT_PAYMENT_OTHERS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientVisitPatientPaymentOthersActionFail(
								modelAction.PatientVisitPatientPaymentOthersModelActionTypes.CREATE_ALL_PATIENT_VISIT_PATIENT_PAYMENT_OTHERS_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVisitPatientPaymentOthersAction>(modelAction.PatientVisitPatientPaymentOthersModelActionTypes.UPDATE_PATIENT_VISIT_PATIENT_PAYMENT_OTHERS),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as PatientVisitPatientPaymentOthersModel;
				...
				return this.service.update(new PatientVisitPatientPaymentOthersModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientVisitPatientPaymentOthersActionOK(
						modelAction.PatientVisitPatientPaymentOthersModelActionTypes.UPDATE_PATIENT_VISIT_PATIENT_PAYMENT_OTHERS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientVisitPatientPaymentOthersActionFail(
								modelAction.PatientVisitPatientPaymentOthersModelActionTypes.UPDATE_PATIENT_VISIT_PATIENT_PAYMENT_OTHERS_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVisitPatientPaymentOthersAction>(modelAction.PatientVisitPatientPaymentOthersModelActionTypes.UPDATE_ALL_PATIENT_VISIT_PATIENT_PAYMENT_OTHERS),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as PatientVisitPatientPaymentOthersModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new PatientVisitPatientPaymentOthersModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientVisitPatientPaymentOthersActionOK(
						modelAction.PatientVisitPatientPaymentOthersModelActionTypes.UPDATE_ALL_PATIENT_VISIT_PATIENT_PAYMENT_OTHERS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientVisitPatientPaymentOthersActionFail(
								modelAction.PatientVisitPatientPaymentOthersModelActionTypes.UPDATE_ALL_PATIENT_VISIT_PATIENT_PAYMENT_OTHERS_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVisitPatientPaymentOthersAction>(modelAction.PatientVisitPatientPaymentOthersModelActionTypes.DELETE_PATIENT_VISIT_PATIENT_PAYMENT_OTHERS),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PatientVisitPatientPaymentOthersActionOK(
						modelAction.PatientVisitPatientPaymentOthersModelActionTypes.DELETE_PATIENT_VISIT_PATIENT_PAYMENT_OTHERS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientVisitPatientPaymentOthersActionFail(
								modelAction.PatientVisitPatientPaymentOthersModelActionTypes.DELETE_PATIENT_VISIT_PATIENT_PAYMENT_OTHERS_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVisitPatientPaymentOthersAction>(modelAction.PatientVisitPatientPaymentOthersModelActionTypes.DELETE_PATIENT_VISIT_PATIENT_PAYMENT_OTHERS_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.PatientVisitPatientPaymentOthersActionOK(
						modelAction.PatientVisitPatientPaymentOthersModelActionTypes.DELETE_PATIENT_VISIT_PATIENT_PAYMENT_OTHERS_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientVisitPatientPaymentOthersActionFail(
								modelAction.PatientVisitPatientPaymentOthersModelActionTypes.DELETE_PATIENT_VISIT_PATIENT_PAYMENT_OTHERS_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVisitPatientPaymentOthersAction>(modelAction.PatientVisitPatientPaymentOthersModelActionTypes.DELETE_ALL_PATIENT_VISIT_PATIENT_PAYMENT_OTHERS),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PatientVisitPatientPaymentOthersActionOK(
						modelAction.PatientVisitPatientPaymentOthersModelActionTypes.DELETE_ALL_PATIENT_VISIT_PATIENT_PAYMENT_OTHERS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientVisitPatientPaymentOthersActionFail(
								modelAction.PatientVisitPatientPaymentOthersModelActionTypes.DELETE_ALL_PATIENT_VISIT_PATIENT_PAYMENT_OTHERS_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVisitPatientPaymentOthersAction>(modelAction.PatientVisitPatientPaymentOthersModelActionTypes.EXPORT_PATIENT_VISIT_PATIENT_PAYMENT_OTHERS),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PatientVisitPatientPaymentOthersActionOK(
						modelAction.PatientVisitPatientPaymentOthersModelActionTypes.EXPORT_PATIENT_VISIT_PATIENT_PAYMENT_OTHERS,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVisitPatientPaymentOthersAction>(modelAction.PatientVisitPatientPaymentOthersModelActionTypes.EXPORT_ALL_PATIENT_VISIT_PATIENT_PAYMENT_OTHERS),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PatientVisitPatientPaymentOthersActionOK(
						modelAction.PatientVisitPatientPaymentOthersModelActionTypes.EXPORT_ALL_PATIENT_VISIT_PATIENT_PAYMENT_OTHERS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientVisitPatientPaymentOthersActionFail(
								modelAction.PatientVisitPatientPaymentOthersModelActionTypes.EXPORT_ALL_PATIENT_VISIT_PATIENT_PAYMENT_OTHERS_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVisitPatientPaymentOthersAction>(modelAction.PatientVisitPatientPaymentOthersModelActionTypes.EXPORT_PATIENT_VISIT_PATIENT_PAYMENT_OTHERS_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PatientVisitPatientPaymentOthersActionOK(
						modelAction.PatientVisitPatientPaymentOthersModelActionTypes.EXPORT_PATIENT_VISIT_PATIENT_PAYMENT_OTHERS_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientVisitPatientPaymentOthersActionFail(
								modelAction.PatientVisitPatientPaymentOthersModelActionTypes.EXPORT_PATIENT_VISIT_PATIENT_PAYMENT_OTHERS_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVisitPatientPaymentOthersAction>(modelAction.PatientVisitPatientPaymentOthersModelActionTypes.IMPORT_PATIENT_VISIT_PATIENT_PAYMENT_OTHERSS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.PatientVisitPatientPaymentOthersActionOK(
						modelAction.PatientVisitPatientPaymentOthersModelActionTypes.IMPORT_PATIENT_VISIT_PATIENT_PAYMENT_OTHERSS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientVisitPatientPaymentOthersActionFail(
								modelAction.PatientVisitPatientPaymentOthersModelActionTypes.IMPORT_PATIENT_VISIT_PATIENT_PAYMENT_OTHERSS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVisitPatientPaymentOthersAction>(modelAction.PatientVisitPatientPaymentOthersModelActionTypes.FETCH_PATIENT_VISIT_PATIENT_PAYMENT_OTHERS_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.PatientVisitPatientPaymentOthersActionOK(
						modelAction.PatientVisitPatientPaymentOthersModelActionTypes.FETCH_PATIENT_VISIT_PATIENT_PAYMENT_OTHERS_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PatientVisitPatientPaymentOthersActionFail(
								modelAction.PatientVisitPatientPaymentOthersModelActionTypes.FETCH_PATIENT_VISIT_PATIENT_PAYMENT_OTHERS_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientVisitPatientPaymentOthersAction>(modelAction.PatientVisitPatientPaymentOthersModelActionTypes.FETCH_PATIENT_VISIT_PATIENT_PAYMENT_OTHERS_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.PatientVisitPatientPaymentOthersActionOK(
						modelAction.PatientVisitPatientPaymentOthersModelActionTypes.FETCH_PATIENT_VISIT_PATIENT_PAYMENT_OTHERS_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PatientVisitPatientPaymentOthersActionFail(
								modelAction.PatientVisitPatientPaymentOthersModelActionTypes.FETCH_PATIENT_VISIT_PATIENT_PAYMENT_OTHERS_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
