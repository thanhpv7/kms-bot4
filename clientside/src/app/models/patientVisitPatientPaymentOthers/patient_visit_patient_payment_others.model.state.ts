...
/**
 * PatientVisitPatientPaymentOthersCollectionState would store the state of a collection of PatientVisitPatientPaymentOthers
 */
export interface PatientVisitPatientPaymentOthersCollectionState extends CollectionState {
 ...
 */
export interface PatientVisitPatientPaymentOthersModelAudit extends AbstractModelAudit<PatientVisitPatientPaymentOthersModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * PatientVisitPatientPaymentOthersModelState would store the state of the model
 */
export interface PatientVisitPatientPaymentOthersModelState {
	collectionState: {
		[key: string]: PatientVisitPatientPaymentOthersCollectionState;
	};
	data: {
		[id: string]: PatientVisitPatientPaymentOthersModel;
	};
	totalCount: number;
	audits: PatientVisitPatientPaymentOthersModelAudit[];
 ...
 */
export const initialPatientVisitPatientPaymentOthersCollectionState: PatientVisitPatientPaymentOthersCollectionState = {
...
/**
 * The initial state of PatientVisitPatientPaymentOthersModelState
 */
export const initialState: PatientVisitPatientPaymentOthersModelState = {
	collectionState: {
