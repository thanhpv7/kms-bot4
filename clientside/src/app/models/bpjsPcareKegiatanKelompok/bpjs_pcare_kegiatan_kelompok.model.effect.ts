...
import * as modelAction from './bpjs_pcare_kegiatan_kelompok.model.action';
import {BpjsPcareKegiatanKelompokService} from '../../services/bpjsPcareKegiatanKelompok/bpjs_pcare_kegiatan_kelompok.service';
...
/**
 * Effect class used for side effects related to BPJS Pcare Kegiatan Kelompok model.
 */
@Injectable()
export class BpjsPcareKegiatanKelompokEffect {
	...
	constructor(
		...
		protected readonly service: BpjsPcareKegiatanKelompokService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKegiatanKelompokAction>(modelAction.BpjsPcareKegiatanKelompokModelActionTypes.COUNT_BPJS_PCARE_KEGIATAN_KELOMPOKS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareKegiatanKelompokActionOK(
						modelAction.BpjsPcareKegiatanKelompokModelActionTypes.COUNT_BPJS_PCARE_KEGIATAN_KELOMPOKS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKegiatanKelompokActionFail(
								modelAction.BpjsPcareKegiatanKelompokModelActionTypes.COUNT_BPJS_PCARE_KEGIATAN_KELOMPOKS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKegiatanKelompokAction>(modelAction.BpjsPcareKegiatanKelompokModelActionTypes.FETCH_BPJS_PCARE_KEGIATAN_KELOMPOK),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareKegiatanKelompokActionOK(
						modelAction.BpjsPcareKegiatanKelompokModelActionTypes.FETCH_BPJS_PCARE_KEGIATAN_KELOMPOK_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKegiatanKelompokActionFail(
								modelAction.BpjsPcareKegiatanKelompokModelActionTypes.FETCH_BPJS_PCARE_KEGIATAN_KELOMPOK_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKegiatanKelompokAction>(modelAction.BpjsPcareKegiatanKelompokModelActionTypes.FETCH_ALL_BPJS_PCARE_KEGIATAN_KELOMPOK),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareKegiatanKelompokActionOK(
						modelAction.BpjsPcareKegiatanKelompokModelActionTypes.FETCH_ALL_BPJS_PCARE_KEGIATAN_KELOMPOK_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKegiatanKelompokActionFail(
								modelAction.BpjsPcareKegiatanKelompokModelActionTypes.FETCH_ALL_BPJS_PCARE_KEGIATAN_KELOMPOK_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKegiatanKelompokAction>(modelAction.BpjsPcareKegiatanKelompokModelActionTypes.FETCH_BPJS_PCARE_KEGIATAN_KELOMPOK_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareKegiatanKelompokActionOK(
						modelAction.BpjsPcareKegiatanKelompokModelActionTypes.FETCH_BPJS_PCARE_KEGIATAN_KELOMPOK_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKegiatanKelompokActionFail(
								modelAction.BpjsPcareKegiatanKelompokModelActionTypes.FETCH_BPJS_PCARE_KEGIATAN_KELOMPOK_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKegiatanKelompokAction>(modelAction.BpjsPcareKegiatanKelompokModelActionTypes.FETCH_LAST_BPJS_PCARE_KEGIATAN_KELOMPOK_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareKegiatanKelompokActionOK(
						modelAction.BpjsPcareKegiatanKelompokModelActionTypes.FETCH_LAST_BPJS_PCARE_KEGIATAN_KELOMPOK_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKegiatanKelompokActionFail(
								modelAction.BpjsPcareKegiatanKelompokModelActionTypes.FETCH_LAST_BPJS_PCARE_KEGIATAN_KELOMPOK_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKegiatanKelompokAction>(modelAction.BpjsPcareKegiatanKelompokModelActionTypes.CREATE_BPJS_PCARE_KEGIATAN_KELOMPOK),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsPcareKegiatanKelompokModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareKegiatanKelompokActionOK(
						modelAction.BpjsPcareKegiatanKelompokModelActionTypes.CREATE_BPJS_PCARE_KEGIATAN_KELOMPOK_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKegiatanKelompokActionFail(
								modelAction.BpjsPcareKegiatanKelompokModelActionTypes.CREATE_BPJS_PCARE_KEGIATAN_KELOMPOK_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKegiatanKelompokAction>(modelAction.BpjsPcareKegiatanKelompokModelActionTypes.CREATE_ALL_BPJS_PCARE_KEGIATAN_KELOMPOK),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsPcareKegiatanKelompokModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareKegiatanKelompokActionOK(
						modelAction.BpjsPcareKegiatanKelompokModelActionTypes.CREATE_ALL_BPJS_PCARE_KEGIATAN_KELOMPOK_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKegiatanKelompokActionFail(
								modelAction.BpjsPcareKegiatanKelompokModelActionTypes.CREATE_ALL_BPJS_PCARE_KEGIATAN_KELOMPOK_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKegiatanKelompokAction>(modelAction.BpjsPcareKegiatanKelompokModelActionTypes.UPDATE_BPJS_PCARE_KEGIATAN_KELOMPOK),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsPcareKegiatanKelompokModel;
				...
				return this.service.update(new BpjsPcareKegiatanKelompokModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareKegiatanKelompokActionOK(
						modelAction.BpjsPcareKegiatanKelompokModelActionTypes.UPDATE_BPJS_PCARE_KEGIATAN_KELOMPOK_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKegiatanKelompokActionFail(
								modelAction.BpjsPcareKegiatanKelompokModelActionTypes.UPDATE_BPJS_PCARE_KEGIATAN_KELOMPOK_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKegiatanKelompokAction>(modelAction.BpjsPcareKegiatanKelompokModelActionTypes.UPDATE_ALL_BPJS_PCARE_KEGIATAN_KELOMPOK),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsPcareKegiatanKelompokModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsPcareKegiatanKelompokModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareKegiatanKelompokActionOK(
						modelAction.BpjsPcareKegiatanKelompokModelActionTypes.UPDATE_ALL_BPJS_PCARE_KEGIATAN_KELOMPOK_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKegiatanKelompokActionFail(
								modelAction.BpjsPcareKegiatanKelompokModelActionTypes.UPDATE_ALL_BPJS_PCARE_KEGIATAN_KELOMPOK_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKegiatanKelompokAction>(modelAction.BpjsPcareKegiatanKelompokModelActionTypes.DELETE_BPJS_PCARE_KEGIATAN_KELOMPOK),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareKegiatanKelompokActionOK(
						modelAction.BpjsPcareKegiatanKelompokModelActionTypes.DELETE_BPJS_PCARE_KEGIATAN_KELOMPOK_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKegiatanKelompokActionFail(
								modelAction.BpjsPcareKegiatanKelompokModelActionTypes.DELETE_BPJS_PCARE_KEGIATAN_KELOMPOK_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKegiatanKelompokAction>(modelAction.BpjsPcareKegiatanKelompokModelActionTypes.DELETE_BPJS_PCARE_KEGIATAN_KELOMPOK_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareKegiatanKelompokActionOK(
						modelAction.BpjsPcareKegiatanKelompokModelActionTypes.DELETE_BPJS_PCARE_KEGIATAN_KELOMPOK_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKegiatanKelompokActionFail(
								modelAction.BpjsPcareKegiatanKelompokModelActionTypes.DELETE_BPJS_PCARE_KEGIATAN_KELOMPOK_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKegiatanKelompokAction>(modelAction.BpjsPcareKegiatanKelompokModelActionTypes.DELETE_ALL_BPJS_PCARE_KEGIATAN_KELOMPOK),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareKegiatanKelompokActionOK(
						modelAction.BpjsPcareKegiatanKelompokModelActionTypes.DELETE_ALL_BPJS_PCARE_KEGIATAN_KELOMPOK_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKegiatanKelompokActionFail(
								modelAction.BpjsPcareKegiatanKelompokModelActionTypes.DELETE_ALL_BPJS_PCARE_KEGIATAN_KELOMPOK_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKegiatanKelompokAction>(modelAction.BpjsPcareKegiatanKelompokModelActionTypes.EXPORT_BPJS_PCARE_KEGIATAN_KELOMPOK),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareKegiatanKelompokActionOK(
						modelAction.BpjsPcareKegiatanKelompokModelActionTypes.EXPORT_BPJS_PCARE_KEGIATAN_KELOMPOK,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKegiatanKelompokAction>(modelAction.BpjsPcareKegiatanKelompokModelActionTypes.EXPORT_ALL_BPJS_PCARE_KEGIATAN_KELOMPOK),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareKegiatanKelompokActionOK(
						modelAction.BpjsPcareKegiatanKelompokModelActionTypes.EXPORT_ALL_BPJS_PCARE_KEGIATAN_KELOMPOK_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKegiatanKelompokActionFail(
								modelAction.BpjsPcareKegiatanKelompokModelActionTypes.EXPORT_ALL_BPJS_PCARE_KEGIATAN_KELOMPOK_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKegiatanKelompokAction>(modelAction.BpjsPcareKegiatanKelompokModelActionTypes.EXPORT_BPJS_PCARE_KEGIATAN_KELOMPOK_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareKegiatanKelompokActionOK(
						modelAction.BpjsPcareKegiatanKelompokModelActionTypes.EXPORT_BPJS_PCARE_KEGIATAN_KELOMPOK_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKegiatanKelompokActionFail(
								modelAction.BpjsPcareKegiatanKelompokModelActionTypes.EXPORT_BPJS_PCARE_KEGIATAN_KELOMPOK_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKegiatanKelompokAction>(modelAction.BpjsPcareKegiatanKelompokModelActionTypes.IMPORT_BPJS_PCARE_KEGIATAN_KELOMPOKS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareKegiatanKelompokActionOK(
						modelAction.BpjsPcareKegiatanKelompokModelActionTypes.IMPORT_BPJS_PCARE_KEGIATAN_KELOMPOKS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKegiatanKelompokActionFail(
								modelAction.BpjsPcareKegiatanKelompokModelActionTypes.IMPORT_BPJS_PCARE_KEGIATAN_KELOMPOKS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKegiatanKelompokAction>(modelAction.BpjsPcareKegiatanKelompokModelActionTypes.FETCH_BPJS_PCARE_KEGIATAN_KELOMPOK_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsPcareKegiatanKelompokActionOK(
						modelAction.BpjsPcareKegiatanKelompokModelActionTypes.FETCH_BPJS_PCARE_KEGIATAN_KELOMPOK_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKegiatanKelompokActionFail(
								modelAction.BpjsPcareKegiatanKelompokModelActionTypes.FETCH_BPJS_PCARE_KEGIATAN_KELOMPOK_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareKegiatanKelompokAction>(modelAction.BpjsPcareKegiatanKelompokModelActionTypes.FETCH_BPJS_PCARE_KEGIATAN_KELOMPOK_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsPcareKegiatanKelompokActionOK(
						modelAction.BpjsPcareKegiatanKelompokModelActionTypes.FETCH_BPJS_PCARE_KEGIATAN_KELOMPOK_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareKegiatanKelompokActionFail(
								modelAction.BpjsPcareKegiatanKelompokModelActionTypes.FETCH_BPJS_PCARE_KEGIATAN_KELOMPOK_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
