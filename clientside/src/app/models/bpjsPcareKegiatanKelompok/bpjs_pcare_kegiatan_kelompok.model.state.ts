...
/**
 * BpjsPcareKegiatanKelompokCollectionState would store the state of a collection of BpjsPcareKegiatanKelompok
 */
export interface BpjsPcareKegiatanKelompokCollectionState extends CollectionState {
 ...
 */
export interface BpjsPcareKegiatanKelompokModelAudit extends AbstractModelAudit<BpjsPcareKegiatanKelompokModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsPcareKegiatanKelompokModelState would store the state of the model
 */
export interface BpjsPcareKegiatanKelompokModelState {
	collectionState: {
		[key: string]: BpjsPcareKegiatanKelompokCollectionState;
	};
	data: {
		[id: string]: BpjsPcareKegiatanKelompokModel;
	};
	totalCount: number;
	audits: BpjsPcareKegiatanKelompokModelAudit[];
 ...
 */
export const initialBpjsPcareKegiatanKelompokCollectionState: BpjsPcareKegiatanKelompokCollectionState = {
...
/**
 * The initial state of BpjsPcareKegiatanKelompokModelState
 */
export const initialState: BpjsPcareKegiatanKelompokModelState = {
	collectionState: {
