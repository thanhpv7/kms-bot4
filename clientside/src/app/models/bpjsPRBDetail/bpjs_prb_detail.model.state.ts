...
/**
 * BpjsPRBDetailCollectionState would store the state of a collection of BpjsPRBDetail
 */
export interface BpjsPRBDetailCollectionState extends CollectionState {
 ...
 */
export interface BpjsPRBDetailModelAudit extends AbstractModelAudit<BpjsPRBDetailModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsPRBDetailModelState would store the state of the model
 */
export interface BpjsPRBDetailModelState {
	collectionState: {
		[key: string]: BpjsPRBDetailCollectionState;
	};
	data: {
		[id: string]: BpjsPRBDetailModel;
	};
	totalCount: number;
	audits: BpjsPRBDetailModelAudit[];
 ...
 */
export const initialBpjsPRBDetailCollectionState: BpjsPRBDetailCollectionState = {
...
/**
 * The initial state of BpjsPRBDetailModelState
 */
export const initialState: BpjsPRBDetailModelState = {
	collectionState: {
