...
import * as modelAction from './bpjs_prb_detail.model.action';
import {BpjsPRBDetailService} from '../../services/bpjsPRBDetail/bpjs_prb_detail.service';
...
/**
 * Effect class used for side effects related to BPJS PRB Detail model.
 */
@Injectable()
export class BpjsPRBDetailEffect {
	...
	constructor(
		...
		protected readonly service: BpjsPRBDetailService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPRBDetailAction>(modelAction.BpjsPRBDetailModelActionTypes.COUNT_BPJS_PRB_DETAILS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsPRBDetailActionOK(
						modelAction.BpjsPRBDetailModelActionTypes.COUNT_BPJS_PRB_DETAILS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPRBDetailActionFail(
								modelAction.BpjsPRBDetailModelActionTypes.COUNT_BPJS_PRB_DETAILS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPRBDetailAction>(modelAction.BpjsPRBDetailModelActionTypes.FETCH_BPJS_PRB_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPRBDetailActionOK(
						modelAction.BpjsPRBDetailModelActionTypes.FETCH_BPJS_PRB_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPRBDetailActionFail(
								modelAction.BpjsPRBDetailModelActionTypes.FETCH_BPJS_PRB_DETAIL_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPRBDetailAction>(modelAction.BpjsPRBDetailModelActionTypes.FETCH_ALL_BPJS_PRB_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsPRBDetailActionOK(
						modelAction.BpjsPRBDetailModelActionTypes.FETCH_ALL_BPJS_PRB_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPRBDetailActionFail(
								modelAction.BpjsPRBDetailModelActionTypes.FETCH_ALL_BPJS_PRB_DETAIL_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPRBDetailAction>(modelAction.BpjsPRBDetailModelActionTypes.FETCH_BPJS_PRB_DETAIL_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPRBDetailActionOK(
						modelAction.BpjsPRBDetailModelActionTypes.FETCH_BPJS_PRB_DETAIL_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPRBDetailActionFail(
								modelAction.BpjsPRBDetailModelActionTypes.FETCH_BPJS_PRB_DETAIL_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPRBDetailAction>(modelAction.BpjsPRBDetailModelActionTypes.FETCH_LAST_BPJS_PRB_DETAIL_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPRBDetailActionOK(
						modelAction.BpjsPRBDetailModelActionTypes.FETCH_LAST_BPJS_PRB_DETAIL_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPRBDetailActionFail(
								modelAction.BpjsPRBDetailModelActionTypes.FETCH_LAST_BPJS_PRB_DETAIL_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPRBDetailAction>(modelAction.BpjsPRBDetailModelActionTypes.CREATE_BPJS_PRB_DETAIL),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsPRBDetailModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPRBDetailActionOK(
						modelAction.BpjsPRBDetailModelActionTypes.CREATE_BPJS_PRB_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPRBDetailActionFail(
								modelAction.BpjsPRBDetailModelActionTypes.CREATE_BPJS_PRB_DETAIL_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPRBDetailAction>(modelAction.BpjsPRBDetailModelActionTypes.CREATE_ALL_BPJS_PRB_DETAIL),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsPRBDetailModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPRBDetailActionOK(
						modelAction.BpjsPRBDetailModelActionTypes.CREATE_ALL_BPJS_PRB_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPRBDetailActionFail(
								modelAction.BpjsPRBDetailModelActionTypes.CREATE_ALL_BPJS_PRB_DETAIL_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPRBDetailAction>(modelAction.BpjsPRBDetailModelActionTypes.UPDATE_BPJS_PRB_DETAIL),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsPRBDetailModel;
				...
				return this.service.update(new BpjsPRBDetailModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPRBDetailActionOK(
						modelAction.BpjsPRBDetailModelActionTypes.UPDATE_BPJS_PRB_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPRBDetailActionFail(
								modelAction.BpjsPRBDetailModelActionTypes.UPDATE_BPJS_PRB_DETAIL_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPRBDetailAction>(modelAction.BpjsPRBDetailModelActionTypes.UPDATE_ALL_BPJS_PRB_DETAIL),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsPRBDetailModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsPRBDetailModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPRBDetailActionOK(
						modelAction.BpjsPRBDetailModelActionTypes.UPDATE_ALL_BPJS_PRB_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPRBDetailActionFail(
								modelAction.BpjsPRBDetailModelActionTypes.UPDATE_ALL_BPJS_PRB_DETAIL_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPRBDetailAction>(modelAction.BpjsPRBDetailModelActionTypes.DELETE_BPJS_PRB_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsPRBDetailActionOK(
						modelAction.BpjsPRBDetailModelActionTypes.DELETE_BPJS_PRB_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPRBDetailActionFail(
								modelAction.BpjsPRBDetailModelActionTypes.DELETE_BPJS_PRB_DETAIL_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPRBDetailAction>(modelAction.BpjsPRBDetailModelActionTypes.DELETE_BPJS_PRB_DETAIL_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsPRBDetailActionOK(
						modelAction.BpjsPRBDetailModelActionTypes.DELETE_BPJS_PRB_DETAIL_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPRBDetailActionFail(
								modelAction.BpjsPRBDetailModelActionTypes.DELETE_BPJS_PRB_DETAIL_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPRBDetailAction>(modelAction.BpjsPRBDetailModelActionTypes.DELETE_ALL_BPJS_PRB_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsPRBDetailActionOK(
						modelAction.BpjsPRBDetailModelActionTypes.DELETE_ALL_BPJS_PRB_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPRBDetailActionFail(
								modelAction.BpjsPRBDetailModelActionTypes.DELETE_ALL_BPJS_PRB_DETAIL_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPRBDetailAction>(modelAction.BpjsPRBDetailModelActionTypes.EXPORT_BPJS_PRB_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsPRBDetailActionOK(
						modelAction.BpjsPRBDetailModelActionTypes.EXPORT_BPJS_PRB_DETAIL,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPRBDetailAction>(modelAction.BpjsPRBDetailModelActionTypes.EXPORT_ALL_BPJS_PRB_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsPRBDetailActionOK(
						modelAction.BpjsPRBDetailModelActionTypes.EXPORT_ALL_BPJS_PRB_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPRBDetailActionFail(
								modelAction.BpjsPRBDetailModelActionTypes.EXPORT_ALL_BPJS_PRB_DETAIL_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPRBDetailAction>(modelAction.BpjsPRBDetailModelActionTypes.EXPORT_BPJS_PRB_DETAIL_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsPRBDetailActionOK(
						modelAction.BpjsPRBDetailModelActionTypes.EXPORT_BPJS_PRB_DETAIL_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPRBDetailActionFail(
								modelAction.BpjsPRBDetailModelActionTypes.EXPORT_BPJS_PRB_DETAIL_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPRBDetailAction>(modelAction.BpjsPRBDetailModelActionTypes.IMPORT_BPJS_PRB_DETAILS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsPRBDetailActionOK(
						modelAction.BpjsPRBDetailModelActionTypes.IMPORT_BPJS_PRB_DETAILS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPRBDetailActionFail(
								modelAction.BpjsPRBDetailModelActionTypes.IMPORT_BPJS_PRB_DETAILS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPRBDetailAction>(modelAction.BpjsPRBDetailModelActionTypes.FETCH_BPJS_PRB_DETAIL_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsPRBDetailActionOK(
						modelAction.BpjsPRBDetailModelActionTypes.FETCH_BPJS_PRB_DETAIL_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPRBDetailActionFail(
								modelAction.BpjsPRBDetailModelActionTypes.FETCH_BPJS_PRB_DETAIL_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPRBDetailAction>(modelAction.BpjsPRBDetailModelActionTypes.FETCH_BPJS_PRB_DETAIL_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsPRBDetailActionOK(
						modelAction.BpjsPRBDetailModelActionTypes.FETCH_BPJS_PRB_DETAIL_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPRBDetailActionFail(
								modelAction.BpjsPRBDetailModelActionTypes.FETCH_BPJS_PRB_DETAIL_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
