...
import * as modelAction from './bpjs_diagnose_prb.model.action';
import {BpjsDiagnosePRBService} from '../../services/bpjsDiagnosePRB/bpjs_diagnose_prb.service';
...
/**
 * Effect class used for side effects related to BPJS Diagnose PRB model.
 */
@Injectable()
export class BpjsDiagnosePRBEffect {
	...
	constructor(
		...
		protected readonly service: BpjsDiagnosePRBService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDiagnosePRBAction>(modelAction.BpjsDiagnosePRBModelActionTypes.COUNT_BPJS_DIAGNOSE_PRBS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsDiagnosePRBActionOK(
						modelAction.BpjsDiagnosePRBModelActionTypes.COUNT_BPJS_DIAGNOSE_PRBS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDiagnosePRBActionFail(
								modelAction.BpjsDiagnosePRBModelActionTypes.COUNT_BPJS_DIAGNOSE_PRBS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDiagnosePRBAction>(modelAction.BpjsDiagnosePRBModelActionTypes.FETCH_BPJS_DIAGNOSE_PRB),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsDiagnosePRBActionOK(
						modelAction.BpjsDiagnosePRBModelActionTypes.FETCH_BPJS_DIAGNOSE_PRB_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDiagnosePRBActionFail(
								modelAction.BpjsDiagnosePRBModelActionTypes.FETCH_BPJS_DIAGNOSE_PRB_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDiagnosePRBAction>(modelAction.BpjsDiagnosePRBModelActionTypes.FETCH_ALL_BPJS_DIAGNOSE_PRB),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsDiagnosePRBActionOK(
						modelAction.BpjsDiagnosePRBModelActionTypes.FETCH_ALL_BPJS_DIAGNOSE_PRB_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDiagnosePRBActionFail(
								modelAction.BpjsDiagnosePRBModelActionTypes.FETCH_ALL_BPJS_DIAGNOSE_PRB_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDiagnosePRBAction>(modelAction.BpjsDiagnosePRBModelActionTypes.FETCH_BPJS_DIAGNOSE_PRB_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsDiagnosePRBActionOK(
						modelAction.BpjsDiagnosePRBModelActionTypes.FETCH_BPJS_DIAGNOSE_PRB_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDiagnosePRBActionFail(
								modelAction.BpjsDiagnosePRBModelActionTypes.FETCH_BPJS_DIAGNOSE_PRB_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDiagnosePRBAction>(modelAction.BpjsDiagnosePRBModelActionTypes.FETCH_LAST_BPJS_DIAGNOSE_PRB_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsDiagnosePRBActionOK(
						modelAction.BpjsDiagnosePRBModelActionTypes.FETCH_LAST_BPJS_DIAGNOSE_PRB_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDiagnosePRBActionFail(
								modelAction.BpjsDiagnosePRBModelActionTypes.FETCH_LAST_BPJS_DIAGNOSE_PRB_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDiagnosePRBAction>(modelAction.BpjsDiagnosePRBModelActionTypes.CREATE_BPJS_DIAGNOSE_PRB),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsDiagnosePRBModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsDiagnosePRBActionOK(
						modelAction.BpjsDiagnosePRBModelActionTypes.CREATE_BPJS_DIAGNOSE_PRB_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDiagnosePRBActionFail(
								modelAction.BpjsDiagnosePRBModelActionTypes.CREATE_BPJS_DIAGNOSE_PRB_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDiagnosePRBAction>(modelAction.BpjsDiagnosePRBModelActionTypes.CREATE_ALL_BPJS_DIAGNOSE_PRB),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsDiagnosePRBModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsDiagnosePRBActionOK(
						modelAction.BpjsDiagnosePRBModelActionTypes.CREATE_ALL_BPJS_DIAGNOSE_PRB_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDiagnosePRBActionFail(
								modelAction.BpjsDiagnosePRBModelActionTypes.CREATE_ALL_BPJS_DIAGNOSE_PRB_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDiagnosePRBAction>(modelAction.BpjsDiagnosePRBModelActionTypes.UPDATE_BPJS_DIAGNOSE_PRB),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsDiagnosePRBModel;
				...
				return this.service.update(new BpjsDiagnosePRBModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsDiagnosePRBActionOK(
						modelAction.BpjsDiagnosePRBModelActionTypes.UPDATE_BPJS_DIAGNOSE_PRB_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDiagnosePRBActionFail(
								modelAction.BpjsDiagnosePRBModelActionTypes.UPDATE_BPJS_DIAGNOSE_PRB_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDiagnosePRBAction>(modelAction.BpjsDiagnosePRBModelActionTypes.UPDATE_ALL_BPJS_DIAGNOSE_PRB),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsDiagnosePRBModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsDiagnosePRBModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsDiagnosePRBActionOK(
						modelAction.BpjsDiagnosePRBModelActionTypes.UPDATE_ALL_BPJS_DIAGNOSE_PRB_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDiagnosePRBActionFail(
								modelAction.BpjsDiagnosePRBModelActionTypes.UPDATE_ALL_BPJS_DIAGNOSE_PRB_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDiagnosePRBAction>(modelAction.BpjsDiagnosePRBModelActionTypes.DELETE_BPJS_DIAGNOSE_PRB),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsDiagnosePRBActionOK(
						modelAction.BpjsDiagnosePRBModelActionTypes.DELETE_BPJS_DIAGNOSE_PRB_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDiagnosePRBActionFail(
								modelAction.BpjsDiagnosePRBModelActionTypes.DELETE_BPJS_DIAGNOSE_PRB_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDiagnosePRBAction>(modelAction.BpjsDiagnosePRBModelActionTypes.DELETE_BPJS_DIAGNOSE_PRB_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsDiagnosePRBActionOK(
						modelAction.BpjsDiagnosePRBModelActionTypes.DELETE_BPJS_DIAGNOSE_PRB_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDiagnosePRBActionFail(
								modelAction.BpjsDiagnosePRBModelActionTypes.DELETE_BPJS_DIAGNOSE_PRB_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDiagnosePRBAction>(modelAction.BpjsDiagnosePRBModelActionTypes.DELETE_ALL_BPJS_DIAGNOSE_PRB),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsDiagnosePRBActionOK(
						modelAction.BpjsDiagnosePRBModelActionTypes.DELETE_ALL_BPJS_DIAGNOSE_PRB_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDiagnosePRBActionFail(
								modelAction.BpjsDiagnosePRBModelActionTypes.DELETE_ALL_BPJS_DIAGNOSE_PRB_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDiagnosePRBAction>(modelAction.BpjsDiagnosePRBModelActionTypes.EXPORT_BPJS_DIAGNOSE_PRB),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsDiagnosePRBActionOK(
						modelAction.BpjsDiagnosePRBModelActionTypes.EXPORT_BPJS_DIAGNOSE_PRB,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDiagnosePRBAction>(modelAction.BpjsDiagnosePRBModelActionTypes.EXPORT_ALL_BPJS_DIAGNOSE_PRB),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsDiagnosePRBActionOK(
						modelAction.BpjsDiagnosePRBModelActionTypes.EXPORT_ALL_BPJS_DIAGNOSE_PRB_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDiagnosePRBActionFail(
								modelAction.BpjsDiagnosePRBModelActionTypes.EXPORT_ALL_BPJS_DIAGNOSE_PRB_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDiagnosePRBAction>(modelAction.BpjsDiagnosePRBModelActionTypes.EXPORT_BPJS_DIAGNOSE_PRB_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsDiagnosePRBActionOK(
						modelAction.BpjsDiagnosePRBModelActionTypes.EXPORT_BPJS_DIAGNOSE_PRB_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDiagnosePRBActionFail(
								modelAction.BpjsDiagnosePRBModelActionTypes.EXPORT_BPJS_DIAGNOSE_PRB_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDiagnosePRBAction>(modelAction.BpjsDiagnosePRBModelActionTypes.IMPORT_BPJS_DIAGNOSE_PRBS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsDiagnosePRBActionOK(
						modelAction.BpjsDiagnosePRBModelActionTypes.IMPORT_BPJS_DIAGNOSE_PRBS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDiagnosePRBActionFail(
								modelAction.BpjsDiagnosePRBModelActionTypes.IMPORT_BPJS_DIAGNOSE_PRBS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDiagnosePRBAction>(modelAction.BpjsDiagnosePRBModelActionTypes.FETCH_BPJS_DIAGNOSE_PRB_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsDiagnosePRBActionOK(
						modelAction.BpjsDiagnosePRBModelActionTypes.FETCH_BPJS_DIAGNOSE_PRB_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDiagnosePRBActionFail(
								modelAction.BpjsDiagnosePRBModelActionTypes.FETCH_BPJS_DIAGNOSE_PRB_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDiagnosePRBAction>(modelAction.BpjsDiagnosePRBModelActionTypes.FETCH_BPJS_DIAGNOSE_PRB_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsDiagnosePRBActionOK(
						modelAction.BpjsDiagnosePRBModelActionTypes.FETCH_BPJS_DIAGNOSE_PRB_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDiagnosePRBActionFail(
								modelAction.BpjsDiagnosePRBModelActionTypes.FETCH_BPJS_DIAGNOSE_PRB_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
