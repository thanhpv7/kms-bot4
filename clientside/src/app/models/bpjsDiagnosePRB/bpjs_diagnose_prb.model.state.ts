...
/**
 * BpjsDiagnosePRBCollectionState would store the state of a collection of BpjsDiagnosePRB
 */
export interface BpjsDiagnosePRBCollectionState extends CollectionState {
 ...
 */
export interface BpjsDiagnosePRBModelAudit extends AbstractModelAudit<BpjsDiagnosePRBModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsDiagnosePRBModelState would store the state of the model
 */
export interface BpjsDiagnosePRBModelState {
	collectionState: {
		[key: string]: BpjsDiagnosePRBCollectionState;
	};
	data: {
		[id: string]: BpjsDiagnosePRBModel;
	};
	totalCount: number;
	audits: BpjsDiagnosePRBModelAudit[];
 ...
 */
export const initialBpjsDiagnosePRBCollectionState: BpjsDiagnosePRBCollectionState = {
...
/**
 * The initial state of BpjsDiagnosePRBModelState
 */
export const initialState: BpjsDiagnosePRBModelState = {
	collectionState: {
