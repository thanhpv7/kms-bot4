...
/**
 * ClaimUserCollectionState would store the state of a collection of ClaimUser
 */
export interface ClaimUserCollectionState extends CollectionState {
 ...
 */
export interface ClaimUserModelAudit extends AbstractModelAudit<ClaimUserModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * ClaimUserModelState would store the state of the model
 */
export interface ClaimUserModelState {
	collectionState: {
		[key: string]: ClaimUserCollectionState;
	};
	data: {
		[id: string]: ClaimUserModel;
	};
	totalCount: number;
	audits: ClaimUserModelAudit[];
 ...
 */
export const initialClaimUserCollectionState: ClaimUserCollectionState = {
...
/**
 * The initial state of ClaimUserModelState
 */
export const initialState: ClaimUserModelState = {
	collectionState: {
