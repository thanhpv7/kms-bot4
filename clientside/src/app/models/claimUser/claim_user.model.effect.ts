...
import * as modelAction from './claim_user.model.action';
import {ClaimUserService} from '../../services/claimUser/claim_user.service';
...
/**
 * Effect class used for side effects related to Claim User model.
 */
@Injectable()
export class ClaimUserEffect {
	...
	constructor(
		...
		protected readonly service: ClaimUserService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ClaimUserAction>(modelAction.ClaimUserModelActionTypes.COUNT_CLAIM_USERS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.ClaimUserActionOK(
						modelAction.ClaimUserModelActionTypes.COUNT_CLAIM_USERS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ClaimUserActionFail(
								modelAction.ClaimUserModelActionTypes.COUNT_CLAIM_USERS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ClaimUserAction>(modelAction.ClaimUserModelActionTypes.FETCH_CLAIM_USER),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ClaimUserActionOK(
						modelAction.ClaimUserModelActionTypes.FETCH_CLAIM_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ClaimUserActionFail(
								modelAction.ClaimUserModelActionTypes.FETCH_CLAIM_USER_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ClaimUserAction>(modelAction.ClaimUserModelActionTypes.FETCH_ALL_CLAIM_USER),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.ClaimUserActionOK(
						modelAction.ClaimUserModelActionTypes.FETCH_ALL_CLAIM_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ClaimUserActionFail(
								modelAction.ClaimUserModelActionTypes.FETCH_ALL_CLAIM_USER_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ClaimUserAction>(modelAction.ClaimUserModelActionTypes.FETCH_CLAIM_USER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.ClaimUserActionOK(
						modelAction.ClaimUserModelActionTypes.FETCH_CLAIM_USER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ClaimUserActionFail(
								modelAction.ClaimUserModelActionTypes.FETCH_CLAIM_USER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ClaimUserAction>(modelAction.ClaimUserModelActionTypes.FETCH_LAST_CLAIM_USER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.ClaimUserActionOK(
						modelAction.ClaimUserModelActionTypes.FETCH_LAST_CLAIM_USER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ClaimUserActionFail(
								modelAction.ClaimUserModelActionTypes.FETCH_LAST_CLAIM_USER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ClaimUserAction>(modelAction.ClaimUserModelActionTypes.CREATE_CLAIM_USER),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as ClaimUserModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ClaimUserActionOK(
						modelAction.ClaimUserModelActionTypes.CREATE_CLAIM_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ClaimUserActionFail(
								modelAction.ClaimUserModelActionTypes.CREATE_CLAIM_USER_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ClaimUserAction>(modelAction.ClaimUserModelActionTypes.CREATE_ALL_CLAIM_USER),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as ClaimUserModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ClaimUserActionOK(
						modelAction.ClaimUserModelActionTypes.CREATE_ALL_CLAIM_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ClaimUserActionFail(
								modelAction.ClaimUserModelActionTypes.CREATE_ALL_CLAIM_USER_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ClaimUserAction>(modelAction.ClaimUserModelActionTypes.UPDATE_CLAIM_USER),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as ClaimUserModel;
				...
				return this.service.update(new ClaimUserModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.ClaimUserActionOK(
						modelAction.ClaimUserModelActionTypes.UPDATE_CLAIM_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ClaimUserActionFail(
								modelAction.ClaimUserModelActionTypes.UPDATE_CLAIM_USER_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ClaimUserAction>(modelAction.ClaimUserModelActionTypes.UPDATE_ALL_CLAIM_USER),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as ClaimUserModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new ClaimUserModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ClaimUserActionOK(
						modelAction.ClaimUserModelActionTypes.UPDATE_ALL_CLAIM_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ClaimUserActionFail(
								modelAction.ClaimUserModelActionTypes.UPDATE_ALL_CLAIM_USER_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ClaimUserAction>(modelAction.ClaimUserModelActionTypes.DELETE_CLAIM_USER),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.ClaimUserActionOK(
						modelAction.ClaimUserModelActionTypes.DELETE_CLAIM_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ClaimUserActionFail(
								modelAction.ClaimUserModelActionTypes.DELETE_CLAIM_USER_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ClaimUserAction>(modelAction.ClaimUserModelActionTypes.DELETE_CLAIM_USER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.ClaimUserActionOK(
						modelAction.ClaimUserModelActionTypes.DELETE_CLAIM_USER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ClaimUserActionFail(
								modelAction.ClaimUserModelActionTypes.DELETE_CLAIM_USER_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ClaimUserAction>(modelAction.ClaimUserModelActionTypes.DELETE_ALL_CLAIM_USER),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.ClaimUserActionOK(
						modelAction.ClaimUserModelActionTypes.DELETE_ALL_CLAIM_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ClaimUserActionFail(
								modelAction.ClaimUserModelActionTypes.DELETE_ALL_CLAIM_USER_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ClaimUserAction>(modelAction.ClaimUserModelActionTypes.EXPORT_CLAIM_USER),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ClaimUserActionOK(
						modelAction.ClaimUserModelActionTypes.EXPORT_CLAIM_USER,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ClaimUserAction>(modelAction.ClaimUserModelActionTypes.EXPORT_ALL_CLAIM_USER),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ClaimUserActionOK(
						modelAction.ClaimUserModelActionTypes.EXPORT_ALL_CLAIM_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ClaimUserActionFail(
								modelAction.ClaimUserModelActionTypes.EXPORT_ALL_CLAIM_USER_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ClaimUserAction>(modelAction.ClaimUserModelActionTypes.EXPORT_CLAIM_USER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ClaimUserActionOK(
						modelAction.ClaimUserModelActionTypes.EXPORT_CLAIM_USER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ClaimUserActionFail(
								modelAction.ClaimUserModelActionTypes.EXPORT_CLAIM_USER_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ClaimUserAction>(modelAction.ClaimUserModelActionTypes.IMPORT_CLAIM_USERS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.ClaimUserActionOK(
						modelAction.ClaimUserModelActionTypes.IMPORT_CLAIM_USERS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ClaimUserActionFail(
								modelAction.ClaimUserModelActionTypes.IMPORT_CLAIM_USERS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ClaimUserAction>(modelAction.ClaimUserModelActionTypes.FETCH_CLAIM_USER_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.ClaimUserActionOK(
						modelAction.ClaimUserModelActionTypes.FETCH_CLAIM_USER_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.ClaimUserActionFail(
								modelAction.ClaimUserModelActionTypes.FETCH_CLAIM_USER_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ClaimUserAction>(modelAction.ClaimUserModelActionTypes.FETCH_CLAIM_USER_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.ClaimUserActionOK(
						modelAction.ClaimUserModelActionTypes.FETCH_CLAIM_USER_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.ClaimUserActionFail(
								modelAction.ClaimUserModelActionTypes.FETCH_CLAIM_USER_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
