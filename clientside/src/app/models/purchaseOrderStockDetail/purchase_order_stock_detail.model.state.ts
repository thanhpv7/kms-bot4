...
/**
 * PurchaseOrderStockDetailCollectionState would store the state of a collection of PurchaseOrderStockDetail
 */
export interface PurchaseOrderStockDetailCollectionState extends CollectionState {
 ...
 */
export interface PurchaseOrderStockDetailModelAudit extends AbstractModelAudit<PurchaseOrderStockDetailModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * PurchaseOrderStockDetailModelState would store the state of the model
 */
export interface PurchaseOrderStockDetailModelState {
	collectionState: {
		[key: string]: PurchaseOrderStockDetailCollectionState;
	};
	data: {
		[id: string]: PurchaseOrderStockDetailModel;
	};
	totalCount: number;
	audits: PurchaseOrderStockDetailModelAudit[];
 ...
 */
export const initialPurchaseOrderStockDetailCollectionState: PurchaseOrderStockDetailCollectionState = {
...
/**
 * The initial state of PurchaseOrderStockDetailModelState
 */
export const initialState: PurchaseOrderStockDetailModelState = {
	collectionState: {
