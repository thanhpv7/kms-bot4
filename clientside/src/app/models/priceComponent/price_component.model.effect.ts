...
import * as modelAction from './price_component.model.action';
import {PriceComponentService} from '../../services/priceComponent/price_component.service';
...
/**
 * Effect class used for side effects related to Price Component model.
 */
@Injectable()
export class PriceComponentEffect {
	...
	constructor(
		...
		protected readonly service: PriceComponentService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PriceComponentAction>(modelAction.PriceComponentModelActionTypes.COUNT_PRICE_COMPONENTS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.PriceComponentActionOK(
						modelAction.PriceComponentModelActionTypes.COUNT_PRICE_COMPONENTS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PriceComponentActionFail(
								modelAction.PriceComponentModelActionTypes.COUNT_PRICE_COMPONENTS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PriceComponentAction>(modelAction.PriceComponentModelActionTypes.FETCH_PRICE_COMPONENT),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PriceComponentActionOK(
						modelAction.PriceComponentModelActionTypes.FETCH_PRICE_COMPONENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PriceComponentActionFail(
								modelAction.PriceComponentModelActionTypes.FETCH_PRICE_COMPONENT_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PriceComponentAction>(modelAction.PriceComponentModelActionTypes.FETCH_ALL_PRICE_COMPONENT),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.PriceComponentActionOK(
						modelAction.PriceComponentModelActionTypes.FETCH_ALL_PRICE_COMPONENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PriceComponentActionFail(
								modelAction.PriceComponentModelActionTypes.FETCH_ALL_PRICE_COMPONENT_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PriceComponentAction>(modelAction.PriceComponentModelActionTypes.FETCH_PRICE_COMPONENT_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PriceComponentActionOK(
						modelAction.PriceComponentModelActionTypes.FETCH_PRICE_COMPONENT_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PriceComponentActionFail(
								modelAction.PriceComponentModelActionTypes.FETCH_PRICE_COMPONENT_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PriceComponentAction>(modelAction.PriceComponentModelActionTypes.FETCH_LAST_PRICE_COMPONENT_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PriceComponentActionOK(
						modelAction.PriceComponentModelActionTypes.FETCH_LAST_PRICE_COMPONENT_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PriceComponentActionFail(
								modelAction.PriceComponentModelActionTypes.FETCH_LAST_PRICE_COMPONENT_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PriceComponentAction>(modelAction.PriceComponentModelActionTypes.CREATE_PRICE_COMPONENT),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as PriceComponentModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PriceComponentActionOK(
						modelAction.PriceComponentModelActionTypes.CREATE_PRICE_COMPONENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PriceComponentActionFail(
								modelAction.PriceComponentModelActionTypes.CREATE_PRICE_COMPONENT_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PriceComponentAction>(modelAction.PriceComponentModelActionTypes.CREATE_ALL_PRICE_COMPONENT),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as PriceComponentModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PriceComponentActionOK(
						modelAction.PriceComponentModelActionTypes.CREATE_ALL_PRICE_COMPONENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PriceComponentActionFail(
								modelAction.PriceComponentModelActionTypes.CREATE_ALL_PRICE_COMPONENT_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PriceComponentAction>(modelAction.PriceComponentModelActionTypes.UPDATE_PRICE_COMPONENT),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as PriceComponentModel;
				...
				return this.service.update(new PriceComponentModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.PriceComponentActionOK(
						modelAction.PriceComponentModelActionTypes.UPDATE_PRICE_COMPONENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PriceComponentActionFail(
								modelAction.PriceComponentModelActionTypes.UPDATE_PRICE_COMPONENT_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PriceComponentAction>(modelAction.PriceComponentModelActionTypes.UPDATE_ALL_PRICE_COMPONENT),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as PriceComponentModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new PriceComponentModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PriceComponentActionOK(
						modelAction.PriceComponentModelActionTypes.UPDATE_ALL_PRICE_COMPONENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PriceComponentActionFail(
								modelAction.PriceComponentModelActionTypes.UPDATE_ALL_PRICE_COMPONENT_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PriceComponentAction>(modelAction.PriceComponentModelActionTypes.DELETE_PRICE_COMPONENT),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PriceComponentActionOK(
						modelAction.PriceComponentModelActionTypes.DELETE_PRICE_COMPONENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PriceComponentActionFail(
								modelAction.PriceComponentModelActionTypes.DELETE_PRICE_COMPONENT_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PriceComponentAction>(modelAction.PriceComponentModelActionTypes.DELETE_PRICE_COMPONENT_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.PriceComponentActionOK(
						modelAction.PriceComponentModelActionTypes.DELETE_PRICE_COMPONENT_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PriceComponentActionFail(
								modelAction.PriceComponentModelActionTypes.DELETE_PRICE_COMPONENT_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PriceComponentAction>(modelAction.PriceComponentModelActionTypes.DELETE_ALL_PRICE_COMPONENT),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PriceComponentActionOK(
						modelAction.PriceComponentModelActionTypes.DELETE_ALL_PRICE_COMPONENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PriceComponentActionFail(
								modelAction.PriceComponentModelActionTypes.DELETE_ALL_PRICE_COMPONENT_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PriceComponentAction>(modelAction.PriceComponentModelActionTypes.EXPORT_PRICE_COMPONENT),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PriceComponentActionOK(
						modelAction.PriceComponentModelActionTypes.EXPORT_PRICE_COMPONENT,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PriceComponentAction>(modelAction.PriceComponentModelActionTypes.EXPORT_ALL_PRICE_COMPONENT),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PriceComponentActionOK(
						modelAction.PriceComponentModelActionTypes.EXPORT_ALL_PRICE_COMPONENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PriceComponentActionFail(
								modelAction.PriceComponentModelActionTypes.EXPORT_ALL_PRICE_COMPONENT_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PriceComponentAction>(modelAction.PriceComponentModelActionTypes.EXPORT_PRICE_COMPONENT_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PriceComponentActionOK(
						modelAction.PriceComponentModelActionTypes.EXPORT_PRICE_COMPONENT_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PriceComponentActionFail(
								modelAction.PriceComponentModelActionTypes.EXPORT_PRICE_COMPONENT_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PriceComponentAction>(modelAction.PriceComponentModelActionTypes.IMPORT_PRICE_COMPONENTS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.PriceComponentActionOK(
						modelAction.PriceComponentModelActionTypes.IMPORT_PRICE_COMPONENTS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PriceComponentActionFail(
								modelAction.PriceComponentModelActionTypes.IMPORT_PRICE_COMPONENTS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PriceComponentAction>(modelAction.PriceComponentModelActionTypes.FETCH_PRICE_COMPONENT_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.PriceComponentActionOK(
						modelAction.PriceComponentModelActionTypes.FETCH_PRICE_COMPONENT_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PriceComponentActionFail(
								modelAction.PriceComponentModelActionTypes.FETCH_PRICE_COMPONENT_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PriceComponentAction>(modelAction.PriceComponentModelActionTypes.FETCH_PRICE_COMPONENT_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.PriceComponentActionOK(
						modelAction.PriceComponentModelActionTypes.FETCH_PRICE_COMPONENT_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PriceComponentActionFail(
								modelAction.PriceComponentModelActionTypes.FETCH_PRICE_COMPONENT_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
