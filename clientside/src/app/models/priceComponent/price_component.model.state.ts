...
/**
 * PriceComponentCollectionState would store the state of a collection of PriceComponent
 */
export interface PriceComponentCollectionState extends CollectionState {
 ...
 */
export interface PriceComponentModelAudit extends AbstractModelAudit<PriceComponentModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * PriceComponentModelState would store the state of the model
 */
export interface PriceComponentModelState {
	collectionState: {
		[key: string]: PriceComponentCollectionState;
	};
	data: {
		[id: string]: PriceComponentModel;
	};
	totalCount: number;
	audits: PriceComponentModelAudit[];
 ...
 */
export const initialPriceComponentCollectionState: PriceComponentCollectionState = {
...
/**
 * The initial state of PriceComponentModelState
 */
export const initialState: PriceComponentModelState = {
	collectionState: {
