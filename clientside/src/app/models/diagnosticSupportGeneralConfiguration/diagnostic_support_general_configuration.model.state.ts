...
/**
 * DiagnosticSupportGeneralConfigurationCollectionState would store the state of a collection of DiagnosticSupportGeneralConfiguration
 */
export interface DiagnosticSupportGeneralConfigurationCollectionState extends CollectionState {
 ...
 */
export interface DiagnosticSupportGeneralConfigurationModelAudit extends AbstractModelAudit<DiagnosticSupportGeneralConfigurationModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * DiagnosticSupportGeneralConfigurationModelState would store the state of the model
 */
export interface DiagnosticSupportGeneralConfigurationModelState {
	collectionState: {
		[key: string]: DiagnosticSupportGeneralConfigurationCollectionState;
	};
	data: {
		[id: string]: DiagnosticSupportGeneralConfigurationModel;
	};
	totalCount: number;
	audits: DiagnosticSupportGeneralConfigurationModelAudit[];
 ...
 */
export const initialDiagnosticSupportGeneralConfigurationCollectionState: DiagnosticSupportGeneralConfigurationCollectionState = {
...
/**
 * The initial state of DiagnosticSupportGeneralConfigurationModelState
 */
export const initialState: DiagnosticSupportGeneralConfigurationModelState = {
	collectionState: {
