...
import * as modelAction from './diagnostic_support_general_configuration.model.action';
import {DiagnosticSupportGeneralConfigurationService} from '../../services/diagnosticSupportGeneralConfiguration/diagnostic_support_general_configuration.service';
...
/**
 * Effect class used for side effects related to Diagnostic Support General Configuration model.
 */
@Injectable()
export class DiagnosticSupportGeneralConfigurationEffect {
	...
	constructor(
		...
		protected readonly service: DiagnosticSupportGeneralConfigurationService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticSupportGeneralConfigurationAction>(modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.COUNT_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATIONS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.DiagnosticSupportGeneralConfigurationActionOK(
						modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.COUNT_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATIONS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticSupportGeneralConfigurationActionFail(
								modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.COUNT_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATIONS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticSupportGeneralConfigurationAction>(modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.FETCH_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATION),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticSupportGeneralConfigurationActionOK(
						modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.FETCH_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticSupportGeneralConfigurationActionFail(
								modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.FETCH_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATION_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticSupportGeneralConfigurationAction>(modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.FETCH_ALL_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATION),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.DiagnosticSupportGeneralConfigurationActionOK(
						modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.FETCH_ALL_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticSupportGeneralConfigurationActionFail(
								modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.FETCH_ALL_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATION_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticSupportGeneralConfigurationAction>(modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.FETCH_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATION_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticSupportGeneralConfigurationActionOK(
						modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.FETCH_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATION_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticSupportGeneralConfigurationActionFail(
								modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.FETCH_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATION_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticSupportGeneralConfigurationAction>(modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.FETCH_LAST_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATION_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticSupportGeneralConfigurationActionOK(
						modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.FETCH_LAST_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATION_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticSupportGeneralConfigurationActionFail(
								modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.FETCH_LAST_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATION_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticSupportGeneralConfigurationAction>(modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.CREATE_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATION),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as DiagnosticSupportGeneralConfigurationModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticSupportGeneralConfigurationActionOK(
						modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.CREATE_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticSupportGeneralConfigurationActionFail(
								modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.CREATE_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATION_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticSupportGeneralConfigurationAction>(modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.CREATE_ALL_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATION),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as DiagnosticSupportGeneralConfigurationModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticSupportGeneralConfigurationActionOK(
						modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.CREATE_ALL_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticSupportGeneralConfigurationActionFail(
								modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.CREATE_ALL_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATION_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticSupportGeneralConfigurationAction>(modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.UPDATE_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATION),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as DiagnosticSupportGeneralConfigurationModel;
				...
				return this.service.update(new DiagnosticSupportGeneralConfigurationModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticSupportGeneralConfigurationActionOK(
						modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.UPDATE_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticSupportGeneralConfigurationActionFail(
								modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.UPDATE_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATION_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticSupportGeneralConfigurationAction>(modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.UPDATE_ALL_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATION),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as DiagnosticSupportGeneralConfigurationModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new DiagnosticSupportGeneralConfigurationModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticSupportGeneralConfigurationActionOK(
						modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.UPDATE_ALL_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticSupportGeneralConfigurationActionFail(
								modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.UPDATE_ALL_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATION_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticSupportGeneralConfigurationAction>(modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.DELETE_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATION),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticSupportGeneralConfigurationActionOK(
						modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.DELETE_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticSupportGeneralConfigurationActionFail(
								modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.DELETE_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATION_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticSupportGeneralConfigurationAction>(modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.DELETE_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATION_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticSupportGeneralConfigurationActionOK(
						modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.DELETE_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATION_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticSupportGeneralConfigurationActionFail(
								modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.DELETE_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATION_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticSupportGeneralConfigurationAction>(modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.DELETE_ALL_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATION),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticSupportGeneralConfigurationActionOK(
						modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.DELETE_ALL_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticSupportGeneralConfigurationActionFail(
								modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.DELETE_ALL_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATION_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticSupportGeneralConfigurationAction>(modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.EXPORT_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATION),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticSupportGeneralConfigurationActionOK(
						modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.EXPORT_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATION,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticSupportGeneralConfigurationAction>(modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.EXPORT_ALL_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATION),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticSupportGeneralConfigurationActionOK(
						modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.EXPORT_ALL_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticSupportGeneralConfigurationActionFail(
								modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.EXPORT_ALL_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATION_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticSupportGeneralConfigurationAction>(modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.EXPORT_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATION_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticSupportGeneralConfigurationActionOK(
						modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.EXPORT_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATION_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticSupportGeneralConfigurationActionFail(
								modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.EXPORT_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATION_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticSupportGeneralConfigurationAction>(modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.IMPORT_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATIONS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.DiagnosticSupportGeneralConfigurationActionOK(
						modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.IMPORT_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATIONS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticSupportGeneralConfigurationActionFail(
								modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.IMPORT_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATIONS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticSupportGeneralConfigurationAction>(modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.FETCH_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATION_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.DiagnosticSupportGeneralConfigurationActionOK(
						modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.FETCH_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATION_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticSupportGeneralConfigurationActionFail(
								modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.FETCH_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATION_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DiagnosticSupportGeneralConfigurationAction>(modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.FETCH_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATION_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.DiagnosticSupportGeneralConfigurationActionOK(
						modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.FETCH_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATION_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.DiagnosticSupportGeneralConfigurationActionFail(
								modelAction.DiagnosticSupportGeneralConfigurationModelActionTypes.FETCH_DIAGNOSTIC_SUPPORT_GENERAL_CONFIGURATION_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
