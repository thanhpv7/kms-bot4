...
/**
 * MedicalCertificateHospitalizationCollectionState would store the state of a collection of MedicalCertificateHospitalization
 */
export interface MedicalCertificateHospitalizationCollectionState extends CollectionState {
 ...
 */
export interface MedicalCertificateHospitalizationModelAudit extends AbstractModelAudit<MedicalCertificateHospitalizationModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * MedicalCertificateHospitalizationModelState would store the state of the model
 */
export interface MedicalCertificateHospitalizationModelState {
	collectionState: {
		[key: string]: MedicalCertificateHospitalizationCollectionState;
	};
	data: {
		[id: string]: MedicalCertificateHospitalizationModel;
	};
	totalCount: number;
	audits: MedicalCertificateHospitalizationModelAudit[];
 ...
 */
export const initialMedicalCertificateHospitalizationCollectionState: MedicalCertificateHospitalizationCollectionState = {
...
/**
 * The initial state of MedicalCertificateHospitalizationModelState
 */
export const initialState: MedicalCertificateHospitalizationModelState = {
	collectionState: {
