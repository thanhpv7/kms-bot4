...
import {initialMedicalCertificateHospitalizationCollectionState} from './medical_certificate_hospitalization.model.state';
...
export function modelReducer(currentState: ModelState, action: Action): ModelState {
	...
	const className = (action as modelAction.BaseMedicalCertificateHospitalizationAction).className;
	...
	return produce(currentState, draft => {
		...
		switch (action.type) {
			case modelAction.MedicalCertificateHospitalizationModelActionTypes.CREATE_MEDICAL_CERTIFICATE_HOSPITALIZATION_OK:
				const createdModel = (action as modelAction.MedicalCertificateHospitalizationActionOK ).stateConfig.targetModel;
				...
				MedicalCertificateHospitalizationModel.deepParse(createdModel).forEach(model => {
				...
				break;
			case modelAction.MedicalCertificateHospitalizationModelActionTypes.CREATE_MEDICAL_CERTIFICATE_HOSPITALIZATION_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.MedicalCertificateHospitalizationModelActionTypes.CREATE_ALL_MEDICAL_CERTIFICATE_HOSPITALIZATION_OK:
				const createdModels = (action as modelAction.MedicalCertificateHospitalizationActionOK).stateConfig.targetModels;
				const collectionIdAfterCreateAll = (action as modelAction.MedicalCertificateHospitalizationActionOK).stateConfig.collectionId;
				...
				createdModels.forEach((m) => {
					MedicalCertificateHospitalizationModel.deepParse(m).forEach(model => {
						draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
						(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
					});
				});
				...
				break;
			case modelAction.MedicalCertificateHospitalizationModelActionTypes.CREATE_ALL_MEDICAL_CERTIFICATE_HOSPITALIZATION_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.MedicalCertificateHospitalizationModelActionTypes.DELETE_MEDICAL_CERTIFICATE_HOSPITALIZATION_OK:
				const deletedModelId = (action as modelAction.MedicalCertificateHospitalizationActionOK).stateConfig.targetModelId;
				const collectionIdAfterDelete = (action as modelAction.MedicalCertificateHospitalizationActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.MedicalCertificateHospitalizationModelActionTypes.DELETE_ALL_MEDICAL_CERTIFICATE_HOSPITALIZATION_OK:
				const deletedModelIds = (action as modelAction.MedicalCertificateHospitalizationActionOK).stateConfig.targetModelIds;
				const collectionIdAfterDeleteAll = (action as modelAction.MedicalCertificateHospitalizationActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.MedicalCertificateHospitalizationModelActionTypes.DELETE_MEDICAL_CERTIFICATE_HOSPITALIZATION_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.MedicalCertificateHospitalizationModelActionTypes.UPDATE_MEDICAL_CERTIFICATE_HOSPITALIZATION_OK:
				const updatedModel = (action as modelAction.MedicalCertificateHospitalizationActionOK).stateConfig.targetModel;
				...
				MedicalCertificateHospitalizationModel.deepParse(updatedModel).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalCertificateHospitalizationModelActionTypes.UPDATE_MEDICAL_CERTIFICATE_HOSPITALIZATION_FAIL:
				// TODO: Add handling of failure
				break;

			case modelAction.MedicalCertificateHospitalizationModelActionTypes.UPDATE_ALL_MEDICAL_CERTIFICATE_HOSPITALIZATION_OK:
				const updatedModels = (action as modelAction.MedicalCertificateHospitalizationActionOK).stateConfig.targetModels;
				const collectionIdAfterUpdateAll = (action as modelAction.MedicalCertificateHospitalizationActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.MedicalCertificateHospitalizationModelActionTypes.UPDATE_ALL_MEDICAL_CERTIFICATE_HOSPITALIZATION_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.MedicalCertificateHospitalizationModelActionTypes.FETCH_MEDICAL_CERTIFICATE_HOSPITALIZATION_OK:
				let fetchedModel = (action as modelAction.MedicalCertificateHospitalizationActionOK).stateConfig.targetModel;
				...
				MedicalCertificateHospitalizationModel.deepParse(fetchedModel).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalCertificateHospitalizationModelActionTypes.FETCH_ALL_MEDICAL_CERTIFICATE_HOSPITALIZATION_OK:
				const totalCountAfterFetchAll = (action as modelAction.MedicalCertificateHospitalizationActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchAll = (action as modelAction.MedicalCertificateHospitalizationActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchAll = (action as modelAction.MedicalCertificateHospitalizationActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchAll = (action as modelAction.MedicalCertificateHospitalizationActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchAll.map(model => MedicalCertificateHospitalizationModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalCertificateHospitalizationModelActionTypes.FETCH_MEDICAL_CERTIFICATE_HOSPITALIZATION_AUDIT_OK:
				const audits = (action as modelAction.MedicalCertificateHospitalizationActionOK).audits;
				...
				break;
			case modelAction.MedicalCertificateHospitalizationModelActionTypes.FETCH_MEDICAL_CERTIFICATE_HOSPITALIZATION_AUDITS_BY_ENTITY_ID_OK:
				const auditsByEntityId = (action as modelAction.MedicalCertificateHospitalizationActionOK).audits;
				...
				break;
			case modelAction.MedicalCertificateHospitalizationModelActionTypes.FETCH_MEDICAL_CERTIFICATE_HOSPITALIZATION_WITH_QUERY_OK:
				const totalCountAfterFetchWithQuery = (action as modelAction.MedicalCertificateHospitalizationActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchWithQuery = (action as modelAction.MedicalCertificateHospitalizationActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchWithQuery = (action as modelAction.MedicalCertificateHospitalizationActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchWithQuery = (action as modelAction.MedicalCertificateHospitalizationActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchWithQuery.map(model => MedicalCertificateHospitalizationModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalCertificateHospitalizationModelActionTypes.FETCH_LAST_MEDICAL_CERTIFICATE_HOSPITALIZATION_WITH_QUERY_OK:
				const totalCountAfterFetchLastWithQuery = (action as modelAction.MedicalCertificateHospitalizationActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchLastWithQuery = (action as modelAction.MedicalCertificateHospitalizationActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchLastWithQuery = (action as modelAction.MedicalCertificateHospitalizationActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchLastWithQuery = (action as modelAction.MedicalCertificateHospitalizationActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchLastWithQuery.map(model => MedicalCertificateHospitalizationModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalCertificateHospitalizationModelActionTypes.COUNT_MEDICAL_CERTIFICATE_HOSPITALIZATIONS_OK:
				const totalCountAfterCount = (action as modelAction.MedicalCertificateHospitalizationActionOK).stateConfig.totalCount;
				...
				break;
			case modelAction.MedicalCertificateHospitalizationModelActionTypes.INITIALISE_MEDICAL_CERTIFICATE_HOSPITALIZATION_COLLECTION_STATE:
				const collectionIdToInitialise =  (action as modelAction.MedicalCertificateHospitalizationActionOK).stateConfig.collectionId;
				const queryParamsToInitialise = (action as modelAction.MedicalCertificateHospitalizationActionOK).stateConfig.queryParams;
				...
				if (!draft[className].collectionState[collectionIdToInitialise]) {
					draft[className].collectionState[collectionIdToInitialise] = {
						...initialMedicalCertificateHospitalizationCollectionState
					};
				}
