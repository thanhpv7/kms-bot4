...
import * as modelAction from './medical_certificate_hospitalization.model.action';
import {MedicalCertificateHospitalizationService} from '../../services/medicalCertificateHospitalization/medical_certificate_hospitalization.service';
...
/**
 * Effect class used for side effects related to Medical Certificate Hospitalization model.
 */
@Injectable()
export class MedicalCertificateHospitalizationEffect {
	...
	constructor(
		...
		protected readonly service: MedicalCertificateHospitalizationService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateHospitalizationAction>(modelAction.MedicalCertificateHospitalizationModelActionTypes.COUNT_MEDICAL_CERTIFICATE_HOSPITALIZATIONS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateHospitalizationActionOK(
						modelAction.MedicalCertificateHospitalizationModelActionTypes.COUNT_MEDICAL_CERTIFICATE_HOSPITALIZATIONS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateHospitalizationActionFail(
								modelAction.MedicalCertificateHospitalizationModelActionTypes.COUNT_MEDICAL_CERTIFICATE_HOSPITALIZATIONS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateHospitalizationAction>(modelAction.MedicalCertificateHospitalizationModelActionTypes.FETCH_MEDICAL_CERTIFICATE_HOSPITALIZATION),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateHospitalizationActionOK(
						modelAction.MedicalCertificateHospitalizationModelActionTypes.FETCH_MEDICAL_CERTIFICATE_HOSPITALIZATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateHospitalizationActionFail(
								modelAction.MedicalCertificateHospitalizationModelActionTypes.FETCH_MEDICAL_CERTIFICATE_HOSPITALIZATION_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateHospitalizationAction>(modelAction.MedicalCertificateHospitalizationModelActionTypes.FETCH_ALL_MEDICAL_CERTIFICATE_HOSPITALIZATION),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateHospitalizationActionOK(
						modelAction.MedicalCertificateHospitalizationModelActionTypes.FETCH_ALL_MEDICAL_CERTIFICATE_HOSPITALIZATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateHospitalizationActionFail(
								modelAction.MedicalCertificateHospitalizationModelActionTypes.FETCH_ALL_MEDICAL_CERTIFICATE_HOSPITALIZATION_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateHospitalizationAction>(modelAction.MedicalCertificateHospitalizationModelActionTypes.FETCH_MEDICAL_CERTIFICATE_HOSPITALIZATION_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateHospitalizationActionOK(
						modelAction.MedicalCertificateHospitalizationModelActionTypes.FETCH_MEDICAL_CERTIFICATE_HOSPITALIZATION_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateHospitalizationActionFail(
								modelAction.MedicalCertificateHospitalizationModelActionTypes.FETCH_MEDICAL_CERTIFICATE_HOSPITALIZATION_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateHospitalizationAction>(modelAction.MedicalCertificateHospitalizationModelActionTypes.FETCH_LAST_MEDICAL_CERTIFICATE_HOSPITALIZATION_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateHospitalizationActionOK(
						modelAction.MedicalCertificateHospitalizationModelActionTypes.FETCH_LAST_MEDICAL_CERTIFICATE_HOSPITALIZATION_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateHospitalizationActionFail(
								modelAction.MedicalCertificateHospitalizationModelActionTypes.FETCH_LAST_MEDICAL_CERTIFICATE_HOSPITALIZATION_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateHospitalizationAction>(modelAction.MedicalCertificateHospitalizationModelActionTypes.CREATE_MEDICAL_CERTIFICATE_HOSPITALIZATION),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as MedicalCertificateHospitalizationModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateHospitalizationActionOK(
						modelAction.MedicalCertificateHospitalizationModelActionTypes.CREATE_MEDICAL_CERTIFICATE_HOSPITALIZATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateHospitalizationActionFail(
								modelAction.MedicalCertificateHospitalizationModelActionTypes.CREATE_MEDICAL_CERTIFICATE_HOSPITALIZATION_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateHospitalizationAction>(modelAction.MedicalCertificateHospitalizationModelActionTypes.CREATE_ALL_MEDICAL_CERTIFICATE_HOSPITALIZATION),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as MedicalCertificateHospitalizationModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateHospitalizationActionOK(
						modelAction.MedicalCertificateHospitalizationModelActionTypes.CREATE_ALL_MEDICAL_CERTIFICATE_HOSPITALIZATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateHospitalizationActionFail(
								modelAction.MedicalCertificateHospitalizationModelActionTypes.CREATE_ALL_MEDICAL_CERTIFICATE_HOSPITALIZATION_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateHospitalizationAction>(modelAction.MedicalCertificateHospitalizationModelActionTypes.UPDATE_MEDICAL_CERTIFICATE_HOSPITALIZATION),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as MedicalCertificateHospitalizationModel;
				...
				return this.service.update(new MedicalCertificateHospitalizationModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateHospitalizationActionOK(
						modelAction.MedicalCertificateHospitalizationModelActionTypes.UPDATE_MEDICAL_CERTIFICATE_HOSPITALIZATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateHospitalizationActionFail(
								modelAction.MedicalCertificateHospitalizationModelActionTypes.UPDATE_MEDICAL_CERTIFICATE_HOSPITALIZATION_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateHospitalizationAction>(modelAction.MedicalCertificateHospitalizationModelActionTypes.UPDATE_ALL_MEDICAL_CERTIFICATE_HOSPITALIZATION),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as MedicalCertificateHospitalizationModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new MedicalCertificateHospitalizationModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateHospitalizationActionOK(
						modelAction.MedicalCertificateHospitalizationModelActionTypes.UPDATE_ALL_MEDICAL_CERTIFICATE_HOSPITALIZATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateHospitalizationActionFail(
								modelAction.MedicalCertificateHospitalizationModelActionTypes.UPDATE_ALL_MEDICAL_CERTIFICATE_HOSPITALIZATION_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateHospitalizationAction>(modelAction.MedicalCertificateHospitalizationModelActionTypes.DELETE_MEDICAL_CERTIFICATE_HOSPITALIZATION),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateHospitalizationActionOK(
						modelAction.MedicalCertificateHospitalizationModelActionTypes.DELETE_MEDICAL_CERTIFICATE_HOSPITALIZATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateHospitalizationActionFail(
								modelAction.MedicalCertificateHospitalizationModelActionTypes.DELETE_MEDICAL_CERTIFICATE_HOSPITALIZATION_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateHospitalizationAction>(modelAction.MedicalCertificateHospitalizationModelActionTypes.DELETE_MEDICAL_CERTIFICATE_HOSPITALIZATION_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateHospitalizationActionOK(
						modelAction.MedicalCertificateHospitalizationModelActionTypes.DELETE_MEDICAL_CERTIFICATE_HOSPITALIZATION_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateHospitalizationActionFail(
								modelAction.MedicalCertificateHospitalizationModelActionTypes.DELETE_MEDICAL_CERTIFICATE_HOSPITALIZATION_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateHospitalizationAction>(modelAction.MedicalCertificateHospitalizationModelActionTypes.DELETE_ALL_MEDICAL_CERTIFICATE_HOSPITALIZATION),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateHospitalizationActionOK(
						modelAction.MedicalCertificateHospitalizationModelActionTypes.DELETE_ALL_MEDICAL_CERTIFICATE_HOSPITALIZATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateHospitalizationActionFail(
								modelAction.MedicalCertificateHospitalizationModelActionTypes.DELETE_ALL_MEDICAL_CERTIFICATE_HOSPITALIZATION_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateHospitalizationAction>(modelAction.MedicalCertificateHospitalizationModelActionTypes.EXPORT_MEDICAL_CERTIFICATE_HOSPITALIZATION),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateHospitalizationActionOK(
						modelAction.MedicalCertificateHospitalizationModelActionTypes.EXPORT_MEDICAL_CERTIFICATE_HOSPITALIZATION,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateHospitalizationAction>(modelAction.MedicalCertificateHospitalizationModelActionTypes.EXPORT_ALL_MEDICAL_CERTIFICATE_HOSPITALIZATION),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateHospitalizationActionOK(
						modelAction.MedicalCertificateHospitalizationModelActionTypes.EXPORT_ALL_MEDICAL_CERTIFICATE_HOSPITALIZATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateHospitalizationActionFail(
								modelAction.MedicalCertificateHospitalizationModelActionTypes.EXPORT_ALL_MEDICAL_CERTIFICATE_HOSPITALIZATION_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateHospitalizationAction>(modelAction.MedicalCertificateHospitalizationModelActionTypes.EXPORT_MEDICAL_CERTIFICATE_HOSPITALIZATION_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateHospitalizationActionOK(
						modelAction.MedicalCertificateHospitalizationModelActionTypes.EXPORT_MEDICAL_CERTIFICATE_HOSPITALIZATION_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateHospitalizationActionFail(
								modelAction.MedicalCertificateHospitalizationModelActionTypes.EXPORT_MEDICAL_CERTIFICATE_HOSPITALIZATION_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateHospitalizationAction>(modelAction.MedicalCertificateHospitalizationModelActionTypes.IMPORT_MEDICAL_CERTIFICATE_HOSPITALIZATIONS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.MedicalCertificateHospitalizationActionOK(
						modelAction.MedicalCertificateHospitalizationModelActionTypes.IMPORT_MEDICAL_CERTIFICATE_HOSPITALIZATIONS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateHospitalizationActionFail(
								modelAction.MedicalCertificateHospitalizationModelActionTypes.IMPORT_MEDICAL_CERTIFICATE_HOSPITALIZATIONS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateHospitalizationAction>(modelAction.MedicalCertificateHospitalizationModelActionTypes.FETCH_MEDICAL_CERTIFICATE_HOSPITALIZATION_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.MedicalCertificateHospitalizationActionOK(
						modelAction.MedicalCertificateHospitalizationModelActionTypes.FETCH_MEDICAL_CERTIFICATE_HOSPITALIZATION_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateHospitalizationActionFail(
								modelAction.MedicalCertificateHospitalizationModelActionTypes.FETCH_MEDICAL_CERTIFICATE_HOSPITALIZATION_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalCertificateHospitalizationAction>(modelAction.MedicalCertificateHospitalizationModelActionTypes.FETCH_MEDICAL_CERTIFICATE_HOSPITALIZATION_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.MedicalCertificateHospitalizationActionOK(
						modelAction.MedicalCertificateHospitalizationModelActionTypes.FETCH_MEDICAL_CERTIFICATE_HOSPITALIZATION_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.MedicalCertificateHospitalizationActionFail(
								modelAction.MedicalCertificateHospitalizationModelActionTypes.FETCH_MEDICAL_CERTIFICATE_HOSPITALIZATION_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
