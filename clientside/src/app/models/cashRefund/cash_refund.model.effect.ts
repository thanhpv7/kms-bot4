...
import * as modelAction from './cash_refund.model.action';
import {CashRefundService} from '../../services/cashRefund/cash_refund.service';
...
/**
 * Effect class used for side effects related to Cash Refund model.
 */
@Injectable()
export class CashRefundEffect {
	...
	constructor(
		...
		protected readonly service: CashRefundService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashRefundAction>(modelAction.CashRefundModelActionTypes.COUNT_CASH_REFUNDS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.CashRefundActionOK(
						modelAction.CashRefundModelActionTypes.COUNT_CASH_REFUNDS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashRefundActionFail(
								modelAction.CashRefundModelActionTypes.COUNT_CASH_REFUNDS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashRefundAction>(modelAction.CashRefundModelActionTypes.FETCH_CASH_REFUND),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.CashRefundActionOK(
						modelAction.CashRefundModelActionTypes.FETCH_CASH_REFUND_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashRefundActionFail(
								modelAction.CashRefundModelActionTypes.FETCH_CASH_REFUND_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashRefundAction>(modelAction.CashRefundModelActionTypes.FETCH_ALL_CASH_REFUND),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.CashRefundActionOK(
						modelAction.CashRefundModelActionTypes.FETCH_ALL_CASH_REFUND_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashRefundActionFail(
								modelAction.CashRefundModelActionTypes.FETCH_ALL_CASH_REFUND_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashRefundAction>(modelAction.CashRefundModelActionTypes.FETCH_CASH_REFUND_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.CashRefundActionOK(
						modelAction.CashRefundModelActionTypes.FETCH_CASH_REFUND_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashRefundActionFail(
								modelAction.CashRefundModelActionTypes.FETCH_CASH_REFUND_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashRefundAction>(modelAction.CashRefundModelActionTypes.FETCH_LAST_CASH_REFUND_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.CashRefundActionOK(
						modelAction.CashRefundModelActionTypes.FETCH_LAST_CASH_REFUND_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashRefundActionFail(
								modelAction.CashRefundModelActionTypes.FETCH_LAST_CASH_REFUND_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashRefundAction>(modelAction.CashRefundModelActionTypes.CREATE_CASH_REFUND),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as CashRefundModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.CashRefundActionOK(
						modelAction.CashRefundModelActionTypes.CREATE_CASH_REFUND_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashRefundActionFail(
								modelAction.CashRefundModelActionTypes.CREATE_CASH_REFUND_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashRefundAction>(modelAction.CashRefundModelActionTypes.CREATE_ALL_CASH_REFUND),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as CashRefundModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.CashRefundActionOK(
						modelAction.CashRefundModelActionTypes.CREATE_ALL_CASH_REFUND_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashRefundActionFail(
								modelAction.CashRefundModelActionTypes.CREATE_ALL_CASH_REFUND_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashRefundAction>(modelAction.CashRefundModelActionTypes.UPDATE_CASH_REFUND),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as CashRefundModel;
				...
				return this.service.update(new CashRefundModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.CashRefundActionOK(
						modelAction.CashRefundModelActionTypes.UPDATE_CASH_REFUND_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashRefundActionFail(
								modelAction.CashRefundModelActionTypes.UPDATE_CASH_REFUND_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashRefundAction>(modelAction.CashRefundModelActionTypes.UPDATE_ALL_CASH_REFUND),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as CashRefundModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new CashRefundModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.CashRefundActionOK(
						modelAction.CashRefundModelActionTypes.UPDATE_ALL_CASH_REFUND_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashRefundActionFail(
								modelAction.CashRefundModelActionTypes.UPDATE_ALL_CASH_REFUND_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashRefundAction>(modelAction.CashRefundModelActionTypes.DELETE_CASH_REFUND),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.CashRefundActionOK(
						modelAction.CashRefundModelActionTypes.DELETE_CASH_REFUND_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashRefundActionFail(
								modelAction.CashRefundModelActionTypes.DELETE_CASH_REFUND_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashRefundAction>(modelAction.CashRefundModelActionTypes.DELETE_CASH_REFUND_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.CashRefundActionOK(
						modelAction.CashRefundModelActionTypes.DELETE_CASH_REFUND_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashRefundActionFail(
								modelAction.CashRefundModelActionTypes.DELETE_CASH_REFUND_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashRefundAction>(modelAction.CashRefundModelActionTypes.DELETE_ALL_CASH_REFUND),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.CashRefundActionOK(
						modelAction.CashRefundModelActionTypes.DELETE_ALL_CASH_REFUND_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashRefundActionFail(
								modelAction.CashRefundModelActionTypes.DELETE_ALL_CASH_REFUND_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashRefundAction>(modelAction.CashRefundModelActionTypes.EXPORT_CASH_REFUND),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.CashRefundActionOK(
						modelAction.CashRefundModelActionTypes.EXPORT_CASH_REFUND,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashRefundAction>(modelAction.CashRefundModelActionTypes.EXPORT_ALL_CASH_REFUND),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.CashRefundActionOK(
						modelAction.CashRefundModelActionTypes.EXPORT_ALL_CASH_REFUND_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashRefundActionFail(
								modelAction.CashRefundModelActionTypes.EXPORT_ALL_CASH_REFUND_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashRefundAction>(modelAction.CashRefundModelActionTypes.EXPORT_CASH_REFUND_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.CashRefundActionOK(
						modelAction.CashRefundModelActionTypes.EXPORT_CASH_REFUND_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashRefundActionFail(
								modelAction.CashRefundModelActionTypes.EXPORT_CASH_REFUND_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashRefundAction>(modelAction.CashRefundModelActionTypes.IMPORT_CASH_REFUNDS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.CashRefundActionOK(
						modelAction.CashRefundModelActionTypes.IMPORT_CASH_REFUNDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CashRefundActionFail(
								modelAction.CashRefundModelActionTypes.IMPORT_CASH_REFUNDS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashRefundAction>(modelAction.CashRefundModelActionTypes.FETCH_CASH_REFUND_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.CashRefundActionOK(
						modelAction.CashRefundModelActionTypes.FETCH_CASH_REFUND_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.CashRefundActionFail(
								modelAction.CashRefundModelActionTypes.FETCH_CASH_REFUND_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CashRefundAction>(modelAction.CashRefundModelActionTypes.FETCH_CASH_REFUND_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.CashRefundActionOK(
						modelAction.CashRefundModelActionTypes.FETCH_CASH_REFUND_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.CashRefundActionFail(
								modelAction.CashRefundModelActionTypes.FETCH_CASH_REFUND_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
