...
/**
 * CashRefundCollectionState would store the state of a collection of CashRefund
 */
export interface CashRefundCollectionState extends CollectionState {
 ...
 */
export interface CashRefundModelAudit extends AbstractModelAudit<CashRefundModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * CashRefundModelState would store the state of the model
 */
export interface CashRefundModelState {
	collectionState: {
		[key: string]: CashRefundCollectionState;
	};
	data: {
		[id: string]: CashRefundModel;
	};
	totalCount: number;
	audits: CashRefundModelAudit[];
 ...
 */
export const initialCashRefundCollectionState: CashRefundCollectionState = {
...
/**
 * The initial state of CashRefundModelState
 */
export const initialState: CashRefundModelState = {
	collectionState: {
