...
/**
 * RoomTransferCollectionState would store the state of a collection of RoomTransfer
 */
export interface RoomTransferCollectionState extends CollectionState {
 ...
 */
export interface RoomTransferModelAudit extends AbstractModelAudit<RoomTransferModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * RoomTransferModelState would store the state of the model
 */
export interface RoomTransferModelState {
	collectionState: {
		[key: string]: RoomTransferCollectionState;
	};
	data: {
		[id: string]: RoomTransferModel;
	};
	totalCount: number;
	audits: RoomTransferModelAudit[];
 ...
 */
export const initialRoomTransferCollectionState: RoomTransferCollectionState = {
...
/**
 * The initial state of RoomTransferModelState
 */
export const initialState: RoomTransferModelState = {
	collectionState: {
