...
import * as modelAction from './room_transfer.model.action';
import {RoomTransferService} from '../../services/roomTransfer/room_transfer.service';
...
/**
 * Effect class used for side effects related to Room Transfer model.
 */
@Injectable()
export class RoomTransferEffect {
	...
	constructor(
		...
		protected readonly service: RoomTransferService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoomTransferAction>(modelAction.RoomTransferModelActionTypes.COUNT_ROOM_TRANSFERS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.RoomTransferActionOK(
						modelAction.RoomTransferModelActionTypes.COUNT_ROOM_TRANSFERS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RoomTransferActionFail(
								modelAction.RoomTransferModelActionTypes.COUNT_ROOM_TRANSFERS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoomTransferAction>(modelAction.RoomTransferModelActionTypes.FETCH_ROOM_TRANSFER),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.RoomTransferActionOK(
						modelAction.RoomTransferModelActionTypes.FETCH_ROOM_TRANSFER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RoomTransferActionFail(
								modelAction.RoomTransferModelActionTypes.FETCH_ROOM_TRANSFER_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoomTransferAction>(modelAction.RoomTransferModelActionTypes.FETCH_ALL_ROOM_TRANSFER),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.RoomTransferActionOK(
						modelAction.RoomTransferModelActionTypes.FETCH_ALL_ROOM_TRANSFER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RoomTransferActionFail(
								modelAction.RoomTransferModelActionTypes.FETCH_ALL_ROOM_TRANSFER_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoomTransferAction>(modelAction.RoomTransferModelActionTypes.FETCH_ROOM_TRANSFER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.RoomTransferActionOK(
						modelAction.RoomTransferModelActionTypes.FETCH_ROOM_TRANSFER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RoomTransferActionFail(
								modelAction.RoomTransferModelActionTypes.FETCH_ROOM_TRANSFER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoomTransferAction>(modelAction.RoomTransferModelActionTypes.FETCH_LAST_ROOM_TRANSFER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.RoomTransferActionOK(
						modelAction.RoomTransferModelActionTypes.FETCH_LAST_ROOM_TRANSFER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RoomTransferActionFail(
								modelAction.RoomTransferModelActionTypes.FETCH_LAST_ROOM_TRANSFER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoomTransferAction>(modelAction.RoomTransferModelActionTypes.CREATE_ROOM_TRANSFER),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as RoomTransferModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.RoomTransferActionOK(
						modelAction.RoomTransferModelActionTypes.CREATE_ROOM_TRANSFER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RoomTransferActionFail(
								modelAction.RoomTransferModelActionTypes.CREATE_ROOM_TRANSFER_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoomTransferAction>(modelAction.RoomTransferModelActionTypes.CREATE_ALL_ROOM_TRANSFER),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as RoomTransferModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.RoomTransferActionOK(
						modelAction.RoomTransferModelActionTypes.CREATE_ALL_ROOM_TRANSFER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RoomTransferActionFail(
								modelAction.RoomTransferModelActionTypes.CREATE_ALL_ROOM_TRANSFER_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoomTransferAction>(modelAction.RoomTransferModelActionTypes.UPDATE_ROOM_TRANSFER),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as RoomTransferModel;
				...
				return this.service.update(new RoomTransferModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.RoomTransferActionOK(
						modelAction.RoomTransferModelActionTypes.UPDATE_ROOM_TRANSFER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RoomTransferActionFail(
								modelAction.RoomTransferModelActionTypes.UPDATE_ROOM_TRANSFER_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoomTransferAction>(modelAction.RoomTransferModelActionTypes.UPDATE_ALL_ROOM_TRANSFER),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as RoomTransferModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new RoomTransferModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.RoomTransferActionOK(
						modelAction.RoomTransferModelActionTypes.UPDATE_ALL_ROOM_TRANSFER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RoomTransferActionFail(
								modelAction.RoomTransferModelActionTypes.UPDATE_ALL_ROOM_TRANSFER_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoomTransferAction>(modelAction.RoomTransferModelActionTypes.DELETE_ROOM_TRANSFER),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.RoomTransferActionOK(
						modelAction.RoomTransferModelActionTypes.DELETE_ROOM_TRANSFER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RoomTransferActionFail(
								modelAction.RoomTransferModelActionTypes.DELETE_ROOM_TRANSFER_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoomTransferAction>(modelAction.RoomTransferModelActionTypes.DELETE_ROOM_TRANSFER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.RoomTransferActionOK(
						modelAction.RoomTransferModelActionTypes.DELETE_ROOM_TRANSFER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RoomTransferActionFail(
								modelAction.RoomTransferModelActionTypes.DELETE_ROOM_TRANSFER_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoomTransferAction>(modelAction.RoomTransferModelActionTypes.DELETE_ALL_ROOM_TRANSFER),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.RoomTransferActionOK(
						modelAction.RoomTransferModelActionTypes.DELETE_ALL_ROOM_TRANSFER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RoomTransferActionFail(
								modelAction.RoomTransferModelActionTypes.DELETE_ALL_ROOM_TRANSFER_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoomTransferAction>(modelAction.RoomTransferModelActionTypes.EXPORT_ROOM_TRANSFER),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.RoomTransferActionOK(
						modelAction.RoomTransferModelActionTypes.EXPORT_ROOM_TRANSFER,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoomTransferAction>(modelAction.RoomTransferModelActionTypes.EXPORT_ALL_ROOM_TRANSFER),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.RoomTransferActionOK(
						modelAction.RoomTransferModelActionTypes.EXPORT_ALL_ROOM_TRANSFER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RoomTransferActionFail(
								modelAction.RoomTransferModelActionTypes.EXPORT_ALL_ROOM_TRANSFER_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoomTransferAction>(modelAction.RoomTransferModelActionTypes.EXPORT_ROOM_TRANSFER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.RoomTransferActionOK(
						modelAction.RoomTransferModelActionTypes.EXPORT_ROOM_TRANSFER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RoomTransferActionFail(
								modelAction.RoomTransferModelActionTypes.EXPORT_ROOM_TRANSFER_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoomTransferAction>(modelAction.RoomTransferModelActionTypes.IMPORT_ROOM_TRANSFERS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.RoomTransferActionOK(
						modelAction.RoomTransferModelActionTypes.IMPORT_ROOM_TRANSFERS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RoomTransferActionFail(
								modelAction.RoomTransferModelActionTypes.IMPORT_ROOM_TRANSFERS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoomTransferAction>(modelAction.RoomTransferModelActionTypes.FETCH_ROOM_TRANSFER_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.RoomTransferActionOK(
						modelAction.RoomTransferModelActionTypes.FETCH_ROOM_TRANSFER_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.RoomTransferActionFail(
								modelAction.RoomTransferModelActionTypes.FETCH_ROOM_TRANSFER_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoomTransferAction>(modelAction.RoomTransferModelActionTypes.FETCH_ROOM_TRANSFER_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.RoomTransferActionOK(
						modelAction.RoomTransferModelActionTypes.FETCH_ROOM_TRANSFER_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.RoomTransferActionFail(
								modelAction.RoomTransferModelActionTypes.FETCH_ROOM_TRANSFER_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
