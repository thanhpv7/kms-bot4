...
/**
 * StockTransactionPerDateCollectionState would store the state of a collection of StockTransactionPerDate
 */
export interface StockTransactionPerDateCollectionState extends CollectionState {
 ...
 */
export interface StockTransactionPerDateModelAudit extends AbstractModelAudit<StockTransactionPerDateModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * StockTransactionPerDateModelState would store the state of the model
 */
export interface StockTransactionPerDateModelState {
	collectionState: {
		[key: string]: StockTransactionPerDateCollectionState;
	};
	data: {
		[id: string]: StockTransactionPerDateModel;
	};
	totalCount: number;
	audits: StockTransactionPerDateModelAudit[];
 ...
 */
export const initialStockTransactionPerDateCollectionState: StockTransactionPerDateCollectionState = {
...
/**
 * The initial state of StockTransactionPerDateModelState
 */
export const initialState: StockTransactionPerDateModelState = {
	collectionState: {
