...
import * as modelAction from './stock_transaction_per_date.model.action';
import {StockTransactionPerDateService} from '../../services/stockTransactionPerDate/stock_transaction_per_date.service';
...
/**
 * Effect class used for side effects related to Stock Transaction Per Date model.
 */
@Injectable()
export class StockTransactionPerDateEffect {
	...
	constructor(
		...
		protected readonly service: StockTransactionPerDateService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionPerDateAction>(modelAction.StockTransactionPerDateModelActionTypes.COUNT_STOCK_TRANSACTION_PER_DATES),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.StockTransactionPerDateActionOK(
						modelAction.StockTransactionPerDateModelActionTypes.COUNT_STOCK_TRANSACTION_PER_DATES_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionPerDateActionFail(
								modelAction.StockTransactionPerDateModelActionTypes.COUNT_STOCK_TRANSACTION_PER_DATES_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionPerDateAction>(modelAction.StockTransactionPerDateModelActionTypes.FETCH_STOCK_TRANSACTION_PER_DATE),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.StockTransactionPerDateActionOK(
						modelAction.StockTransactionPerDateModelActionTypes.FETCH_STOCK_TRANSACTION_PER_DATE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionPerDateActionFail(
								modelAction.StockTransactionPerDateModelActionTypes.FETCH_STOCK_TRANSACTION_PER_DATE_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionPerDateAction>(modelAction.StockTransactionPerDateModelActionTypes.FETCH_ALL_STOCK_TRANSACTION_PER_DATE),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.StockTransactionPerDateActionOK(
						modelAction.StockTransactionPerDateModelActionTypes.FETCH_ALL_STOCK_TRANSACTION_PER_DATE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionPerDateActionFail(
								modelAction.StockTransactionPerDateModelActionTypes.FETCH_ALL_STOCK_TRANSACTION_PER_DATE_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionPerDateAction>(modelAction.StockTransactionPerDateModelActionTypes.FETCH_STOCK_TRANSACTION_PER_DATE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.StockTransactionPerDateActionOK(
						modelAction.StockTransactionPerDateModelActionTypes.FETCH_STOCK_TRANSACTION_PER_DATE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionPerDateActionFail(
								modelAction.StockTransactionPerDateModelActionTypes.FETCH_STOCK_TRANSACTION_PER_DATE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionPerDateAction>(modelAction.StockTransactionPerDateModelActionTypes.FETCH_LAST_STOCK_TRANSACTION_PER_DATE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.StockTransactionPerDateActionOK(
						modelAction.StockTransactionPerDateModelActionTypes.FETCH_LAST_STOCK_TRANSACTION_PER_DATE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionPerDateActionFail(
								modelAction.StockTransactionPerDateModelActionTypes.FETCH_LAST_STOCK_TRANSACTION_PER_DATE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionPerDateAction>(modelAction.StockTransactionPerDateModelActionTypes.CREATE_STOCK_TRANSACTION_PER_DATE),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as StockTransactionPerDateModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.StockTransactionPerDateActionOK(
						modelAction.StockTransactionPerDateModelActionTypes.CREATE_STOCK_TRANSACTION_PER_DATE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionPerDateActionFail(
								modelAction.StockTransactionPerDateModelActionTypes.CREATE_STOCK_TRANSACTION_PER_DATE_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionPerDateAction>(modelAction.StockTransactionPerDateModelActionTypes.CREATE_ALL_STOCK_TRANSACTION_PER_DATE),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as StockTransactionPerDateModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.StockTransactionPerDateActionOK(
						modelAction.StockTransactionPerDateModelActionTypes.CREATE_ALL_STOCK_TRANSACTION_PER_DATE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionPerDateActionFail(
								modelAction.StockTransactionPerDateModelActionTypes.CREATE_ALL_STOCK_TRANSACTION_PER_DATE_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionPerDateAction>(modelAction.StockTransactionPerDateModelActionTypes.UPDATE_STOCK_TRANSACTION_PER_DATE),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as StockTransactionPerDateModel;
				...
				return this.service.update(new StockTransactionPerDateModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.StockTransactionPerDateActionOK(
						modelAction.StockTransactionPerDateModelActionTypes.UPDATE_STOCK_TRANSACTION_PER_DATE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionPerDateActionFail(
								modelAction.StockTransactionPerDateModelActionTypes.UPDATE_STOCK_TRANSACTION_PER_DATE_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionPerDateAction>(modelAction.StockTransactionPerDateModelActionTypes.UPDATE_ALL_STOCK_TRANSACTION_PER_DATE),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as StockTransactionPerDateModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new StockTransactionPerDateModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.StockTransactionPerDateActionOK(
						modelAction.StockTransactionPerDateModelActionTypes.UPDATE_ALL_STOCK_TRANSACTION_PER_DATE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionPerDateActionFail(
								modelAction.StockTransactionPerDateModelActionTypes.UPDATE_ALL_STOCK_TRANSACTION_PER_DATE_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionPerDateAction>(modelAction.StockTransactionPerDateModelActionTypes.DELETE_STOCK_TRANSACTION_PER_DATE),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.StockTransactionPerDateActionOK(
						modelAction.StockTransactionPerDateModelActionTypes.DELETE_STOCK_TRANSACTION_PER_DATE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionPerDateActionFail(
								modelAction.StockTransactionPerDateModelActionTypes.DELETE_STOCK_TRANSACTION_PER_DATE_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionPerDateAction>(modelAction.StockTransactionPerDateModelActionTypes.DELETE_STOCK_TRANSACTION_PER_DATE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.StockTransactionPerDateActionOK(
						modelAction.StockTransactionPerDateModelActionTypes.DELETE_STOCK_TRANSACTION_PER_DATE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionPerDateActionFail(
								modelAction.StockTransactionPerDateModelActionTypes.DELETE_STOCK_TRANSACTION_PER_DATE_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionPerDateAction>(modelAction.StockTransactionPerDateModelActionTypes.DELETE_ALL_STOCK_TRANSACTION_PER_DATE),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.StockTransactionPerDateActionOK(
						modelAction.StockTransactionPerDateModelActionTypes.DELETE_ALL_STOCK_TRANSACTION_PER_DATE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionPerDateActionFail(
								modelAction.StockTransactionPerDateModelActionTypes.DELETE_ALL_STOCK_TRANSACTION_PER_DATE_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionPerDateAction>(modelAction.StockTransactionPerDateModelActionTypes.EXPORT_STOCK_TRANSACTION_PER_DATE),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.StockTransactionPerDateActionOK(
						modelAction.StockTransactionPerDateModelActionTypes.EXPORT_STOCK_TRANSACTION_PER_DATE,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionPerDateAction>(modelAction.StockTransactionPerDateModelActionTypes.EXPORT_ALL_STOCK_TRANSACTION_PER_DATE),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.StockTransactionPerDateActionOK(
						modelAction.StockTransactionPerDateModelActionTypes.EXPORT_ALL_STOCK_TRANSACTION_PER_DATE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionPerDateActionFail(
								modelAction.StockTransactionPerDateModelActionTypes.EXPORT_ALL_STOCK_TRANSACTION_PER_DATE_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionPerDateAction>(modelAction.StockTransactionPerDateModelActionTypes.EXPORT_STOCK_TRANSACTION_PER_DATE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.StockTransactionPerDateActionOK(
						modelAction.StockTransactionPerDateModelActionTypes.EXPORT_STOCK_TRANSACTION_PER_DATE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionPerDateActionFail(
								modelAction.StockTransactionPerDateModelActionTypes.EXPORT_STOCK_TRANSACTION_PER_DATE_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionPerDateAction>(modelAction.StockTransactionPerDateModelActionTypes.IMPORT_STOCK_TRANSACTION_PER_DATES),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.StockTransactionPerDateActionOK(
						modelAction.StockTransactionPerDateModelActionTypes.IMPORT_STOCK_TRANSACTION_PER_DATES_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionPerDateActionFail(
								modelAction.StockTransactionPerDateModelActionTypes.IMPORT_STOCK_TRANSACTION_PER_DATES_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionPerDateAction>(modelAction.StockTransactionPerDateModelActionTypes.FETCH_STOCK_TRANSACTION_PER_DATE_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.StockTransactionPerDateActionOK(
						modelAction.StockTransactionPerDateModelActionTypes.FETCH_STOCK_TRANSACTION_PER_DATE_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionPerDateActionFail(
								modelAction.StockTransactionPerDateModelActionTypes.FETCH_STOCK_TRANSACTION_PER_DATE_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockTransactionPerDateAction>(modelAction.StockTransactionPerDateModelActionTypes.FETCH_STOCK_TRANSACTION_PER_DATE_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.StockTransactionPerDateActionOK(
						modelAction.StockTransactionPerDateModelActionTypes.FETCH_STOCK_TRANSACTION_PER_DATE_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.StockTransactionPerDateActionFail(
								modelAction.StockTransactionPerDateModelActionTypes.FETCH_STOCK_TRANSACTION_PER_DATE_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
