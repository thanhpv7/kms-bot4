...
/**
 * ExaminationItemCollectionState would store the state of a collection of ExaminationItem
 */
export interface ExaminationItemCollectionState extends CollectionState {
 ...
 */
export interface ExaminationItemModelAudit extends AbstractModelAudit<ExaminationItemModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * ExaminationItemModelState would store the state of the model
 */
export interface ExaminationItemModelState {
	collectionState: {
		[key: string]: ExaminationItemCollectionState;
	};
	data: {
		[id: string]: ExaminationItemModel;
	};
	totalCount: number;
	audits: ExaminationItemModelAudit[];
 ...
 */
export const initialExaminationItemCollectionState: ExaminationItemCollectionState = {
...
/**
 * The initial state of ExaminationItemModelState
 */
export const initialState: ExaminationItemModelState = {
	collectionState: {
