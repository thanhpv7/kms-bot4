...
import * as modelAction from './examination_item.model.action';
import {ExaminationItemService} from '../../services/examinationItem/examination_item.service';
...
/**
 * Effect class used for side effects related to Examination Item model.
 */
@Injectable()
export class ExaminationItemEffect {
	...
	constructor(
		...
		protected readonly service: ExaminationItemService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationItemAction>(modelAction.ExaminationItemModelActionTypes.COUNT_EXAMINATION_ITEMS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.ExaminationItemActionOK(
						modelAction.ExaminationItemModelActionTypes.COUNT_EXAMINATION_ITEMS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationItemActionFail(
								modelAction.ExaminationItemModelActionTypes.COUNT_EXAMINATION_ITEMS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationItemAction>(modelAction.ExaminationItemModelActionTypes.FETCH_EXAMINATION_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ExaminationItemActionOK(
						modelAction.ExaminationItemModelActionTypes.FETCH_EXAMINATION_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationItemActionFail(
								modelAction.ExaminationItemModelActionTypes.FETCH_EXAMINATION_ITEM_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationItemAction>(modelAction.ExaminationItemModelActionTypes.FETCH_ALL_EXAMINATION_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.ExaminationItemActionOK(
						modelAction.ExaminationItemModelActionTypes.FETCH_ALL_EXAMINATION_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationItemActionFail(
								modelAction.ExaminationItemModelActionTypes.FETCH_ALL_EXAMINATION_ITEM_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationItemAction>(modelAction.ExaminationItemModelActionTypes.FETCH_EXAMINATION_ITEM_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.ExaminationItemActionOK(
						modelAction.ExaminationItemModelActionTypes.FETCH_EXAMINATION_ITEM_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationItemActionFail(
								modelAction.ExaminationItemModelActionTypes.FETCH_EXAMINATION_ITEM_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationItemAction>(modelAction.ExaminationItemModelActionTypes.FETCH_LAST_EXAMINATION_ITEM_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.ExaminationItemActionOK(
						modelAction.ExaminationItemModelActionTypes.FETCH_LAST_EXAMINATION_ITEM_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationItemActionFail(
								modelAction.ExaminationItemModelActionTypes.FETCH_LAST_EXAMINATION_ITEM_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationItemAction>(modelAction.ExaminationItemModelActionTypes.CREATE_EXAMINATION_ITEM),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as ExaminationItemModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ExaminationItemActionOK(
						modelAction.ExaminationItemModelActionTypes.CREATE_EXAMINATION_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationItemActionFail(
								modelAction.ExaminationItemModelActionTypes.CREATE_EXAMINATION_ITEM_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationItemAction>(modelAction.ExaminationItemModelActionTypes.CREATE_ALL_EXAMINATION_ITEM),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as ExaminationItemModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ExaminationItemActionOK(
						modelAction.ExaminationItemModelActionTypes.CREATE_ALL_EXAMINATION_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationItemActionFail(
								modelAction.ExaminationItemModelActionTypes.CREATE_ALL_EXAMINATION_ITEM_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationItemAction>(modelAction.ExaminationItemModelActionTypes.UPDATE_EXAMINATION_ITEM),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as ExaminationItemModel;
				...
				return this.service.update(new ExaminationItemModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.ExaminationItemActionOK(
						modelAction.ExaminationItemModelActionTypes.UPDATE_EXAMINATION_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationItemActionFail(
								modelAction.ExaminationItemModelActionTypes.UPDATE_EXAMINATION_ITEM_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationItemAction>(modelAction.ExaminationItemModelActionTypes.UPDATE_ALL_EXAMINATION_ITEM),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as ExaminationItemModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new ExaminationItemModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ExaminationItemActionOK(
						modelAction.ExaminationItemModelActionTypes.UPDATE_ALL_EXAMINATION_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationItemActionFail(
								modelAction.ExaminationItemModelActionTypes.UPDATE_ALL_EXAMINATION_ITEM_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationItemAction>(modelAction.ExaminationItemModelActionTypes.DELETE_EXAMINATION_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.ExaminationItemActionOK(
						modelAction.ExaminationItemModelActionTypes.DELETE_EXAMINATION_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationItemActionFail(
								modelAction.ExaminationItemModelActionTypes.DELETE_EXAMINATION_ITEM_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationItemAction>(modelAction.ExaminationItemModelActionTypes.DELETE_EXAMINATION_ITEM_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.ExaminationItemActionOK(
						modelAction.ExaminationItemModelActionTypes.DELETE_EXAMINATION_ITEM_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationItemActionFail(
								modelAction.ExaminationItemModelActionTypes.DELETE_EXAMINATION_ITEM_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationItemAction>(modelAction.ExaminationItemModelActionTypes.DELETE_ALL_EXAMINATION_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.ExaminationItemActionOK(
						modelAction.ExaminationItemModelActionTypes.DELETE_ALL_EXAMINATION_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationItemActionFail(
								modelAction.ExaminationItemModelActionTypes.DELETE_ALL_EXAMINATION_ITEM_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationItemAction>(modelAction.ExaminationItemModelActionTypes.EXPORT_EXAMINATION_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ExaminationItemActionOK(
						modelAction.ExaminationItemModelActionTypes.EXPORT_EXAMINATION_ITEM,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationItemAction>(modelAction.ExaminationItemModelActionTypes.EXPORT_ALL_EXAMINATION_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ExaminationItemActionOK(
						modelAction.ExaminationItemModelActionTypes.EXPORT_ALL_EXAMINATION_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationItemActionFail(
								modelAction.ExaminationItemModelActionTypes.EXPORT_ALL_EXAMINATION_ITEM_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationItemAction>(modelAction.ExaminationItemModelActionTypes.EXPORT_EXAMINATION_ITEM_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ExaminationItemActionOK(
						modelAction.ExaminationItemModelActionTypes.EXPORT_EXAMINATION_ITEM_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationItemActionFail(
								modelAction.ExaminationItemModelActionTypes.EXPORT_EXAMINATION_ITEM_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationItemAction>(modelAction.ExaminationItemModelActionTypes.IMPORT_EXAMINATION_ITEMS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.ExaminationItemActionOK(
						modelAction.ExaminationItemModelActionTypes.IMPORT_EXAMINATION_ITEMS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationItemActionFail(
								modelAction.ExaminationItemModelActionTypes.IMPORT_EXAMINATION_ITEMS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationItemAction>(modelAction.ExaminationItemModelActionTypes.FETCH_EXAMINATION_ITEM_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.ExaminationItemActionOK(
						modelAction.ExaminationItemModelActionTypes.FETCH_EXAMINATION_ITEM_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationItemActionFail(
								modelAction.ExaminationItemModelActionTypes.FETCH_EXAMINATION_ITEM_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ExaminationItemAction>(modelAction.ExaminationItemModelActionTypes.FETCH_EXAMINATION_ITEM_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.ExaminationItemActionOK(
						modelAction.ExaminationItemModelActionTypes.FETCH_EXAMINATION_ITEM_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.ExaminationItemActionFail(
								modelAction.ExaminationItemModelActionTypes.FETCH_EXAMINATION_ITEM_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
