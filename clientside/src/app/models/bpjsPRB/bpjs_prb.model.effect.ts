...
import * as modelAction from './bpjs_prb.model.action';
import {BpjsPRBService} from '../../services/bpjsPRB/bpjs_prb.service';
...
/**
 * Effect class used for side effects related to BPJS PRB model.
 */
@Injectable()
export class BpjsPRBEffect {
	...
	constructor(
		...
		protected readonly service: BpjsPRBService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPRBAction>(modelAction.BpjsPRBModelActionTypes.COUNT_BPJS_PRBS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsPRBActionOK(
						modelAction.BpjsPRBModelActionTypes.COUNT_BPJS_PRBS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPRBActionFail(
								modelAction.BpjsPRBModelActionTypes.COUNT_BPJS_PRBS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPRBAction>(modelAction.BpjsPRBModelActionTypes.FETCH_BPJS_PRB),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPRBActionOK(
						modelAction.BpjsPRBModelActionTypes.FETCH_BPJS_PRB_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPRBActionFail(
								modelAction.BpjsPRBModelActionTypes.FETCH_BPJS_PRB_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPRBAction>(modelAction.BpjsPRBModelActionTypes.FETCH_ALL_BPJS_PRB),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsPRBActionOK(
						modelAction.BpjsPRBModelActionTypes.FETCH_ALL_BPJS_PRB_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPRBActionFail(
								modelAction.BpjsPRBModelActionTypes.FETCH_ALL_BPJS_PRB_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPRBAction>(modelAction.BpjsPRBModelActionTypes.FETCH_BPJS_PRB_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPRBActionOK(
						modelAction.BpjsPRBModelActionTypes.FETCH_BPJS_PRB_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPRBActionFail(
								modelAction.BpjsPRBModelActionTypes.FETCH_BPJS_PRB_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPRBAction>(modelAction.BpjsPRBModelActionTypes.FETCH_LAST_BPJS_PRB_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPRBActionOK(
						modelAction.BpjsPRBModelActionTypes.FETCH_LAST_BPJS_PRB_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPRBActionFail(
								modelAction.BpjsPRBModelActionTypes.FETCH_LAST_BPJS_PRB_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPRBAction>(modelAction.BpjsPRBModelActionTypes.CREATE_BPJS_PRB),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsPRBModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPRBActionOK(
						modelAction.BpjsPRBModelActionTypes.CREATE_BPJS_PRB_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPRBActionFail(
								modelAction.BpjsPRBModelActionTypes.CREATE_BPJS_PRB_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPRBAction>(modelAction.BpjsPRBModelActionTypes.CREATE_ALL_BPJS_PRB),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsPRBModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPRBActionOK(
						modelAction.BpjsPRBModelActionTypes.CREATE_ALL_BPJS_PRB_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPRBActionFail(
								modelAction.BpjsPRBModelActionTypes.CREATE_ALL_BPJS_PRB_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPRBAction>(modelAction.BpjsPRBModelActionTypes.UPDATE_BPJS_PRB),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsPRBModel;
				...
				return this.service.update(new BpjsPRBModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPRBActionOK(
						modelAction.BpjsPRBModelActionTypes.UPDATE_BPJS_PRB_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPRBActionFail(
								modelAction.BpjsPRBModelActionTypes.UPDATE_BPJS_PRB_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPRBAction>(modelAction.BpjsPRBModelActionTypes.UPDATE_ALL_BPJS_PRB),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsPRBModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsPRBModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPRBActionOK(
						modelAction.BpjsPRBModelActionTypes.UPDATE_ALL_BPJS_PRB_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPRBActionFail(
								modelAction.BpjsPRBModelActionTypes.UPDATE_ALL_BPJS_PRB_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPRBAction>(modelAction.BpjsPRBModelActionTypes.DELETE_BPJS_PRB),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsPRBActionOK(
						modelAction.BpjsPRBModelActionTypes.DELETE_BPJS_PRB_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPRBActionFail(
								modelAction.BpjsPRBModelActionTypes.DELETE_BPJS_PRB_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPRBAction>(modelAction.BpjsPRBModelActionTypes.DELETE_BPJS_PRB_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsPRBActionOK(
						modelAction.BpjsPRBModelActionTypes.DELETE_BPJS_PRB_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPRBActionFail(
								modelAction.BpjsPRBModelActionTypes.DELETE_BPJS_PRB_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPRBAction>(modelAction.BpjsPRBModelActionTypes.DELETE_ALL_BPJS_PRB),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsPRBActionOK(
						modelAction.BpjsPRBModelActionTypes.DELETE_ALL_BPJS_PRB_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPRBActionFail(
								modelAction.BpjsPRBModelActionTypes.DELETE_ALL_BPJS_PRB_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPRBAction>(modelAction.BpjsPRBModelActionTypes.EXPORT_BPJS_PRB),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsPRBActionOK(
						modelAction.BpjsPRBModelActionTypes.EXPORT_BPJS_PRB,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPRBAction>(modelAction.BpjsPRBModelActionTypes.EXPORT_ALL_BPJS_PRB),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsPRBActionOK(
						modelAction.BpjsPRBModelActionTypes.EXPORT_ALL_BPJS_PRB_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPRBActionFail(
								modelAction.BpjsPRBModelActionTypes.EXPORT_ALL_BPJS_PRB_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPRBAction>(modelAction.BpjsPRBModelActionTypes.EXPORT_BPJS_PRB_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsPRBActionOK(
						modelAction.BpjsPRBModelActionTypes.EXPORT_BPJS_PRB_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPRBActionFail(
								modelAction.BpjsPRBModelActionTypes.EXPORT_BPJS_PRB_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPRBAction>(modelAction.BpjsPRBModelActionTypes.IMPORT_BPJS_PRBS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsPRBActionOK(
						modelAction.BpjsPRBModelActionTypes.IMPORT_BPJS_PRBS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPRBActionFail(
								modelAction.BpjsPRBModelActionTypes.IMPORT_BPJS_PRBS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPRBAction>(modelAction.BpjsPRBModelActionTypes.FETCH_BPJS_PRB_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsPRBActionOK(
						modelAction.BpjsPRBModelActionTypes.FETCH_BPJS_PRB_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPRBActionFail(
								modelAction.BpjsPRBModelActionTypes.FETCH_BPJS_PRB_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPRBAction>(modelAction.BpjsPRBModelActionTypes.FETCH_BPJS_PRB_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsPRBActionOK(
						modelAction.BpjsPRBModelActionTypes.FETCH_BPJS_PRB_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPRBActionFail(
								modelAction.BpjsPRBModelActionTypes.FETCH_BPJS_PRB_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
