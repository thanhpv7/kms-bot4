...
/**
 * BpjsPRBCollectionState would store the state of a collection of BpjsPRB
 */
export interface BpjsPRBCollectionState extends CollectionState {
 ...
 */
export interface BpjsPRBModelAudit extends AbstractModelAudit<BpjsPRBModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsPRBModelState would store the state of the model
 */
export interface BpjsPRBModelState {
	collectionState: {
		[key: string]: BpjsPRBCollectionState;
	};
	data: {
		[id: string]: BpjsPRBModel;
	};
	totalCount: number;
	audits: BpjsPRBModelAudit[];
 ...
 */
export const initialBpjsPRBCollectionState: BpjsPRBCollectionState = {
...
/**
 * The initial state of BpjsPRBModelState
 */
export const initialState: BpjsPRBModelState = {
	collectionState: {
