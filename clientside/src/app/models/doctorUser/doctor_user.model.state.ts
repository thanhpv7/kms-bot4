...
/**
 * DoctorUserCollectionState would store the state of a collection of DoctorUser
 */
export interface DoctorUserCollectionState extends CollectionState {
 ...
 */
export interface DoctorUserModelAudit extends AbstractModelAudit<DoctorUserModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * DoctorUserModelState would store the state of the model
 */
export interface DoctorUserModelState {
	collectionState: {
		[key: string]: DoctorUserCollectionState;
	};
	data: {
		[id: string]: DoctorUserModel;
	};
	totalCount: number;
	audits: DoctorUserModelAudit[];
 ...
 */
export const initialDoctorUserCollectionState: DoctorUserCollectionState = {
...
/**
 * The initial state of DoctorUserModelState
 */
export const initialState: DoctorUserModelState = {
	collectionState: {
