...
import * as modelAction from './doctor_user.model.action';
import {DoctorUserService} from '../../services/doctorUser/doctor_user.service';
...
/**
 * Effect class used for side effects related to Doctor User model.
 */
@Injectable()
export class DoctorUserEffect {
	...
	constructor(
		...
		protected readonly service: DoctorUserService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DoctorUserAction>(modelAction.DoctorUserModelActionTypes.COUNT_DOCTOR_USERS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.DoctorUserActionOK(
						modelAction.DoctorUserModelActionTypes.COUNT_DOCTOR_USERS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DoctorUserActionFail(
								modelAction.DoctorUserModelActionTypes.COUNT_DOCTOR_USERS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DoctorUserAction>(modelAction.DoctorUserModelActionTypes.FETCH_DOCTOR_USER),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.DoctorUserActionOK(
						modelAction.DoctorUserModelActionTypes.FETCH_DOCTOR_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DoctorUserActionFail(
								modelAction.DoctorUserModelActionTypes.FETCH_DOCTOR_USER_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DoctorUserAction>(modelAction.DoctorUserModelActionTypes.FETCH_ALL_DOCTOR_USER),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.DoctorUserActionOK(
						modelAction.DoctorUserModelActionTypes.FETCH_ALL_DOCTOR_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DoctorUserActionFail(
								modelAction.DoctorUserModelActionTypes.FETCH_ALL_DOCTOR_USER_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DoctorUserAction>(modelAction.DoctorUserModelActionTypes.FETCH_DOCTOR_USER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.DoctorUserActionOK(
						modelAction.DoctorUserModelActionTypes.FETCH_DOCTOR_USER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DoctorUserActionFail(
								modelAction.DoctorUserModelActionTypes.FETCH_DOCTOR_USER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DoctorUserAction>(modelAction.DoctorUserModelActionTypes.FETCH_LAST_DOCTOR_USER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.DoctorUserActionOK(
						modelAction.DoctorUserModelActionTypes.FETCH_LAST_DOCTOR_USER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DoctorUserActionFail(
								modelAction.DoctorUserModelActionTypes.FETCH_LAST_DOCTOR_USER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DoctorUserAction>(modelAction.DoctorUserModelActionTypes.CREATE_DOCTOR_USER),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as DoctorUserModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.DoctorUserActionOK(
						modelAction.DoctorUserModelActionTypes.CREATE_DOCTOR_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DoctorUserActionFail(
								modelAction.DoctorUserModelActionTypes.CREATE_DOCTOR_USER_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DoctorUserAction>(modelAction.DoctorUserModelActionTypes.CREATE_ALL_DOCTOR_USER),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as DoctorUserModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.DoctorUserActionOK(
						modelAction.DoctorUserModelActionTypes.CREATE_ALL_DOCTOR_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DoctorUserActionFail(
								modelAction.DoctorUserModelActionTypes.CREATE_ALL_DOCTOR_USER_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DoctorUserAction>(modelAction.DoctorUserModelActionTypes.UPDATE_DOCTOR_USER),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as DoctorUserModel;
				...
				return this.service.update(new DoctorUserModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.DoctorUserActionOK(
						modelAction.DoctorUserModelActionTypes.UPDATE_DOCTOR_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DoctorUserActionFail(
								modelAction.DoctorUserModelActionTypes.UPDATE_DOCTOR_USER_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DoctorUserAction>(modelAction.DoctorUserModelActionTypes.UPDATE_ALL_DOCTOR_USER),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as DoctorUserModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new DoctorUserModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.DoctorUserActionOK(
						modelAction.DoctorUserModelActionTypes.UPDATE_ALL_DOCTOR_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DoctorUserActionFail(
								modelAction.DoctorUserModelActionTypes.UPDATE_ALL_DOCTOR_USER_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DoctorUserAction>(modelAction.DoctorUserModelActionTypes.DELETE_DOCTOR_USER),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.DoctorUserActionOK(
						modelAction.DoctorUserModelActionTypes.DELETE_DOCTOR_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DoctorUserActionFail(
								modelAction.DoctorUserModelActionTypes.DELETE_DOCTOR_USER_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DoctorUserAction>(modelAction.DoctorUserModelActionTypes.DELETE_DOCTOR_USER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.DoctorUserActionOK(
						modelAction.DoctorUserModelActionTypes.DELETE_DOCTOR_USER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DoctorUserActionFail(
								modelAction.DoctorUserModelActionTypes.DELETE_DOCTOR_USER_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DoctorUserAction>(modelAction.DoctorUserModelActionTypes.DELETE_ALL_DOCTOR_USER),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.DoctorUserActionOK(
						modelAction.DoctorUserModelActionTypes.DELETE_ALL_DOCTOR_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DoctorUserActionFail(
								modelAction.DoctorUserModelActionTypes.DELETE_ALL_DOCTOR_USER_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DoctorUserAction>(modelAction.DoctorUserModelActionTypes.EXPORT_DOCTOR_USER),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.DoctorUserActionOK(
						modelAction.DoctorUserModelActionTypes.EXPORT_DOCTOR_USER,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DoctorUserAction>(modelAction.DoctorUserModelActionTypes.EXPORT_ALL_DOCTOR_USER),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.DoctorUserActionOK(
						modelAction.DoctorUserModelActionTypes.EXPORT_ALL_DOCTOR_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DoctorUserActionFail(
								modelAction.DoctorUserModelActionTypes.EXPORT_ALL_DOCTOR_USER_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DoctorUserAction>(modelAction.DoctorUserModelActionTypes.EXPORT_DOCTOR_USER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.DoctorUserActionOK(
						modelAction.DoctorUserModelActionTypes.EXPORT_DOCTOR_USER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DoctorUserActionFail(
								modelAction.DoctorUserModelActionTypes.EXPORT_DOCTOR_USER_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DoctorUserAction>(modelAction.DoctorUserModelActionTypes.IMPORT_DOCTOR_USERS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.DoctorUserActionOK(
						modelAction.DoctorUserModelActionTypes.IMPORT_DOCTOR_USERS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.DoctorUserActionFail(
								modelAction.DoctorUserModelActionTypes.IMPORT_DOCTOR_USERS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DoctorUserAction>(modelAction.DoctorUserModelActionTypes.FETCH_DOCTOR_USER_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.DoctorUserActionOK(
						modelAction.DoctorUserModelActionTypes.FETCH_DOCTOR_USER_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.DoctorUserActionFail(
								modelAction.DoctorUserModelActionTypes.FETCH_DOCTOR_USER_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.DoctorUserAction>(modelAction.DoctorUserModelActionTypes.FETCH_DOCTOR_USER_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.DoctorUserActionOK(
						modelAction.DoctorUserModelActionTypes.FETCH_DOCTOR_USER_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.DoctorUserActionFail(
								modelAction.DoctorUserModelActionTypes.FETCH_DOCTOR_USER_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
