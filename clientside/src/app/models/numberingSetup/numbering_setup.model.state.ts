...
/**
 * NumberingSetupCollectionState would store the state of a collection of NumberingSetup
 */
export interface NumberingSetupCollectionState extends CollectionState {
 ...
 */
export interface NumberingSetupModelAudit extends AbstractModelAudit<NumberingSetupModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * NumberingSetupModelState would store the state of the model
 */
export interface NumberingSetupModelState {
	collectionState: {
		[key: string]: NumberingSetupCollectionState;
	};
	data: {
		[id: string]: NumberingSetupModel;
	};
	totalCount: number;
	audits: NumberingSetupModelAudit[];
 ...
 */
export const initialNumberingSetupCollectionState: NumberingSetupCollectionState = {
...
/**
 * The initial state of NumberingSetupModelState
 */
export const initialState: NumberingSetupModelState = {
	collectionState: {
