...
import * as modelAction from './numbering_setup.model.action';
import {NumberingSetupService} from '../../services/numberingSetup/numbering_setup.service';
...
/**
 * Effect class used for side effects related to Numbering Setup model.
 */
@Injectable()
export class NumberingSetupEffect {
	...
	constructor(
		...
		protected readonly service: NumberingSetupService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NumberingSetupAction>(modelAction.NumberingSetupModelActionTypes.COUNT_NUMBERING_SETUPS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.NumberingSetupActionOK(
						modelAction.NumberingSetupModelActionTypes.COUNT_NUMBERING_SETUPS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NumberingSetupActionFail(
								modelAction.NumberingSetupModelActionTypes.COUNT_NUMBERING_SETUPS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NumberingSetupAction>(modelAction.NumberingSetupModelActionTypes.FETCH_NUMBERING_SETUP),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.NumberingSetupActionOK(
						modelAction.NumberingSetupModelActionTypes.FETCH_NUMBERING_SETUP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NumberingSetupActionFail(
								modelAction.NumberingSetupModelActionTypes.FETCH_NUMBERING_SETUP_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NumberingSetupAction>(modelAction.NumberingSetupModelActionTypes.FETCH_ALL_NUMBERING_SETUP),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.NumberingSetupActionOK(
						modelAction.NumberingSetupModelActionTypes.FETCH_ALL_NUMBERING_SETUP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NumberingSetupActionFail(
								modelAction.NumberingSetupModelActionTypes.FETCH_ALL_NUMBERING_SETUP_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NumberingSetupAction>(modelAction.NumberingSetupModelActionTypes.FETCH_NUMBERING_SETUP_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.NumberingSetupActionOK(
						modelAction.NumberingSetupModelActionTypes.FETCH_NUMBERING_SETUP_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NumberingSetupActionFail(
								modelAction.NumberingSetupModelActionTypes.FETCH_NUMBERING_SETUP_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NumberingSetupAction>(modelAction.NumberingSetupModelActionTypes.FETCH_LAST_NUMBERING_SETUP_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.NumberingSetupActionOK(
						modelAction.NumberingSetupModelActionTypes.FETCH_LAST_NUMBERING_SETUP_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NumberingSetupActionFail(
								modelAction.NumberingSetupModelActionTypes.FETCH_LAST_NUMBERING_SETUP_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NumberingSetupAction>(modelAction.NumberingSetupModelActionTypes.CREATE_NUMBERING_SETUP),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as NumberingSetupModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.NumberingSetupActionOK(
						modelAction.NumberingSetupModelActionTypes.CREATE_NUMBERING_SETUP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NumberingSetupActionFail(
								modelAction.NumberingSetupModelActionTypes.CREATE_NUMBERING_SETUP_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NumberingSetupAction>(modelAction.NumberingSetupModelActionTypes.CREATE_ALL_NUMBERING_SETUP),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as NumberingSetupModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.NumberingSetupActionOK(
						modelAction.NumberingSetupModelActionTypes.CREATE_ALL_NUMBERING_SETUP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NumberingSetupActionFail(
								modelAction.NumberingSetupModelActionTypes.CREATE_ALL_NUMBERING_SETUP_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NumberingSetupAction>(modelAction.NumberingSetupModelActionTypes.UPDATE_NUMBERING_SETUP),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as NumberingSetupModel;
				...
				return this.service.update(new NumberingSetupModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.NumberingSetupActionOK(
						modelAction.NumberingSetupModelActionTypes.UPDATE_NUMBERING_SETUP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NumberingSetupActionFail(
								modelAction.NumberingSetupModelActionTypes.UPDATE_NUMBERING_SETUP_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NumberingSetupAction>(modelAction.NumberingSetupModelActionTypes.UPDATE_ALL_NUMBERING_SETUP),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as NumberingSetupModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new NumberingSetupModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.NumberingSetupActionOK(
						modelAction.NumberingSetupModelActionTypes.UPDATE_ALL_NUMBERING_SETUP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NumberingSetupActionFail(
								modelAction.NumberingSetupModelActionTypes.UPDATE_ALL_NUMBERING_SETUP_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NumberingSetupAction>(modelAction.NumberingSetupModelActionTypes.DELETE_NUMBERING_SETUP),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.NumberingSetupActionOK(
						modelAction.NumberingSetupModelActionTypes.DELETE_NUMBERING_SETUP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NumberingSetupActionFail(
								modelAction.NumberingSetupModelActionTypes.DELETE_NUMBERING_SETUP_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NumberingSetupAction>(modelAction.NumberingSetupModelActionTypes.DELETE_NUMBERING_SETUP_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.NumberingSetupActionOK(
						modelAction.NumberingSetupModelActionTypes.DELETE_NUMBERING_SETUP_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NumberingSetupActionFail(
								modelAction.NumberingSetupModelActionTypes.DELETE_NUMBERING_SETUP_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NumberingSetupAction>(modelAction.NumberingSetupModelActionTypes.DELETE_ALL_NUMBERING_SETUP),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.NumberingSetupActionOK(
						modelAction.NumberingSetupModelActionTypes.DELETE_ALL_NUMBERING_SETUP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NumberingSetupActionFail(
								modelAction.NumberingSetupModelActionTypes.DELETE_ALL_NUMBERING_SETUP_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NumberingSetupAction>(modelAction.NumberingSetupModelActionTypes.EXPORT_NUMBERING_SETUP),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.NumberingSetupActionOK(
						modelAction.NumberingSetupModelActionTypes.EXPORT_NUMBERING_SETUP,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NumberingSetupAction>(modelAction.NumberingSetupModelActionTypes.EXPORT_ALL_NUMBERING_SETUP),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.NumberingSetupActionOK(
						modelAction.NumberingSetupModelActionTypes.EXPORT_ALL_NUMBERING_SETUP_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NumberingSetupActionFail(
								modelAction.NumberingSetupModelActionTypes.EXPORT_ALL_NUMBERING_SETUP_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NumberingSetupAction>(modelAction.NumberingSetupModelActionTypes.EXPORT_NUMBERING_SETUP_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.NumberingSetupActionOK(
						modelAction.NumberingSetupModelActionTypes.EXPORT_NUMBERING_SETUP_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NumberingSetupActionFail(
								modelAction.NumberingSetupModelActionTypes.EXPORT_NUMBERING_SETUP_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NumberingSetupAction>(modelAction.NumberingSetupModelActionTypes.IMPORT_NUMBERING_SETUPS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.NumberingSetupActionOK(
						modelAction.NumberingSetupModelActionTypes.IMPORT_NUMBERING_SETUPS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NumberingSetupActionFail(
								modelAction.NumberingSetupModelActionTypes.IMPORT_NUMBERING_SETUPS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NumberingSetupAction>(modelAction.NumberingSetupModelActionTypes.FETCH_NUMBERING_SETUP_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.NumberingSetupActionOK(
						modelAction.NumberingSetupModelActionTypes.FETCH_NUMBERING_SETUP_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.NumberingSetupActionFail(
								modelAction.NumberingSetupModelActionTypes.FETCH_NUMBERING_SETUP_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NumberingSetupAction>(modelAction.NumberingSetupModelActionTypes.FETCH_NUMBERING_SETUP_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.NumberingSetupActionOK(
						modelAction.NumberingSetupModelActionTypes.FETCH_NUMBERING_SETUP_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.NumberingSetupActionFail(
								modelAction.NumberingSetupModelActionTypes.FETCH_NUMBERING_SETUP_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
