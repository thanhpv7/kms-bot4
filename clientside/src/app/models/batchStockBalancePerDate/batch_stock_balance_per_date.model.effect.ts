...
import * as modelAction from './batch_stock_balance_per_date.model.action';
import {BatchStockBalancePerDateService} from '../../services/batchStockBalancePerDate/batch_stock_balance_per_date.service';
...
/**
 * Effect class used for side effects related to Batch Stock Balance Per Date model.
 */
@Injectable()
export class BatchStockBalancePerDateEffect {
	...
	constructor(
		...
		protected readonly service: BatchStockBalancePerDateService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockBalancePerDateAction>(modelAction.BatchStockBalancePerDateModelActionTypes.COUNT_BATCH_STOCK_BALANCE_PER_DATES),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BatchStockBalancePerDateActionOK(
						modelAction.BatchStockBalancePerDateModelActionTypes.COUNT_BATCH_STOCK_BALANCE_PER_DATES_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockBalancePerDateActionFail(
								modelAction.BatchStockBalancePerDateModelActionTypes.COUNT_BATCH_STOCK_BALANCE_PER_DATES_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockBalancePerDateAction>(modelAction.BatchStockBalancePerDateModelActionTypes.FETCH_BATCH_STOCK_BALANCE_PER_DATE),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BatchStockBalancePerDateActionOK(
						modelAction.BatchStockBalancePerDateModelActionTypes.FETCH_BATCH_STOCK_BALANCE_PER_DATE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockBalancePerDateActionFail(
								modelAction.BatchStockBalancePerDateModelActionTypes.FETCH_BATCH_STOCK_BALANCE_PER_DATE_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockBalancePerDateAction>(modelAction.BatchStockBalancePerDateModelActionTypes.FETCH_ALL_BATCH_STOCK_BALANCE_PER_DATE),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BatchStockBalancePerDateActionOK(
						modelAction.BatchStockBalancePerDateModelActionTypes.FETCH_ALL_BATCH_STOCK_BALANCE_PER_DATE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockBalancePerDateActionFail(
								modelAction.BatchStockBalancePerDateModelActionTypes.FETCH_ALL_BATCH_STOCK_BALANCE_PER_DATE_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockBalancePerDateAction>(modelAction.BatchStockBalancePerDateModelActionTypes.FETCH_BATCH_STOCK_BALANCE_PER_DATE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BatchStockBalancePerDateActionOK(
						modelAction.BatchStockBalancePerDateModelActionTypes.FETCH_BATCH_STOCK_BALANCE_PER_DATE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockBalancePerDateActionFail(
								modelAction.BatchStockBalancePerDateModelActionTypes.FETCH_BATCH_STOCK_BALANCE_PER_DATE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockBalancePerDateAction>(modelAction.BatchStockBalancePerDateModelActionTypes.FETCH_LAST_BATCH_STOCK_BALANCE_PER_DATE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BatchStockBalancePerDateActionOK(
						modelAction.BatchStockBalancePerDateModelActionTypes.FETCH_LAST_BATCH_STOCK_BALANCE_PER_DATE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockBalancePerDateActionFail(
								modelAction.BatchStockBalancePerDateModelActionTypes.FETCH_LAST_BATCH_STOCK_BALANCE_PER_DATE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockBalancePerDateAction>(modelAction.BatchStockBalancePerDateModelActionTypes.CREATE_BATCH_STOCK_BALANCE_PER_DATE),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BatchStockBalancePerDateModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BatchStockBalancePerDateActionOK(
						modelAction.BatchStockBalancePerDateModelActionTypes.CREATE_BATCH_STOCK_BALANCE_PER_DATE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockBalancePerDateActionFail(
								modelAction.BatchStockBalancePerDateModelActionTypes.CREATE_BATCH_STOCK_BALANCE_PER_DATE_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockBalancePerDateAction>(modelAction.BatchStockBalancePerDateModelActionTypes.CREATE_ALL_BATCH_STOCK_BALANCE_PER_DATE),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BatchStockBalancePerDateModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BatchStockBalancePerDateActionOK(
						modelAction.BatchStockBalancePerDateModelActionTypes.CREATE_ALL_BATCH_STOCK_BALANCE_PER_DATE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockBalancePerDateActionFail(
								modelAction.BatchStockBalancePerDateModelActionTypes.CREATE_ALL_BATCH_STOCK_BALANCE_PER_DATE_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockBalancePerDateAction>(modelAction.BatchStockBalancePerDateModelActionTypes.UPDATE_BATCH_STOCK_BALANCE_PER_DATE),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BatchStockBalancePerDateModel;
				...
				return this.service.update(new BatchStockBalancePerDateModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BatchStockBalancePerDateActionOK(
						modelAction.BatchStockBalancePerDateModelActionTypes.UPDATE_BATCH_STOCK_BALANCE_PER_DATE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockBalancePerDateActionFail(
								modelAction.BatchStockBalancePerDateModelActionTypes.UPDATE_BATCH_STOCK_BALANCE_PER_DATE_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockBalancePerDateAction>(modelAction.BatchStockBalancePerDateModelActionTypes.UPDATE_ALL_BATCH_STOCK_BALANCE_PER_DATE),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BatchStockBalancePerDateModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BatchStockBalancePerDateModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BatchStockBalancePerDateActionOK(
						modelAction.BatchStockBalancePerDateModelActionTypes.UPDATE_ALL_BATCH_STOCK_BALANCE_PER_DATE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockBalancePerDateActionFail(
								modelAction.BatchStockBalancePerDateModelActionTypes.UPDATE_ALL_BATCH_STOCK_BALANCE_PER_DATE_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockBalancePerDateAction>(modelAction.BatchStockBalancePerDateModelActionTypes.DELETE_BATCH_STOCK_BALANCE_PER_DATE),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BatchStockBalancePerDateActionOK(
						modelAction.BatchStockBalancePerDateModelActionTypes.DELETE_BATCH_STOCK_BALANCE_PER_DATE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockBalancePerDateActionFail(
								modelAction.BatchStockBalancePerDateModelActionTypes.DELETE_BATCH_STOCK_BALANCE_PER_DATE_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockBalancePerDateAction>(modelAction.BatchStockBalancePerDateModelActionTypes.DELETE_BATCH_STOCK_BALANCE_PER_DATE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BatchStockBalancePerDateActionOK(
						modelAction.BatchStockBalancePerDateModelActionTypes.DELETE_BATCH_STOCK_BALANCE_PER_DATE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockBalancePerDateActionFail(
								modelAction.BatchStockBalancePerDateModelActionTypes.DELETE_BATCH_STOCK_BALANCE_PER_DATE_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockBalancePerDateAction>(modelAction.BatchStockBalancePerDateModelActionTypes.DELETE_ALL_BATCH_STOCK_BALANCE_PER_DATE),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BatchStockBalancePerDateActionOK(
						modelAction.BatchStockBalancePerDateModelActionTypes.DELETE_ALL_BATCH_STOCK_BALANCE_PER_DATE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockBalancePerDateActionFail(
								modelAction.BatchStockBalancePerDateModelActionTypes.DELETE_ALL_BATCH_STOCK_BALANCE_PER_DATE_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockBalancePerDateAction>(modelAction.BatchStockBalancePerDateModelActionTypes.EXPORT_BATCH_STOCK_BALANCE_PER_DATE),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BatchStockBalancePerDateActionOK(
						modelAction.BatchStockBalancePerDateModelActionTypes.EXPORT_BATCH_STOCK_BALANCE_PER_DATE,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockBalancePerDateAction>(modelAction.BatchStockBalancePerDateModelActionTypes.EXPORT_ALL_BATCH_STOCK_BALANCE_PER_DATE),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BatchStockBalancePerDateActionOK(
						modelAction.BatchStockBalancePerDateModelActionTypes.EXPORT_ALL_BATCH_STOCK_BALANCE_PER_DATE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockBalancePerDateActionFail(
								modelAction.BatchStockBalancePerDateModelActionTypes.EXPORT_ALL_BATCH_STOCK_BALANCE_PER_DATE_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockBalancePerDateAction>(modelAction.BatchStockBalancePerDateModelActionTypes.EXPORT_BATCH_STOCK_BALANCE_PER_DATE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BatchStockBalancePerDateActionOK(
						modelAction.BatchStockBalancePerDateModelActionTypes.EXPORT_BATCH_STOCK_BALANCE_PER_DATE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockBalancePerDateActionFail(
								modelAction.BatchStockBalancePerDateModelActionTypes.EXPORT_BATCH_STOCK_BALANCE_PER_DATE_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockBalancePerDateAction>(modelAction.BatchStockBalancePerDateModelActionTypes.IMPORT_BATCH_STOCK_BALANCE_PER_DATES),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BatchStockBalancePerDateActionOK(
						modelAction.BatchStockBalancePerDateModelActionTypes.IMPORT_BATCH_STOCK_BALANCE_PER_DATES_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockBalancePerDateActionFail(
								modelAction.BatchStockBalancePerDateModelActionTypes.IMPORT_BATCH_STOCK_BALANCE_PER_DATES_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockBalancePerDateAction>(modelAction.BatchStockBalancePerDateModelActionTypes.FETCH_BATCH_STOCK_BALANCE_PER_DATE_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BatchStockBalancePerDateActionOK(
						modelAction.BatchStockBalancePerDateModelActionTypes.FETCH_BATCH_STOCK_BALANCE_PER_DATE_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockBalancePerDateActionFail(
								modelAction.BatchStockBalancePerDateModelActionTypes.FETCH_BATCH_STOCK_BALANCE_PER_DATE_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BatchStockBalancePerDateAction>(modelAction.BatchStockBalancePerDateModelActionTypes.FETCH_BATCH_STOCK_BALANCE_PER_DATE_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BatchStockBalancePerDateActionOK(
						modelAction.BatchStockBalancePerDateModelActionTypes.FETCH_BATCH_STOCK_BALANCE_PER_DATE_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BatchStockBalancePerDateActionFail(
								modelAction.BatchStockBalancePerDateModelActionTypes.FETCH_BATCH_STOCK_BALANCE_PER_DATE_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
