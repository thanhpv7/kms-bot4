...
/**
 * BatchStockBalancePerDateCollectionState would store the state of a collection of BatchStockBalancePerDate
 */
export interface BatchStockBalancePerDateCollectionState extends CollectionState {
 ...
 */
export interface BatchStockBalancePerDateModelAudit extends AbstractModelAudit<BatchStockBalancePerDateModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BatchStockBalancePerDateModelState would store the state of the model
 */
export interface BatchStockBalancePerDateModelState {
	collectionState: {
		[key: string]: BatchStockBalancePerDateCollectionState;
	};
	data: {
		[id: string]: BatchStockBalancePerDateModel;
	};
	totalCount: number;
	audits: BatchStockBalancePerDateModelAudit[];
 ...
 */
export const initialBatchStockBalancePerDateCollectionState: BatchStockBalancePerDateCollectionState = {
...
/**
 * The initial state of BatchStockBalancePerDateModelState
 */
export const initialState: BatchStockBalancePerDateModelState = {
	collectionState: {
