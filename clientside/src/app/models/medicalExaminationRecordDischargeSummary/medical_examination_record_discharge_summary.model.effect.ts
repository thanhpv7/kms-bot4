...
import * as modelAction from './medical_examination_record_discharge_summary.model.action';
import {MedicalExaminationRecordDischargeSummaryService} from '../../services/medicalExaminationRecordDischargeSummary/medical_examination_record_discharge_summary.service';
...
/**
 * Effect class used for side effects related to Medical Examination Record Discharge Summary model.
 */
@Injectable()
export class MedicalExaminationRecordDischargeSummaryEffect {
	...
	constructor(
		...
		protected readonly service: MedicalExaminationRecordDischargeSummaryService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalExaminationRecordDischargeSummaryAction>(modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.COUNT_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARYS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.MedicalExaminationRecordDischargeSummaryActionOK(
						modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.COUNT_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARYS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalExaminationRecordDischargeSummaryActionFail(
								modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.COUNT_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARYS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalExaminationRecordDischargeSummaryAction>(modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.FETCH_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalExaminationRecordDischargeSummaryActionOK(
						modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.FETCH_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalExaminationRecordDischargeSummaryActionFail(
								modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.FETCH_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalExaminationRecordDischargeSummaryAction>(modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.FETCH_ALL_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.MedicalExaminationRecordDischargeSummaryActionOK(
						modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.FETCH_ALL_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalExaminationRecordDischargeSummaryActionFail(
								modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.FETCH_ALL_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalExaminationRecordDischargeSummaryAction>(modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.FETCH_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalExaminationRecordDischargeSummaryActionOK(
						modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.FETCH_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalExaminationRecordDischargeSummaryActionFail(
								modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.FETCH_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalExaminationRecordDischargeSummaryAction>(modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.FETCH_LAST_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalExaminationRecordDischargeSummaryActionOK(
						modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.FETCH_LAST_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalExaminationRecordDischargeSummaryActionFail(
								modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.FETCH_LAST_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalExaminationRecordDischargeSummaryAction>(modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.CREATE_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as MedicalExaminationRecordDischargeSummaryModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalExaminationRecordDischargeSummaryActionOK(
						modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.CREATE_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalExaminationRecordDischargeSummaryActionFail(
								modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.CREATE_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalExaminationRecordDischargeSummaryAction>(modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.CREATE_ALL_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as MedicalExaminationRecordDischargeSummaryModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalExaminationRecordDischargeSummaryActionOK(
						modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.CREATE_ALL_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalExaminationRecordDischargeSummaryActionFail(
								modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.CREATE_ALL_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalExaminationRecordDischargeSummaryAction>(modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.UPDATE_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as MedicalExaminationRecordDischargeSummaryModel;
				...
				return this.service.update(new MedicalExaminationRecordDischargeSummaryModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalExaminationRecordDischargeSummaryActionOK(
						modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.UPDATE_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalExaminationRecordDischargeSummaryActionFail(
								modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.UPDATE_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalExaminationRecordDischargeSummaryAction>(modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.UPDATE_ALL_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as MedicalExaminationRecordDischargeSummaryModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new MedicalExaminationRecordDischargeSummaryModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalExaminationRecordDischargeSummaryActionOK(
						modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.UPDATE_ALL_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalExaminationRecordDischargeSummaryActionFail(
								modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.UPDATE_ALL_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalExaminationRecordDischargeSummaryAction>(modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.DELETE_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.MedicalExaminationRecordDischargeSummaryActionOK(
						modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.DELETE_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalExaminationRecordDischargeSummaryActionFail(
								modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.DELETE_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalExaminationRecordDischargeSummaryAction>(modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.DELETE_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.MedicalExaminationRecordDischargeSummaryActionOK(
						modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.DELETE_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalExaminationRecordDischargeSummaryActionFail(
								modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.DELETE_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalExaminationRecordDischargeSummaryAction>(modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.DELETE_ALL_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.MedicalExaminationRecordDischargeSummaryActionOK(
						modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.DELETE_ALL_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalExaminationRecordDischargeSummaryActionFail(
								modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.DELETE_ALL_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalExaminationRecordDischargeSummaryAction>(modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.EXPORT_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicalExaminationRecordDischargeSummaryActionOK(
						modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.EXPORT_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalExaminationRecordDischargeSummaryAction>(modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.EXPORT_ALL_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicalExaminationRecordDischargeSummaryActionOK(
						modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.EXPORT_ALL_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalExaminationRecordDischargeSummaryActionFail(
								modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.EXPORT_ALL_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalExaminationRecordDischargeSummaryAction>(modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.EXPORT_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicalExaminationRecordDischargeSummaryActionOK(
						modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.EXPORT_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalExaminationRecordDischargeSummaryActionFail(
								modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.EXPORT_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalExaminationRecordDischargeSummaryAction>(modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.IMPORT_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARYS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.MedicalExaminationRecordDischargeSummaryActionOK(
						modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.IMPORT_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARYS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalExaminationRecordDischargeSummaryActionFail(
								modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.IMPORT_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARYS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalExaminationRecordDischargeSummaryAction>(modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.FETCH_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.MedicalExaminationRecordDischargeSummaryActionOK(
						modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.FETCH_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.MedicalExaminationRecordDischargeSummaryActionFail(
								modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.FETCH_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalExaminationRecordDischargeSummaryAction>(modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.FETCH_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.MedicalExaminationRecordDischargeSummaryActionOK(
						modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.FETCH_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.MedicalExaminationRecordDischargeSummaryActionFail(
								modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.FETCH_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
