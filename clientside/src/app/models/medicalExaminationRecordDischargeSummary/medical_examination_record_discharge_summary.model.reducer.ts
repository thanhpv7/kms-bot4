...
import {initialMedicalExaminationRecordDischargeSummaryCollectionState} from './medical_examination_record_discharge_summary.model.state';
...
export function modelReducer(currentState: ModelState, action: Action): ModelState {
	...
	const className = (action as modelAction.BaseMedicalExaminationRecordDischargeSummaryAction).className;
	...
	return produce(currentState, draft => {
		...
		switch (action.type) {
			case modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.CREATE_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_OK:
				const createdModel = (action as modelAction.MedicalExaminationRecordDischargeSummaryActionOK ).stateConfig.targetModel;
				...
				MedicalExaminationRecordDischargeSummaryModel.deepParse(createdModel).forEach(model => {
				...
				break;
			case modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.CREATE_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.CREATE_ALL_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_OK:
				const createdModels = (action as modelAction.MedicalExaminationRecordDischargeSummaryActionOK).stateConfig.targetModels;
				const collectionIdAfterCreateAll = (action as modelAction.MedicalExaminationRecordDischargeSummaryActionOK).stateConfig.collectionId;
				...
				createdModels.forEach((m) => {
					MedicalExaminationRecordDischargeSummaryModel.deepParse(m).forEach(model => {
						draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
						(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
					});
				});
				...
				break;
			case modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.CREATE_ALL_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.DELETE_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_OK:
				const deletedModelId = (action as modelAction.MedicalExaminationRecordDischargeSummaryActionOK).stateConfig.targetModelId;
				const collectionIdAfterDelete = (action as modelAction.MedicalExaminationRecordDischargeSummaryActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.DELETE_ALL_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_OK:
				const deletedModelIds = (action as modelAction.MedicalExaminationRecordDischargeSummaryActionOK).stateConfig.targetModelIds;
				const collectionIdAfterDeleteAll = (action as modelAction.MedicalExaminationRecordDischargeSummaryActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.DELETE_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.UPDATE_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_OK:
				const updatedModel = (action as modelAction.MedicalExaminationRecordDischargeSummaryActionOK).stateConfig.targetModel;
				...
				MedicalExaminationRecordDischargeSummaryModel.deepParse(updatedModel).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.UPDATE_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_FAIL:
				// TODO: Add handling of failure
				break;

			case modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.UPDATE_ALL_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_OK:
				const updatedModels = (action as modelAction.MedicalExaminationRecordDischargeSummaryActionOK).stateConfig.targetModels;
				const collectionIdAfterUpdateAll = (action as modelAction.MedicalExaminationRecordDischargeSummaryActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.UPDATE_ALL_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.FETCH_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_OK:
				let fetchedModel = (action as modelAction.MedicalExaminationRecordDischargeSummaryActionOK).stateConfig.targetModel;
				...
				MedicalExaminationRecordDischargeSummaryModel.deepParse(fetchedModel).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.FETCH_ALL_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_OK:
				const totalCountAfterFetchAll = (action as modelAction.MedicalExaminationRecordDischargeSummaryActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchAll = (action as modelAction.MedicalExaminationRecordDischargeSummaryActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchAll = (action as modelAction.MedicalExaminationRecordDischargeSummaryActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchAll = (action as modelAction.MedicalExaminationRecordDischargeSummaryActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchAll.map(model => MedicalExaminationRecordDischargeSummaryModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.FETCH_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_AUDIT_OK:
				const audits = (action as modelAction.MedicalExaminationRecordDischargeSummaryActionOK).audits;
				...
				break;
			case modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.FETCH_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_AUDITS_BY_ENTITY_ID_OK:
				const auditsByEntityId = (action as modelAction.MedicalExaminationRecordDischargeSummaryActionOK).audits;
				...
				break;
			case modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.FETCH_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_WITH_QUERY_OK:
				const totalCountAfterFetchWithQuery = (action as modelAction.MedicalExaminationRecordDischargeSummaryActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchWithQuery = (action as modelAction.MedicalExaminationRecordDischargeSummaryActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchWithQuery = (action as modelAction.MedicalExaminationRecordDischargeSummaryActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchWithQuery = (action as modelAction.MedicalExaminationRecordDischargeSummaryActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchWithQuery.map(model => MedicalExaminationRecordDischargeSummaryModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.FETCH_LAST_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_WITH_QUERY_OK:
				const totalCountAfterFetchLastWithQuery = (action as modelAction.MedicalExaminationRecordDischargeSummaryActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchLastWithQuery = (action as modelAction.MedicalExaminationRecordDischargeSummaryActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchLastWithQuery = (action as modelAction.MedicalExaminationRecordDischargeSummaryActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchLastWithQuery = (action as modelAction.MedicalExaminationRecordDischargeSummaryActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchLastWithQuery.map(model => MedicalExaminationRecordDischargeSummaryModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.COUNT_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARYS_OK:
				const totalCountAfterCount = (action as modelAction.MedicalExaminationRecordDischargeSummaryActionOK).stateConfig.totalCount;
				...
				break;
			case modelAction.MedicalExaminationRecordDischargeSummaryModelActionTypes.INITIALISE_MEDICAL_EXAMINATION_RECORD_DISCHARGE_SUMMARY_COLLECTION_STATE:
				const collectionIdToInitialise =  (action as modelAction.MedicalExaminationRecordDischargeSummaryActionOK).stateConfig.collectionId;
				const queryParamsToInitialise = (action as modelAction.MedicalExaminationRecordDischargeSummaryActionOK).stateConfig.queryParams;
				...
				if (!draft[className].collectionState[collectionIdToInitialise]) {
					draft[className].collectionState[collectionIdToInitialise] = {
						...initialMedicalExaminationRecordDischargeSummaryCollectionState
					};
				}
