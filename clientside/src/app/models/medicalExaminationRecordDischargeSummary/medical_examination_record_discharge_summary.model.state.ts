...
/**
 * MedicalExaminationRecordDischargeSummaryCollectionState would store the state of a collection of MedicalExaminationRecordDischargeSummary
 */
export interface MedicalExaminationRecordDischargeSummaryCollectionState extends CollectionState {
 ...
 */
export interface MedicalExaminationRecordDischargeSummaryModelAudit extends AbstractModelAudit<MedicalExaminationRecordDischargeSummaryModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * MedicalExaminationRecordDischargeSummaryModelState would store the state of the model
 */
export interface MedicalExaminationRecordDischargeSummaryModelState {
	collectionState: {
		[key: string]: MedicalExaminationRecordDischargeSummaryCollectionState;
	};
	data: {
		[id: string]: MedicalExaminationRecordDischargeSummaryModel;
	};
	totalCount: number;
	audits: MedicalExaminationRecordDischargeSummaryModelAudit[];
 ...
 */
export const initialMedicalExaminationRecordDischargeSummaryCollectionState: MedicalExaminationRecordDischargeSummaryCollectionState = {
...
/**
 * The initial state of MedicalExaminationRecordDischargeSummaryModelState
 */
export const initialState: MedicalExaminationRecordDischargeSummaryModelState = {
	collectionState: {
