...
/**
 * TransferOrderCollectionState would store the state of a collection of TransferOrder
 */
export interface TransferOrderCollectionState extends CollectionState {
 ...
 */
export interface TransferOrderModelAudit extends AbstractModelAudit<TransferOrderModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * TransferOrderModelState would store the state of the model
 */
export interface TransferOrderModelState {
	collectionState: {
		[key: string]: TransferOrderCollectionState;
	};
	data: {
		[id: string]: TransferOrderModel;
	};
	totalCount: number;
	audits: TransferOrderModelAudit[];
 ...
 */
export const initialTransferOrderCollectionState: TransferOrderCollectionState = {
...
/**
 * The initial state of TransferOrderModelState
 */
export const initialState: TransferOrderModelState = {
	collectionState: {
