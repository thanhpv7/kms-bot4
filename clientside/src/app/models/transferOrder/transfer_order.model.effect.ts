...
import * as modelAction from './transfer_order.model.action';
import {TransferOrderService} from '../../services/transferOrder/transfer_order.service';
...
/**
 * Effect class used for side effects related to Transfer Order model.
 */
@Injectable()
export class TransferOrderEffect {
	...
	constructor(
		...
		protected readonly service: TransferOrderService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransferOrderAction>(modelAction.TransferOrderModelActionTypes.COUNT_TRANSFER_ORDERS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.TransferOrderActionOK(
						modelAction.TransferOrderModelActionTypes.COUNT_TRANSFER_ORDERS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TransferOrderActionFail(
								modelAction.TransferOrderModelActionTypes.COUNT_TRANSFER_ORDERS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransferOrderAction>(modelAction.TransferOrderModelActionTypes.FETCH_TRANSFER_ORDER),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.TransferOrderActionOK(
						modelAction.TransferOrderModelActionTypes.FETCH_TRANSFER_ORDER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TransferOrderActionFail(
								modelAction.TransferOrderModelActionTypes.FETCH_TRANSFER_ORDER_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransferOrderAction>(modelAction.TransferOrderModelActionTypes.FETCH_ALL_TRANSFER_ORDER),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.TransferOrderActionOK(
						modelAction.TransferOrderModelActionTypes.FETCH_ALL_TRANSFER_ORDER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TransferOrderActionFail(
								modelAction.TransferOrderModelActionTypes.FETCH_ALL_TRANSFER_ORDER_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransferOrderAction>(modelAction.TransferOrderModelActionTypes.FETCH_TRANSFER_ORDER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.TransferOrderActionOK(
						modelAction.TransferOrderModelActionTypes.FETCH_TRANSFER_ORDER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TransferOrderActionFail(
								modelAction.TransferOrderModelActionTypes.FETCH_TRANSFER_ORDER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransferOrderAction>(modelAction.TransferOrderModelActionTypes.FETCH_LAST_TRANSFER_ORDER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.TransferOrderActionOK(
						modelAction.TransferOrderModelActionTypes.FETCH_LAST_TRANSFER_ORDER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TransferOrderActionFail(
								modelAction.TransferOrderModelActionTypes.FETCH_LAST_TRANSFER_ORDER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransferOrderAction>(modelAction.TransferOrderModelActionTypes.CREATE_TRANSFER_ORDER),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as TransferOrderModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.TransferOrderActionOK(
						modelAction.TransferOrderModelActionTypes.CREATE_TRANSFER_ORDER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TransferOrderActionFail(
								modelAction.TransferOrderModelActionTypes.CREATE_TRANSFER_ORDER_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransferOrderAction>(modelAction.TransferOrderModelActionTypes.CREATE_ALL_TRANSFER_ORDER),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as TransferOrderModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.TransferOrderActionOK(
						modelAction.TransferOrderModelActionTypes.CREATE_ALL_TRANSFER_ORDER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TransferOrderActionFail(
								modelAction.TransferOrderModelActionTypes.CREATE_ALL_TRANSFER_ORDER_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransferOrderAction>(modelAction.TransferOrderModelActionTypes.UPDATE_TRANSFER_ORDER),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as TransferOrderModel;
				...
				return this.service.update(new TransferOrderModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.TransferOrderActionOK(
						modelAction.TransferOrderModelActionTypes.UPDATE_TRANSFER_ORDER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TransferOrderActionFail(
								modelAction.TransferOrderModelActionTypes.UPDATE_TRANSFER_ORDER_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransferOrderAction>(modelAction.TransferOrderModelActionTypes.UPDATE_ALL_TRANSFER_ORDER),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as TransferOrderModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new TransferOrderModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.TransferOrderActionOK(
						modelAction.TransferOrderModelActionTypes.UPDATE_ALL_TRANSFER_ORDER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TransferOrderActionFail(
								modelAction.TransferOrderModelActionTypes.UPDATE_ALL_TRANSFER_ORDER_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransferOrderAction>(modelAction.TransferOrderModelActionTypes.DELETE_TRANSFER_ORDER),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.TransferOrderActionOK(
						modelAction.TransferOrderModelActionTypes.DELETE_TRANSFER_ORDER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TransferOrderActionFail(
								modelAction.TransferOrderModelActionTypes.DELETE_TRANSFER_ORDER_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransferOrderAction>(modelAction.TransferOrderModelActionTypes.DELETE_TRANSFER_ORDER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.TransferOrderActionOK(
						modelAction.TransferOrderModelActionTypes.DELETE_TRANSFER_ORDER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TransferOrderActionFail(
								modelAction.TransferOrderModelActionTypes.DELETE_TRANSFER_ORDER_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransferOrderAction>(modelAction.TransferOrderModelActionTypes.DELETE_ALL_TRANSFER_ORDER),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.TransferOrderActionOK(
						modelAction.TransferOrderModelActionTypes.DELETE_ALL_TRANSFER_ORDER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TransferOrderActionFail(
								modelAction.TransferOrderModelActionTypes.DELETE_ALL_TRANSFER_ORDER_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransferOrderAction>(modelAction.TransferOrderModelActionTypes.EXPORT_TRANSFER_ORDER),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.TransferOrderActionOK(
						modelAction.TransferOrderModelActionTypes.EXPORT_TRANSFER_ORDER,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransferOrderAction>(modelAction.TransferOrderModelActionTypes.EXPORT_ALL_TRANSFER_ORDER),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.TransferOrderActionOK(
						modelAction.TransferOrderModelActionTypes.EXPORT_ALL_TRANSFER_ORDER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TransferOrderActionFail(
								modelAction.TransferOrderModelActionTypes.EXPORT_ALL_TRANSFER_ORDER_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransferOrderAction>(modelAction.TransferOrderModelActionTypes.EXPORT_TRANSFER_ORDER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.TransferOrderActionOK(
						modelAction.TransferOrderModelActionTypes.EXPORT_TRANSFER_ORDER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TransferOrderActionFail(
								modelAction.TransferOrderModelActionTypes.EXPORT_TRANSFER_ORDER_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransferOrderAction>(modelAction.TransferOrderModelActionTypes.IMPORT_TRANSFER_ORDERS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.TransferOrderActionOK(
						modelAction.TransferOrderModelActionTypes.IMPORT_TRANSFER_ORDERS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TransferOrderActionFail(
								modelAction.TransferOrderModelActionTypes.IMPORT_TRANSFER_ORDERS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransferOrderAction>(modelAction.TransferOrderModelActionTypes.FETCH_TRANSFER_ORDER_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.TransferOrderActionOK(
						modelAction.TransferOrderModelActionTypes.FETCH_TRANSFER_ORDER_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.TransferOrderActionFail(
								modelAction.TransferOrderModelActionTypes.FETCH_TRANSFER_ORDER_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransferOrderAction>(modelAction.TransferOrderModelActionTypes.FETCH_TRANSFER_ORDER_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.TransferOrderActionOK(
						modelAction.TransferOrderModelActionTypes.FETCH_TRANSFER_ORDER_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.TransferOrderActionFail(
								modelAction.TransferOrderModelActionTypes.FETCH_TRANSFER_ORDER_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
