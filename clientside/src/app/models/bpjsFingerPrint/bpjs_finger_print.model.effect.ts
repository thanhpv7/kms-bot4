...
import * as modelAction from './bpjs_finger_print.model.action';
import {BpjsFingerPrintService} from '../../services/bpjsFingerPrint/bpjs_finger_print.service';
...
/**
 * Effect class used for side effects related to BPJS Finger Print model.
 */
@Injectable()
export class BpjsFingerPrintEffect {
	...
	constructor(
		...
		protected readonly service: BpjsFingerPrintService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsFingerPrintAction>(modelAction.BpjsFingerPrintModelActionTypes.COUNT_BPJS_FINGER_PRINTS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsFingerPrintActionOK(
						modelAction.BpjsFingerPrintModelActionTypes.COUNT_BPJS_FINGER_PRINTS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsFingerPrintActionFail(
								modelAction.BpjsFingerPrintModelActionTypes.COUNT_BPJS_FINGER_PRINTS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsFingerPrintAction>(modelAction.BpjsFingerPrintModelActionTypes.FETCH_BPJS_FINGER_PRINT),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsFingerPrintActionOK(
						modelAction.BpjsFingerPrintModelActionTypes.FETCH_BPJS_FINGER_PRINT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsFingerPrintActionFail(
								modelAction.BpjsFingerPrintModelActionTypes.FETCH_BPJS_FINGER_PRINT_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsFingerPrintAction>(modelAction.BpjsFingerPrintModelActionTypes.FETCH_ALL_BPJS_FINGER_PRINT),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsFingerPrintActionOK(
						modelAction.BpjsFingerPrintModelActionTypes.FETCH_ALL_BPJS_FINGER_PRINT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsFingerPrintActionFail(
								modelAction.BpjsFingerPrintModelActionTypes.FETCH_ALL_BPJS_FINGER_PRINT_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsFingerPrintAction>(modelAction.BpjsFingerPrintModelActionTypes.FETCH_BPJS_FINGER_PRINT_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsFingerPrintActionOK(
						modelAction.BpjsFingerPrintModelActionTypes.FETCH_BPJS_FINGER_PRINT_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsFingerPrintActionFail(
								modelAction.BpjsFingerPrintModelActionTypes.FETCH_BPJS_FINGER_PRINT_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsFingerPrintAction>(modelAction.BpjsFingerPrintModelActionTypes.FETCH_LAST_BPJS_FINGER_PRINT_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsFingerPrintActionOK(
						modelAction.BpjsFingerPrintModelActionTypes.FETCH_LAST_BPJS_FINGER_PRINT_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsFingerPrintActionFail(
								modelAction.BpjsFingerPrintModelActionTypes.FETCH_LAST_BPJS_FINGER_PRINT_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsFingerPrintAction>(modelAction.BpjsFingerPrintModelActionTypes.CREATE_BPJS_FINGER_PRINT),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsFingerPrintModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsFingerPrintActionOK(
						modelAction.BpjsFingerPrintModelActionTypes.CREATE_BPJS_FINGER_PRINT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsFingerPrintActionFail(
								modelAction.BpjsFingerPrintModelActionTypes.CREATE_BPJS_FINGER_PRINT_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsFingerPrintAction>(modelAction.BpjsFingerPrintModelActionTypes.CREATE_ALL_BPJS_FINGER_PRINT),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsFingerPrintModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsFingerPrintActionOK(
						modelAction.BpjsFingerPrintModelActionTypes.CREATE_ALL_BPJS_FINGER_PRINT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsFingerPrintActionFail(
								modelAction.BpjsFingerPrintModelActionTypes.CREATE_ALL_BPJS_FINGER_PRINT_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsFingerPrintAction>(modelAction.BpjsFingerPrintModelActionTypes.UPDATE_BPJS_FINGER_PRINT),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsFingerPrintModel;
				...
				return this.service.update(new BpjsFingerPrintModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsFingerPrintActionOK(
						modelAction.BpjsFingerPrintModelActionTypes.UPDATE_BPJS_FINGER_PRINT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsFingerPrintActionFail(
								modelAction.BpjsFingerPrintModelActionTypes.UPDATE_BPJS_FINGER_PRINT_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsFingerPrintAction>(modelAction.BpjsFingerPrintModelActionTypes.UPDATE_ALL_BPJS_FINGER_PRINT),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsFingerPrintModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsFingerPrintModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsFingerPrintActionOK(
						modelAction.BpjsFingerPrintModelActionTypes.UPDATE_ALL_BPJS_FINGER_PRINT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsFingerPrintActionFail(
								modelAction.BpjsFingerPrintModelActionTypes.UPDATE_ALL_BPJS_FINGER_PRINT_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsFingerPrintAction>(modelAction.BpjsFingerPrintModelActionTypes.DELETE_BPJS_FINGER_PRINT),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsFingerPrintActionOK(
						modelAction.BpjsFingerPrintModelActionTypes.DELETE_BPJS_FINGER_PRINT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsFingerPrintActionFail(
								modelAction.BpjsFingerPrintModelActionTypes.DELETE_BPJS_FINGER_PRINT_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsFingerPrintAction>(modelAction.BpjsFingerPrintModelActionTypes.DELETE_BPJS_FINGER_PRINT_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsFingerPrintActionOK(
						modelAction.BpjsFingerPrintModelActionTypes.DELETE_BPJS_FINGER_PRINT_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsFingerPrintActionFail(
								modelAction.BpjsFingerPrintModelActionTypes.DELETE_BPJS_FINGER_PRINT_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsFingerPrintAction>(modelAction.BpjsFingerPrintModelActionTypes.DELETE_ALL_BPJS_FINGER_PRINT),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsFingerPrintActionOK(
						modelAction.BpjsFingerPrintModelActionTypes.DELETE_ALL_BPJS_FINGER_PRINT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsFingerPrintActionFail(
								modelAction.BpjsFingerPrintModelActionTypes.DELETE_ALL_BPJS_FINGER_PRINT_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsFingerPrintAction>(modelAction.BpjsFingerPrintModelActionTypes.EXPORT_BPJS_FINGER_PRINT),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsFingerPrintActionOK(
						modelAction.BpjsFingerPrintModelActionTypes.EXPORT_BPJS_FINGER_PRINT,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsFingerPrintAction>(modelAction.BpjsFingerPrintModelActionTypes.EXPORT_ALL_BPJS_FINGER_PRINT),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsFingerPrintActionOK(
						modelAction.BpjsFingerPrintModelActionTypes.EXPORT_ALL_BPJS_FINGER_PRINT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsFingerPrintActionFail(
								modelAction.BpjsFingerPrintModelActionTypes.EXPORT_ALL_BPJS_FINGER_PRINT_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsFingerPrintAction>(modelAction.BpjsFingerPrintModelActionTypes.EXPORT_BPJS_FINGER_PRINT_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsFingerPrintActionOK(
						modelAction.BpjsFingerPrintModelActionTypes.EXPORT_BPJS_FINGER_PRINT_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsFingerPrintActionFail(
								modelAction.BpjsFingerPrintModelActionTypes.EXPORT_BPJS_FINGER_PRINT_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsFingerPrintAction>(modelAction.BpjsFingerPrintModelActionTypes.IMPORT_BPJS_FINGER_PRINTS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsFingerPrintActionOK(
						modelAction.BpjsFingerPrintModelActionTypes.IMPORT_BPJS_FINGER_PRINTS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsFingerPrintActionFail(
								modelAction.BpjsFingerPrintModelActionTypes.IMPORT_BPJS_FINGER_PRINTS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsFingerPrintAction>(modelAction.BpjsFingerPrintModelActionTypes.FETCH_BPJS_FINGER_PRINT_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsFingerPrintActionOK(
						modelAction.BpjsFingerPrintModelActionTypes.FETCH_BPJS_FINGER_PRINT_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsFingerPrintActionFail(
								modelAction.BpjsFingerPrintModelActionTypes.FETCH_BPJS_FINGER_PRINT_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsFingerPrintAction>(modelAction.BpjsFingerPrintModelActionTypes.FETCH_BPJS_FINGER_PRINT_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsFingerPrintActionOK(
						modelAction.BpjsFingerPrintModelActionTypes.FETCH_BPJS_FINGER_PRINT_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsFingerPrintActionFail(
								modelAction.BpjsFingerPrintModelActionTypes.FETCH_BPJS_FINGER_PRINT_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
