...
/**
 * BpjsFingerPrintCollectionState would store the state of a collection of BpjsFingerPrint
 */
export interface BpjsFingerPrintCollectionState extends CollectionState {
 ...
 */
export interface BpjsFingerPrintModelAudit extends AbstractModelAudit<BpjsFingerPrintModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsFingerPrintModelState would store the state of the model
 */
export interface BpjsFingerPrintModelState {
	collectionState: {
		[key: string]: BpjsFingerPrintCollectionState;
	};
	data: {
		[id: string]: BpjsFingerPrintModel;
	};
	totalCount: number;
	audits: BpjsFingerPrintModelAudit[];
 ...
 */
export const initialBpjsFingerPrintCollectionState: BpjsFingerPrintCollectionState = {
...
/**
 * The initial state of BpjsFingerPrintModelState
 */
export const initialState: BpjsFingerPrintModelState = {
	collectionState: {
