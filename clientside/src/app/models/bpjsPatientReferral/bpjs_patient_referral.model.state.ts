...
/**
 * BpjsPatientReferralCollectionState would store the state of a collection of BpjsPatientReferral
 */
export interface BpjsPatientReferralCollectionState extends CollectionState {
 ...
 */
export interface BpjsPatientReferralModelAudit extends AbstractModelAudit<BpjsPatientReferralModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsPatientReferralModelState would store the state of the model
 */
export interface BpjsPatientReferralModelState {
	collectionState: {
		[key: string]: BpjsPatientReferralCollectionState;
	};
	data: {
		[id: string]: BpjsPatientReferralModel;
	};
	totalCount: number;
	audits: BpjsPatientReferralModelAudit[];
 ...
 */
export const initialBpjsPatientReferralCollectionState: BpjsPatientReferralCollectionState = {
...
/**
 * The initial state of BpjsPatientReferralModelState
 */
export const initialState: BpjsPatientReferralModelState = {
	collectionState: {
