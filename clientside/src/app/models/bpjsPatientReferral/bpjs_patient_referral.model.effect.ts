...
import * as modelAction from './bpjs_patient_referral.model.action';
import {BpjsPatientReferralService} from '../../services/bpjsPatientReferral/bpjs_patient_referral.service';
...
/**
 * Effect class used for side effects related to BPJS Patient Referral model.
 */
@Injectable()
export class BpjsPatientReferralEffect {
	...
	constructor(
		...
		protected readonly service: BpjsPatientReferralService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPatientReferralAction>(modelAction.BpjsPatientReferralModelActionTypes.COUNT_BPJS_PATIENT_REFERRALS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsPatientReferralActionOK(
						modelAction.BpjsPatientReferralModelActionTypes.COUNT_BPJS_PATIENT_REFERRALS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPatientReferralActionFail(
								modelAction.BpjsPatientReferralModelActionTypes.COUNT_BPJS_PATIENT_REFERRALS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPatientReferralAction>(modelAction.BpjsPatientReferralModelActionTypes.FETCH_BPJS_PATIENT_REFERRAL),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPatientReferralActionOK(
						modelAction.BpjsPatientReferralModelActionTypes.FETCH_BPJS_PATIENT_REFERRAL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPatientReferralActionFail(
								modelAction.BpjsPatientReferralModelActionTypes.FETCH_BPJS_PATIENT_REFERRAL_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPatientReferralAction>(modelAction.BpjsPatientReferralModelActionTypes.FETCH_ALL_BPJS_PATIENT_REFERRAL),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsPatientReferralActionOK(
						modelAction.BpjsPatientReferralModelActionTypes.FETCH_ALL_BPJS_PATIENT_REFERRAL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPatientReferralActionFail(
								modelAction.BpjsPatientReferralModelActionTypes.FETCH_ALL_BPJS_PATIENT_REFERRAL_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPatientReferralAction>(modelAction.BpjsPatientReferralModelActionTypes.FETCH_BPJS_PATIENT_REFERRAL_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPatientReferralActionOK(
						modelAction.BpjsPatientReferralModelActionTypes.FETCH_BPJS_PATIENT_REFERRAL_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPatientReferralActionFail(
								modelAction.BpjsPatientReferralModelActionTypes.FETCH_BPJS_PATIENT_REFERRAL_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPatientReferralAction>(modelAction.BpjsPatientReferralModelActionTypes.FETCH_LAST_BPJS_PATIENT_REFERRAL_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPatientReferralActionOK(
						modelAction.BpjsPatientReferralModelActionTypes.FETCH_LAST_BPJS_PATIENT_REFERRAL_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPatientReferralActionFail(
								modelAction.BpjsPatientReferralModelActionTypes.FETCH_LAST_BPJS_PATIENT_REFERRAL_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPatientReferralAction>(modelAction.BpjsPatientReferralModelActionTypes.CREATE_BPJS_PATIENT_REFERRAL),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsPatientReferralModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPatientReferralActionOK(
						modelAction.BpjsPatientReferralModelActionTypes.CREATE_BPJS_PATIENT_REFERRAL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPatientReferralActionFail(
								modelAction.BpjsPatientReferralModelActionTypes.CREATE_BPJS_PATIENT_REFERRAL_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPatientReferralAction>(modelAction.BpjsPatientReferralModelActionTypes.CREATE_ALL_BPJS_PATIENT_REFERRAL),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsPatientReferralModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPatientReferralActionOK(
						modelAction.BpjsPatientReferralModelActionTypes.CREATE_ALL_BPJS_PATIENT_REFERRAL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPatientReferralActionFail(
								modelAction.BpjsPatientReferralModelActionTypes.CREATE_ALL_BPJS_PATIENT_REFERRAL_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPatientReferralAction>(modelAction.BpjsPatientReferralModelActionTypes.UPDATE_BPJS_PATIENT_REFERRAL),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsPatientReferralModel;
				...
				return this.service.update(new BpjsPatientReferralModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPatientReferralActionOK(
						modelAction.BpjsPatientReferralModelActionTypes.UPDATE_BPJS_PATIENT_REFERRAL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPatientReferralActionFail(
								modelAction.BpjsPatientReferralModelActionTypes.UPDATE_BPJS_PATIENT_REFERRAL_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPatientReferralAction>(modelAction.BpjsPatientReferralModelActionTypes.UPDATE_ALL_BPJS_PATIENT_REFERRAL),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsPatientReferralModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsPatientReferralModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPatientReferralActionOK(
						modelAction.BpjsPatientReferralModelActionTypes.UPDATE_ALL_BPJS_PATIENT_REFERRAL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPatientReferralActionFail(
								modelAction.BpjsPatientReferralModelActionTypes.UPDATE_ALL_BPJS_PATIENT_REFERRAL_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPatientReferralAction>(modelAction.BpjsPatientReferralModelActionTypes.DELETE_BPJS_PATIENT_REFERRAL),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsPatientReferralActionOK(
						modelAction.BpjsPatientReferralModelActionTypes.DELETE_BPJS_PATIENT_REFERRAL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPatientReferralActionFail(
								modelAction.BpjsPatientReferralModelActionTypes.DELETE_BPJS_PATIENT_REFERRAL_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPatientReferralAction>(modelAction.BpjsPatientReferralModelActionTypes.DELETE_BPJS_PATIENT_REFERRAL_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsPatientReferralActionOK(
						modelAction.BpjsPatientReferralModelActionTypes.DELETE_BPJS_PATIENT_REFERRAL_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPatientReferralActionFail(
								modelAction.BpjsPatientReferralModelActionTypes.DELETE_BPJS_PATIENT_REFERRAL_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPatientReferralAction>(modelAction.BpjsPatientReferralModelActionTypes.DELETE_ALL_BPJS_PATIENT_REFERRAL),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsPatientReferralActionOK(
						modelAction.BpjsPatientReferralModelActionTypes.DELETE_ALL_BPJS_PATIENT_REFERRAL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPatientReferralActionFail(
								modelAction.BpjsPatientReferralModelActionTypes.DELETE_ALL_BPJS_PATIENT_REFERRAL_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPatientReferralAction>(modelAction.BpjsPatientReferralModelActionTypes.EXPORT_BPJS_PATIENT_REFERRAL),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsPatientReferralActionOK(
						modelAction.BpjsPatientReferralModelActionTypes.EXPORT_BPJS_PATIENT_REFERRAL,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPatientReferralAction>(modelAction.BpjsPatientReferralModelActionTypes.EXPORT_ALL_BPJS_PATIENT_REFERRAL),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsPatientReferralActionOK(
						modelAction.BpjsPatientReferralModelActionTypes.EXPORT_ALL_BPJS_PATIENT_REFERRAL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPatientReferralActionFail(
								modelAction.BpjsPatientReferralModelActionTypes.EXPORT_ALL_BPJS_PATIENT_REFERRAL_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPatientReferralAction>(modelAction.BpjsPatientReferralModelActionTypes.EXPORT_BPJS_PATIENT_REFERRAL_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsPatientReferralActionOK(
						modelAction.BpjsPatientReferralModelActionTypes.EXPORT_BPJS_PATIENT_REFERRAL_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPatientReferralActionFail(
								modelAction.BpjsPatientReferralModelActionTypes.EXPORT_BPJS_PATIENT_REFERRAL_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPatientReferralAction>(modelAction.BpjsPatientReferralModelActionTypes.IMPORT_BPJS_PATIENT_REFERRALS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsPatientReferralActionOK(
						modelAction.BpjsPatientReferralModelActionTypes.IMPORT_BPJS_PATIENT_REFERRALS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPatientReferralActionFail(
								modelAction.BpjsPatientReferralModelActionTypes.IMPORT_BPJS_PATIENT_REFERRALS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPatientReferralAction>(modelAction.BpjsPatientReferralModelActionTypes.FETCH_BPJS_PATIENT_REFERRAL_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsPatientReferralActionOK(
						modelAction.BpjsPatientReferralModelActionTypes.FETCH_BPJS_PATIENT_REFERRAL_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPatientReferralActionFail(
								modelAction.BpjsPatientReferralModelActionTypes.FETCH_BPJS_PATIENT_REFERRAL_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPatientReferralAction>(modelAction.BpjsPatientReferralModelActionTypes.FETCH_BPJS_PATIENT_REFERRAL_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsPatientReferralActionOK(
						modelAction.BpjsPatientReferralModelActionTypes.FETCH_BPJS_PATIENT_REFERRAL_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPatientReferralActionFail(
								modelAction.BpjsPatientReferralModelActionTypes.FETCH_BPJS_PATIENT_REFERRAL_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
