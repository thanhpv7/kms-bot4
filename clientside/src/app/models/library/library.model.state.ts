...
/**
 * LibraryCollectionState would store the state of a collection of Library
 */
export interface LibraryCollectionState extends CollectionState {
 ...
 */
export interface LibraryModelAudit extends AbstractModelAudit<LibraryModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * LibraryModelState would store the state of the model
 */
export interface LibraryModelState {
	collectionState: {
		[key: string]: LibraryCollectionState;
	};
	data: {
		[id: string]: LibraryModel;
	};
	totalCount: number;
	audits: LibraryModelAudit[];
 ...
 */
export const initialLibraryCollectionState: LibraryCollectionState = {
...
/**
 * The initial state of LibraryModelState
 */
export const initialState: LibraryModelState = {
	collectionState: {
