...
/**
 * Effect class used for side effects related to Library model.
 */
@Injectable()
export class LibraryEffect {
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.LibraryAction>(modelAction.LibraryModelActionTypes.COUNT_LIBRARYS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.LibraryActionOK(
						modelAction.LibraryModelActionTypes.COUNT_LIBRARYS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.LibraryActionFail(
								modelAction.LibraryModelActionTypes.COUNT_LIBRARYS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.LibraryAction>(modelAction.LibraryModelActionTypes.FETCH_LIBRARY),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.LibraryActionOK(
						modelAction.LibraryModelActionTypes.FETCH_LIBRARY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.LibraryActionFail(
								modelAction.LibraryModelActionTypes.FETCH_LIBRARY_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.LibraryAction>(modelAction.LibraryModelActionTypes.FETCH_ALL_LIBRARY),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.LibraryActionOK(
						modelAction.LibraryModelActionTypes.FETCH_ALL_LIBRARY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.LibraryActionFail(
								modelAction.LibraryModelActionTypes.FETCH_ALL_LIBRARY_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.LibraryAction>(modelAction.LibraryModelActionTypes.FETCH_LIBRARY_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.LibraryActionOK(
						modelAction.LibraryModelActionTypes.FETCH_LIBRARY_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.LibraryActionFail(
								modelAction.LibraryModelActionTypes.FETCH_LIBRARY_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.LibraryAction>(modelAction.LibraryModelActionTypes.FETCH_LAST_LIBRARY_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.LibraryActionOK(
						modelAction.LibraryModelActionTypes.FETCH_LAST_LIBRARY_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.LibraryActionFail(
								modelAction.LibraryModelActionTypes.FETCH_LAST_LIBRARY_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.LibraryAction>(modelAction.LibraryModelActionTypes.CREATE_LIBRARY),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as LibraryModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.LibraryActionOK(
						modelAction.LibraryModelActionTypes.CREATE_LIBRARY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.LibraryActionFail(
								modelAction.LibraryModelActionTypes.CREATE_LIBRARY_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.LibraryAction>(modelAction.LibraryModelActionTypes.CREATE_ALL_LIBRARY),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as LibraryModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.LibraryActionOK(
						modelAction.LibraryModelActionTypes.CREATE_ALL_LIBRARY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.LibraryActionFail(
								modelAction.LibraryModelActionTypes.CREATE_ALL_LIBRARY_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.LibraryAction>(modelAction.LibraryModelActionTypes.UPDATE_LIBRARY),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as LibraryModel;
				...
				return this.service.update(new LibraryModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.LibraryActionOK(
						modelAction.LibraryModelActionTypes.UPDATE_LIBRARY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.LibraryActionFail(
								modelAction.LibraryModelActionTypes.UPDATE_LIBRARY_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.LibraryAction>(modelAction.LibraryModelActionTypes.UPDATE_ALL_LIBRARY),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as LibraryModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new LibraryModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.LibraryActionOK(
						modelAction.LibraryModelActionTypes.UPDATE_ALL_LIBRARY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.LibraryActionFail(
								modelAction.LibraryModelActionTypes.UPDATE_ALL_LIBRARY_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.LibraryAction>(modelAction.LibraryModelActionTypes.DELETE_LIBRARY),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.LibraryActionOK(
						modelAction.LibraryModelActionTypes.DELETE_LIBRARY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.LibraryActionFail(
								modelAction.LibraryModelActionTypes.DELETE_LIBRARY_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.LibraryAction>(modelAction.LibraryModelActionTypes.DELETE_LIBRARY_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.LibraryActionOK(
						modelAction.LibraryModelActionTypes.DELETE_LIBRARY_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.LibraryActionFail(
								modelAction.LibraryModelActionTypes.DELETE_LIBRARY_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.LibraryAction>(modelAction.LibraryModelActionTypes.DELETE_ALL_LIBRARY),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.LibraryActionOK(
						modelAction.LibraryModelActionTypes.DELETE_ALL_LIBRARY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.LibraryActionFail(
								modelAction.LibraryModelActionTypes.DELETE_ALL_LIBRARY_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.LibraryAction>(modelAction.LibraryModelActionTypes.EXPORT_LIBRARY),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.LibraryActionOK(
						modelAction.LibraryModelActionTypes.EXPORT_LIBRARY,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.LibraryAction>(modelAction.LibraryModelActionTypes.EXPORT_ALL_LIBRARY),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.LibraryActionOK(
						modelAction.LibraryModelActionTypes.EXPORT_ALL_LIBRARY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.LibraryActionFail(
								modelAction.LibraryModelActionTypes.EXPORT_ALL_LIBRARY_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.LibraryAction>(modelAction.LibraryModelActionTypes.EXPORT_LIBRARY_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.LibraryActionOK(
						modelAction.LibraryModelActionTypes.EXPORT_LIBRARY_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.LibraryActionFail(
								modelAction.LibraryModelActionTypes.EXPORT_LIBRARY_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.LibraryAction>(modelAction.LibraryModelActionTypes.IMPORT_LIBRARYS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.LibraryActionOK(
						modelAction.LibraryModelActionTypes.IMPORT_LIBRARYS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.LibraryActionFail(
								modelAction.LibraryModelActionTypes.IMPORT_LIBRARYS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.LibraryAction>(modelAction.LibraryModelActionTypes.FETCH_LIBRARY_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.LibraryActionOK(
						modelAction.LibraryModelActionTypes.FETCH_LIBRARY_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.LibraryActionFail(
								modelAction.LibraryModelActionTypes.FETCH_LIBRARY_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.LibraryAction>(modelAction.LibraryModelActionTypes.FETCH_LIBRARY_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.LibraryActionOK(
						modelAction.LibraryModelActionTypes.FETCH_LIBRARY_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.LibraryActionFail(
								modelAction.LibraryModelActionTypes.FETCH_LIBRARY_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
