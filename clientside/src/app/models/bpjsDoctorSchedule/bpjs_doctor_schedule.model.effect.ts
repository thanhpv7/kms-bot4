...
import * as modelAction from './bpjs_doctor_schedule.model.action';
import {BpjsDoctorScheduleService} from '../../services/bpjsDoctorSchedule/bpjs_doctor_schedule.service';
...
/**
 * Effect class used for side effects related to BPJS Doctor Schedule model.
 */
@Injectable()
export class BpjsDoctorScheduleEffect {
	...
	constructor(
		...
		protected readonly service: BpjsDoctorScheduleService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDoctorScheduleAction>(modelAction.BpjsDoctorScheduleModelActionTypes.COUNT_BPJS_DOCTOR_SCHEDULES),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsDoctorScheduleActionOK(
						modelAction.BpjsDoctorScheduleModelActionTypes.COUNT_BPJS_DOCTOR_SCHEDULES_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDoctorScheduleActionFail(
								modelAction.BpjsDoctorScheduleModelActionTypes.COUNT_BPJS_DOCTOR_SCHEDULES_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDoctorScheduleAction>(modelAction.BpjsDoctorScheduleModelActionTypes.FETCH_BPJS_DOCTOR_SCHEDULE),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsDoctorScheduleActionOK(
						modelAction.BpjsDoctorScheduleModelActionTypes.FETCH_BPJS_DOCTOR_SCHEDULE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDoctorScheduleActionFail(
								modelAction.BpjsDoctorScheduleModelActionTypes.FETCH_BPJS_DOCTOR_SCHEDULE_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDoctorScheduleAction>(modelAction.BpjsDoctorScheduleModelActionTypes.FETCH_ALL_BPJS_DOCTOR_SCHEDULE),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsDoctorScheduleActionOK(
						modelAction.BpjsDoctorScheduleModelActionTypes.FETCH_ALL_BPJS_DOCTOR_SCHEDULE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDoctorScheduleActionFail(
								modelAction.BpjsDoctorScheduleModelActionTypes.FETCH_ALL_BPJS_DOCTOR_SCHEDULE_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDoctorScheduleAction>(modelAction.BpjsDoctorScheduleModelActionTypes.FETCH_BPJS_DOCTOR_SCHEDULE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsDoctorScheduleActionOK(
						modelAction.BpjsDoctorScheduleModelActionTypes.FETCH_BPJS_DOCTOR_SCHEDULE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDoctorScheduleActionFail(
								modelAction.BpjsDoctorScheduleModelActionTypes.FETCH_BPJS_DOCTOR_SCHEDULE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDoctorScheduleAction>(modelAction.BpjsDoctorScheduleModelActionTypes.FETCH_LAST_BPJS_DOCTOR_SCHEDULE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsDoctorScheduleActionOK(
						modelAction.BpjsDoctorScheduleModelActionTypes.FETCH_LAST_BPJS_DOCTOR_SCHEDULE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDoctorScheduleActionFail(
								modelAction.BpjsDoctorScheduleModelActionTypes.FETCH_LAST_BPJS_DOCTOR_SCHEDULE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDoctorScheduleAction>(modelAction.BpjsDoctorScheduleModelActionTypes.CREATE_BPJS_DOCTOR_SCHEDULE),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsDoctorScheduleModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsDoctorScheduleActionOK(
						modelAction.BpjsDoctorScheduleModelActionTypes.CREATE_BPJS_DOCTOR_SCHEDULE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDoctorScheduleActionFail(
								modelAction.BpjsDoctorScheduleModelActionTypes.CREATE_BPJS_DOCTOR_SCHEDULE_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDoctorScheduleAction>(modelAction.BpjsDoctorScheduleModelActionTypes.CREATE_ALL_BPJS_DOCTOR_SCHEDULE),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsDoctorScheduleModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsDoctorScheduleActionOK(
						modelAction.BpjsDoctorScheduleModelActionTypes.CREATE_ALL_BPJS_DOCTOR_SCHEDULE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDoctorScheduleActionFail(
								modelAction.BpjsDoctorScheduleModelActionTypes.CREATE_ALL_BPJS_DOCTOR_SCHEDULE_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDoctorScheduleAction>(modelAction.BpjsDoctorScheduleModelActionTypes.UPDATE_BPJS_DOCTOR_SCHEDULE),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsDoctorScheduleModel;
				...
				return this.service.update(new BpjsDoctorScheduleModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsDoctorScheduleActionOK(
						modelAction.BpjsDoctorScheduleModelActionTypes.UPDATE_BPJS_DOCTOR_SCHEDULE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDoctorScheduleActionFail(
								modelAction.BpjsDoctorScheduleModelActionTypes.UPDATE_BPJS_DOCTOR_SCHEDULE_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDoctorScheduleAction>(modelAction.BpjsDoctorScheduleModelActionTypes.UPDATE_ALL_BPJS_DOCTOR_SCHEDULE),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsDoctorScheduleModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsDoctorScheduleModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsDoctorScheduleActionOK(
						modelAction.BpjsDoctorScheduleModelActionTypes.UPDATE_ALL_BPJS_DOCTOR_SCHEDULE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDoctorScheduleActionFail(
								modelAction.BpjsDoctorScheduleModelActionTypes.UPDATE_ALL_BPJS_DOCTOR_SCHEDULE_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDoctorScheduleAction>(modelAction.BpjsDoctorScheduleModelActionTypes.DELETE_BPJS_DOCTOR_SCHEDULE),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsDoctorScheduleActionOK(
						modelAction.BpjsDoctorScheduleModelActionTypes.DELETE_BPJS_DOCTOR_SCHEDULE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDoctorScheduleActionFail(
								modelAction.BpjsDoctorScheduleModelActionTypes.DELETE_BPJS_DOCTOR_SCHEDULE_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDoctorScheduleAction>(modelAction.BpjsDoctorScheduleModelActionTypes.DELETE_BPJS_DOCTOR_SCHEDULE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsDoctorScheduleActionOK(
						modelAction.BpjsDoctorScheduleModelActionTypes.DELETE_BPJS_DOCTOR_SCHEDULE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDoctorScheduleActionFail(
								modelAction.BpjsDoctorScheduleModelActionTypes.DELETE_BPJS_DOCTOR_SCHEDULE_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDoctorScheduleAction>(modelAction.BpjsDoctorScheduleModelActionTypes.DELETE_ALL_BPJS_DOCTOR_SCHEDULE),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsDoctorScheduleActionOK(
						modelAction.BpjsDoctorScheduleModelActionTypes.DELETE_ALL_BPJS_DOCTOR_SCHEDULE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDoctorScheduleActionFail(
								modelAction.BpjsDoctorScheduleModelActionTypes.DELETE_ALL_BPJS_DOCTOR_SCHEDULE_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDoctorScheduleAction>(modelAction.BpjsDoctorScheduleModelActionTypes.EXPORT_BPJS_DOCTOR_SCHEDULE),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsDoctorScheduleActionOK(
						modelAction.BpjsDoctorScheduleModelActionTypes.EXPORT_BPJS_DOCTOR_SCHEDULE,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDoctorScheduleAction>(modelAction.BpjsDoctorScheduleModelActionTypes.EXPORT_ALL_BPJS_DOCTOR_SCHEDULE),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsDoctorScheduleActionOK(
						modelAction.BpjsDoctorScheduleModelActionTypes.EXPORT_ALL_BPJS_DOCTOR_SCHEDULE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDoctorScheduleActionFail(
								modelAction.BpjsDoctorScheduleModelActionTypes.EXPORT_ALL_BPJS_DOCTOR_SCHEDULE_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDoctorScheduleAction>(modelAction.BpjsDoctorScheduleModelActionTypes.EXPORT_BPJS_DOCTOR_SCHEDULE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsDoctorScheduleActionOK(
						modelAction.BpjsDoctorScheduleModelActionTypes.EXPORT_BPJS_DOCTOR_SCHEDULE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDoctorScheduleActionFail(
								modelAction.BpjsDoctorScheduleModelActionTypes.EXPORT_BPJS_DOCTOR_SCHEDULE_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDoctorScheduleAction>(modelAction.BpjsDoctorScheduleModelActionTypes.IMPORT_BPJS_DOCTOR_SCHEDULES),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsDoctorScheduleActionOK(
						modelAction.BpjsDoctorScheduleModelActionTypes.IMPORT_BPJS_DOCTOR_SCHEDULES_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDoctorScheduleActionFail(
								modelAction.BpjsDoctorScheduleModelActionTypes.IMPORT_BPJS_DOCTOR_SCHEDULES_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDoctorScheduleAction>(modelAction.BpjsDoctorScheduleModelActionTypes.FETCH_BPJS_DOCTOR_SCHEDULE_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsDoctorScheduleActionOK(
						modelAction.BpjsDoctorScheduleModelActionTypes.FETCH_BPJS_DOCTOR_SCHEDULE_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDoctorScheduleActionFail(
								modelAction.BpjsDoctorScheduleModelActionTypes.FETCH_BPJS_DOCTOR_SCHEDULE_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDoctorScheduleAction>(modelAction.BpjsDoctorScheduleModelActionTypes.FETCH_BPJS_DOCTOR_SCHEDULE_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsDoctorScheduleActionOK(
						modelAction.BpjsDoctorScheduleModelActionTypes.FETCH_BPJS_DOCTOR_SCHEDULE_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDoctorScheduleActionFail(
								modelAction.BpjsDoctorScheduleModelActionTypes.FETCH_BPJS_DOCTOR_SCHEDULE_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
