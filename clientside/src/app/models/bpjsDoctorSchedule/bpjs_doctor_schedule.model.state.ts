...
/**
 * BpjsDoctorScheduleCollectionState would store the state of a collection of BpjsDoctorSchedule
 */
export interface BpjsDoctorScheduleCollectionState extends CollectionState {
 ...
 */
export interface BpjsDoctorScheduleModelAudit extends AbstractModelAudit<BpjsDoctorScheduleModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsDoctorScheduleModelState would store the state of the model
 */
export interface BpjsDoctorScheduleModelState {
	collectionState: {
		[key: string]: BpjsDoctorScheduleCollectionState;
	};
	data: {
		[id: string]: BpjsDoctorScheduleModel;
	};
	totalCount: number;
	audits: BpjsDoctorScheduleModelAudit[];
 ...
 */
export const initialBpjsDoctorScheduleCollectionState: BpjsDoctorScheduleCollectionState = {
...
/**
 * The initial state of BpjsDoctorScheduleModelState
 */
export const initialState: BpjsDoctorScheduleModelState = {
	collectionState: {
