...
/**
 * BpjsHealthFacilityCollectionState would store the state of a collection of BpjsHealthFacility
 */
export interface BpjsHealthFacilityCollectionState extends CollectionState {
 ...
 */
export interface BpjsHealthFacilityModelAudit extends AbstractModelAudit<BpjsHealthFacilityModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsHealthFacilityModelState would store the state of the model
 */
export interface BpjsHealthFacilityModelState {
	collectionState: {
		[key: string]: BpjsHealthFacilityCollectionState;
	};
	data: {
		[id: string]: BpjsHealthFacilityModel;
	};
	totalCount: number;
	audits: BpjsHealthFacilityModelAudit[];
 ...
 */
export const initialBpjsHealthFacilityCollectionState: BpjsHealthFacilityCollectionState = {
...
/**
 * The initial state of BpjsHealthFacilityModelState
 */
export const initialState: BpjsHealthFacilityModelState = {
	collectionState: {
