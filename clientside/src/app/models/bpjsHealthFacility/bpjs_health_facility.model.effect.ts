...
import * as modelAction from './bpjs_health_facility.model.action';
import {BpjsHealthFacilityService} from '../../services/bpjsHealthFacility/bpjs_health_facility.service';
...
/**
 * Effect class used for side effects related to BPJS Health Facility model.
 */
@Injectable()
export class BpjsHealthFacilityEffect {
	...
	constructor(
		...
		protected readonly service: BpjsHealthFacilityService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsHealthFacilityAction>(modelAction.BpjsHealthFacilityModelActionTypes.COUNT_BPJS_HEALTH_FACILITYS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsHealthFacilityActionOK(
						modelAction.BpjsHealthFacilityModelActionTypes.COUNT_BPJS_HEALTH_FACILITYS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsHealthFacilityActionFail(
								modelAction.BpjsHealthFacilityModelActionTypes.COUNT_BPJS_HEALTH_FACILITYS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsHealthFacilityAction>(modelAction.BpjsHealthFacilityModelActionTypes.FETCH_BPJS_HEALTH_FACILITY),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsHealthFacilityActionOK(
						modelAction.BpjsHealthFacilityModelActionTypes.FETCH_BPJS_HEALTH_FACILITY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsHealthFacilityActionFail(
								modelAction.BpjsHealthFacilityModelActionTypes.FETCH_BPJS_HEALTH_FACILITY_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsHealthFacilityAction>(modelAction.BpjsHealthFacilityModelActionTypes.FETCH_ALL_BPJS_HEALTH_FACILITY),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsHealthFacilityActionOK(
						modelAction.BpjsHealthFacilityModelActionTypes.FETCH_ALL_BPJS_HEALTH_FACILITY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsHealthFacilityActionFail(
								modelAction.BpjsHealthFacilityModelActionTypes.FETCH_ALL_BPJS_HEALTH_FACILITY_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsHealthFacilityAction>(modelAction.BpjsHealthFacilityModelActionTypes.FETCH_BPJS_HEALTH_FACILITY_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsHealthFacilityActionOK(
						modelAction.BpjsHealthFacilityModelActionTypes.FETCH_BPJS_HEALTH_FACILITY_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsHealthFacilityActionFail(
								modelAction.BpjsHealthFacilityModelActionTypes.FETCH_BPJS_HEALTH_FACILITY_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsHealthFacilityAction>(modelAction.BpjsHealthFacilityModelActionTypes.FETCH_LAST_BPJS_HEALTH_FACILITY_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsHealthFacilityActionOK(
						modelAction.BpjsHealthFacilityModelActionTypes.FETCH_LAST_BPJS_HEALTH_FACILITY_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsHealthFacilityActionFail(
								modelAction.BpjsHealthFacilityModelActionTypes.FETCH_LAST_BPJS_HEALTH_FACILITY_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsHealthFacilityAction>(modelAction.BpjsHealthFacilityModelActionTypes.CREATE_BPJS_HEALTH_FACILITY),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsHealthFacilityModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsHealthFacilityActionOK(
						modelAction.BpjsHealthFacilityModelActionTypes.CREATE_BPJS_HEALTH_FACILITY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsHealthFacilityActionFail(
								modelAction.BpjsHealthFacilityModelActionTypes.CREATE_BPJS_HEALTH_FACILITY_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsHealthFacilityAction>(modelAction.BpjsHealthFacilityModelActionTypes.CREATE_ALL_BPJS_HEALTH_FACILITY),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsHealthFacilityModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsHealthFacilityActionOK(
						modelAction.BpjsHealthFacilityModelActionTypes.CREATE_ALL_BPJS_HEALTH_FACILITY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsHealthFacilityActionFail(
								modelAction.BpjsHealthFacilityModelActionTypes.CREATE_ALL_BPJS_HEALTH_FACILITY_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsHealthFacilityAction>(modelAction.BpjsHealthFacilityModelActionTypes.UPDATE_BPJS_HEALTH_FACILITY),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsHealthFacilityModel;
				...
				return this.service.update(new BpjsHealthFacilityModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsHealthFacilityActionOK(
						modelAction.BpjsHealthFacilityModelActionTypes.UPDATE_BPJS_HEALTH_FACILITY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsHealthFacilityActionFail(
								modelAction.BpjsHealthFacilityModelActionTypes.UPDATE_BPJS_HEALTH_FACILITY_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsHealthFacilityAction>(modelAction.BpjsHealthFacilityModelActionTypes.UPDATE_ALL_BPJS_HEALTH_FACILITY),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsHealthFacilityModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsHealthFacilityModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsHealthFacilityActionOK(
						modelAction.BpjsHealthFacilityModelActionTypes.UPDATE_ALL_BPJS_HEALTH_FACILITY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsHealthFacilityActionFail(
								modelAction.BpjsHealthFacilityModelActionTypes.UPDATE_ALL_BPJS_HEALTH_FACILITY_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsHealthFacilityAction>(modelAction.BpjsHealthFacilityModelActionTypes.DELETE_BPJS_HEALTH_FACILITY),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsHealthFacilityActionOK(
						modelAction.BpjsHealthFacilityModelActionTypes.DELETE_BPJS_HEALTH_FACILITY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsHealthFacilityActionFail(
								modelAction.BpjsHealthFacilityModelActionTypes.DELETE_BPJS_HEALTH_FACILITY_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsHealthFacilityAction>(modelAction.BpjsHealthFacilityModelActionTypes.DELETE_BPJS_HEALTH_FACILITY_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsHealthFacilityActionOK(
						modelAction.BpjsHealthFacilityModelActionTypes.DELETE_BPJS_HEALTH_FACILITY_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsHealthFacilityActionFail(
								modelAction.BpjsHealthFacilityModelActionTypes.DELETE_BPJS_HEALTH_FACILITY_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsHealthFacilityAction>(modelAction.BpjsHealthFacilityModelActionTypes.DELETE_ALL_BPJS_HEALTH_FACILITY),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsHealthFacilityActionOK(
						modelAction.BpjsHealthFacilityModelActionTypes.DELETE_ALL_BPJS_HEALTH_FACILITY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsHealthFacilityActionFail(
								modelAction.BpjsHealthFacilityModelActionTypes.DELETE_ALL_BPJS_HEALTH_FACILITY_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsHealthFacilityAction>(modelAction.BpjsHealthFacilityModelActionTypes.EXPORT_BPJS_HEALTH_FACILITY),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsHealthFacilityActionOK(
						modelAction.BpjsHealthFacilityModelActionTypes.EXPORT_BPJS_HEALTH_FACILITY,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsHealthFacilityAction>(modelAction.BpjsHealthFacilityModelActionTypes.EXPORT_ALL_BPJS_HEALTH_FACILITY),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsHealthFacilityActionOK(
						modelAction.BpjsHealthFacilityModelActionTypes.EXPORT_ALL_BPJS_HEALTH_FACILITY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsHealthFacilityActionFail(
								modelAction.BpjsHealthFacilityModelActionTypes.EXPORT_ALL_BPJS_HEALTH_FACILITY_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsHealthFacilityAction>(modelAction.BpjsHealthFacilityModelActionTypes.EXPORT_BPJS_HEALTH_FACILITY_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsHealthFacilityActionOK(
						modelAction.BpjsHealthFacilityModelActionTypes.EXPORT_BPJS_HEALTH_FACILITY_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsHealthFacilityActionFail(
								modelAction.BpjsHealthFacilityModelActionTypes.EXPORT_BPJS_HEALTH_FACILITY_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsHealthFacilityAction>(modelAction.BpjsHealthFacilityModelActionTypes.IMPORT_BPJS_HEALTH_FACILITYS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsHealthFacilityActionOK(
						modelAction.BpjsHealthFacilityModelActionTypes.IMPORT_BPJS_HEALTH_FACILITYS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsHealthFacilityActionFail(
								modelAction.BpjsHealthFacilityModelActionTypes.IMPORT_BPJS_HEALTH_FACILITYS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsHealthFacilityAction>(modelAction.BpjsHealthFacilityModelActionTypes.FETCH_BPJS_HEALTH_FACILITY_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsHealthFacilityActionOK(
						modelAction.BpjsHealthFacilityModelActionTypes.FETCH_BPJS_HEALTH_FACILITY_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsHealthFacilityActionFail(
								modelAction.BpjsHealthFacilityModelActionTypes.FETCH_BPJS_HEALTH_FACILITY_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsHealthFacilityAction>(modelAction.BpjsHealthFacilityModelActionTypes.FETCH_BPJS_HEALTH_FACILITY_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsHealthFacilityActionOK(
						modelAction.BpjsHealthFacilityModelActionTypes.FETCH_BPJS_HEALTH_FACILITY_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsHealthFacilityActionFail(
								modelAction.BpjsHealthFacilityModelActionTypes.FETCH_BPJS_HEALTH_FACILITY_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
