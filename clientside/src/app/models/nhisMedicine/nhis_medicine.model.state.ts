...
/**
 * NhisMedicineCollectionState would store the state of a collection of NhisMedicine
 */
export interface NhisMedicineCollectionState extends CollectionState {
 ...
 */
export interface NhisMedicineModelAudit extends AbstractModelAudit<NhisMedicineModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * NhisMedicineModelState would store the state of the model
 */
export interface NhisMedicineModelState {
	collectionState: {
		[key: string]: NhisMedicineCollectionState;
	};
	data: {
		[id: string]: NhisMedicineModel;
	};
	totalCount: number;
	audits: NhisMedicineModelAudit[];
 ...
 */
export const initialNhisMedicineCollectionState: NhisMedicineCollectionState = {
...
/**
 * The initial state of NhisMedicineModelState
 */
export const initialState: NhisMedicineModelState = {
	collectionState: {
