...
import * as modelAction from './nhis_medicine.model.action';
import {NhisMedicineService} from '../../services/nhisMedicine/nhis_medicine.service';
...
/**
 * Effect class used for side effects related to NHIS Medicine model.
 */
@Injectable()
export class NhisMedicineEffect {
	...
	constructor(
		...
		protected readonly service: NhisMedicineService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisMedicineAction>(modelAction.NhisMedicineModelActionTypes.COUNT_NHIS_MEDICINES),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.NhisMedicineActionOK(
						modelAction.NhisMedicineModelActionTypes.COUNT_NHIS_MEDICINES_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisMedicineActionFail(
								modelAction.NhisMedicineModelActionTypes.COUNT_NHIS_MEDICINES_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisMedicineAction>(modelAction.NhisMedicineModelActionTypes.FETCH_NHIS_MEDICINE),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisMedicineActionOK(
						modelAction.NhisMedicineModelActionTypes.FETCH_NHIS_MEDICINE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisMedicineActionFail(
								modelAction.NhisMedicineModelActionTypes.FETCH_NHIS_MEDICINE_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisMedicineAction>(modelAction.NhisMedicineModelActionTypes.FETCH_ALL_NHIS_MEDICINE),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.NhisMedicineActionOK(
						modelAction.NhisMedicineModelActionTypes.FETCH_ALL_NHIS_MEDICINE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisMedicineActionFail(
								modelAction.NhisMedicineModelActionTypes.FETCH_ALL_NHIS_MEDICINE_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisMedicineAction>(modelAction.NhisMedicineModelActionTypes.FETCH_NHIS_MEDICINE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisMedicineActionOK(
						modelAction.NhisMedicineModelActionTypes.FETCH_NHIS_MEDICINE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisMedicineActionFail(
								modelAction.NhisMedicineModelActionTypes.FETCH_NHIS_MEDICINE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisMedicineAction>(modelAction.NhisMedicineModelActionTypes.FETCH_LAST_NHIS_MEDICINE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisMedicineActionOK(
						modelAction.NhisMedicineModelActionTypes.FETCH_LAST_NHIS_MEDICINE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisMedicineActionFail(
								modelAction.NhisMedicineModelActionTypes.FETCH_LAST_NHIS_MEDICINE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisMedicineAction>(modelAction.NhisMedicineModelActionTypes.CREATE_NHIS_MEDICINE),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as NhisMedicineModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisMedicineActionOK(
						modelAction.NhisMedicineModelActionTypes.CREATE_NHIS_MEDICINE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisMedicineActionFail(
								modelAction.NhisMedicineModelActionTypes.CREATE_NHIS_MEDICINE_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisMedicineAction>(modelAction.NhisMedicineModelActionTypes.CREATE_ALL_NHIS_MEDICINE),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as NhisMedicineModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisMedicineActionOK(
						modelAction.NhisMedicineModelActionTypes.CREATE_ALL_NHIS_MEDICINE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisMedicineActionFail(
								modelAction.NhisMedicineModelActionTypes.CREATE_ALL_NHIS_MEDICINE_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisMedicineAction>(modelAction.NhisMedicineModelActionTypes.UPDATE_NHIS_MEDICINE),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as NhisMedicineModel;
				...
				return this.service.update(new NhisMedicineModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisMedicineActionOK(
						modelAction.NhisMedicineModelActionTypes.UPDATE_NHIS_MEDICINE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisMedicineActionFail(
								modelAction.NhisMedicineModelActionTypes.UPDATE_NHIS_MEDICINE_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisMedicineAction>(modelAction.NhisMedicineModelActionTypes.UPDATE_ALL_NHIS_MEDICINE),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as NhisMedicineModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new NhisMedicineModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.NhisMedicineActionOK(
						modelAction.NhisMedicineModelActionTypes.UPDATE_ALL_NHIS_MEDICINE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisMedicineActionFail(
								modelAction.NhisMedicineModelActionTypes.UPDATE_ALL_NHIS_MEDICINE_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisMedicineAction>(modelAction.NhisMedicineModelActionTypes.DELETE_NHIS_MEDICINE),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.NhisMedicineActionOK(
						modelAction.NhisMedicineModelActionTypes.DELETE_NHIS_MEDICINE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisMedicineActionFail(
								modelAction.NhisMedicineModelActionTypes.DELETE_NHIS_MEDICINE_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisMedicineAction>(modelAction.NhisMedicineModelActionTypes.DELETE_NHIS_MEDICINE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.NhisMedicineActionOK(
						modelAction.NhisMedicineModelActionTypes.DELETE_NHIS_MEDICINE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisMedicineActionFail(
								modelAction.NhisMedicineModelActionTypes.DELETE_NHIS_MEDICINE_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisMedicineAction>(modelAction.NhisMedicineModelActionTypes.DELETE_ALL_NHIS_MEDICINE),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.NhisMedicineActionOK(
						modelAction.NhisMedicineModelActionTypes.DELETE_ALL_NHIS_MEDICINE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisMedicineActionFail(
								modelAction.NhisMedicineModelActionTypes.DELETE_ALL_NHIS_MEDICINE_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisMedicineAction>(modelAction.NhisMedicineModelActionTypes.EXPORT_NHIS_MEDICINE),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.NhisMedicineActionOK(
						modelAction.NhisMedicineModelActionTypes.EXPORT_NHIS_MEDICINE,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisMedicineAction>(modelAction.NhisMedicineModelActionTypes.EXPORT_ALL_NHIS_MEDICINE),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.NhisMedicineActionOK(
						modelAction.NhisMedicineModelActionTypes.EXPORT_ALL_NHIS_MEDICINE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisMedicineActionFail(
								modelAction.NhisMedicineModelActionTypes.EXPORT_ALL_NHIS_MEDICINE_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisMedicineAction>(modelAction.NhisMedicineModelActionTypes.EXPORT_NHIS_MEDICINE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.NhisMedicineActionOK(
						modelAction.NhisMedicineModelActionTypes.EXPORT_NHIS_MEDICINE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisMedicineActionFail(
								modelAction.NhisMedicineModelActionTypes.EXPORT_NHIS_MEDICINE_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisMedicineAction>(modelAction.NhisMedicineModelActionTypes.IMPORT_NHIS_MEDICINES),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.NhisMedicineActionOK(
						modelAction.NhisMedicineModelActionTypes.IMPORT_NHIS_MEDICINES_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.NhisMedicineActionFail(
								modelAction.NhisMedicineModelActionTypes.IMPORT_NHIS_MEDICINES_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisMedicineAction>(modelAction.NhisMedicineModelActionTypes.FETCH_NHIS_MEDICINE_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.NhisMedicineActionOK(
						modelAction.NhisMedicineModelActionTypes.FETCH_NHIS_MEDICINE_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.NhisMedicineActionFail(
								modelAction.NhisMedicineModelActionTypes.FETCH_NHIS_MEDICINE_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.NhisMedicineAction>(modelAction.NhisMedicineModelActionTypes.FETCH_NHIS_MEDICINE_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.NhisMedicineActionOK(
						modelAction.NhisMedicineModelActionTypes.FETCH_NHIS_MEDICINE_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.NhisMedicineActionFail(
								modelAction.NhisMedicineModelActionTypes.FETCH_NHIS_MEDICINE_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
