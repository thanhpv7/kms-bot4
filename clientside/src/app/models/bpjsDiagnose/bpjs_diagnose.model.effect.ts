...
import * as modelAction from './bpjs_diagnose.model.action';
import {BpjsDiagnoseService} from '../../services/bpjsDiagnose/bpjs_diagnose.service';
...
/**
 * Effect class used for side effects related to BPJS Diagnose model.
 */
@Injectable()
export class BpjsDiagnoseEffect {
	...
	constructor(
		...
		protected readonly service: BpjsDiagnoseService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDiagnoseAction>(modelAction.BpjsDiagnoseModelActionTypes.COUNT_BPJS_DIAGNOSES),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsDiagnoseActionOK(
						modelAction.BpjsDiagnoseModelActionTypes.COUNT_BPJS_DIAGNOSES_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDiagnoseActionFail(
								modelAction.BpjsDiagnoseModelActionTypes.COUNT_BPJS_DIAGNOSES_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDiagnoseAction>(modelAction.BpjsDiagnoseModelActionTypes.FETCH_BPJS_DIAGNOSE),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsDiagnoseActionOK(
						modelAction.BpjsDiagnoseModelActionTypes.FETCH_BPJS_DIAGNOSE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDiagnoseActionFail(
								modelAction.BpjsDiagnoseModelActionTypes.FETCH_BPJS_DIAGNOSE_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDiagnoseAction>(modelAction.BpjsDiagnoseModelActionTypes.FETCH_ALL_BPJS_DIAGNOSE),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsDiagnoseActionOK(
						modelAction.BpjsDiagnoseModelActionTypes.FETCH_ALL_BPJS_DIAGNOSE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDiagnoseActionFail(
								modelAction.BpjsDiagnoseModelActionTypes.FETCH_ALL_BPJS_DIAGNOSE_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDiagnoseAction>(modelAction.BpjsDiagnoseModelActionTypes.FETCH_BPJS_DIAGNOSE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsDiagnoseActionOK(
						modelAction.BpjsDiagnoseModelActionTypes.FETCH_BPJS_DIAGNOSE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDiagnoseActionFail(
								modelAction.BpjsDiagnoseModelActionTypes.FETCH_BPJS_DIAGNOSE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDiagnoseAction>(modelAction.BpjsDiagnoseModelActionTypes.FETCH_LAST_BPJS_DIAGNOSE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsDiagnoseActionOK(
						modelAction.BpjsDiagnoseModelActionTypes.FETCH_LAST_BPJS_DIAGNOSE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDiagnoseActionFail(
								modelAction.BpjsDiagnoseModelActionTypes.FETCH_LAST_BPJS_DIAGNOSE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDiagnoseAction>(modelAction.BpjsDiagnoseModelActionTypes.CREATE_BPJS_DIAGNOSE),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsDiagnoseModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsDiagnoseActionOK(
						modelAction.BpjsDiagnoseModelActionTypes.CREATE_BPJS_DIAGNOSE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDiagnoseActionFail(
								modelAction.BpjsDiagnoseModelActionTypes.CREATE_BPJS_DIAGNOSE_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDiagnoseAction>(modelAction.BpjsDiagnoseModelActionTypes.CREATE_ALL_BPJS_DIAGNOSE),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsDiagnoseModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsDiagnoseActionOK(
						modelAction.BpjsDiagnoseModelActionTypes.CREATE_ALL_BPJS_DIAGNOSE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDiagnoseActionFail(
								modelAction.BpjsDiagnoseModelActionTypes.CREATE_ALL_BPJS_DIAGNOSE_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDiagnoseAction>(modelAction.BpjsDiagnoseModelActionTypes.UPDATE_BPJS_DIAGNOSE),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsDiagnoseModel;
				...
				return this.service.update(new BpjsDiagnoseModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsDiagnoseActionOK(
						modelAction.BpjsDiagnoseModelActionTypes.UPDATE_BPJS_DIAGNOSE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDiagnoseActionFail(
								modelAction.BpjsDiagnoseModelActionTypes.UPDATE_BPJS_DIAGNOSE_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDiagnoseAction>(modelAction.BpjsDiagnoseModelActionTypes.UPDATE_ALL_BPJS_DIAGNOSE),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsDiagnoseModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsDiagnoseModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsDiagnoseActionOK(
						modelAction.BpjsDiagnoseModelActionTypes.UPDATE_ALL_BPJS_DIAGNOSE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDiagnoseActionFail(
								modelAction.BpjsDiagnoseModelActionTypes.UPDATE_ALL_BPJS_DIAGNOSE_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDiagnoseAction>(modelAction.BpjsDiagnoseModelActionTypes.DELETE_BPJS_DIAGNOSE),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsDiagnoseActionOK(
						modelAction.BpjsDiagnoseModelActionTypes.DELETE_BPJS_DIAGNOSE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDiagnoseActionFail(
								modelAction.BpjsDiagnoseModelActionTypes.DELETE_BPJS_DIAGNOSE_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDiagnoseAction>(modelAction.BpjsDiagnoseModelActionTypes.DELETE_BPJS_DIAGNOSE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsDiagnoseActionOK(
						modelAction.BpjsDiagnoseModelActionTypes.DELETE_BPJS_DIAGNOSE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDiagnoseActionFail(
								modelAction.BpjsDiagnoseModelActionTypes.DELETE_BPJS_DIAGNOSE_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDiagnoseAction>(modelAction.BpjsDiagnoseModelActionTypes.DELETE_ALL_BPJS_DIAGNOSE),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsDiagnoseActionOK(
						modelAction.BpjsDiagnoseModelActionTypes.DELETE_ALL_BPJS_DIAGNOSE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDiagnoseActionFail(
								modelAction.BpjsDiagnoseModelActionTypes.DELETE_ALL_BPJS_DIAGNOSE_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDiagnoseAction>(modelAction.BpjsDiagnoseModelActionTypes.EXPORT_BPJS_DIAGNOSE),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsDiagnoseActionOK(
						modelAction.BpjsDiagnoseModelActionTypes.EXPORT_BPJS_DIAGNOSE,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDiagnoseAction>(modelAction.BpjsDiagnoseModelActionTypes.EXPORT_ALL_BPJS_DIAGNOSE),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsDiagnoseActionOK(
						modelAction.BpjsDiagnoseModelActionTypes.EXPORT_ALL_BPJS_DIAGNOSE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDiagnoseActionFail(
								modelAction.BpjsDiagnoseModelActionTypes.EXPORT_ALL_BPJS_DIAGNOSE_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDiagnoseAction>(modelAction.BpjsDiagnoseModelActionTypes.EXPORT_BPJS_DIAGNOSE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsDiagnoseActionOK(
						modelAction.BpjsDiagnoseModelActionTypes.EXPORT_BPJS_DIAGNOSE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDiagnoseActionFail(
								modelAction.BpjsDiagnoseModelActionTypes.EXPORT_BPJS_DIAGNOSE_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDiagnoseAction>(modelAction.BpjsDiagnoseModelActionTypes.IMPORT_BPJS_DIAGNOSES),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsDiagnoseActionOK(
						modelAction.BpjsDiagnoseModelActionTypes.IMPORT_BPJS_DIAGNOSES_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDiagnoseActionFail(
								modelAction.BpjsDiagnoseModelActionTypes.IMPORT_BPJS_DIAGNOSES_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDiagnoseAction>(modelAction.BpjsDiagnoseModelActionTypes.FETCH_BPJS_DIAGNOSE_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsDiagnoseActionOK(
						modelAction.BpjsDiagnoseModelActionTypes.FETCH_BPJS_DIAGNOSE_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDiagnoseActionFail(
								modelAction.BpjsDiagnoseModelActionTypes.FETCH_BPJS_DIAGNOSE_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDiagnoseAction>(modelAction.BpjsDiagnoseModelActionTypes.FETCH_BPJS_DIAGNOSE_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsDiagnoseActionOK(
						modelAction.BpjsDiagnoseModelActionTypes.FETCH_BPJS_DIAGNOSE_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDiagnoseActionFail(
								modelAction.BpjsDiagnoseModelActionTypes.FETCH_BPJS_DIAGNOSE_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
