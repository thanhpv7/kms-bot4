...
/**
 * BpjsDiagnoseCollectionState would store the state of a collection of BpjsDiagnose
 */
export interface BpjsDiagnoseCollectionState extends CollectionState {
 ...
 */
export interface BpjsDiagnoseModelAudit extends AbstractModelAudit<BpjsDiagnoseModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsDiagnoseModelState would store the state of the model
 */
export interface BpjsDiagnoseModelState {
	collectionState: {
		[key: string]: BpjsDiagnoseCollectionState;
	};
	data: {
		[id: string]: BpjsDiagnoseModel;
	};
	totalCount: number;
	audits: BpjsDiagnoseModelAudit[];
 ...
 */
export const initialBpjsDiagnoseCollectionState: BpjsDiagnoseCollectionState = {
...
/**
 * The initial state of BpjsDiagnoseModelState
 */
export const initialState: BpjsDiagnoseModelState = {
	collectionState: {
