...
import * as modelAction from './body_chart_examination.model.action';
import {BodyChartExaminationService} from '../../services/bodyChartExamination/body_chart_examination.service';
...
/**
 * Effect class used for side effects related to Body Chart Examination model.
 */
@Injectable()
export class BodyChartExaminationEffect {
	...
	constructor(
		...
		protected readonly service: BodyChartExaminationService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BodyChartExaminationAction>(modelAction.BodyChartExaminationModelActionTypes.COUNT_BODY_CHART_EXAMINATIONS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BodyChartExaminationActionOK(
						modelAction.BodyChartExaminationModelActionTypes.COUNT_BODY_CHART_EXAMINATIONS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BodyChartExaminationActionFail(
								modelAction.BodyChartExaminationModelActionTypes.COUNT_BODY_CHART_EXAMINATIONS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BodyChartExaminationAction>(modelAction.BodyChartExaminationModelActionTypes.FETCH_BODY_CHART_EXAMINATION),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BodyChartExaminationActionOK(
						modelAction.BodyChartExaminationModelActionTypes.FETCH_BODY_CHART_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BodyChartExaminationActionFail(
								modelAction.BodyChartExaminationModelActionTypes.FETCH_BODY_CHART_EXAMINATION_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BodyChartExaminationAction>(modelAction.BodyChartExaminationModelActionTypes.FETCH_ALL_BODY_CHART_EXAMINATION),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BodyChartExaminationActionOK(
						modelAction.BodyChartExaminationModelActionTypes.FETCH_ALL_BODY_CHART_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BodyChartExaminationActionFail(
								modelAction.BodyChartExaminationModelActionTypes.FETCH_ALL_BODY_CHART_EXAMINATION_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BodyChartExaminationAction>(modelAction.BodyChartExaminationModelActionTypes.FETCH_BODY_CHART_EXAMINATION_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BodyChartExaminationActionOK(
						modelAction.BodyChartExaminationModelActionTypes.FETCH_BODY_CHART_EXAMINATION_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BodyChartExaminationActionFail(
								modelAction.BodyChartExaminationModelActionTypes.FETCH_BODY_CHART_EXAMINATION_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BodyChartExaminationAction>(modelAction.BodyChartExaminationModelActionTypes.FETCH_LAST_BODY_CHART_EXAMINATION_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BodyChartExaminationActionOK(
						modelAction.BodyChartExaminationModelActionTypes.FETCH_LAST_BODY_CHART_EXAMINATION_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BodyChartExaminationActionFail(
								modelAction.BodyChartExaminationModelActionTypes.FETCH_LAST_BODY_CHART_EXAMINATION_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BodyChartExaminationAction>(modelAction.BodyChartExaminationModelActionTypes.CREATE_BODY_CHART_EXAMINATION),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BodyChartExaminationModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BodyChartExaminationActionOK(
						modelAction.BodyChartExaminationModelActionTypes.CREATE_BODY_CHART_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BodyChartExaminationActionFail(
								modelAction.BodyChartExaminationModelActionTypes.CREATE_BODY_CHART_EXAMINATION_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BodyChartExaminationAction>(modelAction.BodyChartExaminationModelActionTypes.CREATE_ALL_BODY_CHART_EXAMINATION),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BodyChartExaminationModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BodyChartExaminationActionOK(
						modelAction.BodyChartExaminationModelActionTypes.CREATE_ALL_BODY_CHART_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BodyChartExaminationActionFail(
								modelAction.BodyChartExaminationModelActionTypes.CREATE_ALL_BODY_CHART_EXAMINATION_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BodyChartExaminationAction>(modelAction.BodyChartExaminationModelActionTypes.UPDATE_BODY_CHART_EXAMINATION),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BodyChartExaminationModel;
				...
				return this.service.update(new BodyChartExaminationModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BodyChartExaminationActionOK(
						modelAction.BodyChartExaminationModelActionTypes.UPDATE_BODY_CHART_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BodyChartExaminationActionFail(
								modelAction.BodyChartExaminationModelActionTypes.UPDATE_BODY_CHART_EXAMINATION_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BodyChartExaminationAction>(modelAction.BodyChartExaminationModelActionTypes.UPDATE_ALL_BODY_CHART_EXAMINATION),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BodyChartExaminationModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BodyChartExaminationModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BodyChartExaminationActionOK(
						modelAction.BodyChartExaminationModelActionTypes.UPDATE_ALL_BODY_CHART_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BodyChartExaminationActionFail(
								modelAction.BodyChartExaminationModelActionTypes.UPDATE_ALL_BODY_CHART_EXAMINATION_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BodyChartExaminationAction>(modelAction.BodyChartExaminationModelActionTypes.DELETE_BODY_CHART_EXAMINATION),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BodyChartExaminationActionOK(
						modelAction.BodyChartExaminationModelActionTypes.DELETE_BODY_CHART_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BodyChartExaminationActionFail(
								modelAction.BodyChartExaminationModelActionTypes.DELETE_BODY_CHART_EXAMINATION_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BodyChartExaminationAction>(modelAction.BodyChartExaminationModelActionTypes.DELETE_BODY_CHART_EXAMINATION_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BodyChartExaminationActionOK(
						modelAction.BodyChartExaminationModelActionTypes.DELETE_BODY_CHART_EXAMINATION_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BodyChartExaminationActionFail(
								modelAction.BodyChartExaminationModelActionTypes.DELETE_BODY_CHART_EXAMINATION_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BodyChartExaminationAction>(modelAction.BodyChartExaminationModelActionTypes.DELETE_ALL_BODY_CHART_EXAMINATION),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BodyChartExaminationActionOK(
						modelAction.BodyChartExaminationModelActionTypes.DELETE_ALL_BODY_CHART_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BodyChartExaminationActionFail(
								modelAction.BodyChartExaminationModelActionTypes.DELETE_ALL_BODY_CHART_EXAMINATION_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BodyChartExaminationAction>(modelAction.BodyChartExaminationModelActionTypes.EXPORT_BODY_CHART_EXAMINATION),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BodyChartExaminationActionOK(
						modelAction.BodyChartExaminationModelActionTypes.EXPORT_BODY_CHART_EXAMINATION,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BodyChartExaminationAction>(modelAction.BodyChartExaminationModelActionTypes.EXPORT_ALL_BODY_CHART_EXAMINATION),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BodyChartExaminationActionOK(
						modelAction.BodyChartExaminationModelActionTypes.EXPORT_ALL_BODY_CHART_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BodyChartExaminationActionFail(
								modelAction.BodyChartExaminationModelActionTypes.EXPORT_ALL_BODY_CHART_EXAMINATION_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BodyChartExaminationAction>(modelAction.BodyChartExaminationModelActionTypes.EXPORT_BODY_CHART_EXAMINATION_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BodyChartExaminationActionOK(
						modelAction.BodyChartExaminationModelActionTypes.EXPORT_BODY_CHART_EXAMINATION_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BodyChartExaminationActionFail(
								modelAction.BodyChartExaminationModelActionTypes.EXPORT_BODY_CHART_EXAMINATION_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BodyChartExaminationAction>(modelAction.BodyChartExaminationModelActionTypes.IMPORT_BODY_CHART_EXAMINATIONS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BodyChartExaminationActionOK(
						modelAction.BodyChartExaminationModelActionTypes.IMPORT_BODY_CHART_EXAMINATIONS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BodyChartExaminationActionFail(
								modelAction.BodyChartExaminationModelActionTypes.IMPORT_BODY_CHART_EXAMINATIONS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BodyChartExaminationAction>(modelAction.BodyChartExaminationModelActionTypes.FETCH_BODY_CHART_EXAMINATION_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BodyChartExaminationActionOK(
						modelAction.BodyChartExaminationModelActionTypes.FETCH_BODY_CHART_EXAMINATION_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BodyChartExaminationActionFail(
								modelAction.BodyChartExaminationModelActionTypes.FETCH_BODY_CHART_EXAMINATION_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BodyChartExaminationAction>(modelAction.BodyChartExaminationModelActionTypes.FETCH_BODY_CHART_EXAMINATION_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BodyChartExaminationActionOK(
						modelAction.BodyChartExaminationModelActionTypes.FETCH_BODY_CHART_EXAMINATION_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BodyChartExaminationActionFail(
								modelAction.BodyChartExaminationModelActionTypes.FETCH_BODY_CHART_EXAMINATION_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
