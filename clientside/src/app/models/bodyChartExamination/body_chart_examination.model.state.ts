...
/**
 * BodyChartExaminationCollectionState would store the state of a collection of BodyChartExamination
 */
export interface BodyChartExaminationCollectionState extends CollectionState {
 ...
 */
export interface BodyChartExaminationModelAudit extends AbstractModelAudit<BodyChartExaminationModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BodyChartExaminationModelState would store the state of the model
 */
export interface BodyChartExaminationModelState {
	collectionState: {
		[key: string]: BodyChartExaminationCollectionState;
	};
	data: {
		[id: string]: BodyChartExaminationModel;
	};
	totalCount: number;
	audits: BodyChartExaminationModelAudit[];
 ...
 */
export const initialBodyChartExaminationCollectionState: BodyChartExaminationCollectionState = {
...
/**
 * The initial state of BodyChartExaminationModelState
 */
export const initialState: BodyChartExaminationModelState = {
	collectionState: {
