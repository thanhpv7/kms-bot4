...
/**
 * BpjsVisitDataCollectionState would store the state of a collection of BpjsVisitData
 */
export interface BpjsVisitDataCollectionState extends CollectionState {
 ...
 */
export interface BpjsVisitDataModelAudit extends AbstractModelAudit<BpjsVisitDataModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsVisitDataModelState would store the state of the model
 */
export interface BpjsVisitDataModelState {
	collectionState: {
		[key: string]: BpjsVisitDataCollectionState;
	};
	data: {
		[id: string]: BpjsVisitDataModel;
	};
	totalCount: number;
	audits: BpjsVisitDataModelAudit[];
 ...
 */
export const initialBpjsVisitDataCollectionState: BpjsVisitDataCollectionState = {
...
/**
 * The initial state of BpjsVisitDataModelState
 */
export const initialState: BpjsVisitDataModelState = {
	collectionState: {
