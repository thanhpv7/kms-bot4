...
/**
 * EmergencyMedicalExaminationRecordCollectionState would store the state of a collection of EmergencyMedicalExaminationRecord
 */
export interface EmergencyMedicalExaminationRecordCollectionState extends CollectionState {
 ...
 */
export interface EmergencyMedicalExaminationRecordModelAudit extends AbstractModelAudit<EmergencyMedicalExaminationRecordModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * EmergencyMedicalExaminationRecordModelState would store the state of the model
 */
export interface EmergencyMedicalExaminationRecordModelState {
	collectionState: {
		[key: string]: EmergencyMedicalExaminationRecordCollectionState;
	};
	data: {
		[id: string]: EmergencyMedicalExaminationRecordModel;
	};
	totalCount: number;
	audits: EmergencyMedicalExaminationRecordModelAudit[];
 ...
 */
export const initialEmergencyMedicalExaminationRecordCollectionState: EmergencyMedicalExaminationRecordCollectionState = {
...
/**
 * The initial state of EmergencyMedicalExaminationRecordModelState
 */
export const initialState: EmergencyMedicalExaminationRecordModelState = {
	collectionState: {
