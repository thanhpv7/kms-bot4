...
import {initialEmergencyMedicalExaminationRecordCollectionState} from './emergency_medical_examination_record.model.state';
...
export function modelReducer(currentState: ModelState, action: Action): ModelState {
	...
	const className = (action as modelAction.BaseEmergencyMedicalExaminationRecordAction).className;
	...
	return produce(currentState, draft => {
		...
		switch (action.type) {
			case modelAction.EmergencyMedicalExaminationRecordModelActionTypes.CREATE_EMERGENCY_MEDICAL_EXAMINATION_RECORD_OK:
				const createdModel = (action as modelAction.EmergencyMedicalExaminationRecordActionOK ).stateConfig.targetModel;
				...
				EmergencyMedicalExaminationRecordModel.deepParse(createdModel).forEach(model => {
				...
				break;
			case modelAction.EmergencyMedicalExaminationRecordModelActionTypes.CREATE_EMERGENCY_MEDICAL_EXAMINATION_RECORD_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.EmergencyMedicalExaminationRecordModelActionTypes.CREATE_ALL_EMERGENCY_MEDICAL_EXAMINATION_RECORD_OK:
				const createdModels = (action as modelAction.EmergencyMedicalExaminationRecordActionOK).stateConfig.targetModels;
				const collectionIdAfterCreateAll = (action as modelAction.EmergencyMedicalExaminationRecordActionOK).stateConfig.collectionId;
				...
				createdModels.forEach((m) => {
					EmergencyMedicalExaminationRecordModel.deepParse(m).forEach(model => {
						draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
						(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
					});
				});
				...
				break;
			case modelAction.EmergencyMedicalExaminationRecordModelActionTypes.CREATE_ALL_EMERGENCY_MEDICAL_EXAMINATION_RECORD_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.EmergencyMedicalExaminationRecordModelActionTypes.DELETE_EMERGENCY_MEDICAL_EXAMINATION_RECORD_OK:
				const deletedModelId = (action as modelAction.EmergencyMedicalExaminationRecordActionOK).stateConfig.targetModelId;
				const collectionIdAfterDelete = (action as modelAction.EmergencyMedicalExaminationRecordActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.EmergencyMedicalExaminationRecordModelActionTypes.DELETE_ALL_EMERGENCY_MEDICAL_EXAMINATION_RECORD_OK:
				const deletedModelIds = (action as modelAction.EmergencyMedicalExaminationRecordActionOK).stateConfig.targetModelIds;
				const collectionIdAfterDeleteAll = (action as modelAction.EmergencyMedicalExaminationRecordActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.EmergencyMedicalExaminationRecordModelActionTypes.DELETE_EMERGENCY_MEDICAL_EXAMINATION_RECORD_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.EmergencyMedicalExaminationRecordModelActionTypes.UPDATE_EMERGENCY_MEDICAL_EXAMINATION_RECORD_OK:
				const updatedModel = (action as modelAction.EmergencyMedicalExaminationRecordActionOK).stateConfig.targetModel;
				...
				EmergencyMedicalExaminationRecordModel.deepParse(updatedModel).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.EmergencyMedicalExaminationRecordModelActionTypes.UPDATE_EMERGENCY_MEDICAL_EXAMINATION_RECORD_FAIL:
				// TODO: Add handling of failure
				break;

			case modelAction.EmergencyMedicalExaminationRecordModelActionTypes.UPDATE_ALL_EMERGENCY_MEDICAL_EXAMINATION_RECORD_OK:
				const updatedModels = (action as modelAction.EmergencyMedicalExaminationRecordActionOK).stateConfig.targetModels;
				const collectionIdAfterUpdateAll = (action as modelAction.EmergencyMedicalExaminationRecordActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.EmergencyMedicalExaminationRecordModelActionTypes.UPDATE_ALL_EMERGENCY_MEDICAL_EXAMINATION_RECORD_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.EmergencyMedicalExaminationRecordModelActionTypes.FETCH_EMERGENCY_MEDICAL_EXAMINATION_RECORD_OK:
				let fetchedModel = (action as modelAction.EmergencyMedicalExaminationRecordActionOK).stateConfig.targetModel;
				...
				EmergencyMedicalExaminationRecordModel.deepParse(fetchedModel).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.EmergencyMedicalExaminationRecordModelActionTypes.FETCH_ALL_EMERGENCY_MEDICAL_EXAMINATION_RECORD_OK:
				const totalCountAfterFetchAll = (action as modelAction.EmergencyMedicalExaminationRecordActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchAll = (action as modelAction.EmergencyMedicalExaminationRecordActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchAll = (action as modelAction.EmergencyMedicalExaminationRecordActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchAll = (action as modelAction.EmergencyMedicalExaminationRecordActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchAll.map(model => EmergencyMedicalExaminationRecordModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.EmergencyMedicalExaminationRecordModelActionTypes.FETCH_EMERGENCY_MEDICAL_EXAMINATION_RECORD_AUDIT_OK:
				const audits = (action as modelAction.EmergencyMedicalExaminationRecordActionOK).audits;
				...
				break;
			case modelAction.EmergencyMedicalExaminationRecordModelActionTypes.FETCH_EMERGENCY_MEDICAL_EXAMINATION_RECORD_AUDITS_BY_ENTITY_ID_OK:
				const auditsByEntityId = (action as modelAction.EmergencyMedicalExaminationRecordActionOK).audits;
				...
				break;
			case modelAction.EmergencyMedicalExaminationRecordModelActionTypes.FETCH_EMERGENCY_MEDICAL_EXAMINATION_RECORD_WITH_QUERY_OK:
				const totalCountAfterFetchWithQuery = (action as modelAction.EmergencyMedicalExaminationRecordActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchWithQuery = (action as modelAction.EmergencyMedicalExaminationRecordActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchWithQuery = (action as modelAction.EmergencyMedicalExaminationRecordActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchWithQuery = (action as modelAction.EmergencyMedicalExaminationRecordActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchWithQuery.map(model => EmergencyMedicalExaminationRecordModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.EmergencyMedicalExaminationRecordModelActionTypes.FETCH_LAST_EMERGENCY_MEDICAL_EXAMINATION_RECORD_WITH_QUERY_OK:
				const totalCountAfterFetchLastWithQuery = (action as modelAction.EmergencyMedicalExaminationRecordActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchLastWithQuery = (action as modelAction.EmergencyMedicalExaminationRecordActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchLastWithQuery = (action as modelAction.EmergencyMedicalExaminationRecordActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchLastWithQuery = (action as modelAction.EmergencyMedicalExaminationRecordActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchLastWithQuery.map(model => EmergencyMedicalExaminationRecordModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.EmergencyMedicalExaminationRecordModelActionTypes.COUNT_EMERGENCY_MEDICAL_EXAMINATION_RECORDS_OK:
				const totalCountAfterCount = (action as modelAction.EmergencyMedicalExaminationRecordActionOK).stateConfig.totalCount;
				...
				break;
			case modelAction.EmergencyMedicalExaminationRecordModelActionTypes.INITIALISE_EMERGENCY_MEDICAL_EXAMINATION_RECORD_COLLECTION_STATE:
				const collectionIdToInitialise =  (action as modelAction.EmergencyMedicalExaminationRecordActionOK).stateConfig.collectionId;
				const queryParamsToInitialise = (action as modelAction.EmergencyMedicalExaminationRecordActionOK).stateConfig.queryParams;
				...
				if (!draft[className].collectionState[collectionIdToInitialise]) {
					draft[className].collectionState[collectionIdToInitialise] = {
						...initialEmergencyMedicalExaminationRecordCollectionState
					};
				}
