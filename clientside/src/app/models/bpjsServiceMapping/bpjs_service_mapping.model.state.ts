...
/**
 * BpjsServiceMappingCollectionState would store the state of a collection of BpjsServiceMapping
 */
export interface BpjsServiceMappingCollectionState extends CollectionState {
 ...
 */
export interface BpjsServiceMappingModelAudit extends AbstractModelAudit<BpjsServiceMappingModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsServiceMappingModelState would store the state of the model
 */
export interface BpjsServiceMappingModelState {
	collectionState: {
		[key: string]: BpjsServiceMappingCollectionState;
	};
	data: {
		[id: string]: BpjsServiceMappingModel;
	};
	totalCount: number;
	audits: BpjsServiceMappingModelAudit[];
 ...
 */
export const initialBpjsServiceMappingCollectionState: BpjsServiceMappingCollectionState = {
...
/**
 * The initial state of BpjsServiceMappingModelState
 */
export const initialState: BpjsServiceMappingModelState = {
	collectionState: {
