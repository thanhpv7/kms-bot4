...
import * as modelAction from './bpjs_service_mapping.model.action';
import {BpjsServiceMappingService} from '../../services/bpjsServiceMapping/bpjs_service_mapping.service';
...
/**
 * Effect class used for side effects related to BPJS Service Mapping model.
 */
@Injectable()
export class BpjsServiceMappingEffect {
	...
	constructor(
		...
		protected readonly service: BpjsServiceMappingService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsServiceMappingAction>(modelAction.BpjsServiceMappingModelActionTypes.COUNT_BPJS_SERVICE_MAPPINGS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsServiceMappingActionOK(
						modelAction.BpjsServiceMappingModelActionTypes.COUNT_BPJS_SERVICE_MAPPINGS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsServiceMappingActionFail(
								modelAction.BpjsServiceMappingModelActionTypes.COUNT_BPJS_SERVICE_MAPPINGS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsServiceMappingAction>(modelAction.BpjsServiceMappingModelActionTypes.FETCH_BPJS_SERVICE_MAPPING),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsServiceMappingActionOK(
						modelAction.BpjsServiceMappingModelActionTypes.FETCH_BPJS_SERVICE_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsServiceMappingActionFail(
								modelAction.BpjsServiceMappingModelActionTypes.FETCH_BPJS_SERVICE_MAPPING_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsServiceMappingAction>(modelAction.BpjsServiceMappingModelActionTypes.FETCH_ALL_BPJS_SERVICE_MAPPING),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsServiceMappingActionOK(
						modelAction.BpjsServiceMappingModelActionTypes.FETCH_ALL_BPJS_SERVICE_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsServiceMappingActionFail(
								modelAction.BpjsServiceMappingModelActionTypes.FETCH_ALL_BPJS_SERVICE_MAPPING_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsServiceMappingAction>(modelAction.BpjsServiceMappingModelActionTypes.FETCH_BPJS_SERVICE_MAPPING_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsServiceMappingActionOK(
						modelAction.BpjsServiceMappingModelActionTypes.FETCH_BPJS_SERVICE_MAPPING_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsServiceMappingActionFail(
								modelAction.BpjsServiceMappingModelActionTypes.FETCH_BPJS_SERVICE_MAPPING_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsServiceMappingAction>(modelAction.BpjsServiceMappingModelActionTypes.FETCH_LAST_BPJS_SERVICE_MAPPING_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsServiceMappingActionOK(
						modelAction.BpjsServiceMappingModelActionTypes.FETCH_LAST_BPJS_SERVICE_MAPPING_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsServiceMappingActionFail(
								modelAction.BpjsServiceMappingModelActionTypes.FETCH_LAST_BPJS_SERVICE_MAPPING_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsServiceMappingAction>(modelAction.BpjsServiceMappingModelActionTypes.CREATE_BPJS_SERVICE_MAPPING),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsServiceMappingModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsServiceMappingActionOK(
						modelAction.BpjsServiceMappingModelActionTypes.CREATE_BPJS_SERVICE_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsServiceMappingActionFail(
								modelAction.BpjsServiceMappingModelActionTypes.CREATE_BPJS_SERVICE_MAPPING_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsServiceMappingAction>(modelAction.BpjsServiceMappingModelActionTypes.CREATE_ALL_BPJS_SERVICE_MAPPING),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsServiceMappingModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsServiceMappingActionOK(
						modelAction.BpjsServiceMappingModelActionTypes.CREATE_ALL_BPJS_SERVICE_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsServiceMappingActionFail(
								modelAction.BpjsServiceMappingModelActionTypes.CREATE_ALL_BPJS_SERVICE_MAPPING_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsServiceMappingAction>(modelAction.BpjsServiceMappingModelActionTypes.UPDATE_BPJS_SERVICE_MAPPING),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsServiceMappingModel;
				...
				return this.service.update(new BpjsServiceMappingModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsServiceMappingActionOK(
						modelAction.BpjsServiceMappingModelActionTypes.UPDATE_BPJS_SERVICE_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsServiceMappingActionFail(
								modelAction.BpjsServiceMappingModelActionTypes.UPDATE_BPJS_SERVICE_MAPPING_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsServiceMappingAction>(modelAction.BpjsServiceMappingModelActionTypes.UPDATE_ALL_BPJS_SERVICE_MAPPING),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsServiceMappingModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsServiceMappingModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsServiceMappingActionOK(
						modelAction.BpjsServiceMappingModelActionTypes.UPDATE_ALL_BPJS_SERVICE_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsServiceMappingActionFail(
								modelAction.BpjsServiceMappingModelActionTypes.UPDATE_ALL_BPJS_SERVICE_MAPPING_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsServiceMappingAction>(modelAction.BpjsServiceMappingModelActionTypes.DELETE_BPJS_SERVICE_MAPPING),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsServiceMappingActionOK(
						modelAction.BpjsServiceMappingModelActionTypes.DELETE_BPJS_SERVICE_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsServiceMappingActionFail(
								modelAction.BpjsServiceMappingModelActionTypes.DELETE_BPJS_SERVICE_MAPPING_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsServiceMappingAction>(modelAction.BpjsServiceMappingModelActionTypes.DELETE_BPJS_SERVICE_MAPPING_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsServiceMappingActionOK(
						modelAction.BpjsServiceMappingModelActionTypes.DELETE_BPJS_SERVICE_MAPPING_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsServiceMappingActionFail(
								modelAction.BpjsServiceMappingModelActionTypes.DELETE_BPJS_SERVICE_MAPPING_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsServiceMappingAction>(modelAction.BpjsServiceMappingModelActionTypes.DELETE_ALL_BPJS_SERVICE_MAPPING),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsServiceMappingActionOK(
						modelAction.BpjsServiceMappingModelActionTypes.DELETE_ALL_BPJS_SERVICE_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsServiceMappingActionFail(
								modelAction.BpjsServiceMappingModelActionTypes.DELETE_ALL_BPJS_SERVICE_MAPPING_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsServiceMappingAction>(modelAction.BpjsServiceMappingModelActionTypes.EXPORT_BPJS_SERVICE_MAPPING),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsServiceMappingActionOK(
						modelAction.BpjsServiceMappingModelActionTypes.EXPORT_BPJS_SERVICE_MAPPING,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsServiceMappingAction>(modelAction.BpjsServiceMappingModelActionTypes.EXPORT_ALL_BPJS_SERVICE_MAPPING),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsServiceMappingActionOK(
						modelAction.BpjsServiceMappingModelActionTypes.EXPORT_ALL_BPJS_SERVICE_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsServiceMappingActionFail(
								modelAction.BpjsServiceMappingModelActionTypes.EXPORT_ALL_BPJS_SERVICE_MAPPING_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsServiceMappingAction>(modelAction.BpjsServiceMappingModelActionTypes.EXPORT_BPJS_SERVICE_MAPPING_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsServiceMappingActionOK(
						modelAction.BpjsServiceMappingModelActionTypes.EXPORT_BPJS_SERVICE_MAPPING_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsServiceMappingActionFail(
								modelAction.BpjsServiceMappingModelActionTypes.EXPORT_BPJS_SERVICE_MAPPING_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsServiceMappingAction>(modelAction.BpjsServiceMappingModelActionTypes.IMPORT_BPJS_SERVICE_MAPPINGS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsServiceMappingActionOK(
						modelAction.BpjsServiceMappingModelActionTypes.IMPORT_BPJS_SERVICE_MAPPINGS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsServiceMappingActionFail(
								modelAction.BpjsServiceMappingModelActionTypes.IMPORT_BPJS_SERVICE_MAPPINGS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsServiceMappingAction>(modelAction.BpjsServiceMappingModelActionTypes.FETCH_BPJS_SERVICE_MAPPING_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsServiceMappingActionOK(
						modelAction.BpjsServiceMappingModelActionTypes.FETCH_BPJS_SERVICE_MAPPING_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsServiceMappingActionFail(
								modelAction.BpjsServiceMappingModelActionTypes.FETCH_BPJS_SERVICE_MAPPING_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsServiceMappingAction>(modelAction.BpjsServiceMappingModelActionTypes.FETCH_BPJS_SERVICE_MAPPING_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsServiceMappingActionOK(
						modelAction.BpjsServiceMappingModelActionTypes.FETCH_BPJS_SERVICE_MAPPING_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsServiceMappingActionFail(
								modelAction.BpjsServiceMappingModelActionTypes.FETCH_BPJS_SERVICE_MAPPING_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
