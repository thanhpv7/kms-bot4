...
/**
 * SupplierProductDetailCollectionState would store the state of a collection of SupplierProductDetail
 */
export interface SupplierProductDetailCollectionState extends CollectionState {
 ...
 */
export interface SupplierProductDetailModelAudit extends AbstractModelAudit<SupplierProductDetailModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * SupplierProductDetailModelState would store the state of the model
 */
export interface SupplierProductDetailModelState {
	collectionState: {
		[key: string]: SupplierProductDetailCollectionState;
	};
	data: {
		[id: string]: SupplierProductDetailModel;
	};
	totalCount: number;
	audits: SupplierProductDetailModelAudit[];
 ...
 */
export const initialSupplierProductDetailCollectionState: SupplierProductDetailCollectionState = {
...
/**
 * The initial state of SupplierProductDetailModelState
 */
export const initialState: SupplierProductDetailModelState = {
	collectionState: {
