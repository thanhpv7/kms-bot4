...
import * as modelAction from './supplier_product_detail.model.action';
import {SupplierProductDetailService} from '../../services/supplierProductDetail/supplier_product_detail.service';
...
/**
 * Effect class used for side effects related to Supplier Product Detail model.
 */
@Injectable()
export class SupplierProductDetailEffect {
	...
	constructor(
		...
		protected readonly service: SupplierProductDetailService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierProductDetailAction>(modelAction.SupplierProductDetailModelActionTypes.COUNT_SUPPLIER_PRODUCT_DETAILS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.SupplierProductDetailActionOK(
						modelAction.SupplierProductDetailModelActionTypes.COUNT_SUPPLIER_PRODUCT_DETAILS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SupplierProductDetailActionFail(
								modelAction.SupplierProductDetailModelActionTypes.COUNT_SUPPLIER_PRODUCT_DETAILS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierProductDetailAction>(modelAction.SupplierProductDetailModelActionTypes.FETCH_SUPPLIER_PRODUCT_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.SupplierProductDetailActionOK(
						modelAction.SupplierProductDetailModelActionTypes.FETCH_SUPPLIER_PRODUCT_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SupplierProductDetailActionFail(
								modelAction.SupplierProductDetailModelActionTypes.FETCH_SUPPLIER_PRODUCT_DETAIL_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierProductDetailAction>(modelAction.SupplierProductDetailModelActionTypes.FETCH_ALL_SUPPLIER_PRODUCT_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.SupplierProductDetailActionOK(
						modelAction.SupplierProductDetailModelActionTypes.FETCH_ALL_SUPPLIER_PRODUCT_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SupplierProductDetailActionFail(
								modelAction.SupplierProductDetailModelActionTypes.FETCH_ALL_SUPPLIER_PRODUCT_DETAIL_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierProductDetailAction>(modelAction.SupplierProductDetailModelActionTypes.FETCH_SUPPLIER_PRODUCT_DETAIL_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.SupplierProductDetailActionOK(
						modelAction.SupplierProductDetailModelActionTypes.FETCH_SUPPLIER_PRODUCT_DETAIL_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SupplierProductDetailActionFail(
								modelAction.SupplierProductDetailModelActionTypes.FETCH_SUPPLIER_PRODUCT_DETAIL_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierProductDetailAction>(modelAction.SupplierProductDetailModelActionTypes.FETCH_LAST_SUPPLIER_PRODUCT_DETAIL_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.SupplierProductDetailActionOK(
						modelAction.SupplierProductDetailModelActionTypes.FETCH_LAST_SUPPLIER_PRODUCT_DETAIL_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SupplierProductDetailActionFail(
								modelAction.SupplierProductDetailModelActionTypes.FETCH_LAST_SUPPLIER_PRODUCT_DETAIL_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierProductDetailAction>(modelAction.SupplierProductDetailModelActionTypes.CREATE_SUPPLIER_PRODUCT_DETAIL),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as SupplierProductDetailModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.SupplierProductDetailActionOK(
						modelAction.SupplierProductDetailModelActionTypes.CREATE_SUPPLIER_PRODUCT_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SupplierProductDetailActionFail(
								modelAction.SupplierProductDetailModelActionTypes.CREATE_SUPPLIER_PRODUCT_DETAIL_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierProductDetailAction>(modelAction.SupplierProductDetailModelActionTypes.CREATE_ALL_SUPPLIER_PRODUCT_DETAIL),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as SupplierProductDetailModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.SupplierProductDetailActionOK(
						modelAction.SupplierProductDetailModelActionTypes.CREATE_ALL_SUPPLIER_PRODUCT_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SupplierProductDetailActionFail(
								modelAction.SupplierProductDetailModelActionTypes.CREATE_ALL_SUPPLIER_PRODUCT_DETAIL_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierProductDetailAction>(modelAction.SupplierProductDetailModelActionTypes.UPDATE_SUPPLIER_PRODUCT_DETAIL),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as SupplierProductDetailModel;
				...
				return this.service.update(new SupplierProductDetailModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.SupplierProductDetailActionOK(
						modelAction.SupplierProductDetailModelActionTypes.UPDATE_SUPPLIER_PRODUCT_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SupplierProductDetailActionFail(
								modelAction.SupplierProductDetailModelActionTypes.UPDATE_SUPPLIER_PRODUCT_DETAIL_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierProductDetailAction>(modelAction.SupplierProductDetailModelActionTypes.UPDATE_ALL_SUPPLIER_PRODUCT_DETAIL),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as SupplierProductDetailModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new SupplierProductDetailModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.SupplierProductDetailActionOK(
						modelAction.SupplierProductDetailModelActionTypes.UPDATE_ALL_SUPPLIER_PRODUCT_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SupplierProductDetailActionFail(
								modelAction.SupplierProductDetailModelActionTypes.UPDATE_ALL_SUPPLIER_PRODUCT_DETAIL_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierProductDetailAction>(modelAction.SupplierProductDetailModelActionTypes.DELETE_SUPPLIER_PRODUCT_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.SupplierProductDetailActionOK(
						modelAction.SupplierProductDetailModelActionTypes.DELETE_SUPPLIER_PRODUCT_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SupplierProductDetailActionFail(
								modelAction.SupplierProductDetailModelActionTypes.DELETE_SUPPLIER_PRODUCT_DETAIL_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierProductDetailAction>(modelAction.SupplierProductDetailModelActionTypes.DELETE_SUPPLIER_PRODUCT_DETAIL_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.SupplierProductDetailActionOK(
						modelAction.SupplierProductDetailModelActionTypes.DELETE_SUPPLIER_PRODUCT_DETAIL_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SupplierProductDetailActionFail(
								modelAction.SupplierProductDetailModelActionTypes.DELETE_SUPPLIER_PRODUCT_DETAIL_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierProductDetailAction>(modelAction.SupplierProductDetailModelActionTypes.DELETE_ALL_SUPPLIER_PRODUCT_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.SupplierProductDetailActionOK(
						modelAction.SupplierProductDetailModelActionTypes.DELETE_ALL_SUPPLIER_PRODUCT_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SupplierProductDetailActionFail(
								modelAction.SupplierProductDetailModelActionTypes.DELETE_ALL_SUPPLIER_PRODUCT_DETAIL_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierProductDetailAction>(modelAction.SupplierProductDetailModelActionTypes.EXPORT_SUPPLIER_PRODUCT_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.SupplierProductDetailActionOK(
						modelAction.SupplierProductDetailModelActionTypes.EXPORT_SUPPLIER_PRODUCT_DETAIL,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierProductDetailAction>(modelAction.SupplierProductDetailModelActionTypes.EXPORT_ALL_SUPPLIER_PRODUCT_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.SupplierProductDetailActionOK(
						modelAction.SupplierProductDetailModelActionTypes.EXPORT_ALL_SUPPLIER_PRODUCT_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SupplierProductDetailActionFail(
								modelAction.SupplierProductDetailModelActionTypes.EXPORT_ALL_SUPPLIER_PRODUCT_DETAIL_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierProductDetailAction>(modelAction.SupplierProductDetailModelActionTypes.EXPORT_SUPPLIER_PRODUCT_DETAIL_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.SupplierProductDetailActionOK(
						modelAction.SupplierProductDetailModelActionTypes.EXPORT_SUPPLIER_PRODUCT_DETAIL_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SupplierProductDetailActionFail(
								modelAction.SupplierProductDetailModelActionTypes.EXPORT_SUPPLIER_PRODUCT_DETAIL_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierProductDetailAction>(modelAction.SupplierProductDetailModelActionTypes.IMPORT_SUPPLIER_PRODUCT_DETAILS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.SupplierProductDetailActionOK(
						modelAction.SupplierProductDetailModelActionTypes.IMPORT_SUPPLIER_PRODUCT_DETAILS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SupplierProductDetailActionFail(
								modelAction.SupplierProductDetailModelActionTypes.IMPORT_SUPPLIER_PRODUCT_DETAILS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierProductDetailAction>(modelAction.SupplierProductDetailModelActionTypes.FETCH_SUPPLIER_PRODUCT_DETAIL_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.SupplierProductDetailActionOK(
						modelAction.SupplierProductDetailModelActionTypes.FETCH_SUPPLIER_PRODUCT_DETAIL_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.SupplierProductDetailActionFail(
								modelAction.SupplierProductDetailModelActionTypes.FETCH_SUPPLIER_PRODUCT_DETAIL_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SupplierProductDetailAction>(modelAction.SupplierProductDetailModelActionTypes.FETCH_SUPPLIER_PRODUCT_DETAIL_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.SupplierProductDetailActionOK(
						modelAction.SupplierProductDetailModelActionTypes.FETCH_SUPPLIER_PRODUCT_DETAIL_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.SupplierProductDetailActionFail(
								modelAction.SupplierProductDetailModelActionTypes.FETCH_SUPPLIER_PRODUCT_DETAIL_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
