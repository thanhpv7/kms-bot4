...
/**
 * ObstetricAndGynecologyHistoryCollectionState would store the state of a collection of ObstetricAndGynecologyHistory
 */
export interface ObstetricAndGynecologyHistoryCollectionState extends CollectionState {
 ...
 */
export interface ObstetricAndGynecologyHistoryModelAudit extends AbstractModelAudit<ObstetricAndGynecologyHistoryModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * ObstetricAndGynecologyHistoryModelState would store the state of the model
 */
export interface ObstetricAndGynecologyHistoryModelState {
	collectionState: {
		[key: string]: ObstetricAndGynecologyHistoryCollectionState;
	};
	data: {
		[id: string]: ObstetricAndGynecologyHistoryModel;
	};
	totalCount: number;
	audits: ObstetricAndGynecologyHistoryModelAudit[];
 ...
 */
export const initialObstetricAndGynecologyHistoryCollectionState: ObstetricAndGynecologyHistoryCollectionState = {
...
/**
 * The initial state of ObstetricAndGynecologyHistoryModelState
 */
export const initialState: ObstetricAndGynecologyHistoryModelState = {
	collectionState: {
