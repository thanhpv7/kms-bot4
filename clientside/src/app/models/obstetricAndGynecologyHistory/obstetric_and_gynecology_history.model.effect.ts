...
import * as modelAction from './obstetric_and_gynecology_history.model.action';
import {ObstetricAndGynecologyHistoryService} from '../../services/obstetricAndGynecologyHistory/obstetric_and_gynecology_history.service';
...
/**
 * Effect class used for side effects related to Obstetric And Gynecology History model.
 */
@Injectable()
export class ObstetricAndGynecologyHistoryEffect {
	...
	constructor(
		...
		protected readonly service: ObstetricAndGynecologyHistoryService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ObstetricAndGynecologyHistoryAction>(modelAction.ObstetricAndGynecologyHistoryModelActionTypes.COUNT_OBSTETRIC_AND_GYNECOLOGY_HISTORYS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.ObstetricAndGynecologyHistoryActionOK(
						modelAction.ObstetricAndGynecologyHistoryModelActionTypes.COUNT_OBSTETRIC_AND_GYNECOLOGY_HISTORYS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ObstetricAndGynecologyHistoryActionFail(
								modelAction.ObstetricAndGynecologyHistoryModelActionTypes.COUNT_OBSTETRIC_AND_GYNECOLOGY_HISTORYS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ObstetricAndGynecologyHistoryAction>(modelAction.ObstetricAndGynecologyHistoryModelActionTypes.FETCH_OBSTETRIC_AND_GYNECOLOGY_HISTORY),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ObstetricAndGynecologyHistoryActionOK(
						modelAction.ObstetricAndGynecologyHistoryModelActionTypes.FETCH_OBSTETRIC_AND_GYNECOLOGY_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ObstetricAndGynecologyHistoryActionFail(
								modelAction.ObstetricAndGynecologyHistoryModelActionTypes.FETCH_OBSTETRIC_AND_GYNECOLOGY_HISTORY_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ObstetricAndGynecologyHistoryAction>(modelAction.ObstetricAndGynecologyHistoryModelActionTypes.FETCH_ALL_OBSTETRIC_AND_GYNECOLOGY_HISTORY),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.ObstetricAndGynecologyHistoryActionOK(
						modelAction.ObstetricAndGynecologyHistoryModelActionTypes.FETCH_ALL_OBSTETRIC_AND_GYNECOLOGY_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ObstetricAndGynecologyHistoryActionFail(
								modelAction.ObstetricAndGynecologyHistoryModelActionTypes.FETCH_ALL_OBSTETRIC_AND_GYNECOLOGY_HISTORY_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ObstetricAndGynecologyHistoryAction>(modelAction.ObstetricAndGynecologyHistoryModelActionTypes.FETCH_OBSTETRIC_AND_GYNECOLOGY_HISTORY_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.ObstetricAndGynecologyHistoryActionOK(
						modelAction.ObstetricAndGynecologyHistoryModelActionTypes.FETCH_OBSTETRIC_AND_GYNECOLOGY_HISTORY_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ObstetricAndGynecologyHistoryActionFail(
								modelAction.ObstetricAndGynecologyHistoryModelActionTypes.FETCH_OBSTETRIC_AND_GYNECOLOGY_HISTORY_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ObstetricAndGynecologyHistoryAction>(modelAction.ObstetricAndGynecologyHistoryModelActionTypes.FETCH_LAST_OBSTETRIC_AND_GYNECOLOGY_HISTORY_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.ObstetricAndGynecologyHistoryActionOK(
						modelAction.ObstetricAndGynecologyHistoryModelActionTypes.FETCH_LAST_OBSTETRIC_AND_GYNECOLOGY_HISTORY_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ObstetricAndGynecologyHistoryActionFail(
								modelAction.ObstetricAndGynecologyHistoryModelActionTypes.FETCH_LAST_OBSTETRIC_AND_GYNECOLOGY_HISTORY_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ObstetricAndGynecologyHistoryAction>(modelAction.ObstetricAndGynecologyHistoryModelActionTypes.CREATE_OBSTETRIC_AND_GYNECOLOGY_HISTORY),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as ObstetricAndGynecologyHistoryModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ObstetricAndGynecologyHistoryActionOK(
						modelAction.ObstetricAndGynecologyHistoryModelActionTypes.CREATE_OBSTETRIC_AND_GYNECOLOGY_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ObstetricAndGynecologyHistoryActionFail(
								modelAction.ObstetricAndGynecologyHistoryModelActionTypes.CREATE_OBSTETRIC_AND_GYNECOLOGY_HISTORY_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ObstetricAndGynecologyHistoryAction>(modelAction.ObstetricAndGynecologyHistoryModelActionTypes.CREATE_ALL_OBSTETRIC_AND_GYNECOLOGY_HISTORY),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as ObstetricAndGynecologyHistoryModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ObstetricAndGynecologyHistoryActionOK(
						modelAction.ObstetricAndGynecologyHistoryModelActionTypes.CREATE_ALL_OBSTETRIC_AND_GYNECOLOGY_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ObstetricAndGynecologyHistoryActionFail(
								modelAction.ObstetricAndGynecologyHistoryModelActionTypes.CREATE_ALL_OBSTETRIC_AND_GYNECOLOGY_HISTORY_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ObstetricAndGynecologyHistoryAction>(modelAction.ObstetricAndGynecologyHistoryModelActionTypes.UPDATE_OBSTETRIC_AND_GYNECOLOGY_HISTORY),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as ObstetricAndGynecologyHistoryModel;
				...
				return this.service.update(new ObstetricAndGynecologyHistoryModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.ObstetricAndGynecologyHistoryActionOK(
						modelAction.ObstetricAndGynecologyHistoryModelActionTypes.UPDATE_OBSTETRIC_AND_GYNECOLOGY_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ObstetricAndGynecologyHistoryActionFail(
								modelAction.ObstetricAndGynecologyHistoryModelActionTypes.UPDATE_OBSTETRIC_AND_GYNECOLOGY_HISTORY_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ObstetricAndGynecologyHistoryAction>(modelAction.ObstetricAndGynecologyHistoryModelActionTypes.UPDATE_ALL_OBSTETRIC_AND_GYNECOLOGY_HISTORY),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as ObstetricAndGynecologyHistoryModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new ObstetricAndGynecologyHistoryModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ObstetricAndGynecologyHistoryActionOK(
						modelAction.ObstetricAndGynecologyHistoryModelActionTypes.UPDATE_ALL_OBSTETRIC_AND_GYNECOLOGY_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ObstetricAndGynecologyHistoryActionFail(
								modelAction.ObstetricAndGynecologyHistoryModelActionTypes.UPDATE_ALL_OBSTETRIC_AND_GYNECOLOGY_HISTORY_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ObstetricAndGynecologyHistoryAction>(modelAction.ObstetricAndGynecologyHistoryModelActionTypes.DELETE_OBSTETRIC_AND_GYNECOLOGY_HISTORY),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.ObstetricAndGynecologyHistoryActionOK(
						modelAction.ObstetricAndGynecologyHistoryModelActionTypes.DELETE_OBSTETRIC_AND_GYNECOLOGY_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ObstetricAndGynecologyHistoryActionFail(
								modelAction.ObstetricAndGynecologyHistoryModelActionTypes.DELETE_OBSTETRIC_AND_GYNECOLOGY_HISTORY_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ObstetricAndGynecologyHistoryAction>(modelAction.ObstetricAndGynecologyHistoryModelActionTypes.DELETE_OBSTETRIC_AND_GYNECOLOGY_HISTORY_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.ObstetricAndGynecologyHistoryActionOK(
						modelAction.ObstetricAndGynecologyHistoryModelActionTypes.DELETE_OBSTETRIC_AND_GYNECOLOGY_HISTORY_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ObstetricAndGynecologyHistoryActionFail(
								modelAction.ObstetricAndGynecologyHistoryModelActionTypes.DELETE_OBSTETRIC_AND_GYNECOLOGY_HISTORY_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ObstetricAndGynecologyHistoryAction>(modelAction.ObstetricAndGynecologyHistoryModelActionTypes.DELETE_ALL_OBSTETRIC_AND_GYNECOLOGY_HISTORY),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.ObstetricAndGynecologyHistoryActionOK(
						modelAction.ObstetricAndGynecologyHistoryModelActionTypes.DELETE_ALL_OBSTETRIC_AND_GYNECOLOGY_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ObstetricAndGynecologyHistoryActionFail(
								modelAction.ObstetricAndGynecologyHistoryModelActionTypes.DELETE_ALL_OBSTETRIC_AND_GYNECOLOGY_HISTORY_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ObstetricAndGynecologyHistoryAction>(modelAction.ObstetricAndGynecologyHistoryModelActionTypes.EXPORT_OBSTETRIC_AND_GYNECOLOGY_HISTORY),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ObstetricAndGynecologyHistoryActionOK(
						modelAction.ObstetricAndGynecologyHistoryModelActionTypes.EXPORT_OBSTETRIC_AND_GYNECOLOGY_HISTORY,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ObstetricAndGynecologyHistoryAction>(modelAction.ObstetricAndGynecologyHistoryModelActionTypes.EXPORT_ALL_OBSTETRIC_AND_GYNECOLOGY_HISTORY),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ObstetricAndGynecologyHistoryActionOK(
						modelAction.ObstetricAndGynecologyHistoryModelActionTypes.EXPORT_ALL_OBSTETRIC_AND_GYNECOLOGY_HISTORY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ObstetricAndGynecologyHistoryActionFail(
								modelAction.ObstetricAndGynecologyHistoryModelActionTypes.EXPORT_ALL_OBSTETRIC_AND_GYNECOLOGY_HISTORY_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ObstetricAndGynecologyHistoryAction>(modelAction.ObstetricAndGynecologyHistoryModelActionTypes.EXPORT_OBSTETRIC_AND_GYNECOLOGY_HISTORY_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ObstetricAndGynecologyHistoryActionOK(
						modelAction.ObstetricAndGynecologyHistoryModelActionTypes.EXPORT_OBSTETRIC_AND_GYNECOLOGY_HISTORY_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ObstetricAndGynecologyHistoryActionFail(
								modelAction.ObstetricAndGynecologyHistoryModelActionTypes.EXPORT_OBSTETRIC_AND_GYNECOLOGY_HISTORY_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ObstetricAndGynecologyHistoryAction>(modelAction.ObstetricAndGynecologyHistoryModelActionTypes.IMPORT_OBSTETRIC_AND_GYNECOLOGY_HISTORYS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.ObstetricAndGynecologyHistoryActionOK(
						modelAction.ObstetricAndGynecologyHistoryModelActionTypes.IMPORT_OBSTETRIC_AND_GYNECOLOGY_HISTORYS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ObstetricAndGynecologyHistoryActionFail(
								modelAction.ObstetricAndGynecologyHistoryModelActionTypes.IMPORT_OBSTETRIC_AND_GYNECOLOGY_HISTORYS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ObstetricAndGynecologyHistoryAction>(modelAction.ObstetricAndGynecologyHistoryModelActionTypes.FETCH_OBSTETRIC_AND_GYNECOLOGY_HISTORY_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.ObstetricAndGynecologyHistoryActionOK(
						modelAction.ObstetricAndGynecologyHistoryModelActionTypes.FETCH_OBSTETRIC_AND_GYNECOLOGY_HISTORY_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.ObstetricAndGynecologyHistoryActionFail(
								modelAction.ObstetricAndGynecologyHistoryModelActionTypes.FETCH_OBSTETRIC_AND_GYNECOLOGY_HISTORY_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ObstetricAndGynecologyHistoryAction>(modelAction.ObstetricAndGynecologyHistoryModelActionTypes.FETCH_OBSTETRIC_AND_GYNECOLOGY_HISTORY_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.ObstetricAndGynecologyHistoryActionOK(
						modelAction.ObstetricAndGynecologyHistoryModelActionTypes.FETCH_OBSTETRIC_AND_GYNECOLOGY_HISTORY_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.ObstetricAndGynecologyHistoryActionFail(
								modelAction.ObstetricAndGynecologyHistoryModelActionTypes.FETCH_OBSTETRIC_AND_GYNECOLOGY_HISTORY_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
