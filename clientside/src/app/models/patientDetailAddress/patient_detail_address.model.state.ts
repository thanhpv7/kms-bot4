...
/**
 * PatientDetailAddressCollectionState would store the state of a collection of PatientDetailAddress
 */
export interface PatientDetailAddressCollectionState extends CollectionState {
 ...
 */
export interface PatientDetailAddressModelAudit extends AbstractModelAudit<PatientDetailAddressModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * PatientDetailAddressModelState would store the state of the model
 */
export interface PatientDetailAddressModelState {
	collectionState: {
		[key: string]: PatientDetailAddressCollectionState;
	};
	data: {
		[id: string]: PatientDetailAddressModel;
	};
	totalCount: number;
	audits: PatientDetailAddressModelAudit[];
 ...
 */
export const initialPatientDetailAddressCollectionState: PatientDetailAddressCollectionState = {
...
/**
 * The initial state of PatientDetailAddressModelState
 */
export const initialState: PatientDetailAddressModelState = {
	collectionState: {
