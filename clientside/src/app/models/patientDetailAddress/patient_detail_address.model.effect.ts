...
import * as modelAction from './patient_detail_address.model.action';
import {PatientDetailAddressService} from '../../services/patientDetailAddress/patient_detail_address.service';
...
/**
 * Effect class used for side effects related to Patient Detail Address model.
 */
@Injectable()
export class PatientDetailAddressEffect {
	...
	constructor(
		...
		protected readonly service: PatientDetailAddressService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientDetailAddressAction>(modelAction.PatientDetailAddressModelActionTypes.COUNT_PATIENT_DETAIL_ADDRESSS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.PatientDetailAddressActionOK(
						modelAction.PatientDetailAddressModelActionTypes.COUNT_PATIENT_DETAIL_ADDRESSS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientDetailAddressActionFail(
								modelAction.PatientDetailAddressModelActionTypes.COUNT_PATIENT_DETAIL_ADDRESSS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientDetailAddressAction>(modelAction.PatientDetailAddressModelActionTypes.FETCH_PATIENT_DETAIL_ADDRESS),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientDetailAddressActionOK(
						modelAction.PatientDetailAddressModelActionTypes.FETCH_PATIENT_DETAIL_ADDRESS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientDetailAddressActionFail(
								modelAction.PatientDetailAddressModelActionTypes.FETCH_PATIENT_DETAIL_ADDRESS_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientDetailAddressAction>(modelAction.PatientDetailAddressModelActionTypes.FETCH_ALL_PATIENT_DETAIL_ADDRESS),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.PatientDetailAddressActionOK(
						modelAction.PatientDetailAddressModelActionTypes.FETCH_ALL_PATIENT_DETAIL_ADDRESS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientDetailAddressActionFail(
								modelAction.PatientDetailAddressModelActionTypes.FETCH_ALL_PATIENT_DETAIL_ADDRESS_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientDetailAddressAction>(modelAction.PatientDetailAddressModelActionTypes.FETCH_PATIENT_DETAIL_ADDRESS_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientDetailAddressActionOK(
						modelAction.PatientDetailAddressModelActionTypes.FETCH_PATIENT_DETAIL_ADDRESS_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientDetailAddressActionFail(
								modelAction.PatientDetailAddressModelActionTypes.FETCH_PATIENT_DETAIL_ADDRESS_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientDetailAddressAction>(modelAction.PatientDetailAddressModelActionTypes.FETCH_LAST_PATIENT_DETAIL_ADDRESS_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientDetailAddressActionOK(
						modelAction.PatientDetailAddressModelActionTypes.FETCH_LAST_PATIENT_DETAIL_ADDRESS_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientDetailAddressActionFail(
								modelAction.PatientDetailAddressModelActionTypes.FETCH_LAST_PATIENT_DETAIL_ADDRESS_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientDetailAddressAction>(modelAction.PatientDetailAddressModelActionTypes.CREATE_PATIENT_DETAIL_ADDRESS),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as PatientDetailAddressModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientDetailAddressActionOK(
						modelAction.PatientDetailAddressModelActionTypes.CREATE_PATIENT_DETAIL_ADDRESS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientDetailAddressActionFail(
								modelAction.PatientDetailAddressModelActionTypes.CREATE_PATIENT_DETAIL_ADDRESS_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientDetailAddressAction>(modelAction.PatientDetailAddressModelActionTypes.CREATE_ALL_PATIENT_DETAIL_ADDRESS),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as PatientDetailAddressModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientDetailAddressActionOK(
						modelAction.PatientDetailAddressModelActionTypes.CREATE_ALL_PATIENT_DETAIL_ADDRESS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientDetailAddressActionFail(
								modelAction.PatientDetailAddressModelActionTypes.CREATE_ALL_PATIENT_DETAIL_ADDRESS_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientDetailAddressAction>(modelAction.PatientDetailAddressModelActionTypes.UPDATE_PATIENT_DETAIL_ADDRESS),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as PatientDetailAddressModel;
				...
				return this.service.update(new PatientDetailAddressModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientDetailAddressActionOK(
						modelAction.PatientDetailAddressModelActionTypes.UPDATE_PATIENT_DETAIL_ADDRESS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientDetailAddressActionFail(
								modelAction.PatientDetailAddressModelActionTypes.UPDATE_PATIENT_DETAIL_ADDRESS_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientDetailAddressAction>(modelAction.PatientDetailAddressModelActionTypes.UPDATE_ALL_PATIENT_DETAIL_ADDRESS),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as PatientDetailAddressModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new PatientDetailAddressModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientDetailAddressActionOK(
						modelAction.PatientDetailAddressModelActionTypes.UPDATE_ALL_PATIENT_DETAIL_ADDRESS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientDetailAddressActionFail(
								modelAction.PatientDetailAddressModelActionTypes.UPDATE_ALL_PATIENT_DETAIL_ADDRESS_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientDetailAddressAction>(modelAction.PatientDetailAddressModelActionTypes.DELETE_PATIENT_DETAIL_ADDRESS),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PatientDetailAddressActionOK(
						modelAction.PatientDetailAddressModelActionTypes.DELETE_PATIENT_DETAIL_ADDRESS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientDetailAddressActionFail(
								modelAction.PatientDetailAddressModelActionTypes.DELETE_PATIENT_DETAIL_ADDRESS_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientDetailAddressAction>(modelAction.PatientDetailAddressModelActionTypes.DELETE_PATIENT_DETAIL_ADDRESS_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.PatientDetailAddressActionOK(
						modelAction.PatientDetailAddressModelActionTypes.DELETE_PATIENT_DETAIL_ADDRESS_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientDetailAddressActionFail(
								modelAction.PatientDetailAddressModelActionTypes.DELETE_PATIENT_DETAIL_ADDRESS_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientDetailAddressAction>(modelAction.PatientDetailAddressModelActionTypes.DELETE_ALL_PATIENT_DETAIL_ADDRESS),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PatientDetailAddressActionOK(
						modelAction.PatientDetailAddressModelActionTypes.DELETE_ALL_PATIENT_DETAIL_ADDRESS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientDetailAddressActionFail(
								modelAction.PatientDetailAddressModelActionTypes.DELETE_ALL_PATIENT_DETAIL_ADDRESS_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientDetailAddressAction>(modelAction.PatientDetailAddressModelActionTypes.EXPORT_PATIENT_DETAIL_ADDRESS),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PatientDetailAddressActionOK(
						modelAction.PatientDetailAddressModelActionTypes.EXPORT_PATIENT_DETAIL_ADDRESS,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientDetailAddressAction>(modelAction.PatientDetailAddressModelActionTypes.EXPORT_ALL_PATIENT_DETAIL_ADDRESS),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PatientDetailAddressActionOK(
						modelAction.PatientDetailAddressModelActionTypes.EXPORT_ALL_PATIENT_DETAIL_ADDRESS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientDetailAddressActionFail(
								modelAction.PatientDetailAddressModelActionTypes.EXPORT_ALL_PATIENT_DETAIL_ADDRESS_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientDetailAddressAction>(modelAction.PatientDetailAddressModelActionTypes.EXPORT_PATIENT_DETAIL_ADDRESS_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PatientDetailAddressActionOK(
						modelAction.PatientDetailAddressModelActionTypes.EXPORT_PATIENT_DETAIL_ADDRESS_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientDetailAddressActionFail(
								modelAction.PatientDetailAddressModelActionTypes.EXPORT_PATIENT_DETAIL_ADDRESS_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientDetailAddressAction>(modelAction.PatientDetailAddressModelActionTypes.IMPORT_PATIENT_DETAIL_ADDRESSS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.PatientDetailAddressActionOK(
						modelAction.PatientDetailAddressModelActionTypes.IMPORT_PATIENT_DETAIL_ADDRESSS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientDetailAddressActionFail(
								modelAction.PatientDetailAddressModelActionTypes.IMPORT_PATIENT_DETAIL_ADDRESSS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientDetailAddressAction>(modelAction.PatientDetailAddressModelActionTypes.FETCH_PATIENT_DETAIL_ADDRESS_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.PatientDetailAddressActionOK(
						modelAction.PatientDetailAddressModelActionTypes.FETCH_PATIENT_DETAIL_ADDRESS_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PatientDetailAddressActionFail(
								modelAction.PatientDetailAddressModelActionTypes.FETCH_PATIENT_DETAIL_ADDRESS_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientDetailAddressAction>(modelAction.PatientDetailAddressModelActionTypes.FETCH_PATIENT_DETAIL_ADDRESS_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.PatientDetailAddressActionOK(
						modelAction.PatientDetailAddressModelActionTypes.FETCH_PATIENT_DETAIL_ADDRESS_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PatientDetailAddressActionFail(
								modelAction.PatientDetailAddressModelActionTypes.FETCH_PATIENT_DETAIL_ADDRESS_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
