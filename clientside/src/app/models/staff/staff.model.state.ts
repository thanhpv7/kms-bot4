...
/**
 * StaffCollectionState would store the state of a collection of Staff
 */
export interface StaffCollectionState extends CollectionState {
 ...
 */
export interface StaffModelAudit extends AbstractModelAudit<StaffModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * StaffModelState would store the state of the model
 */
export interface StaffModelState {
	collectionState: {
		[key: string]: StaffCollectionState;
	};
	data: {
		[id: string]: StaffModel;
	};
	totalCount: number;
	audits: StaffModelAudit[];
 ...
 */
export const initialStaffCollectionState: StaffCollectionState = {
...
/**
 * The initial state of StaffModelState
 */
export const initialState: StaffModelState = {
	collectionState: {
