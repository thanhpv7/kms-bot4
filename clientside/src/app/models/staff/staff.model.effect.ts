...
/**
 * Effect class used for side effects related to Staff model.
 */
@Injectable()
export class StaffEffect {
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StaffAction>(modelAction.StaffModelActionTypes.COUNT_STAFFS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.StaffActionOK(
						modelAction.StaffModelActionTypes.COUNT_STAFFS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StaffActionFail(
								modelAction.StaffModelActionTypes.COUNT_STAFFS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StaffAction>(modelAction.StaffModelActionTypes.FETCH_STAFF),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.StaffActionOK(
						modelAction.StaffModelActionTypes.FETCH_STAFF_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StaffActionFail(
								modelAction.StaffModelActionTypes.FETCH_STAFF_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StaffAction>(modelAction.StaffModelActionTypes.FETCH_ALL_STAFF),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.StaffActionOK(
						modelAction.StaffModelActionTypes.FETCH_ALL_STAFF_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StaffActionFail(
								modelAction.StaffModelActionTypes.FETCH_ALL_STAFF_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StaffAction>(modelAction.StaffModelActionTypes.FETCH_STAFF_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.StaffActionOK(
						modelAction.StaffModelActionTypes.FETCH_STAFF_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StaffActionFail(
								modelAction.StaffModelActionTypes.FETCH_STAFF_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StaffAction>(modelAction.StaffModelActionTypes.FETCH_LAST_STAFF_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.StaffActionOK(
						modelAction.StaffModelActionTypes.FETCH_LAST_STAFF_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StaffActionFail(
								modelAction.StaffModelActionTypes.FETCH_LAST_STAFF_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StaffAction>(modelAction.StaffModelActionTypes.CREATE_STAFF),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as StaffModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.StaffActionOK(
						modelAction.StaffModelActionTypes.CREATE_STAFF_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StaffActionFail(
								modelAction.StaffModelActionTypes.CREATE_STAFF_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StaffAction>(modelAction.StaffModelActionTypes.CREATE_ALL_STAFF),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as StaffModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.StaffActionOK(
						modelAction.StaffModelActionTypes.CREATE_ALL_STAFF_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StaffActionFail(
								modelAction.StaffModelActionTypes.CREATE_ALL_STAFF_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StaffAction>(modelAction.StaffModelActionTypes.UPDATE_STAFF),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as StaffModel;
				...
				return this.service.update(new StaffModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.StaffActionOK(
						modelAction.StaffModelActionTypes.UPDATE_STAFF_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StaffActionFail(
								modelAction.StaffModelActionTypes.UPDATE_STAFF_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StaffAction>(modelAction.StaffModelActionTypes.UPDATE_ALL_STAFF),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as StaffModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new StaffModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.StaffActionOK(
						modelAction.StaffModelActionTypes.UPDATE_ALL_STAFF_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StaffActionFail(
								modelAction.StaffModelActionTypes.UPDATE_ALL_STAFF_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StaffAction>(modelAction.StaffModelActionTypes.DELETE_STAFF),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.StaffActionOK(
						modelAction.StaffModelActionTypes.DELETE_STAFF_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StaffActionFail(
								modelAction.StaffModelActionTypes.DELETE_STAFF_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StaffAction>(modelAction.StaffModelActionTypes.DELETE_STAFF_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.StaffActionOK(
						modelAction.StaffModelActionTypes.DELETE_STAFF_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StaffActionFail(
								modelAction.StaffModelActionTypes.DELETE_STAFF_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StaffAction>(modelAction.StaffModelActionTypes.DELETE_ALL_STAFF),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.StaffActionOK(
						modelAction.StaffModelActionTypes.DELETE_ALL_STAFF_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StaffActionFail(
								modelAction.StaffModelActionTypes.DELETE_ALL_STAFF_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StaffAction>(modelAction.StaffModelActionTypes.EXPORT_STAFF),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.StaffActionOK(
						modelAction.StaffModelActionTypes.EXPORT_STAFF,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StaffAction>(modelAction.StaffModelActionTypes.EXPORT_ALL_STAFF),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.StaffActionOK(
						modelAction.StaffModelActionTypes.EXPORT_ALL_STAFF_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StaffActionFail(
								modelAction.StaffModelActionTypes.EXPORT_ALL_STAFF_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StaffAction>(modelAction.StaffModelActionTypes.EXPORT_STAFF_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.StaffActionOK(
						modelAction.StaffModelActionTypes.EXPORT_STAFF_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StaffActionFail(
								modelAction.StaffModelActionTypes.EXPORT_STAFF_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StaffAction>(modelAction.StaffModelActionTypes.IMPORT_STAFFS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.StaffActionOK(
						modelAction.StaffModelActionTypes.IMPORT_STAFFS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StaffActionFail(
								modelAction.StaffModelActionTypes.IMPORT_STAFFS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StaffAction>(modelAction.StaffModelActionTypes.FETCH_STAFF_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.StaffActionOK(
						modelAction.StaffModelActionTypes.FETCH_STAFF_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.StaffActionFail(
								modelAction.StaffModelActionTypes.FETCH_STAFF_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StaffAction>(modelAction.StaffModelActionTypes.FETCH_STAFF_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.StaffActionOK(
						modelAction.StaffModelActionTypes.FETCH_STAFF_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.StaffActionFail(
								modelAction.StaffModelActionTypes.FETCH_STAFF_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
