...
/**
 * MedicalTranscriberUserCollectionState would store the state of a collection of MedicalTranscriberUser
 */
export interface MedicalTranscriberUserCollectionState extends CollectionState {
 ...
 */
export interface MedicalTranscriberUserModelAudit extends AbstractModelAudit<MedicalTranscriberUserModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * MedicalTranscriberUserModelState would store the state of the model
 */
export interface MedicalTranscriberUserModelState {
	collectionState: {
		[key: string]: MedicalTranscriberUserCollectionState;
	};
	data: {
		[id: string]: MedicalTranscriberUserModel;
	};
	totalCount: number;
	audits: MedicalTranscriberUserModelAudit[];
 ...
 */
export const initialMedicalTranscriberUserCollectionState: MedicalTranscriberUserCollectionState = {
...
/**
 * The initial state of MedicalTranscriberUserModelState
 */
export const initialState: MedicalTranscriberUserModelState = {
	collectionState: {
