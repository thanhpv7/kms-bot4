...
import * as modelAction from './medical_transcriber_user.model.action';
import {MedicalTranscriberUserService} from '../../services/medicalTranscriberUser/medical_transcriber_user.service';
...
/**
 * Effect class used for side effects related to Medical Transcriber User model.
 */
@Injectable()
export class MedicalTranscriberUserEffect {
	...
	constructor(
		...
		protected readonly service: MedicalTranscriberUserService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalTranscriberUserAction>(modelAction.MedicalTranscriberUserModelActionTypes.COUNT_MEDICAL_TRANSCRIBER_USERS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.MedicalTranscriberUserActionOK(
						modelAction.MedicalTranscriberUserModelActionTypes.COUNT_MEDICAL_TRANSCRIBER_USERS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalTranscriberUserActionFail(
								modelAction.MedicalTranscriberUserModelActionTypes.COUNT_MEDICAL_TRANSCRIBER_USERS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalTranscriberUserAction>(modelAction.MedicalTranscriberUserModelActionTypes.FETCH_MEDICAL_TRANSCRIBER_USER),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalTranscriberUserActionOK(
						modelAction.MedicalTranscriberUserModelActionTypes.FETCH_MEDICAL_TRANSCRIBER_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalTranscriberUserActionFail(
								modelAction.MedicalTranscriberUserModelActionTypes.FETCH_MEDICAL_TRANSCRIBER_USER_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalTranscriberUserAction>(modelAction.MedicalTranscriberUserModelActionTypes.FETCH_ALL_MEDICAL_TRANSCRIBER_USER),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.MedicalTranscriberUserActionOK(
						modelAction.MedicalTranscriberUserModelActionTypes.FETCH_ALL_MEDICAL_TRANSCRIBER_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalTranscriberUserActionFail(
								modelAction.MedicalTranscriberUserModelActionTypes.FETCH_ALL_MEDICAL_TRANSCRIBER_USER_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalTranscriberUserAction>(modelAction.MedicalTranscriberUserModelActionTypes.FETCH_MEDICAL_TRANSCRIBER_USER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalTranscriberUserActionOK(
						modelAction.MedicalTranscriberUserModelActionTypes.FETCH_MEDICAL_TRANSCRIBER_USER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalTranscriberUserActionFail(
								modelAction.MedicalTranscriberUserModelActionTypes.FETCH_MEDICAL_TRANSCRIBER_USER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalTranscriberUserAction>(modelAction.MedicalTranscriberUserModelActionTypes.FETCH_LAST_MEDICAL_TRANSCRIBER_USER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalTranscriberUserActionOK(
						modelAction.MedicalTranscriberUserModelActionTypes.FETCH_LAST_MEDICAL_TRANSCRIBER_USER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalTranscriberUserActionFail(
								modelAction.MedicalTranscriberUserModelActionTypes.FETCH_LAST_MEDICAL_TRANSCRIBER_USER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalTranscriberUserAction>(modelAction.MedicalTranscriberUserModelActionTypes.CREATE_MEDICAL_TRANSCRIBER_USER),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as MedicalTranscriberUserModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalTranscriberUserActionOK(
						modelAction.MedicalTranscriberUserModelActionTypes.CREATE_MEDICAL_TRANSCRIBER_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalTranscriberUserActionFail(
								modelAction.MedicalTranscriberUserModelActionTypes.CREATE_MEDICAL_TRANSCRIBER_USER_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalTranscriberUserAction>(modelAction.MedicalTranscriberUserModelActionTypes.CREATE_ALL_MEDICAL_TRANSCRIBER_USER),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as MedicalTranscriberUserModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalTranscriberUserActionOK(
						modelAction.MedicalTranscriberUserModelActionTypes.CREATE_ALL_MEDICAL_TRANSCRIBER_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalTranscriberUserActionFail(
								modelAction.MedicalTranscriberUserModelActionTypes.CREATE_ALL_MEDICAL_TRANSCRIBER_USER_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalTranscriberUserAction>(modelAction.MedicalTranscriberUserModelActionTypes.UPDATE_MEDICAL_TRANSCRIBER_USER),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as MedicalTranscriberUserModel;
				...
				return this.service.update(new MedicalTranscriberUserModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalTranscriberUserActionOK(
						modelAction.MedicalTranscriberUserModelActionTypes.UPDATE_MEDICAL_TRANSCRIBER_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalTranscriberUserActionFail(
								modelAction.MedicalTranscriberUserModelActionTypes.UPDATE_MEDICAL_TRANSCRIBER_USER_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalTranscriberUserAction>(modelAction.MedicalTranscriberUserModelActionTypes.UPDATE_ALL_MEDICAL_TRANSCRIBER_USER),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as MedicalTranscriberUserModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new MedicalTranscriberUserModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalTranscriberUserActionOK(
						modelAction.MedicalTranscriberUserModelActionTypes.UPDATE_ALL_MEDICAL_TRANSCRIBER_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalTranscriberUserActionFail(
								modelAction.MedicalTranscriberUserModelActionTypes.UPDATE_ALL_MEDICAL_TRANSCRIBER_USER_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalTranscriberUserAction>(modelAction.MedicalTranscriberUserModelActionTypes.DELETE_MEDICAL_TRANSCRIBER_USER),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.MedicalTranscriberUserActionOK(
						modelAction.MedicalTranscriberUserModelActionTypes.DELETE_MEDICAL_TRANSCRIBER_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalTranscriberUserActionFail(
								modelAction.MedicalTranscriberUserModelActionTypes.DELETE_MEDICAL_TRANSCRIBER_USER_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalTranscriberUserAction>(modelAction.MedicalTranscriberUserModelActionTypes.DELETE_MEDICAL_TRANSCRIBER_USER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.MedicalTranscriberUserActionOK(
						modelAction.MedicalTranscriberUserModelActionTypes.DELETE_MEDICAL_TRANSCRIBER_USER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalTranscriberUserActionFail(
								modelAction.MedicalTranscriberUserModelActionTypes.DELETE_MEDICAL_TRANSCRIBER_USER_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalTranscriberUserAction>(modelAction.MedicalTranscriberUserModelActionTypes.DELETE_ALL_MEDICAL_TRANSCRIBER_USER),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.MedicalTranscriberUserActionOK(
						modelAction.MedicalTranscriberUserModelActionTypes.DELETE_ALL_MEDICAL_TRANSCRIBER_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalTranscriberUserActionFail(
								modelAction.MedicalTranscriberUserModelActionTypes.DELETE_ALL_MEDICAL_TRANSCRIBER_USER_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalTranscriberUserAction>(modelAction.MedicalTranscriberUserModelActionTypes.EXPORT_MEDICAL_TRANSCRIBER_USER),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicalTranscriberUserActionOK(
						modelAction.MedicalTranscriberUserModelActionTypes.EXPORT_MEDICAL_TRANSCRIBER_USER,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalTranscriberUserAction>(modelAction.MedicalTranscriberUserModelActionTypes.EXPORT_ALL_MEDICAL_TRANSCRIBER_USER),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicalTranscriberUserActionOK(
						modelAction.MedicalTranscriberUserModelActionTypes.EXPORT_ALL_MEDICAL_TRANSCRIBER_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalTranscriberUserActionFail(
								modelAction.MedicalTranscriberUserModelActionTypes.EXPORT_ALL_MEDICAL_TRANSCRIBER_USER_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalTranscriberUserAction>(modelAction.MedicalTranscriberUserModelActionTypes.EXPORT_MEDICAL_TRANSCRIBER_USER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicalTranscriberUserActionOK(
						modelAction.MedicalTranscriberUserModelActionTypes.EXPORT_MEDICAL_TRANSCRIBER_USER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalTranscriberUserActionFail(
								modelAction.MedicalTranscriberUserModelActionTypes.EXPORT_MEDICAL_TRANSCRIBER_USER_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalTranscriberUserAction>(modelAction.MedicalTranscriberUserModelActionTypes.IMPORT_MEDICAL_TRANSCRIBER_USERS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.MedicalTranscriberUserActionOK(
						modelAction.MedicalTranscriberUserModelActionTypes.IMPORT_MEDICAL_TRANSCRIBER_USERS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalTranscriberUserActionFail(
								modelAction.MedicalTranscriberUserModelActionTypes.IMPORT_MEDICAL_TRANSCRIBER_USERS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalTranscriberUserAction>(modelAction.MedicalTranscriberUserModelActionTypes.FETCH_MEDICAL_TRANSCRIBER_USER_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.MedicalTranscriberUserActionOK(
						modelAction.MedicalTranscriberUserModelActionTypes.FETCH_MEDICAL_TRANSCRIBER_USER_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.MedicalTranscriberUserActionFail(
								modelAction.MedicalTranscriberUserModelActionTypes.FETCH_MEDICAL_TRANSCRIBER_USER_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalTranscriberUserAction>(modelAction.MedicalTranscriberUserModelActionTypes.FETCH_MEDICAL_TRANSCRIBER_USER_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.MedicalTranscriberUserActionOK(
						modelAction.MedicalTranscriberUserModelActionTypes.FETCH_MEDICAL_TRANSCRIBER_USER_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.MedicalTranscriberUserActionFail(
								modelAction.MedicalTranscriberUserModelActionTypes.FETCH_MEDICAL_TRANSCRIBER_USER_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
