...
import * as modelAction from './reference_header.model.action';
import {ReferenceHeaderService} from '../../services/referenceHeader/reference_header.service';
...
/**
 * Effect class used for side effects related to Reference Header model.
 */
@Injectable()
export class ReferenceHeaderEffect {
	...
	constructor(
		...
		protected readonly service: ReferenceHeaderService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReferenceHeaderAction>(modelAction.ReferenceHeaderModelActionTypes.COUNT_REFERENCE_HEADERS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.ReferenceHeaderActionOK(
						modelAction.ReferenceHeaderModelActionTypes.COUNT_REFERENCE_HEADERS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReferenceHeaderActionFail(
								modelAction.ReferenceHeaderModelActionTypes.COUNT_REFERENCE_HEADERS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReferenceHeaderAction>(modelAction.ReferenceHeaderModelActionTypes.FETCH_REFERENCE_HEADER),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ReferenceHeaderActionOK(
						modelAction.ReferenceHeaderModelActionTypes.FETCH_REFERENCE_HEADER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReferenceHeaderActionFail(
								modelAction.ReferenceHeaderModelActionTypes.FETCH_REFERENCE_HEADER_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReferenceHeaderAction>(modelAction.ReferenceHeaderModelActionTypes.FETCH_ALL_REFERENCE_HEADER),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.ReferenceHeaderActionOK(
						modelAction.ReferenceHeaderModelActionTypes.FETCH_ALL_REFERENCE_HEADER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReferenceHeaderActionFail(
								modelAction.ReferenceHeaderModelActionTypes.FETCH_ALL_REFERENCE_HEADER_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReferenceHeaderAction>(modelAction.ReferenceHeaderModelActionTypes.FETCH_REFERENCE_HEADER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.ReferenceHeaderActionOK(
						modelAction.ReferenceHeaderModelActionTypes.FETCH_REFERENCE_HEADER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReferenceHeaderActionFail(
								modelAction.ReferenceHeaderModelActionTypes.FETCH_REFERENCE_HEADER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReferenceHeaderAction>(modelAction.ReferenceHeaderModelActionTypes.FETCH_LAST_REFERENCE_HEADER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.ReferenceHeaderActionOK(
						modelAction.ReferenceHeaderModelActionTypes.FETCH_LAST_REFERENCE_HEADER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReferenceHeaderActionFail(
								modelAction.ReferenceHeaderModelActionTypes.FETCH_LAST_REFERENCE_HEADER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReferenceHeaderAction>(modelAction.ReferenceHeaderModelActionTypes.CREATE_REFERENCE_HEADER),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as ReferenceHeaderModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ReferenceHeaderActionOK(
						modelAction.ReferenceHeaderModelActionTypes.CREATE_REFERENCE_HEADER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReferenceHeaderActionFail(
								modelAction.ReferenceHeaderModelActionTypes.CREATE_REFERENCE_HEADER_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReferenceHeaderAction>(modelAction.ReferenceHeaderModelActionTypes.CREATE_ALL_REFERENCE_HEADER),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as ReferenceHeaderModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ReferenceHeaderActionOK(
						modelAction.ReferenceHeaderModelActionTypes.CREATE_ALL_REFERENCE_HEADER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReferenceHeaderActionFail(
								modelAction.ReferenceHeaderModelActionTypes.CREATE_ALL_REFERENCE_HEADER_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReferenceHeaderAction>(modelAction.ReferenceHeaderModelActionTypes.UPDATE_REFERENCE_HEADER),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as ReferenceHeaderModel;
				...
				return this.service.update(new ReferenceHeaderModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.ReferenceHeaderActionOK(
						modelAction.ReferenceHeaderModelActionTypes.UPDATE_REFERENCE_HEADER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReferenceHeaderActionFail(
								modelAction.ReferenceHeaderModelActionTypes.UPDATE_REFERENCE_HEADER_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReferenceHeaderAction>(modelAction.ReferenceHeaderModelActionTypes.UPDATE_ALL_REFERENCE_HEADER),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as ReferenceHeaderModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new ReferenceHeaderModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ReferenceHeaderActionOK(
						modelAction.ReferenceHeaderModelActionTypes.UPDATE_ALL_REFERENCE_HEADER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReferenceHeaderActionFail(
								modelAction.ReferenceHeaderModelActionTypes.UPDATE_ALL_REFERENCE_HEADER_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReferenceHeaderAction>(modelAction.ReferenceHeaderModelActionTypes.DELETE_REFERENCE_HEADER),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.ReferenceHeaderActionOK(
						modelAction.ReferenceHeaderModelActionTypes.DELETE_REFERENCE_HEADER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReferenceHeaderActionFail(
								modelAction.ReferenceHeaderModelActionTypes.DELETE_REFERENCE_HEADER_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReferenceHeaderAction>(modelAction.ReferenceHeaderModelActionTypes.DELETE_REFERENCE_HEADER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.ReferenceHeaderActionOK(
						modelAction.ReferenceHeaderModelActionTypes.DELETE_REFERENCE_HEADER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReferenceHeaderActionFail(
								modelAction.ReferenceHeaderModelActionTypes.DELETE_REFERENCE_HEADER_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReferenceHeaderAction>(modelAction.ReferenceHeaderModelActionTypes.DELETE_ALL_REFERENCE_HEADER),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.ReferenceHeaderActionOK(
						modelAction.ReferenceHeaderModelActionTypes.DELETE_ALL_REFERENCE_HEADER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReferenceHeaderActionFail(
								modelAction.ReferenceHeaderModelActionTypes.DELETE_ALL_REFERENCE_HEADER_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReferenceHeaderAction>(modelAction.ReferenceHeaderModelActionTypes.EXPORT_REFERENCE_HEADER),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ReferenceHeaderActionOK(
						modelAction.ReferenceHeaderModelActionTypes.EXPORT_REFERENCE_HEADER,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReferenceHeaderAction>(modelAction.ReferenceHeaderModelActionTypes.EXPORT_ALL_REFERENCE_HEADER),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ReferenceHeaderActionOK(
						modelAction.ReferenceHeaderModelActionTypes.EXPORT_ALL_REFERENCE_HEADER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReferenceHeaderActionFail(
								modelAction.ReferenceHeaderModelActionTypes.EXPORT_ALL_REFERENCE_HEADER_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReferenceHeaderAction>(modelAction.ReferenceHeaderModelActionTypes.EXPORT_REFERENCE_HEADER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ReferenceHeaderActionOK(
						modelAction.ReferenceHeaderModelActionTypes.EXPORT_REFERENCE_HEADER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReferenceHeaderActionFail(
								modelAction.ReferenceHeaderModelActionTypes.EXPORT_REFERENCE_HEADER_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReferenceHeaderAction>(modelAction.ReferenceHeaderModelActionTypes.IMPORT_REFERENCE_HEADERS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.ReferenceHeaderActionOK(
						modelAction.ReferenceHeaderModelActionTypes.IMPORT_REFERENCE_HEADERS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReferenceHeaderActionFail(
								modelAction.ReferenceHeaderModelActionTypes.IMPORT_REFERENCE_HEADERS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReferenceHeaderAction>(modelAction.ReferenceHeaderModelActionTypes.FETCH_REFERENCE_HEADER_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.ReferenceHeaderActionOK(
						modelAction.ReferenceHeaderModelActionTypes.FETCH_REFERENCE_HEADER_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.ReferenceHeaderActionFail(
								modelAction.ReferenceHeaderModelActionTypes.FETCH_REFERENCE_HEADER_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReferenceHeaderAction>(modelAction.ReferenceHeaderModelActionTypes.FETCH_REFERENCE_HEADER_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.ReferenceHeaderActionOK(
						modelAction.ReferenceHeaderModelActionTypes.FETCH_REFERENCE_HEADER_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.ReferenceHeaderActionFail(
								modelAction.ReferenceHeaderModelActionTypes.FETCH_REFERENCE_HEADER_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
