...
/**
 * ReferenceHeaderCollectionState would store the state of a collection of ReferenceHeader
 */
export interface ReferenceHeaderCollectionState extends CollectionState {
 ...
 */
export interface ReferenceHeaderModelAudit extends AbstractModelAudit<ReferenceHeaderModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * ReferenceHeaderModelState would store the state of the model
 */
export interface ReferenceHeaderModelState {
	collectionState: {
		[key: string]: ReferenceHeaderCollectionState;
	};
	data: {
		[id: string]: ReferenceHeaderModel;
	};
	totalCount: number;
	audits: ReferenceHeaderModelAudit[];
 ...
 */
export const initialReferenceHeaderCollectionState: ReferenceHeaderCollectionState = {
...
/**
 * The initial state of ReferenceHeaderModelState
 */
export const initialState: ReferenceHeaderModelState = {
	collectionState: {
