...
/**
 * ReturnSupplierCollectionState would store the state of a collection of ReturnSupplier
 */
export interface ReturnSupplierCollectionState extends CollectionState {
 ...
 */
export interface ReturnSupplierModelAudit extends AbstractModelAudit<ReturnSupplierModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * ReturnSupplierModelState would store the state of the model
 */
export interface ReturnSupplierModelState {
	collectionState: {
		[key: string]: ReturnSupplierCollectionState;
	};
	data: {
		[id: string]: ReturnSupplierModel;
	};
	totalCount: number;
	audits: ReturnSupplierModelAudit[];
 ...
 */
export const initialReturnSupplierCollectionState: ReturnSupplierCollectionState = {
...
/**
 * The initial state of ReturnSupplierModelState
 */
export const initialState: ReturnSupplierModelState = {
	collectionState: {
