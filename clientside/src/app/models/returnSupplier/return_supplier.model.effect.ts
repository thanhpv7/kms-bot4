...
import * as modelAction from './return_supplier.model.action';
import {ReturnSupplierService} from '../../services/returnSupplier/return_supplier.service';
...
/**
 * Effect class used for side effects related to Return Supplier model.
 */
@Injectable()
export class ReturnSupplierEffect {
	...
	constructor(
		...
		protected readonly service: ReturnSupplierService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReturnSupplierAction>(modelAction.ReturnSupplierModelActionTypes.COUNT_RETURN_SUPPLIERS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.ReturnSupplierActionOK(
						modelAction.ReturnSupplierModelActionTypes.COUNT_RETURN_SUPPLIERS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReturnSupplierActionFail(
								modelAction.ReturnSupplierModelActionTypes.COUNT_RETURN_SUPPLIERS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReturnSupplierAction>(modelAction.ReturnSupplierModelActionTypes.FETCH_RETURN_SUPPLIER),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ReturnSupplierActionOK(
						modelAction.ReturnSupplierModelActionTypes.FETCH_RETURN_SUPPLIER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReturnSupplierActionFail(
								modelAction.ReturnSupplierModelActionTypes.FETCH_RETURN_SUPPLIER_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReturnSupplierAction>(modelAction.ReturnSupplierModelActionTypes.FETCH_ALL_RETURN_SUPPLIER),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.ReturnSupplierActionOK(
						modelAction.ReturnSupplierModelActionTypes.FETCH_ALL_RETURN_SUPPLIER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReturnSupplierActionFail(
								modelAction.ReturnSupplierModelActionTypes.FETCH_ALL_RETURN_SUPPLIER_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReturnSupplierAction>(modelAction.ReturnSupplierModelActionTypes.FETCH_RETURN_SUPPLIER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.ReturnSupplierActionOK(
						modelAction.ReturnSupplierModelActionTypes.FETCH_RETURN_SUPPLIER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReturnSupplierActionFail(
								modelAction.ReturnSupplierModelActionTypes.FETCH_RETURN_SUPPLIER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReturnSupplierAction>(modelAction.ReturnSupplierModelActionTypes.FETCH_LAST_RETURN_SUPPLIER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.ReturnSupplierActionOK(
						modelAction.ReturnSupplierModelActionTypes.FETCH_LAST_RETURN_SUPPLIER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReturnSupplierActionFail(
								modelAction.ReturnSupplierModelActionTypes.FETCH_LAST_RETURN_SUPPLIER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReturnSupplierAction>(modelAction.ReturnSupplierModelActionTypes.CREATE_RETURN_SUPPLIER),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as ReturnSupplierModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ReturnSupplierActionOK(
						modelAction.ReturnSupplierModelActionTypes.CREATE_RETURN_SUPPLIER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReturnSupplierActionFail(
								modelAction.ReturnSupplierModelActionTypes.CREATE_RETURN_SUPPLIER_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReturnSupplierAction>(modelAction.ReturnSupplierModelActionTypes.CREATE_ALL_RETURN_SUPPLIER),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as ReturnSupplierModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ReturnSupplierActionOK(
						modelAction.ReturnSupplierModelActionTypes.CREATE_ALL_RETURN_SUPPLIER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReturnSupplierActionFail(
								modelAction.ReturnSupplierModelActionTypes.CREATE_ALL_RETURN_SUPPLIER_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReturnSupplierAction>(modelAction.ReturnSupplierModelActionTypes.UPDATE_RETURN_SUPPLIER),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as ReturnSupplierModel;
				...
				return this.service.update(new ReturnSupplierModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.ReturnSupplierActionOK(
						modelAction.ReturnSupplierModelActionTypes.UPDATE_RETURN_SUPPLIER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReturnSupplierActionFail(
								modelAction.ReturnSupplierModelActionTypes.UPDATE_RETURN_SUPPLIER_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReturnSupplierAction>(modelAction.ReturnSupplierModelActionTypes.UPDATE_ALL_RETURN_SUPPLIER),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as ReturnSupplierModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new ReturnSupplierModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ReturnSupplierActionOK(
						modelAction.ReturnSupplierModelActionTypes.UPDATE_ALL_RETURN_SUPPLIER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReturnSupplierActionFail(
								modelAction.ReturnSupplierModelActionTypes.UPDATE_ALL_RETURN_SUPPLIER_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReturnSupplierAction>(modelAction.ReturnSupplierModelActionTypes.DELETE_RETURN_SUPPLIER),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.ReturnSupplierActionOK(
						modelAction.ReturnSupplierModelActionTypes.DELETE_RETURN_SUPPLIER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReturnSupplierActionFail(
								modelAction.ReturnSupplierModelActionTypes.DELETE_RETURN_SUPPLIER_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReturnSupplierAction>(modelAction.ReturnSupplierModelActionTypes.DELETE_RETURN_SUPPLIER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.ReturnSupplierActionOK(
						modelAction.ReturnSupplierModelActionTypes.DELETE_RETURN_SUPPLIER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReturnSupplierActionFail(
								modelAction.ReturnSupplierModelActionTypes.DELETE_RETURN_SUPPLIER_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReturnSupplierAction>(modelAction.ReturnSupplierModelActionTypes.DELETE_ALL_RETURN_SUPPLIER),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.ReturnSupplierActionOK(
						modelAction.ReturnSupplierModelActionTypes.DELETE_ALL_RETURN_SUPPLIER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReturnSupplierActionFail(
								modelAction.ReturnSupplierModelActionTypes.DELETE_ALL_RETURN_SUPPLIER_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReturnSupplierAction>(modelAction.ReturnSupplierModelActionTypes.EXPORT_RETURN_SUPPLIER),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ReturnSupplierActionOK(
						modelAction.ReturnSupplierModelActionTypes.EXPORT_RETURN_SUPPLIER,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReturnSupplierAction>(modelAction.ReturnSupplierModelActionTypes.EXPORT_ALL_RETURN_SUPPLIER),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ReturnSupplierActionOK(
						modelAction.ReturnSupplierModelActionTypes.EXPORT_ALL_RETURN_SUPPLIER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReturnSupplierActionFail(
								modelAction.ReturnSupplierModelActionTypes.EXPORT_ALL_RETURN_SUPPLIER_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReturnSupplierAction>(modelAction.ReturnSupplierModelActionTypes.EXPORT_RETURN_SUPPLIER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ReturnSupplierActionOK(
						modelAction.ReturnSupplierModelActionTypes.EXPORT_RETURN_SUPPLIER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReturnSupplierActionFail(
								modelAction.ReturnSupplierModelActionTypes.EXPORT_RETURN_SUPPLIER_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReturnSupplierAction>(modelAction.ReturnSupplierModelActionTypes.IMPORT_RETURN_SUPPLIERS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.ReturnSupplierActionOK(
						modelAction.ReturnSupplierModelActionTypes.IMPORT_RETURN_SUPPLIERS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ReturnSupplierActionFail(
								modelAction.ReturnSupplierModelActionTypes.IMPORT_RETURN_SUPPLIERS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReturnSupplierAction>(modelAction.ReturnSupplierModelActionTypes.FETCH_RETURN_SUPPLIER_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.ReturnSupplierActionOK(
						modelAction.ReturnSupplierModelActionTypes.FETCH_RETURN_SUPPLIER_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.ReturnSupplierActionFail(
								modelAction.ReturnSupplierModelActionTypes.FETCH_RETURN_SUPPLIER_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ReturnSupplierAction>(modelAction.ReturnSupplierModelActionTypes.FETCH_RETURN_SUPPLIER_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.ReturnSupplierActionOK(
						modelAction.ReturnSupplierModelActionTypes.FETCH_RETURN_SUPPLIER_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.ReturnSupplierActionFail(
								modelAction.ReturnSupplierModelActionTypes.FETCH_RETURN_SUPPLIER_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
