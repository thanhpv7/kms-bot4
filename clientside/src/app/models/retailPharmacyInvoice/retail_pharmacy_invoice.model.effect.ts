...
import * as modelAction from './retail_pharmacy_invoice.model.action';
import {RetailPharmacyInvoiceService} from '../../services/retailPharmacyInvoice/retail_pharmacy_invoice.service';
...
/**
 * Effect class used for side effects related to Retail Pharmacy Invoice model.
 */
@Injectable()
export class RetailPharmacyInvoiceEffect {
	...
	constructor(
		...
		protected readonly service: RetailPharmacyInvoiceService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RetailPharmacyInvoiceAction>(modelAction.RetailPharmacyInvoiceModelActionTypes.COUNT_RETAIL_PHARMACY_INVOICES),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.RetailPharmacyInvoiceActionOK(
						modelAction.RetailPharmacyInvoiceModelActionTypes.COUNT_RETAIL_PHARMACY_INVOICES_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RetailPharmacyInvoiceActionFail(
								modelAction.RetailPharmacyInvoiceModelActionTypes.COUNT_RETAIL_PHARMACY_INVOICES_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RetailPharmacyInvoiceAction>(modelAction.RetailPharmacyInvoiceModelActionTypes.FETCH_RETAIL_PHARMACY_INVOICE),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.RetailPharmacyInvoiceActionOK(
						modelAction.RetailPharmacyInvoiceModelActionTypes.FETCH_RETAIL_PHARMACY_INVOICE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RetailPharmacyInvoiceActionFail(
								modelAction.RetailPharmacyInvoiceModelActionTypes.FETCH_RETAIL_PHARMACY_INVOICE_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RetailPharmacyInvoiceAction>(modelAction.RetailPharmacyInvoiceModelActionTypes.FETCH_ALL_RETAIL_PHARMACY_INVOICE),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.RetailPharmacyInvoiceActionOK(
						modelAction.RetailPharmacyInvoiceModelActionTypes.FETCH_ALL_RETAIL_PHARMACY_INVOICE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RetailPharmacyInvoiceActionFail(
								modelAction.RetailPharmacyInvoiceModelActionTypes.FETCH_ALL_RETAIL_PHARMACY_INVOICE_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RetailPharmacyInvoiceAction>(modelAction.RetailPharmacyInvoiceModelActionTypes.FETCH_RETAIL_PHARMACY_INVOICE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.RetailPharmacyInvoiceActionOK(
						modelAction.RetailPharmacyInvoiceModelActionTypes.FETCH_RETAIL_PHARMACY_INVOICE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RetailPharmacyInvoiceActionFail(
								modelAction.RetailPharmacyInvoiceModelActionTypes.FETCH_RETAIL_PHARMACY_INVOICE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RetailPharmacyInvoiceAction>(modelAction.RetailPharmacyInvoiceModelActionTypes.FETCH_LAST_RETAIL_PHARMACY_INVOICE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.RetailPharmacyInvoiceActionOK(
						modelAction.RetailPharmacyInvoiceModelActionTypes.FETCH_LAST_RETAIL_PHARMACY_INVOICE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RetailPharmacyInvoiceActionFail(
								modelAction.RetailPharmacyInvoiceModelActionTypes.FETCH_LAST_RETAIL_PHARMACY_INVOICE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RetailPharmacyInvoiceAction>(modelAction.RetailPharmacyInvoiceModelActionTypes.CREATE_RETAIL_PHARMACY_INVOICE),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as RetailPharmacyInvoiceModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.RetailPharmacyInvoiceActionOK(
						modelAction.RetailPharmacyInvoiceModelActionTypes.CREATE_RETAIL_PHARMACY_INVOICE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RetailPharmacyInvoiceActionFail(
								modelAction.RetailPharmacyInvoiceModelActionTypes.CREATE_RETAIL_PHARMACY_INVOICE_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RetailPharmacyInvoiceAction>(modelAction.RetailPharmacyInvoiceModelActionTypes.CREATE_ALL_RETAIL_PHARMACY_INVOICE),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as RetailPharmacyInvoiceModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.RetailPharmacyInvoiceActionOK(
						modelAction.RetailPharmacyInvoiceModelActionTypes.CREATE_ALL_RETAIL_PHARMACY_INVOICE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RetailPharmacyInvoiceActionFail(
								modelAction.RetailPharmacyInvoiceModelActionTypes.CREATE_ALL_RETAIL_PHARMACY_INVOICE_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RetailPharmacyInvoiceAction>(modelAction.RetailPharmacyInvoiceModelActionTypes.UPDATE_RETAIL_PHARMACY_INVOICE),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as RetailPharmacyInvoiceModel;
				...
				return this.service.update(new RetailPharmacyInvoiceModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.RetailPharmacyInvoiceActionOK(
						modelAction.RetailPharmacyInvoiceModelActionTypes.UPDATE_RETAIL_PHARMACY_INVOICE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RetailPharmacyInvoiceActionFail(
								modelAction.RetailPharmacyInvoiceModelActionTypes.UPDATE_RETAIL_PHARMACY_INVOICE_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RetailPharmacyInvoiceAction>(modelAction.RetailPharmacyInvoiceModelActionTypes.UPDATE_ALL_RETAIL_PHARMACY_INVOICE),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as RetailPharmacyInvoiceModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new RetailPharmacyInvoiceModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.RetailPharmacyInvoiceActionOK(
						modelAction.RetailPharmacyInvoiceModelActionTypes.UPDATE_ALL_RETAIL_PHARMACY_INVOICE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RetailPharmacyInvoiceActionFail(
								modelAction.RetailPharmacyInvoiceModelActionTypes.UPDATE_ALL_RETAIL_PHARMACY_INVOICE_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RetailPharmacyInvoiceAction>(modelAction.RetailPharmacyInvoiceModelActionTypes.DELETE_RETAIL_PHARMACY_INVOICE),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.RetailPharmacyInvoiceActionOK(
						modelAction.RetailPharmacyInvoiceModelActionTypes.DELETE_RETAIL_PHARMACY_INVOICE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RetailPharmacyInvoiceActionFail(
								modelAction.RetailPharmacyInvoiceModelActionTypes.DELETE_RETAIL_PHARMACY_INVOICE_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RetailPharmacyInvoiceAction>(modelAction.RetailPharmacyInvoiceModelActionTypes.DELETE_RETAIL_PHARMACY_INVOICE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.RetailPharmacyInvoiceActionOK(
						modelAction.RetailPharmacyInvoiceModelActionTypes.DELETE_RETAIL_PHARMACY_INVOICE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RetailPharmacyInvoiceActionFail(
								modelAction.RetailPharmacyInvoiceModelActionTypes.DELETE_RETAIL_PHARMACY_INVOICE_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RetailPharmacyInvoiceAction>(modelAction.RetailPharmacyInvoiceModelActionTypes.DELETE_ALL_RETAIL_PHARMACY_INVOICE),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.RetailPharmacyInvoiceActionOK(
						modelAction.RetailPharmacyInvoiceModelActionTypes.DELETE_ALL_RETAIL_PHARMACY_INVOICE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RetailPharmacyInvoiceActionFail(
								modelAction.RetailPharmacyInvoiceModelActionTypes.DELETE_ALL_RETAIL_PHARMACY_INVOICE_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RetailPharmacyInvoiceAction>(modelAction.RetailPharmacyInvoiceModelActionTypes.EXPORT_RETAIL_PHARMACY_INVOICE),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.RetailPharmacyInvoiceActionOK(
						modelAction.RetailPharmacyInvoiceModelActionTypes.EXPORT_RETAIL_PHARMACY_INVOICE,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RetailPharmacyInvoiceAction>(modelAction.RetailPharmacyInvoiceModelActionTypes.EXPORT_ALL_RETAIL_PHARMACY_INVOICE),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.RetailPharmacyInvoiceActionOK(
						modelAction.RetailPharmacyInvoiceModelActionTypes.EXPORT_ALL_RETAIL_PHARMACY_INVOICE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RetailPharmacyInvoiceActionFail(
								modelAction.RetailPharmacyInvoiceModelActionTypes.EXPORT_ALL_RETAIL_PHARMACY_INVOICE_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RetailPharmacyInvoiceAction>(modelAction.RetailPharmacyInvoiceModelActionTypes.EXPORT_RETAIL_PHARMACY_INVOICE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.RetailPharmacyInvoiceActionOK(
						modelAction.RetailPharmacyInvoiceModelActionTypes.EXPORT_RETAIL_PHARMACY_INVOICE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RetailPharmacyInvoiceActionFail(
								modelAction.RetailPharmacyInvoiceModelActionTypes.EXPORT_RETAIL_PHARMACY_INVOICE_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RetailPharmacyInvoiceAction>(modelAction.RetailPharmacyInvoiceModelActionTypes.IMPORT_RETAIL_PHARMACY_INVOICES),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.RetailPharmacyInvoiceActionOK(
						modelAction.RetailPharmacyInvoiceModelActionTypes.IMPORT_RETAIL_PHARMACY_INVOICES_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RetailPharmacyInvoiceActionFail(
								modelAction.RetailPharmacyInvoiceModelActionTypes.IMPORT_RETAIL_PHARMACY_INVOICES_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RetailPharmacyInvoiceAction>(modelAction.RetailPharmacyInvoiceModelActionTypes.FETCH_RETAIL_PHARMACY_INVOICE_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.RetailPharmacyInvoiceActionOK(
						modelAction.RetailPharmacyInvoiceModelActionTypes.FETCH_RETAIL_PHARMACY_INVOICE_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.RetailPharmacyInvoiceActionFail(
								modelAction.RetailPharmacyInvoiceModelActionTypes.FETCH_RETAIL_PHARMACY_INVOICE_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RetailPharmacyInvoiceAction>(modelAction.RetailPharmacyInvoiceModelActionTypes.FETCH_RETAIL_PHARMACY_INVOICE_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.RetailPharmacyInvoiceActionOK(
						modelAction.RetailPharmacyInvoiceModelActionTypes.FETCH_RETAIL_PHARMACY_INVOICE_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.RetailPharmacyInvoiceActionFail(
								modelAction.RetailPharmacyInvoiceModelActionTypes.FETCH_RETAIL_PHARMACY_INVOICE_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
