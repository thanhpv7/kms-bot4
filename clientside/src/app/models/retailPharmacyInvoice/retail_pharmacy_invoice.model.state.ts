...
/**
 * RetailPharmacyInvoiceCollectionState would store the state of a collection of RetailPharmacyInvoice
 */
export interface RetailPharmacyInvoiceCollectionState extends CollectionState {
 ...
 */
export interface RetailPharmacyInvoiceModelAudit extends AbstractModelAudit<RetailPharmacyInvoiceModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * RetailPharmacyInvoiceModelState would store the state of the model
 */
export interface RetailPharmacyInvoiceModelState {
	collectionState: {
		[key: string]: RetailPharmacyInvoiceCollectionState;
	};
	data: {
		[id: string]: RetailPharmacyInvoiceModel;
	};
	totalCount: number;
	audits: RetailPharmacyInvoiceModelAudit[];
 ...
 */
export const initialRetailPharmacyInvoiceCollectionState: RetailPharmacyInvoiceCollectionState = {
...
/**
 * The initial state of RetailPharmacyInvoiceModelState
 */
export const initialState: RetailPharmacyInvoiceModelState = {
	collectionState: {
