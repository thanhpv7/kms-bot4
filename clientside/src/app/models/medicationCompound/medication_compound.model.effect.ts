...
import * as modelAction from './medication_compound.model.action';
import {MedicationCompoundService} from '../../services/medicationCompound/medication_compound.service';
...
/**
 * Effect class used for side effects related to Medication Compound model.
 */
@Injectable()
export class MedicationCompoundEffect {
	...
	constructor(
		...
		protected readonly service: MedicationCompoundService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationCompoundAction>(modelAction.MedicationCompoundModelActionTypes.COUNT_MEDICATION_COMPOUNDS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.MedicationCompoundActionOK(
						modelAction.MedicationCompoundModelActionTypes.COUNT_MEDICATION_COMPOUNDS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationCompoundActionFail(
								modelAction.MedicationCompoundModelActionTypes.COUNT_MEDICATION_COMPOUNDS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationCompoundAction>(modelAction.MedicationCompoundModelActionTypes.FETCH_MEDICATION_COMPOUND),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicationCompoundActionOK(
						modelAction.MedicationCompoundModelActionTypes.FETCH_MEDICATION_COMPOUND_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationCompoundActionFail(
								modelAction.MedicationCompoundModelActionTypes.FETCH_MEDICATION_COMPOUND_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationCompoundAction>(modelAction.MedicationCompoundModelActionTypes.FETCH_ALL_MEDICATION_COMPOUND),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.MedicationCompoundActionOK(
						modelAction.MedicationCompoundModelActionTypes.FETCH_ALL_MEDICATION_COMPOUND_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationCompoundActionFail(
								modelAction.MedicationCompoundModelActionTypes.FETCH_ALL_MEDICATION_COMPOUND_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationCompoundAction>(modelAction.MedicationCompoundModelActionTypes.FETCH_MEDICATION_COMPOUND_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicationCompoundActionOK(
						modelAction.MedicationCompoundModelActionTypes.FETCH_MEDICATION_COMPOUND_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationCompoundActionFail(
								modelAction.MedicationCompoundModelActionTypes.FETCH_MEDICATION_COMPOUND_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationCompoundAction>(modelAction.MedicationCompoundModelActionTypes.FETCH_LAST_MEDICATION_COMPOUND_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicationCompoundActionOK(
						modelAction.MedicationCompoundModelActionTypes.FETCH_LAST_MEDICATION_COMPOUND_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationCompoundActionFail(
								modelAction.MedicationCompoundModelActionTypes.FETCH_LAST_MEDICATION_COMPOUND_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationCompoundAction>(modelAction.MedicationCompoundModelActionTypes.CREATE_MEDICATION_COMPOUND),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as MedicationCompoundModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicationCompoundActionOK(
						modelAction.MedicationCompoundModelActionTypes.CREATE_MEDICATION_COMPOUND_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationCompoundActionFail(
								modelAction.MedicationCompoundModelActionTypes.CREATE_MEDICATION_COMPOUND_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationCompoundAction>(modelAction.MedicationCompoundModelActionTypes.CREATE_ALL_MEDICATION_COMPOUND),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as MedicationCompoundModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicationCompoundActionOK(
						modelAction.MedicationCompoundModelActionTypes.CREATE_ALL_MEDICATION_COMPOUND_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationCompoundActionFail(
								modelAction.MedicationCompoundModelActionTypes.CREATE_ALL_MEDICATION_COMPOUND_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationCompoundAction>(modelAction.MedicationCompoundModelActionTypes.UPDATE_MEDICATION_COMPOUND),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as MedicationCompoundModel;
				...
				return this.service.update(new MedicationCompoundModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicationCompoundActionOK(
						modelAction.MedicationCompoundModelActionTypes.UPDATE_MEDICATION_COMPOUND_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationCompoundActionFail(
								modelAction.MedicationCompoundModelActionTypes.UPDATE_MEDICATION_COMPOUND_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationCompoundAction>(modelAction.MedicationCompoundModelActionTypes.UPDATE_ALL_MEDICATION_COMPOUND),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as MedicationCompoundModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new MedicationCompoundModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicationCompoundActionOK(
						modelAction.MedicationCompoundModelActionTypes.UPDATE_ALL_MEDICATION_COMPOUND_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationCompoundActionFail(
								modelAction.MedicationCompoundModelActionTypes.UPDATE_ALL_MEDICATION_COMPOUND_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationCompoundAction>(modelAction.MedicationCompoundModelActionTypes.DELETE_MEDICATION_COMPOUND),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.MedicationCompoundActionOK(
						modelAction.MedicationCompoundModelActionTypes.DELETE_MEDICATION_COMPOUND_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationCompoundActionFail(
								modelAction.MedicationCompoundModelActionTypes.DELETE_MEDICATION_COMPOUND_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationCompoundAction>(modelAction.MedicationCompoundModelActionTypes.DELETE_MEDICATION_COMPOUND_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.MedicationCompoundActionOK(
						modelAction.MedicationCompoundModelActionTypes.DELETE_MEDICATION_COMPOUND_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationCompoundActionFail(
								modelAction.MedicationCompoundModelActionTypes.DELETE_MEDICATION_COMPOUND_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationCompoundAction>(modelAction.MedicationCompoundModelActionTypes.DELETE_ALL_MEDICATION_COMPOUND),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.MedicationCompoundActionOK(
						modelAction.MedicationCompoundModelActionTypes.DELETE_ALL_MEDICATION_COMPOUND_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationCompoundActionFail(
								modelAction.MedicationCompoundModelActionTypes.DELETE_ALL_MEDICATION_COMPOUND_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationCompoundAction>(modelAction.MedicationCompoundModelActionTypes.EXPORT_MEDICATION_COMPOUND),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicationCompoundActionOK(
						modelAction.MedicationCompoundModelActionTypes.EXPORT_MEDICATION_COMPOUND,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationCompoundAction>(modelAction.MedicationCompoundModelActionTypes.EXPORT_ALL_MEDICATION_COMPOUND),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicationCompoundActionOK(
						modelAction.MedicationCompoundModelActionTypes.EXPORT_ALL_MEDICATION_COMPOUND_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationCompoundActionFail(
								modelAction.MedicationCompoundModelActionTypes.EXPORT_ALL_MEDICATION_COMPOUND_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationCompoundAction>(modelAction.MedicationCompoundModelActionTypes.EXPORT_MEDICATION_COMPOUND_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicationCompoundActionOK(
						modelAction.MedicationCompoundModelActionTypes.EXPORT_MEDICATION_COMPOUND_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationCompoundActionFail(
								modelAction.MedicationCompoundModelActionTypes.EXPORT_MEDICATION_COMPOUND_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationCompoundAction>(modelAction.MedicationCompoundModelActionTypes.IMPORT_MEDICATION_COMPOUNDS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.MedicationCompoundActionOK(
						modelAction.MedicationCompoundModelActionTypes.IMPORT_MEDICATION_COMPOUNDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicationCompoundActionFail(
								modelAction.MedicationCompoundModelActionTypes.IMPORT_MEDICATION_COMPOUNDS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationCompoundAction>(modelAction.MedicationCompoundModelActionTypes.FETCH_MEDICATION_COMPOUND_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.MedicationCompoundActionOK(
						modelAction.MedicationCompoundModelActionTypes.FETCH_MEDICATION_COMPOUND_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.MedicationCompoundActionFail(
								modelAction.MedicationCompoundModelActionTypes.FETCH_MEDICATION_COMPOUND_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicationCompoundAction>(modelAction.MedicationCompoundModelActionTypes.FETCH_MEDICATION_COMPOUND_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.MedicationCompoundActionOK(
						modelAction.MedicationCompoundModelActionTypes.FETCH_MEDICATION_COMPOUND_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.MedicationCompoundActionFail(
								modelAction.MedicationCompoundModelActionTypes.FETCH_MEDICATION_COMPOUND_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
