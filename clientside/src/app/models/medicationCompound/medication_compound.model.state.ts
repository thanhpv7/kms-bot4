...
/**
 * MedicationCompoundCollectionState would store the state of a collection of MedicationCompound
 */
export interface MedicationCompoundCollectionState extends CollectionState {
 ...
 */
export interface MedicationCompoundModelAudit extends AbstractModelAudit<MedicationCompoundModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * MedicationCompoundModelState would store the state of the model
 */
export interface MedicationCompoundModelState {
	collectionState: {
		[key: string]: MedicationCompoundCollectionState;
	};
	data: {
		[id: string]: MedicationCompoundModel;
	};
	totalCount: number;
	audits: MedicationCompoundModelAudit[];
 ...
 */
export const initialMedicationCompoundCollectionState: MedicationCompoundCollectionState = {
...
/**
 * The initial state of MedicationCompoundModelState
 */
export const initialState: MedicationCompoundModelState = {
	collectionState: {
