...
import * as modelAction from './transaction_detail_type_mapping.model.action';
import {TransactionDetailTypeMappingService} from '../../services/transactionDetailTypeMapping/transaction_detail_type_mapping.service';
...
/**
 * Effect class used for side effects related to Transaction Detail Type Mapping model.
 */
@Injectable()
export class TransactionDetailTypeMappingEffect {
	...
	constructor(
		...
		protected readonly service: TransactionDetailTypeMappingService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransactionDetailTypeMappingAction>(modelAction.TransactionDetailTypeMappingModelActionTypes.COUNT_TRANSACTION_DETAIL_TYPE_MAPPINGS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.TransactionDetailTypeMappingActionOK(
						modelAction.TransactionDetailTypeMappingModelActionTypes.COUNT_TRANSACTION_DETAIL_TYPE_MAPPINGS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TransactionDetailTypeMappingActionFail(
								modelAction.TransactionDetailTypeMappingModelActionTypes.COUNT_TRANSACTION_DETAIL_TYPE_MAPPINGS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransactionDetailTypeMappingAction>(modelAction.TransactionDetailTypeMappingModelActionTypes.FETCH_TRANSACTION_DETAIL_TYPE_MAPPING),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.TransactionDetailTypeMappingActionOK(
						modelAction.TransactionDetailTypeMappingModelActionTypes.FETCH_TRANSACTION_DETAIL_TYPE_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TransactionDetailTypeMappingActionFail(
								modelAction.TransactionDetailTypeMappingModelActionTypes.FETCH_TRANSACTION_DETAIL_TYPE_MAPPING_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransactionDetailTypeMappingAction>(modelAction.TransactionDetailTypeMappingModelActionTypes.FETCH_ALL_TRANSACTION_DETAIL_TYPE_MAPPING),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.TransactionDetailTypeMappingActionOK(
						modelAction.TransactionDetailTypeMappingModelActionTypes.FETCH_ALL_TRANSACTION_DETAIL_TYPE_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TransactionDetailTypeMappingActionFail(
								modelAction.TransactionDetailTypeMappingModelActionTypes.FETCH_ALL_TRANSACTION_DETAIL_TYPE_MAPPING_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransactionDetailTypeMappingAction>(modelAction.TransactionDetailTypeMappingModelActionTypes.FETCH_TRANSACTION_DETAIL_TYPE_MAPPING_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.TransactionDetailTypeMappingActionOK(
						modelAction.TransactionDetailTypeMappingModelActionTypes.FETCH_TRANSACTION_DETAIL_TYPE_MAPPING_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TransactionDetailTypeMappingActionFail(
								modelAction.TransactionDetailTypeMappingModelActionTypes.FETCH_TRANSACTION_DETAIL_TYPE_MAPPING_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransactionDetailTypeMappingAction>(modelAction.TransactionDetailTypeMappingModelActionTypes.FETCH_LAST_TRANSACTION_DETAIL_TYPE_MAPPING_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.TransactionDetailTypeMappingActionOK(
						modelAction.TransactionDetailTypeMappingModelActionTypes.FETCH_LAST_TRANSACTION_DETAIL_TYPE_MAPPING_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TransactionDetailTypeMappingActionFail(
								modelAction.TransactionDetailTypeMappingModelActionTypes.FETCH_LAST_TRANSACTION_DETAIL_TYPE_MAPPING_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransactionDetailTypeMappingAction>(modelAction.TransactionDetailTypeMappingModelActionTypes.CREATE_TRANSACTION_DETAIL_TYPE_MAPPING),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as TransactionDetailTypeMappingModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.TransactionDetailTypeMappingActionOK(
						modelAction.TransactionDetailTypeMappingModelActionTypes.CREATE_TRANSACTION_DETAIL_TYPE_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TransactionDetailTypeMappingActionFail(
								modelAction.TransactionDetailTypeMappingModelActionTypes.CREATE_TRANSACTION_DETAIL_TYPE_MAPPING_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransactionDetailTypeMappingAction>(modelAction.TransactionDetailTypeMappingModelActionTypes.CREATE_ALL_TRANSACTION_DETAIL_TYPE_MAPPING),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as TransactionDetailTypeMappingModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.TransactionDetailTypeMappingActionOK(
						modelAction.TransactionDetailTypeMappingModelActionTypes.CREATE_ALL_TRANSACTION_DETAIL_TYPE_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TransactionDetailTypeMappingActionFail(
								modelAction.TransactionDetailTypeMappingModelActionTypes.CREATE_ALL_TRANSACTION_DETAIL_TYPE_MAPPING_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransactionDetailTypeMappingAction>(modelAction.TransactionDetailTypeMappingModelActionTypes.UPDATE_TRANSACTION_DETAIL_TYPE_MAPPING),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as TransactionDetailTypeMappingModel;
				...
				return this.service.update(new TransactionDetailTypeMappingModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.TransactionDetailTypeMappingActionOK(
						modelAction.TransactionDetailTypeMappingModelActionTypes.UPDATE_TRANSACTION_DETAIL_TYPE_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TransactionDetailTypeMappingActionFail(
								modelAction.TransactionDetailTypeMappingModelActionTypes.UPDATE_TRANSACTION_DETAIL_TYPE_MAPPING_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransactionDetailTypeMappingAction>(modelAction.TransactionDetailTypeMappingModelActionTypes.UPDATE_ALL_TRANSACTION_DETAIL_TYPE_MAPPING),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as TransactionDetailTypeMappingModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new TransactionDetailTypeMappingModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.TransactionDetailTypeMappingActionOK(
						modelAction.TransactionDetailTypeMappingModelActionTypes.UPDATE_ALL_TRANSACTION_DETAIL_TYPE_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TransactionDetailTypeMappingActionFail(
								modelAction.TransactionDetailTypeMappingModelActionTypes.UPDATE_ALL_TRANSACTION_DETAIL_TYPE_MAPPING_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransactionDetailTypeMappingAction>(modelAction.TransactionDetailTypeMappingModelActionTypes.DELETE_TRANSACTION_DETAIL_TYPE_MAPPING),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.TransactionDetailTypeMappingActionOK(
						modelAction.TransactionDetailTypeMappingModelActionTypes.DELETE_TRANSACTION_DETAIL_TYPE_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TransactionDetailTypeMappingActionFail(
								modelAction.TransactionDetailTypeMappingModelActionTypes.DELETE_TRANSACTION_DETAIL_TYPE_MAPPING_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransactionDetailTypeMappingAction>(modelAction.TransactionDetailTypeMappingModelActionTypes.DELETE_TRANSACTION_DETAIL_TYPE_MAPPING_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.TransactionDetailTypeMappingActionOK(
						modelAction.TransactionDetailTypeMappingModelActionTypes.DELETE_TRANSACTION_DETAIL_TYPE_MAPPING_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TransactionDetailTypeMappingActionFail(
								modelAction.TransactionDetailTypeMappingModelActionTypes.DELETE_TRANSACTION_DETAIL_TYPE_MAPPING_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransactionDetailTypeMappingAction>(modelAction.TransactionDetailTypeMappingModelActionTypes.DELETE_ALL_TRANSACTION_DETAIL_TYPE_MAPPING),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.TransactionDetailTypeMappingActionOK(
						modelAction.TransactionDetailTypeMappingModelActionTypes.DELETE_ALL_TRANSACTION_DETAIL_TYPE_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TransactionDetailTypeMappingActionFail(
								modelAction.TransactionDetailTypeMappingModelActionTypes.DELETE_ALL_TRANSACTION_DETAIL_TYPE_MAPPING_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransactionDetailTypeMappingAction>(modelAction.TransactionDetailTypeMappingModelActionTypes.EXPORT_TRANSACTION_DETAIL_TYPE_MAPPING),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.TransactionDetailTypeMappingActionOK(
						modelAction.TransactionDetailTypeMappingModelActionTypes.EXPORT_TRANSACTION_DETAIL_TYPE_MAPPING,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransactionDetailTypeMappingAction>(modelAction.TransactionDetailTypeMappingModelActionTypes.EXPORT_ALL_TRANSACTION_DETAIL_TYPE_MAPPING),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.TransactionDetailTypeMappingActionOK(
						modelAction.TransactionDetailTypeMappingModelActionTypes.EXPORT_ALL_TRANSACTION_DETAIL_TYPE_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TransactionDetailTypeMappingActionFail(
								modelAction.TransactionDetailTypeMappingModelActionTypes.EXPORT_ALL_TRANSACTION_DETAIL_TYPE_MAPPING_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransactionDetailTypeMappingAction>(modelAction.TransactionDetailTypeMappingModelActionTypes.EXPORT_TRANSACTION_DETAIL_TYPE_MAPPING_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.TransactionDetailTypeMappingActionOK(
						modelAction.TransactionDetailTypeMappingModelActionTypes.EXPORT_TRANSACTION_DETAIL_TYPE_MAPPING_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TransactionDetailTypeMappingActionFail(
								modelAction.TransactionDetailTypeMappingModelActionTypes.EXPORT_TRANSACTION_DETAIL_TYPE_MAPPING_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransactionDetailTypeMappingAction>(modelAction.TransactionDetailTypeMappingModelActionTypes.IMPORT_TRANSACTION_DETAIL_TYPE_MAPPINGS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.TransactionDetailTypeMappingActionOK(
						modelAction.TransactionDetailTypeMappingModelActionTypes.IMPORT_TRANSACTION_DETAIL_TYPE_MAPPINGS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TransactionDetailTypeMappingActionFail(
								modelAction.TransactionDetailTypeMappingModelActionTypes.IMPORT_TRANSACTION_DETAIL_TYPE_MAPPINGS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransactionDetailTypeMappingAction>(modelAction.TransactionDetailTypeMappingModelActionTypes.FETCH_TRANSACTION_DETAIL_TYPE_MAPPING_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.TransactionDetailTypeMappingActionOK(
						modelAction.TransactionDetailTypeMappingModelActionTypes.FETCH_TRANSACTION_DETAIL_TYPE_MAPPING_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.TransactionDetailTypeMappingActionFail(
								modelAction.TransactionDetailTypeMappingModelActionTypes.FETCH_TRANSACTION_DETAIL_TYPE_MAPPING_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TransactionDetailTypeMappingAction>(modelAction.TransactionDetailTypeMappingModelActionTypes.FETCH_TRANSACTION_DETAIL_TYPE_MAPPING_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.TransactionDetailTypeMappingActionOK(
						modelAction.TransactionDetailTypeMappingModelActionTypes.FETCH_TRANSACTION_DETAIL_TYPE_MAPPING_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.TransactionDetailTypeMappingActionFail(
								modelAction.TransactionDetailTypeMappingModelActionTypes.FETCH_TRANSACTION_DETAIL_TYPE_MAPPING_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
