...
/**
 * TransactionDetailTypeMappingCollectionState would store the state of a collection of TransactionDetailTypeMapping
 */
export interface TransactionDetailTypeMappingCollectionState extends CollectionState {
 ...
 */
export interface TransactionDetailTypeMappingModelAudit extends AbstractModelAudit<TransactionDetailTypeMappingModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * TransactionDetailTypeMappingModelState would store the state of the model
 */
export interface TransactionDetailTypeMappingModelState {
	collectionState: {
		[key: string]: TransactionDetailTypeMappingCollectionState;
	};
	data: {
		[id: string]: TransactionDetailTypeMappingModel;
	};
	totalCount: number;
	audits: TransactionDetailTypeMappingModelAudit[];
 ...
 */
export const initialTransactionDetailTypeMappingCollectionState: TransactionDetailTypeMappingCollectionState = {
...
/**
 * The initial state of TransactionDetailTypeMappingModelState
 */
export const initialState: TransactionDetailTypeMappingModelState = {
	collectionState: {
