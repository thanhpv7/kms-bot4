...
/**
 * VaccinationOrderDetailCollectionState would store the state of a collection of VaccinationOrderDetail
 */
export interface VaccinationOrderDetailCollectionState extends CollectionState {
 ...
 */
export interface VaccinationOrderDetailModelAudit extends AbstractModelAudit<VaccinationOrderDetailModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * VaccinationOrderDetailModelState would store the state of the model
 */
export interface VaccinationOrderDetailModelState {
	collectionState: {
		[key: string]: VaccinationOrderDetailCollectionState;
	};
	data: {
		[id: string]: VaccinationOrderDetailModel;
	};
	totalCount: number;
	audits: VaccinationOrderDetailModelAudit[];
 ...
 */
export const initialVaccinationOrderDetailCollectionState: VaccinationOrderDetailCollectionState = {
...
/**
 * The initial state of VaccinationOrderDetailModelState
 */
export const initialState: VaccinationOrderDetailModelState = {
	collectionState: {
