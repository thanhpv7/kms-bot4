...
import * as modelAction from './vaccination_order_detail.model.action';
import {VaccinationOrderDetailService} from '../../services/vaccinationOrderDetail/vaccination_order_detail.service';
...
/**
 * Effect class used for side effects related to Vaccination Order Detail model.
 */
@Injectable()
export class VaccinationOrderDetailEffect {
	...
	constructor(
		...
		protected readonly service: VaccinationOrderDetailService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VaccinationOrderDetailAction>(modelAction.VaccinationOrderDetailModelActionTypes.COUNT_VACCINATION_ORDER_DETAILS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.VaccinationOrderDetailActionOK(
						modelAction.VaccinationOrderDetailModelActionTypes.COUNT_VACCINATION_ORDER_DETAILS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.VaccinationOrderDetailActionFail(
								modelAction.VaccinationOrderDetailModelActionTypes.COUNT_VACCINATION_ORDER_DETAILS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VaccinationOrderDetailAction>(modelAction.VaccinationOrderDetailModelActionTypes.FETCH_VACCINATION_ORDER_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.VaccinationOrderDetailActionOK(
						modelAction.VaccinationOrderDetailModelActionTypes.FETCH_VACCINATION_ORDER_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.VaccinationOrderDetailActionFail(
								modelAction.VaccinationOrderDetailModelActionTypes.FETCH_VACCINATION_ORDER_DETAIL_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VaccinationOrderDetailAction>(modelAction.VaccinationOrderDetailModelActionTypes.FETCH_ALL_VACCINATION_ORDER_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.VaccinationOrderDetailActionOK(
						modelAction.VaccinationOrderDetailModelActionTypes.FETCH_ALL_VACCINATION_ORDER_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.VaccinationOrderDetailActionFail(
								modelAction.VaccinationOrderDetailModelActionTypes.FETCH_ALL_VACCINATION_ORDER_DETAIL_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VaccinationOrderDetailAction>(modelAction.VaccinationOrderDetailModelActionTypes.FETCH_VACCINATION_ORDER_DETAIL_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.VaccinationOrderDetailActionOK(
						modelAction.VaccinationOrderDetailModelActionTypes.FETCH_VACCINATION_ORDER_DETAIL_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.VaccinationOrderDetailActionFail(
								modelAction.VaccinationOrderDetailModelActionTypes.FETCH_VACCINATION_ORDER_DETAIL_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VaccinationOrderDetailAction>(modelAction.VaccinationOrderDetailModelActionTypes.FETCH_LAST_VACCINATION_ORDER_DETAIL_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.VaccinationOrderDetailActionOK(
						modelAction.VaccinationOrderDetailModelActionTypes.FETCH_LAST_VACCINATION_ORDER_DETAIL_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.VaccinationOrderDetailActionFail(
								modelAction.VaccinationOrderDetailModelActionTypes.FETCH_LAST_VACCINATION_ORDER_DETAIL_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VaccinationOrderDetailAction>(modelAction.VaccinationOrderDetailModelActionTypes.CREATE_VACCINATION_ORDER_DETAIL),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as VaccinationOrderDetailModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.VaccinationOrderDetailActionOK(
						modelAction.VaccinationOrderDetailModelActionTypes.CREATE_VACCINATION_ORDER_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.VaccinationOrderDetailActionFail(
								modelAction.VaccinationOrderDetailModelActionTypes.CREATE_VACCINATION_ORDER_DETAIL_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VaccinationOrderDetailAction>(modelAction.VaccinationOrderDetailModelActionTypes.CREATE_ALL_VACCINATION_ORDER_DETAIL),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as VaccinationOrderDetailModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.VaccinationOrderDetailActionOK(
						modelAction.VaccinationOrderDetailModelActionTypes.CREATE_ALL_VACCINATION_ORDER_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.VaccinationOrderDetailActionFail(
								modelAction.VaccinationOrderDetailModelActionTypes.CREATE_ALL_VACCINATION_ORDER_DETAIL_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VaccinationOrderDetailAction>(modelAction.VaccinationOrderDetailModelActionTypes.UPDATE_VACCINATION_ORDER_DETAIL),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as VaccinationOrderDetailModel;
				...
				return this.service.update(new VaccinationOrderDetailModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.VaccinationOrderDetailActionOK(
						modelAction.VaccinationOrderDetailModelActionTypes.UPDATE_VACCINATION_ORDER_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.VaccinationOrderDetailActionFail(
								modelAction.VaccinationOrderDetailModelActionTypes.UPDATE_VACCINATION_ORDER_DETAIL_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VaccinationOrderDetailAction>(modelAction.VaccinationOrderDetailModelActionTypes.UPDATE_ALL_VACCINATION_ORDER_DETAIL),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as VaccinationOrderDetailModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new VaccinationOrderDetailModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.VaccinationOrderDetailActionOK(
						modelAction.VaccinationOrderDetailModelActionTypes.UPDATE_ALL_VACCINATION_ORDER_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.VaccinationOrderDetailActionFail(
								modelAction.VaccinationOrderDetailModelActionTypes.UPDATE_ALL_VACCINATION_ORDER_DETAIL_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VaccinationOrderDetailAction>(modelAction.VaccinationOrderDetailModelActionTypes.DELETE_VACCINATION_ORDER_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.VaccinationOrderDetailActionOK(
						modelAction.VaccinationOrderDetailModelActionTypes.DELETE_VACCINATION_ORDER_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.VaccinationOrderDetailActionFail(
								modelAction.VaccinationOrderDetailModelActionTypes.DELETE_VACCINATION_ORDER_DETAIL_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VaccinationOrderDetailAction>(modelAction.VaccinationOrderDetailModelActionTypes.DELETE_VACCINATION_ORDER_DETAIL_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.VaccinationOrderDetailActionOK(
						modelAction.VaccinationOrderDetailModelActionTypes.DELETE_VACCINATION_ORDER_DETAIL_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.VaccinationOrderDetailActionFail(
								modelAction.VaccinationOrderDetailModelActionTypes.DELETE_VACCINATION_ORDER_DETAIL_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VaccinationOrderDetailAction>(modelAction.VaccinationOrderDetailModelActionTypes.DELETE_ALL_VACCINATION_ORDER_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.VaccinationOrderDetailActionOK(
						modelAction.VaccinationOrderDetailModelActionTypes.DELETE_ALL_VACCINATION_ORDER_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.VaccinationOrderDetailActionFail(
								modelAction.VaccinationOrderDetailModelActionTypes.DELETE_ALL_VACCINATION_ORDER_DETAIL_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VaccinationOrderDetailAction>(modelAction.VaccinationOrderDetailModelActionTypes.EXPORT_VACCINATION_ORDER_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.VaccinationOrderDetailActionOK(
						modelAction.VaccinationOrderDetailModelActionTypes.EXPORT_VACCINATION_ORDER_DETAIL,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VaccinationOrderDetailAction>(modelAction.VaccinationOrderDetailModelActionTypes.EXPORT_ALL_VACCINATION_ORDER_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.VaccinationOrderDetailActionOK(
						modelAction.VaccinationOrderDetailModelActionTypes.EXPORT_ALL_VACCINATION_ORDER_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.VaccinationOrderDetailActionFail(
								modelAction.VaccinationOrderDetailModelActionTypes.EXPORT_ALL_VACCINATION_ORDER_DETAIL_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VaccinationOrderDetailAction>(modelAction.VaccinationOrderDetailModelActionTypes.EXPORT_VACCINATION_ORDER_DETAIL_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.VaccinationOrderDetailActionOK(
						modelAction.VaccinationOrderDetailModelActionTypes.EXPORT_VACCINATION_ORDER_DETAIL_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.VaccinationOrderDetailActionFail(
								modelAction.VaccinationOrderDetailModelActionTypes.EXPORT_VACCINATION_ORDER_DETAIL_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VaccinationOrderDetailAction>(modelAction.VaccinationOrderDetailModelActionTypes.IMPORT_VACCINATION_ORDER_DETAILS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.VaccinationOrderDetailActionOK(
						modelAction.VaccinationOrderDetailModelActionTypes.IMPORT_VACCINATION_ORDER_DETAILS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.VaccinationOrderDetailActionFail(
								modelAction.VaccinationOrderDetailModelActionTypes.IMPORT_VACCINATION_ORDER_DETAILS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VaccinationOrderDetailAction>(modelAction.VaccinationOrderDetailModelActionTypes.FETCH_VACCINATION_ORDER_DETAIL_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.VaccinationOrderDetailActionOK(
						modelAction.VaccinationOrderDetailModelActionTypes.FETCH_VACCINATION_ORDER_DETAIL_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.VaccinationOrderDetailActionFail(
								modelAction.VaccinationOrderDetailModelActionTypes.FETCH_VACCINATION_ORDER_DETAIL_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VaccinationOrderDetailAction>(modelAction.VaccinationOrderDetailModelActionTypes.FETCH_VACCINATION_ORDER_DETAIL_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.VaccinationOrderDetailActionOK(
						modelAction.VaccinationOrderDetailModelActionTypes.FETCH_VACCINATION_ORDER_DETAIL_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.VaccinationOrderDetailActionFail(
								modelAction.VaccinationOrderDetailModelActionTypes.FETCH_VACCINATION_ORDER_DETAIL_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
