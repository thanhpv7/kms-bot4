...
import * as modelAction from './pcare_referensi_sarana.model.action';
import {PcareReferensiSaranaService} from '../../services/pcareReferensiSarana/pcare_referensi_sarana.service';
...
/**
 * Effect class used for side effects related to PCare Referensi Sarana model.
 */
@Injectable()
export class PcareReferensiSaranaEffect {
	...
	constructor(
		...
		protected readonly service: PcareReferensiSaranaService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareReferensiSaranaAction>(modelAction.PcareReferensiSaranaModelActionTypes.COUNT_PCARE_REFERENSI_SARANAS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.PcareReferensiSaranaActionOK(
						modelAction.PcareReferensiSaranaModelActionTypes.COUNT_PCARE_REFERENSI_SARANAS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareReferensiSaranaActionFail(
								modelAction.PcareReferensiSaranaModelActionTypes.COUNT_PCARE_REFERENSI_SARANAS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareReferensiSaranaAction>(modelAction.PcareReferensiSaranaModelActionTypes.FETCH_PCARE_REFERENSI_SARANA),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareReferensiSaranaActionOK(
						modelAction.PcareReferensiSaranaModelActionTypes.FETCH_PCARE_REFERENSI_SARANA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareReferensiSaranaActionFail(
								modelAction.PcareReferensiSaranaModelActionTypes.FETCH_PCARE_REFERENSI_SARANA_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareReferensiSaranaAction>(modelAction.PcareReferensiSaranaModelActionTypes.FETCH_ALL_PCARE_REFERENSI_SARANA),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.PcareReferensiSaranaActionOK(
						modelAction.PcareReferensiSaranaModelActionTypes.FETCH_ALL_PCARE_REFERENSI_SARANA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareReferensiSaranaActionFail(
								modelAction.PcareReferensiSaranaModelActionTypes.FETCH_ALL_PCARE_REFERENSI_SARANA_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareReferensiSaranaAction>(modelAction.PcareReferensiSaranaModelActionTypes.FETCH_PCARE_REFERENSI_SARANA_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareReferensiSaranaActionOK(
						modelAction.PcareReferensiSaranaModelActionTypes.FETCH_PCARE_REFERENSI_SARANA_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareReferensiSaranaActionFail(
								modelAction.PcareReferensiSaranaModelActionTypes.FETCH_PCARE_REFERENSI_SARANA_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareReferensiSaranaAction>(modelAction.PcareReferensiSaranaModelActionTypes.FETCH_LAST_PCARE_REFERENSI_SARANA_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareReferensiSaranaActionOK(
						modelAction.PcareReferensiSaranaModelActionTypes.FETCH_LAST_PCARE_REFERENSI_SARANA_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareReferensiSaranaActionFail(
								modelAction.PcareReferensiSaranaModelActionTypes.FETCH_LAST_PCARE_REFERENSI_SARANA_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareReferensiSaranaAction>(modelAction.PcareReferensiSaranaModelActionTypes.CREATE_PCARE_REFERENSI_SARANA),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as PcareReferensiSaranaModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareReferensiSaranaActionOK(
						modelAction.PcareReferensiSaranaModelActionTypes.CREATE_PCARE_REFERENSI_SARANA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareReferensiSaranaActionFail(
								modelAction.PcareReferensiSaranaModelActionTypes.CREATE_PCARE_REFERENSI_SARANA_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareReferensiSaranaAction>(modelAction.PcareReferensiSaranaModelActionTypes.CREATE_ALL_PCARE_REFERENSI_SARANA),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as PcareReferensiSaranaModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareReferensiSaranaActionOK(
						modelAction.PcareReferensiSaranaModelActionTypes.CREATE_ALL_PCARE_REFERENSI_SARANA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareReferensiSaranaActionFail(
								modelAction.PcareReferensiSaranaModelActionTypes.CREATE_ALL_PCARE_REFERENSI_SARANA_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareReferensiSaranaAction>(modelAction.PcareReferensiSaranaModelActionTypes.UPDATE_PCARE_REFERENSI_SARANA),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as PcareReferensiSaranaModel;
				...
				return this.service.update(new PcareReferensiSaranaModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareReferensiSaranaActionOK(
						modelAction.PcareReferensiSaranaModelActionTypes.UPDATE_PCARE_REFERENSI_SARANA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareReferensiSaranaActionFail(
								modelAction.PcareReferensiSaranaModelActionTypes.UPDATE_PCARE_REFERENSI_SARANA_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareReferensiSaranaAction>(modelAction.PcareReferensiSaranaModelActionTypes.UPDATE_ALL_PCARE_REFERENSI_SARANA),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as PcareReferensiSaranaModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new PcareReferensiSaranaModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareReferensiSaranaActionOK(
						modelAction.PcareReferensiSaranaModelActionTypes.UPDATE_ALL_PCARE_REFERENSI_SARANA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareReferensiSaranaActionFail(
								modelAction.PcareReferensiSaranaModelActionTypes.UPDATE_ALL_PCARE_REFERENSI_SARANA_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareReferensiSaranaAction>(modelAction.PcareReferensiSaranaModelActionTypes.DELETE_PCARE_REFERENSI_SARANA),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PcareReferensiSaranaActionOK(
						modelAction.PcareReferensiSaranaModelActionTypes.DELETE_PCARE_REFERENSI_SARANA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareReferensiSaranaActionFail(
								modelAction.PcareReferensiSaranaModelActionTypes.DELETE_PCARE_REFERENSI_SARANA_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareReferensiSaranaAction>(modelAction.PcareReferensiSaranaModelActionTypes.DELETE_PCARE_REFERENSI_SARANA_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.PcareReferensiSaranaActionOK(
						modelAction.PcareReferensiSaranaModelActionTypes.DELETE_PCARE_REFERENSI_SARANA_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareReferensiSaranaActionFail(
								modelAction.PcareReferensiSaranaModelActionTypes.DELETE_PCARE_REFERENSI_SARANA_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareReferensiSaranaAction>(modelAction.PcareReferensiSaranaModelActionTypes.DELETE_ALL_PCARE_REFERENSI_SARANA),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PcareReferensiSaranaActionOK(
						modelAction.PcareReferensiSaranaModelActionTypes.DELETE_ALL_PCARE_REFERENSI_SARANA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareReferensiSaranaActionFail(
								modelAction.PcareReferensiSaranaModelActionTypes.DELETE_ALL_PCARE_REFERENSI_SARANA_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareReferensiSaranaAction>(modelAction.PcareReferensiSaranaModelActionTypes.EXPORT_PCARE_REFERENSI_SARANA),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PcareReferensiSaranaActionOK(
						modelAction.PcareReferensiSaranaModelActionTypes.EXPORT_PCARE_REFERENSI_SARANA,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareReferensiSaranaAction>(modelAction.PcareReferensiSaranaModelActionTypes.EXPORT_ALL_PCARE_REFERENSI_SARANA),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PcareReferensiSaranaActionOK(
						modelAction.PcareReferensiSaranaModelActionTypes.EXPORT_ALL_PCARE_REFERENSI_SARANA_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareReferensiSaranaActionFail(
								modelAction.PcareReferensiSaranaModelActionTypes.EXPORT_ALL_PCARE_REFERENSI_SARANA_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareReferensiSaranaAction>(modelAction.PcareReferensiSaranaModelActionTypes.EXPORT_PCARE_REFERENSI_SARANA_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PcareReferensiSaranaActionOK(
						modelAction.PcareReferensiSaranaModelActionTypes.EXPORT_PCARE_REFERENSI_SARANA_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareReferensiSaranaActionFail(
								modelAction.PcareReferensiSaranaModelActionTypes.EXPORT_PCARE_REFERENSI_SARANA_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareReferensiSaranaAction>(modelAction.PcareReferensiSaranaModelActionTypes.IMPORT_PCARE_REFERENSI_SARANAS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.PcareReferensiSaranaActionOK(
						modelAction.PcareReferensiSaranaModelActionTypes.IMPORT_PCARE_REFERENSI_SARANAS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareReferensiSaranaActionFail(
								modelAction.PcareReferensiSaranaModelActionTypes.IMPORT_PCARE_REFERENSI_SARANAS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareReferensiSaranaAction>(modelAction.PcareReferensiSaranaModelActionTypes.FETCH_PCARE_REFERENSI_SARANA_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.PcareReferensiSaranaActionOK(
						modelAction.PcareReferensiSaranaModelActionTypes.FETCH_PCARE_REFERENSI_SARANA_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PcareReferensiSaranaActionFail(
								modelAction.PcareReferensiSaranaModelActionTypes.FETCH_PCARE_REFERENSI_SARANA_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareReferensiSaranaAction>(modelAction.PcareReferensiSaranaModelActionTypes.FETCH_PCARE_REFERENSI_SARANA_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.PcareReferensiSaranaActionOK(
						modelAction.PcareReferensiSaranaModelActionTypes.FETCH_PCARE_REFERENSI_SARANA_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PcareReferensiSaranaActionFail(
								modelAction.PcareReferensiSaranaModelActionTypes.FETCH_PCARE_REFERENSI_SARANA_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
