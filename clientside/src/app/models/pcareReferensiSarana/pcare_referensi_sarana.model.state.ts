...
/**
 * PcareReferensiSaranaCollectionState would store the state of a collection of PcareReferensiSarana
 */
export interface PcareReferensiSaranaCollectionState extends CollectionState {
 ...
 */
export interface PcareReferensiSaranaModelAudit extends AbstractModelAudit<PcareReferensiSaranaModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * PcareReferensiSaranaModelState would store the state of the model
 */
export interface PcareReferensiSaranaModelState {
	collectionState: {
		[key: string]: PcareReferensiSaranaCollectionState;
	};
	data: {
		[id: string]: PcareReferensiSaranaModel;
	};
	totalCount: number;
	audits: PcareReferensiSaranaModelAudit[];
 ...
 */
export const initialPcareReferensiSaranaCollectionState: PcareReferensiSaranaCollectionState = {
...
/**
 * The initial state of PcareReferensiSaranaModelState
 */
export const initialState: PcareReferensiSaranaModelState = {
	collectionState: {
