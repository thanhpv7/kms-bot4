...
/**
 * InsuranceProviderCollectionState would store the state of a collection of InsuranceProvider
 */
export interface InsuranceProviderCollectionState extends CollectionState {
 ...
 */
export interface InsuranceProviderModelAudit extends AbstractModelAudit<InsuranceProviderModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * InsuranceProviderModelState would store the state of the model
 */
export interface InsuranceProviderModelState {
	collectionState: {
		[key: string]: InsuranceProviderCollectionState;
	};
	data: {
		[id: string]: InsuranceProviderModel;
	};
	totalCount: number;
	audits: InsuranceProviderModelAudit[];
 ...
 */
export const initialInsuranceProviderCollectionState: InsuranceProviderCollectionState = {
...
/**
 * The initial state of InsuranceProviderModelState
 */
export const initialState: InsuranceProviderModelState = {
	collectionState: {
