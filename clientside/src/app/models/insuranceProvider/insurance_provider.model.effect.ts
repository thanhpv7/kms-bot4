...
import * as modelAction from './insurance_provider.model.action';
import {InsuranceProviderService} from '../../services/insuranceProvider/insurance_provider.service';
...
/**
 * Effect class used for side effects related to Insurance Provider model.
 */
@Injectable()
export class InsuranceProviderEffect {
	...
	constructor(
		...
		protected readonly service: InsuranceProviderService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InsuranceProviderAction>(modelAction.InsuranceProviderModelActionTypes.COUNT_INSURANCE_PROVIDERS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.InsuranceProviderActionOK(
						modelAction.InsuranceProviderModelActionTypes.COUNT_INSURANCE_PROVIDERS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InsuranceProviderActionFail(
								modelAction.InsuranceProviderModelActionTypes.COUNT_INSURANCE_PROVIDERS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InsuranceProviderAction>(modelAction.InsuranceProviderModelActionTypes.FETCH_INSURANCE_PROVIDER),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InsuranceProviderActionOK(
						modelAction.InsuranceProviderModelActionTypes.FETCH_INSURANCE_PROVIDER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InsuranceProviderActionFail(
								modelAction.InsuranceProviderModelActionTypes.FETCH_INSURANCE_PROVIDER_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InsuranceProviderAction>(modelAction.InsuranceProviderModelActionTypes.FETCH_ALL_INSURANCE_PROVIDER),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.InsuranceProviderActionOK(
						modelAction.InsuranceProviderModelActionTypes.FETCH_ALL_INSURANCE_PROVIDER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InsuranceProviderActionFail(
								modelAction.InsuranceProviderModelActionTypes.FETCH_ALL_INSURANCE_PROVIDER_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InsuranceProviderAction>(modelAction.InsuranceProviderModelActionTypes.FETCH_INSURANCE_PROVIDER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.InsuranceProviderActionOK(
						modelAction.InsuranceProviderModelActionTypes.FETCH_INSURANCE_PROVIDER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InsuranceProviderActionFail(
								modelAction.InsuranceProviderModelActionTypes.FETCH_INSURANCE_PROVIDER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InsuranceProviderAction>(modelAction.InsuranceProviderModelActionTypes.FETCH_LAST_INSURANCE_PROVIDER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.InsuranceProviderActionOK(
						modelAction.InsuranceProviderModelActionTypes.FETCH_LAST_INSURANCE_PROVIDER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InsuranceProviderActionFail(
								modelAction.InsuranceProviderModelActionTypes.FETCH_LAST_INSURANCE_PROVIDER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InsuranceProviderAction>(modelAction.InsuranceProviderModelActionTypes.CREATE_INSURANCE_PROVIDER),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as InsuranceProviderModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InsuranceProviderActionOK(
						modelAction.InsuranceProviderModelActionTypes.CREATE_INSURANCE_PROVIDER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InsuranceProviderActionFail(
								modelAction.InsuranceProviderModelActionTypes.CREATE_INSURANCE_PROVIDER_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InsuranceProviderAction>(modelAction.InsuranceProviderModelActionTypes.CREATE_ALL_INSURANCE_PROVIDER),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as InsuranceProviderModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InsuranceProviderActionOK(
						modelAction.InsuranceProviderModelActionTypes.CREATE_ALL_INSURANCE_PROVIDER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InsuranceProviderActionFail(
								modelAction.InsuranceProviderModelActionTypes.CREATE_ALL_INSURANCE_PROVIDER_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InsuranceProviderAction>(modelAction.InsuranceProviderModelActionTypes.UPDATE_INSURANCE_PROVIDER),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as InsuranceProviderModel;
				...
				return this.service.update(new InsuranceProviderModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.InsuranceProviderActionOK(
						modelAction.InsuranceProviderModelActionTypes.UPDATE_INSURANCE_PROVIDER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InsuranceProviderActionFail(
								modelAction.InsuranceProviderModelActionTypes.UPDATE_INSURANCE_PROVIDER_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InsuranceProviderAction>(modelAction.InsuranceProviderModelActionTypes.UPDATE_ALL_INSURANCE_PROVIDER),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as InsuranceProviderModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new InsuranceProviderModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InsuranceProviderActionOK(
						modelAction.InsuranceProviderModelActionTypes.UPDATE_ALL_INSURANCE_PROVIDER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InsuranceProviderActionFail(
								modelAction.InsuranceProviderModelActionTypes.UPDATE_ALL_INSURANCE_PROVIDER_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InsuranceProviderAction>(modelAction.InsuranceProviderModelActionTypes.DELETE_INSURANCE_PROVIDER),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.InsuranceProviderActionOK(
						modelAction.InsuranceProviderModelActionTypes.DELETE_INSURANCE_PROVIDER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InsuranceProviderActionFail(
								modelAction.InsuranceProviderModelActionTypes.DELETE_INSURANCE_PROVIDER_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InsuranceProviderAction>(modelAction.InsuranceProviderModelActionTypes.DELETE_INSURANCE_PROVIDER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.InsuranceProviderActionOK(
						modelAction.InsuranceProviderModelActionTypes.DELETE_INSURANCE_PROVIDER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InsuranceProviderActionFail(
								modelAction.InsuranceProviderModelActionTypes.DELETE_INSURANCE_PROVIDER_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InsuranceProviderAction>(modelAction.InsuranceProviderModelActionTypes.DELETE_ALL_INSURANCE_PROVIDER),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.InsuranceProviderActionOK(
						modelAction.InsuranceProviderModelActionTypes.DELETE_ALL_INSURANCE_PROVIDER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InsuranceProviderActionFail(
								modelAction.InsuranceProviderModelActionTypes.DELETE_ALL_INSURANCE_PROVIDER_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InsuranceProviderAction>(modelAction.InsuranceProviderModelActionTypes.EXPORT_INSURANCE_PROVIDER),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.InsuranceProviderActionOK(
						modelAction.InsuranceProviderModelActionTypes.EXPORT_INSURANCE_PROVIDER,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InsuranceProviderAction>(modelAction.InsuranceProviderModelActionTypes.EXPORT_ALL_INSURANCE_PROVIDER),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.InsuranceProviderActionOK(
						modelAction.InsuranceProviderModelActionTypes.EXPORT_ALL_INSURANCE_PROVIDER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InsuranceProviderActionFail(
								modelAction.InsuranceProviderModelActionTypes.EXPORT_ALL_INSURANCE_PROVIDER_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InsuranceProviderAction>(modelAction.InsuranceProviderModelActionTypes.EXPORT_INSURANCE_PROVIDER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.InsuranceProviderActionOK(
						modelAction.InsuranceProviderModelActionTypes.EXPORT_INSURANCE_PROVIDER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InsuranceProviderActionFail(
								modelAction.InsuranceProviderModelActionTypes.EXPORT_INSURANCE_PROVIDER_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InsuranceProviderAction>(modelAction.InsuranceProviderModelActionTypes.IMPORT_INSURANCE_PROVIDERS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.InsuranceProviderActionOK(
						modelAction.InsuranceProviderModelActionTypes.IMPORT_INSURANCE_PROVIDERS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InsuranceProviderActionFail(
								modelAction.InsuranceProviderModelActionTypes.IMPORT_INSURANCE_PROVIDERS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InsuranceProviderAction>(modelAction.InsuranceProviderModelActionTypes.FETCH_INSURANCE_PROVIDER_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.InsuranceProviderActionOK(
						modelAction.InsuranceProviderModelActionTypes.FETCH_INSURANCE_PROVIDER_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.InsuranceProviderActionFail(
								modelAction.InsuranceProviderModelActionTypes.FETCH_INSURANCE_PROVIDER_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InsuranceProviderAction>(modelAction.InsuranceProviderModelActionTypes.FETCH_INSURANCE_PROVIDER_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.InsuranceProviderActionOK(
						modelAction.InsuranceProviderModelActionTypes.FETCH_INSURANCE_PROVIDER_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.InsuranceProviderActionFail(
								modelAction.InsuranceProviderModelActionTypes.FETCH_INSURANCE_PROVIDER_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
