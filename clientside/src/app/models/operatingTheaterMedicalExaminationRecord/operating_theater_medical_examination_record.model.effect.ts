...
import * as modelAction from './operating_theater_medical_examination_record.model.action';
import {OperatingTheaterMedicalExaminationRecordService} from '../../services/operatingTheaterMedicalExaminationRecord/operating_theater_medical_examination_record.service';
...
/**
 * Effect class used for side effects related to Operating Theater Medical Examination Record model.
 */
@Injectable()
export class OperatingTheaterMedicalExaminationRecordEffect {
	...
	constructor(
		...
		protected readonly service: OperatingTheaterMedicalExaminationRecordService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OperatingTheaterMedicalExaminationRecordAction>(modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.COUNT_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORDS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.OperatingTheaterMedicalExaminationRecordActionOK(
						modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.COUNT_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORDS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.OperatingTheaterMedicalExaminationRecordActionFail(
								modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.COUNT_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORDS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OperatingTheaterMedicalExaminationRecordAction>(modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.FETCH_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.OperatingTheaterMedicalExaminationRecordActionOK(
						modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.FETCH_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.OperatingTheaterMedicalExaminationRecordActionFail(
								modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.FETCH_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OperatingTheaterMedicalExaminationRecordAction>(modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.FETCH_ALL_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.OperatingTheaterMedicalExaminationRecordActionOK(
						modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.FETCH_ALL_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.OperatingTheaterMedicalExaminationRecordActionFail(
								modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.FETCH_ALL_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OperatingTheaterMedicalExaminationRecordAction>(modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.FETCH_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.OperatingTheaterMedicalExaminationRecordActionOK(
						modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.FETCH_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.OperatingTheaterMedicalExaminationRecordActionFail(
								modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.FETCH_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OperatingTheaterMedicalExaminationRecordAction>(modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.FETCH_LAST_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.OperatingTheaterMedicalExaminationRecordActionOK(
						modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.FETCH_LAST_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.OperatingTheaterMedicalExaminationRecordActionFail(
								modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.FETCH_LAST_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OperatingTheaterMedicalExaminationRecordAction>(modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.CREATE_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as OperatingTheaterMedicalExaminationRecordModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.OperatingTheaterMedicalExaminationRecordActionOK(
						modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.CREATE_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.OperatingTheaterMedicalExaminationRecordActionFail(
								modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.CREATE_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OperatingTheaterMedicalExaminationRecordAction>(modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.CREATE_ALL_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as OperatingTheaterMedicalExaminationRecordModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.OperatingTheaterMedicalExaminationRecordActionOK(
						modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.CREATE_ALL_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.OperatingTheaterMedicalExaminationRecordActionFail(
								modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.CREATE_ALL_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OperatingTheaterMedicalExaminationRecordAction>(modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.UPDATE_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as OperatingTheaterMedicalExaminationRecordModel;
				...
				return this.service.update(new OperatingTheaterMedicalExaminationRecordModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.OperatingTheaterMedicalExaminationRecordActionOK(
						modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.UPDATE_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.OperatingTheaterMedicalExaminationRecordActionFail(
								modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.UPDATE_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OperatingTheaterMedicalExaminationRecordAction>(modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.UPDATE_ALL_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as OperatingTheaterMedicalExaminationRecordModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new OperatingTheaterMedicalExaminationRecordModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.OperatingTheaterMedicalExaminationRecordActionOK(
						modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.UPDATE_ALL_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.OperatingTheaterMedicalExaminationRecordActionFail(
								modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.UPDATE_ALL_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OperatingTheaterMedicalExaminationRecordAction>(modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.DELETE_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.OperatingTheaterMedicalExaminationRecordActionOK(
						modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.DELETE_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.OperatingTheaterMedicalExaminationRecordActionFail(
								modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.DELETE_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OperatingTheaterMedicalExaminationRecordAction>(modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.DELETE_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.OperatingTheaterMedicalExaminationRecordActionOK(
						modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.DELETE_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.OperatingTheaterMedicalExaminationRecordActionFail(
								modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.DELETE_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OperatingTheaterMedicalExaminationRecordAction>(modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.DELETE_ALL_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.OperatingTheaterMedicalExaminationRecordActionOK(
						modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.DELETE_ALL_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.OperatingTheaterMedicalExaminationRecordActionFail(
								modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.DELETE_ALL_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OperatingTheaterMedicalExaminationRecordAction>(modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.EXPORT_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.OperatingTheaterMedicalExaminationRecordActionOK(
						modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.EXPORT_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OperatingTheaterMedicalExaminationRecordAction>(modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.EXPORT_ALL_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.OperatingTheaterMedicalExaminationRecordActionOK(
						modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.EXPORT_ALL_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.OperatingTheaterMedicalExaminationRecordActionFail(
								modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.EXPORT_ALL_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OperatingTheaterMedicalExaminationRecordAction>(modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.EXPORT_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.OperatingTheaterMedicalExaminationRecordActionOK(
						modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.EXPORT_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.OperatingTheaterMedicalExaminationRecordActionFail(
								modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.EXPORT_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OperatingTheaterMedicalExaminationRecordAction>(modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.IMPORT_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORDS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.OperatingTheaterMedicalExaminationRecordActionOK(
						modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.IMPORT_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.OperatingTheaterMedicalExaminationRecordActionFail(
								modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.IMPORT_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORDS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OperatingTheaterMedicalExaminationRecordAction>(modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.FETCH_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.OperatingTheaterMedicalExaminationRecordActionOK(
						modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.FETCH_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.OperatingTheaterMedicalExaminationRecordActionFail(
								modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.FETCH_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OperatingTheaterMedicalExaminationRecordAction>(modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.FETCH_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.OperatingTheaterMedicalExaminationRecordActionOK(
						modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.FETCH_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.OperatingTheaterMedicalExaminationRecordActionFail(
								modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.FETCH_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
