...
/**
 * OperatingTheaterMedicalExaminationRecordCollectionState would store the state of a collection of OperatingTheaterMedicalExaminationRecord
 */
export interface OperatingTheaterMedicalExaminationRecordCollectionState extends CollectionState {
 ...
 */
export interface OperatingTheaterMedicalExaminationRecordModelAudit extends AbstractModelAudit<OperatingTheaterMedicalExaminationRecordModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * OperatingTheaterMedicalExaminationRecordModelState would store the state of the model
 */
export interface OperatingTheaterMedicalExaminationRecordModelState {
	collectionState: {
		[key: string]: OperatingTheaterMedicalExaminationRecordCollectionState;
	};
	data: {
		[id: string]: OperatingTheaterMedicalExaminationRecordModel;
	};
	totalCount: number;
	audits: OperatingTheaterMedicalExaminationRecordModelAudit[];
 ...
 */
export const initialOperatingTheaterMedicalExaminationRecordCollectionState: OperatingTheaterMedicalExaminationRecordCollectionState = {
...
/**
 * The initial state of OperatingTheaterMedicalExaminationRecordModelState
 */
export const initialState: OperatingTheaterMedicalExaminationRecordModelState = {
	collectionState: {
