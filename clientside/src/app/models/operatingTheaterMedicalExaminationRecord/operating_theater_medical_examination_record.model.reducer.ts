...
import {initialOperatingTheaterMedicalExaminationRecordCollectionState} from './operating_theater_medical_examination_record.model.state';
...
export function modelReducer(currentState: ModelState, action: Action): ModelState {
	...
	const className = (action as modelAction.BaseOperatingTheaterMedicalExaminationRecordAction).className;
	...
	return produce(currentState, draft => {
		...
		switch (action.type) {
			case modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.CREATE_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_OK:
				const createdModel = (action as modelAction.OperatingTheaterMedicalExaminationRecordActionOK ).stateConfig.targetModel;
				...
				OperatingTheaterMedicalExaminationRecordModel.deepParse(createdModel).forEach(model => {
				...
				break;
			case modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.CREATE_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.CREATE_ALL_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_OK:
				const createdModels = (action as modelAction.OperatingTheaterMedicalExaminationRecordActionOK).stateConfig.targetModels;
				const collectionIdAfterCreateAll = (action as modelAction.OperatingTheaterMedicalExaminationRecordActionOK).stateConfig.collectionId;
				...
				createdModels.forEach((m) => {
					OperatingTheaterMedicalExaminationRecordModel.deepParse(m).forEach(model => {
						draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
						(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
					});
				});
				...
				break;
			case modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.CREATE_ALL_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.DELETE_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_OK:
				const deletedModelId = (action as modelAction.OperatingTheaterMedicalExaminationRecordActionOK).stateConfig.targetModelId;
				const collectionIdAfterDelete = (action as modelAction.OperatingTheaterMedicalExaminationRecordActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.DELETE_ALL_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_OK:
				const deletedModelIds = (action as modelAction.OperatingTheaterMedicalExaminationRecordActionOK).stateConfig.targetModelIds;
				const collectionIdAfterDeleteAll = (action as modelAction.OperatingTheaterMedicalExaminationRecordActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.DELETE_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.UPDATE_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_OK:
				const updatedModel = (action as modelAction.OperatingTheaterMedicalExaminationRecordActionOK).stateConfig.targetModel;
				...
				OperatingTheaterMedicalExaminationRecordModel.deepParse(updatedModel).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.UPDATE_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_FAIL:
				// TODO: Add handling of failure
				break;

			case modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.UPDATE_ALL_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_OK:
				const updatedModels = (action as modelAction.OperatingTheaterMedicalExaminationRecordActionOK).stateConfig.targetModels;
				const collectionIdAfterUpdateAll = (action as modelAction.OperatingTheaterMedicalExaminationRecordActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.UPDATE_ALL_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.FETCH_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_OK:
				let fetchedModel = (action as modelAction.OperatingTheaterMedicalExaminationRecordActionOK).stateConfig.targetModel;
				...
				OperatingTheaterMedicalExaminationRecordModel.deepParse(fetchedModel).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.FETCH_ALL_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_OK:
				const totalCountAfterFetchAll = (action as modelAction.OperatingTheaterMedicalExaminationRecordActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchAll = (action as modelAction.OperatingTheaterMedicalExaminationRecordActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchAll = (action as modelAction.OperatingTheaterMedicalExaminationRecordActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchAll = (action as modelAction.OperatingTheaterMedicalExaminationRecordActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchAll.map(model => OperatingTheaterMedicalExaminationRecordModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.FETCH_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_AUDIT_OK:
				const audits = (action as modelAction.OperatingTheaterMedicalExaminationRecordActionOK).audits;
				...
				break;
			case modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.FETCH_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_AUDITS_BY_ENTITY_ID_OK:
				const auditsByEntityId = (action as modelAction.OperatingTheaterMedicalExaminationRecordActionOK).audits;
				...
				break;
			case modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.FETCH_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_WITH_QUERY_OK:
				const totalCountAfterFetchWithQuery = (action as modelAction.OperatingTheaterMedicalExaminationRecordActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchWithQuery = (action as modelAction.OperatingTheaterMedicalExaminationRecordActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchWithQuery = (action as modelAction.OperatingTheaterMedicalExaminationRecordActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchWithQuery = (action as modelAction.OperatingTheaterMedicalExaminationRecordActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchWithQuery.map(model => OperatingTheaterMedicalExaminationRecordModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.FETCH_LAST_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_WITH_QUERY_OK:
				const totalCountAfterFetchLastWithQuery = (action as modelAction.OperatingTheaterMedicalExaminationRecordActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchLastWithQuery = (action as modelAction.OperatingTheaterMedicalExaminationRecordActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchLastWithQuery = (action as modelAction.OperatingTheaterMedicalExaminationRecordActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchLastWithQuery = (action as modelAction.OperatingTheaterMedicalExaminationRecordActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchLastWithQuery.map(model => OperatingTheaterMedicalExaminationRecordModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.COUNT_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORDS_OK:
				const totalCountAfterCount = (action as modelAction.OperatingTheaterMedicalExaminationRecordActionOK).stateConfig.totalCount;
				...
				break;
			case modelAction.OperatingTheaterMedicalExaminationRecordModelActionTypes.INITIALISE_OPERATING_THEATER_MEDICAL_EXAMINATION_RECORD_COLLECTION_STATE:
				const collectionIdToInitialise =  (action as modelAction.OperatingTheaterMedicalExaminationRecordActionOK).stateConfig.collectionId;
				const queryParamsToInitialise = (action as modelAction.OperatingTheaterMedicalExaminationRecordActionOK).stateConfig.queryParams;
				...
				if (!draft[className].collectionState[collectionIdToInitialise]) {
					draft[className].collectionState[collectionIdToInitialise] = {
						...initialOperatingTheaterMedicalExaminationRecordCollectionState
					};
				}
