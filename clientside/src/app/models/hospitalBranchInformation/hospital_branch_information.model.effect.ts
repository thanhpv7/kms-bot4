...
import * as modelAction from './hospital_branch_information.model.action';
import {HospitalBranchInformationService} from '../../services/hospitalBranchInformation/hospital_branch_information.service';
...
/**
 * Effect class used for side effects related to Hospital Branch Information model.
 */
@Injectable()
export class HospitalBranchInformationEffect {
	...
	constructor(
		...
		protected readonly service: HospitalBranchInformationService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HospitalBranchInformationAction>(modelAction.HospitalBranchInformationModelActionTypes.COUNT_HOSPITAL_BRANCH_INFORMATIONS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.HospitalBranchInformationActionOK(
						modelAction.HospitalBranchInformationModelActionTypes.COUNT_HOSPITAL_BRANCH_INFORMATIONS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.HospitalBranchInformationActionFail(
								modelAction.HospitalBranchInformationModelActionTypes.COUNT_HOSPITAL_BRANCH_INFORMATIONS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HospitalBranchInformationAction>(modelAction.HospitalBranchInformationModelActionTypes.FETCH_HOSPITAL_BRANCH_INFORMATION),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.HospitalBranchInformationActionOK(
						modelAction.HospitalBranchInformationModelActionTypes.FETCH_HOSPITAL_BRANCH_INFORMATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.HospitalBranchInformationActionFail(
								modelAction.HospitalBranchInformationModelActionTypes.FETCH_HOSPITAL_BRANCH_INFORMATION_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HospitalBranchInformationAction>(modelAction.HospitalBranchInformationModelActionTypes.FETCH_ALL_HOSPITAL_BRANCH_INFORMATION),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.HospitalBranchInformationActionOK(
						modelAction.HospitalBranchInformationModelActionTypes.FETCH_ALL_HOSPITAL_BRANCH_INFORMATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.HospitalBranchInformationActionFail(
								modelAction.HospitalBranchInformationModelActionTypes.FETCH_ALL_HOSPITAL_BRANCH_INFORMATION_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HospitalBranchInformationAction>(modelAction.HospitalBranchInformationModelActionTypes.FETCH_HOSPITAL_BRANCH_INFORMATION_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.HospitalBranchInformationActionOK(
						modelAction.HospitalBranchInformationModelActionTypes.FETCH_HOSPITAL_BRANCH_INFORMATION_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.HospitalBranchInformationActionFail(
								modelAction.HospitalBranchInformationModelActionTypes.FETCH_HOSPITAL_BRANCH_INFORMATION_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HospitalBranchInformationAction>(modelAction.HospitalBranchInformationModelActionTypes.FETCH_LAST_HOSPITAL_BRANCH_INFORMATION_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.HospitalBranchInformationActionOK(
						modelAction.HospitalBranchInformationModelActionTypes.FETCH_LAST_HOSPITAL_BRANCH_INFORMATION_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.HospitalBranchInformationActionFail(
								modelAction.HospitalBranchInformationModelActionTypes.FETCH_LAST_HOSPITAL_BRANCH_INFORMATION_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HospitalBranchInformationAction>(modelAction.HospitalBranchInformationModelActionTypes.CREATE_HOSPITAL_BRANCH_INFORMATION),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as HospitalBranchInformationModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.HospitalBranchInformationActionOK(
						modelAction.HospitalBranchInformationModelActionTypes.CREATE_HOSPITAL_BRANCH_INFORMATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.HospitalBranchInformationActionFail(
								modelAction.HospitalBranchInformationModelActionTypes.CREATE_HOSPITAL_BRANCH_INFORMATION_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HospitalBranchInformationAction>(modelAction.HospitalBranchInformationModelActionTypes.CREATE_ALL_HOSPITAL_BRANCH_INFORMATION),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as HospitalBranchInformationModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.HospitalBranchInformationActionOK(
						modelAction.HospitalBranchInformationModelActionTypes.CREATE_ALL_HOSPITAL_BRANCH_INFORMATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.HospitalBranchInformationActionFail(
								modelAction.HospitalBranchInformationModelActionTypes.CREATE_ALL_HOSPITAL_BRANCH_INFORMATION_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HospitalBranchInformationAction>(modelAction.HospitalBranchInformationModelActionTypes.UPDATE_HOSPITAL_BRANCH_INFORMATION),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as HospitalBranchInformationModel;
				...
				return this.service.update(new HospitalBranchInformationModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.HospitalBranchInformationActionOK(
						modelAction.HospitalBranchInformationModelActionTypes.UPDATE_HOSPITAL_BRANCH_INFORMATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.HospitalBranchInformationActionFail(
								modelAction.HospitalBranchInformationModelActionTypes.UPDATE_HOSPITAL_BRANCH_INFORMATION_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HospitalBranchInformationAction>(modelAction.HospitalBranchInformationModelActionTypes.UPDATE_ALL_HOSPITAL_BRANCH_INFORMATION),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as HospitalBranchInformationModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new HospitalBranchInformationModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.HospitalBranchInformationActionOK(
						modelAction.HospitalBranchInformationModelActionTypes.UPDATE_ALL_HOSPITAL_BRANCH_INFORMATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.HospitalBranchInformationActionFail(
								modelAction.HospitalBranchInformationModelActionTypes.UPDATE_ALL_HOSPITAL_BRANCH_INFORMATION_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HospitalBranchInformationAction>(modelAction.HospitalBranchInformationModelActionTypes.DELETE_HOSPITAL_BRANCH_INFORMATION),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.HospitalBranchInformationActionOK(
						modelAction.HospitalBranchInformationModelActionTypes.DELETE_HOSPITAL_BRANCH_INFORMATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.HospitalBranchInformationActionFail(
								modelAction.HospitalBranchInformationModelActionTypes.DELETE_HOSPITAL_BRANCH_INFORMATION_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HospitalBranchInformationAction>(modelAction.HospitalBranchInformationModelActionTypes.DELETE_HOSPITAL_BRANCH_INFORMATION_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.HospitalBranchInformationActionOK(
						modelAction.HospitalBranchInformationModelActionTypes.DELETE_HOSPITAL_BRANCH_INFORMATION_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.HospitalBranchInformationActionFail(
								modelAction.HospitalBranchInformationModelActionTypes.DELETE_HOSPITAL_BRANCH_INFORMATION_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HospitalBranchInformationAction>(modelAction.HospitalBranchInformationModelActionTypes.DELETE_ALL_HOSPITAL_BRANCH_INFORMATION),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.HospitalBranchInformationActionOK(
						modelAction.HospitalBranchInformationModelActionTypes.DELETE_ALL_HOSPITAL_BRANCH_INFORMATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.HospitalBranchInformationActionFail(
								modelAction.HospitalBranchInformationModelActionTypes.DELETE_ALL_HOSPITAL_BRANCH_INFORMATION_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HospitalBranchInformationAction>(modelAction.HospitalBranchInformationModelActionTypes.EXPORT_HOSPITAL_BRANCH_INFORMATION),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.HospitalBranchInformationActionOK(
						modelAction.HospitalBranchInformationModelActionTypes.EXPORT_HOSPITAL_BRANCH_INFORMATION,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HospitalBranchInformationAction>(modelAction.HospitalBranchInformationModelActionTypes.EXPORT_ALL_HOSPITAL_BRANCH_INFORMATION),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.HospitalBranchInformationActionOK(
						modelAction.HospitalBranchInformationModelActionTypes.EXPORT_ALL_HOSPITAL_BRANCH_INFORMATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.HospitalBranchInformationActionFail(
								modelAction.HospitalBranchInformationModelActionTypes.EXPORT_ALL_HOSPITAL_BRANCH_INFORMATION_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HospitalBranchInformationAction>(modelAction.HospitalBranchInformationModelActionTypes.EXPORT_HOSPITAL_BRANCH_INFORMATION_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.HospitalBranchInformationActionOK(
						modelAction.HospitalBranchInformationModelActionTypes.EXPORT_HOSPITAL_BRANCH_INFORMATION_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.HospitalBranchInformationActionFail(
								modelAction.HospitalBranchInformationModelActionTypes.EXPORT_HOSPITAL_BRANCH_INFORMATION_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HospitalBranchInformationAction>(modelAction.HospitalBranchInformationModelActionTypes.IMPORT_HOSPITAL_BRANCH_INFORMATIONS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.HospitalBranchInformationActionOK(
						modelAction.HospitalBranchInformationModelActionTypes.IMPORT_HOSPITAL_BRANCH_INFORMATIONS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.HospitalBranchInformationActionFail(
								modelAction.HospitalBranchInformationModelActionTypes.IMPORT_HOSPITAL_BRANCH_INFORMATIONS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HospitalBranchInformationAction>(modelAction.HospitalBranchInformationModelActionTypes.FETCH_HOSPITAL_BRANCH_INFORMATION_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.HospitalBranchInformationActionOK(
						modelAction.HospitalBranchInformationModelActionTypes.FETCH_HOSPITAL_BRANCH_INFORMATION_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.HospitalBranchInformationActionFail(
								modelAction.HospitalBranchInformationModelActionTypes.FETCH_HOSPITAL_BRANCH_INFORMATION_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.HospitalBranchInformationAction>(modelAction.HospitalBranchInformationModelActionTypes.FETCH_HOSPITAL_BRANCH_INFORMATION_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.HospitalBranchInformationActionOK(
						modelAction.HospitalBranchInformationModelActionTypes.FETCH_HOSPITAL_BRANCH_INFORMATION_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.HospitalBranchInformationActionFail(
								modelAction.HospitalBranchInformationModelActionTypes.FETCH_HOSPITAL_BRANCH_INFORMATION_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
