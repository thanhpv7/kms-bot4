...
/**
 * HospitalBranchInformationCollectionState would store the state of a collection of HospitalBranchInformation
 */
export interface HospitalBranchInformationCollectionState extends CollectionState {
 ...
 */
export interface HospitalBranchInformationModelAudit extends AbstractModelAudit<HospitalBranchInformationModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * HospitalBranchInformationModelState would store the state of the model
 */
export interface HospitalBranchInformationModelState {
	collectionState: {
		[key: string]: HospitalBranchInformationCollectionState;
	};
	data: {
		[id: string]: HospitalBranchInformationModel;
	};
	totalCount: number;
	audits: HospitalBranchInformationModelAudit[];
 ...
 */
export const initialHospitalBranchInformationCollectionState: HospitalBranchInformationCollectionState = {
...
/**
 * The initial state of HospitalBranchInformationModelState
 */
export const initialState: HospitalBranchInformationModelState = {
	collectionState: {
