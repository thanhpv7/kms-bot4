...
/**
 * BpjsBedAvailabilityCollectionState would store the state of a collection of BpjsBedAvailability
 */
export interface BpjsBedAvailabilityCollectionState extends CollectionState {
 ...
 */
export interface BpjsBedAvailabilityModelAudit extends AbstractModelAudit<BpjsBedAvailabilityModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsBedAvailabilityModelState would store the state of the model
 */
export interface BpjsBedAvailabilityModelState {
	collectionState: {
		[key: string]: BpjsBedAvailabilityCollectionState;
	};
	data: {
		[id: string]: BpjsBedAvailabilityModel;
	};
	totalCount: number;
	audits: BpjsBedAvailabilityModelAudit[];
 ...
 */
export const initialBpjsBedAvailabilityCollectionState: BpjsBedAvailabilityCollectionState = {
...
/**
 * The initial state of BpjsBedAvailabilityModelState
 */
export const initialState: BpjsBedAvailabilityModelState = {
	collectionState: {
