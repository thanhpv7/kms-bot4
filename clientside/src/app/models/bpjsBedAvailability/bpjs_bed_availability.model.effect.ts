...
import * as modelAction from './bpjs_bed_availability.model.action';
import {BpjsBedAvailabilityService} from '../../services/bpjsBedAvailability/bpjs_bed_availability.service';
...
/**
 * Effect class used for side effects related to BPJS Bed Availability model.
 */
@Injectable()
export class BpjsBedAvailabilityEffect {
	...
	constructor(
		...
		protected readonly service: BpjsBedAvailabilityService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsBedAvailabilityAction>(modelAction.BpjsBedAvailabilityModelActionTypes.COUNT_BPJS_BED_AVAILABILITYS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsBedAvailabilityActionOK(
						modelAction.BpjsBedAvailabilityModelActionTypes.COUNT_BPJS_BED_AVAILABILITYS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsBedAvailabilityActionFail(
								modelAction.BpjsBedAvailabilityModelActionTypes.COUNT_BPJS_BED_AVAILABILITYS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsBedAvailabilityAction>(modelAction.BpjsBedAvailabilityModelActionTypes.FETCH_BPJS_BED_AVAILABILITY),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsBedAvailabilityActionOK(
						modelAction.BpjsBedAvailabilityModelActionTypes.FETCH_BPJS_BED_AVAILABILITY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsBedAvailabilityActionFail(
								modelAction.BpjsBedAvailabilityModelActionTypes.FETCH_BPJS_BED_AVAILABILITY_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsBedAvailabilityAction>(modelAction.BpjsBedAvailabilityModelActionTypes.FETCH_ALL_BPJS_BED_AVAILABILITY),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsBedAvailabilityActionOK(
						modelAction.BpjsBedAvailabilityModelActionTypes.FETCH_ALL_BPJS_BED_AVAILABILITY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsBedAvailabilityActionFail(
								modelAction.BpjsBedAvailabilityModelActionTypes.FETCH_ALL_BPJS_BED_AVAILABILITY_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsBedAvailabilityAction>(modelAction.BpjsBedAvailabilityModelActionTypes.FETCH_BPJS_BED_AVAILABILITY_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsBedAvailabilityActionOK(
						modelAction.BpjsBedAvailabilityModelActionTypes.FETCH_BPJS_BED_AVAILABILITY_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsBedAvailabilityActionFail(
								modelAction.BpjsBedAvailabilityModelActionTypes.FETCH_BPJS_BED_AVAILABILITY_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsBedAvailabilityAction>(modelAction.BpjsBedAvailabilityModelActionTypes.FETCH_LAST_BPJS_BED_AVAILABILITY_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsBedAvailabilityActionOK(
						modelAction.BpjsBedAvailabilityModelActionTypes.FETCH_LAST_BPJS_BED_AVAILABILITY_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsBedAvailabilityActionFail(
								modelAction.BpjsBedAvailabilityModelActionTypes.FETCH_LAST_BPJS_BED_AVAILABILITY_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsBedAvailabilityAction>(modelAction.BpjsBedAvailabilityModelActionTypes.CREATE_BPJS_BED_AVAILABILITY),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsBedAvailabilityModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsBedAvailabilityActionOK(
						modelAction.BpjsBedAvailabilityModelActionTypes.CREATE_BPJS_BED_AVAILABILITY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsBedAvailabilityActionFail(
								modelAction.BpjsBedAvailabilityModelActionTypes.CREATE_BPJS_BED_AVAILABILITY_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsBedAvailabilityAction>(modelAction.BpjsBedAvailabilityModelActionTypes.CREATE_ALL_BPJS_BED_AVAILABILITY),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsBedAvailabilityModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsBedAvailabilityActionOK(
						modelAction.BpjsBedAvailabilityModelActionTypes.CREATE_ALL_BPJS_BED_AVAILABILITY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsBedAvailabilityActionFail(
								modelAction.BpjsBedAvailabilityModelActionTypes.CREATE_ALL_BPJS_BED_AVAILABILITY_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsBedAvailabilityAction>(modelAction.BpjsBedAvailabilityModelActionTypes.UPDATE_BPJS_BED_AVAILABILITY),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsBedAvailabilityModel;
				...
				return this.service.update(new BpjsBedAvailabilityModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsBedAvailabilityActionOK(
						modelAction.BpjsBedAvailabilityModelActionTypes.UPDATE_BPJS_BED_AVAILABILITY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsBedAvailabilityActionFail(
								modelAction.BpjsBedAvailabilityModelActionTypes.UPDATE_BPJS_BED_AVAILABILITY_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsBedAvailabilityAction>(modelAction.BpjsBedAvailabilityModelActionTypes.UPDATE_ALL_BPJS_BED_AVAILABILITY),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsBedAvailabilityModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsBedAvailabilityModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsBedAvailabilityActionOK(
						modelAction.BpjsBedAvailabilityModelActionTypes.UPDATE_ALL_BPJS_BED_AVAILABILITY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsBedAvailabilityActionFail(
								modelAction.BpjsBedAvailabilityModelActionTypes.UPDATE_ALL_BPJS_BED_AVAILABILITY_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsBedAvailabilityAction>(modelAction.BpjsBedAvailabilityModelActionTypes.DELETE_BPJS_BED_AVAILABILITY),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsBedAvailabilityActionOK(
						modelAction.BpjsBedAvailabilityModelActionTypes.DELETE_BPJS_BED_AVAILABILITY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsBedAvailabilityActionFail(
								modelAction.BpjsBedAvailabilityModelActionTypes.DELETE_BPJS_BED_AVAILABILITY_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsBedAvailabilityAction>(modelAction.BpjsBedAvailabilityModelActionTypes.DELETE_BPJS_BED_AVAILABILITY_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsBedAvailabilityActionOK(
						modelAction.BpjsBedAvailabilityModelActionTypes.DELETE_BPJS_BED_AVAILABILITY_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsBedAvailabilityActionFail(
								modelAction.BpjsBedAvailabilityModelActionTypes.DELETE_BPJS_BED_AVAILABILITY_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsBedAvailabilityAction>(modelAction.BpjsBedAvailabilityModelActionTypes.DELETE_ALL_BPJS_BED_AVAILABILITY),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsBedAvailabilityActionOK(
						modelAction.BpjsBedAvailabilityModelActionTypes.DELETE_ALL_BPJS_BED_AVAILABILITY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsBedAvailabilityActionFail(
								modelAction.BpjsBedAvailabilityModelActionTypes.DELETE_ALL_BPJS_BED_AVAILABILITY_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsBedAvailabilityAction>(modelAction.BpjsBedAvailabilityModelActionTypes.EXPORT_BPJS_BED_AVAILABILITY),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsBedAvailabilityActionOK(
						modelAction.BpjsBedAvailabilityModelActionTypes.EXPORT_BPJS_BED_AVAILABILITY,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsBedAvailabilityAction>(modelAction.BpjsBedAvailabilityModelActionTypes.EXPORT_ALL_BPJS_BED_AVAILABILITY),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsBedAvailabilityActionOK(
						modelAction.BpjsBedAvailabilityModelActionTypes.EXPORT_ALL_BPJS_BED_AVAILABILITY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsBedAvailabilityActionFail(
								modelAction.BpjsBedAvailabilityModelActionTypes.EXPORT_ALL_BPJS_BED_AVAILABILITY_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsBedAvailabilityAction>(modelAction.BpjsBedAvailabilityModelActionTypes.EXPORT_BPJS_BED_AVAILABILITY_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsBedAvailabilityActionOK(
						modelAction.BpjsBedAvailabilityModelActionTypes.EXPORT_BPJS_BED_AVAILABILITY_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsBedAvailabilityActionFail(
								modelAction.BpjsBedAvailabilityModelActionTypes.EXPORT_BPJS_BED_AVAILABILITY_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsBedAvailabilityAction>(modelAction.BpjsBedAvailabilityModelActionTypes.IMPORT_BPJS_BED_AVAILABILITYS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsBedAvailabilityActionOK(
						modelAction.BpjsBedAvailabilityModelActionTypes.IMPORT_BPJS_BED_AVAILABILITYS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsBedAvailabilityActionFail(
								modelAction.BpjsBedAvailabilityModelActionTypes.IMPORT_BPJS_BED_AVAILABILITYS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsBedAvailabilityAction>(modelAction.BpjsBedAvailabilityModelActionTypes.FETCH_BPJS_BED_AVAILABILITY_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsBedAvailabilityActionOK(
						modelAction.BpjsBedAvailabilityModelActionTypes.FETCH_BPJS_BED_AVAILABILITY_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsBedAvailabilityActionFail(
								modelAction.BpjsBedAvailabilityModelActionTypes.FETCH_BPJS_BED_AVAILABILITY_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsBedAvailabilityAction>(modelAction.BpjsBedAvailabilityModelActionTypes.FETCH_BPJS_BED_AVAILABILITY_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsBedAvailabilityActionOK(
						modelAction.BpjsBedAvailabilityModelActionTypes.FETCH_BPJS_BED_AVAILABILITY_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsBedAvailabilityActionFail(
								modelAction.BpjsBedAvailabilityModelActionTypes.FETCH_BPJS_BED_AVAILABILITY_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
