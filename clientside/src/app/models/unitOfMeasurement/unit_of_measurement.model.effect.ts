...
import * as modelAction from './unit_of_measurement.model.action';
import {UnitOfMeasurementService} from '../../services/unitOfMeasurement/unit_of_measurement.service';
...
/**
 * Effect class used for side effects related to Unit Of Measurement model.
 */
@Injectable()
export class UnitOfMeasurementEffect {
	...
	constructor(
		...
		protected readonly service: UnitOfMeasurementService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.UnitOfMeasurementAction>(modelAction.UnitOfMeasurementModelActionTypes.COUNT_UNIT_OF_MEASUREMENTS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.UnitOfMeasurementActionOK(
						modelAction.UnitOfMeasurementModelActionTypes.COUNT_UNIT_OF_MEASUREMENTS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.UnitOfMeasurementActionFail(
								modelAction.UnitOfMeasurementModelActionTypes.COUNT_UNIT_OF_MEASUREMENTS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.UnitOfMeasurementAction>(modelAction.UnitOfMeasurementModelActionTypes.FETCH_UNIT_OF_MEASUREMENT),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.UnitOfMeasurementActionOK(
						modelAction.UnitOfMeasurementModelActionTypes.FETCH_UNIT_OF_MEASUREMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.UnitOfMeasurementActionFail(
								modelAction.UnitOfMeasurementModelActionTypes.FETCH_UNIT_OF_MEASUREMENT_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.UnitOfMeasurementAction>(modelAction.UnitOfMeasurementModelActionTypes.FETCH_ALL_UNIT_OF_MEASUREMENT),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.UnitOfMeasurementActionOK(
						modelAction.UnitOfMeasurementModelActionTypes.FETCH_ALL_UNIT_OF_MEASUREMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.UnitOfMeasurementActionFail(
								modelAction.UnitOfMeasurementModelActionTypes.FETCH_ALL_UNIT_OF_MEASUREMENT_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.UnitOfMeasurementAction>(modelAction.UnitOfMeasurementModelActionTypes.FETCH_UNIT_OF_MEASUREMENT_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.UnitOfMeasurementActionOK(
						modelAction.UnitOfMeasurementModelActionTypes.FETCH_UNIT_OF_MEASUREMENT_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.UnitOfMeasurementActionFail(
								modelAction.UnitOfMeasurementModelActionTypes.FETCH_UNIT_OF_MEASUREMENT_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.UnitOfMeasurementAction>(modelAction.UnitOfMeasurementModelActionTypes.FETCH_LAST_UNIT_OF_MEASUREMENT_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.UnitOfMeasurementActionOK(
						modelAction.UnitOfMeasurementModelActionTypes.FETCH_LAST_UNIT_OF_MEASUREMENT_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.UnitOfMeasurementActionFail(
								modelAction.UnitOfMeasurementModelActionTypes.FETCH_LAST_UNIT_OF_MEASUREMENT_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.UnitOfMeasurementAction>(modelAction.UnitOfMeasurementModelActionTypes.CREATE_UNIT_OF_MEASUREMENT),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as UnitOfMeasurementModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.UnitOfMeasurementActionOK(
						modelAction.UnitOfMeasurementModelActionTypes.CREATE_UNIT_OF_MEASUREMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.UnitOfMeasurementActionFail(
								modelAction.UnitOfMeasurementModelActionTypes.CREATE_UNIT_OF_MEASUREMENT_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.UnitOfMeasurementAction>(modelAction.UnitOfMeasurementModelActionTypes.CREATE_ALL_UNIT_OF_MEASUREMENT),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as UnitOfMeasurementModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.UnitOfMeasurementActionOK(
						modelAction.UnitOfMeasurementModelActionTypes.CREATE_ALL_UNIT_OF_MEASUREMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.UnitOfMeasurementActionFail(
								modelAction.UnitOfMeasurementModelActionTypes.CREATE_ALL_UNIT_OF_MEASUREMENT_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.UnitOfMeasurementAction>(modelAction.UnitOfMeasurementModelActionTypes.UPDATE_UNIT_OF_MEASUREMENT),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as UnitOfMeasurementModel;
				...
				return this.service.update(new UnitOfMeasurementModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.UnitOfMeasurementActionOK(
						modelAction.UnitOfMeasurementModelActionTypes.UPDATE_UNIT_OF_MEASUREMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.UnitOfMeasurementActionFail(
								modelAction.UnitOfMeasurementModelActionTypes.UPDATE_UNIT_OF_MEASUREMENT_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.UnitOfMeasurementAction>(modelAction.UnitOfMeasurementModelActionTypes.UPDATE_ALL_UNIT_OF_MEASUREMENT),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as UnitOfMeasurementModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new UnitOfMeasurementModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.UnitOfMeasurementActionOK(
						modelAction.UnitOfMeasurementModelActionTypes.UPDATE_ALL_UNIT_OF_MEASUREMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.UnitOfMeasurementActionFail(
								modelAction.UnitOfMeasurementModelActionTypes.UPDATE_ALL_UNIT_OF_MEASUREMENT_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.UnitOfMeasurementAction>(modelAction.UnitOfMeasurementModelActionTypes.DELETE_UNIT_OF_MEASUREMENT),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.UnitOfMeasurementActionOK(
						modelAction.UnitOfMeasurementModelActionTypes.DELETE_UNIT_OF_MEASUREMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.UnitOfMeasurementActionFail(
								modelAction.UnitOfMeasurementModelActionTypes.DELETE_UNIT_OF_MEASUREMENT_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.UnitOfMeasurementAction>(modelAction.UnitOfMeasurementModelActionTypes.DELETE_UNIT_OF_MEASUREMENT_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.UnitOfMeasurementActionOK(
						modelAction.UnitOfMeasurementModelActionTypes.DELETE_UNIT_OF_MEASUREMENT_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.UnitOfMeasurementActionFail(
								modelAction.UnitOfMeasurementModelActionTypes.DELETE_UNIT_OF_MEASUREMENT_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.UnitOfMeasurementAction>(modelAction.UnitOfMeasurementModelActionTypes.DELETE_ALL_UNIT_OF_MEASUREMENT),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.UnitOfMeasurementActionOK(
						modelAction.UnitOfMeasurementModelActionTypes.DELETE_ALL_UNIT_OF_MEASUREMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.UnitOfMeasurementActionFail(
								modelAction.UnitOfMeasurementModelActionTypes.DELETE_ALL_UNIT_OF_MEASUREMENT_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.UnitOfMeasurementAction>(modelAction.UnitOfMeasurementModelActionTypes.EXPORT_UNIT_OF_MEASUREMENT),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.UnitOfMeasurementActionOK(
						modelAction.UnitOfMeasurementModelActionTypes.EXPORT_UNIT_OF_MEASUREMENT,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.UnitOfMeasurementAction>(modelAction.UnitOfMeasurementModelActionTypes.EXPORT_ALL_UNIT_OF_MEASUREMENT),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.UnitOfMeasurementActionOK(
						modelAction.UnitOfMeasurementModelActionTypes.EXPORT_ALL_UNIT_OF_MEASUREMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.UnitOfMeasurementActionFail(
								modelAction.UnitOfMeasurementModelActionTypes.EXPORT_ALL_UNIT_OF_MEASUREMENT_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.UnitOfMeasurementAction>(modelAction.UnitOfMeasurementModelActionTypes.EXPORT_UNIT_OF_MEASUREMENT_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.UnitOfMeasurementActionOK(
						modelAction.UnitOfMeasurementModelActionTypes.EXPORT_UNIT_OF_MEASUREMENT_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.UnitOfMeasurementActionFail(
								modelAction.UnitOfMeasurementModelActionTypes.EXPORT_UNIT_OF_MEASUREMENT_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.UnitOfMeasurementAction>(modelAction.UnitOfMeasurementModelActionTypes.IMPORT_UNIT_OF_MEASUREMENTS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.UnitOfMeasurementActionOK(
						modelAction.UnitOfMeasurementModelActionTypes.IMPORT_UNIT_OF_MEASUREMENTS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.UnitOfMeasurementActionFail(
								modelAction.UnitOfMeasurementModelActionTypes.IMPORT_UNIT_OF_MEASUREMENTS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.UnitOfMeasurementAction>(modelAction.UnitOfMeasurementModelActionTypes.FETCH_UNIT_OF_MEASUREMENT_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.UnitOfMeasurementActionOK(
						modelAction.UnitOfMeasurementModelActionTypes.FETCH_UNIT_OF_MEASUREMENT_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.UnitOfMeasurementActionFail(
								modelAction.UnitOfMeasurementModelActionTypes.FETCH_UNIT_OF_MEASUREMENT_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.UnitOfMeasurementAction>(modelAction.UnitOfMeasurementModelActionTypes.FETCH_UNIT_OF_MEASUREMENT_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.UnitOfMeasurementActionOK(
						modelAction.UnitOfMeasurementModelActionTypes.FETCH_UNIT_OF_MEASUREMENT_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.UnitOfMeasurementActionFail(
								modelAction.UnitOfMeasurementModelActionTypes.FETCH_UNIT_OF_MEASUREMENT_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
