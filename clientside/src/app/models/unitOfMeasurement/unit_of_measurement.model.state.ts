...
/**
 * UnitOfMeasurementCollectionState would store the state of a collection of UnitOfMeasurement
 */
export interface UnitOfMeasurementCollectionState extends CollectionState {
 ...
 */
export interface UnitOfMeasurementModelAudit extends AbstractModelAudit<UnitOfMeasurementModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * UnitOfMeasurementModelState would store the state of the model
 */
export interface UnitOfMeasurementModelState {
	collectionState: {
		[key: string]: UnitOfMeasurementCollectionState;
	};
	data: {
		[id: string]: UnitOfMeasurementModel;
	};
	totalCount: number;
	audits: UnitOfMeasurementModelAudit[];
 ...
 */
export const initialUnitOfMeasurementCollectionState: UnitOfMeasurementCollectionState = {
...
/**
 * The initial state of UnitOfMeasurementModelState
 */
export const initialState: UnitOfMeasurementModelState = {
	collectionState: {
