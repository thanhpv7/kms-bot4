...
import {initialInpatientMedicalExaminationRecordCollectionState} from './inpatient_medical_examination_record.model.state';
...
export function modelReducer(currentState: ModelState, action: Action): ModelState {
	...
	const className = (action as modelAction.BaseInpatientMedicalExaminationRecordAction).className;
	...
	return produce(currentState, draft => {
		...
		switch (action.type) {
			case modelAction.InpatientMedicalExaminationRecordModelActionTypes.CREATE_INPATIENT_MEDICAL_EXAMINATION_RECORD_OK:
				const createdModel = (action as modelAction.InpatientMedicalExaminationRecordActionOK ).stateConfig.targetModel;
				...
				InpatientMedicalExaminationRecordModel.deepParse(createdModel).forEach(model => {
				...
				break;
			case modelAction.InpatientMedicalExaminationRecordModelActionTypes.CREATE_INPATIENT_MEDICAL_EXAMINATION_RECORD_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.InpatientMedicalExaminationRecordModelActionTypes.CREATE_ALL_INPATIENT_MEDICAL_EXAMINATION_RECORD_OK:
				const createdModels = (action as modelAction.InpatientMedicalExaminationRecordActionOK).stateConfig.targetModels;
				const collectionIdAfterCreateAll = (action as modelAction.InpatientMedicalExaminationRecordActionOK).stateConfig.collectionId;
				...
				createdModels.forEach((m) => {
					InpatientMedicalExaminationRecordModel.deepParse(m).forEach(model => {
						draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
						(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
					});
				});
				...
				break;
			case modelAction.InpatientMedicalExaminationRecordModelActionTypes.CREATE_ALL_INPATIENT_MEDICAL_EXAMINATION_RECORD_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.InpatientMedicalExaminationRecordModelActionTypes.DELETE_INPATIENT_MEDICAL_EXAMINATION_RECORD_OK:
				const deletedModelId = (action as modelAction.InpatientMedicalExaminationRecordActionOK).stateConfig.targetModelId;
				const collectionIdAfterDelete = (action as modelAction.InpatientMedicalExaminationRecordActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.InpatientMedicalExaminationRecordModelActionTypes.DELETE_ALL_INPATIENT_MEDICAL_EXAMINATION_RECORD_OK:
				const deletedModelIds = (action as modelAction.InpatientMedicalExaminationRecordActionOK).stateConfig.targetModelIds;
				const collectionIdAfterDeleteAll = (action as modelAction.InpatientMedicalExaminationRecordActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.InpatientMedicalExaminationRecordModelActionTypes.DELETE_INPATIENT_MEDICAL_EXAMINATION_RECORD_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.InpatientMedicalExaminationRecordModelActionTypes.UPDATE_INPATIENT_MEDICAL_EXAMINATION_RECORD_OK:
				const updatedModel = (action as modelAction.InpatientMedicalExaminationRecordActionOK).stateConfig.targetModel;
				...
				InpatientMedicalExaminationRecordModel.deepParse(updatedModel).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.InpatientMedicalExaminationRecordModelActionTypes.UPDATE_INPATIENT_MEDICAL_EXAMINATION_RECORD_FAIL:
				// TODO: Add handling of failure
				break;

			case modelAction.InpatientMedicalExaminationRecordModelActionTypes.UPDATE_ALL_INPATIENT_MEDICAL_EXAMINATION_RECORD_OK:
				const updatedModels = (action as modelAction.InpatientMedicalExaminationRecordActionOK).stateConfig.targetModels;
				const collectionIdAfterUpdateAll = (action as modelAction.InpatientMedicalExaminationRecordActionOK).stateConfig.collectionId;
				...
				break;
			case modelAction.InpatientMedicalExaminationRecordModelActionTypes.UPDATE_ALL_INPATIENT_MEDICAL_EXAMINATION_RECORD_FAIL:
				// TODO: Add handling of failure
				break;
			case modelAction.InpatientMedicalExaminationRecordModelActionTypes.FETCH_INPATIENT_MEDICAL_EXAMINATION_RECORD_OK:
				let fetchedModel = (action as modelAction.InpatientMedicalExaminationRecordActionOK).stateConfig.targetModel;
				...
				InpatientMedicalExaminationRecordModel.deepParse(fetchedModel).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.InpatientMedicalExaminationRecordModelActionTypes.FETCH_ALL_INPATIENT_MEDICAL_EXAMINATION_RECORD_OK:
				const totalCountAfterFetchAll = (action as modelAction.InpatientMedicalExaminationRecordActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchAll = (action as modelAction.InpatientMedicalExaminationRecordActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchAll = (action as modelAction.InpatientMedicalExaminationRecordActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchAll = (action as modelAction.InpatientMedicalExaminationRecordActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchAll.map(model => InpatientMedicalExaminationRecordModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.InpatientMedicalExaminationRecordModelActionTypes.FETCH_INPATIENT_MEDICAL_EXAMINATION_RECORD_AUDIT_OK:
				const audits = (action as modelAction.InpatientMedicalExaminationRecordActionOK).audits;
				...
				break;
			case modelAction.InpatientMedicalExaminationRecordModelActionTypes.FETCH_INPATIENT_MEDICAL_EXAMINATION_RECORD_AUDITS_BY_ENTITY_ID_OK:
				const auditsByEntityId = (action as modelAction.InpatientMedicalExaminationRecordActionOK).audits;
				...
				break;
			case modelAction.InpatientMedicalExaminationRecordModelActionTypes.FETCH_INPATIENT_MEDICAL_EXAMINATION_RECORD_WITH_QUERY_OK:
				const totalCountAfterFetchWithQuery = (action as modelAction.InpatientMedicalExaminationRecordActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchWithQuery = (action as modelAction.InpatientMedicalExaminationRecordActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchWithQuery = (action as modelAction.InpatientMedicalExaminationRecordActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchWithQuery = (action as modelAction.InpatientMedicalExaminationRecordActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchWithQuery.map(model => InpatientMedicalExaminationRecordModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.InpatientMedicalExaminationRecordModelActionTypes.FETCH_LAST_INPATIENT_MEDICAL_EXAMINATION_RECORD_WITH_QUERY_OK:
				const totalCountAfterFetchLastWithQuery = (action as modelAction.InpatientMedicalExaminationRecordActionOK).stateConfig.collectionCount;
				const fetchedModelsAfterFetchLastWithQuery = (action as modelAction.InpatientMedicalExaminationRecordActionOK).stateConfig.targetModels;
				const collectionIdAfterFetchLastWithQuery = (action as modelAction.InpatientMedicalExaminationRecordActionOK).stateConfig.collectionId;
				const queryParamsAfterFetchLastWithQuery = (action as modelAction.InpatientMedicalExaminationRecordActionOK).stateConfig.queryParams;
				...
				_.flatten(fetchedModelsAfterFetchLastWithQuery.map(model => InpatientMedicalExaminationRecordModel.deepParse(model))).forEach(model => {
					draft[model.className].data[model.id] = _.assignWith(draft[model.className].data[model.id], model,
					(objValue, srcValue) => _.isUndefined(srcValue) ? objValue : srcValue);
				});
				...
				break;
			case modelAction.InpatientMedicalExaminationRecordModelActionTypes.COUNT_INPATIENT_MEDICAL_EXAMINATION_RECORDS_OK:
				const totalCountAfterCount = (action as modelAction.InpatientMedicalExaminationRecordActionOK).stateConfig.totalCount;
				...
				break;
			case modelAction.InpatientMedicalExaminationRecordModelActionTypes.INITIALISE_INPATIENT_MEDICAL_EXAMINATION_RECORD_COLLECTION_STATE:
				const collectionIdToInitialise =  (action as modelAction.InpatientMedicalExaminationRecordActionOK).stateConfig.collectionId;
				const queryParamsToInitialise = (action as modelAction.InpatientMedicalExaminationRecordActionOK).stateConfig.queryParams;
				...
				if (!draft[className].collectionState[collectionIdToInitialise]) {
					draft[className].collectionState[collectionIdToInitialise] = {
						...initialInpatientMedicalExaminationRecordCollectionState
					};
				}
