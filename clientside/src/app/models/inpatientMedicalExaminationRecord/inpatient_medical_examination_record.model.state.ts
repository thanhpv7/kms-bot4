...
/**
 * InpatientMedicalExaminationRecordCollectionState would store the state of a collection of InpatientMedicalExaminationRecord
 */
export interface InpatientMedicalExaminationRecordCollectionState extends CollectionState {
 ...
 */
export interface InpatientMedicalExaminationRecordModelAudit extends AbstractModelAudit<InpatientMedicalExaminationRecordModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * InpatientMedicalExaminationRecordModelState would store the state of the model
 */
export interface InpatientMedicalExaminationRecordModelState {
	collectionState: {
		[key: string]: InpatientMedicalExaminationRecordCollectionState;
	};
	data: {
		[id: string]: InpatientMedicalExaminationRecordModel;
	};
	totalCount: number;
	audits: InpatientMedicalExaminationRecordModelAudit[];
 ...
 */
export const initialInpatientMedicalExaminationRecordCollectionState: InpatientMedicalExaminationRecordCollectionState = {
...
/**
 * The initial state of InpatientMedicalExaminationRecordModelState
 */
export const initialState: InpatientMedicalExaminationRecordModelState = {
	collectionState: {
