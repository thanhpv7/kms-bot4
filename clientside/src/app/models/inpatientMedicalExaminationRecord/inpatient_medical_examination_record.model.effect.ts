...
import * as modelAction from './inpatient_medical_examination_record.model.action';
import {InpatientMedicalExaminationRecordService} from '../../services/inpatientMedicalExaminationRecord/inpatient_medical_examination_record.service';
...
/**
 * Effect class used for side effects related to Inpatient Medical Examination Record model.
 */
@Injectable()
export class InpatientMedicalExaminationRecordEffect {
	...
	constructor(
		...
		protected readonly service: InpatientMedicalExaminationRecordService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InpatientMedicalExaminationRecordAction>(modelAction.InpatientMedicalExaminationRecordModelActionTypes.COUNT_INPATIENT_MEDICAL_EXAMINATION_RECORDS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.InpatientMedicalExaminationRecordActionOK(
						modelAction.InpatientMedicalExaminationRecordModelActionTypes.COUNT_INPATIENT_MEDICAL_EXAMINATION_RECORDS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InpatientMedicalExaminationRecordActionFail(
								modelAction.InpatientMedicalExaminationRecordModelActionTypes.COUNT_INPATIENT_MEDICAL_EXAMINATION_RECORDS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InpatientMedicalExaminationRecordAction>(modelAction.InpatientMedicalExaminationRecordModelActionTypes.FETCH_INPATIENT_MEDICAL_EXAMINATION_RECORD),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InpatientMedicalExaminationRecordActionOK(
						modelAction.InpatientMedicalExaminationRecordModelActionTypes.FETCH_INPATIENT_MEDICAL_EXAMINATION_RECORD_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InpatientMedicalExaminationRecordActionFail(
								modelAction.InpatientMedicalExaminationRecordModelActionTypes.FETCH_INPATIENT_MEDICAL_EXAMINATION_RECORD_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InpatientMedicalExaminationRecordAction>(modelAction.InpatientMedicalExaminationRecordModelActionTypes.FETCH_ALL_INPATIENT_MEDICAL_EXAMINATION_RECORD),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.InpatientMedicalExaminationRecordActionOK(
						modelAction.InpatientMedicalExaminationRecordModelActionTypes.FETCH_ALL_INPATIENT_MEDICAL_EXAMINATION_RECORD_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InpatientMedicalExaminationRecordActionFail(
								modelAction.InpatientMedicalExaminationRecordModelActionTypes.FETCH_ALL_INPATIENT_MEDICAL_EXAMINATION_RECORD_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InpatientMedicalExaminationRecordAction>(modelAction.InpatientMedicalExaminationRecordModelActionTypes.FETCH_INPATIENT_MEDICAL_EXAMINATION_RECORD_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.InpatientMedicalExaminationRecordActionOK(
						modelAction.InpatientMedicalExaminationRecordModelActionTypes.FETCH_INPATIENT_MEDICAL_EXAMINATION_RECORD_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InpatientMedicalExaminationRecordActionFail(
								modelAction.InpatientMedicalExaminationRecordModelActionTypes.FETCH_INPATIENT_MEDICAL_EXAMINATION_RECORD_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InpatientMedicalExaminationRecordAction>(modelAction.InpatientMedicalExaminationRecordModelActionTypes.FETCH_LAST_INPATIENT_MEDICAL_EXAMINATION_RECORD_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.InpatientMedicalExaminationRecordActionOK(
						modelAction.InpatientMedicalExaminationRecordModelActionTypes.FETCH_LAST_INPATIENT_MEDICAL_EXAMINATION_RECORD_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InpatientMedicalExaminationRecordActionFail(
								modelAction.InpatientMedicalExaminationRecordModelActionTypes.FETCH_LAST_INPATIENT_MEDICAL_EXAMINATION_RECORD_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InpatientMedicalExaminationRecordAction>(modelAction.InpatientMedicalExaminationRecordModelActionTypes.CREATE_INPATIENT_MEDICAL_EXAMINATION_RECORD),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as InpatientMedicalExaminationRecordModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InpatientMedicalExaminationRecordActionOK(
						modelAction.InpatientMedicalExaminationRecordModelActionTypes.CREATE_INPATIENT_MEDICAL_EXAMINATION_RECORD_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InpatientMedicalExaminationRecordActionFail(
								modelAction.InpatientMedicalExaminationRecordModelActionTypes.CREATE_INPATIENT_MEDICAL_EXAMINATION_RECORD_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InpatientMedicalExaminationRecordAction>(modelAction.InpatientMedicalExaminationRecordModelActionTypes.CREATE_ALL_INPATIENT_MEDICAL_EXAMINATION_RECORD),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as InpatientMedicalExaminationRecordModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InpatientMedicalExaminationRecordActionOK(
						modelAction.InpatientMedicalExaminationRecordModelActionTypes.CREATE_ALL_INPATIENT_MEDICAL_EXAMINATION_RECORD_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InpatientMedicalExaminationRecordActionFail(
								modelAction.InpatientMedicalExaminationRecordModelActionTypes.CREATE_ALL_INPATIENT_MEDICAL_EXAMINATION_RECORD_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InpatientMedicalExaminationRecordAction>(modelAction.InpatientMedicalExaminationRecordModelActionTypes.UPDATE_INPATIENT_MEDICAL_EXAMINATION_RECORD),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as InpatientMedicalExaminationRecordModel;
				...
				return this.service.update(new InpatientMedicalExaminationRecordModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.InpatientMedicalExaminationRecordActionOK(
						modelAction.InpatientMedicalExaminationRecordModelActionTypes.UPDATE_INPATIENT_MEDICAL_EXAMINATION_RECORD_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InpatientMedicalExaminationRecordActionFail(
								modelAction.InpatientMedicalExaminationRecordModelActionTypes.UPDATE_INPATIENT_MEDICAL_EXAMINATION_RECORD_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InpatientMedicalExaminationRecordAction>(modelAction.InpatientMedicalExaminationRecordModelActionTypes.UPDATE_ALL_INPATIENT_MEDICAL_EXAMINATION_RECORD),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as InpatientMedicalExaminationRecordModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new InpatientMedicalExaminationRecordModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InpatientMedicalExaminationRecordActionOK(
						modelAction.InpatientMedicalExaminationRecordModelActionTypes.UPDATE_ALL_INPATIENT_MEDICAL_EXAMINATION_RECORD_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InpatientMedicalExaminationRecordActionFail(
								modelAction.InpatientMedicalExaminationRecordModelActionTypes.UPDATE_ALL_INPATIENT_MEDICAL_EXAMINATION_RECORD_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InpatientMedicalExaminationRecordAction>(modelAction.InpatientMedicalExaminationRecordModelActionTypes.DELETE_INPATIENT_MEDICAL_EXAMINATION_RECORD),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.InpatientMedicalExaminationRecordActionOK(
						modelAction.InpatientMedicalExaminationRecordModelActionTypes.DELETE_INPATIENT_MEDICAL_EXAMINATION_RECORD_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InpatientMedicalExaminationRecordActionFail(
								modelAction.InpatientMedicalExaminationRecordModelActionTypes.DELETE_INPATIENT_MEDICAL_EXAMINATION_RECORD_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InpatientMedicalExaminationRecordAction>(modelAction.InpatientMedicalExaminationRecordModelActionTypes.DELETE_INPATIENT_MEDICAL_EXAMINATION_RECORD_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.InpatientMedicalExaminationRecordActionOK(
						modelAction.InpatientMedicalExaminationRecordModelActionTypes.DELETE_INPATIENT_MEDICAL_EXAMINATION_RECORD_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InpatientMedicalExaminationRecordActionFail(
								modelAction.InpatientMedicalExaminationRecordModelActionTypes.DELETE_INPATIENT_MEDICAL_EXAMINATION_RECORD_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InpatientMedicalExaminationRecordAction>(modelAction.InpatientMedicalExaminationRecordModelActionTypes.DELETE_ALL_INPATIENT_MEDICAL_EXAMINATION_RECORD),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.InpatientMedicalExaminationRecordActionOK(
						modelAction.InpatientMedicalExaminationRecordModelActionTypes.DELETE_ALL_INPATIENT_MEDICAL_EXAMINATION_RECORD_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InpatientMedicalExaminationRecordActionFail(
								modelAction.InpatientMedicalExaminationRecordModelActionTypes.DELETE_ALL_INPATIENT_MEDICAL_EXAMINATION_RECORD_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InpatientMedicalExaminationRecordAction>(modelAction.InpatientMedicalExaminationRecordModelActionTypes.EXPORT_INPATIENT_MEDICAL_EXAMINATION_RECORD),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.InpatientMedicalExaminationRecordActionOK(
						modelAction.InpatientMedicalExaminationRecordModelActionTypes.EXPORT_INPATIENT_MEDICAL_EXAMINATION_RECORD,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InpatientMedicalExaminationRecordAction>(modelAction.InpatientMedicalExaminationRecordModelActionTypes.EXPORT_ALL_INPATIENT_MEDICAL_EXAMINATION_RECORD),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.InpatientMedicalExaminationRecordActionOK(
						modelAction.InpatientMedicalExaminationRecordModelActionTypes.EXPORT_ALL_INPATIENT_MEDICAL_EXAMINATION_RECORD_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InpatientMedicalExaminationRecordActionFail(
								modelAction.InpatientMedicalExaminationRecordModelActionTypes.EXPORT_ALL_INPATIENT_MEDICAL_EXAMINATION_RECORD_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InpatientMedicalExaminationRecordAction>(modelAction.InpatientMedicalExaminationRecordModelActionTypes.EXPORT_INPATIENT_MEDICAL_EXAMINATION_RECORD_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.InpatientMedicalExaminationRecordActionOK(
						modelAction.InpatientMedicalExaminationRecordModelActionTypes.EXPORT_INPATIENT_MEDICAL_EXAMINATION_RECORD_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InpatientMedicalExaminationRecordActionFail(
								modelAction.InpatientMedicalExaminationRecordModelActionTypes.EXPORT_INPATIENT_MEDICAL_EXAMINATION_RECORD_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InpatientMedicalExaminationRecordAction>(modelAction.InpatientMedicalExaminationRecordModelActionTypes.IMPORT_INPATIENT_MEDICAL_EXAMINATION_RECORDS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.InpatientMedicalExaminationRecordActionOK(
						modelAction.InpatientMedicalExaminationRecordModelActionTypes.IMPORT_INPATIENT_MEDICAL_EXAMINATION_RECORDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InpatientMedicalExaminationRecordActionFail(
								modelAction.InpatientMedicalExaminationRecordModelActionTypes.IMPORT_INPATIENT_MEDICAL_EXAMINATION_RECORDS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InpatientMedicalExaminationRecordAction>(modelAction.InpatientMedicalExaminationRecordModelActionTypes.FETCH_INPATIENT_MEDICAL_EXAMINATION_RECORD_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.InpatientMedicalExaminationRecordActionOK(
						modelAction.InpatientMedicalExaminationRecordModelActionTypes.FETCH_INPATIENT_MEDICAL_EXAMINATION_RECORD_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.InpatientMedicalExaminationRecordActionFail(
								modelAction.InpatientMedicalExaminationRecordModelActionTypes.FETCH_INPATIENT_MEDICAL_EXAMINATION_RECORD_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InpatientMedicalExaminationRecordAction>(modelAction.InpatientMedicalExaminationRecordModelActionTypes.FETCH_INPATIENT_MEDICAL_EXAMINATION_RECORD_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.InpatientMedicalExaminationRecordActionOK(
						modelAction.InpatientMedicalExaminationRecordModelActionTypes.FETCH_INPATIENT_MEDICAL_EXAMINATION_RECORD_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.InpatientMedicalExaminationRecordActionFail(
								modelAction.InpatientMedicalExaminationRecordModelActionTypes.FETCH_INPATIENT_MEDICAL_EXAMINATION_RECORD_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
