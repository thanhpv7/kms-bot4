...
/**
 * CatalogueNonMedicalCollectionState would store the state of a collection of CatalogueNonMedical
 */
export interface CatalogueNonMedicalCollectionState extends CollectionState {
 ...
 */
export interface CatalogueNonMedicalModelAudit extends AbstractModelAudit<CatalogueNonMedicalModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * CatalogueNonMedicalModelState would store the state of the model
 */
export interface CatalogueNonMedicalModelState {
	collectionState: {
		[key: string]: CatalogueNonMedicalCollectionState;
	};
	data: {
		[id: string]: CatalogueNonMedicalModel;
	};
	totalCount: number;
	audits: CatalogueNonMedicalModelAudit[];
 ...
 */
export const initialCatalogueNonMedicalCollectionState: CatalogueNonMedicalCollectionState = {
...
/**
 * The initial state of CatalogueNonMedicalModelState
 */
export const initialState: CatalogueNonMedicalModelState = {
	collectionState: {
