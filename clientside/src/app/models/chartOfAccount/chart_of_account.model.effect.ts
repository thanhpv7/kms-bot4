...
import * as modelAction from './chart_of_account.model.action';
import {ChartOfAccountService} from '../../services/chartOfAccount/chart_of_account.service';
...
/**
 * Effect class used for side effects related to Chart of Account model.
 */
@Injectable()
export class ChartOfAccountEffect {
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ChartOfAccountAction>(modelAction.ChartOfAccountModelActionTypes.COUNT_CHART_OF_ACCOUNTS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.ChartOfAccountActionOK(
						modelAction.ChartOfAccountModelActionTypes.COUNT_CHART_OF_ACCOUNTS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ChartOfAccountActionFail(
								modelAction.ChartOfAccountModelActionTypes.COUNT_CHART_OF_ACCOUNTS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ChartOfAccountAction>(modelAction.ChartOfAccountModelActionTypes.FETCH_CHART_OF_ACCOUNT),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ChartOfAccountActionOK(
						modelAction.ChartOfAccountModelActionTypes.FETCH_CHART_OF_ACCOUNT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ChartOfAccountActionFail(
								modelAction.ChartOfAccountModelActionTypes.FETCH_CHART_OF_ACCOUNT_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ChartOfAccountAction>(modelAction.ChartOfAccountModelActionTypes.FETCH_ALL_CHART_OF_ACCOUNT),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.ChartOfAccountActionOK(
						modelAction.ChartOfAccountModelActionTypes.FETCH_ALL_CHART_OF_ACCOUNT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ChartOfAccountActionFail(
								modelAction.ChartOfAccountModelActionTypes.FETCH_ALL_CHART_OF_ACCOUNT_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ChartOfAccountAction>(modelAction.ChartOfAccountModelActionTypes.FETCH_CHART_OF_ACCOUNT_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.ChartOfAccountActionOK(
						modelAction.ChartOfAccountModelActionTypes.FETCH_CHART_OF_ACCOUNT_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ChartOfAccountActionFail(
								modelAction.ChartOfAccountModelActionTypes.FETCH_CHART_OF_ACCOUNT_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ChartOfAccountAction>(modelAction.ChartOfAccountModelActionTypes.FETCH_LAST_CHART_OF_ACCOUNT_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.ChartOfAccountActionOK(
						modelAction.ChartOfAccountModelActionTypes.FETCH_LAST_CHART_OF_ACCOUNT_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ChartOfAccountActionFail(
								modelAction.ChartOfAccountModelActionTypes.FETCH_LAST_CHART_OF_ACCOUNT_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ChartOfAccountAction>(modelAction.ChartOfAccountModelActionTypes.CREATE_CHART_OF_ACCOUNT),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as ChartOfAccountModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ChartOfAccountActionOK(
						modelAction.ChartOfAccountModelActionTypes.CREATE_CHART_OF_ACCOUNT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ChartOfAccountActionFail(
								modelAction.ChartOfAccountModelActionTypes.CREATE_CHART_OF_ACCOUNT_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ChartOfAccountAction>(modelAction.ChartOfAccountModelActionTypes.CREATE_ALL_CHART_OF_ACCOUNT),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as ChartOfAccountModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ChartOfAccountActionOK(
						modelAction.ChartOfAccountModelActionTypes.CREATE_ALL_CHART_OF_ACCOUNT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ChartOfAccountActionFail(
								modelAction.ChartOfAccountModelActionTypes.CREATE_ALL_CHART_OF_ACCOUNT_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ChartOfAccountAction>(modelAction.ChartOfAccountModelActionTypes.UPDATE_CHART_OF_ACCOUNT),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as ChartOfAccountModel;
				...
				return this.service.update(new ChartOfAccountModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.ChartOfAccountActionOK(
						modelAction.ChartOfAccountModelActionTypes.UPDATE_CHART_OF_ACCOUNT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ChartOfAccountActionFail(
								modelAction.ChartOfAccountModelActionTypes.UPDATE_CHART_OF_ACCOUNT_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ChartOfAccountAction>(modelAction.ChartOfAccountModelActionTypes.UPDATE_ALL_CHART_OF_ACCOUNT),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as ChartOfAccountModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new ChartOfAccountModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.ChartOfAccountActionOK(
						modelAction.ChartOfAccountModelActionTypes.UPDATE_ALL_CHART_OF_ACCOUNT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ChartOfAccountActionFail(
								modelAction.ChartOfAccountModelActionTypes.UPDATE_ALL_CHART_OF_ACCOUNT_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ChartOfAccountAction>(modelAction.ChartOfAccountModelActionTypes.DELETE_CHART_OF_ACCOUNT),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.ChartOfAccountActionOK(
						modelAction.ChartOfAccountModelActionTypes.DELETE_CHART_OF_ACCOUNT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ChartOfAccountActionFail(
								modelAction.ChartOfAccountModelActionTypes.DELETE_CHART_OF_ACCOUNT_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ChartOfAccountAction>(modelAction.ChartOfAccountModelActionTypes.DELETE_CHART_OF_ACCOUNT_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.ChartOfAccountActionOK(
						modelAction.ChartOfAccountModelActionTypes.DELETE_CHART_OF_ACCOUNT_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ChartOfAccountActionFail(
								modelAction.ChartOfAccountModelActionTypes.DELETE_CHART_OF_ACCOUNT_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ChartOfAccountAction>(modelAction.ChartOfAccountModelActionTypes.DELETE_ALL_CHART_OF_ACCOUNT),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.ChartOfAccountActionOK(
						modelAction.ChartOfAccountModelActionTypes.DELETE_ALL_CHART_OF_ACCOUNT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ChartOfAccountActionFail(
								modelAction.ChartOfAccountModelActionTypes.DELETE_ALL_CHART_OF_ACCOUNT_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ChartOfAccountAction>(modelAction.ChartOfAccountModelActionTypes.EXPORT_CHART_OF_ACCOUNT),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ChartOfAccountActionOK(
						modelAction.ChartOfAccountModelActionTypes.EXPORT_CHART_OF_ACCOUNT,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ChartOfAccountAction>(modelAction.ChartOfAccountModelActionTypes.EXPORT_ALL_CHART_OF_ACCOUNT),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ChartOfAccountActionOK(
						modelAction.ChartOfAccountModelActionTypes.EXPORT_ALL_CHART_OF_ACCOUNT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ChartOfAccountActionFail(
								modelAction.ChartOfAccountModelActionTypes.EXPORT_ALL_CHART_OF_ACCOUNT_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ChartOfAccountAction>(modelAction.ChartOfAccountModelActionTypes.EXPORT_CHART_OF_ACCOUNT_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.ChartOfAccountActionOK(
						modelAction.ChartOfAccountModelActionTypes.EXPORT_CHART_OF_ACCOUNT_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ChartOfAccountActionFail(
								modelAction.ChartOfAccountModelActionTypes.EXPORT_CHART_OF_ACCOUNT_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ChartOfAccountAction>(modelAction.ChartOfAccountModelActionTypes.IMPORT_CHART_OF_ACCOUNTS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.ChartOfAccountActionOK(
						modelAction.ChartOfAccountModelActionTypes.IMPORT_CHART_OF_ACCOUNTS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.ChartOfAccountActionFail(
								modelAction.ChartOfAccountModelActionTypes.IMPORT_CHART_OF_ACCOUNTS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ChartOfAccountAction>(modelAction.ChartOfAccountModelActionTypes.FETCH_CHART_OF_ACCOUNT_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.ChartOfAccountActionOK(
						modelAction.ChartOfAccountModelActionTypes.FETCH_CHART_OF_ACCOUNT_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.ChartOfAccountActionFail(
								modelAction.ChartOfAccountModelActionTypes.FETCH_CHART_OF_ACCOUNT_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.ChartOfAccountAction>(modelAction.ChartOfAccountModelActionTypes.FETCH_CHART_OF_ACCOUNT_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.ChartOfAccountActionOK(
						modelAction.ChartOfAccountModelActionTypes.FETCH_CHART_OF_ACCOUNT_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.ChartOfAccountActionFail(
								modelAction.ChartOfAccountModelActionTypes.FETCH_CHART_OF_ACCOUNT_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
