...
/**
 * ChartOfAccountCollectionState would store the state of a collection of ChartOfAccount
 */
export interface ChartOfAccountCollectionState extends CollectionState {
 ...
 */
export interface ChartOfAccountModelAudit extends AbstractModelAudit<ChartOfAccountModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * ChartOfAccountModelState would store the state of the model
 */
export interface ChartOfAccountModelState {
	collectionState: {
		[key: string]: ChartOfAccountCollectionState;
	};
	data: {
		[id: string]: ChartOfAccountModel;
	};
	totalCount: number;
	audits: ChartOfAccountModelAudit[];
 ...
 */
export const initialChartOfAccountCollectionState: ChartOfAccountCollectionState = {
...
/**
 * The initial state of ChartOfAccountModelState
 */
export const initialState: ChartOfAccountModelState = {
	collectionState: {
