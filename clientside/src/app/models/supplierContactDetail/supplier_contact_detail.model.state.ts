...
/**
 * SupplierContactDetailCollectionState would store the state of a collection of SupplierContactDetail
 */
export interface SupplierContactDetailCollectionState extends CollectionState {
 ...
 */
export interface SupplierContactDetailModelAudit extends AbstractModelAudit<SupplierContactDetailModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * SupplierContactDetailModelState would store the state of the model
 */
export interface SupplierContactDetailModelState {
	collectionState: {
		[key: string]: SupplierContactDetailCollectionState;
	};
	data: {
		[id: string]: SupplierContactDetailModel;
	};
	totalCount: number;
	audits: SupplierContactDetailModelAudit[];
 ...
 */
export const initialSupplierContactDetailCollectionState: SupplierContactDetailCollectionState = {
...
/**
 * The initial state of SupplierContactDetailModelState
 */
export const initialState: SupplierContactDetailModelState = {
	collectionState: {
