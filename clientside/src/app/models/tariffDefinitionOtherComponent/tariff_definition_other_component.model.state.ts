...
/**
 * TariffDefinitionOtherComponentCollectionState would store the state of a collection of TariffDefinitionOtherComponent
 */
export interface TariffDefinitionOtherComponentCollectionState extends CollectionState {
 ...
 */
export interface TariffDefinitionOtherComponentModelAudit extends AbstractModelAudit<TariffDefinitionOtherComponentModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * TariffDefinitionOtherComponentModelState would store the state of the model
 */
export interface TariffDefinitionOtherComponentModelState {
	collectionState: {
		[key: string]: TariffDefinitionOtherComponentCollectionState;
	};
	data: {
		[id: string]: TariffDefinitionOtherComponentModel;
	};
	totalCount: number;
	audits: TariffDefinitionOtherComponentModelAudit[];
 ...
 */
export const initialTariffDefinitionOtherComponentCollectionState: TariffDefinitionOtherComponentCollectionState = {
...
/**
 * The initial state of TariffDefinitionOtherComponentModelState
 */
export const initialState: TariffDefinitionOtherComponentModelState = {
	collectionState: {
