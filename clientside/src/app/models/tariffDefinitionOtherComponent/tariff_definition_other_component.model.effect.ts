...
import * as modelAction from './tariff_definition_other_component.model.action';
import {TariffDefinitionOtherComponentService} from '../../services/tariffDefinitionOtherComponent/tariff_definition_other_component.service';
...
/**
 * Effect class used for side effects related to Tariff Definition Other Component model.
 */
@Injectable()
export class TariffDefinitionOtherComponentEffect {
	...
	constructor(
		...
		protected readonly service: TariffDefinitionOtherComponentService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffDefinitionOtherComponentAction>(modelAction.TariffDefinitionOtherComponentModelActionTypes.COUNT_TARIFF_DEFINITION_OTHER_COMPONENTS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.TariffDefinitionOtherComponentActionOK(
						modelAction.TariffDefinitionOtherComponentModelActionTypes.COUNT_TARIFF_DEFINITION_OTHER_COMPONENTS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffDefinitionOtherComponentActionFail(
								modelAction.TariffDefinitionOtherComponentModelActionTypes.COUNT_TARIFF_DEFINITION_OTHER_COMPONENTS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffDefinitionOtherComponentAction>(modelAction.TariffDefinitionOtherComponentModelActionTypes.FETCH_TARIFF_DEFINITION_OTHER_COMPONENT),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.TariffDefinitionOtherComponentActionOK(
						modelAction.TariffDefinitionOtherComponentModelActionTypes.FETCH_TARIFF_DEFINITION_OTHER_COMPONENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffDefinitionOtherComponentActionFail(
								modelAction.TariffDefinitionOtherComponentModelActionTypes.FETCH_TARIFF_DEFINITION_OTHER_COMPONENT_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffDefinitionOtherComponentAction>(modelAction.TariffDefinitionOtherComponentModelActionTypes.FETCH_ALL_TARIFF_DEFINITION_OTHER_COMPONENT),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.TariffDefinitionOtherComponentActionOK(
						modelAction.TariffDefinitionOtherComponentModelActionTypes.FETCH_ALL_TARIFF_DEFINITION_OTHER_COMPONENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffDefinitionOtherComponentActionFail(
								modelAction.TariffDefinitionOtherComponentModelActionTypes.FETCH_ALL_TARIFF_DEFINITION_OTHER_COMPONENT_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffDefinitionOtherComponentAction>(modelAction.TariffDefinitionOtherComponentModelActionTypes.FETCH_TARIFF_DEFINITION_OTHER_COMPONENT_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.TariffDefinitionOtherComponentActionOK(
						modelAction.TariffDefinitionOtherComponentModelActionTypes.FETCH_TARIFF_DEFINITION_OTHER_COMPONENT_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffDefinitionOtherComponentActionFail(
								modelAction.TariffDefinitionOtherComponentModelActionTypes.FETCH_TARIFF_DEFINITION_OTHER_COMPONENT_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffDefinitionOtherComponentAction>(modelAction.TariffDefinitionOtherComponentModelActionTypes.FETCH_LAST_TARIFF_DEFINITION_OTHER_COMPONENT_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.TariffDefinitionOtherComponentActionOK(
						modelAction.TariffDefinitionOtherComponentModelActionTypes.FETCH_LAST_TARIFF_DEFINITION_OTHER_COMPONENT_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffDefinitionOtherComponentActionFail(
								modelAction.TariffDefinitionOtherComponentModelActionTypes.FETCH_LAST_TARIFF_DEFINITION_OTHER_COMPONENT_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffDefinitionOtherComponentAction>(modelAction.TariffDefinitionOtherComponentModelActionTypes.CREATE_TARIFF_DEFINITION_OTHER_COMPONENT),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as TariffDefinitionOtherComponentModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.TariffDefinitionOtherComponentActionOK(
						modelAction.TariffDefinitionOtherComponentModelActionTypes.CREATE_TARIFF_DEFINITION_OTHER_COMPONENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffDefinitionOtherComponentActionFail(
								modelAction.TariffDefinitionOtherComponentModelActionTypes.CREATE_TARIFF_DEFINITION_OTHER_COMPONENT_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffDefinitionOtherComponentAction>(modelAction.TariffDefinitionOtherComponentModelActionTypes.CREATE_ALL_TARIFF_DEFINITION_OTHER_COMPONENT),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as TariffDefinitionOtherComponentModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.TariffDefinitionOtherComponentActionOK(
						modelAction.TariffDefinitionOtherComponentModelActionTypes.CREATE_ALL_TARIFF_DEFINITION_OTHER_COMPONENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffDefinitionOtherComponentActionFail(
								modelAction.TariffDefinitionOtherComponentModelActionTypes.CREATE_ALL_TARIFF_DEFINITION_OTHER_COMPONENT_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffDefinitionOtherComponentAction>(modelAction.TariffDefinitionOtherComponentModelActionTypes.UPDATE_TARIFF_DEFINITION_OTHER_COMPONENT),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as TariffDefinitionOtherComponentModel;
				...
				return this.service.update(new TariffDefinitionOtherComponentModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.TariffDefinitionOtherComponentActionOK(
						modelAction.TariffDefinitionOtherComponentModelActionTypes.UPDATE_TARIFF_DEFINITION_OTHER_COMPONENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffDefinitionOtherComponentActionFail(
								modelAction.TariffDefinitionOtherComponentModelActionTypes.UPDATE_TARIFF_DEFINITION_OTHER_COMPONENT_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffDefinitionOtherComponentAction>(modelAction.TariffDefinitionOtherComponentModelActionTypes.UPDATE_ALL_TARIFF_DEFINITION_OTHER_COMPONENT),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as TariffDefinitionOtherComponentModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new TariffDefinitionOtherComponentModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.TariffDefinitionOtherComponentActionOK(
						modelAction.TariffDefinitionOtherComponentModelActionTypes.UPDATE_ALL_TARIFF_DEFINITION_OTHER_COMPONENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffDefinitionOtherComponentActionFail(
								modelAction.TariffDefinitionOtherComponentModelActionTypes.UPDATE_ALL_TARIFF_DEFINITION_OTHER_COMPONENT_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffDefinitionOtherComponentAction>(modelAction.TariffDefinitionOtherComponentModelActionTypes.DELETE_TARIFF_DEFINITION_OTHER_COMPONENT),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.TariffDefinitionOtherComponentActionOK(
						modelAction.TariffDefinitionOtherComponentModelActionTypes.DELETE_TARIFF_DEFINITION_OTHER_COMPONENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffDefinitionOtherComponentActionFail(
								modelAction.TariffDefinitionOtherComponentModelActionTypes.DELETE_TARIFF_DEFINITION_OTHER_COMPONENT_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffDefinitionOtherComponentAction>(modelAction.TariffDefinitionOtherComponentModelActionTypes.DELETE_TARIFF_DEFINITION_OTHER_COMPONENT_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.TariffDefinitionOtherComponentActionOK(
						modelAction.TariffDefinitionOtherComponentModelActionTypes.DELETE_TARIFF_DEFINITION_OTHER_COMPONENT_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffDefinitionOtherComponentActionFail(
								modelAction.TariffDefinitionOtherComponentModelActionTypes.DELETE_TARIFF_DEFINITION_OTHER_COMPONENT_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffDefinitionOtherComponentAction>(modelAction.TariffDefinitionOtherComponentModelActionTypes.DELETE_ALL_TARIFF_DEFINITION_OTHER_COMPONENT),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.TariffDefinitionOtherComponentActionOK(
						modelAction.TariffDefinitionOtherComponentModelActionTypes.DELETE_ALL_TARIFF_DEFINITION_OTHER_COMPONENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffDefinitionOtherComponentActionFail(
								modelAction.TariffDefinitionOtherComponentModelActionTypes.DELETE_ALL_TARIFF_DEFINITION_OTHER_COMPONENT_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffDefinitionOtherComponentAction>(modelAction.TariffDefinitionOtherComponentModelActionTypes.EXPORT_TARIFF_DEFINITION_OTHER_COMPONENT),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.TariffDefinitionOtherComponentActionOK(
						modelAction.TariffDefinitionOtherComponentModelActionTypes.EXPORT_TARIFF_DEFINITION_OTHER_COMPONENT,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffDefinitionOtherComponentAction>(modelAction.TariffDefinitionOtherComponentModelActionTypes.EXPORT_ALL_TARIFF_DEFINITION_OTHER_COMPONENT),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.TariffDefinitionOtherComponentActionOK(
						modelAction.TariffDefinitionOtherComponentModelActionTypes.EXPORT_ALL_TARIFF_DEFINITION_OTHER_COMPONENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffDefinitionOtherComponentActionFail(
								modelAction.TariffDefinitionOtherComponentModelActionTypes.EXPORT_ALL_TARIFF_DEFINITION_OTHER_COMPONENT_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffDefinitionOtherComponentAction>(modelAction.TariffDefinitionOtherComponentModelActionTypes.EXPORT_TARIFF_DEFINITION_OTHER_COMPONENT_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.TariffDefinitionOtherComponentActionOK(
						modelAction.TariffDefinitionOtherComponentModelActionTypes.EXPORT_TARIFF_DEFINITION_OTHER_COMPONENT_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffDefinitionOtherComponentActionFail(
								modelAction.TariffDefinitionOtherComponentModelActionTypes.EXPORT_TARIFF_DEFINITION_OTHER_COMPONENT_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffDefinitionOtherComponentAction>(modelAction.TariffDefinitionOtherComponentModelActionTypes.IMPORT_TARIFF_DEFINITION_OTHER_COMPONENTS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.TariffDefinitionOtherComponentActionOK(
						modelAction.TariffDefinitionOtherComponentModelActionTypes.IMPORT_TARIFF_DEFINITION_OTHER_COMPONENTS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.TariffDefinitionOtherComponentActionFail(
								modelAction.TariffDefinitionOtherComponentModelActionTypes.IMPORT_TARIFF_DEFINITION_OTHER_COMPONENTS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffDefinitionOtherComponentAction>(modelAction.TariffDefinitionOtherComponentModelActionTypes.FETCH_TARIFF_DEFINITION_OTHER_COMPONENT_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.TariffDefinitionOtherComponentActionOK(
						modelAction.TariffDefinitionOtherComponentModelActionTypes.FETCH_TARIFF_DEFINITION_OTHER_COMPONENT_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.TariffDefinitionOtherComponentActionFail(
								modelAction.TariffDefinitionOtherComponentModelActionTypes.FETCH_TARIFF_DEFINITION_OTHER_COMPONENT_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.TariffDefinitionOtherComponentAction>(modelAction.TariffDefinitionOtherComponentModelActionTypes.FETCH_TARIFF_DEFINITION_OTHER_COMPONENT_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.TariffDefinitionOtherComponentActionOK(
						modelAction.TariffDefinitionOtherComponentModelActionTypes.FETCH_TARIFF_DEFINITION_OTHER_COMPONENT_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.TariffDefinitionOtherComponentActionFail(
								modelAction.TariffDefinitionOtherComponentModelActionTypes.FETCH_TARIFF_DEFINITION_OTHER_COMPONENT_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
