...
import * as modelAction from './compound_prescription_item.model.action';
import {CompoundPrescriptionItemService} from '../../services/compoundPrescriptionItem/compound_prescription_item.service';
...
/**
 * Effect class used for side effects related to Compound Prescription Item model.
 */
@Injectable()
export class CompoundPrescriptionItemEffect {
	...
	constructor(
		...
		protected readonly service: CompoundPrescriptionItemService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CompoundPrescriptionItemAction>(modelAction.CompoundPrescriptionItemModelActionTypes.COUNT_COMPOUND_PRESCRIPTION_ITEMS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.CompoundPrescriptionItemActionOK(
						modelAction.CompoundPrescriptionItemModelActionTypes.COUNT_COMPOUND_PRESCRIPTION_ITEMS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CompoundPrescriptionItemActionFail(
								modelAction.CompoundPrescriptionItemModelActionTypes.COUNT_COMPOUND_PRESCRIPTION_ITEMS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CompoundPrescriptionItemAction>(modelAction.CompoundPrescriptionItemModelActionTypes.FETCH_COMPOUND_PRESCRIPTION_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.CompoundPrescriptionItemActionOK(
						modelAction.CompoundPrescriptionItemModelActionTypes.FETCH_COMPOUND_PRESCRIPTION_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CompoundPrescriptionItemActionFail(
								modelAction.CompoundPrescriptionItemModelActionTypes.FETCH_COMPOUND_PRESCRIPTION_ITEM_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CompoundPrescriptionItemAction>(modelAction.CompoundPrescriptionItemModelActionTypes.FETCH_ALL_COMPOUND_PRESCRIPTION_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.CompoundPrescriptionItemActionOK(
						modelAction.CompoundPrescriptionItemModelActionTypes.FETCH_ALL_COMPOUND_PRESCRIPTION_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CompoundPrescriptionItemActionFail(
								modelAction.CompoundPrescriptionItemModelActionTypes.FETCH_ALL_COMPOUND_PRESCRIPTION_ITEM_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CompoundPrescriptionItemAction>(modelAction.CompoundPrescriptionItemModelActionTypes.FETCH_COMPOUND_PRESCRIPTION_ITEM_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.CompoundPrescriptionItemActionOK(
						modelAction.CompoundPrescriptionItemModelActionTypes.FETCH_COMPOUND_PRESCRIPTION_ITEM_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CompoundPrescriptionItemActionFail(
								modelAction.CompoundPrescriptionItemModelActionTypes.FETCH_COMPOUND_PRESCRIPTION_ITEM_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CompoundPrescriptionItemAction>(modelAction.CompoundPrescriptionItemModelActionTypes.FETCH_LAST_COMPOUND_PRESCRIPTION_ITEM_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.CompoundPrescriptionItemActionOK(
						modelAction.CompoundPrescriptionItemModelActionTypes.FETCH_LAST_COMPOUND_PRESCRIPTION_ITEM_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CompoundPrescriptionItemActionFail(
								modelAction.CompoundPrescriptionItemModelActionTypes.FETCH_LAST_COMPOUND_PRESCRIPTION_ITEM_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CompoundPrescriptionItemAction>(modelAction.CompoundPrescriptionItemModelActionTypes.CREATE_COMPOUND_PRESCRIPTION_ITEM),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as CompoundPrescriptionItemModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.CompoundPrescriptionItemActionOK(
						modelAction.CompoundPrescriptionItemModelActionTypes.CREATE_COMPOUND_PRESCRIPTION_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CompoundPrescriptionItemActionFail(
								modelAction.CompoundPrescriptionItemModelActionTypes.CREATE_COMPOUND_PRESCRIPTION_ITEM_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CompoundPrescriptionItemAction>(modelAction.CompoundPrescriptionItemModelActionTypes.CREATE_ALL_COMPOUND_PRESCRIPTION_ITEM),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as CompoundPrescriptionItemModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.CompoundPrescriptionItemActionOK(
						modelAction.CompoundPrescriptionItemModelActionTypes.CREATE_ALL_COMPOUND_PRESCRIPTION_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CompoundPrescriptionItemActionFail(
								modelAction.CompoundPrescriptionItemModelActionTypes.CREATE_ALL_COMPOUND_PRESCRIPTION_ITEM_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CompoundPrescriptionItemAction>(modelAction.CompoundPrescriptionItemModelActionTypes.UPDATE_COMPOUND_PRESCRIPTION_ITEM),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as CompoundPrescriptionItemModel;
				...
				return this.service.update(new CompoundPrescriptionItemModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.CompoundPrescriptionItemActionOK(
						modelAction.CompoundPrescriptionItemModelActionTypes.UPDATE_COMPOUND_PRESCRIPTION_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CompoundPrescriptionItemActionFail(
								modelAction.CompoundPrescriptionItemModelActionTypes.UPDATE_COMPOUND_PRESCRIPTION_ITEM_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CompoundPrescriptionItemAction>(modelAction.CompoundPrescriptionItemModelActionTypes.UPDATE_ALL_COMPOUND_PRESCRIPTION_ITEM),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as CompoundPrescriptionItemModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new CompoundPrescriptionItemModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.CompoundPrescriptionItemActionOK(
						modelAction.CompoundPrescriptionItemModelActionTypes.UPDATE_ALL_COMPOUND_PRESCRIPTION_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CompoundPrescriptionItemActionFail(
								modelAction.CompoundPrescriptionItemModelActionTypes.UPDATE_ALL_COMPOUND_PRESCRIPTION_ITEM_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CompoundPrescriptionItemAction>(modelAction.CompoundPrescriptionItemModelActionTypes.DELETE_COMPOUND_PRESCRIPTION_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.CompoundPrescriptionItemActionOK(
						modelAction.CompoundPrescriptionItemModelActionTypes.DELETE_COMPOUND_PRESCRIPTION_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CompoundPrescriptionItemActionFail(
								modelAction.CompoundPrescriptionItemModelActionTypes.DELETE_COMPOUND_PRESCRIPTION_ITEM_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CompoundPrescriptionItemAction>(modelAction.CompoundPrescriptionItemModelActionTypes.DELETE_COMPOUND_PRESCRIPTION_ITEM_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.CompoundPrescriptionItemActionOK(
						modelAction.CompoundPrescriptionItemModelActionTypes.DELETE_COMPOUND_PRESCRIPTION_ITEM_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CompoundPrescriptionItemActionFail(
								modelAction.CompoundPrescriptionItemModelActionTypes.DELETE_COMPOUND_PRESCRIPTION_ITEM_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CompoundPrescriptionItemAction>(modelAction.CompoundPrescriptionItemModelActionTypes.DELETE_ALL_COMPOUND_PRESCRIPTION_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.CompoundPrescriptionItemActionOK(
						modelAction.CompoundPrescriptionItemModelActionTypes.DELETE_ALL_COMPOUND_PRESCRIPTION_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CompoundPrescriptionItemActionFail(
								modelAction.CompoundPrescriptionItemModelActionTypes.DELETE_ALL_COMPOUND_PRESCRIPTION_ITEM_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CompoundPrescriptionItemAction>(modelAction.CompoundPrescriptionItemModelActionTypes.EXPORT_COMPOUND_PRESCRIPTION_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.CompoundPrescriptionItemActionOK(
						modelAction.CompoundPrescriptionItemModelActionTypes.EXPORT_COMPOUND_PRESCRIPTION_ITEM,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CompoundPrescriptionItemAction>(modelAction.CompoundPrescriptionItemModelActionTypes.EXPORT_ALL_COMPOUND_PRESCRIPTION_ITEM),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.CompoundPrescriptionItemActionOK(
						modelAction.CompoundPrescriptionItemModelActionTypes.EXPORT_ALL_COMPOUND_PRESCRIPTION_ITEM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CompoundPrescriptionItemActionFail(
								modelAction.CompoundPrescriptionItemModelActionTypes.EXPORT_ALL_COMPOUND_PRESCRIPTION_ITEM_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CompoundPrescriptionItemAction>(modelAction.CompoundPrescriptionItemModelActionTypes.EXPORT_COMPOUND_PRESCRIPTION_ITEM_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.CompoundPrescriptionItemActionOK(
						modelAction.CompoundPrescriptionItemModelActionTypes.EXPORT_COMPOUND_PRESCRIPTION_ITEM_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CompoundPrescriptionItemActionFail(
								modelAction.CompoundPrescriptionItemModelActionTypes.EXPORT_COMPOUND_PRESCRIPTION_ITEM_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CompoundPrescriptionItemAction>(modelAction.CompoundPrescriptionItemModelActionTypes.IMPORT_COMPOUND_PRESCRIPTION_ITEMS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.CompoundPrescriptionItemActionOK(
						modelAction.CompoundPrescriptionItemModelActionTypes.IMPORT_COMPOUND_PRESCRIPTION_ITEMS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CompoundPrescriptionItemActionFail(
								modelAction.CompoundPrescriptionItemModelActionTypes.IMPORT_COMPOUND_PRESCRIPTION_ITEMS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CompoundPrescriptionItemAction>(modelAction.CompoundPrescriptionItemModelActionTypes.FETCH_COMPOUND_PRESCRIPTION_ITEM_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.CompoundPrescriptionItemActionOK(
						modelAction.CompoundPrescriptionItemModelActionTypes.FETCH_COMPOUND_PRESCRIPTION_ITEM_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.CompoundPrescriptionItemActionFail(
								modelAction.CompoundPrescriptionItemModelActionTypes.FETCH_COMPOUND_PRESCRIPTION_ITEM_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CompoundPrescriptionItemAction>(modelAction.CompoundPrescriptionItemModelActionTypes.FETCH_COMPOUND_PRESCRIPTION_ITEM_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.CompoundPrescriptionItemActionOK(
						modelAction.CompoundPrescriptionItemModelActionTypes.FETCH_COMPOUND_PRESCRIPTION_ITEM_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.CompoundPrescriptionItemActionFail(
								modelAction.CompoundPrescriptionItemModelActionTypes.FETCH_COMPOUND_PRESCRIPTION_ITEM_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
