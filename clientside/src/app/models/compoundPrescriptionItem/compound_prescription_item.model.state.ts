...
/**
 * CompoundPrescriptionItemCollectionState would store the state of a collection of CompoundPrescriptionItem
 */
export interface CompoundPrescriptionItemCollectionState extends CollectionState {
 ...
 */
export interface CompoundPrescriptionItemModelAudit extends AbstractModelAudit<CompoundPrescriptionItemModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * CompoundPrescriptionItemModelState would store the state of the model
 */
export interface CompoundPrescriptionItemModelState {
	collectionState: {
		[key: string]: CompoundPrescriptionItemCollectionState;
	};
	data: {
		[id: string]: CompoundPrescriptionItemModel;
	};
	totalCount: number;
	audits: CompoundPrescriptionItemModelAudit[];
 ...
 */
export const initialCompoundPrescriptionItemCollectionState: CompoundPrescriptionItemCollectionState = {
...
/**
 * The initial state of CompoundPrescriptionItemModelState
 */
export const initialState: CompoundPrescriptionItemModelState = {
	collectionState: {
