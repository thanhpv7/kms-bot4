...
import * as modelAction from './bpjs_treatment_class_mapping.model.action';
import {BpjsTreatmentClassMappingService} from '../../services/bpjsTreatmentClassMapping/bpjs_treatment_class_mapping.service';
...
/**
 * Effect class used for side effects related to BPJS Treatment Class Mapping model.
 */
@Injectable()
export class BpjsTreatmentClassMappingEffect {
	...
	constructor(
		...
		protected readonly service: BpjsTreatmentClassMappingService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentClassMappingAction>(modelAction.BpjsTreatmentClassMappingModelActionTypes.COUNT_BPJS_TREATMENT_CLASS_MAPPINGS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsTreatmentClassMappingActionOK(
						modelAction.BpjsTreatmentClassMappingModelActionTypes.COUNT_BPJS_TREATMENT_CLASS_MAPPINGS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentClassMappingActionFail(
								modelAction.BpjsTreatmentClassMappingModelActionTypes.COUNT_BPJS_TREATMENT_CLASS_MAPPINGS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentClassMappingAction>(modelAction.BpjsTreatmentClassMappingModelActionTypes.FETCH_BPJS_TREATMENT_CLASS_MAPPING),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsTreatmentClassMappingActionOK(
						modelAction.BpjsTreatmentClassMappingModelActionTypes.FETCH_BPJS_TREATMENT_CLASS_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentClassMappingActionFail(
								modelAction.BpjsTreatmentClassMappingModelActionTypes.FETCH_BPJS_TREATMENT_CLASS_MAPPING_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentClassMappingAction>(modelAction.BpjsTreatmentClassMappingModelActionTypes.FETCH_ALL_BPJS_TREATMENT_CLASS_MAPPING),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsTreatmentClassMappingActionOK(
						modelAction.BpjsTreatmentClassMappingModelActionTypes.FETCH_ALL_BPJS_TREATMENT_CLASS_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentClassMappingActionFail(
								modelAction.BpjsTreatmentClassMappingModelActionTypes.FETCH_ALL_BPJS_TREATMENT_CLASS_MAPPING_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentClassMappingAction>(modelAction.BpjsTreatmentClassMappingModelActionTypes.FETCH_BPJS_TREATMENT_CLASS_MAPPING_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsTreatmentClassMappingActionOK(
						modelAction.BpjsTreatmentClassMappingModelActionTypes.FETCH_BPJS_TREATMENT_CLASS_MAPPING_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentClassMappingActionFail(
								modelAction.BpjsTreatmentClassMappingModelActionTypes.FETCH_BPJS_TREATMENT_CLASS_MAPPING_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentClassMappingAction>(modelAction.BpjsTreatmentClassMappingModelActionTypes.FETCH_LAST_BPJS_TREATMENT_CLASS_MAPPING_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsTreatmentClassMappingActionOK(
						modelAction.BpjsTreatmentClassMappingModelActionTypes.FETCH_LAST_BPJS_TREATMENT_CLASS_MAPPING_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentClassMappingActionFail(
								modelAction.BpjsTreatmentClassMappingModelActionTypes.FETCH_LAST_BPJS_TREATMENT_CLASS_MAPPING_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentClassMappingAction>(modelAction.BpjsTreatmentClassMappingModelActionTypes.CREATE_BPJS_TREATMENT_CLASS_MAPPING),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsTreatmentClassMappingModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsTreatmentClassMappingActionOK(
						modelAction.BpjsTreatmentClassMappingModelActionTypes.CREATE_BPJS_TREATMENT_CLASS_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentClassMappingActionFail(
								modelAction.BpjsTreatmentClassMappingModelActionTypes.CREATE_BPJS_TREATMENT_CLASS_MAPPING_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentClassMappingAction>(modelAction.BpjsTreatmentClassMappingModelActionTypes.CREATE_ALL_BPJS_TREATMENT_CLASS_MAPPING),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsTreatmentClassMappingModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsTreatmentClassMappingActionOK(
						modelAction.BpjsTreatmentClassMappingModelActionTypes.CREATE_ALL_BPJS_TREATMENT_CLASS_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentClassMappingActionFail(
								modelAction.BpjsTreatmentClassMappingModelActionTypes.CREATE_ALL_BPJS_TREATMENT_CLASS_MAPPING_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentClassMappingAction>(modelAction.BpjsTreatmentClassMappingModelActionTypes.UPDATE_BPJS_TREATMENT_CLASS_MAPPING),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsTreatmentClassMappingModel;
				...
				return this.service.update(new BpjsTreatmentClassMappingModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsTreatmentClassMappingActionOK(
						modelAction.BpjsTreatmentClassMappingModelActionTypes.UPDATE_BPJS_TREATMENT_CLASS_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentClassMappingActionFail(
								modelAction.BpjsTreatmentClassMappingModelActionTypes.UPDATE_BPJS_TREATMENT_CLASS_MAPPING_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentClassMappingAction>(modelAction.BpjsTreatmentClassMappingModelActionTypes.UPDATE_ALL_BPJS_TREATMENT_CLASS_MAPPING),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsTreatmentClassMappingModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsTreatmentClassMappingModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsTreatmentClassMappingActionOK(
						modelAction.BpjsTreatmentClassMappingModelActionTypes.UPDATE_ALL_BPJS_TREATMENT_CLASS_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentClassMappingActionFail(
								modelAction.BpjsTreatmentClassMappingModelActionTypes.UPDATE_ALL_BPJS_TREATMENT_CLASS_MAPPING_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentClassMappingAction>(modelAction.BpjsTreatmentClassMappingModelActionTypes.DELETE_BPJS_TREATMENT_CLASS_MAPPING),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsTreatmentClassMappingActionOK(
						modelAction.BpjsTreatmentClassMappingModelActionTypes.DELETE_BPJS_TREATMENT_CLASS_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentClassMappingActionFail(
								modelAction.BpjsTreatmentClassMappingModelActionTypes.DELETE_BPJS_TREATMENT_CLASS_MAPPING_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentClassMappingAction>(modelAction.BpjsTreatmentClassMappingModelActionTypes.DELETE_BPJS_TREATMENT_CLASS_MAPPING_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsTreatmentClassMappingActionOK(
						modelAction.BpjsTreatmentClassMappingModelActionTypes.DELETE_BPJS_TREATMENT_CLASS_MAPPING_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentClassMappingActionFail(
								modelAction.BpjsTreatmentClassMappingModelActionTypes.DELETE_BPJS_TREATMENT_CLASS_MAPPING_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentClassMappingAction>(modelAction.BpjsTreatmentClassMappingModelActionTypes.DELETE_ALL_BPJS_TREATMENT_CLASS_MAPPING),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsTreatmentClassMappingActionOK(
						modelAction.BpjsTreatmentClassMappingModelActionTypes.DELETE_ALL_BPJS_TREATMENT_CLASS_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentClassMappingActionFail(
								modelAction.BpjsTreatmentClassMappingModelActionTypes.DELETE_ALL_BPJS_TREATMENT_CLASS_MAPPING_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentClassMappingAction>(modelAction.BpjsTreatmentClassMappingModelActionTypes.EXPORT_BPJS_TREATMENT_CLASS_MAPPING),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsTreatmentClassMappingActionOK(
						modelAction.BpjsTreatmentClassMappingModelActionTypes.EXPORT_BPJS_TREATMENT_CLASS_MAPPING,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentClassMappingAction>(modelAction.BpjsTreatmentClassMappingModelActionTypes.EXPORT_ALL_BPJS_TREATMENT_CLASS_MAPPING),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsTreatmentClassMappingActionOK(
						modelAction.BpjsTreatmentClassMappingModelActionTypes.EXPORT_ALL_BPJS_TREATMENT_CLASS_MAPPING_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentClassMappingActionFail(
								modelAction.BpjsTreatmentClassMappingModelActionTypes.EXPORT_ALL_BPJS_TREATMENT_CLASS_MAPPING_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentClassMappingAction>(modelAction.BpjsTreatmentClassMappingModelActionTypes.EXPORT_BPJS_TREATMENT_CLASS_MAPPING_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsTreatmentClassMappingActionOK(
						modelAction.BpjsTreatmentClassMappingModelActionTypes.EXPORT_BPJS_TREATMENT_CLASS_MAPPING_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentClassMappingActionFail(
								modelAction.BpjsTreatmentClassMappingModelActionTypes.EXPORT_BPJS_TREATMENT_CLASS_MAPPING_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentClassMappingAction>(modelAction.BpjsTreatmentClassMappingModelActionTypes.IMPORT_BPJS_TREATMENT_CLASS_MAPPINGS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsTreatmentClassMappingActionOK(
						modelAction.BpjsTreatmentClassMappingModelActionTypes.IMPORT_BPJS_TREATMENT_CLASS_MAPPINGS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentClassMappingActionFail(
								modelAction.BpjsTreatmentClassMappingModelActionTypes.IMPORT_BPJS_TREATMENT_CLASS_MAPPINGS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentClassMappingAction>(modelAction.BpjsTreatmentClassMappingModelActionTypes.FETCH_BPJS_TREATMENT_CLASS_MAPPING_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsTreatmentClassMappingActionOK(
						modelAction.BpjsTreatmentClassMappingModelActionTypes.FETCH_BPJS_TREATMENT_CLASS_MAPPING_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentClassMappingActionFail(
								modelAction.BpjsTreatmentClassMappingModelActionTypes.FETCH_BPJS_TREATMENT_CLASS_MAPPING_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsTreatmentClassMappingAction>(modelAction.BpjsTreatmentClassMappingModelActionTypes.FETCH_BPJS_TREATMENT_CLASS_MAPPING_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsTreatmentClassMappingActionOK(
						modelAction.BpjsTreatmentClassMappingModelActionTypes.FETCH_BPJS_TREATMENT_CLASS_MAPPING_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsTreatmentClassMappingActionFail(
								modelAction.BpjsTreatmentClassMappingModelActionTypes.FETCH_BPJS_TREATMENT_CLASS_MAPPING_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
