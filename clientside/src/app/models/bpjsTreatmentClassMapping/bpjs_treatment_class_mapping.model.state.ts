...
/**
 * BpjsTreatmentClassMappingCollectionState would store the state of a collection of BpjsTreatmentClassMapping
 */
export interface BpjsTreatmentClassMappingCollectionState extends CollectionState {
 ...
 */
export interface BpjsTreatmentClassMappingModelAudit extends AbstractModelAudit<BpjsTreatmentClassMappingModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsTreatmentClassMappingModelState would store the state of the model
 */
export interface BpjsTreatmentClassMappingModelState {
	collectionState: {
		[key: string]: BpjsTreatmentClassMappingCollectionState;
	};
	data: {
		[id: string]: BpjsTreatmentClassMappingModel;
	};
	totalCount: number;
	audits: BpjsTreatmentClassMappingModelAudit[];
 ...
 */
export const initialBpjsTreatmentClassMappingCollectionState: BpjsTreatmentClassMappingCollectionState = {
...
/**
 * The initial state of BpjsTreatmentClassMappingModelState
 */
export const initialState: BpjsTreatmentClassMappingModelState = {
	collectionState: {
