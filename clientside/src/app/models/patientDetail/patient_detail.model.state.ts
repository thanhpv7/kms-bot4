...
/**
 * PatientDetailCollectionState would store the state of a collection of PatientDetail
 */
export interface PatientDetailCollectionState extends CollectionState {
 ...
 */
export interface PatientDetailModelAudit extends AbstractModelAudit<PatientDetailModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * PatientDetailModelState would store the state of the model
 */
export interface PatientDetailModelState {
	collectionState: {
		[key: string]: PatientDetailCollectionState;
	};
	data: {
		[id: string]: PatientDetailModel;
	};
	totalCount: number;
	audits: PatientDetailModelAudit[];
 ...
 */
export const initialPatientDetailCollectionState: PatientDetailCollectionState = {
...
/**
 * The initial state of PatientDetailModelState
 */
export const initialState: PatientDetailModelState = {
	collectionState: {
