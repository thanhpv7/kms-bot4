...
/**
 * PatientEmergencyContactDetailCollectionState would store the state of a collection of PatientEmergencyContactDetail
 */
export interface PatientEmergencyContactDetailCollectionState extends CollectionState {
 ...
 */
export interface PatientEmergencyContactDetailModelAudit extends AbstractModelAudit<PatientEmergencyContactDetailModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * PatientEmergencyContactDetailModelState would store the state of the model
 */
export interface PatientEmergencyContactDetailModelState {
	collectionState: {
		[key: string]: PatientEmergencyContactDetailCollectionState;
	};
	data: {
		[id: string]: PatientEmergencyContactDetailModel;
	};
	totalCount: number;
	audits: PatientEmergencyContactDetailModelAudit[];
 ...
 */
export const initialPatientEmergencyContactDetailCollectionState: PatientEmergencyContactDetailCollectionState = {
...
/**
 * The initial state of PatientEmergencyContactDetailModelState
 */
export const initialState: PatientEmergencyContactDetailModelState = {
	collectionState: {
