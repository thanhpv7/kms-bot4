...
import * as modelAction from './patient_emergency_contact_detail.model.action';
import {PatientEmergencyContactDetailService} from '../../services/patientEmergencyContactDetail/patient_emergency_contact_detail.service';
...
/**
 * Effect class used for side effects related to Patient Emergency Contact Detail model.
 */
@Injectable()
export class PatientEmergencyContactDetailEffect {
	...
	constructor(
		...
		protected readonly service: PatientEmergencyContactDetailService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientEmergencyContactDetailAction>(modelAction.PatientEmergencyContactDetailModelActionTypes.COUNT_PATIENT_EMERGENCY_CONTACT_DETAILS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.PatientEmergencyContactDetailActionOK(
						modelAction.PatientEmergencyContactDetailModelActionTypes.COUNT_PATIENT_EMERGENCY_CONTACT_DETAILS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientEmergencyContactDetailActionFail(
								modelAction.PatientEmergencyContactDetailModelActionTypes.COUNT_PATIENT_EMERGENCY_CONTACT_DETAILS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientEmergencyContactDetailAction>(modelAction.PatientEmergencyContactDetailModelActionTypes.FETCH_PATIENT_EMERGENCY_CONTACT_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientEmergencyContactDetailActionOK(
						modelAction.PatientEmergencyContactDetailModelActionTypes.FETCH_PATIENT_EMERGENCY_CONTACT_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientEmergencyContactDetailActionFail(
								modelAction.PatientEmergencyContactDetailModelActionTypes.FETCH_PATIENT_EMERGENCY_CONTACT_DETAIL_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientEmergencyContactDetailAction>(modelAction.PatientEmergencyContactDetailModelActionTypes.FETCH_ALL_PATIENT_EMERGENCY_CONTACT_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.PatientEmergencyContactDetailActionOK(
						modelAction.PatientEmergencyContactDetailModelActionTypes.FETCH_ALL_PATIENT_EMERGENCY_CONTACT_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientEmergencyContactDetailActionFail(
								modelAction.PatientEmergencyContactDetailModelActionTypes.FETCH_ALL_PATIENT_EMERGENCY_CONTACT_DETAIL_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientEmergencyContactDetailAction>(modelAction.PatientEmergencyContactDetailModelActionTypes.FETCH_PATIENT_EMERGENCY_CONTACT_DETAIL_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientEmergencyContactDetailActionOK(
						modelAction.PatientEmergencyContactDetailModelActionTypes.FETCH_PATIENT_EMERGENCY_CONTACT_DETAIL_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientEmergencyContactDetailActionFail(
								modelAction.PatientEmergencyContactDetailModelActionTypes.FETCH_PATIENT_EMERGENCY_CONTACT_DETAIL_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientEmergencyContactDetailAction>(modelAction.PatientEmergencyContactDetailModelActionTypes.FETCH_LAST_PATIENT_EMERGENCY_CONTACT_DETAIL_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientEmergencyContactDetailActionOK(
						modelAction.PatientEmergencyContactDetailModelActionTypes.FETCH_LAST_PATIENT_EMERGENCY_CONTACT_DETAIL_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientEmergencyContactDetailActionFail(
								modelAction.PatientEmergencyContactDetailModelActionTypes.FETCH_LAST_PATIENT_EMERGENCY_CONTACT_DETAIL_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientEmergencyContactDetailAction>(modelAction.PatientEmergencyContactDetailModelActionTypes.CREATE_PATIENT_EMERGENCY_CONTACT_DETAIL),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as PatientEmergencyContactDetailModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientEmergencyContactDetailActionOK(
						modelAction.PatientEmergencyContactDetailModelActionTypes.CREATE_PATIENT_EMERGENCY_CONTACT_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientEmergencyContactDetailActionFail(
								modelAction.PatientEmergencyContactDetailModelActionTypes.CREATE_PATIENT_EMERGENCY_CONTACT_DETAIL_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientEmergencyContactDetailAction>(modelAction.PatientEmergencyContactDetailModelActionTypes.CREATE_ALL_PATIENT_EMERGENCY_CONTACT_DETAIL),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as PatientEmergencyContactDetailModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientEmergencyContactDetailActionOK(
						modelAction.PatientEmergencyContactDetailModelActionTypes.CREATE_ALL_PATIENT_EMERGENCY_CONTACT_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientEmergencyContactDetailActionFail(
								modelAction.PatientEmergencyContactDetailModelActionTypes.CREATE_ALL_PATIENT_EMERGENCY_CONTACT_DETAIL_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientEmergencyContactDetailAction>(modelAction.PatientEmergencyContactDetailModelActionTypes.UPDATE_PATIENT_EMERGENCY_CONTACT_DETAIL),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as PatientEmergencyContactDetailModel;
				...
				return this.service.update(new PatientEmergencyContactDetailModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientEmergencyContactDetailActionOK(
						modelAction.PatientEmergencyContactDetailModelActionTypes.UPDATE_PATIENT_EMERGENCY_CONTACT_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientEmergencyContactDetailActionFail(
								modelAction.PatientEmergencyContactDetailModelActionTypes.UPDATE_PATIENT_EMERGENCY_CONTACT_DETAIL_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientEmergencyContactDetailAction>(modelAction.PatientEmergencyContactDetailModelActionTypes.UPDATE_ALL_PATIENT_EMERGENCY_CONTACT_DETAIL),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as PatientEmergencyContactDetailModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new PatientEmergencyContactDetailModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientEmergencyContactDetailActionOK(
						modelAction.PatientEmergencyContactDetailModelActionTypes.UPDATE_ALL_PATIENT_EMERGENCY_CONTACT_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientEmergencyContactDetailActionFail(
								modelAction.PatientEmergencyContactDetailModelActionTypes.UPDATE_ALL_PATIENT_EMERGENCY_CONTACT_DETAIL_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientEmergencyContactDetailAction>(modelAction.PatientEmergencyContactDetailModelActionTypes.DELETE_PATIENT_EMERGENCY_CONTACT_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PatientEmergencyContactDetailActionOK(
						modelAction.PatientEmergencyContactDetailModelActionTypes.DELETE_PATIENT_EMERGENCY_CONTACT_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientEmergencyContactDetailActionFail(
								modelAction.PatientEmergencyContactDetailModelActionTypes.DELETE_PATIENT_EMERGENCY_CONTACT_DETAIL_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientEmergencyContactDetailAction>(modelAction.PatientEmergencyContactDetailModelActionTypes.DELETE_PATIENT_EMERGENCY_CONTACT_DETAIL_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.PatientEmergencyContactDetailActionOK(
						modelAction.PatientEmergencyContactDetailModelActionTypes.DELETE_PATIENT_EMERGENCY_CONTACT_DETAIL_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientEmergencyContactDetailActionFail(
								modelAction.PatientEmergencyContactDetailModelActionTypes.DELETE_PATIENT_EMERGENCY_CONTACT_DETAIL_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientEmergencyContactDetailAction>(modelAction.PatientEmergencyContactDetailModelActionTypes.DELETE_ALL_PATIENT_EMERGENCY_CONTACT_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PatientEmergencyContactDetailActionOK(
						modelAction.PatientEmergencyContactDetailModelActionTypes.DELETE_ALL_PATIENT_EMERGENCY_CONTACT_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientEmergencyContactDetailActionFail(
								modelAction.PatientEmergencyContactDetailModelActionTypes.DELETE_ALL_PATIENT_EMERGENCY_CONTACT_DETAIL_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientEmergencyContactDetailAction>(modelAction.PatientEmergencyContactDetailModelActionTypes.EXPORT_PATIENT_EMERGENCY_CONTACT_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PatientEmergencyContactDetailActionOK(
						modelAction.PatientEmergencyContactDetailModelActionTypes.EXPORT_PATIENT_EMERGENCY_CONTACT_DETAIL,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientEmergencyContactDetailAction>(modelAction.PatientEmergencyContactDetailModelActionTypes.EXPORT_ALL_PATIENT_EMERGENCY_CONTACT_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PatientEmergencyContactDetailActionOK(
						modelAction.PatientEmergencyContactDetailModelActionTypes.EXPORT_ALL_PATIENT_EMERGENCY_CONTACT_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientEmergencyContactDetailActionFail(
								modelAction.PatientEmergencyContactDetailModelActionTypes.EXPORT_ALL_PATIENT_EMERGENCY_CONTACT_DETAIL_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientEmergencyContactDetailAction>(modelAction.PatientEmergencyContactDetailModelActionTypes.EXPORT_PATIENT_EMERGENCY_CONTACT_DETAIL_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PatientEmergencyContactDetailActionOK(
						modelAction.PatientEmergencyContactDetailModelActionTypes.EXPORT_PATIENT_EMERGENCY_CONTACT_DETAIL_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientEmergencyContactDetailActionFail(
								modelAction.PatientEmergencyContactDetailModelActionTypes.EXPORT_PATIENT_EMERGENCY_CONTACT_DETAIL_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientEmergencyContactDetailAction>(modelAction.PatientEmergencyContactDetailModelActionTypes.IMPORT_PATIENT_EMERGENCY_CONTACT_DETAILS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.PatientEmergencyContactDetailActionOK(
						modelAction.PatientEmergencyContactDetailModelActionTypes.IMPORT_PATIENT_EMERGENCY_CONTACT_DETAILS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientEmergencyContactDetailActionFail(
								modelAction.PatientEmergencyContactDetailModelActionTypes.IMPORT_PATIENT_EMERGENCY_CONTACT_DETAILS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientEmergencyContactDetailAction>(modelAction.PatientEmergencyContactDetailModelActionTypes.FETCH_PATIENT_EMERGENCY_CONTACT_DETAIL_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.PatientEmergencyContactDetailActionOK(
						modelAction.PatientEmergencyContactDetailModelActionTypes.FETCH_PATIENT_EMERGENCY_CONTACT_DETAIL_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PatientEmergencyContactDetailActionFail(
								modelAction.PatientEmergencyContactDetailModelActionTypes.FETCH_PATIENT_EMERGENCY_CONTACT_DETAIL_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientEmergencyContactDetailAction>(modelAction.PatientEmergencyContactDetailModelActionTypes.FETCH_PATIENT_EMERGENCY_CONTACT_DETAIL_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.PatientEmergencyContactDetailActionOK(
						modelAction.PatientEmergencyContactDetailModelActionTypes.FETCH_PATIENT_EMERGENCY_CONTACT_DETAIL_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PatientEmergencyContactDetailActionFail(
								modelAction.PatientEmergencyContactDetailModelActionTypes.FETCH_PATIENT_EMERGENCY_CONTACT_DETAIL_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
