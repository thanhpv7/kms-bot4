...
/**
 * PatientSupportingDocumentCollectionState would store the state of a collection of PatientSupportingDocument
 */
export interface PatientSupportingDocumentCollectionState extends CollectionState {
 ...
 */
export interface PatientSupportingDocumentModelAudit extends AbstractModelAudit<PatientSupportingDocumentModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * PatientSupportingDocumentModelState would store the state of the model
 */
export interface PatientSupportingDocumentModelState {
	collectionState: {
		[key: string]: PatientSupportingDocumentCollectionState;
	};
	data: {
		[id: string]: PatientSupportingDocumentModel;
	};
	totalCount: number;
	audits: PatientSupportingDocumentModelAudit[];
 ...
 */
export const initialPatientSupportingDocumentCollectionState: PatientSupportingDocumentCollectionState = {
...
/**
 * The initial state of PatientSupportingDocumentModelState
 */
export const initialState: PatientSupportingDocumentModelState = {
	collectionState: {
