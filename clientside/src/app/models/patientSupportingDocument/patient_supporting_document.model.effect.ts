...
import * as modelAction from './patient_supporting_document.model.action';
import {PatientSupportingDocumentService} from '../../services/patientSupportingDocument/patient_supporting_document.service';
...
/**
 * Effect class used for side effects related to Patient Supporting Document model.
 */
@Injectable()
export class PatientSupportingDocumentEffect {
	...
	constructor(
		...
		protected readonly service: PatientSupportingDocumentService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientSupportingDocumentAction>(modelAction.PatientSupportingDocumentModelActionTypes.COUNT_PATIENT_SUPPORTING_DOCUMENTS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.PatientSupportingDocumentActionOK(
						modelAction.PatientSupportingDocumentModelActionTypes.COUNT_PATIENT_SUPPORTING_DOCUMENTS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientSupportingDocumentActionFail(
								modelAction.PatientSupportingDocumentModelActionTypes.COUNT_PATIENT_SUPPORTING_DOCUMENTS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientSupportingDocumentAction>(modelAction.PatientSupportingDocumentModelActionTypes.FETCH_PATIENT_SUPPORTING_DOCUMENT),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientSupportingDocumentActionOK(
						modelAction.PatientSupportingDocumentModelActionTypes.FETCH_PATIENT_SUPPORTING_DOCUMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientSupportingDocumentActionFail(
								modelAction.PatientSupportingDocumentModelActionTypes.FETCH_PATIENT_SUPPORTING_DOCUMENT_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientSupportingDocumentAction>(modelAction.PatientSupportingDocumentModelActionTypes.FETCH_ALL_PATIENT_SUPPORTING_DOCUMENT),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.PatientSupportingDocumentActionOK(
						modelAction.PatientSupportingDocumentModelActionTypes.FETCH_ALL_PATIENT_SUPPORTING_DOCUMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientSupportingDocumentActionFail(
								modelAction.PatientSupportingDocumentModelActionTypes.FETCH_ALL_PATIENT_SUPPORTING_DOCUMENT_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientSupportingDocumentAction>(modelAction.PatientSupportingDocumentModelActionTypes.FETCH_PATIENT_SUPPORTING_DOCUMENT_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientSupportingDocumentActionOK(
						modelAction.PatientSupportingDocumentModelActionTypes.FETCH_PATIENT_SUPPORTING_DOCUMENT_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientSupportingDocumentActionFail(
								modelAction.PatientSupportingDocumentModelActionTypes.FETCH_PATIENT_SUPPORTING_DOCUMENT_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientSupportingDocumentAction>(modelAction.PatientSupportingDocumentModelActionTypes.FETCH_LAST_PATIENT_SUPPORTING_DOCUMENT_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientSupportingDocumentActionOK(
						modelAction.PatientSupportingDocumentModelActionTypes.FETCH_LAST_PATIENT_SUPPORTING_DOCUMENT_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientSupportingDocumentActionFail(
								modelAction.PatientSupportingDocumentModelActionTypes.FETCH_LAST_PATIENT_SUPPORTING_DOCUMENT_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientSupportingDocumentAction>(modelAction.PatientSupportingDocumentModelActionTypes.CREATE_PATIENT_SUPPORTING_DOCUMENT),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as PatientSupportingDocumentModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientSupportingDocumentActionOK(
						modelAction.PatientSupportingDocumentModelActionTypes.CREATE_PATIENT_SUPPORTING_DOCUMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientSupportingDocumentActionFail(
								modelAction.PatientSupportingDocumentModelActionTypes.CREATE_PATIENT_SUPPORTING_DOCUMENT_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientSupportingDocumentAction>(modelAction.PatientSupportingDocumentModelActionTypes.CREATE_ALL_PATIENT_SUPPORTING_DOCUMENT),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as PatientSupportingDocumentModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientSupportingDocumentActionOK(
						modelAction.PatientSupportingDocumentModelActionTypes.CREATE_ALL_PATIENT_SUPPORTING_DOCUMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientSupportingDocumentActionFail(
								modelAction.PatientSupportingDocumentModelActionTypes.CREATE_ALL_PATIENT_SUPPORTING_DOCUMENT_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientSupportingDocumentAction>(modelAction.PatientSupportingDocumentModelActionTypes.UPDATE_PATIENT_SUPPORTING_DOCUMENT),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as PatientSupportingDocumentModel;
				...
				return this.service.update(new PatientSupportingDocumentModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientSupportingDocumentActionOK(
						modelAction.PatientSupportingDocumentModelActionTypes.UPDATE_PATIENT_SUPPORTING_DOCUMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientSupportingDocumentActionFail(
								modelAction.PatientSupportingDocumentModelActionTypes.UPDATE_PATIENT_SUPPORTING_DOCUMENT_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientSupportingDocumentAction>(modelAction.PatientSupportingDocumentModelActionTypes.UPDATE_ALL_PATIENT_SUPPORTING_DOCUMENT),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as PatientSupportingDocumentModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new PatientSupportingDocumentModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientSupportingDocumentActionOK(
						modelAction.PatientSupportingDocumentModelActionTypes.UPDATE_ALL_PATIENT_SUPPORTING_DOCUMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientSupportingDocumentActionFail(
								modelAction.PatientSupportingDocumentModelActionTypes.UPDATE_ALL_PATIENT_SUPPORTING_DOCUMENT_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientSupportingDocumentAction>(modelAction.PatientSupportingDocumentModelActionTypes.DELETE_PATIENT_SUPPORTING_DOCUMENT),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PatientSupportingDocumentActionOK(
						modelAction.PatientSupportingDocumentModelActionTypes.DELETE_PATIENT_SUPPORTING_DOCUMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientSupportingDocumentActionFail(
								modelAction.PatientSupportingDocumentModelActionTypes.DELETE_PATIENT_SUPPORTING_DOCUMENT_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientSupportingDocumentAction>(modelAction.PatientSupportingDocumentModelActionTypes.DELETE_PATIENT_SUPPORTING_DOCUMENT_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.PatientSupportingDocumentActionOK(
						modelAction.PatientSupportingDocumentModelActionTypes.DELETE_PATIENT_SUPPORTING_DOCUMENT_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientSupportingDocumentActionFail(
								modelAction.PatientSupportingDocumentModelActionTypes.DELETE_PATIENT_SUPPORTING_DOCUMENT_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientSupportingDocumentAction>(modelAction.PatientSupportingDocumentModelActionTypes.DELETE_ALL_PATIENT_SUPPORTING_DOCUMENT),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PatientSupportingDocumentActionOK(
						modelAction.PatientSupportingDocumentModelActionTypes.DELETE_ALL_PATIENT_SUPPORTING_DOCUMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientSupportingDocumentActionFail(
								modelAction.PatientSupportingDocumentModelActionTypes.DELETE_ALL_PATIENT_SUPPORTING_DOCUMENT_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientSupportingDocumentAction>(modelAction.PatientSupportingDocumentModelActionTypes.EXPORT_PATIENT_SUPPORTING_DOCUMENT),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PatientSupportingDocumentActionOK(
						modelAction.PatientSupportingDocumentModelActionTypes.EXPORT_PATIENT_SUPPORTING_DOCUMENT,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientSupportingDocumentAction>(modelAction.PatientSupportingDocumentModelActionTypes.EXPORT_ALL_PATIENT_SUPPORTING_DOCUMENT),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PatientSupportingDocumentActionOK(
						modelAction.PatientSupportingDocumentModelActionTypes.EXPORT_ALL_PATIENT_SUPPORTING_DOCUMENT_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientSupportingDocumentActionFail(
								modelAction.PatientSupportingDocumentModelActionTypes.EXPORT_ALL_PATIENT_SUPPORTING_DOCUMENT_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientSupportingDocumentAction>(modelAction.PatientSupportingDocumentModelActionTypes.EXPORT_PATIENT_SUPPORTING_DOCUMENT_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PatientSupportingDocumentActionOK(
						modelAction.PatientSupportingDocumentModelActionTypes.EXPORT_PATIENT_SUPPORTING_DOCUMENT_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientSupportingDocumentActionFail(
								modelAction.PatientSupportingDocumentModelActionTypes.EXPORT_PATIENT_SUPPORTING_DOCUMENT_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientSupportingDocumentAction>(modelAction.PatientSupportingDocumentModelActionTypes.IMPORT_PATIENT_SUPPORTING_DOCUMENTS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.PatientSupportingDocumentActionOK(
						modelAction.PatientSupportingDocumentModelActionTypes.IMPORT_PATIENT_SUPPORTING_DOCUMENTS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientSupportingDocumentActionFail(
								modelAction.PatientSupportingDocumentModelActionTypes.IMPORT_PATIENT_SUPPORTING_DOCUMENTS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientSupportingDocumentAction>(modelAction.PatientSupportingDocumentModelActionTypes.FETCH_PATIENT_SUPPORTING_DOCUMENT_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.PatientSupportingDocumentActionOK(
						modelAction.PatientSupportingDocumentModelActionTypes.FETCH_PATIENT_SUPPORTING_DOCUMENT_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PatientSupportingDocumentActionFail(
								modelAction.PatientSupportingDocumentModelActionTypes.FETCH_PATIENT_SUPPORTING_DOCUMENT_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientSupportingDocumentAction>(modelAction.PatientSupportingDocumentModelActionTypes.FETCH_PATIENT_SUPPORTING_DOCUMENT_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.PatientSupportingDocumentActionOK(
						modelAction.PatientSupportingDocumentModelActionTypes.FETCH_PATIENT_SUPPORTING_DOCUMENT_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PatientSupportingDocumentActionFail(
								modelAction.PatientSupportingDocumentModelActionTypes.FETCH_PATIENT_SUPPORTING_DOCUMENT_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
