...
/**
 * SystemAdminUserCollectionState would store the state of a collection of SystemAdminUser
 */
export interface SystemAdminUserCollectionState extends CollectionState {
 ...
 */
export interface SystemAdminUserModelAudit extends AbstractModelAudit<SystemAdminUserModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * SystemAdminUserModelState would store the state of the model
 */
export interface SystemAdminUserModelState {
	collectionState: {
		[key: string]: SystemAdminUserCollectionState;
	};
	data: {
		[id: string]: SystemAdminUserModel;
	};
	totalCount: number;
	audits: SystemAdminUserModelAudit[];
 ...
 */
export const initialSystemAdminUserCollectionState: SystemAdminUserCollectionState = {
...
/**
 * The initial state of SystemAdminUserModelState
 */
export const initialState: SystemAdminUserModelState = {
	collectionState: {
