...
import * as modelAction from './system_admin_user.model.action';
import {SystemAdminUserService} from '../../services/systemAdminUser/system_admin_user.service';
...
/**
 * Effect class used for side effects related to System Admin User model.
 */
@Injectable()
export class SystemAdminUserEffect {
	...
	constructor(
		...
		protected readonly service: SystemAdminUserService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SystemAdminUserAction>(modelAction.SystemAdminUserModelActionTypes.COUNT_SYSTEM_ADMIN_USERS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.SystemAdminUserActionOK(
						modelAction.SystemAdminUserModelActionTypes.COUNT_SYSTEM_ADMIN_USERS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SystemAdminUserActionFail(
								modelAction.SystemAdminUserModelActionTypes.COUNT_SYSTEM_ADMIN_USERS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SystemAdminUserAction>(modelAction.SystemAdminUserModelActionTypes.FETCH_SYSTEM_ADMIN_USER),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.SystemAdminUserActionOK(
						modelAction.SystemAdminUserModelActionTypes.FETCH_SYSTEM_ADMIN_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SystemAdminUserActionFail(
								modelAction.SystemAdminUserModelActionTypes.FETCH_SYSTEM_ADMIN_USER_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SystemAdminUserAction>(modelAction.SystemAdminUserModelActionTypes.FETCH_ALL_SYSTEM_ADMIN_USER),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.SystemAdminUserActionOK(
						modelAction.SystemAdminUserModelActionTypes.FETCH_ALL_SYSTEM_ADMIN_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SystemAdminUserActionFail(
								modelAction.SystemAdminUserModelActionTypes.FETCH_ALL_SYSTEM_ADMIN_USER_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SystemAdminUserAction>(modelAction.SystemAdminUserModelActionTypes.FETCH_SYSTEM_ADMIN_USER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.SystemAdminUserActionOK(
						modelAction.SystemAdminUserModelActionTypes.FETCH_SYSTEM_ADMIN_USER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SystemAdminUserActionFail(
								modelAction.SystemAdminUserModelActionTypes.FETCH_SYSTEM_ADMIN_USER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SystemAdminUserAction>(modelAction.SystemAdminUserModelActionTypes.FETCH_LAST_SYSTEM_ADMIN_USER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.SystemAdminUserActionOK(
						modelAction.SystemAdminUserModelActionTypes.FETCH_LAST_SYSTEM_ADMIN_USER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SystemAdminUserActionFail(
								modelAction.SystemAdminUserModelActionTypes.FETCH_LAST_SYSTEM_ADMIN_USER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SystemAdminUserAction>(modelAction.SystemAdminUserModelActionTypes.CREATE_SYSTEM_ADMIN_USER),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as SystemAdminUserModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.SystemAdminUserActionOK(
						modelAction.SystemAdminUserModelActionTypes.CREATE_SYSTEM_ADMIN_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SystemAdminUserActionFail(
								modelAction.SystemAdminUserModelActionTypes.CREATE_SYSTEM_ADMIN_USER_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SystemAdminUserAction>(modelAction.SystemAdminUserModelActionTypes.CREATE_ALL_SYSTEM_ADMIN_USER),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as SystemAdminUserModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.SystemAdminUserActionOK(
						modelAction.SystemAdminUserModelActionTypes.CREATE_ALL_SYSTEM_ADMIN_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SystemAdminUserActionFail(
								modelAction.SystemAdminUserModelActionTypes.CREATE_ALL_SYSTEM_ADMIN_USER_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SystemAdminUserAction>(modelAction.SystemAdminUserModelActionTypes.UPDATE_SYSTEM_ADMIN_USER),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as SystemAdminUserModel;
				...
				return this.service.update(new SystemAdminUserModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.SystemAdminUserActionOK(
						modelAction.SystemAdminUserModelActionTypes.UPDATE_SYSTEM_ADMIN_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SystemAdminUserActionFail(
								modelAction.SystemAdminUserModelActionTypes.UPDATE_SYSTEM_ADMIN_USER_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SystemAdminUserAction>(modelAction.SystemAdminUserModelActionTypes.UPDATE_ALL_SYSTEM_ADMIN_USER),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as SystemAdminUserModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new SystemAdminUserModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.SystemAdminUserActionOK(
						modelAction.SystemAdminUserModelActionTypes.UPDATE_ALL_SYSTEM_ADMIN_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SystemAdminUserActionFail(
								modelAction.SystemAdminUserModelActionTypes.UPDATE_ALL_SYSTEM_ADMIN_USER_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SystemAdminUserAction>(modelAction.SystemAdminUserModelActionTypes.DELETE_SYSTEM_ADMIN_USER),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.SystemAdminUserActionOK(
						modelAction.SystemAdminUserModelActionTypes.DELETE_SYSTEM_ADMIN_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SystemAdminUserActionFail(
								modelAction.SystemAdminUserModelActionTypes.DELETE_SYSTEM_ADMIN_USER_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SystemAdminUserAction>(modelAction.SystemAdminUserModelActionTypes.DELETE_SYSTEM_ADMIN_USER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.SystemAdminUserActionOK(
						modelAction.SystemAdminUserModelActionTypes.DELETE_SYSTEM_ADMIN_USER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SystemAdminUserActionFail(
								modelAction.SystemAdminUserModelActionTypes.DELETE_SYSTEM_ADMIN_USER_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SystemAdminUserAction>(modelAction.SystemAdminUserModelActionTypes.DELETE_ALL_SYSTEM_ADMIN_USER),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.SystemAdminUserActionOK(
						modelAction.SystemAdminUserModelActionTypes.DELETE_ALL_SYSTEM_ADMIN_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SystemAdminUserActionFail(
								modelAction.SystemAdminUserModelActionTypes.DELETE_ALL_SYSTEM_ADMIN_USER_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SystemAdminUserAction>(modelAction.SystemAdminUserModelActionTypes.EXPORT_SYSTEM_ADMIN_USER),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.SystemAdminUserActionOK(
						modelAction.SystemAdminUserModelActionTypes.EXPORT_SYSTEM_ADMIN_USER,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SystemAdminUserAction>(modelAction.SystemAdminUserModelActionTypes.EXPORT_ALL_SYSTEM_ADMIN_USER),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.SystemAdminUserActionOK(
						modelAction.SystemAdminUserModelActionTypes.EXPORT_ALL_SYSTEM_ADMIN_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SystemAdminUserActionFail(
								modelAction.SystemAdminUserModelActionTypes.EXPORT_ALL_SYSTEM_ADMIN_USER_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SystemAdminUserAction>(modelAction.SystemAdminUserModelActionTypes.EXPORT_SYSTEM_ADMIN_USER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.SystemAdminUserActionOK(
						modelAction.SystemAdminUserModelActionTypes.EXPORT_SYSTEM_ADMIN_USER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SystemAdminUserActionFail(
								modelAction.SystemAdminUserModelActionTypes.EXPORT_SYSTEM_ADMIN_USER_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SystemAdminUserAction>(modelAction.SystemAdminUserModelActionTypes.IMPORT_SYSTEM_ADMIN_USERS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.SystemAdminUserActionOK(
						modelAction.SystemAdminUserModelActionTypes.IMPORT_SYSTEM_ADMIN_USERS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SystemAdminUserActionFail(
								modelAction.SystemAdminUserModelActionTypes.IMPORT_SYSTEM_ADMIN_USERS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SystemAdminUserAction>(modelAction.SystemAdminUserModelActionTypes.FETCH_SYSTEM_ADMIN_USER_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.SystemAdminUserActionOK(
						modelAction.SystemAdminUserModelActionTypes.FETCH_SYSTEM_ADMIN_USER_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.SystemAdminUserActionFail(
								modelAction.SystemAdminUserModelActionTypes.FETCH_SYSTEM_ADMIN_USER_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SystemAdminUserAction>(modelAction.SystemAdminUserModelActionTypes.FETCH_SYSTEM_ADMIN_USER_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.SystemAdminUserActionOK(
						modelAction.SystemAdminUserModelActionTypes.FETCH_SYSTEM_ADMIN_USER_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.SystemAdminUserActionFail(
								modelAction.SystemAdminUserModelActionTypes.FETCH_SYSTEM_ADMIN_USER_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
