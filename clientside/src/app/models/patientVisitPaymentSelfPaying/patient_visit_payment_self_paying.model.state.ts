...
/**
 * PatientVisitPaymentSelfPayingCollectionState would store the state of a collection of PatientVisitPaymentSelfPaying
 */
export interface PatientVisitPaymentSelfPayingCollectionState extends CollectionState {
 ...
 */
export interface PatientVisitPaymentSelfPayingModelAudit extends AbstractModelAudit<PatientVisitPaymentSelfPayingModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * PatientVisitPaymentSelfPayingModelState would store the state of the model
 */
export interface PatientVisitPaymentSelfPayingModelState {
	collectionState: {
		[key: string]: PatientVisitPaymentSelfPayingCollectionState;
	};
	data: {
		[id: string]: PatientVisitPaymentSelfPayingModel;
	};
	totalCount: number;
	audits: PatientVisitPaymentSelfPayingModelAudit[];
 ...
 */
export const initialPatientVisitPaymentSelfPayingCollectionState: PatientVisitPaymentSelfPayingCollectionState = {
...
/**
 * The initial state of PatientVisitPaymentSelfPayingModelState
 */
export const initialState: PatientVisitPaymentSelfPayingModelState = {
	collectionState: {
