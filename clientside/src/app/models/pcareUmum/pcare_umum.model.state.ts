...
/**
 * PcareUmumCollectionState would store the state of a collection of PcareUmum
 */
export interface PcareUmumCollectionState extends CollectionState {
 ...
 */
export interface PcareUmumModelAudit extends AbstractModelAudit<PcareUmumModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * PcareUmumModelState would store the state of the model
 */
export interface PcareUmumModelState {
	collectionState: {
		[key: string]: PcareUmumCollectionState;
	};
	data: {
		[id: string]: PcareUmumModel;
	};
	totalCount: number;
	audits: PcareUmumModelAudit[];
 ...
 */
export const initialPcareUmumCollectionState: PcareUmumCollectionState = {
...
/**
 * The initial state of PcareUmumModelState
 */
export const initialState: PcareUmumModelState = {
	collectionState: {
