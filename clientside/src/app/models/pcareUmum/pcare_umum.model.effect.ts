...
import * as modelAction from './pcare_umum.model.action';
import {PcareUmumService} from '../../services/pcareUmum/pcare_umum.service';
...
/**
 * Effect class used for side effects related to PCare Umum model.
 */
@Injectable()
export class PcareUmumEffect {
	...
	constructor(
		...
		protected readonly service: PcareUmumService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareUmumAction>(modelAction.PcareUmumModelActionTypes.COUNT_PCARE_UMUMS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.PcareUmumActionOK(
						modelAction.PcareUmumModelActionTypes.COUNT_PCARE_UMUMS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareUmumActionFail(
								modelAction.PcareUmumModelActionTypes.COUNT_PCARE_UMUMS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareUmumAction>(modelAction.PcareUmumModelActionTypes.FETCH_PCARE_UMUM),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareUmumActionOK(
						modelAction.PcareUmumModelActionTypes.FETCH_PCARE_UMUM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareUmumActionFail(
								modelAction.PcareUmumModelActionTypes.FETCH_PCARE_UMUM_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareUmumAction>(modelAction.PcareUmumModelActionTypes.FETCH_ALL_PCARE_UMUM),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.PcareUmumActionOK(
						modelAction.PcareUmumModelActionTypes.FETCH_ALL_PCARE_UMUM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareUmumActionFail(
								modelAction.PcareUmumModelActionTypes.FETCH_ALL_PCARE_UMUM_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareUmumAction>(modelAction.PcareUmumModelActionTypes.FETCH_PCARE_UMUM_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareUmumActionOK(
						modelAction.PcareUmumModelActionTypes.FETCH_PCARE_UMUM_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareUmumActionFail(
								modelAction.PcareUmumModelActionTypes.FETCH_PCARE_UMUM_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareUmumAction>(modelAction.PcareUmumModelActionTypes.FETCH_LAST_PCARE_UMUM_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareUmumActionOK(
						modelAction.PcareUmumModelActionTypes.FETCH_LAST_PCARE_UMUM_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareUmumActionFail(
								modelAction.PcareUmumModelActionTypes.FETCH_LAST_PCARE_UMUM_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareUmumAction>(modelAction.PcareUmumModelActionTypes.CREATE_PCARE_UMUM),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as PcareUmumModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareUmumActionOK(
						modelAction.PcareUmumModelActionTypes.CREATE_PCARE_UMUM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareUmumActionFail(
								modelAction.PcareUmumModelActionTypes.CREATE_PCARE_UMUM_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareUmumAction>(modelAction.PcareUmumModelActionTypes.CREATE_ALL_PCARE_UMUM),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as PcareUmumModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareUmumActionOK(
						modelAction.PcareUmumModelActionTypes.CREATE_ALL_PCARE_UMUM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareUmumActionFail(
								modelAction.PcareUmumModelActionTypes.CREATE_ALL_PCARE_UMUM_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareUmumAction>(modelAction.PcareUmumModelActionTypes.UPDATE_PCARE_UMUM),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as PcareUmumModel;
				...
				return this.service.update(new PcareUmumModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareUmumActionOK(
						modelAction.PcareUmumModelActionTypes.UPDATE_PCARE_UMUM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareUmumActionFail(
								modelAction.PcareUmumModelActionTypes.UPDATE_PCARE_UMUM_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareUmumAction>(modelAction.PcareUmumModelActionTypes.UPDATE_ALL_PCARE_UMUM),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as PcareUmumModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new PcareUmumModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareUmumActionOK(
						modelAction.PcareUmumModelActionTypes.UPDATE_ALL_PCARE_UMUM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareUmumActionFail(
								modelAction.PcareUmumModelActionTypes.UPDATE_ALL_PCARE_UMUM_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareUmumAction>(modelAction.PcareUmumModelActionTypes.DELETE_PCARE_UMUM),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PcareUmumActionOK(
						modelAction.PcareUmumModelActionTypes.DELETE_PCARE_UMUM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareUmumActionFail(
								modelAction.PcareUmumModelActionTypes.DELETE_PCARE_UMUM_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareUmumAction>(modelAction.PcareUmumModelActionTypes.DELETE_PCARE_UMUM_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.PcareUmumActionOK(
						modelAction.PcareUmumModelActionTypes.DELETE_PCARE_UMUM_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareUmumActionFail(
								modelAction.PcareUmumModelActionTypes.DELETE_PCARE_UMUM_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareUmumAction>(modelAction.PcareUmumModelActionTypes.DELETE_ALL_PCARE_UMUM),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PcareUmumActionOK(
						modelAction.PcareUmumModelActionTypes.DELETE_ALL_PCARE_UMUM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareUmumActionFail(
								modelAction.PcareUmumModelActionTypes.DELETE_ALL_PCARE_UMUM_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareUmumAction>(modelAction.PcareUmumModelActionTypes.EXPORT_PCARE_UMUM),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PcareUmumActionOK(
						modelAction.PcareUmumModelActionTypes.EXPORT_PCARE_UMUM,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareUmumAction>(modelAction.PcareUmumModelActionTypes.EXPORT_ALL_PCARE_UMUM),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PcareUmumActionOK(
						modelAction.PcareUmumModelActionTypes.EXPORT_ALL_PCARE_UMUM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareUmumActionFail(
								modelAction.PcareUmumModelActionTypes.EXPORT_ALL_PCARE_UMUM_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareUmumAction>(modelAction.PcareUmumModelActionTypes.EXPORT_PCARE_UMUM_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PcareUmumActionOK(
						modelAction.PcareUmumModelActionTypes.EXPORT_PCARE_UMUM_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareUmumActionFail(
								modelAction.PcareUmumModelActionTypes.EXPORT_PCARE_UMUM_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareUmumAction>(modelAction.PcareUmumModelActionTypes.IMPORT_PCARE_UMUMS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.PcareUmumActionOK(
						modelAction.PcareUmumModelActionTypes.IMPORT_PCARE_UMUMS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareUmumActionFail(
								modelAction.PcareUmumModelActionTypes.IMPORT_PCARE_UMUMS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareUmumAction>(modelAction.PcareUmumModelActionTypes.FETCH_PCARE_UMUM_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.PcareUmumActionOK(
						modelAction.PcareUmumModelActionTypes.FETCH_PCARE_UMUM_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PcareUmumActionFail(
								modelAction.PcareUmumModelActionTypes.FETCH_PCARE_UMUM_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareUmumAction>(modelAction.PcareUmumModelActionTypes.FETCH_PCARE_UMUM_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.PcareUmumActionOK(
						modelAction.PcareUmumModelActionTypes.FETCH_PCARE_UMUM_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PcareUmumActionFail(
								modelAction.PcareUmumModelActionTypes.FETCH_PCARE_UMUM_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
