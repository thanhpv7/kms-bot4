...
import * as modelAction from './invoice_payment_other.model.action';
import {InvoicePaymentOtherService} from '../../services/invoicePaymentOther/invoice_payment_other.service';
...
/**
 * Effect class used for side effects related to Invoice Payment Other model.
 */
@Injectable()
export class InvoicePaymentOtherEffect {
	...
	constructor(
		...
		protected readonly service: InvoicePaymentOtherService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentOtherAction>(modelAction.InvoicePaymentOtherModelActionTypes.COUNT_INVOICE_PAYMENT_OTHERS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.InvoicePaymentOtherActionOK(
						modelAction.InvoicePaymentOtherModelActionTypes.COUNT_INVOICE_PAYMENT_OTHERS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentOtherActionFail(
								modelAction.InvoicePaymentOtherModelActionTypes.COUNT_INVOICE_PAYMENT_OTHERS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentOtherAction>(modelAction.InvoicePaymentOtherModelActionTypes.FETCH_INVOICE_PAYMENT_OTHER),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InvoicePaymentOtherActionOK(
						modelAction.InvoicePaymentOtherModelActionTypes.FETCH_INVOICE_PAYMENT_OTHER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentOtherActionFail(
								modelAction.InvoicePaymentOtherModelActionTypes.FETCH_INVOICE_PAYMENT_OTHER_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentOtherAction>(modelAction.InvoicePaymentOtherModelActionTypes.FETCH_ALL_INVOICE_PAYMENT_OTHER),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.InvoicePaymentOtherActionOK(
						modelAction.InvoicePaymentOtherModelActionTypes.FETCH_ALL_INVOICE_PAYMENT_OTHER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentOtherActionFail(
								modelAction.InvoicePaymentOtherModelActionTypes.FETCH_ALL_INVOICE_PAYMENT_OTHER_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentOtherAction>(modelAction.InvoicePaymentOtherModelActionTypes.FETCH_INVOICE_PAYMENT_OTHER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.InvoicePaymentOtherActionOK(
						modelAction.InvoicePaymentOtherModelActionTypes.FETCH_INVOICE_PAYMENT_OTHER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentOtherActionFail(
								modelAction.InvoicePaymentOtherModelActionTypes.FETCH_INVOICE_PAYMENT_OTHER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentOtherAction>(modelAction.InvoicePaymentOtherModelActionTypes.FETCH_LAST_INVOICE_PAYMENT_OTHER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.InvoicePaymentOtherActionOK(
						modelAction.InvoicePaymentOtherModelActionTypes.FETCH_LAST_INVOICE_PAYMENT_OTHER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentOtherActionFail(
								modelAction.InvoicePaymentOtherModelActionTypes.FETCH_LAST_INVOICE_PAYMENT_OTHER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentOtherAction>(modelAction.InvoicePaymentOtherModelActionTypes.CREATE_INVOICE_PAYMENT_OTHER),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as InvoicePaymentOtherModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InvoicePaymentOtherActionOK(
						modelAction.InvoicePaymentOtherModelActionTypes.CREATE_INVOICE_PAYMENT_OTHER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentOtherActionFail(
								modelAction.InvoicePaymentOtherModelActionTypes.CREATE_INVOICE_PAYMENT_OTHER_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentOtherAction>(modelAction.InvoicePaymentOtherModelActionTypes.CREATE_ALL_INVOICE_PAYMENT_OTHER),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as InvoicePaymentOtherModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InvoicePaymentOtherActionOK(
						modelAction.InvoicePaymentOtherModelActionTypes.CREATE_ALL_INVOICE_PAYMENT_OTHER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentOtherActionFail(
								modelAction.InvoicePaymentOtherModelActionTypes.CREATE_ALL_INVOICE_PAYMENT_OTHER_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentOtherAction>(modelAction.InvoicePaymentOtherModelActionTypes.UPDATE_INVOICE_PAYMENT_OTHER),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as InvoicePaymentOtherModel;
				...
				return this.service.update(new InvoicePaymentOtherModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.InvoicePaymentOtherActionOK(
						modelAction.InvoicePaymentOtherModelActionTypes.UPDATE_INVOICE_PAYMENT_OTHER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentOtherActionFail(
								modelAction.InvoicePaymentOtherModelActionTypes.UPDATE_INVOICE_PAYMENT_OTHER_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentOtherAction>(modelAction.InvoicePaymentOtherModelActionTypes.UPDATE_ALL_INVOICE_PAYMENT_OTHER),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as InvoicePaymentOtherModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new InvoicePaymentOtherModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.InvoicePaymentOtherActionOK(
						modelAction.InvoicePaymentOtherModelActionTypes.UPDATE_ALL_INVOICE_PAYMENT_OTHER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentOtherActionFail(
								modelAction.InvoicePaymentOtherModelActionTypes.UPDATE_ALL_INVOICE_PAYMENT_OTHER_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentOtherAction>(modelAction.InvoicePaymentOtherModelActionTypes.DELETE_INVOICE_PAYMENT_OTHER),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.InvoicePaymentOtherActionOK(
						modelAction.InvoicePaymentOtherModelActionTypes.DELETE_INVOICE_PAYMENT_OTHER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentOtherActionFail(
								modelAction.InvoicePaymentOtherModelActionTypes.DELETE_INVOICE_PAYMENT_OTHER_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentOtherAction>(modelAction.InvoicePaymentOtherModelActionTypes.DELETE_INVOICE_PAYMENT_OTHER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.InvoicePaymentOtherActionOK(
						modelAction.InvoicePaymentOtherModelActionTypes.DELETE_INVOICE_PAYMENT_OTHER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentOtherActionFail(
								modelAction.InvoicePaymentOtherModelActionTypes.DELETE_INVOICE_PAYMENT_OTHER_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentOtherAction>(modelAction.InvoicePaymentOtherModelActionTypes.DELETE_ALL_INVOICE_PAYMENT_OTHER),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.InvoicePaymentOtherActionOK(
						modelAction.InvoicePaymentOtherModelActionTypes.DELETE_ALL_INVOICE_PAYMENT_OTHER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentOtherActionFail(
								modelAction.InvoicePaymentOtherModelActionTypes.DELETE_ALL_INVOICE_PAYMENT_OTHER_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentOtherAction>(modelAction.InvoicePaymentOtherModelActionTypes.EXPORT_INVOICE_PAYMENT_OTHER),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.InvoicePaymentOtherActionOK(
						modelAction.InvoicePaymentOtherModelActionTypes.EXPORT_INVOICE_PAYMENT_OTHER,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentOtherAction>(modelAction.InvoicePaymentOtherModelActionTypes.EXPORT_ALL_INVOICE_PAYMENT_OTHER),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.InvoicePaymentOtherActionOK(
						modelAction.InvoicePaymentOtherModelActionTypes.EXPORT_ALL_INVOICE_PAYMENT_OTHER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentOtherActionFail(
								modelAction.InvoicePaymentOtherModelActionTypes.EXPORT_ALL_INVOICE_PAYMENT_OTHER_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentOtherAction>(modelAction.InvoicePaymentOtherModelActionTypes.EXPORT_INVOICE_PAYMENT_OTHER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.InvoicePaymentOtherActionOK(
						modelAction.InvoicePaymentOtherModelActionTypes.EXPORT_INVOICE_PAYMENT_OTHER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentOtherActionFail(
								modelAction.InvoicePaymentOtherModelActionTypes.EXPORT_INVOICE_PAYMENT_OTHER_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentOtherAction>(modelAction.InvoicePaymentOtherModelActionTypes.IMPORT_INVOICE_PAYMENT_OTHERS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.InvoicePaymentOtherActionOK(
						modelAction.InvoicePaymentOtherModelActionTypes.IMPORT_INVOICE_PAYMENT_OTHERS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentOtherActionFail(
								modelAction.InvoicePaymentOtherModelActionTypes.IMPORT_INVOICE_PAYMENT_OTHERS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentOtherAction>(modelAction.InvoicePaymentOtherModelActionTypes.FETCH_INVOICE_PAYMENT_OTHER_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.InvoicePaymentOtherActionOK(
						modelAction.InvoicePaymentOtherModelActionTypes.FETCH_INVOICE_PAYMENT_OTHER_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentOtherActionFail(
								modelAction.InvoicePaymentOtherModelActionTypes.FETCH_INVOICE_PAYMENT_OTHER_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.InvoicePaymentOtherAction>(modelAction.InvoicePaymentOtherModelActionTypes.FETCH_INVOICE_PAYMENT_OTHER_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.InvoicePaymentOtherActionOK(
						modelAction.InvoicePaymentOtherModelActionTypes.FETCH_INVOICE_PAYMENT_OTHER_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.InvoicePaymentOtherActionFail(
								modelAction.InvoicePaymentOtherModelActionTypes.FETCH_INVOICE_PAYMENT_OTHER_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
