...
/**
 * CompoundPrescriptionDetailCollectionState would store the state of a collection of CompoundPrescriptionDetail
 */
export interface CompoundPrescriptionDetailCollectionState extends CollectionState {
 ...
 */
export interface CompoundPrescriptionDetailModelAudit extends AbstractModelAudit<CompoundPrescriptionDetailModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * CompoundPrescriptionDetailModelState would store the state of the model
 */
export interface CompoundPrescriptionDetailModelState {
	collectionState: {
		[key: string]: CompoundPrescriptionDetailCollectionState;
	};
	data: {
		[id: string]: CompoundPrescriptionDetailModel;
	};
	totalCount: number;
	audits: CompoundPrescriptionDetailModelAudit[];
 ...
 */
export const initialCompoundPrescriptionDetailCollectionState: CompoundPrescriptionDetailCollectionState = {
...
/**
 * The initial state of CompoundPrescriptionDetailModelState
 */
export const initialState: CompoundPrescriptionDetailModelState = {
	collectionState: {
