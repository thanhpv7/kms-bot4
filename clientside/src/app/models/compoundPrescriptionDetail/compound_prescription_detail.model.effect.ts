...
import * as modelAction from './compound_prescription_detail.model.action';
import {CompoundPrescriptionDetailService} from '../../services/compoundPrescriptionDetail/compound_prescription_detail.service';
...
/**
 * Effect class used for side effects related to Compound Prescription Detail model.
 */
@Injectable()
export class CompoundPrescriptionDetailEffect {
	...
	constructor(
		...
		protected readonly service: CompoundPrescriptionDetailService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CompoundPrescriptionDetailAction>(modelAction.CompoundPrescriptionDetailModelActionTypes.COUNT_COMPOUND_PRESCRIPTION_DETAILS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.CompoundPrescriptionDetailActionOK(
						modelAction.CompoundPrescriptionDetailModelActionTypes.COUNT_COMPOUND_PRESCRIPTION_DETAILS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CompoundPrescriptionDetailActionFail(
								modelAction.CompoundPrescriptionDetailModelActionTypes.COUNT_COMPOUND_PRESCRIPTION_DETAILS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CompoundPrescriptionDetailAction>(modelAction.CompoundPrescriptionDetailModelActionTypes.FETCH_COMPOUND_PRESCRIPTION_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.CompoundPrescriptionDetailActionOK(
						modelAction.CompoundPrescriptionDetailModelActionTypes.FETCH_COMPOUND_PRESCRIPTION_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CompoundPrescriptionDetailActionFail(
								modelAction.CompoundPrescriptionDetailModelActionTypes.FETCH_COMPOUND_PRESCRIPTION_DETAIL_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CompoundPrescriptionDetailAction>(modelAction.CompoundPrescriptionDetailModelActionTypes.FETCH_ALL_COMPOUND_PRESCRIPTION_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.CompoundPrescriptionDetailActionOK(
						modelAction.CompoundPrescriptionDetailModelActionTypes.FETCH_ALL_COMPOUND_PRESCRIPTION_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CompoundPrescriptionDetailActionFail(
								modelAction.CompoundPrescriptionDetailModelActionTypes.FETCH_ALL_COMPOUND_PRESCRIPTION_DETAIL_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CompoundPrescriptionDetailAction>(modelAction.CompoundPrescriptionDetailModelActionTypes.FETCH_COMPOUND_PRESCRIPTION_DETAIL_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.CompoundPrescriptionDetailActionOK(
						modelAction.CompoundPrescriptionDetailModelActionTypes.FETCH_COMPOUND_PRESCRIPTION_DETAIL_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CompoundPrescriptionDetailActionFail(
								modelAction.CompoundPrescriptionDetailModelActionTypes.FETCH_COMPOUND_PRESCRIPTION_DETAIL_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CompoundPrescriptionDetailAction>(modelAction.CompoundPrescriptionDetailModelActionTypes.FETCH_LAST_COMPOUND_PRESCRIPTION_DETAIL_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.CompoundPrescriptionDetailActionOK(
						modelAction.CompoundPrescriptionDetailModelActionTypes.FETCH_LAST_COMPOUND_PRESCRIPTION_DETAIL_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CompoundPrescriptionDetailActionFail(
								modelAction.CompoundPrescriptionDetailModelActionTypes.FETCH_LAST_COMPOUND_PRESCRIPTION_DETAIL_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CompoundPrescriptionDetailAction>(modelAction.CompoundPrescriptionDetailModelActionTypes.CREATE_COMPOUND_PRESCRIPTION_DETAIL),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as CompoundPrescriptionDetailModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.CompoundPrescriptionDetailActionOK(
						modelAction.CompoundPrescriptionDetailModelActionTypes.CREATE_COMPOUND_PRESCRIPTION_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CompoundPrescriptionDetailActionFail(
								modelAction.CompoundPrescriptionDetailModelActionTypes.CREATE_COMPOUND_PRESCRIPTION_DETAIL_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CompoundPrescriptionDetailAction>(modelAction.CompoundPrescriptionDetailModelActionTypes.CREATE_ALL_COMPOUND_PRESCRIPTION_DETAIL),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as CompoundPrescriptionDetailModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.CompoundPrescriptionDetailActionOK(
						modelAction.CompoundPrescriptionDetailModelActionTypes.CREATE_ALL_COMPOUND_PRESCRIPTION_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CompoundPrescriptionDetailActionFail(
								modelAction.CompoundPrescriptionDetailModelActionTypes.CREATE_ALL_COMPOUND_PRESCRIPTION_DETAIL_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CompoundPrescriptionDetailAction>(modelAction.CompoundPrescriptionDetailModelActionTypes.UPDATE_COMPOUND_PRESCRIPTION_DETAIL),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as CompoundPrescriptionDetailModel;
				...
				return this.service.update(new CompoundPrescriptionDetailModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.CompoundPrescriptionDetailActionOK(
						modelAction.CompoundPrescriptionDetailModelActionTypes.UPDATE_COMPOUND_PRESCRIPTION_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CompoundPrescriptionDetailActionFail(
								modelAction.CompoundPrescriptionDetailModelActionTypes.UPDATE_COMPOUND_PRESCRIPTION_DETAIL_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CompoundPrescriptionDetailAction>(modelAction.CompoundPrescriptionDetailModelActionTypes.UPDATE_ALL_COMPOUND_PRESCRIPTION_DETAIL),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as CompoundPrescriptionDetailModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new CompoundPrescriptionDetailModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.CompoundPrescriptionDetailActionOK(
						modelAction.CompoundPrescriptionDetailModelActionTypes.UPDATE_ALL_COMPOUND_PRESCRIPTION_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CompoundPrescriptionDetailActionFail(
								modelAction.CompoundPrescriptionDetailModelActionTypes.UPDATE_ALL_COMPOUND_PRESCRIPTION_DETAIL_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CompoundPrescriptionDetailAction>(modelAction.CompoundPrescriptionDetailModelActionTypes.DELETE_COMPOUND_PRESCRIPTION_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.CompoundPrescriptionDetailActionOK(
						modelAction.CompoundPrescriptionDetailModelActionTypes.DELETE_COMPOUND_PRESCRIPTION_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CompoundPrescriptionDetailActionFail(
								modelAction.CompoundPrescriptionDetailModelActionTypes.DELETE_COMPOUND_PRESCRIPTION_DETAIL_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CompoundPrescriptionDetailAction>(modelAction.CompoundPrescriptionDetailModelActionTypes.DELETE_COMPOUND_PRESCRIPTION_DETAIL_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.CompoundPrescriptionDetailActionOK(
						modelAction.CompoundPrescriptionDetailModelActionTypes.DELETE_COMPOUND_PRESCRIPTION_DETAIL_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CompoundPrescriptionDetailActionFail(
								modelAction.CompoundPrescriptionDetailModelActionTypes.DELETE_COMPOUND_PRESCRIPTION_DETAIL_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CompoundPrescriptionDetailAction>(modelAction.CompoundPrescriptionDetailModelActionTypes.DELETE_ALL_COMPOUND_PRESCRIPTION_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.CompoundPrescriptionDetailActionOK(
						modelAction.CompoundPrescriptionDetailModelActionTypes.DELETE_ALL_COMPOUND_PRESCRIPTION_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CompoundPrescriptionDetailActionFail(
								modelAction.CompoundPrescriptionDetailModelActionTypes.DELETE_ALL_COMPOUND_PRESCRIPTION_DETAIL_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CompoundPrescriptionDetailAction>(modelAction.CompoundPrescriptionDetailModelActionTypes.EXPORT_COMPOUND_PRESCRIPTION_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.CompoundPrescriptionDetailActionOK(
						modelAction.CompoundPrescriptionDetailModelActionTypes.EXPORT_COMPOUND_PRESCRIPTION_DETAIL,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CompoundPrescriptionDetailAction>(modelAction.CompoundPrescriptionDetailModelActionTypes.EXPORT_ALL_COMPOUND_PRESCRIPTION_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.CompoundPrescriptionDetailActionOK(
						modelAction.CompoundPrescriptionDetailModelActionTypes.EXPORT_ALL_COMPOUND_PRESCRIPTION_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CompoundPrescriptionDetailActionFail(
								modelAction.CompoundPrescriptionDetailModelActionTypes.EXPORT_ALL_COMPOUND_PRESCRIPTION_DETAIL_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CompoundPrescriptionDetailAction>(modelAction.CompoundPrescriptionDetailModelActionTypes.EXPORT_COMPOUND_PRESCRIPTION_DETAIL_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.CompoundPrescriptionDetailActionOK(
						modelAction.CompoundPrescriptionDetailModelActionTypes.EXPORT_COMPOUND_PRESCRIPTION_DETAIL_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CompoundPrescriptionDetailActionFail(
								modelAction.CompoundPrescriptionDetailModelActionTypes.EXPORT_COMPOUND_PRESCRIPTION_DETAIL_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CompoundPrescriptionDetailAction>(modelAction.CompoundPrescriptionDetailModelActionTypes.IMPORT_COMPOUND_PRESCRIPTION_DETAILS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.CompoundPrescriptionDetailActionOK(
						modelAction.CompoundPrescriptionDetailModelActionTypes.IMPORT_COMPOUND_PRESCRIPTION_DETAILS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CompoundPrescriptionDetailActionFail(
								modelAction.CompoundPrescriptionDetailModelActionTypes.IMPORT_COMPOUND_PRESCRIPTION_DETAILS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CompoundPrescriptionDetailAction>(modelAction.CompoundPrescriptionDetailModelActionTypes.FETCH_COMPOUND_PRESCRIPTION_DETAIL_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.CompoundPrescriptionDetailActionOK(
						modelAction.CompoundPrescriptionDetailModelActionTypes.FETCH_COMPOUND_PRESCRIPTION_DETAIL_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.CompoundPrescriptionDetailActionFail(
								modelAction.CompoundPrescriptionDetailModelActionTypes.FETCH_COMPOUND_PRESCRIPTION_DETAIL_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CompoundPrescriptionDetailAction>(modelAction.CompoundPrescriptionDetailModelActionTypes.FETCH_COMPOUND_PRESCRIPTION_DETAIL_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.CompoundPrescriptionDetailActionOK(
						modelAction.CompoundPrescriptionDetailModelActionTypes.FETCH_COMPOUND_PRESCRIPTION_DETAIL_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.CompoundPrescriptionDetailActionFail(
								modelAction.CompoundPrescriptionDetailModelActionTypes.FETCH_COMPOUND_PRESCRIPTION_DETAIL_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
