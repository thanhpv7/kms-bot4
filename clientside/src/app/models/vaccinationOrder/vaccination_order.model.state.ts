...
/**
 * VaccinationOrderCollectionState would store the state of a collection of VaccinationOrder
 */
export interface VaccinationOrderCollectionState extends CollectionState {
 ...
 */
export interface VaccinationOrderModelAudit extends AbstractModelAudit<VaccinationOrderModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * VaccinationOrderModelState would store the state of the model
 */
export interface VaccinationOrderModelState {
	collectionState: {
		[key: string]: VaccinationOrderCollectionState;
	};
	data: {
		[id: string]: VaccinationOrderModel;
	};
	totalCount: number;
	audits: VaccinationOrderModelAudit[];
 ...
 */
export const initialVaccinationOrderCollectionState: VaccinationOrderCollectionState = {
...
/**
 * The initial state of VaccinationOrderModelState
 */
export const initialState: VaccinationOrderModelState = {
	collectionState: {
