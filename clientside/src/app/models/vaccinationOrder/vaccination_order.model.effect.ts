...
import {VaccinationOrderService} from '../../services/vaccinationOrder/vaccination_order.service';
...
/**
 * Effect class used for side effects related to Vaccination Order model.
 */
@Injectable()
export class VaccinationOrderEffect {
	...
	constructor(
		...
		protected readonly service: VaccinationOrderService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VaccinationOrderAction>(modelAction.VaccinationOrderModelActionTypes.COUNT_VACCINATION_ORDERS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.VaccinationOrderActionOK(
						modelAction.VaccinationOrderModelActionTypes.COUNT_VACCINATION_ORDERS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.VaccinationOrderActionFail(
								modelAction.VaccinationOrderModelActionTypes.COUNT_VACCINATION_ORDERS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VaccinationOrderAction>(modelAction.VaccinationOrderModelActionTypes.FETCH_VACCINATION_ORDER),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.VaccinationOrderActionOK(
						modelAction.VaccinationOrderModelActionTypes.FETCH_VACCINATION_ORDER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.VaccinationOrderActionFail(
								modelAction.VaccinationOrderModelActionTypes.FETCH_VACCINATION_ORDER_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VaccinationOrderAction>(modelAction.VaccinationOrderModelActionTypes.FETCH_ALL_VACCINATION_ORDER),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.VaccinationOrderActionOK(
						modelAction.VaccinationOrderModelActionTypes.FETCH_ALL_VACCINATION_ORDER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.VaccinationOrderActionFail(
								modelAction.VaccinationOrderModelActionTypes.FETCH_ALL_VACCINATION_ORDER_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VaccinationOrderAction>(modelAction.VaccinationOrderModelActionTypes.FETCH_VACCINATION_ORDER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.VaccinationOrderActionOK(
						modelAction.VaccinationOrderModelActionTypes.FETCH_VACCINATION_ORDER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.VaccinationOrderActionFail(
								modelAction.VaccinationOrderModelActionTypes.FETCH_VACCINATION_ORDER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VaccinationOrderAction>(modelAction.VaccinationOrderModelActionTypes.FETCH_LAST_VACCINATION_ORDER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.VaccinationOrderActionOK(
						modelAction.VaccinationOrderModelActionTypes.FETCH_LAST_VACCINATION_ORDER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.VaccinationOrderActionFail(
								modelAction.VaccinationOrderModelActionTypes.FETCH_LAST_VACCINATION_ORDER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VaccinationOrderAction>(modelAction.VaccinationOrderModelActionTypes.CREATE_VACCINATION_ORDER),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as VaccinationOrderModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.VaccinationOrderActionOK(
						modelAction.VaccinationOrderModelActionTypes.CREATE_VACCINATION_ORDER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.VaccinationOrderActionFail(
								modelAction.VaccinationOrderModelActionTypes.CREATE_VACCINATION_ORDER_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VaccinationOrderAction>(modelAction.VaccinationOrderModelActionTypes.CREATE_ALL_VACCINATION_ORDER),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as VaccinationOrderModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.VaccinationOrderActionOK(
						modelAction.VaccinationOrderModelActionTypes.CREATE_ALL_VACCINATION_ORDER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.VaccinationOrderActionFail(
								modelAction.VaccinationOrderModelActionTypes.CREATE_ALL_VACCINATION_ORDER_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VaccinationOrderAction>(modelAction.VaccinationOrderModelActionTypes.UPDATE_VACCINATION_ORDER),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as VaccinationOrderModel;
				...
				return this.service.update(new VaccinationOrderModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.VaccinationOrderActionOK(
						modelAction.VaccinationOrderModelActionTypes.UPDATE_VACCINATION_ORDER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.VaccinationOrderActionFail(
								modelAction.VaccinationOrderModelActionTypes.UPDATE_VACCINATION_ORDER_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VaccinationOrderAction>(modelAction.VaccinationOrderModelActionTypes.UPDATE_ALL_VACCINATION_ORDER),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as VaccinationOrderModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new VaccinationOrderModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.VaccinationOrderActionOK(
						modelAction.VaccinationOrderModelActionTypes.UPDATE_ALL_VACCINATION_ORDER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.VaccinationOrderActionFail(
								modelAction.VaccinationOrderModelActionTypes.UPDATE_ALL_VACCINATION_ORDER_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VaccinationOrderAction>(modelAction.VaccinationOrderModelActionTypes.DELETE_VACCINATION_ORDER),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.VaccinationOrderActionOK(
						modelAction.VaccinationOrderModelActionTypes.DELETE_VACCINATION_ORDER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.VaccinationOrderActionFail(
								modelAction.VaccinationOrderModelActionTypes.DELETE_VACCINATION_ORDER_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VaccinationOrderAction>(modelAction.VaccinationOrderModelActionTypes.DELETE_VACCINATION_ORDER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.VaccinationOrderActionOK(
						modelAction.VaccinationOrderModelActionTypes.DELETE_VACCINATION_ORDER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.VaccinationOrderActionFail(
								modelAction.VaccinationOrderModelActionTypes.DELETE_VACCINATION_ORDER_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VaccinationOrderAction>(modelAction.VaccinationOrderModelActionTypes.DELETE_ALL_VACCINATION_ORDER),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.VaccinationOrderActionOK(
						modelAction.VaccinationOrderModelActionTypes.DELETE_ALL_VACCINATION_ORDER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.VaccinationOrderActionFail(
								modelAction.VaccinationOrderModelActionTypes.DELETE_ALL_VACCINATION_ORDER_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VaccinationOrderAction>(modelAction.VaccinationOrderModelActionTypes.EXPORT_VACCINATION_ORDER),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.VaccinationOrderActionOK(
						modelAction.VaccinationOrderModelActionTypes.EXPORT_VACCINATION_ORDER,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VaccinationOrderAction>(modelAction.VaccinationOrderModelActionTypes.EXPORT_ALL_VACCINATION_ORDER),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.VaccinationOrderActionOK(
						modelAction.VaccinationOrderModelActionTypes.EXPORT_ALL_VACCINATION_ORDER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.VaccinationOrderActionFail(
								modelAction.VaccinationOrderModelActionTypes.EXPORT_ALL_VACCINATION_ORDER_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VaccinationOrderAction>(modelAction.VaccinationOrderModelActionTypes.EXPORT_VACCINATION_ORDER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.VaccinationOrderActionOK(
						modelAction.VaccinationOrderModelActionTypes.EXPORT_VACCINATION_ORDER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.VaccinationOrderActionFail(
								modelAction.VaccinationOrderModelActionTypes.EXPORT_VACCINATION_ORDER_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VaccinationOrderAction>(modelAction.VaccinationOrderModelActionTypes.IMPORT_VACCINATION_ORDERS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.VaccinationOrderActionOK(
						modelAction.VaccinationOrderModelActionTypes.IMPORT_VACCINATION_ORDERS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.VaccinationOrderActionFail(
								modelAction.VaccinationOrderModelActionTypes.IMPORT_VACCINATION_ORDERS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VaccinationOrderAction>(modelAction.VaccinationOrderModelActionTypes.FETCH_VACCINATION_ORDER_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.VaccinationOrderActionOK(
						modelAction.VaccinationOrderModelActionTypes.FETCH_VACCINATION_ORDER_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.VaccinationOrderActionFail(
								modelAction.VaccinationOrderModelActionTypes.FETCH_VACCINATION_ORDER_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.VaccinationOrderAction>(modelAction.VaccinationOrderModelActionTypes.FETCH_VACCINATION_ORDER_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.VaccinationOrderActionOK(
						modelAction.VaccinationOrderModelActionTypes.FETCH_VACCINATION_ORDER_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.VaccinationOrderActionFail(
								modelAction.VaccinationOrderModelActionTypes.FETCH_VACCINATION_ORDER_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
