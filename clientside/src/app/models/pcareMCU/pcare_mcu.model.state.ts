...
/**
 * PcareMCUCollectionState would store the state of a collection of PcareMCU
 */
export interface PcareMCUCollectionState extends CollectionState {
 ...
 */
export interface PcareMCUModelAudit extends AbstractModelAudit<PcareMCUModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * PcareMCUModelState would store the state of the model
 */
export interface PcareMCUModelState {
	collectionState: {
		[key: string]: PcareMCUCollectionState;
	};
	data: {
		[id: string]: PcareMCUModel;
	};
	totalCount: number;
	audits: PcareMCUModelAudit[];
 ...
 */
export const initialPcareMCUCollectionState: PcareMCUCollectionState = {
...
/**
 * The initial state of PcareMCUModelState
 */
export const initialState: PcareMCUModelState = {
	collectionState: {
