...
import * as modelAction from './pcare_mcu.model.action';
import {PcareMCUService} from '../../services/pcareMCU/pcare_mcu.service';
...
/**
 * Effect class used for side effects related to PCare MCU model.
 */
@Injectable()
export class PcareMCUEffect {
	...
	constructor(
		...
		protected readonly service: PcareMCUService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareMCUAction>(modelAction.PcareMCUModelActionTypes.COUNT_PCARE_MCUS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.PcareMCUActionOK(
						modelAction.PcareMCUModelActionTypes.COUNT_PCARE_MCUS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareMCUActionFail(
								modelAction.PcareMCUModelActionTypes.COUNT_PCARE_MCUS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareMCUAction>(modelAction.PcareMCUModelActionTypes.FETCH_PCARE_MCU),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareMCUActionOK(
						modelAction.PcareMCUModelActionTypes.FETCH_PCARE_MCU_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareMCUActionFail(
								modelAction.PcareMCUModelActionTypes.FETCH_PCARE_MCU_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareMCUAction>(modelAction.PcareMCUModelActionTypes.FETCH_ALL_PCARE_MCU),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.PcareMCUActionOK(
						modelAction.PcareMCUModelActionTypes.FETCH_ALL_PCARE_MCU_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareMCUActionFail(
								modelAction.PcareMCUModelActionTypes.FETCH_ALL_PCARE_MCU_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareMCUAction>(modelAction.PcareMCUModelActionTypes.FETCH_PCARE_MCU_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareMCUActionOK(
						modelAction.PcareMCUModelActionTypes.FETCH_PCARE_MCU_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareMCUActionFail(
								modelAction.PcareMCUModelActionTypes.FETCH_PCARE_MCU_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareMCUAction>(modelAction.PcareMCUModelActionTypes.FETCH_LAST_PCARE_MCU_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareMCUActionOK(
						modelAction.PcareMCUModelActionTypes.FETCH_LAST_PCARE_MCU_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareMCUActionFail(
								modelAction.PcareMCUModelActionTypes.FETCH_LAST_PCARE_MCU_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareMCUAction>(modelAction.PcareMCUModelActionTypes.CREATE_PCARE_MCU),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as PcareMCUModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareMCUActionOK(
						modelAction.PcareMCUModelActionTypes.CREATE_PCARE_MCU_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareMCUActionFail(
								modelAction.PcareMCUModelActionTypes.CREATE_PCARE_MCU_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareMCUAction>(modelAction.PcareMCUModelActionTypes.CREATE_ALL_PCARE_MCU),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as PcareMCUModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareMCUActionOK(
						modelAction.PcareMCUModelActionTypes.CREATE_ALL_PCARE_MCU_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareMCUActionFail(
								modelAction.PcareMCUModelActionTypes.CREATE_ALL_PCARE_MCU_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareMCUAction>(modelAction.PcareMCUModelActionTypes.UPDATE_PCARE_MCU),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as PcareMCUModel;
				...
				return this.service.update(new PcareMCUModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareMCUActionOK(
						modelAction.PcareMCUModelActionTypes.UPDATE_PCARE_MCU_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareMCUActionFail(
								modelAction.PcareMCUModelActionTypes.UPDATE_PCARE_MCU_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareMCUAction>(modelAction.PcareMCUModelActionTypes.UPDATE_ALL_PCARE_MCU),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as PcareMCUModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new PcareMCUModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareMCUActionOK(
						modelAction.PcareMCUModelActionTypes.UPDATE_ALL_PCARE_MCU_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareMCUActionFail(
								modelAction.PcareMCUModelActionTypes.UPDATE_ALL_PCARE_MCU_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareMCUAction>(modelAction.PcareMCUModelActionTypes.DELETE_PCARE_MCU),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PcareMCUActionOK(
						modelAction.PcareMCUModelActionTypes.DELETE_PCARE_MCU_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareMCUActionFail(
								modelAction.PcareMCUModelActionTypes.DELETE_PCARE_MCU_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareMCUAction>(modelAction.PcareMCUModelActionTypes.DELETE_PCARE_MCU_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.PcareMCUActionOK(
						modelAction.PcareMCUModelActionTypes.DELETE_PCARE_MCU_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareMCUActionFail(
								modelAction.PcareMCUModelActionTypes.DELETE_PCARE_MCU_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareMCUAction>(modelAction.PcareMCUModelActionTypes.DELETE_ALL_PCARE_MCU),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PcareMCUActionOK(
						modelAction.PcareMCUModelActionTypes.DELETE_ALL_PCARE_MCU_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareMCUActionFail(
								modelAction.PcareMCUModelActionTypes.DELETE_ALL_PCARE_MCU_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareMCUAction>(modelAction.PcareMCUModelActionTypes.EXPORT_PCARE_MCU),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PcareMCUActionOK(
						modelAction.PcareMCUModelActionTypes.EXPORT_PCARE_MCU,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareMCUAction>(modelAction.PcareMCUModelActionTypes.EXPORT_ALL_PCARE_MCU),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PcareMCUActionOK(
						modelAction.PcareMCUModelActionTypes.EXPORT_ALL_PCARE_MCU_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareMCUActionFail(
								modelAction.PcareMCUModelActionTypes.EXPORT_ALL_PCARE_MCU_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareMCUAction>(modelAction.PcareMCUModelActionTypes.EXPORT_PCARE_MCU_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PcareMCUActionOK(
						modelAction.PcareMCUModelActionTypes.EXPORT_PCARE_MCU_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareMCUActionFail(
								modelAction.PcareMCUModelActionTypes.EXPORT_PCARE_MCU_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareMCUAction>(modelAction.PcareMCUModelActionTypes.IMPORT_PCARE_MCUS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.PcareMCUActionOK(
						modelAction.PcareMCUModelActionTypes.IMPORT_PCARE_MCUS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareMCUActionFail(
								modelAction.PcareMCUModelActionTypes.IMPORT_PCARE_MCUS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareMCUAction>(modelAction.PcareMCUModelActionTypes.FETCH_PCARE_MCU_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.PcareMCUActionOK(
						modelAction.PcareMCUModelActionTypes.FETCH_PCARE_MCU_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PcareMCUActionFail(
								modelAction.PcareMCUModelActionTypes.FETCH_PCARE_MCU_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareMCUAction>(modelAction.PcareMCUModelActionTypes.FETCH_PCARE_MCU_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.PcareMCUActionOK(
						modelAction.PcareMCUModelActionTypes.FETCH_PCARE_MCU_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PcareMCUActionFail(
								modelAction.PcareMCUModelActionTypes.FETCH_PCARE_MCU_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
