...
/**
 * FormulirKonselingTesHivCollectionState would store the state of a collection of FormulirKonselingTesHiv
 */
export interface FormulirKonselingTesHivCollectionState extends CollectionState {
 ...
 */
export interface FormulirKonselingTesHivModelAudit extends AbstractModelAudit<FormulirKonselingTesHivModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * FormulirKonselingTesHivModelState would store the state of the model
 */
export interface FormulirKonselingTesHivModelState {
	collectionState: {
		[key: string]: FormulirKonselingTesHivCollectionState;
	};
	data: {
		[id: string]: FormulirKonselingTesHivModel;
	};
	totalCount: number;
	audits: FormulirKonselingTesHivModelAudit[];
 ...
 */
export const initialFormulirKonselingTesHivCollectionState: FormulirKonselingTesHivCollectionState = {
...
/**
 * The initial state of FormulirKonselingTesHivModelState
 */
export const initialState: FormulirKonselingTesHivModelState = {
	collectionState: {
