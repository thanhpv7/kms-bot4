...
import * as modelAction from './formulir_konseling_tes_hiv.model.action';
import {FormulirKonselingTesHivService} from '../../services/formulirKonselingTesHiv/formulir_konseling_tes_hiv.service';
...
/**
 * Effect class used for side effects related to Formulir Konseling Tes Hiv model.
 */
@Injectable()
export class FormulirKonselingTesHivEffect {
	...
	constructor(
		...
		protected readonly service: FormulirKonselingTesHivService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FormulirKonselingTesHivAction>(modelAction.FormulirKonselingTesHivModelActionTypes.COUNT_FORMULIR_KONSELING_TES_HIVS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.FormulirKonselingTesHivActionOK(
						modelAction.FormulirKonselingTesHivModelActionTypes.COUNT_FORMULIR_KONSELING_TES_HIVS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FormulirKonselingTesHivActionFail(
								modelAction.FormulirKonselingTesHivModelActionTypes.COUNT_FORMULIR_KONSELING_TES_HIVS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FormulirKonselingTesHivAction>(modelAction.FormulirKonselingTesHivModelActionTypes.FETCH_FORMULIR_KONSELING_TES_HIV),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.FormulirKonselingTesHivActionOK(
						modelAction.FormulirKonselingTesHivModelActionTypes.FETCH_FORMULIR_KONSELING_TES_HIV_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FormulirKonselingTesHivActionFail(
								modelAction.FormulirKonselingTesHivModelActionTypes.FETCH_FORMULIR_KONSELING_TES_HIV_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FormulirKonselingTesHivAction>(modelAction.FormulirKonselingTesHivModelActionTypes.FETCH_ALL_FORMULIR_KONSELING_TES_HIV),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.FormulirKonselingTesHivActionOK(
						modelAction.FormulirKonselingTesHivModelActionTypes.FETCH_ALL_FORMULIR_KONSELING_TES_HIV_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FormulirKonselingTesHivActionFail(
								modelAction.FormulirKonselingTesHivModelActionTypes.FETCH_ALL_FORMULIR_KONSELING_TES_HIV_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FormulirKonselingTesHivAction>(modelAction.FormulirKonselingTesHivModelActionTypes.FETCH_FORMULIR_KONSELING_TES_HIV_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.FormulirKonselingTesHivActionOK(
						modelAction.FormulirKonselingTesHivModelActionTypes.FETCH_FORMULIR_KONSELING_TES_HIV_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FormulirKonselingTesHivActionFail(
								modelAction.FormulirKonselingTesHivModelActionTypes.FETCH_FORMULIR_KONSELING_TES_HIV_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FormulirKonselingTesHivAction>(modelAction.FormulirKonselingTesHivModelActionTypes.FETCH_LAST_FORMULIR_KONSELING_TES_HIV_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.FormulirKonselingTesHivActionOK(
						modelAction.FormulirKonselingTesHivModelActionTypes.FETCH_LAST_FORMULIR_KONSELING_TES_HIV_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FormulirKonselingTesHivActionFail(
								modelAction.FormulirKonselingTesHivModelActionTypes.FETCH_LAST_FORMULIR_KONSELING_TES_HIV_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FormulirKonselingTesHivAction>(modelAction.FormulirKonselingTesHivModelActionTypes.CREATE_FORMULIR_KONSELING_TES_HIV),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as FormulirKonselingTesHivModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.FormulirKonselingTesHivActionOK(
						modelAction.FormulirKonselingTesHivModelActionTypes.CREATE_FORMULIR_KONSELING_TES_HIV_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FormulirKonselingTesHivActionFail(
								modelAction.FormulirKonselingTesHivModelActionTypes.CREATE_FORMULIR_KONSELING_TES_HIV_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FormulirKonselingTesHivAction>(modelAction.FormulirKonselingTesHivModelActionTypes.CREATE_ALL_FORMULIR_KONSELING_TES_HIV),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as FormulirKonselingTesHivModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.FormulirKonselingTesHivActionOK(
						modelAction.FormulirKonselingTesHivModelActionTypes.CREATE_ALL_FORMULIR_KONSELING_TES_HIV_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FormulirKonselingTesHivActionFail(
								modelAction.FormulirKonselingTesHivModelActionTypes.CREATE_ALL_FORMULIR_KONSELING_TES_HIV_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FormulirKonselingTesHivAction>(modelAction.FormulirKonselingTesHivModelActionTypes.UPDATE_FORMULIR_KONSELING_TES_HIV),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as FormulirKonselingTesHivModel;
				...
				return this.service.update(new FormulirKonselingTesHivModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.FormulirKonselingTesHivActionOK(
						modelAction.FormulirKonselingTesHivModelActionTypes.UPDATE_FORMULIR_KONSELING_TES_HIV_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FormulirKonselingTesHivActionFail(
								modelAction.FormulirKonselingTesHivModelActionTypes.UPDATE_FORMULIR_KONSELING_TES_HIV_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FormulirKonselingTesHivAction>(modelAction.FormulirKonselingTesHivModelActionTypes.UPDATE_ALL_FORMULIR_KONSELING_TES_HIV),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as FormulirKonselingTesHivModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new FormulirKonselingTesHivModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.FormulirKonselingTesHivActionOK(
						modelAction.FormulirKonselingTesHivModelActionTypes.UPDATE_ALL_FORMULIR_KONSELING_TES_HIV_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FormulirKonselingTesHivActionFail(
								modelAction.FormulirKonselingTesHivModelActionTypes.UPDATE_ALL_FORMULIR_KONSELING_TES_HIV_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FormulirKonselingTesHivAction>(modelAction.FormulirKonselingTesHivModelActionTypes.DELETE_FORMULIR_KONSELING_TES_HIV),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.FormulirKonselingTesHivActionOK(
						modelAction.FormulirKonselingTesHivModelActionTypes.DELETE_FORMULIR_KONSELING_TES_HIV_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FormulirKonselingTesHivActionFail(
								modelAction.FormulirKonselingTesHivModelActionTypes.DELETE_FORMULIR_KONSELING_TES_HIV_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FormulirKonselingTesHivAction>(modelAction.FormulirKonselingTesHivModelActionTypes.DELETE_FORMULIR_KONSELING_TES_HIV_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.FormulirKonselingTesHivActionOK(
						modelAction.FormulirKonselingTesHivModelActionTypes.DELETE_FORMULIR_KONSELING_TES_HIV_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FormulirKonselingTesHivActionFail(
								modelAction.FormulirKonselingTesHivModelActionTypes.DELETE_FORMULIR_KONSELING_TES_HIV_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FormulirKonselingTesHivAction>(modelAction.FormulirKonselingTesHivModelActionTypes.DELETE_ALL_FORMULIR_KONSELING_TES_HIV),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.FormulirKonselingTesHivActionOK(
						modelAction.FormulirKonselingTesHivModelActionTypes.DELETE_ALL_FORMULIR_KONSELING_TES_HIV_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FormulirKonselingTesHivActionFail(
								modelAction.FormulirKonselingTesHivModelActionTypes.DELETE_ALL_FORMULIR_KONSELING_TES_HIV_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FormulirKonselingTesHivAction>(modelAction.FormulirKonselingTesHivModelActionTypes.EXPORT_FORMULIR_KONSELING_TES_HIV),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.FormulirKonselingTesHivActionOK(
						modelAction.FormulirKonselingTesHivModelActionTypes.EXPORT_FORMULIR_KONSELING_TES_HIV,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FormulirKonselingTesHivAction>(modelAction.FormulirKonselingTesHivModelActionTypes.EXPORT_ALL_FORMULIR_KONSELING_TES_HIV),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.FormulirKonselingTesHivActionOK(
						modelAction.FormulirKonselingTesHivModelActionTypes.EXPORT_ALL_FORMULIR_KONSELING_TES_HIV_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FormulirKonselingTesHivActionFail(
								modelAction.FormulirKonselingTesHivModelActionTypes.EXPORT_ALL_FORMULIR_KONSELING_TES_HIV_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FormulirKonselingTesHivAction>(modelAction.FormulirKonselingTesHivModelActionTypes.EXPORT_FORMULIR_KONSELING_TES_HIV_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.FormulirKonselingTesHivActionOK(
						modelAction.FormulirKonselingTesHivModelActionTypes.EXPORT_FORMULIR_KONSELING_TES_HIV_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FormulirKonselingTesHivActionFail(
								modelAction.FormulirKonselingTesHivModelActionTypes.EXPORT_FORMULIR_KONSELING_TES_HIV_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FormulirKonselingTesHivAction>(modelAction.FormulirKonselingTesHivModelActionTypes.IMPORT_FORMULIR_KONSELING_TES_HIVS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.FormulirKonselingTesHivActionOK(
						modelAction.FormulirKonselingTesHivModelActionTypes.IMPORT_FORMULIR_KONSELING_TES_HIVS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FormulirKonselingTesHivActionFail(
								modelAction.FormulirKonselingTesHivModelActionTypes.IMPORT_FORMULIR_KONSELING_TES_HIVS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FormulirKonselingTesHivAction>(modelAction.FormulirKonselingTesHivModelActionTypes.FETCH_FORMULIR_KONSELING_TES_HIV_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.FormulirKonselingTesHivActionOK(
						modelAction.FormulirKonselingTesHivModelActionTypes.FETCH_FORMULIR_KONSELING_TES_HIV_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.FormulirKonselingTesHivActionFail(
								modelAction.FormulirKonselingTesHivModelActionTypes.FETCH_FORMULIR_KONSELING_TES_HIV_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FormulirKonselingTesHivAction>(modelAction.FormulirKonselingTesHivModelActionTypes.FETCH_FORMULIR_KONSELING_TES_HIV_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.FormulirKonselingTesHivActionOK(
						modelAction.FormulirKonselingTesHivModelActionTypes.FETCH_FORMULIR_KONSELING_TES_HIV_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.FormulirKonselingTesHivActionFail(
								modelAction.FormulirKonselingTesHivModelActionTypes.FETCH_FORMULIR_KONSELING_TES_HIV_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
