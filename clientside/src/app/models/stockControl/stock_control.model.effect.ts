...
import * as modelAction from './stock_control.model.action';
import {StockControlService} from '../../services/stockControl/stock_control.service';
...
/**
 * Effect class used for side effects related to Stock Control model.
 */
@Injectable()
export class StockControlEffect {
	...
	constructor(
		...
		protected readonly service: StockControlService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockControlAction>(modelAction.StockControlModelActionTypes.COUNT_STOCK_CONTROLS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.StockControlActionOK(
						modelAction.StockControlModelActionTypes.COUNT_STOCK_CONTROLS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockControlActionFail(
								modelAction.StockControlModelActionTypes.COUNT_STOCK_CONTROLS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockControlAction>(modelAction.StockControlModelActionTypes.FETCH_STOCK_CONTROL),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.StockControlActionOK(
						modelAction.StockControlModelActionTypes.FETCH_STOCK_CONTROL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockControlActionFail(
								modelAction.StockControlModelActionTypes.FETCH_STOCK_CONTROL_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockControlAction>(modelAction.StockControlModelActionTypes.FETCH_ALL_STOCK_CONTROL),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.StockControlActionOK(
						modelAction.StockControlModelActionTypes.FETCH_ALL_STOCK_CONTROL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockControlActionFail(
								modelAction.StockControlModelActionTypes.FETCH_ALL_STOCK_CONTROL_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockControlAction>(modelAction.StockControlModelActionTypes.FETCH_STOCK_CONTROL_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.StockControlActionOK(
						modelAction.StockControlModelActionTypes.FETCH_STOCK_CONTROL_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockControlActionFail(
								modelAction.StockControlModelActionTypes.FETCH_STOCK_CONTROL_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockControlAction>(modelAction.StockControlModelActionTypes.FETCH_LAST_STOCK_CONTROL_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.StockControlActionOK(
						modelAction.StockControlModelActionTypes.FETCH_LAST_STOCK_CONTROL_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockControlActionFail(
								modelAction.StockControlModelActionTypes.FETCH_LAST_STOCK_CONTROL_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockControlAction>(modelAction.StockControlModelActionTypes.CREATE_STOCK_CONTROL),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as StockControlModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.StockControlActionOK(
						modelAction.StockControlModelActionTypes.CREATE_STOCK_CONTROL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockControlActionFail(
								modelAction.StockControlModelActionTypes.CREATE_STOCK_CONTROL_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockControlAction>(modelAction.StockControlModelActionTypes.CREATE_ALL_STOCK_CONTROL),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as StockControlModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.StockControlActionOK(
						modelAction.StockControlModelActionTypes.CREATE_ALL_STOCK_CONTROL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockControlActionFail(
								modelAction.StockControlModelActionTypes.CREATE_ALL_STOCK_CONTROL_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockControlAction>(modelAction.StockControlModelActionTypes.UPDATE_STOCK_CONTROL),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as StockControlModel;
				...
				return this.service.update(new StockControlModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.StockControlActionOK(
						modelAction.StockControlModelActionTypes.UPDATE_STOCK_CONTROL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockControlActionFail(
								modelAction.StockControlModelActionTypes.UPDATE_STOCK_CONTROL_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockControlAction>(modelAction.StockControlModelActionTypes.UPDATE_ALL_STOCK_CONTROL),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as StockControlModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new StockControlModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.StockControlActionOK(
						modelAction.StockControlModelActionTypes.UPDATE_ALL_STOCK_CONTROL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockControlActionFail(
								modelAction.StockControlModelActionTypes.UPDATE_ALL_STOCK_CONTROL_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockControlAction>(modelAction.StockControlModelActionTypes.DELETE_STOCK_CONTROL),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.StockControlActionOK(
						modelAction.StockControlModelActionTypes.DELETE_STOCK_CONTROL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockControlActionFail(
								modelAction.StockControlModelActionTypes.DELETE_STOCK_CONTROL_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockControlAction>(modelAction.StockControlModelActionTypes.DELETE_STOCK_CONTROL_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.StockControlActionOK(
						modelAction.StockControlModelActionTypes.DELETE_STOCK_CONTROL_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockControlActionFail(
								modelAction.StockControlModelActionTypes.DELETE_STOCK_CONTROL_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockControlAction>(modelAction.StockControlModelActionTypes.DELETE_ALL_STOCK_CONTROL),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.StockControlActionOK(
						modelAction.StockControlModelActionTypes.DELETE_ALL_STOCK_CONTROL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockControlActionFail(
								modelAction.StockControlModelActionTypes.DELETE_ALL_STOCK_CONTROL_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockControlAction>(modelAction.StockControlModelActionTypes.EXPORT_STOCK_CONTROL),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.StockControlActionOK(
						modelAction.StockControlModelActionTypes.EXPORT_STOCK_CONTROL,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockControlAction>(modelAction.StockControlModelActionTypes.EXPORT_ALL_STOCK_CONTROL),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.StockControlActionOK(
						modelAction.StockControlModelActionTypes.EXPORT_ALL_STOCK_CONTROL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockControlActionFail(
								modelAction.StockControlModelActionTypes.EXPORT_ALL_STOCK_CONTROL_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockControlAction>(modelAction.StockControlModelActionTypes.EXPORT_STOCK_CONTROL_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.StockControlActionOK(
						modelAction.StockControlModelActionTypes.EXPORT_STOCK_CONTROL_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockControlActionFail(
								modelAction.StockControlModelActionTypes.EXPORT_STOCK_CONTROL_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockControlAction>(modelAction.StockControlModelActionTypes.IMPORT_STOCK_CONTROLS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.StockControlActionOK(
						modelAction.StockControlModelActionTypes.IMPORT_STOCK_CONTROLS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.StockControlActionFail(
								modelAction.StockControlModelActionTypes.IMPORT_STOCK_CONTROLS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockControlAction>(modelAction.StockControlModelActionTypes.FETCH_STOCK_CONTROL_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.StockControlActionOK(
						modelAction.StockControlModelActionTypes.FETCH_STOCK_CONTROL_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.StockControlActionFail(
								modelAction.StockControlModelActionTypes.FETCH_STOCK_CONTROL_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.StockControlAction>(modelAction.StockControlModelActionTypes.FETCH_STOCK_CONTROL_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.StockControlActionOK(
						modelAction.StockControlModelActionTypes.FETCH_STOCK_CONTROL_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.StockControlActionFail(
								modelAction.StockControlModelActionTypes.FETCH_STOCK_CONTROL_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
