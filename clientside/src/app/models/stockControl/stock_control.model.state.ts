...
/**
 * StockControlCollectionState would store the state of a collection of StockControl
 */
export interface StockControlCollectionState extends CollectionState {
 ...
 */
export interface StockControlModelAudit extends AbstractModelAudit<StockControlModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * StockControlModelState would store the state of the model
 */
export interface StockControlModelState {
	collectionState: {
		[key: string]: StockControlCollectionState;
	};
	data: {
		[id: string]: StockControlModel;
	};
	totalCount: number;
	audits: StockControlModelAudit[];
 ...
 */
export const initialStockControlCollectionState: StockControlCollectionState = {
...
/**
 * The initial state of StockControlModelState
 */
export const initialState: StockControlModelState = {
	collectionState: {
