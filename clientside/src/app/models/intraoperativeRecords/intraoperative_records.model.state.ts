...
/**
 * IntraoperativeRecordsCollectionState would store the state of a collection of IntraoperativeRecords
 */
export interface IntraoperativeRecordsCollectionState extends CollectionState {
 ...
 */
export interface IntraoperativeRecordsModelAudit extends AbstractModelAudit<IntraoperativeRecordsModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * IntraoperativeRecordsModelState would store the state of the model
 */
export interface IntraoperativeRecordsModelState {
	collectionState: {
		[key: string]: IntraoperativeRecordsCollectionState;
	};
	data: {
		[id: string]: IntraoperativeRecordsModel;
	};
	totalCount: number;
	audits: IntraoperativeRecordsModelAudit[];
 ...
 */
export const initialIntraoperativeRecordsCollectionState: IntraoperativeRecordsCollectionState = {
...
/**
 * The initial state of IntraoperativeRecordsModelState
 */
export const initialState: IntraoperativeRecordsModelState = {
	collectionState: {
