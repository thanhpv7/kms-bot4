...
import * as modelAction from './intraoperative_records.model.action';
import {IntraoperativeRecordsService} from '../../services/intraoperativeRecords/intraoperative_records.service';
...
/**
 * Effect class used for side effects related to Intraoperative Records model.
 */
@Injectable()
export class IntraoperativeRecordsEffect {
	...
	constructor(
		...
		protected readonly service: IntraoperativeRecordsService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.IntraoperativeRecordsAction>(modelAction.IntraoperativeRecordsModelActionTypes.COUNT_INTRAOPERATIVE_RECORDSS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.IntraoperativeRecordsActionOK(
						modelAction.IntraoperativeRecordsModelActionTypes.COUNT_INTRAOPERATIVE_RECORDSS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.IntraoperativeRecordsActionFail(
								modelAction.IntraoperativeRecordsModelActionTypes.COUNT_INTRAOPERATIVE_RECORDSS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.IntraoperativeRecordsAction>(modelAction.IntraoperativeRecordsModelActionTypes.FETCH_INTRAOPERATIVE_RECORDS),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.IntraoperativeRecordsActionOK(
						modelAction.IntraoperativeRecordsModelActionTypes.FETCH_INTRAOPERATIVE_RECORDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.IntraoperativeRecordsActionFail(
								modelAction.IntraoperativeRecordsModelActionTypes.FETCH_INTRAOPERATIVE_RECORDS_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.IntraoperativeRecordsAction>(modelAction.IntraoperativeRecordsModelActionTypes.FETCH_ALL_INTRAOPERATIVE_RECORDS),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.IntraoperativeRecordsActionOK(
						modelAction.IntraoperativeRecordsModelActionTypes.FETCH_ALL_INTRAOPERATIVE_RECORDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.IntraoperativeRecordsActionFail(
								modelAction.IntraoperativeRecordsModelActionTypes.FETCH_ALL_INTRAOPERATIVE_RECORDS_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.IntraoperativeRecordsAction>(modelAction.IntraoperativeRecordsModelActionTypes.FETCH_INTRAOPERATIVE_RECORDS_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.IntraoperativeRecordsActionOK(
						modelAction.IntraoperativeRecordsModelActionTypes.FETCH_INTRAOPERATIVE_RECORDS_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.IntraoperativeRecordsActionFail(
								modelAction.IntraoperativeRecordsModelActionTypes.FETCH_INTRAOPERATIVE_RECORDS_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.IntraoperativeRecordsAction>(modelAction.IntraoperativeRecordsModelActionTypes.FETCH_LAST_INTRAOPERATIVE_RECORDS_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.IntraoperativeRecordsActionOK(
						modelAction.IntraoperativeRecordsModelActionTypes.FETCH_LAST_INTRAOPERATIVE_RECORDS_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.IntraoperativeRecordsActionFail(
								modelAction.IntraoperativeRecordsModelActionTypes.FETCH_LAST_INTRAOPERATIVE_RECORDS_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.IntraoperativeRecordsAction>(modelAction.IntraoperativeRecordsModelActionTypes.CREATE_INTRAOPERATIVE_RECORDS),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as IntraoperativeRecordsModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.IntraoperativeRecordsActionOK(
						modelAction.IntraoperativeRecordsModelActionTypes.CREATE_INTRAOPERATIVE_RECORDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.IntraoperativeRecordsActionFail(
								modelAction.IntraoperativeRecordsModelActionTypes.CREATE_INTRAOPERATIVE_RECORDS_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.IntraoperativeRecordsAction>(modelAction.IntraoperativeRecordsModelActionTypes.CREATE_ALL_INTRAOPERATIVE_RECORDS),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as IntraoperativeRecordsModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.IntraoperativeRecordsActionOK(
						modelAction.IntraoperativeRecordsModelActionTypes.CREATE_ALL_INTRAOPERATIVE_RECORDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.IntraoperativeRecordsActionFail(
								modelAction.IntraoperativeRecordsModelActionTypes.CREATE_ALL_INTRAOPERATIVE_RECORDS_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.IntraoperativeRecordsAction>(modelAction.IntraoperativeRecordsModelActionTypes.UPDATE_INTRAOPERATIVE_RECORDS),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as IntraoperativeRecordsModel;
				...
				return this.service.update(new IntraoperativeRecordsModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.IntraoperativeRecordsActionOK(
						modelAction.IntraoperativeRecordsModelActionTypes.UPDATE_INTRAOPERATIVE_RECORDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.IntraoperativeRecordsActionFail(
								modelAction.IntraoperativeRecordsModelActionTypes.UPDATE_INTRAOPERATIVE_RECORDS_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.IntraoperativeRecordsAction>(modelAction.IntraoperativeRecordsModelActionTypes.UPDATE_ALL_INTRAOPERATIVE_RECORDS),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as IntraoperativeRecordsModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new IntraoperativeRecordsModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.IntraoperativeRecordsActionOK(
						modelAction.IntraoperativeRecordsModelActionTypes.UPDATE_ALL_INTRAOPERATIVE_RECORDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.IntraoperativeRecordsActionFail(
								modelAction.IntraoperativeRecordsModelActionTypes.UPDATE_ALL_INTRAOPERATIVE_RECORDS_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.IntraoperativeRecordsAction>(modelAction.IntraoperativeRecordsModelActionTypes.DELETE_INTRAOPERATIVE_RECORDS),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.IntraoperativeRecordsActionOK(
						modelAction.IntraoperativeRecordsModelActionTypes.DELETE_INTRAOPERATIVE_RECORDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.IntraoperativeRecordsActionFail(
								modelAction.IntraoperativeRecordsModelActionTypes.DELETE_INTRAOPERATIVE_RECORDS_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.IntraoperativeRecordsAction>(modelAction.IntraoperativeRecordsModelActionTypes.DELETE_INTRAOPERATIVE_RECORDS_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.IntraoperativeRecordsActionOK(
						modelAction.IntraoperativeRecordsModelActionTypes.DELETE_INTRAOPERATIVE_RECORDS_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.IntraoperativeRecordsActionFail(
								modelAction.IntraoperativeRecordsModelActionTypes.DELETE_INTRAOPERATIVE_RECORDS_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.IntraoperativeRecordsAction>(modelAction.IntraoperativeRecordsModelActionTypes.DELETE_ALL_INTRAOPERATIVE_RECORDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.IntraoperativeRecordsActionOK(
						modelAction.IntraoperativeRecordsModelActionTypes.DELETE_ALL_INTRAOPERATIVE_RECORDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.IntraoperativeRecordsActionFail(
								modelAction.IntraoperativeRecordsModelActionTypes.DELETE_ALL_INTRAOPERATIVE_RECORDS_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.IntraoperativeRecordsAction>(modelAction.IntraoperativeRecordsModelActionTypes.EXPORT_INTRAOPERATIVE_RECORDS),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.IntraoperativeRecordsActionOK(
						modelAction.IntraoperativeRecordsModelActionTypes.EXPORT_INTRAOPERATIVE_RECORDS,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.IntraoperativeRecordsAction>(modelAction.IntraoperativeRecordsModelActionTypes.EXPORT_ALL_INTRAOPERATIVE_RECORDS),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.IntraoperativeRecordsActionOK(
						modelAction.IntraoperativeRecordsModelActionTypes.EXPORT_ALL_INTRAOPERATIVE_RECORDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.IntraoperativeRecordsActionFail(
								modelAction.IntraoperativeRecordsModelActionTypes.EXPORT_ALL_INTRAOPERATIVE_RECORDS_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.IntraoperativeRecordsAction>(modelAction.IntraoperativeRecordsModelActionTypes.EXPORT_INTRAOPERATIVE_RECORDS_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.IntraoperativeRecordsActionOK(
						modelAction.IntraoperativeRecordsModelActionTypes.EXPORT_INTRAOPERATIVE_RECORDS_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.IntraoperativeRecordsActionFail(
								modelAction.IntraoperativeRecordsModelActionTypes.EXPORT_INTRAOPERATIVE_RECORDS_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.IntraoperativeRecordsAction>(modelAction.IntraoperativeRecordsModelActionTypes.IMPORT_INTRAOPERATIVE_RECORDSS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.IntraoperativeRecordsActionOK(
						modelAction.IntraoperativeRecordsModelActionTypes.IMPORT_INTRAOPERATIVE_RECORDSS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.IntraoperativeRecordsActionFail(
								modelAction.IntraoperativeRecordsModelActionTypes.IMPORT_INTRAOPERATIVE_RECORDSS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.IntraoperativeRecordsAction>(modelAction.IntraoperativeRecordsModelActionTypes.FETCH_INTRAOPERATIVE_RECORDS_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.IntraoperativeRecordsActionOK(
						modelAction.IntraoperativeRecordsModelActionTypes.FETCH_INTRAOPERATIVE_RECORDS_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.IntraoperativeRecordsActionFail(
								modelAction.IntraoperativeRecordsModelActionTypes.FETCH_INTRAOPERATIVE_RECORDS_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.IntraoperativeRecordsAction>(modelAction.IntraoperativeRecordsModelActionTypes.FETCH_INTRAOPERATIVE_RECORDS_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.IntraoperativeRecordsActionOK(
						modelAction.IntraoperativeRecordsModelActionTypes.FETCH_INTRAOPERATIVE_RECORDS_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.IntraoperativeRecordsActionFail(
								modelAction.IntraoperativeRecordsModelActionTypes.FETCH_INTRAOPERATIVE_RECORDS_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
