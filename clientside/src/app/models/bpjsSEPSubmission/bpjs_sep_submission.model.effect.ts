...
import * as modelAction from './bpjs_sep_submission.model.action';
import {BpjsSEPSubmissionService} from '../../services/bpjsSEPSubmission/bpjs_sep_submission.service';
...
/**
 * Effect class used for side effects related to BPJS SEP Submission model.
 */
@Injectable()
export class BpjsSEPSubmissionEffect {
	...
	constructor(
		...
		protected readonly service: BpjsSEPSubmissionService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPSubmissionAction>(modelAction.BpjsSEPSubmissionModelActionTypes.COUNT_BPJS_SEP_SUBMISSIONS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPSubmissionActionOK(
						modelAction.BpjsSEPSubmissionModelActionTypes.COUNT_BPJS_SEP_SUBMISSIONS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPSubmissionActionFail(
								modelAction.BpjsSEPSubmissionModelActionTypes.COUNT_BPJS_SEP_SUBMISSIONS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPSubmissionAction>(modelAction.BpjsSEPSubmissionModelActionTypes.FETCH_BPJS_SEP_SUBMISSION),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPSubmissionActionOK(
						modelAction.BpjsSEPSubmissionModelActionTypes.FETCH_BPJS_SEP_SUBMISSION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPSubmissionActionFail(
								modelAction.BpjsSEPSubmissionModelActionTypes.FETCH_BPJS_SEP_SUBMISSION_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPSubmissionAction>(modelAction.BpjsSEPSubmissionModelActionTypes.FETCH_ALL_BPJS_SEP_SUBMISSION),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPSubmissionActionOK(
						modelAction.BpjsSEPSubmissionModelActionTypes.FETCH_ALL_BPJS_SEP_SUBMISSION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPSubmissionActionFail(
								modelAction.BpjsSEPSubmissionModelActionTypes.FETCH_ALL_BPJS_SEP_SUBMISSION_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPSubmissionAction>(modelAction.BpjsSEPSubmissionModelActionTypes.FETCH_BPJS_SEP_SUBMISSION_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPSubmissionActionOK(
						modelAction.BpjsSEPSubmissionModelActionTypes.FETCH_BPJS_SEP_SUBMISSION_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPSubmissionActionFail(
								modelAction.BpjsSEPSubmissionModelActionTypes.FETCH_BPJS_SEP_SUBMISSION_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPSubmissionAction>(modelAction.BpjsSEPSubmissionModelActionTypes.FETCH_LAST_BPJS_SEP_SUBMISSION_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPSubmissionActionOK(
						modelAction.BpjsSEPSubmissionModelActionTypes.FETCH_LAST_BPJS_SEP_SUBMISSION_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPSubmissionActionFail(
								modelAction.BpjsSEPSubmissionModelActionTypes.FETCH_LAST_BPJS_SEP_SUBMISSION_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPSubmissionAction>(modelAction.BpjsSEPSubmissionModelActionTypes.CREATE_BPJS_SEP_SUBMISSION),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsSEPSubmissionModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPSubmissionActionOK(
						modelAction.BpjsSEPSubmissionModelActionTypes.CREATE_BPJS_SEP_SUBMISSION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPSubmissionActionFail(
								modelAction.BpjsSEPSubmissionModelActionTypes.CREATE_BPJS_SEP_SUBMISSION_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPSubmissionAction>(modelAction.BpjsSEPSubmissionModelActionTypes.CREATE_ALL_BPJS_SEP_SUBMISSION),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsSEPSubmissionModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPSubmissionActionOK(
						modelAction.BpjsSEPSubmissionModelActionTypes.CREATE_ALL_BPJS_SEP_SUBMISSION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPSubmissionActionFail(
								modelAction.BpjsSEPSubmissionModelActionTypes.CREATE_ALL_BPJS_SEP_SUBMISSION_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPSubmissionAction>(modelAction.BpjsSEPSubmissionModelActionTypes.UPDATE_BPJS_SEP_SUBMISSION),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsSEPSubmissionModel;
				...
				return this.service.update(new BpjsSEPSubmissionModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPSubmissionActionOK(
						modelAction.BpjsSEPSubmissionModelActionTypes.UPDATE_BPJS_SEP_SUBMISSION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPSubmissionActionFail(
								modelAction.BpjsSEPSubmissionModelActionTypes.UPDATE_BPJS_SEP_SUBMISSION_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPSubmissionAction>(modelAction.BpjsSEPSubmissionModelActionTypes.UPDATE_ALL_BPJS_SEP_SUBMISSION),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsSEPSubmissionModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsSEPSubmissionModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPSubmissionActionOK(
						modelAction.BpjsSEPSubmissionModelActionTypes.UPDATE_ALL_BPJS_SEP_SUBMISSION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPSubmissionActionFail(
								modelAction.BpjsSEPSubmissionModelActionTypes.UPDATE_ALL_BPJS_SEP_SUBMISSION_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPSubmissionAction>(modelAction.BpjsSEPSubmissionModelActionTypes.DELETE_BPJS_SEP_SUBMISSION),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPSubmissionActionOK(
						modelAction.BpjsSEPSubmissionModelActionTypes.DELETE_BPJS_SEP_SUBMISSION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPSubmissionActionFail(
								modelAction.BpjsSEPSubmissionModelActionTypes.DELETE_BPJS_SEP_SUBMISSION_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPSubmissionAction>(modelAction.BpjsSEPSubmissionModelActionTypes.DELETE_BPJS_SEP_SUBMISSION_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPSubmissionActionOK(
						modelAction.BpjsSEPSubmissionModelActionTypes.DELETE_BPJS_SEP_SUBMISSION_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPSubmissionActionFail(
								modelAction.BpjsSEPSubmissionModelActionTypes.DELETE_BPJS_SEP_SUBMISSION_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPSubmissionAction>(modelAction.BpjsSEPSubmissionModelActionTypes.DELETE_ALL_BPJS_SEP_SUBMISSION),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPSubmissionActionOK(
						modelAction.BpjsSEPSubmissionModelActionTypes.DELETE_ALL_BPJS_SEP_SUBMISSION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPSubmissionActionFail(
								modelAction.BpjsSEPSubmissionModelActionTypes.DELETE_ALL_BPJS_SEP_SUBMISSION_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPSubmissionAction>(modelAction.BpjsSEPSubmissionModelActionTypes.EXPORT_BPJS_SEP_SUBMISSION),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPSubmissionActionOK(
						modelAction.BpjsSEPSubmissionModelActionTypes.EXPORT_BPJS_SEP_SUBMISSION,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPSubmissionAction>(modelAction.BpjsSEPSubmissionModelActionTypes.EXPORT_ALL_BPJS_SEP_SUBMISSION),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPSubmissionActionOK(
						modelAction.BpjsSEPSubmissionModelActionTypes.EXPORT_ALL_BPJS_SEP_SUBMISSION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPSubmissionActionFail(
								modelAction.BpjsSEPSubmissionModelActionTypes.EXPORT_ALL_BPJS_SEP_SUBMISSION_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPSubmissionAction>(modelAction.BpjsSEPSubmissionModelActionTypes.EXPORT_BPJS_SEP_SUBMISSION_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPSubmissionActionOK(
						modelAction.BpjsSEPSubmissionModelActionTypes.EXPORT_BPJS_SEP_SUBMISSION_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPSubmissionActionFail(
								modelAction.BpjsSEPSubmissionModelActionTypes.EXPORT_BPJS_SEP_SUBMISSION_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPSubmissionAction>(modelAction.BpjsSEPSubmissionModelActionTypes.IMPORT_BPJS_SEP_SUBMISSIONS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsSEPSubmissionActionOK(
						modelAction.BpjsSEPSubmissionModelActionTypes.IMPORT_BPJS_SEP_SUBMISSIONS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPSubmissionActionFail(
								modelAction.BpjsSEPSubmissionModelActionTypes.IMPORT_BPJS_SEP_SUBMISSIONS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPSubmissionAction>(modelAction.BpjsSEPSubmissionModelActionTypes.FETCH_BPJS_SEP_SUBMISSION_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsSEPSubmissionActionOK(
						modelAction.BpjsSEPSubmissionModelActionTypes.FETCH_BPJS_SEP_SUBMISSION_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPSubmissionActionFail(
								modelAction.BpjsSEPSubmissionModelActionTypes.FETCH_BPJS_SEP_SUBMISSION_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsSEPSubmissionAction>(modelAction.BpjsSEPSubmissionModelActionTypes.FETCH_BPJS_SEP_SUBMISSION_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsSEPSubmissionActionOK(
						modelAction.BpjsSEPSubmissionModelActionTypes.FETCH_BPJS_SEP_SUBMISSION_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsSEPSubmissionActionFail(
								modelAction.BpjsSEPSubmissionModelActionTypes.FETCH_BPJS_SEP_SUBMISSION_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
