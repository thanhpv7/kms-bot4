...
/**
 * BpjsSEPSubmissionCollectionState would store the state of a collection of BpjsSEPSubmission
 */
export interface BpjsSEPSubmissionCollectionState extends CollectionState {
 ...
 */
export interface BpjsSEPSubmissionModelAudit extends AbstractModelAudit<BpjsSEPSubmissionModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsSEPSubmissionModelState would store the state of the model
 */
export interface BpjsSEPSubmissionModelState {
	collectionState: {
		[key: string]: BpjsSEPSubmissionCollectionState;
	};
	data: {
		[id: string]: BpjsSEPSubmissionModel;
	};
	totalCount: number;
	audits: BpjsSEPSubmissionModelAudit[];
 ...
 */
export const initialBpjsSEPSubmissionCollectionState: BpjsSEPSubmissionCollectionState = {
...
/**
 * The initial state of BpjsSEPSubmissionModelState
 */
export const initialState: BpjsSEPSubmissionModelState = {
	collectionState: {
