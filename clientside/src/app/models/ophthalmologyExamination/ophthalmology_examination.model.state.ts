...
/**
 * OphthalmologyExaminationCollectionState would store the state of a collection of OphthalmologyExamination
 */
export interface OphthalmologyExaminationCollectionState extends CollectionState {
 ...
 */
export interface OphthalmologyExaminationModelAudit extends AbstractModelAudit<OphthalmologyExaminationModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * OphthalmologyExaminationModelState would store the state of the model
 */
export interface OphthalmologyExaminationModelState {
	collectionState: {
		[key: string]: OphthalmologyExaminationCollectionState;
	};
	data: {
		[id: string]: OphthalmologyExaminationModel;
	};
	totalCount: number;
	audits: OphthalmologyExaminationModelAudit[];
 ...
 */
export const initialOphthalmologyExaminationCollectionState: OphthalmologyExaminationCollectionState = {
...
/**
 * The initial state of OphthalmologyExaminationModelState
 */
export const initialState: OphthalmologyExaminationModelState = {
	collectionState: {
