...
import * as modelAction from './ophthalmology_examination.model.action';
import {OphthalmologyExaminationService} from '../../services/ophthalmologyExamination/ophthalmology_examination.service';
...
/**
 * Effect class used for side effects related to Ophthalmology Examination model.
 */
@Injectable()
export class OphthalmologyExaminationEffect {
	...
	constructor(
		...
		protected readonly service: OphthalmologyExaminationService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OphthalmologyExaminationAction>(modelAction.OphthalmologyExaminationModelActionTypes.COUNT_OPHTHALMOLOGY_EXAMINATIONS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.OphthalmologyExaminationActionOK(
						modelAction.OphthalmologyExaminationModelActionTypes.COUNT_OPHTHALMOLOGY_EXAMINATIONS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.OphthalmologyExaminationActionFail(
								modelAction.OphthalmologyExaminationModelActionTypes.COUNT_OPHTHALMOLOGY_EXAMINATIONS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OphthalmologyExaminationAction>(modelAction.OphthalmologyExaminationModelActionTypes.FETCH_OPHTHALMOLOGY_EXAMINATION),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.OphthalmologyExaminationActionOK(
						modelAction.OphthalmologyExaminationModelActionTypes.FETCH_OPHTHALMOLOGY_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.OphthalmologyExaminationActionFail(
								modelAction.OphthalmologyExaminationModelActionTypes.FETCH_OPHTHALMOLOGY_EXAMINATION_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OphthalmologyExaminationAction>(modelAction.OphthalmologyExaminationModelActionTypes.FETCH_ALL_OPHTHALMOLOGY_EXAMINATION),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.OphthalmologyExaminationActionOK(
						modelAction.OphthalmologyExaminationModelActionTypes.FETCH_ALL_OPHTHALMOLOGY_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.OphthalmologyExaminationActionFail(
								modelAction.OphthalmologyExaminationModelActionTypes.FETCH_ALL_OPHTHALMOLOGY_EXAMINATION_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OphthalmologyExaminationAction>(modelAction.OphthalmologyExaminationModelActionTypes.FETCH_OPHTHALMOLOGY_EXAMINATION_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.OphthalmologyExaminationActionOK(
						modelAction.OphthalmologyExaminationModelActionTypes.FETCH_OPHTHALMOLOGY_EXAMINATION_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.OphthalmologyExaminationActionFail(
								modelAction.OphthalmologyExaminationModelActionTypes.FETCH_OPHTHALMOLOGY_EXAMINATION_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OphthalmologyExaminationAction>(modelAction.OphthalmologyExaminationModelActionTypes.FETCH_LAST_OPHTHALMOLOGY_EXAMINATION_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.OphthalmologyExaminationActionOK(
						modelAction.OphthalmologyExaminationModelActionTypes.FETCH_LAST_OPHTHALMOLOGY_EXAMINATION_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.OphthalmologyExaminationActionFail(
								modelAction.OphthalmologyExaminationModelActionTypes.FETCH_LAST_OPHTHALMOLOGY_EXAMINATION_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OphthalmologyExaminationAction>(modelAction.OphthalmologyExaminationModelActionTypes.CREATE_OPHTHALMOLOGY_EXAMINATION),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as OphthalmologyExaminationModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.OphthalmologyExaminationActionOK(
						modelAction.OphthalmologyExaminationModelActionTypes.CREATE_OPHTHALMOLOGY_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.OphthalmologyExaminationActionFail(
								modelAction.OphthalmologyExaminationModelActionTypes.CREATE_OPHTHALMOLOGY_EXAMINATION_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OphthalmologyExaminationAction>(modelAction.OphthalmologyExaminationModelActionTypes.CREATE_ALL_OPHTHALMOLOGY_EXAMINATION),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as OphthalmologyExaminationModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.OphthalmologyExaminationActionOK(
						modelAction.OphthalmologyExaminationModelActionTypes.CREATE_ALL_OPHTHALMOLOGY_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.OphthalmologyExaminationActionFail(
								modelAction.OphthalmologyExaminationModelActionTypes.CREATE_ALL_OPHTHALMOLOGY_EXAMINATION_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OphthalmologyExaminationAction>(modelAction.OphthalmologyExaminationModelActionTypes.UPDATE_OPHTHALMOLOGY_EXAMINATION),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as OphthalmologyExaminationModel;
				...
				return this.service.update(new OphthalmologyExaminationModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.OphthalmologyExaminationActionOK(
						modelAction.OphthalmologyExaminationModelActionTypes.UPDATE_OPHTHALMOLOGY_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.OphthalmologyExaminationActionFail(
								modelAction.OphthalmologyExaminationModelActionTypes.UPDATE_OPHTHALMOLOGY_EXAMINATION_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OphthalmologyExaminationAction>(modelAction.OphthalmologyExaminationModelActionTypes.UPDATE_ALL_OPHTHALMOLOGY_EXAMINATION),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as OphthalmologyExaminationModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new OphthalmologyExaminationModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.OphthalmologyExaminationActionOK(
						modelAction.OphthalmologyExaminationModelActionTypes.UPDATE_ALL_OPHTHALMOLOGY_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.OphthalmologyExaminationActionFail(
								modelAction.OphthalmologyExaminationModelActionTypes.UPDATE_ALL_OPHTHALMOLOGY_EXAMINATION_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OphthalmologyExaminationAction>(modelAction.OphthalmologyExaminationModelActionTypes.DELETE_OPHTHALMOLOGY_EXAMINATION),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.OphthalmologyExaminationActionOK(
						modelAction.OphthalmologyExaminationModelActionTypes.DELETE_OPHTHALMOLOGY_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.OphthalmologyExaminationActionFail(
								modelAction.OphthalmologyExaminationModelActionTypes.DELETE_OPHTHALMOLOGY_EXAMINATION_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OphthalmologyExaminationAction>(modelAction.OphthalmologyExaminationModelActionTypes.DELETE_OPHTHALMOLOGY_EXAMINATION_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.OphthalmologyExaminationActionOK(
						modelAction.OphthalmologyExaminationModelActionTypes.DELETE_OPHTHALMOLOGY_EXAMINATION_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.OphthalmologyExaminationActionFail(
								modelAction.OphthalmologyExaminationModelActionTypes.DELETE_OPHTHALMOLOGY_EXAMINATION_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OphthalmologyExaminationAction>(modelAction.OphthalmologyExaminationModelActionTypes.DELETE_ALL_OPHTHALMOLOGY_EXAMINATION),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.OphthalmologyExaminationActionOK(
						modelAction.OphthalmologyExaminationModelActionTypes.DELETE_ALL_OPHTHALMOLOGY_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.OphthalmologyExaminationActionFail(
								modelAction.OphthalmologyExaminationModelActionTypes.DELETE_ALL_OPHTHALMOLOGY_EXAMINATION_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OphthalmologyExaminationAction>(modelAction.OphthalmologyExaminationModelActionTypes.EXPORT_OPHTHALMOLOGY_EXAMINATION),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.OphthalmologyExaminationActionOK(
						modelAction.OphthalmologyExaminationModelActionTypes.EXPORT_OPHTHALMOLOGY_EXAMINATION,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OphthalmologyExaminationAction>(modelAction.OphthalmologyExaminationModelActionTypes.EXPORT_ALL_OPHTHALMOLOGY_EXAMINATION),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.OphthalmologyExaminationActionOK(
						modelAction.OphthalmologyExaminationModelActionTypes.EXPORT_ALL_OPHTHALMOLOGY_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.OphthalmologyExaminationActionFail(
								modelAction.OphthalmologyExaminationModelActionTypes.EXPORT_ALL_OPHTHALMOLOGY_EXAMINATION_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OphthalmologyExaminationAction>(modelAction.OphthalmologyExaminationModelActionTypes.EXPORT_OPHTHALMOLOGY_EXAMINATION_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.OphthalmologyExaminationActionOK(
						modelAction.OphthalmologyExaminationModelActionTypes.EXPORT_OPHTHALMOLOGY_EXAMINATION_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.OphthalmologyExaminationActionFail(
								modelAction.OphthalmologyExaminationModelActionTypes.EXPORT_OPHTHALMOLOGY_EXAMINATION_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OphthalmologyExaminationAction>(modelAction.OphthalmologyExaminationModelActionTypes.IMPORT_OPHTHALMOLOGY_EXAMINATIONS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.OphthalmologyExaminationActionOK(
						modelAction.OphthalmologyExaminationModelActionTypes.IMPORT_OPHTHALMOLOGY_EXAMINATIONS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.OphthalmologyExaminationActionFail(
								modelAction.OphthalmologyExaminationModelActionTypes.IMPORT_OPHTHALMOLOGY_EXAMINATIONS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OphthalmologyExaminationAction>(modelAction.OphthalmologyExaminationModelActionTypes.FETCH_OPHTHALMOLOGY_EXAMINATION_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.OphthalmologyExaminationActionOK(
						modelAction.OphthalmologyExaminationModelActionTypes.FETCH_OPHTHALMOLOGY_EXAMINATION_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.OphthalmologyExaminationActionFail(
								modelAction.OphthalmologyExaminationModelActionTypes.FETCH_OPHTHALMOLOGY_EXAMINATION_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.OphthalmologyExaminationAction>(modelAction.OphthalmologyExaminationModelActionTypes.FETCH_OPHTHALMOLOGY_EXAMINATION_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.OphthalmologyExaminationActionOK(
						modelAction.OphthalmologyExaminationModelActionTypes.FETCH_OPHTHALMOLOGY_EXAMINATION_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.OphthalmologyExaminationActionFail(
								modelAction.OphthalmologyExaminationModelActionTypes.FETCH_OPHTHALMOLOGY_EXAMINATION_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
