...
/**
 * BpjsAccidentMasterCollectionState would store the state of a collection of BpjsAccidentMaster
 */
export interface BpjsAccidentMasterCollectionState extends CollectionState {
 ...
 */
export interface BpjsAccidentMasterModelAudit extends AbstractModelAudit<BpjsAccidentMasterModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsAccidentMasterModelState would store the state of the model
 */
export interface BpjsAccidentMasterModelState {
	collectionState: {
		[key: string]: BpjsAccidentMasterCollectionState;
	};
	data: {
		[id: string]: BpjsAccidentMasterModel;
	};
	totalCount: number;
	audits: BpjsAccidentMasterModelAudit[];
 ...
 */
export const initialBpjsAccidentMasterCollectionState: BpjsAccidentMasterCollectionState = {
...
/**
 * The initial state of BpjsAccidentMasterModelState
 */
export const initialState: BpjsAccidentMasterModelState = {
	collectionState: {
