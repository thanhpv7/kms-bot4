...
import * as modelAction from './bpjs_accident_master.model.action';
import {BpjsAccidentMasterService} from '../../services/bpjsAccidentMaster/bpjs_accident_master.service';
...
/**
 * Effect class used for side effects related to BPJS Accident Master model.
 */
@Injectable()
export class BpjsAccidentMasterEffect {
	...
	constructor(
		...
		protected readonly service: BpjsAccidentMasterService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsAccidentMasterAction>(modelAction.BpjsAccidentMasterModelActionTypes.COUNT_BPJS_ACCIDENT_MASTERS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsAccidentMasterActionOK(
						modelAction.BpjsAccidentMasterModelActionTypes.COUNT_BPJS_ACCIDENT_MASTERS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsAccidentMasterActionFail(
								modelAction.BpjsAccidentMasterModelActionTypes.COUNT_BPJS_ACCIDENT_MASTERS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsAccidentMasterAction>(modelAction.BpjsAccidentMasterModelActionTypes.FETCH_BPJS_ACCIDENT_MASTER),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsAccidentMasterActionOK(
						modelAction.BpjsAccidentMasterModelActionTypes.FETCH_BPJS_ACCIDENT_MASTER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsAccidentMasterActionFail(
								modelAction.BpjsAccidentMasterModelActionTypes.FETCH_BPJS_ACCIDENT_MASTER_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsAccidentMasterAction>(modelAction.BpjsAccidentMasterModelActionTypes.FETCH_ALL_BPJS_ACCIDENT_MASTER),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsAccidentMasterActionOK(
						modelAction.BpjsAccidentMasterModelActionTypes.FETCH_ALL_BPJS_ACCIDENT_MASTER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsAccidentMasterActionFail(
								modelAction.BpjsAccidentMasterModelActionTypes.FETCH_ALL_BPJS_ACCIDENT_MASTER_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsAccidentMasterAction>(modelAction.BpjsAccidentMasterModelActionTypes.FETCH_BPJS_ACCIDENT_MASTER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsAccidentMasterActionOK(
						modelAction.BpjsAccidentMasterModelActionTypes.FETCH_BPJS_ACCIDENT_MASTER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsAccidentMasterActionFail(
								modelAction.BpjsAccidentMasterModelActionTypes.FETCH_BPJS_ACCIDENT_MASTER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsAccidentMasterAction>(modelAction.BpjsAccidentMasterModelActionTypes.FETCH_LAST_BPJS_ACCIDENT_MASTER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsAccidentMasterActionOK(
						modelAction.BpjsAccidentMasterModelActionTypes.FETCH_LAST_BPJS_ACCIDENT_MASTER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsAccidentMasterActionFail(
								modelAction.BpjsAccidentMasterModelActionTypes.FETCH_LAST_BPJS_ACCIDENT_MASTER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsAccidentMasterAction>(modelAction.BpjsAccidentMasterModelActionTypes.CREATE_BPJS_ACCIDENT_MASTER),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsAccidentMasterModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsAccidentMasterActionOK(
						modelAction.BpjsAccidentMasterModelActionTypes.CREATE_BPJS_ACCIDENT_MASTER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsAccidentMasterActionFail(
								modelAction.BpjsAccidentMasterModelActionTypes.CREATE_BPJS_ACCIDENT_MASTER_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsAccidentMasterAction>(modelAction.BpjsAccidentMasterModelActionTypes.CREATE_ALL_BPJS_ACCIDENT_MASTER),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsAccidentMasterModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsAccidentMasterActionOK(
						modelAction.BpjsAccidentMasterModelActionTypes.CREATE_ALL_BPJS_ACCIDENT_MASTER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsAccidentMasterActionFail(
								modelAction.BpjsAccidentMasterModelActionTypes.CREATE_ALL_BPJS_ACCIDENT_MASTER_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsAccidentMasterAction>(modelAction.BpjsAccidentMasterModelActionTypes.UPDATE_BPJS_ACCIDENT_MASTER),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsAccidentMasterModel;
				...
				return this.service.update(new BpjsAccidentMasterModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsAccidentMasterActionOK(
						modelAction.BpjsAccidentMasterModelActionTypes.UPDATE_BPJS_ACCIDENT_MASTER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsAccidentMasterActionFail(
								modelAction.BpjsAccidentMasterModelActionTypes.UPDATE_BPJS_ACCIDENT_MASTER_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsAccidentMasterAction>(modelAction.BpjsAccidentMasterModelActionTypes.UPDATE_ALL_BPJS_ACCIDENT_MASTER),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsAccidentMasterModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsAccidentMasterModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsAccidentMasterActionOK(
						modelAction.BpjsAccidentMasterModelActionTypes.UPDATE_ALL_BPJS_ACCIDENT_MASTER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsAccidentMasterActionFail(
								modelAction.BpjsAccidentMasterModelActionTypes.UPDATE_ALL_BPJS_ACCIDENT_MASTER_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsAccidentMasterAction>(modelAction.BpjsAccidentMasterModelActionTypes.DELETE_BPJS_ACCIDENT_MASTER),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsAccidentMasterActionOK(
						modelAction.BpjsAccidentMasterModelActionTypes.DELETE_BPJS_ACCIDENT_MASTER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsAccidentMasterActionFail(
								modelAction.BpjsAccidentMasterModelActionTypes.DELETE_BPJS_ACCIDENT_MASTER_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsAccidentMasterAction>(modelAction.BpjsAccidentMasterModelActionTypes.DELETE_BPJS_ACCIDENT_MASTER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsAccidentMasterActionOK(
						modelAction.BpjsAccidentMasterModelActionTypes.DELETE_BPJS_ACCIDENT_MASTER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsAccidentMasterActionFail(
								modelAction.BpjsAccidentMasterModelActionTypes.DELETE_BPJS_ACCIDENT_MASTER_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsAccidentMasterAction>(modelAction.BpjsAccidentMasterModelActionTypes.DELETE_ALL_BPJS_ACCIDENT_MASTER),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsAccidentMasterActionOK(
						modelAction.BpjsAccidentMasterModelActionTypes.DELETE_ALL_BPJS_ACCIDENT_MASTER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsAccidentMasterActionFail(
								modelAction.BpjsAccidentMasterModelActionTypes.DELETE_ALL_BPJS_ACCIDENT_MASTER_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsAccidentMasterAction>(modelAction.BpjsAccidentMasterModelActionTypes.EXPORT_BPJS_ACCIDENT_MASTER),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsAccidentMasterActionOK(
						modelAction.BpjsAccidentMasterModelActionTypes.EXPORT_BPJS_ACCIDENT_MASTER,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsAccidentMasterAction>(modelAction.BpjsAccidentMasterModelActionTypes.EXPORT_ALL_BPJS_ACCIDENT_MASTER),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsAccidentMasterActionOK(
						modelAction.BpjsAccidentMasterModelActionTypes.EXPORT_ALL_BPJS_ACCIDENT_MASTER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsAccidentMasterActionFail(
								modelAction.BpjsAccidentMasterModelActionTypes.EXPORT_ALL_BPJS_ACCIDENT_MASTER_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsAccidentMasterAction>(modelAction.BpjsAccidentMasterModelActionTypes.EXPORT_BPJS_ACCIDENT_MASTER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsAccidentMasterActionOK(
						modelAction.BpjsAccidentMasterModelActionTypes.EXPORT_BPJS_ACCIDENT_MASTER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsAccidentMasterActionFail(
								modelAction.BpjsAccidentMasterModelActionTypes.EXPORT_BPJS_ACCIDENT_MASTER_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsAccidentMasterAction>(modelAction.BpjsAccidentMasterModelActionTypes.IMPORT_BPJS_ACCIDENT_MASTERS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsAccidentMasterActionOK(
						modelAction.BpjsAccidentMasterModelActionTypes.IMPORT_BPJS_ACCIDENT_MASTERS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsAccidentMasterActionFail(
								modelAction.BpjsAccidentMasterModelActionTypes.IMPORT_BPJS_ACCIDENT_MASTERS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsAccidentMasterAction>(modelAction.BpjsAccidentMasterModelActionTypes.FETCH_BPJS_ACCIDENT_MASTER_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsAccidentMasterActionOK(
						modelAction.BpjsAccidentMasterModelActionTypes.FETCH_BPJS_ACCIDENT_MASTER_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsAccidentMasterActionFail(
								modelAction.BpjsAccidentMasterModelActionTypes.FETCH_BPJS_ACCIDENT_MASTER_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsAccidentMasterAction>(modelAction.BpjsAccidentMasterModelActionTypes.FETCH_BPJS_ACCIDENT_MASTER_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsAccidentMasterActionOK(
						modelAction.BpjsAccidentMasterModelActionTypes.FETCH_BPJS_ACCIDENT_MASTER_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsAccidentMasterActionFail(
								modelAction.BpjsAccidentMasterModelActionTypes.FETCH_BPJS_ACCIDENT_MASTER_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
