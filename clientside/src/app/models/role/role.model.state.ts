...
/**
 * RoleCollectionState would store the state of a collection of Role
 */
export interface RoleCollectionState extends CollectionState {
 ...
 */
export interface RoleModelAudit extends AbstractModelAudit<RoleModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * RoleModelState would store the state of the model
 */
export interface RoleModelState {
	collectionState: {
		[key: string]: RoleCollectionState;
	};
	data: {
		[id: string]: RoleModel;
	};
	totalCount: number;
	audits: RoleModelAudit[];
 ...
 */
export const initialRoleCollectionState: RoleCollectionState = {
...
/**
 * The initial state of RoleModelState
 */
export const initialState: RoleModelState = {
	collectionState: {
