...
export class RoleEffect {
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoleAction>(modelAction.RoleModelActionTypes.COUNT_ROLES),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.RoleActionOK(
						modelAction.RoleModelActionTypes.COUNT_ROLES_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RoleActionFail(
								modelAction.RoleModelActionTypes.COUNT_ROLES_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoleAction>(modelAction.RoleModelActionTypes.FETCH_ROLE),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.RoleActionOK(
						modelAction.RoleModelActionTypes.FETCH_ROLE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RoleActionFail(
								modelAction.RoleModelActionTypes.FETCH_ROLE_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoleAction>(modelAction.RoleModelActionTypes.FETCH_ALL_ROLE),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.RoleActionOK(
						modelAction.RoleModelActionTypes.FETCH_ALL_ROLE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RoleActionFail(
								modelAction.RoleModelActionTypes.FETCH_ALL_ROLE_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoleAction>(modelAction.RoleModelActionTypes.FETCH_ROLE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.RoleActionOK(
						modelAction.RoleModelActionTypes.FETCH_ROLE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RoleActionFail(
								modelAction.RoleModelActionTypes.FETCH_ROLE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoleAction>(modelAction.RoleModelActionTypes.FETCH_LAST_ROLE_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.RoleActionOK(
						modelAction.RoleModelActionTypes.FETCH_LAST_ROLE_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RoleActionFail(
								modelAction.RoleModelActionTypes.FETCH_LAST_ROLE_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoleAction>(modelAction.RoleModelActionTypes.CREATE_ROLE),
			...
			concatMap((action) => {
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.RoleActionOK(
						modelAction.RoleModelActionTypes.CREATE_ROLE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RoleActionFail(
								modelAction.RoleModelActionTypes.CREATE_ROLE_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoleAction>(modelAction.RoleModelActionTypes.CREATE_ALL_ROLE),
			...
			concatMap((action) => {
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.RoleActionOK(
						modelAction.RoleModelActionTypes.CREATE_ALL_ROLE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RoleActionFail(
								modelAction.RoleModelActionTypes.CREATE_ALL_ROLE_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoleAction>(modelAction.RoleModelActionTypes.UPDATE_ROLE),
			...
			concatMap((action) => {
				...
				return this.service.update(new RoleModel({
					...
					map(stateConfig => new modelAction.RoleActionOK(
						modelAction.RoleModelActionTypes.UPDATE_ROLE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RoleActionFail(
								modelAction.RoleModelActionTypes.UPDATE_ROLE_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoleAction>(modelAction.RoleModelActionTypes.UPDATE_ALL_ROLE),
			...
			concatMap((action) => {
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.RoleActionOK(
						modelAction.RoleModelActionTypes.UPDATE_ALL_ROLE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RoleActionFail(
								modelAction.RoleModelActionTypes.UPDATE_ALL_ROLE_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoleAction>(modelAction.RoleModelActionTypes.DELETE_ROLE),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.RoleActionOK(
						modelAction.RoleModelActionTypes.DELETE_ROLE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RoleActionFail(
								modelAction.RoleModelActionTypes.DELETE_ROLE_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoleAction>(modelAction.RoleModelActionTypes.DELETE_ROLE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.RoleActionOK(
						modelAction.RoleModelActionTypes.DELETE_ROLE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RoleActionFail(
								modelAction.RoleModelActionTypes.DELETE_ROLE_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoleAction>(modelAction.RoleModelActionTypes.DELETE_ALL_ROLE),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.RoleActionOK(
						modelAction.RoleModelActionTypes.DELETE_ALL_ROLE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RoleActionFail(
								modelAction.RoleModelActionTypes.DELETE_ALL_ROLE_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoleAction>(modelAction.RoleModelActionTypes.EXPORT_ROLE),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.RoleActionOK(
						modelAction.RoleModelActionTypes.EXPORT_ROLE,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoleAction>(modelAction.RoleModelActionTypes.EXPORT_ALL_ROLE),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.RoleActionOK(
						modelAction.RoleModelActionTypes.EXPORT_ALL_ROLE_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RoleActionFail(
								modelAction.RoleModelActionTypes.EXPORT_ALL_ROLE_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoleAction>(modelAction.RoleModelActionTypes.EXPORT_ROLE_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.RoleActionOK(
						modelAction.RoleModelActionTypes.EXPORT_ROLE_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RoleActionFail(
								modelAction.RoleModelActionTypes.EXPORT_ROLE_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoleAction>(modelAction.RoleModelActionTypes.IMPORT_ROLES),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.RoleActionOK(
						modelAction.RoleModelActionTypes.IMPORT_ROLES_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RoleActionFail(
								modelAction.RoleModelActionTypes.IMPORT_ROLES_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoleAction>(modelAction.RoleModelActionTypes.FETCH_ROLE_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.RoleActionOK(
						modelAction.RoleModelActionTypes.FETCH_ROLE_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.RoleActionFail(
								modelAction.RoleModelActionTypes.FETCH_ROLE_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RoleAction>(modelAction.RoleModelActionTypes.FETCH_ROLE_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.RoleActionOK(
						modelAction.RoleModelActionTypes.FETCH_ROLE_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.RoleActionFail(
								modelAction.RoleModelActionTypes.FETCH_ROLE_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
