...
import * as modelAction from './bpjs_claim_submission.model.action';
import {BpjsClaimSubmissionService} from '../../services/bpjsClaimSubmission/bpjs_claim_submission.service';
...
/**
 * Effect class used for side effects related to BPJS Claim Submission model.
 */
@Injectable()
export class BpjsClaimSubmissionEffect {
	...
	constructor(
		...
		protected readonly service: BpjsClaimSubmissionService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsClaimSubmissionAction>(modelAction.BpjsClaimSubmissionModelActionTypes.COUNT_BPJS_CLAIM_SUBMISSIONS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsClaimSubmissionActionOK(
						modelAction.BpjsClaimSubmissionModelActionTypes.COUNT_BPJS_CLAIM_SUBMISSIONS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsClaimSubmissionActionFail(
								modelAction.BpjsClaimSubmissionModelActionTypes.COUNT_BPJS_CLAIM_SUBMISSIONS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsClaimSubmissionAction>(modelAction.BpjsClaimSubmissionModelActionTypes.FETCH_BPJS_CLAIM_SUBMISSION),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsClaimSubmissionActionOK(
						modelAction.BpjsClaimSubmissionModelActionTypes.FETCH_BPJS_CLAIM_SUBMISSION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsClaimSubmissionActionFail(
								modelAction.BpjsClaimSubmissionModelActionTypes.FETCH_BPJS_CLAIM_SUBMISSION_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsClaimSubmissionAction>(modelAction.BpjsClaimSubmissionModelActionTypes.FETCH_ALL_BPJS_CLAIM_SUBMISSION),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsClaimSubmissionActionOK(
						modelAction.BpjsClaimSubmissionModelActionTypes.FETCH_ALL_BPJS_CLAIM_SUBMISSION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsClaimSubmissionActionFail(
								modelAction.BpjsClaimSubmissionModelActionTypes.FETCH_ALL_BPJS_CLAIM_SUBMISSION_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsClaimSubmissionAction>(modelAction.BpjsClaimSubmissionModelActionTypes.FETCH_BPJS_CLAIM_SUBMISSION_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsClaimSubmissionActionOK(
						modelAction.BpjsClaimSubmissionModelActionTypes.FETCH_BPJS_CLAIM_SUBMISSION_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsClaimSubmissionActionFail(
								modelAction.BpjsClaimSubmissionModelActionTypes.FETCH_BPJS_CLAIM_SUBMISSION_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsClaimSubmissionAction>(modelAction.BpjsClaimSubmissionModelActionTypes.FETCH_LAST_BPJS_CLAIM_SUBMISSION_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsClaimSubmissionActionOK(
						modelAction.BpjsClaimSubmissionModelActionTypes.FETCH_LAST_BPJS_CLAIM_SUBMISSION_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsClaimSubmissionActionFail(
								modelAction.BpjsClaimSubmissionModelActionTypes.FETCH_LAST_BPJS_CLAIM_SUBMISSION_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsClaimSubmissionAction>(modelAction.BpjsClaimSubmissionModelActionTypes.CREATE_BPJS_CLAIM_SUBMISSION),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsClaimSubmissionModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsClaimSubmissionActionOK(
						modelAction.BpjsClaimSubmissionModelActionTypes.CREATE_BPJS_CLAIM_SUBMISSION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsClaimSubmissionActionFail(
								modelAction.BpjsClaimSubmissionModelActionTypes.CREATE_BPJS_CLAIM_SUBMISSION_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsClaimSubmissionAction>(modelAction.BpjsClaimSubmissionModelActionTypes.CREATE_ALL_BPJS_CLAIM_SUBMISSION),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsClaimSubmissionModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsClaimSubmissionActionOK(
						modelAction.BpjsClaimSubmissionModelActionTypes.CREATE_ALL_BPJS_CLAIM_SUBMISSION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsClaimSubmissionActionFail(
								modelAction.BpjsClaimSubmissionModelActionTypes.CREATE_ALL_BPJS_CLAIM_SUBMISSION_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsClaimSubmissionAction>(modelAction.BpjsClaimSubmissionModelActionTypes.UPDATE_BPJS_CLAIM_SUBMISSION),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsClaimSubmissionModel;
				...
				return this.service.update(new BpjsClaimSubmissionModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsClaimSubmissionActionOK(
						modelAction.BpjsClaimSubmissionModelActionTypes.UPDATE_BPJS_CLAIM_SUBMISSION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsClaimSubmissionActionFail(
								modelAction.BpjsClaimSubmissionModelActionTypes.UPDATE_BPJS_CLAIM_SUBMISSION_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsClaimSubmissionAction>(modelAction.BpjsClaimSubmissionModelActionTypes.UPDATE_ALL_BPJS_CLAIM_SUBMISSION),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsClaimSubmissionModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsClaimSubmissionModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsClaimSubmissionActionOK(
						modelAction.BpjsClaimSubmissionModelActionTypes.UPDATE_ALL_BPJS_CLAIM_SUBMISSION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsClaimSubmissionActionFail(
								modelAction.BpjsClaimSubmissionModelActionTypes.UPDATE_ALL_BPJS_CLAIM_SUBMISSION_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsClaimSubmissionAction>(modelAction.BpjsClaimSubmissionModelActionTypes.DELETE_BPJS_CLAIM_SUBMISSION),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsClaimSubmissionActionOK(
						modelAction.BpjsClaimSubmissionModelActionTypes.DELETE_BPJS_CLAIM_SUBMISSION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsClaimSubmissionActionFail(
								modelAction.BpjsClaimSubmissionModelActionTypes.DELETE_BPJS_CLAIM_SUBMISSION_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsClaimSubmissionAction>(modelAction.BpjsClaimSubmissionModelActionTypes.DELETE_BPJS_CLAIM_SUBMISSION_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsClaimSubmissionActionOK(
						modelAction.BpjsClaimSubmissionModelActionTypes.DELETE_BPJS_CLAIM_SUBMISSION_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsClaimSubmissionActionFail(
								modelAction.BpjsClaimSubmissionModelActionTypes.DELETE_BPJS_CLAIM_SUBMISSION_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsClaimSubmissionAction>(modelAction.BpjsClaimSubmissionModelActionTypes.DELETE_ALL_BPJS_CLAIM_SUBMISSION),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsClaimSubmissionActionOK(
						modelAction.BpjsClaimSubmissionModelActionTypes.DELETE_ALL_BPJS_CLAIM_SUBMISSION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsClaimSubmissionActionFail(
								modelAction.BpjsClaimSubmissionModelActionTypes.DELETE_ALL_BPJS_CLAIM_SUBMISSION_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsClaimSubmissionAction>(modelAction.BpjsClaimSubmissionModelActionTypes.EXPORT_BPJS_CLAIM_SUBMISSION),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsClaimSubmissionActionOK(
						modelAction.BpjsClaimSubmissionModelActionTypes.EXPORT_BPJS_CLAIM_SUBMISSION,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsClaimSubmissionAction>(modelAction.BpjsClaimSubmissionModelActionTypes.EXPORT_ALL_BPJS_CLAIM_SUBMISSION),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsClaimSubmissionActionOK(
						modelAction.BpjsClaimSubmissionModelActionTypes.EXPORT_ALL_BPJS_CLAIM_SUBMISSION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsClaimSubmissionActionFail(
								modelAction.BpjsClaimSubmissionModelActionTypes.EXPORT_ALL_BPJS_CLAIM_SUBMISSION_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsClaimSubmissionAction>(modelAction.BpjsClaimSubmissionModelActionTypes.EXPORT_BPJS_CLAIM_SUBMISSION_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsClaimSubmissionActionOK(
						modelAction.BpjsClaimSubmissionModelActionTypes.EXPORT_BPJS_CLAIM_SUBMISSION_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsClaimSubmissionActionFail(
								modelAction.BpjsClaimSubmissionModelActionTypes.EXPORT_BPJS_CLAIM_SUBMISSION_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsClaimSubmissionAction>(modelAction.BpjsClaimSubmissionModelActionTypes.IMPORT_BPJS_CLAIM_SUBMISSIONS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsClaimSubmissionActionOK(
						modelAction.BpjsClaimSubmissionModelActionTypes.IMPORT_BPJS_CLAIM_SUBMISSIONS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsClaimSubmissionActionFail(
								modelAction.BpjsClaimSubmissionModelActionTypes.IMPORT_BPJS_CLAIM_SUBMISSIONS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsClaimSubmissionAction>(modelAction.BpjsClaimSubmissionModelActionTypes.FETCH_BPJS_CLAIM_SUBMISSION_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsClaimSubmissionActionOK(
						modelAction.BpjsClaimSubmissionModelActionTypes.FETCH_BPJS_CLAIM_SUBMISSION_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsClaimSubmissionActionFail(
								modelAction.BpjsClaimSubmissionModelActionTypes.FETCH_BPJS_CLAIM_SUBMISSION_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsClaimSubmissionAction>(modelAction.BpjsClaimSubmissionModelActionTypes.FETCH_BPJS_CLAIM_SUBMISSION_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsClaimSubmissionActionOK(
						modelAction.BpjsClaimSubmissionModelActionTypes.FETCH_BPJS_CLAIM_SUBMISSION_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsClaimSubmissionActionFail(
								modelAction.BpjsClaimSubmissionModelActionTypes.FETCH_BPJS_CLAIM_SUBMISSION_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
