...
/**
 * BpjsClaimSubmissionCollectionState would store the state of a collection of BpjsClaimSubmission
 */
export interface BpjsClaimSubmissionCollectionState extends CollectionState {
 ...
 */
export interface BpjsClaimSubmissionModelAudit extends AbstractModelAudit<BpjsClaimSubmissionModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsClaimSubmissionModelState would store the state of the model
 */
export interface BpjsClaimSubmissionModelState {
	collectionState: {
		[key: string]: BpjsClaimSubmissionCollectionState;
	};
	data: {
		[id: string]: BpjsClaimSubmissionModel;
	};
	totalCount: number;
	audits: BpjsClaimSubmissionModelAudit[];
 ...
 */
export const initialBpjsClaimSubmissionCollectionState: BpjsClaimSubmissionCollectionState = {
...
/**
 * The initial state of BpjsClaimSubmissionModelState
 */
export const initialState: BpjsClaimSubmissionModelState = {
	collectionState: {
