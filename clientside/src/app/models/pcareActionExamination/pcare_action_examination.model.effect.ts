...
import * as modelAction from './pcare_action_examination.model.action';
import {PcareActionExaminationService} from '../../services/pcareActionExamination/pcare_action_examination.service';
...
/**
 * Effect class used for side effects related to PCare Action Examination model.
 */
@Injectable()
export class PcareActionExaminationEffect {
	...
	constructor(
		...
		protected readonly service: PcareActionExaminationService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareActionExaminationAction>(modelAction.PcareActionExaminationModelActionTypes.COUNT_PCARE_ACTION_EXAMINATIONS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.PcareActionExaminationActionOK(
						modelAction.PcareActionExaminationModelActionTypes.COUNT_PCARE_ACTION_EXAMINATIONS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareActionExaminationActionFail(
								modelAction.PcareActionExaminationModelActionTypes.COUNT_PCARE_ACTION_EXAMINATIONS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareActionExaminationAction>(modelAction.PcareActionExaminationModelActionTypes.FETCH_PCARE_ACTION_EXAMINATION),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareActionExaminationActionOK(
						modelAction.PcareActionExaminationModelActionTypes.FETCH_PCARE_ACTION_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareActionExaminationActionFail(
								modelAction.PcareActionExaminationModelActionTypes.FETCH_PCARE_ACTION_EXAMINATION_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareActionExaminationAction>(modelAction.PcareActionExaminationModelActionTypes.FETCH_ALL_PCARE_ACTION_EXAMINATION),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.PcareActionExaminationActionOK(
						modelAction.PcareActionExaminationModelActionTypes.FETCH_ALL_PCARE_ACTION_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareActionExaminationActionFail(
								modelAction.PcareActionExaminationModelActionTypes.FETCH_ALL_PCARE_ACTION_EXAMINATION_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareActionExaminationAction>(modelAction.PcareActionExaminationModelActionTypes.FETCH_PCARE_ACTION_EXAMINATION_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareActionExaminationActionOK(
						modelAction.PcareActionExaminationModelActionTypes.FETCH_PCARE_ACTION_EXAMINATION_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareActionExaminationActionFail(
								modelAction.PcareActionExaminationModelActionTypes.FETCH_PCARE_ACTION_EXAMINATION_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareActionExaminationAction>(modelAction.PcareActionExaminationModelActionTypes.FETCH_LAST_PCARE_ACTION_EXAMINATION_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareActionExaminationActionOK(
						modelAction.PcareActionExaminationModelActionTypes.FETCH_LAST_PCARE_ACTION_EXAMINATION_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareActionExaminationActionFail(
								modelAction.PcareActionExaminationModelActionTypes.FETCH_LAST_PCARE_ACTION_EXAMINATION_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareActionExaminationAction>(modelAction.PcareActionExaminationModelActionTypes.CREATE_PCARE_ACTION_EXAMINATION),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as PcareActionExaminationModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareActionExaminationActionOK(
						modelAction.PcareActionExaminationModelActionTypes.CREATE_PCARE_ACTION_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareActionExaminationActionFail(
								modelAction.PcareActionExaminationModelActionTypes.CREATE_PCARE_ACTION_EXAMINATION_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareActionExaminationAction>(modelAction.PcareActionExaminationModelActionTypes.CREATE_ALL_PCARE_ACTION_EXAMINATION),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as PcareActionExaminationModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareActionExaminationActionOK(
						modelAction.PcareActionExaminationModelActionTypes.CREATE_ALL_PCARE_ACTION_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareActionExaminationActionFail(
								modelAction.PcareActionExaminationModelActionTypes.CREATE_ALL_PCARE_ACTION_EXAMINATION_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareActionExaminationAction>(modelAction.PcareActionExaminationModelActionTypes.UPDATE_PCARE_ACTION_EXAMINATION),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as PcareActionExaminationModel;
				...
				return this.service.update(new PcareActionExaminationModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareActionExaminationActionOK(
						modelAction.PcareActionExaminationModelActionTypes.UPDATE_PCARE_ACTION_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareActionExaminationActionFail(
								modelAction.PcareActionExaminationModelActionTypes.UPDATE_PCARE_ACTION_EXAMINATION_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareActionExaminationAction>(modelAction.PcareActionExaminationModelActionTypes.UPDATE_ALL_PCARE_ACTION_EXAMINATION),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as PcareActionExaminationModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new PcareActionExaminationModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PcareActionExaminationActionOK(
						modelAction.PcareActionExaminationModelActionTypes.UPDATE_ALL_PCARE_ACTION_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareActionExaminationActionFail(
								modelAction.PcareActionExaminationModelActionTypes.UPDATE_ALL_PCARE_ACTION_EXAMINATION_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareActionExaminationAction>(modelAction.PcareActionExaminationModelActionTypes.DELETE_PCARE_ACTION_EXAMINATION),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PcareActionExaminationActionOK(
						modelAction.PcareActionExaminationModelActionTypes.DELETE_PCARE_ACTION_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareActionExaminationActionFail(
								modelAction.PcareActionExaminationModelActionTypes.DELETE_PCARE_ACTION_EXAMINATION_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareActionExaminationAction>(modelAction.PcareActionExaminationModelActionTypes.DELETE_PCARE_ACTION_EXAMINATION_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.PcareActionExaminationActionOK(
						modelAction.PcareActionExaminationModelActionTypes.DELETE_PCARE_ACTION_EXAMINATION_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareActionExaminationActionFail(
								modelAction.PcareActionExaminationModelActionTypes.DELETE_PCARE_ACTION_EXAMINATION_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareActionExaminationAction>(modelAction.PcareActionExaminationModelActionTypes.DELETE_ALL_PCARE_ACTION_EXAMINATION),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PcareActionExaminationActionOK(
						modelAction.PcareActionExaminationModelActionTypes.DELETE_ALL_PCARE_ACTION_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareActionExaminationActionFail(
								modelAction.PcareActionExaminationModelActionTypes.DELETE_ALL_PCARE_ACTION_EXAMINATION_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareActionExaminationAction>(modelAction.PcareActionExaminationModelActionTypes.EXPORT_PCARE_ACTION_EXAMINATION),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PcareActionExaminationActionOK(
						modelAction.PcareActionExaminationModelActionTypes.EXPORT_PCARE_ACTION_EXAMINATION,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareActionExaminationAction>(modelAction.PcareActionExaminationModelActionTypes.EXPORT_ALL_PCARE_ACTION_EXAMINATION),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PcareActionExaminationActionOK(
						modelAction.PcareActionExaminationModelActionTypes.EXPORT_ALL_PCARE_ACTION_EXAMINATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareActionExaminationActionFail(
								modelAction.PcareActionExaminationModelActionTypes.EXPORT_ALL_PCARE_ACTION_EXAMINATION_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareActionExaminationAction>(modelAction.PcareActionExaminationModelActionTypes.EXPORT_PCARE_ACTION_EXAMINATION_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PcareActionExaminationActionOK(
						modelAction.PcareActionExaminationModelActionTypes.EXPORT_PCARE_ACTION_EXAMINATION_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareActionExaminationActionFail(
								modelAction.PcareActionExaminationModelActionTypes.EXPORT_PCARE_ACTION_EXAMINATION_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareActionExaminationAction>(modelAction.PcareActionExaminationModelActionTypes.IMPORT_PCARE_ACTION_EXAMINATIONS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.PcareActionExaminationActionOK(
						modelAction.PcareActionExaminationModelActionTypes.IMPORT_PCARE_ACTION_EXAMINATIONS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PcareActionExaminationActionFail(
								modelAction.PcareActionExaminationModelActionTypes.IMPORT_PCARE_ACTION_EXAMINATIONS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareActionExaminationAction>(modelAction.PcareActionExaminationModelActionTypes.FETCH_PCARE_ACTION_EXAMINATION_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.PcareActionExaminationActionOK(
						modelAction.PcareActionExaminationModelActionTypes.FETCH_PCARE_ACTION_EXAMINATION_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PcareActionExaminationActionFail(
								modelAction.PcareActionExaminationModelActionTypes.FETCH_PCARE_ACTION_EXAMINATION_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PcareActionExaminationAction>(modelAction.PcareActionExaminationModelActionTypes.FETCH_PCARE_ACTION_EXAMINATION_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.PcareActionExaminationActionOK(
						modelAction.PcareActionExaminationModelActionTypes.FETCH_PCARE_ACTION_EXAMINATION_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PcareActionExaminationActionFail(
								modelAction.PcareActionExaminationModelActionTypes.FETCH_PCARE_ACTION_EXAMINATION_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
