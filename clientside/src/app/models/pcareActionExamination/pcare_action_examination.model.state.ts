...
/**
 * PcareActionExaminationCollectionState would store the state of a collection of PcareActionExamination
 */
export interface PcareActionExaminationCollectionState extends CollectionState {
 ...
 */
export interface PcareActionExaminationModelAudit extends AbstractModelAudit<PcareActionExaminationModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * PcareActionExaminationModelState would store the state of the model
 */
export interface PcareActionExaminationModelState {
	collectionState: {
		[key: string]: PcareActionExaminationCollectionState;
	};
	data: {
		[id: string]: PcareActionExaminationModel;
	};
	totalCount: number;
	audits: PcareActionExaminationModelAudit[];
 ...
 */
export const initialPcareActionExaminationCollectionState: PcareActionExaminationCollectionState = {
...
/**
 * The initial state of PcareActionExaminationModelState
 */
export const initialState: PcareActionExaminationModelState = {
	collectionState: {
