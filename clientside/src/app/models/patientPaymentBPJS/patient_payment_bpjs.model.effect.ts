...
import * as modelAction from './patient_payment_bpjs.model.action';
import {PatientPaymentBPJSService} from '../../services/patientPaymentBPJS/patient_payment_bpjs.service';
...
/**
 * Effect class used for side effects related to Patient Payment BPJS model.
 */
@Injectable()
export class PatientPaymentBPJSEffect {
	...
	constructor(
		...
		protected readonly service: PatientPaymentBPJSService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPaymentBPJSAction>(modelAction.PatientPaymentBPJSModelActionTypes.COUNT_PATIENT_PAYMENT_BPJSS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.PatientPaymentBPJSActionOK(
						modelAction.PatientPaymentBPJSModelActionTypes.COUNT_PATIENT_PAYMENT_BPJSS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientPaymentBPJSActionFail(
								modelAction.PatientPaymentBPJSModelActionTypes.COUNT_PATIENT_PAYMENT_BPJSS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPaymentBPJSAction>(modelAction.PatientPaymentBPJSModelActionTypes.FETCH_PATIENT_PAYMENT_BPJS),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientPaymentBPJSActionOK(
						modelAction.PatientPaymentBPJSModelActionTypes.FETCH_PATIENT_PAYMENT_BPJS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientPaymentBPJSActionFail(
								modelAction.PatientPaymentBPJSModelActionTypes.FETCH_PATIENT_PAYMENT_BPJS_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPaymentBPJSAction>(modelAction.PatientPaymentBPJSModelActionTypes.FETCH_ALL_PATIENT_PAYMENT_BPJS),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.PatientPaymentBPJSActionOK(
						modelAction.PatientPaymentBPJSModelActionTypes.FETCH_ALL_PATIENT_PAYMENT_BPJS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientPaymentBPJSActionFail(
								modelAction.PatientPaymentBPJSModelActionTypes.FETCH_ALL_PATIENT_PAYMENT_BPJS_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPaymentBPJSAction>(modelAction.PatientPaymentBPJSModelActionTypes.FETCH_PATIENT_PAYMENT_BPJS_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientPaymentBPJSActionOK(
						modelAction.PatientPaymentBPJSModelActionTypes.FETCH_PATIENT_PAYMENT_BPJS_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientPaymentBPJSActionFail(
								modelAction.PatientPaymentBPJSModelActionTypes.FETCH_PATIENT_PAYMENT_BPJS_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPaymentBPJSAction>(modelAction.PatientPaymentBPJSModelActionTypes.FETCH_LAST_PATIENT_PAYMENT_BPJS_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientPaymentBPJSActionOK(
						modelAction.PatientPaymentBPJSModelActionTypes.FETCH_LAST_PATIENT_PAYMENT_BPJS_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientPaymentBPJSActionFail(
								modelAction.PatientPaymentBPJSModelActionTypes.FETCH_LAST_PATIENT_PAYMENT_BPJS_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPaymentBPJSAction>(modelAction.PatientPaymentBPJSModelActionTypes.CREATE_PATIENT_PAYMENT_BPJS),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as PatientPaymentBPJSModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientPaymentBPJSActionOK(
						modelAction.PatientPaymentBPJSModelActionTypes.CREATE_PATIENT_PAYMENT_BPJS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientPaymentBPJSActionFail(
								modelAction.PatientPaymentBPJSModelActionTypes.CREATE_PATIENT_PAYMENT_BPJS_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPaymentBPJSAction>(modelAction.PatientPaymentBPJSModelActionTypes.CREATE_ALL_PATIENT_PAYMENT_BPJS),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as PatientPaymentBPJSModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientPaymentBPJSActionOK(
						modelAction.PatientPaymentBPJSModelActionTypes.CREATE_ALL_PATIENT_PAYMENT_BPJS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientPaymentBPJSActionFail(
								modelAction.PatientPaymentBPJSModelActionTypes.CREATE_ALL_PATIENT_PAYMENT_BPJS_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPaymentBPJSAction>(modelAction.PatientPaymentBPJSModelActionTypes.UPDATE_PATIENT_PAYMENT_BPJS),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as PatientPaymentBPJSModel;
				...
				return this.service.update(new PatientPaymentBPJSModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientPaymentBPJSActionOK(
						modelAction.PatientPaymentBPJSModelActionTypes.UPDATE_PATIENT_PAYMENT_BPJS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientPaymentBPJSActionFail(
								modelAction.PatientPaymentBPJSModelActionTypes.UPDATE_PATIENT_PAYMENT_BPJS_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPaymentBPJSAction>(modelAction.PatientPaymentBPJSModelActionTypes.UPDATE_ALL_PATIENT_PAYMENT_BPJS),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as PatientPaymentBPJSModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new PatientPaymentBPJSModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.PatientPaymentBPJSActionOK(
						modelAction.PatientPaymentBPJSModelActionTypes.UPDATE_ALL_PATIENT_PAYMENT_BPJS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientPaymentBPJSActionFail(
								modelAction.PatientPaymentBPJSModelActionTypes.UPDATE_ALL_PATIENT_PAYMENT_BPJS_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPaymentBPJSAction>(modelAction.PatientPaymentBPJSModelActionTypes.DELETE_PATIENT_PAYMENT_BPJS),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PatientPaymentBPJSActionOK(
						modelAction.PatientPaymentBPJSModelActionTypes.DELETE_PATIENT_PAYMENT_BPJS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientPaymentBPJSActionFail(
								modelAction.PatientPaymentBPJSModelActionTypes.DELETE_PATIENT_PAYMENT_BPJS_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPaymentBPJSAction>(modelAction.PatientPaymentBPJSModelActionTypes.DELETE_PATIENT_PAYMENT_BPJS_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.PatientPaymentBPJSActionOK(
						modelAction.PatientPaymentBPJSModelActionTypes.DELETE_PATIENT_PAYMENT_BPJS_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientPaymentBPJSActionFail(
								modelAction.PatientPaymentBPJSModelActionTypes.DELETE_PATIENT_PAYMENT_BPJS_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPaymentBPJSAction>(modelAction.PatientPaymentBPJSModelActionTypes.DELETE_ALL_PATIENT_PAYMENT_BPJS),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.PatientPaymentBPJSActionOK(
						modelAction.PatientPaymentBPJSModelActionTypes.DELETE_ALL_PATIENT_PAYMENT_BPJS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientPaymentBPJSActionFail(
								modelAction.PatientPaymentBPJSModelActionTypes.DELETE_ALL_PATIENT_PAYMENT_BPJS_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPaymentBPJSAction>(modelAction.PatientPaymentBPJSModelActionTypes.EXPORT_PATIENT_PAYMENT_BPJS),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PatientPaymentBPJSActionOK(
						modelAction.PatientPaymentBPJSModelActionTypes.EXPORT_PATIENT_PAYMENT_BPJS,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPaymentBPJSAction>(modelAction.PatientPaymentBPJSModelActionTypes.EXPORT_ALL_PATIENT_PAYMENT_BPJS),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PatientPaymentBPJSActionOK(
						modelAction.PatientPaymentBPJSModelActionTypes.EXPORT_ALL_PATIENT_PAYMENT_BPJS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientPaymentBPJSActionFail(
								modelAction.PatientPaymentBPJSModelActionTypes.EXPORT_ALL_PATIENT_PAYMENT_BPJS_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPaymentBPJSAction>(modelAction.PatientPaymentBPJSModelActionTypes.EXPORT_PATIENT_PAYMENT_BPJS_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.PatientPaymentBPJSActionOK(
						modelAction.PatientPaymentBPJSModelActionTypes.EXPORT_PATIENT_PAYMENT_BPJS_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientPaymentBPJSActionFail(
								modelAction.PatientPaymentBPJSModelActionTypes.EXPORT_PATIENT_PAYMENT_BPJS_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPaymentBPJSAction>(modelAction.PatientPaymentBPJSModelActionTypes.IMPORT_PATIENT_PAYMENT_BPJSS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.PatientPaymentBPJSActionOK(
						modelAction.PatientPaymentBPJSModelActionTypes.IMPORT_PATIENT_PAYMENT_BPJSS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.PatientPaymentBPJSActionFail(
								modelAction.PatientPaymentBPJSModelActionTypes.IMPORT_PATIENT_PAYMENT_BPJSS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPaymentBPJSAction>(modelAction.PatientPaymentBPJSModelActionTypes.FETCH_PATIENT_PAYMENT_BPJS_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.PatientPaymentBPJSActionOK(
						modelAction.PatientPaymentBPJSModelActionTypes.FETCH_PATIENT_PAYMENT_BPJS_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PatientPaymentBPJSActionFail(
								modelAction.PatientPaymentBPJSModelActionTypes.FETCH_PATIENT_PAYMENT_BPJS_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.PatientPaymentBPJSAction>(modelAction.PatientPaymentBPJSModelActionTypes.FETCH_PATIENT_PAYMENT_BPJS_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.PatientPaymentBPJSActionOK(
						modelAction.PatientPaymentBPJSModelActionTypes.FETCH_PATIENT_PAYMENT_BPJS_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.PatientPaymentBPJSActionFail(
								modelAction.PatientPaymentBPJSModelActionTypes.FETCH_PATIENT_PAYMENT_BPJS_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
