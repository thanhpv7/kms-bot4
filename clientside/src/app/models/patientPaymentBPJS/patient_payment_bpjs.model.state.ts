...
/**
 * PatientPaymentBPJSCollectionState would store the state of a collection of PatientPaymentBPJS
 */
export interface PatientPaymentBPJSCollectionState extends CollectionState {
 ...
 */
export interface PatientPaymentBPJSModelAudit extends AbstractModelAudit<PatientPaymentBPJSModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * PatientPaymentBPJSModelState would store the state of the model
 */
export interface PatientPaymentBPJSModelState {
	collectionState: {
		[key: string]: PatientPaymentBPJSCollectionState;
	};
	data: {
		[id: string]: PatientPaymentBPJSModel;
	};
	totalCount: number;
	audits: PatientPaymentBPJSModelAudit[];
 ...
 */
export const initialPatientPaymentBPJSCollectionState: PatientPaymentBPJSCollectionState = {
...
/**
 * The initial state of PatientPaymentBPJSModelState
 */
export const initialState: PatientPaymentBPJSModelState = {
	collectionState: {
