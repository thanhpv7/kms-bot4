...
import * as modelAction from './fluid_balance_detail.model.action';
import {FluidBalanceDetailService} from '../../services/fluidBalanceDetail/fluid_balance_detail.service';
...
/**
 * Effect class used for side effects related to Fluid Balance Detail model.
 */
@Injectable()
export class FluidBalanceDetailEffect {
	...
	constructor(
		...
		protected readonly service: FluidBalanceDetailService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FluidBalanceDetailAction>(modelAction.FluidBalanceDetailModelActionTypes.COUNT_FLUID_BALANCE_DETAILS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.FluidBalanceDetailActionOK(
						modelAction.FluidBalanceDetailModelActionTypes.COUNT_FLUID_BALANCE_DETAILS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FluidBalanceDetailActionFail(
								modelAction.FluidBalanceDetailModelActionTypes.COUNT_FLUID_BALANCE_DETAILS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FluidBalanceDetailAction>(modelAction.FluidBalanceDetailModelActionTypes.FETCH_FLUID_BALANCE_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.FluidBalanceDetailActionOK(
						modelAction.FluidBalanceDetailModelActionTypes.FETCH_FLUID_BALANCE_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FluidBalanceDetailActionFail(
								modelAction.FluidBalanceDetailModelActionTypes.FETCH_FLUID_BALANCE_DETAIL_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FluidBalanceDetailAction>(modelAction.FluidBalanceDetailModelActionTypes.FETCH_ALL_FLUID_BALANCE_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.FluidBalanceDetailActionOK(
						modelAction.FluidBalanceDetailModelActionTypes.FETCH_ALL_FLUID_BALANCE_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FluidBalanceDetailActionFail(
								modelAction.FluidBalanceDetailModelActionTypes.FETCH_ALL_FLUID_BALANCE_DETAIL_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FluidBalanceDetailAction>(modelAction.FluidBalanceDetailModelActionTypes.FETCH_FLUID_BALANCE_DETAIL_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.FluidBalanceDetailActionOK(
						modelAction.FluidBalanceDetailModelActionTypes.FETCH_FLUID_BALANCE_DETAIL_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FluidBalanceDetailActionFail(
								modelAction.FluidBalanceDetailModelActionTypes.FETCH_FLUID_BALANCE_DETAIL_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FluidBalanceDetailAction>(modelAction.FluidBalanceDetailModelActionTypes.FETCH_LAST_FLUID_BALANCE_DETAIL_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.FluidBalanceDetailActionOK(
						modelAction.FluidBalanceDetailModelActionTypes.FETCH_LAST_FLUID_BALANCE_DETAIL_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FluidBalanceDetailActionFail(
								modelAction.FluidBalanceDetailModelActionTypes.FETCH_LAST_FLUID_BALANCE_DETAIL_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FluidBalanceDetailAction>(modelAction.FluidBalanceDetailModelActionTypes.CREATE_FLUID_BALANCE_DETAIL),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as FluidBalanceDetailModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.FluidBalanceDetailActionOK(
						modelAction.FluidBalanceDetailModelActionTypes.CREATE_FLUID_BALANCE_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FluidBalanceDetailActionFail(
								modelAction.FluidBalanceDetailModelActionTypes.CREATE_FLUID_BALANCE_DETAIL_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FluidBalanceDetailAction>(modelAction.FluidBalanceDetailModelActionTypes.CREATE_ALL_FLUID_BALANCE_DETAIL),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as FluidBalanceDetailModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.FluidBalanceDetailActionOK(
						modelAction.FluidBalanceDetailModelActionTypes.CREATE_ALL_FLUID_BALANCE_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FluidBalanceDetailActionFail(
								modelAction.FluidBalanceDetailModelActionTypes.CREATE_ALL_FLUID_BALANCE_DETAIL_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FluidBalanceDetailAction>(modelAction.FluidBalanceDetailModelActionTypes.UPDATE_FLUID_BALANCE_DETAIL),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as FluidBalanceDetailModel;
				...
				return this.service.update(new FluidBalanceDetailModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.FluidBalanceDetailActionOK(
						modelAction.FluidBalanceDetailModelActionTypes.UPDATE_FLUID_BALANCE_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FluidBalanceDetailActionFail(
								modelAction.FluidBalanceDetailModelActionTypes.UPDATE_FLUID_BALANCE_DETAIL_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FluidBalanceDetailAction>(modelAction.FluidBalanceDetailModelActionTypes.UPDATE_ALL_FLUID_BALANCE_DETAIL),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as FluidBalanceDetailModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new FluidBalanceDetailModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.FluidBalanceDetailActionOK(
						modelAction.FluidBalanceDetailModelActionTypes.UPDATE_ALL_FLUID_BALANCE_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FluidBalanceDetailActionFail(
								modelAction.FluidBalanceDetailModelActionTypes.UPDATE_ALL_FLUID_BALANCE_DETAIL_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FluidBalanceDetailAction>(modelAction.FluidBalanceDetailModelActionTypes.DELETE_FLUID_BALANCE_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.FluidBalanceDetailActionOK(
						modelAction.FluidBalanceDetailModelActionTypes.DELETE_FLUID_BALANCE_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FluidBalanceDetailActionFail(
								modelAction.FluidBalanceDetailModelActionTypes.DELETE_FLUID_BALANCE_DETAIL_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FluidBalanceDetailAction>(modelAction.FluidBalanceDetailModelActionTypes.DELETE_FLUID_BALANCE_DETAIL_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.FluidBalanceDetailActionOK(
						modelAction.FluidBalanceDetailModelActionTypes.DELETE_FLUID_BALANCE_DETAIL_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FluidBalanceDetailActionFail(
								modelAction.FluidBalanceDetailModelActionTypes.DELETE_FLUID_BALANCE_DETAIL_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FluidBalanceDetailAction>(modelAction.FluidBalanceDetailModelActionTypes.DELETE_ALL_FLUID_BALANCE_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.FluidBalanceDetailActionOK(
						modelAction.FluidBalanceDetailModelActionTypes.DELETE_ALL_FLUID_BALANCE_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FluidBalanceDetailActionFail(
								modelAction.FluidBalanceDetailModelActionTypes.DELETE_ALL_FLUID_BALANCE_DETAIL_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FluidBalanceDetailAction>(modelAction.FluidBalanceDetailModelActionTypes.EXPORT_FLUID_BALANCE_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.FluidBalanceDetailActionOK(
						modelAction.FluidBalanceDetailModelActionTypes.EXPORT_FLUID_BALANCE_DETAIL,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FluidBalanceDetailAction>(modelAction.FluidBalanceDetailModelActionTypes.EXPORT_ALL_FLUID_BALANCE_DETAIL),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.FluidBalanceDetailActionOK(
						modelAction.FluidBalanceDetailModelActionTypes.EXPORT_ALL_FLUID_BALANCE_DETAIL_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FluidBalanceDetailActionFail(
								modelAction.FluidBalanceDetailModelActionTypes.EXPORT_ALL_FLUID_BALANCE_DETAIL_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FluidBalanceDetailAction>(modelAction.FluidBalanceDetailModelActionTypes.EXPORT_FLUID_BALANCE_DETAIL_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.FluidBalanceDetailActionOK(
						modelAction.FluidBalanceDetailModelActionTypes.EXPORT_FLUID_BALANCE_DETAIL_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FluidBalanceDetailActionFail(
								modelAction.FluidBalanceDetailModelActionTypes.EXPORT_FLUID_BALANCE_DETAIL_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FluidBalanceDetailAction>(modelAction.FluidBalanceDetailModelActionTypes.IMPORT_FLUID_BALANCE_DETAILS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.FluidBalanceDetailActionOK(
						modelAction.FluidBalanceDetailModelActionTypes.IMPORT_FLUID_BALANCE_DETAILS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.FluidBalanceDetailActionFail(
								modelAction.FluidBalanceDetailModelActionTypes.IMPORT_FLUID_BALANCE_DETAILS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FluidBalanceDetailAction>(modelAction.FluidBalanceDetailModelActionTypes.FETCH_FLUID_BALANCE_DETAIL_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.FluidBalanceDetailActionOK(
						modelAction.FluidBalanceDetailModelActionTypes.FETCH_FLUID_BALANCE_DETAIL_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.FluidBalanceDetailActionFail(
								modelAction.FluidBalanceDetailModelActionTypes.FETCH_FLUID_BALANCE_DETAIL_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.FluidBalanceDetailAction>(modelAction.FluidBalanceDetailModelActionTypes.FETCH_FLUID_BALANCE_DETAIL_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.FluidBalanceDetailActionOK(
						modelAction.FluidBalanceDetailModelActionTypes.FETCH_FLUID_BALANCE_DETAIL_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.FluidBalanceDetailActionFail(
								modelAction.FluidBalanceDetailModelActionTypes.FETCH_FLUID_BALANCE_DETAIL_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
