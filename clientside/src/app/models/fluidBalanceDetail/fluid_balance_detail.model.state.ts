...
/**
 * FluidBalanceDetailCollectionState would store the state of a collection of FluidBalanceDetail
 */
export interface FluidBalanceDetailCollectionState extends CollectionState {
 ...
 */
export interface FluidBalanceDetailModelAudit extends AbstractModelAudit<FluidBalanceDetailModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * FluidBalanceDetailModelState would store the state of the model
 */
export interface FluidBalanceDetailModelState {
	collectionState: {
		[key: string]: FluidBalanceDetailCollectionState;
	};
	data: {
		[id: string]: FluidBalanceDetailModel;
	};
	totalCount: number;
	audits: FluidBalanceDetailModelAudit[];
 ...
 */
export const initialFluidBalanceDetailCollectionState: FluidBalanceDetailCollectionState = {
...
/**
 * The initial state of FluidBalanceDetailModelState
 */
export const initialState: FluidBalanceDetailModelState = {
	collectionState: {
