...
import * as modelAction from './satu_sehat_configuration.model.action';
import {SatuSehatConfigurationService} from '../../services/satuSehatConfiguration/satu_sehat_configuration.service';
...
/**
 * Effect class used for side effects related to Satu Sehat Configuration model.
 */
@Injectable()
export class SatuSehatConfigurationEffect {
	...
	constructor(
		...
		protected readonly service: SatuSehatConfigurationService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SatuSehatConfigurationAction>(modelAction.SatuSehatConfigurationModelActionTypes.COUNT_SATU_SEHAT_CONFIGURATIONS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.SatuSehatConfigurationActionOK(
						modelAction.SatuSehatConfigurationModelActionTypes.COUNT_SATU_SEHAT_CONFIGURATIONS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SatuSehatConfigurationActionFail(
								modelAction.SatuSehatConfigurationModelActionTypes.COUNT_SATU_SEHAT_CONFIGURATIONS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SatuSehatConfigurationAction>(modelAction.SatuSehatConfigurationModelActionTypes.FETCH_SATU_SEHAT_CONFIGURATION),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.SatuSehatConfigurationActionOK(
						modelAction.SatuSehatConfigurationModelActionTypes.FETCH_SATU_SEHAT_CONFIGURATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SatuSehatConfigurationActionFail(
								modelAction.SatuSehatConfigurationModelActionTypes.FETCH_SATU_SEHAT_CONFIGURATION_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SatuSehatConfigurationAction>(modelAction.SatuSehatConfigurationModelActionTypes.FETCH_ALL_SATU_SEHAT_CONFIGURATION),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.SatuSehatConfigurationActionOK(
						modelAction.SatuSehatConfigurationModelActionTypes.FETCH_ALL_SATU_SEHAT_CONFIGURATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SatuSehatConfigurationActionFail(
								modelAction.SatuSehatConfigurationModelActionTypes.FETCH_ALL_SATU_SEHAT_CONFIGURATION_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SatuSehatConfigurationAction>(modelAction.SatuSehatConfigurationModelActionTypes.FETCH_SATU_SEHAT_CONFIGURATION_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.SatuSehatConfigurationActionOK(
						modelAction.SatuSehatConfigurationModelActionTypes.FETCH_SATU_SEHAT_CONFIGURATION_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SatuSehatConfigurationActionFail(
								modelAction.SatuSehatConfigurationModelActionTypes.FETCH_SATU_SEHAT_CONFIGURATION_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SatuSehatConfigurationAction>(modelAction.SatuSehatConfigurationModelActionTypes.FETCH_LAST_SATU_SEHAT_CONFIGURATION_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.SatuSehatConfigurationActionOK(
						modelAction.SatuSehatConfigurationModelActionTypes.FETCH_LAST_SATU_SEHAT_CONFIGURATION_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SatuSehatConfigurationActionFail(
								modelAction.SatuSehatConfigurationModelActionTypes.FETCH_LAST_SATU_SEHAT_CONFIGURATION_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SatuSehatConfigurationAction>(modelAction.SatuSehatConfigurationModelActionTypes.CREATE_SATU_SEHAT_CONFIGURATION),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as SatuSehatConfigurationModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.SatuSehatConfigurationActionOK(
						modelAction.SatuSehatConfigurationModelActionTypes.CREATE_SATU_SEHAT_CONFIGURATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SatuSehatConfigurationActionFail(
								modelAction.SatuSehatConfigurationModelActionTypes.CREATE_SATU_SEHAT_CONFIGURATION_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SatuSehatConfigurationAction>(modelAction.SatuSehatConfigurationModelActionTypes.CREATE_ALL_SATU_SEHAT_CONFIGURATION),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as SatuSehatConfigurationModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.SatuSehatConfigurationActionOK(
						modelAction.SatuSehatConfigurationModelActionTypes.CREATE_ALL_SATU_SEHAT_CONFIGURATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SatuSehatConfigurationActionFail(
								modelAction.SatuSehatConfigurationModelActionTypes.CREATE_ALL_SATU_SEHAT_CONFIGURATION_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SatuSehatConfigurationAction>(modelAction.SatuSehatConfigurationModelActionTypes.UPDATE_SATU_SEHAT_CONFIGURATION),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as SatuSehatConfigurationModel;
				...
				return this.service.update(new SatuSehatConfigurationModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.SatuSehatConfigurationActionOK(
						modelAction.SatuSehatConfigurationModelActionTypes.UPDATE_SATU_SEHAT_CONFIGURATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SatuSehatConfigurationActionFail(
								modelAction.SatuSehatConfigurationModelActionTypes.UPDATE_SATU_SEHAT_CONFIGURATION_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SatuSehatConfigurationAction>(modelAction.SatuSehatConfigurationModelActionTypes.UPDATE_ALL_SATU_SEHAT_CONFIGURATION),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as SatuSehatConfigurationModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new SatuSehatConfigurationModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.SatuSehatConfigurationActionOK(
						modelAction.SatuSehatConfigurationModelActionTypes.UPDATE_ALL_SATU_SEHAT_CONFIGURATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SatuSehatConfigurationActionFail(
								modelAction.SatuSehatConfigurationModelActionTypes.UPDATE_ALL_SATU_SEHAT_CONFIGURATION_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SatuSehatConfigurationAction>(modelAction.SatuSehatConfigurationModelActionTypes.DELETE_SATU_SEHAT_CONFIGURATION),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.SatuSehatConfigurationActionOK(
						modelAction.SatuSehatConfigurationModelActionTypes.DELETE_SATU_SEHAT_CONFIGURATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SatuSehatConfigurationActionFail(
								modelAction.SatuSehatConfigurationModelActionTypes.DELETE_SATU_SEHAT_CONFIGURATION_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SatuSehatConfigurationAction>(modelAction.SatuSehatConfigurationModelActionTypes.DELETE_SATU_SEHAT_CONFIGURATION_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.SatuSehatConfigurationActionOK(
						modelAction.SatuSehatConfigurationModelActionTypes.DELETE_SATU_SEHAT_CONFIGURATION_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SatuSehatConfigurationActionFail(
								modelAction.SatuSehatConfigurationModelActionTypes.DELETE_SATU_SEHAT_CONFIGURATION_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SatuSehatConfigurationAction>(modelAction.SatuSehatConfigurationModelActionTypes.DELETE_ALL_SATU_SEHAT_CONFIGURATION),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.SatuSehatConfigurationActionOK(
						modelAction.SatuSehatConfigurationModelActionTypes.DELETE_ALL_SATU_SEHAT_CONFIGURATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SatuSehatConfigurationActionFail(
								modelAction.SatuSehatConfigurationModelActionTypes.DELETE_ALL_SATU_SEHAT_CONFIGURATION_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SatuSehatConfigurationAction>(modelAction.SatuSehatConfigurationModelActionTypes.EXPORT_SATU_SEHAT_CONFIGURATION),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.SatuSehatConfigurationActionOK(
						modelAction.SatuSehatConfigurationModelActionTypes.EXPORT_SATU_SEHAT_CONFIGURATION,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SatuSehatConfigurationAction>(modelAction.SatuSehatConfigurationModelActionTypes.EXPORT_ALL_SATU_SEHAT_CONFIGURATION),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.SatuSehatConfigurationActionOK(
						modelAction.SatuSehatConfigurationModelActionTypes.EXPORT_ALL_SATU_SEHAT_CONFIGURATION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SatuSehatConfigurationActionFail(
								modelAction.SatuSehatConfigurationModelActionTypes.EXPORT_ALL_SATU_SEHAT_CONFIGURATION_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SatuSehatConfigurationAction>(modelAction.SatuSehatConfigurationModelActionTypes.EXPORT_SATU_SEHAT_CONFIGURATION_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.SatuSehatConfigurationActionOK(
						modelAction.SatuSehatConfigurationModelActionTypes.EXPORT_SATU_SEHAT_CONFIGURATION_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SatuSehatConfigurationActionFail(
								modelAction.SatuSehatConfigurationModelActionTypes.EXPORT_SATU_SEHAT_CONFIGURATION_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SatuSehatConfigurationAction>(modelAction.SatuSehatConfigurationModelActionTypes.IMPORT_SATU_SEHAT_CONFIGURATIONS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.SatuSehatConfigurationActionOK(
						modelAction.SatuSehatConfigurationModelActionTypes.IMPORT_SATU_SEHAT_CONFIGURATIONS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.SatuSehatConfigurationActionFail(
								modelAction.SatuSehatConfigurationModelActionTypes.IMPORT_SATU_SEHAT_CONFIGURATIONS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SatuSehatConfigurationAction>(modelAction.SatuSehatConfigurationModelActionTypes.FETCH_SATU_SEHAT_CONFIGURATION_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.SatuSehatConfigurationActionOK(
						modelAction.SatuSehatConfigurationModelActionTypes.FETCH_SATU_SEHAT_CONFIGURATION_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.SatuSehatConfigurationActionFail(
								modelAction.SatuSehatConfigurationModelActionTypes.FETCH_SATU_SEHAT_CONFIGURATION_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.SatuSehatConfigurationAction>(modelAction.SatuSehatConfigurationModelActionTypes.FETCH_SATU_SEHAT_CONFIGURATION_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.SatuSehatConfigurationActionOK(
						modelAction.SatuSehatConfigurationModelActionTypes.FETCH_SATU_SEHAT_CONFIGURATION_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.SatuSehatConfigurationActionFail(
								modelAction.SatuSehatConfigurationModelActionTypes.FETCH_SATU_SEHAT_CONFIGURATION_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
