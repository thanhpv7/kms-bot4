...
/**
 * SatuSehatConfigurationCollectionState would store the state of a collection of SatuSehatConfiguration
 */
export interface SatuSehatConfigurationCollectionState extends CollectionState {
 ...
 */
export interface SatuSehatConfigurationModelAudit extends AbstractModelAudit<SatuSehatConfigurationModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * SatuSehatConfigurationModelState would store the state of the model
 */
export interface SatuSehatConfigurationModelState {
	collectionState: {
		[key: string]: SatuSehatConfigurationCollectionState;
	};
	data: {
		[id: string]: SatuSehatConfigurationModel;
	};
	totalCount: number;
	audits: SatuSehatConfigurationModelAudit[];
 ...
 */
export const initialSatuSehatConfigurationCollectionState: SatuSehatConfigurationCollectionState = {
...
/**
 * The initial state of SatuSehatConfigurationModelState
 */
export const initialState: SatuSehatConfigurationModelState = {
	collectionState: {
