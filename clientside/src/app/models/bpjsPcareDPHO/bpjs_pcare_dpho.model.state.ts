...
/**
 * BpjsPcareDPHOCollectionState would store the state of a collection of BpjsPcareDPHO
 */
export interface BpjsPcareDPHOCollectionState extends CollectionState {
 ...
 */
export interface BpjsPcareDPHOModelAudit extends AbstractModelAudit<BpjsPcareDPHOModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsPcareDPHOModelState would store the state of the model
 */
export interface BpjsPcareDPHOModelState {
	collectionState: {
		[key: string]: BpjsPcareDPHOCollectionState;
	};
	data: {
		[id: string]: BpjsPcareDPHOModel;
	};
	totalCount: number;
	audits: BpjsPcareDPHOModelAudit[];
 ...
 */
export const initialBpjsPcareDPHOCollectionState: BpjsPcareDPHOCollectionState = {
...
/**
 * The initial state of BpjsPcareDPHOModelState
 */
export const initialState: BpjsPcareDPHOModelState = {
	collectionState: {
