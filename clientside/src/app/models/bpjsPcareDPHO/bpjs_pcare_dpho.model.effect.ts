...
import * as modelAction from './bpjs_pcare_dpho.model.action';
import {BpjsPcareDPHOService} from '../../services/bpjsPcareDPHO/bpjs_pcare_dpho.service';
...
/**
 * Effect class used for side effects related to BPJS Pcare DPHO model.
 */
@Injectable()
export class BpjsPcareDPHOEffect {
	...
	constructor(
		...
		protected readonly service: BpjsPcareDPHOService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareDPHOAction>(modelAction.BpjsPcareDPHOModelActionTypes.COUNT_BPJS_PCARE_DPHOS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareDPHOActionOK(
						modelAction.BpjsPcareDPHOModelActionTypes.COUNT_BPJS_PCARE_DPHOS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareDPHOActionFail(
								modelAction.BpjsPcareDPHOModelActionTypes.COUNT_BPJS_PCARE_DPHOS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareDPHOAction>(modelAction.BpjsPcareDPHOModelActionTypes.FETCH_BPJS_PCARE_DPHO),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareDPHOActionOK(
						modelAction.BpjsPcareDPHOModelActionTypes.FETCH_BPJS_PCARE_DPHO_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareDPHOActionFail(
								modelAction.BpjsPcareDPHOModelActionTypes.FETCH_BPJS_PCARE_DPHO_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareDPHOAction>(modelAction.BpjsPcareDPHOModelActionTypes.FETCH_ALL_BPJS_PCARE_DPHO),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareDPHOActionOK(
						modelAction.BpjsPcareDPHOModelActionTypes.FETCH_ALL_BPJS_PCARE_DPHO_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareDPHOActionFail(
								modelAction.BpjsPcareDPHOModelActionTypes.FETCH_ALL_BPJS_PCARE_DPHO_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareDPHOAction>(modelAction.BpjsPcareDPHOModelActionTypes.FETCH_BPJS_PCARE_DPHO_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareDPHOActionOK(
						modelAction.BpjsPcareDPHOModelActionTypes.FETCH_BPJS_PCARE_DPHO_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareDPHOActionFail(
								modelAction.BpjsPcareDPHOModelActionTypes.FETCH_BPJS_PCARE_DPHO_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareDPHOAction>(modelAction.BpjsPcareDPHOModelActionTypes.FETCH_LAST_BPJS_PCARE_DPHO_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareDPHOActionOK(
						modelAction.BpjsPcareDPHOModelActionTypes.FETCH_LAST_BPJS_PCARE_DPHO_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareDPHOActionFail(
								modelAction.BpjsPcareDPHOModelActionTypes.FETCH_LAST_BPJS_PCARE_DPHO_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareDPHOAction>(modelAction.BpjsPcareDPHOModelActionTypes.CREATE_BPJS_PCARE_DPHO),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsPcareDPHOModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareDPHOActionOK(
						modelAction.BpjsPcareDPHOModelActionTypes.CREATE_BPJS_PCARE_DPHO_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareDPHOActionFail(
								modelAction.BpjsPcareDPHOModelActionTypes.CREATE_BPJS_PCARE_DPHO_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareDPHOAction>(modelAction.BpjsPcareDPHOModelActionTypes.CREATE_ALL_BPJS_PCARE_DPHO),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsPcareDPHOModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareDPHOActionOK(
						modelAction.BpjsPcareDPHOModelActionTypes.CREATE_ALL_BPJS_PCARE_DPHO_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareDPHOActionFail(
								modelAction.BpjsPcareDPHOModelActionTypes.CREATE_ALL_BPJS_PCARE_DPHO_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareDPHOAction>(modelAction.BpjsPcareDPHOModelActionTypes.UPDATE_BPJS_PCARE_DPHO),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsPcareDPHOModel;
				...
				return this.service.update(new BpjsPcareDPHOModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareDPHOActionOK(
						modelAction.BpjsPcareDPHOModelActionTypes.UPDATE_BPJS_PCARE_DPHO_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareDPHOActionFail(
								modelAction.BpjsPcareDPHOModelActionTypes.UPDATE_BPJS_PCARE_DPHO_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareDPHOAction>(modelAction.BpjsPcareDPHOModelActionTypes.UPDATE_ALL_BPJS_PCARE_DPHO),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsPcareDPHOModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsPcareDPHOModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareDPHOActionOK(
						modelAction.BpjsPcareDPHOModelActionTypes.UPDATE_ALL_BPJS_PCARE_DPHO_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareDPHOActionFail(
								modelAction.BpjsPcareDPHOModelActionTypes.UPDATE_ALL_BPJS_PCARE_DPHO_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareDPHOAction>(modelAction.BpjsPcareDPHOModelActionTypes.DELETE_BPJS_PCARE_DPHO),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareDPHOActionOK(
						modelAction.BpjsPcareDPHOModelActionTypes.DELETE_BPJS_PCARE_DPHO_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareDPHOActionFail(
								modelAction.BpjsPcareDPHOModelActionTypes.DELETE_BPJS_PCARE_DPHO_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareDPHOAction>(modelAction.BpjsPcareDPHOModelActionTypes.DELETE_BPJS_PCARE_DPHO_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareDPHOActionOK(
						modelAction.BpjsPcareDPHOModelActionTypes.DELETE_BPJS_PCARE_DPHO_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareDPHOActionFail(
								modelAction.BpjsPcareDPHOModelActionTypes.DELETE_BPJS_PCARE_DPHO_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareDPHOAction>(modelAction.BpjsPcareDPHOModelActionTypes.DELETE_ALL_BPJS_PCARE_DPHO),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareDPHOActionOK(
						modelAction.BpjsPcareDPHOModelActionTypes.DELETE_ALL_BPJS_PCARE_DPHO_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareDPHOActionFail(
								modelAction.BpjsPcareDPHOModelActionTypes.DELETE_ALL_BPJS_PCARE_DPHO_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareDPHOAction>(modelAction.BpjsPcareDPHOModelActionTypes.EXPORT_BPJS_PCARE_DPHO),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareDPHOActionOK(
						modelAction.BpjsPcareDPHOModelActionTypes.EXPORT_BPJS_PCARE_DPHO,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareDPHOAction>(modelAction.BpjsPcareDPHOModelActionTypes.EXPORT_ALL_BPJS_PCARE_DPHO),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareDPHOActionOK(
						modelAction.BpjsPcareDPHOModelActionTypes.EXPORT_ALL_BPJS_PCARE_DPHO_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareDPHOActionFail(
								modelAction.BpjsPcareDPHOModelActionTypes.EXPORT_ALL_BPJS_PCARE_DPHO_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareDPHOAction>(modelAction.BpjsPcareDPHOModelActionTypes.EXPORT_BPJS_PCARE_DPHO_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareDPHOActionOK(
						modelAction.BpjsPcareDPHOModelActionTypes.EXPORT_BPJS_PCARE_DPHO_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareDPHOActionFail(
								modelAction.BpjsPcareDPHOModelActionTypes.EXPORT_BPJS_PCARE_DPHO_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareDPHOAction>(modelAction.BpjsPcareDPHOModelActionTypes.IMPORT_BPJS_PCARE_DPHOS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsPcareDPHOActionOK(
						modelAction.BpjsPcareDPHOModelActionTypes.IMPORT_BPJS_PCARE_DPHOS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareDPHOActionFail(
								modelAction.BpjsPcareDPHOModelActionTypes.IMPORT_BPJS_PCARE_DPHOS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareDPHOAction>(modelAction.BpjsPcareDPHOModelActionTypes.FETCH_BPJS_PCARE_DPHO_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsPcareDPHOActionOK(
						modelAction.BpjsPcareDPHOModelActionTypes.FETCH_BPJS_PCARE_DPHO_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareDPHOActionFail(
								modelAction.BpjsPcareDPHOModelActionTypes.FETCH_BPJS_PCARE_DPHO_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsPcareDPHOAction>(modelAction.BpjsPcareDPHOModelActionTypes.FETCH_BPJS_PCARE_DPHO_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsPcareDPHOActionOK(
						modelAction.BpjsPcareDPHOModelActionTypes.FETCH_BPJS_PCARE_DPHO_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsPcareDPHOActionFail(
								modelAction.BpjsPcareDPHOModelActionTypes.FETCH_BPJS_PCARE_DPHO_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
