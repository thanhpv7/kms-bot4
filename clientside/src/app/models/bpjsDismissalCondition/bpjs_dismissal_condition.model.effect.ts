...
import * as modelAction from './bpjs_dismissal_condition.model.action';
import {BpjsDismissalConditionService} from '../../services/bpjsDismissalCondition/bpjs_dismissal_condition.service';
...
/**
 * Effect class used for side effects related to BPJS Dismissal Condition model.
 */
@Injectable()
export class BpjsDismissalConditionEffect {
	...
	constructor(
		...
		protected readonly service: BpjsDismissalConditionService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDismissalConditionAction>(modelAction.BpjsDismissalConditionModelActionTypes.COUNT_BPJS_DISMISSAL_CONDITIONS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.BpjsDismissalConditionActionOK(
						modelAction.BpjsDismissalConditionModelActionTypes.COUNT_BPJS_DISMISSAL_CONDITIONS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDismissalConditionActionFail(
								modelAction.BpjsDismissalConditionModelActionTypes.COUNT_BPJS_DISMISSAL_CONDITIONS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDismissalConditionAction>(modelAction.BpjsDismissalConditionModelActionTypes.FETCH_BPJS_DISMISSAL_CONDITION),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsDismissalConditionActionOK(
						modelAction.BpjsDismissalConditionModelActionTypes.FETCH_BPJS_DISMISSAL_CONDITION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDismissalConditionActionFail(
								modelAction.BpjsDismissalConditionModelActionTypes.FETCH_BPJS_DISMISSAL_CONDITION_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDismissalConditionAction>(modelAction.BpjsDismissalConditionModelActionTypes.FETCH_ALL_BPJS_DISMISSAL_CONDITION),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.BpjsDismissalConditionActionOK(
						modelAction.BpjsDismissalConditionModelActionTypes.FETCH_ALL_BPJS_DISMISSAL_CONDITION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDismissalConditionActionFail(
								modelAction.BpjsDismissalConditionModelActionTypes.FETCH_ALL_BPJS_DISMISSAL_CONDITION_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDismissalConditionAction>(modelAction.BpjsDismissalConditionModelActionTypes.FETCH_BPJS_DISMISSAL_CONDITION_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsDismissalConditionActionOK(
						modelAction.BpjsDismissalConditionModelActionTypes.FETCH_BPJS_DISMISSAL_CONDITION_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDismissalConditionActionFail(
								modelAction.BpjsDismissalConditionModelActionTypes.FETCH_BPJS_DISMISSAL_CONDITION_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDismissalConditionAction>(modelAction.BpjsDismissalConditionModelActionTypes.FETCH_LAST_BPJS_DISMISSAL_CONDITION_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsDismissalConditionActionOK(
						modelAction.BpjsDismissalConditionModelActionTypes.FETCH_LAST_BPJS_DISMISSAL_CONDITION_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDismissalConditionActionFail(
								modelAction.BpjsDismissalConditionModelActionTypes.FETCH_LAST_BPJS_DISMISSAL_CONDITION_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDismissalConditionAction>(modelAction.BpjsDismissalConditionModelActionTypes.CREATE_BPJS_DISMISSAL_CONDITION),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as BpjsDismissalConditionModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsDismissalConditionActionOK(
						modelAction.BpjsDismissalConditionModelActionTypes.CREATE_BPJS_DISMISSAL_CONDITION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDismissalConditionActionFail(
								modelAction.BpjsDismissalConditionModelActionTypes.CREATE_BPJS_DISMISSAL_CONDITION_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDismissalConditionAction>(modelAction.BpjsDismissalConditionModelActionTypes.CREATE_ALL_BPJS_DISMISSAL_CONDITION),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as BpjsDismissalConditionModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsDismissalConditionActionOK(
						modelAction.BpjsDismissalConditionModelActionTypes.CREATE_ALL_BPJS_DISMISSAL_CONDITION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDismissalConditionActionFail(
								modelAction.BpjsDismissalConditionModelActionTypes.CREATE_ALL_BPJS_DISMISSAL_CONDITION_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDismissalConditionAction>(modelAction.BpjsDismissalConditionModelActionTypes.UPDATE_BPJS_DISMISSAL_CONDITION),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as BpjsDismissalConditionModel;
				...
				return this.service.update(new BpjsDismissalConditionModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsDismissalConditionActionOK(
						modelAction.BpjsDismissalConditionModelActionTypes.UPDATE_BPJS_DISMISSAL_CONDITION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDismissalConditionActionFail(
								modelAction.BpjsDismissalConditionModelActionTypes.UPDATE_BPJS_DISMISSAL_CONDITION_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDismissalConditionAction>(modelAction.BpjsDismissalConditionModelActionTypes.UPDATE_ALL_BPJS_DISMISSAL_CONDITION),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as BpjsDismissalConditionModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new BpjsDismissalConditionModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.BpjsDismissalConditionActionOK(
						modelAction.BpjsDismissalConditionModelActionTypes.UPDATE_ALL_BPJS_DISMISSAL_CONDITION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDismissalConditionActionFail(
								modelAction.BpjsDismissalConditionModelActionTypes.UPDATE_ALL_BPJS_DISMISSAL_CONDITION_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDismissalConditionAction>(modelAction.BpjsDismissalConditionModelActionTypes.DELETE_BPJS_DISMISSAL_CONDITION),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsDismissalConditionActionOK(
						modelAction.BpjsDismissalConditionModelActionTypes.DELETE_BPJS_DISMISSAL_CONDITION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDismissalConditionActionFail(
								modelAction.BpjsDismissalConditionModelActionTypes.DELETE_BPJS_DISMISSAL_CONDITION_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDismissalConditionAction>(modelAction.BpjsDismissalConditionModelActionTypes.DELETE_BPJS_DISMISSAL_CONDITION_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.BpjsDismissalConditionActionOK(
						modelAction.BpjsDismissalConditionModelActionTypes.DELETE_BPJS_DISMISSAL_CONDITION_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDismissalConditionActionFail(
								modelAction.BpjsDismissalConditionModelActionTypes.DELETE_BPJS_DISMISSAL_CONDITION_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDismissalConditionAction>(modelAction.BpjsDismissalConditionModelActionTypes.DELETE_ALL_BPJS_DISMISSAL_CONDITION),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.BpjsDismissalConditionActionOK(
						modelAction.BpjsDismissalConditionModelActionTypes.DELETE_ALL_BPJS_DISMISSAL_CONDITION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDismissalConditionActionFail(
								modelAction.BpjsDismissalConditionModelActionTypes.DELETE_ALL_BPJS_DISMISSAL_CONDITION_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDismissalConditionAction>(modelAction.BpjsDismissalConditionModelActionTypes.EXPORT_BPJS_DISMISSAL_CONDITION),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsDismissalConditionActionOK(
						modelAction.BpjsDismissalConditionModelActionTypes.EXPORT_BPJS_DISMISSAL_CONDITION,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDismissalConditionAction>(modelAction.BpjsDismissalConditionModelActionTypes.EXPORT_ALL_BPJS_DISMISSAL_CONDITION),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsDismissalConditionActionOK(
						modelAction.BpjsDismissalConditionModelActionTypes.EXPORT_ALL_BPJS_DISMISSAL_CONDITION_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDismissalConditionActionFail(
								modelAction.BpjsDismissalConditionModelActionTypes.EXPORT_ALL_BPJS_DISMISSAL_CONDITION_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDismissalConditionAction>(modelAction.BpjsDismissalConditionModelActionTypes.EXPORT_BPJS_DISMISSAL_CONDITION_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.BpjsDismissalConditionActionOK(
						modelAction.BpjsDismissalConditionModelActionTypes.EXPORT_BPJS_DISMISSAL_CONDITION_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDismissalConditionActionFail(
								modelAction.BpjsDismissalConditionModelActionTypes.EXPORT_BPJS_DISMISSAL_CONDITION_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDismissalConditionAction>(modelAction.BpjsDismissalConditionModelActionTypes.IMPORT_BPJS_DISMISSAL_CONDITIONS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.BpjsDismissalConditionActionOK(
						modelAction.BpjsDismissalConditionModelActionTypes.IMPORT_BPJS_DISMISSAL_CONDITIONS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDismissalConditionActionFail(
								modelAction.BpjsDismissalConditionModelActionTypes.IMPORT_BPJS_DISMISSAL_CONDITIONS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDismissalConditionAction>(modelAction.BpjsDismissalConditionModelActionTypes.FETCH_BPJS_DISMISSAL_CONDITION_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.BpjsDismissalConditionActionOK(
						modelAction.BpjsDismissalConditionModelActionTypes.FETCH_BPJS_DISMISSAL_CONDITION_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDismissalConditionActionFail(
								modelAction.BpjsDismissalConditionModelActionTypes.FETCH_BPJS_DISMISSAL_CONDITION_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.BpjsDismissalConditionAction>(modelAction.BpjsDismissalConditionModelActionTypes.FETCH_BPJS_DISMISSAL_CONDITION_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.BpjsDismissalConditionActionOK(
						modelAction.BpjsDismissalConditionModelActionTypes.FETCH_BPJS_DISMISSAL_CONDITION_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.BpjsDismissalConditionActionFail(
								modelAction.BpjsDismissalConditionModelActionTypes.FETCH_BPJS_DISMISSAL_CONDITION_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
