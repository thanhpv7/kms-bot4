...
/**
 * BpjsDismissalConditionCollectionState would store the state of a collection of BpjsDismissalCondition
 */
export interface BpjsDismissalConditionCollectionState extends CollectionState {
 ...
 */
export interface BpjsDismissalConditionModelAudit extends AbstractModelAudit<BpjsDismissalConditionModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * BpjsDismissalConditionModelState would store the state of the model
 */
export interface BpjsDismissalConditionModelState {
	collectionState: {
		[key: string]: BpjsDismissalConditionCollectionState;
	};
	data: {
		[id: string]: BpjsDismissalConditionModel;
	};
	totalCount: number;
	audits: BpjsDismissalConditionModelAudit[];
 ...
 */
export const initialBpjsDismissalConditionCollectionState: BpjsDismissalConditionCollectionState = {
...
/**
 * The initial state of BpjsDismissalConditionModelState
 */
export const initialState: BpjsDismissalConditionModelState = {
	collectionState: {
