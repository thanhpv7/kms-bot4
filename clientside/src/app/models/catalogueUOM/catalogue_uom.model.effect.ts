...
import * as modelAction from './catalogue_uom.model.action';
import {CatalogueUOMService} from '../../services/catalogueUOM/catalogue_uom.service';
...
/**
 * Effect class used for side effects related to Catalogue UOM model.
 */
@Injectable()
export class CatalogueUOMEffect {
	...
	constructor(
		...
		protected readonly service: CatalogueUOMService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CatalogueUOMAction>(modelAction.CatalogueUOMModelActionTypes.COUNT_CATALOGUE_UOMS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.CatalogueUOMActionOK(
						modelAction.CatalogueUOMModelActionTypes.COUNT_CATALOGUE_UOMS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CatalogueUOMActionFail(
								modelAction.CatalogueUOMModelActionTypes.COUNT_CATALOGUE_UOMS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CatalogueUOMAction>(modelAction.CatalogueUOMModelActionTypes.FETCH_CATALOGUE_UOM),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.CatalogueUOMActionOK(
						modelAction.CatalogueUOMModelActionTypes.FETCH_CATALOGUE_UOM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CatalogueUOMActionFail(
								modelAction.CatalogueUOMModelActionTypes.FETCH_CATALOGUE_UOM_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CatalogueUOMAction>(modelAction.CatalogueUOMModelActionTypes.FETCH_ALL_CATALOGUE_UOM),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.CatalogueUOMActionOK(
						modelAction.CatalogueUOMModelActionTypes.FETCH_ALL_CATALOGUE_UOM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CatalogueUOMActionFail(
								modelAction.CatalogueUOMModelActionTypes.FETCH_ALL_CATALOGUE_UOM_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CatalogueUOMAction>(modelAction.CatalogueUOMModelActionTypes.FETCH_CATALOGUE_UOM_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.CatalogueUOMActionOK(
						modelAction.CatalogueUOMModelActionTypes.FETCH_CATALOGUE_UOM_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CatalogueUOMActionFail(
								modelAction.CatalogueUOMModelActionTypes.FETCH_CATALOGUE_UOM_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CatalogueUOMAction>(modelAction.CatalogueUOMModelActionTypes.FETCH_LAST_CATALOGUE_UOM_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.CatalogueUOMActionOK(
						modelAction.CatalogueUOMModelActionTypes.FETCH_LAST_CATALOGUE_UOM_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CatalogueUOMActionFail(
								modelAction.CatalogueUOMModelActionTypes.FETCH_LAST_CATALOGUE_UOM_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CatalogueUOMAction>(modelAction.CatalogueUOMModelActionTypes.CREATE_CATALOGUE_UOM),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as CatalogueUOMModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.CatalogueUOMActionOK(
						modelAction.CatalogueUOMModelActionTypes.CREATE_CATALOGUE_UOM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CatalogueUOMActionFail(
								modelAction.CatalogueUOMModelActionTypes.CREATE_CATALOGUE_UOM_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CatalogueUOMAction>(modelAction.CatalogueUOMModelActionTypes.CREATE_ALL_CATALOGUE_UOM),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as CatalogueUOMModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.CatalogueUOMActionOK(
						modelAction.CatalogueUOMModelActionTypes.CREATE_ALL_CATALOGUE_UOM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CatalogueUOMActionFail(
								modelAction.CatalogueUOMModelActionTypes.CREATE_ALL_CATALOGUE_UOM_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CatalogueUOMAction>(modelAction.CatalogueUOMModelActionTypes.UPDATE_CATALOGUE_UOM),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as CatalogueUOMModel;
				...
				return this.service.update(new CatalogueUOMModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.CatalogueUOMActionOK(
						modelAction.CatalogueUOMModelActionTypes.UPDATE_CATALOGUE_UOM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CatalogueUOMActionFail(
								modelAction.CatalogueUOMModelActionTypes.UPDATE_CATALOGUE_UOM_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CatalogueUOMAction>(modelAction.CatalogueUOMModelActionTypes.UPDATE_ALL_CATALOGUE_UOM),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as CatalogueUOMModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new CatalogueUOMModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.CatalogueUOMActionOK(
						modelAction.CatalogueUOMModelActionTypes.UPDATE_ALL_CATALOGUE_UOM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CatalogueUOMActionFail(
								modelAction.CatalogueUOMModelActionTypes.UPDATE_ALL_CATALOGUE_UOM_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CatalogueUOMAction>(modelAction.CatalogueUOMModelActionTypes.DELETE_CATALOGUE_UOM),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.CatalogueUOMActionOK(
						modelAction.CatalogueUOMModelActionTypes.DELETE_CATALOGUE_UOM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CatalogueUOMActionFail(
								modelAction.CatalogueUOMModelActionTypes.DELETE_CATALOGUE_UOM_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CatalogueUOMAction>(modelAction.CatalogueUOMModelActionTypes.DELETE_CATALOGUE_UOM_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.CatalogueUOMActionOK(
						modelAction.CatalogueUOMModelActionTypes.DELETE_CATALOGUE_UOM_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CatalogueUOMActionFail(
								modelAction.CatalogueUOMModelActionTypes.DELETE_CATALOGUE_UOM_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CatalogueUOMAction>(modelAction.CatalogueUOMModelActionTypes.DELETE_ALL_CATALOGUE_UOM),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.CatalogueUOMActionOK(
						modelAction.CatalogueUOMModelActionTypes.DELETE_ALL_CATALOGUE_UOM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CatalogueUOMActionFail(
								modelAction.CatalogueUOMModelActionTypes.DELETE_ALL_CATALOGUE_UOM_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CatalogueUOMAction>(modelAction.CatalogueUOMModelActionTypes.EXPORT_CATALOGUE_UOM),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.CatalogueUOMActionOK(
						modelAction.CatalogueUOMModelActionTypes.EXPORT_CATALOGUE_UOM,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CatalogueUOMAction>(modelAction.CatalogueUOMModelActionTypes.EXPORT_ALL_CATALOGUE_UOM),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.CatalogueUOMActionOK(
						modelAction.CatalogueUOMModelActionTypes.EXPORT_ALL_CATALOGUE_UOM_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CatalogueUOMActionFail(
								modelAction.CatalogueUOMModelActionTypes.EXPORT_ALL_CATALOGUE_UOM_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CatalogueUOMAction>(modelAction.CatalogueUOMModelActionTypes.EXPORT_CATALOGUE_UOM_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.CatalogueUOMActionOK(
						modelAction.CatalogueUOMModelActionTypes.EXPORT_CATALOGUE_UOM_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CatalogueUOMActionFail(
								modelAction.CatalogueUOMModelActionTypes.EXPORT_CATALOGUE_UOM_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CatalogueUOMAction>(modelAction.CatalogueUOMModelActionTypes.IMPORT_CATALOGUE_UOMS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.CatalogueUOMActionOK(
						modelAction.CatalogueUOMModelActionTypes.IMPORT_CATALOGUE_UOMS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.CatalogueUOMActionFail(
								modelAction.CatalogueUOMModelActionTypes.IMPORT_CATALOGUE_UOMS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CatalogueUOMAction>(modelAction.CatalogueUOMModelActionTypes.FETCH_CATALOGUE_UOM_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.CatalogueUOMActionOK(
						modelAction.CatalogueUOMModelActionTypes.FETCH_CATALOGUE_UOM_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.CatalogueUOMActionFail(
								modelAction.CatalogueUOMModelActionTypes.FETCH_CATALOGUE_UOM_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.CatalogueUOMAction>(modelAction.CatalogueUOMModelActionTypes.FETCH_CATALOGUE_UOM_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.CatalogueUOMActionOK(
						modelAction.CatalogueUOMModelActionTypes.FETCH_CATALOGUE_UOM_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.CatalogueUOMActionFail(
								modelAction.CatalogueUOMModelActionTypes.FETCH_CATALOGUE_UOM_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
