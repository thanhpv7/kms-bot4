...
/**
 * CatalogueUOMCollectionState would store the state of a collection of CatalogueUOM
 */
export interface CatalogueUOMCollectionState extends CollectionState {
 ...
 */
export interface CatalogueUOMModelAudit extends AbstractModelAudit<CatalogueUOMModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * CatalogueUOMModelState would store the state of the model
 */
export interface CatalogueUOMModelState {
	collectionState: {
		[key: string]: CatalogueUOMCollectionState;
	};
	data: {
		[id: string]: CatalogueUOMModel;
	};
	totalCount: number;
	audits: CatalogueUOMModelAudit[];
 ...
 */
export const initialCatalogueUOMCollectionState: CatalogueUOMCollectionState = {
...
/**
 * The initial state of CatalogueUOMModelState
 */
export const initialState: CatalogueUOMModelState = {
	collectionState: {
