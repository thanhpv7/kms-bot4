...
/**
 * RegistrationUserCollectionState would store the state of a collection of RegistrationUser
 */
export interface RegistrationUserCollectionState extends CollectionState {
 ...
 */
export interface RegistrationUserModelAudit extends AbstractModelAudit<RegistrationUserModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * RegistrationUserModelState would store the state of the model
 */
export interface RegistrationUserModelState {
	collectionState: {
		[key: string]: RegistrationUserCollectionState;
	};
	data: {
		[id: string]: RegistrationUserModel;
	};
	totalCount: number;
	audits: RegistrationUserModelAudit[];
 ...
 */
export const initialRegistrationUserCollectionState: RegistrationUserCollectionState = {
...
/**
 * The initial state of RegistrationUserModelState
 */
export const initialState: RegistrationUserModelState = {
	collectionState: {
