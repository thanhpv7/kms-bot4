...
import * as modelAction from './registration_user.model.action';
import {RegistrationUserService} from '../../services/registrationUser/registration_user.service';
...
/**
 * Effect class used for side effects related to Registration User model.
 */
@Injectable()
export class RegistrationUserEffect {
	...
	constructor(
		...
		protected readonly service: RegistrationUserService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RegistrationUserAction>(modelAction.RegistrationUserModelActionTypes.COUNT_REGISTRATION_USERS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.RegistrationUserActionOK(
						modelAction.RegistrationUserModelActionTypes.COUNT_REGISTRATION_USERS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RegistrationUserActionFail(
								modelAction.RegistrationUserModelActionTypes.COUNT_REGISTRATION_USERS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RegistrationUserAction>(modelAction.RegistrationUserModelActionTypes.FETCH_REGISTRATION_USER),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.RegistrationUserActionOK(
						modelAction.RegistrationUserModelActionTypes.FETCH_REGISTRATION_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RegistrationUserActionFail(
								modelAction.RegistrationUserModelActionTypes.FETCH_REGISTRATION_USER_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RegistrationUserAction>(modelAction.RegistrationUserModelActionTypes.FETCH_ALL_REGISTRATION_USER),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.RegistrationUserActionOK(
						modelAction.RegistrationUserModelActionTypes.FETCH_ALL_REGISTRATION_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RegistrationUserActionFail(
								modelAction.RegistrationUserModelActionTypes.FETCH_ALL_REGISTRATION_USER_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RegistrationUserAction>(modelAction.RegistrationUserModelActionTypes.FETCH_REGISTRATION_USER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.RegistrationUserActionOK(
						modelAction.RegistrationUserModelActionTypes.FETCH_REGISTRATION_USER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RegistrationUserActionFail(
								modelAction.RegistrationUserModelActionTypes.FETCH_REGISTRATION_USER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RegistrationUserAction>(modelAction.RegistrationUserModelActionTypes.FETCH_LAST_REGISTRATION_USER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.RegistrationUserActionOK(
						modelAction.RegistrationUserModelActionTypes.FETCH_LAST_REGISTRATION_USER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RegistrationUserActionFail(
								modelAction.RegistrationUserModelActionTypes.FETCH_LAST_REGISTRATION_USER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RegistrationUserAction>(modelAction.RegistrationUserModelActionTypes.CREATE_REGISTRATION_USER),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as RegistrationUserModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.RegistrationUserActionOK(
						modelAction.RegistrationUserModelActionTypes.CREATE_REGISTRATION_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RegistrationUserActionFail(
								modelAction.RegistrationUserModelActionTypes.CREATE_REGISTRATION_USER_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RegistrationUserAction>(modelAction.RegistrationUserModelActionTypes.CREATE_ALL_REGISTRATION_USER),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as RegistrationUserModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.RegistrationUserActionOK(
						modelAction.RegistrationUserModelActionTypes.CREATE_ALL_REGISTRATION_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RegistrationUserActionFail(
								modelAction.RegistrationUserModelActionTypes.CREATE_ALL_REGISTRATION_USER_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RegistrationUserAction>(modelAction.RegistrationUserModelActionTypes.UPDATE_REGISTRATION_USER),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as RegistrationUserModel;
				...
				return this.service.update(new RegistrationUserModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.RegistrationUserActionOK(
						modelAction.RegistrationUserModelActionTypes.UPDATE_REGISTRATION_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RegistrationUserActionFail(
								modelAction.RegistrationUserModelActionTypes.UPDATE_REGISTRATION_USER_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RegistrationUserAction>(modelAction.RegistrationUserModelActionTypes.UPDATE_ALL_REGISTRATION_USER),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as RegistrationUserModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new RegistrationUserModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.RegistrationUserActionOK(
						modelAction.RegistrationUserModelActionTypes.UPDATE_ALL_REGISTRATION_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RegistrationUserActionFail(
								modelAction.RegistrationUserModelActionTypes.UPDATE_ALL_REGISTRATION_USER_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RegistrationUserAction>(modelAction.RegistrationUserModelActionTypes.DELETE_REGISTRATION_USER),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.RegistrationUserActionOK(
						modelAction.RegistrationUserModelActionTypes.DELETE_REGISTRATION_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RegistrationUserActionFail(
								modelAction.RegistrationUserModelActionTypes.DELETE_REGISTRATION_USER_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RegistrationUserAction>(modelAction.RegistrationUserModelActionTypes.DELETE_REGISTRATION_USER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.RegistrationUserActionOK(
						modelAction.RegistrationUserModelActionTypes.DELETE_REGISTRATION_USER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RegistrationUserActionFail(
								modelAction.RegistrationUserModelActionTypes.DELETE_REGISTRATION_USER_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RegistrationUserAction>(modelAction.RegistrationUserModelActionTypes.DELETE_ALL_REGISTRATION_USER),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.RegistrationUserActionOK(
						modelAction.RegistrationUserModelActionTypes.DELETE_ALL_REGISTRATION_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RegistrationUserActionFail(
								modelAction.RegistrationUserModelActionTypes.DELETE_ALL_REGISTRATION_USER_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RegistrationUserAction>(modelAction.RegistrationUserModelActionTypes.EXPORT_REGISTRATION_USER),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.RegistrationUserActionOK(
						modelAction.RegistrationUserModelActionTypes.EXPORT_REGISTRATION_USER,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RegistrationUserAction>(modelAction.RegistrationUserModelActionTypes.EXPORT_ALL_REGISTRATION_USER),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.RegistrationUserActionOK(
						modelAction.RegistrationUserModelActionTypes.EXPORT_ALL_REGISTRATION_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RegistrationUserActionFail(
								modelAction.RegistrationUserModelActionTypes.EXPORT_ALL_REGISTRATION_USER_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RegistrationUserAction>(modelAction.RegistrationUserModelActionTypes.EXPORT_REGISTRATION_USER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.RegistrationUserActionOK(
						modelAction.RegistrationUserModelActionTypes.EXPORT_REGISTRATION_USER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RegistrationUserActionFail(
								modelAction.RegistrationUserModelActionTypes.EXPORT_REGISTRATION_USER_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RegistrationUserAction>(modelAction.RegistrationUserModelActionTypes.IMPORT_REGISTRATION_USERS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.RegistrationUserActionOK(
						modelAction.RegistrationUserModelActionTypes.IMPORT_REGISTRATION_USERS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.RegistrationUserActionFail(
								modelAction.RegistrationUserModelActionTypes.IMPORT_REGISTRATION_USERS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RegistrationUserAction>(modelAction.RegistrationUserModelActionTypes.FETCH_REGISTRATION_USER_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.RegistrationUserActionOK(
						modelAction.RegistrationUserModelActionTypes.FETCH_REGISTRATION_USER_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.RegistrationUserActionFail(
								modelAction.RegistrationUserModelActionTypes.FETCH_REGISTRATION_USER_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.RegistrationUserAction>(modelAction.RegistrationUserModelActionTypes.FETCH_REGISTRATION_USER_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.RegistrationUserActionOK(
						modelAction.RegistrationUserModelActionTypes.FETCH_REGISTRATION_USER_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.RegistrationUserActionFail(
								modelAction.RegistrationUserModelActionTypes.FETCH_REGISTRATION_USER_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
