...
/**
 * MedicalRecordUserCollectionState would store the state of a collection of MedicalRecordUser
 */
export interface MedicalRecordUserCollectionState extends CollectionState {
 ...
 */
export interface MedicalRecordUserModelAudit extends AbstractModelAudit<MedicalRecordUserModel> {
	// % protected region % [Add any audit properties here] off begin
	// % protected region % [Add any audit properties here] end
}

/**
 * MedicalRecordUserModelState would store the state of the model
 */
export interface MedicalRecordUserModelState {
	collectionState: {
		[key: string]: MedicalRecordUserCollectionState;
	};
	data: {
		[id: string]: MedicalRecordUserModel;
	};
	totalCount: number;
	audits: MedicalRecordUserModelAudit[];
 ...
 */
export const initialMedicalRecordUserCollectionState: MedicalRecordUserCollectionState = {
...
/**
 * The initial state of MedicalRecordUserModelState
 */
export const initialState: MedicalRecordUserModelState = {
	collectionState: {
