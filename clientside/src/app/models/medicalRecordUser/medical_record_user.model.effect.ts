...
import * as modelAction from './medical_record_user.model.action';
import {MedicalRecordUserService} from '../../services/medicalRecordUser/medical_record_user.service';
...
/**
 * Effect class used for side effects related to Medical Record user model.
 */
@Injectable()
export class MedicalRecordUserEffect {
	...
	constructor(
		...
		protected readonly service: MedicalRecordUserService,
	...
	countModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalRecordUserAction>(modelAction.MedicalRecordUserModelActionTypes.COUNT_MEDICAL_RECORD_USERS),
			...
			concatMap((action) => {
				...
				return this.service.count().pipe(
					...
					map(stateConfig => new modelAction.MedicalRecordUserActionOK(
						modelAction.MedicalRecordUserModelActionTypes.COUNT_MEDICAL_RECORD_USERS_OK,
						{
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalRecordUserActionFail(
								modelAction.MedicalRecordUserModelActionTypes.COUNT_MEDICAL_RECORD_USERS_FAIL,
								err
							)
						];
					}),
	...
	fetchedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalRecordUserAction>(modelAction.MedicalRecordUserModelActionTypes.FETCH_MEDICAL_RECORD_USER),
			...
			concatMap((action) => {
				...
				return this.service.get(modelId, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalRecordUserActionOK(
						modelAction.MedicalRecordUserModelActionTypes.FETCH_MEDICAL_RECORD_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalRecordUserActionFail(
								modelAction.MedicalRecordUserModelActionTypes.FETCH_MEDICAL_RECORD_USER_FAIL,
								err,
								{
	...
	fetchedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalRecordUserAction>(modelAction.MedicalRecordUserModelActionTypes.FETCH_ALL_MEDICAL_RECORD_USER),
			...
			concatMap((action) => {
				...
				return this.service.getAll().pipe(
					...
					map(stateConfig => new modelAction.MedicalRecordUserActionOK(
						modelAction.MedicalRecordUserModelActionTypes.FETCH_ALL_MEDICAL_RECORD_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalRecordUserActionFail(
								modelAction.MedicalRecordUserModelActionTypes.FETCH_ALL_MEDICAL_RECORD_USER_FAIL,
								err
							)
						];
					}),
	...
	fetchModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalRecordUserAction>(modelAction.MedicalRecordUserModelActionTypes.FETCH_MEDICAL_RECORD_USER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalRecordUserActionOK(
						modelAction.MedicalRecordUserModelActionTypes.FETCH_MEDICAL_RECORD_USER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalRecordUserActionFail(
								modelAction.MedicalRecordUserModelActionTypes.FETCH_MEDICAL_RECORD_USER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	fetchLastModelWithQuery = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalRecordUserAction>(modelAction.MedicalRecordUserModelActionTypes.FETCH_LAST_MEDICAL_RECORD_USER_WITH_QUERY),
			...
			concatMap((action) => {
				...
				return this.service.getLastWithQuery(queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalRecordUserActionOK(
						modelAction.MedicalRecordUserModelActionTypes.FETCH_LAST_MEDICAL_RECORD_USER_WITH_QUERY_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalRecordUserActionFail(
								modelAction.MedicalRecordUserModelActionTypes.FETCH_LAST_MEDICAL_RECORD_USER_WITH_QUERY_FAIL,
								err
							)
						];
					}),
	...
	createdModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalRecordUserAction>(modelAction.MedicalRecordUserModelActionTypes.CREATE_MEDICAL_RECORD_USER),
			...
			concatMap((action) => {
				const modelToBeCreated = action.stateConfig.targetModel as MedicalRecordUserModel;
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.create(modelToBeCreated, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalRecordUserActionOK(
						modelAction.MedicalRecordUserModelActionTypes.CREATE_MEDICAL_RECORD_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalRecordUserActionFail(
								modelAction.MedicalRecordUserModelActionTypes.CREATE_MEDICAL_RECORD_USER_FAIL,
								err,
								{
	...
	createAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalRecordUserAction>(modelAction.MedicalRecordUserModelActionTypes.CREATE_ALL_MEDICAL_RECORD_USER),
			...
			concatMap((action) => {
				const modelsToCreate = action.stateConfig.targetModels as MedicalRecordUserModel[];
				const collectionId = action.stateConfig.collectionId;
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.createAll(modelsToCreate, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalRecordUserActionOK(
						modelAction.MedicalRecordUserModelActionTypes.CREATE_ALL_MEDICAL_RECORD_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalRecordUserActionFail(
								modelAction.MedicalRecordUserModelActionTypes.CREATE_ALL_MEDICAL_RECORD_USER_FAIL,
								err,
								{
	...
	updatedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalRecordUserAction>(modelAction.MedicalRecordUserModelActionTypes.UPDATE_MEDICAL_RECORD_USER),
			...
			concatMap((action) => {
				const modelToBeUpdated = action.stateConfig.targetModel as MedicalRecordUserModel;
				...
				return this.service.update(new MedicalRecordUserModel({
					...modelToBeUpdated,
					...updates
				}), queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalRecordUserActionOK(
						modelAction.MedicalRecordUserModelActionTypes.UPDATE_MEDICAL_RECORD_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalRecordUserActionFail(
								modelAction.MedicalRecordUserModelActionTypes.UPDATE_MEDICAL_RECORD_USER_FAIL,
								err,
								{
	...
	updateAllModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalRecordUserAction>(modelAction.MedicalRecordUserModelActionTypes.UPDATE_ALL_MEDICAL_RECORD_USER),
			...
			concatMap((action) => {
				const modelsToUpdate = action.stateConfig.targetModels as MedicalRecordUserModel[];
				const updates = action.stateConfig.updates as object[];
				const updatedModels = _.zipWith(modelsToUpdate, updates, (targetModel, update) => new MedicalRecordUserModel({
					...targetModel,
					...update
				}));
				const queryParams = action.stateConfig.queryParams;
				...
				return this.service.updateAll(updatedModels, queryParams).pipe(
					...
					map(stateConfig => new modelAction.MedicalRecordUserActionOK(
						modelAction.MedicalRecordUserModelActionTypes.UPDATE_ALL_MEDICAL_RECORD_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalRecordUserActionFail(
								modelAction.MedicalRecordUserModelActionTypes.UPDATE_ALL_MEDICAL_RECORD_USER_FAIL,
								err,
								{
	...
	deletedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalRecordUserAction>(modelAction.MedicalRecordUserModelActionTypes.DELETE_MEDICAL_RECORD_USER),
			...
			concatMap((action) => {
				...
				return this.service.delete(modelIdToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.MedicalRecordUserActionOK(
						modelAction.MedicalRecordUserModelActionTypes.DELETE_MEDICAL_RECORD_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalRecordUserActionFail(
								modelAction.MedicalRecordUserModelActionTypes.DELETE_MEDICAL_RECORD_USER_FAIL,
								err,
								{
	...
	deletedModelExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalRecordUserAction>(modelAction.MedicalRecordUserModelActionTypes.DELETE_MEDICAL_RECORD_USER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.deleteExcludingIds(modelIdsToBeExcluded).pipe(
					...
					map(stateConfig => new modelAction.MedicalRecordUserActionOK(
						modelAction.MedicalRecordUserModelActionTypes.DELETE_MEDICAL_RECORD_USER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalRecordUserActionFail(
								modelAction.MedicalRecordUserModelActionTypes.DELETE_MEDICAL_RECORD_USER_EXCLUDING_IDS_FAIL,
								err,
								{
	...
	deletedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalRecordUserAction>(modelAction.MedicalRecordUserModelActionTypes.DELETE_ALL_MEDICAL_RECORD_USER),
			...
			concatMap((action) => {
				...
				return this.service.deleteAll(modelIdsToBeDeleted).pipe(
					...
					map(stateConfig => new modelAction.MedicalRecordUserActionOK(
						modelAction.MedicalRecordUserModelActionTypes.DELETE_ALL_MEDICAL_RECORD_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalRecordUserActionFail(
								modelAction.MedicalRecordUserModelActionTypes.DELETE_ALL_MEDICAL_RECORD_USER_FAIL,
								err,
								{
	...
	exportedModel = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalRecordUserAction>(modelAction.MedicalRecordUserModelActionTypes.EXPORT_MEDICAL_RECORD_USER),
			...
			concatMap((action) => {
				...
				return this.service.export(modelIdToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicalRecordUserActionOK(
						modelAction.MedicalRecordUserModelActionTypes.EXPORT_MEDICAL_RECORD_USER,
						{
							...action.stateConfig,
							...stateConfig,
	...
	exportedModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalRecordUserAction>(modelAction.MedicalRecordUserModelActionTypes.EXPORT_ALL_MEDICAL_RECORD_USER),
			...
			concatMap((action) => {
				...
				return this.service.exportAll(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicalRecordUserActionOK(
						modelAction.MedicalRecordUserModelActionTypes.EXPORT_ALL_MEDICAL_RECORD_USER_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalRecordUserActionFail(
								modelAction.MedicalRecordUserModelActionTypes.EXPORT_ALL_MEDICAL_RECORD_USER_FAIL,
								err,
								{
	...
	exportedModelsExcludingIds = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalRecordUserAction>(modelAction.MedicalRecordUserModelActionTypes.EXPORT_MEDICAL_RECORD_USER_EXCLUDING_IDS),
			...
			concatMap((action) => {
				...
				return this.service.exportModelsExcludingIds(modelIdsToBeExported).pipe(
					...
					map(stateConfig => new modelAction.MedicalRecordUserActionOK(
						modelAction.MedicalRecordUserModelActionTypes.EXPORT_MEDICAL_RECORD_USER_EXCLUDING_IDS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalRecordUserActionFail(
								modelAction.MedicalRecordUserModelActionTypes.EXPORT_MEDICAL_RECORD_USER_EXCLUDING_IDS_FAIL,
								err,
								{
									targetModelIds: modelIdsToBeExported,
								}
	...
	importModels = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalRecordUserAction>(modelAction.MedicalRecordUserModelActionTypes.IMPORT_MEDICAL_RECORD_USERS),
			...
			concatMap((action) => {
				...
				return this.service.importModels(file).pipe(
					...
					map(stateConfig => new modelAction.MedicalRecordUserActionOK(
						modelAction.MedicalRecordUserModelActionTypes.IMPORT_MEDICAL_RECORD_USERS_OK,
						{
							...action.stateConfig,
							...stateConfig,
					...
					catchError((err) => {
						return [
							new modelAction.MedicalRecordUserActionFail(
								modelAction.MedicalRecordUserModelActionTypes.IMPORT_MEDICAL_RECORD_USERS_FAIL,
								err,
								{
									targetModelIds: [],
								}
	...
	fetchedAudits = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalRecordUserAction>(modelAction.MedicalRecordUserModelActionTypes.FETCH_MEDICAL_RECORD_USER_AUDIT),
			...
			concatMap((action) => {
				...
				return this.service.getAudits().pipe(
					...
					map(audits => new modelAction.MedicalRecordUserActionOK(
						modelAction.MedicalRecordUserModelActionTypes.FETCH_MEDICAL_RECORD_USER_AUDIT_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.MedicalRecordUserActionFail(
								modelAction.MedicalRecordUserModelActionTypes.FETCH_MEDICAL_RECORD_USER_AUDIT_FAIL,
								err
							)
						];
					}),
	...
	fetchedAuditsByEntityId = createEffect(
		() => this.action$.pipe(
			...
			ofType<modelAction.MedicalRecordUserAction>(modelAction.MedicalRecordUserModelActionTypes.FETCH_MEDICAL_RECORD_USER_AUDITS_BY_ENTITY_ID),
			...
			concatMap((action) => {
				...
				return this.service.getAuditsByEntityId(entityId).pipe(
					...
					map(audits => new modelAction.MedicalRecordUserActionOK(
						modelAction.MedicalRecordUserModelActionTypes.FETCH_MEDICAL_RECORD_USER_AUDITS_BY_ENTITY_ID_OK,
						of({}),
						action.afterwardActions
					...
					catchError((err) => {
						return [
							new modelAction.MedicalRecordUserActionFail(
								modelAction.MedicalRecordUserModelActionTypes.FETCH_MEDICAL_RECORD_USER_AUDITS_BY_ENTITY_ID_FAIL,
								err
							)
						];
					}),
