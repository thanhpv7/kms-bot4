...
export class SearchComponent extends AbstractComponent implements OnInit {
	...
	forceTriggerSearch() {
		...
		// % protected region % [Add any additional logic after force trigger search event] off begin
		// % protected region % [Add any additional logic after force trigger search event] end
	}
