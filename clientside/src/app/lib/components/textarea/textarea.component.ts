...
export class TextareaComponent extends AbstractInputComponent implements OnInit, OnChanges, ControlValueAccessor {
	...
	constructor(
		...
		// % protected region % [Add any additional constructor logic before after process here] off begin
		// % protected region % [Add any additional constructor logic before after process here] end
	}
	...
	textAreaInput(value) {
		...
		// % protected region % [Add any additional logic after textarea input event] off begin
		// % protected region % [Add any additional logic after textarea input event] end
	}
