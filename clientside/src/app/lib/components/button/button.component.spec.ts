...
describe('Button component', () => {
	...
	it('should have correct default classes and properties', () => {
		const expectedClasses = [
			...
			'icon-left',
			'btn--solid',
			// % protected region % [Add any additional custom classes here (1)] off begin
			// % protected region % [Add any additional custom classes here (1)] end
		];
	...
	it('should have correct classes when add more classes', () => {
		...
		const expectedClasses = [
			...
			'btn--solid',
			...additionalClasses,
			// % protected region % [Add any additional custom classes here (2)] off begin
			// % protected region % [Add any additional custom classes here (2)] end
		];
