...
export class RadioButtonComponent extends AbstractInputComponent implements OnInit, OnChanges {
	...
	constructor(private changeDetector: ChangeDetectorRef) {
		...
		// % protected region % [Add any additional logic in constructor after default process] off begin
		// % protected region % [Add any additional logic in constructor after default process] end
	}
