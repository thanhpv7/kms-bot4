...
import {ButtonSize, ButtonStyle, ButtonAccentColour} from '../button/button.component';
...
export interface FilterQuestion {
	...
	// % protected region % [Override the default types for the config element here] off begin
	/**
	 * Configurations for the element component
	 */
	config: DropdownConfig | DatepickerConfig;
	// % protected region % [Override the default types for the config element here] end
...
export class CollectionFilterComponent extends AbstractComponent implements OnInit {
	...
	/**
	 * Copy of the ButtonAccentColour Enum
	 */
	...
	onFilterButtonClick() {
		...
		// % protected region % [Add any additional logic here after the main logic of filter button click] off begin
		// % protected region % [Add any additional logic here after the main logic of filter button click] end
	}
	...
	onClearButtonClick() {
		...
		// % protected region % [Add any additional onClearButtonClick logic after constructing emit event here] off begin
		// % protected region % [Add any additional onClearButtonClick logic after constructing emit event here] end
		...
		// % protected region % [Add any additional onClearButtonClick logic before emitting the event here] off begin
		// % protected region % [Add any additional onClearButtonClick logic before emitting the event here] end
