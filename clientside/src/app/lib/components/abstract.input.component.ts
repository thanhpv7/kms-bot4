...
export class InputErrorMessageComponent extends AbstractComponent
		...
		// % protected region % [Add any additional interfaces to implement here] end
{
	 ...
	 */
	constructor() {
		// % protected region % [Add any additional before constructor logic before default process here] off begin
		// % protected region % [Add any additional before constructor logic before default process here] end

		super();

		// % protected region % [Add any additional after constructor logic before default process here] off begin
		// % protected region % [Add any additional after constructor logic before default process here] end
	}
	...
	ngOnChanges(changes: SimpleChanges): void {
		...
		// % protected region % [Add any additional logic after onChange] off begin
		// % protected region % [Add any additional logic after onChange] end
	}
