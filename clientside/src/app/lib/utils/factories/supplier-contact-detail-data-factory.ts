...
import {SupplierContactDetailModel} from '../../../models/supplierContactDetail/supplier_contact_detail.model';
import * as faker from 'faker';

export class SupplierContactDetailDataFactory extends AbstractDataFactory<SupplierContactDetailModel> {
	...
	create(): SupplierContactDetailModel {
		let newModel = new SupplierContactDetailModel();
	...
	createAll(size: number = 10): SupplierContactDetailModel[] {
		let newModels: SupplierContactDetailModel[] = [];
	...
	/**
	 * Given a blank model of type Supplier Contact Detail, populate the model with its properties.
	 ...
	 */
	populate(model: SupplierContactDetailModel) {
