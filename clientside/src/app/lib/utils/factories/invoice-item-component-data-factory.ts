...
import {InvoiceItemComponentModel} from '../../../models/invoiceItemComponent/invoice_item_component.model';
import * as faker from 'faker';

export class InvoiceItemComponentDataFactory extends AbstractDataFactory<InvoiceItemComponentModel> {
	...
	create(): InvoiceItemComponentModel {
		let newModel = new InvoiceItemComponentModel();
	...
	createAll(size: number = 10): InvoiceItemComponentModel[] {
		let newModels: InvoiceItemComponentModel[] = [];
	...
	/**
	 * Given a blank model of type Invoice Item Component, populate the model with its properties.
	 ...
	 */
	populate(model: InvoiceItemComponentModel) {
