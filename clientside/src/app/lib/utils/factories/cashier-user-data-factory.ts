...
export class CashierUserDataFactory extends UserDataFactory<CashierUserModel> {
	...
	create(): CashierUserModel {
		let newModel = new CashierUserModel();
	...
	createAll(size: number = 10): CashierUserModel[] {
		let newModels: CashierUserModel[] = [];
	...
	/**
	 * Given a blank model of type Cashier User, populate the model with its properties.
	 ...
	 */
	populate(model: CashierUserModel) {
