...
export class PcareReferensiSaranaDataFactory extends AbstractDataFactory<PcareReferensiSaranaModel> {
	...
	create(): PcareReferensiSaranaModel {
		let newModel = new PcareReferensiSaranaModel();
	...
	createAll(size: number = 10): PcareReferensiSaranaModel[] {
		let newModels: PcareReferensiSaranaModel[] = [];
	...
	/**
	 * Given a blank model of type PCare Referensi Sarana, populate the model with its properties.
	 ...
	 */
	populate(model: PcareReferensiSaranaModel) {
		...
		model.kodeSarana = faker.random.words();
		model.namaSarana = faker.random.words();
