...
export class WarehouseUserDataFactory extends UserDataFactory<WarehouseUserModel> {
	...
	create(): WarehouseUserModel {
		let newModel = new WarehouseUserModel();
	...
	createAll(size: number = 10): WarehouseUserModel[] {
		let newModels: WarehouseUserModel[] = [];
	...
	/**
	 * Given a blank model of type Warehouse User, populate the model with its properties.
	 ...
	 */
	populate(model: WarehouseUserModel) {
