...
export class DiagnosticSupportGeneralConfigurationDataFactory extends AbstractDataFactory<DiagnosticSupportGeneralConfigurationModel> {
	...
	create(): DiagnosticSupportGeneralConfigurationModel {
		let newModel = new DiagnosticSupportGeneralConfigurationModel();
	...
	createAll(size: number = 10): DiagnosticSupportGeneralConfigurationModel[] {
		let newModels: DiagnosticSupportGeneralConfigurationModel[] = [];
	...
	/**
	 * Given a blank model of type Diagnostic Support General Configuration, populate the model with its properties.
	 ...
	 */
	populate(model: DiagnosticSupportGeneralConfigurationModel) {
		...
		model.isActiveLIS = faker.random.boolean();
		model.isLISRegistration = faker.random.boolean();
		model.lisWebServiceURL = faker.random.words();
