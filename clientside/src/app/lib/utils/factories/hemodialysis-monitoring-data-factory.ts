...
export class HemodialysisMonitoringDataFactory extends AbstractDataFactory<HemodialysisMonitoringModel> {
	...
	create(): HemodialysisMonitoringModel {
		let newModel = new HemodialysisMonitoringModel();
	...
	createAll(size: number = 10): HemodialysisMonitoringModel[] {
		let newModels: HemodialysisMonitoringModel[] = [];
	...
	/**
	 * Given a blank model of type Hemodialysis Monitoring, populate the model with its properties.
	 ...
	 */
	populate(model: HemodialysisMonitoringModel) {
		...
		model.qb = faker.random.number();
		model.qd = faker.random.number();
		model.venousPressure = faker.random.number();
		model.tmp = faker.random.number();
		model.ufg = faker.random.number();
		model.ufr = faker.random.number();
		model.uf = faker.random.number();
