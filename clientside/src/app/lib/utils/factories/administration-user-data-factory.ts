...
export class AdministrationUserDataFactory extends UserDataFactory<AdministrationUserModel> {
	...
	create(): AdministrationUserModel {
		let newModel = new AdministrationUserModel();
	...
	createAll(size: number = 10): AdministrationUserModel[] {
		let newModels: AdministrationUserModel[] = [];
	...
	/**
	 * Given a blank model of type Administration User, populate the model with its properties.
	 ...
	 */
	populate(model: AdministrationUserModel) {
