...
export class BpjsSearchSEPDataFactory extends AbstractDataFactory<BpjsSearchSEPModel> {
	...
	create(): BpjsSearchSEPModel {
		let newModel = new BpjsSearchSEPModel();
	...
	createAll(size: number = 10): BpjsSearchSEPModel[] {
		let newModels: BpjsSearchSEPModel[] = [];
	...
	/**
	 * Given a blank model of type BPJS Search SEP, populate the model with its properties.
	 ...
	 */
	populate(model: BpjsSearchSEPModel) {
