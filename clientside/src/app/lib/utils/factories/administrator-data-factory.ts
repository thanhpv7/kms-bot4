...
export class AdministratorDataFactory extends UserDataFactory<AdministratorModel> {
	...
	create(): AdministratorModel {
		let newModel = new AdministratorModel();
	...
	createAll(size: number = 10): AdministratorModel[] {
		let newModels: AdministratorModel[] = [];
	...
	/**
	 * Given a blank model of type Administrator, populate the model with its properties.
	 ...
	 */
	populate(model: AdministratorModel) {
