...
export class DiagnosticSupportUserDataFactory extends UserDataFactory<DiagnosticSupportUserModel> {
	...
	create(): DiagnosticSupportUserModel {
		let newModel = new DiagnosticSupportUserModel();
	...
	createAll(size: number = 10): DiagnosticSupportUserModel[] {
		let newModels: DiagnosticSupportUserModel[] = [];
	...
	/**
	 * Given a blank model of type Diagnostic Support User, populate the model with its properties.
	 ...
	 */
	populate(model: DiagnosticSupportUserModel) {
