...
export class BpjsBedAvailabilityDataFactory extends AbstractDataFactory<BpjsBedAvailabilityModel> {
	...
	create(): BpjsBedAvailabilityModel {
		let newModel = new BpjsBedAvailabilityModel();
	...
	createAll(size: number = 10): BpjsBedAvailabilityModel[] {
		let newModels: BpjsBedAvailabilityModel[] = [];
	...
	/**
	 * Given a blank model of type BPJS Bed Availability, populate the model with its properties.
	 ...
	 */
	populate(model: BpjsBedAvailabilityModel) {
		...
		model.koderuang = faker.random.words();
		model.namaruang = faker.random.words();
		model.kodekelas = faker.random.words();
		model.namakelas = faker.random.words();
		model.lastupdate = faker.random.words();
		model.kapasitas = faker.random.number();
		model.tersedia = faker.random.number();
		model.tersediapria = faker.random.number();
		model.tersediawanita = faker.random.number();
		model.tersediapriawanita = faker.random.number();
