...
export class InventoryBatchCorrectionItemDataFactory extends AbstractDataFactory<InventoryBatchCorrectionItemModel> {
	...
	create(): InventoryBatchCorrectionItemModel {
		let newModel = new InventoryBatchCorrectionItemModel();
	...
	createAll(size: number = 10): InventoryBatchCorrectionItemModel[] {
		let newModels: InventoryBatchCorrectionItemModel[] = [];
	...
	/**
	 * Given a blank model of type Inventory Batch Correction Item, populate the model with its properties.
	 ...
	 */
	populate(model: InventoryBatchCorrectionItemModel) {
		...
		model.availableQtyBatch = faker.random.number();
		model.actualQtyBatch = faker.random.number();
		model.qtyAdjusted = faker.random.number();
