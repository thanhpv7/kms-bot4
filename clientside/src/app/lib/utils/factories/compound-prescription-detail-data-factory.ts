...
export class CompoundPrescriptionDetailDataFactory extends AbstractDataFactory<CompoundPrescriptionDetailModel> {
	...
	create(): CompoundPrescriptionDetailModel {
		let newModel = new CompoundPrescriptionDetailModel();
	...
	createAll(size: number = 10): CompoundPrescriptionDetailModel[] {
		let newModels: CompoundPrescriptionDetailModel[] = [];
	...
	/**
	 * Given a blank model of type Compound Prescription Detail, populate the model with its properties.
	 ...
	 */
	populate(model: CompoundPrescriptionDetailModel) {
		...
		model.requestQuantity = faker.random.number();
