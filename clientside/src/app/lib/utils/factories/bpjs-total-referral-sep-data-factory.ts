...
import {BpjsTotalReferralSEPModel} from '../../../models/bpjsTotalReferralSEP/bpjs_total_referral_sep.model';
import * as faker from 'faker';

export class BpjsTotalReferralSEPDataFactory extends AbstractDataFactory<BpjsTotalReferralSEPModel> {
	...
	create(): BpjsTotalReferralSEPModel {
		let newModel = new BpjsTotalReferralSEPModel();
	...
	createAll(size: number = 10): BpjsTotalReferralSEPModel[] {
		let newModels: BpjsTotalReferralSEPModel[] = [];
	...
	/**
	 * Given a blank model of type BPJS Total Referral SEP, populate the model with its properties.
	 ...
	 */
	populate(model: BpjsTotalReferralSEPModel) {
		...
		model.totalSEP = faker.random.words();
