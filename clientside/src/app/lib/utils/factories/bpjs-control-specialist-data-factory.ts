...
export class BpjsControlSpecialistDataFactory extends AbstractDataFactory<BpjsControlSpecialistModel> {
	...
	create(): BpjsControlSpecialistModel {
		let newModel = new BpjsControlSpecialistModel();
	...
	createAll(size: number = 10): BpjsControlSpecialistModel[] {
		let newModels: BpjsControlSpecialistModel[] = [];
	...
	/**
	 * Given a blank model of type BPJS Control Specialist, populate the model with its properties.
	 ...
	 */
	populate(model: BpjsControlSpecialistModel) {
		...
		model.specialistCode = faker.random.words();
		model.specialistName = faker.random.words();
		model.capacity = faker.random.words();
		model.totalControlPlanReferral = faker.random.words();
		model.percentage = faker.random.words();
