...
import {RetailPharmacyStockDetailModel} from '../../../models/retailPharmacyStockDetail/retail_pharmacy_stock_detail.model';
import * as faker from 'faker';

export class RetailPharmacyStockDetailDataFactory extends AbstractDataFactory<RetailPharmacyStockDetailModel> {
	...
	create(): RetailPharmacyStockDetailModel {
		let newModel = new RetailPharmacyStockDetailModel();
	...
	createAll(size: number = 10): RetailPharmacyStockDetailModel[] {
		let newModels: RetailPharmacyStockDetailModel[] = [];
	...
	/**
	 * Given a blank model of type Retail Pharmacy Stock Detail, populate the model with its properties.
	 ...
	 */
	populate(model: RetailPharmacyStockDetailModel) {
		...
		model.discount = faker.random.number();
		model.taxIncluded = faker.random.boolean();
