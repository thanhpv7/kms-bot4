...
export class RegistrationUserDataFactory extends UserDataFactory<RegistrationUserModel> {
	...
	create(): RegistrationUserModel {
		let newModel = new RegistrationUserModel();
	...
	createAll(size: number = 10): RegistrationUserModel[] {
		let newModels: RegistrationUserModel[] = [];
	...
	/**
	 * Given a blank model of type Registration User, populate the model with its properties.
	 ...
	 */
	populate(model: RegistrationUserModel) {
