...
import {PatientDetailAddressModel} from '../../../models/patientDetailAddress/patient_detail_address.model';
import * as faker from 'faker';

export class PatientDetailAddressDataFactory extends AbstractDataFactory<PatientDetailAddressModel> {
	...
	create(): PatientDetailAddressModel {
		let newModel = new PatientDetailAddressModel();
	...
	createAll(size: number = 10): PatientDetailAddressModel[] {
		let newModels: PatientDetailAddressModel[] = [];
	...
	/**
	 * Given a blank model of type Patient Detail Address, populate the model with its properties.
	 ...
	 */
	populate(model: PatientDetailAddressModel) {
		...
		model.rt = faker.random.words();
		model.rw = faker.random.words();
