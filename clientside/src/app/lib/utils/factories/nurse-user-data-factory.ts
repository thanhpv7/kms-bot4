...
export class NurseUserDataFactory extends UserDataFactory<NurseUserModel> {
	...
	create(): NurseUserModel {
		let newModel = new NurseUserModel();
	...
	createAll(size: number = 10): NurseUserModel[] {
		let newModels: NurseUserModel[] = [];
	...
	/**
	 * Given a blank model of type Nurse User, populate the model with its properties.
