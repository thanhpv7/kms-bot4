...
export class BpjsDiagnoseDataFactory extends AbstractDataFactory<BpjsDiagnoseModel> {
	...
	create(): BpjsDiagnoseModel {
		let newModel = new BpjsDiagnoseModel();
	...
	createAll(size: number = 10): BpjsDiagnoseModel[] {
		let newModels: BpjsDiagnoseModel[] = [];
	...
	/**
	 * Given a blank model of type BPJS Diagnose, populate the model with its properties.
	 ...
	 */
	populate(model: BpjsDiagnoseModel) {
