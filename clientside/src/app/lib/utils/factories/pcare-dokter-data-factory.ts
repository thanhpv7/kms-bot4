...
export class PcareDokterDataFactory extends AbstractDataFactory<PcareDokterModel> {
	...
	create(): PcareDokterModel {
		let newModel = new PcareDokterModel();
	...
	createAll(size: number = 10): PcareDokterModel[] {
		let newModels: PcareDokterModel[] = [];
	...
	/**
	 * Given a blank model of type PCare Dokter, populate the model with its properties.
	 ...
	 */
	populate(model: PcareDokterModel) {
