...
export class MedicalCertificatePhysicalHealthDataFactory extends AbstractDataFactory<MedicalCertificatePhysicalHealthModel> {
	...
	create(): MedicalCertificatePhysicalHealthModel {
		let newModel = new MedicalCertificatePhysicalHealthModel();
	...
	createAll(size: number = 10): MedicalCertificatePhysicalHealthModel[] {
		let newModels: MedicalCertificatePhysicalHealthModel[] = [];
	...
	/**
	 * Given a blank model of type Medical Certificate Physical Health, populate the model with its properties.
	 ...
	 */
	populate(model: MedicalCertificatePhysicalHealthModel) {
		...
		model.examinationDateTime = new Date();
		model.examinationResult = faker.random.boolean();
