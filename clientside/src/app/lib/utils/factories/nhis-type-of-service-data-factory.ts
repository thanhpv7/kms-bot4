...
export class NhisTypeOfServiceDataFactory extends AbstractDataFactory<NhisTypeOfServiceModel> {
	...
	create(): NhisTypeOfServiceModel {
		let newModel = new NhisTypeOfServiceModel();
	...
	createAll(size: number = 10): NhisTypeOfServiceModel[] {
		let newModels: NhisTypeOfServiceModel[] = [];
	...
	/**
	 * Given a blank model of type NHIS Type Of Service, populate the model with its properties.
	 ...
	 */
	populate(model: NhisTypeOfServiceModel) {
		...
		model.sections = faker.random.words();
