...
export class TransactionDetailTypeDataFactory extends AbstractDataFactory<TransactionDetailTypeModel> {
	...
	create(): TransactionDetailTypeModel {
		let newModel = new TransactionDetailTypeModel();
	...
	createAll(size: number = 10): TransactionDetailTypeModel[] {
		let newModels: TransactionDetailTypeModel[] = [];
	...
	/**
	 * Given a blank model of type Transaction Detail Type, populate the model with its properties.
	 ...
	 */
	populate(model: TransactionDetailTypeModel) {
		...
		model.transactionDetail = faker.random.words();
