...
export class MedicalCertificateHospitalizationDataFactory extends AbstractDataFactory<MedicalCertificateHospitalizationModel> {
	...
	create(): MedicalCertificateHospitalizationModel {
		let newModel = new MedicalCertificateHospitalizationModel();
	...
	createAll(size: number = 10): MedicalCertificateHospitalizationModel[] {
		let newModels: MedicalCertificateHospitalizationModel[] = [];
	...
	/**
	 * Given a blank model of type Medical Certificate Hospitalization, populate the model with its properties.
	 ...
	 */
	populate(model: MedicalCertificateHospitalizationModel) {
