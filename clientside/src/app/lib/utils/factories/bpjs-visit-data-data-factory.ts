...
import {BpjsVisitDataModel} from '../../../models/bpjsVisitData/bpjs_visit_data.model';
import * as faker from 'faker';

export class BpjsVisitDataDataFactory extends AbstractDataFactory<BpjsVisitDataModel> {
	...
	create(): BpjsVisitDataModel {
		let newModel = new BpjsVisitDataModel();
	...
	createAll(size: number = 10): BpjsVisitDataModel[] {
		let newModels: BpjsVisitDataModel[] = [];
	...
	/**
	 * Given a blank model of type BPJS Visit Data, populate the model with its properties.
	 ...
	 */
	populate(model: BpjsVisitDataModel) {
		...
		model.sepDismissalDate = faker.random.words();
