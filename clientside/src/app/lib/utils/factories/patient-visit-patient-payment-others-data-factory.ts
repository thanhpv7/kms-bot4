...
export class PatientVisitPatientPaymentOthersDataFactory extends AbstractDataFactory<PatientVisitPatientPaymentOthersModel> {
	...
	create(): PatientVisitPatientPaymentOthersModel {
		let newModel = new PatientVisitPatientPaymentOthersModel();
	...
	createAll(size: number = 10): PatientVisitPatientPaymentOthersModel[] {
		let newModels: PatientVisitPatientPaymentOthersModel[] = [];
	...
	/**
	 * Given a blank model of type Patient Visit Patient Payment Others, populate the model with its properties.
	 ...
	 */
	populate(model: PatientVisitPatientPaymentOthersModel) {
