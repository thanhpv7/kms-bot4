...
import {BpjsHealthFacilityModel} from '../../../models/bpjsHealthFacility/bpjs_health_facility.model';
import * as faker from 'faker';

export class BpjsHealthFacilityDataFactory extends AbstractDataFactory<BpjsHealthFacilityModel> {
	...
	create(): BpjsHealthFacilityModel {
		let newModel = new BpjsHealthFacilityModel();
	...
	createAll(size: number = 10): BpjsHealthFacilityModel[] {
		let newModels: BpjsHealthFacilityModel[] = [];
	...
	/**
	 * Given a blank model of type BPJS Health Facility, populate the model with its properties.
	 ...
	 */
	populate(model: BpjsHealthFacilityModel) {
