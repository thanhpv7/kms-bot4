...
import {MedicationCompoundModel} from '../../../models/medicationCompound/medication_compound.model';
import * as faker from 'faker';

export class MedicationCompoundDataFactory extends AbstractDataFactory<MedicationCompoundModel> {
	...
	create(): MedicationCompoundModel {
		let newModel = new MedicationCompoundModel();
	...
	createAll(size: number = 10): MedicationCompoundModel[] {
		let newModels: MedicationCompoundModel[] = [];
	...
	/**
	 * Given a blank model of type Medication Compound, populate the model with its properties.
	 ...
	 */
	populate(model: MedicationCompoundModel) {
