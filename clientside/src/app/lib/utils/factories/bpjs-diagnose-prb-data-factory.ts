...
export class BpjsDiagnosePRBDataFactory extends AbstractDataFactory<BpjsDiagnosePRBModel> {
	...
	create(): BpjsDiagnosePRBModel {
		let newModel = new BpjsDiagnosePRBModel();
	...
	createAll(size: number = 10): BpjsDiagnosePRBModel[] {
		let newModels: BpjsDiagnosePRBModel[] = [];
	...
	/**
	 * Given a blank model of type BPJS Diagnose PRB, populate the model with its properties.
	 ...
	 */
	populate(model: BpjsDiagnosePRBModel) {
