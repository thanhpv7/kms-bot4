...
import {BatchStockBalanceModel} from '../../../models/batchStockBalance/batch_stock_balance.model';
import * as faker from 'faker';

export class BatchStockBalanceDataFactory extends AbstractDataFactory<BatchStockBalanceModel> {
	...
	create(): BatchStockBalanceModel {
		let newModel = new BatchStockBalanceModel();
	...
	createAll(size: number = 10): BatchStockBalanceModel[] {
		let newModels: BatchStockBalanceModel[] = [];
	...
	/**
	 * Given a blank model of type Batch Stock Balance, populate the model with its properties.
	 ...
	 */
	populate(model: BatchStockBalanceModel) {
