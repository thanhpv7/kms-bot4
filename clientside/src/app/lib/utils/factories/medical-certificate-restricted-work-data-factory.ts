...
import {MedicalCertificateRestrictedWorkModel} from '../../../models/medicalCertificateRestrictedWork/medical_certificate_restricted_work.model';
import * as faker from 'faker';

export class MedicalCertificateRestrictedWorkDataFactory extends AbstractDataFactory<MedicalCertificateRestrictedWorkModel> {
	...
	create(): MedicalCertificateRestrictedWorkModel {
		let newModel = new MedicalCertificateRestrictedWorkModel();
	...
	createAll(size: number = 10): MedicalCertificateRestrictedWorkModel[] {
		let newModels: MedicalCertificateRestrictedWorkModel[] = [];
	...
	/**
	 * Given a blank model of type Medical Certificate Restricted Work, populate the model with its properties.
	 ...
	 */
	populate(model: MedicalCertificateRestrictedWorkModel) {
		...
		model.period = faker.random.number();
