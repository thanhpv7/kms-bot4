...
export class FormulirKonselingTesHivDataFactory extends AbstractDataFactory<FormulirKonselingTesHivModel> {
	...
	create(): FormulirKonselingTesHivModel {
		let newModel = new FormulirKonselingTesHivModel();
	...
	createAll(size: number = 10): FormulirKonselingTesHivModel[] {
		let newModels: FormulirKonselingTesHivModel[] = [];
	...
	/**
	 * Given a blank model of type Formulir Konseling Tes Hiv, populate the model with its properties.
	 ...
	 */
	populate(model: FormulirKonselingTesHivModel) {
		...
		model.formData = faker.random.words();
