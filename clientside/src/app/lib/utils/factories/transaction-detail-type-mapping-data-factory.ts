...
export class TransactionDetailTypeMappingDataFactory extends AbstractDataFactory<TransactionDetailTypeMappingModel> {
	...
	create(): TransactionDetailTypeMappingModel {
		let newModel = new TransactionDetailTypeMappingModel();
	...
	createAll(size: number = 10): TransactionDetailTypeMappingModel[] {
		let newModels: TransactionDetailTypeMappingModel[] = [];
	...
	/**
	 * Given a blank model of type Transaction Detail Type Mapping, populate the model with its properties.
	 ...
	 */
	populate(model: TransactionDetailTypeMappingModel) {
