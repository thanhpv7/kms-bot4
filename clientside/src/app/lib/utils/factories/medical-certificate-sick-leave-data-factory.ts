...
export class MedicalCertificateSickLeaveDataFactory extends AbstractDataFactory<MedicalCertificateSickLeaveModel> {
	...
	create(): MedicalCertificateSickLeaveModel {
		let newModel = new MedicalCertificateSickLeaveModel();
	...
	createAll(size: number = 10): MedicalCertificateSickLeaveModel[] {
		let newModels: MedicalCertificateSickLeaveModel[] = [];
	...
	/**
	 * Given a blank model of type Medical Certificate Sick Leave, populate the model with its properties.
	 ...
	 */
	populate(model: MedicalCertificateSickLeaveModel) {
