...
export class PatientPaymentInsuranceDataFactory extends AbstractDataFactory<PatientPaymentInsuranceModel> {
	...
	create(): PatientPaymentInsuranceModel {
		let newModel = new PatientPaymentInsuranceModel();
	...
	createAll(size: number = 10): PatientPaymentInsuranceModel[] {
		let newModels: PatientPaymentInsuranceModel[] = [];
	...
	/**
	 * Given a blank model of type Patient Payment Insurance, populate the model with its properties.
	 ...
	 */
	populate(model: PatientPaymentInsuranceModel) {
