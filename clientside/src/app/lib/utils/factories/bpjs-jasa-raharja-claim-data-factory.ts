...
export class BpjsJasaRaharjaClaimDataFactory extends AbstractDataFactory<BpjsJasaRaharjaClaimModel> {
	...
	create(): BpjsJasaRaharjaClaimModel {
		let newModel = new BpjsJasaRaharjaClaimModel();
	...
	createAll(size: number = 10): BpjsJasaRaharjaClaimModel[] {
		let newModels: BpjsJasaRaharjaClaimModel[] = [];
	...
	/**
	 * Given a blank model of type BPJS Jasa Raharja Claim, populate the model with its properties.
	 ...
	 */
	populate(model: BpjsJasaRaharjaClaimModel) {
