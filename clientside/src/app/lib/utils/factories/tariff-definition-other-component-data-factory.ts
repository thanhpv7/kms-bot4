...
export class TariffDefinitionOtherComponentDataFactory extends AbstractDataFactory<TariffDefinitionOtherComponentModel> {
	...
	create(): TariffDefinitionOtherComponentModel {
		let newModel = new TariffDefinitionOtherComponentModel();
	...
	createAll(size: number = 10): TariffDefinitionOtherComponentModel[] {
		let newModels: TariffDefinitionOtherComponentModel[] = [];
	...
	/**
	 * Given a blank model of type Tariff Definition Other Component, populate the model with its properties.
	 ...
	 */
	populate(model: TariffDefinitionOtherComponentModel) {
