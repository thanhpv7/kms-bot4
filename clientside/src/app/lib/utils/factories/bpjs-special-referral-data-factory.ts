...
export class BpjsSpecialReferralDataFactory extends AbstractDataFactory<BpjsSpecialReferralModel> {
	...
	create(): BpjsSpecialReferralModel {
		let newModel = new BpjsSpecialReferralModel();
	...
	createAll(size: number = 10): BpjsSpecialReferralModel[] {
		let newModels: BpjsSpecialReferralModel[] = [];
	...
	/**
	 * Given a blank model of type BPJS Special Referral, populate the model with its properties.
	 ...
	 */
	populate(model: BpjsSpecialReferralModel) {
		...
		model.referralID = faker.random.words();
		model.referralNo = faker.random.words();
		model.bpjsCardNo = faker.random.words();
		model.name = faker.random.words();
		model.ppkDiagnose = faker.random.words();
		model.referralStartDate = faker.random.words();
		model.referralEndDate = faker.random.words();
