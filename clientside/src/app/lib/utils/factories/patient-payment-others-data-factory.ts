...
export class PatientPaymentOthersDataFactory extends AbstractDataFactory<PatientPaymentOthersModel> {
	...
	create(): PatientPaymentOthersModel {
		let newModel = new PatientPaymentOthersModel();
	...
	createAll(size: number = 10): PatientPaymentOthersModel[] {
		let newModels: PatientPaymentOthersModel[] = [];
	...
	/**
	 * Given a blank model of type Patient Payment Others, populate the model with its properties.
	 ...
	 */
	populate(model: PatientPaymentOthersModel) {
