...
import {CompoundPrescriptionItemModel} from '../../../models/compoundPrescriptionItem/compound_prescription_item.model';
import * as faker from 'faker';

export class CompoundPrescriptionItemDataFactory extends AbstractDataFactory<CompoundPrescriptionItemModel> {
	...
	create(): CompoundPrescriptionItemModel {
		let newModel = new CompoundPrescriptionItemModel();
	...
	createAll(size: number = 10): CompoundPrescriptionItemModel[] {
		let newModels: CompoundPrescriptionItemModel[] = [];
	...
	/**
	 * Given a blank model of type Compound Prescription Item, populate the model with its properties.
	 ...
	 */
	populate(model: CompoundPrescriptionItemModel) {
