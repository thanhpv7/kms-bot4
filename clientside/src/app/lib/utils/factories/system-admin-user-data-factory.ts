...
export class SystemAdminUserDataFactory extends UserDataFactory<SystemAdminUserModel> {
	...
	create(): SystemAdminUserModel {
		let newModel = new SystemAdminUserModel();
	...
	createAll(size: number = 10): SystemAdminUserModel[] {
		let newModels: SystemAdminUserModel[] = [];
	...
	/**
	 * Given a blank model of type System Admin User, populate the model with its properties.
	 ...
	 */
	populate(model: SystemAdminUserModel) {
