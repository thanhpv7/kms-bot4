...
export class PatientPaymentSelfPayingDataFactory extends AbstractDataFactory<PatientPaymentSelfPayingModel> {
	...
	create(): PatientPaymentSelfPayingModel {
		let newModel = new PatientPaymentSelfPayingModel();
	...
	createAll(size: number = 10): PatientPaymentSelfPayingModel[] {
		let newModels: PatientPaymentSelfPayingModel[] = [];
	...
	/**
	 * Given a blank model of type Patient Payment  Self Paying, populate the model with its properties.
	 ...
	 */
	populate(model: PatientPaymentSelfPayingModel) {
