...
import {MedicalCertificateMedicalAttendanceModel} from '../../../models/medicalCertificateMedicalAttendance/medical_certificate_medical_attendance.model';
import * as faker from 'faker';

export class MedicalCertificateMedicalAttendanceDataFactory extends AbstractDataFactory<MedicalCertificateMedicalAttendanceModel> {
	...
	create(): MedicalCertificateMedicalAttendanceModel {
		let newModel = new MedicalCertificateMedicalAttendanceModel();
	...
	createAll(size: number = 10): MedicalCertificateMedicalAttendanceModel[] {
		let newModels: MedicalCertificateMedicalAttendanceModel[] = [];
	...
	/**
	 * Given a blank model of type Medical Certificate Medical Attendance, populate the model with its properties.
	 ...
	 */
	populate(model: MedicalCertificateMedicalAttendanceModel) {
