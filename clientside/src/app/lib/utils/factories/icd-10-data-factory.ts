...
import {Icd10Model} from '../../../models/icd10/icd_10.model';
import * as faker from 'faker';

export class Icd10DataFactory extends AbstractDataFactory<Icd10Model> {
	...
	createAll(size: number = 10): Icd10Model[] {
		let newModels: Icd10Model[] = [];
	...
	/**
	 * Given a blank model of type ICD 10, populate the model with its properties.
	...
	populate(model: Icd10Model) {
		...
		model.classificationDisease = faker.random.boolean();
		model.classificationInfectious = faker.random.boolean();
		model.classificationChronic = faker.random.boolean();
		model.classificationTopDisease = faker.random.boolean();
		model.classificationRestrictedCase = faker.random.boolean();
		model.classificationReportableCase = faker.random.boolean();
		model.classificationAcute = faker.random.boolean();
