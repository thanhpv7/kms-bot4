...
import {PurchasingUserModel} from '../../../models/purchasingUser/purchasing_user.model';
import * as faker from 'faker';

export class PurchasingUserDataFactory extends UserDataFactory<PurchasingUserModel> {
	...
	create(): PurchasingUserModel {
		let newModel = new PurchasingUserModel();
	...
	createAll(size: number = 10): PurchasingUserModel[] {
		let newModels: PurchasingUserModel[] = [];
	...
	/**
	 * Given a blank model of type Purchasing User, populate the model with its properties.
	 ...
	 */
	populate(model: PurchasingUserModel) {
