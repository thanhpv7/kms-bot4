...
export class ServiceItemAssignmentDataFactory extends AbstractDataFactory<ServiceItemAssignmentModel> {
	...
	create(): ServiceItemAssignmentModel {
		let newModel = new ServiceItemAssignmentModel();
	...
	createAll(size: number = 10): ServiceItemAssignmentModel[] {
		let newModels: ServiceItemAssignmentModel[] = [];
	...
	/**
	 * Given a blank model of type Service Item Assignment, populate the model with its properties.
	 ...
	 */
	populate(model: ServiceItemAssignmentModel) {
