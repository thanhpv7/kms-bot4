...
export class ExaminationItemDetailDataFactory extends AbstractDataFactory<ExaminationItemDetailModel> {
	...
	create(): ExaminationItemDetailModel {
		let newModel = new ExaminationItemDetailModel();
	...
	createAll(size: number = 10): ExaminationItemDetailModel[] {
		let newModels: ExaminationItemDetailModel[] = [];
	...
	/**
	 * Given a blank model of type Examination Item Detail, populate the model with its properties.
	 ...
	 */
	populate(model: ExaminationItemDetailModel) {
		...
		model.ageMinimum = faker.random.number();
		model.ageMaximum = faker.random.number();
		model.gender = faker.random.words();
		model.normalRangeLow = faker.random.number();
		model.normalRangeHigh = faker.random.number();
		model.unit = faker.random.words();
		model.criticalValueLow = faker.random.number();
		model.criticalValueHigh = faker.random.number();
		model.ageMinUnit = faker.random.words();
		model.ageMaxUnit = faker.random.words();
