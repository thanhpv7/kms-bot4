...
export class ClaimUserDataFactory extends UserDataFactory<ClaimUserModel> {
	...
	create(): ClaimUserModel {
		let newModel = new ClaimUserModel();
	...
	createAll(size: number = 10): ClaimUserModel[] {
		let newModels: ClaimUserModel[] = [];
	...
	/**
	 * Given a blank model of type Claim User, populate the model with its properties.
