...
export class StockTransactionPerDateDataFactory extends AbstractDataFactory<StockTransactionPerDateModel> {
	...
	create(): StockTransactionPerDateModel {
		let newModel = new StockTransactionPerDateModel();
	...
	createAll(size: number = 10): StockTransactionPerDateModel[] {
		let newModels: StockTransactionPerDateModel[] = [];
	...
	/**
	 * Given a blank model of type Stock Transaction Per Date, populate the model with its properties.
	 ...
	 */
	populate(model: StockTransactionPerDateModel) {
		...
		model.qtyTransitUoi = faker.random.number();
