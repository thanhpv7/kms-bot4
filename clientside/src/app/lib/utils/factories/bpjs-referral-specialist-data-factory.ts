...
export class BpjsReferralSpecialistDataFactory extends AbstractDataFactory<BpjsReferralSpecialistModel> {
	...
	create(): BpjsReferralSpecialistModel {
		let newModel = new BpjsReferralSpecialistModel();
	...
	createAll(size: number = 10): BpjsReferralSpecialistModel[] {
		let newModels: BpjsReferralSpecialistModel[] = [];
	...
	/**
	 * Given a blank model of type BPJS Referral Specialist, populate the model with its properties.
	 ...
	 */
	populate(model: BpjsReferralSpecialistModel) {
		...
		model.totalReferral = faker.random.words();
