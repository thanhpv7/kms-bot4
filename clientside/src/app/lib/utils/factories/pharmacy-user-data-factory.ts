...
export class PharmacyUserDataFactory extends UserDataFactory<PharmacyUserModel> {
	...
	create(): PharmacyUserModel {
		let newModel = new PharmacyUserModel();
	...
	createAll(size: number = 10): PharmacyUserModel[] {
		let newModels: PharmacyUserModel[] = [];
	...
	/**
	 * Given a blank model of type Pharmacy User, populate the model with its properties.
	 ...
	 */
	populate(model: PharmacyUserModel) {
