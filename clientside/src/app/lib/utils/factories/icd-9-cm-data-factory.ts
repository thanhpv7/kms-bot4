...
import {Icd9CMModel} from '../../../models/icd9CM/icd_9_cm.model';
import * as faker from 'faker';

export class Icd9CMDataFactory extends AbstractDataFactory<Icd9CMModel> {
	...
	createAll(size: number = 10): Icd9CMModel[] {
		let newModels: Icd9CMModel[] = [];
	...
	/**
	 * Given a blank model of type ICD 9 CM, populate the model with its properties.
	...
	populate(model: Icd9CMModel) {
		...
		model.topProcedure = faker.random.boolean();
