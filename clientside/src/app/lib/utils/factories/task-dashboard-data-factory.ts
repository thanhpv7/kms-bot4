...
import {TaskDashboardModel} from '../../../models/taskDashboard/task_dashboard.model';
import * as faker from 'faker';

export class TaskDashboardDataFactory extends AbstractDataFactory<TaskDashboardModel> {
	...
	create(): TaskDashboardModel {
		let newModel = new TaskDashboardModel();
	...
	createAll(size: number = 10): TaskDashboardModel[] {
		let newModels: TaskDashboardModel[] = [];
	...
	/**
	 * Given a blank model of type Task Dashboard, populate the model with its properties.
	 ...
	 */
	populate(model: TaskDashboardModel) {
		...
		model.jumlahAntrean = faker.random.number();
		model.namapoli = faker.random.words();
		model.nmppk = faker.random.words();
		model.kodepoli = faker.random.words();
		model.insertDate = new Date();
		model.tanggal = new Date();
		model.waktuTask1 = faker.random.number();
		model.waktuTask2 = faker.random.number();
		model.waktuTask3 = faker.random.number();
		model.waktuTask4 = faker.random.number();
		model.waktuTask5 = faker.random.number();
		model.waktuTask6 = faker.random.number();
		model.avgWaktuTask1 = faker.random.number();
		model.avgWaktuTask2 = faker.random.number();
		model.avgWaktuTask3 = faker.random.number();
		model.avgWaktuTask4 = faker.random.number();
		model.avgWaktuTask5 = faker.random.number();
		model.avgWaktuTask6 = faker.random.number();
