...
import {ServiceFacilityCategoryModel} from '../../../models/serviceFacilityCategory/service_facility_category.model';
import * as faker from 'faker';

export class ServiceFacilityCategoryDataFactory extends AbstractDataFactory<ServiceFacilityCategoryModel> {
	...
	create(): ServiceFacilityCategoryModel {
		let newModel = new ServiceFacilityCategoryModel();
	...
	createAll(size: number = 10): ServiceFacilityCategoryModel[] {
		let newModels: ServiceFacilityCategoryModel[] = [];
	...
	/**
	 * Given a blank model of type Service Facility Category, populate the model with its properties.
	 ...
	 */
	populate(model: ServiceFacilityCategoryModel) {
		...
		model.facilityCode = faker.random.words();
