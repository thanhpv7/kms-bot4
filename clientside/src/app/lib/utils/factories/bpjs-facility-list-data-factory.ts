...
export class BpjsFacilityListDataFactory extends AbstractDataFactory<BpjsFacilityListModel> {
	...
	create(): BpjsFacilityListModel {
		let newModel = new BpjsFacilityListModel();
	...
	createAll(size: number = 10): BpjsFacilityListModel[] {
		let newModels: BpjsFacilityListModel[] = [];
	...
	/**
	 * Given a blank model of type BPJS Facility List, populate the model with its properties.
	 ...
	 */
	populate(model: BpjsFacilityListModel) {
		...
		model.facilityName = faker.random.words();
