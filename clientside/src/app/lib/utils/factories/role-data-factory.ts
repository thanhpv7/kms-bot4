...
export class RoleDataFactory extends AbstractDataFactory<RoleModel> {
	...
	createAll(size: number = 10): RoleModel[] {
		let newModels: RoleModel[] = [];
	...
	/**
	 * Given a blank model of type Role, populate the model with its properties.
