...
export class NhisSpecialtyAttendedDataFactory extends AbstractDataFactory<NhisSpecialtyAttendedModel> {
	...
	create(): NhisSpecialtyAttendedModel {
		let newModel = new NhisSpecialtyAttendedModel();
	...
	createAll(size: number = 10): NhisSpecialtyAttendedModel[] {
		let newModels: NhisSpecialtyAttendedModel[] = [];
	...
	/**
	 * Given a blank model of type NHIS Specialty Attended, populate the model with its properties.
	 ...
	 */
	populate(model: NhisSpecialtyAttendedModel) {
		...
		model.services = faker.random.words();
