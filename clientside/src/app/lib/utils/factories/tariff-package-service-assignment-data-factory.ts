...
export class TariffPackageServiceAssignmentDataFactory extends AbstractDataFactory<TariffPackageServiceAssignmentModel> {
	...
	create(): TariffPackageServiceAssignmentModel {
		let newModel = new TariffPackageServiceAssignmentModel();
	...
	createAll(size: number = 10): TariffPackageServiceAssignmentModel[] {
		let newModels: TariffPackageServiceAssignmentModel[] = [];
	...
	/**
	 * Given a blank model of type Tariff Package Service Assignment, populate the model with its properties.
	 ...
	 */
	populate(model: TariffPackageServiceAssignmentModel) {
		...
		model.assignCode = faker.random.words();
