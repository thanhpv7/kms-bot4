...
export class BpjsFingerPrintDataFactory extends AbstractDataFactory<BpjsFingerPrintModel> {
	...
	create(): BpjsFingerPrintModel {
		let newModel = new BpjsFingerPrintModel();
	...
	createAll(size: number = 10): BpjsFingerPrintModel[] {
		let newModels: BpjsFingerPrintModel[] = [];
	...
	/**
	 * Given a blank model of type BPJS Finger Print, populate the model with its properties.
	 ...
	 */
	populate(model: BpjsFingerPrintModel) {
