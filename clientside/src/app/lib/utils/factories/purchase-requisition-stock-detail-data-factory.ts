...
export class PurchaseRequisitionStockDetailDataFactory extends AbstractDataFactory<PurchaseRequisitionStockDetailModel> {
	...
	create(): PurchaseRequisitionStockDetailModel {
		let newModel = new PurchaseRequisitionStockDetailModel();
	...
	createAll(size: number = 10): PurchaseRequisitionStockDetailModel[] {
		let newModels: PurchaseRequisitionStockDetailModel[] = [];
	...
	/**
	 * Given a blank model of type Purchase Requisition Stock Detail, populate the model with its properties.
	 ...
	 */
	populate(model: PurchaseRequisitionStockDetailModel) {
		...
		model.quantityRequested = faker.random.number();
