...
export class BpjsControlPlanDataFactory extends AbstractDataFactory<BpjsControlPlanModel> {
	...
	create(): BpjsControlPlanModel {
		let newModel = new BpjsControlPlanModel();
	...
	createAll(size: number = 10): BpjsControlPlanModel[] {
		let newModels: BpjsControlPlanModel[] = [];
	...
	/**
	 * Given a blank model of type BPJS Control Plan, populate the model with its properties.
	 ...
	 */
	populate(model: BpjsControlPlanModel) {
		...
		model.polyclinicCode = faker.random.words();
