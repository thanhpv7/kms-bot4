...
export class FluidBalanceDetailDataFactory extends AbstractDataFactory<FluidBalanceDetailModel> {
	...
	create(): FluidBalanceDetailModel {
		let newModel = new FluidBalanceDetailModel();
	...
	createAll(size: number = 10): FluidBalanceDetailModel[] {
		let newModels: FluidBalanceDetailModel[] = [];
	...
	/**
	 * Given a blank model of type Fluid Balance Detail, populate the model with its properties.
	 ...
	 */
	populate(model: FluidBalanceDetailModel) {
		...
		model.intakeOral = faker.random.number();
		model.intakeNGT = faker.random.number();
		model.intakeIVLine = faker.random.number();
		model.intakeOthers = faker.random.number();
		model.outputUrine = faker.random.number();
		model.outputNGT = faker.random.number();
		model.outputDrain = faker.random.number();
		model.outputStool = faker.random.number();
		model.outputBlood = faker.random.number();
		model.outputIWL = faker.random.number();
		model.outputOthers = faker.random.number();
		model.notes = faker.random.words();
		model.totalInput = faker.random.number();
		model.totalOutput = faker.random.number();
		model.totalBalanceFluid = faker.random.number();
