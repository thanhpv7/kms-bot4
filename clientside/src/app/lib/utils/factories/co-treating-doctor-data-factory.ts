...
export class CoTreatingDoctorDataFactory extends AbstractDataFactory<CoTreatingDoctorModel> {
	...
	create(): CoTreatingDoctorModel {
		let newModel = new CoTreatingDoctorModel();
	...
	createAll(size: number = 10): CoTreatingDoctorModel[] {
		let newModels: CoTreatingDoctorModel[] = [];
	...
	/**
	 * Given a blank model of type Co Treating Doctor, populate the model with its properties.
	 ...
	 */
	populate(model: CoTreatingDoctorModel) {
		...
		model.doctorNotes = faker.random.words();
