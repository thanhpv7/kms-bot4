...
import {McuPackageItemModel} from '../../../models/mcuPackageItem/mcu_package_item.model';
import * as faker from 'faker';

export class McuPackageItemDataFactory extends AbstractDataFactory<McuPackageItemModel> {
	...
	create(): McuPackageItemModel {
		let newModel = new McuPackageItemModel();
	...
	createAll(size: number = 10): McuPackageItemModel[] {
		let newModels: McuPackageItemModel[] = [];
	...
	/**
	 * Given a blank model of type MCU Package Item, populate the model with its properties.
	 ...
	 */
	populate(model: McuPackageItemModel) {
