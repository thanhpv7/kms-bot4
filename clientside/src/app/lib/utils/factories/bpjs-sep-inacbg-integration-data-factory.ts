...
import {BpjsSEPINACBGIntegrationModel} from '../../../models/bpjsSEPINACBGIntegration/bpjs_sep_inacbg_integration.model';
import * as faker from 'faker';

export class BpjsSEPINACBGIntegrationDataFactory extends AbstractDataFactory<BpjsSEPINACBGIntegrationModel> {
	...
	create(): BpjsSEPINACBGIntegrationModel {
		let newModel = new BpjsSEPINACBGIntegrationModel();
	...
	createAll(size: number = 10): BpjsSEPINACBGIntegrationModel[] {
		let newModels: BpjsSEPINACBGIntegrationModel[] = [];
	...
	/**
	 * Given a blank model of type BPJS SEP INACBG Integration, populate the model with its properties.
	 ...
	 */
	populate(model: BpjsSEPINACBGIntegrationModel) {
		...
		model.visitDate = faker.random.words();
