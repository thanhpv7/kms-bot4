...
import {RetailPharmacyModel} from '../../../models/retailPharmacy/retail_pharmacy.model';
import * as faker from 'faker';

export class RetailPharmacyDataFactory extends AbstractDataFactory<RetailPharmacyModel> {
	...
	create(): RetailPharmacyModel {
		let newModel = new RetailPharmacyModel();
	...
	createAll(size: number = 10): RetailPharmacyModel[] {
		let newModels: RetailPharmacyModel[] = [];
	...
	/**
	 * Given a blank model of type Retail Pharmacy, populate the model with its properties.
	 ...
	 */
	populate(model: RetailPharmacyModel) {
		...
		model.customerType = faker.random.words();
		model.retailNumber = faker.random.words();
