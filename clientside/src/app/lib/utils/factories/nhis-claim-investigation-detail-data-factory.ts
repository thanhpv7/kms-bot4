...
export class NhisClaimInvestigationDetailDataFactory extends AbstractDataFactory<NhisClaimInvestigationDetailModel> {
	...
	create(): NhisClaimInvestigationDetailModel {
		let newModel = new NhisClaimInvestigationDetailModel();
	...
	createAll(size: number = 10): NhisClaimInvestigationDetailModel[] {
		let newModels: NhisClaimInvestigationDetailModel[] = [];
	...
	/**
	 * Given a blank model of type NHIS Claim Investigation Detail, populate the model with its properties.
	 ...
	 */
	populate(model: NhisClaimInvestigationDetailModel) {
