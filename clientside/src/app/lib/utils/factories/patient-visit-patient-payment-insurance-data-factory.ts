...
export class PatientVisitPatientPaymentInsuranceDataFactory extends AbstractDataFactory<PatientVisitPatientPaymentInsuranceModel> {
	...
	create(): PatientVisitPatientPaymentInsuranceModel {
		let newModel = new PatientVisitPatientPaymentInsuranceModel();
	...
	createAll(size: number = 10): PatientVisitPatientPaymentInsuranceModel[] {
		let newModels: PatientVisitPatientPaymentInsuranceModel[] = [];
	...
	/**
	 * Given a blank model of type Patient Visit Patient Payment Insurance, populate the model with its properties.
	 ...
	 */
	populate(model: PatientVisitPatientPaymentInsuranceModel) {
		...
		model.policyHolderNo = faker.random.words();
		model.eligilityVerification = faker.random.words();
		model.guaranteeLetterNo = faker.random.words();
		model.coverageBalance = faker.random.number();
