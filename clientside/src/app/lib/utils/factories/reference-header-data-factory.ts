...
export class ReferenceHeaderDataFactory extends AbstractDataFactory<ReferenceHeaderModel> {
	...
	create(): ReferenceHeaderModel {
		let newModel = new ReferenceHeaderModel();
	...
	createAll(size: number = 10): ReferenceHeaderModel[] {
		let newModels: ReferenceHeaderModel[] = [];
	...
	/**
	 * Given a blank model of type Reference Header, populate the model with its properties.
	 ...
	 */
	populate(model: ReferenceHeaderModel) {
