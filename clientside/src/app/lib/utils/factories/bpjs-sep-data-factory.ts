...
export class BpjsSEPDataFactory extends AbstractDataFactory<BpjsSEPModel> {
	...
	createAll(size: number = 10): BpjsSEPModel[] {
		let newModels: BpjsSEPModel[] = [];
	...
	/**
	 * Given a blank model of type BPJS SEP, populate the model with its properties.
