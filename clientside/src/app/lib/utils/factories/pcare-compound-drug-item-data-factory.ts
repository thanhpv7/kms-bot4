...
export class PcareCompoundDrugItemDataFactory extends AbstractDataFactory<PcareCompoundDrugItemModel> {
	...
	create(): PcareCompoundDrugItemModel {
		let newModel = new PcareCompoundDrugItemModel();
	...
	createAll(size: number = 10): PcareCompoundDrugItemModel[] {
		let newModels: PcareCompoundDrugItemModel[] = [];
	...
	/**
	 * Given a blank model of type PCare Compound Drug Item, populate the model with its properties.
	 ...
	 */
	populate(model: PcareCompoundDrugItemModel) {
		...
		model.request = faker.random.number();
