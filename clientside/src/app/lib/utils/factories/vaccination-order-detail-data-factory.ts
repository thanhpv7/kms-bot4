...
export class VaccinationOrderDetailDataFactory extends AbstractDataFactory<VaccinationOrderDetailModel> {
	...
	create(): VaccinationOrderDetailModel {
		let newModel = new VaccinationOrderDetailModel();
	...
	createAll(size: number = 10): VaccinationOrderDetailModel[] {
		let newModels: VaccinationOrderDetailModel[] = [];
	...
	/**
	 * Given a blank model of type Vaccination Order Detail, populate the model with its properties.
	 ...
	 */
	populate(model: VaccinationOrderDetailModel) {
		...
		model.vaccinationDate = new Date();
		model.vaccinationType = faker.random.words();
		model.vaccinationDetail = faker.random.words();
