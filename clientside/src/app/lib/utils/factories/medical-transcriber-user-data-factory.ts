...
import {MedicalTranscriberUserModel} from '../../../models/medicalTranscriberUser/medical_transcriber_user.model';
import * as faker from 'faker';

export class MedicalTranscriberUserDataFactory extends UserDataFactory<MedicalTranscriberUserModel> {
	...
	create(): MedicalTranscriberUserModel {
		let newModel = new MedicalTranscriberUserModel();
	...
	createAll(size: number = 10): MedicalTranscriberUserModel[] {
		let newModels: MedicalTranscriberUserModel[] = [];
	...
	/**
	 * Given a blank model of type Medical Transcriber User, populate the model with its properties.
	 ...
	 */
	populate(model: MedicalTranscriberUserModel) {
