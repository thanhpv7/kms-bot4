...
import {BpjsListFingerPrintModel} from '../../../models/bpjsListFingerPrint/bpjs_list_finger_print.model';
import * as faker from 'faker';

export class BpjsListFingerPrintDataFactory extends AbstractDataFactory<BpjsListFingerPrintModel> {
	...
	create(): BpjsListFingerPrintModel {
		let newModel = new BpjsListFingerPrintModel();
	...
	createAll(size: number = 10): BpjsListFingerPrintModel[] {
		let newModels: BpjsListFingerPrintModel[] = [];
	...
	/**
	 * Given a blank model of type BPJS List Finger Print, populate the model with its properties.
	 ...
	 */
	populate(model: BpjsListFingerPrintModel) {
