...
export class BpjsPcareProviderRayonisasiDataFactory extends AbstractDataFactory<BpjsPcareProviderRayonisasiModel> {
	...
	create(): BpjsPcareProviderRayonisasiModel {
		let newModel = new BpjsPcareProviderRayonisasiModel();
	...
	createAll(size: number = 10): BpjsPcareProviderRayonisasiModel[] {
		let newModels: BpjsPcareProviderRayonisasiModel[] = [];
	...
	/**
	 * Given a blank model of type BPJS Pcare Provider Rayonisasi, populate the model with its properties.
	 ...
	 */
	populate(model: BpjsPcareProviderRayonisasiModel) {
