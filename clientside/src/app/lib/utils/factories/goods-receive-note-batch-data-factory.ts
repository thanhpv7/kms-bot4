...
export class GoodsReceiveNoteBatchDataFactory extends AbstractDataFactory<GoodsReceiveNoteBatchModel> {
	...
	create(): GoodsReceiveNoteBatchModel {
		let newModel = new GoodsReceiveNoteBatchModel();
	...
	createAll(size: number = 10): GoodsReceiveNoteBatchModel[] {
		let newModels: GoodsReceiveNoteBatchModel[] = [];
	...
	/**
	 * Given a blank model of type Goods Receive Note Batch, populate the model with its properties.
	 ...
	 */
	populate(model: GoodsReceiveNoteBatchModel) {
