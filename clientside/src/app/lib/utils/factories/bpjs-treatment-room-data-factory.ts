...
export class BpjsTreatmentRoomDataFactory extends AbstractDataFactory<BpjsTreatmentRoomModel> {
	...
	create(): BpjsTreatmentRoomModel {
		let newModel = new BpjsTreatmentRoomModel();
	...
	createAll(size: number = 10): BpjsTreatmentRoomModel[] {
		let newModels: BpjsTreatmentRoomModel[] = [];
	...
	/**
	 * Given a blank model of type BPJS Treatment Room, populate the model with its properties.
	 ...
	 */
	populate(model: BpjsTreatmentRoomModel) {
