...
export class ManagementUserDataFactory extends UserDataFactory<ManagementUserModel> {
	...
	create(): ManagementUserModel {
		let newModel = new ManagementUserModel();
	...
	createAll(size: number = 10): ManagementUserModel[] {
		let newModels: ManagementUserModel[] = [];
	...
	/**
	 * Given a blank model of type Management User, populate the model with its properties.
	 ...
	 */
	populate(model: ManagementUserModel) {
