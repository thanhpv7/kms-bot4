...
export class MedicalRecordInitialChecklistDataFactory extends AbstractDataFactory<MedicalRecordInitialChecklistModel> {
	...
	create(): MedicalRecordInitialChecklistModel {
		let newModel = new MedicalRecordInitialChecklistModel();
	...
	createAll(size: number = 10): MedicalRecordInitialChecklistModel[] {
		let newModels: MedicalRecordInitialChecklistModel[] = [];
	...
	/**
	 * Given a blank model of type Medical Record Initial Checklist, populate the model with its properties.
	 ...
	 */
	populate(model: MedicalRecordInitialChecklistModel) {
