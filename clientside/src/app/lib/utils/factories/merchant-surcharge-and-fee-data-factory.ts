...
import {MerchantSurchargeAndFeeModel} from '../../../models/merchantSurchargeAndFee/merchant_surcharge_and_fee.model';
import * as faker from 'faker';

export class MerchantSurchargeAndFeeDataFactory extends AbstractDataFactory<MerchantSurchargeAndFeeModel> {
	...
	create(): MerchantSurchargeAndFeeModel {
		let newModel = new MerchantSurchargeAndFeeModel();
	...
	createAll(size: number = 10): MerchantSurchargeAndFeeModel[] {
		let newModels: MerchantSurchargeAndFeeModel[] = [];
	...
	/**
	 * Given a blank model of type Merchant Surcharge and Fee, populate the model with its properties.
	 ...
	 */
	populate(model: MerchantSurchargeAndFeeModel) {
		...
		model.surcharge = faker.random.number();
		model.fee = faker.random.words();
