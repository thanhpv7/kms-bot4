...
import {InventoryAdjusmentBatchModel} from '../../../models/inventoryAdjusmentBatch/inventory_adjusment_batch.model';
import * as faker from 'faker';

export class InventoryAdjusmentBatchDataFactory extends AbstractDataFactory<InventoryAdjusmentBatchModel> {
	...
	create(): InventoryAdjusmentBatchModel {
		let newModel = new InventoryAdjusmentBatchModel();
	...
	createAll(size: number = 10): InventoryAdjusmentBatchModel[] {
		let newModels: InventoryAdjusmentBatchModel[] = [];
	...
	/**
	 * Given a blank model of type Inventory Adjusment Batch, populate the model with its properties.
	 ...
	 */
	populate(model: InventoryAdjusmentBatchModel) {
