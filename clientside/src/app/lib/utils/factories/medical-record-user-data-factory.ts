...
export class MedicalRecordUserDataFactory extends UserDataFactory<MedicalRecordUserModel> {
	...
	create(): MedicalRecordUserModel {
		let newModel = new MedicalRecordUserModel();
	...
	createAll(size: number = 10): MedicalRecordUserModel[] {
		let newModels: MedicalRecordUserModel[] = [];
	...
	/**
	 * Given a blank model of type Medical Record user, populate the model with its properties.
	 ...
	 */
	populate(model: MedicalRecordUserModel) {
