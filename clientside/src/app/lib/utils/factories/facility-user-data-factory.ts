...
export class FacilityUserDataFactory extends UserDataFactory<FacilityUserModel> {
	...
	create(): FacilityUserModel {
		let newModel = new FacilityUserModel();
	...
	createAll(size: number = 10): FacilityUserModel[] {
		let newModels: FacilityUserModel[] = [];
	...
	/**
	 * Given a blank model of type Facility User, populate the model with its properties.
	 ...
	 */
	populate(model: FacilityUserModel) {
