...
export class ExaminationGroupDataFactory extends AbstractDataFactory<ExaminationGroupModel> {
	...
	create(): ExaminationGroupModel {
		let newModel = new ExaminationGroupModel();
	...
	createAll(size: number = 10): ExaminationGroupModel[] {
		let newModels: ExaminationGroupModel[] = [];
	...
	/**
	 * Given a blank model of type Examination Group, populate the model with its properties.
	 ...
	 */
	populate(model: ExaminationGroupModel) {
		...
		model.diagnosticGroupCode = faker.random.words();
