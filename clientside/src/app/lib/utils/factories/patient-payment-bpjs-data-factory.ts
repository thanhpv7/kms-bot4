...
export class PatientPaymentBPJSDataFactory extends AbstractDataFactory<PatientPaymentBPJSModel> {
	...
	create(): PatientPaymentBPJSModel {
		let newModel = new PatientPaymentBPJSModel();
	...
	createAll(size: number = 10): PatientPaymentBPJSModel[] {
		let newModels: PatientPaymentBPJSModel[] = [];
	...
	/**
	 * Given a blank model of type Patient Payment BPJS, populate the model with its properties.
	 ...
	 */
	populate(model: PatientPaymentBPJSModel) {
