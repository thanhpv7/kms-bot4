...
export class BatchStockBalancePerDateDataFactory extends AbstractDataFactory<BatchStockBalancePerDateModel> {
	...
	create(): BatchStockBalancePerDateModel {
		let newModel = new BatchStockBalancePerDateModel();
	...
	createAll(size: number = 10): BatchStockBalancePerDateModel[] {
		let newModels: BatchStockBalancePerDateModel[] = [];
	...
	/**
	 * Given a blank model of type Batch Stock Balance Per Date, populate the model with its properties.
	 ...
	 */
	populate(model: BatchStockBalancePerDateModel) {
