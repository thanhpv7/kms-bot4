...
import {NhisClaimGDRGDetailModel} from '../../../models/nhisClaimGDRGDetail/nhis_claim_gdrg_detail.model';
import * as faker from 'faker';

export class NhisClaimGDRGDetailDataFactory extends AbstractDataFactory<NhisClaimGDRGDetailModel> {
	...
	create(): NhisClaimGDRGDetailModel {
		let newModel = new NhisClaimGDRGDetailModel();
	...
	createAll(size: number = 10): NhisClaimGDRGDetailModel[] {
		let newModels: NhisClaimGDRGDetailModel[] = [];
	...
	/**
	 * Given a blank model of type NHIS Claim GDRG Detail, populate the model with its properties.
	 ...
	 */
	populate(model: NhisClaimGDRGDetailModel) {
