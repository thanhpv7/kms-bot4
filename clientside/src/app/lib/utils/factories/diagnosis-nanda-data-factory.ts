...
export class DiagnosisNandaDataFactory extends AbstractDataFactory<DiagnosisNandaModel> {
	...
	create(): DiagnosisNandaModel {
		let newModel = new DiagnosisNandaModel();
	...
	createAll(size: number = 10): DiagnosisNandaModel[] {
		let newModels: DiagnosisNandaModel[] = [];
	...
	/**
	 * Given a blank model of type Diagnosis Nanda, populate the model with its properties.
	 ...
	 */
	populate(model: DiagnosisNandaModel) {
		...
		model.nursingNotes = faker.random.words();
