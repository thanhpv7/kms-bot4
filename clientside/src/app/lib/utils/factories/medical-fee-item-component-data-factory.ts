...
export class MedicalFeeItemComponentDataFactory extends AbstractDataFactory<MedicalFeeItemComponentModel> {
	...
	create(): MedicalFeeItemComponentModel {
		let newModel = new MedicalFeeItemComponentModel();
	...
	createAll(size: number = 10): MedicalFeeItemComponentModel[] {
		let newModels: MedicalFeeItemComponentModel[] = [];
	...
	/**
	 * Given a blank model of type Medical Fee Item Component, populate the model with its properties.
	 ...
	 */
	populate(model: MedicalFeeItemComponentModel) {
