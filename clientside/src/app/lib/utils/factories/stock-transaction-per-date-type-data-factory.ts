...
export class StockTransactionPerDateTypeDataFactory extends AbstractDataFactory<StockTransactionPerDateTypeModel> {
	...
	create(): StockTransactionPerDateTypeModel {
		let newModel = new StockTransactionPerDateTypeModel();
	...
	createAll(size: number = 10): StockTransactionPerDateTypeModel[] {
		let newModels: StockTransactionPerDateTypeModel[] = [];
	...
	/**
	 * Given a blank model of type Stock Transaction Per Date Type, populate the model with its properties.
	 ...
	 */
	populate(model: StockTransactionPerDateTypeModel) {
