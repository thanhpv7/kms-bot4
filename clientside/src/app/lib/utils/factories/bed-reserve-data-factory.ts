...
export class BedReserveDataFactory extends AbstractDataFactory<BedReserveModel> {
	...
	create(): BedReserveModel {
		let newModel = new BedReserveModel();
	...
	createAll(size: number = 10): BedReserveModel[] {
		let newModels: BedReserveModel[] = [];
	...
	/**
	 * Given a blank model of type Bed Reserve, populate the model with its properties.
	 ...
	 */
	populate(model: BedReserveModel) {
