...
export class NhisInvestigationDataFactory extends AbstractDataFactory<NhisInvestigationModel> {
	...
	create(): NhisInvestigationModel {
		let newModel = new NhisInvestigationModel();
	...
	createAll(size: number = 10): NhisInvestigationModel[] {
		let newModels: NhisInvestigationModel[] = [];
	...
	/**
	 * Given a blank model of type NHIS Investigation, populate the model with its properties.
	 ...
	 */
	populate(model: NhisInvestigationModel) {
		...
		model.gdrgCode = faker.random.words();
