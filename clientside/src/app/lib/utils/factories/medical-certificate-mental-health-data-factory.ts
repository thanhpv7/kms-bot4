...
export class MedicalCertificateMentalHealthDataFactory extends AbstractDataFactory<MedicalCertificateMentalHealthModel> {
	...
	create(): MedicalCertificateMentalHealthModel {
		let newModel = new MedicalCertificateMentalHealthModel();
	...
	createAll(size: number = 10): MedicalCertificateMentalHealthModel[] {
		let newModels: MedicalCertificateMentalHealthModel[] = [];
	...
	/**
	 * Given a blank model of type Medical Certificate Mental Health, populate the model with its properties.
	 ...
	 */
	populate(model: MedicalCertificateMentalHealthModel) {
