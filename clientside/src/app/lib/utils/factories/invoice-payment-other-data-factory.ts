...
export class InvoicePaymentOtherDataFactory extends AbstractDataFactory<InvoicePaymentOtherModel> {
	...
	create(): InvoicePaymentOtherModel {
		let newModel = new InvoicePaymentOtherModel();
	...
	createAll(size: number = 10): InvoicePaymentOtherModel[] {
		let newModels: InvoicePaymentOtherModel[] = [];
	...
	/**
	 * Given a blank model of type Invoice Payment Other, populate the model with its properties.
	 ...
	 */
	populate(model: InvoicePaymentOtherModel) {
