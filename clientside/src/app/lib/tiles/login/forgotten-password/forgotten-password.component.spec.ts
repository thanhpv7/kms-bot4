...
import {initialModelState, initialRouterState, RouterState} from '../../../../models/model.state';
...
describe('Forgotten Password Component', () => {
	...
	it('should not call reset password function when click button with invalid form', () => {
		// % protected region % [Add any additional logic before main logic for 'should not call reset password function when click button with valid form' here] off begin
		// % protected region % [Add any additional logic before main logic for 'should not call reset password function when click button with valid form' here] end
	...
	it('should component update state when button is clicked', () => {
		// % protected region % [Add any additional logic before main logic for 'should component update state when button is clicked' here] off begin
		// % protected region % [Add any additional logic before main logic for 'should component update state when button is clicked' here] end
