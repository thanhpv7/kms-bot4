...
export class NavigateRoutingAction implements Action {
	...
	// % protected region % [Add any additional class fields for NavigateRoutingAction here] off begin
	// % protected region % [Add any additional class fields for NavigateRoutingAction here] end
