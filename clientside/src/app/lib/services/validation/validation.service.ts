...
export class ValidationService {
	...
	/**
	 * Error message for invalid URL validator in angular
	 */
	static urlErrorMessage(errorValue, entity) {
		// % protected region % [Customise your error message for the invalid url] off begin
		return `${entity} must be a valid URL`;
		// % protected region % [Customise your error message for the invalid url] end
	}

	/**
	 * Error message for invalid UUID validator in angular
	 */
	static uuidErrorMessage(errorValue, entity) {
		// % protected region % [Customise your error message for the invalid uuid] off begin
		return `${entity} must be a valid UUID`;
		// % protected region % [Customise your error message for the invalid uuid] end
	}

	/**
	 * Error message for invalid alphanumeric validator in angular
	 */
	static alphanumericErrorMessage(errorValue, entity) {
		// % protected region % [Customise your error message for the invalid alphanumeric string] off begin
		return `${entity} must be a valid alphanumeric string`;
		// % protected region % [Customise your error message for the invalid alphanumeric string] end
	}

	/**
	 * Error message for invalid numeric validator in angular
	 */
	static numericErrorMessage(errorValue, entity) {
		// % protected region % [Customise your error message for the invalid numeric string] off begin
		return `${entity} must be a valid numeric string`;
		// % protected region % [Customise your error message for the invalid numeric string] end
	}
	...
	static emailErrorMessage(errorValue, entity) {
		...
		return `${entity} must be a valid email address`;
	...
	static minlengthErrorMessage(errorValue, entity) {
		...
		return `Length must be longer than ${errorValue.requiredLength}`;
	...
	static maxlengthErrorMessage(errorValue, entity) {
		...
		return `Length must be shorter than ${errorValue.requiredLength}`;
	...
	/**
	 * Validation message to show on empty string validation failure
	 *
	 * @param errorValue The values involved, i.e contains values for `actual` and `max`.
	 * @param entity The name of the field that this is being triggered on
	 */
	static nonEmptyStringErrorMessage(errorValue, entity) {
		// % protected region % [Customise your error message for the emptyString validator] off begin
		return `${entity} must not contain only whitespace`;
		// % protected region % [Customise your error message for the emptyString validator] end
	}
