...
export class Link {
	constructor(
		...
		// % protected region % [Add any additional Link attributes here] off begin
		// % protected region % [Add any additional Link attributes here] end
	) {
		this.href = href || '';
		// % protected region % [Add any additional Link constructor logic here] off begin
		// % protected region % [Add any additional Link constructor logic here] end
	}
}
