...
import {PatientVisitPatientPaymentInsuranceModel} from '../../models/patientVisitPatientPaymentInsurance/patient_visit_patient_payment_insurance.model';
import {PatientVisitPatientPaymentInsuranceModelAudit} from '../../models/patientVisitPatientPaymentInsurance/patient_visit_patient_payment_insurance.model.state';
...
/**
 * Patient Visit Patient Payment Insurance service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class PatientVisitPatientPaymentInsuranceService extends AbstractHttpService<PatientVisitPatientPaymentInsuranceModel, PatientVisitPatientPaymentInsuranceModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the PatientVisitPatientPaymentInsuranceProperties classFragment here] off begin
			fragment PatientVisitPatientPaymentInsuranceProperties on PatientVisitPatientPaymentInsurance {
				...PatientVisitPatientPaymentInsuranceBaseProperties
				memberNo
				policyHolderNo
				eligilityVerification
				guaranteeLetterNo
				coverageBalance
				notes
			}
			# % protected region % [Modify the PatientVisitPatientPaymentInsuranceProperties classFragment here] end
			${super.fragments('PatientVisitPatientPaymentInsurance').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<PatientVisitPatientPaymentInsuranceModel>> {
		...
		return  this.apollo.query<PassableStateConfig<PatientVisitPatientPaymentInsuranceModel>>(
			{
				query: gql`
					query Count {
						totalCount: countPatientVisitPatientPaymentInsurances
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<PatientVisitPatientPaymentInsuranceModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<PatientVisitPatientPaymentInsuranceModel>> {
		...
		return this.apollo.query<PassableStateConfig<PatientVisitPatientPaymentInsuranceModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						PatientVisitPatientPaymentInsuranceById: patientVisitPatientPaymentInsuranceById(id: $id) {
							...PatientVisitPatientPaymentInsuranceProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.PatientVisitPatientPaymentInsuranceById as PatientVisitPatientPaymentInsuranceModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PatientVisitPatientPaymentInsuranceModel>> {
		...
		return this.apollo.query<PassableStateConfig<PatientVisitPatientPaymentInsuranceModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						patientVisitPatientPaymentInsurances: patientVisitPatientPaymentInsurances(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...PatientVisitPatientPaymentInsuranceProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countPatientVisitPatientPaymentInsurances(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.patientVisitPatientPaymentInsurances as PatientVisitPatientPaymentInsuranceModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PatientVisitPatientPaymentInsuranceModel>> {
		...
		return this.apollo.query<PassableStateConfig<PatientVisitPatientPaymentInsuranceModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						patientVisitPatientPaymentInsurances: lastPatientVisitPatientPaymentInsurances(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...PatientVisitPatientPaymentInsuranceProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: PatientVisitPatientPaymentInsuranceModel, queryParams?: QueryParams): Observable<PassableStateConfig<PatientVisitPatientPaymentInsuranceModel>> {
		...
		const successMessage = 'Created Patient Visit Patient Payment Insurance entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($patientVisitPatientPaymentInsurance: PatientVisitPatientPaymentInsuranceInput!, $persistRelations: Boolean) {
						patientVisitPatientPaymentInsurance: createPatientVisitPatientPaymentInsurance(patientVisitPatientPaymentInsurance: $patientVisitPatientPaymentInsurance, persistRelations: $persistRelations) {
							...PatientVisitPatientPaymentInsuranceProperties,
				...
				variables: {
					patientVisitPatientPaymentInsurance: {
						...
						insuranceBenefitPlan: entity.insuranceBenefitPlan ? new InsuranceBenefitPlanModel(entity.insuranceBenefitPlan).toJSON() : undefined,
					},
			...
			map(result => {
				...
				return {
					targetModel: result.data.patientVisitPatientPaymentInsurance as PatientVisitPatientPaymentInsuranceModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: PatientVisitPatientPaymentInsuranceModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PatientVisitPatientPaymentInsuranceModel>> {
		...
		const successMessage = 'Created Multiple Patient Visit Patient Payment Insurance entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($patientVisitPatientPaymentInsurances: [PatientVisitPatientPaymentInsuranceInput!]!) {
						patientVisitPatientPaymentInsurance: createAllPatientVisitPatientPaymentInsurance(patientVisitPatientPaymentInsurances: $patientVisitPatientPaymentInsurances) {
							...PatientVisitPatientPaymentInsuranceProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					patientVisitPatientPaymentInsurances: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.patientVisitPatientPaymentInsurance as PatientVisitPatientPaymentInsuranceModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: PatientVisitPatientPaymentInsuranceModel, queryParams?: QueryParams): Observable<PassableStateConfig<PatientVisitPatientPaymentInsuranceModel>> {
		...
		const successMessage = 'Updated Patient Visit Patient Payment Insurance entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($patientVisitPatientPaymentInsurance: PatientVisitPatientPaymentInsuranceInput!, $persistRelations: Boolean) {
						patientVisitPatientPaymentInsurance: updatePatientVisitPatientPaymentInsurance(patientVisitPatientPaymentInsurance: $patientVisitPatientPaymentInsurance, persistRelations: $persistRelations) {
							...PatientVisitPatientPaymentInsuranceProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: PatientVisitPatientPaymentInsuranceModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PatientVisitPatientPaymentInsuranceModel>> {
		...
		const successMessage = 'Update Multiple Patient Visit Patient Payment Insurance entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($patientVisitPatientPaymentInsurances: [PatientVisitPatientPaymentInsuranceInput!]!) {
						patientVisitPatientPaymentInsurance: updateAllPatientVisitPatientPaymentInsurance(patientVisitPatientPaymentInsurances: $patientVisitPatientPaymentInsurances) {
							...PatientVisitPatientPaymentInsuranceProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<PatientVisitPatientPaymentInsuranceModel>> {
		...
		const successMessage = 'Deleted Patient Visit Patient Payment Insurance entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($patientVisitPatientPaymentInsuranceId: ID!) {
						patientVisitPatientPaymentInsuranceId: deletePatientVisitPatientPaymentInsuranceById(patientVisitPatientPaymentInsuranceId: $patientVisitPatientPaymentInsuranceId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.patientVisitPatientPaymentInsuranceId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<PatientVisitPatientPaymentInsuranceModel>> {
		...
		const successMessage = 'Deleted selected Patient Visit Patient Payment Insurance entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($patientVisitPatientPaymentInsuranceIds: [ID!]!){
						deletePatientVisitPatientPaymentInsuranceExcludingIds(patientVisitPatientPaymentInsuranceIds: $patientVisitPatientPaymentInsuranceIds)
				...
				`,
				variables: {
					patientVisitPatientPaymentInsuranceIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.patientVisitPatientPaymentInsuranceIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<PatientVisitPatientPaymentInsuranceModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($patientVisitPatientPaymentInsuranceIds: [ID!]!) {
						patientVisitPatientPaymentInsuranceIds: deleteAllPatientVisitPatientPaymentInsuranceByIds(patientVisitPatientPaymentInsuranceIds: $patientVisitPatientPaymentInsuranceIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<PatientVisitPatientPaymentInsuranceModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PatientVisitPatientPaymentInsuranceModel>>(
			{
				query: gql`
					query GetAudits {
						audits: patientVisitPatientPaymentInsuranceAudits {
							entity {
								...PatientVisitPatientPaymentInsuranceProperties
							}
							timestamp
			...
			map(result => {
				let audits: PatientVisitPatientPaymentInsuranceModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new PatientVisitPatientPaymentInsuranceModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<PatientVisitPatientPaymentInsuranceModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PatientVisitPatientPaymentInsuranceModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($patientVisitPatientPaymentInsuranceId: ID!) {
						audits: patientVisitPatientPaymentInsuranceAuditsByEntityId(patientVisitPatientPaymentInsuranceId: $patientVisitPatientPaymentInsuranceId) {
							entity {
								...PatientVisitPatientPaymentInsuranceProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<PatientVisitPatientPaymentInsuranceModel>> {
		const url = environment.API_URL + '/api/patientvisitpatientpaymentinsurance/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<PatientVisitPatientPaymentInsuranceModel>> {
		const url = environment.API_URL + '/api/patientvisitpatientpaymentinsurance/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<PatientVisitPatientPaymentInsuranceModel>> {
		let apiUrl = environment.API_URL + '/api/patientvisitpatientpaymentinsurance/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<PatientVisitPatientPaymentInsuranceModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/patientvisitpatientpaymentinsurance/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Patient Visit Patient Payment Insurance entities')),
