...
import {VaccinationOrderDetailModel} from '../../models/vaccinationOrderDetail/vaccination_order_detail.model';
import {VaccinationOrderDetailModelAudit} from '../../models/vaccinationOrderDetail/vaccination_order_detail.model.state';
...
/**
 * Vaccination Order Detail service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class VaccinationOrderDetailService extends AbstractHttpService<VaccinationOrderDetailModel, VaccinationOrderDetailModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the VaccinationOrderDetailProperties classFragment here] off begin
			fragment VaccinationOrderDetailProperties on VaccinationOrderDetail {
				...VaccinationOrderDetailBaseProperties
				vaccinationDate
				vaccinationType
				vaccinationDetail
				quantity
			}
			# % protected region % [Modify the VaccinationOrderDetailProperties classFragment here] end
			${super.fragments('VaccinationOrderDetail').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<VaccinationOrderDetailModel>> {
		...
		return  this.apollo.query<PassableStateConfig<VaccinationOrderDetailModel>>(
			{
				query: gql`
					query Count {
						totalCount: countVaccinationOrderDetails
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<VaccinationOrderDetailModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<VaccinationOrderDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<VaccinationOrderDetailModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						VaccinationOrderDetailById: vaccinationOrderDetailById(id: $id) {
							...VaccinationOrderDetailProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.VaccinationOrderDetailById as VaccinationOrderDetailModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<VaccinationOrderDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<VaccinationOrderDetailModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						vaccinationOrderDetails: vaccinationOrderDetails(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...VaccinationOrderDetailProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countVaccinationOrderDetails(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.vaccinationOrderDetails as VaccinationOrderDetailModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<VaccinationOrderDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<VaccinationOrderDetailModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						vaccinationOrderDetails: lastVaccinationOrderDetails(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...VaccinationOrderDetailProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: VaccinationOrderDetailModel, queryParams?: QueryParams): Observable<PassableStateConfig<VaccinationOrderDetailModel>> {
		...
		const successMessage = 'Created Vaccination Order Detail entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($vaccinationOrderDetail: VaccinationOrderDetailInput!, $persistRelations: Boolean) {
						vaccinationOrderDetail: createVaccinationOrderDetail(vaccinationOrderDetail: $vaccinationOrderDetail, persistRelations: $persistRelations) {
							...VaccinationOrderDetailProperties,
				...
				`,
				variables: {
					vaccinationOrderDetail: {
						...entity.toJSON(),
						stockCatalogue: entity.stockCatalogue ? new StockCatalogueModel(entity.stockCatalogue).toJSON() : undefined,
						vaccinationOrder: entity.vaccinationOrder ? new VaccinationOrderModel(entity.vaccinationOrder).toJSON() : undefined,
			...
			map(result => {
				...
				return {
					targetModel: result.data.vaccinationOrderDetail as VaccinationOrderDetailModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: VaccinationOrderDetailModel[], queryParams?: QueryParams): Observable<PassableStateConfig<VaccinationOrderDetailModel>> {
		...
		const successMessage = 'Created Multiple Vaccination Order Detail entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($vaccinationOrderDetails: [VaccinationOrderDetailInput!]!) {
						vaccinationOrderDetail: createAllVaccinationOrderDetail(vaccinationOrderDetails: $vaccinationOrderDetails) {
							...VaccinationOrderDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					vaccinationOrderDetails: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.vaccinationOrderDetail as VaccinationOrderDetailModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: VaccinationOrderDetailModel, queryParams?: QueryParams): Observable<PassableStateConfig<VaccinationOrderDetailModel>> {
		...
		const successMessage = 'Updated Vaccination Order Detail entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($vaccinationOrderDetail: VaccinationOrderDetailInput!, $persistRelations: Boolean) {
						vaccinationOrderDetail: updateVaccinationOrderDetail(vaccinationOrderDetail: $vaccinationOrderDetail, persistRelations: $persistRelations) {
							...VaccinationOrderDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: VaccinationOrderDetailModel[], queryParams?: QueryParams): Observable<PassableStateConfig<VaccinationOrderDetailModel>> {
		...
		const successMessage = 'Update Multiple Vaccination Order Detail entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($vaccinationOrderDetails: [VaccinationOrderDetailInput!]!) {
						vaccinationOrderDetail: updateAllVaccinationOrderDetail(vaccinationOrderDetails: $vaccinationOrderDetails) {
							...VaccinationOrderDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<VaccinationOrderDetailModel>> {
		...
		const successMessage = 'Deleted Vaccination Order Detail entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($vaccinationOrderDetailId: ID!) {
						vaccinationOrderDetailId: deleteVaccinationOrderDetailById(vaccinationOrderDetailId: $vaccinationOrderDetailId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.vaccinationOrderDetailId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<VaccinationOrderDetailModel>> {
		...
		const successMessage = 'Deleted selected Vaccination Order Detail entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($vaccinationOrderDetailIds: [ID!]!){
						deleteVaccinationOrderDetailExcludingIds(vaccinationOrderDetailIds: $vaccinationOrderDetailIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.vaccinationOrderDetailIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<VaccinationOrderDetailModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($vaccinationOrderDetailIds: [ID!]!) {
						vaccinationOrderDetailIds: deleteAllVaccinationOrderDetailByIds(vaccinationOrderDetailIds: $vaccinationOrderDetailIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<VaccinationOrderDetailModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<VaccinationOrderDetailModel>>(
			{
				query: gql`
					query GetAudits {
						audits: vaccinationOrderDetailAudits {
							entity {
								...VaccinationOrderDetailProperties
							}
							timestamp
			...
			map(result => {
				let audits: VaccinationOrderDetailModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new VaccinationOrderDetailModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<VaccinationOrderDetailModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<VaccinationOrderDetailModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($vaccinationOrderDetailId: ID!) {
						audits: vaccinationOrderDetailAuditsByEntityId(vaccinationOrderDetailId: $vaccinationOrderDetailId) {
							entity {
								...VaccinationOrderDetailProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<VaccinationOrderDetailModel>> {
		const url = environment.API_URL + '/api/vaccinationorderdetail/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<VaccinationOrderDetailModel>> {
		const url = environment.API_URL + '/api/vaccinationorderdetail/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<VaccinationOrderDetailModel>> {
		let apiUrl = environment.API_URL + '/api/vaccinationorderdetail/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<VaccinationOrderDetailModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/vaccinationorderdetail/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Vaccination Order Detail entities')),
