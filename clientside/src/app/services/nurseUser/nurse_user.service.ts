...
import {NurseUserModel} from '../../models/nurseUser/nurse_user.model';
import {NurseUserModelAudit} from '../../models/nurseUser/nurse_user.model.state';
...
/**
 * Nurse User service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class NurseUserService extends UserService<NurseUserModel, NurseUserModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the NurseUserProperties classFragment here] off begin
			fragment NurseUserProperties on NurseUser {
				...NurseUserUserProperties
			}
			# % protected region % [Modify the NurseUserProperties classFragment here] end
			${super.fragments('NurseUser').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<NurseUserModel>> {
		...
		return  this.apollo.query<PassableStateConfig<NurseUserModel>>(
			{
				query: gql`
					query Count {
						totalCount: countNurseUsers
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<NurseUserModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<NurseUserModel>> {
		...
		return this.apollo.query<PassableStateConfig<NurseUserModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						NurseUserById: nurseUserById(id: $id) {
							...NurseUserProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.NurseUserById as NurseUserModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<NurseUserModel>> {
		...
		return this.apollo.query<PassableStateConfig<NurseUserModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						nurseUsers: nurseUsers(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...NurseUserProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countNurseUsers(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.nurseUsers as NurseUserModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<NurseUserModel>> {
		...
		return this.apollo.query<PassableStateConfig<NurseUserModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						nurseUsers: lastNurseUsers(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...NurseUserProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: NurseUserModel, queryParams?: QueryParams): Observable<PassableStateConfig<NurseUserModel>> {
		...
		const successMessage = 'Created Nurse User entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($nurseUser: NurseUserInput!, $persistRelations: Boolean) {
						nurseUser: createNurseUser(nurseUser: $nurseUser, persistRelations: $persistRelations) {
							...NurseUserProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.nurseUser as NurseUserModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: NurseUserModel[], queryParams?: QueryParams): Observable<PassableStateConfig<NurseUserModel>> {
		...
		const successMessage = 'Created Multiple Nurse User entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($nurseUsers: [NurseUserInput!]!) {
						nurseUser: createAllNurseUser(nurseUsers: $nurseUsers) {
							...NurseUserProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					nurseUsers: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.nurseUser as NurseUserModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: NurseUserModel, queryParams?: QueryParams): Observable<PassableStateConfig<NurseUserModel>> {
		...
		const successMessage = 'Updated Nurse User entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($nurseUser: NurseUserInput!, $persistRelations: Boolean) {
						nurseUser: updateNurseUser(nurseUser: $nurseUser, persistRelations: $persistRelations) {
							...NurseUserProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: NurseUserModel[], queryParams?: QueryParams): Observable<PassableStateConfig<NurseUserModel>> {
		...
		const successMessage = 'Update Multiple Nurse User entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($nurseUsers: [NurseUserInput!]!) {
						nurseUser: updateAllNurseUser(nurseUsers: $nurseUsers) {
							...NurseUserProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<NurseUserModel>> {
		...
		const successMessage = 'Deleted Nurse User entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($nurseUserId: ID!) {
						nurseUserId: deleteNurseUserById(nurseUserId: $nurseUserId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.nurseUserId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<NurseUserModel>> {
		...
		const successMessage = 'Deleted selected Nurse User entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($nurseUserIds: [ID!]!){
						deleteNurseUserExcludingIds(nurseUserIds: $nurseUserIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.nurseUserIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<NurseUserModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($nurseUserIds: [ID!]!) {
						nurseUserIds: deleteAllNurseUserByIds(nurseUserIds: $nurseUserIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<NurseUserModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<NurseUserModel>>(
			...
			map(result => {
				let audits: NurseUserModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new NurseUserModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<NurseUserModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<NurseUserModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($nurseUserId: ID!) {
						audits: nurseUserAuditsByEntityId(nurseUserId: $nurseUserId) {
							entity {
								...NurseUserProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<NurseUserModel>> {
		const url = environment.API_URL + '/api/nurseuser/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<NurseUserModel>> {
		const url = environment.API_URL + '/api/nurseuser/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<NurseUserModel>> {
		let apiUrl = environment.API_URL + '/api/nurseuser/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<NurseUserModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/nurseuser/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Nurse User entities')),
