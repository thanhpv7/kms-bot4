...
import {BatchStockBalanceModelAudit} from '../../models/batchStockBalance/batch_stock_balance.model.state';
...
/**
 * Batch Stock Balance service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BatchStockBalanceService extends AbstractHttpService<BatchStockBalanceModel, BatchStockBalanceModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BatchStockBalanceProperties classFragment here] off begin
			fragment BatchStockBalanceProperties on BatchStockBalance {
				...BatchStockBalanceBaseProperties
				sourceNumber
				batchNo
				expirationDate
				batchQtyUoi
			...
			# % protected region % [Modify the BatchStockBalanceProperties classFragment here] end
			${super.fragments('BatchStockBalance').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BatchStockBalanceModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BatchStockBalanceModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBatchStockBalances
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BatchStockBalanceModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BatchStockBalanceModel>> {
		...
		return this.apollo.query<PassableStateConfig<BatchStockBalanceModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BatchStockBalanceById: batchStockBalanceById(id: $id) {
							...BatchStockBalanceProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BatchStockBalanceById as BatchStockBalanceModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BatchStockBalanceModel>> {
		...
		return this.apollo.query<PassableStateConfig<BatchStockBalanceModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						batchStockBalances: batchStockBalances(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BatchStockBalanceProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBatchStockBalances(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.batchStockBalances as BatchStockBalanceModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BatchStockBalanceModel>> {
		...
		return this.apollo.query<PassableStateConfig<BatchStockBalanceModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						batchStockBalances: lastBatchStockBalances(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BatchStockBalanceProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BatchStockBalanceModel, queryParams?: QueryParams): Observable<PassableStateConfig<BatchStockBalanceModel>> {
		...
		const successMessage = 'Created Batch Stock Balance entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($batchStockBalance: BatchStockBalanceInput!, $persistRelations: Boolean) {
						batchStockBalance: createBatchStockBalance(batchStockBalance: $batchStockBalance, persistRelations: $persistRelations) {
							...BatchStockBalanceProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.batchStockBalance as BatchStockBalanceModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BatchStockBalanceModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BatchStockBalanceModel>> {
		...
		const successMessage = 'Created Multiple Batch Stock Balance entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($batchStockBalances: [BatchStockBalanceInput!]!) {
						batchStockBalance: createAllBatchStockBalance(batchStockBalances: $batchStockBalances) {
							...BatchStockBalanceProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					batchStockBalances: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.batchStockBalance as BatchStockBalanceModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BatchStockBalanceModel, queryParams?: QueryParams): Observable<PassableStateConfig<BatchStockBalanceModel>> {
		...
		const successMessage = 'Updated Batch Stock Balance entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($batchStockBalance: BatchStockBalanceInput!, $persistRelations: Boolean) {
						batchStockBalance: updateBatchStockBalance(batchStockBalance: $batchStockBalance, persistRelations: $persistRelations) {
							...BatchStockBalanceProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BatchStockBalanceModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BatchStockBalanceModel>> {
		...
		const successMessage = 'Update Multiple Batch Stock Balance entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($batchStockBalances: [BatchStockBalanceInput!]!) {
						batchStockBalance: updateAllBatchStockBalance(batchStockBalances: $batchStockBalances) {
							...BatchStockBalanceProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BatchStockBalanceModel>> {
		...
		const successMessage = 'Deleted Batch Stock Balance entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($batchStockBalanceId: ID!) {
						batchStockBalanceId: deleteBatchStockBalanceById(batchStockBalanceId: $batchStockBalanceId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.batchStockBalanceId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BatchStockBalanceModel>> {
		...
		const successMessage = 'Deleted selected Batch Stock Balance entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($batchStockBalanceIds: [ID!]!){
						deleteBatchStockBalanceExcludingIds(batchStockBalanceIds: $batchStockBalanceIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.batchStockBalanceIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BatchStockBalanceModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($batchStockBalanceIds: [ID!]!) {
						batchStockBalanceIds: deleteAllBatchStockBalanceByIds(batchStockBalanceIds: $batchStockBalanceIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BatchStockBalanceModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BatchStockBalanceModel>>(
			{
				query: gql`
					query GetAudits {
						audits: batchStockBalanceAudits {
							entity {
								...BatchStockBalanceProperties
							}
							timestamp
			...
			map(result => {
				let audits: BatchStockBalanceModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BatchStockBalanceModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BatchStockBalanceModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BatchStockBalanceModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($batchStockBalanceId: ID!) {
						audits: batchStockBalanceAuditsByEntityId(batchStockBalanceId: $batchStockBalanceId) {
							entity {
								...BatchStockBalanceProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BatchStockBalanceModel>> {
		const url = environment.API_URL + '/api/batchstockbalance/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BatchStockBalanceModel>> {
		const url = environment.API_URL + '/api/batchstockbalance/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BatchStockBalanceModel>> {
		let apiUrl = environment.API_URL + '/api/batchstockbalance/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BatchStockBalanceModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/batchstockbalance/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Batch Stock Balance entities')),
