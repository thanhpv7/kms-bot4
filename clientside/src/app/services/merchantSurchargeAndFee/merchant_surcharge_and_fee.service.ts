...
import {MerchantSurchargeAndFeeModelAudit} from '../../models/merchantSurchargeAndFee/merchant_surcharge_and_fee.model.state';
...
/**
 * Merchant Surcharge and Fee service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class MerchantSurchargeAndFeeService extends AbstractHttpService<MerchantSurchargeAndFeeModel, MerchantSurchargeAndFeeModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the MerchantSurchargeAndFeeProperties classFragment here] off begin
			fragment MerchantSurchargeAndFeeProperties on MerchantSurchargeAndFee {
				...MerchantSurchargeAndFeeBaseProperties
				bankName
				cardType
				surcharge
				fee
			}
			# % protected region % [Modify the MerchantSurchargeAndFeeProperties classFragment here] end
			${super.fragments('MerchantSurchargeAndFee').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<MerchantSurchargeAndFeeModel>> {
		...
		return  this.apollo.query<PassableStateConfig<MerchantSurchargeAndFeeModel>>(
			{
				query: gql`
					query Count {
						totalCount: countMerchantSurchargeAndFees
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<MerchantSurchargeAndFeeModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<MerchantSurchargeAndFeeModel>> {
		...
		return this.apollo.query<PassableStateConfig<MerchantSurchargeAndFeeModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						MerchantSurchargeAndFeeById: merchantSurchargeAndFeeById(id: $id) {
							...MerchantSurchargeAndFeeProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.MerchantSurchargeAndFeeById as MerchantSurchargeAndFeeModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<MerchantSurchargeAndFeeModel>> {
		...
		return this.apollo.query<PassableStateConfig<MerchantSurchargeAndFeeModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						merchantSurchargeAndFees: merchantSurchargeAndFees(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...MerchantSurchargeAndFeeProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countMerchantSurchargeAndFees(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.merchantSurchargeAndFees as MerchantSurchargeAndFeeModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<MerchantSurchargeAndFeeModel>> {
		...
		return this.apollo.query<PassableStateConfig<MerchantSurchargeAndFeeModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						merchantSurchargeAndFees: lastMerchantSurchargeAndFees(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...MerchantSurchargeAndFeeProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: MerchantSurchargeAndFeeModel, queryParams?: QueryParams): Observable<PassableStateConfig<MerchantSurchargeAndFeeModel>> {
		...
		const successMessage = 'Created Merchant Surcharge and Fee entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($merchantSurchargeAndFee: MerchantSurchargeAndFeeInput!, $persistRelations: Boolean) {
						merchantSurchargeAndFee: createMerchantSurchargeAndFee(merchantSurchargeAndFee: $merchantSurchargeAndFee, persistRelations: $persistRelations) {
							...MerchantSurchargeAndFeeProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.merchantSurchargeAndFee as MerchantSurchargeAndFeeModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: MerchantSurchargeAndFeeModel[], queryParams?: QueryParams): Observable<PassableStateConfig<MerchantSurchargeAndFeeModel>> {
		...
		const successMessage = 'Created Multiple Merchant Surcharge and Fee entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($merchantSurchargeAndFees: [MerchantSurchargeAndFeeInput!]!) {
						merchantSurchargeAndFee: createAllMerchantSurchargeAndFee(merchantSurchargeAndFees: $merchantSurchargeAndFees) {
							...MerchantSurchargeAndFeeProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					merchantSurchargeAndFees: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.merchantSurchargeAndFee as MerchantSurchargeAndFeeModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: MerchantSurchargeAndFeeModel, queryParams?: QueryParams): Observable<PassableStateConfig<MerchantSurchargeAndFeeModel>> {
		...
		const successMessage = 'Updated Merchant Surcharge and Fee entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($merchantSurchargeAndFee: MerchantSurchargeAndFeeInput!, $persistRelations: Boolean) {
						merchantSurchargeAndFee: updateMerchantSurchargeAndFee(merchantSurchargeAndFee: $merchantSurchargeAndFee, persistRelations: $persistRelations) {
							...MerchantSurchargeAndFeeProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: MerchantSurchargeAndFeeModel[], queryParams?: QueryParams): Observable<PassableStateConfig<MerchantSurchargeAndFeeModel>> {
		...
		const successMessage = 'Update Multiple Merchant Surcharge and Fee entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($merchantSurchargeAndFees: [MerchantSurchargeAndFeeInput!]!) {
						merchantSurchargeAndFee: updateAllMerchantSurchargeAndFee(merchantSurchargeAndFees: $merchantSurchargeAndFees) {
							...MerchantSurchargeAndFeeProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<MerchantSurchargeAndFeeModel>> {
		...
		const successMessage = 'Deleted Merchant Surcharge and Fee entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($merchantSurchargeAndFeeId: ID!) {
						merchantSurchargeAndFeeId: deleteMerchantSurchargeAndFeeById(merchantSurchargeAndFeeId: $merchantSurchargeAndFeeId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.merchantSurchargeAndFeeId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<MerchantSurchargeAndFeeModel>> {
		...
		const successMessage = 'Deleted selected Merchant Surcharge and Fee entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($merchantSurchargeAndFeeIds: [ID!]!){
						deleteMerchantSurchargeAndFeeExcludingIds(merchantSurchargeAndFeeIds: $merchantSurchargeAndFeeIds)
				...
				`,
				variables: {
					merchantSurchargeAndFeeIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.merchantSurchargeAndFeeIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<MerchantSurchargeAndFeeModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($merchantSurchargeAndFeeIds: [ID!]!) {
						merchantSurchargeAndFeeIds: deleteAllMerchantSurchargeAndFeeByIds(merchantSurchargeAndFeeIds: $merchantSurchargeAndFeeIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<MerchantSurchargeAndFeeModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<MerchantSurchargeAndFeeModel>>(
			{
				query: gql`
					query GetAudits {
						audits: merchantSurchargeAndFeeAudits {
							entity {
								...MerchantSurchargeAndFeeProperties
							}
							timestamp
			...
			map(result => {
				let audits: MerchantSurchargeAndFeeModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new MerchantSurchargeAndFeeModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<MerchantSurchargeAndFeeModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<MerchantSurchargeAndFeeModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($merchantSurchargeAndFeeId: ID!) {
						audits: merchantSurchargeAndFeeAuditsByEntityId(merchantSurchargeAndFeeId: $merchantSurchargeAndFeeId) {
							entity {
								...MerchantSurchargeAndFeeProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<MerchantSurchargeAndFeeModel>> {
		const url = environment.API_URL + '/api/merchantsurchargeandfee/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<MerchantSurchargeAndFeeModel>> {
		const url = environment.API_URL + '/api/merchantsurchargeandfee/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<MerchantSurchargeAndFeeModel>> {
		let apiUrl = environment.API_URL + '/api/merchantsurchargeandfee/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<MerchantSurchargeAndFeeModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/merchantsurchargeandfee/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Merchant Surcharge and Fee entities')),
