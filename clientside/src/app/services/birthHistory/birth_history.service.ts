...
import {BirthHistoryModelAudit} from '../../models/birthHistory/birth_history.model.state';
...
/**
 * Birth History service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BirthHistoryService extends AbstractHttpService<BirthHistoryModel, BirthHistoryModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BirthHistoryProperties classFragment here] off begin
			fragment BirthHistoryProperties on BirthHistory {
				...BirthHistoryBaseProperties
				gestationalAgeWeeks
				gestationalAgeDays
				deliveryType
				length
				...
				upperArmCircumferenceUnit
				actionTaken
				weightGestationalAge
			}
			# % protected region % [Modify the BirthHistoryProperties classFragment here] end
			${super.fragments('BirthHistory').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BirthHistoryModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BirthHistoryModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBirthHistorys
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BirthHistoryModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BirthHistoryModel>> {
		...
		return this.apollo.query<PassableStateConfig<BirthHistoryModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BirthHistoryById: birthHistoryById(id: $id) {
							...BirthHistoryProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BirthHistoryById as BirthHistoryModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BirthHistoryModel>> {
		...
		return this.apollo.query<PassableStateConfig<BirthHistoryModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						birthHistorys: birthHistorys(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BirthHistoryProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBirthHistorys(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.birthHistorys as BirthHistoryModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BirthHistoryModel>> {
		...
		return this.apollo.query<PassableStateConfig<BirthHistoryModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						birthHistorys: lastBirthHistorys(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BirthHistoryProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BirthHistoryModel, queryParams?: QueryParams): Observable<PassableStateConfig<BirthHistoryModel>> {
		...
		const successMessage = 'Created Birth History entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($birthHistory: BirthHistoryInput!, $persistRelations: Boolean) {
						birthHistory: createBirthHistory(birthHistory: $birthHistory, persistRelations: $persistRelations) {
							...BirthHistoryProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.birthHistory as BirthHistoryModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BirthHistoryModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BirthHistoryModel>> {
		...
		const successMessage = 'Created Multiple Birth History entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($birthHistorys: [BirthHistoryInput!]!) {
						birthHistory: createAllBirthHistory(birthHistorys: $birthHistorys) {
							...BirthHistoryProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					birthHistorys: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.birthHistory as BirthHistoryModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BirthHistoryModel, queryParams?: QueryParams): Observable<PassableStateConfig<BirthHistoryModel>> {
		...
		const successMessage = 'Updated Birth History entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($birthHistory: BirthHistoryInput!, $persistRelations: Boolean) {
						birthHistory: updateBirthHistory(birthHistory: $birthHistory, persistRelations: $persistRelations) {
							...BirthHistoryProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BirthHistoryModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BirthHistoryModel>> {
		...
		const successMessage = 'Update Multiple Birth History entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($birthHistorys: [BirthHistoryInput!]!) {
						birthHistory: updateAllBirthHistory(birthHistorys: $birthHistorys) {
							...BirthHistoryProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BirthHistoryModel>> {
		...
		const successMessage = 'Deleted Birth History entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($birthHistoryId: ID!) {
						birthHistoryId: deleteBirthHistoryById(birthHistoryId: $birthHistoryId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.birthHistoryId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BirthHistoryModel>> {
		...
		const successMessage = 'Deleted selected Birth History entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($birthHistoryIds: [ID!]!){
						deleteBirthHistoryExcludingIds(birthHistoryIds: $birthHistoryIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.birthHistoryIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BirthHistoryModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($birthHistoryIds: [ID!]!) {
						birthHistoryIds: deleteAllBirthHistoryByIds(birthHistoryIds: $birthHistoryIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BirthHistoryModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BirthHistoryModel>>(
			...
			map(result => {
				let audits: BirthHistoryModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BirthHistoryModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BirthHistoryModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BirthHistoryModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($birthHistoryId: ID!) {
						audits: birthHistoryAuditsByEntityId(birthHistoryId: $birthHistoryId) {
							entity {
								...BirthHistoryProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BirthHistoryModel>> {
		const url = environment.API_URL + '/api/birthhistory/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BirthHistoryModel>> {
		const url = environment.API_URL + '/api/birthhistory/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BirthHistoryModel>> {
		let apiUrl = environment.API_URL + '/api/birthhistory/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BirthHistoryModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/birthhistory/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Birth History entities')),
