...
import {MedicalCertificateSickLeaveModel} from '../../models/medicalCertificateSickLeave/medical_certificate_sick_leave.model';
import {MedicalCertificateSickLeaveModelAudit} from '../../models/medicalCertificateSickLeave/medical_certificate_sick_leave.model.state';
...
/**
 * Medical Certificate Sick Leave service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class MedicalCertificateSickLeaveService extends AbstractHttpService<MedicalCertificateSickLeaveModel, MedicalCertificateSickLeaveModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the MedicalCertificateSickLeaveProperties classFragment here] off begin
			fragment MedicalCertificateSickLeaveProperties on MedicalCertificateSickLeave {
				...MedicalCertificateSickLeaveBaseProperties
				period
				startDate
				endDate
				notes
			}
			# % protected region % [Modify the MedicalCertificateSickLeaveProperties classFragment here] end
			${super.fragments('MedicalCertificateSickLeave').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<MedicalCertificateSickLeaveModel>> {
		...
		return  this.apollo.query<PassableStateConfig<MedicalCertificateSickLeaveModel>>(
			{
				query: gql`
					query Count {
						totalCount: countMedicalCertificateSickLeaves
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<MedicalCertificateSickLeaveModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<MedicalCertificateSickLeaveModel>> {
		...
		return this.apollo.query<PassableStateConfig<MedicalCertificateSickLeaveModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						MedicalCertificateSickLeaveById: medicalCertificateSickLeaveById(id: $id) {
							...MedicalCertificateSickLeaveProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.MedicalCertificateSickLeaveById as MedicalCertificateSickLeaveModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<MedicalCertificateSickLeaveModel>> {
		...
		return this.apollo.query<PassableStateConfig<MedicalCertificateSickLeaveModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						medicalCertificateSickLeaves: medicalCertificateSickLeaves(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...MedicalCertificateSickLeaveProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countMedicalCertificateSickLeaves(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.medicalCertificateSickLeaves as MedicalCertificateSickLeaveModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<MedicalCertificateSickLeaveModel>> {
		...
		return this.apollo.query<PassableStateConfig<MedicalCertificateSickLeaveModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						medicalCertificateSickLeaves: lastMedicalCertificateSickLeaves(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...MedicalCertificateSickLeaveProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: MedicalCertificateSickLeaveModel, queryParams?: QueryParams): Observable<PassableStateConfig<MedicalCertificateSickLeaveModel>> {
		...
		const successMessage = 'Created Medical Certificate Sick Leave entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($medicalCertificateSickLeave: MedicalCertificateSickLeaveInput!, $persistRelations: Boolean) {
						medicalCertificateSickLeave: createMedicalCertificateSickLeave(medicalCertificateSickLeave: $medicalCertificateSickLeave, persistRelations: $persistRelations) {
							...MedicalCertificateSickLeaveProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.medicalCertificateSickLeave as MedicalCertificateSickLeaveModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: MedicalCertificateSickLeaveModel[], queryParams?: QueryParams): Observable<PassableStateConfig<MedicalCertificateSickLeaveModel>> {
		...
		const successMessage = 'Created Multiple Medical Certificate Sick Leave entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($medicalCertificateSickLeaves: [MedicalCertificateSickLeaveInput!]!) {
						medicalCertificateSickLeave: createAllMedicalCertificateSickLeave(medicalCertificateSickLeaves: $medicalCertificateSickLeaves) {
							...MedicalCertificateSickLeaveProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					medicalCertificateSickLeaves: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.medicalCertificateSickLeave as MedicalCertificateSickLeaveModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: MedicalCertificateSickLeaveModel, queryParams?: QueryParams): Observable<PassableStateConfig<MedicalCertificateSickLeaveModel>> {
		...
		const successMessage = 'Updated Medical Certificate Sick Leave entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($medicalCertificateSickLeave: MedicalCertificateSickLeaveInput!, $persistRelations: Boolean) {
						medicalCertificateSickLeave: updateMedicalCertificateSickLeave(medicalCertificateSickLeave: $medicalCertificateSickLeave, persistRelations: $persistRelations) {
							...MedicalCertificateSickLeaveProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: MedicalCertificateSickLeaveModel[], queryParams?: QueryParams): Observable<PassableStateConfig<MedicalCertificateSickLeaveModel>> {
		...
		const successMessage = 'Update Multiple Medical Certificate Sick Leave entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($medicalCertificateSickLeaves: [MedicalCertificateSickLeaveInput!]!) {
						medicalCertificateSickLeave: updateAllMedicalCertificateSickLeave(medicalCertificateSickLeaves: $medicalCertificateSickLeaves) {
							...MedicalCertificateSickLeaveProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<MedicalCertificateSickLeaveModel>> {
		...
		const successMessage = 'Deleted Medical Certificate Sick Leave entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($medicalCertificateSickLeaveId: ID!) {
						medicalCertificateSickLeaveId: deleteMedicalCertificateSickLeaveById(medicalCertificateSickLeaveId: $medicalCertificateSickLeaveId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.medicalCertificateSickLeaveId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<MedicalCertificateSickLeaveModel>> {
		...
		const successMessage = 'Deleted selected Medical Certificate Sick Leave entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($medicalCertificateSickLeaveIds: [ID!]!){
						deleteMedicalCertificateSickLeaveExcludingIds(medicalCertificateSickLeaveIds: $medicalCertificateSickLeaveIds)
				...
				`,
				variables: {
					medicalCertificateSickLeaveIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.medicalCertificateSickLeaveIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<MedicalCertificateSickLeaveModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($medicalCertificateSickLeaveIds: [ID!]!) {
						medicalCertificateSickLeaveIds: deleteAllMedicalCertificateSickLeaveByIds(medicalCertificateSickLeaveIds: $medicalCertificateSickLeaveIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<MedicalCertificateSickLeaveModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<MedicalCertificateSickLeaveModel>>(
			{
				query: gql`
					query GetAudits {
						audits: medicalCertificateSickLeaveAudits {
							entity {
								...MedicalCertificateSickLeaveProperties
							}
							timestamp
			...
			map(result => {
				let audits: MedicalCertificateSickLeaveModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new MedicalCertificateSickLeaveModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<MedicalCertificateSickLeaveModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<MedicalCertificateSickLeaveModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($medicalCertificateSickLeaveId: ID!) {
						audits: medicalCertificateSickLeaveAuditsByEntityId(medicalCertificateSickLeaveId: $medicalCertificateSickLeaveId) {
							entity {
								...MedicalCertificateSickLeaveProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<MedicalCertificateSickLeaveModel>> {
		const url = environment.API_URL + '/api/medicalcertificatesickleave/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<MedicalCertificateSickLeaveModel>> {
		const url = environment.API_URL + '/api/medicalcertificatesickleave/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<MedicalCertificateSickLeaveModel>> {
		let apiUrl = environment.API_URL + '/api/medicalcertificatesickleave/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<MedicalCertificateSickLeaveModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/medicalcertificatesickleave/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Medical Certificate Sick Leave entities')),
