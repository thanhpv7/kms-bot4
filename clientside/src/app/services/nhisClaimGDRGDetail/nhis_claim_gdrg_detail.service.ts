...
import {NhisClaimGDRGDetailModelAudit} from '../../models/nhisClaimGDRGDetail/nhis_claim_gdrg_detail.model.state';
...
/**
 * NHIS Claim GDRG Detail service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class NhisClaimGDRGDetailService extends AbstractHttpService<NhisClaimGDRGDetailModel, NhisClaimGDRGDetailModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the NhisClaimGDRGDetailProperties classFragment here] off begin
			fragment NhisClaimGDRGDetailProperties on NhisClaimGDRGDetail {
				...NhisClaimGDRGDetailBaseProperties
				description
			}
			# % protected region % [Modify the NhisClaimGDRGDetailProperties classFragment here] end
			${super.fragments('NhisClaimGDRGDetail').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<NhisClaimGDRGDetailModel>> {
		...
		return  this.apollo.query<PassableStateConfig<NhisClaimGDRGDetailModel>>(
			{
				query: gql`
					query Count {
						totalCount: countNhisClaimGDRGDetails
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<NhisClaimGDRGDetailModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<NhisClaimGDRGDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<NhisClaimGDRGDetailModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						NhisClaimGDRGDetailById: nhisClaimGDRGDetailById(id: $id) {
							...NhisClaimGDRGDetailProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.NhisClaimGDRGDetailById as NhisClaimGDRGDetailModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<NhisClaimGDRGDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<NhisClaimGDRGDetailModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						nhisClaimGDRGDetails: nhisClaimGDRGDetails(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...NhisClaimGDRGDetailProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countNhisClaimGDRGDetails(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.nhisClaimGDRGDetails as NhisClaimGDRGDetailModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<NhisClaimGDRGDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<NhisClaimGDRGDetailModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						nhisClaimGDRGDetails: lastNhisClaimGDRGDetails(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...NhisClaimGDRGDetailProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: NhisClaimGDRGDetailModel, queryParams?: QueryParams): Observable<PassableStateConfig<NhisClaimGDRGDetailModel>> {
		...
		const successMessage = 'Created NHIS Claim GDRG Detail entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($nhisClaimGDRGDetail: NhisClaimGDRGDetailInput!, $persistRelations: Boolean) {
						nhisClaimGDRGDetail: createNhisClaimGDRGDetail(nhisClaimGDRGDetail: $nhisClaimGDRGDetail, persistRelations: $persistRelations) {
							...NhisClaimGDRGDetailProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.nhisClaimGDRGDetail as NhisClaimGDRGDetailModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: NhisClaimGDRGDetailModel[], queryParams?: QueryParams): Observable<PassableStateConfig<NhisClaimGDRGDetailModel>> {
		...
		const successMessage = 'Created Multiple NHIS Claim GDRG Detail entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($nhisClaimGDRGDetails: [NhisClaimGDRGDetailInput!]!) {
						nhisClaimGDRGDetail: createAllNhisClaimGDRGDetail(nhisClaimGDRGDetails: $nhisClaimGDRGDetails) {
							...NhisClaimGDRGDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					nhisClaimGDRGDetails: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.nhisClaimGDRGDetail as NhisClaimGDRGDetailModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: NhisClaimGDRGDetailModel, queryParams?: QueryParams): Observable<PassableStateConfig<NhisClaimGDRGDetailModel>> {
		...
		const successMessage = 'Updated NHIS Claim GDRG Detail entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($nhisClaimGDRGDetail: NhisClaimGDRGDetailInput!, $persistRelations: Boolean) {
						nhisClaimGDRGDetail: updateNhisClaimGDRGDetail(nhisClaimGDRGDetail: $nhisClaimGDRGDetail, persistRelations: $persistRelations) {
							...NhisClaimGDRGDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: NhisClaimGDRGDetailModel[], queryParams?: QueryParams): Observable<PassableStateConfig<NhisClaimGDRGDetailModel>> {
		...
		const successMessage = 'Update Multiple NHIS Claim GDRG Detail entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($nhisClaimGDRGDetails: [NhisClaimGDRGDetailInput!]!) {
						nhisClaimGDRGDetail: updateAllNhisClaimGDRGDetail(nhisClaimGDRGDetails: $nhisClaimGDRGDetails) {
							...NhisClaimGDRGDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<NhisClaimGDRGDetailModel>> {
		...
		const successMessage = 'Deleted NHIS Claim GDRG Detail entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($nhisClaimGDRGDetailId: ID!) {
						nhisClaimGDRGDetailId: deleteNhisClaimGDRGDetailById(nhisClaimGDRGDetailId: $nhisClaimGDRGDetailId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.nhisClaimGDRGDetailId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<NhisClaimGDRGDetailModel>> {
		...
		const successMessage = 'Deleted selected NHIS Claim GDRG Detail entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($nhisClaimGDRGDetailIds: [ID!]!){
						deleteNhisClaimGDRGDetailExcludingIds(nhisClaimGDRGDetailIds: $nhisClaimGDRGDetailIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.nhisClaimGDRGDetailIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<NhisClaimGDRGDetailModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($nhisClaimGDRGDetailIds: [ID!]!) {
						nhisClaimGDRGDetailIds: deleteAllNhisClaimGDRGDetailByIds(nhisClaimGDRGDetailIds: $nhisClaimGDRGDetailIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<NhisClaimGDRGDetailModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<NhisClaimGDRGDetailModel>>(
			{
				query: gql`
					query GetAudits {
						audits: nhisClaimGDRGDetailAudits {
							entity {
								...NhisClaimGDRGDetailProperties
							}
							timestamp
			...
			map(result => {
				let audits: NhisClaimGDRGDetailModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new NhisClaimGDRGDetailModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<NhisClaimGDRGDetailModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<NhisClaimGDRGDetailModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($nhisClaimGDRGDetailId: ID!) {
						audits: nhisClaimGDRGDetailAuditsByEntityId(nhisClaimGDRGDetailId: $nhisClaimGDRGDetailId) {
							entity {
								...NhisClaimGDRGDetailProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<NhisClaimGDRGDetailModel>> {
		const url = environment.API_URL + '/api/nhisclaimgdrgdetail/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<NhisClaimGDRGDetailModel>> {
		const url = environment.API_URL + '/api/nhisclaimgdrgdetail/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<NhisClaimGDRGDetailModel>> {
		let apiUrl = environment.API_URL + '/api/nhisclaimgdrgdetail/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<NhisClaimGDRGDetailModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/nhisclaimgdrgdetail/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' NHIS Claim GDRG Detail entities')),
