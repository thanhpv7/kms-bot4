...
import {BpjsPcareRegistrationsModel} from '../../models/bpjsPcareRegistrations/bpjs_pcare_registrations.model';
import {BpjsPcareRegistrationsModelAudit} from '../../models/bpjsPcareRegistrations/bpjs_pcare_registrations.model.state';
...
/**
 * BPJS Pcare Registrations service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BpjsPcareRegistrationsService extends AbstractHttpService<BpjsPcareRegistrationsModel, BpjsPcareRegistrationsModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BpjsPcareRegistrationsProperties classFragment here] off begin
			fragment BpjsPcareRegistrationsProperties on BpjsPcareRegistrations {
				...BpjsPcareRegistrationsBaseProperties
				kdproviderpeserta
				tgldaftar
				nokartu
				kdpoli
			...
			# % protected region % [Modify the BpjsPcareRegistrationsProperties classFragment here] end
			${super.fragments('BpjsPcareRegistrations').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BpjsPcareRegistrationsModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BpjsPcareRegistrationsModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBpjsPcareRegistrationss
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BpjsPcareRegistrationsModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPcareRegistrationsModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPcareRegistrationsModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BpjsPcareRegistrationsById: bpjsPcareRegistrationsById(id: $id) {
							...BpjsPcareRegistrationsProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BpjsPcareRegistrationsById as BpjsPcareRegistrationsModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsPcareRegistrationsModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPcareRegistrationsModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						bpjsPcareRegistrationss: bpjsPcareRegistrationss(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BpjsPcareRegistrationsProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBpjsPcareRegistrationss(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.bpjsPcareRegistrationss as BpjsPcareRegistrationsModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsPcareRegistrationsModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPcareRegistrationsModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						bpjsPcareRegistrationss: lastBpjsPcareRegistrationss(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BpjsPcareRegistrationsProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BpjsPcareRegistrationsModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPcareRegistrationsModel>> {
		...
		const successMessage = 'Created BPJS Pcare Registrations entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($bpjsPcareRegistrations: BpjsPcareRegistrationsInput!, $persistRelations: Boolean) {
						bpjsPcareRegistrations: createBpjsPcareRegistrations(bpjsPcareRegistrations: $bpjsPcareRegistrations, persistRelations: $persistRelations) {
							...BpjsPcareRegistrationsProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.bpjsPcareRegistrations as BpjsPcareRegistrationsModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BpjsPcareRegistrationsModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPcareRegistrationsModel>> {
		...
		const successMessage = 'Created Multiple BPJS Pcare Registrations entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($bpjsPcareRegistrationss: [BpjsPcareRegistrationsInput!]!) {
						bpjsPcareRegistrations: createAllBpjsPcareRegistrations(bpjsPcareRegistrationss: $bpjsPcareRegistrationss) {
							...BpjsPcareRegistrationsProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					bpjsPcareRegistrationss: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.bpjsPcareRegistrations as BpjsPcareRegistrationsModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BpjsPcareRegistrationsModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPcareRegistrationsModel>> {
		...
		const successMessage = 'Updated BPJS Pcare Registrations entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($bpjsPcareRegistrations: BpjsPcareRegistrationsInput!, $persistRelations: Boolean) {
						bpjsPcareRegistrations: updateBpjsPcareRegistrations(bpjsPcareRegistrations: $bpjsPcareRegistrations, persistRelations: $persistRelations) {
							...BpjsPcareRegistrationsProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BpjsPcareRegistrationsModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPcareRegistrationsModel>> {
		...
		const successMessage = 'Update Multiple BPJS Pcare Registrations entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($bpjsPcareRegistrationss: [BpjsPcareRegistrationsInput!]!) {
						bpjsPcareRegistrations: updateAllBpjsPcareRegistrations(bpjsPcareRegistrationss: $bpjsPcareRegistrationss) {
							...BpjsPcareRegistrationsProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BpjsPcareRegistrationsModel>> {
		...
		const successMessage = 'Deleted BPJS Pcare Registrations entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($bpjsPcareRegistrationsId: ID!) {
						bpjsPcareRegistrationsId: deleteBpjsPcareRegistrationsById(bpjsPcareRegistrationsId: $bpjsPcareRegistrationsId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.bpjsPcareRegistrationsId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsPcareRegistrationsModel>> {
		...
		const successMessage = 'Deleted selected BPJS Pcare Registrations entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($bpjsPcareRegistrationsIds: [ID!]!){
						deleteBpjsPcareRegistrationsExcludingIds(bpjsPcareRegistrationsIds: $bpjsPcareRegistrationsIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.bpjsPcareRegistrationsIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BpjsPcareRegistrationsModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($bpjsPcareRegistrationsIds: [ID!]!) {
						bpjsPcareRegistrationsIds: deleteAllBpjsPcareRegistrationsByIds(bpjsPcareRegistrationsIds: $bpjsPcareRegistrationsIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BpjsPcareRegistrationsModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPcareRegistrationsModel>>(
			{
				query: gql`
					query GetAudits {
						audits: bpjsPcareRegistrationsAudits {
							entity {
								...BpjsPcareRegistrationsProperties
							}
							timestamp
			...
			map(result => {
				let audits: BpjsPcareRegistrationsModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BpjsPcareRegistrationsModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BpjsPcareRegistrationsModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPcareRegistrationsModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($bpjsPcareRegistrationsId: ID!) {
						audits: bpjsPcareRegistrationsAuditsByEntityId(bpjsPcareRegistrationsId: $bpjsPcareRegistrationsId) {
							entity {
								...BpjsPcareRegistrationsProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BpjsPcareRegistrationsModel>> {
		const url = environment.API_URL + '/api/bpjspcareregistrations/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BpjsPcareRegistrationsModel>> {
		const url = environment.API_URL + '/api/bpjspcareregistrations/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsPcareRegistrationsModel>> {
		let apiUrl = environment.API_URL + '/api/bpjspcareregistrations/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BpjsPcareRegistrationsModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/bpjspcareregistrations/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' BPJS Pcare Registrations entities')),
