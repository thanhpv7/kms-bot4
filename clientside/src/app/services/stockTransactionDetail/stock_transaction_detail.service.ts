...
import {StockTransactionDetailModel} from '../../models/stockTransactionDetail/stock_transaction_detail.model';
import {StockTransactionDetailModelAudit} from '../../models/stockTransactionDetail/stock_transaction_detail.model.state';
...
/**
 * Stock Transaction Detail service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class StockTransactionDetailService extends AbstractHttpService<StockTransactionDetailModel, StockTransactionDetailModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the StockTransactionDetailProperties classFragment here] off begin
			fragment StockTransactionDetailProperties on StockTransactionDetail {
				...StockTransactionDetailBaseProperties
				transactionNumber
				transactionDate
				transactionType
				transactionNotes
				...
				sourceOrderNumber
				qtyTransitUoi
				qtyTransitUomTransaction
			}
			# % protected region % [Modify the StockTransactionDetailProperties classFragment here] end
			${super.fragments('StockTransactionDetail').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<StockTransactionDetailModel>> {
		...
		return  this.apollo.query<PassableStateConfig<StockTransactionDetailModel>>(
			{
				query: gql`
					query Count {
						totalCount: countStockTransactionDetails
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<StockTransactionDetailModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<StockTransactionDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<StockTransactionDetailModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						StockTransactionDetailById: stockTransactionDetailById(id: $id) {
							...StockTransactionDetailProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.StockTransactionDetailById as StockTransactionDetailModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<StockTransactionDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<StockTransactionDetailModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						stockTransactionDetails: stockTransactionDetails(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...StockTransactionDetailProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countStockTransactionDetails(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.stockTransactionDetails as StockTransactionDetailModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<StockTransactionDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<StockTransactionDetailModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						stockTransactionDetails: lastStockTransactionDetails(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...StockTransactionDetailProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: StockTransactionDetailModel, queryParams?: QueryParams): Observable<PassableStateConfig<StockTransactionDetailModel>> {
		...
		const successMessage = 'Created Stock Transaction Detail entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($stockTransactionDetail: StockTransactionDetailInput!, $persistRelations: Boolean) {
						stockTransactionDetail: createStockTransactionDetail(stockTransactionDetail: $stockTransactionDetail, persistRelations: $persistRelations) {
							...StockTransactionDetailProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.stockTransactionDetail as StockTransactionDetailModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: StockTransactionDetailModel[], queryParams?: QueryParams): Observable<PassableStateConfig<StockTransactionDetailModel>> {
		...
		const successMessage = 'Created Multiple Stock Transaction Detail entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($stockTransactionDetails: [StockTransactionDetailInput!]!) {
						stockTransactionDetail: createAllStockTransactionDetail(stockTransactionDetails: $stockTransactionDetails) {
							...StockTransactionDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					stockTransactionDetails: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.stockTransactionDetail as StockTransactionDetailModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: StockTransactionDetailModel, queryParams?: QueryParams): Observable<PassableStateConfig<StockTransactionDetailModel>> {
		...
		const successMessage = 'Updated Stock Transaction Detail entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($stockTransactionDetail: StockTransactionDetailInput!, $persistRelations: Boolean) {
						stockTransactionDetail: updateStockTransactionDetail(stockTransactionDetail: $stockTransactionDetail, persistRelations: $persistRelations) {
							...StockTransactionDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: StockTransactionDetailModel[], queryParams?: QueryParams): Observable<PassableStateConfig<StockTransactionDetailModel>> {
		...
		const successMessage = 'Update Multiple Stock Transaction Detail entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($stockTransactionDetails: [StockTransactionDetailInput!]!) {
						stockTransactionDetail: updateAllStockTransactionDetail(stockTransactionDetails: $stockTransactionDetails) {
							...StockTransactionDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<StockTransactionDetailModel>> {
		...
		const successMessage = 'Deleted Stock Transaction Detail entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($stockTransactionDetailId: ID!) {
						stockTransactionDetailId: deleteStockTransactionDetailById(stockTransactionDetailId: $stockTransactionDetailId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.stockTransactionDetailId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<StockTransactionDetailModel>> {
		...
		const successMessage = 'Deleted selected Stock Transaction Detail entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($stockTransactionDetailIds: [ID!]!){
						deleteStockTransactionDetailExcludingIds(stockTransactionDetailIds: $stockTransactionDetailIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.stockTransactionDetailIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<StockTransactionDetailModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($stockTransactionDetailIds: [ID!]!) {
						stockTransactionDetailIds: deleteAllStockTransactionDetailByIds(stockTransactionDetailIds: $stockTransactionDetailIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<StockTransactionDetailModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<StockTransactionDetailModel>>(
			{
				query: gql`
					query GetAudits {
						audits: stockTransactionDetailAudits {
							entity {
								...StockTransactionDetailProperties
							}
							timestamp
			...
			map(result => {
				let audits: StockTransactionDetailModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new StockTransactionDetailModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<StockTransactionDetailModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<StockTransactionDetailModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($stockTransactionDetailId: ID!) {
						audits: stockTransactionDetailAuditsByEntityId(stockTransactionDetailId: $stockTransactionDetailId) {
							entity {
								...StockTransactionDetailProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<StockTransactionDetailModel>> {
		const url = environment.API_URL + '/api/stocktransactiondetail/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<StockTransactionDetailModel>> {
		const url = environment.API_URL + '/api/stocktransactiondetail/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<StockTransactionDetailModel>> {
		let apiUrl = environment.API_URL + '/api/stocktransactiondetail/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<StockTransactionDetailModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/stocktransactiondetail/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Stock Transaction Detail entities')),
