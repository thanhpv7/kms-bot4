...
import {PatientEmploymentDetailModelAudit} from '../../models/patientEmploymentDetail/patient_employment_detail.model.state';
...
/**
 * Patient Employment Detail  service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class PatientEmploymentDetailService extends AbstractHttpService<PatientEmploymentDetailModel, PatientEmploymentDetailModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the PatientEmploymentDetailProperties classFragment here] off begin
			fragment PatientEmploymentDetailProperties on PatientEmploymentDetail {
				...PatientEmploymentDetailBaseProperties
				employeeID
				universalID
				employeeType
				onsiteStatus
				...
				forwardingAddress
				legalDIsability
				legalDisabilityNotes
				workerInsurance
				workerInsuranceNo
			}
			# % protected region % [Modify the PatientEmploymentDetailProperties classFragment here] end
			${super.fragments('PatientEmploymentDetail').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<PatientEmploymentDetailModel>> {
		...
		return  this.apollo.query<PassableStateConfig<PatientEmploymentDetailModel>>(
			{
				query: gql`
					query Count {
						totalCount: countPatientEmploymentDetails
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<PatientEmploymentDetailModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<PatientEmploymentDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<PatientEmploymentDetailModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						PatientEmploymentDetailById: patientEmploymentDetailById(id: $id) {
							...PatientEmploymentDetailProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.PatientEmploymentDetailById as PatientEmploymentDetailModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PatientEmploymentDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<PatientEmploymentDetailModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						patientEmploymentDetails: patientEmploymentDetails(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...PatientEmploymentDetailProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countPatientEmploymentDetails(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.patientEmploymentDetails as PatientEmploymentDetailModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PatientEmploymentDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<PatientEmploymentDetailModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						patientEmploymentDetails: lastPatientEmploymentDetails(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...PatientEmploymentDetailProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: PatientEmploymentDetailModel, queryParams?: QueryParams): Observable<PassableStateConfig<PatientEmploymentDetailModel>> {
		...
		const successMessage = 'Created Patient Employment Detail  entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($patientEmploymentDetail: PatientEmploymentDetailInput!, $persistRelations: Boolean) {
						patientEmploymentDetail: createPatientEmploymentDetail(patientEmploymentDetail: $patientEmploymentDetail, persistRelations: $persistRelations) {
							...PatientEmploymentDetailProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.patientEmploymentDetail as PatientEmploymentDetailModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: PatientEmploymentDetailModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PatientEmploymentDetailModel>> {
		...
		const successMessage = 'Created Multiple Patient Employment Detail  entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($patientEmploymentDetails: [PatientEmploymentDetailInput!]!) {
						patientEmploymentDetail: createAllPatientEmploymentDetail(patientEmploymentDetails: $patientEmploymentDetails) {
							...PatientEmploymentDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					patientEmploymentDetails: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.patientEmploymentDetail as PatientEmploymentDetailModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: PatientEmploymentDetailModel, queryParams?: QueryParams): Observable<PassableStateConfig<PatientEmploymentDetailModel>> {
		...
		const successMessage = 'Updated Patient Employment Detail  entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($patientEmploymentDetail: PatientEmploymentDetailInput!, $persistRelations: Boolean) {
						patientEmploymentDetail: updatePatientEmploymentDetail(patientEmploymentDetail: $patientEmploymentDetail, persistRelations: $persistRelations) {
							...PatientEmploymentDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: PatientEmploymentDetailModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PatientEmploymentDetailModel>> {
		...
		const successMessage = 'Update Multiple Patient Employment Detail  entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($patientEmploymentDetails: [PatientEmploymentDetailInput!]!) {
						patientEmploymentDetail: updateAllPatientEmploymentDetail(patientEmploymentDetails: $patientEmploymentDetails) {
							...PatientEmploymentDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<PatientEmploymentDetailModel>> {
		...
		const successMessage = 'Deleted Patient Employment Detail  entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($patientEmploymentDetailId: ID!) {
						patientEmploymentDetailId: deletePatientEmploymentDetailById(patientEmploymentDetailId: $patientEmploymentDetailId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.patientEmploymentDetailId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<PatientEmploymentDetailModel>> {
		...
		const successMessage = 'Deleted selected Patient Employment Detail  entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($patientEmploymentDetailIds: [ID!]!){
						deletePatientEmploymentDetailExcludingIds(patientEmploymentDetailIds: $patientEmploymentDetailIds)
				...
				`,
				variables: {
					patientEmploymentDetailIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.patientEmploymentDetailIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<PatientEmploymentDetailModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($patientEmploymentDetailIds: [ID!]!) {
						patientEmploymentDetailIds: deleteAllPatientEmploymentDetailByIds(patientEmploymentDetailIds: $patientEmploymentDetailIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<PatientEmploymentDetailModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PatientEmploymentDetailModel>>(
			{
				query: gql`
					query GetAudits {
						audits: patientEmploymentDetailAudits {
							entity {
								...PatientEmploymentDetailProperties
							}
							timestamp
			...
			map(result => {
				let audits: PatientEmploymentDetailModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new PatientEmploymentDetailModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<PatientEmploymentDetailModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PatientEmploymentDetailModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($patientEmploymentDetailId: ID!) {
						audits: patientEmploymentDetailAuditsByEntityId(patientEmploymentDetailId: $patientEmploymentDetailId) {
							entity {
								...PatientEmploymentDetailProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<PatientEmploymentDetailModel>> {
		const url = environment.API_URL + '/api/patientemploymentdetail/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<PatientEmploymentDetailModel>> {
		const url = environment.API_URL + '/api/patientemploymentdetail/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<PatientEmploymentDetailModel>> {
		let apiUrl = environment.API_URL + '/api/patientemploymentdetail/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<PatientEmploymentDetailModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/patientemploymentdetail/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Patient Employment Detail  entities')),
