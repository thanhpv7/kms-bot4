...
import {SupplierBankAccountModel} from '../../models/supplierBankAccount/supplier_bank_account.model';
import {SupplierBankAccountModelAudit} from '../../models/supplierBankAccount/supplier_bank_account.model.state';
...
/**
 * Supplier Bank Account service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class SupplierBankAccountService extends AbstractHttpService<SupplierBankAccountModel, SupplierBankAccountModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the SupplierBankAccountProperties classFragment here] off begin
			fragment SupplierBankAccountProperties on SupplierBankAccount {
				...SupplierBankAccountBaseProperties
				bankName
				accountName
				accountNumber
				city
			...
			# % protected region % [Modify the SupplierBankAccountProperties classFragment here] end
			${super.fragments('SupplierBankAccount').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<SupplierBankAccountModel>> {
		...
		return  this.apollo.query<PassableStateConfig<SupplierBankAccountModel>>(
			{
				query: gql`
					query Count {
						totalCount: countSupplierBankAccounts
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<SupplierBankAccountModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<SupplierBankAccountModel>> {
		...
		return this.apollo.query<PassableStateConfig<SupplierBankAccountModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						SupplierBankAccountById: supplierBankAccountById(id: $id) {
							...SupplierBankAccountProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.SupplierBankAccountById as SupplierBankAccountModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<SupplierBankAccountModel>> {
		...
		return this.apollo.query<PassableStateConfig<SupplierBankAccountModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						supplierBankAccounts: supplierBankAccounts(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...SupplierBankAccountProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countSupplierBankAccounts(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.supplierBankAccounts as SupplierBankAccountModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<SupplierBankAccountModel>> {
		...
		return this.apollo.query<PassableStateConfig<SupplierBankAccountModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						supplierBankAccounts: lastSupplierBankAccounts(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...SupplierBankAccountProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: SupplierBankAccountModel, queryParams?: QueryParams): Observable<PassableStateConfig<SupplierBankAccountModel>> {
		...
		const successMessage = 'Created Supplier Bank Account entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($supplierBankAccount: SupplierBankAccountInput!, $persistRelations: Boolean) {
						supplierBankAccount: createSupplierBankAccount(supplierBankAccount: $supplierBankAccount, persistRelations: $persistRelations) {
							...SupplierBankAccountProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.supplierBankAccount as SupplierBankAccountModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: SupplierBankAccountModel[], queryParams?: QueryParams): Observable<PassableStateConfig<SupplierBankAccountModel>> {
		...
		const successMessage = 'Created Multiple Supplier Bank Account entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($supplierBankAccounts: [SupplierBankAccountInput!]!) {
						supplierBankAccount: createAllSupplierBankAccount(supplierBankAccounts: $supplierBankAccounts) {
							...SupplierBankAccountProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					supplierBankAccounts: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.supplierBankAccount as SupplierBankAccountModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: SupplierBankAccountModel, queryParams?: QueryParams): Observable<PassableStateConfig<SupplierBankAccountModel>> {
		...
		const successMessage = 'Updated Supplier Bank Account entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($supplierBankAccount: SupplierBankAccountInput!, $persistRelations: Boolean) {
						supplierBankAccount: updateSupplierBankAccount(supplierBankAccount: $supplierBankAccount, persistRelations: $persistRelations) {
							...SupplierBankAccountProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: SupplierBankAccountModel[], queryParams?: QueryParams): Observable<PassableStateConfig<SupplierBankAccountModel>> {
		...
		const successMessage = 'Update Multiple Supplier Bank Account entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($supplierBankAccounts: [SupplierBankAccountInput!]!) {
						supplierBankAccount: updateAllSupplierBankAccount(supplierBankAccounts: $supplierBankAccounts) {
							...SupplierBankAccountProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<SupplierBankAccountModel>> {
		...
		const successMessage = 'Deleted Supplier Bank Account entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($supplierBankAccountId: ID!) {
						supplierBankAccountId: deleteSupplierBankAccountById(supplierBankAccountId: $supplierBankAccountId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.supplierBankAccountId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<SupplierBankAccountModel>> {
		...
		const successMessage = 'Deleted selected Supplier Bank Account entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($supplierBankAccountIds: [ID!]!){
						deleteSupplierBankAccountExcludingIds(supplierBankAccountIds: $supplierBankAccountIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.supplierBankAccountIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<SupplierBankAccountModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($supplierBankAccountIds: [ID!]!) {
						supplierBankAccountIds: deleteAllSupplierBankAccountByIds(supplierBankAccountIds: $supplierBankAccountIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<SupplierBankAccountModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<SupplierBankAccountModel>>(
			{
				query: gql`
					query GetAudits {
						audits: supplierBankAccountAudits {
							entity {
								...SupplierBankAccountProperties
							}
							timestamp
			...
			map(result => {
				let audits: SupplierBankAccountModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new SupplierBankAccountModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<SupplierBankAccountModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<SupplierBankAccountModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($supplierBankAccountId: ID!) {
						audits: supplierBankAccountAuditsByEntityId(supplierBankAccountId: $supplierBankAccountId) {
							entity {
								...SupplierBankAccountProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<SupplierBankAccountModel>> {
		const url = environment.API_URL + '/api/supplierbankaccount/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<SupplierBankAccountModel>> {
		const url = environment.API_URL + '/api/supplierbankaccount/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<SupplierBankAccountModel>> {
		let apiUrl = environment.API_URL + '/api/supplierbankaccount/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<SupplierBankAccountModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/supplierbankaccount/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Supplier Bank Account entities')),
