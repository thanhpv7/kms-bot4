...
import {BpjsHealthFacilityModelAudit} from '../../models/bpjsHealthFacility/bpjs_health_facility.model.state';
...
/**
 * BPJS Health Facility service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BpjsHealthFacilityService extends AbstractHttpService<BpjsHealthFacilityModel, BpjsHealthFacilityModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BpjsHealthFacilityProperties classFragment here] off begin
			fragment BpjsHealthFacilityProperties on BpjsHealthFacility {
				...BpjsHealthFacilityBaseProperties
				refCode
				refName
			}
			# % protected region % [Modify the BpjsHealthFacilityProperties classFragment here] end
			${super.fragments('BpjsHealthFacility').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BpjsHealthFacilityModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BpjsHealthFacilityModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBpjsHealthFacilitys
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BpjsHealthFacilityModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsHealthFacilityModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsHealthFacilityModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BpjsHealthFacilityById: bpjsHealthFacilityById(id: $id) {
							...BpjsHealthFacilityProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BpjsHealthFacilityById as BpjsHealthFacilityModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsHealthFacilityModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsHealthFacilityModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						bpjsHealthFacilitys: bpjsHealthFacilitys(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BpjsHealthFacilityProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBpjsHealthFacilitys(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.bpjsHealthFacilitys as BpjsHealthFacilityModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsHealthFacilityModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsHealthFacilityModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						bpjsHealthFacilitys: lastBpjsHealthFacilitys(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BpjsHealthFacilityProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BpjsHealthFacilityModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsHealthFacilityModel>> {
		...
		const successMessage = 'Created BPJS Health Facility entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($bpjsHealthFacility: BpjsHealthFacilityInput!, $persistRelations: Boolean) {
						bpjsHealthFacility: createBpjsHealthFacility(bpjsHealthFacility: $bpjsHealthFacility, persistRelations: $persistRelations) {
							...BpjsHealthFacilityProperties,
				...
				variables: {
					bpjsHealthFacility: {
						...
						bpjsFacilityLists: entity.bpjsFacilityLists ? entity.bpjsFacilityLists?.map((model: BpjsFacilityListModel) => new BpjsFacilityListModel(model).toJSON()) : [],
						...
						bpjsReferralSpecialists: entity.bpjsReferralSpecialists ? entity.bpjsReferralSpecialists?.map((model: BpjsReferralSpecialistModel) => new BpjsReferralSpecialistModel(model).toJSON()) : [],
					},
			...
			map(result => {
				...
				return {
					targetModel: result.data.bpjsHealthFacility as BpjsHealthFacilityModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BpjsHealthFacilityModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsHealthFacilityModel>> {
		...
		const successMessage = 'Created Multiple BPJS Health Facility entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($bpjsHealthFacilitys: [BpjsHealthFacilityInput!]!) {
						bpjsHealthFacility: createAllBpjsHealthFacility(bpjsHealthFacilitys: $bpjsHealthFacilitys) {
							...BpjsHealthFacilityProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					bpjsHealthFacilitys: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.bpjsHealthFacility as BpjsHealthFacilityModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BpjsHealthFacilityModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsHealthFacilityModel>> {
		...
		const successMessage = 'Updated BPJS Health Facility entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($bpjsHealthFacility: BpjsHealthFacilityInput!, $persistRelations: Boolean) {
						bpjsHealthFacility: updateBpjsHealthFacility(bpjsHealthFacility: $bpjsHealthFacility, persistRelations: $persistRelations) {
							...BpjsHealthFacilityProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BpjsHealthFacilityModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsHealthFacilityModel>> {
		...
		const successMessage = 'Update Multiple BPJS Health Facility entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($bpjsHealthFacilitys: [BpjsHealthFacilityInput!]!) {
						bpjsHealthFacility: updateAllBpjsHealthFacility(bpjsHealthFacilitys: $bpjsHealthFacilitys) {
							...BpjsHealthFacilityProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BpjsHealthFacilityModel>> {
		...
		const successMessage = 'Deleted BPJS Health Facility entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($bpjsHealthFacilityId: ID!) {
						bpjsHealthFacilityId: deleteBpjsHealthFacilityById(bpjsHealthFacilityId: $bpjsHealthFacilityId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.bpjsHealthFacilityId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsHealthFacilityModel>> {
		...
		const successMessage = 'Deleted selected BPJS Health Facility entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($bpjsHealthFacilityIds: [ID!]!){
						deleteBpjsHealthFacilityExcludingIds(bpjsHealthFacilityIds: $bpjsHealthFacilityIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.bpjsHealthFacilityIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BpjsHealthFacilityModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($bpjsHealthFacilityIds: [ID!]!) {
						bpjsHealthFacilityIds: deleteAllBpjsHealthFacilityByIds(bpjsHealthFacilityIds: $bpjsHealthFacilityIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BpjsHealthFacilityModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsHealthFacilityModel>>(
			{
				query: gql`
					query GetAudits {
						audits: bpjsHealthFacilityAudits {
							entity {
								...BpjsHealthFacilityProperties
							}
							timestamp
			...
			map(result => {
				let audits: BpjsHealthFacilityModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BpjsHealthFacilityModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BpjsHealthFacilityModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsHealthFacilityModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($bpjsHealthFacilityId: ID!) {
						audits: bpjsHealthFacilityAuditsByEntityId(bpjsHealthFacilityId: $bpjsHealthFacilityId) {
							entity {
								...BpjsHealthFacilityProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BpjsHealthFacilityModel>> {
		const url = environment.API_URL + '/api/bpjshealthfacility/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BpjsHealthFacilityModel>> {
		const url = environment.API_URL + '/api/bpjshealthfacility/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsHealthFacilityModel>> {
		let apiUrl = environment.API_URL + '/api/bpjshealthfacility/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BpjsHealthFacilityModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/bpjshealthfacility/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' BPJS Health Facility entities')),
