...
import {InvoiceItemComponentModelAudit} from '../../models/invoiceItemComponent/invoice_item_component.model.state';
...
/**
 * Invoice Item Component service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class InvoiceItemComponentService extends AbstractHttpService<InvoiceItemComponentModel, InvoiceItemComponentModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the InvoiceItemComponentProperties classFragment here] off begin
			fragment InvoiceItemComponentProperties on InvoiceItemComponent {
				...InvoiceItemComponentBaseProperties
				price
				medicalStaff
				notes
			}
			# % protected region % [Modify the InvoiceItemComponentProperties classFragment here] end
			${super.fragments('InvoiceItemComponent').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<InvoiceItemComponentModel>> {
		...
		return  this.apollo.query<PassableStateConfig<InvoiceItemComponentModel>>(
			{
				query: gql`
					query Count {
						totalCount: countInvoiceItemComponents
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<InvoiceItemComponentModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<InvoiceItemComponentModel>> {
		...
		return this.apollo.query<PassableStateConfig<InvoiceItemComponentModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						InvoiceItemComponentById: invoiceItemComponentById(id: $id) {
							...InvoiceItemComponentProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.InvoiceItemComponentById as InvoiceItemComponentModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<InvoiceItemComponentModel>> {
		...
		return this.apollo.query<PassableStateConfig<InvoiceItemComponentModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						invoiceItemComponents: invoiceItemComponents(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...InvoiceItemComponentProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countInvoiceItemComponents(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.invoiceItemComponents as InvoiceItemComponentModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<InvoiceItemComponentModel>> {
		...
		return this.apollo.query<PassableStateConfig<InvoiceItemComponentModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						invoiceItemComponents: lastInvoiceItemComponents(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...InvoiceItemComponentProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: InvoiceItemComponentModel, queryParams?: QueryParams): Observable<PassableStateConfig<InvoiceItemComponentModel>> {
		...
		const successMessage = 'Created Invoice Item Component entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($invoiceItemComponent: InvoiceItemComponentInput!, $persistRelations: Boolean) {
						invoiceItemComponent: createInvoiceItemComponent(invoiceItemComponent: $invoiceItemComponent, persistRelations: $persistRelations) {
							...InvoiceItemComponentProperties,
				...
				variables: {
					invoiceItemComponent: {
						...entity.toJSON(),
						invoiceItem: entity.invoiceItem ? new InvoiceItemModel(entity.invoiceItem).toJSON() : undefined,
			...
			map(result => {
				...
				return {
					targetModel: result.data.invoiceItemComponent as InvoiceItemComponentModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: InvoiceItemComponentModel[], queryParams?: QueryParams): Observable<PassableStateConfig<InvoiceItemComponentModel>> {
		...
		const successMessage = 'Created Multiple Invoice Item Component entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($invoiceItemComponents: [InvoiceItemComponentInput!]!) {
						invoiceItemComponent: createAllInvoiceItemComponent(invoiceItemComponents: $invoiceItemComponents) {
							...InvoiceItemComponentProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					invoiceItemComponents: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.invoiceItemComponent as InvoiceItemComponentModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: InvoiceItemComponentModel, queryParams?: QueryParams): Observable<PassableStateConfig<InvoiceItemComponentModel>> {
		...
		const successMessage = 'Updated Invoice Item Component entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($invoiceItemComponent: InvoiceItemComponentInput!, $persistRelations: Boolean) {
						invoiceItemComponent: updateInvoiceItemComponent(invoiceItemComponent: $invoiceItemComponent, persistRelations: $persistRelations) {
							...InvoiceItemComponentProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: InvoiceItemComponentModel[], queryParams?: QueryParams): Observable<PassableStateConfig<InvoiceItemComponentModel>> {
		...
		const successMessage = 'Update Multiple Invoice Item Component entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($invoiceItemComponents: [InvoiceItemComponentInput!]!) {
						invoiceItemComponent: updateAllInvoiceItemComponent(invoiceItemComponents: $invoiceItemComponents) {
							...InvoiceItemComponentProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<InvoiceItemComponentModel>> {
		...
		const successMessage = 'Deleted Invoice Item Component entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($invoiceItemComponentId: ID!) {
						invoiceItemComponentId: deleteInvoiceItemComponentById(invoiceItemComponentId: $invoiceItemComponentId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.invoiceItemComponentId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<InvoiceItemComponentModel>> {
		...
		const successMessage = 'Deleted selected Invoice Item Component entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($invoiceItemComponentIds: [ID!]!){
						deleteInvoiceItemComponentExcludingIds(invoiceItemComponentIds: $invoiceItemComponentIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.invoiceItemComponentIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<InvoiceItemComponentModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($invoiceItemComponentIds: [ID!]!) {
						invoiceItemComponentIds: deleteAllInvoiceItemComponentByIds(invoiceItemComponentIds: $invoiceItemComponentIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<InvoiceItemComponentModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<InvoiceItemComponentModel>>(
			{
				query: gql`
					query GetAudits {
						audits: invoiceItemComponentAudits {
							entity {
								...InvoiceItemComponentProperties
							}
							timestamp
			...
			map(result => {
				let audits: InvoiceItemComponentModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new InvoiceItemComponentModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<InvoiceItemComponentModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<InvoiceItemComponentModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($invoiceItemComponentId: ID!) {
						audits: invoiceItemComponentAuditsByEntityId(invoiceItemComponentId: $invoiceItemComponentId) {
							entity {
								...InvoiceItemComponentProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<InvoiceItemComponentModel>> {
		const url = environment.API_URL + '/api/invoiceitemcomponent/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<InvoiceItemComponentModel>> {
		const url = environment.API_URL + '/api/invoiceitemcomponent/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<InvoiceItemComponentModel>> {
		let apiUrl = environment.API_URL + '/api/invoiceitemcomponent/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<InvoiceItemComponentModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/invoiceitemcomponent/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Invoice Item Component entities')),
