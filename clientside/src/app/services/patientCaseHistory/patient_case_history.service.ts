...
import {PatientCaseHistoryModelAudit} from '../../models/patientCaseHistory/patient_case_history.model.state';
...
/**
 * Patient Case History service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class PatientCaseHistoryService extends AbstractHttpService<PatientCaseHistoryModel, PatientCaseHistoryModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the PatientCaseHistoryProperties classFragment here] off begin
			fragment PatientCaseHistoryProperties on PatientCaseHistory {
				...PatientCaseHistoryBaseProperties
				allergy
				disabilityNotes
				historyOfDisease
				caseHistoryDateTime
			...
			# % protected region % [Modify the PatientCaseHistoryProperties classFragment here] end
			${super.fragments('PatientCaseHistory').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<PatientCaseHistoryModel>> {
		...
		return  this.apollo.query<PassableStateConfig<PatientCaseHistoryModel>>(
			{
				query: gql`
					query Count {
						totalCount: countPatientCaseHistorys
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<PatientCaseHistoryModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<PatientCaseHistoryModel>> {
		...
		return this.apollo.query<PassableStateConfig<PatientCaseHistoryModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						PatientCaseHistoryById: patientCaseHistoryById(id: $id) {
							...PatientCaseHistoryProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.PatientCaseHistoryById as PatientCaseHistoryModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PatientCaseHistoryModel>> {
		...
		return this.apollo.query<PassableStateConfig<PatientCaseHistoryModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						patientCaseHistorys: patientCaseHistorys(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...PatientCaseHistoryProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countPatientCaseHistorys(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.patientCaseHistorys as PatientCaseHistoryModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PatientCaseHistoryModel>> {
		...
		return this.apollo.query<PassableStateConfig<PatientCaseHistoryModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						patientCaseHistorys: lastPatientCaseHistorys(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...PatientCaseHistoryProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: PatientCaseHistoryModel, queryParams?: QueryParams): Observable<PassableStateConfig<PatientCaseHistoryModel>> {
		...
		const successMessage = 'Created Patient Case History entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($patientCaseHistory: PatientCaseHistoryInput!, $persistRelations: Boolean) {
						patientCaseHistory: createPatientCaseHistory(patientCaseHistory: $patientCaseHistory, persistRelations: $persistRelations) {
							...PatientCaseHistoryProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.patientCaseHistory as PatientCaseHistoryModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: PatientCaseHistoryModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PatientCaseHistoryModel>> {
		...
		const successMessage = 'Created Multiple Patient Case History entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($patientCaseHistorys: [PatientCaseHistoryInput!]!) {
						patientCaseHistory: createAllPatientCaseHistory(patientCaseHistorys: $patientCaseHistorys) {
							...PatientCaseHistoryProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					patientCaseHistorys: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.patientCaseHistory as PatientCaseHistoryModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: PatientCaseHistoryModel, queryParams?: QueryParams): Observable<PassableStateConfig<PatientCaseHistoryModel>> {
		...
		const successMessage = 'Updated Patient Case History entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($patientCaseHistory: PatientCaseHistoryInput!, $persistRelations: Boolean) {
						patientCaseHistory: updatePatientCaseHistory(patientCaseHistory: $patientCaseHistory, persistRelations: $persistRelations) {
							...PatientCaseHistoryProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: PatientCaseHistoryModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PatientCaseHistoryModel>> {
		...
		const successMessage = 'Update Multiple Patient Case History entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($patientCaseHistorys: [PatientCaseHistoryInput!]!) {
						patientCaseHistory: updateAllPatientCaseHistory(patientCaseHistorys: $patientCaseHistorys) {
							...PatientCaseHistoryProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<PatientCaseHistoryModel>> {
		...
		const successMessage = 'Deleted Patient Case History entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($patientCaseHistoryId: ID!) {
						patientCaseHistoryId: deletePatientCaseHistoryById(patientCaseHistoryId: $patientCaseHistoryId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.patientCaseHistoryId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<PatientCaseHistoryModel>> {
		...
		const successMessage = 'Deleted selected Patient Case History entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($patientCaseHistoryIds: [ID!]!){
						deletePatientCaseHistoryExcludingIds(patientCaseHistoryIds: $patientCaseHistoryIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.patientCaseHistoryIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<PatientCaseHistoryModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($patientCaseHistoryIds: [ID!]!) {
						patientCaseHistoryIds: deleteAllPatientCaseHistoryByIds(patientCaseHistoryIds: $patientCaseHistoryIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<PatientCaseHistoryModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PatientCaseHistoryModel>>(
			{
				query: gql`
					query GetAudits {
						audits: patientCaseHistoryAudits {
							entity {
								...PatientCaseHistoryProperties
							}
							timestamp
			...
			map(result => {
				let audits: PatientCaseHistoryModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new PatientCaseHistoryModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<PatientCaseHistoryModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PatientCaseHistoryModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($patientCaseHistoryId: ID!) {
						audits: patientCaseHistoryAuditsByEntityId(patientCaseHistoryId: $patientCaseHistoryId) {
							entity {
								...PatientCaseHistoryProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<PatientCaseHistoryModel>> {
		const url = environment.API_URL + '/api/patientcasehistory/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<PatientCaseHistoryModel>> {
		const url = environment.API_URL + '/api/patientcasehistory/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<PatientCaseHistoryModel>> {
		let apiUrl = environment.API_URL + '/api/patientcasehistory/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<PatientCaseHistoryModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/patientcasehistory/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Patient Case History entities')),
