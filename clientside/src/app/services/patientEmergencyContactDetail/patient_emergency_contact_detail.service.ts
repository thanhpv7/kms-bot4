...
import {PatientEmergencyContactDetailModelAudit} from '../../models/patientEmergencyContactDetail/patient_emergency_contact_detail.model.state';
...
/**
 * Patient Emergency Contact Detail service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class PatientEmergencyContactDetailService extends AbstractHttpService<PatientEmergencyContactDetailModel, PatientEmergencyContactDetailModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the PatientEmergencyContactDetailProperties classFragment here] off begin
			fragment PatientEmergencyContactDetailProperties on PatientEmergencyContactDetail {
				...PatientEmergencyContactDetailBaseProperties
				title
				givenName
				lastName
				relationship
			...
			# % protected region % [Modify the PatientEmergencyContactDetailProperties classFragment here] end
			${super.fragments('PatientEmergencyContactDetail').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<PatientEmergencyContactDetailModel>> {
		...
		return  this.apollo.query<PassableStateConfig<PatientEmergencyContactDetailModel>>(
			{
				query: gql`
					query Count {
						totalCount: countPatientEmergencyContactDetails
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<PatientEmergencyContactDetailModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<PatientEmergencyContactDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<PatientEmergencyContactDetailModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						PatientEmergencyContactDetailById: patientEmergencyContactDetailById(id: $id) {
							...PatientEmergencyContactDetailProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.PatientEmergencyContactDetailById as PatientEmergencyContactDetailModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PatientEmergencyContactDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<PatientEmergencyContactDetailModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						patientEmergencyContactDetails: patientEmergencyContactDetails(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...PatientEmergencyContactDetailProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countPatientEmergencyContactDetails(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.patientEmergencyContactDetails as PatientEmergencyContactDetailModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PatientEmergencyContactDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<PatientEmergencyContactDetailModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						patientEmergencyContactDetails: lastPatientEmergencyContactDetails(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...PatientEmergencyContactDetailProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: PatientEmergencyContactDetailModel, queryParams?: QueryParams): Observable<PassableStateConfig<PatientEmergencyContactDetailModel>> {
		...
		const successMessage = 'Created Patient Emergency Contact Detail entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($patientEmergencyContactDetail: PatientEmergencyContactDetailInput!, $persistRelations: Boolean) {
						patientEmergencyContactDetail: createPatientEmergencyContactDetail(patientEmergencyContactDetail: $patientEmergencyContactDetail, persistRelations: $persistRelations) {
							...PatientEmergencyContactDetailProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.patientEmergencyContactDetail as PatientEmergencyContactDetailModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: PatientEmergencyContactDetailModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PatientEmergencyContactDetailModel>> {
		...
		const successMessage = 'Created Multiple Patient Emergency Contact Detail entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($patientEmergencyContactDetails: [PatientEmergencyContactDetailInput!]!) {
						patientEmergencyContactDetail: createAllPatientEmergencyContactDetail(patientEmergencyContactDetails: $patientEmergencyContactDetails) {
							...PatientEmergencyContactDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					patientEmergencyContactDetails: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.patientEmergencyContactDetail as PatientEmergencyContactDetailModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: PatientEmergencyContactDetailModel, queryParams?: QueryParams): Observable<PassableStateConfig<PatientEmergencyContactDetailModel>> {
		...
		const successMessage = 'Updated Patient Emergency Contact Detail entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($patientEmergencyContactDetail: PatientEmergencyContactDetailInput!, $persistRelations: Boolean) {
						patientEmergencyContactDetail: updatePatientEmergencyContactDetail(patientEmergencyContactDetail: $patientEmergencyContactDetail, persistRelations: $persistRelations) {
							...PatientEmergencyContactDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: PatientEmergencyContactDetailModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PatientEmergencyContactDetailModel>> {
		...
		const successMessage = 'Update Multiple Patient Emergency Contact Detail entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($patientEmergencyContactDetails: [PatientEmergencyContactDetailInput!]!) {
						patientEmergencyContactDetail: updateAllPatientEmergencyContactDetail(patientEmergencyContactDetails: $patientEmergencyContactDetails) {
							...PatientEmergencyContactDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<PatientEmergencyContactDetailModel>> {
		...
		const successMessage = 'Deleted Patient Emergency Contact Detail entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($patientEmergencyContactDetailId: ID!) {
						patientEmergencyContactDetailId: deletePatientEmergencyContactDetailById(patientEmergencyContactDetailId: $patientEmergencyContactDetailId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.patientEmergencyContactDetailId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<PatientEmergencyContactDetailModel>> {
		...
		const successMessage = 'Deleted selected Patient Emergency Contact Detail entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($patientEmergencyContactDetailIds: [ID!]!){
						deletePatientEmergencyContactDetailExcludingIds(patientEmergencyContactDetailIds: $patientEmergencyContactDetailIds)
				...
				`,
				variables: {
					patientEmergencyContactDetailIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.patientEmergencyContactDetailIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<PatientEmergencyContactDetailModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($patientEmergencyContactDetailIds: [ID!]!) {
						patientEmergencyContactDetailIds: deleteAllPatientEmergencyContactDetailByIds(patientEmergencyContactDetailIds: $patientEmergencyContactDetailIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<PatientEmergencyContactDetailModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PatientEmergencyContactDetailModel>>(
			{
				query: gql`
					query GetAudits {
						audits: patientEmergencyContactDetailAudits {
							entity {
								...PatientEmergencyContactDetailProperties
							}
							timestamp
			...
			map(result => {
				let audits: PatientEmergencyContactDetailModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new PatientEmergencyContactDetailModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<PatientEmergencyContactDetailModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PatientEmergencyContactDetailModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($patientEmergencyContactDetailId: ID!) {
						audits: patientEmergencyContactDetailAuditsByEntityId(patientEmergencyContactDetailId: $patientEmergencyContactDetailId) {
							entity {
								...PatientEmergencyContactDetailProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<PatientEmergencyContactDetailModel>> {
		const url = environment.API_URL + '/api/patientemergencycontactdetail/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<PatientEmergencyContactDetailModel>> {
		const url = environment.API_URL + '/api/patientemergencycontactdetail/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<PatientEmergencyContactDetailModel>> {
		let apiUrl = environment.API_URL + '/api/patientemergencycontactdetail/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<PatientEmergencyContactDetailModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/patientemergencycontactdetail/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Patient Emergency Contact Detail entities')),
