...
import {BpjsDoctorMappingModelAudit} from '../../models/bpjsDoctorMapping/bpjs_doctor_mapping.model.state';
...
/**
 * BPJS Doctor Mapping service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BpjsDoctorMappingService extends AbstractHttpService<BpjsDoctorMappingModel, BpjsDoctorMappingModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BpjsDoctorMappingProperties classFragment here] off begin
			fragment BpjsDoctorMappingProperties on BpjsDoctorMapping {
				...BpjsDoctorMappingBaseProperties
				refCode
				bpjsMedicalStaff
				notes
				refCodeService
			}
			# % protected region % [Modify the BpjsDoctorMappingProperties classFragment here] end
			${super.fragments('BpjsDoctorMapping').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BpjsDoctorMappingModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BpjsDoctorMappingModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBpjsDoctorMappings
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BpjsDoctorMappingModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsDoctorMappingModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsDoctorMappingModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BpjsDoctorMappingById: bpjsDoctorMappingById(id: $id) {
							...BpjsDoctorMappingProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BpjsDoctorMappingById as BpjsDoctorMappingModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsDoctorMappingModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsDoctorMappingModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						bpjsDoctorMappings: bpjsDoctorMappings(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BpjsDoctorMappingProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBpjsDoctorMappings(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.bpjsDoctorMappings as BpjsDoctorMappingModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsDoctorMappingModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsDoctorMappingModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						bpjsDoctorMappings: lastBpjsDoctorMappings(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BpjsDoctorMappingProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BpjsDoctorMappingModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsDoctorMappingModel>> {
		...
		const successMessage = 'Created BPJS Doctor Mapping entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($bpjsDoctorMapping: BpjsDoctorMappingInput!, $persistRelations: Boolean) {
						bpjsDoctorMapping: createBpjsDoctorMapping(bpjsDoctorMapping: $bpjsDoctorMapping, persistRelations: $persistRelations) {
							...BpjsDoctorMappingProperties,
				...
				variables: {
					bpjsDoctorMapping: {
						...
						kodedokter: entity.kodedokter ? entity.kodedokter?.map((model: BpjsHospitalizationPlanModel) => new BpjsHospitalizationPlanModel(model).toJSON()) : [],
					},
			...
			map(result => {
				...
				return {
					targetModel: result.data.bpjsDoctorMapping as BpjsDoctorMappingModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BpjsDoctorMappingModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsDoctorMappingModel>> {
		...
		const successMessage = 'Created Multiple BPJS Doctor Mapping entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($bpjsDoctorMappings: [BpjsDoctorMappingInput!]!) {
						bpjsDoctorMapping: createAllBpjsDoctorMapping(bpjsDoctorMappings: $bpjsDoctorMappings) {
							...BpjsDoctorMappingProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					bpjsDoctorMappings: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.bpjsDoctorMapping as BpjsDoctorMappingModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BpjsDoctorMappingModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsDoctorMappingModel>> {
		...
		const successMessage = 'Updated BPJS Doctor Mapping entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($bpjsDoctorMapping: BpjsDoctorMappingInput!, $persistRelations: Boolean) {
						bpjsDoctorMapping: updateBpjsDoctorMapping(bpjsDoctorMapping: $bpjsDoctorMapping, persistRelations: $persistRelations) {
							...BpjsDoctorMappingProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BpjsDoctorMappingModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsDoctorMappingModel>> {
		...
		const successMessage = 'Update Multiple BPJS Doctor Mapping entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($bpjsDoctorMappings: [BpjsDoctorMappingInput!]!) {
						bpjsDoctorMapping: updateAllBpjsDoctorMapping(bpjsDoctorMappings: $bpjsDoctorMappings) {
							...BpjsDoctorMappingProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BpjsDoctorMappingModel>> {
		...
		const successMessage = 'Deleted BPJS Doctor Mapping entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($bpjsDoctorMappingId: ID!) {
						bpjsDoctorMappingId: deleteBpjsDoctorMappingById(bpjsDoctorMappingId: $bpjsDoctorMappingId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.bpjsDoctorMappingId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsDoctorMappingModel>> {
		...
		const successMessage = 'Deleted selected BPJS Doctor Mapping entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($bpjsDoctorMappingIds: [ID!]!){
						deleteBpjsDoctorMappingExcludingIds(bpjsDoctorMappingIds: $bpjsDoctorMappingIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.bpjsDoctorMappingIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BpjsDoctorMappingModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($bpjsDoctorMappingIds: [ID!]!) {
						bpjsDoctorMappingIds: deleteAllBpjsDoctorMappingByIds(bpjsDoctorMappingIds: $bpjsDoctorMappingIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BpjsDoctorMappingModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsDoctorMappingModel>>(
			{
				query: gql`
					query GetAudits {
						audits: bpjsDoctorMappingAudits {
							entity {
								...BpjsDoctorMappingProperties
							}
							timestamp
			...
			map(result => {
				let audits: BpjsDoctorMappingModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BpjsDoctorMappingModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BpjsDoctorMappingModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsDoctorMappingModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($bpjsDoctorMappingId: ID!) {
						audits: bpjsDoctorMappingAuditsByEntityId(bpjsDoctorMappingId: $bpjsDoctorMappingId) {
							entity {
								...BpjsDoctorMappingProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BpjsDoctorMappingModel>> {
		const url = environment.API_URL + '/api/bpjsdoctormapping/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BpjsDoctorMappingModel>> {
		const url = environment.API_URL + '/api/bpjsdoctormapping/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsDoctorMappingModel>> {
		let apiUrl = environment.API_URL + '/api/bpjsdoctormapping/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BpjsDoctorMappingModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/bpjsdoctormapping/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' BPJS Doctor Mapping entities')),
