...
import {BpjsPcareDPHOModelAudit} from '../../models/bpjsPcareDPHO/bpjs_pcare_dpho.model.state';
...
/**
 * BPJS Pcare DPHO service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BpjsPcareDPHOService extends AbstractHttpService<BpjsPcareDPHOModel, BpjsPcareDPHOModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BpjsPcareDPHOProperties classFragment here] off begin
			fragment BpjsPcareDPHOProperties on BpjsPcareDPHO {
				...BpjsPcareDPHOBaseProperties
				kdobat
				nmobat
				sedia
			}
			# % protected region % [Modify the BpjsPcareDPHOProperties classFragment here] end
			${super.fragments('BpjsPcareDPHO').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BpjsPcareDPHOModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BpjsPcareDPHOModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBpjsPcareDPHOs
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BpjsPcareDPHOModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPcareDPHOModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPcareDPHOModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BpjsPcareDPHOById: bpjsPcareDPHOById(id: $id) {
							...BpjsPcareDPHOProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BpjsPcareDPHOById as BpjsPcareDPHOModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsPcareDPHOModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPcareDPHOModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						bpjsPcareDPHOs: bpjsPcareDPHOs(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BpjsPcareDPHOProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBpjsPcareDPHOs(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.bpjsPcareDPHOs as BpjsPcareDPHOModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsPcareDPHOModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPcareDPHOModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						bpjsPcareDPHOs: lastBpjsPcareDPHOs(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BpjsPcareDPHOProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BpjsPcareDPHOModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPcareDPHOModel>> {
		...
		const successMessage = 'Created BPJS Pcare DPHO entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($bpjsPcareDPHO: BpjsPcareDPHOInput!, $persistRelations: Boolean) {
						bpjsPcareDPHO: createBpjsPcareDPHO(bpjsPcareDPHO: $bpjsPcareDPHO, persistRelations: $persistRelations) {
							...BpjsPcareDPHOProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.bpjsPcareDPHO as BpjsPcareDPHOModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BpjsPcareDPHOModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPcareDPHOModel>> {
		...
		const successMessage = 'Created Multiple BPJS Pcare DPHO entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($bpjsPcareDPHOs: [BpjsPcareDPHOInput!]!) {
						bpjsPcareDPHO: createAllBpjsPcareDPHO(bpjsPcareDPHOs: $bpjsPcareDPHOs) {
							...BpjsPcareDPHOProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					bpjsPcareDPHOs: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.bpjsPcareDPHO as BpjsPcareDPHOModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BpjsPcareDPHOModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPcareDPHOModel>> {
		...
		const successMessage = 'Updated BPJS Pcare DPHO entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($bpjsPcareDPHO: BpjsPcareDPHOInput!, $persistRelations: Boolean) {
						bpjsPcareDPHO: updateBpjsPcareDPHO(bpjsPcareDPHO: $bpjsPcareDPHO, persistRelations: $persistRelations) {
							...BpjsPcareDPHOProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BpjsPcareDPHOModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPcareDPHOModel>> {
		...
		const successMessage = 'Update Multiple BPJS Pcare DPHO entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($bpjsPcareDPHOs: [BpjsPcareDPHOInput!]!) {
						bpjsPcareDPHO: updateAllBpjsPcareDPHO(bpjsPcareDPHOs: $bpjsPcareDPHOs) {
							...BpjsPcareDPHOProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BpjsPcareDPHOModel>> {
		...
		const successMessage = 'Deleted BPJS Pcare DPHO entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($bpjsPcareDPHOId: ID!) {
						bpjsPcareDPHOId: deleteBpjsPcareDPHOById(bpjsPcareDPHOId: $bpjsPcareDPHOId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.bpjsPcareDPHOId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsPcareDPHOModel>> {
		...
		const successMessage = 'Deleted selected BPJS Pcare DPHO entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($bpjsPcareDPHOIds: [ID!]!){
						deleteBpjsPcareDPHOExcludingIds(bpjsPcareDPHOIds: $bpjsPcareDPHOIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.bpjsPcareDPHOIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BpjsPcareDPHOModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($bpjsPcareDPHOIds: [ID!]!) {
						bpjsPcareDPHOIds: deleteAllBpjsPcareDPHOByIds(bpjsPcareDPHOIds: $bpjsPcareDPHOIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BpjsPcareDPHOModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPcareDPHOModel>>(
			...
			map(result => {
				let audits: BpjsPcareDPHOModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BpjsPcareDPHOModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BpjsPcareDPHOModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPcareDPHOModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($bpjsPcareDPHOId: ID!) {
						audits: bpjsPcareDPHOAuditsByEntityId(bpjsPcareDPHOId: $bpjsPcareDPHOId) {
							entity {
								...BpjsPcareDPHOProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BpjsPcareDPHOModel>> {
		const url = environment.API_URL + '/api/bpjspcaredpho/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BpjsPcareDPHOModel>> {
		const url = environment.API_URL + '/api/bpjspcaredpho/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsPcareDPHOModel>> {
		let apiUrl = environment.API_URL + '/api/bpjspcaredpho/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BpjsPcareDPHOModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/bpjspcaredpho/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' BPJS Pcare DPHO entities')),
