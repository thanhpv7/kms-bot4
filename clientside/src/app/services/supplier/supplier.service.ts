...
import {SupplierModelAudit} from '../../models/supplier/supplier.model.state';
...
/**
 * Supplier service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class SupplierService extends AbstractHttpService<SupplierModel, SupplierModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the SupplierProperties classFragment here] off begin
			fragment SupplierProperties on Supplier {
				...SupplierBaseProperties
				supplierNumber
				supplierName
				taxID
				supplyStockGroup
			...
			# % protected region % [Modify the SupplierProperties classFragment here] end
			${super.fragments('Supplier').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<SupplierModel>> {
		...
		return  this.apollo.query<PassableStateConfig<SupplierModel>>(
			{
				query: gql`
					query Count {
						totalCount: countSuppliers
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<SupplierModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<SupplierModel>> {
		...
		return this.apollo.query<PassableStateConfig<SupplierModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						SupplierById: supplierById(id: $id) {
							...SupplierProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.SupplierById as SupplierModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<SupplierModel>> {
		...
		return this.apollo.query<PassableStateConfig<SupplierModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						suppliers: suppliers(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...SupplierProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countSuppliers(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.suppliers as SupplierModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<SupplierModel>> {
		...
		return this.apollo.query<PassableStateConfig<SupplierModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						suppliers: lastSuppliers(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...SupplierProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: SupplierModel, queryParams?: QueryParams): Observable<PassableStateConfig<SupplierModel>> {
		...
		const successMessage = 'Created Supplier entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($supplier: SupplierInput!, $persistRelations: Boolean) {
						supplier: createSupplier(supplier: $supplier, persistRelations: $persistRelations) {
							...SupplierProperties,
				...
				variables: {
					supplier: {
						...
						suplierContactDetails: entity.suplierContactDetails ? entity.suplierContactDetails?.map((model: SupplierContactDetailModel) => new SupplierContactDetailModel(model).toJSON()) : [],
						supplierBankAccounts: entity.supplierBankAccounts ? entity.supplierBankAccounts?.map((model: SupplierBankAccountModel) => new SupplierBankAccountModel(model).toJSON()) : [],
			...
			map(result => {
				...
				return {
					targetModel: result.data.supplier as SupplierModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: SupplierModel[], queryParams?: QueryParams): Observable<PassableStateConfig<SupplierModel>> {
		...
		const successMessage = 'Created Multiple Supplier entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($suppliers: [SupplierInput!]!) {
						supplier: createAllSupplier(suppliers: $suppliers) {
							...SupplierProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					suppliers: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.supplier as SupplierModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: SupplierModel, queryParams?: QueryParams): Observable<PassableStateConfig<SupplierModel>> {
		...
		const successMessage = 'Updated Supplier entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($supplier: SupplierInput!, $persistRelations: Boolean) {
						supplier: updateSupplier(supplier: $supplier, persistRelations: $persistRelations) {
							...SupplierProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: SupplierModel[], queryParams?: QueryParams): Observable<PassableStateConfig<SupplierModel>> {
		...
		const successMessage = 'Update Multiple Supplier entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($suppliers: [SupplierInput!]!) {
						supplier: updateAllSupplier(suppliers: $suppliers) {
							...SupplierProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<SupplierModel>> {
		...
		const successMessage = 'Deleted Supplier entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($supplierId: ID!) {
						supplierId: deleteSupplierById(supplierId: $supplierId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.supplierId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<SupplierModel>> {
		...
		const successMessage = 'Deleted selected Supplier entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($supplierIds: [ID!]!){
						deleteSupplierExcludingIds(supplierIds: $supplierIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.supplierIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<SupplierModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($supplierIds: [ID!]!) {
						supplierIds: deleteAllSupplierByIds(supplierIds: $supplierIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<SupplierModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<SupplierModel>>(
			...
			map(result => {
				let audits: SupplierModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new SupplierModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<SupplierModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<SupplierModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($supplierId: ID!) {
						audits: supplierAuditsByEntityId(supplierId: $supplierId) {
							entity {
								...SupplierProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<SupplierModel>> {
		const url = environment.API_URL + '/api/supplier/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<SupplierModel>> {
		const url = environment.API_URL + '/api/supplier/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<SupplierModel>> {
		let apiUrl = environment.API_URL + '/api/supplier/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<SupplierModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/supplier/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Supplier entities')),
