...
import {PatientPersonalInfoModel} from '../../models/patientPersonalInfo/patient_personal_info.model';
import {PatientPersonalInfoModelAudit} from '../../models/patientPersonalInfo/patient_personal_info.model.state';
...
/**
 * Patient Personal Info service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class PatientPersonalInfoService extends AbstractHttpService<PatientPersonalInfoModel, PatientPersonalInfoModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the PatientPersonalInfoProperties classFragment here] off begin
			fragment PatientPersonalInfoProperties on PatientPersonalInfo {
				...PatientPersonalInfoBaseProperties
				religion
				nationality
				ethnicity
				bloodType
			...
			# % protected region % [Modify the PatientPersonalInfoProperties classFragment here] end
			${super.fragments('PatientPersonalInfo').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<PatientPersonalInfoModel>> {
		...
		return  this.apollo.query<PassableStateConfig<PatientPersonalInfoModel>>(
			{
				query: gql`
					query Count {
						totalCount: countPatientPersonalInfos
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<PatientPersonalInfoModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<PatientPersonalInfoModel>> {
		...
		return this.apollo.query<PassableStateConfig<PatientPersonalInfoModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						PatientPersonalInfoById: patientPersonalInfoById(id: $id) {
							...PatientPersonalInfoProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.PatientPersonalInfoById as PatientPersonalInfoModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PatientPersonalInfoModel>> {
		...
		return this.apollo.query<PassableStateConfig<PatientPersonalInfoModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						patientPersonalInfos: patientPersonalInfos(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...PatientPersonalInfoProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countPatientPersonalInfos(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.patientPersonalInfos as PatientPersonalInfoModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PatientPersonalInfoModel>> {
		...
		return this.apollo.query<PassableStateConfig<PatientPersonalInfoModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						patientPersonalInfos: lastPatientPersonalInfos(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...PatientPersonalInfoProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: PatientPersonalInfoModel, queryParams?: QueryParams): Observable<PassableStateConfig<PatientPersonalInfoModel>> {
		...
		const successMessage = 'Created Patient Personal Info entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($patientPersonalInfo: PatientPersonalInfoInput!, $persistRelations: Boolean) {
						patientPersonalInfo: createPatientPersonalInfo(patientPersonalInfo: $patientPersonalInfo, persistRelations: $persistRelations) {
							...PatientPersonalInfoProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.patientPersonalInfo as PatientPersonalInfoModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: PatientPersonalInfoModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PatientPersonalInfoModel>> {
		...
		const successMessage = 'Created Multiple Patient Personal Info entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($patientPersonalInfos: [PatientPersonalInfoInput!]!) {
						patientPersonalInfo: createAllPatientPersonalInfo(patientPersonalInfos: $patientPersonalInfos) {
							...PatientPersonalInfoProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					patientPersonalInfos: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.patientPersonalInfo as PatientPersonalInfoModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: PatientPersonalInfoModel, queryParams?: QueryParams): Observable<PassableStateConfig<PatientPersonalInfoModel>> {
		...
		const successMessage = 'Updated Patient Personal Info entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($patientPersonalInfo: PatientPersonalInfoInput!, $persistRelations: Boolean) {
						patientPersonalInfo: updatePatientPersonalInfo(patientPersonalInfo: $patientPersonalInfo, persistRelations: $persistRelations) {
							...PatientPersonalInfoProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: PatientPersonalInfoModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PatientPersonalInfoModel>> {
		...
		const successMessage = 'Update Multiple Patient Personal Info entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($patientPersonalInfos: [PatientPersonalInfoInput!]!) {
						patientPersonalInfo: updateAllPatientPersonalInfo(patientPersonalInfos: $patientPersonalInfos) {
							...PatientPersonalInfoProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<PatientPersonalInfoModel>> {
		...
		const successMessage = 'Deleted Patient Personal Info entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($patientPersonalInfoId: ID!) {
						patientPersonalInfoId: deletePatientPersonalInfoById(patientPersonalInfoId: $patientPersonalInfoId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.patientPersonalInfoId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<PatientPersonalInfoModel>> {
		...
		const successMessage = 'Deleted selected Patient Personal Info entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($patientPersonalInfoIds: [ID!]!){
						deletePatientPersonalInfoExcludingIds(patientPersonalInfoIds: $patientPersonalInfoIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.patientPersonalInfoIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<PatientPersonalInfoModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($patientPersonalInfoIds: [ID!]!) {
						patientPersonalInfoIds: deleteAllPatientPersonalInfoByIds(patientPersonalInfoIds: $patientPersonalInfoIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<PatientPersonalInfoModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PatientPersonalInfoModel>>(
			{
				query: gql`
					query GetAudits {
						audits: patientPersonalInfoAudits {
							entity {
								...PatientPersonalInfoProperties
							}
							timestamp
			...
			map(result => {
				let audits: PatientPersonalInfoModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new PatientPersonalInfoModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<PatientPersonalInfoModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PatientPersonalInfoModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($patientPersonalInfoId: ID!) {
						audits: patientPersonalInfoAuditsByEntityId(patientPersonalInfoId: $patientPersonalInfoId) {
							entity {
								...PatientPersonalInfoProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<PatientPersonalInfoModel>> {
		const url = environment.API_URL + '/api/patientpersonalinfo/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<PatientPersonalInfoModel>> {
		const url = environment.API_URL + '/api/patientpersonalinfo/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<PatientPersonalInfoModel>> {
		let apiUrl = environment.API_URL + '/api/patientpersonalinfo/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<PatientPersonalInfoModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/patientpersonalinfo/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Patient Personal Info entities')),
