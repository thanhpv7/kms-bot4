...
import {TariffPackageModelAudit} from '../../models/tariffPackage/tariff_package.model.state';
...
/**
 * Tariff Package service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class TariffPackageService extends AbstractHttpService<TariffPackageModel, TariffPackageModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the TariffPackageProperties classFragment here] off begin
			fragment TariffPackageProperties on TariffPackage {
				...TariffPackageBaseProperties
				tariffPackageCode
				tariffPackageName
			...
			${super.fragments('TariffPackage').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<TariffPackageModel>> {
		...
		return  this.apollo.query<PassableStateConfig<TariffPackageModel>>(
			{
				query: gql`
					query Count {
						totalCount: countTariffPackages
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<TariffPackageModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<TariffPackageModel>> {
		...
		return this.apollo.query<PassableStateConfig<TariffPackageModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						TariffPackageById: tariffPackageById(id: $id) {
							...TariffPackageProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.TariffPackageById as TariffPackageModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<TariffPackageModel>> {
		...
		return this.apollo.query<PassableStateConfig<TariffPackageModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						tariffPackages: tariffPackages(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...TariffPackageProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countTariffPackages(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.tariffPackages as TariffPackageModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<TariffPackageModel>> {
		...
		return this.apollo.query<PassableStateConfig<TariffPackageModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						tariffPackages: lastTariffPackages(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...TariffPackageProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: TariffPackageModel, queryParams?: QueryParams): Observable<PassableStateConfig<TariffPackageModel>> {
		...
		const successMessage = 'Created Tariff Package entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($tariffPackage: TariffPackageInput!, $persistRelations: Boolean) {
						tariffPackage: createTariffPackage(tariffPackage: $tariffPackage, persistRelations: $persistRelations) {
							...TariffPackageProperties,
				...
				variables: {
					tariffPackage: {
						...entity.toJSON(),
						serviceItemAssignments: entity.serviceItemAssignments ? entity.serviceItemAssignments?.map((model: ServiceItemAssignmentModel) => new ServiceItemAssignmentModel(model).toJSON()) : [],
						tariffPackageItems: entity.tariffPackageItems ? entity.tariffPackageItems?.map((model: TariffPackageItemModel) => new TariffPackageItemModel(model).toJSON()) : [],
						tariffPackageServiceAssignments: entity.tariffPackageServiceAssignments ? entity.tariffPackageServiceAssignments?.map((model: TariffPackageServiceAssignmentModel) => new TariffPackageServiceAssignmentModel(model).toJSON()) : [],
					},
			...
			map(result => {
				...
				return {
					targetModel: result.data.tariffPackage as TariffPackageModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: TariffPackageModel[], queryParams?: QueryParams): Observable<PassableStateConfig<TariffPackageModel>> {
		...
		const successMessage = 'Created Multiple Tariff Package entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($tariffPackages: [TariffPackageInput!]!) {
						tariffPackage: createAllTariffPackage(tariffPackages: $tariffPackages) {
							...TariffPackageProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					tariffPackages: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.tariffPackage as TariffPackageModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: TariffPackageModel, queryParams?: QueryParams): Observable<PassableStateConfig<TariffPackageModel>> {
		...
		const successMessage = 'Updated Tariff Package entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($tariffPackage: TariffPackageInput!, $persistRelations: Boolean) {
						tariffPackage: updateTariffPackage(tariffPackage: $tariffPackage, persistRelations: $persistRelations) {
							...TariffPackageProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: TariffPackageModel[], queryParams?: QueryParams): Observable<PassableStateConfig<TariffPackageModel>> {
		...
		const successMessage = 'Update Multiple Tariff Package entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($tariffPackages: [TariffPackageInput!]!) {
						tariffPackage: updateAllTariffPackage(tariffPackages: $tariffPackages) {
							...TariffPackageProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<TariffPackageModel>> {
		...
		const successMessage = 'Deleted Tariff Package entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($tariffPackageId: ID!) {
						tariffPackageId: deleteTariffPackageById(tariffPackageId: $tariffPackageId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.tariffPackageId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<TariffPackageModel>> {
		...
		const successMessage = 'Deleted selected Tariff Package entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($tariffPackageIds: [ID!]!){
						deleteTariffPackageExcludingIds(tariffPackageIds: $tariffPackageIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.tariffPackageIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<TariffPackageModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($tariffPackageIds: [ID!]!) {
						tariffPackageIds: deleteAllTariffPackageByIds(tariffPackageIds: $tariffPackageIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<TariffPackageModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<TariffPackageModel>>(
			...
			map(result => {
				let audits: TariffPackageModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new TariffPackageModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<TariffPackageModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<TariffPackageModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($tariffPackageId: ID!) {
						audits: tariffPackageAuditsByEntityId(tariffPackageId: $tariffPackageId) {
							entity {
								...TariffPackageProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<TariffPackageModel>> {
		const url = environment.API_URL + '/api/tariffpackage/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<TariffPackageModel>> {
		const url = environment.API_URL + '/api/tariffpackage/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<TariffPackageModel>> {
		let apiUrl = environment.API_URL + '/api/tariffpackage/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<TariffPackageModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/tariffpackage/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Tariff Package entities')),
