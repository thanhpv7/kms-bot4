...
import {CatalogueMedicalModel} from '../../models/catalogueMedical/catalogue_medical.model';
import {CatalogueMedicalModelAudit} from '../../models/catalogueMedical/catalogue_medical.model.state';
...
/**
 * Catalogue Medical  service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class CatalogueMedicalService extends AbstractHttpService<CatalogueMedicalModel, CatalogueMedicalModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the CatalogueMedicalProperties classFragment here] off begin
			fragment CatalogueMedicalProperties on CatalogueMedical {
				...CatalogueMedicalBaseProperties
				composition
				canBePrescribed
				isHospitalFormulary
				approvalNotes
				...
				consumptionMethod
				consumptionUnit
				compoundChargingRounding
				compoundChargingRoundingAmount
				inventoryRounding
				inventoryRoundingAmount
			}
			# % protected region % [Modify the CatalogueMedicalProperties classFragment here] end
			${super.fragments('CatalogueMedical').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<CatalogueMedicalModel>> {
		...
		return  this.apollo.query<PassableStateConfig<CatalogueMedicalModel>>(
			{
				query: gql`
					query Count {
						totalCount: countCatalogueMedicals
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<CatalogueMedicalModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<CatalogueMedicalModel>> {
		...
		return this.apollo.query<PassableStateConfig<CatalogueMedicalModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						CatalogueMedicalById: catalogueMedicalById(id: $id) {
							...CatalogueMedicalProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.CatalogueMedicalById as CatalogueMedicalModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<CatalogueMedicalModel>> {
		...
		return this.apollo.query<PassableStateConfig<CatalogueMedicalModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						catalogueMedicals: catalogueMedicals(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...CatalogueMedicalProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countCatalogueMedicals(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.catalogueMedicals as CatalogueMedicalModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<CatalogueMedicalModel>> {
		...
		return this.apollo.query<PassableStateConfig<CatalogueMedicalModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						catalogueMedicals: lastCatalogueMedicals(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...CatalogueMedicalProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: CatalogueMedicalModel, queryParams?: QueryParams): Observable<PassableStateConfig<CatalogueMedicalModel>> {
		...
		const successMessage = 'Created Catalogue Medical  entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($catalogueMedical: CatalogueMedicalInput!, $persistRelations: Boolean) {
						catalogueMedical: createCatalogueMedical(catalogueMedical: $catalogueMedical, persistRelations: $persistRelations) {
							...CatalogueMedicalProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.catalogueMedical as CatalogueMedicalModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: CatalogueMedicalModel[], queryParams?: QueryParams): Observable<PassableStateConfig<CatalogueMedicalModel>> {
		...
		const successMessage = 'Created Multiple Catalogue Medical  entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($catalogueMedicals: [CatalogueMedicalInput!]!) {
						catalogueMedical: createAllCatalogueMedical(catalogueMedicals: $catalogueMedicals) {
							...CatalogueMedicalProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					catalogueMedicals: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.catalogueMedical as CatalogueMedicalModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: CatalogueMedicalModel, queryParams?: QueryParams): Observable<PassableStateConfig<CatalogueMedicalModel>> {
		...
		const successMessage = 'Updated Catalogue Medical  entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($catalogueMedical: CatalogueMedicalInput!, $persistRelations: Boolean) {
						catalogueMedical: updateCatalogueMedical(catalogueMedical: $catalogueMedical, persistRelations: $persistRelations) {
							...CatalogueMedicalProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: CatalogueMedicalModel[], queryParams?: QueryParams): Observable<PassableStateConfig<CatalogueMedicalModel>> {
		...
		const successMessage = 'Update Multiple Catalogue Medical  entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($catalogueMedicals: [CatalogueMedicalInput!]!) {
						catalogueMedical: updateAllCatalogueMedical(catalogueMedicals: $catalogueMedicals) {
							...CatalogueMedicalProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<CatalogueMedicalModel>> {
		...
		const successMessage = 'Deleted Catalogue Medical  entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($catalogueMedicalId: ID!) {
						catalogueMedicalId: deleteCatalogueMedicalById(catalogueMedicalId: $catalogueMedicalId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.catalogueMedicalId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<CatalogueMedicalModel>> {
		...
		const successMessage = 'Deleted selected Catalogue Medical  entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($catalogueMedicalIds: [ID!]!){
						deleteCatalogueMedicalExcludingIds(catalogueMedicalIds: $catalogueMedicalIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.catalogueMedicalIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<CatalogueMedicalModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($catalogueMedicalIds: [ID!]!) {
						catalogueMedicalIds: deleteAllCatalogueMedicalByIds(catalogueMedicalIds: $catalogueMedicalIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<CatalogueMedicalModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<CatalogueMedicalModel>>(
			...
			map(result => {
				let audits: CatalogueMedicalModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new CatalogueMedicalModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<CatalogueMedicalModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<CatalogueMedicalModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($catalogueMedicalId: ID!) {
						audits: catalogueMedicalAuditsByEntityId(catalogueMedicalId: $catalogueMedicalId) {
							entity {
								...CatalogueMedicalProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<CatalogueMedicalModel>> {
		const url = environment.API_URL + '/api/cataloguemedical/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<CatalogueMedicalModel>> {
		const url = environment.API_URL + '/api/cataloguemedical/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<CatalogueMedicalModel>> {
		let apiUrl = environment.API_URL + '/api/cataloguemedical/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<CatalogueMedicalModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/cataloguemedical/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Catalogue Medical  entities')),
