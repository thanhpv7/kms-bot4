...
import {BpjsDiagnoseModel} from '../../models/bpjsDiagnose/bpjs_diagnose.model';
import {BpjsDiagnoseModelAudit} from '../../models/bpjsDiagnose/bpjs_diagnose.model.state';
...
/**
 * BPJS Diagnose service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BpjsDiagnoseService extends AbstractHttpService<BpjsDiagnoseModel, BpjsDiagnoseModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BpjsDiagnoseProperties classFragment here] off begin
			fragment BpjsDiagnoseProperties on BpjsDiagnose {
				...BpjsDiagnoseBaseProperties
				refCode
				refName
			}
			# % protected region % [Modify the BpjsDiagnoseProperties classFragment here] end
			${super.fragments('BpjsDiagnose').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BpjsDiagnoseModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BpjsDiagnoseModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBpjsDiagnoses
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BpjsDiagnoseModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsDiagnoseModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsDiagnoseModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BpjsDiagnoseById: bpjsDiagnoseById(id: $id) {
							...BpjsDiagnoseProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BpjsDiagnoseById as BpjsDiagnoseModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsDiagnoseModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsDiagnoseModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						bpjsDiagnoses: bpjsDiagnoses(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BpjsDiagnoseProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBpjsDiagnoses(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.bpjsDiagnoses as BpjsDiagnoseModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsDiagnoseModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsDiagnoseModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						bpjsDiagnoses: lastBpjsDiagnoses(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BpjsDiagnoseProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BpjsDiagnoseModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsDiagnoseModel>> {
		...
		const successMessage = 'Created BPJS Diagnose entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($bpjsDiagnose: BpjsDiagnoseInput!, $persistRelations: Boolean) {
						bpjsDiagnose: createBpjsDiagnose(bpjsDiagnose: $bpjsDiagnose, persistRelations: $persistRelations) {
							...BpjsDiagnoseProperties,
				...
				variables: {
					bpjsDiagnose: {
						...
						additionalDiagnose: entity.additionalDiagnose ? entity.additionalDiagnose?.map((model: BpjsSpecialReferralModel) => new BpjsSpecialReferralModel(model).toJSON()) : [],
						...
						primaryDiagnose: entity.primaryDiagnose ? entity.primaryDiagnose?.map((model: BpjsSpecialReferralModel) => new BpjsSpecialReferralModel(model).toJSON()) : [],
					},
			...
			map(result => {
				...
				return {
					targetModel: result.data.bpjsDiagnose as BpjsDiagnoseModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BpjsDiagnoseModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsDiagnoseModel>> {
		...
		const successMessage = 'Created Multiple BPJS Diagnose entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($bpjsDiagnoses: [BpjsDiagnoseInput!]!) {
						bpjsDiagnose: createAllBpjsDiagnose(bpjsDiagnoses: $bpjsDiagnoses) {
							...BpjsDiagnoseProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					bpjsDiagnoses: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.bpjsDiagnose as BpjsDiagnoseModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BpjsDiagnoseModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsDiagnoseModel>> {
		...
		const successMessage = 'Updated BPJS Diagnose entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($bpjsDiagnose: BpjsDiagnoseInput!, $persistRelations: Boolean) {
						bpjsDiagnose: updateBpjsDiagnose(bpjsDiagnose: $bpjsDiagnose, persistRelations: $persistRelations) {
							...BpjsDiagnoseProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BpjsDiagnoseModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsDiagnoseModel>> {
		...
		const successMessage = 'Update Multiple BPJS Diagnose entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($bpjsDiagnoses: [BpjsDiagnoseInput!]!) {
						bpjsDiagnose: updateAllBpjsDiagnose(bpjsDiagnoses: $bpjsDiagnoses) {
							...BpjsDiagnoseProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BpjsDiagnoseModel>> {
		...
		const successMessage = 'Deleted BPJS Diagnose entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($bpjsDiagnoseId: ID!) {
						bpjsDiagnoseId: deleteBpjsDiagnoseById(bpjsDiagnoseId: $bpjsDiagnoseId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.bpjsDiagnoseId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsDiagnoseModel>> {
		...
		const successMessage = 'Deleted selected BPJS Diagnose entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($bpjsDiagnoseIds: [ID!]!){
						deleteBpjsDiagnoseExcludingIds(bpjsDiagnoseIds: $bpjsDiagnoseIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.bpjsDiagnoseIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BpjsDiagnoseModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($bpjsDiagnoseIds: [ID!]!) {
						bpjsDiagnoseIds: deleteAllBpjsDiagnoseByIds(bpjsDiagnoseIds: $bpjsDiagnoseIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BpjsDiagnoseModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsDiagnoseModel>>(
			...
			map(result => {
				let audits: BpjsDiagnoseModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BpjsDiagnoseModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BpjsDiagnoseModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsDiagnoseModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($bpjsDiagnoseId: ID!) {
						audits: bpjsDiagnoseAuditsByEntityId(bpjsDiagnoseId: $bpjsDiagnoseId) {
							entity {
								...BpjsDiagnoseProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BpjsDiagnoseModel>> {
		const url = environment.API_URL + '/api/bpjsdiagnose/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BpjsDiagnoseModel>> {
		const url = environment.API_URL + '/api/bpjsdiagnose/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsDiagnoseModel>> {
		let apiUrl = environment.API_URL + '/api/bpjsdiagnose/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BpjsDiagnoseModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/bpjsdiagnose/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' BPJS Diagnose entities')),
