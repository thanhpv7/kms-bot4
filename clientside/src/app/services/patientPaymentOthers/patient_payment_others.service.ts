...
import {PatientPaymentOthersModel} from '../../models/patientPaymentOthers/patient_payment_others.model';
import {PatientPaymentOthersModelAudit} from '../../models/patientPaymentOthers/patient_payment_others.model.state';
...
/**
 * Patient Payment Others service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class PatientPaymentOthersService extends AbstractHttpService<PatientPaymentOthersModel, PatientPaymentOthersModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the PatientPaymentOthersProperties classFragment here] off begin
			fragment PatientPaymentOthersProperties on PatientPaymentOthers {
				...PatientPaymentOthersBaseProperties
				notes
			}
			# % protected region % [Modify the PatientPaymentOthersProperties classFragment here] end
			${super.fragments('PatientPaymentOthers').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<PatientPaymentOthersModel>> {
		...
		return  this.apollo.query<PassableStateConfig<PatientPaymentOthersModel>>(
			{
				query: gql`
					query Count {
						totalCount: countPatientPaymentOtherss
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<PatientPaymentOthersModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<PatientPaymentOthersModel>> {
		...
		return this.apollo.query<PassableStateConfig<PatientPaymentOthersModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						PatientPaymentOthersById: patientPaymentOthersById(id: $id) {
							...PatientPaymentOthersProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.PatientPaymentOthersById as PatientPaymentOthersModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PatientPaymentOthersModel>> {
		...
		return this.apollo.query<PassableStateConfig<PatientPaymentOthersModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						patientPaymentOtherss: patientPaymentOtherss(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...PatientPaymentOthersProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countPatientPaymentOtherss(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.patientPaymentOtherss as PatientPaymentOthersModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PatientPaymentOthersModel>> {
		...
		return this.apollo.query<PassableStateConfig<PatientPaymentOthersModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						patientPaymentOtherss: lastPatientPaymentOtherss(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...PatientPaymentOthersProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: PatientPaymentOthersModel, queryParams?: QueryParams): Observable<PassableStateConfig<PatientPaymentOthersModel>> {
		...
		const successMessage = 'Created Patient Payment Others entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($patientPaymentOthers: PatientPaymentOthersInput!, $persistRelations: Boolean) {
						patientPaymentOthers: createPatientPaymentOthers(patientPaymentOthers: $patientPaymentOthers, persistRelations: $persistRelations) {
							...PatientPaymentOthersProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.patientPaymentOthers as PatientPaymentOthersModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: PatientPaymentOthersModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PatientPaymentOthersModel>> {
		...
		const successMessage = 'Created Multiple Patient Payment Others entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($patientPaymentOtherss: [PatientPaymentOthersInput!]!) {
						patientPaymentOthers: createAllPatientPaymentOthers(patientPaymentOtherss: $patientPaymentOtherss) {
							...PatientPaymentOthersProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					patientPaymentOtherss: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.patientPaymentOthers as PatientPaymentOthersModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: PatientPaymentOthersModel, queryParams?: QueryParams): Observable<PassableStateConfig<PatientPaymentOthersModel>> {
		...
		const successMessage = 'Updated Patient Payment Others entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($patientPaymentOthers: PatientPaymentOthersInput!, $persistRelations: Boolean) {
						patientPaymentOthers: updatePatientPaymentOthers(patientPaymentOthers: $patientPaymentOthers, persistRelations: $persistRelations) {
							...PatientPaymentOthersProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: PatientPaymentOthersModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PatientPaymentOthersModel>> {
		...
		const successMessage = 'Update Multiple Patient Payment Others entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($patientPaymentOtherss: [PatientPaymentOthersInput!]!) {
						patientPaymentOthers: updateAllPatientPaymentOthers(patientPaymentOtherss: $patientPaymentOtherss) {
							...PatientPaymentOthersProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<PatientPaymentOthersModel>> {
		...
		const successMessage = 'Deleted Patient Payment Others entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($patientPaymentOthersId: ID!) {
						patientPaymentOthersId: deletePatientPaymentOthersById(patientPaymentOthersId: $patientPaymentOthersId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.patientPaymentOthersId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<PatientPaymentOthersModel>> {
		...
		const successMessage = 'Deleted selected Patient Payment Others entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($patientPaymentOthersIds: [ID!]!){
						deletePatientPaymentOthersExcludingIds(patientPaymentOthersIds: $patientPaymentOthersIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.patientPaymentOthersIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<PatientPaymentOthersModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($patientPaymentOthersIds: [ID!]!) {
						patientPaymentOthersIds: deleteAllPatientPaymentOthersByIds(patientPaymentOthersIds: $patientPaymentOthersIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<PatientPaymentOthersModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PatientPaymentOthersModel>>(
			{
				query: gql`
					query GetAudits {
						audits: patientPaymentOthersAudits {
							entity {
								...PatientPaymentOthersProperties
							}
							timestamp
			...
			map(result => {
				let audits: PatientPaymentOthersModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new PatientPaymentOthersModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<PatientPaymentOthersModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PatientPaymentOthersModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($patientPaymentOthersId: ID!) {
						audits: patientPaymentOthersAuditsByEntityId(patientPaymentOthersId: $patientPaymentOthersId) {
							entity {
								...PatientPaymentOthersProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<PatientPaymentOthersModel>> {
		const url = environment.API_URL + '/api/patientpaymentothers/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<PatientPaymentOthersModel>> {
		const url = environment.API_URL + '/api/patientpaymentothers/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<PatientPaymentOthersModel>> {
		let apiUrl = environment.API_URL + '/api/patientpaymentothers/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<PatientPaymentOthersModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/patientpaymentothers/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Patient Payment Others entities')),
