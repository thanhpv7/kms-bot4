...
import {RoomTransferModel} from '../../models/roomTransfer/room_transfer.model';
import {RoomTransferModelAudit} from '../../models/roomTransfer/room_transfer.model.state';
...
/**
 * Room Transfer service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class RoomTransferService extends AbstractHttpService<RoomTransferModel, RoomTransferModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the RoomTransferProperties classFragment here] off begin
			fragment RoomTransferProperties on RoomTransfer {
				...RoomTransferBaseProperties
				startDateTime
				endDateTime
				treatmentClass
				transferringStaffName
			}
			# % protected region % [Modify the RoomTransferProperties classFragment here] end
			${super.fragments('RoomTransfer').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<RoomTransferModel>> {
		...
		return  this.apollo.query<PassableStateConfig<RoomTransferModel>>(
			{
				query: gql`
					query Count {
						totalCount: countRoomTransfers
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<RoomTransferModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<RoomTransferModel>> {
		...
		return this.apollo.query<PassableStateConfig<RoomTransferModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						RoomTransferById: roomTransferById(id: $id) {
							...RoomTransferProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.RoomTransferById as RoomTransferModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<RoomTransferModel>> {
		...
		return this.apollo.query<PassableStateConfig<RoomTransferModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						roomTransfers: roomTransfers(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...RoomTransferProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countRoomTransfers(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.roomTransfers as RoomTransferModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<RoomTransferModel>> {
		...
		return this.apollo.query<PassableStateConfig<RoomTransferModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						roomTransfers: lastRoomTransfers(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...RoomTransferProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: RoomTransferModel, queryParams?: QueryParams): Observable<PassableStateConfig<RoomTransferModel>> {
		...
		const successMessage = 'Created Room Transfer entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($roomTransfer: RoomTransferInput!, $persistRelations: Boolean) {
						roomTransfer: createRoomTransfer(roomTransfer: $roomTransfer, persistRelations: $persistRelations) {
							...RoomTransferProperties,
				...
				variables: {
					roomTransfer: {
						...
						transferringStaff: entity.transferringStaff ? new StaffModel(entity.transferringStaff).toJSON() : undefined,
					},
			...
			map(result => {
				...
				return {
					targetModel: result.data.roomTransfer as RoomTransferModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: RoomTransferModel[], queryParams?: QueryParams): Observable<PassableStateConfig<RoomTransferModel>> {
		...
		const successMessage = 'Created Multiple Room Transfer entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($roomTransfers: [RoomTransferInput!]!) {
						roomTransfer: createAllRoomTransfer(roomTransfers: $roomTransfers) {
							...RoomTransferProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					roomTransfers: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.roomTransfer as RoomTransferModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: RoomTransferModel, queryParams?: QueryParams): Observable<PassableStateConfig<RoomTransferModel>> {
		...
		const successMessage = 'Updated Room Transfer entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($roomTransfer: RoomTransferInput!, $persistRelations: Boolean) {
						roomTransfer: updateRoomTransfer(roomTransfer: $roomTransfer, persistRelations: $persistRelations) {
							...RoomTransferProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: RoomTransferModel[], queryParams?: QueryParams): Observable<PassableStateConfig<RoomTransferModel>> {
		...
		const successMessage = 'Update Multiple Room Transfer entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($roomTransfers: [RoomTransferInput!]!) {
						roomTransfer: updateAllRoomTransfer(roomTransfers: $roomTransfers) {
							...RoomTransferProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<RoomTransferModel>> {
		...
		const successMessage = 'Deleted Room Transfer entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($roomTransferId: ID!) {
						roomTransferId: deleteRoomTransferById(roomTransferId: $roomTransferId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.roomTransferId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<RoomTransferModel>> {
		...
		const successMessage = 'Deleted selected Room Transfer entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($roomTransferIds: [ID!]!){
						deleteRoomTransferExcludingIds(roomTransferIds: $roomTransferIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.roomTransferIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<RoomTransferModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($roomTransferIds: [ID!]!) {
						roomTransferIds: deleteAllRoomTransferByIds(roomTransferIds: $roomTransferIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<RoomTransferModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<RoomTransferModel>>(
			...
			map(result => {
				let audits: RoomTransferModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new RoomTransferModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<RoomTransferModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<RoomTransferModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($roomTransferId: ID!) {
						audits: roomTransferAuditsByEntityId(roomTransferId: $roomTransferId) {
							entity {
								...RoomTransferProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<RoomTransferModel>> {
		const url = environment.API_URL + '/api/roomtransfer/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<RoomTransferModel>> {
		const url = environment.API_URL + '/api/roomtransfer/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<RoomTransferModel>> {
		let apiUrl = environment.API_URL + '/api/roomtransfer/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<RoomTransferModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/roomtransfer/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Room Transfer entities')),
