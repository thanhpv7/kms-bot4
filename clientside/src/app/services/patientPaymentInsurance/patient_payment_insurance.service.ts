...
import {PatientPaymentInsuranceModel} from '../../models/patientPaymentInsurance/patient_payment_insurance.model';
import {PatientPaymentInsuranceModelAudit} from '../../models/patientPaymentInsurance/patient_payment_insurance.model.state';
...
/**
 * Patient Payment Insurance service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class PatientPaymentInsuranceService extends AbstractHttpService<PatientPaymentInsuranceModel, PatientPaymentInsuranceModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the PatientPaymentInsuranceProperties classFragment here] off begin
			fragment PatientPaymentInsuranceProperties on PatientPaymentInsurance {
				...PatientPaymentInsuranceBaseProperties
				memberNo
				policyHolderNo
			...
			# % protected region % [Modify the PatientPaymentInsuranceProperties classFragment here] end
			${super.fragments('PatientPaymentInsurance').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<PatientPaymentInsuranceModel>> {
		...
		return  this.apollo.query<PassableStateConfig<PatientPaymentInsuranceModel>>(
			{
				query: gql`
					query Count {
						totalCount: countPatientPaymentInsurances
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<PatientPaymentInsuranceModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<PatientPaymentInsuranceModel>> {
		...
		return this.apollo.query<PassableStateConfig<PatientPaymentInsuranceModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						PatientPaymentInsuranceById: patientPaymentInsuranceById(id: $id) {
							...PatientPaymentInsuranceProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.PatientPaymentInsuranceById as PatientPaymentInsuranceModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PatientPaymentInsuranceModel>> {
		...
		return this.apollo.query<PassableStateConfig<PatientPaymentInsuranceModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						patientPaymentInsurances: patientPaymentInsurances(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...PatientPaymentInsuranceProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countPatientPaymentInsurances(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.patientPaymentInsurances as PatientPaymentInsuranceModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PatientPaymentInsuranceModel>> {
		...
		return this.apollo.query<PassableStateConfig<PatientPaymentInsuranceModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						patientPaymentInsurances: lastPatientPaymentInsurances(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...PatientPaymentInsuranceProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: PatientPaymentInsuranceModel, queryParams?: QueryParams): Observable<PassableStateConfig<PatientPaymentInsuranceModel>> {
		...
		const successMessage = 'Created Patient Payment Insurance entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($patientPaymentInsurance: PatientPaymentInsuranceInput!, $persistRelations: Boolean) {
						patientPaymentInsurance: createPatientPaymentInsurance(patientPaymentInsurance: $patientPaymentInsurance, persistRelations: $persistRelations) {
							...PatientPaymentInsuranceProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.patientPaymentInsurance as PatientPaymentInsuranceModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: PatientPaymentInsuranceModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PatientPaymentInsuranceModel>> {
		...
		const successMessage = 'Created Multiple Patient Payment Insurance entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($patientPaymentInsurances: [PatientPaymentInsuranceInput!]!) {
						patientPaymentInsurance: createAllPatientPaymentInsurance(patientPaymentInsurances: $patientPaymentInsurances) {
							...PatientPaymentInsuranceProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					patientPaymentInsurances: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.patientPaymentInsurance as PatientPaymentInsuranceModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: PatientPaymentInsuranceModel, queryParams?: QueryParams): Observable<PassableStateConfig<PatientPaymentInsuranceModel>> {
		...
		const successMessage = 'Updated Patient Payment Insurance entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($patientPaymentInsurance: PatientPaymentInsuranceInput!, $persistRelations: Boolean) {
						patientPaymentInsurance: updatePatientPaymentInsurance(patientPaymentInsurance: $patientPaymentInsurance, persistRelations: $persistRelations) {
							...PatientPaymentInsuranceProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: PatientPaymentInsuranceModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PatientPaymentInsuranceModel>> {
		...
		const successMessage = 'Update Multiple Patient Payment Insurance entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($patientPaymentInsurances: [PatientPaymentInsuranceInput!]!) {
						patientPaymentInsurance: updateAllPatientPaymentInsurance(patientPaymentInsurances: $patientPaymentInsurances) {
							...PatientPaymentInsuranceProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<PatientPaymentInsuranceModel>> {
		...
		const successMessage = 'Deleted Patient Payment Insurance entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($patientPaymentInsuranceId: ID!) {
						patientPaymentInsuranceId: deletePatientPaymentInsuranceById(patientPaymentInsuranceId: $patientPaymentInsuranceId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.patientPaymentInsuranceId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<PatientPaymentInsuranceModel>> {
		...
		const successMessage = 'Deleted selected Patient Payment Insurance entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($patientPaymentInsuranceIds: [ID!]!){
						deletePatientPaymentInsuranceExcludingIds(patientPaymentInsuranceIds: $patientPaymentInsuranceIds)
				...
				`,
				variables: {
					patientPaymentInsuranceIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.patientPaymentInsuranceIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<PatientPaymentInsuranceModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($patientPaymentInsuranceIds: [ID!]!) {
						patientPaymentInsuranceIds: deleteAllPatientPaymentInsuranceByIds(patientPaymentInsuranceIds: $patientPaymentInsuranceIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<PatientPaymentInsuranceModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PatientPaymentInsuranceModel>>(
			{
				query: gql`
					query GetAudits {
						audits: patientPaymentInsuranceAudits {
							entity {
								...PatientPaymentInsuranceProperties
							}
							timestamp
			...
			map(result => {
				let audits: PatientPaymentInsuranceModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new PatientPaymentInsuranceModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<PatientPaymentInsuranceModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PatientPaymentInsuranceModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($patientPaymentInsuranceId: ID!) {
						audits: patientPaymentInsuranceAuditsByEntityId(patientPaymentInsuranceId: $patientPaymentInsuranceId) {
							entity {
								...PatientPaymentInsuranceProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<PatientPaymentInsuranceModel>> {
		const url = environment.API_URL + '/api/patientpaymentinsurance/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<PatientPaymentInsuranceModel>> {
		const url = environment.API_URL + '/api/patientpaymentinsurance/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<PatientPaymentInsuranceModel>> {
		let apiUrl = environment.API_URL + '/api/patientpaymentinsurance/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<PatientPaymentInsuranceModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/patientpaymentinsurance/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Patient Payment Insurance entities')),
