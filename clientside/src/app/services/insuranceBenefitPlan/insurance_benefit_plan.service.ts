...
import {InsuranceBenefitPlanModel} from '../../models/insuranceBenefitPlan/insurance_benefit_plan.model';
import {InsuranceBenefitPlanModelAudit} from '../../models/insuranceBenefitPlan/insurance_benefit_plan.model.state';
...
/**
 * Insurance Benefit Plan service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class InsuranceBenefitPlanService extends AbstractHttpService<InsuranceBenefitPlanModel, InsuranceBenefitPlanModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the InsuranceBenefitPlanProperties classFragment here] off begin
			fragment InsuranceBenefitPlanProperties on InsuranceBenefitPlan {
				...InsuranceBenefitPlanBaseProperties
				benefitPlanNo
				benefitPlanName
			...
			# % protected region % [Modify the InsuranceBenefitPlanProperties classFragment here] end
			${super.fragments('InsuranceBenefitPlan').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<InsuranceBenefitPlanModel>> {
		...
		return  this.apollo.query<PassableStateConfig<InsuranceBenefitPlanModel>>(
			{
				query: gql`
					query Count {
						totalCount: countInsuranceBenefitPlans
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<InsuranceBenefitPlanModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<InsuranceBenefitPlanModel>> {
		...
		return this.apollo.query<PassableStateConfig<InsuranceBenefitPlanModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						InsuranceBenefitPlanById: insuranceBenefitPlanById(id: $id) {
							...InsuranceBenefitPlanProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.InsuranceBenefitPlanById as InsuranceBenefitPlanModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<InsuranceBenefitPlanModel>> {
		...
		return this.apollo.query<PassableStateConfig<InsuranceBenefitPlanModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						insuranceBenefitPlans: insuranceBenefitPlans(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...InsuranceBenefitPlanProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countInsuranceBenefitPlans(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.insuranceBenefitPlans as InsuranceBenefitPlanModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<InsuranceBenefitPlanModel>> {
		...
		return this.apollo.query<PassableStateConfig<InsuranceBenefitPlanModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						insuranceBenefitPlans: lastInsuranceBenefitPlans(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...InsuranceBenefitPlanProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: InsuranceBenefitPlanModel, queryParams?: QueryParams): Observable<PassableStateConfig<InsuranceBenefitPlanModel>> {
		...
		const successMessage = 'Created Insurance Benefit Plan entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($insuranceBenefitPlan: InsuranceBenefitPlanInput!, $persistRelations: Boolean) {
						insuranceBenefitPlan: createInsuranceBenefitPlan(insuranceBenefitPlan: $insuranceBenefitPlan, persistRelations: $persistRelations) {
							...InsuranceBenefitPlanProperties,
				...
				variables: {
					insuranceBenefitPlan: {
						...entity.toJSON(),
						insuranceProvider: entity.insuranceProvider ? new InsuranceProviderModel(entity.insuranceProvider).toJSON() : undefined,
						invoicePaymentInsurances: entity.invoicePaymentInsurances ? entity.invoicePaymentInsurances?.map((model: InvoicePaymentInsuranceModel) => new InvoicePaymentInsuranceModel(model).toJSON()) : [],
						patientPaymentInsurances: entity.patientPaymentInsurances ? entity.patientPaymentInsurances?.map((model: PatientPaymentInsuranceModel) => new PatientPaymentInsuranceModel(model).toJSON()) : [],
						patientVisitPatientPaymentInsurances: entity.patientVisitPatientPaymentInsurances ? entity.patientVisitPatientPaymentInsurances?.map((model: PatientVisitPatientPaymentInsuranceModel) => new PatientVisitPatientPaymentInsuranceModel(model).toJSON()) : [],
					},
			...
			map(result => {
				...
				return {
					targetModel: result.data.insuranceBenefitPlan as InsuranceBenefitPlanModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: InsuranceBenefitPlanModel[], queryParams?: QueryParams): Observable<PassableStateConfig<InsuranceBenefitPlanModel>> {
		...
		const successMessage = 'Created Multiple Insurance Benefit Plan entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($insuranceBenefitPlans: [InsuranceBenefitPlanInput!]!) {
						insuranceBenefitPlan: createAllInsuranceBenefitPlan(insuranceBenefitPlans: $insuranceBenefitPlans) {
							...InsuranceBenefitPlanProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					insuranceBenefitPlans: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.insuranceBenefitPlan as InsuranceBenefitPlanModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: InsuranceBenefitPlanModel, queryParams?: QueryParams): Observable<PassableStateConfig<InsuranceBenefitPlanModel>> {
		...
		const successMessage = 'Updated Insurance Benefit Plan entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($insuranceBenefitPlan: InsuranceBenefitPlanInput!, $persistRelations: Boolean) {
						insuranceBenefitPlan: updateInsuranceBenefitPlan(insuranceBenefitPlan: $insuranceBenefitPlan, persistRelations: $persistRelations) {
							...InsuranceBenefitPlanProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: InsuranceBenefitPlanModel[], queryParams?: QueryParams): Observable<PassableStateConfig<InsuranceBenefitPlanModel>> {
		...
		const successMessage = 'Update Multiple Insurance Benefit Plan entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($insuranceBenefitPlans: [InsuranceBenefitPlanInput!]!) {
						insuranceBenefitPlan: updateAllInsuranceBenefitPlan(insuranceBenefitPlans: $insuranceBenefitPlans) {
							...InsuranceBenefitPlanProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<InsuranceBenefitPlanModel>> {
		...
		const successMessage = 'Deleted Insurance Benefit Plan entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($insuranceBenefitPlanId: ID!) {
						insuranceBenefitPlanId: deleteInsuranceBenefitPlanById(insuranceBenefitPlanId: $insuranceBenefitPlanId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.insuranceBenefitPlanId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<InsuranceBenefitPlanModel>> {
		...
		const successMessage = 'Deleted selected Insurance Benefit Plan entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($insuranceBenefitPlanIds: [ID!]!){
						deleteInsuranceBenefitPlanExcludingIds(insuranceBenefitPlanIds: $insuranceBenefitPlanIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.insuranceBenefitPlanIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<InsuranceBenefitPlanModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($insuranceBenefitPlanIds: [ID!]!) {
						insuranceBenefitPlanIds: deleteAllInsuranceBenefitPlanByIds(insuranceBenefitPlanIds: $insuranceBenefitPlanIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<InsuranceBenefitPlanModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<InsuranceBenefitPlanModel>>(
			{
				query: gql`
					query GetAudits {
						audits: insuranceBenefitPlanAudits {
							entity {
								...InsuranceBenefitPlanProperties
							}
							timestamp
			...
			map(result => {
				let audits: InsuranceBenefitPlanModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new InsuranceBenefitPlanModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<InsuranceBenefitPlanModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<InsuranceBenefitPlanModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($insuranceBenefitPlanId: ID!) {
						audits: insuranceBenefitPlanAuditsByEntityId(insuranceBenefitPlanId: $insuranceBenefitPlanId) {
							entity {
								...InsuranceBenefitPlanProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<InsuranceBenefitPlanModel>> {
		const url = environment.API_URL + '/api/insurancebenefitplan/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<InsuranceBenefitPlanModel>> {
		const url = environment.API_URL + '/api/insurancebenefitplan/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<InsuranceBenefitPlanModel>> {
		let apiUrl = environment.API_URL + '/api/insurancebenefitplan/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<InsuranceBenefitPlanModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/insurancebenefitplan/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Insurance Benefit Plan entities')),
