...
import {VitalSignsModel} from '../../models/vitalSigns/vital_signs.model';
import {VitalSignsModelAudit} from '../../models/vitalSigns/vital_signs.model.state';
...
/**
 * Vital Signs service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class VitalSignsService extends AbstractHttpService<VitalSignsModel, VitalSignsModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the VitalSignsProperties classFragment here] off begin
			fragment VitalSignsProperties on VitalSigns {
				...VitalSignsBaseProperties
				time
				hr
				rr
				temprature
			...
			# % protected region % [Modify the VitalSignsProperties classFragment here] end
			${super.fragments('VitalSigns').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<VitalSignsModel>> {
		...
		return  this.apollo.query<PassableStateConfig<VitalSignsModel>>(
			{
				query: gql`
					query Count {
						totalCount: countVitalSignss
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<VitalSignsModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<VitalSignsModel>> {
		...
		return this.apollo.query<PassableStateConfig<VitalSignsModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						VitalSignsById: vitalSignsById(id: $id) {
							...VitalSignsProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.VitalSignsById as VitalSignsModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<VitalSignsModel>> {
		...
		return this.apollo.query<PassableStateConfig<VitalSignsModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						vitalSignss: vitalSignss(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...VitalSignsProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countVitalSignss(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.vitalSignss as VitalSignsModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<VitalSignsModel>> {
		...
		return this.apollo.query<PassableStateConfig<VitalSignsModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						vitalSignss: lastVitalSignss(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...VitalSignsProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: VitalSignsModel, queryParams?: QueryParams): Observable<PassableStateConfig<VitalSignsModel>> {
		...
		const successMessage = 'Created Vital Signs entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($vitalSigns: VitalSignsInput!, $persistRelations: Boolean) {
						vitalSigns: createVitalSigns(vitalSigns: $vitalSigns, persistRelations: $persistRelations) {
							...VitalSignsProperties,
				...
				variables: {
					vitalSigns: {
						...entity.toJSON(),
						newbornDetail: entity.newbornDetail ? new NewbornDetailModel(entity.newbornDetail).toJSON() : undefined,
					},
			...
			map(result => {
				...
				return {
					targetModel: result.data.vitalSigns as VitalSignsModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: VitalSignsModel[], queryParams?: QueryParams): Observable<PassableStateConfig<VitalSignsModel>> {
		...
		const successMessage = 'Created Multiple Vital Signs entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($vitalSignss: [VitalSignsInput!]!) {
						vitalSigns: createAllVitalSigns(vitalSignss: $vitalSignss) {
							...VitalSignsProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					vitalSignss: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.vitalSigns as VitalSignsModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: VitalSignsModel, queryParams?: QueryParams): Observable<PassableStateConfig<VitalSignsModel>> {
		...
		const successMessage = 'Updated Vital Signs entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($vitalSigns: VitalSignsInput!, $persistRelations: Boolean) {
						vitalSigns: updateVitalSigns(vitalSigns: $vitalSigns, persistRelations: $persistRelations) {
							...VitalSignsProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: VitalSignsModel[], queryParams?: QueryParams): Observable<PassableStateConfig<VitalSignsModel>> {
		...
		const successMessage = 'Update Multiple Vital Signs entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($vitalSignss: [VitalSignsInput!]!) {
						vitalSigns: updateAllVitalSigns(vitalSignss: $vitalSignss) {
							...VitalSignsProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<VitalSignsModel>> {
		...
		const successMessage = 'Deleted Vital Signs entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($vitalSignsId: ID!) {
						vitalSignsId: deleteVitalSignsById(vitalSignsId: $vitalSignsId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.vitalSignsId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<VitalSignsModel>> {
		...
		const successMessage = 'Deleted selected Vital Signs entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($vitalSignsIds: [ID!]!){
						deleteVitalSignsExcludingIds(vitalSignsIds: $vitalSignsIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.vitalSignsIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<VitalSignsModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($vitalSignsIds: [ID!]!) {
						vitalSignsIds: deleteAllVitalSignsByIds(vitalSignsIds: $vitalSignsIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<VitalSignsModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<VitalSignsModel>>(
			...
			map(result => {
				let audits: VitalSignsModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new VitalSignsModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<VitalSignsModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<VitalSignsModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($vitalSignsId: ID!) {
						audits: vitalSignsAuditsByEntityId(vitalSignsId: $vitalSignsId) {
							entity {
								...VitalSignsProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<VitalSignsModel>> {
		const url = environment.API_URL + '/api/vitalsigns/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<VitalSignsModel>> {
		const url = environment.API_URL + '/api/vitalsigns/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<VitalSignsModel>> {
		let apiUrl = environment.API_URL + '/api/vitalsigns/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<VitalSignsModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/vitalsigns/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Vital Signs entities')),
