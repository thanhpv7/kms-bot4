...
import {BpjsControlSpecialistModel} from '../../models/bpjsControlSpecialist/bpjs_control_specialist.model';
import {BpjsControlSpecialistModelAudit} from '../../models/bpjsControlSpecialist/bpjs_control_specialist.model.state';
...
/**
 * BPJS Control Specialist service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BpjsControlSpecialistService extends AbstractHttpService<BpjsControlSpecialistModel, BpjsControlSpecialistModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BpjsControlSpecialistProperties classFragment here] off begin
			fragment BpjsControlSpecialistProperties on BpjsControlSpecialist {
				...BpjsControlSpecialistBaseProperties
				specialistCode
				specialistName
				capacity
				totalControlPlanReferral
				percentage
			}
			# % protected region % [Modify the BpjsControlSpecialistProperties classFragment here] end
			${super.fragments('BpjsControlSpecialist').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BpjsControlSpecialistModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BpjsControlSpecialistModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBpjsControlSpecialists
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BpjsControlSpecialistModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsControlSpecialistModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsControlSpecialistModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BpjsControlSpecialistById: bpjsControlSpecialistById(id: $id) {
							...BpjsControlSpecialistProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BpjsControlSpecialistById as BpjsControlSpecialistModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsControlSpecialistModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsControlSpecialistModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						bpjsControlSpecialists: bpjsControlSpecialists(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BpjsControlSpecialistProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBpjsControlSpecialists(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.bpjsControlSpecialists as BpjsControlSpecialistModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsControlSpecialistModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsControlSpecialistModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						bpjsControlSpecialists: lastBpjsControlSpecialists(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BpjsControlSpecialistProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BpjsControlSpecialistModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsControlSpecialistModel>> {
		...
		const successMessage = 'Created BPJS Control Specialist entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($bpjsControlSpecialist: BpjsControlSpecialistInput!, $persistRelations: Boolean) {
						bpjsControlSpecialist: createBpjsControlSpecialist(bpjsControlSpecialist: $bpjsControlSpecialist, persistRelations: $persistRelations) {
							...BpjsControlSpecialistProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.bpjsControlSpecialist as BpjsControlSpecialistModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BpjsControlSpecialistModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsControlSpecialistModel>> {
		...
		const successMessage = 'Created Multiple BPJS Control Specialist entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($bpjsControlSpecialists: [BpjsControlSpecialistInput!]!) {
						bpjsControlSpecialist: createAllBpjsControlSpecialist(bpjsControlSpecialists: $bpjsControlSpecialists) {
							...BpjsControlSpecialistProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					bpjsControlSpecialists: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.bpjsControlSpecialist as BpjsControlSpecialistModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BpjsControlSpecialistModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsControlSpecialistModel>> {
		...
		const successMessage = 'Updated BPJS Control Specialist entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($bpjsControlSpecialist: BpjsControlSpecialistInput!, $persistRelations: Boolean) {
						bpjsControlSpecialist: updateBpjsControlSpecialist(bpjsControlSpecialist: $bpjsControlSpecialist, persistRelations: $persistRelations) {
							...BpjsControlSpecialistProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BpjsControlSpecialistModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsControlSpecialistModel>> {
		...
		const successMessage = 'Update Multiple BPJS Control Specialist entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($bpjsControlSpecialists: [BpjsControlSpecialistInput!]!) {
						bpjsControlSpecialist: updateAllBpjsControlSpecialist(bpjsControlSpecialists: $bpjsControlSpecialists) {
							...BpjsControlSpecialistProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BpjsControlSpecialistModel>> {
		...
		const successMessage = 'Deleted BPJS Control Specialist entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($bpjsControlSpecialistId: ID!) {
						bpjsControlSpecialistId: deleteBpjsControlSpecialistById(bpjsControlSpecialistId: $bpjsControlSpecialistId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.bpjsControlSpecialistId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsControlSpecialistModel>> {
		...
		const successMessage = 'Deleted selected BPJS Control Specialist entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($bpjsControlSpecialistIds: [ID!]!){
						deleteBpjsControlSpecialistExcludingIds(bpjsControlSpecialistIds: $bpjsControlSpecialistIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.bpjsControlSpecialistIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BpjsControlSpecialistModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($bpjsControlSpecialistIds: [ID!]!) {
						bpjsControlSpecialistIds: deleteAllBpjsControlSpecialistByIds(bpjsControlSpecialistIds: $bpjsControlSpecialistIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BpjsControlSpecialistModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsControlSpecialistModel>>(
			{
				query: gql`
					query GetAudits {
						audits: bpjsControlSpecialistAudits {
							entity {
								...BpjsControlSpecialistProperties
							}
							timestamp
			...
			map(result => {
				let audits: BpjsControlSpecialistModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BpjsControlSpecialistModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BpjsControlSpecialistModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsControlSpecialistModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($bpjsControlSpecialistId: ID!) {
						audits: bpjsControlSpecialistAuditsByEntityId(bpjsControlSpecialistId: $bpjsControlSpecialistId) {
							entity {
								...BpjsControlSpecialistProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BpjsControlSpecialistModel>> {
		const url = environment.API_URL + '/api/bpjscontrolspecialist/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BpjsControlSpecialistModel>> {
		const url = environment.API_URL + '/api/bpjscontrolspecialist/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsControlSpecialistModel>> {
		let apiUrl = environment.API_URL + '/api/bpjscontrolspecialist/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BpjsControlSpecialistModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/bpjscontrolspecialist/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' BPJS Control Specialist entities')),
