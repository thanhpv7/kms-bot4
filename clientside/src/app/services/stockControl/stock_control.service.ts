...
import {StockControlModel} from '../../models/stockControl/stock_control.model';
import {StockControlModelAudit} from '../../models/stockControl/stock_control.model.state';
...
/**
 * Stock Control service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class StockControlService extends AbstractHttpService<StockControlModel, StockControlModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the StockControlProperties classFragment here] off begin
			fragment StockControlProperties on StockControl {
				...StockControlBaseProperties
				onHandQty
				availableQty
				onReservedQty
				uoi
			...
			# % protected region % [Modify the StockControlProperties classFragment here] end
			${super.fragments('StockControl').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<StockControlModel>> {
		...
		return  this.apollo.query<PassableStateConfig<StockControlModel>>(
			{
				query: gql`
					query Count {
						totalCount: countStockControls
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<StockControlModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<StockControlModel>> {
		...
		return this.apollo.query<PassableStateConfig<StockControlModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						StockControlById: stockControlById(id: $id) {
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.StockControlById as StockControlModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<StockControlModel>> {
		...
		return this.apollo.query<PassableStateConfig<StockControlModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						stockControls: stockControls(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...StockControlProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countStockControls(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.stockControls as StockControlModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<StockControlModel>> {
		...
		return this.apollo.query<PassableStateConfig<StockControlModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						stockControls: lastStockControls(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...StockControlProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: StockControlModel, queryParams?: QueryParams): Observable<PassableStateConfig<StockControlModel>> {
		...
		const successMessage = 'Created Stock Control entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($stockControl: StockControlInput!, $persistRelations: Boolean) {
						stockControl: createStockControl(stockControl: $stockControl, persistRelations: $persistRelations) {
							...StockControlProperties,
				...
				variables: {
					stockControl: {
						...entity.toJSON(),
						location: entity.location ? new LocationModel(entity.location).toJSON() : undefined,
			...
			map(result => {
				...
				return {
					targetModel: result.data.stockControl as StockControlModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: StockControlModel[], queryParams?: QueryParams): Observable<PassableStateConfig<StockControlModel>> {
		...
		const successMessage = 'Created Multiple Stock Control entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($stockControls: [StockControlInput!]!) {
						stockControl: createAllStockControl(stockControls: $stockControls) {
							...StockControlProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					stockControls: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.stockControl as StockControlModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: StockControlModel, queryParams?: QueryParams): Observable<PassableStateConfig<StockControlModel>> {
		...
		const successMessage = 'Updated Stock Control entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($stockControl: StockControlInput!, $persistRelations: Boolean) {
						stockControl: updateStockControl(stockControl: $stockControl, persistRelations: $persistRelations) {
							...StockControlProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: StockControlModel[], queryParams?: QueryParams): Observable<PassableStateConfig<StockControlModel>> {
		...
		const successMessage = 'Update Multiple Stock Control entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($stockControls: [StockControlInput!]!) {
						stockControl: updateAllStockControl(stockControls: $stockControls) {
							...StockControlProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<StockControlModel>> {
		...
		const successMessage = 'Deleted Stock Control entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($stockControlId: ID!) {
						stockControlId: deleteStockControlById(stockControlId: $stockControlId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.stockControlId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<StockControlModel>> {
		...
		const successMessage = 'Deleted selected Stock Control entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($stockControlIds: [ID!]!){
						deleteStockControlExcludingIds(stockControlIds: $stockControlIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.stockControlIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<StockControlModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($stockControlIds: [ID!]!) {
						stockControlIds: deleteAllStockControlByIds(stockControlIds: $stockControlIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<StockControlModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<StockControlModel>>(
			...
			map(result => {
				let audits: StockControlModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new StockControlModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<StockControlModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<StockControlModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($stockControlId: ID!) {
						audits: stockControlAuditsByEntityId(stockControlId: $stockControlId) {
							entity {
								...StockControlProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<StockControlModel>> {
		const url = environment.API_URL + '/api/stockcontrol/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<StockControlModel>> {
		const url = environment.API_URL + '/api/stockcontrol/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<StockControlModel>> {
		let apiUrl = environment.API_URL + '/api/stockcontrol/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<StockControlModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/stockcontrol/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Stock Control entities')),
