...
import {TariffFormulaModelAudit} from '../../models/tariffFormula/tariff_formula.model.state';
...
/**
 * Tariff Formula service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class TariffFormulaService extends AbstractHttpService<TariffFormulaModel, TariffFormulaModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the TariffFormulaProperties classFragment here] off begin
			fragment TariffFormulaProperties on TariffFormula {
				...TariffFormulaBaseProperties
				tariffType
				classification
				multiplier
				rounding
			...
			# % protected region % [Modify the TariffFormulaProperties classFragment here] end
			${super.fragments('TariffFormula').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<TariffFormulaModel>> {
		...
		return  this.apollo.query<PassableStateConfig<TariffFormulaModel>>(
			{
				query: gql`
					query Count {
						totalCount: countTariffFormulas
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<TariffFormulaModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<TariffFormulaModel>> {
		...
		return this.apollo.query<PassableStateConfig<TariffFormulaModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						TariffFormulaById: tariffFormulaById(id: $id) {
							...TariffFormulaProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.TariffFormulaById as TariffFormulaModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<TariffFormulaModel>> {
		...
		return this.apollo.query<PassableStateConfig<TariffFormulaModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						tariffFormulas: tariffFormulas(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...TariffFormulaProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countTariffFormulas(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.tariffFormulas as TariffFormulaModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<TariffFormulaModel>> {
		...
		return this.apollo.query<PassableStateConfig<TariffFormulaModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						tariffFormulas: lastTariffFormulas(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...TariffFormulaProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: TariffFormulaModel, queryParams?: QueryParams): Observable<PassableStateConfig<TariffFormulaModel>> {
		...
		const successMessage = 'Created Tariff Formula entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($tariffFormula: TariffFormulaInput!, $persistRelations: Boolean) {
						tariffFormula: createTariffFormula(tariffFormula: $tariffFormula, persistRelations: $persistRelations) {
							...TariffFormulaProperties,
				...
				variables: {
					tariffFormula: {
						...entity.toJSON(),
						baseSchema: entity.baseSchema ? new TariffSchemaModel(entity.baseSchema).toJSON() : undefined,
			...
			map(result => {
				...
				return {
					targetModel: result.data.tariffFormula as TariffFormulaModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: TariffFormulaModel[], queryParams?: QueryParams): Observable<PassableStateConfig<TariffFormulaModel>> {
		...
		const successMessage = 'Created Multiple Tariff Formula entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($tariffFormulas: [TariffFormulaInput!]!) {
						tariffFormula: createAllTariffFormula(tariffFormulas: $tariffFormulas) {
							...TariffFormulaProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					tariffFormulas: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.tariffFormula as TariffFormulaModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: TariffFormulaModel, queryParams?: QueryParams): Observable<PassableStateConfig<TariffFormulaModel>> {
		...
		const successMessage = 'Updated Tariff Formula entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($tariffFormula: TariffFormulaInput!, $persistRelations: Boolean) {
						tariffFormula: updateTariffFormula(tariffFormula: $tariffFormula, persistRelations: $persistRelations) {
							...TariffFormulaProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: TariffFormulaModel[], queryParams?: QueryParams): Observable<PassableStateConfig<TariffFormulaModel>> {
		...
		const successMessage = 'Update Multiple Tariff Formula entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($tariffFormulas: [TariffFormulaInput!]!) {
						tariffFormula: updateAllTariffFormula(tariffFormulas: $tariffFormulas) {
							...TariffFormulaProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<TariffFormulaModel>> {
		...
		const successMessage = 'Deleted Tariff Formula entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($tariffFormulaId: ID!) {
						tariffFormulaId: deleteTariffFormulaById(tariffFormulaId: $tariffFormulaId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.tariffFormulaId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<TariffFormulaModel>> {
		...
		const successMessage = 'Deleted selected Tariff Formula entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($tariffFormulaIds: [ID!]!){
						deleteTariffFormulaExcludingIds(tariffFormulaIds: $tariffFormulaIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.tariffFormulaIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<TariffFormulaModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($tariffFormulaIds: [ID!]!) {
						tariffFormulaIds: deleteAllTariffFormulaByIds(tariffFormulaIds: $tariffFormulaIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<TariffFormulaModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<TariffFormulaModel>>(
			...
			map(result => {
				let audits: TariffFormulaModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new TariffFormulaModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<TariffFormulaModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<TariffFormulaModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($tariffFormulaId: ID!) {
						audits: tariffFormulaAuditsByEntityId(tariffFormulaId: $tariffFormulaId) {
							entity {
								...TariffFormulaProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<TariffFormulaModel>> {
		const url = environment.API_URL + '/api/tariffformula/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<TariffFormulaModel>> {
		const url = environment.API_URL + '/api/tariffformula/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<TariffFormulaModel>> {
		let apiUrl = environment.API_URL + '/api/tariffformula/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<TariffFormulaModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/tariffformula/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Tariff Formula entities')),
