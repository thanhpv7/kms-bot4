...
import {CompoundPrescriptionDetailModel} from '../../models/compoundPrescriptionDetail/compound_prescription_detail.model';
import {CompoundPrescriptionDetailModelAudit} from '../../models/compoundPrescriptionDetail/compound_prescription_detail.model.state';
...
/**
 * Compound Prescription Detail service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class CompoundPrescriptionDetailService extends AbstractHttpService<CompoundPrescriptionDetailModel, CompoundPrescriptionDetailModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the CompoundPrescriptionDetailProperties classFragment here] off begin
			fragment CompoundPrescriptionDetailProperties on CompoundPrescriptionDetail {
				...CompoundPrescriptionDetailBaseProperties
				compoundCode
				compoundName
				requestQuantity
				dosageTimes
			...
			# % protected region % [Modify the CompoundPrescriptionDetailProperties classFragment here] end
			${super.fragments('CompoundPrescriptionDetail').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<CompoundPrescriptionDetailModel>> {
		...
		return  this.apollo.query<PassableStateConfig<CompoundPrescriptionDetailModel>>(
			{
				query: gql`
					query Count {
						totalCount: countCompoundPrescriptionDetails
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<CompoundPrescriptionDetailModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<CompoundPrescriptionDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<CompoundPrescriptionDetailModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						CompoundPrescriptionDetailById: compoundPrescriptionDetailById(id: $id) {
							...CompoundPrescriptionDetailProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.CompoundPrescriptionDetailById as CompoundPrescriptionDetailModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<CompoundPrescriptionDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<CompoundPrescriptionDetailModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						compoundPrescriptionDetails: compoundPrescriptionDetails(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...CompoundPrescriptionDetailProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countCompoundPrescriptionDetails(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.compoundPrescriptionDetails as CompoundPrescriptionDetailModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<CompoundPrescriptionDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<CompoundPrescriptionDetailModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						compoundPrescriptionDetails: lastCompoundPrescriptionDetails(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...CompoundPrescriptionDetailProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: CompoundPrescriptionDetailModel, queryParams?: QueryParams): Observable<PassableStateConfig<CompoundPrescriptionDetailModel>> {
		...
		const successMessage = 'Created Compound Prescription Detail entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($compoundPrescriptionDetail: CompoundPrescriptionDetailInput!, $persistRelations: Boolean) {
						compoundPrescriptionDetail: createCompoundPrescriptionDetail(compoundPrescriptionDetail: $compoundPrescriptionDetail, persistRelations: $persistRelations) {
							...CompoundPrescriptionDetailProperties,
				...
				variables: {
					compoundPrescriptionDetail: {
						...entity.toJSON(),
						consumptionUnit: entity.consumptionUnit ? new UnitOfMeasurementModel(entity.consumptionUnit).toJSON() : undefined,
			...
			map(result => {
				...
				return {
					targetModel: result.data.compoundPrescriptionDetail as CompoundPrescriptionDetailModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: CompoundPrescriptionDetailModel[], queryParams?: QueryParams): Observable<PassableStateConfig<CompoundPrescriptionDetailModel>> {
		...
		const successMessage = 'Created Multiple Compound Prescription Detail entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($compoundPrescriptionDetails: [CompoundPrescriptionDetailInput!]!) {
						compoundPrescriptionDetail: createAllCompoundPrescriptionDetail(compoundPrescriptionDetails: $compoundPrescriptionDetails) {
							...CompoundPrescriptionDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					compoundPrescriptionDetails: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.compoundPrescriptionDetail as CompoundPrescriptionDetailModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: CompoundPrescriptionDetailModel, queryParams?: QueryParams): Observable<PassableStateConfig<CompoundPrescriptionDetailModel>> {
		...
		const successMessage = 'Updated Compound Prescription Detail entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($compoundPrescriptionDetail: CompoundPrescriptionDetailInput!, $persistRelations: Boolean) {
						compoundPrescriptionDetail: updateCompoundPrescriptionDetail(compoundPrescriptionDetail: $compoundPrescriptionDetail, persistRelations: $persistRelations) {
							...CompoundPrescriptionDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: CompoundPrescriptionDetailModel[], queryParams?: QueryParams): Observable<PassableStateConfig<CompoundPrescriptionDetailModel>> {
		...
		const successMessage = 'Update Multiple Compound Prescription Detail entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($compoundPrescriptionDetails: [CompoundPrescriptionDetailInput!]!) {
						compoundPrescriptionDetail: updateAllCompoundPrescriptionDetail(compoundPrescriptionDetails: $compoundPrescriptionDetails) {
							...CompoundPrescriptionDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<CompoundPrescriptionDetailModel>> {
		...
		const successMessage = 'Deleted Compound Prescription Detail entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($compoundPrescriptionDetailId: ID!) {
						compoundPrescriptionDetailId: deleteCompoundPrescriptionDetailById(compoundPrescriptionDetailId: $compoundPrescriptionDetailId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.compoundPrescriptionDetailId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<CompoundPrescriptionDetailModel>> {
		...
		const successMessage = 'Deleted selected Compound Prescription Detail entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($compoundPrescriptionDetailIds: [ID!]!){
						deleteCompoundPrescriptionDetailExcludingIds(compoundPrescriptionDetailIds: $compoundPrescriptionDetailIds)
				...
				`,
				variables: {
					compoundPrescriptionDetailIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.compoundPrescriptionDetailIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<CompoundPrescriptionDetailModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($compoundPrescriptionDetailIds: [ID!]!) {
						compoundPrescriptionDetailIds: deleteAllCompoundPrescriptionDetailByIds(compoundPrescriptionDetailIds: $compoundPrescriptionDetailIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<CompoundPrescriptionDetailModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<CompoundPrescriptionDetailModel>>(
			{
				query: gql`
					query GetAudits {
						audits: compoundPrescriptionDetailAudits {
							entity {
								...CompoundPrescriptionDetailProperties
							}
							timestamp
			...
			map(result => {
				let audits: CompoundPrescriptionDetailModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new CompoundPrescriptionDetailModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<CompoundPrescriptionDetailModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<CompoundPrescriptionDetailModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($compoundPrescriptionDetailId: ID!) {
						audits: compoundPrescriptionDetailAuditsByEntityId(compoundPrescriptionDetailId: $compoundPrescriptionDetailId) {
							entity {
								...CompoundPrescriptionDetailProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<CompoundPrescriptionDetailModel>> {
		const url = environment.API_URL + '/api/compoundprescriptiondetail/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<CompoundPrescriptionDetailModel>> {
		const url = environment.API_URL + '/api/compoundprescriptiondetail/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<CompoundPrescriptionDetailModel>> {
		let apiUrl = environment.API_URL + '/api/compoundprescriptiondetail/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<CompoundPrescriptionDetailModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/compoundprescriptiondetail/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Compound Prescription Detail entities')),
