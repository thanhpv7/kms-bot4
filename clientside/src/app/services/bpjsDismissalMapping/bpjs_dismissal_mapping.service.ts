...
import {BpjsDismissalMappingModel} from '../../models/bpjsDismissalMapping/bpjs_dismissal_mapping.model';
import {BpjsDismissalMappingModelAudit} from '../../models/bpjsDismissalMapping/bpjs_dismissal_mapping.model.state';
...
/**
 * BPJS Dismissal Mapping service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BpjsDismissalMappingService extends AbstractHttpService<BpjsDismissalMappingModel, BpjsDismissalMappingModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BpjsDismissalMappingProperties classFragment here] off begin
			fragment BpjsDismissalMappingProperties on BpjsDismissalMapping {
				...BpjsDismissalMappingBaseProperties
				refCode
				refName
				internalDismissal
			}
			# % protected region % [Modify the BpjsDismissalMappingProperties classFragment here] end
			${super.fragments('BpjsDismissalMapping').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BpjsDismissalMappingModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BpjsDismissalMappingModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBpjsDismissalMappings
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BpjsDismissalMappingModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsDismissalMappingModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsDismissalMappingModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BpjsDismissalMappingById: bpjsDismissalMappingById(id: $id) {
							...BpjsDismissalMappingProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BpjsDismissalMappingById as BpjsDismissalMappingModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsDismissalMappingModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsDismissalMappingModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						bpjsDismissalMappings: bpjsDismissalMappings(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BpjsDismissalMappingProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBpjsDismissalMappings(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.bpjsDismissalMappings as BpjsDismissalMappingModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsDismissalMappingModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsDismissalMappingModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						bpjsDismissalMappings: lastBpjsDismissalMappings(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BpjsDismissalMappingProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BpjsDismissalMappingModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsDismissalMappingModel>> {
		...
		const successMessage = 'Created BPJS Dismissal Mapping entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($bpjsDismissalMapping: BpjsDismissalMappingInput!, $persistRelations: Boolean) {
						bpjsDismissalMapping: createBpjsDismissalMapping(bpjsDismissalMapping: $bpjsDismissalMapping, persistRelations: $persistRelations) {
							...BpjsDismissalMappingProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.bpjsDismissalMapping as BpjsDismissalMappingModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BpjsDismissalMappingModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsDismissalMappingModel>> {
		...
		const successMessage = 'Created Multiple BPJS Dismissal Mapping entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($bpjsDismissalMappings: [BpjsDismissalMappingInput!]!) {
						bpjsDismissalMapping: createAllBpjsDismissalMapping(bpjsDismissalMappings: $bpjsDismissalMappings) {
							...BpjsDismissalMappingProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					bpjsDismissalMappings: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.bpjsDismissalMapping as BpjsDismissalMappingModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BpjsDismissalMappingModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsDismissalMappingModel>> {
		...
		const successMessage = 'Updated BPJS Dismissal Mapping entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($bpjsDismissalMapping: BpjsDismissalMappingInput!, $persistRelations: Boolean) {
						bpjsDismissalMapping: updateBpjsDismissalMapping(bpjsDismissalMapping: $bpjsDismissalMapping, persistRelations: $persistRelations) {
							...BpjsDismissalMappingProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BpjsDismissalMappingModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsDismissalMappingModel>> {
		...
		const successMessage = 'Update Multiple BPJS Dismissal Mapping entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($bpjsDismissalMappings: [BpjsDismissalMappingInput!]!) {
						bpjsDismissalMapping: updateAllBpjsDismissalMapping(bpjsDismissalMappings: $bpjsDismissalMappings) {
							...BpjsDismissalMappingProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BpjsDismissalMappingModel>> {
		...
		const successMessage = 'Deleted BPJS Dismissal Mapping entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($bpjsDismissalMappingId: ID!) {
						bpjsDismissalMappingId: deleteBpjsDismissalMappingById(bpjsDismissalMappingId: $bpjsDismissalMappingId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.bpjsDismissalMappingId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsDismissalMappingModel>> {
		...
		const successMessage = 'Deleted selected BPJS Dismissal Mapping entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($bpjsDismissalMappingIds: [ID!]!){
						deleteBpjsDismissalMappingExcludingIds(bpjsDismissalMappingIds: $bpjsDismissalMappingIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.bpjsDismissalMappingIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BpjsDismissalMappingModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($bpjsDismissalMappingIds: [ID!]!) {
						bpjsDismissalMappingIds: deleteAllBpjsDismissalMappingByIds(bpjsDismissalMappingIds: $bpjsDismissalMappingIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BpjsDismissalMappingModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsDismissalMappingModel>>(
			{
				query: gql`
					query GetAudits {
						audits: bpjsDismissalMappingAudits {
							entity {
								...BpjsDismissalMappingProperties
							}
							timestamp
			...
			map(result => {
				let audits: BpjsDismissalMappingModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BpjsDismissalMappingModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BpjsDismissalMappingModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsDismissalMappingModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($bpjsDismissalMappingId: ID!) {
						audits: bpjsDismissalMappingAuditsByEntityId(bpjsDismissalMappingId: $bpjsDismissalMappingId) {
							entity {
								...BpjsDismissalMappingProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BpjsDismissalMappingModel>> {
		const url = environment.API_URL + '/api/bpjsdismissalmapping/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BpjsDismissalMappingModel>> {
		const url = environment.API_URL + '/api/bpjsdismissalmapping/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsDismissalMappingModel>> {
		let apiUrl = environment.API_URL + '/api/bpjsdismissalmapping/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BpjsDismissalMappingModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/bpjsdismissalmapping/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' BPJS Dismissal Mapping entities')),
