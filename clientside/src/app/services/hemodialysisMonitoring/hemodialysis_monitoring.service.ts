...
import {HemodialysisMonitoringModel} from '../../models/hemodialysisMonitoring/hemodialysis_monitoring.model';
import {HemodialysisMonitoringModelAudit} from '../../models/hemodialysisMonitoring/hemodialysis_monitoring.model.state';
...
/**
 * Hemodialysis Monitoring service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class HemodialysisMonitoringService extends AbstractHttpService<HemodialysisMonitoringModel, HemodialysisMonitoringModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the HemodialysisMonitoringProperties classFragment here] off begin
			fragment HemodialysisMonitoringProperties on HemodialysisMonitoring {
				...HemodialysisMonitoringBaseProperties
				datetime
				systole
				diastole
				heartRate
			...
			# % protected region % [Modify the HemodialysisMonitoringProperties classFragment here] end
			${super.fragments('HemodialysisMonitoring').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<HemodialysisMonitoringModel>> {
		...
		return  this.apollo.query<PassableStateConfig<HemodialysisMonitoringModel>>(
			{
				query: gql`
					query Count {
						totalCount: countHemodialysisMonitorings
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<HemodialysisMonitoringModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<HemodialysisMonitoringModel>> {
		...
		return this.apollo.query<PassableStateConfig<HemodialysisMonitoringModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						HemodialysisMonitoringById: hemodialysisMonitoringById(id: $id) {
							...HemodialysisMonitoringProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.HemodialysisMonitoringById as HemodialysisMonitoringModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<HemodialysisMonitoringModel>> {
		...
		return this.apollo.query<PassableStateConfig<HemodialysisMonitoringModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						hemodialysisMonitorings: hemodialysisMonitorings(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...HemodialysisMonitoringProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countHemodialysisMonitorings(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.hemodialysisMonitorings as HemodialysisMonitoringModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<HemodialysisMonitoringModel>> {
		...
		return this.apollo.query<PassableStateConfig<HemodialysisMonitoringModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						hemodialysisMonitorings: lastHemodialysisMonitorings(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...HemodialysisMonitoringProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: HemodialysisMonitoringModel, queryParams?: QueryParams): Observable<PassableStateConfig<HemodialysisMonitoringModel>> {
		...
		const successMessage = 'Created Hemodialysis Monitoring entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($hemodialysisMonitoring: HemodialysisMonitoringInput!, $persistRelations: Boolean) {
						hemodialysisMonitoring: createHemodialysisMonitoring(hemodialysisMonitoring: $hemodialysisMonitoring, persistRelations: $persistRelations) {
							...HemodialysisMonitoringProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.hemodialysisMonitoring as HemodialysisMonitoringModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: HemodialysisMonitoringModel[], queryParams?: QueryParams): Observable<PassableStateConfig<HemodialysisMonitoringModel>> {
		...
		const successMessage = 'Created Multiple Hemodialysis Monitoring entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($hemodialysisMonitorings: [HemodialysisMonitoringInput!]!) {
						hemodialysisMonitoring: createAllHemodialysisMonitoring(hemodialysisMonitorings: $hemodialysisMonitorings) {
							...HemodialysisMonitoringProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					hemodialysisMonitorings: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.hemodialysisMonitoring as HemodialysisMonitoringModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: HemodialysisMonitoringModel, queryParams?: QueryParams): Observable<PassableStateConfig<HemodialysisMonitoringModel>> {
		...
		const successMessage = 'Updated Hemodialysis Monitoring entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($hemodialysisMonitoring: HemodialysisMonitoringInput!, $persistRelations: Boolean) {
						hemodialysisMonitoring: updateHemodialysisMonitoring(hemodialysisMonitoring: $hemodialysisMonitoring, persistRelations: $persistRelations) {
							...HemodialysisMonitoringProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: HemodialysisMonitoringModel[], queryParams?: QueryParams): Observable<PassableStateConfig<HemodialysisMonitoringModel>> {
		...
		const successMessage = 'Update Multiple Hemodialysis Monitoring entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($hemodialysisMonitorings: [HemodialysisMonitoringInput!]!) {
						hemodialysisMonitoring: updateAllHemodialysisMonitoring(hemodialysisMonitorings: $hemodialysisMonitorings) {
							...HemodialysisMonitoringProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<HemodialysisMonitoringModel>> {
		...
		const successMessage = 'Deleted Hemodialysis Monitoring entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($hemodialysisMonitoringId: ID!) {
						hemodialysisMonitoringId: deleteHemodialysisMonitoringById(hemodialysisMonitoringId: $hemodialysisMonitoringId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.hemodialysisMonitoringId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<HemodialysisMonitoringModel>> {
		...
		const successMessage = 'Deleted selected Hemodialysis Monitoring entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($hemodialysisMonitoringIds: [ID!]!){
						deleteHemodialysisMonitoringExcludingIds(hemodialysisMonitoringIds: $hemodialysisMonitoringIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.hemodialysisMonitoringIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<HemodialysisMonitoringModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($hemodialysisMonitoringIds: [ID!]!) {
						hemodialysisMonitoringIds: deleteAllHemodialysisMonitoringByIds(hemodialysisMonitoringIds: $hemodialysisMonitoringIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<HemodialysisMonitoringModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<HemodialysisMonitoringModel>>(
			{
				query: gql`
					query GetAudits {
						audits: hemodialysisMonitoringAudits {
							entity {
								...HemodialysisMonitoringProperties
							}
							timestamp
			...
			map(result => {
				let audits: HemodialysisMonitoringModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new HemodialysisMonitoringModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<HemodialysisMonitoringModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<HemodialysisMonitoringModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($hemodialysisMonitoringId: ID!) {
						audits: hemodialysisMonitoringAuditsByEntityId(hemodialysisMonitoringId: $hemodialysisMonitoringId) {
							entity {
								...HemodialysisMonitoringProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<HemodialysisMonitoringModel>> {
		const url = environment.API_URL + '/api/hemodialysismonitoring/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<HemodialysisMonitoringModel>> {
		const url = environment.API_URL + '/api/hemodialysismonitoring/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<HemodialysisMonitoringModel>> {
		let apiUrl = environment.API_URL + '/api/hemodialysismonitoring/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<HemodialysisMonitoringModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/hemodialysismonitoring/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Hemodialysis Monitoring entities')),
