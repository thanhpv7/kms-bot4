...
import {NhisMedicineModel} from '../../models/nhisMedicine/nhis_medicine.model';
import {NhisMedicineModelAudit} from '../../models/nhisMedicine/nhis_medicine.model.state';
...
/**
 * NHIS Medicine service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class NhisMedicineService extends AbstractHttpService<NhisMedicineModel, NhisMedicineModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the NhisMedicineProperties classFragment here] off begin
			fragment NhisMedicineProperties on NhisMedicine {
				...NhisMedicineBaseProperties
				medicineCode
				medicineName
				dose
				uoi
			...
			# % protected region % [Modify the NhisMedicineProperties classFragment here] end
			${super.fragments('NhisMedicine').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<NhisMedicineModel>> {
		...
		return  this.apollo.query<PassableStateConfig<NhisMedicineModel>>(
			{
				query: gql`
					query Count {
						totalCount: countNhisMedicines
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<NhisMedicineModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<NhisMedicineModel>> {
		...
		return this.apollo.query<PassableStateConfig<NhisMedicineModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						NhisMedicineById: nhisMedicineById(id: $id) {
							...NhisMedicineProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.NhisMedicineById as NhisMedicineModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<NhisMedicineModel>> {
		...
		return this.apollo.query<PassableStateConfig<NhisMedicineModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						nhisMedicines: nhisMedicines(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...NhisMedicineProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countNhisMedicines(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.nhisMedicines as NhisMedicineModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<NhisMedicineModel>> {
		...
		return this.apollo.query<PassableStateConfig<NhisMedicineModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						nhisMedicines: lastNhisMedicines(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...NhisMedicineProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: NhisMedicineModel, queryParams?: QueryParams): Observable<PassableStateConfig<NhisMedicineModel>> {
		...
		const successMessage = 'Created NHIS Medicine entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($nhisMedicine: NhisMedicineInput!, $persistRelations: Boolean) {
						nhisMedicine: createNhisMedicine(nhisMedicine: $nhisMedicine, persistRelations: $persistRelations) {
							...NhisMedicineProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.nhisMedicine as NhisMedicineModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: NhisMedicineModel[], queryParams?: QueryParams): Observable<PassableStateConfig<NhisMedicineModel>> {
		...
		const successMessage = 'Created Multiple NHIS Medicine entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($nhisMedicines: [NhisMedicineInput!]!) {
						nhisMedicine: createAllNhisMedicine(nhisMedicines: $nhisMedicines) {
							...NhisMedicineProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					nhisMedicines: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.nhisMedicine as NhisMedicineModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: NhisMedicineModel, queryParams?: QueryParams): Observable<PassableStateConfig<NhisMedicineModel>> {
		...
		const successMessage = 'Updated NHIS Medicine entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($nhisMedicine: NhisMedicineInput!, $persistRelations: Boolean) {
						nhisMedicine: updateNhisMedicine(nhisMedicine: $nhisMedicine, persistRelations: $persistRelations) {
							...NhisMedicineProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: NhisMedicineModel[], queryParams?: QueryParams): Observable<PassableStateConfig<NhisMedicineModel>> {
		...
		const successMessage = 'Update Multiple NHIS Medicine entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($nhisMedicines: [NhisMedicineInput!]!) {
						nhisMedicine: updateAllNhisMedicine(nhisMedicines: $nhisMedicines) {
							...NhisMedicineProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<NhisMedicineModel>> {
		...
		const successMessage = 'Deleted NHIS Medicine entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($nhisMedicineId: ID!) {
						nhisMedicineId: deleteNhisMedicineById(nhisMedicineId: $nhisMedicineId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.nhisMedicineId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<NhisMedicineModel>> {
		...
		const successMessage = 'Deleted selected NHIS Medicine entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($nhisMedicineIds: [ID!]!){
						deleteNhisMedicineExcludingIds(nhisMedicineIds: $nhisMedicineIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.nhisMedicineIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<NhisMedicineModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($nhisMedicineIds: [ID!]!) {
						nhisMedicineIds: deleteAllNhisMedicineByIds(nhisMedicineIds: $nhisMedicineIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<NhisMedicineModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<NhisMedicineModel>>(
			...
			map(result => {
				let audits: NhisMedicineModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new NhisMedicineModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<NhisMedicineModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<NhisMedicineModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($nhisMedicineId: ID!) {
						audits: nhisMedicineAuditsByEntityId(nhisMedicineId: $nhisMedicineId) {
							entity {
								...NhisMedicineProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<NhisMedicineModel>> {
		const url = environment.API_URL + '/api/nhismedicine/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<NhisMedicineModel>> {
		const url = environment.API_URL + '/api/nhismedicine/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<NhisMedicineModel>> {
		let apiUrl = environment.API_URL + '/api/nhismedicine/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<NhisMedicineModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/nhismedicine/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' NHIS Medicine entities')),
