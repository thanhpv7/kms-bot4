...
import {NhisGDRGModel} from '../../models/nhisGDRG/nhis_gdrg.model';
import {NhisGDRGModelAudit} from '../../models/nhisGDRG/nhis_gdrg.model.state';
...
/**
 * NHIS GDRG service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class NhisGDRGService extends AbstractHttpService<NhisGDRGModel, NhisGDRGModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the NhisGDRGProperties classFragment here] off begin
			fragment NhisGDRGProperties on NhisGDRG {
				...NhisGDRGBaseProperties
				coreGDRGCode
				description
				category
				levelOfHealthcare
			...
			# % protected region % [Modify the NhisGDRGProperties classFragment here] end
			${super.fragments('NhisGDRG').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<NhisGDRGModel>> {
		...
		return  this.apollo.query<PassableStateConfig<NhisGDRGModel>>(
			{
				query: gql`
					query Count {
						totalCount: countNhisGDRGs
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<NhisGDRGModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<NhisGDRGModel>> {
		...
		return this.apollo.query<PassableStateConfig<NhisGDRGModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						NhisGDRGById: nhisGDRGById(id: $id) {
							...NhisGDRGProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.NhisGDRGById as NhisGDRGModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<NhisGDRGModel>> {
		...
		return this.apollo.query<PassableStateConfig<NhisGDRGModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						nhisGDRGs: nhisGDRGs(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...NhisGDRGProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countNhisGDRGs(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.nhisGDRGs as NhisGDRGModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<NhisGDRGModel>> {
		...
		return this.apollo.query<PassableStateConfig<NhisGDRGModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						nhisGDRGs: lastNhisGDRGs(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...NhisGDRGProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: NhisGDRGModel, queryParams?: QueryParams): Observable<PassableStateConfig<NhisGDRGModel>> {
		...
		const successMessage = 'Created NHIS GDRG entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($nhisGDRG: NhisGDRGInput!, $persistRelations: Boolean) {
						nhisGDRG: createNhisGDRG(nhisGDRG: $nhisGDRG, persistRelations: $persistRelations) {
							...NhisGDRGProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.nhisGDRG as NhisGDRGModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: NhisGDRGModel[], queryParams?: QueryParams): Observable<PassableStateConfig<NhisGDRGModel>> {
		...
		const successMessage = 'Created Multiple NHIS GDRG entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($nhisGDRGs: [NhisGDRGInput!]!) {
						nhisGDRG: createAllNhisGDRG(nhisGDRGs: $nhisGDRGs) {
							...NhisGDRGProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					nhisGDRGs: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.nhisGDRG as NhisGDRGModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: NhisGDRGModel, queryParams?: QueryParams): Observable<PassableStateConfig<NhisGDRGModel>> {
		...
		const successMessage = 'Updated NHIS GDRG entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($nhisGDRG: NhisGDRGInput!, $persistRelations: Boolean) {
						nhisGDRG: updateNhisGDRG(nhisGDRG: $nhisGDRG, persistRelations: $persistRelations) {
							...NhisGDRGProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: NhisGDRGModel[], queryParams?: QueryParams): Observable<PassableStateConfig<NhisGDRGModel>> {
		...
		const successMessage = 'Update Multiple NHIS GDRG entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($nhisGDRGs: [NhisGDRGInput!]!) {
						nhisGDRG: updateAllNhisGDRG(nhisGDRGs: $nhisGDRGs) {
							...NhisGDRGProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<NhisGDRGModel>> {
		...
		const successMessage = 'Deleted NHIS GDRG entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($nhisGDRGId: ID!) {
						nhisGDRGId: deleteNhisGDRGById(nhisGDRGId: $nhisGDRGId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.nhisGDRGId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<NhisGDRGModel>> {
		...
		const successMessage = 'Deleted selected NHIS GDRG entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($nhisGDRGIds: [ID!]!){
						deleteNhisGDRGExcludingIds(nhisGDRGIds: $nhisGDRGIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.nhisGDRGIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<NhisGDRGModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($nhisGDRGIds: [ID!]!) {
						nhisGDRGIds: deleteAllNhisGDRGByIds(nhisGDRGIds: $nhisGDRGIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<NhisGDRGModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<NhisGDRGModel>>(
			...
			map(result => {
				let audits: NhisGDRGModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new NhisGDRGModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<NhisGDRGModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<NhisGDRGModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($nhisGDRGId: ID!) {
						audits: nhisGDRGAuditsByEntityId(nhisGDRGId: $nhisGDRGId) {
							entity {
								...NhisGDRGProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<NhisGDRGModel>> {
		const url = environment.API_URL + '/api/nhisgdrg/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<NhisGDRGModel>> {
		const url = environment.API_URL + '/api/nhisgdrg/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<NhisGDRGModel>> {
		let apiUrl = environment.API_URL + '/api/nhisgdrg/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<NhisGDRGModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/nhisgdrg/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' NHIS GDRG entities')),
