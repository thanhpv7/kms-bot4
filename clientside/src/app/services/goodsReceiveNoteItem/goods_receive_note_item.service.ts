...
import {GoodsReceiveNoteItemModelAudit} from '../../models/goodsReceiveNoteItem/goods_receive_note_item.model.state';
...
/**
 * Goods Receive Note Item service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class GoodsReceiveNoteItemService extends AbstractHttpService<GoodsReceiveNoteItemModel, GoodsReceiveNoteItemModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the GoodsReceiveNoteItemProperties classFragment here] off begin
			fragment GoodsReceiveNoteItemProperties on GoodsReceiveNoteItem {
				...GoodsReceiveNoteItemBaseProperties
				itemLineNumber
				uop
				qtyReceived
				qtyOrdered
			...
			# % protected region % [Modify the GoodsReceiveNoteItemProperties classFragment here] end
			${super.fragments('GoodsReceiveNoteItem').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<GoodsReceiveNoteItemModel>> {
		...
		return  this.apollo.query<PassableStateConfig<GoodsReceiveNoteItemModel>>(
			{
				query: gql`
					query Count {
						totalCount: countGoodsReceiveNoteItems
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<GoodsReceiveNoteItemModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<GoodsReceiveNoteItemModel>> {
		...
		return this.apollo.query<PassableStateConfig<GoodsReceiveNoteItemModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						GoodsReceiveNoteItemById: goodsReceiveNoteItemById(id: $id) {
							...GoodsReceiveNoteItemProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.GoodsReceiveNoteItemById as GoodsReceiveNoteItemModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<GoodsReceiveNoteItemModel>> {
		...
		return this.apollo.query<PassableStateConfig<GoodsReceiveNoteItemModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						goodsReceiveNoteItems: goodsReceiveNoteItems(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...GoodsReceiveNoteItemProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countGoodsReceiveNoteItems(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.goodsReceiveNoteItems as GoodsReceiveNoteItemModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<GoodsReceiveNoteItemModel>> {
		...
		return this.apollo.query<PassableStateConfig<GoodsReceiveNoteItemModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						goodsReceiveNoteItems: lastGoodsReceiveNoteItems(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...GoodsReceiveNoteItemProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: GoodsReceiveNoteItemModel, queryParams?: QueryParams): Observable<PassableStateConfig<GoodsReceiveNoteItemModel>> {
		...
		const successMessage = 'Created Goods Receive Note Item entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($goodsReceiveNoteItem: GoodsReceiveNoteItemInput!, $persistRelations: Boolean) {
						goodsReceiveNoteItem: createGoodsReceiveNoteItem(goodsReceiveNoteItem: $goodsReceiveNoteItem, persistRelations: $persistRelations) {
							...GoodsReceiveNoteItemProperties,
				...
				variables: {
					goodsReceiveNoteItem: {
						...entity.toJSON(),
						goodsReceiveNote: entity.goodsReceiveNote ? new GoodsReceiveNoteModel(entity.goodsReceiveNote).toJSON() : undefined,
						purchaseOrderStockDetail: entity.purchaseOrderStockDetail ? new PurchaseOrderStockDetailModel(entity.purchaseOrderStockDetail).toJSON() : undefined,
			...
			map(result => {
				...
				return {
					targetModel: result.data.goodsReceiveNoteItem as GoodsReceiveNoteItemModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: GoodsReceiveNoteItemModel[], queryParams?: QueryParams): Observable<PassableStateConfig<GoodsReceiveNoteItemModel>> {
		...
		const successMessage = 'Created Multiple Goods Receive Note Item entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($goodsReceiveNoteItems: [GoodsReceiveNoteItemInput!]!) {
						goodsReceiveNoteItem: createAllGoodsReceiveNoteItem(goodsReceiveNoteItems: $goodsReceiveNoteItems) {
							...GoodsReceiveNoteItemProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					goodsReceiveNoteItems: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.goodsReceiveNoteItem as GoodsReceiveNoteItemModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: GoodsReceiveNoteItemModel, queryParams?: QueryParams): Observable<PassableStateConfig<GoodsReceiveNoteItemModel>> {
		...
		const successMessage = 'Updated Goods Receive Note Item entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($goodsReceiveNoteItem: GoodsReceiveNoteItemInput!, $persistRelations: Boolean) {
						goodsReceiveNoteItem: updateGoodsReceiveNoteItem(goodsReceiveNoteItem: $goodsReceiveNoteItem, persistRelations: $persistRelations) {
							...GoodsReceiveNoteItemProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: GoodsReceiveNoteItemModel[], queryParams?: QueryParams): Observable<PassableStateConfig<GoodsReceiveNoteItemModel>> {
		...
		const successMessage = 'Update Multiple Goods Receive Note Item entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($goodsReceiveNoteItems: [GoodsReceiveNoteItemInput!]!) {
						goodsReceiveNoteItem: updateAllGoodsReceiveNoteItem(goodsReceiveNoteItems: $goodsReceiveNoteItems) {
							...GoodsReceiveNoteItemProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<GoodsReceiveNoteItemModel>> {
		...
		const successMessage = 'Deleted Goods Receive Note Item entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($goodsReceiveNoteItemId: ID!) {
						goodsReceiveNoteItemId: deleteGoodsReceiveNoteItemById(goodsReceiveNoteItemId: $goodsReceiveNoteItemId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.goodsReceiveNoteItemId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<GoodsReceiveNoteItemModel>> {
		...
		const successMessage = 'Deleted selected Goods Receive Note Item entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($goodsReceiveNoteItemIds: [ID!]!){
						deleteGoodsReceiveNoteItemExcludingIds(goodsReceiveNoteItemIds: $goodsReceiveNoteItemIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.goodsReceiveNoteItemIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<GoodsReceiveNoteItemModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($goodsReceiveNoteItemIds: [ID!]!) {
						goodsReceiveNoteItemIds: deleteAllGoodsReceiveNoteItemByIds(goodsReceiveNoteItemIds: $goodsReceiveNoteItemIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<GoodsReceiveNoteItemModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<GoodsReceiveNoteItemModel>>(
			{
				query: gql`
					query GetAudits {
						audits: goodsReceiveNoteItemAudits {
							entity {
								...GoodsReceiveNoteItemProperties
							}
							timestamp
			...
			map(result => {
				let audits: GoodsReceiveNoteItemModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new GoodsReceiveNoteItemModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<GoodsReceiveNoteItemModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<GoodsReceiveNoteItemModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($goodsReceiveNoteItemId: ID!) {
						audits: goodsReceiveNoteItemAuditsByEntityId(goodsReceiveNoteItemId: $goodsReceiveNoteItemId) {
							entity {
								...GoodsReceiveNoteItemProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<GoodsReceiveNoteItemModel>> {
		const url = environment.API_URL + '/api/goodsreceivenoteitem/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<GoodsReceiveNoteItemModel>> {
		const url = environment.API_URL + '/api/goodsreceivenoteitem/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<GoodsReceiveNoteItemModel>> {
		let apiUrl = environment.API_URL + '/api/goodsreceivenoteitem/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<GoodsReceiveNoteItemModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/goodsreceivenoteitem/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Goods Receive Note Item entities')),
