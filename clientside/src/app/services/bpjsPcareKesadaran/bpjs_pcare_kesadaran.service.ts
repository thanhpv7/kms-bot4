...
import {BpjsPcareKesadaranModel} from '../../models/bpjsPcareKesadaran/bpjs_pcare_kesadaran.model';
import {BpjsPcareKesadaranModelAudit} from '../../models/bpjsPcareKesadaran/bpjs_pcare_kesadaran.model.state';
...
/**
 * BPJS Pcare Kesadaran service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BpjsPcareKesadaranService extends AbstractHttpService<BpjsPcareKesadaranModel, BpjsPcareKesadaranModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BpjsPcareKesadaranProperties classFragment here] off begin
			fragment BpjsPcareKesadaranProperties on BpjsPcareKesadaran {
				...BpjsPcareKesadaranBaseProperties
				kdsadar
				nmsadar
				kesadaranInternal
			}
			# % protected region % [Modify the BpjsPcareKesadaranProperties classFragment here] end
			${super.fragments('BpjsPcareKesadaran').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BpjsPcareKesadaranModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BpjsPcareKesadaranModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBpjsPcareKesadarans
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BpjsPcareKesadaranModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPcareKesadaranModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPcareKesadaranModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BpjsPcareKesadaranById: bpjsPcareKesadaranById(id: $id) {
							...BpjsPcareKesadaranProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BpjsPcareKesadaranById as BpjsPcareKesadaranModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsPcareKesadaranModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPcareKesadaranModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						bpjsPcareKesadarans: bpjsPcareKesadarans(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BpjsPcareKesadaranProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBpjsPcareKesadarans(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.bpjsPcareKesadarans as BpjsPcareKesadaranModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsPcareKesadaranModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPcareKesadaranModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						bpjsPcareKesadarans: lastBpjsPcareKesadarans(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BpjsPcareKesadaranProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BpjsPcareKesadaranModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPcareKesadaranModel>> {
		...
		const successMessage = 'Created BPJS Pcare Kesadaran entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($bpjsPcareKesadaran: BpjsPcareKesadaranInput!, $persistRelations: Boolean) {
						bpjsPcareKesadaran: createBpjsPcareKesadaran(bpjsPcareKesadaran: $bpjsPcareKesadaran, persistRelations: $persistRelations) {
							...BpjsPcareKesadaranProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.bpjsPcareKesadaran as BpjsPcareKesadaranModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BpjsPcareKesadaranModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPcareKesadaranModel>> {
		...
		const successMessage = 'Created Multiple BPJS Pcare Kesadaran entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($bpjsPcareKesadarans: [BpjsPcareKesadaranInput!]!) {
						bpjsPcareKesadaran: createAllBpjsPcareKesadaran(bpjsPcareKesadarans: $bpjsPcareKesadarans) {
							...BpjsPcareKesadaranProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					bpjsPcareKesadarans: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.bpjsPcareKesadaran as BpjsPcareKesadaranModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BpjsPcareKesadaranModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPcareKesadaranModel>> {
		...
		const successMessage = 'Updated BPJS Pcare Kesadaran entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($bpjsPcareKesadaran: BpjsPcareKesadaranInput!, $persistRelations: Boolean) {
						bpjsPcareKesadaran: updateBpjsPcareKesadaran(bpjsPcareKesadaran: $bpjsPcareKesadaran, persistRelations: $persistRelations) {
							...BpjsPcareKesadaranProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BpjsPcareKesadaranModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPcareKesadaranModel>> {
		...
		const successMessage = 'Update Multiple BPJS Pcare Kesadaran entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($bpjsPcareKesadarans: [BpjsPcareKesadaranInput!]!) {
						bpjsPcareKesadaran: updateAllBpjsPcareKesadaran(bpjsPcareKesadarans: $bpjsPcareKesadarans) {
							...BpjsPcareKesadaranProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BpjsPcareKesadaranModel>> {
		...
		const successMessage = 'Deleted BPJS Pcare Kesadaran entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($bpjsPcareKesadaranId: ID!) {
						bpjsPcareKesadaranId: deleteBpjsPcareKesadaranById(bpjsPcareKesadaranId: $bpjsPcareKesadaranId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.bpjsPcareKesadaranId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsPcareKesadaranModel>> {
		...
		const successMessage = 'Deleted selected BPJS Pcare Kesadaran entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($bpjsPcareKesadaranIds: [ID!]!){
						deleteBpjsPcareKesadaranExcludingIds(bpjsPcareKesadaranIds: $bpjsPcareKesadaranIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.bpjsPcareKesadaranIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BpjsPcareKesadaranModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($bpjsPcareKesadaranIds: [ID!]!) {
						bpjsPcareKesadaranIds: deleteAllBpjsPcareKesadaranByIds(bpjsPcareKesadaranIds: $bpjsPcareKesadaranIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BpjsPcareKesadaranModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPcareKesadaranModel>>(
			{
				query: gql`
					query GetAudits {
						audits: bpjsPcareKesadaranAudits {
							entity {
								...BpjsPcareKesadaranProperties
							}
							timestamp
			...
			map(result => {
				let audits: BpjsPcareKesadaranModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BpjsPcareKesadaranModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BpjsPcareKesadaranModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPcareKesadaranModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($bpjsPcareKesadaranId: ID!) {
						audits: bpjsPcareKesadaranAuditsByEntityId(bpjsPcareKesadaranId: $bpjsPcareKesadaranId) {
							entity {
								...BpjsPcareKesadaranProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BpjsPcareKesadaranModel>> {
		const url = environment.API_URL + '/api/bpjspcarekesadaran/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BpjsPcareKesadaranModel>> {
		const url = environment.API_URL + '/api/bpjspcarekesadaran/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsPcareKesadaranModel>> {
		let apiUrl = environment.API_URL + '/api/bpjspcarekesadaran/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BpjsPcareKesadaranModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/bpjspcarekesadaran/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' BPJS Pcare Kesadaran entities')),
