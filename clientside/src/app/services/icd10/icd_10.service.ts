...
import {Icd10ModelAudit} from '../../models/icd10/icd_10.model.state';
...
/**
 * ICD 10 service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class Icd10Service extends AbstractHttpService<Icd10Model, Icd10ModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the Icd10Properties classFragment here] off begin
			fragment Icd10Properties on Icd10 {
				...Icd10BaseProperties
				classificationDisease
				classificationInfectious
				classificationChronic
				classificationTopDisease
				classificationRestrictedCase
				classificationReportableCase
				classificationAcute
				dismissalDate
			}
			# % protected region % [Modify the Icd10Properties classFragment here] end
			${super.fragments('Icd10').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<Icd10Model>> {
		...
		return  this.apollo.query<PassableStateConfig<Icd10Model>>(
			{
				query: gql`
					query Count {
						totalCount: countIcd10s
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<Icd10Model>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<Icd10Model>> {
		...
		return this.apollo.query<PassableStateConfig<Icd10Model>>(
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.Icd10ById as Icd10Model,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<Icd10Model>> {
		...
		return this.apollo.query<PassableStateConfig<Icd10Model>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						icd10s: icd10s(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...Icd10Properties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countIcd10s(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.icd10s as Icd10Model[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<Icd10Model>> {
		...
		return this.apollo.query<PassableStateConfig<Icd10Model>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						icd10s: lastIcd10s(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...Icd10Properties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: Icd10Model, queryParams?: QueryParams): Observable<PassableStateConfig<Icd10Model>> {
		...
		const successMessage = 'Created ICD 10 entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($icd10: Icd10Input!, $persistRelations: Boolean) {
						icd10: createIcd10(icd10: $icd10, persistRelations: $persistRelations) {
							...Icd10Properties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.icd10 as Icd10Model,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: Icd10Model[], queryParams?: QueryParams): Observable<PassableStateConfig<Icd10Model>> {
		...
		const successMessage = 'Created Multiple ICD 10 entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($icd10s: [Icd10Input!]!) {
						icd10: createAllIcd10(icd10s: $icd10s) {
							...Icd10Properties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					icd10s: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.icd10 as Icd10Model[],
	 ...
	 * @inheritDoc
	 */
	update(entity: Icd10Model, queryParams?: QueryParams): Observable<PassableStateConfig<Icd10Model>> {
		...
		const successMessage = 'Updated ICD 10 entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($icd10: Icd10Input!, $persistRelations: Boolean) {
						icd10: updateIcd10(icd10: $icd10, persistRelations: $persistRelations) {
							...Icd10Properties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: Icd10Model[], queryParams?: QueryParams): Observable<PassableStateConfig<Icd10Model>> {
		...
		const successMessage = 'Update Multiple ICD 10 entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($icd10s: [Icd10Input!]!) {
						icd10: updateAllIcd10(icd10s: $icd10s) {
							...Icd10Properties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<Icd10Model>> {
		...
		const successMessage = 'Deleted ICD 10 entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($icd10Id: ID!) {
						icd10Id: deleteIcd10ById(icd10Id: $icd10Id)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.icd10Id as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<Icd10Model>> {
		...
		const successMessage = 'Deleted selected ICD 10 entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($icd10Ids: [ID!]!){
						deleteIcd10ExcludingIds(icd10Ids: $icd10Ids)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.icd10Ids as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<Icd10Model>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($icd10Ids: [ID!]!) {
						icd10Ids: deleteAllIcd10ByIds(icd10Ids: $icd10Ids)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<Icd10ModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<Icd10Model>>(
			...
			map(result => {
				let audits: Icd10ModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new Icd10Model(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<Icd10ModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<Icd10Model>>(
			{
				query: gql`
					query GetAuditsByEntityId($icd10Id: ID!) {
						audits: icd10AuditsByEntityId(icd10Id: $icd10Id) {
							entity {
								...Icd10Properties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<Icd10Model>> {
		const url = environment.API_URL + '/api/icd10/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<Icd10Model>> {
		const url = environment.API_URL + '/api/icd10/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<Icd10Model>> {
		let apiUrl = environment.API_URL + '/api/icd10/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<Icd10Model>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/icd10/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' ICD 10 entities')),
