...
import {PurchaseRequisitionModel} from '../../models/purchaseRequisition/purchase_requisition.model';
import {PurchaseRequisitionModelAudit} from '../../models/purchaseRequisition/purchase_requisition.model.state';
...
/**
 * Purchase Requisition service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class PurchaseRequisitionService extends AbstractHttpService<PurchaseRequisitionModel, PurchaseRequisitionModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the PurchaseRequisitionProperties classFragment here] off begin
			fragment PurchaseRequisitionProperties on PurchaseRequisition {
				...PurchaseRequisitionBaseProperties
			...
			# % protected region % [Modify the PurchaseRequisitionProperties classFragment here] end
			${super.fragments('PurchaseRequisition').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<PurchaseRequisitionModel>> {
		...
		return  this.apollo.query<PassableStateConfig<PurchaseRequisitionModel>>(
			{
				query: gql`
					query Count {
						totalCount: countPurchaseRequisitions
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<PurchaseRequisitionModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<PurchaseRequisitionModel>> {
		...
		return this.apollo.query<PassableStateConfig<PurchaseRequisitionModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						PurchaseRequisitionById: purchaseRequisitionById(id: $id) {
							...PurchaseRequisitionProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.PurchaseRequisitionById as PurchaseRequisitionModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PurchaseRequisitionModel>> {
		...
		return this.apollo.query<PassableStateConfig<PurchaseRequisitionModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						purchaseRequisitions: purchaseRequisitions(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...PurchaseRequisitionProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countPurchaseRequisitions(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.purchaseRequisitions as PurchaseRequisitionModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PurchaseRequisitionModel>> {
		...
		return this.apollo.query<PassableStateConfig<PurchaseRequisitionModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						purchaseRequisitions: lastPurchaseRequisitions(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...PurchaseRequisitionProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: PurchaseRequisitionModel, queryParams?: QueryParams): Observable<PassableStateConfig<PurchaseRequisitionModel>> {
		...
		const successMessage = 'Created Purchase Requisition entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($purchaseRequisition: PurchaseRequisitionInput!, $persistRelations: Boolean) {
						purchaseRequisition: createPurchaseRequisition(purchaseRequisition: $purchaseRequisition, persistRelations: $persistRelations) {
							...PurchaseRequisitionProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.purchaseRequisition as PurchaseRequisitionModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: PurchaseRequisitionModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PurchaseRequisitionModel>> {
		...
		const successMessage = 'Created Multiple Purchase Requisition entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($purchaseRequisitions: [PurchaseRequisitionInput!]!) {
						purchaseRequisition: createAllPurchaseRequisition(purchaseRequisitions: $purchaseRequisitions) {
							...PurchaseRequisitionProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					purchaseRequisitions: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.purchaseRequisition as PurchaseRequisitionModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: PurchaseRequisitionModel, queryParams?: QueryParams): Observable<PassableStateConfig<PurchaseRequisitionModel>> {
		...
		const successMessage = 'Updated Purchase Requisition entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($purchaseRequisition: PurchaseRequisitionInput!, $persistRelations: Boolean) {
						purchaseRequisition: updatePurchaseRequisition(purchaseRequisition: $purchaseRequisition, persistRelations: $persistRelations) {
							...PurchaseRequisitionProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: PurchaseRequisitionModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PurchaseRequisitionModel>> {
		...
		const successMessage = 'Update Multiple Purchase Requisition entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($purchaseRequisitions: [PurchaseRequisitionInput!]!) {
						purchaseRequisition: updateAllPurchaseRequisition(purchaseRequisitions: $purchaseRequisitions) {
							...PurchaseRequisitionProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<PurchaseRequisitionModel>> {
		...
		const successMessage = 'Deleted Purchase Requisition entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($purchaseRequisitionId: ID!) {
						purchaseRequisitionId: deletePurchaseRequisitionById(purchaseRequisitionId: $purchaseRequisitionId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.purchaseRequisitionId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<PurchaseRequisitionModel>> {
		...
		const successMessage = 'Deleted selected Purchase Requisition entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($purchaseRequisitionIds: [ID!]!){
						deletePurchaseRequisitionExcludingIds(purchaseRequisitionIds: $purchaseRequisitionIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.purchaseRequisitionIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<PurchaseRequisitionModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($purchaseRequisitionIds: [ID!]!) {
						purchaseRequisitionIds: deleteAllPurchaseRequisitionByIds(purchaseRequisitionIds: $purchaseRequisitionIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<PurchaseRequisitionModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PurchaseRequisitionModel>>(
			{
				query: gql`
					query GetAudits {
						audits: purchaseRequisitionAudits {
							entity {
								...PurchaseRequisitionProperties
							}
							timestamp
			...
			map(result => {
				let audits: PurchaseRequisitionModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new PurchaseRequisitionModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<PurchaseRequisitionModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PurchaseRequisitionModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($purchaseRequisitionId: ID!) {
						audits: purchaseRequisitionAuditsByEntityId(purchaseRequisitionId: $purchaseRequisitionId) {
							entity {
								...PurchaseRequisitionProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<PurchaseRequisitionModel>> {
		const url = environment.API_URL + '/api/purchaserequisition/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<PurchaseRequisitionModel>> {
		const url = environment.API_URL + '/api/purchaserequisition/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<PurchaseRequisitionModel>> {
		let apiUrl = environment.API_URL + '/api/purchaserequisition/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<PurchaseRequisitionModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/purchaserequisition/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Purchase Requisition entities')),
