...
import {LocationModelAudit} from '../../models/location/location.model.state';
...
/**
 * Location service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class LocationService extends AbstractHttpService<LocationModel, LocationModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the LocationProperties classFragment here] off begin
			fragment LocationProperties on Location {
				...LocationBaseProperties
				locationName
				aisle
				shelf
				bin
			}
			# % protected region % [Modify the LocationProperties classFragment here] end
			${super.fragments('Location').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<LocationModel>> {
		...
		return  this.apollo.query<PassableStateConfig<LocationModel>>(
			{
				query: gql`
					query Count {
						totalCount: countLocations
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<LocationModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<LocationModel>> {
		...
		return this.apollo.query<PassableStateConfig<LocationModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						LocationById: locationById(id: $id) {
							...LocationProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.LocationById as LocationModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<LocationModel>> {
		...
		return this.apollo.query<PassableStateConfig<LocationModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						locations: locations(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...LocationProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countLocations(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.locations as LocationModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<LocationModel>> {
		...
		return this.apollo.query<PassableStateConfig<LocationModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						locations: lastLocations(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...LocationProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: LocationModel, queryParams?: QueryParams): Observable<PassableStateConfig<LocationModel>> {
		...
		const successMessage = 'Created Location entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($location: LocationInput!, $persistRelations: Boolean) {
						location: createLocation(location: $location, persistRelations: $persistRelations) {
							...LocationProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.location as LocationModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: LocationModel[], queryParams?: QueryParams): Observable<PassableStateConfig<LocationModel>> {
		...
		const successMessage = 'Created Multiple Location entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($locations: [LocationInput!]!) {
						location: createAllLocation(locations: $locations) {
							...LocationProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					locations: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.location as LocationModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: LocationModel, queryParams?: QueryParams): Observable<PassableStateConfig<LocationModel>> {
		...
		const successMessage = 'Updated Location entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($location: LocationInput!, $persistRelations: Boolean) {
						location: updateLocation(location: $location, persistRelations: $persistRelations) {
							...LocationProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: LocationModel[], queryParams?: QueryParams): Observable<PassableStateConfig<LocationModel>> {
		...
		const successMessage = 'Update Multiple Location entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($locations: [LocationInput!]!) {
						location: updateAllLocation(locations: $locations) {
							...LocationProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<LocationModel>> {
		...
		const successMessage = 'Deleted Location entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($locationId: ID!) {
						locationId: deleteLocationById(locationId: $locationId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.locationId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<LocationModel>> {
		...
		const successMessage = 'Deleted selected Location entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($locationIds: [ID!]!){
						deleteLocationExcludingIds(locationIds: $locationIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.locationIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<LocationModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($locationIds: [ID!]!) {
						locationIds: deleteAllLocationByIds(locationIds: $locationIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<LocationModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<LocationModel>>(
			...
			map(result => {
				let audits: LocationModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new LocationModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<LocationModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<LocationModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($locationId: ID!) {
						audits: locationAuditsByEntityId(locationId: $locationId) {
							entity {
								...LocationProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<LocationModel>> {
		const url = environment.API_URL + '/api/location/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<LocationModel>> {
		const url = environment.API_URL + '/api/location/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<LocationModel>> {
		let apiUrl = environment.API_URL + '/api/location/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<LocationModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/location/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Location entities')),
