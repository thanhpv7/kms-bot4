...
import {ReferenceDataModel} from '../../models/referenceData/reference_data.model';
import {ReferenceDataModelAudit} from '../../models/referenceData/reference_data.model.state';
...
/**
 * Reference Data service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class ReferenceDataService extends AbstractHttpService<ReferenceDataModel, ReferenceDataModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the ReferenceDataProperties classFragment here] off begin
			fragment ReferenceDataProperties on ReferenceData {
				...ReferenceDataBaseProperties
				referenceType
				code
				description
				associatedValues
			...
			# % protected region % [Modify the ReferenceDataProperties classFragment here] end
			${super.fragments('ReferenceData').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<ReferenceDataModel>> {
		...
		return  this.apollo.query<PassableStateConfig<ReferenceDataModel>>(
			{
				query: gql`
					query Count {
						totalCount: countReferenceDatas
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<ReferenceDataModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<ReferenceDataModel>> {
		...
		return this.apollo.query<PassableStateConfig<ReferenceDataModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						ReferenceDataById: referenceDataById(id: $id) {
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.ReferenceDataById as ReferenceDataModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<ReferenceDataModel>> {
		...
		return this.apollo.query<PassableStateConfig<ReferenceDataModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						referenceDatas: referenceDatas(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...ReferenceDataProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countReferenceDatas(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.referenceDatas as ReferenceDataModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<ReferenceDataModel>> {
		...
		return this.apollo.query<PassableStateConfig<ReferenceDataModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						referenceDatas: lastReferenceDatas(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...ReferenceDataProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: ReferenceDataModel, queryParams?: QueryParams): Observable<PassableStateConfig<ReferenceDataModel>> {
		...
		const successMessage = 'Created Reference Data entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($referenceData: ReferenceDataInput!, $persistRelations: Boolean) {
						referenceData: createReferenceData(referenceData: $referenceData, persistRelations: $persistRelations) {
							...ReferenceDataProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.referenceData as ReferenceDataModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: ReferenceDataModel[], queryParams?: QueryParams): Observable<PassableStateConfig<ReferenceDataModel>> {
		...
		const successMessage = 'Created Multiple Reference Data entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($referenceDatas: [ReferenceDataInput!]!) {
						referenceData: createAllReferenceData(referenceDatas: $referenceDatas) {
							...ReferenceDataProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					referenceDatas: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.referenceData as ReferenceDataModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: ReferenceDataModel, queryParams?: QueryParams): Observable<PassableStateConfig<ReferenceDataModel>> {
		...
		const successMessage = 'Updated Reference Data entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($referenceData: ReferenceDataInput!, $persistRelations: Boolean) {
						referenceData: updateReferenceData(referenceData: $referenceData, persistRelations: $persistRelations) {
							...ReferenceDataProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: ReferenceDataModel[], queryParams?: QueryParams): Observable<PassableStateConfig<ReferenceDataModel>> {
		...
		const successMessage = 'Update Multiple Reference Data entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($referenceDatas: [ReferenceDataInput!]!) {
						referenceData: updateAllReferenceData(referenceDatas: $referenceDatas) {
							...ReferenceDataProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<ReferenceDataModel>> {
		...
		const successMessage = 'Deleted Reference Data entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($referenceDataId: ID!) {
						referenceDataId: deleteReferenceDataById(referenceDataId: $referenceDataId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.referenceDataId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<ReferenceDataModel>> {
		...
		const successMessage = 'Deleted selected Reference Data entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($referenceDataIds: [ID!]!){
						deleteReferenceDataExcludingIds(referenceDataIds: $referenceDataIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.referenceDataIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<ReferenceDataModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($referenceDataIds: [ID!]!) {
						referenceDataIds: deleteAllReferenceDataByIds(referenceDataIds: $referenceDataIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<ReferenceDataModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<ReferenceDataModel>>(
			...
			map(result => {
				let audits: ReferenceDataModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new ReferenceDataModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<ReferenceDataModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<ReferenceDataModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($referenceDataId: ID!) {
						audits: referenceDataAuditsByEntityId(referenceDataId: $referenceDataId) {
							entity {
								...ReferenceDataProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<ReferenceDataModel>> {
		const url = environment.API_URL + '/api/referencedata/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<ReferenceDataModel>> {
		const url = environment.API_URL + '/api/referencedata/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<ReferenceDataModel>> {
		let apiUrl = environment.API_URL + '/api/referencedata/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<ReferenceDataModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/referencedata/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Reference Data entities')),
