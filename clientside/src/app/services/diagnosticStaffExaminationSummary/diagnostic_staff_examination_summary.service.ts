...
import {DiagnosticStaffExaminationSummaryModel} from '../../models/diagnosticStaffExaminationSummary/diagnostic_staff_examination_summary.model';
import {DiagnosticStaffExaminationSummaryModelAudit} from '../../models/diagnosticStaffExaminationSummary/diagnostic_staff_examination_summary.model.state';
...
/**
 * Diagnostic Staff Examination Summary service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class DiagnosticStaffExaminationSummaryService extends AbstractHttpService<DiagnosticStaffExaminationSummaryModel, DiagnosticStaffExaminationSummaryModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the DiagnosticStaffExaminationSummaryProperties classFragment here] off begin
			fragment DiagnosticStaffExaminationSummaryProperties on DiagnosticStaffExaminationSummary {
				...DiagnosticStaffExaminationSummaryBaseProperties
				responsibleDoctor
				medicalTranscriber
				referringRoom
				referingUnit
			...
			# % protected region % [Modify the DiagnosticStaffExaminationSummaryProperties classFragment here] end
			${super.fragments('DiagnosticStaffExaminationSummary').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<DiagnosticStaffExaminationSummaryModel>> {
		...
		return  this.apollo.query<PassableStateConfig<DiagnosticStaffExaminationSummaryModel>>(
			{
				query: gql`
					query Count {
						totalCount: countDiagnosticStaffExaminationSummarys
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<DiagnosticStaffExaminationSummaryModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<DiagnosticStaffExaminationSummaryModel>> {
		...
		return this.apollo.query<PassableStateConfig<DiagnosticStaffExaminationSummaryModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						DiagnosticStaffExaminationSummaryById: diagnosticStaffExaminationSummaryById(id: $id) {
							...DiagnosticStaffExaminationSummaryProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.DiagnosticStaffExaminationSummaryById as DiagnosticStaffExaminationSummaryModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<DiagnosticStaffExaminationSummaryModel>> {
		...
		return this.apollo.query<PassableStateConfig<DiagnosticStaffExaminationSummaryModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						diagnosticStaffExaminationSummarys: diagnosticStaffExaminationSummarys(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...DiagnosticStaffExaminationSummaryProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countDiagnosticStaffExaminationSummarys(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.diagnosticStaffExaminationSummarys as DiagnosticStaffExaminationSummaryModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<DiagnosticStaffExaminationSummaryModel>> {
		...
		return this.apollo.query<PassableStateConfig<DiagnosticStaffExaminationSummaryModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						diagnosticStaffExaminationSummarys: lastDiagnosticStaffExaminationSummarys(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...DiagnosticStaffExaminationSummaryProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: DiagnosticStaffExaminationSummaryModel, queryParams?: QueryParams): Observable<PassableStateConfig<DiagnosticStaffExaminationSummaryModel>> {
		...
		const successMessage = 'Created Diagnostic Staff Examination Summary entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($diagnosticStaffExaminationSummary: DiagnosticStaffExaminationSummaryInput!, $persistRelations: Boolean) {
						diagnosticStaffExaminationSummary: createDiagnosticStaffExaminationSummary(diagnosticStaffExaminationSummary: $diagnosticStaffExaminationSummary, persistRelations: $persistRelations) {
							...DiagnosticStaffExaminationSummaryProperties,
				...
				variables: {
					diagnosticStaffExaminationSummary: {
						...entity.toJSON(),
						diagnosisExaminationRecord: entity.diagnosisExaminationRecord ? new DiagnosisExaminationRecordModel(entity.diagnosisExaminationRecord).toJSON() : undefined,
			...
			map(result => {
				...
				return {
					targetModel: result.data.diagnosticStaffExaminationSummary as DiagnosticStaffExaminationSummaryModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: DiagnosticStaffExaminationSummaryModel[], queryParams?: QueryParams): Observable<PassableStateConfig<DiagnosticStaffExaminationSummaryModel>> {
		...
		const successMessage = 'Created Multiple Diagnostic Staff Examination Summary entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($diagnosticStaffExaminationSummarys: [DiagnosticStaffExaminationSummaryInput!]!) {
						diagnosticStaffExaminationSummary: createAllDiagnosticStaffExaminationSummary(diagnosticStaffExaminationSummarys: $diagnosticStaffExaminationSummarys) {
							...DiagnosticStaffExaminationSummaryProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					diagnosticStaffExaminationSummarys: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.diagnosticStaffExaminationSummary as DiagnosticStaffExaminationSummaryModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: DiagnosticStaffExaminationSummaryModel, queryParams?: QueryParams): Observable<PassableStateConfig<DiagnosticStaffExaminationSummaryModel>> {
		...
		const successMessage = 'Updated Diagnostic Staff Examination Summary entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($diagnosticStaffExaminationSummary: DiagnosticStaffExaminationSummaryInput!, $persistRelations: Boolean) {
						diagnosticStaffExaminationSummary: updateDiagnosticStaffExaminationSummary(diagnosticStaffExaminationSummary: $diagnosticStaffExaminationSummary, persistRelations: $persistRelations) {
							...DiagnosticStaffExaminationSummaryProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: DiagnosticStaffExaminationSummaryModel[], queryParams?: QueryParams): Observable<PassableStateConfig<DiagnosticStaffExaminationSummaryModel>> {
		...
		const successMessage = 'Update Multiple Diagnostic Staff Examination Summary entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($diagnosticStaffExaminationSummarys: [DiagnosticStaffExaminationSummaryInput!]!) {
						diagnosticStaffExaminationSummary: updateAllDiagnosticStaffExaminationSummary(diagnosticStaffExaminationSummarys: $diagnosticStaffExaminationSummarys) {
							...DiagnosticStaffExaminationSummaryProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<DiagnosticStaffExaminationSummaryModel>> {
		...
		const successMessage = 'Deleted Diagnostic Staff Examination Summary entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($diagnosticStaffExaminationSummaryId: ID!) {
						diagnosticStaffExaminationSummaryId: deleteDiagnosticStaffExaminationSummaryById(diagnosticStaffExaminationSummaryId: $diagnosticStaffExaminationSummaryId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.diagnosticStaffExaminationSummaryId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<DiagnosticStaffExaminationSummaryModel>> {
		...
		const successMessage = 'Deleted selected Diagnostic Staff Examination Summary entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($diagnosticStaffExaminationSummaryIds: [ID!]!){
						deleteDiagnosticStaffExaminationSummaryExcludingIds(diagnosticStaffExaminationSummaryIds: $diagnosticStaffExaminationSummaryIds)
				...
				`,
				variables: {
					diagnosticStaffExaminationSummaryIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.diagnosticStaffExaminationSummaryIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<DiagnosticStaffExaminationSummaryModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($diagnosticStaffExaminationSummaryIds: [ID!]!) {
						diagnosticStaffExaminationSummaryIds: deleteAllDiagnosticStaffExaminationSummaryByIds(diagnosticStaffExaminationSummaryIds: $diagnosticStaffExaminationSummaryIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<DiagnosticStaffExaminationSummaryModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<DiagnosticStaffExaminationSummaryModel>>(
			{
				query: gql`
					query GetAudits {
						audits: diagnosticStaffExaminationSummaryAudits {
							entity {
								...DiagnosticStaffExaminationSummaryProperties
							}
							timestamp
			...
			map(result => {
				let audits: DiagnosticStaffExaminationSummaryModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new DiagnosticStaffExaminationSummaryModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<DiagnosticStaffExaminationSummaryModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<DiagnosticStaffExaminationSummaryModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($diagnosticStaffExaminationSummaryId: ID!) {
						audits: diagnosticStaffExaminationSummaryAuditsByEntityId(diagnosticStaffExaminationSummaryId: $diagnosticStaffExaminationSummaryId) {
							entity {
								...DiagnosticStaffExaminationSummaryProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<DiagnosticStaffExaminationSummaryModel>> {
		const url = environment.API_URL + '/api/diagnosticstaffexaminationsummary/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<DiagnosticStaffExaminationSummaryModel>> {
		const url = environment.API_URL + '/api/diagnosticstaffexaminationsummary/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<DiagnosticStaffExaminationSummaryModel>> {
		let apiUrl = environment.API_URL + '/api/diagnosticstaffexaminationsummary/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<DiagnosticStaffExaminationSummaryModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/diagnosticstaffexaminationsummary/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Diagnostic Staff Examination Summary entities')),
