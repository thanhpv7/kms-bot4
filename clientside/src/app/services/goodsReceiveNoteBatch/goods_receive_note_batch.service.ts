...
import {GoodsReceiveNoteBatchModel} from '../../models/goodsReceiveNoteBatch/goods_receive_note_batch.model';
import {GoodsReceiveNoteBatchModelAudit} from '../../models/goodsReceiveNoteBatch/goods_receive_note_batch.model.state';
...
/**
 * Goods Receive Note Batch service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class GoodsReceiveNoteBatchService extends AbstractHttpService<GoodsReceiveNoteBatchModel, GoodsReceiveNoteBatchModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the GoodsReceiveNoteBatchProperties classFragment here] off begin
			fragment GoodsReceiveNoteBatchProperties on GoodsReceiveNoteBatch {
				...GoodsReceiveNoteBatchBaseProperties
				itemLineNumber
				transactionNumber
				transactionDate
				batchNumber
			...
			# % protected region % [Modify the GoodsReceiveNoteBatchProperties classFragment here] end
			${super.fragments('GoodsReceiveNoteBatch').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<GoodsReceiveNoteBatchModel>> {
		...
		return  this.apollo.query<PassableStateConfig<GoodsReceiveNoteBatchModel>>(
			{
				query: gql`
					query Count {
						totalCount: countGoodsReceiveNoteBatchs
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<GoodsReceiveNoteBatchModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<GoodsReceiveNoteBatchModel>> {
		...
		return this.apollo.query<PassableStateConfig<GoodsReceiveNoteBatchModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						GoodsReceiveNoteBatchById: goodsReceiveNoteBatchById(id: $id) {
							...GoodsReceiveNoteBatchProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.GoodsReceiveNoteBatchById as GoodsReceiveNoteBatchModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<GoodsReceiveNoteBatchModel>> {
		...
		return this.apollo.query<PassableStateConfig<GoodsReceiveNoteBatchModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						goodsReceiveNoteBatchs: goodsReceiveNoteBatchs(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...GoodsReceiveNoteBatchProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countGoodsReceiveNoteBatchs(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.goodsReceiveNoteBatchs as GoodsReceiveNoteBatchModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<GoodsReceiveNoteBatchModel>> {
		...
		return this.apollo.query<PassableStateConfig<GoodsReceiveNoteBatchModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						goodsReceiveNoteBatchs: lastGoodsReceiveNoteBatchs(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...GoodsReceiveNoteBatchProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: GoodsReceiveNoteBatchModel, queryParams?: QueryParams): Observable<PassableStateConfig<GoodsReceiveNoteBatchModel>> {
		...
		const successMessage = 'Created Goods Receive Note Batch entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($goodsReceiveNoteBatch: GoodsReceiveNoteBatchInput!, $persistRelations: Boolean) {
						goodsReceiveNoteBatch: createGoodsReceiveNoteBatch(goodsReceiveNoteBatch: $goodsReceiveNoteBatch, persistRelations: $persistRelations) {
							...GoodsReceiveNoteBatchProperties,
				...
				`,
				variables: {
					goodsReceiveNoteBatch: {
						...entity.toJSON(),
						goodsReceiveNoteItem: entity.goodsReceiveNoteItem ? new GoodsReceiveNoteItemModel(entity.goodsReceiveNoteItem).toJSON() : undefined,
			...
			map(result => {
				...
				return {
					targetModel: result.data.goodsReceiveNoteBatch as GoodsReceiveNoteBatchModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: GoodsReceiveNoteBatchModel[], queryParams?: QueryParams): Observable<PassableStateConfig<GoodsReceiveNoteBatchModel>> {
		...
		const successMessage = 'Created Multiple Goods Receive Note Batch entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($goodsReceiveNoteBatchs: [GoodsReceiveNoteBatchInput!]!) {
						goodsReceiveNoteBatch: createAllGoodsReceiveNoteBatch(goodsReceiveNoteBatchs: $goodsReceiveNoteBatchs) {
							...GoodsReceiveNoteBatchProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					goodsReceiveNoteBatchs: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.goodsReceiveNoteBatch as GoodsReceiveNoteBatchModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: GoodsReceiveNoteBatchModel, queryParams?: QueryParams): Observable<PassableStateConfig<GoodsReceiveNoteBatchModel>> {
		...
		const successMessage = 'Updated Goods Receive Note Batch entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($goodsReceiveNoteBatch: GoodsReceiveNoteBatchInput!, $persistRelations: Boolean) {
						goodsReceiveNoteBatch: updateGoodsReceiveNoteBatch(goodsReceiveNoteBatch: $goodsReceiveNoteBatch, persistRelations: $persistRelations) {
							...GoodsReceiveNoteBatchProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: GoodsReceiveNoteBatchModel[], queryParams?: QueryParams): Observable<PassableStateConfig<GoodsReceiveNoteBatchModel>> {
		...
		const successMessage = 'Update Multiple Goods Receive Note Batch entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($goodsReceiveNoteBatchs: [GoodsReceiveNoteBatchInput!]!) {
						goodsReceiveNoteBatch: updateAllGoodsReceiveNoteBatch(goodsReceiveNoteBatchs: $goodsReceiveNoteBatchs) {
							...GoodsReceiveNoteBatchProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<GoodsReceiveNoteBatchModel>> {
		...
		const successMessage = 'Deleted Goods Receive Note Batch entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($goodsReceiveNoteBatchId: ID!) {
						goodsReceiveNoteBatchId: deleteGoodsReceiveNoteBatchById(goodsReceiveNoteBatchId: $goodsReceiveNoteBatchId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.goodsReceiveNoteBatchId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<GoodsReceiveNoteBatchModel>> {
		...
		const successMessage = 'Deleted selected Goods Receive Note Batch entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($goodsReceiveNoteBatchIds: [ID!]!){
						deleteGoodsReceiveNoteBatchExcludingIds(goodsReceiveNoteBatchIds: $goodsReceiveNoteBatchIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.goodsReceiveNoteBatchIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<GoodsReceiveNoteBatchModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($goodsReceiveNoteBatchIds: [ID!]!) {
						goodsReceiveNoteBatchIds: deleteAllGoodsReceiveNoteBatchByIds(goodsReceiveNoteBatchIds: $goodsReceiveNoteBatchIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<GoodsReceiveNoteBatchModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<GoodsReceiveNoteBatchModel>>(
			{
				query: gql`
					query GetAudits {
						audits: goodsReceiveNoteBatchAudits {
							entity {
								...GoodsReceiveNoteBatchProperties
							}
							timestamp
			...
			map(result => {
				let audits: GoodsReceiveNoteBatchModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new GoodsReceiveNoteBatchModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<GoodsReceiveNoteBatchModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<GoodsReceiveNoteBatchModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($goodsReceiveNoteBatchId: ID!) {
						audits: goodsReceiveNoteBatchAuditsByEntityId(goodsReceiveNoteBatchId: $goodsReceiveNoteBatchId) {
							entity {
								...GoodsReceiveNoteBatchProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<GoodsReceiveNoteBatchModel>> {
		const url = environment.API_URL + '/api/goodsreceivenotebatch/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<GoodsReceiveNoteBatchModel>> {
		const url = environment.API_URL + '/api/goodsreceivenotebatch/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<GoodsReceiveNoteBatchModel>> {
		let apiUrl = environment.API_URL + '/api/goodsreceivenotebatch/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<GoodsReceiveNoteBatchModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/goodsreceivenotebatch/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Goods Receive Note Batch entities')),
