...
import {ManagementUserModel} from '../../models/managementUser/management_user.model';
import {ManagementUserModelAudit} from '../../models/managementUser/management_user.model.state';
...
/**
 * Management User service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class ManagementUserService extends UserService<ManagementUserModel, ManagementUserModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the ManagementUserProperties classFragment here] off begin
			fragment ManagementUserProperties on ManagementUser {
				...ManagementUserUserProperties
			}
			# % protected region % [Modify the ManagementUserProperties classFragment here] end
			${super.fragments('ManagementUser').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<ManagementUserModel>> {
		...
		return  this.apollo.query<PassableStateConfig<ManagementUserModel>>(
			{
				query: gql`
					query Count {
						totalCount: countManagementUsers
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<ManagementUserModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<ManagementUserModel>> {
		...
		return this.apollo.query<PassableStateConfig<ManagementUserModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						ManagementUserById: managementUserById(id: $id) {
							...ManagementUserProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.ManagementUserById as ManagementUserModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<ManagementUserModel>> {
		...
		return this.apollo.query<PassableStateConfig<ManagementUserModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						managementUsers: managementUsers(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...ManagementUserProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countManagementUsers(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.managementUsers as ManagementUserModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<ManagementUserModel>> {
		...
		return this.apollo.query<PassableStateConfig<ManagementUserModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						managementUsers: lastManagementUsers(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...ManagementUserProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: ManagementUserModel, queryParams?: QueryParams): Observable<PassableStateConfig<ManagementUserModel>> {
		...
		const successMessage = 'Created Management User entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($managementUser: ManagementUserInput!, $persistRelations: Boolean) {
						managementUser: createManagementUser(managementUser: $managementUser, persistRelations: $persistRelations) {
							...ManagementUserProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.managementUser as ManagementUserModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: ManagementUserModel[], queryParams?: QueryParams): Observable<PassableStateConfig<ManagementUserModel>> {
		...
		const successMessage = 'Created Multiple Management User entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($managementUsers: [ManagementUserInput!]!) {
						managementUser: createAllManagementUser(managementUsers: $managementUsers) {
							...ManagementUserProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					managementUsers: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.managementUser as ManagementUserModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: ManagementUserModel, queryParams?: QueryParams): Observable<PassableStateConfig<ManagementUserModel>> {
		...
		const successMessage = 'Updated Management User entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($managementUser: ManagementUserInput!, $persistRelations: Boolean) {
						managementUser: updateManagementUser(managementUser: $managementUser, persistRelations: $persistRelations) {
							...ManagementUserProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: ManagementUserModel[], queryParams?: QueryParams): Observable<PassableStateConfig<ManagementUserModel>> {
		...
		const successMessage = 'Update Multiple Management User entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($managementUsers: [ManagementUserInput!]!) {
						managementUser: updateAllManagementUser(managementUsers: $managementUsers) {
							...ManagementUserProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<ManagementUserModel>> {
		...
		const successMessage = 'Deleted Management User entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($managementUserId: ID!) {
						managementUserId: deleteManagementUserById(managementUserId: $managementUserId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.managementUserId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<ManagementUserModel>> {
		...
		const successMessage = 'Deleted selected Management User entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($managementUserIds: [ID!]!){
						deleteManagementUserExcludingIds(managementUserIds: $managementUserIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.managementUserIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<ManagementUserModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($managementUserIds: [ID!]!) {
						managementUserIds: deleteAllManagementUserByIds(managementUserIds: $managementUserIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<ManagementUserModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<ManagementUserModel>>(
			...
			map(result => {
				let audits: ManagementUserModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new ManagementUserModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<ManagementUserModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<ManagementUserModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($managementUserId: ID!) {
						audits: managementUserAuditsByEntityId(managementUserId: $managementUserId) {
							entity {
								...ManagementUserProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<ManagementUserModel>> {
		const url = environment.API_URL + '/api/managementuser/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<ManagementUserModel>> {
		const url = environment.API_URL + '/api/managementuser/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<ManagementUserModel>> {
		let apiUrl = environment.API_URL + '/api/managementuser/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<ManagementUserModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/managementuser/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Management User entities')),
