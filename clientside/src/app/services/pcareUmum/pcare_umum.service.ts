...
import {PcareUmumModel} from '../../models/pcareUmum/pcare_umum.model';
import {PcareUmumModelAudit} from '../../models/pcareUmum/pcare_umum.model.state';
...
/**
 * PCare Umum service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class PcareUmumService extends AbstractHttpService<PcareUmumModel, PcareUmumModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the PcareUmumProperties classFragment here] off begin
			fragment PcareUmumProperties on PcareUmum {
				...PcareUmumBaseProperties
				consID
				secretKey
				webServiceURL
				authUsername
			...
			# % protected region % [Modify the PcareUmumProperties classFragment here] end
			${super.fragments('PcareUmum').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<PcareUmumModel>> {
		...
		return  this.apollo.query<PassableStateConfig<PcareUmumModel>>(
			{
				query: gql`
					query Count {
						totalCount: countPcareUmums
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<PcareUmumModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<PcareUmumModel>> {
		...
		return this.apollo.query<PassableStateConfig<PcareUmumModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						PcareUmumById: pcareUmumById(id: $id) {
							...PcareUmumProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.PcareUmumById as PcareUmumModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PcareUmumModel>> {
		...
		return this.apollo.query<PassableStateConfig<PcareUmumModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						pcareUmums: pcareUmums(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...PcareUmumProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countPcareUmums(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.pcareUmums as PcareUmumModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PcareUmumModel>> {
		...
		return this.apollo.query<PassableStateConfig<PcareUmumModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						pcareUmums: lastPcareUmums(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...PcareUmumProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: PcareUmumModel, queryParams?: QueryParams): Observable<PassableStateConfig<PcareUmumModel>> {
		...
		const successMessage = 'Created PCare Umum entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($pcareUmum: PcareUmumInput!, $persistRelations: Boolean) {
						pcareUmum: createPcareUmum(pcareUmum: $pcareUmum, persistRelations: $persistRelations) {
							...PcareUmumProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.pcareUmum as PcareUmumModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: PcareUmumModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PcareUmumModel>> {
		...
		const successMessage = 'Created Multiple PCare Umum entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($pcareUmums: [PcareUmumInput!]!) {
						pcareUmum: createAllPcareUmum(pcareUmums: $pcareUmums) {
							...PcareUmumProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					pcareUmums: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.pcareUmum as PcareUmumModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: PcareUmumModel, queryParams?: QueryParams): Observable<PassableStateConfig<PcareUmumModel>> {
		...
		const successMessage = 'Updated PCare Umum entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($pcareUmum: PcareUmumInput!, $persistRelations: Boolean) {
						pcareUmum: updatePcareUmum(pcareUmum: $pcareUmum, persistRelations: $persistRelations) {
							...PcareUmumProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: PcareUmumModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PcareUmumModel>> {
		...
		const successMessage = 'Update Multiple PCare Umum entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($pcareUmums: [PcareUmumInput!]!) {
						pcareUmum: updateAllPcareUmum(pcareUmums: $pcareUmums) {
							...PcareUmumProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<PcareUmumModel>> {
		...
		const successMessage = 'Deleted PCare Umum entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($pcareUmumId: ID!) {
						pcareUmumId: deletePcareUmumById(pcareUmumId: $pcareUmumId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.pcareUmumId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<PcareUmumModel>> {
		...
		const successMessage = 'Deleted selected PCare Umum entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($pcareUmumIds: [ID!]!){
						deletePcareUmumExcludingIds(pcareUmumIds: $pcareUmumIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.pcareUmumIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<PcareUmumModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($pcareUmumIds: [ID!]!) {
						pcareUmumIds: deleteAllPcareUmumByIds(pcareUmumIds: $pcareUmumIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<PcareUmumModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PcareUmumModel>>(
			...
			map(result => {
				let audits: PcareUmumModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new PcareUmumModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<PcareUmumModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PcareUmumModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($pcareUmumId: ID!) {
						audits: pcareUmumAuditsByEntityId(pcareUmumId: $pcareUmumId) {
							entity {
								...PcareUmumProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<PcareUmumModel>> {
		const url = environment.API_URL + '/api/pcareumum/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<PcareUmumModel>> {
		const url = environment.API_URL + '/api/pcareumum/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<PcareUmumModel>> {
		let apiUrl = environment.API_URL + '/api/pcareumum/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<PcareUmumModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/pcareumum/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' PCare Umum entities')),
