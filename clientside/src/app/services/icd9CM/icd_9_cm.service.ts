...
import {Icd9CMModelAudit} from '../../models/icd9CM/icd_9_cm.model.state';
...
/**
 * ICD 9 CM service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class Icd9CMService extends AbstractHttpService<Icd9CMModel, Icd9CMModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the Icd9CMProperties classFragment here] off begin
			fragment Icd9CMProperties on Icd9CM {
				...Icd9CMBaseProperties
				topProcedure
			}
			# % protected region % [Modify the Icd9CMProperties classFragment here] end
			${super.fragments('Icd9CM').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<Icd9CMModel>> {
		...
		return  this.apollo.query<PassableStateConfig<Icd9CMModel>>(
			{
				query: gql`
					query Count {
						totalCount: countIcd9CMs
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<Icd9CMModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<Icd9CMModel>> {
		...
		return this.apollo.query<PassableStateConfig<Icd9CMModel>>(
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.Icd9CMById as Icd9CMModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<Icd9CMModel>> {
		...
		return this.apollo.query<PassableStateConfig<Icd9CMModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						icd9CMs: icd9CMs(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...Icd9CMProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countIcd9CMs(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.icd9CMs as Icd9CMModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<Icd9CMModel>> {
		...
		return this.apollo.query<PassableStateConfig<Icd9CMModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						icd9CMs: lastIcd9CMs(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...Icd9CMProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: Icd9CMModel, queryParams?: QueryParams): Observable<PassableStateConfig<Icd9CMModel>> {
		...
		const successMessage = 'Created ICD 9 CM entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($icd9CM: Icd9CMInput!, $persistRelations: Boolean) {
						icd9CM: createIcd9CM(icd9CM: $icd9CM, persistRelations: $persistRelations) {
							...Icd9CMProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.icd9CM as Icd9CMModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: Icd9CMModel[], queryParams?: QueryParams): Observable<PassableStateConfig<Icd9CMModel>> {
		...
		const successMessage = 'Created Multiple ICD 9 CM entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($icd9CMs: [Icd9CMInput!]!) {
						icd9CM: createAllIcd9CM(icd9CMs: $icd9CMs) {
							...Icd9CMProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					icd9CMs: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.icd9CM as Icd9CMModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: Icd9CMModel, queryParams?: QueryParams): Observable<PassableStateConfig<Icd9CMModel>> {
		...
		const successMessage = 'Updated ICD 9 CM entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($icd9CM: Icd9CMInput!, $persistRelations: Boolean) {
						icd9CM: updateIcd9CM(icd9CM: $icd9CM, persistRelations: $persistRelations) {
							...Icd9CMProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: Icd9CMModel[], queryParams?: QueryParams): Observable<PassableStateConfig<Icd9CMModel>> {
		...
		const successMessage = 'Update Multiple ICD 9 CM entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($icd9CMs: [Icd9CMInput!]!) {
						icd9CM: updateAllIcd9CM(icd9CMs: $icd9CMs) {
							...Icd9CMProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<Icd9CMModel>> {
		...
		const successMessage = 'Deleted ICD 9 CM entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($icd9CMId: ID!) {
						icd9CMId: deleteIcd9CMById(icd9CMId: $icd9CMId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.icd9CMId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<Icd9CMModel>> {
		...
		const successMessage = 'Deleted selected ICD 9 CM entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($icd9CMIds: [ID!]!){
						deleteIcd9CMExcludingIds(icd9CMIds: $icd9CMIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.icd9CMIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<Icd9CMModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($icd9CMIds: [ID!]!) {
						icd9CMIds: deleteAllIcd9CMByIds(icd9CMIds: $icd9CMIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<Icd9CMModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<Icd9CMModel>>(
			...
			map(result => {
				let audits: Icd9CMModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new Icd9CMModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<Icd9CMModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<Icd9CMModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($icd9CMId: ID!) {
						audits: icd9CMAuditsByEntityId(icd9CMId: $icd9CMId) {
							entity {
								...Icd9CMProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<Icd9CMModel>> {
		const url = environment.API_URL + '/api/icd9cm/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<Icd9CMModel>> {
		const url = environment.API_URL + '/api/icd9cm/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<Icd9CMModel>> {
		let apiUrl = environment.API_URL + '/api/icd9cm/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<Icd9CMModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/icd9cm/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' ICD 9 CM entities')),
