...
import {MedicalCertificateDischargeResumeModel} from '../../models/medicalCertificateDischargeResume/medical_certificate_discharge_resume.model';
import {MedicalCertificateDischargeResumeModelAudit} from '../../models/medicalCertificateDischargeResume/medical_certificate_discharge_resume.model.state';
...
/**
 * Medical Certificate  Discharge Resume service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class MedicalCertificateDischargeResumeService extends AbstractHttpService<MedicalCertificateDischargeResumeModel, MedicalCertificateDischargeResumeModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the MedicalCertificateDischargeResumeProperties classFragment here] off begin
			fragment MedicalCertificateDischargeResumeProperties on MedicalCertificateDischargeResume {
				...MedicalCertificateDischargeResumeBaseProperties
				admissionDateTime
				dischargeDateTime
				condition
				mainDiagnosis
			...
			# % protected region % [Modify the MedicalCertificateDischargeResumeProperties classFragment here] end
			${super.fragments('MedicalCertificateDischargeResume').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<MedicalCertificateDischargeResumeModel>> {
		...
		return  this.apollo.query<PassableStateConfig<MedicalCertificateDischargeResumeModel>>(
			{
				query: gql`
					query Count {
						totalCount: countMedicalCertificateDischargeResumes
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<MedicalCertificateDischargeResumeModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<MedicalCertificateDischargeResumeModel>> {
		...
		return this.apollo.query<PassableStateConfig<MedicalCertificateDischargeResumeModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						MedicalCertificateDischargeResumeById: medicalCertificateDischargeResumeById(id: $id) {
							...MedicalCertificateDischargeResumeProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.MedicalCertificateDischargeResumeById as MedicalCertificateDischargeResumeModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<MedicalCertificateDischargeResumeModel>> {
		...
		return this.apollo.query<PassableStateConfig<MedicalCertificateDischargeResumeModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						medicalCertificateDischargeResumes: medicalCertificateDischargeResumes(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...MedicalCertificateDischargeResumeProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countMedicalCertificateDischargeResumes(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.medicalCertificateDischargeResumes as MedicalCertificateDischargeResumeModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<MedicalCertificateDischargeResumeModel>> {
		...
		return this.apollo.query<PassableStateConfig<MedicalCertificateDischargeResumeModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						medicalCertificateDischargeResumes: lastMedicalCertificateDischargeResumes(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...MedicalCertificateDischargeResumeProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: MedicalCertificateDischargeResumeModel, queryParams?: QueryParams): Observable<PassableStateConfig<MedicalCertificateDischargeResumeModel>> {
		...
		const successMessage = 'Created Medical Certificate  Discharge Resume entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($medicalCertificateDischargeResume: MedicalCertificateDischargeResumeInput!, $persistRelations: Boolean) {
						medicalCertificateDischargeResume: createMedicalCertificateDischargeResume(medicalCertificateDischargeResume: $medicalCertificateDischargeResume, persistRelations: $persistRelations) {
							...MedicalCertificateDischargeResumeProperties,
				...
				variables: {
					medicalCertificateDischargeResume: {
						...
						dischargeICD10: entity.dischargeICD10 ? new DiagnosesAndProceduresModel(entity.dischargeICD10).toJSON() : undefined,
						dischargeICD9CM: entity.dischargeICD9CM ? new DiagnosesAndProceduresModel(entity.dischargeICD9CM).toJSON() : undefined,
						medicalStaff: entity.medicalStaff ? new StaffModel(entity.medicalStaff).toJSON() : undefined,
					},
			...
			map(result => {
				...
				return {
					targetModel: result.data.medicalCertificateDischargeResume as MedicalCertificateDischargeResumeModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: MedicalCertificateDischargeResumeModel[], queryParams?: QueryParams): Observable<PassableStateConfig<MedicalCertificateDischargeResumeModel>> {
		...
		const successMessage = 'Created Multiple Medical Certificate  Discharge Resume entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($medicalCertificateDischargeResumes: [MedicalCertificateDischargeResumeInput!]!) {
						medicalCertificateDischargeResume: createAllMedicalCertificateDischargeResume(medicalCertificateDischargeResumes: $medicalCertificateDischargeResumes) {
							...MedicalCertificateDischargeResumeProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					medicalCertificateDischargeResumes: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.medicalCertificateDischargeResume as MedicalCertificateDischargeResumeModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: MedicalCertificateDischargeResumeModel, queryParams?: QueryParams): Observable<PassableStateConfig<MedicalCertificateDischargeResumeModel>> {
		...
		const successMessage = 'Updated Medical Certificate  Discharge Resume entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($medicalCertificateDischargeResume: MedicalCertificateDischargeResumeInput!, $persistRelations: Boolean) {
						medicalCertificateDischargeResume: updateMedicalCertificateDischargeResume(medicalCertificateDischargeResume: $medicalCertificateDischargeResume, persistRelations: $persistRelations) {
							...MedicalCertificateDischargeResumeProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: MedicalCertificateDischargeResumeModel[], queryParams?: QueryParams): Observable<PassableStateConfig<MedicalCertificateDischargeResumeModel>> {
		...
		const successMessage = 'Update Multiple Medical Certificate  Discharge Resume entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($medicalCertificateDischargeResumes: [MedicalCertificateDischargeResumeInput!]!) {
						medicalCertificateDischargeResume: updateAllMedicalCertificateDischargeResume(medicalCertificateDischargeResumes: $medicalCertificateDischargeResumes) {
							...MedicalCertificateDischargeResumeProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<MedicalCertificateDischargeResumeModel>> {
		...
		const successMessage = 'Deleted Medical Certificate  Discharge Resume entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($medicalCertificateDischargeResumeId: ID!) {
						medicalCertificateDischargeResumeId: deleteMedicalCertificateDischargeResumeById(medicalCertificateDischargeResumeId: $medicalCertificateDischargeResumeId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.medicalCertificateDischargeResumeId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<MedicalCertificateDischargeResumeModel>> {
		...
		const successMessage = 'Deleted selected Medical Certificate  Discharge Resume entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($medicalCertificateDischargeResumeIds: [ID!]!){
						deleteMedicalCertificateDischargeResumeExcludingIds(medicalCertificateDischargeResumeIds: $medicalCertificateDischargeResumeIds)
				...
				`,
				variables: {
					medicalCertificateDischargeResumeIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.medicalCertificateDischargeResumeIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<MedicalCertificateDischargeResumeModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($medicalCertificateDischargeResumeIds: [ID!]!) {
						medicalCertificateDischargeResumeIds: deleteAllMedicalCertificateDischargeResumeByIds(medicalCertificateDischargeResumeIds: $medicalCertificateDischargeResumeIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<MedicalCertificateDischargeResumeModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<MedicalCertificateDischargeResumeModel>>(
			{
				query: gql`
					query GetAudits {
						audits: medicalCertificateDischargeResumeAudits {
							entity {
								...MedicalCertificateDischargeResumeProperties
							}
							timestamp
			...
			map(result => {
				let audits: MedicalCertificateDischargeResumeModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new MedicalCertificateDischargeResumeModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<MedicalCertificateDischargeResumeModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<MedicalCertificateDischargeResumeModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($medicalCertificateDischargeResumeId: ID!) {
						audits: medicalCertificateDischargeResumeAuditsByEntityId(medicalCertificateDischargeResumeId: $medicalCertificateDischargeResumeId) {
							entity {
								...MedicalCertificateDischargeResumeProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<MedicalCertificateDischargeResumeModel>> {
		const url = environment.API_URL + '/api/medicalcertificatedischargeresume/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<MedicalCertificateDischargeResumeModel>> {
		const url = environment.API_URL + '/api/medicalcertificatedischargeresume/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<MedicalCertificateDischargeResumeModel>> {
		let apiUrl = environment.API_URL + '/api/medicalcertificatedischargeresume/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<MedicalCertificateDischargeResumeModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/medicalcertificatedischargeresume/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Medical Certificate  Discharge Resume entities')),
