...
import {PcareCompoundDrugModelAudit} from '../../models/pcareCompoundDrug/pcare_compound_drug.model.state';
...
/**
 * PCare Compound Drug service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class PcareCompoundDrugService extends AbstractHttpService<PcareCompoundDrugModel, PcareCompoundDrugModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the PcareCompoundDrugProperties classFragment here] off begin
			fragment PcareCompoundDrugProperties on PcareCompoundDrug {
				...PcareCompoundDrugBaseProperties
				compoundName
				signaDays
				signaTimes
				packageQty
			...
			# % protected region % [Modify the PcareCompoundDrugProperties classFragment here] end
			${super.fragments('PcareCompoundDrug').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<PcareCompoundDrugModel>> {
		...
		return  this.apollo.query<PassableStateConfig<PcareCompoundDrugModel>>(
			{
				query: gql`
					query Count {
						totalCount: countPcareCompoundDrugs
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<PcareCompoundDrugModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<PcareCompoundDrugModel>> {
		...
		return this.apollo.query<PassableStateConfig<PcareCompoundDrugModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						PcareCompoundDrugById: pcareCompoundDrugById(id: $id) {
							...PcareCompoundDrugProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.PcareCompoundDrugById as PcareCompoundDrugModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PcareCompoundDrugModel>> {
		...
		return this.apollo.query<PassableStateConfig<PcareCompoundDrugModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						pcareCompoundDrugs: pcareCompoundDrugs(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...PcareCompoundDrugProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countPcareCompoundDrugs(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.pcareCompoundDrugs as PcareCompoundDrugModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PcareCompoundDrugModel>> {
		...
		return this.apollo.query<PassableStateConfig<PcareCompoundDrugModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						pcareCompoundDrugs: lastPcareCompoundDrugs(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...PcareCompoundDrugProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: PcareCompoundDrugModel, queryParams?: QueryParams): Observable<PassableStateConfig<PcareCompoundDrugModel>> {
		...
		const successMessage = 'Created PCare Compound Drug entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($pcareCompoundDrug: PcareCompoundDrugInput!, $persistRelations: Boolean) {
						pcareCompoundDrug: createPcareCompoundDrug(pcareCompoundDrug: $pcareCompoundDrug, persistRelations: $persistRelations) {
							...PcareCompoundDrugProperties,
				...
				variables: {
					pcareCompoundDrug: {
						...
						pcareCompoundDrugItems: entity.pcareCompoundDrugItems ? entity.pcareCompoundDrugItems?.map((model: PcareCompoundDrugItemModel) => new PcareCompoundDrugItemModel(model).toJSON()) : [],
					},
			...
			map(result => {
				...
				return {
					targetModel: result.data.pcareCompoundDrug as PcareCompoundDrugModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: PcareCompoundDrugModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PcareCompoundDrugModel>> {
		...
		const successMessage = 'Created Multiple PCare Compound Drug entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($pcareCompoundDrugs: [PcareCompoundDrugInput!]!) {
						pcareCompoundDrug: createAllPcareCompoundDrug(pcareCompoundDrugs: $pcareCompoundDrugs) {
							...PcareCompoundDrugProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					pcareCompoundDrugs: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.pcareCompoundDrug as PcareCompoundDrugModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: PcareCompoundDrugModel, queryParams?: QueryParams): Observable<PassableStateConfig<PcareCompoundDrugModel>> {
		...
		const successMessage = 'Updated PCare Compound Drug entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($pcareCompoundDrug: PcareCompoundDrugInput!, $persistRelations: Boolean) {
						pcareCompoundDrug: updatePcareCompoundDrug(pcareCompoundDrug: $pcareCompoundDrug, persistRelations: $persistRelations) {
							...PcareCompoundDrugProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: PcareCompoundDrugModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PcareCompoundDrugModel>> {
		...
		const successMessage = 'Update Multiple PCare Compound Drug entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($pcareCompoundDrugs: [PcareCompoundDrugInput!]!) {
						pcareCompoundDrug: updateAllPcareCompoundDrug(pcareCompoundDrugs: $pcareCompoundDrugs) {
							...PcareCompoundDrugProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<PcareCompoundDrugModel>> {
		...
		const successMessage = 'Deleted PCare Compound Drug entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($pcareCompoundDrugId: ID!) {
						pcareCompoundDrugId: deletePcareCompoundDrugById(pcareCompoundDrugId: $pcareCompoundDrugId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.pcareCompoundDrugId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<PcareCompoundDrugModel>> {
		...
		const successMessage = 'Deleted selected PCare Compound Drug entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($pcareCompoundDrugIds: [ID!]!){
						deletePcareCompoundDrugExcludingIds(pcareCompoundDrugIds: $pcareCompoundDrugIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.pcareCompoundDrugIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<PcareCompoundDrugModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($pcareCompoundDrugIds: [ID!]!) {
						pcareCompoundDrugIds: deleteAllPcareCompoundDrugByIds(pcareCompoundDrugIds: $pcareCompoundDrugIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<PcareCompoundDrugModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PcareCompoundDrugModel>>(
			{
				query: gql`
					query GetAudits {
						audits: pcareCompoundDrugAudits {
							entity {
								...PcareCompoundDrugProperties
							}
							timestamp
			...
			map(result => {
				let audits: PcareCompoundDrugModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new PcareCompoundDrugModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<PcareCompoundDrugModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PcareCompoundDrugModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($pcareCompoundDrugId: ID!) {
						audits: pcareCompoundDrugAuditsByEntityId(pcareCompoundDrugId: $pcareCompoundDrugId) {
							entity {
								...PcareCompoundDrugProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<PcareCompoundDrugModel>> {
		const url = environment.API_URL + '/api/pcarecompounddrug/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<PcareCompoundDrugModel>> {
		const url = environment.API_URL + '/api/pcarecompounddrug/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<PcareCompoundDrugModel>> {
		let apiUrl = environment.API_URL + '/api/pcarecompounddrug/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<PcareCompoundDrugModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/pcarecompounddrug/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' PCare Compound Drug entities')),
