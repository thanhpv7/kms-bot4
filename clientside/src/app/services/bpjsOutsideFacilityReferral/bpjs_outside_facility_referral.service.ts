...
import {BpjsOutsideFacilityReferralModelAudit} from '../../models/bpjsOutsideFacilityReferral/bpjs_outside_facility_referral.model.state';
...
/**
 * BPJS Outside Facility Referral service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BpjsOutsideFacilityReferralService extends AbstractHttpService<BpjsOutsideFacilityReferralModel, BpjsOutsideFacilityReferralModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BpjsOutsideFacilityReferralProperties classFragment here] off begin
			fragment BpjsOutsideFacilityReferralProperties on BpjsOutsideFacilityReferral {
				...BpjsOutsideFacilityReferralBaseProperties
				referralNo
				referralDate
				treatmentType
				bpjsCardNo
			...
			# % protected region % [Modify the BpjsOutsideFacilityReferralProperties classFragment here] end
			${super.fragments('BpjsOutsideFacilityReferral').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BpjsOutsideFacilityReferralModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BpjsOutsideFacilityReferralModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBpjsOutsideFacilityReferrals
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BpjsOutsideFacilityReferralModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsOutsideFacilityReferralModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsOutsideFacilityReferralModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BpjsOutsideFacilityReferralById: bpjsOutsideFacilityReferralById(id: $id) {
							...BpjsOutsideFacilityReferralProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BpjsOutsideFacilityReferralById as BpjsOutsideFacilityReferralModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsOutsideFacilityReferralModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsOutsideFacilityReferralModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						bpjsOutsideFacilityReferrals: bpjsOutsideFacilityReferrals(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BpjsOutsideFacilityReferralProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBpjsOutsideFacilityReferrals(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.bpjsOutsideFacilityReferrals as BpjsOutsideFacilityReferralModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsOutsideFacilityReferralModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsOutsideFacilityReferralModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						bpjsOutsideFacilityReferrals: lastBpjsOutsideFacilityReferrals(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BpjsOutsideFacilityReferralProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BpjsOutsideFacilityReferralModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsOutsideFacilityReferralModel>> {
		...
		const successMessage = 'Created BPJS Outside Facility Referral entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($bpjsOutsideFacilityReferral: BpjsOutsideFacilityReferralInput!, $persistRelations: Boolean) {
						bpjsOutsideFacilityReferral: createBpjsOutsideFacilityReferral(bpjsOutsideFacilityReferral: $bpjsOutsideFacilityReferral, persistRelations: $persistRelations) {
							...BpjsOutsideFacilityReferralProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.bpjsOutsideFacilityReferral as BpjsOutsideFacilityReferralModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BpjsOutsideFacilityReferralModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsOutsideFacilityReferralModel>> {
		...
		const successMessage = 'Created Multiple BPJS Outside Facility Referral entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($bpjsOutsideFacilityReferrals: [BpjsOutsideFacilityReferralInput!]!) {
						bpjsOutsideFacilityReferral: createAllBpjsOutsideFacilityReferral(bpjsOutsideFacilityReferrals: $bpjsOutsideFacilityReferrals) {
							...BpjsOutsideFacilityReferralProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					bpjsOutsideFacilityReferrals: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.bpjsOutsideFacilityReferral as BpjsOutsideFacilityReferralModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BpjsOutsideFacilityReferralModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsOutsideFacilityReferralModel>> {
		...
		const successMessage = 'Updated BPJS Outside Facility Referral entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($bpjsOutsideFacilityReferral: BpjsOutsideFacilityReferralInput!, $persistRelations: Boolean) {
						bpjsOutsideFacilityReferral: updateBpjsOutsideFacilityReferral(bpjsOutsideFacilityReferral: $bpjsOutsideFacilityReferral, persistRelations: $persistRelations) {
							...BpjsOutsideFacilityReferralProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BpjsOutsideFacilityReferralModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsOutsideFacilityReferralModel>> {
		...
		const successMessage = 'Update Multiple BPJS Outside Facility Referral entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($bpjsOutsideFacilityReferrals: [BpjsOutsideFacilityReferralInput!]!) {
						bpjsOutsideFacilityReferral: updateAllBpjsOutsideFacilityReferral(bpjsOutsideFacilityReferrals: $bpjsOutsideFacilityReferrals) {
							...BpjsOutsideFacilityReferralProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BpjsOutsideFacilityReferralModel>> {
		...
		const successMessage = 'Deleted BPJS Outside Facility Referral entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($bpjsOutsideFacilityReferralId: ID!) {
						bpjsOutsideFacilityReferralId: deleteBpjsOutsideFacilityReferralById(bpjsOutsideFacilityReferralId: $bpjsOutsideFacilityReferralId)
				...
				`,
				variables: {
					bpjsOutsideFacilityReferralId: id,
			...
			map(result => {
				...
				return {
					targetModelId: result.data.bpjsOutsideFacilityReferralId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsOutsideFacilityReferralModel>> {
		...
		const successMessage = 'Deleted selected BPJS Outside Facility Referral entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($bpjsOutsideFacilityReferralIds: [ID!]!){
						deleteBpjsOutsideFacilityReferralExcludingIds(bpjsOutsideFacilityReferralIds: $bpjsOutsideFacilityReferralIds)
				...
				`,
				variables: {
					bpjsOutsideFacilityReferralIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.bpjsOutsideFacilityReferralIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BpjsOutsideFacilityReferralModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($bpjsOutsideFacilityReferralIds: [ID!]!) {
						bpjsOutsideFacilityReferralIds: deleteAllBpjsOutsideFacilityReferralByIds(bpjsOutsideFacilityReferralIds: $bpjsOutsideFacilityReferralIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BpjsOutsideFacilityReferralModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsOutsideFacilityReferralModel>>(
			{
				query: gql`
					query GetAudits {
						audits: bpjsOutsideFacilityReferralAudits {
							entity {
								...BpjsOutsideFacilityReferralProperties
							}
							timestamp
			...
			map(result => {
				let audits: BpjsOutsideFacilityReferralModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BpjsOutsideFacilityReferralModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BpjsOutsideFacilityReferralModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsOutsideFacilityReferralModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($bpjsOutsideFacilityReferralId: ID!) {
						audits: bpjsOutsideFacilityReferralAuditsByEntityId(bpjsOutsideFacilityReferralId: $bpjsOutsideFacilityReferralId) {
							entity {
								...BpjsOutsideFacilityReferralProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BpjsOutsideFacilityReferralModel>> {
		const url = environment.API_URL + '/api/bpjsoutsidefacilityreferral/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BpjsOutsideFacilityReferralModel>> {
		const url = environment.API_URL + '/api/bpjsoutsidefacilityreferral/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsOutsideFacilityReferralModel>> {
		let apiUrl = environment.API_URL + '/api/bpjsoutsidefacilityreferral/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BpjsOutsideFacilityReferralModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/bpjsoutsidefacilityreferral/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' BPJS Outside Facility Referral entities')),
