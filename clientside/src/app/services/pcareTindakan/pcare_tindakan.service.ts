...
import {PcareTindakanModelAudit} from '../../models/pcareTindakan/pcare_tindakan.model.state';
...
/**
 * PCare Tindakan service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class PcareTindakanService extends AbstractHttpService<PcareTindakanModel, PcareTindakanModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the PcareTindakanProperties classFragment here] off begin
			fragment PcareTindakanProperties on PcareTindakan {
				...PcareTindakanBaseProperties
				kodeTindakan
				namaTindakan
				maksimalTarif
				withvalue
			...
			# % protected region % [Modify the PcareTindakanProperties classFragment here] end
			${super.fragments('PcareTindakan').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<PcareTindakanModel>> {
		...
		return  this.apollo.query<PassableStateConfig<PcareTindakanModel>>(
			{
				query: gql`
					query Count {
						totalCount: countPcareTindakans
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<PcareTindakanModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<PcareTindakanModel>> {
		...
		return this.apollo.query<PassableStateConfig<PcareTindakanModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						PcareTindakanById: pcareTindakanById(id: $id) {
							...PcareTindakanProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.PcareTindakanById as PcareTindakanModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PcareTindakanModel>> {
		...
		return this.apollo.query<PassableStateConfig<PcareTindakanModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						pcareTindakans: pcareTindakans(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...PcareTindakanProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countPcareTindakans(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.pcareTindakans as PcareTindakanModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PcareTindakanModel>> {
		...
		return this.apollo.query<PassableStateConfig<PcareTindakanModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						pcareTindakans: lastPcareTindakans(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...PcareTindakanProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: PcareTindakanModel, queryParams?: QueryParams): Observable<PassableStateConfig<PcareTindakanModel>> {
		...
		const successMessage = 'Created PCare Tindakan entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($pcareTindakan: PcareTindakanInput!, $persistRelations: Boolean) {
						pcareTindakan: createPcareTindakan(pcareTindakan: $pcareTindakan, persistRelations: $persistRelations) {
							...PcareTindakanProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.pcareTindakan as PcareTindakanModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: PcareTindakanModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PcareTindakanModel>> {
		...
		const successMessage = 'Created Multiple PCare Tindakan entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($pcareTindakans: [PcareTindakanInput!]!) {
						pcareTindakan: createAllPcareTindakan(pcareTindakans: $pcareTindakans) {
							...PcareTindakanProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					pcareTindakans: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.pcareTindakan as PcareTindakanModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: PcareTindakanModel, queryParams?: QueryParams): Observable<PassableStateConfig<PcareTindakanModel>> {
		...
		const successMessage = 'Updated PCare Tindakan entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($pcareTindakan: PcareTindakanInput!, $persistRelations: Boolean) {
						pcareTindakan: updatePcareTindakan(pcareTindakan: $pcareTindakan, persistRelations: $persistRelations) {
							...PcareTindakanProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: PcareTindakanModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PcareTindakanModel>> {
		...
		const successMessage = 'Update Multiple PCare Tindakan entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($pcareTindakans: [PcareTindakanInput!]!) {
						pcareTindakan: updateAllPcareTindakan(pcareTindakans: $pcareTindakans) {
							...PcareTindakanProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<PcareTindakanModel>> {
		...
		const successMessage = 'Deleted PCare Tindakan entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($pcareTindakanId: ID!) {
						pcareTindakanId: deletePcareTindakanById(pcareTindakanId: $pcareTindakanId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.pcareTindakanId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<PcareTindakanModel>> {
		...
		const successMessage = 'Deleted selected PCare Tindakan entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($pcareTindakanIds: [ID!]!){
						deletePcareTindakanExcludingIds(pcareTindakanIds: $pcareTindakanIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.pcareTindakanIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<PcareTindakanModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($pcareTindakanIds: [ID!]!) {
						pcareTindakanIds: deleteAllPcareTindakanByIds(pcareTindakanIds: $pcareTindakanIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<PcareTindakanModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PcareTindakanModel>>(
			...
			map(result => {
				let audits: PcareTindakanModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new PcareTindakanModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<PcareTindakanModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PcareTindakanModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($pcareTindakanId: ID!) {
						audits: pcareTindakanAuditsByEntityId(pcareTindakanId: $pcareTindakanId) {
							entity {
								...PcareTindakanProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<PcareTindakanModel>> {
		const url = environment.API_URL + '/api/pcaretindakan/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<PcareTindakanModel>> {
		const url = environment.API_URL + '/api/pcaretindakan/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<PcareTindakanModel>> {
		let apiUrl = environment.API_URL + '/api/pcaretindakan/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<PcareTindakanModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/pcaretindakan/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' PCare Tindakan entities')),
