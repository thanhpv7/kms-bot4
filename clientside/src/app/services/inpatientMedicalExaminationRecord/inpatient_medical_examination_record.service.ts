...
import {InpatientMedicalExaminationRecordModel} from '../../models/inpatientMedicalExaminationRecord/inpatient_medical_examination_record.model';
import {InpatientMedicalExaminationRecordModelAudit} from '../../models/inpatientMedicalExaminationRecord/inpatient_medical_examination_record.model.state';
...
/**
 * Inpatient Medical Examination Record service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class InpatientMedicalExaminationRecordService extends AbstractHttpService<InpatientMedicalExaminationRecordModel, InpatientMedicalExaminationRecordModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the InpatientMedicalExaminationRecordProperties classFragment here] off begin
			fragment InpatientMedicalExaminationRecordProperties on InpatientMedicalExaminationRecord {
				...InpatientMedicalExaminationRecordBaseProperties
				startDateTime
				endDateTime
				treatmentClass
				inpatientCase
			...
			# % protected region % [Modify the InpatientMedicalExaminationRecordProperties classFragment here] end
			${super.fragments('InpatientMedicalExaminationRecord').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<InpatientMedicalExaminationRecordModel>> {
		...
		return  this.apollo.query<PassableStateConfig<InpatientMedicalExaminationRecordModel>>(
			{
				query: gql`
					query Count {
						totalCount: countInpatientMedicalExaminationRecords
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<InpatientMedicalExaminationRecordModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<InpatientMedicalExaminationRecordModel>> {
		...
		return this.apollo.query<PassableStateConfig<InpatientMedicalExaminationRecordModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						InpatientMedicalExaminationRecordById: inpatientMedicalExaminationRecordById(id: $id) {
							...InpatientMedicalExaminationRecordProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.InpatientMedicalExaminationRecordById as InpatientMedicalExaminationRecordModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<InpatientMedicalExaminationRecordModel>> {
		...
		return this.apollo.query<PassableStateConfig<InpatientMedicalExaminationRecordModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						inpatientMedicalExaminationRecords: inpatientMedicalExaminationRecords(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...InpatientMedicalExaminationRecordProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countInpatientMedicalExaminationRecords(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.inpatientMedicalExaminationRecords as InpatientMedicalExaminationRecordModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<InpatientMedicalExaminationRecordModel>> {
		...
		return this.apollo.query<PassableStateConfig<InpatientMedicalExaminationRecordModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						inpatientMedicalExaminationRecords: lastInpatientMedicalExaminationRecords(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...InpatientMedicalExaminationRecordProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: InpatientMedicalExaminationRecordModel, queryParams?: QueryParams): Observable<PassableStateConfig<InpatientMedicalExaminationRecordModel>> {
		...
		const successMessage = 'Created Inpatient Medical Examination Record entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($inpatientMedicalExaminationRecord: InpatientMedicalExaminationRecordInput!, $persistRelations: Boolean) {
						inpatientMedicalExaminationRecord: createInpatientMedicalExaminationRecord(inpatientMedicalExaminationRecord: $inpatientMedicalExaminationRecord, persistRelations: $persistRelations) {
							...InpatientMedicalExaminationRecordProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.inpatientMedicalExaminationRecord as InpatientMedicalExaminationRecordModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: InpatientMedicalExaminationRecordModel[], queryParams?: QueryParams): Observable<PassableStateConfig<InpatientMedicalExaminationRecordModel>> {
		...
		const successMessage = 'Created Multiple Inpatient Medical Examination Record entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($inpatientMedicalExaminationRecords: [InpatientMedicalExaminationRecordInput!]!) {
						inpatientMedicalExaminationRecord: createAllInpatientMedicalExaminationRecord(inpatientMedicalExaminationRecords: $inpatientMedicalExaminationRecords) {
							...InpatientMedicalExaminationRecordProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					inpatientMedicalExaminationRecords: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.inpatientMedicalExaminationRecord as InpatientMedicalExaminationRecordModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: InpatientMedicalExaminationRecordModel, queryParams?: QueryParams): Observable<PassableStateConfig<InpatientMedicalExaminationRecordModel>> {
		...
		const successMessage = 'Updated Inpatient Medical Examination Record entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($inpatientMedicalExaminationRecord: InpatientMedicalExaminationRecordInput!, $persistRelations: Boolean) {
						inpatientMedicalExaminationRecord: updateInpatientMedicalExaminationRecord(inpatientMedicalExaminationRecord: $inpatientMedicalExaminationRecord, persistRelations: $persistRelations) {
							...InpatientMedicalExaminationRecordProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: InpatientMedicalExaminationRecordModel[], queryParams?: QueryParams): Observable<PassableStateConfig<InpatientMedicalExaminationRecordModel>> {
		...
		const successMessage = 'Update Multiple Inpatient Medical Examination Record entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($inpatientMedicalExaminationRecords: [InpatientMedicalExaminationRecordInput!]!) {
						inpatientMedicalExaminationRecord: updateAllInpatientMedicalExaminationRecord(inpatientMedicalExaminationRecords: $inpatientMedicalExaminationRecords) {
							...InpatientMedicalExaminationRecordProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<InpatientMedicalExaminationRecordModel>> {
		...
		const successMessage = 'Deleted Inpatient Medical Examination Record entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($inpatientMedicalExaminationRecordId: ID!) {
						inpatientMedicalExaminationRecordId: deleteInpatientMedicalExaminationRecordById(inpatientMedicalExaminationRecordId: $inpatientMedicalExaminationRecordId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.inpatientMedicalExaminationRecordId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<InpatientMedicalExaminationRecordModel>> {
		...
		const successMessage = 'Deleted selected Inpatient Medical Examination Record entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($inpatientMedicalExaminationRecordIds: [ID!]!){
						deleteInpatientMedicalExaminationRecordExcludingIds(inpatientMedicalExaminationRecordIds: $inpatientMedicalExaminationRecordIds)
				...
				`,
				variables: {
					inpatientMedicalExaminationRecordIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.inpatientMedicalExaminationRecordIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<InpatientMedicalExaminationRecordModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($inpatientMedicalExaminationRecordIds: [ID!]!) {
						inpatientMedicalExaminationRecordIds: deleteAllInpatientMedicalExaminationRecordByIds(inpatientMedicalExaminationRecordIds: $inpatientMedicalExaminationRecordIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<InpatientMedicalExaminationRecordModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<InpatientMedicalExaminationRecordModel>>(
			{
				query: gql`
					query GetAudits {
						audits: inpatientMedicalExaminationRecordAudits {
							entity {
								...InpatientMedicalExaminationRecordProperties
							}
							timestamp
			...
			map(result => {
				let audits: InpatientMedicalExaminationRecordModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new InpatientMedicalExaminationRecordModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<InpatientMedicalExaminationRecordModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<InpatientMedicalExaminationRecordModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($inpatientMedicalExaminationRecordId: ID!) {
						audits: inpatientMedicalExaminationRecordAuditsByEntityId(inpatientMedicalExaminationRecordId: $inpatientMedicalExaminationRecordId) {
							entity {
								...InpatientMedicalExaminationRecordProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<InpatientMedicalExaminationRecordModel>> {
		const url = environment.API_URL + '/api/inpatientmedicalexaminationrecord/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<InpatientMedicalExaminationRecordModel>> {
		const url = environment.API_URL + '/api/inpatientmedicalexaminationrecord/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<InpatientMedicalExaminationRecordModel>> {
		let apiUrl = environment.API_URL + '/api/inpatientmedicalexaminationrecord/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<InpatientMedicalExaminationRecordModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/inpatientmedicalexaminationrecord/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Inpatient Medical Examination Record entities')),
