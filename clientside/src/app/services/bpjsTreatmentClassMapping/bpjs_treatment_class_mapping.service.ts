...
import {BpjsTreatmentClassMappingModel} from '../../models/bpjsTreatmentClassMapping/bpjs_treatment_class_mapping.model';
import {BpjsTreatmentClassMappingModelAudit} from '../../models/bpjsTreatmentClassMapping/bpjs_treatment_class_mapping.model.state';
...
/**
 * BPJS Treatment Class Mapping service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BpjsTreatmentClassMappingService extends AbstractHttpService<BpjsTreatmentClassMappingModel, BpjsTreatmentClassMappingModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BpjsTreatmentClassMappingProperties classFragment here] off begin
			fragment BpjsTreatmentClassMappingProperties on BpjsTreatmentClassMapping {
				...BpjsTreatmentClassMappingBaseProperties
				refCode
				refName
				internalTreatmentClass
			}
			# % protected region % [Modify the BpjsTreatmentClassMappingProperties classFragment here] end
			${super.fragments('BpjsTreatmentClassMapping').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BpjsTreatmentClassMappingModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BpjsTreatmentClassMappingModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBpjsTreatmentClassMappings
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BpjsTreatmentClassMappingModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsTreatmentClassMappingModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsTreatmentClassMappingModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BpjsTreatmentClassMappingById: bpjsTreatmentClassMappingById(id: $id) {
							...BpjsTreatmentClassMappingProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BpjsTreatmentClassMappingById as BpjsTreatmentClassMappingModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsTreatmentClassMappingModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsTreatmentClassMappingModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						bpjsTreatmentClassMappings: bpjsTreatmentClassMappings(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BpjsTreatmentClassMappingProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBpjsTreatmentClassMappings(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.bpjsTreatmentClassMappings as BpjsTreatmentClassMappingModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsTreatmentClassMappingModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsTreatmentClassMappingModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						bpjsTreatmentClassMappings: lastBpjsTreatmentClassMappings(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BpjsTreatmentClassMappingProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BpjsTreatmentClassMappingModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsTreatmentClassMappingModel>> {
		...
		const successMessage = 'Created BPJS Treatment Class Mapping entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($bpjsTreatmentClassMapping: BpjsTreatmentClassMappingInput!, $persistRelations: Boolean) {
						bpjsTreatmentClassMapping: createBpjsTreatmentClassMapping(bpjsTreatmentClassMapping: $bpjsTreatmentClassMapping, persistRelations: $persistRelations) {
							...BpjsTreatmentClassMappingProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.bpjsTreatmentClassMapping as BpjsTreatmentClassMappingModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BpjsTreatmentClassMappingModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsTreatmentClassMappingModel>> {
		...
		const successMessage = 'Created Multiple BPJS Treatment Class Mapping entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($bpjsTreatmentClassMappings: [BpjsTreatmentClassMappingInput!]!) {
						bpjsTreatmentClassMapping: createAllBpjsTreatmentClassMapping(bpjsTreatmentClassMappings: $bpjsTreatmentClassMappings) {
							...BpjsTreatmentClassMappingProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					bpjsTreatmentClassMappings: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.bpjsTreatmentClassMapping as BpjsTreatmentClassMappingModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BpjsTreatmentClassMappingModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsTreatmentClassMappingModel>> {
		...
		const successMessage = 'Updated BPJS Treatment Class Mapping entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($bpjsTreatmentClassMapping: BpjsTreatmentClassMappingInput!, $persistRelations: Boolean) {
						bpjsTreatmentClassMapping: updateBpjsTreatmentClassMapping(bpjsTreatmentClassMapping: $bpjsTreatmentClassMapping, persistRelations: $persistRelations) {
							...BpjsTreatmentClassMappingProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BpjsTreatmentClassMappingModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsTreatmentClassMappingModel>> {
		...
		const successMessage = 'Update Multiple BPJS Treatment Class Mapping entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($bpjsTreatmentClassMappings: [BpjsTreatmentClassMappingInput!]!) {
						bpjsTreatmentClassMapping: updateAllBpjsTreatmentClassMapping(bpjsTreatmentClassMappings: $bpjsTreatmentClassMappings) {
							...BpjsTreatmentClassMappingProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BpjsTreatmentClassMappingModel>> {
		...
		const successMessage = 'Deleted BPJS Treatment Class Mapping entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($bpjsTreatmentClassMappingId: ID!) {
						bpjsTreatmentClassMappingId: deleteBpjsTreatmentClassMappingById(bpjsTreatmentClassMappingId: $bpjsTreatmentClassMappingId)
				...
				`,
				variables: {
					bpjsTreatmentClassMappingId: id,
			...
			map(result => {
				...
				return {
					targetModelId: result.data.bpjsTreatmentClassMappingId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsTreatmentClassMappingModel>> {
		...
		const successMessage = 'Deleted selected BPJS Treatment Class Mapping entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($bpjsTreatmentClassMappingIds: [ID!]!){
						deleteBpjsTreatmentClassMappingExcludingIds(bpjsTreatmentClassMappingIds: $bpjsTreatmentClassMappingIds)
				...
				`,
				variables: {
					bpjsTreatmentClassMappingIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.bpjsTreatmentClassMappingIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BpjsTreatmentClassMappingModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($bpjsTreatmentClassMappingIds: [ID!]!) {
						bpjsTreatmentClassMappingIds: deleteAllBpjsTreatmentClassMappingByIds(bpjsTreatmentClassMappingIds: $bpjsTreatmentClassMappingIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BpjsTreatmentClassMappingModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsTreatmentClassMappingModel>>(
			{
				query: gql`
					query GetAudits {
						audits: bpjsTreatmentClassMappingAudits {
							entity {
								...BpjsTreatmentClassMappingProperties
							}
							timestamp
			...
			map(result => {
				let audits: BpjsTreatmentClassMappingModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BpjsTreatmentClassMappingModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BpjsTreatmentClassMappingModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsTreatmentClassMappingModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($bpjsTreatmentClassMappingId: ID!) {
						audits: bpjsTreatmentClassMappingAuditsByEntityId(bpjsTreatmentClassMappingId: $bpjsTreatmentClassMappingId) {
							entity {
								...BpjsTreatmentClassMappingProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BpjsTreatmentClassMappingModel>> {
		const url = environment.API_URL + '/api/bpjstreatmentclassmapping/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BpjsTreatmentClassMappingModel>> {
		const url = environment.API_URL + '/api/bpjstreatmentclassmapping/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsTreatmentClassMappingModel>> {
		let apiUrl = environment.API_URL + '/api/bpjstreatmentclassmapping/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BpjsTreatmentClassMappingModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/bpjstreatmentclassmapping/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' BPJS Treatment Class Mapping entities')),
