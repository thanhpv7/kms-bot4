...
import {BpjsPcareKegiatanKelompokModelAudit} from '../../models/bpjsPcareKegiatanKelompok/bpjs_pcare_kegiatan_kelompok.model.state';
...
/**
 * BPJS Pcare Kegiatan Kelompok service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BpjsPcareKegiatanKelompokService extends AbstractHttpService<BpjsPcareKegiatanKelompokModel, BpjsPcareKegiatanKelompokModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BpjsPcareKegiatanKelompokProperties classFragment here] off begin
			fragment BpjsPcareKegiatanKelompokProperties on BpjsPcareKegiatanKelompok {
				...BpjsPcareKegiatanKelompokBaseProperties
				ketuanama
				nama
				eduid
				clubid
			...
			# % protected region % [Modify the BpjsPcareKegiatanKelompokProperties classFragment here] end
			${super.fragments('BpjsPcareKegiatanKelompok').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BpjsPcareKegiatanKelompokModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BpjsPcareKegiatanKelompokModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBpjsPcareKegiatanKelompoks
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BpjsPcareKegiatanKelompokModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPcareKegiatanKelompokModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPcareKegiatanKelompokModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BpjsPcareKegiatanKelompokById: bpjsPcareKegiatanKelompokById(id: $id) {
							...BpjsPcareKegiatanKelompokProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BpjsPcareKegiatanKelompokById as BpjsPcareKegiatanKelompokModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsPcareKegiatanKelompokModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPcareKegiatanKelompokModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						bpjsPcareKegiatanKelompoks: bpjsPcareKegiatanKelompoks(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BpjsPcareKegiatanKelompokProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBpjsPcareKegiatanKelompoks(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.bpjsPcareKegiatanKelompoks as BpjsPcareKegiatanKelompokModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsPcareKegiatanKelompokModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPcareKegiatanKelompokModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						bpjsPcareKegiatanKelompoks: lastBpjsPcareKegiatanKelompoks(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BpjsPcareKegiatanKelompokProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BpjsPcareKegiatanKelompokModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPcareKegiatanKelompokModel>> {
		...
		const successMessage = 'Created BPJS Pcare Kegiatan Kelompok entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($bpjsPcareKegiatanKelompok: BpjsPcareKegiatanKelompokInput!, $persistRelations: Boolean) {
						bpjsPcareKegiatanKelompok: createBpjsPcareKegiatanKelompok(bpjsPcareKegiatanKelompok: $bpjsPcareKegiatanKelompok, persistRelations: $persistRelations) {
							...BpjsPcareKegiatanKelompokProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.bpjsPcareKegiatanKelompok as BpjsPcareKegiatanKelompokModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BpjsPcareKegiatanKelompokModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPcareKegiatanKelompokModel>> {
		...
		const successMessage = 'Created Multiple BPJS Pcare Kegiatan Kelompok entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($bpjsPcareKegiatanKelompoks: [BpjsPcareKegiatanKelompokInput!]!) {
						bpjsPcareKegiatanKelompok: createAllBpjsPcareKegiatanKelompok(bpjsPcareKegiatanKelompoks: $bpjsPcareKegiatanKelompoks) {
							...BpjsPcareKegiatanKelompokProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					bpjsPcareKegiatanKelompoks: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.bpjsPcareKegiatanKelompok as BpjsPcareKegiatanKelompokModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BpjsPcareKegiatanKelompokModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPcareKegiatanKelompokModel>> {
		...
		const successMessage = 'Updated BPJS Pcare Kegiatan Kelompok entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($bpjsPcareKegiatanKelompok: BpjsPcareKegiatanKelompokInput!, $persistRelations: Boolean) {
						bpjsPcareKegiatanKelompok: updateBpjsPcareKegiatanKelompok(bpjsPcareKegiatanKelompok: $bpjsPcareKegiatanKelompok, persistRelations: $persistRelations) {
							...BpjsPcareKegiatanKelompokProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BpjsPcareKegiatanKelompokModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPcareKegiatanKelompokModel>> {
		...
		const successMessage = 'Update Multiple BPJS Pcare Kegiatan Kelompok entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($bpjsPcareKegiatanKelompoks: [BpjsPcareKegiatanKelompokInput!]!) {
						bpjsPcareKegiatanKelompok: updateAllBpjsPcareKegiatanKelompok(bpjsPcareKegiatanKelompoks: $bpjsPcareKegiatanKelompoks) {
							...BpjsPcareKegiatanKelompokProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BpjsPcareKegiatanKelompokModel>> {
		...
		const successMessage = 'Deleted BPJS Pcare Kegiatan Kelompok entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($bpjsPcareKegiatanKelompokId: ID!) {
						bpjsPcareKegiatanKelompokId: deleteBpjsPcareKegiatanKelompokById(bpjsPcareKegiatanKelompokId: $bpjsPcareKegiatanKelompokId)
				...
				`,
				variables: {
					bpjsPcareKegiatanKelompokId: id,
			...
			map(result => {
				...
				return {
					targetModelId: result.data.bpjsPcareKegiatanKelompokId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsPcareKegiatanKelompokModel>> {
		...
		const successMessage = 'Deleted selected BPJS Pcare Kegiatan Kelompok entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($bpjsPcareKegiatanKelompokIds: [ID!]!){
						deleteBpjsPcareKegiatanKelompokExcludingIds(bpjsPcareKegiatanKelompokIds: $bpjsPcareKegiatanKelompokIds)
				...
				`,
				variables: {
					bpjsPcareKegiatanKelompokIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.bpjsPcareKegiatanKelompokIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BpjsPcareKegiatanKelompokModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($bpjsPcareKegiatanKelompokIds: [ID!]!) {
						bpjsPcareKegiatanKelompokIds: deleteAllBpjsPcareKegiatanKelompokByIds(bpjsPcareKegiatanKelompokIds: $bpjsPcareKegiatanKelompokIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BpjsPcareKegiatanKelompokModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPcareKegiatanKelompokModel>>(
			{
				query: gql`
					query GetAudits {
						audits: bpjsPcareKegiatanKelompokAudits {
							entity {
								...BpjsPcareKegiatanKelompokProperties
							}
							timestamp
			...
			map(result => {
				let audits: BpjsPcareKegiatanKelompokModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BpjsPcareKegiatanKelompokModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BpjsPcareKegiatanKelompokModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPcareKegiatanKelompokModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($bpjsPcareKegiatanKelompokId: ID!) {
						audits: bpjsPcareKegiatanKelompokAuditsByEntityId(bpjsPcareKegiatanKelompokId: $bpjsPcareKegiatanKelompokId) {
							entity {
								...BpjsPcareKegiatanKelompokProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BpjsPcareKegiatanKelompokModel>> {
		const url = environment.API_URL + '/api/bpjspcarekegiatankelompok/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BpjsPcareKegiatanKelompokModel>> {
		const url = environment.API_URL + '/api/bpjspcarekegiatankelompok/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsPcareKegiatanKelompokModel>> {
		let apiUrl = environment.API_URL + '/api/bpjspcarekegiatankelompok/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BpjsPcareKegiatanKelompokModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/bpjspcarekegiatankelompok/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' BPJS Pcare Kegiatan Kelompok entities')),
