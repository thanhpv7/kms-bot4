...
import {MedicationHeaderModel} from '../../models/medicationHeader/medication_header.model';
import {MedicationHeaderModelAudit} from '../../models/medicationHeader/medication_header.model.state';
...
/**
 * Medication Header service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class MedicationHeaderService extends AbstractHttpService<MedicationHeaderModel, MedicationHeaderModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the MedicationHeaderProperties classFragment here] off begin
			fragment MedicationHeaderProperties on MedicationHeader {
				...MedicationHeaderBaseProperties
				medicationNumber
				dispensingType
			...
			# % protected region % [Modify the MedicationHeaderProperties classFragment here] end
			${super.fragments('MedicationHeader').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<MedicationHeaderModel>> {
		...
		return  this.apollo.query<PassableStateConfig<MedicationHeaderModel>>(
			{
				query: gql`
					query Count {
						totalCount: countMedicationHeaders
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<MedicationHeaderModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<MedicationHeaderModel>> {
		...
		return this.apollo.query<PassableStateConfig<MedicationHeaderModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						MedicationHeaderById: medicationHeaderById(id: $id) {
							...MedicationHeaderProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.MedicationHeaderById as MedicationHeaderModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<MedicationHeaderModel>> {
		...
		return this.apollo.query<PassableStateConfig<MedicationHeaderModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						medicationHeaders: medicationHeaders(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...MedicationHeaderProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countMedicationHeaders(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.medicationHeaders as MedicationHeaderModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<MedicationHeaderModel>> {
		...
		return this.apollo.query<PassableStateConfig<MedicationHeaderModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						medicationHeaders: lastMedicationHeaders(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...MedicationHeaderProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: MedicationHeaderModel, queryParams?: QueryParams): Observable<PassableStateConfig<MedicationHeaderModel>> {
		...
		const successMessage = 'Created Medication Header entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($medicationHeader: MedicationHeaderInput!, $persistRelations: Boolean) {
						medicationHeader: createMedicationHeader(medicationHeader: $medicationHeader, persistRelations: $persistRelations) {
							...MedicationHeaderProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.medicationHeader as MedicationHeaderModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: MedicationHeaderModel[], queryParams?: QueryParams): Observable<PassableStateConfig<MedicationHeaderModel>> {
		...
		const successMessage = 'Created Multiple Medication Header entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($medicationHeaders: [MedicationHeaderInput!]!) {
						medicationHeader: createAllMedicationHeader(medicationHeaders: $medicationHeaders) {
							...MedicationHeaderProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					medicationHeaders: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.medicationHeader as MedicationHeaderModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: MedicationHeaderModel, queryParams?: QueryParams): Observable<PassableStateConfig<MedicationHeaderModel>> {
		...
		const successMessage = 'Updated Medication Header entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($medicationHeader: MedicationHeaderInput!, $persistRelations: Boolean) {
						medicationHeader: updateMedicationHeader(medicationHeader: $medicationHeader, persistRelations: $persistRelations) {
							...MedicationHeaderProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: MedicationHeaderModel[], queryParams?: QueryParams): Observable<PassableStateConfig<MedicationHeaderModel>> {
		...
		const successMessage = 'Update Multiple Medication Header entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($medicationHeaders: [MedicationHeaderInput!]!) {
						medicationHeader: updateAllMedicationHeader(medicationHeaders: $medicationHeaders) {
							...MedicationHeaderProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<MedicationHeaderModel>> {
		...
		const successMessage = 'Deleted Medication Header entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($medicationHeaderId: ID!) {
						medicationHeaderId: deleteMedicationHeaderById(medicationHeaderId: $medicationHeaderId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.medicationHeaderId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<MedicationHeaderModel>> {
		...
		const successMessage = 'Deleted selected Medication Header entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($medicationHeaderIds: [ID!]!){
						deleteMedicationHeaderExcludingIds(medicationHeaderIds: $medicationHeaderIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.medicationHeaderIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<MedicationHeaderModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($medicationHeaderIds: [ID!]!) {
						medicationHeaderIds: deleteAllMedicationHeaderByIds(medicationHeaderIds: $medicationHeaderIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<MedicationHeaderModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<MedicationHeaderModel>>(
			...
			map(result => {
				let audits: MedicationHeaderModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new MedicationHeaderModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<MedicationHeaderModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<MedicationHeaderModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($medicationHeaderId: ID!) {
						audits: medicationHeaderAuditsByEntityId(medicationHeaderId: $medicationHeaderId) {
							entity {
								...MedicationHeaderProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<MedicationHeaderModel>> {
		const url = environment.API_URL + '/api/medicationheader/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<MedicationHeaderModel>> {
		const url = environment.API_URL + '/api/medicationheader/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<MedicationHeaderModel>> {
		let apiUrl = environment.API_URL + '/api/medicationheader/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<MedicationHeaderModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/medicationheader/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Medication Header entities')),
