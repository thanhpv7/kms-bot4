...
import {PharmacySetupModelAudit} from '../../models/pharmacySetup/pharmacy_setup.model.state';
...
/**
 * Pharmacy Setup service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class PharmacySetupService extends AbstractHttpService<PharmacySetupModel, PharmacySetupModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the PharmacySetupProperties classFragment here] off begin
			fragment PharmacySetupProperties on PharmacySetup {
				...PharmacySetupBaseProperties
				hospitalPharmacy
				headOfPharmacy
				pharmacistLicenseNo
				labelSetup
			}
			# % protected region % [Modify the PharmacySetupProperties classFragment here] end
			${super.fragments('PharmacySetup').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<PharmacySetupModel>> {
		...
		return  this.apollo.query<PassableStateConfig<PharmacySetupModel>>(
			{
				query: gql`
					query Count {
						totalCount: countPharmacySetups
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<PharmacySetupModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<PharmacySetupModel>> {
		...
		return this.apollo.query<PassableStateConfig<PharmacySetupModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						PharmacySetupById: pharmacySetupById(id: $id) {
							...PharmacySetupProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.PharmacySetupById as PharmacySetupModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PharmacySetupModel>> {
		...
		return this.apollo.query<PassableStateConfig<PharmacySetupModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						pharmacySetups: pharmacySetups(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...PharmacySetupProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countPharmacySetups(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.pharmacySetups as PharmacySetupModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PharmacySetupModel>> {
		...
		return this.apollo.query<PassableStateConfig<PharmacySetupModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						pharmacySetups: lastPharmacySetups(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...PharmacySetupProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: PharmacySetupModel, queryParams?: QueryParams): Observable<PassableStateConfig<PharmacySetupModel>> {
		...
		const successMessage = 'Created Pharmacy Setup entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($pharmacySetup: PharmacySetupInput!, $persistRelations: Boolean) {
						pharmacySetup: createPharmacySetup(pharmacySetup: $pharmacySetup, persistRelations: $persistRelations) {
							...PharmacySetupProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.pharmacySetup as PharmacySetupModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: PharmacySetupModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PharmacySetupModel>> {
		...
		const successMessage = 'Created Multiple Pharmacy Setup entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($pharmacySetups: [PharmacySetupInput!]!) {
						pharmacySetup: createAllPharmacySetup(pharmacySetups: $pharmacySetups) {
							...PharmacySetupProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					pharmacySetups: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.pharmacySetup as PharmacySetupModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: PharmacySetupModel, queryParams?: QueryParams): Observable<PassableStateConfig<PharmacySetupModel>> {
		...
		const successMessage = 'Updated Pharmacy Setup entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($pharmacySetup: PharmacySetupInput!, $persistRelations: Boolean) {
						pharmacySetup: updatePharmacySetup(pharmacySetup: $pharmacySetup, persistRelations: $persistRelations) {
							...PharmacySetupProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: PharmacySetupModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PharmacySetupModel>> {
		...
		const successMessage = 'Update Multiple Pharmacy Setup entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($pharmacySetups: [PharmacySetupInput!]!) {
						pharmacySetup: updateAllPharmacySetup(pharmacySetups: $pharmacySetups) {
							...PharmacySetupProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<PharmacySetupModel>> {
		...
		const successMessage = 'Deleted Pharmacy Setup entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($pharmacySetupId: ID!) {
						pharmacySetupId: deletePharmacySetupById(pharmacySetupId: $pharmacySetupId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.pharmacySetupId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<PharmacySetupModel>> {
		...
		const successMessage = 'Deleted selected Pharmacy Setup entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($pharmacySetupIds: [ID!]!){
						deletePharmacySetupExcludingIds(pharmacySetupIds: $pharmacySetupIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.pharmacySetupIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<PharmacySetupModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($pharmacySetupIds: [ID!]!) {
						pharmacySetupIds: deleteAllPharmacySetupByIds(pharmacySetupIds: $pharmacySetupIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<PharmacySetupModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PharmacySetupModel>>(
			...
			map(result => {
				let audits: PharmacySetupModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new PharmacySetupModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<PharmacySetupModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PharmacySetupModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($pharmacySetupId: ID!) {
						audits: pharmacySetupAuditsByEntityId(pharmacySetupId: $pharmacySetupId) {
							entity {
								...PharmacySetupProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<PharmacySetupModel>> {
		const url = environment.API_URL + '/api/pharmacysetup/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<PharmacySetupModel>> {
		const url = environment.API_URL + '/api/pharmacysetup/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<PharmacySetupModel>> {
		let apiUrl = environment.API_URL + '/api/pharmacysetup/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<PharmacySetupModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/pharmacysetup/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Pharmacy Setup entities')),
