...
import {NhisInvestigationModel} from '../../models/nhisInvestigation/nhis_investigation.model';
import {NhisInvestigationModelAudit} from '../../models/nhisInvestigation/nhis_investigation.model.state';
...
/**
 * NHIS Investigation service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class NhisInvestigationService extends AbstractHttpService<NhisInvestigationModel, NhisInvestigationModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the NhisInvestigationProperties classFragment here] off begin
			fragment NhisInvestigationProperties on NhisInvestigation {
				...NhisInvestigationBaseProperties
				gdrgCode
				description
				category
				price
			...
			# % protected region % [Modify the NhisInvestigationProperties classFragment here] end
			${super.fragments('NhisInvestigation').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<NhisInvestigationModel>> {
		...
		return  this.apollo.query<PassableStateConfig<NhisInvestigationModel>>(
			{
				query: gql`
					query Count {
						totalCount: countNhisInvestigations
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<NhisInvestigationModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<NhisInvestigationModel>> {
		...
		return this.apollo.query<PassableStateConfig<NhisInvestigationModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						NhisInvestigationById: nhisInvestigationById(id: $id) {
							...NhisInvestigationProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.NhisInvestigationById as NhisInvestigationModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<NhisInvestigationModel>> {
		...
		return this.apollo.query<PassableStateConfig<NhisInvestigationModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						nhisInvestigations: nhisInvestigations(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...NhisInvestigationProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countNhisInvestigations(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.nhisInvestigations as NhisInvestigationModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<NhisInvestigationModel>> {
		...
		return this.apollo.query<PassableStateConfig<NhisInvestigationModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						nhisInvestigations: lastNhisInvestigations(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...NhisInvestigationProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: NhisInvestigationModel, queryParams?: QueryParams): Observable<PassableStateConfig<NhisInvestigationModel>> {
		...
		const successMessage = 'Created NHIS Investigation entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($nhisInvestigation: NhisInvestigationInput!, $persistRelations: Boolean) {
						nhisInvestigation: createNhisInvestigation(nhisInvestigation: $nhisInvestigation, persistRelations: $persistRelations) {
							...NhisInvestigationProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.nhisInvestigation as NhisInvestigationModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: NhisInvestigationModel[], queryParams?: QueryParams): Observable<PassableStateConfig<NhisInvestigationModel>> {
		...
		const successMessage = 'Created Multiple NHIS Investigation entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($nhisInvestigations: [NhisInvestigationInput!]!) {
						nhisInvestigation: createAllNhisInvestigation(nhisInvestigations: $nhisInvestigations) {
							...NhisInvestigationProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					nhisInvestigations: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.nhisInvestigation as NhisInvestigationModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: NhisInvestigationModel, queryParams?: QueryParams): Observable<PassableStateConfig<NhisInvestigationModel>> {
		...
		const successMessage = 'Updated NHIS Investigation entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($nhisInvestigation: NhisInvestigationInput!, $persistRelations: Boolean) {
						nhisInvestigation: updateNhisInvestigation(nhisInvestigation: $nhisInvestigation, persistRelations: $persistRelations) {
							...NhisInvestigationProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: NhisInvestigationModel[], queryParams?: QueryParams): Observable<PassableStateConfig<NhisInvestigationModel>> {
		...
		const successMessage = 'Update Multiple NHIS Investigation entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($nhisInvestigations: [NhisInvestigationInput!]!) {
						nhisInvestigation: updateAllNhisInvestigation(nhisInvestigations: $nhisInvestigations) {
							...NhisInvestigationProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<NhisInvestigationModel>> {
		...
		const successMessage = 'Deleted NHIS Investigation entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($nhisInvestigationId: ID!) {
						nhisInvestigationId: deleteNhisInvestigationById(nhisInvestigationId: $nhisInvestigationId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.nhisInvestigationId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<NhisInvestigationModel>> {
		...
		const successMessage = 'Deleted selected NHIS Investigation entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($nhisInvestigationIds: [ID!]!){
						deleteNhisInvestigationExcludingIds(nhisInvestigationIds: $nhisInvestigationIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.nhisInvestigationIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<NhisInvestigationModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($nhisInvestigationIds: [ID!]!) {
						nhisInvestigationIds: deleteAllNhisInvestigationByIds(nhisInvestigationIds: $nhisInvestigationIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<NhisInvestigationModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<NhisInvestigationModel>>(
			{
				query: gql`
					query GetAudits {
						audits: nhisInvestigationAudits {
							entity {
								...NhisInvestigationProperties
							}
							timestamp
			...
			map(result => {
				let audits: NhisInvestigationModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new NhisInvestigationModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<NhisInvestigationModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<NhisInvestigationModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($nhisInvestigationId: ID!) {
						audits: nhisInvestigationAuditsByEntityId(nhisInvestigationId: $nhisInvestigationId) {
							entity {
								...NhisInvestigationProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<NhisInvestigationModel>> {
		const url = environment.API_URL + '/api/nhisinvestigation/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<NhisInvestigationModel>> {
		const url = environment.API_URL + '/api/nhisinvestigation/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<NhisInvestigationModel>> {
		let apiUrl = environment.API_URL + '/api/nhisinvestigation/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<NhisInvestigationModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/nhisinvestigation/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' NHIS Investigation entities')),
