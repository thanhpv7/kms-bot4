...
import {InventoryAdjustmentModel} from '../../models/inventoryAdjustment/inventory_adjustment.model';
import {InventoryAdjustmentModelAudit} from '../../models/inventoryAdjustment/inventory_adjustment.model.state';
...
/**
 * Inventory Adjustment service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class InventoryAdjustmentService extends AbstractHttpService<InventoryAdjustmentModel, InventoryAdjustmentModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the InventoryAdjustmentProperties classFragment here] off begin
			fragment InventoryAdjustmentProperties on InventoryAdjustment {
				...InventoryAdjustmentBaseProperties
				adjustmentNumber
				approvalStatus
				transactionDate
				transactionType
			...
			# % protected region % [Modify the InventoryAdjustmentProperties classFragment here] end
			${super.fragments('InventoryAdjustment').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<InventoryAdjustmentModel>> {
		...
		return  this.apollo.query<PassableStateConfig<InventoryAdjustmentModel>>(
			{
				query: gql`
					query Count {
						totalCount: countInventoryAdjustments
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<InventoryAdjustmentModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<InventoryAdjustmentModel>> {
		...
		return this.apollo.query<PassableStateConfig<InventoryAdjustmentModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						InventoryAdjustmentById: inventoryAdjustmentById(id: $id) {
							...InventoryAdjustmentProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.InventoryAdjustmentById as InventoryAdjustmentModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<InventoryAdjustmentModel>> {
		...
		return this.apollo.query<PassableStateConfig<InventoryAdjustmentModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						inventoryAdjustments: inventoryAdjustments(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...InventoryAdjustmentProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countInventoryAdjustments(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.inventoryAdjustments as InventoryAdjustmentModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<InventoryAdjustmentModel>> {
		...
		return this.apollo.query<PassableStateConfig<InventoryAdjustmentModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						inventoryAdjustments: lastInventoryAdjustments(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...InventoryAdjustmentProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: InventoryAdjustmentModel, queryParams?: QueryParams): Observable<PassableStateConfig<InventoryAdjustmentModel>> {
		...
		const successMessage = 'Created Inventory Adjustment entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($inventoryAdjustment: InventoryAdjustmentInput!, $persistRelations: Boolean) {
						inventoryAdjustment: createInventoryAdjustment(inventoryAdjustment: $inventoryAdjustment, persistRelations: $persistRelations) {
							...InventoryAdjustmentProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.inventoryAdjustment as InventoryAdjustmentModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: InventoryAdjustmentModel[], queryParams?: QueryParams): Observable<PassableStateConfig<InventoryAdjustmentModel>> {
		...
		const successMessage = 'Created Multiple Inventory Adjustment entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($inventoryAdjustments: [InventoryAdjustmentInput!]!) {
						inventoryAdjustment: createAllInventoryAdjustment(inventoryAdjustments: $inventoryAdjustments) {
							...InventoryAdjustmentProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					inventoryAdjustments: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.inventoryAdjustment as InventoryAdjustmentModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: InventoryAdjustmentModel, queryParams?: QueryParams): Observable<PassableStateConfig<InventoryAdjustmentModel>> {
		...
		const successMessage = 'Updated Inventory Adjustment entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($inventoryAdjustment: InventoryAdjustmentInput!, $persistRelations: Boolean) {
						inventoryAdjustment: updateInventoryAdjustment(inventoryAdjustment: $inventoryAdjustment, persistRelations: $persistRelations) {
							...InventoryAdjustmentProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: InventoryAdjustmentModel[], queryParams?: QueryParams): Observable<PassableStateConfig<InventoryAdjustmentModel>> {
		...
		const successMessage = 'Update Multiple Inventory Adjustment entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($inventoryAdjustments: [InventoryAdjustmentInput!]!) {
						inventoryAdjustment: updateAllInventoryAdjustment(inventoryAdjustments: $inventoryAdjustments) {
							...InventoryAdjustmentProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<InventoryAdjustmentModel>> {
		...
		const successMessage = 'Deleted Inventory Adjustment entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($inventoryAdjustmentId: ID!) {
						inventoryAdjustmentId: deleteInventoryAdjustmentById(inventoryAdjustmentId: $inventoryAdjustmentId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.inventoryAdjustmentId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<InventoryAdjustmentModel>> {
		...
		const successMessage = 'Deleted selected Inventory Adjustment entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($inventoryAdjustmentIds: [ID!]!){
						deleteInventoryAdjustmentExcludingIds(inventoryAdjustmentIds: $inventoryAdjustmentIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.inventoryAdjustmentIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<InventoryAdjustmentModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($inventoryAdjustmentIds: [ID!]!) {
						inventoryAdjustmentIds: deleteAllInventoryAdjustmentByIds(inventoryAdjustmentIds: $inventoryAdjustmentIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<InventoryAdjustmentModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<InventoryAdjustmentModel>>(
			{
				query: gql`
					query GetAudits {
						audits: inventoryAdjustmentAudits {
							entity {
								...InventoryAdjustmentProperties
							}
							timestamp
			...
			map(result => {
				let audits: InventoryAdjustmentModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new InventoryAdjustmentModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<InventoryAdjustmentModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<InventoryAdjustmentModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($inventoryAdjustmentId: ID!) {
						audits: inventoryAdjustmentAuditsByEntityId(inventoryAdjustmentId: $inventoryAdjustmentId) {
							entity {
								...InventoryAdjustmentProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<InventoryAdjustmentModel>> {
		const url = environment.API_URL + '/api/inventoryadjustment/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<InventoryAdjustmentModel>> {
		const url = environment.API_URL + '/api/inventoryadjustment/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<InventoryAdjustmentModel>> {
		let apiUrl = environment.API_URL + '/api/inventoryadjustment/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<InventoryAdjustmentModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/inventoryadjustment/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Inventory Adjustment entities')),
