...
import {DiagnosticSupportUserModel} from '../../models/diagnosticSupportUser/diagnostic_support_user.model';
import {DiagnosticSupportUserModelAudit} from '../../models/diagnosticSupportUser/diagnostic_support_user.model.state';
...
/**
 * Diagnostic Support User service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class DiagnosticSupportUserService extends UserService<DiagnosticSupportUserModel, DiagnosticSupportUserModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the DiagnosticSupportUserProperties classFragment here] off begin
			fragment DiagnosticSupportUserProperties on DiagnosticSupportUser {
				...DiagnosticSupportUserUserProperties
			}
			# % protected region % [Modify the DiagnosticSupportUserProperties classFragment here] end
			${super.fragments('DiagnosticSupportUser').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<DiagnosticSupportUserModel>> {
		...
		return  this.apollo.query<PassableStateConfig<DiagnosticSupportUserModel>>(
			{
				query: gql`
					query Count {
						totalCount: countDiagnosticSupportUsers
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<DiagnosticSupportUserModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<DiagnosticSupportUserModel>> {
		...
		return this.apollo.query<PassableStateConfig<DiagnosticSupportUserModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						DiagnosticSupportUserById: diagnosticSupportUserById(id: $id) {
							...DiagnosticSupportUserProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.DiagnosticSupportUserById as DiagnosticSupportUserModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<DiagnosticSupportUserModel>> {
		...
		return this.apollo.query<PassableStateConfig<DiagnosticSupportUserModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						diagnosticSupportUsers: diagnosticSupportUsers(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...DiagnosticSupportUserProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countDiagnosticSupportUsers(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.diagnosticSupportUsers as DiagnosticSupportUserModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<DiagnosticSupportUserModel>> {
		...
		return this.apollo.query<PassableStateConfig<DiagnosticSupportUserModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						diagnosticSupportUsers: lastDiagnosticSupportUsers(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...DiagnosticSupportUserProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: DiagnosticSupportUserModel, queryParams?: QueryParams): Observable<PassableStateConfig<DiagnosticSupportUserModel>> {
		...
		const successMessage = 'Created Diagnostic Support User entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($diagnosticSupportUser: DiagnosticSupportUserInput!, $persistRelations: Boolean) {
						diagnosticSupportUser: createDiagnosticSupportUser(diagnosticSupportUser: $diagnosticSupportUser, persistRelations: $persistRelations) {
							...DiagnosticSupportUserProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.diagnosticSupportUser as DiagnosticSupportUserModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: DiagnosticSupportUserModel[], queryParams?: QueryParams): Observable<PassableStateConfig<DiagnosticSupportUserModel>> {
		...
		const successMessage = 'Created Multiple Diagnostic Support User entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($diagnosticSupportUsers: [DiagnosticSupportUserInput!]!) {
						diagnosticSupportUser: createAllDiagnosticSupportUser(diagnosticSupportUsers: $diagnosticSupportUsers) {
							...DiagnosticSupportUserProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					diagnosticSupportUsers: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.diagnosticSupportUser as DiagnosticSupportUserModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: DiagnosticSupportUserModel, queryParams?: QueryParams): Observable<PassableStateConfig<DiagnosticSupportUserModel>> {
		...
		const successMessage = 'Updated Diagnostic Support User entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($diagnosticSupportUser: DiagnosticSupportUserInput!, $persistRelations: Boolean) {
						diagnosticSupportUser: updateDiagnosticSupportUser(diagnosticSupportUser: $diagnosticSupportUser, persistRelations: $persistRelations) {
							...DiagnosticSupportUserProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: DiagnosticSupportUserModel[], queryParams?: QueryParams): Observable<PassableStateConfig<DiagnosticSupportUserModel>> {
		...
		const successMessage = 'Update Multiple Diagnostic Support User entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($diagnosticSupportUsers: [DiagnosticSupportUserInput!]!) {
						diagnosticSupportUser: updateAllDiagnosticSupportUser(diagnosticSupportUsers: $diagnosticSupportUsers) {
							...DiagnosticSupportUserProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<DiagnosticSupportUserModel>> {
		...
		const successMessage = 'Deleted Diagnostic Support User entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($diagnosticSupportUserId: ID!) {
						diagnosticSupportUserId: deleteDiagnosticSupportUserById(diagnosticSupportUserId: $diagnosticSupportUserId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.diagnosticSupportUserId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<DiagnosticSupportUserModel>> {
		...
		const successMessage = 'Deleted selected Diagnostic Support User entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($diagnosticSupportUserIds: [ID!]!){
						deleteDiagnosticSupportUserExcludingIds(diagnosticSupportUserIds: $diagnosticSupportUserIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.diagnosticSupportUserIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<DiagnosticSupportUserModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($diagnosticSupportUserIds: [ID!]!) {
						diagnosticSupportUserIds: deleteAllDiagnosticSupportUserByIds(diagnosticSupportUserIds: $diagnosticSupportUserIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<DiagnosticSupportUserModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<DiagnosticSupportUserModel>>(
			{
				query: gql`
					query GetAudits {
						audits: diagnosticSupportUserAudits {
							entity {
								...DiagnosticSupportUserProperties
							}
							timestamp
			...
			map(result => {
				let audits: DiagnosticSupportUserModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new DiagnosticSupportUserModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<DiagnosticSupportUserModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<DiagnosticSupportUserModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($diagnosticSupportUserId: ID!) {
						audits: diagnosticSupportUserAuditsByEntityId(diagnosticSupportUserId: $diagnosticSupportUserId) {
							entity {
								...DiagnosticSupportUserProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<DiagnosticSupportUserModel>> {
		const url = environment.API_URL + '/api/diagnosticsupportuser/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<DiagnosticSupportUserModel>> {
		const url = environment.API_URL + '/api/diagnosticsupportuser/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<DiagnosticSupportUserModel>> {
		let apiUrl = environment.API_URL + '/api/diagnosticsupportuser/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<DiagnosticSupportUserModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/diagnosticsupportuser/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Diagnostic Support User entities')),
