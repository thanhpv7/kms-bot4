...
import {PcareReferensiSaranaModel} from '../../models/pcareReferensiSarana/pcare_referensi_sarana.model';
import {PcareReferensiSaranaModelAudit} from '../../models/pcareReferensiSarana/pcare_referensi_sarana.model.state';
...
/**
 * PCare Referensi Sarana service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class PcareReferensiSaranaService extends AbstractHttpService<PcareReferensiSaranaModel, PcareReferensiSaranaModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the PcareReferensiSaranaProperties classFragment here] off begin
			fragment PcareReferensiSaranaProperties on PcareReferensiSarana {
				...PcareReferensiSaranaBaseProperties
				kodeSarana
				namaSarana
			}
			# % protected region % [Modify the PcareReferensiSaranaProperties classFragment here] end
			${super.fragments('PcareReferensiSarana').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<PcareReferensiSaranaModel>> {
		...
		return  this.apollo.query<PassableStateConfig<PcareReferensiSaranaModel>>(
			{
				query: gql`
					query Count {
						totalCount: countPcareReferensiSaranas
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<PcareReferensiSaranaModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<PcareReferensiSaranaModel>> {
		...
		return this.apollo.query<PassableStateConfig<PcareReferensiSaranaModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						PcareReferensiSaranaById: pcareReferensiSaranaById(id: $id) {
							...PcareReferensiSaranaProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.PcareReferensiSaranaById as PcareReferensiSaranaModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PcareReferensiSaranaModel>> {
		...
		return this.apollo.query<PassableStateConfig<PcareReferensiSaranaModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						pcareReferensiSaranas: pcareReferensiSaranas(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...PcareReferensiSaranaProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countPcareReferensiSaranas(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.pcareReferensiSaranas as PcareReferensiSaranaModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PcareReferensiSaranaModel>> {
		...
		return this.apollo.query<PassableStateConfig<PcareReferensiSaranaModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						pcareReferensiSaranas: lastPcareReferensiSaranas(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...PcareReferensiSaranaProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: PcareReferensiSaranaModel, queryParams?: QueryParams): Observable<PassableStateConfig<PcareReferensiSaranaModel>> {
		...
		const successMessage = 'Created PCare Referensi Sarana entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($pcareReferensiSarana: PcareReferensiSaranaInput!, $persistRelations: Boolean) {
						pcareReferensiSarana: createPcareReferensiSarana(pcareReferensiSarana: $pcareReferensiSarana, persistRelations: $persistRelations) {
							...PcareReferensiSaranaProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.pcareReferensiSarana as PcareReferensiSaranaModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: PcareReferensiSaranaModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PcareReferensiSaranaModel>> {
		...
		const successMessage = 'Created Multiple PCare Referensi Sarana entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($pcareReferensiSaranas: [PcareReferensiSaranaInput!]!) {
						pcareReferensiSarana: createAllPcareReferensiSarana(pcareReferensiSaranas: $pcareReferensiSaranas) {
							...PcareReferensiSaranaProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					pcareReferensiSaranas: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.pcareReferensiSarana as PcareReferensiSaranaModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: PcareReferensiSaranaModel, queryParams?: QueryParams): Observable<PassableStateConfig<PcareReferensiSaranaModel>> {
		...
		const successMessage = 'Updated PCare Referensi Sarana entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($pcareReferensiSarana: PcareReferensiSaranaInput!, $persistRelations: Boolean) {
						pcareReferensiSarana: updatePcareReferensiSarana(pcareReferensiSarana: $pcareReferensiSarana, persistRelations: $persistRelations) {
							...PcareReferensiSaranaProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: PcareReferensiSaranaModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PcareReferensiSaranaModel>> {
		...
		const successMessage = 'Update Multiple PCare Referensi Sarana entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($pcareReferensiSaranas: [PcareReferensiSaranaInput!]!) {
						pcareReferensiSarana: updateAllPcareReferensiSarana(pcareReferensiSaranas: $pcareReferensiSaranas) {
							...PcareReferensiSaranaProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<PcareReferensiSaranaModel>> {
		...
		const successMessage = 'Deleted PCare Referensi Sarana entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($pcareReferensiSaranaId: ID!) {
						pcareReferensiSaranaId: deletePcareReferensiSaranaById(pcareReferensiSaranaId: $pcareReferensiSaranaId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.pcareReferensiSaranaId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<PcareReferensiSaranaModel>> {
		...
		const successMessage = 'Deleted selected PCare Referensi Sarana entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($pcareReferensiSaranaIds: [ID!]!){
						deletePcareReferensiSaranaExcludingIds(pcareReferensiSaranaIds: $pcareReferensiSaranaIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.pcareReferensiSaranaIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<PcareReferensiSaranaModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($pcareReferensiSaranaIds: [ID!]!) {
						pcareReferensiSaranaIds: deleteAllPcareReferensiSaranaByIds(pcareReferensiSaranaIds: $pcareReferensiSaranaIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<PcareReferensiSaranaModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PcareReferensiSaranaModel>>(
			{
				query: gql`
					query GetAudits {
						audits: pcareReferensiSaranaAudits {
							entity {
								...PcareReferensiSaranaProperties
							}
							timestamp
			...
			map(result => {
				let audits: PcareReferensiSaranaModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new PcareReferensiSaranaModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<PcareReferensiSaranaModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PcareReferensiSaranaModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($pcareReferensiSaranaId: ID!) {
						audits: pcareReferensiSaranaAuditsByEntityId(pcareReferensiSaranaId: $pcareReferensiSaranaId) {
							entity {
								...PcareReferensiSaranaProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<PcareReferensiSaranaModel>> {
		const url = environment.API_URL + '/api/pcarereferensisarana/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<PcareReferensiSaranaModel>> {
		const url = environment.API_URL + '/api/pcarereferensisarana/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<PcareReferensiSaranaModel>> {
		let apiUrl = environment.API_URL + '/api/pcarereferensisarana/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<PcareReferensiSaranaModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/pcarereferensisarana/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' PCare Referensi Sarana entities')),
