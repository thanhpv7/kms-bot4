...
import {RetailPharmacyStockDetailModelAudit} from '../../models/retailPharmacyStockDetail/retail_pharmacy_stock_detail.model.state';
...
/**
 * Retail Pharmacy Stock Detail service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class RetailPharmacyStockDetailService extends AbstractHttpService<RetailPharmacyStockDetailModel, RetailPharmacyStockDetailModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the RetailPharmacyStockDetailProperties classFragment here] off begin
			fragment RetailPharmacyStockDetailProperties on RetailPharmacyStockDetail {
				...RetailPharmacyStockDetailBaseProperties
				supplyStockGroup
				uoi
				availableQuantity
				quantity
			...
			# % protected region % [Modify the RetailPharmacyStockDetailProperties classFragment here] end
			${super.fragments('RetailPharmacyStockDetail').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<RetailPharmacyStockDetailModel>> {
		...
		return  this.apollo.query<PassableStateConfig<RetailPharmacyStockDetailModel>>(
			{
				query: gql`
					query Count {
						totalCount: countRetailPharmacyStockDetails
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<RetailPharmacyStockDetailModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<RetailPharmacyStockDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<RetailPharmacyStockDetailModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						RetailPharmacyStockDetailById: retailPharmacyStockDetailById(id: $id) {
							...RetailPharmacyStockDetailProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.RetailPharmacyStockDetailById as RetailPharmacyStockDetailModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<RetailPharmacyStockDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<RetailPharmacyStockDetailModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						retailPharmacyStockDetails: retailPharmacyStockDetails(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...RetailPharmacyStockDetailProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countRetailPharmacyStockDetails(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.retailPharmacyStockDetails as RetailPharmacyStockDetailModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<RetailPharmacyStockDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<RetailPharmacyStockDetailModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						retailPharmacyStockDetails: lastRetailPharmacyStockDetails(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...RetailPharmacyStockDetailProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: RetailPharmacyStockDetailModel, queryParams?: QueryParams): Observable<PassableStateConfig<RetailPharmacyStockDetailModel>> {
		...
		const successMessage = 'Created Retail Pharmacy Stock Detail entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($retailPharmacyStockDetail: RetailPharmacyStockDetailInput!, $persistRelations: Boolean) {
						retailPharmacyStockDetail: createRetailPharmacyStockDetail(retailPharmacyStockDetail: $retailPharmacyStockDetail, persistRelations: $persistRelations) {
							...RetailPharmacyStockDetailProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.retailPharmacyStockDetail as RetailPharmacyStockDetailModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: RetailPharmacyStockDetailModel[], queryParams?: QueryParams): Observable<PassableStateConfig<RetailPharmacyStockDetailModel>> {
		...
		const successMessage = 'Created Multiple Retail Pharmacy Stock Detail entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($retailPharmacyStockDetails: [RetailPharmacyStockDetailInput!]!) {
						retailPharmacyStockDetail: createAllRetailPharmacyStockDetail(retailPharmacyStockDetails: $retailPharmacyStockDetails) {
							...RetailPharmacyStockDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					retailPharmacyStockDetails: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.retailPharmacyStockDetail as RetailPharmacyStockDetailModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: RetailPharmacyStockDetailModel, queryParams?: QueryParams): Observable<PassableStateConfig<RetailPharmacyStockDetailModel>> {
		...
		const successMessage = 'Updated Retail Pharmacy Stock Detail entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($retailPharmacyStockDetail: RetailPharmacyStockDetailInput!, $persistRelations: Boolean) {
						retailPharmacyStockDetail: updateRetailPharmacyStockDetail(retailPharmacyStockDetail: $retailPharmacyStockDetail, persistRelations: $persistRelations) {
							...RetailPharmacyStockDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: RetailPharmacyStockDetailModel[], queryParams?: QueryParams): Observable<PassableStateConfig<RetailPharmacyStockDetailModel>> {
		...
		const successMessage = 'Update Multiple Retail Pharmacy Stock Detail entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($retailPharmacyStockDetails: [RetailPharmacyStockDetailInput!]!) {
						retailPharmacyStockDetail: updateAllRetailPharmacyStockDetail(retailPharmacyStockDetails: $retailPharmacyStockDetails) {
							...RetailPharmacyStockDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<RetailPharmacyStockDetailModel>> {
		...
		const successMessage = 'Deleted Retail Pharmacy Stock Detail entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($retailPharmacyStockDetailId: ID!) {
						retailPharmacyStockDetailId: deleteRetailPharmacyStockDetailById(retailPharmacyStockDetailId: $retailPharmacyStockDetailId)
				...
				`,
				variables: {
					retailPharmacyStockDetailId: id,
			...
			map(result => {
				...
				return {
					targetModelId: result.data.retailPharmacyStockDetailId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<RetailPharmacyStockDetailModel>> {
		...
		const successMessage = 'Deleted selected Retail Pharmacy Stock Detail entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($retailPharmacyStockDetailIds: [ID!]!){
						deleteRetailPharmacyStockDetailExcludingIds(retailPharmacyStockDetailIds: $retailPharmacyStockDetailIds)
				...
				`,
				variables: {
					retailPharmacyStockDetailIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.retailPharmacyStockDetailIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<RetailPharmacyStockDetailModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($retailPharmacyStockDetailIds: [ID!]!) {
						retailPharmacyStockDetailIds: deleteAllRetailPharmacyStockDetailByIds(retailPharmacyStockDetailIds: $retailPharmacyStockDetailIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<RetailPharmacyStockDetailModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<RetailPharmacyStockDetailModel>>(
			{
				query: gql`
					query GetAudits {
						audits: retailPharmacyStockDetailAudits {
							entity {
								...RetailPharmacyStockDetailProperties
							}
							timestamp
			...
			map(result => {
				let audits: RetailPharmacyStockDetailModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new RetailPharmacyStockDetailModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<RetailPharmacyStockDetailModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<RetailPharmacyStockDetailModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($retailPharmacyStockDetailId: ID!) {
						audits: retailPharmacyStockDetailAuditsByEntityId(retailPharmacyStockDetailId: $retailPharmacyStockDetailId) {
							entity {
								...RetailPharmacyStockDetailProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<RetailPharmacyStockDetailModel>> {
		const url = environment.API_URL + '/api/retailpharmacystockdetail/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<RetailPharmacyStockDetailModel>> {
		const url = environment.API_URL + '/api/retailpharmacystockdetail/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<RetailPharmacyStockDetailModel>> {
		let apiUrl = environment.API_URL + '/api/retailpharmacystockdetail/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<RetailPharmacyStockDetailModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/retailpharmacystockdetail/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Retail Pharmacy Stock Detail entities')),
