...
import {BpjsUpdateDismissalDateModel} from '../../models/bpjsUpdateDismissalDate/bpjs_update_dismissal_date.model';
import {BpjsUpdateDismissalDateModelAudit} from '../../models/bpjsUpdateDismissalDate/bpjs_update_dismissal_date.model.state';
...
/**
 * BPJS Update Dismissal Date service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BpjsUpdateDismissalDateService extends AbstractHttpService<BpjsUpdateDismissalDateModel, BpjsUpdateDismissalDateModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BpjsUpdateDismissalDateProperties classFragment here] off begin
			fragment BpjsUpdateDismissalDateProperties on BpjsUpdateDismissalDate {
				...BpjsUpdateDismissalDateBaseProperties
				sepNo
				dismissalType
				deathCertificateLetterNo
				timeOfDeath
				dismissalDate
				policeReportNo
			}
			# % protected region % [Modify the BpjsUpdateDismissalDateProperties classFragment here] end
			${super.fragments('BpjsUpdateDismissalDate').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BpjsUpdateDismissalDateModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BpjsUpdateDismissalDateModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBpjsUpdateDismissalDates
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BpjsUpdateDismissalDateModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsUpdateDismissalDateModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsUpdateDismissalDateModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BpjsUpdateDismissalDateById: bpjsUpdateDismissalDateById(id: $id) {
							...BpjsUpdateDismissalDateProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BpjsUpdateDismissalDateById as BpjsUpdateDismissalDateModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsUpdateDismissalDateModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsUpdateDismissalDateModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						bpjsUpdateDismissalDates: bpjsUpdateDismissalDates(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BpjsUpdateDismissalDateProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBpjsUpdateDismissalDates(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.bpjsUpdateDismissalDates as BpjsUpdateDismissalDateModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsUpdateDismissalDateModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsUpdateDismissalDateModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						bpjsUpdateDismissalDates: lastBpjsUpdateDismissalDates(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BpjsUpdateDismissalDateProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BpjsUpdateDismissalDateModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsUpdateDismissalDateModel>> {
		...
		const successMessage = 'Created BPJS Update Dismissal Date entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($bpjsUpdateDismissalDate: BpjsUpdateDismissalDateInput!, $persistRelations: Boolean) {
						bpjsUpdateDismissalDate: createBpjsUpdateDismissalDate(bpjsUpdateDismissalDate: $bpjsUpdateDismissalDate, persistRelations: $persistRelations) {
							...BpjsUpdateDismissalDateProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.bpjsUpdateDismissalDate as BpjsUpdateDismissalDateModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BpjsUpdateDismissalDateModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsUpdateDismissalDateModel>> {
		...
		const successMessage = 'Created Multiple BPJS Update Dismissal Date entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($bpjsUpdateDismissalDates: [BpjsUpdateDismissalDateInput!]!) {
						bpjsUpdateDismissalDate: createAllBpjsUpdateDismissalDate(bpjsUpdateDismissalDates: $bpjsUpdateDismissalDates) {
							...BpjsUpdateDismissalDateProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					bpjsUpdateDismissalDates: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.bpjsUpdateDismissalDate as BpjsUpdateDismissalDateModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BpjsUpdateDismissalDateModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsUpdateDismissalDateModel>> {
		...
		const successMessage = 'Updated BPJS Update Dismissal Date entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($bpjsUpdateDismissalDate: BpjsUpdateDismissalDateInput!, $persistRelations: Boolean) {
						bpjsUpdateDismissalDate: updateBpjsUpdateDismissalDate(bpjsUpdateDismissalDate: $bpjsUpdateDismissalDate, persistRelations: $persistRelations) {
							...BpjsUpdateDismissalDateProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BpjsUpdateDismissalDateModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsUpdateDismissalDateModel>> {
		...
		const successMessage = 'Update Multiple BPJS Update Dismissal Date entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($bpjsUpdateDismissalDates: [BpjsUpdateDismissalDateInput!]!) {
						bpjsUpdateDismissalDate: updateAllBpjsUpdateDismissalDate(bpjsUpdateDismissalDates: $bpjsUpdateDismissalDates) {
							...BpjsUpdateDismissalDateProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BpjsUpdateDismissalDateModel>> {
		...
		const successMessage = 'Deleted BPJS Update Dismissal Date entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($bpjsUpdateDismissalDateId: ID!) {
						bpjsUpdateDismissalDateId: deleteBpjsUpdateDismissalDateById(bpjsUpdateDismissalDateId: $bpjsUpdateDismissalDateId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.bpjsUpdateDismissalDateId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsUpdateDismissalDateModel>> {
		...
		const successMessage = 'Deleted selected BPJS Update Dismissal Date entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($bpjsUpdateDismissalDateIds: [ID!]!){
						deleteBpjsUpdateDismissalDateExcludingIds(bpjsUpdateDismissalDateIds: $bpjsUpdateDismissalDateIds)
				...
				`,
				variables: {
					bpjsUpdateDismissalDateIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.bpjsUpdateDismissalDateIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BpjsUpdateDismissalDateModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($bpjsUpdateDismissalDateIds: [ID!]!) {
						bpjsUpdateDismissalDateIds: deleteAllBpjsUpdateDismissalDateByIds(bpjsUpdateDismissalDateIds: $bpjsUpdateDismissalDateIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BpjsUpdateDismissalDateModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsUpdateDismissalDateModel>>(
			{
				query: gql`
					query GetAudits {
						audits: bpjsUpdateDismissalDateAudits {
							entity {
								...BpjsUpdateDismissalDateProperties
							}
							timestamp
			...
			map(result => {
				let audits: BpjsUpdateDismissalDateModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BpjsUpdateDismissalDateModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BpjsUpdateDismissalDateModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsUpdateDismissalDateModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($bpjsUpdateDismissalDateId: ID!) {
						audits: bpjsUpdateDismissalDateAuditsByEntityId(bpjsUpdateDismissalDateId: $bpjsUpdateDismissalDateId) {
							entity {
								...BpjsUpdateDismissalDateProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BpjsUpdateDismissalDateModel>> {
		const url = environment.API_URL + '/api/bpjsupdatedismissaldate/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BpjsUpdateDismissalDateModel>> {
		const url = environment.API_URL + '/api/bpjsupdatedismissaldate/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsUpdateDismissalDateModel>> {
		let apiUrl = environment.API_URL + '/api/bpjsupdatedismissaldate/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BpjsUpdateDismissalDateModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/bpjsupdatedismissaldate/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' BPJS Update Dismissal Date entities')),
