...
import {TariffSchemaModelAudit} from '../../models/tariffSchema/tariff_schema.model.state';
...
/**
 * Tariff Schema service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class TariffSchemaService extends AbstractHttpService<TariffSchemaModel, TariffSchemaModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the TariffSchemaProperties classFragment here] off begin
			fragment TariffSchemaProperties on TariffSchema {
				...TariffSchemaBaseProperties
				schemaCode
				schemeName
				startDate
				endDate
			}
			# % protected region % [Modify the TariffSchemaProperties classFragment here] end
			${super.fragments('TariffSchema').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<TariffSchemaModel>> {
		...
		return  this.apollo.query<PassableStateConfig<TariffSchemaModel>>(
			{
				query: gql`
					query Count {
						totalCount: countTariffSchemas
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<TariffSchemaModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<TariffSchemaModel>> {
		...
		return this.apollo.query<PassableStateConfig<TariffSchemaModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						TariffSchemaById: tariffSchemaById(id: $id) {
							...TariffSchemaProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.TariffSchemaById as TariffSchemaModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<TariffSchemaModel>> {
		...
		return this.apollo.query<PassableStateConfig<TariffSchemaModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						tariffSchemas: tariffSchemas(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...TariffSchemaProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countTariffSchemas(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.tariffSchemas as TariffSchemaModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<TariffSchemaModel>> {
		...
		return this.apollo.query<PassableStateConfig<TariffSchemaModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						tariffSchemas: lastTariffSchemas(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...TariffSchemaProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: TariffSchemaModel, queryParams?: QueryParams): Observable<PassableStateConfig<TariffSchemaModel>> {
		...
		const successMessage = 'Created Tariff Schema entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($tariffSchema: TariffSchemaInput!, $persistRelations: Boolean) {
						tariffSchema: createTariffSchema(tariffSchema: $tariffSchema, persistRelations: $persistRelations) {
							...TariffSchemaProperties,
				...
				variables: {
					tariffSchema: {
						...entity.toJSON(),
						baseScheme: entity.baseScheme ? entity.baseScheme?.map((model: TariffFormulaModel) => new TariffFormulaModel(model).toJSON()) : [],
						...
						tariffDefinitions: entity.tariffDefinitions ? entity.tariffDefinitions?.map((model: TariffDefinitionModel) => new TariffDefinitionModel(model).toJSON()) : [],
						tariffScheme: entity.tariffScheme ? entity.tariffScheme?.map((model: TariffFormulaModel) => new TariffFormulaModel(model).toJSON()) : [],
					},
			...
			map(result => {
				...
				return {
					targetModel: result.data.tariffSchema as TariffSchemaModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: TariffSchemaModel[], queryParams?: QueryParams): Observable<PassableStateConfig<TariffSchemaModel>> {
		...
		const successMessage = 'Created Multiple Tariff Schema entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($tariffSchemas: [TariffSchemaInput!]!) {
						tariffSchema: createAllTariffSchema(tariffSchemas: $tariffSchemas) {
							...TariffSchemaProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					tariffSchemas: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.tariffSchema as TariffSchemaModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: TariffSchemaModel, queryParams?: QueryParams): Observable<PassableStateConfig<TariffSchemaModel>> {
		...
		const successMessage = 'Updated Tariff Schema entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($tariffSchema: TariffSchemaInput!, $persistRelations: Boolean) {
						tariffSchema: updateTariffSchema(tariffSchema: $tariffSchema, persistRelations: $persistRelations) {
							...TariffSchemaProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: TariffSchemaModel[], queryParams?: QueryParams): Observable<PassableStateConfig<TariffSchemaModel>> {
		...
		const successMessage = 'Update Multiple Tariff Schema entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($tariffSchemas: [TariffSchemaInput!]!) {
						tariffSchema: updateAllTariffSchema(tariffSchemas: $tariffSchemas) {
							...TariffSchemaProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<TariffSchemaModel>> {
		...
		const successMessage = 'Deleted Tariff Schema entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($tariffSchemaId: ID!) {
						tariffSchemaId: deleteTariffSchemaById(tariffSchemaId: $tariffSchemaId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.tariffSchemaId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<TariffSchemaModel>> {
		...
		const successMessage = 'Deleted selected Tariff Schema entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($tariffSchemaIds: [ID!]!){
						deleteTariffSchemaExcludingIds(tariffSchemaIds: $tariffSchemaIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.tariffSchemaIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<TariffSchemaModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($tariffSchemaIds: [ID!]!) {
						tariffSchemaIds: deleteAllTariffSchemaByIds(tariffSchemaIds: $tariffSchemaIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<TariffSchemaModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<TariffSchemaModel>>(
			...
			map(result => {
				let audits: TariffSchemaModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new TariffSchemaModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<TariffSchemaModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<TariffSchemaModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($tariffSchemaId: ID!) {
						audits: tariffSchemaAuditsByEntityId(tariffSchemaId: $tariffSchemaId) {
							entity {
								...TariffSchemaProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<TariffSchemaModel>> {
		const url = environment.API_URL + '/api/tariffschema/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<TariffSchemaModel>> {
		const url = environment.API_URL + '/api/tariffschema/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<TariffSchemaModel>> {
		let apiUrl = environment.API_URL + '/api/tariffschema/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<TariffSchemaModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/tariffschema/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Tariff Schema entities')),
