...
import {PcareActionExaminationModel} from '../../models/pcareActionExamination/pcare_action_examination.model';
import {PcareActionExaminationModelAudit} from '../../models/pcareActionExamination/pcare_action_examination.model.state';
...
/**
 * PCare Action Examination service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class PcareActionExaminationService extends AbstractHttpService<PcareActionExaminationModel, PcareActionExaminationModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the PcareActionExaminationProperties classFragment here] off begin
			fragment PcareActionExaminationProperties on PcareActionExamination {
				...PcareActionExaminationBaseProperties
				actionCode
				fee
				notes
				kdtindakansk
			...
			# % protected region % [Modify the PcareActionExaminationProperties classFragment here] end
			${super.fragments('PcareActionExamination').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<PcareActionExaminationModel>> {
		...
		return  this.apollo.query<PassableStateConfig<PcareActionExaminationModel>>(
			{
				query: gql`
					query Count {
						totalCount: countPcareActionExaminations
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<PcareActionExaminationModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<PcareActionExaminationModel>> {
		...
		return this.apollo.query<PassableStateConfig<PcareActionExaminationModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						PcareActionExaminationById: pcareActionExaminationById(id: $id) {
							...PcareActionExaminationProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.PcareActionExaminationById as PcareActionExaminationModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PcareActionExaminationModel>> {
		...
		return this.apollo.query<PassableStateConfig<PcareActionExaminationModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						pcareActionExaminations: pcareActionExaminations(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...PcareActionExaminationProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countPcareActionExaminations(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.pcareActionExaminations as PcareActionExaminationModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PcareActionExaminationModel>> {
		...
		return this.apollo.query<PassableStateConfig<PcareActionExaminationModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						pcareActionExaminations: lastPcareActionExaminations(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...PcareActionExaminationProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: PcareActionExaminationModel, queryParams?: QueryParams): Observable<PassableStateConfig<PcareActionExaminationModel>> {
		...
		const successMessage = 'Created PCare Action Examination entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($pcareActionExamination: PcareActionExaminationInput!, $persistRelations: Boolean) {
						pcareActionExamination: createPcareActionExamination(pcareActionExamination: $pcareActionExamination, persistRelations: $persistRelations) {
							...PcareActionExaminationProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.pcareActionExamination as PcareActionExaminationModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: PcareActionExaminationModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PcareActionExaminationModel>> {
		...
		const successMessage = 'Created Multiple PCare Action Examination entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($pcareActionExaminations: [PcareActionExaminationInput!]!) {
						pcareActionExamination: createAllPcareActionExamination(pcareActionExaminations: $pcareActionExaminations) {
							...PcareActionExaminationProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					pcareActionExaminations: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.pcareActionExamination as PcareActionExaminationModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: PcareActionExaminationModel, queryParams?: QueryParams): Observable<PassableStateConfig<PcareActionExaminationModel>> {
		...
		const successMessage = 'Updated PCare Action Examination entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($pcareActionExamination: PcareActionExaminationInput!, $persistRelations: Boolean) {
						pcareActionExamination: updatePcareActionExamination(pcareActionExamination: $pcareActionExamination, persistRelations: $persistRelations) {
							...PcareActionExaminationProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: PcareActionExaminationModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PcareActionExaminationModel>> {
		...
		const successMessage = 'Update Multiple PCare Action Examination entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($pcareActionExaminations: [PcareActionExaminationInput!]!) {
						pcareActionExamination: updateAllPcareActionExamination(pcareActionExaminations: $pcareActionExaminations) {
							...PcareActionExaminationProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<PcareActionExaminationModel>> {
		...
		const successMessage = 'Deleted PCare Action Examination entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($pcareActionExaminationId: ID!) {
						pcareActionExaminationId: deletePcareActionExaminationById(pcareActionExaminationId: $pcareActionExaminationId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.pcareActionExaminationId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<PcareActionExaminationModel>> {
		...
		const successMessage = 'Deleted selected PCare Action Examination entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($pcareActionExaminationIds: [ID!]!){
						deletePcareActionExaminationExcludingIds(pcareActionExaminationIds: $pcareActionExaminationIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.pcareActionExaminationIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<PcareActionExaminationModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($pcareActionExaminationIds: [ID!]!) {
						pcareActionExaminationIds: deleteAllPcareActionExaminationByIds(pcareActionExaminationIds: $pcareActionExaminationIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<PcareActionExaminationModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PcareActionExaminationModel>>(
			{
				query: gql`
					query GetAudits {
						audits: pcareActionExaminationAudits {
							entity {
								...PcareActionExaminationProperties
							}
							timestamp
			...
			map(result => {
				let audits: PcareActionExaminationModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new PcareActionExaminationModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<PcareActionExaminationModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PcareActionExaminationModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($pcareActionExaminationId: ID!) {
						audits: pcareActionExaminationAuditsByEntityId(pcareActionExaminationId: $pcareActionExaminationId) {
							entity {
								...PcareActionExaminationProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<PcareActionExaminationModel>> {
		const url = environment.API_URL + '/api/pcareactionexamination/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<PcareActionExaminationModel>> {
		const url = environment.API_URL + '/api/pcareactionexamination/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<PcareActionExaminationModel>> {
		let apiUrl = environment.API_URL + '/api/pcareactionexamination/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<PcareActionExaminationModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/pcareactionexamination/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' PCare Action Examination entities')),
