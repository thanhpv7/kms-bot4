...
import {PcareExaminationModelAudit} from '../../models/pcareExamination/pcare_examination.model.state';
...
/**
 * PCare Examination service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class PcareExaminationService extends AbstractHttpService<PcareExaminationModel, PcareExaminationModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the PcareExaminationProperties classFragment here] off begin
			fragment PcareExaminationProperties on PcareExamination {
				...PcareExaminationBaseProperties
				visitType
				treatment
				destinationPolyclinic
				disease
				diagnosis
				diagnosis2
				diagnosis3
			...
			# % protected region % [Modify the PcareExaminationProperties classFragment here] end
			${super.fragments('PcareExamination').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<PcareExaminationModel>> {
		...
		return  this.apollo.query<PassableStateConfig<PcareExaminationModel>>(
			{
				query: gql`
					query Count {
						totalCount: countPcareExaminations
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<PcareExaminationModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<PcareExaminationModel>> {
		...
		return this.apollo.query<PassableStateConfig<PcareExaminationModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						PcareExaminationById: pcareExaminationById(id: $id) {
							...PcareExaminationProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.PcareExaminationById as PcareExaminationModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PcareExaminationModel>> {
		...
		return this.apollo.query<PassableStateConfig<PcareExaminationModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						pcareExaminations: pcareExaminations(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...PcareExaminationProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countPcareExaminations(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.pcareExaminations as PcareExaminationModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PcareExaminationModel>> {
		...
		return this.apollo.query<PassableStateConfig<PcareExaminationModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						pcareExaminations: lastPcareExaminations(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...PcareExaminationProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: PcareExaminationModel, queryParams?: QueryParams): Observable<PassableStateConfig<PcareExaminationModel>> {
		...
		const successMessage = 'Created PCare Examination entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($pcareExamination: PcareExaminationInput!, $persistRelations: Boolean) {
						pcareExamination: createPcareExamination(pcareExamination: $pcareExamination, persistRelations: $persistRelations) {
							...PcareExaminationProperties,
				...
				variables: {
					pcareExamination: {
						...
						pcareActionExaminations: entity.pcareActionExaminations ? entity.pcareActionExaminations?.map((model: PcareActionExaminationModel) => new PcareActionExaminationModel(model).toJSON()) : [],
						pcareCompoundDrugs: entity.pcareCompoundDrugs ? entity.pcareCompoundDrugs?.map((model: PcareCompoundDrugModel) => new PcareCompoundDrugModel(model).toJSON()) : [],
						pcareNonCompoundDrugs: entity.pcareNonCompoundDrugs ? entity.pcareNonCompoundDrugs?.map((model: PcareNonCompoundDrugModel) => new PcareNonCompoundDrugModel(model).toJSON()) : [],
					},
			...
			map(result => {
				...
				return {
					targetModel: result.data.pcareExamination as PcareExaminationModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: PcareExaminationModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PcareExaminationModel>> {
		...
		const successMessage = 'Created Multiple PCare Examination entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($pcareExaminations: [PcareExaminationInput!]!) {
						pcareExamination: createAllPcareExamination(pcareExaminations: $pcareExaminations) {
							...PcareExaminationProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					pcareExaminations: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.pcareExamination as PcareExaminationModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: PcareExaminationModel, queryParams?: QueryParams): Observable<PassableStateConfig<PcareExaminationModel>> {
		...
		const successMessage = 'Updated PCare Examination entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($pcareExamination: PcareExaminationInput!, $persistRelations: Boolean) {
						pcareExamination: updatePcareExamination(pcareExamination: $pcareExamination, persistRelations: $persistRelations) {
							...PcareExaminationProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: PcareExaminationModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PcareExaminationModel>> {
		...
		const successMessage = 'Update Multiple PCare Examination entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($pcareExaminations: [PcareExaminationInput!]!) {
						pcareExamination: updateAllPcareExamination(pcareExaminations: $pcareExaminations) {
							...PcareExaminationProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<PcareExaminationModel>> {
		...
		const successMessage = 'Deleted PCare Examination entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($pcareExaminationId: ID!) {
						pcareExaminationId: deletePcareExaminationById(pcareExaminationId: $pcareExaminationId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.pcareExaminationId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<PcareExaminationModel>> {
		...
		const successMessage = 'Deleted selected PCare Examination entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($pcareExaminationIds: [ID!]!){
						deletePcareExaminationExcludingIds(pcareExaminationIds: $pcareExaminationIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.pcareExaminationIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<PcareExaminationModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($pcareExaminationIds: [ID!]!) {
						pcareExaminationIds: deleteAllPcareExaminationByIds(pcareExaminationIds: $pcareExaminationIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<PcareExaminationModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PcareExaminationModel>>(
			...
			map(result => {
				let audits: PcareExaminationModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new PcareExaminationModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<PcareExaminationModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PcareExaminationModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($pcareExaminationId: ID!) {
						audits: pcareExaminationAuditsByEntityId(pcareExaminationId: $pcareExaminationId) {
							entity {
								...PcareExaminationProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<PcareExaminationModel>> {
		const url = environment.API_URL + '/api/pcareexamination/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<PcareExaminationModel>> {
		const url = environment.API_URL + '/api/pcareexamination/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<PcareExaminationModel>> {
		let apiUrl = environment.API_URL + '/api/pcareexamination/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<PcareExaminationModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/pcareexamination/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' PCare Examination entities')),
