...
import {HospitalBranchInformationModelAudit} from '../../models/hospitalBranchInformation/hospital_branch_information.model.state';
...
/**
 * Hospital Branch Information service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class HospitalBranchInformationService extends AbstractHttpService<HospitalBranchInformationModel, HospitalBranchInformationModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the HospitalBranchInformationProperties classFragment here] off begin
			fragment HospitalBranchInformationProperties on HospitalBranchInformation {
				...HospitalBranchInformationBaseProperties
				hospitalCode
				hospitalName
				hospitalType
				hospitalClass
				...
				permitType
				validUntil
				hospitalBranchCorporationName
				hospitalBranchCorporationStatus
				accreditationType
				accreditationLevel
				accreditationDate
				bedPerinatology
			...
			# % protected region % [Modify the HospitalBranchInformationProperties classFragment here] end
			${super.fragments('HospitalBranchInformation').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<HospitalBranchInformationModel>> {
		...
		return  this.apollo.query<PassableStateConfig<HospitalBranchInformationModel>>(
			{
				query: gql`
					query Count {
						totalCount: countHospitalBranchInformations
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<HospitalBranchInformationModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<HospitalBranchInformationModel>> {
		...
		return this.apollo.query<PassableStateConfig<HospitalBranchInformationModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						HospitalBranchInformationById: hospitalBranchInformationById(id: $id) {
							...HospitalBranchInformationProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.HospitalBranchInformationById as HospitalBranchInformationModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<HospitalBranchInformationModel>> {
		...
		return this.apollo.query<PassableStateConfig<HospitalBranchInformationModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						hospitalBranchInformations: hospitalBranchInformations(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...HospitalBranchInformationProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countHospitalBranchInformations(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.hospitalBranchInformations as HospitalBranchInformationModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<HospitalBranchInformationModel>> {
		...
		return this.apollo.query<PassableStateConfig<HospitalBranchInformationModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						hospitalBranchInformations: lastHospitalBranchInformations(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...HospitalBranchInformationProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: HospitalBranchInformationModel, queryParams?: QueryParams): Observable<PassableStateConfig<HospitalBranchInformationModel>> {
		...
		const successMessage = 'Created Hospital Branch Information entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($hospitalBranchInformation: HospitalBranchInformationInput!, $persistRelations: Boolean) {
						hospitalBranchInformation: createHospitalBranchInformation(hospitalBranchInformation: $hospitalBranchInformation, persistRelations: $persistRelations) {
							...HospitalBranchInformationProperties,
				...
				`,
				variables: {
					hospitalBranchInformation: {
						...entity.toJSON(),
						hospitalGroup: entity.hospitalGroup ? new HospitalGroupInformationModel(entity.hospitalGroup).toJSON() : undefined,
			...
			map(result => {
				...
				return {
					targetModel: result.data.hospitalBranchInformation as HospitalBranchInformationModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: HospitalBranchInformationModel[], queryParams?: QueryParams): Observable<PassableStateConfig<HospitalBranchInformationModel>> {
		...
		const successMessage = 'Created Multiple Hospital Branch Information entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($hospitalBranchInformations: [HospitalBranchInformationInput!]!) {
						hospitalBranchInformation: createAllHospitalBranchInformation(hospitalBranchInformations: $hospitalBranchInformations) {
							...HospitalBranchInformationProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					hospitalBranchInformations: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.hospitalBranchInformation as HospitalBranchInformationModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: HospitalBranchInformationModel, queryParams?: QueryParams): Observable<PassableStateConfig<HospitalBranchInformationModel>> {
		...
		const successMessage = 'Updated Hospital Branch Information entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($hospitalBranchInformation: HospitalBranchInformationInput!, $persistRelations: Boolean) {
						hospitalBranchInformation: updateHospitalBranchInformation(hospitalBranchInformation: $hospitalBranchInformation, persistRelations: $persistRelations) {
							...HospitalBranchInformationProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: HospitalBranchInformationModel[], queryParams?: QueryParams): Observable<PassableStateConfig<HospitalBranchInformationModel>> {
		...
		const successMessage = 'Update Multiple Hospital Branch Information entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($hospitalBranchInformations: [HospitalBranchInformationInput!]!) {
						hospitalBranchInformation: updateAllHospitalBranchInformation(hospitalBranchInformations: $hospitalBranchInformations) {
							...HospitalBranchInformationProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<HospitalBranchInformationModel>> {
		...
		const successMessage = 'Deleted Hospital Branch Information entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($hospitalBranchInformationId: ID!) {
						hospitalBranchInformationId: deleteHospitalBranchInformationById(hospitalBranchInformationId: $hospitalBranchInformationId)
				...
				`,
				variables: {
					hospitalBranchInformationId: id,
			...
			map(result => {
				...
				return {
					targetModelId: result.data.hospitalBranchInformationId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<HospitalBranchInformationModel>> {
		...
		const successMessage = 'Deleted selected Hospital Branch Information entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($hospitalBranchInformationIds: [ID!]!){
						deleteHospitalBranchInformationExcludingIds(hospitalBranchInformationIds: $hospitalBranchInformationIds)
				...
				`,
				variables: {
					hospitalBranchInformationIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.hospitalBranchInformationIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<HospitalBranchInformationModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($hospitalBranchInformationIds: [ID!]!) {
						hospitalBranchInformationIds: deleteAllHospitalBranchInformationByIds(hospitalBranchInformationIds: $hospitalBranchInformationIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<HospitalBranchInformationModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<HospitalBranchInformationModel>>(
			{
				query: gql`
					query GetAudits {
						audits: hospitalBranchInformationAudits {
							entity {
								...HospitalBranchInformationProperties
							}
							timestamp
			...
			map(result => {
				let audits: HospitalBranchInformationModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new HospitalBranchInformationModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<HospitalBranchInformationModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<HospitalBranchInformationModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($hospitalBranchInformationId: ID!) {
						audits: hospitalBranchInformationAuditsByEntityId(hospitalBranchInformationId: $hospitalBranchInformationId) {
							entity {
								...HospitalBranchInformationProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<HospitalBranchInformationModel>> {
		const url = environment.API_URL + '/api/hospitalbranchinformation/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<HospitalBranchInformationModel>> {
		const url = environment.API_URL + '/api/hospitalbranchinformation/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<HospitalBranchInformationModel>> {
		let apiUrl = environment.API_URL + '/api/hospitalbranchinformation/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<HospitalBranchInformationModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/hospitalbranchinformation/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Hospital Branch Information entities')),
