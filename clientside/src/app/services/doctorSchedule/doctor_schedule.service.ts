...
import {DoctorScheduleModelAudit} from '../../models/doctorSchedule/doctor_schedule.model.state';
...
/**
 * Doctor Schedule service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class DoctorScheduleService extends AbstractHttpService<DoctorScheduleModel, DoctorScheduleModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the DoctorScheduleProperties classFragment here] off begin
			fragment DoctorScheduleProperties on DoctorSchedule {
				...DoctorScheduleBaseProperties
				startDateTime
				endDateTime
				intervalInMinutes
				location
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<DoctorScheduleModel>> {
		...
		return  this.apollo.query<PassableStateConfig<DoctorScheduleModel>>(
			{
				query: gql`
					query Count {
						totalCount: countDoctorSchedules
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<DoctorScheduleModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<DoctorScheduleModel>> {
		...
		return this.apollo.query<PassableStateConfig<DoctorScheduleModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						DoctorScheduleById: doctorScheduleById(id: $id) {
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.DoctorScheduleById as DoctorScheduleModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<DoctorScheduleModel>> {
		...
		return this.apollo.query<PassableStateConfig<DoctorScheduleModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						doctorSchedules: doctorSchedules(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...DoctorScheduleProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countDoctorSchedules(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.doctorSchedules as DoctorScheduleModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<DoctorScheduleModel>> {
		...
		return this.apollo.query<PassableStateConfig<DoctorScheduleModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						doctorSchedules: lastDoctorSchedules(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...DoctorScheduleProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: DoctorScheduleModel, queryParams?: QueryParams): Observable<PassableStateConfig<DoctorScheduleModel>> {
		...
		const successMessage = 'Created Doctor Schedule entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($doctorSchedule: DoctorScheduleInput!, $persistRelations: Boolean) {
						doctorSchedule: createDoctorSchedule(doctorSchedule: $doctorSchedule, persistRelations: $persistRelations) {
							...DoctorScheduleProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.doctorSchedule as DoctorScheduleModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: DoctorScheduleModel[], queryParams?: QueryParams): Observable<PassableStateConfig<DoctorScheduleModel>> {
		...
		const successMessage = 'Created Multiple Doctor Schedule entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($doctorSchedules: [DoctorScheduleInput!]!) {
						doctorSchedule: createAllDoctorSchedule(doctorSchedules: $doctorSchedules) {
							...DoctorScheduleProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					doctorSchedules: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.doctorSchedule as DoctorScheduleModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: DoctorScheduleModel, queryParams?: QueryParams): Observable<PassableStateConfig<DoctorScheduleModel>> {
		...
		const successMessage = 'Updated Doctor Schedule entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($doctorSchedule: DoctorScheduleInput!, $persistRelations: Boolean) {
						doctorSchedule: updateDoctorSchedule(doctorSchedule: $doctorSchedule, persistRelations: $persistRelations) {
							...DoctorScheduleProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: DoctorScheduleModel[], queryParams?: QueryParams): Observable<PassableStateConfig<DoctorScheduleModel>> {
		...
		const successMessage = 'Update Multiple Doctor Schedule entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($doctorSchedules: [DoctorScheduleInput!]!) {
						doctorSchedule: updateAllDoctorSchedule(doctorSchedules: $doctorSchedules) {
							...DoctorScheduleProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<DoctorScheduleModel>> {
		...
		const successMessage = 'Deleted Doctor Schedule entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($doctorScheduleId: ID!) {
						doctorScheduleId: deleteDoctorScheduleById(doctorScheduleId: $doctorScheduleId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.doctorScheduleId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<DoctorScheduleModel>> {
		...
		const successMessage = 'Deleted selected Doctor Schedule entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($doctorScheduleIds: [ID!]!){
						deleteDoctorScheduleExcludingIds(doctorScheduleIds: $doctorScheduleIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.doctorScheduleIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<DoctorScheduleModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($doctorScheduleIds: [ID!]!) {
						doctorScheduleIds: deleteAllDoctorScheduleByIds(doctorScheduleIds: $doctorScheduleIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<DoctorScheduleModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<DoctorScheduleModel>>(
			...
			map(result => {
				let audits: DoctorScheduleModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new DoctorScheduleModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<DoctorScheduleModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<DoctorScheduleModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($doctorScheduleId: ID!) {
						audits: doctorScheduleAuditsByEntityId(doctorScheduleId: $doctorScheduleId) {
							entity {
								...DoctorScheduleProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<DoctorScheduleModel>> {
		const url = environment.API_URL + '/api/doctorschedule/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<DoctorScheduleModel>> {
		const url = environment.API_URL + '/api/doctorschedule/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<DoctorScheduleModel>> {
		let apiUrl = environment.API_URL + '/api/doctorschedule/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<DoctorScheduleModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/doctorschedule/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Doctor Schedule entities')),
