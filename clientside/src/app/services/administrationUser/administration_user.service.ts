...
import {AdministrationUserModel} from '../../models/administrationUser/administration_user.model';
import {AdministrationUserModelAudit} from '../../models/administrationUser/administration_user.model.state';
...
/**
 * Administration User service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class AdministrationUserService extends UserService<AdministrationUserModel, AdministrationUserModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the AdministrationUserProperties classFragment here] off begin
			fragment AdministrationUserProperties on AdministrationUser {
				...AdministrationUserUserProperties
			}
			# % protected region % [Modify the AdministrationUserProperties classFragment here] end
			${super.fragments('AdministrationUser').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<AdministrationUserModel>> {
		...
		return  this.apollo.query<PassableStateConfig<AdministrationUserModel>>(
			{
				query: gql`
					query Count {
						totalCount: countAdministrationUsers
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<AdministrationUserModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<AdministrationUserModel>> {
		...
		return this.apollo.query<PassableStateConfig<AdministrationUserModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						AdministrationUserById: administrationUserById(id: $id) {
							...AdministrationUserProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.AdministrationUserById as AdministrationUserModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<AdministrationUserModel>> {
		...
		return this.apollo.query<PassableStateConfig<AdministrationUserModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						administrationUsers: administrationUsers(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...AdministrationUserProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countAdministrationUsers(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.administrationUsers as AdministrationUserModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<AdministrationUserModel>> {
		...
		return this.apollo.query<PassableStateConfig<AdministrationUserModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						administrationUsers: lastAdministrationUsers(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...AdministrationUserProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: AdministrationUserModel, queryParams?: QueryParams): Observable<PassableStateConfig<AdministrationUserModel>> {
		...
		const successMessage = 'Created Administration User entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($administrationUser: AdministrationUserInput!, $persistRelations: Boolean) {
						administrationUser: createAdministrationUser(administrationUser: $administrationUser, persistRelations: $persistRelations) {
							...AdministrationUserProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.administrationUser as AdministrationUserModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: AdministrationUserModel[], queryParams?: QueryParams): Observable<PassableStateConfig<AdministrationUserModel>> {
		...
		const successMessage = 'Created Multiple Administration User entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($administrationUsers: [AdministrationUserInput!]!) {
						administrationUser: createAllAdministrationUser(administrationUsers: $administrationUsers) {
							...AdministrationUserProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					administrationUsers: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.administrationUser as AdministrationUserModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: AdministrationUserModel, queryParams?: QueryParams): Observable<PassableStateConfig<AdministrationUserModel>> {
		...
		const successMessage = 'Updated Administration User entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($administrationUser: AdministrationUserInput!, $persistRelations: Boolean) {
						administrationUser: updateAdministrationUser(administrationUser: $administrationUser, persistRelations: $persistRelations) {
							...AdministrationUserProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: AdministrationUserModel[], queryParams?: QueryParams): Observable<PassableStateConfig<AdministrationUserModel>> {
		...
		const successMessage = 'Update Multiple Administration User entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($administrationUsers: [AdministrationUserInput!]!) {
						administrationUser: updateAllAdministrationUser(administrationUsers: $administrationUsers) {
							...AdministrationUserProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<AdministrationUserModel>> {
		...
		const successMessage = 'Deleted Administration User entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($administrationUserId: ID!) {
						administrationUserId: deleteAdministrationUserById(administrationUserId: $administrationUserId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.administrationUserId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<AdministrationUserModel>> {
		...
		const successMessage = 'Deleted selected Administration User entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($administrationUserIds: [ID!]!){
						deleteAdministrationUserExcludingIds(administrationUserIds: $administrationUserIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.administrationUserIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<AdministrationUserModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($administrationUserIds: [ID!]!) {
						administrationUserIds: deleteAllAdministrationUserByIds(administrationUserIds: $administrationUserIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<AdministrationUserModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<AdministrationUserModel>>(
			{
				query: gql`
					query GetAudits {
						audits: administrationUserAudits {
							entity {
								...AdministrationUserProperties
							}
							timestamp
			...
			map(result => {
				let audits: AdministrationUserModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new AdministrationUserModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<AdministrationUserModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<AdministrationUserModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($administrationUserId: ID!) {
						audits: administrationUserAuditsByEntityId(administrationUserId: $administrationUserId) {
							entity {
								...AdministrationUserProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<AdministrationUserModel>> {
		const url = environment.API_URL + '/api/administrationuser/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<AdministrationUserModel>> {
		const url = environment.API_URL + '/api/administrationuser/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<AdministrationUserModel>> {
		let apiUrl = environment.API_URL + '/api/administrationuser/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<AdministrationUserModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/administrationuser/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Administration User entities')),
