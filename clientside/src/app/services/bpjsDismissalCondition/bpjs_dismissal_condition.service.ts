...
import {BpjsDismissalConditionModel} from '../../models/bpjsDismissalCondition/bpjs_dismissal_condition.model';
import {BpjsDismissalConditionModelAudit} from '../../models/bpjsDismissalCondition/bpjs_dismissal_condition.model.state';
...
/**
 * BPJS Dismissal Condition service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BpjsDismissalConditionService extends AbstractHttpService<BpjsDismissalConditionModel, BpjsDismissalConditionModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BpjsDismissalConditionProperties classFragment here] off begin
			fragment BpjsDismissalConditionProperties on BpjsDismissalCondition {
				...BpjsDismissalConditionBaseProperties
				conditionName
				conditionCode
			}
			# % protected region % [Modify the BpjsDismissalConditionProperties classFragment here] end
			${super.fragments('BpjsDismissalCondition').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BpjsDismissalConditionModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BpjsDismissalConditionModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBpjsDismissalConditions
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BpjsDismissalConditionModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsDismissalConditionModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsDismissalConditionModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BpjsDismissalConditionById: bpjsDismissalConditionById(id: $id) {
							...BpjsDismissalConditionProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BpjsDismissalConditionById as BpjsDismissalConditionModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsDismissalConditionModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsDismissalConditionModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						bpjsDismissalConditions: bpjsDismissalConditions(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BpjsDismissalConditionProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBpjsDismissalConditions(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.bpjsDismissalConditions as BpjsDismissalConditionModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsDismissalConditionModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsDismissalConditionModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						bpjsDismissalConditions: lastBpjsDismissalConditions(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BpjsDismissalConditionProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BpjsDismissalConditionModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsDismissalConditionModel>> {
		...
		const successMessage = 'Created BPJS Dismissal Condition entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($bpjsDismissalCondition: BpjsDismissalConditionInput!, $persistRelations: Boolean) {
						bpjsDismissalCondition: createBpjsDismissalCondition(bpjsDismissalCondition: $bpjsDismissalCondition, persistRelations: $persistRelations) {
							...BpjsDismissalConditionProperties,
				...
				`,
				variables: {
					bpjsDismissalCondition: {
						...entity.toJSON(),
						bpjsClaimSubmission: entity.bpjsClaimSubmission ? new BpjsClaimSubmissionModel(entity.bpjsClaimSubmission).toJSON() : undefined,
					},
			...
			map(result => {
				...
				return {
					targetModel: result.data.bpjsDismissalCondition as BpjsDismissalConditionModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BpjsDismissalConditionModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsDismissalConditionModel>> {
		...
		const successMessage = 'Created Multiple BPJS Dismissal Condition entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($bpjsDismissalConditions: [BpjsDismissalConditionInput!]!) {
						bpjsDismissalCondition: createAllBpjsDismissalCondition(bpjsDismissalConditions: $bpjsDismissalConditions) {
							...BpjsDismissalConditionProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					bpjsDismissalConditions: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.bpjsDismissalCondition as BpjsDismissalConditionModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BpjsDismissalConditionModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsDismissalConditionModel>> {
		...
		const successMessage = 'Updated BPJS Dismissal Condition entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($bpjsDismissalCondition: BpjsDismissalConditionInput!, $persistRelations: Boolean) {
						bpjsDismissalCondition: updateBpjsDismissalCondition(bpjsDismissalCondition: $bpjsDismissalCondition, persistRelations: $persistRelations) {
							...BpjsDismissalConditionProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BpjsDismissalConditionModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsDismissalConditionModel>> {
		...
		const successMessage = 'Update Multiple BPJS Dismissal Condition entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($bpjsDismissalConditions: [BpjsDismissalConditionInput!]!) {
						bpjsDismissalCondition: updateAllBpjsDismissalCondition(bpjsDismissalConditions: $bpjsDismissalConditions) {
							...BpjsDismissalConditionProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BpjsDismissalConditionModel>> {
		...
		const successMessage = 'Deleted BPJS Dismissal Condition entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($bpjsDismissalConditionId: ID!) {
						bpjsDismissalConditionId: deleteBpjsDismissalConditionById(bpjsDismissalConditionId: $bpjsDismissalConditionId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.bpjsDismissalConditionId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsDismissalConditionModel>> {
		...
		const successMessage = 'Deleted selected BPJS Dismissal Condition entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($bpjsDismissalConditionIds: [ID!]!){
						deleteBpjsDismissalConditionExcludingIds(bpjsDismissalConditionIds: $bpjsDismissalConditionIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.bpjsDismissalConditionIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BpjsDismissalConditionModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($bpjsDismissalConditionIds: [ID!]!) {
						bpjsDismissalConditionIds: deleteAllBpjsDismissalConditionByIds(bpjsDismissalConditionIds: $bpjsDismissalConditionIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BpjsDismissalConditionModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsDismissalConditionModel>>(
			{
				query: gql`
					query GetAudits {
						audits: bpjsDismissalConditionAudits {
							entity {
								...BpjsDismissalConditionProperties
							}
							timestamp
			...
			map(result => {
				let audits: BpjsDismissalConditionModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BpjsDismissalConditionModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BpjsDismissalConditionModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsDismissalConditionModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($bpjsDismissalConditionId: ID!) {
						audits: bpjsDismissalConditionAuditsByEntityId(bpjsDismissalConditionId: $bpjsDismissalConditionId) {
							entity {
								...BpjsDismissalConditionProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BpjsDismissalConditionModel>> {
		const url = environment.API_URL + '/api/bpjsdismissalcondition/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BpjsDismissalConditionModel>> {
		const url = environment.API_URL + '/api/bpjsdismissalcondition/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsDismissalConditionModel>> {
		let apiUrl = environment.API_URL + '/api/bpjsdismissalcondition/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BpjsDismissalConditionModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/bpjsdismissalcondition/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' BPJS Dismissal Condition entities')),
