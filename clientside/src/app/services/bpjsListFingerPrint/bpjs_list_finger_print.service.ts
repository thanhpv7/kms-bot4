...
import {BpjsListFingerPrintModelAudit} from '../../models/bpjsListFingerPrint/bpjs_list_finger_print.model.state';
...
/**
 * BPJS List Finger Print service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BpjsListFingerPrintService extends AbstractHttpService<BpjsListFingerPrintModel, BpjsListFingerPrintModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BpjsListFingerPrintProperties classFragment here] off begin
			fragment BpjsListFingerPrintProperties on BpjsListFingerPrint {
				...BpjsListFingerPrintBaseProperties
				bpjsCardNo
				visitDate
				sepNo
			}
			# % protected region % [Modify the BpjsListFingerPrintProperties classFragment here] end
			${super.fragments('BpjsListFingerPrint').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BpjsListFingerPrintModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BpjsListFingerPrintModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBpjsListFingerPrints
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BpjsListFingerPrintModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsListFingerPrintModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsListFingerPrintModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BpjsListFingerPrintById: bpjsListFingerPrintById(id: $id) {
							...BpjsListFingerPrintProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BpjsListFingerPrintById as BpjsListFingerPrintModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsListFingerPrintModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsListFingerPrintModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						bpjsListFingerPrints: bpjsListFingerPrints(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BpjsListFingerPrintProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBpjsListFingerPrints(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.bpjsListFingerPrints as BpjsListFingerPrintModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsListFingerPrintModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsListFingerPrintModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						bpjsListFingerPrints: lastBpjsListFingerPrints(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BpjsListFingerPrintProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BpjsListFingerPrintModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsListFingerPrintModel>> {
		...
		const successMessage = 'Created BPJS List Finger Print entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($bpjsListFingerPrint: BpjsListFingerPrintInput!, $persistRelations: Boolean) {
						bpjsListFingerPrint: createBpjsListFingerPrint(bpjsListFingerPrint: $bpjsListFingerPrint, persistRelations: $persistRelations) {
							...BpjsListFingerPrintProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.bpjsListFingerPrint as BpjsListFingerPrintModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BpjsListFingerPrintModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsListFingerPrintModel>> {
		...
		const successMessage = 'Created Multiple BPJS List Finger Print entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($bpjsListFingerPrints: [BpjsListFingerPrintInput!]!) {
						bpjsListFingerPrint: createAllBpjsListFingerPrint(bpjsListFingerPrints: $bpjsListFingerPrints) {
							...BpjsListFingerPrintProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					bpjsListFingerPrints: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.bpjsListFingerPrint as BpjsListFingerPrintModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BpjsListFingerPrintModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsListFingerPrintModel>> {
		...
		const successMessage = 'Updated BPJS List Finger Print entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($bpjsListFingerPrint: BpjsListFingerPrintInput!, $persistRelations: Boolean) {
						bpjsListFingerPrint: updateBpjsListFingerPrint(bpjsListFingerPrint: $bpjsListFingerPrint, persistRelations: $persistRelations) {
							...BpjsListFingerPrintProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BpjsListFingerPrintModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsListFingerPrintModel>> {
		...
		const successMessage = 'Update Multiple BPJS List Finger Print entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($bpjsListFingerPrints: [BpjsListFingerPrintInput!]!) {
						bpjsListFingerPrint: updateAllBpjsListFingerPrint(bpjsListFingerPrints: $bpjsListFingerPrints) {
							...BpjsListFingerPrintProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BpjsListFingerPrintModel>> {
		...
		const successMessage = 'Deleted BPJS List Finger Print entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($bpjsListFingerPrintId: ID!) {
						bpjsListFingerPrintId: deleteBpjsListFingerPrintById(bpjsListFingerPrintId: $bpjsListFingerPrintId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.bpjsListFingerPrintId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsListFingerPrintModel>> {
		...
		const successMessage = 'Deleted selected BPJS List Finger Print entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($bpjsListFingerPrintIds: [ID!]!){
						deleteBpjsListFingerPrintExcludingIds(bpjsListFingerPrintIds: $bpjsListFingerPrintIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.bpjsListFingerPrintIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BpjsListFingerPrintModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($bpjsListFingerPrintIds: [ID!]!) {
						bpjsListFingerPrintIds: deleteAllBpjsListFingerPrintByIds(bpjsListFingerPrintIds: $bpjsListFingerPrintIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BpjsListFingerPrintModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsListFingerPrintModel>>(
			{
				query: gql`
					query GetAudits {
						audits: bpjsListFingerPrintAudits {
							entity {
								...BpjsListFingerPrintProperties
							}
							timestamp
			...
			map(result => {
				let audits: BpjsListFingerPrintModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BpjsListFingerPrintModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BpjsListFingerPrintModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsListFingerPrintModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($bpjsListFingerPrintId: ID!) {
						audits: bpjsListFingerPrintAuditsByEntityId(bpjsListFingerPrintId: $bpjsListFingerPrintId) {
							entity {
								...BpjsListFingerPrintProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BpjsListFingerPrintModel>> {
		const url = environment.API_URL + '/api/bpjslistfingerprint/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BpjsListFingerPrintModel>> {
		const url = environment.API_URL + '/api/bpjslistfingerprint/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsListFingerPrintModel>> {
		let apiUrl = environment.API_URL + '/api/bpjslistfingerprint/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BpjsListFingerPrintModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/bpjslistfingerprint/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' BPJS List Finger Print entities')),
