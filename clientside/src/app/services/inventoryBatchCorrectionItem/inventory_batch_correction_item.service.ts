...
import {InventoryBatchCorrectionItemModel} from '../../models/inventoryBatchCorrectionItem/inventory_batch_correction_item.model';
import {InventoryBatchCorrectionItemModelAudit} from '../../models/inventoryBatchCorrectionItem/inventory_batch_correction_item.model.state';
...
/**
 * Inventory Batch Correction Item service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class InventoryBatchCorrectionItemService extends AbstractHttpService<InventoryBatchCorrectionItemModel, InventoryBatchCorrectionItemModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the InventoryBatchCorrectionItemProperties classFragment here] off begin
			fragment InventoryBatchCorrectionItemProperties on InventoryBatchCorrectionItem {
				...InventoryBatchCorrectionItemBaseProperties
				itemLineNumber
				batchNumber
				expirationDate
				uom
			...
			# % protected region % [Modify the InventoryBatchCorrectionItemProperties classFragment here] end
			${super.fragments('InventoryBatchCorrectionItem').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<InventoryBatchCorrectionItemModel>> {
		...
		return  this.apollo.query<PassableStateConfig<InventoryBatchCorrectionItemModel>>(
			{
				query: gql`
					query Count {
						totalCount: countInventoryBatchCorrectionItems
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<InventoryBatchCorrectionItemModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<InventoryBatchCorrectionItemModel>> {
		...
		return this.apollo.query<PassableStateConfig<InventoryBatchCorrectionItemModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						InventoryBatchCorrectionItemById: inventoryBatchCorrectionItemById(id: $id) {
							...InventoryBatchCorrectionItemProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.InventoryBatchCorrectionItemById as InventoryBatchCorrectionItemModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<InventoryBatchCorrectionItemModel>> {
		...
		return this.apollo.query<PassableStateConfig<InventoryBatchCorrectionItemModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						inventoryBatchCorrectionItems: inventoryBatchCorrectionItems(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...InventoryBatchCorrectionItemProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countInventoryBatchCorrectionItems(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.inventoryBatchCorrectionItems as InventoryBatchCorrectionItemModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<InventoryBatchCorrectionItemModel>> {
		...
		return this.apollo.query<PassableStateConfig<InventoryBatchCorrectionItemModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						inventoryBatchCorrectionItems: lastInventoryBatchCorrectionItems(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...InventoryBatchCorrectionItemProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: InventoryBatchCorrectionItemModel, queryParams?: QueryParams): Observable<PassableStateConfig<InventoryBatchCorrectionItemModel>> {
		...
		const successMessage = 'Created Inventory Batch Correction Item entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($inventoryBatchCorrectionItem: InventoryBatchCorrectionItemInput!, $persistRelations: Boolean) {
						inventoryBatchCorrectionItem: createInventoryBatchCorrectionItem(inventoryBatchCorrectionItem: $inventoryBatchCorrectionItem, persistRelations: $persistRelations) {
							...InventoryBatchCorrectionItemProperties,
				...
				`,
				variables: {
					inventoryBatchCorrectionItem: {
						...entity.toJSON(),
						inventoryBatchCorrection: entity.inventoryBatchCorrection ? new InventoryBatchCorrectionModel(entity.inventoryBatchCorrection).toJSON() : undefined,
			...
			map(result => {
				...
				return {
					targetModel: result.data.inventoryBatchCorrectionItem as InventoryBatchCorrectionItemModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: InventoryBatchCorrectionItemModel[], queryParams?: QueryParams): Observable<PassableStateConfig<InventoryBatchCorrectionItemModel>> {
		...
		const successMessage = 'Created Multiple Inventory Batch Correction Item entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($inventoryBatchCorrectionItems: [InventoryBatchCorrectionItemInput!]!) {
						inventoryBatchCorrectionItem: createAllInventoryBatchCorrectionItem(inventoryBatchCorrectionItems: $inventoryBatchCorrectionItems) {
							...InventoryBatchCorrectionItemProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					inventoryBatchCorrectionItems: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.inventoryBatchCorrectionItem as InventoryBatchCorrectionItemModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: InventoryBatchCorrectionItemModel, queryParams?: QueryParams): Observable<PassableStateConfig<InventoryBatchCorrectionItemModel>> {
		...
		const successMessage = 'Updated Inventory Batch Correction Item entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($inventoryBatchCorrectionItem: InventoryBatchCorrectionItemInput!, $persistRelations: Boolean) {
						inventoryBatchCorrectionItem: updateInventoryBatchCorrectionItem(inventoryBatchCorrectionItem: $inventoryBatchCorrectionItem, persistRelations: $persistRelations) {
							...InventoryBatchCorrectionItemProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: InventoryBatchCorrectionItemModel[], queryParams?: QueryParams): Observable<PassableStateConfig<InventoryBatchCorrectionItemModel>> {
		...
		const successMessage = 'Update Multiple Inventory Batch Correction Item entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($inventoryBatchCorrectionItems: [InventoryBatchCorrectionItemInput!]!) {
						inventoryBatchCorrectionItem: updateAllInventoryBatchCorrectionItem(inventoryBatchCorrectionItems: $inventoryBatchCorrectionItems) {
							...InventoryBatchCorrectionItemProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<InventoryBatchCorrectionItemModel>> {
		...
		const successMessage = 'Deleted Inventory Batch Correction Item entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($inventoryBatchCorrectionItemId: ID!) {
						inventoryBatchCorrectionItemId: deleteInventoryBatchCorrectionItemById(inventoryBatchCorrectionItemId: $inventoryBatchCorrectionItemId)
				...
				`,
				variables: {
					inventoryBatchCorrectionItemId: id,
			...
			map(result => {
				...
				return {
					targetModelId: result.data.inventoryBatchCorrectionItemId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<InventoryBatchCorrectionItemModel>> {
		...
		const successMessage = 'Deleted selected Inventory Batch Correction Item entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($inventoryBatchCorrectionItemIds: [ID!]!){
						deleteInventoryBatchCorrectionItemExcludingIds(inventoryBatchCorrectionItemIds: $inventoryBatchCorrectionItemIds)
				...
				`,
				variables: {
					inventoryBatchCorrectionItemIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.inventoryBatchCorrectionItemIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<InventoryBatchCorrectionItemModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($inventoryBatchCorrectionItemIds: [ID!]!) {
						inventoryBatchCorrectionItemIds: deleteAllInventoryBatchCorrectionItemByIds(inventoryBatchCorrectionItemIds: $inventoryBatchCorrectionItemIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<InventoryBatchCorrectionItemModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<InventoryBatchCorrectionItemModel>>(
			{
				query: gql`
					query GetAudits {
						audits: inventoryBatchCorrectionItemAudits {
							entity {
								...InventoryBatchCorrectionItemProperties
							}
							timestamp
			...
			map(result => {
				let audits: InventoryBatchCorrectionItemModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new InventoryBatchCorrectionItemModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<InventoryBatchCorrectionItemModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<InventoryBatchCorrectionItemModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($inventoryBatchCorrectionItemId: ID!) {
						audits: inventoryBatchCorrectionItemAuditsByEntityId(inventoryBatchCorrectionItemId: $inventoryBatchCorrectionItemId) {
							entity {
								...InventoryBatchCorrectionItemProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<InventoryBatchCorrectionItemModel>> {
		const url = environment.API_URL + '/api/inventorybatchcorrectionitem/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<InventoryBatchCorrectionItemModel>> {
		const url = environment.API_URL + '/api/inventorybatchcorrectionitem/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<InventoryBatchCorrectionItemModel>> {
		let apiUrl = environment.API_URL + '/api/inventorybatchcorrectionitem/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<InventoryBatchCorrectionItemModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/inventorybatchcorrectionitem/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Inventory Batch Correction Item entities')),
