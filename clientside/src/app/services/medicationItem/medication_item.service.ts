...
import {MedicationItemModelAudit} from '../../models/medicationItem/medication_item.model.state';
...
/**
 * Medication Item service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class MedicationItemService extends AbstractHttpService<MedicationItemModel, MedicationItemModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the MedicationItemProperties classFragment here] off begin
			fragment MedicationItemProperties on MedicationItem {
				...MedicationItemBaseProperties
				requestedQty
				outstandingQty
				returnedQty
				issuedQty
			...
			# % protected region % [Modify the MedicationItemProperties classFragment here] end
			${super.fragments('MedicationItem').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<MedicationItemModel>> {
		...
		return  this.apollo.query<PassableStateConfig<MedicationItemModel>>(
			{
				query: gql`
					query Count {
						totalCount: countMedicationItems
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<MedicationItemModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<MedicationItemModel>> {
		...
		return this.apollo.query<PassableStateConfig<MedicationItemModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						MedicationItemById: medicationItemById(id: $id) {
							...MedicationItemProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.MedicationItemById as MedicationItemModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<MedicationItemModel>> {
		...
		return this.apollo.query<PassableStateConfig<MedicationItemModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						medicationItems: medicationItems(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...MedicationItemProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countMedicationItems(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.medicationItems as MedicationItemModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<MedicationItemModel>> {
		...
		return this.apollo.query<PassableStateConfig<MedicationItemModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						medicationItems: lastMedicationItems(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...MedicationItemProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: MedicationItemModel, queryParams?: QueryParams): Observable<PassableStateConfig<MedicationItemModel>> {
		...
		const successMessage = 'Created Medication Item entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($medicationItem: MedicationItemInput!, $persistRelations: Boolean) {
						medicationItem: createMedicationItem(medicationItem: $medicationItem, persistRelations: $persistRelations) {
							...MedicationItemProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.medicationItem as MedicationItemModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: MedicationItemModel[], queryParams?: QueryParams): Observable<PassableStateConfig<MedicationItemModel>> {
		...
		const successMessage = 'Created Multiple Medication Item entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($medicationItems: [MedicationItemInput!]!) {
						medicationItem: createAllMedicationItem(medicationItems: $medicationItems) {
							...MedicationItemProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					medicationItems: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.medicationItem as MedicationItemModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: MedicationItemModel, queryParams?: QueryParams): Observable<PassableStateConfig<MedicationItemModel>> {
		...
		const successMessage = 'Updated Medication Item entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($medicationItem: MedicationItemInput!, $persistRelations: Boolean) {
						medicationItem: updateMedicationItem(medicationItem: $medicationItem, persistRelations: $persistRelations) {
							...MedicationItemProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: MedicationItemModel[], queryParams?: QueryParams): Observable<PassableStateConfig<MedicationItemModel>> {
		...
		const successMessage = 'Update Multiple Medication Item entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($medicationItems: [MedicationItemInput!]!) {
						medicationItem: updateAllMedicationItem(medicationItems: $medicationItems) {
							...MedicationItemProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<MedicationItemModel>> {
		...
		const successMessage = 'Deleted Medication Item entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($medicationItemId: ID!) {
						medicationItemId: deleteMedicationItemById(medicationItemId: $medicationItemId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.medicationItemId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<MedicationItemModel>> {
		...
		const successMessage = 'Deleted selected Medication Item entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($medicationItemIds: [ID!]!){
						deleteMedicationItemExcludingIds(medicationItemIds: $medicationItemIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.medicationItemIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<MedicationItemModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($medicationItemIds: [ID!]!) {
						medicationItemIds: deleteAllMedicationItemByIds(medicationItemIds: $medicationItemIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<MedicationItemModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<MedicationItemModel>>(
			...
			map(result => {
				let audits: MedicationItemModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new MedicationItemModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<MedicationItemModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<MedicationItemModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($medicationItemId: ID!) {
						audits: medicationItemAuditsByEntityId(medicationItemId: $medicationItemId) {
							entity {
								...MedicationItemProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<MedicationItemModel>> {
		const url = environment.API_URL + '/api/medicationitem/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<MedicationItemModel>> {
		const url = environment.API_URL + '/api/medicationitem/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<MedicationItemModel>> {
		let apiUrl = environment.API_URL + '/api/medicationitem/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<MedicationItemModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/medicationitem/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Medication Item entities')),
