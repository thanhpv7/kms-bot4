...
import {IntraoperativeRecordsModelAudit} from '../../models/intraoperativeRecords/intraoperative_records.model.state';
...
/**
 * Intraoperative Records service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class IntraoperativeRecordsService extends AbstractHttpService<IntraoperativeRecordsModel, IntraoperativeRecordsModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the IntraoperativeRecordsProperties classFragment here] off begin
			fragment IntraoperativeRecordsProperties on IntraoperativeRecords {
				...IntraoperativeRecordsBaseProperties
				startDateTime
				endDateTime
				...
				bloodTransfusion
				instrumentsUsed
				anesthesiaStartDateTime
				anesthesiaType
				anesthesiaMethod
				anesthesiaAgents
				anesthesiaObservations
				anesthesiaNotes
				anesthesiaEndDateTime
			}
			# % protected region % [Modify the IntraoperativeRecordsProperties classFragment here] end
			${super.fragments('IntraoperativeRecords').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<IntraoperativeRecordsModel>> {
		...
		return  this.apollo.query<PassableStateConfig<IntraoperativeRecordsModel>>(
			{
				query: gql`
					query Count {
						totalCount: countIntraoperativeRecordss
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<IntraoperativeRecordsModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<IntraoperativeRecordsModel>> {
		...
		return this.apollo.query<PassableStateConfig<IntraoperativeRecordsModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						IntraoperativeRecordsById: intraoperativeRecordsById(id: $id) {
							...IntraoperativeRecordsProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.IntraoperativeRecordsById as IntraoperativeRecordsModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<IntraoperativeRecordsModel>> {
		...
		return this.apollo.query<PassableStateConfig<IntraoperativeRecordsModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						intraoperativeRecordss: intraoperativeRecordss(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...IntraoperativeRecordsProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countIntraoperativeRecordss(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.intraoperativeRecordss as IntraoperativeRecordsModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<IntraoperativeRecordsModel>> {
		...
		return this.apollo.query<PassableStateConfig<IntraoperativeRecordsModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						intraoperativeRecordss: lastIntraoperativeRecordss(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...IntraoperativeRecordsProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: IntraoperativeRecordsModel, queryParams?: QueryParams): Observable<PassableStateConfig<IntraoperativeRecordsModel>> {
		...
		const successMessage = 'Created Intraoperative Records entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($intraoperativeRecords: IntraoperativeRecordsInput!, $persistRelations: Boolean) {
						intraoperativeRecords: createIntraoperativeRecords(intraoperativeRecords: $intraoperativeRecords, persistRelations: $persistRelations) {
							...IntraoperativeRecordsProperties,
				...
				variables: {
					intraoperativeRecords: {
						...
						operatingRoom: entity.operatingRoom ? new RoomFacilityModel(entity.operatingRoom).toJSON() : undefined,
			...
			map(result => {
				...
				return {
					targetModel: result.data.intraoperativeRecords as IntraoperativeRecordsModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: IntraoperativeRecordsModel[], queryParams?: QueryParams): Observable<PassableStateConfig<IntraoperativeRecordsModel>> {
		...
		const successMessage = 'Created Multiple Intraoperative Records entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($intraoperativeRecordss: [IntraoperativeRecordsInput!]!) {
						intraoperativeRecords: createAllIntraoperativeRecords(intraoperativeRecordss: $intraoperativeRecordss) {
							...IntraoperativeRecordsProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					intraoperativeRecordss: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.intraoperativeRecords as IntraoperativeRecordsModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: IntraoperativeRecordsModel, queryParams?: QueryParams): Observable<PassableStateConfig<IntraoperativeRecordsModel>> {
		...
		const successMessage = 'Updated Intraoperative Records entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($intraoperativeRecords: IntraoperativeRecordsInput!, $persistRelations: Boolean) {
						intraoperativeRecords: updateIntraoperativeRecords(intraoperativeRecords: $intraoperativeRecords, persistRelations: $persistRelations) {
							...IntraoperativeRecordsProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: IntraoperativeRecordsModel[], queryParams?: QueryParams): Observable<PassableStateConfig<IntraoperativeRecordsModel>> {
		...
		const successMessage = 'Update Multiple Intraoperative Records entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($intraoperativeRecordss: [IntraoperativeRecordsInput!]!) {
						intraoperativeRecords: updateAllIntraoperativeRecords(intraoperativeRecordss: $intraoperativeRecordss) {
							...IntraoperativeRecordsProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<IntraoperativeRecordsModel>> {
		...
		const successMessage = 'Deleted Intraoperative Records entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($intraoperativeRecordsId: ID!) {
						intraoperativeRecordsId: deleteIntraoperativeRecordsById(intraoperativeRecordsId: $intraoperativeRecordsId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.intraoperativeRecordsId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<IntraoperativeRecordsModel>> {
		...
		const successMessage = 'Deleted selected Intraoperative Records entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($intraoperativeRecordsIds: [ID!]!){
						deleteIntraoperativeRecordsExcludingIds(intraoperativeRecordsIds: $intraoperativeRecordsIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.intraoperativeRecordsIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<IntraoperativeRecordsModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($intraoperativeRecordsIds: [ID!]!) {
						intraoperativeRecordsIds: deleteAllIntraoperativeRecordsByIds(intraoperativeRecordsIds: $intraoperativeRecordsIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<IntraoperativeRecordsModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<IntraoperativeRecordsModel>>(
			{
				query: gql`
					query GetAudits {
						audits: intraoperativeRecordsAudits {
							entity {
								...IntraoperativeRecordsProperties
							}
							timestamp
			...
			map(result => {
				let audits: IntraoperativeRecordsModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new IntraoperativeRecordsModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<IntraoperativeRecordsModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<IntraoperativeRecordsModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($intraoperativeRecordsId: ID!) {
						audits: intraoperativeRecordsAuditsByEntityId(intraoperativeRecordsId: $intraoperativeRecordsId) {
							entity {
								...IntraoperativeRecordsProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<IntraoperativeRecordsModel>> {
		const url = environment.API_URL + '/api/intraoperativerecords/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<IntraoperativeRecordsModel>> {
		const url = environment.API_URL + '/api/intraoperativerecords/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<IntraoperativeRecordsModel>> {
		let apiUrl = environment.API_URL + '/api/intraoperativerecords/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<IntraoperativeRecordsModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/intraoperativerecords/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Intraoperative Records entities')),
