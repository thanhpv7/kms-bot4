...
import {ChartOfAccountMappingModelAudit} from '../../models/chartOfAccountMapping/chart_of_account_mapping.model.state';
...
/**
 * Chart of Account Mapping service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class ChartOfAccountMappingService extends AbstractHttpService<ChartOfAccountMappingModel, ChartOfAccountMappingModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the ChartOfAccountMappingProperties classFragment here] off begin
			fragment ChartOfAccountMappingProperties on ChartOfAccountMapping {
				...ChartOfAccountMappingBaseProperties
				accountType
				accountTypeDescription
			}
			# % protected region % [Modify the ChartOfAccountMappingProperties classFragment here] end
			${super.fragments('ChartOfAccountMapping').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<ChartOfAccountMappingModel>> {
		...
		return  this.apollo.query<PassableStateConfig<ChartOfAccountMappingModel>>(
			{
				query: gql`
					query Count {
						totalCount: countChartOfAccountMappings
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<ChartOfAccountMappingModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<ChartOfAccountMappingModel>> {
		...
		return this.apollo.query<PassableStateConfig<ChartOfAccountMappingModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						ChartOfAccountMappingById: chartOfAccountMappingById(id: $id) {
							...ChartOfAccountMappingProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.ChartOfAccountMappingById as ChartOfAccountMappingModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<ChartOfAccountMappingModel>> {
		...
		return this.apollo.query<PassableStateConfig<ChartOfAccountMappingModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						chartOfAccountMappings: chartOfAccountMappings(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...ChartOfAccountMappingProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countChartOfAccountMappings(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.chartOfAccountMappings as ChartOfAccountMappingModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<ChartOfAccountMappingModel>> {
		...
		return this.apollo.query<PassableStateConfig<ChartOfAccountMappingModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						chartOfAccountMappings: lastChartOfAccountMappings(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...ChartOfAccountMappingProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: ChartOfAccountMappingModel, queryParams?: QueryParams): Observable<PassableStateConfig<ChartOfAccountMappingModel>> {
		...
		const successMessage = 'Created Chart of Account Mapping entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($chartOfAccountMapping: ChartOfAccountMappingInput!, $persistRelations: Boolean) {
						chartOfAccountMapping: createChartOfAccountMapping(chartOfAccountMapping: $chartOfAccountMapping, persistRelations: $persistRelations) {
							...ChartOfAccountMappingProperties,
				...
				variables: {
					chartOfAccountMapping: {
						...entity.toJSON(),
						chartOfAccount: entity.chartOfAccount ? new ChartOfAccountModel(entity.chartOfAccount).toJSON() : undefined,
					},
			...
			map(result => {
				...
				return {
					targetModel: result.data.chartOfAccountMapping as ChartOfAccountMappingModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: ChartOfAccountMappingModel[], queryParams?: QueryParams): Observable<PassableStateConfig<ChartOfAccountMappingModel>> {
		...
		const successMessage = 'Created Multiple Chart of Account Mapping entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($chartOfAccountMappings: [ChartOfAccountMappingInput!]!) {
						chartOfAccountMapping: createAllChartOfAccountMapping(chartOfAccountMappings: $chartOfAccountMappings) {
							...ChartOfAccountMappingProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					chartOfAccountMappings: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.chartOfAccountMapping as ChartOfAccountMappingModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: ChartOfAccountMappingModel, queryParams?: QueryParams): Observable<PassableStateConfig<ChartOfAccountMappingModel>> {
		...
		const successMessage = 'Updated Chart of Account Mapping entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($chartOfAccountMapping: ChartOfAccountMappingInput!, $persistRelations: Boolean) {
						chartOfAccountMapping: updateChartOfAccountMapping(chartOfAccountMapping: $chartOfAccountMapping, persistRelations: $persistRelations) {
							...ChartOfAccountMappingProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: ChartOfAccountMappingModel[], queryParams?: QueryParams): Observable<PassableStateConfig<ChartOfAccountMappingModel>> {
		...
		const successMessage = 'Update Multiple Chart of Account Mapping entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($chartOfAccountMappings: [ChartOfAccountMappingInput!]!) {
						chartOfAccountMapping: updateAllChartOfAccountMapping(chartOfAccountMappings: $chartOfAccountMappings) {
							...ChartOfAccountMappingProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<ChartOfAccountMappingModel>> {
		...
		const successMessage = 'Deleted Chart of Account Mapping entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($chartOfAccountMappingId: ID!) {
						chartOfAccountMappingId: deleteChartOfAccountMappingById(chartOfAccountMappingId: $chartOfAccountMappingId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.chartOfAccountMappingId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<ChartOfAccountMappingModel>> {
		...
		const successMessage = 'Deleted selected Chart of Account Mapping entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($chartOfAccountMappingIds: [ID!]!){
						deleteChartOfAccountMappingExcludingIds(chartOfAccountMappingIds: $chartOfAccountMappingIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.chartOfAccountMappingIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<ChartOfAccountMappingModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($chartOfAccountMappingIds: [ID!]!) {
						chartOfAccountMappingIds: deleteAllChartOfAccountMappingByIds(chartOfAccountMappingIds: $chartOfAccountMappingIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<ChartOfAccountMappingModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<ChartOfAccountMappingModel>>(
			{
				query: gql`
					query GetAudits {
						audits: chartOfAccountMappingAudits {
							entity {
								...ChartOfAccountMappingProperties
							}
							timestamp
			...
			map(result => {
				let audits: ChartOfAccountMappingModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new ChartOfAccountMappingModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<ChartOfAccountMappingModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<ChartOfAccountMappingModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($chartOfAccountMappingId: ID!) {
						audits: chartOfAccountMappingAuditsByEntityId(chartOfAccountMappingId: $chartOfAccountMappingId) {
							entity {
								...ChartOfAccountMappingProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<ChartOfAccountMappingModel>> {
		const url = environment.API_URL + '/api/chartofaccountmapping/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<ChartOfAccountMappingModel>> {
		const url = environment.API_URL + '/api/chartofaccountmapping/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<ChartOfAccountMappingModel>> {
		let apiUrl = environment.API_URL + '/api/chartofaccountmapping/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<ChartOfAccountMappingModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/chartofaccountmapping/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Chart of Account Mapping entities')),
