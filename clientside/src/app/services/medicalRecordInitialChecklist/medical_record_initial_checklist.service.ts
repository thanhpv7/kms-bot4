...
import {MedicalRecordInitialChecklistModel} from '../../models/medicalRecordInitialChecklist/medical_record_initial_checklist.model';
import {MedicalRecordInitialChecklistModelAudit} from '../../models/medicalRecordInitialChecklist/medical_record_initial_checklist.model.state';
...
/**
 * Medical Record Initial Checklist service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class MedicalRecordInitialChecklistService extends AbstractHttpService<MedicalRecordInitialChecklistModel, MedicalRecordInitialChecklistModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the MedicalRecordInitialChecklistProperties classFragment here] off begin
			fragment MedicalRecordInitialChecklistProperties on MedicalRecordInitialChecklist {
				...MedicalRecordInitialChecklistBaseProperties
				outVitalSign
				outAnamnesis
			...
			# % protected region % [Modify the MedicalRecordInitialChecklistProperties classFragment here] end
			${super.fragments('MedicalRecordInitialChecklist').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<MedicalRecordInitialChecklistModel>> {
		...
		return  this.apollo.query<PassableStateConfig<MedicalRecordInitialChecklistModel>>(
			{
				query: gql`
					query Count {
						totalCount: countMedicalRecordInitialChecklists
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<MedicalRecordInitialChecklistModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<MedicalRecordInitialChecklistModel>> {
		...
		return this.apollo.query<PassableStateConfig<MedicalRecordInitialChecklistModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						MedicalRecordInitialChecklistById: medicalRecordInitialChecklistById(id: $id) {
							...MedicalRecordInitialChecklistProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.MedicalRecordInitialChecklistById as MedicalRecordInitialChecklistModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<MedicalRecordInitialChecklistModel>> {
		...
		return this.apollo.query<PassableStateConfig<MedicalRecordInitialChecklistModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						medicalRecordInitialChecklists: medicalRecordInitialChecklists(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...MedicalRecordInitialChecklistProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countMedicalRecordInitialChecklists(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.medicalRecordInitialChecklists as MedicalRecordInitialChecklistModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<MedicalRecordInitialChecklistModel>> {
		...
		return this.apollo.query<PassableStateConfig<MedicalRecordInitialChecklistModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						medicalRecordInitialChecklists: lastMedicalRecordInitialChecklists(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...MedicalRecordInitialChecklistProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: MedicalRecordInitialChecklistModel, queryParams?: QueryParams): Observable<PassableStateConfig<MedicalRecordInitialChecklistModel>> {
		...
		const successMessage = 'Created Medical Record Initial Checklist entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($medicalRecordInitialChecklist: MedicalRecordInitialChecklistInput!, $persistRelations: Boolean) {
						medicalRecordInitialChecklist: createMedicalRecordInitialChecklist(medicalRecordInitialChecklist: $medicalRecordInitialChecklist, persistRelations: $persistRelations) {
							...MedicalRecordInitialChecklistProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.medicalRecordInitialChecklist as MedicalRecordInitialChecklistModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: MedicalRecordInitialChecklistModel[], queryParams?: QueryParams): Observable<PassableStateConfig<MedicalRecordInitialChecklistModel>> {
		...
		const successMessage = 'Created Multiple Medical Record Initial Checklist entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($medicalRecordInitialChecklists: [MedicalRecordInitialChecklistInput!]!) {
						medicalRecordInitialChecklist: createAllMedicalRecordInitialChecklist(medicalRecordInitialChecklists: $medicalRecordInitialChecklists) {
							...MedicalRecordInitialChecklistProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					medicalRecordInitialChecklists: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.medicalRecordInitialChecklist as MedicalRecordInitialChecklistModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: MedicalRecordInitialChecklistModel, queryParams?: QueryParams): Observable<PassableStateConfig<MedicalRecordInitialChecklistModel>> {
		...
		const successMessage = 'Updated Medical Record Initial Checklist entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($medicalRecordInitialChecklist: MedicalRecordInitialChecklistInput!, $persistRelations: Boolean) {
						medicalRecordInitialChecklist: updateMedicalRecordInitialChecklist(medicalRecordInitialChecklist: $medicalRecordInitialChecklist, persistRelations: $persistRelations) {
							...MedicalRecordInitialChecklistProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: MedicalRecordInitialChecklistModel[], queryParams?: QueryParams): Observable<PassableStateConfig<MedicalRecordInitialChecklistModel>> {
		...
		const successMessage = 'Update Multiple Medical Record Initial Checklist entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($medicalRecordInitialChecklists: [MedicalRecordInitialChecklistInput!]!) {
						medicalRecordInitialChecklist: updateAllMedicalRecordInitialChecklist(medicalRecordInitialChecklists: $medicalRecordInitialChecklists) {
							...MedicalRecordInitialChecklistProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<MedicalRecordInitialChecklistModel>> {
		...
		const successMessage = 'Deleted Medical Record Initial Checklist entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($medicalRecordInitialChecklistId: ID!) {
						medicalRecordInitialChecklistId: deleteMedicalRecordInitialChecklistById(medicalRecordInitialChecklistId: $medicalRecordInitialChecklistId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.medicalRecordInitialChecklistId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<MedicalRecordInitialChecklistModel>> {
		...
		const successMessage = 'Deleted selected Medical Record Initial Checklist entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($medicalRecordInitialChecklistIds: [ID!]!){
						deleteMedicalRecordInitialChecklistExcludingIds(medicalRecordInitialChecklistIds: $medicalRecordInitialChecklistIds)
				...
				`,
				variables: {
					medicalRecordInitialChecklistIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.medicalRecordInitialChecklistIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<MedicalRecordInitialChecklistModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($medicalRecordInitialChecklistIds: [ID!]!) {
						medicalRecordInitialChecklistIds: deleteAllMedicalRecordInitialChecklistByIds(medicalRecordInitialChecklistIds: $medicalRecordInitialChecklistIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<MedicalRecordInitialChecklistModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<MedicalRecordInitialChecklistModel>>(
			{
				query: gql`
					query GetAudits {
						audits: medicalRecordInitialChecklistAudits {
							entity {
								...MedicalRecordInitialChecklistProperties
							}
							timestamp
			...
			map(result => {
				let audits: MedicalRecordInitialChecklistModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new MedicalRecordInitialChecklistModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<MedicalRecordInitialChecklistModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<MedicalRecordInitialChecklistModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($medicalRecordInitialChecklistId: ID!) {
						audits: medicalRecordInitialChecklistAuditsByEntityId(medicalRecordInitialChecklistId: $medicalRecordInitialChecklistId) {
							entity {
								...MedicalRecordInitialChecklistProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<MedicalRecordInitialChecklistModel>> {
		const url = environment.API_URL + '/api/medicalrecordinitialchecklist/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<MedicalRecordInitialChecklistModel>> {
		const url = environment.API_URL + '/api/medicalrecordinitialchecklist/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<MedicalRecordInitialChecklistModel>> {
		let apiUrl = environment.API_URL + '/api/medicalrecordinitialchecklist/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<MedicalRecordInitialChecklistModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/medicalrecordinitialchecklist/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Medical Record Initial Checklist entities')),
