...
import {DiagnosisNandaModel} from '../../models/diagnosisNanda/diagnosis_nanda.model';
import {DiagnosisNandaModelAudit} from '../../models/diagnosisNanda/diagnosis_nanda.model.state';
...
/**
 * Diagnosis Nanda service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class DiagnosisNandaService extends AbstractHttpService<DiagnosisNandaModel, DiagnosisNandaModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the DiagnosisNandaProperties classFragment here] off begin
			fragment DiagnosisNandaProperties on DiagnosisNanda {
				...DiagnosisNandaBaseProperties
				nursingNotes
				sequence
			}
			# % protected region % [Modify the DiagnosisNandaProperties classFragment here] end
			${super.fragments('DiagnosisNanda').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<DiagnosisNandaModel>> {
		...
		return  this.apollo.query<PassableStateConfig<DiagnosisNandaModel>>(
			{
				query: gql`
					query Count {
						totalCount: countDiagnosisNandas
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<DiagnosisNandaModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<DiagnosisNandaModel>> {
		...
		return this.apollo.query<PassableStateConfig<DiagnosisNandaModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						DiagnosisNandaById: diagnosisNandaById(id: $id) {
							...DiagnosisNandaProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.DiagnosisNandaById as DiagnosisNandaModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<DiagnosisNandaModel>> {
		...
		return this.apollo.query<PassableStateConfig<DiagnosisNandaModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						diagnosisNandas: diagnosisNandas(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...DiagnosisNandaProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countDiagnosisNandas(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.diagnosisNandas as DiagnosisNandaModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<DiagnosisNandaModel>> {
		...
		return this.apollo.query<PassableStateConfig<DiagnosisNandaModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						diagnosisNandas: lastDiagnosisNandas(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...DiagnosisNandaProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: DiagnosisNandaModel, queryParams?: QueryParams): Observable<PassableStateConfig<DiagnosisNandaModel>> {
		...
		const successMessage = 'Created Diagnosis Nanda entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($diagnosisNanda: DiagnosisNandaInput!, $persistRelations: Boolean) {
						diagnosisNanda: createDiagnosisNanda(diagnosisNanda: $diagnosisNanda, persistRelations: $persistRelations) {
							...DiagnosisNandaProperties,
				...
				variables: {
					diagnosisNanda: {
						...
						nursingAnesthesiaDetail: entity.nursingAnesthesiaDetail ? entity.nursingAnesthesiaDetail?.map((model: OperatingTheaterMedicalExaminationRecordModel) => new OperatingTheaterMedicalExaminationRecordModel(model).toJSON()) : [],
						nursingSurgicalDetail: entity.nursingSurgicalDetail ? entity.nursingSurgicalDetail?.map((model: OperatingTheaterMedicalExaminationRecordModel) => new OperatingTheaterMedicalExaminationRecordModel(model).toJSON()) : [],
						nursing: entity.nursing ? entity.nursing?.map((model: DiagnosesAndProceduresModel) => new DiagnosesAndProceduresModel(model).toJSON()) : [],
					},
			...
			map(result => {
				...
				return {
					targetModel: result.data.diagnosisNanda as DiagnosisNandaModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: DiagnosisNandaModel[], queryParams?: QueryParams): Observable<PassableStateConfig<DiagnosisNandaModel>> {
		...
		const successMessage = 'Created Multiple Diagnosis Nanda entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($diagnosisNandas: [DiagnosisNandaInput!]!) {
						diagnosisNanda: createAllDiagnosisNanda(diagnosisNandas: $diagnosisNandas) {
							...DiagnosisNandaProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					diagnosisNandas: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.diagnosisNanda as DiagnosisNandaModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: DiagnosisNandaModel, queryParams?: QueryParams): Observable<PassableStateConfig<DiagnosisNandaModel>> {
		...
		const successMessage = 'Updated Diagnosis Nanda entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($diagnosisNanda: DiagnosisNandaInput!, $persistRelations: Boolean) {
						diagnosisNanda: updateDiagnosisNanda(diagnosisNanda: $diagnosisNanda, persistRelations: $persistRelations) {
							...DiagnosisNandaProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: DiagnosisNandaModel[], queryParams?: QueryParams): Observable<PassableStateConfig<DiagnosisNandaModel>> {
		...
		const successMessage = 'Update Multiple Diagnosis Nanda entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($diagnosisNandas: [DiagnosisNandaInput!]!) {
						diagnosisNanda: updateAllDiagnosisNanda(diagnosisNandas: $diagnosisNandas) {
							...DiagnosisNandaProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<DiagnosisNandaModel>> {
		...
		const successMessage = 'Deleted Diagnosis Nanda entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($diagnosisNandaId: ID!) {
						diagnosisNandaId: deleteDiagnosisNandaById(diagnosisNandaId: $diagnosisNandaId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.diagnosisNandaId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<DiagnosisNandaModel>> {
		...
		const successMessage = 'Deleted selected Diagnosis Nanda entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($diagnosisNandaIds: [ID!]!){
						deleteDiagnosisNandaExcludingIds(diagnosisNandaIds: $diagnosisNandaIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.diagnosisNandaIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<DiagnosisNandaModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($diagnosisNandaIds: [ID!]!) {
						diagnosisNandaIds: deleteAllDiagnosisNandaByIds(diagnosisNandaIds: $diagnosisNandaIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<DiagnosisNandaModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<DiagnosisNandaModel>>(
			...
			map(result => {
				let audits: DiagnosisNandaModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new DiagnosisNandaModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<DiagnosisNandaModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<DiagnosisNandaModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($diagnosisNandaId: ID!) {
						audits: diagnosisNandaAuditsByEntityId(diagnosisNandaId: $diagnosisNandaId) {
							entity {
								...DiagnosisNandaProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<DiagnosisNandaModel>> {
		const url = environment.API_URL + '/api/diagnosisnanda/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<DiagnosisNandaModel>> {
		const url = environment.API_URL + '/api/diagnosisnanda/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<DiagnosisNandaModel>> {
		let apiUrl = environment.API_URL + '/api/diagnosisnanda/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<DiagnosisNandaModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/diagnosisnanda/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Diagnosis Nanda entities')),
