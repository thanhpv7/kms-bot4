...
import {PatientVisitPatientPaymentOthersModel} from '../../models/patientVisitPatientPaymentOthers/patient_visit_patient_payment_others.model';
import {PatientVisitPatientPaymentOthersModelAudit} from '../../models/patientVisitPatientPaymentOthers/patient_visit_patient_payment_others.model.state';
...
/**
 * Patient Visit Patient Payment Others service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class PatientVisitPatientPaymentOthersService extends AbstractHttpService<PatientVisitPatientPaymentOthersModel, PatientVisitPatientPaymentOthersModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the PatientVisitPatientPaymentOthersProperties classFragment here] off begin
			fragment PatientVisitPatientPaymentOthersProperties on PatientVisitPatientPaymentOthers {
				...PatientVisitPatientPaymentOthersBaseProperties
				notes
			}
			# % protected region % [Modify the PatientVisitPatientPaymentOthersProperties classFragment here] end
			${super.fragments('PatientVisitPatientPaymentOthers').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<PatientVisitPatientPaymentOthersModel>> {
		...
		return  this.apollo.query<PassableStateConfig<PatientVisitPatientPaymentOthersModel>>(
			{
				query: gql`
					query Count {
						totalCount: countPatientVisitPatientPaymentOtherss
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<PatientVisitPatientPaymentOthersModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<PatientVisitPatientPaymentOthersModel>> {
		...
		return this.apollo.query<PassableStateConfig<PatientVisitPatientPaymentOthersModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						PatientVisitPatientPaymentOthersById: patientVisitPatientPaymentOthersById(id: $id) {
							...PatientVisitPatientPaymentOthersProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.PatientVisitPatientPaymentOthersById as PatientVisitPatientPaymentOthersModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PatientVisitPatientPaymentOthersModel>> {
		...
		return this.apollo.query<PassableStateConfig<PatientVisitPatientPaymentOthersModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						patientVisitPatientPaymentOtherss: patientVisitPatientPaymentOtherss(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...PatientVisitPatientPaymentOthersProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countPatientVisitPatientPaymentOtherss(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.patientVisitPatientPaymentOtherss as PatientVisitPatientPaymentOthersModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PatientVisitPatientPaymentOthersModel>> {
		...
		return this.apollo.query<PassableStateConfig<PatientVisitPatientPaymentOthersModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						patientVisitPatientPaymentOtherss: lastPatientVisitPatientPaymentOtherss(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...PatientVisitPatientPaymentOthersProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: PatientVisitPatientPaymentOthersModel, queryParams?: QueryParams): Observable<PassableStateConfig<PatientVisitPatientPaymentOthersModel>> {
		...
		const successMessage = 'Created Patient Visit Patient Payment Others entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($patientVisitPatientPaymentOthers: PatientVisitPatientPaymentOthersInput!, $persistRelations: Boolean) {
						patientVisitPatientPaymentOthers: createPatientVisitPatientPaymentOthers(patientVisitPatientPaymentOthers: $patientVisitPatientPaymentOthers, persistRelations: $persistRelations) {
							...PatientVisitPatientPaymentOthersProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.patientVisitPatientPaymentOthers as PatientVisitPatientPaymentOthersModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: PatientVisitPatientPaymentOthersModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PatientVisitPatientPaymentOthersModel>> {
		...
		const successMessage = 'Created Multiple Patient Visit Patient Payment Others entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($patientVisitPatientPaymentOtherss: [PatientVisitPatientPaymentOthersInput!]!) {
						patientVisitPatientPaymentOthers: createAllPatientVisitPatientPaymentOthers(patientVisitPatientPaymentOtherss: $patientVisitPatientPaymentOtherss) {
							...PatientVisitPatientPaymentOthersProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					patientVisitPatientPaymentOtherss: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.patientVisitPatientPaymentOthers as PatientVisitPatientPaymentOthersModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: PatientVisitPatientPaymentOthersModel, queryParams?: QueryParams): Observable<PassableStateConfig<PatientVisitPatientPaymentOthersModel>> {
		...
		const successMessage = 'Updated Patient Visit Patient Payment Others entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($patientVisitPatientPaymentOthers: PatientVisitPatientPaymentOthersInput!, $persistRelations: Boolean) {
						patientVisitPatientPaymentOthers: updatePatientVisitPatientPaymentOthers(patientVisitPatientPaymentOthers: $patientVisitPatientPaymentOthers, persistRelations: $persistRelations) {
							...PatientVisitPatientPaymentOthersProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: PatientVisitPatientPaymentOthersModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PatientVisitPatientPaymentOthersModel>> {
		...
		const successMessage = 'Update Multiple Patient Visit Patient Payment Others entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($patientVisitPatientPaymentOtherss: [PatientVisitPatientPaymentOthersInput!]!) {
						patientVisitPatientPaymentOthers: updateAllPatientVisitPatientPaymentOthers(patientVisitPatientPaymentOtherss: $patientVisitPatientPaymentOtherss) {
							...PatientVisitPatientPaymentOthersProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<PatientVisitPatientPaymentOthersModel>> {
		...
		const successMessage = 'Deleted Patient Visit Patient Payment Others entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($patientVisitPatientPaymentOthersId: ID!) {
						patientVisitPatientPaymentOthersId: deletePatientVisitPatientPaymentOthersById(patientVisitPatientPaymentOthersId: $patientVisitPatientPaymentOthersId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.patientVisitPatientPaymentOthersId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<PatientVisitPatientPaymentOthersModel>> {
		...
		const successMessage = 'Deleted selected Patient Visit Patient Payment Others entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($patientVisitPatientPaymentOthersIds: [ID!]!){
						deletePatientVisitPatientPaymentOthersExcludingIds(patientVisitPatientPaymentOthersIds: $patientVisitPatientPaymentOthersIds)
				...
				`,
				variables: {
					patientVisitPatientPaymentOthersIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.patientVisitPatientPaymentOthersIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<PatientVisitPatientPaymentOthersModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($patientVisitPatientPaymentOthersIds: [ID!]!) {
						patientVisitPatientPaymentOthersIds: deleteAllPatientVisitPatientPaymentOthersByIds(patientVisitPatientPaymentOthersIds: $patientVisitPatientPaymentOthersIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<PatientVisitPatientPaymentOthersModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PatientVisitPatientPaymentOthersModel>>(
			{
				query: gql`
					query GetAudits {
						audits: patientVisitPatientPaymentOthersAudits {
							entity {
								...PatientVisitPatientPaymentOthersProperties
							}
							timestamp
			...
			map(result => {
				let audits: PatientVisitPatientPaymentOthersModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new PatientVisitPatientPaymentOthersModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<PatientVisitPatientPaymentOthersModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PatientVisitPatientPaymentOthersModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($patientVisitPatientPaymentOthersId: ID!) {
						audits: patientVisitPatientPaymentOthersAuditsByEntityId(patientVisitPatientPaymentOthersId: $patientVisitPatientPaymentOthersId) {
							entity {
								...PatientVisitPatientPaymentOthersProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<PatientVisitPatientPaymentOthersModel>> {
		const url = environment.API_URL + '/api/patientvisitpatientpaymentothers/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<PatientVisitPatientPaymentOthersModel>> {
		const url = environment.API_URL + '/api/patientvisitpatientpaymentothers/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<PatientVisitPatientPaymentOthersModel>> {
		let apiUrl = environment.API_URL + '/api/patientvisitpatientpaymentothers/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<PatientVisitPatientPaymentOthersModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/patientvisitpatientpaymentothers/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Patient Visit Patient Payment Others entities')),
