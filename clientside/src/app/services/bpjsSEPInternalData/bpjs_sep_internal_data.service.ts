...
import {BpjsSEPInternalDataModelAudit} from '../../models/bpjsSEPInternalData/bpjs_sep_internal_data.model.state';
...
/**
 * BPJS SEP Internal Data service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BpjsSEPInternalDataService extends AbstractHttpService<BpjsSEPInternalDataModel, BpjsSEPInternalDataModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BpjsSEPInternalDataProperties classFragment here] off begin
			fragment BpjsSEPInternalDataProperties on BpjsSEPInternalData {
				...BpjsSEPInternalDataBaseProperties
				referredPolyclinic
				referringPolyclinic
			...
			# % protected region % [Modify the BpjsSEPInternalDataProperties classFragment here] end
			${super.fragments('BpjsSEPInternalData').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BpjsSEPInternalDataModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BpjsSEPInternalDataModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBpjsSEPInternalDatas
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BpjsSEPInternalDataModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsSEPInternalDataModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsSEPInternalDataModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BpjsSEPInternalDataById: bpjsSEPInternalDataById(id: $id) {
							...BpjsSEPInternalDataProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BpjsSEPInternalDataById as BpjsSEPInternalDataModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsSEPInternalDataModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsSEPInternalDataModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						bpjsSEPInternalDatas: bpjsSEPInternalDatas(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BpjsSEPInternalDataProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBpjsSEPInternalDatas(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.bpjsSEPInternalDatas as BpjsSEPInternalDataModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsSEPInternalDataModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsSEPInternalDataModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						bpjsSEPInternalDatas: lastBpjsSEPInternalDatas(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BpjsSEPInternalDataProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BpjsSEPInternalDataModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsSEPInternalDataModel>> {
		...
		const successMessage = 'Created BPJS SEP Internal Data entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($bpjsSEPInternalData: BpjsSEPInternalDataInput!, $persistRelations: Boolean) {
						bpjsSEPInternalData: createBpjsSEPInternalData(bpjsSEPInternalData: $bpjsSEPInternalData, persistRelations: $persistRelations) {
							...BpjsSEPInternalDataProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.bpjsSEPInternalData as BpjsSEPInternalDataModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BpjsSEPInternalDataModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsSEPInternalDataModel>> {
		...
		const successMessage = 'Created Multiple BPJS SEP Internal Data entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($bpjsSEPInternalDatas: [BpjsSEPInternalDataInput!]!) {
						bpjsSEPInternalData: createAllBpjsSEPInternalData(bpjsSEPInternalDatas: $bpjsSEPInternalDatas) {
							...BpjsSEPInternalDataProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					bpjsSEPInternalDatas: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.bpjsSEPInternalData as BpjsSEPInternalDataModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BpjsSEPInternalDataModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsSEPInternalDataModel>> {
		...
		const successMessage = 'Updated BPJS SEP Internal Data entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($bpjsSEPInternalData: BpjsSEPInternalDataInput!, $persistRelations: Boolean) {
						bpjsSEPInternalData: updateBpjsSEPInternalData(bpjsSEPInternalData: $bpjsSEPInternalData, persistRelations: $persistRelations) {
							...BpjsSEPInternalDataProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BpjsSEPInternalDataModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsSEPInternalDataModel>> {
		...
		const successMessage = 'Update Multiple BPJS SEP Internal Data entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($bpjsSEPInternalDatas: [BpjsSEPInternalDataInput!]!) {
						bpjsSEPInternalData: updateAllBpjsSEPInternalData(bpjsSEPInternalDatas: $bpjsSEPInternalDatas) {
							...BpjsSEPInternalDataProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BpjsSEPInternalDataModel>> {
		...
		const successMessage = 'Deleted BPJS SEP Internal Data entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($bpjsSEPInternalDataId: ID!) {
						bpjsSEPInternalDataId: deleteBpjsSEPInternalDataById(bpjsSEPInternalDataId: $bpjsSEPInternalDataId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.bpjsSEPInternalDataId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsSEPInternalDataModel>> {
		...
		const successMessage = 'Deleted selected BPJS SEP Internal Data entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($bpjsSEPInternalDataIds: [ID!]!){
						deleteBpjsSEPInternalDataExcludingIds(bpjsSEPInternalDataIds: $bpjsSEPInternalDataIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.bpjsSEPInternalDataIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BpjsSEPInternalDataModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($bpjsSEPInternalDataIds: [ID!]!) {
						bpjsSEPInternalDataIds: deleteAllBpjsSEPInternalDataByIds(bpjsSEPInternalDataIds: $bpjsSEPInternalDataIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BpjsSEPInternalDataModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsSEPInternalDataModel>>(
			{
				query: gql`
					query GetAudits {
						audits: bpjsSEPInternalDataAudits {
							entity {
								...BpjsSEPInternalDataProperties
							}
							timestamp
			...
			map(result => {
				let audits: BpjsSEPInternalDataModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BpjsSEPInternalDataModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BpjsSEPInternalDataModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsSEPInternalDataModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($bpjsSEPInternalDataId: ID!) {
						audits: bpjsSEPInternalDataAuditsByEntityId(bpjsSEPInternalDataId: $bpjsSEPInternalDataId) {
							entity {
								...BpjsSEPInternalDataProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BpjsSEPInternalDataModel>> {
		const url = environment.API_URL + '/api/bpjssepinternaldata/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BpjsSEPInternalDataModel>> {
		const url = environment.API_URL + '/api/bpjssepinternaldata/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsSEPInternalDataModel>> {
		let apiUrl = environment.API_URL + '/api/bpjssepinternaldata/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BpjsSEPInternalDataModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/bpjssepinternaldata/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' BPJS SEP Internal Data entities')),
