...
import {BpjsINACBGModelAudit} from '../../models/bpjsINACBG/bpjs_inacbg.model.state';
...
/**
 * BPJS INACBG service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BpjsINACBGService extends AbstractHttpService<BpjsINACBGModel, BpjsINACBGModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BpjsINACBGProperties classFragment here] off begin
			fragment BpjsINACBGProperties on BpjsINACBG {
				...BpjsINACBGBaseProperties
				healthFacilityCode
				healthFacilityName
				address
				stateProvince
			...
			# % protected region % [Modify the BpjsINACBGProperties classFragment here] end
			${super.fragments('BpjsINACBG').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BpjsINACBGModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BpjsINACBGModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBpjsINACBGs
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BpjsINACBGModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsINACBGModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsINACBGModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BpjsINACBGById: bpjsINACBGById(id: $id) {
							...BpjsINACBGProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BpjsINACBGById as BpjsINACBGModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsINACBGModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsINACBGModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						bpjsINACBGs: bpjsINACBGs(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BpjsINACBGProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBpjsINACBGs(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.bpjsINACBGs as BpjsINACBGModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsINACBGModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsINACBGModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						bpjsINACBGs: lastBpjsINACBGs(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BpjsINACBGProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BpjsINACBGModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsINACBGModel>> {
		...
		const successMessage = 'Created BPJS INACBG entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($bpjsINACBG: BpjsINACBGInput!, $persistRelations: Boolean) {
						bpjsINACBG: createBpjsINACBG(bpjsINACBG: $bpjsINACBG, persistRelations: $persistRelations) {
							...BpjsINACBGProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.bpjsINACBG as BpjsINACBGModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BpjsINACBGModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsINACBGModel>> {
		...
		const successMessage = 'Created Multiple BPJS INACBG entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($bpjsINACBGs: [BpjsINACBGInput!]!) {
						bpjsINACBG: createAllBpjsINACBG(bpjsINACBGs: $bpjsINACBGs) {
							...BpjsINACBGProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					bpjsINACBGs: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.bpjsINACBG as BpjsINACBGModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BpjsINACBGModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsINACBGModel>> {
		...
		const successMessage = 'Updated BPJS INACBG entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($bpjsINACBG: BpjsINACBGInput!, $persistRelations: Boolean) {
						bpjsINACBG: updateBpjsINACBG(bpjsINACBG: $bpjsINACBG, persistRelations: $persistRelations) {
							...BpjsINACBGProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BpjsINACBGModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsINACBGModel>> {
		...
		const successMessage = 'Update Multiple BPJS INACBG entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($bpjsINACBGs: [BpjsINACBGInput!]!) {
						bpjsINACBG: updateAllBpjsINACBG(bpjsINACBGs: $bpjsINACBGs) {
							...BpjsINACBGProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BpjsINACBGModel>> {
		...
		const successMessage = 'Deleted BPJS INACBG entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($bpjsINACBGId: ID!) {
						bpjsINACBGId: deleteBpjsINACBGById(bpjsINACBGId: $bpjsINACBGId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.bpjsINACBGId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsINACBGModel>> {
		...
		const successMessage = 'Deleted selected BPJS INACBG entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($bpjsINACBGIds: [ID!]!){
						deleteBpjsINACBGExcludingIds(bpjsINACBGIds: $bpjsINACBGIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.bpjsINACBGIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BpjsINACBGModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($bpjsINACBGIds: [ID!]!) {
						bpjsINACBGIds: deleteAllBpjsINACBGByIds(bpjsINACBGIds: $bpjsINACBGIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BpjsINACBGModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsINACBGModel>>(
			...
			map(result => {
				let audits: BpjsINACBGModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BpjsINACBGModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BpjsINACBGModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsINACBGModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($bpjsINACBGId: ID!) {
						audits: bpjsINACBGAuditsByEntityId(bpjsINACBGId: $bpjsINACBGId) {
							entity {
								...BpjsINACBGProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BpjsINACBGModel>> {
		const url = environment.API_URL + '/api/bpjsinacbg/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BpjsINACBGModel>> {
		const url = environment.API_URL + '/api/bpjsinacbg/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsINACBGModel>> {
		let apiUrl = environment.API_URL + '/api/bpjsinacbg/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BpjsINACBGModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/bpjsinacbg/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' BPJS INACBG entities')),
