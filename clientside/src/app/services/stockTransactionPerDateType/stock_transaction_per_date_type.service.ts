...
import {StockTransactionPerDateTypeModel} from '../../models/stockTransactionPerDateType/stock_transaction_per_date_type.model';
import {StockTransactionPerDateTypeModelAudit} from '../../models/stockTransactionPerDateType/stock_transaction_per_date_type.model.state';
...
/**
 * Stock Transaction Per Date Type service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class StockTransactionPerDateTypeService extends AbstractHttpService<StockTransactionPerDateTypeModel, StockTransactionPerDateTypeModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the StockTransactionPerDateTypeProperties classFragment here] off begin
			fragment StockTransactionPerDateTypeProperties on StockTransactionPerDateType {
				...StockTransactionPerDateTypeBaseProperties
				asOfDate
				transactionType
				qtyUoi
			}
			# % protected region % [Modify the StockTransactionPerDateTypeProperties classFragment here] end
			${super.fragments('StockTransactionPerDateType').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<StockTransactionPerDateTypeModel>> {
		...
		return  this.apollo.query<PassableStateConfig<StockTransactionPerDateTypeModel>>(
			{
				query: gql`
					query Count {
						totalCount: countStockTransactionPerDateTypes
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<StockTransactionPerDateTypeModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<StockTransactionPerDateTypeModel>> {
		...
		return this.apollo.query<PassableStateConfig<StockTransactionPerDateTypeModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						StockTransactionPerDateTypeById: stockTransactionPerDateTypeById(id: $id) {
							...StockTransactionPerDateTypeProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.StockTransactionPerDateTypeById as StockTransactionPerDateTypeModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<StockTransactionPerDateTypeModel>> {
		...
		return this.apollo.query<PassableStateConfig<StockTransactionPerDateTypeModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						stockTransactionPerDateTypes: stockTransactionPerDateTypes(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...StockTransactionPerDateTypeProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countStockTransactionPerDateTypes(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.stockTransactionPerDateTypes as StockTransactionPerDateTypeModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<StockTransactionPerDateTypeModel>> {
		...
		return this.apollo.query<PassableStateConfig<StockTransactionPerDateTypeModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						stockTransactionPerDateTypes: lastStockTransactionPerDateTypes(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...StockTransactionPerDateTypeProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: StockTransactionPerDateTypeModel, queryParams?: QueryParams): Observable<PassableStateConfig<StockTransactionPerDateTypeModel>> {
		...
		const successMessage = 'Created Stock Transaction Per Date Type entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($stockTransactionPerDateType: StockTransactionPerDateTypeInput!, $persistRelations: Boolean) {
						stockTransactionPerDateType: createStockTransactionPerDateType(stockTransactionPerDateType: $stockTransactionPerDateType, persistRelations: $persistRelations) {
							...StockTransactionPerDateTypeProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.stockTransactionPerDateType as StockTransactionPerDateTypeModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: StockTransactionPerDateTypeModel[], queryParams?: QueryParams): Observable<PassableStateConfig<StockTransactionPerDateTypeModel>> {
		...
		const successMessage = 'Created Multiple Stock Transaction Per Date Type entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($stockTransactionPerDateTypes: [StockTransactionPerDateTypeInput!]!) {
						stockTransactionPerDateType: createAllStockTransactionPerDateType(stockTransactionPerDateTypes: $stockTransactionPerDateTypes) {
							...StockTransactionPerDateTypeProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					stockTransactionPerDateTypes: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.stockTransactionPerDateType as StockTransactionPerDateTypeModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: StockTransactionPerDateTypeModel, queryParams?: QueryParams): Observable<PassableStateConfig<StockTransactionPerDateTypeModel>> {
		...
		const successMessage = 'Updated Stock Transaction Per Date Type entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($stockTransactionPerDateType: StockTransactionPerDateTypeInput!, $persistRelations: Boolean) {
						stockTransactionPerDateType: updateStockTransactionPerDateType(stockTransactionPerDateType: $stockTransactionPerDateType, persistRelations: $persistRelations) {
							...StockTransactionPerDateTypeProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: StockTransactionPerDateTypeModel[], queryParams?: QueryParams): Observable<PassableStateConfig<StockTransactionPerDateTypeModel>> {
		...
		const successMessage = 'Update Multiple Stock Transaction Per Date Type entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($stockTransactionPerDateTypes: [StockTransactionPerDateTypeInput!]!) {
						stockTransactionPerDateType: updateAllStockTransactionPerDateType(stockTransactionPerDateTypes: $stockTransactionPerDateTypes) {
							...StockTransactionPerDateTypeProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<StockTransactionPerDateTypeModel>> {
		...
		const successMessage = 'Deleted Stock Transaction Per Date Type entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($stockTransactionPerDateTypeId: ID!) {
						stockTransactionPerDateTypeId: deleteStockTransactionPerDateTypeById(stockTransactionPerDateTypeId: $stockTransactionPerDateTypeId)
				...
				`,
				variables: {
					stockTransactionPerDateTypeId: id,
			...
			map(result => {
				...
				return {
					targetModelId: result.data.stockTransactionPerDateTypeId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<StockTransactionPerDateTypeModel>> {
		...
		const successMessage = 'Deleted selected Stock Transaction Per Date Type entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($stockTransactionPerDateTypeIds: [ID!]!){
						deleteStockTransactionPerDateTypeExcludingIds(stockTransactionPerDateTypeIds: $stockTransactionPerDateTypeIds)
				...
				`,
				variables: {
					stockTransactionPerDateTypeIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.stockTransactionPerDateTypeIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<StockTransactionPerDateTypeModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($stockTransactionPerDateTypeIds: [ID!]!) {
						stockTransactionPerDateTypeIds: deleteAllStockTransactionPerDateTypeByIds(stockTransactionPerDateTypeIds: $stockTransactionPerDateTypeIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<StockTransactionPerDateTypeModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<StockTransactionPerDateTypeModel>>(
			{
				query: gql`
					query GetAudits {
						audits: stockTransactionPerDateTypeAudits {
							entity {
								...StockTransactionPerDateTypeProperties
							}
							timestamp
			...
			map(result => {
				let audits: StockTransactionPerDateTypeModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new StockTransactionPerDateTypeModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<StockTransactionPerDateTypeModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<StockTransactionPerDateTypeModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($stockTransactionPerDateTypeId: ID!) {
						audits: stockTransactionPerDateTypeAuditsByEntityId(stockTransactionPerDateTypeId: $stockTransactionPerDateTypeId) {
							entity {
								...StockTransactionPerDateTypeProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<StockTransactionPerDateTypeModel>> {
		const url = environment.API_URL + '/api/stocktransactionperdatetype/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<StockTransactionPerDateTypeModel>> {
		const url = environment.API_URL + '/api/stocktransactionperdatetype/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<StockTransactionPerDateTypeModel>> {
		let apiUrl = environment.API_URL + '/api/stocktransactionperdatetype/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<StockTransactionPerDateTypeModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/stocktransactionperdatetype/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Stock Transaction Per Date Type entities')),
