...
import {BpjsTreatmentHistoryModel} from '../../models/bpjsTreatmentHistory/bpjs_treatment_history.model';
import {BpjsTreatmentHistoryModelAudit} from '../../models/bpjsTreatmentHistory/bpjs_treatment_history.model.state';
...
/**
 * BPJS Treatment History service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BpjsTreatmentHistoryService extends AbstractHttpService<BpjsTreatmentHistoryModel, BpjsTreatmentHistoryModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BpjsTreatmentHistoryProperties classFragment here] off begin
			fragment BpjsTreatmentHistoryProperties on BpjsTreatmentHistory {
				...BpjsTreatmentHistoryBaseProperties
				diagnose
				treatmentType
				treatmentClass
				name
			...
			# % protected region % [Modify the BpjsTreatmentHistoryProperties classFragment here] end
			${super.fragments('BpjsTreatmentHistory').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BpjsTreatmentHistoryModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BpjsTreatmentHistoryModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBpjsTreatmentHistorys
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BpjsTreatmentHistoryModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsTreatmentHistoryModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsTreatmentHistoryModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BpjsTreatmentHistoryById: bpjsTreatmentHistoryById(id: $id) {
							...BpjsTreatmentHistoryProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BpjsTreatmentHistoryById as BpjsTreatmentHistoryModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsTreatmentHistoryModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsTreatmentHistoryModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						bpjsTreatmentHistorys: bpjsTreatmentHistorys(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BpjsTreatmentHistoryProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBpjsTreatmentHistorys(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.bpjsTreatmentHistorys as BpjsTreatmentHistoryModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsTreatmentHistoryModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsTreatmentHistoryModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						bpjsTreatmentHistorys: lastBpjsTreatmentHistorys(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BpjsTreatmentHistoryProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BpjsTreatmentHistoryModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsTreatmentHistoryModel>> {
		...
		const successMessage = 'Created BPJS Treatment History entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($bpjsTreatmentHistory: BpjsTreatmentHistoryInput!, $persistRelations: Boolean) {
						bpjsTreatmentHistory: createBpjsTreatmentHistory(bpjsTreatmentHistory: $bpjsTreatmentHistory, persistRelations: $persistRelations) {
							...BpjsTreatmentHistoryProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.bpjsTreatmentHistory as BpjsTreatmentHistoryModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BpjsTreatmentHistoryModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsTreatmentHistoryModel>> {
		...
		const successMessage = 'Created Multiple BPJS Treatment History entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($bpjsTreatmentHistorys: [BpjsTreatmentHistoryInput!]!) {
						bpjsTreatmentHistory: createAllBpjsTreatmentHistory(bpjsTreatmentHistorys: $bpjsTreatmentHistorys) {
							...BpjsTreatmentHistoryProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					bpjsTreatmentHistorys: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.bpjsTreatmentHistory as BpjsTreatmentHistoryModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BpjsTreatmentHistoryModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsTreatmentHistoryModel>> {
		...
		const successMessage = 'Updated BPJS Treatment History entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($bpjsTreatmentHistory: BpjsTreatmentHistoryInput!, $persistRelations: Boolean) {
						bpjsTreatmentHistory: updateBpjsTreatmentHistory(bpjsTreatmentHistory: $bpjsTreatmentHistory, persistRelations: $persistRelations) {
							...BpjsTreatmentHistoryProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BpjsTreatmentHistoryModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsTreatmentHistoryModel>> {
		...
		const successMessage = 'Update Multiple BPJS Treatment History entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($bpjsTreatmentHistorys: [BpjsTreatmentHistoryInput!]!) {
						bpjsTreatmentHistory: updateAllBpjsTreatmentHistory(bpjsTreatmentHistorys: $bpjsTreatmentHistorys) {
							...BpjsTreatmentHistoryProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BpjsTreatmentHistoryModel>> {
		...
		const successMessage = 'Deleted BPJS Treatment History entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($bpjsTreatmentHistoryId: ID!) {
						bpjsTreatmentHistoryId: deleteBpjsTreatmentHistoryById(bpjsTreatmentHistoryId: $bpjsTreatmentHistoryId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.bpjsTreatmentHistoryId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsTreatmentHistoryModel>> {
		...
		const successMessage = 'Deleted selected BPJS Treatment History entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($bpjsTreatmentHistoryIds: [ID!]!){
						deleteBpjsTreatmentHistoryExcludingIds(bpjsTreatmentHistoryIds: $bpjsTreatmentHistoryIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.bpjsTreatmentHistoryIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BpjsTreatmentHistoryModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($bpjsTreatmentHistoryIds: [ID!]!) {
						bpjsTreatmentHistoryIds: deleteAllBpjsTreatmentHistoryByIds(bpjsTreatmentHistoryIds: $bpjsTreatmentHistoryIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BpjsTreatmentHistoryModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsTreatmentHistoryModel>>(
			{
				query: gql`
					query GetAudits {
						audits: bpjsTreatmentHistoryAudits {
							entity {
								...BpjsTreatmentHistoryProperties
							}
							timestamp
			...
			map(result => {
				let audits: BpjsTreatmentHistoryModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BpjsTreatmentHistoryModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BpjsTreatmentHistoryModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsTreatmentHistoryModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($bpjsTreatmentHistoryId: ID!) {
						audits: bpjsTreatmentHistoryAuditsByEntityId(bpjsTreatmentHistoryId: $bpjsTreatmentHistoryId) {
							entity {
								...BpjsTreatmentHistoryProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BpjsTreatmentHistoryModel>> {
		const url = environment.API_URL + '/api/bpjstreatmenthistory/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BpjsTreatmentHistoryModel>> {
		const url = environment.API_URL + '/api/bpjstreatmenthistory/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsTreatmentHistoryModel>> {
		let apiUrl = environment.API_URL + '/api/bpjstreatmenthistory/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BpjsTreatmentHistoryModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/bpjstreatmenthistory/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' BPJS Treatment History entities')),
