...
import {RoomFacilityModelAudit} from '../../models/roomFacility/room_facility.model.state';
...
/**
 * Room Facility service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class RoomFacilityService extends AbstractHttpService<RoomFacilityModel, RoomFacilityModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the RoomFacilityProperties classFragment here] off begin
			fragment RoomFacilityProperties on RoomFacility {
				...RoomFacilityBaseProperties
				roomNumber
				roomName
				department
				genderAllocation
			...
			# % protected region % [Modify the RoomFacilityProperties classFragment here] end
			${super.fragments('RoomFacility').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<RoomFacilityModel>> {
		...
		return  this.apollo.query<PassableStateConfig<RoomFacilityModel>>(
			{
				query: gql`
					query Count {
						totalCount: countRoomFacilitys
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<RoomFacilityModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<RoomFacilityModel>> {
		...
		return this.apollo.query<PassableStateConfig<RoomFacilityModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						RoomFacilityById: roomFacilityById(id: $id) {
							...RoomFacilityProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.RoomFacilityById as RoomFacilityModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<RoomFacilityModel>> {
		...
		return this.apollo.query<PassableStateConfig<RoomFacilityModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						roomFacilitys: roomFacilitys(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...RoomFacilityProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countRoomFacilitys(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.roomFacilitys as RoomFacilityModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<RoomFacilityModel>> {
		...
		return this.apollo.query<PassableStateConfig<RoomFacilityModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						roomFacilitys: lastRoomFacilitys(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...RoomFacilityProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: RoomFacilityModel, queryParams?: QueryParams): Observable<PassableStateConfig<RoomFacilityModel>> {
		...
		const successMessage = 'Created Room Facility entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($roomFacility: RoomFacilityInput!, $persistRelations: Boolean) {
						roomFacility: createRoomFacility(roomFacility: $roomFacility, persistRelations: $persistRelations) {
							...RoomFacilityProperties,
				...
				variables: {
					roomFacility: {
						...
						operatingRoom: entity.operatingRoom ? entity.operatingRoom?.map((model: IntraoperativeRecordsModel) => new IntraoperativeRecordsModel(model).toJSON()) : [],
						preoperativeRooms: entity.preoperativeRooms ? entity.preoperativeRooms?.map((model: PreoperativeRecordsModel) => new PreoperativeRecordsModel(model).toJSON()) : [],
						recoveryRooms: entity.recoveryRooms ? entity.recoveryRooms?.map((model: PostOperativeDetailsModel) => new PostOperativeDetailsModel(model).toJSON()) : [],
					},
			...
			map(result => {
				...
				return {
					targetModel: result.data.roomFacility as RoomFacilityModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: RoomFacilityModel[], queryParams?: QueryParams): Observable<PassableStateConfig<RoomFacilityModel>> {
		...
		const successMessage = 'Created Multiple Room Facility entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($roomFacilitys: [RoomFacilityInput!]!) {
						roomFacility: createAllRoomFacility(roomFacilitys: $roomFacilitys) {
							...RoomFacilityProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					roomFacilitys: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.roomFacility as RoomFacilityModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: RoomFacilityModel, queryParams?: QueryParams): Observable<PassableStateConfig<RoomFacilityModel>> {
		...
		const successMessage = 'Updated Room Facility entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($roomFacility: RoomFacilityInput!, $persistRelations: Boolean) {
						roomFacility: updateRoomFacility(roomFacility: $roomFacility, persistRelations: $persistRelations) {
							...RoomFacilityProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: RoomFacilityModel[], queryParams?: QueryParams): Observable<PassableStateConfig<RoomFacilityModel>> {
		...
		const successMessage = 'Update Multiple Room Facility entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($roomFacilitys: [RoomFacilityInput!]!) {
						roomFacility: updateAllRoomFacility(roomFacilitys: $roomFacilitys) {
							...RoomFacilityProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<RoomFacilityModel>> {
		...
		const successMessage = 'Deleted Room Facility entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($roomFacilityId: ID!) {
						roomFacilityId: deleteRoomFacilityById(roomFacilityId: $roomFacilityId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.roomFacilityId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<RoomFacilityModel>> {
		...
		const successMessage = 'Deleted selected Room Facility entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($roomFacilityIds: [ID!]!){
						deleteRoomFacilityExcludingIds(roomFacilityIds: $roomFacilityIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.roomFacilityIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<RoomFacilityModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($roomFacilityIds: [ID!]!) {
						roomFacilityIds: deleteAllRoomFacilityByIds(roomFacilityIds: $roomFacilityIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<RoomFacilityModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<RoomFacilityModel>>(
			...
			map(result => {
				let audits: RoomFacilityModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new RoomFacilityModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<RoomFacilityModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<RoomFacilityModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($roomFacilityId: ID!) {
						audits: roomFacilityAuditsByEntityId(roomFacilityId: $roomFacilityId) {
							entity {
								...RoomFacilityProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<RoomFacilityModel>> {
		const url = environment.API_URL + '/api/roomfacility/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<RoomFacilityModel>> {
		const url = environment.API_URL + '/api/roomfacility/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<RoomFacilityModel>> {
		let apiUrl = environment.API_URL + '/api/roomfacility/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<RoomFacilityModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/roomfacility/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Room Facility entities')),
