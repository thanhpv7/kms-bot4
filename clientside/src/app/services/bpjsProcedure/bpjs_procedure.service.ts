...
import {BpjsProcedureModel} from '../../models/bpjsProcedure/bpjs_procedure.model';
import {BpjsProcedureModelAudit} from '../../models/bpjsProcedure/bpjs_procedure.model.state';
...
/**
 * BPJS Procedure service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BpjsProcedureService extends AbstractHttpService<BpjsProcedureModel, BpjsProcedureModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BpjsProcedureProperties classFragment here] off begin
			fragment BpjsProcedureProperties on BpjsProcedure {
				...BpjsProcedureBaseProperties
				procedureCode
				procedureName
			}
			# % protected region % [Modify the BpjsProcedureProperties classFragment here] end
			${super.fragments('BpjsProcedure').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BpjsProcedureModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BpjsProcedureModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBpjsProcedures
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BpjsProcedureModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsProcedureModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsProcedureModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BpjsProcedureById: bpjsProcedureById(id: $id) {
							...BpjsProcedureProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BpjsProcedureById as BpjsProcedureModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsProcedureModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsProcedureModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						bpjsProcedures: bpjsProcedures(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BpjsProcedureProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBpjsProcedures(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.bpjsProcedures as BpjsProcedureModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsProcedureModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsProcedureModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						bpjsProcedures: lastBpjsProcedures(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BpjsProcedureProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BpjsProcedureModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsProcedureModel>> {
		...
		const successMessage = 'Created BPJS Procedure entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($bpjsProcedure: BpjsProcedureInput!, $persistRelations: Boolean) {
						bpjsProcedure: createBpjsProcedure(bpjsProcedure: $bpjsProcedure, persistRelations: $persistRelations) {
							...BpjsProcedureProperties,
				...
				variables: {
					bpjsProcedure: {
						...entity.toJSON(),
						additionalProcedure: entity.additionalProcedure ? entity.additionalProcedure?.map((model: BpjsSpecialReferralModel) => new BpjsSpecialReferralModel(model).toJSON()) : [],
						...
						primaryProcedure: entity.primaryProcedure ? entity.primaryProcedure?.map((model: BpjsSpecialReferralModel) => new BpjsSpecialReferralModel(model).toJSON()) : [],
					},
			...
			map(result => {
				...
				return {
					targetModel: result.data.bpjsProcedure as BpjsProcedureModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BpjsProcedureModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsProcedureModel>> {
		...
		const successMessage = 'Created Multiple BPJS Procedure entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($bpjsProcedures: [BpjsProcedureInput!]!) {
						bpjsProcedure: createAllBpjsProcedure(bpjsProcedures: $bpjsProcedures) {
							...BpjsProcedureProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					bpjsProcedures: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.bpjsProcedure as BpjsProcedureModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BpjsProcedureModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsProcedureModel>> {
		...
		const successMessage = 'Updated BPJS Procedure entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($bpjsProcedure: BpjsProcedureInput!, $persistRelations: Boolean) {
						bpjsProcedure: updateBpjsProcedure(bpjsProcedure: $bpjsProcedure, persistRelations: $persistRelations) {
							...BpjsProcedureProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BpjsProcedureModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsProcedureModel>> {
		...
		const successMessage = 'Update Multiple BPJS Procedure entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($bpjsProcedures: [BpjsProcedureInput!]!) {
						bpjsProcedure: updateAllBpjsProcedure(bpjsProcedures: $bpjsProcedures) {
							...BpjsProcedureProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BpjsProcedureModel>> {
		...
		const successMessage = 'Deleted BPJS Procedure entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($bpjsProcedureId: ID!) {
						bpjsProcedureId: deleteBpjsProcedureById(bpjsProcedureId: $bpjsProcedureId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.bpjsProcedureId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsProcedureModel>> {
		...
		const successMessage = 'Deleted selected BPJS Procedure entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($bpjsProcedureIds: [ID!]!){
						deleteBpjsProcedureExcludingIds(bpjsProcedureIds: $bpjsProcedureIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.bpjsProcedureIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BpjsProcedureModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($bpjsProcedureIds: [ID!]!) {
						bpjsProcedureIds: deleteAllBpjsProcedureByIds(bpjsProcedureIds: $bpjsProcedureIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BpjsProcedureModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsProcedureModel>>(
			...
			map(result => {
				let audits: BpjsProcedureModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BpjsProcedureModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BpjsProcedureModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsProcedureModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($bpjsProcedureId: ID!) {
						audits: bpjsProcedureAuditsByEntityId(bpjsProcedureId: $bpjsProcedureId) {
							entity {
								...BpjsProcedureProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BpjsProcedureModel>> {
		const url = environment.API_URL + '/api/bpjsprocedure/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BpjsProcedureModel>> {
		const url = environment.API_URL + '/api/bpjsprocedure/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsProcedureModel>> {
		let apiUrl = environment.API_URL + '/api/bpjsprocedure/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BpjsProcedureModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/bpjsprocedure/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' BPJS Procedure entities')),
