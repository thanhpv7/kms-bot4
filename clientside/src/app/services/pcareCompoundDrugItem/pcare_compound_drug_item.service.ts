...
import {PcareCompoundDrugItemModel} from '../../models/pcareCompoundDrugItem/pcare_compound_drug_item.model';
import {PcareCompoundDrugItemModelAudit} from '../../models/pcareCompoundDrugItem/pcare_compound_drug_item.model.state';
...
/**
 * PCare Compound Drug Item service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class PcareCompoundDrugItemService extends AbstractHttpService<PcareCompoundDrugItemModel, PcareCompoundDrugItemModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the PcareCompoundDrugItemProperties classFragment here] off begin
			fragment PcareCompoundDrugItemProperties on PcareCompoundDrugItem {
				...PcareCompoundDrugItemBaseProperties
				drugCode
				drugQty
				request
				dose
			}
			# % protected region % [Modify the PcareCompoundDrugItemProperties classFragment here] end
			${super.fragments('PcareCompoundDrugItem').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<PcareCompoundDrugItemModel>> {
		...
		return  this.apollo.query<PassableStateConfig<PcareCompoundDrugItemModel>>(
			{
				query: gql`
					query Count {
						totalCount: countPcareCompoundDrugItems
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<PcareCompoundDrugItemModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<PcareCompoundDrugItemModel>> {
		...
		return this.apollo.query<PassableStateConfig<PcareCompoundDrugItemModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						PcareCompoundDrugItemById: pcareCompoundDrugItemById(id: $id) {
							...PcareCompoundDrugItemProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.PcareCompoundDrugItemById as PcareCompoundDrugItemModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PcareCompoundDrugItemModel>> {
		...
		return this.apollo.query<PassableStateConfig<PcareCompoundDrugItemModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						pcareCompoundDrugItems: pcareCompoundDrugItems(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...PcareCompoundDrugItemProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countPcareCompoundDrugItems(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.pcareCompoundDrugItems as PcareCompoundDrugItemModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PcareCompoundDrugItemModel>> {
		...
		return this.apollo.query<PassableStateConfig<PcareCompoundDrugItemModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						pcareCompoundDrugItems: lastPcareCompoundDrugItems(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...PcareCompoundDrugItemProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: PcareCompoundDrugItemModel, queryParams?: QueryParams): Observable<PassableStateConfig<PcareCompoundDrugItemModel>> {
		...
		const successMessage = 'Created PCare Compound Drug Item entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($pcareCompoundDrugItem: PcareCompoundDrugItemInput!, $persistRelations: Boolean) {
						pcareCompoundDrugItem: createPcareCompoundDrugItem(pcareCompoundDrugItem: $pcareCompoundDrugItem, persistRelations: $persistRelations) {
							...PcareCompoundDrugItemProperties,
				...
				`,
				variables: {
					pcareCompoundDrugItem: {
						...entity.toJSON(),
						pcareCompoundDrug: entity.pcareCompoundDrug ? new PcareCompoundDrugModel(entity.pcareCompoundDrug).toJSON() : undefined,
					},
			...
			map(result => {
				...
				return {
					targetModel: result.data.pcareCompoundDrugItem as PcareCompoundDrugItemModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: PcareCompoundDrugItemModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PcareCompoundDrugItemModel>> {
		...
		const successMessage = 'Created Multiple PCare Compound Drug Item entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($pcareCompoundDrugItems: [PcareCompoundDrugItemInput!]!) {
						pcareCompoundDrugItem: createAllPcareCompoundDrugItem(pcareCompoundDrugItems: $pcareCompoundDrugItems) {
							...PcareCompoundDrugItemProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					pcareCompoundDrugItems: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.pcareCompoundDrugItem as PcareCompoundDrugItemModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: PcareCompoundDrugItemModel, queryParams?: QueryParams): Observable<PassableStateConfig<PcareCompoundDrugItemModel>> {
		...
		const successMessage = 'Updated PCare Compound Drug Item entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($pcareCompoundDrugItem: PcareCompoundDrugItemInput!, $persistRelations: Boolean) {
						pcareCompoundDrugItem: updatePcareCompoundDrugItem(pcareCompoundDrugItem: $pcareCompoundDrugItem, persistRelations: $persistRelations) {
							...PcareCompoundDrugItemProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: PcareCompoundDrugItemModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PcareCompoundDrugItemModel>> {
		...
		const successMessage = 'Update Multiple PCare Compound Drug Item entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($pcareCompoundDrugItems: [PcareCompoundDrugItemInput!]!) {
						pcareCompoundDrugItem: updateAllPcareCompoundDrugItem(pcareCompoundDrugItems: $pcareCompoundDrugItems) {
							...PcareCompoundDrugItemProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<PcareCompoundDrugItemModel>> {
		...
		const successMessage = 'Deleted PCare Compound Drug Item entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($pcareCompoundDrugItemId: ID!) {
						pcareCompoundDrugItemId: deletePcareCompoundDrugItemById(pcareCompoundDrugItemId: $pcareCompoundDrugItemId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.pcareCompoundDrugItemId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<PcareCompoundDrugItemModel>> {
		...
		const successMessage = 'Deleted selected PCare Compound Drug Item entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($pcareCompoundDrugItemIds: [ID!]!){
						deletePcareCompoundDrugItemExcludingIds(pcareCompoundDrugItemIds: $pcareCompoundDrugItemIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.pcareCompoundDrugItemIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<PcareCompoundDrugItemModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($pcareCompoundDrugItemIds: [ID!]!) {
						pcareCompoundDrugItemIds: deleteAllPcareCompoundDrugItemByIds(pcareCompoundDrugItemIds: $pcareCompoundDrugItemIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<PcareCompoundDrugItemModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PcareCompoundDrugItemModel>>(
			{
				query: gql`
					query GetAudits {
						audits: pcareCompoundDrugItemAudits {
							entity {
								...PcareCompoundDrugItemProperties
							}
							timestamp
			...
			map(result => {
				let audits: PcareCompoundDrugItemModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new PcareCompoundDrugItemModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<PcareCompoundDrugItemModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PcareCompoundDrugItemModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($pcareCompoundDrugItemId: ID!) {
						audits: pcareCompoundDrugItemAuditsByEntityId(pcareCompoundDrugItemId: $pcareCompoundDrugItemId) {
							entity {
								...PcareCompoundDrugItemProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<PcareCompoundDrugItemModel>> {
		const url = environment.API_URL + '/api/pcarecompounddrugitem/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<PcareCompoundDrugItemModel>> {
		const url = environment.API_URL + '/api/pcarecompounddrugitem/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<PcareCompoundDrugItemModel>> {
		let apiUrl = environment.API_URL + '/api/pcarecompounddrugitem/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<PcareCompoundDrugItemModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/pcarecompounddrugitem/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' PCare Compound Drug Item entities')),
