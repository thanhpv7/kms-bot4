...
import {PcareStatusPulangModel} from '../../models/pcareStatusPulang/pcare_status_pulang.model';
import {PcareStatusPulangModelAudit} from '../../models/pcareStatusPulang/pcare_status_pulang.model.state';
...
/**
 * PCare Status Pulang service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class PcareStatusPulangService extends AbstractHttpService<PcareStatusPulangModel, PcareStatusPulangModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the PcareStatusPulangProperties classFragment here] off begin
			fragment PcareStatusPulangProperties on PcareStatusPulang {
				...PcareStatusPulangBaseProperties
				kodeStatusPulang
				namaStatusPulang
				kodeReferensiInternal
			}
			# % protected region % [Modify the PcareStatusPulangProperties classFragment here] end
			${super.fragments('PcareStatusPulang').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<PcareStatusPulangModel>> {
		...
		return  this.apollo.query<PassableStateConfig<PcareStatusPulangModel>>(
			{
				query: gql`
					query Count {
						totalCount: countPcareStatusPulangs
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<PcareStatusPulangModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<PcareStatusPulangModel>> {
		...
		return this.apollo.query<PassableStateConfig<PcareStatusPulangModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						PcareStatusPulangById: pcareStatusPulangById(id: $id) {
							...PcareStatusPulangProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.PcareStatusPulangById as PcareStatusPulangModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PcareStatusPulangModel>> {
		...
		return this.apollo.query<PassableStateConfig<PcareStatusPulangModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						pcareStatusPulangs: pcareStatusPulangs(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...PcareStatusPulangProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countPcareStatusPulangs(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.pcareStatusPulangs as PcareStatusPulangModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PcareStatusPulangModel>> {
		...
		return this.apollo.query<PassableStateConfig<PcareStatusPulangModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						pcareStatusPulangs: lastPcareStatusPulangs(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...PcareStatusPulangProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: PcareStatusPulangModel, queryParams?: QueryParams): Observable<PassableStateConfig<PcareStatusPulangModel>> {
		...
		const successMessage = 'Created PCare Status Pulang entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($pcareStatusPulang: PcareStatusPulangInput!, $persistRelations: Boolean) {
						pcareStatusPulang: createPcareStatusPulang(pcareStatusPulang: $pcareStatusPulang, persistRelations: $persistRelations) {
							...PcareStatusPulangProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.pcareStatusPulang as PcareStatusPulangModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: PcareStatusPulangModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PcareStatusPulangModel>> {
		...
		const successMessage = 'Created Multiple PCare Status Pulang entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($pcareStatusPulangs: [PcareStatusPulangInput!]!) {
						pcareStatusPulang: createAllPcareStatusPulang(pcareStatusPulangs: $pcareStatusPulangs) {
							...PcareStatusPulangProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					pcareStatusPulangs: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.pcareStatusPulang as PcareStatusPulangModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: PcareStatusPulangModel, queryParams?: QueryParams): Observable<PassableStateConfig<PcareStatusPulangModel>> {
		...
		const successMessage = 'Updated PCare Status Pulang entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($pcareStatusPulang: PcareStatusPulangInput!, $persistRelations: Boolean) {
						pcareStatusPulang: updatePcareStatusPulang(pcareStatusPulang: $pcareStatusPulang, persistRelations: $persistRelations) {
							...PcareStatusPulangProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: PcareStatusPulangModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PcareStatusPulangModel>> {
		...
		const successMessage = 'Update Multiple PCare Status Pulang entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($pcareStatusPulangs: [PcareStatusPulangInput!]!) {
						pcareStatusPulang: updateAllPcareStatusPulang(pcareStatusPulangs: $pcareStatusPulangs) {
							...PcareStatusPulangProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<PcareStatusPulangModel>> {
		...
		const successMessage = 'Deleted PCare Status Pulang entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($pcareStatusPulangId: ID!) {
						pcareStatusPulangId: deletePcareStatusPulangById(pcareStatusPulangId: $pcareStatusPulangId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.pcareStatusPulangId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<PcareStatusPulangModel>> {
		...
		const successMessage = 'Deleted selected PCare Status Pulang entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($pcareStatusPulangIds: [ID!]!){
						deletePcareStatusPulangExcludingIds(pcareStatusPulangIds: $pcareStatusPulangIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.pcareStatusPulangIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<PcareStatusPulangModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($pcareStatusPulangIds: [ID!]!) {
						pcareStatusPulangIds: deleteAllPcareStatusPulangByIds(pcareStatusPulangIds: $pcareStatusPulangIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<PcareStatusPulangModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PcareStatusPulangModel>>(
			{
				query: gql`
					query GetAudits {
						audits: pcareStatusPulangAudits {
							entity {
								...PcareStatusPulangProperties
							}
							timestamp
			...
			map(result => {
				let audits: PcareStatusPulangModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new PcareStatusPulangModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<PcareStatusPulangModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PcareStatusPulangModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($pcareStatusPulangId: ID!) {
						audits: pcareStatusPulangAuditsByEntityId(pcareStatusPulangId: $pcareStatusPulangId) {
							entity {
								...PcareStatusPulangProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<PcareStatusPulangModel>> {
		const url = environment.API_URL + '/api/pcarestatuspulang/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<PcareStatusPulangModel>> {
		const url = environment.API_URL + '/api/pcarestatuspulang/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<PcareStatusPulangModel>> {
		let apiUrl = environment.API_URL + '/api/pcarestatuspulang/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<PcareStatusPulangModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/pcarestatuspulang/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' PCare Status Pulang entities')),
