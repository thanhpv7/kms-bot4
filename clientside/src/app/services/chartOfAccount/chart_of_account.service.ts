...
import {ChartOfAccountModel} from '../../models/chartOfAccount/chart_of_account.model';
import {ChartOfAccountModelAudit} from '../../models/chartOfAccount/chart_of_account.model.state';
...
/**
 * Chart of Account service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class ChartOfAccountService extends AbstractHttpService<ChartOfAccountModel, ChartOfAccountModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the ChartOfAccountProperties classFragment here] off begin
			fragment ChartOfAccountProperties on ChartOfAccount {
				...ChartOfAccountBaseProperties
				accountCode
				accountName
				accountType
				taxCode
			...
			# % protected region % [Modify the ChartOfAccountProperties classFragment here] end
			${super.fragments('ChartOfAccount').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<ChartOfAccountModel>> {
		...
		return  this.apollo.query<PassableStateConfig<ChartOfAccountModel>>(
			{
				query: gql`
					query Count {
						totalCount: countChartOfAccounts
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<ChartOfAccountModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<ChartOfAccountModel>> {
		...
		return this.apollo.query<PassableStateConfig<ChartOfAccountModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						ChartOfAccountById: chartOfAccountById(id: $id) {
							...ChartOfAccountProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.ChartOfAccountById as ChartOfAccountModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<ChartOfAccountModel>> {
		...
		return this.apollo.query<PassableStateConfig<ChartOfAccountModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						chartOfAccounts: chartOfAccounts(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...ChartOfAccountProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countChartOfAccounts(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.chartOfAccounts as ChartOfAccountModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<ChartOfAccountModel>> {
		...
		return this.apollo.query<PassableStateConfig<ChartOfAccountModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						chartOfAccounts: lastChartOfAccounts(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...ChartOfAccountProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: ChartOfAccountModel, queryParams?: QueryParams): Observable<PassableStateConfig<ChartOfAccountModel>> {
		...
		const successMessage = 'Created Chart of Account entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($chartOfAccount: ChartOfAccountInput!, $persistRelations: Boolean) {
						chartOfAccount: createChartOfAccount(chartOfAccount: $chartOfAccount, persistRelations: $persistRelations) {
							...ChartOfAccountProperties,
				...
				variables: {
					chartOfAccount: {
						...entity.toJSON(),
						chartOfAccountMappings: entity.chartOfAccountMappings ? entity.chartOfAccountMappings?.map((model: ChartOfAccountMappingModel) => new ChartOfAccountMappingModel(model).toJSON()) : [],
					},
			...
			map(result => {
				...
				return {
					targetModel: result.data.chartOfAccount as ChartOfAccountModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: ChartOfAccountModel[], queryParams?: QueryParams): Observable<PassableStateConfig<ChartOfAccountModel>> {
		...
		const successMessage = 'Created Multiple Chart of Account entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($chartOfAccounts: [ChartOfAccountInput!]!) {
						chartOfAccount: createAllChartOfAccount(chartOfAccounts: $chartOfAccounts) {
							...ChartOfAccountProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					chartOfAccounts: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.chartOfAccount as ChartOfAccountModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: ChartOfAccountModel, queryParams?: QueryParams): Observable<PassableStateConfig<ChartOfAccountModel>> {
		...
		const successMessage = 'Updated Chart of Account entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($chartOfAccount: ChartOfAccountInput!, $persistRelations: Boolean) {
						chartOfAccount: updateChartOfAccount(chartOfAccount: $chartOfAccount, persistRelations: $persistRelations) {
							...ChartOfAccountProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: ChartOfAccountModel[], queryParams?: QueryParams): Observable<PassableStateConfig<ChartOfAccountModel>> {
		...
		const successMessage = 'Update Multiple Chart of Account entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($chartOfAccounts: [ChartOfAccountInput!]!) {
						chartOfAccount: updateAllChartOfAccount(chartOfAccounts: $chartOfAccounts) {
							...ChartOfAccountProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<ChartOfAccountModel>> {
		...
		const successMessage = 'Deleted Chart of Account entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($chartOfAccountId: ID!) {
						chartOfAccountId: deleteChartOfAccountById(chartOfAccountId: $chartOfAccountId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.chartOfAccountId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<ChartOfAccountModel>> {
		...
		const successMessage = 'Deleted selected Chart of Account entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($chartOfAccountIds: [ID!]!){
						deleteChartOfAccountExcludingIds(chartOfAccountIds: $chartOfAccountIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.chartOfAccountIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<ChartOfAccountModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($chartOfAccountIds: [ID!]!) {
						chartOfAccountIds: deleteAllChartOfAccountByIds(chartOfAccountIds: $chartOfAccountIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<ChartOfAccountModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<ChartOfAccountModel>>(
			...
			map(result => {
				let audits: ChartOfAccountModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new ChartOfAccountModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<ChartOfAccountModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<ChartOfAccountModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($chartOfAccountId: ID!) {
						audits: chartOfAccountAuditsByEntityId(chartOfAccountId: $chartOfAccountId) {
							entity {
								...ChartOfAccountProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<ChartOfAccountModel>> {
		const url = environment.API_URL + '/api/chartofaccount/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<ChartOfAccountModel>> {
		const url = environment.API_URL + '/api/chartofaccount/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<ChartOfAccountModel>> {
		let apiUrl = environment.API_URL + '/api/chartofaccount/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<ChartOfAccountModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/chartofaccount/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Chart of Account entities')),
