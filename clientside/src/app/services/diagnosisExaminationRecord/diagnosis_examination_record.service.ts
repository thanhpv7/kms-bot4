...
import {DiagnosisExaminationRecordModelAudit} from '../../models/diagnosisExaminationRecord/diagnosis_examination_record.model.state';
...
/**
 * Diagnosis Examination Record service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class DiagnosisExaminationRecordService extends AbstractHttpService<DiagnosisExaminationRecordModel, DiagnosisExaminationRecordModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the DiagnosisExaminationRecordProperties classFragment here] off begin
			fragment DiagnosisExaminationRecordProperties on DiagnosisExaminationRecord {
				...DiagnosisExaminationRecordBaseProperties
				diagnosisSequence
				diagnosisNotes
				actionNotes
				newCase
			...
			# % protected region % [Modify the DiagnosisExaminationRecordProperties classFragment here] end
			${super.fragments('DiagnosisExaminationRecord').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<DiagnosisExaminationRecordModel>> {
		...
		return  this.apollo.query<PassableStateConfig<DiagnosisExaminationRecordModel>>(
			{
				query: gql`
					query Count {
						totalCount: countDiagnosisExaminationRecords
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<DiagnosisExaminationRecordModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<DiagnosisExaminationRecordModel>> {
		...
		return this.apollo.query<PassableStateConfig<DiagnosisExaminationRecordModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						DiagnosisExaminationRecordById: diagnosisExaminationRecordById(id: $id) {
							...DiagnosisExaminationRecordProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.DiagnosisExaminationRecordById as DiagnosisExaminationRecordModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<DiagnosisExaminationRecordModel>> {
		...
		return this.apollo.query<PassableStateConfig<DiagnosisExaminationRecordModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						diagnosisExaminationRecords: diagnosisExaminationRecords(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...DiagnosisExaminationRecordProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countDiagnosisExaminationRecords(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.diagnosisExaminationRecords as DiagnosisExaminationRecordModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<DiagnosisExaminationRecordModel>> {
		...
		return this.apollo.query<PassableStateConfig<DiagnosisExaminationRecordModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						diagnosisExaminationRecords: lastDiagnosisExaminationRecords(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...DiagnosisExaminationRecordProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: DiagnosisExaminationRecordModel, queryParams?: QueryParams): Observable<PassableStateConfig<DiagnosisExaminationRecordModel>> {
		...
		const successMessage = 'Created Diagnosis Examination Record entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($diagnosisExaminationRecord: DiagnosisExaminationRecordInput!, $persistRelations: Boolean) {
						diagnosisExaminationRecord: createDiagnosisExaminationRecord(diagnosisExaminationRecord: $diagnosisExaminationRecord, persistRelations: $persistRelations) {
							...DiagnosisExaminationRecordProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.diagnosisExaminationRecord as DiagnosisExaminationRecordModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: DiagnosisExaminationRecordModel[], queryParams?: QueryParams): Observable<PassableStateConfig<DiagnosisExaminationRecordModel>> {
		...
		const successMessage = 'Created Multiple Diagnosis Examination Record entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($diagnosisExaminationRecords: [DiagnosisExaminationRecordInput!]!) {
						diagnosisExaminationRecord: createAllDiagnosisExaminationRecord(diagnosisExaminationRecords: $diagnosisExaminationRecords) {
							...DiagnosisExaminationRecordProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					diagnosisExaminationRecords: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.diagnosisExaminationRecord as DiagnosisExaminationRecordModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: DiagnosisExaminationRecordModel, queryParams?: QueryParams): Observable<PassableStateConfig<DiagnosisExaminationRecordModel>> {
		...
		const successMessage = 'Updated Diagnosis Examination Record entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($diagnosisExaminationRecord: DiagnosisExaminationRecordInput!, $persistRelations: Boolean) {
						diagnosisExaminationRecord: updateDiagnosisExaminationRecord(diagnosisExaminationRecord: $diagnosisExaminationRecord, persistRelations: $persistRelations) {
							...DiagnosisExaminationRecordProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: DiagnosisExaminationRecordModel[], queryParams?: QueryParams): Observable<PassableStateConfig<DiagnosisExaminationRecordModel>> {
		...
		const successMessage = 'Update Multiple Diagnosis Examination Record entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($diagnosisExaminationRecords: [DiagnosisExaminationRecordInput!]!) {
						diagnosisExaminationRecord: updateAllDiagnosisExaminationRecord(diagnosisExaminationRecords: $diagnosisExaminationRecords) {
							...DiagnosisExaminationRecordProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<DiagnosisExaminationRecordModel>> {
		...
		const successMessage = 'Deleted Diagnosis Examination Record entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($diagnosisExaminationRecordId: ID!) {
						diagnosisExaminationRecordId: deleteDiagnosisExaminationRecordById(diagnosisExaminationRecordId: $diagnosisExaminationRecordId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.diagnosisExaminationRecordId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<DiagnosisExaminationRecordModel>> {
		...
		const successMessage = 'Deleted selected Diagnosis Examination Record entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($diagnosisExaminationRecordIds: [ID!]!){
						deleteDiagnosisExaminationRecordExcludingIds(diagnosisExaminationRecordIds: $diagnosisExaminationRecordIds)
				...
				`,
				variables: {
					diagnosisExaminationRecordIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.diagnosisExaminationRecordIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<DiagnosisExaminationRecordModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($diagnosisExaminationRecordIds: [ID!]!) {
						diagnosisExaminationRecordIds: deleteAllDiagnosisExaminationRecordByIds(diagnosisExaminationRecordIds: $diagnosisExaminationRecordIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<DiagnosisExaminationRecordModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<DiagnosisExaminationRecordModel>>(
			{
				query: gql`
					query GetAudits {
						audits: diagnosisExaminationRecordAudits {
							entity {
								...DiagnosisExaminationRecordProperties
							}
							timestamp
			...
			map(result => {
				let audits: DiagnosisExaminationRecordModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new DiagnosisExaminationRecordModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<DiagnosisExaminationRecordModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<DiagnosisExaminationRecordModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($diagnosisExaminationRecordId: ID!) {
						audits: diagnosisExaminationRecordAuditsByEntityId(diagnosisExaminationRecordId: $diagnosisExaminationRecordId) {
							entity {
								...DiagnosisExaminationRecordProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<DiagnosisExaminationRecordModel>> {
		const url = environment.API_URL + '/api/diagnosisexaminationrecord/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<DiagnosisExaminationRecordModel>> {
		const url = environment.API_URL + '/api/diagnosisexaminationrecord/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<DiagnosisExaminationRecordModel>> {
		let apiUrl = environment.API_URL + '/api/diagnosisexaminationrecord/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<DiagnosisExaminationRecordModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/diagnosisexaminationrecord/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Diagnosis Examination Record entities')),
