...
import {PatientSupportingDocumentModel} from '../../models/patientSupportingDocument/patient_supporting_document.model';
import {PatientSupportingDocumentModelAudit} from '../../models/patientSupportingDocument/patient_supporting_document.model.state';
...
/**
 * Patient Supporting Document service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class PatientSupportingDocumentService extends AbstractHttpService<PatientSupportingDocumentModel, PatientSupportingDocumentModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the PatientSupportingDocumentProperties classFragment here] off begin
			fragment PatientSupportingDocumentProperties on PatientSupportingDocument {
				...PatientSupportingDocumentBaseProperties
				supportingDocument {
					id
					created
					modified
			...
			# % protected region % [Modify the PatientSupportingDocumentProperties classFragment here] end
			${super.fragments('PatientSupportingDocument').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<PatientSupportingDocumentModel>> {
		...
		return  this.apollo.query<PassableStateConfig<PatientSupportingDocumentModel>>(
			{
				query: gql`
					query Count {
						totalCount: countPatientSupportingDocuments
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<PatientSupportingDocumentModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<PatientSupportingDocumentModel>> {
		...
		return this.apollo.query<PassableStateConfig<PatientSupportingDocumentModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						PatientSupportingDocumentById: patientSupportingDocumentById(id: $id) {
							...PatientSupportingDocumentProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.PatientSupportingDocumentById as PatientSupportingDocumentModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PatientSupportingDocumentModel>> {
		...
		return this.apollo.query<PassableStateConfig<PatientSupportingDocumentModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						patientSupportingDocuments: patientSupportingDocuments(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...PatientSupportingDocumentProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countPatientSupportingDocuments(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.patientSupportingDocuments as PatientSupportingDocumentModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PatientSupportingDocumentModel>> {
		...
		return this.apollo.query<PassableStateConfig<PatientSupportingDocumentModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						patientSupportingDocuments: lastPatientSupportingDocuments(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...PatientSupportingDocumentProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: PatientSupportingDocumentModel, queryParams?: QueryParams): Observable<PassableStateConfig<PatientSupportingDocumentModel>> {
		...
		const successMessage = 'Created Patient Supporting Document entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($patientSupportingDocument: PatientSupportingDocumentInput!, $persistRelations: Boolean) {
						patientSupportingDocument: createPatientSupportingDocument(patientSupportingDocument: $patientSupportingDocument, persistRelations: $persistRelations) {
							...PatientSupportingDocumentProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.patientSupportingDocument as PatientSupportingDocumentModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: PatientSupportingDocumentModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PatientSupportingDocumentModel>> {
		...
		const successMessage = 'Created Multiple Patient Supporting Document entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($patientSupportingDocuments: [PatientSupportingDocumentInput!]!) {
						patientSupportingDocument: createAllPatientSupportingDocument(patientSupportingDocuments: $patientSupportingDocuments) {
							...PatientSupportingDocumentProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					patientSupportingDocuments: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.patientSupportingDocument as PatientSupportingDocumentModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: PatientSupportingDocumentModel, queryParams?: QueryParams): Observable<PassableStateConfig<PatientSupportingDocumentModel>> {
		...
		const successMessage = 'Updated Patient Supporting Document entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($patientSupportingDocument: PatientSupportingDocumentInput!, $persistRelations: Boolean) {
						patientSupportingDocument: updatePatientSupportingDocument(patientSupportingDocument: $patientSupportingDocument, persistRelations: $persistRelations) {
							...PatientSupportingDocumentProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: PatientSupportingDocumentModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PatientSupportingDocumentModel>> {
		...
		const successMessage = 'Update Multiple Patient Supporting Document entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($patientSupportingDocuments: [PatientSupportingDocumentInput!]!) {
						patientSupportingDocument: updateAllPatientSupportingDocument(patientSupportingDocuments: $patientSupportingDocuments) {
							...PatientSupportingDocumentProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<PatientSupportingDocumentModel>> {
		...
		const successMessage = 'Deleted Patient Supporting Document entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($patientSupportingDocumentId: ID!) {
						patientSupportingDocumentId: deletePatientSupportingDocumentById(patientSupportingDocumentId: $patientSupportingDocumentId)
				...
				`,
				variables: {
					patientSupportingDocumentId: id,
			...
			map(result => {
				...
				return {
					targetModelId: result.data.patientSupportingDocumentId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<PatientSupportingDocumentModel>> {
		...
		const successMessage = 'Deleted selected Patient Supporting Document entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($patientSupportingDocumentIds: [ID!]!){
						deletePatientSupportingDocumentExcludingIds(patientSupportingDocumentIds: $patientSupportingDocumentIds)
				...
				`,
				variables: {
					patientSupportingDocumentIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.patientSupportingDocumentIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<PatientSupportingDocumentModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($patientSupportingDocumentIds: [ID!]!) {
						patientSupportingDocumentIds: deleteAllPatientSupportingDocumentByIds(patientSupportingDocumentIds: $patientSupportingDocumentIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<PatientSupportingDocumentModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PatientSupportingDocumentModel>>(
			{
				query: gql`
					query GetAudits {
						audits: patientSupportingDocumentAudits {
							entity {
								...PatientSupportingDocumentProperties
							}
							timestamp
			...
			map(result => {
				let audits: PatientSupportingDocumentModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new PatientSupportingDocumentModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<PatientSupportingDocumentModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PatientSupportingDocumentModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($patientSupportingDocumentId: ID!) {
						audits: patientSupportingDocumentAuditsByEntityId(patientSupportingDocumentId: $patientSupportingDocumentId) {
							entity {
								...PatientSupportingDocumentProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<PatientSupportingDocumentModel>> {
		const url = environment.API_URL + '/api/patientsupportingdocument/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<PatientSupportingDocumentModel>> {
		const url = environment.API_URL + '/api/patientsupportingdocument/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<PatientSupportingDocumentModel>> {
		let apiUrl = environment.API_URL + '/api/patientsupportingdocument/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<PatientSupportingDocumentModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/patientsupportingdocument/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Patient Supporting Document entities')),
