...
import {ClaimUserModel} from '../../models/claimUser/claim_user.model';
import {ClaimUserModelAudit} from '../../models/claimUser/claim_user.model.state';
...
/**
 * Claim User service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class ClaimUserService extends UserService<ClaimUserModel, ClaimUserModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the ClaimUserProperties classFragment here] off begin
			fragment ClaimUserProperties on ClaimUser {
				...ClaimUserUserProperties
			}
			# % protected region % [Modify the ClaimUserProperties classFragment here] end
			${super.fragments('ClaimUser').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<ClaimUserModel>> {
		...
		return  this.apollo.query<PassableStateConfig<ClaimUserModel>>(
			{
				query: gql`
					query Count {
						totalCount: countClaimUsers
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<ClaimUserModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<ClaimUserModel>> {
		...
		return this.apollo.query<PassableStateConfig<ClaimUserModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						ClaimUserById: claimUserById(id: $id) {
							...ClaimUserProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.ClaimUserById as ClaimUserModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<ClaimUserModel>> {
		...
		return this.apollo.query<PassableStateConfig<ClaimUserModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						claimUsers: claimUsers(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...ClaimUserProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countClaimUsers(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.claimUsers as ClaimUserModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<ClaimUserModel>> {
		...
		return this.apollo.query<PassableStateConfig<ClaimUserModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						claimUsers: lastClaimUsers(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...ClaimUserProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: ClaimUserModel, queryParams?: QueryParams): Observable<PassableStateConfig<ClaimUserModel>> {
		...
		const successMessage = 'Created Claim User entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($claimUser: ClaimUserInput!, $persistRelations: Boolean) {
						claimUser: createClaimUser(claimUser: $claimUser, persistRelations: $persistRelations) {
							...ClaimUserProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.claimUser as ClaimUserModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: ClaimUserModel[], queryParams?: QueryParams): Observable<PassableStateConfig<ClaimUserModel>> {
		...
		const successMessage = 'Created Multiple Claim User entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($claimUsers: [ClaimUserInput!]!) {
						claimUser: createAllClaimUser(claimUsers: $claimUsers) {
							...ClaimUserProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					claimUsers: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.claimUser as ClaimUserModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: ClaimUserModel, queryParams?: QueryParams): Observable<PassableStateConfig<ClaimUserModel>> {
		...
		const successMessage = 'Updated Claim User entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($claimUser: ClaimUserInput!, $persistRelations: Boolean) {
						claimUser: updateClaimUser(claimUser: $claimUser, persistRelations: $persistRelations) {
							...ClaimUserProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: ClaimUserModel[], queryParams?: QueryParams): Observable<PassableStateConfig<ClaimUserModel>> {
		...
		const successMessage = 'Update Multiple Claim User entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($claimUsers: [ClaimUserInput!]!) {
						claimUser: updateAllClaimUser(claimUsers: $claimUsers) {
							...ClaimUserProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<ClaimUserModel>> {
		...
		const successMessage = 'Deleted Claim User entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($claimUserId: ID!) {
						claimUserId: deleteClaimUserById(claimUserId: $claimUserId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.claimUserId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<ClaimUserModel>> {
		...
		const successMessage = 'Deleted selected Claim User entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($claimUserIds: [ID!]!){
						deleteClaimUserExcludingIds(claimUserIds: $claimUserIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.claimUserIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<ClaimUserModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($claimUserIds: [ID!]!) {
						claimUserIds: deleteAllClaimUserByIds(claimUserIds: $claimUserIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<ClaimUserModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<ClaimUserModel>>(
			...
			map(result => {
				let audits: ClaimUserModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new ClaimUserModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<ClaimUserModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<ClaimUserModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($claimUserId: ID!) {
						audits: claimUserAuditsByEntityId(claimUserId: $claimUserId) {
							entity {
								...ClaimUserProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<ClaimUserModel>> {
		const url = environment.API_URL + '/api/claimuser/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<ClaimUserModel>> {
		const url = environment.API_URL + '/api/claimuser/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<ClaimUserModel>> {
		let apiUrl = environment.API_URL + '/api/claimuser/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<ClaimUserModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/claimuser/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Claim User entities')),
