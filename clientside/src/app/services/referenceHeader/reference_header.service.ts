...
import {ReferenceHeaderModel} from '../../models/referenceHeader/reference_header.model';
import {ReferenceHeaderModelAudit} from '../../models/referenceHeader/reference_header.model.state';
...
/**
 * Reference Header service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class ReferenceHeaderService extends AbstractHttpService<ReferenceHeaderModel, ReferenceHeaderModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the ReferenceHeaderProperties classFragment here] off begin
			fragment ReferenceHeaderProperties on ReferenceHeader {
				...ReferenceHeaderBaseProperties
				referenceType
				description
			}
			# % protected region % [Modify the ReferenceHeaderProperties classFragment here] end
			${super.fragments('ReferenceHeader').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<ReferenceHeaderModel>> {
		...
		return  this.apollo.query<PassableStateConfig<ReferenceHeaderModel>>(
			{
				query: gql`
					query Count {
						totalCount: countReferenceHeaders
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<ReferenceHeaderModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<ReferenceHeaderModel>> {
		...
		return this.apollo.query<PassableStateConfig<ReferenceHeaderModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						ReferenceHeaderById: referenceHeaderById(id: $id) {
							...ReferenceHeaderProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.ReferenceHeaderById as ReferenceHeaderModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<ReferenceHeaderModel>> {
		...
		return this.apollo.query<PassableStateConfig<ReferenceHeaderModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						referenceHeaders: referenceHeaders(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...ReferenceHeaderProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countReferenceHeaders(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.referenceHeaders as ReferenceHeaderModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<ReferenceHeaderModel>> {
		...
		return this.apollo.query<PassableStateConfig<ReferenceHeaderModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						referenceHeaders: lastReferenceHeaders(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...ReferenceHeaderProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: ReferenceHeaderModel, queryParams?: QueryParams): Observable<PassableStateConfig<ReferenceHeaderModel>> {
		...
		const successMessage = 'Created Reference Header entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($referenceHeader: ReferenceHeaderInput!, $persistRelations: Boolean) {
						referenceHeader: createReferenceHeader(referenceHeader: $referenceHeader, persistRelations: $persistRelations) {
							...ReferenceHeaderProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.referenceHeader as ReferenceHeaderModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: ReferenceHeaderModel[], queryParams?: QueryParams): Observable<PassableStateConfig<ReferenceHeaderModel>> {
		...
		const successMessage = 'Created Multiple Reference Header entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($referenceHeaders: [ReferenceHeaderInput!]!) {
						referenceHeader: createAllReferenceHeader(referenceHeaders: $referenceHeaders) {
							...ReferenceHeaderProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					referenceHeaders: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.referenceHeader as ReferenceHeaderModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: ReferenceHeaderModel, queryParams?: QueryParams): Observable<PassableStateConfig<ReferenceHeaderModel>> {
		...
		const successMessage = 'Updated Reference Header entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($referenceHeader: ReferenceHeaderInput!, $persistRelations: Boolean) {
						referenceHeader: updateReferenceHeader(referenceHeader: $referenceHeader, persistRelations: $persistRelations) {
							...ReferenceHeaderProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: ReferenceHeaderModel[], queryParams?: QueryParams): Observable<PassableStateConfig<ReferenceHeaderModel>> {
		...
		const successMessage = 'Update Multiple Reference Header entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($referenceHeaders: [ReferenceHeaderInput!]!) {
						referenceHeader: updateAllReferenceHeader(referenceHeaders: $referenceHeaders) {
							...ReferenceHeaderProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<ReferenceHeaderModel>> {
		...
		const successMessage = 'Deleted Reference Header entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($referenceHeaderId: ID!) {
						referenceHeaderId: deleteReferenceHeaderById(referenceHeaderId: $referenceHeaderId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.referenceHeaderId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<ReferenceHeaderModel>> {
		...
		const successMessage = 'Deleted selected Reference Header entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($referenceHeaderIds: [ID!]!){
						deleteReferenceHeaderExcludingIds(referenceHeaderIds: $referenceHeaderIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.referenceHeaderIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<ReferenceHeaderModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($referenceHeaderIds: [ID!]!) {
						referenceHeaderIds: deleteAllReferenceHeaderByIds(referenceHeaderIds: $referenceHeaderIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<ReferenceHeaderModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<ReferenceHeaderModel>>(
			...
			map(result => {
				let audits: ReferenceHeaderModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new ReferenceHeaderModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<ReferenceHeaderModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<ReferenceHeaderModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($referenceHeaderId: ID!) {
						audits: referenceHeaderAuditsByEntityId(referenceHeaderId: $referenceHeaderId) {
							entity {
								...ReferenceHeaderProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<ReferenceHeaderModel>> {
		const url = environment.API_URL + '/api/referenceheader/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<ReferenceHeaderModel>> {
		const url = environment.API_URL + '/api/referenceheader/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<ReferenceHeaderModel>> {
		let apiUrl = environment.API_URL + '/api/referenceheader/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<ReferenceHeaderModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/referenceheader/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Reference Header entities')),
