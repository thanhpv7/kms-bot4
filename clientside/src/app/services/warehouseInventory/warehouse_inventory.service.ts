...
import {WarehouseInventoryModelAudit} from '../../models/warehouseInventory/warehouse_inventory.model.state';
...
/**
 * Warehouse Inventory service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class WarehouseInventoryService extends AbstractHttpService<WarehouseInventoryModel, WarehouseInventoryModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the WarehouseInventoryProperties classFragment here] off begin
			fragment WarehouseInventoryProperties on WarehouseInventory {
				...WarehouseInventoryBaseProperties
				soh
				reservedQuantity
				notes
			}
			# % protected region % [Modify the WarehouseInventoryProperties classFragment here] end
			${super.fragments('WarehouseInventory').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<WarehouseInventoryModel>> {
		...
		return  this.apollo.query<PassableStateConfig<WarehouseInventoryModel>>(
			{
				query: gql`
					query Count {
						totalCount: countWarehouseInventorys
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<WarehouseInventoryModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<WarehouseInventoryModel>> {
		...
		return this.apollo.query<PassableStateConfig<WarehouseInventoryModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						WarehouseInventoryById: warehouseInventoryById(id: $id) {
							...WarehouseInventoryProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.WarehouseInventoryById as WarehouseInventoryModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<WarehouseInventoryModel>> {
		...
		return this.apollo.query<PassableStateConfig<WarehouseInventoryModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						warehouseInventorys: warehouseInventorys(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...WarehouseInventoryProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countWarehouseInventorys(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.warehouseInventorys as WarehouseInventoryModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<WarehouseInventoryModel>> {
		...
		return this.apollo.query<PassableStateConfig<WarehouseInventoryModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						warehouseInventorys: lastWarehouseInventorys(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...WarehouseInventoryProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: WarehouseInventoryModel, queryParams?: QueryParams): Observable<PassableStateConfig<WarehouseInventoryModel>> {
		...
		const successMessage = 'Created Warehouse Inventory entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($warehouseInventory: WarehouseInventoryInput!, $persistRelations: Boolean) {
						warehouseInventory: createWarehouseInventory(warehouseInventory: $warehouseInventory, persistRelations: $persistRelations) {
							...WarehouseInventoryProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.warehouseInventory as WarehouseInventoryModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: WarehouseInventoryModel[], queryParams?: QueryParams): Observable<PassableStateConfig<WarehouseInventoryModel>> {
		...
		const successMessage = 'Created Multiple Warehouse Inventory entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($warehouseInventorys: [WarehouseInventoryInput!]!) {
						warehouseInventory: createAllWarehouseInventory(warehouseInventorys: $warehouseInventorys) {
							...WarehouseInventoryProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					warehouseInventorys: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.warehouseInventory as WarehouseInventoryModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: WarehouseInventoryModel, queryParams?: QueryParams): Observable<PassableStateConfig<WarehouseInventoryModel>> {
		...
		const successMessage = 'Updated Warehouse Inventory entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($warehouseInventory: WarehouseInventoryInput!, $persistRelations: Boolean) {
						warehouseInventory: updateWarehouseInventory(warehouseInventory: $warehouseInventory, persistRelations: $persistRelations) {
							...WarehouseInventoryProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: WarehouseInventoryModel[], queryParams?: QueryParams): Observable<PassableStateConfig<WarehouseInventoryModel>> {
		...
		const successMessage = 'Update Multiple Warehouse Inventory entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($warehouseInventorys: [WarehouseInventoryInput!]!) {
						warehouseInventory: updateAllWarehouseInventory(warehouseInventorys: $warehouseInventorys) {
							...WarehouseInventoryProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<WarehouseInventoryModel>> {
		...
		const successMessage = 'Deleted Warehouse Inventory entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($warehouseInventoryId: ID!) {
						warehouseInventoryId: deleteWarehouseInventoryById(warehouseInventoryId: $warehouseInventoryId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.warehouseInventoryId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<WarehouseInventoryModel>> {
		...
		const successMessage = 'Deleted selected Warehouse Inventory entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($warehouseInventoryIds: [ID!]!){
						deleteWarehouseInventoryExcludingIds(warehouseInventoryIds: $warehouseInventoryIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.warehouseInventoryIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<WarehouseInventoryModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($warehouseInventoryIds: [ID!]!) {
						warehouseInventoryIds: deleteAllWarehouseInventoryByIds(warehouseInventoryIds: $warehouseInventoryIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<WarehouseInventoryModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<WarehouseInventoryModel>>(
			{
				query: gql`
					query GetAudits {
						audits: warehouseInventoryAudits {
							entity {
								...WarehouseInventoryProperties
							}
							timestamp
			...
			map(result => {
				let audits: WarehouseInventoryModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new WarehouseInventoryModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<WarehouseInventoryModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<WarehouseInventoryModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($warehouseInventoryId: ID!) {
						audits: warehouseInventoryAuditsByEntityId(warehouseInventoryId: $warehouseInventoryId) {
							entity {
								...WarehouseInventoryProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<WarehouseInventoryModel>> {
		const url = environment.API_URL + '/api/warehouseinventory/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<WarehouseInventoryModel>> {
		const url = environment.API_URL + '/api/warehouseinventory/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<WarehouseInventoryModel>> {
		let apiUrl = environment.API_URL + '/api/warehouseinventory/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<WarehouseInventoryModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/warehouseinventory/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Warehouse Inventory entities')),
