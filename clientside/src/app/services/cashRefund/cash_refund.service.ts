...
import {CashRefundModel} from '../../models/cashRefund/cash_refund.model';
import {CashRefundModelAudit} from '../../models/cashRefund/cash_refund.model.state';
...
/**
 * Cash Refund service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class CashRefundService extends AbstractHttpService<CashRefundModel, CashRefundModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the CashRefundProperties classFragment here] off begin
			fragment CashRefundProperties on CashRefund {
				...CashRefundBaseProperties
				refundNumber
				refundDate
				description
				cashierLocation
			...
			# % protected region % [Modify the CashRefundProperties classFragment here] end
			${super.fragments('CashRefund').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<CashRefundModel>> {
		...
		return  this.apollo.query<PassableStateConfig<CashRefundModel>>(
			{
				query: gql`
					query Count {
						totalCount: countCashRefunds
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<CashRefundModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<CashRefundModel>> {
		...
		return this.apollo.query<PassableStateConfig<CashRefundModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						CashRefundById: cashRefundById(id: $id) {
							...CashRefundProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.CashRefundById as CashRefundModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<CashRefundModel>> {
		...
		return this.apollo.query<PassableStateConfig<CashRefundModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						cashRefunds: cashRefunds(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...CashRefundProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countCashRefunds(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.cashRefunds as CashRefundModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<CashRefundModel>> {
		...
		return this.apollo.query<PassableStateConfig<CashRefundModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						cashRefunds: lastCashRefunds(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...CashRefundProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: CashRefundModel, queryParams?: QueryParams): Observable<PassableStateConfig<CashRefundModel>> {
		...
		const successMessage = 'Created Cash Refund entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($cashRefund: CashRefundInput!, $persistRelations: Boolean) {
						cashRefund: createCashRefund(cashRefund: $cashRefund, persistRelations: $persistRelations) {
							...CashRefundProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.cashRefund as CashRefundModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: CashRefundModel[], queryParams?: QueryParams): Observable<PassableStateConfig<CashRefundModel>> {
		...
		const successMessage = 'Created Multiple Cash Refund entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($cashRefunds: [CashRefundInput!]!) {
						cashRefund: createAllCashRefund(cashRefunds: $cashRefunds) {
							...CashRefundProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					cashRefunds: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.cashRefund as CashRefundModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: CashRefundModel, queryParams?: QueryParams): Observable<PassableStateConfig<CashRefundModel>> {
		...
		const successMessage = 'Updated Cash Refund entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($cashRefund: CashRefundInput!, $persistRelations: Boolean) {
						cashRefund: updateCashRefund(cashRefund: $cashRefund, persistRelations: $persistRelations) {
							...CashRefundProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: CashRefundModel[], queryParams?: QueryParams): Observable<PassableStateConfig<CashRefundModel>> {
		...
		const successMessage = 'Update Multiple Cash Refund entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($cashRefunds: [CashRefundInput!]!) {
						cashRefund: updateAllCashRefund(cashRefunds: $cashRefunds) {
							...CashRefundProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<CashRefundModel>> {
		...
		const successMessage = 'Deleted Cash Refund entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($cashRefundId: ID!) {
						cashRefundId: deleteCashRefundById(cashRefundId: $cashRefundId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.cashRefundId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<CashRefundModel>> {
		...
		const successMessage = 'Deleted selected Cash Refund entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($cashRefundIds: [ID!]!){
						deleteCashRefundExcludingIds(cashRefundIds: $cashRefundIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.cashRefundIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<CashRefundModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($cashRefundIds: [ID!]!) {
						cashRefundIds: deleteAllCashRefundByIds(cashRefundIds: $cashRefundIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<CashRefundModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<CashRefundModel>>(
			...
			map(result => {
				let audits: CashRefundModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new CashRefundModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<CashRefundModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<CashRefundModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($cashRefundId: ID!) {
						audits: cashRefundAuditsByEntityId(cashRefundId: $cashRefundId) {
							entity {
								...CashRefundProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<CashRefundModel>> {
		const url = environment.API_URL + '/api/cashrefund/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<CashRefundModel>> {
		const url = environment.API_URL + '/api/cashrefund/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<CashRefundModel>> {
		let apiUrl = environment.API_URL + '/api/cashrefund/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<CashRefundModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/cashrefund/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Cash Refund entities')),
