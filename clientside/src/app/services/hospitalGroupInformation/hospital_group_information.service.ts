...
import {HospitalGroupInformationModel} from '../../models/hospitalGroupInformation/hospital_group_information.model';
import {HospitalGroupInformationModelAudit} from '../../models/hospitalGroupInformation/hospital_group_information.model.state';
...
/**
 * Hospital Group Information service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class HospitalGroupInformationService extends AbstractHttpService<HospitalGroupInformationModel, HospitalGroupInformationModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the HospitalGroupInformationProperties classFragment here] off begin
			fragment HospitalGroupInformationProperties on HospitalGroupInformation {
				...HospitalGroupInformationBaseProperties
				hospitalGroupCode
				hospitalGroupName
				hospitalGroupCorporationName
				hospitalGroupDirector
				operationalLicenseNo
				hospitalGroupCorporationStatus
				address
				city
				postcode
				phoneNumber
			...
			# % protected region % [Modify the HospitalGroupInformationProperties classFragment here] end
			${super.fragments('HospitalGroupInformation').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<HospitalGroupInformationModel>> {
		...
		return  this.apollo.query<PassableStateConfig<HospitalGroupInformationModel>>(
			{
				query: gql`
					query Count {
						totalCount: countHospitalGroupInformations
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<HospitalGroupInformationModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<HospitalGroupInformationModel>> {
		...
		return this.apollo.query<PassableStateConfig<HospitalGroupInformationModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						HospitalGroupInformationById: hospitalGroupInformationById(id: $id) {
							...HospitalGroupInformationProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.HospitalGroupInformationById as HospitalGroupInformationModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<HospitalGroupInformationModel>> {
		...
		return this.apollo.query<PassableStateConfig<HospitalGroupInformationModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						hospitalGroupInformations: hospitalGroupInformations(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...HospitalGroupInformationProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countHospitalGroupInformations(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.hospitalGroupInformations as HospitalGroupInformationModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<HospitalGroupInformationModel>> {
		...
		return this.apollo.query<PassableStateConfig<HospitalGroupInformationModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						hospitalGroupInformations: lastHospitalGroupInformations(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...HospitalGroupInformationProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: HospitalGroupInformationModel, queryParams?: QueryParams): Observable<PassableStateConfig<HospitalGroupInformationModel>> {
		...
		const successMessage = 'Created Hospital Group Information entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($hospitalGroupInformation: HospitalGroupInformationInput!, $persistRelations: Boolean) {
						hospitalGroupInformation: createHospitalGroupInformation(hospitalGroupInformation: $hospitalGroupInformation, persistRelations: $persistRelations) {
							...HospitalGroupInformationProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.hospitalGroupInformation as HospitalGroupInformationModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: HospitalGroupInformationModel[], queryParams?: QueryParams): Observable<PassableStateConfig<HospitalGroupInformationModel>> {
		...
		const successMessage = 'Created Multiple Hospital Group Information entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($hospitalGroupInformations: [HospitalGroupInformationInput!]!) {
						hospitalGroupInformation: createAllHospitalGroupInformation(hospitalGroupInformations: $hospitalGroupInformations) {
							...HospitalGroupInformationProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					hospitalGroupInformations: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.hospitalGroupInformation as HospitalGroupInformationModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: HospitalGroupInformationModel, queryParams?: QueryParams): Observable<PassableStateConfig<HospitalGroupInformationModel>> {
		...
		const successMessage = 'Updated Hospital Group Information entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($hospitalGroupInformation: HospitalGroupInformationInput!, $persistRelations: Boolean) {
						hospitalGroupInformation: updateHospitalGroupInformation(hospitalGroupInformation: $hospitalGroupInformation, persistRelations: $persistRelations) {
							...HospitalGroupInformationProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: HospitalGroupInformationModel[], queryParams?: QueryParams): Observable<PassableStateConfig<HospitalGroupInformationModel>> {
		...
		const successMessage = 'Update Multiple Hospital Group Information entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($hospitalGroupInformations: [HospitalGroupInformationInput!]!) {
						hospitalGroupInformation: updateAllHospitalGroupInformation(hospitalGroupInformations: $hospitalGroupInformations) {
							...HospitalGroupInformationProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<HospitalGroupInformationModel>> {
		...
		const successMessage = 'Deleted Hospital Group Information entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($hospitalGroupInformationId: ID!) {
						hospitalGroupInformationId: deleteHospitalGroupInformationById(hospitalGroupInformationId: $hospitalGroupInformationId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.hospitalGroupInformationId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<HospitalGroupInformationModel>> {
		...
		const successMessage = 'Deleted selected Hospital Group Information entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($hospitalGroupInformationIds: [ID!]!){
						deleteHospitalGroupInformationExcludingIds(hospitalGroupInformationIds: $hospitalGroupInformationIds)
				...
				`,
				variables: {
					hospitalGroupInformationIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.hospitalGroupInformationIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<HospitalGroupInformationModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($hospitalGroupInformationIds: [ID!]!) {
						hospitalGroupInformationIds: deleteAllHospitalGroupInformationByIds(hospitalGroupInformationIds: $hospitalGroupInformationIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<HospitalGroupInformationModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<HospitalGroupInformationModel>>(
			{
				query: gql`
					query GetAudits {
						audits: hospitalGroupInformationAudits {
							entity {
								...HospitalGroupInformationProperties
							}
							timestamp
			...
			map(result => {
				let audits: HospitalGroupInformationModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new HospitalGroupInformationModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<HospitalGroupInformationModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<HospitalGroupInformationModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($hospitalGroupInformationId: ID!) {
						audits: hospitalGroupInformationAuditsByEntityId(hospitalGroupInformationId: $hospitalGroupInformationId) {
							entity {
								...HospitalGroupInformationProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<HospitalGroupInformationModel>> {
		const url = environment.API_URL + '/api/hospitalgroupinformation/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<HospitalGroupInformationModel>> {
		const url = environment.API_URL + '/api/hospitalgroupinformation/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<HospitalGroupInformationModel>> {
		let apiUrl = environment.API_URL + '/api/hospitalgroupinformation/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<HospitalGroupInformationModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/hospitalgroupinformation/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Hospital Group Information entities')),
