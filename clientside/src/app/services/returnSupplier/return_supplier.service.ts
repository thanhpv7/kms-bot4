...
import {ReturnSupplierModelAudit} from '../../models/returnSupplier/return_supplier.model.state';
...
/**
 * Return Supplier service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class ReturnSupplierService extends AbstractHttpService<ReturnSupplierModel, ReturnSupplierModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the ReturnSupplierProperties classFragment here] off begin
			fragment ReturnSupplierProperties on ReturnSupplier {
				...ReturnSupplierBaseProperties
				returnNumber
				approvalStatus
				returnDate
				orderDate
				...
				voidReason
				subTotal
				extraDiscountInPercentage
				extraDiscountIncludeTax
				extraDiscountValue
				freightFeeIncludeTax
				freightFeeValue
				otherFeeIncludeTax
				otherFeeValue
				taxBase
			...
			# % protected region % [Modify the ReturnSupplierProperties classFragment here] end
			${super.fragments('ReturnSupplier').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<ReturnSupplierModel>> {
		...
		return  this.apollo.query<PassableStateConfig<ReturnSupplierModel>>(
			{
				query: gql`
					query Count {
						totalCount: countReturnSuppliers
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<ReturnSupplierModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<ReturnSupplierModel>> {
		...
		return this.apollo.query<PassableStateConfig<ReturnSupplierModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						ReturnSupplierById: returnSupplierById(id: $id) {
							...ReturnSupplierProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.ReturnSupplierById as ReturnSupplierModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<ReturnSupplierModel>> {
		...
		return this.apollo.query<PassableStateConfig<ReturnSupplierModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						returnSuppliers: returnSuppliers(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...ReturnSupplierProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countReturnSuppliers(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.returnSuppliers as ReturnSupplierModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<ReturnSupplierModel>> {
		...
		return this.apollo.query<PassableStateConfig<ReturnSupplierModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						returnSuppliers: lastReturnSuppliers(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...ReturnSupplierProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: ReturnSupplierModel, queryParams?: QueryParams): Observable<PassableStateConfig<ReturnSupplierModel>> {
		...
		const successMessage = 'Created Return Supplier entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($returnSupplier: ReturnSupplierInput!, $persistRelations: Boolean) {
						returnSupplier: createReturnSupplier(returnSupplier: $returnSupplier, persistRelations: $persistRelations) {
							...ReturnSupplierProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.returnSupplier as ReturnSupplierModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: ReturnSupplierModel[], queryParams?: QueryParams): Observable<PassableStateConfig<ReturnSupplierModel>> {
		...
		const successMessage = 'Created Multiple Return Supplier entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($returnSuppliers: [ReturnSupplierInput!]!) {
						returnSupplier: createAllReturnSupplier(returnSuppliers: $returnSuppliers) {
							...ReturnSupplierProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					returnSuppliers: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.returnSupplier as ReturnSupplierModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: ReturnSupplierModel, queryParams?: QueryParams): Observable<PassableStateConfig<ReturnSupplierModel>> {
		...
		const successMessage = 'Updated Return Supplier entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($returnSupplier: ReturnSupplierInput!, $persistRelations: Boolean) {
						returnSupplier: updateReturnSupplier(returnSupplier: $returnSupplier, persistRelations: $persistRelations) {
							...ReturnSupplierProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: ReturnSupplierModel[], queryParams?: QueryParams): Observable<PassableStateConfig<ReturnSupplierModel>> {
		...
		const successMessage = 'Update Multiple Return Supplier entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($returnSuppliers: [ReturnSupplierInput!]!) {
						returnSupplier: updateAllReturnSupplier(returnSuppliers: $returnSuppliers) {
							...ReturnSupplierProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<ReturnSupplierModel>> {
		...
		const successMessage = 'Deleted Return Supplier entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($returnSupplierId: ID!) {
						returnSupplierId: deleteReturnSupplierById(returnSupplierId: $returnSupplierId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.returnSupplierId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<ReturnSupplierModel>> {
		...
		const successMessage = 'Deleted selected Return Supplier entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($returnSupplierIds: [ID!]!){
						deleteReturnSupplierExcludingIds(returnSupplierIds: $returnSupplierIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.returnSupplierIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<ReturnSupplierModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($returnSupplierIds: [ID!]!) {
						returnSupplierIds: deleteAllReturnSupplierByIds(returnSupplierIds: $returnSupplierIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<ReturnSupplierModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<ReturnSupplierModel>>(
			...
			map(result => {
				let audits: ReturnSupplierModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new ReturnSupplierModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<ReturnSupplierModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<ReturnSupplierModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($returnSupplierId: ID!) {
						audits: returnSupplierAuditsByEntityId(returnSupplierId: $returnSupplierId) {
							entity {
								...ReturnSupplierProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<ReturnSupplierModel>> {
		const url = environment.API_URL + '/api/returnsupplier/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<ReturnSupplierModel>> {
		const url = environment.API_URL + '/api/returnsupplier/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<ReturnSupplierModel>> {
		let apiUrl = environment.API_URL + '/api/returnsupplier/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<ReturnSupplierModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/returnsupplier/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Return Supplier entities')),
