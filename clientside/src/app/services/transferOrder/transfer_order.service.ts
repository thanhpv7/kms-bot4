...
import {TransferOrderModelAudit} from '../../models/transferOrder/transfer_order.model.state';
...
/**
 * Transfer Order service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class TransferOrderService extends AbstractHttpService<TransferOrderModel, TransferOrderModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the TransferOrderProperties classFragment here] off begin
			fragment TransferOrderProperties on TransferOrder {
				...TransferOrderBaseProperties
				transferOrderNumber
				transactionStatus
				approvalStatus
				orderDate
			...
			# % protected region % [Modify the TransferOrderProperties classFragment here] end
			${super.fragments('TransferOrder').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<TransferOrderModel>> {
		...
		return  this.apollo.query<PassableStateConfig<TransferOrderModel>>(
			{
				query: gql`
					query Count {
						totalCount: countTransferOrders
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<TransferOrderModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<TransferOrderModel>> {
		...
		return this.apollo.query<PassableStateConfig<TransferOrderModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						TransferOrderById: transferOrderById(id: $id) {
							...TransferOrderProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.TransferOrderById as TransferOrderModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<TransferOrderModel>> {
		...
		return this.apollo.query<PassableStateConfig<TransferOrderModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						transferOrders: transferOrders(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...TransferOrderProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countTransferOrders(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.transferOrders as TransferOrderModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<TransferOrderModel>> {
		...
		return this.apollo.query<PassableStateConfig<TransferOrderModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						transferOrders: lastTransferOrders(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...TransferOrderProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: TransferOrderModel, queryParams?: QueryParams): Observable<PassableStateConfig<TransferOrderModel>> {
		...
		const successMessage = 'Created Transfer Order entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($transferOrder: TransferOrderInput!, $persistRelations: Boolean) {
						transferOrder: createTransferOrder(transferOrder: $transferOrder, persistRelations: $persistRelations) {
							...TransferOrderProperties,
				...
				variables: {
					transferOrder: {
						...entity.toJSON(),
						destinationWarehouse: entity.destinationWarehouse ? new WarehouseModel(entity.destinationWarehouse).toJSON() : undefined,
						sourceWarehouse: entity.sourceWarehouse ? new WarehouseModel(entity.sourceWarehouse).toJSON() : undefined,
			...
			map(result => {
				...
				return {
					targetModel: result.data.transferOrder as TransferOrderModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: TransferOrderModel[], queryParams?: QueryParams): Observable<PassableStateConfig<TransferOrderModel>> {
		...
		const successMessage = 'Created Multiple Transfer Order entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($transferOrders: [TransferOrderInput!]!) {
						transferOrder: createAllTransferOrder(transferOrders: $transferOrders) {
							...TransferOrderProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					transferOrders: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.transferOrder as TransferOrderModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: TransferOrderModel, queryParams?: QueryParams): Observable<PassableStateConfig<TransferOrderModel>> {
		...
		const successMessage = 'Updated Transfer Order entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($transferOrder: TransferOrderInput!, $persistRelations: Boolean) {
						transferOrder: updateTransferOrder(transferOrder: $transferOrder, persistRelations: $persistRelations) {
							...TransferOrderProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: TransferOrderModel[], queryParams?: QueryParams): Observable<PassableStateConfig<TransferOrderModel>> {
		...
		const successMessage = 'Update Multiple Transfer Order entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($transferOrders: [TransferOrderInput!]!) {
						transferOrder: updateAllTransferOrder(transferOrders: $transferOrders) {
							...TransferOrderProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<TransferOrderModel>> {
		...
		const successMessage = 'Deleted Transfer Order entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($transferOrderId: ID!) {
						transferOrderId: deleteTransferOrderById(transferOrderId: $transferOrderId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.transferOrderId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<TransferOrderModel>> {
		...
		const successMessage = 'Deleted selected Transfer Order entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($transferOrderIds: [ID!]!){
						deleteTransferOrderExcludingIds(transferOrderIds: $transferOrderIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.transferOrderIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<TransferOrderModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($transferOrderIds: [ID!]!) {
						transferOrderIds: deleteAllTransferOrderByIds(transferOrderIds: $transferOrderIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<TransferOrderModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<TransferOrderModel>>(
			...
			map(result => {
				let audits: TransferOrderModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new TransferOrderModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<TransferOrderModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<TransferOrderModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($transferOrderId: ID!) {
						audits: transferOrderAuditsByEntityId(transferOrderId: $transferOrderId) {
							entity {
								...TransferOrderProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<TransferOrderModel>> {
		const url = environment.API_URL + '/api/transferorder/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<TransferOrderModel>> {
		const url = environment.API_URL + '/api/transferorder/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<TransferOrderModel>> {
		let apiUrl = environment.API_URL + '/api/transferorder/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<TransferOrderModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/transferorder/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Transfer Order entities')),
