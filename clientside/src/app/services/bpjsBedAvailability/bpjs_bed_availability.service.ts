...
import {BpjsBedAvailabilityModel} from '../../models/bpjsBedAvailability/bpjs_bed_availability.model';
import {BpjsBedAvailabilityModelAudit} from '../../models/bpjsBedAvailability/bpjs_bed_availability.model.state';
...
/**
 * BPJS Bed Availability service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BpjsBedAvailabilityService extends AbstractHttpService<BpjsBedAvailabilityModel, BpjsBedAvailabilityModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BpjsBedAvailabilityProperties classFragment here] off begin
			fragment BpjsBedAvailabilityProperties on BpjsBedAvailability {
				...BpjsBedAvailabilityBaseProperties
				koderuang
				namaruang
				kodekelas
				namakelas
			...
			# % protected region % [Modify the BpjsBedAvailabilityProperties classFragment here] end
			${super.fragments('BpjsBedAvailability').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BpjsBedAvailabilityModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BpjsBedAvailabilityModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBpjsBedAvailabilitys
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BpjsBedAvailabilityModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsBedAvailabilityModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsBedAvailabilityModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BpjsBedAvailabilityById: bpjsBedAvailabilityById(id: $id) {
							...BpjsBedAvailabilityProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BpjsBedAvailabilityById as BpjsBedAvailabilityModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsBedAvailabilityModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsBedAvailabilityModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						bpjsBedAvailabilitys: bpjsBedAvailabilitys(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BpjsBedAvailabilityProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBpjsBedAvailabilitys(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.bpjsBedAvailabilitys as BpjsBedAvailabilityModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsBedAvailabilityModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsBedAvailabilityModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						bpjsBedAvailabilitys: lastBpjsBedAvailabilitys(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BpjsBedAvailabilityProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BpjsBedAvailabilityModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsBedAvailabilityModel>> {
		...
		const successMessage = 'Created BPJS Bed Availability entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($bpjsBedAvailability: BpjsBedAvailabilityInput!, $persistRelations: Boolean) {
						bpjsBedAvailability: createBpjsBedAvailability(bpjsBedAvailability: $bpjsBedAvailability, persistRelations: $persistRelations) {
							...BpjsBedAvailabilityProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.bpjsBedAvailability as BpjsBedAvailabilityModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BpjsBedAvailabilityModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsBedAvailabilityModel>> {
		...
		const successMessage = 'Created Multiple BPJS Bed Availability entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($bpjsBedAvailabilitys: [BpjsBedAvailabilityInput!]!) {
						bpjsBedAvailability: createAllBpjsBedAvailability(bpjsBedAvailabilitys: $bpjsBedAvailabilitys) {
							...BpjsBedAvailabilityProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					bpjsBedAvailabilitys: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.bpjsBedAvailability as BpjsBedAvailabilityModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BpjsBedAvailabilityModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsBedAvailabilityModel>> {
		...
		const successMessage = 'Updated BPJS Bed Availability entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($bpjsBedAvailability: BpjsBedAvailabilityInput!, $persistRelations: Boolean) {
						bpjsBedAvailability: updateBpjsBedAvailability(bpjsBedAvailability: $bpjsBedAvailability, persistRelations: $persistRelations) {
							...BpjsBedAvailabilityProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BpjsBedAvailabilityModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsBedAvailabilityModel>> {
		...
		const successMessage = 'Update Multiple BPJS Bed Availability entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($bpjsBedAvailabilitys: [BpjsBedAvailabilityInput!]!) {
						bpjsBedAvailability: updateAllBpjsBedAvailability(bpjsBedAvailabilitys: $bpjsBedAvailabilitys) {
							...BpjsBedAvailabilityProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BpjsBedAvailabilityModel>> {
		...
		const successMessage = 'Deleted BPJS Bed Availability entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($bpjsBedAvailabilityId: ID!) {
						bpjsBedAvailabilityId: deleteBpjsBedAvailabilityById(bpjsBedAvailabilityId: $bpjsBedAvailabilityId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.bpjsBedAvailabilityId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsBedAvailabilityModel>> {
		...
		const successMessage = 'Deleted selected BPJS Bed Availability entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($bpjsBedAvailabilityIds: [ID!]!){
						deleteBpjsBedAvailabilityExcludingIds(bpjsBedAvailabilityIds: $bpjsBedAvailabilityIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.bpjsBedAvailabilityIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BpjsBedAvailabilityModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($bpjsBedAvailabilityIds: [ID!]!) {
						bpjsBedAvailabilityIds: deleteAllBpjsBedAvailabilityByIds(bpjsBedAvailabilityIds: $bpjsBedAvailabilityIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BpjsBedAvailabilityModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsBedAvailabilityModel>>(
			{
				query: gql`
					query GetAudits {
						audits: bpjsBedAvailabilityAudits {
							entity {
								...BpjsBedAvailabilityProperties
							}
							timestamp
			...
			map(result => {
				let audits: BpjsBedAvailabilityModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BpjsBedAvailabilityModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BpjsBedAvailabilityModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsBedAvailabilityModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($bpjsBedAvailabilityId: ID!) {
						audits: bpjsBedAvailabilityAuditsByEntityId(bpjsBedAvailabilityId: $bpjsBedAvailabilityId) {
							entity {
								...BpjsBedAvailabilityProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BpjsBedAvailabilityModel>> {
		const url = environment.API_URL + '/api/bpjsbedavailability/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BpjsBedAvailabilityModel>> {
		const url = environment.API_URL + '/api/bpjsbedavailability/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsBedAvailabilityModel>> {
		let apiUrl = environment.API_URL + '/api/bpjsbedavailability/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BpjsBedAvailabilityModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/bpjsbedavailability/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' BPJS Bed Availability entities')),
