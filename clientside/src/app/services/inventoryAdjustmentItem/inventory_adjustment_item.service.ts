...
import {InventoryAdjustmentItemModel} from '../../models/inventoryAdjustmentItem/inventory_adjustment_item.model';
import {InventoryAdjustmentItemModelAudit} from '../../models/inventoryAdjustmentItem/inventory_adjustment_item.model.state';
...
/**
 * Inventory Adjustment Item service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class InventoryAdjustmentItemService extends AbstractHttpService<InventoryAdjustmentItemModel, InventoryAdjustmentItemModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the InventoryAdjustmentItemProperties classFragment here] off begin
			fragment InventoryAdjustmentItemProperties on InventoryAdjustmentItem {
				...InventoryAdjustmentItemBaseProperties
				itemLineNumber
				originalSOH
			...
			# % protected region % [Modify the InventoryAdjustmentItemProperties classFragment here] end
			${super.fragments('InventoryAdjustmentItem').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<InventoryAdjustmentItemModel>> {
		...
		return  this.apollo.query<PassableStateConfig<InventoryAdjustmentItemModel>>(
			{
				query: gql`
					query Count {
						totalCount: countInventoryAdjustmentItems
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<InventoryAdjustmentItemModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<InventoryAdjustmentItemModel>> {
		...
		return this.apollo.query<PassableStateConfig<InventoryAdjustmentItemModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						InventoryAdjustmentItemById: inventoryAdjustmentItemById(id: $id) {
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.InventoryAdjustmentItemById as InventoryAdjustmentItemModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<InventoryAdjustmentItemModel>> {
		...
		return this.apollo.query<PassableStateConfig<InventoryAdjustmentItemModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						inventoryAdjustmentItems: inventoryAdjustmentItems(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...InventoryAdjustmentItemProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countInventoryAdjustmentItems(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.inventoryAdjustmentItems as InventoryAdjustmentItemModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<InventoryAdjustmentItemModel>> {
		...
		return this.apollo.query<PassableStateConfig<InventoryAdjustmentItemModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						inventoryAdjustmentItems: lastInventoryAdjustmentItems(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...InventoryAdjustmentItemProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: InventoryAdjustmentItemModel, queryParams?: QueryParams): Observable<PassableStateConfig<InventoryAdjustmentItemModel>> {
		...
		const successMessage = 'Created Inventory Adjustment Item entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($inventoryAdjustmentItem: InventoryAdjustmentItemInput!, $persistRelations: Boolean) {
						inventoryAdjustmentItem: createInventoryAdjustmentItem(inventoryAdjustmentItem: $inventoryAdjustmentItem, persistRelations: $persistRelations) {
							...InventoryAdjustmentItemProperties,
				...
				variables: {
					inventoryAdjustmentItem: {
						...entity.toJSON(),
						inventoryAdjustment: entity.inventoryAdjustment ? new InventoryAdjustmentModel(entity.inventoryAdjustment).toJSON() : undefined,
			...
			map(result => {
				...
				return {
					targetModel: result.data.inventoryAdjustmentItem as InventoryAdjustmentItemModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: InventoryAdjustmentItemModel[], queryParams?: QueryParams): Observable<PassableStateConfig<InventoryAdjustmentItemModel>> {
		...
		const successMessage = 'Created Multiple Inventory Adjustment Item entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($inventoryAdjustmentItems: [InventoryAdjustmentItemInput!]!) {
						inventoryAdjustmentItem: createAllInventoryAdjustmentItem(inventoryAdjustmentItems: $inventoryAdjustmentItems) {
							...InventoryAdjustmentItemProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					inventoryAdjustmentItems: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.inventoryAdjustmentItem as InventoryAdjustmentItemModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: InventoryAdjustmentItemModel, queryParams?: QueryParams): Observable<PassableStateConfig<InventoryAdjustmentItemModel>> {
		...
		const successMessage = 'Updated Inventory Adjustment Item entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($inventoryAdjustmentItem: InventoryAdjustmentItemInput!, $persistRelations: Boolean) {
						inventoryAdjustmentItem: updateInventoryAdjustmentItem(inventoryAdjustmentItem: $inventoryAdjustmentItem, persistRelations: $persistRelations) {
							...InventoryAdjustmentItemProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: InventoryAdjustmentItemModel[], queryParams?: QueryParams): Observable<PassableStateConfig<InventoryAdjustmentItemModel>> {
		...
		const successMessage = 'Update Multiple Inventory Adjustment Item entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($inventoryAdjustmentItems: [InventoryAdjustmentItemInput!]!) {
						inventoryAdjustmentItem: updateAllInventoryAdjustmentItem(inventoryAdjustmentItems: $inventoryAdjustmentItems) {
							...InventoryAdjustmentItemProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<InventoryAdjustmentItemModel>> {
		...
		const successMessage = 'Deleted Inventory Adjustment Item entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($inventoryAdjustmentItemId: ID!) {
						inventoryAdjustmentItemId: deleteInventoryAdjustmentItemById(inventoryAdjustmentItemId: $inventoryAdjustmentItemId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.inventoryAdjustmentItemId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<InventoryAdjustmentItemModel>> {
		...
		const successMessage = 'Deleted selected Inventory Adjustment Item entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($inventoryAdjustmentItemIds: [ID!]!){
						deleteInventoryAdjustmentItemExcludingIds(inventoryAdjustmentItemIds: $inventoryAdjustmentItemIds)
				...
				`,
				variables: {
					inventoryAdjustmentItemIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.inventoryAdjustmentItemIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<InventoryAdjustmentItemModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($inventoryAdjustmentItemIds: [ID!]!) {
						inventoryAdjustmentItemIds: deleteAllInventoryAdjustmentItemByIds(inventoryAdjustmentItemIds: $inventoryAdjustmentItemIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<InventoryAdjustmentItemModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<InventoryAdjustmentItemModel>>(
			{
				query: gql`
					query GetAudits {
						audits: inventoryAdjustmentItemAudits {
							entity {
								...InventoryAdjustmentItemProperties
							}
							timestamp
			...
			map(result => {
				let audits: InventoryAdjustmentItemModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new InventoryAdjustmentItemModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<InventoryAdjustmentItemModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<InventoryAdjustmentItemModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($inventoryAdjustmentItemId: ID!) {
						audits: inventoryAdjustmentItemAuditsByEntityId(inventoryAdjustmentItemId: $inventoryAdjustmentItemId) {
							entity {
								...InventoryAdjustmentItemProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<InventoryAdjustmentItemModel>> {
		const url = environment.API_URL + '/api/inventoryadjustmentitem/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<InventoryAdjustmentItemModel>> {
		const url = environment.API_URL + '/api/inventoryadjustmentitem/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<InventoryAdjustmentItemModel>> {
		let apiUrl = environment.API_URL + '/api/inventoryadjustmentitem/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<InventoryAdjustmentItemModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/inventoryadjustmentitem/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Inventory Adjustment Item entities')),
