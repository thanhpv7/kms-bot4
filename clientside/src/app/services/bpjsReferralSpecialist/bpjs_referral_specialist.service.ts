...
import {BpjsReferralSpecialistModel} from '../../models/bpjsReferralSpecialist/bpjs_referral_specialist.model';
import {BpjsReferralSpecialistModelAudit} from '../../models/bpjsReferralSpecialist/bpjs_referral_specialist.model.state';
...
/**
 * BPJS Referral Specialist service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BpjsReferralSpecialistService extends AbstractHttpService<BpjsReferralSpecialistModel, BpjsReferralSpecialistModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BpjsReferralSpecialistProperties classFragment here] off begin
			fragment BpjsReferralSpecialistProperties on BpjsReferralSpecialist {
				...BpjsReferralSpecialistBaseProperties
				specialistCode
				specialistName
				capacity
				totalReferral
			...
			# % protected region % [Modify the BpjsReferralSpecialistProperties classFragment here] end
			${super.fragments('BpjsReferralSpecialist').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BpjsReferralSpecialistModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BpjsReferralSpecialistModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBpjsReferralSpecialists
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BpjsReferralSpecialistModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsReferralSpecialistModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsReferralSpecialistModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BpjsReferralSpecialistById: bpjsReferralSpecialistById(id: $id) {
							...BpjsReferralSpecialistProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BpjsReferralSpecialistById as BpjsReferralSpecialistModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsReferralSpecialistModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsReferralSpecialistModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						bpjsReferralSpecialists: bpjsReferralSpecialists(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BpjsReferralSpecialistProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBpjsReferralSpecialists(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.bpjsReferralSpecialists as BpjsReferralSpecialistModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsReferralSpecialistModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsReferralSpecialistModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						bpjsReferralSpecialists: lastBpjsReferralSpecialists(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BpjsReferralSpecialistProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BpjsReferralSpecialistModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsReferralSpecialistModel>> {
		...
		const successMessage = 'Created BPJS Referral Specialist entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($bpjsReferralSpecialist: BpjsReferralSpecialistInput!, $persistRelations: Boolean) {
						bpjsReferralSpecialist: createBpjsReferralSpecialist(bpjsReferralSpecialist: $bpjsReferralSpecialist, persistRelations: $persistRelations) {
							...BpjsReferralSpecialistProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.bpjsReferralSpecialist as BpjsReferralSpecialistModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BpjsReferralSpecialistModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsReferralSpecialistModel>> {
		...
		const successMessage = 'Created Multiple BPJS Referral Specialist entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($bpjsReferralSpecialists: [BpjsReferralSpecialistInput!]!) {
						bpjsReferralSpecialist: createAllBpjsReferralSpecialist(bpjsReferralSpecialists: $bpjsReferralSpecialists) {
							...BpjsReferralSpecialistProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					bpjsReferralSpecialists: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.bpjsReferralSpecialist as BpjsReferralSpecialistModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BpjsReferralSpecialistModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsReferralSpecialistModel>> {
		...
		const successMessage = 'Updated BPJS Referral Specialist entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($bpjsReferralSpecialist: BpjsReferralSpecialistInput!, $persistRelations: Boolean) {
						bpjsReferralSpecialist: updateBpjsReferralSpecialist(bpjsReferralSpecialist: $bpjsReferralSpecialist, persistRelations: $persistRelations) {
							...BpjsReferralSpecialistProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BpjsReferralSpecialistModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsReferralSpecialistModel>> {
		...
		const successMessage = 'Update Multiple BPJS Referral Specialist entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($bpjsReferralSpecialists: [BpjsReferralSpecialistInput!]!) {
						bpjsReferralSpecialist: updateAllBpjsReferralSpecialist(bpjsReferralSpecialists: $bpjsReferralSpecialists) {
							...BpjsReferralSpecialistProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BpjsReferralSpecialistModel>> {
		...
		const successMessage = 'Deleted BPJS Referral Specialist entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($bpjsReferralSpecialistId: ID!) {
						bpjsReferralSpecialistId: deleteBpjsReferralSpecialistById(bpjsReferralSpecialistId: $bpjsReferralSpecialistId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.bpjsReferralSpecialistId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsReferralSpecialistModel>> {
		...
		const successMessage = 'Deleted selected BPJS Referral Specialist entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($bpjsReferralSpecialistIds: [ID!]!){
						deleteBpjsReferralSpecialistExcludingIds(bpjsReferralSpecialistIds: $bpjsReferralSpecialistIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.bpjsReferralSpecialistIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BpjsReferralSpecialistModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($bpjsReferralSpecialistIds: [ID!]!) {
						bpjsReferralSpecialistIds: deleteAllBpjsReferralSpecialistByIds(bpjsReferralSpecialistIds: $bpjsReferralSpecialistIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BpjsReferralSpecialistModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsReferralSpecialistModel>>(
			{
				query: gql`
					query GetAudits {
						audits: bpjsReferralSpecialistAudits {
							entity {
								...BpjsReferralSpecialistProperties
							}
							timestamp
			...
			map(result => {
				let audits: BpjsReferralSpecialistModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BpjsReferralSpecialistModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BpjsReferralSpecialistModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsReferralSpecialistModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($bpjsReferralSpecialistId: ID!) {
						audits: bpjsReferralSpecialistAuditsByEntityId(bpjsReferralSpecialistId: $bpjsReferralSpecialistId) {
							entity {
								...BpjsReferralSpecialistProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BpjsReferralSpecialistModel>> {
		const url = environment.API_URL + '/api/bpjsreferralspecialist/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BpjsReferralSpecialistModel>> {
		const url = environment.API_URL + '/api/bpjsreferralspecialist/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsReferralSpecialistModel>> {
		let apiUrl = environment.API_URL + '/api/bpjsreferralspecialist/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BpjsReferralSpecialistModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/bpjsreferralspecialist/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' BPJS Referral Specialist entities')),
