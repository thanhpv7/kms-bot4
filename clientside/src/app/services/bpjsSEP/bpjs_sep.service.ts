...
import {BpjsSEPModel} from '../../models/bpjsSEP/bpjs_sep.model';
import {BpjsSEPModelAudit} from '../../models/bpjsSEP/bpjs_sep.model.state';
...
/**
 * BPJS SEP service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BpjsSEPService extends AbstractHttpService<BpjsSEPModel, BpjsSEPModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BpjsSEPProperties classFragment here] off begin
			fragment BpjsSEPProperties on BpjsSEP {
				...BpjsSEPBaseProperties
				noSEP
			}
			# % protected region % [Modify the BpjsSEPProperties classFragment here] end
			${super.fragments('BpjsSEP').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BpjsSEPModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BpjsSEPModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBpjsSEPs
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BpjsSEPModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsSEPModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsSEPModel>>(
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BpjsSEPById as BpjsSEPModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsSEPModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsSEPModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						bpjsSEPs: bpjsSEPs(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BpjsSEPProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBpjsSEPs(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.bpjsSEPs as BpjsSEPModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsSEPModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsSEPModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						bpjsSEPs: lastBpjsSEPs(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BpjsSEPProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BpjsSEPModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsSEPModel>> {
		...
		const successMessage = 'Created BPJS SEP entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($bpjsSEP: BpjsSEPInput!, $persistRelations: Boolean) {
						bpjsSEP: createBpjsSEP(bpjsSEP: $bpjsSEP, persistRelations: $persistRelations) {
							...BpjsSEPProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.bpjsSEP as BpjsSEPModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BpjsSEPModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsSEPModel>> {
		...
		const successMessage = 'Created Multiple BPJS SEP entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($bpjsSEPs: [BpjsSEPInput!]!) {
						bpjsSEP: createAllBpjsSEP(bpjsSEPs: $bpjsSEPs) {
							...BpjsSEPProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					bpjsSEPs: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.bpjsSEP as BpjsSEPModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BpjsSEPModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsSEPModel>> {
		...
		const successMessage = 'Updated BPJS SEP entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($bpjsSEP: BpjsSEPInput!, $persistRelations: Boolean) {
						bpjsSEP: updateBpjsSEP(bpjsSEP: $bpjsSEP, persistRelations: $persistRelations) {
							...BpjsSEPProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BpjsSEPModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsSEPModel>> {
		...
		const successMessage = 'Update Multiple BPJS SEP entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($bpjsSEPs: [BpjsSEPInput!]!) {
						bpjsSEP: updateAllBpjsSEP(bpjsSEPs: $bpjsSEPs) {
							...BpjsSEPProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BpjsSEPModel>> {
		...
		const successMessage = 'Deleted BPJS SEP entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($bpjsSEPId: ID!) {
						bpjsSEPId: deleteBpjsSEPById(bpjsSEPId: $bpjsSEPId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.bpjsSEPId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsSEPModel>> {
		...
		const successMessage = 'Deleted selected BPJS SEP entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($bpjsSEPIds: [ID!]!){
						deleteBpjsSEPExcludingIds(bpjsSEPIds: $bpjsSEPIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.bpjsSEPIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BpjsSEPModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($bpjsSEPIds: [ID!]!) {
						bpjsSEPIds: deleteAllBpjsSEPByIds(bpjsSEPIds: $bpjsSEPIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BpjsSEPModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsSEPModel>>(
			...
			map(result => {
				let audits: BpjsSEPModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BpjsSEPModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BpjsSEPModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsSEPModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($bpjsSEPId: ID!) {
						audits: bpjsSEPAuditsByEntityId(bpjsSEPId: $bpjsSEPId) {
							entity {
								...BpjsSEPProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BpjsSEPModel>> {
		const url = environment.API_URL + '/api/bpjssep/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BpjsSEPModel>> {
		const url = environment.API_URL + '/api/bpjssep/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsSEPModel>> {
		let apiUrl = environment.API_URL + '/api/bpjssep/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BpjsSEPModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/bpjssep/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' BPJS SEP entities')),
