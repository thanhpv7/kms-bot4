...
import {BpjsSpecialReferralModel} from '../../models/bpjsSpecialReferral/bpjs_special_referral.model';
import {BpjsSpecialReferralModelAudit} from '../../models/bpjsSpecialReferral/bpjs_special_referral.model.state';
...
/**
 * BPJS Special Referral service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BpjsSpecialReferralService extends AbstractHttpService<BpjsSpecialReferralModel, BpjsSpecialReferralModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BpjsSpecialReferralProperties classFragment here] off begin
			fragment BpjsSpecialReferralProperties on BpjsSpecialReferral {
				...BpjsSpecialReferralBaseProperties
				referralID
				referralNo
				bpjsCardNo
				name
			...
			# % protected region % [Modify the BpjsSpecialReferralProperties classFragment here] end
			${super.fragments('BpjsSpecialReferral').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BpjsSpecialReferralModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BpjsSpecialReferralModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBpjsSpecialReferrals
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BpjsSpecialReferralModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsSpecialReferralModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsSpecialReferralModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BpjsSpecialReferralById: bpjsSpecialReferralById(id: $id) {
							...BpjsSpecialReferralProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BpjsSpecialReferralById as BpjsSpecialReferralModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsSpecialReferralModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsSpecialReferralModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						bpjsSpecialReferrals: bpjsSpecialReferrals(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BpjsSpecialReferralProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBpjsSpecialReferrals(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.bpjsSpecialReferrals as BpjsSpecialReferralModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsSpecialReferralModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsSpecialReferralModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						bpjsSpecialReferrals: lastBpjsSpecialReferrals(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BpjsSpecialReferralProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BpjsSpecialReferralModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsSpecialReferralModel>> {
		...
		const successMessage = 'Created BPJS Special Referral entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($bpjsSpecialReferral: BpjsSpecialReferralInput!, $persistRelations: Boolean) {
						bpjsSpecialReferral: createBpjsSpecialReferral(bpjsSpecialReferral: $bpjsSpecialReferral, persistRelations: $persistRelations) {
							...BpjsSpecialReferralProperties,
				...
				variables: {
					bpjsSpecialReferral: {
						...entity.toJSON(),
						additionalDiagnose: entity.additionalDiagnose ? new BpjsDiagnoseModel(entity.additionalDiagnose).toJSON() : undefined,
						additionalProcedure: entity.additionalProcedure ? new BpjsProcedureModel(entity.additionalProcedure).toJSON() : undefined,
						primaryDiagnose: entity.primaryDiagnose ? new BpjsDiagnoseModel(entity.primaryDiagnose).toJSON() : undefined,
						primaryProcedure: entity.primaryProcedure ? new BpjsProcedureModel(entity.primaryProcedure).toJSON() : undefined,
					},
			...
			map(result => {
				...
				return {
					targetModel: result.data.bpjsSpecialReferral as BpjsSpecialReferralModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BpjsSpecialReferralModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsSpecialReferralModel>> {
		...
		const successMessage = 'Created Multiple BPJS Special Referral entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($bpjsSpecialReferrals: [BpjsSpecialReferralInput!]!) {
						bpjsSpecialReferral: createAllBpjsSpecialReferral(bpjsSpecialReferrals: $bpjsSpecialReferrals) {
							...BpjsSpecialReferralProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					bpjsSpecialReferrals: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.bpjsSpecialReferral as BpjsSpecialReferralModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BpjsSpecialReferralModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsSpecialReferralModel>> {
		...
		const successMessage = 'Updated BPJS Special Referral entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($bpjsSpecialReferral: BpjsSpecialReferralInput!, $persistRelations: Boolean) {
						bpjsSpecialReferral: updateBpjsSpecialReferral(bpjsSpecialReferral: $bpjsSpecialReferral, persistRelations: $persistRelations) {
							...BpjsSpecialReferralProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BpjsSpecialReferralModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsSpecialReferralModel>> {
		...
		const successMessage = 'Update Multiple BPJS Special Referral entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($bpjsSpecialReferrals: [BpjsSpecialReferralInput!]!) {
						bpjsSpecialReferral: updateAllBpjsSpecialReferral(bpjsSpecialReferrals: $bpjsSpecialReferrals) {
							...BpjsSpecialReferralProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BpjsSpecialReferralModel>> {
		...
		const successMessage = 'Deleted BPJS Special Referral entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($bpjsSpecialReferralId: ID!) {
						bpjsSpecialReferralId: deleteBpjsSpecialReferralById(bpjsSpecialReferralId: $bpjsSpecialReferralId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.bpjsSpecialReferralId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsSpecialReferralModel>> {
		...
		const successMessage = 'Deleted selected BPJS Special Referral entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($bpjsSpecialReferralIds: [ID!]!){
						deleteBpjsSpecialReferralExcludingIds(bpjsSpecialReferralIds: $bpjsSpecialReferralIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.bpjsSpecialReferralIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BpjsSpecialReferralModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($bpjsSpecialReferralIds: [ID!]!) {
						bpjsSpecialReferralIds: deleteAllBpjsSpecialReferralByIds(bpjsSpecialReferralIds: $bpjsSpecialReferralIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BpjsSpecialReferralModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsSpecialReferralModel>>(
			{
				query: gql`
					query GetAudits {
						audits: bpjsSpecialReferralAudits {
							entity {
								...BpjsSpecialReferralProperties
							}
							timestamp
			...
			map(result => {
				let audits: BpjsSpecialReferralModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BpjsSpecialReferralModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BpjsSpecialReferralModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsSpecialReferralModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($bpjsSpecialReferralId: ID!) {
						audits: bpjsSpecialReferralAuditsByEntityId(bpjsSpecialReferralId: $bpjsSpecialReferralId) {
							entity {
								...BpjsSpecialReferralProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BpjsSpecialReferralModel>> {
		const url = environment.API_URL + '/api/bpjsspecialreferral/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BpjsSpecialReferralModel>> {
		const url = environment.API_URL + '/api/bpjsspecialreferral/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsSpecialReferralModel>> {
		let apiUrl = environment.API_URL + '/api/bpjsspecialreferral/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BpjsSpecialReferralModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/bpjsspecialreferral/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' BPJS Special Referral entities')),
