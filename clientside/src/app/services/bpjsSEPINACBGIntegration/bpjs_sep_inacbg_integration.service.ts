...
import {BpjsSEPINACBGIntegrationModelAudit} from '../../models/bpjsSEPINACBGIntegration/bpjs_sep_inacbg_integration.model.state';
...
/**
 * BPJS SEP INACBG Integration service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BpjsSEPINACBGIntegrationService extends AbstractHttpService<BpjsSEPINACBGIntegrationModel, BpjsSEPINACBGIntegrationModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BpjsSEPINACBGIntegrationProperties classFragment here] off begin
			fragment BpjsSEPINACBGIntegrationProperties on BpjsSEPINACBGIntegration {
				...BpjsSEPINACBGIntegrationBaseProperties
				sepNo
				patientID
				patientName
				gender
			...
			# % protected region % [Modify the BpjsSEPINACBGIntegrationProperties classFragment here] end
			${super.fragments('BpjsSEPINACBGIntegration').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BpjsSEPINACBGIntegrationModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BpjsSEPINACBGIntegrationModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBpjsSEPINACBGIntegrations
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BpjsSEPINACBGIntegrationModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsSEPINACBGIntegrationModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsSEPINACBGIntegrationModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BpjsSEPINACBGIntegrationById: bpjsSEPINACBGIntegrationById(id: $id) {
							...BpjsSEPINACBGIntegrationProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BpjsSEPINACBGIntegrationById as BpjsSEPINACBGIntegrationModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsSEPINACBGIntegrationModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsSEPINACBGIntegrationModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						bpjsSEPINACBGIntegrations: bpjsSEPINACBGIntegrations(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BpjsSEPINACBGIntegrationProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBpjsSEPINACBGIntegrations(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.bpjsSEPINACBGIntegrations as BpjsSEPINACBGIntegrationModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsSEPINACBGIntegrationModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsSEPINACBGIntegrationModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						bpjsSEPINACBGIntegrations: lastBpjsSEPINACBGIntegrations(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BpjsSEPINACBGIntegrationProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BpjsSEPINACBGIntegrationModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsSEPINACBGIntegrationModel>> {
		...
		const successMessage = 'Created BPJS SEP INACBG Integration entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($bpjsSEPINACBGIntegration: BpjsSEPINACBGIntegrationInput!, $persistRelations: Boolean) {
						bpjsSEPINACBGIntegration: createBpjsSEPINACBGIntegration(bpjsSEPINACBGIntegration: $bpjsSEPINACBGIntegration, persistRelations: $persistRelations) {
							...BpjsSEPINACBGIntegrationProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.bpjsSEPINACBGIntegration as BpjsSEPINACBGIntegrationModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BpjsSEPINACBGIntegrationModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsSEPINACBGIntegrationModel>> {
		...
		const successMessage = 'Created Multiple BPJS SEP INACBG Integration entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($bpjsSEPINACBGIntegrations: [BpjsSEPINACBGIntegrationInput!]!) {
						bpjsSEPINACBGIntegration: createAllBpjsSEPINACBGIntegration(bpjsSEPINACBGIntegrations: $bpjsSEPINACBGIntegrations) {
							...BpjsSEPINACBGIntegrationProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					bpjsSEPINACBGIntegrations: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.bpjsSEPINACBGIntegration as BpjsSEPINACBGIntegrationModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BpjsSEPINACBGIntegrationModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsSEPINACBGIntegrationModel>> {
		...
		const successMessage = 'Updated BPJS SEP INACBG Integration entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($bpjsSEPINACBGIntegration: BpjsSEPINACBGIntegrationInput!, $persistRelations: Boolean) {
						bpjsSEPINACBGIntegration: updateBpjsSEPINACBGIntegration(bpjsSEPINACBGIntegration: $bpjsSEPINACBGIntegration, persistRelations: $persistRelations) {
							...BpjsSEPINACBGIntegrationProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BpjsSEPINACBGIntegrationModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsSEPINACBGIntegrationModel>> {
		...
		const successMessage = 'Update Multiple BPJS SEP INACBG Integration entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($bpjsSEPINACBGIntegrations: [BpjsSEPINACBGIntegrationInput!]!) {
						bpjsSEPINACBGIntegration: updateAllBpjsSEPINACBGIntegration(bpjsSEPINACBGIntegrations: $bpjsSEPINACBGIntegrations) {
							...BpjsSEPINACBGIntegrationProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BpjsSEPINACBGIntegrationModel>> {
		...
		const successMessage = 'Deleted BPJS SEP INACBG Integration entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($bpjsSEPINACBGIntegrationId: ID!) {
						bpjsSEPINACBGIntegrationId: deleteBpjsSEPINACBGIntegrationById(bpjsSEPINACBGIntegrationId: $bpjsSEPINACBGIntegrationId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.bpjsSEPINACBGIntegrationId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsSEPINACBGIntegrationModel>> {
		...
		const successMessage = 'Deleted selected BPJS SEP INACBG Integration entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($bpjsSEPINACBGIntegrationIds: [ID!]!){
						deleteBpjsSEPINACBGIntegrationExcludingIds(bpjsSEPINACBGIntegrationIds: $bpjsSEPINACBGIntegrationIds)
				...
				`,
				variables: {
					bpjsSEPINACBGIntegrationIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.bpjsSEPINACBGIntegrationIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BpjsSEPINACBGIntegrationModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($bpjsSEPINACBGIntegrationIds: [ID!]!) {
						bpjsSEPINACBGIntegrationIds: deleteAllBpjsSEPINACBGIntegrationByIds(bpjsSEPINACBGIntegrationIds: $bpjsSEPINACBGIntegrationIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BpjsSEPINACBGIntegrationModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsSEPINACBGIntegrationModel>>(
			{
				query: gql`
					query GetAudits {
						audits: bpjsSEPINACBGIntegrationAudits {
							entity {
								...BpjsSEPINACBGIntegrationProperties
							}
							timestamp
			...
			map(result => {
				let audits: BpjsSEPINACBGIntegrationModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BpjsSEPINACBGIntegrationModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BpjsSEPINACBGIntegrationModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsSEPINACBGIntegrationModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($bpjsSEPINACBGIntegrationId: ID!) {
						audits: bpjsSEPINACBGIntegrationAuditsByEntityId(bpjsSEPINACBGIntegrationId: $bpjsSEPINACBGIntegrationId) {
							entity {
								...BpjsSEPINACBGIntegrationProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BpjsSEPINACBGIntegrationModel>> {
		const url = environment.API_URL + '/api/bpjssepinacbgintegration/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BpjsSEPINACBGIntegrationModel>> {
		const url = environment.API_URL + '/api/bpjssepinacbgintegration/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsSEPINACBGIntegrationModel>> {
		let apiUrl = environment.API_URL + '/api/bpjssepinacbgintegration/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BpjsSEPINACBGIntegrationModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/bpjssepinacbgintegration/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' BPJS SEP INACBG Integration entities')),
