...
import {PatientContactInfoModel} from '../../models/patientContactInfo/patient_contact_info.model';
import {PatientContactInfoModelAudit} from '../../models/patientContactInfo/patient_contact_info.model.state';
...
/**
 * Patient Contact Info service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class PatientContactInfoService extends AbstractHttpService<PatientContactInfoModel, PatientContactInfoModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the PatientContactInfoProperties classFragment here] off begin
			fragment PatientContactInfoProperties on PatientContactInfo {
				...PatientContactInfoBaseProperties
				mobilePhoneNo
				officePhoneNo
				extensionNo
				emailAddress
			...
			# % protected region % [Modify the PatientContactInfoProperties classFragment here] end
			${super.fragments('PatientContactInfo').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<PatientContactInfoModel>> {
		...
		return  this.apollo.query<PassableStateConfig<PatientContactInfoModel>>(
			{
				query: gql`
					query Count {
						totalCount: countPatientContactInfos
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<PatientContactInfoModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<PatientContactInfoModel>> {
		...
		return this.apollo.query<PassableStateConfig<PatientContactInfoModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						PatientContactInfoById: patientContactInfoById(id: $id) {
							...PatientContactInfoProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.PatientContactInfoById as PatientContactInfoModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PatientContactInfoModel>> {
		...
		return this.apollo.query<PassableStateConfig<PatientContactInfoModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						patientContactInfos: patientContactInfos(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...PatientContactInfoProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countPatientContactInfos(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.patientContactInfos as PatientContactInfoModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PatientContactInfoModel>> {
		...
		return this.apollo.query<PassableStateConfig<PatientContactInfoModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						patientContactInfos: lastPatientContactInfos(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...PatientContactInfoProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: PatientContactInfoModel, queryParams?: QueryParams): Observable<PassableStateConfig<PatientContactInfoModel>> {
		...
		const successMessage = 'Created Patient Contact Info entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($patientContactInfo: PatientContactInfoInput!, $persistRelations: Boolean) {
						patientContactInfo: createPatientContactInfo(patientContactInfo: $patientContactInfo, persistRelations: $persistRelations) {
							...PatientContactInfoProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.patientContactInfo as PatientContactInfoModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: PatientContactInfoModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PatientContactInfoModel>> {
		...
		const successMessage = 'Created Multiple Patient Contact Info entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($patientContactInfos: [PatientContactInfoInput!]!) {
						patientContactInfo: createAllPatientContactInfo(patientContactInfos: $patientContactInfos) {
							...PatientContactInfoProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					patientContactInfos: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.patientContactInfo as PatientContactInfoModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: PatientContactInfoModel, queryParams?: QueryParams): Observable<PassableStateConfig<PatientContactInfoModel>> {
		...
		const successMessage = 'Updated Patient Contact Info entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($patientContactInfo: PatientContactInfoInput!, $persistRelations: Boolean) {
						patientContactInfo: updatePatientContactInfo(patientContactInfo: $patientContactInfo, persistRelations: $persistRelations) {
							...PatientContactInfoProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: PatientContactInfoModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PatientContactInfoModel>> {
		...
		const successMessage = 'Update Multiple Patient Contact Info entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($patientContactInfos: [PatientContactInfoInput!]!) {
						patientContactInfo: updateAllPatientContactInfo(patientContactInfos: $patientContactInfos) {
							...PatientContactInfoProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<PatientContactInfoModel>> {
		...
		const successMessage = 'Deleted Patient Contact Info entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($patientContactInfoId: ID!) {
						patientContactInfoId: deletePatientContactInfoById(patientContactInfoId: $patientContactInfoId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.patientContactInfoId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<PatientContactInfoModel>> {
		...
		const successMessage = 'Deleted selected Patient Contact Info entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($patientContactInfoIds: [ID!]!){
						deletePatientContactInfoExcludingIds(patientContactInfoIds: $patientContactInfoIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.patientContactInfoIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<PatientContactInfoModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($patientContactInfoIds: [ID!]!) {
						patientContactInfoIds: deleteAllPatientContactInfoByIds(patientContactInfoIds: $patientContactInfoIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<PatientContactInfoModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PatientContactInfoModel>>(
			{
				query: gql`
					query GetAudits {
						audits: patientContactInfoAudits {
							entity {
								...PatientContactInfoProperties
							}
							timestamp
			...
			map(result => {
				let audits: PatientContactInfoModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new PatientContactInfoModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<PatientContactInfoModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PatientContactInfoModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($patientContactInfoId: ID!) {
						audits: patientContactInfoAuditsByEntityId(patientContactInfoId: $patientContactInfoId) {
							entity {
								...PatientContactInfoProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<PatientContactInfoModel>> {
		const url = environment.API_URL + '/api/patientcontactinfo/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<PatientContactInfoModel>> {
		const url = environment.API_URL + '/api/patientcontactinfo/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<PatientContactInfoModel>> {
		let apiUrl = environment.API_URL + '/api/patientcontactinfo/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<PatientContactInfoModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/patientcontactinfo/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Patient Contact Info entities')),
