...
import {PurchaseOrderModelAudit} from '../../models/purchaseOrder/purchase_order.model.state';
...
/**
 * Purchase Order service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class PurchaseOrderService extends AbstractHttpService<PurchaseOrderModel, PurchaseOrderModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the PurchaseOrderProperties classFragment here] off begin
			fragment PurchaseOrderProperties on PurchaseOrder {
				...PurchaseOrderBaseProperties
				purchaseOrderType
				purchaseOrderNumber
				status
				supplyStockGroup
				...
				expectedDate
				priceVATIncluded
				inventoryVATIncluded
				referenceDocument
				supplierReferenceDocument
				paymentTerms
				shippingMethod
				notes
				subTotal
				extraDiscountInPercent
			...
			# % protected region % [Modify the PurchaseOrderProperties classFragment here] end
			${super.fragments('PurchaseOrder').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<PurchaseOrderModel>> {
		...
		return  this.apollo.query<PassableStateConfig<PurchaseOrderModel>>(
			{
				query: gql`
					query Count {
						totalCount: countPurchaseOrders
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<PurchaseOrderModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<PurchaseOrderModel>> {
		...
		return this.apollo.query<PassableStateConfig<PurchaseOrderModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						PurchaseOrderById: purchaseOrderById(id: $id) {
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.PurchaseOrderById as PurchaseOrderModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PurchaseOrderModel>> {
		...
		return this.apollo.query<PassableStateConfig<PurchaseOrderModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						purchaseOrders: purchaseOrders(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...PurchaseOrderProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countPurchaseOrders(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.purchaseOrders as PurchaseOrderModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PurchaseOrderModel>> {
		...
		return this.apollo.query<PassableStateConfig<PurchaseOrderModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						purchaseOrders: lastPurchaseOrders(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...PurchaseOrderProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: PurchaseOrderModel, queryParams?: QueryParams): Observable<PassableStateConfig<PurchaseOrderModel>> {
		...
		const successMessage = 'Created Purchase Order entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($purchaseOrder: PurchaseOrderInput!, $persistRelations: Boolean) {
						purchaseOrder: createPurchaseOrder(purchaseOrder: $purchaseOrder, persistRelations: $persistRelations) {
							...PurchaseOrderProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.purchaseOrder as PurchaseOrderModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: PurchaseOrderModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PurchaseOrderModel>> {
		...
		const successMessage = 'Created Multiple Purchase Order entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($purchaseOrders: [PurchaseOrderInput!]!) {
						purchaseOrder: createAllPurchaseOrder(purchaseOrders: $purchaseOrders) {
							...PurchaseOrderProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					purchaseOrders: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.purchaseOrder as PurchaseOrderModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: PurchaseOrderModel, queryParams?: QueryParams): Observable<PassableStateConfig<PurchaseOrderModel>> {
		...
		const successMessage = 'Updated Purchase Order entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($purchaseOrder: PurchaseOrderInput!, $persistRelations: Boolean) {
						purchaseOrder: updatePurchaseOrder(purchaseOrder: $purchaseOrder, persistRelations: $persistRelations) {
							...PurchaseOrderProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: PurchaseOrderModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PurchaseOrderModel>> {
		...
		const successMessage = 'Update Multiple Purchase Order entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($purchaseOrders: [PurchaseOrderInput!]!) {
						purchaseOrder: updateAllPurchaseOrder(purchaseOrders: $purchaseOrders) {
							...PurchaseOrderProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<PurchaseOrderModel>> {
		...
		const successMessage = 'Deleted Purchase Order entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($purchaseOrderId: ID!) {
						purchaseOrderId: deletePurchaseOrderById(purchaseOrderId: $purchaseOrderId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.purchaseOrderId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<PurchaseOrderModel>> {
		...
		const successMessage = 'Deleted selected Purchase Order entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($purchaseOrderIds: [ID!]!){
						deletePurchaseOrderExcludingIds(purchaseOrderIds: $purchaseOrderIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.purchaseOrderIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<PurchaseOrderModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($purchaseOrderIds: [ID!]!) {
						purchaseOrderIds: deleteAllPurchaseOrderByIds(purchaseOrderIds: $purchaseOrderIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<PurchaseOrderModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PurchaseOrderModel>>(
			...
			map(result => {
				let audits: PurchaseOrderModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new PurchaseOrderModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<PurchaseOrderModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PurchaseOrderModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($purchaseOrderId: ID!) {
						audits: purchaseOrderAuditsByEntityId(purchaseOrderId: $purchaseOrderId) {
							entity {
								...PurchaseOrderProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<PurchaseOrderModel>> {
		const url = environment.API_URL + '/api/purchaseorder/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<PurchaseOrderModel>> {
		const url = environment.API_URL + '/api/purchaseorder/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<PurchaseOrderModel>> {
		let apiUrl = environment.API_URL + '/api/purchaseorder/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<PurchaseOrderModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/purchaseorder/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Purchase Order entities')),
