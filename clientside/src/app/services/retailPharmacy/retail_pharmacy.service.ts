...
import {RetailPharmacyModelAudit} from '../../models/retailPharmacy/retail_pharmacy.model.state';
...
/**
 * Retail Pharmacy service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class RetailPharmacyService extends AbstractHttpService<RetailPharmacyModel, RetailPharmacyModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the RetailPharmacyProperties classFragment here] off begin
			fragment RetailPharmacyProperties on RetailPharmacy {
				...RetailPharmacyBaseProperties
				customerType
				retailNumber
				status
				customerName
			...
			# % protected region % [Modify the RetailPharmacyProperties classFragment here] end
			${super.fragments('RetailPharmacy').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<RetailPharmacyModel>> {
		...
		return  this.apollo.query<PassableStateConfig<RetailPharmacyModel>>(
			{
				query: gql`
					query Count {
						totalCount: countRetailPharmacys
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<RetailPharmacyModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<RetailPharmacyModel>> {
		...
		return this.apollo.query<PassableStateConfig<RetailPharmacyModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						RetailPharmacyById: retailPharmacyById(id: $id) {
							...RetailPharmacyProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.RetailPharmacyById as RetailPharmacyModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<RetailPharmacyModel>> {
		...
		return this.apollo.query<PassableStateConfig<RetailPharmacyModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						retailPharmacys: retailPharmacys(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...RetailPharmacyProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countRetailPharmacys(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.retailPharmacys as RetailPharmacyModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<RetailPharmacyModel>> {
		...
		return this.apollo.query<PassableStateConfig<RetailPharmacyModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						retailPharmacys: lastRetailPharmacys(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...RetailPharmacyProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: RetailPharmacyModel, queryParams?: QueryParams): Observable<PassableStateConfig<RetailPharmacyModel>> {
		...
		const successMessage = 'Created Retail Pharmacy entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($retailPharmacy: RetailPharmacyInput!, $persistRelations: Boolean) {
						retailPharmacy: createRetailPharmacy(retailPharmacy: $retailPharmacy, persistRelations: $persistRelations) {
							...RetailPharmacyProperties,
				...
				variables: {
					retailPharmacy: {
						...
						retailPharmacyInvoices: entity.retailPharmacyInvoices ? entity.retailPharmacyInvoices?.map((model: RetailPharmacyInvoiceModel) => new RetailPharmacyInvoiceModel(model).toJSON()) : [],
			...
			map(result => {
				...
				return {
					targetModel: result.data.retailPharmacy as RetailPharmacyModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: RetailPharmacyModel[], queryParams?: QueryParams): Observable<PassableStateConfig<RetailPharmacyModel>> {
		...
		const successMessage = 'Created Multiple Retail Pharmacy entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($retailPharmacys: [RetailPharmacyInput!]!) {
						retailPharmacy: createAllRetailPharmacy(retailPharmacys: $retailPharmacys) {
							...RetailPharmacyProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					retailPharmacys: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.retailPharmacy as RetailPharmacyModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: RetailPharmacyModel, queryParams?: QueryParams): Observable<PassableStateConfig<RetailPharmacyModel>> {
		...
		const successMessage = 'Updated Retail Pharmacy entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($retailPharmacy: RetailPharmacyInput!, $persistRelations: Boolean) {
						retailPharmacy: updateRetailPharmacy(retailPharmacy: $retailPharmacy, persistRelations: $persistRelations) {
							...RetailPharmacyProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: RetailPharmacyModel[], queryParams?: QueryParams): Observable<PassableStateConfig<RetailPharmacyModel>> {
		...
		const successMessage = 'Update Multiple Retail Pharmacy entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($retailPharmacys: [RetailPharmacyInput!]!) {
						retailPharmacy: updateAllRetailPharmacy(retailPharmacys: $retailPharmacys) {
							...RetailPharmacyProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<RetailPharmacyModel>> {
		...
		const successMessage = 'Deleted Retail Pharmacy entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($retailPharmacyId: ID!) {
						retailPharmacyId: deleteRetailPharmacyById(retailPharmacyId: $retailPharmacyId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.retailPharmacyId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<RetailPharmacyModel>> {
		...
		const successMessage = 'Deleted selected Retail Pharmacy entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($retailPharmacyIds: [ID!]!){
						deleteRetailPharmacyExcludingIds(retailPharmacyIds: $retailPharmacyIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.retailPharmacyIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<RetailPharmacyModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($retailPharmacyIds: [ID!]!) {
						retailPharmacyIds: deleteAllRetailPharmacyByIds(retailPharmacyIds: $retailPharmacyIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<RetailPharmacyModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<RetailPharmacyModel>>(
			...
			map(result => {
				let audits: RetailPharmacyModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new RetailPharmacyModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<RetailPharmacyModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<RetailPharmacyModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($retailPharmacyId: ID!) {
						audits: retailPharmacyAuditsByEntityId(retailPharmacyId: $retailPharmacyId) {
							entity {
								...RetailPharmacyProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<RetailPharmacyModel>> {
		const url = environment.API_URL + '/api/retailpharmacy/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<RetailPharmacyModel>> {
		const url = environment.API_URL + '/api/retailpharmacy/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<RetailPharmacyModel>> {
		let apiUrl = environment.API_URL + '/api/retailpharmacy/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<RetailPharmacyModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/retailpharmacy/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Retail Pharmacy entities')),
