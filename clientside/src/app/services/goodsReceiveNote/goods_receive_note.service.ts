...
import {GoodsReceiveNoteModelAudit} from '../../models/goodsReceiveNote/goods_receive_note.model.state';
...
/**
 * Goods Receive Note service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class GoodsReceiveNoteService extends AbstractHttpService<GoodsReceiveNoteModel, GoodsReceiveNoteModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the GoodsReceiveNoteProperties classFragment here] off begin
			fragment GoodsReceiveNoteProperties on GoodsReceiveNote {
				...GoodsReceiveNoteBaseProperties
				receiveNumber
				sourceDocumentType
			...
			# % protected region % [Modify the GoodsReceiveNoteProperties classFragment here] end
			${super.fragments('GoodsReceiveNote').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<GoodsReceiveNoteModel>> {
		...
		return  this.apollo.query<PassableStateConfig<GoodsReceiveNoteModel>>(
			{
				query: gql`
					query Count {
						totalCount: countGoodsReceiveNotes
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<GoodsReceiveNoteModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<GoodsReceiveNoteModel>> {
		...
		return this.apollo.query<PassableStateConfig<GoodsReceiveNoteModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						GoodsReceiveNoteById: goodsReceiveNoteById(id: $id) {
							...GoodsReceiveNoteProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.GoodsReceiveNoteById as GoodsReceiveNoteModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<GoodsReceiveNoteModel>> {
		...
		return this.apollo.query<PassableStateConfig<GoodsReceiveNoteModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						goodsReceiveNotes: goodsReceiveNotes(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...GoodsReceiveNoteProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countGoodsReceiveNotes(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.goodsReceiveNotes as GoodsReceiveNoteModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<GoodsReceiveNoteModel>> {
		...
		return this.apollo.query<PassableStateConfig<GoodsReceiveNoteModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						goodsReceiveNotes: lastGoodsReceiveNotes(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...GoodsReceiveNoteProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: GoodsReceiveNoteModel, queryParams?: QueryParams): Observable<PassableStateConfig<GoodsReceiveNoteModel>> {
		...
		const successMessage = 'Created Goods Receive Note entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($goodsReceiveNote: GoodsReceiveNoteInput!, $persistRelations: Boolean) {
						goodsReceiveNote: createGoodsReceiveNote(goodsReceiveNote: $goodsReceiveNote, persistRelations: $persistRelations) {
							...GoodsReceiveNoteProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.goodsReceiveNote as GoodsReceiveNoteModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: GoodsReceiveNoteModel[], queryParams?: QueryParams): Observable<PassableStateConfig<GoodsReceiveNoteModel>> {
		...
		const successMessage = 'Created Multiple Goods Receive Note entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($goodsReceiveNotes: [GoodsReceiveNoteInput!]!) {
						goodsReceiveNote: createAllGoodsReceiveNote(goodsReceiveNotes: $goodsReceiveNotes) {
							...GoodsReceiveNoteProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					goodsReceiveNotes: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.goodsReceiveNote as GoodsReceiveNoteModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: GoodsReceiveNoteModel, queryParams?: QueryParams): Observable<PassableStateConfig<GoodsReceiveNoteModel>> {
		...
		const successMessage = 'Updated Goods Receive Note entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($goodsReceiveNote: GoodsReceiveNoteInput!, $persistRelations: Boolean) {
						goodsReceiveNote: updateGoodsReceiveNote(goodsReceiveNote: $goodsReceiveNote, persistRelations: $persistRelations) {
							...GoodsReceiveNoteProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: GoodsReceiveNoteModel[], queryParams?: QueryParams): Observable<PassableStateConfig<GoodsReceiveNoteModel>> {
		...
		const successMessage = 'Update Multiple Goods Receive Note entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($goodsReceiveNotes: [GoodsReceiveNoteInput!]!) {
						goodsReceiveNote: updateAllGoodsReceiveNote(goodsReceiveNotes: $goodsReceiveNotes) {
							...GoodsReceiveNoteProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<GoodsReceiveNoteModel>> {
		...
		const successMessage = 'Deleted Goods Receive Note entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($goodsReceiveNoteId: ID!) {
						goodsReceiveNoteId: deleteGoodsReceiveNoteById(goodsReceiveNoteId: $goodsReceiveNoteId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.goodsReceiveNoteId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<GoodsReceiveNoteModel>> {
		...
		const successMessage = 'Deleted selected Goods Receive Note entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($goodsReceiveNoteIds: [ID!]!){
						deleteGoodsReceiveNoteExcludingIds(goodsReceiveNoteIds: $goodsReceiveNoteIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.goodsReceiveNoteIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<GoodsReceiveNoteModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($goodsReceiveNoteIds: [ID!]!) {
						goodsReceiveNoteIds: deleteAllGoodsReceiveNoteByIds(goodsReceiveNoteIds: $goodsReceiveNoteIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<GoodsReceiveNoteModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<GoodsReceiveNoteModel>>(
			...
			map(result => {
				let audits: GoodsReceiveNoteModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new GoodsReceiveNoteModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<GoodsReceiveNoteModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<GoodsReceiveNoteModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($goodsReceiveNoteId: ID!) {
						audits: goodsReceiveNoteAuditsByEntityId(goodsReceiveNoteId: $goodsReceiveNoteId) {
							entity {
								...GoodsReceiveNoteProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<GoodsReceiveNoteModel>> {
		const url = environment.API_URL + '/api/goodsreceivenote/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<GoodsReceiveNoteModel>> {
		const url = environment.API_URL + '/api/goodsreceivenote/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<GoodsReceiveNoteModel>> {
		let apiUrl = environment.API_URL + '/api/goodsreceivenote/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<GoodsReceiveNoteModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/goodsreceivenote/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Goods Receive Note entities')),
