...
import {NhisTypeOfServiceModel} from '../../models/nhisTypeOfService/nhis_type_of_service.model';
import {NhisTypeOfServiceModelAudit} from '../../models/nhisTypeOfService/nhis_type_of_service.model.state';
...
/**
 * NHIS Type Of Service service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class NhisTypeOfServiceService extends AbstractHttpService<NhisTypeOfServiceModel, NhisTypeOfServiceModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the NhisTypeOfServiceProperties classFragment here] off begin
			fragment NhisTypeOfServiceProperties on NhisTypeOfService {
				...NhisTypeOfServiceBaseProperties
				code
				description
				sections
			}
			# % protected region % [Modify the NhisTypeOfServiceProperties classFragment here] end
			${super.fragments('NhisTypeOfService').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<NhisTypeOfServiceModel>> {
		...
		return  this.apollo.query<PassableStateConfig<NhisTypeOfServiceModel>>(
			{
				query: gql`
					query Count {
						totalCount: countNhisTypeOfServices
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<NhisTypeOfServiceModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<NhisTypeOfServiceModel>> {
		...
		return this.apollo.query<PassableStateConfig<NhisTypeOfServiceModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						NhisTypeOfServiceById: nhisTypeOfServiceById(id: $id) {
							...NhisTypeOfServiceProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.NhisTypeOfServiceById as NhisTypeOfServiceModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<NhisTypeOfServiceModel>> {
		...
		return this.apollo.query<PassableStateConfig<NhisTypeOfServiceModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						nhisTypeOfServices: nhisTypeOfServices(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...NhisTypeOfServiceProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countNhisTypeOfServices(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.nhisTypeOfServices as NhisTypeOfServiceModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<NhisTypeOfServiceModel>> {
		...
		return this.apollo.query<PassableStateConfig<NhisTypeOfServiceModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						nhisTypeOfServices: lastNhisTypeOfServices(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...NhisTypeOfServiceProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: NhisTypeOfServiceModel, queryParams?: QueryParams): Observable<PassableStateConfig<NhisTypeOfServiceModel>> {
		...
		const successMessage = 'Created NHIS Type Of Service entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($nhisTypeOfService: NhisTypeOfServiceInput!, $persistRelations: Boolean) {
						nhisTypeOfService: createNhisTypeOfService(nhisTypeOfService: $nhisTypeOfService, persistRelations: $persistRelations) {
							...NhisTypeOfServiceProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.nhisTypeOfService as NhisTypeOfServiceModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: NhisTypeOfServiceModel[], queryParams?: QueryParams): Observable<PassableStateConfig<NhisTypeOfServiceModel>> {
		...
		const successMessage = 'Created Multiple NHIS Type Of Service entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($nhisTypeOfServices: [NhisTypeOfServiceInput!]!) {
						nhisTypeOfService: createAllNhisTypeOfService(nhisTypeOfServices: $nhisTypeOfServices) {
							...NhisTypeOfServiceProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					nhisTypeOfServices: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.nhisTypeOfService as NhisTypeOfServiceModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: NhisTypeOfServiceModel, queryParams?: QueryParams): Observable<PassableStateConfig<NhisTypeOfServiceModel>> {
		...
		const successMessage = 'Updated NHIS Type Of Service entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($nhisTypeOfService: NhisTypeOfServiceInput!, $persistRelations: Boolean) {
						nhisTypeOfService: updateNhisTypeOfService(nhisTypeOfService: $nhisTypeOfService, persistRelations: $persistRelations) {
							...NhisTypeOfServiceProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: NhisTypeOfServiceModel[], queryParams?: QueryParams): Observable<PassableStateConfig<NhisTypeOfServiceModel>> {
		...
		const successMessage = 'Update Multiple NHIS Type Of Service entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($nhisTypeOfServices: [NhisTypeOfServiceInput!]!) {
						nhisTypeOfService: updateAllNhisTypeOfService(nhisTypeOfServices: $nhisTypeOfServices) {
							...NhisTypeOfServiceProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<NhisTypeOfServiceModel>> {
		...
		const successMessage = 'Deleted NHIS Type Of Service entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($nhisTypeOfServiceId: ID!) {
						nhisTypeOfServiceId: deleteNhisTypeOfServiceById(nhisTypeOfServiceId: $nhisTypeOfServiceId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.nhisTypeOfServiceId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<NhisTypeOfServiceModel>> {
		...
		const successMessage = 'Deleted selected NHIS Type Of Service entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($nhisTypeOfServiceIds: [ID!]!){
						deleteNhisTypeOfServiceExcludingIds(nhisTypeOfServiceIds: $nhisTypeOfServiceIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.nhisTypeOfServiceIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<NhisTypeOfServiceModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($nhisTypeOfServiceIds: [ID!]!) {
						nhisTypeOfServiceIds: deleteAllNhisTypeOfServiceByIds(nhisTypeOfServiceIds: $nhisTypeOfServiceIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<NhisTypeOfServiceModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<NhisTypeOfServiceModel>>(
			{
				query: gql`
					query GetAudits {
						audits: nhisTypeOfServiceAudits {
							entity {
								...NhisTypeOfServiceProperties
							}
							timestamp
			...
			map(result => {
				let audits: NhisTypeOfServiceModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new NhisTypeOfServiceModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<NhisTypeOfServiceModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<NhisTypeOfServiceModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($nhisTypeOfServiceId: ID!) {
						audits: nhisTypeOfServiceAuditsByEntityId(nhisTypeOfServiceId: $nhisTypeOfServiceId) {
							entity {
								...NhisTypeOfServiceProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<NhisTypeOfServiceModel>> {
		const url = environment.API_URL + '/api/nhistypeofservice/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<NhisTypeOfServiceModel>> {
		const url = environment.API_URL + '/api/nhistypeofservice/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<NhisTypeOfServiceModel>> {
		let apiUrl = environment.API_URL + '/api/nhistypeofservice/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<NhisTypeOfServiceModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/nhistypeofservice/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' NHIS Type Of Service entities')),
