...
import {CoTreatingDoctorModel} from '../../models/coTreatingDoctor/co_treating_doctor.model';
import {CoTreatingDoctorModelAudit} from '../../models/coTreatingDoctor/co_treating_doctor.model.state';
...
/**
 * Co Treating Doctor service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class CoTreatingDoctorService extends AbstractHttpService<CoTreatingDoctorModel, CoTreatingDoctorModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the CoTreatingDoctorProperties classFragment here] off begin
			fragment CoTreatingDoctorProperties on CoTreatingDoctor {
				...CoTreatingDoctorBaseProperties
				doctorNotes
			}
			# % protected region % [Modify the CoTreatingDoctorProperties classFragment here] end
			${super.fragments('CoTreatingDoctor').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<CoTreatingDoctorModel>> {
		...
		return  this.apollo.query<PassableStateConfig<CoTreatingDoctorModel>>(
			{
				query: gql`
					query Count {
						totalCount: countCoTreatingDoctors
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<CoTreatingDoctorModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<CoTreatingDoctorModel>> {
		...
		return this.apollo.query<PassableStateConfig<CoTreatingDoctorModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						CoTreatingDoctorById: coTreatingDoctorById(id: $id) {
							...CoTreatingDoctorProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.CoTreatingDoctorById as CoTreatingDoctorModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<CoTreatingDoctorModel>> {
		...
		return this.apollo.query<PassableStateConfig<CoTreatingDoctorModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						coTreatingDoctors: coTreatingDoctors(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...CoTreatingDoctorProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countCoTreatingDoctors(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.coTreatingDoctors as CoTreatingDoctorModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<CoTreatingDoctorModel>> {
		...
		return this.apollo.query<PassableStateConfig<CoTreatingDoctorModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						coTreatingDoctors: lastCoTreatingDoctors(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...CoTreatingDoctorProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: CoTreatingDoctorModel, queryParams?: QueryParams): Observable<PassableStateConfig<CoTreatingDoctorModel>> {
		...
		const successMessage = 'Created Co Treating Doctor entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($coTreatingDoctor: CoTreatingDoctorInput!, $persistRelations: Boolean) {
						coTreatingDoctor: createCoTreatingDoctor(coTreatingDoctor: $coTreatingDoctor, persistRelations: $persistRelations) {
							...CoTreatingDoctorProperties,
				...
				variables: {
					coTreatingDoctor: {
						...entity.toJSON(),
						additionalAnesthesiologist: entity.additionalAnesthesiologist ? new PreoperativeRecordsModel(entity.additionalAnesthesiologist).toJSON() : undefined,
						additionalMidwife: entity.additionalMidwife ? new DeliveryMedicalExaminationRecordModel(entity.additionalMidwife).toJSON() : undefined,
						additionalSurgeryNurse: entity.additionalSurgeryNurse ? new PreoperativeRecordsModel(entity.additionalSurgeryNurse).toJSON() : undefined,
						coTreatingAnesthesiologist: entity.coTreatingAnesthesiologist ? new PreoperativeRecordsModel(entity.coTreatingAnesthesiologist).toJSON() : undefined,
						...
						coTreatingSurgeon: entity.coTreatingSurgeon ? new PreoperativeRecordsModel(entity.coTreatingSurgeon).toJSON() : undefined,
					},
			...
			map(result => {
				...
				return {
					targetModel: result.data.coTreatingDoctor as CoTreatingDoctorModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: CoTreatingDoctorModel[], queryParams?: QueryParams): Observable<PassableStateConfig<CoTreatingDoctorModel>> {
		...
		const successMessage = 'Created Multiple Co Treating Doctor entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($coTreatingDoctors: [CoTreatingDoctorInput!]!) {
						coTreatingDoctor: createAllCoTreatingDoctor(coTreatingDoctors: $coTreatingDoctors) {
							...CoTreatingDoctorProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					coTreatingDoctors: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.coTreatingDoctor as CoTreatingDoctorModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: CoTreatingDoctorModel, queryParams?: QueryParams): Observable<PassableStateConfig<CoTreatingDoctorModel>> {
		...
		const successMessage = 'Updated Co Treating Doctor entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($coTreatingDoctor: CoTreatingDoctorInput!, $persistRelations: Boolean) {
						coTreatingDoctor: updateCoTreatingDoctor(coTreatingDoctor: $coTreatingDoctor, persistRelations: $persistRelations) {
							...CoTreatingDoctorProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: CoTreatingDoctorModel[], queryParams?: QueryParams): Observable<PassableStateConfig<CoTreatingDoctorModel>> {
		...
		const successMessage = 'Update Multiple Co Treating Doctor entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($coTreatingDoctors: [CoTreatingDoctorInput!]!) {
						coTreatingDoctor: updateAllCoTreatingDoctor(coTreatingDoctors: $coTreatingDoctors) {
							...CoTreatingDoctorProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<CoTreatingDoctorModel>> {
		...
		const successMessage = 'Deleted Co Treating Doctor entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($coTreatingDoctorId: ID!) {
						coTreatingDoctorId: deleteCoTreatingDoctorById(coTreatingDoctorId: $coTreatingDoctorId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.coTreatingDoctorId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<CoTreatingDoctorModel>> {
		...
		const successMessage = 'Deleted selected Co Treating Doctor entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($coTreatingDoctorIds: [ID!]!){
						deleteCoTreatingDoctorExcludingIds(coTreatingDoctorIds: $coTreatingDoctorIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.coTreatingDoctorIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<CoTreatingDoctorModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($coTreatingDoctorIds: [ID!]!) {
						coTreatingDoctorIds: deleteAllCoTreatingDoctorByIds(coTreatingDoctorIds: $coTreatingDoctorIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<CoTreatingDoctorModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<CoTreatingDoctorModel>>(
			...
			map(result => {
				let audits: CoTreatingDoctorModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new CoTreatingDoctorModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<CoTreatingDoctorModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<CoTreatingDoctorModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($coTreatingDoctorId: ID!) {
						audits: coTreatingDoctorAuditsByEntityId(coTreatingDoctorId: $coTreatingDoctorId) {
							entity {
								...CoTreatingDoctorProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<CoTreatingDoctorModel>> {
		const url = environment.API_URL + '/api/cotreatingdoctor/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<CoTreatingDoctorModel>> {
		const url = environment.API_URL + '/api/cotreatingdoctor/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<CoTreatingDoctorModel>> {
		let apiUrl = environment.API_URL + '/api/cotreatingdoctor/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<CoTreatingDoctorModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/cotreatingdoctor/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Co Treating Doctor entities')),
