...
import {BpjsPRBDetailModel} from '../../models/bpjsPRBDetail/bpjs_prb_detail.model';
import {BpjsPRBDetailModelAudit} from '../../models/bpjsPRBDetail/bpjs_prb_detail.model.state';
...
/**
 * BPJS PRB Detail service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BpjsPRBDetailService extends AbstractHttpService<BpjsPRBDetailModel, BpjsPRBDetailModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BpjsPRBDetailProperties classFragment here] off begin
			fragment BpjsPRBDetailProperties on BpjsPRBDetail {
				...BpjsPRBDetailBaseProperties
				srbNo
				drugCode
				drugName
				signa1
			...
			# % protected region % [Modify the BpjsPRBDetailProperties classFragment here] end
			${super.fragments('BpjsPRBDetail').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BpjsPRBDetailModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BpjsPRBDetailModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBpjsPRBDetails
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BpjsPRBDetailModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPRBDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPRBDetailModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BpjsPRBDetailById: bpjsPRBDetailById(id: $id) {
							...BpjsPRBDetailProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BpjsPRBDetailById as BpjsPRBDetailModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsPRBDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPRBDetailModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						bpjsPRBDetails: bpjsPRBDetails(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BpjsPRBDetailProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBpjsPRBDetails(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.bpjsPRBDetails as BpjsPRBDetailModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsPRBDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPRBDetailModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						bpjsPRBDetails: lastBpjsPRBDetails(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BpjsPRBDetailProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BpjsPRBDetailModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPRBDetailModel>> {
		...
		const successMessage = 'Created BPJS PRB Detail entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($bpjsPRBDetail: BpjsPRBDetailInput!, $persistRelations: Boolean) {
						bpjsPRBDetail: createBpjsPRBDetail(bpjsPRBDetail: $bpjsPRBDetail, persistRelations: $persistRelations) {
							...BpjsPRBDetailProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.bpjsPRBDetail as BpjsPRBDetailModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BpjsPRBDetailModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPRBDetailModel>> {
		...
		const successMessage = 'Created Multiple BPJS PRB Detail entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($bpjsPRBDetails: [BpjsPRBDetailInput!]!) {
						bpjsPRBDetail: createAllBpjsPRBDetail(bpjsPRBDetails: $bpjsPRBDetails) {
							...BpjsPRBDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					bpjsPRBDetails: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.bpjsPRBDetail as BpjsPRBDetailModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BpjsPRBDetailModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPRBDetailModel>> {
		...
		const successMessage = 'Updated BPJS PRB Detail entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($bpjsPRBDetail: BpjsPRBDetailInput!, $persistRelations: Boolean) {
						bpjsPRBDetail: updateBpjsPRBDetail(bpjsPRBDetail: $bpjsPRBDetail, persistRelations: $persistRelations) {
							...BpjsPRBDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BpjsPRBDetailModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPRBDetailModel>> {
		...
		const successMessage = 'Update Multiple BPJS PRB Detail entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($bpjsPRBDetails: [BpjsPRBDetailInput!]!) {
						bpjsPRBDetail: updateAllBpjsPRBDetail(bpjsPRBDetails: $bpjsPRBDetails) {
							...BpjsPRBDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BpjsPRBDetailModel>> {
		...
		const successMessage = 'Deleted BPJS PRB Detail entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($bpjsPRBDetailId: ID!) {
						bpjsPRBDetailId: deleteBpjsPRBDetailById(bpjsPRBDetailId: $bpjsPRBDetailId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.bpjsPRBDetailId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsPRBDetailModel>> {
		...
		const successMessage = 'Deleted selected BPJS PRB Detail entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($bpjsPRBDetailIds: [ID!]!){
						deleteBpjsPRBDetailExcludingIds(bpjsPRBDetailIds: $bpjsPRBDetailIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.bpjsPRBDetailIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BpjsPRBDetailModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($bpjsPRBDetailIds: [ID!]!) {
						bpjsPRBDetailIds: deleteAllBpjsPRBDetailByIds(bpjsPRBDetailIds: $bpjsPRBDetailIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BpjsPRBDetailModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPRBDetailModel>>(
			...
			map(result => {
				let audits: BpjsPRBDetailModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BpjsPRBDetailModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BpjsPRBDetailModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPRBDetailModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($bpjsPRBDetailId: ID!) {
						audits: bpjsPRBDetailAuditsByEntityId(bpjsPRBDetailId: $bpjsPRBDetailId) {
							entity {
								...BpjsPRBDetailProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BpjsPRBDetailModel>> {
		const url = environment.API_URL + '/api/bpjsprbdetail/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BpjsPRBDetailModel>> {
		const url = environment.API_URL + '/api/bpjsprbdetail/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsPRBDetailModel>> {
		let apiUrl = environment.API_URL + '/api/bpjsprbdetail/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BpjsPRBDetailModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/bpjsprbdetail/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' BPJS PRB Detail entities')),
