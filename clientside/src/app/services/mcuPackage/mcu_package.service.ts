...
import {McuPackageModel} from '../../models/mcuPackage/mcu_package.model';
import {McuPackageModelAudit} from '../../models/mcuPackage/mcu_package.model.state';
...
/**
 * MCU Package service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class McuPackageService extends AbstractHttpService<McuPackageModel, McuPackageModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the McuPackageProperties classFragment here] off begin
			fragment McuPackageProperties on McuPackage {
				...McuPackageBaseProperties
				mcuPackageCode
				description
				packageType
				sequence
			}
			# % protected region % [Modify the McuPackageProperties classFragment here] end
			${super.fragments('McuPackage').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<McuPackageModel>> {
		...
		return  this.apollo.query<PassableStateConfig<McuPackageModel>>(
			{
				query: gql`
					query Count {
						totalCount: countMcuPackages
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<McuPackageModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<McuPackageModel>> {
		...
		return this.apollo.query<PassableStateConfig<McuPackageModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						McuPackageById: mcuPackageById(id: $id) {
							...McuPackageProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.McuPackageById as McuPackageModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<McuPackageModel>> {
		...
		return this.apollo.query<PassableStateConfig<McuPackageModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						mcuPackages: mcuPackages(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...McuPackageProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countMcuPackages(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.mcuPackages as McuPackageModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<McuPackageModel>> {
		...
		return this.apollo.query<PassableStateConfig<McuPackageModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						mcuPackages: lastMcuPackages(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...McuPackageProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: McuPackageModel, queryParams?: QueryParams): Observable<PassableStateConfig<McuPackageModel>> {
		...
		const successMessage = 'Created MCU Package entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($mcuPackage: McuPackageInput!, $persistRelations: Boolean) {
						mcuPackage: createMcuPackage(mcuPackage: $mcuPackage, persistRelations: $persistRelations) {
							...McuPackageProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.mcuPackage as McuPackageModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: McuPackageModel[], queryParams?: QueryParams): Observable<PassableStateConfig<McuPackageModel>> {
		...
		const successMessage = 'Created Multiple MCU Package entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($mcuPackages: [McuPackageInput!]!) {
						mcuPackage: createAllMcuPackage(mcuPackages: $mcuPackages) {
							...McuPackageProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					mcuPackages: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.mcuPackage as McuPackageModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: McuPackageModel, queryParams?: QueryParams): Observable<PassableStateConfig<McuPackageModel>> {
		...
		const successMessage = 'Updated MCU Package entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($mcuPackage: McuPackageInput!, $persistRelations: Boolean) {
						mcuPackage: updateMcuPackage(mcuPackage: $mcuPackage, persistRelations: $persistRelations) {
							...McuPackageProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: McuPackageModel[], queryParams?: QueryParams): Observable<PassableStateConfig<McuPackageModel>> {
		...
		const successMessage = 'Update Multiple MCU Package entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($mcuPackages: [McuPackageInput!]!) {
						mcuPackage: updateAllMcuPackage(mcuPackages: $mcuPackages) {
							...McuPackageProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<McuPackageModel>> {
		...
		const successMessage = 'Deleted MCU Package entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($mcuPackageId: ID!) {
						mcuPackageId: deleteMcuPackageById(mcuPackageId: $mcuPackageId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.mcuPackageId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<McuPackageModel>> {
		...
		const successMessage = 'Deleted selected MCU Package entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($mcuPackageIds: [ID!]!){
						deleteMcuPackageExcludingIds(mcuPackageIds: $mcuPackageIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.mcuPackageIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<McuPackageModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($mcuPackageIds: [ID!]!) {
						mcuPackageIds: deleteAllMcuPackageByIds(mcuPackageIds: $mcuPackageIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<McuPackageModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<McuPackageModel>>(
			...
			map(result => {
				let audits: McuPackageModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new McuPackageModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<McuPackageModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<McuPackageModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($mcuPackageId: ID!) {
						audits: mcuPackageAuditsByEntityId(mcuPackageId: $mcuPackageId) {
							entity {
								...McuPackageProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<McuPackageModel>> {
		const url = environment.API_URL + '/api/mcupackage/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<McuPackageModel>> {
		const url = environment.API_URL + '/api/mcupackage/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<McuPackageModel>> {
		let apiUrl = environment.API_URL + '/api/mcupackage/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<McuPackageModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/mcupackage/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' MCU Package entities')),
