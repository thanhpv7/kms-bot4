...
import {PcareDiagnosaModel} from '../../models/pcareDiagnosa/pcare_diagnosa.model';
import {PcareDiagnosaModelAudit} from '../../models/pcareDiagnosa/pcare_diagnosa.model.state';
...
/**
 * PCare Diagnosa service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class PcareDiagnosaService extends AbstractHttpService<PcareDiagnosaModel, PcareDiagnosaModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the PcareDiagnosaProperties classFragment here] off begin
			fragment PcareDiagnosaProperties on PcareDiagnosa {
				...PcareDiagnosaBaseProperties
				kodeDiagnosa
				namaDiagnosa
				nonSpesialis
			}
			# % protected region % [Modify the PcareDiagnosaProperties classFragment here] end
			${super.fragments('PcareDiagnosa').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<PcareDiagnosaModel>> {
		...
		return  this.apollo.query<PassableStateConfig<PcareDiagnosaModel>>(
			{
				query: gql`
					query Count {
						totalCount: countPcareDiagnosas
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<PcareDiagnosaModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<PcareDiagnosaModel>> {
		...
		return this.apollo.query<PassableStateConfig<PcareDiagnosaModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						PcareDiagnosaById: pcareDiagnosaById(id: $id) {
							...PcareDiagnosaProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.PcareDiagnosaById as PcareDiagnosaModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PcareDiagnosaModel>> {
		...
		return this.apollo.query<PassableStateConfig<PcareDiagnosaModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						pcareDiagnosas: pcareDiagnosas(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...PcareDiagnosaProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countPcareDiagnosas(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.pcareDiagnosas as PcareDiagnosaModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PcareDiagnosaModel>> {
		...
		return this.apollo.query<PassableStateConfig<PcareDiagnosaModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						pcareDiagnosas: lastPcareDiagnosas(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...PcareDiagnosaProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: PcareDiagnosaModel, queryParams?: QueryParams): Observable<PassableStateConfig<PcareDiagnosaModel>> {
		...
		const successMessage = 'Created PCare Diagnosa entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($pcareDiagnosa: PcareDiagnosaInput!, $persistRelations: Boolean) {
						pcareDiagnosa: createPcareDiagnosa(pcareDiagnosa: $pcareDiagnosa, persistRelations: $persistRelations) {
							...PcareDiagnosaProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.pcareDiagnosa as PcareDiagnosaModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: PcareDiagnosaModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PcareDiagnosaModel>> {
		...
		const successMessage = 'Created Multiple PCare Diagnosa entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($pcareDiagnosas: [PcareDiagnosaInput!]!) {
						pcareDiagnosa: createAllPcareDiagnosa(pcareDiagnosas: $pcareDiagnosas) {
							...PcareDiagnosaProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					pcareDiagnosas: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.pcareDiagnosa as PcareDiagnosaModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: PcareDiagnosaModel, queryParams?: QueryParams): Observable<PassableStateConfig<PcareDiagnosaModel>> {
		...
		const successMessage = 'Updated PCare Diagnosa entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($pcareDiagnosa: PcareDiagnosaInput!, $persistRelations: Boolean) {
						pcareDiagnosa: updatePcareDiagnosa(pcareDiagnosa: $pcareDiagnosa, persistRelations: $persistRelations) {
							...PcareDiagnosaProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: PcareDiagnosaModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PcareDiagnosaModel>> {
		...
		const successMessage = 'Update Multiple PCare Diagnosa entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($pcareDiagnosas: [PcareDiagnosaInput!]!) {
						pcareDiagnosa: updateAllPcareDiagnosa(pcareDiagnosas: $pcareDiagnosas) {
							...PcareDiagnosaProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<PcareDiagnosaModel>> {
		...
		const successMessage = 'Deleted PCare Diagnosa entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($pcareDiagnosaId: ID!) {
						pcareDiagnosaId: deletePcareDiagnosaById(pcareDiagnosaId: $pcareDiagnosaId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.pcareDiagnosaId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<PcareDiagnosaModel>> {
		...
		const successMessage = 'Deleted selected PCare Diagnosa entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($pcareDiagnosaIds: [ID!]!){
						deletePcareDiagnosaExcludingIds(pcareDiagnosaIds: $pcareDiagnosaIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.pcareDiagnosaIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<PcareDiagnosaModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($pcareDiagnosaIds: [ID!]!) {
						pcareDiagnosaIds: deleteAllPcareDiagnosaByIds(pcareDiagnosaIds: $pcareDiagnosaIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<PcareDiagnosaModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PcareDiagnosaModel>>(
			...
			map(result => {
				let audits: PcareDiagnosaModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new PcareDiagnosaModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<PcareDiagnosaModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PcareDiagnosaModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($pcareDiagnosaId: ID!) {
						audits: pcareDiagnosaAuditsByEntityId(pcareDiagnosaId: $pcareDiagnosaId) {
							entity {
								...PcareDiagnosaProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<PcareDiagnosaModel>> {
		const url = environment.API_URL + '/api/pcarediagnosa/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<PcareDiagnosaModel>> {
		const url = environment.API_URL + '/api/pcarediagnosa/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<PcareDiagnosaModel>> {
		let apiUrl = environment.API_URL + '/api/pcarediagnosa/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<PcareDiagnosaModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/pcarediagnosa/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' PCare Diagnosa entities')),
