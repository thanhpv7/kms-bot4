...
import {DiagnosticExaminationResultsModel} from '../../models/diagnosticExaminationResults/diagnostic_examination_results.model';
import {DiagnosticExaminationResultsModelAudit} from '../../models/diagnosticExaminationResults/diagnostic_examination_results.model.state';
...
/**
 * Diagnostic Examination Results service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class DiagnosticExaminationResultsService extends AbstractHttpService<DiagnosticExaminationResultsModel, DiagnosticExaminationResultsModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the DiagnosticExaminationResultsProperties classFragment here] off begin
			fragment DiagnosticExaminationResultsProperties on DiagnosticExaminationResults {
				...DiagnosticExaminationResultsBaseProperties
				result
				outsideRange
				low
				high
			...
			# % protected region % [Modify the DiagnosticExaminationResultsProperties classFragment here] end
			${super.fragments('DiagnosticExaminationResults').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<DiagnosticExaminationResultsModel>> {
		...
		return  this.apollo.query<PassableStateConfig<DiagnosticExaminationResultsModel>>(
			{
				query: gql`
					query Count {
						totalCount: countDiagnosticExaminationResultss
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<DiagnosticExaminationResultsModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<DiagnosticExaminationResultsModel>> {
		...
		return this.apollo.query<PassableStateConfig<DiagnosticExaminationResultsModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						DiagnosticExaminationResultsById: diagnosticExaminationResultsById(id: $id) {
							...DiagnosticExaminationResultsProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.DiagnosticExaminationResultsById as DiagnosticExaminationResultsModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<DiagnosticExaminationResultsModel>> {
		...
		return this.apollo.query<PassableStateConfig<DiagnosticExaminationResultsModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						diagnosticExaminationResultss: diagnosticExaminationResultss(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...DiagnosticExaminationResultsProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countDiagnosticExaminationResultss(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.diagnosticExaminationResultss as DiagnosticExaminationResultsModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<DiagnosticExaminationResultsModel>> {
		...
		return this.apollo.query<PassableStateConfig<DiagnosticExaminationResultsModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						diagnosticExaminationResultss: lastDiagnosticExaminationResultss(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...DiagnosticExaminationResultsProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: DiagnosticExaminationResultsModel, queryParams?: QueryParams): Observable<PassableStateConfig<DiagnosticExaminationResultsModel>> {
		...
		const successMessage = 'Created Diagnostic Examination Results entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($diagnosticExaminationResults: DiagnosticExaminationResultsInput!, $persistRelations: Boolean) {
						diagnosticExaminationResults: createDiagnosticExaminationResults(diagnosticExaminationResults: $diagnosticExaminationResults, persistRelations: $persistRelations) {
							...DiagnosticExaminationResultsProperties,
				...
				variables: {
					diagnosticExaminationResults: {
						...entity.toJSON(),
						examinationItem: entity.examinationItem ? new ExaminationItemModel(entity.examinationItem).toJSON() : undefined,
			...
			map(result => {
				...
				return {
					targetModel: result.data.diagnosticExaminationResults as DiagnosticExaminationResultsModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: DiagnosticExaminationResultsModel[], queryParams?: QueryParams): Observable<PassableStateConfig<DiagnosticExaminationResultsModel>> {
		...
		const successMessage = 'Created Multiple Diagnostic Examination Results entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($diagnosticExaminationResultss: [DiagnosticExaminationResultsInput!]!) {
						diagnosticExaminationResults: createAllDiagnosticExaminationResults(diagnosticExaminationResultss: $diagnosticExaminationResultss) {
							...DiagnosticExaminationResultsProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					diagnosticExaminationResultss: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.diagnosticExaminationResults as DiagnosticExaminationResultsModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: DiagnosticExaminationResultsModel, queryParams?: QueryParams): Observable<PassableStateConfig<DiagnosticExaminationResultsModel>> {
		...
		const successMessage = 'Updated Diagnostic Examination Results entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($diagnosticExaminationResults: DiagnosticExaminationResultsInput!, $persistRelations: Boolean) {
						diagnosticExaminationResults: updateDiagnosticExaminationResults(diagnosticExaminationResults: $diagnosticExaminationResults, persistRelations: $persistRelations) {
							...DiagnosticExaminationResultsProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: DiagnosticExaminationResultsModel[], queryParams?: QueryParams): Observable<PassableStateConfig<DiagnosticExaminationResultsModel>> {
		...
		const successMessage = 'Update Multiple Diagnostic Examination Results entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($diagnosticExaminationResultss: [DiagnosticExaminationResultsInput!]!) {
						diagnosticExaminationResults: updateAllDiagnosticExaminationResults(diagnosticExaminationResultss: $diagnosticExaminationResultss) {
							...DiagnosticExaminationResultsProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<DiagnosticExaminationResultsModel>> {
		...
		const successMessage = 'Deleted Diagnostic Examination Results entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($diagnosticExaminationResultsId: ID!) {
						diagnosticExaminationResultsId: deleteDiagnosticExaminationResultsById(diagnosticExaminationResultsId: $diagnosticExaminationResultsId)
				...
				`,
				variables: {
					diagnosticExaminationResultsId: id,
			...
			map(result => {
				...
				return {
					targetModelId: result.data.diagnosticExaminationResultsId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<DiagnosticExaminationResultsModel>> {
		...
		const successMessage = 'Deleted selected Diagnostic Examination Results entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($diagnosticExaminationResultsIds: [ID!]!){
						deleteDiagnosticExaminationResultsExcludingIds(diagnosticExaminationResultsIds: $diagnosticExaminationResultsIds)
				...
				`,
				variables: {
					diagnosticExaminationResultsIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.diagnosticExaminationResultsIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<DiagnosticExaminationResultsModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($diagnosticExaminationResultsIds: [ID!]!) {
						diagnosticExaminationResultsIds: deleteAllDiagnosticExaminationResultsByIds(diagnosticExaminationResultsIds: $diagnosticExaminationResultsIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<DiagnosticExaminationResultsModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<DiagnosticExaminationResultsModel>>(
			{
				query: gql`
					query GetAudits {
						audits: diagnosticExaminationResultsAudits {
							entity {
								...DiagnosticExaminationResultsProperties
							}
							timestamp
			...
			map(result => {
				let audits: DiagnosticExaminationResultsModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new DiagnosticExaminationResultsModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<DiagnosticExaminationResultsModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<DiagnosticExaminationResultsModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($diagnosticExaminationResultsId: ID!) {
						audits: diagnosticExaminationResultsAuditsByEntityId(diagnosticExaminationResultsId: $diagnosticExaminationResultsId) {
							entity {
								...DiagnosticExaminationResultsProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<DiagnosticExaminationResultsModel>> {
		const url = environment.API_URL + '/api/diagnosticexaminationresults/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<DiagnosticExaminationResultsModel>> {
		const url = environment.API_URL + '/api/diagnosticexaminationresults/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<DiagnosticExaminationResultsModel>> {
		let apiUrl = environment.API_URL + '/api/diagnosticexaminationresults/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<DiagnosticExaminationResultsModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/diagnosticexaminationresults/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Diagnostic Examination Results entities')),
