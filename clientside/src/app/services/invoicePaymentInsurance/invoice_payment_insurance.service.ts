...
import {InvoicePaymentInsuranceModel} from '../../models/invoicePaymentInsurance/invoice_payment_insurance.model';
import {InvoicePaymentInsuranceModelAudit} from '../../models/invoicePaymentInsurance/invoice_payment_insurance.model.state';
...
/**
 * Invoice Payment Insurance service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class InvoicePaymentInsuranceService extends AbstractHttpService<InvoicePaymentInsuranceModel, InvoicePaymentInsuranceModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the InvoicePaymentInsuranceProperties classFragment here] off begin
			fragment InvoicePaymentInsuranceProperties on InvoicePaymentInsurance {
				...InvoicePaymentInsuranceBaseProperties
				memberNo
				policyHolderNo
			...
			# % protected region % [Modify the InvoicePaymentInsuranceProperties classFragment here] end
			${super.fragments('InvoicePaymentInsurance').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<InvoicePaymentInsuranceModel>> {
		...
		return  this.apollo.query<PassableStateConfig<InvoicePaymentInsuranceModel>>(
			{
				query: gql`
					query Count {
						totalCount: countInvoicePaymentInsurances
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<InvoicePaymentInsuranceModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<InvoicePaymentInsuranceModel>> {
		...
		return this.apollo.query<PassableStateConfig<InvoicePaymentInsuranceModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						InvoicePaymentInsuranceById: invoicePaymentInsuranceById(id: $id) {
							...InvoicePaymentInsuranceProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.InvoicePaymentInsuranceById as InvoicePaymentInsuranceModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<InvoicePaymentInsuranceModel>> {
		...
		return this.apollo.query<PassableStateConfig<InvoicePaymentInsuranceModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						invoicePaymentInsurances: invoicePaymentInsurances(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...InvoicePaymentInsuranceProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countInvoicePaymentInsurances(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.invoicePaymentInsurances as InvoicePaymentInsuranceModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<InvoicePaymentInsuranceModel>> {
		...
		return this.apollo.query<PassableStateConfig<InvoicePaymentInsuranceModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						invoicePaymentInsurances: lastInvoicePaymentInsurances(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...InvoicePaymentInsuranceProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: InvoicePaymentInsuranceModel, queryParams?: QueryParams): Observable<PassableStateConfig<InvoicePaymentInsuranceModel>> {
		...
		const successMessage = 'Created Invoice Payment Insurance entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($invoicePaymentInsurance: InvoicePaymentInsuranceInput!, $persistRelations: Boolean) {
						invoicePaymentInsurance: createInvoicePaymentInsurance(invoicePaymentInsurance: $invoicePaymentInsurance, persistRelations: $persistRelations) {
							...InvoicePaymentInsuranceProperties,
				...
				variables: {
					invoicePaymentInsurance: {
						...
						invoice: entity.invoice ? new InvoiceModel(entity.invoice).toJSON() : undefined,
					},
			...
			map(result => {
				...
				return {
					targetModel: result.data.invoicePaymentInsurance as InvoicePaymentInsuranceModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: InvoicePaymentInsuranceModel[], queryParams?: QueryParams): Observable<PassableStateConfig<InvoicePaymentInsuranceModel>> {
		...
		const successMessage = 'Created Multiple Invoice Payment Insurance entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($invoicePaymentInsurances: [InvoicePaymentInsuranceInput!]!) {
						invoicePaymentInsurance: createAllInvoicePaymentInsurance(invoicePaymentInsurances: $invoicePaymentInsurances) {
							...InvoicePaymentInsuranceProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					invoicePaymentInsurances: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.invoicePaymentInsurance as InvoicePaymentInsuranceModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: InvoicePaymentInsuranceModel, queryParams?: QueryParams): Observable<PassableStateConfig<InvoicePaymentInsuranceModel>> {
		...
		const successMessage = 'Updated Invoice Payment Insurance entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($invoicePaymentInsurance: InvoicePaymentInsuranceInput!, $persistRelations: Boolean) {
						invoicePaymentInsurance: updateInvoicePaymentInsurance(invoicePaymentInsurance: $invoicePaymentInsurance, persistRelations: $persistRelations) {
							...InvoicePaymentInsuranceProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: InvoicePaymentInsuranceModel[], queryParams?: QueryParams): Observable<PassableStateConfig<InvoicePaymentInsuranceModel>> {
		...
		const successMessage = 'Update Multiple Invoice Payment Insurance entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($invoicePaymentInsurances: [InvoicePaymentInsuranceInput!]!) {
						invoicePaymentInsurance: updateAllInvoicePaymentInsurance(invoicePaymentInsurances: $invoicePaymentInsurances) {
							...InvoicePaymentInsuranceProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<InvoicePaymentInsuranceModel>> {
		...
		const successMessage = 'Deleted Invoice Payment Insurance entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($invoicePaymentInsuranceId: ID!) {
						invoicePaymentInsuranceId: deleteInvoicePaymentInsuranceById(invoicePaymentInsuranceId: $invoicePaymentInsuranceId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.invoicePaymentInsuranceId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<InvoicePaymentInsuranceModel>> {
		...
		const successMessage = 'Deleted selected Invoice Payment Insurance entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($invoicePaymentInsuranceIds: [ID!]!){
						deleteInvoicePaymentInsuranceExcludingIds(invoicePaymentInsuranceIds: $invoicePaymentInsuranceIds)
				...
				`,
				variables: {
					invoicePaymentInsuranceIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.invoicePaymentInsuranceIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<InvoicePaymentInsuranceModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($invoicePaymentInsuranceIds: [ID!]!) {
						invoicePaymentInsuranceIds: deleteAllInvoicePaymentInsuranceByIds(invoicePaymentInsuranceIds: $invoicePaymentInsuranceIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<InvoicePaymentInsuranceModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<InvoicePaymentInsuranceModel>>(
			{
				query: gql`
					query GetAudits {
						audits: invoicePaymentInsuranceAudits {
							entity {
								...InvoicePaymentInsuranceProperties
							}
							timestamp
			...
			map(result => {
				let audits: InvoicePaymentInsuranceModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new InvoicePaymentInsuranceModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<InvoicePaymentInsuranceModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<InvoicePaymentInsuranceModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($invoicePaymentInsuranceId: ID!) {
						audits: invoicePaymentInsuranceAuditsByEntityId(invoicePaymentInsuranceId: $invoicePaymentInsuranceId) {
							entity {
								...InvoicePaymentInsuranceProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<InvoicePaymentInsuranceModel>> {
		const url = environment.API_URL + '/api/invoicepaymentinsurance/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<InvoicePaymentInsuranceModel>> {
		const url = environment.API_URL + '/api/invoicepaymentinsurance/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<InvoicePaymentInsuranceModel>> {
		let apiUrl = environment.API_URL + '/api/invoicepaymentinsurance/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<InvoicePaymentInsuranceModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/invoicepaymentinsurance/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Invoice Payment Insurance entities')),
