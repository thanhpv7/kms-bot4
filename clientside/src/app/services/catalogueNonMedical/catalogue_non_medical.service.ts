...
import {CatalogueNonMedicalModel} from '../../models/catalogueNonMedical/catalogue_non_medical.model';
import {CatalogueNonMedicalModelAudit} from '../../models/catalogueNonMedical/catalogue_non_medical.model.state';
...
/**
 * Catalogue Non Medical service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class CatalogueNonMedicalService extends AbstractHttpService<CatalogueNonMedicalModel, CatalogueNonMedicalModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the CatalogueNonMedicalProperties classFragment here] off begin
			fragment CatalogueNonMedicalProperties on CatalogueNonMedical {
				...CatalogueNonMedicalBaseProperties
				manufacturer
			...
			# % protected region % [Modify the CatalogueNonMedicalProperties classFragment here] end
			${super.fragments('CatalogueNonMedical').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<CatalogueNonMedicalModel>> {
		...
		return  this.apollo.query<PassableStateConfig<CatalogueNonMedicalModel>>(
			{
				query: gql`
					query Count {
						totalCount: countCatalogueNonMedicals
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<CatalogueNonMedicalModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<CatalogueNonMedicalModel>> {
		...
		return this.apollo.query<PassableStateConfig<CatalogueNonMedicalModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						CatalogueNonMedicalById: catalogueNonMedicalById(id: $id) {
							...CatalogueNonMedicalProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.CatalogueNonMedicalById as CatalogueNonMedicalModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<CatalogueNonMedicalModel>> {
		...
		return this.apollo.query<PassableStateConfig<CatalogueNonMedicalModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						catalogueNonMedicals: catalogueNonMedicals(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...CatalogueNonMedicalProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countCatalogueNonMedicals(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.catalogueNonMedicals as CatalogueNonMedicalModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<CatalogueNonMedicalModel>> {
		...
		return this.apollo.query<PassableStateConfig<CatalogueNonMedicalModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						catalogueNonMedicals: lastCatalogueNonMedicals(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...CatalogueNonMedicalProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: CatalogueNonMedicalModel, queryParams?: QueryParams): Observable<PassableStateConfig<CatalogueNonMedicalModel>> {
		...
		const successMessage = 'Created Catalogue Non Medical entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($catalogueNonMedical: CatalogueNonMedicalInput!, $persistRelations: Boolean) {
						catalogueNonMedical: createCatalogueNonMedical(catalogueNonMedical: $catalogueNonMedical, persistRelations: $persistRelations) {
							...CatalogueNonMedicalProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.catalogueNonMedical as CatalogueNonMedicalModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: CatalogueNonMedicalModel[], queryParams?: QueryParams): Observable<PassableStateConfig<CatalogueNonMedicalModel>> {
		...
		const successMessage = 'Created Multiple Catalogue Non Medical entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($catalogueNonMedicals: [CatalogueNonMedicalInput!]!) {
						catalogueNonMedical: createAllCatalogueNonMedical(catalogueNonMedicals: $catalogueNonMedicals) {
							...CatalogueNonMedicalProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					catalogueNonMedicals: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.catalogueNonMedical as CatalogueNonMedicalModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: CatalogueNonMedicalModel, queryParams?: QueryParams): Observable<PassableStateConfig<CatalogueNonMedicalModel>> {
		...
		const successMessage = 'Updated Catalogue Non Medical entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($catalogueNonMedical: CatalogueNonMedicalInput!, $persistRelations: Boolean) {
						catalogueNonMedical: updateCatalogueNonMedical(catalogueNonMedical: $catalogueNonMedical, persistRelations: $persistRelations) {
							...CatalogueNonMedicalProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: CatalogueNonMedicalModel[], queryParams?: QueryParams): Observable<PassableStateConfig<CatalogueNonMedicalModel>> {
		...
		const successMessage = 'Update Multiple Catalogue Non Medical entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($catalogueNonMedicals: [CatalogueNonMedicalInput!]!) {
						catalogueNonMedical: updateAllCatalogueNonMedical(catalogueNonMedicals: $catalogueNonMedicals) {
							...CatalogueNonMedicalProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<CatalogueNonMedicalModel>> {
		...
		const successMessage = 'Deleted Catalogue Non Medical entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($catalogueNonMedicalId: ID!) {
						catalogueNonMedicalId: deleteCatalogueNonMedicalById(catalogueNonMedicalId: $catalogueNonMedicalId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.catalogueNonMedicalId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<CatalogueNonMedicalModel>> {
		...
		const successMessage = 'Deleted selected Catalogue Non Medical entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($catalogueNonMedicalIds: [ID!]!){
						deleteCatalogueNonMedicalExcludingIds(catalogueNonMedicalIds: $catalogueNonMedicalIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.catalogueNonMedicalIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<CatalogueNonMedicalModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($catalogueNonMedicalIds: [ID!]!) {
						catalogueNonMedicalIds: deleteAllCatalogueNonMedicalByIds(catalogueNonMedicalIds: $catalogueNonMedicalIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<CatalogueNonMedicalModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<CatalogueNonMedicalModel>>(
			{
				query: gql`
					query GetAudits {
						audits: catalogueNonMedicalAudits {
							entity {
								...CatalogueNonMedicalProperties
							}
							timestamp
			...
			map(result => {
				let audits: CatalogueNonMedicalModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new CatalogueNonMedicalModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<CatalogueNonMedicalModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<CatalogueNonMedicalModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($catalogueNonMedicalId: ID!) {
						audits: catalogueNonMedicalAuditsByEntityId(catalogueNonMedicalId: $catalogueNonMedicalId) {
							entity {
								...CatalogueNonMedicalProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<CatalogueNonMedicalModel>> {
		const url = environment.API_URL + '/api/cataloguenonmedical/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<CatalogueNonMedicalModel>> {
		const url = environment.API_URL + '/api/cataloguenonmedical/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<CatalogueNonMedicalModel>> {
		let apiUrl = environment.API_URL + '/api/cataloguenonmedical/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<CatalogueNonMedicalModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/cataloguenonmedical/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Catalogue Non Medical entities')),
