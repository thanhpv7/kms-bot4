...
import {ServiceItemAssignmentModel} from '../../models/serviceItemAssignment/service_item_assignment.model';
import {ServiceItemAssignmentModelAudit} from '../../models/serviceItemAssignment/service_item_assignment.model.state';
...
/**
 * Service Item Assignment service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class ServiceItemAssignmentService extends AbstractHttpService<ServiceItemAssignmentModel, ServiceItemAssignmentModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the ServiceItemAssignmentProperties classFragment here] off begin
			fragment ServiceItemAssignmentProperties on ServiceItemAssignment {
				...ServiceItemAssignmentBaseProperties
				assignCode
			}
			# % protected region % [Modify the ServiceItemAssignmentProperties classFragment here] end
			${super.fragments('ServiceItemAssignment').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<ServiceItemAssignmentModel>> {
		...
		return  this.apollo.query<PassableStateConfig<ServiceItemAssignmentModel>>(
			{
				query: gql`
					query Count {
						totalCount: countServiceItemAssignments
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<ServiceItemAssignmentModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<ServiceItemAssignmentModel>> {
		...
		return this.apollo.query<PassableStateConfig<ServiceItemAssignmentModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						ServiceItemAssignmentById: serviceItemAssignmentById(id: $id) {
							...ServiceItemAssignmentProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.ServiceItemAssignmentById as ServiceItemAssignmentModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<ServiceItemAssignmentModel>> {
		...
		return this.apollo.query<PassableStateConfig<ServiceItemAssignmentModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						serviceItemAssignments: serviceItemAssignments(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...ServiceItemAssignmentProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countServiceItemAssignments(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.serviceItemAssignments as ServiceItemAssignmentModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<ServiceItemAssignmentModel>> {
		...
		return this.apollo.query<PassableStateConfig<ServiceItemAssignmentModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						serviceItemAssignments: lastServiceItemAssignments(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...ServiceItemAssignmentProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: ServiceItemAssignmentModel, queryParams?: QueryParams): Observable<PassableStateConfig<ServiceItemAssignmentModel>> {
		...
		const successMessage = 'Created Service Item Assignment entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($serviceItemAssignment: ServiceItemAssignmentInput!, $persistRelations: Boolean) {
						serviceItemAssignment: createServiceItemAssignment(serviceItemAssignment: $serviceItemAssignment, persistRelations: $persistRelations) {
							...ServiceItemAssignmentProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.serviceItemAssignment as ServiceItemAssignmentModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: ServiceItemAssignmentModel[], queryParams?: QueryParams): Observable<PassableStateConfig<ServiceItemAssignmentModel>> {
		...
		const successMessage = 'Created Multiple Service Item Assignment entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($serviceItemAssignments: [ServiceItemAssignmentInput!]!) {
						serviceItemAssignment: createAllServiceItemAssignment(serviceItemAssignments: $serviceItemAssignments) {
							...ServiceItemAssignmentProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					serviceItemAssignments: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.serviceItemAssignment as ServiceItemAssignmentModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: ServiceItemAssignmentModel, queryParams?: QueryParams): Observable<PassableStateConfig<ServiceItemAssignmentModel>> {
		...
		const successMessage = 'Updated Service Item Assignment entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($serviceItemAssignment: ServiceItemAssignmentInput!, $persistRelations: Boolean) {
						serviceItemAssignment: updateServiceItemAssignment(serviceItemAssignment: $serviceItemAssignment, persistRelations: $persistRelations) {
							...ServiceItemAssignmentProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: ServiceItemAssignmentModel[], queryParams?: QueryParams): Observable<PassableStateConfig<ServiceItemAssignmentModel>> {
		...
		const successMessage = 'Update Multiple Service Item Assignment entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($serviceItemAssignments: [ServiceItemAssignmentInput!]!) {
						serviceItemAssignment: updateAllServiceItemAssignment(serviceItemAssignments: $serviceItemAssignments) {
							...ServiceItemAssignmentProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<ServiceItemAssignmentModel>> {
		...
		const successMessage = 'Deleted Service Item Assignment entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($serviceItemAssignmentId: ID!) {
						serviceItemAssignmentId: deleteServiceItemAssignmentById(serviceItemAssignmentId: $serviceItemAssignmentId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.serviceItemAssignmentId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<ServiceItemAssignmentModel>> {
		...
		const successMessage = 'Deleted selected Service Item Assignment entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($serviceItemAssignmentIds: [ID!]!){
						deleteServiceItemAssignmentExcludingIds(serviceItemAssignmentIds: $serviceItemAssignmentIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.serviceItemAssignmentIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<ServiceItemAssignmentModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($serviceItemAssignmentIds: [ID!]!) {
						serviceItemAssignmentIds: deleteAllServiceItemAssignmentByIds(serviceItemAssignmentIds: $serviceItemAssignmentIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<ServiceItemAssignmentModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<ServiceItemAssignmentModel>>(
			{
				query: gql`
					query GetAudits {
						audits: serviceItemAssignmentAudits {
							entity {
								...ServiceItemAssignmentProperties
							}
							timestamp
			...
			map(result => {
				let audits: ServiceItemAssignmentModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new ServiceItemAssignmentModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<ServiceItemAssignmentModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<ServiceItemAssignmentModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($serviceItemAssignmentId: ID!) {
						audits: serviceItemAssignmentAuditsByEntityId(serviceItemAssignmentId: $serviceItemAssignmentId) {
							entity {
								...ServiceItemAssignmentProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<ServiceItemAssignmentModel>> {
		const url = environment.API_URL + '/api/serviceitemassignment/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<ServiceItemAssignmentModel>> {
		const url = environment.API_URL + '/api/serviceitemassignment/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<ServiceItemAssignmentModel>> {
		let apiUrl = environment.API_URL + '/api/serviceitemassignment/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<ServiceItemAssignmentModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/serviceitemassignment/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Service Item Assignment entities')),
