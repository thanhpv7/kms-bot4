...
import {PharmacyUserModel} from '../../models/pharmacyUser/pharmacy_user.model';
import {PharmacyUserModelAudit} from '../../models/pharmacyUser/pharmacy_user.model.state';
...
/**
 * Pharmacy User service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class PharmacyUserService extends UserService<PharmacyUserModel, PharmacyUserModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the PharmacyUserProperties classFragment here] off begin
			fragment PharmacyUserProperties on PharmacyUser {
				...PharmacyUserUserProperties
			}
			# % protected region % [Modify the PharmacyUserProperties classFragment here] end
			${super.fragments('PharmacyUser').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<PharmacyUserModel>> {
		...
		return  this.apollo.query<PassableStateConfig<PharmacyUserModel>>(
			{
				query: gql`
					query Count {
						totalCount: countPharmacyUsers
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<PharmacyUserModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<PharmacyUserModel>> {
		...
		return this.apollo.query<PassableStateConfig<PharmacyUserModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						PharmacyUserById: pharmacyUserById(id: $id) {
							...PharmacyUserProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.PharmacyUserById as PharmacyUserModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PharmacyUserModel>> {
		...
		return this.apollo.query<PassableStateConfig<PharmacyUserModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						pharmacyUsers: pharmacyUsers(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...PharmacyUserProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countPharmacyUsers(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.pharmacyUsers as PharmacyUserModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PharmacyUserModel>> {
		...
		return this.apollo.query<PassableStateConfig<PharmacyUserModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						pharmacyUsers: lastPharmacyUsers(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...PharmacyUserProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: PharmacyUserModel, queryParams?: QueryParams): Observable<PassableStateConfig<PharmacyUserModel>> {
		...
		const successMessage = 'Created Pharmacy User entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($pharmacyUser: PharmacyUserInput!, $persistRelations: Boolean) {
						pharmacyUser: createPharmacyUser(pharmacyUser: $pharmacyUser, persistRelations: $persistRelations) {
							...PharmacyUserProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.pharmacyUser as PharmacyUserModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: PharmacyUserModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PharmacyUserModel>> {
		...
		const successMessage = 'Created Multiple Pharmacy User entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($pharmacyUsers: [PharmacyUserInput!]!) {
						pharmacyUser: createAllPharmacyUser(pharmacyUsers: $pharmacyUsers) {
							...PharmacyUserProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					pharmacyUsers: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.pharmacyUser as PharmacyUserModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: PharmacyUserModel, queryParams?: QueryParams): Observable<PassableStateConfig<PharmacyUserModel>> {
		...
		const successMessage = 'Updated Pharmacy User entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($pharmacyUser: PharmacyUserInput!, $persistRelations: Boolean) {
						pharmacyUser: updatePharmacyUser(pharmacyUser: $pharmacyUser, persistRelations: $persistRelations) {
							...PharmacyUserProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: PharmacyUserModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PharmacyUserModel>> {
		...
		const successMessage = 'Update Multiple Pharmacy User entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($pharmacyUsers: [PharmacyUserInput!]!) {
						pharmacyUser: updateAllPharmacyUser(pharmacyUsers: $pharmacyUsers) {
							...PharmacyUserProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<PharmacyUserModel>> {
		...
		const successMessage = 'Deleted Pharmacy User entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($pharmacyUserId: ID!) {
						pharmacyUserId: deletePharmacyUserById(pharmacyUserId: $pharmacyUserId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.pharmacyUserId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<PharmacyUserModel>> {
		...
		const successMessage = 'Deleted selected Pharmacy User entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($pharmacyUserIds: [ID!]!){
						deletePharmacyUserExcludingIds(pharmacyUserIds: $pharmacyUserIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.pharmacyUserIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<PharmacyUserModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($pharmacyUserIds: [ID!]!) {
						pharmacyUserIds: deleteAllPharmacyUserByIds(pharmacyUserIds: $pharmacyUserIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<PharmacyUserModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PharmacyUserModel>>(
			...
			map(result => {
				let audits: PharmacyUserModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new PharmacyUserModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<PharmacyUserModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PharmacyUserModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($pharmacyUserId: ID!) {
						audits: pharmacyUserAuditsByEntityId(pharmacyUserId: $pharmacyUserId) {
							entity {
								...PharmacyUserProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<PharmacyUserModel>> {
		const url = environment.API_URL + '/api/pharmacyuser/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<PharmacyUserModel>> {
		const url = environment.API_URL + '/api/pharmacyuser/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<PharmacyUserModel>> {
		let apiUrl = environment.API_URL + '/api/pharmacyuser/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<PharmacyUserModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/pharmacyuser/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Pharmacy User entities')),
