...
import {BpjsListTaskModel} from '../../models/bpjsListTask/bpjs_list_task.model';
import {BpjsListTaskModelAudit} from '../../models/bpjsListTask/bpjs_list_task.model.state';
...
/**
 * BPJS List Task service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BpjsListTaskService extends AbstractHttpService<BpjsListTaskModel, BpjsListTaskModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BpjsListTaskProperties classFragment here] off begin
			fragment BpjsListTaskProperties on BpjsListTask {
				...BpjsListTaskBaseProperties
				kodebooking
				taskname
				taskid
				waktu
			...
			# % protected region % [Modify the BpjsListTaskProperties classFragment here] end
			${super.fragments('BpjsListTask').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BpjsListTaskModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BpjsListTaskModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBpjsListTasks
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BpjsListTaskModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsListTaskModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsListTaskModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BpjsListTaskById: bpjsListTaskById(id: $id) {
							...BpjsListTaskProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BpjsListTaskById as BpjsListTaskModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsListTaskModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsListTaskModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						bpjsListTasks: bpjsListTasks(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BpjsListTaskProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBpjsListTasks(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.bpjsListTasks as BpjsListTaskModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsListTaskModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsListTaskModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						bpjsListTasks: lastBpjsListTasks(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BpjsListTaskProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BpjsListTaskModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsListTaskModel>> {
		...
		const successMessage = 'Created BPJS List Task entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($bpjsListTask: BpjsListTaskInput!, $persistRelations: Boolean) {
						bpjsListTask: createBpjsListTask(bpjsListTask: $bpjsListTask, persistRelations: $persistRelations) {
							...BpjsListTaskProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.bpjsListTask as BpjsListTaskModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BpjsListTaskModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsListTaskModel>> {
		...
		const successMessage = 'Created Multiple BPJS List Task entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($bpjsListTasks: [BpjsListTaskInput!]!) {
						bpjsListTask: createAllBpjsListTask(bpjsListTasks: $bpjsListTasks) {
							...BpjsListTaskProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					bpjsListTasks: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.bpjsListTask as BpjsListTaskModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BpjsListTaskModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsListTaskModel>> {
		...
		const successMessage = 'Updated BPJS List Task entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($bpjsListTask: BpjsListTaskInput!, $persistRelations: Boolean) {
						bpjsListTask: updateBpjsListTask(bpjsListTask: $bpjsListTask, persistRelations: $persistRelations) {
							...BpjsListTaskProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BpjsListTaskModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsListTaskModel>> {
		...
		const successMessage = 'Update Multiple BPJS List Task entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($bpjsListTasks: [BpjsListTaskInput!]!) {
						bpjsListTask: updateAllBpjsListTask(bpjsListTasks: $bpjsListTasks) {
							...BpjsListTaskProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BpjsListTaskModel>> {
		...
		const successMessage = 'Deleted BPJS List Task entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($bpjsListTaskId: ID!) {
						bpjsListTaskId: deleteBpjsListTaskById(bpjsListTaskId: $bpjsListTaskId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.bpjsListTaskId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsListTaskModel>> {
		...
		const successMessage = 'Deleted selected BPJS List Task entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($bpjsListTaskIds: [ID!]!){
						deleteBpjsListTaskExcludingIds(bpjsListTaskIds: $bpjsListTaskIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.bpjsListTaskIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BpjsListTaskModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($bpjsListTaskIds: [ID!]!) {
						bpjsListTaskIds: deleteAllBpjsListTaskByIds(bpjsListTaskIds: $bpjsListTaskIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BpjsListTaskModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsListTaskModel>>(
			...
			map(result => {
				let audits: BpjsListTaskModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BpjsListTaskModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BpjsListTaskModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsListTaskModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($bpjsListTaskId: ID!) {
						audits: bpjsListTaskAuditsByEntityId(bpjsListTaskId: $bpjsListTaskId) {
							entity {
								...BpjsListTaskProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BpjsListTaskModel>> {
		const url = environment.API_URL + '/api/bpjslisttask/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BpjsListTaskModel>> {
		const url = environment.API_URL + '/api/bpjslisttask/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsListTaskModel>> {
		let apiUrl = environment.API_URL + '/api/bpjslisttask/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BpjsListTaskModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/bpjslisttask/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' BPJS List Task entities')),
