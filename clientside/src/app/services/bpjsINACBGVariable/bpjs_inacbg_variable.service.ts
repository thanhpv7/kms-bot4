...
import {BpjsINACBGVariableModel} from '../../models/bpjsINACBGVariable/bpjs_inacbg_variable.model';
import {BpjsINACBGVariableModelAudit} from '../../models/bpjsINACBGVariable/bpjs_inacbg_variable.model.state';
...
/**
 * BPJS INACBG Variable service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BpjsINACBGVariableService extends AbstractHttpService<BpjsINACBGVariableModel, BpjsINACBGVariableModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BpjsINACBGVariableProperties classFragment here] off begin
			fragment BpjsINACBGVariableProperties on BpjsINACBGVariable {
				...BpjsINACBGVariableBaseProperties
				variableCode
				english
				indonesian
				notes
			}
			# % protected region % [Modify the BpjsINACBGVariableProperties classFragment here] end
			${super.fragments('BpjsINACBGVariable').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BpjsINACBGVariableModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BpjsINACBGVariableModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBpjsINACBGVariables
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BpjsINACBGVariableModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsINACBGVariableModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsINACBGVariableModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BpjsINACBGVariableById: bpjsINACBGVariableById(id: $id) {
							...BpjsINACBGVariableProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BpjsINACBGVariableById as BpjsINACBGVariableModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsINACBGVariableModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsINACBGVariableModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						bpjsINACBGVariables: bpjsINACBGVariables(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BpjsINACBGVariableProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBpjsINACBGVariables(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.bpjsINACBGVariables as BpjsINACBGVariableModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsINACBGVariableModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsINACBGVariableModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						bpjsINACBGVariables: lastBpjsINACBGVariables(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BpjsINACBGVariableProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BpjsINACBGVariableModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsINACBGVariableModel>> {
		...
		const successMessage = 'Created BPJS INACBG Variable entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($bpjsINACBGVariable: BpjsINACBGVariableInput!, $persistRelations: Boolean) {
						bpjsINACBGVariable: createBpjsINACBGVariable(bpjsINACBGVariable: $bpjsINACBGVariable, persistRelations: $persistRelations) {
							...BpjsINACBGVariableProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.bpjsINACBGVariable as BpjsINACBGVariableModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BpjsINACBGVariableModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsINACBGVariableModel>> {
		...
		const successMessage = 'Created Multiple BPJS INACBG Variable entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($bpjsINACBGVariables: [BpjsINACBGVariableInput!]!) {
						bpjsINACBGVariable: createAllBpjsINACBGVariable(bpjsINACBGVariables: $bpjsINACBGVariables) {
							...BpjsINACBGVariableProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					bpjsINACBGVariables: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.bpjsINACBGVariable as BpjsINACBGVariableModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BpjsINACBGVariableModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsINACBGVariableModel>> {
		...
		const successMessage = 'Updated BPJS INACBG Variable entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($bpjsINACBGVariable: BpjsINACBGVariableInput!, $persistRelations: Boolean) {
						bpjsINACBGVariable: updateBpjsINACBGVariable(bpjsINACBGVariable: $bpjsINACBGVariable, persistRelations: $persistRelations) {
							...BpjsINACBGVariableProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BpjsINACBGVariableModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsINACBGVariableModel>> {
		...
		const successMessage = 'Update Multiple BPJS INACBG Variable entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($bpjsINACBGVariables: [BpjsINACBGVariableInput!]!) {
						bpjsINACBGVariable: updateAllBpjsINACBGVariable(bpjsINACBGVariables: $bpjsINACBGVariables) {
							...BpjsINACBGVariableProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BpjsINACBGVariableModel>> {
		...
		const successMessage = 'Deleted BPJS INACBG Variable entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($bpjsINACBGVariableId: ID!) {
						bpjsINACBGVariableId: deleteBpjsINACBGVariableById(bpjsINACBGVariableId: $bpjsINACBGVariableId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.bpjsINACBGVariableId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsINACBGVariableModel>> {
		...
		const successMessage = 'Deleted selected BPJS INACBG Variable entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($bpjsINACBGVariableIds: [ID!]!){
						deleteBpjsINACBGVariableExcludingIds(bpjsINACBGVariableIds: $bpjsINACBGVariableIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.bpjsINACBGVariableIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BpjsINACBGVariableModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($bpjsINACBGVariableIds: [ID!]!) {
						bpjsINACBGVariableIds: deleteAllBpjsINACBGVariableByIds(bpjsINACBGVariableIds: $bpjsINACBGVariableIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BpjsINACBGVariableModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsINACBGVariableModel>>(
			{
				query: gql`
					query GetAudits {
						audits: bpjsINACBGVariableAudits {
							entity {
								...BpjsINACBGVariableProperties
							}
							timestamp
			...
			map(result => {
				let audits: BpjsINACBGVariableModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BpjsINACBGVariableModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BpjsINACBGVariableModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsINACBGVariableModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($bpjsINACBGVariableId: ID!) {
						audits: bpjsINACBGVariableAuditsByEntityId(bpjsINACBGVariableId: $bpjsINACBGVariableId) {
							entity {
								...BpjsINACBGVariableProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BpjsINACBGVariableModel>> {
		const url = environment.API_URL + '/api/bpjsinacbgvariable/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BpjsINACBGVariableModel>> {
		const url = environment.API_URL + '/api/bpjsinacbgvariable/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsINACBGVariableModel>> {
		let apiUrl = environment.API_URL + '/api/bpjsinacbgvariable/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BpjsINACBGVariableModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/bpjsinacbgvariable/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' BPJS INACBG Variable entities')),
