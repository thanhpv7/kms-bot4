...
import {WarehouseInitialStockModelAudit} from '../../models/warehouseInitialStock/warehouse_initial_stock.model.state';
...
/**
 * Warehouse Initial Stock  service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class WarehouseInitialStockService extends AbstractHttpService<WarehouseInitialStockModel, WarehouseInitialStockModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the WarehouseInitialStockProperties classFragment here] off begin
			fragment WarehouseInitialStockProperties on WarehouseInitialStock {
				...WarehouseInitialStockBaseProperties
				minimumLevel
				maximumLevel
			}
			# % protected region % [Modify the WarehouseInitialStockProperties classFragment here] end
			${super.fragments('WarehouseInitialStock').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<WarehouseInitialStockModel>> {
		...
		return  this.apollo.query<PassableStateConfig<WarehouseInitialStockModel>>(
			{
				query: gql`
					query Count {
						totalCount: countWarehouseInitialStocks
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<WarehouseInitialStockModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<WarehouseInitialStockModel>> {
		...
		return this.apollo.query<PassableStateConfig<WarehouseInitialStockModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						WarehouseInitialStockById: warehouseInitialStockById(id: $id) {
							...WarehouseInitialStockProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.WarehouseInitialStockById as WarehouseInitialStockModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<WarehouseInitialStockModel>> {
		...
		return this.apollo.query<PassableStateConfig<WarehouseInitialStockModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						warehouseInitialStocks: warehouseInitialStocks(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...WarehouseInitialStockProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countWarehouseInitialStocks(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.warehouseInitialStocks as WarehouseInitialStockModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<WarehouseInitialStockModel>> {
		...
		return this.apollo.query<PassableStateConfig<WarehouseInitialStockModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						warehouseInitialStocks: lastWarehouseInitialStocks(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...WarehouseInitialStockProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: WarehouseInitialStockModel, queryParams?: QueryParams): Observable<PassableStateConfig<WarehouseInitialStockModel>> {
		...
		const successMessage = 'Created Warehouse Initial Stock  entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($warehouseInitialStock: WarehouseInitialStockInput!, $persistRelations: Boolean) {
						warehouseInitialStock: createWarehouseInitialStock(warehouseInitialStock: $warehouseInitialStock, persistRelations: $persistRelations) {
							...WarehouseInitialStockProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.warehouseInitialStock as WarehouseInitialStockModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: WarehouseInitialStockModel[], queryParams?: QueryParams): Observable<PassableStateConfig<WarehouseInitialStockModel>> {
		...
		const successMessage = 'Created Multiple Warehouse Initial Stock  entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($warehouseInitialStocks: [WarehouseInitialStockInput!]!) {
						warehouseInitialStock: createAllWarehouseInitialStock(warehouseInitialStocks: $warehouseInitialStocks) {
							...WarehouseInitialStockProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					warehouseInitialStocks: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.warehouseInitialStock as WarehouseInitialStockModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: WarehouseInitialStockModel, queryParams?: QueryParams): Observable<PassableStateConfig<WarehouseInitialStockModel>> {
		...
		const successMessage = 'Updated Warehouse Initial Stock  entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($warehouseInitialStock: WarehouseInitialStockInput!, $persistRelations: Boolean) {
						warehouseInitialStock: updateWarehouseInitialStock(warehouseInitialStock: $warehouseInitialStock, persistRelations: $persistRelations) {
							...WarehouseInitialStockProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: WarehouseInitialStockModel[], queryParams?: QueryParams): Observable<PassableStateConfig<WarehouseInitialStockModel>> {
		...
		const successMessage = 'Update Multiple Warehouse Initial Stock  entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($warehouseInitialStocks: [WarehouseInitialStockInput!]!) {
						warehouseInitialStock: updateAllWarehouseInitialStock(warehouseInitialStocks: $warehouseInitialStocks) {
							...WarehouseInitialStockProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<WarehouseInitialStockModel>> {
		...
		const successMessage = 'Deleted Warehouse Initial Stock  entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($warehouseInitialStockId: ID!) {
						warehouseInitialStockId: deleteWarehouseInitialStockById(warehouseInitialStockId: $warehouseInitialStockId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.warehouseInitialStockId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<WarehouseInitialStockModel>> {
		...
		const successMessage = 'Deleted selected Warehouse Initial Stock  entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($warehouseInitialStockIds: [ID!]!){
						deleteWarehouseInitialStockExcludingIds(warehouseInitialStockIds: $warehouseInitialStockIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.warehouseInitialStockIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<WarehouseInitialStockModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($warehouseInitialStockIds: [ID!]!) {
						warehouseInitialStockIds: deleteAllWarehouseInitialStockByIds(warehouseInitialStockIds: $warehouseInitialStockIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<WarehouseInitialStockModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<WarehouseInitialStockModel>>(
			{
				query: gql`
					query GetAudits {
						audits: warehouseInitialStockAudits {
							entity {
								...WarehouseInitialStockProperties
							}
							timestamp
			...
			map(result => {
				let audits: WarehouseInitialStockModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new WarehouseInitialStockModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<WarehouseInitialStockModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<WarehouseInitialStockModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($warehouseInitialStockId: ID!) {
						audits: warehouseInitialStockAuditsByEntityId(warehouseInitialStockId: $warehouseInitialStockId) {
							entity {
								...WarehouseInitialStockProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<WarehouseInitialStockModel>> {
		const url = environment.API_URL + '/api/warehouseinitialstock/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<WarehouseInitialStockModel>> {
		const url = environment.API_URL + '/api/warehouseinitialstock/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<WarehouseInitialStockModel>> {
		let apiUrl = environment.API_URL + '/api/warehouseinitialstock/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<WarehouseInitialStockModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/warehouseinitialstock/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Warehouse Initial Stock  entities')),
