...
import {MedicalTranscriberUserModelAudit} from '../../models/medicalTranscriberUser/medical_transcriber_user.model.state';
...
/**
 * Medical Transcriber User service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class MedicalTranscriberUserService extends UserService<MedicalTranscriberUserModel, MedicalTranscriberUserModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the MedicalTranscriberUserProperties classFragment here] off begin
			fragment MedicalTranscriberUserProperties on MedicalTranscriberUser {
				...MedicalTranscriberUserUserProperties
			}
			# % protected region % [Modify the MedicalTranscriberUserProperties classFragment here] end
			${super.fragments('MedicalTranscriberUser').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<MedicalTranscriberUserModel>> {
		...
		return  this.apollo.query<PassableStateConfig<MedicalTranscriberUserModel>>(
			{
				query: gql`
					query Count {
						totalCount: countMedicalTranscriberUsers
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<MedicalTranscriberUserModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<MedicalTranscriberUserModel>> {
		...
		return this.apollo.query<PassableStateConfig<MedicalTranscriberUserModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						MedicalTranscriberUserById: medicalTranscriberUserById(id: $id) {
							...MedicalTranscriberUserProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.MedicalTranscriberUserById as MedicalTranscriberUserModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<MedicalTranscriberUserModel>> {
		...
		return this.apollo.query<PassableStateConfig<MedicalTranscriberUserModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						medicalTranscriberUsers: medicalTranscriberUsers(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...MedicalTranscriberUserProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countMedicalTranscriberUsers(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.medicalTranscriberUsers as MedicalTranscriberUserModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<MedicalTranscriberUserModel>> {
		...
		return this.apollo.query<PassableStateConfig<MedicalTranscriberUserModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						medicalTranscriberUsers: lastMedicalTranscriberUsers(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...MedicalTranscriberUserProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: MedicalTranscriberUserModel, queryParams?: QueryParams): Observable<PassableStateConfig<MedicalTranscriberUserModel>> {
		...
		const successMessage = 'Created Medical Transcriber User entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($medicalTranscriberUser: MedicalTranscriberUserInput!, $persistRelations: Boolean) {
						medicalTranscriberUser: createMedicalTranscriberUser(medicalTranscriberUser: $medicalTranscriberUser, persistRelations: $persistRelations) {
							...MedicalTranscriberUserProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.medicalTranscriberUser as MedicalTranscriberUserModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: MedicalTranscriberUserModel[], queryParams?: QueryParams): Observable<PassableStateConfig<MedicalTranscriberUserModel>> {
		...
		const successMessage = 'Created Multiple Medical Transcriber User entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($medicalTranscriberUsers: [MedicalTranscriberUserInput!]!) {
						medicalTranscriberUser: createAllMedicalTranscriberUser(medicalTranscriberUsers: $medicalTranscriberUsers) {
							...MedicalTranscriberUserProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					medicalTranscriberUsers: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.medicalTranscriberUser as MedicalTranscriberUserModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: MedicalTranscriberUserModel, queryParams?: QueryParams): Observable<PassableStateConfig<MedicalTranscriberUserModel>> {
		...
		const successMessage = 'Updated Medical Transcriber User entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($medicalTranscriberUser: MedicalTranscriberUserInput!, $persistRelations: Boolean) {
						medicalTranscriberUser: updateMedicalTranscriberUser(medicalTranscriberUser: $medicalTranscriberUser, persistRelations: $persistRelations) {
							...MedicalTranscriberUserProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: MedicalTranscriberUserModel[], queryParams?: QueryParams): Observable<PassableStateConfig<MedicalTranscriberUserModel>> {
		...
		const successMessage = 'Update Multiple Medical Transcriber User entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($medicalTranscriberUsers: [MedicalTranscriberUserInput!]!) {
						medicalTranscriberUser: updateAllMedicalTranscriberUser(medicalTranscriberUsers: $medicalTranscriberUsers) {
							...MedicalTranscriberUserProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<MedicalTranscriberUserModel>> {
		...
		const successMessage = 'Deleted Medical Transcriber User entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($medicalTranscriberUserId: ID!) {
						medicalTranscriberUserId: deleteMedicalTranscriberUserById(medicalTranscriberUserId: $medicalTranscriberUserId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.medicalTranscriberUserId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<MedicalTranscriberUserModel>> {
		...
		const successMessage = 'Deleted selected Medical Transcriber User entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($medicalTranscriberUserIds: [ID!]!){
						deleteMedicalTranscriberUserExcludingIds(medicalTranscriberUserIds: $medicalTranscriberUserIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.medicalTranscriberUserIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<MedicalTranscriberUserModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($medicalTranscriberUserIds: [ID!]!) {
						medicalTranscriberUserIds: deleteAllMedicalTranscriberUserByIds(medicalTranscriberUserIds: $medicalTranscriberUserIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<MedicalTranscriberUserModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<MedicalTranscriberUserModel>>(
			{
				query: gql`
					query GetAudits {
						audits: medicalTranscriberUserAudits {
							entity {
								...MedicalTranscriberUserProperties
							}
							timestamp
			...
			map(result => {
				let audits: MedicalTranscriberUserModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new MedicalTranscriberUserModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<MedicalTranscriberUserModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<MedicalTranscriberUserModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($medicalTranscriberUserId: ID!) {
						audits: medicalTranscriberUserAuditsByEntityId(medicalTranscriberUserId: $medicalTranscriberUserId) {
							entity {
								...MedicalTranscriberUserProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<MedicalTranscriberUserModel>> {
		const url = environment.API_URL + '/api/medicaltranscriberuser/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<MedicalTranscriberUserModel>> {
		const url = environment.API_URL + '/api/medicaltranscriberuser/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<MedicalTranscriberUserModel>> {
		let apiUrl = environment.API_URL + '/api/medicaltranscriberuser/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<MedicalTranscriberUserModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/medicaltranscriberuser/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Medical Transcriber User entities')),
