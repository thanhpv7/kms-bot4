...
import {BpjsGeneralModel} from '../../models/bpjsGeneral/bpjs_general.model';
import {BpjsGeneralModelAudit} from '../../models/bpjsGeneral/bpjs_general.model.state';
...
/**
 * BPJS General service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BpjsGeneralService extends AbstractHttpService<BpjsGeneralModel, BpjsGeneralModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BpjsGeneralProperties classFragment here] off begin
			fragment BpjsGeneralProperties on BpjsGeneral {
				...BpjsGeneralBaseProperties
				consID
				secretKey
				bpjsWebServiceURL
			...
			# % protected region % [Modify the BpjsGeneralProperties classFragment here] end
			${super.fragments('BpjsGeneral').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BpjsGeneralModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BpjsGeneralModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBpjsGenerals
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BpjsGeneralModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsGeneralModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsGeneralModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BpjsGeneralById: bpjsGeneralById(id: $id) {
							...BpjsGeneralProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BpjsGeneralById as BpjsGeneralModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsGeneralModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsGeneralModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						bpjsGenerals: bpjsGenerals(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BpjsGeneralProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBpjsGenerals(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.bpjsGenerals as BpjsGeneralModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsGeneralModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsGeneralModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						bpjsGenerals: lastBpjsGenerals(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BpjsGeneralProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BpjsGeneralModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsGeneralModel>> {
		...
		const successMessage = 'Created BPJS General entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($bpjsGeneral: BpjsGeneralInput!, $persistRelations: Boolean) {
						bpjsGeneral: createBpjsGeneral(bpjsGeneral: $bpjsGeneral, persistRelations: $persistRelations) {
							...BpjsGeneralProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.bpjsGeneral as BpjsGeneralModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BpjsGeneralModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsGeneralModel>> {
		...
		const successMessage = 'Created Multiple BPJS General entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($bpjsGenerals: [BpjsGeneralInput!]!) {
						bpjsGeneral: createAllBpjsGeneral(bpjsGenerals: $bpjsGenerals) {
							...BpjsGeneralProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					bpjsGenerals: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.bpjsGeneral as BpjsGeneralModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BpjsGeneralModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsGeneralModel>> {
		...
		const successMessage = 'Updated BPJS General entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($bpjsGeneral: BpjsGeneralInput!, $persistRelations: Boolean) {
						bpjsGeneral: updateBpjsGeneral(bpjsGeneral: $bpjsGeneral, persistRelations: $persistRelations) {
							...BpjsGeneralProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BpjsGeneralModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsGeneralModel>> {
		...
		const successMessage = 'Update Multiple BPJS General entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($bpjsGenerals: [BpjsGeneralInput!]!) {
						bpjsGeneral: updateAllBpjsGeneral(bpjsGenerals: $bpjsGenerals) {
							...BpjsGeneralProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BpjsGeneralModel>> {
		...
		const successMessage = 'Deleted BPJS General entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($bpjsGeneralId: ID!) {
						bpjsGeneralId: deleteBpjsGeneralById(bpjsGeneralId: $bpjsGeneralId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.bpjsGeneralId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsGeneralModel>> {
		...
		const successMessage = 'Deleted selected BPJS General entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($bpjsGeneralIds: [ID!]!){
						deleteBpjsGeneralExcludingIds(bpjsGeneralIds: $bpjsGeneralIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.bpjsGeneralIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BpjsGeneralModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($bpjsGeneralIds: [ID!]!) {
						bpjsGeneralIds: deleteAllBpjsGeneralByIds(bpjsGeneralIds: $bpjsGeneralIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BpjsGeneralModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsGeneralModel>>(
			...
			map(result => {
				let audits: BpjsGeneralModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BpjsGeneralModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BpjsGeneralModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsGeneralModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($bpjsGeneralId: ID!) {
						audits: bpjsGeneralAuditsByEntityId(bpjsGeneralId: $bpjsGeneralId) {
							entity {
								...BpjsGeneralProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BpjsGeneralModel>> {
		const url = environment.API_URL + '/api/bpjsgeneral/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BpjsGeneralModel>> {
		const url = environment.API_URL + '/api/bpjsgeneral/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsGeneralModel>> {
		let apiUrl = environment.API_URL + '/api/bpjsgeneral/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BpjsGeneralModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/bpjsgeneral/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' BPJS General entities')),
