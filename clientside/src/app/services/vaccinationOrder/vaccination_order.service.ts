...
import {VaccinationOrderModel} from '../../models/vaccinationOrder/vaccination_order.model';
import {VaccinationOrderModelAudit} from '../../models/vaccinationOrder/vaccination_order.model.state';
...
/**
 * Vaccination Order service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class VaccinationOrderService extends AbstractHttpService<VaccinationOrderModel, VaccinationOrderModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the VaccinationOrderProperties classFragment here] off begin
			fragment VaccinationOrderProperties on VaccinationOrder {
				...VaccinationOrderBaseProperties
				vaccinationLocation
				vaccinationReaction
				purpose
				vaccinationNotes
			...
			# % protected region % [Modify the VaccinationOrderProperties classFragment here] end
			${super.fragments('VaccinationOrder').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<VaccinationOrderModel>> {
		...
		return  this.apollo.query<PassableStateConfig<VaccinationOrderModel>>(
			{
				query: gql`
					query Count {
						totalCount: countVaccinationOrders
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<VaccinationOrderModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<VaccinationOrderModel>> {
		...
		return this.apollo.query<PassableStateConfig<VaccinationOrderModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						VaccinationOrderById: vaccinationOrderById(id: $id) {
							...VaccinationOrderProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.VaccinationOrderById as VaccinationOrderModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<VaccinationOrderModel>> {
		...
		return this.apollo.query<PassableStateConfig<VaccinationOrderModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						vaccinationOrders: vaccinationOrders(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...VaccinationOrderProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countVaccinationOrders(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.vaccinationOrders as VaccinationOrderModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<VaccinationOrderModel>> {
		...
		return this.apollo.query<PassableStateConfig<VaccinationOrderModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						vaccinationOrders: lastVaccinationOrders(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...VaccinationOrderProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: VaccinationOrderModel, queryParams?: QueryParams): Observable<PassableStateConfig<VaccinationOrderModel>> {
		...
		const successMessage = 'Created Vaccination Order entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($vaccinationOrder: VaccinationOrderInput!, $persistRelations: Boolean) {
						vaccinationOrder: createVaccinationOrder(vaccinationOrder: $vaccinationOrder, persistRelations: $persistRelations) {
							...VaccinationOrderProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.vaccinationOrder as VaccinationOrderModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: VaccinationOrderModel[], queryParams?: QueryParams): Observable<PassableStateConfig<VaccinationOrderModel>> {
		...
		const successMessage = 'Created Multiple Vaccination Order entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($vaccinationOrders: [VaccinationOrderInput!]!) {
						vaccinationOrder: createAllVaccinationOrder(vaccinationOrders: $vaccinationOrders) {
							...VaccinationOrderProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					vaccinationOrders: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.vaccinationOrder as VaccinationOrderModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: VaccinationOrderModel, queryParams?: QueryParams): Observable<PassableStateConfig<VaccinationOrderModel>> {
		...
		const successMessage = 'Updated Vaccination Order entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($vaccinationOrder: VaccinationOrderInput!, $persistRelations: Boolean) {
						vaccinationOrder: updateVaccinationOrder(vaccinationOrder: $vaccinationOrder, persistRelations: $persistRelations) {
							...VaccinationOrderProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: VaccinationOrderModel[], queryParams?: QueryParams): Observable<PassableStateConfig<VaccinationOrderModel>> {
		...
		const successMessage = 'Update Multiple Vaccination Order entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($vaccinationOrders: [VaccinationOrderInput!]!) {
						vaccinationOrder: updateAllVaccinationOrder(vaccinationOrders: $vaccinationOrders) {
							...VaccinationOrderProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<VaccinationOrderModel>> {
		...
		const successMessage = 'Deleted Vaccination Order entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($vaccinationOrderId: ID!) {
						vaccinationOrderId: deleteVaccinationOrderById(vaccinationOrderId: $vaccinationOrderId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.vaccinationOrderId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<VaccinationOrderModel>> {
		...
		const successMessage = 'Deleted selected Vaccination Order entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($vaccinationOrderIds: [ID!]!){
						deleteVaccinationOrderExcludingIds(vaccinationOrderIds: $vaccinationOrderIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.vaccinationOrderIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<VaccinationOrderModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($vaccinationOrderIds: [ID!]!) {
						vaccinationOrderIds: deleteAllVaccinationOrderByIds(vaccinationOrderIds: $vaccinationOrderIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<VaccinationOrderModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<VaccinationOrderModel>>(
			...
			map(result => {
				let audits: VaccinationOrderModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new VaccinationOrderModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<VaccinationOrderModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<VaccinationOrderModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($vaccinationOrderId: ID!) {
						audits: vaccinationOrderAuditsByEntityId(vaccinationOrderId: $vaccinationOrderId) {
							entity {
								...VaccinationOrderProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<VaccinationOrderModel>> {
		const url = environment.API_URL + '/api/vaccinationorder/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<VaccinationOrderModel>> {
		const url = environment.API_URL + '/api/vaccinationorder/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<VaccinationOrderModel>> {
		let apiUrl = environment.API_URL + '/api/vaccinationorder/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<VaccinationOrderModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/vaccinationorder/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Vaccination Order entities')),
