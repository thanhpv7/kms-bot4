...
import {BpjsAccidentMasterModelAudit} from '../../models/bpjsAccidentMaster/bpjs_accident_master.model.state';
...
/**
 * BPJS Accident Master service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BpjsAccidentMasterService extends AbstractHttpService<BpjsAccidentMasterModel, BpjsAccidentMasterModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BpjsAccidentMasterProperties classFragment here] off begin
			fragment BpjsAccidentMasterProperties on BpjsAccidentMaster {
				...BpjsAccidentMasterBaseProperties
				nosep
				tglkejadian
				ppkpelsep
				kdprop
			...
			# % protected region % [Modify the BpjsAccidentMasterProperties classFragment here] end
			${super.fragments('BpjsAccidentMaster').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BpjsAccidentMasterModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BpjsAccidentMasterModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBpjsAccidentMasters
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BpjsAccidentMasterModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsAccidentMasterModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsAccidentMasterModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BpjsAccidentMasterById: bpjsAccidentMasterById(id: $id) {
							...BpjsAccidentMasterProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BpjsAccidentMasterById as BpjsAccidentMasterModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsAccidentMasterModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsAccidentMasterModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						bpjsAccidentMasters: bpjsAccidentMasters(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BpjsAccidentMasterProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBpjsAccidentMasters(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.bpjsAccidentMasters as BpjsAccidentMasterModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsAccidentMasterModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsAccidentMasterModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						bpjsAccidentMasters: lastBpjsAccidentMasters(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BpjsAccidentMasterProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BpjsAccidentMasterModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsAccidentMasterModel>> {
		...
		const successMessage = 'Created BPJS Accident Master entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($bpjsAccidentMaster: BpjsAccidentMasterInput!, $persistRelations: Boolean) {
						bpjsAccidentMaster: createBpjsAccidentMaster(bpjsAccidentMaster: $bpjsAccidentMaster, persistRelations: $persistRelations) {
							...BpjsAccidentMasterProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.bpjsAccidentMaster as BpjsAccidentMasterModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BpjsAccidentMasterModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsAccidentMasterModel>> {
		...
		const successMessage = 'Created Multiple BPJS Accident Master entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($bpjsAccidentMasters: [BpjsAccidentMasterInput!]!) {
						bpjsAccidentMaster: createAllBpjsAccidentMaster(bpjsAccidentMasters: $bpjsAccidentMasters) {
							...BpjsAccidentMasterProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					bpjsAccidentMasters: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.bpjsAccidentMaster as BpjsAccidentMasterModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BpjsAccidentMasterModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsAccidentMasterModel>> {
		...
		const successMessage = 'Updated BPJS Accident Master entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($bpjsAccidentMaster: BpjsAccidentMasterInput!, $persistRelations: Boolean) {
						bpjsAccidentMaster: updateBpjsAccidentMaster(bpjsAccidentMaster: $bpjsAccidentMaster, persistRelations: $persistRelations) {
							...BpjsAccidentMasterProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BpjsAccidentMasterModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsAccidentMasterModel>> {
		...
		const successMessage = 'Update Multiple BPJS Accident Master entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($bpjsAccidentMasters: [BpjsAccidentMasterInput!]!) {
						bpjsAccidentMaster: updateAllBpjsAccidentMaster(bpjsAccidentMasters: $bpjsAccidentMasters) {
							...BpjsAccidentMasterProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BpjsAccidentMasterModel>> {
		...
		const successMessage = 'Deleted BPJS Accident Master entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($bpjsAccidentMasterId: ID!) {
						bpjsAccidentMasterId: deleteBpjsAccidentMasterById(bpjsAccidentMasterId: $bpjsAccidentMasterId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.bpjsAccidentMasterId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsAccidentMasterModel>> {
		...
		const successMessage = 'Deleted selected BPJS Accident Master entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($bpjsAccidentMasterIds: [ID!]!){
						deleteBpjsAccidentMasterExcludingIds(bpjsAccidentMasterIds: $bpjsAccidentMasterIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.bpjsAccidentMasterIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BpjsAccidentMasterModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($bpjsAccidentMasterIds: [ID!]!) {
						bpjsAccidentMasterIds: deleteAllBpjsAccidentMasterByIds(bpjsAccidentMasterIds: $bpjsAccidentMasterIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BpjsAccidentMasterModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsAccidentMasterModel>>(
			{
				query: gql`
					query GetAudits {
						audits: bpjsAccidentMasterAudits {
							entity {
								...BpjsAccidentMasterProperties
							}
							timestamp
			...
			map(result => {
				let audits: BpjsAccidentMasterModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BpjsAccidentMasterModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BpjsAccidentMasterModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsAccidentMasterModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($bpjsAccidentMasterId: ID!) {
						audits: bpjsAccidentMasterAuditsByEntityId(bpjsAccidentMasterId: $bpjsAccidentMasterId) {
							entity {
								...BpjsAccidentMasterProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BpjsAccidentMasterModel>> {
		const url = environment.API_URL + '/api/bpjsaccidentmaster/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BpjsAccidentMasterModel>> {
		const url = environment.API_URL + '/api/bpjsaccidentmaster/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsAccidentMasterModel>> {
		let apiUrl = environment.API_URL + '/api/bpjsaccidentmaster/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BpjsAccidentMasterModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/bpjsaccidentmaster/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' BPJS Accident Master entities')),
