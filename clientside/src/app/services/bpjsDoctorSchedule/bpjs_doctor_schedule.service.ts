...
import {BpjsDoctorScheduleModel} from '../../models/bpjsDoctorSchedule/bpjs_doctor_schedule.model';
import {BpjsDoctorScheduleModelAudit} from '../../models/bpjsDoctorSchedule/bpjs_doctor_schedule.model.state';
...
/**
 * BPJS Doctor Schedule service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BpjsDoctorScheduleService extends AbstractHttpService<BpjsDoctorScheduleModel, BpjsDoctorScheduleModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BpjsDoctorScheduleProperties classFragment here] off begin
			fragment BpjsDoctorScheduleProperties on BpjsDoctorSchedule {
				...BpjsDoctorScheduleBaseProperties
				hari
				namaHari
				kapasitas
				jknQuota
			...
			# % protected region % [Modify the BpjsDoctorScheduleProperties classFragment here] end
			${super.fragments('BpjsDoctorSchedule').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BpjsDoctorScheduleModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BpjsDoctorScheduleModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBpjsDoctorSchedules
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BpjsDoctorScheduleModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsDoctorScheduleModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsDoctorScheduleModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BpjsDoctorScheduleById: bpjsDoctorScheduleById(id: $id) {
							...BpjsDoctorScheduleProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BpjsDoctorScheduleById as BpjsDoctorScheduleModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsDoctorScheduleModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsDoctorScheduleModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						bpjsDoctorSchedules: bpjsDoctorSchedules(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BpjsDoctorScheduleProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBpjsDoctorSchedules(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.bpjsDoctorSchedules as BpjsDoctorScheduleModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsDoctorScheduleModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsDoctorScheduleModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						bpjsDoctorSchedules: lastBpjsDoctorSchedules(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BpjsDoctorScheduleProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BpjsDoctorScheduleModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsDoctorScheduleModel>> {
		...
		const successMessage = 'Created BPJS Doctor Schedule entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($bpjsDoctorSchedule: BpjsDoctorScheduleInput!, $persistRelations: Boolean) {
						bpjsDoctorSchedule: createBpjsDoctorSchedule(bpjsDoctorSchedule: $bpjsDoctorSchedule, persistRelations: $persistRelations) {
							...BpjsDoctorScheduleProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.bpjsDoctorSchedule as BpjsDoctorScheduleModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BpjsDoctorScheduleModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsDoctorScheduleModel>> {
		...
		const successMessage = 'Created Multiple BPJS Doctor Schedule entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($bpjsDoctorSchedules: [BpjsDoctorScheduleInput!]!) {
						bpjsDoctorSchedule: createAllBpjsDoctorSchedule(bpjsDoctorSchedules: $bpjsDoctorSchedules) {
							...BpjsDoctorScheduleProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					bpjsDoctorSchedules: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.bpjsDoctorSchedule as BpjsDoctorScheduleModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BpjsDoctorScheduleModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsDoctorScheduleModel>> {
		...
		const successMessage = 'Updated BPJS Doctor Schedule entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($bpjsDoctorSchedule: BpjsDoctorScheduleInput!, $persistRelations: Boolean) {
						bpjsDoctorSchedule: updateBpjsDoctorSchedule(bpjsDoctorSchedule: $bpjsDoctorSchedule, persistRelations: $persistRelations) {
							...BpjsDoctorScheduleProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BpjsDoctorScheduleModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsDoctorScheduleModel>> {
		...
		const successMessage = 'Update Multiple BPJS Doctor Schedule entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($bpjsDoctorSchedules: [BpjsDoctorScheduleInput!]!) {
						bpjsDoctorSchedule: updateAllBpjsDoctorSchedule(bpjsDoctorSchedules: $bpjsDoctorSchedules) {
							...BpjsDoctorScheduleProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BpjsDoctorScheduleModel>> {
		...
		const successMessage = 'Deleted BPJS Doctor Schedule entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($bpjsDoctorScheduleId: ID!) {
						bpjsDoctorScheduleId: deleteBpjsDoctorScheduleById(bpjsDoctorScheduleId: $bpjsDoctorScheduleId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.bpjsDoctorScheduleId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsDoctorScheduleModel>> {
		...
		const successMessage = 'Deleted selected BPJS Doctor Schedule entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($bpjsDoctorScheduleIds: [ID!]!){
						deleteBpjsDoctorScheduleExcludingIds(bpjsDoctorScheduleIds: $bpjsDoctorScheduleIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.bpjsDoctorScheduleIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BpjsDoctorScheduleModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($bpjsDoctorScheduleIds: [ID!]!) {
						bpjsDoctorScheduleIds: deleteAllBpjsDoctorScheduleByIds(bpjsDoctorScheduleIds: $bpjsDoctorScheduleIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BpjsDoctorScheduleModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsDoctorScheduleModel>>(
			{
				query: gql`
					query GetAudits {
						audits: bpjsDoctorScheduleAudits {
							entity {
								...BpjsDoctorScheduleProperties
							}
							timestamp
			...
			map(result => {
				let audits: BpjsDoctorScheduleModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BpjsDoctorScheduleModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BpjsDoctorScheduleModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsDoctorScheduleModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($bpjsDoctorScheduleId: ID!) {
						audits: bpjsDoctorScheduleAuditsByEntityId(bpjsDoctorScheduleId: $bpjsDoctorScheduleId) {
							entity {
								...BpjsDoctorScheduleProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BpjsDoctorScheduleModel>> {
		const url = environment.API_URL + '/api/bpjsdoctorschedule/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BpjsDoctorScheduleModel>> {
		const url = environment.API_URL + '/api/bpjsdoctorschedule/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsDoctorScheduleModel>> {
		let apiUrl = environment.API_URL + '/api/bpjsdoctorschedule/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BpjsDoctorScheduleModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/bpjsdoctorschedule/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' BPJS Doctor Schedule entities')),
