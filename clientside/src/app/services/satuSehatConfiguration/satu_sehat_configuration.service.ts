...
import {SatuSehatConfigurationModelAudit} from '../../models/satuSehatConfiguration/satu_sehat_configuration.model.state';
...
/**
 * Satu Sehat Configuration service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class SatuSehatConfigurationService extends AbstractHttpService<SatuSehatConfigurationModel, SatuSehatConfigurationModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the SatuSehatConfigurationProperties classFragment here] off begin
			fragment SatuSehatConfigurationProperties on SatuSehatConfiguration {
				...SatuSehatConfigurationBaseProperties
				organizationID
				clientID
				secretKey
				tokenRequest
			...
			# % protected region % [Modify the SatuSehatConfigurationProperties classFragment here] end
			${super.fragments('SatuSehatConfiguration').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<SatuSehatConfigurationModel>> {
		...
		return  this.apollo.query<PassableStateConfig<SatuSehatConfigurationModel>>(
			{
				query: gql`
					query Count {
						totalCount: countSatuSehatConfigurations
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<SatuSehatConfigurationModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<SatuSehatConfigurationModel>> {
		...
		return this.apollo.query<PassableStateConfig<SatuSehatConfigurationModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						SatuSehatConfigurationById: satuSehatConfigurationById(id: $id) {
							...SatuSehatConfigurationProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.SatuSehatConfigurationById as SatuSehatConfigurationModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<SatuSehatConfigurationModel>> {
		...
		return this.apollo.query<PassableStateConfig<SatuSehatConfigurationModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						satuSehatConfigurations: satuSehatConfigurations(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...SatuSehatConfigurationProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countSatuSehatConfigurations(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.satuSehatConfigurations as SatuSehatConfigurationModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<SatuSehatConfigurationModel>> {
		...
		return this.apollo.query<PassableStateConfig<SatuSehatConfigurationModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						satuSehatConfigurations: lastSatuSehatConfigurations(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...SatuSehatConfigurationProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: SatuSehatConfigurationModel, queryParams?: QueryParams): Observable<PassableStateConfig<SatuSehatConfigurationModel>> {
		...
		const successMessage = 'Created Satu Sehat Configuration entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($satuSehatConfiguration: SatuSehatConfigurationInput!, $persistRelations: Boolean) {
						satuSehatConfiguration: createSatuSehatConfiguration(satuSehatConfiguration: $satuSehatConfiguration, persistRelations: $persistRelations) {
							...SatuSehatConfigurationProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.satuSehatConfiguration as SatuSehatConfigurationModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: SatuSehatConfigurationModel[], queryParams?: QueryParams): Observable<PassableStateConfig<SatuSehatConfigurationModel>> {
		...
		const successMessage = 'Created Multiple Satu Sehat Configuration entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($satuSehatConfigurations: [SatuSehatConfigurationInput!]!) {
						satuSehatConfiguration: createAllSatuSehatConfiguration(satuSehatConfigurations: $satuSehatConfigurations) {
							...SatuSehatConfigurationProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					satuSehatConfigurations: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.satuSehatConfiguration as SatuSehatConfigurationModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: SatuSehatConfigurationModel, queryParams?: QueryParams): Observable<PassableStateConfig<SatuSehatConfigurationModel>> {
		...
		const successMessage = 'Updated Satu Sehat Configuration entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($satuSehatConfiguration: SatuSehatConfigurationInput!, $persistRelations: Boolean) {
						satuSehatConfiguration: updateSatuSehatConfiguration(satuSehatConfiguration: $satuSehatConfiguration, persistRelations: $persistRelations) {
							...SatuSehatConfigurationProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: SatuSehatConfigurationModel[], queryParams?: QueryParams): Observable<PassableStateConfig<SatuSehatConfigurationModel>> {
		...
		const successMessage = 'Update Multiple Satu Sehat Configuration entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($satuSehatConfigurations: [SatuSehatConfigurationInput!]!) {
						satuSehatConfiguration: updateAllSatuSehatConfiguration(satuSehatConfigurations: $satuSehatConfigurations) {
							...SatuSehatConfigurationProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<SatuSehatConfigurationModel>> {
		...
		const successMessage = 'Deleted Satu Sehat Configuration entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($satuSehatConfigurationId: ID!) {
						satuSehatConfigurationId: deleteSatuSehatConfigurationById(satuSehatConfigurationId: $satuSehatConfigurationId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.satuSehatConfigurationId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<SatuSehatConfigurationModel>> {
		...
		const successMessage = 'Deleted selected Satu Sehat Configuration entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($satuSehatConfigurationIds: [ID!]!){
						deleteSatuSehatConfigurationExcludingIds(satuSehatConfigurationIds: $satuSehatConfigurationIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.satuSehatConfigurationIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<SatuSehatConfigurationModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($satuSehatConfigurationIds: [ID!]!) {
						satuSehatConfigurationIds: deleteAllSatuSehatConfigurationByIds(satuSehatConfigurationIds: $satuSehatConfigurationIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<SatuSehatConfigurationModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<SatuSehatConfigurationModel>>(
			{
				query: gql`
					query GetAudits {
						audits: satuSehatConfigurationAudits {
							entity {
								...SatuSehatConfigurationProperties
							}
							timestamp
			...
			map(result => {
				let audits: SatuSehatConfigurationModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new SatuSehatConfigurationModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<SatuSehatConfigurationModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<SatuSehatConfigurationModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($satuSehatConfigurationId: ID!) {
						audits: satuSehatConfigurationAuditsByEntityId(satuSehatConfigurationId: $satuSehatConfigurationId) {
							entity {
								...SatuSehatConfigurationProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<SatuSehatConfigurationModel>> {
		const url = environment.API_URL + '/api/satusehatconfiguration/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<SatuSehatConfigurationModel>> {
		const url = environment.API_URL + '/api/satusehatconfiguration/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<SatuSehatConfigurationModel>> {
		let apiUrl = environment.API_URL + '/api/satusehatconfiguration/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<SatuSehatConfigurationModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/satusehatconfiguration/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Satu Sehat Configuration entities')),
