...
import {PatientDetailAddressModelAudit} from '../../models/patientDetailAddress/patient_detail_address.model.state';
...
/**
 * Patient Detail Address service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class PatientDetailAddressService extends AbstractHttpService<PatientDetailAddressModel, PatientDetailAddressModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the PatientDetailAddressProperties classFragment here] off begin
			fragment PatientDetailAddressProperties on PatientDetailAddress {
				...PatientDetailAddressBaseProperties
				country
				state
				regency
				district
			...
			# % protected region % [Modify the PatientDetailAddressProperties classFragment here] end
			${super.fragments('PatientDetailAddress').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<PatientDetailAddressModel>> {
		...
		return  this.apollo.query<PassableStateConfig<PatientDetailAddressModel>>(
			{
				query: gql`
					query Count {
						totalCount: countPatientDetailAddresss
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<PatientDetailAddressModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<PatientDetailAddressModel>> {
		...
		return this.apollo.query<PassableStateConfig<PatientDetailAddressModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						PatientDetailAddressById: patientDetailAddressById(id: $id) {
							...PatientDetailAddressProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.PatientDetailAddressById as PatientDetailAddressModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PatientDetailAddressModel>> {
		...
		return this.apollo.query<PassableStateConfig<PatientDetailAddressModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						patientDetailAddresss: patientDetailAddresss(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...PatientDetailAddressProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countPatientDetailAddresss(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.patientDetailAddresss as PatientDetailAddressModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PatientDetailAddressModel>> {
		...
		return this.apollo.query<PassableStateConfig<PatientDetailAddressModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						patientDetailAddresss: lastPatientDetailAddresss(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...PatientDetailAddressProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: PatientDetailAddressModel, queryParams?: QueryParams): Observable<PassableStateConfig<PatientDetailAddressModel>> {
		...
		const successMessage = 'Created Patient Detail Address entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($patientDetailAddress: PatientDetailAddressInput!, $persistRelations: Boolean) {
						patientDetailAddress: createPatientDetailAddress(patientDetailAddress: $patientDetailAddress, persistRelations: $persistRelations) {
							...PatientDetailAddressProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.patientDetailAddress as PatientDetailAddressModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: PatientDetailAddressModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PatientDetailAddressModel>> {
		...
		const successMessage = 'Created Multiple Patient Detail Address entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($patientDetailAddresss: [PatientDetailAddressInput!]!) {
						patientDetailAddress: createAllPatientDetailAddress(patientDetailAddresss: $patientDetailAddresss) {
							...PatientDetailAddressProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					patientDetailAddresss: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.patientDetailAddress as PatientDetailAddressModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: PatientDetailAddressModel, queryParams?: QueryParams): Observable<PassableStateConfig<PatientDetailAddressModel>> {
		...
		const successMessage = 'Updated Patient Detail Address entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($patientDetailAddress: PatientDetailAddressInput!, $persistRelations: Boolean) {
						patientDetailAddress: updatePatientDetailAddress(patientDetailAddress: $patientDetailAddress, persistRelations: $persistRelations) {
							...PatientDetailAddressProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: PatientDetailAddressModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PatientDetailAddressModel>> {
		...
		const successMessage = 'Update Multiple Patient Detail Address entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($patientDetailAddresss: [PatientDetailAddressInput!]!) {
						patientDetailAddress: updateAllPatientDetailAddress(patientDetailAddresss: $patientDetailAddresss) {
							...PatientDetailAddressProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<PatientDetailAddressModel>> {
		...
		const successMessage = 'Deleted Patient Detail Address entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($patientDetailAddressId: ID!) {
						patientDetailAddressId: deletePatientDetailAddressById(patientDetailAddressId: $patientDetailAddressId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.patientDetailAddressId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<PatientDetailAddressModel>> {
		...
		const successMessage = 'Deleted selected Patient Detail Address entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($patientDetailAddressIds: [ID!]!){
						deletePatientDetailAddressExcludingIds(patientDetailAddressIds: $patientDetailAddressIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.patientDetailAddressIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<PatientDetailAddressModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($patientDetailAddressIds: [ID!]!) {
						patientDetailAddressIds: deleteAllPatientDetailAddressByIds(patientDetailAddressIds: $patientDetailAddressIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<PatientDetailAddressModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PatientDetailAddressModel>>(
			{
				query: gql`
					query GetAudits {
						audits: patientDetailAddressAudits {
							entity {
								...PatientDetailAddressProperties
							}
							timestamp
			...
			map(result => {
				let audits: PatientDetailAddressModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new PatientDetailAddressModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<PatientDetailAddressModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PatientDetailAddressModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($patientDetailAddressId: ID!) {
						audits: patientDetailAddressAuditsByEntityId(patientDetailAddressId: $patientDetailAddressId) {
							entity {
								...PatientDetailAddressProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<PatientDetailAddressModel>> {
		const url = environment.API_URL + '/api/patientdetailaddress/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<PatientDetailAddressModel>> {
		const url = environment.API_URL + '/api/patientdetailaddress/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<PatientDetailAddressModel>> {
		let apiUrl = environment.API_URL + '/api/patientdetailaddress/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<PatientDetailAddressModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/patientdetailaddress/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Patient Detail Address entities')),
