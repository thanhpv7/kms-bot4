...
import {MedicalRecordNextVerificationChecklistModelAudit} from '../../models/medicalRecordNextVerificationChecklist/medical_record_next_verification_checklist.model.state';
...
/**
 * Medical Record Next Verification Checklist service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class MedicalRecordNextVerificationChecklistService extends AbstractHttpService<MedicalRecordNextVerificationChecklistModel, MedicalRecordNextVerificationChecklistModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the MedicalRecordNextVerificationChecklistProperties classFragment here] off begin
			fragment MedicalRecordNextVerificationChecklistProperties on MedicalRecordNextVerificationChecklist {
				...MedicalRecordNextVerificationChecklistBaseProperties
				outVitalSign
				outAnamnesis
				outPhysicalExamination
				outDiagnosis
				outDismissalType
				outDismissalDateAndTime
				inpVitalSign
				inpDailyCareDoctorNotes
				inpDailyCareDoctorNotesNA
				inpDailyCareNursingNotes
				inpDailyCareNursingNotesNA
				inpDailyCareProgressNotes
				inpDailyCareProgressNotesNA
				inpDismissalDiagnosis
				inpDismissalType
				inpDismissalDateAndTime
				inpDismissalCondition
				drAdmissionDiagnosis
				drObservationDoctorNotes
				drObservationDoctorNotesNA
				drObservationNursingNotes
				drObservationNursingNotesNA
				drObservationProgressNotes
				drObservationProgressNotesNA
				drDismissalDiagnosis
				drDismissalType
				drDismissalDateAndTime
				otPreOperativeDiagnosis
				otPreOperativeNotesSurgery
				otPreOperativeNotesAnaesthesiology
				otIntraOperativeNotesSurgery
				otIntraOperativeNotesAnaesthesiology
				otPostOperativeNotesSurgery
				otPostOperativeNotesAnaesthesiology
				otPostOperativeDiagnosis
				otDismissalType
				otDismissalDateAndTime
				dsResponsibleStaff
				dsInterpretation
				notes
			}
			# % protected region % [Modify the MedicalRecordNextVerificationChecklistProperties classFragment here] end
			${super.fragments('MedicalRecordNextVerificationChecklist').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<MedicalRecordNextVerificationChecklistModel>> {
		...
		return  this.apollo.query<PassableStateConfig<MedicalRecordNextVerificationChecklistModel>>(
			{
				query: gql`
					query Count {
						totalCount: countMedicalRecordNextVerificationChecklists
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<MedicalRecordNextVerificationChecklistModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<MedicalRecordNextVerificationChecklistModel>> {
		...
		return this.apollo.query<PassableStateConfig<MedicalRecordNextVerificationChecklistModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						MedicalRecordNextVerificationChecklistById: medicalRecordNextVerificationChecklistById(id: $id) {
							...MedicalRecordNextVerificationChecklistProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.MedicalRecordNextVerificationChecklistById as MedicalRecordNextVerificationChecklistModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<MedicalRecordNextVerificationChecklistModel>> {
		...
		return this.apollo.query<PassableStateConfig<MedicalRecordNextVerificationChecklistModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						medicalRecordNextVerificationChecklists: medicalRecordNextVerificationChecklists(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...MedicalRecordNextVerificationChecklistProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countMedicalRecordNextVerificationChecklists(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.medicalRecordNextVerificationChecklists as MedicalRecordNextVerificationChecklistModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<MedicalRecordNextVerificationChecklistModel>> {
		...
		return this.apollo.query<PassableStateConfig<MedicalRecordNextVerificationChecklistModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						medicalRecordNextVerificationChecklists: lastMedicalRecordNextVerificationChecklists(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...MedicalRecordNextVerificationChecklistProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: MedicalRecordNextVerificationChecklistModel, queryParams?: QueryParams): Observable<PassableStateConfig<MedicalRecordNextVerificationChecklistModel>> {
		...
		const successMessage = 'Created Medical Record Next Verification Checklist entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($medicalRecordNextVerificationChecklist: MedicalRecordNextVerificationChecklistInput!, $persistRelations: Boolean) {
						medicalRecordNextVerificationChecklist: createMedicalRecordNextVerificationChecklist(medicalRecordNextVerificationChecklist: $medicalRecordNextVerificationChecklist, persistRelations: $persistRelations) {
							...MedicalRecordNextVerificationChecklistProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.medicalRecordNextVerificationChecklist as MedicalRecordNextVerificationChecklistModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: MedicalRecordNextVerificationChecklistModel[], queryParams?: QueryParams): Observable<PassableStateConfig<MedicalRecordNextVerificationChecklistModel>> {
		...
		const successMessage = 'Created Multiple Medical Record Next Verification Checklist entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($medicalRecordNextVerificationChecklists: [MedicalRecordNextVerificationChecklistInput!]!) {
						medicalRecordNextVerificationChecklist: createAllMedicalRecordNextVerificationChecklist(medicalRecordNextVerificationChecklists: $medicalRecordNextVerificationChecklists) {
							...MedicalRecordNextVerificationChecklistProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					medicalRecordNextVerificationChecklists: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.medicalRecordNextVerificationChecklist as MedicalRecordNextVerificationChecklistModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: MedicalRecordNextVerificationChecklistModel, queryParams?: QueryParams): Observable<PassableStateConfig<MedicalRecordNextVerificationChecklistModel>> {
		...
		const successMessage = 'Updated Medical Record Next Verification Checklist entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($medicalRecordNextVerificationChecklist: MedicalRecordNextVerificationChecklistInput!, $persistRelations: Boolean) {
						medicalRecordNextVerificationChecklist: updateMedicalRecordNextVerificationChecklist(medicalRecordNextVerificationChecklist: $medicalRecordNextVerificationChecklist, persistRelations: $persistRelations) {
							...MedicalRecordNextVerificationChecklistProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: MedicalRecordNextVerificationChecklistModel[], queryParams?: QueryParams): Observable<PassableStateConfig<MedicalRecordNextVerificationChecklistModel>> {
		...
		const successMessage = 'Update Multiple Medical Record Next Verification Checklist entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($medicalRecordNextVerificationChecklists: [MedicalRecordNextVerificationChecklistInput!]!) {
						medicalRecordNextVerificationChecklist: updateAllMedicalRecordNextVerificationChecklist(medicalRecordNextVerificationChecklists: $medicalRecordNextVerificationChecklists) {
							...MedicalRecordNextVerificationChecklistProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<MedicalRecordNextVerificationChecklistModel>> {
		...
		const successMessage = 'Deleted Medical Record Next Verification Checklist entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($medicalRecordNextVerificationChecklistId: ID!) {
						medicalRecordNextVerificationChecklistId: deleteMedicalRecordNextVerificationChecklistById(medicalRecordNextVerificationChecklistId: $medicalRecordNextVerificationChecklistId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.medicalRecordNextVerificationChecklistId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<MedicalRecordNextVerificationChecklistModel>> {
		...
		const successMessage = 'Deleted selected Medical Record Next Verification Checklist entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($medicalRecordNextVerificationChecklistIds: [ID!]!){
						deleteMedicalRecordNextVerificationChecklistExcludingIds(medicalRecordNextVerificationChecklistIds: $medicalRecordNextVerificationChecklistIds)
				...
				`,
				variables: {
					medicalRecordNextVerificationChecklistIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.medicalRecordNextVerificationChecklistIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<MedicalRecordNextVerificationChecklistModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($medicalRecordNextVerificationChecklistIds: [ID!]!) {
						medicalRecordNextVerificationChecklistIds: deleteAllMedicalRecordNextVerificationChecklistByIds(medicalRecordNextVerificationChecklistIds: $medicalRecordNextVerificationChecklistIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<MedicalRecordNextVerificationChecklistModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<MedicalRecordNextVerificationChecklistModel>>(
			{
				query: gql`
					query GetAudits {
						audits: medicalRecordNextVerificationChecklistAudits {
							entity {
								...MedicalRecordNextVerificationChecklistProperties
							}
							timestamp
			...
			map(result => {
				let audits: MedicalRecordNextVerificationChecklistModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new MedicalRecordNextVerificationChecklistModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<MedicalRecordNextVerificationChecklistModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<MedicalRecordNextVerificationChecklistModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($medicalRecordNextVerificationChecklistId: ID!) {
						audits: medicalRecordNextVerificationChecklistAuditsByEntityId(medicalRecordNextVerificationChecklistId: $medicalRecordNextVerificationChecklistId) {
							entity {
								...MedicalRecordNextVerificationChecklistProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<MedicalRecordNextVerificationChecklistModel>> {
		const url = environment.API_URL + '/api/medicalrecordnextverificationchecklist/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<MedicalRecordNextVerificationChecklistModel>> {
		const url = environment.API_URL + '/api/medicalrecordnextverificationchecklist/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<MedicalRecordNextVerificationChecklistModel>> {
		let apiUrl = environment.API_URL + '/api/medicalrecordnextverificationchecklist/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<MedicalRecordNextVerificationChecklistModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/medicalrecordnextverificationchecklist/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Medical Record Next Verification Checklist entities')),
