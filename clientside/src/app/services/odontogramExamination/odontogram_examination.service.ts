...
import {OdontogramExaminationModel} from '../../models/odontogramExamination/odontogram_examination.model';
import {OdontogramExaminationModelAudit} from '../../models/odontogramExamination/odontogram_examination.model.state';
...
/**
 * Odontogram Examination service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class OdontogramExaminationService extends AbstractHttpService<OdontogramExaminationModel, OdontogramExaminationModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the OdontogramExaminationProperties classFragment here] off begin
			fragment OdontogramExaminationProperties on OdontogramExamination {
				...OdontogramExaminationBaseProperties
				odontogramData
				isPermanent
			}
			# % protected region % [Modify the OdontogramExaminationProperties classFragment here] end
			${super.fragments('OdontogramExamination').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<OdontogramExaminationModel>> {
		...
		return  this.apollo.query<PassableStateConfig<OdontogramExaminationModel>>(
			{
				query: gql`
					query Count {
						totalCount: countOdontogramExaminations
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<OdontogramExaminationModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<OdontogramExaminationModel>> {
		...
		return this.apollo.query<PassableStateConfig<OdontogramExaminationModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						OdontogramExaminationById: odontogramExaminationById(id: $id) {
							...OdontogramExaminationProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.OdontogramExaminationById as OdontogramExaminationModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<OdontogramExaminationModel>> {
		...
		return this.apollo.query<PassableStateConfig<OdontogramExaminationModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						odontogramExaminations: odontogramExaminations(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...OdontogramExaminationProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countOdontogramExaminations(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.odontogramExaminations as OdontogramExaminationModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<OdontogramExaminationModel>> {
		...
		return this.apollo.query<PassableStateConfig<OdontogramExaminationModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						odontogramExaminations: lastOdontogramExaminations(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...OdontogramExaminationProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: OdontogramExaminationModel, queryParams?: QueryParams): Observable<PassableStateConfig<OdontogramExaminationModel>> {
		...
		const successMessage = 'Created Odontogram Examination entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($odontogramExamination: OdontogramExaminationInput!, $persistRelations: Boolean) {
						odontogramExamination: createOdontogramExamination(odontogramExamination: $odontogramExamination, persistRelations: $persistRelations) {
							...OdontogramExaminationProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.odontogramExamination as OdontogramExaminationModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: OdontogramExaminationModel[], queryParams?: QueryParams): Observable<PassableStateConfig<OdontogramExaminationModel>> {
		...
		const successMessage = 'Created Multiple Odontogram Examination entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($odontogramExaminations: [OdontogramExaminationInput!]!) {
						odontogramExamination: createAllOdontogramExamination(odontogramExaminations: $odontogramExaminations) {
							...OdontogramExaminationProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					odontogramExaminations: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.odontogramExamination as OdontogramExaminationModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: OdontogramExaminationModel, queryParams?: QueryParams): Observable<PassableStateConfig<OdontogramExaminationModel>> {
		...
		const successMessage = 'Updated Odontogram Examination entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($odontogramExamination: OdontogramExaminationInput!, $persistRelations: Boolean) {
						odontogramExamination: updateOdontogramExamination(odontogramExamination: $odontogramExamination, persistRelations: $persistRelations) {
							...OdontogramExaminationProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: OdontogramExaminationModel[], queryParams?: QueryParams): Observable<PassableStateConfig<OdontogramExaminationModel>> {
		...
		const successMessage = 'Update Multiple Odontogram Examination entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($odontogramExaminations: [OdontogramExaminationInput!]!) {
						odontogramExamination: updateAllOdontogramExamination(odontogramExaminations: $odontogramExaminations) {
							...OdontogramExaminationProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<OdontogramExaminationModel>> {
		...
		const successMessage = 'Deleted Odontogram Examination entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($odontogramExaminationId: ID!) {
						odontogramExaminationId: deleteOdontogramExaminationById(odontogramExaminationId: $odontogramExaminationId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.odontogramExaminationId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<OdontogramExaminationModel>> {
		...
		const successMessage = 'Deleted selected Odontogram Examination entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($odontogramExaminationIds: [ID!]!){
						deleteOdontogramExaminationExcludingIds(odontogramExaminationIds: $odontogramExaminationIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.odontogramExaminationIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<OdontogramExaminationModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($odontogramExaminationIds: [ID!]!) {
						odontogramExaminationIds: deleteAllOdontogramExaminationByIds(odontogramExaminationIds: $odontogramExaminationIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<OdontogramExaminationModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<OdontogramExaminationModel>>(
			{
				query: gql`
					query GetAudits {
						audits: odontogramExaminationAudits {
							entity {
								...OdontogramExaminationProperties
							}
							timestamp
			...
			map(result => {
				let audits: OdontogramExaminationModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new OdontogramExaminationModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<OdontogramExaminationModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<OdontogramExaminationModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($odontogramExaminationId: ID!) {
						audits: odontogramExaminationAuditsByEntityId(odontogramExaminationId: $odontogramExaminationId) {
							entity {
								...OdontogramExaminationProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<OdontogramExaminationModel>> {
		const url = environment.API_URL + '/api/odontogramexamination/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<OdontogramExaminationModel>> {
		const url = environment.API_URL + '/api/odontogramexamination/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<OdontogramExaminationModel>> {
		let apiUrl = environment.API_URL + '/api/odontogramexamination/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<OdontogramExaminationModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/odontogramexamination/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Odontogram Examination entities')),
