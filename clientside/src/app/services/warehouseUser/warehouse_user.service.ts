...
import {WarehouseUserModel} from '../../models/warehouseUser/warehouse_user.model';
import {WarehouseUserModelAudit} from '../../models/warehouseUser/warehouse_user.model.state';
...
/**
 * Warehouse User service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class WarehouseUserService extends UserService<WarehouseUserModel, WarehouseUserModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the WarehouseUserProperties classFragment here] off begin
			fragment WarehouseUserProperties on WarehouseUser {
				...WarehouseUserUserProperties
			}
			# % protected region % [Modify the WarehouseUserProperties classFragment here] end
			${super.fragments('WarehouseUser').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<WarehouseUserModel>> {
		...
		return  this.apollo.query<PassableStateConfig<WarehouseUserModel>>(
			{
				query: gql`
					query Count {
						totalCount: countWarehouseUsers
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<WarehouseUserModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<WarehouseUserModel>> {
		...
		return this.apollo.query<PassableStateConfig<WarehouseUserModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						WarehouseUserById: warehouseUserById(id: $id) {
							...WarehouseUserProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.WarehouseUserById as WarehouseUserModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<WarehouseUserModel>> {
		...
		return this.apollo.query<PassableStateConfig<WarehouseUserModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						warehouseUsers: warehouseUsers(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...WarehouseUserProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countWarehouseUsers(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.warehouseUsers as WarehouseUserModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<WarehouseUserModel>> {
		...
		return this.apollo.query<PassableStateConfig<WarehouseUserModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						warehouseUsers: lastWarehouseUsers(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...WarehouseUserProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: WarehouseUserModel, queryParams?: QueryParams): Observable<PassableStateConfig<WarehouseUserModel>> {
		...
		const successMessage = 'Created Warehouse User entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($warehouseUser: WarehouseUserInput!, $persistRelations: Boolean) {
						warehouseUser: createWarehouseUser(warehouseUser: $warehouseUser, persistRelations: $persistRelations) {
							...WarehouseUserProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.warehouseUser as WarehouseUserModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: WarehouseUserModel[], queryParams?: QueryParams): Observable<PassableStateConfig<WarehouseUserModel>> {
		...
		const successMessage = 'Created Multiple Warehouse User entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($warehouseUsers: [WarehouseUserInput!]!) {
						warehouseUser: createAllWarehouseUser(warehouseUsers: $warehouseUsers) {
							...WarehouseUserProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					warehouseUsers: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.warehouseUser as WarehouseUserModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: WarehouseUserModel, queryParams?: QueryParams): Observable<PassableStateConfig<WarehouseUserModel>> {
		...
		const successMessage = 'Updated Warehouse User entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($warehouseUser: WarehouseUserInput!, $persistRelations: Boolean) {
						warehouseUser: updateWarehouseUser(warehouseUser: $warehouseUser, persistRelations: $persistRelations) {
							...WarehouseUserProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: WarehouseUserModel[], queryParams?: QueryParams): Observable<PassableStateConfig<WarehouseUserModel>> {
		...
		const successMessage = 'Update Multiple Warehouse User entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($warehouseUsers: [WarehouseUserInput!]!) {
						warehouseUser: updateAllWarehouseUser(warehouseUsers: $warehouseUsers) {
							...WarehouseUserProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<WarehouseUserModel>> {
		...
		const successMessage = 'Deleted Warehouse User entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($warehouseUserId: ID!) {
						warehouseUserId: deleteWarehouseUserById(warehouseUserId: $warehouseUserId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.warehouseUserId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<WarehouseUserModel>> {
		...
		const successMessage = 'Deleted selected Warehouse User entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($warehouseUserIds: [ID!]!){
						deleteWarehouseUserExcludingIds(warehouseUserIds: $warehouseUserIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.warehouseUserIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<WarehouseUserModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($warehouseUserIds: [ID!]!) {
						warehouseUserIds: deleteAllWarehouseUserByIds(warehouseUserIds: $warehouseUserIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<WarehouseUserModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<WarehouseUserModel>>(
			...
			map(result => {
				let audits: WarehouseUserModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new WarehouseUserModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<WarehouseUserModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<WarehouseUserModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($warehouseUserId: ID!) {
						audits: warehouseUserAuditsByEntityId(warehouseUserId: $warehouseUserId) {
							entity {
								...WarehouseUserProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<WarehouseUserModel>> {
		const url = environment.API_URL + '/api/warehouseuser/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<WarehouseUserModel>> {
		const url = environment.API_URL + '/api/warehouseuser/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<WarehouseUserModel>> {
		let apiUrl = environment.API_URL + '/api/warehouseuser/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<WarehouseUserModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/warehouseuser/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Warehouse User entities')),
