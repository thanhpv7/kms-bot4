...
import {McuPackageItemModelAudit} from '../../models/mcuPackageItem/mcu_package_item.model.state';
...
/**
 * MCU Package Item service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class McuPackageItemService extends AbstractHttpService<McuPackageItemModel, McuPackageItemModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the McuPackageItemProperties classFragment here] off begin
			fragment McuPackageItemProperties on McuPackageItem {
				...McuPackageItemBaseProperties
				itemCode
				duration
				sequence
			}
			# % protected region % [Modify the McuPackageItemProperties classFragment here] end
			${super.fragments('McuPackageItem').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<McuPackageItemModel>> {
		...
		return  this.apollo.query<PassableStateConfig<McuPackageItemModel>>(
			{
				query: gql`
					query Count {
						totalCount: countMcuPackageItems
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<McuPackageItemModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<McuPackageItemModel>> {
		...
		return this.apollo.query<PassableStateConfig<McuPackageItemModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						McuPackageItemById: mcuPackageItemById(id: $id) {
							...McuPackageItemProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.McuPackageItemById as McuPackageItemModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<McuPackageItemModel>> {
		...
		return this.apollo.query<PassableStateConfig<McuPackageItemModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						mcuPackageItems: mcuPackageItems(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...McuPackageItemProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countMcuPackageItems(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.mcuPackageItems as McuPackageItemModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<McuPackageItemModel>> {
		...
		return this.apollo.query<PassableStateConfig<McuPackageItemModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						mcuPackageItems: lastMcuPackageItems(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...McuPackageItemProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: McuPackageItemModel, queryParams?: QueryParams): Observable<PassableStateConfig<McuPackageItemModel>> {
		...
		const successMessage = 'Created MCU Package Item entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($mcuPackageItem: McuPackageItemInput!, $persistRelations: Boolean) {
						mcuPackageItem: createMcuPackageItem(mcuPackageItem: $mcuPackageItem, persistRelations: $persistRelations) {
							...McuPackageItemProperties,
				...
				variables: {
					mcuPackageItem: {
						...entity.toJSON(),
						mcuPackage: entity.mcuPackage ? new McuPackageModel(entity.mcuPackage).toJSON() : undefined,
			...
			map(result => {
				...
				return {
					targetModel: result.data.mcuPackageItem as McuPackageItemModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: McuPackageItemModel[], queryParams?: QueryParams): Observable<PassableStateConfig<McuPackageItemModel>> {
		...
		const successMessage = 'Created Multiple MCU Package Item entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($mcuPackageItems: [McuPackageItemInput!]!) {
						mcuPackageItem: createAllMcuPackageItem(mcuPackageItems: $mcuPackageItems) {
							...McuPackageItemProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					mcuPackageItems: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.mcuPackageItem as McuPackageItemModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: McuPackageItemModel, queryParams?: QueryParams): Observable<PassableStateConfig<McuPackageItemModel>> {
		...
		const successMessage = 'Updated MCU Package Item entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($mcuPackageItem: McuPackageItemInput!, $persistRelations: Boolean) {
						mcuPackageItem: updateMcuPackageItem(mcuPackageItem: $mcuPackageItem, persistRelations: $persistRelations) {
							...McuPackageItemProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: McuPackageItemModel[], queryParams?: QueryParams): Observable<PassableStateConfig<McuPackageItemModel>> {
		...
		const successMessage = 'Update Multiple MCU Package Item entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($mcuPackageItems: [McuPackageItemInput!]!) {
						mcuPackageItem: updateAllMcuPackageItem(mcuPackageItems: $mcuPackageItems) {
							...McuPackageItemProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<McuPackageItemModel>> {
		...
		const successMessage = 'Deleted MCU Package Item entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($mcuPackageItemId: ID!) {
						mcuPackageItemId: deleteMcuPackageItemById(mcuPackageItemId: $mcuPackageItemId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.mcuPackageItemId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<McuPackageItemModel>> {
		...
		const successMessage = 'Deleted selected MCU Package Item entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($mcuPackageItemIds: [ID!]!){
						deleteMcuPackageItemExcludingIds(mcuPackageItemIds: $mcuPackageItemIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.mcuPackageItemIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<McuPackageItemModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($mcuPackageItemIds: [ID!]!) {
						mcuPackageItemIds: deleteAllMcuPackageItemByIds(mcuPackageItemIds: $mcuPackageItemIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<McuPackageItemModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<McuPackageItemModel>>(
			...
			map(result => {
				let audits: McuPackageItemModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new McuPackageItemModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<McuPackageItemModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<McuPackageItemModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($mcuPackageItemId: ID!) {
						audits: mcuPackageItemAuditsByEntityId(mcuPackageItemId: $mcuPackageItemId) {
							entity {
								...McuPackageItemProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<McuPackageItemModel>> {
		const url = environment.API_URL + '/api/mcupackageitem/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<McuPackageItemModel>> {
		const url = environment.API_URL + '/api/mcupackageitem/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<McuPackageItemModel>> {
		let apiUrl = environment.API_URL + '/api/mcupackageitem/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<McuPackageItemModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/mcupackageitem/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' MCU Package Item entities')),
