...
import {ServiceModelAudit} from '../../models/service/service.model.state';
...
/**
 * Service service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class ServiceService extends AbstractHttpService<ServiceModel, ServiceModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the ServiceProperties classFragment here] off begin
			fragment ServiceProperties on Service {
				...ServiceBaseProperties
				serviceNumber
				serviceName
				sectionCode
				byPassDoctorAssignment
				hasExaminationItem
				revenueCenter
				serviceCode
			}
			# % protected region % [Modify the ServiceProperties classFragment here] end
			${super.fragments('Service').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<ServiceModel>> {
		...
		return  this.apollo.query<PassableStateConfig<ServiceModel>>(
			{
				query: gql`
					query Count {
						totalCount: countServices
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<ServiceModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<ServiceModel>> {
		...
		return this.apollo.query<PassableStateConfig<ServiceModel>>(
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.ServiceById as ServiceModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<ServiceModel>> {
		...
		return this.apollo.query<PassableStateConfig<ServiceModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						services: services(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...ServiceProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countServices(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.services as ServiceModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<ServiceModel>> {
		...
		return this.apollo.query<PassableStateConfig<ServiceModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						services: lastServices(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...ServiceProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: ServiceModel, queryParams?: QueryParams): Observable<PassableStateConfig<ServiceModel>> {
		...
		const successMessage = 'Created Service entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($service: ServiceInput!, $persistRelations: Boolean) {
						service: createService(service: $service, persistRelations: $persistRelations) {
							...ServiceProperties,
				...
				variables: {
					service: {
						...entity.toJSON(),
						defaultMedicalStaff: entity.defaultMedicalStaff ? new StaffModel(entity.defaultMedicalStaff).toJSON() : undefined,
						bpjsPcarePoli: entity.bpjsPcarePoli ? new BpjsPcarePoliModel(entity.bpjsPcarePoli).toJSON() : undefined,
						...
						examinationGroups: entity.examinationGroups ? entity.examinationGroups?.map((model: ExaminationGroupModel) => new ExaminationGroupModel(model).toJSON()) : [],
						...
						referringUnit: entity.referringUnit ? entity.referringUnit?.map((model: RegistrationModel) => new RegistrationModel(model).toJSON()) : [],
						registrations: entity.registrations ? entity.registrations?.map((model: RegistrationModel) => new RegistrationModel(model).toJSON()) : [],
						serviceFacilityCategories: entity.serviceFacilityCategories ? entity.serviceFacilityCategories?.map((model: ServiceFacilityCategoryModel) => new ServiceFacilityCategoryModel(model).toJSON()) : [],
						serviceItems: entity.serviceItems ? entity.serviceItems?.map((model: ServiceItemModel) => new ServiceItemModel(model).toJSON()) : [],
						assignedMedicalStaff: entity.assignedMedicalStaff ? entity.assignedMedicalStaff?.map((model: StaffModel) => new StaffModel(model).toJSON()) : [],
					},
			...
			map(result => {
				...
				return {
					targetModel: result.data.service as ServiceModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: ServiceModel[], queryParams?: QueryParams): Observable<PassableStateConfig<ServiceModel>> {
		...
		const successMessage = 'Created Multiple Service entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($services: [ServiceInput!]!) {
						service: createAllService(services: $services) {
							...ServiceProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					services: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.service as ServiceModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: ServiceModel, queryParams?: QueryParams): Observable<PassableStateConfig<ServiceModel>> {
		...
		const successMessage = 'Updated Service entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($service: ServiceInput!, $persistRelations: Boolean) {
						service: updateService(service: $service, persistRelations: $persistRelations) {
							...ServiceProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: ServiceModel[], queryParams?: QueryParams): Observable<PassableStateConfig<ServiceModel>> {
		...
		const successMessage = 'Update Multiple Service entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($services: [ServiceInput!]!) {
						service: updateAllService(services: $services) {
							...ServiceProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<ServiceModel>> {
		...
		const successMessage = 'Deleted Service entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($serviceId: ID!) {
						serviceId: deleteServiceById(serviceId: $serviceId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.serviceId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<ServiceModel>> {
		...
		const successMessage = 'Deleted selected Service entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($serviceIds: [ID!]!){
						deleteServiceExcludingIds(serviceIds: $serviceIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.serviceIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<ServiceModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($serviceIds: [ID!]!) {
						serviceIds: deleteAllServiceByIds(serviceIds: $serviceIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<ServiceModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<ServiceModel>>(
			...
			map(result => {
				let audits: ServiceModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new ServiceModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<ServiceModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<ServiceModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($serviceId: ID!) {
						audits: serviceAuditsByEntityId(serviceId: $serviceId) {
							entity {
								...ServiceProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<ServiceModel>> {
		const url = environment.API_URL + '/api/service/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<ServiceModel>> {
		const url = environment.API_URL + '/api/service/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<ServiceModel>> {
		let apiUrl = environment.API_URL + '/api/service/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<ServiceModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/service/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Service entities')),
