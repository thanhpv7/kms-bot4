...
import {BatchStockTransactionDetailModel} from '../../models/batchStockTransactionDetail/batch_stock_transaction_detail.model';
import {BatchStockTransactionDetailModelAudit} from '../../models/batchStockTransactionDetail/batch_stock_transaction_detail.model.state';
...
/**
 * Batch Stock Transaction Detail service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BatchStockTransactionDetailService extends AbstractHttpService<BatchStockTransactionDetailModel, BatchStockTransactionDetailModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BatchStockTransactionDetailProperties classFragment here] off begin
			fragment BatchStockTransactionDetailProperties on BatchStockTransactionDetail {
				...BatchStockTransactionDetailBaseProperties
				batchNo
				expirationDate
				itemLineNumber
				transactionNumber
				...
				batchQtyUoi
				batchQtyUomTransaction
				uoi
				uomTransaction
				batchItemNotes
			}
			# % protected region % [Modify the BatchStockTransactionDetailProperties classFragment here] end
			${super.fragments('BatchStockTransactionDetail').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BatchStockTransactionDetailModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BatchStockTransactionDetailModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBatchStockTransactionDetails
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BatchStockTransactionDetailModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BatchStockTransactionDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<BatchStockTransactionDetailModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BatchStockTransactionDetailById: batchStockTransactionDetailById(id: $id) {
							...BatchStockTransactionDetailProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BatchStockTransactionDetailById as BatchStockTransactionDetailModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BatchStockTransactionDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<BatchStockTransactionDetailModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						batchStockTransactionDetails: batchStockTransactionDetails(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BatchStockTransactionDetailProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBatchStockTransactionDetails(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.batchStockTransactionDetails as BatchStockTransactionDetailModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BatchStockTransactionDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<BatchStockTransactionDetailModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						batchStockTransactionDetails: lastBatchStockTransactionDetails(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BatchStockTransactionDetailProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BatchStockTransactionDetailModel, queryParams?: QueryParams): Observable<PassableStateConfig<BatchStockTransactionDetailModel>> {
		...
		const successMessage = 'Created Batch Stock Transaction Detail entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($batchStockTransactionDetail: BatchStockTransactionDetailInput!, $persistRelations: Boolean) {
						batchStockTransactionDetail: createBatchStockTransactionDetail(batchStockTransactionDetail: $batchStockTransactionDetail, persistRelations: $persistRelations) {
							...BatchStockTransactionDetailProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.batchStockTransactionDetail as BatchStockTransactionDetailModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BatchStockTransactionDetailModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BatchStockTransactionDetailModel>> {
		...
		const successMessage = 'Created Multiple Batch Stock Transaction Detail entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($batchStockTransactionDetails: [BatchStockTransactionDetailInput!]!) {
						batchStockTransactionDetail: createAllBatchStockTransactionDetail(batchStockTransactionDetails: $batchStockTransactionDetails) {
							...BatchStockTransactionDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					batchStockTransactionDetails: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.batchStockTransactionDetail as BatchStockTransactionDetailModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BatchStockTransactionDetailModel, queryParams?: QueryParams): Observable<PassableStateConfig<BatchStockTransactionDetailModel>> {
		...
		const successMessage = 'Updated Batch Stock Transaction Detail entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($batchStockTransactionDetail: BatchStockTransactionDetailInput!, $persistRelations: Boolean) {
						batchStockTransactionDetail: updateBatchStockTransactionDetail(batchStockTransactionDetail: $batchStockTransactionDetail, persistRelations: $persistRelations) {
							...BatchStockTransactionDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BatchStockTransactionDetailModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BatchStockTransactionDetailModel>> {
		...
		const successMessage = 'Update Multiple Batch Stock Transaction Detail entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($batchStockTransactionDetails: [BatchStockTransactionDetailInput!]!) {
						batchStockTransactionDetail: updateAllBatchStockTransactionDetail(batchStockTransactionDetails: $batchStockTransactionDetails) {
							...BatchStockTransactionDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BatchStockTransactionDetailModel>> {
		...
		const successMessage = 'Deleted Batch Stock Transaction Detail entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($batchStockTransactionDetailId: ID!) {
						batchStockTransactionDetailId: deleteBatchStockTransactionDetailById(batchStockTransactionDetailId: $batchStockTransactionDetailId)
				...
				`,
				variables: {
					batchStockTransactionDetailId: id,
			...
			map(result => {
				...
				return {
					targetModelId: result.data.batchStockTransactionDetailId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BatchStockTransactionDetailModel>> {
		...
		const successMessage = 'Deleted selected Batch Stock Transaction Detail entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($batchStockTransactionDetailIds: [ID!]!){
						deleteBatchStockTransactionDetailExcludingIds(batchStockTransactionDetailIds: $batchStockTransactionDetailIds)
				...
				`,
				variables: {
					batchStockTransactionDetailIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.batchStockTransactionDetailIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BatchStockTransactionDetailModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($batchStockTransactionDetailIds: [ID!]!) {
						batchStockTransactionDetailIds: deleteAllBatchStockTransactionDetailByIds(batchStockTransactionDetailIds: $batchStockTransactionDetailIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BatchStockTransactionDetailModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BatchStockTransactionDetailModel>>(
			{
				query: gql`
					query GetAudits {
						audits: batchStockTransactionDetailAudits {
							entity {
								...BatchStockTransactionDetailProperties
							}
							timestamp
			...
			map(result => {
				let audits: BatchStockTransactionDetailModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BatchStockTransactionDetailModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BatchStockTransactionDetailModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BatchStockTransactionDetailModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($batchStockTransactionDetailId: ID!) {
						audits: batchStockTransactionDetailAuditsByEntityId(batchStockTransactionDetailId: $batchStockTransactionDetailId) {
							entity {
								...BatchStockTransactionDetailProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BatchStockTransactionDetailModel>> {
		const url = environment.API_URL + '/api/batchstocktransactiondetail/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BatchStockTransactionDetailModel>> {
		const url = environment.API_URL + '/api/batchstocktransactiondetail/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BatchStockTransactionDetailModel>> {
		let apiUrl = environment.API_URL + '/api/batchstocktransactiondetail/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BatchStockTransactionDetailModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/batchstocktransactiondetail/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Batch Stock Transaction Detail entities')),
