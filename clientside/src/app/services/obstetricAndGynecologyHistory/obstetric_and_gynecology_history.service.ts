...
import {ObstetricAndGynecologyHistoryModel} from '../../models/obstetricAndGynecologyHistory/obstetric_and_gynecology_history.model';
import {ObstetricAndGynecologyHistoryModelAudit} from '../../models/obstetricAndGynecologyHistory/obstetric_and_gynecology_history.model.state';
...
/**
 * Obstetric And Gynecology History service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class ObstetricAndGynecologyHistoryService extends AbstractHttpService<ObstetricAndGynecologyHistoryModel, ObstetricAndGynecologyHistoryModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the ObstetricAndGynecologyHistoryProperties classFragment here] off begin
			fragment ObstetricAndGynecologyHistoryProperties on ObstetricAndGynecologyHistory {
				...ObstetricAndGynecologyHistoryBaseProperties
				pregnancyHistoryGravida
				patientHistoryPara
				patientHistoryAbortus
				pregnancyHistoryNotes
				ageOfMenarche
				ageOfFirstSexualContact
				startDate
				endDate
				...
				familyPlanHistory
				otherNotes
				educationLevelOfPatient
				nameOfHusbandOrWife
				educationLevelOfHusbandOrWife
				occupationOfHusbandOrWife
				ruptureOfMembrane
			}
			# % protected region % [Modify the ObstetricAndGynecologyHistoryProperties classFragment here] end
			${super.fragments('ObstetricAndGynecologyHistory').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<ObstetricAndGynecologyHistoryModel>> {
		...
		return  this.apollo.query<PassableStateConfig<ObstetricAndGynecologyHistoryModel>>(
			{
				query: gql`
					query Count {
						totalCount: countObstetricAndGynecologyHistorys
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<ObstetricAndGynecologyHistoryModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<ObstetricAndGynecologyHistoryModel>> {
		...
		return this.apollo.query<PassableStateConfig<ObstetricAndGynecologyHistoryModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						ObstetricAndGynecologyHistoryById: obstetricAndGynecologyHistoryById(id: $id) {
							...ObstetricAndGynecologyHistoryProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.ObstetricAndGynecologyHistoryById as ObstetricAndGynecologyHistoryModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<ObstetricAndGynecologyHistoryModel>> {
		...
		return this.apollo.query<PassableStateConfig<ObstetricAndGynecologyHistoryModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						obstetricAndGynecologyHistorys: obstetricAndGynecologyHistorys(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...ObstetricAndGynecologyHistoryProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countObstetricAndGynecologyHistorys(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.obstetricAndGynecologyHistorys as ObstetricAndGynecologyHistoryModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<ObstetricAndGynecologyHistoryModel>> {
		...
		return this.apollo.query<PassableStateConfig<ObstetricAndGynecologyHistoryModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						obstetricAndGynecologyHistorys: lastObstetricAndGynecologyHistorys(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...ObstetricAndGynecologyHistoryProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: ObstetricAndGynecologyHistoryModel, queryParams?: QueryParams): Observable<PassableStateConfig<ObstetricAndGynecologyHistoryModel>> {
		...
		const successMessage = 'Created Obstetric And Gynecology History entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($obstetricAndGynecologyHistory: ObstetricAndGynecologyHistoryInput!, $persistRelations: Boolean) {
						obstetricAndGynecologyHistory: createObstetricAndGynecologyHistory(obstetricAndGynecologyHistory: $obstetricAndGynecologyHistory, persistRelations: $persistRelations) {
							...ObstetricAndGynecologyHistoryProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.obstetricAndGynecologyHistory as ObstetricAndGynecologyHistoryModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: ObstetricAndGynecologyHistoryModel[], queryParams?: QueryParams): Observable<PassableStateConfig<ObstetricAndGynecologyHistoryModel>> {
		...
		const successMessage = 'Created Multiple Obstetric And Gynecology History entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($obstetricAndGynecologyHistorys: [ObstetricAndGynecologyHistoryInput!]!) {
						obstetricAndGynecologyHistory: createAllObstetricAndGynecologyHistory(obstetricAndGynecologyHistorys: $obstetricAndGynecologyHistorys) {
							...ObstetricAndGynecologyHistoryProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					obstetricAndGynecologyHistorys: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.obstetricAndGynecologyHistory as ObstetricAndGynecologyHistoryModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: ObstetricAndGynecologyHistoryModel, queryParams?: QueryParams): Observable<PassableStateConfig<ObstetricAndGynecologyHistoryModel>> {
		...
		const successMessage = 'Updated Obstetric And Gynecology History entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($obstetricAndGynecologyHistory: ObstetricAndGynecologyHistoryInput!, $persistRelations: Boolean) {
						obstetricAndGynecologyHistory: updateObstetricAndGynecologyHistory(obstetricAndGynecologyHistory: $obstetricAndGynecologyHistory, persistRelations: $persistRelations) {
							...ObstetricAndGynecologyHistoryProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: ObstetricAndGynecologyHistoryModel[], queryParams?: QueryParams): Observable<PassableStateConfig<ObstetricAndGynecologyHistoryModel>> {
		...
		const successMessage = 'Update Multiple Obstetric And Gynecology History entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($obstetricAndGynecologyHistorys: [ObstetricAndGynecologyHistoryInput!]!) {
						obstetricAndGynecologyHistory: updateAllObstetricAndGynecologyHistory(obstetricAndGynecologyHistorys: $obstetricAndGynecologyHistorys) {
							...ObstetricAndGynecologyHistoryProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<ObstetricAndGynecologyHistoryModel>> {
		...
		const successMessage = 'Deleted Obstetric And Gynecology History entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($obstetricAndGynecologyHistoryId: ID!) {
						obstetricAndGynecologyHistoryId: deleteObstetricAndGynecologyHistoryById(obstetricAndGynecologyHistoryId: $obstetricAndGynecologyHistoryId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.obstetricAndGynecologyHistoryId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<ObstetricAndGynecologyHistoryModel>> {
		...
		const successMessage = 'Deleted selected Obstetric And Gynecology History entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($obstetricAndGynecologyHistoryIds: [ID!]!){
						deleteObstetricAndGynecologyHistoryExcludingIds(obstetricAndGynecologyHistoryIds: $obstetricAndGynecologyHistoryIds)
				...
				`,
				variables: {
					obstetricAndGynecologyHistoryIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.obstetricAndGynecologyHistoryIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<ObstetricAndGynecologyHistoryModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($obstetricAndGynecologyHistoryIds: [ID!]!) {
						obstetricAndGynecologyHistoryIds: deleteAllObstetricAndGynecologyHistoryByIds(obstetricAndGynecologyHistoryIds: $obstetricAndGynecologyHistoryIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<ObstetricAndGynecologyHistoryModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<ObstetricAndGynecologyHistoryModel>>(
			{
				query: gql`
					query GetAudits {
						audits: obstetricAndGynecologyHistoryAudits {
							entity {
								...ObstetricAndGynecologyHistoryProperties
							}
							timestamp
			...
			map(result => {
				let audits: ObstetricAndGynecologyHistoryModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new ObstetricAndGynecologyHistoryModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<ObstetricAndGynecologyHistoryModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<ObstetricAndGynecologyHistoryModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($obstetricAndGynecologyHistoryId: ID!) {
						audits: obstetricAndGynecologyHistoryAuditsByEntityId(obstetricAndGynecologyHistoryId: $obstetricAndGynecologyHistoryId) {
							entity {
								...ObstetricAndGynecologyHistoryProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<ObstetricAndGynecologyHistoryModel>> {
		const url = environment.API_URL + '/api/obstetricandgynecologyhistory/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<ObstetricAndGynecologyHistoryModel>> {
		const url = environment.API_URL + '/api/obstetricandgynecologyhistory/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<ObstetricAndGynecologyHistoryModel>> {
		let apiUrl = environment.API_URL + '/api/obstetricandgynecologyhistory/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<ObstetricAndGynecologyHistoryModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/obstetricandgynecologyhistory/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Obstetric And Gynecology History entities')),
