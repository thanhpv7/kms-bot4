...
import {MedicalFeeModelAudit} from '../../models/medicalFee/medical_fee.model.state';
...
/**
 * Medical Fee service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class MedicalFeeService extends AbstractHttpService<MedicalFeeModel, MedicalFeeModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the MedicalFeeProperties classFragment here] off begin
			fragment MedicalFeeProperties on MedicalFee {
				...MedicalFeeBaseProperties
				tariffType
				tariffCode
				name
				pharmacyTransactionType
				pharmacyTransactionNumber
				medicationTransactionNumber
				transactionDate
				quantity
				unit
				unitPrice
			...
			# % protected region % [Modify the MedicalFeeProperties classFragment here] end
			${super.fragments('MedicalFee').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<MedicalFeeModel>> {
		...
		return  this.apollo.query<PassableStateConfig<MedicalFeeModel>>(
			{
				query: gql`
					query Count {
						totalCount: countMedicalFees
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<MedicalFeeModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<MedicalFeeModel>> {
		...
		return this.apollo.query<PassableStateConfig<MedicalFeeModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						MedicalFeeById: medicalFeeById(id: $id) {
							...MedicalFeeProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.MedicalFeeById as MedicalFeeModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<MedicalFeeModel>> {
		...
		return this.apollo.query<PassableStateConfig<MedicalFeeModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						medicalFees: medicalFees(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...MedicalFeeProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countMedicalFees(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.medicalFees as MedicalFeeModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<MedicalFeeModel>> {
		...
		return this.apollo.query<PassableStateConfig<MedicalFeeModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						medicalFees: lastMedicalFees(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...MedicalFeeProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: MedicalFeeModel, queryParams?: QueryParams): Observable<PassableStateConfig<MedicalFeeModel>> {
		...
		const successMessage = 'Created Medical Fee entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($medicalFee: MedicalFeeInput!, $persistRelations: Boolean) {
						medicalFee: createMedicalFee(medicalFee: $medicalFee, persistRelations: $persistRelations) {
							...MedicalFeeProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.medicalFee as MedicalFeeModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: MedicalFeeModel[], queryParams?: QueryParams): Observable<PassableStateConfig<MedicalFeeModel>> {
		...
		const successMessage = 'Created Multiple Medical Fee entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($medicalFees: [MedicalFeeInput!]!) {
						medicalFee: createAllMedicalFee(medicalFees: $medicalFees) {
							...MedicalFeeProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					medicalFees: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.medicalFee as MedicalFeeModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: MedicalFeeModel, queryParams?: QueryParams): Observable<PassableStateConfig<MedicalFeeModel>> {
		...
		const successMessage = 'Updated Medical Fee entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($medicalFee: MedicalFeeInput!, $persistRelations: Boolean) {
						medicalFee: updateMedicalFee(medicalFee: $medicalFee, persistRelations: $persistRelations) {
							...MedicalFeeProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: MedicalFeeModel[], queryParams?: QueryParams): Observable<PassableStateConfig<MedicalFeeModel>> {
		...
		const successMessage = 'Update Multiple Medical Fee entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($medicalFees: [MedicalFeeInput!]!) {
						medicalFee: updateAllMedicalFee(medicalFees: $medicalFees) {
							...MedicalFeeProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<MedicalFeeModel>> {
		...
		const successMessage = 'Deleted Medical Fee entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($medicalFeeId: ID!) {
						medicalFeeId: deleteMedicalFeeById(medicalFeeId: $medicalFeeId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.medicalFeeId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<MedicalFeeModel>> {
		...
		const successMessage = 'Deleted selected Medical Fee entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($medicalFeeIds: [ID!]!){
						deleteMedicalFeeExcludingIds(medicalFeeIds: $medicalFeeIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.medicalFeeIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<MedicalFeeModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($medicalFeeIds: [ID!]!) {
						medicalFeeIds: deleteAllMedicalFeeByIds(medicalFeeIds: $medicalFeeIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<MedicalFeeModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<MedicalFeeModel>>(
			...
			map(result => {
				let audits: MedicalFeeModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new MedicalFeeModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<MedicalFeeModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<MedicalFeeModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($medicalFeeId: ID!) {
						audits: medicalFeeAuditsByEntityId(medicalFeeId: $medicalFeeId) {
							entity {
								...MedicalFeeProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<MedicalFeeModel>> {
		const url = environment.API_URL + '/api/medicalfee/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<MedicalFeeModel>> {
		const url = environment.API_URL + '/api/medicalfee/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<MedicalFeeModel>> {
		let apiUrl = environment.API_URL + '/api/medicalfee/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<MedicalFeeModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/medicalfee/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Medical Fee entities')),
