...
import {BedFacilityModelAudit} from '../../models/bedFacility/bed_facility.model.state';
...
/**
 * Bed Facility service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BedFacilityService extends AbstractHttpService<BedFacilityModel, BedFacilityModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BedFacilityProperties classFragment here] off begin
			fragment BedFacilityProperties on BedFacility {
				...BedFacilityBaseProperties
				bedNumber
				bedName
				treatmentClass
				availability
			...
			# % protected region % [Modify the BedFacilityProperties classFragment here] end
			${super.fragments('BedFacility').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BedFacilityModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BedFacilityModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBedFacilitys
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BedFacilityModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BedFacilityModel>> {
		...
		return this.apollo.query<PassableStateConfig<BedFacilityModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BedFacilityById: bedFacilityById(id: $id) {
							...BedFacilityProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BedFacilityById as BedFacilityModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BedFacilityModel>> {
		...
		return this.apollo.query<PassableStateConfig<BedFacilityModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						bedFacilitys: bedFacilitys(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BedFacilityProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBedFacilitys(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.bedFacilitys as BedFacilityModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BedFacilityModel>> {
		...
		return this.apollo.query<PassableStateConfig<BedFacilityModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						bedFacilitys: lastBedFacilitys(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BedFacilityProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BedFacilityModel, queryParams?: QueryParams): Observable<PassableStateConfig<BedFacilityModel>> {
		...
		const successMessage = 'Created Bed Facility entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($bedFacility: BedFacilityInput!, $persistRelations: Boolean) {
						bedFacility: createBedFacility(bedFacility: $bedFacility, persistRelations: $persistRelations) {
							...BedFacilityProperties,
				...
				variables: {
					bedFacility: {
						...
						roomFacility: entity.roomFacility ? new RoomFacilityModel(entity.roomFacility).toJSON() : undefined,
						bedReserves: entity.bedReserves ? entity.bedReserves?.map((model: BedReserveModel) => new BedReserveModel(model).toJSON()) : [],
						inpatientMedicalExaminationRecords: entity.inpatientMedicalExaminationRecords ? entity.inpatientMedicalExaminationRecords?.map((model: InpatientMedicalExaminationRecordModel) => new InpatientMedicalExaminationRecordModel(model).toJSON()) : [],
			...
			map(result => {
				...
				return {
					targetModel: result.data.bedFacility as BedFacilityModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BedFacilityModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BedFacilityModel>> {
		...
		const successMessage = 'Created Multiple Bed Facility entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($bedFacilitys: [BedFacilityInput!]!) {
						bedFacility: createAllBedFacility(bedFacilitys: $bedFacilitys) {
							...BedFacilityProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					bedFacilitys: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.bedFacility as BedFacilityModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BedFacilityModel, queryParams?: QueryParams): Observable<PassableStateConfig<BedFacilityModel>> {
		...
		const successMessage = 'Updated Bed Facility entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($bedFacility: BedFacilityInput!, $persistRelations: Boolean) {
						bedFacility: updateBedFacility(bedFacility: $bedFacility, persistRelations: $persistRelations) {
							...BedFacilityProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BedFacilityModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BedFacilityModel>> {
		...
		const successMessage = 'Update Multiple Bed Facility entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($bedFacilitys: [BedFacilityInput!]!) {
						bedFacility: updateAllBedFacility(bedFacilitys: $bedFacilitys) {
							...BedFacilityProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BedFacilityModel>> {
		...
		const successMessage = 'Deleted Bed Facility entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($bedFacilityId: ID!) {
						bedFacilityId: deleteBedFacilityById(bedFacilityId: $bedFacilityId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.bedFacilityId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BedFacilityModel>> {
		...
		const successMessage = 'Deleted selected Bed Facility entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($bedFacilityIds: [ID!]!){
						deleteBedFacilityExcludingIds(bedFacilityIds: $bedFacilityIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.bedFacilityIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BedFacilityModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($bedFacilityIds: [ID!]!) {
						bedFacilityIds: deleteAllBedFacilityByIds(bedFacilityIds: $bedFacilityIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BedFacilityModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BedFacilityModel>>(
			...
			map(result => {
				let audits: BedFacilityModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BedFacilityModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BedFacilityModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BedFacilityModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($bedFacilityId: ID!) {
						audits: bedFacilityAuditsByEntityId(bedFacilityId: $bedFacilityId) {
							entity {
								...BedFacilityProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BedFacilityModel>> {
		const url = environment.API_URL + '/api/bedfacility/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BedFacilityModel>> {
		const url = environment.API_URL + '/api/bedfacility/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BedFacilityModel>> {
		let apiUrl = environment.API_URL + '/api/bedfacility/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BedFacilityModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/bedfacility/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Bed Facility entities')),
