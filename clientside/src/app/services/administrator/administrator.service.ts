...
import {AdministratorModelAudit} from '../../models/administrator/administrator.model.state';
...
/**
 * Administrator service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class AdministratorService extends UserService<AdministratorModel, AdministratorModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the AdministratorProperties classFragment here] off begin
			fragment AdministratorProperties on Administrator {
				...AdministratorUserProperties
			}
			# % protected region % [Modify the AdministratorProperties classFragment here] end
			${super.fragments('Administrator').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<AdministratorModel>> {
		...
		return  this.apollo.query<PassableStateConfig<AdministratorModel>>(
			{
				query: gql`
					query Count {
						totalCount: countAdministrators
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<AdministratorModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<AdministratorModel>> {
		...
		return this.apollo.query<PassableStateConfig<AdministratorModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						AdministratorById: administratorById(id: $id) {
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.AdministratorById as AdministratorModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<AdministratorModel>> {
		...
		return this.apollo.query<PassableStateConfig<AdministratorModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						administrators: administrators(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...AdministratorProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countAdministrators(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.administrators as AdministratorModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<AdministratorModel>> {
		...
		return this.apollo.query<PassableStateConfig<AdministratorModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						administrators: lastAdministrators(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...AdministratorProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: AdministratorModel, queryParams?: QueryParams): Observable<PassableStateConfig<AdministratorModel>> {
		...
		const successMessage = 'Created Administrator entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($administrator: AdministratorInput!, $persistRelations: Boolean) {
						administrator: createAdministrator(administrator: $administrator, persistRelations: $persistRelations) {
							...AdministratorProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.administrator as AdministratorModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: AdministratorModel[], queryParams?: QueryParams): Observable<PassableStateConfig<AdministratorModel>> {
		...
		const successMessage = 'Created Multiple Administrator entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($administrators: [AdministratorInput!]!) {
						administrator: createAllAdministrator(administrators: $administrators) {
							...AdministratorProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					administrators: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.administrator as AdministratorModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: AdministratorModel, queryParams?: QueryParams): Observable<PassableStateConfig<AdministratorModel>> {
		...
		const successMessage = 'Updated Administrator entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($administrator: AdministratorInput!, $persistRelations: Boolean) {
						administrator: updateAdministrator(administrator: $administrator, persistRelations: $persistRelations) {
							...AdministratorProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: AdministratorModel[], queryParams?: QueryParams): Observable<PassableStateConfig<AdministratorModel>> {
		...
		const successMessage = 'Update Multiple Administrator entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($administrators: [AdministratorInput!]!) {
						administrator: updateAllAdministrator(administrators: $administrators) {
							...AdministratorProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<AdministratorModel>> {
		...
		const successMessage = 'Deleted Administrator entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($administratorId: ID!) {
						administratorId: deleteAdministratorById(administratorId: $administratorId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.administratorId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<AdministratorModel>> {
		...
		const successMessage = 'Deleted selected Administrator entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($administratorIds: [ID!]!){
						deleteAdministratorExcludingIds(administratorIds: $administratorIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.administratorIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<AdministratorModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($administratorIds: [ID!]!) {
						administratorIds: deleteAllAdministratorByIds(administratorIds: $administratorIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<AdministratorModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<AdministratorModel>>(
			...
			map(result => {
				let audits: AdministratorModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new AdministratorModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<AdministratorModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<AdministratorModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($administratorId: ID!) {
						audits: administratorAuditsByEntityId(administratorId: $administratorId) {
							entity {
								...AdministratorProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<AdministratorModel>> {
		const url = environment.API_URL + '/api/administrator/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<AdministratorModel>> {
		const url = environment.API_URL + '/api/administrator/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<AdministratorModel>> {
		let apiUrl = environment.API_URL + '/api/administrator/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<AdministratorModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/administrator/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Administrator entities')),
