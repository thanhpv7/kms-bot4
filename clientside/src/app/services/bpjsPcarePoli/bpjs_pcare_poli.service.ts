...
import {BpjsPcarePoliModel} from '../../models/bpjsPcarePoli/bpjs_pcare_poli.model';
import {BpjsPcarePoliModelAudit} from '../../models/bpjsPcarePoli/bpjs_pcare_poli.model.state';
...
/**
 * BPJS Pcare Poli service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BpjsPcarePoliService extends AbstractHttpService<BpjsPcarePoliModel, BpjsPcarePoliModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BpjsPcarePoliProperties classFragment here] off begin
			fragment BpjsPcarePoliProperties on BpjsPcarePoli {
				...BpjsPcarePoliBaseProperties
				kdpoli
				nmpoli
				polisakit
			}
			# % protected region % [Modify the BpjsPcarePoliProperties classFragment here] end
			${super.fragments('BpjsPcarePoli').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BpjsPcarePoliModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BpjsPcarePoliModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBpjsPcarePolis
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BpjsPcarePoliModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPcarePoliModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPcarePoliModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BpjsPcarePoliById: bpjsPcarePoliById(id: $id) {
							...BpjsPcarePoliProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BpjsPcarePoliById as BpjsPcarePoliModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsPcarePoliModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPcarePoliModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						bpjsPcarePolis: bpjsPcarePolis(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BpjsPcarePoliProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBpjsPcarePolis(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.bpjsPcarePolis as BpjsPcarePoliModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsPcarePoliModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPcarePoliModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						bpjsPcarePolis: lastBpjsPcarePolis(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BpjsPcarePoliProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BpjsPcarePoliModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPcarePoliModel>> {
		...
		const successMessage = 'Created BPJS Pcare Poli entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($bpjsPcarePoli: BpjsPcarePoliInput!, $persistRelations: Boolean) {
						bpjsPcarePoli: createBpjsPcarePoli(bpjsPcarePoli: $bpjsPcarePoli, persistRelations: $persistRelations) {
							...BpjsPcarePoliProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.bpjsPcarePoli as BpjsPcarePoliModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BpjsPcarePoliModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPcarePoliModel>> {
		...
		const successMessage = 'Created Multiple BPJS Pcare Poli entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($bpjsPcarePolis: [BpjsPcarePoliInput!]!) {
						bpjsPcarePoli: createAllBpjsPcarePoli(bpjsPcarePolis: $bpjsPcarePolis) {
							...BpjsPcarePoliProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					bpjsPcarePolis: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.bpjsPcarePoli as BpjsPcarePoliModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BpjsPcarePoliModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPcarePoliModel>> {
		...
		const successMessage = 'Updated BPJS Pcare Poli entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($bpjsPcarePoli: BpjsPcarePoliInput!, $persistRelations: Boolean) {
						bpjsPcarePoli: updateBpjsPcarePoli(bpjsPcarePoli: $bpjsPcarePoli, persistRelations: $persistRelations) {
							...BpjsPcarePoliProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BpjsPcarePoliModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPcarePoliModel>> {
		...
		const successMessage = 'Update Multiple BPJS Pcare Poli entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($bpjsPcarePolis: [BpjsPcarePoliInput!]!) {
						bpjsPcarePoli: updateAllBpjsPcarePoli(bpjsPcarePolis: $bpjsPcarePolis) {
							...BpjsPcarePoliProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BpjsPcarePoliModel>> {
		...
		const successMessage = 'Deleted BPJS Pcare Poli entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($bpjsPcarePoliId: ID!) {
						bpjsPcarePoliId: deleteBpjsPcarePoliById(bpjsPcarePoliId: $bpjsPcarePoliId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.bpjsPcarePoliId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsPcarePoliModel>> {
		...
		const successMessage = 'Deleted selected BPJS Pcare Poli entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($bpjsPcarePoliIds: [ID!]!){
						deleteBpjsPcarePoliExcludingIds(bpjsPcarePoliIds: $bpjsPcarePoliIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.bpjsPcarePoliIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BpjsPcarePoliModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($bpjsPcarePoliIds: [ID!]!) {
						bpjsPcarePoliIds: deleteAllBpjsPcarePoliByIds(bpjsPcarePoliIds: $bpjsPcarePoliIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BpjsPcarePoliModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPcarePoliModel>>(
			...
			map(result => {
				let audits: BpjsPcarePoliModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BpjsPcarePoliModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BpjsPcarePoliModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPcarePoliModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($bpjsPcarePoliId: ID!) {
						audits: bpjsPcarePoliAuditsByEntityId(bpjsPcarePoliId: $bpjsPcarePoliId) {
							entity {
								...BpjsPcarePoliProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BpjsPcarePoliModel>> {
		const url = environment.API_URL + '/api/bpjspcarepoli/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BpjsPcarePoliModel>> {
		const url = environment.API_URL + '/api/bpjspcarepoli/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsPcarePoliModel>> {
		let apiUrl = environment.API_URL + '/api/bpjspcarepoli/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BpjsPcarePoliModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/bpjspcarepoli/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' BPJS Pcare Poli entities')),
