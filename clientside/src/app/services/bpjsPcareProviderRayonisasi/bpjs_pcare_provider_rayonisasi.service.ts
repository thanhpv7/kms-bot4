...
import {BpjsPcareProviderRayonisasiModel} from '../../models/bpjsPcareProviderRayonisasi/bpjs_pcare_provider_rayonisasi.model';
import {BpjsPcareProviderRayonisasiModelAudit} from '../../models/bpjsPcareProviderRayonisasi/bpjs_pcare_provider_rayonisasi.model.state';
...
/**
 * BPJS Pcare Provider Rayonisasi service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BpjsPcareProviderRayonisasiService extends AbstractHttpService<BpjsPcareProviderRayonisasiModel, BpjsPcareProviderRayonisasiModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BpjsPcareProviderRayonisasiProperties classFragment here] off begin
			fragment BpjsPcareProviderRayonisasiProperties on BpjsPcareProviderRayonisasi {
				...BpjsPcareProviderRayonisasiBaseProperties
				kdprovider
				nmprovider
			}
			# % protected region % [Modify the BpjsPcareProviderRayonisasiProperties classFragment here] end
			${super.fragments('BpjsPcareProviderRayonisasi').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BpjsPcareProviderRayonisasiModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BpjsPcareProviderRayonisasiModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBpjsPcareProviderRayonisasis
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BpjsPcareProviderRayonisasiModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPcareProviderRayonisasiModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPcareProviderRayonisasiModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BpjsPcareProviderRayonisasiById: bpjsPcareProviderRayonisasiById(id: $id) {
							...BpjsPcareProviderRayonisasiProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BpjsPcareProviderRayonisasiById as BpjsPcareProviderRayonisasiModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsPcareProviderRayonisasiModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPcareProviderRayonisasiModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						bpjsPcareProviderRayonisasis: bpjsPcareProviderRayonisasis(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BpjsPcareProviderRayonisasiProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBpjsPcareProviderRayonisasis(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.bpjsPcareProviderRayonisasis as BpjsPcareProviderRayonisasiModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsPcareProviderRayonisasiModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPcareProviderRayonisasiModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						bpjsPcareProviderRayonisasis: lastBpjsPcareProviderRayonisasis(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BpjsPcareProviderRayonisasiProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BpjsPcareProviderRayonisasiModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPcareProviderRayonisasiModel>> {
		...
		const successMessage = 'Created BPJS Pcare Provider Rayonisasi entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($bpjsPcareProviderRayonisasi: BpjsPcareProviderRayonisasiInput!, $persistRelations: Boolean) {
						bpjsPcareProviderRayonisasi: createBpjsPcareProviderRayonisasi(bpjsPcareProviderRayonisasi: $bpjsPcareProviderRayonisasi, persistRelations: $persistRelations) {
							...BpjsPcareProviderRayonisasiProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.bpjsPcareProviderRayonisasi as BpjsPcareProviderRayonisasiModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BpjsPcareProviderRayonisasiModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPcareProviderRayonisasiModel>> {
		...
		const successMessage = 'Created Multiple BPJS Pcare Provider Rayonisasi entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($bpjsPcareProviderRayonisasis: [BpjsPcareProviderRayonisasiInput!]!) {
						bpjsPcareProviderRayonisasi: createAllBpjsPcareProviderRayonisasi(bpjsPcareProviderRayonisasis: $bpjsPcareProviderRayonisasis) {
							...BpjsPcareProviderRayonisasiProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					bpjsPcareProviderRayonisasis: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.bpjsPcareProviderRayonisasi as BpjsPcareProviderRayonisasiModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BpjsPcareProviderRayonisasiModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPcareProviderRayonisasiModel>> {
		...
		const successMessage = 'Updated BPJS Pcare Provider Rayonisasi entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($bpjsPcareProviderRayonisasi: BpjsPcareProviderRayonisasiInput!, $persistRelations: Boolean) {
						bpjsPcareProviderRayonisasi: updateBpjsPcareProviderRayonisasi(bpjsPcareProviderRayonisasi: $bpjsPcareProviderRayonisasi, persistRelations: $persistRelations) {
							...BpjsPcareProviderRayonisasiProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BpjsPcareProviderRayonisasiModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPcareProviderRayonisasiModel>> {
		...
		const successMessage = 'Update Multiple BPJS Pcare Provider Rayonisasi entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($bpjsPcareProviderRayonisasis: [BpjsPcareProviderRayonisasiInput!]!) {
						bpjsPcareProviderRayonisasi: updateAllBpjsPcareProviderRayonisasi(bpjsPcareProviderRayonisasis: $bpjsPcareProviderRayonisasis) {
							...BpjsPcareProviderRayonisasiProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BpjsPcareProviderRayonisasiModel>> {
		...
		const successMessage = 'Deleted BPJS Pcare Provider Rayonisasi entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($bpjsPcareProviderRayonisasiId: ID!) {
						bpjsPcareProviderRayonisasiId: deleteBpjsPcareProviderRayonisasiById(bpjsPcareProviderRayonisasiId: $bpjsPcareProviderRayonisasiId)
				...
				`,
				variables: {
					bpjsPcareProviderRayonisasiId: id,
			...
			map(result => {
				...
				return {
					targetModelId: result.data.bpjsPcareProviderRayonisasiId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsPcareProviderRayonisasiModel>> {
		...
		const successMessage = 'Deleted selected BPJS Pcare Provider Rayonisasi entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($bpjsPcareProviderRayonisasiIds: [ID!]!){
						deleteBpjsPcareProviderRayonisasiExcludingIds(bpjsPcareProviderRayonisasiIds: $bpjsPcareProviderRayonisasiIds)
				...
				`,
				variables: {
					bpjsPcareProviderRayonisasiIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.bpjsPcareProviderRayonisasiIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BpjsPcareProviderRayonisasiModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($bpjsPcareProviderRayonisasiIds: [ID!]!) {
						bpjsPcareProviderRayonisasiIds: deleteAllBpjsPcareProviderRayonisasiByIds(bpjsPcareProviderRayonisasiIds: $bpjsPcareProviderRayonisasiIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BpjsPcareProviderRayonisasiModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPcareProviderRayonisasiModel>>(
			{
				query: gql`
					query GetAudits {
						audits: bpjsPcareProviderRayonisasiAudits {
							entity {
								...BpjsPcareProviderRayonisasiProperties
							}
							timestamp
			...
			map(result => {
				let audits: BpjsPcareProviderRayonisasiModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BpjsPcareProviderRayonisasiModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BpjsPcareProviderRayonisasiModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPcareProviderRayonisasiModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($bpjsPcareProviderRayonisasiId: ID!) {
						audits: bpjsPcareProviderRayonisasiAuditsByEntityId(bpjsPcareProviderRayonisasiId: $bpjsPcareProviderRayonisasiId) {
							entity {
								...BpjsPcareProviderRayonisasiProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BpjsPcareProviderRayonisasiModel>> {
		const url = environment.API_URL + '/api/bpjspcareproviderrayonisasi/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BpjsPcareProviderRayonisasiModel>> {
		const url = environment.API_URL + '/api/bpjspcareproviderrayonisasi/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsPcareProviderRayonisasiModel>> {
		let apiUrl = environment.API_URL + '/api/bpjspcareproviderrayonisasi/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BpjsPcareProviderRayonisasiModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/bpjspcareproviderrayonisasi/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' BPJS Pcare Provider Rayonisasi entities')),
