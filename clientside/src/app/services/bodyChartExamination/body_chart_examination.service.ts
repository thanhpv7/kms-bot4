...
import {BodyChartExaminationModelAudit} from '../../models/bodyChartExamination/body_chart_examination.model.state';
...
/**
 * Body Chart Examination service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BodyChartExaminationService extends AbstractHttpService<BodyChartExaminationModel, BodyChartExaminationModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BodyChartExaminationProperties classFragment here] off begin
			fragment BodyChartExaminationProperties on BodyChartExamination {
				...BodyChartExaminationBaseProperties
				bc01Subjective
				bc01Objective
				bc02Subjective
				bc02Objective
			...
			# % protected region % [Modify the BodyChartExaminationProperties classFragment here] end
			${super.fragments('BodyChartExamination').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BodyChartExaminationModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BodyChartExaminationModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBodyChartExaminations
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BodyChartExaminationModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BodyChartExaminationModel>> {
		...
		return this.apollo.query<PassableStateConfig<BodyChartExaminationModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BodyChartExaminationById: bodyChartExaminationById(id: $id) {
							...BodyChartExaminationProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BodyChartExaminationById as BodyChartExaminationModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BodyChartExaminationModel>> {
		...
		return this.apollo.query<PassableStateConfig<BodyChartExaminationModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						bodyChartExaminations: bodyChartExaminations(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BodyChartExaminationProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBodyChartExaminations(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.bodyChartExaminations as BodyChartExaminationModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BodyChartExaminationModel>> {
		...
		return this.apollo.query<PassableStateConfig<BodyChartExaminationModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						bodyChartExaminations: lastBodyChartExaminations(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BodyChartExaminationProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BodyChartExaminationModel, queryParams?: QueryParams): Observable<PassableStateConfig<BodyChartExaminationModel>> {
		...
		const successMessage = 'Created Body Chart Examination entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($bodyChartExamination: BodyChartExaminationInput!, $persistRelations: Boolean) {
						bodyChartExamination: createBodyChartExamination(bodyChartExamination: $bodyChartExamination, persistRelations: $persistRelations) {
							...BodyChartExaminationProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.bodyChartExamination as BodyChartExaminationModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BodyChartExaminationModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BodyChartExaminationModel>> {
		...
		const successMessage = 'Created Multiple Body Chart Examination entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($bodyChartExaminations: [BodyChartExaminationInput!]!) {
						bodyChartExamination: createAllBodyChartExamination(bodyChartExaminations: $bodyChartExaminations) {
							...BodyChartExaminationProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					bodyChartExaminations: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.bodyChartExamination as BodyChartExaminationModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BodyChartExaminationModel, queryParams?: QueryParams): Observable<PassableStateConfig<BodyChartExaminationModel>> {
		...
		const successMessage = 'Updated Body Chart Examination entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($bodyChartExamination: BodyChartExaminationInput!, $persistRelations: Boolean) {
						bodyChartExamination: updateBodyChartExamination(bodyChartExamination: $bodyChartExamination, persistRelations: $persistRelations) {
							...BodyChartExaminationProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BodyChartExaminationModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BodyChartExaminationModel>> {
		...
		const successMessage = 'Update Multiple Body Chart Examination entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($bodyChartExaminations: [BodyChartExaminationInput!]!) {
						bodyChartExamination: updateAllBodyChartExamination(bodyChartExaminations: $bodyChartExaminations) {
							...BodyChartExaminationProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BodyChartExaminationModel>> {
		...
		const successMessage = 'Deleted Body Chart Examination entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($bodyChartExaminationId: ID!) {
						bodyChartExaminationId: deleteBodyChartExaminationById(bodyChartExaminationId: $bodyChartExaminationId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.bodyChartExaminationId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BodyChartExaminationModel>> {
		...
		const successMessage = 'Deleted selected Body Chart Examination entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($bodyChartExaminationIds: [ID!]!){
						deleteBodyChartExaminationExcludingIds(bodyChartExaminationIds: $bodyChartExaminationIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.bodyChartExaminationIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BodyChartExaminationModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($bodyChartExaminationIds: [ID!]!) {
						bodyChartExaminationIds: deleteAllBodyChartExaminationByIds(bodyChartExaminationIds: $bodyChartExaminationIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BodyChartExaminationModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BodyChartExaminationModel>>(
			{
				query: gql`
					query GetAudits {
						audits: bodyChartExaminationAudits {
							entity {
								...BodyChartExaminationProperties
							}
							timestamp
			...
			map(result => {
				let audits: BodyChartExaminationModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BodyChartExaminationModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BodyChartExaminationModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BodyChartExaminationModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($bodyChartExaminationId: ID!) {
						audits: bodyChartExaminationAuditsByEntityId(bodyChartExaminationId: $bodyChartExaminationId) {
							entity {
								...BodyChartExaminationProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BodyChartExaminationModel>> {
		const url = environment.API_URL + '/api/bodychartexamination/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BodyChartExaminationModel>> {
		const url = environment.API_URL + '/api/bodychartexamination/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BodyChartExaminationModel>> {
		let apiUrl = environment.API_URL + '/api/bodychartexamination/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BodyChartExaminationModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/bodychartexamination/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Body Chart Examination entities')),
