...
import {TariffPackageItemModel} from '../../models/tariffPackageItem/tariff_package_item.model';
import {TariffPackageItemModelAudit} from '../../models/tariffPackageItem/tariff_package_item.model.state';
...
/**
 * Tariff Package Item service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class TariffPackageItemService extends AbstractHttpService<TariffPackageItemModel, TariffPackageItemModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the TariffPackageItemProperties classFragment here] off begin
			fragment TariffPackageItemProperties on TariffPackageItem {
				...TariffPackageItemBaseProperties
				tariffType
				tariffCode
				tariffName
				quantity
			...
			# % protected region % [Modify the TariffPackageItemProperties classFragment here] end
			${super.fragments('TariffPackageItem').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<TariffPackageItemModel>> {
		...
		return  this.apollo.query<PassableStateConfig<TariffPackageItemModel>>(
			{
				query: gql`
					query Count {
						totalCount: countTariffPackageItems
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<TariffPackageItemModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<TariffPackageItemModel>> {
		...
		return this.apollo.query<PassableStateConfig<TariffPackageItemModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						TariffPackageItemById: tariffPackageItemById(id: $id) {
							...TariffPackageItemProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.TariffPackageItemById as TariffPackageItemModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<TariffPackageItemModel>> {
		...
		return this.apollo.query<PassableStateConfig<TariffPackageItemModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						tariffPackageItems: tariffPackageItems(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...TariffPackageItemProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countTariffPackageItems(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.tariffPackageItems as TariffPackageItemModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<TariffPackageItemModel>> {
		...
		return this.apollo.query<PassableStateConfig<TariffPackageItemModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						tariffPackageItems: lastTariffPackageItems(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...TariffPackageItemProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: TariffPackageItemModel, queryParams?: QueryParams): Observable<PassableStateConfig<TariffPackageItemModel>> {
		...
		const successMessage = 'Created Tariff Package Item entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($tariffPackageItem: TariffPackageItemInput!, $persistRelations: Boolean) {
						tariffPackageItem: createTariffPackageItem(tariffPackageItem: $tariffPackageItem, persistRelations: $persistRelations) {
							...TariffPackageItemProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.tariffPackageItem as TariffPackageItemModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: TariffPackageItemModel[], queryParams?: QueryParams): Observable<PassableStateConfig<TariffPackageItemModel>> {
		...
		const successMessage = 'Created Multiple Tariff Package Item entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($tariffPackageItems: [TariffPackageItemInput!]!) {
						tariffPackageItem: createAllTariffPackageItem(tariffPackageItems: $tariffPackageItems) {
							...TariffPackageItemProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					tariffPackageItems: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.tariffPackageItem as TariffPackageItemModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: TariffPackageItemModel, queryParams?: QueryParams): Observable<PassableStateConfig<TariffPackageItemModel>> {
		...
		const successMessage = 'Updated Tariff Package Item entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($tariffPackageItem: TariffPackageItemInput!, $persistRelations: Boolean) {
						tariffPackageItem: updateTariffPackageItem(tariffPackageItem: $tariffPackageItem, persistRelations: $persistRelations) {
							...TariffPackageItemProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: TariffPackageItemModel[], queryParams?: QueryParams): Observable<PassableStateConfig<TariffPackageItemModel>> {
		...
		const successMessage = 'Update Multiple Tariff Package Item entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($tariffPackageItems: [TariffPackageItemInput!]!) {
						tariffPackageItem: updateAllTariffPackageItem(tariffPackageItems: $tariffPackageItems) {
							...TariffPackageItemProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<TariffPackageItemModel>> {
		...
		const successMessage = 'Deleted Tariff Package Item entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($tariffPackageItemId: ID!) {
						tariffPackageItemId: deleteTariffPackageItemById(tariffPackageItemId: $tariffPackageItemId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.tariffPackageItemId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<TariffPackageItemModel>> {
		...
		const successMessage = 'Deleted selected Tariff Package Item entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($tariffPackageItemIds: [ID!]!){
						deleteTariffPackageItemExcludingIds(tariffPackageItemIds: $tariffPackageItemIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.tariffPackageItemIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<TariffPackageItemModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($tariffPackageItemIds: [ID!]!) {
						tariffPackageItemIds: deleteAllTariffPackageItemByIds(tariffPackageItemIds: $tariffPackageItemIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<TariffPackageItemModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<TariffPackageItemModel>>(
			{
				query: gql`
					query GetAudits {
						audits: tariffPackageItemAudits {
							entity {
								...TariffPackageItemProperties
							}
							timestamp
			...
			map(result => {
				let audits: TariffPackageItemModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new TariffPackageItemModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<TariffPackageItemModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<TariffPackageItemModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($tariffPackageItemId: ID!) {
						audits: tariffPackageItemAuditsByEntityId(tariffPackageItemId: $tariffPackageItemId) {
							entity {
								...TariffPackageItemProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<TariffPackageItemModel>> {
		const url = environment.API_URL + '/api/tariffpackageitem/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<TariffPackageItemModel>> {
		const url = environment.API_URL + '/api/tariffpackageitem/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<TariffPackageItemModel>> {
		let apiUrl = environment.API_URL + '/api/tariffpackageitem/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<TariffPackageItemModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/tariffpackageitem/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Tariff Package Item entities')),
