...
import {PrescriptionHeaderModel} from '../../models/prescriptionHeader/prescription_header.model';
import {PrescriptionHeaderModelAudit} from '../../models/prescriptionHeader/prescription_header.model.state';
...
/**
 * Prescription Header service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class PrescriptionHeaderService extends AbstractHttpService<PrescriptionHeaderModel, PrescriptionHeaderModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the PrescriptionHeaderProperties classFragment here] off begin
			fragment PrescriptionHeaderProperties on PrescriptionHeader {
				...PrescriptionHeaderBaseProperties
				prescriptionNumber
				prescriptionType
				queueNo
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<PrescriptionHeaderModel>> {
		...
		return  this.apollo.query<PassableStateConfig<PrescriptionHeaderModel>>(
			{
				query: gql`
					query Count {
						totalCount: countPrescriptionHeaders
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<PrescriptionHeaderModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<PrescriptionHeaderModel>> {
		...
		return this.apollo.query<PassableStateConfig<PrescriptionHeaderModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						PrescriptionHeaderById: prescriptionHeaderById(id: $id) {
							...PrescriptionHeaderProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.PrescriptionHeaderById as PrescriptionHeaderModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PrescriptionHeaderModel>> {
		...
		return this.apollo.query<PassableStateConfig<PrescriptionHeaderModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						prescriptionHeaders: prescriptionHeaders(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...PrescriptionHeaderProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countPrescriptionHeaders(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.prescriptionHeaders as PrescriptionHeaderModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PrescriptionHeaderModel>> {
		...
		return this.apollo.query<PassableStateConfig<PrescriptionHeaderModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						prescriptionHeaders: lastPrescriptionHeaders(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...PrescriptionHeaderProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: PrescriptionHeaderModel, queryParams?: QueryParams): Observable<PassableStateConfig<PrescriptionHeaderModel>> {
		...
		const successMessage = 'Created Prescription Header entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($prescriptionHeader: PrescriptionHeaderInput!, $persistRelations: Boolean) {
						prescriptionHeader: createPrescriptionHeader(prescriptionHeader: $prescriptionHeader, persistRelations: $persistRelations) {
							...PrescriptionHeaderProperties,
				...
				variables: {
					prescriptionHeader: {
						...
						prescriptionCompounds: entity.prescriptionCompounds ? entity.prescriptionCompounds?.map((model: PrescriptionCompoundModel) => new PrescriptionCompoundModel(model).toJSON()) : [],
			...
			map(result => {
				...
				return {
					targetModel: result.data.prescriptionHeader as PrescriptionHeaderModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: PrescriptionHeaderModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PrescriptionHeaderModel>> {
		...
		const successMessage = 'Created Multiple Prescription Header entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($prescriptionHeaders: [PrescriptionHeaderInput!]!) {
						prescriptionHeader: createAllPrescriptionHeader(prescriptionHeaders: $prescriptionHeaders) {
							...PrescriptionHeaderProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					prescriptionHeaders: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.prescriptionHeader as PrescriptionHeaderModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: PrescriptionHeaderModel, queryParams?: QueryParams): Observable<PassableStateConfig<PrescriptionHeaderModel>> {
		...
		const successMessage = 'Updated Prescription Header entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($prescriptionHeader: PrescriptionHeaderInput!, $persistRelations: Boolean) {
						prescriptionHeader: updatePrescriptionHeader(prescriptionHeader: $prescriptionHeader, persistRelations: $persistRelations) {
							...PrescriptionHeaderProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: PrescriptionHeaderModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PrescriptionHeaderModel>> {
		...
		const successMessage = 'Update Multiple Prescription Header entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($prescriptionHeaders: [PrescriptionHeaderInput!]!) {
						prescriptionHeader: updateAllPrescriptionHeader(prescriptionHeaders: $prescriptionHeaders) {
							...PrescriptionHeaderProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<PrescriptionHeaderModel>> {
		...
		const successMessage = 'Deleted Prescription Header entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($prescriptionHeaderId: ID!) {
						prescriptionHeaderId: deletePrescriptionHeaderById(prescriptionHeaderId: $prescriptionHeaderId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.prescriptionHeaderId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<PrescriptionHeaderModel>> {
		...
		const successMessage = 'Deleted selected Prescription Header entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($prescriptionHeaderIds: [ID!]!){
						deletePrescriptionHeaderExcludingIds(prescriptionHeaderIds: $prescriptionHeaderIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.prescriptionHeaderIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<PrescriptionHeaderModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($prescriptionHeaderIds: [ID!]!) {
						prescriptionHeaderIds: deleteAllPrescriptionHeaderByIds(prescriptionHeaderIds: $prescriptionHeaderIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<PrescriptionHeaderModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PrescriptionHeaderModel>>(
			{
				query: gql`
					query GetAudits {
						audits: prescriptionHeaderAudits {
							entity {
								...PrescriptionHeaderProperties
							}
							timestamp
			...
			map(result => {
				let audits: PrescriptionHeaderModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new PrescriptionHeaderModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<PrescriptionHeaderModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PrescriptionHeaderModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($prescriptionHeaderId: ID!) {
						audits: prescriptionHeaderAuditsByEntityId(prescriptionHeaderId: $prescriptionHeaderId) {
							entity {
								...PrescriptionHeaderProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<PrescriptionHeaderModel>> {
		const url = environment.API_URL + '/api/prescriptionheader/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<PrescriptionHeaderModel>> {
		const url = environment.API_URL + '/api/prescriptionheader/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<PrescriptionHeaderModel>> {
		let apiUrl = environment.API_URL + '/api/prescriptionheader/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<PrescriptionHeaderModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/prescriptionheader/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Prescription Header entities')),
