...
import {TariffPackageServiceAssignmentModel} from '../../models/tariffPackageServiceAssignment/tariff_package_service_assignment.model';
import {TariffPackageServiceAssignmentModelAudit} from '../../models/tariffPackageServiceAssignment/tariff_package_service_assignment.model.state';
...
/**
 * Tariff Package Service Assignment service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class TariffPackageServiceAssignmentService extends AbstractHttpService<TariffPackageServiceAssignmentModel, TariffPackageServiceAssignmentModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the TariffPackageServiceAssignmentProperties classFragment here] off begin
			fragment TariffPackageServiceAssignmentProperties on TariffPackageServiceAssignment {
				...TariffPackageServiceAssignmentBaseProperties
				assignCode
			}
			# % protected region % [Modify the TariffPackageServiceAssignmentProperties classFragment here] end
			${super.fragments('TariffPackageServiceAssignment').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<TariffPackageServiceAssignmentModel>> {
		...
		return  this.apollo.query<PassableStateConfig<TariffPackageServiceAssignmentModel>>(
			{
				query: gql`
					query Count {
						totalCount: countTariffPackageServiceAssignments
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<TariffPackageServiceAssignmentModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<TariffPackageServiceAssignmentModel>> {
		...
		return this.apollo.query<PassableStateConfig<TariffPackageServiceAssignmentModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						TariffPackageServiceAssignmentById: tariffPackageServiceAssignmentById(id: $id) {
							...TariffPackageServiceAssignmentProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.TariffPackageServiceAssignmentById as TariffPackageServiceAssignmentModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<TariffPackageServiceAssignmentModel>> {
		...
		return this.apollo.query<PassableStateConfig<TariffPackageServiceAssignmentModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						tariffPackageServiceAssignments: tariffPackageServiceAssignments(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...TariffPackageServiceAssignmentProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countTariffPackageServiceAssignments(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.tariffPackageServiceAssignments as TariffPackageServiceAssignmentModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<TariffPackageServiceAssignmentModel>> {
		...
		return this.apollo.query<PassableStateConfig<TariffPackageServiceAssignmentModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						tariffPackageServiceAssignments: lastTariffPackageServiceAssignments(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...TariffPackageServiceAssignmentProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: TariffPackageServiceAssignmentModel, queryParams?: QueryParams): Observable<PassableStateConfig<TariffPackageServiceAssignmentModel>> {
		...
		const successMessage = 'Created Tariff Package Service Assignment entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($tariffPackageServiceAssignment: TariffPackageServiceAssignmentInput!, $persistRelations: Boolean) {
						tariffPackageServiceAssignment: createTariffPackageServiceAssignment(tariffPackageServiceAssignment: $tariffPackageServiceAssignment, persistRelations: $persistRelations) {
							...TariffPackageServiceAssignmentProperties,
				...
				`,
				variables: {
					tariffPackageServiceAssignment: {
						...entity.toJSON(),
						tariffPackage: entity.tariffPackage ? new TariffPackageModel(entity.tariffPackage).toJSON() : undefined,
					},
			...
			map(result => {
				...
				return {
					targetModel: result.data.tariffPackageServiceAssignment as TariffPackageServiceAssignmentModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: TariffPackageServiceAssignmentModel[], queryParams?: QueryParams): Observable<PassableStateConfig<TariffPackageServiceAssignmentModel>> {
		...
		const successMessage = 'Created Multiple Tariff Package Service Assignment entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($tariffPackageServiceAssignments: [TariffPackageServiceAssignmentInput!]!) {
						tariffPackageServiceAssignment: createAllTariffPackageServiceAssignment(tariffPackageServiceAssignments: $tariffPackageServiceAssignments) {
							...TariffPackageServiceAssignmentProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					tariffPackageServiceAssignments: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.tariffPackageServiceAssignment as TariffPackageServiceAssignmentModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: TariffPackageServiceAssignmentModel, queryParams?: QueryParams): Observable<PassableStateConfig<TariffPackageServiceAssignmentModel>> {
		...
		const successMessage = 'Updated Tariff Package Service Assignment entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($tariffPackageServiceAssignment: TariffPackageServiceAssignmentInput!, $persistRelations: Boolean) {
						tariffPackageServiceAssignment: updateTariffPackageServiceAssignment(tariffPackageServiceAssignment: $tariffPackageServiceAssignment, persistRelations: $persistRelations) {
							...TariffPackageServiceAssignmentProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: TariffPackageServiceAssignmentModel[], queryParams?: QueryParams): Observable<PassableStateConfig<TariffPackageServiceAssignmentModel>> {
		...
		const successMessage = 'Update Multiple Tariff Package Service Assignment entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($tariffPackageServiceAssignments: [TariffPackageServiceAssignmentInput!]!) {
						tariffPackageServiceAssignment: updateAllTariffPackageServiceAssignment(tariffPackageServiceAssignments: $tariffPackageServiceAssignments) {
							...TariffPackageServiceAssignmentProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<TariffPackageServiceAssignmentModel>> {
		...
		const successMessage = 'Deleted Tariff Package Service Assignment entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($tariffPackageServiceAssignmentId: ID!) {
						tariffPackageServiceAssignmentId: deleteTariffPackageServiceAssignmentById(tariffPackageServiceAssignmentId: $tariffPackageServiceAssignmentId)
				...
				`,
				variables: {
					tariffPackageServiceAssignmentId: id,
			...
			map(result => {
				...
				return {
					targetModelId: result.data.tariffPackageServiceAssignmentId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<TariffPackageServiceAssignmentModel>> {
		...
		const successMessage = 'Deleted selected Tariff Package Service Assignment entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($tariffPackageServiceAssignmentIds: [ID!]!){
						deleteTariffPackageServiceAssignmentExcludingIds(tariffPackageServiceAssignmentIds: $tariffPackageServiceAssignmentIds)
				...
				`,
				variables: {
					tariffPackageServiceAssignmentIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.tariffPackageServiceAssignmentIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<TariffPackageServiceAssignmentModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($tariffPackageServiceAssignmentIds: [ID!]!) {
						tariffPackageServiceAssignmentIds: deleteAllTariffPackageServiceAssignmentByIds(tariffPackageServiceAssignmentIds: $tariffPackageServiceAssignmentIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<TariffPackageServiceAssignmentModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<TariffPackageServiceAssignmentModel>>(
			{
				query: gql`
					query GetAudits {
						audits: tariffPackageServiceAssignmentAudits {
							entity {
								...TariffPackageServiceAssignmentProperties
							}
							timestamp
			...
			map(result => {
				let audits: TariffPackageServiceAssignmentModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new TariffPackageServiceAssignmentModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<TariffPackageServiceAssignmentModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<TariffPackageServiceAssignmentModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($tariffPackageServiceAssignmentId: ID!) {
						audits: tariffPackageServiceAssignmentAuditsByEntityId(tariffPackageServiceAssignmentId: $tariffPackageServiceAssignmentId) {
							entity {
								...TariffPackageServiceAssignmentProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<TariffPackageServiceAssignmentModel>> {
		const url = environment.API_URL + '/api/tariffpackageserviceassignment/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<TariffPackageServiceAssignmentModel>> {
		const url = environment.API_URL + '/api/tariffpackageserviceassignment/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<TariffPackageServiceAssignmentModel>> {
		let apiUrl = environment.API_URL + '/api/tariffpackageserviceassignment/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<TariffPackageServiceAssignmentModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/tariffpackageserviceassignment/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Tariff Package Service Assignment entities')),
