...
import {BatchStockBalancePerDateModel} from '../../models/batchStockBalancePerDate/batch_stock_balance_per_date.model';
import {BatchStockBalancePerDateModelAudit} from '../../models/batchStockBalancePerDate/batch_stock_balance_per_date.model.state';
...
/**
 * Batch Stock Balance Per Date service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BatchStockBalancePerDateService extends AbstractHttpService<BatchStockBalancePerDateModel, BatchStockBalancePerDateModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BatchStockBalancePerDateProperties classFragment here] off begin
			fragment BatchStockBalancePerDateProperties on BatchStockBalancePerDate {
				...BatchStockBalancePerDateBaseProperties
				batchNo
				expirationDate
				asOfDate
				batchQtyUoi
			...
			# % protected region % [Modify the BatchStockBalancePerDateProperties classFragment here] end
			${super.fragments('BatchStockBalancePerDate').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BatchStockBalancePerDateModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BatchStockBalancePerDateModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBatchStockBalancePerDates
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BatchStockBalancePerDateModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BatchStockBalancePerDateModel>> {
		...
		return this.apollo.query<PassableStateConfig<BatchStockBalancePerDateModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BatchStockBalancePerDateById: batchStockBalancePerDateById(id: $id) {
							...BatchStockBalancePerDateProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BatchStockBalancePerDateById as BatchStockBalancePerDateModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BatchStockBalancePerDateModel>> {
		...
		return this.apollo.query<PassableStateConfig<BatchStockBalancePerDateModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						batchStockBalancePerDates: batchStockBalancePerDates(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BatchStockBalancePerDateProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBatchStockBalancePerDates(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.batchStockBalancePerDates as BatchStockBalancePerDateModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BatchStockBalancePerDateModel>> {
		...
		return this.apollo.query<PassableStateConfig<BatchStockBalancePerDateModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						batchStockBalancePerDates: lastBatchStockBalancePerDates(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BatchStockBalancePerDateProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BatchStockBalancePerDateModel, queryParams?: QueryParams): Observable<PassableStateConfig<BatchStockBalancePerDateModel>> {
		...
		const successMessage = 'Created Batch Stock Balance Per Date entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($batchStockBalancePerDate: BatchStockBalancePerDateInput!, $persistRelations: Boolean) {
						batchStockBalancePerDate: createBatchStockBalancePerDate(batchStockBalancePerDate: $batchStockBalancePerDate, persistRelations: $persistRelations) {
							...BatchStockBalancePerDateProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.batchStockBalancePerDate as BatchStockBalancePerDateModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BatchStockBalancePerDateModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BatchStockBalancePerDateModel>> {
		...
		const successMessage = 'Created Multiple Batch Stock Balance Per Date entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($batchStockBalancePerDates: [BatchStockBalancePerDateInput!]!) {
						batchStockBalancePerDate: createAllBatchStockBalancePerDate(batchStockBalancePerDates: $batchStockBalancePerDates) {
							...BatchStockBalancePerDateProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					batchStockBalancePerDates: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.batchStockBalancePerDate as BatchStockBalancePerDateModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BatchStockBalancePerDateModel, queryParams?: QueryParams): Observable<PassableStateConfig<BatchStockBalancePerDateModel>> {
		...
		const successMessage = 'Updated Batch Stock Balance Per Date entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($batchStockBalancePerDate: BatchStockBalancePerDateInput!, $persistRelations: Boolean) {
						batchStockBalancePerDate: updateBatchStockBalancePerDate(batchStockBalancePerDate: $batchStockBalancePerDate, persistRelations: $persistRelations) {
							...BatchStockBalancePerDateProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BatchStockBalancePerDateModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BatchStockBalancePerDateModel>> {
		...
		const successMessage = 'Update Multiple Batch Stock Balance Per Date entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($batchStockBalancePerDates: [BatchStockBalancePerDateInput!]!) {
						batchStockBalancePerDate: updateAllBatchStockBalancePerDate(batchStockBalancePerDates: $batchStockBalancePerDates) {
							...BatchStockBalancePerDateProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BatchStockBalancePerDateModel>> {
		...
		const successMessage = 'Deleted Batch Stock Balance Per Date entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($batchStockBalancePerDateId: ID!) {
						batchStockBalancePerDateId: deleteBatchStockBalancePerDateById(batchStockBalancePerDateId: $batchStockBalancePerDateId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.batchStockBalancePerDateId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BatchStockBalancePerDateModel>> {
		...
		const successMessage = 'Deleted selected Batch Stock Balance Per Date entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($batchStockBalancePerDateIds: [ID!]!){
						deleteBatchStockBalancePerDateExcludingIds(batchStockBalancePerDateIds: $batchStockBalancePerDateIds)
				...
				`,
				variables: {
					batchStockBalancePerDateIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.batchStockBalancePerDateIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BatchStockBalancePerDateModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($batchStockBalancePerDateIds: [ID!]!) {
						batchStockBalancePerDateIds: deleteAllBatchStockBalancePerDateByIds(batchStockBalancePerDateIds: $batchStockBalancePerDateIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BatchStockBalancePerDateModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BatchStockBalancePerDateModel>>(
			{
				query: gql`
					query GetAudits {
						audits: batchStockBalancePerDateAudits {
							entity {
								...BatchStockBalancePerDateProperties
							}
							timestamp
			...
			map(result => {
				let audits: BatchStockBalancePerDateModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BatchStockBalancePerDateModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BatchStockBalancePerDateModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BatchStockBalancePerDateModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($batchStockBalancePerDateId: ID!) {
						audits: batchStockBalancePerDateAuditsByEntityId(batchStockBalancePerDateId: $batchStockBalancePerDateId) {
							entity {
								...BatchStockBalancePerDateProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BatchStockBalancePerDateModel>> {
		const url = environment.API_URL + '/api/batchstockbalanceperdate/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BatchStockBalancePerDateModel>> {
		const url = environment.API_URL + '/api/batchstockbalanceperdate/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BatchStockBalancePerDateModel>> {
		let apiUrl = environment.API_URL + '/api/batchstockbalanceperdate/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BatchStockBalancePerDateModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/batchstockbalanceperdate/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Batch Stock Balance Per Date entities')),
