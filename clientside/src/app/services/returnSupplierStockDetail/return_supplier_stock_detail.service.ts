...
import {ReturnSupplierStockDetailModelAudit} from '../../models/returnSupplierStockDetail/return_supplier_stock_detail.model.state';
...
/**
 * Return Supplier Stock Detail service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class ReturnSupplierStockDetailService extends AbstractHttpService<ReturnSupplierStockDetailModel, ReturnSupplierStockDetailModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the ReturnSupplierStockDetailProperties classFragment here] off begin
			fragment ReturnSupplierStockDetailProperties on ReturnSupplierStockDetail {
				...ReturnSupplierStockDetailBaseProperties
				price
				availableQuantityReturned
				uop
				discountInPercent
				discountValue
				taxable
				...
				quantityOrdered
				quantityReceived
				previousQuantityReturned
				itemNotes
			}
			# % protected region % [Modify the ReturnSupplierStockDetailProperties classFragment here] end
			${super.fragments('ReturnSupplierStockDetail').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<ReturnSupplierStockDetailModel>> {
		...
		return  this.apollo.query<PassableStateConfig<ReturnSupplierStockDetailModel>>(
			{
				query: gql`
					query Count {
						totalCount: countReturnSupplierStockDetails
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<ReturnSupplierStockDetailModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<ReturnSupplierStockDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<ReturnSupplierStockDetailModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						ReturnSupplierStockDetailById: returnSupplierStockDetailById(id: $id) {
							...ReturnSupplierStockDetailProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.ReturnSupplierStockDetailById as ReturnSupplierStockDetailModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<ReturnSupplierStockDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<ReturnSupplierStockDetailModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						returnSupplierStockDetails: returnSupplierStockDetails(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...ReturnSupplierStockDetailProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countReturnSupplierStockDetails(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.returnSupplierStockDetails as ReturnSupplierStockDetailModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<ReturnSupplierStockDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<ReturnSupplierStockDetailModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						returnSupplierStockDetails: lastReturnSupplierStockDetails(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...ReturnSupplierStockDetailProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: ReturnSupplierStockDetailModel, queryParams?: QueryParams): Observable<PassableStateConfig<ReturnSupplierStockDetailModel>> {
		...
		const successMessage = 'Created Return Supplier Stock Detail entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($returnSupplierStockDetail: ReturnSupplierStockDetailInput!, $persistRelations: Boolean) {
						returnSupplierStockDetail: createReturnSupplierStockDetail(returnSupplierStockDetail: $returnSupplierStockDetail, persistRelations: $persistRelations) {
							...ReturnSupplierStockDetailProperties,
				...
				`,
				variables: {
					returnSupplierStockDetail: {
						...entity.toJSON(),
						returnSupplier: entity.returnSupplier ? new ReturnSupplierModel(entity.returnSupplier).toJSON() : undefined,
			...
			map(result => {
				...
				return {
					targetModel: result.data.returnSupplierStockDetail as ReturnSupplierStockDetailModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: ReturnSupplierStockDetailModel[], queryParams?: QueryParams): Observable<PassableStateConfig<ReturnSupplierStockDetailModel>> {
		...
		const successMessage = 'Created Multiple Return Supplier Stock Detail entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($returnSupplierStockDetails: [ReturnSupplierStockDetailInput!]!) {
						returnSupplierStockDetail: createAllReturnSupplierStockDetail(returnSupplierStockDetails: $returnSupplierStockDetails) {
							...ReturnSupplierStockDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					returnSupplierStockDetails: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.returnSupplierStockDetail as ReturnSupplierStockDetailModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: ReturnSupplierStockDetailModel, queryParams?: QueryParams): Observable<PassableStateConfig<ReturnSupplierStockDetailModel>> {
		...
		const successMessage = 'Updated Return Supplier Stock Detail entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($returnSupplierStockDetail: ReturnSupplierStockDetailInput!, $persistRelations: Boolean) {
						returnSupplierStockDetail: updateReturnSupplierStockDetail(returnSupplierStockDetail: $returnSupplierStockDetail, persistRelations: $persistRelations) {
							...ReturnSupplierStockDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: ReturnSupplierStockDetailModel[], queryParams?: QueryParams): Observable<PassableStateConfig<ReturnSupplierStockDetailModel>> {
		...
		const successMessage = 'Update Multiple Return Supplier Stock Detail entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($returnSupplierStockDetails: [ReturnSupplierStockDetailInput!]!) {
						returnSupplierStockDetail: updateAllReturnSupplierStockDetail(returnSupplierStockDetails: $returnSupplierStockDetails) {
							...ReturnSupplierStockDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<ReturnSupplierStockDetailModel>> {
		...
		const successMessage = 'Deleted Return Supplier Stock Detail entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($returnSupplierStockDetailId: ID!) {
						returnSupplierStockDetailId: deleteReturnSupplierStockDetailById(returnSupplierStockDetailId: $returnSupplierStockDetailId)
				...
				`,
				variables: {
					returnSupplierStockDetailId: id,
			...
			map(result => {
				...
				return {
					targetModelId: result.data.returnSupplierStockDetailId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<ReturnSupplierStockDetailModel>> {
		...
		const successMessage = 'Deleted selected Return Supplier Stock Detail entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($returnSupplierStockDetailIds: [ID!]!){
						deleteReturnSupplierStockDetailExcludingIds(returnSupplierStockDetailIds: $returnSupplierStockDetailIds)
				...
				`,
				variables: {
					returnSupplierStockDetailIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.returnSupplierStockDetailIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<ReturnSupplierStockDetailModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($returnSupplierStockDetailIds: [ID!]!) {
						returnSupplierStockDetailIds: deleteAllReturnSupplierStockDetailByIds(returnSupplierStockDetailIds: $returnSupplierStockDetailIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<ReturnSupplierStockDetailModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<ReturnSupplierStockDetailModel>>(
			{
				query: gql`
					query GetAudits {
						audits: returnSupplierStockDetailAudits {
							entity {
								...ReturnSupplierStockDetailProperties
							}
							timestamp
			...
			map(result => {
				let audits: ReturnSupplierStockDetailModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new ReturnSupplierStockDetailModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<ReturnSupplierStockDetailModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<ReturnSupplierStockDetailModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($returnSupplierStockDetailId: ID!) {
						audits: returnSupplierStockDetailAuditsByEntityId(returnSupplierStockDetailId: $returnSupplierStockDetailId) {
							entity {
								...ReturnSupplierStockDetailProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<ReturnSupplierStockDetailModel>> {
		const url = environment.API_URL + '/api/returnsupplierstockdetail/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<ReturnSupplierStockDetailModel>> {
		const url = environment.API_URL + '/api/returnsupplierstockdetail/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<ReturnSupplierStockDetailModel>> {
		let apiUrl = environment.API_URL + '/api/returnsupplierstockdetail/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<ReturnSupplierStockDetailModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/returnsupplierstockdetail/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Return Supplier Stock Detail entities')),
