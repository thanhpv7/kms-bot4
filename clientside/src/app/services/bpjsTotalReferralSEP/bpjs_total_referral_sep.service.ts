...
import {BpjsTotalReferralSEPModelAudit} from '../../models/bpjsTotalReferralSEP/bpjs_total_referral_sep.model.state';
...
/**
 * BPJS Total Referral SEP service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BpjsTotalReferralSEPService extends AbstractHttpService<BpjsTotalReferralSEPModel, BpjsTotalReferralSEPModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BpjsTotalReferralSEPProperties classFragment here] off begin
			fragment BpjsTotalReferralSEPProperties on BpjsTotalReferralSEP {
				...BpjsTotalReferralSEPBaseProperties
				referralType
				referralNo
				totalSEP
			}
			# % protected region % [Modify the BpjsTotalReferralSEPProperties classFragment here] end
			${super.fragments('BpjsTotalReferralSEP').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BpjsTotalReferralSEPModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BpjsTotalReferralSEPModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBpjsTotalReferralSEPs
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BpjsTotalReferralSEPModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsTotalReferralSEPModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsTotalReferralSEPModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BpjsTotalReferralSEPById: bpjsTotalReferralSEPById(id: $id) {
							...BpjsTotalReferralSEPProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BpjsTotalReferralSEPById as BpjsTotalReferralSEPModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsTotalReferralSEPModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsTotalReferralSEPModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						bpjsTotalReferralSEPs: bpjsTotalReferralSEPs(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BpjsTotalReferralSEPProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBpjsTotalReferralSEPs(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.bpjsTotalReferralSEPs as BpjsTotalReferralSEPModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsTotalReferralSEPModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsTotalReferralSEPModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						bpjsTotalReferralSEPs: lastBpjsTotalReferralSEPs(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BpjsTotalReferralSEPProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BpjsTotalReferralSEPModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsTotalReferralSEPModel>> {
		...
		const successMessage = 'Created BPJS Total Referral SEP entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($bpjsTotalReferralSEP: BpjsTotalReferralSEPInput!, $persistRelations: Boolean) {
						bpjsTotalReferralSEP: createBpjsTotalReferralSEP(bpjsTotalReferralSEP: $bpjsTotalReferralSEP, persistRelations: $persistRelations) {
							...BpjsTotalReferralSEPProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.bpjsTotalReferralSEP as BpjsTotalReferralSEPModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BpjsTotalReferralSEPModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsTotalReferralSEPModel>> {
		...
		const successMessage = 'Created Multiple BPJS Total Referral SEP entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($bpjsTotalReferralSEPs: [BpjsTotalReferralSEPInput!]!) {
						bpjsTotalReferralSEP: createAllBpjsTotalReferralSEP(bpjsTotalReferralSEPs: $bpjsTotalReferralSEPs) {
							...BpjsTotalReferralSEPProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					bpjsTotalReferralSEPs: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.bpjsTotalReferralSEP as BpjsTotalReferralSEPModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BpjsTotalReferralSEPModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsTotalReferralSEPModel>> {
		...
		const successMessage = 'Updated BPJS Total Referral SEP entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($bpjsTotalReferralSEP: BpjsTotalReferralSEPInput!, $persistRelations: Boolean) {
						bpjsTotalReferralSEP: updateBpjsTotalReferralSEP(bpjsTotalReferralSEP: $bpjsTotalReferralSEP, persistRelations: $persistRelations) {
							...BpjsTotalReferralSEPProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BpjsTotalReferralSEPModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsTotalReferralSEPModel>> {
		...
		const successMessage = 'Update Multiple BPJS Total Referral SEP entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($bpjsTotalReferralSEPs: [BpjsTotalReferralSEPInput!]!) {
						bpjsTotalReferralSEP: updateAllBpjsTotalReferralSEP(bpjsTotalReferralSEPs: $bpjsTotalReferralSEPs) {
							...BpjsTotalReferralSEPProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BpjsTotalReferralSEPModel>> {
		...
		const successMessage = 'Deleted BPJS Total Referral SEP entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($bpjsTotalReferralSEPId: ID!) {
						bpjsTotalReferralSEPId: deleteBpjsTotalReferralSEPById(bpjsTotalReferralSEPId: $bpjsTotalReferralSEPId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.bpjsTotalReferralSEPId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsTotalReferralSEPModel>> {
		...
		const successMessage = 'Deleted selected BPJS Total Referral SEP entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($bpjsTotalReferralSEPIds: [ID!]!){
						deleteBpjsTotalReferralSEPExcludingIds(bpjsTotalReferralSEPIds: $bpjsTotalReferralSEPIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.bpjsTotalReferralSEPIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BpjsTotalReferralSEPModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($bpjsTotalReferralSEPIds: [ID!]!) {
						bpjsTotalReferralSEPIds: deleteAllBpjsTotalReferralSEPByIds(bpjsTotalReferralSEPIds: $bpjsTotalReferralSEPIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BpjsTotalReferralSEPModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsTotalReferralSEPModel>>(
			{
				query: gql`
					query GetAudits {
						audits: bpjsTotalReferralSEPAudits {
							entity {
								...BpjsTotalReferralSEPProperties
							}
							timestamp
			...
			map(result => {
				let audits: BpjsTotalReferralSEPModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BpjsTotalReferralSEPModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BpjsTotalReferralSEPModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsTotalReferralSEPModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($bpjsTotalReferralSEPId: ID!) {
						audits: bpjsTotalReferralSEPAuditsByEntityId(bpjsTotalReferralSEPId: $bpjsTotalReferralSEPId) {
							entity {
								...BpjsTotalReferralSEPProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BpjsTotalReferralSEPModel>> {
		const url = environment.API_URL + '/api/bpjstotalreferralsep/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BpjsTotalReferralSEPModel>> {
		const url = environment.API_URL + '/api/bpjstotalreferralsep/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsTotalReferralSEPModel>> {
		let apiUrl = environment.API_URL + '/api/bpjstotalreferralsep/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BpjsTotalReferralSEPModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/bpjstotalreferralsep/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' BPJS Total Referral SEP entities')),
