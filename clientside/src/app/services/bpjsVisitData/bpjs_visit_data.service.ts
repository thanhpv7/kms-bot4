...
import {BpjsVisitDataModelAudit} from '../../models/bpjsVisitData/bpjs_visit_data.model.state';
...
/**
 * BPJS Visit Data service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BpjsVisitDataService extends AbstractHttpService<BpjsVisitDataModel, BpjsVisitDataModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BpjsVisitDataProperties classFragment here] off begin
			fragment BpjsVisitDataProperties on BpjsVisitData {
				...BpjsVisitDataBaseProperties
				diagnose
				treatmentType
				treatmentClass
				name
			...
			# % protected region % [Modify the BpjsVisitDataProperties classFragment here] end
			${super.fragments('BpjsVisitData').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BpjsVisitDataModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BpjsVisitDataModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBpjsVisitDatas
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BpjsVisitDataModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsVisitDataModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsVisitDataModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BpjsVisitDataById: bpjsVisitDataById(id: $id) {
							...BpjsVisitDataProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BpjsVisitDataById as BpjsVisitDataModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsVisitDataModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsVisitDataModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						bpjsVisitDatas: bpjsVisitDatas(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BpjsVisitDataProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBpjsVisitDatas(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.bpjsVisitDatas as BpjsVisitDataModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsVisitDataModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsVisitDataModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						bpjsVisitDatas: lastBpjsVisitDatas(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BpjsVisitDataProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BpjsVisitDataModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsVisitDataModel>> {
		...
		const successMessage = 'Created BPJS Visit Data entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($bpjsVisitData: BpjsVisitDataInput!, $persistRelations: Boolean) {
						bpjsVisitData: createBpjsVisitData(bpjsVisitData: $bpjsVisitData, persistRelations: $persistRelations) {
							...BpjsVisitDataProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.bpjsVisitData as BpjsVisitDataModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BpjsVisitDataModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsVisitDataModel>> {
		...
		const successMessage = 'Created Multiple BPJS Visit Data entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($bpjsVisitDatas: [BpjsVisitDataInput!]!) {
						bpjsVisitData: createAllBpjsVisitData(bpjsVisitDatas: $bpjsVisitDatas) {
							...BpjsVisitDataProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					bpjsVisitDatas: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.bpjsVisitData as BpjsVisitDataModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BpjsVisitDataModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsVisitDataModel>> {
		...
		const successMessage = 'Updated BPJS Visit Data entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($bpjsVisitData: BpjsVisitDataInput!, $persistRelations: Boolean) {
						bpjsVisitData: updateBpjsVisitData(bpjsVisitData: $bpjsVisitData, persistRelations: $persistRelations) {
							...BpjsVisitDataProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BpjsVisitDataModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsVisitDataModel>> {
		...
		const successMessage = 'Update Multiple BPJS Visit Data entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($bpjsVisitDatas: [BpjsVisitDataInput!]!) {
						bpjsVisitData: updateAllBpjsVisitData(bpjsVisitDatas: $bpjsVisitDatas) {
							...BpjsVisitDataProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BpjsVisitDataModel>> {
		...
		const successMessage = 'Deleted BPJS Visit Data entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($bpjsVisitDataId: ID!) {
						bpjsVisitDataId: deleteBpjsVisitDataById(bpjsVisitDataId: $bpjsVisitDataId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.bpjsVisitDataId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsVisitDataModel>> {
		...
		const successMessage = 'Deleted selected BPJS Visit Data entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($bpjsVisitDataIds: [ID!]!){
						deleteBpjsVisitDataExcludingIds(bpjsVisitDataIds: $bpjsVisitDataIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.bpjsVisitDataIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BpjsVisitDataModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($bpjsVisitDataIds: [ID!]!) {
						bpjsVisitDataIds: deleteAllBpjsVisitDataByIds(bpjsVisitDataIds: $bpjsVisitDataIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BpjsVisitDataModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsVisitDataModel>>(
			...
			map(result => {
				let audits: BpjsVisitDataModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BpjsVisitDataModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BpjsVisitDataModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsVisitDataModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($bpjsVisitDataId: ID!) {
						audits: bpjsVisitDataAuditsByEntityId(bpjsVisitDataId: $bpjsVisitDataId) {
							entity {
								...BpjsVisitDataProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BpjsVisitDataModel>> {
		const url = environment.API_URL + '/api/bpjsvisitdata/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BpjsVisitDataModel>> {
		const url = environment.API_URL + '/api/bpjsvisitdata/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsVisitDataModel>> {
		let apiUrl = environment.API_URL + '/api/bpjsvisitdata/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BpjsVisitDataModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/bpjsvisitdata/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' BPJS Visit Data entities')),
