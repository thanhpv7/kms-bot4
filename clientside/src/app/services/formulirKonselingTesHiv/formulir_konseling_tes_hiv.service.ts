...
import {FormulirKonselingTesHivModel} from '../../models/formulirKonselingTesHiv/formulir_konseling_tes_hiv.model';
import {FormulirKonselingTesHivModelAudit} from '../../models/formulirKonselingTesHiv/formulir_konseling_tes_hiv.model.state';
...
/**
 * Formulir Konseling Tes Hiv service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class FormulirKonselingTesHivService extends AbstractHttpService<FormulirKonselingTesHivModel, FormulirKonselingTesHivModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the FormulirKonselingTesHivProperties classFragment here] off begin
			fragment FormulirKonselingTesHivProperties on FormulirKonselingTesHiv {
				...FormulirKonselingTesHivBaseProperties
				formData
			}
			# % protected region % [Modify the FormulirKonselingTesHivProperties classFragment here] end
			${super.fragments('FormulirKonselingTesHiv').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<FormulirKonselingTesHivModel>> {
		...
		return  this.apollo.query<PassableStateConfig<FormulirKonselingTesHivModel>>(
			{
				query: gql`
					query Count {
						totalCount: countFormulirKonselingTesHivs
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<FormulirKonselingTesHivModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<FormulirKonselingTesHivModel>> {
		...
		return this.apollo.query<PassableStateConfig<FormulirKonselingTesHivModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						FormulirKonselingTesHivById: formulirKonselingTesHivById(id: $id) {
							...FormulirKonselingTesHivProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.FormulirKonselingTesHivById as FormulirKonselingTesHivModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<FormulirKonselingTesHivModel>> {
		...
		return this.apollo.query<PassableStateConfig<FormulirKonselingTesHivModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						formulirKonselingTesHivs: formulirKonselingTesHivs(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...FormulirKonselingTesHivProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countFormulirKonselingTesHivs(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.formulirKonselingTesHivs as FormulirKonselingTesHivModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<FormulirKonselingTesHivModel>> {
		...
		return this.apollo.query<PassableStateConfig<FormulirKonselingTesHivModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						formulirKonselingTesHivs: lastFormulirKonselingTesHivs(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...FormulirKonselingTesHivProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: FormulirKonselingTesHivModel, queryParams?: QueryParams): Observable<PassableStateConfig<FormulirKonselingTesHivModel>> {
		...
		const successMessage = 'Created Formulir Konseling Tes Hiv entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($formulirKonselingTesHiv: FormulirKonselingTesHivInput!, $persistRelations: Boolean) {
						formulirKonselingTesHiv: createFormulirKonselingTesHiv(formulirKonselingTesHiv: $formulirKonselingTesHiv, persistRelations: $persistRelations) {
							...FormulirKonselingTesHivProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.formulirKonselingTesHiv as FormulirKonselingTesHivModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: FormulirKonselingTesHivModel[], queryParams?: QueryParams): Observable<PassableStateConfig<FormulirKonselingTesHivModel>> {
		...
		const successMessage = 'Created Multiple Formulir Konseling Tes Hiv entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($formulirKonselingTesHivs: [FormulirKonselingTesHivInput!]!) {
						formulirKonselingTesHiv: createAllFormulirKonselingTesHiv(formulirKonselingTesHivs: $formulirKonselingTesHivs) {
							...FormulirKonselingTesHivProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					formulirKonselingTesHivs: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.formulirKonselingTesHiv as FormulirKonselingTesHivModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: FormulirKonselingTesHivModel, queryParams?: QueryParams): Observable<PassableStateConfig<FormulirKonselingTesHivModel>> {
		...
		const successMessage = 'Updated Formulir Konseling Tes Hiv entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($formulirKonselingTesHiv: FormulirKonselingTesHivInput!, $persistRelations: Boolean) {
						formulirKonselingTesHiv: updateFormulirKonselingTesHiv(formulirKonselingTesHiv: $formulirKonselingTesHiv, persistRelations: $persistRelations) {
							...FormulirKonselingTesHivProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: FormulirKonselingTesHivModel[], queryParams?: QueryParams): Observable<PassableStateConfig<FormulirKonselingTesHivModel>> {
		...
		const successMessage = 'Update Multiple Formulir Konseling Tes Hiv entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($formulirKonselingTesHivs: [FormulirKonselingTesHivInput!]!) {
						formulirKonselingTesHiv: updateAllFormulirKonselingTesHiv(formulirKonselingTesHivs: $formulirKonselingTesHivs) {
							...FormulirKonselingTesHivProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<FormulirKonselingTesHivModel>> {
		...
		const successMessage = 'Deleted Formulir Konseling Tes Hiv entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($formulirKonselingTesHivId: ID!) {
						formulirKonselingTesHivId: deleteFormulirKonselingTesHivById(formulirKonselingTesHivId: $formulirKonselingTesHivId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.formulirKonselingTesHivId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<FormulirKonselingTesHivModel>> {
		...
		const successMessage = 'Deleted selected Formulir Konseling Tes Hiv entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($formulirKonselingTesHivIds: [ID!]!){
						deleteFormulirKonselingTesHivExcludingIds(formulirKonselingTesHivIds: $formulirKonselingTesHivIds)
				...
				`,
				variables: {
					formulirKonselingTesHivIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.formulirKonselingTesHivIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<FormulirKonselingTesHivModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($formulirKonselingTesHivIds: [ID!]!) {
						formulirKonselingTesHivIds: deleteAllFormulirKonselingTesHivByIds(formulirKonselingTesHivIds: $formulirKonselingTesHivIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<FormulirKonselingTesHivModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<FormulirKonselingTesHivModel>>(
			{
				query: gql`
					query GetAudits {
						audits: formulirKonselingTesHivAudits {
							entity {
								...FormulirKonselingTesHivProperties
							}
							timestamp
			...
			map(result => {
				let audits: FormulirKonselingTesHivModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new FormulirKonselingTesHivModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<FormulirKonselingTesHivModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<FormulirKonselingTesHivModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($formulirKonselingTesHivId: ID!) {
						audits: formulirKonselingTesHivAuditsByEntityId(formulirKonselingTesHivId: $formulirKonselingTesHivId) {
							entity {
								...FormulirKonselingTesHivProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<FormulirKonselingTesHivModel>> {
		const url = environment.API_URL + '/api/formulirkonselingteshiv/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<FormulirKonselingTesHivModel>> {
		const url = environment.API_URL + '/api/formulirkonselingteshiv/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<FormulirKonselingTesHivModel>> {
		let apiUrl = environment.API_URL + '/api/formulirkonselingteshiv/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<FormulirKonselingTesHivModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/formulirkonselingteshiv/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Formulir Konseling Tes Hiv entities')),
