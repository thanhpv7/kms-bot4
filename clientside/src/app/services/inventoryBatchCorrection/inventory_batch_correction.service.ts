...
import {InventoryBatchCorrectionModel} from '../../models/inventoryBatchCorrection/inventory_batch_correction.model';
import {InventoryBatchCorrectionModelAudit} from '../../models/inventoryBatchCorrection/inventory_batch_correction.model.state';
...
/**
 * Inventory Batch Correction service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class InventoryBatchCorrectionService extends AbstractHttpService<InventoryBatchCorrectionModel, InventoryBatchCorrectionModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the InventoryBatchCorrectionProperties classFragment here] off begin
			fragment InventoryBatchCorrectionProperties on InventoryBatchCorrection {
				...InventoryBatchCorrectionBaseProperties
			...
			# % protected region % [Modify the InventoryBatchCorrectionProperties classFragment here] end
			${super.fragments('InventoryBatchCorrection').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<InventoryBatchCorrectionModel>> {
		...
		return  this.apollo.query<PassableStateConfig<InventoryBatchCorrectionModel>>(
			{
				query: gql`
					query Count {
						totalCount: countInventoryBatchCorrections
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<InventoryBatchCorrectionModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<InventoryBatchCorrectionModel>> {
		...
		return this.apollo.query<PassableStateConfig<InventoryBatchCorrectionModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						InventoryBatchCorrectionById: inventoryBatchCorrectionById(id: $id) {
							...InventoryBatchCorrectionProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.InventoryBatchCorrectionById as InventoryBatchCorrectionModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<InventoryBatchCorrectionModel>> {
		...
		return this.apollo.query<PassableStateConfig<InventoryBatchCorrectionModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						inventoryBatchCorrections: inventoryBatchCorrections(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...InventoryBatchCorrectionProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countInventoryBatchCorrections(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.inventoryBatchCorrections as InventoryBatchCorrectionModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<InventoryBatchCorrectionModel>> {
		...
		return this.apollo.query<PassableStateConfig<InventoryBatchCorrectionModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						inventoryBatchCorrections: lastInventoryBatchCorrections(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...InventoryBatchCorrectionProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: InventoryBatchCorrectionModel, queryParams?: QueryParams): Observable<PassableStateConfig<InventoryBatchCorrectionModel>> {
		...
		const successMessage = 'Created Inventory Batch Correction entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($inventoryBatchCorrection: InventoryBatchCorrectionInput!, $persistRelations: Boolean) {
						inventoryBatchCorrection: createInventoryBatchCorrection(inventoryBatchCorrection: $inventoryBatchCorrection, persistRelations: $persistRelations) {
							...InventoryBatchCorrectionProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.inventoryBatchCorrection as InventoryBatchCorrectionModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: InventoryBatchCorrectionModel[], queryParams?: QueryParams): Observable<PassableStateConfig<InventoryBatchCorrectionModel>> {
		...
		const successMessage = 'Created Multiple Inventory Batch Correction entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($inventoryBatchCorrections: [InventoryBatchCorrectionInput!]!) {
						inventoryBatchCorrection: createAllInventoryBatchCorrection(inventoryBatchCorrections: $inventoryBatchCorrections) {
							...InventoryBatchCorrectionProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					inventoryBatchCorrections: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.inventoryBatchCorrection as InventoryBatchCorrectionModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: InventoryBatchCorrectionModel, queryParams?: QueryParams): Observable<PassableStateConfig<InventoryBatchCorrectionModel>> {
		...
		const successMessage = 'Updated Inventory Batch Correction entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($inventoryBatchCorrection: InventoryBatchCorrectionInput!, $persistRelations: Boolean) {
						inventoryBatchCorrection: updateInventoryBatchCorrection(inventoryBatchCorrection: $inventoryBatchCorrection, persistRelations: $persistRelations) {
							...InventoryBatchCorrectionProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: InventoryBatchCorrectionModel[], queryParams?: QueryParams): Observable<PassableStateConfig<InventoryBatchCorrectionModel>> {
		...
		const successMessage = 'Update Multiple Inventory Batch Correction entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($inventoryBatchCorrections: [InventoryBatchCorrectionInput!]!) {
						inventoryBatchCorrection: updateAllInventoryBatchCorrection(inventoryBatchCorrections: $inventoryBatchCorrections) {
							...InventoryBatchCorrectionProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<InventoryBatchCorrectionModel>> {
		...
		const successMessage = 'Deleted Inventory Batch Correction entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($inventoryBatchCorrectionId: ID!) {
						inventoryBatchCorrectionId: deleteInventoryBatchCorrectionById(inventoryBatchCorrectionId: $inventoryBatchCorrectionId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.inventoryBatchCorrectionId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<InventoryBatchCorrectionModel>> {
		...
		const successMessage = 'Deleted selected Inventory Batch Correction entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($inventoryBatchCorrectionIds: [ID!]!){
						deleteInventoryBatchCorrectionExcludingIds(inventoryBatchCorrectionIds: $inventoryBatchCorrectionIds)
				...
				`,
				variables: {
					inventoryBatchCorrectionIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.inventoryBatchCorrectionIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<InventoryBatchCorrectionModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($inventoryBatchCorrectionIds: [ID!]!) {
						inventoryBatchCorrectionIds: deleteAllInventoryBatchCorrectionByIds(inventoryBatchCorrectionIds: $inventoryBatchCorrectionIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<InventoryBatchCorrectionModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<InventoryBatchCorrectionModel>>(
			{
				query: gql`
					query GetAudits {
						audits: inventoryBatchCorrectionAudits {
							entity {
								...InventoryBatchCorrectionProperties
							}
							timestamp
			...
			map(result => {
				let audits: InventoryBatchCorrectionModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new InventoryBatchCorrectionModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<InventoryBatchCorrectionModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<InventoryBatchCorrectionModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($inventoryBatchCorrectionId: ID!) {
						audits: inventoryBatchCorrectionAuditsByEntityId(inventoryBatchCorrectionId: $inventoryBatchCorrectionId) {
							entity {
								...InventoryBatchCorrectionProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<InventoryBatchCorrectionModel>> {
		const url = environment.API_URL + '/api/inventorybatchcorrection/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<InventoryBatchCorrectionModel>> {
		const url = environment.API_URL + '/api/inventorybatchcorrection/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<InventoryBatchCorrectionModel>> {
		let apiUrl = environment.API_URL + '/api/inventorybatchcorrection/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<InventoryBatchCorrectionModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/inventorybatchcorrection/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Inventory Batch Correction entities')),
