...
import {PurchaseOrderStockDetailModel} from '../../models/purchaseOrderStockDetail/purchase_order_stock_detail.model';
import {PurchaseOrderStockDetailModelAudit} from '../../models/purchaseOrderStockDetail/purchase_order_stock_detail.model.state';
...
/**
 * Purchase Order Stock Detail service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class PurchaseOrderStockDetailService extends AbstractHttpService<PurchaseOrderStockDetailModel, PurchaseOrderStockDetailModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the PurchaseOrderStockDetailProperties classFragment here] off begin
			fragment PurchaseOrderStockDetailProperties on PurchaseOrderStockDetail {
				...PurchaseOrderStockDetailBaseProperties
				unitPrice
				quantityOrdered
				uop
				discountInPercent
			...
			# % protected region % [Modify the PurchaseOrderStockDetailProperties classFragment here] end
			${super.fragments('PurchaseOrderStockDetail').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<PurchaseOrderStockDetailModel>> {
		...
		return  this.apollo.query<PassableStateConfig<PurchaseOrderStockDetailModel>>(
			{
				query: gql`
					query Count {
						totalCount: countPurchaseOrderStockDetails
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<PurchaseOrderStockDetailModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<PurchaseOrderStockDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<PurchaseOrderStockDetailModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						PurchaseOrderStockDetailById: purchaseOrderStockDetailById(id: $id) {
							...PurchaseOrderStockDetailProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.PurchaseOrderStockDetailById as PurchaseOrderStockDetailModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PurchaseOrderStockDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<PurchaseOrderStockDetailModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						purchaseOrderStockDetails: purchaseOrderStockDetails(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...PurchaseOrderStockDetailProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countPurchaseOrderStockDetails(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.purchaseOrderStockDetails as PurchaseOrderStockDetailModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PurchaseOrderStockDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<PurchaseOrderStockDetailModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						purchaseOrderStockDetails: lastPurchaseOrderStockDetails(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...PurchaseOrderStockDetailProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: PurchaseOrderStockDetailModel, queryParams?: QueryParams): Observable<PassableStateConfig<PurchaseOrderStockDetailModel>> {
		...
		const successMessage = 'Created Purchase Order Stock Detail entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($purchaseOrderStockDetail: PurchaseOrderStockDetailInput!, $persistRelations: Boolean) {
						purchaseOrderStockDetail: createPurchaseOrderStockDetail(purchaseOrderStockDetail: $purchaseOrderStockDetail, persistRelations: $persistRelations) {
							...PurchaseOrderStockDetailProperties,
				...
				variables: {
					purchaseOrderStockDetail: {
						...entity.toJSON(),
						purchaseOrder: entity.purchaseOrder ? new PurchaseOrderModel(entity.purchaseOrder).toJSON() : undefined,
						purchaseRequisitionStockDetail: entity.purchaseRequisitionStockDetail ? new PurchaseRequisitionStockDetailModel(entity.purchaseRequisitionStockDetail).toJSON() : undefined,
			...
			map(result => {
				...
				return {
					targetModel: result.data.purchaseOrderStockDetail as PurchaseOrderStockDetailModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: PurchaseOrderStockDetailModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PurchaseOrderStockDetailModel>> {
		...
		const successMessage = 'Created Multiple Purchase Order Stock Detail entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($purchaseOrderStockDetails: [PurchaseOrderStockDetailInput!]!) {
						purchaseOrderStockDetail: createAllPurchaseOrderStockDetail(purchaseOrderStockDetails: $purchaseOrderStockDetails) {
							...PurchaseOrderStockDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					purchaseOrderStockDetails: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.purchaseOrderStockDetail as PurchaseOrderStockDetailModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: PurchaseOrderStockDetailModel, queryParams?: QueryParams): Observable<PassableStateConfig<PurchaseOrderStockDetailModel>> {
		...
		const successMessage = 'Updated Purchase Order Stock Detail entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($purchaseOrderStockDetail: PurchaseOrderStockDetailInput!, $persistRelations: Boolean) {
						purchaseOrderStockDetail: updatePurchaseOrderStockDetail(purchaseOrderStockDetail: $purchaseOrderStockDetail, persistRelations: $persistRelations) {
							...PurchaseOrderStockDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: PurchaseOrderStockDetailModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PurchaseOrderStockDetailModel>> {
		...
		const successMessage = 'Update Multiple Purchase Order Stock Detail entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($purchaseOrderStockDetails: [PurchaseOrderStockDetailInput!]!) {
						purchaseOrderStockDetail: updateAllPurchaseOrderStockDetail(purchaseOrderStockDetails: $purchaseOrderStockDetails) {
							...PurchaseOrderStockDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<PurchaseOrderStockDetailModel>> {
		...
		const successMessage = 'Deleted Purchase Order Stock Detail entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($purchaseOrderStockDetailId: ID!) {
						purchaseOrderStockDetailId: deletePurchaseOrderStockDetailById(purchaseOrderStockDetailId: $purchaseOrderStockDetailId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.purchaseOrderStockDetailId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<PurchaseOrderStockDetailModel>> {
		...
		const successMessage = 'Deleted selected Purchase Order Stock Detail entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($purchaseOrderStockDetailIds: [ID!]!){
						deletePurchaseOrderStockDetailExcludingIds(purchaseOrderStockDetailIds: $purchaseOrderStockDetailIds)
				...
				`,
				variables: {
					purchaseOrderStockDetailIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.purchaseOrderStockDetailIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<PurchaseOrderStockDetailModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($purchaseOrderStockDetailIds: [ID!]!) {
						purchaseOrderStockDetailIds: deleteAllPurchaseOrderStockDetailByIds(purchaseOrderStockDetailIds: $purchaseOrderStockDetailIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<PurchaseOrderStockDetailModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PurchaseOrderStockDetailModel>>(
			{
				query: gql`
					query GetAudits {
						audits: purchaseOrderStockDetailAudits {
							entity {
								...PurchaseOrderStockDetailProperties
							}
							timestamp
			...
			map(result => {
				let audits: PurchaseOrderStockDetailModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new PurchaseOrderStockDetailModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<PurchaseOrderStockDetailModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PurchaseOrderStockDetailModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($purchaseOrderStockDetailId: ID!) {
						audits: purchaseOrderStockDetailAuditsByEntityId(purchaseOrderStockDetailId: $purchaseOrderStockDetailId) {
							entity {
								...PurchaseOrderStockDetailProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<PurchaseOrderStockDetailModel>> {
		const url = environment.API_URL + '/api/purchaseorderstockdetail/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<PurchaseOrderStockDetailModel>> {
		const url = environment.API_URL + '/api/purchaseorderstockdetail/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<PurchaseOrderStockDetailModel>> {
		let apiUrl = environment.API_URL + '/api/purchaseorderstockdetail/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<PurchaseOrderStockDetailModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/purchaseorderstockdetail/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Purchase Order Stock Detail entities')),
