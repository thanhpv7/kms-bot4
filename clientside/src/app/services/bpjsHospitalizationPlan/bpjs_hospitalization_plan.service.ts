...
import {BpjsHospitalizationPlanModel} from '../../models/bpjsHospitalizationPlan/bpjs_hospitalization_plan.model';
import {BpjsHospitalizationPlanModelAudit} from '../../models/bpjsHospitalizationPlan/bpjs_hospitalization_plan.model.state';
...
/**
 * BPJS Hospitalization Plan service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BpjsHospitalizationPlanService extends AbstractHttpService<BpjsHospitalizationPlanModel, BpjsHospitalizationPlanModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BpjsHospitalizationPlanProperties classFragment here] off begin
			fragment BpjsHospitalizationPlanProperties on BpjsHospitalizationPlan {
				...BpjsHospitalizationPlanBaseProperties
				nokartu
				tglrencanakontrol
				nospri
				diagnosa
			}
			# % protected region % [Modify the BpjsHospitalizationPlanProperties classFragment here] end
			${super.fragments('BpjsHospitalizationPlan').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BpjsHospitalizationPlanModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BpjsHospitalizationPlanModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBpjsHospitalizationPlans
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BpjsHospitalizationPlanModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsHospitalizationPlanModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsHospitalizationPlanModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BpjsHospitalizationPlanById: bpjsHospitalizationPlanById(id: $id) {
							...BpjsHospitalizationPlanProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BpjsHospitalizationPlanById as BpjsHospitalizationPlanModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsHospitalizationPlanModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsHospitalizationPlanModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						bpjsHospitalizationPlans: bpjsHospitalizationPlans(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BpjsHospitalizationPlanProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBpjsHospitalizationPlans(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.bpjsHospitalizationPlans as BpjsHospitalizationPlanModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsHospitalizationPlanModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsHospitalizationPlanModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						bpjsHospitalizationPlans: lastBpjsHospitalizationPlans(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BpjsHospitalizationPlanProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BpjsHospitalizationPlanModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsHospitalizationPlanModel>> {
		...
		const successMessage = 'Created BPJS Hospitalization Plan entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($bpjsHospitalizationPlan: BpjsHospitalizationPlanInput!, $persistRelations: Boolean) {
						bpjsHospitalizationPlan: createBpjsHospitalizationPlan(bpjsHospitalizationPlan: $bpjsHospitalizationPlan, persistRelations: $persistRelations) {
							...BpjsHospitalizationPlanProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.bpjsHospitalizationPlan as BpjsHospitalizationPlanModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BpjsHospitalizationPlanModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsHospitalizationPlanModel>> {
		...
		const successMessage = 'Created Multiple BPJS Hospitalization Plan entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($bpjsHospitalizationPlans: [BpjsHospitalizationPlanInput!]!) {
						bpjsHospitalizationPlan: createAllBpjsHospitalizationPlan(bpjsHospitalizationPlans: $bpjsHospitalizationPlans) {
							...BpjsHospitalizationPlanProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					bpjsHospitalizationPlans: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.bpjsHospitalizationPlan as BpjsHospitalizationPlanModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BpjsHospitalizationPlanModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsHospitalizationPlanModel>> {
		...
		const successMessage = 'Updated BPJS Hospitalization Plan entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($bpjsHospitalizationPlan: BpjsHospitalizationPlanInput!, $persistRelations: Boolean) {
						bpjsHospitalizationPlan: updateBpjsHospitalizationPlan(bpjsHospitalizationPlan: $bpjsHospitalizationPlan, persistRelations: $persistRelations) {
							...BpjsHospitalizationPlanProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BpjsHospitalizationPlanModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsHospitalizationPlanModel>> {
		...
		const successMessage = 'Update Multiple BPJS Hospitalization Plan entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($bpjsHospitalizationPlans: [BpjsHospitalizationPlanInput!]!) {
						bpjsHospitalizationPlan: updateAllBpjsHospitalizationPlan(bpjsHospitalizationPlans: $bpjsHospitalizationPlans) {
							...BpjsHospitalizationPlanProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BpjsHospitalizationPlanModel>> {
		...
		const successMessage = 'Deleted BPJS Hospitalization Plan entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($bpjsHospitalizationPlanId: ID!) {
						bpjsHospitalizationPlanId: deleteBpjsHospitalizationPlanById(bpjsHospitalizationPlanId: $bpjsHospitalizationPlanId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.bpjsHospitalizationPlanId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsHospitalizationPlanModel>> {
		...
		const successMessage = 'Deleted selected BPJS Hospitalization Plan entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($bpjsHospitalizationPlanIds: [ID!]!){
						deleteBpjsHospitalizationPlanExcludingIds(bpjsHospitalizationPlanIds: $bpjsHospitalizationPlanIds)
				...
				`,
				variables: {
					bpjsHospitalizationPlanIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.bpjsHospitalizationPlanIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BpjsHospitalizationPlanModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($bpjsHospitalizationPlanIds: [ID!]!) {
						bpjsHospitalizationPlanIds: deleteAllBpjsHospitalizationPlanByIds(bpjsHospitalizationPlanIds: $bpjsHospitalizationPlanIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BpjsHospitalizationPlanModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsHospitalizationPlanModel>>(
			{
				query: gql`
					query GetAudits {
						audits: bpjsHospitalizationPlanAudits {
							entity {
								...BpjsHospitalizationPlanProperties
							}
							timestamp
			...
			map(result => {
				let audits: BpjsHospitalizationPlanModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BpjsHospitalizationPlanModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BpjsHospitalizationPlanModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsHospitalizationPlanModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($bpjsHospitalizationPlanId: ID!) {
						audits: bpjsHospitalizationPlanAuditsByEntityId(bpjsHospitalizationPlanId: $bpjsHospitalizationPlanId) {
							entity {
								...BpjsHospitalizationPlanProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BpjsHospitalizationPlanModel>> {
		const url = environment.API_URL + '/api/bpjshospitalizationplan/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BpjsHospitalizationPlanModel>> {
		const url = environment.API_URL + '/api/bpjshospitalizationplan/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsHospitalizationPlanModel>> {
		let apiUrl = environment.API_URL + '/api/bpjshospitalizationplan/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BpjsHospitalizationPlanModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/bpjshospitalizationplan/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' BPJS Hospitalization Plan entities')),
