...
import {LibraryModelAudit} from '../../models/library/library.model.state';
...
/**
 * Library service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class LibraryService extends AbstractHttpService<LibraryModel, LibraryModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the LibraryProperties classFragment here] off begin
			fragment LibraryProperties on Library {
				...LibraryBaseProperties
				libraryDocument {
					id
					created
					modified
			...
			# % protected region % [Modify the LibraryProperties classFragment here] end
			${super.fragments('Library').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<LibraryModel>> {
		...
		return  this.apollo.query<PassableStateConfig<LibraryModel>>(
			{
				query: gql`
					query Count {
						totalCount: countLibrarys
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<LibraryModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<LibraryModel>> {
		...
		return this.apollo.query<PassableStateConfig<LibraryModel>>(
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.LibraryById as LibraryModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<LibraryModel>> {
		...
		return this.apollo.query<PassableStateConfig<LibraryModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						librarys: librarys(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...LibraryProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countLibrarys(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.librarys as LibraryModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<LibraryModel>> {
		...
		return this.apollo.query<PassableStateConfig<LibraryModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						librarys: lastLibrarys(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...LibraryProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: LibraryModel, queryParams?: QueryParams): Observable<PassableStateConfig<LibraryModel>> {
		...
		const successMessage = 'Created Library entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($library: LibraryInput!, $persistRelations: Boolean) {
						library: createLibrary(library: $library, persistRelations: $persistRelations) {
							...LibraryProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.library as LibraryModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: LibraryModel[], queryParams?: QueryParams): Observable<PassableStateConfig<LibraryModel>> {
		...
		const successMessage = 'Created Multiple Library entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($librarys: [LibraryInput!]!) {
						library: createAllLibrary(librarys: $librarys) {
							...LibraryProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					librarys: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.library as LibraryModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: LibraryModel, queryParams?: QueryParams): Observable<PassableStateConfig<LibraryModel>> {
		...
		const successMessage = 'Updated Library entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($library: LibraryInput!, $persistRelations: Boolean) {
						library: updateLibrary(library: $library, persistRelations: $persistRelations) {
							...LibraryProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: LibraryModel[], queryParams?: QueryParams): Observable<PassableStateConfig<LibraryModel>> {
		...
		const successMessage = 'Update Multiple Library entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($librarys: [LibraryInput!]!) {
						library: updateAllLibrary(librarys: $librarys) {
							...LibraryProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<LibraryModel>> {
		...
		const successMessage = 'Deleted Library entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($libraryId: ID!) {
						libraryId: deleteLibraryById(libraryId: $libraryId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.libraryId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<LibraryModel>> {
		...
		const successMessage = 'Deleted selected Library entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($libraryIds: [ID!]!){
						deleteLibraryExcludingIds(libraryIds: $libraryIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.libraryIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<LibraryModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($libraryIds: [ID!]!) {
						libraryIds: deleteAllLibraryByIds(libraryIds: $libraryIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<LibraryModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<LibraryModel>>(
			...
			map(result => {
				let audits: LibraryModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new LibraryModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<LibraryModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<LibraryModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($libraryId: ID!) {
						audits: libraryAuditsByEntityId(libraryId: $libraryId) {
							entity {
								...LibraryProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<LibraryModel>> {
		const url = environment.API_URL + '/api/library/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<LibraryModel>> {
		const url = environment.API_URL + '/api/library/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<LibraryModel>> {
		let apiUrl = environment.API_URL + '/api/library/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<LibraryModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/library/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Library entities')),
