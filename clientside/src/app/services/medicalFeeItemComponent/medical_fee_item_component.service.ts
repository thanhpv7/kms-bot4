...
import {MedicalFeeItemComponentModel} from '../../models/medicalFeeItemComponent/medical_fee_item_component.model';
import {MedicalFeeItemComponentModelAudit} from '../../models/medicalFeeItemComponent/medical_fee_item_component.model.state';
...
/**
 * Medical Fee Item Component service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class MedicalFeeItemComponentService extends AbstractHttpService<MedicalFeeItemComponentModel, MedicalFeeItemComponentModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the MedicalFeeItemComponentProperties classFragment here] off begin
			fragment MedicalFeeItemComponentProperties on MedicalFeeItemComponent {
				...MedicalFeeItemComponentBaseProperties
				price
				medicalStaffCode
				notes
			}
			# % protected region % [Modify the MedicalFeeItemComponentProperties classFragment here] end
			${super.fragments('MedicalFeeItemComponent').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<MedicalFeeItemComponentModel>> {
		...
		return  this.apollo.query<PassableStateConfig<MedicalFeeItemComponentModel>>(
			{
				query: gql`
					query Count {
						totalCount: countMedicalFeeItemComponents
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<MedicalFeeItemComponentModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<MedicalFeeItemComponentModel>> {
		...
		return this.apollo.query<PassableStateConfig<MedicalFeeItemComponentModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						MedicalFeeItemComponentById: medicalFeeItemComponentById(id: $id) {
							...MedicalFeeItemComponentProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.MedicalFeeItemComponentById as MedicalFeeItemComponentModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<MedicalFeeItemComponentModel>> {
		...
		return this.apollo.query<PassableStateConfig<MedicalFeeItemComponentModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						medicalFeeItemComponents: medicalFeeItemComponents(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...MedicalFeeItemComponentProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countMedicalFeeItemComponents(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.medicalFeeItemComponents as MedicalFeeItemComponentModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<MedicalFeeItemComponentModel>> {
		...
		return this.apollo.query<PassableStateConfig<MedicalFeeItemComponentModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						medicalFeeItemComponents: lastMedicalFeeItemComponents(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...MedicalFeeItemComponentProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: MedicalFeeItemComponentModel, queryParams?: QueryParams): Observable<PassableStateConfig<MedicalFeeItemComponentModel>> {
		...
		const successMessage = 'Created Medical Fee Item Component entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($medicalFeeItemComponent: MedicalFeeItemComponentInput!, $persistRelations: Boolean) {
						medicalFeeItemComponent: createMedicalFeeItemComponent(medicalFeeItemComponent: $medicalFeeItemComponent, persistRelations: $persistRelations) {
							...MedicalFeeItemComponentProperties,
				...
				`,
				variables: {
					medicalFeeItemComponent: {
						...entity.toJSON(),
						medicalFee: entity.medicalFee ? new MedicalFeeModel(entity.medicalFee).toJSON() : undefined,
			...
			map(result => {
				...
				return {
					targetModel: result.data.medicalFeeItemComponent as MedicalFeeItemComponentModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: MedicalFeeItemComponentModel[], queryParams?: QueryParams): Observable<PassableStateConfig<MedicalFeeItemComponentModel>> {
		...
		const successMessage = 'Created Multiple Medical Fee Item Component entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($medicalFeeItemComponents: [MedicalFeeItemComponentInput!]!) {
						medicalFeeItemComponent: createAllMedicalFeeItemComponent(medicalFeeItemComponents: $medicalFeeItemComponents) {
							...MedicalFeeItemComponentProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					medicalFeeItemComponents: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.medicalFeeItemComponent as MedicalFeeItemComponentModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: MedicalFeeItemComponentModel, queryParams?: QueryParams): Observable<PassableStateConfig<MedicalFeeItemComponentModel>> {
		...
		const successMessage = 'Updated Medical Fee Item Component entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($medicalFeeItemComponent: MedicalFeeItemComponentInput!, $persistRelations: Boolean) {
						medicalFeeItemComponent: updateMedicalFeeItemComponent(medicalFeeItemComponent: $medicalFeeItemComponent, persistRelations: $persistRelations) {
							...MedicalFeeItemComponentProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: MedicalFeeItemComponentModel[], queryParams?: QueryParams): Observable<PassableStateConfig<MedicalFeeItemComponentModel>> {
		...
		const successMessage = 'Update Multiple Medical Fee Item Component entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($medicalFeeItemComponents: [MedicalFeeItemComponentInput!]!) {
						medicalFeeItemComponent: updateAllMedicalFeeItemComponent(medicalFeeItemComponents: $medicalFeeItemComponents) {
							...MedicalFeeItemComponentProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<MedicalFeeItemComponentModel>> {
		...
		const successMessage = 'Deleted Medical Fee Item Component entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($medicalFeeItemComponentId: ID!) {
						medicalFeeItemComponentId: deleteMedicalFeeItemComponentById(medicalFeeItemComponentId: $medicalFeeItemComponentId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.medicalFeeItemComponentId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<MedicalFeeItemComponentModel>> {
		...
		const successMessage = 'Deleted selected Medical Fee Item Component entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($medicalFeeItemComponentIds: [ID!]!){
						deleteMedicalFeeItemComponentExcludingIds(medicalFeeItemComponentIds: $medicalFeeItemComponentIds)
				...
				`,
				variables: {
					medicalFeeItemComponentIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.medicalFeeItemComponentIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<MedicalFeeItemComponentModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($medicalFeeItemComponentIds: [ID!]!) {
						medicalFeeItemComponentIds: deleteAllMedicalFeeItemComponentByIds(medicalFeeItemComponentIds: $medicalFeeItemComponentIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<MedicalFeeItemComponentModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<MedicalFeeItemComponentModel>>(
			{
				query: gql`
					query GetAudits {
						audits: medicalFeeItemComponentAudits {
							entity {
								...MedicalFeeItemComponentProperties
							}
							timestamp
			...
			map(result => {
				let audits: MedicalFeeItemComponentModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new MedicalFeeItemComponentModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<MedicalFeeItemComponentModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<MedicalFeeItemComponentModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($medicalFeeItemComponentId: ID!) {
						audits: medicalFeeItemComponentAuditsByEntityId(medicalFeeItemComponentId: $medicalFeeItemComponentId) {
							entity {
								...MedicalFeeItemComponentProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<MedicalFeeItemComponentModel>> {
		const url = environment.API_URL + '/api/medicalfeeitemcomponent/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<MedicalFeeItemComponentModel>> {
		const url = environment.API_URL + '/api/medicalfeeitemcomponent/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<MedicalFeeItemComponentModel>> {
		let apiUrl = environment.API_URL + '/api/medicalfeeitemcomponent/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<MedicalFeeItemComponentModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/medicalfeeitemcomponent/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Medical Fee Item Component entities')),
