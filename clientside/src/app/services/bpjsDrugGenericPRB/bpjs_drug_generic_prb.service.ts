...
import {BpjsDrugGenericPRBModel} from '../../models/bpjsDrugGenericPRB/bpjs_drug_generic_prb.model';
import {BpjsDrugGenericPRBModelAudit} from '../../models/bpjsDrugGenericPRB/bpjs_drug_generic_prb.model.state';
...
/**
 * BPJS Drug Generic PRB service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BpjsDrugGenericPRBService extends AbstractHttpService<BpjsDrugGenericPRBModel, BpjsDrugGenericPRBModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BpjsDrugGenericPRBProperties classFragment here] off begin
			fragment BpjsDrugGenericPRBProperties on BpjsDrugGenericPRB {
				...BpjsDrugGenericPRBBaseProperties
				refDrugCode
				refDrugName
			}
			# % protected region % [Modify the BpjsDrugGenericPRBProperties classFragment here] end
			${super.fragments('BpjsDrugGenericPRB').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BpjsDrugGenericPRBModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BpjsDrugGenericPRBModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBpjsDrugGenericPRBs
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BpjsDrugGenericPRBModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsDrugGenericPRBModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsDrugGenericPRBModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BpjsDrugGenericPRBById: bpjsDrugGenericPRBById(id: $id) {
							...BpjsDrugGenericPRBProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BpjsDrugGenericPRBById as BpjsDrugGenericPRBModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsDrugGenericPRBModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsDrugGenericPRBModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						bpjsDrugGenericPRBs: bpjsDrugGenericPRBs(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BpjsDrugGenericPRBProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBpjsDrugGenericPRBs(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.bpjsDrugGenericPRBs as BpjsDrugGenericPRBModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsDrugGenericPRBModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsDrugGenericPRBModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						bpjsDrugGenericPRBs: lastBpjsDrugGenericPRBs(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BpjsDrugGenericPRBProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BpjsDrugGenericPRBModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsDrugGenericPRBModel>> {
		...
		const successMessage = 'Created BPJS Drug Generic PRB entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($bpjsDrugGenericPRB: BpjsDrugGenericPRBInput!, $persistRelations: Boolean) {
						bpjsDrugGenericPRB: createBpjsDrugGenericPRB(bpjsDrugGenericPRB: $bpjsDrugGenericPRB, persistRelations: $persistRelations) {
							...BpjsDrugGenericPRBProperties,
				...
				variables: {
					bpjsDrugGenericPRB: {
						...
						bpjsPRBDetails: entity.bpjsPRBDetails ? entity.bpjsPRBDetails?.map((model: BpjsPRBDetailModel) => new BpjsPRBDetailModel(model).toJSON()) : [],
					},
			...
			map(result => {
				...
				return {
					targetModel: result.data.bpjsDrugGenericPRB as BpjsDrugGenericPRBModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BpjsDrugGenericPRBModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsDrugGenericPRBModel>> {
		...
		const successMessage = 'Created Multiple BPJS Drug Generic PRB entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($bpjsDrugGenericPRBs: [BpjsDrugGenericPRBInput!]!) {
						bpjsDrugGenericPRB: createAllBpjsDrugGenericPRB(bpjsDrugGenericPRBs: $bpjsDrugGenericPRBs) {
							...BpjsDrugGenericPRBProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					bpjsDrugGenericPRBs: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.bpjsDrugGenericPRB as BpjsDrugGenericPRBModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BpjsDrugGenericPRBModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsDrugGenericPRBModel>> {
		...
		const successMessage = 'Updated BPJS Drug Generic PRB entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($bpjsDrugGenericPRB: BpjsDrugGenericPRBInput!, $persistRelations: Boolean) {
						bpjsDrugGenericPRB: updateBpjsDrugGenericPRB(bpjsDrugGenericPRB: $bpjsDrugGenericPRB, persistRelations: $persistRelations) {
							...BpjsDrugGenericPRBProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BpjsDrugGenericPRBModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsDrugGenericPRBModel>> {
		...
		const successMessage = 'Update Multiple BPJS Drug Generic PRB entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($bpjsDrugGenericPRBs: [BpjsDrugGenericPRBInput!]!) {
						bpjsDrugGenericPRB: updateAllBpjsDrugGenericPRB(bpjsDrugGenericPRBs: $bpjsDrugGenericPRBs) {
							...BpjsDrugGenericPRBProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BpjsDrugGenericPRBModel>> {
		...
		const successMessage = 'Deleted BPJS Drug Generic PRB entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($bpjsDrugGenericPRBId: ID!) {
						bpjsDrugGenericPRBId: deleteBpjsDrugGenericPRBById(bpjsDrugGenericPRBId: $bpjsDrugGenericPRBId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.bpjsDrugGenericPRBId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsDrugGenericPRBModel>> {
		...
		const successMessage = 'Deleted selected BPJS Drug Generic PRB entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($bpjsDrugGenericPRBIds: [ID!]!){
						deleteBpjsDrugGenericPRBExcludingIds(bpjsDrugGenericPRBIds: $bpjsDrugGenericPRBIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.bpjsDrugGenericPRBIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BpjsDrugGenericPRBModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($bpjsDrugGenericPRBIds: [ID!]!) {
						bpjsDrugGenericPRBIds: deleteAllBpjsDrugGenericPRBByIds(bpjsDrugGenericPRBIds: $bpjsDrugGenericPRBIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BpjsDrugGenericPRBModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsDrugGenericPRBModel>>(
			{
				query: gql`
					query GetAudits {
						audits: bpjsDrugGenericPRBAudits {
							entity {
								...BpjsDrugGenericPRBProperties
							}
							timestamp
			...
			map(result => {
				let audits: BpjsDrugGenericPRBModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BpjsDrugGenericPRBModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BpjsDrugGenericPRBModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsDrugGenericPRBModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($bpjsDrugGenericPRBId: ID!) {
						audits: bpjsDrugGenericPRBAuditsByEntityId(bpjsDrugGenericPRBId: $bpjsDrugGenericPRBId) {
							entity {
								...BpjsDrugGenericPRBProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BpjsDrugGenericPRBModel>> {
		const url = environment.API_URL + '/api/bpjsdruggenericprb/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BpjsDrugGenericPRBModel>> {
		const url = environment.API_URL + '/api/bpjsdruggenericprb/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsDrugGenericPRBModel>> {
		let apiUrl = environment.API_URL + '/api/bpjsdruggenericprb/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BpjsDrugGenericPRBModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/bpjsdruggenericprb/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' BPJS Drug Generic PRB entities')),
