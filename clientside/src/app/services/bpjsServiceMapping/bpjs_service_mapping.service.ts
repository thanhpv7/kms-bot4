...
import {BpjsServiceMappingModel} from '../../models/bpjsServiceMapping/bpjs_service_mapping.model';
import {BpjsServiceMappingModelAudit} from '../../models/bpjsServiceMapping/bpjs_service_mapping.model.state';
...
/**
 * BPJS Service Mapping service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BpjsServiceMappingService extends AbstractHttpService<BpjsServiceMappingModel, BpjsServiceMappingModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BpjsServiceMappingProperties classFragment here] off begin
			fragment BpjsServiceMappingProperties on BpjsServiceMapping {
				...BpjsServiceMappingBaseProperties
				refCode
				refService
				kodeSubspesialis
				namaSubspesialis
			...
			# % protected region % [Modify the BpjsServiceMappingProperties classFragment here] end
			${super.fragments('BpjsServiceMapping').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BpjsServiceMappingModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BpjsServiceMappingModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBpjsServiceMappings
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BpjsServiceMappingModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsServiceMappingModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsServiceMappingModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BpjsServiceMappingById: bpjsServiceMappingById(id: $id) {
							...BpjsServiceMappingProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BpjsServiceMappingById as BpjsServiceMappingModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsServiceMappingModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsServiceMappingModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						bpjsServiceMappings: bpjsServiceMappings(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BpjsServiceMappingProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBpjsServiceMappings(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.bpjsServiceMappings as BpjsServiceMappingModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsServiceMappingModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsServiceMappingModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						bpjsServiceMappings: lastBpjsServiceMappings(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BpjsServiceMappingProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BpjsServiceMappingModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsServiceMappingModel>> {
		...
		const successMessage = 'Created BPJS Service Mapping entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($bpjsServiceMapping: BpjsServiceMappingInput!, $persistRelations: Boolean) {
						bpjsServiceMapping: createBpjsServiceMapping(bpjsServiceMapping: $bpjsServiceMapping, persistRelations: $persistRelations) {
							...BpjsServiceMappingProperties,
				...
				variables: {
					bpjsServiceMapping: {
						...
						bpjsControlPlans: entity.bpjsControlPlans ? entity.bpjsControlPlans?.map((model: BpjsControlPlanModel) => new BpjsControlPlanModel(model).toJSON()) : [],
						...
						polikontrol: entity.polikontrol ? entity.polikontrol?.map((model: BpjsHospitalizationPlanModel) => new BpjsHospitalizationPlanModel(model).toJSON()) : [],
					},
			...
			map(result => {
				...
				return {
					targetModel: result.data.bpjsServiceMapping as BpjsServiceMappingModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BpjsServiceMappingModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsServiceMappingModel>> {
		...
		const successMessage = 'Created Multiple BPJS Service Mapping entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($bpjsServiceMappings: [BpjsServiceMappingInput!]!) {
						bpjsServiceMapping: createAllBpjsServiceMapping(bpjsServiceMappings: $bpjsServiceMappings) {
							...BpjsServiceMappingProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					bpjsServiceMappings: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.bpjsServiceMapping as BpjsServiceMappingModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BpjsServiceMappingModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsServiceMappingModel>> {
		...
		const successMessage = 'Updated BPJS Service Mapping entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($bpjsServiceMapping: BpjsServiceMappingInput!, $persistRelations: Boolean) {
						bpjsServiceMapping: updateBpjsServiceMapping(bpjsServiceMapping: $bpjsServiceMapping, persistRelations: $persistRelations) {
							...BpjsServiceMappingProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BpjsServiceMappingModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsServiceMappingModel>> {
		...
		const successMessage = 'Update Multiple BPJS Service Mapping entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($bpjsServiceMappings: [BpjsServiceMappingInput!]!) {
						bpjsServiceMapping: updateAllBpjsServiceMapping(bpjsServiceMappings: $bpjsServiceMappings) {
							...BpjsServiceMappingProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BpjsServiceMappingModel>> {
		...
		const successMessage = 'Deleted BPJS Service Mapping entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($bpjsServiceMappingId: ID!) {
						bpjsServiceMappingId: deleteBpjsServiceMappingById(bpjsServiceMappingId: $bpjsServiceMappingId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.bpjsServiceMappingId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsServiceMappingModel>> {
		...
		const successMessage = 'Deleted selected BPJS Service Mapping entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($bpjsServiceMappingIds: [ID!]!){
						deleteBpjsServiceMappingExcludingIds(bpjsServiceMappingIds: $bpjsServiceMappingIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.bpjsServiceMappingIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BpjsServiceMappingModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($bpjsServiceMappingIds: [ID!]!) {
						bpjsServiceMappingIds: deleteAllBpjsServiceMappingByIds(bpjsServiceMappingIds: $bpjsServiceMappingIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BpjsServiceMappingModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsServiceMappingModel>>(
			{
				query: gql`
					query GetAudits {
						audits: bpjsServiceMappingAudits {
							entity {
								...BpjsServiceMappingProperties
							}
							timestamp
			...
			map(result => {
				let audits: BpjsServiceMappingModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BpjsServiceMappingModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BpjsServiceMappingModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsServiceMappingModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($bpjsServiceMappingId: ID!) {
						audits: bpjsServiceMappingAuditsByEntityId(bpjsServiceMappingId: $bpjsServiceMappingId) {
							entity {
								...BpjsServiceMappingProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BpjsServiceMappingModel>> {
		const url = environment.API_URL + '/api/bpjsservicemapping/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BpjsServiceMappingModel>> {
		const url = environment.API_URL + '/api/bpjsservicemapping/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsServiceMappingModel>> {
		let apiUrl = environment.API_URL + '/api/bpjsservicemapping/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BpjsServiceMappingModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/bpjsservicemapping/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' BPJS Service Mapping entities')),
