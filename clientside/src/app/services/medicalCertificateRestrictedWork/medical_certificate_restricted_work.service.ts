...
import {MedicalCertificateRestrictedWorkModelAudit} from '../../models/medicalCertificateRestrictedWork/medical_certificate_restricted_work.model.state';
...
/**
 * Medical Certificate Restricted Work service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class MedicalCertificateRestrictedWorkService extends AbstractHttpService<MedicalCertificateRestrictedWorkModel, MedicalCertificateRestrictedWorkModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the MedicalCertificateRestrictedWorkProperties classFragment here] off begin
			fragment MedicalCertificateRestrictedWorkProperties on MedicalCertificateRestrictedWork {
				...MedicalCertificateRestrictedWorkBaseProperties
				period
				startDate
				endDate
				notes
			}
			# % protected region % [Modify the MedicalCertificateRestrictedWorkProperties classFragment here] end
			${super.fragments('MedicalCertificateRestrictedWork').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<MedicalCertificateRestrictedWorkModel>> {
		...
		return  this.apollo.query<PassableStateConfig<MedicalCertificateRestrictedWorkModel>>(
			{
				query: gql`
					query Count {
						totalCount: countMedicalCertificateRestrictedWorks
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<MedicalCertificateRestrictedWorkModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<MedicalCertificateRestrictedWorkModel>> {
		...
		return this.apollo.query<PassableStateConfig<MedicalCertificateRestrictedWorkModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						MedicalCertificateRestrictedWorkById: medicalCertificateRestrictedWorkById(id: $id) {
							...MedicalCertificateRestrictedWorkProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.MedicalCertificateRestrictedWorkById as MedicalCertificateRestrictedWorkModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<MedicalCertificateRestrictedWorkModel>> {
		...
		return this.apollo.query<PassableStateConfig<MedicalCertificateRestrictedWorkModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						medicalCertificateRestrictedWorks: medicalCertificateRestrictedWorks(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...MedicalCertificateRestrictedWorkProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countMedicalCertificateRestrictedWorks(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.medicalCertificateRestrictedWorks as MedicalCertificateRestrictedWorkModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<MedicalCertificateRestrictedWorkModel>> {
		...
		return this.apollo.query<PassableStateConfig<MedicalCertificateRestrictedWorkModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						medicalCertificateRestrictedWorks: lastMedicalCertificateRestrictedWorks(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...MedicalCertificateRestrictedWorkProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: MedicalCertificateRestrictedWorkModel, queryParams?: QueryParams): Observable<PassableStateConfig<MedicalCertificateRestrictedWorkModel>> {
		...
		const successMessage = 'Created Medical Certificate Restricted Work entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($medicalCertificateRestrictedWork: MedicalCertificateRestrictedWorkInput!, $persistRelations: Boolean) {
						medicalCertificateRestrictedWork: createMedicalCertificateRestrictedWork(medicalCertificateRestrictedWork: $medicalCertificateRestrictedWork, persistRelations: $persistRelations) {
							...MedicalCertificateRestrictedWorkProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.medicalCertificateRestrictedWork as MedicalCertificateRestrictedWorkModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: MedicalCertificateRestrictedWorkModel[], queryParams?: QueryParams): Observable<PassableStateConfig<MedicalCertificateRestrictedWorkModel>> {
		...
		const successMessage = 'Created Multiple Medical Certificate Restricted Work entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($medicalCertificateRestrictedWorks: [MedicalCertificateRestrictedWorkInput!]!) {
						medicalCertificateRestrictedWork: createAllMedicalCertificateRestrictedWork(medicalCertificateRestrictedWorks: $medicalCertificateRestrictedWorks) {
							...MedicalCertificateRestrictedWorkProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					medicalCertificateRestrictedWorks: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.medicalCertificateRestrictedWork as MedicalCertificateRestrictedWorkModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: MedicalCertificateRestrictedWorkModel, queryParams?: QueryParams): Observable<PassableStateConfig<MedicalCertificateRestrictedWorkModel>> {
		...
		const successMessage = 'Updated Medical Certificate Restricted Work entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($medicalCertificateRestrictedWork: MedicalCertificateRestrictedWorkInput!, $persistRelations: Boolean) {
						medicalCertificateRestrictedWork: updateMedicalCertificateRestrictedWork(medicalCertificateRestrictedWork: $medicalCertificateRestrictedWork, persistRelations: $persistRelations) {
							...MedicalCertificateRestrictedWorkProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: MedicalCertificateRestrictedWorkModel[], queryParams?: QueryParams): Observable<PassableStateConfig<MedicalCertificateRestrictedWorkModel>> {
		...
		const successMessage = 'Update Multiple Medical Certificate Restricted Work entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($medicalCertificateRestrictedWorks: [MedicalCertificateRestrictedWorkInput!]!) {
						medicalCertificateRestrictedWork: updateAllMedicalCertificateRestrictedWork(medicalCertificateRestrictedWorks: $medicalCertificateRestrictedWorks) {
							...MedicalCertificateRestrictedWorkProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<MedicalCertificateRestrictedWorkModel>> {
		...
		const successMessage = 'Deleted Medical Certificate Restricted Work entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($medicalCertificateRestrictedWorkId: ID!) {
						medicalCertificateRestrictedWorkId: deleteMedicalCertificateRestrictedWorkById(medicalCertificateRestrictedWorkId: $medicalCertificateRestrictedWorkId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.medicalCertificateRestrictedWorkId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<MedicalCertificateRestrictedWorkModel>> {
		...
		const successMessage = 'Deleted selected Medical Certificate Restricted Work entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($medicalCertificateRestrictedWorkIds: [ID!]!){
						deleteMedicalCertificateRestrictedWorkExcludingIds(medicalCertificateRestrictedWorkIds: $medicalCertificateRestrictedWorkIds)
				...
				`,
				variables: {
					medicalCertificateRestrictedWorkIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.medicalCertificateRestrictedWorkIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<MedicalCertificateRestrictedWorkModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($medicalCertificateRestrictedWorkIds: [ID!]!) {
						medicalCertificateRestrictedWorkIds: deleteAllMedicalCertificateRestrictedWorkByIds(medicalCertificateRestrictedWorkIds: $medicalCertificateRestrictedWorkIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<MedicalCertificateRestrictedWorkModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<MedicalCertificateRestrictedWorkModel>>(
			{
				query: gql`
					query GetAudits {
						audits: medicalCertificateRestrictedWorkAudits {
							entity {
								...MedicalCertificateRestrictedWorkProperties
							}
							timestamp
			...
			map(result => {
				let audits: MedicalCertificateRestrictedWorkModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new MedicalCertificateRestrictedWorkModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<MedicalCertificateRestrictedWorkModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<MedicalCertificateRestrictedWorkModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($medicalCertificateRestrictedWorkId: ID!) {
						audits: medicalCertificateRestrictedWorkAuditsByEntityId(medicalCertificateRestrictedWorkId: $medicalCertificateRestrictedWorkId) {
							entity {
								...MedicalCertificateRestrictedWorkProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<MedicalCertificateRestrictedWorkModel>> {
		const url = environment.API_URL + '/api/medicalcertificaterestrictedwork/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<MedicalCertificateRestrictedWorkModel>> {
		const url = environment.API_URL + '/api/medicalcertificaterestrictedwork/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<MedicalCertificateRestrictedWorkModel>> {
		let apiUrl = environment.API_URL + '/api/medicalcertificaterestrictedwork/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<MedicalCertificateRestrictedWorkModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/medicalcertificaterestrictedwork/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Medical Certificate Restricted Work entities')),
