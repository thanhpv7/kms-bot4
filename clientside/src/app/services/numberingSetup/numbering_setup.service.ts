...
import {NumberingSetupModel} from '../../models/numberingSetup/numbering_setup.model';
import {NumberingSetupModelAudit} from '../../models/numberingSetup/numbering_setup.model.state';
...
/**
 * Numbering Setup service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class NumberingSetupService extends AbstractHttpService<NumberingSetupModel, NumberingSetupModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the NumberingSetupProperties classFragment here] off begin
			fragment NumberingSetupProperties on NumberingSetup {
				...NumberingSetupBaseProperties
				numberingType
				prefix
				dateFormat
				sufix
			...
			# % protected region % [Modify the NumberingSetupProperties classFragment here] end
			${super.fragments('NumberingSetup').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<NumberingSetupModel>> {
		...
		return  this.apollo.query<PassableStateConfig<NumberingSetupModel>>(
			{
				query: gql`
					query Count {
						totalCount: countNumberingSetups
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<NumberingSetupModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<NumberingSetupModel>> {
		...
		return this.apollo.query<PassableStateConfig<NumberingSetupModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						NumberingSetupById: numberingSetupById(id: $id) {
							...NumberingSetupProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.NumberingSetupById as NumberingSetupModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<NumberingSetupModel>> {
		...
		return this.apollo.query<PassableStateConfig<NumberingSetupModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						numberingSetups: numberingSetups(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...NumberingSetupProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countNumberingSetups(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.numberingSetups as NumberingSetupModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<NumberingSetupModel>> {
		...
		return this.apollo.query<PassableStateConfig<NumberingSetupModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						numberingSetups: lastNumberingSetups(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...NumberingSetupProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: NumberingSetupModel, queryParams?: QueryParams): Observable<PassableStateConfig<NumberingSetupModel>> {
		...
		const successMessage = 'Created Numbering Setup entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($numberingSetup: NumberingSetupInput!, $persistRelations: Boolean) {
						numberingSetup: createNumberingSetup(numberingSetup: $numberingSetup, persistRelations: $persistRelations) {
							...NumberingSetupProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.numberingSetup as NumberingSetupModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: NumberingSetupModel[], queryParams?: QueryParams): Observable<PassableStateConfig<NumberingSetupModel>> {
		...
		const successMessage = 'Created Multiple Numbering Setup entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($numberingSetups: [NumberingSetupInput!]!) {
						numberingSetup: createAllNumberingSetup(numberingSetups: $numberingSetups) {
							...NumberingSetupProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					numberingSetups: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.numberingSetup as NumberingSetupModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: NumberingSetupModel, queryParams?: QueryParams): Observable<PassableStateConfig<NumberingSetupModel>> {
		...
		const successMessage = 'Updated Numbering Setup entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($numberingSetup: NumberingSetupInput!, $persistRelations: Boolean) {
						numberingSetup: updateNumberingSetup(numberingSetup: $numberingSetup, persistRelations: $persistRelations) {
							...NumberingSetupProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: NumberingSetupModel[], queryParams?: QueryParams): Observable<PassableStateConfig<NumberingSetupModel>> {
		...
		const successMessage = 'Update Multiple Numbering Setup entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($numberingSetups: [NumberingSetupInput!]!) {
						numberingSetup: updateAllNumberingSetup(numberingSetups: $numberingSetups) {
							...NumberingSetupProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<NumberingSetupModel>> {
		...
		const successMessage = 'Deleted Numbering Setup entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($numberingSetupId: ID!) {
						numberingSetupId: deleteNumberingSetupById(numberingSetupId: $numberingSetupId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.numberingSetupId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<NumberingSetupModel>> {
		...
		const successMessage = 'Deleted selected Numbering Setup entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($numberingSetupIds: [ID!]!){
						deleteNumberingSetupExcludingIds(numberingSetupIds: $numberingSetupIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.numberingSetupIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<NumberingSetupModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($numberingSetupIds: [ID!]!) {
						numberingSetupIds: deleteAllNumberingSetupByIds(numberingSetupIds: $numberingSetupIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<NumberingSetupModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<NumberingSetupModel>>(
			...
			map(result => {
				let audits: NumberingSetupModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new NumberingSetupModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<NumberingSetupModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<NumberingSetupModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($numberingSetupId: ID!) {
						audits: numberingSetupAuditsByEntityId(numberingSetupId: $numberingSetupId) {
							entity {
								...NumberingSetupProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<NumberingSetupModel>> {
		const url = environment.API_URL + '/api/numberingsetup/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<NumberingSetupModel>> {
		const url = environment.API_URL + '/api/numberingsetup/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<NumberingSetupModel>> {
		let apiUrl = environment.API_URL + '/api/numberingsetup/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<NumberingSetupModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/numberingsetup/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Numbering Setup entities')),
