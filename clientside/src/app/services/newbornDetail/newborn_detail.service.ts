...
import {NewbornDetailModelAudit} from '../../models/newbornDetail/newborn_detail.model.state';
...
/**
 * Newborn Detail service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class NewbornDetailService extends AbstractHttpService<NewbornDetailModel, NewbornDetailModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the NewbornDetailProperties classFragment here] off begin
			fragment NewbornDetailProperties on NewbornDetail {
				...NewbornDetailBaseProperties
				newbornFirstName
				newbornLastName
				dateTimeOfBirth
				gender
			...
			# % protected region % [Modify the NewbornDetailProperties classFragment here] end
			${super.fragments('NewbornDetail').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<NewbornDetailModel>> {
		...
		return  this.apollo.query<PassableStateConfig<NewbornDetailModel>>(
			{
				query: gql`
					query Count {
						totalCount: countNewbornDetails
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<NewbornDetailModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<NewbornDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<NewbornDetailModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						NewbornDetailById: newbornDetailById(id: $id) {
							...NewbornDetailProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.NewbornDetailById as NewbornDetailModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<NewbornDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<NewbornDetailModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						newbornDetails: newbornDetails(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...NewbornDetailProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countNewbornDetails(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.newbornDetails as NewbornDetailModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<NewbornDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<NewbornDetailModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						newbornDetails: lastNewbornDetails(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...NewbornDetailProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: NewbornDetailModel, queryParams?: QueryParams): Observable<PassableStateConfig<NewbornDetailModel>> {
		...
		const successMessage = 'Created Newborn Detail entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($newbornDetail: NewbornDetailInput!, $persistRelations: Boolean) {
						newbornDetail: createNewbornDetail(newbornDetail: $newbornDetail, persistRelations: $persistRelations) {
							...NewbornDetailProperties,
				...
				variables: {
					newbornDetail: {
						...
						vitalSigns: entity.vitalSigns ? entity.vitalSigns?.map((model: VitalSignsModel) => new VitalSignsModel(model).toJSON()) : [],
					},
			...
			map(result => {
				...
				return {
					targetModel: result.data.newbornDetail as NewbornDetailModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: NewbornDetailModel[], queryParams?: QueryParams): Observable<PassableStateConfig<NewbornDetailModel>> {
		...
		const successMessage = 'Created Multiple Newborn Detail entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($newbornDetails: [NewbornDetailInput!]!) {
						newbornDetail: createAllNewbornDetail(newbornDetails: $newbornDetails) {
							...NewbornDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					newbornDetails: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.newbornDetail as NewbornDetailModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: NewbornDetailModel, queryParams?: QueryParams): Observable<PassableStateConfig<NewbornDetailModel>> {
		...
		const successMessage = 'Updated Newborn Detail entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($newbornDetail: NewbornDetailInput!, $persistRelations: Boolean) {
						newbornDetail: updateNewbornDetail(newbornDetail: $newbornDetail, persistRelations: $persistRelations) {
							...NewbornDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: NewbornDetailModel[], queryParams?: QueryParams): Observable<PassableStateConfig<NewbornDetailModel>> {
		...
		const successMessage = 'Update Multiple Newborn Detail entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($newbornDetails: [NewbornDetailInput!]!) {
						newbornDetail: updateAllNewbornDetail(newbornDetails: $newbornDetails) {
							...NewbornDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<NewbornDetailModel>> {
		...
		const successMessage = 'Deleted Newborn Detail entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($newbornDetailId: ID!) {
						newbornDetailId: deleteNewbornDetailById(newbornDetailId: $newbornDetailId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.newbornDetailId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<NewbornDetailModel>> {
		...
		const successMessage = 'Deleted selected Newborn Detail entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($newbornDetailIds: [ID!]!){
						deleteNewbornDetailExcludingIds(newbornDetailIds: $newbornDetailIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.newbornDetailIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<NewbornDetailModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($newbornDetailIds: [ID!]!) {
						newbornDetailIds: deleteAllNewbornDetailByIds(newbornDetailIds: $newbornDetailIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<NewbornDetailModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<NewbornDetailModel>>(
			...
			map(result => {
				let audits: NewbornDetailModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new NewbornDetailModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<NewbornDetailModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<NewbornDetailModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($newbornDetailId: ID!) {
						audits: newbornDetailAuditsByEntityId(newbornDetailId: $newbornDetailId) {
							entity {
								...NewbornDetailProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<NewbornDetailModel>> {
		const url = environment.API_URL + '/api/newborndetail/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<NewbornDetailModel>> {
		const url = environment.API_URL + '/api/newborndetail/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<NewbornDetailModel>> {
		let apiUrl = environment.API_URL + '/api/newborndetail/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<NewbornDetailModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/newborndetail/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Newborn Detail entities')),
