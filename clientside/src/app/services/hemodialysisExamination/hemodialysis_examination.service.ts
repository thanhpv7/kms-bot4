...
import {HemodialysisExaminationModelAudit} from '../../models/hemodialysisExamination/hemodialysis_examination.model.state';
...
/**
 * Hemodialysis Examination service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class HemodialysisExaminationService extends AbstractHttpService<HemodialysisExaminationModel, HemodialysisExaminationModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the HemodialysisExaminationProperties classFragment here] off begin
			fragment HemodialysisExaminationProperties on HemodialysisExamination {
				...HemodialysisExaminationBaseProperties
				firstDialysis
				dialysisFrequency
				dialysisNo
				hemodialysisType
				...
				vascularAccess
				heparinization
				heparinizationInitialDose
				heparinizationFollowUpDose
				dialyzer
				dialyzerType
				dialysisFluid
				dryWeight
				dryWeightUnit
				weightUponArrival
				weightUponArrivalUnit
				weightDuringPreviousHemodialysis
				weightDuringPreviousHemodialysisUnit
				antiHIV
				hbsag
				antiHCV
				hemodialysisStartTime
				hemodialysisEndTime
				target
				primingVolume
				remainingPriming
				...
				totalFluidOutput
				fluidBalance
				postHemodialysisEvaluation
			}
			# % protected region % [Modify the HemodialysisExaminationProperties classFragment here] end
			${super.fragments('HemodialysisExamination').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<HemodialysisExaminationModel>> {
		...
		return  this.apollo.query<PassableStateConfig<HemodialysisExaminationModel>>(
			{
				query: gql`
					query Count {
						totalCount: countHemodialysisExaminations
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<HemodialysisExaminationModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<HemodialysisExaminationModel>> {
		...
		return this.apollo.query<PassableStateConfig<HemodialysisExaminationModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						HemodialysisExaminationById: hemodialysisExaminationById(id: $id) {
							...HemodialysisExaminationProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.HemodialysisExaminationById as HemodialysisExaminationModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<HemodialysisExaminationModel>> {
		...
		return this.apollo.query<PassableStateConfig<HemodialysisExaminationModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						hemodialysisExaminations: hemodialysisExaminations(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...HemodialysisExaminationProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countHemodialysisExaminations(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.hemodialysisExaminations as HemodialysisExaminationModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<HemodialysisExaminationModel>> {
		...
		return this.apollo.query<PassableStateConfig<HemodialysisExaminationModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						hemodialysisExaminations: lastHemodialysisExaminations(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...HemodialysisExaminationProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: HemodialysisExaminationModel, queryParams?: QueryParams): Observable<PassableStateConfig<HemodialysisExaminationModel>> {
		...
		const successMessage = 'Created Hemodialysis Examination entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($hemodialysisExamination: HemodialysisExaminationInput!, $persistRelations: Boolean) {
						hemodialysisExamination: createHemodialysisExamination(hemodialysisExamination: $hemodialysisExamination, persistRelations: $persistRelations) {
							...HemodialysisExaminationProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.hemodialysisExamination as HemodialysisExaminationModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: HemodialysisExaminationModel[], queryParams?: QueryParams): Observable<PassableStateConfig<HemodialysisExaminationModel>> {
		...
		const successMessage = 'Created Multiple Hemodialysis Examination entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($hemodialysisExaminations: [HemodialysisExaminationInput!]!) {
						hemodialysisExamination: createAllHemodialysisExamination(hemodialysisExaminations: $hemodialysisExaminations) {
							...HemodialysisExaminationProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					hemodialysisExaminations: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.hemodialysisExamination as HemodialysisExaminationModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: HemodialysisExaminationModel, queryParams?: QueryParams): Observable<PassableStateConfig<HemodialysisExaminationModel>> {
		...
		const successMessage = 'Updated Hemodialysis Examination entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($hemodialysisExamination: HemodialysisExaminationInput!, $persistRelations: Boolean) {
						hemodialysisExamination: updateHemodialysisExamination(hemodialysisExamination: $hemodialysisExamination, persistRelations: $persistRelations) {
							...HemodialysisExaminationProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: HemodialysisExaminationModel[], queryParams?: QueryParams): Observable<PassableStateConfig<HemodialysisExaminationModel>> {
		...
		const successMessage = 'Update Multiple Hemodialysis Examination entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($hemodialysisExaminations: [HemodialysisExaminationInput!]!) {
						hemodialysisExamination: updateAllHemodialysisExamination(hemodialysisExaminations: $hemodialysisExaminations) {
							...HemodialysisExaminationProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<HemodialysisExaminationModel>> {
		...
		const successMessage = 'Deleted Hemodialysis Examination entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($hemodialysisExaminationId: ID!) {
						hemodialysisExaminationId: deleteHemodialysisExaminationById(hemodialysisExaminationId: $hemodialysisExaminationId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.hemodialysisExaminationId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<HemodialysisExaminationModel>> {
		...
		const successMessage = 'Deleted selected Hemodialysis Examination entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($hemodialysisExaminationIds: [ID!]!){
						deleteHemodialysisExaminationExcludingIds(hemodialysisExaminationIds: $hemodialysisExaminationIds)
				...
				`,
				variables: {
					hemodialysisExaminationIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.hemodialysisExaminationIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<HemodialysisExaminationModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($hemodialysisExaminationIds: [ID!]!) {
						hemodialysisExaminationIds: deleteAllHemodialysisExaminationByIds(hemodialysisExaminationIds: $hemodialysisExaminationIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<HemodialysisExaminationModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<HemodialysisExaminationModel>>(
			{
				query: gql`
					query GetAudits {
						audits: hemodialysisExaminationAudits {
							entity {
								...HemodialysisExaminationProperties
							}
							timestamp
			...
			map(result => {
				let audits: HemodialysisExaminationModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new HemodialysisExaminationModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<HemodialysisExaminationModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<HemodialysisExaminationModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($hemodialysisExaminationId: ID!) {
						audits: hemodialysisExaminationAuditsByEntityId(hemodialysisExaminationId: $hemodialysisExaminationId) {
							entity {
								...HemodialysisExaminationProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<HemodialysisExaminationModel>> {
		const url = environment.API_URL + '/api/hemodialysisexamination/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<HemodialysisExaminationModel>> {
		const url = environment.API_URL + '/api/hemodialysisexamination/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<HemodialysisExaminationModel>> {
		let apiUrl = environment.API_URL + '/api/hemodialysisexamination/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<HemodialysisExaminationModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/hemodialysisexamination/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Hemodialysis Examination entities')),
