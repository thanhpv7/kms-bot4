...
import {BpjsSEPSubmissionModelAudit} from '../../models/bpjsSEPSubmission/bpjs_sep_submission.model.state';
...
/**
 * BPJS SEP Submission service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BpjsSEPSubmissionService extends AbstractHttpService<BpjsSEPSubmissionModel, BpjsSEPSubmissionModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BpjsSEPSubmissionProperties classFragment here] off begin
			fragment BpjsSEPSubmissionProperties on BpjsSEPSubmission {
				...BpjsSEPSubmissionBaseProperties
				status
				submissionType
				sepDate
				treatmentType
			...
			# % protected region % [Modify the BpjsSEPSubmissionProperties classFragment here] end
			${super.fragments('BpjsSEPSubmission').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BpjsSEPSubmissionModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BpjsSEPSubmissionModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBpjsSEPSubmissions
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BpjsSEPSubmissionModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsSEPSubmissionModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsSEPSubmissionModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BpjsSEPSubmissionById: bpjsSEPSubmissionById(id: $id) {
							...BpjsSEPSubmissionProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BpjsSEPSubmissionById as BpjsSEPSubmissionModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsSEPSubmissionModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsSEPSubmissionModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						bpjsSEPSubmissions: bpjsSEPSubmissions(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BpjsSEPSubmissionProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBpjsSEPSubmissions(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.bpjsSEPSubmissions as BpjsSEPSubmissionModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsSEPSubmissionModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsSEPSubmissionModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						bpjsSEPSubmissions: lastBpjsSEPSubmissions(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BpjsSEPSubmissionProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BpjsSEPSubmissionModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsSEPSubmissionModel>> {
		...
		const successMessage = 'Created BPJS SEP Submission entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($bpjsSEPSubmission: BpjsSEPSubmissionInput!, $persistRelations: Boolean) {
						bpjsSEPSubmission: createBpjsSEPSubmission(bpjsSEPSubmission: $bpjsSEPSubmission, persistRelations: $persistRelations) {
							...BpjsSEPSubmissionProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.bpjsSEPSubmission as BpjsSEPSubmissionModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BpjsSEPSubmissionModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsSEPSubmissionModel>> {
		...
		const successMessage = 'Created Multiple BPJS SEP Submission entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($bpjsSEPSubmissions: [BpjsSEPSubmissionInput!]!) {
						bpjsSEPSubmission: createAllBpjsSEPSubmission(bpjsSEPSubmissions: $bpjsSEPSubmissions) {
							...BpjsSEPSubmissionProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					bpjsSEPSubmissions: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.bpjsSEPSubmission as BpjsSEPSubmissionModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BpjsSEPSubmissionModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsSEPSubmissionModel>> {
		...
		const successMessage = 'Updated BPJS SEP Submission entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($bpjsSEPSubmission: BpjsSEPSubmissionInput!, $persistRelations: Boolean) {
						bpjsSEPSubmission: updateBpjsSEPSubmission(bpjsSEPSubmission: $bpjsSEPSubmission, persistRelations: $persistRelations) {
							...BpjsSEPSubmissionProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BpjsSEPSubmissionModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsSEPSubmissionModel>> {
		...
		const successMessage = 'Update Multiple BPJS SEP Submission entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($bpjsSEPSubmissions: [BpjsSEPSubmissionInput!]!) {
						bpjsSEPSubmission: updateAllBpjsSEPSubmission(bpjsSEPSubmissions: $bpjsSEPSubmissions) {
							...BpjsSEPSubmissionProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BpjsSEPSubmissionModel>> {
		...
		const successMessage = 'Deleted BPJS SEP Submission entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($bpjsSEPSubmissionId: ID!) {
						bpjsSEPSubmissionId: deleteBpjsSEPSubmissionById(bpjsSEPSubmissionId: $bpjsSEPSubmissionId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.bpjsSEPSubmissionId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsSEPSubmissionModel>> {
		...
		const successMessage = 'Deleted selected BPJS SEP Submission entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($bpjsSEPSubmissionIds: [ID!]!){
						deleteBpjsSEPSubmissionExcludingIds(bpjsSEPSubmissionIds: $bpjsSEPSubmissionIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.bpjsSEPSubmissionIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BpjsSEPSubmissionModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($bpjsSEPSubmissionIds: [ID!]!) {
						bpjsSEPSubmissionIds: deleteAllBpjsSEPSubmissionByIds(bpjsSEPSubmissionIds: $bpjsSEPSubmissionIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BpjsSEPSubmissionModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsSEPSubmissionModel>>(
			{
				query: gql`
					query GetAudits {
						audits: bpjsSEPSubmissionAudits {
							entity {
								...BpjsSEPSubmissionProperties
							}
							timestamp
			...
			map(result => {
				let audits: BpjsSEPSubmissionModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BpjsSEPSubmissionModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BpjsSEPSubmissionModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsSEPSubmissionModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($bpjsSEPSubmissionId: ID!) {
						audits: bpjsSEPSubmissionAuditsByEntityId(bpjsSEPSubmissionId: $bpjsSEPSubmissionId) {
							entity {
								...BpjsSEPSubmissionProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BpjsSEPSubmissionModel>> {
		const url = environment.API_URL + '/api/bpjssepsubmission/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BpjsSEPSubmissionModel>> {
		const url = environment.API_URL + '/api/bpjssepsubmission/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsSEPSubmissionModel>> {
		let apiUrl = environment.API_URL + '/api/bpjssepsubmission/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BpjsSEPSubmissionModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/bpjssepsubmission/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' BPJS SEP Submission entities')),
