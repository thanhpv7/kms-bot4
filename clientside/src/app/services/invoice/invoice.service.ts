...
import {InvoiceModelAudit} from '../../models/invoice/invoice.model.state';
...
/**
 * Invoice service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class InvoiceService extends AbstractHttpService<InvoiceModel, InvoiceModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the InvoiceProperties classFragment here] off begin
			fragment InvoiceProperties on Invoice {
				...InvoiceBaseProperties
				invoiceNumber
				revisionNumber
				invoiceStatus
				invoiceType
			...
			# % protected region % [Modify the InvoiceProperties classFragment here] end
			${super.fragments('Invoice').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<InvoiceModel>> {
		...
		return  this.apollo.query<PassableStateConfig<InvoiceModel>>(
			{
				query: gql`
					query Count {
						totalCount: countInvoices
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<InvoiceModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<InvoiceModel>> {
		...
		return this.apollo.query<PassableStateConfig<InvoiceModel>>(
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.InvoiceById as InvoiceModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<InvoiceModel>> {
		...
		return this.apollo.query<PassableStateConfig<InvoiceModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						invoices: invoices(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...InvoiceProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countInvoices(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.invoices as InvoiceModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<InvoiceModel>> {
		...
		return this.apollo.query<PassableStateConfig<InvoiceModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						invoices: lastInvoices(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...InvoiceProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: InvoiceModel, queryParams?: QueryParams): Observable<PassableStateConfig<InvoiceModel>> {
		...
		const successMessage = 'Created Invoice entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($invoice: InvoiceInput!, $persistRelations: Boolean) {
						invoice: createInvoice(invoice: $invoice, persistRelations: $persistRelations) {
							...InvoiceProperties,
				...
				variables: {
					invoice: {
						...
						invoicePaymentOther: entity.invoicePaymentOther ? new InvoicePaymentOtherModel(entity.invoicePaymentOther).toJSON() : undefined,
						invoicePaymentSelfPaying: entity.invoicePaymentSelfPaying ? new InvoicePaymentSelfPayingModel(entity.invoicePaymentSelfPaying).toJSON() : undefined,
						...
						verifiedBy: entity.verifiedBy ? new StaffModel(entity.verifiedBy).toJSON() : undefined,
			...
			map(result => {
				...
				return {
					targetModel: result.data.invoice as InvoiceModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: InvoiceModel[], queryParams?: QueryParams): Observable<PassableStateConfig<InvoiceModel>> {
		...
		const successMessage = 'Created Multiple Invoice entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($invoices: [InvoiceInput!]!) {
						invoice: createAllInvoice(invoices: $invoices) {
							...InvoiceProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					invoices: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.invoice as InvoiceModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: InvoiceModel, queryParams?: QueryParams): Observable<PassableStateConfig<InvoiceModel>> {
		...
		const successMessage = 'Updated Invoice entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($invoice: InvoiceInput!, $persistRelations: Boolean) {
						invoice: updateInvoice(invoice: $invoice, persistRelations: $persistRelations) {
							...InvoiceProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: InvoiceModel[], queryParams?: QueryParams): Observable<PassableStateConfig<InvoiceModel>> {
		...
		const successMessage = 'Update Multiple Invoice entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($invoices: [InvoiceInput!]!) {
						invoice: updateAllInvoice(invoices: $invoices) {
							...InvoiceProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<InvoiceModel>> {
		...
		const successMessage = 'Deleted Invoice entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($invoiceId: ID!) {
						invoiceId: deleteInvoiceById(invoiceId: $invoiceId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.invoiceId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<InvoiceModel>> {
		...
		const successMessage = 'Deleted selected Invoice entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($invoiceIds: [ID!]!){
						deleteInvoiceExcludingIds(invoiceIds: $invoiceIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.invoiceIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<InvoiceModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($invoiceIds: [ID!]!) {
						invoiceIds: deleteAllInvoiceByIds(invoiceIds: $invoiceIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<InvoiceModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<InvoiceModel>>(
			...
			map(result => {
				let audits: InvoiceModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new InvoiceModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<InvoiceModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<InvoiceModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($invoiceId: ID!) {
						audits: invoiceAuditsByEntityId(invoiceId: $invoiceId) {
							entity {
								...InvoiceProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<InvoiceModel>> {
		const url = environment.API_URL + '/api/invoice/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<InvoiceModel>> {
		const url = environment.API_URL + '/api/invoice/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<InvoiceModel>> {
		let apiUrl = environment.API_URL + '/api/invoice/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<InvoiceModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/invoice/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Invoice entities')),
