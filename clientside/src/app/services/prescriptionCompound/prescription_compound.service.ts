...
import {PrescriptionCompoundModelAudit} from '../../models/prescriptionCompound/prescription_compound.model.state';
...
/**
 * Prescription Compound service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class PrescriptionCompoundService extends AbstractHttpService<PrescriptionCompoundModel, PrescriptionCompoundModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the PrescriptionCompoundProperties classFragment here] off begin
			fragment PrescriptionCompoundProperties on PrescriptionCompound {
				...PrescriptionCompoundBaseProperties
				iterationStart
				iterationEnd
				compoundCode
				compoundName
				...
				notes
				totalPrice
				externalCompoundName
				approvalStatus
				inventoryRoundingValue
			}
			# % protected region % [Modify the PrescriptionCompoundProperties classFragment here] end
			${super.fragments('PrescriptionCompound').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<PrescriptionCompoundModel>> {
		...
		return  this.apollo.query<PassableStateConfig<PrescriptionCompoundModel>>(
			{
				query: gql`
					query Count {
						totalCount: countPrescriptionCompounds
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<PrescriptionCompoundModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<PrescriptionCompoundModel>> {
		...
		return this.apollo.query<PassableStateConfig<PrescriptionCompoundModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						PrescriptionCompoundById: prescriptionCompoundById(id: $id) {
							...PrescriptionCompoundProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.PrescriptionCompoundById as PrescriptionCompoundModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PrescriptionCompoundModel>> {
		...
		return this.apollo.query<PassableStateConfig<PrescriptionCompoundModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						prescriptionCompounds: prescriptionCompounds(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...PrescriptionCompoundProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countPrescriptionCompounds(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.prescriptionCompounds as PrescriptionCompoundModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PrescriptionCompoundModel>> {
		...
		return this.apollo.query<PassableStateConfig<PrescriptionCompoundModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						prescriptionCompounds: lastPrescriptionCompounds(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...PrescriptionCompoundProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: PrescriptionCompoundModel, queryParams?: QueryParams): Observable<PassableStateConfig<PrescriptionCompoundModel>> {
		...
		const successMessage = 'Created Prescription Compound entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($prescriptionCompound: PrescriptionCompoundInput!, $persistRelations: Boolean) {
						prescriptionCompound: createPrescriptionCompound(prescriptionCompound: $prescriptionCompound, persistRelations: $persistRelations) {
							...PrescriptionCompoundProperties,
				...
				variables: {
					prescriptionCompound: {
						...entity.toJSON(),
						unit: entity.unit ? new UnitOfMeasurementModel(entity.unit).toJSON() : undefined,
						prescriptionHeader: entity.prescriptionHeader ? new PrescriptionHeaderModel(entity.prescriptionHeader).toJSON() : undefined,
						compoundItems: entity.compoundItems ? entity.compoundItems?.map((model: PrescriptionItemModel) => new PrescriptionItemModel(model).toJSON()) : [],
					},
			...
			map(result => {
				...
				return {
					targetModel: result.data.prescriptionCompound as PrescriptionCompoundModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: PrescriptionCompoundModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PrescriptionCompoundModel>> {
		...
		const successMessage = 'Created Multiple Prescription Compound entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($prescriptionCompounds: [PrescriptionCompoundInput!]!) {
						prescriptionCompound: createAllPrescriptionCompound(prescriptionCompounds: $prescriptionCompounds) {
							...PrescriptionCompoundProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					prescriptionCompounds: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.prescriptionCompound as PrescriptionCompoundModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: PrescriptionCompoundModel, queryParams?: QueryParams): Observable<PassableStateConfig<PrescriptionCompoundModel>> {
		...
		const successMessage = 'Updated Prescription Compound entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($prescriptionCompound: PrescriptionCompoundInput!, $persistRelations: Boolean) {
						prescriptionCompound: updatePrescriptionCompound(prescriptionCompound: $prescriptionCompound, persistRelations: $persistRelations) {
							...PrescriptionCompoundProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: PrescriptionCompoundModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PrescriptionCompoundModel>> {
		...
		const successMessage = 'Update Multiple Prescription Compound entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($prescriptionCompounds: [PrescriptionCompoundInput!]!) {
						prescriptionCompound: updateAllPrescriptionCompound(prescriptionCompounds: $prescriptionCompounds) {
							...PrescriptionCompoundProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<PrescriptionCompoundModel>> {
		...
		const successMessage = 'Deleted Prescription Compound entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($prescriptionCompoundId: ID!) {
						prescriptionCompoundId: deletePrescriptionCompoundById(prescriptionCompoundId: $prescriptionCompoundId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.prescriptionCompoundId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<PrescriptionCompoundModel>> {
		...
		const successMessage = 'Deleted selected Prescription Compound entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($prescriptionCompoundIds: [ID!]!){
						deletePrescriptionCompoundExcludingIds(prescriptionCompoundIds: $prescriptionCompoundIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.prescriptionCompoundIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<PrescriptionCompoundModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($prescriptionCompoundIds: [ID!]!) {
						prescriptionCompoundIds: deleteAllPrescriptionCompoundByIds(prescriptionCompoundIds: $prescriptionCompoundIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<PrescriptionCompoundModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PrescriptionCompoundModel>>(
			{
				query: gql`
					query GetAudits {
						audits: prescriptionCompoundAudits {
							entity {
								...PrescriptionCompoundProperties
							}
							timestamp
			...
			map(result => {
				let audits: PrescriptionCompoundModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new PrescriptionCompoundModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<PrescriptionCompoundModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PrescriptionCompoundModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($prescriptionCompoundId: ID!) {
						audits: prescriptionCompoundAuditsByEntityId(prescriptionCompoundId: $prescriptionCompoundId) {
							entity {
								...PrescriptionCompoundProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<PrescriptionCompoundModel>> {
		const url = environment.API_URL + '/api/prescriptioncompound/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<PrescriptionCompoundModel>> {
		const url = environment.API_URL + '/api/prescriptioncompound/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<PrescriptionCompoundModel>> {
		let apiUrl = environment.API_URL + '/api/prescriptioncompound/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<PrescriptionCompoundModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/prescriptioncompound/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Prescription Compound entities')),
