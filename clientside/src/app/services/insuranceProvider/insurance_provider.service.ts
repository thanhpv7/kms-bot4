...
import {InsuranceProviderModelAudit} from '../../models/insuranceProvider/insurance_provider.model.state';
...
/**
 * Insurance Provider service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class InsuranceProviderService extends AbstractHttpService<InsuranceProviderModel, InsuranceProviderModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the InsuranceProviderProperties classFragment here] off begin
			fragment InsuranceProviderProperties on InsuranceProvider {
				...InsuranceProviderBaseProperties
				providerCode
				providerName
				providerType
				benefitProvider
			...
			# % protected region % [Modify the InsuranceProviderProperties classFragment here] end
			${super.fragments('InsuranceProvider').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<InsuranceProviderModel>> {
		...
		return  this.apollo.query<PassableStateConfig<InsuranceProviderModel>>(
			{
				query: gql`
					query Count {
						totalCount: countInsuranceProviders
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<InsuranceProviderModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<InsuranceProviderModel>> {
		...
		return this.apollo.query<PassableStateConfig<InsuranceProviderModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						InsuranceProviderById: insuranceProviderById(id: $id) {
							...InsuranceProviderProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.InsuranceProviderById as InsuranceProviderModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<InsuranceProviderModel>> {
		...
		return this.apollo.query<PassableStateConfig<InsuranceProviderModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						insuranceProviders: insuranceProviders(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...InsuranceProviderProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countInsuranceProviders(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.insuranceProviders as InsuranceProviderModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<InsuranceProviderModel>> {
		...
		return this.apollo.query<PassableStateConfig<InsuranceProviderModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						insuranceProviders: lastInsuranceProviders(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...InsuranceProviderProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: InsuranceProviderModel, queryParams?: QueryParams): Observable<PassableStateConfig<InsuranceProviderModel>> {
		...
		const successMessage = 'Created Insurance Provider entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($insuranceProvider: InsuranceProviderInput!, $persistRelations: Boolean) {
						insuranceProvider: createInsuranceProvider(insuranceProvider: $insuranceProvider, persistRelations: $persistRelations) {
							...InsuranceProviderProperties,
				...
				variables: {
					insuranceProvider: {
						...entity.toJSON(),
						insuranceBenefitPlans: entity.insuranceBenefitPlans ? entity.insuranceBenefitPlans?.map((model: InsuranceBenefitPlanModel) => new InsuranceBenefitPlanModel(model).toJSON()) : [],
					},
			...
			map(result => {
				...
				return {
					targetModel: result.data.insuranceProvider as InsuranceProviderModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: InsuranceProviderModel[], queryParams?: QueryParams): Observable<PassableStateConfig<InsuranceProviderModel>> {
		...
		const successMessage = 'Created Multiple Insurance Provider entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($insuranceProviders: [InsuranceProviderInput!]!) {
						insuranceProvider: createAllInsuranceProvider(insuranceProviders: $insuranceProviders) {
							...InsuranceProviderProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					insuranceProviders: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.insuranceProvider as InsuranceProviderModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: InsuranceProviderModel, queryParams?: QueryParams): Observable<PassableStateConfig<InsuranceProviderModel>> {
		...
		const successMessage = 'Updated Insurance Provider entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($insuranceProvider: InsuranceProviderInput!, $persistRelations: Boolean) {
						insuranceProvider: updateInsuranceProvider(insuranceProvider: $insuranceProvider, persistRelations: $persistRelations) {
							...InsuranceProviderProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: InsuranceProviderModel[], queryParams?: QueryParams): Observable<PassableStateConfig<InsuranceProviderModel>> {
		...
		const successMessage = 'Update Multiple Insurance Provider entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($insuranceProviders: [InsuranceProviderInput!]!) {
						insuranceProvider: updateAllInsuranceProvider(insuranceProviders: $insuranceProviders) {
							...InsuranceProviderProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<InsuranceProviderModel>> {
		...
		const successMessage = 'Deleted Insurance Provider entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($insuranceProviderId: ID!) {
						insuranceProviderId: deleteInsuranceProviderById(insuranceProviderId: $insuranceProviderId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.insuranceProviderId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<InsuranceProviderModel>> {
		...
		const successMessage = 'Deleted selected Insurance Provider entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($insuranceProviderIds: [ID!]!){
						deleteInsuranceProviderExcludingIds(insuranceProviderIds: $insuranceProviderIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.insuranceProviderIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<InsuranceProviderModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($insuranceProviderIds: [ID!]!) {
						insuranceProviderIds: deleteAllInsuranceProviderByIds(insuranceProviderIds: $insuranceProviderIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<InsuranceProviderModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<InsuranceProviderModel>>(
			{
				query: gql`
					query GetAudits {
						audits: insuranceProviderAudits {
							entity {
								...InsuranceProviderProperties
							}
							timestamp
			...
			map(result => {
				let audits: InsuranceProviderModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new InsuranceProviderModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<InsuranceProviderModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<InsuranceProviderModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($insuranceProviderId: ID!) {
						audits: insuranceProviderAuditsByEntityId(insuranceProviderId: $insuranceProviderId) {
							entity {
								...InsuranceProviderProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<InsuranceProviderModel>> {
		const url = environment.API_URL + '/api/insuranceprovider/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<InsuranceProviderModel>> {
		const url = environment.API_URL + '/api/insuranceprovider/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<InsuranceProviderModel>> {
		let apiUrl = environment.API_URL + '/api/insuranceprovider/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<InsuranceProviderModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/insuranceprovider/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Insurance Provider entities')),
