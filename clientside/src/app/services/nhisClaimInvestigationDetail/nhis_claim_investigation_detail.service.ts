...
import {NhisClaimInvestigationDetailModel} from '../../models/nhisClaimInvestigationDetail/nhis_claim_investigation_detail.model';
import {NhisClaimInvestigationDetailModelAudit} from '../../models/nhisClaimInvestigationDetail/nhis_claim_investigation_detail.model.state';
...
/**
 * NHIS Claim Investigation Detail service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class NhisClaimInvestigationDetailService extends AbstractHttpService<NhisClaimInvestigationDetailModel, NhisClaimInvestigationDetailModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the NhisClaimInvestigationDetailProperties classFragment here] off begin
			fragment NhisClaimInvestigationDetailProperties on NhisClaimInvestigationDetail {
				...NhisClaimInvestigationDetailBaseProperties
				date
				description
			}
			# % protected region % [Modify the NhisClaimInvestigationDetailProperties classFragment here] end
			${super.fragments('NhisClaimInvestigationDetail').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<NhisClaimInvestigationDetailModel>> {
		...
		return  this.apollo.query<PassableStateConfig<NhisClaimInvestigationDetailModel>>(
			{
				query: gql`
					query Count {
						totalCount: countNhisClaimInvestigationDetails
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<NhisClaimInvestigationDetailModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<NhisClaimInvestigationDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<NhisClaimInvestigationDetailModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						NhisClaimInvestigationDetailById: nhisClaimInvestigationDetailById(id: $id) {
							...NhisClaimInvestigationDetailProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.NhisClaimInvestigationDetailById as NhisClaimInvestigationDetailModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<NhisClaimInvestigationDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<NhisClaimInvestigationDetailModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						nhisClaimInvestigationDetails: nhisClaimInvestigationDetails(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...NhisClaimInvestigationDetailProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countNhisClaimInvestigationDetails(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.nhisClaimInvestigationDetails as NhisClaimInvestigationDetailModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<NhisClaimInvestigationDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<NhisClaimInvestigationDetailModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						nhisClaimInvestigationDetails: lastNhisClaimInvestigationDetails(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...NhisClaimInvestigationDetailProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: NhisClaimInvestigationDetailModel, queryParams?: QueryParams): Observable<PassableStateConfig<NhisClaimInvestigationDetailModel>> {
		...
		const successMessage = 'Created NHIS Claim Investigation Detail entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($nhisClaimInvestigationDetail: NhisClaimInvestigationDetailInput!, $persistRelations: Boolean) {
						nhisClaimInvestigationDetail: createNhisClaimInvestigationDetail(nhisClaimInvestigationDetail: $nhisClaimInvestigationDetail, persistRelations: $persistRelations) {
							...NhisClaimInvestigationDetailProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.nhisClaimInvestigationDetail as NhisClaimInvestigationDetailModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: NhisClaimInvestigationDetailModel[], queryParams?: QueryParams): Observable<PassableStateConfig<NhisClaimInvestigationDetailModel>> {
		...
		const successMessage = 'Created Multiple NHIS Claim Investigation Detail entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($nhisClaimInvestigationDetails: [NhisClaimInvestigationDetailInput!]!) {
						nhisClaimInvestigationDetail: createAllNhisClaimInvestigationDetail(nhisClaimInvestigationDetails: $nhisClaimInvestigationDetails) {
							...NhisClaimInvestigationDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					nhisClaimInvestigationDetails: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.nhisClaimInvestigationDetail as NhisClaimInvestigationDetailModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: NhisClaimInvestigationDetailModel, queryParams?: QueryParams): Observable<PassableStateConfig<NhisClaimInvestigationDetailModel>> {
		...
		const successMessage = 'Updated NHIS Claim Investigation Detail entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($nhisClaimInvestigationDetail: NhisClaimInvestigationDetailInput!, $persistRelations: Boolean) {
						nhisClaimInvestigationDetail: updateNhisClaimInvestigationDetail(nhisClaimInvestigationDetail: $nhisClaimInvestigationDetail, persistRelations: $persistRelations) {
							...NhisClaimInvestigationDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: NhisClaimInvestigationDetailModel[], queryParams?: QueryParams): Observable<PassableStateConfig<NhisClaimInvestigationDetailModel>> {
		...
		const successMessage = 'Update Multiple NHIS Claim Investigation Detail entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($nhisClaimInvestigationDetails: [NhisClaimInvestigationDetailInput!]!) {
						nhisClaimInvestigationDetail: updateAllNhisClaimInvestigationDetail(nhisClaimInvestigationDetails: $nhisClaimInvestigationDetails) {
							...NhisClaimInvestigationDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<NhisClaimInvestigationDetailModel>> {
		...
		const successMessage = 'Deleted NHIS Claim Investigation Detail entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($nhisClaimInvestigationDetailId: ID!) {
						nhisClaimInvestigationDetailId: deleteNhisClaimInvestigationDetailById(nhisClaimInvestigationDetailId: $nhisClaimInvestigationDetailId)
				...
				`,
				variables: {
					nhisClaimInvestigationDetailId: id,
			...
			map(result => {
				...
				return {
					targetModelId: result.data.nhisClaimInvestigationDetailId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<NhisClaimInvestigationDetailModel>> {
		...
		const successMessage = 'Deleted selected NHIS Claim Investigation Detail entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($nhisClaimInvestigationDetailIds: [ID!]!){
						deleteNhisClaimInvestigationDetailExcludingIds(nhisClaimInvestigationDetailIds: $nhisClaimInvestigationDetailIds)
				...
				`,
				variables: {
					nhisClaimInvestigationDetailIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.nhisClaimInvestigationDetailIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<NhisClaimInvestigationDetailModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($nhisClaimInvestigationDetailIds: [ID!]!) {
						nhisClaimInvestigationDetailIds: deleteAllNhisClaimInvestigationDetailByIds(nhisClaimInvestigationDetailIds: $nhisClaimInvestigationDetailIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<NhisClaimInvestigationDetailModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<NhisClaimInvestigationDetailModel>>(
			{
				query: gql`
					query GetAudits {
						audits: nhisClaimInvestigationDetailAudits {
							entity {
								...NhisClaimInvestigationDetailProperties
							}
							timestamp
			...
			map(result => {
				let audits: NhisClaimInvestigationDetailModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new NhisClaimInvestigationDetailModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<NhisClaimInvestigationDetailModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<NhisClaimInvestigationDetailModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($nhisClaimInvestigationDetailId: ID!) {
						audits: nhisClaimInvestigationDetailAuditsByEntityId(nhisClaimInvestigationDetailId: $nhisClaimInvestigationDetailId) {
							entity {
								...NhisClaimInvestigationDetailProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<NhisClaimInvestigationDetailModel>> {
		const url = environment.API_URL + '/api/nhisclaiminvestigationdetail/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<NhisClaimInvestigationDetailModel>> {
		const url = environment.API_URL + '/api/nhisclaiminvestigationdetail/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<NhisClaimInvestigationDetailModel>> {
		let apiUrl = environment.API_URL + '/api/nhisclaiminvestigationdetail/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<NhisClaimInvestigationDetailModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/nhisclaiminvestigationdetail/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' NHIS Claim Investigation Detail entities')),
