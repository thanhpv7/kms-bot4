...
import {StockTransactionPerDateModel} from '../../models/stockTransactionPerDate/stock_transaction_per_date.model';
import {StockTransactionPerDateModelAudit} from '../../models/stockTransactionPerDate/stock_transaction_per_date.model.state';
...
/**
 * Stock Transaction Per Date service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class StockTransactionPerDateService extends AbstractHttpService<StockTransactionPerDateModel, StockTransactionPerDateModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the StockTransactionPerDateProperties classFragment here] off begin
			fragment StockTransactionPerDateProperties on StockTransactionPerDate {
				...StockTransactionPerDateBaseProperties
				asOfDate
				qtyUoi
				totalCost
				uoi
			...
			# % protected region % [Modify the StockTransactionPerDateProperties classFragment here] end
			${super.fragments('StockTransactionPerDate').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<StockTransactionPerDateModel>> {
		...
		return  this.apollo.query<PassableStateConfig<StockTransactionPerDateModel>>(
			{
				query: gql`
					query Count {
						totalCount: countStockTransactionPerDates
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<StockTransactionPerDateModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<StockTransactionPerDateModel>> {
		...
		return this.apollo.query<PassableStateConfig<StockTransactionPerDateModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						StockTransactionPerDateById: stockTransactionPerDateById(id: $id) {
							...StockTransactionPerDateProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.StockTransactionPerDateById as StockTransactionPerDateModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<StockTransactionPerDateModel>> {
		...
		return this.apollo.query<PassableStateConfig<StockTransactionPerDateModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						stockTransactionPerDates: stockTransactionPerDates(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...StockTransactionPerDateProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countStockTransactionPerDates(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.stockTransactionPerDates as StockTransactionPerDateModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<StockTransactionPerDateModel>> {
		...
		return this.apollo.query<PassableStateConfig<StockTransactionPerDateModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						stockTransactionPerDates: lastStockTransactionPerDates(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...StockTransactionPerDateProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: StockTransactionPerDateModel, queryParams?: QueryParams): Observable<PassableStateConfig<StockTransactionPerDateModel>> {
		...
		const successMessage = 'Created Stock Transaction Per Date entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($stockTransactionPerDate: StockTransactionPerDateInput!, $persistRelations: Boolean) {
						stockTransactionPerDate: createStockTransactionPerDate(stockTransactionPerDate: $stockTransactionPerDate, persistRelations: $persistRelations) {
							...StockTransactionPerDateProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.stockTransactionPerDate as StockTransactionPerDateModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: StockTransactionPerDateModel[], queryParams?: QueryParams): Observable<PassableStateConfig<StockTransactionPerDateModel>> {
		...
		const successMessage = 'Created Multiple Stock Transaction Per Date entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($stockTransactionPerDates: [StockTransactionPerDateInput!]!) {
						stockTransactionPerDate: createAllStockTransactionPerDate(stockTransactionPerDates: $stockTransactionPerDates) {
							...StockTransactionPerDateProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					stockTransactionPerDates: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.stockTransactionPerDate as StockTransactionPerDateModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: StockTransactionPerDateModel, queryParams?: QueryParams): Observable<PassableStateConfig<StockTransactionPerDateModel>> {
		...
		const successMessage = 'Updated Stock Transaction Per Date entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($stockTransactionPerDate: StockTransactionPerDateInput!, $persistRelations: Boolean) {
						stockTransactionPerDate: updateStockTransactionPerDate(stockTransactionPerDate: $stockTransactionPerDate, persistRelations: $persistRelations) {
							...StockTransactionPerDateProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: StockTransactionPerDateModel[], queryParams?: QueryParams): Observable<PassableStateConfig<StockTransactionPerDateModel>> {
		...
		const successMessage = 'Update Multiple Stock Transaction Per Date entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($stockTransactionPerDates: [StockTransactionPerDateInput!]!) {
						stockTransactionPerDate: updateAllStockTransactionPerDate(stockTransactionPerDates: $stockTransactionPerDates) {
							...StockTransactionPerDateProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<StockTransactionPerDateModel>> {
		...
		const successMessage = 'Deleted Stock Transaction Per Date entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($stockTransactionPerDateId: ID!) {
						stockTransactionPerDateId: deleteStockTransactionPerDateById(stockTransactionPerDateId: $stockTransactionPerDateId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.stockTransactionPerDateId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<StockTransactionPerDateModel>> {
		...
		const successMessage = 'Deleted selected Stock Transaction Per Date entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($stockTransactionPerDateIds: [ID!]!){
						deleteStockTransactionPerDateExcludingIds(stockTransactionPerDateIds: $stockTransactionPerDateIds)
				...
				`,
				variables: {
					stockTransactionPerDateIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.stockTransactionPerDateIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<StockTransactionPerDateModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($stockTransactionPerDateIds: [ID!]!) {
						stockTransactionPerDateIds: deleteAllStockTransactionPerDateByIds(stockTransactionPerDateIds: $stockTransactionPerDateIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<StockTransactionPerDateModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<StockTransactionPerDateModel>>(
			{
				query: gql`
					query GetAudits {
						audits: stockTransactionPerDateAudits {
							entity {
								...StockTransactionPerDateProperties
							}
							timestamp
			...
			map(result => {
				let audits: StockTransactionPerDateModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new StockTransactionPerDateModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<StockTransactionPerDateModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<StockTransactionPerDateModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($stockTransactionPerDateId: ID!) {
						audits: stockTransactionPerDateAuditsByEntityId(stockTransactionPerDateId: $stockTransactionPerDateId) {
							entity {
								...StockTransactionPerDateProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<StockTransactionPerDateModel>> {
		const url = environment.API_URL + '/api/stocktransactionperdate/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<StockTransactionPerDateModel>> {
		const url = environment.API_URL + '/api/stocktransactionperdate/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<StockTransactionPerDateModel>> {
		let apiUrl = environment.API_URL + '/api/stocktransactionperdate/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<StockTransactionPerDateModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/stocktransactionperdate/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Stock Transaction Per Date entities')),
