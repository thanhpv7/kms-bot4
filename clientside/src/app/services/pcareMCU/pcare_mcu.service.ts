...
import {PcareMCUModelAudit} from '../../models/pcareMCU/pcare_mcu.model.state';
...
/**
 * PCare MCU service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class PcareMCUService extends AbstractHttpService<PcareMCUModel, PcareMCUModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the PcareMCUProperties classFragment here] off begin
			fragment PcareMCUProperties on PcareMCU {
				...PcareMCUBaseProperties
				kodeMCU
				noKunjungan
				kodeProvider
				namaProvider
			...
			# % protected region % [Modify the PcareMCUProperties classFragment here] end
			${super.fragments('PcareMCU').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<PcareMCUModel>> {
		...
		return  this.apollo.query<PassableStateConfig<PcareMCUModel>>(
			{
				query: gql`
					query Count {
						totalCount: countPcareMCUs
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<PcareMCUModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<PcareMCUModel>> {
		...
		return this.apollo.query<PassableStateConfig<PcareMCUModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						PcareMCUById: pcareMCUById(id: $id) {
							...PcareMCUProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.PcareMCUById as PcareMCUModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PcareMCUModel>> {
		...
		return this.apollo.query<PassableStateConfig<PcareMCUModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						pcareMCUs: pcareMCUs(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...PcareMCUProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countPcareMCUs(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.pcareMCUs as PcareMCUModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PcareMCUModel>> {
		...
		return this.apollo.query<PassableStateConfig<PcareMCUModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						pcareMCUs: lastPcareMCUs(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...PcareMCUProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: PcareMCUModel, queryParams?: QueryParams): Observable<PassableStateConfig<PcareMCUModel>> {
		...
		const successMessage = 'Created PCare MCU entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($pcareMCU: PcareMCUInput!, $persistRelations: Boolean) {
						pcareMCU: createPcareMCU(pcareMCU: $pcareMCU, persistRelations: $persistRelations) {
							...PcareMCUProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.pcareMCU as PcareMCUModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: PcareMCUModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PcareMCUModel>> {
		...
		const successMessage = 'Created Multiple PCare MCU entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($pcareMCUs: [PcareMCUInput!]!) {
						pcareMCU: createAllPcareMCU(pcareMCUs: $pcareMCUs) {
							...PcareMCUProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					pcareMCUs: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.pcareMCU as PcareMCUModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: PcareMCUModel, queryParams?: QueryParams): Observable<PassableStateConfig<PcareMCUModel>> {
		...
		const successMessage = 'Updated PCare MCU entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($pcareMCU: PcareMCUInput!, $persistRelations: Boolean) {
						pcareMCU: updatePcareMCU(pcareMCU: $pcareMCU, persistRelations: $persistRelations) {
							...PcareMCUProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: PcareMCUModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PcareMCUModel>> {
		...
		const successMessage = 'Update Multiple PCare MCU entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($pcareMCUs: [PcareMCUInput!]!) {
						pcareMCU: updateAllPcareMCU(pcareMCUs: $pcareMCUs) {
							...PcareMCUProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<PcareMCUModel>> {
		...
		const successMessage = 'Deleted PCare MCU entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($pcareMCUId: ID!) {
						pcareMCUId: deletePcareMCUById(pcareMCUId: $pcareMCUId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.pcareMCUId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<PcareMCUModel>> {
		...
		const successMessage = 'Deleted selected PCare MCU entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($pcareMCUIds: [ID!]!){
						deletePcareMCUExcludingIds(pcareMCUIds: $pcareMCUIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.pcareMCUIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<PcareMCUModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($pcareMCUIds: [ID!]!) {
						pcareMCUIds: deleteAllPcareMCUByIds(pcareMCUIds: $pcareMCUIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<PcareMCUModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PcareMCUModel>>(
			...
			map(result => {
				let audits: PcareMCUModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new PcareMCUModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<PcareMCUModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PcareMCUModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($pcareMCUId: ID!) {
						audits: pcareMCUAuditsByEntityId(pcareMCUId: $pcareMCUId) {
							entity {
								...PcareMCUProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<PcareMCUModel>> {
		const url = environment.API_URL + '/api/pcaremcu/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<PcareMCUModel>> {
		const url = environment.API_URL + '/api/pcaremcu/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<PcareMCUModel>> {
		let apiUrl = environment.API_URL + '/api/pcaremcu/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<PcareMCUModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/pcaremcu/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' PCare MCU entities')),
