...
import {MerchantModelAudit} from '../../models/merchant/merchant.model.state';
...
/**
 * Merchant service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class MerchantService extends AbstractHttpService<MerchantModel, MerchantModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the MerchantProperties classFragment here] off begin
			fragment MerchantProperties on Merchant {
				...MerchantBaseProperties
				merchantName
				merchantNumber
				bankAccount
			}
			# % protected region % [Modify the MerchantProperties classFragment here] end
			${super.fragments('Merchant').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<MerchantModel>> {
		...
		return  this.apollo.query<PassableStateConfig<MerchantModel>>(
			{
				query: gql`
					query Count {
						totalCount: countMerchants
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<MerchantModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<MerchantModel>> {
		...
		return this.apollo.query<PassableStateConfig<MerchantModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						MerchantById: merchantById(id: $id) {
							...MerchantProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.MerchantById as MerchantModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<MerchantModel>> {
		...
		return this.apollo.query<PassableStateConfig<MerchantModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						merchants: merchants(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...MerchantProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countMerchants(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.merchants as MerchantModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<MerchantModel>> {
		...
		return this.apollo.query<PassableStateConfig<MerchantModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						merchants: lastMerchants(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...MerchantProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: MerchantModel, queryParams?: QueryParams): Observable<PassableStateConfig<MerchantModel>> {
		...
		const successMessage = 'Created Merchant entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($merchant: MerchantInput!, $persistRelations: Boolean) {
						merchant: createMerchant(merchant: $merchant, persistRelations: $persistRelations) {
							...MerchantProperties,
				...
				variables: {
					merchant: {
						...
						merchantSurchargeAndFees: entity.merchantSurchargeAndFees ? entity.merchantSurchargeAndFees?.map((model: MerchantSurchargeAndFeeModel) => new MerchantSurchargeAndFeeModel(model).toJSON()) : [],
					},
			...
			map(result => {
				...
				return {
					targetModel: result.data.merchant as MerchantModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: MerchantModel[], queryParams?: QueryParams): Observable<PassableStateConfig<MerchantModel>> {
		...
		const successMessage = 'Created Multiple Merchant entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($merchants: [MerchantInput!]!) {
						merchant: createAllMerchant(merchants: $merchants) {
							...MerchantProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					merchants: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.merchant as MerchantModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: MerchantModel, queryParams?: QueryParams): Observable<PassableStateConfig<MerchantModel>> {
		...
		const successMessage = 'Updated Merchant entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($merchant: MerchantInput!, $persistRelations: Boolean) {
						merchant: updateMerchant(merchant: $merchant, persistRelations: $persistRelations) {
							...MerchantProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: MerchantModel[], queryParams?: QueryParams): Observable<PassableStateConfig<MerchantModel>> {
		...
		const successMessage = 'Update Multiple Merchant entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($merchants: [MerchantInput!]!) {
						merchant: updateAllMerchant(merchants: $merchants) {
							...MerchantProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<MerchantModel>> {
		...
		const successMessage = 'Deleted Merchant entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($merchantId: ID!) {
						merchantId: deleteMerchantById(merchantId: $merchantId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.merchantId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<MerchantModel>> {
		...
		const successMessage = 'Deleted selected Merchant entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($merchantIds: [ID!]!){
						deleteMerchantExcludingIds(merchantIds: $merchantIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.merchantIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<MerchantModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($merchantIds: [ID!]!) {
						merchantIds: deleteAllMerchantByIds(merchantIds: $merchantIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<MerchantModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<MerchantModel>>(
			...
			map(result => {
				let audits: MerchantModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new MerchantModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<MerchantModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<MerchantModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($merchantId: ID!) {
						audits: merchantAuditsByEntityId(merchantId: $merchantId) {
							entity {
								...MerchantProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<MerchantModel>> {
		const url = environment.API_URL + '/api/merchant/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<MerchantModel>> {
		const url = environment.API_URL + '/api/merchant/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<MerchantModel>> {
		let apiUrl = environment.API_URL + '/api/merchant/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<MerchantModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/merchant/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Merchant entities')),
