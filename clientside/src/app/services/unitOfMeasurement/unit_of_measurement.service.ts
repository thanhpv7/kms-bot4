...
import {UnitOfMeasurementModel} from '../../models/unitOfMeasurement/unit_of_measurement.model';
import {UnitOfMeasurementModelAudit} from '../../models/unitOfMeasurement/unit_of_measurement.model.state';
...
/**
 * Unit Of Measurement service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class UnitOfMeasurementService extends AbstractHttpService<UnitOfMeasurementModel, UnitOfMeasurementModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the UnitOfMeasurementProperties classFragment here] off begin
			fragment UnitOfMeasurementProperties on UnitOfMeasurement {
				...UnitOfMeasurementBaseProperties
				unitName
				symbol
				description
				unitCategory
			...
			# % protected region % [Modify the UnitOfMeasurementProperties classFragment here] end
			${super.fragments('UnitOfMeasurement').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<UnitOfMeasurementModel>> {
		...
		return  this.apollo.query<PassableStateConfig<UnitOfMeasurementModel>>(
			{
				query: gql`
					query Count {
						totalCount: countUnitOfMeasurements
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<UnitOfMeasurementModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<UnitOfMeasurementModel>> {
		...
		return this.apollo.query<PassableStateConfig<UnitOfMeasurementModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						UnitOfMeasurementById: unitOfMeasurementById(id: $id) {
							...UnitOfMeasurementProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.UnitOfMeasurementById as UnitOfMeasurementModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<UnitOfMeasurementModel>> {
		...
		return this.apollo.query<PassableStateConfig<UnitOfMeasurementModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						unitOfMeasurements: unitOfMeasurements(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...UnitOfMeasurementProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countUnitOfMeasurements(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.unitOfMeasurements as UnitOfMeasurementModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<UnitOfMeasurementModel>> {
		...
		return this.apollo.query<PassableStateConfig<UnitOfMeasurementModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						unitOfMeasurements: lastUnitOfMeasurements(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...UnitOfMeasurementProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: UnitOfMeasurementModel, queryParams?: QueryParams): Observable<PassableStateConfig<UnitOfMeasurementModel>> {
		...
		const successMessage = 'Created Unit Of Measurement entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($unitOfMeasurement: UnitOfMeasurementInput!, $persistRelations: Boolean) {
						unitOfMeasurement: createUnitOfMeasurement(unitOfMeasurement: $unitOfMeasurement, persistRelations: $persistRelations) {
							...UnitOfMeasurementProperties,
				...
				variables: {
					unitOfMeasurement: {
						...entity.toJSON(),
						catalogueUOM: entity.catalogueUOM ? new CatalogueUOMModel(entity.catalogueUOM).toJSON() : undefined,
						compoundPrescriptionDetails: entity.compoundPrescriptionDetails ? entity.compoundPrescriptionDetails?.map((model: CompoundPrescriptionDetailModel) => new CompoundPrescriptionDetailModel(model).toJSON()) : [],
						...
						compoundsUnit: entity.compoundsUnit ? entity.compoundsUnit?.map((model: PrescriptionCompoundModel) => new PrescriptionCompoundModel(model).toJSON()) : [],
						medicationCompounds: entity.medicationCompounds ? entity.medicationCompounds?.map((model: MedicationCompoundModel) => new MedicationCompoundModel(model).toJSON()) : [],
						...
						prescriptionItems: entity.prescriptionItems ? entity.prescriptionItems?.map((model: PrescriptionItemModel) => new PrescriptionItemModel(model).toJSON()) : [],
					},
			...
			map(result => {
				...
				return {
					targetModel: result.data.unitOfMeasurement as UnitOfMeasurementModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: UnitOfMeasurementModel[], queryParams?: QueryParams): Observable<PassableStateConfig<UnitOfMeasurementModel>> {
		...
		const successMessage = 'Created Multiple Unit Of Measurement entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($unitOfMeasurements: [UnitOfMeasurementInput!]!) {
						unitOfMeasurement: createAllUnitOfMeasurement(unitOfMeasurements: $unitOfMeasurements) {
							...UnitOfMeasurementProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					unitOfMeasurements: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.unitOfMeasurement as UnitOfMeasurementModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: UnitOfMeasurementModel, queryParams?: QueryParams): Observable<PassableStateConfig<UnitOfMeasurementModel>> {
		...
		const successMessage = 'Updated Unit Of Measurement entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($unitOfMeasurement: UnitOfMeasurementInput!, $persistRelations: Boolean) {
						unitOfMeasurement: updateUnitOfMeasurement(unitOfMeasurement: $unitOfMeasurement, persistRelations: $persistRelations) {
							...UnitOfMeasurementProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: UnitOfMeasurementModel[], queryParams?: QueryParams): Observable<PassableStateConfig<UnitOfMeasurementModel>> {
		...
		const successMessage = 'Update Multiple Unit Of Measurement entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($unitOfMeasurements: [UnitOfMeasurementInput!]!) {
						unitOfMeasurement: updateAllUnitOfMeasurement(unitOfMeasurements: $unitOfMeasurements) {
							...UnitOfMeasurementProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<UnitOfMeasurementModel>> {
		...
		const successMessage = 'Deleted Unit Of Measurement entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($unitOfMeasurementId: ID!) {
						unitOfMeasurementId: deleteUnitOfMeasurementById(unitOfMeasurementId: $unitOfMeasurementId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.unitOfMeasurementId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<UnitOfMeasurementModel>> {
		...
		const successMessage = 'Deleted selected Unit Of Measurement entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($unitOfMeasurementIds: [ID!]!){
						deleteUnitOfMeasurementExcludingIds(unitOfMeasurementIds: $unitOfMeasurementIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.unitOfMeasurementIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<UnitOfMeasurementModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($unitOfMeasurementIds: [ID!]!) {
						unitOfMeasurementIds: deleteAllUnitOfMeasurementByIds(unitOfMeasurementIds: $unitOfMeasurementIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<UnitOfMeasurementModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<UnitOfMeasurementModel>>(
			{
				query: gql`
					query GetAudits {
						audits: unitOfMeasurementAudits {
							entity {
								...UnitOfMeasurementProperties
							}
							timestamp
			...
			map(result => {
				let audits: UnitOfMeasurementModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new UnitOfMeasurementModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<UnitOfMeasurementModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<UnitOfMeasurementModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($unitOfMeasurementId: ID!) {
						audits: unitOfMeasurementAuditsByEntityId(unitOfMeasurementId: $unitOfMeasurementId) {
							entity {
								...UnitOfMeasurementProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<UnitOfMeasurementModel>> {
		const url = environment.API_URL + '/api/unitofmeasurement/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<UnitOfMeasurementModel>> {
		const url = environment.API_URL + '/api/unitofmeasurement/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<UnitOfMeasurementModel>> {
		let apiUrl = environment.API_URL + '/api/unitofmeasurement/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<UnitOfMeasurementModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/unitofmeasurement/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Unit Of Measurement entities')),
