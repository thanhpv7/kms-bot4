...
import {PcareClubProlanisModel} from '../../models/pcareClubProlanis/pcare_club_prolanis.model';
import {PcareClubProlanisModelAudit} from '../../models/pcareClubProlanis/pcare_club_prolanis.model.state';
...
/**
 * PCare Club Prolanis service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class PcareClubProlanisService extends AbstractHttpService<PcareClubProlanisModel, PcareClubProlanisModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the PcareClubProlanisProperties classFragment here] off begin
			fragment PcareClubProlanisProperties on PcareClubProlanis {
				...PcareClubProlanisBaseProperties
				clubID
				kodeProgram
				namaProgram
				tanggalMulai
			...
			# % protected region % [Modify the PcareClubProlanisProperties classFragment here] end
			${super.fragments('PcareClubProlanis').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<PcareClubProlanisModel>> {
		...
		return  this.apollo.query<PassableStateConfig<PcareClubProlanisModel>>(
			{
				query: gql`
					query Count {
						totalCount: countPcareClubProlaniss
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<PcareClubProlanisModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<PcareClubProlanisModel>> {
		...
		return this.apollo.query<PassableStateConfig<PcareClubProlanisModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						PcareClubProlanisById: pcareClubProlanisById(id: $id) {
							...PcareClubProlanisProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.PcareClubProlanisById as PcareClubProlanisModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PcareClubProlanisModel>> {
		...
		return this.apollo.query<PassableStateConfig<PcareClubProlanisModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						pcareClubProlaniss: pcareClubProlaniss(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...PcareClubProlanisProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countPcareClubProlaniss(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.pcareClubProlaniss as PcareClubProlanisModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PcareClubProlanisModel>> {
		...
		return this.apollo.query<PassableStateConfig<PcareClubProlanisModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						pcareClubProlaniss: lastPcareClubProlaniss(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...PcareClubProlanisProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: PcareClubProlanisModel, queryParams?: QueryParams): Observable<PassableStateConfig<PcareClubProlanisModel>> {
		...
		const successMessage = 'Created PCare Club Prolanis entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($pcareClubProlanis: PcareClubProlanisInput!, $persistRelations: Boolean) {
						pcareClubProlanis: createPcareClubProlanis(pcareClubProlanis: $pcareClubProlanis, persistRelations: $persistRelations) {
							...PcareClubProlanisProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.pcareClubProlanis as PcareClubProlanisModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: PcareClubProlanisModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PcareClubProlanisModel>> {
		...
		const successMessage = 'Created Multiple PCare Club Prolanis entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($pcareClubProlaniss: [PcareClubProlanisInput!]!) {
						pcareClubProlanis: createAllPcareClubProlanis(pcareClubProlaniss: $pcareClubProlaniss) {
							...PcareClubProlanisProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					pcareClubProlaniss: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.pcareClubProlanis as PcareClubProlanisModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: PcareClubProlanisModel, queryParams?: QueryParams): Observable<PassableStateConfig<PcareClubProlanisModel>> {
		...
		const successMessage = 'Updated PCare Club Prolanis entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($pcareClubProlanis: PcareClubProlanisInput!, $persistRelations: Boolean) {
						pcareClubProlanis: updatePcareClubProlanis(pcareClubProlanis: $pcareClubProlanis, persistRelations: $persistRelations) {
							...PcareClubProlanisProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: PcareClubProlanisModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PcareClubProlanisModel>> {
		...
		const successMessage = 'Update Multiple PCare Club Prolanis entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($pcareClubProlaniss: [PcareClubProlanisInput!]!) {
						pcareClubProlanis: updateAllPcareClubProlanis(pcareClubProlaniss: $pcareClubProlaniss) {
							...PcareClubProlanisProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<PcareClubProlanisModel>> {
		...
		const successMessage = 'Deleted PCare Club Prolanis entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($pcareClubProlanisId: ID!) {
						pcareClubProlanisId: deletePcareClubProlanisById(pcareClubProlanisId: $pcareClubProlanisId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.pcareClubProlanisId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<PcareClubProlanisModel>> {
		...
		const successMessage = 'Deleted selected PCare Club Prolanis entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($pcareClubProlanisIds: [ID!]!){
						deletePcareClubProlanisExcludingIds(pcareClubProlanisIds: $pcareClubProlanisIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.pcareClubProlanisIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<PcareClubProlanisModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($pcareClubProlanisIds: [ID!]!) {
						pcareClubProlanisIds: deleteAllPcareClubProlanisByIds(pcareClubProlanisIds: $pcareClubProlanisIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<PcareClubProlanisModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PcareClubProlanisModel>>(
			{
				query: gql`
					query GetAudits {
						audits: pcareClubProlanisAudits {
							entity {
								...PcareClubProlanisProperties
							}
							timestamp
			...
			map(result => {
				let audits: PcareClubProlanisModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new PcareClubProlanisModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<PcareClubProlanisModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PcareClubProlanisModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($pcareClubProlanisId: ID!) {
						audits: pcareClubProlanisAuditsByEntityId(pcareClubProlanisId: $pcareClubProlanisId) {
							entity {
								...PcareClubProlanisProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<PcareClubProlanisModel>> {
		const url = environment.API_URL + '/api/pcareclubprolanis/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<PcareClubProlanisModel>> {
		const url = environment.API_URL + '/api/pcareclubprolanis/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<PcareClubProlanisModel>> {
		let apiUrl = environment.API_URL + '/api/pcareclubprolanis/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<PcareClubProlanisModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/pcareclubprolanis/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' PCare Club Prolanis entities')),
