...
import {EmergencyMedicalExaminationRecordModel} from '../../models/emergencyMedicalExaminationRecord/emergency_medical_examination_record.model';
import {EmergencyMedicalExaminationRecordModelAudit} from '../../models/emergencyMedicalExaminationRecord/emergency_medical_examination_record.model.state';
...
/**
 * Emergency Medical Examination Record service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class EmergencyMedicalExaminationRecordService extends AbstractHttpService<EmergencyMedicalExaminationRecordModel, EmergencyMedicalExaminationRecordModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the EmergencyMedicalExaminationRecordProperties classFragment here] off begin
			fragment EmergencyMedicalExaminationRecordProperties on EmergencyMedicalExaminationRecord {
				...EmergencyMedicalExaminationRecordBaseProperties
			...
			# % protected region % [Modify the EmergencyMedicalExaminationRecordProperties classFragment here] end
			${super.fragments('EmergencyMedicalExaminationRecord').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<EmergencyMedicalExaminationRecordModel>> {
		...
		return  this.apollo.query<PassableStateConfig<EmergencyMedicalExaminationRecordModel>>(
			{
				query: gql`
					query Count {
						totalCount: countEmergencyMedicalExaminationRecords
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<EmergencyMedicalExaminationRecordModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<EmergencyMedicalExaminationRecordModel>> {
		...
		return this.apollo.query<PassableStateConfig<EmergencyMedicalExaminationRecordModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						EmergencyMedicalExaminationRecordById: emergencyMedicalExaminationRecordById(id: $id) {
							...EmergencyMedicalExaminationRecordProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.EmergencyMedicalExaminationRecordById as EmergencyMedicalExaminationRecordModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<EmergencyMedicalExaminationRecordModel>> {
		...
		return this.apollo.query<PassableStateConfig<EmergencyMedicalExaminationRecordModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						emergencyMedicalExaminationRecords: emergencyMedicalExaminationRecords(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...EmergencyMedicalExaminationRecordProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countEmergencyMedicalExaminationRecords(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.emergencyMedicalExaminationRecords as EmergencyMedicalExaminationRecordModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<EmergencyMedicalExaminationRecordModel>> {
		...
		return this.apollo.query<PassableStateConfig<EmergencyMedicalExaminationRecordModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						emergencyMedicalExaminationRecords: lastEmergencyMedicalExaminationRecords(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...EmergencyMedicalExaminationRecordProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: EmergencyMedicalExaminationRecordModel, queryParams?: QueryParams): Observable<PassableStateConfig<EmergencyMedicalExaminationRecordModel>> {
		...
		const successMessage = 'Created Emergency Medical Examination Record entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($emergencyMedicalExaminationRecord: EmergencyMedicalExaminationRecordInput!, $persistRelations: Boolean) {
						emergencyMedicalExaminationRecord: createEmergencyMedicalExaminationRecord(emergencyMedicalExaminationRecord: $emergencyMedicalExaminationRecord, persistRelations: $persistRelations) {
							...EmergencyMedicalExaminationRecordProperties,
				...
				`,
				variables: {
					emergencyMedicalExaminationRecord: {
						...entity.toJSON(),
			...
			map(result => {
				...
				return {
					targetModel: result.data.emergencyMedicalExaminationRecord as EmergencyMedicalExaminationRecordModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: EmergencyMedicalExaminationRecordModel[], queryParams?: QueryParams): Observable<PassableStateConfig<EmergencyMedicalExaminationRecordModel>> {
		...
		const successMessage = 'Created Multiple Emergency Medical Examination Record entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($emergencyMedicalExaminationRecords: [EmergencyMedicalExaminationRecordInput!]!) {
						emergencyMedicalExaminationRecord: createAllEmergencyMedicalExaminationRecord(emergencyMedicalExaminationRecords: $emergencyMedicalExaminationRecords) {
							...EmergencyMedicalExaminationRecordProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					emergencyMedicalExaminationRecords: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.emergencyMedicalExaminationRecord as EmergencyMedicalExaminationRecordModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: EmergencyMedicalExaminationRecordModel, queryParams?: QueryParams): Observable<PassableStateConfig<EmergencyMedicalExaminationRecordModel>> {
		...
		const successMessage = 'Updated Emergency Medical Examination Record entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($emergencyMedicalExaminationRecord: EmergencyMedicalExaminationRecordInput!, $persistRelations: Boolean) {
						emergencyMedicalExaminationRecord: updateEmergencyMedicalExaminationRecord(emergencyMedicalExaminationRecord: $emergencyMedicalExaminationRecord, persistRelations: $persistRelations) {
							...EmergencyMedicalExaminationRecordProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: EmergencyMedicalExaminationRecordModel[], queryParams?: QueryParams): Observable<PassableStateConfig<EmergencyMedicalExaminationRecordModel>> {
		...
		const successMessage = 'Update Multiple Emergency Medical Examination Record entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($emergencyMedicalExaminationRecords: [EmergencyMedicalExaminationRecordInput!]!) {
						emergencyMedicalExaminationRecord: updateAllEmergencyMedicalExaminationRecord(emergencyMedicalExaminationRecords: $emergencyMedicalExaminationRecords) {
							...EmergencyMedicalExaminationRecordProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<EmergencyMedicalExaminationRecordModel>> {
		...
		const successMessage = 'Deleted Emergency Medical Examination Record entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($emergencyMedicalExaminationRecordId: ID!) {
						emergencyMedicalExaminationRecordId: deleteEmergencyMedicalExaminationRecordById(emergencyMedicalExaminationRecordId: $emergencyMedicalExaminationRecordId)
				...
				`,
				variables: {
					emergencyMedicalExaminationRecordId: id,
			...
			map(result => {
				...
				return {
					targetModelId: result.data.emergencyMedicalExaminationRecordId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<EmergencyMedicalExaminationRecordModel>> {
		...
		const successMessage = 'Deleted selected Emergency Medical Examination Record entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($emergencyMedicalExaminationRecordIds: [ID!]!){
						deleteEmergencyMedicalExaminationRecordExcludingIds(emergencyMedicalExaminationRecordIds: $emergencyMedicalExaminationRecordIds)
				...
				`,
				variables: {
					emergencyMedicalExaminationRecordIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.emergencyMedicalExaminationRecordIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<EmergencyMedicalExaminationRecordModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($emergencyMedicalExaminationRecordIds: [ID!]!) {
						emergencyMedicalExaminationRecordIds: deleteAllEmergencyMedicalExaminationRecordByIds(emergencyMedicalExaminationRecordIds: $emergencyMedicalExaminationRecordIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<EmergencyMedicalExaminationRecordModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<EmergencyMedicalExaminationRecordModel>>(
			{
				query: gql`
					query GetAudits {
						audits: emergencyMedicalExaminationRecordAudits {
							entity {
								...EmergencyMedicalExaminationRecordProperties
							}
							timestamp
			...
			map(result => {
				let audits: EmergencyMedicalExaminationRecordModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new EmergencyMedicalExaminationRecordModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<EmergencyMedicalExaminationRecordModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<EmergencyMedicalExaminationRecordModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($emergencyMedicalExaminationRecordId: ID!) {
						audits: emergencyMedicalExaminationRecordAuditsByEntityId(emergencyMedicalExaminationRecordId: $emergencyMedicalExaminationRecordId) {
							entity {
								...EmergencyMedicalExaminationRecordProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<EmergencyMedicalExaminationRecordModel>> {
		const url = environment.API_URL + '/api/emergencymedicalexaminationrecord/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<EmergencyMedicalExaminationRecordModel>> {
		const url = environment.API_URL + '/api/emergencymedicalexaminationrecord/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<EmergencyMedicalExaminationRecordModel>> {
		let apiUrl = environment.API_URL + '/api/emergencymedicalexaminationrecord/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<EmergencyMedicalExaminationRecordModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/emergencymedicalexaminationrecord/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Emergency Medical Examination Record entities')),
