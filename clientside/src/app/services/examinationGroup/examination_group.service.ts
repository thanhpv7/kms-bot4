...
import {ExaminationGroupModel} from '../../models/examinationGroup/examination_group.model';
import {ExaminationGroupModelAudit} from '../../models/examinationGroup/examination_group.model.state';
...
/**
 * Examination Group service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class ExaminationGroupService extends AbstractHttpService<ExaminationGroupModel, ExaminationGroupModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the ExaminationGroupProperties classFragment here] off begin
			fragment ExaminationGroupProperties on ExaminationGroup {
				...ExaminationGroupBaseProperties
				diagnosticGroupCode
				description
				sequence
			}
			# % protected region % [Modify the ExaminationGroupProperties classFragment here] end
			${super.fragments('ExaminationGroup').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<ExaminationGroupModel>> {
		...
		return  this.apollo.query<PassableStateConfig<ExaminationGroupModel>>(
			{
				query: gql`
					query Count {
						totalCount: countExaminationGroups
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<ExaminationGroupModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<ExaminationGroupModel>> {
		...
		return this.apollo.query<PassableStateConfig<ExaminationGroupModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						ExaminationGroupById: examinationGroupById(id: $id) {
							...ExaminationGroupProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.ExaminationGroupById as ExaminationGroupModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<ExaminationGroupModel>> {
		...
		return this.apollo.query<PassableStateConfig<ExaminationGroupModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						examinationGroups: examinationGroups(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...ExaminationGroupProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countExaminationGroups(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.examinationGroups as ExaminationGroupModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<ExaminationGroupModel>> {
		...
		return this.apollo.query<PassableStateConfig<ExaminationGroupModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						examinationGroups: lastExaminationGroups(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...ExaminationGroupProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: ExaminationGroupModel, queryParams?: QueryParams): Observable<PassableStateConfig<ExaminationGroupModel>> {
		...
		const successMessage = 'Created Examination Group entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($examinationGroup: ExaminationGroupInput!, $persistRelations: Boolean) {
						examinationGroup: createExaminationGroup(examinationGroup: $examinationGroup, persistRelations: $persistRelations) {
							...ExaminationGroupProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.examinationGroup as ExaminationGroupModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: ExaminationGroupModel[], queryParams?: QueryParams): Observable<PassableStateConfig<ExaminationGroupModel>> {
		...
		const successMessage = 'Created Multiple Examination Group entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($examinationGroups: [ExaminationGroupInput!]!) {
						examinationGroup: createAllExaminationGroup(examinationGroups: $examinationGroups) {
							...ExaminationGroupProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					examinationGroups: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.examinationGroup as ExaminationGroupModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: ExaminationGroupModel, queryParams?: QueryParams): Observable<PassableStateConfig<ExaminationGroupModel>> {
		...
		const successMessage = 'Updated Examination Group entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($examinationGroup: ExaminationGroupInput!, $persistRelations: Boolean) {
						examinationGroup: updateExaminationGroup(examinationGroup: $examinationGroup, persistRelations: $persistRelations) {
							...ExaminationGroupProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: ExaminationGroupModel[], queryParams?: QueryParams): Observable<PassableStateConfig<ExaminationGroupModel>> {
		...
		const successMessage = 'Update Multiple Examination Group entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($examinationGroups: [ExaminationGroupInput!]!) {
						examinationGroup: updateAllExaminationGroup(examinationGroups: $examinationGroups) {
							...ExaminationGroupProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<ExaminationGroupModel>> {
		...
		const successMessage = 'Deleted Examination Group entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($examinationGroupId: ID!) {
						examinationGroupId: deleteExaminationGroupById(examinationGroupId: $examinationGroupId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.examinationGroupId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<ExaminationGroupModel>> {
		...
		const successMessage = 'Deleted selected Examination Group entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($examinationGroupIds: [ID!]!){
						deleteExaminationGroupExcludingIds(examinationGroupIds: $examinationGroupIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.examinationGroupIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<ExaminationGroupModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($examinationGroupIds: [ID!]!) {
						examinationGroupIds: deleteAllExaminationGroupByIds(examinationGroupIds: $examinationGroupIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<ExaminationGroupModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<ExaminationGroupModel>>(
			...
			map(result => {
				let audits: ExaminationGroupModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new ExaminationGroupModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<ExaminationGroupModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<ExaminationGroupModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($examinationGroupId: ID!) {
						audits: examinationGroupAuditsByEntityId(examinationGroupId: $examinationGroupId) {
							entity {
								...ExaminationGroupProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<ExaminationGroupModel>> {
		const url = environment.API_URL + '/api/examinationgroup/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<ExaminationGroupModel>> {
		const url = environment.API_URL + '/api/examinationgroup/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<ExaminationGroupModel>> {
		let apiUrl = environment.API_URL + '/api/examinationgroup/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<ExaminationGroupModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/examinationgroup/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Examination Group entities')),
