...
import {TariffDefinitionModelAudit} from '../../models/tariffDefinition/tariff_definition.model.state';
...
/**
 * Tariff Definition service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class TariffDefinitionService extends AbstractHttpService<TariffDefinitionModel, TariffDefinitionModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the TariffDefinitionProperties classFragment here] off begin
			fragment TariffDefinitionProperties on TariffDefinition {
				...TariffDefinitionBaseProperties
				tariffType
				tariffCode
				tariffPrice
				hospitalPrice
			...
			# % protected region % [Modify the TariffDefinitionProperties classFragment here] end
			${super.fragments('TariffDefinition').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<TariffDefinitionModel>> {
		...
		return  this.apollo.query<PassableStateConfig<TariffDefinitionModel>>(
			{
				query: gql`
					query Count {
						totalCount: countTariffDefinitions
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<TariffDefinitionModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<TariffDefinitionModel>> {
		...
		return this.apollo.query<PassableStateConfig<TariffDefinitionModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						TariffDefinitionById: tariffDefinitionById(id: $id) {
							...TariffDefinitionProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.TariffDefinitionById as TariffDefinitionModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<TariffDefinitionModel>> {
		...
		return this.apollo.query<PassableStateConfig<TariffDefinitionModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						tariffDefinitions: tariffDefinitions(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...TariffDefinitionProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countTariffDefinitions(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.tariffDefinitions as TariffDefinitionModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<TariffDefinitionModel>> {
		...
		return this.apollo.query<PassableStateConfig<TariffDefinitionModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						tariffDefinitions: lastTariffDefinitions(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...TariffDefinitionProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: TariffDefinitionModel, queryParams?: QueryParams): Observable<PassableStateConfig<TariffDefinitionModel>> {
		...
		const successMessage = 'Created Tariff Definition entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($tariffDefinition: TariffDefinitionInput!, $persistRelations: Boolean) {
						tariffDefinition: createTariffDefinition(tariffDefinition: $tariffDefinition, persistRelations: $persistRelations) {
							...TariffDefinitionProperties,
				...
				variables: {
					tariffDefinition: {
						...entity.toJSON(),
						priceSchema: entity.priceSchema ? new TariffSchemaModel(entity.priceSchema).toJSON() : undefined,
			...
			map(result => {
				...
				return {
					targetModel: result.data.tariffDefinition as TariffDefinitionModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: TariffDefinitionModel[], queryParams?: QueryParams): Observable<PassableStateConfig<TariffDefinitionModel>> {
		...
		const successMessage = 'Created Multiple Tariff Definition entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($tariffDefinitions: [TariffDefinitionInput!]!) {
						tariffDefinition: createAllTariffDefinition(tariffDefinitions: $tariffDefinitions) {
							...TariffDefinitionProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					tariffDefinitions: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.tariffDefinition as TariffDefinitionModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: TariffDefinitionModel, queryParams?: QueryParams): Observable<PassableStateConfig<TariffDefinitionModel>> {
		...
		const successMessage = 'Updated Tariff Definition entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($tariffDefinition: TariffDefinitionInput!, $persistRelations: Boolean) {
						tariffDefinition: updateTariffDefinition(tariffDefinition: $tariffDefinition, persistRelations: $persistRelations) {
							...TariffDefinitionProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: TariffDefinitionModel[], queryParams?: QueryParams): Observable<PassableStateConfig<TariffDefinitionModel>> {
		...
		const successMessage = 'Update Multiple Tariff Definition entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($tariffDefinitions: [TariffDefinitionInput!]!) {
						tariffDefinition: updateAllTariffDefinition(tariffDefinitions: $tariffDefinitions) {
							...TariffDefinitionProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<TariffDefinitionModel>> {
		...
		const successMessage = 'Deleted Tariff Definition entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($tariffDefinitionId: ID!) {
						tariffDefinitionId: deleteTariffDefinitionById(tariffDefinitionId: $tariffDefinitionId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.tariffDefinitionId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<TariffDefinitionModel>> {
		...
		const successMessage = 'Deleted selected Tariff Definition entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($tariffDefinitionIds: [ID!]!){
						deleteTariffDefinitionExcludingIds(tariffDefinitionIds: $tariffDefinitionIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.tariffDefinitionIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<TariffDefinitionModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($tariffDefinitionIds: [ID!]!) {
						tariffDefinitionIds: deleteAllTariffDefinitionByIds(tariffDefinitionIds: $tariffDefinitionIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<TariffDefinitionModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<TariffDefinitionModel>>(
			...
			map(result => {
				let audits: TariffDefinitionModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new TariffDefinitionModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<TariffDefinitionModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<TariffDefinitionModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($tariffDefinitionId: ID!) {
						audits: tariffDefinitionAuditsByEntityId(tariffDefinitionId: $tariffDefinitionId) {
							entity {
								...TariffDefinitionProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<TariffDefinitionModel>> {
		const url = environment.API_URL + '/api/tariffdefinition/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<TariffDefinitionModel>> {
		const url = environment.API_URL + '/api/tariffdefinition/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<TariffDefinitionModel>> {
		let apiUrl = environment.API_URL + '/api/tariffdefinition/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<TariffDefinitionModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/tariffdefinition/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Tariff Definition entities')),
