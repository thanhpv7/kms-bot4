...
import {BpjsDiagnosePRBModel} from '../../models/bpjsDiagnosePRB/bpjs_diagnose_prb.model';
import {BpjsDiagnosePRBModelAudit} from '../../models/bpjsDiagnosePRB/bpjs_diagnose_prb.model.state';
...
/**
 * BPJS Diagnose PRB service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BpjsDiagnosePRBService extends AbstractHttpService<BpjsDiagnosePRBModel, BpjsDiagnosePRBModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BpjsDiagnosePRBProperties classFragment here] off begin
			fragment BpjsDiagnosePRBProperties on BpjsDiagnosePRB {
				...BpjsDiagnosePRBBaseProperties
				refCode
				refName
			}
			# % protected region % [Modify the BpjsDiagnosePRBProperties classFragment here] end
			${super.fragments('BpjsDiagnosePRB').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BpjsDiagnosePRBModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BpjsDiagnosePRBModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBpjsDiagnosePRBs
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BpjsDiagnosePRBModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsDiagnosePRBModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsDiagnosePRBModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BpjsDiagnosePRBById: bpjsDiagnosePRBById(id: $id) {
							...BpjsDiagnosePRBProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BpjsDiagnosePRBById as BpjsDiagnosePRBModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsDiagnosePRBModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsDiagnosePRBModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						bpjsDiagnosePRBs: bpjsDiagnosePRBs(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BpjsDiagnosePRBProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBpjsDiagnosePRBs(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.bpjsDiagnosePRBs as BpjsDiagnosePRBModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsDiagnosePRBModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsDiagnosePRBModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						bpjsDiagnosePRBs: lastBpjsDiagnosePRBs(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BpjsDiagnosePRBProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BpjsDiagnosePRBModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsDiagnosePRBModel>> {
		...
		const successMessage = 'Created BPJS Diagnose PRB entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($bpjsDiagnosePRB: BpjsDiagnosePRBInput!, $persistRelations: Boolean) {
						bpjsDiagnosePRB: createBpjsDiagnosePRB(bpjsDiagnosePRB: $bpjsDiagnosePRB, persistRelations: $persistRelations) {
							...BpjsDiagnosePRBProperties,
				...
				variables: {
					bpjsDiagnosePRB: {
						...entity.toJSON(),
						diagnosesAndProcedures: entity.diagnosesAndProcedures ? new DiagnosesAndProceduresModel(entity.diagnosesAndProcedures).toJSON() : undefined,
						bpjsPRBs: entity.bpjsPRBs ? entity.bpjsPRBs?.map((model: BpjsPRBModel) => new BpjsPRBModel(model).toJSON()) : [],
					},
			...
			map(result => {
				...
				return {
					targetModel: result.data.bpjsDiagnosePRB as BpjsDiagnosePRBModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BpjsDiagnosePRBModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsDiagnosePRBModel>> {
		...
		const successMessage = 'Created Multiple BPJS Diagnose PRB entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($bpjsDiagnosePRBs: [BpjsDiagnosePRBInput!]!) {
						bpjsDiagnosePRB: createAllBpjsDiagnosePRB(bpjsDiagnosePRBs: $bpjsDiagnosePRBs) {
							...BpjsDiagnosePRBProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					bpjsDiagnosePRBs: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.bpjsDiagnosePRB as BpjsDiagnosePRBModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BpjsDiagnosePRBModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsDiagnosePRBModel>> {
		...
		const successMessage = 'Updated BPJS Diagnose PRB entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($bpjsDiagnosePRB: BpjsDiagnosePRBInput!, $persistRelations: Boolean) {
						bpjsDiagnosePRB: updateBpjsDiagnosePRB(bpjsDiagnosePRB: $bpjsDiagnosePRB, persistRelations: $persistRelations) {
							...BpjsDiagnosePRBProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BpjsDiagnosePRBModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsDiagnosePRBModel>> {
		...
		const successMessage = 'Update Multiple BPJS Diagnose PRB entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($bpjsDiagnosePRBs: [BpjsDiagnosePRBInput!]!) {
						bpjsDiagnosePRB: updateAllBpjsDiagnosePRB(bpjsDiagnosePRBs: $bpjsDiagnosePRBs) {
							...BpjsDiagnosePRBProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BpjsDiagnosePRBModel>> {
		...
		const successMessage = 'Deleted BPJS Diagnose PRB entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($bpjsDiagnosePRBId: ID!) {
						bpjsDiagnosePRBId: deleteBpjsDiagnosePRBById(bpjsDiagnosePRBId: $bpjsDiagnosePRBId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.bpjsDiagnosePRBId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsDiagnosePRBModel>> {
		...
		const successMessage = 'Deleted selected BPJS Diagnose PRB entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($bpjsDiagnosePRBIds: [ID!]!){
						deleteBpjsDiagnosePRBExcludingIds(bpjsDiagnosePRBIds: $bpjsDiagnosePRBIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.bpjsDiagnosePRBIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BpjsDiagnosePRBModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($bpjsDiagnosePRBIds: [ID!]!) {
						bpjsDiagnosePRBIds: deleteAllBpjsDiagnosePRBByIds(bpjsDiagnosePRBIds: $bpjsDiagnosePRBIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BpjsDiagnosePRBModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsDiagnosePRBModel>>(
			...
			map(result => {
				let audits: BpjsDiagnosePRBModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BpjsDiagnosePRBModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BpjsDiagnosePRBModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsDiagnosePRBModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($bpjsDiagnosePRBId: ID!) {
						audits: bpjsDiagnosePRBAuditsByEntityId(bpjsDiagnosePRBId: $bpjsDiagnosePRBId) {
							entity {
								...BpjsDiagnosePRBProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BpjsDiagnosePRBModel>> {
		const url = environment.API_URL + '/api/bpjsdiagnoseprb/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BpjsDiagnosePRBModel>> {
		const url = environment.API_URL + '/api/bpjsdiagnoseprb/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsDiagnosePRBModel>> {
		let apiUrl = environment.API_URL + '/api/bpjsdiagnoseprb/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BpjsDiagnosePRBModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/bpjsdiagnoseprb/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' BPJS Diagnose PRB entities')),
