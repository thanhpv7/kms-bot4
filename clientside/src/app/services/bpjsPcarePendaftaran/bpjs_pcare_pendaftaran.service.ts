...
import {BpjsPcarePendaftaranModelAudit} from '../../models/bpjsPcarePendaftaran/bpjs_pcare_pendaftaran.model.state';
...
/**
 * Bpjs Pcare Pendaftaran service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BpjsPcarePendaftaranService extends AbstractHttpService<BpjsPcarePendaftaranModel, BpjsPcarePendaftaranModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BpjsPcarePendaftaranProperties classFragment here] off begin
			fragment BpjsPcarePendaftaranProperties on BpjsPcarePendaftaran {
				...BpjsPcarePendaftaranBaseProperties
				nourut
				tgldaftar
				providerpelayanan
				nokartu
			...
			# % protected region % [Modify the BpjsPcarePendaftaranProperties classFragment here] end
			${super.fragments('BpjsPcarePendaftaran').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BpjsPcarePendaftaranModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BpjsPcarePendaftaranModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBpjsPcarePendaftarans
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BpjsPcarePendaftaranModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPcarePendaftaranModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPcarePendaftaranModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BpjsPcarePendaftaranById: bpjsPcarePendaftaranById(id: $id) {
							...BpjsPcarePendaftaranProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BpjsPcarePendaftaranById as BpjsPcarePendaftaranModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsPcarePendaftaranModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPcarePendaftaranModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						bpjsPcarePendaftarans: bpjsPcarePendaftarans(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BpjsPcarePendaftaranProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBpjsPcarePendaftarans(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.bpjsPcarePendaftarans as BpjsPcarePendaftaranModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsPcarePendaftaranModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPcarePendaftaranModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						bpjsPcarePendaftarans: lastBpjsPcarePendaftarans(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BpjsPcarePendaftaranProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BpjsPcarePendaftaranModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPcarePendaftaranModel>> {
		...
		const successMessage = 'Created Bpjs Pcare Pendaftaran entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($bpjsPcarePendaftaran: BpjsPcarePendaftaranInput!, $persistRelations: Boolean) {
						bpjsPcarePendaftaran: createBpjsPcarePendaftaran(bpjsPcarePendaftaran: $bpjsPcarePendaftaran, persistRelations: $persistRelations) {
							...BpjsPcarePendaftaranProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.bpjsPcarePendaftaran as BpjsPcarePendaftaranModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BpjsPcarePendaftaranModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPcarePendaftaranModel>> {
		...
		const successMessage = 'Created Multiple Bpjs Pcare Pendaftaran entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($bpjsPcarePendaftarans: [BpjsPcarePendaftaranInput!]!) {
						bpjsPcarePendaftaran: createAllBpjsPcarePendaftaran(bpjsPcarePendaftarans: $bpjsPcarePendaftarans) {
							...BpjsPcarePendaftaranProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					bpjsPcarePendaftarans: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.bpjsPcarePendaftaran as BpjsPcarePendaftaranModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BpjsPcarePendaftaranModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPcarePendaftaranModel>> {
		...
		const successMessage = 'Updated Bpjs Pcare Pendaftaran entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($bpjsPcarePendaftaran: BpjsPcarePendaftaranInput!, $persistRelations: Boolean) {
						bpjsPcarePendaftaran: updateBpjsPcarePendaftaran(bpjsPcarePendaftaran: $bpjsPcarePendaftaran, persistRelations: $persistRelations) {
							...BpjsPcarePendaftaranProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BpjsPcarePendaftaranModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPcarePendaftaranModel>> {
		...
		const successMessage = 'Update Multiple Bpjs Pcare Pendaftaran entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($bpjsPcarePendaftarans: [BpjsPcarePendaftaranInput!]!) {
						bpjsPcarePendaftaran: updateAllBpjsPcarePendaftaran(bpjsPcarePendaftarans: $bpjsPcarePendaftarans) {
							...BpjsPcarePendaftaranProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BpjsPcarePendaftaranModel>> {
		...
		const successMessage = 'Deleted Bpjs Pcare Pendaftaran entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($bpjsPcarePendaftaranId: ID!) {
						bpjsPcarePendaftaranId: deleteBpjsPcarePendaftaranById(bpjsPcarePendaftaranId: $bpjsPcarePendaftaranId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.bpjsPcarePendaftaranId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsPcarePendaftaranModel>> {
		...
		const successMessage = 'Deleted selected Bpjs Pcare Pendaftaran entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($bpjsPcarePendaftaranIds: [ID!]!){
						deleteBpjsPcarePendaftaranExcludingIds(bpjsPcarePendaftaranIds: $bpjsPcarePendaftaranIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.bpjsPcarePendaftaranIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BpjsPcarePendaftaranModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($bpjsPcarePendaftaranIds: [ID!]!) {
						bpjsPcarePendaftaranIds: deleteAllBpjsPcarePendaftaranByIds(bpjsPcarePendaftaranIds: $bpjsPcarePendaftaranIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BpjsPcarePendaftaranModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPcarePendaftaranModel>>(
			{
				query: gql`
					query GetAudits {
						audits: bpjsPcarePendaftaranAudits {
							entity {
								...BpjsPcarePendaftaranProperties
							}
							timestamp
			...
			map(result => {
				let audits: BpjsPcarePendaftaranModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BpjsPcarePendaftaranModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BpjsPcarePendaftaranModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPcarePendaftaranModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($bpjsPcarePendaftaranId: ID!) {
						audits: bpjsPcarePendaftaranAuditsByEntityId(bpjsPcarePendaftaranId: $bpjsPcarePendaftaranId) {
							entity {
								...BpjsPcarePendaftaranProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BpjsPcarePendaftaranModel>> {
		const url = environment.API_URL + '/api/bpjspcarependaftaran/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BpjsPcarePendaftaranModel>> {
		const url = environment.API_URL + '/api/bpjspcarependaftaran/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsPcarePendaftaranModel>> {
		let apiUrl = environment.API_URL + '/api/bpjspcarependaftaran/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BpjsPcarePendaftaranModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/bpjspcarependaftaran/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Bpjs Pcare Pendaftaran entities')),
