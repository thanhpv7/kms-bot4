...
import {PcareNonCompoundDrugModel} from '../../models/pcareNonCompoundDrug/pcare_noncompound_drug.model';
import {PcareNonCompoundDrugModelAudit} from '../../models/pcareNonCompoundDrug/pcare_noncompound_drug.model.state';
...
/**
 * PCare NonCompound Drug service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class PcareNonCompoundDrugService extends AbstractHttpService<PcareNonCompoundDrugModel, PcareNonCompoundDrugModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the PcareNonCompoundDrugProperties classFragment here] off begin
			fragment PcareNonCompoundDrugProperties on PcareNonCompoundDrug {
				...PcareNonCompoundDrugBaseProperties
				drugCode
				drugName
				signaDays
				signaTimes
			...
			# % protected region % [Modify the PcareNonCompoundDrugProperties classFragment here] end
			${super.fragments('PcareNonCompoundDrug').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<PcareNonCompoundDrugModel>> {
		...
		return  this.apollo.query<PassableStateConfig<PcareNonCompoundDrugModel>>(
			{
				query: gql`
					query Count {
						totalCount: countPcareNonCompoundDrugs
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<PcareNonCompoundDrugModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<PcareNonCompoundDrugModel>> {
		...
		return this.apollo.query<PassableStateConfig<PcareNonCompoundDrugModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						PcareNonCompoundDrugById: pcareNonCompoundDrugById(id: $id) {
							...PcareNonCompoundDrugProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.PcareNonCompoundDrugById as PcareNonCompoundDrugModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PcareNonCompoundDrugModel>> {
		...
		return this.apollo.query<PassableStateConfig<PcareNonCompoundDrugModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						pcareNonCompoundDrugs: pcareNonCompoundDrugs(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...PcareNonCompoundDrugProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countPcareNonCompoundDrugs(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.pcareNonCompoundDrugs as PcareNonCompoundDrugModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PcareNonCompoundDrugModel>> {
		...
		return this.apollo.query<PassableStateConfig<PcareNonCompoundDrugModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						pcareNonCompoundDrugs: lastPcareNonCompoundDrugs(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...PcareNonCompoundDrugProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: PcareNonCompoundDrugModel, queryParams?: QueryParams): Observable<PassableStateConfig<PcareNonCompoundDrugModel>> {
		...
		const successMessage = 'Created PCare NonCompound Drug entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($pcareNonCompoundDrug: PcareNonCompoundDrugInput!, $persistRelations: Boolean) {
						pcareNonCompoundDrug: createPcareNonCompoundDrug(pcareNonCompoundDrug: $pcareNonCompoundDrug, persistRelations: $persistRelations) {
							...PcareNonCompoundDrugProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.pcareNonCompoundDrug as PcareNonCompoundDrugModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: PcareNonCompoundDrugModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PcareNonCompoundDrugModel>> {
		...
		const successMessage = 'Created Multiple PCare NonCompound Drug entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($pcareNonCompoundDrugs: [PcareNonCompoundDrugInput!]!) {
						pcareNonCompoundDrug: createAllPcareNonCompoundDrug(pcareNonCompoundDrugs: $pcareNonCompoundDrugs) {
							...PcareNonCompoundDrugProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					pcareNonCompoundDrugs: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.pcareNonCompoundDrug as PcareNonCompoundDrugModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: PcareNonCompoundDrugModel, queryParams?: QueryParams): Observable<PassableStateConfig<PcareNonCompoundDrugModel>> {
		...
		const successMessage = 'Updated PCare NonCompound Drug entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($pcareNonCompoundDrug: PcareNonCompoundDrugInput!, $persistRelations: Boolean) {
						pcareNonCompoundDrug: updatePcareNonCompoundDrug(pcareNonCompoundDrug: $pcareNonCompoundDrug, persistRelations: $persistRelations) {
							...PcareNonCompoundDrugProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: PcareNonCompoundDrugModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PcareNonCompoundDrugModel>> {
		...
		const successMessage = 'Update Multiple PCare NonCompound Drug entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($pcareNonCompoundDrugs: [PcareNonCompoundDrugInput!]!) {
						pcareNonCompoundDrug: updateAllPcareNonCompoundDrug(pcareNonCompoundDrugs: $pcareNonCompoundDrugs) {
							...PcareNonCompoundDrugProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<PcareNonCompoundDrugModel>> {
		...
		const successMessage = 'Deleted PCare NonCompound Drug entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($pcareNonCompoundDrugId: ID!) {
						pcareNonCompoundDrugId: deletePcareNonCompoundDrugById(pcareNonCompoundDrugId: $pcareNonCompoundDrugId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.pcareNonCompoundDrugId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<PcareNonCompoundDrugModel>> {
		...
		const successMessage = 'Deleted selected PCare NonCompound Drug entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($pcareNonCompoundDrugIds: [ID!]!){
						deletePcareNonCompoundDrugExcludingIds(pcareNonCompoundDrugIds: $pcareNonCompoundDrugIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.pcareNonCompoundDrugIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<PcareNonCompoundDrugModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($pcareNonCompoundDrugIds: [ID!]!) {
						pcareNonCompoundDrugIds: deleteAllPcareNonCompoundDrugByIds(pcareNonCompoundDrugIds: $pcareNonCompoundDrugIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<PcareNonCompoundDrugModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PcareNonCompoundDrugModel>>(
			{
				query: gql`
					query GetAudits {
						audits: pcareNonCompoundDrugAudits {
							entity {
								...PcareNonCompoundDrugProperties
							}
							timestamp
			...
			map(result => {
				let audits: PcareNonCompoundDrugModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new PcareNonCompoundDrugModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<PcareNonCompoundDrugModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PcareNonCompoundDrugModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($pcareNonCompoundDrugId: ID!) {
						audits: pcareNonCompoundDrugAuditsByEntityId(pcareNonCompoundDrugId: $pcareNonCompoundDrugId) {
							entity {
								...PcareNonCompoundDrugProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<PcareNonCompoundDrugModel>> {
		const url = environment.API_URL + '/api/pcarenoncompounddrug/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<PcareNonCompoundDrugModel>> {
		const url = environment.API_URL + '/api/pcarenoncompounddrug/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<PcareNonCompoundDrugModel>> {
		let apiUrl = environment.API_URL + '/api/pcarenoncompounddrug/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<PcareNonCompoundDrugModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/pcarenoncompounddrug/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' PCare NonCompound Drug entities')),
