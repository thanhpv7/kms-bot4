...
import {BpjsSearchSEPModel} from '../../models/bpjsSearchSEP/bpjs_search_sep.model';
import {BpjsSearchSEPModelAudit} from '../../models/bpjsSearchSEP/bpjs_search_sep.model.state';
...
/**
 * BPJS Search SEP service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BpjsSearchSEPService extends AbstractHttpService<BpjsSearchSEPModel, BpjsSearchSEPModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BpjsSearchSEPProperties classFragment here] off begin
			fragment BpjsSearchSEPProperties on BpjsSearchSEP {
				...BpjsSearchSEPBaseProperties
				sepNo
				sepDate
				treatmentType
				polyclinic
			...
			# % protected region % [Modify the BpjsSearchSEPProperties classFragment here] end
			${super.fragments('BpjsSearchSEP').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BpjsSearchSEPModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BpjsSearchSEPModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBpjsSearchSEPs
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BpjsSearchSEPModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsSearchSEPModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsSearchSEPModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BpjsSearchSEPById: bpjsSearchSEPById(id: $id) {
							...BpjsSearchSEPProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BpjsSearchSEPById as BpjsSearchSEPModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsSearchSEPModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsSearchSEPModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						bpjsSearchSEPs: bpjsSearchSEPs(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BpjsSearchSEPProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBpjsSearchSEPs(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.bpjsSearchSEPs as BpjsSearchSEPModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsSearchSEPModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsSearchSEPModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						bpjsSearchSEPs: lastBpjsSearchSEPs(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BpjsSearchSEPProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BpjsSearchSEPModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsSearchSEPModel>> {
		...
		const successMessage = 'Created BPJS Search SEP entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($bpjsSearchSEP: BpjsSearchSEPInput!, $persistRelations: Boolean) {
						bpjsSearchSEP: createBpjsSearchSEP(bpjsSearchSEP: $bpjsSearchSEP, persistRelations: $persistRelations) {
							...BpjsSearchSEPProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.bpjsSearchSEP as BpjsSearchSEPModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BpjsSearchSEPModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsSearchSEPModel>> {
		...
		const successMessage = 'Created Multiple BPJS Search SEP entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($bpjsSearchSEPs: [BpjsSearchSEPInput!]!) {
						bpjsSearchSEP: createAllBpjsSearchSEP(bpjsSearchSEPs: $bpjsSearchSEPs) {
							...BpjsSearchSEPProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					bpjsSearchSEPs: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.bpjsSearchSEP as BpjsSearchSEPModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BpjsSearchSEPModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsSearchSEPModel>> {
		...
		const successMessage = 'Updated BPJS Search SEP entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($bpjsSearchSEP: BpjsSearchSEPInput!, $persistRelations: Boolean) {
						bpjsSearchSEP: updateBpjsSearchSEP(bpjsSearchSEP: $bpjsSearchSEP, persistRelations: $persistRelations) {
							...BpjsSearchSEPProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BpjsSearchSEPModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsSearchSEPModel>> {
		...
		const successMessage = 'Update Multiple BPJS Search SEP entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($bpjsSearchSEPs: [BpjsSearchSEPInput!]!) {
						bpjsSearchSEP: updateAllBpjsSearchSEP(bpjsSearchSEPs: $bpjsSearchSEPs) {
							...BpjsSearchSEPProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BpjsSearchSEPModel>> {
		...
		const successMessage = 'Deleted BPJS Search SEP entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($bpjsSearchSEPId: ID!) {
						bpjsSearchSEPId: deleteBpjsSearchSEPById(bpjsSearchSEPId: $bpjsSearchSEPId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.bpjsSearchSEPId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsSearchSEPModel>> {
		...
		const successMessage = 'Deleted selected BPJS Search SEP entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($bpjsSearchSEPIds: [ID!]!){
						deleteBpjsSearchSEPExcludingIds(bpjsSearchSEPIds: $bpjsSearchSEPIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.bpjsSearchSEPIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BpjsSearchSEPModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($bpjsSearchSEPIds: [ID!]!) {
						bpjsSearchSEPIds: deleteAllBpjsSearchSEPByIds(bpjsSearchSEPIds: $bpjsSearchSEPIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BpjsSearchSEPModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsSearchSEPModel>>(
			...
			map(result => {
				let audits: BpjsSearchSEPModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BpjsSearchSEPModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BpjsSearchSEPModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsSearchSEPModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($bpjsSearchSEPId: ID!) {
						audits: bpjsSearchSEPAuditsByEntityId(bpjsSearchSEPId: $bpjsSearchSEPId) {
							entity {
								...BpjsSearchSEPProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BpjsSearchSEPModel>> {
		const url = environment.API_URL + '/api/bpjssearchsep/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BpjsSearchSEPModel>> {
		const url = environment.API_URL + '/api/bpjssearchsep/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsSearchSEPModel>> {
		let apiUrl = environment.API_URL + '/api/bpjssearchsep/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BpjsSearchSEPModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/bpjssearchsep/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' BPJS Search SEP entities')),
