...
import {MedicalCertificateMentalHealthModel} from '../../models/medicalCertificateMentalHealth/medical_certificate_mental_health.model';
import {MedicalCertificateMentalHealthModelAudit} from '../../models/medicalCertificateMentalHealth/medical_certificate_mental_health.model.state';
...
/**
 * Medical Certificate Mental Health service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class MedicalCertificateMentalHealthService extends AbstractHttpService<MedicalCertificateMentalHealthModel, MedicalCertificateMentalHealthModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the MedicalCertificateMentalHealthProperties classFragment here] off begin
			fragment MedicalCertificateMentalHealthProperties on MedicalCertificateMentalHealth {
				...MedicalCertificateMentalHealthBaseProperties
				examinationDateTime
				examinationResult
				notes
				purpose
			}
			# % protected region % [Modify the MedicalCertificateMentalHealthProperties classFragment here] end
			${super.fragments('MedicalCertificateMentalHealth').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<MedicalCertificateMentalHealthModel>> {
		...
		return  this.apollo.query<PassableStateConfig<MedicalCertificateMentalHealthModel>>(
			{
				query: gql`
					query Count {
						totalCount: countMedicalCertificateMentalHealths
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<MedicalCertificateMentalHealthModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<MedicalCertificateMentalHealthModel>> {
		...
		return this.apollo.query<PassableStateConfig<MedicalCertificateMentalHealthModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						MedicalCertificateMentalHealthById: medicalCertificateMentalHealthById(id: $id) {
							...MedicalCertificateMentalHealthProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.MedicalCertificateMentalHealthById as MedicalCertificateMentalHealthModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<MedicalCertificateMentalHealthModel>> {
		...
		return this.apollo.query<PassableStateConfig<MedicalCertificateMentalHealthModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						medicalCertificateMentalHealths: medicalCertificateMentalHealths(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...MedicalCertificateMentalHealthProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countMedicalCertificateMentalHealths(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.medicalCertificateMentalHealths as MedicalCertificateMentalHealthModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<MedicalCertificateMentalHealthModel>> {
		...
		return this.apollo.query<PassableStateConfig<MedicalCertificateMentalHealthModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						medicalCertificateMentalHealths: lastMedicalCertificateMentalHealths(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...MedicalCertificateMentalHealthProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: MedicalCertificateMentalHealthModel, queryParams?: QueryParams): Observable<PassableStateConfig<MedicalCertificateMentalHealthModel>> {
		...
		const successMessage = 'Created Medical Certificate Mental Health entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($medicalCertificateMentalHealth: MedicalCertificateMentalHealthInput!, $persistRelations: Boolean) {
						medicalCertificateMentalHealth: createMedicalCertificateMentalHealth(medicalCertificateMentalHealth: $medicalCertificateMentalHealth, persistRelations: $persistRelations) {
							...MedicalCertificateMentalHealthProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.medicalCertificateMentalHealth as MedicalCertificateMentalHealthModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: MedicalCertificateMentalHealthModel[], queryParams?: QueryParams): Observable<PassableStateConfig<MedicalCertificateMentalHealthModel>> {
		...
		const successMessage = 'Created Multiple Medical Certificate Mental Health entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($medicalCertificateMentalHealths: [MedicalCertificateMentalHealthInput!]!) {
						medicalCertificateMentalHealth: createAllMedicalCertificateMentalHealth(medicalCertificateMentalHealths: $medicalCertificateMentalHealths) {
							...MedicalCertificateMentalHealthProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					medicalCertificateMentalHealths: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.medicalCertificateMentalHealth as MedicalCertificateMentalHealthModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: MedicalCertificateMentalHealthModel, queryParams?: QueryParams): Observable<PassableStateConfig<MedicalCertificateMentalHealthModel>> {
		...
		const successMessage = 'Updated Medical Certificate Mental Health entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($medicalCertificateMentalHealth: MedicalCertificateMentalHealthInput!, $persistRelations: Boolean) {
						medicalCertificateMentalHealth: updateMedicalCertificateMentalHealth(medicalCertificateMentalHealth: $medicalCertificateMentalHealth, persistRelations: $persistRelations) {
							...MedicalCertificateMentalHealthProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: MedicalCertificateMentalHealthModel[], queryParams?: QueryParams): Observable<PassableStateConfig<MedicalCertificateMentalHealthModel>> {
		...
		const successMessage = 'Update Multiple Medical Certificate Mental Health entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($medicalCertificateMentalHealths: [MedicalCertificateMentalHealthInput!]!) {
						medicalCertificateMentalHealth: updateAllMedicalCertificateMentalHealth(medicalCertificateMentalHealths: $medicalCertificateMentalHealths) {
							...MedicalCertificateMentalHealthProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<MedicalCertificateMentalHealthModel>> {
		...
		const successMessage = 'Deleted Medical Certificate Mental Health entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($medicalCertificateMentalHealthId: ID!) {
						medicalCertificateMentalHealthId: deleteMedicalCertificateMentalHealthById(medicalCertificateMentalHealthId: $medicalCertificateMentalHealthId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.medicalCertificateMentalHealthId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<MedicalCertificateMentalHealthModel>> {
		...
		const successMessage = 'Deleted selected Medical Certificate Mental Health entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($medicalCertificateMentalHealthIds: [ID!]!){
						deleteMedicalCertificateMentalHealthExcludingIds(medicalCertificateMentalHealthIds: $medicalCertificateMentalHealthIds)
				...
				`,
				variables: {
					medicalCertificateMentalHealthIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.medicalCertificateMentalHealthIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<MedicalCertificateMentalHealthModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($medicalCertificateMentalHealthIds: [ID!]!) {
						medicalCertificateMentalHealthIds: deleteAllMedicalCertificateMentalHealthByIds(medicalCertificateMentalHealthIds: $medicalCertificateMentalHealthIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<MedicalCertificateMentalHealthModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<MedicalCertificateMentalHealthModel>>(
			{
				query: gql`
					query GetAudits {
						audits: medicalCertificateMentalHealthAudits {
							entity {
								...MedicalCertificateMentalHealthProperties
							}
							timestamp
			...
			map(result => {
				let audits: MedicalCertificateMentalHealthModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new MedicalCertificateMentalHealthModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<MedicalCertificateMentalHealthModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<MedicalCertificateMentalHealthModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($medicalCertificateMentalHealthId: ID!) {
						audits: medicalCertificateMentalHealthAuditsByEntityId(medicalCertificateMentalHealthId: $medicalCertificateMentalHealthId) {
							entity {
								...MedicalCertificateMentalHealthProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<MedicalCertificateMentalHealthModel>> {
		const url = environment.API_URL + '/api/medicalcertificatementalhealth/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<MedicalCertificateMentalHealthModel>> {
		const url = environment.API_URL + '/api/medicalcertificatementalhealth/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<MedicalCertificateMentalHealthModel>> {
		let apiUrl = environment.API_URL + '/api/medicalcertificatementalhealth/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<MedicalCertificateMentalHealthModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/medicalcertificatementalhealth/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Medical Certificate Mental Health entities')),
