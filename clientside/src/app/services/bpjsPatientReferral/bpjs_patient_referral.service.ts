...
import {BpjsPatientReferralModel} from '../../models/bpjsPatientReferral/bpjs_patient_referral.model';
import {BpjsPatientReferralModelAudit} from '../../models/bpjsPatientReferral/bpjs_patient_referral.model.state';
...
/**
 * BPJS Patient Referral service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BpjsPatientReferralService extends AbstractHttpService<BpjsPatientReferralModel, BpjsPatientReferralModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BpjsPatientReferralProperties classFragment here] off begin
			fragment BpjsPatientReferralProperties on BpjsPatientReferral {
				...BpjsPatientReferralBaseProperties
				noSEP
				referralNo
				referredType
				referralDate
			...
			# % protected region % [Modify the BpjsPatientReferralProperties classFragment here] end
			${super.fragments('BpjsPatientReferral').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BpjsPatientReferralModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BpjsPatientReferralModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBpjsPatientReferrals
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BpjsPatientReferralModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPatientReferralModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPatientReferralModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BpjsPatientReferralById: bpjsPatientReferralById(id: $id) {
							...BpjsPatientReferralProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BpjsPatientReferralById as BpjsPatientReferralModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsPatientReferralModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPatientReferralModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						bpjsPatientReferrals: bpjsPatientReferrals(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BpjsPatientReferralProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBpjsPatientReferrals(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.bpjsPatientReferrals as BpjsPatientReferralModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsPatientReferralModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPatientReferralModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						bpjsPatientReferrals: lastBpjsPatientReferrals(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BpjsPatientReferralProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BpjsPatientReferralModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPatientReferralModel>> {
		...
		const successMessage = 'Created BPJS Patient Referral entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($bpjsPatientReferral: BpjsPatientReferralInput!, $persistRelations: Boolean) {
						bpjsPatientReferral: createBpjsPatientReferral(bpjsPatientReferral: $bpjsPatientReferral, persistRelations: $persistRelations) {
							...BpjsPatientReferralProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.bpjsPatientReferral as BpjsPatientReferralModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BpjsPatientReferralModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPatientReferralModel>> {
		...
		const successMessage = 'Created Multiple BPJS Patient Referral entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($bpjsPatientReferrals: [BpjsPatientReferralInput!]!) {
						bpjsPatientReferral: createAllBpjsPatientReferral(bpjsPatientReferrals: $bpjsPatientReferrals) {
							...BpjsPatientReferralProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					bpjsPatientReferrals: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.bpjsPatientReferral as BpjsPatientReferralModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BpjsPatientReferralModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPatientReferralModel>> {
		...
		const successMessage = 'Updated BPJS Patient Referral entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($bpjsPatientReferral: BpjsPatientReferralInput!, $persistRelations: Boolean) {
						bpjsPatientReferral: updateBpjsPatientReferral(bpjsPatientReferral: $bpjsPatientReferral, persistRelations: $persistRelations) {
							...BpjsPatientReferralProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BpjsPatientReferralModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPatientReferralModel>> {
		...
		const successMessage = 'Update Multiple BPJS Patient Referral entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($bpjsPatientReferrals: [BpjsPatientReferralInput!]!) {
						bpjsPatientReferral: updateAllBpjsPatientReferral(bpjsPatientReferrals: $bpjsPatientReferrals) {
							...BpjsPatientReferralProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BpjsPatientReferralModel>> {
		...
		const successMessage = 'Deleted BPJS Patient Referral entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($bpjsPatientReferralId: ID!) {
						bpjsPatientReferralId: deleteBpjsPatientReferralById(bpjsPatientReferralId: $bpjsPatientReferralId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.bpjsPatientReferralId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsPatientReferralModel>> {
		...
		const successMessage = 'Deleted selected BPJS Patient Referral entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($bpjsPatientReferralIds: [ID!]!){
						deleteBpjsPatientReferralExcludingIds(bpjsPatientReferralIds: $bpjsPatientReferralIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.bpjsPatientReferralIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BpjsPatientReferralModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($bpjsPatientReferralIds: [ID!]!) {
						bpjsPatientReferralIds: deleteAllBpjsPatientReferralByIds(bpjsPatientReferralIds: $bpjsPatientReferralIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BpjsPatientReferralModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPatientReferralModel>>(
			{
				query: gql`
					query GetAudits {
						audits: bpjsPatientReferralAudits {
							entity {
								...BpjsPatientReferralProperties
							}
							timestamp
			...
			map(result => {
				let audits: BpjsPatientReferralModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BpjsPatientReferralModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BpjsPatientReferralModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPatientReferralModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($bpjsPatientReferralId: ID!) {
						audits: bpjsPatientReferralAuditsByEntityId(bpjsPatientReferralId: $bpjsPatientReferralId) {
							entity {
								...BpjsPatientReferralProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BpjsPatientReferralModel>> {
		const url = environment.API_URL + '/api/bpjspatientreferral/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BpjsPatientReferralModel>> {
		const url = environment.API_URL + '/api/bpjspatientreferral/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsPatientReferralModel>> {
		let apiUrl = environment.API_URL + '/api/bpjspatientreferral/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BpjsPatientReferralModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/bpjspatientreferral/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' BPJS Patient Referral entities')),
