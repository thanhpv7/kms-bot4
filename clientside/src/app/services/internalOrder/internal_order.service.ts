...
import {InternalOrderModel} from '../../models/internalOrder/internal_order.model';
import {InternalOrderModelAudit} from '../../models/internalOrder/internal_order.model.state';
...
/**
 * Internal Order service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class InternalOrderService extends AbstractHttpService<InternalOrderModel, InternalOrderModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the InternalOrderProperties classFragment here] off begin
			fragment InternalOrderProperties on InternalOrder {
				...InternalOrderBaseProperties
				internalOrderNumber
				transactionStatus
				approvalStatus
				orderDate
			...
			# % protected region % [Modify the InternalOrderProperties classFragment here] end
			${super.fragments('InternalOrder').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<InternalOrderModel>> {
		...
		return  this.apollo.query<PassableStateConfig<InternalOrderModel>>(
			{
				query: gql`
					query Count {
						totalCount: countInternalOrders
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<InternalOrderModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<InternalOrderModel>> {
		...
		return this.apollo.query<PassableStateConfig<InternalOrderModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						InternalOrderById: internalOrderById(id: $id) {
							...InternalOrderProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.InternalOrderById as InternalOrderModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<InternalOrderModel>> {
		...
		return this.apollo.query<PassableStateConfig<InternalOrderModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						internalOrders: internalOrders(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...InternalOrderProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countInternalOrders(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.internalOrders as InternalOrderModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<InternalOrderModel>> {
		...
		return this.apollo.query<PassableStateConfig<InternalOrderModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						internalOrders: lastInternalOrders(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...InternalOrderProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: InternalOrderModel, queryParams?: QueryParams): Observable<PassableStateConfig<InternalOrderModel>> {
		...
		const successMessage = 'Created Internal Order entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($internalOrder: InternalOrderInput!, $persistRelations: Boolean) {
						internalOrder: createInternalOrder(internalOrder: $internalOrder, persistRelations: $persistRelations) {
							...InternalOrderProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.internalOrder as InternalOrderModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: InternalOrderModel[], queryParams?: QueryParams): Observable<PassableStateConfig<InternalOrderModel>> {
		...
		const successMessage = 'Created Multiple Internal Order entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($internalOrders: [InternalOrderInput!]!) {
						internalOrder: createAllInternalOrder(internalOrders: $internalOrders) {
							...InternalOrderProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					internalOrders: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.internalOrder as InternalOrderModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: InternalOrderModel, queryParams?: QueryParams): Observable<PassableStateConfig<InternalOrderModel>> {
		...
		const successMessage = 'Updated Internal Order entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($internalOrder: InternalOrderInput!, $persistRelations: Boolean) {
						internalOrder: updateInternalOrder(internalOrder: $internalOrder, persistRelations: $persistRelations) {
							...InternalOrderProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: InternalOrderModel[], queryParams?: QueryParams): Observable<PassableStateConfig<InternalOrderModel>> {
		...
		const successMessage = 'Update Multiple Internal Order entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($internalOrders: [InternalOrderInput!]!) {
						internalOrder: updateAllInternalOrder(internalOrders: $internalOrders) {
							...InternalOrderProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<InternalOrderModel>> {
		...
		const successMessage = 'Deleted Internal Order entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($internalOrderId: ID!) {
						internalOrderId: deleteInternalOrderById(internalOrderId: $internalOrderId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.internalOrderId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<InternalOrderModel>> {
		...
		const successMessage = 'Deleted selected Internal Order entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($internalOrderIds: [ID!]!){
						deleteInternalOrderExcludingIds(internalOrderIds: $internalOrderIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.internalOrderIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<InternalOrderModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($internalOrderIds: [ID!]!) {
						internalOrderIds: deleteAllInternalOrderByIds(internalOrderIds: $internalOrderIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<InternalOrderModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<InternalOrderModel>>(
			...
			map(result => {
				let audits: InternalOrderModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new InternalOrderModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<InternalOrderModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<InternalOrderModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($internalOrderId: ID!) {
						audits: internalOrderAuditsByEntityId(internalOrderId: $internalOrderId) {
							entity {
								...InternalOrderProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<InternalOrderModel>> {
		const url = environment.API_URL + '/api/internalorder/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<InternalOrderModel>> {
		const url = environment.API_URL + '/api/internalorder/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<InternalOrderModel>> {
		let apiUrl = environment.API_URL + '/api/internalorder/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<InternalOrderModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/internalorder/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Internal Order entities')),
