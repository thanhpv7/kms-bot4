...
import {InvoicePaymentOtherModel} from '../../models/invoicePaymentOther/invoice_payment_other.model';
import {InvoicePaymentOtherModelAudit} from '../../models/invoicePaymentOther/invoice_payment_other.model.state';
...
/**
 * Invoice Payment Other service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class InvoicePaymentOtherService extends AbstractHttpService<InvoicePaymentOtherModel, InvoicePaymentOtherModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the InvoicePaymentOtherProperties classFragment here] off begin
			fragment InvoicePaymentOtherProperties on InvoicePaymentOther {
				...InvoicePaymentOtherBaseProperties
				notes
				taxAmount
			}
			# % protected region % [Modify the InvoicePaymentOtherProperties classFragment here] end
			${super.fragments('InvoicePaymentOther').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<InvoicePaymentOtherModel>> {
		...
		return  this.apollo.query<PassableStateConfig<InvoicePaymentOtherModel>>(
			{
				query: gql`
					query Count {
						totalCount: countInvoicePaymentOthers
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<InvoicePaymentOtherModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<InvoicePaymentOtherModel>> {
		...
		return this.apollo.query<PassableStateConfig<InvoicePaymentOtherModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						InvoicePaymentOtherById: invoicePaymentOtherById(id: $id) {
							...InvoicePaymentOtherProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.InvoicePaymentOtherById as InvoicePaymentOtherModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<InvoicePaymentOtherModel>> {
		...
		return this.apollo.query<PassableStateConfig<InvoicePaymentOtherModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						invoicePaymentOthers: invoicePaymentOthers(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...InvoicePaymentOtherProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countInvoicePaymentOthers(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.invoicePaymentOthers as InvoicePaymentOtherModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<InvoicePaymentOtherModel>> {
		...
		return this.apollo.query<PassableStateConfig<InvoicePaymentOtherModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						invoicePaymentOthers: lastInvoicePaymentOthers(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...InvoicePaymentOtherProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: InvoicePaymentOtherModel, queryParams?: QueryParams): Observable<PassableStateConfig<InvoicePaymentOtherModel>> {
		...
		const successMessage = 'Created Invoice Payment Other entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($invoicePaymentOther: InvoicePaymentOtherInput!, $persistRelations: Boolean) {
						invoicePaymentOther: createInvoicePaymentOther(invoicePaymentOther: $invoicePaymentOther, persistRelations: $persistRelations) {
							...InvoicePaymentOtherProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.invoicePaymentOther as InvoicePaymentOtherModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: InvoicePaymentOtherModel[], queryParams?: QueryParams): Observable<PassableStateConfig<InvoicePaymentOtherModel>> {
		...
		const successMessage = 'Created Multiple Invoice Payment Other entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($invoicePaymentOthers: [InvoicePaymentOtherInput!]!) {
						invoicePaymentOther: createAllInvoicePaymentOther(invoicePaymentOthers: $invoicePaymentOthers) {
							...InvoicePaymentOtherProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					invoicePaymentOthers: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.invoicePaymentOther as InvoicePaymentOtherModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: InvoicePaymentOtherModel, queryParams?: QueryParams): Observable<PassableStateConfig<InvoicePaymentOtherModel>> {
		...
		const successMessage = 'Updated Invoice Payment Other entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($invoicePaymentOther: InvoicePaymentOtherInput!, $persistRelations: Boolean) {
						invoicePaymentOther: updateInvoicePaymentOther(invoicePaymentOther: $invoicePaymentOther, persistRelations: $persistRelations) {
							...InvoicePaymentOtherProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: InvoicePaymentOtherModel[], queryParams?: QueryParams): Observable<PassableStateConfig<InvoicePaymentOtherModel>> {
		...
		const successMessage = 'Update Multiple Invoice Payment Other entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($invoicePaymentOthers: [InvoicePaymentOtherInput!]!) {
						invoicePaymentOther: updateAllInvoicePaymentOther(invoicePaymentOthers: $invoicePaymentOthers) {
							...InvoicePaymentOtherProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<InvoicePaymentOtherModel>> {
		...
		const successMessage = 'Deleted Invoice Payment Other entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($invoicePaymentOtherId: ID!) {
						invoicePaymentOtherId: deleteInvoicePaymentOtherById(invoicePaymentOtherId: $invoicePaymentOtherId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.invoicePaymentOtherId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<InvoicePaymentOtherModel>> {
		...
		const successMessage = 'Deleted selected Invoice Payment Other entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($invoicePaymentOtherIds: [ID!]!){
						deleteInvoicePaymentOtherExcludingIds(invoicePaymentOtherIds: $invoicePaymentOtherIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.invoicePaymentOtherIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<InvoicePaymentOtherModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($invoicePaymentOtherIds: [ID!]!) {
						invoicePaymentOtherIds: deleteAllInvoicePaymentOtherByIds(invoicePaymentOtherIds: $invoicePaymentOtherIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<InvoicePaymentOtherModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<InvoicePaymentOtherModel>>(
			{
				query: gql`
					query GetAudits {
						audits: invoicePaymentOtherAudits {
							entity {
								...InvoicePaymentOtherProperties
							}
							timestamp
			...
			map(result => {
				let audits: InvoicePaymentOtherModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new InvoicePaymentOtherModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<InvoicePaymentOtherModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<InvoicePaymentOtherModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($invoicePaymentOtherId: ID!) {
						audits: invoicePaymentOtherAuditsByEntityId(invoicePaymentOtherId: $invoicePaymentOtherId) {
							entity {
								...InvoicePaymentOtherProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<InvoicePaymentOtherModel>> {
		const url = environment.API_URL + '/api/invoicepaymentother/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<InvoicePaymentOtherModel>> {
		const url = environment.API_URL + '/api/invoicepaymentother/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<InvoicePaymentOtherModel>> {
		let apiUrl = environment.API_URL + '/api/invoicepaymentother/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<InvoicePaymentOtherModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/invoicepaymentother/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Invoice Payment Other entities')),
