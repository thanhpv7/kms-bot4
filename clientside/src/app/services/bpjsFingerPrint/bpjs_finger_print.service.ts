...
import {BpjsFingerPrintModel} from '../../models/bpjsFingerPrint/bpjs_finger_print.model';
import {BpjsFingerPrintModelAudit} from '../../models/bpjsFingerPrint/bpjs_finger_print.model.state';
...
/**
 * BPJS Finger Print service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BpjsFingerPrintService extends AbstractHttpService<BpjsFingerPrintModel, BpjsFingerPrintModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BpjsFingerPrintProperties classFragment here] off begin
			fragment BpjsFingerPrintProperties on BpjsFingerPrint {
				...BpjsFingerPrintBaseProperties
				bpjsCardNo
				visitDate
				code
				status
			}
			# % protected region % [Modify the BpjsFingerPrintProperties classFragment here] end
			${super.fragments('BpjsFingerPrint').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BpjsFingerPrintModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BpjsFingerPrintModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBpjsFingerPrints
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BpjsFingerPrintModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsFingerPrintModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsFingerPrintModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BpjsFingerPrintById: bpjsFingerPrintById(id: $id) {
							...BpjsFingerPrintProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BpjsFingerPrintById as BpjsFingerPrintModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsFingerPrintModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsFingerPrintModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						bpjsFingerPrints: bpjsFingerPrints(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BpjsFingerPrintProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBpjsFingerPrints(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.bpjsFingerPrints as BpjsFingerPrintModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsFingerPrintModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsFingerPrintModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						bpjsFingerPrints: lastBpjsFingerPrints(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BpjsFingerPrintProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BpjsFingerPrintModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsFingerPrintModel>> {
		...
		const successMessage = 'Created BPJS Finger Print entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($bpjsFingerPrint: BpjsFingerPrintInput!, $persistRelations: Boolean) {
						bpjsFingerPrint: createBpjsFingerPrint(bpjsFingerPrint: $bpjsFingerPrint, persistRelations: $persistRelations) {
							...BpjsFingerPrintProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.bpjsFingerPrint as BpjsFingerPrintModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BpjsFingerPrintModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsFingerPrintModel>> {
		...
		const successMessage = 'Created Multiple BPJS Finger Print entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($bpjsFingerPrints: [BpjsFingerPrintInput!]!) {
						bpjsFingerPrint: createAllBpjsFingerPrint(bpjsFingerPrints: $bpjsFingerPrints) {
							...BpjsFingerPrintProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					bpjsFingerPrints: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.bpjsFingerPrint as BpjsFingerPrintModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BpjsFingerPrintModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsFingerPrintModel>> {
		...
		const successMessage = 'Updated BPJS Finger Print entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($bpjsFingerPrint: BpjsFingerPrintInput!, $persistRelations: Boolean) {
						bpjsFingerPrint: updateBpjsFingerPrint(bpjsFingerPrint: $bpjsFingerPrint, persistRelations: $persistRelations) {
							...BpjsFingerPrintProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BpjsFingerPrintModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsFingerPrintModel>> {
		...
		const successMessage = 'Update Multiple BPJS Finger Print entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($bpjsFingerPrints: [BpjsFingerPrintInput!]!) {
						bpjsFingerPrint: updateAllBpjsFingerPrint(bpjsFingerPrints: $bpjsFingerPrints) {
							...BpjsFingerPrintProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BpjsFingerPrintModel>> {
		...
		const successMessage = 'Deleted BPJS Finger Print entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($bpjsFingerPrintId: ID!) {
						bpjsFingerPrintId: deleteBpjsFingerPrintById(bpjsFingerPrintId: $bpjsFingerPrintId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.bpjsFingerPrintId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsFingerPrintModel>> {
		...
		const successMessage = 'Deleted selected BPJS Finger Print entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($bpjsFingerPrintIds: [ID!]!){
						deleteBpjsFingerPrintExcludingIds(bpjsFingerPrintIds: $bpjsFingerPrintIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.bpjsFingerPrintIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BpjsFingerPrintModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($bpjsFingerPrintIds: [ID!]!) {
						bpjsFingerPrintIds: deleteAllBpjsFingerPrintByIds(bpjsFingerPrintIds: $bpjsFingerPrintIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BpjsFingerPrintModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsFingerPrintModel>>(
			...
			map(result => {
				let audits: BpjsFingerPrintModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BpjsFingerPrintModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BpjsFingerPrintModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsFingerPrintModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($bpjsFingerPrintId: ID!) {
						audits: bpjsFingerPrintAuditsByEntityId(bpjsFingerPrintId: $bpjsFingerPrintId) {
							entity {
								...BpjsFingerPrintProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BpjsFingerPrintModel>> {
		const url = environment.API_URL + '/api/bpjsfingerprint/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BpjsFingerPrintModel>> {
		const url = environment.API_URL + '/api/bpjsfingerprint/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsFingerPrintModel>> {
		let apiUrl = environment.API_URL + '/api/bpjsfingerprint/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BpjsFingerPrintModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/bpjsfingerprint/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' BPJS Finger Print entities')),
