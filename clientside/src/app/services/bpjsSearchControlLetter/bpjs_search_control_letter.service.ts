...
import {BpjsSearchControlLetterModel} from '../../models/bpjsSearchControlLetter/bpjs_search_control_letter.model';
import {BpjsSearchControlLetterModelAudit} from '../../models/bpjsSearchControlLetter/bpjs_search_control_letter.model.state';
...
/**
 * BPJS Search Control Letter service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BpjsSearchControlLetterService extends AbstractHttpService<BpjsSearchControlLetterModel, BpjsSearchControlLetterModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BpjsSearchControlLetterProperties classFragment here] off begin
			fragment BpjsSearchControlLetterProperties on BpjsSearchControlLetter {
				...BpjsSearchControlLetterBaseProperties
				controlLetterNo
				controlPlanDate
				date
				controlType
			...
			# % protected region % [Modify the BpjsSearchControlLetterProperties classFragment here] end
			${super.fragments('BpjsSearchControlLetter').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BpjsSearchControlLetterModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BpjsSearchControlLetterModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBpjsSearchControlLetters
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BpjsSearchControlLetterModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsSearchControlLetterModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsSearchControlLetterModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BpjsSearchControlLetterById: bpjsSearchControlLetterById(id: $id) {
							...BpjsSearchControlLetterProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BpjsSearchControlLetterById as BpjsSearchControlLetterModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsSearchControlLetterModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsSearchControlLetterModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						bpjsSearchControlLetters: bpjsSearchControlLetters(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BpjsSearchControlLetterProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBpjsSearchControlLetters(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.bpjsSearchControlLetters as BpjsSearchControlLetterModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsSearchControlLetterModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsSearchControlLetterModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						bpjsSearchControlLetters: lastBpjsSearchControlLetters(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BpjsSearchControlLetterProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BpjsSearchControlLetterModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsSearchControlLetterModel>> {
		...
		const successMessage = 'Created BPJS Search Control Letter entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($bpjsSearchControlLetter: BpjsSearchControlLetterInput!, $persistRelations: Boolean) {
						bpjsSearchControlLetter: createBpjsSearchControlLetter(bpjsSearchControlLetter: $bpjsSearchControlLetter, persistRelations: $persistRelations) {
							...BpjsSearchControlLetterProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.bpjsSearchControlLetter as BpjsSearchControlLetterModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BpjsSearchControlLetterModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsSearchControlLetterModel>> {
		...
		const successMessage = 'Created Multiple BPJS Search Control Letter entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($bpjsSearchControlLetters: [BpjsSearchControlLetterInput!]!) {
						bpjsSearchControlLetter: createAllBpjsSearchControlLetter(bpjsSearchControlLetters: $bpjsSearchControlLetters) {
							...BpjsSearchControlLetterProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					bpjsSearchControlLetters: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.bpjsSearchControlLetter as BpjsSearchControlLetterModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BpjsSearchControlLetterModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsSearchControlLetterModel>> {
		...
		const successMessage = 'Updated BPJS Search Control Letter entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($bpjsSearchControlLetter: BpjsSearchControlLetterInput!, $persistRelations: Boolean) {
						bpjsSearchControlLetter: updateBpjsSearchControlLetter(bpjsSearchControlLetter: $bpjsSearchControlLetter, persistRelations: $persistRelations) {
							...BpjsSearchControlLetterProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BpjsSearchControlLetterModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsSearchControlLetterModel>> {
		...
		const successMessage = 'Update Multiple BPJS Search Control Letter entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($bpjsSearchControlLetters: [BpjsSearchControlLetterInput!]!) {
						bpjsSearchControlLetter: updateAllBpjsSearchControlLetter(bpjsSearchControlLetters: $bpjsSearchControlLetters) {
							...BpjsSearchControlLetterProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BpjsSearchControlLetterModel>> {
		...
		const successMessage = 'Deleted BPJS Search Control Letter entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($bpjsSearchControlLetterId: ID!) {
						bpjsSearchControlLetterId: deleteBpjsSearchControlLetterById(bpjsSearchControlLetterId: $bpjsSearchControlLetterId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.bpjsSearchControlLetterId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsSearchControlLetterModel>> {
		...
		const successMessage = 'Deleted selected BPJS Search Control Letter entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($bpjsSearchControlLetterIds: [ID!]!){
						deleteBpjsSearchControlLetterExcludingIds(bpjsSearchControlLetterIds: $bpjsSearchControlLetterIds)
				...
				`,
				variables: {
					bpjsSearchControlLetterIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.bpjsSearchControlLetterIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BpjsSearchControlLetterModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($bpjsSearchControlLetterIds: [ID!]!) {
						bpjsSearchControlLetterIds: deleteAllBpjsSearchControlLetterByIds(bpjsSearchControlLetterIds: $bpjsSearchControlLetterIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BpjsSearchControlLetterModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsSearchControlLetterModel>>(
			{
				query: gql`
					query GetAudits {
						audits: bpjsSearchControlLetterAudits {
							entity {
								...BpjsSearchControlLetterProperties
							}
							timestamp
			...
			map(result => {
				let audits: BpjsSearchControlLetterModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BpjsSearchControlLetterModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BpjsSearchControlLetterModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsSearchControlLetterModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($bpjsSearchControlLetterId: ID!) {
						audits: bpjsSearchControlLetterAuditsByEntityId(bpjsSearchControlLetterId: $bpjsSearchControlLetterId) {
							entity {
								...BpjsSearchControlLetterProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BpjsSearchControlLetterModel>> {
		const url = environment.API_URL + '/api/bpjssearchcontrolletter/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BpjsSearchControlLetterModel>> {
		const url = environment.API_URL + '/api/bpjssearchcontrolletter/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsSearchControlLetterModel>> {
		let apiUrl = environment.API_URL + '/api/bpjssearchcontrolletter/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BpjsSearchControlLetterModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/bpjssearchcontrolletter/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' BPJS Search Control Letter entities')),
