...
import {SystemAdminUserModel} from '../../models/systemAdminUser/system_admin_user.model';
import {SystemAdminUserModelAudit} from '../../models/systemAdminUser/system_admin_user.model.state';
...
/**
 * System Admin User service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class SystemAdminUserService extends UserService<SystemAdminUserModel, SystemAdminUserModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the SystemAdminUserProperties classFragment here] off begin
			fragment SystemAdminUserProperties on SystemAdminUser {
				...SystemAdminUserUserProperties
			}
			# % protected region % [Modify the SystemAdminUserProperties classFragment here] end
			${super.fragments('SystemAdminUser').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<SystemAdminUserModel>> {
		...
		return  this.apollo.query<PassableStateConfig<SystemAdminUserModel>>(
			{
				query: gql`
					query Count {
						totalCount: countSystemAdminUsers
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<SystemAdminUserModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<SystemAdminUserModel>> {
		...
		return this.apollo.query<PassableStateConfig<SystemAdminUserModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						SystemAdminUserById: systemAdminUserById(id: $id) {
							...SystemAdminUserProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.SystemAdminUserById as SystemAdminUserModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<SystemAdminUserModel>> {
		...
		return this.apollo.query<PassableStateConfig<SystemAdminUserModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						systemAdminUsers: systemAdminUsers(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...SystemAdminUserProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countSystemAdminUsers(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.systemAdminUsers as SystemAdminUserModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<SystemAdminUserModel>> {
		...
		return this.apollo.query<PassableStateConfig<SystemAdminUserModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						systemAdminUsers: lastSystemAdminUsers(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...SystemAdminUserProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: SystemAdminUserModel, queryParams?: QueryParams): Observable<PassableStateConfig<SystemAdminUserModel>> {
		...
		const successMessage = 'Created System Admin User entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($systemAdminUser: SystemAdminUserInput!, $persistRelations: Boolean) {
						systemAdminUser: createSystemAdminUser(systemAdminUser: $systemAdminUser, persistRelations: $persistRelations) {
							...SystemAdminUserProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.systemAdminUser as SystemAdminUserModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: SystemAdminUserModel[], queryParams?: QueryParams): Observable<PassableStateConfig<SystemAdminUserModel>> {
		...
		const successMessage = 'Created Multiple System Admin User entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($systemAdminUsers: [SystemAdminUserInput!]!) {
						systemAdminUser: createAllSystemAdminUser(systemAdminUsers: $systemAdminUsers) {
							...SystemAdminUserProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					systemAdminUsers: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.systemAdminUser as SystemAdminUserModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: SystemAdminUserModel, queryParams?: QueryParams): Observable<PassableStateConfig<SystemAdminUserModel>> {
		...
		const successMessage = 'Updated System Admin User entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($systemAdminUser: SystemAdminUserInput!, $persistRelations: Boolean) {
						systemAdminUser: updateSystemAdminUser(systemAdminUser: $systemAdminUser, persistRelations: $persistRelations) {
							...SystemAdminUserProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: SystemAdminUserModel[], queryParams?: QueryParams): Observable<PassableStateConfig<SystemAdminUserModel>> {
		...
		const successMessage = 'Update Multiple System Admin User entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($systemAdminUsers: [SystemAdminUserInput!]!) {
						systemAdminUser: updateAllSystemAdminUser(systemAdminUsers: $systemAdminUsers) {
							...SystemAdminUserProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<SystemAdminUserModel>> {
		...
		const successMessage = 'Deleted System Admin User entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($systemAdminUserId: ID!) {
						systemAdminUserId: deleteSystemAdminUserById(systemAdminUserId: $systemAdminUserId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.systemAdminUserId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<SystemAdminUserModel>> {
		...
		const successMessage = 'Deleted selected System Admin User entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($systemAdminUserIds: [ID!]!){
						deleteSystemAdminUserExcludingIds(systemAdminUserIds: $systemAdminUserIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.systemAdminUserIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<SystemAdminUserModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($systemAdminUserIds: [ID!]!) {
						systemAdminUserIds: deleteAllSystemAdminUserByIds(systemAdminUserIds: $systemAdminUserIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<SystemAdminUserModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<SystemAdminUserModel>>(
			...
			map(result => {
				let audits: SystemAdminUserModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new SystemAdminUserModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<SystemAdminUserModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<SystemAdminUserModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($systemAdminUserId: ID!) {
						audits: systemAdminUserAuditsByEntityId(systemAdminUserId: $systemAdminUserId) {
							entity {
								...SystemAdminUserProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<SystemAdminUserModel>> {
		const url = environment.API_URL + '/api/systemadminuser/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<SystemAdminUserModel>> {
		const url = environment.API_URL + '/api/systemadminuser/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<SystemAdminUserModel>> {
		let apiUrl = environment.API_URL + '/api/systemadminuser/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<SystemAdminUserModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/systemadminuser/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' System Admin User entities')),
