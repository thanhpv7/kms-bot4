...
import {InvoiceItemModelAudit} from '../../models/invoiceItem/invoice_item.model.state';
...
/**
 * Invoice Item service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class InvoiceItemService extends AbstractHttpService<InvoiceItemModel, InvoiceItemModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the InvoiceItemProperties classFragment here] off begin
			fragment InvoiceItemProperties on InvoiceItem {
				...InvoiceItemBaseProperties
				transactionDate
				tariffCode
				tariffType
				name
			...
			# % protected region % [Modify the InvoiceItemProperties classFragment here] end
			${super.fragments('InvoiceItem').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<InvoiceItemModel>> {
		...
		return  this.apollo.query<PassableStateConfig<InvoiceItemModel>>(
			{
				query: gql`
					query Count {
						totalCount: countInvoiceItems
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<InvoiceItemModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<InvoiceItemModel>> {
		...
		return this.apollo.query<PassableStateConfig<InvoiceItemModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						InvoiceItemById: invoiceItemById(id: $id) {
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.InvoiceItemById as InvoiceItemModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<InvoiceItemModel>> {
		...
		return this.apollo.query<PassableStateConfig<InvoiceItemModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						invoiceItems: invoiceItems(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...InvoiceItemProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countInvoiceItems(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.invoiceItems as InvoiceItemModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<InvoiceItemModel>> {
		...
		return this.apollo.query<PassableStateConfig<InvoiceItemModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						invoiceItems: lastInvoiceItems(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...InvoiceItemProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: InvoiceItemModel, queryParams?: QueryParams): Observable<PassableStateConfig<InvoiceItemModel>> {
		...
		const successMessage = 'Created Invoice Item entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($invoiceItem: InvoiceItemInput!, $persistRelations: Boolean) {
						invoiceItem: createInvoiceItem(invoiceItem: $invoiceItem, persistRelations: $persistRelations) {
							...InvoiceItemProperties,
				...
				variables: {
					invoiceItem: {
						...
						serviceNumber: entity.serviceNumber ? new RegistrationModel(entity.serviceNumber).toJSON() : undefined,
						tariffSchema: entity.tariffSchema ? new TariffSchemaModel(entity.tariffSchema).toJSON() : undefined,
			...
			map(result => {
				...
				return {
					targetModel: result.data.invoiceItem as InvoiceItemModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: InvoiceItemModel[], queryParams?: QueryParams): Observable<PassableStateConfig<InvoiceItemModel>> {
		...
		const successMessage = 'Created Multiple Invoice Item entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($invoiceItems: [InvoiceItemInput!]!) {
						invoiceItem: createAllInvoiceItem(invoiceItems: $invoiceItems) {
							...InvoiceItemProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					invoiceItems: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.invoiceItem as InvoiceItemModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: InvoiceItemModel, queryParams?: QueryParams): Observable<PassableStateConfig<InvoiceItemModel>> {
		...
		const successMessage = 'Updated Invoice Item entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($invoiceItem: InvoiceItemInput!, $persistRelations: Boolean) {
						invoiceItem: updateInvoiceItem(invoiceItem: $invoiceItem, persistRelations: $persistRelations) {
							...InvoiceItemProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: InvoiceItemModel[], queryParams?: QueryParams): Observable<PassableStateConfig<InvoiceItemModel>> {
		...
		const successMessage = 'Update Multiple Invoice Item entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($invoiceItems: [InvoiceItemInput!]!) {
						invoiceItem: updateAllInvoiceItem(invoiceItems: $invoiceItems) {
							...InvoiceItemProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<InvoiceItemModel>> {
		...
		const successMessage = 'Deleted Invoice Item entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($invoiceItemId: ID!) {
						invoiceItemId: deleteInvoiceItemById(invoiceItemId: $invoiceItemId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.invoiceItemId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<InvoiceItemModel>> {
		...
		const successMessage = 'Deleted selected Invoice Item entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($invoiceItemIds: [ID!]!){
						deleteInvoiceItemExcludingIds(invoiceItemIds: $invoiceItemIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.invoiceItemIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<InvoiceItemModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($invoiceItemIds: [ID!]!) {
						invoiceItemIds: deleteAllInvoiceItemByIds(invoiceItemIds: $invoiceItemIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<InvoiceItemModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<InvoiceItemModel>>(
			...
			map(result => {
				let audits: InvoiceItemModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new InvoiceItemModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<InvoiceItemModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<InvoiceItemModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($invoiceItemId: ID!) {
						audits: invoiceItemAuditsByEntityId(invoiceItemId: $invoiceItemId) {
							entity {
								...InvoiceItemProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<InvoiceItemModel>> {
		const url = environment.API_URL + '/api/invoiceitem/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<InvoiceItemModel>> {
		const url = environment.API_URL + '/api/invoiceitem/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<InvoiceItemModel>> {
		let apiUrl = environment.API_URL + '/api/invoiceitem/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<InvoiceItemModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/invoiceitem/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Invoice Item entities')),
