...
import {BpjsPRBModel} from '../../models/bpjsPRB/bpjs_prb.model';
import {BpjsPRBModelAudit} from '../../models/bpjsPRB/bpjs_prb.model.state';
...
/**
 * BPJS PRB service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BpjsPRBService extends AbstractHttpService<BpjsPRBModel, BpjsPRBModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BpjsPRBProperties classFragment here] off begin
			fragment BpjsPRBProperties on BpjsPRB {
				...BpjsPRBBaseProperties
				srbNo
				sepNo
				bpjsCardNo
				address
			...
			# % protected region % [Modify the BpjsPRBProperties classFragment here] end
			${super.fragments('BpjsPRB').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BpjsPRBModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BpjsPRBModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBpjsPRBs
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BpjsPRBModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPRBModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPRBModel>>(
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BpjsPRBById as BpjsPRBModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsPRBModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPRBModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						bpjsPRBs: bpjsPRBs(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BpjsPRBProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBpjsPRBs(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.bpjsPRBs as BpjsPRBModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsPRBModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPRBModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						bpjsPRBs: lastBpjsPRBs(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BpjsPRBProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BpjsPRBModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPRBModel>> {
		...
		const successMessage = 'Created BPJS PRB entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($bpjsPRB: BpjsPRBInput!, $persistRelations: Boolean) {
						bpjsPRB: createBpjsPRB(bpjsPRB: $bpjsPRB, persistRelations: $persistRelations) {
							...BpjsPRBProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.bpjsPRB as BpjsPRBModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BpjsPRBModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPRBModel>> {
		...
		const successMessage = 'Created Multiple BPJS PRB entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($bpjsPRBs: [BpjsPRBInput!]!) {
						bpjsPRB: createAllBpjsPRB(bpjsPRBs: $bpjsPRBs) {
							...BpjsPRBProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					bpjsPRBs: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.bpjsPRB as BpjsPRBModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BpjsPRBModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPRBModel>> {
		...
		const successMessage = 'Updated BPJS PRB entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($bpjsPRB: BpjsPRBInput!, $persistRelations: Boolean) {
						bpjsPRB: updateBpjsPRB(bpjsPRB: $bpjsPRB, persistRelations: $persistRelations) {
							...BpjsPRBProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BpjsPRBModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPRBModel>> {
		...
		const successMessage = 'Update Multiple BPJS PRB entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($bpjsPRBs: [BpjsPRBInput!]!) {
						bpjsPRB: updateAllBpjsPRB(bpjsPRBs: $bpjsPRBs) {
							...BpjsPRBProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BpjsPRBModel>> {
		...
		const successMessage = 'Deleted BPJS PRB entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($bpjsPRBId: ID!) {
						bpjsPRBId: deleteBpjsPRBById(bpjsPRBId: $bpjsPRBId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.bpjsPRBId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsPRBModel>> {
		...
		const successMessage = 'Deleted selected BPJS PRB entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($bpjsPRBIds: [ID!]!){
						deleteBpjsPRBExcludingIds(bpjsPRBIds: $bpjsPRBIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.bpjsPRBIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BpjsPRBModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($bpjsPRBIds: [ID!]!) {
						bpjsPRBIds: deleteAllBpjsPRBByIds(bpjsPRBIds: $bpjsPRBIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BpjsPRBModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPRBModel>>(
			...
			map(result => {
				let audits: BpjsPRBModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BpjsPRBModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BpjsPRBModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPRBModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($bpjsPRBId: ID!) {
						audits: bpjsPRBAuditsByEntityId(bpjsPRBId: $bpjsPRBId) {
							entity {
								...BpjsPRBProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BpjsPRBModel>> {
		const url = environment.API_URL + '/api/bpjsprb/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BpjsPRBModel>> {
		const url = environment.API_URL + '/api/bpjsprb/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsPRBModel>> {
		let apiUrl = environment.API_URL + '/api/bpjsprb/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BpjsPRBModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/bpjsprb/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' BPJS PRB entities')),
