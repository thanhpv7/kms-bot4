...
import {NurseVitalSignMeasurementModelAudit} from '../../models/nurseVitalSignMeasurement/nurse_vital_sign_measurement.model.state';
...
/**
 * Nurse Vital Sign Measurement service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class NurseVitalSignMeasurementService extends AbstractHttpService<NurseVitalSignMeasurementModel, NurseVitalSignMeasurementModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the NurseVitalSignMeasurementProperties classFragment here] off begin
			fragment NurseVitalSignMeasurementProperties on NurseVitalSignMeasurement {
				...NurseVitalSignMeasurementBaseProperties
				diastole
				systole
				temperature
				temperatureScale
			...
			# % protected region % [Modify the NurseVitalSignMeasurementProperties classFragment here] end
			${super.fragments('NurseVitalSignMeasurement').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<NurseVitalSignMeasurementModel>> {
		...
		return  this.apollo.query<PassableStateConfig<NurseVitalSignMeasurementModel>>(
			{
				query: gql`
					query Count {
						totalCount: countNurseVitalSignMeasurements
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<NurseVitalSignMeasurementModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<NurseVitalSignMeasurementModel>> {
		...
		return this.apollo.query<PassableStateConfig<NurseVitalSignMeasurementModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						NurseVitalSignMeasurementById: nurseVitalSignMeasurementById(id: $id) {
							...NurseVitalSignMeasurementProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.NurseVitalSignMeasurementById as NurseVitalSignMeasurementModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<NurseVitalSignMeasurementModel>> {
		...
		return this.apollo.query<PassableStateConfig<NurseVitalSignMeasurementModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						nurseVitalSignMeasurements: nurseVitalSignMeasurements(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...NurseVitalSignMeasurementProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countNurseVitalSignMeasurements(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.nurseVitalSignMeasurements as NurseVitalSignMeasurementModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<NurseVitalSignMeasurementModel>> {
		...
		return this.apollo.query<PassableStateConfig<NurseVitalSignMeasurementModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						nurseVitalSignMeasurements: lastNurseVitalSignMeasurements(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...NurseVitalSignMeasurementProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: NurseVitalSignMeasurementModel, queryParams?: QueryParams): Observable<PassableStateConfig<NurseVitalSignMeasurementModel>> {
		...
		const successMessage = 'Created Nurse Vital Sign Measurement entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($nurseVitalSignMeasurement: NurseVitalSignMeasurementInput!, $persistRelations: Boolean) {
						nurseVitalSignMeasurement: createNurseVitalSignMeasurement(nurseVitalSignMeasurement: $nurseVitalSignMeasurement, persistRelations: $persistRelations) {
							...NurseVitalSignMeasurementProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.nurseVitalSignMeasurement as NurseVitalSignMeasurementModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: NurseVitalSignMeasurementModel[], queryParams?: QueryParams): Observable<PassableStateConfig<NurseVitalSignMeasurementModel>> {
		...
		const successMessage = 'Created Multiple Nurse Vital Sign Measurement entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($nurseVitalSignMeasurements: [NurseVitalSignMeasurementInput!]!) {
						nurseVitalSignMeasurement: createAllNurseVitalSignMeasurement(nurseVitalSignMeasurements: $nurseVitalSignMeasurements) {
							...NurseVitalSignMeasurementProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					nurseVitalSignMeasurements: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.nurseVitalSignMeasurement as NurseVitalSignMeasurementModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: NurseVitalSignMeasurementModel, queryParams?: QueryParams): Observable<PassableStateConfig<NurseVitalSignMeasurementModel>> {
		...
		const successMessage = 'Updated Nurse Vital Sign Measurement entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($nurseVitalSignMeasurement: NurseVitalSignMeasurementInput!, $persistRelations: Boolean) {
						nurseVitalSignMeasurement: updateNurseVitalSignMeasurement(nurseVitalSignMeasurement: $nurseVitalSignMeasurement, persistRelations: $persistRelations) {
							...NurseVitalSignMeasurementProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: NurseVitalSignMeasurementModel[], queryParams?: QueryParams): Observable<PassableStateConfig<NurseVitalSignMeasurementModel>> {
		...
		const successMessage = 'Update Multiple Nurse Vital Sign Measurement entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($nurseVitalSignMeasurements: [NurseVitalSignMeasurementInput!]!) {
						nurseVitalSignMeasurement: updateAllNurseVitalSignMeasurement(nurseVitalSignMeasurements: $nurseVitalSignMeasurements) {
							...NurseVitalSignMeasurementProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<NurseVitalSignMeasurementModel>> {
		...
		const successMessage = 'Deleted Nurse Vital Sign Measurement entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($nurseVitalSignMeasurementId: ID!) {
						nurseVitalSignMeasurementId: deleteNurseVitalSignMeasurementById(nurseVitalSignMeasurementId: $nurseVitalSignMeasurementId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.nurseVitalSignMeasurementId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<NurseVitalSignMeasurementModel>> {
		...
		const successMessage = 'Deleted selected Nurse Vital Sign Measurement entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($nurseVitalSignMeasurementIds: [ID!]!){
						deleteNurseVitalSignMeasurementExcludingIds(nurseVitalSignMeasurementIds: $nurseVitalSignMeasurementIds)
				...
				`,
				variables: {
					nurseVitalSignMeasurementIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.nurseVitalSignMeasurementIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<NurseVitalSignMeasurementModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($nurseVitalSignMeasurementIds: [ID!]!) {
						nurseVitalSignMeasurementIds: deleteAllNurseVitalSignMeasurementByIds(nurseVitalSignMeasurementIds: $nurseVitalSignMeasurementIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<NurseVitalSignMeasurementModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<NurseVitalSignMeasurementModel>>(
			{
				query: gql`
					query GetAudits {
						audits: nurseVitalSignMeasurementAudits {
							entity {
								...NurseVitalSignMeasurementProperties
							}
							timestamp
			...
			map(result => {
				let audits: NurseVitalSignMeasurementModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new NurseVitalSignMeasurementModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<NurseVitalSignMeasurementModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<NurseVitalSignMeasurementModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($nurseVitalSignMeasurementId: ID!) {
						audits: nurseVitalSignMeasurementAuditsByEntityId(nurseVitalSignMeasurementId: $nurseVitalSignMeasurementId) {
							entity {
								...NurseVitalSignMeasurementProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<NurseVitalSignMeasurementModel>> {
		const url = environment.API_URL + '/api/nursevitalsignmeasurement/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<NurseVitalSignMeasurementModel>> {
		const url = environment.API_URL + '/api/nursevitalsignmeasurement/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<NurseVitalSignMeasurementModel>> {
		let apiUrl = environment.API_URL + '/api/nursevitalsignmeasurement/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<NurseVitalSignMeasurementModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/nursevitalsignmeasurement/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Nurse Vital Sign Measurement entities')),
