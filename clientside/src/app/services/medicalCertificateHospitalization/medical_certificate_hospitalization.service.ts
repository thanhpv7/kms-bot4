...
import {MedicalCertificateHospitalizationModel} from '../../models/medicalCertificateHospitalization/medical_certificate_hospitalization.model';
import {MedicalCertificateHospitalizationModelAudit} from '../../models/medicalCertificateHospitalization/medical_certificate_hospitalization.model.state';
...
/**
 * Medical Certificate Hospitalization service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class MedicalCertificateHospitalizationService extends AbstractHttpService<MedicalCertificateHospitalizationModel, MedicalCertificateHospitalizationModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the MedicalCertificateHospitalizationProperties classFragment here] off begin
			fragment MedicalCertificateHospitalizationProperties on MedicalCertificateHospitalization {
				...MedicalCertificateHospitalizationBaseProperties
				admissionDateTime
				dischargeDateTime
				notes
			}
			# % protected region % [Modify the MedicalCertificateHospitalizationProperties classFragment here] end
			${super.fragments('MedicalCertificateHospitalization').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<MedicalCertificateHospitalizationModel>> {
		...
		return  this.apollo.query<PassableStateConfig<MedicalCertificateHospitalizationModel>>(
			{
				query: gql`
					query Count {
						totalCount: countMedicalCertificateHospitalizations
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<MedicalCertificateHospitalizationModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<MedicalCertificateHospitalizationModel>> {
		...
		return this.apollo.query<PassableStateConfig<MedicalCertificateHospitalizationModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						MedicalCertificateHospitalizationById: medicalCertificateHospitalizationById(id: $id) {
							...MedicalCertificateHospitalizationProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.MedicalCertificateHospitalizationById as MedicalCertificateHospitalizationModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<MedicalCertificateHospitalizationModel>> {
		...
		return this.apollo.query<PassableStateConfig<MedicalCertificateHospitalizationModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						medicalCertificateHospitalizations: medicalCertificateHospitalizations(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...MedicalCertificateHospitalizationProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countMedicalCertificateHospitalizations(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.medicalCertificateHospitalizations as MedicalCertificateHospitalizationModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<MedicalCertificateHospitalizationModel>> {
		...
		return this.apollo.query<PassableStateConfig<MedicalCertificateHospitalizationModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						medicalCertificateHospitalizations: lastMedicalCertificateHospitalizations(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...MedicalCertificateHospitalizationProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: MedicalCertificateHospitalizationModel, queryParams?: QueryParams): Observable<PassableStateConfig<MedicalCertificateHospitalizationModel>> {
		...
		const successMessage = 'Created Medical Certificate Hospitalization entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($medicalCertificateHospitalization: MedicalCertificateHospitalizationInput!, $persistRelations: Boolean) {
						medicalCertificateHospitalization: createMedicalCertificateHospitalization(medicalCertificateHospitalization: $medicalCertificateHospitalization, persistRelations: $persistRelations) {
							...MedicalCertificateHospitalizationProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.medicalCertificateHospitalization as MedicalCertificateHospitalizationModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: MedicalCertificateHospitalizationModel[], queryParams?: QueryParams): Observable<PassableStateConfig<MedicalCertificateHospitalizationModel>> {
		...
		const successMessage = 'Created Multiple Medical Certificate Hospitalization entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($medicalCertificateHospitalizations: [MedicalCertificateHospitalizationInput!]!) {
						medicalCertificateHospitalization: createAllMedicalCertificateHospitalization(medicalCertificateHospitalizations: $medicalCertificateHospitalizations) {
							...MedicalCertificateHospitalizationProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					medicalCertificateHospitalizations: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.medicalCertificateHospitalization as MedicalCertificateHospitalizationModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: MedicalCertificateHospitalizationModel, queryParams?: QueryParams): Observable<PassableStateConfig<MedicalCertificateHospitalizationModel>> {
		...
		const successMessage = 'Updated Medical Certificate Hospitalization entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($medicalCertificateHospitalization: MedicalCertificateHospitalizationInput!, $persistRelations: Boolean) {
						medicalCertificateHospitalization: updateMedicalCertificateHospitalization(medicalCertificateHospitalization: $medicalCertificateHospitalization, persistRelations: $persistRelations) {
							...MedicalCertificateHospitalizationProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: MedicalCertificateHospitalizationModel[], queryParams?: QueryParams): Observable<PassableStateConfig<MedicalCertificateHospitalizationModel>> {
		...
		const successMessage = 'Update Multiple Medical Certificate Hospitalization entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($medicalCertificateHospitalizations: [MedicalCertificateHospitalizationInput!]!) {
						medicalCertificateHospitalization: updateAllMedicalCertificateHospitalization(medicalCertificateHospitalizations: $medicalCertificateHospitalizations) {
							...MedicalCertificateHospitalizationProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<MedicalCertificateHospitalizationModel>> {
		...
		const successMessage = 'Deleted Medical Certificate Hospitalization entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($medicalCertificateHospitalizationId: ID!) {
						medicalCertificateHospitalizationId: deleteMedicalCertificateHospitalizationById(medicalCertificateHospitalizationId: $medicalCertificateHospitalizationId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.medicalCertificateHospitalizationId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<MedicalCertificateHospitalizationModel>> {
		...
		const successMessage = 'Deleted selected Medical Certificate Hospitalization entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($medicalCertificateHospitalizationIds: [ID!]!){
						deleteMedicalCertificateHospitalizationExcludingIds(medicalCertificateHospitalizationIds: $medicalCertificateHospitalizationIds)
				...
				`,
				variables: {
					medicalCertificateHospitalizationIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.medicalCertificateHospitalizationIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<MedicalCertificateHospitalizationModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($medicalCertificateHospitalizationIds: [ID!]!) {
						medicalCertificateHospitalizationIds: deleteAllMedicalCertificateHospitalizationByIds(medicalCertificateHospitalizationIds: $medicalCertificateHospitalizationIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<MedicalCertificateHospitalizationModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<MedicalCertificateHospitalizationModel>>(
			{
				query: gql`
					query GetAudits {
						audits: medicalCertificateHospitalizationAudits {
							entity {
								...MedicalCertificateHospitalizationProperties
							}
							timestamp
			...
			map(result => {
				let audits: MedicalCertificateHospitalizationModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new MedicalCertificateHospitalizationModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<MedicalCertificateHospitalizationModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<MedicalCertificateHospitalizationModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($medicalCertificateHospitalizationId: ID!) {
						audits: medicalCertificateHospitalizationAuditsByEntityId(medicalCertificateHospitalizationId: $medicalCertificateHospitalizationId) {
							entity {
								...MedicalCertificateHospitalizationProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<MedicalCertificateHospitalizationModel>> {
		const url = environment.API_URL + '/api/medicalcertificatehospitalization/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<MedicalCertificateHospitalizationModel>> {
		const url = environment.API_URL + '/api/medicalcertificatehospitalization/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<MedicalCertificateHospitalizationModel>> {
		let apiUrl = environment.API_URL + '/api/medicalcertificatehospitalization/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<MedicalCertificateHospitalizationModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/medicalcertificatehospitalization/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Medical Certificate Hospitalization entities')),
