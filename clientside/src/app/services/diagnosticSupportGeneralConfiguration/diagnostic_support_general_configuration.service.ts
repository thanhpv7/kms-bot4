...
import {DiagnosticSupportGeneralConfigurationModel} from '../../models/diagnosticSupportGeneralConfiguration/diagnostic_support_general_configuration.model';
import {DiagnosticSupportGeneralConfigurationModelAudit} from '../../models/diagnosticSupportGeneralConfiguration/diagnostic_support_general_configuration.model.state';
...
/**
 * Diagnostic Support General Configuration service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class DiagnosticSupportGeneralConfigurationService extends AbstractHttpService<DiagnosticSupportGeneralConfigurationModel, DiagnosticSupportGeneralConfigurationModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the DiagnosticSupportGeneralConfigurationProperties classFragment here] off begin
			fragment DiagnosticSupportGeneralConfigurationProperties on DiagnosticSupportGeneralConfiguration {
				...DiagnosticSupportGeneralConfigurationBaseProperties
				isActiveLIS
				isLISRegistration
				lisWebServiceURL
			}
			# % protected region % [Modify the DiagnosticSupportGeneralConfigurationProperties classFragment here] end
			${super.fragments('DiagnosticSupportGeneralConfiguration').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<DiagnosticSupportGeneralConfigurationModel>> {
		...
		return  this.apollo.query<PassableStateConfig<DiagnosticSupportGeneralConfigurationModel>>(
			{
				query: gql`
					query Count {
						totalCount: countDiagnosticSupportGeneralConfigurations
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<DiagnosticSupportGeneralConfigurationModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<DiagnosticSupportGeneralConfigurationModel>> {
		...
		return this.apollo.query<PassableStateConfig<DiagnosticSupportGeneralConfigurationModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						DiagnosticSupportGeneralConfigurationById: diagnosticSupportGeneralConfigurationById(id: $id) {
							...DiagnosticSupportGeneralConfigurationProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.DiagnosticSupportGeneralConfigurationById as DiagnosticSupportGeneralConfigurationModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<DiagnosticSupportGeneralConfigurationModel>> {
		...
		return this.apollo.query<PassableStateConfig<DiagnosticSupportGeneralConfigurationModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						diagnosticSupportGeneralConfigurations: diagnosticSupportGeneralConfigurations(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...DiagnosticSupportGeneralConfigurationProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countDiagnosticSupportGeneralConfigurations(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.diagnosticSupportGeneralConfigurations as DiagnosticSupportGeneralConfigurationModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<DiagnosticSupportGeneralConfigurationModel>> {
		...
		return this.apollo.query<PassableStateConfig<DiagnosticSupportGeneralConfigurationModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						diagnosticSupportGeneralConfigurations: lastDiagnosticSupportGeneralConfigurations(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...DiagnosticSupportGeneralConfigurationProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: DiagnosticSupportGeneralConfigurationModel, queryParams?: QueryParams): Observable<PassableStateConfig<DiagnosticSupportGeneralConfigurationModel>> {
		...
		const successMessage = 'Created Diagnostic Support General Configuration entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($diagnosticSupportGeneralConfiguration: DiagnosticSupportGeneralConfigurationInput!, $persistRelations: Boolean) {
						diagnosticSupportGeneralConfiguration: createDiagnosticSupportGeneralConfiguration(diagnosticSupportGeneralConfiguration: $diagnosticSupportGeneralConfiguration, persistRelations: $persistRelations) {
							...DiagnosticSupportGeneralConfigurationProperties,
				...
				`,
				variables: {
					diagnosticSupportGeneralConfiguration: {
						...entity.toJSON(),
					},
			...
			map(result => {
				...
				return {
					targetModel: result.data.diagnosticSupportGeneralConfiguration as DiagnosticSupportGeneralConfigurationModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: DiagnosticSupportGeneralConfigurationModel[], queryParams?: QueryParams): Observable<PassableStateConfig<DiagnosticSupportGeneralConfigurationModel>> {
		...
		const successMessage = 'Created Multiple Diagnostic Support General Configuration entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($diagnosticSupportGeneralConfigurations: [DiagnosticSupportGeneralConfigurationInput!]!) {
						diagnosticSupportGeneralConfiguration: createAllDiagnosticSupportGeneralConfiguration(diagnosticSupportGeneralConfigurations: $diagnosticSupportGeneralConfigurations) {
							...DiagnosticSupportGeneralConfigurationProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					diagnosticSupportGeneralConfigurations: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.diagnosticSupportGeneralConfiguration as DiagnosticSupportGeneralConfigurationModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: DiagnosticSupportGeneralConfigurationModel, queryParams?: QueryParams): Observable<PassableStateConfig<DiagnosticSupportGeneralConfigurationModel>> {
		...
		const successMessage = 'Updated Diagnostic Support General Configuration entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($diagnosticSupportGeneralConfiguration: DiagnosticSupportGeneralConfigurationInput!, $persistRelations: Boolean) {
						diagnosticSupportGeneralConfiguration: updateDiagnosticSupportGeneralConfiguration(diagnosticSupportGeneralConfiguration: $diagnosticSupportGeneralConfiguration, persistRelations: $persistRelations) {
							...DiagnosticSupportGeneralConfigurationProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: DiagnosticSupportGeneralConfigurationModel[], queryParams?: QueryParams): Observable<PassableStateConfig<DiagnosticSupportGeneralConfigurationModel>> {
		...
		const successMessage = 'Update Multiple Diagnostic Support General Configuration entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($diagnosticSupportGeneralConfigurations: [DiagnosticSupportGeneralConfigurationInput!]!) {
						diagnosticSupportGeneralConfiguration: updateAllDiagnosticSupportGeneralConfiguration(diagnosticSupportGeneralConfigurations: $diagnosticSupportGeneralConfigurations) {
							...DiagnosticSupportGeneralConfigurationProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<DiagnosticSupportGeneralConfigurationModel>> {
		...
		const successMessage = 'Deleted Diagnostic Support General Configuration entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($diagnosticSupportGeneralConfigurationId: ID!) {
						diagnosticSupportGeneralConfigurationId: deleteDiagnosticSupportGeneralConfigurationById(diagnosticSupportGeneralConfigurationId: $diagnosticSupportGeneralConfigurationId)
				...
				`,
				variables: {
					diagnosticSupportGeneralConfigurationId: id,
			...
			map(result => {
				...
				return {
					targetModelId: result.data.diagnosticSupportGeneralConfigurationId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<DiagnosticSupportGeneralConfigurationModel>> {
		...
		const successMessage = 'Deleted selected Diagnostic Support General Configuration entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($diagnosticSupportGeneralConfigurationIds: [ID!]!){
						deleteDiagnosticSupportGeneralConfigurationExcludingIds(diagnosticSupportGeneralConfigurationIds: $diagnosticSupportGeneralConfigurationIds)
				...
				`,
				variables: {
					diagnosticSupportGeneralConfigurationIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.diagnosticSupportGeneralConfigurationIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<DiagnosticSupportGeneralConfigurationModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($diagnosticSupportGeneralConfigurationIds: [ID!]!) {
						diagnosticSupportGeneralConfigurationIds: deleteAllDiagnosticSupportGeneralConfigurationByIds(diagnosticSupportGeneralConfigurationIds: $diagnosticSupportGeneralConfigurationIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<DiagnosticSupportGeneralConfigurationModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<DiagnosticSupportGeneralConfigurationModel>>(
			{
				query: gql`
					query GetAudits {
						audits: diagnosticSupportGeneralConfigurationAudits {
							entity {
								...DiagnosticSupportGeneralConfigurationProperties
							}
							timestamp
			...
			map(result => {
				let audits: DiagnosticSupportGeneralConfigurationModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new DiagnosticSupportGeneralConfigurationModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<DiagnosticSupportGeneralConfigurationModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<DiagnosticSupportGeneralConfigurationModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($diagnosticSupportGeneralConfigurationId: ID!) {
						audits: diagnosticSupportGeneralConfigurationAuditsByEntityId(diagnosticSupportGeneralConfigurationId: $diagnosticSupportGeneralConfigurationId) {
							entity {
								...DiagnosticSupportGeneralConfigurationProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<DiagnosticSupportGeneralConfigurationModel>> {
		const url = environment.API_URL + '/api/diagnosticsupportgeneralconfiguration/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<DiagnosticSupportGeneralConfigurationModel>> {
		const url = environment.API_URL + '/api/diagnosticsupportgeneralconfiguration/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<DiagnosticSupportGeneralConfigurationModel>> {
		let apiUrl = environment.API_URL + '/api/diagnosticsupportgeneralconfiguration/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<DiagnosticSupportGeneralConfigurationModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/diagnosticsupportgeneralconfiguration/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Diagnostic Support General Configuration entities')),
