...
import {BpjsPcareRiwayatKunjunganModelAudit} from '../../models/bpjsPcareRiwayatKunjungan/bpjs_pcare_riwayat_kunjungan.model.state';
...
/**
 * Bpjs Pcare Riwayat Kunjungan service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BpjsPcareRiwayatKunjunganService extends AbstractHttpService<BpjsPcareRiwayatKunjunganModel, BpjsPcareRiwayatKunjunganModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BpjsPcareRiwayatKunjunganProperties classFragment here] off begin
			fragment BpjsPcareRiwayatKunjunganProperties on BpjsPcareRiwayatKunjungan {
				...BpjsPcareRiwayatKunjunganBaseProperties
				nokunjungan
				tglkunjungan
				providerpelayanan
				nokartu
			...
			# % protected region % [Modify the BpjsPcareRiwayatKunjunganProperties classFragment here] end
			${super.fragments('BpjsPcareRiwayatKunjungan').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BpjsPcareRiwayatKunjunganModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BpjsPcareRiwayatKunjunganModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBpjsPcareRiwayatKunjungans
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BpjsPcareRiwayatKunjunganModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPcareRiwayatKunjunganModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPcareRiwayatKunjunganModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BpjsPcareRiwayatKunjunganById: bpjsPcareRiwayatKunjunganById(id: $id) {
							...BpjsPcareRiwayatKunjunganProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BpjsPcareRiwayatKunjunganById as BpjsPcareRiwayatKunjunganModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsPcareRiwayatKunjunganModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPcareRiwayatKunjunganModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						bpjsPcareRiwayatKunjungans: bpjsPcareRiwayatKunjungans(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BpjsPcareRiwayatKunjunganProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBpjsPcareRiwayatKunjungans(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.bpjsPcareRiwayatKunjungans as BpjsPcareRiwayatKunjunganModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsPcareRiwayatKunjunganModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPcareRiwayatKunjunganModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						bpjsPcareRiwayatKunjungans: lastBpjsPcareRiwayatKunjungans(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BpjsPcareRiwayatKunjunganProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BpjsPcareRiwayatKunjunganModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPcareRiwayatKunjunganModel>> {
		...
		const successMessage = 'Created Bpjs Pcare Riwayat Kunjungan entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($bpjsPcareRiwayatKunjungan: BpjsPcareRiwayatKunjunganInput!, $persistRelations: Boolean) {
						bpjsPcareRiwayatKunjungan: createBpjsPcareRiwayatKunjungan(bpjsPcareRiwayatKunjungan: $bpjsPcareRiwayatKunjungan, persistRelations: $persistRelations) {
							...BpjsPcareRiwayatKunjunganProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.bpjsPcareRiwayatKunjungan as BpjsPcareRiwayatKunjunganModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BpjsPcareRiwayatKunjunganModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPcareRiwayatKunjunganModel>> {
		...
		const successMessage = 'Created Multiple Bpjs Pcare Riwayat Kunjungan entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($bpjsPcareRiwayatKunjungans: [BpjsPcareRiwayatKunjunganInput!]!) {
						bpjsPcareRiwayatKunjungan: createAllBpjsPcareRiwayatKunjungan(bpjsPcareRiwayatKunjungans: $bpjsPcareRiwayatKunjungans) {
							...BpjsPcareRiwayatKunjunganProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					bpjsPcareRiwayatKunjungans: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.bpjsPcareRiwayatKunjungan as BpjsPcareRiwayatKunjunganModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BpjsPcareRiwayatKunjunganModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPcareRiwayatKunjunganModel>> {
		...
		const successMessage = 'Updated Bpjs Pcare Riwayat Kunjungan entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($bpjsPcareRiwayatKunjungan: BpjsPcareRiwayatKunjunganInput!, $persistRelations: Boolean) {
						bpjsPcareRiwayatKunjungan: updateBpjsPcareRiwayatKunjungan(bpjsPcareRiwayatKunjungan: $bpjsPcareRiwayatKunjungan, persistRelations: $persistRelations) {
							...BpjsPcareRiwayatKunjunganProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BpjsPcareRiwayatKunjunganModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsPcareRiwayatKunjunganModel>> {
		...
		const successMessage = 'Update Multiple Bpjs Pcare Riwayat Kunjungan entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($bpjsPcareRiwayatKunjungans: [BpjsPcareRiwayatKunjunganInput!]!) {
						bpjsPcareRiwayatKunjungan: updateAllBpjsPcareRiwayatKunjungan(bpjsPcareRiwayatKunjungans: $bpjsPcareRiwayatKunjungans) {
							...BpjsPcareRiwayatKunjunganProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BpjsPcareRiwayatKunjunganModel>> {
		...
		const successMessage = 'Deleted Bpjs Pcare Riwayat Kunjungan entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($bpjsPcareRiwayatKunjunganId: ID!) {
						bpjsPcareRiwayatKunjunganId: deleteBpjsPcareRiwayatKunjunganById(bpjsPcareRiwayatKunjunganId: $bpjsPcareRiwayatKunjunganId)
				...
				`,
				variables: {
					bpjsPcareRiwayatKunjunganId: id,
			...
			map(result => {
				...
				return {
					targetModelId: result.data.bpjsPcareRiwayatKunjunganId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsPcareRiwayatKunjunganModel>> {
		...
		const successMessage = 'Deleted selected Bpjs Pcare Riwayat Kunjungan entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($bpjsPcareRiwayatKunjunganIds: [ID!]!){
						deleteBpjsPcareRiwayatKunjunganExcludingIds(bpjsPcareRiwayatKunjunganIds: $bpjsPcareRiwayatKunjunganIds)
				...
				`,
				variables: {
					bpjsPcareRiwayatKunjunganIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.bpjsPcareRiwayatKunjunganIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BpjsPcareRiwayatKunjunganModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($bpjsPcareRiwayatKunjunganIds: [ID!]!) {
						bpjsPcareRiwayatKunjunganIds: deleteAllBpjsPcareRiwayatKunjunganByIds(bpjsPcareRiwayatKunjunganIds: $bpjsPcareRiwayatKunjunganIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BpjsPcareRiwayatKunjunganModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPcareRiwayatKunjunganModel>>(
			{
				query: gql`
					query GetAudits {
						audits: bpjsPcareRiwayatKunjunganAudits {
							entity {
								...BpjsPcareRiwayatKunjunganProperties
							}
							timestamp
			...
			map(result => {
				let audits: BpjsPcareRiwayatKunjunganModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BpjsPcareRiwayatKunjunganModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BpjsPcareRiwayatKunjunganModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsPcareRiwayatKunjunganModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($bpjsPcareRiwayatKunjunganId: ID!) {
						audits: bpjsPcareRiwayatKunjunganAuditsByEntityId(bpjsPcareRiwayatKunjunganId: $bpjsPcareRiwayatKunjunganId) {
							entity {
								...BpjsPcareRiwayatKunjunganProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BpjsPcareRiwayatKunjunganModel>> {
		const url = environment.API_URL + '/api/bpjspcareriwayatkunjungan/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BpjsPcareRiwayatKunjunganModel>> {
		const url = environment.API_URL + '/api/bpjspcareriwayatkunjungan/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsPcareRiwayatKunjunganModel>> {
		let apiUrl = environment.API_URL + '/api/bpjspcareriwayatkunjungan/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BpjsPcareRiwayatKunjunganModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/bpjspcareriwayatkunjungan/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Bpjs Pcare Riwayat Kunjungan entities')),
