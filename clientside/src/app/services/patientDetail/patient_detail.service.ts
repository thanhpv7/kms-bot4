...
import {PatientDetailModel} from '../../models/patientDetail/patient_detail.model';
import {PatientDetailModelAudit} from '../../models/patientDetail/patient_detail.model.state';
...
/**
 * Patient Detail service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class PatientDetailService extends AbstractHttpService<PatientDetailModel, PatientDetailModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the PatientDetailProperties classFragment here] off begin
			fragment PatientDetailProperties on PatientDetail {
				...PatientDetailBaseProperties
				activePatientID
			...
			# % protected region % [Modify the PatientDetailProperties classFragment here] end
			${super.fragments('PatientDetail').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<PatientDetailModel>> {
		...
		return  this.apollo.query<PassableStateConfig<PatientDetailModel>>(
			{
				query: gql`
					query Count {
						totalCount: countPatientDetails
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<PatientDetailModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<PatientDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<PatientDetailModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						PatientDetailById: patientDetailById(id: $id) {
							...PatientDetailProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.PatientDetailById as PatientDetailModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PatientDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<PatientDetailModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						patientDetails: patientDetails(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...PatientDetailProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countPatientDetails(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.patientDetails as PatientDetailModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PatientDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<PatientDetailModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						patientDetails: lastPatientDetails(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...PatientDetailProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: PatientDetailModel, queryParams?: QueryParams): Observable<PassableStateConfig<PatientDetailModel>> {
		...
		const successMessage = 'Created Patient Detail entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($patientDetail: PatientDetailInput!, $persistRelations: Boolean) {
						patientDetail: createPatientDetail(patientDetail: $patientDetail, persistRelations: $persistRelations) {
							...PatientDetailProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.patientDetail as PatientDetailModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: PatientDetailModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PatientDetailModel>> {
		...
		const successMessage = 'Created Multiple Patient Detail entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($patientDetails: [PatientDetailInput!]!) {
						patientDetail: createAllPatientDetail(patientDetails: $patientDetails) {
							...PatientDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					patientDetails: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.patientDetail as PatientDetailModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: PatientDetailModel, queryParams?: QueryParams): Observable<PassableStateConfig<PatientDetailModel>> {
		...
		const successMessage = 'Updated Patient Detail entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($patientDetail: PatientDetailInput!, $persistRelations: Boolean) {
						patientDetail: updatePatientDetail(patientDetail: $patientDetail, persistRelations: $persistRelations) {
							...PatientDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: PatientDetailModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PatientDetailModel>> {
		...
		const successMessage = 'Update Multiple Patient Detail entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($patientDetails: [PatientDetailInput!]!) {
						patientDetail: updateAllPatientDetail(patientDetails: $patientDetails) {
							...PatientDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<PatientDetailModel>> {
		...
		const successMessage = 'Deleted Patient Detail entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($patientDetailId: ID!) {
						patientDetailId: deletePatientDetailById(patientDetailId: $patientDetailId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.patientDetailId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<PatientDetailModel>> {
		...
		const successMessage = 'Deleted selected Patient Detail entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($patientDetailIds: [ID!]!){
						deletePatientDetailExcludingIds(patientDetailIds: $patientDetailIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.patientDetailIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<PatientDetailModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($patientDetailIds: [ID!]!) {
						patientDetailIds: deleteAllPatientDetailByIds(patientDetailIds: $patientDetailIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<PatientDetailModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PatientDetailModel>>(
			...
			map(result => {
				let audits: PatientDetailModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new PatientDetailModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<PatientDetailModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PatientDetailModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($patientDetailId: ID!) {
						audits: patientDetailAuditsByEntityId(patientDetailId: $patientDetailId) {
							entity {
								...PatientDetailProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<PatientDetailModel>> {
		const url = environment.API_URL + '/api/patientdetail/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<PatientDetailModel>> {
		const url = environment.API_URL + '/api/patientdetail/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<PatientDetailModel>> {
		let apiUrl = environment.API_URL + '/api/patientdetail/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<PatientDetailModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/patientdetail/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Patient Detail entities')),
