...
import {ExaminationItemDetailModel} from '../../models/examinationItemDetail/examination_item_detail.model';
import {ExaminationItemDetailModelAudit} from '../../models/examinationItemDetail/examination_item_detail.model.state';
...
/**
 * Examination Item Detail service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class ExaminationItemDetailService extends AbstractHttpService<ExaminationItemDetailModel, ExaminationItemDetailModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the ExaminationItemDetailProperties classFragment here] off begin
			fragment ExaminationItemDetailProperties on ExaminationItemDetail {
				...ExaminationItemDetailBaseProperties
				ageMinimum
				ageMaximum
				gender
				normalRangeLow
			...
			# % protected region % [Modify the ExaminationItemDetailProperties classFragment here] end
			${super.fragments('ExaminationItemDetail').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<ExaminationItemDetailModel>> {
		...
		return  this.apollo.query<PassableStateConfig<ExaminationItemDetailModel>>(
			{
				query: gql`
					query Count {
						totalCount: countExaminationItemDetails
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<ExaminationItemDetailModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<ExaminationItemDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<ExaminationItemDetailModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						ExaminationItemDetailById: examinationItemDetailById(id: $id) {
							...ExaminationItemDetailProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.ExaminationItemDetailById as ExaminationItemDetailModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<ExaminationItemDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<ExaminationItemDetailModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						examinationItemDetails: examinationItemDetails(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...ExaminationItemDetailProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countExaminationItemDetails(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.examinationItemDetails as ExaminationItemDetailModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<ExaminationItemDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<ExaminationItemDetailModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						examinationItemDetails: lastExaminationItemDetails(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...ExaminationItemDetailProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: ExaminationItemDetailModel, queryParams?: QueryParams): Observable<PassableStateConfig<ExaminationItemDetailModel>> {
		...
		const successMessage = 'Created Examination Item Detail entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($examinationItemDetail: ExaminationItemDetailInput!, $persistRelations: Boolean) {
						examinationItemDetail: createExaminationItemDetail(examinationItemDetail: $examinationItemDetail, persistRelations: $persistRelations) {
							...ExaminationItemDetailProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.examinationItemDetail as ExaminationItemDetailModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: ExaminationItemDetailModel[], queryParams?: QueryParams): Observable<PassableStateConfig<ExaminationItemDetailModel>> {
		...
		const successMessage = 'Created Multiple Examination Item Detail entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($examinationItemDetails: [ExaminationItemDetailInput!]!) {
						examinationItemDetail: createAllExaminationItemDetail(examinationItemDetails: $examinationItemDetails) {
							...ExaminationItemDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					examinationItemDetails: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.examinationItemDetail as ExaminationItemDetailModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: ExaminationItemDetailModel, queryParams?: QueryParams): Observable<PassableStateConfig<ExaminationItemDetailModel>> {
		...
		const successMessage = 'Updated Examination Item Detail entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($examinationItemDetail: ExaminationItemDetailInput!, $persistRelations: Boolean) {
						examinationItemDetail: updateExaminationItemDetail(examinationItemDetail: $examinationItemDetail, persistRelations: $persistRelations) {
							...ExaminationItemDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: ExaminationItemDetailModel[], queryParams?: QueryParams): Observable<PassableStateConfig<ExaminationItemDetailModel>> {
		...
		const successMessage = 'Update Multiple Examination Item Detail entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($examinationItemDetails: [ExaminationItemDetailInput!]!) {
						examinationItemDetail: updateAllExaminationItemDetail(examinationItemDetails: $examinationItemDetails) {
							...ExaminationItemDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<ExaminationItemDetailModel>> {
		...
		const successMessage = 'Deleted Examination Item Detail entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($examinationItemDetailId: ID!) {
						examinationItemDetailId: deleteExaminationItemDetailById(examinationItemDetailId: $examinationItemDetailId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.examinationItemDetailId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<ExaminationItemDetailModel>> {
		...
		const successMessage = 'Deleted selected Examination Item Detail entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($examinationItemDetailIds: [ID!]!){
						deleteExaminationItemDetailExcludingIds(examinationItemDetailIds: $examinationItemDetailIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.examinationItemDetailIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<ExaminationItemDetailModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($examinationItemDetailIds: [ID!]!) {
						examinationItemDetailIds: deleteAllExaminationItemDetailByIds(examinationItemDetailIds: $examinationItemDetailIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<ExaminationItemDetailModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<ExaminationItemDetailModel>>(
			{
				query: gql`
					query GetAudits {
						audits: examinationItemDetailAudits {
							entity {
								...ExaminationItemDetailProperties
							}
							timestamp
			...
			map(result => {
				let audits: ExaminationItemDetailModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new ExaminationItemDetailModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<ExaminationItemDetailModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<ExaminationItemDetailModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($examinationItemDetailId: ID!) {
						audits: examinationItemDetailAuditsByEntityId(examinationItemDetailId: $examinationItemDetailId) {
							entity {
								...ExaminationItemDetailProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<ExaminationItemDetailModel>> {
		const url = environment.API_URL + '/api/examinationitemdetail/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<ExaminationItemDetailModel>> {
		const url = environment.API_URL + '/api/examinationitemdetail/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<ExaminationItemDetailModel>> {
		let apiUrl = environment.API_URL + '/api/examinationitemdetail/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<ExaminationItemDetailModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/examinationitemdetail/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Examination Item Detail entities')),
