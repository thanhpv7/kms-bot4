...
import {NhisSpecialtyAttendedModel} from '../../models/nhisSpecialtyAttended/nhis_specialty_attended.model';
import {NhisSpecialtyAttendedModelAudit} from '../../models/nhisSpecialtyAttended/nhis_specialty_attended.model.state';
...
/**
 * NHIS Specialty Attended service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class NhisSpecialtyAttendedService extends AbstractHttpService<NhisSpecialtyAttendedModel, NhisSpecialtyAttendedModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the NhisSpecialtyAttendedProperties classFragment here] off begin
			fragment NhisSpecialtyAttendedProperties on NhisSpecialtyAttended {
				...NhisSpecialtyAttendedBaseProperties
				code
				description
				services
			}
			# % protected region % [Modify the NhisSpecialtyAttendedProperties classFragment here] end
			${super.fragments('NhisSpecialtyAttended').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<NhisSpecialtyAttendedModel>> {
		...
		return  this.apollo.query<PassableStateConfig<NhisSpecialtyAttendedModel>>(
			{
				query: gql`
					query Count {
						totalCount: countNhisSpecialtyAttendeds
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<NhisSpecialtyAttendedModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<NhisSpecialtyAttendedModel>> {
		...
		return this.apollo.query<PassableStateConfig<NhisSpecialtyAttendedModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						NhisSpecialtyAttendedById: nhisSpecialtyAttendedById(id: $id) {
							...NhisSpecialtyAttendedProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.NhisSpecialtyAttendedById as NhisSpecialtyAttendedModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<NhisSpecialtyAttendedModel>> {
		...
		return this.apollo.query<PassableStateConfig<NhisSpecialtyAttendedModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						nhisSpecialtyAttendeds: nhisSpecialtyAttendeds(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...NhisSpecialtyAttendedProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countNhisSpecialtyAttendeds(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.nhisSpecialtyAttendeds as NhisSpecialtyAttendedModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<NhisSpecialtyAttendedModel>> {
		...
		return this.apollo.query<PassableStateConfig<NhisSpecialtyAttendedModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						nhisSpecialtyAttendeds: lastNhisSpecialtyAttendeds(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...NhisSpecialtyAttendedProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: NhisSpecialtyAttendedModel, queryParams?: QueryParams): Observable<PassableStateConfig<NhisSpecialtyAttendedModel>> {
		...
		const successMessage = 'Created NHIS Specialty Attended entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($nhisSpecialtyAttended: NhisSpecialtyAttendedInput!, $persistRelations: Boolean) {
						nhisSpecialtyAttended: createNhisSpecialtyAttended(nhisSpecialtyAttended: $nhisSpecialtyAttended, persistRelations: $persistRelations) {
							...NhisSpecialtyAttendedProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.nhisSpecialtyAttended as NhisSpecialtyAttendedModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: NhisSpecialtyAttendedModel[], queryParams?: QueryParams): Observable<PassableStateConfig<NhisSpecialtyAttendedModel>> {
		...
		const successMessage = 'Created Multiple NHIS Specialty Attended entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($nhisSpecialtyAttendeds: [NhisSpecialtyAttendedInput!]!) {
						nhisSpecialtyAttended: createAllNhisSpecialtyAttended(nhisSpecialtyAttendeds: $nhisSpecialtyAttendeds) {
							...NhisSpecialtyAttendedProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					nhisSpecialtyAttendeds: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.nhisSpecialtyAttended as NhisSpecialtyAttendedModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: NhisSpecialtyAttendedModel, queryParams?: QueryParams): Observable<PassableStateConfig<NhisSpecialtyAttendedModel>> {
		...
		const successMessage = 'Updated NHIS Specialty Attended entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($nhisSpecialtyAttended: NhisSpecialtyAttendedInput!, $persistRelations: Boolean) {
						nhisSpecialtyAttended: updateNhisSpecialtyAttended(nhisSpecialtyAttended: $nhisSpecialtyAttended, persistRelations: $persistRelations) {
							...NhisSpecialtyAttendedProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: NhisSpecialtyAttendedModel[], queryParams?: QueryParams): Observable<PassableStateConfig<NhisSpecialtyAttendedModel>> {
		...
		const successMessage = 'Update Multiple NHIS Specialty Attended entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($nhisSpecialtyAttendeds: [NhisSpecialtyAttendedInput!]!) {
						nhisSpecialtyAttended: updateAllNhisSpecialtyAttended(nhisSpecialtyAttendeds: $nhisSpecialtyAttendeds) {
							...NhisSpecialtyAttendedProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<NhisSpecialtyAttendedModel>> {
		...
		const successMessage = 'Deleted NHIS Specialty Attended entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($nhisSpecialtyAttendedId: ID!) {
						nhisSpecialtyAttendedId: deleteNhisSpecialtyAttendedById(nhisSpecialtyAttendedId: $nhisSpecialtyAttendedId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.nhisSpecialtyAttendedId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<NhisSpecialtyAttendedModel>> {
		...
		const successMessage = 'Deleted selected NHIS Specialty Attended entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($nhisSpecialtyAttendedIds: [ID!]!){
						deleteNhisSpecialtyAttendedExcludingIds(nhisSpecialtyAttendedIds: $nhisSpecialtyAttendedIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.nhisSpecialtyAttendedIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<NhisSpecialtyAttendedModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($nhisSpecialtyAttendedIds: [ID!]!) {
						nhisSpecialtyAttendedIds: deleteAllNhisSpecialtyAttendedByIds(nhisSpecialtyAttendedIds: $nhisSpecialtyAttendedIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<NhisSpecialtyAttendedModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<NhisSpecialtyAttendedModel>>(
			{
				query: gql`
					query GetAudits {
						audits: nhisSpecialtyAttendedAudits {
							entity {
								...NhisSpecialtyAttendedProperties
							}
							timestamp
			...
			map(result => {
				let audits: NhisSpecialtyAttendedModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new NhisSpecialtyAttendedModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<NhisSpecialtyAttendedModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<NhisSpecialtyAttendedModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($nhisSpecialtyAttendedId: ID!) {
						audits: nhisSpecialtyAttendedAuditsByEntityId(nhisSpecialtyAttendedId: $nhisSpecialtyAttendedId) {
							entity {
								...NhisSpecialtyAttendedProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<NhisSpecialtyAttendedModel>> {
		const url = environment.API_URL + '/api/nhisspecialtyattended/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<NhisSpecialtyAttendedModel>> {
		const url = environment.API_URL + '/api/nhisspecialtyattended/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<NhisSpecialtyAttendedModel>> {
		let apiUrl = environment.API_URL + '/api/nhisspecialtyattended/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<NhisSpecialtyAttendedModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/nhisspecialtyattended/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' NHIS Specialty Attended entities')),
