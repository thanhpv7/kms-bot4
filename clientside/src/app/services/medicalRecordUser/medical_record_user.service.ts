...
import {MedicalRecordUserModel} from '../../models/medicalRecordUser/medical_record_user.model';
import {MedicalRecordUserModelAudit} from '../../models/medicalRecordUser/medical_record_user.model.state';
...
/**
 * Medical Record user service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class MedicalRecordUserService extends UserService<MedicalRecordUserModel, MedicalRecordUserModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the MedicalRecordUserProperties classFragment here] off begin
			fragment MedicalRecordUserProperties on MedicalRecordUser {
				...MedicalRecordUserUserProperties
			}
			# % protected region % [Modify the MedicalRecordUserProperties classFragment here] end
			${super.fragments('MedicalRecordUser').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<MedicalRecordUserModel>> {
		...
		return  this.apollo.query<PassableStateConfig<MedicalRecordUserModel>>(
			{
				query: gql`
					query Count {
						totalCount: countMedicalRecordUsers
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<MedicalRecordUserModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<MedicalRecordUserModel>> {
		...
		return this.apollo.query<PassableStateConfig<MedicalRecordUserModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						MedicalRecordUserById: medicalRecordUserById(id: $id) {
							...MedicalRecordUserProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.MedicalRecordUserById as MedicalRecordUserModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<MedicalRecordUserModel>> {
		...
		return this.apollo.query<PassableStateConfig<MedicalRecordUserModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						medicalRecordUsers: medicalRecordUsers(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...MedicalRecordUserProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countMedicalRecordUsers(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.medicalRecordUsers as MedicalRecordUserModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<MedicalRecordUserModel>> {
		...
		return this.apollo.query<PassableStateConfig<MedicalRecordUserModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						medicalRecordUsers: lastMedicalRecordUsers(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...MedicalRecordUserProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: MedicalRecordUserModel, queryParams?: QueryParams): Observable<PassableStateConfig<MedicalRecordUserModel>> {
		...
		const successMessage = 'Created Medical Record user entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($medicalRecordUser: MedicalRecordUserInput!, $persistRelations: Boolean) {
						medicalRecordUser: createMedicalRecordUser(medicalRecordUser: $medicalRecordUser, persistRelations: $persistRelations) {
							...MedicalRecordUserProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.medicalRecordUser as MedicalRecordUserModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: MedicalRecordUserModel[], queryParams?: QueryParams): Observable<PassableStateConfig<MedicalRecordUserModel>> {
		...
		const successMessage = 'Created Multiple Medical Record user entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($medicalRecordUsers: [MedicalRecordUserInput!]!) {
						medicalRecordUser: createAllMedicalRecordUser(medicalRecordUsers: $medicalRecordUsers) {
							...MedicalRecordUserProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					medicalRecordUsers: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.medicalRecordUser as MedicalRecordUserModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: MedicalRecordUserModel, queryParams?: QueryParams): Observable<PassableStateConfig<MedicalRecordUserModel>> {
		...
		const successMessage = 'Updated Medical Record user entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($medicalRecordUser: MedicalRecordUserInput!, $persistRelations: Boolean) {
						medicalRecordUser: updateMedicalRecordUser(medicalRecordUser: $medicalRecordUser, persistRelations: $persistRelations) {
							...MedicalRecordUserProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: MedicalRecordUserModel[], queryParams?: QueryParams): Observable<PassableStateConfig<MedicalRecordUserModel>> {
		...
		const successMessage = 'Update Multiple Medical Record user entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($medicalRecordUsers: [MedicalRecordUserInput!]!) {
						medicalRecordUser: updateAllMedicalRecordUser(medicalRecordUsers: $medicalRecordUsers) {
							...MedicalRecordUserProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<MedicalRecordUserModel>> {
		...
		const successMessage = 'Deleted Medical Record user entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($medicalRecordUserId: ID!) {
						medicalRecordUserId: deleteMedicalRecordUserById(medicalRecordUserId: $medicalRecordUserId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.medicalRecordUserId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<MedicalRecordUserModel>> {
		...
		const successMessage = 'Deleted selected Medical Record user entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($medicalRecordUserIds: [ID!]!){
						deleteMedicalRecordUserExcludingIds(medicalRecordUserIds: $medicalRecordUserIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.medicalRecordUserIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<MedicalRecordUserModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($medicalRecordUserIds: [ID!]!) {
						medicalRecordUserIds: deleteAllMedicalRecordUserByIds(medicalRecordUserIds: $medicalRecordUserIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<MedicalRecordUserModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<MedicalRecordUserModel>>(
			{
				query: gql`
					query GetAudits {
						audits: medicalRecordUserAudits {
							entity {
								...MedicalRecordUserProperties
							}
							timestamp
			...
			map(result => {
				let audits: MedicalRecordUserModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new MedicalRecordUserModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<MedicalRecordUserModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<MedicalRecordUserModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($medicalRecordUserId: ID!) {
						audits: medicalRecordUserAuditsByEntityId(medicalRecordUserId: $medicalRecordUserId) {
							entity {
								...MedicalRecordUserProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<MedicalRecordUserModel>> {
		const url = environment.API_URL + '/api/medicalrecorduser/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<MedicalRecordUserModel>> {
		const url = environment.API_URL + '/api/medicalrecorduser/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<MedicalRecordUserModel>> {
		let apiUrl = environment.API_URL + '/api/medicalrecorduser/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<MedicalRecordUserModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/medicalrecorduser/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Medical Record user entities')),
