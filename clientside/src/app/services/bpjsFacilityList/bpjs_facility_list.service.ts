...
import {BpjsFacilityListModel} from '../../models/bpjsFacilityList/bpjs_facility_list.model';
import {BpjsFacilityListModelAudit} from '../../models/bpjsFacilityList/bpjs_facility_list.model.state';
...
/**
 * BPJS Facility List service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BpjsFacilityListService extends AbstractHttpService<BpjsFacilityListModel, BpjsFacilityListModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BpjsFacilityListProperties classFragment here] off begin
			fragment BpjsFacilityListProperties on BpjsFacilityList {
				...BpjsFacilityListBaseProperties
				facilityCode
				facilityName
			}
			# % protected region % [Modify the BpjsFacilityListProperties classFragment here] end
			${super.fragments('BpjsFacilityList').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BpjsFacilityListModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BpjsFacilityListModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBpjsFacilityLists
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BpjsFacilityListModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsFacilityListModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsFacilityListModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BpjsFacilityListById: bpjsFacilityListById(id: $id) {
							...BpjsFacilityListProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BpjsFacilityListById as BpjsFacilityListModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsFacilityListModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsFacilityListModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						bpjsFacilityLists: bpjsFacilityLists(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BpjsFacilityListProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBpjsFacilityLists(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.bpjsFacilityLists as BpjsFacilityListModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsFacilityListModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsFacilityListModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						bpjsFacilityLists: lastBpjsFacilityLists(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BpjsFacilityListProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BpjsFacilityListModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsFacilityListModel>> {
		...
		const successMessage = 'Created BPJS Facility List entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($bpjsFacilityList: BpjsFacilityListInput!, $persistRelations: Boolean) {
						bpjsFacilityList: createBpjsFacilityList(bpjsFacilityList: $bpjsFacilityList, persistRelations: $persistRelations) {
							...BpjsFacilityListProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.bpjsFacilityList as BpjsFacilityListModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BpjsFacilityListModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsFacilityListModel>> {
		...
		const successMessage = 'Created Multiple BPJS Facility List entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($bpjsFacilityLists: [BpjsFacilityListInput!]!) {
						bpjsFacilityList: createAllBpjsFacilityList(bpjsFacilityLists: $bpjsFacilityLists) {
							...BpjsFacilityListProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					bpjsFacilityLists: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.bpjsFacilityList as BpjsFacilityListModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BpjsFacilityListModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsFacilityListModel>> {
		...
		const successMessage = 'Updated BPJS Facility List entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($bpjsFacilityList: BpjsFacilityListInput!, $persistRelations: Boolean) {
						bpjsFacilityList: updateBpjsFacilityList(bpjsFacilityList: $bpjsFacilityList, persistRelations: $persistRelations) {
							...BpjsFacilityListProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BpjsFacilityListModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsFacilityListModel>> {
		...
		const successMessage = 'Update Multiple BPJS Facility List entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($bpjsFacilityLists: [BpjsFacilityListInput!]!) {
						bpjsFacilityList: updateAllBpjsFacilityList(bpjsFacilityLists: $bpjsFacilityLists) {
							...BpjsFacilityListProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BpjsFacilityListModel>> {
		...
		const successMessage = 'Deleted BPJS Facility List entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($bpjsFacilityListId: ID!) {
						bpjsFacilityListId: deleteBpjsFacilityListById(bpjsFacilityListId: $bpjsFacilityListId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.bpjsFacilityListId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsFacilityListModel>> {
		...
		const successMessage = 'Deleted selected BPJS Facility List entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($bpjsFacilityListIds: [ID!]!){
						deleteBpjsFacilityListExcludingIds(bpjsFacilityListIds: $bpjsFacilityListIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.bpjsFacilityListIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BpjsFacilityListModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($bpjsFacilityListIds: [ID!]!) {
						bpjsFacilityListIds: deleteAllBpjsFacilityListByIds(bpjsFacilityListIds: $bpjsFacilityListIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BpjsFacilityListModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsFacilityListModel>>(
			...
			map(result => {
				let audits: BpjsFacilityListModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BpjsFacilityListModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BpjsFacilityListModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsFacilityListModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($bpjsFacilityListId: ID!) {
						audits: bpjsFacilityListAuditsByEntityId(bpjsFacilityListId: $bpjsFacilityListId) {
							entity {
								...BpjsFacilityListProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BpjsFacilityListModel>> {
		const url = environment.API_URL + '/api/bpjsfacilitylist/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BpjsFacilityListModel>> {
		const url = environment.API_URL + '/api/bpjsfacilitylist/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsFacilityListModel>> {
		let apiUrl = environment.API_URL + '/api/bpjsfacilitylist/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BpjsFacilityListModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/bpjsfacilitylist/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' BPJS Facility List entities')),
