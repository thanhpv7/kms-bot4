...
import {MedicalCertificateMedicalAttendanceModelAudit} from '../../models/medicalCertificateMedicalAttendance/medical_certificate_medical_attendance.model.state';
...
/**
 * Medical Certificate Medical Attendance service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class MedicalCertificateMedicalAttendanceService extends AbstractHttpService<MedicalCertificateMedicalAttendanceModel, MedicalCertificateMedicalAttendanceModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the MedicalCertificateMedicalAttendanceProperties classFragment here] off begin
			fragment MedicalCertificateMedicalAttendanceProperties on MedicalCertificateMedicalAttendance {
				...MedicalCertificateMedicalAttendanceBaseProperties
				date
				startTime
				endTime
				notes
			}
			# % protected region % [Modify the MedicalCertificateMedicalAttendanceProperties classFragment here] end
			${super.fragments('MedicalCertificateMedicalAttendance').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<MedicalCertificateMedicalAttendanceModel>> {
		...
		return  this.apollo.query<PassableStateConfig<MedicalCertificateMedicalAttendanceModel>>(
			{
				query: gql`
					query Count {
						totalCount: countMedicalCertificateMedicalAttendances
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<MedicalCertificateMedicalAttendanceModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<MedicalCertificateMedicalAttendanceModel>> {
		...
		return this.apollo.query<PassableStateConfig<MedicalCertificateMedicalAttendanceModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						MedicalCertificateMedicalAttendanceById: medicalCertificateMedicalAttendanceById(id: $id) {
							...MedicalCertificateMedicalAttendanceProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.MedicalCertificateMedicalAttendanceById as MedicalCertificateMedicalAttendanceModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<MedicalCertificateMedicalAttendanceModel>> {
		...
		return this.apollo.query<PassableStateConfig<MedicalCertificateMedicalAttendanceModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						medicalCertificateMedicalAttendances: medicalCertificateMedicalAttendances(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...MedicalCertificateMedicalAttendanceProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countMedicalCertificateMedicalAttendances(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.medicalCertificateMedicalAttendances as MedicalCertificateMedicalAttendanceModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<MedicalCertificateMedicalAttendanceModel>> {
		...
		return this.apollo.query<PassableStateConfig<MedicalCertificateMedicalAttendanceModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						medicalCertificateMedicalAttendances: lastMedicalCertificateMedicalAttendances(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...MedicalCertificateMedicalAttendanceProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: MedicalCertificateMedicalAttendanceModel, queryParams?: QueryParams): Observable<PassableStateConfig<MedicalCertificateMedicalAttendanceModel>> {
		...
		const successMessage = 'Created Medical Certificate Medical Attendance entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($medicalCertificateMedicalAttendance: MedicalCertificateMedicalAttendanceInput!, $persistRelations: Boolean) {
						medicalCertificateMedicalAttendance: createMedicalCertificateMedicalAttendance(medicalCertificateMedicalAttendance: $medicalCertificateMedicalAttendance, persistRelations: $persistRelations) {
							...MedicalCertificateMedicalAttendanceProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.medicalCertificateMedicalAttendance as MedicalCertificateMedicalAttendanceModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: MedicalCertificateMedicalAttendanceModel[], queryParams?: QueryParams): Observable<PassableStateConfig<MedicalCertificateMedicalAttendanceModel>> {
		...
		const successMessage = 'Created Multiple Medical Certificate Medical Attendance entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($medicalCertificateMedicalAttendances: [MedicalCertificateMedicalAttendanceInput!]!) {
						medicalCertificateMedicalAttendance: createAllMedicalCertificateMedicalAttendance(medicalCertificateMedicalAttendances: $medicalCertificateMedicalAttendances) {
							...MedicalCertificateMedicalAttendanceProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					medicalCertificateMedicalAttendances: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.medicalCertificateMedicalAttendance as MedicalCertificateMedicalAttendanceModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: MedicalCertificateMedicalAttendanceModel, queryParams?: QueryParams): Observable<PassableStateConfig<MedicalCertificateMedicalAttendanceModel>> {
		...
		const successMessage = 'Updated Medical Certificate Medical Attendance entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($medicalCertificateMedicalAttendance: MedicalCertificateMedicalAttendanceInput!, $persistRelations: Boolean) {
						medicalCertificateMedicalAttendance: updateMedicalCertificateMedicalAttendance(medicalCertificateMedicalAttendance: $medicalCertificateMedicalAttendance, persistRelations: $persistRelations) {
							...MedicalCertificateMedicalAttendanceProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: MedicalCertificateMedicalAttendanceModel[], queryParams?: QueryParams): Observable<PassableStateConfig<MedicalCertificateMedicalAttendanceModel>> {
		...
		const successMessage = 'Update Multiple Medical Certificate Medical Attendance entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($medicalCertificateMedicalAttendances: [MedicalCertificateMedicalAttendanceInput!]!) {
						medicalCertificateMedicalAttendance: updateAllMedicalCertificateMedicalAttendance(medicalCertificateMedicalAttendances: $medicalCertificateMedicalAttendances) {
							...MedicalCertificateMedicalAttendanceProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<MedicalCertificateMedicalAttendanceModel>> {
		...
		const successMessage = 'Deleted Medical Certificate Medical Attendance entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($medicalCertificateMedicalAttendanceId: ID!) {
						medicalCertificateMedicalAttendanceId: deleteMedicalCertificateMedicalAttendanceById(medicalCertificateMedicalAttendanceId: $medicalCertificateMedicalAttendanceId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.medicalCertificateMedicalAttendanceId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<MedicalCertificateMedicalAttendanceModel>> {
		...
		const successMessage = 'Deleted selected Medical Certificate Medical Attendance entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($medicalCertificateMedicalAttendanceIds: [ID!]!){
						deleteMedicalCertificateMedicalAttendanceExcludingIds(medicalCertificateMedicalAttendanceIds: $medicalCertificateMedicalAttendanceIds)
				...
				`,
				variables: {
					medicalCertificateMedicalAttendanceIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.medicalCertificateMedicalAttendanceIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<MedicalCertificateMedicalAttendanceModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($medicalCertificateMedicalAttendanceIds: [ID!]!) {
						medicalCertificateMedicalAttendanceIds: deleteAllMedicalCertificateMedicalAttendanceByIds(medicalCertificateMedicalAttendanceIds: $medicalCertificateMedicalAttendanceIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<MedicalCertificateMedicalAttendanceModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<MedicalCertificateMedicalAttendanceModel>>(
			{
				query: gql`
					query GetAudits {
						audits: medicalCertificateMedicalAttendanceAudits {
							entity {
								...MedicalCertificateMedicalAttendanceProperties
							}
							timestamp
			...
			map(result => {
				let audits: MedicalCertificateMedicalAttendanceModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new MedicalCertificateMedicalAttendanceModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<MedicalCertificateMedicalAttendanceModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<MedicalCertificateMedicalAttendanceModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($medicalCertificateMedicalAttendanceId: ID!) {
						audits: medicalCertificateMedicalAttendanceAuditsByEntityId(medicalCertificateMedicalAttendanceId: $medicalCertificateMedicalAttendanceId) {
							entity {
								...MedicalCertificateMedicalAttendanceProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<MedicalCertificateMedicalAttendanceModel>> {
		const url = environment.API_URL + '/api/medicalcertificatemedicalattendance/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<MedicalCertificateMedicalAttendanceModel>> {
		const url = environment.API_URL + '/api/medicalcertificatemedicalattendance/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<MedicalCertificateMedicalAttendanceModel>> {
		let apiUrl = environment.API_URL + '/api/medicalcertificatemedicalattendance/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<MedicalCertificateMedicalAttendanceModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/medicalcertificatemedicalattendance/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Medical Certificate Medical Attendance entities')),
