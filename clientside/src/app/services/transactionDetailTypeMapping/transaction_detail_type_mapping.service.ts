...
import {TransactionDetailTypeMappingModel} from '../../models/transactionDetailTypeMapping/transaction_detail_type_mapping.model';
import {TransactionDetailTypeMappingModelAudit} from '../../models/transactionDetailTypeMapping/transaction_detail_type_mapping.model.state';
...
/**
 * Transaction Detail Type Mapping service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class TransactionDetailTypeMappingService extends AbstractHttpService<TransactionDetailTypeMappingModel, TransactionDetailTypeMappingModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the TransactionDetailTypeMappingProperties classFragment here] off begin
			fragment TransactionDetailTypeMappingProperties on TransactionDetailTypeMapping {
				...TransactionDetailTypeMappingBaseProperties
				transactionType
			}
			# % protected region % [Modify the TransactionDetailTypeMappingProperties classFragment here] end
			${super.fragments('TransactionDetailTypeMapping').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<TransactionDetailTypeMappingModel>> {
		...
		return  this.apollo.query<PassableStateConfig<TransactionDetailTypeMappingModel>>(
			{
				query: gql`
					query Count {
						totalCount: countTransactionDetailTypeMappings
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<TransactionDetailTypeMappingModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<TransactionDetailTypeMappingModel>> {
		...
		return this.apollo.query<PassableStateConfig<TransactionDetailTypeMappingModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						TransactionDetailTypeMappingById: transactionDetailTypeMappingById(id: $id) {
							...TransactionDetailTypeMappingProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.TransactionDetailTypeMappingById as TransactionDetailTypeMappingModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<TransactionDetailTypeMappingModel>> {
		...
		return this.apollo.query<PassableStateConfig<TransactionDetailTypeMappingModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						transactionDetailTypeMappings: transactionDetailTypeMappings(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...TransactionDetailTypeMappingProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countTransactionDetailTypeMappings(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.transactionDetailTypeMappings as TransactionDetailTypeMappingModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<TransactionDetailTypeMappingModel>> {
		...
		return this.apollo.query<PassableStateConfig<TransactionDetailTypeMappingModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						transactionDetailTypeMappings: lastTransactionDetailTypeMappings(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...TransactionDetailTypeMappingProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: TransactionDetailTypeMappingModel, queryParams?: QueryParams): Observable<PassableStateConfig<TransactionDetailTypeMappingModel>> {
		...
		const successMessage = 'Created Transaction Detail Type Mapping entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($transactionDetailTypeMapping: TransactionDetailTypeMappingInput!, $persistRelations: Boolean) {
						transactionDetailTypeMapping: createTransactionDetailTypeMapping(transactionDetailTypeMapping: $transactionDetailTypeMapping, persistRelations: $persistRelations) {
							...TransactionDetailTypeMappingProperties,
				...
				`,
				variables: {
					transactionDetailTypeMapping: {
						...entity.toJSON(),
						transactionDetailType: entity.transactionDetailType ? new TransactionDetailTypeModel(entity.transactionDetailType).toJSON() : undefined,
					},
			...
			map(result => {
				...
				return {
					targetModel: result.data.transactionDetailTypeMapping as TransactionDetailTypeMappingModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: TransactionDetailTypeMappingModel[], queryParams?: QueryParams): Observable<PassableStateConfig<TransactionDetailTypeMappingModel>> {
		...
		const successMessage = 'Created Multiple Transaction Detail Type Mapping entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($transactionDetailTypeMappings: [TransactionDetailTypeMappingInput!]!) {
						transactionDetailTypeMapping: createAllTransactionDetailTypeMapping(transactionDetailTypeMappings: $transactionDetailTypeMappings) {
							...TransactionDetailTypeMappingProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					transactionDetailTypeMappings: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.transactionDetailTypeMapping as TransactionDetailTypeMappingModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: TransactionDetailTypeMappingModel, queryParams?: QueryParams): Observable<PassableStateConfig<TransactionDetailTypeMappingModel>> {
		...
		const successMessage = 'Updated Transaction Detail Type Mapping entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($transactionDetailTypeMapping: TransactionDetailTypeMappingInput!, $persistRelations: Boolean) {
						transactionDetailTypeMapping: updateTransactionDetailTypeMapping(transactionDetailTypeMapping: $transactionDetailTypeMapping, persistRelations: $persistRelations) {
							...TransactionDetailTypeMappingProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: TransactionDetailTypeMappingModel[], queryParams?: QueryParams): Observable<PassableStateConfig<TransactionDetailTypeMappingModel>> {
		...
		const successMessage = 'Update Multiple Transaction Detail Type Mapping entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($transactionDetailTypeMappings: [TransactionDetailTypeMappingInput!]!) {
						transactionDetailTypeMapping: updateAllTransactionDetailTypeMapping(transactionDetailTypeMappings: $transactionDetailTypeMappings) {
							...TransactionDetailTypeMappingProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<TransactionDetailTypeMappingModel>> {
		...
		const successMessage = 'Deleted Transaction Detail Type Mapping entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($transactionDetailTypeMappingId: ID!) {
						transactionDetailTypeMappingId: deleteTransactionDetailTypeMappingById(transactionDetailTypeMappingId: $transactionDetailTypeMappingId)
				...
				`,
				variables: {
					transactionDetailTypeMappingId: id,
			...
			map(result => {
				...
				return {
					targetModelId: result.data.transactionDetailTypeMappingId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<TransactionDetailTypeMappingModel>> {
		...
		const successMessage = 'Deleted selected Transaction Detail Type Mapping entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($transactionDetailTypeMappingIds: [ID!]!){
						deleteTransactionDetailTypeMappingExcludingIds(transactionDetailTypeMappingIds: $transactionDetailTypeMappingIds)
				...
				`,
				variables: {
					transactionDetailTypeMappingIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.transactionDetailTypeMappingIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<TransactionDetailTypeMappingModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($transactionDetailTypeMappingIds: [ID!]!) {
						transactionDetailTypeMappingIds: deleteAllTransactionDetailTypeMappingByIds(transactionDetailTypeMappingIds: $transactionDetailTypeMappingIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<TransactionDetailTypeMappingModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<TransactionDetailTypeMappingModel>>(
			{
				query: gql`
					query GetAudits {
						audits: transactionDetailTypeMappingAudits {
							entity {
								...TransactionDetailTypeMappingProperties
							}
							timestamp
			...
			map(result => {
				let audits: TransactionDetailTypeMappingModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new TransactionDetailTypeMappingModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<TransactionDetailTypeMappingModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<TransactionDetailTypeMappingModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($transactionDetailTypeMappingId: ID!) {
						audits: transactionDetailTypeMappingAuditsByEntityId(transactionDetailTypeMappingId: $transactionDetailTypeMappingId) {
							entity {
								...TransactionDetailTypeMappingProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<TransactionDetailTypeMappingModel>> {
		const url = environment.API_URL + '/api/transactiondetailtypemapping/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<TransactionDetailTypeMappingModel>> {
		const url = environment.API_URL + '/api/transactiondetailtypemapping/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<TransactionDetailTypeMappingModel>> {
		let apiUrl = environment.API_URL + '/api/transactiondetailtypemapping/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<TransactionDetailTypeMappingModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/transactiondetailtypemapping/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Transaction Detail Type Mapping entities')),
