...
import {SampleCollectionInformationModel} from '../../models/sampleCollectionInformation/sample_collection_information.model';
import {SampleCollectionInformationModelAudit} from '../../models/sampleCollectionInformation/sample_collection_information.model.state';
...
/**
 * Sample Collection Information service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class SampleCollectionInformationService extends AbstractHttpService<SampleCollectionInformationModel, SampleCollectionInformationModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the SampleCollectionInformationProperties classFragment here] off begin
			fragment SampleCollectionInformationProperties on SampleCollectionInformation {
				...SampleCollectionInformationBaseProperties
				patientInformed
				patientConsented
				patientFastedEnough
				medicationTakenIn24Hours
				medicationTakenIn72Hours
			}
			# % protected region % [Modify the SampleCollectionInformationProperties classFragment here] end
			${super.fragments('SampleCollectionInformation').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<SampleCollectionInformationModel>> {
		...
		return  this.apollo.query<PassableStateConfig<SampleCollectionInformationModel>>(
			{
				query: gql`
					query Count {
						totalCount: countSampleCollectionInformations
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<SampleCollectionInformationModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<SampleCollectionInformationModel>> {
		...
		return this.apollo.query<PassableStateConfig<SampleCollectionInformationModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						SampleCollectionInformationById: sampleCollectionInformationById(id: $id) {
							...SampleCollectionInformationProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.SampleCollectionInformationById as SampleCollectionInformationModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<SampleCollectionInformationModel>> {
		...
		return this.apollo.query<PassableStateConfig<SampleCollectionInformationModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						sampleCollectionInformations: sampleCollectionInformations(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...SampleCollectionInformationProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countSampleCollectionInformations(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.sampleCollectionInformations as SampleCollectionInformationModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<SampleCollectionInformationModel>> {
		...
		return this.apollo.query<PassableStateConfig<SampleCollectionInformationModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						sampleCollectionInformations: lastSampleCollectionInformations(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...SampleCollectionInformationProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: SampleCollectionInformationModel, queryParams?: QueryParams): Observable<PassableStateConfig<SampleCollectionInformationModel>> {
		...
		const successMessage = 'Created Sample Collection Information entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($sampleCollectionInformation: SampleCollectionInformationInput!, $persistRelations: Boolean) {
						sampleCollectionInformation: createSampleCollectionInformation(sampleCollectionInformation: $sampleCollectionInformation, persistRelations: $persistRelations) {
							...SampleCollectionInformationProperties,
				...
				variables: {
					sampleCollectionInformation: {
						...
						sampleCollectionItems: entity.sampleCollectionItems ? entity.sampleCollectionItems?.map((model: SampleCollectionItemsModel) => new SampleCollectionItemsModel(model).toJSON()) : [],
					},
			...
			map(result => {
				...
				return {
					targetModel: result.data.sampleCollectionInformation as SampleCollectionInformationModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: SampleCollectionInformationModel[], queryParams?: QueryParams): Observable<PassableStateConfig<SampleCollectionInformationModel>> {
		...
		const successMessage = 'Created Multiple Sample Collection Information entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($sampleCollectionInformations: [SampleCollectionInformationInput!]!) {
						sampleCollectionInformation: createAllSampleCollectionInformation(sampleCollectionInformations: $sampleCollectionInformations) {
							...SampleCollectionInformationProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					sampleCollectionInformations: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.sampleCollectionInformation as SampleCollectionInformationModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: SampleCollectionInformationModel, queryParams?: QueryParams): Observable<PassableStateConfig<SampleCollectionInformationModel>> {
		...
		const successMessage = 'Updated Sample Collection Information entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($sampleCollectionInformation: SampleCollectionInformationInput!, $persistRelations: Boolean) {
						sampleCollectionInformation: updateSampleCollectionInformation(sampleCollectionInformation: $sampleCollectionInformation, persistRelations: $persistRelations) {
							...SampleCollectionInformationProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: SampleCollectionInformationModel[], queryParams?: QueryParams): Observable<PassableStateConfig<SampleCollectionInformationModel>> {
		...
		const successMessage = 'Update Multiple Sample Collection Information entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($sampleCollectionInformations: [SampleCollectionInformationInput!]!) {
						sampleCollectionInformation: updateAllSampleCollectionInformation(sampleCollectionInformations: $sampleCollectionInformations) {
							...SampleCollectionInformationProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<SampleCollectionInformationModel>> {
		...
		const successMessage = 'Deleted Sample Collection Information entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($sampleCollectionInformationId: ID!) {
						sampleCollectionInformationId: deleteSampleCollectionInformationById(sampleCollectionInformationId: $sampleCollectionInformationId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.sampleCollectionInformationId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<SampleCollectionInformationModel>> {
		...
		const successMessage = 'Deleted selected Sample Collection Information entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($sampleCollectionInformationIds: [ID!]!){
						deleteSampleCollectionInformationExcludingIds(sampleCollectionInformationIds: $sampleCollectionInformationIds)
				...
				`,
				variables: {
					sampleCollectionInformationIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.sampleCollectionInformationIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<SampleCollectionInformationModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($sampleCollectionInformationIds: [ID!]!) {
						sampleCollectionInformationIds: deleteAllSampleCollectionInformationByIds(sampleCollectionInformationIds: $sampleCollectionInformationIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<SampleCollectionInformationModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<SampleCollectionInformationModel>>(
			{
				query: gql`
					query GetAudits {
						audits: sampleCollectionInformationAudits {
							entity {
								...SampleCollectionInformationProperties
							}
							timestamp
			...
			map(result => {
				let audits: SampleCollectionInformationModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new SampleCollectionInformationModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<SampleCollectionInformationModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<SampleCollectionInformationModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($sampleCollectionInformationId: ID!) {
						audits: sampleCollectionInformationAuditsByEntityId(sampleCollectionInformationId: $sampleCollectionInformationId) {
							entity {
								...SampleCollectionInformationProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<SampleCollectionInformationModel>> {
		const url = environment.API_URL + '/api/samplecollectioninformation/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<SampleCollectionInformationModel>> {
		const url = environment.API_URL + '/api/samplecollectioninformation/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<SampleCollectionInformationModel>> {
		let apiUrl = environment.API_URL + '/api/samplecollectioninformation/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<SampleCollectionInformationModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/samplecollectioninformation/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Sample Collection Information entities')),
