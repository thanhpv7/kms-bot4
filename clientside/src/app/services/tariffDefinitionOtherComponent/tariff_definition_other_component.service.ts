...
import {TariffDefinitionOtherComponentModel} from '../../models/tariffDefinitionOtherComponent/tariff_definition_other_component.model';
import {TariffDefinitionOtherComponentModelAudit} from '../../models/tariffDefinitionOtherComponent/tariff_definition_other_component.model.state';
...
/**
 * Tariff Definition Other Component service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class TariffDefinitionOtherComponentService extends AbstractHttpService<TariffDefinitionOtherComponentModel, TariffDefinitionOtherComponentModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the TariffDefinitionOtherComponentProperties classFragment here] off begin
			fragment TariffDefinitionOtherComponentProperties on TariffDefinitionOtherComponent {
				...TariffDefinitionOtherComponentBaseProperties
				price
			}
			# % protected region % [Modify the TariffDefinitionOtherComponentProperties classFragment here] end
			${super.fragments('TariffDefinitionOtherComponent').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<TariffDefinitionOtherComponentModel>> {
		...
		return  this.apollo.query<PassableStateConfig<TariffDefinitionOtherComponentModel>>(
			{
				query: gql`
					query Count {
						totalCount: countTariffDefinitionOtherComponents
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<TariffDefinitionOtherComponentModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<TariffDefinitionOtherComponentModel>> {
		...
		return this.apollo.query<PassableStateConfig<TariffDefinitionOtherComponentModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						TariffDefinitionOtherComponentById: tariffDefinitionOtherComponentById(id: $id) {
							...TariffDefinitionOtherComponentProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.TariffDefinitionOtherComponentById as TariffDefinitionOtherComponentModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<TariffDefinitionOtherComponentModel>> {
		...
		return this.apollo.query<PassableStateConfig<TariffDefinitionOtherComponentModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						tariffDefinitionOtherComponents: tariffDefinitionOtherComponents(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...TariffDefinitionOtherComponentProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countTariffDefinitionOtherComponents(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.tariffDefinitionOtherComponents as TariffDefinitionOtherComponentModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<TariffDefinitionOtherComponentModel>> {
		...
		return this.apollo.query<PassableStateConfig<TariffDefinitionOtherComponentModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						tariffDefinitionOtherComponents: lastTariffDefinitionOtherComponents(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...TariffDefinitionOtherComponentProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: TariffDefinitionOtherComponentModel, queryParams?: QueryParams): Observable<PassableStateConfig<TariffDefinitionOtherComponentModel>> {
		...
		const successMessage = 'Created Tariff Definition Other Component entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($tariffDefinitionOtherComponent: TariffDefinitionOtherComponentInput!, $persistRelations: Boolean) {
						tariffDefinitionOtherComponent: createTariffDefinitionOtherComponent(tariffDefinitionOtherComponent: $tariffDefinitionOtherComponent, persistRelations: $persistRelations) {
							...TariffDefinitionOtherComponentProperties,
				...
				`,
				variables: {
					tariffDefinitionOtherComponent: {
						...entity.toJSON(),
						priceComponent: entity.priceComponent ? new PriceComponentModel(entity.priceComponent).toJSON() : undefined,
						priceDefinition: entity.priceDefinition ? new TariffDefinitionModel(entity.priceDefinition).toJSON() : undefined,
					},
			...
			map(result => {
				...
				return {
					targetModel: result.data.tariffDefinitionOtherComponent as TariffDefinitionOtherComponentModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: TariffDefinitionOtherComponentModel[], queryParams?: QueryParams): Observable<PassableStateConfig<TariffDefinitionOtherComponentModel>> {
		...
		const successMessage = 'Created Multiple Tariff Definition Other Component entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($tariffDefinitionOtherComponents: [TariffDefinitionOtherComponentInput!]!) {
						tariffDefinitionOtherComponent: createAllTariffDefinitionOtherComponent(tariffDefinitionOtherComponents: $tariffDefinitionOtherComponents) {
							...TariffDefinitionOtherComponentProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					tariffDefinitionOtherComponents: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.tariffDefinitionOtherComponent as TariffDefinitionOtherComponentModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: TariffDefinitionOtherComponentModel, queryParams?: QueryParams): Observable<PassableStateConfig<TariffDefinitionOtherComponentModel>> {
		...
		const successMessage = 'Updated Tariff Definition Other Component entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($tariffDefinitionOtherComponent: TariffDefinitionOtherComponentInput!, $persistRelations: Boolean) {
						tariffDefinitionOtherComponent: updateTariffDefinitionOtherComponent(tariffDefinitionOtherComponent: $tariffDefinitionOtherComponent, persistRelations: $persistRelations) {
							...TariffDefinitionOtherComponentProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: TariffDefinitionOtherComponentModel[], queryParams?: QueryParams): Observable<PassableStateConfig<TariffDefinitionOtherComponentModel>> {
		...
		const successMessage = 'Update Multiple Tariff Definition Other Component entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($tariffDefinitionOtherComponents: [TariffDefinitionOtherComponentInput!]!) {
						tariffDefinitionOtherComponent: updateAllTariffDefinitionOtherComponent(tariffDefinitionOtherComponents: $tariffDefinitionOtherComponents) {
							...TariffDefinitionOtherComponentProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<TariffDefinitionOtherComponentModel>> {
		...
		const successMessage = 'Deleted Tariff Definition Other Component entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($tariffDefinitionOtherComponentId: ID!) {
						tariffDefinitionOtherComponentId: deleteTariffDefinitionOtherComponentById(tariffDefinitionOtherComponentId: $tariffDefinitionOtherComponentId)
				...
				`,
				variables: {
					tariffDefinitionOtherComponentId: id,
			...
			map(result => {
				...
				return {
					targetModelId: result.data.tariffDefinitionOtherComponentId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<TariffDefinitionOtherComponentModel>> {
		...
		const successMessage = 'Deleted selected Tariff Definition Other Component entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($tariffDefinitionOtherComponentIds: [ID!]!){
						deleteTariffDefinitionOtherComponentExcludingIds(tariffDefinitionOtherComponentIds: $tariffDefinitionOtherComponentIds)
				...
				`,
				variables: {
					tariffDefinitionOtherComponentIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.tariffDefinitionOtherComponentIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<TariffDefinitionOtherComponentModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($tariffDefinitionOtherComponentIds: [ID!]!) {
						tariffDefinitionOtherComponentIds: deleteAllTariffDefinitionOtherComponentByIds(tariffDefinitionOtherComponentIds: $tariffDefinitionOtherComponentIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<TariffDefinitionOtherComponentModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<TariffDefinitionOtherComponentModel>>(
			{
				query: gql`
					query GetAudits {
						audits: tariffDefinitionOtherComponentAudits {
							entity {
								...TariffDefinitionOtherComponentProperties
							}
							timestamp
			...
			map(result => {
				let audits: TariffDefinitionOtherComponentModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new TariffDefinitionOtherComponentModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<TariffDefinitionOtherComponentModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<TariffDefinitionOtherComponentModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($tariffDefinitionOtherComponentId: ID!) {
						audits: tariffDefinitionOtherComponentAuditsByEntityId(tariffDefinitionOtherComponentId: $tariffDefinitionOtherComponentId) {
							entity {
								...TariffDefinitionOtherComponentProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<TariffDefinitionOtherComponentModel>> {
		const url = environment.API_URL + '/api/tariffdefinitionothercomponent/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<TariffDefinitionOtherComponentModel>> {
		const url = environment.API_URL + '/api/tariffdefinitionothercomponent/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<TariffDefinitionOtherComponentModel>> {
		let apiUrl = environment.API_URL + '/api/tariffdefinitionothercomponent/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<TariffDefinitionOtherComponentModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/tariffdefinitionothercomponent/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Tariff Definition Other Component entities')),
