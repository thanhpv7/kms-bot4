...
import {OphthalmologyExaminationModel} from '../../models/ophthalmologyExamination/ophthalmology_examination.model';
import {OphthalmologyExaminationModelAudit} from '../../models/ophthalmologyExamination/ophthalmology_examination.model.state';
...
/**
 * Ophthalmology Examination service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class OphthalmologyExaminationService extends AbstractHttpService<OphthalmologyExaminationModel, OphthalmologyExaminationModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the OphthalmologyExaminationProperties classFragment here] off begin
			fragment OphthalmologyExaminationProperties on OphthalmologyExamination {
				...OphthalmologyExaminationBaseProperties
				rightEyelidSubjective
				rightEyelidObjective
				rightPupilSubjective
				rightPupilObjective
				rightScleraSubjective
				rightScleraObjective
				rightIrisSubjective
				rightIrisObjective
				leftEyelidSubjective
				leftEyelidObjective
				leftPupilSubjective
				leftPupilObjective
				leftScleraSubjective
				leftScleraObjective
				leftIrisSubjective
				leftIrisObjective
			}
			# % protected region % [Modify the OphthalmologyExaminationProperties classFragment here] end
			${super.fragments('OphthalmologyExamination').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<OphthalmologyExaminationModel>> {
		...
		return  this.apollo.query<PassableStateConfig<OphthalmologyExaminationModel>>(
			{
				query: gql`
					query Count {
						totalCount: countOphthalmologyExaminations
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<OphthalmologyExaminationModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<OphthalmologyExaminationModel>> {
		...
		return this.apollo.query<PassableStateConfig<OphthalmologyExaminationModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						OphthalmologyExaminationById: ophthalmologyExaminationById(id: $id) {
							...OphthalmologyExaminationProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.OphthalmologyExaminationById as OphthalmologyExaminationModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<OphthalmologyExaminationModel>> {
		...
		return this.apollo.query<PassableStateConfig<OphthalmologyExaminationModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						ophthalmologyExaminations: ophthalmologyExaminations(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...OphthalmologyExaminationProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countOphthalmologyExaminations(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.ophthalmologyExaminations as OphthalmologyExaminationModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<OphthalmologyExaminationModel>> {
		...
		return this.apollo.query<PassableStateConfig<OphthalmologyExaminationModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						ophthalmologyExaminations: lastOphthalmologyExaminations(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...OphthalmologyExaminationProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: OphthalmologyExaminationModel, queryParams?: QueryParams): Observable<PassableStateConfig<OphthalmologyExaminationModel>> {
		...
		const successMessage = 'Created Ophthalmology Examination entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($ophthalmologyExamination: OphthalmologyExaminationInput!, $persistRelations: Boolean) {
						ophthalmologyExamination: createOphthalmologyExamination(ophthalmologyExamination: $ophthalmologyExamination, persistRelations: $persistRelations) {
							...OphthalmologyExaminationProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.ophthalmologyExamination as OphthalmologyExaminationModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: OphthalmologyExaminationModel[], queryParams?: QueryParams): Observable<PassableStateConfig<OphthalmologyExaminationModel>> {
		...
		const successMessage = 'Created Multiple Ophthalmology Examination entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($ophthalmologyExaminations: [OphthalmologyExaminationInput!]!) {
						ophthalmologyExamination: createAllOphthalmologyExamination(ophthalmologyExaminations: $ophthalmologyExaminations) {
							...OphthalmologyExaminationProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					ophthalmologyExaminations: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.ophthalmologyExamination as OphthalmologyExaminationModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: OphthalmologyExaminationModel, queryParams?: QueryParams): Observable<PassableStateConfig<OphthalmologyExaminationModel>> {
		...
		const successMessage = 'Updated Ophthalmology Examination entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($ophthalmologyExamination: OphthalmologyExaminationInput!, $persistRelations: Boolean) {
						ophthalmologyExamination: updateOphthalmologyExamination(ophthalmologyExamination: $ophthalmologyExamination, persistRelations: $persistRelations) {
							...OphthalmologyExaminationProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: OphthalmologyExaminationModel[], queryParams?: QueryParams): Observable<PassableStateConfig<OphthalmologyExaminationModel>> {
		...
		const successMessage = 'Update Multiple Ophthalmology Examination entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($ophthalmologyExaminations: [OphthalmologyExaminationInput!]!) {
						ophthalmologyExamination: updateAllOphthalmologyExamination(ophthalmologyExaminations: $ophthalmologyExaminations) {
							...OphthalmologyExaminationProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<OphthalmologyExaminationModel>> {
		...
		const successMessage = 'Deleted Ophthalmology Examination entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($ophthalmologyExaminationId: ID!) {
						ophthalmologyExaminationId: deleteOphthalmologyExaminationById(ophthalmologyExaminationId: $ophthalmologyExaminationId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.ophthalmologyExaminationId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<OphthalmologyExaminationModel>> {
		...
		const successMessage = 'Deleted selected Ophthalmology Examination entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($ophthalmologyExaminationIds: [ID!]!){
						deleteOphthalmologyExaminationExcludingIds(ophthalmologyExaminationIds: $ophthalmologyExaminationIds)
				...
				`,
				variables: {
					ophthalmologyExaminationIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.ophthalmologyExaminationIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<OphthalmologyExaminationModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($ophthalmologyExaminationIds: [ID!]!) {
						ophthalmologyExaminationIds: deleteAllOphthalmologyExaminationByIds(ophthalmologyExaminationIds: $ophthalmologyExaminationIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<OphthalmologyExaminationModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<OphthalmologyExaminationModel>>(
			{
				query: gql`
					query GetAudits {
						audits: ophthalmologyExaminationAudits {
							entity {
								...OphthalmologyExaminationProperties
							}
							timestamp
			...
			map(result => {
				let audits: OphthalmologyExaminationModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new OphthalmologyExaminationModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<OphthalmologyExaminationModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<OphthalmologyExaminationModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($ophthalmologyExaminationId: ID!) {
						audits: ophthalmologyExaminationAuditsByEntityId(ophthalmologyExaminationId: $ophthalmologyExaminationId) {
							entity {
								...OphthalmologyExaminationProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<OphthalmologyExaminationModel>> {
		const url = environment.API_URL + '/api/ophthalmologyexamination/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<OphthalmologyExaminationModel>> {
		const url = environment.API_URL + '/api/ophthalmologyexamination/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<OphthalmologyExaminationModel>> {
		let apiUrl = environment.API_URL + '/api/ophthalmologyexamination/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<OphthalmologyExaminationModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/ophthalmologyexamination/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Ophthalmology Examination entities')),
