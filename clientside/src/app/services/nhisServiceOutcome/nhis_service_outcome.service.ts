...
import {NhisServiceOutcomeModelAudit} from '../../models/nhisServiceOutcome/nhis_service_outcome.model.state';
...
/**
 * NHIS Service Outcome service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class NhisServiceOutcomeService extends AbstractHttpService<NhisServiceOutcomeModel, NhisServiceOutcomeModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the NhisServiceOutcomeProperties classFragment here] off begin
			fragment NhisServiceOutcomeProperties on NhisServiceOutcome {
				...NhisServiceOutcomeBaseProperties
				code
				description
				dismissalTypes
			}
			# % protected region % [Modify the NhisServiceOutcomeProperties classFragment here] end
			${super.fragments('NhisServiceOutcome').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<NhisServiceOutcomeModel>> {
		...
		return  this.apollo.query<PassableStateConfig<NhisServiceOutcomeModel>>(
			{
				query: gql`
					query Count {
						totalCount: countNhisServiceOutcomes
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<NhisServiceOutcomeModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<NhisServiceOutcomeModel>> {
		...
		return this.apollo.query<PassableStateConfig<NhisServiceOutcomeModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						NhisServiceOutcomeById: nhisServiceOutcomeById(id: $id) {
							...NhisServiceOutcomeProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.NhisServiceOutcomeById as NhisServiceOutcomeModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<NhisServiceOutcomeModel>> {
		...
		return this.apollo.query<PassableStateConfig<NhisServiceOutcomeModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						nhisServiceOutcomes: nhisServiceOutcomes(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...NhisServiceOutcomeProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countNhisServiceOutcomes(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.nhisServiceOutcomes as NhisServiceOutcomeModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<NhisServiceOutcomeModel>> {
		...
		return this.apollo.query<PassableStateConfig<NhisServiceOutcomeModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						nhisServiceOutcomes: lastNhisServiceOutcomes(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...NhisServiceOutcomeProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: NhisServiceOutcomeModel, queryParams?: QueryParams): Observable<PassableStateConfig<NhisServiceOutcomeModel>> {
		...
		const successMessage = 'Created NHIS Service Outcome entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($nhisServiceOutcome: NhisServiceOutcomeInput!, $persistRelations: Boolean) {
						nhisServiceOutcome: createNhisServiceOutcome(nhisServiceOutcome: $nhisServiceOutcome, persistRelations: $persistRelations) {
							...NhisServiceOutcomeProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.nhisServiceOutcome as NhisServiceOutcomeModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: NhisServiceOutcomeModel[], queryParams?: QueryParams): Observable<PassableStateConfig<NhisServiceOutcomeModel>> {
		...
		const successMessage = 'Created Multiple NHIS Service Outcome entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($nhisServiceOutcomes: [NhisServiceOutcomeInput!]!) {
						nhisServiceOutcome: createAllNhisServiceOutcome(nhisServiceOutcomes: $nhisServiceOutcomes) {
							...NhisServiceOutcomeProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					nhisServiceOutcomes: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.nhisServiceOutcome as NhisServiceOutcomeModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: NhisServiceOutcomeModel, queryParams?: QueryParams): Observable<PassableStateConfig<NhisServiceOutcomeModel>> {
		...
		const successMessage = 'Updated NHIS Service Outcome entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($nhisServiceOutcome: NhisServiceOutcomeInput!, $persistRelations: Boolean) {
						nhisServiceOutcome: updateNhisServiceOutcome(nhisServiceOutcome: $nhisServiceOutcome, persistRelations: $persistRelations) {
							...NhisServiceOutcomeProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: NhisServiceOutcomeModel[], queryParams?: QueryParams): Observable<PassableStateConfig<NhisServiceOutcomeModel>> {
		...
		const successMessage = 'Update Multiple NHIS Service Outcome entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($nhisServiceOutcomes: [NhisServiceOutcomeInput!]!) {
						nhisServiceOutcome: updateAllNhisServiceOutcome(nhisServiceOutcomes: $nhisServiceOutcomes) {
							...NhisServiceOutcomeProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<NhisServiceOutcomeModel>> {
		...
		const successMessage = 'Deleted NHIS Service Outcome entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($nhisServiceOutcomeId: ID!) {
						nhisServiceOutcomeId: deleteNhisServiceOutcomeById(nhisServiceOutcomeId: $nhisServiceOutcomeId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.nhisServiceOutcomeId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<NhisServiceOutcomeModel>> {
		...
		const successMessage = 'Deleted selected NHIS Service Outcome entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($nhisServiceOutcomeIds: [ID!]!){
						deleteNhisServiceOutcomeExcludingIds(nhisServiceOutcomeIds: $nhisServiceOutcomeIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.nhisServiceOutcomeIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<NhisServiceOutcomeModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($nhisServiceOutcomeIds: [ID!]!) {
						nhisServiceOutcomeIds: deleteAllNhisServiceOutcomeByIds(nhisServiceOutcomeIds: $nhisServiceOutcomeIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<NhisServiceOutcomeModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<NhisServiceOutcomeModel>>(
			{
				query: gql`
					query GetAudits {
						audits: nhisServiceOutcomeAudits {
							entity {
								...NhisServiceOutcomeProperties
							}
							timestamp
			...
			map(result => {
				let audits: NhisServiceOutcomeModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new NhisServiceOutcomeModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<NhisServiceOutcomeModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<NhisServiceOutcomeModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($nhisServiceOutcomeId: ID!) {
						audits: nhisServiceOutcomeAuditsByEntityId(nhisServiceOutcomeId: $nhisServiceOutcomeId) {
							entity {
								...NhisServiceOutcomeProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<NhisServiceOutcomeModel>> {
		const url = environment.API_URL + '/api/nhisserviceoutcome/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<NhisServiceOutcomeModel>> {
		const url = environment.API_URL + '/api/nhisserviceoutcome/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<NhisServiceOutcomeModel>> {
		let apiUrl = environment.API_URL + '/api/nhisserviceoutcome/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<NhisServiceOutcomeModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/nhisserviceoutcome/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' NHIS Service Outcome entities')),
