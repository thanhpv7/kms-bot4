...
import {BpjsControlPlanModel} from '../../models/bpjsControlPlan/bpjs_control_plan.model';
import {BpjsControlPlanModelAudit} from '../../models/bpjsControlPlan/bpjs_control_plan.model.state';
...
/**
 * BPJS Control Plan service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class BpjsControlPlanService extends AbstractHttpService<BpjsControlPlanModel, BpjsControlPlanModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the BpjsControlPlanProperties classFragment here] off begin
			fragment BpjsControlPlanProperties on BpjsControlPlan {
				...BpjsControlPlanBaseProperties
				noSEP
				controlLetterNo
				controlPlanDate
				bpjsCardNo
			...
			# % protected region % [Modify the BpjsControlPlanProperties classFragment here] end
			${super.fragments('BpjsControlPlan').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<BpjsControlPlanModel>> {
		...
		return  this.apollo.query<PassableStateConfig<BpjsControlPlanModel>>(
			{
				query: gql`
					query Count {
						totalCount: countBpjsControlPlans
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<BpjsControlPlanModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsControlPlanModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsControlPlanModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						BpjsControlPlanById: bpjsControlPlanById(id: $id) {
							...BpjsControlPlanProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.BpjsControlPlanById as BpjsControlPlanModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsControlPlanModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsControlPlanModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						bpjsControlPlans: bpjsControlPlans(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...BpjsControlPlanProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countBpjsControlPlans(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.bpjsControlPlans as BpjsControlPlanModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<BpjsControlPlanModel>> {
		...
		return this.apollo.query<PassableStateConfig<BpjsControlPlanModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						bpjsControlPlans: lastBpjsControlPlans(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...BpjsControlPlanProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: BpjsControlPlanModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsControlPlanModel>> {
		...
		const successMessage = 'Created BPJS Control Plan entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($bpjsControlPlan: BpjsControlPlanInput!, $persistRelations: Boolean) {
						bpjsControlPlan: createBpjsControlPlan(bpjsControlPlan: $bpjsControlPlan, persistRelations: $persistRelations) {
							...BpjsControlPlanProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.bpjsControlPlan as BpjsControlPlanModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: BpjsControlPlanModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsControlPlanModel>> {
		...
		const successMessage = 'Created Multiple BPJS Control Plan entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($bpjsControlPlans: [BpjsControlPlanInput!]!) {
						bpjsControlPlan: createAllBpjsControlPlan(bpjsControlPlans: $bpjsControlPlans) {
							...BpjsControlPlanProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					bpjsControlPlans: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.bpjsControlPlan as BpjsControlPlanModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: BpjsControlPlanModel, queryParams?: QueryParams): Observable<PassableStateConfig<BpjsControlPlanModel>> {
		...
		const successMessage = 'Updated BPJS Control Plan entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($bpjsControlPlan: BpjsControlPlanInput!, $persistRelations: Boolean) {
						bpjsControlPlan: updateBpjsControlPlan(bpjsControlPlan: $bpjsControlPlan, persistRelations: $persistRelations) {
							...BpjsControlPlanProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: BpjsControlPlanModel[], queryParams?: QueryParams): Observable<PassableStateConfig<BpjsControlPlanModel>> {
		...
		const successMessage = 'Update Multiple BPJS Control Plan entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($bpjsControlPlans: [BpjsControlPlanInput!]!) {
						bpjsControlPlan: updateAllBpjsControlPlan(bpjsControlPlans: $bpjsControlPlans) {
							...BpjsControlPlanProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<BpjsControlPlanModel>> {
		...
		const successMessage = 'Deleted BPJS Control Plan entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($bpjsControlPlanId: ID!) {
						bpjsControlPlanId: deleteBpjsControlPlanById(bpjsControlPlanId: $bpjsControlPlanId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.bpjsControlPlanId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsControlPlanModel>> {
		...
		const successMessage = 'Deleted selected BPJS Control Plan entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($bpjsControlPlanIds: [ID!]!){
						deleteBpjsControlPlanExcludingIds(bpjsControlPlanIds: $bpjsControlPlanIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.bpjsControlPlanIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<BpjsControlPlanModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($bpjsControlPlanIds: [ID!]!) {
						bpjsControlPlanIds: deleteAllBpjsControlPlanByIds(bpjsControlPlanIds: $bpjsControlPlanIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<BpjsControlPlanModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsControlPlanModel>>(
			...
			map(result => {
				let audits: BpjsControlPlanModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new BpjsControlPlanModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<BpjsControlPlanModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<BpjsControlPlanModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($bpjsControlPlanId: ID!) {
						audits: bpjsControlPlanAuditsByEntityId(bpjsControlPlanId: $bpjsControlPlanId) {
							entity {
								...BpjsControlPlanProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<BpjsControlPlanModel>> {
		const url = environment.API_URL + '/api/bpjscontrolplan/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<BpjsControlPlanModel>> {
		const url = environment.API_URL + '/api/bpjscontrolplan/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<BpjsControlPlanModel>> {
		let apiUrl = environment.API_URL + '/api/bpjscontrolplan/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<BpjsControlPlanModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/bpjscontrolplan/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' BPJS Control Plan entities')),
