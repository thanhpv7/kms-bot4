...
import {InternalOrderStockDetailModelAudit} from '../../models/internalOrderStockDetail/internal_order_stock_detail.model.state';
...
/**
 * Internal Order Stock Detail service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class InternalOrderStockDetailService extends AbstractHttpService<InternalOrderStockDetailModel, InternalOrderStockDetailModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the InternalOrderStockDetailProperties classFragment here] off begin
			fragment InternalOrderStockDetailProperties on InternalOrderStockDetail {
				...InternalOrderStockDetailBaseProperties
				itemNumber
			...
			# % protected region % [Modify the InternalOrderStockDetailProperties classFragment here] end
			${super.fragments('InternalOrderStockDetail').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<InternalOrderStockDetailModel>> {
		...
		return  this.apollo.query<PassableStateConfig<InternalOrderStockDetailModel>>(
			{
				query: gql`
					query Count {
						totalCount: countInternalOrderStockDetails
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<InternalOrderStockDetailModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<InternalOrderStockDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<InternalOrderStockDetailModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						InternalOrderStockDetailById: internalOrderStockDetailById(id: $id) {
							...InternalOrderStockDetailProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.InternalOrderStockDetailById as InternalOrderStockDetailModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<InternalOrderStockDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<InternalOrderStockDetailModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						internalOrderStockDetails: internalOrderStockDetails(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...InternalOrderStockDetailProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countInternalOrderStockDetails(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.internalOrderStockDetails as InternalOrderStockDetailModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<InternalOrderStockDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<InternalOrderStockDetailModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						internalOrderStockDetails: lastInternalOrderStockDetails(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...InternalOrderStockDetailProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: InternalOrderStockDetailModel, queryParams?: QueryParams): Observable<PassableStateConfig<InternalOrderStockDetailModel>> {
		...
		const successMessage = 'Created Internal Order Stock Detail entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($internalOrderStockDetail: InternalOrderStockDetailInput!, $persistRelations: Boolean) {
						internalOrderStockDetail: createInternalOrderStockDetail(internalOrderStockDetail: $internalOrderStockDetail, persistRelations: $persistRelations) {
							...InternalOrderStockDetailProperties,
				...
				`,
				variables: {
					internalOrderStockDetail: {
						...entity.toJSON(),
						internalOrder: entity.internalOrder ? new InternalOrderModel(entity.internalOrder).toJSON() : undefined,
			...
			map(result => {
				...
				return {
					targetModel: result.data.internalOrderStockDetail as InternalOrderStockDetailModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: InternalOrderStockDetailModel[], queryParams?: QueryParams): Observable<PassableStateConfig<InternalOrderStockDetailModel>> {
		...
		const successMessage = 'Created Multiple Internal Order Stock Detail entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($internalOrderStockDetails: [InternalOrderStockDetailInput!]!) {
						internalOrderStockDetail: createAllInternalOrderStockDetail(internalOrderStockDetails: $internalOrderStockDetails) {
							...InternalOrderStockDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					internalOrderStockDetails: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.internalOrderStockDetail as InternalOrderStockDetailModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: InternalOrderStockDetailModel, queryParams?: QueryParams): Observable<PassableStateConfig<InternalOrderStockDetailModel>> {
		...
		const successMessage = 'Updated Internal Order Stock Detail entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($internalOrderStockDetail: InternalOrderStockDetailInput!, $persistRelations: Boolean) {
						internalOrderStockDetail: updateInternalOrderStockDetail(internalOrderStockDetail: $internalOrderStockDetail, persistRelations: $persistRelations) {
							...InternalOrderStockDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: InternalOrderStockDetailModel[], queryParams?: QueryParams): Observable<PassableStateConfig<InternalOrderStockDetailModel>> {
		...
		const successMessage = 'Update Multiple Internal Order Stock Detail entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($internalOrderStockDetails: [InternalOrderStockDetailInput!]!) {
						internalOrderStockDetail: updateAllInternalOrderStockDetail(internalOrderStockDetails: $internalOrderStockDetails) {
							...InternalOrderStockDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<InternalOrderStockDetailModel>> {
		...
		const successMessage = 'Deleted Internal Order Stock Detail entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($internalOrderStockDetailId: ID!) {
						internalOrderStockDetailId: deleteInternalOrderStockDetailById(internalOrderStockDetailId: $internalOrderStockDetailId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.internalOrderStockDetailId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<InternalOrderStockDetailModel>> {
		...
		const successMessage = 'Deleted selected Internal Order Stock Detail entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($internalOrderStockDetailIds: [ID!]!){
						deleteInternalOrderStockDetailExcludingIds(internalOrderStockDetailIds: $internalOrderStockDetailIds)
				...
				`,
				variables: {
					internalOrderStockDetailIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.internalOrderStockDetailIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<InternalOrderStockDetailModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($internalOrderStockDetailIds: [ID!]!) {
						internalOrderStockDetailIds: deleteAllInternalOrderStockDetailByIds(internalOrderStockDetailIds: $internalOrderStockDetailIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<InternalOrderStockDetailModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<InternalOrderStockDetailModel>>(
			{
				query: gql`
					query GetAudits {
						audits: internalOrderStockDetailAudits {
							entity {
								...InternalOrderStockDetailProperties
							}
							timestamp
			...
			map(result => {
				let audits: InternalOrderStockDetailModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new InternalOrderStockDetailModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<InternalOrderStockDetailModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<InternalOrderStockDetailModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($internalOrderStockDetailId: ID!) {
						audits: internalOrderStockDetailAuditsByEntityId(internalOrderStockDetailId: $internalOrderStockDetailId) {
							entity {
								...InternalOrderStockDetailProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<InternalOrderStockDetailModel>> {
		const url = environment.API_URL + '/api/internalorderstockdetail/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<InternalOrderStockDetailModel>> {
		const url = environment.API_URL + '/api/internalorderstockdetail/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<InternalOrderStockDetailModel>> {
		let apiUrl = environment.API_URL + '/api/internalorderstockdetail/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<InternalOrderStockDetailModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/internalorderstockdetail/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Internal Order Stock Detail entities')),
