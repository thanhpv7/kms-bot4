...
import {PostOperativeDetailsModel} from '../../models/postOperativeDetails/post_operative_details.model';
import {PostOperativeDetailsModelAudit} from '../../models/postOperativeDetails/post_operative_details.model.state';
...
/**
 * Post Operative Details service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class PostOperativeDetailsService extends AbstractHttpService<PostOperativeDetailsModel, PostOperativeDetailsModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the PostOperativeDetailsProperties classFragment here] off begin
			fragment PostOperativeDetailsProperties on PostOperativeDetails {
				...PostOperativeDetailsBaseProperties
				recoveryStartDateTime
				recoveryEndDateTime
				postoperativeMainDiagnosis
				postoperativeAction
				newCase
				postoperativeDiagnosisSupportOrder
				anesthesiaPostoperativeMonitoring
				anesthesiaPostoperativeAction
			}
			# % protected region % [Modify the PostOperativeDetailsProperties classFragment here] end
			${super.fragments('PostOperativeDetails').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<PostOperativeDetailsModel>> {
		...
		return  this.apollo.query<PassableStateConfig<PostOperativeDetailsModel>>(
			{
				query: gql`
					query Count {
						totalCount: countPostOperativeDetailss
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<PostOperativeDetailsModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<PostOperativeDetailsModel>> {
		...
		return this.apollo.query<PassableStateConfig<PostOperativeDetailsModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						PostOperativeDetailsById: postOperativeDetailsById(id: $id) {
							...PostOperativeDetailsProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.PostOperativeDetailsById as PostOperativeDetailsModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PostOperativeDetailsModel>> {
		...
		return this.apollo.query<PassableStateConfig<PostOperativeDetailsModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						postOperativeDetailss: postOperativeDetailss(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...PostOperativeDetailsProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countPostOperativeDetailss(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.postOperativeDetailss as PostOperativeDetailsModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<PostOperativeDetailsModel>> {
		...
		return this.apollo.query<PassableStateConfig<PostOperativeDetailsModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						postOperativeDetailss: lastPostOperativeDetailss(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...PostOperativeDetailsProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: PostOperativeDetailsModel, queryParams?: QueryParams): Observable<PassableStateConfig<PostOperativeDetailsModel>> {
		...
		const successMessage = 'Created Post Operative Details entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($postOperativeDetails: PostOperativeDetailsInput!, $persistRelations: Boolean) {
						postOperativeDetails: createPostOperativeDetails(postOperativeDetails: $postOperativeDetails, persistRelations: $persistRelations) {
							...PostOperativeDetailsProperties,
				...
				variables: {
					postOperativeDetails: {
						...
						postOperativeICD10: entity.postOperativeICD10 ? new DiagnosesAndProceduresModel(entity.postOperativeICD10).toJSON() : undefined,
						postOperativeICD9CM: entity.postOperativeICD9CM ? new DiagnosesAndProceduresModel(entity.postOperativeICD9CM).toJSON() : undefined,
						recoveryRooms: entity.recoveryRooms ? new RoomFacilityModel(entity.recoveryRooms).toJSON() : undefined,
			...
			map(result => {
				...
				return {
					targetModel: result.data.postOperativeDetails as PostOperativeDetailsModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: PostOperativeDetailsModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PostOperativeDetailsModel>> {
		...
		const successMessage = 'Created Multiple Post Operative Details entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($postOperativeDetailss: [PostOperativeDetailsInput!]!) {
						postOperativeDetails: createAllPostOperativeDetails(postOperativeDetailss: $postOperativeDetailss) {
							...PostOperativeDetailsProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					postOperativeDetailss: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.postOperativeDetails as PostOperativeDetailsModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: PostOperativeDetailsModel, queryParams?: QueryParams): Observable<PassableStateConfig<PostOperativeDetailsModel>> {
		...
		const successMessage = 'Updated Post Operative Details entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($postOperativeDetails: PostOperativeDetailsInput!, $persistRelations: Boolean) {
						postOperativeDetails: updatePostOperativeDetails(postOperativeDetails: $postOperativeDetails, persistRelations: $persistRelations) {
							...PostOperativeDetailsProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: PostOperativeDetailsModel[], queryParams?: QueryParams): Observable<PassableStateConfig<PostOperativeDetailsModel>> {
		...
		const successMessage = 'Update Multiple Post Operative Details entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($postOperativeDetailss: [PostOperativeDetailsInput!]!) {
						postOperativeDetails: updateAllPostOperativeDetails(postOperativeDetailss: $postOperativeDetailss) {
							...PostOperativeDetailsProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<PostOperativeDetailsModel>> {
		...
		const successMessage = 'Deleted Post Operative Details entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($postOperativeDetailsId: ID!) {
						postOperativeDetailsId: deletePostOperativeDetailsById(postOperativeDetailsId: $postOperativeDetailsId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.postOperativeDetailsId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<PostOperativeDetailsModel>> {
		...
		const successMessage = 'Deleted selected Post Operative Details entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($postOperativeDetailsIds: [ID!]!){
						deletePostOperativeDetailsExcludingIds(postOperativeDetailsIds: $postOperativeDetailsIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.postOperativeDetailsIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<PostOperativeDetailsModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($postOperativeDetailsIds: [ID!]!) {
						postOperativeDetailsIds: deleteAllPostOperativeDetailsByIds(postOperativeDetailsIds: $postOperativeDetailsIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<PostOperativeDetailsModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PostOperativeDetailsModel>>(
			{
				query: gql`
					query GetAudits {
						audits: postOperativeDetailsAudits {
							entity {
								...PostOperativeDetailsProperties
							}
							timestamp
			...
			map(result => {
				let audits: PostOperativeDetailsModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new PostOperativeDetailsModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<PostOperativeDetailsModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<PostOperativeDetailsModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($postOperativeDetailsId: ID!) {
						audits: postOperativeDetailsAuditsByEntityId(postOperativeDetailsId: $postOperativeDetailsId) {
							entity {
								...PostOperativeDetailsProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<PostOperativeDetailsModel>> {
		const url = environment.API_URL + '/api/postoperativedetails/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<PostOperativeDetailsModel>> {
		const url = environment.API_URL + '/api/postoperativedetails/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<PostOperativeDetailsModel>> {
		let apiUrl = environment.API_URL + '/api/postoperativedetails/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<PostOperativeDetailsModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/postoperativedetails/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Post Operative Details entities')),
