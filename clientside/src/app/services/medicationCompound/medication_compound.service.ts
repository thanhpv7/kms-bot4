...
import {MedicationCompoundModelAudit} from '../../models/medicationCompound/medication_compound.model.state';
...
/**
 * Medication Compound service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class MedicationCompoundService extends AbstractHttpService<MedicationCompoundModel, MedicationCompoundModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the MedicationCompoundProperties classFragment here] off begin
			fragment MedicationCompoundProperties on MedicationCompound {
				...MedicationCompoundBaseProperties
				compoundCode
				compoundName
				requestedQty
				outstandingQty
			...
			# % protected region % [Modify the MedicationCompoundProperties classFragment here] end
			${super.fragments('MedicationCompound').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<MedicationCompoundModel>> {
		...
		return  this.apollo.query<PassableStateConfig<MedicationCompoundModel>>(
			{
				query: gql`
					query Count {
						totalCount: countMedicationCompounds
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<MedicationCompoundModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<MedicationCompoundModel>> {
		...
		return this.apollo.query<PassableStateConfig<MedicationCompoundModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						MedicationCompoundById: medicationCompoundById(id: $id) {
							...MedicationCompoundProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.MedicationCompoundById as MedicationCompoundModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<MedicationCompoundModel>> {
		...
		return this.apollo.query<PassableStateConfig<MedicationCompoundModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						medicationCompounds: medicationCompounds(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...MedicationCompoundProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countMedicationCompounds(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.medicationCompounds as MedicationCompoundModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<MedicationCompoundModel>> {
		...
		return this.apollo.query<PassableStateConfig<MedicationCompoundModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						medicationCompounds: lastMedicationCompounds(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...MedicationCompoundProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: MedicationCompoundModel, queryParams?: QueryParams): Observable<PassableStateConfig<MedicationCompoundModel>> {
		...
		const successMessage = 'Created Medication Compound entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($medicationCompound: MedicationCompoundInput!, $persistRelations: Boolean) {
						medicationCompound: createMedicationCompound(medicationCompound: $medicationCompound, persistRelations: $persistRelations) {
							...MedicationCompoundProperties,
				...
				variables: {
					medicationCompound: {
						...entity.toJSON(),
						medicationHeader: entity.medicationHeader ? new MedicationHeaderModel(entity.medicationHeader).toJSON() : undefined,
						unitOfMeasurement: entity.unitOfMeasurement ? new UnitOfMeasurementModel(entity.unitOfMeasurement).toJSON() : undefined,
						medicationAdministeredHistories: entity.medicationAdministeredHistories ? entity.medicationAdministeredHistories?.map((model: MedicationAdministeredHistoryModel) => new MedicationAdministeredHistoryModel(model).toJSON()) : [],
			...
			map(result => {
				...
				return {
					targetModel: result.data.medicationCompound as MedicationCompoundModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: MedicationCompoundModel[], queryParams?: QueryParams): Observable<PassableStateConfig<MedicationCompoundModel>> {
		...
		const successMessage = 'Created Multiple Medication Compound entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($medicationCompounds: [MedicationCompoundInput!]!) {
						medicationCompound: createAllMedicationCompound(medicationCompounds: $medicationCompounds) {
							...MedicationCompoundProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					medicationCompounds: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.medicationCompound as MedicationCompoundModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: MedicationCompoundModel, queryParams?: QueryParams): Observable<PassableStateConfig<MedicationCompoundModel>> {
		...
		const successMessage = 'Updated Medication Compound entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($medicationCompound: MedicationCompoundInput!, $persistRelations: Boolean) {
						medicationCompound: updateMedicationCompound(medicationCompound: $medicationCompound, persistRelations: $persistRelations) {
							...MedicationCompoundProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: MedicationCompoundModel[], queryParams?: QueryParams): Observable<PassableStateConfig<MedicationCompoundModel>> {
		...
		const successMessage = 'Update Multiple Medication Compound entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($medicationCompounds: [MedicationCompoundInput!]!) {
						medicationCompound: updateAllMedicationCompound(medicationCompounds: $medicationCompounds) {
							...MedicationCompoundProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<MedicationCompoundModel>> {
		...
		const successMessage = 'Deleted Medication Compound entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($medicationCompoundId: ID!) {
						medicationCompoundId: deleteMedicationCompoundById(medicationCompoundId: $medicationCompoundId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.medicationCompoundId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<MedicationCompoundModel>> {
		...
		const successMessage = 'Deleted selected Medication Compound entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($medicationCompoundIds: [ID!]!){
						deleteMedicationCompoundExcludingIds(medicationCompoundIds: $medicationCompoundIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.medicationCompoundIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<MedicationCompoundModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($medicationCompoundIds: [ID!]!) {
						medicationCompoundIds: deleteAllMedicationCompoundByIds(medicationCompoundIds: $medicationCompoundIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<MedicationCompoundModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<MedicationCompoundModel>>(
			{
				query: gql`
					query GetAudits {
						audits: medicationCompoundAudits {
							entity {
								...MedicationCompoundProperties
							}
							timestamp
			...
			map(result => {
				let audits: MedicationCompoundModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new MedicationCompoundModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<MedicationCompoundModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<MedicationCompoundModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($medicationCompoundId: ID!) {
						audits: medicationCompoundAuditsByEntityId(medicationCompoundId: $medicationCompoundId) {
							entity {
								...MedicationCompoundProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<MedicationCompoundModel>> {
		const url = environment.API_URL + '/api/medicationcompound/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<MedicationCompoundModel>> {
		const url = environment.API_URL + '/api/medicationcompound/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<MedicationCompoundModel>> {
		let apiUrl = environment.API_URL + '/api/medicationcompound/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<MedicationCompoundModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/medicationcompound/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Medication Compound entities')),
