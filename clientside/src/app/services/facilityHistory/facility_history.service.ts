...
import {FacilityHistoryModel} from '../../models/facilityHistory/facility_history.model';
import {FacilityHistoryModelAudit} from '../../models/facilityHistory/facility_history.model.state';
...
/**
 * Facility History service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class FacilityHistoryService extends AbstractHttpService<FacilityHistoryModel, FacilityHistoryModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the FacilityHistoryProperties classFragment here] off begin
			fragment FacilityHistoryProperties on FacilityHistory {
				...FacilityHistoryBaseProperties
				changeDate
				facilityNo
				currentQty
				changedQty
			...
			# % protected region % [Modify the FacilityHistoryProperties classFragment here] end
			${super.fragments('FacilityHistory').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<FacilityHistoryModel>> {
		...
		return  this.apollo.query<PassableStateConfig<FacilityHistoryModel>>(
			{
				query: gql`
					query Count {
						totalCount: countFacilityHistorys
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<FacilityHistoryModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<FacilityHistoryModel>> {
		...
		return this.apollo.query<PassableStateConfig<FacilityHistoryModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						FacilityHistoryById: facilityHistoryById(id: $id) {
							...FacilityHistoryProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.FacilityHistoryById as FacilityHistoryModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<FacilityHistoryModel>> {
		...
		return this.apollo.query<PassableStateConfig<FacilityHistoryModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						facilityHistorys: facilityHistorys(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...FacilityHistoryProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countFacilityHistorys(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.facilityHistorys as FacilityHistoryModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<FacilityHistoryModel>> {
		...
		return this.apollo.query<PassableStateConfig<FacilityHistoryModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						facilityHistorys: lastFacilityHistorys(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...FacilityHistoryProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: FacilityHistoryModel, queryParams?: QueryParams): Observable<PassableStateConfig<FacilityHistoryModel>> {
		...
		const successMessage = 'Created Facility History entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($facilityHistory: FacilityHistoryInput!, $persistRelations: Boolean) {
						facilityHistory: createFacilityHistory(facilityHistory: $facilityHistory, persistRelations: $persistRelations) {
							...FacilityHistoryProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.facilityHistory as FacilityHistoryModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: FacilityHistoryModel[], queryParams?: QueryParams): Observable<PassableStateConfig<FacilityHistoryModel>> {
		...
		const successMessage = 'Created Multiple Facility History entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($facilityHistorys: [FacilityHistoryInput!]!) {
						facilityHistory: createAllFacilityHistory(facilityHistorys: $facilityHistorys) {
							...FacilityHistoryProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					facilityHistorys: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.facilityHistory as FacilityHistoryModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: FacilityHistoryModel, queryParams?: QueryParams): Observable<PassableStateConfig<FacilityHistoryModel>> {
		...
		const successMessage = 'Updated Facility History entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($facilityHistory: FacilityHistoryInput!, $persistRelations: Boolean) {
						facilityHistory: updateFacilityHistory(facilityHistory: $facilityHistory, persistRelations: $persistRelations) {
							...FacilityHistoryProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: FacilityHistoryModel[], queryParams?: QueryParams): Observable<PassableStateConfig<FacilityHistoryModel>> {
		...
		const successMessage = 'Update Multiple Facility History entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($facilityHistorys: [FacilityHistoryInput!]!) {
						facilityHistory: updateAllFacilityHistory(facilityHistorys: $facilityHistorys) {
							...FacilityHistoryProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<FacilityHistoryModel>> {
		...
		const successMessage = 'Deleted Facility History entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($facilityHistoryId: ID!) {
						facilityHistoryId: deleteFacilityHistoryById(facilityHistoryId: $facilityHistoryId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.facilityHistoryId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<FacilityHistoryModel>> {
		...
		const successMessage = 'Deleted selected Facility History entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($facilityHistoryIds: [ID!]!){
						deleteFacilityHistoryExcludingIds(facilityHistoryIds: $facilityHistoryIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.facilityHistoryIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<FacilityHistoryModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($facilityHistoryIds: [ID!]!) {
						facilityHistoryIds: deleteAllFacilityHistoryByIds(facilityHistoryIds: $facilityHistoryIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<FacilityHistoryModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<FacilityHistoryModel>>(
			...
			map(result => {
				let audits: FacilityHistoryModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new FacilityHistoryModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<FacilityHistoryModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<FacilityHistoryModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($facilityHistoryId: ID!) {
						audits: facilityHistoryAuditsByEntityId(facilityHistoryId: $facilityHistoryId) {
							entity {
								...FacilityHistoryProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<FacilityHistoryModel>> {
		const url = environment.API_URL + '/api/facilityhistory/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<FacilityHistoryModel>> {
		const url = environment.API_URL + '/api/facilityhistory/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<FacilityHistoryModel>> {
		let apiUrl = environment.API_URL + '/api/facilityhistory/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<FacilityHistoryModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/facilityhistory/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Facility History entities')),
