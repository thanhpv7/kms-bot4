...
import {InvoiceSummaryModel} from '../../models/invoiceSummary/invoice_summary.model';
import {InvoiceSummaryModelAudit} from '../../models/invoiceSummary/invoice_summary.model.state';
...
/**
 * Invoice Summary service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class InvoiceSummaryService extends AbstractHttpService<InvoiceSummaryModel, InvoiceSummaryModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the InvoiceSummaryProperties classFragment here] off begin
			fragment InvoiceSummaryProperties on InvoiceSummary {
				...InvoiceSummaryBaseProperties
				subTotal
				taxOnOtherDiscount
				otherDiscount
				taxOnOtherFee
			...
			# % protected region % [Modify the InvoiceSummaryProperties classFragment here] end
			${super.fragments('InvoiceSummary').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<InvoiceSummaryModel>> {
		...
		return  this.apollo.query<PassableStateConfig<InvoiceSummaryModel>>(
			{
				query: gql`
					query Count {
						totalCount: countInvoiceSummarys
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<InvoiceSummaryModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<InvoiceSummaryModel>> {
		...
		return this.apollo.query<PassableStateConfig<InvoiceSummaryModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						InvoiceSummaryById: invoiceSummaryById(id: $id) {
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.InvoiceSummaryById as InvoiceSummaryModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<InvoiceSummaryModel>> {
		...
		return this.apollo.query<PassableStateConfig<InvoiceSummaryModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						invoiceSummarys: invoiceSummarys(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...InvoiceSummaryProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countInvoiceSummarys(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.invoiceSummarys as InvoiceSummaryModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<InvoiceSummaryModel>> {
		...
		return this.apollo.query<PassableStateConfig<InvoiceSummaryModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						invoiceSummarys: lastInvoiceSummarys(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...InvoiceSummaryProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: InvoiceSummaryModel, queryParams?: QueryParams): Observable<PassableStateConfig<InvoiceSummaryModel>> {
		...
		const successMessage = 'Created Invoice Summary entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($invoiceSummary: InvoiceSummaryInput!, $persistRelations: Boolean) {
						invoiceSummary: createInvoiceSummary(invoiceSummary: $invoiceSummary, persistRelations: $persistRelations) {
							...InvoiceSummaryProperties,
				...
				variables: {
					invoiceSummary: {
						...
						retailPharmacyInvoice: entity.retailPharmacyInvoice ? new RetailPharmacyInvoiceModel(entity.retailPharmacyInvoice).toJSON() : undefined,
					},
			...
			map(result => {
				...
				return {
					targetModel: result.data.invoiceSummary as InvoiceSummaryModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: InvoiceSummaryModel[], queryParams?: QueryParams): Observable<PassableStateConfig<InvoiceSummaryModel>> {
		...
		const successMessage = 'Created Multiple Invoice Summary entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($invoiceSummarys: [InvoiceSummaryInput!]!) {
						invoiceSummary: createAllInvoiceSummary(invoiceSummarys: $invoiceSummarys) {
							...InvoiceSummaryProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					invoiceSummarys: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.invoiceSummary as InvoiceSummaryModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: InvoiceSummaryModel, queryParams?: QueryParams): Observable<PassableStateConfig<InvoiceSummaryModel>> {
		...
		const successMessage = 'Updated Invoice Summary entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($invoiceSummary: InvoiceSummaryInput!, $persistRelations: Boolean) {
						invoiceSummary: updateInvoiceSummary(invoiceSummary: $invoiceSummary, persistRelations: $persistRelations) {
							...InvoiceSummaryProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: InvoiceSummaryModel[], queryParams?: QueryParams): Observable<PassableStateConfig<InvoiceSummaryModel>> {
		...
		const successMessage = 'Update Multiple Invoice Summary entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($invoiceSummarys: [InvoiceSummaryInput!]!) {
						invoiceSummary: updateAllInvoiceSummary(invoiceSummarys: $invoiceSummarys) {
							...InvoiceSummaryProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<InvoiceSummaryModel>> {
		...
		const successMessage = 'Deleted Invoice Summary entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($invoiceSummaryId: ID!) {
						invoiceSummaryId: deleteInvoiceSummaryById(invoiceSummaryId: $invoiceSummaryId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.invoiceSummaryId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<InvoiceSummaryModel>> {
		...
		const successMessage = 'Deleted selected Invoice Summary entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($invoiceSummaryIds: [ID!]!){
						deleteInvoiceSummaryExcludingIds(invoiceSummaryIds: $invoiceSummaryIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.invoiceSummaryIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<InvoiceSummaryModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($invoiceSummaryIds: [ID!]!) {
						invoiceSummaryIds: deleteAllInvoiceSummaryByIds(invoiceSummaryIds: $invoiceSummaryIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<InvoiceSummaryModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<InvoiceSummaryModel>>(
			...
			map(result => {
				let audits: InvoiceSummaryModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new InvoiceSummaryModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<InvoiceSummaryModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<InvoiceSummaryModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($invoiceSummaryId: ID!) {
						audits: invoiceSummaryAuditsByEntityId(invoiceSummaryId: $invoiceSummaryId) {
							entity {
								...InvoiceSummaryProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<InvoiceSummaryModel>> {
		const url = environment.API_URL + '/api/invoicesummary/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<InvoiceSummaryModel>> {
		const url = environment.API_URL + '/api/invoicesummary/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<InvoiceSummaryModel>> {
		let apiUrl = environment.API_URL + '/api/invoicesummary/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<InvoiceSummaryModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/invoicesummary/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Invoice Summary entities')),
