...
import {SupplierContactDetailModelAudit} from '../../models/supplierContactDetail/supplier_contact_detail.model.state';
...
/**
 * Supplier Contact Detail service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class SupplierContactDetailService extends AbstractHttpService<SupplierContactDetailModel, SupplierContactDetailModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the SupplierContactDetailProperties classFragment here] off begin
			fragment SupplierContactDetailProperties on SupplierContactDetail {
				...SupplierContactDetailBaseProperties
				name
				position
				phoneNumber
				mobilePhoneNumber
			...
			# % protected region % [Modify the SupplierContactDetailProperties classFragment here] end
			${super.fragments('SupplierContactDetail').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<SupplierContactDetailModel>> {
		...
		return  this.apollo.query<PassableStateConfig<SupplierContactDetailModel>>(
			{
				query: gql`
					query Count {
						totalCount: countSupplierContactDetails
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<SupplierContactDetailModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<SupplierContactDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<SupplierContactDetailModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						SupplierContactDetailById: supplierContactDetailById(id: $id) {
							...SupplierContactDetailProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.SupplierContactDetailById as SupplierContactDetailModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<SupplierContactDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<SupplierContactDetailModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						supplierContactDetails: supplierContactDetails(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...SupplierContactDetailProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countSupplierContactDetails(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.supplierContactDetails as SupplierContactDetailModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<SupplierContactDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<SupplierContactDetailModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						supplierContactDetails: lastSupplierContactDetails(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...SupplierContactDetailProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: SupplierContactDetailModel, queryParams?: QueryParams): Observable<PassableStateConfig<SupplierContactDetailModel>> {
		...
		const successMessage = 'Created Supplier Contact Detail entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($supplierContactDetail: SupplierContactDetailInput!, $persistRelations: Boolean) {
						supplierContactDetail: createSupplierContactDetail(supplierContactDetail: $supplierContactDetail, persistRelations: $persistRelations) {
							...SupplierContactDetailProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.supplierContactDetail as SupplierContactDetailModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: SupplierContactDetailModel[], queryParams?: QueryParams): Observable<PassableStateConfig<SupplierContactDetailModel>> {
		...
		const successMessage = 'Created Multiple Supplier Contact Detail entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($supplierContactDetails: [SupplierContactDetailInput!]!) {
						supplierContactDetail: createAllSupplierContactDetail(supplierContactDetails: $supplierContactDetails) {
							...SupplierContactDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					supplierContactDetails: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.supplierContactDetail as SupplierContactDetailModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: SupplierContactDetailModel, queryParams?: QueryParams): Observable<PassableStateConfig<SupplierContactDetailModel>> {
		...
		const successMessage = 'Updated Supplier Contact Detail entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($supplierContactDetail: SupplierContactDetailInput!, $persistRelations: Boolean) {
						supplierContactDetail: updateSupplierContactDetail(supplierContactDetail: $supplierContactDetail, persistRelations: $persistRelations) {
							...SupplierContactDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: SupplierContactDetailModel[], queryParams?: QueryParams): Observable<PassableStateConfig<SupplierContactDetailModel>> {
		...
		const successMessage = 'Update Multiple Supplier Contact Detail entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($supplierContactDetails: [SupplierContactDetailInput!]!) {
						supplierContactDetail: updateAllSupplierContactDetail(supplierContactDetails: $supplierContactDetails) {
							...SupplierContactDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<SupplierContactDetailModel>> {
		...
		const successMessage = 'Deleted Supplier Contact Detail entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($supplierContactDetailId: ID!) {
						supplierContactDetailId: deleteSupplierContactDetailById(supplierContactDetailId: $supplierContactDetailId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.supplierContactDetailId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<SupplierContactDetailModel>> {
		...
		const successMessage = 'Deleted selected Supplier Contact Detail entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($supplierContactDetailIds: [ID!]!){
						deleteSupplierContactDetailExcludingIds(supplierContactDetailIds: $supplierContactDetailIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.supplierContactDetailIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<SupplierContactDetailModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($supplierContactDetailIds: [ID!]!) {
						supplierContactDetailIds: deleteAllSupplierContactDetailByIds(supplierContactDetailIds: $supplierContactDetailIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<SupplierContactDetailModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<SupplierContactDetailModel>>(
			{
				query: gql`
					query GetAudits {
						audits: supplierContactDetailAudits {
							entity {
								...SupplierContactDetailProperties
							}
							timestamp
			...
			map(result => {
				let audits: SupplierContactDetailModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new SupplierContactDetailModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<SupplierContactDetailModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<SupplierContactDetailModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($supplierContactDetailId: ID!) {
						audits: supplierContactDetailAuditsByEntityId(supplierContactDetailId: $supplierContactDetailId) {
							entity {
								...SupplierContactDetailProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<SupplierContactDetailModel>> {
		const url = environment.API_URL + '/api/suppliercontactdetail/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<SupplierContactDetailModel>> {
		const url = environment.API_URL + '/api/suppliercontactdetail/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<SupplierContactDetailModel>> {
		let apiUrl = environment.API_URL + '/api/suppliercontactdetail/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<SupplierContactDetailModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/suppliercontactdetail/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Supplier Contact Detail entities')),
