...
import {SupplierProductDetailModel} from '../../models/supplierProductDetail/supplier_product_detail.model';
import {SupplierProductDetailModelAudit} from '../../models/supplierProductDetail/supplier_product_detail.model.state';
...
/**
 * Supplier Product Detail service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class SupplierProductDetailService extends AbstractHttpService<SupplierProductDetailModel, SupplierProductDetailModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the SupplierProductDetailProperties classFragment here] off begin
			fragment SupplierProductDetailProperties on SupplierProductDetail {
				...SupplierProductDetailBaseProperties
				unitCode
				unitName
				price
				discount
			}
			# % protected region % [Modify the SupplierProductDetailProperties classFragment here] end
			${super.fragments('SupplierProductDetail').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<SupplierProductDetailModel>> {
		...
		return  this.apollo.query<PassableStateConfig<SupplierProductDetailModel>>(
			{
				query: gql`
					query Count {
						totalCount: countSupplierProductDetails
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<SupplierProductDetailModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<SupplierProductDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<SupplierProductDetailModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						SupplierProductDetailById: supplierProductDetailById(id: $id) {
							...SupplierProductDetailProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.SupplierProductDetailById as SupplierProductDetailModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<SupplierProductDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<SupplierProductDetailModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						supplierProductDetails: supplierProductDetails(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...SupplierProductDetailProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countSupplierProductDetails(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.supplierProductDetails as SupplierProductDetailModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<SupplierProductDetailModel>> {
		...
		return this.apollo.query<PassableStateConfig<SupplierProductDetailModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						supplierProductDetails: lastSupplierProductDetails(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...SupplierProductDetailProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: SupplierProductDetailModel, queryParams?: QueryParams): Observable<PassableStateConfig<SupplierProductDetailModel>> {
		...
		const successMessage = 'Created Supplier Product Detail entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($supplierProductDetail: SupplierProductDetailInput!, $persistRelations: Boolean) {
						supplierProductDetail: createSupplierProductDetail(supplierProductDetail: $supplierProductDetail, persistRelations: $persistRelations) {
							...SupplierProductDetailProperties,
				...
				variables: {
					supplierProductDetail: {
						...
						supplier: entity.supplier ? new SupplierModel(entity.supplier).toJSON() : undefined,
					},
			...
			map(result => {
				...
				return {
					targetModel: result.data.supplierProductDetail as SupplierProductDetailModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: SupplierProductDetailModel[], queryParams?: QueryParams): Observable<PassableStateConfig<SupplierProductDetailModel>> {
		...
		const successMessage = 'Created Multiple Supplier Product Detail entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($supplierProductDetails: [SupplierProductDetailInput!]!) {
						supplierProductDetail: createAllSupplierProductDetail(supplierProductDetails: $supplierProductDetails) {
							...SupplierProductDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					supplierProductDetails: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.supplierProductDetail as SupplierProductDetailModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: SupplierProductDetailModel, queryParams?: QueryParams): Observable<PassableStateConfig<SupplierProductDetailModel>> {
		...
		const successMessage = 'Updated Supplier Product Detail entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($supplierProductDetail: SupplierProductDetailInput!, $persistRelations: Boolean) {
						supplierProductDetail: updateSupplierProductDetail(supplierProductDetail: $supplierProductDetail, persistRelations: $persistRelations) {
							...SupplierProductDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: SupplierProductDetailModel[], queryParams?: QueryParams): Observable<PassableStateConfig<SupplierProductDetailModel>> {
		...
		const successMessage = 'Update Multiple Supplier Product Detail entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($supplierProductDetails: [SupplierProductDetailInput!]!) {
						supplierProductDetail: updateAllSupplierProductDetail(supplierProductDetails: $supplierProductDetails) {
							...SupplierProductDetailProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<SupplierProductDetailModel>> {
		...
		const successMessage = 'Deleted Supplier Product Detail entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($supplierProductDetailId: ID!) {
						supplierProductDetailId: deleteSupplierProductDetailById(supplierProductDetailId: $supplierProductDetailId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.supplierProductDetailId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<SupplierProductDetailModel>> {
		...
		const successMessage = 'Deleted selected Supplier Product Detail entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($supplierProductDetailIds: [ID!]!){
						deleteSupplierProductDetailExcludingIds(supplierProductDetailIds: $supplierProductDetailIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.supplierProductDetailIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<SupplierProductDetailModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($supplierProductDetailIds: [ID!]!) {
						supplierProductDetailIds: deleteAllSupplierProductDetailByIds(supplierProductDetailIds: $supplierProductDetailIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<SupplierProductDetailModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<SupplierProductDetailModel>>(
			{
				query: gql`
					query GetAudits {
						audits: supplierProductDetailAudits {
							entity {
								...SupplierProductDetailProperties
							}
							timestamp
			...
			map(result => {
				let audits: SupplierProductDetailModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new SupplierProductDetailModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<SupplierProductDetailModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<SupplierProductDetailModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($supplierProductDetailId: ID!) {
						audits: supplierProductDetailAuditsByEntityId(supplierProductDetailId: $supplierProductDetailId) {
							entity {
								...SupplierProductDetailProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<SupplierProductDetailModel>> {
		const url = environment.API_URL + '/api/supplierproductdetail/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<SupplierProductDetailModel>> {
		const url = environment.API_URL + '/api/supplierproductdetail/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<SupplierProductDetailModel>> {
		let apiUrl = environment.API_URL + '/api/supplierproductdetail/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<SupplierProductDetailModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/supplierproductdetail/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Supplier Product Detail entities')),
