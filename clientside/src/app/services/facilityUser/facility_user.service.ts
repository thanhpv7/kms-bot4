...
import {FacilityUserModel} from '../../models/facilityUser/facility_user.model';
import {FacilityUserModelAudit} from '../../models/facilityUser/facility_user.model.state';
...
/**
 * Facility User service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class FacilityUserService extends UserService<FacilityUserModel, FacilityUserModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the FacilityUserProperties classFragment here] off begin
			fragment FacilityUserProperties on FacilityUser {
				...FacilityUserUserProperties
			}
			# % protected region % [Modify the FacilityUserProperties classFragment here] end
			${super.fragments('FacilityUser').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<FacilityUserModel>> {
		...
		return  this.apollo.query<PassableStateConfig<FacilityUserModel>>(
			{
				query: gql`
					query Count {
						totalCount: countFacilityUsers
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<FacilityUserModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<FacilityUserModel>> {
		...
		return this.apollo.query<PassableStateConfig<FacilityUserModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						FacilityUserById: facilityUserById(id: $id) {
							...FacilityUserProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.FacilityUserById as FacilityUserModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<FacilityUserModel>> {
		...
		return this.apollo.query<PassableStateConfig<FacilityUserModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						facilityUsers: facilityUsers(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...FacilityUserProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countFacilityUsers(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.facilityUsers as FacilityUserModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<FacilityUserModel>> {
		...
		return this.apollo.query<PassableStateConfig<FacilityUserModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						facilityUsers: lastFacilityUsers(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...FacilityUserProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: FacilityUserModel, queryParams?: QueryParams): Observable<PassableStateConfig<FacilityUserModel>> {
		...
		const successMessage = 'Created Facility User entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($facilityUser: FacilityUserInput!, $persistRelations: Boolean) {
						facilityUser: createFacilityUser(facilityUser: $facilityUser, persistRelations: $persistRelations) {
							...FacilityUserProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.facilityUser as FacilityUserModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: FacilityUserModel[], queryParams?: QueryParams): Observable<PassableStateConfig<FacilityUserModel>> {
		...
		const successMessage = 'Created Multiple Facility User entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($facilityUsers: [FacilityUserInput!]!) {
						facilityUser: createAllFacilityUser(facilityUsers: $facilityUsers) {
							...FacilityUserProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					facilityUsers: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.facilityUser as FacilityUserModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: FacilityUserModel, queryParams?: QueryParams): Observable<PassableStateConfig<FacilityUserModel>> {
		...
		const successMessage = 'Updated Facility User entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($facilityUser: FacilityUserInput!, $persistRelations: Boolean) {
						facilityUser: updateFacilityUser(facilityUser: $facilityUser, persistRelations: $persistRelations) {
							...FacilityUserProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: FacilityUserModel[], queryParams?: QueryParams): Observable<PassableStateConfig<FacilityUserModel>> {
		...
		const successMessage = 'Update Multiple Facility User entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($facilityUsers: [FacilityUserInput!]!) {
						facilityUser: updateAllFacilityUser(facilityUsers: $facilityUsers) {
							...FacilityUserProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<FacilityUserModel>> {
		...
		const successMessage = 'Deleted Facility User entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($facilityUserId: ID!) {
						facilityUserId: deleteFacilityUserById(facilityUserId: $facilityUserId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.facilityUserId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<FacilityUserModel>> {
		...
		const successMessage = 'Deleted selected Facility User entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($facilityUserIds: [ID!]!){
						deleteFacilityUserExcludingIds(facilityUserIds: $facilityUserIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.facilityUserIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<FacilityUserModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($facilityUserIds: [ID!]!) {
						facilityUserIds: deleteAllFacilityUserByIds(facilityUserIds: $facilityUserIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<FacilityUserModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<FacilityUserModel>>(
			...
			map(result => {
				let audits: FacilityUserModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new FacilityUserModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<FacilityUserModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<FacilityUserModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($facilityUserId: ID!) {
						audits: facilityUserAuditsByEntityId(facilityUserId: $facilityUserId) {
							entity {
								...FacilityUserProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<FacilityUserModel>> {
		const url = environment.API_URL + '/api/facilityuser/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<FacilityUserModel>> {
		const url = environment.API_URL + '/api/facilityuser/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<FacilityUserModel>> {
		let apiUrl = environment.API_URL + '/api/facilityuser/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<FacilityUserModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/facilityuser/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Facility User entities')),
