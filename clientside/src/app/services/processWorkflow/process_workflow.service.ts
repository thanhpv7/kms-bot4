...
import {ProcessWorkflowModel} from '../../models/processWorkflow/process_workflow.model';
import {ProcessWorkflowModelAudit} from '../../models/processWorkflow/process_workflow.model.state';
...
/**
 * Process Workflow service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class ProcessWorkflowService extends AbstractHttpService<ProcessWorkflowModel, ProcessWorkflowModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the ProcessWorkflowProperties classFragment here] off begin
			fragment ProcessWorkflowProperties on ProcessWorkflow {
				...ProcessWorkflowBaseProperties
				stepNumber
				moduleName
				processName
				referenceID
			...
			# % protected region % [Modify the ProcessWorkflowProperties classFragment here] end
			${super.fragments('ProcessWorkflow').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<ProcessWorkflowModel>> {
		...
		return  this.apollo.query<PassableStateConfig<ProcessWorkflowModel>>(
			{
				query: gql`
					query Count {
						totalCount: countProcessWorkflows
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<ProcessWorkflowModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<ProcessWorkflowModel>> {
		...
		return this.apollo.query<PassableStateConfig<ProcessWorkflowModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						ProcessWorkflowById: processWorkflowById(id: $id) {
							...ProcessWorkflowProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.ProcessWorkflowById as ProcessWorkflowModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<ProcessWorkflowModel>> {
		...
		return this.apollo.query<PassableStateConfig<ProcessWorkflowModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						processWorkflows: processWorkflows(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...ProcessWorkflowProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countProcessWorkflows(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.processWorkflows as ProcessWorkflowModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<ProcessWorkflowModel>> {
		...
		return this.apollo.query<PassableStateConfig<ProcessWorkflowModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						processWorkflows: lastProcessWorkflows(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...ProcessWorkflowProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: ProcessWorkflowModel, queryParams?: QueryParams): Observable<PassableStateConfig<ProcessWorkflowModel>> {
		...
		const successMessage = 'Created Process Workflow entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($processWorkflow: ProcessWorkflowInput!, $persistRelations: Boolean) {
						processWorkflow: createProcessWorkflow(processWorkflow: $processWorkflow, persistRelations: $persistRelations) {
							...ProcessWorkflowProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.processWorkflow as ProcessWorkflowModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: ProcessWorkflowModel[], queryParams?: QueryParams): Observable<PassableStateConfig<ProcessWorkflowModel>> {
		...
		const successMessage = 'Created Multiple Process Workflow entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($processWorkflows: [ProcessWorkflowInput!]!) {
						processWorkflow: createAllProcessWorkflow(processWorkflows: $processWorkflows) {
							...ProcessWorkflowProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					processWorkflows: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.processWorkflow as ProcessWorkflowModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: ProcessWorkflowModel, queryParams?: QueryParams): Observable<PassableStateConfig<ProcessWorkflowModel>> {
		...
		const successMessage = 'Updated Process Workflow entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($processWorkflow: ProcessWorkflowInput!, $persistRelations: Boolean) {
						processWorkflow: updateProcessWorkflow(processWorkflow: $processWorkflow, persistRelations: $persistRelations) {
							...ProcessWorkflowProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: ProcessWorkflowModel[], queryParams?: QueryParams): Observable<PassableStateConfig<ProcessWorkflowModel>> {
		...
		const successMessage = 'Update Multiple Process Workflow entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($processWorkflows: [ProcessWorkflowInput!]!) {
						processWorkflow: updateAllProcessWorkflow(processWorkflows: $processWorkflows) {
							...ProcessWorkflowProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<ProcessWorkflowModel>> {
		...
		const successMessage = 'Deleted Process Workflow entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($processWorkflowId: ID!) {
						processWorkflowId: deleteProcessWorkflowById(processWorkflowId: $processWorkflowId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.processWorkflowId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<ProcessWorkflowModel>> {
		...
		const successMessage = 'Deleted selected Process Workflow entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($processWorkflowIds: [ID!]!){
						deleteProcessWorkflowExcludingIds(processWorkflowIds: $processWorkflowIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.processWorkflowIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<ProcessWorkflowModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($processWorkflowIds: [ID!]!) {
						processWorkflowIds: deleteAllProcessWorkflowByIds(processWorkflowIds: $processWorkflowIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<ProcessWorkflowModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<ProcessWorkflowModel>>(
			...
			map(result => {
				let audits: ProcessWorkflowModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new ProcessWorkflowModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<ProcessWorkflowModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<ProcessWorkflowModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($processWorkflowId: ID!) {
						audits: processWorkflowAuditsByEntityId(processWorkflowId: $processWorkflowId) {
							entity {
								...ProcessWorkflowProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<ProcessWorkflowModel>> {
		const url = environment.API_URL + '/api/processworkflow/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<ProcessWorkflowModel>> {
		const url = environment.API_URL + '/api/processworkflow/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<ProcessWorkflowModel>> {
		let apiUrl = environment.API_URL + '/api/processworkflow/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<ProcessWorkflowModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/processworkflow/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Process Workflow entities')),
