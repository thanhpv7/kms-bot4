...
import {InventoryAdjusmentBatchModelAudit} from '../../models/inventoryAdjusmentBatch/inventory_adjusment_batch.model.state';
...
/**
 * Inventory Adjusment Batch service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class InventoryAdjusmentBatchService extends AbstractHttpService<InventoryAdjusmentBatchModel, InventoryAdjusmentBatchModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the InventoryAdjusmentBatchProperties classFragment here] off begin
			fragment InventoryAdjusmentBatchProperties on InventoryAdjusmentBatch {
				...InventoryAdjusmentBatchBaseProperties
				itemLineNumber
				transactionNumber
				transactionDate
				batchNo
			...
			# % protected region % [Modify the InventoryAdjusmentBatchProperties classFragment here] end
			${super.fragments('InventoryAdjusmentBatch').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<InventoryAdjusmentBatchModel>> {
		...
		return  this.apollo.query<PassableStateConfig<InventoryAdjusmentBatchModel>>(
			{
				query: gql`
					query Count {
						totalCount: countInventoryAdjusmentBatchs
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<InventoryAdjusmentBatchModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<InventoryAdjusmentBatchModel>> {
		...
		return this.apollo.query<PassableStateConfig<InventoryAdjusmentBatchModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						InventoryAdjusmentBatchById: inventoryAdjusmentBatchById(id: $id) {
							...InventoryAdjusmentBatchProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.InventoryAdjusmentBatchById as InventoryAdjusmentBatchModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<InventoryAdjusmentBatchModel>> {
		...
		return this.apollo.query<PassableStateConfig<InventoryAdjusmentBatchModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						inventoryAdjusmentBatchs: inventoryAdjusmentBatchs(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...InventoryAdjusmentBatchProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countInventoryAdjusmentBatchs(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.inventoryAdjusmentBatchs as InventoryAdjusmentBatchModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<InventoryAdjusmentBatchModel>> {
		...
		return this.apollo.query<PassableStateConfig<InventoryAdjusmentBatchModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						inventoryAdjusmentBatchs: lastInventoryAdjusmentBatchs(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...InventoryAdjusmentBatchProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: InventoryAdjusmentBatchModel, queryParams?: QueryParams): Observable<PassableStateConfig<InventoryAdjusmentBatchModel>> {
		...
		const successMessage = 'Created Inventory Adjusment Batch entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($inventoryAdjusmentBatch: InventoryAdjusmentBatchInput!, $persistRelations: Boolean) {
						inventoryAdjusmentBatch: createInventoryAdjusmentBatch(inventoryAdjusmentBatch: $inventoryAdjusmentBatch, persistRelations: $persistRelations) {
							...InventoryAdjusmentBatchProperties,
				...
				`,
				variables: {
					inventoryAdjusmentBatch: {
						...entity.toJSON(),
						inventoryAdjustmentItem: entity.inventoryAdjustmentItem ? new InventoryAdjustmentItemModel(entity.inventoryAdjustmentItem).toJSON() : undefined,
			...
			map(result => {
				...
				return {
					targetModel: result.data.inventoryAdjusmentBatch as InventoryAdjusmentBatchModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: InventoryAdjusmentBatchModel[], queryParams?: QueryParams): Observable<PassableStateConfig<InventoryAdjusmentBatchModel>> {
		...
		const successMessage = 'Created Multiple Inventory Adjusment Batch entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($inventoryAdjusmentBatchs: [InventoryAdjusmentBatchInput!]!) {
						inventoryAdjusmentBatch: createAllInventoryAdjusmentBatch(inventoryAdjusmentBatchs: $inventoryAdjusmentBatchs) {
							...InventoryAdjusmentBatchProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					inventoryAdjusmentBatchs: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.inventoryAdjusmentBatch as InventoryAdjusmentBatchModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: InventoryAdjusmentBatchModel, queryParams?: QueryParams): Observable<PassableStateConfig<InventoryAdjusmentBatchModel>> {
		...
		const successMessage = 'Updated Inventory Adjusment Batch entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($inventoryAdjusmentBatch: InventoryAdjusmentBatchInput!, $persistRelations: Boolean) {
						inventoryAdjusmentBatch: updateInventoryAdjusmentBatch(inventoryAdjusmentBatch: $inventoryAdjusmentBatch, persistRelations: $persistRelations) {
							...InventoryAdjusmentBatchProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: InventoryAdjusmentBatchModel[], queryParams?: QueryParams): Observable<PassableStateConfig<InventoryAdjusmentBatchModel>> {
		...
		const successMessage = 'Update Multiple Inventory Adjusment Batch entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($inventoryAdjusmentBatchs: [InventoryAdjusmentBatchInput!]!) {
						inventoryAdjusmentBatch: updateAllInventoryAdjusmentBatch(inventoryAdjusmentBatchs: $inventoryAdjusmentBatchs) {
							...InventoryAdjusmentBatchProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<InventoryAdjusmentBatchModel>> {
		...
		const successMessage = 'Deleted Inventory Adjusment Batch entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($inventoryAdjusmentBatchId: ID!) {
						inventoryAdjusmentBatchId: deleteInventoryAdjusmentBatchById(inventoryAdjusmentBatchId: $inventoryAdjusmentBatchId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.inventoryAdjusmentBatchId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<InventoryAdjusmentBatchModel>> {
		...
		const successMessage = 'Deleted selected Inventory Adjusment Batch entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($inventoryAdjusmentBatchIds: [ID!]!){
						deleteInventoryAdjusmentBatchExcludingIds(inventoryAdjusmentBatchIds: $inventoryAdjusmentBatchIds)
				...
				`,
				variables: {
					inventoryAdjusmentBatchIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.inventoryAdjusmentBatchIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<InventoryAdjusmentBatchModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($inventoryAdjusmentBatchIds: [ID!]!) {
						inventoryAdjusmentBatchIds: deleteAllInventoryAdjusmentBatchByIds(inventoryAdjusmentBatchIds: $inventoryAdjusmentBatchIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<InventoryAdjusmentBatchModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<InventoryAdjusmentBatchModel>>(
			{
				query: gql`
					query GetAudits {
						audits: inventoryAdjusmentBatchAudits {
							entity {
								...InventoryAdjusmentBatchProperties
							}
							timestamp
			...
			map(result => {
				let audits: InventoryAdjusmentBatchModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new InventoryAdjusmentBatchModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<InventoryAdjusmentBatchModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<InventoryAdjusmentBatchModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($inventoryAdjusmentBatchId: ID!) {
						audits: inventoryAdjusmentBatchAuditsByEntityId(inventoryAdjusmentBatchId: $inventoryAdjusmentBatchId) {
							entity {
								...InventoryAdjusmentBatchProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<InventoryAdjusmentBatchModel>> {
		const url = environment.API_URL + '/api/inventoryadjusmentbatch/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<InventoryAdjusmentBatchModel>> {
		const url = environment.API_URL + '/api/inventoryadjusmentbatch/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<InventoryAdjusmentBatchModel>> {
		let apiUrl = environment.API_URL + '/api/inventoryadjusmentbatch/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<InventoryAdjusmentBatchModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/inventoryadjusmentbatch/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Inventory Adjusment Batch entities')),
