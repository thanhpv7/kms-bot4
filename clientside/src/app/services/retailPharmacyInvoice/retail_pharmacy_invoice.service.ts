...
import {RetailPharmacyInvoiceModel} from '../../models/retailPharmacyInvoice/retail_pharmacy_invoice.model';
import {RetailPharmacyInvoiceModelAudit} from '../../models/retailPharmacyInvoice/retail_pharmacy_invoice.model.state';
...
/**
 * Retail Pharmacy Invoice service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class RetailPharmacyInvoiceService extends AbstractHttpService<RetailPharmacyInvoiceModel, RetailPharmacyInvoiceModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the RetailPharmacyInvoiceProperties classFragment here] off begin
			fragment RetailPharmacyInvoiceProperties on RetailPharmacyInvoice {
				...RetailPharmacyInvoiceBaseProperties
				invoiceNumber
				revisionNumber
				invoiceStatus
				invoiceDate
			...
			# % protected region % [Modify the RetailPharmacyInvoiceProperties classFragment here] end
			${super.fragments('RetailPharmacyInvoice').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<RetailPharmacyInvoiceModel>> {
		...
		return  this.apollo.query<PassableStateConfig<RetailPharmacyInvoiceModel>>(
			{
				query: gql`
					query Count {
						totalCount: countRetailPharmacyInvoices
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<RetailPharmacyInvoiceModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<RetailPharmacyInvoiceModel>> {
		...
		return this.apollo.query<PassableStateConfig<RetailPharmacyInvoiceModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						RetailPharmacyInvoiceById: retailPharmacyInvoiceById(id: $id) {
							...RetailPharmacyInvoiceProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.RetailPharmacyInvoiceById as RetailPharmacyInvoiceModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<RetailPharmacyInvoiceModel>> {
		...
		return this.apollo.query<PassableStateConfig<RetailPharmacyInvoiceModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						retailPharmacyInvoices: retailPharmacyInvoices(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...RetailPharmacyInvoiceProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countRetailPharmacyInvoices(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.retailPharmacyInvoices as RetailPharmacyInvoiceModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<RetailPharmacyInvoiceModel>> {
		...
		return this.apollo.query<PassableStateConfig<RetailPharmacyInvoiceModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						retailPharmacyInvoices: lastRetailPharmacyInvoices(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...RetailPharmacyInvoiceProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: RetailPharmacyInvoiceModel, queryParams?: QueryParams): Observable<PassableStateConfig<RetailPharmacyInvoiceModel>> {
		...
		const successMessage = 'Created Retail Pharmacy Invoice entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($retailPharmacyInvoice: RetailPharmacyInvoiceInput!, $persistRelations: Boolean) {
						retailPharmacyInvoice: createRetailPharmacyInvoice(retailPharmacyInvoice: $retailPharmacyInvoice, persistRelations: $persistRelations) {
							...RetailPharmacyInvoiceProperties,
				...
				variables: {
					retailPharmacyInvoice: {
						...entity.toJSON(),
						invoiceSummary: entity.invoiceSummary ? new InvoiceSummaryModel(entity.invoiceSummary).toJSON() : undefined,
						retailPharmacy: entity.retailPharmacy ? new RetailPharmacyModel(entity.retailPharmacy).toJSON() : undefined,
						cashReceipts: entity.cashReceipts ? entity.cashReceipts?.map((model: CashReceiptModel) => new CashReceiptModel(model).toJSON()) : [],
			...
			map(result => {
				...
				return {
					targetModel: result.data.retailPharmacyInvoice as RetailPharmacyInvoiceModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: RetailPharmacyInvoiceModel[], queryParams?: QueryParams): Observable<PassableStateConfig<RetailPharmacyInvoiceModel>> {
		...
		const successMessage = 'Created Multiple Retail Pharmacy Invoice entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($retailPharmacyInvoices: [RetailPharmacyInvoiceInput!]!) {
						retailPharmacyInvoice: createAllRetailPharmacyInvoice(retailPharmacyInvoices: $retailPharmacyInvoices) {
							...RetailPharmacyInvoiceProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					retailPharmacyInvoices: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.retailPharmacyInvoice as RetailPharmacyInvoiceModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: RetailPharmacyInvoiceModel, queryParams?: QueryParams): Observable<PassableStateConfig<RetailPharmacyInvoiceModel>> {
		...
		const successMessage = 'Updated Retail Pharmacy Invoice entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($retailPharmacyInvoice: RetailPharmacyInvoiceInput!, $persistRelations: Boolean) {
						retailPharmacyInvoice: updateRetailPharmacyInvoice(retailPharmacyInvoice: $retailPharmacyInvoice, persistRelations: $persistRelations) {
							...RetailPharmacyInvoiceProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: RetailPharmacyInvoiceModel[], queryParams?: QueryParams): Observable<PassableStateConfig<RetailPharmacyInvoiceModel>> {
		...
		const successMessage = 'Update Multiple Retail Pharmacy Invoice entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($retailPharmacyInvoices: [RetailPharmacyInvoiceInput!]!) {
						retailPharmacyInvoice: updateAllRetailPharmacyInvoice(retailPharmacyInvoices: $retailPharmacyInvoices) {
							...RetailPharmacyInvoiceProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<RetailPharmacyInvoiceModel>> {
		...
		const successMessage = 'Deleted Retail Pharmacy Invoice entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($retailPharmacyInvoiceId: ID!) {
						retailPharmacyInvoiceId: deleteRetailPharmacyInvoiceById(retailPharmacyInvoiceId: $retailPharmacyInvoiceId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.retailPharmacyInvoiceId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<RetailPharmacyInvoiceModel>> {
		...
		const successMessage = 'Deleted selected Retail Pharmacy Invoice entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($retailPharmacyInvoiceIds: [ID!]!){
						deleteRetailPharmacyInvoiceExcludingIds(retailPharmacyInvoiceIds: $retailPharmacyInvoiceIds)
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.retailPharmacyInvoiceIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<RetailPharmacyInvoiceModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($retailPharmacyInvoiceIds: [ID!]!) {
						retailPharmacyInvoiceIds: deleteAllRetailPharmacyInvoiceByIds(retailPharmacyInvoiceIds: $retailPharmacyInvoiceIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<RetailPharmacyInvoiceModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<RetailPharmacyInvoiceModel>>(
			{
				query: gql`
					query GetAudits {
						audits: retailPharmacyInvoiceAudits {
							entity {
								...RetailPharmacyInvoiceProperties
							}
							timestamp
			...
			map(result => {
				let audits: RetailPharmacyInvoiceModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new RetailPharmacyInvoiceModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<RetailPharmacyInvoiceModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<RetailPharmacyInvoiceModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($retailPharmacyInvoiceId: ID!) {
						audits: retailPharmacyInvoiceAuditsByEntityId(retailPharmacyInvoiceId: $retailPharmacyInvoiceId) {
							entity {
								...RetailPharmacyInvoiceProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<RetailPharmacyInvoiceModel>> {
		const url = environment.API_URL + '/api/retailpharmacyinvoice/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<RetailPharmacyInvoiceModel>> {
		const url = environment.API_URL + '/api/retailpharmacyinvoice/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<RetailPharmacyInvoiceModel>> {
		let apiUrl = environment.API_URL + '/api/retailpharmacyinvoice/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<RetailPharmacyInvoiceModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/retailpharmacyinvoice/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Retail Pharmacy Invoice entities')),
