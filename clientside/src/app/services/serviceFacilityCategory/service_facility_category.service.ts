...
import {ServiceFacilityCategoryModelAudit} from '../../models/serviceFacilityCategory/service_facility_category.model.state';
...
/**
 * Service Facility Category service used to handle all CRUD operations against this entity.
 */
@Injectable({
	providedIn: 'root'
})
export class ServiceFacilityCategoryService extends AbstractHttpService<ServiceFacilityCategoryModel, ServiceFacilityCategoryModelAudit> {
	...
	protected readonly classFragments = {
		properties: gql`
			# % protected region % [Modify the ServiceFacilityCategoryProperties classFragment here] off begin
			fragment ServiceFacilityCategoryProperties on ServiceFacilityCategory {
				...ServiceFacilityCategoryBaseProperties
				facilityCode
			}
			# % protected region % [Modify the ServiceFacilityCategoryProperties classFragment here] end
			${super.fragments('ServiceFacilityCategory').properties}
		`,
	 ...
	 * @inheritDoc
	 */
	count(): Observable<PassableStateConfig<ServiceFacilityCategoryModel>> {
		...
		return  this.apollo.query<PassableStateConfig<ServiceFacilityCategoryModel>>(
			{
				query: gql`
					query Count {
						totalCount: countServiceFacilityCategorys
	 ...
	 * @inheritDoc
	 */
	getAll(): Observable<PassableStateConfig<ServiceFacilityCategoryModel>> {
	 ...
	 * @inheritDoc
	 */
	get(id: string, queryParams?: QueryParams): Observable<PassableStateConfig<ServiceFacilityCategoryModel>> {
		...
		return this.apollo.query<PassableStateConfig<ServiceFacilityCategoryModel>>(
			{
				query: gql`
					query Get($id: ID!) {
						ServiceFacilityCategoryById: serviceFacilityCategoryById(id: $id) {
							...ServiceFacilityCategoryProperties
			...
			map(result => {
				...
				return {
					targetModelId: id,
					targetModel: result.data.ServiceFacilityCategoryById as ServiceFacilityCategoryModel,
	 ...
	 * @inheritDoc
	 */
	getWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<ServiceFacilityCategoryModel>> {
		...
		return this.apollo.query<PassableStateConfig<ServiceFacilityCategoryModel>>(
			{
				query: gql`
					query GetWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!], $where: [[Where!]!]) {
						serviceFacilityCategorys: serviceFacilityCategorys(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy, where: $where) {
							...ServiceFacilityCategoryProperties
							${this.getExpands(queryParams.expands)}
						}

						totalCount: countServiceFacilityCategorys(where: $where)
			...
			map(result => {
				...
				return {
					...
					targetModels: result.data.serviceFacilityCategorys as ServiceFacilityCategoryModel[],
	 ...
	 * @inheritDoc
	 */
	getLastWithQuery(queryParams: QueryParams): Observable<PassableStateConfig<ServiceFacilityCategoryModel>> {
		...
		return this.apollo.query<PassableStateConfig<ServiceFacilityCategoryModel>>(
			{
				query: gql`
					query GetLastWithQuery($pageIndex: Int, $pageSize: Int, $orderBy: [OrderBy!]!) {
						serviceFacilityCategorys: lastServiceFacilityCategorys(pageIndex: $pageIndex, pageSize: $pageSize, orderBy: $orderBy) {
							...ServiceFacilityCategoryProperties
						}
	 ...
	 * @inheritDoc
	 */
	create(entity: ServiceFacilityCategoryModel, queryParams?: QueryParams): Observable<PassableStateConfig<ServiceFacilityCategoryModel>> {
		...
		const successMessage = 'Created Service Facility Category entity successfully';
		// % protected region % [Customise the success message for create here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Create($serviceFacilityCategory: ServiceFacilityCategoryInput!, $persistRelations: Boolean) {
						serviceFacilityCategory: createServiceFacilityCategory(serviceFacilityCategory: $serviceFacilityCategory, persistRelations: $persistRelations) {
							...ServiceFacilityCategoryProperties,
			...
			map(result => {
				...
				return {
					targetModel: result.data.serviceFacilityCategory as ServiceFacilityCategoryModel,
	 ...
	 * @inheritDoc
	 */
	createAll(entities: ServiceFacilityCategoryModel[], queryParams?: QueryParams): Observable<PassableStateConfig<ServiceFacilityCategoryModel>> {
		...
		const successMessage = 'Created Multiple Service Facility Category entities successfully';
		// % protected region % [Customise the success message for createAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation createAll($serviceFacilityCategorys: [ServiceFacilityCategoryInput!]!) {
						serviceFacilityCategory: createAllServiceFacilityCategory(serviceFacilityCategorys: $serviceFacilityCategorys) {
							...ServiceFacilityCategoryProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
				...
				`,
				variables: {
					serviceFacilityCategorys: entities.map(entity => entity.toJSON()),
			...
			map(result => {
				...
				return {
					targetModels: result.data.serviceFacilityCategory as ServiceFacilityCategoryModel[],
	 ...
	 * @inheritDoc
	 */
	update(entity: ServiceFacilityCategoryModel, queryParams?: QueryParams): Observable<PassableStateConfig<ServiceFacilityCategoryModel>> {
		...
		const successMessage = 'Updated Service Facility Category entity successfully';
		// % protected region % [Customise the success message for update here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Update($serviceFacilityCategory: ServiceFacilityCategoryInput!, $persistRelations: Boolean) {
						serviceFacilityCategory: updateServiceFacilityCategory(serviceFacilityCategory: $serviceFacilityCategory, persistRelations: $persistRelations) {
							...ServiceFacilityCategoryProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	updateAll(entities: ServiceFacilityCategoryModel[], queryParams?: QueryParams): Observable<PassableStateConfig<ServiceFacilityCategoryModel>> {
		...
		const successMessage = 'Update Multiple Service Facility Category entities successfully';
		// % protected region % [Customise the success message for updateAll here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation updateAll($serviceFacilityCategorys: [ServiceFacilityCategoryInput!]!) {
						serviceFacilityCategory: updateAllServiceFacilityCategory(serviceFacilityCategorys: $serviceFacilityCategorys) {
							...ServiceFacilityCategoryProperties,
							${this.getExpands(queryParams ? queryParams.expands : [])}
						}
	 ...
	 * @inheritDoc
	 */
	delete(id: string): Observable<PassableStateConfig<ServiceFacilityCategoryModel>> {
		...
		const successMessage = 'Deleted Service Facility Category entity successfully';
		// % protected region % [Customise the success message for delete here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation Delete($serviceFacilityCategoryId: ID!) {
						serviceFacilityCategoryId: deleteServiceFacilityCategoryById(serviceFacilityCategoryId: $serviceFacilityCategoryId)
			...
			map(result => {
				...
				return {
					targetModelId: result.data.serviceFacilityCategoryId as string,
	...
	deleteExcludingIds(ids: string[]): Observable<PassableStateConfig<ServiceFacilityCategoryModel>> {
		...
		const successMessage = 'Deleted selected Service Facility Category entities successfully';
		// % protected region % [Customise the success message for delete excluding here] end

		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation deleteAll($serviceFacilityCategoryIds: [ID!]!){
						deleteServiceFacilityCategoryExcludingIds(serviceFacilityCategoryIds: $serviceFacilityCategoryIds)
				...
				`,
				variables: {
					serviceFacilityCategoryIds: ids,
			...
			map(result => {
				...
				return {
					targetModelIds: result.data.serviceFacilityCategoryIds as string[],
	 ...
	 * @inheritDoc
	 */
	deleteAll(ids: string[]): Observable<PassableStateConfig<ServiceFacilityCategoryModel>> {
		...
		return this.apollo.mutate<any>(
			{
				mutation: gql`
					mutation DeleteAll($serviceFacilityCategoryIds: [ID!]!) {
						serviceFacilityCategoryIds: deleteAllServiceFacilityCategoryByIds(serviceFacilityCategoryIds: $serviceFacilityCategoryIds)
	 ...
	 * @inheritDoc
	 */
	getAudits(): Observable<ServiceFacilityCategoryModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<ServiceFacilityCategoryModel>>(
			{
				query: gql`
					query GetAudits {
						audits: serviceFacilityCategoryAudits {
							entity {
								...ServiceFacilityCategoryProperties
							}
							timestamp
			...
			map(result => {
				let audits: ServiceFacilityCategoryModelAudit[] = result.data.audits.map(audit => {
					return {
						entity: new ServiceFacilityCategoryModel(audit.entity),
	 ...
	 * @inheritDoc
	 */
	getAuditsByEntityId(id: string): Observable<ServiceFacilityCategoryModelAudit[]> {
		...
		return this.apollo.query<PassableStateConfig<ServiceFacilityCategoryModel>>(
			{
				query: gql`
					query GetAuditsByEntityId($serviceFacilityCategoryId: ID!) {
						audits: serviceFacilityCategoryAuditsByEntityId(serviceFacilityCategoryId: $serviceFacilityCategoryId) {
							entity {
								...ServiceFacilityCategoryProperties
							}
							timestamp
	 ...
	 * @inheritdoc
	 */
	export(id: string): Observable<PassableStateConfig<ServiceFacilityCategoryModel>> {
		const url = environment.API_URL + '/api/servicefacilitycategory/export';
	 ...
	 * @inheritdoc
	 */
	exportAll(ids: string[]): Observable<PassableStateConfig<ServiceFacilityCategoryModel>> {
		const url = environment.API_URL + '/api/servicefacilitycategory/export';
	...
	exportModelsExcludingIds(ids: string[]): Observable<PassableStateConfig<ServiceFacilityCategoryModel>> {
		let apiUrl = environment.API_URL + '/api/servicefacilitycategory/export-excluding?ids=';
	...
	importModels(file: File): Observable<PassableStateConfig<ServiceFacilityCategoryModel>> {
		const requestData: FormData = new FormData();
		requestData.append('file', file);

		let apiUrl = environment.API_URL + '/api/servicefacilitycategory/import-csv';
		...
		return this.http.post(apiUrl, requestData, {withCredentials: true, responseType: 'text'}).pipe(
			tap(result => this.toastrService.success('Successfully Imported ' + result.split(',').length + ' Service Facility Category entities')),
