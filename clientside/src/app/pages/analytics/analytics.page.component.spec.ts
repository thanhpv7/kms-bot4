...
import { AnalyticsPageModule } from './analytics.page.module';
...
describe('Analytics Page Component tests', () => {
	let fixture: ComponentFixture<AnalyticsPageComponent>;
	let componentInstance: AnalyticsPageComponent;
	...
	// % protected region % [Add any additional tests to the Analytics page component here] off begin
	// % protected region % [Add any additional tests to the Analytics page component here] end
});
