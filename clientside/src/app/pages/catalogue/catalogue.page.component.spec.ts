...
import { CataloguePageModule } from './catalogue.page.module';
...
describe('Catalogue Page Component tests', () => {
	let fixture: ComponentFixture<CataloguePageComponent>;
	let componentInstance: CataloguePageComponent;
	...
	it ('renders the Stock Catalogue Crud Component with id 4fa0608d-6f58-4dd7-be82-aa4aa97dbbfa correctly', () => {
		fixture.detectChanges();
		const crudComponent: DebugElement = fixture.debugElement.query(By.css('cb-stock-catalogue-crud#crud-4fa0608d-6f58-4dd7-be82-aa4aa97dbbfa'));

		expect(crudComponent).toBeTruthy();
		expect(crudComponent.query(By.css('section > h2')).nativeElement.textContent).toBe('Stock Catalogue');
	});

	// % protected region % [Add any additional tests to the Catalogue page component here] off begin
	// % protected region % [Add any additional tests to the Catalogue page component here] end
});
