...
/**
 * Page Component named Medication Detail.
 *
 ...
 *
 * Selectors for all of the html elements present in the HTML structure can be found in 'medication-detail.tile.component.scss', so styling of this
 * tile can be completed in that file
 *
 */
@Component({
	selector: 'cb-medication-detail-page-component',
	templateUrl: './medication-detail.page.component.html',
	styleUrls: ['./medication-detail.page.component.scss']
})
export class MedicationDetailPageComponent
