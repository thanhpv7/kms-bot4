...
import { PatientProfilePageModule } from './patient-profile.page.module';
...
describe('Patient Profile Page Component tests', () => {
	let fixture: ComponentFixture<PatientProfilePageComponent>;
	let componentInstance: PatientProfilePageComponent;
	...
	it ('renders the Patient Profile Page', () => {
		fixture.detectChanges();
		expect(componentInstance).toBeTruthy();
	});

	it ('renders the Patient General Info Crud Component with id 5ce87e1e-a3dd-41c8-8fe1-10ab3947f11d correctly', () => {
		fixture.detectChanges();
		const crudComponent: DebugElement = fixture.debugElement.query(By.css('cb-patient-general-info-crud#crud-5ce87e1e-a3dd-41c8-8fe1-10ab3947f11d'));

		expect(crudComponent).toBeTruthy();
		expect(crudComponent.query(By.css('section > h2')).nativeElement.textContent).toBe('Patient General Info');
	});

	// % protected region % [Add any additional tests to the Patient Profile page component here] off begin
	// % protected region % [Add any additional tests to the Patient Profile page component here] end
});
