...
/**
 * Page Component named Patient Profile.
 *
 ...
 *
 * Selectors for all of the html elements present in the HTML structure can be found in 'patient-profile.tile.component.scss', so styling of this
 * tile can be completed in that file
 *
 */
@Component({
	selector: 'cb-patient-profile-page-component',
	...
	// % protected region % [Add any interfaces to implement here] end
{
	...
	// Typescript code is not written by the bot for the Crud Component for the entity Patient General Info
	// The Crud Component can be modified in src/app/components/crud/patient-general-info
