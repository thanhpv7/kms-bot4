...
import { ReferencePageModule } from './reference.page.module';
...
describe('Reference Page Component tests', () => {
	let fixture: ComponentFixture<ReferencePageComponent>;
	let componentInstance: ReferencePageComponent;
	...
	// % protected region % [Add any additional tests to the Reference page component here] off begin
	// % protected region % [Add any additional tests to the Reference page component here] end
});
