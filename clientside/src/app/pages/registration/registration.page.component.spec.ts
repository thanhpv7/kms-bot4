...
describe('Registration Page Component tests', () => {
	let fixture: ComponentFixture<RegistrationPageComponent>;
	let componentInstance: RegistrationPageComponent;
	...
	it ('renders the Registration Crud Component with id 25a0aea6-7eae-4faf-8e28-bd0a892577ee correctly', () => {
		fixture.detectChanges();
		const crudComponent: DebugElement = fixture.debugElement.query(By.css('cb-registration-crud#crud-25a0aea6-7eae-4faf-8e28-bd0a892577ee'));

		expect(crudComponent).toBeTruthy();
		expect(crudComponent.query(By.css('section > h2')).nativeElement.textContent).toBe('Registration');
	});

	// % protected region % [Add any additional tests to the Registration page component here] off begin
	// % protected region % [Add any additional tests to the Registration page component here] end
});
