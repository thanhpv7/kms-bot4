...
/**
 * Page Component named Purchasing.
 *
 ...
 *
 * Selectors for all of the html elements present in the HTML structure can be found in 'purchasing.tile.component.scss', so styling of this
 * tile can be completed in that file
 *
 */
@Component({
	selector: 'cb-purchasing-page-component',
