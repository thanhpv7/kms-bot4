...
import { PurchasingPageModule } from './purchasing.page.module';
...
describe('Purchasing Page Component tests', () => {
	let fixture: ComponentFixture<PurchasingPageComponent>;
	let componentInstance: PurchasingPageComponent;
	...
	it ('renders the Purchasing Page', () => {
	...
	// % protected region % [Add any additional tests to the Purchasing page component here] off begin
	// % protected region % [Add any additional tests to the Purchasing page component here] end
});
