...
import { BedPageModule } from './bed.page.module';
...
describe('Bed Page Component tests', () => {
	let fixture: ComponentFixture<BedPageComponent>;
	let componentInstance: BedPageComponent;
	...
	it ('renders the Bed Page', () => {
		fixture.detectChanges();
		expect(componentInstance).toBeTruthy();
	});

	it ('renders the Bed Facility Crud Component with id 28b11289-b1f8-4af3-a424-f805aae629ff correctly', () => {
		fixture.detectChanges();
		const crudComponent: DebugElement = fixture.debugElement.query(By.css('cb-bed-facility-crud#crud-28b11289-b1f8-4af3-a424-f805aae629ff'));

		expect(crudComponent).toBeTruthy();
		expect(crudComponent.query(By.css('section > h2')).nativeElement.textContent).toBe('Bed Facility');
	});

	// % protected region % [Add any additional tests to the Bed page component here] off begin
	// % protected region % [Add any additional tests to the Bed page component here] end
});
