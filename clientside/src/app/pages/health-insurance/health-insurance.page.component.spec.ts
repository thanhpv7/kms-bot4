...
import { HealthInsurancePageModule } from './health-insurance.page.module';
...
describe('Health Insurance Page Component tests', () => {
	let fixture: ComponentFixture<HealthInsurancePageComponent>;
	let componentInstance: HealthInsurancePageComponent;
	...
	it ('renders the Health Insurance Page', () => {
		fixture.detectChanges();
		expect(componentInstance).toBeTruthy();
	});

	it ('renders the Insurance Provider Crud Component with id 876e2c08-9304-4aef-88a6-220cf41e0e09 correctly', () => {
		fixture.detectChanges();
		const crudComponent: DebugElement = fixture.debugElement.query(By.css('cb-insurance-provider-crud#crud-876e2c08-9304-4aef-88a6-220cf41e0e09'));

		expect(crudComponent).toBeTruthy();
		expect(crudComponent.query(By.css('section > h2')).nativeElement.textContent).toBe('Insurance Provider');
	});

	// % protected region % [Add any additional tests to the Health Insurance page component here] off begin
	// % protected region % [Add any additional tests to the Health Insurance page component here] end
});
