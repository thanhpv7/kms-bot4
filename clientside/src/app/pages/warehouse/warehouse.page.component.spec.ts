...
import { WarehousePageModule } from './warehouse.page.module';
...
describe('Warehouse Page Component tests', () => {
	let fixture: ComponentFixture<WarehousePageComponent>;
	let componentInstance: WarehousePageComponent;
	...
	it ('renders the Warehouse Crud Component with id 50f7dc1f-89ff-4cf5-9609-2bd55ad5d834 correctly', () => {
		fixture.detectChanges();
		const crudComponent: DebugElement = fixture.debugElement.query(By.css('cb-warehouse-crud#crud-50f7dc1f-89ff-4cf5-9609-2bd55ad5d834'));

		expect(crudComponent).toBeTruthy();
		expect(crudComponent.query(By.css('section > h2')).nativeElement.textContent).toBe('Warehouse');
	});

	// % protected region % [Add any additional tests to the Warehouse page component here] off begin
	// % protected region % [Add any additional tests to the Warehouse page component here] end
});
