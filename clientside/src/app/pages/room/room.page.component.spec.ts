...
describe('Room Page Component tests', () => {
	let fixture: ComponentFixture<RoomPageComponent>;
	let componentInstance: RoomPageComponent;
	...
	it ('renders the Room Facility Crud Component with id 943b41ff-5ba7-4039-997d-465530bc62dc correctly', () => {
		fixture.detectChanges();
		const crudComponent: DebugElement = fixture.debugElement.query(By.css('cb-room-facility-crud#crud-943b41ff-5ba7-4039-997d-465530bc62dc'));

		expect(crudComponent).toBeTruthy();
		expect(crudComponent.query(By.css('section > h2')).nativeElement.textContent).toBe('Room Facility');
	});

	// % protected region % [Add any additional tests to the Room page component here] off begin
	// % protected region % [Add any additional tests to the Room page component here] end
});
