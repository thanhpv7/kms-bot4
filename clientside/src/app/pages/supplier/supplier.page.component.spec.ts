...
import { SupplierPageModule } from './supplier.page.module';
...
describe('Supplier Page Component tests', () => {
	let fixture: ComponentFixture<SupplierPageComponent>;
	let componentInstance: SupplierPageComponent;
	...
	it ('renders the Supplier Page', () => {
		fixture.detectChanges();
		expect(componentInstance).toBeTruthy();
	});

	it ('renders the Supplier Crud Component with id 7fff4f47-97b4-4ffe-ae5d-d21bfcfc2e96 correctly', () => {
		fixture.detectChanges();
		const crudComponent: DebugElement = fixture.debugElement.query(By.css('cb-supplier-crud#crud-7fff4f47-97b4-4ffe-ae5d-d21bfcfc2e96'));

		expect(crudComponent).toBeTruthy();
		expect(crudComponent.query(By.css('section > h2')).nativeElement.textContent).toBe('Supplier');
	});

	// % protected region % [Add any additional tests to the Supplier page component here] off begin
	// % protected region % [Add any additional tests to the Supplier page component here] end
});
