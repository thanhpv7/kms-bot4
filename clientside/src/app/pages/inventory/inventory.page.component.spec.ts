...
import { InventoryPageModule } from './inventory.page.module';
...
describe('Inventory Page Component tests', () => {
	let fixture: ComponentFixture<InventoryPageComponent>;
	let componentInstance: InventoryPageComponent;
	...
	// % protected region % [Add any additional tests to the Inventory page component here] off begin
	// % protected region % [Add any additional tests to the Inventory page component here] end
});
