...
/**
 * Page Component named Personalization.
 *
 ...
 *
 * Selectors for all of the html elements present in the HTML structure can be found in 'personalization.tile.component.scss', so styling of this
 * tile can be completed in that file
 *
 */
@Component({
	selector: 'cb-personalization-page-component',
