...
import { SettlementReportPageModule } from './settlement-report.page.module';
...
describe('Settlement Report Page Component tests', () => {
	let fixture: ComponentFixture<SettlementReportPageComponent>;
	let componentInstance: SettlementReportPageComponent;
	...
	it ('renders the Settlement Report Page', () => {
	...
	// % protected region % [Add any additional tests to the Settlement Report page component here] off begin
	// % protected region % [Add any additional tests to the Settlement Report page component here] end
});
