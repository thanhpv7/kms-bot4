...
import { ClaimReportPageModule } from './claim-report.page.module';
...
describe('Claim Report Page Component tests', () => {
	let fixture: ComponentFixture<ClaimReportPageComponent>;
	let componentInstance: ClaimReportPageComponent;
	...
	it ('renders the Claim Report Page', () => {
	...
	// % protected region % [Add any additional tests to the Claim Report page component here] off begin
	// % protected region % [Add any additional tests to the Claim Report page component here] end
});
