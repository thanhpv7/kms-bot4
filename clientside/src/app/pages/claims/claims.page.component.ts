 ...
 *
 * Selectors for all of the html elements present in the HTML structure can be found in 'claims.tile.component.scss', so styling of this
 * tile can be completed in that file
 *
 */
@Component({
	selector: 'cb-claims-page-component',
