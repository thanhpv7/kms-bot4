...
import { ClaimsPageModule } from './claims.page.module';
...
describe('Claims Page Component tests', () => {
	...
	let componentInstance: ClaimsPageComponent;
	...
	// % protected region % [Add any additional tests to the Claims page component here] off begin
	// % protected region % [Add any additional tests to the Claims page component here] end
});
