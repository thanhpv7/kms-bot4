...
import { PharmacyPageModule } from './pharmacy.page.module';
...
describe('Pharmacy Page Component tests', () => {
	let fixture: ComponentFixture<PharmacyPageComponent>;
	let componentInstance: PharmacyPageComponent;
	...
	// % protected region % [Add any additional tests to the Pharmacy page component here] off begin
	// % protected region % [Add any additional tests to the Pharmacy page component here] end
});
