...
import { PurchaseOrderPageModule } from './purchase-order.page.module';
...
describe('Purchase Order Page Component tests', () => {
	let fixture: ComponentFixture<PurchaseOrderPageComponent>;
	let componentInstance: PurchaseOrderPageComponent;
	...
	it ('renders the Purchase Order Page', () => {
		fixture.detectChanges();
		expect(componentInstance).toBeTruthy();
	});

	it ('renders the Purchase Order Crud Component with id c7591236-8787-4f80-a1ad-fb50a87d1886 correctly', () => {
		fixture.detectChanges();
		const crudComponent: DebugElement = fixture.debugElement.query(By.css('cb-purchase-order-crud#crud-c7591236-8787-4f80-a1ad-fb50a87d1886'));

		expect(crudComponent).toBeTruthy();
		expect(crudComponent.query(By.css('section > h2')).nativeElement.textContent).toBe('Purchase Order');
	});

	// % protected region % [Add any additional tests to the Purchase Order page component here] off begin
	// % protected region % [Add any additional tests to the Purchase Order page component here] end
});
