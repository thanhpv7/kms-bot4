...
import { ServiceItemPageModule } from './service-item.page.module';
...
describe('Service Item Page Component tests', () => {
	let fixture: ComponentFixture<ServiceItemPageComponent>;
	let componentInstance: ServiceItemPageComponent;
	...
	it ('renders the Service Item Page', () => {
		fixture.detectChanges();
		expect(componentInstance).toBeTruthy();
	});

	it ('renders the Service Item Crud Component with id 01579654-d081-4f85-941a-7df886969780 correctly', () => {
		fixture.detectChanges();
		const crudComponent: DebugElement = fixture.debugElement.query(By.css('cb-service-item-crud#crud-01579654-d081-4f85-941a-7df886969780'));

		expect(crudComponent).toBeTruthy();
		expect(crudComponent.query(By.css('section > h2')).nativeElement.textContent).toBe('Service Item');
	});

	// % protected region % [Add any additional tests to the Service Item page component here] off begin
	// % protected region % [Add any additional tests to the Service Item page component here] end
});
