...
import { OutpatientPageModule } from './outpatient.page.module';
import { OutpatientPageComponent } from './outpatient.page.component';
...
describe('Outpatient Page Component tests', () => {
	let fixture: ComponentFixture<OutpatientPageComponent>;
	let componentInstance: OutpatientPageComponent;
	...
	beforeEach(async () => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(OutpatientPageComponent);
	...
	it ('renders the Outpatient Page', () => {
		fixture.detectChanges();
		expect(componentInstance).toBeTruthy();
	});

	// % protected region % [Add any additional tests to the Outpatient page component here] off begin
	// % protected region % [Add any additional tests to the Outpatient page component here] end
});
