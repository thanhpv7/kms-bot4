...
/**
 * Page Component named Service Detail.
 *
 ...
 *
 * Selectors for all of the html elements present in the HTML structure can be found in 'service-detail.tile.component.scss', so styling of this
 * tile can be completed in that file
 *
 */
@Component({
	selector: 'cb-service-detail-page-component',
