...
import { ServiceDetailPageModule } from './service-detail.page.module';
...
describe('Service Detail Page Component tests', () => {
	let fixture: ComponentFixture<ServiceDetailPageComponent>;
	let componentInstance: ServiceDetailPageComponent;
	...
	it ('renders the Service Detail Page', () => {
	...
	// % protected region % [Add any additional tests to the Service Detail page component here] off begin
	// % protected region % [Add any additional tests to the Service Detail page component here] end
});
