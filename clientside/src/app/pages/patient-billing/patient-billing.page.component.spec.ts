...
import { PatientBillingPageModule } from './patient-billing.page.module';
...
describe('Patient Billing Page Component tests', () => {
	let fixture: ComponentFixture<PatientBillingPageComponent>;
	let componentInstance: PatientBillingPageComponent;
	...
	it ('renders the Patient Billing Page', () => {
	...
	// % protected region % [Add any additional tests to the Patient Billing page component here] off begin
	// % protected region % [Add any additional tests to the Patient Billing page component here] end
});
