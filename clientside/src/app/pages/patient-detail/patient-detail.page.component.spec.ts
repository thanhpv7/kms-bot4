...
import { PatientDetailPageModule } from './patient-detail.page.module';
...
describe('Patient Detail Page Component tests', () => {
	let fixture: ComponentFixture<PatientDetailPageComponent>;
	let componentInstance: PatientDetailPageComponent;
	...
	it ('renders the Patient Detail Page', () => {
		fixture.detectChanges();
		expect(componentInstance).toBeTruthy();
	});

	it ('renders the Patient Detail Crud Component with id 550bd2a1-cdf8-4f54-bee1-3db774f43448 correctly', () => {
		fixture.detectChanges();
		const crudComponent: DebugElement = fixture.debugElement.query(By.css('cb-patient-detail-crud#crud-550bd2a1-cdf8-4f54-bee1-3db774f43448'));

		expect(crudComponent).toBeTruthy();
		expect(crudComponent.query(By.css('section > h2')).nativeElement.textContent).toBe('Patient Detail');
	});

	// % protected region % [Add any additional tests to the Patient Detail page component here] off begin
	// % protected region % [Add any additional tests to the Patient Detail page component here] end
});
