...
describe('Dashboard Page Component tests', () => {
	...
	let componentInstance: DashboardPageComponent;
	...
	// % protected region % [Add any additional tests to the Dashboard page component here] off begin
	// % protected region % [Add any additional tests to the Dashboard page component here] end
});
