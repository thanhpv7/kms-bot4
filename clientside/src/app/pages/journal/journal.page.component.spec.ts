...
import { JournalPageModule } from './journal.page.module';
...
describe('Journal Page Component tests', () => {
	let fixture: ComponentFixture<JournalPageComponent>;
	let componentInstance: JournalPageComponent;
	...
	it ('renders the Journal Crud Component with id 88482637-7752-42af-83e3-6ee69dace57b correctly', () => {
		fixture.detectChanges();
		const crudComponent: DebugElement = fixture.debugElement.query(By.css('cb-journal-crud#crud-88482637-7752-42af-83e3-6ee69dace57b'));

		expect(crudComponent).toBeTruthy();
		expect(crudComponent.query(By.css('section > h2')).nativeElement.textContent).toBe('Journal');
	});

	// % protected region % [Add any additional tests to the Journal page component here] off begin
	// % protected region % [Add any additional tests to the Journal page component here] end
});
