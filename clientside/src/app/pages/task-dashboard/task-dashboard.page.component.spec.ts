...
import { TaskDashboardPageModule } from './task-dashboard.page.module';
...
describe('Task Dashboard Page Component tests', () => {
	let fixture: ComponentFixture<TaskDashboardPageComponent>;
	let componentInstance: TaskDashboardPageComponent;
	...
	it ('renders the Task Dashboard Page', () => {
		fixture.detectChanges();
		expect(componentInstance).toBeTruthy();
	});

	it ('renders the Task Dashboard Crud Component with id 01845a85-0482-47ee-b1bf-7e798a627e66 correctly', () => {
		fixture.detectChanges();
		const crudComponent: DebugElement = fixture.debugElement.query(By.css('cb-task-dashboard-crud#crud-01845a85-0482-47ee-b1bf-7e798a627e66'));

		expect(crudComponent).toBeTruthy();
		expect(crudComponent.query(By.css('section > h2')).nativeElement.textContent).toBe('Task Dashboard');
	});

	// % protected region % [Add any additional tests to the Task Dashboard page component here] off begin
	// % protected region % [Add any additional tests to the Task Dashboard page component here] end
});
