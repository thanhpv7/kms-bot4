...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: GoodsReceiveNoteItemCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: GoodsReceiveNoteItemCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'goods-receive-note-item/view/:id',
				component: GoodsReceiveNoteItemCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'goods-receive-note-item/create',
				component: GoodsReceiveNoteItemCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'goods-receive-note-item/edit/:id',
				component: GoodsReceiveNoteItemCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class GoodsReceiveNoteItemCrudRoutingModule {
}
