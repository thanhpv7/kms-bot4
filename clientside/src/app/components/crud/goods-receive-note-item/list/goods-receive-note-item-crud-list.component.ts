...
@Component({
	selector: 'cb-goods-receive-note-item-crud-list',
	templateUrl: './goods-receive-note-item-crud-list.component.html',
	styleUrls: [
		'./goods-receive-note-item-crud-list.component.scss',
...
export class GoodsReceiveNoteItemCrudListComponent
