...
import {GoodsReceiveNoteItemCrudListComponent} from './goods-receive-note-item-crud-list.component';
...
describe('Goods Receive Note Item Crud List Tile Component', () => {
	...
	let fixture;
	let goodsReceiveNoteItemCrudListComponent: GoodsReceiveNoteItemCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(GoodsReceiveNoteItemCrudListComponent);
