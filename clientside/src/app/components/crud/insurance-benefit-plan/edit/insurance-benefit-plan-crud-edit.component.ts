...
@Component({
	selector: 'cb-insurance-benefit-plan-crud-edit',
	templateUrl: './insurance-benefit-plan-crud-edit.component.html',
	styleUrls: [
		'./insurance-benefit-plan-crud-edit.component.scss',
...
export class InsuranceBenefitPlanCrudEditComponent
