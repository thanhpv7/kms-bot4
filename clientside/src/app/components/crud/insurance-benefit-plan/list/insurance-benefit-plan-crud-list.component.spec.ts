...
import {InsuranceBenefitPlanCrudListComponent} from './insurance-benefit-plan-crud-list.component';
...
describe('Insurance Benefit Plan Crud List Tile Component', () => {
	...
	let fixture;
	let insuranceBenefitPlanCrudListComponent: InsuranceBenefitPlanCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(InsuranceBenefitPlanCrudListComponent);
