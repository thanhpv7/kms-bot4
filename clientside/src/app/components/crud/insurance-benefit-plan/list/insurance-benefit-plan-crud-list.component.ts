...
@Component({
	selector: 'cb-insurance-benefit-plan-crud-list',
	templateUrl: './insurance-benefit-plan-crud-list.component.html',
	styleUrls: [
		'./insurance-benefit-plan-crud-list.component.scss',
...
export class InsuranceBenefitPlanCrudListComponent
