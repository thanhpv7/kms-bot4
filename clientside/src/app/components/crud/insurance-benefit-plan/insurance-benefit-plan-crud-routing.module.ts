...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: InsuranceBenefitPlanCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: InsuranceBenefitPlanCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'insurance-benefit-plan/view/:id',
				component: InsuranceBenefitPlanCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'insurance-benefit-plan/create',
				component: InsuranceBenefitPlanCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'insurance-benefit-plan/edit/:id',
				component: InsuranceBenefitPlanCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class InsuranceBenefitPlanCrudRoutingModule {
}
