...
@Component({
	selector: 'cb-bpjs-treatment-room-crud-edit',
	templateUrl: './bpjs-treatment-room-crud-edit.component.html',
	styleUrls: [
		'./bpjs-treatment-room-crud-edit.component.scss',
...
export class BpjsTreatmentRoomCrudEditComponent
