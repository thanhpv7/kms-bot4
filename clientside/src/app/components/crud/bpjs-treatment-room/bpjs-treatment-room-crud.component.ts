 ...
 */
@Component({
	selector: 'cb-bpjs-treatment-room-crud',
	templateUrl: './bpjs-treatment-room-crud.component.html',
	styleUrls: [
		'./bpjs-treatment-room-crud.component.scss',
...
export class BpjsTreatmentRoomCrudComponent implements OnDestroy {
