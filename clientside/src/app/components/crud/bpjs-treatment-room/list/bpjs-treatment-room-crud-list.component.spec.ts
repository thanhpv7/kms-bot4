...
import {BpjsTreatmentRoomCrudListComponent} from './bpjs-treatment-room-crud-list.component';
...
describe('BPJS Treatment Room Crud List Tile Component', () => {
	...
	let fixture;
	let bpjsTreatmentRoomCrudListComponent: BpjsTreatmentRoomCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(BpjsTreatmentRoomCrudListComponent);
