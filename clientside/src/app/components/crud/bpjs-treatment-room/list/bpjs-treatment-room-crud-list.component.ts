...
@Component({
	selector: 'cb-bpjs-treatment-room-crud-list',
	templateUrl: './bpjs-treatment-room-crud-list.component.html',
	styleUrls: [
		'./bpjs-treatment-room-crud-list.component.scss',
...
export class BpjsTreatmentRoomCrudListComponent
