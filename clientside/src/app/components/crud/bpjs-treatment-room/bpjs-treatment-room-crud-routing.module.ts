...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: BpjsTreatmentRoomCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: BpjsTreatmentRoomCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-treatment-room/view/:id',
				component: BpjsTreatmentRoomCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-treatment-room/create',
				component: BpjsTreatmentRoomCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'bpjs-treatment-room/edit/:id',
				component: BpjsTreatmentRoomCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class BpjsTreatmentRoomCrudRoutingModule {
}
