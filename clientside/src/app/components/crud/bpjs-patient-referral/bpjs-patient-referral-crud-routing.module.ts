...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: BpjsPatientReferralCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: BpjsPatientReferralCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-patient-referral/view/:id',
				component: BpjsPatientReferralCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-patient-referral/create',
				component: BpjsPatientReferralCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'bpjs-patient-referral/edit/:id',
				component: BpjsPatientReferralCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class BpjsPatientReferralCrudRoutingModule {
}
