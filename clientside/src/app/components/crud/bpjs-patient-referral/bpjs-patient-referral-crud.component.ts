 ...
 */
@Component({
	selector: 'cb-bpjs-patient-referral-crud',
	templateUrl: './bpjs-patient-referral-crud.component.html',
	styleUrls: [
		'./bpjs-patient-referral-crud.component.scss',
...
export class BpjsPatientReferralCrudComponent implements OnDestroy {
