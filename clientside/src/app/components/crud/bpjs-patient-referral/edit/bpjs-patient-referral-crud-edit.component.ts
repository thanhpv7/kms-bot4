...
@Component({
	selector: 'cb-bpjs-patient-referral-crud-edit',
	templateUrl: './bpjs-patient-referral-crud-edit.component.html',
	styleUrls: [
		'./bpjs-patient-referral-crud-edit.component.scss',
...
export class BpjsPatientReferralCrudEditComponent
