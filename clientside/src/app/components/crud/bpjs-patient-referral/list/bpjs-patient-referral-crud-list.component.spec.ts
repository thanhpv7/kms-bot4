...
import {BpjsPatientReferralCrudListComponent} from './bpjs-patient-referral-crud-list.component';
...
describe('BPJS Patient Referral Crud List Tile Component', () => {
	...
	let fixture;
	let bpjsPatientReferralCrudListComponent: BpjsPatientReferralCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(BpjsPatientReferralCrudListComponent);
