...
@Component({
	selector: 'cb-bpjs-patient-referral-crud-list',
	templateUrl: './bpjs-patient-referral-crud-list.component.html',
	styleUrls: [
		'./bpjs-patient-referral-crud-list.component.scss',
...
export class BpjsPatientReferralCrudListComponent
