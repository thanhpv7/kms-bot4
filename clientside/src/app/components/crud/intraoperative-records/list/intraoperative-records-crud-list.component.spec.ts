...
import {IntraoperativeRecordsCrudListComponent} from './intraoperative-records-crud-list.component';
...
describe('Intraoperative Records Crud List Tile Component', () => {
	...
	let fixture;
	let intraoperativeRecordsCrudListComponent: IntraoperativeRecordsCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(IntraoperativeRecordsCrudListComponent);
