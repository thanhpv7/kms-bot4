...
@Component({
	selector: 'cb-intraoperative-records-crud-list',
	templateUrl: './intraoperative-records-crud-list.component.html',
	styleUrls: [
		'./intraoperative-records-crud-list.component.scss',
...
export class IntraoperativeRecordsCrudListComponent
