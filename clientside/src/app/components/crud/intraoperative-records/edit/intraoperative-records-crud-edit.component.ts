...
@Component({
	selector: 'cb-intraoperative-records-crud-edit',
	templateUrl: './intraoperative-records-crud-edit.component.html',
	styleUrls: [
		'./intraoperative-records-crud-edit.component.scss',
...
export class IntraoperativeRecordsCrudEditComponent
