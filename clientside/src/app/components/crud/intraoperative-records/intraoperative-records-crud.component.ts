 ...
 */
@Component({
	selector: 'cb-intraoperative-records-crud',
	templateUrl: './intraoperative-records-crud.component.html',
	styleUrls: [
		'./intraoperative-records-crud.component.scss',
...
export class IntraoperativeRecordsCrudComponent implements OnDestroy {
