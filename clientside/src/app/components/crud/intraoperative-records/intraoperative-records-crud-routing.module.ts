...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: IntraoperativeRecordsCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: IntraoperativeRecordsCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'intraoperative-records/view/:id',
				component: IntraoperativeRecordsCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'intraoperative-records/create',
				component: IntraoperativeRecordsCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'intraoperative-records/edit/:id',
				component: IntraoperativeRecordsCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class IntraoperativeRecordsCrudRoutingModule {
}
