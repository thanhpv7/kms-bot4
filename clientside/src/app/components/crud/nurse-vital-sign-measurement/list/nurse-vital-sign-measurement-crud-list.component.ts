...
import {CrudTileMode} from '../nurse-vital-sign-measurement-crud.component';
...
@Component({
	selector: 'cb-nurse-vital-sign-measurement-crud-list',
	templateUrl: './nurse-vital-sign-measurement-crud-list.component.html',
	styleUrls: [
		'./nurse-vital-sign-measurement-crud-list.component.scss',
...
export class NurseVitalSignMeasurementCrudListComponent
