...
import { NurseVitalSignMeasurementCrudEditComponent } from './nurse-vital-sign-measurement-crud-edit.component';
import {
...
describe('Nurse Vital Sign Measurement CRUD Edit component tests', () => {
	let fixture: ComponentFixture<NurseVitalSignMeasurementCrudEditComponent>
	let component: NurseVitalSignMeasurementCrudEditComponent;
	...
	let nurseVitalSignMeasurementCountBehaviorSubject: BehaviorSubject<number>;
	...
	let nurseVitalSignMeasurementWithId: NurseVitalSignMeasurementModel = defaultNurseVitalSignMeasurementEntities[0];
	let nurseVitalSignMeasurementModelWithIdBehaviorSubject: BehaviorSubject<NurseVitalSignMeasurementModel>;

	nurseVitalSignMeasurementWithId.medicalExaminationRecord = defaultMedicalExaminationRecordEntities[0];
	nurseVitalSignMeasurementWithId.medicalExaminationRecordId = nurseVitalSignMeasurementWithId.medicalExaminationRecord.id;
	...
	function spySelectorsInStore() {
		...
		nurseVitalSignMeasurementCountBehaviorSubject = new BehaviorSubject(defaultNurseVitalSignMeasurementCount);
		...
		nurseVitalSignMeasurementModelWithIdBehaviorSubject = new BehaviorSubject(nurseVitalSignMeasurementWithId);
		medicalExaminationRecordWithIdBehaviorSubject = new BehaviorSubject(nurseVitalSignMeasurementWithId.medicalExaminationRecord);

		spyOn(store, 'select')
			.withArgs(getCountNurseVitalSignMeasurementModels).and.returnValue(nurseVitalSignMeasurementCountBehaviorSubject)
			.withArgs(getNurseVitalSignMeasurementModelWithId, nurseVitalSignMeasurementWithId.id).and.returnValue(nurseVitalSignMeasurementModelWithIdBehaviorSubject)
			...
			.withArgs(getMedicalExaminationRecordModelWithId, nurseVitalSignMeasurementWithId.medicalExaminationRecordId).and.returnValue(medicalExaminationRecordWithIdBehaviorSubject)
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(NurseVitalSignMeasurementCrudEditComponent);
			component = fixture.debugElement.componentInstance;
			component.ngOnInit();
			component.targetModel = new NurseVitalSignMeasurementModel();
	 ...
	 */
	it ('Renders the Nurse Vital Sign Measurement CRUD Edit Component', () => {
	...
	*/
	...
	it ('renders related Medical Examination Record entities from model when loading in edit mode', () => {
		component.targetModel = nurseVitalSignMeasurementWithId;
		component.targetModelId = nurseVitalSignMeasurementWithId.id;
