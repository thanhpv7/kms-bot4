...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: NurseVitalSignMeasurementCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: NurseVitalSignMeasurementCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'nurse-vital-sign-measurement/view/:id',
				component: NurseVitalSignMeasurementCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'nurse-vital-sign-measurement/create',
				component: NurseVitalSignMeasurementCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'nurse-vital-sign-measurement/edit/:id',
				component: NurseVitalSignMeasurementCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class NurseVitalSignMeasurementCrudRoutingModule {
}
