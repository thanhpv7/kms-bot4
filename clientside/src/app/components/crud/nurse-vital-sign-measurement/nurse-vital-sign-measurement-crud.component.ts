 ...
 */
@Component({
	selector: 'cb-nurse-vital-sign-measurement-crud',
	templateUrl: './nurse-vital-sign-measurement-crud.component.html',
	styleUrls: [
		'./nurse-vital-sign-measurement-crud.component.scss',
...
export class NurseVitalSignMeasurementCrudComponent implements OnDestroy {
