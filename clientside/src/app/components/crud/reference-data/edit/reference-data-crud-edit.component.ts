...
@Component({
	selector: 'cb-reference-data-crud-edit',
	templateUrl: './reference-data-crud-edit.component.html',
	styleUrls: [
		'./reference-data-crud-edit.component.scss',
...
export class ReferenceDataCrudEditComponent
