...
@Component({
	selector: 'cb-reference-data-crud-list',
	templateUrl: './reference-data-crud-list.component.html',
	styleUrls: [
		'./reference-data-crud-list.component.scss',
...
export class ReferenceDataCrudListComponent
