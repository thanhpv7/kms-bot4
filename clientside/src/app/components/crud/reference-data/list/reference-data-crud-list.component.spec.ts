...
import {ReferenceDataCrudListComponent} from './reference-data-crud-list.component';
...
describe('Reference Data Crud List Tile Component', () => {
	...
	let fixture;
	let referenceDataCrudListComponent: ReferenceDataCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(ReferenceDataCrudListComponent);
