 ...
 */
@Component({
	selector: 'cb-reference-data-crud',
	templateUrl: './reference-data-crud.component.html',
	styleUrls: [
		'./reference-data-crud.component.scss',
...
export class ReferenceDataCrudComponent implements OnDestroy {
