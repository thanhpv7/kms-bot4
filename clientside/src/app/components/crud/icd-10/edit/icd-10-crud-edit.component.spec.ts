...
import { Icd10CrudEditComponent } from './icd-10-crud-edit.component';
import {
	Icd10ModelState,
...
describe('ICD 10 CRUD Edit component tests', () => {
	let fixture: ComponentFixture<Icd10CrudEditComponent>
	let component: Icd10CrudEditComponent;
	...
	let icd10CountBehaviorSubject: BehaviorSubject<number>;
	...
	let icd10WithId: Icd10Model = defaultIcd10Entities[0];
	let icd10ModelWithIdBehaviorSubject: BehaviorSubject<Icd10Model>;

	icd10WithId.diagnosesAndProcedures = defaultDiagnosesAndProceduresEntities[0];
	icd10WithId.diagnosesAndProceduresId = icd10WithId.diagnosesAndProcedures.id;
	...
	function spySelectorsInStore() {
		...
		icd10CountBehaviorSubject = new BehaviorSubject(defaultIcd10Count);
		...
		icd10ModelWithIdBehaviorSubject = new BehaviorSubject(icd10WithId);
		diagnosesAndProceduresWithIdBehaviorSubject = new BehaviorSubject(icd10WithId.diagnosesAndProcedures);

		spyOn(store, 'select')
			.withArgs(getCountIcd10Models).and.returnValue(icd10CountBehaviorSubject)
			.withArgs(getIcd10ModelWithId, icd10WithId.id).and.returnValue(icd10ModelWithIdBehaviorSubject)
			...
			.withArgs(getDiagnosesAndProceduresModelWithId, icd10WithId.diagnosesAndProceduresId).and.returnValue(diagnosesAndProceduresWithIdBehaviorSubject)
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(Icd10CrudEditComponent);
			component = fixture.debugElement.componentInstance;
			component.ngOnInit();
			component.targetModel = new Icd10Model();
	 ...
	 */
	it ('Renders the ICD 10 CRUD Edit Component', () => {
	...
	*/
	...
	it ('renders related Diagnoses and Procedures entities from model when loading in edit mode', () => {
		component.targetModel = icd10WithId;
		component.targetModelId = icd10WithId.id;
