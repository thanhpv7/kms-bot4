...
import {CrudTileMode} from '../icd-10-crud.component';
...
@Component({
	selector: 'cb-icd-10-crud-list',
	templateUrl: './icd-10-crud-list.component.html',
	styleUrls: [
		'./icd-10-crud-list.component.scss',
...
export class Icd10CrudListComponent
