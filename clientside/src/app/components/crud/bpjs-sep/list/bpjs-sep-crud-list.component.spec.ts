...
import {BpjsSEPCrudListComponent} from './bpjs-sep-crud-list.component';
...
describe('BPJS SEP Crud List Tile Component', () => {
	...
	let fixture;
	let bpjsSEPCrudListComponent: BpjsSEPCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(BpjsSEPCrudListComponent);
