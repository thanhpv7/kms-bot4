...
import {BpjsSEPCrudListComponent} from './list/bpjs-sep-crud-list.component';
import {BpjsSEPCrudEditComponent} from './edit/bpjs-sep-crud-edit.component';
import {BpjsSEPCrudComponent} from './bpjs-sep-crud.component';
...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: BpjsSEPCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: BpjsSEPCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-sep/view/:id',
				component: BpjsSEPCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class BpjsSEPCrudRoutingModule {
}
