...
@Component({
	selector: 'cb-health-facility-crud-list',
	templateUrl: './health-facility-crud-list.component.html',
	styleUrls: [
		'./health-facility-crud-list.component.scss',
...
export class HealthFacilityCrudListComponent
