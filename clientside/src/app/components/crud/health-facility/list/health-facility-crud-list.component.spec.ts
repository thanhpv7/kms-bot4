...
import {HealthFacilityCrudListComponent} from './health-facility-crud-list.component';
...
describe('Health Facility Crud List Tile Component', () => {
	...
	let fixture;
	let healthFacilityCrudListComponent: HealthFacilityCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(HealthFacilityCrudListComponent);
