...
@Component({
	selector: 'cb-health-facility-crud-edit',
	templateUrl: './health-facility-crud-edit.component.html',
	styleUrls: [
		'./health-facility-crud-edit.component.scss',
...
export class HealthFacilityCrudEditComponent
