...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: HealthFacilityCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: HealthFacilityCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'health-facility/view/:id',
				component: HealthFacilityCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class HealthFacilityCrudRoutingModule {
}
