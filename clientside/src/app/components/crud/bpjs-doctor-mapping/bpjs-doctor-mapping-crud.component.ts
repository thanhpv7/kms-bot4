 ...
 */
@Component({
	selector: 'cb-bpjs-doctor-mapping-crud',
	templateUrl: './bpjs-doctor-mapping-crud.component.html',
	styleUrls: [
		'./bpjs-doctor-mapping-crud.component.scss',
...
export class BpjsDoctorMappingCrudComponent implements OnDestroy {
