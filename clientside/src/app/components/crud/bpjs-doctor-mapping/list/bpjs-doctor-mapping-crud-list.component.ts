...
@Component({
	selector: 'cb-bpjs-doctor-mapping-crud-list',
	templateUrl: './bpjs-doctor-mapping-crud-list.component.html',
	styleUrls: [
		'./bpjs-doctor-mapping-crud-list.component.scss',
...
export class BpjsDoctorMappingCrudListComponent
