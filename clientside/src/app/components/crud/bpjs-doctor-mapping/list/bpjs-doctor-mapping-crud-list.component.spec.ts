...
import {BpjsDoctorMappingCrudListComponent} from './bpjs-doctor-mapping-crud-list.component';
...
describe('BPJS Doctor Mapping Crud List Tile Component', () => {
	...
	let fixture;
	let bpjsDoctorMappingCrudListComponent: BpjsDoctorMappingCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(BpjsDoctorMappingCrudListComponent);
