...
@Component({
	selector: 'cb-bpjs-doctor-mapping-crud-edit',
	templateUrl: './bpjs-doctor-mapping-crud-edit.component.html',
	styleUrls: [
		'./bpjs-doctor-mapping-crud-edit.component.scss',
...
export class BpjsDoctorMappingCrudEditComponent
