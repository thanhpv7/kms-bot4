 ...
 */
@Component({
	selector: 'cb-bpjs-treatment-history-crud',
	templateUrl: './bpjs-treatment-history-crud.component.html',
	styleUrls: [
		'./bpjs-treatment-history-crud.component.scss',
...
export class BpjsTreatmentHistoryCrudComponent implements OnDestroy {
