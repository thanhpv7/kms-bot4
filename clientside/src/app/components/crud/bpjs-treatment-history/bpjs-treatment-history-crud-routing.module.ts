...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: BpjsTreatmentHistoryCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: BpjsTreatmentHistoryCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-treatment-history/view/:id',
				component: BpjsTreatmentHistoryCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-treatment-history/create',
				component: BpjsTreatmentHistoryCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'bpjs-treatment-history/edit/:id',
				component: BpjsTreatmentHistoryCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class BpjsTreatmentHistoryCrudRoutingModule {
}
