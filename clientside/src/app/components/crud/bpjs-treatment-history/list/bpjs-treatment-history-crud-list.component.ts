...
import {CrudTileMode} from '../bpjs-treatment-history-crud.component';
...
@Component({
	selector: 'cb-bpjs-treatment-history-crud-list',
	templateUrl: './bpjs-treatment-history-crud-list.component.html',
	styleUrls: [
		'./bpjs-treatment-history-crud-list.component.scss',
...
export class BpjsTreatmentHistoryCrudListComponent
