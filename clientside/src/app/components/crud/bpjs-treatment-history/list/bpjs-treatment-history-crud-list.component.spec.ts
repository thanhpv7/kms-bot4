...
import {BpjsTreatmentHistoryCrudListComponent} from './bpjs-treatment-history-crud-list.component';
...
import {BpjsTreatmentHistoryCrudModule} from '../bpjs-treatment-history-crud.module';
import {
...
describe('BPJS Treatment History Crud List Tile Component', () => {
	...
	let fixture;
	let bpjsTreatmentHistoryCrudListComponent: BpjsTreatmentHistoryCrudListComponent;
	...
	const routerState: RouterState = {
		url: 'bpjs-treatment-history-crud',
		urls: ['bpjs-treatment-history-crud'],
		params: {},
		queryParams: {},
		data: {},
	};
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			imports: [
				...
				BpjsTreatmentHistoryCrudModule,
			],
			providers: [
				provideMockStore(),
				{
			...
			fixture = TestBed.createComponent(BpjsTreatmentHistoryCrudListComponent);
