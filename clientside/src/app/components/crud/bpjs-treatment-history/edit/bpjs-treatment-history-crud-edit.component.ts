...
@Component({
	selector: 'cb-bpjs-treatment-history-crud-edit',
	templateUrl: './bpjs-treatment-history-crud-edit.component.html',
	styleUrls: [
		'./bpjs-treatment-history-crud-edit.component.scss',
...
export class BpjsTreatmentHistoryCrudEditComponent
