...
import {PrescriptionItemCrudListComponent} from './prescription-item-crud-list.component';
...
describe('Prescription Item Crud List Tile Component', () => {
	...
	let fixture;
	let prescriptionItemCrudListComponent: PrescriptionItemCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(PrescriptionItemCrudListComponent);
