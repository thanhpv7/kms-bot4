...
@Component({
	selector: 'cb-prescription-item-crud-list',
	templateUrl: './prescription-item-crud-list.component.html',
	styleUrls: [
		'./prescription-item-crud-list.component.scss',
...
export class PrescriptionItemCrudListComponent
