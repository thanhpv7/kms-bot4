 ...
 */
@Component({
	selector: 'cb-prescription-item-crud',
	templateUrl: './prescription-item-crud.component.html',
	styleUrls: [
		'./prescription-item-crud.component.scss',
...
export class PrescriptionItemCrudComponent implements OnDestroy {
