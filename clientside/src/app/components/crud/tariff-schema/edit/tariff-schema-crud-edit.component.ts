...
@Component({
	selector: 'cb-tariff-schema-crud-edit',
	templateUrl: './tariff-schema-crud-edit.component.html',
	styleUrls: [
		'./tariff-schema-crud-edit.component.scss',
...
export class TariffSchemaCrudEditComponent
