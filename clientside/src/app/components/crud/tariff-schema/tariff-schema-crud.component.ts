 ...
 */
@Component({
	selector: 'cb-tariff-schema-crud',
	templateUrl: './tariff-schema-crud.component.html',
	styleUrls: [
		'./tariff-schema-crud.component.scss',
...
export class TariffSchemaCrudComponent implements OnDestroy {
