...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: TariffSchemaCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: TariffSchemaCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'tariff-schema/view/:id',
				component: TariffSchemaCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class TariffSchemaCrudRoutingModule {
}
