...
import {TariffSchemaCrudListComponent} from './tariff-schema-crud-list.component';
...
describe('Tariff Schema Crud List Tile Component', () => {
	...
	let fixture;
	let tariffSchemaCrudListComponent: TariffSchemaCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(TariffSchemaCrudListComponent);
