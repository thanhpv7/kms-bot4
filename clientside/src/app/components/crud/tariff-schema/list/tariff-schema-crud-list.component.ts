...
@Component({
	selector: 'cb-tariff-schema-crud-list',
	templateUrl: './tariff-schema-crud-list.component.html',
	styleUrls: [
		'./tariff-schema-crud-list.component.scss',
...
export class TariffSchemaCrudListComponent
