...
@Component({
	selector: 'cb-purchase-order-crud-edit',
	templateUrl: './purchase-order-crud-edit.component.html',
	styleUrls: [
		'./purchase-order-crud-edit.component.scss',
...
export class PurchaseOrderCrudEditComponent
