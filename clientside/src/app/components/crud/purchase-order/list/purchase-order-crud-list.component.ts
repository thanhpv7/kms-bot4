...
@Component({
	selector: 'cb-purchase-order-crud-list',
	templateUrl: './purchase-order-crud-list.component.html',
	styleUrls: [
		'./purchase-order-crud-list.component.scss',
...
export class PurchaseOrderCrudListComponent
