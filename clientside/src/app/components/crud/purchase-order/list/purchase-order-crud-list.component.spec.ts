...
import {PurchaseOrderCrudListComponent} from './purchase-order-crud-list.component';
...
describe('Purchase Order Crud List Tile Component', () => {
	...
	let fixture;
	let purchaseOrderCrudListComponent: PurchaseOrderCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(PurchaseOrderCrudListComponent);
