...
import {CrudTileMode} from '../bpjs-pcare-dpho-crud.component';
...
@Component({
	selector: 'cb-bpjs-pcare-dpho-crud-list',
	templateUrl: './bpjs-pcare-dpho-crud-list.component.html',
	styleUrls: [
		'./bpjs-pcare-dpho-crud-list.component.scss',
...
export class BpjsPcareDPHOCrudListComponent
