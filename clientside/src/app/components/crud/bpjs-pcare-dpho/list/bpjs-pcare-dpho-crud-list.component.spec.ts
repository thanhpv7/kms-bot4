...
import {BpjsPcareDPHOCrudListComponent} from './bpjs-pcare-dpho-crud-list.component';
...
import {BpjsPcareDPHOCrudModule} from '../bpjs-pcare-dpho-crud.module';
import {
...
describe('BPJS Pcare DPHO Crud List Tile Component', () => {
	...
	let fixture;
	let bpjsPcareDPHOCrudListComponent: BpjsPcareDPHOCrudListComponent;
	...
	const routerState: RouterState = {
		url: 'bpjs-pcare-dpho-crud',
		urls: ['bpjs-pcare-dpho-crud'],
		params: {},
		queryParams: {},
		data: {},
	};
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(BpjsPcareDPHOCrudListComponent);
