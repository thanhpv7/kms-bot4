...
@Component({
	selector: 'cb-bpjs-pcare-dpho-crud-edit',
	templateUrl: './bpjs-pcare-dpho-crud-edit.component.html',
	styleUrls: [
		'./bpjs-pcare-dpho-crud-edit.component.scss',
...
export class BpjsPcareDPHOCrudEditComponent
