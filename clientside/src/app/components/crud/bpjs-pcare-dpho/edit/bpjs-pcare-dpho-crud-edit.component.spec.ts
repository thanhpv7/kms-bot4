...
import { BpjsPcareDPHOCrudEditComponent } from './bpjs-pcare-dpho-crud-edit.component';
import {
...
describe('BPJS Pcare DPHO CRUD Edit component tests', () => {
	let fixture: ComponentFixture<BpjsPcareDPHOCrudEditComponent>
	let component: BpjsPcareDPHOCrudEditComponent;
	...
	let bpjsPcareDPHOCountBehaviorSubject: BehaviorSubject<number>;
	...
	let bpjsPcareDPHOWithId: BpjsPcareDPHOModel = defaultBpjsPcareDPHOEntities[0];
	let bpjsPcareDPHOModelWithIdBehaviorSubject: BehaviorSubject<BpjsPcareDPHOModel>;

	bpjsPcareDPHOWithId.stockCatalogue = defaultStockCatalogueEntities[0];
	bpjsPcareDPHOWithId.stockCatalogueId = bpjsPcareDPHOWithId.stockCatalogue.id;
	...
	function spySelectorsInStore() {
		...
		bpjsPcareDPHOCountBehaviorSubject = new BehaviorSubject(defaultBpjsPcareDPHOCount);
		...
		bpjsPcareDPHOModelWithIdBehaviorSubject = new BehaviorSubject(bpjsPcareDPHOWithId);
		stockCatalogueWithIdBehaviorSubject = new BehaviorSubject(bpjsPcareDPHOWithId.stockCatalogue);

		spyOn(store, 'select')
			.withArgs(getCountBpjsPcareDPHOModels).and.returnValue(bpjsPcareDPHOCountBehaviorSubject)
			.withArgs(getBpjsPcareDPHOModelWithId, bpjsPcareDPHOWithId.id).and.returnValue(bpjsPcareDPHOModelWithIdBehaviorSubject)
			...
			.withArgs(getStockCatalogueModelWithId, bpjsPcareDPHOWithId.stockCatalogueId).and.returnValue(stockCatalogueWithIdBehaviorSubject)
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(BpjsPcareDPHOCrudEditComponent);
			component = fixture.debugElement.componentInstance;
			component.ngOnInit();
			component.targetModel = new BpjsPcareDPHOModel();
	 ...
	 */
	it ('Renders the BPJS Pcare DPHO CRUD Edit Component', () => {
	...
	*/
	...
	it ('renders related Stock Catalogue entities from model when loading in edit mode', () => {
		component.targetModel = bpjsPcareDPHOWithId;
		component.targetModelId = bpjsPcareDPHOWithId.id;
