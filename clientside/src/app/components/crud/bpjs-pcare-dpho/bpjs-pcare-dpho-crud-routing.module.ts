...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: BpjsPcareDPHOCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: BpjsPcareDPHOCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-pcare-dpho/view/:id',
				component: BpjsPcareDPHOCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class BpjsPcareDPHOCrudRoutingModule {
}
