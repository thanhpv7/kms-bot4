...
import {BpjsPcareRiwayatKunjunganCrudListComponent} from './bpjs-pcare-riwayat-kunjungan-crud-list.component';
...
describe('Bpjs Pcare Riwayat Kunjungan Crud List Tile Component', () => {
	...
	let fixture;
	let bpjsPcareRiwayatKunjunganCrudListComponent: BpjsPcareRiwayatKunjunganCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(BpjsPcareRiwayatKunjunganCrudListComponent);
