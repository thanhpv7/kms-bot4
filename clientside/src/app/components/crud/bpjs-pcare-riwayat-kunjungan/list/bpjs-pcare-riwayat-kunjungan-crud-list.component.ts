...
@Component({
	selector: 'cb-bpjs-pcare-riwayat-kunjungan-crud-list',
	templateUrl: './bpjs-pcare-riwayat-kunjungan-crud-list.component.html',
	styleUrls: [
		'./bpjs-pcare-riwayat-kunjungan-crud-list.component.scss',
...
export class BpjsPcareRiwayatKunjunganCrudListComponent
