...
@Component({
	selector: 'cb-bpjs-pcare-riwayat-kunjungan-crud-edit',
	templateUrl: './bpjs-pcare-riwayat-kunjungan-crud-edit.component.html',
	styleUrls: [
		'./bpjs-pcare-riwayat-kunjungan-crud-edit.component.scss',
...
export class BpjsPcareRiwayatKunjunganCrudEditComponent
