 ...
 */
@Component({
	selector: 'cb-bpjs-pcare-riwayat-kunjungan-crud',
	templateUrl: './bpjs-pcare-riwayat-kunjungan-crud.component.html',
	styleUrls: [
		'./bpjs-pcare-riwayat-kunjungan-crud.component.scss',
...
export class BpjsPcareRiwayatKunjunganCrudComponent implements OnDestroy {
