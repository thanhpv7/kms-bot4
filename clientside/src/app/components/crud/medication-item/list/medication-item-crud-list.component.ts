...
@Component({
	selector: 'cb-medication-item-crud-list',
	templateUrl: './medication-item-crud-list.component.html',
	styleUrls: [
		'./medication-item-crud-list.component.scss',
...
export class MedicationItemCrudListComponent
