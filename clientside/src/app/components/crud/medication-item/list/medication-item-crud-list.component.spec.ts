...
import {MedicationItemCrudListComponent} from './medication-item-crud-list.component';
...
describe('Medication Item Crud List Tile Component', () => {
	...
	let fixture;
	let medicationItemCrudListComponent: MedicationItemCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(MedicationItemCrudListComponent);
