 ...
 */
@Component({
	selector: 'cb-medication-item-crud',
	templateUrl: './medication-item-crud.component.html',
	styleUrls: [
		'./medication-item-crud.component.scss',
...
export class MedicationItemCrudComponent implements OnDestroy {
