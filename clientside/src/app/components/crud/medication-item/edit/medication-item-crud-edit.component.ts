...
@Component({
	selector: 'cb-medication-item-crud-edit',
	templateUrl: './medication-item-crud-edit.component.html',
	styleUrls: [
		'./medication-item-crud-edit.component.scss',
...
export class MedicationItemCrudEditComponent
