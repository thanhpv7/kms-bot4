...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: RoomFacilityCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: RoomFacilityCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'room-facility/view/:id',
				component: RoomFacilityCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class RoomFacilityCrudRoutingModule {
}
