...
@Component({
	selector: 'cb-room-facility-crud-list',
	templateUrl: './room-facility-crud-list.component.html',
	styleUrls: [
		'./room-facility-crud-list.component.scss',
...
export class RoomFacilityCrudListComponent
