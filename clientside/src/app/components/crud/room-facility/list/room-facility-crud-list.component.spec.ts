...
import {RoomFacilityCrudListComponent} from './room-facility-crud-list.component';
...
describe('Room Facility Crud List Tile Component', () => {
	...
	let fixture;
	let roomFacilityCrudListComponent: RoomFacilityCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(RoomFacilityCrudListComponent);
