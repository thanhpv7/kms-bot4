 ...
 */
@Component({
	selector: 'cb-room-facility-crud',
	templateUrl: './room-facility-crud.component.html',
	styleUrls: [
		'./room-facility-crud.component.scss',
...
export class RoomFacilityCrudComponent implements OnDestroy {
