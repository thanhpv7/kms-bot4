...
@Component({
	selector: 'cb-bpjs-service-mapping-crud-list',
	templateUrl: './bpjs-service-mapping-crud-list.component.html',
	styleUrls: [
		'./bpjs-service-mapping-crud-list.component.scss',
...
export class BpjsServiceMappingCrudListComponent
