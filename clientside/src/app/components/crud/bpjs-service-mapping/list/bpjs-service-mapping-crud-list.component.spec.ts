...
import {BpjsServiceMappingCrudListComponent} from './bpjs-service-mapping-crud-list.component';
...
describe('BPJS Service Mapping Crud List Tile Component', () => {
	...
	let fixture;
	let bpjsServiceMappingCrudListComponent: BpjsServiceMappingCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(BpjsServiceMappingCrudListComponent);
