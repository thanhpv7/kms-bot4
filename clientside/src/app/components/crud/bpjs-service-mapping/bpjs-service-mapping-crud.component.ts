 ...
 */
@Component({
	selector: 'cb-bpjs-service-mapping-crud',
	templateUrl: './bpjs-service-mapping-crud.component.html',
	styleUrls: [
		'./bpjs-service-mapping-crud.component.scss',
...
export class BpjsServiceMappingCrudComponent implements OnDestroy {
