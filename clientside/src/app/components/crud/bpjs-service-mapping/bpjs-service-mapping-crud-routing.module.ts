...
import {BpjsServiceMappingCrudListComponent} from './list/bpjs-service-mapping-crud-list.component';
import {BpjsServiceMappingCrudEditComponent} from './edit/bpjs-service-mapping-crud-edit.component';
import {BpjsServiceMappingCrudComponent} from './bpjs-service-mapping-crud.component';
...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: BpjsServiceMappingCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: BpjsServiceMappingCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-service-mapping/view/:id',
				component: BpjsServiceMappingCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-service-mapping/create',
				component: BpjsServiceMappingCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'bpjs-service-mapping/edit/:id',
				component: BpjsServiceMappingCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class BpjsServiceMappingCrudRoutingModule {
}
