...
import {TariffFormulaCrudListComponent} from './tariff-formula-crud-list.component';
...
describe('Tariff Formula Crud List Tile Component', () => {
	...
	let fixture;
	let tariffFormulaCrudListComponent: TariffFormulaCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(TariffFormulaCrudListComponent);
