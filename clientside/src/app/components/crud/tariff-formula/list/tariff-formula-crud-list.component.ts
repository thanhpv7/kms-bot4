...
@Component({
	selector: 'cb-tariff-formula-crud-list',
	templateUrl: './tariff-formula-crud-list.component.html',
	styleUrls: [
		'./tariff-formula-crud-list.component.scss',
...
export class TariffFormulaCrudListComponent
