...
@Component({
	selector: 'cb-tariff-formula-crud-edit',
	templateUrl: './tariff-formula-crud-edit.component.html',
	styleUrls: [
		'./tariff-formula-crud-edit.component.scss',
...
export class TariffFormulaCrudEditComponent
