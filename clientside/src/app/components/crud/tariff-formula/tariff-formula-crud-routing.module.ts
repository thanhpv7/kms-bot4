...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: TariffFormulaCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: TariffFormulaCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'tariff-formula/view/:id',
				component: TariffFormulaCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class TariffFormulaCrudRoutingModule {
}
