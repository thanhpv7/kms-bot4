...
@Component({
	selector: 'cb-pcare-referensi-sarana-crud-edit',
	templateUrl: './pcare-referensi-sarana-crud-edit.component.html',
	styleUrls: [
		'./pcare-referensi-sarana-crud-edit.component.scss',
...
export class PcareReferensiSaranaCrudEditComponent
