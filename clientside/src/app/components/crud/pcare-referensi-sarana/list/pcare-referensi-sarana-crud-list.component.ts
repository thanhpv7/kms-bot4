...
@Component({
	selector: 'cb-pcare-referensi-sarana-crud-list',
	templateUrl: './pcare-referensi-sarana-crud-list.component.html',
	styleUrls: [
		'./pcare-referensi-sarana-crud-list.component.scss',
...
export class PcareReferensiSaranaCrudListComponent
