...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: PcareReferensiSaranaCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: PcareReferensiSaranaCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'pcare-referensi-sarana/view/:id',
				component: PcareReferensiSaranaCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'pcare-referensi-sarana/create',
				component: PcareReferensiSaranaCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'pcare-referensi-sarana/edit/:id',
				component: PcareReferensiSaranaCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class PcareReferensiSaranaCrudRoutingModule {
}
