...
@Component({
	selector: 'cb-prescription-compound-crud-edit',
	templateUrl: './prescription-compound-crud-edit.component.html',
	styleUrls: [
		'./prescription-compound-crud-edit.component.scss',
...
export class PrescriptionCompoundCrudEditComponent
