...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: PrescriptionCompoundCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: PrescriptionCompoundCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'prescription-compound/view/:id',
				component: PrescriptionCompoundCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'prescription-compound/create',
				component: PrescriptionCompoundCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'prescription-compound/edit/:id',
				component: PrescriptionCompoundCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class PrescriptionCompoundCrudRoutingModule {
}
