...
@Component({
	selector: 'cb-prescription-compound-crud-list',
	templateUrl: './prescription-compound-crud-list.component.html',
	styleUrls: [
		'./prescription-compound-crud-list.component.scss',
...
export class PrescriptionCompoundCrudListComponent
