...
import {PrescriptionCompoundCrudListComponent} from './prescription-compound-crud-list.component';
...
describe('Prescription Compound Crud List Tile Component', () => {
	...
	let fixture;
	let prescriptionCompoundCrudListComponent: PrescriptionCompoundCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(PrescriptionCompoundCrudListComponent);
