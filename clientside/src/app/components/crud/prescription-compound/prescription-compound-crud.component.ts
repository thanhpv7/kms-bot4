 ...
 */
@Component({
	selector: 'cb-prescription-compound-crud',
	templateUrl: './prescription-compound-crud.component.html',
	styleUrls: [
		'./prescription-compound-crud.component.scss',
...
export class PrescriptionCompoundCrudComponent implements OnDestroy {
