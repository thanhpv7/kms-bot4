...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: BpjsListTaskCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: BpjsListTaskCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-list-task/view/:id',
				component: BpjsListTaskCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class BpjsListTaskCrudRoutingModule {
}
