...
@Component({
	selector: 'cb-bpjs-list-task-crud-edit',
	templateUrl: './bpjs-list-task-crud-edit.component.html',
	styleUrls: [
		'./bpjs-list-task-crud-edit.component.scss',
...
export class BpjsListTaskCrudEditComponent
