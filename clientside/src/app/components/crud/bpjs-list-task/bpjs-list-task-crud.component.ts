 ...
 */
@Component({
	selector: 'cb-bpjs-list-task-crud',
	templateUrl: './bpjs-list-task-crud.component.html',
	styleUrls: [
		'./bpjs-list-task-crud.component.scss',
...
export class BpjsListTaskCrudComponent implements OnDestroy {
