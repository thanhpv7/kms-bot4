...
@Component({
	selector: 'cb-bpjs-list-task-crud-list',
	templateUrl: './bpjs-list-task-crud-list.component.html',
	styleUrls: [
		'./bpjs-list-task-crud-list.component.scss',
...
export class BpjsListTaskCrudListComponent
