 ...
 */
@Component({
	selector: 'cb-price-component-crud',
	templateUrl: './price-component-crud.component.html',
	styleUrls: [
		'./price-component-crud.component.scss',
...
export class PriceComponentCrudComponent implements OnDestroy {
