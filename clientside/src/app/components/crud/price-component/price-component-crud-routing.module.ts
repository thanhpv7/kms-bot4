...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: PriceComponentCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: PriceComponentCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'price-component/view/:id',
				component: PriceComponentCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class PriceComponentCrudRoutingModule {
}
