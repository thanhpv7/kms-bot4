...
import {PriceComponentCrudListComponent} from './price-component-crud-list.component';
...
describe('Price Component Crud List Tile Component', () => {
	...
	let fixture;
	let priceComponentCrudListComponent: PriceComponentCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(PriceComponentCrudListComponent);
