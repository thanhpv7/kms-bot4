...
@Component({
	selector: 'cb-price-component-crud-list',
	templateUrl: './price-component-crud-list.component.html',
	styleUrls: [
		'./price-component-crud-list.component.scss',
...
export class PriceComponentCrudListComponent
