 ...
 */
@Component({
	selector: 'cb-transfer-order-stock-detail-crud',
	templateUrl: './transfer-order-stock-detail-crud.component.html',
	styleUrls: [
		'./transfer-order-stock-detail-crud.component.scss',
...
export class TransferOrderStockDetailCrudComponent implements OnDestroy {
