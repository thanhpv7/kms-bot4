...
@Component({
	selector: 'cb-transfer-order-stock-detail-crud-edit',
	templateUrl: './transfer-order-stock-detail-crud-edit.component.html',
	styleUrls: [
		'./transfer-order-stock-detail-crud-edit.component.scss',
...
export class TransferOrderStockDetailCrudEditComponent
