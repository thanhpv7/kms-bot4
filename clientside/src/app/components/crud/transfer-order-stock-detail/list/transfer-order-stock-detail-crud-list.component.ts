...
@Component({
	selector: 'cb-transfer-order-stock-detail-crud-list',
	templateUrl: './transfer-order-stock-detail-crud-list.component.html',
	styleUrls: [
		'./transfer-order-stock-detail-crud-list.component.scss',
...
export class TransferOrderStockDetailCrudListComponent
