...
import {TransferOrderStockDetailCrudListComponent} from './transfer-order-stock-detail-crud-list.component';
...
describe('Transfer Order Stock Detail Crud List Tile Component', () => {
	...
	let fixture;
	let transferOrderStockDetailCrudListComponent: TransferOrderStockDetailCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(TransferOrderStockDetailCrudListComponent);
