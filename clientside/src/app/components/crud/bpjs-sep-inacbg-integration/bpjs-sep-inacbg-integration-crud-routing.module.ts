...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: BpjsSEPINACBGIntegrationCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: BpjsSEPINACBGIntegrationCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-sep-inacbg-integration/view/:id',
				component: BpjsSEPINACBGIntegrationCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-sep-inacbg-integration/create',
				component: BpjsSEPINACBGIntegrationCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'bpjs-sep-inacbg-integration/edit/:id',
				component: BpjsSEPINACBGIntegrationCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class BpjsSEPINACBGIntegrationCrudRoutingModule {
}
