...
import {BpjsSEPINACBGIntegrationCrudListComponent} from './bpjs-sep-inacbg-integration-crud-list.component';
...
import {BpjsSEPINACBGIntegrationCrudModule} from '../bpjs-sep-inacbg-integration-crud.module';
import {
...
describe('BPJS SEP INACBG Integration Crud List Tile Component', () => {
	...
	let fixture;
	let bpjsSEPINACBGIntegrationCrudListComponent: BpjsSEPINACBGIntegrationCrudListComponent;
	...
	const routerState: RouterState = {
		url: 'bpjs-sep-inacbg-integration-crud',
		urls: ['bpjs-sep-inacbg-integration-crud'],
		params: {},
		queryParams: {},
		data: {},
	};
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			imports: [
				...
				BpjsSEPINACBGIntegrationCrudModule,
			],
			providers: [
				provideMockStore(),
				{
			...
			fixture = TestBed.createComponent(BpjsSEPINACBGIntegrationCrudListComponent);
