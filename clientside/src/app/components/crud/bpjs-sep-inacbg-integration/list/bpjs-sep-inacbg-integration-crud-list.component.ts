...
import {CrudTileMode} from '../bpjs-sep-inacbg-integration-crud.component';
...
@Component({
	selector: 'cb-bpjs-sep-inacbg-integration-crud-list',
	templateUrl: './bpjs-sep-inacbg-integration-crud-list.component.html',
	styleUrls: [
		'./bpjs-sep-inacbg-integration-crud-list.component.scss',
...
export class BpjsSEPINACBGIntegrationCrudListComponent
