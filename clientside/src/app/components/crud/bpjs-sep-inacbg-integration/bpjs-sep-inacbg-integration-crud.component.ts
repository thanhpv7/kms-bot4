 ...
 */
@Component({
	selector: 'cb-bpjs-sep-inacbg-integration-crud',
	templateUrl: './bpjs-sep-inacbg-integration-crud.component.html',
	styleUrls: [
		'./bpjs-sep-inacbg-integration-crud.component.scss',
...
export class BpjsSEPINACBGIntegrationCrudComponent implements OnDestroy {
