...
@Component({
	selector: 'cb-mcu-package-item-crud-edit',
	templateUrl: './mcu-package-item-crud-edit.component.html',
	styleUrls: [
		'./mcu-package-item-crud-edit.component.scss',
...
export class McuPackageItemCrudEditComponent
