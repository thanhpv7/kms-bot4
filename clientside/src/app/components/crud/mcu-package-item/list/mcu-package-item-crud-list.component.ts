...
@Component({
	selector: 'cb-mcu-package-item-crud-list',
	templateUrl: './mcu-package-item-crud-list.component.html',
	styleUrls: [
		'./mcu-package-item-crud-list.component.scss',
...
export class McuPackageItemCrudListComponent
