...
import {McuPackageItemCrudListComponent} from './mcu-package-item-crud-list.component';
...
describe('MCU Package Item Crud List Tile Component', () => {
	...
	let fixture;
	let mcuPackageItemCrudListComponent: McuPackageItemCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(McuPackageItemCrudListComponent);
