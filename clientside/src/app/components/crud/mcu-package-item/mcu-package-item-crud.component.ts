 ...
 */
@Component({
	selector: 'cb-mcu-package-item-crud',
	templateUrl: './mcu-package-item-crud.component.html',
	styleUrls: [
		'./mcu-package-item-crud.component.scss',
...
export class McuPackageItemCrudComponent implements OnDestroy {
