...
import {RegistrationCrudRoutingModule} from './registration-crud-routing.module';
...
@NgModule({
	declarations: [
		RegistrationCrudListComponent,
		RegistrationCrudEditComponent,
...
export class RegistrationCrudModule {
}
