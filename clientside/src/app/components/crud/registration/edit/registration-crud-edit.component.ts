...
@Component({
	selector: 'cb-registration-crud-edit',
	templateUrl: './registration-crud-edit.component.html',
	styleUrls: [
		'./registration-crud-edit.component.scss',
...
export class RegistrationCrudEditComponent
