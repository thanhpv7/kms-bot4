...
import {RegistrationCrudListComponent} from './registration-crud-list.component';
...
describe('Registration Crud List Tile Component', () => {
	...
	let fixture;
	let registrationCrudListComponent: RegistrationCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(RegistrationCrudListComponent);
