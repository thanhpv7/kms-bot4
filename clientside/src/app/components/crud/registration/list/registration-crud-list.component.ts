...
@Component({
	selector: 'cb-registration-crud-list',
	templateUrl: './registration-crud-list.component.html',
	styleUrls: [
		'./registration-crud-list.component.scss',
...
export class RegistrationCrudListComponent
