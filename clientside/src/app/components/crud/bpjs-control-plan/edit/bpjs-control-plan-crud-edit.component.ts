...
@Component({
	selector: 'cb-bpjs-control-plan-crud-edit',
	templateUrl: './bpjs-control-plan-crud-edit.component.html',
	styleUrls: [
		'./bpjs-control-plan-crud-edit.component.scss',
...
export class BpjsControlPlanCrudEditComponent
