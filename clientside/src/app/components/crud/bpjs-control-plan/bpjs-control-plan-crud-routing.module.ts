...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: BpjsControlPlanCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: BpjsControlPlanCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-control-plan/view/:id',
				component: BpjsControlPlanCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-control-plan/edit/:id',
				component: BpjsControlPlanCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class BpjsControlPlanCrudRoutingModule {
}
