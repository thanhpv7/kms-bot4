 ...
 */
@Component({
	selector: 'cb-bpjs-control-plan-crud',
	templateUrl: './bpjs-control-plan-crud.component.html',
	styleUrls: [
		'./bpjs-control-plan-crud.component.scss',
...
export class BpjsControlPlanCrudComponent implements OnDestroy {
