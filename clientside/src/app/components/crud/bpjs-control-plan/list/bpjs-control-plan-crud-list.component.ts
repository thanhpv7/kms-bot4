...
@Component({
	selector: 'cb-bpjs-control-plan-crud-list',
	templateUrl: './bpjs-control-plan-crud-list.component.html',
	styleUrls: [
		'./bpjs-control-plan-crud-list.component.scss',
...
export class BpjsControlPlanCrudListComponent
