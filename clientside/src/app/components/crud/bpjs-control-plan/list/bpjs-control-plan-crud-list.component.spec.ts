...
import {BpjsControlPlanCrudListComponent} from './bpjs-control-plan-crud-list.component';
...
describe('BPJS Control Plan Crud List Tile Component', () => {
	...
	let fixture;
	let bpjsControlPlanCrudListComponent: BpjsControlPlanCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(BpjsControlPlanCrudListComponent);
