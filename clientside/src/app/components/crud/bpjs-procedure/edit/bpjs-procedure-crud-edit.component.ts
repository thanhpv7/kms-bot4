...
@Component({
	selector: 'cb-bpjs-procedure-crud-edit',
	templateUrl: './bpjs-procedure-crud-edit.component.html',
	styleUrls: [
		'./bpjs-procedure-crud-edit.component.scss',
...
export class BpjsProcedureCrudEditComponent
