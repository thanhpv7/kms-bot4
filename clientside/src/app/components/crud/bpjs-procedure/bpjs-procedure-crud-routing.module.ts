...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: BpjsProcedureCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: BpjsProcedureCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-procedure/view/:id',
				component: BpjsProcedureCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class BpjsProcedureCrudRoutingModule {
}
