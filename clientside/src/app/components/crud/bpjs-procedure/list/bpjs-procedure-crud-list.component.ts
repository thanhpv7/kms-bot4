...
@Component({
	selector: 'cb-bpjs-procedure-crud-list',
	templateUrl: './bpjs-procedure-crud-list.component.html',
	styleUrls: [
		'./bpjs-procedure-crud-list.component.scss',
...
export class BpjsProcedureCrudListComponent
