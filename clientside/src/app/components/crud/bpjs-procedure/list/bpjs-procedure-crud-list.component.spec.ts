...
import {BpjsProcedureCrudListComponent} from './bpjs-procedure-crud-list.component';
...
describe('BPJS Procedure Crud List Tile Component', () => {
	...
	let fixture;
	let bpjsProcedureCrudListComponent: BpjsProcedureCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(BpjsProcedureCrudListComponent);
