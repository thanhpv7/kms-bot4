 ...
 */
@Component({
	selector: 'cb-bpjs-procedure-crud',
	templateUrl: './bpjs-procedure-crud.component.html',
	styleUrls: [
		'./bpjs-procedure-crud.component.scss',
...
export class BpjsProcedureCrudComponent implements OnDestroy {
