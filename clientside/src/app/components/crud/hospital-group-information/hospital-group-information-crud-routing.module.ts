...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: HospitalGroupInformationCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: HospitalGroupInformationCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'hospital-group-information/view/:id',
				component: HospitalGroupInformationCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'hospital-group-information/create',
				component: HospitalGroupInformationCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'hospital-group-information/edit/:id',
				component: HospitalGroupInformationCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class HospitalGroupInformationCrudRoutingModule {
}
