 ...
 */
@Component({
	selector: 'cb-hospital-group-information-crud',
	templateUrl: './hospital-group-information-crud.component.html',
	styleUrls: [
		'./hospital-group-information-crud.component.scss',
...
export class HospitalGroupInformationCrudComponent implements OnDestroy {
