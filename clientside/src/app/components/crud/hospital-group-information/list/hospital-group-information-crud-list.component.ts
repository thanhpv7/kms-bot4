...
@Component({
	selector: 'cb-hospital-group-information-crud-list',
	templateUrl: './hospital-group-information-crud-list.component.html',
	styleUrls: [
		'./hospital-group-information-crud-list.component.scss',
...
export class HospitalGroupInformationCrudListComponent
