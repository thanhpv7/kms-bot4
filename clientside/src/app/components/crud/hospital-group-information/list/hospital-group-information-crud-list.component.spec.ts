...
import {HospitalGroupInformationCrudListComponent} from './hospital-group-information-crud-list.component';
...
describe('Hospital Group Information Crud List Tile Component', () => {
	...
	let fixture;
	let hospitalGroupInformationCrudListComponent: HospitalGroupInformationCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(HospitalGroupInformationCrudListComponent);
