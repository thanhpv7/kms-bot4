 ...
 */
@Component({
	selector: 'cb-medical-examination-record-crud',
	templateUrl: './medical-examination-record-crud.component.html',
	styleUrls: [
		'./medical-examination-record-crud.component.scss',
...
export class MedicalExaminationRecordCrudComponent implements OnDestroy {
