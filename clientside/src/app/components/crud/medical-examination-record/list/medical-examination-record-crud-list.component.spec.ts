...
import {MedicalExaminationRecordCrudListComponent} from './medical-examination-record-crud-list.component';
...
describe('Medical Examination Record Crud List Tile Component', () => {
	...
	let fixture;
	let medicalExaminationRecordCrudListComponent: MedicalExaminationRecordCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(MedicalExaminationRecordCrudListComponent);
