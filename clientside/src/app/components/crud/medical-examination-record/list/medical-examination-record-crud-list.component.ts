...
@Component({
	selector: 'cb-medical-examination-record-crud-list',
	templateUrl: './medical-examination-record-crud-list.component.html',
	styleUrls: [
		'./medical-examination-record-crud-list.component.scss',
...
export class MedicalExaminationRecordCrudListComponent
