...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: MedicalExaminationRecordCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: MedicalExaminationRecordCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'medical-examination-record/view/:id',
				component: MedicalExaminationRecordCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'medical-examination-record/create',
				component: MedicalExaminationRecordCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'medical-examination-record/edit/:id',
				component: MedicalExaminationRecordCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class MedicalExaminationRecordCrudRoutingModule {
}
