...
import {AmendmentDetailCrudListComponent} from './list/amendment-detail-crud-list.component';
import {AmendmentDetailCrudEditComponent} from './edit/amendment-detail-crud-edit.component';
import {AmendmentDetailCrudComponent} from './amendment-detail-crud.component';
...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: AmendmentDetailCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: AmendmentDetailCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'amendment-detail/view/:id',
				component: AmendmentDetailCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class AmendmentDetailCrudRoutingModule {
}
