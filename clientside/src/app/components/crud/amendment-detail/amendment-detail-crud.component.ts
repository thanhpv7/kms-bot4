 ...
 */
@Component({
	selector: 'cb-amendment-detail-crud',
	templateUrl: './amendment-detail-crud.component.html',
	styleUrls: [
		'./amendment-detail-crud.component.scss',
...
export class AmendmentDetailCrudComponent implements OnDestroy {
