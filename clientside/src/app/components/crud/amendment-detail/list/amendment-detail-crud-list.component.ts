...
import {CrudTileMode} from '../amendment-detail-crud.component';
...
@Component({
	selector: 'cb-amendment-detail-crud-list',
	templateUrl: './amendment-detail-crud-list.component.html',
	styleUrls: [
		'./amendment-detail-crud-list.component.scss',
...
export class AmendmentDetailCrudListComponent
