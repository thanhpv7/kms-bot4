...
import {AmendmentDetailCrudListComponent} from './amendment-detail-crud-list.component';
...
describe('Amendment Detail Crud List Tile Component', () => {
	...
	let fixture;
	let amendmentDetailCrudListComponent: AmendmentDetailCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(AmendmentDetailCrudListComponent);
