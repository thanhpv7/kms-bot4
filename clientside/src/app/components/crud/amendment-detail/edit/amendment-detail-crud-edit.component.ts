...
@Component({
	selector: 'cb-amendment-detail-crud-edit',
	templateUrl: './amendment-detail-crud-edit.component.html',
	styleUrls: [
		'./amendment-detail-crud-edit.component.scss',
...
export class AmendmentDetailCrudEditComponent
