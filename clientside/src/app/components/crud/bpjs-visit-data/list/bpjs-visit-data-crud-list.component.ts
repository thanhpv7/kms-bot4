...
@Component({
	selector: 'cb-bpjs-visit-data-crud-list',
	templateUrl: './bpjs-visit-data-crud-list.component.html',
	styleUrls: [
		'./bpjs-visit-data-crud-list.component.scss',
...
export class BpjsVisitDataCrudListComponent
