...
@Component({
	selector: 'cb-bpjs-visit-data-crud-edit',
	templateUrl: './bpjs-visit-data-crud-edit.component.html',
	styleUrls: [
		'./bpjs-visit-data-crud-edit.component.scss',
...
export class BpjsVisitDataCrudEditComponent
