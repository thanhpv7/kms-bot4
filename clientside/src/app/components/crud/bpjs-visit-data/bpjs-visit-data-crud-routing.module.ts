...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: BpjsVisitDataCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: BpjsVisitDataCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-visit-data/view/:id',
				component: BpjsVisitDataCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class BpjsVisitDataCrudRoutingModule {
}
