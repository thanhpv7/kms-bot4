 ...
 */
@Component({
	selector: 'cb-bpjs-visit-data-crud',
	templateUrl: './bpjs-visit-data-crud.component.html',
	styleUrls: [
		'./bpjs-visit-data-crud.component.scss',
...
export class BpjsVisitDataCrudComponent implements OnDestroy {
