 ...
 */
@Component({
	selector: 'cb-bpjs-hospitalization-plan-crud',
	templateUrl: './bpjs-hospitalization-plan-crud.component.html',
	styleUrls: [
		'./bpjs-hospitalization-plan-crud.component.scss',
...
export class BpjsHospitalizationPlanCrudComponent implements OnDestroy {
