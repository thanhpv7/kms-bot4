...
@Component({
	selector: 'cb-bpjs-hospitalization-plan-crud-edit',
	templateUrl: './bpjs-hospitalization-plan-crud-edit.component.html',
	styleUrls: [
		'./bpjs-hospitalization-plan-crud-edit.component.scss',
...
export class BpjsHospitalizationPlanCrudEditComponent
