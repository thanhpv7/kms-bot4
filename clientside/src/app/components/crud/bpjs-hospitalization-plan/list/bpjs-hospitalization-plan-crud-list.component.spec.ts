...
import {BpjsHospitalizationPlanCrudListComponent} from './bpjs-hospitalization-plan-crud-list.component';
...
describe('BPJS Hospitalization Plan Crud List Tile Component', () => {
	...
	let fixture;
	let bpjsHospitalizationPlanCrudListComponent: BpjsHospitalizationPlanCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(BpjsHospitalizationPlanCrudListComponent);
