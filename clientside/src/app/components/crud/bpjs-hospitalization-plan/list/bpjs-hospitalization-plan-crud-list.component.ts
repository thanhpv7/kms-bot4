...
@Component({
	selector: 'cb-bpjs-hospitalization-plan-crud-list',
	templateUrl: './bpjs-hospitalization-plan-crud-list.component.html',
	styleUrls: [
		'./bpjs-hospitalization-plan-crud-list.component.scss',
...
export class BpjsHospitalizationPlanCrudListComponent
