...
@Component({
	selector: 'cb-return-supplier-stock-detail-crud-edit',
	templateUrl: './return-supplier-stock-detail-crud-edit.component.html',
	styleUrls: [
		'./return-supplier-stock-detail-crud-edit.component.scss',
...
export class ReturnSupplierStockDetailCrudEditComponent
