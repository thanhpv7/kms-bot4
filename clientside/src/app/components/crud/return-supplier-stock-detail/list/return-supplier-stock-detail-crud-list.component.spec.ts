...
import {ReturnSupplierStockDetailCrudListComponent} from './return-supplier-stock-detail-crud-list.component';
...
describe('Return Supplier Stock Detail Crud List Tile Component', () => {
	...
	let fixture;
	let returnSupplierStockDetailCrudListComponent: ReturnSupplierStockDetailCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(ReturnSupplierStockDetailCrudListComponent);
