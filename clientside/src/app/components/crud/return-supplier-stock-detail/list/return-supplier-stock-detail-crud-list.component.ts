...
@Component({
	selector: 'cb-return-supplier-stock-detail-crud-list',
	templateUrl: './return-supplier-stock-detail-crud-list.component.html',
	styleUrls: [
		'./return-supplier-stock-detail-crud-list.component.scss',
...
export class ReturnSupplierStockDetailCrudListComponent
