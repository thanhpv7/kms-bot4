 ...
 */
@Component({
	selector: 'cb-return-supplier-stock-detail-crud',
	templateUrl: './return-supplier-stock-detail-crud.component.html',
	styleUrls: [
		'./return-supplier-stock-detail-crud.component.scss',
...
export class ReturnSupplierStockDetailCrudComponent implements OnDestroy {
