 ...
 */
@Component({
	selector: 'cb-emergency-medical-examination-record-crud',
	templateUrl: './emergency-medical-examination-record-crud.component.html',
	styleUrls: [
		'./emergency-medical-examination-record-crud.component.scss',
...
export class EmergencyMedicalExaminationRecordCrudComponent implements OnDestroy {
