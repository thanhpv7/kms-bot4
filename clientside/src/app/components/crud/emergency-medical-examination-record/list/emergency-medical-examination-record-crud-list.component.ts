...
import {CrudTileMode} from '../emergency-medical-examination-record-crud.component';
...
@Component({
	selector: 'cb-emergency-medical-examination-record-crud-list',
	templateUrl: './emergency-medical-examination-record-crud-list.component.html',
	styleUrls: [
		'./emergency-medical-examination-record-crud-list.component.scss',
...
export class EmergencyMedicalExaminationRecordCrudListComponent
