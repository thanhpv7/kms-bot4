...
import {EmergencyMedicalExaminationRecordCrudListComponent} from './emergency-medical-examination-record-crud-list.component';
...
describe('Emergency Medical Examination Record Crud List Tile Component', () => {
	...
	let fixture;
	let emergencyMedicalExaminationRecordCrudListComponent: EmergencyMedicalExaminationRecordCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(EmergencyMedicalExaminationRecordCrudListComponent);
