...
import { EmergencyMedicalExaminationRecordCrudModule } from '../emergency-medical-examination-record-crud.module';
import { EmergencyMedicalExaminationRecordCrudEditComponent } from './emergency-medical-examination-record-crud-edit.component';
import {
	EmergencyMedicalExaminationRecordModelState,
	initialState as initialEmergencyMedicalExaminationRecordModelState
} from 'src/app/models/emergencyMedicalExaminationRecord/emergency_medical_examination_record.model.state';
...
describe('Emergency Medical Examination Record CRUD Edit component tests', () => {
	let fixture: ComponentFixture<EmergencyMedicalExaminationRecordCrudEditComponent>
	let component: EmergencyMedicalExaminationRecordCrudEditComponent;

	let emergencyMedicalExaminationRecordModelState: EmergencyMedicalExaminationRecordModelState;

	let store: MockStore<{ model: EmergencyMedicalExaminationRecordModelState }>;
	let routerStore: MockStore<{router: RouterState}>;

	let routerStateBehaviorSubject: BehaviorSubject<RouterState>;
	let emergencyMedicalExaminationRecordCountBehaviorSubject: BehaviorSubject<number>;
	...
	let emergencyMedicalExaminationRecordWithId: EmergencyMedicalExaminationRecordModel = defaultEmergencyMedicalExaminationRecordEntities[0];
	let emergencyMedicalExaminationRecordModelWithIdBehaviorSubject: BehaviorSubject<EmergencyMedicalExaminationRecordModel>;

	emergencyMedicalExaminationRecordWithId.medicalExaminationRecord = defaultMedicalExaminationRecordEntities[0];
	emergencyMedicalExaminationRecordWithId.medicalExaminationRecordId = emergencyMedicalExaminationRecordWithId.medicalExaminationRecord.id;
	let medicalExaminationRecordWithIdBehaviorSubject: BehaviorSubject<MedicalExaminationRecordModel>;


	const routerState: RouterState = {
		url: 'emergency-medical-examination-record-crud',
		urls: ['emergency-medical-examination-record-crud'],
		params: {},
		queryParams: {},
		data: {},
	};
	...
	function spySelectorsInStore() {
		...
		store = TestBed.inject(Store) as MockStore<{ model: EmergencyMedicalExaminationRecordModelState }>;
		routerStore = TestBed.inject(Store) as MockStore<{ router: RouterState }>;

		emergencyMedicalExaminationRecordModelState = initialEmergencyMedicalExaminationRecordModelState;
		store.setState({model: emergencyMedicalExaminationRecordModelState});
		routerStateBehaviorSubject = new BehaviorSubject(routerState);
		emergencyMedicalExaminationRecordCountBehaviorSubject = new BehaviorSubject(defaultEmergencyMedicalExaminationRecordCount);
		...
		emergencyMedicalExaminationRecordModelWithIdBehaviorSubject = new BehaviorSubject(emergencyMedicalExaminationRecordWithId);
		medicalExaminationRecordWithIdBehaviorSubject = new BehaviorSubject(emergencyMedicalExaminationRecordWithId.medicalExaminationRecord);

		spyOn(store, 'select')
			.withArgs(getCountEmergencyMedicalExaminationRecordModels).and.returnValue(emergencyMedicalExaminationRecordCountBehaviorSubject)
			.withArgs(getEmergencyMedicalExaminationRecordModelWithId, emergencyMedicalExaminationRecordWithId.id).and.returnValue(emergencyMedicalExaminationRecordModelWithIdBehaviorSubject)
			...
			.withArgs(getMedicalExaminationRecordModelWithId, emergencyMedicalExaminationRecordWithId.medicalExaminationRecordId).and.returnValue(medicalExaminationRecordWithIdBehaviorSubject)
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			imports: [
				...
				EmergencyMedicalExaminationRecordCrudModule,
			...
			fixture = TestBed.createComponent(EmergencyMedicalExaminationRecordCrudEditComponent);
			component = fixture.debugElement.componentInstance;
			component.ngOnInit();
			component.targetModel = new EmergencyMedicalExaminationRecordModel();
	 ...
	 */
	it ('Renders the Emergency Medical Examination Record CRUD Edit Component', () => {
	...
	*/
	...
	it ('renders related Medical Examination Record entities from model when loading in edit mode', () => {
		component.targetModel = emergencyMedicalExaminationRecordWithId;
		component.targetModelId = emergencyMedicalExaminationRecordWithId.id;
