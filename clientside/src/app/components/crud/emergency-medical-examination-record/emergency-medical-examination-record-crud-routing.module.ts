...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: EmergencyMedicalExaminationRecordCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: EmergencyMedicalExaminationRecordCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'emergency-medical-examination-record/view/:id',
				component: EmergencyMedicalExaminationRecordCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'emergency-medical-examination-record/create',
				component: EmergencyMedicalExaminationRecordCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'emergency-medical-examination-record/edit/:id',
				component: EmergencyMedicalExaminationRecordCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class EmergencyMedicalExaminationRecordCrudRoutingModule {
}
