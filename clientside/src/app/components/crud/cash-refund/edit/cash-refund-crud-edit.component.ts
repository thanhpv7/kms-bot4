...
@Component({
	selector: 'cb-cash-refund-crud-edit',
	templateUrl: './cash-refund-crud-edit.component.html',
	styleUrls: [
		'./cash-refund-crud-edit.component.scss',
...
export class CashRefundCrudEditComponent
