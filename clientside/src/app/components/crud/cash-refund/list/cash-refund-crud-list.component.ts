...
@Component({
	selector: 'cb-cash-refund-crud-list',
	templateUrl: './cash-refund-crud-list.component.html',
	styleUrls: [
		'./cash-refund-crud-list.component.scss',
...
export class CashRefundCrudListComponent
