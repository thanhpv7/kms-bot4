...
import {CashRefundCrudListComponent} from './cash-refund-crud-list.component';
...
describe('Cash Refund Crud List Tile Component', () => {
	...
	let fixture;
	let cashRefundCrudListComponent: CashRefundCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(CashRefundCrudListComponent);
