...
@Component({
	selector: 'cb-warehouse-crud-edit',
	templateUrl: './warehouse-crud-edit.component.html',
	styleUrls: [
		'./warehouse-crud-edit.component.scss',
...
export class WarehouseCrudEditComponent
