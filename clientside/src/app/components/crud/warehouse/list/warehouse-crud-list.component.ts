...
@Component({
	selector: 'cb-warehouse-crud-list',
	templateUrl: './warehouse-crud-list.component.html',
	styleUrls: [
		'./warehouse-crud-list.component.scss',
...
export class WarehouseCrudListComponent
