...
import {WarehouseCrudListComponent} from './warehouse-crud-list.component';
...
describe('Warehouse Crud List Tile Component', () => {
	...
	let fixture;
	let warehouseCrudListComponent: WarehouseCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(WarehouseCrudListComponent);
