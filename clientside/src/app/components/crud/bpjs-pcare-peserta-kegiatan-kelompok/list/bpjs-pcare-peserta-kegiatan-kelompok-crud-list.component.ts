...
@Component({
	selector: 'cb-bpjs-pcare-peserta-kegiatan-kelompok-crud-list',
	templateUrl: './bpjs-pcare-peserta-kegiatan-kelompok-crud-list.component.html',
	styleUrls: [
		'./bpjs-pcare-peserta-kegiatan-kelompok-crud-list.component.scss',
...
export class BpjsPcarePesertaKegiatanKelompokCrudListComponent
