 ...
 */
@Component({
	selector: 'cb-bpjs-pcare-peserta-kegiatan-kelompok-crud',
	templateUrl: './bpjs-pcare-peserta-kegiatan-kelompok-crud.component.html',
	styleUrls: [
		'./bpjs-pcare-peserta-kegiatan-kelompok-crud.component.scss',
...
export class BpjsPcarePesertaKegiatanKelompokCrudComponent implements OnDestroy {
