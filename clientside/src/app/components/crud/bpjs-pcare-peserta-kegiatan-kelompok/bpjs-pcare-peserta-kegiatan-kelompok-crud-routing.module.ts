...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: BpjsPcarePesertaKegiatanKelompokCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: BpjsPcarePesertaKegiatanKelompokCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-pcare-peserta-kegiatan-kelompok/view/:id',
				component: BpjsPcarePesertaKegiatanKelompokCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-pcare-peserta-kegiatan-kelompok/create',
				component: BpjsPcarePesertaKegiatanKelompokCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'bpjs-pcare-peserta-kegiatan-kelompok/edit/:id',
				component: BpjsPcarePesertaKegiatanKelompokCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class BpjsPcarePesertaKegiatanKelompokCrudRoutingModule {
}
