...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: MedicationAdministeredHistoryCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: MedicationAdministeredHistoryCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'medication-administered-history/view/:id',
				component: MedicationAdministeredHistoryCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'medication-administered-history/create',
				component: MedicationAdministeredHistoryCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'medication-administered-history/edit/:id',
				component: MedicationAdministeredHistoryCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class MedicationAdministeredHistoryCrudRoutingModule {
}
