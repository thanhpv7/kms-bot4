...
@Component({
	selector: 'cb-medication-administered-history-crud-edit',
	templateUrl: './medication-administered-history-crud-edit.component.html',
	styleUrls: [
		'./medication-administered-history-crud-edit.component.scss',
...
export class MedicationAdministeredHistoryCrudEditComponent
