...
import {MedicationAdministeredHistoryCrudListComponent} from './medication-administered-history-crud-list.component';
...
describe('Medication Administered History Crud List Tile Component', () => {
	...
	let fixture;
	let medicationAdministeredHistoryCrudListComponent: MedicationAdministeredHistoryCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(MedicationAdministeredHistoryCrudListComponent);
