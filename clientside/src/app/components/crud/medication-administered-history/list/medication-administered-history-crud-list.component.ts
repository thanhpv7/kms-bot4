...
@Component({
	selector: 'cb-medication-administered-history-crud-list',
	templateUrl: './medication-administered-history-crud-list.component.html',
	styleUrls: [
		'./medication-administered-history-crud-list.component.scss',
...
export class MedicationAdministeredHistoryCrudListComponent
