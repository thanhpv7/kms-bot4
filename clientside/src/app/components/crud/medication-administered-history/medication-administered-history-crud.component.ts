 ...
 */
@Component({
	selector: 'cb-medication-administered-history-crud',
	templateUrl: './medication-administered-history-crud.component.html',
	styleUrls: [
		'./medication-administered-history-crud.component.scss',
...
export class MedicationAdministeredHistoryCrudComponent implements OnDestroy {
