 ...
 */
@Component({
	selector: 'cb-patient-detail-crud',
	templateUrl: './patient-detail-crud.component.html',
	styleUrls: [
		'./patient-detail-crud.component.scss',
...
export class PatientDetailCrudComponent implements OnDestroy {
