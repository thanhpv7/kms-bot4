...
@Component({
	selector: 'cb-patient-detail-crud-edit',
	templateUrl: './patient-detail-crud-edit.component.html',
	styleUrls: [
		'./patient-detail-crud-edit.component.scss',
...
export class PatientDetailCrudEditComponent
