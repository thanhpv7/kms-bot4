...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: PatientDetailCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: PatientDetailCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'patient-detail/view/:id',
				component: PatientDetailCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class PatientDetailCrudRoutingModule {
}
