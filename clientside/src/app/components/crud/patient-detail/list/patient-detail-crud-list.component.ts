...
@Component({
	selector: 'cb-patient-detail-crud-list',
	templateUrl: './patient-detail-crud-list.component.html',
	styleUrls: [
		'./patient-detail-crud-list.component.scss',
...
export class PatientDetailCrudListComponent
