...
import {PatientDetailCrudListComponent} from './patient-detail-crud-list.component';
...
describe('Patient Detail Crud List Tile Component', () => {
	...
	let fixture;
	let patientDetailCrudListComponent: PatientDetailCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(PatientDetailCrudListComponent);
