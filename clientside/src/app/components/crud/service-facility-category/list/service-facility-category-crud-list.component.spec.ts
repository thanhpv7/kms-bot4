...
import {ServiceFacilityCategoryCrudListComponent} from './service-facility-category-crud-list.component';
...
describe('Service Facility Category Crud List Tile Component', () => {
	...
	let fixture;
	let serviceFacilityCategoryCrudListComponent: ServiceFacilityCategoryCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(ServiceFacilityCategoryCrudListComponent);
