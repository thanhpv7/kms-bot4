...
@Component({
	selector: 'cb-service-facility-category-crud-list',
	templateUrl: './service-facility-category-crud-list.component.html',
	styleUrls: [
		'./service-facility-category-crud-list.component.scss',
...
export class ServiceFacilityCategoryCrudListComponent
