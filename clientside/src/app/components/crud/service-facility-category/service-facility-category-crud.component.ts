 ...
 */
@Component({
	selector: 'cb-service-facility-category-crud',
	templateUrl: './service-facility-category-crud.component.html',
	styleUrls: [
		'./service-facility-category-crud.component.scss',
...
export class ServiceFacilityCategoryCrudComponent implements OnDestroy {
