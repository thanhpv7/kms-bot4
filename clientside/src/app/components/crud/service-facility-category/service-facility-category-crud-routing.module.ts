...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: ServiceFacilityCategoryCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: ServiceFacilityCategoryCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'service-facility-category/view/:id',
				component: ServiceFacilityCategoryCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'service-facility-category/create',
				component: ServiceFacilityCategoryCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'service-facility-category/edit/:id',
				component: ServiceFacilityCategoryCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class ServiceFacilityCategoryCrudRoutingModule {
}
