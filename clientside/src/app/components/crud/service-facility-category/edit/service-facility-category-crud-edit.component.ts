...
@Component({
	selector: 'cb-service-facility-category-crud-edit',
	templateUrl: './service-facility-category-crud-edit.component.html',
	styleUrls: [
		'./service-facility-category-crud-edit.component.scss',
...
export class ServiceFacilityCategoryCrudEditComponent
