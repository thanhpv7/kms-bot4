...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: PostOperativeDetailsCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: PostOperativeDetailsCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'post-operative-details/view/:id',
				component: PostOperativeDetailsCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'post-operative-details/create',
				component: PostOperativeDetailsCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'post-operative-details/edit/:id',
				component: PostOperativeDetailsCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class PostOperativeDetailsCrudRoutingModule {
}
