 ...
 */
@Component({
	selector: 'cb-post-operative-details-crud',
	templateUrl: './post-operative-details-crud.component.html',
	styleUrls: [
		'./post-operative-details-crud.component.scss',
...
export class PostOperativeDetailsCrudComponent implements OnDestroy {
