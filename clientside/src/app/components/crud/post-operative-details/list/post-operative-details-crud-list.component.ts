...
@Component({
	selector: 'cb-post-operative-details-crud-list',
	templateUrl: './post-operative-details-crud-list.component.html',
	styleUrls: [
		'./post-operative-details-crud-list.component.scss',
...
export class PostOperativeDetailsCrudListComponent
