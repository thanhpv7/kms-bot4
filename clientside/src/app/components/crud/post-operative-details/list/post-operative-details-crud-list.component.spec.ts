...
import {PostOperativeDetailsCrudListComponent} from './post-operative-details-crud-list.component';
...
describe('Post Operative Details Crud List Tile Component', () => {
	...
	let fixture;
	let postOperativeDetailsCrudListComponent: PostOperativeDetailsCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(PostOperativeDetailsCrudListComponent);
