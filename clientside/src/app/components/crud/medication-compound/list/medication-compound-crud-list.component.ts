...
@Component({
	selector: 'cb-medication-compound-crud-list',
	templateUrl: './medication-compound-crud-list.component.html',
	styleUrls: [
		'./medication-compound-crud-list.component.scss',
...
export class MedicationCompoundCrudListComponent
