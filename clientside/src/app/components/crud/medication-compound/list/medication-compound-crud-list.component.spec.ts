...
import {MedicationCompoundCrudListComponent} from './medication-compound-crud-list.component';
...
describe('Medication Compound Crud List Tile Component', () => {
	...
	let fixture;
	let medicationCompoundCrudListComponent: MedicationCompoundCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(MedicationCompoundCrudListComponent);
