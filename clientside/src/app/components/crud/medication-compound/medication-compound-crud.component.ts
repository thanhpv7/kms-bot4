 ...
 */
@Component({
	selector: 'cb-medication-compound-crud',
	templateUrl: './medication-compound-crud.component.html',
	styleUrls: [
		'./medication-compound-crud.component.scss',
...
export class MedicationCompoundCrudComponent implements OnDestroy {
