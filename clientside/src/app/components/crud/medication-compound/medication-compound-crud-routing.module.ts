...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: MedicationCompoundCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: MedicationCompoundCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'medication-compound/view/:id',
				component: MedicationCompoundCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'medication-compound/create',
				component: MedicationCompoundCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'medication-compound/edit/:id',
				component: MedicationCompoundCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class MedicationCompoundCrudRoutingModule {
}
