...
@Component({
	selector: 'cb-bpjs-pcare-kesadaran-crud-edit',
	templateUrl: './bpjs-pcare-kesadaran-crud-edit.component.html',
	styleUrls: [
		'./bpjs-pcare-kesadaran-crud-edit.component.scss',
...
export class BpjsPcareKesadaranCrudEditComponent
