 ...
 */
@Component({
	selector: 'cb-bpjs-pcare-kesadaran-crud',
	templateUrl: './bpjs-pcare-kesadaran-crud.component.html',
	styleUrls: [
		'./bpjs-pcare-kesadaran-crud.component.scss',
...
export class BpjsPcareKesadaranCrudComponent implements OnDestroy {
