...
@Component({
	selector: 'cb-bpjs-pcare-kesadaran-crud-list',
	templateUrl: './bpjs-pcare-kesadaran-crud-list.component.html',
	styleUrls: [
		'./bpjs-pcare-kesadaran-crud-list.component.scss',
...
export class BpjsPcareKesadaranCrudListComponent
