 ...
 */
@Component({
	selector: 'cb-examination-item-crud',
	templateUrl: './examination-item-crud.component.html',
	styleUrls: [
		'./examination-item-crud.component.scss',
...
export class ExaminationItemCrudComponent implements OnDestroy {
