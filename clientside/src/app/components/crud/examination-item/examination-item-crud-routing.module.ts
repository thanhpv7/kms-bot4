...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: ExaminationItemCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: ExaminationItemCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'examination-item/view/:id',
				component: ExaminationItemCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class ExaminationItemCrudRoutingModule {
}
