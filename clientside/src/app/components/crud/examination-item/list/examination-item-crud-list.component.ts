...
@Component({
	selector: 'cb-examination-item-crud-list',
	templateUrl: './examination-item-crud-list.component.html',
	styleUrls: [
		'./examination-item-crud-list.component.scss',
...
export class ExaminationItemCrudListComponent
