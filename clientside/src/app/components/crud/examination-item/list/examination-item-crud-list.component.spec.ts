...
import {ExaminationItemCrudListComponent} from './examination-item-crud-list.component';
...
describe('Examination Item Crud List Tile Component', () => {
	...
	let fixture;
	let examinationItemCrudListComponent: ExaminationItemCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(ExaminationItemCrudListComponent);
