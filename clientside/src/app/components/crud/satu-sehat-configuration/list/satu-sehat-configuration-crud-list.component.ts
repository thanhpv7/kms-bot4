...
@Component({
	selector: 'cb-satu-sehat-configuration-crud-list',
	templateUrl: './satu-sehat-configuration-crud-list.component.html',
	styleUrls: [
		'./satu-sehat-configuration-crud-list.component.scss',
...
export class SatuSehatConfigurationCrudListComponent
