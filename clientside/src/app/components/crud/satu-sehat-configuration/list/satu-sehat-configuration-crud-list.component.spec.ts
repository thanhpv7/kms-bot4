...
import {SatuSehatConfigurationCrudListComponent} from './satu-sehat-configuration-crud-list.component';
...
describe('Satu Sehat Configuration Crud List Tile Component', () => {
	...
	let fixture;
	let satuSehatConfigurationCrudListComponent: SatuSehatConfigurationCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(SatuSehatConfigurationCrudListComponent);
