...
@Component({
	selector: 'cb-satu-sehat-configuration-crud-edit',
	templateUrl: './satu-sehat-configuration-crud-edit.component.html',
	styleUrls: [
		'./satu-sehat-configuration-crud-edit.component.scss',
...
export class SatuSehatConfigurationCrudEditComponent
