 ...
 */
@Component({
	selector: 'cb-satu-sehat-configuration-crud',
	templateUrl: './satu-sehat-configuration-crud.component.html',
	styleUrls: [
		'./satu-sehat-configuration-crud.component.scss',
...
export class SatuSehatConfigurationCrudComponent implements OnDestroy {
