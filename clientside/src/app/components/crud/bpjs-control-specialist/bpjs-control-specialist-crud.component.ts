 ...
 */
@Component({
	selector: 'cb-bpjs-control-specialist-crud',
	templateUrl: './bpjs-control-specialist-crud.component.html',
	styleUrls: [
		'./bpjs-control-specialist-crud.component.scss',
...
export class BpjsControlSpecialistCrudComponent implements OnDestroy {
