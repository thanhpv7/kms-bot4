...
@Component({
	selector: 'cb-bpjs-control-specialist-crud-edit',
	templateUrl: './bpjs-control-specialist-crud-edit.component.html',
	styleUrls: [
		'./bpjs-control-specialist-crud-edit.component.scss',
...
export class BpjsControlSpecialistCrudEditComponent
