...
@Component({
	selector: 'cb-bpjs-control-specialist-crud-list',
	templateUrl: './bpjs-control-specialist-crud-list.component.html',
	styleUrls: [
		'./bpjs-control-specialist-crud-list.component.scss',
...
export class BpjsControlSpecialistCrudListComponent
