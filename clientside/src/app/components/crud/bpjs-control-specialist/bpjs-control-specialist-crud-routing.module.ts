...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: BpjsControlSpecialistCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: BpjsControlSpecialistCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-control-specialist/view/:id',
				component: BpjsControlSpecialistCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-control-specialist/create',
				component: BpjsControlSpecialistCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'bpjs-control-specialist/edit/:id',
				component: BpjsControlSpecialistCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class BpjsControlSpecialistCrudRoutingModule {
}
