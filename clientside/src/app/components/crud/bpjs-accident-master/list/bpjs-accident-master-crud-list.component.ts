...
import {CrudTileMode} from '../bpjs-accident-master-crud.component';
...
@Component({
	selector: 'cb-bpjs-accident-master-crud-list',
	templateUrl: './bpjs-accident-master-crud-list.component.html',
	styleUrls: [
		'./bpjs-accident-master-crud-list.component.scss',
...
export class BpjsAccidentMasterCrudListComponent
