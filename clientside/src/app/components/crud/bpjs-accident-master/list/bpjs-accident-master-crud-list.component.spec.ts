...
import {BpjsAccidentMasterCrudListComponent} from './bpjs-accident-master-crud-list.component';
...
import {BpjsAccidentMasterCrudModule} from '../bpjs-accident-master-crud.module';
import {
...
describe('BPJS Accident Master Crud List Tile Component', () => {
	...
	let fixture;
	let bpjsAccidentMasterCrudListComponent: BpjsAccidentMasterCrudListComponent;
	...
	const routerState: RouterState = {
		url: 'bpjs-accident-master-crud',
		urls: ['bpjs-accident-master-crud'],
		params: {},
		queryParams: {},
		data: {},
	};
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(BpjsAccidentMasterCrudListComponent);
