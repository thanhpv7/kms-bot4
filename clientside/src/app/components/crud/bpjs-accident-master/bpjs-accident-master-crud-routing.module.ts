...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: BpjsAccidentMasterCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: BpjsAccidentMasterCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-accident-master/view/:id',
				component: BpjsAccidentMasterCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-accident-master/create',
				component: BpjsAccidentMasterCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'bpjs-accident-master/edit/:id',
				component: BpjsAccidentMasterCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class BpjsAccidentMasterCrudRoutingModule {
}
