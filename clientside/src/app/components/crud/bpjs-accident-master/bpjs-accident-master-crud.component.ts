 ...
 */
@Component({
	selector: 'cb-bpjs-accident-master-crud',
	templateUrl: './bpjs-accident-master-crud.component.html',
	styleUrls: [
		'./bpjs-accident-master-crud.component.scss',
...
export class BpjsAccidentMasterCrudComponent implements OnDestroy {
