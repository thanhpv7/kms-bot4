...
import { BpjsAccidentMasterCrudEditComponent } from './bpjs-accident-master-crud-edit.component';
import {
...
describe('BPJS Accident Master CRUD Edit component tests', () => {
	let fixture: ComponentFixture<BpjsAccidentMasterCrudEditComponent>
	let component: BpjsAccidentMasterCrudEditComponent;
	...
	let bpjsAccidentMasterCountBehaviorSubject: BehaviorSubject<number>;
	...
	let bpjsAccidentMasterWithId: BpjsAccidentMasterModel = defaultBpjsAccidentMasterEntities[0];
	let bpjsAccidentMasterModelWithIdBehaviorSubject: BehaviorSubject<BpjsAccidentMasterModel>;

	bpjsAccidentMasterWithId.patientPaymentBPJS = defaultPatientPaymentBPJSEntities[0];
	bpjsAccidentMasterWithId.patientPaymentBPJSId = bpjsAccidentMasterWithId.patientPaymentBPJS.id;
	...
	function spySelectorsInStore() {
		...
		bpjsAccidentMasterCountBehaviorSubject = new BehaviorSubject(defaultBpjsAccidentMasterCount);
		...
		bpjsAccidentMasterModelWithIdBehaviorSubject = new BehaviorSubject(bpjsAccidentMasterWithId);
		patientPaymentBPJSWithIdBehaviorSubject = new BehaviorSubject(bpjsAccidentMasterWithId.patientPaymentBPJS);

		spyOn(store, 'select')
			.withArgs(getCountBpjsAccidentMasterModels).and.returnValue(bpjsAccidentMasterCountBehaviorSubject)
			.withArgs(getBpjsAccidentMasterModelWithId, bpjsAccidentMasterWithId.id).and.returnValue(bpjsAccidentMasterModelWithIdBehaviorSubject)
			...
			.withArgs(getPatientPaymentBPJSModelWithId, bpjsAccidentMasterWithId.patientPaymentBPJSId).and.returnValue(patientPaymentBPJSWithIdBehaviorSubject)
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(BpjsAccidentMasterCrudEditComponent);
			component = fixture.debugElement.componentInstance;
			component.ngOnInit();
			component.targetModel = new BpjsAccidentMasterModel();
	 ...
	 */
	it ('Renders the BPJS Accident Master CRUD Edit Component', () => {
	...
	*/
	...
	it ('renders related Patient Payment BPJS entities from model when loading in edit mode', () => {
		component.targetModel = bpjsAccidentMasterWithId;
		component.targetModelId = bpjsAccidentMasterWithId.id;
