...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: PurchaseRequisitionStockDetailCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: PurchaseRequisitionStockDetailCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'purchase-requisition-stock-detail/view/:id',
				component: PurchaseRequisitionStockDetailCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'purchase-requisition-stock-detail/create',
				component: PurchaseRequisitionStockDetailCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'purchase-requisition-stock-detail/edit/:id',
				component: PurchaseRequisitionStockDetailCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class PurchaseRequisitionStockDetailCrudRoutingModule {
}
