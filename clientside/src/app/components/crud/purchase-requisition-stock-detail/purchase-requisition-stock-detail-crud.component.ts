 ...
 */
@Component({
	selector: 'cb-purchase-requisition-stock-detail-crud',
	templateUrl: './purchase-requisition-stock-detail-crud.component.html',
	styleUrls: [
		'./purchase-requisition-stock-detail-crud.component.scss',
...
export class PurchaseRequisitionStockDetailCrudComponent implements OnDestroy {
