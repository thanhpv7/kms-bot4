...
@Component({
	selector: 'cb-purchase-requisition-stock-detail-crud-list',
	templateUrl: './purchase-requisition-stock-detail-crud-list.component.html',
	styleUrls: [
		'./purchase-requisition-stock-detail-crud-list.component.scss',
...
export class PurchaseRequisitionStockDetailCrudListComponent
