...
import {PurchaseRequisitionStockDetailCrudListComponent} from './purchase-requisition-stock-detail-crud-list.component';
...
describe('Purchase Requisition Stock Detail Crud List Tile Component', () => {
	...
	let fixture;
	let purchaseRequisitionStockDetailCrudListComponent: PurchaseRequisitionStockDetailCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(PurchaseRequisitionStockDetailCrudListComponent);
