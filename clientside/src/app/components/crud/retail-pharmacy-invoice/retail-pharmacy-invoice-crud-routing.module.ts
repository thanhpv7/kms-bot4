...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: RetailPharmacyInvoiceCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: RetailPharmacyInvoiceCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'retail-pharmacy-invoice/view/:id',
				component: RetailPharmacyInvoiceCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'retail-pharmacy-invoice/create',
				component: RetailPharmacyInvoiceCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'retail-pharmacy-invoice/edit/:id',
				component: RetailPharmacyInvoiceCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class RetailPharmacyInvoiceCrudRoutingModule {
}
