...
import {RetailPharmacyInvoiceCrudListComponent} from './retail-pharmacy-invoice-crud-list.component';
...
describe('Retail Pharmacy Invoice Crud List Tile Component', () => {
	...
	let fixture;
	let retailPharmacyInvoiceCrudListComponent: RetailPharmacyInvoiceCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(RetailPharmacyInvoiceCrudListComponent);
