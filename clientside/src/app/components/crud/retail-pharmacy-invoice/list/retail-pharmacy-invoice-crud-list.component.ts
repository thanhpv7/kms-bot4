...
@Component({
	selector: 'cb-retail-pharmacy-invoice-crud-list',
	templateUrl: './retail-pharmacy-invoice-crud-list.component.html',
	styleUrls: [
		'./retail-pharmacy-invoice-crud-list.component.scss',
...
export class RetailPharmacyInvoiceCrudListComponent
