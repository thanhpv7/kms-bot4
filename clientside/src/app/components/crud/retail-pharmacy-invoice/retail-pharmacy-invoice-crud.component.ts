 ...
 */
@Component({
	selector: 'cb-retail-pharmacy-invoice-crud',
	templateUrl: './retail-pharmacy-invoice-crud.component.html',
	styleUrls: [
		'./retail-pharmacy-invoice-crud.component.scss',
...
export class RetailPharmacyInvoiceCrudComponent implements OnDestroy {
