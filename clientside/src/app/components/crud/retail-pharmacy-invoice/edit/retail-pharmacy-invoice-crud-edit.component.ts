...
@Component({
	selector: 'cb-retail-pharmacy-invoice-crud-edit',
	templateUrl: './retail-pharmacy-invoice-crud-edit.component.html',
	styleUrls: [
		'./retail-pharmacy-invoice-crud-edit.component.scss',
...
export class RetailPharmacyInvoiceCrudEditComponent
