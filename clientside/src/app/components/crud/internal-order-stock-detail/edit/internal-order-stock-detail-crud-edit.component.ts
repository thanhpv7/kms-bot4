...
import {CrudTileMode} from '../internal-order-stock-detail-crud.component';
...
@Component({
	selector: 'cb-internal-order-stock-detail-crud-edit',
	templateUrl: './internal-order-stock-detail-crud-edit.component.html',
	styleUrls: [
		'./internal-order-stock-detail-crud-edit.component.scss',
...
export class InternalOrderStockDetailCrudEditComponent
