 ...
 */
@Component({
	selector: 'cb-internal-order-stock-detail-crud',
	templateUrl: './internal-order-stock-detail-crud.component.html',
	styleUrls: [
		'./internal-order-stock-detail-crud.component.scss',
...
export class InternalOrderStockDetailCrudComponent implements OnDestroy {
