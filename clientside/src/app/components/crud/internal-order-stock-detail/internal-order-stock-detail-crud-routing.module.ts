...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: InternalOrderStockDetailCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: InternalOrderStockDetailCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'internal-order-stock-detail/view/:id',
				component: InternalOrderStockDetailCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'internal-order-stock-detail/create',
				component: InternalOrderStockDetailCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'internal-order-stock-detail/edit/:id',
				component: InternalOrderStockDetailCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class InternalOrderStockDetailCrudRoutingModule {
}
