...
@Component({
	selector: 'cb-internal-order-stock-detail-crud-list',
	templateUrl: './internal-order-stock-detail-crud-list.component.html',
	styleUrls: [
		'./internal-order-stock-detail-crud-list.component.scss',
...
export class InternalOrderStockDetailCrudListComponent
