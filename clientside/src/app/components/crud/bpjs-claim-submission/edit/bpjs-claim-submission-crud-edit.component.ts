...
@Component({
	selector: 'cb-bpjs-claim-submission-crud-edit',
	templateUrl: './bpjs-claim-submission-crud-edit.component.html',
	styleUrls: [
		'./bpjs-claim-submission-crud-edit.component.scss',
...
export class BpjsClaimSubmissionCrudEditComponent
