...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: BpjsClaimSubmissionCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: BpjsClaimSubmissionCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-claim-submission/view/:id',
				component: BpjsClaimSubmissionCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-claim-submission/create',
				component: BpjsClaimSubmissionCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'bpjs-claim-submission/edit/:id',
				component: BpjsClaimSubmissionCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class BpjsClaimSubmissionCrudRoutingModule {
}
