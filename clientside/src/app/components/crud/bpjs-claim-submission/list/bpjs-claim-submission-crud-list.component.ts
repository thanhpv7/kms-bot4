...
@Component({
	selector: 'cb-bpjs-claim-submission-crud-list',
	templateUrl: './bpjs-claim-submission-crud-list.component.html',
	styleUrls: [
		'./bpjs-claim-submission-crud-list.component.scss',
...
export class BpjsClaimSubmissionCrudListComponent
