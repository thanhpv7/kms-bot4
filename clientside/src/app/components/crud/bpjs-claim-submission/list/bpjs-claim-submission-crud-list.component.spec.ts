...
import {BpjsClaimSubmissionCrudListComponent} from './bpjs-claim-submission-crud-list.component';
...
describe('BPJS Claim Submission Crud List Tile Component', () => {
	...
	let fixture;
	let bpjsClaimSubmissionCrudListComponent: BpjsClaimSubmissionCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(BpjsClaimSubmissionCrudListComponent);
