 ...
 */
@Component({
	selector: 'cb-bpjs-claim-submission-crud',
	templateUrl: './bpjs-claim-submission-crud.component.html',
	styleUrls: [
		'./bpjs-claim-submission-crud.component.scss',
...
export class BpjsClaimSubmissionCrudComponent implements OnDestroy {
