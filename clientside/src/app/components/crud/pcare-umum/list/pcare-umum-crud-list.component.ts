...
import {CrudTileMode} from '../pcare-umum-crud.component';
...
@Component({
	selector: 'cb-pcare-umum-crud-list',
	templateUrl: './pcare-umum-crud-list.component.html',
	styleUrls: [
		'./pcare-umum-crud-list.component.scss',
...
export class PcareUmumCrudListComponent
