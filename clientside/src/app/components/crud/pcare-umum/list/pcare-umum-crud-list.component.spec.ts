...
import {PcareUmumCrudListComponent} from './pcare-umum-crud-list.component';
...
import {PcareUmumCrudModule} from '../pcare-umum-crud.module';
import {
	PcareUmumModelState,
...
describe('PCare Umum Crud List Tile Component', () => {
	...
	let fixture;
	let pcareUmumCrudListComponent: PcareUmumCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(PcareUmumCrudListComponent);
