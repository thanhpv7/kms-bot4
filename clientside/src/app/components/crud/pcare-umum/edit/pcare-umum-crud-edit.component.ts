...
@Component({
	selector: 'cb-pcare-umum-crud-edit',
	templateUrl: './pcare-umum-crud-edit.component.html',
	styleUrls: [
		'./pcare-umum-crud-edit.component.scss',
...
export class PcareUmumCrudEditComponent
