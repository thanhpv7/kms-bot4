...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: PcareUmumCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: PcareUmumCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'pcare-umum/view/:id',
				component: PcareUmumCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class PcareUmumCrudRoutingModule {
}
