 ...
 */
@Component({
	selector: 'cb-pcare-umum-crud',
	templateUrl: './pcare-umum-crud.component.html',
	styleUrls: [
		'./pcare-umum-crud.component.scss',
...
export class PcareUmumCrudComponent implements OnDestroy {
