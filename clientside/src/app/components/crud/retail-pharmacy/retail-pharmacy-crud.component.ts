 ...
 */
@Component({
	selector: 'cb-retail-pharmacy-crud',
	templateUrl: './retail-pharmacy-crud.component.html',
	styleUrls: [
		'./retail-pharmacy-crud.component.scss',
...
export class RetailPharmacyCrudComponent implements OnDestroy {
