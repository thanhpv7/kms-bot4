...
@Component({
	selector: 'cb-retail-pharmacy-crud-edit',
	templateUrl: './retail-pharmacy-crud-edit.component.html',
	styleUrls: [
		'./retail-pharmacy-crud-edit.component.scss',
...
export class RetailPharmacyCrudEditComponent
