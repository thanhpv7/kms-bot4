...
@Component({
	selector: 'cb-retail-pharmacy-crud-list',
	templateUrl: './retail-pharmacy-crud-list.component.html',
	styleUrls: [
		'./retail-pharmacy-crud-list.component.scss',
...
export class RetailPharmacyCrudListComponent
