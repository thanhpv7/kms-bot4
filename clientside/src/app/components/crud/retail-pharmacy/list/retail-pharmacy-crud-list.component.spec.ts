...
import {RetailPharmacyCrudListComponent} from './retail-pharmacy-crud-list.component';
...
describe('Retail Pharmacy Crud List Tile Component', () => {
	...
	let fixture;
	let retailPharmacyCrudListComponent: RetailPharmacyCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(RetailPharmacyCrudListComponent);
