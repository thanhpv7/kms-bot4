...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: RetailPharmacyCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: RetailPharmacyCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'retail-pharmacy/view/:id',
				component: RetailPharmacyCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class RetailPharmacyCrudRoutingModule {
}
