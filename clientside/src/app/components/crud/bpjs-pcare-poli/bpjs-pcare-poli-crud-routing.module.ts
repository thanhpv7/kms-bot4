...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: BpjsPcarePoliCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: BpjsPcarePoliCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-pcare-poli/view/:id',
				component: BpjsPcarePoliCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class BpjsPcarePoliCrudRoutingModule {
}
