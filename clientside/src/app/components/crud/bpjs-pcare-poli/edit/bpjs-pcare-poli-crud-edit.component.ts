...
@Component({
	selector: 'cb-bpjs-pcare-poli-crud-edit',
	templateUrl: './bpjs-pcare-poli-crud-edit.component.html',
	styleUrls: [
		'./bpjs-pcare-poli-crud-edit.component.scss',
...
export class BpjsPcarePoliCrudEditComponent
