...
import { BpjsPcarePoliCrudEditComponent } from './bpjs-pcare-poli-crud-edit.component';
import {
...
describe('BPJS Pcare Poli CRUD Edit component tests', () => {
	let fixture: ComponentFixture<BpjsPcarePoliCrudEditComponent>
	let component: BpjsPcarePoliCrudEditComponent;
	...
	let bpjsPcarePoliCountBehaviorSubject: BehaviorSubject<number>;
	...
	let bpjsPcarePoliWithId: BpjsPcarePoliModel = defaultBpjsPcarePoliEntities[0];
	let bpjsPcarePoliModelWithIdBehaviorSubject: BehaviorSubject<BpjsPcarePoliModel>;

	bpjsPcarePoliWithId.service = defaultServiceEntities[0];
	bpjsPcarePoliWithId.serviceId = bpjsPcarePoliWithId.service.id;
	...
	function spySelectorsInStore() {
		...
		bpjsPcarePoliCountBehaviorSubject = new BehaviorSubject(defaultBpjsPcarePoliCount);
		...
		bpjsPcarePoliModelWithIdBehaviorSubject = new BehaviorSubject(bpjsPcarePoliWithId);
		serviceWithIdBehaviorSubject = new BehaviorSubject(bpjsPcarePoliWithId.service);

		spyOn(store, 'select')
			.withArgs(getCountBpjsPcarePoliModels).and.returnValue(bpjsPcarePoliCountBehaviorSubject)
			.withArgs(getBpjsPcarePoliModelWithId, bpjsPcarePoliWithId.id).and.returnValue(bpjsPcarePoliModelWithIdBehaviorSubject)
			...
			.withArgs(getServiceModelWithId, bpjsPcarePoliWithId.serviceId).and.returnValue(serviceWithIdBehaviorSubject)
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(BpjsPcarePoliCrudEditComponent);
			component = fixture.debugElement.componentInstance;
			component.ngOnInit();
			component.targetModel = new BpjsPcarePoliModel();
	 ...
	 */
	it ('Renders the BPJS Pcare Poli CRUD Edit Component', () => {
	...
	*/
	...
	it ('renders related Service entities from model when loading in edit mode', () => {
		component.targetModel = bpjsPcarePoliWithId;
		component.targetModelId = bpjsPcarePoliWithId.id;
