...
import {CrudTileMode} from '../bpjs-pcare-poli-crud.component';
...
@Component({
	selector: 'cb-bpjs-pcare-poli-crud-list',
	templateUrl: './bpjs-pcare-poli-crud-list.component.html',
	styleUrls: [
		'./bpjs-pcare-poli-crud-list.component.scss',
...
export class BpjsPcarePoliCrudListComponent
