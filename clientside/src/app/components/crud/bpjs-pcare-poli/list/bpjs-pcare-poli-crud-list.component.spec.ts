...
import {BpjsPcarePoliCrudListComponent} from './bpjs-pcare-poli-crud-list.component';
...
import {BpjsPcarePoliCrudModule} from '../bpjs-pcare-poli-crud.module';
import {
...
describe('BPJS Pcare Poli Crud List Tile Component', () => {
	...
	let fixture;
	let bpjsPcarePoliCrudListComponent: BpjsPcarePoliCrudListComponent;
	...
	const routerState: RouterState = {
		url: 'bpjs-pcare-poli-crud',
		urls: ['bpjs-pcare-poli-crud'],
		params: {},
		queryParams: {},
		data: {},
	};
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(BpjsPcarePoliCrudListComponent);
