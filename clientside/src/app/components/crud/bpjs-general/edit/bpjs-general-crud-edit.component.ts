...
@Component({
	selector: 'cb-bpjs-general-crud-edit',
	templateUrl: './bpjs-general-crud-edit.component.html',
	styleUrls: [
		'./bpjs-general-crud-edit.component.scss',
...
export class BpjsGeneralCrudEditComponent
