 ...
 */
@Component({
	selector: 'cb-bpjs-general-crud',
	templateUrl: './bpjs-general-crud.component.html',
	styleUrls: [
		'./bpjs-general-crud.component.scss',
...
export class BpjsGeneralCrudComponent implements OnDestroy {
