...
@Component({
	selector: 'cb-bpjs-general-crud-list',
	templateUrl: './bpjs-general-crud-list.component.html',
	styleUrls: [
		'./bpjs-general-crud-list.component.scss',
...
export class BpjsGeneralCrudListComponent
