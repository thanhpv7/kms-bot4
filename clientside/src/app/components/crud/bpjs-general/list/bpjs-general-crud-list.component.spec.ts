...
import {BpjsGeneralCrudListComponent} from './bpjs-general-crud-list.component';
...
describe('BPJS General Crud List Tile Component', () => {
	...
	let fixture;
	let bpjsGeneralCrudListComponent: BpjsGeneralCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(BpjsGeneralCrudListComponent);
