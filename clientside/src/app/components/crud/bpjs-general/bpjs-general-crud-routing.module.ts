...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: BpjsGeneralCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: BpjsGeneralCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-general/view/:id',
				component: BpjsGeneralCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class BpjsGeneralCrudRoutingModule {
}
