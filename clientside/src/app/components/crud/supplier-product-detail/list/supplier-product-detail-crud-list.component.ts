...
@Component({
	selector: 'cb-supplier-product-detail-crud-list',
	templateUrl: './supplier-product-detail-crud-list.component.html',
	styleUrls: [
		'./supplier-product-detail-crud-list.component.scss',
...
export class SupplierProductDetailCrudListComponent
