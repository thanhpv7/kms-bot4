...
import {SupplierProductDetailCrudRoutingModule} from './supplier-product-detail-crud-routing.module';
...
@NgModule({
	declarations: [
		SupplierProductDetailCrudListComponent,
		SupplierProductDetailCrudEditComponent,
		SupplierProductDetailCrudComponent,
	...
	imports: [
		...
		CommonPipeModule,
		SupplierProductDetailCrudRoutingModule,
...
export class SupplierProductDetailCrudModule {
}
