...
@Component({
	selector: 'cb-supplier-product-detail-crud-edit',
	templateUrl: './supplier-product-detail-crud-edit.component.html',
	styleUrls: [
		'./supplier-product-detail-crud-edit.component.scss',
...
export class SupplierProductDetailCrudEditComponent
