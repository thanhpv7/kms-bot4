 ...
 */
@Component({
	selector: 'cb-supplier-product-detail-crud',
	templateUrl: './supplier-product-detail-crud.component.html',
	styleUrls: [
		'./supplier-product-detail-crud.component.scss',
...
export class SupplierProductDetailCrudComponent implements OnDestroy {
