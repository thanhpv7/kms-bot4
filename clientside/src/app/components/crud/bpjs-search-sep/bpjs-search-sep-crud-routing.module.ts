...
import {BpjsSearchSEPCrudListComponent} from './list/bpjs-search-sep-crud-list.component';
import {BpjsSearchSEPCrudEditComponent} from './edit/bpjs-search-sep-crud-edit.component';
import {BpjsSearchSEPCrudComponent} from './bpjs-search-sep-crud.component';
...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: BpjsSearchSEPCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: BpjsSearchSEPCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-search-sep/view/:id',
				component: BpjsSearchSEPCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class BpjsSearchSEPCrudRoutingModule {
}
