...
@Component({
	selector: 'cb-bpjs-search-sep-crud-edit',
	templateUrl: './bpjs-search-sep-crud-edit.component.html',
	styleUrls: [
		'./bpjs-search-sep-crud-edit.component.scss',
...
export class BpjsSearchSEPCrudEditComponent
