...
import {CrudTileMode} from '../bpjs-search-sep-crud.component';
...
@Component({
	selector: 'cb-bpjs-search-sep-crud-list',
	templateUrl: './bpjs-search-sep-crud-list.component.html',
	styleUrls: [
		'./bpjs-search-sep-crud-list.component.scss',
...
export class BpjsSearchSEPCrudListComponent
