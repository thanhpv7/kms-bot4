...
import {BpjsSearchSEPCrudListComponent} from './bpjs-search-sep-crud-list.component';
...
import {BpjsSearchSEPCrudModule} from '../bpjs-search-sep-crud.module';
import {
...
describe('BPJS Search SEP Crud List Tile Component', () => {
	...
	let fixture;
	let bpjsSearchSEPCrudListComponent: BpjsSearchSEPCrudListComponent;
	...
	const routerState: RouterState = {
		url: 'bpjs-search-sep-crud',
		urls: ['bpjs-search-sep-crud'],
		params: {},
		queryParams: {},
		data: {},
	};
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(BpjsSearchSEPCrudListComponent);
