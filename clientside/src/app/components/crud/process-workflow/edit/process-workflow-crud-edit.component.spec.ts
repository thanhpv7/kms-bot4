...
import { ProcessWorkflowCrudEditComponent } from './process-workflow-crud-edit.component';
import {
...
describe('Process Workflow CRUD Edit component tests', () => {
	let fixture: ComponentFixture<ProcessWorkflowCrudEditComponent>
	let component: ProcessWorkflowCrudEditComponent;
	...
	let processWorkflowCountBehaviorSubject: BehaviorSubject<number>;
	...
	let processWorkflowWithId: ProcessWorkflowModel = defaultProcessWorkflowEntities[0];
	let processWorkflowModelWithIdBehaviorSubject: BehaviorSubject<ProcessWorkflowModel>;

	processWorkflowWithId.staff = defaultStaffEntities[0];
	processWorkflowWithId.staffId = processWorkflowWithId.staff.id;
	...
	function spySelectorsInStore() {
		...
		processWorkflowCountBehaviorSubject = new BehaviorSubject(defaultProcessWorkflowCount);
		...
		processWorkflowModelWithIdBehaviorSubject = new BehaviorSubject(processWorkflowWithId);
		staffWithIdBehaviorSubject = new BehaviorSubject(processWorkflowWithId.staff);

		spyOn(store, 'select')
			.withArgs(getCountProcessWorkflowModels).and.returnValue(processWorkflowCountBehaviorSubject)
			.withArgs(getProcessWorkflowModelWithId, processWorkflowWithId.id).and.returnValue(processWorkflowModelWithIdBehaviorSubject)
			...
			.withArgs(getStaffModelWithId, processWorkflowWithId.staffId).and.returnValue(staffWithIdBehaviorSubject)
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(ProcessWorkflowCrudEditComponent);
			component = fixture.debugElement.componentInstance;
			component.ngOnInit();
			component.targetModel = new ProcessWorkflowModel();
	 ...
	 */
	it ('Renders the Process Workflow CRUD Edit Component', () => {
	...
	*/
	...
	it ('renders related Staff entities from model when loading in edit mode', () => {
		component.targetModel = processWorkflowWithId;
		component.targetModelId = processWorkflowWithId.id;
