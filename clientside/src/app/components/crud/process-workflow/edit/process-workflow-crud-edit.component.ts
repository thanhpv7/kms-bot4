...
@Component({
	selector: 'cb-process-workflow-crud-edit',
	templateUrl: './process-workflow-crud-edit.component.html',
	styleUrls: [
		'./process-workflow-crud-edit.component.scss',
...
export class ProcessWorkflowCrudEditComponent
