...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: ProcessWorkflowCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: ProcessWorkflowCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'process-workflow/view/:id',
				component: ProcessWorkflowCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class ProcessWorkflowCrudRoutingModule {
}
