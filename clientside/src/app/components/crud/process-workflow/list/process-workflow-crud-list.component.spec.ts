...
import {ProcessWorkflowCrudListComponent} from './process-workflow-crud-list.component';
...
import {ProcessWorkflowCrudModule} from '../process-workflow-crud.module';
import {
...
describe('Process Workflow Crud List Tile Component', () => {
	...
	let fixture;
	let processWorkflowCrudListComponent: ProcessWorkflowCrudListComponent;
	...
	const routerState: RouterState = {
		url: 'process-workflow-crud',
		urls: ['process-workflow-crud'],
		params: {},
		queryParams: {},
		data: {},
	};
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(ProcessWorkflowCrudListComponent);
