...
import {CrudTileMode} from '../process-workflow-crud.component';
...
@Component({
	selector: 'cb-process-workflow-crud-list',
	templateUrl: './process-workflow-crud-list.component.html',
	styleUrls: [
		'./process-workflow-crud-list.component.scss',
...
export class ProcessWorkflowCrudListComponent
