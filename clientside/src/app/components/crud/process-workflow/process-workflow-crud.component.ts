 ...
 */
@Component({
	selector: 'cb-process-workflow-crud',
	templateUrl: './process-workflow-crud.component.html',
	styleUrls: [
		'./process-workflow-crud.component.scss',
...
export class ProcessWorkflowCrudComponent implements OnDestroy {
