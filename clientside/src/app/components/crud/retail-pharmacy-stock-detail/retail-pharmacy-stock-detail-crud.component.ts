 ...
 */
@Component({
	selector: 'cb-retail-pharmacy-stock-detail-crud',
	templateUrl: './retail-pharmacy-stock-detail-crud.component.html',
	styleUrls: [
		'./retail-pharmacy-stock-detail-crud.component.scss',
...
export class RetailPharmacyStockDetailCrudComponent implements OnDestroy {
