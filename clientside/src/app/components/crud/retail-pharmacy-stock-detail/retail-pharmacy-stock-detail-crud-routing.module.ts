...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: RetailPharmacyStockDetailCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: RetailPharmacyStockDetailCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'retail-pharmacy-stock-detail/view/:id',
				component: RetailPharmacyStockDetailCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'retail-pharmacy-stock-detail/create',
				component: RetailPharmacyStockDetailCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'retail-pharmacy-stock-detail/edit/:id',
				component: RetailPharmacyStockDetailCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class RetailPharmacyStockDetailCrudRoutingModule {
}
