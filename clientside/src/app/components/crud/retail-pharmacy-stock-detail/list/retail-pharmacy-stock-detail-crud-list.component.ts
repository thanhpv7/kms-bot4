...
import {CrudTileMode} from '../retail-pharmacy-stock-detail-crud.component';
...
@Component({
	selector: 'cb-retail-pharmacy-stock-detail-crud-list',
	templateUrl: './retail-pharmacy-stock-detail-crud-list.component.html',
	styleUrls: [
		'./retail-pharmacy-stock-detail-crud-list.component.scss',
...
export class RetailPharmacyStockDetailCrudListComponent
