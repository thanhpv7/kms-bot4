...
import {RetailPharmacyStockDetailCrudListComponent} from './retail-pharmacy-stock-detail-crud-list.component';
...
import {RetailPharmacyStockDetailCrudModule} from '../retail-pharmacy-stock-detail-crud.module';
import {
...
describe('Retail Pharmacy Stock Detail Crud List Tile Component', () => {
	...
	let fixture;
	let retailPharmacyStockDetailCrudListComponent: RetailPharmacyStockDetailCrudListComponent;
	...
	const routerState: RouterState = {
		url: 'retail-pharmacy-stock-detail-crud',
		urls: ['retail-pharmacy-stock-detail-crud'],
		params: {},
		queryParams: {},
		data: {},
	};
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			imports: [
				...
				RetailPharmacyStockDetailCrudModule,
			],
			providers: [
				provideMockStore(),
				{
			...
			fixture = TestBed.createComponent(RetailPharmacyStockDetailCrudListComponent);
