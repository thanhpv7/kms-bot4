...
import { RetailPharmacyStockDetailCrudEditComponent } from './retail-pharmacy-stock-detail-crud-edit.component';
import {
...
describe('Retail Pharmacy Stock Detail CRUD Edit component tests', () => {
	let fixture: ComponentFixture<RetailPharmacyStockDetailCrudEditComponent>
	let component: RetailPharmacyStockDetailCrudEditComponent;
	...
	let retailPharmacyStockDetailCountBehaviorSubject: BehaviorSubject<number>;
	...
	let retailPharmacyStockDetailWithId: RetailPharmacyStockDetailModel = defaultRetailPharmacyStockDetailEntities[0];
	let retailPharmacyStockDetailModelWithIdBehaviorSubject: BehaviorSubject<RetailPharmacyStockDetailModel>;

	retailPharmacyStockDetailWithId.retailPharmacy = defaultRetailPharmacyEntities[0];
	retailPharmacyStockDetailWithId.retailPharmacyId = retailPharmacyStockDetailWithId.retailPharmacy.id;
	let retailPharmacyWithIdBehaviorSubject: BehaviorSubject<RetailPharmacyModel>;

	retailPharmacyStockDetailWithId.stockCatalogue = defaultStockCatalogueEntities[0];
	retailPharmacyStockDetailWithId.stockCatalogueId = retailPharmacyStockDetailWithId.stockCatalogue.id;
	...
	function spySelectorsInStore() {
		...
		retailPharmacyStockDetailCountBehaviorSubject = new BehaviorSubject(defaultRetailPharmacyStockDetailCount);
		...
		retailPharmacyStockDetailModelWithIdBehaviorSubject = new BehaviorSubject(retailPharmacyStockDetailWithId);
		retailPharmacyWithIdBehaviorSubject = new BehaviorSubject(retailPharmacyStockDetailWithId.retailPharmacy);
		stockCatalogueWithIdBehaviorSubject = new BehaviorSubject(retailPharmacyStockDetailWithId.stockCatalogue);

		spyOn(store, 'select')
			.withArgs(getCountRetailPharmacyStockDetailModels).and.returnValue(retailPharmacyStockDetailCountBehaviorSubject)
			.withArgs(getRetailPharmacyStockDetailModelWithId, retailPharmacyStockDetailWithId.id).and.returnValue(retailPharmacyStockDetailModelWithIdBehaviorSubject)
			...
			.withArgs(getRetailPharmacyModelWithId, retailPharmacyStockDetailWithId.retailPharmacyId).and.returnValue(retailPharmacyWithIdBehaviorSubject)
			.withArgs(getStockCatalogueModelWithId, retailPharmacyStockDetailWithId.stockCatalogueId).and.returnValue(stockCatalogueWithIdBehaviorSubject)
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(RetailPharmacyStockDetailCrudEditComponent);
			component = fixture.debugElement.componentInstance;
			component.ngOnInit();
			component.targetModel = new RetailPharmacyStockDetailModel();
	 ...
	 */
	it ('Renders the Retail Pharmacy Stock Detail CRUD Edit Component', () => {
	...
	*/
	...
	it ('renders related Retail Pharmacy entities from model when loading in edit mode', () => {
		component.targetModel = retailPharmacyStockDetailWithId;
		component.targetModelId = retailPharmacyStockDetailWithId.id;
