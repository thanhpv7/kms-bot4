...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: BpjsFacilityListCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: BpjsFacilityListCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-facility-list/view/:id',
				component: BpjsFacilityListCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-facility-list/create',
				component: BpjsFacilityListCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'bpjs-facility-list/edit/:id',
				component: BpjsFacilityListCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class BpjsFacilityListCrudRoutingModule {
}
