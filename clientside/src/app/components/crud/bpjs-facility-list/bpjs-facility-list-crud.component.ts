 ...
 */
@Component({
	selector: 'cb-bpjs-facility-list-crud',
	templateUrl: './bpjs-facility-list-crud.component.html',
	styleUrls: [
		'./bpjs-facility-list-crud.component.scss',
...
export class BpjsFacilityListCrudComponent implements OnDestroy {
