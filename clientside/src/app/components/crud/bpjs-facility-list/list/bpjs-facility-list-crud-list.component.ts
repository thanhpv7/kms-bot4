...
@Component({
	selector: 'cb-bpjs-facility-list-crud-list',
	templateUrl: './bpjs-facility-list-crud-list.component.html',
	styleUrls: [
		'./bpjs-facility-list-crud-list.component.scss',
...
export class BpjsFacilityListCrudListComponent
