...
import {BpjsFacilityListCrudListComponent} from './bpjs-facility-list-crud-list.component';
...
describe('BPJS Facility List Crud List Tile Component', () => {
	...
	let fixture;
	let bpjsFacilityListCrudListComponent: BpjsFacilityListCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(BpjsFacilityListCrudListComponent);
