...
@Component({
	selector: 'cb-bpjs-facility-list-crud-edit',
	templateUrl: './bpjs-facility-list-crud-edit.component.html',
	styleUrls: [
		'./bpjs-facility-list-crud-edit.component.scss',
...
export class BpjsFacilityListCrudEditComponent
