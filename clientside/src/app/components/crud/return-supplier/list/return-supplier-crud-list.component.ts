...
@Component({
	selector: 'cb-return-supplier-crud-list',
	templateUrl: './return-supplier-crud-list.component.html',
	styleUrls: [
		'./return-supplier-crud-list.component.scss',
...
export class ReturnSupplierCrudListComponent
