...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: ReturnSupplierCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: ReturnSupplierCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'return-supplier/view/:id',
				component: ReturnSupplierCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class ReturnSupplierCrudRoutingModule {
}
