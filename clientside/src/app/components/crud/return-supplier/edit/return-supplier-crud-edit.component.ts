...
import {CrudTileMode} from '../return-supplier-crud.component';
...
@Component({
	selector: 'cb-return-supplier-crud-edit',
	templateUrl: './return-supplier-crud-edit.component.html',
	styleUrls: [
		'./return-supplier-crud-edit.component.scss',
...
export class ReturnSupplierCrudEditComponent
