...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: BpjsDrugGenericPRBCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: BpjsDrugGenericPRBCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-drug-generic-prb/view/:id',
				component: BpjsDrugGenericPRBCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-drug-generic-prb/create',
				component: BpjsDrugGenericPRBCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'bpjs-drug-generic-prb/edit/:id',
				component: BpjsDrugGenericPRBCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class BpjsDrugGenericPRBCrudRoutingModule {
}
