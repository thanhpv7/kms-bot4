 ...
 */
@Component({
	selector: 'cb-bpjs-drug-generic-prb-crud',
	templateUrl: './bpjs-drug-generic-prb-crud.component.html',
	styleUrls: [
		'./bpjs-drug-generic-prb-crud.component.scss',
...
export class BpjsDrugGenericPRBCrudComponent implements OnDestroy {
