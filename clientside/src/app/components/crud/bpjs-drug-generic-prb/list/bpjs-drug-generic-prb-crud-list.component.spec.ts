...
import {BpjsDrugGenericPRBCrudListComponent} from './bpjs-drug-generic-prb-crud-list.component';
...
import {BpjsDrugGenericPRBCrudModule} from '../bpjs-drug-generic-prb-crud.module';
import {
...
describe('BPJS Drug Generic PRB Crud List Tile Component', () => {
	...
	let fixture;
	let bpjsDrugGenericPRBCrudListComponent: BpjsDrugGenericPRBCrudListComponent;
	...
	const routerState: RouterState = {
		url: 'bpjs-drug-generic-prb-crud',
		urls: ['bpjs-drug-generic-prb-crud'],
		params: {},
		queryParams: {},
		data: {},
	};
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(BpjsDrugGenericPRBCrudListComponent);
