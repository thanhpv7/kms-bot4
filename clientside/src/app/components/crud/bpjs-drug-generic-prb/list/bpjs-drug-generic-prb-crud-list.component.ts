...
@Component({
	selector: 'cb-bpjs-drug-generic-prb-crud-list',
	templateUrl: './bpjs-drug-generic-prb-crud-list.component.html',
	styleUrls: [
		'./bpjs-drug-generic-prb-crud-list.component.scss',
...
export class BpjsDrugGenericPRBCrudListComponent
