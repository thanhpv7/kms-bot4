...
import {PcareMCUCrudListComponent} from './pcare-mcu-crud-list.component';
...
describe('PCare MCU Crud List Tile Component', () => {
	...
	let fixture;
	let pcareMCUCrudListComponent: PcareMCUCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(PcareMCUCrudListComponent);
