 ...
 */
@Component({
	selector: 'cb-pcare-mcu-crud',
	templateUrl: './pcare-mcu-crud.component.html',
	styleUrls: [
		'./pcare-mcu-crud.component.scss',
...
export class PcareMCUCrudComponent implements OnDestroy {
