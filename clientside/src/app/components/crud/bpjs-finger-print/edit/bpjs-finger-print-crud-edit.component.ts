...
@Component({
	selector: 'cb-bpjs-finger-print-crud-edit',
	templateUrl: './bpjs-finger-print-crud-edit.component.html',
	styleUrls: [
		'./bpjs-finger-print-crud-edit.component.scss',
...
export class BpjsFingerPrintCrudEditComponent
