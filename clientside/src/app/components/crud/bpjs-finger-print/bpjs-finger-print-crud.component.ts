 ...
 */
@Component({
	selector: 'cb-bpjs-finger-print-crud',
	templateUrl: './bpjs-finger-print-crud.component.html',
	styleUrls: [
		'./bpjs-finger-print-crud.component.scss',
...
export class BpjsFingerPrintCrudComponent implements OnDestroy {
