...
import {BpjsFingerPrintCrudListComponent} from './bpjs-finger-print-crud-list.component';
...
describe('BPJS Finger Print Crud List Tile Component', () => {
	...
	let fixture;
	let bpjsFingerPrintCrudListComponent: BpjsFingerPrintCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(BpjsFingerPrintCrudListComponent);
