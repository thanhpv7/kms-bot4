...
@Component({
	selector: 'cb-bpjs-finger-print-crud-list',
	templateUrl: './bpjs-finger-print-crud-list.component.html',
	styleUrls: [
		'./bpjs-finger-print-crud-list.component.scss',
...
export class BpjsFingerPrintCrudListComponent
