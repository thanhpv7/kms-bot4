...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: PcareTindakanCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: PcareTindakanCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'pcare-tindakan/view/:id',
				component: PcareTindakanCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class PcareTindakanCrudRoutingModule {
}
