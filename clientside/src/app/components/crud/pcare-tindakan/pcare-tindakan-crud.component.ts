 ...
 */
@Component({
	selector: 'cb-pcare-tindakan-crud',
	templateUrl: './pcare-tindakan-crud.component.html',
	styleUrls: [
		'./pcare-tindakan-crud.component.scss',
...
export class PcareTindakanCrudComponent implements OnDestroy {
