...
@Component({
	selector: 'cb-pcare-tindakan-crud-edit',
	templateUrl: './pcare-tindakan-crud-edit.component.html',
	styleUrls: [
		'./pcare-tindakan-crud-edit.component.scss',
...
export class PcareTindakanCrudEditComponent
