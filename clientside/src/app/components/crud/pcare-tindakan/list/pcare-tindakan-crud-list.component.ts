...
import {CrudTileMode} from '../pcare-tindakan-crud.component';
...
@Component({
	selector: 'cb-pcare-tindakan-crud-list',
	templateUrl: './pcare-tindakan-crud-list.component.html',
	styleUrls: [
		'./pcare-tindakan-crud-list.component.scss',
...
export class PcareTindakanCrudListComponent
