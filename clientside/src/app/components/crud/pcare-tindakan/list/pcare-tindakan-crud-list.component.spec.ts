...
import {PcareTindakanCrudListComponent} from './pcare-tindakan-crud-list.component';
...
import {PcareTindakanCrudModule} from '../pcare-tindakan-crud.module';
import {
...
describe('PCare Tindakan Crud List Tile Component', () => {
	...
	let fixture;
	let pcareTindakanCrudListComponent: PcareTindakanCrudListComponent;
	...
	const routerState: RouterState = {
		url: 'pcare-tindakan-crud',
		urls: ['pcare-tindakan-crud'],
		params: {},
		queryParams: {},
		data: {},
	};
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(PcareTindakanCrudListComponent);
