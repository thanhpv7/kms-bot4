 ...
 */
@Component({
	selector: 'cb-bpjs-total-referral-sep-crud',
	templateUrl: './bpjs-total-referral-sep-crud.component.html',
	styleUrls: [
		'./bpjs-total-referral-sep-crud.component.scss',
...
export class BpjsTotalReferralSEPCrudComponent implements OnDestroy {
