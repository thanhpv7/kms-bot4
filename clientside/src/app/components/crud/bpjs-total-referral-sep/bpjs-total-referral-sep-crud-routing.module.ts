...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: BpjsTotalReferralSEPCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: BpjsTotalReferralSEPCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-total-referral-sep/view/:id',
				component: BpjsTotalReferralSEPCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-total-referral-sep/create',
				component: BpjsTotalReferralSEPCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'bpjs-total-referral-sep/edit/:id',
				component: BpjsTotalReferralSEPCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class BpjsTotalReferralSEPCrudRoutingModule {
}
