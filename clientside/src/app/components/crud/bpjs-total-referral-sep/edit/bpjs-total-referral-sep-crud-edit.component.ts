...
@Component({
	selector: 'cb-bpjs-total-referral-sep-crud-edit',
	templateUrl: './bpjs-total-referral-sep-crud-edit.component.html',
	styleUrls: [
		'./bpjs-total-referral-sep-crud-edit.component.scss',
...
export class BpjsTotalReferralSEPCrudEditComponent
