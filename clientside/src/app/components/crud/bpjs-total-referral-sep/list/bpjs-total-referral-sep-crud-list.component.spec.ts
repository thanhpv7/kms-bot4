...
import {BpjsTotalReferralSEPCrudListComponent} from './bpjs-total-referral-sep-crud-list.component';
...
describe('BPJS Total Referral SEP Crud List Tile Component', () => {
	...
	let fixture;
	let bpjsTotalReferralSEPCrudListComponent: BpjsTotalReferralSEPCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(BpjsTotalReferralSEPCrudListComponent);
