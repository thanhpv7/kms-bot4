...
@Component({
	selector: 'cb-bpjs-total-referral-sep-crud-list',
	templateUrl: './bpjs-total-referral-sep-crud-list.component.html',
	styleUrls: [
		'./bpjs-total-referral-sep-crud-list.component.scss',
...
export class BpjsTotalReferralSEPCrudListComponent
