 ...
 */
@Component({
	selector: 'cb-inventory-batch-correction-crud',
	templateUrl: './inventory-batch-correction-crud.component.html',
	styleUrls: [
		'./inventory-batch-correction-crud.component.scss',
...
export class InventoryBatchCorrectionCrudComponent implements OnDestroy {
