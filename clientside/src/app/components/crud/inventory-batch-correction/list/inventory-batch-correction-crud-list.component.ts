...
@Component({
	selector: 'cb-inventory-batch-correction-crud-list',
	templateUrl: './inventory-batch-correction-crud-list.component.html',
	styleUrls: [
		'./inventory-batch-correction-crud-list.component.scss',
...
export class InventoryBatchCorrectionCrudListComponent
