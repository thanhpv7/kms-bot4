...
import {InventoryBatchCorrectionCrudListComponent} from './inventory-batch-correction-crud-list.component';
...
describe('Inventory Batch Correction Crud List Tile Component', () => {
	...
	let fixture;
	let inventoryBatchCorrectionCrudListComponent: InventoryBatchCorrectionCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(InventoryBatchCorrectionCrudListComponent);
