...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: InventoryBatchCorrectionCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: InventoryBatchCorrectionCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'inventory-batch-correction/view/:id',
				component: InventoryBatchCorrectionCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'inventory-batch-correction/create',
				component: InventoryBatchCorrectionCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'inventory-batch-correction/edit/:id',
				component: InventoryBatchCorrectionCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class InventoryBatchCorrectionCrudRoutingModule {
}
