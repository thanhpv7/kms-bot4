...
@Component({
	selector: 'cb-inventory-batch-correction-crud-edit',
	templateUrl: './inventory-batch-correction-crud-edit.component.html',
	styleUrls: [
		'./inventory-batch-correction-crud-edit.component.scss',
...
export class InventoryBatchCorrectionCrudEditComponent
