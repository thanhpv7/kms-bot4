...
@Component({
	selector: 'cb-sample-collection-items-crud-edit',
	templateUrl: './sample-collection-items-crud-edit.component.html',
	styleUrls: [
		'./sample-collection-items-crud-edit.component.scss',
...
export class SampleCollectionItemsCrudEditComponent
