 ...
 */
@Component({
	selector: 'cb-sample-collection-items-crud',
	templateUrl: './sample-collection-items-crud.component.html',
	styleUrls: [
		'./sample-collection-items-crud.component.scss',
...
export class SampleCollectionItemsCrudComponent implements OnDestroy {
