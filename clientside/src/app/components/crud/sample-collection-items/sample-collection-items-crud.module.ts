...
import {SampleCollectionItemsCrudRoutingModule} from './sample-collection-items-crud-routing.module';
...
@NgModule({
	declarations: [
		SampleCollectionItemsCrudListComponent,
		SampleCollectionItemsCrudEditComponent,
		SampleCollectionItemsCrudComponent,
	...
	imports: [
		...
		CommonPipeModule,
		SampleCollectionItemsCrudRoutingModule,
...
export class SampleCollectionItemsCrudModule {
}
