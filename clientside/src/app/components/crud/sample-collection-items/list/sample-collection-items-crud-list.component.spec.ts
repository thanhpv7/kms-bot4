...
import {SampleCollectionItemsCrudListComponent} from './sample-collection-items-crud-list.component';
...
describe('Sample Collection Items Crud List Tile Component', () => {
	...
	let fixture;
	let sampleCollectionItemsCrudListComponent: SampleCollectionItemsCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(SampleCollectionItemsCrudListComponent);
