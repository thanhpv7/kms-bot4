...
@Component({
	selector: 'cb-sample-collection-items-crud-list',
	templateUrl: './sample-collection-items-crud-list.component.html',
	styleUrls: [
		'./sample-collection-items-crud-list.component.scss',
...
export class SampleCollectionItemsCrudListComponent
