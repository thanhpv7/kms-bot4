...
@Component({
	selector: 'cb-preoperative-records-crud-list',
	templateUrl: './preoperative-records-crud-list.component.html',
	styleUrls: [
		'./preoperative-records-crud-list.component.scss',
...
export class PreoperativeRecordsCrudListComponent
