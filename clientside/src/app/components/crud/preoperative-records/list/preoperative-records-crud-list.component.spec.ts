...
import {PreoperativeRecordsCrudListComponent} from './preoperative-records-crud-list.component';
...
describe('Preoperative Records Crud List Tile Component', () => {
	...
	let fixture;
	let preoperativeRecordsCrudListComponent: PreoperativeRecordsCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(PreoperativeRecordsCrudListComponent);
