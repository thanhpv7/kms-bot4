 ...
 */
@Component({
	selector: 'cb-preoperative-records-crud',
	templateUrl: './preoperative-records-crud.component.html',
	styleUrls: [
		'./preoperative-records-crud.component.scss',
...
export class PreoperativeRecordsCrudComponent implements OnDestroy {
