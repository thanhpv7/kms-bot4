...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: PreoperativeRecordsCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: PreoperativeRecordsCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'preoperative-records/view/:id',
				component: PreoperativeRecordsCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'preoperative-records/create',
				component: PreoperativeRecordsCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'preoperative-records/edit/:id',
				component: PreoperativeRecordsCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class PreoperativeRecordsCrudRoutingModule {
}
