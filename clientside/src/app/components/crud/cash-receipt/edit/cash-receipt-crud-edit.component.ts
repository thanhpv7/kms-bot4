...
@Component({
	selector: 'cb-cash-receipt-crud-edit',
	templateUrl: './cash-receipt-crud-edit.component.html',
	styleUrls: [
		'./cash-receipt-crud-edit.component.scss',
...
export class CashReceiptCrudEditComponent
