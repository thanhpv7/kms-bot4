...
import {CashReceiptCrudRoutingModule} from './cash-receipt-crud-routing.module';
...
@NgModule({
	declarations: [
		CashReceiptCrudListComponent,
		CashReceiptCrudEditComponent,
		CashReceiptCrudComponent,
...
export class CashReceiptCrudModule {
}
