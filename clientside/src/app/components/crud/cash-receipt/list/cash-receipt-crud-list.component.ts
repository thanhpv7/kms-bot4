...
@Component({
	selector: 'cb-cash-receipt-crud-list',
	templateUrl: './cash-receipt-crud-list.component.html',
	styleUrls: [
		'./cash-receipt-crud-list.component.scss',
...
export class CashReceiptCrudListComponent
