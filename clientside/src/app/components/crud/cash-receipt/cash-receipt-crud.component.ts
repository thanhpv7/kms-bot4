 ...
 */
@Component({
	selector: 'cb-cash-receipt-crud',
	templateUrl: './cash-receipt-crud.component.html',
	styleUrls: [
		'./cash-receipt-crud.component.scss',
...
export class CashReceiptCrudComponent implements OnDestroy {
