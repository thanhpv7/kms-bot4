...
@Component({
	selector: 'cb-vaccination-order-detail-crud-edit',
	templateUrl: './vaccination-order-detail-crud-edit.component.html',
	styleUrls: [
		'./vaccination-order-detail-crud-edit.component.scss',
...
export class VaccinationOrderDetailCrudEditComponent
