...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: VaccinationOrderDetailCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: VaccinationOrderDetailCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'vaccination-order-detail/view/:id',
				component: VaccinationOrderDetailCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'vaccination-order-detail/create',
				component: VaccinationOrderDetailCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'vaccination-order-detail/edit/:id',
				component: VaccinationOrderDetailCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class VaccinationOrderDetailCrudRoutingModule {
}
