...
import {VaccinationOrderDetailCrudListComponent} from './vaccination-order-detail-crud-list.component';
...
describe('Vaccination Order Detail Crud List Tile Component', () => {
	...
	let fixture;
	let vaccinationOrderDetailCrudListComponent: VaccinationOrderDetailCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(VaccinationOrderDetailCrudListComponent);
