...
@Component({
	selector: 'cb-vaccination-order-detail-crud-list',
	templateUrl: './vaccination-order-detail-crud-list.component.html',
	styleUrls: [
		'./vaccination-order-detail-crud-list.component.scss',
...
export class VaccinationOrderDetailCrudListComponent
