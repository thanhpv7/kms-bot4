 ...
 */
@Component({
	selector: 'cb-vaccination-order-detail-crud',
	templateUrl: './vaccination-order-detail-crud.component.html',
	styleUrls: [
		'./vaccination-order-detail-crud.component.scss',
...
export class VaccinationOrderDetailCrudComponent implements OnDestroy {
