...
@Component({
	selector: 'cb-purchase-requisition-crud-list',
	templateUrl: './purchase-requisition-crud-list.component.html',
	styleUrls: [
		'./purchase-requisition-crud-list.component.scss',
...
export class PurchaseRequisitionCrudListComponent
