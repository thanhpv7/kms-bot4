...
import {PurchaseRequisitionCrudListComponent} from './purchase-requisition-crud-list.component';
...
describe('Purchase Requisition Crud List Tile Component', () => {
	...
	let fixture;
	let purchaseRequisitionCrudListComponent: PurchaseRequisitionCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(PurchaseRequisitionCrudListComponent);
