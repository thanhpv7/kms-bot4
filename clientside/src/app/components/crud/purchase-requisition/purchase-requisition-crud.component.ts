 ...
 */
@Component({
	selector: 'cb-purchase-requisition-crud',
	templateUrl: './purchase-requisition-crud.component.html',
	styleUrls: [
		'./purchase-requisition-crud.component.scss',
...
export class PurchaseRequisitionCrudComponent implements OnDestroy {
