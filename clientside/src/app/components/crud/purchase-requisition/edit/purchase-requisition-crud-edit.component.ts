...
@Component({
	selector: 'cb-purchase-requisition-crud-edit',
	templateUrl: './purchase-requisition-crud-edit.component.html',
	styleUrls: [
		'./purchase-requisition-crud-edit.component.scss',
...
export class PurchaseRequisitionCrudEditComponent
