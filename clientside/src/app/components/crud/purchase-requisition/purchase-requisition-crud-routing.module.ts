...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: PurchaseRequisitionCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: PurchaseRequisitionCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'purchase-requisition/view/:id',
				component: PurchaseRequisitionCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class PurchaseRequisitionCrudRoutingModule {
}
