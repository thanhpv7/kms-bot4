...
import {CrudTileMode} from '../pcare-dokter-crud.component';
...
@Component({
	selector: 'cb-pcare-dokter-crud-list',
	templateUrl: './pcare-dokter-crud-list.component.html',
	styleUrls: [
		'./pcare-dokter-crud-list.component.scss',
...
export class PcareDokterCrudListComponent
