...
import {PcareDokterCrudListComponent} from './pcare-dokter-crud-list.component';
...
import {PcareDokterCrudModule} from '../pcare-dokter-crud.module';
import {
...
describe('PCare Dokter Crud List Tile Component', () => {
	...
	let fixture;
	let pcareDokterCrudListComponent: PcareDokterCrudListComponent;
	...
	const routerState: RouterState = {
		url: 'pcare-dokter-crud',
		urls: ['pcare-dokter-crud'],
		params: {},
		queryParams: {},
		data: {},
	};
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(PcareDokterCrudListComponent);
