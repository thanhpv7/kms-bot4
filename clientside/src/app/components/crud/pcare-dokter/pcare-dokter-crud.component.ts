 ...
 */
@Component({
	selector: 'cb-pcare-dokter-crud',
	templateUrl: './pcare-dokter-crud.component.html',
	styleUrls: [
		'./pcare-dokter-crud.component.scss',
...
export class PcareDokterCrudComponent implements OnDestroy {
