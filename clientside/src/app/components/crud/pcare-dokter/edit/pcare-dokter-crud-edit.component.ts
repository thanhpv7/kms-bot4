...
@Component({
	selector: 'cb-pcare-dokter-crud-edit',
	templateUrl: './pcare-dokter-crud-edit.component.html',
	styleUrls: [
		'./pcare-dokter-crud-edit.component.scss',
...
export class PcareDokterCrudEditComponent
