...
import { PcareDokterCrudEditComponent } from './pcare-dokter-crud-edit.component';
import {
...
describe('PCare Dokter CRUD Edit component tests', () => {
	let fixture: ComponentFixture<PcareDokterCrudEditComponent>
	let component: PcareDokterCrudEditComponent;
	...
	let pcareDokterCountBehaviorSubject: BehaviorSubject<number>;
	...
	let pcareDokterWithId: PcareDokterModel = defaultPcareDokterEntities[0];
	let pcareDokterModelWithIdBehaviorSubject: BehaviorSubject<PcareDokterModel>;

	pcareDokterWithId.staff = defaultStaffEntities[0];
	pcareDokterWithId.staffId = pcareDokterWithId.staff.id;
	...
	function spySelectorsInStore() {
		...
		pcareDokterCountBehaviorSubject = new BehaviorSubject(defaultPcareDokterCount);
		...
		pcareDokterModelWithIdBehaviorSubject = new BehaviorSubject(pcareDokterWithId);
		staffWithIdBehaviorSubject = new BehaviorSubject(pcareDokterWithId.staff);

		spyOn(store, 'select')
			.withArgs(getCountPcareDokterModels).and.returnValue(pcareDokterCountBehaviorSubject)
			.withArgs(getPcareDokterModelWithId, pcareDokterWithId.id).and.returnValue(pcareDokterModelWithIdBehaviorSubject)
			...
			.withArgs(getStaffModelWithId, pcareDokterWithId.staffId).and.returnValue(staffWithIdBehaviorSubject)
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(PcareDokterCrudEditComponent);
			component = fixture.debugElement.componentInstance;
			component.ngOnInit();
			component.targetModel = new PcareDokterModel();
	 ...
	 */
	it ('Renders the PCare Dokter CRUD Edit Component', () => {
	...
	*/
	...
	it ('renders related Staff entities from model when loading in edit mode', () => {
		component.targetModel = pcareDokterWithId;
		component.targetModelId = pcareDokterWithId.id;
