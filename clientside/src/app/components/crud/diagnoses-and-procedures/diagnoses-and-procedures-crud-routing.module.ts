...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: DiagnosesAndProceduresCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: DiagnosesAndProceduresCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'diagnoses-and-procedures/view/:id',
				component: DiagnosesAndProceduresCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'diagnoses-and-procedures/create',
				component: DiagnosesAndProceduresCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'diagnoses-and-procedures/edit/:id',
				component: DiagnosesAndProceduresCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class DiagnosesAndProceduresCrudRoutingModule {
}
