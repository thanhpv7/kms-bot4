...
@Component({
	selector: 'cb-diagnoses-and-procedures-crud-list',
	templateUrl: './diagnoses-and-procedures-crud-list.component.html',
	styleUrls: [
		'./diagnoses-and-procedures-crud-list.component.scss',
...
export class DiagnosesAndProceduresCrudListComponent
