...
import {DiagnosesAndProceduresCrudListComponent} from './diagnoses-and-procedures-crud-list.component';
...
describe('Diagnoses and Procedures Crud List Tile Component', () => {
	...
	let fixture;
	let diagnosesAndProceduresCrudListComponent: DiagnosesAndProceduresCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(DiagnosesAndProceduresCrudListComponent);
