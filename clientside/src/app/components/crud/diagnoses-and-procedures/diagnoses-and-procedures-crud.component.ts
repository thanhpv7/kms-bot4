 ...
 */
@Component({
	selector: 'cb-diagnoses-and-procedures-crud',
	templateUrl: './diagnoses-and-procedures-crud.component.html',
	styleUrls: [
		'./diagnoses-and-procedures-crud.component.scss',
...
export class DiagnosesAndProceduresCrudComponent implements OnDestroy {
