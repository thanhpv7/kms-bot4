 ...
 */
@Component({
	selector: 'cb-hospital-branch-information-crud',
	templateUrl: './hospital-branch-information-crud.component.html',
	styleUrls: [
		'./hospital-branch-information-crud.component.scss',
...
export class HospitalBranchInformationCrudComponent implements OnDestroy {
