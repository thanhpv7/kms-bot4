...
@Component({
	selector: 'cb-hospital-branch-information-crud-list',
	templateUrl: './hospital-branch-information-crud-list.component.html',
	styleUrls: [
		'./hospital-branch-information-crud-list.component.scss',
...
export class HospitalBranchInformationCrudListComponent
