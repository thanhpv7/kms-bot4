 ...
 */
@Component({
	selector: 'cb-bpjs-pcare-provider-rayonisasi-crud',
	templateUrl: './bpjs-pcare-provider-rayonisasi-crud.component.html',
	styleUrls: [
		'./bpjs-pcare-provider-rayonisasi-crud.component.scss',
...
export class BpjsPcareProviderRayonisasiCrudComponent implements OnDestroy {
