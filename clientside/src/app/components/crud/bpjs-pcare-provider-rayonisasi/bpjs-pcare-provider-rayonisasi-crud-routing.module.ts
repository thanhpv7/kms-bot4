...
import {BpjsPcareProviderRayonisasiCrudListComponent} from './list/bpjs-pcare-provider-rayonisasi-crud-list.component';
import {BpjsPcareProviderRayonisasiCrudEditComponent} from './edit/bpjs-pcare-provider-rayonisasi-crud-edit.component';
import {BpjsPcareProviderRayonisasiCrudComponent} from './bpjs-pcare-provider-rayonisasi-crud.component';
...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: BpjsPcareProviderRayonisasiCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: BpjsPcareProviderRayonisasiCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-pcare-provider-rayonisasi/view/:id',
				component: BpjsPcareProviderRayonisasiCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-pcare-provider-rayonisasi/create',
				component: BpjsPcareProviderRayonisasiCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'bpjs-pcare-provider-rayonisasi/edit/:id',
				component: BpjsPcareProviderRayonisasiCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class BpjsPcareProviderRayonisasiCrudRoutingModule {
}
