...
import {BpjsPcareProviderRayonisasiCrudListComponent} from './bpjs-pcare-provider-rayonisasi-crud-list.component';
...
describe('BPJS Pcare Provider Rayonisasi Crud List Tile Component', () => {
	...
	let fixture;
	let bpjsPcareProviderRayonisasiCrudListComponent: BpjsPcareProviderRayonisasiCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(BpjsPcareProviderRayonisasiCrudListComponent);
