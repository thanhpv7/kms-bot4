...
@Component({
	selector: 'cb-bpjs-pcare-provider-rayonisasi-crud-list',
	templateUrl: './bpjs-pcare-provider-rayonisasi-crud-list.component.html',
	styleUrls: [
		'./bpjs-pcare-provider-rayonisasi-crud-list.component.scss',
...
export class BpjsPcareProviderRayonisasiCrudListComponent
