...
@Component({
	selector: 'cb-bpjs-pcare-provider-rayonisasi-crud-edit',
	templateUrl: './bpjs-pcare-provider-rayonisasi-crud-edit.component.html',
	styleUrls: [
		'./bpjs-pcare-provider-rayonisasi-crud-edit.component.scss',
...
export class BpjsPcareProviderRayonisasiCrudEditComponent
