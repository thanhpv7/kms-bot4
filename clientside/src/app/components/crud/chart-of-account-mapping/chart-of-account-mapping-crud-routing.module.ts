...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: ChartOfAccountMappingCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: ChartOfAccountMappingCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'chart-of-account-mapping/view/:id',
				component: ChartOfAccountMappingCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'chart-of-account-mapping/create',
				component: ChartOfAccountMappingCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'chart-of-account-mapping/edit/:id',
				component: ChartOfAccountMappingCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class ChartOfAccountMappingCrudRoutingModule {
}
