 ...
 */
@Component({
	selector: 'cb-chart-of-account-mapping-crud',
	templateUrl: './chart-of-account-mapping-crud.component.html',
	styleUrls: [
		'./chart-of-account-mapping-crud.component.scss',
...
export class ChartOfAccountMappingCrudComponent implements OnDestroy {
