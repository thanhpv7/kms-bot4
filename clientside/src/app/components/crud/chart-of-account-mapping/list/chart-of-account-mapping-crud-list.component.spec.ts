...
import {ChartOfAccountMappingCrudListComponent} from './chart-of-account-mapping-crud-list.component';
...
describe('Chart of Account Mapping Crud List Tile Component', () => {
	...
	let fixture;
	let chartOfAccountMappingCrudListComponent: ChartOfAccountMappingCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(ChartOfAccountMappingCrudListComponent);
