...
@Component({
	selector: 'cb-chart-of-account-mapping-crud-list',
	templateUrl: './chart-of-account-mapping-crud-list.component.html',
	styleUrls: [
		'./chart-of-account-mapping-crud-list.component.scss',
...
export class ChartOfAccountMappingCrudListComponent
