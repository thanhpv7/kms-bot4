...
@Component({
	selector: 'cb-chart-of-account-mapping-crud-edit',
	templateUrl: './chart-of-account-mapping-crud-edit.component.html',
	styleUrls: [
		'./chart-of-account-mapping-crud-edit.component.scss',
...
export class ChartOfAccountMappingCrudEditComponent
