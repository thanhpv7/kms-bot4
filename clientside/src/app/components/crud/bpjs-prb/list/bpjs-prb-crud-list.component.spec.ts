...
import {BpjsPRBCrudListComponent} from './bpjs-prb-crud-list.component';
...
describe('BPJS PRB Crud List Tile Component', () => {
	...
	let fixture;
	let bpjsPRBCrudListComponent: BpjsPRBCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(BpjsPRBCrudListComponent);
