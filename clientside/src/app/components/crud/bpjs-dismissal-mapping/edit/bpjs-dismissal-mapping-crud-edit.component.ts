...
@Component({
	selector: 'cb-bpjs-dismissal-mapping-crud-edit',
	templateUrl: './bpjs-dismissal-mapping-crud-edit.component.html',
	styleUrls: [
		'./bpjs-dismissal-mapping-crud-edit.component.scss',
...
export class BpjsDismissalMappingCrudEditComponent
