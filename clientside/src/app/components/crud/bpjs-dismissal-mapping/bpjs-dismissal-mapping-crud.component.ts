 ...
 */
@Component({
	selector: 'cb-bpjs-dismissal-mapping-crud',
	templateUrl: './bpjs-dismissal-mapping-crud.component.html',
	styleUrls: [
		'./bpjs-dismissal-mapping-crud.component.scss',
...
export class BpjsDismissalMappingCrudComponent implements OnDestroy {
