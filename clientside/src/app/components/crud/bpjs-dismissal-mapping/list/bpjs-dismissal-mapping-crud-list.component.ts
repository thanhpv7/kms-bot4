...
@Component({
	selector: 'cb-bpjs-dismissal-mapping-crud-list',
	templateUrl: './bpjs-dismissal-mapping-crud-list.component.html',
	styleUrls: [
		'./bpjs-dismissal-mapping-crud-list.component.scss',
...
export class BpjsDismissalMappingCrudListComponent
