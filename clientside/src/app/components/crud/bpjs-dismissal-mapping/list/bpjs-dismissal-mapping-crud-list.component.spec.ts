...
import {BpjsDismissalMappingCrudListComponent} from './bpjs-dismissal-mapping-crud-list.component';
...
describe('BPJS Dismissal Mapping Crud List Tile Component', () => {
	...
	let fixture;
	let bpjsDismissalMappingCrudListComponent: BpjsDismissalMappingCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(BpjsDismissalMappingCrudListComponent);
