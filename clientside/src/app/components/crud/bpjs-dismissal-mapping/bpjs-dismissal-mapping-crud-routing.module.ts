...
import {BpjsDismissalMappingCrudListComponent} from './list/bpjs-dismissal-mapping-crud-list.component';
import {BpjsDismissalMappingCrudEditComponent} from './edit/bpjs-dismissal-mapping-crud-edit.component';
import {BpjsDismissalMappingCrudComponent} from './bpjs-dismissal-mapping-crud.component';
...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: BpjsDismissalMappingCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: BpjsDismissalMappingCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-dismissal-mapping/view/:id',
				component: BpjsDismissalMappingCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-dismissal-mapping/create',
				component: BpjsDismissalMappingCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'bpjs-dismissal-mapping/edit/:id',
				component: BpjsDismissalMappingCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class BpjsDismissalMappingCrudRoutingModule {
}
