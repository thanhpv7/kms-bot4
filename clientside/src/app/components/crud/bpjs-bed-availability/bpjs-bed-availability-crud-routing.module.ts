...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: BpjsBedAvailabilityCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: BpjsBedAvailabilityCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-bed-availability/view/:id',
				component: BpjsBedAvailabilityCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-bed-availability/create',
				component: BpjsBedAvailabilityCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'bpjs-bed-availability/edit/:id',
				component: BpjsBedAvailabilityCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class BpjsBedAvailabilityCrudRoutingModule {
}
