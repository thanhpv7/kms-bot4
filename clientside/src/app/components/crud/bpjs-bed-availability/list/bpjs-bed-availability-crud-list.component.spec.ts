...
import {BpjsBedAvailabilityCrudListComponent} from './bpjs-bed-availability-crud-list.component';
...
describe('BPJS Bed Availability Crud List Tile Component', () => {
	...
	let fixture;
	let bpjsBedAvailabilityCrudListComponent: BpjsBedAvailabilityCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(BpjsBedAvailabilityCrudListComponent);
