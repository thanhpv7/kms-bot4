...
@Component({
	selector: 'cb-bpjs-bed-availability-crud-list',
	templateUrl: './bpjs-bed-availability-crud-list.component.html',
	styleUrls: [
		'./bpjs-bed-availability-crud-list.component.scss',
...
export class BpjsBedAvailabilityCrudListComponent
