 ...
 */
@Component({
	selector: 'cb-bpjs-bed-availability-crud',
	templateUrl: './bpjs-bed-availability-crud.component.html',
	styleUrls: [
		'./bpjs-bed-availability-crud.component.scss',
...
export class BpjsBedAvailabilityCrudComponent implements OnDestroy {
