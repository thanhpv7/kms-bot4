...
import {BpjsJasaRaharjaCrudRoutingModule} from './bpjs-jasa-raharja-crud-routing.module';
...
@NgModule({
	declarations: [
		BpjsJasaRaharjaCrudListComponent,
		BpjsJasaRaharjaCrudEditComponent,
		BpjsJasaRaharjaCrudComponent,
	...
	imports: [
		...
		CommonPipeModule,
		BpjsJasaRaharjaCrudRoutingModule,
...
export class BpjsJasaRaharjaCrudModule {
}
