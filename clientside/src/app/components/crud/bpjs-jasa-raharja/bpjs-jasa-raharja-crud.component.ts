 ...
 */
@Component({
	selector: 'cb-bpjs-jasa-raharja-crud',
	templateUrl: './bpjs-jasa-raharja-crud.component.html',
	styleUrls: [
		'./bpjs-jasa-raharja-crud.component.scss',
...
export class BpjsJasaRaharjaCrudComponent implements OnDestroy {
