...
@Component({
	selector: 'cb-bpjs-jasa-raharja-crud-edit',
	templateUrl: './bpjs-jasa-raharja-crud-edit.component.html',
	styleUrls: [
		'./bpjs-jasa-raharja-crud-edit.component.scss',
...
export class BpjsJasaRaharjaCrudEditComponent
