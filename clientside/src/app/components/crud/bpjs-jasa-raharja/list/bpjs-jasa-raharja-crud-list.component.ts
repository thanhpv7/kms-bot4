...
@Component({
	selector: 'cb-bpjs-jasa-raharja-crud-list',
	templateUrl: './bpjs-jasa-raharja-crud-list.component.html',
	styleUrls: [
		'./bpjs-jasa-raharja-crud-list.component.scss',
...
export class BpjsJasaRaharjaCrudListComponent
