...
import {BpjsJasaRaharjaCrudListComponent} from './bpjs-jasa-raharja-crud-list.component';
...
describe('BPJS Jasa Raharja Crud List Tile Component', () => {
	...
	let fixture;
	let bpjsJasaRaharjaCrudListComponent: BpjsJasaRaharjaCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(BpjsJasaRaharjaCrudListComponent);
