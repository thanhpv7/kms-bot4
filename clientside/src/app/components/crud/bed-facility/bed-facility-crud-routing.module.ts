...
import {BedFacilityCrudListComponent} from './list/bed-facility-crud-list.component';
import {BedFacilityCrudEditComponent} from './edit/bed-facility-crud-edit.component';
import {BedFacilityCrudComponent} from './bed-facility-crud.component';
...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: BedFacilityCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: BedFacilityCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bed-facility/view/:id',
				component: BedFacilityCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class BedFacilityCrudRoutingModule {
}
