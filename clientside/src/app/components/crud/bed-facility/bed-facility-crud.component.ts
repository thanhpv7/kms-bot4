 ...
 */
@Component({
	selector: 'cb-bed-facility-crud',
	templateUrl: './bed-facility-crud.component.html',
	styleUrls: [
		'./bed-facility-crud.component.scss',
...
export class BedFacilityCrudComponent implements OnDestroy {
