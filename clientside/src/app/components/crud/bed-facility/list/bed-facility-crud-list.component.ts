...
@Component({
	selector: 'cb-bed-facility-crud-list',
	templateUrl: './bed-facility-crud-list.component.html',
	styleUrls: [
		'./bed-facility-crud-list.component.scss',
...
export class BedFacilityCrudListComponent
