...
import {BedFacilityCrudListComponent} from './bed-facility-crud-list.component';
...
describe('Bed Facility Crud List Tile Component', () => {
	...
	let fixture;
	let bedFacilityCrudListComponent: BedFacilityCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(BedFacilityCrudListComponent);
