...
@Component({
	selector: 'cb-examination-group-crud-list',
	templateUrl: './examination-group-crud-list.component.html',
	styleUrls: [
		'./examination-group-crud-list.component.scss',
...
export class ExaminationGroupCrudListComponent
