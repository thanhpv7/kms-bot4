...
import {ExaminationGroupCrudListComponent} from './examination-group-crud-list.component';
...
describe('Examination Group Crud List Tile Component', () => {
	...
	let fixture;
	let examinationGroupCrudListComponent: ExaminationGroupCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(ExaminationGroupCrudListComponent);
