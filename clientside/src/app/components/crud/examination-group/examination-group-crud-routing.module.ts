...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: ExaminationGroupCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: ExaminationGroupCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'examination-group/view/:id',
				component: ExaminationGroupCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'examination-group/edit/:id',
				component: ExaminationGroupCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class ExaminationGroupCrudRoutingModule {
}
