...
@Component({
	selector: 'cb-examination-group-crud-edit',
	templateUrl: './examination-group-crud-edit.component.html',
	styleUrls: [
		'./examination-group-crud-edit.component.scss',
...
export class ExaminationGroupCrudEditComponent
