 ...
 */
@Component({
	selector: 'cb-examination-group-crud',
	templateUrl: './examination-group-crud.component.html',
	styleUrls: [
		'./examination-group-crud.component.scss',
...
export class ExaminationGroupCrudComponent implements OnDestroy {
