...
@Component({
	selector: 'cb-bpjs-inacbg-crud-edit',
	templateUrl: './bpjs-inacbg-crud-edit.component.html',
	styleUrls: [
		'./bpjs-inacbg-crud-edit.component.scss',
...
export class BpjsINACBGCrudEditComponent
