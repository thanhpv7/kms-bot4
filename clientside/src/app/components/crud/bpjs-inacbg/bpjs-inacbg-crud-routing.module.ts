...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: BpjsINACBGCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: BpjsINACBGCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-inacbg/view/:id',
				component: BpjsINACBGCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class BpjsINACBGCrudRoutingModule {
}
