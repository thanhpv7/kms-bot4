 ...
 */
@Component({
	selector: 'cb-bpjs-inacbg-crud',
	templateUrl: './bpjs-inacbg-crud.component.html',
	styleUrls: [
		'./bpjs-inacbg-crud.component.scss',
...
export class BpjsINACBGCrudComponent implements OnDestroy {
