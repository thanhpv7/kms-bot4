...
import {BpjsINACBGCrudListComponent} from './bpjs-inacbg-crud-list.component';
...
describe('BPJS INACBG Crud List Tile Component', () => {
	...
	let fixture;
	let bpjsINACBGCrudListComponent: BpjsINACBGCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(BpjsINACBGCrudListComponent);
