...
@Component({
	selector: 'cb-bpjs-inacbg-crud-list',
	templateUrl: './bpjs-inacbg-crud-list.component.html',
	styleUrls: [
		'./bpjs-inacbg-crud-list.component.scss',
...
export class BpjsINACBGCrudListComponent
