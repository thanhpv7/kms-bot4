...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: CompoundPrescriptionDetailCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: CompoundPrescriptionDetailCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'compound-prescription-detail/view/:id',
				component: CompoundPrescriptionDetailCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'compound-prescription-detail/create',
				component: CompoundPrescriptionDetailCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'compound-prescription-detail/edit/:id',
				component: CompoundPrescriptionDetailCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class CompoundPrescriptionDetailCrudRoutingModule {
}
