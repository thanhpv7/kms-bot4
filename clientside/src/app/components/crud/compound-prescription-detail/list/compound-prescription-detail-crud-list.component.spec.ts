...
import {CompoundPrescriptionDetailCrudListComponent} from './compound-prescription-detail-crud-list.component';
...
describe('Compound Prescription Detail Crud List Tile Component', () => {
	...
	let fixture;
	let compoundPrescriptionDetailCrudListComponent: CompoundPrescriptionDetailCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(CompoundPrescriptionDetailCrudListComponent);
