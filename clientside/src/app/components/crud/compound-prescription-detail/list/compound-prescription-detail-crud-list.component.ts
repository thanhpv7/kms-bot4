...
@Component({
	selector: 'cb-compound-prescription-detail-crud-list',
	templateUrl: './compound-prescription-detail-crud-list.component.html',
	styleUrls: [
		'./compound-prescription-detail-crud-list.component.scss',
...
export class CompoundPrescriptionDetailCrudListComponent
