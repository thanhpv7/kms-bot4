...
@Component({
	selector: 'cb-compound-prescription-detail-crud-edit',
	templateUrl: './compound-prescription-detail-crud-edit.component.html',
	styleUrls: [
		'./compound-prescription-detail-crud-edit.component.scss',
...
export class CompoundPrescriptionDetailCrudEditComponent
