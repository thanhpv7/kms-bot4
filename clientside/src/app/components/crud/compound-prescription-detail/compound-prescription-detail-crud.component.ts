 ...
 */
@Component({
	selector: 'cb-compound-prescription-detail-crud',
	templateUrl: './compound-prescription-detail-crud.component.html',
	styleUrls: [
		'./compound-prescription-detail-crud.component.scss',
...
export class CompoundPrescriptionDetailCrudComponent implements OnDestroy {
