...
import {FluidBalanceDetailCrudListComponent} from './list/fluid-balance-detail-crud-list.component';
import {FluidBalanceDetailCrudEditComponent} from './edit/fluid-balance-detail-crud-edit.component';
import {FluidBalanceDetailCrudComponent} from './fluid-balance-detail-crud.component';
...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: FluidBalanceDetailCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: FluidBalanceDetailCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'fluid-balance-detail/view/:id',
				component: FluidBalanceDetailCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'fluid-balance-detail/create',
				component: FluidBalanceDetailCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'fluid-balance-detail/edit/:id',
				component: FluidBalanceDetailCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class FluidBalanceDetailCrudRoutingModule {
}
