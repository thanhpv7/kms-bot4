...
@Component({
	selector: 'cb-fluid-balance-detail-crud-edit',
	templateUrl: './fluid-balance-detail-crud-edit.component.html',
	styleUrls: [
		'./fluid-balance-detail-crud-edit.component.scss',
...
export class FluidBalanceDetailCrudEditComponent
