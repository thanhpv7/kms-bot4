...
import {FluidBalanceDetailCrudListComponent} from './fluid-balance-detail-crud-list.component';
...
describe('Fluid Balance Detail Crud List Tile Component', () => {
	...
	let fixture;
	let fluidBalanceDetailCrudListComponent: FluidBalanceDetailCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(FluidBalanceDetailCrudListComponent);
