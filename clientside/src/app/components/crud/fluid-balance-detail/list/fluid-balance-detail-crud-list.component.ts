...
@Component({
	selector: 'cb-fluid-balance-detail-crud-list',
	templateUrl: './fluid-balance-detail-crud-list.component.html',
	styleUrls: [
		'./fluid-balance-detail-crud-list.component.scss',
...
export class FluidBalanceDetailCrudListComponent
