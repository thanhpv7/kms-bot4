 ...
 */
@Component({
	selector: 'cb-fluid-balance-detail-crud',
	templateUrl: './fluid-balance-detail-crud.component.html',
	styleUrls: [
		'./fluid-balance-detail-crud.component.scss',
...
export class FluidBalanceDetailCrudComponent implements OnDestroy {
