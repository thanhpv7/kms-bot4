...
@Component({
	selector: 'cb-chart-of-account-crud-list',
	templateUrl: './chart-of-account-crud-list.component.html',
	styleUrls: [
		'./chart-of-account-crud-list.component.scss',
...
export class ChartOfAccountCrudListComponent
