...
import {ChartOfAccountCrudListComponent} from './chart-of-account-crud-list.component';
...
describe('Chart of Account Crud List Tile Component', () => {
	...
	let fixture;
	let chartOfAccountCrudListComponent: ChartOfAccountCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(ChartOfAccountCrudListComponent);
