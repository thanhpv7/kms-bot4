...
@Component({
	selector: 'cb-chart-of-account-crud-edit',
	templateUrl: './chart-of-account-crud-edit.component.html',
	styleUrls: [
		'./chart-of-account-crud-edit.component.scss',
...
export class ChartOfAccountCrudEditComponent
