 ...
 */
@Component({
	selector: 'cb-chart-of-account-crud',
	templateUrl: './chart-of-account-crud.component.html',
	styleUrls: [
		'./chart-of-account-crud.component.scss',
...
export class ChartOfAccountCrudComponent implements OnDestroy {
