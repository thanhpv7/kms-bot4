...
import {PcareDiagnosaCrudListComponent} from './pcare-diagnosa-crud-list.component';
...
import {PcareDiagnosaCrudModule} from '../pcare-diagnosa-crud.module';
import {
...
describe('PCare Diagnosa Crud List Tile Component', () => {
	...
	let fixture;
	let pcareDiagnosaCrudListComponent: PcareDiagnosaCrudListComponent;
	...
	const routerState: RouterState = {
		url: 'pcare-diagnosa-crud',
		urls: ['pcare-diagnosa-crud'],
		params: {},
		queryParams: {},
		data: {},
	};
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(PcareDiagnosaCrudListComponent);
