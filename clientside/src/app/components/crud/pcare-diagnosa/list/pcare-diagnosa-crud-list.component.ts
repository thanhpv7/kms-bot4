...
import {CrudTileMode} from '../pcare-diagnosa-crud.component';
...
@Component({
	selector: 'cb-pcare-diagnosa-crud-list',
	templateUrl: './pcare-diagnosa-crud-list.component.html',
	styleUrls: [
		'./pcare-diagnosa-crud-list.component.scss',
...
export class PcareDiagnosaCrudListComponent
