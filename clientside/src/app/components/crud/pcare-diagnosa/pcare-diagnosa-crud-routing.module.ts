...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: PcareDiagnosaCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: PcareDiagnosaCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'pcare-diagnosa/view/:id',
				component: PcareDiagnosaCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class PcareDiagnosaCrudRoutingModule {
}
