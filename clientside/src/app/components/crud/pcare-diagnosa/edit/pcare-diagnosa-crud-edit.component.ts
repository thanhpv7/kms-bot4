...
@Component({
	selector: 'cb-pcare-diagnosa-crud-edit',
	templateUrl: './pcare-diagnosa-crud-edit.component.html',
	styleUrls: [
		'./pcare-diagnosa-crud-edit.component.scss',
...
export class PcareDiagnosaCrudEditComponent
