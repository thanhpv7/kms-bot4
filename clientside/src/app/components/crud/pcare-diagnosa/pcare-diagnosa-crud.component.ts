 ...
 */
@Component({
	selector: 'cb-pcare-diagnosa-crud',
	templateUrl: './pcare-diagnosa-crud.component.html',
	styleUrls: [
		'./pcare-diagnosa-crud.component.scss',
...
export class PcareDiagnosaCrudComponent implements OnDestroy {
