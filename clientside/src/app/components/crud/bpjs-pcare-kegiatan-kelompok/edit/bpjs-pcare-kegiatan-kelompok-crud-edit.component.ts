...
@Component({
	selector: 'cb-bpjs-pcare-kegiatan-kelompok-crud-edit',
	templateUrl: './bpjs-pcare-kegiatan-kelompok-crud-edit.component.html',
	styleUrls: [
		'./bpjs-pcare-kegiatan-kelompok-crud-edit.component.scss',
...
export class BpjsPcareKegiatanKelompokCrudEditComponent
