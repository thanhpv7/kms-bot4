...
import {BpjsPcareKegiatanKelompokCrudListComponent} from './bpjs-pcare-kegiatan-kelompok-crud-list.component';
...
describe('BPJS Pcare Kegiatan Kelompok Crud List Tile Component', () => {
	...
	let fixture;
	let bpjsPcareKegiatanKelompokCrudListComponent: BpjsPcareKegiatanKelompokCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(BpjsPcareKegiatanKelompokCrudListComponent);
