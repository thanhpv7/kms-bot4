...
@Component({
	selector: 'cb-bpjs-pcare-kegiatan-kelompok-crud-list',
	templateUrl: './bpjs-pcare-kegiatan-kelompok-crud-list.component.html',
	styleUrls: [
		'./bpjs-pcare-kegiatan-kelompok-crud-list.component.scss',
...
export class BpjsPcareKegiatanKelompokCrudListComponent
