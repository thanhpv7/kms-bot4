...
import {BpjsPcareKegiatanKelompokCrudRoutingModule} from './bpjs-pcare-kegiatan-kelompok-crud-routing.module';
...
@NgModule({
	declarations: [
		BpjsPcareKegiatanKelompokCrudListComponent,
		BpjsPcareKegiatanKelompokCrudEditComponent,
		BpjsPcareKegiatanKelompokCrudComponent,
	...
	imports: [
		...
		CommonPipeModule,
		BpjsPcareKegiatanKelompokCrudRoutingModule,
...
export class BpjsPcareKegiatanKelompokCrudModule {
}
