 ...
 */
@Component({
	selector: 'cb-bpjs-pcare-kegiatan-kelompok-crud',
	templateUrl: './bpjs-pcare-kegiatan-kelompok-crud.component.html',
	styleUrls: [
		'./bpjs-pcare-kegiatan-kelompok-crud.component.scss',
...
export class BpjsPcareKegiatanKelompokCrudComponent implements OnDestroy {
