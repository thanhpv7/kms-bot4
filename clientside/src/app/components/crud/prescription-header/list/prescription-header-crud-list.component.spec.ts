...
import {PrescriptionHeaderCrudListComponent} from './prescription-header-crud-list.component';
...
describe('Prescription Header Crud List Tile Component', () => {
	...
	let fixture;
	let prescriptionHeaderCrudListComponent: PrescriptionHeaderCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(PrescriptionHeaderCrudListComponent);
