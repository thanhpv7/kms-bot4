...
@Component({
	selector: 'cb-prescription-header-crud-list',
	templateUrl: './prescription-header-crud-list.component.html',
	styleUrls: [
		'./prescription-header-crud-list.component.scss',
...
export class PrescriptionHeaderCrudListComponent
