 ...
 */
@Component({
	selector: 'cb-prescription-header-crud',
	templateUrl: './prescription-header-crud.component.html',
	styleUrls: [
		'./prescription-header-crud.component.scss',
...
export class PrescriptionHeaderCrudComponent implements OnDestroy {
