...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: PrescriptionHeaderCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: PrescriptionHeaderCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'prescription-header/view/:id',
				component: PrescriptionHeaderCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'prescription-header/create',
				component: PrescriptionHeaderCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'prescription-header/edit/:id',
				component: PrescriptionHeaderCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class PrescriptionHeaderCrudRoutingModule {
}
