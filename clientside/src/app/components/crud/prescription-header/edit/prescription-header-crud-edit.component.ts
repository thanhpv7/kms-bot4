...
@Component({
	selector: 'cb-prescription-header-crud-edit',
	templateUrl: './prescription-header-crud-edit.component.html',
	styleUrls: [
		'./prescription-header-crud-edit.component.scss',
...
export class PrescriptionHeaderCrudEditComponent
