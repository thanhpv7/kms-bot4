 ...
 */
@Component({
	selector: 'cb-delivery-medical-examination-record-crud',
	templateUrl: './delivery-medical-examination-record-crud.component.html',
	styleUrls: [
		'./delivery-medical-examination-record-crud.component.scss',
...
export class DeliveryMedicalExaminationRecordCrudComponent implements OnDestroy {
