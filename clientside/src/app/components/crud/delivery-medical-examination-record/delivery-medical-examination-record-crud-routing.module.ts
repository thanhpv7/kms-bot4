...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: DeliveryMedicalExaminationRecordCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: DeliveryMedicalExaminationRecordCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'delivery-medical-examination-record/view/:id',
				component: DeliveryMedicalExaminationRecordCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'delivery-medical-examination-record/create',
				component: DeliveryMedicalExaminationRecordCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'delivery-medical-examination-record/edit/:id',
				component: DeliveryMedicalExaminationRecordCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class DeliveryMedicalExaminationRecordCrudRoutingModule {
}
