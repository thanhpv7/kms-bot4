...
@Component({
	selector: 'cb-delivery-medical-examination-record-crud-list',
	templateUrl: './delivery-medical-examination-record-crud-list.component.html',
	styleUrls: [
		'./delivery-medical-examination-record-crud-list.component.scss',
...
export class DeliveryMedicalExaminationRecordCrudListComponent
