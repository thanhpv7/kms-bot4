 ...
 */
@Component({
	selector: 'cb-bpjs-doctor-schedule-crud',
	templateUrl: './bpjs-doctor-schedule-crud.component.html',
	styleUrls: [
		'./bpjs-doctor-schedule-crud.component.scss',
...
export class BpjsDoctorScheduleCrudComponent implements OnDestroy {
