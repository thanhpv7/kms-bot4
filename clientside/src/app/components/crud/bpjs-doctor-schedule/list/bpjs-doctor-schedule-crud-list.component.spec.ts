...
import {BpjsDoctorScheduleCrudListComponent} from './bpjs-doctor-schedule-crud-list.component';
...
describe('BPJS Doctor Schedule Crud List Tile Component', () => {
	...
	let fixture;
	let bpjsDoctorScheduleCrudListComponent: BpjsDoctorScheduleCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(BpjsDoctorScheduleCrudListComponent);
