...
@Component({
	selector: 'cb-bpjs-doctor-schedule-crud-list',
	templateUrl: './bpjs-doctor-schedule-crud-list.component.html',
	styleUrls: [
		'./bpjs-doctor-schedule-crud-list.component.scss',
...
export class BpjsDoctorScheduleCrudListComponent
