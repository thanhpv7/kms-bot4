...
@Component({
	selector: 'cb-bpjs-doctor-schedule-crud-edit',
	templateUrl: './bpjs-doctor-schedule-crud-edit.component.html',
	styleUrls: [
		'./bpjs-doctor-schedule-crud-edit.component.scss',
...
export class BpjsDoctorScheduleCrudEditComponent
