...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: BpjsDoctorScheduleCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: BpjsDoctorScheduleCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-doctor-schedule/view/:id',
				component: BpjsDoctorScheduleCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-doctor-schedule/create',
				component: BpjsDoctorScheduleCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'bpjs-doctor-schedule/edit/:id',
				component: BpjsDoctorScheduleCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class BpjsDoctorScheduleCrudRoutingModule {
}
