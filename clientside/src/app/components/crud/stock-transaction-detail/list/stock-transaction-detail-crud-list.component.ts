...
import {CrudTileMode} from '../stock-transaction-detail-crud.component';
...
@Component({
	selector: 'cb-stock-transaction-detail-crud-list',
	templateUrl: './stock-transaction-detail-crud-list.component.html',
	styleUrls: [
		'./stock-transaction-detail-crud-list.component.scss',
...
export class StockTransactionDetailCrudListComponent
