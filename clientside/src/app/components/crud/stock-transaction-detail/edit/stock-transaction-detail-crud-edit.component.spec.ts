...
import { 
	...
	getCountStockTransactionDetailModels,
	getStockTransactionDetailModelWithId
} from 'src/app/models/stockTransactionDetail/stock_transaction_detail.model.selector';
import { StockTransactionDetailCrudModule } from '../stock-transaction-detail-crud.module';
import { StockTransactionDetailCrudEditComponent } from './stock-transaction-detail-crud-edit.component';
import {
	StockTransactionDetailModelState,
	initialState as initialStockTransactionDetailModelState
} from 'src/app/models/stockTransactionDetail/stock_transaction_detail.model.state';
...
describe('Stock Transaction Detail CRUD Edit component tests', () => {
	let fixture: ComponentFixture<StockTransactionDetailCrudEditComponent>
	let component: StockTransactionDetailCrudEditComponent;

	let stockTransactionDetailModelState: StockTransactionDetailModelState;

	let store: MockStore<{ model: StockTransactionDetailModelState }>;
	let routerStore: MockStore<{router: RouterState}>;

	let routerStateBehaviorSubject: BehaviorSubject<RouterState>;
	let stockTransactionDetailCountBehaviorSubject: BehaviorSubject<number>;
	...
	let stockTransactionDetailWithId: StockTransactionDetailModel = defaultStockTransactionDetailEntities[0];
	let stockTransactionDetailModelWithIdBehaviorSubject: BehaviorSubject<StockTransactionDetailModel>;

	stockTransactionDetailWithId.stockCatalogue = defaultStockCatalogueEntities[0];
	stockTransactionDetailWithId.stockCatalogueId = stockTransactionDetailWithId.stockCatalogue.id;
	let stockCatalogueWithIdBehaviorSubject: BehaviorSubject<StockCatalogueModel>;

	stockTransactionDetailWithId.transactionDetailType = defaultTransactionDetailTypeEntities[0];
	stockTransactionDetailWithId.transactionDetailTypeId = stockTransactionDetailWithId.transactionDetailType.id;
	let transactionDetailTypeWithIdBehaviorSubject: BehaviorSubject<TransactionDetailTypeModel>;

	stockTransactionDetailWithId.warehouse = defaultWarehouseEntities[0];
	stockTransactionDetailWithId.warehouseId = stockTransactionDetailWithId.warehouse.id;
	let warehouseWithIdBehaviorSubject: BehaviorSubject<WarehouseModel>;


	const routerState: RouterState = {
		url: 'stock-transaction-detail-crud',
		urls: ['stock-transaction-detail-crud'],
		params: {},
		queryParams: {},
		data: {},
	};
	...
	function spySelectorsInStore() {
		...
		store = TestBed.inject(Store) as MockStore<{ model: StockTransactionDetailModelState }>;
		routerStore = TestBed.inject(Store) as MockStore<{ router: RouterState }>;

		stockTransactionDetailModelState = initialStockTransactionDetailModelState;
		store.setState({model: stockTransactionDetailModelState});
		routerStateBehaviorSubject = new BehaviorSubject(routerState);
		stockTransactionDetailCountBehaviorSubject = new BehaviorSubject(defaultStockTransactionDetailCount);
		...
		stockTransactionDetailModelWithIdBehaviorSubject = new BehaviorSubject(stockTransactionDetailWithId);
		stockCatalogueWithIdBehaviorSubject = new BehaviorSubject(stockTransactionDetailWithId.stockCatalogue);
		transactionDetailTypeWithIdBehaviorSubject = new BehaviorSubject(stockTransactionDetailWithId.transactionDetailType);
		warehouseWithIdBehaviorSubject = new BehaviorSubject(stockTransactionDetailWithId.warehouse);

		spyOn(store, 'select')
			.withArgs(getCountStockTransactionDetailModels).and.returnValue(stockTransactionDetailCountBehaviorSubject)
			.withArgs(getStockTransactionDetailModelWithId, stockTransactionDetailWithId.id).and.returnValue(stockTransactionDetailModelWithIdBehaviorSubject)
			...
			.withArgs(getStockCatalogueModelWithId, stockTransactionDetailWithId.stockCatalogueId).and.returnValue(stockCatalogueWithIdBehaviorSubject)
			.withArgs(getTransactionDetailTypeModelWithId, stockTransactionDetailWithId.transactionDetailTypeId).and.returnValue(transactionDetailTypeWithIdBehaviorSubject)
			.withArgs(getWarehouseModelWithId, stockTransactionDetailWithId.warehouseId).and.returnValue(warehouseWithIdBehaviorSubject)
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			imports: [
				...
				StockTransactionDetailCrudModule,
			...
			fixture = TestBed.createComponent(StockTransactionDetailCrudEditComponent);
			component = fixture.debugElement.componentInstance;
			component.ngOnInit();
			component.targetModel = new StockTransactionDetailModel();
	 ...
	 */
	it ('Renders the Stock Transaction Detail CRUD Edit Component', () => {
	...
	*/
	...
	it ('renders related Stock Catalogue entities from model when loading in edit mode', () => {
		component.targetModel = stockTransactionDetailWithId;
		component.targetModelId = stockTransactionDetailWithId.id;
