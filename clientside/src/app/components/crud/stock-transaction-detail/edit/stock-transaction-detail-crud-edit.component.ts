...
@Component({
	selector: 'cb-stock-transaction-detail-crud-edit',
	templateUrl: './stock-transaction-detail-crud-edit.component.html',
	styleUrls: [
		'./stock-transaction-detail-crud-edit.component.scss',
...
export class StockTransactionDetailCrudEditComponent
