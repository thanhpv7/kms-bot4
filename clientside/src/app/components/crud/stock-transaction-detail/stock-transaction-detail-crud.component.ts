 ...
 */
@Component({
	selector: 'cb-stock-transaction-detail-crud',
	templateUrl: './stock-transaction-detail-crud.component.html',
	styleUrls: [
		'./stock-transaction-detail-crud.component.scss',
...
export class StockTransactionDetailCrudComponent implements OnDestroy {
