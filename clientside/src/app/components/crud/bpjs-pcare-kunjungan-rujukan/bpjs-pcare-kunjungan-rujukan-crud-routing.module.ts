...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: BpjsPcareKunjunganRujukanCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: BpjsPcareKunjunganRujukanCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-pcare-kunjungan-rujukan/view/:id',
				component: BpjsPcareKunjunganRujukanCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-pcare-kunjungan-rujukan/create',
				component: BpjsPcareKunjunganRujukanCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'bpjs-pcare-kunjungan-rujukan/edit/:id',
				component: BpjsPcareKunjunganRujukanCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class BpjsPcareKunjunganRujukanCrudRoutingModule {
}
