...
@Component({
	selector: 'cb-bpjs-pcare-kunjungan-rujukan-crud-list',
	templateUrl: './bpjs-pcare-kunjungan-rujukan-crud-list.component.html',
	styleUrls: [
		'./bpjs-pcare-kunjungan-rujukan-crud-list.component.scss',
...
export class BpjsPcareKunjunganRujukanCrudListComponent
