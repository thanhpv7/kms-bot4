 ...
 */
@Component({
	selector: 'cb-bpjs-pcare-kunjungan-rujukan-crud',
	templateUrl: './bpjs-pcare-kunjungan-rujukan-crud.component.html',
	styleUrls: [
		'./bpjs-pcare-kunjungan-rujukan-crud.component.scss',
...
export class BpjsPcareKunjunganRujukanCrudComponent implements OnDestroy {
