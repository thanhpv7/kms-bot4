...
@Component({
	selector: 'cb-bpjs-pcare-kunjungan-rujukan-crud-edit',
	templateUrl: './bpjs-pcare-kunjungan-rujukan-crud-edit.component.html',
	styleUrls: [
		'./bpjs-pcare-kunjungan-rujukan-crud-edit.component.scss',
...
export class BpjsPcareKunjunganRujukanCrudEditComponent
