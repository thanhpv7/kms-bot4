...
@Component({
	selector: 'cb-examination-item-detail-crud-list',
	templateUrl: './examination-item-detail-crud-list.component.html',
	styleUrls: [
		'./examination-item-detail-crud-list.component.scss',
...
export class ExaminationItemDetailCrudListComponent
