...
import {ExaminationItemDetailCrudListComponent} from './examination-item-detail-crud-list.component';
...
describe('Examination Item Detail Crud List Tile Component', () => {
	...
	let fixture;
	let examinationItemDetailCrudListComponent: ExaminationItemDetailCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(ExaminationItemDetailCrudListComponent);
