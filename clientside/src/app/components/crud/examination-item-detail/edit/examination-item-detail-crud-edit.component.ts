...
@Component({
	selector: 'cb-examination-item-detail-crud-edit',
	templateUrl: './examination-item-detail-crud-edit.component.html',
	styleUrls: [
		'./examination-item-detail-crud-edit.component.scss',
...
export class ExaminationItemDetailCrudEditComponent
