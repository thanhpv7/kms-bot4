 ...
 */
@Component({
	selector: 'cb-examination-item-detail-crud',
	templateUrl: './examination-item-detail-crud.component.html',
	styleUrls: [
		'./examination-item-detail-crud.component.scss',
...
export class ExaminationItemDetailCrudComponent implements OnDestroy {
