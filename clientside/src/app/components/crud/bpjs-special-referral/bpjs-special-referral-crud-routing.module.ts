...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: BpjsSpecialReferralCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: BpjsSpecialReferralCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-special-referral/view/:id',
				component: BpjsSpecialReferralCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-special-referral/create',
				component: BpjsSpecialReferralCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'bpjs-special-referral/edit/:id',
				component: BpjsSpecialReferralCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class BpjsSpecialReferralCrudRoutingModule {
}
