...
import {BpjsSpecialReferralCrudListComponent} from './bpjs-special-referral-crud-list.component';
...
describe('BPJS Special Referral Crud List Tile Component', () => {
	...
	let fixture;
	let bpjsSpecialReferralCrudListComponent: BpjsSpecialReferralCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(BpjsSpecialReferralCrudListComponent);
