...
@Component({
	selector: 'cb-bpjs-special-referral-crud-list',
	templateUrl: './bpjs-special-referral-crud-list.component.html',
	styleUrls: [
		'./bpjs-special-referral-crud-list.component.scss',
...
export class BpjsSpecialReferralCrudListComponent
