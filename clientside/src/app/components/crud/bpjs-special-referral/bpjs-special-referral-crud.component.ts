 ...
 */
@Component({
	selector: 'cb-bpjs-special-referral-crud',
	templateUrl: './bpjs-special-referral-crud.component.html',
	styleUrls: [
		'./bpjs-special-referral-crud.component.scss',
...
export class BpjsSpecialReferralCrudComponent implements OnDestroy {
