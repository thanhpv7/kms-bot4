 ...
 */
@Component({
	selector: 'cb-bpjs-health-facility-crud',
	templateUrl: './bpjs-health-facility-crud.component.html',
	styleUrls: [
		'./bpjs-health-facility-crud.component.scss',
...
export class BpjsHealthFacilityCrudComponent implements OnDestroy {
