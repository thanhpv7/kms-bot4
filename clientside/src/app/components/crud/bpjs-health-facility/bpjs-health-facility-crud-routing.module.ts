...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: BpjsHealthFacilityCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: BpjsHealthFacilityCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-health-facility/view/:id',
				component: BpjsHealthFacilityCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-health-facility/create',
				component: BpjsHealthFacilityCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'bpjs-health-facility/edit/:id',
				component: BpjsHealthFacilityCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class BpjsHealthFacilityCrudRoutingModule {
}
