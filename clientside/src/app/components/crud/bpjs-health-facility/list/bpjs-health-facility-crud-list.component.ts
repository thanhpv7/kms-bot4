...
@Component({
	selector: 'cb-bpjs-health-facility-crud-list',
	templateUrl: './bpjs-health-facility-crud-list.component.html',
	styleUrls: [
		'./bpjs-health-facility-crud-list.component.scss',
...
export class BpjsHealthFacilityCrudListComponent
