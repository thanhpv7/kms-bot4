...
import {BpjsHealthFacilityCrudListComponent} from './bpjs-health-facility-crud-list.component';
...
describe('BPJS Health Facility Crud List Tile Component', () => {
	...
	let fixture;
	let bpjsHealthFacilityCrudListComponent: BpjsHealthFacilityCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(BpjsHealthFacilityCrudListComponent);
