...
import {GoodsReceiveNoteCrudListComponent} from './goods-receive-note-crud-list.component';
...
describe('Goods Receive Note Crud List Tile Component', () => {
	...
	let fixture;
	let goodsReceiveNoteCrudListComponent: GoodsReceiveNoteCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(GoodsReceiveNoteCrudListComponent);
