...
@Component({
	selector: 'cb-goods-receive-note-crud-list',
	templateUrl: './goods-receive-note-crud-list.component.html',
	styleUrls: [
		'./goods-receive-note-crud-list.component.scss',
...
export class GoodsReceiveNoteCrudListComponent
