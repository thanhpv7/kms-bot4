...
@Component({
	selector: 'cb-goods-receive-note-crud-edit',
	templateUrl: './goods-receive-note-crud-edit.component.html',
	styleUrls: [
		'./goods-receive-note-crud-edit.component.scss',
...
export class GoodsReceiveNoteCrudEditComponent
