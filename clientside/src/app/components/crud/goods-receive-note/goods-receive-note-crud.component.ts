 ...
 */
@Component({
	selector: 'cb-goods-receive-note-crud',
	templateUrl: './goods-receive-note-crud.component.html',
	styleUrls: [
		'./goods-receive-note-crud.component.scss',
...
export class GoodsReceiveNoteCrudComponent implements OnDestroy {
