...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: VaccinationOrderCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: VaccinationOrderCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'vaccination-order/view/:id',
				component: VaccinationOrderCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'vaccination-order/edit/:id',
				component: VaccinationOrderCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class VaccinationOrderCrudRoutingModule {
}
