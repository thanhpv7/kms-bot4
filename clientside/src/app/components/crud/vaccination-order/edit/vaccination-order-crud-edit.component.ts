...
@Component({
	selector: 'cb-vaccination-order-crud-edit',
	templateUrl: './vaccination-order-crud-edit.component.html',
	styleUrls: [
		'./vaccination-order-crud-edit.component.scss',
...
export class VaccinationOrderCrudEditComponent
