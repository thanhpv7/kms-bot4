 ...
 */
@Component({
	selector: 'cb-vaccination-order-crud',
	templateUrl: './vaccination-order-crud.component.html',
	styleUrls: [
		'./vaccination-order-crud.component.scss',
...
export class VaccinationOrderCrudComponent implements OnDestroy {
