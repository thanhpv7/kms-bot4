...
import {CrudTileMode} from '../vaccination-order-crud.component';
...
@Component({
	selector: 'cb-vaccination-order-crud-list',
	templateUrl: './vaccination-order-crud-list.component.html',
	styleUrls: [
		'./vaccination-order-crud-list.component.scss',
...
export class VaccinationOrderCrudListComponent
