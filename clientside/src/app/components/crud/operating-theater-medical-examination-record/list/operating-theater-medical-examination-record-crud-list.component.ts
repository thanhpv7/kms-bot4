...
@Component({
	selector: 'cb-operating-theater-medical-examination-record-crud-list',
	templateUrl: './operating-theater-medical-examination-record-crud-list.component.html',
	styleUrls: [
		'./operating-theater-medical-examination-record-crud-list.component.scss',
...
export class OperatingTheaterMedicalExaminationRecordCrudListComponent
