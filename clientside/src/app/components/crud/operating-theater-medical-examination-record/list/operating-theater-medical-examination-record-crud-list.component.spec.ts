...
import {OperatingTheaterMedicalExaminationRecordCrudListComponent} from './operating-theater-medical-examination-record-crud-list.component';
...
describe('Operating Theater Medical Examination Record Crud List Tile Component', () => {
	...
	let fixture;
	let operatingTheaterMedicalExaminationRecordCrudListComponent: OperatingTheaterMedicalExaminationRecordCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(OperatingTheaterMedicalExaminationRecordCrudListComponent);
