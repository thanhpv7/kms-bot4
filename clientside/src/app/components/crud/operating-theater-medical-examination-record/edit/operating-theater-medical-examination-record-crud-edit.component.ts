...
@Component({
	selector: 'cb-operating-theater-medical-examination-record-crud-edit',
	templateUrl: './operating-theater-medical-examination-record-crud-edit.component.html',
	styleUrls: [
		'./operating-theater-medical-examination-record-crud-edit.component.scss',
...
export class OperatingTheaterMedicalExaminationRecordCrudEditComponent
