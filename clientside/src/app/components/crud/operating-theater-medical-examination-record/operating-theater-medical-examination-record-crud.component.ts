 ...
 */
@Component({
	selector: 'cb-operating-theater-medical-examination-record-crud',
	templateUrl: './operating-theater-medical-examination-record-crud.component.html',
	styleUrls: [
		'./operating-theater-medical-examination-record-crud.component.scss',
...
export class OperatingTheaterMedicalExaminationRecordCrudComponent implements OnDestroy {
