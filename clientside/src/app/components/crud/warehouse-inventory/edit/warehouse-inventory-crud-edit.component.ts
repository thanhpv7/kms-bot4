...
@Component({
	selector: 'cb-warehouse-inventory-crud-edit',
	templateUrl: './warehouse-inventory-crud-edit.component.html',
	styleUrls: [
		'./warehouse-inventory-crud-edit.component.scss',
...
export class WarehouseInventoryCrudEditComponent
