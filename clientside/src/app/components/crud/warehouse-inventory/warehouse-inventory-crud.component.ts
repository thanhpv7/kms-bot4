 ...
 */
@Component({
	selector: 'cb-warehouse-inventory-crud',
	templateUrl: './warehouse-inventory-crud.component.html',
	styleUrls: [
		'./warehouse-inventory-crud.component.scss',
...
export class WarehouseInventoryCrudComponent implements OnDestroy {
