...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: WarehouseInventoryCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: WarehouseInventoryCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'warehouse-inventory/view/:id',
				component: WarehouseInventoryCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class WarehouseInventoryCrudRoutingModule {
}
