...
import {WarehouseInventoryCrudListComponent} from './warehouse-inventory-crud-list.component';
...
describe('Warehouse Inventory Crud List Tile Component', () => {
	...
	let fixture;
	let warehouseInventoryCrudListComponent: WarehouseInventoryCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(WarehouseInventoryCrudListComponent);
