...
@Component({
	selector: 'cb-warehouse-inventory-crud-list',
	templateUrl: './warehouse-inventory-crud-list.component.html',
	styleUrls: [
		'./warehouse-inventory-crud-list.component.scss',
...
export class WarehouseInventoryCrudListComponent
