...
@Component({
	selector: 'cb-bpjs-outside-facility-referral-crud-edit',
	templateUrl: './bpjs-outside-facility-referral-crud-edit.component.html',
	styleUrls: [
		'./bpjs-outside-facility-referral-crud-edit.component.scss',
...
export class BpjsOutsideFacilityReferralCrudEditComponent
