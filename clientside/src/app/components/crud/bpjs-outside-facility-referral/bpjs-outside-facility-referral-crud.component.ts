 ...
 */
@Component({
	selector: 'cb-bpjs-outside-facility-referral-crud',
	templateUrl: './bpjs-outside-facility-referral-crud.component.html',
	styleUrls: [
		'./bpjs-outside-facility-referral-crud.component.scss',
...
export class BpjsOutsideFacilityReferralCrudComponent implements OnDestroy {
