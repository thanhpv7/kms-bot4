...
import {BpjsOutsideFacilityReferralCrudListComponent} from './bpjs-outside-facility-referral-crud-list.component';
...
import {BpjsOutsideFacilityReferralCrudModule} from '../bpjs-outside-facility-referral-crud.module';
import {
...
describe('BPJS Outside Facility Referral Crud List Tile Component', () => {
	...
	let fixture;
	let bpjsOutsideFacilityReferralCrudListComponent: BpjsOutsideFacilityReferralCrudListComponent;
	...
	const routerState: RouterState = {
		url: 'bpjs-outside-facility-referral-crud',
		urls: ['bpjs-outside-facility-referral-crud'],
		params: {},
		queryParams: {},
		data: {},
	};
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			imports: [
				...
				BpjsOutsideFacilityReferralCrudModule,
			],
			providers: [
				provideMockStore(),
				{
			...
			fixture = TestBed.createComponent(BpjsOutsideFacilityReferralCrudListComponent);
