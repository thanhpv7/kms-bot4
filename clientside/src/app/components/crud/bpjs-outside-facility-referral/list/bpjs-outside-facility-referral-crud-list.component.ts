...
import {CrudTileMode} from '../bpjs-outside-facility-referral-crud.component';
...
@Component({
	selector: 'cb-bpjs-outside-facility-referral-crud-list',
	templateUrl: './bpjs-outside-facility-referral-crud-list.component.html',
	styleUrls: [
		'./bpjs-outside-facility-referral-crud-list.component.scss',
...
export class BpjsOutsideFacilityReferralCrudListComponent
