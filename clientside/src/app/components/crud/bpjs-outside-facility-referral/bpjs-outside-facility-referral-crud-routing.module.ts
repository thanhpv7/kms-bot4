...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: BpjsOutsideFacilityReferralCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: BpjsOutsideFacilityReferralCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-outside-facility-referral/view/:id',
				component: BpjsOutsideFacilityReferralCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-outside-facility-referral/create',
				component: BpjsOutsideFacilityReferralCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'bpjs-outside-facility-referral/edit/:id',
				component: BpjsOutsideFacilityReferralCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class BpjsOutsideFacilityReferralCrudRoutingModule {
}
