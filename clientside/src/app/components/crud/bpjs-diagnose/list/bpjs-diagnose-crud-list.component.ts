...
@Component({
	selector: 'cb-bpjs-diagnose-crud-list',
	templateUrl: './bpjs-diagnose-crud-list.component.html',
	styleUrls: [
		'./bpjs-diagnose-crud-list.component.scss',
...
export class BpjsDiagnoseCrudListComponent
