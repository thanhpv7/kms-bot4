...
import {BpjsDiagnoseCrudListComponent} from './bpjs-diagnose-crud-list.component';
...
describe('BPJS Diagnose Crud List Tile Component', () => {
	...
	let fixture;
	let bpjsDiagnoseCrudListComponent: BpjsDiagnoseCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(BpjsDiagnoseCrudListComponent);
