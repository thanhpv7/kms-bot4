 ...
 */
@Component({
	selector: 'cb-bpjs-diagnose-crud',
	templateUrl: './bpjs-diagnose-crud.component.html',
	styleUrls: [
		'./bpjs-diagnose-crud.component.scss',
...
export class BpjsDiagnoseCrudComponent implements OnDestroy {
