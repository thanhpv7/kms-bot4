 ...
 */
@Component({
	selector: 'cb-bpjs-claim-data-crud',
	templateUrl: './bpjs-claim-data-crud.component.html',
	styleUrls: [
		'./bpjs-claim-data-crud.component.scss',
...
export class BpjsClaimDataCrudComponent implements OnDestroy {
