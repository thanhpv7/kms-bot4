...
@Component({
	selector: 'cb-bpjs-claim-data-crud-list',
	templateUrl: './bpjs-claim-data-crud-list.component.html',
	styleUrls: [
		'./bpjs-claim-data-crud-list.component.scss',
...
export class BpjsClaimDataCrudListComponent
