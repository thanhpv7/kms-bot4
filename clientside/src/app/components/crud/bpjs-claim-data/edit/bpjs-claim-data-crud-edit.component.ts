...
@Component({
	selector: 'cb-bpjs-claim-data-crud-edit',
	templateUrl: './bpjs-claim-data-crud-edit.component.html',
	styleUrls: [
		'./bpjs-claim-data-crud-edit.component.scss',
...
export class BpjsClaimDataCrudEditComponent
