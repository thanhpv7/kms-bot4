...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: BpjsClaimDataCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: BpjsClaimDataCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-claim-data/view/:id',
				component: BpjsClaimDataCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class BpjsClaimDataCrudRoutingModule {
}
