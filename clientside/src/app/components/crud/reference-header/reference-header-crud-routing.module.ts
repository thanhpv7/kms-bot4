...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: ReferenceHeaderCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: ReferenceHeaderCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'reference-header/view/:id',
				component: ReferenceHeaderCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class ReferenceHeaderCrudRoutingModule {
}
