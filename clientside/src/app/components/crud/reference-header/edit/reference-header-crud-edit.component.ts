...
@Component({
	selector: 'cb-reference-header-crud-edit',
	templateUrl: './reference-header-crud-edit.component.html',
	styleUrls: [
		'./reference-header-crud-edit.component.scss',
...
export class ReferenceHeaderCrudEditComponent
