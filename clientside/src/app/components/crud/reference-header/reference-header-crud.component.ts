 ...
 */
@Component({
	selector: 'cb-reference-header-crud',
	templateUrl: './reference-header-crud.component.html',
	styleUrls: [
		'./reference-header-crud.component.scss',
...
export class ReferenceHeaderCrudComponent implements OnDestroy {
