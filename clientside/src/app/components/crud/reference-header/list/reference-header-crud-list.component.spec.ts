...
import {ReferenceHeaderCrudListComponent} from './reference-header-crud-list.component';
...
describe('Reference Header Crud List Tile Component', () => {
	...
	let fixture;
	let referenceHeaderCrudListComponent: ReferenceHeaderCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(ReferenceHeaderCrudListComponent);
