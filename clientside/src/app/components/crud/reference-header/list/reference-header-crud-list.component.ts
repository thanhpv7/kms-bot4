...
@Component({
	selector: 'cb-reference-header-crud-list',
	templateUrl: './reference-header-crud-list.component.html',
	styleUrls: [
		'./reference-header-crud-list.component.scss',
...
export class ReferenceHeaderCrudListComponent
