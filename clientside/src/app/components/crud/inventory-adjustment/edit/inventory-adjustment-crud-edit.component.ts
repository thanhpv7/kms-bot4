...
@Component({
	selector: 'cb-inventory-adjustment-crud-edit',
	templateUrl: './inventory-adjustment-crud-edit.component.html',
	styleUrls: [
		'./inventory-adjustment-crud-edit.component.scss',
...
export class InventoryAdjustmentCrudEditComponent
