 ...
 */
@Component({
	selector: 'cb-inventory-adjustment-crud',
	templateUrl: './inventory-adjustment-crud.component.html',
	styleUrls: [
		'./inventory-adjustment-crud.component.scss',
...
export class InventoryAdjustmentCrudComponent implements OnDestroy {
