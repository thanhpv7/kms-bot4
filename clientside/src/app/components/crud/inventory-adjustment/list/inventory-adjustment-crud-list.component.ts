...
@Component({
	selector: 'cb-inventory-adjustment-crud-list',
	templateUrl: './inventory-adjustment-crud-list.component.html',
	styleUrls: [
		'./inventory-adjustment-crud-list.component.scss',
...
export class InventoryAdjustmentCrudListComponent
