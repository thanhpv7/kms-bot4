...
import {CrudTileMode} from '../bpjs-update-dismissal-date-crud.component';
...
@Component({
	selector: 'cb-bpjs-update-dismissal-date-crud-list',
	templateUrl: './bpjs-update-dismissal-date-crud-list.component.html',
	styleUrls: [
		'./bpjs-update-dismissal-date-crud-list.component.scss',
...
export class BpjsUpdateDismissalDateCrudListComponent
