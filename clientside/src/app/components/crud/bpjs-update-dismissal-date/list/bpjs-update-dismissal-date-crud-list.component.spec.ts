...
import {BpjsUpdateDismissalDateCrudListComponent} from './bpjs-update-dismissal-date-crud-list.component';
...
import {BpjsUpdateDismissalDateCrudModule} from '../bpjs-update-dismissal-date-crud.module';
import {
...
describe('BPJS Update Dismissal Date Crud List Tile Component', () => {
	...
	let fixture;
	let bpjsUpdateDismissalDateCrudListComponent: BpjsUpdateDismissalDateCrudListComponent;
	...
	const routerState: RouterState = {
		url: 'bpjs-update-dismissal-date-crud',
		urls: ['bpjs-update-dismissal-date-crud'],
		params: {},
		queryParams: {},
		data: {},
	};
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			imports: [
				...
				BpjsUpdateDismissalDateCrudModule,
			],
			providers: [
				provideMockStore(),
				{
			...
			fixture = TestBed.createComponent(BpjsUpdateDismissalDateCrudListComponent);
