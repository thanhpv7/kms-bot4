...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: BpjsUpdateDismissalDateCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: BpjsUpdateDismissalDateCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-update-dismissal-date/view/:id',
				component: BpjsUpdateDismissalDateCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-update-dismissal-date/create',
				component: BpjsUpdateDismissalDateCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'bpjs-update-dismissal-date/edit/:id',
				component: BpjsUpdateDismissalDateCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class BpjsUpdateDismissalDateCrudRoutingModule {
}
