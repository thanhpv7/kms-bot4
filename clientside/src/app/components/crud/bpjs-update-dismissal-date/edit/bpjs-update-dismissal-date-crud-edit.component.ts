...
@Component({
	selector: 'cb-bpjs-update-dismissal-date-crud-edit',
	templateUrl: './bpjs-update-dismissal-date-crud-edit.component.html',
	styleUrls: [
		'./bpjs-update-dismissal-date-crud-edit.component.scss',
...
export class BpjsUpdateDismissalDateCrudEditComponent
