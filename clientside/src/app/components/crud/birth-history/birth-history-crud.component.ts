 ...
 */
@Component({
	selector: 'cb-birth-history-crud',
	templateUrl: './birth-history-crud.component.html',
	styleUrls: [
		'./birth-history-crud.component.scss',
...
export class BirthHistoryCrudComponent implements OnDestroy {
