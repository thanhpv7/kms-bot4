...
import { BirthHistoryCrudEditComponent } from './birth-history-crud-edit.component';
import {
...
describe('Birth History CRUD Edit component tests', () => {
	let fixture: ComponentFixture<BirthHistoryCrudEditComponent>
	let component: BirthHistoryCrudEditComponent;
	...
	let birthHistoryCountBehaviorSubject: BehaviorSubject<number>;
	...
	let birthHistoryWithId: BirthHistoryModel = defaultBirthHistoryEntities[0];
	let birthHistoryModelWithIdBehaviorSubject: BehaviorSubject<BirthHistoryModel>;

	birthHistoryWithId.medicalExaminationRecord = defaultMedicalExaminationRecordEntities[0];
	birthHistoryWithId.medicalExaminationRecordId = birthHistoryWithId.medicalExaminationRecord.id;
	...
	function spySelectorsInStore() {
		...
		birthHistoryCountBehaviorSubject = new BehaviorSubject(defaultBirthHistoryCount);
		...
		birthHistoryModelWithIdBehaviorSubject = new BehaviorSubject(birthHistoryWithId);
		medicalExaminationRecordWithIdBehaviorSubject = new BehaviorSubject(birthHistoryWithId.medicalExaminationRecord);

		spyOn(store, 'select')
			.withArgs(getCountBirthHistoryModels).and.returnValue(birthHistoryCountBehaviorSubject)
			.withArgs(getBirthHistoryModelWithId, birthHistoryWithId.id).and.returnValue(birthHistoryModelWithIdBehaviorSubject)
			...
			.withArgs(getMedicalExaminationRecordModelWithId, birthHistoryWithId.medicalExaminationRecordId).and.returnValue(medicalExaminationRecordWithIdBehaviorSubject)
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(BirthHistoryCrudEditComponent);
			component = fixture.debugElement.componentInstance;
			component.ngOnInit();
			component.targetModel = new BirthHistoryModel();
	 ...
	 */
	it ('Renders the Birth History CRUD Edit Component', () => {
	...
	*/
	...
	it ('renders related Medical Examination Record entities from model when loading in edit mode', () => {
		component.targetModel = birthHistoryWithId;
		component.targetModelId = birthHistoryWithId.id;
