...
@Component({
	selector: 'cb-birth-history-crud-edit',
	templateUrl: './birth-history-crud-edit.component.html',
	styleUrls: [
		'./birth-history-crud-edit.component.scss',
...
export class BirthHistoryCrudEditComponent
