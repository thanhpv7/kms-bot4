...
import {CrudTileMode} from '../birth-history-crud.component';
...
@Component({
	selector: 'cb-birth-history-crud-list',
	templateUrl: './birth-history-crud-list.component.html',
	styleUrls: [
		'./birth-history-crud-list.component.scss',
...
export class BirthHistoryCrudListComponent
