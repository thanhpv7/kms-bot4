...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: BirthHistoryCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: BirthHistoryCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'birth-history/view/:id',
				component: BirthHistoryCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class BirthHistoryCrudRoutingModule {
}
