...
import {SupplierCrudListComponent} from './supplier-crud-list.component';
...
describe('Supplier Crud List Tile Component', () => {
	...
	let fixture;
	let supplierCrudListComponent: SupplierCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(SupplierCrudListComponent);
