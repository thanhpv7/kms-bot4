 ...
 */
@Component({
	selector: 'cb-service-item-assignment-crud',
	templateUrl: './service-item-assignment-crud.component.html',
	styleUrls: [
		'./service-item-assignment-crud.component.scss',
...
export class ServiceItemAssignmentCrudComponent implements OnDestroy {
