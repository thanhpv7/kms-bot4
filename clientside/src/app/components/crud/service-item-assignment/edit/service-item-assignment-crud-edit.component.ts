...
@Component({
	selector: 'cb-service-item-assignment-crud-edit',
	templateUrl: './service-item-assignment-crud-edit.component.html',
	styleUrls: [
		'./service-item-assignment-crud-edit.component.scss',
...
export class ServiceItemAssignmentCrudEditComponent
