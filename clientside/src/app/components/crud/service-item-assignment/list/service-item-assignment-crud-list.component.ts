...
@Component({
	selector: 'cb-service-item-assignment-crud-list',
	templateUrl: './service-item-assignment-crud-list.component.html',
	styleUrls: [
		'./service-item-assignment-crud-list.component.scss',
...
export class ServiceItemAssignmentCrudListComponent
