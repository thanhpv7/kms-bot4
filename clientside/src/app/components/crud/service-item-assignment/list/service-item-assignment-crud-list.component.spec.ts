...
import {ServiceItemAssignmentCrudListComponent} from './service-item-assignment-crud-list.component';
...
describe('Service Item Assignment Crud List Tile Component', () => {
	...
	let fixture;
	let serviceItemAssignmentCrudListComponent: ServiceItemAssignmentCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(ServiceItemAssignmentCrudListComponent);
