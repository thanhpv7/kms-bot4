...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: ServiceItemAssignmentCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: ServiceItemAssignmentCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'service-item-assignment/view/:id',
				component: ServiceItemAssignmentCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'service-item-assignment/create',
				component: ServiceItemAssignmentCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'service-item-assignment/edit/:id',
				component: ServiceItemAssignmentCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class ServiceItemAssignmentCrudRoutingModule {
}
