...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: PcareClubProlanisCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: PcareClubProlanisCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'pcare-club-prolanis/view/:id',
				component: PcareClubProlanisCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'pcare-club-prolanis/create',
				component: PcareClubProlanisCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'pcare-club-prolanis/edit/:id',
				component: PcareClubProlanisCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class PcareClubProlanisCrudRoutingModule {
}
