 ...
 */
@Component({
	selector: 'cb-pcare-club-prolanis-crud',
	templateUrl: './pcare-club-prolanis-crud.component.html',
	styleUrls: [
		'./pcare-club-prolanis-crud.component.scss',
...
export class PcareClubProlanisCrudComponent implements OnDestroy {
