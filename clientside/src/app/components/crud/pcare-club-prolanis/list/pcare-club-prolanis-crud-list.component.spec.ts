...
import {PcareClubProlanisCrudListComponent} from './pcare-club-prolanis-crud-list.component';
...
import {PcareClubProlanisCrudModule} from '../pcare-club-prolanis-crud.module';
import {
...
describe('PCare Club Prolanis Crud List Tile Component', () => {
	...
	let fixture;
	let pcareClubProlanisCrudListComponent: PcareClubProlanisCrudListComponent;
	...
	const routerState: RouterState = {
		url: 'pcare-club-prolanis-crud',
		urls: ['pcare-club-prolanis-crud'],
		params: {},
		queryParams: {},
		data: {},
	};
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(PcareClubProlanisCrudListComponent);
