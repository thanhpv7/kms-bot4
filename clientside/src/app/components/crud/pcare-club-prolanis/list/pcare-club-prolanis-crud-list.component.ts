...
import {CrudTileMode} from '../pcare-club-prolanis-crud.component';
...
@Component({
	selector: 'cb-pcare-club-prolanis-crud-list',
	templateUrl: './pcare-club-prolanis-crud-list.component.html',
	styleUrls: [
		'./pcare-club-prolanis-crud-list.component.scss',
...
export class PcareClubProlanisCrudListComponent
