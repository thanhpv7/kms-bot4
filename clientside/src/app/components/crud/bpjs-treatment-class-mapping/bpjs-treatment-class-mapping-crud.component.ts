 ...
 */
@Component({
	selector: 'cb-bpjs-treatment-class-mapping-crud',
	templateUrl: './bpjs-treatment-class-mapping-crud.component.html',
	styleUrls: [
		'./bpjs-treatment-class-mapping-crud.component.scss',
...
export class BpjsTreatmentClassMappingCrudComponent implements OnDestroy {
