...
@Component({
	selector: 'cb-bpjs-treatment-class-mapping-crud-list',
	templateUrl: './bpjs-treatment-class-mapping-crud-list.component.html',
	styleUrls: [
		'./bpjs-treatment-class-mapping-crud-list.component.scss',
...
export class BpjsTreatmentClassMappingCrudListComponent
