...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: BpjsTreatmentClassMappingCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: BpjsTreatmentClassMappingCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-treatment-class-mapping/view/:id',
				component: BpjsTreatmentClassMappingCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-treatment-class-mapping/create',
				component: BpjsTreatmentClassMappingCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'bpjs-treatment-class-mapping/edit/:id',
				component: BpjsTreatmentClassMappingCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class BpjsTreatmentClassMappingCrudRoutingModule {
}
