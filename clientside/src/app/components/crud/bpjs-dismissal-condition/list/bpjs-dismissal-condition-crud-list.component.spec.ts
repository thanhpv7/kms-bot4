...
import {BpjsDismissalConditionCrudListComponent} from './bpjs-dismissal-condition-crud-list.component';
...
describe('BPJS Dismissal Condition Crud List Tile Component', () => {
	...
	let fixture;
	let bpjsDismissalConditionCrudListComponent: BpjsDismissalConditionCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(BpjsDismissalConditionCrudListComponent);
