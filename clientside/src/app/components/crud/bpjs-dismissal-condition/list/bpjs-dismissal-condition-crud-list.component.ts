...
@Component({
	selector: 'cb-bpjs-dismissal-condition-crud-list',
	templateUrl: './bpjs-dismissal-condition-crud-list.component.html',
	styleUrls: [
		'./bpjs-dismissal-condition-crud-list.component.scss',
...
export class BpjsDismissalConditionCrudListComponent
