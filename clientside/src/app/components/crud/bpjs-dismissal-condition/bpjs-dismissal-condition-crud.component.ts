 ...
 */
@Component({
	selector: 'cb-bpjs-dismissal-condition-crud',
	templateUrl: './bpjs-dismissal-condition-crud.component.html',
	styleUrls: [
		'./bpjs-dismissal-condition-crud.component.scss',
...
export class BpjsDismissalConditionCrudComponent implements OnDestroy {
