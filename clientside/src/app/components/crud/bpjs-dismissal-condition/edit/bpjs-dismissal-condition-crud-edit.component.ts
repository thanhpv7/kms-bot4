...
import {CrudTileMode} from '../bpjs-dismissal-condition-crud.component';
...
@Component({
	selector: 'cb-bpjs-dismissal-condition-crud-edit',
	templateUrl: './bpjs-dismissal-condition-crud-edit.component.html',
	styleUrls: [
		'./bpjs-dismissal-condition-crud-edit.component.scss',
...
export class BpjsDismissalConditionCrudEditComponent
