...
import { BpjsDismissalConditionCrudModule } from '../bpjs-dismissal-condition-crud.module';
import { BpjsDismissalConditionCrudEditComponent } from './bpjs-dismissal-condition-crud-edit.component';
import {
...
describe('BPJS Dismissal Condition CRUD Edit component tests', () => {
	let fixture: ComponentFixture<BpjsDismissalConditionCrudEditComponent>
	let component: BpjsDismissalConditionCrudEditComponent;
	...
	let bpjsDismissalConditionCountBehaviorSubject: BehaviorSubject<number>;
	...
	let bpjsDismissalConditionWithId: BpjsDismissalConditionModel = defaultBpjsDismissalConditionEntities[0];
	let bpjsDismissalConditionModelWithIdBehaviorSubject: BehaviorSubject<BpjsDismissalConditionModel>;

	bpjsDismissalConditionWithId.bpjsClaimSubmission = defaultBpjsClaimSubmissionEntities[0];
	bpjsDismissalConditionWithId.bpjsClaimSubmissionId = bpjsDismissalConditionWithId.bpjsClaimSubmission.id;
	let bpjsClaimSubmissionWithIdBehaviorSubject: BehaviorSubject<BpjsClaimSubmissionModel>;


	const routerState: RouterState = {
		url: 'bpjs-dismissal-condition-crud',
		urls: ['bpjs-dismissal-condition-crud'],
		params: {},
		queryParams: {},
		data: {},
	};
	...
	function spySelectorsInStore() {
		...
		bpjsDismissalConditionCountBehaviorSubject = new BehaviorSubject(defaultBpjsDismissalConditionCount);
		...
		bpjsDismissalConditionModelWithIdBehaviorSubject = new BehaviorSubject(bpjsDismissalConditionWithId);
		bpjsClaimSubmissionWithIdBehaviorSubject = new BehaviorSubject(bpjsDismissalConditionWithId.bpjsClaimSubmission);

		spyOn(store, 'select')
			.withArgs(getCountBpjsDismissalConditionModels).and.returnValue(bpjsDismissalConditionCountBehaviorSubject)
			.withArgs(getBpjsDismissalConditionModelWithId, bpjsDismissalConditionWithId.id).and.returnValue(bpjsDismissalConditionModelWithIdBehaviorSubject)
			...
			.withArgs(getBpjsClaimSubmissionModelWithId, bpjsDismissalConditionWithId.bpjsClaimSubmissionId).and.returnValue(bpjsClaimSubmissionWithIdBehaviorSubject)
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			imports: [
				...
				BpjsDismissalConditionCrudModule,
			...
			fixture = TestBed.createComponent(BpjsDismissalConditionCrudEditComponent);
			component = fixture.debugElement.componentInstance;
			component.ngOnInit();
			component.targetModel = new BpjsDismissalConditionModel();
	 ...
	 */
	it ('Renders the BPJS Dismissal Condition CRUD Edit Component', () => {
	...
	*/
	...
	it ('renders related BPJS Claim Submission entities from model when loading in edit mode', () => {
		component.targetModel = bpjsDismissalConditionWithId;
		component.targetModelId = bpjsDismissalConditionWithId.id;
