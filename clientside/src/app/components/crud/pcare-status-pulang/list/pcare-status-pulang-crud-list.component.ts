...
@Component({
	selector: 'cb-pcare-status-pulang-crud-list',
	templateUrl: './pcare-status-pulang-crud-list.component.html',
	styleUrls: [
		'./pcare-status-pulang-crud-list.component.scss',
...
export class PcareStatusPulangCrudListComponent
