...
import {PcareStatusPulangCrudListComponent} from './pcare-status-pulang-crud-list.component';
...
describe('PCare Status Pulang Crud List Tile Component', () => {
	...
	let fixture;
	let pcareStatusPulangCrudListComponent: PcareStatusPulangCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(PcareStatusPulangCrudListComponent);
