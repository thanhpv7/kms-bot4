...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: PcareStatusPulangCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: PcareStatusPulangCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'pcare-status-pulang/view/:id',
				component: PcareStatusPulangCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'pcare-status-pulang/create',
				component: PcareStatusPulangCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'pcare-status-pulang/edit/:id',
				component: PcareStatusPulangCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class PcareStatusPulangCrudRoutingModule {
}
