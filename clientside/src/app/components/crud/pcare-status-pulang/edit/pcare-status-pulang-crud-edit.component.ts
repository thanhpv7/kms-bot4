...
@Component({
	selector: 'cb-pcare-status-pulang-crud-edit',
	templateUrl: './pcare-status-pulang-crud-edit.component.html',
	styleUrls: [
		'./pcare-status-pulang-crud-edit.component.scss',
...
export class PcareStatusPulangCrudEditComponent
