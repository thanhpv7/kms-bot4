 ...
 */
@Component({
	selector: 'cb-pcare-status-pulang-crud',
	templateUrl: './pcare-status-pulang-crud.component.html',
	styleUrls: [
		'./pcare-status-pulang-crud.component.scss',
...
export class PcareStatusPulangCrudComponent implements OnDestroy {
