 ...
 */
@Component({
	selector: 'cb-bpjs-prb-detail-crud',
	templateUrl: './bpjs-prb-detail-crud.component.html',
	styleUrls: [
		'./bpjs-prb-detail-crud.component.scss',
...
export class BpjsPRBDetailCrudComponent implements OnDestroy {
