...
import {BpjsPRBDetailCrudListComponent} from './bpjs-prb-detail-crud-list.component';
...
describe('BPJS PRB Detail Crud List Tile Component', () => {
	...
	let fixture;
	let bpjsPRBDetailCrudListComponent: BpjsPRBDetailCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(BpjsPRBDetailCrudListComponent);
