...
import {CrudTileMode} from '../bpjs-prb-detail-crud.component';
...
@Component({
	selector: 'cb-bpjs-prb-detail-crud-list',
	templateUrl: './bpjs-prb-detail-crud-list.component.html',
	styleUrls: [
		'./bpjs-prb-detail-crud-list.component.scss',
...
export class BpjsPRBDetailCrudListComponent
