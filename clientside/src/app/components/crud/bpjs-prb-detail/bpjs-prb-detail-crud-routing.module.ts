...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: BpjsPRBDetailCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: BpjsPRBDetailCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-prb-detail/view/:id',
				component: BpjsPRBDetailCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class BpjsPRBDetailCrudRoutingModule {
}
