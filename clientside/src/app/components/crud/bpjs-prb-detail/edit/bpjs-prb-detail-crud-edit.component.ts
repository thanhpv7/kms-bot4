...
@Component({
	selector: 'cb-bpjs-prb-detail-crud-edit',
	templateUrl: './bpjs-prb-detail-crud-edit.component.html',
	styleUrls: [
		'./bpjs-prb-detail-crud-edit.component.scss',
...
export class BpjsPRBDetailCrudEditComponent
