...
import { PatientVitalInformationCrudModule } from '../patient-vital-information-crud.module';
import { PatientVitalInformationCrudEditComponent } from './patient-vital-information-crud-edit.component';
import {
	PatientVitalInformationModelState,
	initialState as initialPatientVitalInformationModelState
} from 'src/app/models/patientVitalInformation/patient_vital_information.model.state';
...
describe('Patient Vital Information CRUD Edit component tests', () => {
	let fixture: ComponentFixture<PatientVitalInformationCrudEditComponent>
	let component: PatientVitalInformationCrudEditComponent;

	let patientVitalInformationModelState: PatientVitalInformationModelState;

	let store: MockStore<{ model: PatientVitalInformationModelState }>;
	let routerStore: MockStore<{router: RouterState}>;

	let routerStateBehaviorSubject: BehaviorSubject<RouterState>;
	let patientVitalInformationCountBehaviorSubject: BehaviorSubject<number>;
	...
	let patientVitalInformationWithId: PatientVitalInformationModel = defaultPatientVitalInformationEntities[0];
	let patientVitalInformationModelWithIdBehaviorSubject: BehaviorSubject<PatientVitalInformationModel>;

	patientVitalInformationWithId.registration = defaultRegistrationEntities[0];
	patientVitalInformationWithId.registrationId = patientVitalInformationWithId.registration.id;
	let registrationWithIdBehaviorSubject: BehaviorSubject<RegistrationModel>;

	patientVitalInformationWithId.staff = defaultStaffEntities[0];
	patientVitalInformationWithId.staffId = patientVitalInformationWithId.staff.id;
	let staffWithIdBehaviorSubject: BehaviorSubject<StaffModel>;


	const routerState: RouterState = {
		url: 'patient-vital-information-crud',
		urls: ['patient-vital-information-crud'],
		params: {},
		queryParams: {},
		data: {},
	};
	...
	function spySelectorsInStore() {
		...
		store = TestBed.inject(Store) as MockStore<{ model: PatientVitalInformationModelState }>;
		routerStore = TestBed.inject(Store) as MockStore<{ router: RouterState }>;

		patientVitalInformationModelState = initialPatientVitalInformationModelState;
		store.setState({model: patientVitalInformationModelState});
		routerStateBehaviorSubject = new BehaviorSubject(routerState);
		patientVitalInformationCountBehaviorSubject = new BehaviorSubject(defaultPatientVitalInformationCount);
		...
		patientVitalInformationModelWithIdBehaviorSubject = new BehaviorSubject(patientVitalInformationWithId);
		registrationWithIdBehaviorSubject = new BehaviorSubject(patientVitalInformationWithId.registration);
		staffWithIdBehaviorSubject = new BehaviorSubject(patientVitalInformationWithId.staff);

		spyOn(store, 'select')
			.withArgs(getCountPatientVitalInformationModels).and.returnValue(patientVitalInformationCountBehaviorSubject)
			.withArgs(getPatientVitalInformationModelWithId, patientVitalInformationWithId.id).and.returnValue(patientVitalInformationModelWithIdBehaviorSubject)
			...
			.withArgs(getRegistrationModelWithId, patientVitalInformationWithId.registrationId).and.returnValue(registrationWithIdBehaviorSubject)
			.withArgs(getStaffModelWithId, patientVitalInformationWithId.staffId).and.returnValue(staffWithIdBehaviorSubject)
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			imports: [
				...
				PatientVitalInformationCrudModule,
			...
			fixture = TestBed.createComponent(PatientVitalInformationCrudEditComponent);
			component = fixture.debugElement.componentInstance;
			component.ngOnInit();
			component.targetModel = new PatientVitalInformationModel();
	 ...
	 */
	it ('Renders the Patient Vital Information CRUD Edit Component', () => {
	...
	*/
	...
	it ('renders related Registration entities from model when loading in edit mode', () => {
		component.targetModel = patientVitalInformationWithId;
		component.targetModelId = patientVitalInformationWithId.id;
