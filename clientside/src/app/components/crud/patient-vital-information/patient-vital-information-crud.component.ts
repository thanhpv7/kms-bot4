 ...
 */
@Component({
	selector: 'cb-patient-vital-information-crud',
	templateUrl: './patient-vital-information-crud.component.html',
	styleUrls: [
		'./patient-vital-information-crud.component.scss',
...
export class PatientVitalInformationCrudComponent implements OnDestroy {
