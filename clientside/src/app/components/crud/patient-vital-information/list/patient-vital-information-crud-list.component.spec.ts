...
import {PatientVitalInformationCrudListComponent} from './patient-vital-information-crud-list.component';
...
describe('Patient Vital Information Crud List Tile Component', () => {
	...
	let fixture;
	let patientVitalInformationCrudListComponent: PatientVitalInformationCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(PatientVitalInformationCrudListComponent);
