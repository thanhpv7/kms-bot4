...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: PatientVitalInformationCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: PatientVitalInformationCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'patient-vital-information/view/:id',
				component: PatientVitalInformationCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'patient-vital-information/create',
				component: PatientVitalInformationCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'patient-vital-information/edit/:id',
				component: PatientVitalInformationCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class PatientVitalInformationCrudRoutingModule {
}
