 ...
 */
@Component({
	selector: 'cb-obstetric-and-gynecology-history-crud',
	templateUrl: './obstetric-and-gynecology-history-crud.component.html',
	styleUrls: [
		'./obstetric-and-gynecology-history-crud.component.scss',
...
export class ObstetricAndGynecologyHistoryCrudComponent implements OnDestroy {
