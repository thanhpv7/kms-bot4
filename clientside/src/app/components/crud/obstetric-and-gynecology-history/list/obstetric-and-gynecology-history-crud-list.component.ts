...
@Component({
	selector: 'cb-obstetric-and-gynecology-history-crud-list',
	templateUrl: './obstetric-and-gynecology-history-crud-list.component.html',
	styleUrls: [
		'./obstetric-and-gynecology-history-crud-list.component.scss',
...
export class ObstetricAndGynecologyHistoryCrudListComponent
