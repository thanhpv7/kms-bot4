...
import {ObstetricAndGynecologyHistoryCrudListComponent} from './obstetric-and-gynecology-history-crud-list.component';
...
describe('Obstetric And Gynecology History Crud List Tile Component', () => {
	...
	let fixture;
	let obstetricAndGynecologyHistoryCrudListComponent: ObstetricAndGynecologyHistoryCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(ObstetricAndGynecologyHistoryCrudListComponent);
