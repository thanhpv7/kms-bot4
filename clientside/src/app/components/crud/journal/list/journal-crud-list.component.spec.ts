...
import {JournalCrudListComponent} from './journal-crud-list.component';
...
describe('Journal Crud List Tile Component', () => {
	...
	let fixture;
	let journalCrudListComponent: JournalCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(JournalCrudListComponent);
