...
@Component({
	selector: 'cb-bpjs-sep-submission-crud-edit',
	templateUrl: './bpjs-sep-submission-crud-edit.component.html',
	styleUrls: [
		'./bpjs-sep-submission-crud-edit.component.scss',
...
export class BpjsSEPSubmissionCrudEditComponent
