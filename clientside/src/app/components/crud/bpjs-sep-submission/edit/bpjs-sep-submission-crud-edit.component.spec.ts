...
import { BpjsSEPSubmissionCrudEditComponent } from './bpjs-sep-submission-crud-edit.component';
import {
...
describe('BPJS SEP Submission CRUD Edit component tests', () => {
	let fixture: ComponentFixture<BpjsSEPSubmissionCrudEditComponent>
	let component: BpjsSEPSubmissionCrudEditComponent;
	...
	let bpjsSEPSubmissionCountBehaviorSubject: BehaviorSubject<number>;
	...
	let bpjsSEPSubmissionWithId: BpjsSEPSubmissionModel = defaultBpjsSEPSubmissionEntities[0];
	let bpjsSEPSubmissionModelWithIdBehaviorSubject: BehaviorSubject<BpjsSEPSubmissionModel>;

	bpjsSEPSubmissionWithId.patientPaymentBPJS = defaultPatientPaymentBPJSEntities[0];
	bpjsSEPSubmissionWithId.patientPaymentBPJSId = bpjsSEPSubmissionWithId.patientPaymentBPJS.id;
	...
	function spySelectorsInStore() {
		...
		bpjsSEPSubmissionCountBehaviorSubject = new BehaviorSubject(defaultBpjsSEPSubmissionCount);
		...
		bpjsSEPSubmissionModelWithIdBehaviorSubject = new BehaviorSubject(bpjsSEPSubmissionWithId);
		patientPaymentBPJSWithIdBehaviorSubject = new BehaviorSubject(bpjsSEPSubmissionWithId.patientPaymentBPJS);

		spyOn(store, 'select')
			.withArgs(getCountBpjsSEPSubmissionModels).and.returnValue(bpjsSEPSubmissionCountBehaviorSubject)
			.withArgs(getBpjsSEPSubmissionModelWithId, bpjsSEPSubmissionWithId.id).and.returnValue(bpjsSEPSubmissionModelWithIdBehaviorSubject)
			...
			.withArgs(getPatientPaymentBPJSModelWithId, bpjsSEPSubmissionWithId.patientPaymentBPJSId).and.returnValue(patientPaymentBPJSWithIdBehaviorSubject)
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(BpjsSEPSubmissionCrudEditComponent);
			component = fixture.debugElement.componentInstance;
			component.ngOnInit();
			component.targetModel = new BpjsSEPSubmissionModel();
	 ...
	 */
	it ('Renders the BPJS SEP Submission CRUD Edit Component', () => {
	...
	*/
	...
	it ('renders related Patient Payment BPJS entities from model when loading in edit mode', () => {
		component.targetModel = bpjsSEPSubmissionWithId;
		component.targetModelId = bpjsSEPSubmissionWithId.id;
