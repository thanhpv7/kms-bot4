...
import {BpjsSEPSubmissionCrudListComponent} from './bpjs-sep-submission-crud-list.component';
...
import {BpjsSEPSubmissionCrudModule} from '../bpjs-sep-submission-crud.module';
import {
...
describe('BPJS SEP Submission Crud List Tile Component', () => {
	...
	let fixture;
	let bpjsSEPSubmissionCrudListComponent: BpjsSEPSubmissionCrudListComponent;
	...
	const routerState: RouterState = {
		url: 'bpjs-sep-submission-crud',
		urls: ['bpjs-sep-submission-crud'],
		params: {},
		queryParams: {},
		data: {},
	};
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(BpjsSEPSubmissionCrudListComponent);
