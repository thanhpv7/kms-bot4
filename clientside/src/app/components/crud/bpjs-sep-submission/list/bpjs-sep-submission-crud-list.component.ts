...
import {CrudTileMode} from '../bpjs-sep-submission-crud.component';
...
@Component({
	selector: 'cb-bpjs-sep-submission-crud-list',
	templateUrl: './bpjs-sep-submission-crud-list.component.html',
	styleUrls: [
		'./bpjs-sep-submission-crud-list.component.scss',
...
export class BpjsSEPSubmissionCrudListComponent
