 ...
 */
@Component({
	selector: 'cb-bpjs-sep-submission-crud',
	templateUrl: './bpjs-sep-submission-crud.component.html',
	styleUrls: [
		'./bpjs-sep-submission-crud.component.scss',
...
export class BpjsSEPSubmissionCrudComponent implements OnDestroy {
