...
import {BpjsINACBGVariableCrudListComponent} from './bpjs-inacbg-variable-crud-list.component';
...
describe('BPJS INACBG Variable Crud List Tile Component', () => {
	...
	let fixture;
	let bpjsINACBGVariableCrudListComponent: BpjsINACBGVariableCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(BpjsINACBGVariableCrudListComponent);
