...
@Component({
	selector: 'cb-bpjs-inacbg-variable-crud-list',
	templateUrl: './bpjs-inacbg-variable-crud-list.component.html',
	styleUrls: [
		'./bpjs-inacbg-variable-crud-list.component.scss',
...
export class BpjsINACBGVariableCrudListComponent
