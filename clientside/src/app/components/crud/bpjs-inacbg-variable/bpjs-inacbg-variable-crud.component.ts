 ...
 */
@Component({
	selector: 'cb-bpjs-inacbg-variable-crud',
	templateUrl: './bpjs-inacbg-variable-crud.component.html',
	styleUrls: [
		'./bpjs-inacbg-variable-crud.component.scss',
...
export class BpjsINACBGVariableCrudComponent implements OnDestroy {
