...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: BpjsINACBGVariableCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: BpjsINACBGVariableCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-inacbg-variable/view/:id',
				component: BpjsINACBGVariableCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-inacbg-variable/create',
				component: BpjsINACBGVariableCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'bpjs-inacbg-variable/edit/:id',
				component: BpjsINACBGVariableCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class BpjsINACBGVariableCrudRoutingModule {
}
