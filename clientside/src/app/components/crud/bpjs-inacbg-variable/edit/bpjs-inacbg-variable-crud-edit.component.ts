...
@Component({
	selector: 'cb-bpjs-inacbg-variable-crud-edit',
	templateUrl: './bpjs-inacbg-variable-crud-edit.component.html',
	styleUrls: [
		'./bpjs-inacbg-variable-crud-edit.component.scss',
...
export class BpjsINACBGVariableCrudEditComponent
