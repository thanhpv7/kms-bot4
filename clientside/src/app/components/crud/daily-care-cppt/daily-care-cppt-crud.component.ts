 ...
 */
@Component({
	selector: 'cb-daily-care-cppt-crud',
	templateUrl: './daily-care-cppt-crud.component.html',
	styleUrls: [
		'./daily-care-cppt-crud.component.scss',
...
export class DailyCareCPPTCrudComponent implements OnDestroy {
