...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: DailyCareCPPTCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: DailyCareCPPTCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'daily-care-cppt/view/:id',
				component: DailyCareCPPTCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class DailyCareCPPTCrudRoutingModule {
}
