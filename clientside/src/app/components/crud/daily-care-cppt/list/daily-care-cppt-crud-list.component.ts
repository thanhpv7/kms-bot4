...
@Component({
	selector: 'cb-daily-care-cppt-crud-list',
	templateUrl: './daily-care-cppt-crud-list.component.html',
	styleUrls: [
		'./daily-care-cppt-crud-list.component.scss',
...
export class DailyCareCPPTCrudListComponent
