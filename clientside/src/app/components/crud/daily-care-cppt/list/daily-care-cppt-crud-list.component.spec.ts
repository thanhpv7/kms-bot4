...
import {DailyCareCPPTCrudListComponent} from './daily-care-cppt-crud-list.component';
...
describe('Daily Care CPPT Crud List Tile Component', () => {
	...
	let fixture;
	let dailyCareCPPTCrudListComponent: DailyCareCPPTCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(DailyCareCPPTCrudListComponent);
