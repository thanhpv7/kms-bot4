...
@Component({
	selector: 'cb-daily-care-cppt-crud-edit',
	templateUrl: './daily-care-cppt-crud-edit.component.html',
	styleUrls: [
		'./daily-care-cppt-crud-edit.component.scss',
...
export class DailyCareCPPTCrudEditComponent
