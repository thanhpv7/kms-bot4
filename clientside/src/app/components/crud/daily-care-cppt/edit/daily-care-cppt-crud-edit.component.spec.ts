...
import { 
	getDailyCareCPPTCollectionModels,
	getCountDailyCareCPPTModels,
	getDailyCareCPPTModelWithId
} from 'src/app/models/dailyCareCPPT/daily_care_cppt.model.selector';
import { DailyCareCPPTCrudModule } from '../daily-care-cppt-crud.module';
import { DailyCareCPPTCrudEditComponent } from './daily-care-cppt-crud-edit.component';
import {
	DailyCareCPPTModelState,
	initialState as initialDailyCareCPPTModelState
} from 'src/app/models/dailyCareCPPT/daily_care_cppt.model.state';
...
import { CrudTileMode } from '../daily-care-cppt-crud.component';
...
describe('Daily Care CPPT CRUD Edit component tests', () => {
	let fixture: ComponentFixture<DailyCareCPPTCrudEditComponent>
	let component: DailyCareCPPTCrudEditComponent;

	let dailyCareCPPTModelState: DailyCareCPPTModelState;

	let store: MockStore<{ model: DailyCareCPPTModelState }>;
	let routerStore: MockStore<{router: RouterState}>;

	let routerStateBehaviorSubject: BehaviorSubject<RouterState>;
	let dailyCareCPPTCountBehaviorSubject: BehaviorSubject<number>;
	...
	let dailyCareCPPTWithId: DailyCareCPPTModel = defaultDailyCareCPPTEntities[0];
	let dailyCareCPPTModelWithIdBehaviorSubject: BehaviorSubject<DailyCareCPPTModel>;

	dailyCareCPPTWithId.icd10 = defaultDiagnosesAndProceduresEntities[0];
	dailyCareCPPTWithId.icd10Id = dailyCareCPPTWithId.icd10.id;
	let icd10WithIdBehaviorSubject: BehaviorSubject<DiagnosesAndProceduresModel>;

	dailyCareCPPTWithId.icd9CM = defaultDiagnosesAndProceduresEntities[0];
	dailyCareCPPTWithId.icd9CMId = dailyCareCPPTWithId.icd9CM.id;
	let icd9CMWithIdBehaviorSubject: BehaviorSubject<DiagnosesAndProceduresModel>;

	dailyCareCPPTWithId.createdByStaff = defaultStaffEntities[0];
	dailyCareCPPTWithId.createdByStaffId = dailyCareCPPTWithId.createdByStaff.id;
	let createdByStaffWithIdBehaviorSubject: BehaviorSubject<StaffModel>;

	dailyCareCPPTWithId.doctorInCharge = defaultStaffEntities[0];
	dailyCareCPPTWithId.doctorInChargeId = dailyCareCPPTWithId.doctorInCharge.id;
	let doctorInChargeWithIdBehaviorSubject: BehaviorSubject<StaffModel>;

	dailyCareCPPTWithId.medicalTranscriber = defaultStaffEntities[0];
	dailyCareCPPTWithId.medicalTranscriberId = dailyCareCPPTWithId.medicalTranscriber.id;
	let medicalTranscriberWithIdBehaviorSubject: BehaviorSubject<StaffModel>;

	dailyCareCPPTWithId.medicalExaminationRecord = defaultMedicalExaminationRecordEntities[0];
	dailyCareCPPTWithId.medicalExaminationRecordId = dailyCareCPPTWithId.medicalExaminationRecord.id;
	let medicalExaminationRecordWithIdBehaviorSubject: BehaviorSubject<MedicalExaminationRecordModel>;


	const routerState: RouterState = {
		url: 'daily-care-cppt-crud',
		urls: ['daily-care-cppt-crud'],
		params: {},
		queryParams: {},
		data: {},
	};
	...
	function spySelectorsInStore() {
		...
		store = TestBed.inject(Store) as MockStore<{ model: DailyCareCPPTModelState }>;
		routerStore = TestBed.inject(Store) as MockStore<{ router: RouterState }>;

		dailyCareCPPTModelState = initialDailyCareCPPTModelState;
		store.setState({model: dailyCareCPPTModelState});
		routerStateBehaviorSubject = new BehaviorSubject(routerState);
		dailyCareCPPTCountBehaviorSubject = new BehaviorSubject(defaultDailyCareCPPTCount);
		...
		dailyCareCPPTModelWithIdBehaviorSubject = new BehaviorSubject(dailyCareCPPTWithId);
		icd10WithIdBehaviorSubject = new BehaviorSubject(dailyCareCPPTWithId.icd10);
		icd9CMWithIdBehaviorSubject = new BehaviorSubject(dailyCareCPPTWithId.icd9CM);
		createdByStaffWithIdBehaviorSubject = new BehaviorSubject(dailyCareCPPTWithId.createdByStaff);
		doctorInChargeWithIdBehaviorSubject = new BehaviorSubject(dailyCareCPPTWithId.doctorInCharge);
		medicalTranscriberWithIdBehaviorSubject = new BehaviorSubject(dailyCareCPPTWithId.medicalTranscriber);
		medicalExaminationRecordWithIdBehaviorSubject = new BehaviorSubject(dailyCareCPPTWithId.medicalExaminationRecord);

		spyOn(store, 'select')
			.withArgs(getCountDailyCareCPPTModels).and.returnValue(dailyCareCPPTCountBehaviorSubject)
			.withArgs(getDailyCareCPPTModelWithId, dailyCareCPPTWithId.id).and.returnValue(dailyCareCPPTModelWithIdBehaviorSubject)
			...
			.withArgs(getDiagnosesAndProceduresModelWithId, dailyCareCPPTWithId.icd10Id).and.returnValue(icd10WithIdBehaviorSubject)
			.withArgs(getDiagnosesAndProceduresModelWithId, dailyCareCPPTWithId.icd9CMId).and.returnValue(icd9CMWithIdBehaviorSubject)
			.withArgs(getStaffModelWithId, dailyCareCPPTWithId.createdByStaffId).and.returnValue(createdByStaffWithIdBehaviorSubject)
			.withArgs(getStaffModelWithId, dailyCareCPPTWithId.doctorInChargeId).and.returnValue(doctorInChargeWithIdBehaviorSubject)
			.withArgs(getStaffModelWithId, dailyCareCPPTWithId.medicalTranscriberId).and.returnValue(medicalTranscriberWithIdBehaviorSubject)
			.withArgs(getMedicalExaminationRecordModelWithId, dailyCareCPPTWithId.medicalExaminationRecordId).and.returnValue(medicalExaminationRecordWithIdBehaviorSubject)
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(DailyCareCPPTCrudEditComponent);
			component = fixture.debugElement.componentInstance;
			component.ngOnInit();
			component.targetModel = new DailyCareCPPTModel();
	 ...
	 */
	it ('Renders the Daily Care CPPT CRUD Edit Component', () => {
	...
	*/
	...
	it ('renders related ICD 10 entities from model when loading in edit mode', () => {
		component.targetModel = dailyCareCPPTWithId;
		component.targetModelId = dailyCareCPPTWithId.id;
	...
	*/
	...
	/**
	* Checks that the status of the add model button matches the multi entity status for the Created By Staff relation.
	*
	* The button should only exist if createdByStaffMultiCrudActive is true
	*/
	it ('Renders Created By Staff Add Entity button in create mode', fakeAsync(() => {
		const createdByStaffButton: DebugElement = fixture.debugElement
				.queryAll(By.css('button.btn__add-entity'))
				.find(element => element.nativeElement.textContent.includes('Add New ' + component.createdByStaffDisplayName + ' to Model'));

		// For this test we don't need to interact with the button, as we are looking to prove that it exists and is present on the page
		// prepending the element with `!!` will turn the object into a boolean which is true if the element exists and false otherwise
		// If multi crud is off for this entity, then we expect the button to not exist, so we can check for equality with the MultiCrudActive attribute
		expect(!!createdByStaffButton).toEqual(component.createdByStaffMultiCrudActive);
	}));


	it ('Adds a new entity to the page when clicking button to add new Created By Staff', fakeAsync(() => {
		const createdByStaffButton: DebugElement = fixture.debugElement
				.queryAll(By.css('button.btn__add-entity'))
				.find(element => element.nativeElement.textContent.includes('Add New ' + component.createdByStaffDisplayName + ' to Model'));
		...
		if (component.createdByStaffMultiCrudActive) {
			// After clicking the add entity button, we will expect that the number of these buttons increases
			// We store this value now so that we can access it following interaction with the component
			const initialCreatedByStaffRemoveButtonCount = fixture.debugElement
					.queryAll(By.css('button.btn__remove-entity'))
					.filter(element => element.nativeElement.textContent.includes('Remove ' + component.createdByStaffDisplayName + ' from Model')).length;

			createdByStaffButton.nativeElement.click();
			fixture.detectChanges();

			const actualCreatedByStaffRemoveButtonCount = fixture.debugElement
					.queryAll(By.css('button.btn__remove-entity'))
					.filter(element => element.nativeElement.textContent.includes('Remove ' + component.createdByStaffDisplayName + ' from Model')).length;

			expect(actualCreatedByStaffRemoveButtonCount).toEqual(initialCreatedByStaffRemoveButtonCount + 1);
		}
	}));

	it ('Removes an additional entity from the page when clicking remove Created By Staff button', () => {
		const createdByStaffButton: DebugElement = fixture.debugElement
				.queryAll(By.css('button.btn__add-entity'))
				.find(element => element.nativeElement.textContent.includes('Add New ' + component.createdByStaffDisplayName + ' to Model'));
		...
		if (component.createdByStaffMultiCrudActive) {
			...
			// create an array of elements here as opposed to just getting the length (like in previous tests)
			// as we need to interact with the button in this test
			const initialCreatedByStaffRemoveButtons = fixture.debugElement
					.queryAll(By.css('button.btn__remove-entity'))
					.filter(element => element.nativeElement.textContent.includes('Remove ' + component.createdByStaffDisplayName + ' from Model'));

			// As we have already tested that clicking the add button adds the element, we know there will be at lease one button here to click
			initialCreatedByStaffRemoveButtons[0].nativeElement.click();
			fixture.detectChanges();

			const actualCreatedByStaffRemoveButtons = fixture.debugElement
					.queryAll(By.css('button.btn__remove-entity'))
					.filter(element => element.nativeElement.textContent.includes('Remove ' + component.createdByStaffDisplayName + ' from Model'));

			expect(actualCreatedByStaffRemoveButtons.length).toEqual(initialCreatedByStaffRemoveButtons.length - 1);
		}
	});

	it ('should disable the add Created By Staff button when one has already been added', () => {
		...
		if (component.createdByStaffMultiCrudActive) {
			...
			const updatedcreatedByStaffButton: DebugElement = fixture.debugElement
					.queryAll(By.css('button.btn__add-entity'))
					.find(element => element.nativeElement.textContent.includes('Add New ' + component.createdByStaffDisplayName + ' to Model'));

			expect(updatedcreatedByStaffButton.nativeElement.disabled).toBe(true);
		}
	});

	it ('renders related Created By Staff entities from model when loading in edit mode', () => {
		component.targetModel = dailyCareCPPTWithId;
		component.targetModelId = dailyCareCPPTWithId.id;
		component.tileMode = CrudTileMode.Edit;
		component.ngOnInit();
		...
		if (component.createdByStaffMultiCrudActive) {
			// As there is always one remove button per additional entity, running a test against the number of remove buttons is a simple
			// and reliable method to determine how many entities of the given type are present in the crud page
			const createdByStaffRemoveButtonCount = fixture.debugElement
				.queryAll(By.css('button.btn__remove-entity'))
				.filter(element => element.nativeElement.textContent.includes('Remove ' + component.createdByStaffDisplayName + ' from Model')).length;

			expect(createdByStaffRemoveButtonCount).toEqual(1);
		}
	});

	/**
	* Checks that the status of the add model button matches the multi entity status for the Doctor in Charge relation.
	*
	* The button should only exist if doctorInChargeMultiCrudActive is true
	*/
	it ('Renders Doctor in Charge Add Entity button in create mode', fakeAsync(() => {
		const doctorInChargeButton: DebugElement = fixture.debugElement
				.queryAll(By.css('button.btn__add-entity'))
				.find(element => element.nativeElement.textContent.includes('Add New ' + component.doctorInChargeDisplayName + ' to Model'));

		// For this test we don't need to interact with the button, as we are looking to prove that it exists and is present on the page
		// prepending the element with `!!` will turn the object into a boolean which is true if the element exists and false otherwise
		// If multi crud is off for this entity, then we expect the button to not exist, so we can check for equality with the MultiCrudActive attribute
		expect(!!doctorInChargeButton).toEqual(component.doctorInChargeMultiCrudActive);
	}));


	it ('Adds a new entity to the page when clicking button to add new Doctor in Charge', fakeAsync(() => {
		const doctorInChargeButton: DebugElement = fixture.debugElement
				.queryAll(By.css('button.btn__add-entity'))
				.find(element => element.nativeElement.textContent.includes('Add New ' + component.doctorInChargeDisplayName + ' to Model'));
		...
		if (component.doctorInChargeMultiCrudActive) {
			// After clicking the add entity button, we will expect that the number of these buttons increases
			// We store this value now so that we can access it following interaction with the component
			const initialDoctorInChargeRemoveButtonCount = fixture.debugElement
					.queryAll(By.css('button.btn__remove-entity'))
					.filter(element => element.nativeElement.textContent.includes('Remove ' + component.doctorInChargeDisplayName + ' from Model')).length;

			doctorInChargeButton.nativeElement.click();
			fixture.detectChanges();

			const actualDoctorInChargeRemoveButtonCount = fixture.debugElement
					.queryAll(By.css('button.btn__remove-entity'))
					.filter(element => element.nativeElement.textContent.includes('Remove ' + component.doctorInChargeDisplayName + ' from Model')).length;

			expect(actualDoctorInChargeRemoveButtonCount).toEqual(initialDoctorInChargeRemoveButtonCount + 1);
		}
	}));

	it ('Removes an additional entity from the page when clicking remove Doctor in Charge button', () => {
		const doctorInChargeButton: DebugElement = fixture.debugElement
				.queryAll(By.css('button.btn__add-entity'))
				.find(element => element.nativeElement.textContent.includes('Add New ' + component.doctorInChargeDisplayName + ' to Model'));
		...
		if (component.doctorInChargeMultiCrudActive) {
			...
			// create an array of elements here as opposed to just getting the length (like in previous tests)
			// as we need to interact with the button in this test
			const initialDoctorInChargeRemoveButtons = fixture.debugElement
					.queryAll(By.css('button.btn__remove-entity'))
					.filter(element => element.nativeElement.textContent.includes('Remove ' + component.doctorInChargeDisplayName + ' from Model'));

			// As we have already tested that clicking the add button adds the element, we know there will be at lease one button here to click
			initialDoctorInChargeRemoveButtons[0].nativeElement.click();
			fixture.detectChanges();

			const actualDoctorInChargeRemoveButtons = fixture.debugElement
					.queryAll(By.css('button.btn__remove-entity'))
					.filter(element => element.nativeElement.textContent.includes('Remove ' + component.doctorInChargeDisplayName + ' from Model'));

			expect(actualDoctorInChargeRemoveButtons.length).toEqual(initialDoctorInChargeRemoveButtons.length - 1);
		}
	});

	it ('should disable the add Doctor in Charge button when one has already been added', () => {
		...
		if (component.doctorInChargeMultiCrudActive) {
			...
			const updateddoctorInChargeButton: DebugElement = fixture.debugElement
					.queryAll(By.css('button.btn__add-entity'))
					.find(element => element.nativeElement.textContent.includes('Add New ' + component.doctorInChargeDisplayName + ' to Model'));

			expect(updateddoctorInChargeButton.nativeElement.disabled).toBe(true);
		}
	});

	it ('renders related Doctor in Charge entities from model when loading in edit mode', () => {
		component.targetModel = dailyCareCPPTWithId;
		component.targetModelId = dailyCareCPPTWithId.id;
		component.tileMode = CrudTileMode.Edit;
		component.ngOnInit();
		...
		if (component.doctorInChargeMultiCrudActive) {
			// As there is always one remove button per additional entity, running a test against the number of remove buttons is a simple
			// and reliable method to determine how many entities of the given type are present in the crud page
			const doctorInChargeRemoveButtonCount = fixture.debugElement
				.queryAll(By.css('button.btn__remove-entity'))
				.filter(element => element.nativeElement.textContent.includes('Remove ' + component.doctorInChargeDisplayName + ' from Model')).length;

			expect(doctorInChargeRemoveButtonCount).toEqual(1);
		}
	});
