...
@Component({
	selector: 'cb-bpjs-pcare-pendaftaran-crud-edit',
	templateUrl: './bpjs-pcare-pendaftaran-crud-edit.component.html',
	styleUrls: [
		'./bpjs-pcare-pendaftaran-crud-edit.component.scss',
...
export class BpjsPcarePendaftaranCrudEditComponent
