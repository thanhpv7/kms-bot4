 ...
 */
@Component({
	selector: 'cb-bpjs-pcare-pendaftaran-crud',
	templateUrl: './bpjs-pcare-pendaftaran-crud.component.html',
	styleUrls: [
		'./bpjs-pcare-pendaftaran-crud.component.scss',
...
export class BpjsPcarePendaftaranCrudComponent implements OnDestroy {
