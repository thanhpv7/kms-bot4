...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: BpjsPcarePendaftaranCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: BpjsPcarePendaftaranCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-pcare-pendaftaran/view/:id',
				component: BpjsPcarePendaftaranCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-pcare-pendaftaran/create',
				component: BpjsPcarePendaftaranCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'bpjs-pcare-pendaftaran/edit/:id',
				component: BpjsPcarePendaftaranCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class BpjsPcarePendaftaranCrudRoutingModule {
}
