...
@Component({
	selector: 'cb-bpjs-pcare-pendaftaran-crud-list',
	templateUrl: './bpjs-pcare-pendaftaran-crud-list.component.html',
	styleUrls: [
		'./bpjs-pcare-pendaftaran-crud-list.component.scss',
...
export class BpjsPcarePendaftaranCrudListComponent
