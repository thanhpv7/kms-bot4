...
import {BpjsPcarePendaftaranCrudListComponent} from './bpjs-pcare-pendaftaran-crud-list.component';
...
describe('Bpjs Pcare Pendaftaran Crud List Tile Component', () => {
	...
	let fixture;
	let bpjsPcarePendaftaranCrudListComponent: BpjsPcarePendaftaranCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(BpjsPcarePendaftaranCrudListComponent);
