...
@Component({
	selector: 'cb-internal-order-crud-edit',
	templateUrl: './internal-order-crud-edit.component.html',
	styleUrls: [
		'./internal-order-crud-edit.component.scss',
...
export class InternalOrderCrudEditComponent
