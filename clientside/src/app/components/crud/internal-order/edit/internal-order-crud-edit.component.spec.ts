...
import { InternalOrderCrudEditComponent } from './internal-order-crud-edit.component';
import {
...
describe('Internal Order CRUD Edit component tests', () => {
	let fixture: ComponentFixture<InternalOrderCrudEditComponent>
	let component: InternalOrderCrudEditComponent;
	...
	let internalOrderCountBehaviorSubject: BehaviorSubject<number>;
	...
	let internalOrderWithId: InternalOrderModel = defaultInternalOrderEntities[0];
	let internalOrderModelWithIdBehaviorSubject: BehaviorSubject<InternalOrderModel>;

	internalOrderWithId.warehouse = defaultWarehouseEntities[0];
	internalOrderWithId.warehouseId = internalOrderWithId.warehouse.id;
	let warehouseWithIdBehaviorSubject: BehaviorSubject<WarehouseModel>;

	internalOrderWithId.internalOrderStockDetails = defaultInternalOrderStockDetailEntities;
	internalOrderWithId.internalOrderStockDetailsIds = internalOrderWithId.internalOrderStockDetails.map(internalOrderStockDetails => internalOrderStockDetails.id);
	...
	function spySelectorsInStore() {
		...
		internalOrderCountBehaviorSubject = new BehaviorSubject(defaultInternalOrderCount);
		...
		internalOrderModelWithIdBehaviorSubject = new BehaviorSubject(internalOrderWithId);
		warehouseWithIdBehaviorSubject = new BehaviorSubject(internalOrderWithId.warehouse);

		spyOn(store, 'select')
			.withArgs(getCountInternalOrderModels).and.returnValue(internalOrderCountBehaviorSubject)
			.withArgs(getInternalOrderModelWithId, internalOrderWithId.id).and.returnValue(internalOrderModelWithIdBehaviorSubject)
			...
			.withArgs(getWarehouseModelWithId, internalOrderWithId.warehouseId).and.returnValue(warehouseWithIdBehaviorSubject)
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(InternalOrderCrudEditComponent);
			component = fixture.debugElement.componentInstance;
			component.ngOnInit();
			component.targetModel = new InternalOrderModel();
	 ...
	 */
	it ('Renders the Internal Order CRUD Edit Component', () => {
	...
	*/
	...
	it ('renders related Warehouse entities from model when loading in edit mode', () => {
		component.targetModel = internalOrderWithId;
		component.targetModelId = internalOrderWithId.id;
	...
	*/
	...
	it ('renders related Internal Order Stock Details entities from model when loading in edit mode', () => {
		...
		if (component.internalOrderStockDetailsMultiCrudActive) {
			...
			expect(internalOrderStockDetailsRemoveButtonCount).toEqual(internalOrderWithId.internalOrderStockDetails.length);
		}
	});
