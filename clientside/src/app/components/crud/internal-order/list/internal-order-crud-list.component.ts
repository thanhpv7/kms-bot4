...
import {CrudTileMode} from '../internal-order-crud.component';
...
@Component({
	selector: 'cb-internal-order-crud-list',
	templateUrl: './internal-order-crud-list.component.html',
	styleUrls: [
		'./internal-order-crud-list.component.scss',
...
export class InternalOrderCrudListComponent
