...
import {InternalOrderCrudListComponent} from './internal-order-crud-list.component';
...
import {InternalOrderCrudModule} from '../internal-order-crud.module';
import {
...
describe('Internal Order Crud List Tile Component', () => {
	...
	let fixture;
	let internalOrderCrudListComponent: InternalOrderCrudListComponent;
	...
	const routerState: RouterState = {
		url: 'internal-order-crud',
		urls: ['internal-order-crud'],
		params: {},
		queryParams: {},
		data: {},
	};
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(InternalOrderCrudListComponent);
