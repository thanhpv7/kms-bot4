...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: InternalOrderCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: InternalOrderCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			},
			{
				...
				component: InternalOrderCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class InternalOrderCrudRoutingModule {
}
