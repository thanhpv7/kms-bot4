 ...
 */
@Component({
	selector: 'cb-internal-order-crud',
	templateUrl: './internal-order-crud.component.html',
	styleUrls: [
		'./internal-order-crud.component.scss',
...
export class InternalOrderCrudComponent implements OnDestroy {
