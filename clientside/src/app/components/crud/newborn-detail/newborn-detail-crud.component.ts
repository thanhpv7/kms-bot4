 ...
 */
@Component({
	selector: 'cb-newborn-detail-crud',
	templateUrl: './newborn-detail-crud.component.html',
	styleUrls: [
		'./newborn-detail-crud.component.scss',
...
export class NewbornDetailCrudComponent implements OnDestroy {
