...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: NewbornDetailCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: NewbornDetailCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'newborn-detail/view/:id',
				component: NewbornDetailCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class NewbornDetailCrudRoutingModule {
}
