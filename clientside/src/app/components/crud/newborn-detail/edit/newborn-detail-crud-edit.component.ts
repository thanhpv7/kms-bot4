...
import {CrudTileMode} from '../newborn-detail-crud.component';
...
@Component({
	selector: 'cb-newborn-detail-crud-edit',
	templateUrl: './newborn-detail-crud-edit.component.html',
	styleUrls: [
		'./newborn-detail-crud-edit.component.scss',
...
export class NewbornDetailCrudEditComponent
