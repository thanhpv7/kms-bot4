...
import {NewbornDetailCrudListComponent} from './newborn-detail-crud-list.component';
...
describe('Newborn Detail Crud List Tile Component', () => {
	...
	let fixture;
	let newbornDetailCrudListComponent: NewbornDetailCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(NewbornDetailCrudListComponent);
