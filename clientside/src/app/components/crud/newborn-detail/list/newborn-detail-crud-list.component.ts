...
@Component({
	selector: 'cb-newborn-detail-crud-list',
	templateUrl: './newborn-detail-crud-list.component.html',
	styleUrls: [
		'./newborn-detail-crud-list.component.scss',
...
export class NewbornDetailCrudListComponent
