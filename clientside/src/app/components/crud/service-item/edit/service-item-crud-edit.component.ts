...
@Component({
	selector: 'cb-service-item-crud-edit',
	templateUrl: './service-item-crud-edit.component.html',
	styleUrls: [
		'./service-item-crud-edit.component.scss',
...
export class ServiceItemCrudEditComponent
