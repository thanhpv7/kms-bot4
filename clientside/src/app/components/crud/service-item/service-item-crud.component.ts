 ...
 */
@Component({
	selector: 'cb-service-item-crud',
	templateUrl: './service-item-crud.component.html',
	styleUrls: [
		'./service-item-crud.component.scss',
...
export class ServiceItemCrudComponent implements OnDestroy {
