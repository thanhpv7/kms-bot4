...
import {ServiceItemCrudListComponent} from './service-item-crud-list.component';
...
describe('Service Item Crud List Tile Component', () => {
	...
	let fixture;
	let serviceItemCrudListComponent: ServiceItemCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(ServiceItemCrudListComponent);
