...
@Component({
	selector: 'cb-service-item-crud-list',
	templateUrl: './service-item-crud-list.component.html',
	styleUrls: [
		'./service-item-crud-list.component.scss',
...
export class ServiceItemCrudListComponent
