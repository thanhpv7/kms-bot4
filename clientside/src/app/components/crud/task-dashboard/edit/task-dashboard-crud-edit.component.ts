...
@Component({
	selector: 'cb-task-dashboard-crud-edit',
	templateUrl: './task-dashboard-crud-edit.component.html',
	styleUrls: [
		'./task-dashboard-crud-edit.component.scss',
...
export class TaskDashboardCrudEditComponent
