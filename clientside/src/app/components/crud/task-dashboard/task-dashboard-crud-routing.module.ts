...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: TaskDashboardCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: TaskDashboardCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'task-dashboard/view/:id',
				component: TaskDashboardCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class TaskDashboardCrudRoutingModule {
}
