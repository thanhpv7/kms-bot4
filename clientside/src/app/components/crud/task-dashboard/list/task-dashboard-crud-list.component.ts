...
import {CrudTileMode} from '../task-dashboard-crud.component';
...
@Component({
	selector: 'cb-task-dashboard-crud-list',
	templateUrl: './task-dashboard-crud-list.component.html',
	styleUrls: [
		'./task-dashboard-crud-list.component.scss',
...
export class TaskDashboardCrudListComponent
