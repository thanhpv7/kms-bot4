...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: MedicationHeaderCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: MedicationHeaderCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'medication-header/view/:id',
				component: MedicationHeaderCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'medication-header/edit/:id',
				component: MedicationHeaderCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class MedicationHeaderCrudRoutingModule {
}
