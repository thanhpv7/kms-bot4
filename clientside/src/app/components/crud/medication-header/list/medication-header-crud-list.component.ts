...
@Component({
	selector: 'cb-medication-header-crud-list',
	templateUrl: './medication-header-crud-list.component.html',
	styleUrls: [
		'./medication-header-crud-list.component.scss',
...
export class MedicationHeaderCrudListComponent
