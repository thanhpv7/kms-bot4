...
import {MedicationHeaderCrudListComponent} from './medication-header-crud-list.component';
...
describe('Medication Header Crud List Tile Component', () => {
	...
	let fixture;
	let medicationHeaderCrudListComponent: MedicationHeaderCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(MedicationHeaderCrudListComponent);
