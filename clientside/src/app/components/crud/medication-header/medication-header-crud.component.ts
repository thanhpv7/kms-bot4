 ...
 */
@Component({
	selector: 'cb-medication-header-crud',
	templateUrl: './medication-header-crud.component.html',
	styleUrls: [
		'./medication-header-crud.component.scss',
...
export class MedicationHeaderCrudComponent implements OnDestroy {
