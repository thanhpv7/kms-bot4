...
import {CrudTileMode} from '../medication-header-crud.component';
...
@Component({
	selector: 'cb-medication-header-crud-edit',
	templateUrl: './medication-header-crud-edit.component.html',
	styleUrls: [
		'./medication-header-crud-edit.component.scss',
...
export class MedicationHeaderCrudEditComponent
