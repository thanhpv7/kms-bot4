...
@Component({
	selector: 'cb-bpjs-sep-internal-data-crud-list',
	templateUrl: './bpjs-sep-internal-data-crud-list.component.html',
	styleUrls: [
		'./bpjs-sep-internal-data-crud-list.component.scss',
...
export class BpjsSEPInternalDataCrudListComponent
