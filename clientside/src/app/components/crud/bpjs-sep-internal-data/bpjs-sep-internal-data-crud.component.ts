 ...
 */
@Component({
	selector: 'cb-bpjs-sep-internal-data-crud',
	templateUrl: './bpjs-sep-internal-data-crud.component.html',
	styleUrls: [
		'./bpjs-sep-internal-data-crud.component.scss',
...
export class BpjsSEPInternalDataCrudComponent implements OnDestroy {
