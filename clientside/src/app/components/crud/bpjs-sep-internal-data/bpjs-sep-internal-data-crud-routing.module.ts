...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: BpjsSEPInternalDataCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: BpjsSEPInternalDataCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-sep-internal-data/view/:id',
				component: BpjsSEPInternalDataCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-sep-internal-data/create',
				component: BpjsSEPInternalDataCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'bpjs-sep-internal-data/edit/:id',
				component: BpjsSEPInternalDataCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class BpjsSEPInternalDataCrudRoutingModule {
}
