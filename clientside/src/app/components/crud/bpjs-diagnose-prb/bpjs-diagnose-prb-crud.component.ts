 ...
 */
@Component({
	selector: 'cb-bpjs-diagnose-prb-crud',
	templateUrl: './bpjs-diagnose-prb-crud.component.html',
	styleUrls: [
		'./bpjs-diagnose-prb-crud.component.scss',
...
export class BpjsDiagnosePRBCrudComponent implements OnDestroy {
