...
@Component({
	selector: 'cb-bpjs-diagnose-prb-crud-edit',
	templateUrl: './bpjs-diagnose-prb-crud-edit.component.html',
	styleUrls: [
		'./bpjs-diagnose-prb-crud-edit.component.scss',
...
export class BpjsDiagnosePRBCrudEditComponent
