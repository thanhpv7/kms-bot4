...
@Component({
	selector: 'cb-bpjs-diagnose-prb-crud-list',
	templateUrl: './bpjs-diagnose-prb-crud-list.component.html',
	styleUrls: [
		'./bpjs-diagnose-prb-crud-list.component.scss',
...
export class BpjsDiagnosePRBCrudListComponent
