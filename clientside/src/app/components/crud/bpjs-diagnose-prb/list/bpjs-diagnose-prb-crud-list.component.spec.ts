...
import {BpjsDiagnosePRBCrudListComponent} from './bpjs-diagnose-prb-crud-list.component';
...
describe('BPJS Diagnose PRB Crud List Tile Component', () => {
	...
	let fixture;
	let bpjsDiagnosePRBCrudListComponent: BpjsDiagnosePRBCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(BpjsDiagnosePRBCrudListComponent);
