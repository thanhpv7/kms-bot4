...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: DoctorScheduleCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: DoctorScheduleCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'doctor-schedule/view/:id',
				component: DoctorScheduleCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class DoctorScheduleCrudRoutingModule {
}
