 ...
 */
@Component({
	selector: 'cb-doctor-schedule-crud',
	templateUrl: './doctor-schedule-crud.component.html',
	styleUrls: [
		'./doctor-schedule-crud.component.scss',
...
export class DoctorScheduleCrudComponent implements OnDestroy {
