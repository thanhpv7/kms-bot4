...
import {DoctorScheduleCrudListComponent} from './doctor-schedule-crud-list.component';
...
describe('Doctor Schedule Crud List Tile Component', () => {
	...
	let fixture;
	let doctorScheduleCrudListComponent: DoctorScheduleCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(DoctorScheduleCrudListComponent);
