...
import {CrudTileMode} from '../doctor-schedule-crud.component';
...
@Component({
	selector: 'cb-doctor-schedule-crud-list',
	templateUrl: './doctor-schedule-crud-list.component.html',
	styleUrls: [
		'./doctor-schedule-crud-list.component.scss',
...
export class DoctorScheduleCrudListComponent
