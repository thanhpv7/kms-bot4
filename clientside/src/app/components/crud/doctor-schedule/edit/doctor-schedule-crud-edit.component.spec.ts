...
import { DoctorScheduleCrudModule } from '../doctor-schedule-crud.module';
import { DoctorScheduleCrudEditComponent } from './doctor-schedule-crud-edit.component';
import {
	DoctorScheduleModelState,
	initialState as initialDoctorScheduleModelState
} from 'src/app/models/doctorSchedule/doctor_schedule.model.state';
...
describe('Doctor Schedule CRUD Edit component tests', () => {
	let fixture: ComponentFixture<DoctorScheduleCrudEditComponent>
	let component: DoctorScheduleCrudEditComponent;

	let doctorScheduleModelState: DoctorScheduleModelState;

	let store: MockStore<{ model: DoctorScheduleModelState }>;
	let routerStore: MockStore<{router: RouterState}>;

	let routerStateBehaviorSubject: BehaviorSubject<RouterState>;
	let doctorScheduleCountBehaviorSubject: BehaviorSubject<number>;
	...
	let doctorScheduleWithId: DoctorScheduleModel = defaultDoctorScheduleEntities[0];
	let doctorScheduleModelWithIdBehaviorSubject: BehaviorSubject<DoctorScheduleModel>;

	doctorScheduleWithId.service = defaultServiceEntities[0];
	doctorScheduleWithId.serviceId = doctorScheduleWithId.service.id;
	let serviceWithIdBehaviorSubject: BehaviorSubject<ServiceModel>;

	doctorScheduleWithId.staff = defaultStaffEntities[0];
	doctorScheduleWithId.staffId = doctorScheduleWithId.staff.id;
	let staffWithIdBehaviorSubject: BehaviorSubject<StaffModel>;


	const routerState: RouterState = {
		url: 'doctor-schedule-crud',
		urls: ['doctor-schedule-crud'],
		params: {},
		queryParams: {},
		data: {},
	};
	...
	function spySelectorsInStore() {
		...
		store = TestBed.inject(Store) as MockStore<{ model: DoctorScheduleModelState }>;
		routerStore = TestBed.inject(Store) as MockStore<{ router: RouterState }>;

		doctorScheduleModelState = initialDoctorScheduleModelState;
		store.setState({model: doctorScheduleModelState});
		routerStateBehaviorSubject = new BehaviorSubject(routerState);
		doctorScheduleCountBehaviorSubject = new BehaviorSubject(defaultDoctorScheduleCount);
		...
		doctorScheduleModelWithIdBehaviorSubject = new BehaviorSubject(doctorScheduleWithId);
		serviceWithIdBehaviorSubject = new BehaviorSubject(doctorScheduleWithId.service);
		staffWithIdBehaviorSubject = new BehaviorSubject(doctorScheduleWithId.staff);

		spyOn(store, 'select')
			.withArgs(getCountDoctorScheduleModels).and.returnValue(doctorScheduleCountBehaviorSubject)
			.withArgs(getDoctorScheduleModelWithId, doctorScheduleWithId.id).and.returnValue(doctorScheduleModelWithIdBehaviorSubject)
			...
			.withArgs(getServiceModelWithId, doctorScheduleWithId.serviceId).and.returnValue(serviceWithIdBehaviorSubject)
			.withArgs(getStaffModelWithId, doctorScheduleWithId.staffId).and.returnValue(staffWithIdBehaviorSubject)
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(DoctorScheduleCrudEditComponent);
			component = fixture.debugElement.componentInstance;
			component.ngOnInit();
			component.targetModel = new DoctorScheduleModel();
	 ...
	 */
	it ('Renders the Doctor Schedule CRUD Edit Component', () => {
	...
	*/
	...
	it ('renders related Service entities from model when loading in edit mode', () => {
		component.targetModel = doctorScheduleWithId;
		component.targetModelId = doctorScheduleWithId.id;
