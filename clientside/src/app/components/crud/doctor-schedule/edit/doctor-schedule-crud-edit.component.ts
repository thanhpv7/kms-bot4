...
@Component({
	selector: 'cb-doctor-schedule-crud-edit',
	templateUrl: './doctor-schedule-crud-edit.component.html',
	styleUrls: [
		'./doctor-schedule-crud-edit.component.scss',
...
export class DoctorScheduleCrudEditComponent
