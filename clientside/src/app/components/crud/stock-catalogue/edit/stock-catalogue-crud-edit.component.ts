...
@Component({
	selector: 'cb-stock-catalogue-crud-edit',
	templateUrl: './stock-catalogue-crud-edit.component.html',
	styleUrls: [
		'./stock-catalogue-crud-edit.component.scss',
...
export class StockCatalogueCrudEditComponent
