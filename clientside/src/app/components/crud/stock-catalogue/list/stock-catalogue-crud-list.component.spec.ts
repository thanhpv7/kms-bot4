...
import {StockCatalogueCrudListComponent} from './stock-catalogue-crud-list.component';
...
describe('Stock Catalogue Crud List Tile Component', () => {
	...
	let fixture;
	let stockCatalogueCrudListComponent: StockCatalogueCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(StockCatalogueCrudListComponent);
