...
@Component({
	selector: 'cb-stock-catalogue-crud-list',
	templateUrl: './stock-catalogue-crud-list.component.html',
	styleUrls: [
		'./stock-catalogue-crud-list.component.scss',
...
export class StockCatalogueCrudListComponent
