 ...
 */
@Component({
	selector: 'cb-stock-catalogue-crud',
	templateUrl: './stock-catalogue-crud.component.html',
	styleUrls: [
		'./stock-catalogue-crud.component.scss',
...
export class StockCatalogueCrudComponent implements OnDestroy {
