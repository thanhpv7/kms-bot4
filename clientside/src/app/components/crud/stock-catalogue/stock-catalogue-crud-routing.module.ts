...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: StockCatalogueCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: StockCatalogueCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'stock-catalogue/view/:id',
				component: StockCatalogueCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class StockCatalogueCrudRoutingModule {
}
