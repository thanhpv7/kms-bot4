...
@Component({
	selector: 'cb-purchase-order-stock-detail-crud-edit',
	templateUrl: './purchase-order-stock-detail-crud-edit.component.html',
	styleUrls: [
		'./purchase-order-stock-detail-crud-edit.component.scss',
...
export class PurchaseOrderStockDetailCrudEditComponent
