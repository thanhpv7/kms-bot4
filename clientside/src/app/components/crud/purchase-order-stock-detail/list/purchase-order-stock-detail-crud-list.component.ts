...
@Component({
	selector: 'cb-purchase-order-stock-detail-crud-list',
	templateUrl: './purchase-order-stock-detail-crud-list.component.html',
	styleUrls: [
		'./purchase-order-stock-detail-crud-list.component.scss',
...
export class PurchaseOrderStockDetailCrudListComponent
