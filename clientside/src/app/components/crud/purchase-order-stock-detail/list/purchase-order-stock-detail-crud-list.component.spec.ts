...
import {PurchaseOrderStockDetailCrudListComponent} from './purchase-order-stock-detail-crud-list.component';
...
describe('Purchase Order Stock Detail Crud List Tile Component', () => {
	...
	let fixture;
	let purchaseOrderStockDetailCrudListComponent: PurchaseOrderStockDetailCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(PurchaseOrderStockDetailCrudListComponent);
