 ...
 */
@Component({
	selector: 'cb-purchase-order-stock-detail-crud',
	templateUrl: './purchase-order-stock-detail-crud.component.html',
	styleUrls: [
		'./purchase-order-stock-detail-crud.component.scss',
...
export class PurchaseOrderStockDetailCrudComponent implements OnDestroy {
