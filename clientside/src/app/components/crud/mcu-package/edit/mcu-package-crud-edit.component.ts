...
@Component({
	selector: 'cb-mcu-package-crud-edit',
	templateUrl: './mcu-package-crud-edit.component.html',
	styleUrls: [
		'./mcu-package-crud-edit.component.scss',
...
export class McuPackageCrudEditComponent
