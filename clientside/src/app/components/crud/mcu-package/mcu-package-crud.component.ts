 ...
 */
@Component({
	selector: 'cb-mcu-package-crud',
	templateUrl: './mcu-package-crud.component.html',
	styleUrls: [
		'./mcu-package-crud.component.scss',
...
export class McuPackageCrudComponent implements OnDestroy {
