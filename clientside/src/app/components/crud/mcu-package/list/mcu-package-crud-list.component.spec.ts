...
import {McuPackageCrudListComponent} from './mcu-package-crud-list.component';
...
describe('MCU Package Crud List Tile Component', () => {
	...
	let fixture;
	let mcuPackageCrudListComponent: McuPackageCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(McuPackageCrudListComponent);
