...
@Component({
	selector: 'cb-mcu-package-crud-list',
	templateUrl: './mcu-package-crud-list.component.html',
	styleUrls: [
		'./mcu-package-crud-list.component.scss',
...
export class McuPackageCrudListComponent
