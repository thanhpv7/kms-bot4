...
import {McuPackageCrudListComponent} from './list/mcu-package-crud-list.component';
import {McuPackageCrudEditComponent} from './edit/mcu-package-crud-edit.component';
import {McuPackageCrudComponent} from './mcu-package-crud.component';
...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: McuPackageCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: McuPackageCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'mcu-package/view/:id',
				component: McuPackageCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class McuPackageCrudRoutingModule {
}
