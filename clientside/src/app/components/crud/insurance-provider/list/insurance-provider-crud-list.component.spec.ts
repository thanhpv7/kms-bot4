...
import {InsuranceProviderCrudListComponent} from './insurance-provider-crud-list.component';
...
describe('Insurance Provider Crud List Tile Component', () => {
	...
	let fixture;
	let insuranceProviderCrudListComponent: InsuranceProviderCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(InsuranceProviderCrudListComponent);
