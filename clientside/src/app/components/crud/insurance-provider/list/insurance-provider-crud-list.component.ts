...
@Component({
	selector: 'cb-insurance-provider-crud-list',
	templateUrl: './insurance-provider-crud-list.component.html',
	styleUrls: [
		'./insurance-provider-crud-list.component.scss',
...
export class InsuranceProviderCrudListComponent
