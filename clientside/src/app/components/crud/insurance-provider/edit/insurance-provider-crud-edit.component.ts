...
@Component({
	selector: 'cb-insurance-provider-crud-edit',
	templateUrl: './insurance-provider-crud-edit.component.html',
	styleUrls: [
		'./insurance-provider-crud-edit.component.scss',
...
export class InsuranceProviderCrudEditComponent
