...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: InsuranceProviderCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: InsuranceProviderCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'insurance-provider/view/:id',
				component: InsuranceProviderCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'insurance-provider/create',
				component: InsuranceProviderCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'insurance-provider/edit/:id',
				component: InsuranceProviderCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class InsuranceProviderCrudRoutingModule {
}
