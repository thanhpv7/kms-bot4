 ...
 */
@Component({
	selector: 'cb-insurance-provider-crud',
	templateUrl: './insurance-provider-crud.component.html',
	styleUrls: [
		'./insurance-provider-crud.component.scss',
...
export class InsuranceProviderCrudComponent implements OnDestroy {
