...
import {BpjsSearchControlLetterCrudListComponent} from './bpjs-search-control-letter-crud-list.component';
...
import {BpjsSearchControlLetterCrudModule} from '../bpjs-search-control-letter-crud.module';
import {
...
describe('BPJS Search Control Letter Crud List Tile Component', () => {
	...
	let fixture;
	let bpjsSearchControlLetterCrudListComponent: BpjsSearchControlLetterCrudListComponent;
	...
	const routerState: RouterState = {
		url: 'bpjs-search-control-letter-crud',
		urls: ['bpjs-search-control-letter-crud'],
		params: {},
		queryParams: {},
		data: {},
	};
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			imports: [
				...
				BpjsSearchControlLetterCrudModule,
			],
			providers: [
				provideMockStore(),
				{
			...
			fixture = TestBed.createComponent(BpjsSearchControlLetterCrudListComponent);
