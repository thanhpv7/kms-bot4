...
import {CrudTileMode} from '../bpjs-search-control-letter-crud.component';
...
@Component({
	selector: 'cb-bpjs-search-control-letter-crud-list',
	templateUrl: './bpjs-search-control-letter-crud-list.component.html',
	styleUrls: [
		'./bpjs-search-control-letter-crud-list.component.scss',
...
export class BpjsSearchControlLetterCrudListComponent
