 ...
 */
@Component({
	selector: 'cb-bpjs-jasa-raharja-claim-crud',
	templateUrl: './bpjs-jasa-raharja-claim-crud.component.html',
	styleUrls: [
		'./bpjs-jasa-raharja-claim-crud.component.scss',
...
export class BpjsJasaRaharjaClaimCrudComponent implements OnDestroy {
