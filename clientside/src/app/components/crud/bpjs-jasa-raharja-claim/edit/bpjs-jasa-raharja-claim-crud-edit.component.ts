...
@Component({
	selector: 'cb-bpjs-jasa-raharja-claim-crud-edit',
	templateUrl: './bpjs-jasa-raharja-claim-crud-edit.component.html',
	styleUrls: [
		'./bpjs-jasa-raharja-claim-crud-edit.component.scss',
...
export class BpjsJasaRaharjaClaimCrudEditComponent
