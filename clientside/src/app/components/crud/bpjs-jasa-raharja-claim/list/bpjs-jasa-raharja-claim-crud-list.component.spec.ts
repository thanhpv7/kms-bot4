...
import {BpjsJasaRaharjaClaimCrudListComponent} from './bpjs-jasa-raharja-claim-crud-list.component';
...
describe('BPJS Jasa Raharja Claim Crud List Tile Component', () => {
	...
	let fixture;
	let bpjsJasaRaharjaClaimCrudListComponent: BpjsJasaRaharjaClaimCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(BpjsJasaRaharjaClaimCrudListComponent);
