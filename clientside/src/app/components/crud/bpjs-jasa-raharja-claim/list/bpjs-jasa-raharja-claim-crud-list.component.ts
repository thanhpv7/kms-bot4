...
@Component({
	selector: 'cb-bpjs-jasa-raharja-claim-crud-list',
	templateUrl: './bpjs-jasa-raharja-claim-crud-list.component.html',
	styleUrls: [
		'./bpjs-jasa-raharja-claim-crud-list.component.scss',
...
export class BpjsJasaRaharjaClaimCrudListComponent
