...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: BpjsJasaRaharjaClaimCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: BpjsJasaRaharjaClaimCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-jasa-raharja-claim/view/:id',
				component: BpjsJasaRaharjaClaimCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-jasa-raharja-claim/create',
				component: BpjsJasaRaharjaClaimCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'bpjs-jasa-raharja-claim/edit/:id',
				component: BpjsJasaRaharjaClaimCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class BpjsJasaRaharjaClaimCrudRoutingModule {
}
