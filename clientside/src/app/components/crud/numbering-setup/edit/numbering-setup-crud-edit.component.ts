...
@Component({
	selector: 'cb-numbering-setup-crud-edit',
	templateUrl: './numbering-setup-crud-edit.component.html',
	styleUrls: [
		'./numbering-setup-crud-edit.component.scss',
...
export class NumberingSetupCrudEditComponent
