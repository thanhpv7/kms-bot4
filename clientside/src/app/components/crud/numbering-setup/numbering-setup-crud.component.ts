 ...
 */
@Component({
	selector: 'cb-numbering-setup-crud',
	templateUrl: './numbering-setup-crud.component.html',
	styleUrls: [
		'./numbering-setup-crud.component.scss',
...
export class NumberingSetupCrudComponent implements OnDestroy {
