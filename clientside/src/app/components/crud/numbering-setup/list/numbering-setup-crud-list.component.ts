...
@Component({
	selector: 'cb-numbering-setup-crud-list',
	templateUrl: './numbering-setup-crud-list.component.html',
	styleUrls: [
		'./numbering-setup-crud-list.component.scss',
...
export class NumberingSetupCrudListComponent
