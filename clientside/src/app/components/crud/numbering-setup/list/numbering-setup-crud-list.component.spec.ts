...
import {NumberingSetupCrudListComponent} from './numbering-setup-crud-list.component';
...
describe('Numbering Setup Crud List Tile Component', () => {
	...
	let fixture;
	let numberingSetupCrudListComponent: NumberingSetupCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(NumberingSetupCrudListComponent);
