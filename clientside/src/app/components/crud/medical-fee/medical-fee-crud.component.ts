 ...
 */
@Component({
	selector: 'cb-medical-fee-crud',
	templateUrl: './medical-fee-crud.component.html',
	styleUrls: [
		'./medical-fee-crud.component.scss',
...
export class MedicalFeeCrudComponent implements OnDestroy {
