...
@Component({
	selector: 'cb-medical-fee-crud-list',
	templateUrl: './medical-fee-crud-list.component.html',
	styleUrls: [
		'./medical-fee-crud-list.component.scss',
...
export class MedicalFeeCrudListComponent
