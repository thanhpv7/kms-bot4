...
import {MedicalFeeCrudListComponent} from './medical-fee-crud-list.component';
...
describe('Medical Fee Crud List Tile Component', () => {
	...
	let fixture;
	let medicalFeeCrudListComponent: MedicalFeeCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(MedicalFeeCrudListComponent);
