...
@Component({
	selector: 'cb-transfer-order-crud-edit',
	templateUrl: './transfer-order-crud-edit.component.html',
	styleUrls: [
		'./transfer-order-crud-edit.component.scss',
...
export class TransferOrderCrudEditComponent
