...
@Component({
	selector: 'cb-transfer-order-crud-list',
	templateUrl: './transfer-order-crud-list.component.html',
	styleUrls: [
		'./transfer-order-crud-list.component.scss',
...
export class TransferOrderCrudListComponent
