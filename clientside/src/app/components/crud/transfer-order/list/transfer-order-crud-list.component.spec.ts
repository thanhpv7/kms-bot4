...
import {TransferOrderCrudListComponent} from './transfer-order-crud-list.component';
...
describe('Transfer Order Crud List Tile Component', () => {
	...
	let fixture;
	let transferOrderCrudListComponent: TransferOrderCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(TransferOrderCrudListComponent);
