...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: TransferOrderCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: TransferOrderCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			},
			{
				...
				component: TransferOrderCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
...
export class TransferOrderCrudRoutingModule {
}
