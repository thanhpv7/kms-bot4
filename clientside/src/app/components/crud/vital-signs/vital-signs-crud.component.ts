 ...
 */
@Component({
	selector: 'cb-vital-signs-crud',
	templateUrl: './vital-signs-crud.component.html',
	styleUrls: [
		'./vital-signs-crud.component.scss',
...
export class VitalSignsCrudComponent implements OnDestroy {
