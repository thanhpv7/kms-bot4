...
@Component({
	selector: 'cb-vital-signs-crud-edit',
	templateUrl: './vital-signs-crud-edit.component.html',
	styleUrls: [
		'./vital-signs-crud-edit.component.scss',
...
export class VitalSignsCrudEditComponent
