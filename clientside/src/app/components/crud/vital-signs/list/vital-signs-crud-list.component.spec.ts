...
import {VitalSignsCrudListComponent} from './vital-signs-crud-list.component';
...
describe('Vital Signs Crud List Tile Component', () => {
	...
	let fixture;
	let vitalSignsCrudListComponent: VitalSignsCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(VitalSignsCrudListComponent);
