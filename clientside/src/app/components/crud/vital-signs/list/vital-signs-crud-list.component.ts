...
@Component({
	selector: 'cb-vital-signs-crud-list',
	templateUrl: './vital-signs-crud-list.component.html',
	styleUrls: [
		'./vital-signs-crud-list.component.scss',
...
export class VitalSignsCrudListComponent
