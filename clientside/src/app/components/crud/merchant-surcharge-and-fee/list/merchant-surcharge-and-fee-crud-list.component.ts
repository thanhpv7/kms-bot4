...
@Component({
	selector: 'cb-merchant-surcharge-and-fee-crud-list',
	templateUrl: './merchant-surcharge-and-fee-crud-list.component.html',
	styleUrls: [
		'./merchant-surcharge-and-fee-crud-list.component.scss',
...
export class MerchantSurchargeAndFeeCrudListComponent
