...
import {MerchantSurchargeAndFeeCrudListComponent} from './merchant-surcharge-and-fee-crud-list.component';
...
describe('Merchant Surcharge and Fee Crud List Tile Component', () => {
	...
	let fixture;
	let merchantSurchargeAndFeeCrudListComponent: MerchantSurchargeAndFeeCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(MerchantSurchargeAndFeeCrudListComponent);
