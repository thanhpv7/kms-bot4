...
import {InvoiceCrudListComponent} from './invoice-crud-list.component';
...
describe('Invoice Crud List Tile Component', () => {
	...
	let fixture;
	let invoiceCrudListComponent: InvoiceCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(InvoiceCrudListComponent);
