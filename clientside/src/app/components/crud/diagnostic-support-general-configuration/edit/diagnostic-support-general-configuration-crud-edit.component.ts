...
@Component({
	selector: 'cb-diagnostic-support-general-configuration-crud-edit',
	templateUrl: './diagnostic-support-general-configuration-crud-edit.component.html',
	styleUrls: [
		'./diagnostic-support-general-configuration-crud-edit.component.scss',
...
export class DiagnosticSupportGeneralConfigurationCrudEditComponent
