 ...
 */
@Component({
	selector: 'cb-diagnostic-support-general-configuration-crud',
	templateUrl: './diagnostic-support-general-configuration-crud.component.html',
	styleUrls: [
		'./diagnostic-support-general-configuration-crud.component.scss',
...
export class DiagnosticSupportGeneralConfigurationCrudComponent implements OnDestroy {
