...
import {DiagnosticSupportGeneralConfigurationCrudListComponent} from './list/diagnostic-support-general-configuration-crud-list.component';
import {DiagnosticSupportGeneralConfigurationCrudEditComponent} from './edit/diagnostic-support-general-configuration-crud-edit.component';
import {DiagnosticSupportGeneralConfigurationCrudComponent} from './diagnostic-support-general-configuration-crud.component';
...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: DiagnosticSupportGeneralConfigurationCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: DiagnosticSupportGeneralConfigurationCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'diagnostic-support-general-configuration/view/:id',
				component: DiagnosticSupportGeneralConfigurationCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'diagnostic-support-general-configuration/create',
				component: DiagnosticSupportGeneralConfigurationCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'diagnostic-support-general-configuration/edit/:id',
				component: DiagnosticSupportGeneralConfigurationCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class DiagnosticSupportGeneralConfigurationCrudRoutingModule {
}
