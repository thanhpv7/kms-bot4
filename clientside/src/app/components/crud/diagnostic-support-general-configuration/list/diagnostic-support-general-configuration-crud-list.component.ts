...
import {CrudTileMode} from '../diagnostic-support-general-configuration-crud.component';
...
@Component({
	selector: 'cb-diagnostic-support-general-configuration-crud-list',
	templateUrl: './diagnostic-support-general-configuration-crud-list.component.html',
	styleUrls: [
		'./diagnostic-support-general-configuration-crud-list.component.scss',
...
export class DiagnosticSupportGeneralConfigurationCrudListComponent
