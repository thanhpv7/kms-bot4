...
import {TransactionDetailTypeCrudRoutingModule} from './transaction-detail-type-crud-routing.module';
...
@NgModule({
	declarations: [
		TransactionDetailTypeCrudListComponent,
		TransactionDetailTypeCrudEditComponent,
		TransactionDetailTypeCrudComponent,
	...
	imports: [
		...
		CommonPipeModule,
		TransactionDetailTypeCrudRoutingModule,
...
export class TransactionDetailTypeCrudModule {
}
