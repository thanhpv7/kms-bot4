...
import {TransactionDetailTypeCrudListComponent} from './transaction-detail-type-crud-list.component';
...
describe('Transaction Detail Type Crud List Tile Component', () => {
	...
	let fixture;
	let transactionDetailTypeCrudListComponent: TransactionDetailTypeCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(TransactionDetailTypeCrudListComponent);
