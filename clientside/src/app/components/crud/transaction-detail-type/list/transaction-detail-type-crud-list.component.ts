...
@Component({
	selector: 'cb-transaction-detail-type-crud-list',
	templateUrl: './transaction-detail-type-crud-list.component.html',
	styleUrls: [
		'./transaction-detail-type-crud-list.component.scss',
...
export class TransactionDetailTypeCrudListComponent
