 ...
 */
@Component({
	selector: 'cb-transaction-detail-type-crud',
	templateUrl: './transaction-detail-type-crud.component.html',
	styleUrls: [
		'./transaction-detail-type-crud.component.scss',
...
export class TransactionDetailTypeCrudComponent implements OnDestroy {
