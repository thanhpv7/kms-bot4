 ...
 */
@Component({
	selector: 'cb-tariff-definition-crud',
	templateUrl: './tariff-definition-crud.component.html',
	styleUrls: [
		'./tariff-definition-crud.component.scss',
...
export class TariffDefinitionCrudComponent implements OnDestroy {
