...
import {TariffDefinitionCrudListComponent} from './tariff-definition-crud-list.component';
...
describe('Tariff Definition Crud List Tile Component', () => {
	...
	let fixture;
	let tariffDefinitionCrudListComponent: TariffDefinitionCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(TariffDefinitionCrudListComponent);
