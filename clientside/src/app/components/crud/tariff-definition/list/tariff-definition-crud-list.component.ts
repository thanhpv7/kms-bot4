...
@Component({
	selector: 'cb-tariff-definition-crud-list',
	templateUrl: './tariff-definition-crud-list.component.html',
	styleUrls: [
		'./tariff-definition-crud-list.component.scss',
...
export class TariffDefinitionCrudListComponent
