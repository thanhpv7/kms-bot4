...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: TariffDefinitionCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: TariffDefinitionCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'tariff-definition/view/:id',
				component: TariffDefinitionCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'tariff-definition/edit/:id',
				component: TariffDefinitionCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class TariffDefinitionCrudRoutingModule {
}
