...
@Component({
	selector: 'cb-tariff-definition-crud-edit',
	templateUrl: './tariff-definition-crud-edit.component.html',
	styleUrls: [
		'./tariff-definition-crud-edit.component.scss',
...
export class TariffDefinitionCrudEditComponent
