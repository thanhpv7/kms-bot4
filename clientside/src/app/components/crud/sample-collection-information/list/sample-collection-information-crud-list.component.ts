...
@Component({
	selector: 'cb-sample-collection-information-crud-list',
	templateUrl: './sample-collection-information-crud-list.component.html',
	styleUrls: [
		'./sample-collection-information-crud-list.component.scss',
...
export class SampleCollectionInformationCrudListComponent
