...
import {SampleCollectionInformationCrudListComponent} from './sample-collection-information-crud-list.component';
...
describe('Sample Collection Information Crud List Tile Component', () => {
	...
	let fixture;
	let sampleCollectionInformationCrudListComponent: SampleCollectionInformationCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(SampleCollectionInformationCrudListComponent);
