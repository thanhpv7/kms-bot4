...
@Component({
	selector: 'cb-sample-collection-information-crud-edit',
	templateUrl: './sample-collection-information-crud-edit.component.html',
	styleUrls: [
		'./sample-collection-information-crud-edit.component.scss',
...
export class SampleCollectionInformationCrudEditComponent
