 ...
 */
@Component({
	selector: 'cb-sample-collection-information-crud',
	templateUrl: './sample-collection-information-crud.component.html',
	styleUrls: [
		'./sample-collection-information-crud.component.scss',
...
export class SampleCollectionInformationCrudComponent implements OnDestroy {
