...
import {BpjsReferralSpecialistCrudListComponent} from './bpjs-referral-specialist-crud-list.component';
...
describe('BPJS Referral Specialist Crud List Tile Component', () => {
	...
	let fixture;
	let bpjsReferralSpecialistCrudListComponent: BpjsReferralSpecialistCrudListComponent;
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(BpjsReferralSpecialistCrudListComponent);
