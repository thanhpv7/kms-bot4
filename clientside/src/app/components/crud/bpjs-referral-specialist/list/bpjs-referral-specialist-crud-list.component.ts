...
@Component({
	selector: 'cb-bpjs-referral-specialist-crud-list',
	templateUrl: './bpjs-referral-specialist-crud-list.component.html',
	styleUrls: [
		'./bpjs-referral-specialist-crud-list.component.scss',
...
export class BpjsReferralSpecialistCrudListComponent
