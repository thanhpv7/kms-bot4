...
@Component({
	selector: 'cb-bpjs-referral-specialist-crud-edit',
	templateUrl: './bpjs-referral-specialist-crud-edit.component.html',
	styleUrls: [
		'./bpjs-referral-specialist-crud-edit.component.scss',
...
export class BpjsReferralSpecialistCrudEditComponent
