 ...
 */
@Component({
	selector: 'cb-bpjs-referral-specialist-crud',
	templateUrl: './bpjs-referral-specialist-crud.component.html',
	styleUrls: [
		'./bpjs-referral-specialist-crud.component.scss',
...
export class BpjsReferralSpecialistCrudComponent implements OnDestroy {
