...
const appRoutes: Routes = [
	...
	{
		path: '',
		component: BpjsReferralSpecialistCrudComponent,
		children: [
			{
				path: '',
				pathMatch: 'full',
				component: BpjsReferralSpecialistCrudListComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-referral-specialist/view/:id',
				component: BpjsReferralSpecialistCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
				data: {
			...
			{
				path: 'bpjs-referral-specialist/create',
				component: BpjsReferralSpecialistCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
			...
			{
				path: 'bpjs-referral-specialist/edit/:id',
				component: BpjsReferralSpecialistCrudEditComponent,
				canActivate: [
					RoleGuard,
				],
...
export class BpjsReferralSpecialistCrudRoutingModule {
}
