...
@Component({
	selector: 'cb-bpjs-list-finger-print-crud-edit',
	templateUrl: './bpjs-list-finger-print-crud-edit.component.html',
	styleUrls: [
		'./bpjs-list-finger-print-crud-edit.component.scss',
...
export class BpjsListFingerPrintCrudEditComponent
