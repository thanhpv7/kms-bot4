...
import {BpjsListFingerPrintCrudListComponent} from './bpjs-list-finger-print-crud-list.component';
...
import {BpjsListFingerPrintCrudModule} from '../bpjs-list-finger-print-crud.module';
import {
...
describe('BPJS List Finger Print Crud List Tile Component', () => {
	...
	let fixture;
	let bpjsListFingerPrintCrudListComponent: BpjsListFingerPrintCrudListComponent;
	...
	const routerState: RouterState = {
		url: 'bpjs-list-finger-print-crud',
		urls: ['bpjs-list-finger-print-crud'],
		params: {},
		queryParams: {},
		data: {},
	};
	...
	beforeEach(waitForAsync (() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(BpjsListFingerPrintCrudListComponent);
