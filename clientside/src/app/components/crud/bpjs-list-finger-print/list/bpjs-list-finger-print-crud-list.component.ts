...
import {CrudTileMode} from '../bpjs-list-finger-print-crud.component';
...
@Component({
	selector: 'cb-bpjs-list-finger-print-crud-list',
	templateUrl: './bpjs-list-finger-print-crud-list.component.html',
	styleUrls: [
		'./bpjs-list-finger-print-crud-list.component.scss',
...
export class BpjsListFingerPrintCrudListComponent
