 ...
 */
@Component({
	selector: 'cb-bpjs-list-finger-print-crud',
	templateUrl: './bpjs-list-finger-print-crud.component.html',
	styleUrls: [
		'./bpjs-list-finger-print-crud.component.scss',
...
export class BpjsListFingerPrintCrudComponent implements OnDestroy {
