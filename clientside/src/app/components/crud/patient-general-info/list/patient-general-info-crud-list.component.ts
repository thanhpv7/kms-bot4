...
@Component({
	selector: 'cb-patient-general-info-crud-list',
	templateUrl: './patient-general-info-crud-list.component.html',
	styleUrls: [
		'./patient-general-info-crud-list.component.scss',
...
export class PatientGeneralInfoCrudListComponent
