 ...
 */
@Component({
	selector: 'cb-patient-general-info-crud',
	templateUrl: './patient-general-info-crud.component.html',
	styleUrls: [
		'./patient-general-info-crud.component.scss',
...
export class PatientGeneralInfoCrudComponent implements OnDestroy {
